...
############################# Head ############################
head_title: "Combina fitxers VSDM mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers VSDM a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "VSDM Fusió a Java"
description: "Combina VSDM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers VSDM a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers VSDM implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers VSDM mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers VSDM mitjançant l'API de GroupDocs.Merger per a Java
