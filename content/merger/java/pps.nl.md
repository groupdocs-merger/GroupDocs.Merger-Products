...
############################# Head ############################
head_title: "Samenvoegen PPS Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PPS Fusie in Java"
description: "Voeg PPS samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PPS bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPS bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PPS bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één PPS bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) te gaan.
