...
############################# Head ############################
head_title: "Samenvoegen MHTML Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "MHTML Fusie in Java"
description: "Voeg MHTML samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere MHTML bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHTML bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg MHTML bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één MHTML bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) te gaan.
