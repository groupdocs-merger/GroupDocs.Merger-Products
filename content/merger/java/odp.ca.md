...
############################# Head ############################
head_title: "Combina fitxers ODP mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers ODP a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "ODP Fusió a Java"
description: "Combina ODP amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers ODP a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers ODP implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers ODP mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers ODP mitjançant l'API de GroupDocs.Merger per a Java
