...
############################# Head ############################
head_title: "Ühendage ODT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ODT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "ODT ühinemine programmis Java"
description: "Ühendage ODT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ODT faili, kasutades Java näitekoodi">}}
