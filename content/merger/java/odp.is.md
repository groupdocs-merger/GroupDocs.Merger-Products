...
############################# Head ############################
head_title: "Sameina ODP skrár með Java & J2SE Documents Merger API"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að sameina margar ODP skrár með því að útfæra nokkur auðveld skref.
