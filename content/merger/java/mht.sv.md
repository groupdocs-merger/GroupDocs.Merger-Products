...
############################# Head ############################
head_title: "Slå samman MHT filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera MHT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "MHT sammanslagning i Java"
description: "Slå samman MHT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera MHT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera MHT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar MHT filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman MHT-filer med GroupDocs.Merger för Java API
