...
############################# Head ############################
head_title: "Sloučit soubory XLSM přes rozhraní Java & J2SE Documents Merger API"
head_description: "Sloučit více souborů XLSM v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "XLSM Fúze v Java"
description: "Sloučit XLSM s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Sloučit více souborů XLSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java sloučení více souborů XLSM pomocí několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory XLSM pomocí ukázkového kódu Java">}}

        ```java    
        // Sloučit XLSM soubory pomocí GroupDocs.Merger for Java API
        // Okamžité sloučení se vstupním dokumentem XLSM
...
demos:
    ...
    content: |
       Na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) sloučte hned teď více než jeden soubor XLSM.
