...
############################# Head ############################
head_title: "Ühendage ODP failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ODP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "ODP ühinemine programmis Java"
description: "Ühendage ODP mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ODP faili, kasutades Java näitekoodi">}}
