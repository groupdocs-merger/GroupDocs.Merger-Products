...
############################# Head ############################
head_title: "Ühendage XLTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLTX ühinemine programmis Java"
description: "Ühendage XLTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLTX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLTX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLTX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks XLTX faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
