...
############################# Head ############################
head_title: "Merge HTML files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate HTML document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge HTML files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage HTML documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of HTML documents. Enhance your Java applications by combining multiple files into one.
