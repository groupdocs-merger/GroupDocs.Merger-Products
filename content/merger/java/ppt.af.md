...
############################# Head ############################
head_title: "Voeg PPT lêers saam via Java & J2SE Documents Merger API"
head_description: "Voeg veelvuldige PPT-lêers in Java saam met behulp van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "PPT samesmelting in Java"
description: "Voeg PPT saam met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Voeg veelvuldige PPT-lêers saam in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige PPT-lêers saam te voeg deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPT lêers saam te voeg deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Voeg PPT lêers saam met GroupDocs.Merger vir Java API
