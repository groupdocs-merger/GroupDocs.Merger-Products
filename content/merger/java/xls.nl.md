...
############################# Head ############################
head_title: "Samenvoegen XLS Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLS Fusie in Java"
description: "Voeg XLS samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLS bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLS bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLS bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLS bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) te gaan.
