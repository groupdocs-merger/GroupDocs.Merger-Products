...
############################# Head ############################
head_title: "Egyesítse az OTP fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több OTP fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "OTP Egyesülés a Java programban"
description: "Egyesítse a(z) OTP terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több OTP fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több OTP fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen OTP fájlokat a GroupDocs.Merger for Java API segítségével
