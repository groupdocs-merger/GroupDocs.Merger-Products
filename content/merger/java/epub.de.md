...
############################# Head ############################
head_title: "Führen Sie EPUB-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere EPUB-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "EPUB Fusion in Java"
description: "Führen Sie EPUB mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere EPUB-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere EPUB-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie EPUB-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie EPUB-Dateien mit GroupDocs.Merger for Java API zusammen
