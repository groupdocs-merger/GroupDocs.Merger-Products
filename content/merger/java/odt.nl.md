...
############################# Head ############################
head_title: "Samenvoegen ODT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "ODT Fusie in Java"
description: "Voeg ODT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere ODT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg ODT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één ODT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) te gaan.
