...
############################# Head ############################
head_title: "Slå samman DOC filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera DOC-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "DOC sammanslagning i Java"
description: "Slå samman DOC med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera DOC-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera DOC-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar DOC filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman DOC-filer med GroupDocs.Merger för Java API
