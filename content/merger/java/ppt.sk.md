...
############################# Head ############################
head_title: "Zlúčiť súbory PPT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PPT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PPT Zlúčenie v Java"
description: "Zlúčte PPT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PPT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PPT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PPT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PPT súbory pomocou GroupDocs.Merger for Java API
