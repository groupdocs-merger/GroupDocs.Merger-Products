...
############################# Head ############################
head_title: "Voeg XLS lêers saam via Java & J2SE Documents Merger API"
head_description: "Voeg veelvuldige XLS-lêers in Java saam met behulp van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "XLS samesmelting in Java"
description: "Voeg XLS saam met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Voeg veelvuldige XLS-lêers saam in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige XLS-lêers saam te voeg deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLS lêers saam te voeg deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Voeg XLS lêers saam met GroupDocs.Merger vir Java API
