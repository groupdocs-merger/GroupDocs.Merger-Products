...
############################# Head ############################
head_title: "دمج ملفات XLSB عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLSB في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLSB الاندماج في Java"
description: "دمج XLSB ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLSB ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
