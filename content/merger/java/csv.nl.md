...
############################# Head ############################
head_title: "Samenvoegen CSV Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "CSV Fusie in Java"
description: "Voeg CSV samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere CSV bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe CSV bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg CSV bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één CSV bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) te gaan.
