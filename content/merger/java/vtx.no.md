...
############################# Head ############################
head_title: "Slå sammen VTX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VTX sammenslåing i Java"
description: "Slå sammen VTX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VTX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VTX filer med GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VTX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
