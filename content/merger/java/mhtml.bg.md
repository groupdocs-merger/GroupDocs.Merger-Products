...
############################# Head ############################
head_title: "Обединете MHTML файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество MHTML файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "MHTML Обединяване в Java"
description: "Обединете MHTML с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество MHTML файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините MHTML файлове с Java примерен код">}}

        ```java    
        // Обединете MHTML файлове с помощта на GroupDocs.Merger за Java API
