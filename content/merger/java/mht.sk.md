...
############################# Head ############################
head_title: "Zlúčiť súbory MHT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero MHT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "MHT Zlúčenie v Java"
description: "Zlúčte MHT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero MHT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov MHT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory MHT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť MHT súbory pomocou GroupDocs.Merger for Java API
