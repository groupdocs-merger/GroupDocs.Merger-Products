...
############################# Head ############################
head_title: "Zlúčiť súbory HTML cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero HTML súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "HTML Zlúčenie v Java"
description: "Zlúčte HTML s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero HTML súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov HTML vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory HTML pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť HTML súbory pomocou GroupDocs.Merger for Java API
