...
############################# Head ############################
head_title: "Samenvoegen ONE Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "ONE Fusie in Java"
description: "Voeg ONE samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere ONE bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ONE bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg ONE bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één ONE bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) te gaan.
