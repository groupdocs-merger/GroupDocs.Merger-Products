...
############################# Head ############################
head_title: "Egyesítse az OTT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több OTT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "OTT Egyesülés a Java programban"
description: "Egyesítse a(z) OTT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több OTT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több OTT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen OTT fájlokat a GroupDocs.Merger for Java API segítségével
