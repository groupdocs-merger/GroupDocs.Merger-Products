...
############################# Head ############################
head_title: "Zlúčiť súbory DOTX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOTX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOTX Zlúčenie v Java"
description: "Zlúčte DOTX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOTX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOTX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOTX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOTX súbory pomocou GroupDocs.Merger for Java API
