...
############################# Head ############################
head_title: "Slå sammen DOTX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOTX sammenslåing i Java"
description: "Slå sammen DOTX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOTX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOTX filer med GroupDocs.Merger for Java API
