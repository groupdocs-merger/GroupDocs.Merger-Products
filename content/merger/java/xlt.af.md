...
############################# Head ############################
head_title: "Voeg XLT lêers saam via Java & J2SE Documents Merger API"
head_description: "Voeg veelvuldige XLT-lêers in Java saam met behulp van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "XLT samesmelting in Java"
description: "Voeg XLT saam met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Voeg veelvuldige XLT-lêers saam in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige XLT-lêers saam te voeg deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêers saam te voeg deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Voeg XLT lêers saam met GroupDocs.Merger vir Java API
