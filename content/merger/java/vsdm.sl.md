...
############################# Head ############################
head_title: "Spoji datoteke VSDM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSDM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSDM Združitev v Java"
description: "Spojite VSDM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSDM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSDM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSDM z API-jem GroupDocs.Merger for Java
