...
############################# Head ############################
head_title: "Cumaisc DOTX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid DOTX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "DOTX Cumasc i Java"
description: "Cumaisc DOTX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc DOTX Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid DOTX iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOTX comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc DOTX comhad le GroupDocs.Merger le haghaidh Java API
