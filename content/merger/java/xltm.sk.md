...
############################# Head ############################
head_title: "Zlúčiť súbory XLTM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLTM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLTM Zlúčenie v Java"
description: "Zlúčte XLTM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLTM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLTM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLTM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLTM súbory pomocou GroupDocs.Merger for Java API
