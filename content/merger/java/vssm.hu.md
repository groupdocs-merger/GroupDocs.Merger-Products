...
############################# Head ############################
head_title: "Egyesítse az VSSM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSSM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSSM Egyesülés a Java programban"
description: "Egyesítse a(z) VSSM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSSM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSSM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSSM fájlokat a GroupDocs.Merger for Java API segítségével
