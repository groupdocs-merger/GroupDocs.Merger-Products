...
############################# Head ############################
head_title: "Samenvoegen XLAM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLAM Fusie in Java"
description: "Voeg XLAM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLAM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLAM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLAM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLAM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) te gaan.
