...
############################# Head ############################
head_title: "Egyesítse az XPS fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XPS fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XPS Egyesülés a Java programban"
description: "Egyesítse a(z) XPS terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XPS fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XPS fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XPS fájlokat a GroupDocs.Merger for Java API segítségével
