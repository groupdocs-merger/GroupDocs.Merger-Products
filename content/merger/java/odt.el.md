...
############################# Head ############################
head_title: "Συγχώνευση αρχείων ODT μέσω Java & J2SE Documents Merger API"
head_description: "Συγχωνεύστε πολλά αρχεία ODT σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "ODT Συγχώνευση στο Java"
description: "Συγχώνευση ODT με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συγχώνευση πολλών ODT αρχείων στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συγχωνεύουν πολλά αρχεία ODT εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία ODT χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συγχώνευση αρχείων ODT χρησιμοποιώντας GroupDocs.Merger for Java API
