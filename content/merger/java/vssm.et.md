...
############################# Head ############################
head_title: "Ühendage VSSM failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSSM ühinemine programmis Java"
description: "Ühendage VSSM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSSM faili, kasutades Java näitekoodi">}}
