...
############################# Head ############################
head_title: "Zlúčiť súbory ODT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero ODT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "ODT Zlúčenie v Java"
description: "Zlúčte ODT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero ODT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov ODT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory ODT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť ODT súbory pomocou GroupDocs.Merger for Java API
