...
############################# Head ############################
head_title: "Sameina VSX skrár með Java & J2SE Documents Merger API"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að sameina margar VSX skrár með því að útfæra nokkur auðveld skref.
...
demos:
    ...
    content: |
       Sameina fleiri en eina VSX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) vefsíðu.
