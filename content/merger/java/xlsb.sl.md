...
############################# Head ############################
head_title: "Spoji datoteke XLSB prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLSB v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLSB Združitev v Java"
description: "Spojite XLSB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLSB v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSB s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLSB z API-jem GroupDocs.Merger for Java
