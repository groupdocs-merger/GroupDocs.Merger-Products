...
############################# Head ############################
head_title: "دمج ملفات ODP عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات ODP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "ODP الاندماج في Java"
description: "دمج ODP ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من ODP ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
