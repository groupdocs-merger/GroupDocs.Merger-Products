...
############################# Head ############################
head_title: "Slå sammen XLSX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLSX sammenslåing i Java"
description: "Slå sammen XLSX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLSX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLSX filer med GroupDocs.Merger for Java API
