...
############################# Head ############################
head_title: "TEX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla TEX dosyasını birleştirin."

############################# Header ############################
title: "TEX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok TEX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) web sitesini ziyaret ederek birden fazla TEX dosyayı birleştirin.
