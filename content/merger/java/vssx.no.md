...
############################# Head ############################
head_title: "Slå sammen VSSX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VSSX sammenslåing i Java"
description: "Slå sammen VSSX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSSX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VSSX filer med GroupDocs.Merger for Java API
