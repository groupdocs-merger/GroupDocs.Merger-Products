...
############################# Head ############################
head_title: "PPTX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ አዋህድ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ PPTX ፋይሎችን በጃቫ ውስጥ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "የPPTX ውህደት በJava"
description: "PPTXን ከጥቂት የJava ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ PPTX ፋይሎችን አዋህድ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ PPTX ፋይሎችን ማዋሃድ ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም PPTX ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም PPTX ፋይሎችን አዋህድ
