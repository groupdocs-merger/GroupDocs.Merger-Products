...
head_description: "Utilisez GroupDocs.Merger for Java pour intégrer les fonctionnalités de fusion de documents JPEG dans vos projets Java."

############################# Header ############################
title: "Fusionner des fichiers JPEG" 
description: "Avec GroupDocs.Merger for Java, vous pouvez créer des applications avancées Java qui fusionnent et gèrent les documents JPEG sans difficulté."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) permet de fusionner facilement des documents JPEG. Améliorez vos applications Java en combinant plusieurs fichiers en un.
      
      1. Fournissez le chemin vers le premier fichier JPEG.
