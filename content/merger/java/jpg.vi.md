...
############################# Head ############################
head_title: "Gộp các tệp JPG trong Java"
head_description: "Sử dụng GroupDocs.Merger for Java để tích hợp khả năng gộp tài liệu JPG vào các dự án Java của bạn."

############################# Header ############################
title: "Gộp các tệp JPG" 
description: "Với GroupDocs.Merger for Java, bạn có thể xây dựng các ứng dụng Java tiên tiến có khả năng gộp và quản lý các tài liệu JPG một cách liền mạch."
...
steps:
    enable: true
    title: "Cách gộp tài liệu JPG"
    content: |
      [GroupDocs.Merger](/merger/java/) cho phép gộp liền mạch các tài liệu JPG. Nâng cao các ứng dụng Java của bạn bằng cách kết hợp nhiều tệp thành một.
