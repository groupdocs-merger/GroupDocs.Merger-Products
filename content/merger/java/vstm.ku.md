...
############################# Head ############################
head_title: "Pelên VSTM bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên VSTM di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "VSTM Yekbûn di Java"
...
steps:
    enable: true
    title_left: "Gelek VSTM Pelên di Java de bibin yek"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên VSTM bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên VSTM bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) niha ji yek pelan zêdetir VSTM bikin yek.
