...
############################# Head ############################
head_title: "VSDM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSDM dosyasını birleştirin."

############################# Header ############################
title: "VSDM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSDM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) web sitesini ziyaret ederek birden fazla VSDM dosyayı birleştirin.
