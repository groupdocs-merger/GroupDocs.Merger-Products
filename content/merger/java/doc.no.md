...
############################# Head ############################
head_title: "Slå sammen DOC filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOC sammenslåing i Java"
description: "Slå sammen DOC med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOC filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOC filer med GroupDocs.Merger for Java API
