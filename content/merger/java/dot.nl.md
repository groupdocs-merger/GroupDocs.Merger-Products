...
############################# Head ############################
head_title: "Samenvoegen DOT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOT Fusie in Java"
description: "Voeg DOT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) te gaan.
