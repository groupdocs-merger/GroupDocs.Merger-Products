...
############################# Head ############################
head_title: "Egyesítse az PDF fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PDF fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PDF Egyesülés a Java programban"
description: "Egyesítse a(z) PDF terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PDF fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PDF fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PDF fájlokat a GroupDocs.Merger for Java API segítségével
