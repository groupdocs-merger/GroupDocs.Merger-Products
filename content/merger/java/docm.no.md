...
############################# Head ############################
head_title: "Slå sammen DOCM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOCM sammenslåing i Java"
description: "Slå sammen DOCM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOCM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOCM filer med GroupDocs.Merger for Java API
