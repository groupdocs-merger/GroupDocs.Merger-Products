...
############################# Head ############################
head_title: "Ühendage DOTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "DOTX ühinemine programmis Java"
description: "Ühendage DOTX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOTX faili, kasutades Java näitekoodi">}}
