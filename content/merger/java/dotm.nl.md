...
############################# Head ############################
head_title: "Samenvoegen DOTM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOTM Fusie in Java"
description: "Voeg DOTM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOTM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOTM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOTM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) te gaan.
