...
############################# Head ############################
head_title: "استخراج صفحات XLSX في Java"
head_description: "استخرج سريعًا الصفحات من ملف XLSX في Java. احفظ المستند الجديد الذي يحتوي على الصفحات المحددة باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "استخراج صفحات XLSX في Java"
description: "استخراج صفحات XLSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "استخراج صفحات الملف XLSX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java استخراج الصفحات المطلوبة من ملف XLSX وحفظها باسم ملف جديد يحتوي على الصفحات المحددة من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية استخراج صفحات ملف XLSX باستخدام كود مثال Java">}}

        ```java    
        // استخراج صفحات الملف XLSX باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - استخراج صفحات XLSX عبر الإنترنت"
    content: |
       استخرج صفحات ملف XLSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
