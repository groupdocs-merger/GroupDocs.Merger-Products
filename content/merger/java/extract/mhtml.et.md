...
############################# Head ############################
head_title: "Ekstraheerige MHTML lehte Java"
head_description: "Eksportige kiiresti lehed MHTML failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige MHTML lehte rakenduses Java"
description: "Ekstraheerige MHTML lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige MHTML faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist MHTML ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili MHTML lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili MHTML lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis MHTML lehekülge"
    content: |
       Ekstraktige kohe MHTML faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
