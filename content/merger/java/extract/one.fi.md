...
############################# Head ############################
head_title: "Pura ONE sivua Java"
head_description: "Pura sivut nopeasti ONE-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ONE sivua Java"
description: "Pura ONE sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura ONE tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut ONE-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ONE tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura ONE tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura ONE sivua verkossa"
    content: |
       Pura ONE tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one) -sivustolla.
