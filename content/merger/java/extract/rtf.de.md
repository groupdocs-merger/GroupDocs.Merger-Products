...
############################# Head ############################
head_title: "Extrahiere RTF Seiten in Java"
head_description: "Extrahieren Sie schnell Seiten aus einer RTF-Datei in Java. Speichern Sie das neue Dokument mit den ausgewählten Seiten mithilfe der Documents Merger API."

############################# Header ############################
title: "Extrahiere RTF Seiten in Java"
description: "Extrahieren Sie RTF-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "RTF Dateiseiten in Java extrahieren"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, die gewünschten Seiten aus einer RTF-Datei zu extrahieren und als zu speichern eine neue Datei mit den ausgewählten Seiten, indem Sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So extrahieren Sie RTF-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie RTF-Dateiseiten mit der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Extrahieren Sie RTF Seiten online"
    content: |
       Extrahieren Sie jetzt RTF Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) besuchen.
