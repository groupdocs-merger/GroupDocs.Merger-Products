...
############################# Head ############################
head_title: "Pura HTML sivua Java"
head_description: "Pura sivut nopeasti HTML-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura HTML sivua Java"
description: "Pura HTML sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura HTML tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut HTML-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa HTML tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura HTML tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura HTML sivua verkossa"
    content: |
       Pura HTML tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html) -sivustolla.
