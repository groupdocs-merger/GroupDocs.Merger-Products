...
############################# Head ############################
head_title: "Izvilkt MHT lapas programmā Java"
head_description: "Ātri izvelciet lapas no MHT faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt MHT lapas programmā Java"
description: "Izvelciet MHT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt MHT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila MHT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt MHT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet MHT faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet MHT lapas tiešsaistē"
    content: |
       Izņemiet MHT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht).
