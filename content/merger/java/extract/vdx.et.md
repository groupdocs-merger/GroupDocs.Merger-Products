...
############################# Head ############################
head_title: "Ekstraheerige VDX lehte Java"
head_description: "Eksportige kiiresti lehed VDX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VDX lehte rakenduses Java"
description: "Ekstraheerige VDX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VDX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VDX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VDX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VDX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VDX lehekülge"
    content: |
       Ekstraktige kohe VDX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx).
