...
############################# Head ############################
head_title: "VSTX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VSTX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VSTX oldal kibontása a Java nyelven"
description: "Bontsa ki az VSTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VSTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VSTX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VSTX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx) webhely meglátogatásával azonnal kibonthatja az VSTX fájloldalakat.
