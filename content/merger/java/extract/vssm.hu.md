...
############################# Head ############################
head_title: "VSSM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VSSM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VSSM oldal kibontása a Java nyelven"
description: "Bontsa ki az VSSM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSSM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VSSM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VSSM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VSSM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm) webhely meglátogatásával azonnal kibonthatja az VSSM fájloldalakat.
