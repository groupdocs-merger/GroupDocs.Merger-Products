...
############################# Head ############################
head_title: "Extreu MHT pàgines a Java"
head_description: "Extraieu ràpidament pàgines d'un fitxer MHT a Java. Deseu el nou document que conté les pàgines seleccionades mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Extreu MHT pàgines a Java"
description: "Extreu MHT pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Extreu MHT pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java extreure les pàgines desitjades d'un fitxer MHT i desar-les com a un nou fitxer que conté les pàgines seleccionades implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com extreure pàgines de fitxers MHT utilitzant el codi d'exemple Java">}}
