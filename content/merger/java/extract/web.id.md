...
head_title: "Ekstrak WEB ke Beberapa File di Java"
head_description: "Pengguna Java mengekstrak satu file WEB menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Ekstrak WEB Ke Beberapa File di Java"
description: "Ekstrak satu file WEB menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Ekstrak File WEB Dengan Halaman di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak satu file WEB menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak file WEB menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak Halaman WEB Online"
    content: |
        Ekstrak file WEB sekarang dengan mengunjungi situs web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/WEB).
