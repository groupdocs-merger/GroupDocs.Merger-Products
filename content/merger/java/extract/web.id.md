...
head_description: "Ekstrak halaman dengan cepat dari file WEB di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak WEB Halaman Di Java"
description: "Ekstrak Halaman WEB dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File WEB di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file WEB dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file WEB menggunakan kode contoh Java">}}
