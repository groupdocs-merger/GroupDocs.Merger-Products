...
############################# Head ############################
head_title: "Ekstraheerige XLTM lehte Java"
head_description: "Eksportige kiiresti lehed XLTM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLTM lehte rakenduses Java"
description: "Ekstraheerige XLTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLTM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist XLTM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLTM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili XLTM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis XLTM lehekülge"
    content: |
       Ekstraktige kohe XLTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltm).
