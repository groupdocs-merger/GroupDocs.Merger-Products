...
############################# Head ############################
head_title: "VSDX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VSDX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VSDX oldal kibontása a Java nyelven"
description: "Bontsa ki az VSDX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSDX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VSDX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX fájloldalak kibontása a Java példakóddal">}}
