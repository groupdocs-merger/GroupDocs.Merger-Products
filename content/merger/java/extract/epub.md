...
head_description: "Quickly extract pages from a EPUB file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract EPUB Pages In Java"
description: "Extract EPUB Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract EPUB File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a EPUB file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract EPUB file pages using Java example code">}}
