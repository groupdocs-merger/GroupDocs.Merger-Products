...
############################# Head ############################
head_title: "Udpak XLSX sider i Java"
head_description: "Udpak hurtigt sider fra en XLSX-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak XLSX sider i Java"
description: "Udpak XLSX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak XLSX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en XLSX-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes XLSX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Udpak XLSX filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Udpak XLSX sider online"
    content: |
       Udpak XLSX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
