...
############################# Head ############################
head_title: "Ekstraheerige XLSX lehte Java"
head_description: "Eksportige kiiresti lehed XLSX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLSX lehte rakenduses Java"
description: "Ekstraheerige XLSX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLSX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist XLSX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLSX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili XLSX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis XLSX lehekülge"
    content: |
       Ekstraktige kohe XLSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
