...
############################# Head ############################
head_title: "Extrahujte VTX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VTX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VTX stránek v Java"
description: "Extrahujte VTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VTX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VTX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VTX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VTX stránek online"
    content: |
       Extrahujte stránky souborů VTX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx).
