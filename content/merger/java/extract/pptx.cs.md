...
############################# Head ############################
head_title: "Extrahujte PPTX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru PPTX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte PPTX stránek v Java"
description: "Extrahujte PPTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PPTX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru PPTX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru PPTX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru PPTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte PPTX stránek online"
    content: |
       Extrahujte stránky souborů PPTX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
