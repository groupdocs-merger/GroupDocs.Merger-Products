...
############################# Head ############################
head_title: "Ekstraheerige DOCX lehte Java"
head_description: "Eksportige kiiresti lehed DOCX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige DOCX lehte rakenduses Java"
description: "Ekstraheerige DOCX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige DOCX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist DOCX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili DOCX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili DOCX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis DOCX lehekülge"
    content: |
       Ekstraktige kohe DOCX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx).
