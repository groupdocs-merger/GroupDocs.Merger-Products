...
############################# Head ############################
head_title: "Di Java de VSSM Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek VSSM di Java de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên VSSM Di Java de derxe"
description: "Rûpelên VSSM bi çend rêzikên koda Java derxe."
...
steps:
    enable: true
    title_left: "Di Java de VSSM Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku rûpelên xwestinê ji pelek VSSM derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên VSSM derxe">}}

        ```java    
        // Rûpelên pelê yên VSSM bi kar tînin GroupDocs.Merger API derxînin
...
demos:
    enable: true
    title: "Demokên Zindî - Rûpelên Serhêl ên VSSM derxînin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm) niha rûpelên pelê yên VSSM derxînin.
