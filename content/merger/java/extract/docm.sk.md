...
############################# Head ############################
head_title: "Extrahujte DOCM stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru DOCM v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte DOCM stránok v Java"
description: "Extrahujte DOCM stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOCM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru DOCM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru DOCM pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte DOCM strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte DOCM stránok online"
    content: |
       Rozbaľte stránky súboru DOCM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
