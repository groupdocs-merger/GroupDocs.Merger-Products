...
############################# Head ############################
head_title: "Ekstrakt ODS stranica u Java"
head_description: "Brzo izdvojite stranice iz ODS datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt ODS stranica u Java"
description: "Izdvojite ODS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt ODS stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz ODS datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti ODS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte ODS stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite ODS stranica na mreži"
    content: |
       Izdvojite ODS stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods) web stranice.
