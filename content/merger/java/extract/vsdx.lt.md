...
############################# Head ############################
head_title: "Išskleiskite VSDX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš VSDX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSDX puslapius Java"
description: "Išskleiskite VSDX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSDX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš VSDX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSDX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite VSDX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite VSDX puslapius internete"
    content: |
       Išskleiskite VSDX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx) svetainėje.
