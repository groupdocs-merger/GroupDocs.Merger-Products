...
############################# Head ############################
head_title: "Extrahujte XPS stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XPS v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XPS stránek v Java"
description: "Extrahujte XPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XPS stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XPS a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XPS pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XPS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XPS stránek online"
    content: |
       Extrahujte stránky souborů XPS právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps).
