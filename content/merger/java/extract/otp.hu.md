...
############################# Head ############################
head_title: "OTP oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy OTP fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "OTP oldal kibontása a Java nyelven"
description: "Bontsa ki az OTP oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "OTP fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy OTP fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az OTP fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – OTP oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp) webhely meglátogatásával azonnal kibonthatja az OTP fájloldalakat.
