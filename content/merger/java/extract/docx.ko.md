...
############################# Head ############################
head_title: "DOCX 페이지 추출하기 - Java"
head_description: "GroupDocs.Merger for Java를 사용하여 DOCX 문서에서 특정 페이지를 추출하고 이를 별도의 파일로 저장하세요."

############################# Header ############################
title: "DOCX 페이지 추출하기" 
description: "GroupDocs.Merger for Java를 통해 Java 애플리케이션에 DOCX 파일에 대한 강력한 문서 처리 기능을 추가할 수 있습니다."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)을 사용하면 DOCX 문서에서 페이지를 추출할 수 있습니다. 향상된 문서 관리 기능을 통합하여 Java 애플리케이션을 강화하세요.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "문서에서 특정 페이지 추출"
      content: |
        이 예제는 DOCX 문서에서 페이지 범위를 추출하고 이를 별도의 파일로 저장하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
