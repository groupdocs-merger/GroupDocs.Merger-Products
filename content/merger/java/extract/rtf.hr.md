...
############################# Head ############################
head_title: "Ekstrakt RTF stranica u Java"
head_description: "Brzo izdvojite stranice iz RTF datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt RTF stranica u Java"
description: "Izdvojite RTF stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt RTF stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz RTF datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti RTF stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte RTF stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite RTF stranica na mreži"
    content: |
       Izdvojite RTF stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) web stranice.
