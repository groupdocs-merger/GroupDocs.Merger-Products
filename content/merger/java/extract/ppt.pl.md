...
############################# Head ############################
head_title: "Wyodrębnij strony PPT w Java"
head_description: "Szybko wyodrębnij strony z pliku PPT w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij PPT strony w Java"
description: "Wyodrębnij strony PPT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików PPT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku PPT i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku PPT za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku PPT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij PPT strony online"
    content: |
       Wyodrębnij strony plików PPT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt).
