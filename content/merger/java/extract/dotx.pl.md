...
############################# Head ############################
head_title: "Wyodrębnij strony DOTX w Java"
head_description: "Szybko wyodrębnij strony z pliku DOTX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOTX strony w Java"
description: "Wyodrębnij strony DOTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku DOTX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku DOTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij DOTX strony online"
    content: |
       Wyodrębnij strony plików DOTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx).
