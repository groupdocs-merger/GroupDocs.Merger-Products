...
############################# Head ############################
head_title: "Ekstraheerige OTP lehte Java"
head_description: "Eksportige kiiresti lehed OTP failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige OTP lehte rakenduses Java"
description: "Ekstraheerige OTP lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige OTP faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist OTP ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili OTP lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili OTP lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis OTP lehekülge"
    content: |
       Ekstraktige kohe OTP faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
