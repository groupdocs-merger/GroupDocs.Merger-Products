...
############################# Head ############################
head_title: "Extrahujte VSSX stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru VSSX v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte VSSX stránok v Java"
description: "Extrahujte VSSX stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSSX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru VSSX a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru VSSX pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte VSSX strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte VSSX stránok online"
    content: |
       Rozbaľte stránky súboru VSSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssx).
