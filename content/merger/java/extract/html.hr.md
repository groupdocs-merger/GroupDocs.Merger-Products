...
############################# Head ############################
head_title: "Ekstrakt HTML stranica u Java"
head_description: "Brzo izdvojite stranice iz HTML datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt HTML stranica u Java"
description: "Izdvojite HTML stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt HTML stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz HTML datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti HTML stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte HTML stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite HTML stranica na mreži"
    content: |
       Izdvojite HTML stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html) web stranice.
