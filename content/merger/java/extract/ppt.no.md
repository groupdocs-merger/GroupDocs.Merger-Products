...
############################# Head ############################
head_title: "Trekk ut PPT sider i Java"
head_description: "Trekk ut sider raskt fra en PPT-fil i Java. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut PPT sider i Java"
description: "Trekk ut PPT sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Pakk ut PPT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å trekke ut de ønskede sidene fra en PPT-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut PPT filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Pakk ut PPT filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Trekk ut PPT-sider på nett"
    content: |
       Pakk ut PPT-filsider akkurat nå ved å besøke nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt).
