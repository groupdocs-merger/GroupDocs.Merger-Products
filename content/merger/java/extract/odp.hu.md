...
############################# Head ############################
head_title: "ODP oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy ODP fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "ODP oldal kibontása a Java nyelven"
description: "Bontsa ki az ODP oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODP fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy ODP fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az ODP fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – ODP oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp) webhely meglátogatásával azonnal kibonthatja az ODP fájloldalakat.
