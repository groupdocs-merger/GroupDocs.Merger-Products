...
############################# Head ############################
head_title: "Pura XLSM sivua Java"
head_description: "Pura sivut nopeasti XLSM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSM sivua Java"
description: "Pura XLSM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLSM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLSM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLSM sivua verkossa"
    content: |
       Pura XLSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm) -sivustolla.
