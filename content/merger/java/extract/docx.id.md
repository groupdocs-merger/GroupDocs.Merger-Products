...
############################# Head ############################
head_title: "Ekstrak DOCX Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file DOCX di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOCX Halaman Di Java"
description: "Ekstrak Halaman DOCX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File DOCX di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file DOCX dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file DOCX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak DOCX Halaman Online"
    content: |
       Ekstrak halaman file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/docx).
