...
############################# Head ############################
head_title: "Pura PPTX sivua Java"
head_description: "Pura sivut nopeasti PPTX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPTX sivua Java"
description: "Pura PPTX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura PPTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut PPTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPTX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura PPTX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura PPTX sivua verkossa"
    content: |
       Pura PPTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx) -sivustolla.
