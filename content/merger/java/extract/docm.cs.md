...
############################# Head ############################
head_title: "Extrahujte DOCM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru DOCM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte DOCM stránek v Java"
description: "Extrahujte DOCM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOCM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru DOCM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru DOCM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru DOCM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte DOCM stránek online"
    content: |
       Extrahujte stránky souborů DOCM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
