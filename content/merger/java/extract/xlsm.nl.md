...
############################# Head ############################
head_title: "Extraheer XLSM pagina's in Java"
head_description: "Extraheer snel pagina's uit een XLSM bestand in Java. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer XLSM pagina's in Java"
description: "Extraheer XLSM pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Pak XLSM Bestandspagina's uit in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om de gewenste pagina's uit een XLSM bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSM bestandspagina's te extraheren met behulp van Java voorbeeldcode">}}

        ```java    
        // Extraheer XLSM bestandspagina's met de GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live demo's - Extraheer XLSM pagina's online"
    content: |
       Pak nu XLSM bestandspagina's uit door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm) te gaan.
