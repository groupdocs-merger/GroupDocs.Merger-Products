...
############################# Head ############################
head_title: "Trekk ut XPS sider i Java"
head_description: "Trekk ut sider raskt fra en XPS-fil i Java. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut XPS sider i Java"
description: "Trekk ut XPS sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Pakk ut XPS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å trekke ut de ønskede sidene fra en XPS-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut XPS filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Pakk ut XPS filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Trekk ut XPS-sider på nett"
    content: |
       Pakk ut XPS-filsider akkurat nå ved å besøke nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps).
