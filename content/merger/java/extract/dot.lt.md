...
############################# Head ############################
head_title: "Išskleiskite DOT puslapius Java"
head_description: "Greitai išskleiskite puslapius iš DOT failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite DOT puslapius Java"
description: "Išskleiskite DOT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite DOT failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš DOT failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti DOT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite DOT failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite DOT puslapius internete"
    content: |
       Išskleiskite DOT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot) svetainėje.
