...
############################# Head ############################
head_title: "Ekstrak VSDM Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file VSDM di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VSDM Halaman Di Java"
description: "Ekstrak Halaman VSDM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File VSDM di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file VSDM dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file VSDM menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak halaman file VSDM menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak VSDM Halaman Online"
    content: |
       Ekstrak halaman file VSDM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/vsdm).
