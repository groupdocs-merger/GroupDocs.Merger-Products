...
############################# Head ############################
head_title: "Pura DOT sivua Java"
head_description: "Pura sivut nopeasti DOT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOT sivua Java"
description: "Pura DOT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura DOT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut DOT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura DOT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura DOT sivua verkossa"
    content: |
       Pura DOT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot) -sivustolla.
