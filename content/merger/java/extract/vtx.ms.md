...
############################# Head ############################
head_title: "Ekstrak VTX Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail VTX dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VTX Halaman Dalam Java"
description: "Ekstrak VTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak VTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail VTX dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak VTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak VTX halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak VTX Halaman Dalam Talian"
    content: |
       Ekstrak VTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx).
