...
############################# Head ############################
head_title: "Izvilkt DOTM lapas programmā Java"
head_description: "Ātri izvelciet lapas no DOTM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOTM lapas programmā Java"
description: "Izvelciet DOTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOTM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet DOTM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet DOTM lapas tiešsaistē"
    content: |
       Izņemiet DOTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
