...
############################# Head ############################
head_title: "Extrahujte PPT stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru PPT v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte PPT stránok v Java"
description: "Extrahujte PPT stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PPT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru PPT a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru PPT pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte PPT strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte PPT stránok online"
    content: |
       Rozbaľte stránky súboru PPT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt).
