...
############################# Head ############################
head_title: "Extrahujte DOTM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru DOTM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte DOTM stránek v Java"
description: "Extrahujte DOTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOTM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru DOTM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru DOTM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru DOTM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte DOTM stránek online"
    content: |
       Extrahujte stránky souborů DOTM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
