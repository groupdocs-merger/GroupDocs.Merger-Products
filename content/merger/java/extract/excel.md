...
############################# Head ############################
head_title: "Extract EXCEL Pages in Java"
head_description: "Quickly extract pages from a EXCEL file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract EXCEL Pages In Java"
description: "Extract EXCEL Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract EXCEL File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a EXCEL file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract EXCEL file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract EXCEL Pages Online"
    content: |
       Extract EXCEL file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/excel) website.
