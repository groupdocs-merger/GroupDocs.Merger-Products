...
############################# Head ############################
head_title: "Extract DOCX Pages in Java"
head_description: "Quickly extract pages from a DOCX file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract DOCX Pages In Java"
description: "Extract DOCX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract DOCX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a DOCX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract DOCX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract DOCX Pages Online"
    content: |
       Extract DOCX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx) website.
