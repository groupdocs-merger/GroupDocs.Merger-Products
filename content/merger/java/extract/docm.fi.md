...
############################# Head ############################
head_title: "Pura DOCM sivua Java"
head_description: "Pura sivut nopeasti DOCM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOCM sivua Java"
description: "Pura DOCM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura DOCM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut DOCM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOCM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura DOCM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura DOCM sivua verkossa"
    content: |
       Pura DOCM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm) -sivustolla.
