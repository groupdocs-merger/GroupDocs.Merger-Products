...
############################# Head ############################
head_title: "Ekstrak OTT Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail OTT dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak OTT Halaman Dalam Java"
description: "Ekstrak OTT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak OTT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail OTT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak OTT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak OTT halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak OTT Halaman Dalam Talian"
    content: |
       Ekstrak OTT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
