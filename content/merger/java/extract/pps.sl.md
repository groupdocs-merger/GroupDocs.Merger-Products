...
############################# Head ############################
head_title: "Ekstrahiraj PPS strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke PPS v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj PPS strani v Java"
description: "Izvlecite strani PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke PPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke PPS in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke PPS s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke PPS z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte PPS strani na spletu"
    content: |
       Ekstrahirajte strani datoteke PPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps).
