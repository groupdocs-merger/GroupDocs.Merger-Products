...
############################# Head ############################
head_title: "Ekstrahiraj DOC strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke DOC v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj DOC strani v Java"
description: "Izvlecite strani DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke DOC v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke DOC in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke DOC s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke DOC z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte DOC strani na spletu"
    content: |
       Ekstrahirajte strani datoteke DOC tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
