...
############################# Head ############################
head_title: "Pura XLAM sivua Java"
head_description: "Pura sivut nopeasti XLAM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLAM sivua Java"
description: "Pura XLAM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLAM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLAM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLAM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLAM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLAM sivua verkossa"
    content: |
       Pura XLAM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) -sivustolla.
