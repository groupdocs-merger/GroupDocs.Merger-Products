...
############################# Head ############################
head_title: "Ekstrak DOC Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail DOC dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOC Halaman Dalam Java"
description: "Ekstrak DOC Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak DOC Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail DOC dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak DOC halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak DOC halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak DOC Halaman Dalam Talian"
    content: |
       Ekstrak DOC halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
