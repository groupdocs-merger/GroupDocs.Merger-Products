...
############################# Head ############################
head_title: "Pura VDX sivua Java"
head_description: "Pura sivut nopeasti VDX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VDX sivua Java"
description: "Pura VDX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VDX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VDX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VDX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VDX sivua verkossa"
    content: |
       Pura VDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx) -sivustolla.
