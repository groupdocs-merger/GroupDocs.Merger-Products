...
############################# Head ############################
head_title: "Pura VSTX sivua Java"
head_description: "Pura sivut nopeasti VSTX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSTX sivua Java"
description: "Pura VSTX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VSTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VSTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSTX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VSTX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VSTX sivua verkossa"
    content: |
       Pura VSTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx) -sivustolla.
