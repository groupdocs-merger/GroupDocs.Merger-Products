...
############################# Head ############################
head_title: "Wyodrębnij strony XLSX w Java"
head_description: "Szybko wyodrębnij strony z pliku XLSX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLSX strony w Java"
description: "Wyodrębnij strony XLSX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku XLSX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku XLSX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij XLSX strony online"
    content: |
       Wyodrębnij strony plików XLSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
