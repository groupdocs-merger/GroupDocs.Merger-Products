...
############################# Head ############################
head_title: "Java ішіндегі PPS беттерді шығарып алу"
head_description: "Java ішіндегі PPS файлынан беттерді жылдам шығарып алыңыз. Таңдалған беттерді қамтитын жаңа құжатты құжаттарды біріктіру API арқылы сақтаңыз."

############################# Header ############################
title: "PPS беттерді Java ішінен шығарып алу"
description: "PPS Java кодының бірнеше жолы бар PPS беттерді шығарып алыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі PPS файл беттерін шығарып алыңыз"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне PPS файлынан қажетті беттерді шығарып, оны келесідей сақтауды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы таңдалған беттерді қамтитын жаңа файл.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS файл беттерін Java мысал кодын пайдаланып шығару жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы PPS файл бетін шығарып алыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - PPS беттерді желіден шығарып алыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps) веб-сайтына кіру арқылы PPS файл бетін дәл қазір шығарып алыңыз.
