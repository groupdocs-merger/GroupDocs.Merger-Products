...
############################# Head ############################
head_title: "Išskleiskite PDF puslapius Java"
head_description: "Greitai išskleiskite puslapius iš PDF failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite PDF puslapius Java"
description: "Išskleiskite PDF puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite PDF failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš PDF failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti PDF failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite PDF failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite PDF puslapius internete"
    content: |
       Išskleiskite PDF failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf) svetainėje.
