...
############################# Head ############################
head_title: "Extrahujte OTP stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru OTP v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte OTP stránek v Java"
description: "Extrahujte OTP stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte OTP stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru OTP a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru OTP pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru OTP pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte OTP stránek online"
    content: |
       Extrahujte stránky souborů OTP právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
