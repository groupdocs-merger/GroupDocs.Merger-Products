...
############################# Head ############################
head_title: "Ekstrakt PPSX stranica u Java"
head_description: "Brzo izdvojite stranice iz PPSX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt PPSX stranica u Java"
description: "Izdvojite PPSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt PPSX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz PPSX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti PPSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte PPSX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite PPSX stranica na mreži"
    content: |
       Izdvojite PPSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx) web stranice.
