...
############################# Head ############################
head_title: "XLS oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLS fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLS oldal kibontása a Java nyelven"
description: "Bontsa ki az XLS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLS fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLS fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLS fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLS oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xls) webhely meglátogatásával azonnal kibonthatja az XLS fájloldalakat.
