...
############################# Head ############################
head_title: "Extrahujte OTT stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru OTT v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte OTT stránek v Java"
description: "Extrahujte OTT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte OTT stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru OTT a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru OTT pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru OTT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte OTT stránek online"
    content: |
       Extrahujte stránky souborů OTT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
