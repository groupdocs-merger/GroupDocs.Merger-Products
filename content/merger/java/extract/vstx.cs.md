...
############################# Head ############################
head_title: "Extrahujte VSTX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VSTX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VSTX stránek v Java"
description: "Extrahujte VSTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSTX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VSTX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VSTX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VSTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VSTX stránek online"
    content: |
       Extrahujte stránky souborů VSTX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx).
