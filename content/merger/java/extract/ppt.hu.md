...
############################# Head ############################
head_title: "PPT oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy PPT fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "PPT oldal kibontása a Java nyelven"
description: "Bontsa ki az PPT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPT fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy PPT fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPT fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az PPT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – PPT oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt) webhely meglátogatásával azonnal kibonthatja az PPT fájloldalakat.
