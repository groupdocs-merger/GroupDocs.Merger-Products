...
############################# Head ############################
head_title: "Extrahera VSDM sidor i Java"
head_description: "Extrahera snabbt sidor från en VSDM-fil i Java. Spara det nya dokumentet som innehåller de valda sidorna med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Extrahera VSDM sidor i Java"
description: "Extrahera VSDM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Extrahera VSDM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att extrahera önskade sidor från en VSDM-fil och spara den som en ny fil som innehåller de valda sidorna genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man extraherar VSDM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Extrahera VSDM filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Extrahera VSDM sidor online"
    content: |
       Extrahera VSDM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm).
