...
############################# Head ############################
head_title: "Extraer TEX páginas en Java"
head_description: "Extraiga rápidamente páginas de un archivo TEX en Java. Guarde el nuevo documento que contiene las páginas seleccionadas utilizando la API de fusión de documentos."

############################# Header ############################
title: "Extraer TEX páginas en Java"
description: "Extrae TEX páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Extraer TEX páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java extraer las páginas deseadas de un archivo TEX y guardarlo como un nuevo archivo que contiene las páginas seleccionadas mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo extraer páginas de archivos TEX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga TEX páginas de archivo usando GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demostraciones en vivo: extraiga TEX páginas en línea"
    content: |
       Extraiga páginas de archivos TEX ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex).
