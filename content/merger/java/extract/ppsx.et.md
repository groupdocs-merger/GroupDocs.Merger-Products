...
############################# Head ############################
head_title: "Ekstraheerige PPSX lehte Java"
head_description: "Eksportige kiiresti lehed PPSX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige PPSX lehte rakenduses Java"
description: "Ekstraheerige PPSX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige PPSX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist PPSX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili PPSX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili PPSX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis PPSX lehekülge"
    content: |
       Ekstraktige kohe PPSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx).
