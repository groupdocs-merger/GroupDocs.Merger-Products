...
############################# Head ############################
head_title: "Pura VSDX sivua Java"
head_description: "Pura sivut nopeasti VSDX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSDX sivua Java"
description: "Pura VSDX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VSDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VSDX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSDX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VSDX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VSDX sivua verkossa"
    content: |
       Pura VSDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx) -sivustolla.
