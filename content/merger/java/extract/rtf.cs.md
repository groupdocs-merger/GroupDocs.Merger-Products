...
############################# Head ############################
head_title: "Extrahujte RTF stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru RTF v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte RTF stránek v Java"
description: "Extrahujte RTF stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte RTF stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru RTF a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru RTF pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru RTF pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte RTF stránek online"
    content: |
       Extrahujte stránky souborů RTF právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf).
