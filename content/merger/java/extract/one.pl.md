...
############################# Head ############################
head_title: "Wyodrębnij strony ONE w Java"
head_description: "Szybko wyodrębnij strony z pliku ONE w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij ONE strony w Java"
description: "Wyodrębnij strony ONE z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików ONE w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku ONE i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku ONE za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku ONE za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij ONE strony online"
    content: |
       Wyodrębnij strony plików ONE już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
