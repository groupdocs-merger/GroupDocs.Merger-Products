...
############################# Head ############################
head_title: "Pura XLTM sivua Java"
head_description: "Pura sivut nopeasti XLTM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLTM sivua Java"
description: "Pura XLTM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLTM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLTM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLTM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLTM sivua verkossa"
    content: |
       Pura XLTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltm) -sivustolla.
