...
############################# Head ############################
head_title: "Ekstrahiraj DOCM strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke DOCM v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj DOCM strani v Java"
description: "Izvlecite strani DOCM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke DOCM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke DOCM in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke DOCM s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke DOCM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte DOCM strani na spletu"
    content: |
       Ekstrahirajte strani datoteke DOCM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
