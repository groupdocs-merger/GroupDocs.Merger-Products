...
############################# Head ############################
head_title: "Ekstrakt XLTX stranica u Java"
head_description: "Brzo izdvojite stranice iz XLTX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt XLTX stranica u Java"
description: "Izdvojite XLTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt XLTX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz XLTX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti XLTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte XLTX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite XLTX stranica na mreži"
    content: |
       Izdvojite XLTX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx) web stranice.
