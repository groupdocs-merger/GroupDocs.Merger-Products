...
############################# Head ############################
head_title: "Išskleiskite EPUB puslapius Java"
head_description: "Greitai išskleiskite puslapius iš EPUB failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite EPUB puslapius Java"
description: "Išskleiskite EPUB puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite EPUB failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš EPUB failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti EPUB failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite EPUB failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite EPUB puslapius internete"
    content: |
       Išskleiskite EPUB failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub) svetainėje.
