...
############################# Head ############################
head_title: "Bain DOCX Leathanaigh as Java"
head_description: "Bain go tapa leathanaigh as comhad DOCX in Java. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain DOCX Leathanaigh I Java"
description: "Sliocht DOCX Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain DOCX Leathanaigh Chomhad as Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java na leathanaigh atá ag teastáil a bhaint as comhad DOCX agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOCX a bhaint as trí úsáid a bhaint as cód samplach Java">}}

        ```java    
        // Bain leathanaigh comhad DOCX ag úsáid GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Sliocht DOCX Leathanaigh Ar Líne"
    content: |
       Bain DOCX leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx) láithreán gréasáin.
