...
############################# Head ############################
head_title: "Wyodrębnij strony PPSX w Java"
head_description: "Szybko wyodrębnij strony z pliku PPSX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij PPSX strony w Java"
description: "Wyodrębnij strony PPSX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików PPSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku PPSX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku PPSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku PPSX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij PPSX strony online"
    content: |
       Wyodrębnij strony plików PPSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx).
