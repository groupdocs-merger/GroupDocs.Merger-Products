...
############################# Head ############################
head_title: "Wyodrębnij strony MHTML w Java"
head_description: "Szybko wyodrębnij strony z pliku MHTML w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij MHTML strony w Java"
description: "Wyodrębnij strony MHTML z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików MHTML w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku MHTML i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku MHTML za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku MHTML za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij MHTML strony online"
    content: |
       Wyodrębnij strony plików MHTML już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
