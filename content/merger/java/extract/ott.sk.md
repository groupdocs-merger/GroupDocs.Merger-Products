...
############################# Head ############################
head_title: "Extrahujte OTT stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru OTT v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte OTT stránok v Java"
description: "Extrahujte OTT stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte OTT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru OTT a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru OTT pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte OTT strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte OTT stránok online"
    content: |
       Rozbaľte stránky súboru OTT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
