...
############################# Head ############################
head_title: "Ekstrak OTP Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file OTP di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak OTP Halaman Di Java"
description: "Ekstrak Halaman OTP dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File OTP di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file OTP dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file OTP menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak OTP Halaman Online"
    content: |
       Ekstrak halaman file OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/otp).
