...
############################# Head ############################
head_title: "Pura DOTX sivua Java"
head_description: "Pura sivut nopeasti DOTX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOTX sivua Java"
description: "Pura DOTX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura DOTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut DOTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOTX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura DOTX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura DOTX sivua verkossa"
    content: |
       Pura DOTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx) -sivustolla.
