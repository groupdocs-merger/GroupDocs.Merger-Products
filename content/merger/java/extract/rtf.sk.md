...
############################# Head ############################
head_title: "Extrahujte RTF stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru RTF v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte RTF stránok v Java"
description: "Extrahujte RTF stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte RTF strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru RTF a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru RTF pomocou vzorového kódu Java">}}
