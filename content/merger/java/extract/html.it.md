...
############################# Head ############################
head_title: "Estrai HTML pagine in Java"
head_description: "Estrai rapidamente le pagine da un file HTML in Java. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai HTML pagine in Java"
description: "Estrai HTML pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Estrai HTML pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di estrarre facilmente le pagine desiderate da un file HTML e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file HTML utilizzando il codice di esempio Java">}}

        ```java    
        // Estrai HTML pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo dal vivo - Estrai HTML pagine online"
    content: |
       Estrai subito HTML pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html).
