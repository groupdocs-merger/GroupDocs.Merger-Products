...
############################# Head ############################
head_title: "Java İçindeki ONE Sayfayı Çıkarın"
head_description: "Sayfaları bir ONE dosyasından Java içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "Java İçindeki ONE Sayfayı Çıkarın"
description: "ONE Sayfalarını birkaç satır Java koduyla çıkarın."
...
steps:
    enable: true
    title_left: "Java içindeki ONE Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin bir ONE dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ONE dosya sayfaları nasıl ayıklanır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ONE dosya sayfalarını çıkarın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi ONE Sayfayı Çıkarın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one) web sitesini ziyaret ederek ONE dosya sayfalarını hemen çıkarın.
