...
############################# Head ############################
head_title: "Pura EPUB sivua Java"
head_description: "Pura sivut nopeasti EPUB-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura EPUB sivua Java"
description: "Pura EPUB sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura EPUB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut EPUB-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa EPUB tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura EPUB tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura EPUB sivua verkossa"
    content: |
       Pura EPUB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub) -sivustolla.
