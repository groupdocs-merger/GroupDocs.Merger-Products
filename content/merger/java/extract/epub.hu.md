...
############################# Head ############################
head_title: "EPUB oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy EPUB fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "EPUB oldal kibontása a Java nyelven"
description: "Bontsa ki az EPUB oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "EPUB fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy EPUB fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az EPUB fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – EPUB oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub) webhely meglátogatásával azonnal kibonthatja az EPUB fájloldalakat.
