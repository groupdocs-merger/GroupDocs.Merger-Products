...
############################# Head ############################
head_title: "VDX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VDX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VDX oldal kibontása a Java nyelven"
description: "Bontsa ki az VDX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VDX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VDX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VDX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VDX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx) webhely meglátogatásával azonnal kibonthatja az VDX fájloldalakat.
