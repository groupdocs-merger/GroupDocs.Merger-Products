...
############################# Head ############################
head_title: "Ekstrak ODP Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail ODP dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODP Halaman Dalam Java"
description: "Ekstrak ODP Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak ODP Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail ODP dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ODP halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak ODP halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak ODP Halaman Dalam Talian"
    content: |
       Ekstrak ODP halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
