...
############################# Head ############################
head_title: "VSDM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VSDM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VSDM oldal kibontása a Java nyelven"
description: "Bontsa ki az VSDM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSDM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VSDM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VSDM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VSDM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm) webhely meglátogatásával azonnal kibonthatja az VSDM fájloldalakat.
