...
############################# Head ############################
head_title: "Extract VSSM Pages in Java"
head_description: "Quickly extract pages from a VSSM file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract VSSM Pages In Java"
description: "Extract VSSM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract VSSM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a VSSM file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract VSSM file pages using Java example code">}}

        ```java    
        // Extract VSSM file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Extract VSSM Pages Online"
    content: |
       Extract VSSM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm) website.
