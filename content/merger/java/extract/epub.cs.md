...
############################# Head ############################
head_title: "Extrahujte EPUB stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru EPUB v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte EPUB stránek v Java"
description: "Extrahujte EPUB stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte EPUB stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru EPUB a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru EPUB pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru EPUB pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte EPUB stránek online"
    content: |
       Extrahujte stránky souborů EPUB právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
