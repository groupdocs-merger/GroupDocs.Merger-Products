...
############################# Head ############################
head_title: "Izvilkt VDX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VDX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VDX lapas programmā Java"
description: "Izvelciet VDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VDX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VDX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VDX lapas tiešsaistē"
    content: |
       Izņemiet VDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx).
