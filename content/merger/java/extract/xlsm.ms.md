...
############################# Head ############################
head_title: "Ekstrak XLSM Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail XLSM dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLSM Halaman Dalam Java"
description: "Ekstrak XLSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak XLSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail XLSM dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak XLSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak XLSM halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak XLSM Halaman Dalam Talian"
    content: |
       Ekstrak XLSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
