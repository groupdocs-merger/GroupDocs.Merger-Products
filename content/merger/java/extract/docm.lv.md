...
############################# Head ############################
head_title: "Izvilkt DOCM lapas programmā Java"
head_description: "Ātri izvelciet lapas no DOCM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOCM lapas programmā Java"
description: "Izvelciet DOCM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOCM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOCM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOCM faila lapas, izmantojot Java piemēra kodu">}}
