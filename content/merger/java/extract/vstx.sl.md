...
############################# Head ############################
head_title: "Ekstrahiraj VSTX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke VSTX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj VSTX strani v Java"
description: "Izvlecite strani VSTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke VSTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke VSTX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke VSTX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke VSTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte VSTX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke VSTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx).
