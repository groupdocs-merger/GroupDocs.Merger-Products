...
############################# Head ############################
head_title: "Pura ODT sivua Java"
head_description: "Pura sivut nopeasti ODT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ODT sivua Java"
description: "Pura ODT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura ODT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut ODT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ODT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura ODT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura ODT sivua verkossa"
    content: |
       Pura ODT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt) -sivustolla.
