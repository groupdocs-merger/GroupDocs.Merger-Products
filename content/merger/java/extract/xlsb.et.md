...
############################# Head ############################
head_title: "Ekstraheerige XLSB lehte Java"
head_description: "Eksportige kiiresti lehed XLSB failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLSB lehte rakenduses Java"
description: "Ekstraheerige XLSB lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLSB faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist XLSB ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLSB lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili XLSB lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis XLSB lehekülge"
    content: |
       Ekstraktige kohe XLSB faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb).
