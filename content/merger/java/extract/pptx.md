...
head_description: "Quickly extract pages from a PPTX file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract PPTX Pages In Java"
description: "Extract PPTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract PPTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a PPTX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract PPTX file pages using Java example code">}}
