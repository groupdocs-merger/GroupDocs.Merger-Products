...
############################# Head ############################
head_title: "Ekstraheerige DOC lehte Java"
head_description: "Eksportige kiiresti lehed DOC failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige DOC lehte rakenduses Java"
description: "Ekstraheerige DOC lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige DOC faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist DOC ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili DOC lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili DOC lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis DOC lehekülge"
    content: |
       Ekstraktige kohe DOC faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
