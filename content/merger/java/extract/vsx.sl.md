...
############################# Head ############################
head_title: "Ekstrahiraj VSX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke VSX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj VSX strani v Java"
description: "Izvlecite strani VSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke VSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke VSX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke VSX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke VSX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte VSX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke VSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsx).
