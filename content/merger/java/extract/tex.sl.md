...
############################# Head ############################
head_title: "Ekstrahiraj TEX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke TEX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj TEX strani v Java"
description: "Izvlecite strani TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke TEX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke TEX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke TEX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke TEX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte TEX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke TEX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex).
