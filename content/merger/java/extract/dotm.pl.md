...
############################# Head ############################
head_title: "Wyodrębnij strony DOTM w Java"
head_description: "Szybko wyodrębnij strony z pliku DOTM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOTM strony w Java"
description: "Wyodrębnij strony DOTM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku DOTM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOTM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku DOTM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij DOTM strony online"
    content: |
       Wyodrębnij strony plików DOTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
