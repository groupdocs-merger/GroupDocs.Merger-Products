...
############################# Head ############################
head_title: "Ekstraheerige ODS lehte Java"
head_description: "Eksportige kiiresti lehed ODS failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige ODS lehte rakenduses Java"
description: "Ekstraheerige ODS lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige ODS faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist ODS ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili ODS lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili ODS lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis ODS lehekülge"
    content: |
       Ekstraktige kohe ODS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods).
