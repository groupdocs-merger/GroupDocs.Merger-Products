...
############################# Head ############################
head_title: "PPTX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy PPTX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "PPTX oldal kibontása a Java nyelven"
description: "Bontsa ki az PPTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPTX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy PPTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az PPTX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – PPTX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx) webhely meglátogatásával azonnal kibonthatja az PPTX fájloldalakat.
