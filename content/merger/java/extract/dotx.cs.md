...
############################# Head ############################
head_title: "Extrahujte DOTX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru DOTX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte DOTX stránek v Java"
description: "Extrahujte DOTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOTX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru DOTX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru DOTX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru DOTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte DOTX stránek online"
    content: |
       Extrahujte stránky souborů DOTX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx).
