...
############################# Head ############################
head_title: "Pura XLS sivua Java"
head_description: "Pura sivut nopeasti XLS-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLS sivua Java"
description: "Pura XLS sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLS tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLS tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLS sivua verkossa"
    content: |
       Pura XLS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xls) -sivustolla.
