...
############################# Head ############################
head_title: "Extrahujte EPUB stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru EPUB v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte EPUB stránok v Java"
description: "Extrahujte EPUB stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte EPUB strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru EPUB a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru EPUB pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte EPUB strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte EPUB stránok online"
    content: |
       Rozbaľte stránky súboru EPUB hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
