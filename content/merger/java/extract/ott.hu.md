...
############################# Head ############################
head_title: "OTT oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy OTT fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "OTT oldal kibontása a Java nyelven"
description: "Bontsa ki az OTT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "OTT fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy OTT fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az OTT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – OTT oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott) webhely meglátogatásával azonnal kibonthatja az OTT fájloldalakat.
