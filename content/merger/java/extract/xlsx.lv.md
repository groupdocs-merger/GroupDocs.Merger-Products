...
############################# Head ############################
head_title: "Izvilkt XLSX lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLSX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLSX lapas programmā Java"
description: "Izvelciet XLSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLSX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLSX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLSX lapas tiešsaistē"
    content: |
       Izņemiet XLSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
