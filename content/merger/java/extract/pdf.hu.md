...
############################# Head ############################
head_title: "PDF oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy PDF fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "PDF oldal kibontása a Java nyelven"
description: "Bontsa ki az PDF oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PDF fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy PDF fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az PDF fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – PDF oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf) webhely meglátogatásával azonnal kibonthatja az PDF fájloldalakat.
