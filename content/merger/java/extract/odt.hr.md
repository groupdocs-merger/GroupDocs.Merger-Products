...
############################# Head ############################
head_title: "Ekstrakt ODT stranica u Java"
head_description: "Brzo izdvojite stranice iz ODT datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt ODT stranica u Java"
description: "Izdvojite ODT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt ODT stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz ODT datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti ODT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte ODT stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite ODT stranica na mreži"
    content: |
       Izdvojite ODT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt) web stranice.
