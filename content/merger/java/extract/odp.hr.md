...
############################# Head ############################
head_title: "Ekstrakt ODP stranica u Java"
head_description: "Brzo izdvojite stranice iz ODP datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt ODP stranica u Java"
description: "Izdvojite ODP stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt ODP stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz ODP datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti ODP stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte ODP stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite ODP stranica na mreži"
    content: |
       Izdvojite ODP stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp) web stranice.
