...
############################# Head ############################
head_title: "Išskleiskite DOCM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš DOCM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite DOCM puslapius Java"
description: "Išskleiskite DOCM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite DOCM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš DOCM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti DOCM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite DOCM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite DOCM puslapius internete"
    content: |
       Išskleiskite DOCM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm) svetainėje.
