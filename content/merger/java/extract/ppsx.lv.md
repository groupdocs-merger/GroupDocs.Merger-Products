...
############################# Head ############################
head_title: "Izvilkt PPSX lapas programmā Java"
head_description: "Ātri izvelciet lapas no PPSX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt PPSX lapas programmā Java"
description: "Izvelciet PPSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt PPSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila PPSX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt PPSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet PPSX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet PPSX lapas tiešsaistē"
    content: |
       Izņemiet PPSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx).
