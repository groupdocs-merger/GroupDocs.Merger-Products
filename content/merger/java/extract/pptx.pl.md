...
############################# Head ############################
head_title: "Wyodrębnij strony PPTX w Java"
head_description: "Szybko wyodrębnij strony z pliku PPTX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij PPTX strony w Java"
description: "Wyodrębnij strony PPTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików PPTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku PPTX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku PPTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku PPTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij PPTX strony online"
    content: |
       Wyodrębnij strony plików PPTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
