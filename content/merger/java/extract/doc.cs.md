...
############################# Head ############################
head_title: "Extrahujte DOC stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru DOC v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte DOC stránek v Java"
description: "Extrahujte DOC stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOC stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru DOC a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru DOC pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru DOC pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte DOC stránek online"
    content: |
       Extrahujte stránky souborů DOC právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
