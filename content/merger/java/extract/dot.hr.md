...
############################# Head ############################
head_title: "Ekstrakt DOT stranica u Java"
head_description: "Brzo izdvojite stranice iz DOT datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOT stranica u Java"
description: "Izdvojite DOT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOT stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz DOT datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte DOT stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite DOT stranica na mreži"
    content: |
       Izdvojite DOT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot) web stranice.
