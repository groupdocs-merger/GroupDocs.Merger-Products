...
############################# Head ############################
head_title: "Extrahujte PPSX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru PPSX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte PPSX stránek v Java"
description: "Extrahujte PPSX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PPSX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru PPSX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru PPSX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru PPSX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte PPSX stránek online"
    content: |
       Extrahujte stránky souborů PPSX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx).
