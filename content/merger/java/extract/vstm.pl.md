...
############################# Head ############################
head_title: "Wyodrębnij strony VSTM w Java"
head_description: "Szybko wyodrębnij strony z pliku VSTM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VSTM strony w Java"
description: "Wyodrębnij strony VSTM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VSTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku VSTM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VSTM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku VSTM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij VSTM strony online"
    content: |
       Wyodrębnij strony plików VSTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm).
