...
############################# Head ############################
head_title: "Ekstraheerige VSTX lehte Java"
head_description: "Eksportige kiiresti lehed VSTX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSTX lehte rakenduses Java"
description: "Ekstraheerige VSTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSTX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VSTX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSTX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VSTX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VSTX lehekülge"
    content: |
       Ekstraktige kohe VSTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx).
