...
############################# Head ############################
head_title: "VTX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VTX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VTX oldal kibontása a Java nyelven"
description: "Bontsa ki az VTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VTX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VTX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VTX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx) webhely meglátogatásával azonnal kibonthatja az VTX fájloldalakat.
