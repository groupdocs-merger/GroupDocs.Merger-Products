...
############################# Head ############################
head_title: "Pura VTX sivua Java"
head_description: "Pura sivut nopeasti VTX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VTX sivua Java"
description: "Pura VTX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VTX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VTX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VTX sivua verkossa"
    content: |
       Pura VTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx) -sivustolla.
