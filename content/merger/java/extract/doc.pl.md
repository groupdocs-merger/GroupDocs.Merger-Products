...
############################# Head ############################
head_title: "Wyodrębnij strony DOC w Java"
head_description: "Szybko wyodrębnij strony z pliku DOC w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOC strony w Java"
description: "Wyodrębnij strony DOC z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOC w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku DOC i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOC za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku DOC za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij DOC strony online"
    content: |
       Wyodrębnij strony plików DOC już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
