...
############################# Head ############################
head_title: "Izvilkt ODS lapas programmā Java"
head_description: "Ātri izvelciet lapas no ODS faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt ODS lapas programmā Java"
description: "Izvelciet ODS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt ODS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila ODS un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt ODS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet ODS faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet ODS lapas tiešsaistē"
    content: |
       Izņemiet ODS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods).
