...
############################# Head ############################
head_title: "Išskleiskite XLS puslapius Java"
head_description: "Greitai išskleiskite puslapius iš XLS failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLS puslapius Java"
description: "Išskleiskite XLS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLS failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš XLS failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite XLS failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite XLS puslapius internete"
    content: |
       Išskleiskite XLS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xls) svetainėje.
