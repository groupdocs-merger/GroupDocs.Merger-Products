...
############################# Head ############################
head_title: "Extrahujte DOTX stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru DOTX v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte DOTX stránok v Java"
description: "Extrahujte DOTX stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru DOTX a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru DOTX pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte DOTX strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte DOTX stránok online"
    content: |
       Rozbaľte stránky súboru DOTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx).
