...
############################# Head ############################
head_title: "Ekstrahiraj XLTX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke XLTX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj XLTX strani v Java"
description: "Izvlecite strani XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke XLTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke XLTX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke XLTX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke XLTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte XLTX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke XLTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx).
