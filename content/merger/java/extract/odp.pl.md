...
############################# Head ############################
head_title: "Wyodrębnij strony ODP w Java"
head_description: "Szybko wyodrębnij strony z pliku ODP w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij ODP strony w Java"
description: "Wyodrębnij strony ODP z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików ODP w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku ODP i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku ODP za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku ODP za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij ODP strony online"
    content: |
       Wyodrębnij strony plików ODP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
