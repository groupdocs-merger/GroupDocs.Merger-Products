...
############################# Head ############################
head_title: "Onttrek XLAM bladsye in Java"
head_description: "Onttrek bladsye vinnig uit 'n XLAM-lêer in Java. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek XLAM bladsye in Java"
description: "Onttrek XLAM Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Onttrek XLAM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om die verlangde bladsye uit 'n XLAM-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLAM lêerbladsye te onttrek deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Onttrek XLAM lêerbladsye met GroupDocs.Merger API
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Onttrek XLAM bladsye aanlyn"
    content: |
       Onttrek XLAM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) webwerf te besoek.
