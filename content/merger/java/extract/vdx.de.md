...
############################# Head ############################
head_title: "Extrahiere VDX Seiten in Java"
head_description: "Extrahieren Sie schnell Seiten aus einer VDX-Datei in Java. Speichern Sie das neue Dokument mit den ausgewählten Seiten mithilfe der Documents Merger API."

############################# Header ############################
title: "Extrahiere VDX Seiten in Java"
description: "Extrahieren Sie VDX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VDX Dateiseiten in Java extrahieren"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, die gewünschten Seiten aus einer VDX-Datei zu extrahieren und als zu speichern eine neue Datei mit den ausgewählten Seiten, indem Sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So extrahieren Sie VDX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie VDX-Dateiseiten mit der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Extrahieren Sie VDX Seiten online"
    content: |
       Extrahieren Sie jetzt VDX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx) besuchen.
