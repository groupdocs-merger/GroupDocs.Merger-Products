...
############################# Head ############################
head_title: "Pura XLSB sivua Java"
head_description: "Pura sivut nopeasti XLSB-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSB sivua Java"
description: "Pura XLSB sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLSB-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSB tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLSB tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLSB sivua verkossa"
    content: |
       Pura XLSB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb) -sivustolla.
