...
############################# Head ############################
head_title: "Արտահանել PDF էջ Java-ում"
head_description: "Արագ հանեք էջերը PDF ֆայլից Java-ում: Պահպանեք ընտրված էջերը պարունակող նոր փաստաթուղթը՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Արտահանել PDF էջ Java-ում"
description: "Հանեք PDF էջեր Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Արտահանել PDF ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար ցանկալի էջերը հանել PDF ֆայլից և պահպանել այն որպես ընտրված էջերը պարունակող նոր ֆայլ՝ կատարելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հանել PDF ֆայլի էջեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Արտահանեք PDF ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ. հանեք PDF էջեր առցանց"
    content: |
       Հանեք PDF ֆայլի էջեր հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/exttract-pages/pdf) կայքը:
