...
############################# Head ############################
head_title: "Extract XLS Pages in Java"
head_description: "Quickly extract pages from a XLS file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract XLS Pages In Java"
description: "Extract XLS Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract XLS File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a XLS file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract XLS file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract XLS Pages Online"
    content: |
       Extract XLS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xls) website.
