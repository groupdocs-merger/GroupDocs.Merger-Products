...
############################# Head ############################
head_title: "Extraer VDX páginas en Java"
head_description: "Extraiga rápidamente páginas de un archivo VDX en Java. Guarde el nuevo documento que contiene las páginas seleccionadas utilizando la API de fusión de documentos."

############################# Header ############################
title: "Extraer VDX páginas en Java"
description: "Extrae VDX páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Extraer VDX páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java extraer las páginas deseadas de un archivo VDX y guardarlo como un nuevo archivo que contiene las páginas seleccionadas mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo extraer páginas de archivos VDX usando el código de ejemplo Java">}}

        ```java    
        // Extraiga VDX páginas de archivo usando GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demostraciones en vivo: extraiga VDX páginas en línea"
    content: |
       Extraiga páginas de archivos VDX ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx).
