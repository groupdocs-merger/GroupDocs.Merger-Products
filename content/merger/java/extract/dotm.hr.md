...
############################# Head ############################
head_title: "Ekstrakt DOTM stranica u Java"
head_description: "Brzo izdvojite stranice iz DOTM datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOTM stranica u Java"
description: "Izdvojite DOTM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOTM stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz DOTM datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOTM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte DOTM stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite DOTM stranica na mreži"
    content: |
       Izdvojite DOTM stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm) web stranice.
