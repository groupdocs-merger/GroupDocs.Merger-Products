...
############################# Head ############################
head_title: "Ekstrakt MHTML stranica u Java"
head_description: "Brzo izdvojite stranice iz MHTML datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt MHTML stranica u Java"
description: "Izdvojite MHTML stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt MHTML stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz MHTML datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti MHTML stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte MHTML stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite MHTML stranica na mreži"
    content: |
       Izdvojite MHTML stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml) web stranice.
