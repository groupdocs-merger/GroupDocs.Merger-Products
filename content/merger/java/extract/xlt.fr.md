...
############################# Head ############################
head_title: "Extraire XLT pages en Java"
head_description: "Extrayez rapidement des pages d'un fichier XLT en Java. Enregistrez le nouveau document contenant les pages sélectionnées à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Extraire XLT pages dans Java"
description: "Extrayez XLT pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Extraire XLT pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java d'extraire facilement les pages souhaitées d'un fichier XLT et de l'enregistrer sous un nouveau fichier contenant les pages sélectionnées en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment extraire les pages de fichier XLT à l'aide de l'exemple de code Java">}}
