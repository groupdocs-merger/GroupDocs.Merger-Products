...
############################# Head ############################
head_title: "Ekstraheerige ODP lehte Java"
head_description: "Eksportige kiiresti lehed ODP failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige ODP lehte rakenduses Java"
description: "Ekstraheerige ODP lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige ODP faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist ODP ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili ODP lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili ODP lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis ODP lehekülge"
    content: |
       Ekstraktige kohe ODP faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
