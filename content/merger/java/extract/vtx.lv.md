...
############################# Head ############################
head_title: "Izvilkt VTX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VTX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VTX lapas programmā Java"
description: "Izvelciet VTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VTX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VTX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VTX lapas tiešsaistē"
    content: |
       Izņemiet VTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx).
