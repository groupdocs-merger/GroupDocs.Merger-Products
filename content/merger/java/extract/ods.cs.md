...
############################# Head ############################
head_title: "Extrahujte ODS stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru ODS v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte ODS stránek v Java"
description: "Extrahujte ODS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte ODS stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru ODS a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru ODS pomocí ukázkového kódu Java">}}
