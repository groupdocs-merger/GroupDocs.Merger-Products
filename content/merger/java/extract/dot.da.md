...
############################# Head ############################
head_title: "Udpak DOT sider i Java"
head_description: "Udpak hurtigt sider fra en DOT-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak DOT sider i Java"
description: "Udpak DOT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak DOT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en DOT-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes DOT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Udpak DOT filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Udpak DOT sider online"
    content: |
       Udpak DOT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot).
