...
############################# Head ############################
head_title: "ONE oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy ONE fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "ONE oldal kibontása a Java nyelven"
description: "Bontsa ki az ONE oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ONE fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy ONE fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az ONE fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – ONE oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one) webhely meglátogatásával azonnal kibonthatja az ONE fájloldalakat.
