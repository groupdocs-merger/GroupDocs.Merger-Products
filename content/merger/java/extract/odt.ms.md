...
############################# Head ############################
head_title: "Ekstrak ODT Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail ODT dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODT Halaman Dalam Java"
description: "Ekstrak ODT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak ODT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail ODT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ODT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak ODT halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak ODT Halaman Dalam Talian"
    content: |
       Ekstrak ODT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
