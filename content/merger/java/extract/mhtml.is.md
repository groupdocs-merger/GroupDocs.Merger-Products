...
############################# Head ############################
head_title: "Dragðu út MHTML síður í Java"
head_description: "Dragðu síður út á fljótlegan hátt úr MHTML skrá í Java. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út MHTML síður í Java"
description: "Dragðu út MHTML síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Dragðu út MHTML skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar forriturum Java að draga þær síður sem óskað er eftir úr MHTML skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út MHTML skráarsíður með því að nota Java dæmi kóða">}}

        ```java    
        // Dragðu út MHTML skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Dragðu út MHTML síður á netinu"
    content: |
       Dragðu út MHTML skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
