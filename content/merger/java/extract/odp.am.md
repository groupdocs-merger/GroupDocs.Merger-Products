...
############################# Head ############################
head_title: "ODP ገጾችን በJava ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከODP ፋይል በJava ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "ODP ገጾችን በJava ውስጥ ያውጡ"
description: "ODP ገጾችን ከጥቂት መስመሮች Java ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "ODP የፋይል ገጾችን በJava ያውጡ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች የሚፈለጉትን ገፆች ከODP ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የODP ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም ODP የፋይል ገጾችን ያውጡ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - ODP ገጾችን በመስመር ላይ ያውጡ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/{ext}}) ድር ጣቢያን በመጎብኘት የODP ፋይል ገጾችን አሁኑኑ ያውጡ።
