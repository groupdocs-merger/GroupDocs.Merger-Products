...
############################# Head ############################
head_title: "Išskleiskite PPTX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš PPTX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite PPTX puslapius Java"
description: "Išskleiskite PPTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite PPTX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš PPTX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti PPTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite PPTX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite PPTX puslapius internete"
    content: |
       Išskleiskite PPTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx) svetainėje.
