...
############################# Head ############################
head_title: "在 Java 中提取 RTF 个页面"
head_description: "从 Java 中的 RTF 文件中快速提取页面。使用文档合并 API 保存包含所选页面的新文档。"

############################# Header ############################
title: "在 Java 中提取 RTF 页"
description: "使用几行 Java 代码提取 RTF 页面。"
...
steps:
    enable: true
    title_left: "提取 Java 中的 RTF 个文件页"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 使 Java 开发人员可以轻松地从 RTF 文件中提取所需的页面并将其另存为通过执行几个简单的步骤来创建一个包含所选页面的新文件。
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码提取 RTF 文件页面">}}

        ```java    
        // 使用 GroupDocs.Merger API 提取 RTF 文件页面
...
demos:
    enable: true
    title: "现场演示 - 在线提取 RTF 页面"
    content: |
       访问 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) 网站，立即提取 RTF 文件页面。
       现场演示具有以下好处。
