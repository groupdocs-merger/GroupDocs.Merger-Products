...
############################# Head ############################
head_title: "VSX ገጾችን በJava ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከVSX ፋይል በJava ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "VSX ገጾችን በJava ውስጥ ያውጡ"
description: "VSX ገጾችን ከጥቂት መስመሮች Java ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "VSX የፋይል ገጾችን በJava ያውጡ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች የሚፈለጉትን ገፆች ከVSX ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የVSX ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም VSX የፋይል ገጾችን ያውጡ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - VSX ገጾችን በመስመር ላይ ያውጡ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/{ext}}) ድር ጣቢያን በመጎብኘት የVSX ፋይል ገጾችን አሁኑኑ ያውጡ።
