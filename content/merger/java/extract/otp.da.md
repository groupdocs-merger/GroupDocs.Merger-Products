...
############################# Head ############################
head_title: "Udpak OTP sider i Java"
head_description: "Udpak hurtigt sider fra en OTP-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak OTP sider i Java"
description: "Udpak OTP sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak OTP filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en OTP-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes OTP filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Udpak OTP filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Udpak OTP sider online"
    content: |
       Udpak OTP filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
