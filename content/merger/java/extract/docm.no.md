...
############################# Head ############################
head_title: "Trekk ut DOCM sider i Java"
head_description: "Trekk ut sider raskt fra en DOCM-fil i Java. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut DOCM sider i Java"
description: "Trekk ut DOCM sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Pakk ut DOCM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å trekke ut de ønskede sidene fra en DOCM-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut DOCM filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Pakk ut DOCM filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Trekk ut DOCM-sider på nett"
    content: |
       Pakk ut DOCM-filsider akkurat nå ved å besøke nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
