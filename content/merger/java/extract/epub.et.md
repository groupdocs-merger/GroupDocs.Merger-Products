...
############################# Head ############################
head_title: "Ekstraheerige EPUB lehte Java"
head_description: "Eksportige kiiresti lehed EPUB failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige EPUB lehte rakenduses Java"
description: "Ekstraheerige EPUB lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige EPUB faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist EPUB ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili EPUB lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili EPUB lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis EPUB lehekülge"
    content: |
       Ekstraktige kohe EPUB faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
