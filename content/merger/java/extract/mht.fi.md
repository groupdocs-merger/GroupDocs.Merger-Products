...
############################# Head ############################
head_title: "Pura MHT sivua Java"
head_description: "Pura sivut nopeasti MHT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura MHT sivua Java"
description: "Pura MHT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura MHT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut MHT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa MHT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura MHT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura MHT sivua verkossa"
    content: |
       Pura MHT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht) -sivustolla.
