...
############################# Head ############################
head_title: "Ekstrahiraj PPT strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke PPT v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj PPT strani v Java"
description: "Izvlecite strani PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke PPT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke PPT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke PPT s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke PPT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte PPT strani na spletu"
    content: |
       Ekstrahirajte strani datoteke PPT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt).
