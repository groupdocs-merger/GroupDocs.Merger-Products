...
############################# Head ############################
head_title: "Ekstrakt VDX stranica u Java"
head_description: "Brzo izdvojite stranice iz VDX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt VDX stranica u Java"
description: "Izdvojite VDX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt VDX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz VDX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti VDX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte VDX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite VDX stranica na mreži"
    content: |
       Izdvojite VDX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx) web stranice.
