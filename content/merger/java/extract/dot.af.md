...
############################# Head ############################
head_title: "Onttrek DOT bladsye in Java"
head_description: "Onttrek bladsye vinnig uit 'n DOT-lêer in Java. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek DOT bladsye in Java"
description: "Onttrek DOT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Onttrek DOT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om die verlangde bladsye uit 'n DOT-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOT lêerbladsye te onttrek deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Onttrek DOT lêerbladsye met GroupDocs.Merger API
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Onttrek DOT bladsye aanlyn"
    content: |
       Onttrek DOT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot) webwerf te besoek.
