...
############################# Head ############################
head_title: "Ekstrak VSSX Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file VSSX di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VSSX Halaman Di Java"
description: "Ekstrak Halaman VSSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File VSSX di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file VSSX dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file VSSX menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak halaman file VSSX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak VSSX Halaman Online"
    content: |
       Ekstrak halaman file VSSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/vssx).
