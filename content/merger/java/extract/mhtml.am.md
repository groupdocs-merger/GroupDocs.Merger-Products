...
############################# Head ############################
head_title: "MHTML ገጾችን በJava ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከMHTML ፋይል በJava ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "MHTML ገጾችን በJava ውስጥ ያውጡ"
description: "MHTML ገጾችን ከጥቂት መስመሮች Java ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "MHTML የፋይል ገጾችን በJava ያውጡ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች የሚፈለጉትን ገፆች ከMHTML ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የMHTML ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም MHTML የፋይል ገጾችን ያውጡ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - MHTML ገጾችን በመስመር ላይ ያውጡ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/{ext}}) ድር ጣቢያን በመጎብኘት የMHTML ፋይል ገጾችን አሁኑኑ ያውጡ።
