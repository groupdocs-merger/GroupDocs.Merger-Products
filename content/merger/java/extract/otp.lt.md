...
############################# Head ############################
head_title: "Išskleiskite OTP puslapius Java"
head_description: "Greitai išskleiskite puslapius iš OTP failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite OTP puslapius Java"
description: "Išskleiskite OTP puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite OTP failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš OTP failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti OTP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite OTP failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite OTP puslapius internete"
    content: |
       Išskleiskite OTP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp) svetainėje.
