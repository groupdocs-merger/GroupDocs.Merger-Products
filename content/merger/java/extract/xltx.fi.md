...
############################# Head ############################
head_title: "Pura XLTX sivua Java"
head_description: "Pura sivut nopeasti XLTX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLTX sivua Java"
description: "Pura XLTX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLTX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLTX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLTX sivua verkossa"
    content: |
       Pura XLTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx) -sivustolla.
