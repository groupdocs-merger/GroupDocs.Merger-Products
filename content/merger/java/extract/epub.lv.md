...
############################# Head ############################
head_title: "Izvilkt EPUB lapas programmā Java"
head_description: "Ātri izvelciet lapas no EPUB faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt EPUB lapas programmā Java"
description: "Izvelciet EPUB lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt EPUB faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila EPUB un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt EPUB faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet EPUB faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet EPUB lapas tiešsaistē"
    content: |
       Izņemiet EPUB faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
