...
############################# Head ############################
head_title: "Trekk ut EPUB sider i Java"
head_description: "Trekk ut sider raskt fra en EPUB-fil i Java. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut EPUB sider i Java"
description: "Trekk ut EPUB sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Pakk ut EPUB filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å trekke ut de ønskede sidene fra en EPUB-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut EPUB filsider ved å bruke Java eksempelkode">}}
