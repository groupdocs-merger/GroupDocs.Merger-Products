...
############################# Head ############################
head_title: "Java İçindeki VDX Sayfayı Çıkarın"
head_description: "Sayfaları bir VDX dosyasından Java içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "Java İçindeki VDX Sayfayı Çıkarın"
description: "VDX Sayfalarını birkaç satır Java koduyla çıkarın."
...
steps:
    enable: true
    title_left: "Java içindeki VDX Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin bir VDX dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VDX dosya sayfaları nasıl ayıklanır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VDX dosya sayfalarını çıkarın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi VDX Sayfayı Çıkarın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx) web sitesini ziyaret ederek VDX dosya sayfalarını hemen çıkarın.
