...
############################# Head ############################
head_title: "Extrahujte ONE stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru ONE v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte ONE stránek v Java"
description: "Extrahujte ONE stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte ONE stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru ONE a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru ONE pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru ONE pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte ONE stránek online"
    content: |
       Extrahujte stránky souborů ONE právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
