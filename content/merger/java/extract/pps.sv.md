...
############################# Head ############################
head_title: "Extrahera PPS sidor i Java"
head_description: "Extrahera snabbt sidor från en PPS-fil i Java. Spara det nya dokumentet som innehåller de valda sidorna med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Extrahera PPS sidor i Java"
description: "Extrahera PPS sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Extrahera PPS filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att extrahera önskade sidor från en PPS-fil och spara den som en ny fil som innehåller de valda sidorna genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man extraherar PPS filsidor med hjälp av Java exempelkod">}}
