...
############################# Head ############################
head_title: "Udpak VSX sider i Java"
head_description: "Udpak hurtigt sider fra en VSX-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak VSX sider i Java"
description: "Udpak VSX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak VSX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en VSX-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes VSX filsider ved hjælp af Java eksempelkode">}}
