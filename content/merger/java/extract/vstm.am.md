...
############################# Head ############################
head_title: "VSTM ገጾችን በJava ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከVSTM ፋይል በJava ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "VSTM ገጾችን በJava ውስጥ ያውጡ"
description: "VSTM ገጾችን ከጥቂት መስመሮች Java ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "VSTM የፋይል ገጾችን በJava ያውጡ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች የሚፈለጉትን ገፆች ከVSTM ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የVSTM ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም VSTM የፋይል ገጾችን ያውጡ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - VSTM ገጾችን በመስመር ላይ ያውጡ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/{ext}}) ድር ጣቢያን በመጎብኘት የVSTM ፋይል ገጾችን አሁኑኑ ያውጡ።
