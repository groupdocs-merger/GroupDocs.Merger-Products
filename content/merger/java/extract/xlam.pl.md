...
############################# Head ############################
head_title: "Wyodrębnij strony XLAM w Java"
head_description: "Szybko wyodrębnij strony z pliku XLAM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLAM strony w Java"
description: "Wyodrębnij strony XLAM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLAM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku XLAM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLAM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku XLAM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij XLAM strony online"
    content: |
       Wyodrębnij strony plików XLAM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam).
