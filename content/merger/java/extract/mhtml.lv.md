...
############################# Head ############################
head_title: "Izvilkt MHTML lapas programmā Java"
head_description: "Ātri izvelciet lapas no MHTML faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt MHTML lapas programmā Java"
description: "Izvelciet MHTML lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt MHTML faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila MHTML un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt MHTML faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet MHTML faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet MHTML lapas tiešsaistē"
    content: |
       Izņemiet MHTML faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
