...
############################# Head ############################
head_title: "XLT oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLT fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLT oldal kibontása a Java nyelven"
description: "Bontsa ki az XLT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLT fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLT fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLT oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlt) webhely meglátogatásával azonnal kibonthatja az XLT fájloldalakat.
