...
############################# Head ############################
head_title: "Extrahujte TEX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru TEX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte TEX stránek v Java"
description: "Extrahujte TEX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte TEX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru TEX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru TEX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru TEX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte TEX stránek online"
    content: |
       Extrahujte stránky souborů TEX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex).
