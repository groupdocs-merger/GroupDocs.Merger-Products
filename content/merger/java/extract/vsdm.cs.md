...
############################# Head ############################
head_title: "Extrahujte VSDM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VSDM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VSDM stránek v Java"
description: "Extrahujte VSDM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSDM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VSDM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VSDM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VSDM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VSDM stránek online"
    content: |
       Extrahujte stránky souborů VSDM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm).
