...
head_title: "Ekstrak POTM ke Beberapa File di Java"
head_description: "Pengguna Java mengekstrak satu file POTM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Ekstrak POTM Ke Beberapa File di Java"
description: "Ekstrak satu file POTM menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Ekstrak File POTM Dengan Halaman di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak satu file POTM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak file POTM menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak Halaman POTM Online"
    content: |
        Ekstrak file POTM sekarang dengan mengunjungi situs web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/POTM).
