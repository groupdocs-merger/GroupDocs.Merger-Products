...
############################# Head ############################
head_title: "Wyodrębnij strony DOT w Java"
head_description: "Szybko wyodrębnij strony z pliku DOT w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOT strony w Java"
description: "Wyodrębnij strony DOT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku DOT i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOT za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku DOT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij DOT strony online"
    content: |
       Wyodrębnij strony plików DOT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot).
