...
############################# Head ############################
head_title: "MHTML oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy MHTML fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "MHTML oldal kibontása a Java nyelven"
description: "Bontsa ki az MHTML oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "MHTML fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy MHTML fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az MHTML fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – MHTML oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml) webhely meglátogatásával azonnal kibonthatja az MHTML fájloldalakat.
