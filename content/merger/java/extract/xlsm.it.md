...
############################# Head ############################
head_title: "Estrai XLSM pagine in Java"
head_description: "Estrai rapidamente le pagine da un file XLSM in Java. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai XLSM pagine in Java"
description: "Estrai XLSM pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Estrai XLSM pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di estrarre facilmente le pagine desiderate da un file XLSM e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file XLSM utilizzando il codice di esempio Java">}}

        ```java    
        // Estrai XLSM pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo dal vivo - Estrai XLSM pagine online"
    content: |
       Estrai subito XLSM pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
