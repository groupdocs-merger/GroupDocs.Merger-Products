...
############################# Head ############################
head_title: "Udpak DOTX sider i Java"
head_description: "Udpak hurtigt sider fra en DOTX-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak DOTX sider i Java"
description: "Udpak DOTX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak DOTX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en DOTX-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes DOTX filsider ved hjælp af Java eksempelkode">}}
