...
head_description: "Nhanh chóng trích xuất các trang từ tệp HTML trong Java. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất HTML Trang trong Java"
description: "Trích xuất các Trang HTML với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp HTML trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp HTML bằng mã mẫu Java">}}
