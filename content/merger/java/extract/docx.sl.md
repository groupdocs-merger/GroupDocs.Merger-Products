...
############################# Head ############################
head_title: "Ekstrahiraj DOCX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke DOCX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj DOCX strani v Java"
description: "Izvlecite strani DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke DOCX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke DOCX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke DOCX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke DOCX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte DOCX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke DOCX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx).
