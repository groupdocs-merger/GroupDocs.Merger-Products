...
############################# Head ############################
head_title: "Išskleiskite HTML puslapius Java"
head_description: "Greitai išskleiskite puslapius iš HTML failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite HTML puslapius Java"
description: "Išskleiskite HTML puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite HTML failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš HTML failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti HTML failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite HTML failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite HTML puslapius internete"
    content: |
       Išskleiskite HTML failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html) svetainėje.
