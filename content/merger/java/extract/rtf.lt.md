...
############################# Head ############################
head_title: "Išskleiskite RTF puslapius Java"
head_description: "Greitai išskleiskite puslapius iš RTF failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite RTF puslapius Java"
description: "Išskleiskite RTF puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite RTF failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš RTF failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti RTF failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite RTF failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite RTF puslapius internete"
    content: |
       Išskleiskite RTF failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) svetainėje.
