...
############################# Head ############################
head_title: "Extraire XPS pages en Java"
head_description: "Extrayez rapidement des pages d'un fichier XPS en Java. Enregistrez le nouveau document contenant les pages sélectionnées à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Extraire XPS pages dans Java"
description: "Extrayez XPS pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Extraire XPS pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java d'extraire facilement les pages souhaitées d'un fichier XPS et de l'enregistrer sous un nouveau fichier contenant les pages sélectionnées en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment extraire les pages de fichier XPS à l'aide de l'exemple de code Java">}}

        ```java    
        // Extrayez XPS pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Extraire XPS pages en ligne"
    content: |
       Extrayez XPS pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps).
