...
############################# Head ############################
head_title: "Išskleiskite ONE puslapius Java"
head_description: "Greitai išskleiskite puslapius iš ONE failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite ONE puslapius Java"
description: "Išskleiskite ONE puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite ONE failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš ONE failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti ONE failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite ONE failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite ONE puslapius internete"
    content: |
       Išskleiskite ONE failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one) svetainėje.
