...
############################# Head ############################
head_title: "Wyodrębnij strony VSTX w Java"
head_description: "Szybko wyodrębnij strony z pliku VSTX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VSTX strony w Java"
description: "Wyodrębnij strony VSTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VSTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku VSTX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VSTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku VSTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij VSTX strony online"
    content: |
       Wyodrębnij strony plików VSTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx).
