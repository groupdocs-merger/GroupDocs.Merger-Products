...
############################# Head ############################
head_title: "Ekstrak DOTX Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail DOTX dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOTX Halaman Dalam Java"
description: "Ekstrak DOTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak DOTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail DOTX dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak DOTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak DOTX halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak DOTX Halaman Dalam Talian"
    content: |
       Ekstrak DOTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx).
