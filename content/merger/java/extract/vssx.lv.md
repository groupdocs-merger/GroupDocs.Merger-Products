...
############################# Head ############################
head_title: "Izvilkt VSSX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSSX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSSX lapas programmā Java"
description: "Izvelciet VSSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSSX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSSX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSSX lapas tiešsaistē"
    content: |
       Izņemiet VSSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssx).
