...
############################# Head ############################
head_title: "Extrahujte VSSM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VSSM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VSSM stránek v Java"
description: "Extrahujte VSSM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSSM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VSSM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VSSM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VSSM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VSSM stránek online"
    content: |
       Extrahujte stránky souborů VSSM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm).
