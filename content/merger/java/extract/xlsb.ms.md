...
############################# Head ############################
head_title: "Ekstrak XLSB Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail XLSB dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLSB Halaman Dalam Java"
description: "Ekstrak XLSB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak XLSB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail XLSB dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak XLSB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak XLSB halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak XLSB Halaman Dalam Talian"
    content: |
       Ekstrak XLSB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb).
