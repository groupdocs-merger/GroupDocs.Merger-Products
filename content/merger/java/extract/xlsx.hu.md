...
############################# Head ############################
head_title: "XLSX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLSX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLSX oldal kibontása a Java nyelven"
description: "Bontsa ki az XLSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLSX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLSX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLSX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx) webhely meglátogatásával azonnal kibonthatja az XLSX fájloldalakat.
