...
############################# Head ############################
head_title: "DOC oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy DOC fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "DOC oldal kibontása a Java nyelven"
description: "Bontsa ki az DOC oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOC fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy DOC fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az DOC fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – DOC oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc) webhely meglátogatásával azonnal kibonthatja az DOC fájloldalakat.
