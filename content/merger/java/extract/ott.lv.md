...
############################# Head ############################
head_title: "Izvilkt OTT lapas programmā Java"
head_description: "Ātri izvelciet lapas no OTT faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt OTT lapas programmā Java"
description: "Izvelciet OTT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt OTT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila OTT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt OTT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet OTT faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet OTT lapas tiešsaistē"
    content: |
       Izņemiet OTT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
