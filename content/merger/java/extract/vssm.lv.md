...
############################# Head ############################
head_title: "Izvilkt VSSM lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSSM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSSM lapas programmā Java"
description: "Izvelciet VSSM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSSM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSSM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSSM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSSM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSSM lapas tiešsaistē"
    content: |
       Izņemiet VSSM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm).
