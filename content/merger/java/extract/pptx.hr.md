...
############################# Head ############################
head_title: "Ekstrakt PPTX stranica u Java"
head_description: "Brzo izdvojite stranice iz PPTX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt PPTX stranica u Java"
description: "Izdvojite PPTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt PPTX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz PPTX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti PPTX stranice datoteke koristeći Java primjer koda">}}
