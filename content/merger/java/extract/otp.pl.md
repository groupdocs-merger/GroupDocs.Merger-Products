...
############################# Head ############################
head_title: "Wyodrębnij strony OTP w Java"
head_description: "Szybko wyodrębnij strony z pliku OTP w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij OTP strony w Java"
description: "Wyodrębnij strony OTP z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików OTP w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku OTP i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku OTP za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku OTP za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij OTP strony online"
    content: |
       Wyodrębnij strony plików OTP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
