...
############################# Head ############################
head_title: "Pura OTT sivua Java"
head_description: "Pura sivut nopeasti OTT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura OTT sivua Java"
description: "Pura OTT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura OTT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut OTT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa OTT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura OTT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura OTT sivua verkossa"
    content: |
       Pura OTT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott) -sivustolla.
