...
############################# Head ############################
head_title: "Extrahera VSSX sidor i Java"
head_description: "Extrahera snabbt sidor från en VSSX-fil i Java. Spara det nya dokumentet som innehåller de valda sidorna med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Extrahera VSSX sidor i Java"
description: "Extrahera VSSX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Extrahera VSSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att extrahera önskade sidor från en VSSX-fil och spara den som en ny fil som innehåller de valda sidorna genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man extraherar VSSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Extrahera VSSX filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Extrahera VSSX sidor online"
    content: |
       Extrahera VSSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssx).
