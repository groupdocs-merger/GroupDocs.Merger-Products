...
############################# Head ############################
head_title: "Bain DOTX Leathanaigh as Java"
head_description: "Bain go tapa leathanaigh as comhad DOTX in Java. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain DOTX Leathanaigh I Java"
description: "Sliocht DOTX Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain DOTX Leathanaigh Chomhad as Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java na leathanaigh atá ag teastáil a bhaint as comhad DOTX agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOTX a bhaint as trí úsáid a bhaint as cód samplach Java">}}
