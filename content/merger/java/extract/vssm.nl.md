...
############################# Head ############################
head_title: "Extraheer VSSM pagina's in Java"
head_description: "Extraheer snel pagina's uit een VSSM bestand in Java. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer VSSM pagina's in Java"
description: "Extraheer VSSM pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Pak VSSM Bestandspagina's uit in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om de gewenste pagina's uit een VSSM bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestandspagina's te extraheren met behulp van Java voorbeeldcode">}}

        ```java    
        // Extraheer VSSM bestandspagina's met de GroupDocs.Merger API
        // Initialiseer de ExtractOptions-klasse met geselecteerde paginanummers
        ExtractOptions extractOptions = new ExtractOptions(new int[] { 2, 5 });

        // Instantie van fusie met invoer VSSM document
...
demos:
    enable: true
    title: "Live demo's - Extraheer VSSM pagina's online"
    content: |
       Pak nu VSSM bestandspagina's uit door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm) te gaan.
