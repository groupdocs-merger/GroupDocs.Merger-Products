...
############################# Head ############################
head_title: "Di Java de XLAM Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek XLAM di Java de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên XLAM Di Java de derxe"
description: "Rûpelên XLAM bi çend rêzikên koda Java derxe."
...
steps:
    enable: true
    title_left: "Di Java de XLAM Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku rûpelên xwestinê ji pelek XLAM derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên XLAM derxe">}}

        ```java    
        // Rûpelên pelê yên XLAM bi kar tînin GroupDocs.Merger API derxînin
...
demos:
    enable: true
    title: "Demokên Zindî - Rûpelên Serhêl ên XLAM derxînin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) niha rûpelên pelê yên XLAM derxînin.
