...
############################# Head ############################
head_title: "Ekstrak DOC Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file DOC di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOC Halaman Di Java"
description: "Ekstrak Halaman DOC dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File DOC di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file DOC dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file DOC menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak DOC Halaman Online"
    content: |
       Ekstrak halaman file DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/doc).
