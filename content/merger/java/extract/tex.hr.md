...
############################# Head ############################
head_title: "Ekstrakt TEX stranica u Java"
head_description: "Brzo izdvojite stranice iz TEX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt TEX stranica u Java"
description: "Izdvojite TEX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt TEX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz TEX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti TEX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte TEX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite TEX stranica na mreži"
    content: |
       Izdvojite TEX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex) web stranice.
