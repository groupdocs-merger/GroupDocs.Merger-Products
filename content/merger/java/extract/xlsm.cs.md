...
############################# Head ############################
head_title: "Extrahujte XLSM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLSM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLSM stránek v Java"
description: "Extrahujte XLSM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLSM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLSM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLSM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLSM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLSM stránek online"
    content: |
       Extrahujte stránky souborů XLSM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
