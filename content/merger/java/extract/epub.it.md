...
############################# Head ############################
head_title: "Estrai pagine EPUB in Java"
head_description: "Utilizza GroupDocs.Merger for Java per estrarre pagine specifiche da un documento EPUB e salvarle come file separato."

############################# Header ############################
title: "Estrai pagine EPUB" 
description: "Con GroupDocs.Merger for Java, puoi arricchire le tue applicazioni Java con potenti funzionalità di elaborazione documenti per file EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ti consente di estrarre pagine da documenti EPUB. Migliora le tue applicazioni Java integrando potenti capacità di gestione documenti.
      
      1. Specifica il percorso del file del documento sorgente EPUB.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Estrai pagine specifiche da un documento"
      content: |
        Questo esempio mostra come estrarre un intervallo di pagine da un documento EPUB e salvarle come un file separato.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
