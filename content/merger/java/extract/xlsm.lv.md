...
############################# Head ############################
head_title: "Izvilkt XLSM lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLSM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLSM lapas programmā Java"
description: "Izvelciet XLSM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLSM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLSM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLSM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLSM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLSM lapas tiešsaistē"
    content: |
       Izņemiet XLSM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
