...
############################# Head ############################
head_title: "Ekstrahiraj VSSM strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke VSSM v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj VSSM strani v Java"
description: "Izvlecite strani VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke VSSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke VSSM in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke VSSM s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke VSSM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte VSSM strani na spletu"
    content: |
       Ekstrahirajte strani datoteke VSSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm).
