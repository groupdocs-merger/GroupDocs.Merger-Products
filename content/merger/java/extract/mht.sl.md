...
############################# Head ############################
head_title: "Ekstrahiraj MHT strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke MHT v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj MHT strani v Java"
description: "Izvlecite strani MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke MHT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke MHT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke MHT s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke MHT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte MHT strani na spletu"
    content: |
       Ekstrahirajte strani datoteke MHT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht).
