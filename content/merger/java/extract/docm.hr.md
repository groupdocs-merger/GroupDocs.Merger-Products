...
############################# Head ############################
head_title: "Ekstrakt DOCM stranica u Java"
head_description: "Brzo izdvojite stranice iz DOCM datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOCM stranica u Java"
description: "Izdvojite DOCM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOCM stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz DOCM datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOCM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte DOCM stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite DOCM stranica na mreži"
    content: |
       Izdvojite DOCM stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm) web stranice.
