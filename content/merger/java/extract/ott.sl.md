...
############################# Head ############################
head_title: "Ekstrahiraj OTT strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke OTT v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj OTT strani v Java"
description: "Izvlecite strani OTT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke OTT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke OTT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke OTT s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke OTT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte OTT strani na spletu"
    content: |
       Ekstrahirajte strani datoteke OTT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
