...
############################# Head ############################
head_title: "Ekstrak RTF Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file RTF di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak RTF Halaman Di Java"
description: "Ekstrak Halaman RTF dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File RTF di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file RTF dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file RTF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak RTF Halaman Online"
    content: |
       Ekstrak halaman file RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/rtf).
