...
############################# Head ############################
head_title: "Estrai VSSX pagine in Java"
head_description: "Estrai rapidamente le pagine da un file VSSX in Java. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai VSSX pagine in Java"
description: "Estrai VSSX pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Estrai VSSX pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di estrarre facilmente le pagine desiderate da un file VSSX e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file VSSX utilizzando il codice di esempio Java">}}
