...
############################# Head ############################
head_title: "Extrahujte XLAM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLAM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLAM stránek v Java"
description: "Extrahujte XLAM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLAM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLAM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLAM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLAM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLAM stránek online"
    content: |
       Extrahujte stránky souborů XLAM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam).
