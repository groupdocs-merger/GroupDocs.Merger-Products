...
############################# Head ############################
head_title: "Išskleiskite DOTM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš DOTM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite DOTM puslapius Java"
description: "Išskleiskite DOTM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite DOTM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš DOTM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti DOTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite DOTM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite DOTM puslapius internete"
    content: |
       Išskleiskite DOTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm) svetainėje.
