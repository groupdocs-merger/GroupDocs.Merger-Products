...
############################# Head ############################
head_title: "Extract VSDX into Multiple Files in Java"
head_description: "Java users to extract a single VSDX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Extract VSDX Into Multiple Files in Java"
description: "Extract a single VSDX file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    ...
    code: |
        ```cs
        // Extract VSDX file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Exract VSDX Pages Online"
    content: |
        Extract VSDX file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx) website.
