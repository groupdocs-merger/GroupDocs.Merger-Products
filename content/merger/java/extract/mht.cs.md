...
############################# Head ############################
head_title: "Extrahujte MHT stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru MHT v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte MHT stránek v Java"
description: "Extrahujte MHT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte MHT stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru MHT a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru MHT pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru MHT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte MHT stránek online"
    content: |
       Extrahujte stránky souborů MHT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht).
