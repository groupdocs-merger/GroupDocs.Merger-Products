...
############################# Head ############################
head_title: "DOCX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy DOCX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "DOCX oldal kibontása a Java nyelven"
description: "Bontsa ki az DOCX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOCX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy DOCX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az DOCX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – DOCX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx) webhely meglátogatásával azonnal kibonthatja az DOCX fájloldalakat.
