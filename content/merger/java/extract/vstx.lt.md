...
############################# Head ############################
head_title: "Išskleiskite VSTX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš VSTX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSTX puslapius Java"
description: "Išskleiskite VSTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSTX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš VSTX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite VSTX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite VSTX puslapius internete"
    content: |
       Išskleiskite VSTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx) svetainėje.
