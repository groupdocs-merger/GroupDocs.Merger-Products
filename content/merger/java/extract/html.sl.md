...
############################# Head ############################
head_title: "Ekstrahiraj HTML strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke HTML v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj HTML strani v Java"
description: "Izvlecite strani HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke HTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke HTML in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke HTML s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke HTML z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte HTML strani na spletu"
    content: |
       Ekstrahirajte strani datoteke HTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html).
