...
############################# Head ############################
head_title: "Pura DOTM sivua Java"
head_description: "Pura sivut nopeasti DOTM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOTM sivua Java"
description: "Pura DOTM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura DOTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut DOTM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOTM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura DOTM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura DOTM sivua verkossa"
    content: |
       Pura DOTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm) -sivustolla.
