...
############################# Head ############################
head_title: "Wyodrębnij strony PDF w Java"
head_description: "Szybko wyodrębnij strony z pliku PDF w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij PDF strony w Java"
description: "Wyodrębnij strony PDF z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików PDF w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku PDF i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku PDF za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku PDF za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij PDF strony online"
    content: |
       Wyodrębnij strony plików PDF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf).
