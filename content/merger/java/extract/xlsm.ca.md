...
############################# Head ############################
head_title: "Extreu XLSM pàgines a Java"
head_description: "Extraieu ràpidament pàgines d'un fitxer XLSM a Java. Deseu el nou document que conté les pàgines seleccionades mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Extreu XLSM pàgines a Java"
description: "Extreu XLSM pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Extreu XLSM pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java extreure les pàgines desitjades d'un fitxer XLSM i desar-les com a un nou fitxer que conté les pàgines seleccionades implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com extreure pàgines de fitxers XLSM utilitzant el codi d'exemple Java">}}

        ```java    
        // Extreu XLSM pàgines de fitxers mitjançant l'API de GroupDocs.Merger
...
demos:
    enable: true
    title: "Demostracions en directe: extreu XLSM pàgines en línia"
    content: |
       Extreu XLSM pàgines de fitxers ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
