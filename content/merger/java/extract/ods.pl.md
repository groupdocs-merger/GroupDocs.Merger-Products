...
############################# Head ############################
head_title: "Wyodrębnij strony ODS w Java"
head_description: "Szybko wyodrębnij strony z pliku ODS w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij ODS strony w Java"
description: "Wyodrębnij strony ODS z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików ODS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku ODS i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku ODS za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku ODS za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij ODS strony online"
    content: |
       Wyodrębnij strony plików ODS już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods).
