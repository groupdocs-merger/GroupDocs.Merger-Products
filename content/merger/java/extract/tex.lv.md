...
############################# Head ############################
head_title: "Izvilkt TEX lapas programmā Java"
head_description: "Ātri izvelciet lapas no TEX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt TEX lapas programmā Java"
description: "Izvelciet TEX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt TEX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila TEX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt TEX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet TEX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet TEX lapas tiešsaistē"
    content: |
       Izņemiet TEX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex).
