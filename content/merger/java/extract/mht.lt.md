...
############################# Head ############################
head_title: "Išskleiskite MHT puslapius Java"
head_description: "Greitai išskleiskite puslapius iš MHT failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite MHT puslapius Java"
description: "Išskleiskite MHT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite MHT failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš MHT failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti MHT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite MHT failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite MHT puslapius internete"
    content: |
       Išskleiskite MHT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht) svetainėje.
