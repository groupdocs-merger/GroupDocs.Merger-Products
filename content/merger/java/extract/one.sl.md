...
############################# Head ############################
head_title: "Ekstrahiraj ONE strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke ONE v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj ONE strani v Java"
description: "Izvlecite strani ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke ONE v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke ONE in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke ONE s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke ONE z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte ONE strani na spletu"
    content: |
       Ekstrahirajte strani datoteke ONE tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
