...
############################# Head ############################
head_title: "Ekstrakt DOCX stranica u Java"
head_description: "Brzo izdvojite stranice iz DOCX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOCX stranica u Java"
description: "Izdvojite DOCX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOCX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz DOCX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOCX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte DOCX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite DOCX stranica na mreži"
    content: |
       Izdvojite DOCX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx) web stranice.
