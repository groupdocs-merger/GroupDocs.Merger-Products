...
############################# Head ############################
head_title: "Extract XLTX Pages in Java"
head_description: "Quickly extract pages from a XLTX file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract XLTX Pages In Java"
description: "Extract XLTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract XLTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a XLTX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract XLTX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract XLTX Pages Online"
    content: |
       Extract XLTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx) website.
