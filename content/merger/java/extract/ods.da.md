...
############################# Head ############################
head_title: "Udpak ODS sider i Java"
head_description: "Udpak hurtigt sider fra en ODS-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak ODS sider i Java"
description: "Udpak ODS sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak ODS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en ODS-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes ODS filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Udpak ODS filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Udpak ODS sider online"
    content: |
       Udpak ODS filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods).
