...
############################# Head ############################
head_title: "Wyodrębnij strony VSDX w Java"
head_description: "Szybko wyodrębnij strony z pliku VSDX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VSDX strony w Java"
description: "Wyodrębnij strony VSDX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VSDX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku VSDX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VSDX za pomocą przykładowego kodu Java">}}
