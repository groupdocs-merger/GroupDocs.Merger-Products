...
############################# Head ############################
head_title: "Extrahiere ONENOTE Seiten in Java"
head_description: "Extrahieren Sie schnell Seiten aus einer ONENOTE-Datei in Java. Speichern Sie das neue Dokument mit den ausgewählten Seiten mithilfe der Documents Merger API."

############################# Header ############################
title: "Extrahiere ONENOTE Seiten in Java"
description: "Extrahieren Sie ONENOTE-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "ONENOTE Dateiseiten in Java extrahieren"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, die gewünschten Seiten aus einer ONENOTE-Datei zu extrahieren und als zu speichern eine neue Datei mit den ausgewählten Seiten, indem Sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So extrahieren Sie ONENOTE-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie ONENOTE-Dateiseiten mit der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Extrahieren Sie ONENOTE Seiten online"
    content: |
       Extrahieren Sie jetzt ONENOTE Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/onenote) besuchen.
