...
############################# Head ############################
head_title: "Extraire DOCM pages en Java"
head_description: "Extrayez rapidement des pages d'un fichier DOCM en Java. Enregistrez le nouveau document contenant les pages sélectionnées à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Extraire DOCM pages dans Java"
description: "Extrayez DOCM pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Extraire DOCM pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java d'extraire facilement les pages souhaitées d'un fichier DOCM et de l'enregistrer sous un nouveau fichier contenant les pages sélectionnées en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment extraire les pages de fichier DOCM à l'aide de l'exemple de code Java">}}

        ```java    
        // Extrayez DOCM pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Extraire DOCM pages en ligne"
    content: |
       Extrayez DOCM pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
