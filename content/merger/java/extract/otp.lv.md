...
############################# Head ############################
head_title: "Izvilkt OTP lapas programmā Java"
head_description: "Ātri izvelciet lapas no OTP faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt OTP lapas programmā Java"
description: "Izvelciet OTP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt OTP faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila OTP un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt OTP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet OTP faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet OTP lapas tiešsaistē"
    content: |
       Izņemiet OTP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
