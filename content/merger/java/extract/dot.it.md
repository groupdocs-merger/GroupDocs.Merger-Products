...
############################# Head ############################
head_title: "Estrai DOT pagine in Java"
head_description: "Estrai rapidamente le pagine da un file DOT in Java. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai DOT pagine in Java"
description: "Estrai DOT pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Estrai DOT pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di estrarre facilmente le pagine desiderate da un file DOT e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file DOT utilizzando il codice di esempio Java">}}

        ```java    
        // Estrai DOT pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo dal vivo - Estrai DOT pagine online"
    content: |
       Estrai subito DOT pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot).
