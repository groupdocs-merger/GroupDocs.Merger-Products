...
############################# Head ############################
head_title: "Ekstrak ODS Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file ODS di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODS Halaman Di Java"
description: "Ekstrak Halaman ODS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File ODS di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file ODS dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file ODS menggunakan kode contoh Java">}}

        ```java    
        // Ekstrak halaman file ODS menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak ODS Halaman Online"
    content: |
       Ekstrak halaman file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/ods).
