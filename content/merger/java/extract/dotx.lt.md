...
############################# Head ############################
head_title: "Išskleiskite DOTX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš DOTX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite DOTX puslapius Java"
description: "Išskleiskite DOTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite DOTX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš DOTX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti DOTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite DOTX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite DOTX puslapius internete"
    content: |
       Išskleiskite DOTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx) svetainėje.
