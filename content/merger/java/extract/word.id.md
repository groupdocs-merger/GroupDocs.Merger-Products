...
############################# Head ############################
head_title: "Ekstrak WORD Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file WORD di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak WORD Halaman Di Java"
description: "Ekstrak Halaman WORD dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File WORD di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file WORD dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file WORD menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak WORD Halaman Online"
    content: |
       Ekstrak halaman file WORD sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/word).
