...
############################# Head ############################
head_title: "Bain ONE Leathanaigh as Java"
head_description: "Bain go tapa leathanaigh as comhad ONE in Java. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain ONE Leathanaigh I Java"
description: "Sliocht ONE Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain ONE Leathanaigh Chomhad as Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java na leathanaigh atá ag teastáil a bhaint as comhad ONE agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ONE a bhaint as trí úsáid a bhaint as cód samplach Java">}}

        ```java    
        // Bain leathanaigh comhad ONE ag úsáid GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Sliocht ONE Leathanaigh Ar Líne"
    content: |
       Bain ONE leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one) láithreán gréasáin.
