...
############################# Head ############################
head_title: "Extraheer ODP pagina's in Java"
head_description: "Extraheer snel pagina's uit een ODP bestand in Java. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer ODP pagina's in Java"
description: "Extraheer ODP pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Pak ODP Bestandspagina's uit in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om de gewenste pagina's uit een ODP bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODP bestandspagina's te extraheren met behulp van Java voorbeeldcode">}}

        ```java    
        // Extraheer ODP bestandspagina's met de GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live demo's - Extraheer ODP pagina's online"
    content: |
       Pak nu ODP bestandspagina's uit door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp) te gaan.
