...
############################# Head ############################
head_title: "Ekstrak PPT Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail PPT dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak PPT Halaman Dalam Java"
description: "Ekstrak PPT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak PPT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail PPT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak PPT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak PPT halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak PPT Halaman Dalam Talian"
    content: |
       Ekstrak PPT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt).
