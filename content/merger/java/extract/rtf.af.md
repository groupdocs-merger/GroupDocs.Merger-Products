...
############################# Head ############################
head_title: "Onttrek RTF bladsye in Java"
head_description: "Onttrek bladsye vinnig uit 'n RTF-lêer in Java. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek RTF bladsye in Java"
description: "Onttrek RTF Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Onttrek RTF lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om die verlangde bladsye uit 'n RTF-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om RTF lêerbladsye te onttrek deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Onttrek RTF lêerbladsye met GroupDocs.Merger API
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Onttrek RTF bladsye aanlyn"
    content: |
       Onttrek RTF lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) webwerf te besoek.
