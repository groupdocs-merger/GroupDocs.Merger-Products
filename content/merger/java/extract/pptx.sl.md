...
############################# Head ############################
head_title: "Ekstrahiraj PPTX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke PPTX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj PPTX strani v Java"
description: "Izvlecite strani PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke PPTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke PPTX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke PPTX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke PPTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte PPTX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke PPTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
