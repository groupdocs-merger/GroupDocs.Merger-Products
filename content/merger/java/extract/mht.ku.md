...
############################# Head ############################
head_title: "Di Java de MHT Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek MHT di Java de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên MHT Di Java de derxe"
description: "Rûpelên MHT bi çend rêzikên koda Java derxe."
...
steps:
    enable: true
    title_left: "Di Java de MHT Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku rûpelên xwestinê ji pelek MHT derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên MHT derxe">}}

        ```java    
        // Rûpelên pelê yên MHT bi kar tînin GroupDocs.Merger API derxînin
...
demos:
    enable: true
    title: "Demokên Zindî - Rûpelên Serhêl ên MHT derxînin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht) niha rûpelên pelê yên MHT derxînin.
