...
############################# Head ############################
head_title: "Extraheer PPS pagina's in Java"
head_description: "Extraheer snel pagina's uit een PPS bestand in Java. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer PPS pagina's in Java"
description: "Extraheer PPS pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Pak PPS Bestandspagina's uit in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om de gewenste pagina's uit een PPS bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPS bestandspagina's te extraheren met behulp van Java voorbeeldcode">}}

        ```java    
        // Extraheer PPS bestandspagina's met de GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live demo's - Extraheer PPS pagina's online"
    content: |
       Pak nu PPS bestandspagina's uit door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps) te gaan.
