...
############################# Head ############################
head_title: "Extrahujte XLSX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLSX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLSX stránek v Java"
description: "Extrahujte XLSX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLSX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLSX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLSX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLSX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLSX stránek online"
    content: |
       Extrahujte stránky souborů XLSX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx).
