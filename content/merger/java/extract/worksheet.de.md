...
############################# Head ############################
head_title: "Extrahiere WORKSHEET Seiten in Java"
head_description: "Extrahieren Sie schnell Seiten aus einer WORKSHEET-Datei in Java. Speichern Sie das neue Dokument mit den ausgewählten Seiten mithilfe der Documents Merger API."

############################# Header ############################
title: "Extrahiere WORKSHEET Seiten in Java"
description: "Extrahieren Sie WORKSHEET-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "WORKSHEET Dateiseiten in Java extrahieren"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, die gewünschten Seiten aus einer WORKSHEET-Datei zu extrahieren und als zu speichern eine neue Datei mit den ausgewählten Seiten, indem Sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So extrahieren Sie WORKSHEET-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie WORKSHEET-Dateiseiten mit der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Extrahieren Sie WORKSHEET Seiten online"
    content: |
       Extrahieren Sie jetzt WORKSHEET Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/worksheet) besuchen.
