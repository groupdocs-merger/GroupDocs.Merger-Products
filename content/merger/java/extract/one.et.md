...
############################# Head ############################
head_title: "Ekstraheerige ONE lehte Java"
head_description: "Eksportige kiiresti lehed ONE failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige ONE lehte rakenduses Java"
description: "Ekstraheerige ONE lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige ONE faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist ONE ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili ONE lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili ONE lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis ONE lehekülge"
    content: |
       Ekstraktige kohe ONE faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
