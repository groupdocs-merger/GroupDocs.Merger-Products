...
############################# Head ############################
head_title: "Extract XLAM Pages in Java"
head_description: "Quickly extract pages from a XLAM file in Java. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract XLAM Pages In Java"
description: "Extract XLAM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Extract XLAM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to extract the desired pages from a XLAM file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract XLAM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract XLAM Pages Online"
    content: |
       Extract XLAM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) website.
