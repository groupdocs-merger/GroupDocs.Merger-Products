...
############################# Head ############################
head_title: "Pura VSSM sivua Java"
head_description: "Pura sivut nopeasti VSSM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSSM sivua Java"
description: "Pura VSSM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VSSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VSSM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSSM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VSSM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VSSM sivua verkossa"
    content: |
       Pura VSSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm) -sivustolla.
