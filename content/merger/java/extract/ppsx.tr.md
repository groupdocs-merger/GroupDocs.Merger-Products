...
############################# Head ############################
head_title: "Java İçindeki PPSX Sayfayı Çıkarın"
head_description: "Sayfaları bir PPSX dosyasından Java içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "Java İçindeki PPSX Sayfayı Çıkarın"
description: "PPSX Sayfalarını birkaç satır Java koduyla çıkarın."
...
steps:
    enable: true
    title_left: "Java içindeki PPSX Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin bir PPSX dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPSX dosya sayfaları nasıl ayıklanır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak PPSX dosya sayfalarını çıkarın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi PPSX Sayfayı Çıkarın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx) web sitesini ziyaret ederek PPSX dosya sayfalarını hemen çıkarın.
