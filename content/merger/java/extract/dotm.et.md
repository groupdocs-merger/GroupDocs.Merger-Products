...
############################# Head ############################
head_title: "Ekstraheerige DOTM lehte Java"
head_description: "Eksportige kiiresti lehed DOTM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige DOTM lehte rakenduses Java"
description: "Ekstraheerige DOTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige DOTM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist DOTM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili DOTM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili DOTM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis DOTM lehekülge"
    content: |
       Ekstraktige kohe DOTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
