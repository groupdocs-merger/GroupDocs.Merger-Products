...
############################# Head ############################
head_title: "Ekstrahiraj DOTM strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke DOTM v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj DOTM strani v Java"
description: "Izvlecite strani DOTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke DOTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke DOTM in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke DOTM s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke DOTM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte DOTM strani na spletu"
    content: |
       Ekstrahirajte strani datoteke DOTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
