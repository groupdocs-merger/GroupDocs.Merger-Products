...
############################# Head ############################
head_title: "Extrahujte VDX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VDX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VDX stránek v Java"
description: "Extrahujte VDX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VDX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VDX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VDX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VDX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VDX stránek online"
    content: |
       Extrahujte stránky souborů VDX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vdx).
