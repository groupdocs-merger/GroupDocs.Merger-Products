...
############################# Head ############################
head_title: "Extrahiere TEX Seiten in Java"
head_description: "Extrahieren Sie schnell Seiten aus einer TEX-Datei in Java. Speichern Sie das neue Dokument mit den ausgewählten Seiten mithilfe der Documents Merger API."

############################# Header ############################
title: "Extrahiere TEX Seiten in Java"
description: "Extrahieren Sie TEX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "TEX Dateiseiten in Java extrahieren"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, die gewünschten Seiten aus einer TEX-Datei zu extrahieren und als zu speichern eine neue Datei mit den ausgewählten Seiten, indem Sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So extrahieren Sie TEX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Extrahieren Sie TEX-Dateiseiten mit der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Extrahieren Sie TEX Seiten online"
    content: |
       Extrahieren Sie jetzt TEX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex) besuchen.
