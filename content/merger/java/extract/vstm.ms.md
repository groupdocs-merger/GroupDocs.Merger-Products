...
############################# Head ############################
head_title: "Ekstrak VSTM Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail VSTM dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VSTM Halaman Dalam Java"
description: "Ekstrak VSTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak VSTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail VSTM dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak VSTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak VSTM halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak VSTM Halaman Dalam Talian"
    content: |
       Ekstrak VSTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm).
