...
############################# Head ############################
head_title: "Udpak ODT sider i Java"
head_description: "Udpak hurtigt sider fra en ODT-fil i Java. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak ODT sider i Java"
description: "Udpak ODT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Udpak ODT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at udtrække de ønskede sider fra en ODT-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes ODT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Udpak ODT filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Udpak ODT sider online"
    content: |
       Udpak ODT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
