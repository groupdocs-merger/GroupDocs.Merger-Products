...
############################# Head ############################
head_title: "Java میں ODT صفحات نکالیں"
head_description: "Java میں کسی ODT فائل سے جلدی سے صفحات نکالیں۔ دستاویزات کے انضمام API کا استعمال کرتے ہوئے منتخب صفحات پر مشتمل نئی دستاویز کو محفوظ کریں۔"

############################# Header ############################
title: "Java میں ODT صفحات نکالیں"
description: "ODT صفحات کو Java کوڈ کی چند سطروں کے ساتھ نکالیں۔"
...
steps:
    enable: true
    title_left: "Java میں ODT فائل کے صفحات نکالیں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے مطلوبہ صفحات کو ODT فائل سے نکالنا اور اسے بطور محفوظ کرنا آسان بناتا ہے۔ ایک نئی فائل جس میں چند آسان مراحل کو لاگو کرکے منتخب صفحات پر مشتمل ہے۔
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے ODT فائل کے صفحات کو کیسے نکالا جائے۔">}}

        ```java    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے ODT فائل کے صفحات نکالیں۔
...
demos:
    enable: true
    title: "لائیو ڈیمو - آن لائن ODT صفحات نکالیں۔"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt) ویب سائٹ پر جا کر ابھی ODT فائل کے صفحات نکالیں۔
