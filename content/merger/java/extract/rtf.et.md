...
############################# Head ############################
head_title: "Ekstraheerige RTF lehte Java"
head_description: "Eksportige kiiresti lehed RTF failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige RTF lehte rakenduses Java"
description: "Ekstraheerige RTF lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige RTF faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist RTF ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili RTF lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili RTF lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis RTF lehekülge"
    content: |
       Ekstraktige kohe RTF faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf).
