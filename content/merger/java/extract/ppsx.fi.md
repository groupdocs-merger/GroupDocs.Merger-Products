...
############################# Head ############################
head_title: "Pura PPSX sivua Java"
head_description: "Pura sivut nopeasti PPSX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPSX sivua Java"
description: "Pura PPSX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura PPSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut PPSX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPSX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura PPSX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura PPSX sivua verkossa"
    content: |
       Pura PPSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx) -sivustolla.
