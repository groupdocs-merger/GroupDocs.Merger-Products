...
############################# Head ############################
head_title: "Wyodrębnij strony VTX w Java"
head_description: "Szybko wyodrębnij strony z pliku VTX w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VTX strony w Java"
description: "Wyodrębnij strony VTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku VTX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku VTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij VTX strony online"
    content: |
       Wyodrębnij strony plików VTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx).
