...
############################# Head ############################
head_title: "Išskleiskite MHTML puslapius Java"
head_description: "Greitai išskleiskite puslapius iš MHTML failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite MHTML puslapius Java"
description: "Išskleiskite MHTML puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite MHTML failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš MHTML failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti MHTML failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite MHTML failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite MHTML puslapius internete"
    content: |
       Išskleiskite MHTML failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml) svetainėje.
