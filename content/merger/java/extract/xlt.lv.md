...
############################# Head ############################
head_title: "Izvilkt XLT lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLT faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLT lapas programmā Java"
description: "Izvelciet XLT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLT faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLT lapas tiešsaistē"
    content: |
       Izņemiet XLT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlt).
