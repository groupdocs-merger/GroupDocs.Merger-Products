...
############################# Head ############################
head_title: "Wyodrębnij strony XLSM w Java"
head_description: "Szybko wyodrębnij strony z pliku XLSM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLSM strony w Java"
description: "Wyodrębnij strony XLSM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLSM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku XLSM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLSM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku XLSM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij XLSM strony online"
    content: |
       Wyodrębnij strony plików XLSM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm).
