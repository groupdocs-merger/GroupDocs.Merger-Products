...
############################# Head ############################
head_title: "XLSB oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLSB fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLSB oldal kibontása a Java nyelven"
description: "Bontsa ki az XLSB oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSB fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLSB fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLSB fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLSB oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb) webhely meglátogatásával azonnal kibonthatja az XLSB fájloldalakat.
