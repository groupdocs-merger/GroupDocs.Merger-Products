...
############################# Head ############################
head_title: "Izvilkt ODP lapas programmā Java"
head_description: "Ātri izvelciet lapas no ODP faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt ODP lapas programmā Java"
description: "Izvelciet ODP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt ODP faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila ODP un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt ODP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet ODP faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet ODP lapas tiešsaistē"
    content: |
       Izņemiet ODP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
