...
############################# Head ############################
head_title: "Extrahujte ODT stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru ODT v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte ODT stránek v Java"
description: "Extrahujte ODT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte ODT stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru ODT a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru ODT pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru ODT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte ODT stránek online"
    content: |
       Extrahujte stránky souborů ODT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
