...
############################# Head ############################
head_title: "Java ішіндегі VTX беттерді шығарып алу"
head_description: "Java ішіндегі VTX файлынан беттерді жылдам шығарып алыңыз. Таңдалған беттерді қамтитын жаңа құжатты құжаттарды біріктіру API арқылы сақтаңыз."

############################# Header ############################
title: "VTX беттерді Java ішінен шығарып алу"
description: "VTX Java кодының бірнеше жолы бар VTX беттерді шығарып алыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі VTX файл беттерін шығарып алыңыз"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне VTX файлынан қажетті беттерді шығарып, оны келесідей сақтауды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы таңдалған беттерді қамтитын жаңа файл.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX файл беттерін Java мысал кодын пайдаланып шығару жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VTX файл бетін шығарып алыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VTX беттерді желіден шығарып алыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vtx) веб-сайтына кіру арқылы VTX файл бетін дәл қазір шығарып алыңыз.
