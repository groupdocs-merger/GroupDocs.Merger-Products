...
############################# Head ############################
head_title: "Ekstrakt MHT stranica u Java"
head_description: "Brzo izdvojite stranice iz MHT datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt MHT stranica u Java"
description: "Izdvojite MHT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt MHT stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz MHT datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti MHT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte MHT stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite MHT stranica na mreži"
    content: |
       Izdvojite MHT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht) web stranice.
