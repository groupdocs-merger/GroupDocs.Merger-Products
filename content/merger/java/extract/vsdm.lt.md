...
############################# Head ############################
head_title: "Išskleiskite VSDM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš VSDM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSDM puslapius Java"
description: "Išskleiskite VSDM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSDM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš VSDM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSDM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite VSDM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite VSDM puslapius internete"
    content: |
       Išskleiskite VSDM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm) svetainėje.
