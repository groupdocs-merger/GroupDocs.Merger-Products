...
############################# Head ############################
head_title: "ODS ገጾችን በJava ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከODS ፋይል በJava ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "ODS ገጾችን በJava ውስጥ ያውጡ"
description: "ODS ገጾችን ከጥቂት መስመሮች Java ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "ODS የፋይል ገጾችን በJava ያውጡ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች የሚፈለጉትን ገፆች ከODS ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የODS ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም ODS የፋይል ገጾችን ያውጡ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - ODS ገጾችን በመስመር ላይ ያውጡ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/{ext}}) ድር ጣቢያን በመጎብኘት የODS ፋይል ገጾችን አሁኑኑ ያውጡ።
