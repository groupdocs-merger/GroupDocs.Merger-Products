...
############################# Head ############################
head_title: "Extract RTF into Multiple Files in Java"
head_description: "Java users to extract a single RTF file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Extract RTF Into Multiple Files in Java"
description: "Extract a single RTF file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Extract RTF File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to extract a single RTF file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Extract RTF file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Exract RTF Pages Online"
    content: |
        Extract RTF file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) website.
