...
############################# Head ############################
head_title: "Extraia páginas de PDF em Java"
head_description: "Use GroupDocs.Merger for Java para extrair páginas específicas de um documento PDF e salvá-las como um arquivo separado."

############################# Header ############################
title: "Extraia páginas de PDF" 
description: "Com GroupDocs.Merger for Java, você pode aprimorar suas aplicações Java com recursos poderosos de processamento de documentos para arquivos PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) permite que você extraia páginas de documentos PDF de forma eficiente. Aperfeiçoe suas aplicações Java integrando capacidades avançadas de gerenciamento de documentos.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraia páginas específicas de um documento"
      content: |
        Este exemplo demonstra como extrair um intervalo de páginas de um documento PDF e salvá-las como um arquivo separado.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
