...
############################# Head ############################
head_title: "Ekstrahiraj ODP strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke ODP v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj ODP strani v Java"
description: "Izvlecite strani ODP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke ODP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke ODP in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke ODP s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke ODP z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte ODP strani na spletu"
    content: |
       Ekstrahirajte strani datoteke ODP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
