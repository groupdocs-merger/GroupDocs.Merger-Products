...
############################# Head ############################
head_title: "DOTX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy DOTX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "DOTX oldal kibontása a Java nyelven"
description: "Bontsa ki az DOTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOTX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy DOTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az DOTX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – DOTX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx) webhely meglátogatásával azonnal kibonthatja az DOTX fájloldalakat.
