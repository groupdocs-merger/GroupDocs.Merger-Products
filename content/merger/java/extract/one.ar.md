...
############################# Head ############################
head_title: "استخراج صفحات ONE في Java"
head_description: "استخرج سريعًا الصفحات من ملف ONE في Java. احفظ المستند الجديد الذي يحتوي على الصفحات المحددة باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "استخراج صفحات ONE في Java"
description: "استخراج صفحات ONE ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "استخراج صفحات الملف ONE في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java استخراج الصفحات المطلوبة من ملف ONE وحفظها باسم ملف جديد يحتوي على الصفحات المحددة من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية استخراج صفحات ملف ONE باستخدام كود مثال Java">}}

        ```java    
        // استخراج صفحات الملف ONE باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - استخراج صفحات ONE عبر الإنترنت"
    content: |
       استخرج صفحات ملف ONE الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
