...
head_description: "Use GroupDocs.Merger for Java to extract specific pages from a PDF document and save them as a separate file."

############################# Header ############################
title: "Extract PDF pages" 
description: "With GroupDocs.Merger for Java, you can enhance your Java applications with powerful document processing features for PDF files."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to extract pages from PDF documents easily. Enhance your Java applications by integrating advanced document management capabilities.
