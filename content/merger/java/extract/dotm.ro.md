...
############################# Head ############################
head_title: "Extrageți DOTM pagini în Java"
head_description: "Extrageți rapid pagini dintr-un fișier DOTM în Java. Salvați noul document care conține paginile selectate folosind API-ul de fuziune a documentelor."

############################# Header ############################
title: "Extrageți DOTM pagini în Java"
description: "Extrageți DOTM pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Extrageți DOTM pagini de fișiere din Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să extragă paginile dorite dintr-un fișier DOTM și să le salveze ca un nou fișier care conține paginile selectate prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să extrageți pagini de fișiere DOTM folosind codul exemplu Java">}}

        ```java    
        // Extrageți DOTM pagini de fișier folosind API-ul GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live - Extrageți DOTM pagini online"
    content: |
       Extrageți DOTM pagini de fișier chiar acum, vizitând [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
