...
############################# Head ############################
head_title: "Pura OTP sivua Java"
head_description: "Pura sivut nopeasti OTP-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura OTP sivua Java"
description: "Pura OTP sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura OTP tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut OTP-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa OTP tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura OTP tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura OTP sivua verkossa"
    content: |
       Pura OTP tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp) -sivustolla.
