...
############################# Head ############################
head_title: "Pura XPS sivua Java"
head_description: "Pura sivut nopeasti XPS-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XPS sivua Java"
description: "Pura XPS sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XPS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XPS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XPS tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XPS tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XPS sivua verkossa"
    content: |
       Pura XPS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps) -sivustolla.
