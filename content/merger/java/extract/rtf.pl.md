...
############################# Head ############################
head_title: "Wyodrębnij strony RTF w Java"
head_description: "Szybko wyodrębnij strony z pliku RTF w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij RTF strony w Java"
description: "Wyodrębnij strony RTF z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików RTF w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku RTF i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku RTF za pomocą przykładowego kodu Java">}}
