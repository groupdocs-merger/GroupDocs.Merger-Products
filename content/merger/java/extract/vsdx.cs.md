...
############################# Head ############################
head_title: "Extrahujte VSDX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VSDX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VSDX stránek v Java"
description: "Extrahujte VSDX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSDX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VSDX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VSDX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VSDX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VSDX stránek online"
    content: |
       Extrahujte stránky souborů VSDX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx).
