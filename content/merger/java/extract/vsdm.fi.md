...
############################# Head ############################
head_title: "Pura VSDM sivua Java"
head_description: "Pura sivut nopeasti VSDM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSDM sivua Java"
description: "Pura VSDM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VSDM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VSDM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSDM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VSDM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VSDM sivua verkossa"
    content: |
       Pura VSDM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm) -sivustolla.
