...
############################# Head ############################
head_title: "Ekstrahiraj OTP strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke OTP v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj OTP strani v Java"
description: "Izvlecite strani OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke OTP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke OTP in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke OTP s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke OTP z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte OTP strani na spletu"
    content: |
       Ekstrahirajte strani datoteke OTP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp).
