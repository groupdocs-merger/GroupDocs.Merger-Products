...
############################# Head ############################
head_title: "استخراج صفحات VSSX في Java"
head_description: "استخرج سريعًا الصفحات من ملف VSSX في Java. احفظ المستند الجديد الذي يحتوي على الصفحات المحددة باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "استخراج صفحات VSSX في Java"
description: "استخراج صفحات VSSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "استخراج صفحات الملف VSSX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java استخراج الصفحات المطلوبة من ملف VSSX وحفظها باسم ملف جديد يحتوي على الصفحات المحددة من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية استخراج صفحات ملف VSSX باستخدام كود مثال Java">}}

        ```java    
        // استخراج صفحات الملف VSSX باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - استخراج صفحات VSSX عبر الإنترنت"
    content: |
       استخرج صفحات ملف VSSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssx).
