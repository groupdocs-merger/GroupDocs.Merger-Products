...
############################# Head ############################
head_title: "Ekstraheerige VSDM lehte Java"
head_description: "Eksportige kiiresti lehed VSDM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSDM lehte rakenduses Java"
description: "Ekstraheerige VSDM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSDM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VSDM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSDM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VSDM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VSDM lehekülge"
    content: |
       Ekstraktige kohe VSDM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm).
