...
############################# Head ############################
head_title: "Di Java de VSTX Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek VSTX di Java de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên VSTX Di Java de derxe"
description: "Rûpelên VSTX bi çend rêzikên koda Java derxe."
...
steps:
    enable: true
    title_left: "Di Java de VSTX Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku rûpelên xwestinê ji pelek VSTX derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên VSTX derxe">}}

        ```java    
        // Rûpelên pelê yên VSTX bi kar tînin GroupDocs.Merger API derxînin
...
demos:
    enable: true
    title: "Demokên Zindî - Rûpelên Serhêl ên VSTX derxînin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx) niha rûpelên pelê yên VSTX derxînin.
