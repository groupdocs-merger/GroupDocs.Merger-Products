...
############################# Head ############################
head_title: "Ekstrak HTML Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file HTML di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak HTML Halaman Di Java"
description: "Ekstrak Halaman HTML dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File HTML di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file HTML dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file HTML menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak HTML Halaman Online"
    content: |
       Ekstrak halaman file HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/html).
