...
############################# Head ############################
head_title: "XLTX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLTX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLTX oldal kibontása a Java nyelven"
description: "Bontsa ki az XLTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLTX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLTX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLTX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx) webhely meglátogatásával azonnal kibonthatja az XLTX fájloldalakat.
