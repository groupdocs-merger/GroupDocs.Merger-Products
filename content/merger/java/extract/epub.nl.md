...
############################# Head ############################
head_title: "Extraheer EPUB pagina's in Java"
head_description: "Extraheer snel pagina's uit een EPUB bestand in Java. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer EPUB pagina's in Java"
description: "Extraheer EPUB pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Pak EPUB Bestandspagina's uit in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om de gewenste pagina's uit een EPUB bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestandspagina's te extraheren met behulp van Java voorbeeldcode">}}
