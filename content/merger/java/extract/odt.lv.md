...
############################# Head ############################
head_title: "Izvilkt ODT lapas programmā Java"
head_description: "Ātri izvelciet lapas no ODT faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt ODT lapas programmā Java"
description: "Izvelciet ODT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt ODT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila ODT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt ODT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet ODT faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet ODT lapas tiešsaistē"
    content: |
       Izņemiet ODT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
