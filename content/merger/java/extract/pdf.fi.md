...
############################# Head ############################
head_title: "Pura PDF sivua Java"
head_description: "Pura sivut nopeasti PDF-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PDF sivua Java"
description: "Pura PDF sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura PDF tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut PDF-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PDF tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura PDF tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura PDF sivua verkossa"
    content: |
       Pura PDF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf) -sivustolla.
