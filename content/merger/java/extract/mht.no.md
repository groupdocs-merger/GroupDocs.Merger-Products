...
############################# Head ############################
head_title: "Trekk ut MHT sider i Java"
head_description: "Trekk ut sider raskt fra en MHT-fil i Java. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut MHT sider i Java"
description: "Trekk ut MHT sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Pakk ut MHT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å trekke ut de ønskede sidene fra en MHT-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut MHT filsider ved å bruke Java eksempelkode">}}
