...
############################# Head ############################
head_title: "Ekstrak ONE Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail ONE dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ONE Halaman Dalam Java"
description: "Ekstrak ONE Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak ONE Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail ONE dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ONE halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak ONE halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak ONE Halaman Dalam Talian"
    content: |
       Ekstrak ONE halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
