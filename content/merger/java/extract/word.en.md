...
head_description: "Use GroupDocs.Merger for Java to extract specific pages from a WORD document and save them as a separate file."

############################# Header ############################
title: "Extract WORD pages" 
description: "With GroupDocs.Merger for Java, you can enhance your Java applications with powerful document processing features for WORD files."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to extract pages from WORD documents easily. Enhance your Java applications by integrating advanced document management capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example demonstrates how to extract a range of pages from a WORD document and save them as a separate file.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
