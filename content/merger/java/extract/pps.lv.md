...
############################# Head ############################
head_title: "Izvilkt PPS lapas programmā Java"
head_description: "Ātri izvelciet lapas no PPS faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt PPS lapas programmā Java"
description: "Izvelciet PPS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt PPS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila PPS un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt PPS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet PPS faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet PPS lapas tiešsaistē"
    content: |
       Izņemiet PPS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps).
