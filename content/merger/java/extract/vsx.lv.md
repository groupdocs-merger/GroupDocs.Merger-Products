...
############################# Head ############################
head_title: "Izvilkt VSX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSX lapas programmā Java"
description: "Izvelciet VSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSX lapas tiešsaistē"
    content: |
       Izņemiet VSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsx).
