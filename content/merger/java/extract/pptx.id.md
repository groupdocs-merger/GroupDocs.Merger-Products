...
head_title: "Ekstrak PPTX ke Beberapa File di Java"
head_description: "Pengguna Java mengekstrak satu file PPTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Ekstrak PPTX Ke Beberapa File di Java"
description: "Ekstrak satu file PPTX menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Ekstrak File PPTX Dengan Halaman di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak satu file PPTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak file PPTX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak Halaman PPTX Online"
    content: |
        Ekstrak file PPTX sekarang dengan mengunjungi situs web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/PPTX).
