...
############################# Head ############################
head_title: "Wyodrębnij strony OTT w Java"
head_description: "Szybko wyodrębnij strony z pliku OTT w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij OTT strony w Java"
description: "Wyodrębnij strony OTT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików OTT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku OTT i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku OTT za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku OTT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij OTT strony online"
    content: |
       Wyodrębnij strony plików OTT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott).
