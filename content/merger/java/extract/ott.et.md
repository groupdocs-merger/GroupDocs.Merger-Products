...
############################# Head ############################
head_title: "Ekstraheerige OTT lehte Java"
head_description: "Eksportige kiiresti lehed OTT failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige OTT lehte rakenduses Java"
description: "Ekstraheerige OTT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige OTT faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist OTT ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili OTT lehekülgi, kasutades Java näidiskoodi">}}
