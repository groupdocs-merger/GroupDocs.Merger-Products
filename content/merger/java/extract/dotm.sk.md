...
############################# Head ############################
head_title: "Extrahujte DOTM stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru DOTM v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte DOTM stránok v Java"
description: "Extrahujte DOTM stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte DOTM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru DOTM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru DOTM pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte DOTM strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte DOTM stránok online"
    content: |
       Rozbaľte stránky súboru DOTM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotm).
