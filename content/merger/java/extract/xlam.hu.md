...
############################# Head ############################
head_title: "XLAM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLAM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLAM oldal kibontása a Java nyelven"
description: "Bontsa ki az XLAM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLAM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLAM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLAM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLAM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) webhely meglátogatásával azonnal kibonthatja az XLAM fájloldalakat.
