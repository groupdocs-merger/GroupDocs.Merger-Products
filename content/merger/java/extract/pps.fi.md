...
############################# Head ############################
head_title: "Pura PPS sivua Java"
head_description: "Pura sivut nopeasti PPS-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPS sivua Java"
description: "Pura PPS sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura PPS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut PPS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPS tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura PPS tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura PPS sivua verkossa"
    content: |
       Pura PPS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps) -sivustolla.
