...
############################# Head ############################
head_title: "Izvilkt DOC lapas programmā Java"
head_description: "Ātri izvelciet lapas no DOC faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOC lapas programmā Java"
description: "Izvelciet DOC lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOC faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOC un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOC faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet DOC faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet DOC lapas tiešsaistē"
    content: |
       Izņemiet DOC faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
