...
############################# Head ############################
head_title: "Ekstrahiraj ODT strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke ODT v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj ODT strani v Java"
description: "Izvlecite strani ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke ODT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke ODT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke ODT s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke ODT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte ODT strani na spletu"
    content: |
       Ekstrahirajte strani datoteke ODT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
