...
############################# Head ############################
head_title: "Pura XLT sivua Java"
head_description: "Pura sivut nopeasti XLT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLT sivua Java"
description: "Pura XLT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLT sivua verkossa"
    content: |
       Pura XLT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlt) -sivustolla.
