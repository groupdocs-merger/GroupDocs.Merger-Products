...
############################# Head ############################
head_title: "Pura PPT sivua Java"
head_description: "Pura sivut nopeasti PPT-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPT sivua Java"
description: "Pura PPT sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura PPT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut PPT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPT tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura PPT tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura PPT sivua verkossa"
    content: |
       Pura PPT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt) -sivustolla.
