...
############################# Head ############################
head_title: "Ekstrahiraj XPS strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke XPS v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj XPS strani v Java"
description: "Izvlecite strani XPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke XPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke XPS in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke XPS s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke XPS z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte XPS strani na spletu"
    content: |
       Ekstrahirajte strani datoteke XPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps).
