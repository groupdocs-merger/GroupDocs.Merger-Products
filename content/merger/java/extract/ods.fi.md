...
############################# Head ############################
head_title: "Pura ODS sivua Java"
head_description: "Pura sivut nopeasti ODS-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ODS sivua Java"
description: "Pura ODS sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura ODS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut ODS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ODS tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura ODS tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura ODS sivua verkossa"
    content: |
       Pura ODS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods) -sivustolla.
