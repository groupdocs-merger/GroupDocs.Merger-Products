...
############################# Head ############################
head_title: "Extrahujte PDF stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru PDF v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte PDF stránek v Java"
description: "Extrahujte PDF stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PDF stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru PDF a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru PDF pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru PDF pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte PDF stránek online"
    content: |
       Extrahujte stránky souborů PDF právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf).
