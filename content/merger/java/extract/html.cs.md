...
############################# Head ############################
head_title: "Extrahujte HTML stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru HTML v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte HTML stránek v Java"
description: "Extrahujte HTML stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte HTML stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru HTML a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru HTML pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru HTML pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte HTML stránek online"
    content: |
       Extrahujte stránky souborů HTML právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html).
