...
############################# Head ############################
head_title: "Извличане на ONE страници в Java"
head_description: "Бързо извличане на страници от ONE файл в Java. Запазете новия документ, съдържащ избраните страници, като използвате API за сливане на документи."

############################# Header ############################
title: "Извличане на ONE страници в Java"
description: "Извлечете ONE страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Извличане на ONE файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да извличат желаните страници от ONE файл и да го запазват като нов файл, съдържащ избраните страници, като изпълните няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да извлечете ONE файлови страници с помощта на Java примерен код">}}
