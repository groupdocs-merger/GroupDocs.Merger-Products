...
############################# Head ############################
head_title: "Ekstrakt EPUB stranica u Java"
head_description: "Brzo izdvojite stranice iz EPUB datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt EPUB stranica u Java"
description: "Izdvojite EPUB stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt EPUB stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz EPUB datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti EPUB stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte EPUB stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite EPUB stranica na mreži"
    content: |
       Izdvojite EPUB stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub) web stranice.
