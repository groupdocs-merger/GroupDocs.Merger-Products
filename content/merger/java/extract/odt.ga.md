...
############################# Head ############################
head_title: "Bain ODT Leathanaigh as Java"
head_description: "Bain go tapa leathanaigh as comhad ODT in Java. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain ODT Leathanaigh I Java"
description: "Sliocht ODT Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain ODT Leathanaigh Chomhad as Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java na leathanaigh atá ag teastáil a bhaint as comhad ODT agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ODT a bhaint as trí úsáid a bhaint as cód samplach Java">}}

        ```java    
        // Bain leathanaigh comhad ODT ag úsáid GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Sliocht ODT Leathanaigh Ar Líne"
    content: |
       Bain ODT leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt) láithreán gréasáin.
