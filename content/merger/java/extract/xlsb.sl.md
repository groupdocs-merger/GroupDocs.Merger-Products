...
############################# Head ############################
head_title: "Ekstrahiraj XLSB strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke XLSB v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj XLSB strani v Java"
description: "Izvlecite strani XLSB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke XLSB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke XLSB in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke XLSB s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke XLSB z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte XLSB strani na spletu"
    content: |
       Ekstrahirajte strani datoteke XLSB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb).
