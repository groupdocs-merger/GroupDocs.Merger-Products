...
############################# Head ############################
head_title: "Wyodrębnij strony XLTM w Java"
head_description: "Szybko wyodrębnij strony z pliku XLTM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLTM strony w Java"
description: "Wyodrębnij strony XLTM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku XLTM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLTM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku XLTM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij XLTM strony online"
    content: |
       Wyodrębnij strony plików XLTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltm).
