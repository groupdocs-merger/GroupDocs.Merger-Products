...
############################# Head ############################
head_title: "Izvilkt PDF lapas programmā Java"
head_description: "Ātri izvelciet lapas no PDF faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt PDF lapas programmā Java"
description: "Izvelciet PDF lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt PDF faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila PDF un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt PDF faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet PDF faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet PDF lapas tiešsaistē"
    content: |
       Izņemiet PDF faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf).
