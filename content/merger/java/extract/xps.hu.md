...
############################# Head ############################
head_title: "XPS oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XPS fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XPS oldal kibontása a Java nyelven"
description: "Bontsa ki az XPS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XPS fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XPS fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XPS fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XPS oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xps) webhely meglátogatásával azonnal kibonthatja az XPS fájloldalakat.
