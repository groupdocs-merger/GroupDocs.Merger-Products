...
############################# Head ############################
head_title: "Wyodrębnij strony DOCM w Java"
head_description: "Szybko wyodrębnij strony z pliku DOCM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOCM strony w Java"
description: "Wyodrębnij strony DOCM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOCM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku DOCM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOCM za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku DOCM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij DOCM strony online"
    content: |
       Wyodrębnij strony plików DOCM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm).
