...
############################# Head ############################
head_title: "XLSM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLSM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLSM oldal kibontása a Java nyelven"
description: "Bontsa ki az XLSM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLSM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az XLSM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – XLSM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm) webhely meglátogatásával azonnal kibonthatja az XLSM fájloldalakat.
