...
############################# Head ############################
head_title: "Ekstraheerige HTML lehte Java"
head_description: "Eksportige kiiresti lehed HTML failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige HTML lehte rakenduses Java"
description: "Ekstraheerige HTML lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige HTML faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist HTML ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili HTML lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili HTML lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis HTML lehekülge"
    content: |
       Ekstraktige kohe HTML faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html).
