...
############################# Head ############################
head_title: "Pura VSTM sivua Java"
head_description: "Pura sivut nopeasti VSTM-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSTM sivua Java"
description: "Pura VSTM sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura VSTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut VSTM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSTM tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura VSTM tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura VSTM sivua verkossa"
    content: |
       Pura VSTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm) -sivustolla.
