...
############################# Head ############################
head_title: "Ekstrahiraj MHTML strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke MHTML v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj MHTML strani v Java"
description: "Izvlecite strani MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke MHTML in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke MHTML s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke MHTML z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte MHTML strani na spletu"
    content: |
       Ekstrahirajte strani datoteke MHTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
