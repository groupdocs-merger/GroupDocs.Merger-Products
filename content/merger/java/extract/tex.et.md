...
############################# Head ############################
head_title: "Ekstraheerige TEX lehte Java"
head_description: "Eksportige kiiresti lehed TEX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige TEX lehte rakenduses Java"
description: "Ekstraheerige TEX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige TEX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist TEX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili TEX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili TEX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis TEX lehekülge"
    content: |
       Ekstraktige kohe TEX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex).
