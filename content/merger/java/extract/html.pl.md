...
############################# Head ############################
head_title: "Wyodrębnij strony HTML w Java"
head_description: "Szybko wyodrębnij strony z pliku HTML w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij HTML strony w Java"
description: "Wyodrębnij strony HTML z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików HTML w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku HTML i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku HTML za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku HTML za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij HTML strony online"
    content: |
       Wyodrębnij strony plików HTML już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html).
