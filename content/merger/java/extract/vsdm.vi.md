...
############################# Head ############################
head_title: "Trích xuất các trang VSDM trong Java"
head_description: "Nhanh chóng trích xuất các trang từ tệp VSDM trong Java. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất VSDM Trang trong Java"
description: "Trích xuất các Trang VSDM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp VSDM trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng trích xuất các trang mong muốn từ tệp VSDM và lưu nó dưới dạng một tệp mới chứa các trang đã chọn bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp VSDM bằng mã mẫu Java">}}

        ```java    
        // Giải nén các trang tệp VSDM bằng API GroupDocs.Merger
...
demos:
    enable: true
    title: "Bản trình diễn trực tiếp - Trích xuất các trang VSDM Trực tuyến"
    content: |
       Giải nén các trang tệp VSDM ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm) trang web.
