...
############################# Head ############################
head_title: "Išskleiskite PPSX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš PPSX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite PPSX puslapius Java"
description: "Išskleiskite PPSX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite PPSX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš PPSX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti PPSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite PPSX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite PPSX puslapius internete"
    content: |
       Išskleiskite PPSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx) svetainėje.
