...
############################# Head ############################
head_title: "Izvilkt VSTX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSTX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSTX lapas programmā Java"
description: "Izvelciet VSTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSTX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSTX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSTX lapas tiešsaistē"
    content: |
       Izņemiet VSTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstx).
