...
############################# Head ############################
head_title: "Ekstraheerige XLAM lehte Java"
head_description: "Eksportige kiiresti lehed XLAM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLAM lehte rakenduses Java"
description: "Ekstraheerige XLAM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLAM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist XLAM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLAM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili XLAM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis XLAM lehekülge"
    content: |
       Ekstraktige kohe XLAM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam).
