...
############################# Head ############################
head_title: "Ekstrak EPUB Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail EPUB dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EPUB Halaman Dalam Java"
description: "Ekstrak EPUB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak EPUB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail EPUB dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak EPUB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak EPUB halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak EPUB Halaman Dalam Talian"
    content: |
       Ekstrak EPUB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
