...
############################# Head ############################
head_title: "Ekstraheerige VSSM lehte Java"
head_description: "Eksportige kiiresti lehed VSSM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSSM lehte rakenduses Java"
description: "Ekstraheerige VSSM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSSM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VSSM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSSM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VSSM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VSSM lehekülge"
    content: |
       Ekstraktige kohe VSSM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssm).
