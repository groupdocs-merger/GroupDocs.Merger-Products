...
############################# Head ############################
head_title: "Ekstrak XLTX Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file XLTX di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLTX Halaman Di Java"
description: "Ekstrak Halaman XLTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File XLTX di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file XLTX dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file XLTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak XLTX Halaman Online"
    content: |
       Ekstrak halaman file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/xltx).
