...
############################# Head ############################
head_title: "Išskleiskite VSTM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš VSTM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSTM puslapius Java"
description: "Išskleiskite VSTM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSTM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš VSTM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite VSTM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite VSTM puslapius internete"
    content: |
       Išskleiskite VSTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm) svetainėje.
