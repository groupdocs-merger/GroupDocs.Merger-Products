...
############################# Head ############################
head_title: "Ekstraheerige VSDX lehte Java"
head_description: "Eksportige kiiresti lehed VSDX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSDX lehte rakenduses Java"
description: "Ekstraheerige VSDX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSDX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VSDX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSDX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VSDX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VSDX lehekülge"
    content: |
       Ekstraktige kohe VSDX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx).
