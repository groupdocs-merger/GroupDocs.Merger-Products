...
############################# Head ############################
head_title: "Išskleiskite XLTX puslapius Java"
head_description: "Greitai išskleiskite puslapius iš XLTX failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLTX puslapius Java"
description: "Išskleiskite XLTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLTX failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš XLTX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite XLTX failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite XLTX puslapius internete"
    content: |
       Išskleiskite XLTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx) svetainėje.
