...
############################# Head ############################
head_title: "Išskleiskite ODP puslapius Java"
head_description: "Greitai išskleiskite puslapius iš ODP failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite ODP puslapius Java"
description: "Išskleiskite ODP puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite ODP failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš ODP failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti ODP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite ODP failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite ODP puslapius internete"
    content: |
       Išskleiskite ODP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp) svetainėje.
