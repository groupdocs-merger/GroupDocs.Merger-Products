...
############################# Head ############################
head_title: "PPS oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy PPS fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "PPS oldal kibontása a Java nyelven"
description: "Bontsa ki az PPS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPS fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy PPS fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az PPS fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – PPS oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps) webhely meglátogatásával azonnal kibonthatja az PPS fájloldalakat.
