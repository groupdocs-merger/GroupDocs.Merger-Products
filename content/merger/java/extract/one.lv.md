...
############################# Head ############################
head_title: "Izvilkt ONE lapas programmā Java"
head_description: "Ātri izvelciet lapas no ONE faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt ONE lapas programmā Java"
description: "Izvelciet ONE lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt ONE faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila ONE un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt ONE faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet ONE faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet ONE lapas tiešsaistē"
    content: |
       Izņemiet ONE faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/one).
