...
############################# Head ############################
head_title: "Pura XLSX sivua Java"
head_description: "Pura sivut nopeasti XLSX-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSX sivua Java"
description: "Pura XLSX sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut XLSX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSX tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura XLSX tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura XLSX sivua verkossa"
    content: |
       Pura XLSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx) -sivustolla.
