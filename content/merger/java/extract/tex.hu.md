...
############################# Head ############################
head_title: "TEX oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy TEX fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "TEX oldal kibontása a Java nyelven"
description: "Bontsa ki az TEX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "TEX fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy TEX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az TEX fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – TEX oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/tex) webhely meglátogatásával azonnal kibonthatja az TEX fájloldalakat.
