...
############################# Head ############################
head_title: "Ekstrakt XLSX stranica u Java"
head_description: "Brzo izdvojite stranice iz XLSX datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt XLSX stranica u Java"
description: "Izdvojite XLSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt XLSX stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz XLSX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti XLSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte XLSX stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite XLSX stranica na mreži"
    content: |
       Izdvojite XLSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx) web stranice.
