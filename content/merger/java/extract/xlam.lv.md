...
############################# Head ############################
head_title: "Izvilkt XLAM lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLAM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLAM lapas programmā Java"
description: "Izvelciet XLAM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLAM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLAM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLAM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLAM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLAM lapas tiešsaistē"
    content: |
       Izņemiet XLAM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam).
