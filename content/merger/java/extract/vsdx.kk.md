...
############################# Head ############################
head_title: "Java ішіндегі VSDX беттерді шығарып алу"
head_description: "Java ішіндегі VSDX файлынан беттерді жылдам шығарып алыңыз. Таңдалған беттерді қамтитын жаңа құжатты құжаттарды біріктіру API арқылы сақтаңыз."

############################# Header ############################
title: "VSDX беттерді Java ішінен шығарып алу"
description: "VSDX Java кодының бірнеше жолы бар VSDX беттерді шығарып алыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі VSDX файл беттерін шығарып алыңыз"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне VSDX файлынан қажетті беттерді шығарып, оны келесідей сақтауды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы таңдалған беттерді қамтитын жаңа файл.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX файл беттерін Java мысал кодын пайдаланып шығару жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VSDX файл бетін шығарып алыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VSDX беттерді желіден шығарып алыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx) веб-сайтына кіру арқылы VSDX файл бетін дәл қазір шығарып алыңыз.
