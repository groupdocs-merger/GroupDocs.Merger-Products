...
############################# Head ############################
head_title: "DOCM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy DOCM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "DOCM oldal kibontása a Java nyelven"
description: "Bontsa ki az DOCM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOCM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy DOCM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az DOCM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – DOCM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm) webhely meglátogatásával azonnal kibonthatja az DOCM fájloldalakat.
