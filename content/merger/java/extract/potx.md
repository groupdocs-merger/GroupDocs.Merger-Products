...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to extract a single POTX file into multiple resultant files by implementing a few easy steps.
