...
############################# Head ############################
head_title: "Extrahujte XLTX stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLTX v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLTX stránek v Java"
description: "Extrahujte XLTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLTX stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLTX a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLTX pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLTX stránek online"
    content: |
       Extrahujte stránky souborů XLTX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx).
