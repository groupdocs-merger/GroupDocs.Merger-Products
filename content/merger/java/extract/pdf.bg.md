...
############################# Head ############################
head_title: "Извличане на PDF страници в Java"
head_description: "Бързо извличане на страници от PDF файл в Java. Запазете новия документ, съдържащ избраните страници, като използвате API за сливане на документи."

############################# Header ############################
title: "Извличане на PDF страници в Java"
description: "Извлечете PDF страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Извличане на PDF файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да извличат желаните страници от PDF файл и да го запазват като нов файл, съдържащ избраните страници, като изпълните няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да извлечете PDF файлови страници с помощта на Java примерен код">}}

        ```java    
        // Извлечете PDF файлови страници с помощта на GroupDocs.Merger API
...
demos:
    enable: true
    title: "Демонстрации на живо - Извличане на PDF страници онлайн"
    content: |
       Извлечете PDF файлови страници точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf).
