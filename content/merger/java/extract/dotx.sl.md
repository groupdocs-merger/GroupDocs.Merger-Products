...
############################# Head ############################
head_title: "Ekstrahiraj DOTX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke DOTX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj DOTX strani v Java"
description: "Izvlecite strani DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke DOTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke DOTX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke DOTX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke DOTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte DOTX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke DOTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dotx).
