...
############################# Head ############################
head_title: "Wyodrębnij strony MHT w Java"
head_description: "Szybko wyodrębnij strony z pliku MHT w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij MHT strony w Java"
description: "Wyodrębnij strony MHT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików MHT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku MHT i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku MHT za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku MHT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij MHT strony online"
    content: |
       Wyodrębnij strony plików MHT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht).
