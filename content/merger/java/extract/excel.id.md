...
############################# Head ############################
head_title: "Ekstrak EXCEL Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file EXCEL di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EXCEL Halaman Di Java"
description: "Ekstrak Halaman EXCEL dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File EXCEL di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file EXCEL dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file EXCEL menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak EXCEL Halaman Online"
    content: |
       Ekstrak halaman file EXCEL sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/excel).
