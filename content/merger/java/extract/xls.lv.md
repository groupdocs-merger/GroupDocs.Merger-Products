...
############################# Head ############################
head_title: "Izvilkt XLS lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLS faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLS lapas programmā Java"
description: "Izvelciet XLS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLS un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLS faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLS lapas tiešsaistē"
    content: |
       Izņemiet XLS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xls).
