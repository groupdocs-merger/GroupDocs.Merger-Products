...
############################# Head ############################
head_title: "Išskleiskite PPT puslapius Java"
head_description: "Greitai išskleiskite puslapius iš PPT failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite PPT puslapius Java"
description: "Išskleiskite PPT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite PPT failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš PPT failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti PPT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite PPT failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite PPT puslapius internete"
    content: |
       Išskleiskite PPT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppt) svetainėje.
