...
############################# Head ############################
head_title: "Արտահանել VSTM էջ Java-ում"
head_description: "Արագ հանեք էջերը VSTM ֆայլից Java-ում: Պահպանեք ընտրված էջերը պարունակող նոր փաստաթուղթը՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Արտահանել VSTM էջ Java-ում"
description: "Հանեք VSTM էջեր Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Արտահանել VSTM ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար ցանկալի էջերը հանել VSTM ֆայլից և պահպանել այն որպես ընտրված էջերը պարունակող նոր ֆայլ՝ կատարելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հանել VSTM ֆայլի էջեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Արտահանեք VSTM ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ. հանեք VSTM էջեր առցանց"
    content: |
       Հանեք VSTM ֆայլի էջեր հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/exttract-pages/vstm) կայքը:
