...
############################# Head ############################
head_title: "DOT oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy DOT fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "DOT oldal kibontása a Java nyelven"
description: "Bontsa ki az DOT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOT fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy DOT fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az DOT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – DOT oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/dot) webhely meglátogatásával azonnal kibonthatja az DOT fájloldalakat.
