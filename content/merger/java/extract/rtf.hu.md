...
############################# Head ############################
head_title: "RTF oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy RTF fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "RTF oldal kibontása a Java nyelven"
description: "Bontsa ki az RTF oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "RTF fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy RTF fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az RTF fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – RTF oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) webhely meglátogatásával azonnal kibonthatja az RTF fájloldalakat.
