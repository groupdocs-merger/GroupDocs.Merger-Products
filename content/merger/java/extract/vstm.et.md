...
############################# Head ############################
head_title: "Ekstraheerige VSTM lehte Java"
head_description: "Eksportige kiiresti lehed VSTM failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSTM lehte rakenduses Java"
description: "Ekstraheerige VSTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSTM faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VSTM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSTM lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili VSTM lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis VSTM lehekülge"
    content: |
       Ekstraktige kohe VSTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm).
