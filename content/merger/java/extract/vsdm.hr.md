...
############################# Head ############################
head_title: "Ekstrakt VSDM stranica u Java"
head_description: "Brzo izdvojite stranice iz VSDM datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt VSDM stranica u Java"
description: "Izdvojite VSDM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt VSDM stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz VSDM datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti VSDM stranice datoteke koristeći Java primjer koda">}}
