...
############################# Head ############################
head_title: "Dragðu út VTX síður í Java"
head_description: "Dragðu síður út á fljótlegan hátt úr VTX skrá í Java. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út VTX síður í Java"
description: "Dragðu út VTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Dragðu út VTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar forriturum Java að draga þær síður sem óskað er eftir úr VTX skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út VTX skráarsíður með því að nota Java dæmi kóða">}}
