...
############################# Head ############################
head_title: "Ekstrahiraj XLT strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke XLT v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj XLT strani v Java"
description: "Izvlecite strani XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke XLT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke XLT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke XLT s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke XLT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte XLT strani na spletu"
    content: |
       Ekstrahirajte strani datoteke XLT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlt).
