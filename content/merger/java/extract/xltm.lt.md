...
############################# Head ############################
head_title: "Išskleiskite XLTM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš XLTM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLTM puslapius Java"
description: "Išskleiskite XLTM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLTM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš XLTM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite XLTM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite XLTM puslapius internete"
    content: |
       Išskleiskite XLTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltm) svetainėje.
