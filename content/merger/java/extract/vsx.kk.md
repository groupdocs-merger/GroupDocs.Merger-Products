...
############################# Head ############################
head_title: "Java ішіндегі VSX беттерді шығарып алу"
head_description: "Java ішіндегі VSX файлынан беттерді жылдам шығарып алыңыз. Таңдалған беттерді қамтитын жаңа құжатты құжаттарды біріктіру API арқылы сақтаңыз."

############################# Header ############################
title: "VSX беттерді Java ішінен шығарып алу"
description: "VSX Java кодының бірнеше жолы бар VSX беттерді шығарып алыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі VSX файл беттерін шығарып алыңыз"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне VSX файлынан қажетті беттерді шығарып, оны келесідей сақтауды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы таңдалған беттерді қамтитын жаңа файл.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX файл беттерін Java мысал кодын пайдаланып шығару жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VSX файл бетін шығарып алыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VSX беттерді желіден шығарып алыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsx) веб-сайтына кіру арқылы VSX файл бетін дәл қазір шығарып алыңыз.
