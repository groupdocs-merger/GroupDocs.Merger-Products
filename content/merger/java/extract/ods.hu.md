...
############################# Head ############################
head_title: "ODS oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy ODS fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "ODS oldal kibontása a Java nyelven"
description: "Bontsa ki az ODS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODS fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy ODS fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODS fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az ODS fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – ODS oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods) webhely meglátogatásával azonnal kibonthatja az ODS fájloldalakat.
