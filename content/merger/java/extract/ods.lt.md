...
############################# Head ############################
head_title: "Išskleiskite ODS puslapius Java"
head_description: "Greitai išskleiskite puslapius iš ODS failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite ODS puslapius Java"
description: "Išskleiskite ODS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite ODS failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš ODS failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti ODS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite ODS failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite ODS puslapius internete"
    content: |
       Išskleiskite ODS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods) svetainėje.
