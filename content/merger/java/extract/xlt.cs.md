...
############################# Head ############################
head_title: "Extrahujte XLT stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLT v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLT stránek v Java"
description: "Extrahujte XLT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLT stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLT a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLT pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLT stránek online"
    content: |
       Extrahujte stránky souborů XLT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlt).
