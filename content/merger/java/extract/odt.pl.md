...
############################# Head ############################
head_title: "Wyodrębnij strony ODT w Java"
head_description: "Szybko wyodrębnij strony z pliku ODT w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij ODT strony w Java"
description: "Wyodrębnij strony ODT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików ODT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku ODT i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku ODT za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku ODT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij ODT strony online"
    content: |
       Wyodrębnij strony plików ODT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt).
