...
############################# Head ############################
head_title: "Wyodrębnij strony EPUB w Java"
head_description: "Szybko wyodrębnij strony z pliku EPUB w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij EPUB strony w Java"
description: "Wyodrębnij strony EPUB z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików EPUB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wyodrębnienie żądanych stron z pliku EPUB i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku EPUB za pomocą przykładowego kodu Java">}}

        ```java    
        // Wyodrębnij strony pliku EPUB za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij EPUB strony online"
    content: |
       Wyodrębnij strony plików EPUB już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub).
