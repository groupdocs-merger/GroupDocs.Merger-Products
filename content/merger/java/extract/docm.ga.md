...
############################# Head ############################
head_title: "Bain DOCM Leathanaigh as Java"
head_description: "Bain go tapa leathanaigh as comhad DOCM in Java. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain DOCM Leathanaigh I Java"
description: "Sliocht DOCM Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain DOCM Leathanaigh Chomhad as Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java na leathanaigh atá ag teastáil a bhaint as comhad DOCM agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOCM a bhaint as trí úsáid a bhaint as cód samplach Java">}}

        ```java    
        // Bain leathanaigh comhad DOCM ag úsáid GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Sliocht DOCM Leathanaigh Ar Líne"
    content: |
       Bain DOCM leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docm) láithreán gréasáin.
