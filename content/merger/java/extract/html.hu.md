...
############################# Head ############################
head_title: "HTML oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy HTML fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "HTML oldal kibontása a Java nyelven"
description: "Bontsa ki az HTML oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "HTML fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy HTML fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az HTML fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – HTML oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/html) webhely meglátogatásával azonnal kibonthatja az HTML fájloldalakat.
