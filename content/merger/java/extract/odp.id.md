...
############################# Head ############################
head_title: "Ekstrak ODP Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file ODP di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODP Halaman Di Java"
description: "Ekstrak Halaman ODP dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File ODP di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file ODP dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file ODP menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak ODP Halaman Online"
    content: |
       Ekstrak halaman file ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/odp).
