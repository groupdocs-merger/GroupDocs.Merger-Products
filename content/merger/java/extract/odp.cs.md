...
############################# Head ############################
head_title: "Extrahujte ODP stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru ODP v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte ODP stránek v Java"
description: "Extrahujte ODP stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte ODP stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru ODP a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru ODP pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru ODP pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte ODP stránek online"
    content: |
       Extrahujte stránky souborů ODP právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odp).
