...
############################# Head ############################
head_title: "Izvilkt PPTX lapas programmā Java"
head_description: "Ātri izvelciet lapas no PPTX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt PPTX lapas programmā Java"
description: "Izvelciet PPTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt PPTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila PPTX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt PPTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet PPTX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet PPTX lapas tiešsaistē"
    content: |
       Izņemiet PPTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
