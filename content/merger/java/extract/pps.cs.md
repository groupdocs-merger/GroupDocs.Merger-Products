...
############################# Head ############################
head_title: "Extrahujte PPS stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru PPS v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte PPS stránek v Java"
description: "Extrahujte PPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PPS stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru PPS a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru PPS pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru PPS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte PPS stránek online"
    content: |
       Extrahujte stránky souborů PPS právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps).
