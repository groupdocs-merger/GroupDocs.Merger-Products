...
############################# Head ############################
head_title: "Extrahujte XLAM stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru XLAM v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte XLAM stránok v Java"
description: "Extrahujte XLAM stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLAM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru XLAM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru XLAM pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte XLAM strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte XLAM stránok online"
    content: |
       Rozbaľte stránky súboru XLAM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam).
