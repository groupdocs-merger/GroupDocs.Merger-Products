...
############################# Head ############################
head_title: "Išskleiskite PPS puslapius Java"
head_description: "Greitai išskleiskite puslapius iš PPS failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite PPS puslapius Java"
description: "Išskleiskite PPS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite PPS failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš PPS failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti PPS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite PPS failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite PPS puslapius internete"
    content: |
       Išskleiskite PPS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pps) svetainėje.
