...
############################# Head ############################
head_title: "Ekstraheerige VTX lehte Java"
head_description: "Eksportige kiiresti lehed VTX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VTX lehte rakenduses Java"
description: "Ekstraheerige VTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VTX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist VTX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VTX lehekülgi, kasutades Java näidiskoodi">}}
