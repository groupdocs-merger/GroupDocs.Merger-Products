...
############################# Head ############################
head_title: "Extrahujte PPTX stránok v Java"
head_description: "Rýchlo extrahujte stránky zo súboru PPTX v Java. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte PPTX stránok v Java"
description: "Extrahujte PPTX stránok pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte PPTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java extrahovať požadované stránky zo súboru PPTX a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru PPTX pomocou vzorového kódu Java">}}

        ```java    
        // Extrahujte PPTX strán súboru pomocou GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – extrahujte PPTX stránok online"
    content: |
       Rozbaľte stránky súboru PPTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
