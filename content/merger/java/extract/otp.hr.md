...
############################# Head ############################
head_title: "Ekstrakt OTP stranica u Java"
head_description: "Brzo izdvojite stranice iz OTP datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt OTP stranica u Java"
description: "Izdvojite OTP stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt OTP stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz OTP datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti OTP stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte OTP stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite OTP stranica na mreži"
    content: |
       Izdvojite OTP stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/otp) web stranice.
