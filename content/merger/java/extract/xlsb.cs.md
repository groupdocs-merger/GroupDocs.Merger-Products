...
############################# Head ############################
head_title: "Extrahujte XLSB stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru XLSB v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte XLSB stránek v Java"
description: "Extrahujte XLSB stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte XLSB stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru XLSB a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru XLSB pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru XLSB pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte XLSB stránek online"
    content: |
       Extrahujte stránky souborů XLSB právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsb).
