...
############################# Head ############################
head_title: "Extrahujte MHTML stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru MHTML v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte MHTML stránek v Java"
description: "Extrahujte MHTML stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte MHTML stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru MHTML a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru MHTML pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru MHTML pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte MHTML stránek online"
    content: |
       Extrahujte stránky souborů MHTML právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mhtml).
