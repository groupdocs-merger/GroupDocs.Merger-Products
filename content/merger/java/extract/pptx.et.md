...
############################# Head ############################
head_title: "Ekstraheerige PPTX lehte Java"
head_description: "Eksportige kiiresti lehed PPTX failist rakenduses Java. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige PPTX lehte rakenduses Java"
description: "Ekstraheerige PPTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige PPTX faililehte tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks soovitud lehtede eraldamise failist PPTX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili PPTX lehekülgi, kasutades Java näidiskoodi">}}

        ```java    
        // Ekstraheerige faili PPTX lehed GroupDocs.Merger API abil
...
demos:
    enable: true
    title: "Reaalajas demod – ekstraktige veebis PPTX lehekülge"
    content: |
       Ekstraktige kohe PPTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx).
