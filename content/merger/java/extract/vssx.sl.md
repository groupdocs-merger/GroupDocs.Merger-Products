...
############################# Head ############################
head_title: "Ekstrahiraj VSSX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke VSSX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj VSSX strani v Java"
description: "Izvlecite strani VSSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke VSSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke VSSX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke VSSX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke VSSX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte VSSX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke VSSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vssx).
