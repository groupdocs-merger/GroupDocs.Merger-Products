...
############################# Head ############################
head_title: "VSTM oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy VSTM fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "VSTM oldal kibontása a Java nyelven"
description: "Bontsa ki az VSTM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSTM fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy VSTM fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az VSTM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – VSTM oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm) webhely meglátogatásával azonnal kibonthatja az VSTM fájloldalakat.
