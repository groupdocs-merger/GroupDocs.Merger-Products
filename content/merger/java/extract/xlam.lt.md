...
############################# Head ############################
head_title: "Išskleiskite XLAM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš XLAM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLAM puslapius Java"
description: "Išskleiskite XLAM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLAM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš XLAM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLAM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite XLAM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite XLAM puslapius internete"
    content: |
       Išskleiskite XLAM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlam) svetainėje.
