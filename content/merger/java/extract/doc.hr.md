...
############################# Head ############################
head_title: "Ekstrakt DOC stranica u Java"
head_description: "Brzo izdvojite stranice iz DOC datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOC stranica u Java"
description: "Izdvojite DOC stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOC stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz DOC datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOC stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte DOC stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite DOC stranica na mreži"
    content: |
       Izdvojite DOC stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc) web stranice.
