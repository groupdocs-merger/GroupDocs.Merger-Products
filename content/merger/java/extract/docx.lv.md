...
############################# Head ############################
head_title: "Izvilkt DOCX lapas programmā Java"
head_description: "Ātri izvelciet lapas no DOCX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOCX lapas programmā Java"
description: "Izvelciet DOCX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOCX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOCX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOCX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet DOCX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet DOCX lapas tiešsaistē"
    content: |
       Izņemiet DOCX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/docx).
