...
############################# Head ############################
head_title: "Extreu MHTML pàgines a Java"
head_description: "Extraieu ràpidament pàgines d'un fitxer MHTML a Java. Deseu el nou document que conté les pàgines seleccionades mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Extreu MHTML pàgines a Java"
description: "Extreu MHTML pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Extreu MHTML pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java extreure les pàgines desitjades d'un fitxer MHTML i desar-les com a un nou fitxer que conté les pàgines seleccionades implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com extreure pàgines de fitxers MHTML utilitzant el codi d'exemple Java">}}
