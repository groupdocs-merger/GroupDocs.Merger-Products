...
############################# Head ############################
head_title: "Izvilkt VSDX lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSDX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSDX lapas programmā Java"
description: "Izvelciet VSDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSDX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSDX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSDX lapas tiešsaistē"
    content: |
       Izņemiet VSDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdx).
