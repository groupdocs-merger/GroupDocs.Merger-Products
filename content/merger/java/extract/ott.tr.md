...
############################# Head ############################
head_title: "Java İçindeki OTT Sayfayı Çıkarın"
head_description: "Sayfaları bir OTT dosyasından Java içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "Java İçindeki OTT Sayfayı Çıkarın"
description: "OTT Sayfalarını birkaç satır Java koduyla çıkarın."
...
steps:
    enable: true
    title_left: "Java içindeki OTT Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin bir OTT dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTT dosya sayfaları nasıl ayıklanır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak OTT dosya sayfalarını çıkarın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi OTT Sayfayı Çıkarın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott) web sitesini ziyaret ederek OTT dosya sayfalarını hemen çıkarın.
