...
############################# Head ############################
head_title: "Izvilkt VSTM lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSTM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSTM lapas programmā Java"
description: "Izvelciet VSTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSTM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSTM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSTM lapas tiešsaistē"
    content: |
       Izņemiet VSTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm).
