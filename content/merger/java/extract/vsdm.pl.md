...
############################# Head ############################
head_title: "Wyodrębnij strony VSDM w Java"
head_description: "Szybko wyodrębnij strony z pliku VSDM w Java. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VSDM strony w Java"
description: "Wyodrębnij strony VSDM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VSDM w Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VSDM za pomocą przykładowego kodu Java">}}
