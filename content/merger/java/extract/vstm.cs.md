...
############################# Head ############################
head_title: "Extrahujte VSTM stránek v Java"
head_description: "Rychle extrahujte stránky ze souboru VSTM v Java. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte VSTM stránek v Java"
description: "Extrahujte VSTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Extrahujte VSTM stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java extrahovat požadované stránky ze souboru VSTM a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru VSTM pomocí ukázkového kódu Java">}}

        ```java    
        // Extrahujte stránky souboru VSTM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – extrahujte VSTM stránek online"
    content: |
       Extrahujte stránky souborů VSTM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vstm).
