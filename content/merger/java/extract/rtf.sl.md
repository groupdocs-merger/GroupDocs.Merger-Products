...
############################# Head ############################
head_title: "Ekstrahiraj RTF strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke RTF v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj RTF strani v Java"
description: "Izvlecite strani RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke RTF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke RTF in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke RTF s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke RTF z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte RTF strani na spletu"
    content: |
       Ekstrahirajte strani datoteke RTF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf).
