...
############################# Head ############################
head_title: "Di Java de RTF Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek RTF di Java de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên RTF Di Java de derxe"
description: "Rûpelên RTF bi çend rêzikên koda Java derxe."
...
steps:
    enable: true
    title_left: "Di Java de RTF Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku rûpelên xwestinê ji pelek RTF derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên RTF derxe">}}

        ```java    
        // Rûpelên pelê yên RTF bi kar tînin GroupDocs.Merger API derxînin
...
demos:
    enable: true
    title: "Demokên Zindî - Rûpelên Serhêl ên RTF derxînin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) niha rûpelên pelê yên RTF derxînin.
