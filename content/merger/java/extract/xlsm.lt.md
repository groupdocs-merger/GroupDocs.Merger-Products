...
############################# Head ############################
head_title: "Išskleiskite XLSM puslapius Java"
head_description: "Greitai išskleiskite puslapius iš XLSM failo Java. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLSM puslapius Java"
description: "Išskleiskite XLSM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLSM failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai išgauti norimus puslapius iš XLSM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLSM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Išskleiskite XLSM failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – ištraukite XLSM puslapius internete"
    content: |
       Išskleiskite XLSM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsm) svetainėje.
