...
############################# Head ############################
head_title: "Izvilkt VSDM lapas programmā Java"
head_description: "Ātri izvelciet lapas no VSDM faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt VSDM lapas programmā Java"
description: "Izvelciet VSDM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt VSDM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila VSDM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt VSDM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet VSDM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet VSDM lapas tiešsaistē"
    content: |
       Izņemiet VSDM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm).
