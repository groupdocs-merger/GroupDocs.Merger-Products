...
############################# Head ############################
head_title: "Ekstrak EPUB Halaman di Java"
head_description: "Ekstrak halaman dengan cepat dari file EPUB di Java. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EPUB Halaman Di Java"
description: "Ekstrak Halaman EPUB dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File EPUB di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk mengekstrak halaman yang diinginkan dari file EPUB dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file EPUB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak EPUB Halaman Online"
    content: |
       Ekstrak halaman file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/extract-pages/epub).
