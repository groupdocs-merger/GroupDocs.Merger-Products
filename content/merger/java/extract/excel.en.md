...
head_description: "Use GroupDocs.Merger for Java to extract specific pages from a EXCEL document and save them as a separate file."

############################# Header ############################
title: "Extract EXCEL pages" 
description: "With GroupDocs.Merger for Java, you can enhance your Java applications with powerful document processing features for EXCEL files."
...
steps:
    enable: true
    title: "How to extract EXCEL pages"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to extract pages from EXCEL documents easily. Enhance your Java applications by integrating advanced document management capabilities.
      
      1. Specify the file path of the source EXCEL document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example demonstrates how to extract a range of pages from a EXCEL document and save them as a separate file.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
