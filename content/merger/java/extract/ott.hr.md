...
############################# Head ############################
head_title: "Ekstrakt OTT stranica u Java"
head_description: "Brzo izdvojite stranice iz OTT datoteke u Java. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt OTT stranica u Java"
description: "Izdvojite OTT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ekstrakt OTT stranica datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima izdvajanje željenih stranica iz OTT datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti OTT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ekstrahirajte OTT stranice datoteke koristeći GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demonstracije uživo - izdvojite OTT stranica na mreži"
    content: |
       Izdvojite OTT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ott) web stranice.
