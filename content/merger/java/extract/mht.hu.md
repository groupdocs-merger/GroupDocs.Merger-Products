...
############################# Head ############################
head_title: "MHT oldal kibontása a Java nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy MHT fájlból a Java nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "MHT oldal kibontása a Java nyelven"
description: "Bontsa ki az MHT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "MHT fájloldal kibontása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy kivonják a kívánt oldalakat egy MHT fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájloldalak kibontása a Java példakóddal">}}

        ```java    
        // Bontsa ki az MHT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – MHT oldal online kibontása"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht) webhely meglátogatásával azonnal kibonthatja az MHT fájloldalakat.
