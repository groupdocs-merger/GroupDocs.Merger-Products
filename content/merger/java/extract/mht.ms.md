...
############################# Head ############################
head_title: "Ekstrak MHT Halaman dalam Java"
head_description: "Ekstrak halaman dengan cepat daripada fail MHT dalam Java. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak MHT Halaman Dalam Java"
description: "Ekstrak MHT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Ekstrak MHT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java mengekstrak halaman yang dikehendaki daripada fail MHT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak MHT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Ekstrak MHT halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Ekstrak MHT Halaman Dalam Talian"
    content: |
       Ekstrak MHT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/mht).
