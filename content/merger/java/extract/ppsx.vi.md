...
############################# Head ############################
head_title: "Trích xuất các trang PPSX trong Java"
head_description: "Nhanh chóng trích xuất các trang từ tệp PPSX trong Java. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất PPSX Trang trong Java"
description: "Trích xuất các Trang PPSX với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp PPSX trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng trích xuất các trang mong muốn từ tệp PPSX và lưu nó dưới dạng một tệp mới chứa các trang đã chọn bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp PPSX bằng mã mẫu Java">}}

        ```java    
        // Giải nén các trang tệp PPSX bằng API GroupDocs.Merger
...
demos:
    enable: true
    title: "Bản trình diễn trực tiếp - Trích xuất các trang PPSX Trực tuyến"
    content: |
       Giải nén các trang tệp PPSX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ ppsx) trang web.
