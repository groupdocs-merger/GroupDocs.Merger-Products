...
############################# Head ############################
head_title: "Java İçindeki ODT Sayfayı Çıkarın"
head_description: "Sayfaları bir ODT dosyasından Java içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "Java İçindeki ODT Sayfayı Çıkarın"
description: "ODT Sayfalarını birkaç satır Java koduyla çıkarın."
...
steps:
    enable: true
    title_left: "Java içindeki ODT Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin bir ODT dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODT dosya sayfaları nasıl ayıklanır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ODT dosya sayfalarını çıkarın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi ODT Sayfayı Çıkarın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/odt) web sitesini ziyaret ederek ODT dosya sayfalarını hemen çıkarın.
