...
############################# Head ############################
head_title: "Pura RTF sivua Java"
head_description: "Pura sivut nopeasti RTF-tiedostosta Java:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura RTF sivua Java"
description: "Pura RTF sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Pura RTF tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi purkaa halutut sivut RTF-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa RTF tiedostosivut käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Pura RTF tiedostosivua GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Pura RTF sivua verkossa"
    content: |
       Pura RTF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/rtf) -sivustolla.
