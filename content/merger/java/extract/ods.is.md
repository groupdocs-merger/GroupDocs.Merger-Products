...
############################# Head ############################
head_title: "Dragðu út ODS síður í Java"
head_description: "Dragðu síður út á fljótlegan hátt úr ODS skrá í Java. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út ODS síður í Java"
description: "Dragðu út ODS síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Dragðu út ODS skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar forriturum Java að draga þær síður sem óskað er eftir úr ODS skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út ODS skráarsíður með því að nota Java dæmi kóða">}}

        ```java    
        // Dragðu út ODS skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Dragðu út ODS síður á netinu"
    content: |
       Dragðu út ODS skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ods).
