...
############################# Head ############################
head_title: "Extraia DOC Páginas em Java"
head_description: "Extraia rapidamente páginas de um arquivo DOC em Java. Salve o novo documento que contém as páginas selecionadas usando a API de fusão de documentos."

############################# Header ############################
title: "Extraia DOC Páginas em Java"
description: "Extraia DOC Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Extrair páginas de arquivo DOC em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) torna mais fácil para os desenvolvedores do Java extrair as páginas desejadas de um arquivo DOC e salvá-lo como um novo arquivo contendo as páginas selecionadas implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como extrair páginas de arquivo DOC usando o código de exemplo Java">}}

        ```java    
        // Extraia páginas de arquivo DOC usando a API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Extraia DOC páginas on-line"
    content: |
       Extraia as páginas do arquivo DOC agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/doc).
