...
############################# Head ############################
head_title: "Izvilkt XLTX lapas programmā Java"
head_description: "Ātri izvelciet lapas no XLTX faila programmā Java. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLTX lapas programmā Java"
description: "Izvelciet XLTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java/lv/merger/java/) ļauj Java izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLTX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Izņemiet XLTX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešsaistes demonstrācijas — izņemiet XLTX lapas tiešsaistē"
    content: |
       Izņemiet XLTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xltx).
