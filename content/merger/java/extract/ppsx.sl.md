...
############################# Head ############################
head_title: "Ekstrahiraj PPSX strani v Java"
head_description: "Hitro ekstrahirajte strani iz datoteke PPSX v Java. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj PPSX strani v Java"
description: "Izvlecite strani PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke PPSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša ekstrahiranje želenih strani iz datoteke PPSX in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke PPSX s primerom kode Java">}}

        ```java    
        // Ekstrahirajte strani datoteke PPSX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - ekstrahirajte PPSX strani na spletu"
    content: |
       Ekstrahirajte strani datoteke PPSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/ppsx).
