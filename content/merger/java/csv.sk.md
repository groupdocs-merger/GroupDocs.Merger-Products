...
############################# Head ############################
head_title: "Zlúčiť súbory CSV cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero CSV súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "CSV Zlúčenie v Java"
description: "Zlúčte CSV s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero CSV súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov CSV vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory CSV pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť CSV súbory pomocou GroupDocs.Merger for Java API
