...
############################# Head ############################
head_title: "Slå sammen XLT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLT sammenslåing i Java"
description: "Slå sammen XLT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLT filer med GroupDocs.Merger for Java API
