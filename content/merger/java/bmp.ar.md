...
############################# Head ############################
head_title: "دمج ملفات BMP عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات BMP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "BMP الاندماج في Java"
description: "دمج BMP ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من BMP ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
