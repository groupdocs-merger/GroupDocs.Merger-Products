...
############################# Head ############################
head_title: "Zlúčiť súbory OTP cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero OTP súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "OTP Zlúčenie v Java"
description: "Zlúčte OTP s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero OTP súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov OTP vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory OTP pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť OTP súbory pomocou GroupDocs.Merger for Java API
