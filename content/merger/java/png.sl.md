...
############################# Head ############################
head_title: "Spoji datoteke PNG prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PNG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PNG Združitev v Java"
description: "Spojite PNG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PNG v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PNG s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PNG z API-jem GroupDocs.Merger for Java
