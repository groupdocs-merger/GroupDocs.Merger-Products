...
############################# Head ############################
head_title: "Ühendage VDX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VDX ühinemine programmis Java"
description: "Ühendage VDX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VDX faili, kasutades Java näitekoodi">}}
