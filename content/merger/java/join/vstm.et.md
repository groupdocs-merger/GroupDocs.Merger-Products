...
############################# Head ############################
head_title: "Liituge failidega VSTM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSTM failiga rakenduses Java"
description: "Liituge tootega VSTM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSTM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSTM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSTM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSTM, kasutades GroupDocs.Merger for Java API-t
