...
############################# Head ############################
head_title: "Prisijunkite prie VSSM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis VSSM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie VSSM failų Java"
description: "Prisijunkite prie VSSM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis VSSM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis VSSM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSSM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite VSSM failus naudodami GroupDocs.Merger for Java API
