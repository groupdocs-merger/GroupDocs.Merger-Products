...
############################# Head ############################
head_title: "Bergabunglah dengan WEB File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung WEB File Di Java"
description: "Bergabunglah dengan WEB dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file WEB menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file WEB menggunakan GroupDocs.Merger untuk Java API
