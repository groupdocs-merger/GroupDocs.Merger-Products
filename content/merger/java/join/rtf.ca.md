...
############################# Head ############################
head_title: "Uniu-vos a fitxers RTF mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers RTF a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a RTF fitxers a Java"
description: "Uniu-vos a RTF amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers RTF a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers RTF implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers RTF mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers RTF mitjançant l'API de GroupDocs.Merger per a Java
