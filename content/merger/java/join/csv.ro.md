...
############################# Head ############################
head_title: "Alăturați-vă fișierelor CSV prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Alăturați mai multe fișiere CSV în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Alăturați-vă fișierelor CSV în Java"
description: "Alăturați-vă CSV cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Alăturați mai multe fișiere CSV în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează alăturarea mai multor fișiere CSV dezvoltatorilor Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor CSV utilizând codul exemplu Java">}}

        ```java    
        // Alăturați-vă fișierelor CSV utilizând API-ul GroupDocs.Merger pentru Java
