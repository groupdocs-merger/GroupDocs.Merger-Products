...
############################# Head ############################
head_title: "Prisijunkite prie XLSB failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLSB failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLSB failų Java"
description: "Prisijunkite prie XLSB naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLSB failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLSB failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLSB failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLSB failus naudodami GroupDocs.Merger for Java API
