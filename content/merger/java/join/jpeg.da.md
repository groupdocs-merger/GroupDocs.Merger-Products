...
############################# Head ############################
head_title: "Deltag i JPEG filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere JPEG-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i JPEG filer i Java"
description: "Slut dig til JPEG med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere JPEG-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere JPEG-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du JPEG filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i JPEG filer ved hjælp af GroupDocs.Merger for Java API
