...
############################# Head ############################
head_title: "Liituge failidega XLAM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLAM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLAM failiga rakenduses Java"
description: "Liituge tootega XLAM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLAM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLAM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLAM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLAM, kasutades GroupDocs.Merger for Java API-t
