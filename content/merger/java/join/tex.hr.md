...
############################# Head ############################
head_title: "Pridružite TEX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više TEX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite TEX datotekama u Java"
description: "Pridružite se TEX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više TEX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti TEX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite TEX datoteke koristeći GroupDocs.Merger za Java API
