...
############################# Head ############################
head_title: "Sertai DOTM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOTM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOTM Fail Dalam Java"
description: "Sertai DOTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOTM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOTM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOTM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOTM fail menggunakan GroupDocs.Merger untuk API Java
