...
############################# Head ############################
head_title: "Liituge failidega TSV Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge TSV failiga rakenduses Java"
description: "Liituge tootega TSV mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu TSV faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme TSV faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TSV faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid TSV, kasutades GroupDocs.Merger for Java API-t
