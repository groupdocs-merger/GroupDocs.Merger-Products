...
############################# Head ############################
head_title: "Pridružite DOTM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOTM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite DOTM datotekama u Java"
description: "Pridružite se DOTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više DOTM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOTM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite DOTM datoteke koristeći GroupDocs.Merger za Java API
...
demos:
    ...
    content: |
       Pridružite se više od jedne DOTM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
