...
############################# Head ############################
head_title: "Csatlakozzon a ODP fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több ODP fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás ODP fájlhoz itt: Java"
description: "Csatlakozzon az ODP termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több ODP fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több ODP fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson ODP fájlt a GroupDocs.Merger for Java API segítségével
