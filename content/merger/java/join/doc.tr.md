...
############################# Head ############################
head_title: "DOC Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla DOC dosyasına katılın."

############################# Header ############################
title: "Java İçindeki DOC Dosyaya Katılın"
description: "Birkaç satır Java koduyla DOC'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok DOC Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok DOC dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOC dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOC dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) web sitesini ziyaret ederek birden fazla DOC dosyasına hemen katılın.
