...
############################# Head ############################
head_title: "Sertai OTP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail OTP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai OTP Fail Dalam Java"
description: "Sertai OTP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang OTP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail OTP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail OTP menggunakan kod contoh Java.">}}

        ```java    
        // Sertai OTP fail menggunakan GroupDocs.Merger untuk API Java
