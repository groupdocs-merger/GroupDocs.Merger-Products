...
############################# Head ############################
head_title: "Word lid van XLTM bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere XLTM-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van XLTM bestanden in Java"
description: "Sluit je aan bij XLTM met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere XLTM bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere XLTM-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u XLTM bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van XLTM bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één XLTM-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) te gaan.
