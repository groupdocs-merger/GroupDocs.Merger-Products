...
############################# Head ############################
head_title: "Sertai XLT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLT Fail Dalam Java"
description: "Sertai XLT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLT fail menggunakan GroupDocs.Merger untuk API Java
