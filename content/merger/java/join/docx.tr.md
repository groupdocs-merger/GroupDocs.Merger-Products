...
############################# Head ############################
head_title: "DOCX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla DOCX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki DOCX Dosyaya Katılın"
description: "Birkaç satır Java koduyla DOCX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok DOCX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok DOCX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOCX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOCX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) web sitesini ziyaret ederek birden fazla DOCX dosyasına hemen katılın.
