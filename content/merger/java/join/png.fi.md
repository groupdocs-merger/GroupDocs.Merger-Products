...
############################# Head ############################
head_title: "Liity PNG-tiedostoihin Java & J2SE Documents Merger API:n kautta"
head_description: "Liitä useita PNG-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "Liity PNG tiedostoon Java"
description: "Liity kohtaan PNG muutamalla rivillä Java-koodia."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tarjoaa kätevän ratkaisun useiden PDF-, Microsoft Office- (Word, Excel, PowerPoint, OneNote), OpenDocument-, HTML-, kuvien ja monet muut asiakirjat yhdeksi tiedostoksi Java sovelluksissa. GroupDocs.Merger säästää paljon vaivaa, koska voit liittyä PNG asiakirjoihin - sinun ei tarvitse asentaa kolmannen osapuolen ohjelmistoja, työpöytäsovelluksia tai laajennuksia. Nyt on turhaa tuhlata aikaasi ja yhdistää tiedostoja manuaalisesti! GroupDocsin tehtävänä on tarjota parasta laatua ja yksinkertaistaa asiakirjankäsittelyn työnkulkuja.
...
steps:
    enable: true
    title_left: "Liitä useita PNG tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) helpottaa Java-kehittäjien liittämistä useisiin PNG tiedostoihin muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka liittää PNG tiedostot käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Liitä PNG tiedostot GroupDocs.Merger for Java API:lla
