...
############################# Head ############################
head_title: "Liituge failidega RTF Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu RTF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge RTF failiga rakenduses Java"
description: "Liituge tootega RTF mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu RTF faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme RTF faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada RTF faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid RTF, kasutades GroupDocs.Merger for Java API-t
