...
############################# Head ############################
head_title: "Unir archivos TIFF en Java"
head_description: "Utilice GroupDocs.Merger for Java para agregar capacidades de unión de documentos TIFF a sus aplicaciones Java."

############################# Header ############################
title: "Unir archivos TIFF" 
description: "GroupDocs.Merger for Java le permite desarrollar aplicaciones Java que unen eficientemente múltiples documentos TIFF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) proporciona una forma sencilla de unir documentos TIFF. Mejore sus aplicaciones Java combinando múltiples archivos en uno.
      
      1. Especifique la ruta al primer archivo TIFF.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicializar Merger con el documento de entrada TIFF
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas específicas de diferentes formatos de documentos"
      content: |
        Este ejemplo muestra cómo unir archivos TIFF seleccionando páginas específicas de otros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
