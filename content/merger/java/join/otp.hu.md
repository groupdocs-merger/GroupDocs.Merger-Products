...
############################# Head ############################
head_title: "Csatlakozzon a OTP fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több OTP fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás OTP fájlhoz itt: Java"
description: "Csatlakozzon az OTP termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több OTP fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több OTP fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson OTP fájlt a GroupDocs.Merger for Java API segítségével
