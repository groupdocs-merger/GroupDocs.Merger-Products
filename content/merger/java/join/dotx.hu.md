...
############################# Head ############################
head_title: "Csatlakozzon a DOTX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több DOTX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás DOTX fájlhoz itt: Java"
description: "Csatlakozzon az DOTX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több DOTX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több DOTX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson DOTX fájlt a GroupDocs.Merger for Java API segítségével
