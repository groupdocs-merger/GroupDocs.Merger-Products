...
############################# Head ############################
head_title: "Tham gia các tệp VSDX qua API hợp nhất tài liệu Java & J2SE"
head_description: "Nối nhiều tệp VSDX trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Tham gia VSDX Tệp trong Java"
description: "Tham gia VSDX với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Nối Nhiều VSDX Tệp trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp VSDX bằng mã mẫu Java">}}

        ```java    
        // Nối các tệp VSDX bằng GroupDocs.Merger cho Java API
