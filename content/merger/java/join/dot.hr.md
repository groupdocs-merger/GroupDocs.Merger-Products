...
############################# Head ############################
head_title: "Pridružite DOT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite DOT datotekama u Java"
description: "Pridružite se DOT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više DOT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite DOT datoteke koristeći GroupDocs.Merger za Java API
