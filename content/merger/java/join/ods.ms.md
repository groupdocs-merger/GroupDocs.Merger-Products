...
############################# Head ############################
head_title: "Sertai ODS Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail ODS dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai ODS Fail Dalam Java"
description: "Sertai ODS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang ODS Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail ODS dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail ODS menggunakan kod contoh Java.">}}

        ```java    
        // Sertai ODS fail menggunakan GroupDocs.Merger untuk API Java
