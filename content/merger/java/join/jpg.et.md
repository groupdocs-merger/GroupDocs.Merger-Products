...
############################# Head ############################
head_title: "Liituge failidega JPG Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu JPG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge JPG failiga rakenduses Java"
description: "Liituge tootega JPG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu JPG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme JPG faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada JPG faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid JPG, kasutades GroupDocs.Merger for Java API-t
