...
############################# Head ############################
head_title: "Sertai RTF Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail RTF dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai RTF Fail Dalam Java"
description: "Sertai RTF dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang RTF Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail RTF dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail RTF menggunakan kod contoh Java.">}}

        ```java    
        // Sertai RTF fail menggunakan GroupDocs.Merger untuk API Java
