...
############################# Head ############################
head_title: "Glac páirt i VSTM Comhaid trí Java & J2SE Documents Merger API"
head_description: "Glac le comhaid VSTM iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Glac páirt i VSTM Comhaid in Java"
description: "Ceangail VSTM le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Glac páirt i gcomhad iolracha VSTM in Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java dul isteach i gcomhad iolracha VSTM trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas páirt a ghlacadh i gcomhaid VSTM trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Glac páirt i gcomhaid VSTM le GroupDocs.Merger le haghaidh Java API
