...
############################# Head ############################
head_title: "Prisijunkite prie XLSX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLSX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLSX failų Java"
description: "Prisijunkite prie XLSX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLSX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLSX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLSX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLSX failus naudodami GroupDocs.Merger for Java API
