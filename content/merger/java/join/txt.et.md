...
############################# Head ############################
head_title: "Liituge failidega TXT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TXT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge TXT failiga rakenduses Java"
description: "Liituge tootega TXT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu TXT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme TXT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TXT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid TXT, kasutades GroupDocs.Merger for Java API-t
