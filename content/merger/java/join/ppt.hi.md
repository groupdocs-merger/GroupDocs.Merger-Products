...
############################# Head ############################
head_title: "PPT जावा और J2SE दस्तावेज़ मर्जर API के माध्यम से फ़ाइलें शामिल हों"
head_description: "स्रोत दस्तावेज़ के रूप में सभी डेटा, शैली और स्वरूपण के साथ दस्तावेज़ विलय API का उपयोग करके जावा में एकाधिक PPT फ़ाइलों में शामिल हों।"

############################# Header ############################
title: "PPT फ़ाइलें Java में शामिल हों"
...
steps:
    enable: true
    title_left: "Java में कई PPT फाइलों में शामिल हों"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) जावा डेवलपर्स के लिए कुछ आसान चरणों को लागू करके कई PPT फाइलों में शामिल होना आसान बनाता है।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके PPT फ़ाइलों में कैसे शामिल हों">}}

        ```java    
        // GroupDocs.Merger for Java API का उपयोग करके PPT फाइलों में शामिल हों
