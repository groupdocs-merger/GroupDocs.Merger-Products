...
############################# Head ############################
head_title: "Csatlakozzon a XLS fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több XLS fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás XLS fájlhoz itt: Java"
description: "Csatlakozzon az XLS termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több XLS fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több XLS fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson XLS fájlt a GroupDocs.Merger for Java API segítségével
