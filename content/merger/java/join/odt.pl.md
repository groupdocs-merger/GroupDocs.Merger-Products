...
############################# Head ############################
head_title: "Dołącz do plików ODT przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików ODT w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do ODT plików w Java"
description: "Dołącz do ODT za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików ODT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików ODT, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików ODT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików ODT za pomocą GroupDocs.Merger for Java API
