...
############################# Head ############################
head_title: "Gå med i ODP filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera ODP-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i ODP-filer i Java"
description: "Gå med i ODP med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera ODP-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera ODP-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i ODP-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i ODP-filer med GroupDocs.Merger för Java API
