...
############################# Head ############################
head_title: "Liituge failidega DOCX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOCX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOCX failiga rakenduses Java"
description: "Liituge tootega DOCX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOCX faili, kasutades Java näitekoodi">}}
