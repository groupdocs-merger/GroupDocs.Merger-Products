...
############################# Head ############################
head_title: "Liituge failidega PPT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge PPT failiga rakenduses Java"
description: "Liituge tootega PPT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu PPT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme PPT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid PPT, kasutades GroupDocs.Merger for Java API-t
