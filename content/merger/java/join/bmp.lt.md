...
############################# Head ############################
head_title: "Prisijunkite prie BMP failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis BMP failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie BMP failų Java"
description: "Prisijunkite prie BMP naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis BMP failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis BMP failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti BMP failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite BMP failus naudodami GroupDocs.Merger for Java API
