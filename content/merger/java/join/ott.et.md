...
############################# Head ############################
head_title: "Liituge failidega OTT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu OTT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge OTT failiga rakenduses Java"
description: "Liituge tootega OTT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada OTT faili, kasutades Java näitekoodi">}}
