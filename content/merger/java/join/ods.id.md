...
############################# Head ############################
head_title: "Bergabunglah dengan ODS File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung ODS File Di Java"
description: "Bergabunglah dengan ODS dengan beberapa baris kode Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file ODS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ODS menggunakan kode contoh Java">}}

        ```java    
        // Bergabunglah dengan file ODS menggunakan GroupDocs.Merger untuk Java API
