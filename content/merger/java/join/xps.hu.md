...
############################# Head ############################
head_title: "Csatlakozzon a XPS fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több XPS fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás XPS fájlhoz itt: Java"
description: "Csatlakozzon az XPS termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több XPS fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több XPS fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson XPS fájlt a GroupDocs.Merger for Java API segítségével
