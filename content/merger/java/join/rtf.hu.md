...
############################# Head ############################
head_title: "Csatlakozzon a RTF fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több RTF fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás RTF fájlhoz itt: Java"
description: "Csatlakozzon az RTF termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több RTF fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több RTF fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson RTF fájlt a GroupDocs.Merger for Java API segítségével
