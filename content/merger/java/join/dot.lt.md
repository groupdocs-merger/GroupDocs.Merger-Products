...
############################# Head ############################
head_title: "Prisijunkite prie DOT failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis DOT failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie DOT failų Java"
description: "Prisijunkite prie DOT naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis DOT failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis DOT failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOT failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite DOT failus naudodami GroupDocs.Merger for Java API
