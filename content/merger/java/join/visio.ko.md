...
############################# Head ############################
head_title: "Java에서 VISIO 파일 합치기"
head_description: "Java 애플리케이션에 VISIO 문서 병합 기능을 추가하기 위해 GroupDocs.Merger for Java를 사용하세요."

############################# Header ############################
title: "VISIO 파일 병합" 
description: "GroupDocs.Merger for Java를 통해 여러 VISIO 문서를 효과적으로 병합하는 Java 애플리케이션을 개발할 수 있습니다."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)는 VISIO 문서를 병합하는 간편한 방법을 제공합니다. 여러 파일을 하나로 결합하여 Java 애플리케이션을 강화하세요.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "다양한 문서 형식에서 특정 페이지 병합"
      content: |
        이 예제는 다른 형식에서 특정 페이지를 선택하면서 VISIO 파일을 병합하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
