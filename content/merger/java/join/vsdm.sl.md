...
############################# Head ############################
head_title: "Pridružite se datotekam VSDM prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam VSDM v Java"
description: "Pridružite se VSDM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam VSDM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSDM s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam VSDM z API-jem GroupDocs.Merger za Java
...
demos:
    ...
    content: |
       Pridružite se več kot eni VSDM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
