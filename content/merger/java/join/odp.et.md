...
############################# Head ############################
head_title: "Liituge failidega ODP Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ODP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge ODP failiga rakenduses Java"
description: "Liituge tootega ODP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu ODP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme ODP faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ODP faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid ODP, kasutades GroupDocs.Merger for Java API-t
