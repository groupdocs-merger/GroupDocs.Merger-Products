...
############################# Head ############################
head_title: "Word lid van OTT bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere OTT-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van OTT bestanden in Java"
description: "Sluit je aan bij OTT met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere OTT bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere OTT-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u OTT bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van OTT bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één OTT-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) te gaan.
