...
############################# Head ############################
head_title: "Dołącz do plików VSDX przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików VSDX w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do VSDX plików w Java"
description: "Dołącz do VSDX za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików VSDX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików VSDX, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików VSDX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików VSDX za pomocą GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego VSDX plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
