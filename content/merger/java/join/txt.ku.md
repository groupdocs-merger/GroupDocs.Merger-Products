...
############################# Head ############################
head_title: "Tevlî pelên TXT bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên TXT li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên TXT Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî TXT bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek TXT Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên TXT bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên TXT dibe">}}

        ```java    
        // Tevlî pelên TXT bibin bi karanîna GroupDocs.Merger ji bo Java API
