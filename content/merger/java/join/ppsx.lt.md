...
############################# Head ############################
head_title: "Prisijunkite prie PPSX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis PPSX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie PPSX failų Java"
description: "Prisijunkite prie PPSX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis PPSX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis PPSX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PPSX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite PPSX failus naudodami GroupDocs.Merger for Java API
