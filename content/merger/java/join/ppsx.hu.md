...
############################# Head ############################
head_title: "Csatlakozzon a PPSX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több PPSX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás PPSX fájlhoz itt: Java"
description: "Csatlakozzon az PPSX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több PPSX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több PPSX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson PPSX fájlt a GroupDocs.Merger for Java API segítségével
