...
############################# Head ############################
head_title: "RTF Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla RTF dosyasına katılın."

############################# Header ############################
title: "Java İçindeki RTF Dosyaya Katılın"
description: "Birkaç satır Java koduyla RTF'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok RTF Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok RTF dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak RTF dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak RTF dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) web sitesini ziyaret ederek birden fazla RTF dosyasına hemen katılın.
