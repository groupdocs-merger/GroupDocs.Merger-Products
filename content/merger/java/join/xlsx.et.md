...
############################# Head ############################
head_title: "Liituge failidega XLSX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLSX failiga rakenduses Java"
description: "Liituge tootega XLSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLSX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLSX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLSX, kasutades GroupDocs.Merger for Java API-t
