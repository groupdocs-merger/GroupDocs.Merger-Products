...
############################# Head ############################
head_title: "Prisijunkite prie XLSM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLSM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLSM failų Java"
description: "Prisijunkite prie XLSM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLSM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLSM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLSM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLSM failus naudodami GroupDocs.Merger for Java API
