...
############################# Head ############################
head_title: "Sertai ODP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail ODP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai ODP Fail Dalam Java"
description: "Sertai ODP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang ODP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail ODP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail ODP menggunakan kod contoh Java.">}}

        ```java    
        // Sertai ODP fail menggunakan GroupDocs.Merger untuk API Java
