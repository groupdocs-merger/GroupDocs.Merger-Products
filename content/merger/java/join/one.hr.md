...
############################# Head ############################
head_title: "Pridružite ONE datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više ONE datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite ONE datotekama u Java"
description: "Pridružite se ONE s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više ONE datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ONE datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite ONE datoteke koristeći GroupDocs.Merger za Java API
