...
############################# Head ############################
head_title: "Word lid van PDF bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere PDF-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van PDF bestanden in Java"
description: "Sluit je aan bij PDF met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere PDF bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere PDF-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u PDF bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van PDF bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één PDF-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) te gaan.
