...
############################# Head ############################
head_title: "Bergabunglah dengan ONENOTE File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung ONENOTE File Di Java"
description: "Bergabunglah dengan ONENOTE dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ONENOTE menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file ONENOTE menggunakan GroupDocs.Merger untuk Java API
