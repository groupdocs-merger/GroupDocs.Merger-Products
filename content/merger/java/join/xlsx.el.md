...
############################# Head ############################
head_title: "Εγγραφείτε στα αρχεία XLSX μέσω Java & J2SE Documents Merger API"
head_description: "Συνδέστε πολλά αρχεία XLSX σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία XLSX σε Java"
description: "Εγγραφείτε στο XLSX με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συμμετοχή σε πολλά XLSX αρχεία στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να ενώσουν πολλά αρχεία XLSX εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία XLSX χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Εγγραφείτε σε αρχεία XLSX χρησιμοποιώντας το GroupDocs.Merger for Java API
        // Άμεση συγχώνευση με το έγγραφο εισαγωγής XLSX
...
demos:
    ...
    content: |
       Εγγραφείτε σε περισσότερα από ένα αρχεία XLSX αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
