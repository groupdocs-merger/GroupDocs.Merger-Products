...
############################# Head ############################
head_title: "Sertai XLS Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLS dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLS Fail Dalam Java"
description: "Sertai XLS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLS Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLS dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLS menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLS fail menggunakan GroupDocs.Merger untuk API Java
