...
############################# Head ############################
head_title: "Pridružite DOC datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOC datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite DOC datotekama u Java"
description: "Pridružite se DOC s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više DOC datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOC datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite DOC datoteke koristeći GroupDocs.Merger za Java API
