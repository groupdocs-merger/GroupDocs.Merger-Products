...
############################# Head ############################
head_title: "Sertai VSDX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSDX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSDX Fail Dalam Java"
description: "Sertai VSDX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSDX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSDX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSDX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSDX fail menggunakan GroupDocs.Merger untuk API Java
