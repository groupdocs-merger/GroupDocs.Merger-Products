...
############################# Head ############################
head_title: "Csatlakozzon a VSDM fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több VSDM fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás VSDM fájlhoz itt: Java"
description: "Csatlakozzon az VSDM termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több VSDM fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több VSDM fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson VSDM fájlt a GroupDocs.Merger for Java API segítségével
