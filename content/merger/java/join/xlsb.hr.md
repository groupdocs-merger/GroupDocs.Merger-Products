...
############################# Head ############################
head_title: "Pridružite XLSB datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLSB datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLSB datotekama u Java"
description: "Pridružite se XLSB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLSB datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSB datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLSB datoteke koristeći GroupDocs.Merger za Java API
