...
############################# Head ############################
head_title: "Sertai EPUB Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail EPUB dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai EPUB Fail Dalam Java"
description: "Sertai EPUB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang EPUB Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail EPUB dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail EPUB menggunakan kod contoh Java.">}}

        ```java    
        // Sertai EPUB fail menggunakan GroupDocs.Merger untuk API Java
