...
############################# Head ############################
head_title: "Pridružite VSDX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSDX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSDX datotekama u Java"
description: "Pridružite se VSDX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSDX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSDX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSDX datoteke koristeći GroupDocs.Merger za Java API
