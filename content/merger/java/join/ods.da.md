...
############################# Head ############################
head_title: "Deltag i ODS filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere ODS-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i ODS filer i Java"
description: "Slut dig til ODS med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere ODS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere ODS-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du ODS filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i ODS filer ved hjælp af GroupDocs.Merger for Java API
