...
############################# Head ############################
head_title: "Միացեք ODP Ֆայլերին Java & J2SE Documents Merger API-ի միջոցով"
head_description: "Միացրեք բազմաթիվ ODP ֆայլեր Java-ում՝ օգտագործելով փաստաթղթերի միաձուլման API՝ բոլոր տվյալները, ոճը և ձևաչափումը որպես սկզբնաղբյուր փաստաթղթեր:"

############################# Header ############################
title: "Միացեք ODP ֆայլերին Java-ում"
description: "Միացեք ODP-ին Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Միացեք բազմաթիվ ODP ֆայլերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) Java ծրագրավորողների համար հեշտացնում է մի քանի ODP ֆայլեր միանալը մի քանի հեշտ քայլերի միջոցով:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել ODP ֆայլեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Միացե՛ք ODP ֆայլեր՝ օգտագործելով GroupDocs.Merger Java API-ի համար
