...
head_description: "Verwenden Sie GroupDocs.Merger for Java, um VISIO-Dokumenten zusammenführende Funktionen zu Ihren Java-Anwendungen hinzuzufügen."

############################# Header ############################
title: "VISIO-Dateien zusammenführen" 
description: "GroupDocs.Merger for Java ermöglicht die Entwicklung von Java-Anwendungen, die effizient mehrere VISIO-Dokumente zusammenführen."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) bietet eine Möglichkeit, VISIO-Dokumente zusammenzuführen. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien zu einer zusammenfassen.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingabedokument VISIO initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus verschiedenen Dokumentformaten zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man VISIO-Dateien zusammenführt und dabei bestimmte Seiten aus anderen Formaten auswählt.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
