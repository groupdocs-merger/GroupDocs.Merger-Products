...
############################# Head ############################
head_title: "Csatlakozzon a DOTM fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több DOTM fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás DOTM fájlhoz itt: Java"
description: "Csatlakozzon az DOTM termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több DOTM fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több DOTM fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson DOTM fájlt a GroupDocs.Merger for Java API segítségével
