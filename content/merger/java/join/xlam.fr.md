...
############################# Head ############################
head_title: "Joindre XLAM fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Joignez plusieurs fichiers XLAM en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Joindre XLAM fichiers dans Java"
description: "Joignez XLAM avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Joindre plusieurs fichiers XLAM dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de joindre facilement plusieurs fichiers XLAM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment joindre des fichiers XLAM à l'aide de l'exemple de code Java">}}

        ```java    
        // Joindre des fichiers XLAM à l'aide de l'API GroupDocs.Merger pour Java
