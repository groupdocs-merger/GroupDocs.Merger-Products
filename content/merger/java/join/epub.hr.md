...
############################# Head ############################
head_title: "Pridružite EPUB datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više EPUB datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite EPUB datotekama u Java"
description: "Pridružite se EPUB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više EPUB datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima spajanje više EPUB datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti EPUB datoteke koristeći Java primjer koda">}}

        ```java    
        // Pridružite EPUB datoteke koristeći GroupDocs.Merger za Java API
