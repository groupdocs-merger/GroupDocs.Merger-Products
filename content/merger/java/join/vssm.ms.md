...
############################# Head ############################
head_title: "Sertai VSSM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSSM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSSM Fail Dalam Java"
description: "Sertai VSSM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSSM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSSM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSSM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSSM fail menggunakan GroupDocs.Merger untuk API Java
