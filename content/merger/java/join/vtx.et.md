...
############################# Head ############################
head_title: "Liituge failidega VTX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VTX failiga rakenduses Java"
description: "Liituge tootega VTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VTX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VTX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VTX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe VTX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
