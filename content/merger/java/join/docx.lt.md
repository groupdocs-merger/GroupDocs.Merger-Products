...
############################# Head ############################
head_title: "Prisijunkite prie DOCX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis DOCX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie DOCX failų Java"
description: "Prisijunkite prie DOCX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis DOCX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis DOCX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOCX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite DOCX failus naudodami GroupDocs.Merger for Java API
