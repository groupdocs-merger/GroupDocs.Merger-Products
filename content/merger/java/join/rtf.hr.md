...
############################# Head ############################
head_title: "Pridružite RTF datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više RTF datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite RTF datotekama u Java"
description: "Pridružite se RTF s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više RTF datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti RTF datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite RTF datoteke koristeći GroupDocs.Merger za Java API
