...
############################# Head ############################
head_title: "PPT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla PPT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki PPT Dosyaya Katılın"
description: "Birkaç satır Java koduyla PPT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok PPT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok PPT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) web sitesini ziyaret ederek birden fazla PPT dosyasına hemen katılın.
