...
############################# Head ############################
head_title: "Pridružite OTT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više OTT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite OTT datotekama u Java"
description: "Pridružite se OTT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više OTT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti OTT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite OTT datoteke koristeći GroupDocs.Merger za Java API
...
demos:
    ...
    content: |
       Pridružite se više od jedne OTT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
