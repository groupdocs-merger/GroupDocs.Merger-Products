...
############################# Head ############################
head_title: "Sertai DOT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOT Fail Dalam Java"
description: "Sertai DOT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOT fail menggunakan GroupDocs.Merger untuk API Java
