...
############################# Head ############################
head_title: "Tevlî pelên XPS bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên XPS li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên XPS Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî XPS bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek XPS Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên XPS bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên XPS dibe">}}

        ```java    
        // Tevlî pelên XPS bibin bi karanîna GroupDocs.Merger ji bo Java API
