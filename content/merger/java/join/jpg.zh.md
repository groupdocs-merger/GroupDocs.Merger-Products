...
head_description: "使用GroupDocs.Merger for Java为您的Java应用程序添加JPG文档合并功能。"

############################# Header ############################
title: "合并JPG文件" 
description: "GroupDocs.Merger for Java使您能够开发高效合并多个JPG文档的Java应用程序。"
...
steps:
    ...
    title: "如何合并JPG文档"
    content: |
      [GroupDocs.Merger](/merger/java/) 提供了一种合并JPG文档的简便方法。通过将多个文件合并为一个，增强您的Java应用程序。
