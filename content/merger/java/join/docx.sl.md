...
############################# Head ############################
head_title: "Pridružite se datotekam DOCX prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam DOCX v Java"
description: "Pridružite se DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam DOCX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCX s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam DOCX z API-jem GroupDocs.Merger za Java
