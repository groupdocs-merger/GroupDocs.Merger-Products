...
############################# Head ############################
head_title: "Word lid van XLSM bestanden via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Word lid van XLSM bestanden in Java"
description: "Sluit je aan bij XLSM met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere XLSM bestanden in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u XLSM bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van XLSM bestanden met behulp van GroupDocs.Merger voor Java API
