...
############################# Head ############################
head_title: "Prisijunkite prie XLS failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLS failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLS failų Java"
description: "Prisijunkite prie XLS naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLS failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLS failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLS failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLS failus naudodami GroupDocs.Merger for Java API
