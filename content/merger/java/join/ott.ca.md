...
############################# Head ############################
head_title: "Uniu-vos a fitxers OTT mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers OTT a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a OTT fitxers a Java"
description: "Uniu-vos a OTT amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers OTT a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers OTT implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers OTT mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers OTT mitjançant l'API de GroupDocs.Merger per a Java
