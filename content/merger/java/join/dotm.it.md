...
############################# Head ############################
head_title: "Unisciti a DOTM file tramite Java e J2SE Documents Merger API"
...
############################# Header ############################
title: "Unisciti a DOTM file in Java"
description: "Unisciti a DOTM con poche righe di codice Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/it/merger/java/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni Java. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unirti a DOTM documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori Java di unire facilmente più file DOTM implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file DOTM utilizzando il codice di esempio Java">}}
        ...
        ```java    
        // Unisciti ai file DOTM utilizzando GroupDocs.Merger per l'API Java
