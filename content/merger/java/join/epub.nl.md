...
############################# Head ############################
head_title: "Word lid van EPUB bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere EPUB-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van EPUB bestanden in Java"
description: "Sluit je aan bij EPUB met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere EPUB bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere EPUB-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u EPUB bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van EPUB bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één EPUB-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) te gaan.
