...
############################# Head ############################
head_title: "JPG Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla JPG dosyasına katılın."

############################# Header ############################
title: "Java İçindeki JPG Dosyaya Katılın"
description: "Birkaç satır Java koduyla JPG'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok JPG Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok JPG dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak JPG dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak JPG dosyalarına katılın
