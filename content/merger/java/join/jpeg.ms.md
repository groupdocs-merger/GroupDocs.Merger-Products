...
############################# Head ############################
head_title: "Sertai JPEG Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail JPEG dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai JPEG Fail Dalam Java"
description: "Sertai JPEG dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang JPEG Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail JPEG dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail JPEG menggunakan kod contoh Java.">}}

        ```java    
        // Sertai JPEG fail menggunakan GroupDocs.Merger untuk API Java
