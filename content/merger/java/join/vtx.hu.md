...
############################# Head ############################
head_title: "Csatlakozzon a VTX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több VTX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás VTX fájlhoz itt: Java"
description: "Csatlakozzon az VTX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több VTX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több VTX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson VTX fájlt a GroupDocs.Merger for Java API segítségével
