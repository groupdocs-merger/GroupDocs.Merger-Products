...
############################# Head ############################
head_title: "Csatlakozzon a DOT fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több DOT fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás DOT fájlhoz itt: Java"
description: "Csatlakozzon az DOT termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több DOT fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több DOT fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson DOT fájlt a GroupDocs.Merger for Java API segítségével
