...
############################# Head ############################
head_title: "Glac páirt i PNG Comhaid trí Java & J2SE Documents Merger API"
head_description: "Glac le comhaid PNG iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Glac páirt i PNG Comhaid in Java"
description: "Ceangail PNG le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Glac páirt i gcomhad iolracha PNG in Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java dul isteach i gcomhad iolracha PNG trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas páirt a ghlacadh i gcomhaid PNG trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Glac páirt i gcomhaid PNG le GroupDocs.Merger le haghaidh Java API
