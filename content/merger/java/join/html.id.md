...
############################# Head ############################
head_title: "Gabung berkas HTML dalam Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen HTML ke aplikasi Java Anda."

############################# Header ############################
title: "Gabung berkas HTML" 
description: "GroupDocs.Merger for Java memungkinkan Anda mengembangkan aplikasi Java yang secara efisien menggabungkan beberapa dokumen HTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan cara untuk menggabungkan dokumen HTML. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalan ke berkas HTML pertama.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inisialisasi Merger dengan dokumen HTML input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berbagai format dokumen"
      content: |
        Contoh ini menunjukkan cara menggabungkan berkas HTML sambil memilih halaman tertentu dari format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
