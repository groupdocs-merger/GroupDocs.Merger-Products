...
############################# Head ############################
head_title: "DOTM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla DOTM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki DOTM Dosyaya Katılın"
description: "Birkaç satır Java koduyla DOTM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok DOTM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok DOTM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOTM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOTM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) web sitesini ziyaret ederek birden fazla DOTM dosyasına hemen katılın.
