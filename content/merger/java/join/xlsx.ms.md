...
############################# Head ############################
head_title: "Sertai XLSX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLSX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLSX Fail Dalam Java"
description: "Sertai XLSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLSX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLSX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLSX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLSX fail menggunakan GroupDocs.Merger untuk API Java
