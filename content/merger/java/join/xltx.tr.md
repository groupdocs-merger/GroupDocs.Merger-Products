...
############################# Head ############################
head_title: "XLTX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLTX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLTX Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLTX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLTX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLTX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLTX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLTX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) web sitesini ziyaret ederek birden fazla XLTX dosyasına hemen katılın.
