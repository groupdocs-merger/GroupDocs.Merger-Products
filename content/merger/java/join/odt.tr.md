...
############################# Head ############################
head_title: "ODT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla ODT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki ODT Dosyaya Katılın"
description: "Birkaç satır Java koduyla ODT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok ODT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok ODT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) web sitesini ziyaret ederek birden fazla ODT dosyasına hemen katılın.
