...
############################# Head ############################
head_title: "Word lid van PPS bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere PPS-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van PPS bestanden in Java"
description: "Sluit je aan bij PPS met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere PPS bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere PPS-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u PPS bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van PPS bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één PPS-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) te gaan.
