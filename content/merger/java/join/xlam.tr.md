...
############################# Head ############################
head_title: "XLAM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLAM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLAM Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLAM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLAM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLAM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLAM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLAM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) web sitesini ziyaret ederek birden fazla XLAM dosyasına hemen katılın.
