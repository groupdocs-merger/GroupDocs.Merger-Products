...
############################# Head ############################
head_title: "Liituge failidega PPSX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge PPSX failiga rakenduses Java"
description: "Liituge tootega PPSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu PPSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme PPSX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPSX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid PPSX, kasutades GroupDocs.Merger for Java API-t
