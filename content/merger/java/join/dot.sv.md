...
############################# Head ############################
head_title: "Gå med i DOT filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera DOT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i DOT-filer i Java"
description: "Gå med i DOT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera DOT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera DOT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i DOT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i DOT-filer med GroupDocs.Merger för Java API
