...
############################# Head ############################
head_title: "Gå med i PPS filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera PPS-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i PPS-filer i Java"
description: "Gå med i PPS med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera PPS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera PPS-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i PPS-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i PPS-filer med GroupDocs.Merger för Java API
