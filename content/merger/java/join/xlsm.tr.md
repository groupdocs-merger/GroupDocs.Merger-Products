...
############################# Head ############################
head_title: "XLSM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLSM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLSM Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLSM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLSM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLSM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) web sitesini ziyaret ederek birden fazla XLSM dosyasına hemen katılın.
