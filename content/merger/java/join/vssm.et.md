...
############################# Head ############################
head_title: "Liituge failidega VSSM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSSM failiga rakenduses Java"
description: "Liituge tootega VSSM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSSM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSSM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSSM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSSM, kasutades GroupDocs.Merger for Java API-t
