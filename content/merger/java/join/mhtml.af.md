...
############################# Head ############################
head_title: "Sluit aan by MHTML-lêers via Java & J2SE Documents Merger API"
head_description: "Sluit aan by verskeie MHTML-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Sluit aan by MHTML-lêers in Java"
description: "Sluit aan by MHTML met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Sluit aan by verskeie MHTML-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om by verskeie MHTML-lêers aan te sluit deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by MHTML-lêers aan te sluit deur Java-voorbeeldkode te gebruik">}}

        ```java    
        // Sluit aan by MHTML lêers deur GroupDocs.Merger vir Java API te gebruik
