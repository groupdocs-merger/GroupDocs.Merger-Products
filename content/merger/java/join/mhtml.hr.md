...
############################# Head ############################
head_title: "Pridružite MHTML datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više MHTML datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite MHTML datotekama u Java"
description: "Pridružite se MHTML s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više MHTML datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti MHTML datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite MHTML datoteke koristeći GroupDocs.Merger za Java API
