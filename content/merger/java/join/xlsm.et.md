...
############################# Head ############################
head_title: "Liituge failidega XLSM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLSM failiga rakenduses Java"
description: "Liituge tootega XLSM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLSM faili, kasutades Java näitekoodi">}}
