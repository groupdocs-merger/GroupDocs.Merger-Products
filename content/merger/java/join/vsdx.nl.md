...
############################# Head ############################
head_title: "Word lid van VSDX bestanden via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Word lid van VSDX bestanden in Java"
description: "Sluit je aan bij VSDX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere VSDX bestanden in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u VSDX bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van VSDX bestanden met behulp van GroupDocs.Merger voor Java API
