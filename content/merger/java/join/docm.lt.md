...
############################# Head ############################
head_title: "Prisijunkite prie DOCM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis DOCM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie DOCM failų Java"
description: "Prisijunkite prie DOCM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis DOCM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis DOCM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOCM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite DOCM failus naudodami GroupDocs.Merger for Java API
