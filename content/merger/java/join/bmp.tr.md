...
############################# Head ############################
head_title: "BMP Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla BMP dosyasına katılın."

############################# Header ############################
title: "Java İçindeki BMP Dosyaya Katılın"
description: "Birkaç satır Java koduyla BMP'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok BMP Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok BMP dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak BMP dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak BMP dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) web sitesini ziyaret ederek birden fazla BMP dosyasına hemen katılın.
