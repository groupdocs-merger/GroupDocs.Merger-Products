...
############################# Head ############################
head_title: "Liituge failidega DOTX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOTX failiga rakenduses Java"
description: "Liituge tootega DOTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu DOTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme DOTX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOTX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid DOTX, kasutades GroupDocs.Merger for Java API-t
