...
############################# Head ############################
head_title: "Liituge failidega ODT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ODT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge ODT failiga rakenduses Java"
description: "Liituge tootega ODT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu ODT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme ODT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ODT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid ODT, kasutades GroupDocs.Merger for Java API-t
