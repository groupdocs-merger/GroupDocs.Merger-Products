...
############################# Head ############################
head_title: "Liituge failidega XLTX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLTX failiga rakenduses Java"
description: "Liituge tootega XLTX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLTX faili, kasutades Java näitekoodi">}}
