...
############################# Head ############################
head_title: "Bli med i TXT filer via Java & J2SE Documents Merger API"
head_description: "Slå sammen flere TXT-filer i Java ved å bruke Documents Merger API med all data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Bli med TXT-filer i Java"
description: "Bli med TXT med noen få linjer med Java-kode."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/no/merger/java/) gir en praktisk løsning for å slå sammen flere PDF-filer, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, bilder og mange andre dokumenter i én enkelt fil i Java-applikasjoner. GroupDocs.Merger vil spare deg for mye krefter, siden du har lov til å bli med i TXT-dokumenter - det er ikke nødvendig å installere tredjepartsprogramvare, skrivebordsapplikasjoner eller plugins. Nå er det unødvendig å kaste bort tiden din og koble til filer manuelt! GroupDocs oppgave er å gi den beste kvaliteten og forenkle dokumentbehandlingsarbeidsflyten.
...
steps:
    enable: true
    title_left: "Slå sammen flere TXT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slå sammen flere TXT-filer ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til TXT-filer ved å bruke Java-eksempelkoden">}}

        ```java    
        // Bli med TXT-filer ved hjelp av GroupDocs.Merger for Java API
