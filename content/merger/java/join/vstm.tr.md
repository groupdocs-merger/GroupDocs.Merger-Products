...
############################# Head ############################
head_title: "VSTM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VSTM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VSTM Dosyaya Katılın"
description: "Birkaç satır Java koduyla VSTM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VSTM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSTM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSTM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSTM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) web sitesini ziyaret ederek birden fazla VSTM dosyasına hemen katılın.
