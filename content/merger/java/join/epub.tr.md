...
############################# Head ############################
head_title: "EPUB Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla EPUB dosyasına katılın."

############################# Header ############################
title: "Java İçindeki EPUB Dosyaya Katılın"
description: "Birkaç satır Java koduyla EPUB'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok EPUB Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok EPUB dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak EPUB dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak EPUB dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) web sitesini ziyaret ederek birden fazla EPUB dosyasına hemen katılın.
