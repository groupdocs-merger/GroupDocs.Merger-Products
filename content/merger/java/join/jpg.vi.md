...
############################# Head ############################
head_title: "Tham gia các tệp JPG qua API hợp nhất tài liệu Java & J2SE"
head_description: "Nối nhiều tệp JPG trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Tham gia JPG Tệp trong Java"
description: "Tham gia JPG với một vài dòng mã Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java]({{Sl slash_lang}}/merge/java/) cung cấp một giải pháp thuận tiện để kết hợp nhiều tệp PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, hình ảnh và nhiều tài liệu khác thành một tệp duy nhất trong các ứng dụng Java. GroupDocs.Merger sẽ giúp bạn tiết kiệm rất nhiều công sức vì bạn được phép tham gia các tài liệu JPG - không cần cài đặt bất kỳ phần mềm, ứng dụng máy tính để bàn hoặc plugin nào của bên thứ ba. Bây giờ không cần thiết phải lãng phí thời gian của bạn và nối các tệp theo cách thủ công! Sứ mệnh của GroupDocs là cung cấp chất lượng tốt nhất và đơn giản hóa quy trình xử lý tài liệu.
...
steps:
    enable: true
    title_left: "Nối Nhiều JPG Tệp trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp JPG bằng mã mẫu Java">}}

        ```java    
        // Nối các tệp JPG bằng GroupDocs.Merger cho Java API
