...
############################# Head ############################
head_title: "Prisijunkite prie EPUB failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis EPUB failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie EPUB failų Java"
description: "Prisijunkite prie EPUB naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis EPUB failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis EPUB failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti EPUB failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite EPUB failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno EPUB failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) svetainėje.
