...
############################# Head ############################
head_title: "TXT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla TXT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki TXT Dosyaya Katılın"
description: "Birkaç satır Java koduyla TXT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok TXT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok TXT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TXT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak TXT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) web sitesini ziyaret ederek birden fazla TXT dosyasına hemen katılın.
