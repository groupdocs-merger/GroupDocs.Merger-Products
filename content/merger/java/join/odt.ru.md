...
############################# Head ############################
head_title: "Присоединяйтесь к ODT файлам через Java и J2SE Documents Merger API"
...
############################# Header ############################
title: "Присоединяйтесь к ODT файлам в Java"
description: "Присоединитесь к ODT с помощью нескольких строк кода Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Как соединить файлы ODT, используя пример кода Java">}}

        ```java    
        // Присоединяйтесь к ODT файлам с помощью GroupDocs.Merge for Java API
