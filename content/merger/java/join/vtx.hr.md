...
############################# Head ############################
head_title: "Pridružite VTX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VTX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VTX datotekama u Java"
description: "Pridružite se VTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VTX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VTX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VTX datoteke koristeći GroupDocs.Merger za Java API
