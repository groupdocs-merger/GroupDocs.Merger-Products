...
############################# Head ############################
head_title: "Об'єднайте файли BMP в Java"
head_description: "Використовуйте GroupDocs.Merger for Java, щоб додати можливості об'єднання документів BMP до ваших додатків Java."

############################# Header ############################
title: "Об'єднати файли BMP" 
description: "GroupDocs.Merger for Java дозволяє розробляти додатки Java, які ефективно об'єднують кілька документів BMP."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) пропонує простий спосіб об'єднання документів BMP. Покращте ваші додатки Java, комбінуючи кілька файлів в один.
      
      1. Вкажіть шлях до першого файлу BMP.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Ініціалізуйте Merger з вхідним документом BMP
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання конкретних сторінок з різних форматів документів"
      content: |
        Цей приклад демонструє, як об'єднати файли BMP, вибираючи конкретні сторінки з інших форматів.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
