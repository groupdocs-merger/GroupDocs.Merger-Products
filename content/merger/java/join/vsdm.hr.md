...
############################# Head ############################
head_title: "Pridružite VSDM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSDM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSDM datotekama u Java"
description: "Pridružite se VSDM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSDM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSDM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSDM datoteke koristeći GroupDocs.Merger za Java API
