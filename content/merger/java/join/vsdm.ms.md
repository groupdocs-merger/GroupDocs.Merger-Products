...
############################# Head ############################
head_title: "Sertai VSDM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSDM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSDM Fail Dalam Java"
description: "Sertai VSDM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSDM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSDM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSDM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSDM fail menggunakan GroupDocs.Merger untuk API Java
