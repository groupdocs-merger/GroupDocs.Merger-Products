...
############################# Head ############################
head_title: "PNG Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla PNG dosyasına katılın."

############################# Header ############################
title: "Java İçindeki PNG Dosyaya Katılın"
description: "Birkaç satır Java koduyla PNG'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok PNG Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok PNG dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PNG dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PNG dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) web sitesini ziyaret ederek birden fazla PNG dosyasına hemen katılın.
