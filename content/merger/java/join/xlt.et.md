...
############################# Head ############################
head_title: "Liituge failidega XLT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLT failiga rakenduses Java"
description: "Liituge tootega XLT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLT, kasutades GroupDocs.Merger for Java API-t
