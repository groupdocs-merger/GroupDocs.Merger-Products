...
############################# Head ############################
head_title: "Csatlakozzon a HTML fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több HTML fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás HTML fájlhoz itt: Java"
description: "Csatlakozzon az HTML termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több HTML fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több HTML fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson HTML fájlt a GroupDocs.Merger for Java API segítségével
