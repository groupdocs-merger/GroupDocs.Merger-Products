...
############################# Head ############################
head_title: "PDF Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla PDF dosyasına katılın."

############################# Header ############################
title: "Java İçindeki PDF Dosyaya Katılın"
description: "Birkaç satır Java koduyla PDF'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok PDF Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok PDF dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PDF dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PDF dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) web sitesini ziyaret ederek birden fazla PDF dosyasına hemen katılın.
