...
############################# Head ############################
head_title: "Sertai XLTX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLTX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLTX Fail Dalam Java"
description: "Sertai XLTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLTX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLTX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLTX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLTX fail menggunakan GroupDocs.Merger untuk API Java
