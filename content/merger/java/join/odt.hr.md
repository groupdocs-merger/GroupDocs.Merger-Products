...
############################# Head ############################
head_title: "Pridružite ODT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više ODT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite ODT datotekama u Java"
description: "Pridružite se ODT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više ODT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite ODT datoteke koristeći GroupDocs.Merger za Java API
