...
############################# Head ############################
head_title: "Alăturați-vă fișierelor VSDX prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Alăturați mai multe fișiere VSDX în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Alăturați-vă fișierelor VSDX în Java"
description: "Alăturați-vă VSDX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Alăturați mai multe fișiere VSDX în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează alăturarea mai multor fișiere VSDX dezvoltatorilor Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor VSDX utilizând codul exemplu Java">}}

        ```java    
        // Alăturați-vă fișierelor VSDX utilizând API-ul GroupDocs.Merger pentru Java
