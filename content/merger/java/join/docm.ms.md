...
############################# Head ############################
head_title: "Sertai DOCM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOCM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOCM Fail Dalam Java"
description: "Sertai DOCM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOCM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOCM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOCM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOCM fail menggunakan GroupDocs.Merger untuk API Java
