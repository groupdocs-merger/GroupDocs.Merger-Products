...
############################# Head ############################
head_title: "Prisijunkite prie PPS failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis PPS failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie PPS failų Java"
description: "Prisijunkite prie PPS naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis PPS failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis PPS failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PPS failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite PPS failus naudodami GroupDocs.Merger for Java API
