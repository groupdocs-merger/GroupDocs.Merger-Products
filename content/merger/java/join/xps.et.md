...
############################# Head ############################
head_title: "Liituge failidega XPS Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XPS failiga rakenduses Java"
description: "Liituge tootega XPS mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XPS faili, kasutades Java näitekoodi">}}
