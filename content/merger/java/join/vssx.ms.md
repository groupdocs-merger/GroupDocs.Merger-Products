...
############################# Head ############################
head_title: "Sertai VSSX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSSX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSSX Fail Dalam Java"
description: "Sertai VSSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSSX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSSX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSSX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSSX fail menggunakan GroupDocs.Merger untuk API Java
