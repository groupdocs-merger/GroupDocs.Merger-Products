...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы XLAM файлдарына қосылыңыз"
head_description: "Java тіліндегі бірнеше XLAM файлдарды бастапқы құжаттар ретінде барлық деректермен, стильмен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "XLAM файлдарына Java ішінде қосылу"
description: "XLAM жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше XLAM файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы XLAM файлдарға қосылыңыз
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) веб-сайтына кіру арқылы бірден көп XLAM файлдарға қосылыңыз.
