...
############################# Head ############################
head_title: "Prisijunkite prie ODS failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis ODS failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie ODS failų Java"
description: "Prisijunkite prie ODS naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis ODS failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis ODS failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti ODS failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite ODS failus naudodami GroupDocs.Merger for Java API
