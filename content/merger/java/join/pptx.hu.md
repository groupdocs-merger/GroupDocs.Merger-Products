...
############################# Head ############################
head_title: "Csatlakozzon a PPTX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több PPTX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás PPTX fájlhoz itt: Java"
description: "Csatlakozzon az PPTX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több PPTX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több PPTX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson PPTX fájlt a GroupDocs.Merger for Java API segítségével
