...
############################# Head ############################
head_title: "HTML Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla HTML dosyasına katılın."

############################# Header ############################
title: "Java İçindeki HTML Dosyaya Katılın"
description: "Birkaç satır Java koduyla HTML'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok HTML Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok HTML dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak HTML dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak HTML dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) web sitesini ziyaret ederek birden fazla HTML dosyasına hemen katılın.
