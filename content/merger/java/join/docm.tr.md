...
############################# Head ############################
head_title: "DOCM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla DOCM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki DOCM Dosyaya Katılın"
description: "Birkaç satır Java koduyla DOCM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok DOCM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok DOCM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOCM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOCM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) web sitesini ziyaret ederek birden fazla DOCM dosyasına hemen katılın.
