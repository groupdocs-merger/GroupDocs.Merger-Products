...
############################# Head ############################
head_title: "Csatlakozzon a XLAM fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több XLAM fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás XLAM fájlhoz itt: Java"
description: "Csatlakozzon az XLAM termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több XLAM fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több XLAM fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson XLAM fájlt a GroupDocs.Merger for Java API segítségével
