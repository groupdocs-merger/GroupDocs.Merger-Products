...
############################# Head ############################
head_title: "Объединение ONENOTE файлов через Java и J2SE Documents Merger API"
head_description: "Объединяйте несколько файлов ONENOTE в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "ONENOTE Объединение на Java"
...
steps:
    enable: true
    title_left: "Объединить несколько ONENOTE файлов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы ONENOTE, используя пример кода Java">}}
        ...
        ```java    
        // Объединить ONENOTE файлов с помощью GroupDocs.Merger for Java API
