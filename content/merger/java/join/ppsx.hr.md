...
############################# Head ############################
head_title: "Pridružite PPSX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PPSX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PPSX datotekama u Java"
description: "Pridružite se PPSX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PPSX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPSX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PPSX datoteke koristeći GroupDocs.Merger za Java API
