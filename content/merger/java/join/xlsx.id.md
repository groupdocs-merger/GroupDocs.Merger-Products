...
############################# Head ############################
head_title: "Gabung berkas XLSX dalam Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen XLSX ke aplikasi Java Anda."

############################# Header ############################
title: "Gabung berkas XLSX" 
description: "GroupDocs.Merger for Java memungkinkan Anda mengembangkan aplikasi Java yang secara efisien menggabungkan beberapa dokumen XLSX."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan cara untuk menggabungkan dokumen XLSX. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalan ke berkas XLSX pertama.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berbagai format dokumen"
      content: |
        Contoh ini menunjukkan cara menggabungkan berkas XLSX sambil memilih halaman tertentu dari format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
