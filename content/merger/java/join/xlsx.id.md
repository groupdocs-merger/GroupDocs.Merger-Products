...
############################# Head ############################
head_title: "Bergabunglah dengan XLSX File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung XLSX File Di Java"
description: "Bergabunglah dengan XLSX dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLSX menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file XLSX menggunakan GroupDocs.Merger untuk Java API
