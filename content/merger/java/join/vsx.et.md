...
############################# Head ############################
head_title: "Liituge failidega VSX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSX failiga rakenduses Java"
description: "Liituge tootega VSX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSX faili, kasutades Java näitekoodi">}}
