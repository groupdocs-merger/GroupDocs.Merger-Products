...
############################# Head ############################
head_title: "Միացեք VSDX Ֆայլերին Java & J2SE Documents Merger API-ի միջոցով"
head_description: "Միացրեք բազմաթիվ VSDX ֆայլեր Java-ում՝ օգտագործելով փաստաթղթերի միաձուլման API՝ բոլոր տվյալները, ոճը և ձևաչափումը որպես սկզբնաղբյուր փաստաթղթեր:"

############################# Header ############################
title: "Միացեք VSDX ֆայլերին Java-ում"
description: "Միացեք VSDX-ին Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Միացեք բազմաթիվ VSDX ֆայլերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) Java ծրագրավորողների համար հեշտացնում է մի քանի VSDX ֆայլեր միանալը մի քանի հեշտ քայլերի միջոցով:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել VSDX ֆայլեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Միացե՛ք VSDX ֆայլեր՝ օգտագործելով GroupDocs.Merger Java API-ի համար
