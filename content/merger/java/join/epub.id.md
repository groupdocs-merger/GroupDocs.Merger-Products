...
############################# Head ############################
head_title: "Bergabunglah dengan EPUB File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung EPUB File Di Java"
description: "Bergabunglah dengan EPUB dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file EPUB menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file EPUB menggunakan GroupDocs.Merger untuk Java API
