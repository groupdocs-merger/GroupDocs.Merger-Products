...
############################# Head ############################
head_title: "Csatlakozzon a VSTX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több VSTX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás VSTX fájlhoz itt: Java"
description: "Csatlakozzon az VSTX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több VSTX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több VSTX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson VSTX fájlt a GroupDocs.Merger for Java API segítségével
