...
############################# Head ############################
head_title: "Gabung berkas PNG dalam Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen PNG ke aplikasi Java Anda."

############################# Header ############################
title: "Gabung berkas PNG" 
description: "GroupDocs.Merger for Java memungkinkan Anda mengembangkan aplikasi Java yang secara efisien menggabungkan beberapa dokumen PNG."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan cara untuk menggabungkan dokumen PNG. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalan ke berkas PNG pertama.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inisialisasi Merger dengan dokumen PNG input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berbagai format dokumen"
      content: |
        Contoh ini menunjukkan cara menggabungkan berkas PNG sambil memilih halaman tertentu dari format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
