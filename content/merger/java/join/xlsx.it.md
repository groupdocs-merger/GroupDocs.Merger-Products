...
############################# Head ############################
head_title: "Unisciti a XLSX file tramite Java e J2SE Documents Merger API"
head_description: "Unisci più file XLSX in Java utilizzando l'API di fusione documenti con tutti i dati, lo stile e la formattazione come documenti di origine."

############################# Header ############################
title: "Unisciti a XLSX file in Java"
description: "Unisciti a XLSX con poche righe di codice Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/it/merger/java/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni Java. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unirti a XLSX documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    enable: true
    title_left: "Unisci più file XLSX in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori Java di unire facilmente più file XLSX implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file XLSX utilizzando il codice di esempio Java">}}

        ```java    
        // Unisciti ai file XLSX utilizzando GroupDocs.Merger per l'API Java
