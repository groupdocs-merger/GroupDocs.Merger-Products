...
head_description: "使用GroupDocs.Merger for Java为您的Java应用程序添加DOCX文档合并功能。"

############################# Header ############################
title: "合并DOCX文件" 
description: "GroupDocs.Merger for Java使您能够开发高效合并多个DOCX文档的Java应用程序。"
...
steps:
    ...
    title: "如何合并DOCX文档"
    content: |
      [GroupDocs.Merger](/merger/java/) 提供了一种合并DOCX文档的简便方法。通过将多个文件合并为一个，增强您的Java应用程序。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "合并来自不同文档格式的特定页面"
      content: |
        此示例演示如何在合并DOCX文件时选择来自其他格式的特定页面。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
