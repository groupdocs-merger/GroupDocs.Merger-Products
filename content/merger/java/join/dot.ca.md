...
############################# Head ############################
head_title: "Uniu-vos a fitxers DOT mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers DOT a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a DOT fitxers a Java"
description: "Uniu-vos a DOT amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers DOT a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers DOT implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers DOT mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers DOT mitjançant l'API de GroupDocs.Merger per a Java
