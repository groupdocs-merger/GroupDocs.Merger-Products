...
############################# Head ############################
head_title: "Prisijunkite prie XLT failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLT failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLT failų Java"
description: "Prisijunkite prie XLT naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLT failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLT failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLT failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLT failus naudodami GroupDocs.Merger for Java API
