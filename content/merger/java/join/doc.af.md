...
############################# Head ############################
head_title: "Sluit aan by DOC-lêers via Java & J2SE Documents Merger API"
head_description: "Sluit aan by verskeie DOC-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Sluit aan by DOC-lêers in Java"
description: "Sluit aan by DOC met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Sluit aan by verskeie DOC-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om by verskeie DOC-lêers aan te sluit deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by DOC-lêers aan te sluit deur Java-voorbeeldkode te gebruik">}}

        ```java    
        // Sluit aan by DOC lêers deur GroupDocs.Merger vir Java API te gebruik
