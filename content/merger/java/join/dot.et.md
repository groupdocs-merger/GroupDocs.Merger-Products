...
############################# Head ############################
head_title: "Liituge failidega DOT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOT failiga rakenduses Java"
description: "Liituge tootega DOT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu DOT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme DOT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid DOT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe DOT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
