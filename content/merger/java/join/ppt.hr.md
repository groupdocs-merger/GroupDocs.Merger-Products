...
############################# Head ############################
head_title: "Pridružite PPT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PPT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PPT datotekama u Java"
description: "Pridružite se PPT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PPT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PPT datoteke koristeći GroupDocs.Merger za Java API
