...
############################# Head ############################
head_title: "Tevlî pelên RTF bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên RTF li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên RTF Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî RTF bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek RTF Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên RTF bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên RTF dibe">}}

        ```java    
        // Tevlî pelên RTF bibin bi karanîna GroupDocs.Merger ji bo Java API
