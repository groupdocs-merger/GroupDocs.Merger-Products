...
############################# Head ############################
head_title: "Word lid van TEX bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere TEX-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van TEX bestanden in Java"
description: "Sluit je aan bij TEX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere TEX bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere TEX-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u TEX bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van TEX bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één TEX-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) te gaan.
