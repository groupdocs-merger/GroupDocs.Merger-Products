...
############################# Head ############################
head_title: "Dołącz do plików DOT przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików DOT w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do DOT plików w Java"
description: "Dołącz do DOT za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików DOT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików DOT, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików DOT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików DOT za pomocą GroupDocs.Merger for Java API
