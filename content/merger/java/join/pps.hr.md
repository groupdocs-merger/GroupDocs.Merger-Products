...
############################# Head ############################
head_title: "Pridružite PPS datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PPS datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PPS datotekama u Java"
description: "Pridružite se PPS s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PPS datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPS datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PPS datoteke koristeći GroupDocs.Merger za Java API
