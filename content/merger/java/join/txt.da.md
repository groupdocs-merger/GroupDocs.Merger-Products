...
############################# Head ############################
head_title: "Deltag i TXT filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere TXT-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i TXT filer i Java"
description: "Slut dig til TXT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere TXT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere TXT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du TXT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i TXT filer ved hjælp af GroupDocs.Merger for Java API
