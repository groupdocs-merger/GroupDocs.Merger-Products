...
############################# Head ############################
head_title: "Sertai VDX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VDX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VDX Fail Dalam Java"
description: "Sertai VDX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VDX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VDX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VDX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VDX fail menggunakan GroupDocs.Merger untuk API Java
