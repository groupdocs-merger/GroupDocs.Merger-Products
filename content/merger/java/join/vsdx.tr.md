...
############################# Head ############################
head_title: "VSDX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VSDX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VSDX Dosyaya Katılın"
description: "Birkaç satır Java koduyla VSDX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VSDX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSDX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSDX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) web sitesini ziyaret ederek birden fazla VSDX dosyasına hemen katılın.
