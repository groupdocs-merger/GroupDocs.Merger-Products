...
############################# Head ############################
head_title: "Junte-se a ODT Arquivos via Java & J2SE Documents Merger API"
head_description: "Junte vários arquivos ODT em Java usando a API de fusão de documentos com todos os dados, estilo e formatação como documentos de origem."

############################# Header ############################
title: "Junte-se a ODT arquivos em Java"
description: "Junte-se a ODT com algumas linhas de código Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pt/merger/java/) fornece uma solução conveniente para juntar vários PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, imagens e muitos outros documentos em um único arquivo dentro dos aplicativos Java. O GroupDocs.Merger economizará muito esforço, pois você tem permissão para juntar ODT documentos - não há necessidade de instalar nenhum software de terceiros, aplicativos de desktop ou plug-ins. Agora é desnecessário perder seu tempo e juntar arquivos manualmente! A missão do GroupDocs é fornecer a melhor qualidade e simplificar os fluxos de trabalho de processamento de documentos.
...
steps:
    enable: true
    title_left: "Junte vários arquivos ODT em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores Java juntarem vários arquivos ODT implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos ODT usando o código de exemplo Java">}}

        ```java    
        // Junte-se a arquivos ODT usando GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Junte-se a mais de um arquivo ODT agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
