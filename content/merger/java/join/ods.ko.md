...
description: "몇 줄의 Java 코드로 ODS에 가입하세요."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 몇 가지 간단한 단계를 구현하여 Java 개발자가 여러 ODS 파일을 쉽게 결합할 수 있습니다.
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) 웹사이트를 방문하여 지금 하나 이상의 ODS 파일에 참여하세요.
