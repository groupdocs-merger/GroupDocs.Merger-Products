...
############################# Head ############################
head_title: "Liituge failidega BMP Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu BMP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge BMP failiga rakenduses Java"
description: "Liituge tootega BMP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu BMP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme BMP faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada BMP faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid BMP, kasutades GroupDocs.Merger for Java API-t
