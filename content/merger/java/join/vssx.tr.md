...
############################# Head ############################
head_title: "VSSX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VSSX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VSSX Dosyaya Katılın"
description: "Birkaç satır Java koduyla VSSX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VSSX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSSX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSSX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) web sitesini ziyaret ederek birden fazla VSSX dosyasına hemen katılın.
