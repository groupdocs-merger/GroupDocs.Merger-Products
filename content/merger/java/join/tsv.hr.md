...
############################# Head ############################
head_title: "Pridružite TSV datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više TSV datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite TSV datotekama u Java"
description: "Pridružite se TSV s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više TSV datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti TSV datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite TSV datoteke koristeći GroupDocs.Merger za Java API
