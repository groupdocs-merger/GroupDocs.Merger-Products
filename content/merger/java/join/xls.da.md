...
############################# Head ############################
head_title: "Deltag i XLS filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere XLS-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i XLS filer i Java"
description: "Slut dig til XLS med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere XLS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere XLS-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du XLS filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i XLS filer ved hjælp af GroupDocs.Merger for Java API
