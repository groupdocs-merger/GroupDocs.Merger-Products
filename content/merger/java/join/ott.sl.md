...
############################# Head ############################
head_title: "Pridružite se datotekam OTT prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek OTT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Pridružite se datotekam OTT v Java"
description: "Pridružite se OTT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam OTT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTT s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam OTT z API-jem GroupDocs.Merger za Java
...
demos:
    ...
    content: |
       Pridružite se več kot eni OTT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
