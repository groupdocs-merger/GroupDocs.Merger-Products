...
############################# Head ############################
head_title: "Sertai DOTX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOTX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOTX Fail Dalam Java"
description: "Sertai DOTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOTX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOTX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOTX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOTX fail menggunakan GroupDocs.Merger untuk API Java
