...
############################# Head ############################
head_title: "PPS ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ይቀላቀሉ"
head_description: "የሰነዶች ውህደት ኤፒአይ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት ጋር እንደ ምንጭ ሰነዶች በመጠቀም ብዙ PPS ፋይሎችን በጃቫ ውስጥ ይቀላቀሉ።"

############################# Header ############################
title: "በJava ውስጥ PPS ፋይሎችን ይቀላቀሉ"
description: "PPSን በጥቂት የJava ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ PPS ፋይሎችን ይቀላቀሉ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ PPS ፋይሎችን መቀላቀል ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="Java ምሳሌ ኮድን በመጠቀም PPS ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለJava API በመጠቀም PPS ፋይሎችን ይቀላቀሉ
