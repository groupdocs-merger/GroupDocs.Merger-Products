...
############################# Head ############################
head_title: "Liituge failidega OTP Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu OTP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge OTP failiga rakenduses Java"
description: "Liituge tootega OTP mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada OTP faili, kasutades Java näitekoodi">}}
