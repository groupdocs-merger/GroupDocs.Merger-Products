...
############################# Head ############################
head_title: "انضم إلى ملفات VSTX عبر Java & J2SE Documents Merger API"
head_description: "انضم إلى عدة ملفات VSTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "انضم إلى ملفات VSTX في Java"
description: "انضم إلى VSTX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "ضم عدة ملفات VSTX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا الانضمام إلى عدة ملفات VSTX من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات VSTX باستخدام كود مثال Java">}}

        ```java    
        // انضم إلى ملفات VSTX باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات Java
...
demos:
    ...
    content: |
       انضم إلى أكثر من VSTX ملف واحد الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx).
