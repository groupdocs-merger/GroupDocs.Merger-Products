...
############################# Head ############################
head_title: "Εγγραφείτε στα αρχεία DOC μέσω Java & J2SE Documents Merger API"
head_description: "Συνδέστε πολλά αρχεία DOC σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία DOC σε Java"
description: "Εγγραφείτε στο DOC με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συμμετοχή σε πολλά DOC αρχεία στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να ενώσουν πολλά αρχεία DOC εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία DOC χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Εγγραφείτε σε αρχεία DOC χρησιμοποιώντας το GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Εγγραφείτε σε περισσότερα από ένα αρχεία DOC αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
