...
############################# Head ############################
head_title: "Liituge failidega XLTM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLTM failiga rakenduses Java"
description: "Liituge tootega XLTM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLTM faili, kasutades Java näitekoodi">}}
