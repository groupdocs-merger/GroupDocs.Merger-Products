...
############################# Head ############################
head_title: "Bergabunglah dengan OTP File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung OTP File Di Java"
description: "Bergabunglah dengan OTP dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file OTP menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file OTP menggunakan GroupDocs.Merger untuk Java API
