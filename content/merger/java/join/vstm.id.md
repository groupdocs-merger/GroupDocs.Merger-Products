...
############################# Head ############################
head_title: "Bergabunglah dengan VSTM File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung VSTM File Di Java"
description: "Bergabunglah dengan VSTM dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSTM menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file VSTM menggunakan GroupDocs.Merger untuk Java API
