...
############################# Head ############################
head_title: "Bli med i ODT filer via Java & J2SE Documents Merger API"
head_description: "Slå sammen flere ODT-filer i Java ved å bruke Documents Merger API med all data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Bli med ODT-filer i Java"
description: "Bli med ODT med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slå sammen flere ODT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slå sammen flere ODT-filer ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til ODT-filer ved å bruke Java-eksempelkoden">}}

        ```java    
        // Bli med ODT-filer ved hjelp av GroupDocs.Merger for Java API
