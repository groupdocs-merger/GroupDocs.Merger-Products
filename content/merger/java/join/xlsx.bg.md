...
############################# Head ############################
head_title: "Присъединете се към XLSX файлове чрез Java & J2SE Documents Merger API"
head_description: "Свържете множество XLSX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Присъединете се към XLSX файлове в Java"
description: "Присъединете се към XLSX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Присъединете се към множество XLSX файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да обединяват множество XLSX файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да съедините XLSX файлове с Java примерен код">}}

        ```java    
        // Присъединете се към XLSX файлове с помощта на GroupDocs.Merger за Java API
