...
############################# Head ############################
head_title: "Tevlî pelên DOTX bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên DOTX li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên DOTX Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî DOTX bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek DOTX Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên DOTX bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên DOTX dibe">}}

        ```java    
        // Tevlî pelên DOTX bibin bi karanîna GroupDocs.Merger ji bo Java API
