...
############################# Head ############################
head_title: "XLS Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLS dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLS Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLS'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLS Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLS dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLS dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLS dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) web sitesini ziyaret ederek birden fazla XLS dosyasına hemen katılın.
