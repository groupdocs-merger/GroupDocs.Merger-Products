...
############################# Head ############################
head_title: "Sertai XLTM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLTM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLTM Fail Dalam Java"
description: "Sertai XLTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLTM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLTM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLTM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLTM fail menggunakan GroupDocs.Merger untuk API Java
