...
############################# Head ############################
head_title: "Liituge failidega TEX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TEX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge TEX failiga rakenduses Java"
description: "Liituge tootega TEX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu TEX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme TEX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TEX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid TEX, kasutades GroupDocs.Merger for Java API-t
