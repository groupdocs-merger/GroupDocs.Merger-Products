...
############################# Head ############################
head_title: "Prisijunkite prie VSTM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis VSTM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie VSTM failų Java"
description: "Prisijunkite prie VSTM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis VSTM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis VSTM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSTM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite VSTM failus naudodami GroupDocs.Merger for Java API
