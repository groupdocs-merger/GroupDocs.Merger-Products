...
############################# Head ############################
head_title: "Pridružite BMP datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više BMP datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite BMP datotekama u Java"
description: "Pridružite se BMP s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više BMP datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti BMP datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite BMP datoteke koristeći GroupDocs.Merger za Java API
...
demos:
    ...
    content: |
       Pridružite se više od jedne BMP datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
