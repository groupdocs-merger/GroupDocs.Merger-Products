...
############################# Head ############################
head_title: "Uniu-vos a fitxers HTML mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers HTML a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a HTML fitxers a Java"
description: "Uniu-vos a HTML amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers HTML a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers HTML implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers HTML mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers HTML mitjançant l'API de GroupDocs.Merger per a Java
