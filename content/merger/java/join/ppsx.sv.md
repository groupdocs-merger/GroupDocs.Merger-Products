...
############################# Head ############################
head_title: "Gå med i PPSX filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera PPSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i PPSX-filer i Java"
description: "Gå med i PPSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera PPSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera PPSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i PPSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i PPSX-filer med GroupDocs.Merger för Java API
