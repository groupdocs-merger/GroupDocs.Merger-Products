...
############################# Head ############################
head_title: "Joindre EXCEL fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Joignez plusieurs fichiers EXCEL en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Joindre EXCEL fichiers dans Java"
description: "Joignez EXCEL avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Joindre plusieurs fichiers EXCEL dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de joindre facilement plusieurs fichiers EXCEL en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment joindre des fichiers EXCEL à l'aide de l'exemple de code Java">}}

        ```java    
        // Joindre des fichiers EXCEL à l'aide de l'API GroupDocs.Merger pour Java
