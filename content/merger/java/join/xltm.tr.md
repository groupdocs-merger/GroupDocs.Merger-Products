...
############################# Head ############################
head_title: "XLTM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLTM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLTM Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLTM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLTM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLTM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLTM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLTM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) web sitesini ziyaret ederek birden fazla XLTM dosyasına hemen katılın.
