...
############################# Head ############################
head_title: "Prisijunkite prie TEX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis TEX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie TEX failų Java"
description: "Prisijunkite prie TEX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis TEX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis TEX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti TEX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite TEX failus naudodami GroupDocs.Merger for Java API
