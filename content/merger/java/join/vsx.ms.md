...
############################# Head ############################
head_title: "Sertai VSX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSX Fail Dalam Java"
description: "Sertai VSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSX fail menggunakan GroupDocs.Merger untuk API Java
