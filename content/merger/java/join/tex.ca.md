...
############################# Head ############################
head_title: "Uniu-vos a fitxers TEX mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers TEX a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a TEX fitxers a Java"
description: "Uniu-vos a TEX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers TEX a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers TEX implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers TEX mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers TEX mitjançant l'API de GroupDocs.Merger per a Java
