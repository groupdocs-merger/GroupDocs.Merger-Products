...
############################# Head ############################
head_title: "ODS Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla ODS dosyasına katılın."

############################# Header ############################
title: "Java İçindeki ODS Dosyaya Katılın"
description: "Birkaç satır Java koduyla ODS'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok ODS Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok ODS dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODS dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODS dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) web sitesini ziyaret ederek birden fazla ODS dosyasına hemen katılın.
