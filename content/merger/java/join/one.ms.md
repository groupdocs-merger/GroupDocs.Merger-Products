...
############################# Head ############################
head_title: "Sertai ONE Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail ONE dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai ONE Fail Dalam Java"
description: "Sertai ONE dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang ONE Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail ONE dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail ONE menggunakan kod contoh Java.">}}

        ```java    
        // Sertai ONE fail menggunakan GroupDocs.Merger untuk API Java
