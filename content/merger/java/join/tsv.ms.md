...
############################# Head ############################
head_title: "Sertai TSV Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail TSV dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai TSV Fail Dalam Java"
description: "Sertai TSV dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang TSV Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail TSV dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail TSV menggunakan kod contoh Java.">}}

        ```java    
        // Sertai TSV fail menggunakan GroupDocs.Merger untuk API Java
