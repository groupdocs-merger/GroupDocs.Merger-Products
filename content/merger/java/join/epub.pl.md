...
############################# Head ############################
head_title: "Dołącz do plików EPUB przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików EPUB w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do EPUB plików w Java"
description: "Dołącz do EPUB za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików EPUB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików EPUB, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików EPUB przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików EPUB za pomocą GroupDocs.Merger for Java API
