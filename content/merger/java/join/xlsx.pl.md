...
############################# Head ############################
head_title: "Dołącz do plików XLSX przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików XLSX w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do XLSX plików w Java"
description: "Dołącz do XLSX za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików XLSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików XLSX, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików XLSX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików XLSX za pomocą GroupDocs.Merger for Java API
