...
############################# Head ############################
head_title: "Uniu-vos a fitxers VSDM mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers VSDM a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a VSDM fitxers a Java"
description: "Uniu-vos a VSDM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers VSDM a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers VSDM implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers VSDM mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers VSDM mitjançant l'API de GroupDocs.Merger per a Java
