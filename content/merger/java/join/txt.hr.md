...
############################# Head ############################
head_title: "Pridružite TXT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više TXT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite TXT datotekama u Java"
description: "Pridružite se TXT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više TXT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti TXT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite TXT datoteke koristeći GroupDocs.Merger za Java API
