...
############################# Head ############################
head_title: "Tham gia các tệp DOTM qua API hợp nhất tài liệu Java & J2SE"
head_description: "Nối nhiều tệp DOTM trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Tham gia DOTM Tệp trong Java"
description: "Tham gia DOTM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Nối Nhiều DOTM Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng kết hợp nhiều tệp DOTM bằng cách triển khai một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp DOTM bằng mã mẫu Java">}}

        ```java    
        // Nối các tệp DOTM bằng GroupDocs.Merger cho Java API
...
demos:
    ...
    content: |
       Tham gia nhiều tệp DOTM ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ dotm) trang web.
