...
############################# Head ############################
head_title: "JPEG Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla JPEG dosyasına katılın."

############################# Header ############################
title: "Java İçindeki JPEG Dosyaya Katılın"
description: "Birkaç satır Java koduyla JPEG'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok JPEG Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok JPEG dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak JPEG dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak JPEG dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) web sitesini ziyaret ederek birden fazla JPEG dosyasına hemen katılın.
