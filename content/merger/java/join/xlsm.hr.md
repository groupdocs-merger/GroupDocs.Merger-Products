...
############################# Head ############################
head_title: "Pridružite XLSM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLSM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLSM datotekama u Java"
description: "Pridružite se XLSM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLSM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLSM datoteke koristeći GroupDocs.Merger za Java API
