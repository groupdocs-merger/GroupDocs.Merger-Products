...
############################# Head ############################
head_title: "Pridružite se datotekam MHTML prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam MHTML v Java"
description: "Pridružite se MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam MHTML v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke MHTML s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam MHTML z API-jem GroupDocs.Merger za Java
