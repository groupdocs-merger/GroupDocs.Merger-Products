...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы MHTML файлдарына қосылыңыз"
...
############################# Header ############################
title: "MHTML файлдарына Java ішінде қосылу"
description: "MHTML жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше MHTML файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы MHTML файлдарға қосылыңыз
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) веб-сайтына кіру арқылы бірден көп MHTML файлдарға қосылыңыз.
