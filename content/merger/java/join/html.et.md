...
############################# Head ############################
head_title: "Liituge failidega HTML Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu HTML-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge HTML failiga rakenduses Java"
description: "Liituge tootega HTML mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada HTML faili, kasutades Java näitekoodi">}}
