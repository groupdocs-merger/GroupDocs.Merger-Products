...
############################# Head ############################
head_title: "Sertai ODT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail ODT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai ODT Fail Dalam Java"
description: "Sertai ODT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang ODT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail ODT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail ODT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai ODT fail menggunakan GroupDocs.Merger untuk API Java
