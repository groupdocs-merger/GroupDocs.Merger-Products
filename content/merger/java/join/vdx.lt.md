...
############################# Head ############################
head_title: "Prisijunkite prie VDX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis VDX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie VDX failų Java"
description: "Prisijunkite prie VDX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis VDX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis VDX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VDX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite VDX failus naudodami GroupDocs.Merger for Java API
