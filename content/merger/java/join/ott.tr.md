...
############################# Head ############################
head_title: "OTT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla OTT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki OTT Dosyaya Katılın"
description: "Birkaç satır Java koduyla OTT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok OTT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok OTT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak OTT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) web sitesini ziyaret ederek birden fazla OTT dosyasına hemen katılın.
