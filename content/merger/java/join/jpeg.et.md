...
############################# Head ############################
head_title: "Liituge failidega JPEG Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu JPEG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge JPEG failiga rakenduses Java"
description: "Liituge tootega JPEG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu JPEG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme JPEG faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada JPEG faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid JPEG, kasutades GroupDocs.Merger for Java API-t
