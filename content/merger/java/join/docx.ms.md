...
############################# Head ############################
head_title: "Sertai DOCX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOCX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOCX Fail Dalam Java"
description: "Sertai DOCX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOCX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOCX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOCX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOCX fail menggunakan GroupDocs.Merger untuk API Java
