...
############################# Head ############################
head_title: "Prisijunkite prie TSV failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis TSV failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie TSV failų Java"
description: "Prisijunkite prie TSV naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis TSV failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis TSV failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti TSV failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite TSV failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno TSV failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) svetainėje.
