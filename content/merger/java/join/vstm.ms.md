...
############################# Head ############################
head_title: "Sertai VSTM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSTM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSTM Fail Dalam Java"
description: "Sertai VSTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSTM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSTM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSTM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSTM fail menggunakan GroupDocs.Merger untuk API Java
