...
############################# Head ############################
head_title: "Gå med i PPT filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera PPT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i PPT-filer i Java"
description: "Gå med i PPT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera PPT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera PPT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i PPT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i PPT-filer med GroupDocs.Merger för Java API
