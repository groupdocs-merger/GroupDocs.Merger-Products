...
############################# Head ############################
head_title: "Prisijunkite prie VSSX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis VSSX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie VSSX failų Java"
description: "Prisijunkite prie VSSX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis VSSX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis VSSX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSSX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite VSSX failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSSX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) svetainėje.
