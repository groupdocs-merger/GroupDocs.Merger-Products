...
############################# Head ############################
head_title: "Pridružite PPTX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PPTX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PPTX datotekama u Java"
description: "Pridružite se PPTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PPTX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPTX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PPTX datoteke koristeći GroupDocs.Merger za Java API
