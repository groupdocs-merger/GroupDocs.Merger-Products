...
############################# Head ############################
head_title: "Միացեք PDF Ֆայլերին Java & J2SE Documents Merger API-ի միջոցով"
head_description: "Միացրեք բազմաթիվ PDF ֆայլեր Java-ում՝ օգտագործելով փաստաթղթերի միաձուլման API՝ բոլոր տվյալները, ոճը և ձևաչափումը որպես սկզբնաղբյուր փաստաթղթեր:"

############################# Header ############################
title: "Միացեք PDF ֆայլերին Java-ում"
description: "Միացեք PDF-ին Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Միացեք բազմաթիվ PDF ֆայլերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) Java ծրագրավորողների համար հեշտացնում է մի քանի PDF ֆայլեր միանալը մի քանի հեշտ քայլերի միջոցով:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել PDF ֆայլեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Միացե՛ք PDF ֆայլեր՝ օգտագործելով GroupDocs.Merger Java API-ի համար
