...
############################# Head ############################
head_title: "Liituge failidega EPUB Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu EPUB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge EPUB failiga rakenduses Java"
description: "Liituge tootega EPUB mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu EPUB faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme EPUB faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada EPUB faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid EPUB, kasutades GroupDocs.Merger for Java API-t
