...
############################# Head ############################
head_title: "Sertai XLAM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLAM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLAM Fail Dalam Java"
description: "Sertai XLAM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLAM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLAM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLAM menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLAM fail menggunakan GroupDocs.Merger untuk API Java
