...
############################# Head ############################
head_title: "Bergabunglah dengan JPEG File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung JPEG File Di Java"
description: "Bergabunglah dengan JPEG dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPEG menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file JPEG menggunakan GroupDocs.Merger untuk Java API
