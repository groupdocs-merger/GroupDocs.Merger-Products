...
############################# Head ############################
head_title: "Liituge failidega XLS Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLS failiga rakenduses Java"
description: "Liituge tootega XLS mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLS faili, kasutades Java näitekoodi">}}
