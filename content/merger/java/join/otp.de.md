...
############################# Head ############################
head_title: "Verbinden Sie OTP Dateien über die Java & J2SE Documents Merger API"
head_description: "Verbinden Sie mehrere OTP-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Verbinden Sie OTP Dateien in Java"
description: "Treten Sie OTP mit ein paar Zeilen Java-Code bei."
...
steps:
    enable: true
    title_left: "Verbinden Sie mehrere OTP-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere OTP-Dateien zu verbinden, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So verbinden Sie OTP-Dateien mit Java-Beispielcode">}}

        ```java    
        // Verknüpfen Sie OTP-Dateien mit GroupDocs.Merger for Java API
