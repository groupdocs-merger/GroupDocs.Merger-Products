...
############################# Head ############################
head_title: "Bergabunglah dengan MHTML File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung MHTML File Di Java"
description: "Bergabunglah dengan MHTML dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file MHTML menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file MHTML menggunakan GroupDocs.Merger untuk Java API
