...
############################# Head ############################
head_title: "Присъединете се към RTF файлове чрез Java & J2SE Documents Merger API"
head_description: "Свържете множество RTF файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Присъединете се към RTF файлове в Java"
description: "Присъединете се към RTF с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Присъединете се към множество RTF файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да съедините RTF файлове с Java примерен код">}}

        ```java    
        // Присъединете се към RTF файлове с помощта на GroupDocs.Merger за Java API
