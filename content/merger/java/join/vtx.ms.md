...
############################# Head ############################
head_title: "Sertai VTX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VTX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VTX Fail Dalam Java"
description: "Sertai VTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VTX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VTX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VTX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VTX fail menggunakan GroupDocs.Merger untuk API Java
