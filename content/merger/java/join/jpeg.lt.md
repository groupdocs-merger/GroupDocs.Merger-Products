...
############################# Head ############################
head_title: "Prisijunkite prie JPEG failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis JPEG failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie JPEG failų Java"
description: "Prisijunkite prie JPEG naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis JPEG failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis JPEG failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti JPEG failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite JPEG failus naudodami GroupDocs.Merger for Java API
