...
############################# Head ############################
head_title: "Pridružite VSTX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSTX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSTX datotekama u Java"
description: "Pridružite se VSTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSTX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSTX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSTX datoteke koristeći GroupDocs.Merger za Java API
