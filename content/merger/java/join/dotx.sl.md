...
############################# Head ############################
head_title: "Pridružite se datotekam DOTX prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam DOTX v Java"
description: "Pridružite se DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam DOTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOTX s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam DOTX z API-jem GroupDocs.Merger za Java
