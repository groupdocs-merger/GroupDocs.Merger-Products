...
############################# Head ############################
head_title: "Prisijunkite prie OTP failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis OTP failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie OTP failų Java"
description: "Prisijunkite prie OTP naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis OTP failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis OTP failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti OTP failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite OTP failus naudodami GroupDocs.Merger for Java API
