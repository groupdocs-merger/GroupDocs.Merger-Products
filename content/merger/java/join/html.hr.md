...
############################# Head ############################
head_title: "Pridružite HTML datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više HTML datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite HTML datotekama u Java"
description: "Pridružite se HTML s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više HTML datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti HTML datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite HTML datoteke koristeći GroupDocs.Merger za Java API
