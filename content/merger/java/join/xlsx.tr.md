...
############################# Head ############################
head_title: "XLSX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLSX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLSX Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLSX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLSX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLSX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) web sitesini ziyaret ederek birden fazla XLSX dosyasına hemen katılın.
