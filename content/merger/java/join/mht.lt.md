...
############################# Head ############################
head_title: "Prisijunkite prie MHT failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis MHT failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie MHT failų Java"
description: "Prisijunkite prie MHT naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis MHT failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis MHT failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti MHT failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite MHT failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno MHT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) svetainėje.
