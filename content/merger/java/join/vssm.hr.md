...
############################# Head ############################
head_title: "Pridružite VSSM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSSM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSSM datotekama u Java"
description: "Pridružite se VSSM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSSM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSSM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSSM datoteke koristeći GroupDocs.Merger za Java API
