...
############################# Head ############################
head_title: "Pridružite PNG datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PNG datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PNG datotekama u Java"
description: "Pridružite se PNG s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PNG datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PNG datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PNG datoteke koristeći GroupDocs.Merger za Java API
