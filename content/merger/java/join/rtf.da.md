...
############################# Head ############################
head_title: "Deltag i RTF filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere RTF-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i RTF filer i Java"
description: "Slut dig til RTF med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere RTF-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere RTF-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du RTF filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i RTF filer ved hjælp af GroupDocs.Merger for Java API
