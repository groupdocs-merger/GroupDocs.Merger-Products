...
############################# Head ############################
head_title: "Csatlakozzon a OTT fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több OTT fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás OTT fájlhoz itt: Java"
description: "Csatlakozzon az OTT termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több OTT fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több OTT fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson OTT fájlt a GroupDocs.Merger for Java API segítségével
