...
############################# Head ############################
head_title: "Tevlî pelên XLTM bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên XLTM li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên XLTM Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî XLTM bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek XLTM Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên XLTM bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên XLTM dibe">}}

        ```java    
        // Tevlî pelên XLTM bibin bi karanîna GroupDocs.Merger ji bo Java API
