...
############################# Head ############################
head_title: "Liituge failidega MHT Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu MHT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge MHT failiga rakenduses Java"
description: "Liituge tootega MHT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu MHT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme MHT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada MHT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid MHT, kasutades GroupDocs.Merger for Java API-t
