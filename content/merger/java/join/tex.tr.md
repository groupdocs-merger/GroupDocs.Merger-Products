...
############################# Head ############################
head_title: "TEX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla TEX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki TEX Dosyaya Katılın"
description: "Birkaç satır Java koduyla TEX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok TEX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok TEX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TEX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak TEX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) web sitesini ziyaret ederek birden fazla TEX dosyasına hemen katılın.
