...
############################# Head ############################
head_title: "BMP ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ይቀላቀሉ"
head_description: "የሰነዶች ውህደት ኤፒአይ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት ጋር እንደ ምንጭ ሰነዶች በመጠቀም ብዙ BMP ፋይሎችን በጃቫ ውስጥ ይቀላቀሉ።"

############################# Header ############################
title: "በJava ውስጥ BMP ፋይሎችን ይቀላቀሉ"
description: "BMPን በጥቂት የJava ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ BMP ፋይሎችን ይቀላቀሉ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ BMP ፋይሎችን መቀላቀል ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="Java ምሳሌ ኮድን በመጠቀም BMP ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለJava API በመጠቀም BMP ፋይሎችን ይቀላቀሉ
