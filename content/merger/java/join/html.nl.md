...
############################# Head ############################
head_title: "Word lid van HTML bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere HTML-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van HTML bestanden in Java"
description: "Sluit je aan bij HTML met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere HTML bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere HTML-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u HTML bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van HTML bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één HTML-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) te gaan.
