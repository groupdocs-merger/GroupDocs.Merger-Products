...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы TXT файлдарына қосылыңыз"
...
############################# Header ############################
title: "TXT файлдарына Java ішінде қосылу"
description: "TXT жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше TXT файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="TXT файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы TXT файлдарға қосылыңыз
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) веб-сайтына кіру арқылы бірден көп TXT файлдарға қосылыңыз.
