...
############################# Head ############################
head_title: "Pridružite CSV datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više CSV datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite CSV datotekama u Java"
description: "Pridružite se CSV s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više CSV datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti CSV datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite CSV datoteke koristeći GroupDocs.Merger za Java API
