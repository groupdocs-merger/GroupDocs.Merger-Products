...
############################# Head ############################
head_title: "VSDM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VSDM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VSDM Dosyaya Katılın"
description: "Birkaç satır Java koduyla VSDM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VSDM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSDM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSDM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) web sitesini ziyaret ederek birden fazla VSDM dosyasına hemen katılın.
