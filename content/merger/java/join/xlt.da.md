...
############################# Head ############################
head_title: "Deltag i XLT filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere XLT-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i XLT filer i Java"
description: "Slut dig til XLT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere XLT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere XLT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du XLT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i XLT filer ved hjælp af GroupDocs.Merger for Java API
