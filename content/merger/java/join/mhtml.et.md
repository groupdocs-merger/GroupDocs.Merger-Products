...
############################# Head ############################
head_title: "Liituge failidega MHTML Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu MHTML-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge MHTML failiga rakenduses Java"
description: "Liituge tootega MHTML mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu MHTML faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme MHTML faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada MHTML faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid MHTML, kasutades GroupDocs.Merger for Java API-t
