...
############################# Head ############################
head_title: "Sertai DOC Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail DOC dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai DOC Fail Dalam Java"
description: "Sertai DOC dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang DOC Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail DOC dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail DOC menggunakan kod contoh Java.">}}

        ```java    
        // Sertai DOC fail menggunakan GroupDocs.Merger untuk API Java
