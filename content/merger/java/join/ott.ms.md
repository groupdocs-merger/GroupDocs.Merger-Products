...
############################# Head ############################
head_title: "Sertai OTT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail OTT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai OTT Fail Dalam Java"
description: "Sertai OTT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang OTT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail OTT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail OTT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai OTT fail menggunakan GroupDocs.Merger untuk API Java
