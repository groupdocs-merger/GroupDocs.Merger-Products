...
############################# Head ############################
head_title: "Prisijunkite prie PDF failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis PDF failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie PDF failų Java"
description: "Prisijunkite prie PDF naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis PDF failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis PDF failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PDF failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite PDF failus naudodami GroupDocs.Merger for Java API
