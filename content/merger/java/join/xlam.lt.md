...
############################# Head ############################
head_title: "Prisijunkite prie XLAM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLAM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLAM failų Java"
description: "Prisijunkite prie XLAM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLAM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLAM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLAM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLAM failus naudodami GroupDocs.Merger for Java API
