...
############################# Head ############################
head_title: "PPTX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla PPTX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki PPTX Dosyaya Katılın"
description: "Birkaç satır Java koduyla PPTX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok PPTX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok PPTX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPTX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPTX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) web sitesini ziyaret ederek birden fazla PPTX dosyasına hemen katılın.
