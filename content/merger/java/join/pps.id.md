...
############################# Head ############################
head_title: "Bergabunglah dengan PPS File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung PPS File Di Java"
description: "Bergabunglah dengan PPS dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPS menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file PPS menggunakan GroupDocs.Merger untuk Java API
