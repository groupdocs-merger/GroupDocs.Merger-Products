...
############################# Head ############################
head_title: "Sertai TXT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail TXT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai TXT Fail Dalam Java"
description: "Sertai TXT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang TXT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail TXT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail TXT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai TXT fail menggunakan GroupDocs.Merger untuk API Java
