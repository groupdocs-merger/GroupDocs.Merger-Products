...
############################# Head ############################
head_title: "Unir arquivos WORD em Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de junção de documentos WORD às suas aplicações Java."

############################# Header ############################
title: "Unir arquivos WORD" 
description: "GroupDocs.Merger for Java permite que você desenvolva aplicações Java que juntam eficientemente múltiplos documentos WORD."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece uma maneira de unir documentos WORD. Melhore suas aplicações Java combinando vários arquivos em um.
      
      1. Especifique o caminho para o primeiro arquivo WORD.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicialize Merger com o documento de entrada WORD
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas específicas de diferentes formatos de documentos"
      content: |
        Este exemplo mostra como unir arquivos WORD enquanto seleciona páginas específicas de outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
