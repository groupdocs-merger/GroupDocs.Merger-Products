...
############################# Head ############################
head_title: "Sertai HTML Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail HTML dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai HTML Fail Dalam Java"
description: "Sertai HTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang HTML Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail HTML dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail HTML menggunakan kod contoh Java.">}}

        ```java    
        // Sertai HTML fail menggunakan GroupDocs.Merger untuk API Java
