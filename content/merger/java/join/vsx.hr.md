...
############################# Head ############################
head_title: "Pridružite VSX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSX datotekama u Java"
description: "Pridružite se VSX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSX datoteke koristeći GroupDocs.Merger za Java API
