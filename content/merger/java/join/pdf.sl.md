...
############################# Head ############################
head_title: "Pridružite se datotekam PDF prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam PDF v Java"
description: "Pridružite se PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam PDF v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PDF s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam PDF z API-jem GroupDocs.Merger za Java
