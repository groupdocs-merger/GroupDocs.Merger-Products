...
############################# Head ############################
head_title: "Junte-se a DOC Arquivos via Java & J2SE Documents Merger API"
head_description: "Junte vários arquivos DOC em Java usando a API de fusão de documentos com todos os dados, estilo e formatação como documentos de origem."

############################# Header ############################
title: "Junte-se a DOC arquivos em Java"
description: "Junte-se a DOC com algumas linhas de código Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pt/merger/java/) fornece uma solução conveniente para juntar vários PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, imagens e muitos outros documentos em um único arquivo dentro dos aplicativos Java. O GroupDocs.Merger economizará muito esforço, pois você tem permissão para juntar DOC documentos - não há necessidade de instalar nenhum software de terceiros, aplicativos de desktop ou plug-ins. Agora é desnecessário perder seu tempo e juntar arquivos manualmente! A missão do GroupDocs é fornecer a melhor qualidade e simplificar os fluxos de trabalho de processamento de documentos.
...
steps:
    enable: true
    title_left: "Junte vários arquivos DOC em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores Java juntarem vários arquivos DOC implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOC usando o código de exemplo Java">}}

        ```java    
        // Junte-se a arquivos DOC usando GroupDocs.Merger for Java API
        // Instanciar Fusão com documento de entrada DOC
...
demos:
    ...
    content: |
       Junte-se a mais de um arquivo DOC agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
