...
############################# Head ############################
head_title: "Dołącz do plików XLSB przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików XLSB w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do XLSB plików w Java"
description: "Dołącz do XLSB za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików XLSB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików XLSB, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików XLSB przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików XLSB za pomocą GroupDocs.Merger for Java API
