...
############################# Head ############################
head_title: "Sertai MHT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail MHT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai MHT Fail Dalam Java"
description: "Sertai MHT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang MHT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail MHT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail MHT menggunakan kod contoh Java.">}}

        ```java    
        // Sertai MHT fail menggunakan GroupDocs.Merger untuk API Java
