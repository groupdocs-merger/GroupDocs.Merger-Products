...
############################# Head ############################
head_title: "Word lid van VSX bestanden via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Word lid van VSX bestanden in Java"
description: "Sluit je aan bij VSX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere VSX bestanden in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u VSX bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van VSX bestanden met behulp van GroupDocs.Merger voor Java API
