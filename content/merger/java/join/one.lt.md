...
############################# Head ############################
head_title: "Prisijunkite prie ONE failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis ONE failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie ONE failų Java"
description: "Prisijunkite prie ONE naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis ONE failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis ONE failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti ONE failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite ONE failus naudodami GroupDocs.Merger for Java API
