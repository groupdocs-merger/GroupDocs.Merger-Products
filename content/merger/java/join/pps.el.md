...
############################# Head ############################
head_title: "Εγγραφείτε στα αρχεία PPS μέσω Java & J2SE Documents Merger API"
head_description: "Συνδέστε πολλά αρχεία PPS σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία PPS σε Java"
description: "Εγγραφείτε στο PPS με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συμμετοχή σε πολλά PPS αρχεία στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να ενώσουν πολλά αρχεία PPS εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία PPS χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Εγγραφείτε σε αρχεία PPS χρησιμοποιώντας το GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Εγγραφείτε σε περισσότερα από ένα αρχεία PPS αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
