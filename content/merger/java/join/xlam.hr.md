...
############################# Head ############################
head_title: "Pridružite XLAM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLAM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLAM datotekama u Java"
description: "Pridružite se XLAM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLAM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLAM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLAM datoteke koristeći GroupDocs.Merger za Java API
