...
head_description: "Utilizza GroupDocs.Merger for Java per aggiungere capacità di unione di documenti PNG alle tue applicazioni Java."

############################# Header ############################
title: "Unisci file PNG" 
description: "GroupDocs.Merger for Java ti consente di sviluppare applicazioni Java che uniscono in modo efficiente più documenti PNG."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) offre un metodo per unire documenti PNG. Migliora le tue applicazioni Java combinando più file in uno.
      
      1. Specificare il percorso del primo file PNG.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine specifiche da diversi formati di documento"
      content: |
        Questo esempio mostra come unire file PNG selezionando pagine specifiche da altri formati.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
