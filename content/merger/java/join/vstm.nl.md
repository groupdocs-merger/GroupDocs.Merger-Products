...
############################# Head ############################
head_title: "Word lid van VSTM bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere VSTM-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van VSTM bestanden in Java"
description: "Sluit je aan bij VSTM met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere VSTM bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere VSTM-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u VSTM bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van VSTM bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één VSTM-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) te gaan.
