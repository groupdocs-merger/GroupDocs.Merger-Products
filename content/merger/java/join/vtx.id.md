...
############################# Head ############################
head_title: "Bergabunglah dengan VTX File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung VTX File Di Java"
description: "Bergabunglah dengan VTX dengan beberapa baris kode Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file VTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VTX menggunakan kode contoh Java">}}

        ```java    
        // Bergabunglah dengan file VTX menggunakan GroupDocs.Merger untuk Java API
