...
############################# Head ############################
head_title: "Csatlakozzon a JPEG fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több JPEG fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás JPEG fájlhoz itt: Java"
description: "Csatlakozzon az JPEG termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több JPEG fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több JPEG fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPEG fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson JPEG fájlt a GroupDocs.Merger for Java API segítségével
