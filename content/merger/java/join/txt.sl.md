...
############################# Head ############################
head_title: "Pridružite se datotekam TXT prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam TXT v Java"
description: "Pridružite se TXT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam TXT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TXT s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam TXT z API-jem GroupDocs.Merger za Java
...
demos:
    ...
    content: |
       Pridružite se več kot eni TXT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
