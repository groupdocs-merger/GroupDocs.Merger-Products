...
############################# Head ############################
head_title: "Prisijunkite prie XLTM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLTM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLTM failų Java"
description: "Prisijunkite prie XLTM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLTM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLTM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLTM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLTM failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno XLTM failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) svetainėje.
