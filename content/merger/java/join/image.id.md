...
############################# Head ############################
head_title: "Bergabunglah dengan IMAGE File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung IMAGE File Di Java"
description: "Bergabunglah dengan IMAGE dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file IMAGE menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file IMAGE menggunakan GroupDocs.Merger untuk Java API
