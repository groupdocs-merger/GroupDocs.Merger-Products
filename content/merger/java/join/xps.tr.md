...
############################# Head ############################
head_title: "XPS Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XPS dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XPS Dosyaya Katılın"
description: "Birkaç satır Java koduyla XPS'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XPS Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XPS dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XPS dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XPS dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) web sitesini ziyaret ederek birden fazla XPS dosyasına hemen katılın.
