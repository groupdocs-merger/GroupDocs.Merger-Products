...
############################# Head ############################
head_title: "Bergabunglah dengan PDF File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung PDF File Di Java"
description: "Bergabunglah dengan PDF dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PDF menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file PDF menggunakan GroupDocs.Merger untuk Java API
