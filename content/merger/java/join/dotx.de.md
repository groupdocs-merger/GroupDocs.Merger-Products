...
############################# Head ############################
head_title: "Verbinden Sie DOTX Dateien über die Java & J2SE Documents Merger API"
head_description: "Verbinden Sie mehrere DOTX-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Verbinden Sie DOTX Dateien in Java"
description: "Treten Sie DOTX mit ein paar Zeilen Java-Code bei."
...
steps:
    enable: true
    title_left: "Verbinden Sie mehrere DOTX-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOTX-Dateien zu verbinden, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So verbinden Sie DOTX-Dateien mit Java-Beispielcode">}}

        ```java    
        // Verknüpfen Sie DOTX-Dateien mit GroupDocs.Merger for Java API
