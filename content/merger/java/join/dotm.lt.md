...
############################# Head ############################
head_title: "Prisijunkite prie DOTM failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis DOTM failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie DOTM failų Java"
description: "Prisijunkite prie DOTM naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis DOTM failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis DOTM failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOTM failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite DOTM failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno DOTM failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) svetainėje.
