...
############################# Head ############################
head_title: "Pridružite ODS datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više ODS datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite ODS datotekama u Java"
description: "Pridružite se ODS s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više ODS datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODS datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite ODS datoteke koristeći GroupDocs.Merger za Java API
