...
############################# Head ############################
head_title: "Unisciti a PPTX file tramite Java e J2SE Documents Merger API"
head_description: "Unisci più file PPTX in Java utilizzando l'API di fusione documenti con tutti i dati, lo stile e la formattazione come documenti di origine."

############################# Header ############################
title: "Unisciti a PPTX file in Java"
description: "Unisciti a PPTX con poche righe di codice Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/it/merger/java/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni Java. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unirti a PPTX documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    enable: true
    title_left: "Unisci più file PPTX in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori Java di unire facilmente più file PPTX implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file PPTX utilizzando il codice di esempio Java">}}

        ```java    
        // Unisciti ai file PPTX utilizzando GroupDocs.Merger per l'API Java
