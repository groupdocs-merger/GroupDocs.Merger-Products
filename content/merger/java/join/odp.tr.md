...
############################# Head ############################
head_title: "ODP Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla ODP dosyasına katılın."

############################# Header ############################
title: "Java İçindeki ODP Dosyaya Katılın"
description: "Birkaç satır Java koduyla ODP'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok ODP Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok ODP dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODP dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODP dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) web sitesini ziyaret ederek birden fazla ODP dosyasına hemen katılın.
