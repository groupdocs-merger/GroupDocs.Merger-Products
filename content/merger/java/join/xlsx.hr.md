...
############################# Head ############################
head_title: "Pridružite XLSX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLSX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLSX datotekama u Java"
description: "Pridružite se XLSX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLSX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLSX datoteke koristeći GroupDocs.Merger za Java API
