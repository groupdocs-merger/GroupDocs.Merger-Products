...
############################# Head ############################
head_title: "Prisijunkite prie VSDX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis VSDX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie VSDX failų Java"
description: "Prisijunkite prie VSDX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis VSDX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis VSDX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSDX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite VSDX failus naudodami GroupDocs.Merger for Java API
