...
############################# Head ############################
head_title: "Prisijunkite prie DOC failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis DOC failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie DOC failų Java"
description: "Prisijunkite prie DOC naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis DOC failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis DOC failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOC failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite DOC failus naudodami GroupDocs.Merger for Java API
