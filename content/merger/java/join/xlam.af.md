...
############################# Head ############################
head_title: "Sluit aan by XLAM-lêers via Java & J2SE Documents Merger API"
head_description: "Sluit aan by verskeie XLAM-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Sluit aan by XLAM-lêers in Java"
description: "Sluit aan by XLAM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Sluit aan by verskeie XLAM-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om by verskeie XLAM-lêers aan te sluit deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by XLAM-lêers aan te sluit deur Java-voorbeeldkode te gebruik">}}

        ```java    
        // Sluit aan by XLAM lêers deur GroupDocs.Merger vir Java API te gebruik
