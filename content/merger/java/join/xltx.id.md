...
############################# Head ############################
head_title: "Bergabunglah dengan XLTX File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung XLTX File Di Java"
description: "Bergabunglah dengan XLTX dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLTX menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file XLTX menggunakan GroupDocs.Merger untuk Java API
