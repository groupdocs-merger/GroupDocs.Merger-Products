...
############################# Head ############################
head_title: "Join PDF files in Java"
head_description: "Use GroupDocs.Merger for Java to add PDF document joining capabilities to your Java applications."

############################# Header ############################
title: "Join PDF files" 
description: "GroupDocs.Merger for Java enables you to develop Java applications that efficiently join multiple PDF documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) provides an easy way to join PDF documents. Enhance your Java applications by combining multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join specific pages from different document formats"
      content: |
        This example shows how to join PDF files while selecting specific pages from other formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
