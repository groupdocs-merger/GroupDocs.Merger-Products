...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы PPSX файлдарына қосылыңыз"
...
############################# Header ############################
title: "PPSX файлдарына Java ішінде қосылу"
description: "PPSX жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше PPSX файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы PPSX файлдарға қосылыңыз
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) веб-сайтына кіру арқылы бірден көп PPSX файлдарға қосылыңыз.
