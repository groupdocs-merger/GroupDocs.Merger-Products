...
############################# Head ############################
head_title: "Csatlakozzon a BMP fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több BMP fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás BMP fájlhoz itt: Java"
description: "Csatlakozzon az BMP termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több BMP fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több BMP fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="BMP fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson BMP fájlt a GroupDocs.Merger for Java API segítségével
