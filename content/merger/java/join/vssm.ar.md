...
############################# Head ############################
head_title: "انضم إلى ملفات VSSM عبر Java & J2SE Documents Merger API"
head_description: "انضم إلى عدة ملفات VSSM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "انضم إلى ملفات VSSM في Java"
description: "انضم إلى VSSM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "ضم عدة ملفات VSSM في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا الانضمام إلى عدة ملفات VSSM من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات VSSM باستخدام كود مثال Java">}}

        ```java    
        // انضم إلى ملفات VSSM باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات Java
