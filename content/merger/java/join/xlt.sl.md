...
############################# Head ############################
head_title: "Pridružite se datotekam XLT prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam XLT v Java"
description: "Pridružite se XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam XLT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLT s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam XLT z API-jem GroupDocs.Merger za Java
