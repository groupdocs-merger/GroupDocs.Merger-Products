...
############################# Head ############################
head_title: "ONE Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla ONE dosyasına katılın."

############################# Header ############################
title: "Java İçindeki ONE Dosyaya Katılın"
description: "Birkaç satır Java koduyla ONE'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok ONE Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok ONE dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ONE dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ONE dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) web sitesini ziyaret ederek birden fazla ONE dosyasına hemen katılın.
