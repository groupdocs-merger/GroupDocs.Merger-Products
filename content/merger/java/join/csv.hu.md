...
############################# Head ############################
head_title: "Csatlakozzon a CSV fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több CSV fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás CSV fájlhoz itt: Java"
description: "Csatlakozzon az CSV termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több CSV fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több CSV fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="CSV fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson CSV fájlt a GroupDocs.Merger for Java API segítségével
