...
############################# Head ############################
head_title: "Pridružite XLS datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLS datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLS datotekama u Java"
description: "Pridružite se XLS s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLS datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLS datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLS datoteke koristeći GroupDocs.Merger za Java API
