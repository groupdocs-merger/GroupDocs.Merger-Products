...
############################# Head ############################
head_title: "Liituge failidega VDX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VDX failiga rakenduses Java"
description: "Liituge tootega VDX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VDX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VDX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VDX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VDX, kasutades GroupDocs.Merger for Java API-t
