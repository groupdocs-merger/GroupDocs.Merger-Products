...
############################# Head ############################
head_title: "Csatlakozzon a TSV fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több TSV fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás TSV fájlhoz itt: Java"
description: "Csatlakozzon az TSV termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több TSV fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több TSV fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="TSV fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson TSV fájlt a GroupDocs.Merger for Java API segítségével
