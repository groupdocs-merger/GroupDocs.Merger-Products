...
############################# Head ############################
head_title: "Csatlakozzon a VSSX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több VSSX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás VSSX fájlhoz itt: Java"
description: "Csatlakozzon az VSSX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több VSSX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több VSSX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson VSSX fájlt a GroupDocs.Merger for Java API segítségével
