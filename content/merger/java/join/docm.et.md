...
############################# Head ############################
head_title: "Liituge failidega DOCM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOCM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOCM failiga rakenduses Java"
description: "Liituge tootega DOCM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu DOCM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme DOCM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOCM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid DOCM, kasutades GroupDocs.Merger for Java API-t
