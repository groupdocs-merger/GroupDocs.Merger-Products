...
############################# Head ############################
head_title: "Pridružite JPG datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više JPG datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite JPG datotekama u Java"
description: "Pridružite se JPG s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više JPG datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti JPG datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite JPG datoteke koristeći GroupDocs.Merger za Java API
