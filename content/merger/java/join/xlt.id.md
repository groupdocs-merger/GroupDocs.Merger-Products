...
############################# Head ############################
head_title: "Bergabunglah dengan XLT File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung XLT File Di Java"
description: "Bergabunglah dengan XLT dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLT menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file XLT menggunakan GroupDocs.Merger untuk Java API
