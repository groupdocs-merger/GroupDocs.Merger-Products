...
############################# Head ############################
head_title: "Připojte se k XPS souborům prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Spojte více XPS souborů v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Připojte se k XPS souborům v Java"
description: "Připojte se k XPS pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Spojit více souborů XPS ve službě Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům jazyka Java spojení více souborů XPS provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak připojit soubory XPS pomocí ukázkového kódu Java">}}

        ```java    
        // Připojte se k XPS souborům pomocí GroupDocs.Merger for Java API
