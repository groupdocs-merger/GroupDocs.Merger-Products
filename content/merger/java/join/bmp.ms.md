...
############################# Head ############################
head_title: "Sertai BMP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail BMP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai BMP Fail Dalam Java"
description: "Sertai BMP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang BMP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail BMP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail BMP menggunakan kod contoh Java.">}}

        ```java    
        // Sertai BMP fail menggunakan GroupDocs.Merger untuk API Java
