...
############################# Head ############################
head_title: "Pridružite se datotekam DOC prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Pridružite se datotekam DOC v Java"
description: "Pridružite se DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Pridružite se več datotekam DOC v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOC s primerom kode Java">}}
        ...
        ```java    
        // Pridružite se datotekam DOC z API-jem GroupDocs.Merger za Java
...
demos:
    ...
    content: |
       Pridružite se več kot eni DOC datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
