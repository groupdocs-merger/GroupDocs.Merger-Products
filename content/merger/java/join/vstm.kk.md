...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы VSTM файлдарына қосылыңыз"
...
############################# Header ############################
title: "VSTM файлдарына Java ішінде қосылу"
description: "VSTM жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше VSTM файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы VSTM файлдарға қосылыңыз
