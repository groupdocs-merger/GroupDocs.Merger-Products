...
############################# Head ############################
head_title: "Liituge failidega VSDX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSDX failiga rakenduses Java"
description: "Liituge tootega VSDX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSDX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSDX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSDX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSDX, kasutades GroupDocs.Merger for Java API-t
