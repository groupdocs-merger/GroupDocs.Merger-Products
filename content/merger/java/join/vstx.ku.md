...
############################# Head ############################
head_title: "Tevlî pelên VSTX bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên VSTX li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên VSTX Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî VSTX bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek VSTX Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên VSTX bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên VSTX dibe">}}

        ```java    
        // Tevlî pelên VSTX bibin bi karanîna GroupDocs.Merger ji bo Java API
