...
############################# Head ############################
head_title: "Pridružite DOCM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOCM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite DOCM datotekama u Java"
description: "Pridružite se DOCM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više DOCM datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima spajanje više DOCM datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCM datoteke koristeći Java primjer koda">}}

        ```java    
        // Pridružite DOCM datoteke koristeći GroupDocs.Merger za Java API
