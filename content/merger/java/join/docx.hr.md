...
############################# Head ############################
head_title: "Pridružite DOCX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOCX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite DOCX datotekama u Java"
description: "Pridružite se DOCX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više DOCX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite DOCX datoteke koristeći GroupDocs.Merger za Java API
