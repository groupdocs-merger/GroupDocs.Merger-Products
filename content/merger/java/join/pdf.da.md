...
############################# Head ############################
head_title: "Deltag i PDF filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere PDF-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i PDF filer i Java"
description: "Slut dig til PDF med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere PDF-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere PDF-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du PDF filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i PDF filer ved hjælp af GroupDocs.Merger for Java API
