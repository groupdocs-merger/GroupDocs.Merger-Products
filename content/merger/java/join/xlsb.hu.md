...
############################# Head ############################
head_title: "Csatlakozzon a XLSB fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több XLSB fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás XLSB fájlhoz itt: Java"
description: "Csatlakozzon az XLSB termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több XLSB fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több XLSB fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson XLSB fájlt a GroupDocs.Merger for Java API segítségével
