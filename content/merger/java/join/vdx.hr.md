...
############################# Head ############################
head_title: "Pridružite VDX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VDX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VDX datotekama u Java"
description: "Pridružite se VDX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VDX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VDX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VDX datoteke koristeći GroupDocs.Merger za Java API
