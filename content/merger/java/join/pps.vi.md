...
############################# Head ############################
head_title: "Tham gia các tệp PPS qua API hợp nhất tài liệu Java & J2SE"
head_description: "Nối nhiều tệp PPS trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Tham gia PPS Tệp trong Java"
description: "Tham gia PPS với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Nối Nhiều PPS Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng kết hợp nhiều tệp PPS bằng cách triển khai một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp PPS bằng mã mẫu Java">}}

        ```java    
        // Nối các tệp PPS bằng GroupDocs.Merger cho Java API
