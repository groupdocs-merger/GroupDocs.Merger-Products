...
############################# Head ############################
head_title: "Liituge failidega DOC Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOC-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOC failiga rakenduses Java"
description: "Liituge tootega DOC mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu DOC faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme DOC faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOC faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid DOC, kasutades GroupDocs.Merger for Java API-t
