...
############################# Head ############################
head_title: "Csatlakozzon a XLSM fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több XLSM fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás XLSM fájlhoz itt: Java"
description: "Csatlakozzon az XLSM termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több XLSM fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több XLSM fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson XLSM fájlt a GroupDocs.Merger for Java API segítségével
