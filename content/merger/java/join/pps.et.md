...
############################# Head ############################
head_title: "Liituge failidega PPS Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge PPS failiga rakenduses Java"
description: "Liituge tootega PPS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu PPS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme PPS faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPS faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid PPS, kasutades GroupDocs.Merger for Java API-t
