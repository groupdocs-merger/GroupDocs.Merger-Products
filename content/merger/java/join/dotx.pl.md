...
############################# Head ############################
head_title: "Dołącz do plików DOTX przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików DOTX w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do DOTX plików w Java"
description: "Dołącz do DOTX za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików DOTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików DOTX, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików DOTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików DOTX za pomocą GroupDocs.Merger for Java API
