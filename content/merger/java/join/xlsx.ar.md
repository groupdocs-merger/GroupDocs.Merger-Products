...
############################# Head ############################
head_title: "انضم إلى ملفات XLSX عبر Java & J2SE Documents Merger API"
head_description: "انضم إلى عدة ملفات XLSX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "انضم إلى ملفات XLSX في Java"
description: "انضم إلى XLSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "ضم عدة ملفات XLSX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا الانضمام إلى عدة ملفات XLSX من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات XLSX باستخدام كود مثال Java">}}

        ```java    
        // انضم إلى ملفات XLSX باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات Java
...
demos:
    ...
    content: |
       انضم إلى أكثر من XLSX ملف واحد الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
