...
############################# Head ############################
head_title: "Deltag i DOC filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere DOC-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i DOC filer i Java"
description: "Slut dig til DOC med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere DOC-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere DOC-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du DOC filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i DOC filer ved hjælp af GroupDocs.Merger for Java API
