...
############################# Head ############################
head_title: "Pridružite JPEG datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više JPEG datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite JPEG datotekama u Java"
description: "Pridružite se JPEG s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više JPEG datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima spajanje više JPEG datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti JPEG datoteke koristeći Java primjer koda">}}

        ```java    
        // Pridružite JPEG datoteke koristeći GroupDocs.Merger za Java API
