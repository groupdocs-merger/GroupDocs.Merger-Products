...
############################# Head ############################
head_title: "Bergabunglah dengan VSSX File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung VSSX File Di Java"
description: "Bergabunglah dengan VSSX dengan beberapa baris kode Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file VSSX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSSX menggunakan kode contoh Java">}}

        ```java    
        // Bergabunglah dengan file VSSX menggunakan GroupDocs.Merger untuk Java API
