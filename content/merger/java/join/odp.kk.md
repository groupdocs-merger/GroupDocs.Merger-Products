...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы ODP файлдарына қосылыңыз"
...
############################# Header ############################
title: "ODP файлдарына Java ішінде қосылу"
description: "ODP жүйесіне Java кодының бірнеше жолымен қосылыңыз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше ODP файлдарға қосылу"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP файлдарды Java мысал кодын пайдаланып қосу жолы">}}

        ```java    
        // Java API үшін GroupDocs.Merger арқылы ODP файлдарға қосылыңыз
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) веб-сайтына кіру арқылы бірден көп ODP файлдарға қосылыңыз.
