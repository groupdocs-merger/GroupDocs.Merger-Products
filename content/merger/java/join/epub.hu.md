...
############################# Head ############################
head_title: "Csatlakozzon a EPUB fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több EPUB fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás EPUB fájlhoz itt: Java"
description: "Csatlakozzon az EPUB termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több EPUB fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több EPUB fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson EPUB fájlt a GroupDocs.Merger for Java API segítségével
