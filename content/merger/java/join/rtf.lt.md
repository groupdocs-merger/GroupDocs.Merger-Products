...
############################# Head ############################
head_title: "Prisijunkite prie RTF failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis RTF failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie RTF failų Java"
description: "Prisijunkite prie RTF naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis RTF failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis RTF failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti RTF failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite RTF failus naudodami GroupDocs.Merger for Java API
