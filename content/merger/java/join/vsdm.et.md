...
############################# Head ############################
head_title: "Liituge failidega VSDM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSDM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSDM failiga rakenduses Java"
description: "Liituge tootega VSDM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSDM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSDM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSDM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSDM, kasutades GroupDocs.Merger for Java API-t
