...
############################# Head ############################
head_title: "Sertai XLSB Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail XLSB dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai XLSB Fail Dalam Java"
description: "Sertai XLSB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang XLSB Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail XLSB dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XLSB menggunakan kod contoh Java.">}}

        ```java    
        // Sertai XLSB fail menggunakan GroupDocs.Merger untuk API Java
