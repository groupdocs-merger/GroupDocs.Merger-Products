...
############################# Head ############################
head_title: "Pridružite XLTM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLTM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLTM datotekama u Java"
description: "Pridružite se XLTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLTM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLTM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLTM datoteke koristeći GroupDocs.Merger za Java API
