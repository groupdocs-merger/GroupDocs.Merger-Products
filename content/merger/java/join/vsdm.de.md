...
############################# Head ############################
head_title: "Verbinden Sie VSDM Dateien über die Java & J2SE Documents Merger API"
head_description: "Verbinden Sie mehrere VSDM-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Verbinden Sie VSDM Dateien in Java"
description: "Treten Sie VSDM mit ein paar Zeilen Java-Code bei."
...
steps:
    enable: true
    title_left: "Verbinden Sie mehrere VSDM-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VSDM-Dateien zu verbinden, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So verbinden Sie VSDM-Dateien mit Java-Beispielcode">}}

        ```java    
        // Verknüpfen Sie VSDM-Dateien mit GroupDocs.Merger for Java API
