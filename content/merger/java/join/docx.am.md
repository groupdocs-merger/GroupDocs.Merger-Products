...
############################# Head ############################
head_title: "DOCX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ይቀላቀሉ"
head_description: "የሰነዶች ውህደት ኤፒአይ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት ጋር እንደ ምንጭ ሰነዶች በመጠቀም ብዙ DOCX ፋይሎችን በጃቫ ውስጥ ይቀላቀሉ።"

############################# Header ############################
title: "በJava ውስጥ DOCX ፋይሎችን ይቀላቀሉ"
description: "DOCXን በጥቂት የJava ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ DOCX ፋይሎችን ይቀላቀሉ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ DOCX ፋይሎችን መቀላቀል ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="Java ምሳሌ ኮድን በመጠቀም DOCX ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለJava API በመጠቀም DOCX ፋይሎችን ይቀላቀሉ
