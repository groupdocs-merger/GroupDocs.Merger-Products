...
############################# Head ############################
head_title: "Dołącz do plików PPT przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików PPT w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do PPT plików w Java"
description: "Dołącz do PPT za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików PPT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików PPT, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików PPT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików PPT za pomocą GroupDocs.Merger for Java API
