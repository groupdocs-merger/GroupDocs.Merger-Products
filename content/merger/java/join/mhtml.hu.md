...
############################# Head ############################
head_title: "Csatlakozzon a MHTML fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több MHTML fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás MHTML fájlhoz itt: Java"
description: "Csatlakozzon az MHTML termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több MHTML fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több MHTML fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson MHTML fájlt a GroupDocs.Merger for Java API segítségével
