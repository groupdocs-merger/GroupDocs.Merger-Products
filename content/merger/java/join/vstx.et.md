...
############################# Head ############################
head_title: "Liituge failidega VSTX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSTX failiga rakenduses Java"
description: "Liituge tootega VSTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSTX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSTX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSTX, kasutades GroupDocs.Merger for Java API-t
