...
############################# Head ############################
head_title: "Liituge failidega CSV Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu CSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge CSV failiga rakenduses Java"
description: "Liituge tootega CSV mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu CSV faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme CSV faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada CSV faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid CSV, kasutades GroupDocs.Merger for Java API-t
