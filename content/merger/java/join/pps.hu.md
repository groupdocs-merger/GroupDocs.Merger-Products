...
############################# Head ############################
head_title: "Csatlakozzon a PPS fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több PPS fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás PPS fájlhoz itt: Java"
description: "Csatlakozzon az PPS termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több PPS fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több PPS fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson PPS fájlt a GroupDocs.Merger for Java API segítségével
