...
############################# Head ############################
head_title: "Tham gia các tệp PNG qua API hợp nhất tài liệu Java & J2SE"
head_description: "Nối nhiều tệp PNG trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Tham gia PNG Tệp trong Java"
description: "Tham gia PNG với một vài dòng mã Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp PNG bằng mã mẫu Java">}}

        ```java    
        // Nối các tệp PNG bằng GroupDocs.Merger cho Java API
