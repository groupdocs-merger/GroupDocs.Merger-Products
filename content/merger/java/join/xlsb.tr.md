...
############################# Head ############################
head_title: "XLSB Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLSB dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLSB Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLSB'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLSB Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLSB dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSB dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSB dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) web sitesini ziyaret ederek birden fazla XLSB dosyasına hemen katılın.
