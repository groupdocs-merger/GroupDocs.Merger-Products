...
############################# Head ############################
head_title: "Word lid van XLSX bestanden via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Word lid van XLSX bestanden in Java"
description: "Sluit je aan bij XLSX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere XLSX bestanden in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u XLSX bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van XLSX bestanden met behulp van GroupDocs.Merger voor Java API
