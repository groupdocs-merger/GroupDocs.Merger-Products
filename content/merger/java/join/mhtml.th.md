...
############################# Head ############################
head_title: "เข้าร่วม MHTML ไฟล์ผ่าน Java & J2SE Documents Merger API"
head_description: "เข้าร่วมไฟล์ MHTML หลายไฟล์ใน Java โดยใช้ API การรวมเอกสารที่มีข้อมูล สไตล์ และการจัดรูปแบบทั้งหมดเป็นเอกสารต้นทาง"

############################# Header ############################
title: "เข้าร่วม MHTML ไฟล์ใน Java"
description: "เข้าร่วม MHTML ด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "เข้าร่วมไฟล์ MHTML หลายไฟล์ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ทำให้นักพัฒนา Java สามารถเข้าร่วมไฟล์ MHTML หลายไฟล์ได้ง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีเข้าร่วมไฟล์ MHTML โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // เข้าร่วม MHTML ไฟล์โดยใช้ GroupDocs.Merger สำหรับ Java API
