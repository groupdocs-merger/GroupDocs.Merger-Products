...
head_description: "Utilisez GroupDocs.Merger for Java pour ajouter des capacités de fusion de documents PDF à vos applications Java."

############################# Header ############################
title: "Fusionner des fichiers PDF" 
description: "GroupDocs.Merger for Java vous permet de développer des applications Java qui fusionnent efficacement plusieurs documents PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) offre un moyen pratique de fusionner des documents PDF. Améliorez vos applications Java en combinant plusieurs fichiers en un seul.
      
      1. Spécifiez le chemin du premier fichier PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages spécifiques à partir de différents formats de documents"
      content: |
        Cet exemple montre comment fusionner des fichiers PDF tout en sélectionnant des pages spécifiques d'autres formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
