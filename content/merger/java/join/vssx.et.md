...
############################# Head ############################
head_title: "Liituge failidega VSSX Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge VSSX failiga rakenduses Java"
description: "Liituge tootega VSSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSSX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSSX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSSX, kasutades GroupDocs.Merger for Java API-t
