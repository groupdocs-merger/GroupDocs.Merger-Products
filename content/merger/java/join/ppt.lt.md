...
############################# Head ############################
head_title: "Prisijunkite prie PPT failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis PPT failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie PPT failų Java"
description: "Prisijunkite prie PPT naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis PPT failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis PPT failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PPT failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite PPT failus naudodami GroupDocs.Merger for Java API
