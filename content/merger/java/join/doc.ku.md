...
############################# Head ############################
head_title: "Tevlî pelên DOC bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên DOC li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên DOC Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî DOC bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek DOC Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên DOC bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên DOC dibe">}}

        ```java    
        // Tevlî pelên DOC bibin bi karanîna GroupDocs.Merger ji bo Java API
