...
############################# Head ############################
head_title: "Pridružite XLT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLT datotekama u Java"
description: "Pridružite se XLT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLT datoteke koristeći GroupDocs.Merger za Java API
