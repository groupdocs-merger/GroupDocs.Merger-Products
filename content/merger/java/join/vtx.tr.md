...
############################# Head ############################
head_title: "VTX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VTX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VTX Dosyaya Katılın"
description: "Birkaç satır Java koduyla VTX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VTX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VTX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VTX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VTX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) web sitesini ziyaret ederek birden fazla VTX dosyasına hemen katılın.
