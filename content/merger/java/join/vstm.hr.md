...
############################# Head ############################
head_title: "Pridružite VSTM datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSTM datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSTM datotekama u Java"
description: "Pridružite se VSTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSTM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSTM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSTM datoteke koristeći GroupDocs.Merger za Java API
