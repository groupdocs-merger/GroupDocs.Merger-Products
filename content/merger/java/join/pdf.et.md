...
############################# Head ############################
head_title: "Liituge failidega PDF Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PDF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge PDF failiga rakenduses Java"
description: "Liituge tootega PDF mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu PDF faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme PDF faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PDF faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid PDF, kasutades GroupDocs.Merger for Java API-t
