...
############################# Head ############################
head_title: "Csatlakozzon a DOCX fájlokhoz a Java & J2SE Documents Merger API-n keresztül"
head_description: "Csatlakoztasson több DOCX fájlt Java-ban a dokumentumok egyesítése API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "Csatlakozás DOCX fájlhoz itt: Java"
description: "Csatlakozzon az DOCX termékhez néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Csatlakoztasson több DOCX fájlt a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára, hogy több DOCX fájlt egyesítsenek.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájlok összekapcsolása a Java példakóddal">}}

        ```java    
        // Csatlakoztasson DOCX fájlt a GroupDocs.Merger for Java API segítségével
