...
############################# Head ############################
head_title: "XLAM ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ይቀላቀሉ"
head_description: "የሰነዶች ውህደት ኤፒአይ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት ጋር እንደ ምንጭ ሰነዶች በመጠቀም ብዙ XLAM ፋይሎችን በጃቫ ውስጥ ይቀላቀሉ።"

############################# Header ############################
title: "በJava ውስጥ XLAM ፋይሎችን ይቀላቀሉ"
description: "XLAMን በጥቂት የJava ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ XLAM ፋይሎችን ይቀላቀሉ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ XLAM ፋይሎችን መቀላቀል ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="Java ምሳሌ ኮድን በመጠቀም XLAM ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለJava API በመጠቀም XLAM ፋይሎችን ይቀላቀሉ
