...
############################# Head ############################
head_title: "Sertai JPG Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail JPG dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai JPG Fail Dalam Java"
description: "Sertai JPG dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang JPG Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail JPG dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail JPG menggunakan kod contoh Java.">}}

        ```java    
        // Sertai JPG fail menggunakan GroupDocs.Merger untuk API Java
