...
############################# Head ############################
head_title: "OTP ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ይቀላቀሉ"
head_description: "የሰነዶች ውህደት ኤፒአይ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት ጋር እንደ ምንጭ ሰነዶች በመጠቀም ብዙ OTP ፋይሎችን በጃቫ ውስጥ ይቀላቀሉ።"

############################# Header ############################
title: "በJava ውስጥ OTP ፋይሎችን ይቀላቀሉ"
description: "OTPን በጥቂት የJava ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ OTP ፋይሎችን ይቀላቀሉ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ OTP ፋይሎችን መቀላቀል ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="Java ምሳሌ ኮድን በመጠቀም OTP ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለJava API በመጠቀም OTP ፋይሎችን ይቀላቀሉ
