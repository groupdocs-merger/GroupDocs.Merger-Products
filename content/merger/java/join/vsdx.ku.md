...
############################# Head ############################
head_title: "Tevlî pelên VSDX bibin bi navgîniya Java & J2SE Documents Merger API"
head_description: "Tevlî gelek pelên VSDX li Java-yê bibin bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkanî."

############################# Header ############################
title: "Tevlî pelên VSDX Di Java de bibin"
description: "Bi çend rêzikên koda Java beşdarî VSDX bibin."
...
steps:
    enable: true
    title_left: "Tevlî Gelek VSDX Pelên di Java de bibin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan tevlî gelek pelên VSDX bibin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java beşdarî pelên VSDX dibe">}}

        ```java    
        // Tevlî pelên VSDX bibin bi karanîna GroupDocs.Merger ji bo Java API
