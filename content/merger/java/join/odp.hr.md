...
############################# Head ############################
head_title: "Pridružite ODP datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više ODP datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite ODP datotekama u Java"
description: "Pridružite se ODP s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više ODP datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODP datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite ODP datoteke koristeći GroupDocs.Merger za Java API
