...
############################# Head ############################
head_title: "VDX Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VDX dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VDX Dosyaya Katılın"
description: "Birkaç satır Java koduyla VDX'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VDX Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VDX dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VDX dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VDX dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) web sitesini ziyaret ederek birden fazla VDX dosyasına hemen katılın.
