...
############################# Head ############################
head_title: "VSSM Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla VSSM dosyasına katılın."

############################# Header ############################
title: "Java İçindeki VSSM Dosyaya Katılın"
description: "Birkaç satır Java koduyla VSSM'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok VSSM Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSSM dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSM dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSSM dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) web sitesini ziyaret ederek birden fazla VSSM dosyasına hemen katılın.
