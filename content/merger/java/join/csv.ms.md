...
############################# Head ############################
head_title: "Sertai CSV Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail CSV dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai CSV Fail Dalam Java"
description: "Sertai CSV dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang CSV Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail CSV dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail CSV menggunakan kod contoh Java.">}}

        ```java    
        // Sertai CSV fail menggunakan GroupDocs.Merger untuk API Java
