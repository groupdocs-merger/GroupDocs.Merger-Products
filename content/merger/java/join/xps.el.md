...
############################# Head ############################
head_title: "Εγγραφείτε στα αρχεία XPS μέσω Java & J2SE Documents Merger API"
head_description: "Συνδέστε πολλά αρχεία XPS σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία XPS σε Java"
description: "Εγγραφείτε στο XPS με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συμμετοχή σε πολλά XPS αρχεία στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να ενώσουν πολλά αρχεία XPS εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία XPS χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Εγγραφείτε σε αρχεία XPS χρησιμοποιώντας το GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Εγγραφείτε σε περισσότερα από ένα αρχεία XPS αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
