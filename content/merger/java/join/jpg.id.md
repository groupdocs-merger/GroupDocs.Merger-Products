...
############################# Head ############################
head_title: "Bergabunglah dengan JPG File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung JPG File Di Java"
description: "Bergabunglah dengan JPG dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPG menggunakan kode contoh Java">}}
        ...
        ```java    
        // Bergabunglah dengan file JPG menggunakan GroupDocs.Merger untuk Java API
