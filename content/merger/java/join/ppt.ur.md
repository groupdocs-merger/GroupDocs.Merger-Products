...
############################# Head ############################
head_title: "Java اور J2SE Documents Merger API کے ذریعے PPT فائلوں میں شامل ہوں۔"
head_description: "جاوا میں متعدد PPT فائلوں میں شامل ہوں دستاویزات انضمام API کا استعمال کرتے ہوئے تمام ڈیٹا، اسٹائل اور فارمیٹنگ کو بطور ماخذ دستاویزات۔"

############################# Header ############################
title: "Java میں PPT فائلوں میں شامل ہوں"
description: "Java کوڈ کی چند سطروں کے ساتھ PPT میں شامل ہوں۔"
...
steps:
    enable: true
    title_left: "Java میں متعدد PPT فائلوں میں شامل ہوں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) جاوا ڈویلپرز کے لیے چند آسان اقدامات کو لاگو کرکے متعدد PPT فائلوں میں شامل ہونا آسان بناتا ہے۔
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے PPT فائلوں میں شامل ہونے کا طریقہ">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے PPT فائلوں میں شامل ہوں۔
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) ویب سائٹ پر جا کر ابھی ایک سے زیادہ PPT فائلوں میں شامل ہوں۔
