...
############################# Head ############################
head_title: "Присъединете се към VTX файлове чрез Java & J2SE Documents Merger API"
head_description: "Свържете множество VTX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Присъединете се към VTX файлове в Java"
description: "Присъединете се към VTX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Присъединете се към множество VTX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да съедините VTX файлове с Java примерен код">}}

        ```java    
        // Присъединете се към VTX файлове с помощта на GroupDocs.Merger за Java API
