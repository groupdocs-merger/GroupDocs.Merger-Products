...
############################# Head ############################
head_title: "Prisijunkite prie OTT failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis OTT failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie OTT failų Java"
description: "Prisijunkite prie OTT naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis OTT failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis OTT failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti OTT failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite OTT failus naudodami GroupDocs.Merger for Java API
