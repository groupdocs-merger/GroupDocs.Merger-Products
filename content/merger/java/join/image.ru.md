...
head_description: "Используйте GroupDocs.Merger for Java для добавления функций объединения документов IMAGE в ваши приложения Java."

############################# Header ############################
title: "Объединение файлов IMAGE" 
description: "GroupDocs.Merger for Java позволяет вам разрабатывать приложения Java, которые эффективно объединяют несколько документов IMAGE."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) предоставляет удобный способ объединять документы IMAGE. Улучшите ваши приложения Java, объединив несколько файлов в один.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение конкретных страниц из разных форматов документов"
      content: |
        Этот пример показывает, как объединять файлы IMAGE, выбирая конкретные страницы из других форматов.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
