...
############################# Head ############################
head_title: "Liituge failidega DOTM Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge DOTM failiga rakenduses Java"
description: "Liituge tootega DOTM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu DOTM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme DOTM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOTM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid DOTM, kasutades GroupDocs.Merger for Java API-t
