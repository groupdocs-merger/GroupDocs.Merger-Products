...
############################# Head ############################
head_title: "Alăturați-vă fișierelor DOTX prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Alăturați mai multe fișiere DOTX în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Alăturați-vă fișierelor DOTX în Java"
description: "Alăturați-vă DOTX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Alăturați mai multe fișiere DOTX în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează alăturarea mai multor fișiere DOTX dezvoltatorilor Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor DOTX utilizând codul exemplu Java">}}

        ```java    
        // Alăturați-vă fișierelor DOTX utilizând API-ul GroupDocs.Merger pentru Java
