...
############################# Head ############################
head_title: "Pridružite VSSX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više VSSX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite VSSX datotekama u Java"
description: "Pridružite se VSSX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više VSSX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSSX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite VSSX datoteke koristeći GroupDocs.Merger za Java API
