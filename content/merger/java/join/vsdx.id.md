...
############################# Head ############################
head_title: "Bergabunglah dengan VSDX File melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan beberapa file VSDX di Java menggunakan API penggabungan dokumen dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabung VSDX File Di Java"
description: "Bergabunglah dengan VSDX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Gabungkan Beberapa File VSDX di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file VSDX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSDX menggunakan kode contoh Java">}}

        ```java    
        // Bergabunglah dengan file VSDX menggunakan GroupDocs.Merger untuk Java API
        // Instansiasi Penggabungan dengan dokumen masukan VSDX
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu VSDX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/vsdx).
