...
############################# Head ############################
head_title: "Sertai TEX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail TEX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai TEX Fail Dalam Java"
description: "Sertai TEX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang TEX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail TEX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail TEX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai TEX fail menggunakan GroupDocs.Merger untuk API Java
