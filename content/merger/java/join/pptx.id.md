...
############################# Head ############################
head_title: "Bergabunglah dengan PPTX File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabung PPTX File Di Java"
description: "Bergabunglah dengan PPTX dengan beberapa baris kode Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file PPTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPTX menggunakan kode contoh Java">}}

        ```java    
        // Bergabunglah dengan file PPTX menggunakan GroupDocs.Merger untuk Java API
