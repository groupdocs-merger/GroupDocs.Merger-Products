...
head_title: "Bergabunglah dengan File XLAM melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Bergabunglah dengan beberapa file XLAM di Java menggunakan API penggabungan dokumen dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."

title: "Bergabunglah dengan File XLAM di Aplikasi Java & J2SE"
description: "Gabungkan beberapa file XLAM menjadi satu file menggunakan API penggabungan dokumen Java. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."
...
steps:
    enable: true
    title_left: "Bergabunglah dengan Beberapa File XLAM di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk Bergabung dengan beberapa file XLAM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```java
        // Gabung file XLAM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    ...
    content: |
        Bergabunglah dengan lebih dari satu file XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/XLAM). Demo langsung memiliki manfaat sebagai berikut.
