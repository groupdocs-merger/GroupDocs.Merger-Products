...
############################# Head ############################
head_title: "Sluit aan by PPT-lêers via Java & J2SE Documents Merger API"
head_description: "Sluit aan by verskeie PPT-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Sluit aan by PPT-lêers in Java"
description: "Sluit aan by PPT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Sluit aan by verskeie PPT-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om by verskeie PPT-lêers aan te sluit deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by PPT-lêers aan te sluit deur Java-voorbeeldkode te gebruik">}}

        ```java    
        // Sluit aan by PPT lêers deur GroupDocs.Merger vir Java API te gebruik
