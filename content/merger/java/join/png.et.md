...
############################# Head ############################
head_title: "Liituge failidega PNG Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PNG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge PNG failiga rakenduses Java"
description: "Liituge tootega PNG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu PNG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme PNG faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PNG faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid PNG, kasutades GroupDocs.Merger for Java API-t
