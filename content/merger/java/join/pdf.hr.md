...
############################# Head ############################
head_title: "Pridružite PDF datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više PDF datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite PDF datotekama u Java"
description: "Pridružite se PDF s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više PDF datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PDF datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite PDF datoteke koristeći GroupDocs.Merger za Java API
