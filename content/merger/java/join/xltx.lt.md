...
############################# Head ############################
head_title: "Prisijunkite prie XLTX failų naudodami Java ir J2SE Documents Merger API"
head_description: "Sujunkite kelis XLTX failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Prisijunkite prie XLTX failų Java"
description: "Prisijunkite prie XLTX naudodami kelias Java kodo eilutes."
...
steps:
    enable: true
    title_left: "Sujunkite kelis XLTX failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis XLTX failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLTX failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite XLTX failus naudodami GroupDocs.Merger for Java API
