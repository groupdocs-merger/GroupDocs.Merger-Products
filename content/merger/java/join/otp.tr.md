...
############################# Head ############################
head_title: "OTP Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla OTP dosyasına katılın."

############################# Header ############################
title: "Java İçindeki OTP Dosyaya Katılın"
description: "Birkaç satır Java koduyla OTP'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok OTP Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok OTP dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTP dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak OTP dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) web sitesini ziyaret ederek birden fazla OTP dosyasına hemen katılın.
