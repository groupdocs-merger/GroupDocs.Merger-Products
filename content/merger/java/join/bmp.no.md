...
############################# Head ############################
head_title: "Bli med i BMP filer via Java & J2SE Documents Merger API"
head_description: "Slå sammen flere BMP-filer i Java ved å bruke Documents Merger API med all data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Bli med BMP-filer i Java"
description: "Bli med BMP med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slå sammen flere BMP-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slå sammen flere BMP-filer ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til BMP-filer ved å bruke Java-eksempelkoden">}}

        ```java    
        // Bli med BMP-filer ved hjelp av GroupDocs.Merger for Java API
