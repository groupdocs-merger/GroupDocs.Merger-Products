...
############################# Head ############################
head_title: "Pridružite OTP datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više OTP datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite OTP datotekama u Java"
description: "Pridružite se OTP s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više OTP datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti OTP datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite OTP datoteke koristeći GroupDocs.Merger za Java API
