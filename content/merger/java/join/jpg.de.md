...
############################# Head ############################
head_title: "JPG-Dateien in Java zusammenführen"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um JPG-Dokumenten zusammenführende Funktionen zu Ihren Java-Anwendungen hinzuzufügen."

############################# Header ############################
title: "JPG-Dateien zusammenführen" 
description: "GroupDocs.Merger for Java ermöglicht die Entwicklung von Java-Anwendungen, die effizient mehrere JPG-Dokumente zusammenführen."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) bietet eine Möglichkeit, JPG-Dokumente zusammenzuführen. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien zu einer zusammenfassen.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingabedokument JPG initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus verschiedenen Dokumentformaten zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man JPG-Dateien zusammenführt und dabei bestimmte Seiten aus anderen Formaten auswählt.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
