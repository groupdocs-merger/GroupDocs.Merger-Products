...
############################# Head ############################
head_title: "Sertai VSTX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail VSTX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai VSTX Fail Dalam Java"
description: "Sertai VSTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang VSTX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail VSTX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail VSTX menggunakan kod contoh Java.">}}

        ```java    
        // Sertai VSTX fail menggunakan GroupDocs.Merger untuk API Java
