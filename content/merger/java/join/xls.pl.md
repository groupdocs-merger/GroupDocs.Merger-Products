...
############################# Head ############################
head_title: "Dołącz do plików XLS przez Java i J2SE Documents Merger API"
head_description: "Dołącz do wielu plików XLS w Javie, korzystając z interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "Dołącz do XLS plików w Java"
description: "Dołącz do XLS za pomocą kilku linijek kodu Java."
...
steps:
    enable: true
    title_left: "Dołącz do wielu plików XLS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java dołączenie do wielu plików XLS, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików XLS przy użyciu przykładowego kodu Java">}}

        ```java    
        // Dołącz do plików XLS za pomocą GroupDocs.Merger for Java API
