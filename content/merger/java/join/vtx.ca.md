...
############################# Head ############################
head_title: "Uniu-vos a fitxers VTX mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Uniu diversos fitxers VTX a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Uniu-vos a VTX fitxers a Java"
description: "Uniu-vos a VTX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Uniu diversos fitxers VTX a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java uneixin diversos fitxers VTX implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers VTX mitjançant el codi d'exemple Java">}}

        ```java    
        // Uniu fitxers VTX mitjançant l'API de GroupDocs.Merger per a Java
