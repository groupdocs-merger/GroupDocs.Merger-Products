...
############################# Head ############################
head_title: "Pridružite XLTX datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više XLTX datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite XLTX datotekama u Java"
description: "Pridružite se XLTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više XLTX datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLTX datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite XLTX datoteke koristeći GroupDocs.Merger za Java API
