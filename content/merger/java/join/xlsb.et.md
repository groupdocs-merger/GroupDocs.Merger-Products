...
############################# Head ############################
head_title: "Liituge failidega XLSB Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge XLSB failiga rakenduses Java"
description: "Liituge tootega XLSB mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLSB faili, kasutades Java näitekoodi">}}
