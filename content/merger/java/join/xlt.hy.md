...
############################# Head ############################
head_title: "Միացեք XLT Ֆայլերին Java & J2SE Documents Merger API-ի միջոցով"
head_description: "Միացրեք բազմաթիվ XLT ֆայլեր Java-ում՝ օգտագործելով փաստաթղթերի միաձուլման API՝ բոլոր տվյալները, ոճը և ձևաչափումը որպես սկզբնաղբյուր փաստաթղթեր:"

############################# Header ############################
title: "Միացեք XLT ֆայլերին Java-ում"
description: "Միացեք XLT-ին Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Միացեք բազմաթիվ XLT ֆայլերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) Java ծրագրավորողների համար հեշտացնում է մի քանի XLT ֆայլեր միանալը մի քանի հեշտ քայլերի միջոցով:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել XLT ֆայլեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Միացե՛ք XLT ֆայլեր՝ օգտագործելով GroupDocs.Merger Java API-ի համար
