...
############################# Head ############################
head_title: "Deltag i XLSX filer via Java & J2SE Documents Merger API"
head_description: "Deltag i flere XLSX-filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Deltag i XLSX filer i Java"
description: "Slut dig til XLSX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Slut dig til flere XLSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at forbinde flere XLSX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du XLSX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Deltag i XLSX filer ved hjælp af GroupDocs.Merger for Java API
