...
############################# Head ############################
head_title: "Sluit aan by RTF-lêers via Java & J2SE Documents Merger API"
head_description: "Sluit aan by verskeie RTF-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Sluit aan by RTF-lêers in Java"
description: "Sluit aan by RTF met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Sluit aan by verskeie RTF-lêers in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by RTF-lêers aan te sluit deur Java-voorbeeldkode te gebruik">}}

        ```java    
        // Sluit aan by RTF lêers deur GroupDocs.Merger vir Java API te gebruik
