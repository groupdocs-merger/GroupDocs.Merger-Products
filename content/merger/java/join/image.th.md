...
############################# Head ############################
head_title: "รวมไฟล์ IMAGE ใน Java"
head_description: "ใช้ GroupDocs.Merger for Java เพื่อเพิ่มความสามารถในการรวมเอกสาร IMAGE ไปยังแอปพลิเคชัน Java ของคุณ."

############################# Header ############################
title: "รวมไฟล์ IMAGE" 
description: "GroupDocs.Merger for Java ช่วยให้คุณพัฒนาแอปพลิเคชัน Java ที่สามารถรวมเอกสาร IMAGE หลาย ๆ ฉบับได้อย่างมีประสิทธิภาพ."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ให้วิธีการรวมเอกสาร IMAGE ที่สะดวก เพิ่มความสามารถในแอปพลิเคชัน Java ของคุณโดยการรวมไฟล์หลายไฟล์เป็นหนึ่งเดียว.
      
      1. กำหนดเส้นทางไปยังไฟล์ IMAGE แรก.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // เริ่มต้น Merger ด้วยเอกสาร IMAGE ที่นำเข้า
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "รวมหน้าที่เฉพาะจากรูปแบบเอกสารต่าง ๆ"
      content: |
        ตัวอย่างนี้แสดงวิธีการรวมไฟล์ IMAGE โดยเลือกหน้าที่เฉพาะจากรูปแบบอื่น.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
