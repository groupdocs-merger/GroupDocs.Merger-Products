...
############################# Head ############################
head_title: "MHT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla MHT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki MHT Dosyaya Katılın"
description: "Birkaç satır Java koduyla MHT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok MHT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok MHT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak MHT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) web sitesini ziyaret ederek birden fazla MHT dosyasına hemen katılın.
