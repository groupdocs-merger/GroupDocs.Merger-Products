...
############################# Head ############################
head_title: "انضم إلى ملفات BMP عبر Java & J2SE Documents Merger API"
head_description: "انضم إلى عدة ملفات BMP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "انضم إلى ملفات BMP في Java"
description: "انضم إلى BMP ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "ضم عدة ملفات BMP في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا الانضمام إلى عدة ملفات BMP من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات BMP باستخدام كود مثال Java">}}

        ```java    
        // انضم إلى ملفات BMP باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات Java
        // إنشاء دمج مع مستند الإدخال BMP
...
demos:
    ...
    content: |
       انضم إلى أكثر من BMP ملف واحد الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
