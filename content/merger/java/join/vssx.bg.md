...
############################# Head ############################
head_title: "Присъединете се към VSSX файлове чрез Java & J2SE Documents Merger API"
head_description: "Свържете множество VSSX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Присъединете се към VSSX файлове в Java"
description: "Присъединете се към VSSX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Присъединете се към множество VSSX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да съедините VSSX файлове с Java примерен код">}}

        ```java    
        // Присъединете се към VSSX файлове с помощта на GroupDocs.Merger за Java API
