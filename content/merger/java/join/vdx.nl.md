...
############################# Head ############################
head_title: "Word lid van VDX bestanden via Java & J2SE Documents Merger API"
head_description: "Voeg meerdere VDX-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Word lid van VDX bestanden in Java"
description: "Sluit je aan bij VDX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Word lid van meerdere VDX bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere VDX-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u VDX bestanden samenvoegt met behulp van Java voorbeeldcode">}}

        ```java    
        // Word lid van VDX bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één VDX-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) te gaan.
