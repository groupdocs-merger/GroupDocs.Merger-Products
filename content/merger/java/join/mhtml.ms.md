...
############################# Head ############################
head_title: "Sertai MHTML Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Sertai berbilang fail MHTML dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Sertai MHTML Fail Dalam Java"
description: "Sertai MHTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Sertai Berbilang MHTML Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menyertai berbilang fail MHTML dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail MHTML menggunakan kod contoh Java.">}}

        ```java    
        // Sertai MHTML fail menggunakan GroupDocs.Merger untuk API Java
