...
############################# Head ############################
head_title: "XLT Dosyalarına Java ve J2SE Documents Merger API aracılığıyla katılın"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak Java'da birden fazla XLT dosyasına katılın."

############################# Header ############################
title: "Java İçindeki XLT Dosyaya Katılın"
description: "Birkaç satır Java koduyla XLT'e katılın."
...
steps:
    enable: true
    title_left: "Java İçindeki Birden Çok XLT Dosyaya Katılın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLT dosyasına katılmasını kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLT dosyalarına nasıl katılınır">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLT dosyalarına katılın
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) web sitesini ziyaret ederek birden fazla XLT dosyasına hemen katılın.
