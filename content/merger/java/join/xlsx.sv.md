...
############################# Head ############################
head_title: "Gå med i XLSX filer via Java & J2SE Documents Merger API"
head_description: "Sammanfoga flera XLSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Gå med i XLSX-filer i Java"
description: "Gå med i XLSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Gå med i flera XLSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att gå med i flera XLSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i XLSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Gå med i XLSX-filer med GroupDocs.Merger för Java API
