...
############################# Head ############################
head_title: "Pridružite MHT datotekama putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više MHT datoteka u Javi koristeći API za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Pridružite MHT datotekama u Java"
description: "Pridružite se MHT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Pridružite više MHT datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti MHT datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Pridružite MHT datoteke koristeći GroupDocs.Merger za Java API
