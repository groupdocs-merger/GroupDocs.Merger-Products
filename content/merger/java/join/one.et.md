...
############################# Head ############################
head_title: "Liituge failidega ONE Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ONE-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiilide ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Liituge ONE failiga rakenduses Java"
description: "Liituge tootega ONE mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu ONE faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme ONE faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ONE faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid ONE, kasutades GroupDocs.Merger for Java API-t
