...
############################# Head ############################
head_title: "შეუერთდით PNG ფაილებს Java & J2SE Documents Merger API-ით"
head_description: "შეუერთეთ რამდენიმე PNG ფაილს Java-ში დოკუმენტების შერწყმის API-ის გამოყენებით ყველა მონაცემით, სტილით და ფორმატით, როგორც წყარო დოკუმენტები."

############################# Header ############################
title: "შეუერთდით PNG ფაილებს Java-ში"
description: "შეუერთდით PNG-ს Java კოდის რამდენიმე ხაზით."
...
steps:
    enable: true
    title_left: "შეუერთდით რამდენიმე PNG ფაილს Java-ში"
    content_left: |
        [GroupDocs.Merger for Java](/ka/merger/java/) ჯავის დეველოპერებს უადვილებს რამდენიმე PNG ფაილის შეერთებას რამდენიმე მარტივი ნაბიჯის განხორციელებით.
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ შევაერთოთ PNG ფაილი Java-ის მაგალითის კოდის გამოყენებით">}}

        ```java    
        // შეუერთდით PNG ფაილს GroupDocs.Merger for Java API-ის გამოყენებით
