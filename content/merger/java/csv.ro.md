...
############################# Head ############################
head_title: "Îmbinați fișierele CSV prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere CSV în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "CSV Fuziune în Java"
description: "Îmbinați CSV cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere CSV în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere CSV pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere CSV folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere CSV utilizând API-ul GroupDocs.Merger pentru Java
