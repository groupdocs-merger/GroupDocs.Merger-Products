...
############################# Head ############################
head_title: "Führen Sie ONENOTE-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere ONENOTE-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "ONENOTE Fusion in Java"
description: "Führen Sie ONENOTE mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere ONENOTE-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere ONENOTE-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie ONENOTE-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie ONENOTE-Dateien mit GroupDocs.Merger for Java API zusammen
