...
############################# Head ############################
head_title: "Fusionner PDF fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers PDF en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "PDF Fusionner dans Java"
description: "Fusionnez PDF avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers PDF dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers PDF en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers PDF à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers PDF à l'aide de GroupDocs.Merger pour l'API Java
