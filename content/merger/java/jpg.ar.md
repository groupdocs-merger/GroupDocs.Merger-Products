...
############################# Head ############################
head_title: "دمج ملفات JPG عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات JPG في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "JPG الاندماج في Java"
description: "دمج JPG ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من JPG ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg).
