...
############################# Head ############################
head_title: "Slå sammen XLS filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLS sammenslåing i Java"
description: "Slå sammen XLS med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLS filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLS filer med GroupDocs.Merger for Java API
