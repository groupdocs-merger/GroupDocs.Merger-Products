...
############################# Head ############################
head_title: "Kombinera XLAM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLAM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLAM filer i Java"
description: "Kombinera XLAM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLAM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLAM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLAM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLAM filer med GroupDocs.Merger för Java API
