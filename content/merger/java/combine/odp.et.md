...
############################# Head ############################
head_title: "Kombineerige ODP failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu ODP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri ODP faili Java"
description: "Kombineerige ODP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu ODP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme ODP faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida ODP faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid ODP, kasutades GroupDocs.Merger for Java API-t
