...
############################# Head ############################
head_title: "Kombineer VTX lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige VTX-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer VTX lêers in Java"
description: "Kombineer VTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige VTX-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige VTX-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer VTX lêers deur GroupDocs.Merger vir Java API te gebruik
