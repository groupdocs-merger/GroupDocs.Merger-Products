...
############################# Head ############################
head_title: "OTP ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ያጣምሩ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ የOTP ፋይሎችን በጃቫ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "OTP ፋይሎችን በJava ውስጥ ያጣምሩ"
description: "OTPን ከጥቂት የJava ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ OTP ፋይሎችን ያጣምሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለጃቫ ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ብዙ OTP ፋይሎችን ማጣመር ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም OTP ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም OTP ፋይሎችን ያጣምሩ
