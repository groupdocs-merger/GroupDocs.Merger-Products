...
############################# Head ############################
head_title: "Java & J2SE Documents Merger API を介して DOTX ファイルを結合"
head_description: "ドキュメント マージ API を使用して Java で複数の DOTX ファイルを結合し、ソース ドキュメントとしてすべてのデータ、スタイル、書式設定を行います。"

############################# Header ############################
title: "Java 内の DOTX ファイルを結合します"
description: "DOTX を数行の Java コードと組み合わせます。"
...
steps:
    enable: true
    title_left: "Java 内の複数の DOTX ファイルを結合"
    content_left: |
        [GroupDocs.Merger for Java](/ja/merger/java/) を使用すると、Java 開発者はいくつかの簡単な手順を実装することで、複数の DOTX ファイルを簡単に組み合わせることができます。
    ...
    code: |
     ...
     {{< merger/code-merger title="Java サンプル コードを使用して DOTX ファイルを結合する方法">}}

        ```java    
        // GroupDocs.Merger for Java API を使用して DOTX ファイルを結合します
        // 入力 DOTX ドキュメントで Merger をインスタンス化する
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) Web サイトにアクセスして、複数の DOTX ファイルを今すぐ結合してください。
       ライブデモには次の利点があります。
