...
############################# Head ############################
head_title: "Kombinera EPUB filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera EPUB-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera EPUB filer i Java"
description: "Kombinera EPUB med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera EPUB-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera EPUB-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar EPUB-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera EPUB filer med GroupDocs.Merger för Java API
