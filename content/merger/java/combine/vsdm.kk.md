...
############################# Head ############################
head_title: "VSDM файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
...
############################# Header ############################
title: "VSDM файлды Java ішінде біріктіру"
description: "VSDM Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше VSDM файлды біріктіру"
    content_left: |
