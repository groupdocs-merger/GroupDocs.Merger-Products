...
############################# Head ############################
head_title: "ادمج PPT الملفات عبر Java & J2SE Documents Merger API"
head_description: "ادمج عدة ملفات PPT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "دمج ملفات PPT في Java"
description: "ادمج PPT مع بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "دمج عدة ملفات PPT في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا دمج عدة ملفات PPT من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات PPT باستخدام كود مثال Java">}}

        ```java    
        // دمج ملفات PPT باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
...
demos:
    ...
    content: |
       اجمع بين أكثر من ملف PPT واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
