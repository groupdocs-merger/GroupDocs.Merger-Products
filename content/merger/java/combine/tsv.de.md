...
############################# Head ############################
head_title: "Kombinieren Sie TSV-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere TSV-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie TSV-Dateien in Java"
description: "Kombinieren Sie TSV mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere TSV-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere TSV-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie TSV-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie TSV-Dateien mit GroupDocs.Merger for Java API
