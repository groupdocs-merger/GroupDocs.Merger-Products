...
############################# Head ############################
head_title: "Combinar arquivos EXCEL no Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de mesclagem de documentos EXCEL aos seus projetos Java."

############################# Header ############################
title: "Combinar arquivos EXCEL" 
description: "Com GroupDocs.Merger for Java, você pode desenvolver aplicações avançadas em Java que mesclam documentos EXCEL de forma eficaz."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece capacidades de mesclagem para documentos EXCEL. Aprimore suas aplicações Java mesclando vários arquivos em um só.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas específicas de arquivos de diferentes formatos"
      content: |
        Este exemplo demonstra como mesclar arquivos EXCEL incluindo páginas específicas de documentos em outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
