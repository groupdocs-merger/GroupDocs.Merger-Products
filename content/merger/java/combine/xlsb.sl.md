...
############################# Head ############################
head_title: "Združite XLSB datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLSB v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLSB datotek v Java"
description: "Kombinirajte XLSB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLSB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLSB z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSB s primerom kode Java">}}

        ```java    
        // Združite datoteke XLSB z API-jem GroupDocs.Merger for Java
