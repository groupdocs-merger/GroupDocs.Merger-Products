...
############################# Head ############################
head_title: "Združite XLT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLT datotek v Java"
description: "Kombinirajte XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLT s primerom kode Java">}}

        ```java    
        // Združite datoteke XLT z API-jem GroupDocs.Merger for Java
