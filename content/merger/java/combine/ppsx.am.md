...
############################# Head ############################
head_title: "PPSX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ያጣምሩ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ የPPSX ፋይሎችን በጃቫ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "PPSX ፋይሎችን በJava ውስጥ ያጣምሩ"
description: "PPSXን ከጥቂት የJava ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ PPSX ፋይሎችን ያጣምሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለጃቫ ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ብዙ PPSX ፋይሎችን ማጣመር ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም PPSX ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም PPSX ፋይሎችን ያጣምሩ
