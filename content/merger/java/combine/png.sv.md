...
############################# Head ############################
head_title: "Kombinera PNG filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera PNG-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera PNG filer i Java"
description: "Kombinera PNG med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera PNG-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera PNG-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PNG-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera PNG filer med GroupDocs.Merger för Java API
