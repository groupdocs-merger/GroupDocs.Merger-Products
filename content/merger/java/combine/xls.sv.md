...
############################# Head ############################
head_title: "Kombinera XLS filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLS-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLS filer i Java"
description: "Kombinera XLS med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLS-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLS-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLS filer med GroupDocs.Merger för Java API
