...
############################# Head ############################
head_title: "Kombinera DOTM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera DOTM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera DOTM filer i Java"
description: "Kombinera DOTM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera DOTM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera DOTM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar DOTM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera DOTM filer med GroupDocs.Merger för Java API
