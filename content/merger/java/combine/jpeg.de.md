...
############################# Head ############################
head_title: "Kombinieren Sie JPEG-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere JPEG-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie JPEG-Dateien in Java"
description: "Kombinieren Sie JPEG mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere JPEG-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere JPEG-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie JPEG-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie JPEG-Dateien mit GroupDocs.Merger for Java API
