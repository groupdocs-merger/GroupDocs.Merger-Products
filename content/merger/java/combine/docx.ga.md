...
############################# Head ############################
head_title: "Comhcheangail DOCX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Comhcheangail comhaid DOCX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Comhcheangail DOCX Comhaid i Java"
description: "Comhcheangail DOCX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Comhcheangail Ilchomhad DOCX i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid DOCX iolracha a chomhcheangal trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOCX comhad a chur le chéile trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Comhcheangail DOCX comhad le GroupDocs.Merger le haghaidh Java API
        // Cuir Cumasc leis an doiciméad ionchuir DOCX
...
demos:
    ...
    content: |
       Comhcheangail níos mó ná comhad DOCX amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
