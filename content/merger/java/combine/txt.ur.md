...
############################# Head ############################
head_title: "TXT فائلوں کو جاوا اور J2SE Documents Merger API کے ذریعے یکجا کریں۔"
head_description: "جاوا میں متعدد TXT فائلوں کو جمع کریں دستاویزات کے انضمام API کا استعمال کرتے ہوئے تمام ڈیٹا، طرز اور فارمیٹنگ کو بطور ماخذ دستاویزات۔"

############################# Header ############################
title: "TXT فائلوں کو Java میں یکجا کریں"
description: "TXT کو Java کوڈ کی چند سطروں کے ساتھ جوڑیں۔"
...
steps:
    enable: true
    title_left: "Java میں متعدد TXT فائلوں کو یکجا کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) جاوا ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے متعدد TXT فائلوں کو یکجا کرنا آسان بناتا ہے۔
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے TXT فائلوں کو کیسے جوڑیں۔">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے TXT فائلوں کو یکجا کریں۔
