...
############################# Head ############################
head_title: "Kombinera TXT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera TXT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera TXT filer i Java"
description: "Kombinera TXT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera TXT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera TXT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar TXT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera TXT filer med GroupDocs.Merger för Java API
