...
############################# Head ############################
head_title: "Объедините файлы IMAGE в Java"
head_description: "Используйте GroupDocs.Merger for Java, чтобы добавить возможности слияния документов IMAGE в ваши проекты на Java."

############################# Header ############################
title: "Объединение файлов IMAGE" 
description: "С помощью GroupDocs.Merger for Java вы можете разрабатывать сложные приложения на Java, которые объединяют документы IMAGE."
subtitle: "" 
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) предоставляет возможности слияния для документов IMAGE. Улучшите свои приложения на Java, объединив несколько файлов в один.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Инициализируйте Merger с входным документом IMAGE
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение определенных страниц из файлов разных форматов"
      content: |
        Этот пример демонстрирует, как объединить файлы IMAGE, включая определенные страницы из документов других форматов.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
