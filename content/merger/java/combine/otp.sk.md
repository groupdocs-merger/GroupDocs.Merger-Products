...
############################# Head ############################
head_title: "Skombinujte OTP súbory cez rozhranie Java & J2SE Documents Merger API"
head_description: "Skombinujte viacero súborov OTP v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "Skombinujte OTP súbory v Java"
description: "Skombinujte OTP s niekoľkými riadkami kódu Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/sk/merger/java/) poskytuje pohodlné riešenie na kombináciu viacerých súborov PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázkov a mnoho ďalších dokumentov do jedného súboru v aplikáciách Java. GroupDocs.Merger vám ušetrí veľa námahy, pretože máte povolené kombinovať OTP dokumenty – nie je potrebné inštalovať žiadny softvér tretích strán, desktopové aplikácie alebo pluginy. Teraz je zbytočné strácať čas a kombinovať súbory ručne! Poslaním GroupDocs je poskytovať najlepšiu kvalitu a zjednodušiť pracovné postupy spracovania dokumentov.
...
steps:
    enable: true
    title_left: "Skombinujte viacero OTP súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom jazyka Java skombinovanie viacerých súborov OTP implementáciou niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako skombinovať súbory OTP pomocou vzorového kódu Java">}}

        ```java    
        // Skombinujte OTP súbory pomocou GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Na webe [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) skombinujte hneď teraz viac ako jeden súbor OTP.
