...
############################# Head ############################
head_title: "Kết hợp các tệp VDX thông qua API hợp nhất tài liệu Java & J2SE"
head_description: "Kết hợp nhiều tệp VDX trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Kết hợp VDX Tệp trong Java"
description: "Kết hợp VDX với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Kết hợp Nhiều VDX Tệp trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách kết hợp các tệp VDX bằng mã mẫu Java">}}

        ```java    
        // Kết hợp các tệp VDX bằng GroupDocs.Merger cho Java API
