...
############################# Head ############################
head_title: "Kombinera PDF filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera PDF-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera PDF filer i Java"
description: "Kombinera PDF med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera PDF-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera PDF-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PDF-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera PDF filer med GroupDocs.Merger för Java API
