...
############################# Head ############################
head_title: "VISIO-Dateien in Java kombinieren"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um die Funktionen zum Zusammenführen von VISIO-Dokumenten in Ihren Java-Projekten hinzuzufügen."

############################# Header ############################
title: "VISIO-Dateien kombinieren" 
description: "Mit GroupDocs.Merger for Java können Sie fortschrittliche Java-Anwendungen entwickeln, die VISIO-Dokumenten problemlos zusammenführen."
...
steps:
    enable: true
    title: "Wie man VISIO-Dokumenten zusammenführt"
    content: |
      [GroupDocs.Merger](/merger/java/) bietet Funktionen zum Zusammenführen von VISIO-Dokumenten. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien in eine kombinieren.
      
      1. Geben Sie den Pfad zur ersten VISIO-Datei an.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingang VISIO-Dokument initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus Dateien verschiedener Formate zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man VISIO-Dateien zusammenführt und dabei spezifische Seiten aus Dokumenten in anderen Formaten einbezieht.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
