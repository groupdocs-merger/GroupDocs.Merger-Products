...
############################# Head ############################
head_title: "Kombinera VSX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSX filer i Java"
description: "Kombinera VSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSX filer med GroupDocs.Merger för Java API
