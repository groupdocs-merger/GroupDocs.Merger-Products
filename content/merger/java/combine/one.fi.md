...
############################# Head ############################
head_title: "Yhdistä ONE tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita ONE-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä ONE tiedostoa Java"
description: "Yhdistä ONE muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita ONE tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita ONE-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ONE tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä ONE tiedostot GroupDocs.Merger for Java API:lla
