...
############################# Head ############################
head_title: "Kombinirajte XLSB datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Kombinirajte više XLSB datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Kombinirajte XLSB datoteka u Java"
description: "Kombinirajte XLSB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Kombinirajte više XLSB datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima kombiniranje više XLSB datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati XLSB datoteke koristeći Java primjer koda">}}

        ```java    
        // Kombinirajte XLSB datoteke koristeći GroupDocs.Merger za Java API
