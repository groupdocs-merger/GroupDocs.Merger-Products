...
############################# Head ############################
head_title: "Kombineerige XLSB failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLSB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLSB faili Java"
description: "Kombineerige XLSB mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLSB faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLSB faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLSB faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLSB, kasutades GroupDocs.Merger for Java API-t
