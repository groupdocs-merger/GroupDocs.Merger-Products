...
############################# Head ############################
head_title: "Gabungkan ODP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail ODP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan ODP Fail Dalam Java"
description: "Gabungkan ODP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang ODP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail ODP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan ODP fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan ODP fail menggunakan GroupDocs.Merger untuk Java API
