...
############################# Head ############################
head_title: "Comhcheangail DOC Comhaid trí Java & J2SE Documents Merger API"
head_description: "Comhcheangail comhaid DOC iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Comhcheangail DOC Comhaid i Java"
description: "Comhcheangail DOC le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Comhcheangail Ilchomhad DOC i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid DOC iolracha a chomhcheangal trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOC comhad a chur le chéile trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Comhcheangail DOC comhad le GroupDocs.Merger le haghaidh Java API
...
demos:
    ...
    content: |
       Comhcheangail níos mó ná comhad DOC amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
