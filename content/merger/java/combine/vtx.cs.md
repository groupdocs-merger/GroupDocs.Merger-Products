...
############################# Head ############################
head_title: "Kombinujte soubory VTX prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů VTX v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat VTX soubory v Java"
description: "Zkombinujte VTX s několika řádky kódu Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/cs/merger/java/) poskytuje pohodlné řešení pro kombinaci více PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázků a mnoho dalších dokumentů do jednoho souboru v aplikacích Java. GroupDocs.Merger vám ušetří spoustu námahy, protože můžete kombinovat VTX dokumenty – není třeba instalovat žádný software třetích stran, desktopové aplikace nebo pluginy. Nyní je zbytečné ztrácet čas a kombinovat soubory ručně! Posláním GroupDocs je poskytovat nejlepší kvalitu a zjednodušit pracovní postupy zpracování dokumentů.
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů VTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů VTX pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory VTX pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory VTX pomocí GroupDocs.Merger for Java API
