...
############################# Head ############################
head_title: "Kombineerige MHT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu MHT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri MHT faili Java"
description: "Kombineerige MHT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu MHT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme MHT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida MHT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid MHT, kasutades GroupDocs.Merger for Java API-t
