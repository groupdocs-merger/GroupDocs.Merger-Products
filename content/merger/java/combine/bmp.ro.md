...
############################# Head ############################
head_title: "Combinați fișiere BMP prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Combinați mai multe fișiere BMP în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Combinați fișiere BMP în Java"
description: "Combinați BMP cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Combinați mai multe fișiere BMP în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java combinarea mai multor fișiere BMP prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să combinați fișiere BMP folosind codul exemplu Java">}}

        ```java    
        // Combinați fișiere BMP utilizând API-ul GroupDocs.Merger pentru Java
