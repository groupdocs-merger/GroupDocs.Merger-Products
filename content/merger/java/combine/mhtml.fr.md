...
############################# Head ############################
head_title: "Combiner des fichiers MHTML dans Java"
head_description: "Utilisez GroupDocs.Merger for Java pour ajouter des fonctionnalités de fusion de documents MHTML à vos projets Java."

############################# Header ############################
title: "Combiner des fichiers MHTML" 
description: "Avec GroupDocs.Merger for Java, vous pouvez développer des applications avancées Java qui fusionnent des documents MHTML sans effort."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) fournit des capacités de fusion pour les documents MHTML. Améliorez vos applications Java en fusionnant plusieurs fichiers en un.
      
      1. Spécifiez le chemin du premier fichier MHTML.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Initialiser Merger avec le document MHTML d'entrée
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages spécifiques de fichiers de différents formats"
      content: |
        Cet exemple démontre comment fusionner des fichiers MHTML tout en incluant des pages spécifiques de documents dans d'autres formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
