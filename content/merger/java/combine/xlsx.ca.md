...
############################# Head ############################
head_title: "Combina fitxers XLSX mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Combineu diversos fitxers XLSX a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Combina XLSX fitxers a Java"
description: "Combina XLSX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers XLSX a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java combinar diversos fitxers XLSX implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLSX utilitzant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers XLSX mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    ...
    content: |
       Combineu més d'un fitxer XLSX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
