...
############################# Head ############################
head_title: "Yhdistä XLTX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLTX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLTX tiedostoa Java"
description: "Yhdistä XLTX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLTX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLTX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLTX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLTX tiedostot GroupDocs.Merger for Java API:lla
