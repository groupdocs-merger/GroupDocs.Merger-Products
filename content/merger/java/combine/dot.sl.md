...
############################# Head ############################
head_title: "Združite DOT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek DOT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi DOT datotek v Java"
description: "Kombinirajte DOT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek DOT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek DOT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOT s primerom kode Java">}}

        ```java    
        // Združite datoteke DOT z API-jem GroupDocs.Merger for Java
