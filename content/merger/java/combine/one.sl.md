...
############################# Head ############################
head_title: "Združite ONE datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek ONE v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi ONE datotek v Java"
description: "Kombinirajte ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek ONE v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek ONE z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ONE s primerom kode Java">}}

        ```java    
        // Združite datoteke ONE z API-jem GroupDocs.Merger for Java
