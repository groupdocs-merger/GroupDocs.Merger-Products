...
############################# Head ############################
head_title: "Pelên OTP bi navgîniya Java & J2SE Documents Merger API-ê bihev bikin"
head_description: "Gelek pelên OTP di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî daneyan, şêwaz û şeklê wekî belgeyên çavkaniyê re bikin yek."

############################# Header ############################
title: "Pelên OTP Di Java de berhev bikin"
...
steps:
    enable: true
    title_left: "Gelek OTP Pelên di Java de bi hev re bikin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên OTP bi karanîna koda nimûneya Java berhev dike">}}

        ```java    
        // Pelên OTP bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi kar bînin
