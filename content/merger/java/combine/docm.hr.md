...
############################# Head ############################
head_title: "Kombinirajte DOCM datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Kombinirajte više DOCM datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Kombinirajte DOCM datoteka u Java"
description: "Kombinirajte DOCM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Kombinirajte više DOCM datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima kombiniranje više DOCM datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati DOCM datoteke koristeći Java primjer koda">}}

        ```java    
        // Kombinirajte DOCM datoteke koristeći GroupDocs.Merger za Java API
