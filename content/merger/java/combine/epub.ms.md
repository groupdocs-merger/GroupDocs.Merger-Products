...
############################# Head ############################
head_title: "Gabungkan EPUB Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail EPUB dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan EPUB Fail Dalam Java"
description: "Gabungkan EPUB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang EPUB Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail EPUB dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan EPUB fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan EPUB fail menggunakan GroupDocs.Merger untuk Java API
