...
############################# Head ############################
head_title: "Pelên EPUB bi navgîniya Java & J2SE Documents Merger API-ê bihev bikin"
head_description: "Gelek pelên EPUB di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî daneyan, şêwaz û şeklê wekî belgeyên çavkaniyê re bikin yek."

############################# Header ############################
title: "Pelên EPUB Di Java de berhev bikin"
...
steps:
    enable: true
    title_left: "Gelek EPUB Pelên di Java de bi hev re bikin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên EPUB bi karanîna koda nimûneya Java berhev dike">}}

        ```java    
        // Pelên EPUB bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi kar bînin
