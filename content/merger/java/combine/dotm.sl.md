...
############################# Head ############################
head_title: "Združite DOTM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek DOTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi DOTM datotek v Java"
description: "Kombinirajte DOTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek DOTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek DOTM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOTM s primerom kode Java">}}

        ```java    
        // Združite datoteke DOTM z API-jem GroupDocs.Merger for Java
