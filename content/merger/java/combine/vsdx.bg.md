...
############################# Head ############################
head_title: "Комбинирайте VSDX файлове чрез Java & J2SE Documents Merger API"
head_description: "Комбинирайте множество VSDX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Комбинирайте VSDX файлове в Java"
description: "Комбинирайте VSDX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Комбинирайте множество VSDX файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да комбинират множество VSDX файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате VSDX файлове с помощта на Java примерен код">}}

        ```java    
        // Комбинирайте VSDX файлове с помощта на GroupDocs.Merger за Java API
