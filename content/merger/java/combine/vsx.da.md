...
head_description: "Kombiner flere VSX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner VSX filer i Java"
description: "Kombiner VSX med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere VSX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer VSX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner VSX filer ved hjælp af GroupDocs.Merger for Java API
