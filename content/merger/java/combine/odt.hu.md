...
############################# Head ############################
head_title: "Kombinálja az ODT fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több ODT fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "ODT fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) ODT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több ODT fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több ODT fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ODT fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az ODT fájlokat a GroupDocs.Merger for Java API segítségével
