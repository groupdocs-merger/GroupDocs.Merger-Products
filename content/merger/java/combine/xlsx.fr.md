...
############################# Head ############################
head_title: "Combinez XLSX fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Combinez plusieurs fichiers XLSX en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Combinez XLSX fichiers dans Java"
description: "Combinez XLSX avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Combinez plusieurs fichiers XLSX dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de combiner facilement plusieurs fichiers XLSX en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers XLSX à l'aide de l'exemple de code Java">}}

        ```java    
        // Combinez les fichiers XLSX à l'aide de GroupDocs.Merger pour l'API Java
