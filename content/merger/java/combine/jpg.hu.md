...
############################# Head ############################
head_title: "Kombinálja az JPG fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több JPG fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "JPG fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) JPG elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több JPG fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több JPG fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk JPG fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az JPG fájlokat a GroupDocs.Merger for Java API segítségével
