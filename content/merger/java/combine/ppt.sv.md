...
############################# Head ############################
head_title: "Kombinera PPT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera PPT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera PPT filer i Java"
description: "Kombinera PPT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera PPT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera PPT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PPT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera PPT filer med GroupDocs.Merger för Java API
