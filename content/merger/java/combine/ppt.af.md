...
############################# Head ############################
head_title: "Kombineer PPT lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige PPT-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer PPT lêers in Java"
description: "Kombineer PPT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige PPT-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige PPT-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPT lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer PPT lêers deur GroupDocs.Merger vir Java API te gebruik
