...
############################# Head ############################
head_title: "Kombineerige DOTM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu DOTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri DOTM faili Java"
description: "Kombineerige DOTM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu DOTM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme DOTM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOTM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid DOTM, kasutades GroupDocs.Merger for Java API-t
