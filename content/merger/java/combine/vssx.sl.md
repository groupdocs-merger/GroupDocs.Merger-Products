...
############################# Head ############################
head_title: "Združite VSSX datoteke prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Združi VSSX datotek v Java"
description: "Kombinirajte VSSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSSX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSSX s primerom kode Java">}}
        ...
        ```java    
        // Združite datoteke VSSX z API-jem GroupDocs.Merger for Java
