...
############################# Head ############################
head_title: "Kombinálja az XLTX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több XLTX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLTX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) XLTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLTX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLTX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLTX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az XLTX fájlokat a GroupDocs.Merger for Java API segítségével
