...
############################# Head ############################
head_title: "Kombineer ODT lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige ODT-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer ODT lêers in Java"
description: "Kombineer ODT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige ODT-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige ODT-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODT lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer ODT lêers deur GroupDocs.Merger vir Java API te gebruik
