...
############################# Head ############################
head_title: "Yhdistä PPTX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PPTX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä PPTX tiedostoa Java"
description: "Yhdistä PPTX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PPTX tiedostoja tuotteessa Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPTX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PPTX tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PPTX tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
