...
############################# Head ############################
head_title: "Združite OTT datoteke prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Združi OTT datotek v Java"
description: "Kombinirajte OTT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek OTT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTT s primerom kode Java">}}
        ...
        ```java    
        // Združite datoteke OTT z API-jem GroupDocs.Merger for Java
