...
############################# Head ############################
head_title: "Kombinálja az CSV fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több CSV fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "CSV fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) CSV elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több CSV fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több CSV fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk CSV fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az CSV fájlokat a GroupDocs.Merger for Java API segítségével
