...
############################# Head ############################
head_title: "Kombinera VSSM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSSM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSSM filer i Java"
description: "Kombinera VSSM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSSM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSSM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSSM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSSM filer med GroupDocs.Merger för Java API
