...
############################# Head ############################
head_title: "Kombinera DOCM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera DOCM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera DOCM filer i Java"
description: "Kombinera DOCM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera DOCM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera DOCM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar DOCM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera DOCM filer med GroupDocs.Merger för Java API
