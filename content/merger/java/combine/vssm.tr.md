...
############################# Head ############################
head_title: "VSSM Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok VSSM dosyasını Java'da birleştirin."

############################# Header ############################
title: "VSSM Dosyalarını Java İçinde Birleştirin"
description: "VSSM kodunu birkaç satır Java koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSSM Dosyasını Java İçinde Birleştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok VSSM dosyasını birleştirmesini kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSM dosyaları nasıl birleştirilir">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSSM dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla VSSM dosyayı birleştirin.
