...
############################# Head ############################
head_title: "ONE Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok ONE dosyasını Java'da birleştirin."

############################# Header ############################
title: "ONE Dosyalarını Java İçinde Birleştirin"
...
steps:
    enable: true
    title_left: "Birden Çok ONE Dosyasını Java İçinde Birleştirin"
    content_left: |
