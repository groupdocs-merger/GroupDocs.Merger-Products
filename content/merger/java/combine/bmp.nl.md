...
############################# Head ############################
head_title: "Combineer BMP bestanden via Java & J2SE Documents Merger API"
head_description: "Combineer meerdere BMP-bestanden in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Combineer BMP bestanden in Java"
description: "Combineer BMP met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Combineer meerdere BMP bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere BMP-bestanden te combineren door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe BMP bestanden te combineren met behulp van Java voorbeeldcode">}}

        ```java    
        // Combineer BMP bestanden met behulp van GroupDocs.Merger voor Java API
        // Instantie van fusie met invoer BMP document
...
demos:
    ...
    content: |
       Combineer nu meer dan één BMP bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) te gaan.
