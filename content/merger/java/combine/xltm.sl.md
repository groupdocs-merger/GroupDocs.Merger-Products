...
############################# Head ############################
head_title: "Združite XLTM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLTM datotek v Java"
description: "Kombinirajte XLTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLTM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLTM s primerom kode Java">}}

        ```java    
        // Združite datoteke XLTM z API-jem GroupDocs.Merger for Java
