...
############################# Head ############################
head_title: "Yhdistä CSV tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita CSV-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä CSV tiedostoa Java"
description: "Yhdistä CSV muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita CSV tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita CSV-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää CSV tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä CSV tiedostot GroupDocs.Merger for Java API:lla
