...
############################# Head ############################
head_title: "Združite VDX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VDX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VDX datotek v Java"
description: "Kombinirajte VDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VDX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VDX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VDX s primerom kode Java">}}

        ```java    
        // Združite datoteke VDX z API-jem GroupDocs.Merger for Java
