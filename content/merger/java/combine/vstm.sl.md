...
############################# Head ############################
head_title: "Združite VSTM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VSTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VSTM datotek v Java"
description: "Kombinirajte VSTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSTM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSTM s primerom kode Java">}}

        ```java    
        // Združite datoteke VSTM z API-jem GroupDocs.Merger for Java
