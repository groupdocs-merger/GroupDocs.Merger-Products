...
############################# Head ############################
head_title: "Combinez HTML fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Combinez plusieurs fichiers HTML en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Combinez HTML fichiers dans Java"
description: "Combinez HTML avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Combinez plusieurs fichiers HTML dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de combiner facilement plusieurs fichiers HTML en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers HTML à l'aide de l'exemple de code Java">}}

        ```java    
        // Combinez les fichiers HTML à l'aide de GroupDocs.Merger pour l'API Java
