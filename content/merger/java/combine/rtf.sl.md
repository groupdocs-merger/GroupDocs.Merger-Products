...
############################# Head ############################
head_title: "Združite RTF datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek RTF v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi RTF datotek v Java"
description: "Kombinirajte RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek RTF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek RTF z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke RTF s primerom kode Java">}}

        ```java    
        // Združite datoteke RTF z API-jem GroupDocs.Merger for Java
