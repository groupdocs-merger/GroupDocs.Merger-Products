...
############################# Head ############################
head_title: "Yhdistä XLSM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLSM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLSM tiedostoa Java"
description: "Yhdistä XLSM muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLSM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLSM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLSM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLSM tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLSM tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
