...
############################# Head ############################
head_title: "Kombinálja az VSX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VSX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VSX fájlokat a GroupDocs.Merger for Java API segítségével
...
demos:
    ...
    content: |
       Egynél több VSX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
