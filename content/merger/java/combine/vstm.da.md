...
head_description: "Kombiner flere VSTM filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner VSTM filer i Java"
description: "Kombiner VSTM med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere VSTM-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer VSTM filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner VSTM filer ved hjælp af GroupDocs.Merger for Java API
