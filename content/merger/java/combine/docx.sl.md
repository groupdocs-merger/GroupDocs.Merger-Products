...
############################# Head ############################
head_title: "Združite DOCX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek DOCX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi DOCX datotek v Java"
description: "Kombinirajte DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek DOCX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek DOCX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCX s primerom kode Java">}}

        ```java    
        // Združite datoteke DOCX z API-jem GroupDocs.Merger for Java
