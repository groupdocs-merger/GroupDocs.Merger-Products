...
############################# Head ############################
head_title: "Kombinera VTX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VTX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VTX filer i Java"
description: "Kombinera VTX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VTX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VTX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VTX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VTX filer med GroupDocs.Merger för Java API
