...
############################# Head ############################
head_title: "Združite PPSX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PPSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PPSX datotek v Java"
description: "Kombinirajte PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PPSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PPSX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPSX s primerom kode Java">}}

        ```java    
        // Združite datoteke PPSX z API-jem GroupDocs.Merger for Java
