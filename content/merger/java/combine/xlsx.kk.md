...
############################# Head ############################
head_title: "XLSX файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
...
############################# Header ############################
title: "XLSX файлды Java ішінде біріктіру"
description: "XLSX Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше XLSX файлды біріктіру"
    content_left: |
