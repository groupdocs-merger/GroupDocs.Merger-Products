...
############################# Head ############################
head_title: "Kombinera VSDX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSDX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSDX filer i Java"
description: "Kombinera VSDX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSDX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSDX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSDX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSDX filer med GroupDocs.Merger för Java API
