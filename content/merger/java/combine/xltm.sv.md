...
############################# Head ############################
head_title: "Kombinera XLTM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLTM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLTM filer i Java"
description: "Kombinera XLTM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLTM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLTM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLTM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLTM filer med GroupDocs.Merger för Java API
