...
############################# Head ############################
head_title: "Kombinera OTT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera OTT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera OTT filer i Java"
description: "Kombinera OTT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera OTT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera OTT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar OTT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera OTT filer med GroupDocs.Merger för Java API
