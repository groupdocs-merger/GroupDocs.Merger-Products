...
############################# Head ############################
head_title: "Comhcheangail DOTX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Comhcheangail comhaid DOTX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Comhcheangail DOTX Comhaid i Java"
description: "Comhcheangail DOTX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Comhcheangail Ilchomhad DOTX i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid DOTX iolracha a chomhcheangal trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOTX comhad a chur le chéile trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Comhcheangail DOTX comhad le GroupDocs.Merger le haghaidh Java API
...
demos:
    ...
    content: |
       Comhcheangail níos mó ná comhad DOTX amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
