...
############################# Head ############################
head_title: "Gabungkan MHT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail MHT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan MHT Fail Dalam Java"
description: "Gabungkan MHT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang MHT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail MHT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan MHT fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan MHT fail menggunakan GroupDocs.Merger untuk Java API
