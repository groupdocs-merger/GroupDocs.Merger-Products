...
############################# Head ############################
head_title: "Kombinera XLT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLT filer i Java"
description: "Kombinera XLT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLT filer med GroupDocs.Merger för Java API
