...
############################# Head ############################
head_title: "Gabungkan ONE Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail ONE dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan ONE Fail Dalam Java"
description: "Gabungkan ONE dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang ONE Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail ONE dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan ONE fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan ONE fail menggunakan GroupDocs.Merger untuk Java API
