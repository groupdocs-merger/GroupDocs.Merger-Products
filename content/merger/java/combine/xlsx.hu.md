...
############################# Head ############################
head_title: "Kombinálja az XLSX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több XLSX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLSX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) XLSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLSX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLSX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLSX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az XLSX fájlokat a GroupDocs.Merger for Java API segítségével
