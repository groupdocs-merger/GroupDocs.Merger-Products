...
############################# Head ############################
head_title: "Kombinera RTF filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera RTF-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera RTF filer i Java"
description: "Kombinera RTF med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera RTF-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera RTF-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar RTF-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera RTF filer med GroupDocs.Merger för Java API
