...
############################# Head ############################
head_title: "Yhdistä XLS tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLS-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLS tiedostoa Java"
description: "Yhdistä XLS muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLS tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLS-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLS tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLS tiedostot GroupDocs.Merger for Java API:lla
