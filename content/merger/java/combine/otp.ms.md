...
############################# Head ############################
head_title: "Gabungkan OTP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail OTP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan OTP Fail Dalam Java"
description: "Gabungkan OTP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang OTP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail OTP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan OTP fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan OTP fail menggunakan GroupDocs.Merger untuk Java API
