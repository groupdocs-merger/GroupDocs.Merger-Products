...
############################# Head ############################
head_title: "Combineer PPSX bestanden via Java & J2SE Documents Merger API"
head_description: "Combineer meerdere PPSX-bestanden in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Combineer PPSX bestanden in Java"
description: "Combineer PPSX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Combineer meerdere PPSX bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere PPSX-bestanden te combineren door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPSX bestanden te combineren met behulp van Java voorbeeldcode">}}

        ```java    
        // Combineer PPSX bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Combineer nu meer dan één PPSX bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) te gaan.
