...
############################# Head ############################
head_title: "Gabungkan berkas PPTX di Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen PPTX ke proyek Java Anda."

############################# Header ############################
title: "Gabungkan berkas PPTX" 
description: "Dengan GroupDocs.Merger for Java, Anda dapat mengembangkan aplikasi Java canggih yang menggabungkan dokumen PPTX tanpa kesulitan."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan kemampuan penggabungan untuk dokumen PPTX. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalur ke berkas PPTX pertama.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inisialisasi Merger dengan dokumen PPTX masukan
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berkas dengan format berbeda"
      content: |
        Contoh ini menunjukkan bagaimana menggabungkan berkas PPTX sambil menyertakan halaman tertentu dari dokumen dengan format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
