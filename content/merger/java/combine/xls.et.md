...
############################# Head ############################
head_title: "Kombineerige XLS failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLS faili Java"
description: "Kombineerige XLS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLS faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLS faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLS, kasutades GroupDocs.Merger for Java API-t
