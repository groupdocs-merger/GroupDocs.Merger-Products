...
############################# Head ############################
head_title: "Kombinálja az VSTM fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VSTM fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSTM fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VSTM elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSTM fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSTM fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSTM fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VSTM fájlokat a GroupDocs.Merger for Java API segítségével
