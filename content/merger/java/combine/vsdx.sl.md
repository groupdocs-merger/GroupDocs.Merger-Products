...
############################# Head ############################
head_title: "Združite VSDX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VSDX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VSDX datotek v Java"
description: "Kombinirajte VSDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSDX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSDX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSDX s primerom kode Java">}}

        ```java    
        // Združite datoteke VSDX z API-jem GroupDocs.Merger for Java
