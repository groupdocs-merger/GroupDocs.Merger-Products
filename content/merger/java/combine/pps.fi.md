...
############################# Head ############################
head_title: "Yhdistä PPS tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PPS-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä PPS tiedostoa Java"
description: "Yhdistä PPS muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PPS tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita PPS-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPS tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PPS tiedostot GroupDocs.Merger for Java API:lla
