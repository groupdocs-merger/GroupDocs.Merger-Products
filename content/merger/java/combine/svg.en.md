...
############################# Head ############################
head_title: "Combine SVG files in Java"
head_description: "Use GroupDocs.Merger for Java to add SVG document merging capabilities to your Java projects."

############################# Header ############################
title: "Combine SVG files" 
description: "With GroupDocs.Merger for Java, you can develop advanced Java applications that merge SVG documents effortlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) provides merging capabilities for SVG documents. Enhance your Java applications by merging multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge specific pages from files of different formats"
      content: |
        This example demonstrates how to merge SVG files while including specific pages from documents in other formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Extract pages"
          operation: "extract"
          link: "/merger/java/extract/svg/"
          description: "Save selected pages as a separate document"

        # operation loop 3
        - name: "Move pages"
          operation: "move"
          link: "/merger/java/move/svg/"
          description: "Reposition any page within a document"

        # operation loop 4
        - name: "Remove pages"
          operation: "remove"
          link: "/merger/java/remove/svg/"
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/java/rotate/svg/"
          description: "Rotate document pages"

        # operation loop 7
        - name: "Split doc"
          operation: "split"
          link: "/merger/java/split/svg/"
          description: "Split documents"

        # operation loop 8
        - name: "Swap pages"
          operation: "swap"
          link: "/merger/java/swap/svg/"
          description: "Swap document pages"

        # operation loop 9
        - name: "Change orientation"
          operation: "orientation"
          link: "/merger/java/orientation/svg/"
