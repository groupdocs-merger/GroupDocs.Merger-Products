...
############################# Head ############################
head_title: "Kombinálja az PPT fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több PPT fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPT fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) PPT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPT fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPT fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPT fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az PPT fájlokat a GroupDocs.Merger for Java API segítségével
...
demos:
    ...
    content: |
       Egynél több PPT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
