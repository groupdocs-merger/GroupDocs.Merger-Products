...
############################# Head ############################
head_title: "Kombineerige VSSM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSSM faili Java"
description: "Kombineerige VSSM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSSM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSSM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSSM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSSM, kasutades GroupDocs.Merger for Java API-t
