...
############################# Head ############################
head_title: "Yhdistä JPG tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita JPG-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä JPG tiedostoa Java"
description: "Yhdistä JPG muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita JPG tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita JPG-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää JPG tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä JPG tiedostot GroupDocs.Merger for Java API:lla
