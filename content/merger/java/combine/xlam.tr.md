...
############################# Head ############################
head_title: "XLAM Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok XLAM dosyasını Java'da birleştirin."

############################# Header ############################
title: "XLAM Dosyalarını Java İçinde Birleştirin"
description: "XLAM kodunu birkaç satır Java koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLAM Dosyasını Java İçinde Birleştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XLAM dosyasını birleştirmesini kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLAM dosyaları nasıl birleştirilir">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLAM dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla XLAM dosyayı birleştirin.
