...
############################# Head ############################
head_title: "Kombinálja az VSSX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VSSX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSSX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VSSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSSX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSSX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSSX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VSSX fájlokat a GroupDocs.Merger for Java API segítségével
