...
############################# Head ############################
head_title: "Združite PPTX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PPTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PPTX datotek v Java"
description: "Kombinirajte PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PPTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PPTX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPTX s primerom kode Java">}}

        ```java    
        // Združite datoteke PPTX z API-jem GroupDocs.Merger for Java
