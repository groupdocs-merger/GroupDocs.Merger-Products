...
############################# Head ############################
head_title: "Gabungkan XLAM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail XLAM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan XLAM Fail Dalam Java"
description: "Gabungkan XLAM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang XLAM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail XLAM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XLAM fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan XLAM fail menggunakan GroupDocs.Merger untuk Java API
