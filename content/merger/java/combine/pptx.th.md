...
head_description: "ใช้ GroupDocs.Merger for Java เพื่อเพิ่มฟังก์ชันการรวมเอกสาร PPTX ลงในโครงการ Java ของคุณ."

############################# Header ############################
title: "รวมไฟล์ PPTX" 
description: "ด้วย GroupDocs.Merger for Java คุณสามารถพัฒนาแอปพลิเคชัน Java ที่ทันสมัยซึ่งรวมเอกสาร PPTX ได้อย่างมีประสิทธิภาพ."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) มีฟังก์ชันการรวมสำหรับเอกสาร PPTX ปรับปรุงแอปพลิเคชัน Java ของคุณโดยการรวมไฟล์หลายไฟล์เป็นไฟล์เดียว.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "รวมหน้าที่เฉพาะจากไฟล์ที่แตกต่างกัน"
      content: |
        ตัวอย่างนี้แสดงให้เห็นถึงการรวมไฟล์ PPTX โดยรวมเฉพาะหน้าจากเอกสารในรูปแบบอื่น.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
