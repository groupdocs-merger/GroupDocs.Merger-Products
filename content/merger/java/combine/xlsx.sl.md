...
############################# Head ############################
head_title: "Združite XLSX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLSX datotek v Java"
description: "Kombinirajte XLSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLSX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSX s primerom kode Java">}}

        ```java    
        // Združite datoteke XLSX z API-jem GroupDocs.Merger for Java
