...
############################# Head ############################
head_title: "Združite XPS datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XPS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XPS datotek v Java"
description: "Kombinirajte XPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XPS z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XPS s primerom kode Java">}}

        ```java    
        // Združite datoteke XPS z API-jem GroupDocs.Merger for Java
