...
############################# Head ############################
head_title: "Kombineerige VTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VTX faili Java"
description: "Kombineerige VTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VTX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VTX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VTX, kasutades GroupDocs.Merger for Java API-t
