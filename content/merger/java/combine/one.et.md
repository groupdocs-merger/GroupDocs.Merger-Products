...
############################# Head ############################
head_title: "Kombineerige ONE failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu ONE-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri ONE faili Java"
description: "Kombineerige ONE mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu ONE faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme ONE faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida ONE faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid ONE, kasutades GroupDocs.Merger for Java API-t
