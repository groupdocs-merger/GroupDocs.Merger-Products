...
############################# Head ############################
head_title: "MHTML файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
head_description: "Java тіліндегі бірнеше MHTML файлдарды бастапқы құжаттар ретінде барлық деректермен, стильмен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "MHTML файлды Java ішінде біріктіру"
description: "MHTML Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше MHTML файлды біріктіру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы бірнеше MHTML файлдарды біріктіруді жеңілдетеді.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML файлдарды Java мысал кодын пайдаланып біріктіру жолы">}}

        ```java    
        // MHTML файлдарды Java API үшін GroupDocs.Merger арқылы біріктіріңіз
        // MHTML кіріс құжатымен бірігуді іске қосыңыз
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) веб-сайтына кіру арқылы дәл қазір бірден көп MHTML файлдарды біріктіріңіз.
