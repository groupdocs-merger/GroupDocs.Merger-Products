...
############################# Head ############################
head_title: "Kombinálja az EPUB fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több EPUB fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "EPUB fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) EPUB elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több EPUB fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több EPUB fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk EPUB fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az EPUB fájlokat a GroupDocs.Merger for Java API segítségével
