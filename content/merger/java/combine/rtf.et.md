...
############################# Head ############################
head_title: "Kombineerige RTF failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu RTF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri RTF faili Java"
description: "Kombineerige RTF mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu RTF faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme RTF faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida RTF faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid RTF, kasutades GroupDocs.Merger for Java API-t
