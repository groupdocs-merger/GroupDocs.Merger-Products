...
############################# Head ############################
head_title: "Combinar arquivos PDF no Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de mesclagem de documentos PDF aos seus projetos Java."

############################# Header ############################
title: "Combinar arquivos PDF" 
description: "Com GroupDocs.Merger for Java, você pode desenvolver aplicações avançadas em Java que mesclam documentos PDF de forma eficaz."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece capacidades de mesclagem para documentos PDF. Aprimore suas aplicações Java mesclando vários arquivos em um só.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas específicas de arquivos de diferentes formatos"
      content: |
        Este exemplo demonstra como mesclar arquivos PDF incluindo páginas específicas de documentos em outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
