...
############################# Head ############################
head_title: "Kombinera PPSX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera PPSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera PPSX filer i Java"
description: "Kombinera PPSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera PPSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera PPSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PPSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera PPSX filer med GroupDocs.Merger för Java API
