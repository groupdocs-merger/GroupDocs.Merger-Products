...
############################# Head ############################
head_title: "Συνδυάστε αρχεία JPEG μέσω Java & J2SE Documents Merger API"
head_description: "Συνδυάστε πολλά αρχεία JPEG σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Συνδυάστε JPEG αρχεία σε Java"
description: "Συνδυάστε το JPEG με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συνδυάστε πολλά JPEG αρχεία στο Java"
    content_left: |
        Το [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συνδυάσουν πολλά αρχεία JPEG εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδυάσετε αρχεία JPEG χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συνδυάστε JPEG αρχεία χρησιμοποιώντας το GroupDocs.Merger for Java API
