...
############################# Head ############################
head_title: "Yhdistä TXT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita TXT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä TXT tiedostoa Java"
description: "Yhdistä TXT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita TXT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita TXT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää TXT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä TXT tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi TXT tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
