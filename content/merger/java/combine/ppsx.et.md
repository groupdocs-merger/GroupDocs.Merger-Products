...
############################# Head ############################
head_title: "Kombineerige PPSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PPSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PPSX faili Java"
description: "Kombineerige PPSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PPSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PPSX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPSX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PPSX, kasutades GroupDocs.Merger for Java API-t
