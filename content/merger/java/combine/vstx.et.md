...
############################# Head ############################
head_title: "Kombineerige VSTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSTX faili Java"
description: "Kombineerige VSTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSTX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSTX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSTX, kasutades GroupDocs.Merger for Java API-t
