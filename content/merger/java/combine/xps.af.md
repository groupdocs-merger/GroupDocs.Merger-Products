...
############################# Head ############################
head_title: "Kombineer XPS lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige XPS-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer XPS lêers in Java"
description: "Kombineer XPS met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige XPS-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige XPS-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XPS lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer XPS lêers deur GroupDocs.Merger vir Java API te gebruik
