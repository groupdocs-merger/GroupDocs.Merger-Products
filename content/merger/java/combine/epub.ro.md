...
############################# Head ############################
head_title: "Combinați fișiere EPUB prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Combinați mai multe fișiere EPUB în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Combinați fișiere EPUB în Java"
description: "Combinați EPUB cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Combinați mai multe fișiere EPUB în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java combinarea mai multor fișiere EPUB prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să combinați fișiere EPUB folosind codul exemplu Java">}}

        ```java    
        // Combinați fișiere EPUB utilizând API-ul GroupDocs.Merger pentru Java
