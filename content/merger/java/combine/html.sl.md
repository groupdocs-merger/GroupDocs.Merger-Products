...
############################# Head ############################
head_title: "Združite HTML datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek HTML v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi HTML datotek v Java"
description: "Kombinirajte HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek HTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek HTML z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke HTML s primerom kode Java">}}

        ```java    
        // Združite datoteke HTML z API-jem GroupDocs.Merger for Java
