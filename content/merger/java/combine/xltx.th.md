...
############################# Head ############################
head_title: "รวม XLTX ไฟล์ผ่าน Java & J2SE Documents Merger API"
head_description: "รวมไฟล์ XLTX หลายไฟล์ใน Java โดยใช้ API การรวมเอกสารกับข้อมูล สไตล์ และการจัดรูปแบบทั้งหมดเป็นเอกสารต้นทาง"

############################# Header ############################
title: "รวม XLTX ไฟล์ใน Java"
description: "รวม XLTX กับโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "รวมไฟล์ XLTX หลายไฟล์ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ทำให้นักพัฒนา Java สามารถรวมไฟล์ XLTX หลายไฟล์ได้ง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีรวมไฟล์ XLTX ไฟล์โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // รวมไฟล์ XLTX ไฟล์โดยใช้ GroupDocs.Merger สำหรับ Java API
