...
############################# Head ############################
head_title: "Yhdistä MHTML tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita MHTML-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä MHTML tiedostoa Java"
description: "Yhdistä MHTML muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita MHTML tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita MHTML-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää MHTML tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä MHTML tiedostot GroupDocs.Merger for Java API:lla
