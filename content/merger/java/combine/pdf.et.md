...
############################# Head ############################
head_title: "Kombineerige PDF failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PDF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PDF faili Java"
description: "Kombineerige PDF mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PDF faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PDF faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PDF faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PDF, kasutades GroupDocs.Merger for Java API-t
