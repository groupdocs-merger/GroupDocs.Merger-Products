...
############################# Head ############################
head_title: "Kombineerige XLTM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLTM faili Java"
description: "Kombineerige XLTM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLTM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLTM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLTM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLTM, kasutades GroupDocs.Merger for Java API-t
