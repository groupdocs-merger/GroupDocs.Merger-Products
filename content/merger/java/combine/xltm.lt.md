...
############################# Head ############################
head_title: "Sujunkite XLTM failus naudodami Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Sujungti XLTM failus Java"
description: "Sujunkite XLTM su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis XLTM failus Java"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną XLTM failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
