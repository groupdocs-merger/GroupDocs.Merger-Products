...
############################# Head ############################
head_title: "Kombineerige VDX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VDX faili Java"
description: "Kombineerige VDX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VDX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VDX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VDX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VDX, kasutades GroupDocs.Merger for Java API-t
