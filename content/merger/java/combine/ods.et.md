...
############################# Head ############################
head_title: "Kombineerige ODS failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu ODS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri ODS faili Java"
description: "Kombineerige ODS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu ODS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme ODS faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida ODS faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid ODS, kasutades GroupDocs.Merger for Java API-t
