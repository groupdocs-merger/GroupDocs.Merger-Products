...
############################# Head ############################
head_title: "Kombineer VSTX lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige VSTX-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer VSTX lêers in Java"
description: "Kombineer VSTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige VSTX-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige VSTX-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTX lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer VSTX lêers deur GroupDocs.Merger vir Java API te gebruik
