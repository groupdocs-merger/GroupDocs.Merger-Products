...
############################# Head ############################
head_title: "Kombineerige XLTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLTX faili Java"
description: "Kombineerige XLTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLTX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLTX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLTX, kasutades GroupDocs.Merger for Java API-t
