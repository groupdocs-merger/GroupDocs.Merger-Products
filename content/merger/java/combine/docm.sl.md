...
############################# Head ############################
head_title: "Združite DOCM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek DOCM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi DOCM datotek v Java"
description: "Kombinirajte DOCM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek DOCM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek DOCM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCM s primerom kode Java">}}

        ```java    
        // Združite datoteke DOCM z API-jem GroupDocs.Merger for Java
