...
############################# Head ############################
head_title: "Kombineerige TSV failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu TSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri TSV faili Java"
description: "Kombineerige TSV mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu TSV faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme TSV faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida TSV faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid TSV, kasutades GroupDocs.Merger for Java API-t
