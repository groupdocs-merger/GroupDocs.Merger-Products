...
############################# Head ############################
head_title: "Yhdistä PDF tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PDF-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä PDF tiedostoa Java"
description: "Yhdistä PDF muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PDF tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita PDF-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PDF tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PDF tiedostot GroupDocs.Merger for Java API:lla
