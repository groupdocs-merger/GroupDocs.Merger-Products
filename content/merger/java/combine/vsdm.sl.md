...
############################# Head ############################
head_title: "Združite VSDM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VSDM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VSDM datotek v Java"
description: "Kombinirajte VSDM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSDM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSDM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSDM s primerom kode Java">}}

        ```java    
        // Združite datoteke VSDM z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno VSDM datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
