...
############################# Head ############################
head_title: "Combine JPEG files in Java"
head_description: "Use GroupDocs.Merger for Java to add JPEG document merging capabilities to your Java projects."

############################# Header ############################
title: "Combine JPEG files" 
description: "With GroupDocs.Merger for Java, you can develop advanced Java applications that merge JPEG documents effortlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) provides merging capabilities for JPEG documents. Enhance your Java applications by merging multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge specific pages from files of different formats"
      content: |
        This example demonstrates how to merge JPEG files while including specific pages from documents in other formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
