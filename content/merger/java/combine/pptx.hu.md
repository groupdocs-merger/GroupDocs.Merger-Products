...
############################# Head ############################
head_title: "Kombinálja az PPTX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több PPTX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPTX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) PPTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPTX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPTX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPTX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az PPTX fájlokat a GroupDocs.Merger for Java API segítségével
