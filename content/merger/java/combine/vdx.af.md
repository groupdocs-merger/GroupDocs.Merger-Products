...
############################# Head ############################
head_title: "Kombineer VDX lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige VDX-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer VDX lêers in Java"
description: "Kombineer VDX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige VDX-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige VDX-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer VDX lêers deur GroupDocs.Merger vir Java API te gebruik
