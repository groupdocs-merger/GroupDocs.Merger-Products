...
############################# Head ############################
head_title: "Yhdistä VDX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VDX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VDX tiedostoa Java"
description: "Yhdistä VDX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VDX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VDX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VDX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VDX tiedostot GroupDocs.Merger for Java API:lla
