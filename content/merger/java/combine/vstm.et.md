...
############################# Head ############################
head_title: "Kombineerige VSTM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSTM faili Java"
description: "Kombineerige VSTM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSTM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSTM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSTM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSTM, kasutades GroupDocs.Merger for Java API-t
