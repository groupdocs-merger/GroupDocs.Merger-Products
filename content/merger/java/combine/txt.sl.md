...
############################# Head ############################
head_title: "Združite TXT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek TXT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi TXT datotek v Java"
description: "Kombinirajte TXT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek TXT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek TXT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TXT s primerom kode Java">}}

        ```java    
        // Združite datoteke TXT z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno TXT datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
