...
############################# Head ############################
head_title: "Kombinera VDX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VDX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VDX filer i Java"
description: "Kombinera VDX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VDX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VDX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VDX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VDX filer med GroupDocs.Merger för Java API
