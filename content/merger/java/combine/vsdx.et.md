...
############################# Head ############################
head_title: "Kombineerige VSDX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSDX faili Java"
description: "Kombineerige VSDX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSDX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSDX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSDX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSDX, kasutades GroupDocs.Merger for Java API-t
