...
############################# Head ############################
head_title: "Kombinálja az PDF fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több PDF fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PDF fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) PDF elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PDF fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PDF fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PDF fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az PDF fájlokat a GroupDocs.Merger for Java API segítségével
