...
############################# Head ############################
head_title: "Kombinálja az DOT fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több DOT fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOT fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) DOT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOT fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOT fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk DOT fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az DOT fájlokat a GroupDocs.Merger for Java API segítségével
