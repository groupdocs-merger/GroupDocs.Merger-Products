...
############################# Head ############################
head_title: "CSV-Dateien in Java kombinieren"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um die Funktionen zum Zusammenführen von CSV-Dokumenten in Ihren Java-Projekten hinzuzufügen."

############################# Header ############################
title: "CSV-Dateien kombinieren" 
description: "Mit GroupDocs.Merger for Java können Sie fortschrittliche Java-Anwendungen entwickeln, die CSV-Dokumenten problemlos zusammenführen."
...
steps:
    enable: true
    title: "Wie man CSV-Dokumenten zusammenführt"
    content: |
      [GroupDocs.Merger](/merger/java/) bietet Funktionen zum Zusammenführen von CSV-Dokumenten. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien in eine kombinieren.
      
      1. Geben Sie den Pfad zur ersten CSV-Datei an.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingang CSV-Dokument initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus Dateien verschiedener Formate zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man CSV-Dateien zusammenführt und dabei spezifische Seiten aus Dokumenten in anderen Formaten einbezieht.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
