...
############################# Head ############################
head_title: "Kombinálja az VSDM fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VSDM fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSDM fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VSDM elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSDM fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSDM fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSDM fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VSDM fájlokat a GroupDocs.Merger for Java API segítségével
