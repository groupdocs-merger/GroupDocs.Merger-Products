...
############################# Head ############################
head_title: "Gabungkan JPG Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail JPG dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan JPG Fail Dalam Java"
description: "Gabungkan JPG dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang JPG Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail JPG dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan JPG fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan JPG fail menggunakan GroupDocs.Merger untuk Java API
