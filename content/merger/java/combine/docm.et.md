...
############################# Head ############################
head_title: "Kombineerige DOCM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu DOCM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri DOCM faili Java"
description: "Kombineerige DOCM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu DOCM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme DOCM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOCM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid DOCM, kasutades GroupDocs.Merger for Java API-t
