...
############################# Head ############################
head_title: "Kombinieren Sie VSTM-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere VSTM-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie VSTM-Dateien in Java"
description: "Kombinieren Sie VSTM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere VSTM-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VSTM-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie VSTM-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie VSTM-Dateien mit GroupDocs.Merger for Java API
