...
############################# Head ############################
head_title: "Gabungkan EXCEL File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "Gabungkan EXCEL File Di Java"
description: "Gabungkan EXCEL dengan beberapa baris kode Java."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file EXCEL dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file EXCEL menggunakan kode contoh Java">}}

        ```java    
        // Gabungkan file EXCEL menggunakan GroupDocs.Merger untuk Java API
