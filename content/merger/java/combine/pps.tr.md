...
############################# Head ############################
head_title: "PPS Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok PPS dosyasını Java'da birleştirin."

############################# Header ############################
title: "PPS Dosyalarını Java İçinde Birleştirin"
...
steps:
    enable: true
    title_left: "Birden Çok PPS Dosyasını Java İçinde Birleştirin"
    content_left: |
