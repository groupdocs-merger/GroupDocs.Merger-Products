...
############################# Head ############################
head_title: "Združite VSSM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VSSM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VSSM datotek v Java"
description: "Kombinirajte VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSSM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSSM s primerom kode Java">}}

        ```java    
        // Združite datoteke VSSM z API-jem GroupDocs.Merger for Java
