...
############################# Head ############################
head_title: "Gabungkan DOT Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail DOT dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan DOT Fail Dalam Java"
description: "Gabungkan DOT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang DOT Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail DOT dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan DOT fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan DOT fail menggunakan GroupDocs.Merger untuk Java API
