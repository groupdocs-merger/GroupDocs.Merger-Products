...
############################# Head ############################
head_title: "Comhcheangail JPEG Comhaid trí Java & J2SE Documents Merger API"
head_description: "Comhcheangail comhaid JPEG iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "Comhcheangail JPEG Comhaid i Java"
description: "Comhcheangail JPEG le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Comhcheangail Ilchomhad JPEG i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid JPEG iolracha a chomhcheangal trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas JPEG comhad a chur le chéile trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Comhcheangail JPEG comhad le GroupDocs.Merger le haghaidh Java API
