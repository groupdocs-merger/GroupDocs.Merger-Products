...
############################# Head ############################
head_title: "Kombineerige OTP failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu OTP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri OTP faili Java"
description: "Kombineerige OTP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu OTP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme OTP faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida OTP faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid OTP, kasutades GroupDocs.Merger for Java API-t
