...
############################# Head ############################
head_title: "Kombinera DOCX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera DOCX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera DOCX filer i Java"
description: "Kombinera DOCX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera DOCX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera DOCX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar DOCX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera DOCX filer med GroupDocs.Merger för Java API
