...
head_description: "Apvienojiet vairākus OTP failus Java, izmantojot dokumentu apvienošanas API ar visiem datiem, stilu un formatējumu kā avota dokumentus."

############################# Header ############################
title: "Apvienot OTP failus programmā Java"
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/lv/merger/java/) nodrošina ērtu risinājumu, lai apvienotu vairākus PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlus un daudzus citus dokumentus vienā failā Java lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts apvienot OTP dokumentus - nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt laiku un manuāli apvienot failus! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Apvienot vairākus OTP failus Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apvienot OTP failus, izmantojot Java piemēra kodu">}}
