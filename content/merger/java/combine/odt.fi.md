...
############################# Head ############################
head_title: "Yhdistä ODT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita ODT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä ODT tiedostoa Java"
description: "Yhdistä ODT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita ODT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita ODT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ODT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä ODT tiedostot GroupDocs.Merger for Java API:lla
