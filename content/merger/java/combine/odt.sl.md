...
############################# Head ############################
head_title: "Združite ODT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek ODT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi ODT datotek v Java"
description: "Kombinirajte ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek ODT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek ODT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODT s primerom kode Java">}}

        ```java    
        // Združite datoteke ODT z API-jem GroupDocs.Merger for Java
