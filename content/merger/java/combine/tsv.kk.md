...
############################# Head ############################
head_title: "TSV файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
head_description: "Java тіліндегі бірнеше TSV файлдарды бастапқы құжаттар ретінде барлық деректермен, стильмен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "TSV файлды Java ішінде біріктіру"
description: "TSV Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше TSV файлды біріктіру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы бірнеше TSV файлдарды біріктіруді жеңілдетеді.
    ...
    code: |
     ...
     {{< merger/code-merger title="TSV файлдарды Java мысал кодын пайдаланып біріктіру жолы">}}

        ```java    
        // TSV файлдарды Java API үшін GroupDocs.Merger арқылы біріктіріңіз
        // TSV кіріс құжатымен бірігуді іске қосыңыз
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) веб-сайтына кіру арқылы дәл қазір бірден көп TSV файлдарды біріктіріңіз.
