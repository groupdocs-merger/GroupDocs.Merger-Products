...
############################# Head ############################
head_title: "Združite BMP datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek BMP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi BMP datotek v Java"
description: "Kombinirajte BMP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek BMP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek BMP z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke BMP s primerom kode Java">}}

        ```java    
        // Združite datoteke BMP z API-jem GroupDocs.Merger for Java
