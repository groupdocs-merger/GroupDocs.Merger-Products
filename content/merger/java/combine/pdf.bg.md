...
############################# Head ############################
head_title: "Комбинирайте PDF файлове чрез Java & J2SE Documents Merger API"
head_description: "Комбинирайте множество PDF файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Комбинирайте PDF файлове в Java"
description: "Комбинирайте PDF с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Комбинирайте множество PDF файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да комбинират множество PDF файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате PDF файлове с помощта на Java примерен код">}}

        ```java    
        // Комбинирайте PDF файлове с помощта на GroupDocs.Merger за Java API
