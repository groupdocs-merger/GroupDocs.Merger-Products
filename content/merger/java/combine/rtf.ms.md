...
############################# Head ############################
head_title: "Gabungkan RTF Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail RTF dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan RTF Fail Dalam Java"
description: "Gabungkan RTF dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang RTF Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail RTF dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan RTF fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan RTF fail menggunakan GroupDocs.Merger untuk Java API
