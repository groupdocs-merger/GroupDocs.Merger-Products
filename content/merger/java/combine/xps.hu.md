...
############################# Head ############################
head_title: "Kombinálja az XPS fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több XPS fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XPS fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) XPS elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XPS fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XPS fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XPS fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az XPS fájlokat a GroupDocs.Merger for Java API segítségével
