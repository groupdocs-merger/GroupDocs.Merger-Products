...
############################# Head ############################
head_title: "Kombinera MHTML filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera MHTML-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera MHTML filer i Java"
description: "Kombinera MHTML med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera MHTML-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera MHTML-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar MHTML-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera MHTML filer med GroupDocs.Merger för Java API
