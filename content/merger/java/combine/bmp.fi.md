...
############################# Head ############################
head_title: "Yhdistä BMP tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita BMP-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä BMP tiedostoa Java"
description: "Yhdistä BMP muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita BMP tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita BMP-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää BMP tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä BMP tiedostot GroupDocs.Merger for Java API:lla
