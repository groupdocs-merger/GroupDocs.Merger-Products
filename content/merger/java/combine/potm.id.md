...
head_description: "Gabungkan beberapa file POTM di Java menggunakan API penggabungan dokumen dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."
...
steps:
    enable: true
    title_left: "Gabungkan Beberapa File POTM di Java"
    content_left: |
