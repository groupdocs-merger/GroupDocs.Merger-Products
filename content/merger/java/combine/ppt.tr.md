...
############################# Head ############################
head_title: "PPT Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok PPT dosyasını Java'da birleştirin."

############################# Header ############################
title: "PPT Dosyalarını Java İçinde Birleştirin"
description: "PPT kodunu birkaç satır Java koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok PPT Dosyasını Java İçinde Birleştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok PPT dosyasını birleştirmesini kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPT dosyaları nasıl birleştirilir">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPT dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla PPT dosyayı birleştirin.
