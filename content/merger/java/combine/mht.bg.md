...
############################# Head ############################
head_title: "Комбинирайте MHT файлове чрез Java & J2SE Documents Merger API"
head_description: "Комбинирайте множество MHT файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Комбинирайте MHT файлове в Java"
description: "Комбинирайте MHT с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Комбинирайте множество MHT файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да комбинират множество MHT файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате MHT файлове с помощта на Java примерен код">}}

        ```java    
        // Комбинирайте MHT файлове с помощта на GroupDocs.Merger за Java API
