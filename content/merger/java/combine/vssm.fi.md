...
############################# Head ############################
head_title: "Yhdistä VSSM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSSM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSSM tiedostoa Java"
description: "Yhdistä VSSM muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSSM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSSM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSSM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSSM tiedostot GroupDocs.Merger for Java API:lla
