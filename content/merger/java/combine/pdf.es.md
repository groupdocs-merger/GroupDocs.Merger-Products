...
############################# Head ############################
head_title: "Combina archivos PDF en Java"
head_description: "Utiliza GroupDocs.Merger for Java para agregar capacidades de fusión de documentos PDF a tus proyectos de Java."

############################# Header ############################
title: "Combina archivos PDF" 
description: "Con GroupDocs.Merger for Java, puedes desarrollar aplicaciones avanzadas de Java que fusionan documentos PDF sin complicaciones."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) proporciona capacidades de fusión para documentos PDF. Mejora tus aplicaciones de Java fusionando múltiples archivos en uno solo.
      
      1. Especifica la ruta al primer archivo PDF.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicializa Merger con el documento de entrada PDF
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas específicas de archivos de diferentes formatos"
      content: |
        Este ejemplo demuestra cómo fusionar archivos PDF incluyendo páginas específicas de documentos en otros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
