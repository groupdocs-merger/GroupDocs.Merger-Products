...
############################# Head ############################
head_title: "Kombineerige EPUB failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu EPUB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri EPUB faili Java"
description: "Kombineerige EPUB mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu EPUB faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme EPUB faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida EPUB faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid EPUB, kasutades GroupDocs.Merger for Java API-t
