...
############################# Head ############################
head_title: "Združite XLSM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLSM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLSM datotek v Java"
description: "Kombinirajte XLSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLSM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSM s primerom kode Java">}}

        ```java    
        // Združite datoteke XLSM z API-jem GroupDocs.Merger for Java
