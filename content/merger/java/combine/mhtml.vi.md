...
head_description: "Sử dụng GroupDocs.Merger for Java để thêm khả năng hợp nhất tài liệu MHTML vào các dự án Java của bạn."

############################# Header ############################
title: "Kết hợp các tệp MHTML" 
description: "Với GroupDocs.Merger for Java, bạn có thể phát triển các ứng dụng Java tiên tiến giúp hợp nhất tài liệu MHTML một cách hiệu quả."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) cung cấp khả năng hợp nhất cho tài liệu MHTML. Nâng cao các ứng dụng Java của bạn bằng cách hợp nhất nhiều tệp thành một.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hợp nhất các trang cụ thể từ các tệp có định dạng khác nhau"
      content: |
        Ví dụ này cho thấy cách hợp nhất các tệp MHTML trong khi bao gồm các trang cụ thể từ tài liệu ở định dạng khác.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
