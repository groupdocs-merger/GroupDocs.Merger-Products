...
############################# Head ############################
head_title: "Združite PPT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PPT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PPT datotek v Java"
description: "Kombinirajte PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PPT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PPT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPT s primerom kode Java">}}

        ```java    
        // Združite datoteke PPT z API-jem GroupDocs.Merger for Java
