...
head_description: "Kombiner flere ODP filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner ODP filer i Java"
description: "Kombiner ODP med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere ODP-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer ODP filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner ODP filer ved hjælp af GroupDocs.Merger for Java API
