...
############################# Head ############################
head_title: "Yhdistä XLSX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLSX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLSX tiedostoa Java"
description: "Yhdistä XLSX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLSX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLSX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLSX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLSX tiedostot GroupDocs.Merger for Java API:lla
