...
############################# Head ############################
head_title: "Yhdistä HTML tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita HTML-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä HTML tiedostoa Java"
description: "Yhdistä HTML muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita HTML tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita HTML-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää HTML tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä HTML tiedostot GroupDocs.Merger for Java API:lla
