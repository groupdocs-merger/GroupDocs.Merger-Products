...
############################# Head ############################
head_title: "Gabungkan berkas DOCX di Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen DOCX ke proyek Java Anda."

############################# Header ############################
title: "Gabungkan berkas DOCX" 
description: "Dengan GroupDocs.Merger for Java, Anda dapat mengembangkan aplikasi Java canggih yang menggabungkan dokumen DOCX tanpa kesulitan."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan kemampuan penggabungan untuk dokumen DOCX. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalur ke berkas DOCX pertama.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inisialisasi Merger dengan dokumen DOCX masukan
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berkas dengan format berbeda"
      content: |
        Contoh ini menunjukkan bagaimana menggabungkan berkas DOCX sambil menyertakan halaman tertentu dari dokumen dengan format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
