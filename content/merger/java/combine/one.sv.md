...
############################# Head ############################
head_title: "Kombinera ONE filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera ONE-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera ONE filer i Java"
description: "Kombinera ONE med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera ONE-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera ONE-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ONE-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera ONE filer med GroupDocs.Merger för Java API
