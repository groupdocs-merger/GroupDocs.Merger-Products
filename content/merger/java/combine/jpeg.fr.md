...
############################# Head ############################
head_title: "Combiner des fichiers JPEG dans Java"
head_description: "Utilisez GroupDocs.Merger for Java pour ajouter des fonctionnalités de fusion de documents JPEG à vos projets Java."

############################# Header ############################
title: "Combiner des fichiers JPEG" 
description: "Avec GroupDocs.Merger for Java, vous pouvez développer des applications avancées Java qui fusionnent des documents JPEG sans effort."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) fournit des capacités de fusion pour les documents JPEG. Améliorez vos applications Java en fusionnant plusieurs fichiers en un.
      
      1. Spécifiez le chemin du premier fichier JPEG.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Initialiser Merger avec le document JPEG d'entrée
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages spécifiques de fichiers de différents formats"
      content: |
        Cet exemple démontre comment fusionner des fichiers JPEG tout en incluant des pages spécifiques de documents dans d'autres formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
