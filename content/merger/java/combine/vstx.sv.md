...
############################# Head ############################
head_title: "Kombinera VSTX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSTX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSTX filer i Java"
description: "Kombinera VSTX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSTX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSTX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSTX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSTX filer med GroupDocs.Merger för Java API
