...
############################# Head ############################
head_title: "Kombinálja az ODP fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több ODP fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "ODP fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) ODP elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több ODP fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több ODP fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ODP fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az ODP fájlokat a GroupDocs.Merger for Java API segítségével
