...
############################# Head ############################
head_title: "Gabungkan PDF Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail PDF dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan PDF Fail Dalam Java"
description: "Gabungkan PDF dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang PDF Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail PDF dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan PDF fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan PDF fail menggunakan GroupDocs.Merger untuk Java API
