...
############################# Head ############################
head_title: "Combine VSX Arquivos via Java & J2SE Documents Merger API"
head_description: "Combine vários arquivos VSX em Java usando a API de fusão de documentos com todos os dados, estilo e formatação como documentos de origem."

############################# Header ############################
title: "Combine VSX Arquivos em Java"
description: "Combine VSX com algumas linhas de código Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pt/merger/java/) fornece uma solução conveniente para combinar vários PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, imagens e muitos outros documentos em um único arquivo dentro dos aplicativos Java. O GroupDocs.Merger economizará muito esforço, pois você pode combinar documentos VSX - não há necessidade de instalar nenhum software de terceiros, aplicativos de desktop ou plug-ins. Agora é desnecessário perder seu tempo e combinar arquivos manualmente! A missão do GroupDocs é fornecer a melhor qualidade e simplificar os fluxos de trabalho de processamento de documentos.
...
steps:
    enable: true
    title_left: "Combine vários arquivos VSX em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores Java combinar vários arquivos VSX implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos VSX usando o código de exemplo Java">}}

        ```java    
        // Combine arquivos VSX usando GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Combine mais de um arquivo VSX agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
