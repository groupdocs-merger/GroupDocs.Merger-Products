...
############################# Head ############################
head_title: "Միավորել ODS ֆայլեր Java & J2SE Documents Merger API-ի միջոցով"
head_description: "Միավորել բազմաթիվ ODS ֆայլեր Java-ում՝ օգտագործելով փաստաթղթերի միաձուլման API-ն բոլոր տվյալների, ոճի և ձևաչափի հետ՝ որպես սկզբնաղբյուր փաստաթղթեր:"

############################# Header ############################
title: "Միավորել ODS ֆայլեր Java-ում"
description: "Միավորել ODS-ը Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Միավորել բազմաթիվ ODS ֆայլեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) Java ծրագրավորողների համար հեշտացնում է մի քանի ODS ֆայլեր համատեղելը` մի քանի հեշտ քայլեր իրականացնելով:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միավորել ODS ֆայլեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Միավորել ODS ֆայլեր՝ օգտագործելով GroupDocs.Merger Java API-ի համար
...
demos:
    ...
    content: |
       Միավորեք մեկից ավելի ODS ֆայլ հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) կայքը:
