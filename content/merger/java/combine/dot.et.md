...
############################# Head ############################
head_title: "Kombineerige DOT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu DOT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri DOT faili Java"
description: "Kombineerige DOT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu DOT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme DOT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid DOT, kasutades GroupDocs.Merger for Java API-t
