...
############################# Head ############################
head_title: "Gabungkan ODS Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail ODS dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan ODS Fail Dalam Java"
description: "Gabungkan ODS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang ODS Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail ODS dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan ODS fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan ODS fail menggunakan GroupDocs.Merger untuk Java API
