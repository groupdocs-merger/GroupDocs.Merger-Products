...
############################# Head ############################
head_title: "Kombineerige VSSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSSX faili Java"
description: "Kombineerige VSSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSSX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSSX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSSX, kasutades GroupDocs.Merger for Java API-t
