...
############################# Head ############################
head_title: "Gabungkan MHTML Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail MHTML dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan MHTML Fail Dalam Java"
description: "Gabungkan MHTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang MHTML Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail MHTML dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan MHTML fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan MHTML fail menggunakan GroupDocs.Merger untuk Java API
