...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีรวมไฟล์ XLSM ไฟล์โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // รวมไฟล์ XLSM ไฟล์โดยใช้ GroupDocs.Merger สำหรับ Java API
