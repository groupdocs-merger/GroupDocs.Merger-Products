...
############################# Head ############################
head_title: "Java & J2SE Documents Merger API を介して HTML ファイルを結合"
head_description: "ドキュメント マージ API を使用して Java で複数の HTML ファイルを結合し、ソース ドキュメントとしてすべてのデータ、スタイル、書式設定を行います。"

############################# Header ############################
title: "Java 内の HTML ファイルを結合します"
description: "HTML を数行の Java コードと組み合わせます。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ja/merger/java/) を使用すると、Java 開発者はいくつかの簡単な手順を実装することで、複数の HTML ファイルを簡単に組み合わせることができます。
    ...
    code: |
     ...
     {{< merger/code-merger title="Java サンプル コードを使用して HTML ファイルを結合する方法">}}

        ```java    
        // GroupDocs.Merger for Java API を使用して HTML ファイルを結合します
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) Web サイトにアクセスして、複数の HTML ファイルを今すぐ結合してください。
       ライブデモには次の利点があります。
