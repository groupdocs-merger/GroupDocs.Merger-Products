...
############################# Head ############################
head_title: "JPEG ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ያጣምሩ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ የJPEG ፋይሎችን በጃቫ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "JPEG ፋይሎችን በJava ውስጥ ያጣምሩ"
description: "JPEGን ከጥቂት የJava ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ JPEG ፋይሎችን ያጣምሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለጃቫ ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ብዙ JPEG ፋይሎችን ማጣመር ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም JPEG ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም JPEG ፋይሎችን ያጣምሩ
