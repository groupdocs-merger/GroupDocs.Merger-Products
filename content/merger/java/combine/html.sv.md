...
############################# Head ############################
head_title: "Kombinera HTML filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera HTML-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera HTML filer i Java"
description: "Kombinera HTML med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera HTML-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera HTML-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar HTML-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera HTML filer med GroupDocs.Merger för Java API
