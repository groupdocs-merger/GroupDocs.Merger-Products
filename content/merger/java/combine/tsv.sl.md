...
############################# Head ############################
head_title: "Združite TSV datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek TSV v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi TSV datotek v Java"
description: "Kombinirajte TSV z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek TSV v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek TSV z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TSV s primerom kode Java">}}

        ```java    
        // Združite datoteke TSV z API-jem GroupDocs.Merger for Java
