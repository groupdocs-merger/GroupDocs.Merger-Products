...
############################# Head ############################
head_title: "Kombineerige TEX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu TEX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri TEX faili Java"
description: "Kombineerige TEX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu TEX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme TEX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida TEX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid TEX, kasutades GroupDocs.Merger for Java API-t
