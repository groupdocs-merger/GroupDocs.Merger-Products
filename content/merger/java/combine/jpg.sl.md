...
############################# Head ############################
head_title: "Združite JPG datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek JPG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi JPG datotek v Java"
description: "Kombinirajte JPG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek JPG v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek JPG z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPG s primerom kode Java">}}

        ```java    
        // Združite datoteke JPG z API-jem GroupDocs.Merger for Java
