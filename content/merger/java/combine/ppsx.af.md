...
############################# Head ############################
head_title: "Kombineer PPSX lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige PPSX-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer PPSX lêers in Java"
description: "Kombineer PPSX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige PPSX-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige PPSX-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer PPSX lêers deur GroupDocs.Merger vir Java API te gebruik
