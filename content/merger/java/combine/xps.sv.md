...
############################# Head ############################
head_title: "Kombinera XPS filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XPS-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XPS filer i Java"
description: "Kombinera XPS med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XPS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XPS-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XPS-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XPS filer med GroupDocs.Merger för Java API
