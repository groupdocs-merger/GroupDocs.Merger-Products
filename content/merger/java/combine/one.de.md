...
############################# Head ############################
head_title: "Kombinieren Sie ONE-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere ONE-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie ONE-Dateien in Java"
description: "Kombinieren Sie ONE mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere ONE-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere ONE-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie ONE-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie ONE-Dateien mit GroupDocs.Merger for Java API
