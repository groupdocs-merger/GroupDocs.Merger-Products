...
############################# Head ############################
head_title: "Kombinujte soubory PDF prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů PDF v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat PDF soubory v Java"
description: "Zkombinujte PDF s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů PDF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů PDF pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory PDF pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory PDF pomocí GroupDocs.Merger for Java API
