...
############################# Head ############################
head_title: "Kombineerige XPS failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XPS faili Java"
description: "Kombineerige XPS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XPS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XPS faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XPS faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XPS, kasutades GroupDocs.Merger for Java API-t
