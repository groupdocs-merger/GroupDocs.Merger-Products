...
############################# Head ############################
head_title: "Yhdistä DOCX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita DOCX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä DOCX tiedostoa Java"
description: "Yhdistä DOCX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita DOCX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita DOCX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOCX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä DOCX tiedostot GroupDocs.Merger for Java API:lla
