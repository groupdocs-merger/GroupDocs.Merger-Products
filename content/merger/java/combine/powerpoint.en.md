...
############################# Head ############################
head_title: "Combine POWERPOINT files in Java"
head_description: "Use GroupDocs.Merger for Java to add POWERPOINT document merging capabilities to your Java projects."

############################# Header ############################
title: "Combine POWERPOINT files" 
description: "With GroupDocs.Merger for Java, you can develop advanced Java applications that merge POWERPOINT documents effortlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) provides merging capabilities for POWERPOINT documents. Enhance your Java applications by merging multiple files into one.
      
      1. Specify the path to the first POWERPOINT file.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Initialize Merger with the input POWERPOINT document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge specific pages from files of different formats"
      content: |
        This example demonstrates how to merge POWERPOINT files while including specific pages from documents in other formats.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
