...
############################# Head ############################
head_title: "Combina VSDM file tramite Java e J2SE Documents Merger API"
head_description: "Combina più file VSDM in Java utilizzando l'API di fusione documenti con tutti i dati, lo stile e la formattazione come documenti di origine."

############################# Header ############################
title: "Combina VSDM file in Java"
description: "Combina VSDM con poche righe di codice Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/it/merger/java/) fornisce una comoda soluzione per combinare più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni Java. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito combinare VSDM documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e combinare i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    enable: true
    title_left: "Combina più file VSDM in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori Java di combinare facilmente più file VSDM implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come combinare file VSDM utilizzando il codice di esempio Java">}}

        ```java    
        // Combina file VSDM utilizzando GroupDocs.Merger per l'API Java
