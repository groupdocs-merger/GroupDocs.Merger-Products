...
############################# Head ############################
head_title: "ادمج XLTM الملفات عبر Java & J2SE Documents Merger API"
head_description: "ادمج عدة ملفات XLTM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "دمج ملفات XLTM في Java"
description: "ادمج XLTM مع بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "دمج عدة ملفات XLTM في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا دمج عدة ملفات XLTM من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات XLTM باستخدام كود مثال Java">}}

        ```java    
        // دمج ملفات XLTM باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
...
demos:
    ...
    content: |
       اجمع بين أكثر من ملف XLTM واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
