...
############################# Head ############################
head_title: "Gabungkan JPEG Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail JPEG dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan JPEG Fail Dalam Java"
description: "Gabungkan JPEG dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang JPEG Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail JPEG dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan JPEG fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan JPEG fail menggunakan GroupDocs.Merger untuk Java API
