...
############################# Head ############################
head_title: "Kombineerige OTT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu OTT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri OTT faili Java"
description: "Kombineerige OTT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu OTT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme OTT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida OTT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid OTT, kasutades GroupDocs.Merger for Java API-t
