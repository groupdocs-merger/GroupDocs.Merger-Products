...
############################# Head ############################
head_title: "Yhdistä DOCM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita DOCM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä DOCM tiedostoa Java"
description: "Yhdistä DOCM muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita DOCM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita DOCM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOCM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä DOCM tiedostot GroupDocs.Merger for Java API:lla
