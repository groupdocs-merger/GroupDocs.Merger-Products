...
############################# Head ############################
head_title: "Sujunkite CSV failus naudodami Java & J2SE Documents Merger API"
head_description: "Sujunkite kelis CSV failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Sujungti CSV failus Java"
description: "Sujunkite CSV su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis CSV failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis CSV failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti CSV failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite CSV failus naudodami GroupDocs.Merger for Java API
