...
############################# Head ############################
head_title: "Yhdistä PPT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PPT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä PPT tiedostoa Java"
description: "Yhdistä PPT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PPT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita PPT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PPT tiedostot GroupDocs.Merger for Java API:lla
