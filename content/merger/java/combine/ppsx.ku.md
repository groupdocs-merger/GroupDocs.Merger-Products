...
############################# Head ############################
head_title: "Pelên PPSX bi navgîniya Java & J2SE Documents Merger API-ê bihev bikin"
head_description: "Gelek pelên PPSX di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî daneyan, şêwaz û şeklê wekî belgeyên çavkaniyê re bikin yek."

############################# Header ############################
title: "Pelên PPSX Di Java de berhev bikin"
description: "PPSX bi çend rêzikên koda Java re bibin yek."
...
steps:
    enable: true
    title_left: "Gelek PPSX Pelên di Java de bi hev re bikin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve gelek pelên PPSX li hev bikin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên PPSX bi karanîna koda nimûneya Java berhev dike">}}

        ```java    
        // Pelên PPSX bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi kar bînin
