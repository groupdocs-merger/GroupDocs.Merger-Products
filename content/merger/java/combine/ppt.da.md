...
head_description: "Kombiner flere PPT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner PPT filer i Java"
description: "Kombiner PPT med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere PPT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer PPT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner PPT filer ved hjælp af GroupDocs.Merger for Java API
