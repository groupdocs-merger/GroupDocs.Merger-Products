...
############################# Head ############################
head_title: "Združite ODS datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek ODS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi ODS datotek v Java"
description: "Kombinirajte ODS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek ODS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek ODS z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODS s primerom kode Java">}}

        ```java    
        // Združite datoteke ODS z API-jem GroupDocs.Merger for Java
