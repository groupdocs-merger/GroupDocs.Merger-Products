...
############################# Head ############################
head_title: "Združite XLS datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLS datotek v Java"
description: "Kombinirajte XLS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLS z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLS s primerom kode Java">}}

        ```java    
        // Združite datoteke XLS z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno XLS datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
