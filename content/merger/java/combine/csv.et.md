...
############################# Head ############################
head_title: "Kombineerige CSV failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu CSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri CSV faili Java"
description: "Kombineerige CSV mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu CSV faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme CSV faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida CSV faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid CSV, kasutades GroupDocs.Merger for Java API-t
