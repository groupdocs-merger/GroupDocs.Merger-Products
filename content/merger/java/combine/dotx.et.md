...
############################# Head ############################
head_title: "Kombineerige DOTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu DOTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri DOTX faili Java"
description: "Kombineerige DOTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu DOTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme DOTX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOTX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid DOTX, kasutades GroupDocs.Merger for Java API-t
