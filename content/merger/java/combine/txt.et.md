...
############################# Head ############################
head_title: "Kombineerige TXT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu TXT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri TXT faili Java"
description: "Kombineerige TXT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu TXT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme TXT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida TXT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid TXT, kasutades GroupDocs.Merger for Java API-t
