...
############################# Head ############################
head_title: "Combina fitxers XLSB mitjançant l'API de fusió de documents Java i J2SE"
...
############################# Header ############################
title: "Combina XLSB fitxers a Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java combinar diversos fitxers XLSB implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLSB utilitzant el codi d'exemple Java">}}
