...
############################# Head ############################
head_title: "Kombinera XLSX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLSX filer i Java"
description: "Kombinera XLSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLSX filer med GroupDocs.Merger för Java API
