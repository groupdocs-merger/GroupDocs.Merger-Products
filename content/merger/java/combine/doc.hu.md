...
############################# Head ############################
head_title: "Kombinálja az DOC fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több DOC fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOC fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) DOC elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOC fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOC fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk DOC fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az DOC fájlokat a GroupDocs.Merger for Java API segítségével
