...
############################# Head ############################
head_title: "Kombineerige PPS failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PPS faili Java"
description: "Kombineerige PPS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PPS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PPS faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPS faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PPS, kasutades GroupDocs.Merger for Java API-t
