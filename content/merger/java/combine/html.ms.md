...
############################# Head ############################
head_title: "Gabungkan HTML Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail HTML dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan HTML Fail Dalam Java"
description: "Gabungkan HTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang HTML Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail HTML dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan HTML fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan HTML fail menggunakan GroupDocs.Merger untuk Java API
