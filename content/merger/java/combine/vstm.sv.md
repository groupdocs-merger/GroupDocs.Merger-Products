...
############################# Head ############################
head_title: "Kombinera VSTM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSTM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSTM filer i Java"
description: "Kombinera VSTM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSTM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSTM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSTM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSTM filer med GroupDocs.Merger för Java API
