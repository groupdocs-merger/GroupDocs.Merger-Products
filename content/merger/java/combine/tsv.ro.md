...
############################# Head ############################
head_title: "Combinați fișiere TSV prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Combinați mai multe fișiere TSV în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "Combinați fișiere TSV în Java"
description: "Combinați TSV cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Combinați mai multe fișiere TSV în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java combinarea mai multor fișiere TSV prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să combinați fișiere TSV folosind codul exemplu Java">}}

        ```java    
        // Combinați fișiere TSV utilizând API-ul GroupDocs.Merger pentru Java
