...
############################# Head ############################
head_title: "Gabungkan berkas IMAGE di Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menambahkan kemampuan penggabungan dokumen IMAGE ke proyek Java Anda."

############################# Header ############################
title: "Gabungkan berkas IMAGE" 
description: "Dengan GroupDocs.Merger for Java, Anda dapat mengembangkan aplikasi Java canggih yang menggabungkan dokumen IMAGE tanpa kesulitan."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) menyediakan kemampuan penggabungan untuk dokumen IMAGE. Tingkatkan aplikasi Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Tentukan jalur ke berkas IMAGE pertama.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inisialisasi Merger dengan dokumen IMAGE masukan
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman tertentu dari berkas dengan format berbeda"
      content: |
        Contoh ini menunjukkan bagaimana menggabungkan berkas IMAGE sambil menyertakan halaman tertentu dari dokumen dengan format lain.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
