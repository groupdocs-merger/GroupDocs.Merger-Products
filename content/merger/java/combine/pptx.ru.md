...
############################# Head ############################
head_title: "Объедините файлы PPTX в Java"
head_description: "Используйте GroupDocs.Merger for Java, чтобы добавить возможности слияния документов PPTX в ваши проекты на Java."

############################# Header ############################
title: "Объединение файлов PPTX" 
description: "С помощью GroupDocs.Merger for Java вы можете разрабатывать сложные приложения на Java, которые объединяют документы PPTX."
subtitle: "" 
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) предоставляет возможности слияния для документов PPTX. Улучшите свои приложения на Java, объединив несколько файлов в один.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение определенных страниц из файлов разных форматов"
      content: |
        Этот пример демонстрирует, как объединить файлы PPTX, включая определенные страницы из документов других форматов.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
