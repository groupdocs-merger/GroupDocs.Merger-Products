...
############################# Head ############################
head_title: "Kombinálja az VSTX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VSTX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSTX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VSTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSTX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSTX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSTX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VSTX fájlokat a GroupDocs.Merger for Java API segítségével
