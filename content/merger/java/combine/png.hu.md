...
############################# Head ############################
head_title: "Kombinálja az PNG fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több PNG fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PNG fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) PNG elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PNG fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PNG fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PNG fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az PNG fájlokat a GroupDocs.Merger for Java API segítségével
