...
############################# Head ############################
head_title: "Combine DOCX files in Java via Java"
...
more_formats:
    ...
    items: 
        ...
        - name: "Search in PPTX"
          format: "PPTX"
          link: "/search/java/combine/pptx/"
          description: "PowerPoint Open XML Presentation"

        # format loop 4
        - name: "Search in TXT"
          format: "TXT"
          link: "/search/java/combine/txt/"
          description: "Text Document"
          
        # format loop 5
        - name: "Search in XLSX"
          format: "XLSX"
          link: "/search/java/combine/xlsx/"
