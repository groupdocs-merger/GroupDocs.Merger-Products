...
############################# Head ############################
head_title: "Yhdistä XLT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLT tiedostoa Java"
description: "Yhdistä XLT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLT tiedostot GroupDocs.Merger for Java API:lla
