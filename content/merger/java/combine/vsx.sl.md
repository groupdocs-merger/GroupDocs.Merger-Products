...
############################# Head ############################
head_title: "Združite VSX datoteke prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Združi VSX datotek v Java"
description: "Kombinirajte VSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSX s primerom kode Java">}}
        ...
        ```java    
        // Združite datoteke VSX z API-jem GroupDocs.Merger for Java
