...
############################# Head ############################
head_title: "Kombinieren Sie DOC-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere DOC-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie DOC-Dateien in Java"
description: "Kombinieren Sie DOC mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere DOC-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOC-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie DOC-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie DOC-Dateien mit GroupDocs.Merger for Java API
