...
############################# Head ############################
head_title: "Combineer ONE bestanden via Java & J2SE Documents Merger API"
head_description: "Combineer meerdere ONE-bestanden in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Combineer ONE bestanden in Java"
description: "Combineer ONE met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Combineer meerdere ONE bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere ONE-bestanden te combineren door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ONE bestanden te combineren met behulp van Java voorbeeldcode">}}

        ```java    
        // Combineer ONE bestanden met behulp van GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Combineer nu meer dan één ONE bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) te gaan.
