...
############################# Head ############################
head_title: "Kombinera XLSM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLSM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLSM filer i Java"
description: "Kombinera XLSM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLSM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLSM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLSM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLSM filer med GroupDocs.Merger för Java API
