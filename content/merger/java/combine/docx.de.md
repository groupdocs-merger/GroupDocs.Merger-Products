...
############################# Head ############################
head_title: "Kombinieren Sie DOCX-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere DOCX-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie DOCX-Dateien in Java"
description: "Kombinieren Sie DOCX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere DOCX-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOCX-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie DOCX-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie DOCX-Dateien mit GroupDocs.Merger for Java API
