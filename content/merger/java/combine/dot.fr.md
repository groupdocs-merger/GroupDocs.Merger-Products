...
############################# Head ############################
head_title: "Combinez DOT fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Combinez plusieurs fichiers DOT en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Combinez DOT fichiers dans Java"
description: "Combinez DOT avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Combinez plusieurs fichiers DOT dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de combiner facilement plusieurs fichiers DOT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers DOT à l'aide de l'exemple de code Java">}}

        ```java    
        // Combinez les fichiers DOT à l'aide de GroupDocs.Merger pour l'API Java
