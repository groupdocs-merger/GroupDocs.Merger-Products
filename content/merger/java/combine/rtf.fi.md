...
############################# Head ############################
head_title: "Yhdistä RTF tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita RTF-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä RTF tiedostoa Java"
description: "Yhdistä RTF muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita RTF tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita RTF-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää RTF tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä RTF tiedostot GroupDocs.Merger for Java API:lla
