...
############################# Head ############################
head_title: "Объединение XLSX файлов с помощью Java и J2SE Documents Merger API"
head_description: "Объедините несколько файлов XLSX в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "Объединить XLSX на Java"
description: "Объедините XLSX с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Объединение нескольких XLSX файлов на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) позволяет разработчикам Java легко объединять несколько файлов XLSX, выполняя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы XLSX, используя пример кода Java">}}

        ```java    
        // Объедините XLSX файлов с помощью GroupDocs.Merger for Java API
