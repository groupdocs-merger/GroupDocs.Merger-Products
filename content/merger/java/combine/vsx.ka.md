...
############################# Head ############################
head_title: "შეუთავსეთ VSX ფაილები Java & J2SE Documents Merger API-ით"
head_description: "შეუთავსეთ მრავალი VSX ფაილი Java-ში დოკუმენტების შერწყმის API-ის გამოყენებით ყველა მონაცემით, სტილით და ფორმატით, როგორც წყარო დოკუმენტები."

############################# Header ############################
title: "შეუთავსეთ VSX ფაილები Java-ში"
description: "შეუთავსეთ VSX Java კოდის რამდენიმე სტრიქონთან."
...
steps:
    enable: true
    title_left: "შეუთავსეთ მრავალი VSX ფაილი Java-ში"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ გავაერთიანოთ VSX ფაილი Java-ის მაგალითის კოდის გამოყენებით">}}
        ...
        ```java    
        // შეუთავსეთ VSX ფაილი GroupDocs.Merger for Java API-ის გამოყენებით
