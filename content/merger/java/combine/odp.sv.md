...
############################# Head ############################
head_title: "Kombinera ODP filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera ODP-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera ODP filer i Java"
description: "Kombinera ODP med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera ODP-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera ODP-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ODP-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera ODP filer med GroupDocs.Merger för Java API
