...
############################# Head ############################
head_title: "Gabungkan XLSB Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail XLSB dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan XLSB Fail Dalam Java"
description: "Gabungkan XLSB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang XLSB Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail XLSB dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XLSB fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan XLSB fail menggunakan GroupDocs.Merger untuk Java API
