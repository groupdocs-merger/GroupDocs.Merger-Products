...
############################# Head ############################
head_title: "Pelên XLSM bi navgîniya Java & J2SE Documents Merger API-ê bihev bikin"
head_description: "Gelek pelên XLSM di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî daneyan, şêwaz û şeklê wekî belgeyên çavkaniyê re bikin yek."

############################# Header ############################
title: "Pelên XLSM Di Java de berhev bikin"
description: "XLSM bi çend rêzikên koda Java re bibin yek."
...
steps:
    enable: true
    title_left: "Gelek XLSM Pelên di Java de bi hev re bikin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve gelek pelên XLSM li hev bikin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên XLSM bi karanîna koda nimûneya Java berhev dike">}}

        ```java    
        // Pelên XLSM bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi kar bînin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) aniha ji yek pelê zêdetir XLSM hev bikin.
