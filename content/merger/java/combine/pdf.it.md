...
############################# Head ############################
head_title: "Unisci file PDF in Java"
head_description: "Utilizza GroupDocs.Merger for Java per aggiungere capacità di fusione di documenti PDF ai tuoi progetti Java."

############################# Header ############################
title: "Unisci file PDF" 
description: "Con GroupDocs.Merger for Java, puoi sviluppare applicazioni avanzate in Java che uniscono documenti PDF in modo efficace."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) fornisce capacità di fusione per documenti PDF. Migliora le tue applicazioni Java unendo più file in uno.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine specifiche da file di formati diversi"
      content: |
        Questo esempio dimostra come unire file PDF includendo pagine specifiche da documenti in altri formati.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
