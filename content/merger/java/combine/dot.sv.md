...
############################# Head ############################
head_title: "Kombinera DOT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera DOT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera DOT filer i Java"
description: "Kombinera DOT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera DOT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera DOT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar DOT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera DOT filer med GroupDocs.Merger för Java API
