...
############################# Head ############################
head_title: "Kombiner DOT filer via Java & J2SE Documents Merger API"
head_description: "Kombiner flere DOT-filer i Java ved å bruke Documents Merger API med all data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner DOT filer i Java"
description: "Kombiner DOT med noen få linjer med Java-kode."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/no/merger/java/) gir en praktisk løsning for å kombinere flere PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, bilder og mange andre dokumenter i én enkelt fil i Java-applikasjoner. GroupDocs.Merger vil spare deg for mye krefter, siden du har lov til å kombinere DOT dokumenter - det er ikke nødvendig å installere tredjepartsprogramvare, skrivebordsapplikasjoner eller plugins. Nå er det unødvendig å kaste bort tiden din og kombinere filer manuelt! GroupDocs oppgave er å gi den beste kvaliteten og forenkle dokumentbehandlingsarbeidsflyten.
...
steps:
    enable: true
    title_left: "Kombiner flere DOT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å kombinere flere DOT-filer ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan kombinere DOT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Kombiner DOT filer med GroupDocs.Merger for Java API
