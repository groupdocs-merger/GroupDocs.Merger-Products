...
############################# Head ############################
head_title: "जावा और J2SE दस्तावेज़ मर्जर API के माध्यम से VSSM फ़ाइलें संयोजित करें"
head_description: "स्रोत दस्तावेज़ के रूप में सभी डेटा, शैली और स्वरूपण के साथ दस्तावेज़ विलय API का उपयोग करके जावा में एकाधिक VSSM फ़ाइलों को संयोजित करें।"

############################# Header ############################
title: "VSSM फाइलों को Java में मिलाएं"
description: "VSSM को Java कोड की कुछ पंक्तियों के साथ मिलाएं।"
...
steps:
    enable: true
    title_left: "Java में अनेक VSSM फ़ाइलें संयोजित करें"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) जावा डेवलपर्स के लिए कुछ आसान चरणों को लागू करके कई VSSM फाइलों को जोड़ना आसान बनाता है।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके VSSM फ़ाइलों को कैसे संयोजित करें">}}

        ```java    
        // GroupDocs.Merger for Java API का उपयोग करके VSSM फ़ाइलें संयोजित करें
