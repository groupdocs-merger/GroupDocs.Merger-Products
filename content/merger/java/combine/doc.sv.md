...
############################# Head ############################
head_title: "Kombinera DOC filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera DOC-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera DOC filer i Java"
description: "Kombinera DOC med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera DOC-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera DOC-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar DOC-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera DOC filer med GroupDocs.Merger för Java API
