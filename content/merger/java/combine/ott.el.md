...
############################# Head ############################
head_title: "Συνδυάστε αρχεία OTT μέσω Java & J2SE Documents Merger API"
head_description: "Συνδυάστε πολλά αρχεία OTT σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Συνδυάστε OTT αρχεία σε Java"
description: "Συνδυάστε το OTT με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συνδυάστε πολλά OTT αρχεία στο Java"
    content_left: |
        Το [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συνδυάσουν πολλά αρχεία OTT εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδυάσετε αρχεία OTT χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συνδυάστε OTT αρχεία χρησιμοποιώντας το GroupDocs.Merger for Java API
