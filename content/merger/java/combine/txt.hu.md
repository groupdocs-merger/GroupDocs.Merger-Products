...
############################# Head ############################
head_title: "Kombinálja az TXT fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több TXT fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "TXT fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) TXT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több TXT fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több TXT fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk TXT fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az TXT fájlokat a GroupDocs.Merger for Java API segítségével
...
demos:
    ...
    content: |
       Egynél több TXT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
