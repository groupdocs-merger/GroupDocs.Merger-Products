...
head_description: "Kombiner flere ONE filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner ONE filer i Java"
description: "Kombiner ONE med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere ONE-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer ONE filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner ONE filer ved hjælp af GroupDocs.Merger for Java API
