...
############################# Head ############################
head_title: "Kombinirajte EPUB datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Kombinirajte više EPUB datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Kombinirajte EPUB datoteka u Java"
description: "Kombinirajte EPUB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Kombinirajte više EPUB datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima kombiniranje više EPUB datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati EPUB datoteke koristeći Java primjer koda">}}

        ```java    
        // Kombinirajte EPUB datoteke koristeći GroupDocs.Merger za Java API
