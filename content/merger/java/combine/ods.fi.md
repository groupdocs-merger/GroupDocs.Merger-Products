...
############################# Head ############################
head_title: "Yhdistä ODS tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita ODS-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä ODS tiedostoa Java"
description: "Yhdistä ODS muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita ODS tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita ODS-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ODS tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä ODS tiedostot GroupDocs.Merger for Java API:lla
