...
############################# Head ############################
head_title: "Kombinálja az OTP fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több OTP fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "OTP fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) OTP elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több OTP fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több OTP fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk OTP fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az OTP fájlokat a GroupDocs.Merger for Java API segítségével
