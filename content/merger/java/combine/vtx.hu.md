...
############################# Head ############################
head_title: "Kombinálja az VTX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több VTX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VTX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) VTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VTX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VTX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VTX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az VTX fájlokat a GroupDocs.Merger for Java API segítségével
