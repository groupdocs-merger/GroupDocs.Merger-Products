...
############################# Head ############################
head_title: "XLAM файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
...
############################# Header ############################
title: "XLAM файлды Java ішінде біріктіру"
description: "XLAM Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше XLAM файлды біріктіру"
    content_left: |
