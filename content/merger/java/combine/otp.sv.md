...
############################# Head ############################
head_title: "Kombinera OTP filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera OTP-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera OTP filer i Java"
description: "Kombinera OTP med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera OTP-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera OTP-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar OTP-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera OTP filer med GroupDocs.Merger för Java API
