...
############################# Head ############################
head_title: "Yhdistä MHT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita MHT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä MHT tiedostoa Java"
description: "Yhdistä MHT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita MHT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita MHT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää MHT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä MHT tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi MHT tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
