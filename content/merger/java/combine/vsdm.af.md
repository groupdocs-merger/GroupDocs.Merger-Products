...
############################# Head ############################
head_title: "Kombineer VSDM lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige VSDM-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer VSDM lêers in Java"
description: "Kombineer VSDM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige VSDM-lêers in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige VSDM-lêers te kombineer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer VSDM lêers deur GroupDocs.Merger vir Java API te gebruik
