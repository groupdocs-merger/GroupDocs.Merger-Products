...
############################# Head ############################
head_title: "Yhdistä TSV tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita TSV-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä TSV tiedostoa Java"
description: "Yhdistä TSV muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita TSV tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita TSV-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää TSV tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä TSV tiedostot GroupDocs.Merger for Java API:lla
