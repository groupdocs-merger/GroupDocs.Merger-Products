...
############################# Head ############################
head_title: "Combinez PPT fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Combinez plusieurs fichiers PPT en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "Combinez PPT fichiers dans Java"
description: "Combinez PPT avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Combinez plusieurs fichiers PPT dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de combiner facilement plusieurs fichiers PPT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers PPT à l'aide de l'exemple de code Java">}}

        ```java    
        // Combinez les fichiers PPT à l'aide de GroupDocs.Merger pour l'API Java
