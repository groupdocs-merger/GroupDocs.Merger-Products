...
############################# Head ############################
head_title: "Kombineerige VSDM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSDM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSDM faili Java"
description: "Kombineerige VSDM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSDM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSDM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSDM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSDM, kasutades GroupDocs.Merger for Java API-t
