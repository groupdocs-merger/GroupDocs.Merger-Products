...
############################# Head ############################
head_title: "Kombinálja az XLS fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több XLS fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLS fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) XLS elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLS fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLS fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLS fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az XLS fájlokat a GroupDocs.Merger for Java API segítségével
