...
############################# Head ############################
head_title: "Kombineerige VSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu VSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri VSX faili Java"
description: "Kombineerige VSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu VSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme VSX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid VSX, kasutades GroupDocs.Merger for Java API-t
