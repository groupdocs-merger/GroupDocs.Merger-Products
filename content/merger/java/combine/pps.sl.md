...
############################# Head ############################
head_title: "Združite PPS datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PPS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PPS datotek v Java"
description: "Kombinirajte PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PPS z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPS s primerom kode Java">}}

        ```java    
        // Združite datoteke PPS z API-jem GroupDocs.Merger for Java
