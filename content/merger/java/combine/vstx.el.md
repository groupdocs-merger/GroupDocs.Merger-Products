...
############################# Head ############################
head_title: "Συνδυάστε αρχεία VSTX μέσω Java & J2SE Documents Merger API"
head_description: "Συνδυάστε πολλά αρχεία VSTX σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Συνδυάστε VSTX αρχεία σε Java"
description: "Συνδυάστε το VSTX με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συνδυάστε πολλά VSTX αρχεία στο Java"
    content_left: |
        Το [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συνδυάσουν πολλά αρχεία VSTX εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδυάσετε αρχεία VSTX χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συνδυάστε VSTX αρχεία χρησιμοποιώντας το GroupDocs.Merger for Java API
