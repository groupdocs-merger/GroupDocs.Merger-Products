...
############################# Head ############################
head_title: "Yhdistä PNG tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PNG-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä PNG tiedostoa Java"
description: "Yhdistä PNG muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PNG tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita PNG-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PNG tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PNG tiedostot GroupDocs.Merger for Java API:lla
