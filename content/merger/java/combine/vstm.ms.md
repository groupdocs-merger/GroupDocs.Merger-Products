...
############################# Head ############################
head_title: "Gabungkan VSTM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail VSTM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan VSTM Fail Dalam Java"
description: "Gabungkan VSTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang VSTM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail VSTM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan VSTM fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan VSTM fail menggunakan GroupDocs.Merger untuk Java API
