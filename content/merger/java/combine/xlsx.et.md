...
############################# Head ############################
head_title: "Kombineerige XLSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLSX faili Java"
description: "Kombineerige XLSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLSX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLSX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLSX, kasutades GroupDocs.Merger for Java API-t
