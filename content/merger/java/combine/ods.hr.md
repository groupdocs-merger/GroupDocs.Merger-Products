...
############################# Head ############################
head_title: "Kombinirajte ODS datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Kombinirajte više ODS datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Kombinirajte ODS datoteka u Java"
description: "Kombinirajte ODS s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Kombinirajte više ODS datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima kombiniranje više ODS datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati ODS datoteke koristeći Java primjer koda">}}

        ```java    
        // Kombinirajte ODS datoteke koristeći GroupDocs.Merger za Java API
