...
############################# Head ############################
head_title: "Комбинирайте JPG файлове чрез Java & J2SE Documents Merger API"
head_description: "Комбинирайте множество JPG файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "Комбинирайте JPG файлове в Java"
description: "Комбинирайте JPG с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Комбинирайте множество JPG файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да комбинират множество JPG файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате JPG файлове с помощта на Java примерен код">}}

        ```java    
        // Комбинирайте JPG файлове с помощта на GroupDocs.Merger за Java API
