...
############################# Head ############################
head_title: "Združite PNG datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PNG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PNG datotek v Java"
description: "Kombinirajte PNG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PNG v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PNG z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PNG s primerom kode Java">}}

        ```java    
        // Združite datoteke PNG z API-jem GroupDocs.Merger for Java
