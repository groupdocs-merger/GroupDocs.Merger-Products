...
############################# Head ############################
head_title: "Kombinera JPEG filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera JPEG-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera JPEG filer i Java"
description: "Kombinera JPEG med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera JPEG-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera JPEG-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar JPEG-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera JPEG filer med GroupDocs.Merger för Java API
