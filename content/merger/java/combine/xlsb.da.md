...
head_description: "Kombiner flere XLSB filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner XLSB filer i Java"
description: "Kombiner XLSB med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere XLSB-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer XLSB filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner XLSB filer ved hjælp af GroupDocs.Merger for Java API
