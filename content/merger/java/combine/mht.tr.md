...
############################# Head ############################
head_title: "MHT Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok MHT dosyasını Java'da birleştirin."

############################# Header ############################
title: "MHT Dosyalarını Java İçinde Birleştirin"
...
steps:
    enable: true
    title_left: "Birden Çok MHT Dosyasını Java İçinde Birleştirin"
    content_left: |
