...
############################# Head ############################
head_title: "Združite DOC datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek DOC v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi DOC datotek v Java"
description: "Kombinirajte DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek DOC v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek DOC z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOC s primerom kode Java">}}

        ```java    
        // Združite datoteke DOC z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno DOC datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
