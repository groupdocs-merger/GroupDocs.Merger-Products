...
############################# Head ############################
head_title: "Gabungkan XLSM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail XLSM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan XLSM Fail Dalam Java"
description: "Gabungkan XLSM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang XLSM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail XLSM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XLSM fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan XLSM fail menggunakan GroupDocs.Merger untuk Java API
