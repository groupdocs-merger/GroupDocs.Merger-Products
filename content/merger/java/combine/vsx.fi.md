...
############################# Head ############################
head_title: "Yhdistä VSX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSX tiedostoa Java"
description: "Yhdistä VSX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSX tiedostot GroupDocs.Merger for Java API:lla
