...
############################# Head ############################
head_title: "Yhdistä XLSB tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLSB-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XLSB tiedostoa Java"
description: "Yhdistä XLSB muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLSB tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLSB-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLSB tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLSB tiedostot GroupDocs.Merger for Java API:lla
