...
############################# Head ############################
head_title: "Kombinujte soubory OTP prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů OTP v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat OTP soubory v Java"
description: "Zkombinujte OTP s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů OTP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů OTP pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory OTP pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory OTP pomocí GroupDocs.Merger for Java API
