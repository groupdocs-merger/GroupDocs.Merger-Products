...
############################# Head ############################
head_title: "Kombinera PPS filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera PPS-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera PPS filer i Java"
description: "Kombinera PPS med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera PPS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera PPS-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PPS-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera PPS filer med GroupDocs.Merger för Java API
