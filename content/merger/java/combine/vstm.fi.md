...
############################# Head ############################
head_title: "Yhdistä VSTM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSTM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSTM tiedostoa Java"
description: "Yhdistä VSTM muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSTM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSTM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSTM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSTM tiedostot GroupDocs.Merger for Java API:lla
