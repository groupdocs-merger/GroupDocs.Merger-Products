...
############################# Head ############################
head_title: "Yhdistä OTP tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita OTP-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä OTP tiedostoa Java"
description: "Yhdistä OTP muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita OTP tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita OTP-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää OTP tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä OTP tiedostot GroupDocs.Merger for Java API:lla
