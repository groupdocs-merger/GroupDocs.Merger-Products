...
############################# Head ############################
head_title: "Combina fitxers MHTML mitjançant l'API de fusió de documents Java i J2SE"
head_description: "Combineu diversos fitxers MHTML a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "Combina MHTML fitxers a Java"
description: "Combina MHTML amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers MHTML a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java combinar diversos fitxers MHTML implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers MHTML utilitzant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers MHTML mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    ...
    content: |
       Combineu més d'un fitxer MHTML ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
