...
############################# Head ############################
head_title: "Kombinera XLTX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLTX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLTX filer i Java"
description: "Kombinera XLTX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLTX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLTX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLTX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLTX filer med GroupDocs.Merger för Java API
