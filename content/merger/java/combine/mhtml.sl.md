...
############################# Head ############################
head_title: "Združite MHTML datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek MHTML v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi MHTML datotek v Java"
description: "Kombinirajte MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek MHTML z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke MHTML s primerom kode Java">}}

        ```java    
        // Združite datoteke MHTML z API-jem GroupDocs.Merger for Java
