...
############################# Head ############################
head_title: "Združite MHT datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek MHT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi MHT datotek v Java"
description: "Kombinirajte MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek MHT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek MHT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke MHT s primerom kode Java">}}

        ```java    
        // Združite datoteke MHT z API-jem GroupDocs.Merger for Java
