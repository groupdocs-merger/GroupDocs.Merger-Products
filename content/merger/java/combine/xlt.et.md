...
############################# Head ############################
head_title: "Kombineerige XLT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLT faili Java"
description: "Kombineerige XLT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLT, kasutades GroupDocs.Merger for Java API-t
