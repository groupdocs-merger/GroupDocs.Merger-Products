...
############################# Head ############################
head_title: "Sameina PPS skrár í gegnum Java & J2SE Documents Merger API"
head_description: "Sameina margar PPS skrár í Java með því að nota skjalasamruna API með öllum gögnum, stíl og sniði sem upprunaskjöl."

############################# Header ############################
title: "Sameina PPS skrár í Java"
description: "Sameina PPS með nokkrum línum af Java kóða."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/is/merger/java/) býður upp á þægilega lausn til að sameina margar PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, myndir og mörg önnur skjöl í einni skrá innan Java forrita. GroupDocs.Merger mun spara þér mikla fyrirhöfn, þar sem þú hefur leyfi til að sameina PPS skjöl - það er engin þörf á að setja upp hugbúnað frá þriðja aðila, skjáborðsforrit eða viðbætur. Nú er óþarfi að eyða tíma þínum og sameina skrár handvirkt! Hlutverk GroupDocs er að veita bestu gæði og einfalda verkflæði skjalavinnslu.
...
steps:
    enable: true
    title_left: "Sameina margar PPS skrár í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að sameina margar PPS skrár með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að sameina PPS skrár með því að nota Java dæmi kóða">}}

        ```java    
        // Sameina PPS skrár með GroupDocs.Merger fyrir Java API
