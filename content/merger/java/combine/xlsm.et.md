...
############################# Head ############################
head_title: "Kombineerige XLSM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLSM faili Java"
description: "Kombineerige XLSM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLSM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLSM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLSM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLSM, kasutades GroupDocs.Merger for Java API-t
