...
############################# Head ############################
head_title: "Kombinera ODS filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera ODS-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera ODS filer i Java"
description: "Kombinera ODS med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera ODS-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera ODS-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ODS-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera ODS filer med GroupDocs.Merger för Java API
