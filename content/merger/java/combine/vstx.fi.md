...
############################# Head ############################
head_title: "Yhdistä VSTX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSTX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSTX tiedostoa Java"
description: "Yhdistä VSTX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSTX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSTX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSTX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSTX tiedostot GroupDocs.Merger for Java API:lla
