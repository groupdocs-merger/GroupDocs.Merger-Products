...
############################# Head ############################
head_title: "Kombineerige XLAM failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu XLAM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri XLAM faili Java"
description: "Kombineerige XLAM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu XLAM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme XLAM faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLAM faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid XLAM, kasutades GroupDocs.Merger for Java API-t
