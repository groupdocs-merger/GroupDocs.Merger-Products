...
############################# Head ############################
head_title: "EPUB Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok EPUB dosyasını Java'da birleştirin."

############################# Header ############################
title: "EPUB Dosyalarını Java İçinde Birleştirin"
...
steps:
    enable: true
    title_left: "Birden Çok EPUB Dosyasını Java İçinde Birleştirin"
    content_left: |
