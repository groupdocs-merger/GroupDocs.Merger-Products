...
############################# Head ############################
head_title: "Združite JPEG datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek JPEG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi JPEG datotek v Java"
description: "Kombinirajte JPEG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek JPEG v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek JPEG z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPEG s primerom kode Java">}}

        ```java    
        // Združite datoteke JPEG z API-jem GroupDocs.Merger for Java
