...
############################# Head ############################
head_title: "Kombineerige PNG failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PNG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PNG faili Java"
description: "Kombineerige PNG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PNG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PNG faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PNG faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PNG, kasutades GroupDocs.Merger for Java API-t
