...
############################# Head ############################
head_title: "BMP Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok BMP dosyasını Java'da birleştirin."

############################# Header ############################
title: "BMP Dosyalarını Java İçinde Birleştirin"
...
steps:
    enable: true
    title_left: "Birden Çok BMP Dosyasını Java İçinde Birleştirin"
    content_left: |
