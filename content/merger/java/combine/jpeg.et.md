...
############################# Head ############################
head_title: "Kombineerige JPEG failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu JPEG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri JPEG faili Java"
description: "Kombineerige JPEG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu JPEG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme JPEG faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida JPEG faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid JPEG, kasutades GroupDocs.Merger for Java API-t
