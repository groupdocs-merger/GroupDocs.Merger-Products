...
############################# Head ############################
head_title: "Kombinera VSDM filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSDM-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSDM filer i Java"
description: "Kombinera VSDM med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSDM-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSDM-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSDM-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSDM filer med GroupDocs.Merger för Java API
