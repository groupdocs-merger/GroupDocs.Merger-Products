...
############################# Head ############################
head_title: "Gabungkan DOC Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail DOC dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan DOC Fail Dalam Java"
description: "Gabungkan DOC dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang DOC Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail DOC dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan DOC fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan DOC fail menggunakan GroupDocs.Merger untuk Java API
