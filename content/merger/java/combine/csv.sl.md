...
############################# Head ############################
head_title: "Združite CSV datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek CSV v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi CSV datotek v Java"
description: "Kombinirajte CSV z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek CSV v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek CSV z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke CSV s primerom kode Java">}}

        ```java    
        // Združite datoteke CSV z API-jem GroupDocs.Merger for Java
