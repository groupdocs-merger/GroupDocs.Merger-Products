...
############################# Head ############################
head_title: "DOC файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
head_description: "Java тіліндегі бірнеше DOC файлдарды бастапқы құжаттар ретінде барлық деректермен, стильмен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "DOC файлды Java ішінде біріктіру"
description: "DOC Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше DOC файлды біріктіру"
    content_left: |
