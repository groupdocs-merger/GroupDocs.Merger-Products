...
############################# Head ############################
head_title: "Yhdistä DOTM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita DOTM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä DOTM tiedostoa Java"
description: "Yhdistä DOTM muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita DOTM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita DOTM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOTM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä DOTM tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOTM tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
