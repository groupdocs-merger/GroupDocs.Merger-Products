...
############################# Head ############################
head_title: "Gabungkan DOTM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail DOTM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan DOTM Fail Dalam Java"
description: "Gabungkan DOTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang DOTM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail DOTM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan DOTM fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan DOTM fail menggunakan GroupDocs.Merger untuk Java API
