...
############################# Head ############################
head_title: "Gabungkan BMP Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail BMP dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan BMP Fail Dalam Java"
description: "Gabungkan BMP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang BMP Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail BMP dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan BMP fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan BMP fail menggunakan GroupDocs.Merger untuk Java API
