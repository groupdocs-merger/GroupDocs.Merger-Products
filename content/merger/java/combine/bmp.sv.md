...
############################# Head ############################
head_title: "Kombinera BMP filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera BMP-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera BMP filer i Java"
description: "Kombinera BMP med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera BMP-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera BMP-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar BMP-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera BMP filer med GroupDocs.Merger för Java API
