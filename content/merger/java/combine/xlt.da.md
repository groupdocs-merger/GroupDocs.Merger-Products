...
head_description: "Kombiner flere XLT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner XLT filer i Java"
description: "Kombiner XLT med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere XLT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer XLT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner XLT filer ved hjælp af GroupDocs.Merger for Java API
