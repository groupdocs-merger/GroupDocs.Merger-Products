...
############################# Head ############################
head_title: "Združite OTP datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek OTP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi OTP datotek v Java"
description: "Kombinirajte OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek OTP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek OTP z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTP s primerom kode Java">}}

        ```java    
        // Združite datoteke OTP z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno OTP datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
