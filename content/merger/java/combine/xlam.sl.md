...
############################# Head ############################
head_title: "Združite XLAM datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek XLAM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi XLAM datotek v Java"
description: "Kombinirajte XLAM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLAM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek XLAM z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLAM s primerom kode Java">}}

        ```java    
        // Združite datoteke XLAM z API-jem GroupDocs.Merger for Java
