...
############################# Head ############################
head_title: "Kombinálja az JPEG fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több JPEG fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "JPEG fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) JPEG elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több JPEG fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több JPEG fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk JPEG fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az JPEG fájlokat a GroupDocs.Merger for Java API segítségével
