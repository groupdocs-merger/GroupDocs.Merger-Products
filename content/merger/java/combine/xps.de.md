...
############################# Head ############################
head_title: "XPS-Dateien in Java kombinieren"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um die Funktionen zum Zusammenführen von XPS-Dokumenten in Ihren Java-Projekten hinzuzufügen."

############################# Header ############################
title: "XPS-Dateien kombinieren" 
description: "Mit GroupDocs.Merger for Java können Sie fortschrittliche Java-Anwendungen entwickeln, die XPS-Dokumenten problemlos zusammenführen."
...
steps:
    enable: true
    title: "Wie man XPS-Dokumenten zusammenführt"
    content: |
      [GroupDocs.Merger](/merger/java/) bietet Funktionen zum Zusammenführen von XPS-Dokumenten. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien in eine kombinieren.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingang XPS-Dokument initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus Dateien verschiedener Formate zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man XPS-Dateien zusammenführt und dabei spezifische Seiten aus Dokumenten in anderen Formaten einbezieht.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
