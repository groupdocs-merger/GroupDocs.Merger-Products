...
############################# Head ############################
head_title: "Kombinálja az PPSX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több PPSX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPSX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) PPSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPSX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPSX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPSX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az PPSX fájlokat a GroupDocs.Merger for Java API segítségével
