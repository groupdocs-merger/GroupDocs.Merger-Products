...
############################# Head ############################
head_title: "Sujunkite DOTM failus naudodami Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Sujungti DOTM failus Java"
description: "Sujunkite DOTM su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis DOTM failus Java"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną DOTM failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
