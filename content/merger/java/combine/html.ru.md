...
############################# Head ############################
head_title: "Объедините файлы HTML в Java"
head_description: "Используйте GroupDocs.Merger for Java, чтобы добавить возможности слияния документов HTML в ваши проекты на Java."

############################# Header ############################
title: "Объединение файлов HTML" 
description: "С помощью GroupDocs.Merger for Java вы можете разрабатывать сложные приложения на Java, которые объединяют документы HTML."
subtitle: "" 
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) предоставляет возможности слияния для документов HTML. Улучшите свои приложения на Java, объединив несколько файлов в один.
      
      1. Укажите путь к первому файлу HTML.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Инициализируйте Merger с входным документом HTML
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение определенных страниц из файлов разных форматов"
      content: |
        Этот пример демонстрирует, как объединить файлы HTML, включая определенные страницы из документов других форматов.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
