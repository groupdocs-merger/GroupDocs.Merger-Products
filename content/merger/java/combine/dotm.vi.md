...
############################# Head ############################
head_title: "Kết hợp các tệp DOTM thông qua API hợp nhất tài liệu Java & J2SE"
head_description: "Kết hợp nhiều tệp DOTM trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "Kết hợp DOTM Tệp trong Java"
description: "Kết hợp DOTM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Kết hợp Nhiều DOTM Tệp trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách kết hợp các tệp DOTM bằng mã mẫu Java">}}

        ```java    
        // Kết hợp các tệp DOTM bằng GroupDocs.Merger cho Java API
