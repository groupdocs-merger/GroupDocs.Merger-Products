...
############################# Head ############################
head_title: "Kombinujte soubory ODS prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů ODS v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat ODS soubory v Java"
description: "Zkombinujte ODS s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů ODS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů ODS pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory ODS pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory ODS pomocí GroupDocs.Merger for Java API
