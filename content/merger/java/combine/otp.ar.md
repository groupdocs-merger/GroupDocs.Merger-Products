...
############################# Head ############################
head_title: "ادمج OTP الملفات عبر Java & J2SE Documents Merger API"
head_description: "ادمج عدة ملفات OTP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "دمج ملفات OTP في Java"
description: "ادمج OTP مع بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "دمج عدة ملفات OTP في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري جافا دمج عدة ملفات OTP من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات OTP باستخدام كود مثال Java">}}

        ```java    
        // دمج ملفات OTP باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
...
demos:
    ...
    content: |
       اجمع بين أكثر من ملف OTP واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
