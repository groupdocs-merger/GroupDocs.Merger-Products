...
############################# Head ############################
head_title: "Kombineer ONE lêers via Java & J2SE Documents Merger API"
head_description: "Kombineer veelvuldige ONE-lêers in Java deur gebruik te maak van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "Kombineer ONE lêers in Java"
description: "Kombineer ONE met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Kombineer veelvuldige ONE-lêers in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ONE lêers te kombineer deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Kombineer ONE lêers deur GroupDocs.Merger vir Java API te gebruik
