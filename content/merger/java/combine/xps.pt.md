...
############################# Head ############################
head_title: "Combinar arquivos XPS no Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de mesclagem de documentos XPS aos seus projetos Java."

############################# Header ############################
title: "Combinar arquivos XPS" 
description: "Com GroupDocs.Merger for Java, você pode desenvolver aplicações avançadas em Java que mesclam documentos XPS de forma eficaz."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece capacidades de mesclagem para documentos XPS. Aprimore suas aplicações Java mesclando vários arquivos em um só.
      
      1. Especifique o caminho para o primeiro arquivo XPS.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicialize Merger com o documento XPS de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas específicas de arquivos de diferentes formatos"
      content: |
        Este exemplo demonstra como mesclar arquivos XPS incluindo páginas específicas de documentos em outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
