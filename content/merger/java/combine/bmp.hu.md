...
############################# Head ############################
head_title: "Kombinálja az BMP fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több BMP fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "BMP fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) BMP elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több BMP fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több BMP fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk BMP fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az BMP fájlokat a GroupDocs.Merger for Java API segítségével
