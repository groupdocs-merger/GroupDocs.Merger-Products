...
############################# Head ############################
head_title: "Gabungkan PPSX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail PPSX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan PPSX Fail Dalam Java"
description: "Gabungkan PPSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang PPSX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail PPSX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan PPSX fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan PPSX fail menggunakan GroupDocs.Merger untuk Java API
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu PPSX fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
