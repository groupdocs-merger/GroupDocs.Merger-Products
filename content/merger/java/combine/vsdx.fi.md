...
############################# Head ############################
head_title: "Yhdistä VSDX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSDX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSDX tiedostoa Java"
description: "Yhdistä VSDX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSDX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSDX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSDX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSDX tiedostot GroupDocs.Merger for Java API:lla
