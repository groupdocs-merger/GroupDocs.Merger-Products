...
############################# Head ############################
head_title: "Kombinieren Sie DOTX-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere DOTX-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie DOTX-Dateien in Java"
description: "Kombinieren Sie DOTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere DOTX-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOTX-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie DOTX-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie DOTX-Dateien mit GroupDocs.Merger for Java API
