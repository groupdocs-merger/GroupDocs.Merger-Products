...
############################# Head ############################
head_title: "Združite VSTX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VSTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VSTX datotek v Java"
description: "Kombinirajte VSTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VSTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSTX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSTX s primerom kode Java">}}

        ```java    
        // Združite datoteke VSTX z API-jem GroupDocs.Merger for Java
