...
############################# Head ############################
head_title: "XPS Dosyalarını Java ve J2SE Documents Merger API ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veri, stil ve biçimlendirmeyle birlikte belge birleştirme API'sini kullanarak birden çok XPS dosyasını Java'da birleştirin."

############################# Header ############################
title: "XPS Dosyalarını Java İçinde Birleştirin"
description: "XPS kodunu birkaç satır Java koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XPS Dosyasını Java İçinde Birleştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok XPS dosyasını birleştirmesini kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XPS dosyaları nasıl birleştirilir">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XPS dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla XPS dosyayı birleştirin.
