...
############################# Head ############################
head_title: "Gabungkan XPS Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail XPS dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan XPS Fail Dalam Java"
description: "Gabungkan XPS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang XPS Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail XPS dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XPS fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan XPS fail menggunakan GroupDocs.Merger untuk Java API
