...
############################# Head ############################
head_title: "Yhdistä VTX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VTX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VTX tiedostoa Java"
description: "Yhdistä VTX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VTX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VTX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VTX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VTX tiedostot GroupDocs.Merger for Java API:lla
