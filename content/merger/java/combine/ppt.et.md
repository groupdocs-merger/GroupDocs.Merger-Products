...
############################# Head ############################
head_title: "Kombineerige PPT failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PPT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PPT faili Java"
description: "Kombineerige PPT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PPT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PPT faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPT faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PPT, kasutades GroupDocs.Merger for Java API-t
