...
############################# Head ############################
head_title: "Združite ODP datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek ODP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi ODP datotek v Java"
description: "Kombinirajte ODP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek ODP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek ODP z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODP s primerom kode Java">}}

        ```java    
        // Združite datoteke ODP z API-jem GroupDocs.Merger for Java
