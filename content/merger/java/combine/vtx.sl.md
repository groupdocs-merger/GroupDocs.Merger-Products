...
############################# Head ############################
head_title: "Združite VTX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek VTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi VTX datotek v Java"
description: "Kombinirajte VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek VTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VTX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VTX s primerom kode Java">}}

        ```java    
        // Združite datoteke VTX z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Takoj združite več kot eno VTX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
