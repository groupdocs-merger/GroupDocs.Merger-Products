...
############################# Head ############################
head_title: "Yhdistä JPEG tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita JPEG-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä JPEG tiedostoa Java"
description: "Yhdistä JPEG muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita JPEG tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita JPEG-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää JPEG tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä JPEG tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi JPEG tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
