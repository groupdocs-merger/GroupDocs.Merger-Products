...
############################# Head ############################
head_title: "Združite TEX datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek TEX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi TEX datotek v Java"
description: "Kombinirajte TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek TEX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek TEX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TEX s primerom kode Java">}}

        ```java    
        // Združite datoteke TEX z API-jem GroupDocs.Merger for Java
