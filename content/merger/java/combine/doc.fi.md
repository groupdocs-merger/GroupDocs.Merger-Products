...
############################# Head ############################
head_title: "Yhdistä DOC tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita DOC-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä DOC tiedostoa Java"
description: "Yhdistä DOC muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita DOC tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita DOC-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOC tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä DOC tiedostot GroupDocs.Merger for Java API:lla
