...
############################# Head ############################
head_title: "Yhdistä DOT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita DOT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä DOT tiedostoa Java"
description: "Yhdistä DOT muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita DOT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita DOT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä DOT tiedostot GroupDocs.Merger for Java API:lla
