...
############################# Head ############################
head_title: "Kombineerige DOC failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu DOC-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri DOC faili Java"
description: "Kombineerige DOC mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu DOC faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme DOC faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOC faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid DOC, kasutades GroupDocs.Merger for Java API-t
