...
############################# Head ############################
head_title: "Kombinujte soubory VSDM prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů VSDM v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat VSDM soubory v Java"
description: "Zkombinujte VSDM s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů VSDM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů VSDM pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory VSDM pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory VSDM pomocí GroupDocs.Merger for Java API
