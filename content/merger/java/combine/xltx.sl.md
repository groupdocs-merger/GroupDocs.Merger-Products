...
############################# Head ############################
head_title: "Združite XLTX datoteke prek Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "Združi XLTX datotek v Java"
description: "Kombinirajte XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek XLTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLTX s primerom kode Java">}}
        ...
        ```java    
        // Združite datoteke XLTX z API-jem GroupDocs.Merger for Java
