...
############################# Head ############################
head_title: "Kombinálja az DOTM fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több DOTM fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOTM fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) DOTM elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOTM fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOTM fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk DOTM fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az DOTM fájlokat a GroupDocs.Merger for Java API segítségével
