...
############################# Head ############################
head_title: "Kombinera VSSX filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera VSSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera VSSX filer i Java"
description: "Kombinera VSSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera VSSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera VSSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSSX-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera VSSX filer med GroupDocs.Merger för Java API
