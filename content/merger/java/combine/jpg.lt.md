...
############################# Head ############################
head_title: "Sujunkite JPG failus naudodami Java & J2SE Documents Merger API"
head_description: "Sujunkite kelis JPG failus Java naudodami dokumentų sujungimo API su visais duomenimis, stiliumi ir formatavimu kaip šaltinio dokumentais."

############################# Header ############################
title: "Sujungti JPG failus Java"
description: "Sujunkite JPG su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis JPG failus Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai sujungti kelis JPG failus, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti JPG failus naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sujunkite JPG failus naudodami GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną JPG failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
