...
############################# Head ############################
head_title: "Yhdistä XPS tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XPS-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä XPS tiedostoa Java"
description: "Yhdistä XPS muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XPS tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XPS-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XPS tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XPS tiedostot GroupDocs.Merger for Java API:lla
