...
############################# Head ############################
head_title: "Kombineerige BMP failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu BMP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri BMP faili Java"
description: "Kombineerige BMP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu BMP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme BMP faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida BMP faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid BMP, kasutades GroupDocs.Merger for Java API-t
