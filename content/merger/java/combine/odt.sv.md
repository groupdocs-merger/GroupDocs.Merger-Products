...
############################# Head ############################
head_title: "Kombinera ODT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera ODT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera ODT filer i Java"
description: "Kombinera ODT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera ODT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera ODT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ODT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera ODT filer med GroupDocs.Merger för Java API
