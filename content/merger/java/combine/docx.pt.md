...
############################# Head ############################
head_title: "Combinar arquivos DOCX no Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de mesclagem de documentos DOCX aos seus projetos Java."

############################# Header ############################
title: "Combinar arquivos DOCX" 
description: "Com GroupDocs.Merger for Java, você pode desenvolver aplicações avançadas em Java que mesclam documentos DOCX de forma eficaz."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece capacidades de mesclagem para documentos DOCX. Aprimore suas aplicações Java mesclando vários arquivos em um só.
      
      1. Especifique o caminho para o primeiro arquivo DOCX.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicialize Merger com o documento DOCX de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas específicas de arquivos de diferentes formatos"
      content: |
        Este exemplo demonstra como mesclar arquivos DOCX incluindo páginas específicas de documentos em outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
