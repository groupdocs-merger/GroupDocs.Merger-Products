...
############################# Head ############################
head_title: "Gabungkan VSDM Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail VSDM dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan VSDM Fail Dalam Java"
description: "Gabungkan VSDM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang VSDM Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail VSDM dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan VSDM fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan VSDM fail menggunakan GroupDocs.Merger untuk Java API
