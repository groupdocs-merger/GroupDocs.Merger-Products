...
############################# Head ############################
head_title: "Kombinera XLSB filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera XLSB-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera XLSB filer i Java"
description: "Kombinera XLSB med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera XLSB-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera XLSB-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLSB-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera XLSB filer med GroupDocs.Merger för Java API
