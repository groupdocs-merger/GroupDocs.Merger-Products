...
head_description: "Kombiner flere XLAM filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner XLAM filer i Java"
description: "Kombiner XLAM med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere XLAM-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer XLAM filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner XLAM filer ved hjælp af GroupDocs.Merger for Java API
