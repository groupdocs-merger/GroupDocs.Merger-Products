...
############################# Head ############################
head_title: "Yhdistä VSSX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita VSSX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa on kaikki tiedot, tyylit ja muotoilut lähdeasiakirjoina."

############################# Header ############################
title: "Yhdistä VSSX tiedostoa Java"
description: "Yhdistä VSSX muutamaan riviin Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita VSSX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita VSSX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSSX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä VSSX tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VSSX tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
