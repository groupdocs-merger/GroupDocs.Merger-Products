...
############################# Head ############################
head_title: "Združite PDF datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek PDF v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi PDF datotek v Java"
description: "Kombinirajte PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek PDF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek PDF z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PDF s primerom kode Java">}}

        ```java    
        // Združite datoteke PDF z API-jem GroupDocs.Merger for Java
