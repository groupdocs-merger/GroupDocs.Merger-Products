...
############################# Head ############################
head_title: "Kombinera MHT filer via Java & J2SE Documents Merger API"
head_description: "Kombinera flera MHT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "Kombinera MHT filer i Java"
description: "Kombinera MHT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Kombinera flera MHT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att kombinera flera MHT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar MHT-filer med hjälp av Java exempelkod">}}

        ```java    
        // Kombinera MHT filer med GroupDocs.Merger för Java API
