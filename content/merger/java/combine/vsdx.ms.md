...
############################# Head ############################
head_title: "Gabungkan VSDX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail VSDX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "Gabungkan VSDX Fail Dalam Java"
description: "Gabungkan VSDX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang VSDX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail VSDX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan VSDX fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan VSDX fail menggunakan GroupDocs.Merger untuk Java API
