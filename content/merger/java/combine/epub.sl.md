...
############################# Head ############################
head_title: "Združite EPUB datoteke prek Java & J2SE Documents Merger API"
head_description: "Združite več datotek EPUB v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "Združi EPUB datotek v Java"
description: "Kombinirajte EPUB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Združite več datotek EPUB v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke EPUB s primerom kode Java">}}
        ...
        ```java    
        // Združite datoteke EPUB z API-jem GroupDocs.Merger for Java
