...
############################# Head ############################
head_title: "Kombinálja az RTF fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több RTF fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "RTF fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) RTF elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több RTF fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több RTF fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk RTF fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az RTF fájlokat a GroupDocs.Merger for Java API segítségével
