...
############################# Head ############################
head_title: "Kombinirajte JPEG datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Kombinirajte više JPEG datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "Kombinirajte JPEG datoteka u Java"
description: "Kombinirajte JPEG s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Kombinirajte više JPEG datoteka u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima kombiniranje više JPEG datoteka implementacijom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati JPEG datoteke koristeći Java primjer koda">}}

        ```java    
        // Kombinirajte JPEG datoteke koristeći GroupDocs.Merger za Java API
