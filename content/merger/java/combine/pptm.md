...
############################# Head ############################
head_title: "Combine PPTM Files via Java & J2SE Documents Merger API"
head_description: "Combine multiple PPTM files in Java using documents merger API with all data, style and formatting as the source documents."

############################# Header ############################
title: "Combine PPTM Files in Java Applications"
description: "Combine multiple PPTM files into a single file using Java documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    enable: true
    title_left: "Combine Multiple PPTM Files in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to combine multiple PPTM files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Combine PPTM files using GroupDocs.Merger for Java API
