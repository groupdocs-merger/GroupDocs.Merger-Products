...
############################# Head ############################
head_title: "XLSX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ ያጣምሩ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ የXLSX ፋይሎችን በጃቫ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "XLSX ፋይሎችን በJava ውስጥ ያጣምሩ"
description: "XLSXን ከጥቂት የJava ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ XLSX ፋይሎችን ያጣምሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለጃቫ ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ብዙ XLSX ፋይሎችን ማጣመር ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም XLSX ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም XLSX ፋይሎችን ያጣምሩ
