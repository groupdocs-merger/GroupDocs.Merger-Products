...
############################# Head ############################
head_title: "Kombinieren Sie XLTX-Dateien über die Java & J2SE Documents Merger API"
head_description: "Kombinieren Sie mehrere XLTX-Dateien in Java mithilfe der Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente."

############################# Header ############################
title: "Kombinieren Sie XLTX-Dateien in Java"
description: "Kombinieren Sie XLTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Kombinieren Sie mehrere XLTX-Dateien in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere XLTX-Dateien zu kombinieren, indem sie einige einfache Schritte implementieren.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie XLTX-Dateien mit Java-Beispielcode">}}

        ```java    
        // Kombinieren Sie XLTX-Dateien mit GroupDocs.Merger for Java API
