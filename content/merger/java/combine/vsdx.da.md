...
head_description: "Kombiner flere VSDX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "Kombiner VSDX filer i Java"
description: "Kombiner VSDX med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at kombinere flere VSDX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer VSDX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Kombiner VSDX filer ved hjælp af GroupDocs.Merger for Java API
