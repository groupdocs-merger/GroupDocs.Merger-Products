...
############################# Head ############################
head_title: "Kombineerige JPG failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu JPG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri JPG faili Java"
description: "Kombineerige JPG mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu JPG faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme JPG faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida JPG faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid JPG, kasutades GroupDocs.Merger for Java API-t
