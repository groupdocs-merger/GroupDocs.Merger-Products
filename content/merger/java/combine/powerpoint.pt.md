...
############################# Head ############################
head_title: "Combinar arquivos POWERPOINT no Java"
head_description: "Use GroupDocs.Merger for Java para adicionar capacidades de mesclagem de documentos POWERPOINT aos seus projetos Java."

############################# Header ############################
title: "Combinar arquivos POWERPOINT" 
description: "Com GroupDocs.Merger for Java, você pode desenvolver aplicações avançadas em Java que mesclam documentos POWERPOINT de forma eficaz."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) oferece capacidades de mesclagem para documentos POWERPOINT. Aprimore suas aplicações Java mesclando vários arquivos em um só.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Inicialize Merger com o documento POWERPOINT de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas específicas de arquivos de diferentes formatos"
      content: |
        Este exemplo demonstra como mesclar arquivos POWERPOINT incluindo páginas específicas de documentos em outros formatos.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
