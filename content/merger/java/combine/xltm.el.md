...
############################# Head ############################
head_title: "Συνδυάστε αρχεία XLTM μέσω Java & J2SE Documents Merger API"
head_description: "Συνδυάστε πολλά αρχεία XLTM σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "Συνδυάστε XLTM αρχεία σε Java"
description: "Συνδυάστε το XLTM με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συνδυάστε πολλά XLTM αρχεία στο Java"
    content_left: |
        Το [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συνδυάσουν πολλά αρχεία XLTM εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδυάσετε αρχεία XLTM χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συνδυάστε XLTM αρχεία χρησιμοποιώντας το GroupDocs.Merger for Java API
