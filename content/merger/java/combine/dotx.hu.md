...
############################# Head ############################
head_title: "Kombinálja az DOTX fájlokat a Java & J2SE Documents Merger API-n keresztül"
head_description: "Kombináljon több DOTX fájlt Java-ban a Dokumentumok-egyesítés API-val az összes adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOTX fájlok kombinálása a Java nyelven"
description: "Kombinálja a(z) DOTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOTX fájl kombinálása a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOTX fájl kombinálását.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk DOTX fájlokat a Java példakóddal">}}

        ```java    
        // Kombinálja az DOTX fájlokat a GroupDocs.Merger for Java API segítségével
