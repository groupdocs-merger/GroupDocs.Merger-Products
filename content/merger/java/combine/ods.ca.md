...
############################# Head ############################
head_title: "Combina fitxers ODS mitjançant l'API de fusió de documents Java i J2SE"
...
############################# Header ############################
title: "Combina ODS fitxers a Java"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java combinar diversos fitxers ODS implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers ODS utilitzant el codi d'exemple Java">}}
