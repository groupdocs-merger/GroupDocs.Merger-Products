...
############################# Head ############################
head_title: "OTP файлдарды Java және J2SE Documents Merger API арқылы біріктіріңіз"
...
############################# Header ############################
title: "OTP файлды Java ішінде біріктіру"
description: "OTP Java кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше OTP файлды біріктіру"
    content_left: |
