...
############################# Head ############################
head_title: "Combine POTM Files via Java & J2SE Documents Merger API"
head_description: "Combine multiple POTM files in Java using documents merger API with all data, style and formatting as the source documents."

############################# Header ############################
title: "Combine POTM Files in Java Applications"
description: "Combine multiple POTM files into a single file using Java documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    enable: true
    title_left: "Combine Multiple POTM Files in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to combine multiple POTM files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Combine POTM files using GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
        Combine more than one POTM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
