...
head_description: "Gabungkan beberapa file PPTM di Java menggunakan API penggabungan dokumen dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."
...
steps:
    enable: true
    title_left: "Gabungkan Beberapa File PPTM di Java"
    content_left: |
...
demos:
    ...
    content: |
        Gabungkan lebih dari satu file PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/family).  
