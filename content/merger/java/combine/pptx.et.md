...
############################# Head ############################
head_title: "Kombineerige PPTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Kombineerige Java-s mitu PPTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "Kombineeri PPTX faili Java"
description: "Kombineerige PPTX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Kombineeri mitu PPTX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks mitme PPTX faili kombineerimise lihtsaks, rakendades mõne lihtsa sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPTX faile, kasutades Java näitekoodi">}}

        ```java    
        // Kombineerige failid PPTX, kasutades GroupDocs.Merger for Java API-t
