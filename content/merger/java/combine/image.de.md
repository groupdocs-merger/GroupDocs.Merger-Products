...
############################# Head ############################
head_title: "IMAGE-Dateien in Java kombinieren"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um die Funktionen zum Zusammenführen von IMAGE-Dokumenten in Ihren Java-Projekten hinzuzufügen."

############################# Header ############################
title: "IMAGE-Dateien kombinieren" 
description: "Mit GroupDocs.Merger for Java können Sie fortschrittliche Java-Anwendungen entwickeln, die IMAGE-Dokumenten problemlos zusammenführen."
...
steps:
    enable: true
    title: "Wie man IMAGE-Dokumenten zusammenführt"
    content: |
      [GroupDocs.Merger](/merger/java/) bietet Funktionen zum Zusammenführen von IMAGE-Dokumenten. Verbessern Sie Ihre Java-Anwendungen, indem Sie mehrere Dateien in eine kombinieren.
      
      1. Geben Sie den Pfad zur ersten IMAGE-Datei an.
    ...
    code:
      ...
      content: |
        ```java {style=abap}
        // Merger mit dem Eingang IMAGE-Dokument initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bestimmte Seiten aus Dateien verschiedener Formate zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man IMAGE-Dateien zusammenführt und dabei spezifische Seiten aus Dokumenten in anderen Formaten einbezieht.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
