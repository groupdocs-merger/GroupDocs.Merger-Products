...
############################# Head ############################
head_title: "Combineer DOT bestanden via Java & J2SE Documents Merger API"
head_description: "Combineer meerdere DOT-bestanden in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "Combineer DOT bestanden in Java"
description: "Combineer DOT met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Combineer meerdere DOT bestanden in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere DOT-bestanden te combineren door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOT bestanden te combineren met behulp van Java voorbeeldcode">}}

        ```java    
        // Combineer DOT bestanden met behulp van GroupDocs.Merger voor Java API
