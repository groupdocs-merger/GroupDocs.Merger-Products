...
############################# Head ############################
head_title: "Kombinujte soubory PPT prostřednictvím rozhraní Java & J2SE Documents Merger API"
head_description: "Kombinujte více souborů PPT v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "Kombinovat PPT soubory v Java"
description: "Zkombinujte PPT s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Zkombinovat více souborů PPT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java kombinovat více souborů PPT pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory PPT pomocí ukázkového kódu Java">}}

        ```java    
        // Zkombinujte soubory PPT pomocí GroupDocs.Merger for Java API
