...
############################# Head ############################
head_title: "DOTM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla DOTM dosyasını birleştirin."

############################# Header ############################
title: "DOTM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok DOTM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) web sitesini ziyaret ederek birden fazla DOTM dosyayı birleştirin.
