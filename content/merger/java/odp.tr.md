...
############################# Head ############################
head_title: "ODP Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla ODP dosyasını birleştirin."

############################# Header ############################
title: "ODP Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok ODP Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) web sitesini ziyaret ederek birden fazla ODP dosyayı birleştirin.
