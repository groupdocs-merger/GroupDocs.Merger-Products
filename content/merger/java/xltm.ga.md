...
############################# Head ############################
head_title: "Cumaisc XLTM Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid XLTM iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "XLTM Cumasc i Java"
description: "Cumaisc XLTM le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc XLTM Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid XLTM iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLTM comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc XLTM comhad le GroupDocs.Merger le haghaidh Java API
