...
############################# Head ############################
head_title: "Führen Sie EXCEL-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere EXCEL-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "EXCEL Fusion in Java"
description: "Führen Sie EXCEL mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere EXCEL-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere EXCEL-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie EXCEL-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie EXCEL-Dateien mit GroupDocs.Merger for Java API zusammen
