...
############################# Head ############################
head_title: "Samenvoegen JPG Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "JPG Fusie in Java"
description: "Voeg JPG samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere JPG bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe JPG bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg JPG bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één JPG bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) te gaan.
