...
############################# Head ############################
head_title: "Spoji datoteke VSSM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSSM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSSM Združitev v Java"
description: "Spojite VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSSM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSSM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSSM z API-jem GroupDocs.Merger for Java
