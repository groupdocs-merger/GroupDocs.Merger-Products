...
############################# Head ############################
head_title: "Обединете PDF файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество PDF файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "PDF Обединяване в Java"
description: "Обединете PDF с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество PDF файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините PDF файлове с Java примерен код">}}

        ```java    
        // Обединете PDF файлове с помощта на GroupDocs.Merger за Java API
