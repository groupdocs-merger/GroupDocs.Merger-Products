...
############################# Head ############################
head_title: "Ühendage XLSM failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLSM ühinemine programmis Java"
description: "Ühendage XLSM mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLSM faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLSM faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLSM faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLSM, kasutades GroupDocs.Merger for Java API-t
