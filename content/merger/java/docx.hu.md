...
############################# Head ############################
head_title: "Egyesítse az DOCX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több DOCX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOCX Egyesülés a Java programban"
description: "Egyesítse a(z) DOCX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOCX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOCX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen DOCX fájlokat a GroupDocs.Merger for Java API segítségével
