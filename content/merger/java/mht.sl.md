...
############################# Head ############################
head_title: "Spoji datoteke MHT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek MHT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "MHT Združitev v Java"
description: "Spojite MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek MHT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke MHT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke MHT z API-jem GroupDocs.Merger for Java
