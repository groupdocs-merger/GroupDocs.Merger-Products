...
############################# Head ############################
head_title: "دمج ملفات OTT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات OTT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "OTT الاندماج في Java"
description: "دمج OTT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من OTT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
