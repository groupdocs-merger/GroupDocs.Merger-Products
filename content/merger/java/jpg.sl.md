...
############################# Head ############################
head_title: "Spoji datoteke JPG prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek JPG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "JPG Združitev v Java"
description: "Spojite JPG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek JPG v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPG s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke JPG z API-jem GroupDocs.Merger for Java
