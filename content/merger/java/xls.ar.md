...
############################# Head ############################
head_title: "دمج ملفات XLS عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLS في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLS الاندماج في Java"
description: "دمج XLS ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLS ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
