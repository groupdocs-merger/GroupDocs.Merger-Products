...
############################# Head ############################
head_title: "Συγχώνευση αρχείων XLSM μέσω Java & J2SE Documents Merger API"
head_description: "Συγχωνεύστε πολλά αρχεία XLSM σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "XLSM Συγχώνευση στο Java"
description: "Συγχώνευση XLSM με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συγχώνευση πολλών XLSM αρχείων στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συγχωνεύουν πολλά αρχεία XLSM εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία XLSM χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συγχώνευση αρχείων XLSM χρησιμοποιώντας GroupDocs.Merger for Java API
