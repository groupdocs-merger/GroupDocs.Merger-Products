...
############################# Head ############################
head_title: "Spoji datoteke VSDX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSDX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSDX Združitev v Java"
description: "Spojite VSDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSDX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSDX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSDX z API-jem GroupDocs.Merger for Java
