...
############################# Head ############################
head_title: "Führen Sie WEB-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere WEB-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "WEB Fusion in Java"
description: "Führen Sie WEB mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere WEB-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere WEB-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie WEB-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie WEB-Dateien mit GroupDocs.Merger for Java API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine WEB-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/web) besuchen.
