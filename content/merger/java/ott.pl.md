...
############################# Head ############################
head_title: "Scal pliki OTT za pomocą interfejsu API łączenia dokumentów Java i J2SE"
head_description: "Scal wiele plików OTT w Javie za pomocą interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "OTT Fuzja w Java"
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pl/merger/java/) zapewnia wygodne rozwiązanie do scalania wielu plików PDF, pakietu Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrazów i wiele innych dokumentów w jednym pliku w aplikacjach Java. GroupDocs.Merger zaoszczędzi Ci wiele wysiłku, ponieważ możesz łączyć dokumenty OTT - nie ma potrzeby instalowania żadnego oprogramowania innych firm, aplikacji komputerowych ani wtyczek. Teraz nie musisz tracić czasu i ręcznie scalać pliki! Misją GroupDocs jest zapewnienie najwyższej jakości i uproszczenie przepływów pracy przy przetwarzaniu dokumentów.
...
steps:
    enable: true
    title_left: "Scal wiele plików OTT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java łączenie wielu plików OTT przez wykonanie kilku prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak scalić pliki OTT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Scal pliki OTT za pomocą GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Scal teraz więcej niż jeden plik OTT, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
