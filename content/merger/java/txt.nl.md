...
############################# Head ############################
head_title: "Samenvoegen TXT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "TXT Fusie in Java"
description: "Voeg TXT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere TXT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TXT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg TXT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één TXT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) te gaan.
