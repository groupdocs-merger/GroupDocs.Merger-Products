...
############################# Head ############################
head_title: "دمج ملفات TSV عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات TSV في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "TSV الاندماج في Java"
description: "دمج TSV ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من TSV ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
