...
############################# Head ############################
head_title: "Merge TIFF files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate TIFF document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge TIFF files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage TIFF documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of TIFF documents. Enhance your Java applications by combining multiple files into one.
