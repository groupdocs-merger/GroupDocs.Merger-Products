...
############################# Head ############################
head_title: "Spoji datoteke PPS prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PPS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PPS Združitev v Java"
description: "Spojite PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PPS v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPS s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PPS z API-jem GroupDocs.Merger for Java
