...
############################# Head ############################
head_title: "MHT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla MHT dosyasını birleştirin."

############################# Header ############################
title: "MHT Java'da Birleşme"
description: "MHT kodunu birkaç satır Java koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok MHT Dosyayı Java İçinde Birleştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak birden çok MHT dosyasını birleştirmesini kolaylaştırır.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHT dosyaları nasıl birleştirilir">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak MHT dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) web sitesini ziyaret ederek birden fazla MHT dosyayı birleştirin.
