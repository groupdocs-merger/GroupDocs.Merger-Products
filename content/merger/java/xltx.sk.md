...
############################# Head ############################
head_title: "Zlúčiť súbory XLTX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLTX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLTX Zlúčenie v Java"
description: "Zlúčte XLTX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLTX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLTX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLTX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLTX súbory pomocou GroupDocs.Merger for Java API
