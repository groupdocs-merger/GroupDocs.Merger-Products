...
############################# Head ############################
head_title: "Spoji datoteke ONE prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek ONE v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "ONE Združitev v Java"
description: "Spojite ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek ONE v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ONE s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke ONE z API-jem GroupDocs.Merger for Java
