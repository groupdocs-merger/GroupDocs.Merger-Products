...
############################# Head ############################
head_title: "Обединете XLAM файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество XLAM файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "XLAM Обединяване в Java"
description: "Обединете XLAM с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество XLAM файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините XLAM файлове с Java примерен код">}}

        ```java    
        // Обединете XLAM файлове с помощта на GroupDocs.Merger за Java API
