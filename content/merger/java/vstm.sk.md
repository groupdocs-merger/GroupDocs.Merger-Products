...
############################# Head ############################
head_title: "Zlúčiť súbory VSTM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSTM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSTM Zlúčenie v Java"
description: "Zlúčte VSTM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSTM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSTM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSTM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSTM súbory pomocou GroupDocs.Merger for Java API
