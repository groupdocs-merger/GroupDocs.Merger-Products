...
############################# Head ############################
head_title: "Samenvoegen PPSX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PPSX Fusie in Java"
description: "Voeg PPSX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PPSX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPSX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PPSX bestanden samen met GroupDocs.Merger voor Java API
