...
############################# Head ############################
head_title: "Combina fitxers XLAM mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers XLAM a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "XLAM Fusió a Java"
description: "Combina XLAM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers XLAM a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers XLAM implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLAM mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers XLAM mitjançant l'API de GroupDocs.Merger per a Java
