...
############################# Head ############################
head_title: "Zlúčiť súbory XLT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLT Zlúčenie v Java"
description: "Zlúčte XLT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLT súbory pomocou GroupDocs.Merger for Java API
