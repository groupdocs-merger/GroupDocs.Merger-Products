...
############################# Head ############################
head_title: "Zlúčiť súbory VSDM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSDM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSDM Zlúčenie v Java"
description: "Zlúčte VSDM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSDM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSDM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSDM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSDM súbory pomocou GroupDocs.Merger for Java API
