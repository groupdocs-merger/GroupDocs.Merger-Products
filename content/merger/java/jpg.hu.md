...
############################# Head ############################
head_title: "Egyesítse az JPG fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több JPG fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "JPG Egyesülés a Java programban"
description: "Egyesítse a(z) JPG terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több JPG fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több JPG fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPG fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen JPG fájlokat a GroupDocs.Merger for Java API segítségével
