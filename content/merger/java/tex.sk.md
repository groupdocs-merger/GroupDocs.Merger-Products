...
############################# Head ############################
head_title: "Zlúčiť súbory TEX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero TEX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "TEX Zlúčenie v Java"
description: "Zlúčte TEX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero TEX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov TEX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory TEX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť TEX súbory pomocou GroupDocs.Merger for Java API
