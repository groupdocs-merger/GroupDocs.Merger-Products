...
############################# Head ############################
head_title: "Spoji datoteke VSSX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSSX Združitev v Java"
description: "Spojite VSSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek VSSX z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSSX s primerom kode Java">}}

        ```java    
        // Spojite datoteke VSSX z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Združite več kot eno datoteko VSSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
