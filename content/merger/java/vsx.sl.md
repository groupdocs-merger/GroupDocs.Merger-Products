...
############################# Head ############################
head_title: "Spoji datoteke VSX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSX Združitev v Java"
description: "Spojite VSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSX z API-jem GroupDocs.Merger for Java
