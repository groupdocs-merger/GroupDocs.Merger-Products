...
############################# Head ############################
head_title: "Egyesítse az XLSM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLSM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLSM Egyesülés a Java programban"
description: "Egyesítse a(z) XLSM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLSM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLSM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLSM fájlokat a GroupDocs.Merger for Java API segítségével
