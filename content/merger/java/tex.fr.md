...
############################# Head ############################
head_title: "Fusionner TEX fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers TEX en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "TEX Fusionner dans Java"
description: "Fusionnez TEX avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers TEX dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers TEX en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers TEX à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers TEX à l'aide de GroupDocs.Merger pour l'API Java
