...
############################# Head ############################
head_title: "Spoji datoteke PDF prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PDF v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PDF Združitev v Java"
description: "Spojite PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PDF v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PDF s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PDF z API-jem GroupDocs.Merger for Java
