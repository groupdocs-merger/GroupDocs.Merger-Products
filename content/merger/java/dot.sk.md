...
############################# Head ############################
head_title: "Zlúčiť súbory DOT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOT Zlúčenie v Java"
description: "Zlúčte DOT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOT súbory pomocou GroupDocs.Merger for Java API
