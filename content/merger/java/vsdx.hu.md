...
############################# Head ############################
head_title: "Egyesítse az VSDX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSDX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSDX Egyesülés a Java programban"
description: "Egyesítse a(z) VSDX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSDX fájl egyesítése a következőben: Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSDX fájlokat a GroupDocs.Merger for Java API segítségével
