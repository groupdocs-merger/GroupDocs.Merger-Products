...
############################# Head ############################
head_title: "Sloučit soubory MHTML přes rozhraní Java & J2SE Documents Merger API"
head_description: "Sloučit více souborů MHTML v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "MHTML Fúze v Java"
description: "Sloučit MHTML s několika řádky kódu Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/cs/merger/java/) poskytuje pohodlné řešení pro sloučení více PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázků a mnoho dalších dokumentů do jednoho souboru v aplikacích Java. GroupDocs.Merger vám ušetří spoustu námahy, protože máte povoleno slučovat MHTML dokumenty – není potřeba instalovat žádný software třetích stran, desktopové aplikace nebo pluginy. Nyní je zbytečné ztrácet čas a slučovat soubory ručně! Posláním GroupDocs je poskytovat nejlepší kvalitu a zjednodušit pracovní postupy zpracování dokumentů.
...
steps:
    enable: true
    title_left: "Sloučit více souborů MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java sloučení více souborů MHTML pomocí několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory MHTML pomocí ukázkového kódu Java">}}

        ```java    
        // Sloučit MHTML soubory pomocí GroupDocs.Merger for Java API
