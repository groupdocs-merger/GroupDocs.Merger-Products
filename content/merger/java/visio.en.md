...
############################# Head ############################
head_title: "Merge VISIO files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate VISIO document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge VISIO files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage VISIO documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of VISIO documents. Enhance your Java applications by combining multiple files into one.
