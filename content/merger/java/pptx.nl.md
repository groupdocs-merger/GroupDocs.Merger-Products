...
############################# Head ############################
head_title: "Samenvoegen PPTX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PPTX Fusie in Java"
description: "Voeg PPTX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PPTX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PPTX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één PPTX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) te gaan.
