...
############################# Head ############################
head_title: "Samenvoegen VTX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VTX Fusie in Java"
description: "Voeg VTX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VTX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VTX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VTX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VTX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) te gaan.
