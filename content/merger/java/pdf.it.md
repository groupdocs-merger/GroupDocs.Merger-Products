...
head_description: "Utilizza GroupDocs.Merger for Java per integrare le funzionalità di unione dei documenti PDF nei tuoi progetti Java."

############################# Header ############################
title: "Unisci file PDF" 
description: "Con GroupDocs.Merger for Java, puoi costruire applicazioni avanzate Java che uniscono e gestiscono senza difficoltà documenti PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) consente l'unione senza problemi di documenti PDF. Potenzia le tue applicazioni Java unendo più file in uno.
      
      1. Fornisci il percorso del primo file PDF.
