...
############################# Head ############################
head_title: "Zlúčiť súbory ODS cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero ODS súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "ODS Zlúčenie v Java"
description: "Zlúčte ODS s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero ODS súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov ODS vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory ODS pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť ODS súbory pomocou GroupDocs.Merger for Java API
