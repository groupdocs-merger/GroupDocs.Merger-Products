...
############################# Head ############################
head_title: "Zlúčiť súbory VSTX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSTX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSTX Zlúčenie v Java"
description: "Zlúčte VSTX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSTX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSTX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSTX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSTX súbory pomocou GroupDocs.Merger for Java API
