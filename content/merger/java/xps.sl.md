...
############################# Head ############################
head_title: "Spoji datoteke XPS prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XPS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XPS Združitev v Java"
description: "Spojite XPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XPS v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XPS s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XPS z API-jem GroupDocs.Merger for Java
