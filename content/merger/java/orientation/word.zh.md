...
############################# Head ############################
head_title: "在Java应用中更改WORD页面方向"
head_description: "使用GroupDocs.Merger for Java调整WORD页面方向（纵向或横向）。管理PDF、Word文档、Excel表格、PowerPoint幻灯片、Visio文件、图片、压缩包等。"

############################# Header ############################
title: "控制WORD的页面方向" 
description: "GroupDocs.Merger for Java为Java应用提供了实用工具。开发人员可以通过管理流行的文件格式和调整WORD页面方向来提升他们的项目。"
...
steps:
    ...
    title: "如何更改WORD页面方向"
    content: |
      使用[GroupDocs.Merger](/merger/java/)来调整WORD页面方向。此功能以及其他功能为Java项目带来了坚实的文档管理解决方案。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "更改WORD文档中最后一页的方向"
      content: |
        学习如何计算WORD文件中的页面数并更改最后一页的方向。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
