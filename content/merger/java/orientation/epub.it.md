...
############################# Head ############################
head_title: "Cambia l'orientamento delle pagine EPUB nelle app Java"
head_description: "Utilizza GroupDocs.Merger for Java per regolare l'orientamento delle pagine EPUB (verticale o orizzontale). Gestisci PDF, documenti Word, fogli Excel, diapositive PowerPoint, file Visio, immagini, archivi e altro."

############################# Header ############################
title: "Controllo dell'orientamento della pagina in EPUB" 
description: "GroupDocs.Merger for Java fornisce agli app Java strumenti utili. Gli sviluppatori possono migliorare i loro progetti gestendo formati di file popolari e regolando l'orientamento delle pagine EPUB."
...
steps:
    enable: true
    title: "Come cambiare l'orientamento delle pagine EPUB"
    content: |
      Utilizza [GroupDocs.Merger](/merger/java/) per regolare l'orientamento delle pagine EPUB. Questa funzione, insieme ad altre, fornisce una gestione documentale solida ai progetti Java.
      
      1. Indica il file sorgente EPUB.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cambia l'orientamento dell'ultima pagina nel documento EPUB"
      content: |
