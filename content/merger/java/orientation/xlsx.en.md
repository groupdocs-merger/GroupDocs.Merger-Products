...
############################# Head ############################
head_title: "Change XLSX pages orientation in Java apps"
head_description: "Use GroupDocs.Merger for Java to adjust XLSX page orientation (portrait or landscape). Manage PDFs, Word docs, Excel sheets, PowerPoint slides, Visio files, images, archives, and more with ease."

############################# Header ############################
title: "Page orientation control in XLSX" 
description: "GroupDocs.Merger for Java equips Java apps with handy tools. Developers can enhance their projects by managing popular file formats and tweaking XLSX page orientation."
...
steps:
    enable: true
    title: "How to change XLSX pages orientation"
    content: |
      Use [GroupDocs.Merger](/merger/java/) to adjust XLSX page orientation. This feature, along with others, brings solid document management to Java projects.
      
      1. Point to the XLSX source file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Change orientation of the last page in XLSX doc"
      content: |
        Learn how to count pages in a XLSX file and change the last one’s orientation.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
