...
############################# Head ############################
head_title: "Cambiar la orientación de páginas de POWERPOINT en aplicaciones Java"
head_description: "Utiliza GroupDocs.Merger for Java para ajustar la orientación de las páginas de POWERPOINT (vertical u horizontal). Administra PDFs, documentos de Word, hojas de Excel, presentaciones de PowerPoint, archivos de Visio, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Control de orientación de páginas en POWERPOINT" 
description: "GroupDocs.Merger for Java proporciona a las aplicaciones Java herramientas útiles. Los desarrolladores pueden mejorar sus proyectos gestionando formatos de archivo populares y ajustando la orientación de las páginas de POWERPOINT."
...
steps:
    enable: true
    title: "Cómo cambiar la orientación de páginas POWERPOINT"
    content: |
      Utiliza [GroupDocs.Merger](/merger/java/) para ajustar la orientación de la página POWERPOINT. Esta función, junto con otras, proporciona una sólida gestión de documentos para los proyectos de Java.
      
      1. Apunta al archivo fuente POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cambiar la orientación de la última página en el documento POWERPOINT"
      content: |
        Aprende a contar las páginas en un archivo POWERPOINT y cambiar la orientación de la última.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
