...
############################# Head ############################
head_title: "Change EPUB pages orientation in Java apps"
head_description: "Use GroupDocs.Merger for Java to adjust EPUB page orientation (portrait or landscape). Manage PDFs, Word docs, Excel sheets, PowerPoint slides, Visio files, images, archives, and more with ease."

############################# Header ############################
title: "Page orientation control in EPUB" 
description: "GroupDocs.Merger for Java equips Java apps with handy tools. Developers can enhance their projects by managing popular file formats and tweaking EPUB page orientation."
...
steps:
    enable: true
    title: "How to change EPUB pages orientation"
    content: |
      Use [GroupDocs.Merger](/merger/java/) to adjust EPUB page orientation. This feature, along with others, brings solid document management to Java projects.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Change orientation of the last page in EPUB doc"
      content: |
