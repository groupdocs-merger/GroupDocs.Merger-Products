...
############################# Head ############################
head_title: "Alterar a orientação das páginas WORD em aplicativos Java"
head_description: "Utilize o GroupDocs.Merger for Java para ajustar a orientação das páginas WORD (retrato ou paisagem). Gerencie PDFs, documentos Word, planilhas Excel, slides PowerPoint, arquivos Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Controle de orientação de página em WORD" 
description: "GroupDocs.Merger for Java fornece aos aplicativos Java ferramentas úteis. Os desenvolvedores podem aprimorar seus projetos gerenciando formatos de arquivos populares e ajustando a orientação das páginas WORD."
...
steps:
    enable: true
    title: "Como alterar a orientação das páginas WORD"
    content: |
      Utilize [GroupDocs.Merger](/merger/java/) para ajustar a orientação das páginas WORD. Este recurso, juntamente com outros, traz um gerenciamento sólido de documentos para projetos Java.
      
      1. Aponte para o arquivo de origem WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Alterar a orientação da última página no documento WORD"
      content: |
        Aprenda como contar as páginas em um arquivo WORD e alterar a orientação da última.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
