...
############################# Head ############################
head_title: "Combina fitxers VSDX mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers VSDX a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "VSDX Fusió a Java"
description: "Combina VSDX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers VSDX a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers VSDX implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers VSDX mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers VSDX mitjançant l'API de GroupDocs.Merger per a Java
