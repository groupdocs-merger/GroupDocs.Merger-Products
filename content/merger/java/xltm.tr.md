...
############################# Head ############################
head_title: "XLTM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLTM dosyasını birleştirin."

############################# Header ############################
title: "XLTM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLTM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) web sitesini ziyaret ederek birden fazla XLTM dosyayı birleştirin.
