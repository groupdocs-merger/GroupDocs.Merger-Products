...
############################# Head ############################
head_title: "Egyesítse az VTX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VTX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VTX Egyesülés a Java programban"
description: "Egyesítse a(z) VTX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VTX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VTX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VTX fájlokat a GroupDocs.Merger for Java API segítségével
