...
############################# Head ############################
head_title: "Flet VDX filer via Java & J2SE Documents Merger API"
head_description: "Flet flere VDX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "VDX fusion i Java"
description: "Flet VDX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere VDX filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere VDX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VDX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet VDX filer ved hjælp af GroupDocs.Merger for Java API
