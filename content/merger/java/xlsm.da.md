...
############################# Head ############################
head_title: "Flet XLSM filer via Java & J2SE Documents Merger API"
head_description: "Flet flere XLSM filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "XLSM fusion i Java"
description: "Flet XLSM med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere XLSM filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere XLSM-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLSM filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet XLSM filer ved hjælp af GroupDocs.Merger for Java API
