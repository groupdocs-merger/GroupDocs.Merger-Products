...
############################# Head ############################
head_title: "Slå sammen VDX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VDX sammenslåing i Java"
description: "Slå sammen VDX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VDX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VDX filer med GroupDocs.Merger for Java API
