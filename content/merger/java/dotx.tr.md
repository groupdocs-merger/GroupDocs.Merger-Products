...
############################# Head ############################
head_title: "DOTX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla DOTX dosyasını birleştirin."

############################# Header ############################
title: "DOTX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok DOTX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) web sitesini ziyaret ederek birden fazla DOTX dosyayı birleştirin.
