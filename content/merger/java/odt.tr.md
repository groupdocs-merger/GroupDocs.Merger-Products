...
############################# Head ############################
head_title: "ODT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla ODT dosyasını birleştirin."

############################# Header ############################
title: "ODT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok ODT Dosyayı Java İçinde Birleştirin"
    content_left: |
