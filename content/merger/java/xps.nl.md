...
############################# Head ############################
head_title: "Samenvoegen XPS Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XPS Fusie in Java"
description: "Voeg XPS samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XPS bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XPS bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XPS bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XPS bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) te gaan.
