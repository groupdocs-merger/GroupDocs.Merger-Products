...
############################# Head ############################
head_title: "Ühendage PPTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PPTX ühinemine programmis Java"
description: "Ühendage PPTX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PPTX faili, kasutades Java näitekoodi">}}
