...
############################# Head ############################
head_title: "DOC Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla DOC dosyasını birleştirin."

############################# Header ############################
title: "DOC Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok DOC Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) web sitesini ziyaret ederek birden fazla DOC dosyayı birleştirin.
