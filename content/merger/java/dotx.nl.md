...
############################# Head ############################
head_title: "Samenvoegen DOTX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOTX Fusie in Java"
description: "Voeg DOTX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOTX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOTX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOTX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) te gaan.
