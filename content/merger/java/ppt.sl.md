...
############################# Head ############################
head_title: "Spoji datoteke PPT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PPT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PPT Združitev v Java"
description: "Spojite PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PPT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PPT z API-jem GroupDocs.Merger for Java
