...
############################# Head ############################
head_title: "Zlúčiť súbory VSDX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSDX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSDX Zlúčenie v Java"
description: "Zlúčte VSDX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSDX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSDX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSDX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSDX súbory pomocou GroupDocs.Merger for Java API
