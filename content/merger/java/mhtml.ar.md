...
############################# Head ############################
head_title: "دمج ملفات MHTML عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات MHTML في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "MHTML الاندماج في Java"
description: "دمج MHTML ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من MHTML ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
