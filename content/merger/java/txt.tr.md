...
############################# Head ############################
head_title: "TXT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla TXT dosyasını birleştirin."

############################# Header ############################
title: "TXT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok TXT Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) web sitesini ziyaret ederek birden fazla TXT dosyayı birleştirin.
