...
############################# Head ############################
head_title: "Sloučit soubory XLTM přes rozhraní Java & J2SE Documents Merger API"
head_description: "Sloučit více souborů XLTM v Javě pomocí API pro slučování dokumentů se všemi daty, stylem a formátováním jako zdrojovými dokumenty."

############################# Header ############################
title: "XLTM Fúze v Java"
description: "Sloučit XLTM s několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Sloučit více souborů XLTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java sloučení více souborů XLTM pomocí několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory XLTM pomocí ukázkového kódu Java">}}

        ```java    
        // Sloučit XLTM soubory pomocí GroupDocs.Merger for Java API
