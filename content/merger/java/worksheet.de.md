...
############################# Head ############################
head_title: "Führen Sie WORKSHEET-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere WORKSHEET-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "WORKSHEET Fusion in Java"
description: "Führen Sie WORKSHEET mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere WORKSHEET-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere WORKSHEET-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie WORKSHEET-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie WORKSHEET-Dateien mit GroupDocs.Merger for Java API zusammen
