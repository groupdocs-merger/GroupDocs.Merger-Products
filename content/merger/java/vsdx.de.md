...
############################# Head ############################
head_title: "Führen Sie VSDX-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere VSDX-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "VSDX Fusion in Java"
description: "Führen Sie VSDX mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere VSDX-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VSDX-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VSDX-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie VSDX-Dateien mit GroupDocs.Merger for Java API zusammen
