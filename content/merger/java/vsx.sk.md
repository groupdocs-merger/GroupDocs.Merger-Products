...
############################# Head ############################
head_title: "Zlúčiť súbory VSX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSX Zlúčenie v Java"
description: "Zlúčte VSX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSX súbory pomocou GroupDocs.Merger for Java API
