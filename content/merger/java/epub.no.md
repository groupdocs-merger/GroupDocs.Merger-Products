...
############################# Head ############################
head_title: "Slå sammen EPUB filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "EPUB sammenslåing i Java"
description: "Slå sammen EPUB med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen EPUB filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen EPUB filer med GroupDocs.Merger for Java API
