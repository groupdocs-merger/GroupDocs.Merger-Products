...
############################# Head ############################
head_title: "Combina fitxers DOCM mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers DOCM a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "DOCM Fusió a Java"
description: "Combina DOCM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers DOCM a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers DOCM implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers DOCM mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers DOCM mitjançant l'API de GroupDocs.Merger per a Java
