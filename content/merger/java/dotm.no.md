...
############################# Head ############################
head_title: "Slå sammen DOTM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOTM sammenslåing i Java"
description: "Slå sammen DOTM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOTM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOTM filer med GroupDocs.Merger for Java API
