...
############################# Head ############################
head_title: "Spoji datoteke XLAM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLAM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLAM Združitev v Java"
description: "Spojite XLAM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLAM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLAM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLAM z API-jem GroupDocs.Merger for Java
