...
############################# Head ############################
head_title: "Sujunkite MHT failus naudodami Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "MHT Susijungimas Java"
description: "Sujunkite MHT su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis MHT failus Java"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną MHT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) svetainėje.
