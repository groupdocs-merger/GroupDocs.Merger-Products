...
############################# Head ############################
head_title: "Îmbinați fișierele JPEG prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere JPEG în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "JPEG Fuziune în Java"
description: "Îmbinați JPEG cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere JPEG în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere JPEG pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere JPEG folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere JPEG utilizând API-ul GroupDocs.Merger pentru Java
