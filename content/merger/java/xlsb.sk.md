...
############################# Head ############################
head_title: "Zlúčiť súbory XLSB cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLSB súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLSB Zlúčenie v Java"
description: "Zlúčte XLSB s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLSB súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLSB vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLSB pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLSB súbory pomocou GroupDocs.Merger for Java API
