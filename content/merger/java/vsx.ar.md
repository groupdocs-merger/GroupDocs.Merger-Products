...
############################# Head ############################
head_title: "دمج ملفات VSX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSX الاندماج في Java"
description: "دمج VSX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
