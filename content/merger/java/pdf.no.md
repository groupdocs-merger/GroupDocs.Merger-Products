...
############################# Head ############################
head_title: "Slå sammen PDF filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PDF sammenslåing i Java"
description: "Slå sammen PDF med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PDF filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PDF filer med GroupDocs.Merger for Java API
