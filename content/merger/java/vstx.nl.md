...
############################# Head ############################
head_title: "Samenvoegen VSTX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VSTX Fusie in Java"
description: "Voeg VSTX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VSTX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSTX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VSTX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VSTX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) te gaan.
