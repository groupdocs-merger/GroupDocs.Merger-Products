...
############################# Head ############################
head_title: "Zlúčiť súbory RTF cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero RTF súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "RTF Zlúčenie v Java"
description: "Zlúčte RTF s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero RTF súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov RTF vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory RTF pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť RTF súbory pomocou GroupDocs.Merger for Java API
