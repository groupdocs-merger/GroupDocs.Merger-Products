...
############################# Head ############################
head_title: "XLSB Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLSB dosyasını birleştirin."

############################# Header ############################
title: "XLSB Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLSB Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) web sitesini ziyaret ederek birden fazla XLSB dosyayı birleştirin.
