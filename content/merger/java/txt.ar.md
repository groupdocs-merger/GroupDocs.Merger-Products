...
############################# Head ############################
head_title: "دمج ملفات TXT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات TXT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "TXT الاندماج في Java"
description: "دمج TXT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من TXT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
