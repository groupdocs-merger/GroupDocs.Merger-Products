...
############################# Head ############################
head_title: "Spoji datoteke VSTX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSTX Združitev v Java"
description: "Spojite VSTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSTX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSTX z API-jem GroupDocs.Merger for Java
