...
############################# Head ############################
head_title: "Îmbinați fișierele XLTM prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere XLTM în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "XLTM Fuziune în Java"
description: "Îmbinați XLTM cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere XLTM în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere XLTM pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere XLTM folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere XLTM utilizând API-ul GroupDocs.Merger pentru Java
