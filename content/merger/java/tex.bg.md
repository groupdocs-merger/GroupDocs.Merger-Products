...
############################# Head ############################
head_title: "Обединете TEX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество TEX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "TEX Обединяване в Java"
description: "Обединете TEX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество TEX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините TEX файлове с Java примерен код">}}

        ```java    
        // Обединете TEX файлове с помощта на GroupDocs.Merger за Java API
