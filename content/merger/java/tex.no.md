...
############################# Head ############################
head_title: "Slå sammen TEX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "TEX sammenslåing i Java"
description: "Slå sammen TEX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TEX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen TEX filer med GroupDocs.Merger for Java API
