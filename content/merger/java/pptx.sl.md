...
############################# Head ############################
head_title: "Spoji datoteke PPTX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PPTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PPTX Združitev v Java"
description: "Spojite PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PPTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPTX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PPTX z API-jem GroupDocs.Merger for Java
