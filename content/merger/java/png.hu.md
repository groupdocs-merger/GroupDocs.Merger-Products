...
############################# Head ############################
head_title: "Egyesítse az PNG fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PNG fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PNG Egyesülés a Java programban"
description: "Egyesítse a(z) PNG terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PNG fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PNG fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PNG fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PNG fájlokat a GroupDocs.Merger for Java API segítségével
