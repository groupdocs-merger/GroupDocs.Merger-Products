...
############################# Head ############################
head_title: "Zlúčiť súbory PPTX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PPTX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PPTX Zlúčenie v Java"
description: "Zlúčte PPTX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PPTX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PPTX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PPTX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PPTX súbory pomocou GroupDocs.Merger for Java API
