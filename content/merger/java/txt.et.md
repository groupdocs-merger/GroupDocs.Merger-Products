...
############################# Head ############################
head_title: "Ühendage TXT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TXT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "TXT ühinemine programmis Java"
description: "Ühendage TXT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita TXT faili, kasutades Java näitekoodi">}}
