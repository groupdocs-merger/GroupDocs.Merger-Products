...
############################# Head ############################
head_title: "Slå sammen ONE filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "ONE sammenslåing i Java"
description: "Slå sammen ONE med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ONE filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen ONE filer med GroupDocs.Merger for Java API
