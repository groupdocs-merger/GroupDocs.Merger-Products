...
############################# Head ############################
head_title: "Fusionner XLTM fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers XLTM en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "XLTM Fusionner dans Java"
description: "Fusionnez XLTM avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers XLTM dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers XLTM en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers XLTM à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers XLTM à l'aide de GroupDocs.Merger pour l'API Java
