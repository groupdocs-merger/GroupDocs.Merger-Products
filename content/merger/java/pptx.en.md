...
############################# Head ############################
head_title: "Merge PPTX files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate PPTX document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge PPTX files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage PPTX documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of PPTX documents. Enhance your Java applications by combining multiple files into one.
