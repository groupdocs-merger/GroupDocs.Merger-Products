...
############################# Head ############################
head_title: "Slå samman PPT filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera PPT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "PPT sammanslagning i Java"
description: "Slå samman PPT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera PPT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera PPT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar PPT filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman PPT-filer med GroupDocs.Merger för Java API
