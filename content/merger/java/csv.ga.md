...
############################# Head ############################
head_title: "Cumaisc CSV Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid CSV iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "CSV Cumasc i Java"
description: "Cumaisc CSV le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc CSV Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid CSV iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas CSV comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc CSV comhad le GroupDocs.Merger le haghaidh Java API
