...
############################# Head ############################
head_title: "RTF Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla RTF dosyasını birleştirin."

############################# Header ############################
title: "RTF Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok RTF Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) web sitesini ziyaret ederek birden fazla RTF dosyayı birleştirin.
