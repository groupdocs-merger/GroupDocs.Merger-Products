...
############################# Head ############################
head_title: "Slå sammen JPEG filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "JPEG sammenslåing i Java"
description: "Slå sammen JPEG med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen JPEG filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen JPEG filer med GroupDocs.Merger for Java API
