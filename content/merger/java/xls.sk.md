...
############################# Head ############################
head_title: "Zlúčiť súbory XLS cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLS súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLS Zlúčenie v Java"
description: "Zlúčte XLS s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLS súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLS vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLS pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLS súbory pomocou GroupDocs.Merger for Java API
