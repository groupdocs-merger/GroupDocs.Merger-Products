...
############################# Head ############################
head_title: "Spoji datoteke XLSX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLSX Združitev v Java"
description: "Spojite XLSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLSX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLSX z API-jem GroupDocs.Merger for Java
