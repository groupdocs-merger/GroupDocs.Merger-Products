...
############################# Head ############################
head_title: "Merge EPUB files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate EPUB document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge EPUB files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage EPUB documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of EPUB documents. Enhance your Java applications by combining multiple files into one.
