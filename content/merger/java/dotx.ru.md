...
############################# Head ############################
head_title: "Объединение DOTX файлов через Java и J2SE Documents Merger API"
head_description: "Объединяйте несколько файлов DOTX в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "DOTX Объединение на Java"
...
steps:
    enable: true
    title_left: "Объединить несколько DOTX файлов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы DOTX, используя пример кода Java">}}
        ...
        ```java    
        // Объединить DOTX файлов с помощью GroupDocs.Merger for Java API
