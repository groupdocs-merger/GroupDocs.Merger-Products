...
############################# Head ############################
head_title: "Yhdistä PPSX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita PPSX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "PPSX Sulautuminen Java"
description: "Yhdistä PPSX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita PPSX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita PPSX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPSX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä PPSX tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PPSX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) -sivustolla.
