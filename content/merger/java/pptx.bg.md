...
############################# Head ############################
head_title: "Обединете PPTX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество PPTX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "PPTX Обединяване в Java"
description: "Обединете PPTX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество PPTX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините PPTX файлове с Java примерен код">}}

        ```java    
        // Обединете PPTX файлове с помощта на GroupDocs.Merger за Java API
