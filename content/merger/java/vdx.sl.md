...
############################# Head ############################
head_title: "Spoji datoteke VDX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VDX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VDX Združitev v Java"
description: "Spojite VDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VDX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VDX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VDX z API-jem GroupDocs.Merger for Java
