...
############################# Head ############################
head_title: "Zlúčiť súbory VSSX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSSX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSSX Zlúčenie v Java"
description: "Zlúčte VSSX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSSX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSSX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSSX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSSX súbory pomocou GroupDocs.Merger for Java API
