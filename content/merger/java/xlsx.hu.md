...
############################# Head ############################
head_title: "Egyesítse az XLSX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLSX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLSX Egyesülés a Java programban"
description: "Egyesítse a(z) XLSX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLSX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLSX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLSX fájlokat a GroupDocs.Merger for Java API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLSX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) webhely meglátogatásával.
