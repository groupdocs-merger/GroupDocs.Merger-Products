...
############################# Head ############################
head_title: "Samenvoegen XLT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLT Fusie in Java"
description: "Voeg XLT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) te gaan.
