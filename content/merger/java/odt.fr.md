...
############################# Head ############################
head_title: "Fusionner ODT fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers ODT en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "ODT Fusionner dans Java"
description: "Fusionnez ODT avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers ODT dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers ODT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers ODT à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers ODT à l'aide de GroupDocs.Merger pour l'API Java
