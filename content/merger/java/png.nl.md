...
############################# Head ############################
head_title: "Samenvoegen PNG Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PNG Fusie in Java"
description: "Voeg PNG samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PNG bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PNG bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PNG bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één PNG bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) te gaan.
