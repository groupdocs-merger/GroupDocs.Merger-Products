...
############################# Head ############################
head_title: "Flet VSTX filer via Java & J2SE Documents Merger API"
head_description: "Flet flere VSTX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "VSTX fusion i Java"
description: "Flet VSTX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere VSTX filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere VSTX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSTX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet VSTX filer ved hjælp af GroupDocs.Merger for Java API
