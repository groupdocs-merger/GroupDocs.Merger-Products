...
############################# Head ############################
head_title: "دمج ملفات XLTM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLTM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLTM الاندماج في Java"
description: "دمج XLTM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLTM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
