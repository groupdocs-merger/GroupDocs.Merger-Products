...
############################# Head ############################
head_title: "DOCX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla DOCX dosyasını birleştirin."

############################# Header ############################
title: "DOCX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok DOCX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) web sitesini ziyaret ederek birden fazla DOCX dosyayı birleştirin.
