...
############################# Head ############################
head_title: "JPG فائلوں کو Java اور J2SE Documents Merger API کے ذریعے ضم کریں۔"
head_description: "جاوا میں متعدد JPG فائلوں کو دستاویزات کے انضمام API کا استعمال کرتے ہوئے تمام ڈیٹا، اسٹائل اور فارمیٹنگ کو بطور ماخذ دستاویزات کے ساتھ ضم کریں۔"

############################# Header ############################
title: "JPG انضمام Java میں"
description: "JPG کو Java کوڈ کی چند سطروں کے ساتھ ضم کریں۔"
...
steps:
    enable: true
    title_left: "متعدد JPG فائلوں کو Java میں ضم کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) جاوا ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے متعدد JPG فائلوں کو ضم کرنا آسان بناتا ہے۔
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے JPG فائلوں کو کیسے ملایا جائے۔">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے JPG فائلوں کو ضم کریں۔
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) ویب سائٹ پر جا کر ابھی ایک سے زیادہ JPG فائلوں کو ضم کریں۔
