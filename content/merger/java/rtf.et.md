...
############################# Head ############################
head_title: "Ühendage RTF failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu RTF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "RTF ühinemine programmis Java"
description: "Ühendage RTF mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita RTF faili, kasutades Java näitekoodi">}}
