...
############################# Head ############################
head_title: "Samenvoegen EPUB Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "EPUB Fusie in Java"
description: "Voeg EPUB samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere EPUB bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg EPUB bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één EPUB bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) te gaan.
