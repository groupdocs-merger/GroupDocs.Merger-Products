...
############################# Head ############################
head_title: "Spoji datoteke VTX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VTX Združitev v Java"
description: "Spojite VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VTX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VTX z API-jem GroupDocs.Merger for Java
