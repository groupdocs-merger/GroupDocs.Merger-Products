...
############################# Head ############################
head_title: "Обединете VSTM файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество VSTM файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "VSTM Обединяване в Java"
description: "Обединете VSTM с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество VSTM файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VSTM файлове с Java примерен код">}}

        ```java    
        // Обединете VSTM файлове с помощта на GroupDocs.Merger за Java API
