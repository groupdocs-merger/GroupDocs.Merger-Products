...
############################# Head ############################
head_title: "Slå sammen XLSB filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLSB sammenslåing i Java"
description: "Slå sammen XLSB med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLSB filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLSB filer med GroupDocs.Merger for Java API
