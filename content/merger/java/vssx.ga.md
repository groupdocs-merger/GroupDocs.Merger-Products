...
############################# Head ############################
head_title: "Cumaisc VSSX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid VSSX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "VSSX Cumasc i Java"
description: "Cumaisc VSSX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc VSSX Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid VSSX iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSSX comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc VSSX comhad le GroupDocs.Merger le haghaidh Java API
