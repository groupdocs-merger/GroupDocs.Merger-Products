...
############################# Head ############################
head_title: "Egyesítse az XLAM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLAM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLAM Egyesülés a Java programban"
description: "Egyesítse a(z) XLAM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLAM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLAM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLAM fájlokat a GroupDocs.Merger for Java API segítségével
