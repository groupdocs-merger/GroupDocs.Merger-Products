...
############################# Head ############################
head_title: "Spoji datoteke JPEG prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek JPEG v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "JPEG Združitev v Java"
description: "Spojite JPEG z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek JPEG v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPEG s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke JPEG z API-jem GroupDocs.Merger for Java
