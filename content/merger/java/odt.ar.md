...
############################# Head ############################
head_title: "دمج ملفات ODT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات ODT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "ODT الاندماج في Java"
description: "دمج ODT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من ODT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
