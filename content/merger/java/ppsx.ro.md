...
############################# Head ############################
head_title: "Îmbinați fișierele PPSX prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere PPSX în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "PPSX Fuziune în Java"
description: "Îmbinați PPSX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere PPSX în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere PPSX pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere PPSX folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere PPSX utilizând API-ul GroupDocs.Merger pentru Java
