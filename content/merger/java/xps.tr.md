...
############################# Head ############################
head_title: "XPS Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XPS dosyasını birleştirin."

############################# Header ############################
title: "XPS Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XPS Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) web sitesini ziyaret ederek birden fazla XPS dosyayı birleştirin.
