...
############################# Head ############################
head_title: "Ühendage ODS failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ODS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "ODS ühinemine programmis Java"
description: "Ühendage ODS mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ODS faili, kasutades Java näitekoodi">}}
