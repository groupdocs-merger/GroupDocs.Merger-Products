...
############################# Head ############################
head_title: "Egyesítse az DOT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több DOT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOT Egyesülés a Java programban"
description: "Egyesítse a(z) DOT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen DOT fájlokat a GroupDocs.Merger for Java API segítségével
