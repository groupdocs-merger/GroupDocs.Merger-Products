...
############################# Head ############################
head_title: "Zlúčiť súbory TXT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero TXT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "TXT Zlúčenie v Java"
description: "Zlúčte TXT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero TXT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov TXT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory TXT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť TXT súbory pomocou GroupDocs.Merger for Java API
