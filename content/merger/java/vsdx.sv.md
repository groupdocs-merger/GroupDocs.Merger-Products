...
############################# Head ############################
head_title: "Slå samman VSDX filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera VSDX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "VSDX sammanslagning i Java"
description: "Slå samman VSDX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera VSDX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera VSDX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar VSDX filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman VSDX-filer med GroupDocs.Merger för Java API
