...
############################# Head ############################
head_title: "Pelên DOTX bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên DOTX di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "DOTX Yekbûn di Java"
...
steps:
    enable: true
    title_left: "Gelek DOTX Pelên di Java de bibin yek"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên DOTX bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên DOTX bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) niha ji yek pelan zêdetir DOTX bikin yek.
