...
head_description: "Yhdistä useita JPEG-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "JPEG Sulautuminen Java"
description: "Yhdistä JPEG muutamalla rivillä Java-koodia."
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi JPEG-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) -sivustolla.
