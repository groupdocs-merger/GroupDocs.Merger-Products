...
head_description: "ドキュメント マージ API を使用して Java で複数の EXCEL ファイルをマージし、すべてのデータ、スタイル、フォーマットをソース ドキュメントとして使用します。"

############################# Header ############################
title: "EXCEL Javaでの合併"
description: "EXCEL を数行の Java コードとマージします。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ja/merger/java/) を使用すると、Java 開発者はいくつかの簡単な手順を実装することで、複数の EXCEL ファイルを簡単にマージできます。
    ...
    code: |
     ...
     {{< merger/code-merger title="Java サンプル コードを使用して EXCEL ファイルをマージする方法">}}

        ```java    
        // GroupDocs.Merger for Java API を使用して EXCEL ファイルをマージします
