...
############################# Head ############################
head_title: "Обединете VSSM файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество VSSM файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "VSSM Обединяване в Java"
description: "Обединете VSSM с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество VSSM файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VSSM файлове с Java примерен код">}}

        ```java    
        // Обединете VSSM файлове с помощта на GroupDocs.Merger за Java API
