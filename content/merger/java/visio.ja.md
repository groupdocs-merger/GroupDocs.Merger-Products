...
############################# Head ############################
head_title: "Java & J2SE Documents Merger API 経由で VISIO ファイルをマージ"
head_description: "ドキュメント マージ API を使用して Java で複数の VISIO ファイルをマージし、すべてのデータ、スタイル、フォーマットをソース ドキュメントとして使用します。"

############################# Header ############################
title: "VISIO Javaでの合併"
description: "VISIO を数行の Java コードとマージします。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/ja/merger/java/) を使用すると、Java 開発者はいくつかの簡単な手順を実装することで、複数の VISIO ファイルを簡単にマージできます。
    ...
    code: |
     ...
     {{< merger/code-merger title="Java サンプル コードを使用して VISIO ファイルをマージする方法">}}

        ```java    
        // GroupDocs.Merger for Java API を使用して VISIO ファイルをマージします
