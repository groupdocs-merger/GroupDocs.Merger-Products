...
############################# Head ############################
head_title: "Yhdistä EPUB tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita EPUB-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "EPUB Sulautuminen Java"
description: "Yhdistä EPUB muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita EPUB tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita EPUB-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää EPUB tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä EPUB tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi EPUB-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) -sivustolla.
