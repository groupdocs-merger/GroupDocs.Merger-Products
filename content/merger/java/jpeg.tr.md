...
############################# Head ############################
head_title: "JPEG Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla JPEG dosyasını birleştirin."

############################# Header ############################
title: "JPEG Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok JPEG Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) web sitesini ziyaret ederek birden fazla JPEG dosyayı birleştirin.
