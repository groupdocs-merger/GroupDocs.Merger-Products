...
############################# Head ############################
head_title: "Egyesítse az JPEG fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több JPEG fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "JPEG Egyesülés a Java programban"
description: "Egyesítse a(z) JPEG terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több JPEG fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több JPEG fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPEG fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen JPEG fájlokat a GroupDocs.Merger for Java API segítségével
