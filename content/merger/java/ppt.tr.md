...
############################# Head ############################
head_title: "PPT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla PPT dosyasını birleştirin."

############################# Header ############################
title: "PPT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok PPT Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) web sitesini ziyaret ederek birden fazla PPT dosyayı birleştirin.
