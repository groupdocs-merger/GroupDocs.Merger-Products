...
############################# Head ############################
head_title: "Обединете VSDX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество VSDX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "VSDX Обединяване в Java"
description: "Обединете VSDX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество VSDX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VSDX файлове с Java примерен код">}}

        ```java    
        // Обединете VSDX файлове с помощта на GroupDocs.Merger за Java API
