...
############################# Head ############################
head_title: "دمج ملفات DOTM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات DOTM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "DOTM الاندماج في Java"
description: "دمج DOTM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من DOTM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
