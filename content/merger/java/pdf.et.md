...
############################# Head ############################
head_title: "Ühendage PDF failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PDF-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PDF ühinemine programmis Java"
description: "Ühendage PDF mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PDF faili, kasutades Java näitekoodi">}}
