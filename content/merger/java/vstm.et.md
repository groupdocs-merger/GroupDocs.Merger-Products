...
############################# Head ############################
head_title: "Ühendage VSTM failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSTM ühinemine programmis Java"
description: "Ühendage VSTM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSTM faili, kasutades Java näitekoodi">}}
