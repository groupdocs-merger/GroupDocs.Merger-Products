...
############################# Head ############################
head_title: "HTML Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla HTML dosyasını birleştirin."

############################# Header ############################
title: "HTML Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok HTML Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) web sitesini ziyaret ederek birden fazla HTML dosyayı birleştirin.
