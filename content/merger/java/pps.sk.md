...
############################# Head ############################
head_title: "Zlúčiť súbory PPS cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PPS súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PPS Zlúčenie v Java"
description: "Zlúčte PPS s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PPS súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PPS vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PPS pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PPS súbory pomocou GroupDocs.Merger for Java API
