...
############################# Head ############################
head_title: "Spoji JPEG datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više JPEG datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "JPEG Spajanje u Java"
description: "Spoji JPEG s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Spoji više JPEG datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti JPEG datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Spoji JPEG datoteke koristeći GroupDocs.Merger za Java API
