...
############################# Head ############################
head_title: "Slå sammen HTML filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "HTML sammenslåing i Java"
description: "Slå sammen HTML med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen HTML filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen HTML filer med GroupDocs.Merger for Java API
