...
############################# Head ############################
head_title: "Îmbinați fișierele ODT prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere ODT în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "ODT Fuziune în Java"
description: "Îmbinați ODT cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere ODT în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere ODT pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere ODT folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere ODT utilizând API-ul GroupDocs.Merger pentru Java
