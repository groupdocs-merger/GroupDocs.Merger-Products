...
############################# Head ############################
head_title: "Pelên VSX bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên VSX di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "VSX Yekbûn di Java"
...
steps:
    enable: true
    title_left: "Gelek VSX Pelên di Java de bibin yek"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên VSX bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên VSX bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
