...
############################# Head ############################
head_title: "Samenvoegen VSSM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VSSM Fusie in Java"
description: "Voeg VSSM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VSSM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VSSM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VSSM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) te gaan.
