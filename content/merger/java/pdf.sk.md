...
############################# Head ############################
head_title: "Zlúčiť súbory PDF cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PDF súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PDF Zlúčenie v Java"
description: "Zlúčte PDF s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PDF súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PDF vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PDF pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PDF súbory pomocou GroupDocs.Merger for Java API
