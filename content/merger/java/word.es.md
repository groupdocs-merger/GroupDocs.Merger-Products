...
############################# Head ############################
head_title: "Fusionar archivos WORD en Java"
head_description: "Utiliza GroupDocs.Merger for Java para integrar capacidades de fusión de documentos WORD en tus proyectos de Java."

############################# Header ############################
title: "Fusionar archivos WORD" 
description: "Con GroupDocs.Merger for Java, puedes construir aplicaciones avanzadas en Java que fusionen y gestionen documentos WORD sin problemas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) habilita la fusión sin problemas de documentos WORD. Mejora tus aplicaciones de Java combinando múltiples archivos en uno.
