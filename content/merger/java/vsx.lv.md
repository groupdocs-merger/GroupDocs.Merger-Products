...
head_description: "Apvienojiet vairākus VSX failus Java, izmantojot dokumentu sapludināšanas API ar visiem datiem, stilu un formatējumu kā avota dokumentus."

############################# Header ############################
title: "VSX Apvienošanās programmā Java"
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/lv/merger/java/) nodrošina ērtu risinājumu vairāku PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlu un daudzus citus dokumentus vienā failā Java lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts sapludināt VSX dokumentus — nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt savu laiku un apvienot failus manuāli! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Apvienot vairākus VSX failus pakalpojumā Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sapludināt VSX failus, izmantojot Java piemēra kodu">}}
