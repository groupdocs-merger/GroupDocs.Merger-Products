...
############################# Head ############################
head_title: "دمج ملفات PPTX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات PPTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "PPTX الاندماج في Java"
description: "دمج PPTX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من PPTX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
