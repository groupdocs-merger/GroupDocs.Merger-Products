...
############################# Head ############################
head_title: "Обединете DOCX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество DOCX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "DOCX Обединяване в Java"
description: "Обединете DOCX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество DOCX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините DOCX файлове с Java примерен код">}}

        ```java    
        // Обединете DOCX файлове с помощта на GroupDocs.Merger за Java API
