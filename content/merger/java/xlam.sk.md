...
############################# Head ############################
head_title: "Zlúčiť súbory XLAM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLAM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLAM Zlúčenie v Java"
description: "Zlúčte XLAM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLAM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLAM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLAM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLAM súbory pomocou GroupDocs.Merger for Java API
