...
############################# Head ############################
head_title: "Gabungkan XLTX File melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan beberapa file XLTX di Java menggunakan API penggabungan dokumen dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "XLTX Penggabungan Dalam Java"
description: "Gabungkan XLTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Gabungkan Beberapa File XLTX di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menggabungkan beberapa file XLTX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLTX menggunakan kode contoh Java">}}
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLTX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
