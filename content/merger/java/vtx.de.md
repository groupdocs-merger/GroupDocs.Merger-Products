...
############################# Head ############################
head_title: "Führen Sie VTX-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere VTX-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "VTX Fusion in Java"
description: "Führen Sie VTX mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere VTX-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VTX-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VTX-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie VTX-Dateien mit GroupDocs.Merger for Java API zusammen
