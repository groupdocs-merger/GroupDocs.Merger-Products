...
############################# Head ############################
head_title: "Flet VSSX filer via Java & J2SE Documents Merger API"
head_description: "Flet flere VSSX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "VSSX fusion i Java"
description: "Flet VSSX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere VSSX filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere VSSX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSSX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet VSSX filer ved hjælp af GroupDocs.Merger for Java API
