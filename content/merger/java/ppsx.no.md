...
############################# Head ############################
head_title: "Slå sammen PPSX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PPSX sammenslåing i Java"
description: "Slå sammen PPSX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPSX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PPSX filer med GroupDocs.Merger for Java API
