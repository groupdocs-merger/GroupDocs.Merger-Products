...
############################# Head ############################
head_title: "Обединете HTML файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество HTML файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "HTML Обединяване в Java"
description: "Обединете HTML с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество HTML файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините HTML файлове с Java примерен код">}}

        ```java    
        // Обединете HTML файлове с помощта на GroupDocs.Merger за Java API
