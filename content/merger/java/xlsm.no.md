...
############################# Head ############################
head_title: "Slå sammen XLSM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLSM sammenslåing i Java"
description: "Slå sammen XLSM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLSM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLSM filer med GroupDocs.Merger for Java API
