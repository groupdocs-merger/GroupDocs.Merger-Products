...
############################# Head ############################
head_title: "Egyesítse az RTF fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több RTF fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "RTF Egyesülés a Java programban"
description: "Egyesítse a(z) RTF terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több RTF fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több RTF fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen RTF fájlokat a GroupDocs.Merger for Java API segítségével
