...
############################# Head ############################
head_title: "Egyesítse az DOC fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több DOC fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOC Egyesülés a Java programban"
description: "Egyesítse a(z) DOC terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOC fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOC fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen DOC fájlokat a GroupDocs.Merger for Java API segítségével
