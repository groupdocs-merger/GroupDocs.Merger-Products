...
head_description: "Utilizza GroupDocs.Merger for Java per integrare le funzionalità di unione dei documenti EXCEL nei tuoi progetti Java."

############################# Header ############################
title: "Unisci file EXCEL" 
description: "Con GroupDocs.Merger for Java, puoi costruire applicazioni avanzate Java che uniscono e gestiscono senza difficoltà documenti EXCEL."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) consente l'unione senza problemi di documenti EXCEL. Potenzia le tue applicazioni Java unendo più file in uno.
      
      1. Fornisci il percorso del primo file EXCEL.
