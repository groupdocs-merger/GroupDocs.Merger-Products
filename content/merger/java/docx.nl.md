...
############################# Head ############################
head_title: "Samenvoegen DOCX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOCX Fusie in Java"
description: "Voeg DOCX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOCX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOCX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOCX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) te gaan.
