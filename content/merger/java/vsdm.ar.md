...
############################# Head ############################
head_title: "دمج ملفات VSDM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSDM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSDM الاندماج في Java"
description: "دمج VSDM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSDM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
