...
############################# Head ############################
head_title: "Zlúčiť súbory OTT cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero OTT súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "OTT Zlúčenie v Java"
description: "Zlúčte OTT s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero OTT súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov OTT vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory OTT pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť OTT súbory pomocou GroupDocs.Merger for Java API
