...
############################# Head ############################
head_title: "PDF Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla PDF dosyasını birleştirin."

############################# Header ############################
title: "PDF Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok PDF Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) web sitesini ziyaret ederek birden fazla PDF dosyayı birleştirin.
