...
############################# Head ############################
head_title: "Slå sammen OTP filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "OTP sammenslåing i Java"
description: "Slå sammen OTP med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen OTP filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen OTP filer med GroupDocs.Merger for Java API
