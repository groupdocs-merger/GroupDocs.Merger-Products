...
############################# Head ############################
head_title: "Zlúčiť súbory PNG cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PNG súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PNG Zlúčenie v Java"
description: "Zlúčte PNG s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PNG súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PNG vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PNG pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PNG súbory pomocou GroupDocs.Merger for Java API
