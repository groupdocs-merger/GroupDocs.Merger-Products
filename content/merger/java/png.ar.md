...
############################# Head ############################
head_title: "دمج ملفات PNG عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات PNG في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "PNG الاندماج في Java"
description: "دمج PNG ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من PNG ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
