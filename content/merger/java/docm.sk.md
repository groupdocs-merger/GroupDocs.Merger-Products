...
############################# Head ############################
head_title: "Zlúčiť súbory DOCM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOCM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOCM Zlúčenie v Java"
description: "Zlúčte DOCM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOCM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOCM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOCM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOCM súbory pomocou GroupDocs.Merger for Java API
