...
############################# Head ############################
head_title: "Обединете DOTX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество DOTX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "DOTX Обединяване в Java"
description: "Обединете DOTX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество DOTX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините DOTX файлове с Java примерен код">}}

        ```java    
        // Обединете DOTX файлове с помощта на GroupDocs.Merger за Java API
