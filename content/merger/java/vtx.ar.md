...
############################# Head ############################
head_title: "دمج ملفات VTX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VTX الاندماج في Java"
description: "دمج VTX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VTX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
