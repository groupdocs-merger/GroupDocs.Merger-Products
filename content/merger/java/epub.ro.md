...
############################# Head ############################
head_title: "Îmbinați fișierele EPUB prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere EPUB în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "EPUB Fuziune în Java"
description: "Îmbinați EPUB cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere EPUB în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere EPUB pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere EPUB folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere EPUB utilizând API-ul GroupDocs.Merger pentru Java
