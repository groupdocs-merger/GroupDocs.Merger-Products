...
############################# Head ############################
head_title: "دمج ملفات JPEG عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات JPEG في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "JPEG الاندماج في Java"
description: "دمج JPEG ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من JPEG ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
