...
############################# Head ############################
head_title: "Führen Sie XLSM-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere XLSM-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "XLSM Fusion in Java"
description: "Führen Sie XLSM mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere XLSM-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere XLSM-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie XLSM-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie XLSM-Dateien mit GroupDocs.Merger for Java API zusammen
