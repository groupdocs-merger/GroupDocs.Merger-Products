...
############################# Head ############################
head_title: "Flet VSDM filer via Java & J2SE Documents Merger API"
head_description: "Flet flere VSDM filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "VSDM fusion i Java"
description: "Flet VSDM med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere VSDM filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere VSDM-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSDM filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet VSDM filer ved hjælp af GroupDocs.Merger for Java API
