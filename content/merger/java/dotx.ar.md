...
############################# Head ############################
head_title: "دمج ملفات DOTX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات DOTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "DOTX الاندماج في Java"
description: "دمج DOTX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من DOTX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx).
