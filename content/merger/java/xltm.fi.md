...
############################# Head ############################
head_title: "Yhdistä XLTM tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita XLTM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "XLTM Sulautuminen Java"
description: "Yhdistä XLTM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita XLTM tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita XLTM-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLTM tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä XLTM tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLTM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) -sivustolla.
