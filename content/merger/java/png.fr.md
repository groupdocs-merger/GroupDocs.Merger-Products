...
############################# Head ############################
head_title: "Fusionner PNG fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers PNG en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "PNG Fusionner dans Java"
description: "Fusionnez PNG avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers PNG dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers PNG en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers PNG à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers PNG à l'aide de GroupDocs.Merger pour l'API Java
