...
############################# Head ############################
head_title: "Merge BMP files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate BMP document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge BMP files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage BMP documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of BMP documents. Enhance your Java applications by combining multiple files into one.
