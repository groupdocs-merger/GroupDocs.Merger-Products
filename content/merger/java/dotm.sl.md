...
############################# Head ############################
head_title: "Spoji datoteke DOTM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOTM Združitev v Java"
description: "Spojite DOTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOTM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOTM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOTM z API-jem GroupDocs.Merger for Java
