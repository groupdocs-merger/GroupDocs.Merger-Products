...
############################# Head ############################
head_title: "Egyesítse az ODP fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több ODP fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "ODP Egyesülés a Java programban"
description: "Egyesítse a(z) ODP terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több ODP fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több ODP fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen ODP fájlokat a GroupDocs.Merger for Java API segítségével
