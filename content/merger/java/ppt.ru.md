...
############################# Head ############################
head_title: "Объединение PPT файлов через Java и J2SE Documents Merger API"
head_description: "Объединяйте несколько файлов PPT в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "PPT Объединение на Java"
...
steps:
    enable: true
    title_left: "Объединить несколько PPT файлов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы PPT, используя пример кода Java">}}
        ...
        ```java    
        // Объединить PPT файлов с помощью GroupDocs.Merger for Java API
