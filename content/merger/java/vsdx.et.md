...
############################# Head ############################
head_title: "Ühendage VSDX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSDX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSDX ühinemine programmis Java"
description: "Ühendage VSDX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSDX faili, kasutades Java näitekoodi">}}
