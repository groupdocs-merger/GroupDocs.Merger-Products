...
############################# Head ############################
head_title: "Cumaisc VSDM Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid VSDM iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "VSDM Cumasc i Java"
description: "Cumaisc VSDM le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc VSDM Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid VSDM iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSDM comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc VSDM comhad le GroupDocs.Merger le haghaidh Java API
