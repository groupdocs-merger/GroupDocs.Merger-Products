...
############################# Head ############################
head_title: "Samenvoegen VSSX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VSSX Fusie in Java"
description: "Voeg VSSX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VSSX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VSSX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VSSX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) te gaan.
