...
############################# Head ############################
head_title: "Slå sammen MHT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "MHT sammenslåing i Java"
description: "Slå sammen MHT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen MHT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen MHT filer med GroupDocs.Merger for Java API
