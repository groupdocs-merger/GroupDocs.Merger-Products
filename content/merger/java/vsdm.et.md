...
############################# Head ############################
head_title: "Ühendage VSDM failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSDM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSDM ühinemine programmis Java"
description: "Ühendage VSDM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSDM faili, kasutades Java näitekoodi">}}
