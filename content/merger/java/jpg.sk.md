...
############################# Head ############################
head_title: "Zlúčiť súbory JPG cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero JPG súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "JPG Zlúčenie v Java"
description: "Zlúčte JPG s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero JPG súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov JPG vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory JPG pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť JPG súbory pomocou GroupDocs.Merger for Java API
