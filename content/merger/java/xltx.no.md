...
############################# Head ############################
head_title: "Slå sammen XLTX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLTX sammenslåing i Java"
description: "Slå sammen XLTX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLTX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLTX filer med GroupDocs.Merger for Java API
