...
############################# Head ############################
head_title: "XLSX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLSX dosyasını birleştirin."

############################# Header ############################
title: "XLSX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLSX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) web sitesini ziyaret ederek birden fazla XLSX dosyayı birleştirin.
