...
############################# Head ############################
head_title: "Flet PPS filer via Java & J2SE Documents Merger API"
head_description: "Flet flere PPS filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "PPS fusion i Java"
description: "Flet PPS med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere PPS filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere PPS-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes PPS filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet PPS filer ved hjælp af GroupDocs.Merger for Java API
