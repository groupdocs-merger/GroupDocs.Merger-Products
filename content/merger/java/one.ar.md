...
############################# Head ############################
head_title: "دمج ملفات ONE عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات ONE في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "ONE الاندماج في Java"
description: "دمج ONE ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من ONE ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
