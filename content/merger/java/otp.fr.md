...
############################# Head ############################
head_title: "Fusionner OTP fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers OTP en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "OTP Fusionner dans Java"
description: "Fusionnez OTP avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers OTP dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers OTP en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers OTP à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers OTP à l'aide de GroupDocs.Merger pour l'API Java
