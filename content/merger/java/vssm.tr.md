...
############################# Head ############################
head_title: "VSSM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSSM dosyasını birleştirin."

############################# Header ############################
title: "VSSM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSSM Dosyayı Java İçinde Birleştirin"
    content_left: |
