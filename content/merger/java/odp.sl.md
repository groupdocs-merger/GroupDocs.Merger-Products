...
############################# Head ############################
head_title: "Spoji datoteke ODP prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek ODP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "ODP Združitev v Java"
description: "Spojite ODP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek ODP v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODP s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke ODP z API-jem GroupDocs.Merger for Java
