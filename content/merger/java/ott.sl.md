...
############################# Head ############################
head_title: "Spoji datoteke OTT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek OTT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "OTT Združitev v Java"
description: "Spojite OTT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek OTT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša združevanje več datotek OTT z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTT s primerom kode Java">}}

        ```java    
        // Spojite datoteke OTT z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Združite več kot eno datoteko OTT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
