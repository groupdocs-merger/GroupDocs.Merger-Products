...
############################# Head ############################
head_title: "JavaでDOCXファイルをマージ"
head_description: "JavaプロジェクトにDOCXドキュメントマージ機能を統合するために、GroupDocs.Merger for Javaを使用します。"

############################# Header ############################
title: "DOCXファイルをマージ" 
description: "GroupDocs.Merger for Javaを使用すれば、Javaアプリケーションを構築して、DOCXドキュメントをシームレスにマージおよび管理できます。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)はDOCXドキュメントのシームレスなマージを可能にします。複数のファイルを1つに統合して、Javaアプリケーションを強化します。
      
      1. 最初のDOCXファイルのパスを指定します。
