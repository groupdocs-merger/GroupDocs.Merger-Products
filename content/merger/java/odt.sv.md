...
############################# Head ############################
head_title: "Slå samman ODT filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera ODT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "ODT sammanslagning i Java"
description: "Slå samman ODT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera ODT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera ODT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar ODT filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman ODT-filer med GroupDocs.Merger för Java API
