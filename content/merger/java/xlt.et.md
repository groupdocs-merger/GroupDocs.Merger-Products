...
############################# Head ############################
head_title: "Ühendage XLT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLT ühinemine programmis Java"
description: "Ühendage XLT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLT faili, kasutades Java näitekoodi">}}
