...
############################# Head ############################
head_title: "Ühendage TSV failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "TSV ühinemine programmis Java"
description: "Ühendage TSV mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita TSV faili, kasutades Java näitekoodi">}}
