...
############################# Head ############################
head_title: "Slå sammen VSDM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VSDM sammenslåing i Java"
description: "Slå sammen VSDM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSDM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VSDM filer med GroupDocs.Merger for Java API
