...
############################# Head ############################
head_title: "OTT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla OTT dosyasını birleştirin."

############################# Header ############################
title: "OTT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok OTT Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) web sitesini ziyaret ederek birden fazla OTT dosyayı birleştirin.
