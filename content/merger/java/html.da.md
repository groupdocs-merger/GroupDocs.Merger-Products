...
############################# Head ############################
head_title: "Flet HTML filer via Java & J2SE Documents Merger API"
head_description: "Flet flere HTML filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "HTML fusion i Java"
description: "Flet HTML med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere HTML filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere HTML-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes HTML filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet HTML filer ved hjælp af GroupDocs.Merger for Java API
