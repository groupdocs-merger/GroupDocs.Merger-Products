...
############################# Head ############################
head_title: "Cumaisc BMP Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid BMP iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "BMP Cumasc i Java"
description: "Cumaisc BMP le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc BMP Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid BMP iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas BMP comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc BMP comhad le GroupDocs.Merger le haghaidh Java API
