...
############################# Head ############################
head_title: "Slå sammen OTT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "OTT sammenslåing i Java"
description: "Slå sammen OTT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen OTT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen OTT filer med GroupDocs.Merger for Java API
