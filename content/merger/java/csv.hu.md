...
############################# Head ############################
head_title: "Egyesítse az CSV fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több CSV fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "CSV Egyesülés a Java programban"
description: "Egyesítse a(z) CSV terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több CSV fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több CSV fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="CSV fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen CSV fájlokat a GroupDocs.Merger for Java API segítségével
