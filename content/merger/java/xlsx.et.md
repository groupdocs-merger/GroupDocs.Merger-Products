...
############################# Head ############################
head_title: "Ühendage XLSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLSX ühinemine programmis Java"
description: "Ühendage XLSX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLSX faili, kasutades Java näitekoodi">}}
