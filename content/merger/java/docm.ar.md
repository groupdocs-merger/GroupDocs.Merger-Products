...
############################# Head ############################
head_title: "دمج ملفات DOCM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات DOCM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "DOCM الاندماج في Java"
description: "دمج DOCM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من DOCM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
