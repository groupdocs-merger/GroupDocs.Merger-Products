...
############################# Head ############################
head_title: "Egyesítse az VSSX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSSX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSSX Egyesülés a Java programban"
description: "Egyesítse a(z) VSSX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSSX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSSX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSSX fájlokat a GroupDocs.Merger for Java API segítségével
