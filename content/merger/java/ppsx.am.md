...
############################# Head ############################
head_title: "PPSX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ አዋህድ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ PPSX ፋይሎችን በጃቫ ውስጥ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "የPPSX ውህደት በJava"
description: "PPSXን ከጥቂት የJava ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ PPSX ፋይሎችን አዋህድ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ PPSX ፋይሎችን ማዋሃድ ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም PPSX ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም PPSX ፋይሎችን አዋህድ
