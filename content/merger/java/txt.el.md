...
############################# Head ############################
head_title: "Συγχώνευση αρχείων TXT μέσω Java & J2SE Documents Merger API"
head_description: "Συγχωνεύστε πολλά αρχεία TXT σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "TXT Συγχώνευση στο Java"
description: "Συγχώνευση TXT με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συγχώνευση πολλών TXT αρχείων στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συγχωνεύουν πολλά αρχεία TXT εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία TXT χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συγχώνευση αρχείων TXT χρησιμοποιώντας GroupDocs.Merger for Java API
