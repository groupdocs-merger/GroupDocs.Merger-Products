...
############################# Head ############################
head_title: "Flet ODT filer via Java & J2SE Documents Merger API"
head_description: "Flet flere ODT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "ODT fusion i Java"
description: "Flet ODT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere ODT filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere ODT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes ODT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet ODT filer ved hjælp af GroupDocs.Merger for Java API
