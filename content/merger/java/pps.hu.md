...
############################# Head ############################
head_title: "Egyesítse az PPS fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PPS fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPS Egyesülés a Java programban"
description: "Egyesítse a(z) PPS terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPS fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPS fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PPS fájlokat a GroupDocs.Merger for Java API segítségével
