...
############################# Head ############################
head_title: "Spoji datoteke DOCM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOCM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOCM Združitev v Java"
description: "Spojite DOCM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOCM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOCM z API-jem GroupDocs.Merger for Java
