...
############################# Head ############################
head_title: "Spoji datoteke XLS prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLS Združitev v Java"
description: "Spojite XLS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLS v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLS s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLS z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Združite več kot eno datoteko XLS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
