...
############################# Head ############################
head_title: "Ühendage TEX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu TEX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "TEX ühinemine programmis Java"
description: "Ühendage TEX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita TEX faili, kasutades Java näitekoodi">}}
