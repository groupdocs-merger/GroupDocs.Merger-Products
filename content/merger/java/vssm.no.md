...
############################# Head ############################
head_title: "Slå sammen VSSM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VSSM sammenslåing i Java"
description: "Slå sammen VSSM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSSM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VSSM filer med GroupDocs.Merger for Java API
