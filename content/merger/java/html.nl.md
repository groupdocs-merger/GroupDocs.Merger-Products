...
############################# Head ############################
head_title: "Samenvoegen HTML Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "HTML Fusie in Java"
description: "Voeg HTML samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere HTML bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe HTML bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg HTML bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één HTML bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) te gaan.
