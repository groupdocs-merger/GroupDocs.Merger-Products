...
############################# Head ############################
head_title: "Führen Sie DOCM-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere DOCM-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "DOCM Fusion in Java"
description: "Führen Sie DOCM mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere DOCM-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOCM-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie DOCM-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie DOCM-Dateien mit GroupDocs.Merger for Java API zusammen
