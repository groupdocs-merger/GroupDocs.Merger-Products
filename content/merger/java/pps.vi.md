...
############################# Head ############################
head_title: "Hợp nhất tệp PPS qua API hợp nhất tài liệu Java & J2SE"
head_description: "Hợp nhất nhiều tệp PPS trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "PPS Hợp nhất trong Java"
description: "Hợp nhất PPS với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Hợp nhất Nhiều PPS Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng hợp nhất nhiều tệp PPS bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hợp nhất các tệp PPS bằng mã mẫu Java">}}

        ```java    
        // Hợp nhất các tệp PPS bằng GroupDocs.Merger cho Java API
