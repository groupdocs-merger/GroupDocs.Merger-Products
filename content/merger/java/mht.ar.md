...
############################# Head ############################
head_title: "دمج ملفات MHT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات MHT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "MHT الاندماج في Java"
description: "دمج MHT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من MHT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
