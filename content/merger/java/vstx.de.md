...
############################# Head ############################
head_title: "Führen Sie VSTX-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere VSTX-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "VSTX Fusion in Java"
description: "Führen Sie VSTX mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere VSTX-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VSTX-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VSTX-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie VSTX-Dateien mit GroupDocs.Merger for Java API zusammen
