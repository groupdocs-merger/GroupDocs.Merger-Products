...
############################# Head ############################
head_title: "Spoji datoteke XLTM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLTM Združitev v Java"
description: "Spojite XLTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLTM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLTM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLTM z API-jem GroupDocs.Merger for Java
