...
############################# Head ############################
head_title: "Spoji datoteke XLT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLT Združitev v Java"
description: "Spojite XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLT z API-jem GroupDocs.Merger for Java
