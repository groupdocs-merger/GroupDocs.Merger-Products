...
############################# Head ############################
head_title: "Ühendage JPG failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu JPG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "JPG ühinemine programmis Java"
description: "Ühendage JPG mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita JPG faili, kasutades Java näitekoodi">}}
