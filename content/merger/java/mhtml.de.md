...
############################# Head ############################
head_title: "Führen Sie MHTML-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere MHTML-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "MHTML Fusion in Java"
description: "Führen Sie MHTML mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere MHTML-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere MHTML-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie MHTML-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie MHTML-Dateien mit GroupDocs.Merger for Java API zusammen
