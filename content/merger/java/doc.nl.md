...
############################# Head ############################
head_title: "Samenvoegen DOC Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOC Fusie in Java"
description: "Voeg DOC samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOC bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOC bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOC bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOC bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) te gaan.
