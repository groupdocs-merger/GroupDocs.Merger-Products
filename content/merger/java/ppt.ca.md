...
############################# Head ############################
head_title: "Combina fitxers PPT mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers PPT a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "PPT Fusió a Java"
description: "Combina PPT amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers PPT a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers PPT implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers PPT mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers PPT mitjançant l'API de GroupDocs.Merger per a Java
