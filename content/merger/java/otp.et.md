...
############################# Head ############################
head_title: "Ühendage OTP failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu OTP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "OTP ühinemine programmis Java"
description: "Ühendage OTP mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu OTP faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme OTP faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita OTP faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid OTP, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks OTP faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
