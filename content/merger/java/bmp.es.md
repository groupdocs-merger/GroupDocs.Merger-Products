...
############################# Head ############################
head_title: "Fusionar archivos BMP en Java"
head_description: "Utiliza GroupDocs.Merger for Java para integrar capacidades de fusión de documentos BMP en tus proyectos de Java."

############################# Header ############################
title: "Fusionar archivos BMP" 
description: "Con GroupDocs.Merger for Java, puedes construir aplicaciones avanzadas en Java que fusionen y gestionen documentos BMP sin problemas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) habilita la fusión sin problemas de documentos BMP. Mejora tus aplicaciones de Java combinando múltiples archivos en uno.
      
      1. Proporciona la ruta al primer archivo BMP.
