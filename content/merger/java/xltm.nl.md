...
############################# Head ############################
head_title: "Samenvoegen XLTM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLTM Fusie in Java"
description: "Voeg XLTM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLTM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLTM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLTM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLTM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) te gaan.
