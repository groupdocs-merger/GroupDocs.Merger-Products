...
############################# Head ############################
head_title: "Ühendage DOT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "DOT ühinemine programmis Java"
description: "Ühendage DOT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOT faili, kasutades Java näitekoodi">}}
