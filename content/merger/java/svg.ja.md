...
############################# Head ############################
head_title: "JavaでSVGファイルをマージ"
head_description: "JavaプロジェクトにSVGドキュメントマージ機能を統合するために、GroupDocs.Merger for Javaを使用します。"

############################# Header ############################
title: "SVGファイルをマージ" 
description: "GroupDocs.Merger for Javaを使用すれば、Javaアプリケーションを構築して、SVGドキュメントをシームレスにマージおよび管理できます。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)はSVGドキュメントのシームレスなマージを可能にします。複数のファイルを1つに統合して、Javaアプリケーションを強化します。
      
      1. 最初のSVGファイルのパスを指定します。
