...
############################# Head ############################
head_title: "Ühendage HTML failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu HTML-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "HTML ühinemine programmis Java"
description: "Ühendage HTML mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu HTML faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme HTML faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita HTML faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid HTML, kasutades GroupDocs.Merger for Java API-t
