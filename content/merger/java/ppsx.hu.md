...
############################# Head ############################
head_title: "Egyesítse az PPSX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PPSX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPSX Egyesülés a Java programban"
description: "Egyesítse a(z) PPSX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPSX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPSX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PPSX fájlokat a GroupDocs.Merger for Java API segítségével
