...
############################# Head ############################
head_title: "Führen Sie XLTM-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere XLTM-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "XLTM Fusion in Java"
description: "Führen Sie XLTM mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere XLTM-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere XLTM-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie XLTM-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie XLTM-Dateien mit GroupDocs.Merger for Java API zusammen
