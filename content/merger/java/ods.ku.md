...
############################# Head ############################
head_title: "Pelên ODS bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên ODS di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "ODS Yekbûn di Java"
...
steps:
    enable: true
    title_left: "Gelek ODS Pelên di Java de bibin yek"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên ODS bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên ODS bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) niha ji yek pelan zêdetir ODS bikin yek.
