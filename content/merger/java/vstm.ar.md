...
############################# Head ############################
head_title: "دمج ملفات VSTM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSTM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSTM الاندماج في Java"
description: "دمج VSTM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSTM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm).
