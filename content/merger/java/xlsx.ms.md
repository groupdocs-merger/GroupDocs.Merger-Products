...
############################# Head ############################
head_title: "Gabungkan XLSX Fail melalui API Penggabungan Dokumen Java & J2SE"
head_description: "Gabungkan berbilang fail XLSX dalam Java menggunakan API penggabungan dokumen dengan semua data, gaya dan pemformatan sebagai dokumen sumber."

############################# Header ############################
title: "XLSX Penggabungan Dalam Java"
description: "Gabungkan XLSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Gabungkan Berbilang XLSX Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java untuk menggabungkan berbilang fail XLSX dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XLSX fail menggunakan kod contoh Java.">}}

        ```java    
        // Gabungkan XLSX fail menggunakan GroupDocs.Merger untuk Java API
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu XLSX fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
