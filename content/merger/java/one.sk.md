...
############################# Head ############################
head_title: "Zlúčiť súbory ONE cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero ONE súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "ONE Zlúčenie v Java"
description: "Zlúčte ONE s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero ONE súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov ONE vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory ONE pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť ONE súbory pomocou GroupDocs.Merger for Java API
