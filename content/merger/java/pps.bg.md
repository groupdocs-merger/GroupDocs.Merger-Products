...
############################# Head ############################
head_title: "Обединете PPS файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество PPS файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "PPS Обединяване в Java"
description: "Обединете PPS с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество PPS файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините PPS файлове с Java примерен код">}}

        ```java    
        // Обединете PPS файлове с помощта на GroupDocs.Merger за Java API
