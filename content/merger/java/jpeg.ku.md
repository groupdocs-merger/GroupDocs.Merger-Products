...
############################# Head ############################
head_title: "Pelên JPEG bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên JPEG di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "JPEG Yekbûn di Java"
description: "JPEG bi çend rêzikên koda Java re bibin yek."
...
steps:
    enable: true
    title_left: "Gelek JPEG Pelên di Java de bibin yek"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan ve gelek pelên JPEG li hev bikin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên JPEG bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên JPEG bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) niha ji yek pelan zêdetir JPEG bikin yek.
