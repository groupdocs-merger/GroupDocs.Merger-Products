...
############################# Head ############################
head_title: "मर्ज PPSX जावा और J2SE दस्तावेज़ों के माध्यम से फ़ाइलें मर्जर API"
head_description: "स्रोत दस्तावेज़ के रूप में सभी डेटा, शैली और स्वरूपण के साथ दस्तावेज़ विलय API का उपयोग करके जावा में एकाधिक PPSX फ़ाइलें मर्ज करें।"

############################# Header ############################
title: "PPSX विलय Java में"
...
steps:
    enable: true
    title_left: "Java में एकाधिक PPSX फ़ाइलें मर्ज करें"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) जावा डेवलपर्स के लिए कुछ आसान चरणों को लागू करके कई PPSX फाइलों को मर्ज करना आसान बनाता है।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके PPSX फ़ाइलों को कैसे मर्ज करें">}}

        ```java    
        // GroupDocs.Merger for Java API का उपयोग करके PPSX फ़ाइलें मर्ज करें
