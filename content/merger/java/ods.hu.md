...
############################# Head ############################
head_title: "Egyesítse az ODS fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több ODS fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "ODS Egyesülés a Java programban"
description: "Egyesítse a(z) ODS terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több ODS fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több ODS fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODS fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen ODS fájlokat a GroupDocs.Merger for Java API segítségével
