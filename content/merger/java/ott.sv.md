...
############################# Head ############################
head_title: "Slå samman OTT filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera OTT-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "OTT sammanslagning i Java"
description: "Slå samman OTT med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera OTT-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera OTT-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar OTT filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman OTT-filer med GroupDocs.Merger för Java API
