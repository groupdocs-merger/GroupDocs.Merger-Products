...
############################# Head ############################
head_title: "Egyesítse az PPTX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PPTX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPTX Egyesülés a Java programban"
description: "Egyesítse a(z) PPTX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPTX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPTX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PPTX fájlokat a GroupDocs.Merger for Java API segítségével
