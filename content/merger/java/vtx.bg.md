...
############################# Head ############################
head_title: "Обединете VTX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество VTX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "VTX Обединяване в Java"
description: "Обединете VTX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество VTX файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да обединяват множество VTX файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VTX файлове с Java примерен код">}}

        ```java    
        // Обединете VTX файлове с помощта на GroupDocs.Merger за Java API
