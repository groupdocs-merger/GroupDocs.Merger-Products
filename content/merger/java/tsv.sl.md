...
############################# Head ############################
head_title: "Spoji datoteke TSV prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek TSV v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "TSV Združitev v Java"
description: "Spojite TSV z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek TSV v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TSV s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke TSV z API-jem GroupDocs.Merger for Java
