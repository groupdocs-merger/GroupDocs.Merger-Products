...
############################# Head ############################
head_title: "Samenvoegen PDF Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PDF Fusie in Java"
description: "Voeg PDF samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PDF bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PDF bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PDF bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één PDF bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) te gaan.
