...
############################# Head ############################
head_title: "Ühendage VSTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSTX ühinemine programmis Java"
description: "Ühendage VSTX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSTX faili, kasutades Java näitekoodi">}}
