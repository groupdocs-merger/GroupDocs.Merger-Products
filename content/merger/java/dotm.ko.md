...
############################# Head ############################
head_title: "Java 및 J2SE 문서 병합 API를 통해 DOTM 파일 병합"
head_description: "모든 데이터, 스타일 및 형식을 소스 문서로 포함하는 문서 병합 API를 사용하여 Java에서 여러 DOTM 파일을 병합합니다."

############################# Header ############################
title: "DOTM Java 합병"
description: "몇 줄의 Java 코드와 DOTM를 병합합니다."
...
steps:
    enable: true
    title_left: "Java에서 여러 DOTM 파일 병합"
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 Java 개발자가 몇 가지 간단한 단계를 구현하여 여러 DOTM 파일을 쉽게 병합할 수 있습니다.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 DOTM 파일을 병합하는 방법">}}

        ```java    
        // Java API용 GroupDocs.Merger를 사용하여 DOTM 파일 병합
