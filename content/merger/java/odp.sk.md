...
############################# Head ############################
head_title: "Zlúčiť súbory ODP cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero ODP súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "ODP Zlúčenie v Java"
description: "Zlúčte ODP s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero ODP súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov ODP vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory ODP pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť ODP súbory pomocou GroupDocs.Merger for Java API
