...
############################# Head ############################
head_title: "Spoji datoteke TEX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek TEX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "TEX Združitev v Java"
description: "Spojite TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek TEX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TEX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke TEX z API-jem GroupDocs.Merger for Java
