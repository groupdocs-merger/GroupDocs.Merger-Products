...
############################# Head ############################
head_title: "Zlúčiť súbory XLSM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XLSM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XLSM Zlúčenie v Java"
description: "Zlúčte XLSM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XLSM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XLSM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XLSM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XLSM súbory pomocou GroupDocs.Merger for Java API
