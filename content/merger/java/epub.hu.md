...
############################# Head ############################
head_title: "Egyesítse az EPUB fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több EPUB fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "EPUB Egyesülés a Java programban"
description: "Egyesítse a(z) EPUB terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több EPUB fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több EPUB fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen EPUB fájlokat a GroupDocs.Merger for Java API segítségével
