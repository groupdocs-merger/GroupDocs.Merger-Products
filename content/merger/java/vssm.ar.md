...
############################# Head ############################
head_title: "دمج ملفات VSSM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSSM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSSM الاندماج في Java"
description: "دمج VSSM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSSM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
