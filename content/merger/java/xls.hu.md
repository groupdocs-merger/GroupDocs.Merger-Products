...
############################# Head ############################
head_title: "Egyesítse az XLS fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLS fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLS Egyesülés a Java programban"
description: "Egyesítse a(z) XLS terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLS fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLS fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLS fájlokat a GroupDocs.Merger for Java API segítségével
