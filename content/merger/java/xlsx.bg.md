...
############################# Head ############################
head_title: "Обединете XLSX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество XLSX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "XLSX Обединяване в Java"
description: "Обединете XLSX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество XLSX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините XLSX файлове с Java примерен код">}}

        ```java    
        // Обединете XLSX файлове с помощта на GroupDocs.Merger за Java API
