...
############################# Head ############################
head_title: "Egyesítse az BMP fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több BMP fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "BMP Egyesülés a Java programban"
description: "Egyesítse a(z) BMP terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több BMP fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több BMP fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="BMP fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen BMP fájlokat a GroupDocs.Merger for Java API segítségével
