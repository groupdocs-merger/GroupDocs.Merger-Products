...
############################# Head ############################
head_title: "Ühendage OTT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu OTT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "OTT ühinemine programmis Java"
description: "Ühendage OTT mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu OTT faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme OTT faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita OTT faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid OTT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks OTT faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
