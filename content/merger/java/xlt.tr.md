...
############################# Head ############################
head_title: "XLT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLT dosyasını birleştirin."

############################# Header ############################
title: "XLT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLT Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) web sitesini ziyaret ederek birden fazla XLT dosyayı birleştirin.
