...
head_description: "Utilisez GroupDocs.Merger for Java pour intégrer les fonctionnalités de fusion de documents XLSX dans vos projets Java."

############################# Header ############################
title: "Fusionner des fichiers XLSX" 
description: "Avec GroupDocs.Merger for Java, vous pouvez créer des applications avancées Java qui fusionnent et gèrent les documents XLSX sans difficulté."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) permet de fusionner facilement des documents XLSX. Améliorez vos applications Java en combinant plusieurs fichiers en un.
