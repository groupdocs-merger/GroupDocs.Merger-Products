...
############################# Head ############################
head_title: "Spoji datoteke MHTML prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek MHTML v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "MHTML Združitev v Java"
description: "Spojite MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek MHTML v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke MHTML s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke MHTML z API-jem GroupDocs.Merger for Java
