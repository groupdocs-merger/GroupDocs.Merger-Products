...
############################# Head ############################
head_title: "Zlúčiť súbory DOCX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOCX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOCX Zlúčenie v Java"
description: "Zlúčte DOCX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOCX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOCX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOCX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOCX súbory pomocou GroupDocs.Merger for Java API
