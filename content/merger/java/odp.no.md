...
############################# Head ############################
head_title: "Slå sammen ODP filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "ODP sammenslåing i Java"
description: "Slå sammen ODP med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODP filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen ODP filer med GroupDocs.Merger for Java API
