...
############################# Head ############################
head_title: "Egyesítse az PPT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több PPT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "PPT Egyesülés a Java programban"
description: "Egyesítse a(z) PPT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több PPT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több PPT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen PPT fájlokat a GroupDocs.Merger for Java API segítségével
