...
############################# Head ############################
head_title: "Samenvoegen XLSB Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLSB Fusie in Java"
description: "Voeg XLSB samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLSB bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSB bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLSB bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLSB bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) te gaan.
