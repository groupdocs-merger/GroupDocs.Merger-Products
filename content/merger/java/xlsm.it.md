...
############################# Head ############################
head_title: "Unisci file XLSM tramite API di fusione di documenti Java e J2SE"
...
############################# Header ############################
title: "XLSM Fusione in Java"
description: "Unisci XLSM con poche righe di codice Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/it/merger/java/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni Java. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unire XLSM documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) semplifica agli sviluppatori Java l'unione di più file XLSM implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file XLSM utilizzando il codice di esempio Java">}}
        ...
        ```java    
        // Unisci i file XLSM utilizzando GroupDocs.Merger per l'API Java
