...
############################# Head ############################
head_title: "Slå sammen TXT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "TXT sammenslåing i Java"
description: "Slå sammen TXT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TXT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen TXT filer med GroupDocs.Merger for Java API
