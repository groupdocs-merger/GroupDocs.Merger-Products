...
############################# Head ############################
head_title: "JPG Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla JPG dosyasını birleştirin."

############################# Header ############################
title: "JPG Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok JPG Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) web sitesini ziyaret ederek birden fazla JPG dosyayı birleştirin.
