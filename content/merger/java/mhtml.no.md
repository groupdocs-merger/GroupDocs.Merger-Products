...
############################# Head ############################
head_title: "Slå sammen MHTML filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "MHTML sammenslåing i Java"
description: "Slå sammen MHTML med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen MHTML filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen MHTML filer med GroupDocs.Merger for Java API
