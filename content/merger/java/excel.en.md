...
############################# Head ############################
head_title: "Merge EXCEL files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate EXCEL document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge EXCEL files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage EXCEL documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of EXCEL documents. Enhance your Java applications by combining multiple files into one.
