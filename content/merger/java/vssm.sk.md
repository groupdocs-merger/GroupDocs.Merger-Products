...
############################# Head ############################
head_title: "Zlúčiť súbory VSSM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VSSM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VSSM Zlúčenie v Java"
description: "Zlúčte VSSM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VSSM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VSSM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VSSM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VSSM súbory pomocou GroupDocs.Merger for Java API
