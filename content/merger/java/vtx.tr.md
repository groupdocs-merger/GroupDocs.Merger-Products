...
############################# Head ############################
head_title: "VTX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VTX dosyasını birleştirin."

############################# Header ############################
title: "VTX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VTX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) web sitesini ziyaret ederek birden fazla VTX dosyayı birleştirin.
