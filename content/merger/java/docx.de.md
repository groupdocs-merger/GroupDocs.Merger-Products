...
############################# Head ############################
head_title: "Führen Sie DOCX-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere DOCX-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "DOCX Fusion in Java"
description: "Führen Sie DOCX mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere DOCX-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere DOCX-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie DOCX-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie DOCX-Dateien mit GroupDocs.Merger for Java API zusammen
