...
############################# Head ############################
head_title: "Egyesítse az MHT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több MHT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "MHT Egyesülés a Java programban"
description: "Egyesítse a(z) MHT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több MHT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több MHT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen MHT fájlokat a GroupDocs.Merger for Java API segítségével
