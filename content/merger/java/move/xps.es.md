...
############################# Head ############################
head_title: "Mover páginas de XPS en Java"
head_description: "Utiliza GroupDocs.Merger for Java para reordenar páginas en documentos XPS sin esfuerzo. Procesa PDF, Word, Excel, PowerPoint, imágenes y más."

############################# Header ############################
title: "Mover páginas en XPS" 
description: "GroupDocs.Merger for Java permite a las aplicaciones de Java reordenar páginas en documentos XPS de manera fluida."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) te permite mover páginas seleccionadas en documentos XPS. Mejora tus aplicaciones Java con funciones avanzadas de procesamiento de documentos.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mover una página al final del documento"
      content: |
        Aprende cómo mover una página específica al final de un documento XPS.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
