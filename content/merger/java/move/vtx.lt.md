...
############################# Head ############################
head_title: "Perkelti VTX puslapius Java"
head_description: "Perkelkite puslapius VTX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VTX puslapius Java"
description: "Perkelkite VTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VTX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VTX puslapius į internetą"
    content: |
       Perkelkite VTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) svetainėje.
