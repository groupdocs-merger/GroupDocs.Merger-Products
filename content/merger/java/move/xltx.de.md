...
############################# Head ############################
head_title: "Verschiebe XLTX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLTX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLTX Seiten in Java"
description: "Verschieben Sie XLTX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLTX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLTX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLTX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLTX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLTX Seiten online"
    content: |
       Verschieben Sie jetzt XLTX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx) besuchen.
