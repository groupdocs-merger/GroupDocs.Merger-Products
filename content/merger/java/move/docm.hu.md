...
############################# Head ############################
head_title: "DOCM oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy DOCM dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCM oldal mozgatása a Java nyelven"
description: "Mozgasson át DOCM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOCM fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy DOCM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet DOCM fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOCM oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) webhely meglátogatásával azonnal áthelyezhet DOCM fájloldalt.
