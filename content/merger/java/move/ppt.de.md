...
############################# Head ############################
head_title: "Verschiebe PPT Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines PPT-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe PPT Seiten in Java"
description: "Verschieben Sie PPT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie PPT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer PPT-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie PPT-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie PPT Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie PPT Seiten online"
    content: |
       Verschieben Sie jetzt PPT Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) besuchen.
