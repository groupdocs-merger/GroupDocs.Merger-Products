...
############################# Head ############################
head_title: "Premakni VSDX strani v Java"
head_description: "Premaknite strani znotraj dokumenta VSDX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSDX strani v Java"
description: "Premaknite strani VSDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSDX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VSDX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSDX s primerom kode Java">}}
