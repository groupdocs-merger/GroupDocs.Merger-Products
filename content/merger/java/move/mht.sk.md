...
############################# Head ############################
head_title: "Presunúť MHT stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu MHT v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť MHT stránok do Java"
description: "Presuňte MHT stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť MHT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru MHT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru MHT pomocou vzorového kódu Java">}}
