...
############################# Head ############################
head_title: "Siirrä XLSB sivua Java"
head_description: "Siirrä XLSB-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLSB sivua Java"
description: "Siirrä XLSB sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLSB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XLSB-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLSB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XLSB tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XLSB sivua verkkoon"
    content: |
       Siirrä XLSB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) -sivustolla.
