...
############################# Head ############################
head_title: "Sposta le pagine di EXCEL in Java"
head_description: "Utilizza GroupDocs.Merger for Java per riordinare le pagine nei documenti EXCEL senza sforzo. Elabora PDF, Word, Excel, PowerPoint, immagini e altro ancora."

############################# Header ############################
title: "Sposta pagine in EXCEL" 
description: "GroupDocs.Merger for Java consente alle applicazioni Java di riordinare le pagine nei documenti EXCEL in modo fluido."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ti permette di spostare pagine selezionate nei documenti EXCEL. Migliora le tue applicazioni Java con funzionalità avanzate di elaborazione documentale.
      
      1. Specifica il percorso del file EXCEL sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta una pagina alla fine del documento"
      content: |
        Scopri come spostare una pagina specifica alla fine di un documento EXCEL.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
