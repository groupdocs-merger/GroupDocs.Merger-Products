...
############################# Head ############################
head_title: "XLAM oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XLAM dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLAM oldal mozgatása a Java nyelven"
description: "Mozgasson át XLAM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLAM fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XLAM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet XLAM fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLAM oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam) webhely meglátogatásával azonnal áthelyezhet XLAM fájloldalt.
