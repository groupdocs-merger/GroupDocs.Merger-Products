...
############################# Head ############################
head_title: "Perkelti PPS puslapius Java"
head_description: "Perkelkite puslapius PPS dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPS puslapius Java"
description: "Perkelkite PPS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPS failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius PPS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite PPS failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite PPS puslapius į internetą"
    content: |
       Perkelkite PPS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) svetainėje.
