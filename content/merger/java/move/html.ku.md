...
############################# Head ############################
head_title: "Rûpelên HTML di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek HTML ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên HTML Di Java de biguhezînin"
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê HTML biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê HTML bar dike">}}
