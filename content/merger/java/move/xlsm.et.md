...
############################# Head ############################
head_title: "Teisalda XLSM lehte teenuses Java"
head_description: "Teisaldage dokumendi XLSM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSM lehte rakenduses Java"
description: "Teisaldage XLSM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLSM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLSM lehte võrgus"
    content: |
       Teisaldage kohe XLSM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm).
