...
############################# Head ############################
head_title: "Premakni PPSX strani v Java"
head_description: "Premaknite strani znotraj dokumenta PPSX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPSX strani v Java"
description: "Premaknite strani PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke PPSX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPSX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke PPSX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite PPSX strani na splet"
    content: |
       Takoj premaknite strani datoteke PPSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
