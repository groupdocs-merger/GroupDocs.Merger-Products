...
############################# Head ############################
head_title: "Move XLTX Pages in Java"
head_description: "Move pages within a XLTX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLTX Pages In Java"
description: "Move XLTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLTX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLTX Pages Online"
    content: |
       Move XLTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx) website.
