...
############################# Head ############################
head_title: "Færa PDF síður í Java"
head_description: "Færðu síður innan PDF skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PDF síður í Java"
description: "Færðu PDF síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa PDF skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í PDF skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PDF skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu PDF skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu PDF síður á netinu"
    content: |
       Færðu PDF skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) vefsíðu.
