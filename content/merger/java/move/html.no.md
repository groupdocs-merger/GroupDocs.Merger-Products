...
############################# Head ############################
head_title: "Flytt HTML sider i Java"
head_description: "Flytt sider i et HTML-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt HTML sider i Java"
description: "Flytt HTML sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt HTML filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en HTML-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte HTML filsider ved hjelp av Java eksempelkode">}}
