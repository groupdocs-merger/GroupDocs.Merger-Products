...
############################# Head ############################
head_title: "Pārvietot VSTX lapas programmā Java"
head_description: "Pārvietojiet lapas VSTX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSTX lapas programmā Java"
description: "Pārvietojiet VSTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSTX lapas tiešsaistē"
    content: |
       Pārvietojiet VSTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx).
