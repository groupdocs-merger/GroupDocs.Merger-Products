...
############################# Head ############################
head_title: "XLS Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir XLS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLS Sayfayı Java İçinde Taşı"
description: "XLS Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLS Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir XLS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLS dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak XLS dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - XLS Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls) web sitesini ziyaret ederek XLS dosya sayfalarını hemen şimdi taşıyın.
