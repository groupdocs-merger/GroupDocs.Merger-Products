...
############################# Head ############################
head_title: "Alihkan ODP Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen ODP dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODP Halaman Dalam Java"
description: "Alihkan ODP Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan ODP Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail ODP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODP halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan ODP halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan ODP Halaman Dalam Talian"
    content: |
       Alihkan ODP halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp).
