...
############################# Head ############################
head_title: "Perkelti XLAM puslapius Java"
head_description: "Perkelkite puslapius XLAM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLAM puslapius Java"
description: "Perkelkite XLAM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLAM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLAM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLAM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLAM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLAM puslapius į internetą"
    content: |
       Perkelkite XLAM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam) svetainėje.
