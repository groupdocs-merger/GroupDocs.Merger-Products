...
############################# Head ############################
head_title: "Siirrä ONE sivua Java"
head_description: "Siirrä ONE-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ONE sivua Java"
description: "Siirrä ONE sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ONE tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja ONE-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ONE tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä ONE tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä ONE sivua verkkoon"
    content: |
       Siirrä ONE tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) -sivustolla.
