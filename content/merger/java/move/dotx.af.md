...
############################# Head ############################
head_title: "Skuif DOTX bladsye in Java"
head_description: "Skuif bladsye binne 'n DOTX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif DOTX bladsye in Java"
description: "Skuif DOTX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif DOTX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOTX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOTX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif DOTX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif DOTX bladsye aanlyn"
    content: |
       Skuif DOTX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) webwerf te besoek.
