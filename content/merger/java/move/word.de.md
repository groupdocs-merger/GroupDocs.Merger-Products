...
############################# Head ############################
head_title: "Verschiebe WORD Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines WORD-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe WORD Seiten in Java"
description: "Verschieben Sie WORD-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie WORD Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer WORD-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie WORD-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie WORD Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie WORD Seiten online"
    content: |
       Verschieben Sie jetzt WORD Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/word) besuchen.
