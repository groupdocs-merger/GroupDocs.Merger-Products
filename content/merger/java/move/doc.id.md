...
############################# Head ############################
head_title: "Pindahkan DOC Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen DOC di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOC Halaman Di Java"
description: "Pindahkan Halaman DOC dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan DOC Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file DOC dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOC menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan DOC Halaman Online"
    content: |
       Pindahkan halaman file DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/doc).
