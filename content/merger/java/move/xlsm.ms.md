...
############################# Head ############################
head_title: "Alihkan XLSM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLSM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLSM Halaman Dalam Java"
description: "Alihkan XLSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XLSM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XLSM Halaman Dalam Talian"
    content: |
       Alihkan XLSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm).
