...
############################# Head ############################
head_title: "Teisalda PPSX lehte teenuses Java"
head_description: "Teisaldage dokumendi PPSX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPSX lehte rakenduses Java"
description: "Teisaldage PPSX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis PPSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage PPSX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage PPSX lehte võrgus"
    content: |
       Teisaldage kohe PPSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
