...
############################# Head ############################
head_title: "Move VSDM Pages in Java"
head_description: "Move pages within a VSDM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSDM Pages In Java"
description: "Move VSDM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSDM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSDM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSDM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSDM Pages Online"
    content: |
       Move VSDM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm) website.
