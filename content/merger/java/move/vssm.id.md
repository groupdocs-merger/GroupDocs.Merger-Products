...
############################# Head ############################
head_title: "Pindahkan VSSM Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen VSSM di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSSM Halaman Di Java"
description: "Pindahkan Halaman VSSM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan VSSM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file VSSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSSM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan VSSM Halaman Online"
    content: |
       Pindahkan halaman file VSSM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/vssm).
