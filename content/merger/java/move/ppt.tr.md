...
############################# Head ############################
head_title: "PPT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir PPT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPT Sayfayı Java İçinde Taşı"
description: "PPT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir PPT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak PPT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - PPT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) web sitesini ziyaret ederek PPT dosya sayfalarını hemen şimdi taşıyın.
