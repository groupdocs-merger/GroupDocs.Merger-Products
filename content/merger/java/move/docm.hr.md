...
############################# Head ############################
head_title: "Premjesti DOCM stranice u Java"
head_description: "Premjestite stranice unutar DOCM dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOCM stranice u Java"
description: "Premjesti DOCM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOCM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOCM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOCM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOCM stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOCM stranice na mrežu"
    content: |
       Premjestite DOCM stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) web stranice.
