...
############################# Head ############################
head_title: "Skuif PDF bladsye in Java"
head_description: "Skuif bladsye binne 'n PDF dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PDF bladsye in Java"
description: "Skuif PDF bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif PDF lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n PDF-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PDF lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif PDF lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif PDF bladsye aanlyn"
    content: |
       Skuif PDF lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) webwerf te besoek.
