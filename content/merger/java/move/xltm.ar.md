...
############################# Head ############################
head_title: "نقل صفحات XLTM في Java"
head_description: "انقل الصفحات داخل مستند XLTM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLTM في Java"
description: "انقل صفحات XLTM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLTM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLTM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLTM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLTM عبر الإنترنت"
    content: |
       انقل صفحات ملف XLTM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
