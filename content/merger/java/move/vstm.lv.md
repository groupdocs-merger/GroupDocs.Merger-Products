...
############################# Head ############################
head_title: "Pārvietot VSTM lapas programmā Java"
head_description: "Pārvietojiet lapas VSTM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSTM lapas programmā Java"
description: "Pārvietojiet VSTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSTM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSTM lapas tiešsaistē"
    content: |
       Pārvietojiet VSTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
