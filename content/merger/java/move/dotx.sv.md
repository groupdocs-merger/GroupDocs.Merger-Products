...
############################# Head ############################
head_title: "Flytta DOTX sidor i Java"
head_description: "Flytta sidor i ett DOTX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOTX sidor i Java"
description: "Flytta DOTX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta DOTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en DOTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta DOTX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta DOTX sidor online"
    content: |
       Flytta DOTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx).
