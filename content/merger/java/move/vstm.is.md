...
############################# Head ############################
head_title: "Færa VSTM síður í Java"
head_description: "Færðu síður innan VSTM skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSTM síður í Java"
description: "Færðu VSTM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa VSTM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í VSTM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSTM skráarsíður með því að nota Java dæmikóða">}}
