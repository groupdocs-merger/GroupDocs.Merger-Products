...
############################# Head ############################
head_title: "Verschiebe XLAM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLAM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLAM Seiten in Java"
description: "Verschieben Sie XLAM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLAM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLAM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLAM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLAM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLAM Seiten online"
    content: |
       Verschieben Sie jetzt XLAM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam) besuchen.
