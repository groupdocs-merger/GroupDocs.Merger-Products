...
############################# Head ############################
head_title: "Skuif PPTX bladsye in Java"
head_description: "Skuif bladsye binne 'n PPTX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PPTX bladsye in Java"
description: "Skuif PPTX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif PPTX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n PPTX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPTX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif PPTX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif PPTX bladsye aanlyn"
    content: |
       Skuif PPTX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) webwerf te besoek.
