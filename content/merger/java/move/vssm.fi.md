...
############################# Head ############################
head_title: "Siirrä VSSM sivua Java"
head_description: "Siirrä VSSM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSSM sivua Java"
description: "Siirrä VSSM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VSSM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSSM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VSSM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VSSM sivua verkkoon"
    content: |
       Siirrä VSSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) -sivustolla.
