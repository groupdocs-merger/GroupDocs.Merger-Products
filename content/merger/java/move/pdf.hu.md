...
############################# Head ############################
head_title: "PDF oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy PDF dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PDF oldal mozgatása a Java nyelven"
description: "Mozgasson át PDF oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PDF fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy PDF fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF fájloldalak mozgatása a Java példakóddal">}}
