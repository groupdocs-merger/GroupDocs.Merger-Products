...
############################# Head ############################
head_title: "Verschiebe ONENOTE Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines ONENOTE-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe ONENOTE Seiten in Java"
description: "Verschieben Sie ONENOTE-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie ONENOTE Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer ONENOTE-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie ONENOTE-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie ONENOTE Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie ONENOTE Seiten online"
    content: |
       Verschieben Sie jetzt ONENOTE Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/onenote) besuchen.
