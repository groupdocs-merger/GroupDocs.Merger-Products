...
############################# Head ############################
head_title: "Di chuyển DOTM Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu DOTM trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển DOTM Trang trong Java"
description: "Di chuyển các Trang DOTM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển DOTM Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp DOTM bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp DOTM bằng mã mẫu Java">}}
