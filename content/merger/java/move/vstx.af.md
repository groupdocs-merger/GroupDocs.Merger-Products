...
############################# Head ############################
head_title: "Skuif VSTX bladsye in Java"
head_description: "Skuif bladsye binne 'n VSTX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VSTX bladsye in Java"
description: "Skuif VSTX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VSTX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSTX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VSTX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VSTX bladsye aanlyn"
    content: |
       Skuif VSTX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx) webwerf te besoek.
