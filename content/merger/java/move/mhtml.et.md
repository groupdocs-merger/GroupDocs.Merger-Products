...
############################# Head ############################
head_title: "Teisalda MHTML lehte teenuses Java"
head_description: "Teisaldage dokumendi MHTML lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda MHTML lehte rakenduses Java"
description: "Teisaldage MHTML lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda MHTML faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis MHTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada MHTML faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage MHTML faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage MHTML lehte võrgus"
    content: |
       Teisaldage kohe MHTML faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
