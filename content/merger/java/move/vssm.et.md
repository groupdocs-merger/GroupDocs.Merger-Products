...
############################# Head ############################
head_title: "Teisalda VSSM lehte teenuses Java"
head_description: "Teisaldage dokumendi VSSM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSSM lehte rakenduses Java"
description: "Teisaldage VSSM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSSM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSSM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VSSM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VSSM lehte võrgus"
    content: |
       Teisaldage kohe VSSM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
