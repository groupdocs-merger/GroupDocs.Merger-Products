...
############################# Head ############################
head_title: "Premakni ODS strani v Java"
head_description: "Premaknite strani znotraj dokumenta ODS v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ODS strani v Java"
description: "Premaknite strani ODS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ODS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke ODS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ODS s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke ODS z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite ODS strani na splet"
    content: |
       Takoj premaknite strani datoteke ODS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods).
