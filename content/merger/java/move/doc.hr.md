...
############################# Head ############################
head_title: "Premjesti DOC stranice u Java"
head_description: "Premjestite stranice unutar DOC dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOC stranice u Java"
description: "Premjesti DOC stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOC stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOC datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOC stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOC stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOC stranice na mrežu"
    content: |
       Premjestite DOC stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc) web stranice.
