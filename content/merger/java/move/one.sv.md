...
############################# Head ############################
head_title: "Flytta ONE sidor i Java"
head_description: "Flytta sidor i ett ONE-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ONE sidor i Java"
description: "Flytta ONE sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta ONE filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en ONE-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ONE filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta ONE filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta ONE sidor online"
    content: |
       Flytta ONE filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
