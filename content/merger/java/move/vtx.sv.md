...
############################# Head ############################
head_title: "Flytta VTX sidor i Java"
head_description: "Flytta sidor i ett VTX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VTX sidor i Java"
description: "Flytta VTX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VTX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VTX sidor online"
    content: |
       Flytta VTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx).
