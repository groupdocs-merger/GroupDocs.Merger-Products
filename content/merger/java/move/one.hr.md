...
############################# Head ############################
head_title: "Premjesti ONE stranice u Java"
head_description: "Premjestite stranice unutar ONE dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ONE stranice u Java"
description: "Premjesti ONE stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti ONE stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar ONE datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ONE stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti ONE stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti ONE stranice na mrežu"
    content: |
       Premjestite ONE stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) web stranice.
