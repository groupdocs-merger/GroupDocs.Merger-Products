...
############################# Head ############################
head_title: "Færa EPUB síður í Java"
head_description: "Færðu síður innan EPUB skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa EPUB síður í Java"
description: "Færðu EPUB síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa EPUB skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í EPUB skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa EPUB skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu EPUB skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu EPUB síður á netinu"
    content: |
       Færðu EPUB skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) vefsíðu.
