...
############################# Head ############################
head_title: "Flytt VDX sider i Java"
head_description: "Flytt sider i et VDX-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VDX sider i Java"
description: "Flytt VDX sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt VDX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en VDX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VDX filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt VDX filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt VDX sider på nettet"
    content: |
       Flytt VDX filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx) nettstedet.
