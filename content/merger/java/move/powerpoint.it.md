...
############################# Head ############################
head_title: "Sposta le pagine di POWERPOINT in Java"
head_description: "Utilizza GroupDocs.Merger for Java per riordinare le pagine nei documenti POWERPOINT senza sforzo. Elabora PDF, Word, Excel, PowerPoint, immagini e altro ancora."

############################# Header ############################
title: "Sposta pagine in POWERPOINT" 
description: "GroupDocs.Merger for Java consente alle applicazioni Java di riordinare le pagine nei documenti POWERPOINT in modo fluido."
...
steps:
    enable: true
    title: "Come spostare le pagine di POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/java/) ti permette di spostare pagine selezionate nei documenti POWERPOINT. Migliora le tue applicazioni Java con funzionalità avanzate di elaborazione documentale.
      
      1. Specifica il percorso del file POWERPOINT sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta una pagina alla fine del documento"
      content: |
        Scopri come spostare una pagina specifica alla fine di un documento POWERPOINT.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
