...
############################# Head ############################
head_title: "Verschiebe DOT Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines DOT-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe DOT Seiten in Java"
description: "Verschieben Sie DOT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie DOT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer DOT-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie DOT-Dateiseiten mit Java-Beispielcode">}}
