...
############################# Head ############################
head_title: "Premakni MHT strani v Java"
head_description: "Premaknite strani znotraj dokumenta MHT v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni MHT strani v Java"
description: "Premaknite strani MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke MHT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke MHT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke MHT s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke MHT z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite MHT strani na splet"
    content: |
       Takoj premaknite strani datoteke MHT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
