...
############################# Head ############################
head_title: "Di chuyển ODT Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu ODT trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển ODT Trang trong Java"
description: "Di chuyển các Trang ODT với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển ODT Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp ODT bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp ODT bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp ODT bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Di chuyển ODT Trang trực tuyến"
    content: |
       Di chuyển các trang tệp ODT ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ odt) trang web.
