...
############################# Head ############################
head_title: "Premjesti VSX stranice u Java"
head_description: "Premjestite stranice unutar VSX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSX stranice u Java"
description: "Premjesti VSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VSX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VSX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VSX stranice na mrežu"
    content: |
       Premjestite VSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) web stranice.
