...
############################# Head ############################
head_title: "Presunúť XLT stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu XLT v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLT stránok do Java"
description: "Presuňte XLT stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť XLT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru XLT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLT pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru XLT pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte XLT stránok online"
    content: |
       Presuňte stránky súboru XLT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
