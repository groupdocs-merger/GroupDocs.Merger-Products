...
############################# Head ############################
head_title: "Presunúť MHTML stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu MHTML v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť MHTML stránok do Java"
description: "Presuňte MHTML stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť MHTML strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru MHTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru MHTML pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru MHTML pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte MHTML stránok online"
    content: |
       Presuňte stránky súboru MHTML hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
