...
############################# Head ############################
head_title: "نقل صفحات XLAM في Java"
head_description: "انقل الصفحات داخل مستند XLAM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLAM في Java"
description: "انقل صفحات XLAM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLAM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLAM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLAM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLAM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLAM عبر الإنترنت"
    content: |
       انقل صفحات ملف XLAM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam).
