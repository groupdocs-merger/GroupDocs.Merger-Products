...
############################# Head ############################
head_title: "Verschiebe VTX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VTX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VTX Seiten in Java"
description: "Verschieben Sie VTX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VTX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VTX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VTX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VTX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VTX Seiten online"
    content: |
       Verschieben Sie jetzt VTX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) besuchen.
