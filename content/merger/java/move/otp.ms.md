...
############################# Head ############################
head_title: "Alihkan OTP Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen OTP dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan OTP Halaman Dalam Java"
description: "Alihkan OTP Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan OTP Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail OTP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan OTP halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan OTP halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan OTP Halaman Dalam Talian"
    content: |
       Alihkan OTP halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
