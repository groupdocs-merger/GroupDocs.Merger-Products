...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to move selected pages in EPUB documents. Enhance your Java applications with advanced document processing features.
      
      1. Specify the source EPUB file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Move a page to the end of the document"
      content: |
        Learn how to move a specific page to the end of a EPUB document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
