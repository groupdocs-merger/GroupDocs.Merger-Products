...
############################# Head ############################
head_title: "Alihkan DOCX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen DOCX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOCX Halaman Dalam Java"
description: "Alihkan DOCX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan DOCX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail DOCX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOCX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan DOCX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan DOCX Halaman Dalam Talian"
    content: |
       Alihkan DOCX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx).
