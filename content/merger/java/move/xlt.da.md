...
############################# Head ############################
head_title: "Flyt XLT sider i Java"
head_description: "Flyt sider i et XLT-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLT sider i Java"
description: "Flyt XLT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt XLT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en XLT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLT filsider ved hjælp af Java eksempelkode">}}
