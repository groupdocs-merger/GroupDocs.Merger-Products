...
############################# Head ############################
head_title: "نقل صفحات HTML في Java"
head_description: "انقل الصفحات داخل مستند HTML في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات HTML في Java"
description: "انقل صفحات HTML ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل HTML صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف HTML من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف HTML باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف HTML باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات HTML عبر الإنترنت"
    content: |
       انقل صفحات ملف HTML الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
