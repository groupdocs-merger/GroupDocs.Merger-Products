...
############################# Head ############################
head_title: "Flytta PPT sidor i Java"
head_description: "Flytta sidor i ett PPT-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPT sidor i Java"
description: "Flytta PPT sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta PPT filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en PPT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPT filsidor med hjälp av Java exempelkod">}}
