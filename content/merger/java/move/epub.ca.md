...
############################# Head ############################
head_title: "Mou EPUB pàgines a Java"
head_description: "Mou les pàgines d'un document EPUB a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou EPUB pàgines a Java"
description: "Mou EPUB pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou EPUB pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer EPUB implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers EPUB utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou EPUB pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou EPUB pàgines en línia"
    content: |
       Mou les pàgines de fitxers EPUB ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
