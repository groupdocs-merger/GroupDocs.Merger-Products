...
############################# Head ############################
head_title: "Skuif VSDX bladsye in Java"
head_description: "Skuif bladsye binne 'n VSDX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VSDX bladsye in Java"
description: "Skuif VSDX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VSDX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSDX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VSDX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VSDX bladsye aanlyn"
    content: |
       Skuif VSDX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) webwerf te besoek.
