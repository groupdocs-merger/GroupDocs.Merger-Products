...
############################# Head ############################
head_title: "Flyt MHTML sider i Java"
head_description: "Flyt sider i et MHTML-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt MHTML sider i Java"
description: "Flyt MHTML sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt MHTML filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en MHTML-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes MHTML filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Flyt MHTML filsider ved hjælp af GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemoer - Flyt MHTML sider online"
    content: |
       Flyt MHTML filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
