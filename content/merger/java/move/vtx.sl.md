...
############################# Head ############################
head_title: "Premakni VTX strani v Java"
head_description: "Premaknite strani znotraj dokumenta VTX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VTX strani v Java"
description: "Premaknite strani VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VTX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke VTX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite VTX strani na splet"
    content: |
       Takoj premaknite strani datoteke VTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx).
