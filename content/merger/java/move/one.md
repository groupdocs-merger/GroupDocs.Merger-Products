...
############################# Head ############################
head_title: "Move ONE Pages in Java"
head_description: "Move pages within a ONE document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move ONE Pages In Java"
description: "Move ONE Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move ONE File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a ONE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ONE file pages using Java example code">}}

        ```java    
        // Move ONE file pages using GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live Demos - Move ONE Pages Online"
    content: |
       Move ONE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) website.
