...
############################# Head ############################
head_title: "PDF Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir PDF belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PDF Sayfayı Java İçinde Taşı"
description: "PDF Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PDF Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir PDF dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PDF dosya sayfaları nasıl taşınır">}}
