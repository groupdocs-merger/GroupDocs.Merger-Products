...
############################# Head ############################
head_title: "Pārvietot PPT lapas programmā Java"
head_description: "Pārvietojiet lapas PPT dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPT lapas programmā Java"
description: "Pārvietojiet PPT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas PPT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet PPT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet PPT lapas tiešsaistē"
    content: |
       Pārvietojiet PPT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
