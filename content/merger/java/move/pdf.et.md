...
############################# Head ############################
head_title: "Teisalda PDF lehte teenuses Java"
head_description: "Teisaldage dokumendi PDF lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PDF lehte rakenduses Java"
description: "Teisaldage PDF lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PDF faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis PDF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PDF faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage PDF faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage PDF lehte võrgus"
    content: |
       Teisaldage kohe PDF faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
