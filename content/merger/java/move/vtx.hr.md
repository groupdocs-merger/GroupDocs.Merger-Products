...
############################# Head ############################
head_title: "Premjesti VTX stranice u Java"
head_description: "Premjestite stranice unutar VTX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VTX stranice u Java"
description: "Premjesti VTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VTX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VTX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VTX stranice na mrežu"
    content: |
       Premjestite VTX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) web stranice.
