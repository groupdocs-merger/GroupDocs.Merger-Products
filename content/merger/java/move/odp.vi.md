...
############################# Head ############################
head_title: "Di chuyển ODP Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu ODP trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển ODP Trang trong Java"
description: "Di chuyển các Trang ODP với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển ODP Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp ODP bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp ODP bằng mã mẫu Java">}}
