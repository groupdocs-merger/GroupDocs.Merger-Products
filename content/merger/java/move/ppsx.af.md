...
############################# Head ############################
head_title: "Skuif PPSX bladsye in Java"
head_description: "Skuif bladsye binne 'n PPSX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PPSX bladsye in Java"
description: "Skuif PPSX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif PPSX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n PPSX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif PPSX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif PPSX bladsye aanlyn"
    content: |
       Skuif PPSX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) webwerf te besoek.
