...
############################# Head ############################
head_title: "Bog MHTML Leathanaigh i Java"
head_description: "Bog leathanaigh laistigh de dhoiciméad MHTML in Java go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog MHTML Leathanaigh I Java"
description: "Bog MHTML Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bog MHTML Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a bhogadh laistigh de chomhad MHTML trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas MHTML leathanaigh chomhaid a bhogadh ag úsáid cód sampla Java">}}
