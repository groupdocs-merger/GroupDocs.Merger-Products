...
############################# Head ############################
head_title: "Perkelti ODP puslapius Java"
head_description: "Perkelkite puslapius ODP dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODP puslapius Java"
description: "Perkelkite ODP puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODP failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius ODP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite ODP failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite ODP puslapius į internetą"
    content: |
       Perkelkite ODP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) svetainėje.
