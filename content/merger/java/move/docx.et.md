...
############################# Head ############################
head_title: "Teisalda DOCX lehte teenuses Java"
head_description: "Teisaldage dokumendi DOCX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOCX lehte rakenduses Java"
description: "Teisaldage DOCX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOCX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOCX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOCX faililehte, kasutades Java näitekoodi">}}
