...
############################# Head ############################
head_title: "Premjesti XLS stranice u Java"
head_description: "Premjestite stranice unutar XLS dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLS stranice u Java"
description: "Premjesti XLS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti XLS stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar XLS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti XLS stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti XLS stranice na mrežu"
    content: |
       Premjestite XLS stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls) web stranice.
