...
############################# Head ############################
head_title: "Perkelti PPTX puslapius Java"
head_description: "Perkelkite puslapius PPTX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPTX puslapius Java"
description: "Perkelkite PPTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPTX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius PPTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite PPTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite PPTX puslapius į internetą"
    content: |
       Perkelkite PPTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) svetainėje.
