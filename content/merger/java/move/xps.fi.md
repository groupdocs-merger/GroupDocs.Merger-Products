...
############################# Head ############################
head_title: "Siirrä XPS sivua Java"
head_description: "Siirrä XPS-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XPS sivua Java"
description: "Siirrä XPS sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XPS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XPS-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XPS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XPS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XPS sivua verkkoon"
    content: |
       Siirrä XPS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) -sivustolla.
