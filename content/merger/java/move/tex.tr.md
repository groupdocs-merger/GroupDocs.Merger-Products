...
############################# Head ############################
head_title: "TEX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir TEX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "TEX Sayfayı Java İçinde Taşı"
description: "TEX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "TEX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir TEX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TEX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak TEX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - TEX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) web sitesini ziyaret ederek TEX dosya sayfalarını hemen şimdi taşıyın.
