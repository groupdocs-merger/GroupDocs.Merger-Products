...
############################# Head ############################
head_title: "Færa PPTX síður í Java"
head_description: "Færðu síður innan PPTX skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPTX síður í Java"
description: "Færðu PPTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa PPTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í PPTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPTX skráarsíður með því að nota Java dæmikóða">}}
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu PPTX síður á netinu"
    content: |
       Færðu PPTX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) vefsíðu.
