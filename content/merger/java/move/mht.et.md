...
############################# Head ############################
head_title: "Teisalda MHT lehte teenuses Java"
head_description: "Teisaldage dokumendi MHT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda MHT lehte rakenduses Java"
description: "Teisaldage MHT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda MHT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis MHT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada MHT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage MHT faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage MHT lehte võrgus"
    content: |
       Teisaldage kohe MHT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
