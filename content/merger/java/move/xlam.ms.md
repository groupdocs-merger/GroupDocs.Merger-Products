...
############################# Head ############################
head_title: "Alihkan XLAM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLAM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLAM Halaman Dalam Java"
description: "Alihkan XLAM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLAM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLAM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLAM halaman fail menggunakan kod contoh Java.">}}
