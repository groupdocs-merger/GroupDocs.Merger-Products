...
head_description: "Move pages within a PPTX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move PPTX Pages In Java"
description: "Move PPTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move PPTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a PPTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPTX file pages using Java example code">}}
