...
############################# Head ############################
head_title: "Premjesti ODP stranice u Java"
head_description: "Premjestite stranice unutar ODP dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ODP stranice u Java"
description: "Premjesti ODP stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti ODP stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar ODP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ODP stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti ODP stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti ODP stranice na mrežu"
    content: |
       Premjestite ODP stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) web stranice.
