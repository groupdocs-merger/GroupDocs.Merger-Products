...
############################# Head ############################
head_title: "Di chuyển PPS Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu PPS trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển PPS Trang trong Java"
description: "Di chuyển các Trang PPS với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển PPS Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp PPS bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp PPS bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp PPS bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Di chuyển PPS Trang trực tuyến"
    content: |
       Di chuyển các trang tệp PPS ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ pps) trang web.
