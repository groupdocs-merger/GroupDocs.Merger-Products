...
############################# Head ############################
head_title: "RTF Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir RTF belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "RTF Sayfayı Java İçinde Taşı"
description: "RTF Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "RTF Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir RTF dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak RTF dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak RTF dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - RTF Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) web sitesini ziyaret ederek RTF dosya sayfalarını hemen şimdi taşıyın.
