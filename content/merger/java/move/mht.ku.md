...
############################# Head ############################
head_title: "Rûpelên MHT di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek MHT ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên MHT Di Java de biguhezînin"
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê MHT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê MHT bar dike">}}
