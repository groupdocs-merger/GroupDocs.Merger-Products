...
############################# Head ############################
head_title: "Siirrä XLAM sivua Java"
head_description: "Siirrä XLAM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLAM sivua Java"
description: "Siirrä XLAM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLAM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XLAM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLAM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XLAM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XLAM sivua verkkoon"
    content: |
       Siirrä XLAM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam) -sivustolla.
