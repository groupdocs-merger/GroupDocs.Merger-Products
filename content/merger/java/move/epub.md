...
############################# Head ############################
head_title: "Move EPUB Pages in Java"
head_description: "Move pages within a EPUB document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move EPUB Pages In Java"
description: "Move EPUB Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move EPUB File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a EPUB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move EPUB file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move EPUB Pages Online"
    content: |
       Move EPUB file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) website.
