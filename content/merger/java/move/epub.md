...
############################# Head ############################
head_title: "Move, Rearrange & Reorder EPUB Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a EPUB document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder EPUB Pages in Java"
description: "Move and Rearrange the pages within a EPUB document to any position using documents merger API for Java & J2SE applications."
