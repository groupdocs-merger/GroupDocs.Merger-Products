...
############################# Head ############################
head_title: "Przenieś MHTML strony w Java"
head_description: "Przenieś strony w dokumencie MHTML w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś MHTML strony w Java"
description: "Przenieś strony MHTML za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików MHTML do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku MHTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść MHTML strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików MHTML za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś MHTML strony online"
    content: |
       Przenieś strony plików MHTML już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
