...
############################# Head ############################
head_title: "Verschiebe VSSM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSSM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSSM Seiten in Java"
description: "Verschieben Sie VSSM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSSM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSSM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSSM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSSM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSSM Seiten online"
    content: |
       Verschieben Sie jetzt VSSM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) besuchen.
