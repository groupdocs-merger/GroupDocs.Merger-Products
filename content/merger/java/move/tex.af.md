...
############################# Head ############################
head_title: "Skuif TEX bladsye in Java"
head_description: "Skuif bladsye binne 'n TEX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif TEX bladsye in Java"
description: "Skuif TEX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif TEX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n TEX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TEX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}
