...
############################# Head ############################
head_title: "Verschiebe VSSX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSSX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSSX Seiten in Java"
description: "Verschieben Sie VSSX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSSX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSSX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSSX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSSX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSSX Seiten online"
    content: |
       Verschieben Sie jetzt VSSX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) besuchen.
