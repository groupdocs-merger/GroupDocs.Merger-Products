...
############################# Head ############################
head_title: "Pārvietot XLSM lapas programmā Java"
head_description: "Pārvietojiet lapas XLSM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLSM lapas programmā Java"
description: "Pārvietojiet XLSM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLSM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLSM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLSM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLSM lapas tiešsaistē"
    content: |
       Pārvietojiet XLSM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm).
