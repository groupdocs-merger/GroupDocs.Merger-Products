...
############################# Head ############################
head_title: "EPUB Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir EPUB belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "EPUB Sayfayı Java İçinde Taşı"
description: "EPUB Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "EPUB Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir EPUB dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak EPUB dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak EPUB dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - EPUB Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) web sitesini ziyaret ederek EPUB dosya sayfalarını hemen şimdi taşıyın.
