...
############################# Head ############################
head_title: "Przenieś VSTM strony w Java"
head_description: "Przenieś strony w dokumencie VSTM w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VSTM strony w Java"
description: "Przenieś strony VSTM za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VSTM do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku VSTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VSTM strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików VSTM za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś VSTM strony online"
    content: |
       Przenieś strony plików VSTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
