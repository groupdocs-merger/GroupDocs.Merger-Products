...
############################# Head ############################
head_title: "Siirrä ODT sivua Java"
head_description: "Siirrä ODT-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODT sivua Java"
description: "Siirrä ODT sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja ODT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä ODT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä ODT sivua verkkoon"
    content: |
       Siirrä ODT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) -sivustolla.
