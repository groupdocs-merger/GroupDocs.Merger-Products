...
############################# Head ############################
head_title: "Alihkan VSSM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSSM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSSM Halaman Dalam Java"
description: "Alihkan VSSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSSM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSSM Halaman Dalam Talian"
    content: |
       Alihkan VSSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
