...
############################# Head ############################
head_title: "Færa DOTX síður í Java"
head_description: "Færðu síður innan DOTX skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOTX síður í Java"
description: "Færðu DOTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa DOTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í DOTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOTX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu DOTX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu DOTX síður á netinu"
    content: |
       Færðu DOTX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) vefsíðu.
