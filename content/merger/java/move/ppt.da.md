...
############################# Head ############################
head_title: "Flyt PPT sider i Java"
head_description: "Flyt sider i et PPT-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PPT sider i Java"
description: "Flyt PPT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt PPT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en PPT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PPT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Flyt PPT filsider ved hjælp af GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemoer - Flyt PPT sider online"
    content: |
       Flyt PPT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
