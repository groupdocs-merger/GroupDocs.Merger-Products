...
############################# Head ############################
head_title: "ODP oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy ODP dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODP oldal mozgatása a Java nyelven"
description: "Mozgasson át ODP oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODP fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy ODP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet ODP fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ODP oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) webhely meglátogatásával azonnal áthelyezhet ODP fájloldalt.
