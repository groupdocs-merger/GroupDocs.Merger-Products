...
############################# Head ############################
head_title: "Rûpelên PPS di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek PPS ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PPS Di Java de biguhezînin"
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê PPS biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê PPS bar dike">}}
