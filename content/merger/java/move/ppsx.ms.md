...
############################# Head ############################
head_title: "Alihkan PPSX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen PPSX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPSX Halaman Dalam Java"
description: "Alihkan PPSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan PPSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail PPSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan PPSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan PPSX Halaman Dalam Talian"
    content: |
       Alihkan PPSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
