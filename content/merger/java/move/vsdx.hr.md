...
############################# Head ############################
head_title: "Premjesti VSDX stranice u Java"
head_description: "Premjestite stranice unutar VSDX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSDX stranice u Java"
description: "Premjesti VSDX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VSDX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VSDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSDX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VSDX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VSDX stranice na mrežu"
    content: |
       Premjestite VSDX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) web stranice.
