...
############################# Head ############################
head_title: "Rûpelên OTT di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek OTT ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên OTT Di Java de biguhezînin"
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê OTT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê OTT bar dike">}}
