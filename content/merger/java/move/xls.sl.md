...
############################# Head ############################
head_title: "Premakni XLS strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLS v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLS strani v Java"
description: "Premaknite strani XLS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLS s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke XLS z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite XLS strani na splet"
    content: |
       Takoj premaknite strani datoteke XLS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
