...
############################# Head ############################
head_title: "Færa OTT síður í Java"
head_description: "Færðu síður innan OTT skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa OTT síður í Java"
description: "Færðu OTT síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa OTT skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í OTT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa OTT skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu OTT skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu OTT síður á netinu"
    content: |
       Færðu OTT skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) vefsíðu.
