...
############################# Head ############################
head_title: "Siirrä XLSM sivua Java"
head_description: "Siirrä XLSM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLSM sivua Java"
description: "Siirrä XLSM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XLSM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLSM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XLSM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XLSM sivua verkkoon"
    content: |
       Siirrä XLSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) -sivustolla.
