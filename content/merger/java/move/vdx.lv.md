...
############################# Head ############################
head_title: "Pārvietot VDX lapas programmā Java"
head_description: "Pārvietojiet lapas VDX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VDX lapas programmā Java"
description: "Pārvietojiet VDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VDX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VDX lapas tiešsaistē"
    content: |
       Pārvietojiet VDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
