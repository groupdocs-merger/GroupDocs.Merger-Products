...
############################# Head ############################
head_title: "Pārvietot XLSX lapas programmā Java"
head_description: "Pārvietojiet lapas XLSX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLSX lapas programmā Java"
description: "Pārvietojiet XLSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLSX lapas tiešsaistē"
    content: |
       Pārvietojiet XLSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx).
