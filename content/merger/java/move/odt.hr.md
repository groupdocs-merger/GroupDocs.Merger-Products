...
############################# Head ############################
head_title: "Premjesti ODT stranice u Java"
head_description: "Premjestite stranice unutar ODT dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ODT stranice u Java"
description: "Premjesti ODT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti ODT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar ODT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ODT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti ODT stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti ODT stranice na mrežu"
    content: |
       Premjestite ODT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) web stranice.
