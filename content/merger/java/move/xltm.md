...
############################# Head ############################
head_title: "Move XLTM Pages in Java"
head_description: "Move pages within a XLTM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLTM Pages In Java"
description: "Move XLTM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLTM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLTM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLTM Pages Online"
    content: |
       Move XLTM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) website.
