...
############################# Head ############################
head_title: "Teisalda XLSX lehte teenuses Java"
head_description: "Teisaldage dokumendi XLSX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSX lehte rakenduses Java"
description: "Teisaldage XLSX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLSX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLSX lehte võrgus"
    content: |
       Teisaldage kohe XLSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx).
