...
############################# Head ############################
head_title: "Premakni RTF strani v Java"
head_description: "Premaknite strani znotraj dokumenta RTF v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni RTF strani v Java"
description: "Premaknite strani RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke RTF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke RTF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke RTF s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke RTF z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite RTF strani na splet"
    content: |
       Takoj premaknite strani datoteke RTF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
