...
############################# Head ############################
head_title: "Flytta OTP sidor i Java"
head_description: "Flytta sidor i ett OTP-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta OTP sidor i Java"
description: "Flytta OTP sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta OTP filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en OTP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar OTP filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta OTP filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta OTP sidor online"
    content: |
       Flytta OTP filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
