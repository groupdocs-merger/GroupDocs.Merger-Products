...
############################# Head ############################
head_title: "Verschiebe IMAGE Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines IMAGE-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe IMAGE Seiten in Java"
description: "Verschieben Sie IMAGE-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie IMAGE Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer IMAGE-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie IMAGE-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie IMAGE Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie IMAGE Seiten online"
    content: |
       Verschieben Sie jetzt IMAGE Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/image) besuchen.
