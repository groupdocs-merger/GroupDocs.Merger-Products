...
############################# Head ############################
head_title: "Verschiebe TEX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines TEX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe TEX Seiten in Java"
description: "Verschieben Sie TEX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie TEX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer TEX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie TEX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie TEX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie TEX Seiten online"
    content: |
       Verschieben Sie jetzt TEX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) besuchen.
