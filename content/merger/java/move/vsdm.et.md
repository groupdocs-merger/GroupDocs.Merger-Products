...
############################# Head ############################
head_title: "Teisalda VSDM lehte teenuses Java"
head_description: "Teisaldage dokumendi VSDM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSDM lehte rakenduses Java"
description: "Teisaldage VSDM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSDM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSDM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSDM faililehte, kasutades Java näitekoodi">}}
