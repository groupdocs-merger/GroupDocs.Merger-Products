...
############################# Head ############################
head_title: "Verschiebe ODT Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines ODT-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe ODT Seiten in Java"
description: "Verschieben Sie ODT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie ODT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer ODT-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie ODT-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie ODT Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie ODT Seiten online"
    content: |
       Verschieben Sie jetzt ODT Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) besuchen.
