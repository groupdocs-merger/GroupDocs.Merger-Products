...
############################# Head ############################
head_title: "Verschiebe XLSB Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLSB-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLSB Seiten in Java"
description: "Verschieben Sie XLSB-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLSB Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLSB-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLSB-Dateiseiten mit Java-Beispielcode">}}
