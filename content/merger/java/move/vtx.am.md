...
############################# Head ############################
head_title: "VTX ገጾችን በJava ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በVTX ሰነድ ውስጥ በJava ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "VTX ገጾችን በJava ውስጥ አንቀሳቅስ"
description: "VTX ገጾችን ከጥቂት መስመሮች Java ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "VTX የፋይል ገጾችን በJava አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በVTX ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የVTX ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም VTX የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - VTX ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የVTX ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
