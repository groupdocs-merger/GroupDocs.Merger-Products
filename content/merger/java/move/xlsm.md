...
############################# Head ############################
head_title: "Move XLSM Pages in Java"
head_description: "Move pages within a XLSM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLSM Pages In Java"
description: "Move XLSM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLSM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLSM Pages Online"
    content: |
       Move XLSM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) website.
