...
############################# Head ############################
head_title: "Siirrä VSDX sivua Java"
head_description: "Siirrä VSDX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSDX sivua Java"
description: "Siirrä VSDX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VSDX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSDX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VSDX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VSDX sivua verkkoon"
    content: |
       Siirrä VSDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) -sivustolla.
