...
############################# Head ############################
head_title: "Færa XLSB síður í Java"
head_description: "Færðu síður innan XLSB skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLSB síður í Java"
description: "Færðu XLSB síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa XLSB skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í XLSB skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLSB skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu XLSB skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu XLSB síður á netinu"
    content: |
       Færðu XLSB skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) vefsíðu.
