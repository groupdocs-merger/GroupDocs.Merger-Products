...
############################# Head ############################
head_title: "Alihkan TEX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen TEX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan TEX Halaman Dalam Java"
description: "Alihkan TEX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan TEX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail TEX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan TEX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan TEX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan TEX Halaman Dalam Talian"
    content: |
       Alihkan TEX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex).
