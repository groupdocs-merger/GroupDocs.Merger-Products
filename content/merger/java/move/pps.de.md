...
############################# Head ############################
head_title: "Verschiebe PPS Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines PPS-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe PPS Seiten in Java"
description: "Verschieben Sie PPS-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie PPS Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer PPS-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie PPS-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie PPS Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie PPS Seiten online"
    content: |
       Verschieben Sie jetzt PPS Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) besuchen.
