...
############################# Head ############################
head_title: "Przenieś PDF strony w Java"
head_description: "Przenieś strony w dokumencie PDF w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś PDF strony w Java"
description: "Przenieś strony PDF za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików PDF do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku PDF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść PDF strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików PDF za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś PDF strony online"
    content: |
       Przenieś strony plików PDF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
