...
############################# Head ############################
head_title: "Alihkan VTX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VTX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VTX Halaman Dalam Java"
description: "Alihkan VTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VTX Halaman Dalam Talian"
    content: |
       Alihkan VTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx).
