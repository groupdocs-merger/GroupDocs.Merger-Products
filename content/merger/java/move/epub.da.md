...
############################# Head ############################
head_title: "Flyt EPUB sider i Java"
head_description: "Flyt sider i et EPUB-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt EPUB sider i Java"
description: "Flyt EPUB sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt EPUB filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en EPUB-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes EPUB filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Flyt EPUB filsider ved hjælp af GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemoer - Flyt EPUB sider online"
    content: |
       Flyt EPUB filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
