...
############################# Head ############################
head_title: "Flytta TEX sidor i Java"
head_description: "Flytta sidor i ett TEX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta TEX sidor i Java"
description: "Flytta TEX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta TEX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en TEX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar TEX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta TEX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta TEX sidor online"
    content: |
       Flytta TEX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex).
