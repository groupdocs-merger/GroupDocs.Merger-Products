...
############################# Head ############################
head_title: "Flytt MHT sider i Java"
head_description: "Flytt sider i et MHT-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt MHT sider i Java"
description: "Flytt MHT sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt MHT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en MHT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte MHT filsider ved hjelp av Java eksempelkode">}}
