...
############################# Head ############################
head_title: "Flytta PPSX sidor i Java"
head_description: "Flytta sidor i ett PPSX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPSX sidor i Java"
description: "Flytta PPSX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta PPSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en PPSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta PPSX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta PPSX sidor online"
    content: |
       Flytta PPSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
