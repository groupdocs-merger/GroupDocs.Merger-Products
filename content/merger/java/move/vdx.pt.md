...
############################# Head ############################
head_title: "Mover VDX Páginas em Java"
head_description: "Mova as páginas em um documento VDX em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VDX Páginas em Java"
description: "Mova VDX Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VDX em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo VDX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VDX usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo VDX usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover VDX páginas on-line"
    content: |
       Mova as páginas do arquivo VDX agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
