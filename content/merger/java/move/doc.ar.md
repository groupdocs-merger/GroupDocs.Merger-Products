...
############################# Head ############################
head_title: "نقل صفحات DOC في Java"
head_description: "انقل الصفحات داخل مستند DOC في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOC في Java"
description: "انقل صفحات DOC ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOC صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOC من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOC باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOC باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOC عبر الإنترنت"
    content: |
       انقل صفحات ملف DOC الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc).
