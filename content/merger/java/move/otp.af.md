...
############################# Head ############################
head_title: "Skuif OTP bladsye in Java"
head_description: "Skuif bladsye binne 'n OTP dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif OTP bladsye in Java"
description: "Skuif OTP bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif OTP lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n OTP-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTP lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif OTP lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif OTP bladsye aanlyn"
    content: |
       Skuif OTP lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) webwerf te besoek.
