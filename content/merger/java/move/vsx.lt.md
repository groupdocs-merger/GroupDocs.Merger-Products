...
############################# Head ############################
head_title: "Perkelti VSX puslapius Java"
head_description: "Perkelkite puslapius VSX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSX puslapius Java"
description: "Perkelkite VSX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VSX puslapius į internetą"
    content: |
       Perkelkite VSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) svetainėje.
