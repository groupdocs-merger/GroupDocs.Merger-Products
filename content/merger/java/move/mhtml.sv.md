...
############################# Head ############################
head_title: "Flytta MHTML sidor i Java"
head_description: "Flytta sidor i ett MHTML-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta MHTML sidor i Java"
description: "Flytta MHTML sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta MHTML filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en MHTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar MHTML filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta MHTML filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta MHTML sidor online"
    content: |
       Flytta MHTML filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
