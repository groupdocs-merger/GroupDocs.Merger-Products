...
############################# Head ############################
head_title: "OTT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir OTT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "OTT Sayfayı Java İçinde Taşı"
description: "OTT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "OTT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir OTT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak OTT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - OTT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) web sitesini ziyaret ederek OTT dosya sayfalarını hemen şimdi taşıyın.
