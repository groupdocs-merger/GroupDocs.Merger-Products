...
############################# Head ############################
head_title: "Færa VSSM síður í Java"
head_description: "Færðu síður innan VSSM skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSSM síður í Java"
description: "Færðu VSSM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa VSSM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í VSSM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSSM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu VSSM skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu VSSM síður á netinu"
    content: |
       Færðu VSSM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) vefsíðu.
