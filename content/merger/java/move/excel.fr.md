...
############################# Head ############################
head_title: "Déplacer des pages EXCEL dans Java"
head_description: "Utilisez GroupDocs.Merger for Java pour réorganiser les pages dans des documents EXCEL sans effort. Traitez des PDF, des documents Word, des feuilles Excel, des présentations PowerPoint, des images, et plus encore."

############################# Header ############################
title: "Déplacer des pages dans EXCEL" 
description: "GroupDocs.Merger for Java permet aux applications Java de réorganiser les pages dans des documents EXCEL de manière transparente."
...
steps:
    enable: true
    title: "Comment déplacer des pages EXCEL"
    content: |
      [GroupDocs.Merger](/merger/java/) vous permet de déplacer des pages sélectionnées dans des documents EXCEL. Améliorez vos applications Java avec des fonctionnalités avancées de traitement de documents.
      
      1. Spécifiez le chemin du fichier EXCEL source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Déplacer une page à la fin du document"
      content: |
        Découvrez comment déplacer une page spécifique à la fin d'un document EXCEL.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
