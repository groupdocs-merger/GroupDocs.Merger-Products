...
############################# Head ############################
head_title: "VSTX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy VSTX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTX oldal mozgatása a Java nyelven"
description: "Mozgasson át VSTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy VSTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet VSTX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSTX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx) webhely meglátogatásával azonnal áthelyezhet VSTX fájloldalt.
