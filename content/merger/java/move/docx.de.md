...
############################# Head ############################
head_title: "Verschiebe DOCX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines DOCX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe DOCX Seiten in Java"
description: "Verschieben Sie DOCX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie DOCX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer DOCX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie DOCX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie DOCX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie DOCX Seiten online"
    content: |
       Verschieben Sie jetzt DOCX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) besuchen.
