...
############################# Head ############################
head_title: "نقل صفحات VSDM في Java"
head_description: "انقل الصفحات داخل مستند VSDM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSDM في Java"
description: "انقل صفحات VSDM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل VSDM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف VSDM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSDM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف VSDM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات VSDM عبر الإنترنت"
    content: |
       انقل صفحات ملف VSDM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
