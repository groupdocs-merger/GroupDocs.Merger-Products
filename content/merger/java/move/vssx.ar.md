...
############################# Head ############################
head_title: "نقل صفحات VSSX في Java"
head_description: "انقل الصفحات داخل مستند VSSX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSSX في Java"
description: "انقل صفحات VSSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل VSSX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف VSSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSSX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف VSSX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات VSSX عبر الإنترنت"
    content: |
       انقل صفحات ملف VSSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx).
