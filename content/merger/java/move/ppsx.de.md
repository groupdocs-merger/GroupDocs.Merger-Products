...
############################# Head ############################
head_title: "Verschiebe PPSX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines PPSX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe PPSX Seiten in Java"
description: "Verschieben Sie PPSX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie PPSX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer PPSX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie PPSX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie PPSX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie PPSX Seiten online"
    content: |
       Verschieben Sie jetzt PPSX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) besuchen.
