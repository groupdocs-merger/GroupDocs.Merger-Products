...
############################# Head ############################
head_title: "Pindahkan XLSX Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen XLSX di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLSX Halaman Di Java"
description: "Pindahkan Halaman XLSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan XLSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file XLSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLSX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan XLSX Halaman Online"
    content: |
       Pindahkan halaman file XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/xlsx).
