...
############################# Head ############################
head_title: "Flytt ODS sider i Java"
head_description: "Flytt sider i et ODS-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ODS sider i Java"
description: "Flytt ODS sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt ODS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en ODS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ODS filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt ODS filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt ODS sider på nettet"
    content: |
       Flytt ODS filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) nettstedet.
