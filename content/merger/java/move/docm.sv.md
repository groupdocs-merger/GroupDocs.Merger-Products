...
############################# Head ############################
head_title: "Flytta DOCM sidor i Java"
head_description: "Flytta sidor i ett DOCM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOCM sidor i Java"
description: "Flytta DOCM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta DOCM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en DOCM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOCM filsidor med hjälp av Java exempelkod">}}
