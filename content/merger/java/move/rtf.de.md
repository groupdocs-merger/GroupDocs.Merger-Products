...
############################# Head ############################
head_title: "Verschiebe RTF Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines RTF-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe RTF Seiten in Java"
description: "Verschieben Sie RTF-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie RTF Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer RTF-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie RTF-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie RTF Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie RTF Seiten online"
    content: |
       Verschieben Sie jetzt RTF Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) besuchen.
