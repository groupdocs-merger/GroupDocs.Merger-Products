...
############################# Head ############################
head_title: "Przenieś OTP strony w Java"
head_description: "Przenieś strony w dokumencie OTP w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś OTP strony w Java"
description: "Przenieś strony OTP za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików OTP do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku OTP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść OTP strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików OTP za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś OTP strony online"
    content: |
       Przenieś strony plików OTP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
