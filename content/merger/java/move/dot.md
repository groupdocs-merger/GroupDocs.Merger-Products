...
############################# Head ############################
head_title: "Move DOT Pages in Java"
head_description: "Move pages within a DOT document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOT Pages In Java"
description: "Move DOT Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOT File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOT file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move DOT Pages Online"
    content: |
       Move DOT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) website.
