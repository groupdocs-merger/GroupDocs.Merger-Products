...
############################# Head ############################
head_title: "Přesunout VSDM stránky v Java"
head_description: "Přesunout stránky v dokumentu VSDM v Java na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout VSDM stránky do Java"
description: "Přesuňte VSDM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Přesunout VSDM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java přesouvat stránky v souboru VSDM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru VSDM pomocí ukázkového kódu Java">}}

        ```java    
        // Přesunout stránky souboru VSDM pomocí GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živá ukázka – přesouvejte VSDM stránek online"
    content: |
       Přesuňte stránky souborů VSDM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
