...
############################# Head ############################
head_title: "Perkelti TEX puslapius Java"
head_description: "Perkelkite puslapius TEX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti TEX puslapius Java"
description: "Perkelkite TEX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti TEX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius TEX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti TEX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite TEX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite TEX puslapius į internetą"
    content: |
       Perkelkite TEX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) svetainėje.
