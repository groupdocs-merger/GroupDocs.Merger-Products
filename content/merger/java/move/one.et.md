...
############################# Head ############################
head_title: "Teisalda ONE lehte teenuses Java"
head_description: "Teisaldage dokumendi ONE lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ONE lehte rakenduses Java"
description: "Teisaldage ONE lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ONE faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis ONE, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ONE faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage ONE faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage ONE lehte võrgus"
    content: |
       Teisaldage kohe ONE faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
