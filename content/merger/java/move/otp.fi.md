...
############################# Head ############################
head_title: "Siirrä OTP sivua Java"
head_description: "Siirrä OTP-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä OTP sivua Java"
description: "Siirrä OTP sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä OTP tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja OTP-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää OTP tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä OTP tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä OTP sivua verkkoon"
    content: |
       Siirrä OTP tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) -sivustolla.
