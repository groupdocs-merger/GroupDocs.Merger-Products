...
############################# Head ############################
head_title: "Sposta le pagine di XPS in Java"
head_description: "Utilizza GroupDocs.Merger for Java per riordinare le pagine nei documenti XPS senza sforzo. Elabora PDF, Word, Excel, PowerPoint, immagini e altro ancora."

############################# Header ############################
title: "Sposta pagine in XPS" 
description: "GroupDocs.Merger for Java consente alle applicazioni Java di riordinare le pagine nei documenti XPS in modo fluido."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ti permette di spostare pagine selezionate nei documenti XPS. Migliora le tue applicazioni Java con funzionalità avanzate di elaborazione documentale.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta una pagina alla fine del documento"
      content: |
        Scopri come spostare una pagina specifica alla fine di un documento XPS.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
