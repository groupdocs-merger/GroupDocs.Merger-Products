...
############################# Head ############################
head_title: "Siirrä PPT sivua Java"
head_description: "Siirrä PPT-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PPT sivua Java"
description: "Siirrä PPT sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PPT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja PPT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PPT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä PPT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä PPT sivua verkkoon"
    content: |
       Siirrä PPT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) -sivustolla.
