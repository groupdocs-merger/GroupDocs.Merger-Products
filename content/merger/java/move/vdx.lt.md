...
############################# Head ############################
head_title: "Perkelti VDX puslapius Java"
head_description: "Perkelkite puslapius VDX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VDX puslapius Java"
description: "Perkelkite VDX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VDX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VDX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VDX failo puslapius naudojant Java pavyzdinį kodą">}}
