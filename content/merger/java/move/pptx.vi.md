...
############################# Head ############################
head_title: "Di chuyển PPTX Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu PPTX trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển PPTX Trang trong Java"
description: "Di chuyển các Trang PPTX với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển PPTX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp PPTX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp PPTX bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp PPTX bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
