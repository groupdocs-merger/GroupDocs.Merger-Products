...
############################# Head ############################
head_title: "Տեղափոխել VDX էջ Java-ում"
head_description: "Տեղափոխեք էջերը VDX փաստաթղթում Java-ում ցանկացած դիրք` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Տեղափոխել VDX էջ Java-ում"
description: "Տեղափոխեք VDX էջեր Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Տեղափոխել VDX ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար էջերը տեղափոխել VDX ֆայլի մեջ` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես տեղափոխել VDX ֆայլի էջեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Տեղափոխեք VDX ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Տեղափոխեք VDX էջեր առցանց"
    content: |
       Տեղափոխեք VDX ֆայլի էջեր հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx) կայքը:
