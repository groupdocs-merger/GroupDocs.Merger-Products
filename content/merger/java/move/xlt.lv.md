...
############################# Head ############################
head_title: "Pārvietot XLT lapas programmā Java"
head_description: "Pārvietojiet lapas XLT dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLT lapas programmā Java"
description: "Pārvietojiet XLT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLT lapas tiešsaistē"
    content: |
       Pārvietojiet XLT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
