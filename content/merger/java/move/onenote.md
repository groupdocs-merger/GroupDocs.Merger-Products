...
############################# Head ############################
head_title: "Move ONENOTE Pages in Java"
head_description: "Move pages within a ONENOTE document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move ONENOTE Pages In Java"
description: "Move ONENOTE Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move ONENOTE File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a ONENOTE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ONENOTE file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move ONENOTE Pages Online"
    content: |
       Move ONENOTE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/onenote) website.
