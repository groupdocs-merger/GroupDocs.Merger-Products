...
############################# Head ############################
head_title: "Skuif OTT bladsye in Java"
head_description: "Skuif bladsye binne 'n OTT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif OTT bladsye in Java"
description: "Skuif OTT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif OTT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n OTT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif OTT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif OTT bladsye aanlyn"
    content: |
       Skuif OTT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) webwerf te besoek.
