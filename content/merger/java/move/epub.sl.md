...
############################# Head ############################
head_title: "Premakni EPUB strani v Java"
head_description: "Premaknite strani znotraj dokumenta EPUB v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni EPUB strani v Java"
description: "Premaknite strani EPUB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke EPUB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke EPUB z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke EPUB s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke EPUB z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite EPUB strani na splet"
    content: |
       Takoj premaknite strani datoteke EPUB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
