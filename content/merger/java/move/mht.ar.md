...
############################# Head ############################
head_title: "نقل صفحات MHT في Java"
head_description: "انقل الصفحات داخل مستند MHT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات MHT في Java"
description: "انقل صفحات MHT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل MHT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف MHT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف MHT باستخدام كود مثال Java">}}
