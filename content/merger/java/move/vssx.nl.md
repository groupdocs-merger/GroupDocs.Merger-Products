...
############################# Head ############################
head_title: "Verplaats VSSX pagina's in Java"
head_description: "Verplaats pagina's binnen een VSSX document in Java naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats VSSX pagina's in Java"
description: "Verplaats VSSX pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verplaats VSSX bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een VSSX bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSX bestandspagina's te verplaatsen met behulp van Java voorbeeldcode">}}
