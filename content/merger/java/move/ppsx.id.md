...
############################# Head ############################
head_title: "Pindahkan PPSX Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen PPSX di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PPSX Halaman Di Java"
description: "Pindahkan Halaman PPSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan PPSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file PPSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PPSX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan PPSX Halaman Online"
    content: |
       Pindahkan halaman file PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/ppsx).
