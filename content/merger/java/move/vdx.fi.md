...
############################# Head ############################
head_title: "Siirrä VDX sivua Java"
head_description: "Siirrä VDX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VDX sivua Java"
description: "Siirrä VDX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VDX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VDX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VDX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VDX sivua verkkoon"
    content: |
       Siirrä VDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx) -sivustolla.
