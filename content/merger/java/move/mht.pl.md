...
############################# Head ############################
head_title: "Przenieś MHT strony w Java"
head_description: "Przenieś strony w dokumencie MHT w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś MHT strony w Java"
description: "Przenieś strony MHT za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików MHT do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku MHT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść MHT strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików MHT za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś MHT strony online"
    content: |
       Przenieś strony plików MHT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
