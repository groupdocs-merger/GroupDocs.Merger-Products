...
############################# Head ############################
head_title: "XLTM oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XLTM dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTM oldal mozgatása a Java nyelven"
description: "Mozgasson át XLTM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLTM fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XLTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTM fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet XLTM fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLTM oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) webhely meglátogatásával azonnal áthelyezhet XLTM fájloldalt.
