...
############################# Head ############################
head_title: "Skuif EPUB bladsye in Java"
head_description: "Skuif bladsye binne 'n EPUB dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif EPUB bladsye in Java"
description: "Skuif EPUB bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif EPUB lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n EPUB-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om EPUB lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif EPUB lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif EPUB bladsye aanlyn"
    content: |
       Skuif EPUB lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) webwerf te besoek.
