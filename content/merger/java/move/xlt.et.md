...
############################# Head ############################
head_title: "Teisalda XLT lehte teenuses Java"
head_description: "Teisaldage dokumendi XLT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLT lehte rakenduses Java"
description: "Teisaldage XLT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLT faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLT lehte võrgus"
    content: |
       Teisaldage kohe XLT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
