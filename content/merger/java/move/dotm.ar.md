...
############################# Head ############################
head_title: "نقل صفحات DOTM في Java"
head_description: "انقل الصفحات داخل مستند DOTM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOTM في Java"
description: "انقل صفحات DOTM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOTM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOTM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOTM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOTM عبر الإنترنت"
    content: |
       انقل صفحات ملف DOTM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
