...
############################# Head ############################
head_title: "نقل صفحات ODP في Java"
head_description: "انقل الصفحات داخل مستند ODP في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ODP في Java"
description: "انقل صفحات ODP ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل ODP صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف ODP من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ODP باستخدام كود مثال Java">}}
