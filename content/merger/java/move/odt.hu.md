...
############################# Head ############################
head_title: "ODT oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy ODT dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODT oldal mozgatása a Java nyelven"
description: "Mozgasson át ODT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODT fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy ODT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet ODT fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ODT oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) webhely meglátogatásával azonnal áthelyezhet ODT fájloldalt.
