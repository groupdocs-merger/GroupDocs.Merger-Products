...
############################# Head ############################
head_title: "Move XLAM Pages in Java"
head_description: "Move pages within a XLAM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLAM Pages In Java"
description: "Move XLAM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLAM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLAM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLAM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLAM Pages Online"
    content: |
       Move XLAM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam) website.
