...
############################# Head ############################
head_title: "Teisalda XPS lehte teenuses Java"
head_description: "Teisaldage dokumendi XPS lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XPS lehte rakenduses Java"
description: "Teisaldage XPS lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XPS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XPS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XPS faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XPS lehte võrgus"
    content: |
       Teisaldage kohe XPS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps).
