...
############################# Head ############################
head_title: "Teisalda DOT lehte teenuses Java"
head_description: "Teisaldage dokumendi DOT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOT lehte rakenduses Java"
description: "Teisaldage DOT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage DOT faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage DOT lehte võrgus"
    content: |
       Teisaldage kohe DOT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot).
