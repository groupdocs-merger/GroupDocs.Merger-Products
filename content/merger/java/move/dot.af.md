...
############################# Head ############################
head_title: "Skuif DOT bladsye in Java"
head_description: "Skuif bladsye binne 'n DOT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif DOT bladsye in Java"
description: "Skuif DOT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif DOT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif DOT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif DOT bladsye aanlyn"
    content: |
       Skuif DOT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) webwerf te besoek.
