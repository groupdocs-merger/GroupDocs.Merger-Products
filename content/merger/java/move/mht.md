...
############################# Head ############################
head_title: "Move MHT Pages in Java"
head_description: "Move pages within a MHT document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move MHT Pages In Java"
description: "Move MHT Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move MHT File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a MHT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move MHT file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move MHT Pages Online"
    content: |
       Move MHT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) website.
