...
############################# Head ############################
head_title: "Mover XLS páginas en Java"
head_description: "Mueva páginas dentro de un documento XLS en Java a cualquier posición usando la API de fusión de documentos."

############################# Header ############################
title: "Mover XLS páginas en Java"
description: "Mueva XLS páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Mover XLS páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java mover páginas dentro de un archivo XLS mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo mover páginas de archivos XLS usando el código de ejemplo Java">}}

        ```java    
        // Mover XLS páginas de archivos usando GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo - Mover XLS páginas en línea"
    content: |
       Mueva las páginas de archivos XLS ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
