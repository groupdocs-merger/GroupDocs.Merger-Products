...
############################# Head ############################
head_title: "Déplacer ONENOTE pages dans Java"
head_description: "Déplacez les pages d'un document ONENOTE dans Java vers n'importe quelle position à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Déplacer ONENOTE pages dans Java"
description: "Déplacez ONENOTE pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Déplacer ONENOTE pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de déplacer facilement des pages dans un fichier ONENOTE en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment déplacer les pages de fichiers ONENOTE à l'aide de l'exemple de code Java">}}

        ```java    
        // Déplacer ONENOTE pages de fichiers à l'aide de l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Démos en direct - Déplacer ONENOTE pages en ligne"
    content: |
       Déplacez ONENOTE pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/onenote).
