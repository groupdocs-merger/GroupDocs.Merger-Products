...
############################# Head ############################
head_title: "Færa HTML síður í Java"
head_description: "Færðu síður innan HTML skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa HTML síður í Java"
description: "Færðu HTML síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa HTML skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í HTML skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa HTML skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu HTML skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu HTML síður á netinu"
    content: |
       Færðu HTML skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) vefsíðu.
