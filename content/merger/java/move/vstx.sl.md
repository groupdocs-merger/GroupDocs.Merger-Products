...
############################# Head ############################
head_title: "Premakni VSTX strani v Java"
head_description: "Premaknite strani znotraj dokumenta VSTX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSTX strani v Java"
description: "Premaknite strani VSTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VSTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSTX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke VSTX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite VSTX strani na splet"
    content: |
       Takoj premaknite strani datoteke VSTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx).
