...
############################# Head ############################
head_title: "Verschiebe XPS Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XPS-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XPS Seiten in Java"
description: "Verschieben Sie XPS-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XPS Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XPS-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XPS-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XPS Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XPS Seiten online"
    content: |
       Verschieben Sie jetzt XPS Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) besuchen.
