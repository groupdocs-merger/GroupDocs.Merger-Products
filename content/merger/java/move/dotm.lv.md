...
############################# Head ############################
head_title: "Pārvietot DOTM lapas programmā Java"
head_description: "Pārvietojiet lapas DOTM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOTM lapas programmā Java"
description: "Pārvietojiet DOTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOTM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOTM lapas tiešsaistē"
    content: |
       Pārvietojiet DOTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
