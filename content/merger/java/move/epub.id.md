...
############################# Head ############################
head_title: "Pindahkan EPUB Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen EPUB di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan EPUB Halaman Di Java"
description: "Pindahkan Halaman EPUB dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan EPUB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file EPUB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file EPUB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan EPUB Halaman Online"
    content: |
       Pindahkan halaman file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/epub).
