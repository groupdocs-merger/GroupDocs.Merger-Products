...
############################# Head ############################
head_title: "Flytt ODT sider i Java"
head_description: "Flytt sider i et ODT-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ODT sider i Java"
description: "Flytt ODT sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt ODT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en ODT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ODT filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt ODT filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt ODT sider på nettet"
    content: |
       Flytt ODT filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) nettstedet.
