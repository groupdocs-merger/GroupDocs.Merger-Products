...
############################# Head ############################
head_title: "Sposta XLTM pagine in Java"
head_description: "Sposta le pagine all'interno di un documento XLTM in Java in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta XLTM pagine in Java"
description: "Sposta XLTM pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Sposta XLTM pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di spostare facilmente le pagine all'interno di un file XLTM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file XLTM utilizzando il codice di esempio Java">}}

        ```java    
        // Sposta le pagine dei file XLTM utilizzando l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Sposta XLTM pagine online"
    content: |
       Sposta subito XLTM pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
