...
############################# Head ############################
head_title: "Premakni XLSM strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLSM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLSM strani v Java"
description: "Premaknite strani XLSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLSM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLSM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke XLSM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite XLSM strani na splet"
    content: |
       Takoj premaknite strani datoteke XLSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm).
