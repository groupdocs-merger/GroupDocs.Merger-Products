...
############################# Head ############################
head_title: "Verplaats MHTML pagina's in Java"
head_description: "Verplaats pagina's binnen een MHTML document in Java naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats MHTML pagina's in Java"
description: "Verplaats MHTML pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verplaats MHTML bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een MHTML bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHTML bestandspagina's te verplaatsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verplaats MHTML bestandspagina's met de GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live demo's - Verplaats MHTML pagina's online"
    content: |
       Verplaats MHTML bestandspagina's nu meteen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml) te gaan.
