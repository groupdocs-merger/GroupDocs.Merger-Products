...
############################# Head ############################
head_title: "Alihkan PPT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen PPT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPT Halaman Dalam Java"
description: "Alihkan PPT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan PPT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail PPT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan PPT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan PPT Halaman Dalam Talian"
    content: |
       Alihkan PPT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
