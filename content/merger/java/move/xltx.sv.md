...
############################# Head ############################
head_title: "Flytta XLTX sidor i Java"
head_description: "Flytta sidor i ett XLTX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLTX sidor i Java"
description: "Flytta XLTX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta XLTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en XLTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta XLTX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta XLTX sidor online"
    content: |
       Flytta XLTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
