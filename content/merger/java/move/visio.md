...
############################# Head ############################
head_title: "Move, Rearrange & Reorder VISIO Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a VISIO document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder VISIO Pages in Java"
description: "Move and Rearrange the pages within a VISIO document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange VISIO File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a VISIO file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Move VISIO Document Pages Online"
    content: |
        Move pages within VISIO files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/visio) website.
