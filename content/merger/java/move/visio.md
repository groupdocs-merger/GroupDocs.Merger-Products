...
############################# Head ############################
head_title: "Move VISIO Pages in Java"
head_description: "Move pages within a VISIO document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VISIO Pages In Java"
description: "Move VISIO Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VISIO File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VISIO file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VISIO file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VISIO Pages Online"
    content: |
       Move VISIO file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/visio) website.
