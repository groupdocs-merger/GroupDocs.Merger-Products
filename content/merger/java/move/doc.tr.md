...
############################# Head ############################
head_title: "DOC Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir DOC belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOC Sayfayı Java İçinde Taşı"
description: "DOC Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOC Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir DOC dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOC dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak DOC dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - DOC Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc) web sitesini ziyaret ederek DOC dosya sayfalarını hemen şimdi taşıyın.
