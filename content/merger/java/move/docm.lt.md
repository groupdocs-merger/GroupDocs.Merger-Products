...
############################# Head ############################
head_title: "Perkelti DOCM puslapius Java"
head_description: "Perkelkite puslapius DOCM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOCM puslapius Java"
description: "Perkelkite DOCM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOCM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOCM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOCM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOCM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOCM puslapius į internetą"
    content: |
       Perkelkite DOCM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) svetainėje.
