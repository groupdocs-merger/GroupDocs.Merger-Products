...
############################# Head ############################
head_title: "Alihkan VSDX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSDX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSDX Halaman Dalam Java"
description: "Alihkan VSDX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSDX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSDX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSDX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSDX Halaman Dalam Talian"
    content: |
       Alihkan VSDX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx).
