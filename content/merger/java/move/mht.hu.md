...
############################# Head ############################
head_title: "MHT oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy MHT dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHT oldal mozgatása a Java nyelven"
description: "Mozgasson át MHT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "MHT fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy MHT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet MHT fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – MHT oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) webhely meglátogatásával azonnal áthelyezhet MHT fájloldalt.
