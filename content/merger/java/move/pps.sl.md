...
############################# Head ############################
head_title: "Premakni PPS strani v Java"
head_description: "Premaknite strani znotraj dokumenta PPS v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPS strani v Java"
description: "Premaknite strani PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke PPS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPS s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke PPS z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite PPS strani na splet"
    content: |
       Takoj premaknite strani datoteke PPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
