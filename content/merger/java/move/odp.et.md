...
############################# Head ############################
head_title: "Teisalda ODP lehte teenuses Java"
head_description: "Teisaldage dokumendi ODP lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ODP lehte rakenduses Java"
description: "Teisaldage ODP lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ODP faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis ODP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ODP faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage ODP faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage ODP lehte võrgus"
    content: |
       Teisaldage kohe ODP faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp).
