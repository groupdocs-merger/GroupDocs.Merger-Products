...
############################# Head ############################
head_title: "HTML oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy HTML dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "HTML oldal mozgatása a Java nyelven"
description: "Mozgasson át HTML oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "HTML fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy HTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet HTML fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – HTML oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) webhely meglátogatásával azonnal áthelyezhet HTML fájloldalt.
