...
############################# Head ############################
head_title: "Perkelti RTF puslapius Java"
head_description: "Perkelkite puslapius RTF dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti RTF puslapius Java"
description: "Perkelkite RTF puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti RTF failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius RTF faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti RTF failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite RTF failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite RTF puslapius į internetą"
    content: |
       Perkelkite RTF failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) svetainėje.
