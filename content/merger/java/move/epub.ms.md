...
############################# Head ############################
head_title: "Alihkan EPUB Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen EPUB dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan EPUB Halaman Dalam Java"
description: "Alihkan EPUB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan EPUB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail EPUB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan EPUB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan EPUB halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan EPUB Halaman Dalam Talian"
    content: |
       Alihkan EPUB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
