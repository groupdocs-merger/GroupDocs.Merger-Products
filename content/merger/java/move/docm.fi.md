...
############################# Head ############################
head_title: "Siirrä DOCM sivua Java"
head_description: "Siirrä DOCM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOCM sivua Java"
description: "Siirrä DOCM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOCM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja DOCM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOCM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä DOCM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä DOCM sivua verkkoon"
    content: |
       Siirrä DOCM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) -sivustolla.
