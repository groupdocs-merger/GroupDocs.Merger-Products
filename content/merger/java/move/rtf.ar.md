...
############################# Head ############################
head_title: "نقل صفحات RTF في Java"
head_description: "انقل الصفحات داخل مستند RTF في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات RTF في Java"
description: "انقل صفحات RTF ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل RTF صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف RTF من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف RTF باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف RTF باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات RTF عبر الإنترنت"
    content: |
       انقل صفحات ملف RTF الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
