...
############################# Head ############################
head_title: "Presunúť RTF stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu RTF v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť RTF stránok do Java"
description: "Presuňte RTF stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť RTF strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru RTF implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru RTF pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru RTF pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte RTF stránok online"
    content: |
       Presuňte stránky súboru RTF hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
