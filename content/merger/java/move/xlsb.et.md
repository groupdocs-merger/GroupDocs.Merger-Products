...
############################# Head ############################
head_title: "Teisalda XLSB lehte teenuses Java"
head_description: "Teisaldage dokumendi XLSB lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSB lehte rakenduses Java"
description: "Teisaldage XLSB lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSB faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLSB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSB faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLSB faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLSB lehte võrgus"
    content: |
       Teisaldage kohe XLSB faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb).
