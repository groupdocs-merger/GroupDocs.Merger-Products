...
############################# Head ############################
head_title: "Move VSSM Pages in Java"
head_description: "Move pages within a VSSM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSSM Pages In Java"
description: "Move VSSM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSSM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSSM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSSM Pages Online"
    content: |
       Move VSSM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) website.
