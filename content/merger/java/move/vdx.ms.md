...
############################# Head ############################
head_title: "Alihkan VDX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VDX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VDX Halaman Dalam Java"
description: "Alihkan VDX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VDX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VDX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VDX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VDX Halaman Dalam Talian"
    content: |
       Alihkan VDX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
