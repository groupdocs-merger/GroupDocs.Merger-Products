...
############################# Head ############################
head_title: "Μετακίνηση PPSX σελίδων σε Java"
head_description: "Μετακινήστε σελίδες σε ένα έγγραφο PPSX στο Java σε οποιαδήποτε θέση χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Μετακίνηση PPSX σελίδων σε Java"
description: "Μετακινήστε PPSX σελίδες με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Μετακίνηση PPSX σελίδων αρχείου στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να μετακινούν σελίδες μέσα σε ένα αρχείο PPSX εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να μετακινήσετε PPSX σελίδες αρχείου χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Μετακινήστε PPSX σελίδες αρχείου χρησιμοποιώντας το GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Μετακίνηση σελίδων PPSX στο Διαδίκτυο"
    content: |
       Μετακινήστε PPSX σελίδες αρχείων αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
