...
############################# Head ############################
head_title: "MHTML Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir MHTML belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "MHTML Sayfayı Java İçinde Taşı"
description: "MHTML Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "MHTML Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir MHTML dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHTML dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak MHTML dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - MHTML Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml) web sitesini ziyaret ederek MHTML dosya sayfalarını hemen şimdi taşıyın.
