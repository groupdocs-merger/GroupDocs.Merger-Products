...
############################# Head ############################
head_title: "Perkelti VSSM puslapius Java"
head_description: "Perkelkite puslapius VSSM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSSM puslapius Java"
description: "Perkelkite VSSM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSSM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VSSM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSSM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VSSM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VSSM puslapius į internetą"
    content: |
       Perkelkite VSSM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) svetainėje.
