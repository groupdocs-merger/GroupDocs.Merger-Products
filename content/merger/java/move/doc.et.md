...
############################# Head ############################
head_title: "Teisalda DOC lehte teenuses Java"
head_description: "Teisaldage dokumendi DOC lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOC lehte rakenduses Java"
description: "Teisaldage DOC lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOC faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOC, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOC faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage DOC faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage DOC lehte võrgus"
    content: |
       Teisaldage kohe DOC faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc).
