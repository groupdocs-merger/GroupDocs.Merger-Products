...
############################# Head ############################
head_title: "Alihkan HTML Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen HTML dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan HTML Halaman Dalam Java"
description: "Alihkan HTML Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan HTML Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail HTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan HTML halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan HTML halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan HTML Halaman Dalam Talian"
    content: |
       Alihkan HTML halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
