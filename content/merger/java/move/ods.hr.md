...
############################# Head ############################
head_title: "Premjesti ODS stranice u Java"
head_description: "Premjestite stranice unutar ODS dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ODS stranice u Java"
description: "Premjesti ODS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti ODS stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar ODS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ODS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti ODS stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti ODS stranice na mrežu"
    content: |
       Premjestite ODS stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) web stranice.
