...
############################# Head ############################
head_title: "Alihkan DOT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen DOT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOT Halaman Dalam Java"
description: "Alihkan DOT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan DOT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail DOT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan DOT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan DOT Halaman Dalam Talian"
    content: |
       Alihkan DOT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot).
