...
############################# Head ############################
head_title: "Premakni VSTM strani v Java"
head_description: "Premaknite strani znotraj dokumenta VSTM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSTM strani v Java"
description: "Premaknite strani VSTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VSTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSTM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke VSTM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite VSTM strani na splet"
    content: |
       Takoj premaknite strani datoteke VSTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
