...
############################# Head ############################
head_title: "Rûpelên PPT di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek PPT ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PPT Di Java de biguhezînin"
description: "Rûpelên PPT bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê PPT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê PPT bar dike">}}

        ```java    
        // Rûpelên pelê yên PPT bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin PPT"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) niha rûpelên pelê yên PPT biguhezînin.
