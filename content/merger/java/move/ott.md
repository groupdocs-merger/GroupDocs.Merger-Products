...
############################# Head ############################
head_title: "Move OTT Pages in Java"
head_description: "Move pages within a OTT document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move OTT Pages In Java"
description: "Move OTT Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move OTT File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a OTT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move OTT file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move OTT Pages Online"
    content: |
       Move OTT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) website.
