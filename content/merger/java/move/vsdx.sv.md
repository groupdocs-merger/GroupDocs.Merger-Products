...
############################# Head ############################
head_title: "Flytta VSDX sidor i Java"
head_description: "Flytta sidor i ett VSDX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSDX sidor i Java"
description: "Flytta VSDX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSDX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSDX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSDX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSDX sidor online"
    content: |
       Flytta VSDX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx).
