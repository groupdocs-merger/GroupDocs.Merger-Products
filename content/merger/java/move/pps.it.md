...
############################# Head ############################
head_title: "Sposta PPS pagine in Java"
head_description: "Sposta le pagine all'interno di un documento PPS in Java in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta PPS pagine in Java"
description: "Sposta PPS pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Sposta PPS pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di spostare facilmente le pagine all'interno di un file PPS implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file PPS utilizzando il codice di esempio Java">}}

        ```java    
        // Sposta le pagine dei file PPS utilizzando l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Sposta PPS pagine online"
    content: |
       Sposta subito PPS pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
