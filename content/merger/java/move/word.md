...
############################# Head ############################
head_title: "Move WORD Pages in Java"
head_description: "Move pages within a WORD document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move WORD Pages In Java"
description: "Move WORD Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move WORD File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a WORD file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WORD file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move WORD Pages Online"
    content: |
       Move WORD file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/word) website.
