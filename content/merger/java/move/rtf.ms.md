...
############################# Head ############################
head_title: "Alihkan RTF Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen RTF dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan RTF Halaman Dalam Java"
description: "Alihkan RTF Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan RTF Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail RTF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan RTF halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan RTF halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan RTF Halaman Dalam Talian"
    content: |
       Alihkan RTF halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
