...
############################# Head ############################
head_title: "Pindahkan ODT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen ODT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ODT Halaman Di Java"
description: "Pindahkan Halaman ODT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan ODT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file ODT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ODT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan ODT Halaman Online"
    content: |
       Pindahkan halaman file ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/odt).
