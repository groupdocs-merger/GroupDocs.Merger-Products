...
############################# Head ############################
head_title: "نقل صفحات PPSX في Java"
head_description: "انقل الصفحات داخل مستند PPSX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPSX في Java"
description: "انقل صفحات PPSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل PPSX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف PPSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPSX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف PPSX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات PPSX عبر الإنترنت"
    content: |
       انقل صفحات ملف PPSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
