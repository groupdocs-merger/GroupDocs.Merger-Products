...
############################# Head ############################
head_title: "Mover XLT Páginas em Java"
head_description: "Mova as páginas em um documento XLT em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLT Páginas em Java"
description: "Mova XLT Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLT em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo XLT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLT usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo XLT usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover XLT páginas on-line"
    content: |
       Mova as páginas do arquivo XLT agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
