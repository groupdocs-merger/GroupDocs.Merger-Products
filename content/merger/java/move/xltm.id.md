...
############################# Head ############################
head_title: "Pindahkan XLTM Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen XLTM di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLTM Halaman Di Java"
description: "Pindahkan Halaman XLTM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan XLTM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file XLTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLTM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan XLTM Halaman Online"
    content: |
       Pindahkan halaman file XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/xltm).
