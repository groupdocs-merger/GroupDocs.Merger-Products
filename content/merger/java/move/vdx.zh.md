...
############################# Head ############################
head_title: "在 Java 中移动 VDX 页"
head_description: "使用文档合并 API 将 Java 中的 VDX 文档中的页面移动到任何位置。"

############################# Header ############################
title: "在 Java 中移动 VDX 页"
description: "使用几行 Java 代码移动 VDX 页。"
...
steps:
    enable: true
    title_left: "移动 Java 中的 VDX 个文件页"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 让 Java 开发人员通过执行几个简单的步骤即可轻松地在 VDX 文件中移动页面.
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码移动 VDX 文件页面">}}

        ```java    
        // 使用 GroupDocs.Merger API 移动 VDX 文件页面
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "现场演示 - 在线移动 VDX 页面"
    content: |
       访问 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx) 网站，立即移动 VDX 文件页面。
       现场演示具有以下好处。
