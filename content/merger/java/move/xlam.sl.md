...
############################# Head ############################
head_title: "Premakni XLAM strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLAM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLAM strani v Java"
description: "Premaknite strani XLAM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLAM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLAM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLAM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke XLAM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite XLAM strani na splet"
    content: |
       Takoj premaknite strani datoteke XLAM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam).
