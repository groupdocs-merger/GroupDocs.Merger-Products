...
############################# Head ############################
head_title: "VDX ገጾችን በJava ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በVDX ሰነድ ውስጥ በJava ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "VDX ገጾችን በJava ውስጥ አንቀሳቅስ"
description: "VDX ገጾችን ከጥቂት መስመሮች Java ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "VDX የፋይል ገጾችን በJava አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በVDX ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የVDX ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም VDX የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - VDX ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የVDX ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
