...
############################# Head ############################
head_title: "Alihkan DOTM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen DOTM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOTM Halaman Dalam Java"
description: "Alihkan DOTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan DOTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail DOTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan DOTM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan DOTM Halaman Dalam Talian"
    content: |
       Alihkan DOTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
