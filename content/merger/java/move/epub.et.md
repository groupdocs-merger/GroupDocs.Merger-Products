...
############################# Head ############################
head_title: "Teisalda EPUB lehte teenuses Java"
head_description: "Teisaldage dokumendi EPUB lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda EPUB lehte rakenduses Java"
description: "Teisaldage EPUB lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda EPUB faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis EPUB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada EPUB faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage EPUB faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage EPUB lehte võrgus"
    content: |
       Teisaldage kohe EPUB faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
