...
############################# Head ############################
head_title: "نقل صفحات XLSX في Java"
head_description: "انقل الصفحات داخل مستند XLSX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLSX في Java"
description: "انقل صفحات XLSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLSX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLSX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLSX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLSX عبر الإنترنت"
    content: |
       انقل صفحات ملف XLSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx).
