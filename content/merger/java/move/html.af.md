...
############################# Head ############################
head_title: "Skuif HTML bladsye in Java"
head_description: "Skuif bladsye binne 'n HTML dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif HTML bladsye in Java"
description: "Skuif HTML bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif HTML lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n HTML-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om HTML lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif HTML lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif HTML bladsye aanlyn"
    content: |
       Skuif HTML lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) webwerf te besoek.
