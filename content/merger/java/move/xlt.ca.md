...
############################# Head ############################
head_title: "Mou XLT pàgines a Java"
head_description: "Mou les pàgines d'un document XLT a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou XLT pàgines a Java"
description: "Mou XLT pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou XLT pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer XLT implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers XLT utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou XLT pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou XLT pàgines en línia"
    content: |
       Mou les pàgines de fitxers XLT ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
