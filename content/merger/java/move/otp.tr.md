...
############################# Head ############################
head_title: "OTP Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir OTP belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "OTP Sayfayı Java İçinde Taşı"
description: "OTP Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "OTP Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir OTP dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTP dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak OTP dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - OTP Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) web sitesini ziyaret ederek OTP dosya sayfalarını hemen şimdi taşıyın.
