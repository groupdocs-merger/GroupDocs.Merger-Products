...
############################# Head ############################
head_title: "Přesunout PPS stránky v Java"
head_description: "Přesunout stránky v dokumentu PPS v Java na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout PPS stránky do Java"
description: "Přesuňte PPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Přesunout PPS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java přesouvat stránky v souboru PPS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru PPS pomocí ukázkového kódu Java">}}
