...
############################# Head ############################
head_title: "PPTX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir PPTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPTX Sayfayı Java İçinde Taşı"
description: "PPTX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPTX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir PPTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPTX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak PPTX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - PPTX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) web sitesini ziyaret ederek PPTX dosya sayfalarını hemen şimdi taşıyın.
