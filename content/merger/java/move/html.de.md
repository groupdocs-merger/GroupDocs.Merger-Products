...
############################# Head ############################
head_title: "Verschiebe HTML Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines HTML-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe HTML Seiten in Java"
description: "Verschieben Sie HTML-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie HTML Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer HTML-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie HTML-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie HTML Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie HTML Seiten online"
    content: |
       Verschieben Sie jetzt HTML Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) besuchen.
