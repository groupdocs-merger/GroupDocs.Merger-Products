...
############################# Head ############################
head_title: "Преместете ODP страници в Java"
head_description: "Преместете страници в ODP документ в Java на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете ODP страници в Java"
description: "Преместете ODP страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Преместете ODP файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да преместват страници в рамките на файл ODP чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате ODP файлови страници с помощта на Java примерен код">}}
