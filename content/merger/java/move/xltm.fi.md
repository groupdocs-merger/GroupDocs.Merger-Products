...
############################# Head ############################
head_title: "Siirrä XLTM sivua Java"
head_description: "Siirrä XLTM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLTM sivua Java"
description: "Siirrä XLTM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XLTM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XLTM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XLTM sivua verkkoon"
    content: |
       Siirrä XLTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) -sivustolla.
