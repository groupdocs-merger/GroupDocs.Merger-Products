...
############################# Head ############################
head_title: "Skuif VSSM bladsye in Java"
head_description: "Skuif bladsye binne 'n VSSM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VSSM bladsye in Java"
description: "Skuif VSSM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VSSM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSSM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VSSM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VSSM bladsye aanlyn"
    content: |
       Skuif VSSM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) webwerf te besoek.
