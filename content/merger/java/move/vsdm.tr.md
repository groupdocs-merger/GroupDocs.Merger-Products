...
############################# Head ############################
head_title: "VSDM Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSDM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSDM Sayfayı Java İçinde Taşı"
description: "VSDM Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSDM Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSDM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDM dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VSDM dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - VSDM Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm) web sitesini ziyaret ederek VSDM dosya sayfalarını hemen şimdi taşıyın.
