...
############################# Head ############################
head_title: "Flyt PPS sider i Java"
head_description: "Flyt sider i et PPS-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PPS sider i Java"
description: "Flyt PPS sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt PPS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en PPS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PPS filsider ved hjælp af Java eksempelkode">}}
