...
############################# Head ############################
head_title: "Flytta VSX sidor i Java"
head_description: "Flytta sidor i ett VSX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSX sidor i Java"
description: "Flytta VSX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSX sidor online"
    content: |
       Flytta VSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx).
