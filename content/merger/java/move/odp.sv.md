...
############################# Head ############################
head_title: "Flytta ODP sidor i Java"
head_description: "Flytta sidor i ett ODP-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ODP sidor i Java"
description: "Flytta ODP sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta ODP filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en ODP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ODP filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta ODP filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta ODP sidor online"
    content: |
       Flytta ODP filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp).
