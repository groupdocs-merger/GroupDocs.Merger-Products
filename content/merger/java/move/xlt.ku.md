...
############################# Head ############################
head_title: "Rûpelên XLT di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLT ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLT Di Java de biguhezînin"
description: "Rûpelên XLT bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê XLT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê XLT bar dike">}}

        ```java    
        // Rûpelên pelê yên XLT bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin XLT"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) niha rûpelên pelê yên XLT biguhezînin.
