...
############################# Head ############################
head_title: "Pārvietot VSDX lapas programmā Java"
head_description: "Pārvietojiet lapas VSDX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSDX lapas programmā Java"
description: "Pārvietojiet VSDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSDX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSDX lapas tiešsaistē"
    content: |
       Pārvietojiet VSDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx).
