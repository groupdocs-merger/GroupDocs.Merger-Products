...
############################# Head ############################
head_title: "Skuif MHT bladsye in Java"
head_description: "Skuif bladsye binne 'n MHT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif MHT bladsye in Java"
description: "Skuif MHT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif MHT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n MHT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif MHT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif MHT bladsye aanlyn"
    content: |
       Skuif MHT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) webwerf te besoek.
