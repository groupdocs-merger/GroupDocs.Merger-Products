...
############################# Head ############################
head_title: "Move PPS Pages in Java"
head_description: "Move pages within a PPS document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move PPS Pages In Java"
description: "Move PPS Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move PPS File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a PPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPS file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move PPS Pages Online"
    content: |
       Move PPS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) website.
