...
############################# Head ############################
head_title: "نقل صفحات OTT في Java"
head_description: "انقل الصفحات داخل مستند OTT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات OTT في Java"
description: "انقل صفحات OTT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل OTT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف OTT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف OTT باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف OTT باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات OTT عبر الإنترنت"
    content: |
       انقل صفحات ملف OTT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
