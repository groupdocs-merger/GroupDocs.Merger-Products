...
############################# Head ############################
head_title: "Siirrä PPSX sivua Java"
head_description: "Siirrä PPSX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PPSX sivua Java"
description: "Siirrä PPSX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PPSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja PPSX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PPSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä PPSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä PPSX sivua verkkoon"
    content: |
       Siirrä PPSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) -sivustolla.
