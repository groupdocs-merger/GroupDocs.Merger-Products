...
############################# Head ############################
head_title: "Move DOTM Pages in Java"
head_description: "Move pages within a DOTM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOTM Pages In Java"
description: "Move DOTM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOTM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOTM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move DOTM Pages Online"
    content: |
       Move DOTM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) website.
