...
############################# Head ############################
head_title: "نقل صفحات VSTM في Java"
head_description: "انقل الصفحات داخل مستند VSTM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSTM في Java"
description: "انقل صفحات VSTM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل VSTM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف VSTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSTM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف VSTM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات VSTM عبر الإنترنت"
    content: |
       انقل صفحات ملف VSTM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
