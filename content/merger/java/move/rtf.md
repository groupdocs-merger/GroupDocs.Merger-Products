...
############################# Head ############################
head_title: "Move RTF Pages in Java"
head_description: "Move pages within a RTF document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move RTF Pages In Java"
description: "Move RTF Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move RTF File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a RTF file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move RTF file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move RTF Pages Online"
    content: |
       Move RTF file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) website.
