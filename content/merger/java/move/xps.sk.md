...
############################# Head ############################
head_title: "Presunúť XPS stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu XPS v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XPS stránok do Java"
description: "Presuňte XPS stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť XPS strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru XPS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XPS pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru XPS pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte XPS stránok online"
    content: |
       Presuňte stránky súboru XPS hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps).
