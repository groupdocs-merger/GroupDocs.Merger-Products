...
############################# Head ############################
head_title: "Premjesti XLT stranice u Java"
head_description: "Premjestite stranice unutar XLT dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLT stranice u Java"
description: "Premjesti XLT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti XLT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar XLT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti XLT stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti XLT stranice na mrežu"
    content: |
       Premjestite XLT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) web stranice.
