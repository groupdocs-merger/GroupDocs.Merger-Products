...
############################# Head ############################
head_title: "Flytta MHT sidor i Java"
head_description: "Flytta sidor i ett MHT-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta MHT sidor i Java"
description: "Flytta MHT sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta MHT filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en MHT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar MHT filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta MHT filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta MHT sidor online"
    content: |
       Flytta MHT filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
