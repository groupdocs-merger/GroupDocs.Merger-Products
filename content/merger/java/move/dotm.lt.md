...
############################# Head ############################
head_title: "Perkelti DOTM puslapius Java"
head_description: "Perkelkite puslapius DOTM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOTM puslapius Java"
description: "Perkelkite DOTM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOTM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOTM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOTM puslapius į internetą"
    content: |
       Perkelkite DOTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) svetainėje.
