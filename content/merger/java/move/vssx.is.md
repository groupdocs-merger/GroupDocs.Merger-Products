...
############################# Head ############################
head_title: "Færa VSSX síður í Java"
head_description: "Færðu síður innan VSSX skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSSX síður í Java"
description: "Færðu VSSX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa VSSX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í VSSX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSSX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu VSSX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu VSSX síður á netinu"
    content: |
       Færðu VSSX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) vefsíðu.
