...
############################# Head ############################
head_title: "Premakni DOTM strani v Java"
head_description: "Premaknite strani znotraj dokumenta DOTM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOTM strani v Java"
description: "Premaknite strani DOTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke DOTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOTM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke DOTM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite DOTM strani na splet"
    content: |
       Takoj premaknite strani datoteke DOTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
