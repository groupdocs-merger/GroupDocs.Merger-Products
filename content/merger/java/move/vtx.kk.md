...
############################# Head ############################
head_title: "VTX бетті Java ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы VTX құжатының беттерін Java ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "VTX бетті Java ішінде жылжыту"
description: "VTX беттерді Java кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "VTX файл бетін Java ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы VTX файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX файл беттерін Java мысал кодын пайдаланып жылжыту жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VTX файл бетін жылжытыңыз
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VTX беттерді желіге жылжытыңыз"
    content: |
       VTX файл бетін дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) веб-сайтына жылжытыңыз.
