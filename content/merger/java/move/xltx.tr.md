...
############################# Head ############################
head_title: "XLTX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir XLTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLTX Sayfayı Java İçinde Taşı"
description: "XLTX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLTX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir XLTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLTX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak XLTX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - XLTX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx) web sitesini ziyaret ederek XLTX dosya sayfalarını hemen şimdi taşıyın.
