...
############################# Head ############################
head_title: "Færa DOTM síður í Java"
head_description: "Færðu síður innan DOTM skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOTM síður í Java"
description: "Færðu DOTM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa DOTM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í DOTM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOTM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu DOTM skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu DOTM síður á netinu"
    content: |
       Færðu DOTM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) vefsíðu.
