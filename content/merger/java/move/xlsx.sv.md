...
############################# Head ############################
head_title: "Flytta XLSX sidor i Java"
head_description: "Flytta sidor i ett XLSX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLSX sidor i Java"
description: "Flytta XLSX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta XLSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en XLSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta XLSX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta XLSX sidor online"
    content: |
       Flytta XLSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx).
