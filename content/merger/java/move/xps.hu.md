...
############################# Head ############################
head_title: "XPS oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XPS dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XPS oldal mozgatása a Java nyelven"
description: "Mozgasson át XPS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XPS fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet XPS fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XPS oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) webhely meglátogatásával azonnal áthelyezhet XPS fájloldalt.
