...
############################# Head ############################
head_title: "Pindahkan DOTX Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen DOTX di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOTX Halaman Di Java"
description: "Pindahkan Halaman DOTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan DOTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file DOTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan DOTX Halaman Online"
    content: |
       Pindahkan halaman file DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/dotx).
