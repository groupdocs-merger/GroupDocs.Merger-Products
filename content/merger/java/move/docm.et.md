...
############################# Head ############################
head_title: "Teisalda DOCM lehte teenuses Java"
head_description: "Teisaldage dokumendi DOCM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOCM lehte rakenduses Java"
description: "Teisaldage DOCM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOCM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOCM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOCM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage DOCM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage DOCM lehte võrgus"
    content: |
       Teisaldage kohe DOCM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
