...
############################# Head ############################
head_title: "Alihkan PDF Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen PDF dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PDF Halaman Dalam Java"
description: "Alihkan PDF Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan PDF Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail PDF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PDF halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan PDF halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan PDF Halaman Dalam Talian"
    content: |
       Alihkan PDF halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
