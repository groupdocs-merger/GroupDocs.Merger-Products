...
############################# Head ############################
head_title: "Teisalda OTT lehte teenuses Java"
head_description: "Teisaldage dokumendi OTT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda OTT lehte rakenduses Java"
description: "Teisaldage OTT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda OTT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis OTT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada OTT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage OTT faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage OTT lehte võrgus"
    content: |
       Teisaldage kohe OTT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
