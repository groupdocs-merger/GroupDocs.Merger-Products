...
############################# Head ############################
head_title: "Pindahkan XLS Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen XLS di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLS Halaman Di Java"
description: "Pindahkan Halaman XLS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan XLS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file XLS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLS menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan XLS Halaman Online"
    content: |
       Pindahkan halaman file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/xls).
