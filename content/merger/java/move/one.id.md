...
############################# Head ############################
head_title: "Pindahkan ONE Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen ONE di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ONE Halaman Di Java"
description: "Pindahkan Halaman ONE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan ONE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file ONE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ONE menggunakan kode contoh Java">}}

        ```java    
        // Pindahkan halaman file ONE menggunakan GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan ONE Halaman Online"
    content: |
       Pindahkan halaman file ONE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/one).
