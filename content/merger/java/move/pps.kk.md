...
############################# Head ############################
head_title: "PPS бетті Java ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы PPS құжатының беттерін Java ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "PPS бетті Java ішінде жылжыту"
description: "PPS беттерді Java кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "PPS файл бетін Java ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы PPS файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS файл беттерін Java мысал кодын пайдаланып жылжыту жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы PPS файл бетін жылжытыңыз
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - PPS беттерді желіге жылжытыңыз"
    content: |
       PPS файл бетін дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) веб-сайтына жылжытыңыз.
