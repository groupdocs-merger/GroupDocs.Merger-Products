...
############################# Head ############################
head_title: "Pindahkan IMAGE Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen IMAGE di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan IMAGE Halaman Di Java"
description: "Pindahkan Halaman IMAGE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan IMAGE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file IMAGE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file IMAGE menggunakan kode contoh Java">}}
