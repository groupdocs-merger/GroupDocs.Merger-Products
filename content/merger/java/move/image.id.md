...
head_title: "Pindahkan, Atur Ulang & Susun Ulang Halaman IMAGE di Java"
head_description: "Pengguna Java untuk memindahkan, mengatur ulang, dan menyusun ulang halaman dalam dokumen IMAGE dengan membalik urutan halaman menggunakan API penggabungan dokumen."

title: "Pindahkan & Susun Ulang IMAGE Halaman di Java"
description: "Pindahkan dan Atur ulang halaman dalam dokumen IMAGE ke posisi apa pun menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Atur ulang IMAGE File Pages di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk memindahkan dan mengatur ulang halaman dalam file IMAGE dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan IMAGE Halaman Dokumen Online"
    content: |
        Pindahkan halaman dalam file IMAGE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/IMAGE).
