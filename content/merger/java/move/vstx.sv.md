...
############################# Head ############################
head_title: "Flytta VSTX sidor i Java"
head_description: "Flytta sidor i ett VSTX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSTX sidor i Java"
description: "Flytta VSTX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSTX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSTX sidor online"
    content: |
       Flytta VSTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx).
