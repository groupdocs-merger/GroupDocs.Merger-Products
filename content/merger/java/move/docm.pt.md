...
############################# Head ############################
head_title: "Mover DOCM Páginas em Java"
head_description: "Mova as páginas em um documento DOCM em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover DOCM Páginas em Java"
description: "Mova DOCM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo DOCM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo DOCM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo DOCM usando o código de exemplo Java">}}
