...
############################# Head ############################
head_title: "Premakni VSSM strani v Java"
head_description: "Premaknite strani znotraj dokumenta VSSM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSSM strani v Java"
description: "Premaknite strani VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VSSM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSSM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke VSSM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite VSSM strani na splet"
    content: |
       Takoj premaknite strani datoteke VSSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
