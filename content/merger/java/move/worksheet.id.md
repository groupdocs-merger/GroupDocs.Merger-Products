...
############################# Head ############################
head_title: "Pindahkan WORKSHEET Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen WORKSHEET di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WORKSHEET Halaman Di Java"
description: "Pindahkan Halaman WORKSHEET dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan WORKSHEET Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file WORKSHEET dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WORKSHEET menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan WORKSHEET Halaman Online"
    content: |
       Pindahkan halaman file WORKSHEET sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/worksheet).
