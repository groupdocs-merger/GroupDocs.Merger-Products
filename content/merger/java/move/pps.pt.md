...
############################# Head ############################
head_title: "Mover PPS Páginas em Java"
head_description: "Mova as páginas em um documento PPS em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PPS Páginas em Java"
description: "Mova PPS Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PPS em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo PPS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PPS usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo PPS usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover PPS páginas on-line"
    content: |
       Mova as páginas do arquivo PPS agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
