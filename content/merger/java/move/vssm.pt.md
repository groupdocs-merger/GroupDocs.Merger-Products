...
############################# Head ############################
head_title: "Mover VSSM Páginas em Java"
head_description: "Mova as páginas em um documento VSSM em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSSM Páginas em Java"
description: "Mova VSSM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSSM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo VSSM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSSM usando o código de exemplo Java">}}
