...
############################# Head ############################
head_title: "Perkelti XLTX puslapius Java"
head_description: "Perkelkite puslapius XLTX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLTX puslapius Java"
description: "Perkelkite XLTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLTX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLTX puslapius į internetą"
    content: |
       Perkelkite XLTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx) svetainėje.
