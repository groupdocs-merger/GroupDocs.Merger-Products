...
############################# Head ############################
head_title: "Mutați ODT pagini în Java"
head_description: "Mutați paginile dintr-un document ODT în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ODT pagini în Java"
description: "Mutați ODT pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați ODT pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier ODT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ODT utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere ODT utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​ODT pagini online"
    content: |
       Mutați pagini de fișiere ODT chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
