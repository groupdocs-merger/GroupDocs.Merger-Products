...
############################# Head ############################
head_title: "Pindahkan ODS Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen ODS di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ODS Halaman Di Java"
description: "Pindahkan Halaman ODS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan ODS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file ODS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ODS menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan ODS Halaman Online"
    content: |
       Pindahkan halaman file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/ods).
