...
############################# Head ############################
head_title: "Perkelti DOCX puslapius Java"
head_description: "Perkelkite puslapius DOCX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOCX puslapius Java"
description: "Perkelkite DOCX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOCX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOCX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOCX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOCX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOCX puslapius į internetą"
    content: |
       Perkelkite DOCX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) svetainėje.
