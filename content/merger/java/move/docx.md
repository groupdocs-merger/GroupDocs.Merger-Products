...
head_description: "Move pages within a DOCX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOCX Pages In Java"
description: "Move DOCX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOCX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOCX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOCX file pages using Java example code">}}
