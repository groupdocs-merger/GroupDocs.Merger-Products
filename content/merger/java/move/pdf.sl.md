...
############################# Head ############################
head_title: "Premakni PDF strani v Java"
head_description: "Premaknite strani znotraj dokumenta PDF v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PDF strani v Java"
description: "Premaknite strani PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PDF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke PDF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PDF s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke PDF z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite PDF strani na splet"
    content: |
       Takoj premaknite strani datoteke PDF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
