...
############################# Head ############################
head_title: "Move DOC Pages in Java"
head_description: "Move pages within a DOC document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOC Pages In Java"
description: "Move DOC Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOC File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOC file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOC file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move DOC Pages Online"
    content: |
       Move DOC file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc) website.
