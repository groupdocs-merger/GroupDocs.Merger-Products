...
############################# Head ############################
head_title: "Premakni PPT strani v Java"
head_description: "Premaknite strani znotraj dokumenta PPT v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPT strani v Java"
description: "Premaknite strani PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke PPT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPT s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke PPT z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite PPT strani na splet"
    content: |
       Takoj premaknite strani datoteke PPT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
