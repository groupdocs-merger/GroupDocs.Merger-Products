...
############################# Head ############################
head_title: "Move IMAGE Pages in Java"
head_description: "Move pages within a IMAGE document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move IMAGE Pages In Java"
description: "Move IMAGE Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move IMAGE File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a IMAGE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move IMAGE file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move IMAGE Pages Online"
    content: |
       Move IMAGE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/image) website.
