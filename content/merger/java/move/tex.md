...
############################# Head ############################
head_title: "Move TEX Pages in Java"
head_description: "Move pages within a TEX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move TEX Pages In Java"
description: "Move TEX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move TEX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a TEX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move TEX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move TEX Pages Online"
    content: |
       Move TEX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) website.
