...
############################# Head ############################
head_title: "Flytta VSDM sidor i Java"
head_description: "Flytta sidor i ett VSDM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSDM sidor i Java"
description: "Flytta VSDM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSDM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSDM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSDM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSDM filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSDM sidor online"
    content: |
       Flytta VSDM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
