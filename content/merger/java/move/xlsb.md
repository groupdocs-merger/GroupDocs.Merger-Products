...
############################# Head ############################
head_title: "Move XLSB Pages in Java"
head_description: "Move pages within a XLSB document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLSB Pages In Java"
description: "Move XLSB Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLSB File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLSB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSB file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLSB Pages Online"
    content: |
       Move XLSB file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) website.
