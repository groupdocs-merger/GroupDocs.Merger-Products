...
############################# Head ############################
head_title: "Flytt VSX sider i Java"
head_description: "Flytt sider i et VSX-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSX sider i Java"
description: "Flytt VSX sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt VSX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en VSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSX filsider ved hjelp av Java eksempelkode">}}
