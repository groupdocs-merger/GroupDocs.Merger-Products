...
############################# Head ############################
head_title: "Premakni ONE strani v Java"
head_description: "Premaknite strani znotraj dokumenta ONE v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ONE strani v Java"
description: "Premaknite strani ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ONE v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke ONE z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ONE s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke ONE z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite ONE strani na splet"
    content: |
       Takoj premaknite strani datoteke ONE tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
