...
############################# Head ############################
head_title: "Skuif PPT bladsye in Java"
head_description: "Skuif bladsye binne 'n PPT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PPT bladsye in Java"
description: "Skuif PPT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif PPT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n PPT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif PPT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif PPT bladsye aanlyn"
    content: |
       Skuif PPT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) webwerf te besoek.
