...
############################# Head ############################
head_title: "Siirrä OTT sivua Java"
head_description: "Siirrä OTT-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä OTT sivua Java"
description: "Siirrä OTT sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä OTT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja OTT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää OTT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä OTT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä OTT sivua verkkoon"
    content: |
       Siirrä OTT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) -sivustolla.
