...
############################# Head ############################
head_title: "Move XLS Pages in Java"
head_description: "Move pages within a XLS document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLS Pages In Java"
description: "Move XLS Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLS File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLS file pages using Java example code">}}

        ```java    
        // Move XLS file pages using GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live Demos - Move XLS Pages Online"
    content: |
       Move XLS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls) website.
