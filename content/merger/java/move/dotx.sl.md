...
############################# Head ############################
head_title: "Premakni DOTX strani v Java"
head_description: "Premaknite strani znotraj dokumenta DOTX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOTX strani v Java"
description: "Premaknite strani DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke DOTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOTX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke DOTX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite DOTX strani na splet"
    content: |
       Takoj premaknite strani datoteke DOTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx).
