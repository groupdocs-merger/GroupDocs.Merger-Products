...
############################# Head ############################
head_title: "Pārvietot EPUB lapas programmā Java"
head_description: "Pārvietojiet lapas EPUB dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot EPUB lapas programmā Java"
description: "Pārvietojiet EPUB lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot EPUB faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas EPUB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot EPUB faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet EPUB faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet EPUB lapas tiešsaistē"
    content: |
       Pārvietojiet EPUB faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
