...
############################# Head ############################
head_title: "VSSX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSSX Sayfayı Java İçinde Taşı"
description: "VSSX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSSX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VSSX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - VSSX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) web sitesini ziyaret ederek VSSX dosya sayfalarını hemen şimdi taşıyın.
