...
############################# Head ############################
head_title: "Mutați OTP pagini în Java"
head_description: "Mutați paginile dintr-un document OTP în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați OTP pagini în Java"
description: "Mutați OTP pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați OTP pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier OTP prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere OTP utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere OTP utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​OTP pagini online"
    content: |
       Mutați pagini de fișiere OTP chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
