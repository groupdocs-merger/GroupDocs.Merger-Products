...
############################# Head ############################
head_title: "Move PDF pages in Java"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to move selected pages in PDF documents. Enhance your Java applications with advanced document processing features.
