...
############################# Head ############################
head_title: "Teisalda VDX lehte teenuses Java"
head_description: "Teisaldage dokumendi VDX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VDX lehte rakenduses Java"
description: "Teisaldage VDX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VDX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VDX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VDX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VDX lehte võrgus"
    content: |
       Teisaldage kohe VDX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
