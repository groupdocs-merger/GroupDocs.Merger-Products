...
############################# Head ############################
head_title: "Premakni ODT strani v Java"
head_description: "Premaknite strani znotraj dokumenta ODT v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ODT strani v Java"
description: "Premaknite strani ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ODT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke ODT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ODT s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke ODT z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite ODT strani na splet"
    content: |
       Takoj premaknite strani datoteke ODT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
