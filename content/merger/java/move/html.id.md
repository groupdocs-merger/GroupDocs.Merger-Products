...
head_title: "Pindahkan, Atur Ulang & Susun Ulang Halaman HTML di Java"
head_description: "Pengguna Java untuk memindahkan, mengatur ulang, dan menyusun ulang halaman dalam dokumen HTML dengan membalik urutan halaman menggunakan API penggabungan dokumen."

title: "Pindahkan & Susun Ulang HTML Halaman di Java"
description: "Pindahkan dan Atur ulang halaman dalam dokumen HTML ke posisi apa pun menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Atur ulang HTML File Pages di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk memindahkan dan mengatur ulang halaman dalam file HTML dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```java
        // Pindahkan halaman file HTML menggunakan GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan HTML Halaman Dokumen Online"
    content: |
        Pindahkan halaman dalam file HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/HTML).
