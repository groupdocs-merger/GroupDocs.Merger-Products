...
############################# Head ############################
head_title: "Mutați PPTX pagini în Java"
head_description: "Mutați paginile dintr-un document PPTX în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PPTX pagini în Java"
description: "Mutați PPTX pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați PPTX pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier PPTX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PPTX utilizând codul exemplu Java">}}
