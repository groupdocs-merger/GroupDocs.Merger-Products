...
############################# Head ############################
head_title: "VSDX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSDX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSDX Sayfayı Java İçinde Taşı"
description: "VSDX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSDX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSDX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VSDX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - VSDX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) web sitesini ziyaret ederek VSDX dosya sayfalarını hemen şimdi taşıyın.
