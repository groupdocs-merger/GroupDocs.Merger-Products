...
############################# Head ############################
head_title: "HTML صفحات کو Java میں منتقل کریں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے Java میں HTML دستاویز کے اندر صفحات کو کسی بھی پوزیشن پر منتقل کریں۔"

############################# Header ############################
title: "HTML صفحات کو Java میں منتقل کریں"
description: "Java کوڈ کی چند سطروں کے ساتھ HTML صفحات کو منتقل کریں۔"
...
steps:
    enable: true
    title_left: "HTML فائل صفحات کو Java میں منتقل کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) کچھ آسان اقدامات کو لاگو کرکے Java ڈویلپرز کے لیے صفحات کو HTML فائل میں منتقل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے HTML فائل کے صفحات کو کیسے منتقل کریں۔">}}

        ```java    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے HTML فائل کے صفحات کو منتقل کریں۔
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "لائیو ڈیمو - HTML صفحات آن لائن منتقل کریں۔"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) ویب سائٹ پر جا کر HTML فائل کے صفحات کو ابھی منتقل کریں۔
