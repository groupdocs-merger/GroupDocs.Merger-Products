...
############################# Head ############################
head_title: "Teisalda XLTX lehte teenuses Java"
head_description: "Teisaldage dokumendi XLTX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLTX lehte rakenduses Java"
description: "Teisaldage XLTX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLTX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLTX lehte võrgus"
    content: |
       Teisaldage kohe XLTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
