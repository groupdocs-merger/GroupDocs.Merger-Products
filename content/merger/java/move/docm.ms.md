...
############################# Head ############################
head_title: "Alihkan DOCM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen DOCM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOCM Halaman Dalam Java"
description: "Alihkan DOCM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan DOCM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail DOCM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOCM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan DOCM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan DOCM Halaman Dalam Talian"
    content: |
       Alihkan DOCM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
