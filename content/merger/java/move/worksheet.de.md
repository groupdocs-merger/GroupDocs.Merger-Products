...
############################# Head ############################
head_title: "Verschiebe WORKSHEET Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines WORKSHEET-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe WORKSHEET Seiten in Java"
description: "Verschieben Sie WORKSHEET-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie WORKSHEET Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer WORKSHEET-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie WORKSHEET-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie WORKSHEET Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie WORKSHEET Seiten online"
    content: |
       Verschieben Sie jetzt WORKSHEET Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/worksheet) besuchen.
