...
############################# Head ############################
head_title: "Skuif XLTM bladsye in Java"
head_description: "Skuif bladsye binne 'n XLTM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XLTM bladsye in Java"
description: "Skuif XLTM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XLTM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLTM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XLTM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XLTM bladsye aanlyn"
    content: |
       Skuif XLTM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) webwerf te besoek.
