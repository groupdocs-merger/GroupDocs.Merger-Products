...
############################# Head ############################
head_title: "Verschiebe VSTM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSTM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSTM Seiten in Java"
description: "Verschieben Sie VSTM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSTM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSTM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSTM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSTM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSTM Seiten online"
    content: |
       Verschieben Sie jetzt VSTM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm) besuchen.
