...
############################# Head ############################
head_title: "Pārvietot XPS lapas programmā Java"
head_description: "Pārvietojiet lapas XPS dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XPS lapas programmā Java"
description: "Pārvietojiet XPS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XPS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XPS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XPS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XPS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XPS lapas tiešsaistē"
    content: |
       Pārvietojiet XPS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps).
