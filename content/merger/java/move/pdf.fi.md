...
############################# Head ############################
head_title: "Siirrä PDF sivua Java"
head_description: "Siirrä PDF-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PDF sivua Java"
description: "Siirrä PDF sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PDF tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja PDF-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PDF tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä PDF tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä PDF sivua verkkoon"
    content: |
       Siirrä PDF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) -sivustolla.
