...
############################# Head ############################
head_title: "Flytta ODT sidor i Java"
head_description: "Flytta sidor i ett ODT-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ODT sidor i Java"
description: "Flytta ODT sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta ODT filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en ODT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ODT filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta ODT filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta ODT sidor online"
    content: |
       Flytta ODT filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
