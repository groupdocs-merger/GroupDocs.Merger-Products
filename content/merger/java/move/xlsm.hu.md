...
############################# Head ############################
head_title: "XLSM oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XLSM dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSM oldal mozgatása a Java nyelven"
description: "Mozgasson át XLSM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSM fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XLSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet XLSM fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLSM oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) webhely meglátogatásával azonnal áthelyezhet XLSM fájloldalt.
