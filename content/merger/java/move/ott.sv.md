...
############################# Head ############################
head_title: "Flytta OTT sidor i Java"
head_description: "Flytta sidor i ett OTT-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta OTT sidor i Java"
description: "Flytta OTT sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta OTT filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en OTT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar OTT filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta OTT filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta OTT sidor online"
    content: |
       Flytta OTT filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
