...
############################# Head ############################
head_title: "Verschiebe XLS Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLS-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLS Seiten in Java"
description: "Verschieben Sie XLS-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLS Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLS-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLS-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLS Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLS Seiten online"
    content: |
       Verschieben Sie jetzt XLS Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls) besuchen.
