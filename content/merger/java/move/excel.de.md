...
############################# Head ############################
head_title: "Verschiebe EXCEL Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines EXCEL-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe EXCEL Seiten in Java"
description: "Verschieben Sie EXCEL-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie EXCEL Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer EXCEL-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie EXCEL-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie EXCEL Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie EXCEL Seiten online"
    content: |
       Verschieben Sie jetzt EXCEL Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/excel) besuchen.
