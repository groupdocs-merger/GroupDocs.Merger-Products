...
############################# Head ############################
head_title: "Seiten in EXCEL in Java verschieben"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um Seiten in EXCEL-Dokumenten mühelos neu anzuordnen. Verarbeiten Sie PDF-, Word-, Excel-, PowerPoint-Dateien, Bilder und mehr."

############################# Header ############################
title: "Seiten in EXCEL verschieben" 
description: "GroupDocs.Merger for Java ermöglicht Anwendungen in Java, Seiten in EXCEL-Dokumenten nahtlos neu anzuordnen."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ermöglicht es Ihnen, ausgewählte Seiten in EXCEL-Dokumenten zu verschieben. Erweitern Sie Ihre Java-Anwendungen um fortschrittliche Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Speicherort der EXCEL-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eine Seite an das Ende des Dokuments verschieben"
      content: |
        Erfahren Sie, wie Sie eine bestimmte Seite an das Ende eines EXCEL-Dokuments verschieben.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
