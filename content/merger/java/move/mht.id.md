...
############################# Head ############################
head_title: "Pindahkan MHT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen MHT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan MHT Halaman Di Java"
description: "Pindahkan Halaman MHT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan MHT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file MHT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file MHT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan MHT Halaman Online"
    content: |
       Pindahkan halaman file MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/mht).
