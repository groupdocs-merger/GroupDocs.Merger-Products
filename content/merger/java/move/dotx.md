...
############################# Head ############################
head_title: "Move DOTX Pages in Java"
head_description: "Move pages within a DOTX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOTX Pages In Java"
description: "Move DOTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOTX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move DOTX Pages Online"
    content: |
       Move DOTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) website.
