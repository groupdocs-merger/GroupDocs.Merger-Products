...
############################# Head ############################
head_title: "Verschiebe VSDX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSDX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSDX Seiten in Java"
description: "Verschieben Sie VSDX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSDX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSDX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSDX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSDX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSDX Seiten online"
    content: |
       Verschieben Sie jetzt VSDX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) besuchen.
