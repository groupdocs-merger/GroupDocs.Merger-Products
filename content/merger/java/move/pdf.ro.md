...
############################# Head ############################
head_title: "Mutați PDF pagini în Java"
head_description: "Mutați paginile dintr-un document PDF în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PDF pagini în Java"
description: "Mutați PDF pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați PDF pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier PDF prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PDF utilizând codul exemplu Java">}}
