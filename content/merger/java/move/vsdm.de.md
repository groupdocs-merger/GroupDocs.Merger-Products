...
############################# Head ############################
head_title: "Verschiebe VSDM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSDM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSDM Seiten in Java"
description: "Verschieben Sie VSDM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSDM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSDM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSDM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSDM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSDM Seiten online"
    content: |
       Verschieben Sie jetzt VSDM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm) besuchen.
