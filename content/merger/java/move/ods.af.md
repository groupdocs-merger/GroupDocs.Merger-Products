...
############################# Head ############################
head_title: "Skuif ODS bladsye in Java"
head_description: "Skuif bladsye binne 'n ODS dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif ODS bladsye in Java"
description: "Skuif ODS bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif ODS lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n ODS-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODS lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif ODS lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif ODS bladsye aanlyn"
    content: |
       Skuif ODS lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) webwerf te besoek.
