...
############################# Head ############################
head_title: "نقل صفحات ODS في Java"
head_description: "انقل الصفحات داخل مستند ODS في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ODS في Java"
description: "انقل صفحات ODS ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل ODS صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف ODS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ODS باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف ODS باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات ODS عبر الإنترنت"
    content: |
       انقل صفحات ملف ODS الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods).
