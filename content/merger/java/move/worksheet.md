...
############################# Head ############################
head_title: "Move WORKSHEET Pages in Java"
head_description: "Move pages within a WORKSHEET document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move WORKSHEET Pages In Java"
description: "Move WORKSHEET Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move WORKSHEET File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a WORKSHEET file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WORKSHEET file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move WORKSHEET Pages Online"
    content: |
       Move WORKSHEET file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/worksheet) website.
