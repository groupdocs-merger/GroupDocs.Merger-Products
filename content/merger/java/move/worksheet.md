...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to move and rearrange pages within a WORKSHEET file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Move WORKSHEET Document Pages Online"
    content: |
        Move pages within WORKSHEET files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/worksheet) website.
