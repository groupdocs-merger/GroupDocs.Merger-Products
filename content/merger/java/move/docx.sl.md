...
############################# Head ############################
head_title: "Premakni DOCX strani v Java"
head_description: "Premaknite strani znotraj dokumenta DOCX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOCX strani v Java"
description: "Premaknite strani DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOCX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke DOCX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOCX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke DOCX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite DOCX strani na splet"
    content: |
       Takoj premaknite strani datoteke DOCX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx).
