...
############################# Head ############################
head_title: "Mover ONE Páginas em Java"
head_description: "Mova as páginas em um documento ONE em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ONE Páginas em Java"
description: "Mova ONE Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ONE em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo ONE implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ONE usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo ONE usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover ONE páginas on-line"
    content: |
       Mova as páginas do arquivo ONE agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
