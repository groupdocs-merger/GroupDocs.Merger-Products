...
############################# Head ############################
head_title: "Skuif PPS bladsye in Java"
head_description: "Skuif bladsye binne 'n PPS dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PPS bladsye in Java"
description: "Skuif PPS bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif PPS lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n PPS-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPS lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif PPS lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif PPS bladsye aanlyn"
    content: |
       Skuif PPS lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) webwerf te besoek.
