...
############################# Head ############################
head_title: "Flytta VSSX sidor i Java"
head_description: "Flytta sidor i ett VSSX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSSX sidor i Java"
description: "Flytta VSSX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSSX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSSX sidor online"
    content: |
       Flytta VSSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx).
