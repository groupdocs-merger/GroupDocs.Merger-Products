...
############################# Head ############################
head_title: "Преместете VDX страници в Java"
head_description: "Преместете страници в VDX документ в Java на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете VDX страници в Java"
description: "Преместете VDX страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Преместете VDX файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да преместват страници в рамките на файл VDX чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате VDX файлови страници с помощта на Java примерен код">}}

        ```java    
        // Преместете VDX файлови страници с помощта на GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Демонстрации на живо - Преместете VDX страници онлайн"
    content: |
       Преместете VDX файлови страници точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
