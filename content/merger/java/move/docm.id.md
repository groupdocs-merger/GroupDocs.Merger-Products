...
############################# Head ############################
head_title: "Pindahkan DOCM Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen DOCM di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOCM Halaman Di Java"
description: "Pindahkan Halaman DOCM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan DOCM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file DOCM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOCM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan DOCM Halaman Online"
    content: |
       Pindahkan halaman file DOCM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/docm).
