...
############################# Head ############################
head_title: "Premakni XLTM strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLTM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLTM strani v Java"
description: "Premaknite strani XLTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLTM s primerom kode Java">}}
