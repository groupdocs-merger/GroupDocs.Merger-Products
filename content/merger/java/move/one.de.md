...
############################# Head ############################
head_title: "Verschiebe ONE Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines ONE-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe ONE Seiten in Java"
description: "Verschieben Sie ONE-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie ONE Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer ONE-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie ONE-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie ONE Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie ONE Seiten online"
    content: |
       Verschieben Sie jetzt ONE Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) besuchen.
