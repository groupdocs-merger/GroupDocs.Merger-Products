...
############################# Head ############################
head_title: "Flytt PPTX sider i Java"
head_description: "Flytt sider i et PPTX-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PPTX sider i Java"
description: "Flytt PPTX sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt PPTX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en PPTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PPTX filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt PPTX filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt PPTX sider på nettet"
    content: |
       Flytt PPTX filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) nettstedet.
