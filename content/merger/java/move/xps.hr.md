...
############################# Head ############################
head_title: "Premjesti XPS stranice u Java"
head_description: "Premjestite stranice unutar XPS dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XPS stranice u Java"
description: "Premjesti XPS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti XPS stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar XPS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XPS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti XPS stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti XPS stranice na mrežu"
    content: |
       Premjestite XPS stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) web stranice.
