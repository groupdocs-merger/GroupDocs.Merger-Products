...
############################# Head ############################
head_title: "نقل صفحات DOTX في Java"
head_description: "انقل الصفحات داخل مستند DOTX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOTX في Java"
description: "انقل صفحات DOTX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOTX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOTX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOTX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOTX عبر الإنترنت"
    content: |
       انقل صفحات ملف DOTX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx).
