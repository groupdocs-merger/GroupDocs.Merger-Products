...
############################# Head ############################
head_title: "Alihkan PPTX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen PPTX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPTX Halaman Dalam Java"
description: "Alihkan PPTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan PPTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail PPTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan PPTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan PPTX Halaman Dalam Talian"
    content: |
       Alihkan PPTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
