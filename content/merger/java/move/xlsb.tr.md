...
############################# Head ############################
head_title: "XLSB Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir XLSB belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLSB Sayfayı Java İçinde Taşı"
description: "XLSB Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLSB Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir XLSB dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSB dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak XLSB dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - XLSB Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) web sitesini ziyaret ederek XLSB dosya sayfalarını hemen şimdi taşıyın.
