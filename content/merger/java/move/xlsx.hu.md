...
############################# Head ############################
head_title: "XLSX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XLSX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSX oldal mozgatása a Java nyelven"
description: "Mozgasson át XLSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XLSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet XLSX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLSX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) webhely meglátogatásával azonnal áthelyezhet XLSX fájloldalt.
