...
############################# Head ############################
head_title: "Perkelti XLSB puslapius Java"
head_description: "Perkelkite puslapius XLSB dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSB puslapius Java"
description: "Perkelkite XLSB puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSB failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLSB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSB failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLSB failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLSB puslapius į internetą"
    content: |
       Perkelkite XLSB failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) svetainėje.
