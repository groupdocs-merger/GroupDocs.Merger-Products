...
############################# Head ############################
head_title: "XLT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir XLT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLT Sayfayı Java İçinde Taşı"
description: "XLT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir XLT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak XLT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - XLT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) web sitesini ziyaret ederek XLT dosya sayfalarını hemen şimdi taşıyın.
