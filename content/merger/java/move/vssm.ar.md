...
############################# Head ############################
head_title: "نقل صفحات VSSM في Java"
head_description: "انقل الصفحات داخل مستند VSSM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSSM في Java"
description: "انقل صفحات VSSM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل VSSM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف VSSM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSSM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف VSSM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات VSSM عبر الإنترنت"
    content: |
       انقل صفحات ملف VSSM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
