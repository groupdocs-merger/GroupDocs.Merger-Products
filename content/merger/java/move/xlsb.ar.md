...
############################# Head ############################
head_title: "نقل صفحات XLSB في Java"
head_description: "انقل الصفحات داخل مستند XLSB في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLSB في Java"
description: "انقل صفحات XLSB ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLSB صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLSB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLSB باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLSB باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLSB عبر الإنترنت"
    content: |
       انقل صفحات ملف XLSB الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb).
