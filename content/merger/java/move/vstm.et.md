...
############################# Head ############################
head_title: "Teisalda VSTM lehte teenuses Java"
head_description: "Teisaldage dokumendi VSTM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSTM lehte rakenduses Java"
description: "Teisaldage VSTM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VSTM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VSTM lehte võrgus"
    content: |
       Teisaldage kohe VSTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
