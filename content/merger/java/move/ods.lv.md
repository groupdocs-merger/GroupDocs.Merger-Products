...
############################# Head ############################
head_title: "Pārvietot ODS lapas programmā Java"
head_description: "Pārvietojiet lapas ODS dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot ODS lapas programmā Java"
description: "Pārvietojiet ODS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot ODS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas ODS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot ODS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet ODS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet ODS lapas tiešsaistē"
    content: |
       Pārvietojiet ODS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods).
