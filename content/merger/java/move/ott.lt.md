...
############################# Head ############################
head_title: "Perkelti OTT puslapius Java"
head_description: "Perkelkite puslapius OTT dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti OTT puslapius Java"
description: "Perkelkite OTT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti OTT failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius OTT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti OTT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite OTT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite OTT puslapius į internetą"
    content: |
       Perkelkite OTT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) svetainėje.
