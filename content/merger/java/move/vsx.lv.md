...
############################# Head ############################
head_title: "Pārvietot VSX lapas programmā Java"
head_description: "Pārvietojiet lapas VSX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSX lapas programmā Java"
description: "Pārvietojiet VSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSX lapas tiešsaistē"
    content: |
       Pārvietojiet VSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx).
