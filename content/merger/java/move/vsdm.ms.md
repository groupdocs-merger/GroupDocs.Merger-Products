...
############################# Head ############################
head_title: "Alihkan VSDM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSDM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSDM Halaman Dalam Java"
description: "Alihkan VSDM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSDM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSDM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSDM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSDM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSDM Halaman Dalam Talian"
    content: |
       Alihkan VSDM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
