...
############################# Head ############################
head_title: "Perkelti OTP puslapius Java"
head_description: "Perkelkite puslapius OTP dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti OTP puslapius Java"
description: "Perkelkite OTP puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti OTP failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius OTP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti OTP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite OTP failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite OTP puslapius į internetą"
    content: |
       Perkelkite OTP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) svetainėje.
