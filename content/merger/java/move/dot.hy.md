...
############################# Head ############################
head_title: "Տեղափոխել DOT էջ Java-ում"
head_description: "Տեղափոխեք էջերը DOT փաստաթղթում Java-ում ցանկացած դիրք` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Տեղափոխել DOT էջ Java-ում"
description: "Տեղափոխեք DOT էջեր Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Տեղափոխել DOT ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար էջերը տեղափոխել DOT ֆայլի մեջ` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես տեղափոխել DOT ֆայլի էջեր՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Տեղափոխեք DOT ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Տեղափոխեք DOT էջեր առցանց"
    content: |
       Տեղափոխեք DOT ֆայլի էջեր հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) կայքը:
