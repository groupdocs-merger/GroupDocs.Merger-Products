...
############################# Head ############################
head_title: "Verschiebe OTP Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines OTP-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe OTP Seiten in Java"
description: "Verschieben Sie OTP-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie OTP Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer OTP-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie OTP-Dateiseiten mit Java-Beispielcode">}}
