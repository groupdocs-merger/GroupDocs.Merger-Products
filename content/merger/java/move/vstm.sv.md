...
############################# Head ############################
head_title: "Flytta VSTM sidor i Java"
head_description: "Flytta sidor i ett VSTM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSTM sidor i Java"
description: "Flytta VSTM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSTM filsidor med hjälp av Java exempelkod">}}
