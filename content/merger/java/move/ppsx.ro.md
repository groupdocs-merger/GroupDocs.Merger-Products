...
############################# Head ############################
head_title: "Mutați PPSX pagini în Java"
head_description: "Mutați paginile dintr-un document PPSX în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PPSX pagini în Java"
description: "Mutați PPSX pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați PPSX pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier PPSX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PPSX utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere PPSX utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​PPSX pagini online"
    content: |
       Mutați pagini de fișiere PPSX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
