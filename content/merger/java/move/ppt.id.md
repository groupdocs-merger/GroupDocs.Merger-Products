...
############################# Head ############################
head_title: "Pindahkan PPT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen PPT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PPT Halaman Di Java"
description: "Pindahkan Halaman PPT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan PPT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file PPT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PPT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan PPT Halaman Online"
    content: |
       Pindahkan halaman file PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/ppt).
