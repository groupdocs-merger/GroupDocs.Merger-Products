...
############################# Head ############################
head_title: "Perkelti MHT puslapius Java"
head_description: "Perkelkite puslapius MHT dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti MHT puslapius Java"
description: "Perkelkite MHT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti MHT failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius MHT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti MHT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite MHT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite MHT puslapius į internetą"
    content: |
       Perkelkite MHT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) svetainėje.
