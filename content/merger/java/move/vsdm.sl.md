...
############################# Head ############################
head_title: "Premakni VSDM strani v Java"
head_description: "Premaknite strani znotraj dokumenta VSDM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSDM strani v Java"
description: "Premaknite strani VSDM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSDM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke VSDM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSDM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke VSDM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite VSDM strani na splet"
    content: |
       Takoj premaknite strani datoteke VSDM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
