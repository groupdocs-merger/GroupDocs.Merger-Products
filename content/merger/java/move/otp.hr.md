...
############################# Head ############################
head_title: "Premjesti OTP stranice u Java"
head_description: "Premjestite stranice unutar OTP dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti OTP stranice u Java"
description: "Premjesti OTP stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti OTP stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar OTP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti OTP stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti OTP stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti OTP stranice na mrežu"
    content: |
       Premjestite OTP stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) web stranice.
