...
############################# Head ############################
head_title: "Teisalda VSSX lehte teenuses Java"
head_description: "Teisaldage dokumendi VSSX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSSX lehte rakenduses Java"
description: "Teisaldage VSSX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VSSX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VSSX lehte võrgus"
    content: |
       Teisaldage kohe VSSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx).
