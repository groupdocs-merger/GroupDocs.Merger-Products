...
############################# Head ############################
head_title: "نقل صفحات PPTX في Java"
head_description: "انقل الصفحات داخل مستند PPTX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPTX في Java"
description: "انقل صفحات PPTX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل PPTX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف PPTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPTX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف PPTX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات PPTX عبر الإنترنت"
    content: |
       انقل صفحات ملف PPTX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
