...
############################# Head ############################
head_title: "Mover páginas de XLSX em Java"
head_description: "Utilize GroupDocs.Merger for Java para reorganizar páginas em documentos XLSX de forma eficaz. Processar PDFs, Word, Excel, PowerPoint, imagens e muito mais."

############################# Header ############################
title: "Mover páginas em XLSX" 
description: "GroupDocs.Merger for Java permite que aplicativos Java reorganizem páginas em documentos XLSX de maneira integrada."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) permite que você mova páginas selecionadas em documentos XLSX. Aprimore seus aplicativos Java com recursos avançados de processamento de documentos.
      
      1. Especifique o caminho do arquivo XLSX de origem.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mover uma página para o final do documento"
      content: |
        Aprenda como mover uma página específica para o final de um documento XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
