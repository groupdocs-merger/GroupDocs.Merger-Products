...
############################# Head ############################
head_title: "Siirrä VSSX sivua Java"
head_description: "Siirrä VSSX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSSX sivua Java"
description: "Siirrä VSSX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VSSX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VSSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VSSX sivua verkkoon"
    content: |
       Siirrä VSSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) -sivustolla.
