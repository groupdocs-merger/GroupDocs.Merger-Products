...
############################# Head ############################
head_title: "Perkelti VSTX puslapius Java"
head_description: "Perkelkite puslapius VSTX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSTX puslapius Java"
description: "Perkelkite VSTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSTX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VSTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VSTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VSTX puslapius į internetą"
    content: |
       Perkelkite VSTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx) svetainėje.
