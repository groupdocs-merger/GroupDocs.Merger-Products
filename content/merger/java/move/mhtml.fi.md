...
############################# Head ############################
head_title: "Siirrä MHTML sivua Java"
head_description: "Siirrä MHTML-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä MHTML sivua Java"
description: "Siirrä MHTML sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä MHTML tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja MHTML-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää MHTML tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä MHTML tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä MHTML sivua verkkoon"
    content: |
       Siirrä MHTML tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml) -sivustolla.
