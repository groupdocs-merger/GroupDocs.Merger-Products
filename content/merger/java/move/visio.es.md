...
############################# Head ############################
head_title: "Mover páginas de VISIO en Java"
head_description: "Utiliza GroupDocs.Merger for Java para reordenar páginas en documentos VISIO sin esfuerzo. Procesa PDF, Word, Excel, PowerPoint, imágenes y más."

############################# Header ############################
title: "Mover páginas en VISIO" 
description: "GroupDocs.Merger for Java permite a las aplicaciones de Java reordenar páginas en documentos VISIO de manera fluida."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) te permite mover páginas seleccionadas en documentos VISIO. Mejora tus aplicaciones Java con funciones avanzadas de procesamiento de documentos.
      
      1. Especifica la ruta del archivo VISIO de origen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mover una página al final del documento"
      content: |
        Aprende cómo mover una página específica al final de un documento VISIO.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
