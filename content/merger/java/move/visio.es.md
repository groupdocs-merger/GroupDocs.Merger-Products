...
############################# Head ############################
head_title: "Mover VISIO páginas en Java"
head_description: "Mueva páginas dentro de un documento VISIO en Java a cualquier posición usando la API de fusión de documentos."

############################# Header ############################
title: "Mover VISIO páginas en Java"
description: "Mueva VISIO páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Mover VISIO páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java mover páginas dentro de un archivo VISIO mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo mover páginas de archivos VISIO usando el código de ejemplo Java">}}

        ```java    
        // Mover VISIO páginas de archivos usando GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo - Mover VISIO páginas en línea"
    content: |
       Mueva las páginas de archivos VISIO ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/visio).
