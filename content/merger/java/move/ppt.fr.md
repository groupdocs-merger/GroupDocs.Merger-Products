...
############################# Head ############################
head_title: "Déplacer PPT pages dans Java"
head_description: "Déplacez les pages d'un document PPT dans Java vers n'importe quelle position à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Déplacer PPT pages dans Java"
description: "Déplacez PPT pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Déplacer PPT pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de déplacer facilement des pages dans un fichier PPT en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment déplacer les pages de fichiers PPT à l'aide de l'exemple de code Java">}}

        ```java    
        // Déplacer PPT pages de fichiers à l'aide de l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Démos en direct - Déplacer PPT pages en ligne"
    content: |
       Déplacez PPT pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
