...
############################# Head ############################
head_title: "Przenieś RTF strony w Java"
head_description: "Przenieś strony w dokumencie RTF w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś RTF strony w Java"
description: "Przenieś strony RTF za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików RTF do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku RTF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść RTF strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików RTF za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś RTF strony online"
    content: |
       Przenieś strony plików RTF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
