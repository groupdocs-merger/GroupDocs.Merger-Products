...
############################# Head ############################
head_title: "Teisalda PPS lehte teenuses Java"
head_description: "Teisaldage dokumendi PPS lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPS lehte rakenduses Java"
description: "Teisaldage PPS lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis PPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage PPS faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage PPS lehte võrgus"
    content: |
       Teisaldage kohe PPS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
