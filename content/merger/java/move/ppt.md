...
############################# Head ############################
head_title: "Move PPT Pages in Java"
head_description: "Move pages within a PPT document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move PPT Pages In Java"
description: "Move PPT Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move PPT File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a PPT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPT file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move PPT Pages Online"
    content: |
       Move PPT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) website.
