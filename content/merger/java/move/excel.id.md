...
head_description: "Pindahkan halaman dalam dokumen EXCEL di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan EXCEL Halaman Di Java"
description: "Pindahkan Halaman EXCEL dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan EXCEL Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file EXCEL dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file EXCEL menggunakan kode contoh Java">}}
