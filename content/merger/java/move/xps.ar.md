...
############################# Head ############################
head_title: "نقل صفحات XPS في Java"
head_description: "انقل الصفحات داخل مستند XPS في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XPS في Java"
description: "انقل صفحات XPS ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XPS صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XPS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XPS باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XPS باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XPS عبر الإنترنت"
    content: |
       انقل صفحات ملف XPS الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps).
