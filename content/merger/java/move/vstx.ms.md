...
############################# Head ############################
head_title: "Alihkan VSTX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSTX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSTX Halaman Dalam Java"
description: "Alihkan VSTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSTX Halaman Dalam Talian"
    content: |
       Alihkan VSTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx).
