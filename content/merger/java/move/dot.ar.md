...
############################# Head ############################
head_title: "نقل صفحات DOT في Java"
head_description: "انقل الصفحات داخل مستند DOT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOT في Java"
description: "انقل صفحات DOT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOT باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOT باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOT عبر الإنترنت"
    content: |
       انقل صفحات ملف DOT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot).
