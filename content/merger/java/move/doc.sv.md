...
############################# Head ############################
head_title: "Flytta DOC sidor i Java"
head_description: "Flytta sidor i ett DOC-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOC sidor i Java"
description: "Flytta DOC sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta DOC filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en DOC-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOC filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta DOC filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta DOC sidor online"
    content: |
       Flytta DOC filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc).
