...
############################# Head ############################
head_title: "Move VSX Pages in Java"
head_description: "Move pages within a VSX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSX Pages In Java"
description: "Move VSX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSX Pages Online"
    content: |
       Move VSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) website.
