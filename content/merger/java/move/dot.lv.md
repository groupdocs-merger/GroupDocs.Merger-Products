...
############################# Head ############################
head_title: "Pārvietot DOT lapas programmā Java"
head_description: "Pārvietojiet lapas DOT dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOT lapas programmā Java"
description: "Pārvietojiet DOT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOT lapas tiešsaistē"
    content: |
       Pārvietojiet DOT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot).
