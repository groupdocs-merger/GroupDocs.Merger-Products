...
############################# Head ############################
head_title: "PPS Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir PPS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPS Sayfayı Java İçinde Taşı"
description: "PPS Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPS Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir PPS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPS dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak PPS dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - PPS Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) web sitesini ziyaret ederek PPS dosya sayfalarını hemen şimdi taşıyın.
