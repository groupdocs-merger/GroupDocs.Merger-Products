...
############################# Head ############################
head_title: "Pārvietot VSDM lapas programmā Java"
head_description: "Pārvietojiet lapas VSDM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSDM lapas programmā Java"
description: "Pārvietojiet VSDM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSDM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSDM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSDM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSDM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSDM lapas tiešsaistē"
    content: |
       Pārvietojiet VSDM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
