...
############################# Head ############################
head_title: "XLSM ገጾችን በJava ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በXLSM ሰነድ ውስጥ በJava ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "XLSM ገጾችን በJava ውስጥ አንቀሳቅስ"
description: "XLSM ገጾችን ከጥቂት መስመሮች Java ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "XLSM የፋይል ገጾችን በJava አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በXLSM ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የXLSM ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም XLSM የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - XLSM ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የXLSM ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
