...
############################# Head ############################
head_title: "Siirrä TEX sivua Java"
head_description: "Siirrä TEX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä TEX sivua Java"
description: "Siirrä TEX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä TEX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja TEX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää TEX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä TEX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä TEX sivua verkkoon"
    content: |
       Siirrä TEX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) -sivustolla.
