...
############################# Head ############################
head_title: "Flytta HTML sidor i Java"
head_description: "Flytta sidor i ett HTML-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta HTML sidor i Java"
description: "Flytta HTML sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta HTML filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en HTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar HTML filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta HTML filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta HTML sidor online"
    content: |
       Flytta HTML filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
