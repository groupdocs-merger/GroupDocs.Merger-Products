...
############################# Head ############################
head_title: "Přesunout XLTM stránky v Java"
head_description: "Přesunout stránky v dokumentu XLTM v Java na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout XLTM stránky do Java"
description: "Přesuňte XLTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Přesunout XLTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java přesouvat stránky v souboru XLTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru XLTM pomocí ukázkového kódu Java">}}

        ```java    
        // Přesunout stránky souboru XLTM pomocí GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živá ukázka – přesouvejte XLTM stránek online"
    content: |
       Přesuňte stránky souborů XLTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
