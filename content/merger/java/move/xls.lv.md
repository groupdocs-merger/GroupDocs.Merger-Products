...
############################# Head ############################
head_title: "Pārvietot XLS lapas programmā Java"
head_description: "Pārvietojiet lapas XLS dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLS lapas programmā Java"
description: "Pārvietojiet XLS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLS lapas tiešsaistē"
    content: |
       Pārvietojiet XLS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
