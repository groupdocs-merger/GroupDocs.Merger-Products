...
############################# Head ############################
head_title: "Pārvietot PPS lapas programmā Java"
head_description: "Pārvietojiet lapas PPS dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPS lapas programmā Java"
description: "Pārvietojiet PPS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas PPS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPS faila lapas, izmantojot Java piemēra kodu">}}
