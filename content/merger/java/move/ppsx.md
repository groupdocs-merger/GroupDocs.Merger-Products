...
############################# Head ############################
head_title: "Move PPSX Pages in Java"
head_description: "Move pages within a PPSX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move PPSX Pages In Java"
description: "Move PPSX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move PPSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a PPSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPSX file pages using Java example code">}}
