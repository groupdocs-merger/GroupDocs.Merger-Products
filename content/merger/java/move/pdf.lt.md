...
############################# Head ############################
head_title: "Perkelti PDF puslapius Java"
head_description: "Perkelkite puslapius PDF dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PDF puslapius Java"
description: "Perkelkite PDF puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PDF failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius PDF faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PDF failo puslapius naudojant Java pavyzdinį kodą">}}
