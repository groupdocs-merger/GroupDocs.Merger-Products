...
############################# Head ############################
head_title: "Pindahkan XLTX Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen XLTX di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLTX Halaman Di Java"
description: "Pindahkan Halaman XLTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan XLTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file XLTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan XLTX Halaman Online"
    content: |
       Pindahkan halaman file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/xltx).
