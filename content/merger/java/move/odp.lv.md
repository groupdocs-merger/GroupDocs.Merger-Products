...
############################# Head ############################
head_title: "Pārvietot ODP lapas programmā Java"
head_description: "Pārvietojiet lapas ODP dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot ODP lapas programmā Java"
description: "Pārvietojiet ODP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot ODP faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas ODP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot ODP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet ODP faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet ODP lapas tiešsaistē"
    content: |
       Pārvietojiet ODP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp).
