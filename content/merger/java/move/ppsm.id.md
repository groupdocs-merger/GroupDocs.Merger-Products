...
head_title: "Pindahkan, Atur Ulang & Susun Ulang Halaman PPSM di Java"
head_description: "Pengguna Java untuk memindahkan, mengatur ulang, dan menyusun ulang halaman dalam dokumen PPSM dengan membalik urutan halaman menggunakan API penggabungan dokumen."

title: "Pindahkan & Susun Ulang PPSM Halaman di Java"
description: "Pindahkan dan Atur ulang halaman dalam dokumen PPSM ke posisi apa pun menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Atur ulang PPSM File Pages di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk memindahkan dan mengatur ulang halaman dalam file PPSM dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```java
        // Pindahkan halaman file PPSM menggunakan GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan PPSM Halaman Dokumen Online"
    content: |
        Pindahkan halaman dalam file PPSM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/PPSM).
