...
############################# Head ############################
head_title: "Pārvietot XLTX lapas programmā Java"
head_description: "Pārvietojiet lapas XLTX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLTX lapas programmā Java"
description: "Pārvietojiet XLTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLTX lapas tiešsaistē"
    content: |
       Pārvietojiet XLTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
