...
############################# Head ############################
head_title: "Perkelti VSSX puslapius Java"
head_description: "Perkelkite puslapius VSSX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSSX puslapius Java"
description: "Perkelkite VSSX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSSX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VSSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VSSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VSSX puslapius į internetą"
    content: |
       Perkelkite VSSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) svetainėje.
