...
############################# Head ############################
head_title: "Perkelti XLTM puslapius Java"
head_description: "Perkelkite puslapius XLTM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLTM puslapius Java"
description: "Perkelkite XLTM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLTM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLTM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLTM puslapius į internetą"
    content: |
       Perkelkite XLTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) svetainėje.
