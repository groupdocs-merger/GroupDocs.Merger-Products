...
############################# Head ############################
head_title: "Verplaats MHT pagina's in Java"
head_description: "Verplaats pagina's binnen een MHT document in Java naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats MHT pagina's in Java"
description: "Verplaats MHT pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verplaats MHT bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een MHT bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHT bestandspagina's te verplaatsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verplaats MHT bestandspagina's met de GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live demo's - Verplaats MHT pagina's online"
    content: |
       Verplaats MHT bestandspagina's nu meteen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) te gaan.
