...
############################# Head ############################
head_title: "Flytta XLSB sidor i Java"
head_description: "Flytta sidor i ett XLSB-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLSB sidor i Java"
description: "Flytta XLSB sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta XLSB filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en XLSB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLSB filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta XLSB filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta XLSB sidor online"
    content: |
       Flytta XLSB filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb).
