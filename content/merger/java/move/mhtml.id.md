...
############################# Head ############################
head_title: "Pindahkan MHTML Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen MHTML di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan MHTML Halaman Di Java"
description: "Pindahkan Halaman MHTML dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan MHTML Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file MHTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file MHTML menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan MHTML Halaman Online"
    content: |
       Pindahkan halaman file MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/mhtml).
