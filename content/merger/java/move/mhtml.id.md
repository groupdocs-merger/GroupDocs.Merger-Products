...
############################# Head ############################
head_title: "Pindahkan halaman MHTML di Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk mengatur ulang halaman dalam dokumen MHTML tanpa kesulitan. Proses PDF, Word, Excel, PowerPoint, gambar, dan lainnya."

############################# Header ############################
title: "Pindahkan halaman dalam MHTML" 
description: "GroupDocs.Merger for Java memberdayakan aplikasi Java untuk mengatur ulang halaman dalam dokumen MHTML dengan lancar."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) memungkinkan Anda memindahkan halaman yang dipilih dalam dokumen MHTML. Tingkatkan aplikasi Java Anda dengan fitur pemrosesan dokumen yang canggih.
      
      1. Tentukan jalur file MHTML sumber.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pindahkan halaman ke akhir dokumen"
      content: |
        Pelajari cara memindahkan halaman tertentu ke akhir dokumen MHTML.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
