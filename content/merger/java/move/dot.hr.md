...
############################# Head ############################
head_title: "Premjesti DOT stranice u Java"
head_description: "Premjestite stranice unutar DOT dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOT stranice u Java"
description: "Premjesti DOT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOT stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOT stranice na mrežu"
    content: |
       Premjestite DOT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) web stranice.
