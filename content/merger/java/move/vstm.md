...
############################# Head ############################
head_title: "Move VSTM Pages in Java"
head_description: "Move pages within a VSTM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSTM Pages In Java"
description: "Move VSTM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSTM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSTM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSTM Pages Online"
    content: |
       Move VSTM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm) website.
