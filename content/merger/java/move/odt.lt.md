...
############################# Head ############################
head_title: "Perkelti ODT puslapius Java"
head_description: "Perkelkite puslapius ODT dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODT puslapius Java"
description: "Perkelkite ODT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODT failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius ODT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite ODT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite ODT puslapius į internetą"
    content: |
       Perkelkite ODT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) svetainėje.
