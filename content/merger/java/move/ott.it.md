...
############################# Head ############################
head_title: "Sposta OTT pagine in Java"
head_description: "Sposta le pagine all'interno di un documento OTT in Java in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta OTT pagine in Java"
description: "Sposta OTT pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Sposta OTT pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di spostare facilmente le pagine all'interno di un file OTT implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file OTT utilizzando il codice di esempio Java">}}

        ```java    
        // Sposta le pagine dei file OTT utilizzando l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Sposta OTT pagine online"
    content: |
       Sposta subito OTT pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
