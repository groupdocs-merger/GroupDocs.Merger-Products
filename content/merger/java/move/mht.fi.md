...
############################# Head ############################
head_title: "Siirrä MHT sivua Java"
head_description: "Siirrä MHT-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä MHT sivua Java"
description: "Siirrä MHT sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä MHT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja MHT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää MHT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä MHT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä MHT sivua verkkoon"
    content: |
       Siirrä MHT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) -sivustolla.
