...
############################# Head ############################
head_title: "Pindahkan VSTM Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen VSTM di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSTM Halaman Di Java"
description: "Pindahkan Halaman VSTM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan VSTM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file VSTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSTM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan VSTM Halaman Online"
    content: |
       Pindahkan halaman file VSTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/vstm).
