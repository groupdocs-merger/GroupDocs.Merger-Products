...
############################# Head ############################
head_title: "Verschiebe VISIO Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VISIO-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VISIO Seiten in Java"
description: "Verschieben Sie VISIO-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VISIO Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VISIO-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VISIO-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VISIO Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VISIO Seiten online"
    content: |
       Verschieben Sie jetzt VISIO Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/visio) besuchen.
