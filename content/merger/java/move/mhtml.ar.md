...
############################# Head ############################
head_title: "نقل صفحات MHTML في Java"
head_description: "انقل الصفحات داخل مستند MHTML في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات MHTML في Java"
description: "انقل صفحات MHTML ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل MHTML صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف MHTML من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف MHTML باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف MHTML باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات MHTML عبر الإنترنت"
    content: |
       انقل صفحات ملف MHTML الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
