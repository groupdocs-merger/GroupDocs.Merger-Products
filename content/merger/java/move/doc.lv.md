...
############################# Head ############################
head_title: "Pārvietot DOC lapas programmā Java"
head_description: "Pārvietojiet lapas DOC dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOC lapas programmā Java"
description: "Pārvietojiet DOC lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOC faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOC failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOC faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOC faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOC lapas tiešsaistē"
    content: |
       Pārvietojiet DOC faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc).
