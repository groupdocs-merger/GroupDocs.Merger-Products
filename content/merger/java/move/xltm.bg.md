...
############################# Head ############################
head_title: "Преместете XLTM страници в Java"
head_description: "Преместете страници в XLTM документ в Java на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете XLTM страници в Java"
description: "Преместете XLTM страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Преместете XLTM файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да преместват страници в рамките на файл XLTM чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате XLTM файлови страници с помощта на Java примерен код">}}
