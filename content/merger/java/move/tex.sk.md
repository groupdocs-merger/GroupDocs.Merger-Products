...
############################# Head ############################
head_title: "Presunúť TEX stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu TEX v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť TEX stránok do Java"
description: "Presuňte TEX stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť TEX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru TEX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru TEX pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru TEX pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte TEX stránok online"
    content: |
       Presuňte stránky súboru TEX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex).
