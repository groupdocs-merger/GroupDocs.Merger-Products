...
############################# Head ############################
head_title: "Perkelti XLSM puslapius Java"
head_description: "Perkelkite puslapius XLSM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSM puslapius Java"
description: "Perkelkite XLSM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLSM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLSM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLSM puslapius į internetą"
    content: |
       Perkelkite XLSM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) svetainėje.
