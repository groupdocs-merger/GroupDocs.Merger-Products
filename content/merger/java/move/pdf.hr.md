...
############################# Head ############################
head_title: "Premjesti PDF stranice u Java"
head_description: "Premjestite stranice unutar PDF dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti PDF stranice u Java"
description: "Premjesti PDF stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti PDF stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar PDF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti PDF stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti PDF stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti PDF stranice na mrežu"
    content: |
       Premjestite PDF stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) web stranice.
