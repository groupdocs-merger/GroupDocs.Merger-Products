...
############################# Head ############################
head_title: "MHT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir MHT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "MHT Sayfayı Java İçinde Taşı"
description: "MHT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "MHT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir MHT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak MHT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - MHT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) web sitesini ziyaret ederek MHT dosya sayfalarını hemen şimdi taşıyın.
