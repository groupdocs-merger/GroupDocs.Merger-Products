...
############################# Head ############################
head_title: "Skuif RTF bladsye in Java"
head_description: "Skuif bladsye binne 'n RTF dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif RTF bladsye in Java"
description: "Skuif RTF bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif RTF lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n RTF-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om RTF lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif RTF lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif RTF bladsye aanlyn"
    content: |
       Skuif RTF lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) webwerf te besoek.
