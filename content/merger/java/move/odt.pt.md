...
############################# Head ############################
head_title: "Mover ODT Páginas em Java"
head_description: "Mova as páginas em um documento ODT em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ODT Páginas em Java"
description: "Mova ODT Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ODT em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo ODT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ODT usando o código de exemplo Java">}}
