...
############################# Head ############################
head_title: "Mover páginas de MHTML em Java"
head_description: "Utilize GroupDocs.Merger for Java para reorganizar páginas em documentos MHTML de forma eficaz. Processar PDFs, Word, Excel, PowerPoint, imagens e muito mais."

############################# Header ############################
title: "Mover páginas em MHTML" 
description: "GroupDocs.Merger for Java permite que aplicativos Java reorganizem páginas em documentos MHTML de maneira integrada."
...
steps:
    enable: true
    title: "Como mover páginas de MHTML"
    content: |
      [GroupDocs.Merger](/merger/java/) permite que você mova páginas selecionadas em documentos MHTML. Aprimore seus aplicativos Java com recursos avançados de processamento de documentos.
      
      1. Especifique o caminho do arquivo MHTML de origem.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mover uma página para o final do documento"
      content: |
        Aprenda como mover uma página específica para o final de um documento MHTML.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
