...
############################# Head ############################
head_title: "Premjesti DOTX stranice u Java"
head_description: "Premjestite stranice unutar DOTX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOTX stranice u Java"
description: "Premjesti DOTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOTX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOTX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOTX stranice na mrežu"
    content: |
       Premjestite DOTX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) web stranice.
