...
############################# Head ############################
head_title: "Alihkan MHTML Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen MHTML dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan MHTML Halaman Dalam Java"
description: "Alihkan MHTML Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan MHTML Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail MHTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan MHTML halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan MHTML halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan MHTML Halaman Dalam Talian"
    content: |
       Alihkan MHTML halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
