...
############################# Head ############################
head_title: "Alihkan MHT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen MHT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan MHT Halaman Dalam Java"
description: "Alihkan MHT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan MHT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail MHT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan MHT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan MHT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan MHT Halaman Dalam Talian"
    content: |
       Alihkan MHT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
