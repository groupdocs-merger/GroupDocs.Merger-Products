...
############################# Head ############################
head_title: "Skuif XLSB bladsye in Java"
head_description: "Skuif bladsye binne 'n XLSB dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XLSB bladsye in Java"
description: "Skuif XLSB bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XLSB lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLSB-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSB lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XLSB lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XLSB bladsye aanlyn"
    content: |
       Skuif XLSB lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb) webwerf te besoek.
