...
############################# Head ############################
head_title: "Pārvietot VTX lapas programmā Java"
head_description: "Pārvietojiet lapas VTX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VTX lapas programmā Java"
description: "Pārvietojiet VTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VTX lapas tiešsaistē"
    content: |
       Pārvietojiet VTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx).
