...
############################# Head ############################
head_title: "Move ODP Pages in Java"
head_description: "Move pages within a ODP document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move ODP Pages In Java"
description: "Move ODP Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move ODP File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a ODP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODP file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move ODP Pages Online"
    content: |
       Move ODP file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) website.
