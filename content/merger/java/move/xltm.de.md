...
############################# Head ############################
head_title: "Verschiebe XLTM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLTM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLTM Seiten in Java"
description: "Verschieben Sie XLTM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLTM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLTM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLTM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLTM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLTM Seiten online"
    content: |
       Verschieben Sie jetzt XLTM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm) besuchen.
