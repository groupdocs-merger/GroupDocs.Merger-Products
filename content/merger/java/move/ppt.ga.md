...
############################# Head ############################
head_title: "Bog PPT Leathanaigh i Java"
head_description: "Bog leathanaigh laistigh de dhoiciméad PPT in Java go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog PPT Leathanaigh I Java"
description: "Bog PPT Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bog PPT Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a bhogadh laistigh de chomhad PPT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas PPT leathanaigh chomhaid a bhogadh ag úsáid cód sampla Java">}}

        ```java    
        // Bog leathanaigh comhad PPT ag baint úsáide as GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Taispeántais Bheo - Bog PPT Leathanaigh Ar Líne"
    content: |
       Bog PPT leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) láithreán gréasáin.
