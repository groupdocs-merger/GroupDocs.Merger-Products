...
############################# Head ############################
head_title: "Pārvietot PPSX lapas programmā Java"
head_description: "Pārvietojiet lapas PPSX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPSX lapas programmā Java"
description: "Pārvietojiet PPSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas PPSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet PPSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet PPSX lapas tiešsaistē"
    content: |
       Pārvietojiet PPSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx).
