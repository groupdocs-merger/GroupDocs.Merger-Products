...
############################# Head ############################
head_title: "Skuif VTX bladsye in Java"
head_description: "Skuif bladsye binne 'n VTX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VTX bladsye in Java"
description: "Skuif VTX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VTX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VTX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VTX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VTX bladsye aanlyn"
    content: |
       Skuif VTX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) webwerf te besoek.
