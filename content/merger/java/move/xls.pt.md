...
############################# Head ############################
head_title: "Mover XLS Páginas em Java"
head_description: "Mova as páginas em um documento XLS em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLS Páginas em Java"
description: "Mova XLS Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLS em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo XLS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLS usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo XLS usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover XLS páginas on-line"
    content: |
       Mova as páginas do arquivo XLS agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
