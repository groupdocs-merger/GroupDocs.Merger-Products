...
############################# Head ############################
head_title: "DOT oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy DOT dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOT oldal mozgatása a Java nyelven"
description: "Mozgasson át DOT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOT fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy DOT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet DOT fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOT oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) webhely meglátogatásával azonnal áthelyezhet DOT fájloldalt.
