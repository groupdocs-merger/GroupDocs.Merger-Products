...
############################# Head ############################
head_title: "Move VTX Pages in Java"
head_description: "Move pages within a VTX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VTX Pages In Java"
description: "Move VTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VTX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VTX Pages Online"
    content: |
       Move VTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) website.
