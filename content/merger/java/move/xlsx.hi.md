...
############################# Head ############################
head_title: "XLSX पेजों को Java में ले जाएं"
head_description: "दस्तावेज़ विलय API का उपयोग करके Java में XLSX दस्तावेज़ के पृष्ठों को किसी भी स्थिति में ले जाएं।"

############################# Header ############################
title: "XLSX पृष्ठों को Java में ले जाएं"
description: "{{उत्पादनाम}} कोड की कुछ पंक्तियों के साथ XLSX पृष्ठों को स्थानांतरित करें।"
...
steps:
    enable: true
    title_left: "XLSX फ़ाइल पृष्ठों को Java में ले जाएं"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) कुछ आसान चरणों को लागू करके Java डेवलपर्स के लिए एक XLSX फ़ाइल के भीतर पृष्ठों को स्थानांतरित करना आसान बनाता है। .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके XLSX फ़ाइल पृष्ठों को कैसे स्थानांतरित करें">}}

        ```java    
        // GroupDocs.Merger API का उपयोग करके XLSX फ़ाइल पृष्ठों को स्थानांतरित करें
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "लाइव डेमो - XLSX पेज ऑनलाइन ले जाएं"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) वेबसाइट पर जाकर XLSX फ़ाइल पेजों को अभी मूव करें।
