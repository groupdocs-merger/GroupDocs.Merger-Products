...
############################# Head ############################
head_title: "DOTX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir DOTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOTX Sayfayı Java İçinde Taşı"
description: "DOTX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOTX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir DOTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOTX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak DOTX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - DOTX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) web sitesini ziyaret ederek DOTX dosya sayfalarını hemen şimdi taşıyın.
