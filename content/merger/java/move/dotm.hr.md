...
############################# Head ############################
head_title: "Premjesti DOTM stranice u Java"
head_description: "Premjestite stranice unutar DOTM dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOTM stranice u Java"
description: "Premjesti DOTM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOTM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOTM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOTM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOTM stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOTM stranice na mrežu"
    content: |
       Premjestite DOTM stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) web stranice.
