...
############################# Head ############################
head_title: "Teisalda XLS lehte teenuses Java"
head_description: "Teisaldage dokumendi XLS lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLS lehte rakenduses Java"
description: "Teisaldage XLS lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLS faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLS lehte võrgus"
    content: |
       Teisaldage kohe XLS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
