...
head_description: "使用 GroupDocs.Merger for Java 轻松重新排列 VISIO 文档中的页面。处理 PDF、Word、Excel、PowerPoint、图像等文件。"

############################# Header ############################
title: "移动 VISIO 中的页面" 
description: "GroupDocs.Merger for Java 使 Java 应用能够无缝地重新排列 VISIO 文档中的页面。"
...
steps:
    ...
    title: "如何移动 VISIO 页面"
    content: |
      [GroupDocs.Merger](/merger/java/) 允许您在 VISIO 文档中移动选定页面。通过增强您的 Java 应用程序的高级文档处理功能，提升用户体验。
