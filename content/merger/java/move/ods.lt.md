...
############################# Head ############################
head_title: "Perkelti ODS puslapius Java"
head_description: "Perkelkite puslapius ODS dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODS puslapius Java"
description: "Perkelkite ODS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODS failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius ODS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite ODS failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite ODS puslapius į internetą"
    content: |
       Perkelkite ODS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) svetainėje.
