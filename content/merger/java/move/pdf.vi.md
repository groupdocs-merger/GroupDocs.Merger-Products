...
############################# Head ############################
head_title: "Di chuyển PDF Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu PDF trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển PDF Trang trong Java"
description: "Di chuyển các Trang PDF với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển PDF Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp PDF bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp PDF bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp PDF bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Di chuyển PDF Trang trực tuyến"
    content: |
       Di chuyển các trang tệp PDF ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) trang web.
