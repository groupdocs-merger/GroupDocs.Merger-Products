...
############################# Head ############################
head_title: "Alihkan VSTM Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSTM dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSTM Halaman Dalam Java"
description: "Alihkan VSTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSTM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSTM Halaman Dalam Talian"
    content: |
       Alihkan VSTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
