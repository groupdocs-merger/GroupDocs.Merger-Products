...
head_description: "Move pages within a HTML document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move HTML Pages In Java"
description: "Move HTML Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move HTML File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a HTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move HTML file pages using Java example code">}}
