...
############################# Head ############################
head_title: "Di chuyển DOC Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu DOC trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển DOC Trang trong Java"
description: "Di chuyển các Trang DOC với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển DOC Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp DOC bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp DOC bằng mã mẫu Java">}}
