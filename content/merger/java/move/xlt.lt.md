...
############################# Head ############################
head_title: "Perkelti XLT puslapius Java"
head_description: "Perkelkite puslapius XLT dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLT puslapius Java"
description: "Perkelkite XLT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLT failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLT puslapius į internetą"
    content: |
       Perkelkite XLT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) svetainėje.
