...
############################# Head ############################
head_title: "نقل صفحات ODT في Java"
head_description: "انقل الصفحات داخل مستند ODT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ODT في Java"
description: "انقل صفحات ODT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل ODT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف ODT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ODT باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف ODT باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات ODT عبر الإنترنت"
    content: |
       انقل صفحات ملف ODT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
