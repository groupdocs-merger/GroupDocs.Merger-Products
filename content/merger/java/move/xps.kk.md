...
############################# Head ############################
head_title: "XPS бетті Java ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы XPS құжатының беттерін Java ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "XPS бетті Java ішінде жылжыту"
description: "XPS беттерді Java кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "XPS файл бетін Java ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы XPS файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS файл беттерін Java мысал кодын пайдаланып жылжыту жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы XPS файл бетін жылжытыңыз
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - XPS беттерді желіге жылжытыңыз"
    content: |
       XPS файл бетін дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) веб-сайтына жылжытыңыз.
