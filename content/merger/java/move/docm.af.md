...
############################# Head ############################
head_title: "Skuif DOCM bladsye in Java"
head_description: "Skuif bladsye binne 'n DOCM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif DOCM bladsye in Java"
description: "Skuif DOCM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif DOCM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOCM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif DOCM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif DOCM bladsye aanlyn"
    content: |
       Skuif DOCM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) webwerf te besoek.
