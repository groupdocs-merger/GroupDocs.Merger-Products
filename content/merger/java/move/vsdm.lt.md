...
############################# Head ############################
head_title: "Perkelti VSDM puslapius Java"
head_description: "Perkelkite puslapius VSDM dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSDM puslapius Java"
description: "Perkelkite VSDM puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSDM failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius VSDM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSDM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite VSDM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite VSDM puslapius į internetą"
    content: |
       Perkelkite VSDM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm) svetainėje.
