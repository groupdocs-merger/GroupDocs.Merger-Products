...
############################# Head ############################
head_title: "PPT oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy PPT dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPT oldal mozgatása a Java nyelven"
description: "Mozgasson át PPT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPT fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy PPT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPT fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet PPT fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – PPT oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) webhely meglátogatásával azonnal áthelyezhet PPT fájloldalt.
