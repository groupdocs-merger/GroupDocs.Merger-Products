...
############################# Head ############################
head_title: "Flyt DOTM sider i Java"
head_description: "Flyt sider i et DOTM-dokument i Java til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOTM sider i Java"
description: "Flyt DOTM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flyt DOTM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flytte sider i en DOTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOTM filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Flyt DOTM filsider ved hjælp af GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemoer - Flyt DOTM sider online"
    content: |
       Flyt DOTM filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
