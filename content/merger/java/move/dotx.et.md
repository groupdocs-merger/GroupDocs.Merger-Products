...
############################# Head ############################
head_title: "Teisalda DOTX lehte teenuses Java"
head_description: "Teisaldage dokumendi DOTX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOTX lehte rakenduses Java"
description: "Teisaldage DOTX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage DOTX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage DOTX lehte võrgus"
    content: |
       Teisaldage kohe DOTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx).
