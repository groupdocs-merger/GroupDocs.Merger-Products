...
############################# Head ############################
head_title: "Преместете VSDX страници в Java"
head_description: "Преместете страници в VSDX документ в Java на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете VSDX страници в Java"
description: "Преместете VSDX страници с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Преместете VSDX файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да преместват страници в рамките на файл VSDX чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате VSDX файлови страници с помощта на Java примерен код">}}
