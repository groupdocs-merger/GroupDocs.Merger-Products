...
############################# Head ############################
head_title: "Skuif DOC bladsye in Java"
head_description: "Skuif bladsye binne 'n DOC dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif DOC bladsye in Java"
description: "Skuif DOC bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif DOC lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOC-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOC lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif DOC lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif DOC bladsye aanlyn"
    content: |
       Skuif DOC lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc) webwerf te besoek.
