...
############################# Head ############################
head_title: "Verschiebe MHT Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines MHT-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe MHT Seiten in Java"
description: "Verschieben Sie MHT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie MHT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer MHT-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie MHT-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie MHT Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie MHT Seiten online"
    content: |
       Verschieben Sie jetzt MHT Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht) besuchen.
