...
############################# Head ############################
head_title: "Déplacer des pages WORD dans Java"
head_description: "Utilisez GroupDocs.Merger for Java pour réorganiser les pages dans des documents WORD sans effort. Traitez des PDF, des documents Word, des feuilles Excel, des présentations PowerPoint, des images, et plus encore."

############################# Header ############################
title: "Déplacer des pages dans WORD" 
description: "GroupDocs.Merger for Java permet aux applications Java de réorganiser les pages dans des documents WORD de manière transparente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) vous permet de déplacer des pages sélectionnées dans des documents WORD. Améliorez vos applications Java avec des fonctionnalités avancées de traitement de documents.
      
      1. Spécifiez le chemin du fichier WORD source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Déplacer une page à la fin du document"
      content: |
        Découvrez comment déplacer une page spécifique à la fin d'un document WORD.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
