...
date: 2022-09-13T13:31:04
draft: false
otherformats: otp ott pdf pps ppsx ppt pptx rtf tex vdx vsdm vsdx vssm vssx vstm vstx

############################# Head ############################
head_title: "Move ODT Pages in Java"
head_description: "Move pages within a ODT document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move ODT Pages In Java"
description: "Move ODT Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move ODT File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a ODT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODT file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move ODT Pages Online"
    content: |
       Move ODT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) website.
