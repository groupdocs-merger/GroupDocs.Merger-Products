...
############################# Head ############################
head_title: "Pārvietot XLTM lapas programmā Java"
head_description: "Pārvietojiet lapas XLTM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLTM lapas programmā Java"
description: "Pārvietojiet XLTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLTM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLTM lapas tiešsaistē"
    content: |
       Pārvietojiet XLTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
