...
############################# Head ############################
head_title: "Переместить XLTX страницы на Java"
head_description: "Переместите страницы в документе XLTX на Java в любую позицию с помощью Merger API."

############################# Header ############################
title: "Переместить XLTX страницы на Java"
description: "Переместите XLTX страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Переместить страницы XLTX документов на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) позволяет разработчикам Java легко перемещать страницы в файле XLTX, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как переместить страницы XLTX документов, используя пример кода Java">}}

        ```java    
        // Переместите страницы XLTX документов с помощью GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Живые демонстрации – переместите XLTX страницы онлайн"
    content: |
       Переместите страницы XLTX документов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/splitter/move-pages/xltx).
