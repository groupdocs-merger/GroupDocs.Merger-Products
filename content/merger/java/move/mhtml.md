...
############################# Head ############################
head_title: "Move MHTML Pages in Java"
head_description: "Move pages within a MHTML document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move MHTML Pages In Java"
description: "Move MHTML Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move MHTML File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a MHTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move MHTML file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move MHTML Pages Online"
    content: |
       Move MHTML file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml) website.
