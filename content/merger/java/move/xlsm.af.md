...
############################# Head ############################
head_title: "Skuif XLSM bladsye in Java"
head_description: "Skuif bladsye binne 'n XLSM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XLSM bladsye in Java"
description: "Skuif XLSM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XLSM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLSM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XLSM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XLSM bladsye aanlyn"
    content: |
       Skuif XLSM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) webwerf te besoek.
