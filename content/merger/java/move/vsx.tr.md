...
############################# Head ############################
head_title: "VSX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSX Sayfayı Java İçinde Taşı"
description: "VSX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VSX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - VSX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) web sitesini ziyaret ederek VSX dosya sayfalarını hemen şimdi taşıyın.
