...
############################# Head ############################
head_title: "Alihkan VSSX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSSX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSSX Halaman Dalam Java"
description: "Alihkan VSSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSSX Halaman Dalam Talian"
    content: |
       Alihkan VSSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx).
