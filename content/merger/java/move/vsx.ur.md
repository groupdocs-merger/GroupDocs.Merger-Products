...
############################# Head ############################
head_title: "VSX صفحات کو Java میں منتقل کریں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے Java میں VSX دستاویز کے اندر صفحات کو کسی بھی پوزیشن پر منتقل کریں۔"

############################# Header ############################
title: "VSX صفحات کو Java میں منتقل کریں"
description: "Java کوڈ کی چند سطروں کے ساتھ VSX صفحات کو منتقل کریں۔"
...
steps:
    enable: true
    title_left: "VSX فائل صفحات کو Java میں منتقل کریں"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے VSX فائل کے صفحات کو کیسے منتقل کریں۔">}}
