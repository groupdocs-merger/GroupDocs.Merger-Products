...
############################# Head ############################
head_title: "Verschiebe PDF Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines PDF-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe PDF Seiten in Java"
description: "Verschieben Sie PDF-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie PDF Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer PDF-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie PDF-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie PDF Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie PDF Seiten online"
    content: |
       Verschieben Sie jetzt PDF Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf) besuchen.
