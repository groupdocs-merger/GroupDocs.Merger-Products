...
############################# Head ############################
head_title: "Flytta VDX sidor i Java"
head_description: "Flytta sidor i ett VDX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VDX sidor i Java"
description: "Flytta VDX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VDX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VDX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VDX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VDX sidor online"
    content: |
       Flytta VDX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx).
