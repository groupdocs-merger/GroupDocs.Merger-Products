...
############################# Head ############################
head_title: "Presunúť ODT stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu ODT v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť ODT stránok do Java"
description: "Presuňte ODT stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť ODT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru ODT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru ODT pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru ODT pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte ODT stránok online"
    content: |
       Presuňte stránky súboru ODT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
