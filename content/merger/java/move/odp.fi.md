...
############################# Head ############################
head_title: "Siirrä ODP sivua Java"
head_description: "Siirrä ODP-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODP sivua Java"
description: "Siirrä ODP sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODP tiedostosivua tuotteessa Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODP tiedostosivua käyttämällä Java esimerkkikoodia">}}
