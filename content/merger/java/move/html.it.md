...
############################# Head ############################
head_title: "Sposta HTML pagine in Java"
head_description: "Sposta le pagine all'interno di un documento HTML in Java in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta HTML pagine in Java"
description: "Sposta HTML pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Sposta HTML pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di spostare facilmente le pagine all'interno di un file HTML implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file HTML utilizzando il codice di esempio Java">}}

        ```java    
        // Sposta le pagine dei file HTML utilizzando l'API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Sposta HTML pagine online"
    content: |
       Sposta subito HTML pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
