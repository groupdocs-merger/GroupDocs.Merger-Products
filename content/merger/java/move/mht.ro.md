...
############################# Head ############################
head_title: "Mutați MHT pagini în Java"
head_description: "Mutați paginile dintr-un document MHT în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați MHT pagini în Java"
description: "Mutați MHT pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați MHT pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier MHT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere MHT utilizând codul exemplu Java">}}
