...
############################# Head ############################
head_title: "VSX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy VSX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSX oldal mozgatása a Java nyelven"
description: "Mozgasson át VSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy VSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet VSX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) webhely meglátogatásával azonnal áthelyezhet VSX fájloldalt.
