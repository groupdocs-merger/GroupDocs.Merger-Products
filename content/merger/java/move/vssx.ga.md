...
############################# Head ############################
head_title: "Bog VSSX Leathanaigh i Java"
head_description: "Bog leathanaigh laistigh de dhoiciméad VSSX in Java go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog VSSX Leathanaigh I Java"
description: "Bog VSSX Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bog VSSX Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a bhogadh laistigh de chomhad VSSX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSSX leathanaigh chomhaid a bhogadh ag úsáid cód sampla Java">}}

        ```java    
        // Bog leathanaigh comhad VSSX ag baint úsáide as GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Taispeántais Bheo - Bog VSSX Leathanaigh Ar Líne"
    content: |
       Bog VSSX leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) láithreán gréasáin.
