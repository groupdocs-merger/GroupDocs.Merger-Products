...
############################# Head ############################
head_title: "Siirrä EPUB sivua Java"
head_description: "Siirrä EPUB-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä EPUB sivua Java"
description: "Siirrä EPUB sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä EPUB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja EPUB-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää EPUB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä EPUB tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä EPUB sivua verkkoon"
    content: |
       Siirrä EPUB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) -sivustolla.
