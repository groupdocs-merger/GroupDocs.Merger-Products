...
############################# Head ############################
head_title: "Verschiebe ODP Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines ODP-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe ODP Seiten in Java"
description: "Verschieben Sie ODP-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie ODP Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer ODP-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie ODP-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie ODP Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie ODP Seiten online"
    content: |
       Verschieben Sie jetzt ODP Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) besuchen.
