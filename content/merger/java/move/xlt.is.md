...
############################# Head ############################
head_title: "Færa XLT síður í Java"
head_description: "Færðu síður innan XLT skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLT síður í Java"
description: "Færðu XLT síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa XLT skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í XLT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLT skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu XLT skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu XLT síður á netinu"
    content: |
       Færðu XLT skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) vefsíðu.
