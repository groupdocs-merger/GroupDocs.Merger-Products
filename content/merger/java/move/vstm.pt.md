...
############################# Head ############################
head_title: "Mover VSTM Páginas em Java"
head_description: "Mova as páginas em um documento VSTM em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSTM Páginas em Java"
description: "Mova VSTM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSTM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo VSTM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSTM usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo VSTM usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover VSTM páginas on-line"
    content: |
       Mova as páginas do arquivo VSTM agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstm).
