...
############################# Head ############################
head_title: "ONE Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir ONE belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ONE Sayfayı Java İçinde Taşı"
description: "ONE Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ONE Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir ONE dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ONE dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ONE dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - ONE Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) web sitesini ziyaret ederek ONE dosya sayfalarını hemen şimdi taşıyın.
