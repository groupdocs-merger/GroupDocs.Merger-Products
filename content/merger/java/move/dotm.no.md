...
############################# Head ############################
head_title: "Flytt DOTM sider i Java"
head_description: "Flytt sider i et DOTM-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOTM sider i Java"
description: "Flytt DOTM sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt DOTM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en DOTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOTM filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt DOTM filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt DOTM sider på nettet"
    content: |
       Flytt DOTM filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) nettstedet.
