...
############################# Head ############################
head_title: "DOTM oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy DOTM dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTM oldal mozgatása a Java nyelven"
description: "Mozgasson át DOTM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOTM fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy DOTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet DOTM fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOTM oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) webhely meglátogatásával azonnal áthelyezhet DOTM fájloldalt.
