...
############################# Head ############################
head_title: "Premakni XLTX strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLTX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLTX strani v Java"
description: "Premaknite strani XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLTX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke XLTX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite XLTX strani na splet"
    content: |
       Takoj premaknite strani datoteke XLTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
