...
############################# Head ############################
head_title: "Bog HTML Leathanaigh i Java"
head_description: "Bog leathanaigh laistigh de dhoiciméad HTML in Java go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog HTML Leathanaigh I Java"
description: "Bog HTML Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bog HTML Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a bhogadh laistigh de chomhad HTML trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas HTML leathanaigh chomhaid a bhogadh ag úsáid cód sampla Java">}}

        ```java    
        // Bog leathanaigh comhad HTML ag baint úsáide as GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Taispeántais Bheo - Bog HTML Leathanaigh Ar Líne"
    content: |
       Bog HTML leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) láithreán gréasáin.
