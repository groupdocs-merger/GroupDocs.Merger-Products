...
############################# Head ############################
head_title: "Teisalda RTF lehte teenuses Java"
head_description: "Teisaldage dokumendi RTF lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda RTF lehte rakenduses Java"
description: "Teisaldage RTF lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda RTF faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis RTF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada RTF faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage RTF faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage RTF lehte võrgus"
    content: |
       Teisaldage kohe RTF faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
