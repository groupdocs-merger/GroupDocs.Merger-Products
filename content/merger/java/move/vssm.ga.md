...
############################# Head ############################
head_title: "Bog VSSM Leathanaigh i Java"
head_description: "Bog leathanaigh laistigh de dhoiciméad VSSM in Java go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog VSSM Leathanaigh I Java"
description: "Bog VSSM Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bog VSSM Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a bhogadh laistigh de chomhad VSSM trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSSM leathanaigh chomhaid a bhogadh ag úsáid cód sampla Java">}}

        ```java    
        // Bog leathanaigh comhad VSSM ag baint úsáide as GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Taispeántais Bheo - Bog VSSM Leathanaigh Ar Líne"
    content: |
       Bog VSSM leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) láithreán gréasáin.
