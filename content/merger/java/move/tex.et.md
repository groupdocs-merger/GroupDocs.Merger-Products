...
############################# Head ############################
head_title: "Teisalda TEX lehte teenuses Java"
head_description: "Teisaldage dokumendi TEX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda TEX lehte rakenduses Java"
description: "Teisaldage TEX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda TEX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis TEX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada TEX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage TEX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage TEX lehte võrgus"
    content: |
       Teisaldage kohe TEX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex).
