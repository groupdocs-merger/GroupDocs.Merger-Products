...
############################# Head ############################
head_title: "PPSX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy PPSX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPSX oldal mozgatása a Java nyelven"
description: "Mozgasson át PPSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPSX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy PPSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet PPSX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – PPSX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) webhely meglátogatásával azonnal áthelyezhet PPSX fájloldalt.
