...
############################# Head ############################
head_title: "Move DOCM Pages in Java"
head_description: "Move pages within a DOCM document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move DOCM Pages In Java"
description: "Move DOCM Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move DOCM File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a DOCM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOCM file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move DOCM Pages Online"
    content: |
       Move DOCM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) website.
