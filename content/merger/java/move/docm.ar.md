...
############################# Head ############################
head_title: "نقل صفحات DOCM في Java"
head_description: "انقل الصفحات داخل مستند DOCM في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOCM في Java"
description: "انقل صفحات DOCM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOCM صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOCM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOCM باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOCM باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOCM عبر الإنترنت"
    content: |
       انقل صفحات ملف DOCM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
