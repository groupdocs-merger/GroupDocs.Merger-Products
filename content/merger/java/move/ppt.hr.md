...
############################# Head ############################
head_title: "Premjesti PPT stranice u Java"
head_description: "Premjestite stranice unutar PPT dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti PPT stranice u Java"
description: "Premjesti PPT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti PPT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar PPT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti PPT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti PPT stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti PPT stranice na mrežu"
    content: |
       Premjestite PPT stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt) web stranice.
