...
############################# Head ############################
head_title: "Siirrä DOCX sivua Java"
head_description: "Siirrä DOCX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOCX sivua Java"
description: "Siirrä DOCX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOCX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja DOCX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOCX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä DOCX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä DOCX sivua verkkoon"
    content: |
       Siirrä DOCX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) -sivustolla.
