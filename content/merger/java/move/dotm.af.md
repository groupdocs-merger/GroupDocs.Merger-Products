...
############################# Head ############################
head_title: "Skuif DOTM bladsye in Java"
head_description: "Skuif bladsye binne 'n DOTM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif DOTM bladsye in Java"
description: "Skuif DOTM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif DOTM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOTM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOTM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif DOTM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif DOTM bladsye aanlyn"
    content: |
       Skuif DOTM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) webwerf te besoek.
