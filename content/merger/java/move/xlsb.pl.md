...
############################# Head ############################
head_title: "Przenieś XLSB strony w Java"
head_description: "Przenieś strony w dokumencie XLSB w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLSB strony w Java"
description: "Przenieś strony XLSB za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLSB do Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLSB strony pliku za pomocą Java przykładowego kodu">}}
