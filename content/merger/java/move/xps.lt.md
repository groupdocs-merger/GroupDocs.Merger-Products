...
############################# Head ############################
head_title: "Perkelti XPS puslapius Java"
head_description: "Perkelkite puslapius XPS dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XPS puslapius Java"
description: "Perkelkite XPS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XPS failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XPS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XPS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XPS failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XPS puslapius į internetą"
    content: |
       Perkelkite XPS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) svetainėje.
