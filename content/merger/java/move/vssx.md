...
############################# Head ############################
head_title: "Move VSSX Pages in Java"
head_description: "Move pages within a VSSX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSSX Pages In Java"
description: "Move VSSX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSSX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSSX Pages Online"
    content: |
       Move VSSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) website.
