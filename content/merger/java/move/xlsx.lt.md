...
############################# Head ############################
head_title: "Perkelti XLSX puslapius Java"
head_description: "Perkelkite puslapius XLSX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSX puslapius Java"
description: "Perkelkite XLSX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius XLSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite XLSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite XLSX puslapius į internetą"
    content: |
       Perkelkite XLSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) svetainėje.
