...
############################# Head ############################
head_title: "نقل صفحات DOCX في Java"
head_description: "انقل الصفحات داخل مستند DOCX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOCX في Java"
description: "انقل صفحات DOCX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل DOCX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف DOCX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOCX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف DOCX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات DOCX عبر الإنترنت"
    content: |
       انقل صفحات ملف DOCX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx).
