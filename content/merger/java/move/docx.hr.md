...
############################# Head ############################
head_title: "Premjesti DOCX stranice u Java"
head_description: "Premjestite stranice unutar DOCX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOCX stranice u Java"
description: "Premjesti DOCX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti DOCX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar DOCX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOCX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti DOCX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti DOCX stranice na mrežu"
    content: |
       Premjestite DOCX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) web stranice.
