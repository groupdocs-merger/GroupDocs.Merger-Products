...
############################# Head ############################
head_title: "Premjesti XLSX stranice u Java"
head_description: "Premjestite stranice unutar XLSX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLSX stranice u Java"
description: "Premjesti XLSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti XLSX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar XLSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti XLSX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti XLSX stranice na mrežu"
    content: |
       Premjestite XLSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) web stranice.
