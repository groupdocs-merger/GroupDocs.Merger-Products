...
############################# Head ############################
head_title: "Μετακίνηση VSDM σελίδων σε Java"
head_description: "Μετακινήστε σελίδες σε ένα έγγραφο VSDM στο Java σε οποιαδήποτε θέση χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Μετακίνηση VSDM σελίδων σε Java"
description: "Μετακινήστε VSDM σελίδες με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Μετακίνηση VSDM σελίδων αρχείου στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να μετακινούν σελίδες μέσα σε ένα αρχείο VSDM εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να μετακινήσετε VSDM σελίδες αρχείου χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Μετακινήστε VSDM σελίδες αρχείου χρησιμοποιώντας το GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Μετακίνηση σελίδων VSDM στο Διαδίκτυο"
    content: |
       Μετακινήστε VSDM σελίδες αρχείων αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm).
