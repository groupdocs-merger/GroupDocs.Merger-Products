...
############################# Head ############################
head_title: "Skuif MHTML bladsye in Java"
head_description: "Skuif bladsye binne 'n MHTML dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif MHTML bladsye in Java"
description: "Skuif MHTML bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif MHTML lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n MHTML-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHTML lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}
