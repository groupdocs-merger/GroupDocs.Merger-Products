...
############################# Head ############################
head_title: "Alihkan XLSX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLSX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLSX Halaman Dalam Java"
description: "Alihkan XLSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XLSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XLSX Halaman Dalam Talian"
    content: |
       Alihkan XLSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx).
