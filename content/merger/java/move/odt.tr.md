...
############################# Head ############################
head_title: "ODT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir ODT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ODT Sayfayı Java İçinde Taşı"
description: "ODT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ODT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir ODT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ODT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - ODT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) web sitesini ziyaret ederek ODT dosya sayfalarını hemen şimdi taşıyın.
