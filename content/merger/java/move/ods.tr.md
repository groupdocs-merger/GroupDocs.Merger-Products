...
############################# Head ############################
head_title: "ODS Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir ODS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ODS Sayfayı Java İçinde Taşı"
description: "ODS Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ODS Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir ODS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODS dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ODS dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - ODS Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) web sitesini ziyaret ederek ODS dosya sayfalarını hemen şimdi taşıyın.
