...
############################# Head ############################
head_title: "Mover ODS Páginas em Java"
head_description: "Mova as páginas em um documento ODS em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ODS Páginas em Java"
description: "Mova ODS Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ODS em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo ODS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ODS usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo ODS usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover ODS páginas on-line"
    content: |
       Mova as páginas do arquivo ODS agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods).
