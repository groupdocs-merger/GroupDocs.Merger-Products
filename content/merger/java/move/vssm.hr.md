...
############################# Head ############################
head_title: "Premjesti VSSM stranice u Java"
head_description: "Premjestite stranice unutar VSSM dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSSM stranice u Java"
description: "Premjesti VSSM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VSSM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VSSM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSSM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VSSM stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VSSM stranice na mrežu"
    content: |
       Premjestite VSSM stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm) web stranice.
