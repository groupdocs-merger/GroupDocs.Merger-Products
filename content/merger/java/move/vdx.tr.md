...
############################# Head ############################
head_title: "VDX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VDX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VDX Sayfayı Java İçinde Taşı"
description: "VDX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VDX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VDX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VDX dosya sayfaları nasıl taşınır">}}
