...
############################# Head ############################
head_title: "Verschiebe PPTX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines PPTX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe PPTX Seiten in Java"
description: "Verschieben Sie PPTX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie PPTX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer PPTX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie PPTX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie PPTX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie PPTX Seiten online"
    content: |
       Verschieben Sie jetzt PPTX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) besuchen.
