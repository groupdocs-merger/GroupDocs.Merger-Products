...
############################# Head ############################
head_title: "Siirrä DOTM sivua Java"
head_description: "Siirrä DOTM-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOTM sivua Java"
description: "Siirrä DOTM sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja DOTM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä DOTM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä DOTM sivua verkkoon"
    content: |
       Siirrä DOTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) -sivustolla.
