...
############################# Head ############################
head_title: "ย้าย XLSX หน้าใน Java"
head_description: "ย้ายหน้าภายในเอกสาร XLSX ใน Java ไปยังตำแหน่งใดก็ได้โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "ย้าย XLSX หน้าใน Java"
description: "ย้าย XLSX หน้าด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "ย้ายหน้าไฟล์ XLSX ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ทำให้นักพัฒนา Java สามารถย้ายหน้าภายในไฟล์ XLSX ได้โดยง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน .
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีย้ายหน้าไฟล์ XLSX โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // ย้ายหน้าไฟล์ XLSX โดยใช้ GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "การสาธิตสด - ย้าย XLSX เพจออนไลน์"
    content: |
       ย้ายหน้าไฟล์ XLSX ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx)
