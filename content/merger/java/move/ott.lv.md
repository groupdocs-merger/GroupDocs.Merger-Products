...
############################# Head ############################
head_title: "Pārvietot OTT lapas programmā Java"
head_description: "Pārvietojiet lapas OTT dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot OTT lapas programmā Java"
description: "Pārvietojiet OTT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot OTT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas OTT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot OTT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet OTT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet OTT lapas tiešsaistē"
    content: |
       Pārvietojiet OTT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
