...
############################# Head ############################
head_title: "Perkelti HTML puslapius Java"
head_description: "Perkelkite puslapius HTML dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti HTML puslapius Java"
description: "Perkelkite HTML puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti HTML failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius HTML faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti HTML failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite HTML failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite HTML puslapius į internetą"
    content: |
       Perkelkite HTML failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) svetainėje.
