...
############################# Head ############################
head_title: "Pārvietot RTF lapas programmā Java"
head_description: "Pārvietojiet lapas RTF dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot RTF lapas programmā Java"
description: "Pārvietojiet RTF lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot RTF faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas RTF failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot RTF faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet RTF faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet RTF lapas tiešsaistē"
    content: |
       Pārvietojiet RTF faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf).
