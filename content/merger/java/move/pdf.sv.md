...
############################# Head ############################
head_title: "Flytta PDF sidor i Java"
head_description: "Flytta sidor i ett PDF-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PDF sidor i Java"
description: "Flytta PDF sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta PDF filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en PDF-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PDF filsidor med hjälp av Java exempelkod">}}
