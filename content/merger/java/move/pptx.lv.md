...
############################# Head ############################
head_title: "Pārvietot PPTX lapas programmā Java"
head_description: "Pārvietojiet lapas PPTX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPTX lapas programmā Java"
description: "Pārvietojiet PPTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas PPTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet PPTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet PPTX lapas tiešsaistē"
    content: |
       Pārvietojiet PPTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
