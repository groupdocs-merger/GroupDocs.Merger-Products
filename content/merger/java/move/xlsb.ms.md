...
############################# Head ############################
head_title: "Alihkan XLSB Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLSB dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLSB Halaman Dalam Java"
description: "Alihkan XLSB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLSB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLSB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLSB halaman fail menggunakan kod contoh Java.">}}
