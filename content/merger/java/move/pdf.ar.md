...
############################# Head ############################
head_title: "نقل صفحات PDF في Java"
head_description: "انقل الصفحات داخل مستند PDF في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PDF في Java"
description: "انقل صفحات PDF ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل PDF صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف PDF من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PDF باستخدام كود مثال Java">}}
