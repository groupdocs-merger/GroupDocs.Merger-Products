...
############################# Head ############################
head_title: "Pindahkan OTT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen OTT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan OTT Halaman Di Java"
description: "Pindahkan Halaman OTT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan OTT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file OTT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file OTT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan OTT Halaman Online"
    content: |
       Pindahkan halaman file OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/ott).
