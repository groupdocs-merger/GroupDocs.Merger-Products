...
############################# Head ############################
head_title: "Teisalda VSTX lehte teenuses Java"
head_description: "Teisaldage dokumendi VSTX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSTX lehte rakenduses Java"
description: "Teisaldage VSTX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VSTX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VSTX lehte võrgus"
    content: |
       Teisaldage kohe VSTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx).
