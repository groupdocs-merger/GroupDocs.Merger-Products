...
############################# Head ############################
head_title: "Alihkan XLT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLT Halaman Dalam Java"
description: "Alihkan XLT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XLT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XLT Halaman Dalam Talian"
    content: |
       Alihkan XLT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
