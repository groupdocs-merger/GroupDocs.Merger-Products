...
############################# Head ############################
head_title: "Premjesti VDX stranice u Java"
head_description: "Premjestite stranice unutar VDX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VDX stranice u Java"
description: "Premjesti VDX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VDX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VDX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VDX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VDX stranice na mrežu"
    content: |
       Premjestite VDX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vdx) web stranice.
