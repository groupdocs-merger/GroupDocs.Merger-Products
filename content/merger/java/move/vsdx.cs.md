...
############################# Head ############################
head_title: "Přesunout VSDX stránky v Java"
head_description: "Přesunout stránky v dokumentu VSDX v Java na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout VSDX stránky do Java"
description: "Přesuňte VSDX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Přesunout VSDX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java přesouvat stránky v souboru VSDX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru VSDX pomocí ukázkového kódu Java">}}

        ```java    
        // Přesunout stránky souboru VSDX pomocí GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živá ukázka – přesouvejte VSDX stránek online"
    content: |
       Přesuňte stránky souborů VSDX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx).
