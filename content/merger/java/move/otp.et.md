...
############################# Head ############################
head_title: "Teisalda OTP lehte teenuses Java"
head_description: "Teisaldage dokumendi OTP lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda OTP lehte rakenduses Java"
description: "Teisaldage OTP lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda OTP faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis OTP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada OTP faililehte, kasutades Java näitekoodi">}}
