...
############################# Head ############################
head_title: "Seiten in EPUB in Java verschieben"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um Seiten in EPUB-Dokumenten mühelos neu anzuordnen. Verarbeiten Sie PDF-, Word-, Excel-, PowerPoint-Dateien, Bilder und mehr."

############################# Header ############################
title: "Seiten in EPUB verschieben" 
description: "GroupDocs.Merger for Java ermöglicht Anwendungen in Java, Seiten in EPUB-Dokumenten nahtlos neu anzuordnen."
...
steps:
    enable: true
    title: "So verschieben Sie EPUB-Seiten"
    content: |
      [GroupDocs.Merger](/merger/java/) ermöglicht es Ihnen, ausgewählte Seiten in EPUB-Dokumenten zu verschieben. Erweitern Sie Ihre Java-Anwendungen um fortschrittliche Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Speicherort der EPUB-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eine Seite an das Ende des Dokuments verschieben"
      content: |
        Erfahren Sie, wie Sie eine bestimmte Seite an das Ende eines EPUB-Dokuments verschieben.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
