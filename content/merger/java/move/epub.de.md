...
############################# Head ############################
head_title: "Verschiebe EPUB Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines EPUB-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe EPUB Seiten in Java"
description: "Verschieben Sie EPUB-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie EPUB Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer EPUB-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie EPUB-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie EPUB Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie EPUB Seiten online"
    content: |
       Verschieben Sie jetzt EPUB Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) besuchen.
