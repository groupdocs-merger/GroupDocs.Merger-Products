...
############################# Head ############################
head_title: "Teisalda XLTM lehte teenuses Java"
head_description: "Teisaldage dokumendi XLTM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLTM lehte rakenduses Java"
description: "Teisaldage XLTM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLTM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLTM lehte võrgus"
    content: |
       Teisaldage kohe XLTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
