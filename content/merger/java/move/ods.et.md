...
############################# Head ############################
head_title: "Teisalda ODS lehte teenuses Java"
head_description: "Teisaldage dokumendi ODS lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ODS lehte rakenduses Java"
description: "Teisaldage ODS lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ODS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis ODS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ODS faililehte, kasutades Java näitekoodi">}}
