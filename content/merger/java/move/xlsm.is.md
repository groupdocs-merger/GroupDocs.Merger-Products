...
############################# Head ############################
head_title: "Færa XLSM síður í Java"
head_description: "Færðu síður innan XLSM skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLSM síður í Java"
description: "Færðu XLSM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa XLSM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í XLSM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLSM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu XLSM skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu XLSM síður á netinu"
    content: |
       Færðu XLSM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) vefsíðu.
