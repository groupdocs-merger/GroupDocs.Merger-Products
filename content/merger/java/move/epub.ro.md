...
############################# Head ############################
head_title: "Mutați EPUB pagini în Java"
head_description: "Mutați paginile dintr-un document EPUB în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați EPUB pagini în Java"
description: "Mutați EPUB pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați EPUB pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier EPUB prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere EPUB utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere EPUB utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​EPUB pagini online"
    content: |
       Mutați pagini de fișiere EPUB chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
