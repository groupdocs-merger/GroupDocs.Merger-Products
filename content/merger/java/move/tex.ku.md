...
############################# Head ############################
head_title: "Rûpelên TEX di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek TEX ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên TEX Di Java de biguhezînin"
description: "Rûpelên TEX bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê TEX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê TEX bar dike">}}

        ```java    
        // Rûpelên pelê yên TEX bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin TEX"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) niha rûpelên pelê yên TEX biguhezînin.
