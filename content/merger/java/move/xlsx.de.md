...
############################# Head ############################
head_title: "Verschiebe XLSX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLSX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLSX Seiten in Java"
description: "Verschieben Sie XLSX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLSX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLSX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLSX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLSX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLSX Seiten online"
    content: |
       Verschieben Sie jetzt XLSX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) besuchen.
