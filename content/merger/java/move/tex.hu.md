...
############################# Head ############################
head_title: "TEX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy TEX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "TEX oldal mozgatása a Java nyelven"
description: "Mozgasson át TEX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "TEX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy TEX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet TEX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – TEX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex) webhely meglátogatásával azonnal áthelyezhet TEX fájloldalt.
