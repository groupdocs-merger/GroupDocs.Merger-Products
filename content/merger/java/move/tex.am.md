...
############################# Head ############################
head_title: "TEX ገጾችን በJava ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በTEX ሰነድ ውስጥ በJava ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "TEX ገጾችን በJava ውስጥ አንቀሳቅስ"
description: "TEX ገጾችን ከጥቂት መስመሮች Java ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "TEX የፋይል ገጾችን በJava አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በTEX ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የTEX ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም TEX የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - TEX ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የTEX ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
