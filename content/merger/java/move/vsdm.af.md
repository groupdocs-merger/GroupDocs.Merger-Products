...
############################# Head ############################
head_title: "Skuif VSDM bladsye in Java"
head_description: "Skuif bladsye binne 'n VSDM dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VSDM bladsye in Java"
description: "Skuif VSDM bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VSDM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSDM-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VSDM lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VSDM bladsye aanlyn"
    content: |
       Skuif VSDM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdm) webwerf te besoek.
