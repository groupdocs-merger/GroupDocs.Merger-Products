...
############################# Head ############################
head_title: "Pindahkan PPS Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen PPS di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PPS Halaman Di Java"
description: "Pindahkan Halaman PPS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan PPS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file PPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PPS menggunakan kode contoh Java">}}
