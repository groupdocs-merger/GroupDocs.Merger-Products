...
############################# Head ############################
head_title: "Presunúť DOTM stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu DOTM v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOTM stránok do Java"
description: "Presuňte DOTM stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť DOTM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru DOTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOTM pomocou vzorového kódu Java">}}
