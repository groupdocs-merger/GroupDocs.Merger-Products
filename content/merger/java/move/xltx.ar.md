...
############################# Head ############################
head_title: "نقل صفحات XLTX في Java"
head_description: "انقل الصفحات داخل مستند XLTX في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLTX في Java"
description: "انقل صفحات XLTX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLTX صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLTX باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLTX باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLTX عبر الإنترنت"
    content: |
       انقل صفحات ملف XLTX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
