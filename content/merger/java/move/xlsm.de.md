...
############################# Head ############################
head_title: "Verschiebe XLSM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines XLSM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe XLSM Seiten in Java"
description: "Verschieben Sie XLSM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie XLSM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLSM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie XLSM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie XLSM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie XLSM Seiten online"
    content: |
       Verschieben Sie jetzt XLSM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm) besuchen.
