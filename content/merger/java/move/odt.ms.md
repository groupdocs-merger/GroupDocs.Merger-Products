...
############################# Head ############################
head_title: "Alihkan ODT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen ODT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODT Halaman Dalam Java"
description: "Alihkan ODT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan ODT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail ODT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan ODT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan ODT Halaman Dalam Talian"
    content: |
       Alihkan ODT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
