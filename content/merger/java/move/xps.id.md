...
############################# Head ############################
head_title: "Pindahkan halaman XPS di Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk mengatur ulang halaman dalam dokumen XPS tanpa kesulitan. Proses PDF, Word, Excel, PowerPoint, gambar, dan lainnya."

############################# Header ############################
title: "Pindahkan halaman dalam XPS" 
description: "GroupDocs.Merger for Java memberdayakan aplikasi Java untuk mengatur ulang halaman dalam dokumen XPS dengan lancar."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) memungkinkan Anda memindahkan halaman yang dipilih dalam dokumen XPS. Tingkatkan aplikasi Java Anda dengan fitur pemrosesan dokumen yang canggih.
      
      1. Tentukan jalur file XPS sumber.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pindahkan halaman ke akhir dokumen"
      content: |
        Pelajari cara memindahkan halaman tertentu ke akhir dokumen XPS.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
