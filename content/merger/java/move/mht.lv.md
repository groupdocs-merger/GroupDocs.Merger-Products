...
############################# Head ############################
head_title: "Pārvietot MHT lapas programmā Java"
head_description: "Pārvietojiet lapas MHT dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot MHT lapas programmā Java"
description: "Pārvietojiet MHT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot MHT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas MHT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot MHT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet MHT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet MHT lapas tiešsaistē"
    content: |
       Pārvietojiet MHT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
