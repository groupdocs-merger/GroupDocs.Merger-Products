...
############################# Head ############################
head_title: "Verschiebe ODS Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines ODS-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe ODS Seiten in Java"
description: "Verschieben Sie ODS-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie ODS Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer ODS-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie ODS-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie ODS Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie ODS Seiten online"
    content: |
       Verschieben Sie jetzt ODS Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) besuchen.
