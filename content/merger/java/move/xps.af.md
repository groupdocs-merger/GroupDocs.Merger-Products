...
############################# Head ############################
head_title: "Skuif XPS bladsye in Java"
head_description: "Skuif bladsye binne 'n XPS dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XPS bladsye in Java"
description: "Skuif XPS bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XPS lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XPS-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XPS lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XPS lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XPS bladsye aanlyn"
    content: |
       Skuif XPS lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) webwerf te besoek.
