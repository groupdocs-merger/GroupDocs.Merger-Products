...
############################# Head ############################
head_title: "Flytta EPUB sidor i Java"
head_description: "Flytta sidor i ett EPUB-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta EPUB sidor i Java"
description: "Flytta EPUB sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta EPUB filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en EPUB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar EPUB filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta EPUB filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta EPUB sidor online"
    content: |
       Flytta EPUB filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
