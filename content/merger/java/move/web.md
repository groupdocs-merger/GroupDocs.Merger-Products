...
############################# Head ############################
head_title: "Move WEB Pages in Java"
head_description: "Move pages within a WEB document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move WEB Pages In Java"
description: "Move WEB Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move WEB File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a WEB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WEB file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move WEB Pages Online"
    content: |
       Move WEB file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/web) website.
