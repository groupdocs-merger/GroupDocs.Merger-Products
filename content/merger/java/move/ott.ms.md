...
############################# Head ############################
head_title: "Alihkan OTT Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen OTT dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan OTT Halaman Dalam Java"
description: "Alihkan OTT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan OTT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail OTT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan OTT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan OTT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan OTT Halaman Dalam Talian"
    content: |
       Alihkan OTT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
