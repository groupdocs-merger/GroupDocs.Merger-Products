...
############################# Head ############################
head_title: "Skuif XLT bladsye in Java"
head_description: "Skuif bladsye binne 'n XLT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XLT bladsye in Java"
description: "Skuif XLT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XLT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XLT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XLT bladsye aanlyn"
    content: |
       Skuif XLT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt) webwerf te besoek.
