...
############################# Head ############################
head_title: "Teisalda PPT lehte teenuses Java"
head_description: "Teisaldage dokumendi PPT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPT lehte rakenduses Java"
description: "Teisaldage PPT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis PPT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPT faililehte, kasutades Java näitekoodi">}}
