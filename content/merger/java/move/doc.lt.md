...
############################# Head ############################
head_title: "Perkelti DOC puslapius Java"
head_description: "Perkelkite puslapius DOC dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOC puslapius Java"
description: "Perkelkite DOC puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOC failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOC faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOC failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOC failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOC puslapius į internetą"
    content: |
       Perkelkite DOC failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/doc) svetainėje.
