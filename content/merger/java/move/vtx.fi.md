...
############################# Head ############################
head_title: "Siirrä VTX sivua Java"
head_description: "Siirrä VTX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VTX sivua Java"
description: "Siirrä VTX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VTX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VTX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VTX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VTX sivua verkkoon"
    content: |
       Siirrä VTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx) -sivustolla.
