...
############################# Head ############################
head_title: "Færa DOCX síður í Java"
head_description: "Færðu síður innan DOCX skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOCX síður í Java"
description: "Færðu DOCX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa DOCX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í DOCX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOCX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu DOCX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu DOCX síður á netinu"
    content: |
       Færðu DOCX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) vefsíðu.
