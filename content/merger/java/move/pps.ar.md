...
############################# Head ############################
head_title: "نقل صفحات PPS في Java"
head_description: "انقل الصفحات داخل مستند PPS في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPS في Java"
description: "انقل صفحات PPS ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل PPS صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف PPS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPS باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف PPS باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات PPS عبر الإنترنت"
    content: |
       انقل صفحات ملف PPS الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
