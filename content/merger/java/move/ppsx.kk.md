...
############################# Head ############################
head_title: "PPSX бетті Java ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы PPSX құжатының беттерін Java ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "PPSX бетті Java ішінде жылжыту"
description: "PPSX беттерді Java кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "PPSX файл бетін Java ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы PPSX файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX файл беттерін Java мысал кодын пайдаланып жылжыту жолы">}}
