...
############################# Head ############################
head_title: "Alihkan ODS Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen ODS dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODS Halaman Dalam Java"
description: "Alihkan ODS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan ODS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail ODS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan ODS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan ODS Halaman Dalam Talian"
    content: |
       Alihkan ODS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods).
