...
############################# Head ############################
head_title: "Verplaats ODP pagina's in Java"
head_description: "Verplaats pagina's binnen een ODP document in Java naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats ODP pagina's in Java"
description: "Verplaats ODP pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verplaats ODP bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een ODP bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODP bestandspagina's te verplaatsen met behulp van Java voorbeeldcode">}}
