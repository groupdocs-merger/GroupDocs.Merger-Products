...
############################# Head ############################
head_title: "Flytt OTP sider i Java"
head_description: "Flytt sider i et OTP-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt OTP sider i Java"
description: "Flytt OTP sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt OTP filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en OTP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte OTP filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt OTP filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt OTP sider på nettet"
    content: |
       Flytt OTP filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp) nettstedet.
