...
############################# Head ############################
head_title: "Di chuyển XLSB Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu XLSB trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển XLSB Trang trong Java"
description: "Di chuyển các Trang XLSB với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển XLSB Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp XLSB bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp XLSB bằng mã mẫu Java">}}
