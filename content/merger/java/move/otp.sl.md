...
############################# Head ############################
head_title: "Premakni OTP strani v Java"
head_description: "Premaknite strani znotraj dokumenta OTP v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni OTP strani v Java"
description: "Premaknite strani OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke OTP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke OTP z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke OTP s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke OTP z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite OTP strani na splet"
    content: |
       Takoj premaknite strani datoteke OTP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
