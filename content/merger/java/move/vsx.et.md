...
############################# Head ############################
head_title: "Teisalda VSX lehte teenuses Java"
head_description: "Teisaldage dokumendi VSX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSX lehte rakenduses Java"
description: "Teisaldage VSX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VSX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VSX lehte võrgus"
    content: |
       Teisaldage kohe VSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx).
