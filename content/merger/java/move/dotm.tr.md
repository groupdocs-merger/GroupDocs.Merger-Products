...
############################# Head ############################
head_title: "DOTM Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir DOTM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOTM Sayfayı Java İçinde Taşı"
description: "DOTM Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOTM Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir DOTM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOTM dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak DOTM dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - DOTM Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) web sitesini ziyaret ederek DOTM dosya sayfalarını hemen şimdi taşıyın.
