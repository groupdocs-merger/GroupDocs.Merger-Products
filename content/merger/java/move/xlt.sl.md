...
############################# Head ############################
head_title: "Premakni XLT strani v Java"
head_description: "Premaknite strani znotraj dokumenta XLT v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLT strani v Java"
description: "Premaknite strani XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke XLT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLT s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke XLT z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite XLT strani na splet"
    content: |
       Takoj premaknite strani datoteke XLT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
