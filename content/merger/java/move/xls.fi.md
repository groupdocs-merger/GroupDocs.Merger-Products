...
############################# Head ############################
head_title: "Siirrä XLS sivua Java"
head_description: "Siirrä XLS-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLS sivua Java"
description: "Siirrä XLS sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja XLS-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä XLS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä XLS sivua verkkoon"
    content: |
       Siirrä XLS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls) -sivustolla.
