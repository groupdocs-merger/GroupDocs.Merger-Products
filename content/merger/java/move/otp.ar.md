...
############################# Head ############################
head_title: "نقل صفحات OTP في Java"
head_description: "انقل الصفحات داخل مستند OTP في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات OTP في Java"
description: "انقل صفحات OTP ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل OTP صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف OTP من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف OTP باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف OTP باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات OTP عبر الإنترنت"
    content: |
       انقل صفحات ملف OTP الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/otp).
