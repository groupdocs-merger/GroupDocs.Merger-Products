...
############################# Head ############################
head_title: "Alihkan XPS Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XPS dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XPS Halaman Dalam Java"
description: "Alihkan XPS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XPS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XPS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XPS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XPS Halaman Dalam Talian"
    content: |
       Alihkan XPS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps).
