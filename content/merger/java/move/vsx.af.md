...
############################# Head ############################
head_title: "Skuif VSX bladsye in Java"
head_description: "Skuif bladsye binne 'n VSX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VSX bladsye in Java"
description: "Skuif VSX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif VSX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif VSX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif VSX bladsye aanlyn"
    content: |
       Skuif VSX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) webwerf te besoek.
