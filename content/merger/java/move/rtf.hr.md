...
############################# Head ############################
head_title: "Premjesti RTF stranice u Java"
head_description: "Premjestite stranice unutar RTF dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti RTF stranice u Java"
description: "Premjesti RTF stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti RTF stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar RTF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti RTF stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti RTF stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti RTF stranice na mrežu"
    content: |
       Premjestite RTF stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) web stranice.
