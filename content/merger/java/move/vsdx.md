...
############################# Head ############################
head_title: "Move VSDX Pages in Java"
head_description: "Move pages within a VSDX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSDX Pages In Java"
description: "Move VSDX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSDX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSDX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move VSDX Pages Online"
    content: |
       Move VSDX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsdx) website.
