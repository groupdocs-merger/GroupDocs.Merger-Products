...
############################# Head ############################
head_title: "Move VSTX Pages in Java"
head_description: "Move pages within a VSTX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move VSTX Pages In Java"
description: "Move VSTX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move VSTX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a VSTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSTX file pages using Java example code">}}
