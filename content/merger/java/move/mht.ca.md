...
############################# Head ############################
head_title: "Mou MHT pàgines a Java"
head_description: "Mou les pàgines d'un document MHT a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou MHT pàgines a Java"
description: "Mou MHT pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou MHT pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer MHT implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers MHT utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou MHT pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou MHT pàgines en línia"
    content: |
       Mou les pàgines de fitxers MHT ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mht).
