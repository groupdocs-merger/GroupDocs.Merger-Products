...
############################# Head ############################
head_title: "Alihkan XLTX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLTX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLTX Halaman Dalam Java"
description: "Alihkan XLTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XLTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XLTX Halaman Dalam Talian"
    content: |
       Alihkan XLTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltx).
