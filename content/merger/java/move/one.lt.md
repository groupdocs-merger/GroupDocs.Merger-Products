...
############################# Head ############################
head_title: "Perkelti ONE puslapius Java"
head_description: "Perkelkite puslapius ONE dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ONE puslapius Java"
description: "Perkelkite ONE puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ONE failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius ONE faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ONE failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite ONE failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite ONE puslapius į internetą"
    content: |
       Perkelkite ONE failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) svetainėje.
