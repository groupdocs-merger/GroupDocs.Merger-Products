...
############################# Head ############################
head_title: "Perkelti DOT puslapius Java"
head_description: "Perkelkite puslapius DOT dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOT puslapius Java"
description: "Perkelkite DOT puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOT failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOT puslapius į internetą"
    content: |
       Perkelkite DOT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) svetainėje.
