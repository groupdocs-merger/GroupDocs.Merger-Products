...
############################# Head ############################
head_title: "Verschiebe VSTX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines VSTX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe VSTX Seiten in Java"
description: "Verschieben Sie VSTX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie VSTX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSTX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie VSTX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie VSTX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie VSTX Seiten online"
    content: |
       Verschieben Sie jetzt VSTX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx) besuchen.
