...
############################# Head ############################
head_title: "Premakni HTML strani v Java"
head_description: "Premaknite strani znotraj dokumenta HTML v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni HTML strani v Java"
description: "Premaknite strani HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke HTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke HTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke HTML s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke HTML z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite HTML strani na splet"
    content: |
       Takoj premaknite strani datoteke HTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
