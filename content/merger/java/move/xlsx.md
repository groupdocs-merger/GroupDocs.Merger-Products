...
############################# Head ############################
head_title: "Move XLSX Pages in Java"
head_description: "Move pages within a XLSX document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XLSX Pages In Java"
description: "Move XLSX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XLSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XLSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XLSX Pages Online"
    content: |
       Move XLSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) website.
