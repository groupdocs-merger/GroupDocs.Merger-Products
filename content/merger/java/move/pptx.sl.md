...
############################# Head ############################
head_title: "Premakni PPTX strani v Java"
head_description: "Premaknite strani znotraj dokumenta PPTX v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPTX strani v Java"
description: "Premaknite strani PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke PPTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPTX s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke PPTX z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite PPTX strani na splet"
    content: |
       Takoj premaknite strani datoteke PPTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
