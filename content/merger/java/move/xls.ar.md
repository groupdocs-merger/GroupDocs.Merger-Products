...
############################# Head ############################
head_title: "نقل صفحات XLS في Java"
head_description: "انقل الصفحات داخل مستند XLS في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLS في Java"
description: "انقل صفحات XLS ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLS صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLS باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLS باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLS عبر الإنترنت"
    content: |
       انقل صفحات ملف XLS الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
