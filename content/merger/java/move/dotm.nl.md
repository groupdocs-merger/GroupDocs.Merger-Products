...
############################# Head ############################
head_title: "Verplaats DOTM pagina's in Java"
head_description: "Verplaats pagina's binnen een DOTM document in Java naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats DOTM pagina's in Java"
description: "Verplaats DOTM pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verplaats DOTM bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een DOTM bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTM bestandspagina's te verplaatsen met behulp van Java voorbeeldcode">}}
