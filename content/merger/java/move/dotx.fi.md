...
############################# Head ############################
head_title: "Siirrä DOTX sivua Java"
head_description: "Siirrä DOTX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOTX sivua Java"
description: "Siirrä DOTX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja DOTX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOTX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä DOTX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä DOTX sivua verkkoon"
    content: |
       Siirrä DOTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) -sivustolla.
