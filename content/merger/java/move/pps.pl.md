...
############################# Head ############################
head_title: "Przenieś PPS strony w Java"
head_description: "Przenieś strony w dokumencie PPS w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś PPS strony w Java"
description: "Przenieś strony PPS za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików PPS do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku PPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść PPS strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików PPS za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś PPS strony online"
    content: |
       Przenieś strony plików PPS już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps).
