...
############################# Head ############################
head_title: "Perkelti DOTX puslapius Java"
head_description: "Perkelkite puslapius DOTX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOTX puslapius Java"
description: "Perkelkite DOTX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOTX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius DOTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite DOTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite DOTX puslapius į internetą"
    content: |
       Perkelkite DOTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) svetainėje.
