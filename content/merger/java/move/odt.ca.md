...
############################# Head ############################
head_title: "Mou ODT pàgines a Java"
head_description: "Mou les pàgines d'un document ODT a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou ODT pàgines a Java"
description: "Mou ODT pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou ODT pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer ODT implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers ODT utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou ODT pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou ODT pàgines en línia"
    content: |
       Mou les pàgines de fitxers ODT ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
