...
############################# Head ############################
head_title: "Flytta PPTX sidor i Java"
head_description: "Flytta sidor i ett PPTX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPTX sidor i Java"
description: "Flytta PPTX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta PPTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en PPTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta PPTX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta PPTX sidor online"
    content: |
       Flytta PPTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
