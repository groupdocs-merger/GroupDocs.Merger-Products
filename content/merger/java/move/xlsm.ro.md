...
############################# Head ############################
head_title: "Mutați XLSM pagini în Java"
head_description: "Mutați paginile dintr-un document XLSM în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLSM pagini în Java"
description: "Mutați XLSM pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați XLSM pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier XLSM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLSM utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere XLSM utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​XLSM pagini online"
    content: |
       Mutați pagini de fișiere XLSM chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsm).
