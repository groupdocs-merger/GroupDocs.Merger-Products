...
############################# Head ############################
head_title: "Teisalda ODT lehte teenuses Java"
head_description: "Teisaldage dokumendi ODT lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ODT lehte rakenduses Java"
description: "Teisaldage ODT lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ODT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis ODT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ODT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage ODT faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage ODT lehte võrgus"
    content: |
       Teisaldage kohe ODT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt).
