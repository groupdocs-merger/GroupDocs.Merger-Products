...
head_title: "Pindahkan, Atur Ulang & Susun Ulang Halaman PDF di Java"
head_description: "Pengguna Java untuk memindahkan, mengatur ulang, dan menyusun ulang halaman dalam dokumen PDF dengan membalik urutan halaman menggunakan API penggabungan dokumen."

title: "Pindahkan & Susun Ulang PDF Halaman di Java"
description: "Pindahkan dan Atur ulang halaman dalam dokumen PDF ke posisi apa pun menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Atur ulang PDF File Pages di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk memindahkan dan mengatur ulang halaman dalam file PDF dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```java
        // Pindahkan halaman file PDF menggunakan GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan PDF Halaman Dokumen Online"
    content: |
        Pindahkan halaman dalam file PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/PDF).
