...
############################# Head ############################
head_title: "Pindahkan PDF Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen PDF di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PDF Halaman Di Java"
description: "Pindahkan Halaman PDF dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan PDF Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file PDF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PDF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan PDF Halaman Online"
    content: |
       Pindahkan halaman file PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/pdf).
