...
############################# Head ############################
head_title: "Pārvietot PDF lapas programmā Java"
head_description: "Pārvietojiet lapas PDF dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PDF lapas programmā Java"
description: "Pārvietojiet PDF lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PDF faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas PDF failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PDF faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet PDF faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet PDF lapas tiešsaistē"
    content: |
       Pārvietojiet PDF faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
