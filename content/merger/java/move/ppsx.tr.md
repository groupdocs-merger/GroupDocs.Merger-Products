...
############################# Head ############################
head_title: "PPSX Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir PPSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPSX Sayfayı Java İçinde Taşı"
description: "PPSX Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPSX Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir PPSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPSX dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak PPSX dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - PPSX Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) web sitesini ziyaret ederek PPSX dosya sayfalarını hemen şimdi taşıyın.
