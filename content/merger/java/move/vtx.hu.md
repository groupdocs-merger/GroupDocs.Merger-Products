...
############################# Head ############################
head_title: "VTX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy VTX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VTX oldal mozgatása a Java nyelven"
description: "Mozgasson át VTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VTX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy VTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájloldalak mozgatása a Java példakóddal">}}
