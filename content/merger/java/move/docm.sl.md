...
############################# Head ############################
head_title: "Premakni DOCM strani v Java"
head_description: "Premaknite strani znotraj dokumenta DOCM v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOCM strani v Java"
description: "Premaknite strani DOCM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOCM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke DOCM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOCM s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke DOCM z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite DOCM strani na splet"
    content: |
       Takoj premaknite strani datoteke DOCM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
