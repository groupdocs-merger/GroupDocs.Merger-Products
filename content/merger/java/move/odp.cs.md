...
############################# Head ############################
head_title: "Přesunout ODP stránky v Java"
head_description: "Přesunout stránky v dokumentu ODP v Java na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout ODP stránky do Java"
description: "Přesuňte ODP stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Přesunout ODP stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java přesouvat stránky v souboru ODP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru ODP pomocí ukázkového kódu Java">}}

        ```java    
        // Přesunout stránky souboru ODP pomocí GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živá ukázka – přesouvejte ODP stránek online"
    content: |
       Přesuňte stránky souborů ODP hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp).
