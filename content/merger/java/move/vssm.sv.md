...
############################# Head ############################
head_title: "Flytta VSSM sidor i Java"
head_description: "Flytta sidor i ett VSSM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSSM sidor i Java"
description: "Flytta VSSM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta VSSM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en VSSM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSSM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta VSSM filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta VSSM sidor online"
    content: |
       Flytta VSSM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
