...
############################# Head ############################
head_title: "Mutați OTT pagini în Java"
head_description: "Mutați paginile dintr-un document OTT în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați OTT pagini în Java"
description: "Mutați OTT pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați OTT pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier OTT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere OTT utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere OTT utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​OTT pagini online"
    content: |
       Mutați pagini de fișiere OTT chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott).
