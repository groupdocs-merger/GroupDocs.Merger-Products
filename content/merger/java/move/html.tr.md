...
############################# Head ############################
head_title: "HTML Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir HTML belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "HTML Sayfayı Java İçinde Taşı"
description: "HTML Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "HTML Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir HTML dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak HTML dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak HTML dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - HTML Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) web sitesini ziyaret ederek HTML dosya sayfalarını hemen şimdi taşıyın.
