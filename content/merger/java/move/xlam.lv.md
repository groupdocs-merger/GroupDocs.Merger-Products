...
############################# Head ############################
head_title: "Pārvietot XLAM lapas programmā Java"
head_description: "Pārvietojiet lapas XLAM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLAM lapas programmā Java"
description: "Pārvietojiet XLAM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLAM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLAM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLAM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet XLAM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet XLAM lapas tiešsaistē"
    content: |
       Pārvietojiet XLAM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam).
