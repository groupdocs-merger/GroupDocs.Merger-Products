...
############################# Head ############################
head_title: "Presunúť HTML stránok v Java"
head_description: "Presuňte stránky v rámci dokumentu HTML v Java na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť HTML stránok do Java"
description: "Presuňte HTML stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Presunúť HTML strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java presúvať stránky v rámci súboru HTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru HTML pomocou vzorového kódu Java">}}

        ```java    
        // Presuňte stránky súboru HTML pomocou rozhrania GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Presuňte HTML stránok online"
    content: |
       Presuňte stránky súboru HTML hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html).
