...
############################# Head ############################
head_title: "Mou PPTX pàgines a Java"
head_description: "Mou les pàgines d'un document PPTX a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou PPTX pàgines a Java"
description: "Mou PPTX pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou PPTX pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer PPTX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers PPTX utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou PPTX pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou PPTX pàgines en línia"
    content: |
       Mou les pàgines de fitxers PPTX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
