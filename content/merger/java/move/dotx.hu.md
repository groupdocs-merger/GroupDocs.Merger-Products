...
############################# Head ############################
head_title: "DOTX oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy DOTX dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTX oldal mozgatása a Java nyelven"
description: "Mozgasson át DOTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOTX fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy DOTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet DOTX fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOTX oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) webhely meglátogatásával azonnal áthelyezhet DOTX fájloldalt.
