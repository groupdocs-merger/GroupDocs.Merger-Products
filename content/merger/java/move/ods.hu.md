...
############################# Head ############################
head_title: "ODS oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy ODS dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODS oldal mozgatása a Java nyelven"
description: "Mozgasson át ODS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODS fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy ODS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODS fájloldalak mozgatása a Java példakóddal">}}
