...
############################# Head ############################
head_title: "نقل صفحات EPUB في Java"
head_description: "انقل الصفحات داخل مستند EPUB في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات EPUB في Java"
description: "انقل صفحات EPUB ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل EPUB صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف EPUB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف EPUB باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف EPUB باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات EPUB عبر الإنترنت"
    content: |
       انقل صفحات ملف EPUB الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
