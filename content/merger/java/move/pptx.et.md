...
############################# Head ############################
head_title: "Teisalda PPTX lehte teenuses Java"
head_description: "Teisaldage dokumendi PPTX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPTX lehte rakenduses Java"
description: "Teisaldage PPTX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis PPTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage PPTX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage PPTX lehte võrgus"
    content: |
       Teisaldage kohe PPTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx).
