...
############################# Head ############################
head_title: "Flytta DOTM sidor i Java"
head_description: "Flytta sidor i ett DOTM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOTM sidor i Java"
description: "Flytta DOTM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta DOTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en DOTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOTM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta DOTM filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta DOTM sidor online"
    content: |
       Flytta DOTM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
