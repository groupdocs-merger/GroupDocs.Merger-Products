...
############################# Head ############################
head_title: "نقل صفحات PPT في Java"
head_description: "انقل الصفحات داخل مستند PPT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPT في Java"
description: "انقل صفحات PPT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل PPT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف PPT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPT باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف PPT باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات PPT عبر الإنترنت"
    content: |
       انقل صفحات ملف PPT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppt).
