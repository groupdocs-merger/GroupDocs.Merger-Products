...
############################# Head ############################
head_title: "Rûpelên XPS di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek XPS ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XPS Di Java de biguhezînin"
description: "Rûpelên XPS bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê XPS biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê XPS bar dike">}}

        ```java    
        // Rûpelên pelê yên XPS bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin XPS"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) niha rûpelên pelê yên XPS biguhezînin.
