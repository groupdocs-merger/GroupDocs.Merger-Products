...
############################# Head ############################
head_title: "Teisalda DOTM lehte teenuses Java"
head_description: "Teisaldage dokumendi DOTM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOTM lehte rakenduses Java"
description: "Teisaldage DOTM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis DOTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage DOTM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage DOTM lehte võrgus"
    content: |
       Teisaldage kohe DOTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm).
