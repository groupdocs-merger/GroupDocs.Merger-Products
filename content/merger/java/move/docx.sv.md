...
############################# Head ############################
head_title: "Flytta DOCX sidor i Java"
head_description: "Flytta sidor i ett DOCX-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOCX sidor i Java"
description: "Flytta DOCX sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta DOCX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en DOCX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOCX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta DOCX filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta DOCX sidor online"
    content: |
       Flytta DOCX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx).
