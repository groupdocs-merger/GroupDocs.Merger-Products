...
############################# Head ############################
head_title: "Pindahkan WORD Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen WORD di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WORD Halaman Di Java"
description: "Pindahkan Halaman WORD dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan WORD Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file WORD dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WORD menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan WORD Halaman Online"
    content: |
       Pindahkan halaman file WORD sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/word).
