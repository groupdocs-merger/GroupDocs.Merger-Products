...
############################# Head ############################
head_title: "Færa PPS síður í Java"
head_description: "Færðu síður innan PPS skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPS síður í Java"
description: "Færðu PPS síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa PPS skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í PPS skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPS skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu PPS skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu PPS síður á netinu"
    content: |
       Færðu PPS skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pps) vefsíðu.
