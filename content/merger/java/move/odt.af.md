...
############################# Head ############################
head_title: "Skuif ODT bladsye in Java"
head_description: "Skuif bladsye binne 'n ODT dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif ODT bladsye in Java"
description: "Skuif ODT bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif ODT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n ODT-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODT lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif ODT lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif ODT bladsye aanlyn"
    content: |
       Skuif ODT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odt) webwerf te besoek.
