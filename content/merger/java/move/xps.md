...
head_description: "Move pages within a XPS document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move XPS Pages In Java"
description: "Move XPS Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move XPS File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a XPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XPS file pages using Java example code">}}
