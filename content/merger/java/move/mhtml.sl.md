...
############################# Head ############################
head_title: "Premakni MHTML strani v Java"
head_description: "Premaknite strani znotraj dokumenta MHTML v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni MHTML strani v Java"
description: "Premaknite strani MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke MHTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke MHTML s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke MHTML z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite MHTML strani na splet"
    content: |
       Takoj premaknite strani datoteke MHTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
