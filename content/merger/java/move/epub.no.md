...
############################# Head ############################
head_title: "Flytt EPUB sider i Java"
head_description: "Flytt sider i et EPUB-dokument i Java til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt EPUB sider i Java"
description: "Flytt EPUB sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flytt EPUB filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å flytte sider i en EPUB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte EPUB filsider ved hjelp av Java eksempelkode">}}

        ```java    
        // Flytt EPUB filsider ved hjelp av GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-demoer – Flytt EPUB sider på nettet"
    content: |
       Flytt EPUB filsider akkurat nå ved å gå til [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) nettstedet.
