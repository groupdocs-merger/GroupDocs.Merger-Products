...
############################# Head ############################
head_title: "Pindahkan XLT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen XLT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLT Halaman Di Java"
description: "Pindahkan Halaman XLT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan XLT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file XLT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan XLT Halaman Online"
    content: |
       Pindahkan halaman file XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/xlt).
