...
############################# Head ############################
head_title: "Seiten in MHTML in Java verschieben"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um Seiten in MHTML-Dokumenten mühelos neu anzuordnen. Verarbeiten Sie PDF-, Word-, Excel-, PowerPoint-Dateien, Bilder und mehr."

############################# Header ############################
title: "Seiten in MHTML verschieben" 
description: "GroupDocs.Merger for Java ermöglicht Anwendungen in Java, Seiten in MHTML-Dokumenten nahtlos neu anzuordnen."
...
steps:
    enable: true
    title: "So verschieben Sie MHTML-Seiten"
    content: |
      [GroupDocs.Merger](/merger/java/) ermöglicht es Ihnen, ausgewählte Seiten in MHTML-Dokumenten zu verschieben. Erweitern Sie Ihre Java-Anwendungen um fortschrittliche Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Speicherort der MHTML-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eine Seite an das Ende des Dokuments verschieben"
      content: |
        Erfahren Sie, wie Sie eine bestimmte Seite an das Ende eines MHTML-Dokuments verschieben.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
