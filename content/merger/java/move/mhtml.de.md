...
############################# Head ############################
head_title: "Verschiebe MHTML Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines MHTML-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe MHTML Seiten in Java"
description: "Verschieben Sie MHTML-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie MHTML Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer MHTML-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie MHTML-Dateiseiten mit Java-Beispielcode">}}
