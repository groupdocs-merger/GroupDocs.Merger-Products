...
############################# Head ############################
head_title: "Mover EPUB Páginas em Java"
head_description: "Mova as páginas em um documento EPUB em Java para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover EPUB Páginas em Java"
description: "Mova EPUB Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo EPUB em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java mover páginas em um arquivo EPUB implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo EPUB usando o código de exemplo Java">}}

        ```java    
        // Mova as páginas do arquivo EPUB usando a API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Mover EPUB páginas on-line"
    content: |
       Mova as páginas do arquivo EPUB agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub).
