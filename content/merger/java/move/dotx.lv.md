...
############################# Head ############################
head_title: "Pārvietot DOTX lapas programmā Java"
head_description: "Pārvietojiet lapas DOTX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOTX lapas programmā Java"
description: "Pārvietojiet DOTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOTX lapas tiešsaistē"
    content: |
       Pārvietojiet DOTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx).
