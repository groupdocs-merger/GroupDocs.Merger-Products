...
############################# Head ############################
head_title: "Rûpelên ONE di Java de biguhezînin"
head_description: "Rûpelên di nav belgeyek ONE ya di Java de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên ONE Di Java de biguhezînin"
description: "Rûpelên ONE bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê ONE biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java rûpelên pelê ONE bar dike">}}

        ```java    
        // Rûpelên pelê yên ONE bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin ONE"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) niha rûpelên pelê yên ONE biguhezînin.
