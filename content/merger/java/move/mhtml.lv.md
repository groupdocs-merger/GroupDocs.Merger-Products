...
############################# Head ############################
head_title: "Pārvietot MHTML lapas programmā Java"
head_description: "Pārvietojiet lapas MHTML dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot MHTML lapas programmā Java"
description: "Pārvietojiet MHTML lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot MHTML faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas MHTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot MHTML faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet MHTML faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet MHTML lapas tiešsaistē"
    content: |
       Pārvietojiet MHTML faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/mhtml).
