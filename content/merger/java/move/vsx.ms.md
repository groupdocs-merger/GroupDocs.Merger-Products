...
############################# Head ############################
head_title: "Alihkan VSX Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen VSX dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSX Halaman Dalam Java"
description: "Alihkan VSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan VSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail VSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan VSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan VSX Halaman Dalam Talian"
    content: |
       Alihkan VSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx).
