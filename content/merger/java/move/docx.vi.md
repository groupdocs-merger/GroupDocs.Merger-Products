...
############################# Head ############################
head_title: "Di chuyển DOCX Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu DOCX trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển DOCX Trang trong Java"
description: "Di chuyển các Trang DOCX với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển DOCX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp DOCX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp DOCX bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp DOCX bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Di chuyển DOCX Trang trực tuyến"
    content: |
       Di chuyển các trang tệp DOCX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx) trang web.
