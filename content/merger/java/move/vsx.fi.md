...
############################# Head ############################
head_title: "Siirrä VSX sivua Java"
head_description: "Siirrä VSX-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSX sivua Java"
description: "Siirrä VSX sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja VSX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä VSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä VSX sivua verkkoon"
    content: |
       Siirrä VSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vsx) -sivustolla.
