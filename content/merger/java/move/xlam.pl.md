...
############################# Head ############################
head_title: "Przenieś XLAM strony w Java"
head_description: "Przenieś strony w dokumencie XLAM w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLAM strony w Java"
description: "Przenieś strony XLAM za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLAM do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku XLAM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLAM strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików XLAM za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś XLAM strony online"
    content: |
       Przenieś strony plików XLAM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam).
