...
############################# Head ############################
head_title: "Pārvietot XLSB lapas programmā Java"
head_description: "Pārvietojiet lapas XLSB dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLSB lapas programmā Java"
description: "Pārvietojiet XLSB lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLSB faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas XLSB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLSB faila lapas, izmantojot Java piemēra kodu">}}
