...
############################# Head ############################
head_title: "Teisalda XLAM lehte teenuses Java"
head_description: "Teisaldage dokumendi XLAM lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLAM lehte rakenduses Java"
description: "Teisaldage XLAM lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLAM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis XLAM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLAM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage XLAM faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage XLAM lehte võrgus"
    content: |
       Teisaldage kohe XLAM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlam).
