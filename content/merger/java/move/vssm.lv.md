...
############################# Head ############################
head_title: "Pārvietot VSSM lapas programmā Java"
head_description: "Pārvietojiet lapas VSSM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSSM lapas programmā Java"
description: "Pārvietojiet VSSM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSSM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSSM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSSM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSSM lapas tiešsaistē"
    content: |
       Pārvietojiet VSSM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssm).
