...
############################# Head ############################
head_title: "Perkelti EPUB puslapius Java"
head_description: "Perkelkite puslapius EPUB dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti EPUB puslapius Java"
description: "Perkelkite EPUB puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti EPUB failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius EPUB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti EPUB failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite EPUB failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite EPUB puslapius į internetą"
    content: |
       Perkelkite EPUB failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) svetainėje.
