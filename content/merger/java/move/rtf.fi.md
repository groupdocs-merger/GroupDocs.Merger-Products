...
############################# Head ############################
head_title: "Siirrä RTF sivua Java"
head_description: "Siirrä RTF-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä RTF sivua Java"
description: "Siirrä RTF sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä RTF tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja RTF-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää RTF tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä RTF tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä RTF sivua verkkoon"
    content: |
       Siirrä RTF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/rtf) -sivustolla.
