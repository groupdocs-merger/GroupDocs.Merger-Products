...
############################# Head ############################
head_title: "Flytta XLTM sidor i Java"
head_description: "Flytta sidor i ett XLTM-dokument i Java till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLTM sidor i Java"
description: "Flytta XLTM sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Flytta XLTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att flytta sidor i en XLTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLTM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Flytta XLTM filsidor med GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Livedemos - Flytta XLTM sidor online"
    content: |
       Flytta XLTM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xltm).
