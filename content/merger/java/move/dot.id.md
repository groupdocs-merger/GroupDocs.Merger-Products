...
############################# Head ############################
head_title: "Pindahkan DOT Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen DOT di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOT Halaman Di Java"
description: "Pindahkan Halaman DOT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan DOT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file DOT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan DOT Halaman Online"
    content: |
       Pindahkan halaman file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/dot).
