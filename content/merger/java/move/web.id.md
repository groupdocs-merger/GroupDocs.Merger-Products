...
############################# Head ############################
head_title: "Pindahkan WEB Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen WEB di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WEB Halaman Di Java"
description: "Pindahkan Halaman WEB dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan WEB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file WEB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WEB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan WEB Halaman Online"
    content: |
       Pindahkan halaman file WEB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/web).
