...
############################# Head ############################
head_title: "Alihkan PPS Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen PPS dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPS Halaman Dalam Java"
description: "Alihkan PPS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan PPS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail PPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPS halaman fail menggunakan kod contoh Java.">}}
