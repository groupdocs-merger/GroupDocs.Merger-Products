...
############################# Head ############################
head_title: "Verschiebe OTT Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines OTT-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe OTT Seiten in Java"
description: "Verschieben Sie OTT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie OTT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer OTT-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie OTT-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie OTT Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie OTT Seiten online"
    content: |
       Verschieben Sie jetzt OTT Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) besuchen.
