...
############################# Head ############################
head_title: "Perkelti PPSX puslapius Java"
head_description: "Perkelkite puslapius PPSX dokumente Java į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPSX puslapius Java"
description: "Perkelkite PPSX puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPSX failo puslapius į Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai perkelti puslapius PPSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Perkelkite PPSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – perkelkite PPSX puslapius į internetą"
    content: |
       Perkelkite PPSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) svetainėje.
