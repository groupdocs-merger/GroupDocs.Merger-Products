...
############################# Head ############################
head_title: "DOT Sayfayı Java İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir DOT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOT Sayfayı Java İçinde Taşı"
description: "DOT Sayfasını birkaç satır Java koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOT Dosya Sayfalarını Java içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir DOT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOT dosya sayfaları nasıl taşınır">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak DOT dosya sayfalarını taşıyın
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - DOT Sayfayı Çevrimiçi Taşıyın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot) web sitesini ziyaret ederek DOT dosya sayfalarını hemen şimdi taşıyın.
