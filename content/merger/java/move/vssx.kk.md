...
############################# Head ############################
head_title: "VSSX бетті Java ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы VSSX құжатының беттерін Java ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "VSSX бетті Java ішінде жылжыту"
description: "VSSX беттерді Java кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "VSSX файл бетін Java ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы VSSX файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX файл беттерін Java мысал кодын пайдаланып жылжыту жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VSSX файл бетін жылжытыңыз
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VSSX беттерді желіге жылжытыңыз"
    content: |
       VSSX файл бетін дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) веб-сайтына жылжытыңыз.
