...
############################# Head ############################
head_title: "EPUB oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy EPUB dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "EPUB oldal mozgatása a Java nyelven"
description: "Mozgasson át EPUB oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "EPUB fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy EPUB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet EPUB fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – EPUB oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/epub) webhely meglátogatásával azonnal áthelyezhet EPUB fájloldalt.
