...
############################# Head ############################
head_title: "Sposta le pagine di VISIO in Java"
head_description: "Utilizza GroupDocs.Merger for Java per riordinare le pagine nei documenti VISIO senza sforzo. Elabora PDF, Word, Excel, PowerPoint, immagini e altro ancora."

############################# Header ############################
title: "Sposta pagine in VISIO" 
description: "GroupDocs.Merger for Java consente alle applicazioni Java di riordinare le pagine nei documenti VISIO in modo fluido."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) ti permette di spostare pagine selezionate nei documenti VISIO. Migliora le tue applicazioni Java con funzionalità avanzate di elaborazione documentale.
      
      1. Specifica il percorso del file VISIO sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta una pagina alla fine del documento"
      content: |
        Scopri come spostare una pagina specifica alla fine di un documento VISIO.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
