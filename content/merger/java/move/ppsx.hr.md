...
############################# Head ############################
head_title: "Premjesti PPSX stranice u Java"
head_description: "Premjestite stranice unutar PPSX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti PPSX stranice u Java"
description: "Premjesti PPSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti PPSX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar PPSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti PPSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti PPSX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti PPSX stranice na mrežu"
    content: |
       Premjestite PPSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ppsx) web stranice.
