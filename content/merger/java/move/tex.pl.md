...
############################# Head ############################
head_title: "Przenieś TEX strony w Java"
head_description: "Przenieś strony w dokumencie TEX w Java w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś TEX strony w Java"
description: "Przenieś strony TEX za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Przenieś strony plików TEX do Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java przenoszenie stron w pliku TEX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść TEX strony pliku za pomocą Java przykładowego kodu">}}

        ```java    
        // Przenieś strony plików TEX za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś TEX strony online"
    content: |
       Przenieś strony plików TEX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/tex).
