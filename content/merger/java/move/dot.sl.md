...
############################# Head ############################
head_title: "Premakni DOT strani v Java"
head_description: "Premaknite strani znotraj dokumenta DOT v Java na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOT strani v Java"
description: "Premaknite strani DOT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša premikanje strani znotraj datoteke DOT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOT s primerom kode Java">}}

        ```java    
        // Premaknite strani datoteke DOT z API-jem GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - premaknite DOT strani na splet"
    content: |
       Takoj premaknite strani datoteke DOT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dot).
