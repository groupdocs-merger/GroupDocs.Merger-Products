...
############################# Head ############################
head_title: "Mutați ONE pagini în Java"
head_description: "Mutați paginile dintr-un document ONE în Java în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ONE pagini în Java"
description: "Mutați ONE pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Mutați ONE pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să mute paginile dintr-un fișier ONE prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ONE utilizând codul exemplu Java">}}

        ```java    
        // Mutați pagini de fișiere ONE utilizând API-ul GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo live - Mută ​​ONE pagini online"
    content: |
       Mutați pagini de fișiere ONE chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
