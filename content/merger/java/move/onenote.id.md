...
############################# Head ############################
head_title: "Pindahkan ONENOTE Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen ONENOTE di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ONENOTE Halaman Di Java"
description: "Pindahkan Halaman ONENOTE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan ONENOTE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file ONENOTE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ONENOTE menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan ONENOTE Halaman Online"
    content: |
       Pindahkan halaman file ONENOTE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/onenote).
