...
############################# Head ############################
head_title: "Di chuyển XLSM Trang trong Java"
head_description: "Di chuyển các trang trong tài liệu XLSM trong Java đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển XLSM Trang trong Java"
description: "Di chuyển các Trang XLSM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Di chuyển XLSM Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng di chuyển các trang trong tệp XLSM bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp XLSM bằng mã mẫu Java">}}

        ```java    
        // Di chuyển các trang tệp XLSM bằng API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
