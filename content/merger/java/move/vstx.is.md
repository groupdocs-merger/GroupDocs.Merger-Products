...
############################# Head ############################
head_title: "Færa VSTX síður í Java"
head_description: "Færðu síður innan VSTX skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSTX síður í Java"
description: "Færðu VSTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa VSTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í VSTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSTX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu VSTX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu VSTX síður á netinu"
    content: |
       Færðu VSTX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vstx) vefsíðu.
