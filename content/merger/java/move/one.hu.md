...
############################# Head ############################
head_title: "ONE oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy ONE dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ONE oldal mozgatása a Java nyelven"
description: "Mozgasson át ONE oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ONE fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy ONE fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájloldalak mozgatása a Java példakóddal">}}

        ```java    
        // Áthelyezhet ONE fájloldalt a GroupDocs.Merger API segítségével
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ONE oldal áthelyezése online"
    content: |
       A [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one) webhely meglátogatásával azonnal áthelyezhet ONE fájloldalt.
