...
############################# Head ############################
head_title: "Teisalda VTX lehte teenuses Java"
head_description: "Teisaldage dokumendi VTX lehed rakenduses Java mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VTX lehte rakenduses Java"
description: "Teisaldage VTX lehti mõne toote Java koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede teisaldamise failis VTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Teisaldage VTX faililehte GroupDocs.Merger API abil
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – teisaldage VTX lehte võrgus"
    content: |
       Teisaldage kohe VTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vtx).
