...
head_description: "Use GroupDocs.Merger for Java to reorder pages in MHTML documents effortlessly. Process PDF, Word, Excel, PowerPoint, images, and more with ease."

############################# Header ############################
title: "Move pages in MHTML" 
description: "GroupDocs.Merger for Java empowers Java applications to reorder pages in MHTML documents seamlessly."
...
steps:
    enable: true
    title: "How to move MHTML pages"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to move selected pages in MHTML documents. Enhance your Java applications with advanced document processing features.
      
      1. Specify the source MHTML file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Move a page to the end of the document"
      content: |
        Learn how to move a specific page to the end of a MHTML document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
