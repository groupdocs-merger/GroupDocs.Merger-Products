...
############################# Head ############################
head_title: "Alihkan XLS Halaman dalam Java"
head_description: "Alihkan halaman dalam dokumen XLS dalam Java ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLS Halaman Dalam Java"
description: "Alihkan XLS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alihkan XLS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memindahkan halaman dalam fail XLS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alihkan XLS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Alihkan XLS Halaman Dalam Talian"
    content: |
       Alihkan XLS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xls).
