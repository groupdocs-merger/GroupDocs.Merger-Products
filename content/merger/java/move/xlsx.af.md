...
############################# Head ############################
head_title: "Skuif XLSX bladsye in Java"
head_description: "Skuif bladsye binne 'n XLSX dokument in Java na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif XLSX bladsye in Java"
description: "Skuif XLSX bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Skuif XLSX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLSX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSX lêerbladsye te skuif deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Skuif XLSX lêerbladsye deur GroupDocs.Merger API te gebruik
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Skuif XLSX bladsye aanlyn"
    content: |
       Skuif XLSX lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsx) webwerf te besoek.
