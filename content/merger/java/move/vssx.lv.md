...
############################# Head ############################
head_title: "Pārvietot VSSX lapas programmā Java"
head_description: "Pārvietojiet lapas VSSX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSSX lapas programmā Java"
description: "Pārvietojiet VSSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas VSSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet VSSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet VSSX lapas tiešsaistē"
    content: |
       Pārvietojiet VSSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx).
