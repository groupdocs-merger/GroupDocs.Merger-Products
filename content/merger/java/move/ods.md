...
############################# Head ############################
head_title: "Move, Rearrange & Reorder ODS Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a ODS document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder ODS Pages in Java"
description: "Move and Rearrange the pages within a ODS document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange ODS File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a ODS file by implementing a few easy steps.
