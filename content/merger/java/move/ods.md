...
############################# Head ############################
head_title: "Move ODS Pages in Java"
head_description: "Move pages within a ODS document in Java to any position using the documents merger API."

############################# Header ############################
title: "Move ODS Pages In Java"
description: "Move ODS Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Move ODS File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to move pages within a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODS file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move ODS Pages Online"
    content: |
       Move ODS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) website.
