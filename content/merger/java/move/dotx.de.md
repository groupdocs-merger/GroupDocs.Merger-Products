...
############################# Head ############################
head_title: "Verschiebe DOTX Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines DOTX-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe DOTX Seiten in Java"
description: "Verschieben Sie DOTX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie DOTX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer DOTX-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie DOTX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie DOTX Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie DOTX Seiten online"
    content: |
       Verschieben Sie jetzt DOTX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotx) besuchen.
