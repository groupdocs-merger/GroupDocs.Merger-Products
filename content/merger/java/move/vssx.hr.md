...
############################# Head ############################
head_title: "Premjesti VSSX stranice u Java"
head_description: "Premjestite stranice unutar VSSX dokumenta u Java na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSSX stranice u Java"
description: "Premjesti VSSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Premjesti VSSX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima premještanje stranica unutar VSSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Premjesti VSSX stranice datoteke pomoću API-ja GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - premjesti VSSX stranice na mrežu"
    content: |
       Premjestite VSSX stranice datoteke upravo sada posjetom [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/vssx) web stranice.
