...
############################# Head ############################
head_title: "DOT ገጾችን በJava ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በDOT ሰነድ ውስጥ በJava ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "DOT ገጾችን በJava ውስጥ አንቀሳቅስ"
description: "DOT ገጾችን ከጥቂት መስመሮች Java ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "DOT የፋይል ገጾችን በJava አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በDOT ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የDOT ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger API በመጠቀም DOT የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - DOT ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የDOT ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
