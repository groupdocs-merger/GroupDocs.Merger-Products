...
############################# Head ############################
head_title: "Verschiebe DOCM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines DOCM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe DOCM Seiten in Java"
description: "Verschieben Sie DOCM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie DOCM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer DOCM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie DOCM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie DOCM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie DOCM Seiten online"
    content: |
       Verschieben Sie jetzt DOCM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm) besuchen.
