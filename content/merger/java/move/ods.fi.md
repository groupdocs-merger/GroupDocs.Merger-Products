...
############################# Head ############################
head_title: "Siirrä ODS sivua Java"
head_description: "Siirrä ODS-asiakirjan sivuja Java:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODS sivua Java"
description: "Siirrä ODS sivua muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi siirtää sivuja ODS-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Siirrä ODS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä ODS sivua verkkoon"
    content: |
       Siirrä ODS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ods) -sivustolla.
