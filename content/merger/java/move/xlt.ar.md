...
############################# Head ############################
head_title: "نقل صفحات XLT في Java"
head_description: "انقل الصفحات داخل مستند XLT في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLT في Java"
description: "انقل صفحات XLT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل XLT صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف XLT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLT باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف XLT باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات XLT عبر الإنترنت"
    content: |
       انقل صفحات ملف XLT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlt).
