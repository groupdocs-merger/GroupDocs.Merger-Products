...
############################# Head ############################
head_title: "Færa ODP síður í Java"
head_description: "Færðu síður innan ODP skjals í Java á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa ODP síður í Java"
description: "Færðu ODP síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Færa ODP skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að færa síður í ODP skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa ODP skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Færðu ODP skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Færðu ODP síður á netinu"
    content: |
       Færðu ODP skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) vefsíðu.
