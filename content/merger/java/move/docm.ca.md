...
############################# Head ############################
head_title: "Mou DOCM pàgines a Java"
head_description: "Mou les pàgines d'un document DOCM a Java a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou DOCM pàgines a Java"
description: "Mou DOCM pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Mou DOCM pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java puguin moure pàgines dins d'un fitxer DOCM implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers DOCM utilitzant el codi d'exemple Java">}}

        ```java    
        // Mou DOCM pàgines de fitxers mitjançant l'API de GroupDocs.Merger
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: mou DOCM pàgines en línia"
    content: |
       Mou les pàgines de fitxers DOCM ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
