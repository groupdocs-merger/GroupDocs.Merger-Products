...
############################# Head ############################
head_title: "نقل صفحات ONE في Java"
head_description: "انقل الصفحات داخل مستند ONE في Java إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ONE في Java"
description: "انقل صفحات ONE ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "نقل ONE صفحات الملفات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java نقل الصفحات داخل ملف ONE من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ONE باستخدام كود مثال Java">}}

        ```java    
        // انقل صفحات ملف ONE باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات ONE عبر الإنترنت"
    content: |
       انقل صفحات ملف ONE الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/one).
