...
############################# Head ############################
head_title: "Java에서 XPS 페이지 이동"
head_description: "문서 병합 API를 사용하여 Java의 XPS 문서 내의 페이지를 원하는 위치로 이동합니다."

############################# Header ############################
title: "Java에서 XPS 페이지 이동"
description: "몇 줄의 Java 코드로 XPS 페이지를 이동하세요."
...
steps:
    enable: true
    title_left: "Java에서 XPS 파일 페이지 이동"
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 Java 개발자가 몇 가지 간단한 단계를 구현하여 XPS 파일 내에서 페이지를 쉽게 이동할 수 있습니다. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 XPS 파일 페이지를 이동하는 방법">}}

        ```java    
        // GroupDocs.Merger API를 사용하여 XPS 파일 페이지 이동
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "라이브 데모 - 온라인으로 XPS 페이지 이동"
    content: |
       지금 바로 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) 웹사이트를 방문하여 XPS 파일 페이지를 이동하세요.
