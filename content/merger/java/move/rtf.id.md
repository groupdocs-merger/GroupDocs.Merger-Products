...
############################# Head ############################
head_title: "Pindahkan RTF Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen RTF di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan RTF Halaman Di Java"
description: "Pindahkan Halaman RTF dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan RTF Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file RTF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file RTF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan RTF Halaman Online"
    content: |
       Pindahkan halaman file RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/rtf).
