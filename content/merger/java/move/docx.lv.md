...
############################# Head ############################
head_title: "Pārvietot DOCX lapas programmā Java"
head_description: "Pārvietojiet lapas DOCX dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOCX lapas programmā Java"
description: "Pārvietojiet DOCX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOCX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOCX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOCX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOCX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOCX lapas tiešsaistē"
    content: |
       Pārvietojiet DOCX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docx).
