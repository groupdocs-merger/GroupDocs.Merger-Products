...
############################# Head ############################
head_title: "Pārvietot DOCM lapas programmā Java"
head_description: "Pārvietojiet lapas DOCM dokumentā programmā Java uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOCM lapas programmā Java"
description: "Pārvietojiet DOCM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOCM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pārvietot lapas DOCM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOCM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Pārvietojiet DOCM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demonstrācijas tiešraidē — pārvietojiet DOCM lapas tiešsaistē"
    content: |
       Pārvietojiet DOCM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/docm).
