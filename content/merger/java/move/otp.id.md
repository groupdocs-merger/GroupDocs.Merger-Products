...
############################# Head ############################
head_title: "Pindahkan OTP Halaman di Java"
head_description: "Pindahkan halaman dalam dokumen OTP di Java ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan OTP Halaman Di Java"
description: "Pindahkan Halaman OTP dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pindahkan OTP Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk memindahkan halaman dalam file OTP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file OTP menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan OTP Halaman Online"
    content: |
       Pindahkan halaman file OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/otp).
