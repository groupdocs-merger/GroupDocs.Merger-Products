...
############################# Head ############################
head_title: "Verschiebe DOTM Seiten in Java"
head_description: "Verschieben Sie Seiten innerhalb eines DOTM-Dokuments in Java mithilfe der Documents Merger API an eine beliebige Position."

############################# Header ############################
title: "Verschiebe DOTM Seiten in Java"
description: "Verschieben Sie DOTM-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Verschieben Sie DOTM Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer DOTM-Datei zu verschieben, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So verschieben Sie DOTM-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Verschieben Sie DOTM Dateiseiten mit der GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-Demos - Verschieben Sie DOTM Seiten online"
    content: |
       Verschieben Sie jetzt DOTM Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/dotm) besuchen.
