...
############################# Head ############################
head_title: "XLT oldal áthelyezése a Java nyelven"
head_description: "Mozgassa át az oldalakat egy XLT dokumentumon belül a Java nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLT oldal mozgatása a Java nyelven"
description: "Mozgasson át XLT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLT fájloldal áthelyezése a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára az oldalak áthelyezését egy XLT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT fájloldalak mozgatása a Java példakóddal">}}
