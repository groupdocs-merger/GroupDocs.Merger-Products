...
############################# Head ############################
head_title: "Egyesítse az XLTM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLTM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLTM Egyesülés a Java programban"
description: "Egyesítse a(z) XLTM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLTM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLTM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLTM fájlokat a GroupDocs.Merger for Java API segítségével
