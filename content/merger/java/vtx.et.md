...
############################# Head ############################
head_title: "Ühendage VTX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VTX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VTX ühinemine programmis Java"
description: "Ühendage VTX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VTX faili, kasutades Java näitekoodi">}}
