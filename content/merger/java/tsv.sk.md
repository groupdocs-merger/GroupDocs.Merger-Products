...
############################# Head ############################
head_title: "Zlúčiť súbory TSV cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero TSV súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "TSV Zlúčenie v Java"
description: "Zlúčte TSV s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero TSV súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov TSV vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory TSV pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť TSV súbory pomocou GroupDocs.Merger for Java API
