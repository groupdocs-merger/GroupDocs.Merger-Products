...
############################# Head ############################
head_title: "Slå sammen CSV filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "CSV sammenslåing i Java"
description: "Slå sammen CSV med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen CSV filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen CSV filer med GroupDocs.Merger for Java API
