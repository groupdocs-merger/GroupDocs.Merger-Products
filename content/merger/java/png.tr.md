...
############################# Head ############################
head_title: "PNG Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla PNG dosyasını birleştirin."

############################# Header ############################
title: "PNG Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok PNG Dosyayı Java İçinde Birleştirin"
    content_left: |
