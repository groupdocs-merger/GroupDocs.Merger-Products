...
############################# Head ############################
head_title: "Ühendage BMP failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu BMP-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "BMP ühinemine programmis Java"
description: "Ühendage BMP mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita BMP faili, kasutades Java näitekoodi">}}
