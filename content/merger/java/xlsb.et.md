...
############################# Head ############################
head_title: "Ühendage XLSB failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLSB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLSB ühinemine programmis Java"
description: "Ühendage XLSB mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLSB faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLSB faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLSB faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLSB, kasutades GroupDocs.Merger for Java API-t
