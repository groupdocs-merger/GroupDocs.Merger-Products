...
############################# Head ############################
head_title: "Führen Sie VSDM-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere VSDM-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "VSDM Fusion in Java"
description: "Führen Sie VSDM mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere VSDM-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere VSDM-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VSDM-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie VSDM-Dateien mit GroupDocs.Merger for Java API zusammen
