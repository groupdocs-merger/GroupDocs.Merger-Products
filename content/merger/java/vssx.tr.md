...
############################# Head ############################
head_title: "VSSX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSSX dosyasını birleştirin."

############################# Header ############################
title: "VSSX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSSX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) web sitesini ziyaret ederek birden fazla VSSX dosyayı birleştirin.
