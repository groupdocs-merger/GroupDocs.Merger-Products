...
############################# Head ############################
head_title: "Combina fitxers XLSM mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers XLSM a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "XLSM Fusió a Java"
description: "Combina XLSM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers XLSM a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers XLSM implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLSM mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers XLSM mitjançant l'API de GroupDocs.Merger per a Java
