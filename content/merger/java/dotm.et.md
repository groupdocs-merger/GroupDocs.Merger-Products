...
############################# Head ############################
head_title: "Ühendage DOTM failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOTM-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "DOTM ühinemine programmis Java"
description: "Ühendage DOTM mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOTM faili, kasutades Java näitekoodi">}}
