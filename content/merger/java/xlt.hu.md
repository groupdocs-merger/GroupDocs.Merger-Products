...
############################# Head ############################
head_title: "Egyesítse az XLT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLT Egyesülés a Java programban"
description: "Egyesítse a(z) XLT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLT fájlokat a GroupDocs.Merger for Java API segítségével
