...
############################# Head ############################
head_title: "Führen Sie IMAGE-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere IMAGE-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "IMAGE Fusion in Java"
description: "Führen Sie IMAGE mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere IMAGE-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere IMAGE-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie IMAGE-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie IMAGE-Dateien mit GroupDocs.Merger for Java API zusammen
