...
############################# Head ############################
head_title: "Spoji datoteke OTP prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek OTP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "OTP Združitev v Java"
description: "Spojite OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek OTP v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTP s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke OTP z API-jem GroupDocs.Merger for Java
...
demos:
    ...
    content: |
       Združite več kot eno datoteko OTP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
