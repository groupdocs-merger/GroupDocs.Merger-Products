...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы ODP файлдарды біріктіріңіз"
head_description: "Java тіліндегі бірнеше ODP файлдарды бастапқы құжаттар ретінде барлық деректермен, мәнерлермен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "ODP Біріктіру Java"
description: "ODP кодының бірнеше жолын Java кодымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше ODP файлдарды біріктіру"
    content_left: |
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) веб-сайтына кіру арқылы бірден көп ODP файлдарды біріктіріңіз.
