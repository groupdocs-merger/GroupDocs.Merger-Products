...
############################# Head ############################
head_title: "Slå sammen XLAM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLAM sammenslåing i Java"
description: "Slå sammen XLAM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLAM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLAM filer med GroupDocs.Merger for Java API
