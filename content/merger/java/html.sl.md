...
############################# Head ############################
head_title: "Spoji datoteke HTML prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek HTML v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "HTML Združitev v Java"
description: "Spojite HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek HTML v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke HTML s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke HTML z API-jem GroupDocs.Merger for Java
