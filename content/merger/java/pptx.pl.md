...
############################# Head ############################
head_title: "Scal pliki PPTX za pomocą interfejsu API łączenia dokumentów Java i J2SE"
head_description: "Scal wiele plików PPTX w Javie za pomocą interfejsu API łączenia dokumentów ze wszystkimi danymi, stylami i formatowaniem jako dokumentami źródłowymi."

############################# Header ############################
title: "PPTX Fuzja w Java"
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pl/merger/java/) zapewnia wygodne rozwiązanie do scalania wielu plików PDF, pakietu Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrazów i wiele innych dokumentów w jednym pliku w aplikacjach Java. GroupDocs.Merger zaoszczędzi Ci wiele wysiłku, ponieważ możesz łączyć dokumenty PPTX - nie ma potrzeby instalowania żadnego oprogramowania innych firm, aplikacji komputerowych ani wtyczek. Teraz nie musisz tracić czasu i ręcznie scalać pliki! Misją GroupDocs jest zapewnienie najwyższej jakości i uproszczenie przepływów pracy przy przetwarzaniu dokumentów.
...
steps:
    enable: true
    title_left: "Scal wiele plików PPTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java łączenie wielu plików PPTX przez wykonanie kilku prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak scalić pliki PPTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Scal pliki PPTX za pomocą GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Scal teraz więcej niż jeden plik PPTX, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
