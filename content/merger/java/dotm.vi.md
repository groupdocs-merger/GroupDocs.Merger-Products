...
############################# Head ############################
head_title: "Hợp nhất tệp DOTM qua API hợp nhất tài liệu Java & J2SE"
head_description: "Hợp nhất nhiều tệp DOTM trong Java bằng cách sử dụng API hợp nhất tài liệu với tất cả dữ liệu, kiểu và định dạng làm tài liệu nguồn."

############################# Header ############################
title: "DOTM Hợp nhất trong Java"
description: "Hợp nhất DOTM với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Hợp nhất Nhiều DOTM Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng hợp nhất nhiều tệp DOTM bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hợp nhất các tệp DOTM bằng mã mẫu Java">}}

        ```java    
        // Hợp nhất các tệp DOTM bằng GroupDocs.Merger cho Java API
