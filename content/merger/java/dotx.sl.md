...
############################# Head ############################
head_title: "Spoji datoteke DOTX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOTX Združitev v Java"
description: "Spojite DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOTX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOTX z API-jem GroupDocs.Merger for Java
