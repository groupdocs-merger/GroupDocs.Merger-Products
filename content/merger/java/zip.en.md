...
############################# Head ############################
head_title: "Merge ZIP files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate ZIP document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge ZIP files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage ZIP documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of ZIP documents. Enhance your Java applications by combining multiple files into one.
