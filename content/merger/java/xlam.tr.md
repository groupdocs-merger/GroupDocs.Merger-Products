...
############################# Head ############################
head_title: "XLAM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLAM dosyasını birleştirin."

############################# Header ############################
title: "XLAM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLAM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) web sitesini ziyaret ederek birden fazla XLAM dosyayı birleştirin.
