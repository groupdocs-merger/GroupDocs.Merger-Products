...
############################# Head ############################
head_title: "Slå sammen XPS filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XPS sammenslåing i Java"
description: "Slå sammen XPS med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XPS filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XPS filer med GroupDocs.Merger for Java API
