...
############################# Head ############################
head_title: "Ühendage JPEG failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu JPEG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "JPEG ühinemine programmis Java"
description: "Ühendage JPEG mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita JPEG faili, kasutades Java näitekoodi">}}
