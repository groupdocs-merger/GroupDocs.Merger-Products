...
############################# Head ############################
head_title: "Egyesítse az DOTX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több DOTX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOTX Egyesülés a Java programban"
description: "Egyesítse a(z) DOTX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOTX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOTX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen DOTX fájlokat a GroupDocs.Merger for Java API segítségével
