...
head_description: "使用文档合并 API 合并 Java 中的多个 EPUB 文件，并将所有数据、样式和格式作为源文档。"

############################# Header ############################
title: "EPUB 合并到 Java"
description: "将 EPUB 与几行 Java 代码合并。"
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 为合并多个 PDF、Microsoft Office（Word、Excel、PowerPoint、OneNote）、OpenDocument、HTML、图像和在 Java 应用程序中将许多其他文档合并到一个文件中。 GroupDocs.Merger 将为您节省大量精力，因为您可以合并 EPUB 文档 - 无需安装任何第三方软件、桌面应用程序或插件。现在不必浪费时间手动合并文件了！ GroupDocs 的使命是提供最佳质量并简化文档处理工作流程。
...
steps:
    enable: true
    title_left: "合并 Java 中的多个 EPUB 文件"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 通过执行几个简单的步骤，让 Java 开发人员可以轻松合并多个 EPUB 文件。
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码合并 EPUB 文件">}}
...
demos:
    ...
    content: |
       访问 [GroupDocs.Merger 现场演示](https://products.groupdocs.app/merger/epub) 网站，立即合并多个 EPUB 文件。
       现场演示具有以下好处。
