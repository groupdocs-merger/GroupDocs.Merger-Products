...
############################# Head ############################
head_title: "Slå sammen BMP filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "BMP sammenslåing i Java"
description: "Slå sammen BMP med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen BMP filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen BMP filer med GroupDocs.Merger for Java API
