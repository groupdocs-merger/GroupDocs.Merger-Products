...
############################# Head ############################
head_title: "Mesclar arquivos DOCM via API de mesclagem de documentos Java e J2SE"
head_description: "Mescle vários arquivos DOCM em Java usando a API de fusão de documentos com todos os dados, estilo e formatação como documentos de origem."

############################# Header ############################
title: "DOCM Fusão em Java"
description: "Mescle DOCM com algumas linhas de código Java."
...
about:
    ...
    content: |
        [GroupDocs.Merger for Java](/pt/merger/java/) fornece uma solução conveniente para mesclar vários PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, imagens e muitos outros documentos em um único arquivo dentro dos aplicativos Java. O GroupDocs.Merger economizará muito esforço, pois você tem permissão para mesclar DOCM documentos - não há necessidade de instalar nenhum software de terceiros, aplicativos de desktop ou plug-ins. Agora é desnecessário perder seu tempo e mesclar arquivos manualmente! A missão do GroupDocs é fornecer a melhor qualidade e simplificar os fluxos de trabalho de processamento de documentos.
...
steps:
    enable: true
    title_left: "Mesclar vários arquivos DOCM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores Java mesclar vários arquivos DOCM implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOCM usando o código de exemplo Java">}}

        ```java    
        // Mesclar arquivos DOCM usando GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Mescle mais de um arquivo DOCM agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
