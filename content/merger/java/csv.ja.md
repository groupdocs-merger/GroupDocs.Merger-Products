...
############################# Head ############################
head_title: "JavaでCSVファイルをマージ"
head_description: "JavaプロジェクトにCSVドキュメントマージ機能を統合するために、GroupDocs.Merger for Javaを使用します。"

############################# Header ############################
title: "CSVファイルをマージ" 
description: "GroupDocs.Merger for Javaを使用すれば、Javaアプリケーションを構築して、CSVドキュメントをシームレスにマージおよび管理できます。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)はCSVドキュメントのシームレスなマージを可能にします。複数のファイルを1つに統合して、Javaアプリケーションを強化します。
      
      1. 最初のCSVファイルのパスを指定します。
