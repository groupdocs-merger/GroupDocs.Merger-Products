...
############################# Head ############################
head_title: "XLTX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLTX dosyasını birleştirin."

############################# Header ############################
title: "XLTX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLTX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) web sitesini ziyaret ederek birden fazla XLTX dosyayı birleştirin.
