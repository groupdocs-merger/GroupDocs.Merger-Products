...
############################# Head ############################
head_title: "تدوير الصفحات XPS في Java - تدوير بزاوية 90 و 180 و 270"
head_description: "قم بتدوير صفحات محددة أو كل صفحات المستند لملف XPS بزاوية دوران 90 ، 180 ، 270 باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تدوير الصفحات XPS في Java"
description: "تدوير الصفحات XPS ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تدوير صفحات الملفات XPS في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تدوير بعض الصفحات المحددة أو جميعها داخل ملف XPS عند 90 180 أو 270 زاوية دوران من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تدوير صفحات ملف XPS باستخدام كود مثال Java">}}

        ```java    
        // تدوير صفحات ملف XPS باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - تدوير صفحات ملف XPS عبر الإنترنت"
    content: |
       قم بتدوير صفحات ملف XPS الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps).
