...
############################# Head ############################
head_title: "Obróć PDF Strony w Java – Obróć o 90, 180, 270 Kąt"
head_description: "Obracaj określone lub wszystkie strony dokumentu pliku PDF pod kątem 90, 180, 270 za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Obróć PDF strony w Java"
description: "Obracaj strony PDF za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Obróć strony plików PDF w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java rotację niektórych lub wszystkich stron w pliku PDF o 90 , kąt obrotu 180 lub 270, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak obracać strony plików PDF przy użyciu przykładowego kodu Java">}}

        ```java    
        // Obracaj strony plików PDF za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo – Obróć PDF strony plików online"
    content: |
       Obracaj strony plików PDF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/pdf).
