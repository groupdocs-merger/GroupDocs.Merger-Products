...
############################# Head ############################
head_title: "Gira PDF pàgines en Java: gira a 90, 180, 270 angles"
head_description: "Gireu pàgines específiques o totes del document d'un fitxer PDF amb un angle de rotació de 90, 180, 270 mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Gira PDF pàgines a Java"
description: "Gira PDF pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Gira PDF pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java giren algunes pàgines específiques o totes dins d'un fitxer PDF a 90 , 180 o 270 angle de gir implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com girar les pàgines de fitxers PDF utilitzant el codi d'exemple Java">}}

        ```java    
        // Gireu PDF pàgines de fitxers mitjançant l'API de GroupDocs.Merger
...
demos:
    enable: true
    title: "Demostracions en directe: gireu PDF pàgines de fitxers en línia"
    content: |
       Gireu les pàgines del fitxer PDF ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/pdf).
