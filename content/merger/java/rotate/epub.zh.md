...
############################# Head ############################
head_title: "在Java应用程序中旋转EPUB页面"
head_description: "使用GroupDocs.Merger for Java旋转任何EPUB页面。通过我们的解决方案管理PDF、Word文档、Excel电子表格、PowerPoint演示文稿、图像、压缩文件等。"

############################# Header ############################
title: "在EPUB中旋转页面" 
description: "GroupDocs.Merger for Java扩展了Java应用程序的功能。处理流行业务格式的文档，具备在EPUB文件中旋转页面等功能。"
...
steps:
    ...
    title: "如何旋转EPUB页面"
    content: |
      使用[GroupDocs.Merger](/merger/java/)，您可以在EPUB文档中旋转页面，从而增强Java应用程序中的文档管理能力。
