...
############################# Head ############################
head_title: "XPS-Seiten in Java-Apps drehen"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um beliebige Seiten in XPS zu drehen. Verwalten Sie PDFs, Word-Dokumente, Excel-Tabellen, PowerPoint-Präsentationen, Bilder, Archive und mehr mit unseren Lösungen."

############################# Header ############################
title: "XPS-Seitenrotation" 
description: "GroupDocs.Merger for Java erweitert die Funktionen von Java-Anwendungen. Verarbeiten Sie Dokumente in gängigen Geschäftsformaten mit Funktionen wie der Seitenrotation in XPS-Dateien."
...
steps:
    ...
    content: |
      Mit [GroupDocs.Merger](/merger/java/) können Sie Seiten in XPS-Dokumenten drehen, was die Dokumentenmanagementfähigkeiten in Java-Anwendungen verbessert.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Drehen Sie alle gerade nummerierten XPS-Seiten"
      content: |
        Sehen Sie sich dieses Beispiel an, das zeigt, wie Sie alle gerade nummerierten Seiten in einem XPS-Dokument drehen.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
