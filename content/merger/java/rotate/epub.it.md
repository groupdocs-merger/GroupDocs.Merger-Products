...
############################# Head ############################
head_title: "Ruota le pagine EPUB nelle app Java"
head_description: "Utilizza GroupDocs.Merger for Java per ruotare qualsiasi pagina EPUB. Gestisci PDF, documenti Word, fogli di calcolo Excel, presentazioni PowerPoint, immagini, archivi e altro ancora con le nostre soluzioni."

############################# Header ############################
title: "Rotazione delle pagine in EPUB" 
description: "GroupDocs.Merger for Java estende le capacità delle applicazioni Java. Elabora documenti in formati aziendali popolari con funzionalità come la rotazione delle pagine nei file EPUB."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/java/), puoi ruotare le pagine nei documenti EPUB, migliorando le capacità di gestione dei documenti nelle applicazioni Java.
      
      1. Specifica il percorso del file EPUB sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ruota tutte le pagine EPUB con numero pari"
      content: |
        Dai un'occhiata a questo esempio che dimostra come ruotare tutte le pagine con numero pari in un documento EPUB.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
