...
############################# Head ############################
head_title: "Rotera EPUB sidor i Java – Rotera i 90, 180, 270 vinkel"
...
############################# Header ############################
title: "Rotera EPUB sidor i Java"
description: "Rotera EPUB sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Rotera EPUB filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att rotera vissa specifika eller alla sidor i en EPUB-fil vid 90 , 180 eller 270 rotationsvinkel genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man roterar EPUB filsidor med hjälp av Java exempelkod">}}
