...
############################# Head ############################
head_title: "Otočit XPS stránky v Java – Otočit v úhlu 90, 180, 270"
...
############################# Header ############################
title: "Otočit XPS stránek v Java"
description: "Otočte XPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Otočit XPS stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java otočit některé konkrétní nebo všechny stránky v souboru XPS na 90 , 180 nebo 270 úhel otočení pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak otočit stránky souboru XPS pomocí ukázkového kódu Java">}}
