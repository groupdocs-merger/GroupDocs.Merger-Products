...
############################# Head ############################
head_title: "Rothlaigh XPS Leathanaigh i Java - Rothlaigh ag 90, 180, 270 Uillinn"
head_description: "Rothlaigh leathanaigh sainiúla nó gach leathanach doiciméid de chomhad XPS ag uillinn uainíochta 90, 180, 270 ag baint úsáide as API cumaisc doiciméad."

############################# Header ############################
title: "Rothlaigh XPS Leathanaigh i Java"
description: "Rothlaigh XPS Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Rothlaigh XPS Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java roinnt leathanaigh ar leith nó gach leathanach a rothlú laistigh de chomhad XPS ag 90 , uillinn uainíochta 180 nó 270 trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XPS a rothlú ag úsáid cód sampla Java">}}

        ```java    
        // Rothlaigh leathanaigh comhaid XPS ag baint úsáide as GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Rothlaigh XPS Leathanaigh Chomhad Ar Líne"
    content: |
       Rothlaigh XPS leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps).
