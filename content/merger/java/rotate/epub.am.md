...
############################# Head ############################
head_title: "EPUB ገጾችን በJava አሽከርክር - በ90፣ 180፣ 270 አንግል አሽከርክር"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የEPUB ፋይል የተወሰኑ ወይም ሁሉንም የሰነድ ገጾችን በ90፣ 180፣ 270 የማዞሪያ አንግል አሽከርክር።"

############################# Header ############################
title: "EPUB ገጾችን በJava አሽከርክር"
description: "EPUB ገጾችን ከጥቂት መስመሮች Java ኮድ ጋር አሽከርክር።"
...
steps:
    enable: true
    title_left: "EPUB የፋይል ገጾችን በJava አሽከርክር"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች አንዳንድ የተወሰኑ ወይም ሁሉንም ገጾች በEPUB ፋይል በ90 ማሽከርከር ቀላል ያደርገዋል። ፣ ጥቂት ቀላል ደረጃዎችን በመተግበር 180 ወይም 270 የማዞሪያ አንግል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የEPUB ፋይል ገጾችን እንዴት ማሽከርከር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የEPUB ፋይል ገጾችን አሽከርክር
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - EPUB የፋይል ገጾችን በመስመር ላይ አሽከርክር"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/epub) ድህረ ገጽን በመጎብኘት የEPUB ፋይል ገጾችን አሽከርክር።
