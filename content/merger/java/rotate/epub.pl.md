...
############################# Head ############################
head_title: "Obróć EPUB Strony w Java – Obróć o 90, 180, 270 Kąt"
...
############################# Header ############################
title: "Obróć EPUB strony w Java"
description: "Obracaj strony EPUB za pomocą kilku wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Obróć strony plików EPUB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java rotację niektórych lub wszystkich stron w pliku EPUB o 90 , kąt obrotu 180 lub 270, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak obracać strony plików EPUB przy użyciu przykładowego kodu Java">}}
