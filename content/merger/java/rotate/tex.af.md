...
############################# Head ############################
head_title: "Draai TEX bladsye in Java – Draai teen 90, 180, 270 hoek"
...
############################# Header ############################
title: "Draai TEX bladsye in Java"
description: "Draai TEX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Draai TEX lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om sekere spesifieke of alle bladsye binne 'n TEX-lêer teen 90 te draai , 180 of 270 rotasiehoek deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TEX lêerbladsye te draai deur Java voorbeeldkode te gebruik">}}
