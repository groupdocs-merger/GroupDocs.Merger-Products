...
############################# Head ############################
head_title: "Xoay XPS Trang trong Java - Xoay ở các góc 90, 180, 270"
head_description: "Xoay các trang tài liệu cụ thể hoặc tất cả các trang của tệp XPS ở góc xoay 90, 180, 270 bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xoay XPS Trang trong Java"
description: "Xoay các trang XPS với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Xoay XPS Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng xoay một số trang cụ thể hoặc tất cả các trang trong tệp XPS ở 90 , Góc quay 180 hoặc 270 bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xoay các trang tệp XPS bằng mã mẫu Java">}}

        ```java    
        // Xoay các trang tệp XPS bằng API GroupDocs.Merger
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Xoay vòng XPS Trang Tệp Trực tuyến"
    content: |
       Xoay vòng các trang tệp XPS ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/ xps) trang web.
