...
############################# Head ############################
head_title: "Pasukti XPS puslapius Java – pasukti 90, 180, 270 kampu"
head_description: "Pasukite konkrečius arba visus XPS failo dokumento puslapius 90, 180, 270 kampu, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pasukti XPS puslapius Java"
description: "Pasukite XPS puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pasukti XPS failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai pasukti kai kuriuos konkrečius arba visus puslapius XPS faile esant 90 , 180 arba 270 sukimosi kampu, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pasukti XPS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukite XPS failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – pasukite XPS failo puslapius prisijungę"
    content: |
       Dabar pasukite XPS failo puslapius apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps) svetainėje.
