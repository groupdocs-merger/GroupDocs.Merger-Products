...
############################# Head ############################
head_title: "Rothlaigh PDF Leathanaigh i Java - Rothlaigh ag 90, 180, 270 Uillinn"
...
############################# Header ############################
title: "Rothlaigh PDF Leathanaigh i Java"
description: "Rothlaigh PDF Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Rothlaigh PDF Leathanaigh Chomhad i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java roinnt leathanaigh ar leith nó gach leathanach a rothlú laistigh de chomhad PDF ag 90 , uillinn uainíochta 180 nó 270 trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid PDF a rothlú ag úsáid cód sampla Java">}}
