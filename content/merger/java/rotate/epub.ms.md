...
############################# Header ############################
title: "Putar EPUB Halaman Dalam Java"
description: "Putar EPUB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Putar EPUB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memutar beberapa halaman tertentu atau semua halaman dalam fail EPUB pada 90 , 180 atau 270 sudut putaran dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memutar EPUB halaman fail menggunakan kod contoh Java.">}}
