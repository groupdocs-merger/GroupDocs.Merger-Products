...
############################# Head ############################
head_title: "Java에서 XPS 페이지 회전 – 90, 180, 270 각도로 회전"
head_description: "문서 병합 API를 사용하여 XPS 파일의 특정 또는 모든 문서 페이지를 90, 180, 270 회전 각도로 회전합니다."

############################# Header ############################
title: "Java에서 XPS 페이지 회전"
description: "몇 줄의 Java 코드로 XPS 페이지를 회전합니다."
...
about:
    ...
    content: |
        ...
        GroupDocs.Merger API는 파일 페이지 회전 기능이 필요한 기업 솔루션에 적합한 선택입니다. 이러한 API는 J2SE 7.0 (1.7), J2SE 8.0 (1.8), Java 10을 포함한 모든 주요 운영 체제 및 플랫폼에서 잘 지원됩니다.

############################# Steps ############################
steps:
    enable: true
    title_left: "Java에서 XPS 파일 페이지 회전"
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 Java 개발자가 XPS 파일 내의 특정 또는 모든 페이지를 90도로 회전할 수 있습니다. , 몇 가지 간단한 단계를 구현하여 180도 또는 270도 회전 각도.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 XPS 파일 페이지를 회전하는 방법">}}

        ```java    
        // GroupDocs.Merger API를 사용하여 XPS 파일 페이지 회전
        ...
        // rotatePages 메서드를 호출하고 여기에 RotateOptions 객체를 전달합니다.
...
demos:
    enable: true
    title: "라이브 데모 - 온라인에서 XPS 파일 페이지 회전"
    content: |
       지금 바로 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps) 웹사이트를 방문하여 XPS 파일 페이지를 회전하세요.
...
more_formats:
    ...
    content: |
        Java은(는) 파일 형식 및 이미지에 대한 병합 및 분할 API를 문서화합니다. 아래에 설명된 대로 인기 있는 파일 형식 중 일부를 회전합니다.
