...
############################# Head ############################
head_title: "Otočiť TEX strán v Java – Otočiť o uhol 90, 180, 270"
...
############################# Header ############################
title: "Otočiť TEX strán v Java"
description: "Otočte TEX stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Otočte TEX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java otáčať niektoré konkrétne alebo všetky stránky v súbore TEX o 90° , 180 alebo 270 uhol otáčania vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako otočiť TEX strán súboru pomocou Java vzorového kódu">}}
