...
############################# Head ############################
head_title: "EPUB Sayfaları Java İçinde Döndür – 90, 180, 270 Açıda Döndür"
...
############################# Header ############################
title: "EPUB Sayfayı Java İçinde Döndür"
description: "EPUB Sayfalarını birkaç satır Java koduyla döndürün."
...
steps:
    enable: true
    title_left: "Java içinde EPUB Dosya Sayfalarını Döndür"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir EPUB dosyasındaki belirli veya tüm sayfaları 90'da döndürmesini kolaylaştırır , Birkaç kolay adım uygulayarak 180 veya 270 dönüş açısı.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak EPUB dosya sayfaları nasıl döndürülür">}}
