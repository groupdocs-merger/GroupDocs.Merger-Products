...
############################# Head ############################
head_title: "EPUB पृष्ठों को Java में घुमाएं - 90, 180, 270 कोण पर घुमाएं"
head_description: "दस्तावेज़ विलय API का उपयोग करके किसी EPUB फ़ाइल के विशिष्ट या सभी दस्तावेज़ पृष्ठों को 90, 180, 270 रोटेशन कोण पर घुमाएँ।"

############################# Header ############################
title: "EPUB पृष्ठों को Java में घुमाएं"
description: "EPUB पृष्ठों को Java कोड की कुछ पंक्तियों के साथ घुमाएं।"
...
steps:
    enable: true
    title_left: "EPUB फ़ाइल पृष्ठों को Java में घुमाएं"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) डेवलपर्स के लिए Java फ़ाइल के भीतर कुछ विशिष्ट या सभी पृष्ठों को 90 पर एक EPUB फ़ाइल में घुमाना आसान बनाता है। कुछ आसान चरणों को लागू करके 180 या 270 रोटेशन कोण।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके EPUB फ़ाइल पृष्ठों को कैसे घुमाएँ">}}

        ```java    
        // GroupDocs.Merger API का उपयोग करके EPUB फ़ाइल पृष्ठों को घुमाएँ
...
demos:
    enable: true
    title: "लाइव डेमो - घुमाएँ EPUB फ़ाइल पेज ऑनलाइन"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/epub) वेबसाइट पर जाकर EPUB फ़ाइल पेजों को अभी घुमाएँ।
