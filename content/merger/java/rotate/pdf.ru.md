...
date: 2022-09-16T13:27:36
draft: false
otherformats: xps tex epub

############################# Head ############################
head_title: "Повернуть PDF страницы на Java — поворот на угол 90, 180, 270"
...
############################# Header ############################
title: "Повернуть PDF страницы на Java"
description: "Поверните PDF страниц с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Повернуть страницы PDF документов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как повернуть страницы PDF документов, используя пример кода Java">}}
