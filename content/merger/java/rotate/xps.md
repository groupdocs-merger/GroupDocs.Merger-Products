...
############################# Header ############################
title: "Rotate XPS Pages In Java"
description: "Rotate XPS Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to rotate some specific or all pages within a XPS file at 90, 180 or 270 rotation angle by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to rotate XPS file pages using Java example code">}}
