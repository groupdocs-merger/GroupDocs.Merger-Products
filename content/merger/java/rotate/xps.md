...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to rotate some specific or all pages within a XPS file at 90, 180 or 270 rotation angle by implementing a few easy steps.
