...
############################# Head ############################
head_title: "XPS Sayfaları Java İçinde Döndür – 90, 180, 270 Açıda Döndür"
...
############################# Header ############################
title: "XPS Sayfayı Java İçinde Döndür"
description: "XPS Sayfalarını birkaç satır Java koduyla döndürün."
...
steps:
    enable: true
    title_left: "Java içinde XPS Dosya Sayfalarını Döndür"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir XPS dosyasındaki belirli veya tüm sayfaları 90'da döndürmesini kolaylaştırır , Birkaç kolay adım uygulayarak 180 veya 270 dönüş açısı.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XPS dosya sayfaları nasıl döndürülür">}}
