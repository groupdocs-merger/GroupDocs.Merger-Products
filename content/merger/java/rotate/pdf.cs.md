...
############################# Head ############################
head_title: "Otočit PDF stránky v Java – Otočit v úhlu 90, 180, 270"
...
############################# Header ############################
title: "Otočit PDF stránek v Java"
description: "Otočte PDF stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Otočit PDF stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java otočit některé konkrétní nebo všechny stránky v souboru PDF na 90 , 180 nebo 270 úhel otočení pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak otočit stránky souboru PDF pomocí ukázkového kódu Java">}}
