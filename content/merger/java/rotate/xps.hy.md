...
############################# Head ############################
head_title: "Պտտեցնել XPS էջերը Java-ում – Պտտել 90, 180, 270 անկյան տակ"
head_description: "Պտտեք XPS ֆայլի հատուկ կամ բոլոր փաստաթղթերի էջերը 90, 180, 270 պտտման անկյան տակ՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Պտտեցնել XPS էջ Java-ում"
description: "Պտտեցնել XPS էջերը Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Պտտեցնել XPS ֆայլի էջերը Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար պտտել որոշ կոնկրետ կամ բոլոր էջերը XPS ֆայլում 90-ով: , 180 կամ 270 ռոտացիայի անկյուն՝ կատարելով մի քանի հեշտ քայլեր։
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես պտտել XPS ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Պտտեցնել XPS ֆայլի էջերը՝ օգտագործելով GroupDocs.Merger API-ը
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Պտտեք XPS ֆայլի էջերը առցանց"
    content: |
       Պտտեք XPS ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps) կայքը:
