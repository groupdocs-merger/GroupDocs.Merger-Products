...
############################# Head ############################
head_title: "Rotiți paginile XPS în Java – Rotiți la un unghi de 90, 180, 270"
head_description: "Rotiți anumite pagini de document sau toate paginile unui fișier XPS la un unghi de rotație de 90, 180, 270 folosind API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Rotiți XPS pagini în Java"
description: "Rotiți XPS Pagini cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Rotiți XPS pagini de fișiere în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să rotească anumite pagini sau toate paginile dintr-un fișier XPS la 90 , 180 sau 270 unghi de rotație prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să rotiți pagini de fișiere XPS folosind codul exemplu Java">}}

        ```java    
        // Rotiți pagini de fișiere XPS utilizând API-ul GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live - Rotiți paginile de fișiere XPS online"
    content: |
       Rotiți paginile de fișiere XPS chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps).
