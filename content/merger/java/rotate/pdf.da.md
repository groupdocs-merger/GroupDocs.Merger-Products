...
description: "Roter PDF sider med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at rotere nogle specifikke eller alle sider i en PDF-fil ved 90 , 180 eller 270 rotationsvinkel ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan roteres PDF filsider ved hjælp af Java eksempelkode">}}
