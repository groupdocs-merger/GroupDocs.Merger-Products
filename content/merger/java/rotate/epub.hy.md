...
############################# Head ############################
head_title: "Պտտեցնել EPUB էջերը Java-ում – Պտտել 90, 180, 270 անկյան տակ"
...
############################# Header ############################
title: "Պտտեցնել EPUB էջ Java-ում"
description: "Պտտեցնել EPUB էջերը Java կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Պտտեցնել EPUB ֆայլի էջերը Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար պտտել որոշ կոնկրետ կամ բոլոր էջերը EPUB ֆայլում 90-ով: , 180 կամ 270 ռոտացիայի անկյուն՝ կատարելով մի քանի հեշտ քայլեր։
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես պտտել EPUB ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}
