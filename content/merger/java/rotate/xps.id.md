...
############################# Head ############################
head_title: "Putar halaman XPS dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk memutar halaman XPS. Kelola PDF, dokumen Word, spreadsheet Excel, presentasi PowerPoint, gambar, arsip, dan lainnya dengan solusi kami."

############################# Header ############################
title: "Pemutaran halaman pada XPS" 
description: "GroupDocs.Merger for Java memperluas kemampuan aplikasi Java. Proses dokumen dalam format bisnis populer dengan fitur seperti pemutaran halaman dalam file XPS."
...
steps:
    ...
    content: |
      Dengan [GroupDocs.Merger](/merger/java/), Anda dapat memutar halaman dalam dokumen XPS, meningkatkan kemampuan manajemen dokumen dalam aplikasi Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Putar semua halaman XPS bernomor genap"
      content: |
        Periksa contoh ini yang menunjukkan cara memutar semua halaman bernomor genap dalam dokumen XPS.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
