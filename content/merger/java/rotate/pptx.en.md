...
############################# Head ############################
head_title: "Rotate PPTX pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to rotate any PPTX page. Manage PDFs, Word documents, Excel spreadsheets, PowerPoint presentations, images, archives, and more with our solutions."

############################# Header ############################
title: "Page rotation in PPTX" 
description: "GroupDocs.Merger for Java extends the capabilities of Java applications. Process documents in popular business formats with features like page rotation in PPTX files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/java/), you can rotate pages in PPTX documents, enhancing document management capabilities in Java applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rotate all even-numbered PPTX pages"
      content: |
        Check out this example demonstrating how to rotate all even-numbered pages in a PPTX document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
