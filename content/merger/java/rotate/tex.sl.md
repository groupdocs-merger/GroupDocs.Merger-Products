...
############################# Head ############################
head_title: "Zasukaj TEX strani v Java – zasukaj pod kotom 90, 180, 270"
head_description: "Zavrtite določene ali vse strani dokumenta datoteke TEX pod kotom vrtenja 90, 180, 270 z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zavrti TEX strani v Java"
description: "Zavrtite strani TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zavrti strani datoteke TEX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša vrtenje nekaterih ali vseh strani znotraj datoteke TEX na 90 , kot vrtenja 180 ali 270 z izvedbo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zasukati strani datoteke TEX s primerom kode Java">}}

        ```java    
        // Zasukajte strani datoteke TEX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - zavrtite TEX strani datotek na spletu"
    content: |
       Zasukajte strani datoteke TEX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/tex).
