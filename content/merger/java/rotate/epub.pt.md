...
############################# Head ############################
head_title: "Rotacionar páginas de EPUB em aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para rotacionar qualquer página de EPUB. Gerencie PDFs, documentos do Word, planilhas do Excel, apresentações do PowerPoint, imagens, arquivos e muito mais com nossas soluções."

############################# Header ############################
title: "Rotação de páginas em EPUB" 
description: "GroupDocs.Merger for Java amplia as capacidades das aplicações Java. Processe documentos em formatos de negócios populares com recursos como rotação de páginas em arquivos EPUB."
...
steps:
    ...
    content: |
      Com [GroupDocs.Merger](/merger/java/), você pode rotacionar páginas em documentos de EPUB, aprimorando as capacidades de gestão de documentos em aplicações Java.
      
      1. Especifique o caminho de origem do arquivo EPUB.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rotacione todas as páginas pares de EPUB"
      content: |
        Confira este exemplo demonstrando como rotacionar todas as páginas pares em um documento de EPUB.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
