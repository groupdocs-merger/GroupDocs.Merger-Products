...
############################# Head ############################
head_title: "Pagriezt PDF lapas Java — pagriezt 90, 180, 270 leņķī"
...
############################# Header ############################
title: "Pagriezt PDF lapas programmā Java"
description: "Pagrieziet PDF lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Pagriezt PDF faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli pagriezt dažas konkrētas vai visas lapas PDF failā ar 90 , 180 vai 270 griešanās leņķis, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pagriezt PDF faila lapas, izmantojot Java piemēra kodu">}}
