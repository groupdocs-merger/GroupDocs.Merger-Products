...
############################# Head ############################
head_title: "หมุน TEX หน้าใน Java – หมุนที่มุม 90, 180, 270"
head_description: "หมุนหน้าเอกสารเฉพาะหรือทั้งหมดของไฟล์ TEX ที่มุมการหมุน 90, 180, 270 โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "หมุน TEX หน้าใน Java"
description: "หมุน TEX หน้าด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "หมุนหน้าไฟล์ TEX ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ช่วยให้นักพัฒนา Java สามารถหมุนเวียนบางหน้าหรือบางหน้าภายในไฟล์ TEX ที่ 90 ได้ง่าย , มุมการหมุน 180 หรือ 270 โดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีหมุนหน้าไฟล์ TEX โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // หมุนหน้าไฟล์ TEX โดยใช้ GroupDocs.Merger API
...
demos:
    enable: true
    title: "การสาธิตสด - หมุนหน้าไฟล์ TEX ออนไลน์"
    content: |
       หมุนหน้าไฟล์ TEX ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/tex)
