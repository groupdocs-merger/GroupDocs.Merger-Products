...
############################# Head ############################
head_title: "Ruota PDF pagine in Java – Ruota ad angolo di 90, 180, 270"
...
############################# Header ############################
title: "Ruota PDF pagine in Java"
description: "Ruota PDF pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Ruota PDF pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di ruotare facilmente alcune pagine specifiche o tutte all'interno di un file PDF a 90 , angolo di rotazione 180 o 270 implementando pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come ruotare le pagine dei file PDF utilizzando il codice di esempio Java">}}
