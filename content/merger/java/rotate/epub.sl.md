...
############################# Head ############################
head_title: "Zasukaj EPUB strani v Java – zasukaj pod kotom 90, 180, 270"
...
############################# Header ############################
title: "Zavrti EPUB strani v Java"
description: "Zavrtite strani EPUB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zavrti strani datoteke EPUB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša vrtenje nekaterih ali vseh strani znotraj datoteke EPUB na 90 , kot vrtenja 180 ali 270 z izvedbo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zasukati strani datoteke EPUB s primerom kode Java">}}
