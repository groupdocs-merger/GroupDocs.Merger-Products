...
############################# Head ############################
head_title: "Draai XPS Pagina's in Java - Draai in een hoek van 90, 180, 270"
head_description: "Roteer specifieke of alle documentpagina's van een XPS bestand met een rotatiehoek van 90, 180, 270 met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Draai XPS pagina's in Java"
description: "Roteer XPS pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Draai XPS Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om bepaalde of alle pagina's binnen een XPS bestand op 90 te roteren , 180 of 270 draaihoek door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XPS bestandspagina's te roteren met behulp van Java voorbeeldcode">}}

        ```java    
        // Draai XPS bestandspagina's met de GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live demo's - Draai XPS Bestandspagina's online"
    content: |
       Roteer XPS bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/xps) te gaan.
