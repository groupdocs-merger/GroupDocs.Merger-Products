...
############################# Head ############################
head_title: "Faire pivoter EPUB Pages dans Java - Faire pivoter à 90, 180, 270 Angle"
...
############################# Header ############################
title: "Faire pivoter EPUB pages dans Java"
description: "Faites pivoter les pages EPUB avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Faire pivoter EPUB pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de faire pivoter facilement certaines pages ou toutes les pages d'un fichier EPUB à 90 , 180 ou 270 angle de rotation en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment faire pivoter les pages de fichiers EPUB à l'aide de l'exemple de code Java">}}
