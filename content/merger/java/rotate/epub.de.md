...
############################# Head ############################
head_title: "Drehe EPUB Seiten in Java – Drehe um 90, 180, 270 Winkel"
...
############################# Header ############################
title: "Drehe EPUB Seiten in Java"
description: "Drehen Sie EPUB-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Drehe EPUB Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Entwicklern von Java leicht, einige bestimmte oder alle Seiten innerhalb einer EPUB-Datei um 90 zu rotieren , 180 oder 270 Drehwinkel, indem Sie ein paar einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So drehen Sie EPUB-Dateiseiten mit Java-Beispielcode">}}
