...
############################# Head ############################
head_title: "Otočit EPUB stránky v Java – Otočit v úhlu 90, 180, 270"
...
############################# Header ############################
title: "Otočit EPUB stránek v Java"
description: "Otočte EPUB stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Otočit EPUB stránek souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java otočit některé konkrétní nebo všechny stránky v souboru EPUB na 90 , 180 nebo 270 úhel otočení pomocí několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak otočit stránky souboru EPUB pomocí ukázkového kódu Java">}}
