...
############################# Head ############################
head_title: "Xoay PDF Trang trong Java - Xoay ở các góc 90, 180, 270"
...
############################# Header ############################
title: "Xoay PDF Trang trong Java"
description: "Xoay các trang PDF với một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Xoay PDF Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng xoay một số trang cụ thể hoặc tất cả các trang trong tệp PDF ở 90 , Góc quay 180 hoặc 270 bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xoay các trang tệp PDF bằng mã mẫu Java">}}
