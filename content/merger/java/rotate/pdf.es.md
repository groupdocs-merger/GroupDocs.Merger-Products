...
############################# Head ############################
head_title: "Girar páginas de PDF en aplicaciones Java"
head_description: "Utiliza GroupDocs.Merger for Java para girar cualquier página de PDF. Gestiona PDFs, documentos de Word, hojas de cálculo de Excel, presentaciones de PowerPoint, imágenes, archivos y más con nuestras soluciones."

############################# Header ############################
title: "Rotación de páginas en PDF" 
description: "GroupDocs.Merger for Java amplía las capacidades de las aplicaciones Java. Procesa documentos en formatos comerciales populares con características como la rotación de páginas en archivos PDF."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/java/), puedes girar páginas en documentos PDF, mejorando las capacidades de gestión de documentos en aplicaciones Java.
      
      1. Especifica la ruta del archivo PDF de origen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gira todas las páginas pares de PDF"
      content: |
        Consulta este ejemplo que demuestra cómo girar todas las páginas pares en un documento PDF.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
