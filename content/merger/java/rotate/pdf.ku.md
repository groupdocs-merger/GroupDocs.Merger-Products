...
############################# Head ############################
head_title: "Bizivire PDF Rûpelên di Java de - Bi 90, 180, 270 Goşeyê Bizivire"
...
############################# Header ############################
title: "Rûpelên PDF Di Java de bizivirin"
...
steps:
    enable: true
    title_left: "Di Java de Rûpelên Pelê PDF bizivirîne"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku hin rûpelan an hemî rûpelan di nav pelek PDF de di 90 de bizivirînin. , 180 an 270 goşeya zivirandinê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi karanîna koda nimûneya Java rûpelên pelê PDF dizivire">}}
