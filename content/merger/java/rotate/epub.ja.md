...
############################# Head ############################
head_title: "JavaアプリでのEPUBページの回転"
head_description: "GroupDocs.Merger for Javaを使用して、任意のEPUBページを回転させます。PDF、Word文書、Excelスプレッドシート、PowerPointプレゼンテーション、画像、アーカイブなどを管理できるソリューションです。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)を使用して、EPUB文書のページを回転させ、Javaアプリケーションでのドキュメント管理機能を向上させます。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "すべての偶数番号のEPUBページを回転"
      content: |
        この例では、EPUB文書内のすべての偶数番号のページを回転する方法を示しています。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
