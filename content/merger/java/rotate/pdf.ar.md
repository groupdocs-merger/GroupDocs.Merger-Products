...
############################# Head ############################
head_title: "تدوير الصفحات PDF في Java - تدوير بزاوية 90 و 180 و 270"
...
############################# Header ############################
title: "تدوير الصفحات PDF في Java"
description: "تدوير الصفحات PDF ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تدوير صفحات الملفات PDF في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تدوير بعض الصفحات المحددة أو جميعها داخل ملف PDF عند 90 180 أو 270 زاوية دوران من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تدوير صفحات ملف PDF باستخدام كود مثال Java">}}
