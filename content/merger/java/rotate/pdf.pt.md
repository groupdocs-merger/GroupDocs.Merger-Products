...
############################# Head ############################
head_title: "Rotacionar páginas de PDF em aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para rotacionar qualquer página de PDF. Gerencie PDFs, documentos do Word, planilhas do Excel, apresentações do PowerPoint, imagens, arquivos e muito mais com nossas soluções."

############################# Header ############################
title: "Rotação de páginas em PDF" 
description: "GroupDocs.Merger for Java amplia as capacidades das aplicações Java. Processe documentos em formatos de negócios populares com recursos como rotação de páginas em arquivos PDF."
...
steps:
    ...
    content: |
      Com [GroupDocs.Merger](/merger/java/), você pode rotacionar páginas em documentos de PDF, aprimorando as capacidades de gestão de documentos em aplicações Java.
      
      1. Especifique o caminho de origem do arquivo PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rotacione todas as páginas pares de PDF"
      content: |
        Confira este exemplo demonstrando como rotacionar todas as páginas pares em um documento de PDF.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
