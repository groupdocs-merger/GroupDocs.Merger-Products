...
############################# Head ############################
head_title: "Обертати EPUB сторінки в Java – повертати на 90, 180, 270 кут"
...
############################# Header ############################
title: "Обертати EPUB сторінки на Java"
description: "Поверніть EPUB сторінки з кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Обертати EPUB сторінки файлів у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) дозволяє розробникам Java легко обертати окремі або всі сторінки у файлі EPUB на 90 , кут повороту 180 або 270, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як обертати сторінки файлу EPUB за допомогою прикладу коду Java">}}
