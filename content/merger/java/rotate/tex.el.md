...
############################# Head ############################
head_title: "Περιστροφή σελίδων TEX σε Java – Περιστροφή σε γωνία 90, 180, 270"
head_description: "Περιστρέψτε συγκεκριμένες ή όλες τις σελίδες εγγράφου ενός αρχείου TEX σε γωνία περιστροφής 90, 180, 270 χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Περιστροφή TEX σελίδων σε Java"
description: "Περιστρέψτε TEX σελίδες με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Περιστροφή TEX σελίδων αρχείου στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να περιστρέψουν ορισμένες συγκεκριμένες ή όλες τις σελίδες σε ένα αρχείο TEX στα 90 , γωνία περιστροφής 180 ή 270 εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Τρόπος περιστροφής σελίδων αρχείου TEX χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Περιστρέψτε TEX σελίδες αρχείου χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Περιστροφή TEX σελίδων αρχείων στο Διαδίκτυο"
    content: |
       Περιστρέψτε σελίδες αρχείου TEX αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/tex).
