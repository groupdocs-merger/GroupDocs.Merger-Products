...
############################# Head ############################
head_title: "Girar EPUB páginas en Java: girar en ángulo de 90, 180, 270"
head_description: "Gire páginas de documentos específicas o todas de un archivo EPUB en un ángulo de rotación de 90, 180, 270 usando la API de fusión de documentos."

############################# Header ############################
title: "Rotar EPUB páginas en Java"
description: "Gire EPUB páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Rotar EPUB páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java rotar algunas páginas específicas o todas dentro de un archivo EPUB en 90 , 180 o 270 ángulo de rotación mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo rotar las páginas del archivo EPUB usando el código de ejemplo Java">}}

        ```java    
        // Rotar EPUB páginas de archivos usando GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demostraciones en vivo - Rotar EPUB páginas de archivos en línea"
    content: |
       Gire las páginas de archivos EPUB ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/epub).
