...
description: "Roter TEX sider med noen få linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å rotere noen spesifikke eller alle sider i en TEX-fil ved 90 , 180 eller 270 rotasjonsvinkel ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan rotere TEX filsider ved å bruke Java eksempelkode">}}
