...
############################# Head ############################
head_title: "Otočiť EPUB strán v Java – Otočiť o uhol 90, 180, 270"
...
############################# Header ############################
title: "Otočiť EPUB strán v Java"
description: "Otočte EPUB stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Otočte EPUB strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java otáčať niektoré konkrétne alebo všetky stránky v súbore EPUB o 90° , 180 alebo 270 uhol otáčania vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako otočiť EPUB strán súboru pomocou Java vzorového kódu">}}
