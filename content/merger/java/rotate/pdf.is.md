...
############################# Head ############################
head_title: "Snúa PDF síðum í Java – Snúa í 90, 180, 270 horn"
head_description: "Snúðu tilteknum eða öllum skjalasíðum í PDF skrá með 90, 180, 270 snúningshorni með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Snúa PDF síðum í Java"
description: "Snúðu PDF síðum með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Snúa PDF skráarsíðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að snúa einhverjum ákveðnum eða öllum síðum innan PDF skráar í 90 , 180 eða 270 snúningshorn með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að snúa PDF skráarsíðum með því að nota Java dæmikóða">}}

        ```java    
        // Snúðu PDF skráarsíðum með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Snúa PDF skráarsíðum á netinu"
    content: |
       Snúðu PDF skráarsíðum núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/pdf) vefsíðu.
