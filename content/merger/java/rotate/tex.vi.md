...
############################# Head ############################
head_title: "Xoay TEX Trang trong Java - Xoay ở các góc 90, 180, 270"
head_description: "Xoay các trang tài liệu cụ thể hoặc tất cả các trang của tệp TEX ở góc xoay 90, 180, 270 bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xoay TEX Trang trong Java"
description: "Xoay các trang TEX với một vài dòng mã Java."
...
about:
    ...
    content: |
        ...
        API GroupDocs.Merger là một lựa chọn đúng đắn cho các giải pháp công ty cần các tính năng xoay trang tệp. Các API này được hỗ trợ tốt trên tất cả các hệ điều hành và nền tảng chính bao gồm J2SE 7.0 (1.7), J2SE 8.0 (1.8), Java 10.

############################# Steps ############################
steps:
    enable: true
    title_left: "Xoay TEX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng xoay một số trang cụ thể hoặc tất cả các trang trong tệp TEX ở 90 , Góc quay 180 hoặc 270 bằng cách thực hiện một vài bước đơn giản.
        ...
        * Gọi ** xoayPages ** và chuyển đối tượng ** RotateOptions **.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xoay các trang tệp TEX bằng mã mẫu Java">}}

        ```java    
        // Xoay các trang tệp TEX bằng API GroupDocs.Merger
        ...
        // Gọi phương thức RotPages và chuyển đối tượng RotateOptions cho nó
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Xoay vòng TEX Trang Tệp Trực tuyến"
    content: |
       Xoay vòng các trang tệp TEX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/tex) trang web.
...
more_formats:
    ...
    content: |
        Java tài liệu API tách và sáp nhập cho các định dạng tệp và hình ảnh. Xoay một số định dạng tệp phổ biến như được nêu bên dưới.
