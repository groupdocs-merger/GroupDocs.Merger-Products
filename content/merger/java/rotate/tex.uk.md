...
############################# Head ############################
head_title: "Обертати TEX сторінки в Java – повертати на 90, 180, 270 кут"
...
############################# Header ############################
title: "Обертати TEX сторінки на Java"
description: "Поверніть TEX сторінки з кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Обертати TEX сторінки файлів у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) дозволяє розробникам Java легко обертати окремі або всі сторінки у файлі TEX на 90 , кут повороту 180 або 270, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як обертати сторінки файлу TEX за допомогою прикладу коду Java">}}
