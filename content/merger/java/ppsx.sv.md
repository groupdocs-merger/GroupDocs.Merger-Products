...
############################# Head ############################
head_title: "Slå samman PPSX filer via Java & J2SE Documents Merger API"
head_description: "Slå samman flera PPSX-filer i Java med hjälp av Documents Merger API med all data, stil och formatering som källdokument."

############################# Header ############################
title: "PPSX sammanslagning i Java"
description: "Slå samman PPSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Slå samman flera PPSX-filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att slå samman flera PPSX-filer genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar PPSX filer med hjälp av Java exempelkod">}}

        ```java    
        // Slå samman PPSX-filer med GroupDocs.Merger för Java API
