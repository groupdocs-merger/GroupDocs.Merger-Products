...
############################# Head ############################
head_title: "Slå sammen VSX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VSX sammenslåing i Java"
description: "Slå sammen VSX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VSX filer med GroupDocs.Merger for Java API
