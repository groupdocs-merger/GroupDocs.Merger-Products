...
############################# Head ############################
head_title: "Sujunkite TSV failus naudodami Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "TSV Susijungimas Java"
description: "Sujunkite TSV su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis TSV failus Java"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną TSV failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) svetainėje.
