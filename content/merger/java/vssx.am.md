...
############################# Head ############################
head_title: "VSSX ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ አዋህድ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ VSSX ፋይሎችን በጃቫ ውስጥ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "የVSSX ውህደት በJava"
description: "VSSXን ከጥቂት የJava ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ VSSX ፋይሎችን አዋህድ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ VSSX ፋይሎችን ማዋሃድ ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም VSSX ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም VSSX ፋይሎችን አዋህድ
