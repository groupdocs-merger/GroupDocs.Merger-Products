...
############################# Head ############################
head_title: "Java және J2SE Documents Merger API арқылы VSTM файлдарды біріктіріңіз"
head_description: "Java тіліндегі бірнеше VSTM файлдарды бастапқы құжаттар ретінде барлық деректермен, мәнерлермен және пішімдеумен бірге құжаттарды біріктіру API арқылы біріктіріңіз."

############################# Header ############################
title: "VSTM Біріктіру Java"
description: "VSTM кодының бірнеше жолын Java кодымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Java ішінде бірнеше VSTM файлдарды біріктіру"
    content_left: |
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) веб-сайтына кіру арқылы бірден көп VSTM файлдарды біріктіріңіз.
