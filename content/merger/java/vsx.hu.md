...
############################# Head ############################
head_title: "Egyesítse az VSX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSX Egyesülés a Java programban"
description: "Egyesítse a(z) VSX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSX fájlokat a GroupDocs.Merger for Java API segítségével
