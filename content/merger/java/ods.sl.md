...
############################# Head ############################
head_title: "Spoji datoteke ODS prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek ODS v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "ODS Združitev v Java"
description: "Spojite ODS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek ODS v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODS s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke ODS z API-jem GroupDocs.Merger for Java
