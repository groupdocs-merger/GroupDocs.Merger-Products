...
############################# Head ############################
head_title: "Flet XLT filer via Java & J2SE Documents Merger API"
head_description: "Flet flere XLT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "XLT fusion i Java"
description: "Flet XLT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere XLT filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere XLT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet XLT filer ved hjælp af GroupDocs.Merger for Java API
