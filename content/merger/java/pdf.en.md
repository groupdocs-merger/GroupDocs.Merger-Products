...
############################# Head ############################
head_title: "Merge PDF files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate PDF document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge PDF files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage PDF documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of PDF documents. Enhance your Java applications by combining multiple files into one.
