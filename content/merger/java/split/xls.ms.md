...
############################# Head ############################
head_title: "Pisahkan XLS kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLS kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLS Pemisah Dalam Java"
description: "Pisahkan XLS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLS Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLS menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLS menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLS Fail Dalam Talian"
    content: |
       Pisahkan fail XLS sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls).
