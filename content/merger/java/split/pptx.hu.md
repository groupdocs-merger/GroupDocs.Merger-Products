...
############################# Head ############################
head_title: "A(z) PPTX felosztása több fájlra a Java programban"
head_description: "Egyetlen PPTX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPTX Splitter in Java"
description: "Oszd fel az PPTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) PPTX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen PPTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az PPTX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az PPTX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split PPTX fájl online"
    content: |
       Ossza meg az PPTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) webhely meglátogatásával.
