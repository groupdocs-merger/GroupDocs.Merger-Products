...
############################# Head ############################
head_title: "Divida PPS em vários arquivos em Java"
...
############################# Header ############################
title: "PPS Divisor em Java"
description: "Divida PPS com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir PPS arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo PPS em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo PPS usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo PPS usando GroupDocs.Merger for Java API
