...
############################# Head ############################
head_title: "Podziel VTX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VTX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VTX Rozdzielacz w Java"
description: "Podziel VTX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VTX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VTX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VTX online"
    content: |
       Podziel plik VTX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx).
