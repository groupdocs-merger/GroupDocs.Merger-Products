...
############################# Head ############################
head_title: "Rozdělit XLT do více souborů v Java"
...
description: "Rozdělte XLT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit XLT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru XLT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor XLT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor XLT pomocí GroupDocs.Merger for Java API
