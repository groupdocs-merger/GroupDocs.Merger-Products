...
############################# Head ############################
head_title: "Podijeli PPT u više datoteka u Java"
head_description: "Podijelite jednu PPT datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "PPT Splitter u Java"
description: "Podijelite PPT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli PPT datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne PPT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPT datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli PPT datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split PPT datoteka na mreži"
    content: |
       Podijeli PPT datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt) web mjesto.
