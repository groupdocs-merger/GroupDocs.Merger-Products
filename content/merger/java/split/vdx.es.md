...
############################# Head ############################
head_title: "Dividir VDX en varios archivos en Java"
...
############################# Header ############################
title: "VDX Divisor en Java"
description: "Divida VDX con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir VDX archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo VDX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo VDX usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo VDX usando GroupDocs.Merger para la API de Java
