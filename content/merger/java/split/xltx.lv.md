...
############################# Head ############################
head_title: "Sadaliet XLTX vairākos failos programmā Java"
head_description: "Sadaliet vienu XLTX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLTX sadalītājs programmā Java"
description: "Sadaliet XLTX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLTX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLTX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLTX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLTX failu tiešsaistē"
    content: |
       Sadaliet XLTX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
