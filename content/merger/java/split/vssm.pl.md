...
############################# Head ############################
head_title: "Podziel VSSM na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSSM na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSSM Rozdzielacz w Java"
description: "Podziel VSSM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSSM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSSM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSSM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSSM za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSSM online"
    content: |
       Podziel plik VSSM już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
