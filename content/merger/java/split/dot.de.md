...
############################# Head ############################
head_title: "Teilen Sie DOT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne DOT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "DOT Splittereingang Java"
description: "Teilen Sie DOT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "DOT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne DOT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die DOT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // DOT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - DOT-Datei online teilen"
    content: |
       Teilen Sie die Datei DOT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) besuchen.
