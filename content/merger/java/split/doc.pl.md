...
############################# Head ############################
head_title: "Podziel DOC na wiele plików w Java"
head_description: "Podziel pojedynczy plik DOC na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "DOC Rozdzielacz w Java"
description: "Podziel DOC z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik DOC według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku DOC na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik DOC za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik DOC za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik DOC online"
    content: |
       Podziel plik DOC już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
