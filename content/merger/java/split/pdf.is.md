...
############################# Head ############################
head_title: "Skiptu PDF í margar skrár í Java"
head_description: "Skiptu einni PDF skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "PDF Skerandi í Java"
description: "Skiptu PDF með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu PDF skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni PDF skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PDF skrá með Java dæmi kóða">}}
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu PDF skrá á netinu"
    content: |
       Skiptu PDF skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) vefsíðu.
