...
############################# Head ############################
head_title: "Teilen Sie MHT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne MHT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "MHT Splittereingang Java"
description: "Teilen Sie MHT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "MHT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne MHT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die MHT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // MHT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - MHT-Datei online teilen"
    content: |
       Teilen Sie die Datei MHT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht) besuchen.
