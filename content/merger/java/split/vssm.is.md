...
############################# Head ############################
head_title: "Skiptu VSSM í margar skrár í Java"
head_description: "Skiptu einni VSSM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSSM Skerandi í Java"
description: "Skiptu VSSM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSSM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSSM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSSM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSSM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSSM skrá á netinu"
    content: |
       Skiptu VSSM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) vefsíðu.
