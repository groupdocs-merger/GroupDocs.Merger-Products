...
############################# Head ############################
head_title: "Split EXCEL documents in Java apps"
head_description: "Use GroupDocs.Merger for Java to split EXCEL files into separate documents. Manage PDFs, Word files, Excel sheets, PowerPoint slides, Visio files, images, archives, and more with ease."

############################# Header ############################
title: "Split EXCEL files" 
description: "GroupDocs.Merger for Java enhances Java applications by adding advanced document processing features. Easily split EXCEL files and work with a variety of popular business formats."
...
steps:
    enable: true
    title: "How to split EXCEL files"
    content: |
      With [GroupDocs.Merger](/merger/java/), you can split EXCEL documents and save selected pages as a new file. Integrate advanced document management into your Java applications.
      
      1. Provide the source path of the EXCEL file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Split EXCEL document and save even-numbered pages"
      content: |
        This example demonstrates how to split a EXCEL document and save all even-numbered pages as a separate file.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
