...
############################# Head ############################
head_title: "Padalinkite OTP į kelis failus Java"
head_description: "Padalinkite vieną OTP failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "OTP skirstytuvas Java"
description: "Padalinkite OTP keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite OTP failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną OTP failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti OTP failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite OTP failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite OTP failą internete"
    content: |
       Padalykite OTP failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) svetainėje.
