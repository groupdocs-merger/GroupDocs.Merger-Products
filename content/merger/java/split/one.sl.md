...
############################# Head ############################
head_title: "Razdeli ONE na več datotek v Java"
head_description: "Eno datoteko ONE razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "ONE razdelilnik v Java"
description: "Razdelite ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko ONE po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke ONE na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko ONE s primerom kode Java">}}

        ```java    
        // Razdeli datoteko ONE z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli ONE datoteko na spletu"
    content: |
       Takoj razdelite datoteko ONE tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
