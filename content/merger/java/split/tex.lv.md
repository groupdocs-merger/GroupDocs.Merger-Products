...
############################# Head ############################
head_title: "Sadaliet TEX vairākos failos programmā Java"
head_description: "Sadaliet vienu TEX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "TEX sadalītājs programmā Java"
description: "Sadaliet TEX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TEX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu TEX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TEX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet TEX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt TEX failu tiešsaistē"
    content: |
       Sadaliet TEX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
