...
############################# Head ############################
head_title: "Rozdělit OTT do více souborů v Java"
head_description: "Rozdělte jeden soubor OTT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "OTT Splitter v Java"
description: "Rozdělte OTT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit OTT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru OTT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor OTT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor OTT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru OTT online"
    content: |
       Rozdělte soubor OTT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott).
