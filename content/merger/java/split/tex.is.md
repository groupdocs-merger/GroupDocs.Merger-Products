...
############################# Head ############################
head_title: "Skiptu TEX í margar skrár í Java"
head_description: "Skiptu einni TEX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "TEX Skerandi í Java"
description: "Skiptu TEX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu TEX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni TEX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta TEX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu TEX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu TEX skrá á netinu"
    content: |
       Skiptu TEX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) vefsíðu.
