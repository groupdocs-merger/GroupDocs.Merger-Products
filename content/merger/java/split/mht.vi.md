...
############################# Head ############################
head_title: "Tách MHT thành nhiều tệp trong Java"
...
############################# Header ############################
title: "MHT Splitter trong Java"
description: "Tách MHT bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp MHT theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp MHT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp MHT bằng mã mẫu Java">}}

        ```java    
        // Tách tệp MHT bằng GroupDocs.Merger cho Java API
