...
############################# Head ############################
head_title: "EPUB'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir EPUB dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "EPUB Ayırıcı Java"
description: "EPUB kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "EPUB Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak EPUB dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak EPUB dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - EPUB Dosyasını Çevrimiçi Böl"
    content: |
       EPUB dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) web sitesini ziyaret ederek bölün.
