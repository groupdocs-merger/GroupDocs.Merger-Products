...
############################# Head ############################
head_title: "Jaa VSX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VSX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VSX Jakaja sisään Java"
description: "Jaa VSX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VSX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VSX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VSX tiedosto verkossa"
    content: |
       Jaa tiedosto VSX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx) -sivustolla.
