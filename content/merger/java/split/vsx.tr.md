...
############################# Head ############################
head_title: "VSX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VSX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VSX Ayırıcı Java"
description: "VSX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VSX Dosyasını Çevrimiçi Böl"
    content: |
       VSX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx) web sitesini ziyaret ederek bölün.
