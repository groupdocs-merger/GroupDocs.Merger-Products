...
############################# Head ############################
head_title: "Verdeel XLSB in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLSB-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLSB Splitter in Java"
description: "Verdeel XLSB met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSB lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLSB-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSB-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLSB lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLSB lêer aanlyn"
    content: |
       Verdeel XLSB-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) webwerf te besoek.
