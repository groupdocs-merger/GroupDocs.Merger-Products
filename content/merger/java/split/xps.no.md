...
############################# Head ############################
head_title: "Del XPS i flere filer i Java"
head_description: "Del en enkelt XPS-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "XPS splitter i Java"
description: "Del XPS med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del XPS-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt XPS-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XPS-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del XPS-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del XPS-fil på nett"
    content: |
       Del opp XPS-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps).
