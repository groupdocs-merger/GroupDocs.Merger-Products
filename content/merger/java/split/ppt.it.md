...
############################# Head ############################
head_title: "Dividi PPT in più file in Java"
head_description: "Dividi un singolo file PPT in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "PPT Separatore in Java"
description: "Dividi PPT con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file PPT per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file PPT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file PPT utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file PPT utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file PPT online"
    content: |
       Dividi subito il file PPT visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
