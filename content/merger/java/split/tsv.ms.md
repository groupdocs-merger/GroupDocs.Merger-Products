...
############################# Head ############################
head_title: "Pisahkan TSV kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail TSV kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "TSV Pemisah Dalam Java"
description: "Pisahkan TSV dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan TSV Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail TSV kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail TSV menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail TSV menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split TSV Fail Dalam Talian"
    content: |
       Pisahkan fail TSV sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
