...
############################# Header ############################
title: "XLSX Pemisah Di Java"
description: "Pisahkan XLSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLSX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLSX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file XLSX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file XLSX menggunakan GroupDocs.Merger untuk Java API
