...
head_title: "Pisahkan XLSX menjadi Beberapa File di Java"
head_description: "Pengguna Java untuk membagi satu file XLSX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Pisahkan XLSX Menjadi Beberapa File di Java"
description: "Pisahkan satu file XLSX menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Pisahkan File XLSX Dengan Halaman di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLSX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
