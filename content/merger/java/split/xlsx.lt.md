...
############################# Head ############################
head_title: "Padalinkite XLSX į kelis failus Java"
head_description: "Padalinkite vieną XLSX failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "XLSX skirstytuvas Java"
description: "Padalinkite XLSX keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLSX failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XLSX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLSX failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XLSX failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite XLSX failą internete"
    content: |
       Padalykite XLSX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) svetainėje.
