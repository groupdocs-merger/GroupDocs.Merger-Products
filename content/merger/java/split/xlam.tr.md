...
############################# Head ############################
head_title: "XLAM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLAM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLAM Ayırıcı Java"
description: "XLAM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLAM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLAM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLAM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLAM Dosyasını Çevrimiçi Böl"
    content: |
       XLAM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) web sitesini ziyaret ederek bölün.
