...
############################# Head ############################
head_title: "Podziel CSV na wiele plików w Java"
head_description: "Podziel pojedynczy plik CSV na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "CSV Rozdzielacz w Java"
description: "Podziel CSV z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik CSV według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku CSV na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik CSV za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik CSV za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik CSV online"
    content: |
       Podziel plik CSV już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
