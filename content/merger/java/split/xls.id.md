...
head_description: "Pisahkan satu file XLS menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLS Pemisah Di Java"
description: "Pisahkan XLS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLS File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLS menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file XLS menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file XLS menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan XLS File Online"
    content: |
       Pisahkan file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/xls).
