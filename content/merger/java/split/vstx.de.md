...
############################# Head ############################
head_title: "Teilen Sie VSTX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VSTX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VSTX Splittereingang Java"
description: "Teilen Sie VSTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VSTX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VSTX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VSTX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VSTX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VSTX-Datei online teilen"
    content: |
       Teilen Sie die Datei VSTX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) besuchen.
