...
############################# Head ############################
head_title: "Teilen Sie IMAGE in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne IMAGE-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "IMAGE Splittereingang Java"
description: "Teilen Sie IMAGE mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "IMAGE-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne IMAGE-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die IMAGE-Datei mit dem Java-Beispielcode">}}

        ```java    
        // IMAGE-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - IMAGE-Datei online teilen"
    content: |
       Teilen Sie die Datei IMAGE jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/image) besuchen.
