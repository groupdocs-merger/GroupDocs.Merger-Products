...
############################# Head ############################
head_title: "Jagage PPS mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail PPS mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "PPS Splitter in Java"
description: "Tükeldage PPS mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPS fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks PPS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili PPS, kasutades Java näidet">}}

        ```java    
        // Jagage fail PPS, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – PPS faili jagamine võrgus"
    content: |
       Tükeldage fail PPS kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps).
