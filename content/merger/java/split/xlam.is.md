...
############################# Head ############################
head_title: "Skiptu XLAM í margar skrár í Java"
head_description: "Skiptu einni XLAM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XLAM Skerandi í Java"
description: "Skiptu XLAM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLAM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLAM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLAM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLAM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XLAM skrá á netinu"
    content: |
       Skiptu XLAM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) vefsíðu.
