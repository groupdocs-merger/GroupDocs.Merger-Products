...
############################# Head ############################
head_title: "Splits PDF in meerdere bestanden in Java"
...
description: "Splits PDF met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits PDF bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel PDF bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een PDF bestand te splitsen met behulp van Java voorbeeldcode">}}
