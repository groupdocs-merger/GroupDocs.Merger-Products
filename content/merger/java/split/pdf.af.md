...
############################# Head ############################
head_title: "Verdeel PDF in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele PDF-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "PDF Splitter in Java"
description: "Verdeel PDF met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel PDF lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele PDF-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PDF-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel PDF lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel PDF lêer aanlyn"
    content: |
       Verdeel PDF-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) webwerf te besoek.
