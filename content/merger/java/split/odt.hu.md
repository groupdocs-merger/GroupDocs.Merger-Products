...
############################# Head ############################
head_title: "A(z) ODT felosztása több fájlra a Java programban"
head_description: "Egyetlen ODT fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODT Splitter in Java"
description: "Oszd fel az ODT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) ODT fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen ODT fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az ODT fájl felosztása a Java példakóddal">}}

        ```java    
        // Az ODT fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split ODT fájl online"
    content: |
       Ossza meg az ODT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) webhely meglátogatásával.
