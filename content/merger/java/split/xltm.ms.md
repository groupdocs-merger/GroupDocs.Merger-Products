...
############################# Head ############################
head_title: "Pisahkan XLTM kepada Berbilang Fail dalam Java"
...
############################# Header ############################
title: "XLTM Pemisah Dalam Java"
description: "Pisahkan XLTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLTM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLTM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLTM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLTM menggunakan GroupDocs.Merger untuk Java API
