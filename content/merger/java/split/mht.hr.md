...
############################# Head ############################
head_title: "Podijeli MHT u više datoteka u Java"
head_description: "Podijelite jednu MHT datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "MHT Splitter u Java"
description: "Podijelite MHT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli MHT datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne MHT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti MHT datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli MHT datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split MHT datoteka na mreži"
    content: |
       Podijeli MHT datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht) web mjesto.
