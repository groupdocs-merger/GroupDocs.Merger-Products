...
head_description: "Pisahkan satu file IMAGE menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "IMAGE Pemisah Di Java"
description: "Pisahkan IMAGE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan IMAGE File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file IMAGE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file IMAGE menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file IMAGE menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan IMAGE File Online"
    content: |
       Pisahkan file IMAGE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/image).
