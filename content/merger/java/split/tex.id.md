...
head_description: "Pisahkan satu file TEX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "TEX Pemisah Di Java"
description: "Pisahkan TEX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan TEX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file TEX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file TEX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file TEX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan TEX File Online"
    content: |
       Pisahkan file TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/tex).
