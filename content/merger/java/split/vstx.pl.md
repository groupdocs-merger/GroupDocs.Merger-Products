...
############################# Head ############################
head_title: "Podziel VSTX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSTX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSTX Rozdzielacz w Java"
description: "Podziel VSTX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSTX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSTX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSTX online"
    content: |
       Podziel plik VSTX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx).
