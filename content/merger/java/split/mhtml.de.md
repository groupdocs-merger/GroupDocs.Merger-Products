...
############################# Head ############################
head_title: "Teilen Sie MHTML in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne MHTML-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "MHTML Splittereingang Java"
description: "Teilen Sie MHTML mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "MHTML-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne MHTML-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die MHTML-Datei mit dem Java-Beispielcode">}}

        ```java    
        // MHTML-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - MHTML-Datei online teilen"
    content: |
       Teilen Sie die Datei MHTML jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml) besuchen.
