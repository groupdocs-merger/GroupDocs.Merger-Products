...
############################# Head ############################
head_title: "Padalinkite VSTX į kelis failus Java"
head_description: "Padalinkite vieną VSTX failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "VSTX skirstytuvas Java"
description: "Padalinkite VSTX keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSTX failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną VSTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSTX failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite VSTX failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite VSTX failą internete"
    content: |
       Padalykite VSTX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) svetainėje.
