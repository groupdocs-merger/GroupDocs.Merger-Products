...
head_description: "Pisahkan satu file WORD menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "WORD Pemisah Di Java"
description: "Pisahkan WORD dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan WORD File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file WORD menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file WORD menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file WORD menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan WORD File Online"
    content: |
       Pisahkan file WORD sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/word).
