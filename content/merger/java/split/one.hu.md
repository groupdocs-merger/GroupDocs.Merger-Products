...
############################# Head ############################
head_title: "A(z) ONE felosztása több fájlra a Java programban"
head_description: "Egyetlen ONE fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ONE Splitter in Java"
description: "Oszd fel az ONE elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) ONE fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen ONE fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az ONE fájl felosztása a Java példakóddal">}}

        ```java    
        // Az ONE fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split ONE fájl online"
    content: |
       Ossza meg az ONE fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) webhely meglátogatásával.
