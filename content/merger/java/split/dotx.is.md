...
############################# Head ############################
head_title: "Skiptu DOTX í margar skrár í Java"
head_description: "Skiptu einni DOTX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "DOTX Skerandi í Java"
description: "Skiptu DOTX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOTX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni DOTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOTX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu DOTX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu DOTX skrá á netinu"
    content: |
       Skiptu DOTX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) vefsíðu.
