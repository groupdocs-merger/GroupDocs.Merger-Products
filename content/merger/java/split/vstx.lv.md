...
############################# Head ############################
head_title: "Sadaliet VSTX vairākos failos programmā Java"
head_description: "Sadaliet vienu VSTX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSTX sadalītājs programmā Java"
description: "Sadaliet VSTX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSTX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSTX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSTX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSTX failu tiešsaistē"
    content: |
       Sadaliet VSTX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx).
