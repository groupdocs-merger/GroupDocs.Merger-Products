...
############################# Head ############################
head_title: "Pisahkan DOCM kepada Berbilang Fail dalam Java"
...
############################# Header ############################
title: "DOCM Pemisah Dalam Java"
description: "Pisahkan DOCM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOCM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail DOCM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail DOCM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail DOCM menggunakan GroupDocs.Merger untuk Java API
