...
############################# Head ############################
head_title: "Jagage XPS mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail XPS mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "XPS Splitter in Java"
description: "Tükeldage XPS mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage XPS fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks XPS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili XPS, kasutades Java näidet">}}

        ```java    
        // Jagage fail XPS, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – XPS faili jagamine võrgus"
    content: |
       Tükeldage fail XPS kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps).
