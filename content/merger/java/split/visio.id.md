...
head_description: "Pisahkan satu file VISIO menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VISIO Pemisah Di Java"
description: "Pisahkan VISIO dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VISIO File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VISIO menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VISIO menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VISIO menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VISIO File Online"
    content: |
       Pisahkan file VISIO sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/visio).
