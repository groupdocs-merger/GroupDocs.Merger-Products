...
############################# Head ############################
head_title: "Dividi XLSX in più file in Java"
head_description: "Dividi un singolo file XLSX in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "XLSX Separatore in Java"
description: "Dividi XLSX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file XLSX per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file XLSX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file XLSX utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file XLSX utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file XLSX online"
    content: |
       Dividi subito il file XLSX visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx).
