...
############################# Head ############################
head_title: "Jaa DOTX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen DOTX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "DOTX Jakaja sisään Java"
description: "Jaa DOTX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto DOTX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden DOTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOTX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto DOTX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa DOTX tiedosto verkossa"
    content: |
       Jaa tiedosto DOTX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) -sivustolla.
