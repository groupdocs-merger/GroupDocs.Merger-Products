...
############################# Head ############################
head_title: "Tách XLSM thành nhiều tệp trong Java"
head_description: "Tách một tệp XLSM thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "XLSM Splitter trong Java"
description: "Tách XLSM bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp XLSM theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp XLSM thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp XLSM bằng mã mẫu Java">}}

        ```java    
        // Tách tệp XLSM bằng GroupDocs.Merger cho Java API
