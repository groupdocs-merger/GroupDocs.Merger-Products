...
############################# Head ############################
head_title: "Dela upp PDF i flera filer i Java"
...
description: "Dela upp PDF med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp PDF fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda PDF-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PDF-filen med hjälp av Java exempelkod">}}
