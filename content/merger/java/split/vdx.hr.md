...
############################# Head ############################
head_title: "Podijeli VDX u više datoteka u Java"
head_description: "Podijelite jednu VDX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "VDX Splitter u Java"
description: "Podijelite VDX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VDX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VDX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VDX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VDX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split VDX datoteka na mreži"
    content: |
       Podijeli VDX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) web mjesto.
