...
############################# Head ############################
head_title: "Skiptu ONE í margar skrár í Java"
head_description: "Skiptu einni ONE skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "ONE Skerandi í Java"
description: "Skiptu ONE með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu ONE skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni ONE skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ONE skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu ONE skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu ONE skrá á netinu"
    content: |
       Skiptu ONE skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) vefsíðu.
