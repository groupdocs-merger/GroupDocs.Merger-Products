...
############################# Head ############################
head_title: "Jaa VSSX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VSSX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VSSX Jakaja sisään Java"
description: "Jaa VSSX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VSSX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VSSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSSX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VSSX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VSSX tiedosto verkossa"
    content: |
       Jaa tiedosto VSSX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) -sivustolla.
