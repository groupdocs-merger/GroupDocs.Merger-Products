...
############################# Head ############################
head_title: "Împărțiți PDF în mai multe fișiere în Java"
head_description: "Împărțiți un singur fișier PDF în mai multe fișiere pe baza numerelor de pagină, a intervalelor de pagini, a paginilor pare sau impare, utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Splitter PDF în Java"
description: "Împărțiți PDF cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul PDF după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier PDF în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul PDF folosind codul exemplu Java">}}
...
demos:
    enable: true
    title: "Demo live - Împărțiți fișierul PDF online"
    content: |
       Împărțiți fișierul PDF chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
