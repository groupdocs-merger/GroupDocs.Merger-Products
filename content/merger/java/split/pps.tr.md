...
############################# Head ############################
head_title: "PPS'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir PPS dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "PPS Ayırıcı Java"
description: "PPS kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPS Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPS dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPS dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - PPS Dosyasını Çevrimiçi Böl"
    content: |
       PPS dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) web sitesini ziyaret ederek bölün.
