...
############################# Head ############################
head_title: "Podziel PPS na wiele plików w Java"
head_description: "Podziel pojedynczy plik PPS na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "PPS Rozdzielacz w Java"
description: "Podziel PPS z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik PPS według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku PPS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik PPS za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik PPS za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik PPS online"
    content: |
       Podziel plik PPS już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps).
