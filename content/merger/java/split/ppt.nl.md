...
############################# Head ############################
head_title: "Splits PPT in meerdere bestanden in Java"
head_description: "Splits een enkel PPT bestand in meerdere bestanden op basis van paginanummers, pagina-intervallen, even of oneven pagina's met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "PPT Splitter in Java"
description: "Splits PPT met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits PPT bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel PPT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een PPT bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits PPT bestand met behulp van GroupDocs.Merger voor Java API
...
demos:
    enable: true
    title: "Live demo's - PPT bestand online splitsen"
    content: |
       Splits PPT bestand nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt) te gaan.
