...
############################# Head ############################
head_title: "Jaa VDX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VDX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VDX Jakaja sisään Java"
description: "Jaa VDX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VDX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VDX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VDX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VDX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VDX tiedosto verkossa"
    content: |
       Jaa tiedosto VDX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) -sivustolla.
