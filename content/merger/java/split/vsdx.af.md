...
############################# Head ############################
head_title: "Verdeel VSDX in veelvuldige lêers in Java"
...
description: "Verdeel VSDX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSDX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSDX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSDX lêer deur GroupDocs.Merger vir Java API te gebruik
