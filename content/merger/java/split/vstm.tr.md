...
############################# Head ############################
head_title: "VSTM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VSTM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VSTM Ayırıcı Java"
description: "VSTM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSTM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSTM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSTM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VSTM Dosyasını Çevrimiçi Böl"
    content: |
       VSTM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm) web sitesini ziyaret ederek bölün.
