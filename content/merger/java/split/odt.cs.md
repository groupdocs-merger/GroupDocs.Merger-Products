...
############################# Head ############################
head_title: "Rozdělit ODT do více souborů v Java"
head_description: "Rozdělte jeden soubor ODT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "ODT Splitter v Java"
description: "Rozdělte ODT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit ODT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru ODT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor ODT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor ODT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru ODT online"
    content: |
       Rozdělte soubor ODT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
