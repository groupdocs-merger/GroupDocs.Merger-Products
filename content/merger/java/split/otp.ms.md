...
############################# Head ############################
head_title: "Pisahkan OTP kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail OTP kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "OTP Pemisah Dalam Java"
description: "Pisahkan OTP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan OTP Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail OTP kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail OTP menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail OTP menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split OTP Fail Dalam Talian"
    content: |
       Pisahkan fail OTP sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
