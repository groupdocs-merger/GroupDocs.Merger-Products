...
############################# Head ############################
head_title: "Razdeli TEX na več datotek v Java"
head_description: "Eno datoteko TEX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "TEX razdelilnik v Java"
description: "Razdelite TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko TEX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke TEX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko TEX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko TEX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli TEX datoteko na spletu"
    content: |
       Takoj razdelite datoteko TEX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
