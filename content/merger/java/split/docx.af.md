...
############################# Head ############################
head_title: "Verdeel DOCX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele DOCX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "DOCX Splitter in Java"
description: "Verdeel DOCX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOCX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOCX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOCX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel DOCX lêer aanlyn"
    content: |
       Verdeel DOCX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) webwerf te besoek.
