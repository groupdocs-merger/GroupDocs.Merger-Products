...
############################# Head ############################
head_title: "Dividi DOCX in più file in Java"
head_description: "Dividi un singolo file DOCX in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "DOCX Separatore in Java"
description: "Dividi DOCX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file DOCX per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file DOCX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file DOCX utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file DOCX utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file DOCX online"
    content: |
       Dividi subito il file DOCX visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
