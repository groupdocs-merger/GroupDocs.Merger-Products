...
############################# Head ############################
head_title: "Dividir OTT en varios archivos en Java"
head_description: "Divida un solo archivo OTT en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "OTT Divisor en Java"
description: "Divida OTT con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir OTT archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo OTT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo OTT usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo OTT usando GroupDocs.Merger para la API de Java
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir OTT archivo en línea"
    content: |
       Divida el archivo OTT ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott).
