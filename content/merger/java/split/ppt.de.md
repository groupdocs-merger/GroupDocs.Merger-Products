...
############################# Head ############################
head_title: "Teilen Sie PPT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne PPT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "PPT Splittereingang Java"
description: "Teilen Sie PPT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "PPT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne PPT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die PPT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // PPT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - PPT-Datei online teilen"
    content: |
       Teilen Sie die Datei PPT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt) besuchen.
