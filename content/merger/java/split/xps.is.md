...
############################# Head ############################
head_title: "Skiptu XPS í margar skrár í Java"
head_description: "Skiptu einni XPS skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XPS Skerandi í Java"
description: "Skiptu XPS með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XPS skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XPS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XPS skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XPS skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XPS skrá á netinu"
    content: |
       Skiptu XPS skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) vefsíðu.
