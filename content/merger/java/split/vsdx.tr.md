...
############################# Head ############################
head_title: "VSDX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VSDX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VSDX Ayırıcı Java"
description: "VSDX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSDX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSDX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VSDX Dosyasını Çevrimiçi Böl"
    content: |
       VSDX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx) web sitesini ziyaret ederek bölün.
