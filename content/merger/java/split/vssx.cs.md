...
############################# Head ############################
head_title: "Rozdělit VSSX do více souborů v Java"
head_description: "Rozdělte jeden soubor VSSX do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "VSSX Splitter v Java"
description: "Rozdělte VSSX několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit VSSX soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru VSSX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor VSSX pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor VSSX pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru VSSX online"
    content: |
       Rozdělte soubor VSSX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
