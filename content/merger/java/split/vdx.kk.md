...
############################# Head ############################
head_title: "VDX файлын Java ішінде бірнеше файлға бөліңіз"
head_description: "Бір VDX файлын құжаттарды біріктіру API көмегімен бет нөмірлеріне, бет аралықтарына, жұп немесе тақ беттерге негізделген бірнеше файлдарға бөліңіз."

############################# Header ############################
title: "VDX Java ішіндегі бөлгіш"
description: "VDX кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "VDX файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір VDX файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // VDX файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VDX файлды желіде бөліңіз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) веб-сайтына кіру арқылы VDX файлды дәл қазір бөліңіз.
