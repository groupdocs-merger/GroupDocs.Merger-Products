...
############################# Header ############################
title: "WORKSHEET Splitter In Java"
description: "Split WORKSHEET with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single WORKSHEET file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split WORKSHEET file using Java example code">}}

        ```java    
        // Split WORKSHEET file using GroupDocs.Merger for Java API
