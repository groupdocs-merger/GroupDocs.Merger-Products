...
############################# Head ############################
head_title: "Padalinkite DOTM į kelis failus Java"
head_description: "Padalinkite vieną DOTM failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "DOTM skirstytuvas Java"
description: "Padalinkite DOTM keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOTM failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną DOTM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOTM failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite DOTM failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite DOTM failą internete"
    content: |
       Padalykite DOTM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm) svetainėje.
