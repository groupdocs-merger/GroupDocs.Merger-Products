...
############################# Head ############################
head_title: "A(z) TEX felosztása több fájlra a Java programban"
head_description: "Egyetlen TEX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "TEX Splitter in Java"
description: "Oszd fel az TEX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) TEX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen TEX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az TEX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az TEX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split TEX fájl online"
    content: |
       Ossza meg az TEX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) webhely meglátogatásával.
