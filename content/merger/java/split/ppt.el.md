...
############################# Head ############################
head_title: "Διαχωρίστε το PPT σε πολλά αρχεία στο Java"
head_description: "Διαχωρίστε ένα αρχείο PPT σε πολλά αρχεία με βάση αριθμούς σελίδων, διαστήματα σελίδων, ζυγές ή μονές σελίδες χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "PPT Splitter σε Java"
description: "Διαχωρίστε το PPT με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Διαχωρισμός αρχείου PPT ανά σελίδες στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να χωρίσουν ένα μεμονωμένο αρχείο PPT σε πολλά προκύπτοντα αρχεία εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να χωρίσετε το αρχείο PPT χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Διαχωρίστε το αρχείο PPT χρησιμοποιώντας το GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Διαχωρισμός αρχείων PPT στο Διαδίκτυο"
    content: |
       Διαχωρίστε το αρχείο PPT τώρα, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
