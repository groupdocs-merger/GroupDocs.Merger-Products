...
############################# Head ############################
head_title: "Rozdeliť CSV do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor CSV do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "CSV Splitter v Java"
description: "Rozdeľte CSV niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť CSV súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor CSV na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť CSV súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor CSV pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru CSV online"
    content: |
       Rozdeľte súbor CSV hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
