...
############################# Head ############################
head_title: "Jaa VSSM useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VSSM-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VSSM Jakaja sisään Java"
description: "Jaa VSSM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VSSM sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VSSM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSSM tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VSSM GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VSSM tiedosto verkossa"
    content: |
       Jaa tiedosto VSSM heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) -sivustolla.
