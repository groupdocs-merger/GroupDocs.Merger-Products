...
############################# Head ############################
head_title: "Podziel DOTX na wiele plików w Java"
head_description: "Podziel pojedynczy plik DOTX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "DOTX Rozdzielacz w Java"
description: "Podziel DOTX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik DOTX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku DOTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik DOTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik DOTX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik DOTX online"
    content: |
       Podziel plik DOTX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
