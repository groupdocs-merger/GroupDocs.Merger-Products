...
############################# Head ############################
head_title: "Pisahkan VDX menjadi Beberapa File di Java"
head_description: "Pisahkan satu file VDX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VDX Pemisah Di Java"
description: "Pisahkan VDX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VDX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VDX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VDX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VDX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VDX File Online"
    content: |
       Pisahkan file VDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vdx).
