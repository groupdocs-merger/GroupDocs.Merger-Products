...
head_description: "Pisahkan satu file DOCM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOCM Pemisah Di Java"
description: "Pisahkan DOCM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOCM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file DOCM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file DOCM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file DOCM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan DOCM File Online"
    content: |
       Pisahkan file DOCM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/docm).
