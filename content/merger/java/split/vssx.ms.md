...
############################# Head ############################
head_title: "Pisahkan VSSX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSSX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSSX Pemisah Dalam Java"
description: "Pisahkan VSSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSSX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSSX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSSX Fail Dalam Talian"
    content: |
       Pisahkan fail VSSX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
