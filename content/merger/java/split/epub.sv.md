...
############################# Head ############################
head_title: "Dela upp EPUB i flera filer i Java"
head_description: "Dela upp en enda EPUB-fil i flera filer baserat på sidnummer, sidintervall, jämna eller udda sidor med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "EPUB splitter i Java"
description: "Dela upp EPUB med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp EPUB fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda EPUB-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp EPUB-filen med hjälp av Java exempelkod">}}

        ```java    
        // Dela EPUB-fil med GroupDocs.Merger för Java API
...
demos:
    enable: true
    title: "Livedemos - Split EPUB fil online"
    content: |
       Dela upp EPUB-filen just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
