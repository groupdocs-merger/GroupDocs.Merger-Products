...
############################# Head ############################
head_title: "Divisez XLT en plusieurs fichiers dans Java"
head_description: "Divisez un seul fichier XLT en plusieurs fichiers en fonction des numéros de page, des intervalles de page, des pages paires ou impaires à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "XLT Séparateur dans Java"
description: "Divisez XLT avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Diviser le fichier XLT par pages dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de diviser facilement un seul fichier XLT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser le fichier XLT à l'aide de l'exemple de code Java">}}

        ```java    
        // Diviser le fichier XLT à l'aide de GroupDocs.Merger pour l'API Java
...
demos:
    enable: true
    title: "Démos en direct – Diviser le fichier XLT en ligne"
    content: |
       Divisez le fichier XLT dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt).
