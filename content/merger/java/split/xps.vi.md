...
############################# Head ############################
head_title: "Tách XPS thành nhiều tệp trong Java"
head_description: "Tách một tệp XPS thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "XPS Splitter trong Java"
description: "Tách XPS bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp XPS theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp XPS thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp XPS bằng mã mẫu Java">}}

        ```java    
        // Tách tệp XPS bằng GroupDocs.Merger cho Java API
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Tách tệp XPS Trực tuyến"
    content: |
       Tách tệp XPS ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) trang web.
