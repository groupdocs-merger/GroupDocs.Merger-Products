...
############################# Head ############################
head_title: "Podziel XLSM na wiele plików w Java"
...
############################# Header ############################
title: "XLSM Rozdzielacz w Java"
description: "Podziel XLSM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLSM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLSM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLSM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLSM za pomocą GroupDocs.Merger for Java API
