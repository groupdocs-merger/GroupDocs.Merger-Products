...
############################# Head ############################
head_title: "HTML'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir HTML dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "HTML Ayırıcı Java"
description: "HTML kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "HTML Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak HTML dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak HTML dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - HTML Dosyasını Çevrimiçi Böl"
    content: |
       HTML dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html) web sitesini ziyaret ederek bölün.
