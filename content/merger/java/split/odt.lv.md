...
############################# Head ############################
head_title: "Sadaliet ODT vairākos failos programmā Java"
head_description: "Sadaliet vienu ODT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "ODT sadalītājs programmā Java"
description: "Sadaliet ODT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu ODT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet ODT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt ODT failu tiešsaistē"
    content: |
       Sadaliet ODT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
