...
############################# Head ############################
head_title: "Rozdělit TXT do více souborů v Java"
head_description: "Rozdělte jeden soubor TXT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "TXT Splitter v Java"
description: "Rozdělte TXT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit TXT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru TXT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor TXT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor TXT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru TXT online"
    content: |
       Rozdělte soubor TXT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
