...
############################# Head ############################
head_title: "Del XLTX i flere filer i Java"
head_description: "Del en enkelt XLTX-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "XLTX splitter i Java"
description: "Del XLTX med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del XLTX-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt XLTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLTX-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del XLTX-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del XLTX-fil på nett"
    content: |
       Del opp XLTX-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
