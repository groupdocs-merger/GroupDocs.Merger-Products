...
############################# Head ############################
head_title: "Divida VSTX em vários arquivos em Java"
head_description: "Divida um único arquivo VSTX em vários arquivos com base em números de página, intervalos de página, páginas pares ou ímpares usando a API de fusão de documentos."

############################# Header ############################
title: "VSTX Divisor em Java"
description: "Divida VSTX com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir VSTX arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo VSTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo VSTX usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo VSTX usando GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Dividir arquivo VSTX on-line"
    content: |
       Divida o arquivo VSTX agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx).
