...
############################# Head ############################
head_title: "Rozdělit MHT do více souborů v Java"
head_description: "Rozdělte jeden soubor MHT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "MHT Splitter v Java"
description: "Rozdělte MHT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit MHT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru MHT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor MHT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor MHT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru MHT online"
    content: |
       Rozdělte soubor MHT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
