...
############################# Head ############################
head_title: "Sadaliet XLS vairākos failos programmā Java"
head_description: "Sadaliet vienu XLS failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLS sadalītājs programmā Java"
description: "Sadaliet XLS ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLS failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLS failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLS failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLS failu tiešsaistē"
    content: |
       Sadaliet XLS failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls).
