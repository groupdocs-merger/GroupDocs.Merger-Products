...
head_description: "Pisahkan satu file ODS menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "ODS Pemisah Di Java"
description: "Pisahkan ODS dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan ODS File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file ODS menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file ODS menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file ODS menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan ODS File Online"
    content: |
       Pisahkan file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/ods).
