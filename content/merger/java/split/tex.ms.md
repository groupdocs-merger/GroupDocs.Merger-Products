...
############################# Head ############################
head_title: "Pisahkan TEX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail TEX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "TEX Pemisah Dalam Java"
description: "Pisahkan TEX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan TEX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail TEX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail TEX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail TEX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split TEX Fail Dalam Talian"
    content: |
       Pisahkan fail TEX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
