...
############################# Head ############################
head_title: "Podziel VSSX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSSX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSSX Rozdzielacz w Java"
description: "Podziel VSSX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSSX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSSX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSSX online"
    content: |
       Podziel plik VSSX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
