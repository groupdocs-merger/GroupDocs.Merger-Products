...
############################# Head ############################
head_title: "Razdeli MHT na več datotek v Java"
head_description: "Eno datoteko MHT razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "MHT razdelilnik v Java"
description: "Razdelite MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko MHT po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke MHT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko MHT s primerom kode Java">}}

        ```java    
        // Razdeli datoteko MHT z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli MHT datoteko na spletu"
    content: |
       Takoj razdelite datoteko MHT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
