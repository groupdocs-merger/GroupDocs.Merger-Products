...
############################# Head ############################
head_title: "Padalinkite ODP į kelis failus Java"
head_description: "Padalinkite vieną ODP failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "ODP skirstytuvas Java"
description: "Padalinkite ODP keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ODP failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną ODP failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ODP failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite ODP failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite ODP failą internete"
    content: |
       Padalykite ODP failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp) svetainėje.
