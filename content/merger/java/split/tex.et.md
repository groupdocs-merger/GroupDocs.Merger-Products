...
############################# Head ############################
head_title: "Jagage TEX mitmeks failiks rakenduses Java"
...
description: "Tükeldage TEX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage TEX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks TEX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili TEX, kasutades Java näidet">}}

        ```java    
        // Jagage fail TEX, kasutades GroupDocs.Merger for Java API-t
