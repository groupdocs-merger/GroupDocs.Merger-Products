...
############################# Head ############################
head_title: "Jaa PPT useiksi tiedostoiksi Java"
...
############################# Header ############################
title: "PPT Jakaja sisään Java"
description: "Jaa PPT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto PPT sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden PPT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPT tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto PPT GroupDocs.Merger for Java API:lla
