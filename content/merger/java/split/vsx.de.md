...
############################# Head ############################
head_title: "Teilen Sie VSX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VSX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VSX Splittereingang Java"
description: "Teilen Sie VSX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VSX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VSX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VSX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VSX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VSX-Datei online teilen"
    content: |
       Teilen Sie die Datei VSX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx) besuchen.
