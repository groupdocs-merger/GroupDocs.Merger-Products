...
############################# Head ############################
head_title: "Sadaliet DOCX vairākos failos programmā Java"
head_description: "Sadaliet vienu DOCX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "DOCX sadalītājs programmā Java"
description: "Sadaliet DOCX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOCX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu DOCX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOCX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet DOCX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt DOCX failu tiešsaistē"
    content: |
       Sadaliet DOCX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
