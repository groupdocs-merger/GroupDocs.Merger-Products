...
############################# Head ############################
head_title: "Pisahkan EPUB kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail EPUB kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "EPUB Pemisah Dalam Java"
description: "Pisahkan EPUB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan EPUB Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail EPUB kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail EPUB menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail EPUB menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split EPUB Fail Dalam Talian"
    content: |
       Pisahkan fail EPUB sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
