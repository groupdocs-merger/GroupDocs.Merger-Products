...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single VTX file into multiple resultant files by implementing a few easy steps.
