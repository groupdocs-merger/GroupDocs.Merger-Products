...
############################# Head ############################
head_title: "Pisahkan DOC kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail DOC kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOC Pemisah Dalam Java"
description: "Pisahkan DOC dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOC Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail DOC kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail DOC menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail DOC menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split DOC Fail Dalam Talian"
    content: |
       Pisahkan fail DOC sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
