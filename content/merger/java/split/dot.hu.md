...
############################# Head ############################
head_title: "A(z) DOT felosztása több fájlra a Java programban"
head_description: "Egyetlen DOT fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOT Splitter in Java"
description: "Oszd fel az DOT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) DOT fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen DOT fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az DOT fájl felosztása a Java példakóddal">}}

        ```java    
        // Az DOT fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split DOT fájl online"
    content: |
       Ossza meg az DOT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) webhely meglátogatásával.
