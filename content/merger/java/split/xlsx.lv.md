...
############################# Head ############################
head_title: "Sadaliet XLSX vairākos failos programmā Java"
head_description: "Sadaliet vienu XLSX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLSX sadalītājs programmā Java"
description: "Sadaliet XLSX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLSX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLSX failu tiešsaistē"
    content: |
       Sadaliet XLSX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx).
