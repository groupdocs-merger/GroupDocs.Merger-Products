...
############################# Head ############################
head_title: "Jagage DOTM mitmeks failiks rakenduses Java"
...
description: "Tükeldage DOTM mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOTM fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOTM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOTM, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOTM, kasutades GroupDocs.Merger for Java API-t
