...
############################# Head ############################
head_title: "Padalinkite VTX į kelis failus Java"
head_description: "Padalinkite vieną VTX failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "VTX skirstytuvas Java"
description: "Padalinkite VTX keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VTX failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną VTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VTX failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite VTX failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite VTX failą internete"
    content: |
       Padalykite VTX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) svetainėje.
