...
############################# Head ############################
head_title: "Skiptu DOC í margar skrár í Java"
head_description: "Skiptu einni DOC skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "DOC Skerandi í Java"
description: "Skiptu DOC með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOC skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni DOC skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOC skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu DOC skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu DOC skrá á netinu"
    content: |
       Skiptu DOC skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc) vefsíðu.
