...
############################# Head ############################
head_title: "Razdeli RTF na več datotek v Java"
head_description: "Eno datoteko RTF razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "RTF razdelilnik v Java"
description: "Razdelite RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko RTF po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke RTF na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko RTF s primerom kode Java">}}

        ```java    
        // Razdeli datoteko RTF z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli RTF datoteko na spletu"
    content: |
       Takoj razdelite datoteko RTF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
