...
############################# Head ############################
head_title: "Rozdělit VSDM do více souborů v Java"
head_description: "Rozdělte jeden soubor VSDM do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "VSDM Splitter v Java"
description: "Rozdělte VSDM několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit VSDM soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru VSDM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor VSDM pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor VSDM pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru VSDM online"
    content: |
       Rozdělte soubor VSDM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm).
