...
head_description: "Split a single PPTX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "PPTX Splitter In Java"
description: "Split PPTX with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) makes it easy for Java developers to split a single PPTX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split PPTX file using Java example code">}}

        ```java    
        // Split PPTX file using GroupDocs.Merger for Java API
