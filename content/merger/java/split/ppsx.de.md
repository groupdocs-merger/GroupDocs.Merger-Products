...
############################# Head ############################
head_title: "Teilen Sie PPSX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne PPSX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "PPSX Splittereingang Java"
description: "Teilen Sie PPSX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "PPSX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne PPSX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die PPSX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // PPSX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - PPSX-Datei online teilen"
    content: |
       Teilen Sie die Datei PPSX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) besuchen.
