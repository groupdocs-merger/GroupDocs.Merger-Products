...
head_title: "Pisahkan PPTM menjadi Beberapa File di Java"
head_description: "Pengguna Java untuk membagi satu file PPTM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Pisahkan PPTM Menjadi Beberapa File di Java"
description: "Pisahkan satu file PPTM menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Pisahkan File PPTM Dengan Halaman di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file PPTM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
