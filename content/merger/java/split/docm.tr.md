...
############################# Head ############################
head_title: "DOCM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOCM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOCM Ayırıcı Java"
description: "DOCM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOCM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOCM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOCM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOCM Dosyasını Çevrimiçi Böl"
    content: |
       DOCM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) web sitesini ziyaret ederek bölün.
