...
############################# Head ############################
head_title: "Del TEX i flere filer i Java"
...
description: "Del TEX med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del TEX-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt TEX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp TEX-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del TEX-filen med GroupDocs.Merger for Java API
