...
############################# Head ############################
head_title: "Pisahkan XPS kepada Berbilang Fail dalam Java"
...
############################# Header ############################
title: "XPS Pemisah Dalam Java"
description: "Pisahkan XPS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XPS Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XPS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XPS menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XPS menggunakan GroupDocs.Merger untuk Java API
