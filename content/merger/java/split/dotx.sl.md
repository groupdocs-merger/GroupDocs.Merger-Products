...
############################# Head ############################
head_title: "Razdeli DOTX na več datotek v Java"
head_description: "Eno datoteko DOTX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "DOTX razdelilnik v Java"
description: "Razdelite DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko DOTX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke DOTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko DOTX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko DOTX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli DOTX datoteko na spletu"
    content: |
       Takoj razdelite datoteko DOTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
