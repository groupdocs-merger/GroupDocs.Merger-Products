...
head_description: "Split a single IMAGE file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "IMAGE Splitter In Java"
description: "Split IMAGE with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single IMAGE file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split IMAGE file using Java example code">}}

        ```java    
        // Split IMAGE file using GroupDocs.Merger for Java API
