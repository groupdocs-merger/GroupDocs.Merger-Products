...
############################# Head ############################
head_title: "تقسيم XLAM إلى ملفات متعددة في Java"
...
############################# Header ############################
title: "XLAM الفاصل في Java"
description: "قسِّم XLAM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تقسيم XLAM الملف حسب الصفحات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تقسيم ملف واحد XLAM إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملف XLAM باستخدام مثال كود Java">}}

        ```java    
        // انقسام الملف XLAM باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
