...
############################# Head ############################
head_title: "Sadaliet TXT vairākos failos programmā Java"
head_description: "Sadaliet vienu TXT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "TXT sadalītājs programmā Java"
description: "Sadaliet TXT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TXT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu TXT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TXT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet TXT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt TXT failu tiešsaistē"
    content: |
       Sadaliet TXT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
