...
############################# Head ############################
head_title: "Teilen Sie XLTM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XLTM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XLTM Splittereingang Java"
description: "Teilen Sie XLTM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XLTM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XLTM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XLTM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XLTM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XLTM-Datei online teilen"
    content: |
       Teilen Sie die Datei XLTM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm) besuchen.
