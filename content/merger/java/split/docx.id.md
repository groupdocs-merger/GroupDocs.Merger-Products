...
############################# Head ############################
head_title: "Pecah dokumen DOCX dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk memecah file DOCX menjadi dokumen terpisah. Kelola PDF, file Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pecah file DOCX" 
description: "GroupDocs.Merger for Java meningkatkan aplikasi Java dengan menambahkan fitur pemrosesan dokumen yang canggih. Pecah file DOCX dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memecah file DOCX"
    content: |
      Dengan [GroupDocs.Merger](/merger/java/), Anda dapat memecah dokumen DOCX dan menyimpan halaman yang dipilih sebagai file baru. Integrasikan manajemen dokumen canggih ke dalam aplikasi Java Anda.
      
      1. Sediakan jalur sumber dari file DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pecah dokumen DOCX dan simpan halaman bernomor genap"
      content: |
        Contoh ini menunjukkan cara memecah dokumen DOCX dan menyimpan semua halaman bernomor genap sebagai file terpisah.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
