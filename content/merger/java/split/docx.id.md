...
head_description: "Pisahkan satu file DOCX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOCX Pemisah Di Java"
description: "Pisahkan DOCX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOCX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file DOCX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file DOCX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file DOCX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan DOCX File Online"
    content: |
       Pisahkan file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/docx).
