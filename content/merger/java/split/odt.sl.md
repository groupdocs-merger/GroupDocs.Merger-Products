...
############################# Head ############################
head_title: "Razdeli ODT na več datotek v Java"
head_description: "Eno datoteko ODT razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "ODT razdelilnik v Java"
description: "Razdelite ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko ODT po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke ODT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko ODT s primerom kode Java">}}

        ```java    
        // Razdeli datoteko ODT z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli ODT datoteko na spletu"
    content: |
       Takoj razdelite datoteko ODT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
