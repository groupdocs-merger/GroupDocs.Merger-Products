...
############################# Head ############################
head_title: "Rozdělit TEX do více souborů v Java"
head_description: "Rozdělte jeden soubor TEX do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "TEX Splitter v Java"
description: "Rozdělte TEX několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit TEX soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru TEX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor TEX pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor TEX pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru TEX online"
    content: |
       Rozdělte soubor TEX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
