...
############################# Head ############################
head_title: "Разделете VSDX на няколко файла в Java"
head_description: "Разделете един файл VSDX на няколко файла въз основа на номера на страници, интервали между страници, четни или нечетни страници, като използвате API за сливане на документи."

############################# Header ############################
title: "VSDX Сплитер в Java"
description: "Разделете VSDX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете VSDX файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл VSDX на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл VSDX с примерен код на Java">}}

        ```java    
        // Разделете VSDX файл с помощта на GroupDocs.Merger за Java API
...
demos:
    enable: true
    title: "Демонстрации на живо - Разделете VSDX файл онлайн"
    content: |
       Разделете файла VSDX веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx).
