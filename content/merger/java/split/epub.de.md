...
############################# Head ############################
head_title: "Teilen Sie EPUB in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne EPUB-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "EPUB Splittereingang Java"
description: "Teilen Sie EPUB mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "EPUB-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne EPUB-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die EPUB-Datei mit dem Java-Beispielcode">}}

        ```java    
        // EPUB-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - EPUB-Datei online teilen"
    content: |
       Teilen Sie die Datei EPUB jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) besuchen.
