...
############################# Head ############################
head_title: "Razdeli CSV na več datotek v Java"
head_description: "Eno datoteko CSV razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "CSV razdelilnik v Java"
description: "Razdelite CSV z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko CSV po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke CSV na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko CSV s primerom kode Java">}}

        ```java    
        // Razdeli datoteko CSV z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli CSV datoteko na spletu"
    content: |
       Takoj razdelite datoteko CSV tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
