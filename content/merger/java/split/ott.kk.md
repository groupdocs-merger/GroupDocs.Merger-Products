...
############################# Head ############################
head_title: "OTT файлын Java ішінде бірнеше файлға бөліңіз"
head_description: "Бір OTT файлын құжаттарды біріктіру API көмегімен бет нөмірлеріне, бет аралықтарына, жұп немесе тақ беттерге негізделген бірнеше файлдарға бөліңіз."

############################# Header ############################
title: "OTT Java ішіндегі бөлгіш"
description: "OTT кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "OTT файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір OTT файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // OTT файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - OTT файлды желіде бөліңіз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) веб-сайтына кіру арқылы OTT файлды дәл қазір бөліңіз.
