...
############################# Head ############################
head_title: "Pisahkan VSDX menjadi Beberapa File di Java"
head_description: "Pisahkan satu file VSDX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSDX Pemisah Di Java"
description: "Pisahkan VSDX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSDX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSDX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSDX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSDX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSDX File Online"
    content: |
       Pisahkan file VSDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vsdx).
