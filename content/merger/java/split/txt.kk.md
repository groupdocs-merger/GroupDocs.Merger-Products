...
############################# Head ############################
head_title: "TXT файлын Java ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "TXT Java ішіндегі бөлгіш"
description: "TXT кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "TXT файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір TXT файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="TXT файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // TXT файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
