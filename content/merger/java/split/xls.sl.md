...
############################# Head ############################
head_title: "Razdeli XLS na več datotek v Java"
head_description: "Eno datoteko XLS razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XLS razdelilnik v Java"
description: "Razdelite XLS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XLS po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XLS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XLS s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XLS z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XLS datoteko na spletu"
    content: |
       Takoj razdelite datoteko XLS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls).
