...
############################# Head ############################
head_title: "PPSX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir PPSX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "PPSX Ayırıcı Java"
description: "PPSX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPSX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPSX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPSX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - PPSX Dosyasını Çevrimiçi Böl"
    content: |
       PPSX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) web sitesini ziyaret ederek bölün.
