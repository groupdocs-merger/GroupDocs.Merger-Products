...
head_description: "Pisahkan satu file EPUB menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "EPUB Pemisah Di Java"
description: "Pisahkan EPUB dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan EPUB File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file EPUB menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file EPUB menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file EPUB menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan EPUB File Online"
    content: |
       Pisahkan file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/epub).
