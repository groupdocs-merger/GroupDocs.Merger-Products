...
############################# Head ############################
head_title: "Teilen Sie PPS in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne PPS-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "PPS Splittereingang Java"
description: "Teilen Sie PPS mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "PPS-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne PPS-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die PPS-Datei mit dem Java-Beispielcode">}}

        ```java    
        // PPS-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - PPS-Datei online teilen"
    content: |
       Teilen Sie die Datei PPS jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) besuchen.
