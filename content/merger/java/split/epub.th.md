...
############################# Head ############################
head_title: "แยก EPUB ออกเป็นหลายไฟล์ใน Java"
head_description: "แยกไฟล์ EPUB ไฟล์เดียวออกเป็นหลายไฟล์ตามหมายเลขหน้า ช่วงหน้า หน้าคู่หรือหน้าคี่โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "EPUB แยกใน Java"
description: "แยก EPUB ด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "แยกไฟล์ EPUB ทีละหน้าใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ช่วยให้นักพัฒนา Java แยกไฟล์ EPUB ไฟล์เดียวออกเป็นไฟล์ผลลัพธ์ได้หลายไฟล์โดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีแยกไฟล์ EPUB โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // แยกไฟล์ EPUB โดยใช้ GroupDocs.Merger สำหรับ Java API
...
demos:
    enable: true
    title: "การสาธิตสด - แยกไฟล์ EPUB ออนไลน์"
    content: |
       แยกไฟล์ EPUB ออกทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub)
