...
############################# Head ############################
head_title: "Divida HTML em vários arquivos em Java"
head_description: "Divida um único arquivo HTML em vários arquivos com base em números de página, intervalos de página, páginas pares ou ímpares usando a API de fusão de documentos."

############################# Header ############################
title: "HTML Divisor em Java"
description: "Divida HTML com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir HTML arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo HTML em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo HTML usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo HTML usando GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Dividir arquivo HTML on-line"
    content: |
       Divida o arquivo HTML agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
