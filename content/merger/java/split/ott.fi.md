...
############################# Head ############################
head_title: "Jaa OTT useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen OTT-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "OTT Jakaja sisään Java"
description: "Jaa OTT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto OTT sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden OTT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa OTT tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto OTT GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa OTT tiedosto verkossa"
    content: |
       Jaa tiedosto OTT heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) -sivustolla.
