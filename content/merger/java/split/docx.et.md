...
############################# Head ############################
head_title: "Jagage DOCX mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail DOCX mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "DOCX Splitter in Java"
description: "Tükeldage DOCX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOCX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOCX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOCX, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOCX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – DOCX faili jagamine võrgus"
    content: |
       Tükeldage fail DOCX kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
