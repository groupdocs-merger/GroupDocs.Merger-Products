...
############################# Head ############################
head_title: "Jaa DOCM useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen DOCM-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "DOCM Jakaja sisään Java"
description: "Jaa DOCM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto DOCM sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden DOCM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOCM tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto DOCM GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa DOCM tiedosto verkossa"
    content: |
       Jaa tiedosto DOCM heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) -sivustolla.
