...
############################# Head ############################
head_title: "Teilen Sie TSV in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne TSV-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "TSV Splittereingang Java"
description: "Teilen Sie TSV mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "TSV-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne TSV-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die TSV-Datei mit dem Java-Beispielcode">}}

        ```java    
        // TSV-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - TSV-Datei online teilen"
    content: |
       Teilen Sie die Datei TSV jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) besuchen.
