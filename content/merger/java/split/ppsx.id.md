...
head_description: "Pisahkan satu file PPSX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PPSX Pemisah Di Java"
description: "Pisahkan PPSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan PPSX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file PPSX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file PPSX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file PPSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan PPSX File Online"
    content: |
       Pisahkan file PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/ppsx).
