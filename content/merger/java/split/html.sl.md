...
############################# Head ############################
head_title: "Razdeli HTML na več datotek v Java"
head_description: "Eno datoteko HTML razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "HTML razdelilnik v Java"
description: "Razdelite HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko HTML po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke HTML na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko HTML s primerom kode Java">}}

        ```java    
        // Razdeli datoteko HTML z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli HTML datoteko na spletu"
    content: |
       Takoj razdelite datoteko HTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
