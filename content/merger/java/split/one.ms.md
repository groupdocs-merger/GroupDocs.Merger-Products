...
############################# Head ############################
head_title: "Pisahkan ONE kepada Berbilang Fail dalam Java"
...
############################# Header ############################
title: "ONE Pemisah Dalam Java"
description: "Pisahkan ONE dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan ONE Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail ONE kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail ONE menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail ONE menggunakan GroupDocs.Merger untuk Java API
