...
############################# Head ############################
head_title: "A(z) DOTX felosztása több fájlra a Java programban"
head_description: "Egyetlen DOTX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTX Splitter in Java"
description: "Oszd fel az DOTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) DOTX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen DOTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az DOTX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az DOTX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split DOTX fájl online"
    content: |
       Ossza meg az DOTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) webhely meglátogatásával.
