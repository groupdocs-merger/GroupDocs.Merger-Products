...
############################# Head ############################
head_title: "Razdeli PPSX na več datotek v Java"
head_description: "Eno datoteko PPSX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "PPSX razdelilnik v Java"
description: "Razdelite PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko PPSX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke PPSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko PPSX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko PPSX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli PPSX datoteko na spletu"
    content: |
       Takoj razdelite datoteko PPSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx).
