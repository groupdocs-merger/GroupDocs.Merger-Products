...
############################# Head ############################
head_title: "Skiptu ODP í margar skrár í Java"
head_description: "Skiptu einni ODP skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "ODP Skerandi í Java"
description: "Skiptu ODP með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODP skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni ODP skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODP skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu ODP skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu ODP skrá á netinu"
    content: |
       Skiptu ODP skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp) vefsíðu.
