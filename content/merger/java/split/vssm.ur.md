...
############################# Head ############################
head_title: "VSSM کو Java میں متعدد فائلوں میں تقسیم کریں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے صفحہ نمبر، صفحہ کے وقفوں، مساوی یا طاق صفحات کی بنیاد پر ایک VSSM فائل کو کئی فائلوں میں تقسیم کریں۔"

############################# Header ############################
title: "VSSM سپلٹر ان Java"
description: "Java کوڈ کی چند لائنوں کے ساتھ VSSM کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "VSSM فائل کو Java میں صفحات کے لحاظ سے تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے ایک VSSM فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کوڈ کا استعمال کرتے ہوئے VSSM فائل کو کیسے تقسیم کیا جائے۔">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے VSSM فائل کو تقسیم کریں۔
...
demos:
    enable: true
    title: "لائیو ڈیمو - تقسیم VSSM فائل آن لائن"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) ویب سائٹ پر جا کر ابھی VSSM فائل کو تقسیم کریں۔
