...
############################# Head ############################
head_title: "Verdeel DOC in veelvuldige lêers in Java"
...
description: "Verdeel DOC met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOC lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOC-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOC-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOC lêer deur GroupDocs.Merger vir Java API te gebruik
