...
############################# Head ############################
head_title: "Razdeli XLAM na več datotek v Java"
head_description: "Eno datoteko XLAM razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XLAM razdelilnik v Java"
description: "Razdelite XLAM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XLAM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XLAM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XLAM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XLAM z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XLAM datoteko na spletu"
    content: |
       Takoj razdelite datoteko XLAM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam).
