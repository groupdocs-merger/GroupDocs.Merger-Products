...
############################# Head ############################
head_title: "Pisahkan VSX menjadi Beberapa File di Java"
head_description: "Pisahkan satu file VSX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSX Pemisah Di Java"
description: "Pisahkan VSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSX File Online"
    content: |
       Pisahkan file VSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vsx).
