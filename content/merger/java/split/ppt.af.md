...
############################# Head ############################
head_title: "Verdeel PPT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele PPT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "PPT Splitter in Java"
description: "Verdeel PPT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele PPT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel PPT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel PPT lêer aanlyn"
    content: |
       Verdeel PPT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt) webwerf te besoek.
