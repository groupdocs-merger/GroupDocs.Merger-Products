...
############################# Head ############################
head_title: "Podziel HTML na wiele plików w Java"
head_description: "Podziel pojedynczy plik HTML na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "HTML Rozdzielacz w Java"
description: "Podziel HTML z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik HTML według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku HTML na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik HTML za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik HTML za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik HTML online"
    content: |
       Podziel plik HTML już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
