...
############################# Head ############################
head_title: "A(z) CSV felosztása több fájlra a Java programban"
head_description: "Egyetlen CSV fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "CSV Splitter in Java"
description: "Oszd fel az CSV elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) CSV fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen CSV fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az CSV fájl felosztása a Java példakóddal">}}

        ```java    
        // Az CSV fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split CSV fájl online"
    content: |
       Ossza meg az CSV fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) webhely meglátogatásával.
