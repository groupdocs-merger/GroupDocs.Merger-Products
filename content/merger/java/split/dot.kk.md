...
############################# Head ############################
head_title: "DOT файлын Java ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "DOT Java ішіндегі бөлгіш"
description: "DOT кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "DOT файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір DOT файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // DOT файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
