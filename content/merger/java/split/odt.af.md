...
############################# Head ############################
head_title: "Verdeel ODT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele ODT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "ODT Splitter in Java"
description: "Verdeel ODT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel ODT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele ODT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel ODT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel ODT lêer aanlyn"
    content: |
       Verdeel ODT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) webwerf te besoek.
