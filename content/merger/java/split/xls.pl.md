...
############################# Head ############################
head_title: "Podziel XLS na wiele plików w Java"
head_description: "Podziel pojedynczy plik XLS na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "XLS Rozdzielacz w Java"
description: "Podziel XLS z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLS według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLS za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLS za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik XLS online"
    content: |
       Podziel plik XLS już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls).
