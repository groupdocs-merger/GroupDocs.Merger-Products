...
############################# Head ############################
head_title: "Sadaliet XPS vairākos failos programmā Java"
head_description: "Sadaliet vienu XPS failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XPS sadalītājs programmā Java"
description: "Sadaliet XPS ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XPS failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XPS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XPS failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XPS failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XPS failu tiešsaistē"
    content: |
       Sadaliet XPS failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps).
