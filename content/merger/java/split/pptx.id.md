...
############################# Head ############################
head_title: "Pecah dokumen PPTX dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk memecah file PPTX menjadi dokumen terpisah. Kelola PDF, file Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pecah file PPTX" 
description: "GroupDocs.Merger for Java meningkatkan aplikasi Java dengan menambahkan fitur pemrosesan dokumen yang canggih. Pecah file PPTX dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memecah file PPTX"
    content: |
      Dengan [GroupDocs.Merger](/merger/java/), Anda dapat memecah dokumen PPTX dan menyimpan halaman yang dipilih sebagai file baru. Integrasikan manajemen dokumen canggih ke dalam aplikasi Java Anda.
      
      1. Sediakan jalur sumber dari file PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pecah dokumen PPTX dan simpan halaman bernomor genap"
      content: |
        Contoh ini menunjukkan cara memecah dokumen PPTX dan menyimpan semua halaman bernomor genap sebagai file terpisah.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
