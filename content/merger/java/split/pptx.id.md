...
head_description: "Pisahkan satu file PPTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PPTX Pemisah Di Java"
description: "Pisahkan PPTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan PPTX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file PPTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file PPTX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file PPTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan PPTX File Online"
    content: |
       Pisahkan file PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/pptx).
