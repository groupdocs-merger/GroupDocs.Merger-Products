...
############################# Head ############################
head_title: "Podziel VDX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VDX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VDX Rozdzielacz w Java"
description: "Podziel VDX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VDX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VDX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VDX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VDX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VDX online"
    content: |
       Podziel plik VDX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
