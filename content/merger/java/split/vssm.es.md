...
############################# Head ############################
head_title: "Dividir VSSM en varios archivos en Java"
head_description: "Divida un solo archivo VSSM en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "VSSM Divisor en Java"
description: "Divida VSSM con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir VSSM archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo VSSM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo VSSM usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo VSSM usando GroupDocs.Merger para la API de Java
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir VSSM archivo en línea"
    content: |
       Divida el archivo VSSM ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
