...
############################# Head ############################
head_title: "Razdeli XLTX na več datotek v Java"
head_description: "Eno datoteko XLTX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XLTX razdelilnik v Java"
description: "Razdelite XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XLTX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XLTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XLTX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XLTX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XLTX datoteko na spletu"
    content: |
       Takoj razdelite datoteko XLTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
