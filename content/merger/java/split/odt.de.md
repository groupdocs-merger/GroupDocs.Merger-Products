...
############################# Head ############################
head_title: "Teilen Sie ODT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne ODT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "ODT Splittereingang Java"
description: "Teilen Sie ODT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "ODT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne ODT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die ODT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // ODT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - ODT-Datei online teilen"
    content: |
       Teilen Sie die Datei ODT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) besuchen.
