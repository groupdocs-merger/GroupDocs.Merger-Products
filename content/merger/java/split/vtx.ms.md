...
############################# Head ############################
head_title: "Pisahkan VTX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VTX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VTX Pemisah Dalam Java"
description: "Pisahkan VTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VTX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VTX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VTX Fail Dalam Talian"
    content: |
       Pisahkan fail VTX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx).
