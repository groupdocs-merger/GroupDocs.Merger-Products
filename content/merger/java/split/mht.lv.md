...
############################# Head ############################
head_title: "Sadaliet MHT vairākos failos programmā Java"
head_description: "Sadaliet vienu MHT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "MHT sadalītājs programmā Java"
description: "Sadaliet MHT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet MHT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu MHT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt MHT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet MHT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt MHT failu tiešsaistē"
    content: |
       Sadaliet MHT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
