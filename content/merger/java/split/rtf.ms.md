...
############################# Head ############################
head_title: "Pisahkan RTF kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail RTF kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "RTF Pemisah Dalam Java"
description: "Pisahkan RTF dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan RTF Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail RTF kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail RTF menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail RTF menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split RTF Fail Dalam Talian"
    content: |
       Pisahkan fail RTF sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
