...
############################# Head ############################
head_title: "Skiptu OTT í margar skrár í Java"
head_description: "Skiptu einni OTT skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "OTT Skerandi í Java"
description: "Skiptu OTT með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu OTT skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni OTT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta OTT skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu OTT skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu OTT skrá á netinu"
    content: |
       Skiptu OTT skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) vefsíðu.
