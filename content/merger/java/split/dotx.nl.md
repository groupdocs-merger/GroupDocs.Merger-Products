...
############################# Head ############################
head_title: "Splits DOTX in meerdere bestanden in Java"
head_description: "Splits een enkel DOTX bestand in meerdere bestanden op basis van paginanummers, pagina-intervallen, even of oneven pagina's met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "DOTX Splitter in Java"
description: "Splits DOTX met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits DOTX bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel DOTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een DOTX bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits DOTX bestand met behulp van GroupDocs.Merger voor Java API
...
demos:
    enable: true
    title: "Live demo's - DOTX bestand online splitsen"
    content: |
       Splits DOTX bestand nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) te gaan.
