...
############################# Head ############################
head_title: "Rozdělit CSV do více souborů v Java"
...
description: "Rozdělte CSV několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit CSV soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru CSV do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor CSV pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor CSV pomocí GroupDocs.Merger for Java API
