...
############################# Head ############################
head_title: "Pisahkan HTML kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail HTML kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "HTML Pemisah Dalam Java"
description: "Pisahkan HTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan HTML Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail HTML kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail HTML menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail HTML menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split HTML Fail Dalam Talian"
    content: |
       Pisahkan fail HTML sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
