...
############################# Head ############################
head_title: "Dividiu HTML en diversos fitxers a Java"
...
############################# Header ############################
title: "HTML Divisor a Java"
description: "Dividiu HTML amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer HTML per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer HTML en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer HTML mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer HTML mitjançant l'API de GroupDocs.Merger per a Java
