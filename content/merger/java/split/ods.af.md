...
############################# Head ############################
head_title: "Verdeel ODS in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele ODS-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "ODS Splitter in Java"
description: "Verdeel ODS met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel ODS lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele ODS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODS-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel ODS lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel ODS lêer aanlyn"
    content: |
       Verdeel ODS-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods) webwerf te besoek.
