...
############################# Head ############################
head_title: "Dividi XLSB in più file in Java"
...
############################# Header ############################
title: "XLSB Separatore in Java"
description: "Dividi XLSB con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file XLSB per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file XLSB in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file XLSB utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file XLSB utilizzando GroupDocs.Merger per l'API Java
