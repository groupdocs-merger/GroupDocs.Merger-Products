...
############################# Head ############################
head_title: "Dividiu OTP en diversos fitxers a Java"
head_description: "Dividiu un únic fitxer OTP en diversos fitxers segons els números de pàgina, els intervals de pàgina i les pàgines parells o senars mitjançant l'API de fusió de documents."

############################# Header ############################
title: "OTP Divisor a Java"
description: "Dividiu OTP amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer OTP per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer OTP en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer OTP mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer OTP mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    enable: true
    title: "Demostracions en directe: divideix el fitxer OTP en línia"
    content: |
       Dividiu el fitxer OTP ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
