...
############################# Head ############################
head_title: "Verdeel MHT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele MHT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "MHT Splitter in Java"
description: "Verdeel MHT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel MHT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele MHT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel MHT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel MHT lêer aanlyn"
    content: |
       Verdeel MHT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht) webwerf te besoek.
