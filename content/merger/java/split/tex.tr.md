...
############################# Head ############################
head_title: "TEX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir TEX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "TEX Ayırıcı Java"
description: "TEX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "TEX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TEX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak TEX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - TEX Dosyasını Çevrimiçi Böl"
    content: |
       TEX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) web sitesini ziyaret ederek bölün.
