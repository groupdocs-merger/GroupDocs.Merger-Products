...
############################# Head ############################
head_title: "Rozdeliť XLSB do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor XLSB do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "XLSB Splitter v Java"
description: "Rozdeľte XLSB niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť XLSB súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor XLSB na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLSB súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor XLSB pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru XLSB online"
    content: |
       Rozdeľte súbor XLSB hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
