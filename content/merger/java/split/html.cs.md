...
############################# Head ############################
head_title: "Rozdělit HTML do více souborů v Java"
head_description: "Rozdělte jeden soubor HTML do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "HTML Splitter v Java"
description: "Rozdělte HTML několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit HTML soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru HTML do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor HTML pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor HTML pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru HTML online"
    content: |
       Rozdělte soubor HTML právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
