...
############################# Head ############################
head_title: "Podziel TSV na wiele plików w Java"
head_description: "Podziel pojedynczy plik TSV na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "TSV Rozdzielacz w Java"
description: "Podziel TSV z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik TSV według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku TSV na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik TSV za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik TSV za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik TSV online"
    content: |
       Podziel plik TSV już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
