...
############################# Header ############################
title: "RTF Pemisah Di Java"
description: "Pisahkan RTF dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan RTF File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file RTF menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file RTF menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file RTF menggunakan GroupDocs.Merger untuk Java API
