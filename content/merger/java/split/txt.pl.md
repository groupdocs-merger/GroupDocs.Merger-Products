...
############################# Head ############################
head_title: "Podziel TXT na wiele plików w Java"
head_description: "Podziel pojedynczy plik TXT na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "TXT Rozdzielacz w Java"
description: "Podziel TXT z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik TXT według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku TXT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik TXT za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik TXT za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik TXT online"
    content: |
       Podziel plik TXT już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
