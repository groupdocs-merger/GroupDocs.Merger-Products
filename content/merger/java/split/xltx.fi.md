...
############################# Head ############################
head_title: "Jaa XLTX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLTX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLTX Jakaja sisään Java"
description: "Jaa XLTX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLTX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLTX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLTX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLTX tiedosto verkossa"
    content: |
       Jaa tiedosto XLTX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx) -sivustolla.
