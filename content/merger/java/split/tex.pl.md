...
############################# Head ############################
head_title: "Podziel TEX na wiele plików w Java"
head_description: "Podziel pojedynczy plik TEX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "TEX Rozdzielacz w Java"
description: "Podziel TEX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik TEX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku TEX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik TEX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik TEX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik TEX online"
    content: |
       Podziel plik TEX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
