...
############################# Head ############################
head_title: "Dividir XLAM en varios archivos en Java"
...
############################# Header ############################
title: "XLAM Divisor en Java"
description: "Divida XLAM con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir XLAM archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo XLAM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo XLAM usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo XLAM usando GroupDocs.Merger para la API de Java
