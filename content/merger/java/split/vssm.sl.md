...
############################# Head ############################
head_title: "Razdeli VSSM na več datotek v Java"
head_description: "Eno datoteko VSSM razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VSSM razdelilnik v Java"
description: "Razdelite VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VSSM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VSSM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VSSM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VSSM z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VSSM datoteko na spletu"
    content: |
       Takoj razdelite datoteko VSSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
