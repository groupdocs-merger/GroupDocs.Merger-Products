...
############################# Head ############################
head_title: "Skiptu RTF í margar skrár í Java"
head_description: "Skiptu einni RTF skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "RTF Skerandi í Java"
description: "Skiptu RTF með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu RTF skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni RTF skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta RTF skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu RTF skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu RTF skrá á netinu"
    content: |
       Skiptu RTF skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) vefsíðu.
