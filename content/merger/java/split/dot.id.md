...
############################# Head ############################
head_title: "Pisahkan DOT menjadi Beberapa File di Java"
head_description: "Pisahkan satu file DOT menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOT Pemisah Di Java"
description: "Pisahkan DOT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOT File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file DOT menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file DOT menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file DOT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan DOT File Online"
    content: |
       Pisahkan file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/dot).
