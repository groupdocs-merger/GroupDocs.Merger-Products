...
############################# Head ############################
head_title: "Sadaliet MHTML vairākos failos programmā Java"
head_description: "Sadaliet vienu MHTML failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "MHTML sadalītājs programmā Java"
description: "Sadaliet MHTML ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet MHTML failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu MHTML failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt MHTML failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet MHTML failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt MHTML failu tiešsaistē"
    content: |
       Sadaliet MHTML failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
