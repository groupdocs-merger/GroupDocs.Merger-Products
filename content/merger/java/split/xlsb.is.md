...
############################# Head ############################
head_title: "Skiptu XLSB í margar skrár í Java"
head_description: "Skiptu einni XLSB skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XLSB Skerandi í Java"
description: "Skiptu XLSB með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSB skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLSB skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSB skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLSB skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XLSB skrá á netinu"
    content: |
       Skiptu XLSB skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) vefsíðu.
