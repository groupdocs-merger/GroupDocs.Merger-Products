...
date: 2022-09-13T13:31:08
draft: false
otherformats: otp ott pdf pps ppsx ppt pptx rtf tex vdx vsdm vsdx vssm vssx vstm vstx

############################# Head ############################
head_title: "Split ODT into Multiple Files in Java"
head_description: "Split a single ODT file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "ODT Splitter In Java"
description: "Split ODT with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single ODT file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split ODT file using Java example code">}}

        ```java    
        // Split ODT file using GroupDocs.Merger for Java API
