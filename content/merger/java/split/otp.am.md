...
############################# Head ############################
head_title: "OTPን በJava ውስጥ ወደ ብዙ ፋይሎች ተከፋፍል"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም አንድ ነጠላ OTP ፋይል በገጽ ቁጥሮች፣ የገጽ ክፍተቶች፣ አልፎ ተርፎም ወይም ያልተለመዱ ገጾችን ወደ ብዙ ፋይሎች ይከፋፍሉ።"

############################# Header ############################
title: "OTP Splitter በJava ውስጥ"
description: "OTPን በጥቂት የJava ኮድ መስመሮች ተከፍል።"
...
steps:
    enable: true
    title_left: "OTP ፋይል በገጽ በJava ክፈል"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች አንድን ነጠላ OTP ፋይል በመተግበር ወደ ብዙ የውጤት ፋይሎች መከፋፈል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP ፋይልን Java ምሳሌ ኮድን በመጠቀም እንዴት እንደሚከፋፈል">}}

        ```java    
        // GroupDocs.Mergerን ለጃቫ ኤፒአይ በመጠቀም OTP ፋይል ክፈሉ።
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የተከፈለ OTP ፋይል በመስመር ላይ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) ድር ጣቢያን በመጎብኘት የOTP ፋይል አሁኑኑ ይከፋፍሉ።
