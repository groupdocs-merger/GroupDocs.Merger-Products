...
############################# Head ############################
head_title: "Skiptu HTML í margar skrár í Java"
head_description: "Skiptu einni HTML skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "HTML Skerandi í Java"
description: "Skiptu HTML með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu HTML skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni HTML skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta HTML skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu HTML skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu HTML skrá á netinu"
    content: |
       Skiptu HTML skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html) vefsíðu.
