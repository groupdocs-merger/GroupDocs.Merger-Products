...
############################# Head ############################
head_title: "Pisahkan XLTX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLTX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLTX Pemisah Dalam Java"
description: "Pisahkan XLTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLTX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLTX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLTX Fail Dalam Talian"
    content: |
       Pisahkan fail XLTX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
