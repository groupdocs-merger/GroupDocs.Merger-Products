...
############################# Head ############################
head_title: "XPS'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XPS dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XPS Ayırıcı Java"
description: "XPS kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XPS Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XPS dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XPS dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XPS Dosyasını Çevrimiçi Böl"
    content: |
       XPS dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) web sitesini ziyaret ederek bölün.
