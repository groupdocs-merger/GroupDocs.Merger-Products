...
############################# Head ############################
head_title: "Rozdeliť ODP do viacerých súborov v Java"
...
description: "Rozdeľte ODP niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť ODP súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor ODP na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ODP súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor ODP pomocou rozhrania GroupDocs.Merger for Java API
