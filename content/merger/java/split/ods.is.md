...
############################# Head ############################
head_title: "Skiptu ODS í margar skrár í Java"
head_description: "Skiptu einni ODS skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "ODS Skerandi í Java"
description: "Skiptu ODS með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODS skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni ODS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODS skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu ODS skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu ODS skrá á netinu"
    content: |
       Skiptu ODS skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods) vefsíðu.
