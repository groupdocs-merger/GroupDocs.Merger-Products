...
############################# Head ############################
head_title: "Podziel VSX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSX Rozdzielacz w Java"
description: "Podziel VSX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSX online"
    content: |
       Podziel plik VSX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx).
