...
############################# Head ############################
head_title: "Verdeel VSX in veelvuldige lêers in Java"
...
description: "Verdeel VSX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSX lêer deur GroupDocs.Merger vir Java API te gebruik
