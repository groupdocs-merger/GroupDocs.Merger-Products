...
############################# Head ############################
head_title: "Jagage HTML mitmeks failiks rakenduses Java"
...
description: "Tükeldage HTML mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage HTML fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks HTML-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili HTML, kasutades Java näidet">}}

        ```java    
        // Jagage fail HTML, kasutades GroupDocs.Merger for Java API-t
