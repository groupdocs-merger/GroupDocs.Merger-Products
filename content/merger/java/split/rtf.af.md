...
############################# Head ############################
head_title: "Verdeel RTF in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele RTF-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "RTF Splitter in Java"
description: "Verdeel RTF met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel RTF lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele RTF-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om RTF-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel RTF lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel RTF lêer aanlyn"
    content: |
       Verdeel RTF-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) webwerf te besoek.
