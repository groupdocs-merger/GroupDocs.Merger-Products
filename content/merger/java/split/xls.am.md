...
steps:
    enable: true
    title_left: "XLS ፋይል በገጽ በJava ክፈል"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS ፋይልን Java ምሳሌ ኮድን በመጠቀም እንዴት እንደሚከፋፈል">}}

        ```java    
        // GroupDocs.Mergerን ለጃቫ ኤፒአይ በመጠቀም XLS ፋይል ክፈሉ።
