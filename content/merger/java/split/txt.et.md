...
############################# Head ############################
head_title: "Jagage TXT mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail TXT mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "TXT Splitter in Java"
description: "Tükeldage TXT mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage TXT fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks TXT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili TXT, kasutades Java näidet">}}

        ```java    
        // Jagage fail TXT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – TXT faili jagamine võrgus"
    content: |
       Tükeldage fail TXT kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
