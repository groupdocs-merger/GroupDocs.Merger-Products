...
############################# Head ############################
head_title: "Jagage XLAM mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail XLAM mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "XLAM Splitter in Java"
description: "Tükeldage XLAM mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLAM fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks XLAM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili XLAM, kasutades Java näidet">}}

        ```java    
        // Jagage fail XLAM, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – XLAM faili jagamine võrgus"
    content: |
       Tükeldage fail XLAM kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam).
