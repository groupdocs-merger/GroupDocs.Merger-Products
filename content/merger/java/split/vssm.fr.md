...
############################# Head ############################
head_title: "Divisez VSSM en plusieurs fichiers dans Java"
head_description: "Divisez un seul fichier VSSM en plusieurs fichiers en fonction des numéros de page, des intervalles de page, des pages paires ou impaires à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "VSSM Séparateur dans Java"
description: "Divisez VSSM avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Diviser le fichier VSSM par pages dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de diviser facilement un seul fichier VSSM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser le fichier VSSM à l'aide de l'exemple de code Java">}}

        ```java    
        // Diviser le fichier VSSM à l'aide de GroupDocs.Merger pour l'API Java
...
demos:
    enable: true
    title: "Démos en direct – Diviser le fichier VSSM en ligne"
    content: |
       Divisez le fichier VSSM dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
