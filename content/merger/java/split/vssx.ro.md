...
############################# Head ############################
head_title: "Împărțiți VSSX în mai multe fișiere în Java"
...
############################# Header ############################
title: "Splitter VSSX în Java"
description: "Împărțiți VSSX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul VSSX după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier VSSX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul VSSX folosind codul exemplu Java">}}

        ```java    
        // Împărțiți fișierul VSSX utilizând API-ul GroupDocs.Merger pentru Java
