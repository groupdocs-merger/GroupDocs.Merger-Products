...
############################# Head ############################
head_title: "Podziel VSTM na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSTM na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSTM Rozdzielacz w Java"
description: "Podziel VSTM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSTM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSTM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSTM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSTM za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSTM online"
    content: |
       Podziel plik VSTM już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
