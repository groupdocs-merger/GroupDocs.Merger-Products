...
############################# Head ############################
head_title: "Skiptu VTX í margar skrár í Java"
head_description: "Skiptu einni VTX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VTX Skerandi í Java"
description: "Skiptu VTX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VTX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VTX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VTX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VTX skrá á netinu"
    content: |
       Skiptu VTX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) vefsíðu.
