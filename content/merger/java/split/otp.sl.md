...
############################# Head ############################
head_title: "Razdeli OTP na več datotek v Java"
head_description: "Eno datoteko OTP razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "OTP razdelilnik v Java"
description: "Razdelite OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko OTP po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke OTP na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko OTP s primerom kode Java">}}

        ```java    
        // Razdeli datoteko OTP z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli OTP datoteko na spletu"
    content: |
       Takoj razdelite datoteko OTP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
