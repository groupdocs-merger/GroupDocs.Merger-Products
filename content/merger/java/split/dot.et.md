...
############################# Head ############################
head_title: "Jagage DOT mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail DOT mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "DOT Splitter in Java"
description: "Tükeldage DOT mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOT fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOT, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – DOT faili jagamine võrgus"
    content: |
       Tükeldage fail DOT kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot).
