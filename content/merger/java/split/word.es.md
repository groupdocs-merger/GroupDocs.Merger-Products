...
############################# Head ############################
head_title: "Dividir WORD en varios archivos en Java"
head_description: "Divida un solo archivo WORD en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "WORD Divisor en Java"
description: "Divida WORD con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir WORD archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo WORD en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo WORD usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo WORD usando GroupDocs.Merger para la API de Java
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir WORD archivo en línea"
    content: |
       Divida el archivo WORD ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/word).
