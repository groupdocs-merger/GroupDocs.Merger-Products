...
############################# Head ############################
head_title: "Pisahkan PPS kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail PPS kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PPS Pemisah Dalam Java"
description: "Pisahkan PPS dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan PPS Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail PPS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail PPS menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail PPS menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split PPS Fail Dalam Talian"
    content: |
       Pisahkan fail PPS sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps).
