...
############################# Head ############################
head_title: "Sadaliet DOCM vairākos failos programmā Java"
...
############################# Header ############################
title: "DOCM sadalītājs programmā Java"
description: "Sadaliet DOCM ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOCM failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu DOCM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOCM failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet DOCM failu, izmantojot GroupDocs.Merger for Java API
