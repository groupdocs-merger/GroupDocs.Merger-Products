...
############################# Head ############################
head_title: "Skiptu VSX í margar skrár í Java"
head_description: "Skiptu einni VSX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSX Skerandi í Java"
description: "Skiptu VSX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSX skrá á netinu"
    content: |
       Skiptu VSX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx) vefsíðu.
