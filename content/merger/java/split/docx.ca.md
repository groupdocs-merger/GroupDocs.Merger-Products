...
############################# Head ############################
head_title: "Dividiu DOCX en diversos fitxers a Java"
head_description: "Dividiu un únic fitxer DOCX en diversos fitxers segons els números de pàgina, els intervals de pàgina i les pàgines parells o senars mitjançant l'API de fusió de documents."

############################# Header ############################
title: "DOCX Divisor a Java"
description: "Dividiu DOCX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer DOCX per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer DOCX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer DOCX mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer DOCX mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    enable: true
    title: "Demostracions en directe: divideix el fitxer DOCX en línia"
    content: |
       Dividiu el fitxer DOCX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
