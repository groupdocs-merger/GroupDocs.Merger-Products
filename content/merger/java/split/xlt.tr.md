...
############################# Head ############################
head_title: "XLT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLT Ayırıcı Java"
description: "XLT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLT Dosyasını Çevrimiçi Böl"
    content: |
       XLT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt) web sitesini ziyaret ederek bölün.
