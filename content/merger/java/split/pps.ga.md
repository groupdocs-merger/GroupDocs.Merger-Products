...
############################# Head ############################
head_title: "Scoilt PPS ina Ilchomhaid i Java"
...
############################# Header ############################
title: "PPS Scoilteoir i Java"
description: "Scoilt PPS le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt PPS Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin PPS a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad PPS a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt PPS comhad ag baint úsáide as GroupDocs.Merger do Java API
