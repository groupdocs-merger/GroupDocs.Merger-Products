...
############################# Head ############################
head_title: "Rozdělit TSV do více souborů v Java"
head_description: "Rozdělte jeden soubor TSV do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "TSV Splitter v Java"
description: "Rozdělte TSV několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit TSV soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru TSV do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor TSV pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor TSV pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru TSV online"
    content: |
       Rozdělte soubor TSV právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
