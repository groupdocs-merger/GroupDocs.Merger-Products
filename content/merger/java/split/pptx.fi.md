...
############################# Head ############################
head_title: "Jaa PPTX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen PPTX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "PPTX Jakaja sisään Java"
description: "Jaa PPTX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto PPTX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden PPTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPTX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto PPTX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa PPTX tiedosto verkossa"
    content: |
       Jaa tiedosto PPTX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) -sivustolla.
