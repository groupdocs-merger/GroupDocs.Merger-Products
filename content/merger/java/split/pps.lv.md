...
############################# Head ############################
head_title: "Sadaliet PPS vairākos failos programmā Java"
head_description: "Sadaliet vienu PPS failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "PPS sadalītājs programmā Java"
description: "Sadaliet PPS ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPS failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu PPS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPS failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet PPS failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt PPS failu tiešsaistē"
    content: |
       Sadaliet PPS failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps).
