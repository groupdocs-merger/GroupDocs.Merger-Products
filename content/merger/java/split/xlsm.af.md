...
############################# Head ############################
head_title: "Verdeel XLSM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLSM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLSM Splitter in Java"
description: "Verdeel XLSM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLSM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLSM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLSM lêer aanlyn"
    content: |
       Verdeel XLSM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm) webwerf te besoek.
