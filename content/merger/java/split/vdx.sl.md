...
############################# Head ############################
head_title: "Razdeli VDX na več datotek v Java"
head_description: "Eno datoteko VDX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VDX razdelilnik v Java"
description: "Razdelite VDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VDX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VDX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VDX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VDX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VDX datoteko na spletu"
    content: |
       Takoj razdelite datoteko VDX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
