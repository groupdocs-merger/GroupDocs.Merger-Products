...
head_description: "Pisahkan satu file DOTM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOTM Pemisah Di Java"
description: "Pisahkan DOTM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOTM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file DOTM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file DOTM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file DOTM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan DOTM File Online"
    content: |
       Pisahkan file DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/dotm).
