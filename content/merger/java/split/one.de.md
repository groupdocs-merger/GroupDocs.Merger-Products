...
############################# Head ############################
head_title: "Teilen Sie ONE in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne ONE-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "ONE Splittereingang Java"
description: "Teilen Sie ONE mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "ONE-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne ONE-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die ONE-Datei mit dem Java-Beispielcode">}}

        ```java    
        // ONE-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - ONE-Datei online teilen"
    content: |
       Teilen Sie die Datei ONE jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) besuchen.
