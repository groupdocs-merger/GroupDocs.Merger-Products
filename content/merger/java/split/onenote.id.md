...
head_description: "Pisahkan satu file ONENOTE menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "ONENOTE Pemisah Di Java"
description: "Pisahkan ONENOTE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan ONENOTE File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file ONENOTE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file ONENOTE menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file ONENOTE menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan ONENOTE File Online"
    content: |
       Pisahkan file ONENOTE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/onenote).
