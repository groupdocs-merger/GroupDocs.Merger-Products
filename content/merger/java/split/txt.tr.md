...
############################# Head ############################
head_title: "TXT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir TXT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "TXT Ayırıcı Java"
description: "TXT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "TXT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TXT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak TXT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - TXT Dosyasını Çevrimiçi Böl"
    content: |
       TXT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) web sitesini ziyaret ederek bölün.
