...
############################# Head ############################
head_title: "Sadaliet VSTM vairākos failos programmā Java"
head_description: "Sadaliet vienu VSTM failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSTM sadalītājs programmā Java"
description: "Sadaliet VSTM ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSTM failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSTM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSTM failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSTM failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSTM failu tiešsaistē"
    content: |
       Sadaliet VSTM failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
