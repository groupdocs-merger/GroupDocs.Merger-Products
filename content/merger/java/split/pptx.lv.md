...
############################# Head ############################
head_title: "Sadaliet PPTX vairākos failos programmā Java"
head_description: "Sadaliet vienu PPTX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "PPTX sadalītājs programmā Java"
description: "Sadaliet PPTX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPTX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu PPTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPTX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet PPTX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt PPTX failu tiešsaistē"
    content: |
       Sadaliet PPTX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
