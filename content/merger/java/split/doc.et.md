...
############################# Head ############################
head_title: "Jagage DOC mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail DOC mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "DOC Splitter in Java"
description: "Tükeldage DOC mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOC fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOC-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOC, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOC, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – DOC faili jagamine võrgus"
    content: |
       Tükeldage fail DOC kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
