...
############################# Head ############################
head_title: "Jaa TSV useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen TSV-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "TSV Jakaja sisään Java"
description: "Jaa TSV muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto TSV sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden TSV-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TSV tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto TSV GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa TSV tiedosto verkossa"
    content: |
       Jaa tiedosto TSV heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) -sivustolla.
