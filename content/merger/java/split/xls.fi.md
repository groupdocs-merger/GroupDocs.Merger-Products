...
############################# Head ############################
head_title: "Jaa XLS useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLS-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLS Jakaja sisään Java"
description: "Jaa XLS muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLS sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLS tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLS GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLS tiedosto verkossa"
    content: |
       Jaa tiedosto XLS heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls) -sivustolla.
