...
############################# Head ############################
head_title: "Jagage ODS mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail ODS mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "ODS Splitter in Java"
description: "Tükeldage ODS mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage ODS fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks ODS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili ODS, kasutades Java näidet">}}

        ```java    
        // Jagage fail ODS, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – ODS faili jagamine võrgus"
    content: |
       Tükeldage fail ODS kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
