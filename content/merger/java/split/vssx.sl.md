...
############################# Head ############################
head_title: "Razdeli VSSX na več datotek v Java"
head_description: "Eno datoteko VSSX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VSSX razdelilnik v Java"
description: "Razdelite VSSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VSSX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VSSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VSSX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VSSX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VSSX datoteko na spletu"
    content: |
       Takoj razdelite datoteko VSSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
