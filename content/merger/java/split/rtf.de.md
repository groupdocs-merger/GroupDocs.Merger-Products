...
############################# Head ############################
head_title: "Teilen Sie RTF in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne RTF-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "RTF Splittereingang Java"
description: "Teilen Sie RTF mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "RTF-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne RTF-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die RTF-Datei mit dem Java-Beispielcode">}}

        ```java    
        // RTF-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - RTF-Datei online teilen"
    content: |
       Teilen Sie die Datei RTF jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) besuchen.
