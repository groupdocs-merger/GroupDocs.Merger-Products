...
############################# Head ############################
head_title: "Jaa XLAM useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLAM-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLAM Jakaja sisään Java"
description: "Jaa XLAM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLAM sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLAM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLAM tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLAM GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLAM tiedosto verkossa"
    content: |
       Jaa tiedosto XLAM heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) -sivustolla.
