...
############################# Head ############################
head_title: "Di Java de MHT li Pir Pelan veqetînin"
...
############################# Header ############################
title: "MHT Splitter Li Java"
description: "MHT bi çend rêzikên koda Java parçe bikin."
...
steps:
    enable: true
    title_left: "Di Java de MHT Pelê Li gorî Rûpelan veqetînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebiranên Java re hêsan dike ku pelek yek MHT li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelê MHT bi karanîna koda nimûneya Java parçe dike">}}

        ```java    
        // Pelê MHT bi karanîna GroupDocs.Merger ji bo Java API-ê veqetînin
