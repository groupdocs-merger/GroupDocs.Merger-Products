...
############################# Head ############################
head_title: "Rozdeliť ODT do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor ODT do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "ODT Splitter v Java"
description: "Rozdeľte ODT niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť ODT súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor ODT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ODT súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor ODT pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru ODT online"
    content: |
       Rozdeľte súbor ODT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
