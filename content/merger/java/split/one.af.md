...
############################# Head ############################
head_title: "Verdeel ONE in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele ONE-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "ONE Splitter in Java"
description: "Verdeel ONE met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel ONE lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele ONE-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ONE-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel ONE lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel ONE lêer aanlyn"
    content: |
       Verdeel ONE-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) webwerf te besoek.
