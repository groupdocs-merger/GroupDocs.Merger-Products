...
############################# Head ############################
head_title: "Διαχωρίστε το EPUB σε πολλά αρχεία στο Java"
head_description: "Διαχωρίστε ένα αρχείο EPUB σε πολλά αρχεία με βάση αριθμούς σελίδων, διαστήματα σελίδων, ζυγές ή μονές σελίδες χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "EPUB Splitter σε Java"
description: "Διαχωρίστε το EPUB με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Διαχωρισμός αρχείου EPUB ανά σελίδες στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να χωρίσουν ένα μεμονωμένο αρχείο EPUB σε πολλά προκύπτοντα αρχεία εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να χωρίσετε το αρχείο EPUB χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Διαχωρίστε το αρχείο EPUB χρησιμοποιώντας το GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Διαχωρισμός αρχείων EPUB στο Διαδίκτυο"
    content: |
       Διαχωρίστε το αρχείο EPUB τώρα, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
