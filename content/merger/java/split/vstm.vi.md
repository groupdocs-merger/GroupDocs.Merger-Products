...
############################# Head ############################
head_title: "Tách VSTM thành nhiều tệp trong Java"
head_description: "Tách một tệp VSTM thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "VSTM Splitter trong Java"
description: "Tách VSTM bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp VSTM theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp VSTM thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp VSTM bằng mã mẫu Java">}}

        ```java    
        // Tách tệp VSTM bằng GroupDocs.Merger cho Java API
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Tách tệp VSTM Trực tuyến"
    content: |
       Tách tệp VSTM ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos] (https://products.groupdocs.app/splitter/ vstm) trang web.
