...
############################# Head ############################
head_title: "ODP'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir ODP dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "ODP Ayırıcı Java"
description: "ODP kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODP Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODP dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODP dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - ODP Dosyasını Çevrimiçi Böl"
    content: |
       ODP dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp) web sitesini ziyaret ederek bölün.
