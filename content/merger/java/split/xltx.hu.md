...
############################# Head ############################
head_title: "A(z) XLTX felosztása több fájlra a Java programban"
head_description: "Egyetlen XLTX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTX Splitter in Java"
description: "Oszd fel az XLTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) XLTX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen XLTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az XLTX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az XLTX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split XLTX fájl online"
    content: |
       Ossza meg az XLTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx) webhely meglátogatásával.
