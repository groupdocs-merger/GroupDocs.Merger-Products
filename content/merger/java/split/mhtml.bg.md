...
############################# Head ############################
head_title: "Разделете MHTML на няколко файла в Java"
head_description: "Разделете един файл MHTML на няколко файла въз основа на номера на страници, интервали между страници, четни или нечетни страници, като използвате API за сливане на документи."

############################# Header ############################
title: "MHTML Сплитер в Java"
description: "Разделете MHTML с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете MHTML файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл MHTML на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл MHTML с примерен код на Java">}}

        ```java    
        // Разделете MHTML файл с помощта на GroupDocs.Merger за Java API
...
demos:
    enable: true
    title: "Демонстрации на живо - Разделете MHTML файл онлайн"
    content: |
       Разделете файла MHTML веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
