...
############################# Head ############################
head_title: "Podziel PPSX na wiele plików w Java"
head_description: "Podziel pojedynczy plik PPSX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "PPSX Rozdzielacz w Java"
description: "Podziel PPSX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik PPSX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku PPSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik PPSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik PPSX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik PPSX online"
    content: |
       Podziel plik PPSX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx).
