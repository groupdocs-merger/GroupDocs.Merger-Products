...
############################# Head ############################
head_title: "Podijeli DOCX u više datoteka u Java"
head_description: "Podijelite jednu DOCX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "DOCX Splitter u Java"
description: "Podijelite DOCX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli DOCX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne DOCX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOCX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli DOCX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split DOCX datoteka na mreži"
    content: |
       Podijeli DOCX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) web mjesto.
