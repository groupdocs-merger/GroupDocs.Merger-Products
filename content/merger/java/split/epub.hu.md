...
############################# Head ############################
head_title: "A(z) EPUB felosztása több fájlra a Java programban"
head_description: "Egyetlen EPUB fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "EPUB Splitter in Java"
description: "Oszd fel az EPUB elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) EPUB fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen EPUB fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az EPUB fájl felosztása a Java példakóddal">}}

        ```java    
        // Az EPUB fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split EPUB fájl online"
    content: |
       Ossza meg az EPUB fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) webhely meglátogatásával.
