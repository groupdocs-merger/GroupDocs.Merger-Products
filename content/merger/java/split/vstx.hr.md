...
############################# Head ############################
head_title: "Podijeli VSTX u više datoteka u Java"
head_description: "Podijelite jednu VSTX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "VSTX Splitter u Java"
description: "Podijelite VSTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VSTX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VSTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSTX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VSTX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split VSTX datoteka na mreži"
    content: |
       Podijeli VSTX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) web mjesto.
