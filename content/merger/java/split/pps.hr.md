...
############################# Head ############################
head_title: "Podijeli PPS u više datoteka u Java"
...
############################# Header ############################
title: "PPS Splitter u Java"
description: "Podijelite PPS s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli PPS datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne PPS datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPS datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli PPS datoteku koristeći GroupDocs.Merger za Java API
