...
head_description: "Pisahkan satu file VSSM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSSM Pemisah Di Java"
description: "Pisahkan VSSM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSSM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSSM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSSM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSSM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSSM File Online"
    content: |
       Pisahkan file VSSM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vssm).
