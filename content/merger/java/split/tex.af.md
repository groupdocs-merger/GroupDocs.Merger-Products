...
############################# Head ############################
head_title: "Verdeel TEX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele TEX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "TEX Splitter in Java"
description: "Verdeel TEX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel TEX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele TEX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TEX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel TEX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel TEX lêer aanlyn"
    content: |
       Verdeel TEX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) webwerf te besoek.
