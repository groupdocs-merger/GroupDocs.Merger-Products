...
############################# Head ############################
head_title: "Jaa TXT useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen TXT-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "TXT Jakaja sisään Java"
description: "Jaa TXT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto TXT sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden TXT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TXT tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto TXT GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa TXT tiedosto verkossa"
    content: |
       Jaa tiedosto TXT heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) -sivustolla.
