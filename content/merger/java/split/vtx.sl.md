...
############################# Head ############################
head_title: "Razdeli VTX na več datotek v Java"
head_description: "Eno datoteko VTX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VTX razdelilnik v Java"
description: "Razdelite VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VTX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VTX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VTX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VTX datoteko na spletu"
    content: |
       Takoj razdelite datoteko VTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx).
