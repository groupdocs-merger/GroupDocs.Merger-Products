...
############################# Head ############################
head_title: "Divisez VISIO en plusieurs fichiers dans Java"
...
############################# Header ############################
title: "VISIO Séparateur dans Java"
description: "Divisez VISIO avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Diviser le fichier VISIO par pages dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de diviser facilement un seul fichier VISIO en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser le fichier VISIO à l'aide de l'exemple de code Java">}}

        ```java    
        // Diviser le fichier VISIO à l'aide de GroupDocs.Merger pour l'API Java
