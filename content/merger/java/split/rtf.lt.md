...
############################# Head ############################
head_title: "Padalinkite RTF į kelis failus Java"
head_description: "Padalinkite vieną RTF failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "RTF skirstytuvas Java"
description: "Padalinkite RTF keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite RTF failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną RTF failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti RTF failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite RTF failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite RTF failą internete"
    content: |
       Padalykite RTF failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) svetainėje.
