...
############################# Head ############################
head_title: "Jagage ODT mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail ODT mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "ODT Splitter in Java"
description: "Tükeldage ODT mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage ODT fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks ODT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili ODT, kasutades Java näidet">}}

        ```java    
        // Jagage fail ODT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – ODT faili jagamine võrgus"
    content: |
       Tükeldage fail ODT kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
