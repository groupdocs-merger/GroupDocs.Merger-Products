...
############################# Head ############################
head_title: "Razdeli ODS na več datotek v Java"
head_description: "Eno datoteko ODS razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "ODS razdelilnik v Java"
description: "Razdelite ODS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko ODS po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke ODS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko ODS s primerom kode Java">}}

        ```java    
        // Razdeli datoteko ODS z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli ODS datoteko na spletu"
    content: |
       Takoj razdelite datoteko ODS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
