...
############################# Head ############################
head_title: "Skiptu PPT í margar skrár í Java"
head_description: "Skiptu einni PPT skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "PPT Skerandi í Java"
description: "Skiptu PPT með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPT skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni PPT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPT skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu PPT skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu PPT skrá á netinu"
    content: |
       Skiptu PPT skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt) vefsíðu.
