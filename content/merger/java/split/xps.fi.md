...
############################# Head ############################
head_title: "Jaa XPS useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XPS-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XPS Jakaja sisään Java"
description: "Jaa XPS muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XPS sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XPS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XPS tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XPS GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XPS tiedosto verkossa"
    content: |
       Jaa tiedosto XPS heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) -sivustolla.
