...
############################# Head ############################
head_title: "PPT'i Java İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "PPT Ayırıcı Java"
description: "PPT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PPT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PPT dosyasını ayırın
