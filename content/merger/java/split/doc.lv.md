...
############################# Head ############################
head_title: "Sadaliet DOC vairākos failos programmā Java"
head_description: "Sadaliet vienu DOC failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "DOC sadalītājs programmā Java"
description: "Sadaliet DOC ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOC failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu DOC failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOC failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet DOC failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt DOC failu tiešsaistē"
    content: |
       Sadaliet DOC failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
