...
############################# Head ############################
head_title: "Rozdeliť ONE do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor ONE do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "ONE Splitter v Java"
description: "Rozdeľte ONE niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť ONE súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor ONE na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ONE súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor ONE pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru ONE online"
    content: |
       Rozdeľte súbor ONE hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
