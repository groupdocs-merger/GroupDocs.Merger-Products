...
############################# Head ############################
head_title: "Sadaliet XLT vairākos failos programmā Java"
...
############################# Header ############################
title: "XLT sadalītājs programmā Java"
description: "Sadaliet XLT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLT failu, izmantojot GroupDocs.Merger for Java API
