...
############################# Head ############################
head_title: "Pisahkan DOCX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail DOCX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOCX Pemisah Dalam Java"
description: "Pisahkan DOCX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOCX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail DOCX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail DOCX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail DOCX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split DOCX Fail Dalam Talian"
    content: |
       Pisahkan fail DOCX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
