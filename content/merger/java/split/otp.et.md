...
############################# Head ############################
head_title: "Jagage OTP mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail OTP mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "OTP Splitter in Java"
description: "Tükeldage OTP mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage OTP fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks OTP-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili OTP, kasutades Java näidet">}}

        ```java    
        // Jagage fail OTP, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – OTP faili jagamine võrgus"
    content: |
       Tükeldage fail OTP kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
