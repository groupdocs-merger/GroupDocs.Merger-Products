...
############################# Head ############################
head_title: "Podziel DOCM na wiele plików w Java"
head_description: "Podziel pojedynczy plik DOCM na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "DOCM Rozdzielacz w Java"
description: "Podziel DOCM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik DOCM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku DOCM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik DOCM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik DOCM za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik DOCM online"
    content: |
       Podziel plik DOCM już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm).
