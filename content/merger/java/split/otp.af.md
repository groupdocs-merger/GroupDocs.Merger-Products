...
############################# Head ############################
head_title: "Verdeel OTP in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele OTP-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "OTP Splitter in Java"
description: "Verdeel OTP met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel OTP lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele OTP-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTP-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel OTP lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel OTP lêer aanlyn"
    content: |
       Verdeel OTP-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) webwerf te besoek.
