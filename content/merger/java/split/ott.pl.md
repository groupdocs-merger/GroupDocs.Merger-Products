...
############################# Head ############################
head_title: "Podziel OTT na wiele plików w Java"
...
############################# Header ############################
title: "OTT Rozdzielacz w Java"
description: "Podziel OTT z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik OTT według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku OTT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik OTT za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik OTT za pomocą GroupDocs.Merger for Java API
