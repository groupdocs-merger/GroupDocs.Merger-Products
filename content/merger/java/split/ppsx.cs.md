...
############################# Head ############################
head_title: "Rozdělit PPSX do více souborů v Java"
head_description: "Rozdělte jeden soubor PPSX do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "PPSX Splitter v Java"
description: "Rozdělte PPSX několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit PPSX soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru PPSX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor PPSX pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor PPSX pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru PPSX online"
    content: |
       Rozdělte soubor PPSX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx).
