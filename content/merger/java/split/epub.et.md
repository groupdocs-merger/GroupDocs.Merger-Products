...
############################# Head ############################
head_title: "Jagage EPUB mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail EPUB mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "EPUB Splitter in Java"
description: "Tükeldage EPUB mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage EPUB fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks EPUB-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili EPUB, kasutades Java näidet">}}

        ```java    
        // Jagage fail EPUB, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – EPUB faili jagamine võrgus"
    content: |
       Tükeldage fail EPUB kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
