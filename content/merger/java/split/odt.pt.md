...
############################# Head ############################
head_title: "Divida ODT em vários arquivos em Java"
...
############################# Header ############################
title: "ODT Divisor em Java"
description: "Divida ODT com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir ODT arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo ODT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo ODT usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo ODT usando GroupDocs.Merger for Java API
