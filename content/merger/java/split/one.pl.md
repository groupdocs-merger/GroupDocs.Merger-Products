...
############################# Head ############################
head_title: "Podziel ONE na wiele plików w Java"
head_description: "Podziel pojedynczy plik ONE na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "ONE Rozdzielacz w Java"
description: "Podziel ONE z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik ONE według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku ONE na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik ONE za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik ONE za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik ONE online"
    content: |
       Podziel plik ONE już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
