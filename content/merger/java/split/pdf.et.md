...
############################# Head ############################
head_title: "Jagage PDF mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail PDF mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "PDF Splitter in Java"
description: "Tükeldage PDF mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage PDF fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks PDF-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili PDF, kasutades Java näidet">}}

        ```java    
        // Jagage fail PDF, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – PDF faili jagamine võrgus"
    content: |
       Tükeldage fail PDF kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
