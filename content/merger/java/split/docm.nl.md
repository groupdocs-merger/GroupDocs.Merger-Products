...
############################# Head ############################
head_title: "Splits DOCM in meerdere bestanden in Java"
head_description: "Splits een enkel DOCM bestand in meerdere bestanden op basis van paginanummers, pagina-intervallen, even of oneven pagina's met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "DOCM Splitter in Java"
description: "Splits DOCM met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits DOCM bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel DOCM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een DOCM bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits DOCM bestand met behulp van GroupDocs.Merger voor Java API
...
demos:
    enable: true
    title: "Live demo's - DOCM bestand online splitsen"
    content: |
       Splits DOCM bestand nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) te gaan.
