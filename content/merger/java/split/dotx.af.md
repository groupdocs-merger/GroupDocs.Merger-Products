...
############################# Head ############################
head_title: "Verdeel DOTX in veelvuldige lêers in Java"
...
description: "Verdeel DOTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOTX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOTX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOTX lêer deur GroupDocs.Merger vir Java API te gebruik
