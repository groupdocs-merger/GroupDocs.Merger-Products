...
############################# Head ############################
head_title: "Padalinkite XPS į kelis failus Java"
head_description: "Padalinkite vieną XPS failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "XPS skirstytuvas Java"
description: "Padalinkite XPS keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XPS failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XPS failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XPS failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XPS failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite XPS failą internete"
    content: |
       Padalykite XPS failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) svetainėje.
