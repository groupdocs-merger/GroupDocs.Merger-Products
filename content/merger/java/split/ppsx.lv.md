...
############################# Head ############################
head_title: "Sadaliet PPSX vairākos failos programmā Java"
head_description: "Sadaliet vienu PPSX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "PPSX sadalītājs programmā Java"
description: "Sadaliet PPSX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPSX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu PPSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPSX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet PPSX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt PPSX failu tiešsaistē"
    content: |
       Sadaliet PPSX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx).
