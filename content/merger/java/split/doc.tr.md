...
############################# Head ############################
head_title: "DOC'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOC dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOC Ayırıcı Java"
description: "DOC kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOC Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOC dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOC dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOC Dosyasını Çevrimiçi Böl"
    content: |
       DOC dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc) web sitesini ziyaret ederek bölün.
