...
############################# Head ############################
head_title: "Pisahkan PDF kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail PDF kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PDF Pemisah Dalam Java"
description: "Pisahkan PDF dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan PDF Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail PDF kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail PDF menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail PDF menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split PDF Fail Dalam Talian"
    content: |
       Pisahkan fail PDF sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
