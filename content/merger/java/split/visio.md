...
head_description: "Split a single VISIO file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "VISIO Splitter In Java"
description: "Split VISIO with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single VISIO file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VISIO file using Java example code">}}

        ```java    
        // Split VISIO file using GroupDocs.Merger for Java API
