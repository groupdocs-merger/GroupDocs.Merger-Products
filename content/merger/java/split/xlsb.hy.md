...
############################# Head ############################
head_title: "Բաժանել XLSB-ը մի քանի ֆայլերի Java-ում"
head_description: "Մեկ XLSB ֆայլը բաժանեք մի քանի ֆայլերի՝ հիմնվելով էջերի համարների, էջի ընդմիջումների, զույգ կամ կենտ էջերի վրա՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "XLSB Splitter Java-ում"
description: "Բաժանեք XLSB-ը Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել XLSB ֆայլը ըստ էջերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար մեկ XLSB ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել XLSB ֆայլը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Բաժանեք XLSB ֆայլը՝ օգտագործելով GroupDocs.Merger Java API-ի համար
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Split XLSB File Online"
    content: |
       Բաժանեք XLSB ֆայլը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) կայքը:
