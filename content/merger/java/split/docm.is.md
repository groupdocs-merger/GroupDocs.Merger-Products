...
############################# Head ############################
head_title: "Skiptu DOCM í margar skrár í Java"
head_description: "Skiptu einni DOCM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "DOCM Skerandi í Java"
description: "Skiptu DOCM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOCM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni DOCM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOCM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu DOCM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu DOCM skrá á netinu"
    content: |
       Skiptu DOCM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) vefsíðu.
