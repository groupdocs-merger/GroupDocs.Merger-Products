...
############################# Head ############################
head_title: "Podziel DOT na wiele plików w Java"
head_description: "Podziel pojedynczy plik DOT na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "DOT Rozdzielacz w Java"
description: "Podziel DOT z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik DOT według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku DOT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik DOT za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik DOT za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik DOT online"
    content: |
       Podziel plik DOT już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot).
