...
############################# Head ############################
head_title: "Pisahkan PPTX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail PPTX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PPTX Pemisah Dalam Java"
description: "Pisahkan PPTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan PPTX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail PPTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail PPTX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail PPTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split PPTX Fail Dalam Talian"
    content: |
       Pisahkan fail PPTX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
