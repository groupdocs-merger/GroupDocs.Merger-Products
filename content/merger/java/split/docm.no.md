...
############################# Head ############################
head_title: "Del DOCM i flere filer i Java"
head_description: "Del en enkelt DOCM-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "DOCM splitter i Java"
description: "Del DOCM med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del DOCM-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt DOCM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOCM-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del DOCM-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del DOCM-fil på nett"
    content: |
       Del opp DOCM-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm).
