...
############################# Head ############################
head_title: "Jaa PPSX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen PPSX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "PPSX Jakaja sisään Java"
description: "Jaa PPSX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto PPSX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden PPSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPSX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto PPSX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa PPSX tiedosto verkossa"
    content: |
       Jaa tiedosto PPSX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) -sivustolla.
