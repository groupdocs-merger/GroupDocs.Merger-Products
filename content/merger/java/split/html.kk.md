...
############################# Head ############################
head_title: "HTML файлын Java ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "HTML Java ішіндегі бөлгіш"
description: "HTML кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "HTML файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір HTML файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // HTML файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
