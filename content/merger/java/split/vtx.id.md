...
head_description: "Pisahkan satu file VTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VTX Pemisah Di Java"
description: "Pisahkan VTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VTX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VTX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VTX File Online"
    content: |
       Pisahkan file VTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vtx).
