...
############################# Head ############################
head_title: "Verdeel XPS in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XPS-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XPS Splitter in Java"
description: "Verdeel XPS met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XPS lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XPS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XPS-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XPS lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XPS lêer aanlyn"
    content: |
       Verdeel XPS-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) webwerf te besoek.
