...
############################# Head ############################
head_title: "Podijeli MHTML u više datoteka u Java"
head_description: "Podijelite jednu MHTML datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "MHTML Splitter u Java"
description: "Podijelite MHTML s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli MHTML datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne MHTML datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti MHTML datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli MHTML datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split MHTML datoteka na mreži"
    content: |
       Podijeli MHTML datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml) web mjesto.
