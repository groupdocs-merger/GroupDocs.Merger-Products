...
############################# Head ############################
head_title: "Jagage DOTX mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail DOTX mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "DOTX Splitter in Java"
description: "Tükeldage DOTX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOTX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOTX, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOTX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – DOTX faili jagamine võrgus"
    content: |
       Tükeldage fail DOTX kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
