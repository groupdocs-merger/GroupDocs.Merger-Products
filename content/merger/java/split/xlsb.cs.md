...
############################# Head ############################
head_title: "Rozdělit XLSB do více souborů v Java"
head_description: "Rozdělte jeden soubor XLSB do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "XLSB Splitter v Java"
description: "Rozdělte XLSB několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit XLSB soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru XLSB do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor XLSB pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor XLSB pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru XLSB online"
    content: |
       Rozdělte soubor XLSB právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
