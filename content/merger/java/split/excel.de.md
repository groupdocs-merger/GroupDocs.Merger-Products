...
############################# Head ############################
head_title: "Teilen Sie EXCEL in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne EXCEL-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "EXCEL Splittereingang Java"
description: "Teilen Sie EXCEL mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "EXCEL-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne EXCEL-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die EXCEL-Datei mit dem Java-Beispielcode">}}

        ```java    
        // EXCEL-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - EXCEL-Datei online teilen"
    content: |
       Teilen Sie die Datei EXCEL jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/excel) besuchen.
