...
############################# Head ############################
head_title: "Dela upp DOC i flera filer i Java"
...
description: "Dela upp DOC med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOC fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda DOC-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOC-filen med hjälp av Java exempelkod">}}

        ```java    
        // Dela DOC-fil med GroupDocs.Merger för Java API
