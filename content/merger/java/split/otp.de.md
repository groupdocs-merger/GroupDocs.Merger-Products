...
############################# Head ############################
head_title: "Teilen Sie OTP in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne OTP-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "OTP Splittereingang Java"
description: "Teilen Sie OTP mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "OTP-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne OTP-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die OTP-Datei mit dem Java-Beispielcode">}}

        ```java    
        // OTP-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - OTP-Datei online teilen"
    content: |
       Teilen Sie die Datei OTP jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) besuchen.
