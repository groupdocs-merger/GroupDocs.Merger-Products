...
############################# Head ############################
head_title: "Dividir PDF en varios archivos en Java"
...
############################# Header ############################
title: "PDF Divisor en Java"
description: "Divida PDF con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir PDF archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo PDF en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo PDF usando el código de ejemplo Java">}}
