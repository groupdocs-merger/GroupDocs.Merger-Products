...
############################# Head ############################
head_title: "Razdeli PPTX na več datotek v Java"
head_description: "Eno datoteko PPTX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "PPTX razdelilnik v Java"
description: "Razdelite PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko PPTX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke PPTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko PPTX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko PPTX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli PPTX datoteko na spletu"
    content: |
       Takoj razdelite datoteko PPTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
