...
############################# Head ############################
head_title: "Pisahkan DOTX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail DOTX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOTX Pemisah Dalam Java"
description: "Pisahkan DOTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOTX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail DOTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail DOTX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail DOTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split DOTX Fail Dalam Talian"
    content: |
       Pisahkan fail DOTX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
