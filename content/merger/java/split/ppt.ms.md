...
############################# Head ############################
head_title: "Pisahkan PPT kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail PPT kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "PPT Pemisah Dalam Java"
description: "Pisahkan PPT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan PPT Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail PPT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail PPT menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail PPT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split PPT Fail Dalam Talian"
    content: |
       Pisahkan fail PPT sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
