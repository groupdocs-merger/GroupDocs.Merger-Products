...
############################# Head ############################
head_title: "Sadaliet OTT vairākos failos programmā Java"
head_description: "Sadaliet vienu OTT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "OTT sadalītājs programmā Java"
description: "Sadaliet OTT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet OTT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu OTT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt OTT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet OTT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt OTT failu tiešsaistē"
    content: |
       Sadaliet OTT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott).
