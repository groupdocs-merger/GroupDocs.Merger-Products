...
############################# Head ############################
head_title: "Teilen Sie DOTM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne DOTM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "DOTM Splittereingang Java"
description: "Teilen Sie DOTM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "DOTM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne DOTM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die DOTM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // DOTM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - DOTM-Datei online teilen"
    content: |
       Teilen Sie die Datei DOTM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm) besuchen.
