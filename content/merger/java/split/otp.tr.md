...
############################# Head ############################
head_title: "OTP'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir OTP dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "OTP Ayırıcı Java"
description: "OTP kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "OTP Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTP dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak OTP dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - OTP Dosyasını Çevrimiçi Böl"
    content: |
       OTP dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) web sitesini ziyaret ederek bölün.
