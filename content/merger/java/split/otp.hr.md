...
############################# Head ############################
head_title: "Podijeli OTP u više datoteka u Java"
head_description: "Podijelite jednu OTP datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "OTP Splitter u Java"
description: "Podijelite OTP s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli OTP datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne OTP datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti OTP datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli OTP datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split OTP datoteka na mreži"
    content: |
       Podijeli OTP datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) web mjesto.
