...
############################# Head ############################
head_title: "Dividiu EPUB en diversos fitxers a Java"
head_description: "Dividiu un únic fitxer EPUB en diversos fitxers segons els números de pàgina, els intervals de pàgina i les pàgines parells o senars mitjançant l'API de fusió de documents."

############################# Header ############################
title: "EPUB Divisor a Java"
description: "Dividiu EPUB amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer EPUB per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer EPUB en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer EPUB mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer EPUB mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    enable: true
    title: "Demostracions en directe: divideix el fitxer EPUB en línia"
    content: |
       Dividiu el fitxer EPUB ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
