...
############################# Head ############################
head_title: "Verdeel VSTM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VSTM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VSTM Splitter in Java"
description: "Verdeel VSTM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSTM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSTM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSTM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VSTM lêer aanlyn"
    content: |
       Verdeel VSTM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm) webwerf te besoek.
