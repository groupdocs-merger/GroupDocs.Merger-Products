...
############################# Head ############################
head_title: "Rozdělit RTF do více souborů v Java"
head_description: "Rozdělte jeden soubor RTF do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "RTF Splitter v Java"
description: "Rozdělte RTF několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit RTF soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru RTF do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor RTF pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor RTF pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru RTF online"
    content: |
       Rozdělte soubor RTF právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
