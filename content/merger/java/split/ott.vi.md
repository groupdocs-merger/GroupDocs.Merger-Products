...
############################# Head ############################
head_title: "Tách OTT thành nhiều tệp trong Java"
head_description: "Tách một tệp OTT thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "OTT Splitter trong Java"
description: "Tách OTT bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp OTT theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp OTT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp OTT bằng mã mẫu Java">}}

        ```java    
        // Tách tệp OTT bằng GroupDocs.Merger cho Java API
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Tách tệp OTT Trực tuyến"
    content: |
       Tách tệp OTT ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos] (https://products.groupdocs.app/splitter/ ott) trang web.
