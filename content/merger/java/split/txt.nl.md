...
############################# Head ############################
head_title: "Splits TXT in meerdere bestanden in Java"
...
description: "Splits TXT met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits TXT bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel TXT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een TXT bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits TXT bestand met behulp van GroupDocs.Merger voor Java API
