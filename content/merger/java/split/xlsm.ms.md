...
############################# Head ############################
head_title: "Pisahkan XLSM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLSM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLSM Pemisah Dalam Java"
description: "Pisahkan XLSM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLSM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLSM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLSM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLSM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLSM Fail Dalam Talian"
    content: |
       Pisahkan fail XLSM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm).
