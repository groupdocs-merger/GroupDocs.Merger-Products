...
############################# Head ############################
head_title: "تقسيم ONE إلى ملفات متعددة في Java"
head_description: "قم بتقسيم ملف واحد ONE إلى عدة ملفات بناءً على أرقام الصفحات وفواصل الصفحات والصفحات الزوجية أو الفردية باستخدام واجهة برمجة التطبيقات لدمج المستندات."

############################# Header ############################
title: "ONE الفاصل في Java"
description: "قسِّم ONE ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تقسيم ONE الملف حسب الصفحات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تقسيم ملف واحد ONE إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملف ONE باستخدام مثال كود Java">}}

        ```java    
        // انقسام الملف ONE باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
...
demos:
    enable: true
    title: "العروض التوضيحية المباشرة - تقسيم الملف ONE عبر الإنترنت"
    content: |
       قسّم الملف ONE الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
