...
############################# Head ############################
head_title: "Sadaliet OTP vairākos failos programmā Java"
head_description: "Sadaliet vienu OTP failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "OTP sadalītājs programmā Java"
description: "Sadaliet OTP ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet OTP failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu OTP failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt OTP failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet OTP failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt OTP failu tiešsaistē"
    content: |
       Sadaliet OTP failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
