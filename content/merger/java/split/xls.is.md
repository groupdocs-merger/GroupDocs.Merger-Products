...
############################# Head ############################
head_title: "Skiptu XLS í margar skrár í Java"
head_description: "Skiptu einni XLS skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XLS Skerandi í Java"
description: "Skiptu XLS með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLS skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLS skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLS skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XLS skrá á netinu"
    content: |
       Skiptu XLS skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls) vefsíðu.
