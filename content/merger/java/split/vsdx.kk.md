...
############################# Head ############################
head_title: "VSDX файлын Java ішінде бірнеше файлға бөліңіз"
head_description: "Бір VSDX файлын құжаттарды біріктіру API көмегімен бет нөмірлеріне, бет аралықтарына, жұп немесе тақ беттерге негізделген бірнеше файлдарға бөліңіз."

############################# Header ############################
title: "VSDX Java ішіндегі бөлгіш"
description: "VSDX кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "VSDX файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір VSDX файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // VSDX файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VSDX файлды желіде бөліңіз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx) веб-сайтына кіру арқылы VSDX файлды дәл қазір бөліңіз.
