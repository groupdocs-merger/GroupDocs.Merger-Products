...
############################# Head ############################
head_title: "Podijeli TSV u više datoteka u Java"
head_description: "Podijelite jednu TSV datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "TSV Splitter u Java"
description: "Podijelite TSV s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli TSV datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne TSV datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti TSV datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli TSV datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split TSV datoteka na mreži"
    content: |
       Podijeli TSV datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) web mjesto.
