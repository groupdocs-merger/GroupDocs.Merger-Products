...
############################# Head ############################
head_title: "ODS'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir ODS dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "ODS Ayırıcı Java"
description: "ODS kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODS Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODS dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODS dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - ODS Dosyasını Çevrimiçi Böl"
    content: |
       ODS dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods) web sitesini ziyaret ederek bölün.
