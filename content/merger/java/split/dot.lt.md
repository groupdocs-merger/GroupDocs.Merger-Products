...
############################# Head ############################
head_title: "Padalinkite DOT į kelis failus Java"
head_description: "Padalinkite vieną DOT failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "DOT skirstytuvas Java"
description: "Padalinkite DOT keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOT failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną DOT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOT failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite DOT failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite DOT failą internete"
    content: |
       Padalykite DOT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) svetainėje.
