...
############################# Head ############################
head_title: "XLS'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLS dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLS Ayırıcı Java"
description: "XLS kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLS Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLS dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLS dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLS Dosyasını Çevrimiçi Böl"
    content: |
       XLS dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls) web sitesini ziyaret ederek bölün.
