...
############################# Head ############################
head_title: "Razdeli OTT na več datotek v Java"
head_description: "Eno datoteko OTT razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "OTT razdelilnik v Java"
description: "Razdelite OTT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko OTT po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke OTT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko OTT s primerom kode Java">}}

        ```java    
        // Razdeli datoteko OTT z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli OTT datoteko na spletu"
    content: |
       Takoj razdelite datoteko OTT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott).
