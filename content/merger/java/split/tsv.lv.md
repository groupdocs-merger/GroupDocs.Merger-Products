...
############################# Head ############################
head_title: "Sadaliet TSV vairākos failos programmā Java"
head_description: "Sadaliet vienu TSV failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "TSV sadalītājs programmā Java"
description: "Sadaliet TSV ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TSV failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu TSV failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TSV failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet TSV failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt TSV failu tiešsaistē"
    content: |
       Sadaliet TSV failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
