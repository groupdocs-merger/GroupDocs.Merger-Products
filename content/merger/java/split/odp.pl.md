...
############################# Head ############################
head_title: "Podziel ODP na wiele plików w Java"
head_description: "Podziel pojedynczy plik ODP na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "ODP Rozdzielacz w Java"
description: "Podziel ODP z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik ODP według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku ODP na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik ODP za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik ODP za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik ODP online"
    content: |
       Podziel plik ODP już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp).
