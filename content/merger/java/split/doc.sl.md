...
############################# Head ############################
head_title: "Razdeli DOC na več datotek v Java"
head_description: "Eno datoteko DOC razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "DOC razdelilnik v Java"
description: "Razdelite DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko DOC po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke DOC na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko DOC s primerom kode Java">}}

        ```java    
        // Razdeli datoteko DOC z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli DOC datoteko na spletu"
    content: |
       Takoj razdelite datoteko DOC tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
