...
############################# Head ############################
head_title: "Scoilt OTT ina Ilchomhaid i Java"
...
############################# Header ############################
title: "OTT Scoilteoir i Java"
description: "Scoilt OTT le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt OTT Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin OTT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad OTT a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt OTT comhad ag baint úsáide as GroupDocs.Merger do Java API
