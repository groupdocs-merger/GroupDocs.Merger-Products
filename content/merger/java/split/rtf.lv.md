...
############################# Head ############################
head_title: "Sadaliet RTF vairākos failos programmā Java"
head_description: "Sadaliet vienu RTF failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "RTF sadalītājs programmā Java"
description: "Sadaliet RTF ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet RTF failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu RTF failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt RTF failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet RTF failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt RTF failu tiešsaistē"
    content: |
       Sadaliet RTF failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
