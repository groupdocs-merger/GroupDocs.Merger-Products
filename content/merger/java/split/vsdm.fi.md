...
############################# Head ############################
head_title: "Jaa VSDM useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VSDM-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VSDM Jakaja sisään Java"
description: "Jaa VSDM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VSDM sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VSDM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSDM tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VSDM GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VSDM tiedosto verkossa"
    content: |
       Jaa tiedosto VSDM heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) -sivustolla.
