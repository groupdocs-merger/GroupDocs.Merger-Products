...
############################# Head ############################
head_title: "Splits MHT in meerdere bestanden in Java"
head_description: "Splits een enkel MHT bestand in meerdere bestanden op basis van paginanummers, pagina-intervallen, even of oneven pagina's met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "MHT Splitter in Java"
description: "Splits MHT met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits MHT bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel MHT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een MHT bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits MHT bestand met behulp van GroupDocs.Merger voor Java API
...
demos:
    enable: true
    title: "Live demo's - MHT bestand online splitsen"
    content: |
       Splits MHT bestand nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht) te gaan.
