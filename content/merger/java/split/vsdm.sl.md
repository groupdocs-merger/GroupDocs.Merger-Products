...
############################# Head ############################
head_title: "Razdeli VSDM na več datotek v Java"
...
############################# Header ############################
title: "VSDM razdelilnik v Java"
description: "Razdelite VSDM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VSDM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VSDM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VSDM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VSDM z API-jem GroupDocs.Merger za Java
