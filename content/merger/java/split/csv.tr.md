...
############################# Head ############################
head_title: "CSV'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir CSV dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "CSV Ayırıcı Java"
description: "CSV kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "CSV Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak CSV dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak CSV dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - CSV Dosyasını Çevrimiçi Böl"
    content: |
       CSV dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) web sitesini ziyaret ederek bölün.
