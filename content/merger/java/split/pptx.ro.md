...
############################# Head ############################
head_title: "Împărțiți PPTX în mai multe fișiere în Java"
head_description: "Împărțiți un singur fișier PPTX în mai multe fișiere pe baza numerelor de pagină, a intervalelor de pagini, a paginilor pare sau impare, utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Splitter PPTX în Java"
description: "Împărțiți PPTX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul PPTX după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier PPTX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul PPTX folosind codul exemplu Java">}}

        ```java    
        // Împărțiți fișierul PPTX utilizând API-ul GroupDocs.Merger pentru Java
...
demos:
    enable: true
    title: "Demo live - Împărțiți fișierul PPTX online"
    content: |
       Împărțiți fișierul PPTX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
