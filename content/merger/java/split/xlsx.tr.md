...
############################# Head ############################
head_title: "XLSX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLSX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLSX Ayırıcı Java"
description: "XLSX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLSX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLSX Dosyasını Çevrimiçi Böl"
    content: |
       XLSX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) web sitesini ziyaret ederek bölün.
