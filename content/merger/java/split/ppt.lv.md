...
############################# Head ############################
head_title: "Sadaliet PPT vairākos failos programmā Java"
head_description: "Sadaliet vienu PPT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "PPT sadalītājs programmā Java"
description: "Sadaliet PPT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu PPT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet PPT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt PPT failu tiešsaistē"
    content: |
       Sadaliet PPT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
