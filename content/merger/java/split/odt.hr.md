...
############################# Head ############################
head_title: "Podijeli ODT u više datoteka u Java"
head_description: "Podijelite jednu ODT datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "ODT Splitter u Java"
description: "Podijelite ODT s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli ODT datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne ODT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti ODT datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli ODT datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split ODT datoteka na mreži"
    content: |
       Podijeli ODT datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) web mjesto.
