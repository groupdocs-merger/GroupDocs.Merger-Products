...
############################# Head ############################
head_title: "Împărțiți DOTX în mai multe fișiere în Java"
head_description: "Împărțiți un singur fișier DOTX în mai multe fișiere pe baza numerelor de pagină, a intervalelor de pagini, a paginilor pare sau impare, utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Splitter DOTX în Java"
description: "Împărțiți DOTX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul DOTX după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier DOTX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul DOTX folosind codul exemplu Java">}}

        ```java    
        // Împărțiți fișierul DOTX utilizând API-ul GroupDocs.Merger pentru Java
...
demos:
    enable: true
    title: "Demo live - Împărțiți fișierul DOTX online"
    content: |
       Împărțiți fișierul DOTX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
