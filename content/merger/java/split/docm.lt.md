...
############################# Head ############################
head_title: "Padalinkite DOCM į kelis failus Java"
...
############################# Header ############################
title: "DOCM skirstytuvas Java"
description: "Padalinkite DOCM keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOCM failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną DOCM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOCM failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite DOCM failą naudodami GroupDocs.Merger for Java API
