...
############################# Head ############################
head_title: "Divida XLTX em vários arquivos em Java"
head_description: "Divida um único arquivo XLTX em vários arquivos com base em números de página, intervalos de página, páginas pares ou ímpares usando a API de fusão de documentos."

############################# Header ############################
title: "XLTX Divisor em Java"
description: "Divida XLTX com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir XLTX arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo XLTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo XLTX usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo XLTX usando GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Dividir arquivo XLTX on-line"
    content: |
       Divida o arquivo XLTX agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
