...
############################# Head ############################
head_title: "Teilen Sie PPTX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne PPTX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "PPTX Splittereingang Java"
description: "Teilen Sie PPTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "PPTX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne PPTX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die PPTX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // PPTX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - PPTX-Datei online teilen"
    content: |
       Teilen Sie die Datei PPTX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) besuchen.
