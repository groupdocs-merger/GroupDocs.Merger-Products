...
############################# Head ############################
head_title: "Teilen Sie VDX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VDX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VDX Splittereingang Java"
description: "Teilen Sie VDX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VDX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VDX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VDX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VDX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VDX-Datei online teilen"
    content: |
       Teilen Sie die Datei VDX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) besuchen.
