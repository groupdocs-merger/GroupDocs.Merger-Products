...
############################# Head ############################
head_title: "Split ONE into Multiple Files in Java"
head_description: "Split a single ONE file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "ONE Splitter In Java"
description: "Split ONE with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Split ONE File By Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) makes it easy for Java developers to split a single ONE file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split ONE file using Java example code">}}

        ```java    
        // Split ONE file using GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live Demos - Split ONE File Online"
    content: |
       Split ONE file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) website.
