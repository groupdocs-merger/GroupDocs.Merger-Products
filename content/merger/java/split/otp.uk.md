...
############################# Head ############################
head_title: "Розділити OTP на кілька файлів у Java"
head_description: "Розділіть один файл OTP на кілька файлів на основі номерів сторінок, інтервалів сторінок, парних чи непарних сторінок за допомогою API об’єднання документів."

############################# Header ############################
title: "OTP Спліттер у Java"
description: "Розділіть OTP кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Розділити OTP файл за сторінками в Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) дозволяє розробникам Java легко розділити один файл OTP на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файл OTP за допомогою прикладу коду Java">}}

        ```java    
        // Розділіть файл OTP за допомогою API GroupDocs.Merger для Java
...
demos:
    enable: true
    title: "Демонстрації в прямому ефірі - розділіть OTP файл онлайн"
    content: |
       Розділіть файл OTP прямо зараз, відвідавши веб-сайт [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
