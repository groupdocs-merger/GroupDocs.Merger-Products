...
############################# Head ############################
head_title: "Verdeel MHTML in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele MHTML-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "MHTML Splitter in Java"
description: "Verdeel MHTML met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel MHTML lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele MHTML-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHTML-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel MHTML lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel MHTML lêer aanlyn"
    content: |
       Verdeel MHTML-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml) webwerf te besoek.
