...
############################# Head ############################
head_title: "Sadaliet XLAM vairākos failos programmā Java"
head_description: "Sadaliet vienu XLAM failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLAM sadalītājs programmā Java"
description: "Sadaliet XLAM ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLAM failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLAM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLAM failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLAM failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLAM failu tiešsaistē"
    content: |
       Sadaliet XLAM failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam).
