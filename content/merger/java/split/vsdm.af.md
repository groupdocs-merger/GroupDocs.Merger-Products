...
############################# Head ############################
head_title: "Verdeel VSDM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VSDM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VSDM Splitter in Java"
description: "Verdeel VSDM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSDM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSDM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSDM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VSDM lêer aanlyn"
    content: |
       Verdeel VSDM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) webwerf te besoek.
