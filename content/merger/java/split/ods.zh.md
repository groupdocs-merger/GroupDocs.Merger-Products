...
############################# Head ############################
head_title: "在 Java 中将 ODS 拆分为多个文件"
head_description: "使用文档合并 API 根据页码、页间隔、偶数页或奇数页将单个 ODS 文件拆分为多个文件。"

############################# Header ############################
title: "ODS Java 中的拆分器"
description: "用几行 Java 代码拆分 ODS。"
...
steps:
    enable: true
    title_left: "按 Java 中的页面拆分 ODS 文件"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码拆分 ODS 文件">}}

        ```java    
        // 使用 GroupDocs.Merger for Java API 拆分 ODS 文件
...
demos:
    enable: true
    title: "现场演示 - 在线拆分 ODS 文件"
    content: |
       立即访问 [GroupDocs.Merger 现场演示](https://products.groupdocs.app/splitter/ods) 网站拆分 ODS 文件。
       现场演示具有以下好处。
