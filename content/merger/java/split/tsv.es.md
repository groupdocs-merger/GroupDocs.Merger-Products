...
############################# Head ############################
head_title: "Dividir TSV en varios archivos en Java"
...
############################# Header ############################
title: "TSV Divisor en Java"
description: "Divida TSV con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir TSV archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo TSV en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo TSV usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo TSV usando GroupDocs.Merger para la API de Java
