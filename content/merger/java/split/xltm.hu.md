...
############################# Head ############################
head_title: "A(z) XLTM felosztása több fájlra a Java programban"
head_description: "Egyetlen XLTM fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTM Splitter in Java"
description: "Oszd fel az XLTM elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) XLTM fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen XLTM fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az XLTM fájl felosztása a Java példakóddal">}}

        ```java    
        // Az XLTM fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split XLTM fájl online"
    content: |
       Ossza meg az XLTM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm) webhely meglátogatásával.
