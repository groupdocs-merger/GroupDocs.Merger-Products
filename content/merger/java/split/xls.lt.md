...
############################# Head ############################
head_title: "Padalinkite XLS į kelis failus Java"
...
############################# Header ############################
title: "XLS skirstytuvas Java"
description: "Padalinkite XLS keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLS failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XLS failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLS failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XLS failą naudodami GroupDocs.Merger for Java API
