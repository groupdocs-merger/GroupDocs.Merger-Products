...
############################# Head ############################
head_title: "Podziel XLAM na wiele plików w Java"
...
############################# Header ############################
title: "XLAM Rozdzielacz w Java"
description: "Podziel XLAM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLAM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLAM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLAM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLAM za pomocą GroupDocs.Merger for Java API
