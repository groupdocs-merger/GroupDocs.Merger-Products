...
############################# Head ############################
head_title: "Podijeli TEX u više datoteka u Java"
head_description: "Podijelite jednu TEX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "TEX Splitter u Java"
description: "Podijelite TEX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli TEX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne TEX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti TEX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli TEX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split TEX datoteka na mreži"
    content: |
       Podijeli TEX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) web mjesto.
