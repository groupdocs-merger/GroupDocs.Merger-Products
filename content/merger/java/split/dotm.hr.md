...
############################# Head ############################
head_title: "Podijeli DOTM u više datoteka u Java"
head_description: "Podijelite jednu DOTM datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "DOTM Splitter u Java"
description: "Podijelite DOTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli DOTM datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne DOTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOTM datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli DOTM datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split DOTM datoteka na mreži"
    content: |
       Podijeli DOTM datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm) web mjesto.
