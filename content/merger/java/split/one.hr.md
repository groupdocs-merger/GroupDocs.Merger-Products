...
############################# Head ############################
head_title: "Podijeli ONE u više datoteka u Java"
...
############################# Header ############################
title: "ONE Splitter u Java"
description: "Podijelite ONE s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli ONE datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne ONE datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti ONE datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli ONE datoteku koristeći GroupDocs.Merger za Java API
