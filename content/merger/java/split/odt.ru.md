...
steps:
    enable: true
    title_left: "Разделить ODT файл по страницам в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файл ODT, используя пример кода Java">}}
        ...
        ```java    
        // Разделить ODT файл с помощью GroupDocs.Merge for Java API
...
more_formats:
    ...
    content: |
        Java API слияния и разделения документов для форматов файлов и изображений. Разделите некоторые из популярных форматов файлов, как указано ниже.
