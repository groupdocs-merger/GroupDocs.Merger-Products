...
head_description: "Split a single EXCEL file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "EXCEL Splitter In Java"
description: "Split EXCEL with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single EXCEL file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split EXCEL file using Java example code">}}

        ```java    
        // Split EXCEL file using GroupDocs.Merger for Java API
