...
############################# Head ############################
head_title: "Jaa TEX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen TEX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "TEX Jakaja sisään Java"
description: "Jaa TEX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto TEX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden TEX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TEX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto TEX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa TEX tiedosto verkossa"
    content: |
       Jaa tiedosto TEX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) -sivustolla.
