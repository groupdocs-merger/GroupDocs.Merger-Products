...
############################# Head ############################
head_title: "Jaa ODT useiksi tiedostoiksi Java"
...
############################# Header ############################
title: "ODT Jakaja sisään Java"
description: "Jaa ODT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto ODT sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden ODT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ODT tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto ODT GroupDocs.Merger for Java API:lla
