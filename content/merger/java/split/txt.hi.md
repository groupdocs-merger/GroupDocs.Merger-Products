...
############################# Head ############################
head_title: "Java में TXT को कई फाइलों में विभाजित करें"
head_description: "दस्तावेज़ विलय API का उपयोग करके पृष्ठ संख्या, पृष्ठ अंतराल, सम या विषम पृष्ठों के आधार पर एकल TXT फ़ाइल को कई फ़ाइलों में विभाजित करें।"

############################# Header ############################
title: "TXT स्प्लिटर इन Java"
description: "TXT को Java कोड की कुछ पंक्तियों से विभाजित करें।"
...
steps:
    enable: true
    title_left: "TXT फ़ाइल को Java में पृष्ठों के अनुसार विभाजित करें"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) डेवलपर्स के लिए Java डेवलपर्स के लिए एक TXT फ़ाइल को कई परिणामी फाइलों में विभाजित करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके TXT फ़ाइल को कैसे विभाजित करें">}}

        ```java    
        // GroupDocs.Merger for Java API का उपयोग करके TXT फ़ाइल को विभाजित करें
...
demos:
    enable: true
    title: "लाइव डेमो - स्प्लिट TXT फाइल ऑनलाइन"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) वेबसाइट पर जाकर TXT फ़ाइल को अभी विभाजित करें।
