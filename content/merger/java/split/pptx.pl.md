...
############################# Head ############################
head_title: "Podziel PPTX na wiele plików w Java"
head_description: "Podziel pojedynczy plik PPTX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "PPTX Rozdzielacz w Java"
description: "Podziel PPTX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik PPTX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku PPTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik PPTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik PPTX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik PPTX online"
    content: |
       Podziel plik PPTX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
