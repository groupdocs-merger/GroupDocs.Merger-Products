...
############################# Head ############################
head_title: "Rozdeliť VSDM do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor VSDM do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "VSDM Splitter v Java"
description: "Rozdeľte VSDM niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť VSDM súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor VSDM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSDM súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor VSDM pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru VSDM online"
    content: |
       Rozdeľte súbor VSDM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm).
