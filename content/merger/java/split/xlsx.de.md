...
############################# Head ############################
head_title: "Teilen Sie XLSX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XLSX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XLSX Splittereingang Java"
description: "Teilen Sie XLSX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XLSX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XLSX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XLSX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XLSX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XLSX-Datei online teilen"
    content: |
       Teilen Sie die Datei XLSX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) besuchen.
