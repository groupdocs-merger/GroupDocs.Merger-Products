...
############################# Head ############################
head_title: "Jaa XLT useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLT-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLT Jakaja sisään Java"
description: "Jaa XLT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLT sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLT tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLT GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLT tiedosto verkossa"
    content: |
       Jaa tiedosto XLT heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt) -sivustolla.
