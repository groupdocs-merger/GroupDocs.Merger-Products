...
############################# Head ############################
head_title: "Sadaliet PDF vairākos failos programmā Java"
head_description: "Sadaliet vienu PDF failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "PDF sadalītājs programmā Java"
description: "Sadaliet PDF ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PDF failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu PDF failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PDF failu, izmantojot Java piemēra kodu">}}
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt PDF failu tiešsaistē"
    content: |
       Sadaliet PDF failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
