...
############################# Head ############################
head_title: "Teilen Sie DOCX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne DOCX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "DOCX Splittereingang Java"
description: "Teilen Sie DOCX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "DOCX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne DOCX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die DOCX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // DOCX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - DOCX-Datei online teilen"
    content: |
       Teilen Sie die Datei DOCX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) besuchen.
