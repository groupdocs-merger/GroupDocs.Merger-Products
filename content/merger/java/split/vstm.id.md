...
head_description: "Pisahkan satu file VSTM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSTM Pemisah Di Java"
description: "Pisahkan VSTM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSTM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSTM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSTM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSTM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSTM File Online"
    content: |
       Pisahkan file VSTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vstm).
