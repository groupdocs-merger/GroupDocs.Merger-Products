...
head_description: "Pisahkan satu file VSSX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSSX Pemisah Di Java"
description: "Pisahkan VSSX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSSX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSSX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSSX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSSX File Online"
    content: |
       Pisahkan file VSSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vssx).
