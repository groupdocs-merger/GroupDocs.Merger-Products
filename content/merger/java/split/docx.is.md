...
############################# Head ############################
head_title: "Skiptu DOCX í margar skrár í Java"
head_description: "Skiptu einni DOCX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "DOCX Skerandi í Java"
description: "Skiptu DOCX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOCX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni DOCX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOCX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu DOCX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu DOCX skrá á netinu"
    content: |
       Skiptu DOCX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) vefsíðu.
