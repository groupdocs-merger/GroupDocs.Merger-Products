...
############################# Head ############################
head_title: "Skiptu XLSM í margar skrár í Java"
head_description: "Skiptu einni XLSM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XLSM Skerandi í Java"
description: "Skiptu XLSM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLSM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLSM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XLSM skrá á netinu"
    content: |
       Skiptu XLSM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm) vefsíðu.
