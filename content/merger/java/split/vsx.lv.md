...
############################# Head ############################
head_title: "Sadaliet VSX vairākos failos programmā Java"
head_description: "Sadaliet vienu VSX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSX sadalītājs programmā Java"
description: "Sadaliet VSX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSX failu tiešsaistē"
    content: |
       Sadaliet VSX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx).
