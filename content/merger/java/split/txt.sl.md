...
############################# Head ############################
head_title: "Razdeli TXT na več datotek v Java"
head_description: "Eno datoteko TXT razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "TXT razdelilnik v Java"
description: "Razdelite TXT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko TXT po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke TXT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko TXT s primerom kode Java">}}

        ```java    
        // Razdeli datoteko TXT z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli TXT datoteko na spletu"
    content: |
       Takoj razdelite datoteko TXT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
