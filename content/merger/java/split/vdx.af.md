...
############################# Head ############################
head_title: "Verdeel VDX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VDX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VDX Splitter in Java"
description: "Verdeel VDX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VDX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VDX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VDX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VDX lêer aanlyn"
    content: |
       Verdeel VDX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) webwerf te besoek.
