...
############################# Head ############################
head_title: "Dividir EXCEL en varios archivos en Java"
...
############################# Header ############################
title: "EXCEL Divisor en Java"
description: "Divida EXCEL con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir EXCEL archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo EXCEL en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo EXCEL usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo EXCEL usando GroupDocs.Merger para la API de Java
