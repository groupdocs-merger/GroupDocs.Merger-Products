...
############################# Head ############################
head_title: "VSSX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VSSX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VSSX Ayırıcı Java"
description: "VSSX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSSX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSSX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VSSX Dosyasını Çevrimiçi Böl"
    content: |
       VSSX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) web sitesini ziyaret ederek bölün.
