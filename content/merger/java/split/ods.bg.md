...
############################# Head ############################
head_title: "Разделете ODS на няколко файла в Java"
head_description: "Разделете един файл ODS на няколко файла въз основа на номера на страници, интервали между страници, четни или нечетни страници, като използвате API за сливане на документи."

############################# Header ############################
title: "ODS Сплитер в Java"
description: "Разделете ODS с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете ODS файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл ODS на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл ODS с примерен код на Java">}}

        ```java    
        // Разделете ODS файл с помощта на GroupDocs.Merger за Java API
...
demos:
    enable: true
    title: "Демонстрации на живо - Разделете ODS файл онлайн"
    content: |
       Разделете файла ODS веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
