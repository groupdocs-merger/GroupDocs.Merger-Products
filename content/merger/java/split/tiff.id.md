...
############################# Head ############################
head_title: "Pecah dokumen TIFF dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk memecah file TIFF menjadi dokumen terpisah. Kelola PDF, file Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pecah file TIFF" 
description: "GroupDocs.Merger for Java meningkatkan aplikasi Java dengan menambahkan fitur pemrosesan dokumen yang canggih. Pecah file TIFF dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memecah file TIFF"
    content: |
      Dengan [GroupDocs.Merger](/merger/java/), Anda dapat memecah dokumen TIFF dan menyimpan halaman yang dipilih sebagai file baru. Integrasikan manajemen dokumen canggih ke dalam aplikasi Java Anda.
      
      1. Sediakan jalur sumber dari file TIFF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pecah dokumen TIFF dan simpan halaman bernomor genap"
      content: |
        Contoh ini menunjukkan cara memecah dokumen TIFF dan menyimpan semua halaman bernomor genap sebagai file terpisah.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
