...
############################# Head ############################
head_title: "Opdel ODP i flere filer i Java"
head_description: "Opdel en enkelt ODP-fil i flere filer baseret på sidetal, sideintervaller, lige eller ulige sider ved hjælp af Documents Merger API."

############################# Header ############################
title: "ODP Splitter i Java"
description: "Opdel ODP med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Opdel ODP fil efter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at opdele en enkelt ODP-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ODP fil ved hjælp af Java eksempelkode">}}

        ```java    
        // Opdel ODP fil ved hjælp af GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Livedemoer - Split ODP fil online"
    content: |
       Opdel ODP-filen lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp).
