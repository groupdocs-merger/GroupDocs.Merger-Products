...
############################# Head ############################
head_title: "Podziel MHTML na wiele plików w Java"
head_description: "Podziel pojedynczy plik MHTML na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "MHTML Rozdzielacz w Java"
description: "Podziel MHTML z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik MHTML według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku MHTML na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik MHTML za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik MHTML za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik MHTML online"
    content: |
       Podziel plik MHTML już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
