...
############################# Head ############################
head_title: "Pisahkan XLSX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLSX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLSX Pemisah Dalam Java"
description: "Pisahkan XLSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLSX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLSX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLSX Fail Dalam Talian"
    content: |
       Pisahkan fail XLSX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx).
