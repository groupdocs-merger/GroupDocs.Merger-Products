...
############################# Head ############################
head_title: "Rozdělit DOCX do více souborů v Java"
head_description: "Rozdělte jeden soubor DOCX do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "DOCX Splitter v Java"
description: "Rozdělte DOCX několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit DOCX soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru DOCX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor DOCX pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor DOCX pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru DOCX online"
    content: |
       Rozdělte soubor DOCX právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
