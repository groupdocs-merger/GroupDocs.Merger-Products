...
############################# Head ############################
head_title: "Skiptu DOT í margar skrár í Java"
head_description: "Skiptu einni DOT skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "DOT Skerandi í Java"
description: "Skiptu DOT með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOT skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni DOT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOT skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu DOT skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu DOT skrá á netinu"
    content: |
       Skiptu DOT skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) vefsíðu.
