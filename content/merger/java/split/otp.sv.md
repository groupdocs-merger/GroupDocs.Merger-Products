...
############################# Head ############################
head_title: "Dela upp OTP i flera filer i Java"
head_description: "Dela upp en enda OTP-fil i flera filer baserat på sidnummer, sidintervall, jämna eller udda sidor med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "OTP splitter i Java"
description: "Dela upp OTP med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp OTP fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda OTP-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp OTP-filen med hjälp av Java exempelkod">}}

        ```java    
        // Dela OTP-fil med GroupDocs.Merger för Java API
...
demos:
    enable: true
    title: "Livedemos - Split OTP fil online"
    content: |
       Dela upp OTP-filen just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
