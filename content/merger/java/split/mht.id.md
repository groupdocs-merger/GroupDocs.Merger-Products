...
head_description: "Pisahkan satu file MHT menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "MHT Pemisah Di Java"
description: "Pisahkan MHT dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan MHT File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file MHT menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file MHT menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file MHT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan MHT File Online"
    content: |
       Pisahkan file MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/mht).
