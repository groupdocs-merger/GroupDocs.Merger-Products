...
############################# Head ############################
head_title: "Sadaliet VDX vairākos failos programmā Java"
head_description: "Sadaliet vienu VDX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VDX sadalītājs programmā Java"
description: "Sadaliet VDX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VDX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VDX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VDX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VDX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VDX failu tiešsaistē"
    content: |
       Sadaliet VDX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
