...
############################# Head ############################
head_title: "RTF файлын Java ішінде бірнеше файлға бөліңіз"
head_description: "Бір RTF файлын құжаттарды біріктіру API көмегімен бет нөмірлеріне, бет аралықтарына, жұп немесе тақ беттерге негізделген бірнеше файлдарға бөліңіз."

############################# Header ############################
title: "RTF Java ішіндегі бөлгіш"
description: "RTF кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "RTF файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір RTF файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // RTF файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - RTF файлды желіде бөліңіз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) веб-сайтына кіру арқылы RTF файлды дәл қазір бөліңіз.
