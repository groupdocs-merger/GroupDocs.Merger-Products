...
############################# Head ############################
head_title: "Verdeel XLTM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLTM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLTM Splitter in Java"
description: "Verdeel XLTM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLTM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLTM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLTM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLTM lêer aanlyn"
    content: |
       Verdeel XLTM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm) webwerf te besoek.
