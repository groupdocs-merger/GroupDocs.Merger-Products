...
############################# Head ############################
head_title: "Teilen Sie VSTM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VSTM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VSTM Splittereingang Java"
description: "Teilen Sie VSTM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VSTM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VSTM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VSTM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VSTM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VSTM-Datei online teilen"
    content: |
       Teilen Sie die Datei VSTM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm) besuchen.
