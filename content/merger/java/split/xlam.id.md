...
head_description: "Pisahkan satu file XLAM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLAM Pemisah Di Java"
description: "Pisahkan XLAM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLAM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLAM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file XLAM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file XLAM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan XLAM File Online"
    content: |
       Pisahkan file XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/xlam).
