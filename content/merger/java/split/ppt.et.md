...
############################# Head ############################
head_title: "Jagage PPT mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail PPT mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "PPT Splitter in Java"
description: "Tükeldage PPT mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPT fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks PPT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili PPT, kasutades Java näidet">}}

        ```java    
        // Jagage fail PPT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – PPT faili jagamine võrgus"
    content: |
       Tükeldage fail PPT kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
