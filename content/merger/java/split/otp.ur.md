...
############################# Head ############################
head_title: "OTP کو Java میں متعدد فائلوں میں تقسیم کریں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے صفحہ نمبر، صفحہ کے وقفوں، مساوی یا طاق صفحات کی بنیاد پر ایک OTP فائل کو کئی فائلوں میں تقسیم کریں۔"

############################# Header ############################
title: "OTP سپلٹر ان Java"
description: "Java کوڈ کی چند لائنوں کے ساتھ OTP کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "OTP فائل کو Java میں صفحات کے لحاظ سے تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے ایک OTP فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کوڈ کا استعمال کرتے ہوئے OTP فائل کو کیسے تقسیم کیا جائے۔">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے OTP فائل کو تقسیم کریں۔
...
demos:
    enable: true
    title: "لائیو ڈیمو - تقسیم OTP فائل آن لائن"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) ویب سائٹ پر جا کر ابھی OTP فائل کو تقسیم کریں۔
