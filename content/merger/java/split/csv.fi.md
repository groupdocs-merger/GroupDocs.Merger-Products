...
############################# Head ############################
head_title: "Jaa CSV useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen CSV-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "CSV Jakaja sisään Java"
description: "Jaa CSV muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto CSV sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden CSV-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa CSV tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto CSV GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa CSV tiedosto verkossa"
    content: |
       Jaa tiedosto CSV heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) -sivustolla.
