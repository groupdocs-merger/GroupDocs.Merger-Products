...
############################# Head ############################
head_title: "Skiptu VSDM í margar skrár í Java"
head_description: "Skiptu einni VSDM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSDM Skerandi í Java"
description: "Skiptu VSDM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSDM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSDM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSDM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSDM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSDM skrá á netinu"
    content: |
       Skiptu VSDM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) vefsíðu.
