...
############################# Head ############################
head_title: "Podijeli XLAM u više datoteka u Java"
head_description: "Podijelite jednu XLAM datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "XLAM Splitter u Java"
description: "Podijelite XLAM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli XLAM datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne XLAM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLAM datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli XLAM datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split XLAM datoteka na mreži"
    content: |
       Podijeli XLAM datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) web mjesto.
