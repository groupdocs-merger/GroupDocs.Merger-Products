...
############################# Head ############################
head_title: "DOTX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOTX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOTX Ayırıcı Java"
description: "DOTX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOTX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOTX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOTX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOTX Dosyasını Çevrimiçi Böl"
    content: |
       DOTX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) web sitesini ziyaret ederek bölün.
