...
############################# Head ############################
head_title: "Jagage MHTML mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail MHTML mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "MHTML Splitter in Java"
description: "Tükeldage MHTML mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage MHTML fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks MHTML-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili MHTML, kasutades Java näidet">}}

        ```java    
        // Jagage fail MHTML, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – MHTML faili jagamine võrgus"
    content: |
       Tükeldage fail MHTML kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
