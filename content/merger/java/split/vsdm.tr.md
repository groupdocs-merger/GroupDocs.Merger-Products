...
############################# Head ############################
head_title: "VSDM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VSDM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VSDM Ayırıcı Java"
description: "VSDM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSDM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSDM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VSDM Dosyasını Çevrimiçi Böl"
    content: |
       VSDM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) web sitesini ziyaret ederek bölün.
