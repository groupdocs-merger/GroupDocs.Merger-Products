...
############################# Head ############################
head_title: "Pisahkan CSV kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail CSV kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "CSV Pemisah Dalam Java"
description: "Pisahkan CSV dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan CSV Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail CSV kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail CSV menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail CSV menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split CSV Fail Dalam Talian"
    content: |
       Pisahkan fail CSV sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
