...
############################# Head ############################
head_title: "MHT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir MHT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "MHT Ayırıcı Java"
description: "MHT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "MHT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak MHT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - MHT Dosyasını Çevrimiçi Böl"
    content: |
       MHT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht) web sitesini ziyaret ederek bölün.
