...
############################# Head ############################
head_title: "Pisahkan XLAM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLAM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLAM Pemisah Dalam Java"
description: "Pisahkan XLAM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLAM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLAM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLAM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLAM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLAM Fail Dalam Talian"
    content: |
       Pisahkan fail XLAM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam).
