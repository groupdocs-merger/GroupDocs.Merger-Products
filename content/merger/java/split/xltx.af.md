...
############################# Head ############################
head_title: "Verdeel XLTX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLTX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLTX Splitter in Java"
description: "Verdeel XLTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLTX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLTX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLTX lêer aanlyn"
    content: |
       Verdeel XLTX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx) webwerf te besoek.
