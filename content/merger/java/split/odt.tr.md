...
############################# Head ############################
head_title: "ODT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir ODT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "ODT Ayırıcı Java"
description: "ODT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak ODT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - ODT Dosyasını Çevrimiçi Böl"
    content: |
       ODT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) web sitesini ziyaret ederek bölün.
