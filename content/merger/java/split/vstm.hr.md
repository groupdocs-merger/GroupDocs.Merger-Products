...
############################# Head ############################
head_title: "Podijeli VSTM u više datoteka u Java"
head_description: "Podijelite jednu VSTM datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "VSTM Splitter u Java"
description: "Podijelite VSTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VSTM datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VSTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSTM datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VSTM datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split VSTM datoteka na mreži"
    content: |
       Podijeli VSTM datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm) web mjesto.
