...
############################# Head ############################
head_title: "Dividiu VSDM en diversos fitxers a Java"
...
############################# Header ############################
title: "VSDM Divisor a Java"
description: "Dividiu VSDM amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer VSDM per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer VSDM en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer VSDM mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer VSDM mitjançant l'API de GroupDocs.Merger per a Java
