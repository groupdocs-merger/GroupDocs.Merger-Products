...
############################# Header ############################
title: "WORKSHEET Java 中的拆分器"
description: "用几行 Java 代码拆分 WORKSHEET。"
...
steps:
    enable: true
    title_left: "按 Java 中的页面拆分 WORKSHEET 文件"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码拆分 WORKSHEET 文件">}}

        ```java    
        // 使用 GroupDocs.Merger for Java API 拆分 WORKSHEET 文件
