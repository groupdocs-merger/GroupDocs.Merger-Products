...
############################# Head ############################
head_title: "Jagage RTF mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail RTF mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "RTF Splitter in Java"
description: "Tükeldage RTF mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage RTF fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks RTF-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili RTF, kasutades Java näidet">}}

        ```java    
        // Jagage fail RTF, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – RTF faili jagamine võrgus"
    content: |
       Tükeldage fail RTF kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
