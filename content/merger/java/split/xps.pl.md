...
############################# Head ############################
head_title: "Podziel XPS na wiele plików w Java"
head_description: "Podziel pojedynczy plik XPS na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "XPS Rozdzielacz w Java"
description: "Podziel XPS z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XPS według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XPS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XPS za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XPS za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik XPS online"
    content: |
       Podziel plik XPS już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps).
