...
############################# Head ############################
head_title: "Pisahkan OTT kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail OTT kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "OTT Pemisah Dalam Java"
description: "Pisahkan OTT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan OTT Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail OTT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail OTT menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail OTT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split OTT Fail Dalam Talian"
    content: |
       Pisahkan fail OTT sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott).
