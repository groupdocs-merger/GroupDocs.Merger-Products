...
############################# Head ############################
head_title: "Teilen Sie HTML in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne HTML-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "HTML Splittereingang Java"
description: "Teilen Sie HTML mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "HTML-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne HTML-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die HTML-Datei mit dem Java-Beispielcode">}}

        ```java    
        // HTML-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - HTML-Datei online teilen"
    content: |
       Teilen Sie die Datei HTML jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html) besuchen.
