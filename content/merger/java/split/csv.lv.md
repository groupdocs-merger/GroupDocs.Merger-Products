...
############################# Head ############################
head_title: "Sadaliet CSV vairākos failos programmā Java"
head_description: "Sadaliet vienu CSV failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "CSV sadalītājs programmā Java"
description: "Sadaliet CSV ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet CSV failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu CSV failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt CSV failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet CSV failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt CSV failu tiešsaistē"
    content: |
       Sadaliet CSV failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
