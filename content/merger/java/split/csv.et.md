...
############################# Head ############################
head_title: "Jagage CSV mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail CSV mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "CSV Splitter in Java"
description: "Tükeldage CSV mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage CSV fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks CSV-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili CSV, kasutades Java näidet">}}

        ```java    
        // Jagage fail CSV, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – CSV faili jagamine võrgus"
    content: |
       Tükeldage fail CSV kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
