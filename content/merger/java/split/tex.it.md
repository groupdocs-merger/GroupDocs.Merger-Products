...
############################# Head ############################
head_title: "Dividi TEX in più file in Java"
head_description: "Dividi un singolo file TEX in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "TEX Separatore in Java"
description: "Dividi TEX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file TEX per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file TEX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file TEX utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file TEX utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file TEX online"
    content: |
       Dividi subito il file TEX visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
