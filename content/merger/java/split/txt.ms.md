...
############################# Head ############################
head_title: "Pisahkan TXT kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail TXT kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "TXT Pemisah Dalam Java"
description: "Pisahkan TXT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan TXT Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail TXT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail TXT menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail TXT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split TXT Fail Dalam Talian"
    content: |
       Pisahkan fail TXT sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
