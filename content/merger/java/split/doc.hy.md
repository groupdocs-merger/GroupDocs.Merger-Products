...
############################# Head ############################
head_title: "Բաժանել DOC-ը մի քանի ֆայլերի Java-ում"
head_description: "Մեկ DOC ֆայլը բաժանեք մի քանի ֆայլերի՝ հիմնվելով էջերի համարների, էջի ընդմիջումների, զույգ կամ կենտ էջերի վրա՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "DOC Splitter Java-ում"
description: "Բաժանեք DOC-ը Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել DOC ֆայլը ըստ էջերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար մեկ DOC ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել DOC ֆայլը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Բաժանեք DOC ֆայլը՝ օգտագործելով GroupDocs.Merger Java API-ի համար
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Split DOC File Online"
    content: |
       Բաժանեք DOC ֆայլը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc) կայքը:
