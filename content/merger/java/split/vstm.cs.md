...
############################# Head ############################
head_title: "Rozdělit VSTM do více souborů v Java"
head_description: "Rozdělte jeden soubor VSTM do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "VSTM Splitter v Java"
description: "Rozdělte VSTM několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit VSTM soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru VSTM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor VSTM pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor VSTM pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru VSTM online"
    content: |
       Rozdělte soubor VSTM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
