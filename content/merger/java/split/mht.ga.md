...
############################# Head ############################
head_title: "Scoilt MHT ina Ilchomhaid i Java"
...
############################# Header ############################
title: "MHT Scoilteoir i Java"
description: "Scoilt MHT le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt MHT Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin MHT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad MHT a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt MHT comhad ag baint úsáide as GroupDocs.Merger do Java API
