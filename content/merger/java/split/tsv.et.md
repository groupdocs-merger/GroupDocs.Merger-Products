...
############################# Head ############################
head_title: "Jagage TSV mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail TSV mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "TSV Splitter in Java"
description: "Tükeldage TSV mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage TSV fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks TSV-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili TSV, kasutades Java näidet">}}

        ```java    
        // Jagage fail TSV, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – TSV faili jagamine võrgus"
    content: |
       Tükeldage fail TSV kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
