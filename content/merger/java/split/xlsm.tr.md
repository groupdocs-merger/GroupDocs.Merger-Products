...
############################# Head ############################
head_title: "XLSM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLSM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLSM Ayırıcı Java"
description: "XLSM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLSM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLSM Dosyasını Çevrimiçi Böl"
    content: |
       XLSM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm) web sitesini ziyaret ederek bölün.
