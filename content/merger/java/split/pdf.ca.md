...
############################# Head ############################
head_title: "Dividiu PDF en diversos fitxers a Java"
head_description: "Dividiu un únic fitxer PDF en diversos fitxers segons els números de pàgina, els intervals de pàgina i les pàgines parells o senars mitjançant l'API de fusió de documents."

############################# Header ############################
title: "PDF Divisor a Java"
description: "Dividiu PDF amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer PDF per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer PDF en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer PDF mitjançant el codi d'exemple Java">}}
...
demos:
    enable: true
    title: "Demostracions en directe: divideix el fitxer PDF en línia"
    content: |
       Dividiu el fitxer PDF ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
