...
############################# Head ############################
head_title: "Pisahkan ODT kepada Berbilang Fail dalam Java"
...
############################# Header ############################
title: "ODT Pemisah Dalam Java"
description: "Pisahkan ODT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan ODT Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail ODT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail ODT menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail ODT menggunakan GroupDocs.Merger untuk Java API
