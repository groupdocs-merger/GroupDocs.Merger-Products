...
############################# Head ############################
head_title: "Dividi PDF in più file in Java"
...
############################# Header ############################
title: "PDF Separatore in Java"
description: "Dividi PDF con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file PDF per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file PDF in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file PDF utilizzando il codice di esempio Java">}}
