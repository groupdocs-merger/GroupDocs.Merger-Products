...
############################# Head ############################
head_title: "Verdeel VSTX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VSTX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VSTX Splitter in Java"
description: "Verdeel VSTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSTX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSTX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VSTX lêer aanlyn"
    content: |
       Verdeel VSTX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) webwerf te besoek.
