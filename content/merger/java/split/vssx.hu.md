...
############################# Head ############################
head_title: "A(z) VSSX felosztása több fájlra a Java programban"
head_description: "Egyetlen VSSX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSX Splitter in Java"
description: "Oszd fel az VSSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) VSSX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen VSSX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az VSSX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az VSSX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split VSSX fájl online"
    content: |
       Ossza meg az VSSX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) webhely meglátogatásával.
