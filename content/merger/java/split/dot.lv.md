...
############################# Head ############################
head_title: "Sadaliet DOT vairākos failos programmā Java"
head_description: "Sadaliet vienu DOT failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "DOT sadalītājs programmā Java"
description: "Sadaliet DOT ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOT failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu DOT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOT failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet DOT failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt DOT failu tiešsaistē"
    content: |
       Sadaliet DOT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot).
