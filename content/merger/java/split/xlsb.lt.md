...
############################# Head ############################
head_title: "Padalinkite XLSB į kelis failus Java"
head_description: "Padalinkite vieną XLSB failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "XLSB skirstytuvas Java"
description: "Padalinkite XLSB keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLSB failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XLSB failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLSB failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XLSB failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite XLSB failą internete"
    content: |
       Padalykite XLSB failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) svetainėje.
