...
############################# Head ############################
head_title: "Pisahkan XLSB kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail XLSB kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLSB Pemisah Dalam Java"
description: "Pisahkan XLSB dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLSB Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail XLSB kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail XLSB menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail XLSB menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split XLSB Fail Dalam Talian"
    content: |
       Pisahkan fail XLSB sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
