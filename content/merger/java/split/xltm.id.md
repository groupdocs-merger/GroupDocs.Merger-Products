...
head_description: "Pisahkan satu file XLTM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLTM Pemisah Di Java"
description: "Pisahkan XLTM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLTM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLTM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file XLTM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file XLTM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan XLTM File Online"
    content: |
       Pisahkan file XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/xltm).
