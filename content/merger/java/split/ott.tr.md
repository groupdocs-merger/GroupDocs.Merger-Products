...
############################# Head ############################
head_title: "OTT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir OTT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "OTT Ayırıcı Java"
description: "OTT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "OTT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak OTT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak OTT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - OTT Dosyasını Çevrimiçi Böl"
    content: |
       OTT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) web sitesini ziyaret ederek bölün.
