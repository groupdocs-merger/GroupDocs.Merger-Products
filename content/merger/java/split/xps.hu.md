...
############################# Head ############################
head_title: "A(z) XPS felosztása több fájlra a Java programban"
head_description: "Egyetlen XPS fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XPS Splitter in Java"
description: "Oszd fel az XPS elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) XPS fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen XPS fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az XPS fájl felosztása a Java példakóddal">}}

        ```java    
        // Az XPS fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split XPS fájl online"
    content: |
       Ossza meg az XPS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) webhely meglátogatásával.
