...
############################# Head ############################
head_title: "Padalinkite XLTX į kelis failus Java"
head_description: "Padalinkite vieną XLTX failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "XLTX skirstytuvas Java"
description: "Padalinkite XLTX keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLTX failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XLTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLTX failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XLTX failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite XLTX failą internete"
    content: |
       Padalykite XLTX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx) svetainėje.
