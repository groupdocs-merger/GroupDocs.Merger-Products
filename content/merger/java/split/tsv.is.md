...
############################# Head ############################
head_title: "Skiptu TSV í margar skrár í Java"
...
############################# Header ############################
title: "TSV Skerandi í Java"
description: "Skiptu TSV með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu TSV skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni TSV skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta TSV skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu TSV skrá með GroupDocs.Merger fyrir Java API
