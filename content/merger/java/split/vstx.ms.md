...
############################# Head ############################
head_title: "Pisahkan VSTX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSTX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSTX Pemisah Dalam Java"
description: "Pisahkan VSTX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSTX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSTX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSTX Fail Dalam Talian"
    content: |
       Pisahkan fail VSTX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx).
