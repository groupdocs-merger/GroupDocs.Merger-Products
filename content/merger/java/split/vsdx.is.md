...
############################# Head ############################
head_title: "Skiptu VSDX í margar skrár í Java"
head_description: "Skiptu einni VSDX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSDX Skerandi í Java"
description: "Skiptu VSDX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSDX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSDX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSDX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSDX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSDX skrá á netinu"
    content: |
       Skiptu VSDX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx) vefsíðu.
