...
############################# Head ############################
head_title: "Razdeli DOCX na več datotek v Java"
head_description: "Eno datoteko DOCX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "DOCX razdelilnik v Java"
description: "Razdelite DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko DOCX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke DOCX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko DOCX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko DOCX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli DOCX datoteko na spletu"
    content: |
       Takoj razdelite datoteko DOCX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
