...
############################# Head ############################
head_title: "Podijeli RTF u više datoteka u Java"
head_description: "Podijelite jednu RTF datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "RTF Splitter u Java"
description: "Podijelite RTF s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli RTF datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne RTF datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti RTF datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli RTF datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split RTF datoteka na mreži"
    content: |
       Podijeli RTF datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf) web mjesto.
