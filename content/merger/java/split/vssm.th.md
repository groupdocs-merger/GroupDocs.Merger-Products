...
############################# Head ############################
head_title: "แยก VSSM ออกเป็นหลายไฟล์ใน Java"
head_description: "แยกไฟล์ VSSM ไฟล์เดียวออกเป็นหลายไฟล์ตามหมายเลขหน้า ช่วงหน้า หน้าคู่หรือหน้าคี่โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "VSSM แยกใน Java"
description: "แยก VSSM ด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "แยกไฟล์ VSSM ทีละหน้าใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ช่วยให้นักพัฒนา Java แยกไฟล์ VSSM ไฟล์เดียวออกเป็นไฟล์ผลลัพธ์ได้หลายไฟล์โดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีแยกไฟล์ VSSM โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // แยกไฟล์ VSSM โดยใช้ GroupDocs.Merger สำหรับ Java API
...
demos:
    enable: true
    title: "การสาธิตสด - แยกไฟล์ VSSM ออนไลน์"
    content: |
       แยกไฟล์ VSSM ออกทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm)
