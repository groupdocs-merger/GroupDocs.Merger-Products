...
############################# Head ############################
head_title: "Jaa PPS useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen PPS-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "PPS Jakaja sisään Java"
description: "Jaa PPS muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto PPS sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden PPS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPS tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto PPS GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa PPS tiedosto verkossa"
    content: |
       Jaa tiedosto PPS heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) -sivustolla.
