...
############################# Head ############################
head_title: "Verdeel ODP in veelvuldige lêers in Java"
...
description: "Verdeel ODP met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel ODP lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele ODP-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODP-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel ODP lêer deur GroupDocs.Merger vir Java API te gebruik
