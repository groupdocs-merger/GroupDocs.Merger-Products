...
############################# Head ############################
head_title: "Rozdělit ONE do více souborů v Java"
head_description: "Rozdělte jeden soubor ONE do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "ONE Splitter v Java"
description: "Rozdělte ONE několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit ONE soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru ONE do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor ONE pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor ONE pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru ONE online"
    content: |
       Rozdělte soubor ONE právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
