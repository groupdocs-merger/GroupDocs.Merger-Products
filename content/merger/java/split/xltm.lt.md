...
############################# Head ############################
head_title: "Padalinkite XLTM į kelis failus Java"
head_description: "Padalinkite vieną XLTM failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "XLTM skirstytuvas Java"
description: "Padalinkite XLTM keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLTM failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną XLTM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLTM failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite XLTM failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite XLTM failą internete"
    content: |
       Padalykite XLTM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm) svetainėje.
