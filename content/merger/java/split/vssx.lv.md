...
############################# Head ############################
head_title: "Sadaliet VSSX vairākos failos programmā Java"
head_description: "Sadaliet vienu VSSX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSSX sadalītājs programmā Java"
description: "Sadaliet VSSX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSSX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSSX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSSX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSSX failu tiešsaistē"
    content: |
       Sadaliet VSSX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
