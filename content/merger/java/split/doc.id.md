...
head_description: "Pisahkan satu file DOC menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOC Pemisah Di Java"
description: "Pisahkan DOC dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOC File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file DOC menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file DOC menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file DOC menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan DOC File Online"
    content: |
       Pisahkan file DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/doc).
