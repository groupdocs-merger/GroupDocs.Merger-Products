...
############################# Head ############################
head_title: "Razdeli PPT na več datotek v Java"
head_description: "Eno datoteko PPT razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "PPT razdelilnik v Java"
description: "Razdelite PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko PPT po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke PPT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko PPT s primerom kode Java">}}

        ```java    
        // Razdeli datoteko PPT z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli PPT datoteko na spletu"
    content: |
       Takoj razdelite datoteko PPT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
