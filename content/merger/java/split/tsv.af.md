...
############################# Head ############################
head_title: "Verdeel TSV in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele TSV-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "TSV Splitter in Java"
description: "Verdeel TSV met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel TSV lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele TSV-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TSV-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel TSV lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel TSV lêer aanlyn"
    content: |
       Verdeel TSV-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) webwerf te besoek.
