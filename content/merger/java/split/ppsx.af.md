...
############################# Head ############################
head_title: "Verdeel PPSX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele PPSX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "PPSX Splitter in Java"
description: "Verdeel PPSX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPSX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele PPSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel PPSX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel PPSX lêer aanlyn"
    content: |
       Verdeel PPSX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) webwerf te besoek.
