...
############################# Head ############################
head_title: "Razdeli PPS na več datotek v Java"
...
############################# Header ############################
title: "PPS razdelilnik v Java"
description: "Razdelite PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko PPS po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke PPS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko PPS s primerom kode Java">}}

        ```java    
        // Razdeli datoteko PPS z API-jem GroupDocs.Merger za Java
