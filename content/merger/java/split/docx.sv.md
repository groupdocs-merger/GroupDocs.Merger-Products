...
############################# Head ############################
head_title: "Dela upp DOCX i flera filer i Java"
head_description: "Dela upp en enda DOCX-fil i flera filer baserat på sidnummer, sidintervall, jämna eller udda sidor med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "DOCX splitter i Java"
description: "Dela upp DOCX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOCX fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda DOCX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOCX-filen med hjälp av Java exempelkod">}}

        ```java    
        // Dela DOCX-fil med GroupDocs.Merger för Java API
...
demos:
    enable: true
    title: "Livedemos - Split DOCX fil online"
    content: |
       Dela upp DOCX-filen just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
