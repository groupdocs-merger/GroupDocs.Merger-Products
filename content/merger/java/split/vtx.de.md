...
############################# Head ############################
head_title: "Teilen Sie VTX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VTX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VTX Splittereingang Java"
description: "Teilen Sie VTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VTX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VTX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VTX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VTX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VTX-Datei online teilen"
    content: |
       Teilen Sie die Datei VTX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) besuchen.
