...
############################# Head ############################
head_title: "Sadaliet XLSB vairākos failos programmā Java"
head_description: "Sadaliet vienu XLSB failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLSB sadalītājs programmā Java"
description: "Sadaliet XLSB ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSB failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLSB failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSB failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLSB failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLSB failu tiešsaistē"
    content: |
       Sadaliet XLSB failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
