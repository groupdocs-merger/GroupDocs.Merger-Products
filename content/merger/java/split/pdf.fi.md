...
############################# Head ############################
head_title: "Jaa PDF useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen PDF-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "PDF Jakaja sisään Java"
description: "Jaa PDF muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto PDF sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden PDF-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PDF tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto PDF GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa PDF tiedosto verkossa"
    content: |
       Jaa tiedosto PDF heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) -sivustolla.
