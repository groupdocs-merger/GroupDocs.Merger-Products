...
############################# Head ############################
head_title: "Jagage PPTX mitmeks failiks rakenduses Java"
...
description: "Tükeldage PPTX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPTX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks PPTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili PPTX, kasutades Java näidet">}}

        ```java    
        // Jagage fail PPTX, kasutades GroupDocs.Merger for Java API-t
