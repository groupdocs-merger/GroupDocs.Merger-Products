...
############################# Head ############################
head_title: "Pisahkan ONE menjadi Beberapa File di Java"
head_description: "Pisahkan satu file ONE menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "ONE Pemisah Di Java"
description: "Pisahkan ONE dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan ONE File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file ONE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file ONE menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file ONE menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan ONE File Online"
    content: |
       Pisahkan file ONE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/one).
