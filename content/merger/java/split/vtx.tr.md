...
############################# Head ############################
head_title: "VTX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir VTX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "VTX Ayırıcı Java"
description: "VTX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VTX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VTX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VTX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - VTX Dosyasını Çevrimiçi Böl"
    content: |
       VTX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) web sitesini ziyaret ederek bölün.
