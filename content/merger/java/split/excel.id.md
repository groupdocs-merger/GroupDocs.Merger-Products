...
head_description: "Pisahkan satu file EXCEL menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "EXCEL Pemisah Di Java"
description: "Pisahkan EXCEL dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan EXCEL File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file EXCEL menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file EXCEL menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file EXCEL menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan EXCEL File Online"
    content: |
       Pisahkan file EXCEL sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/excel).
