...
############################# Head ############################
head_title: "Divida TXT em vários arquivos em Java"
head_description: "Divida um único arquivo TXT em vários arquivos com base em números de página, intervalos de página, páginas pares ou ímpares usando a API de fusão de documentos."

############################# Header ############################
title: "TXT Divisor em Java"
description: "Divida TXT com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Dividir TXT arquivo por páginas em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java dividir um único arquivo TXT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir o arquivo TXT usando o código de exemplo Java">}}

        ```java    
        // Divida o arquivo TXT usando GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Dividir arquivo TXT on-line"
    content: |
       Divida o arquivo TXT agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
