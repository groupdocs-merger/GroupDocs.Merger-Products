...
############################# Head ############################
head_title: "Podziel VSDX na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSDX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSDX Rozdzielacz w Java"
description: "Podziel VSDX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSDX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSDX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSDX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSDX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSDX online"
    content: |
       Podziel plik VSDX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx).
