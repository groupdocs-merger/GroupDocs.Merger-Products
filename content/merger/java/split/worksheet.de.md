...
############################# Head ############################
head_title: "Teilen Sie WORKSHEET in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne WORKSHEET-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "WORKSHEET Splittereingang Java"
description: "Teilen Sie WORKSHEET mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "WORKSHEET-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne WORKSHEET-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die WORKSHEET-Datei mit dem Java-Beispielcode">}}

        ```java    
        // WORKSHEET-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - WORKSHEET-Datei online teilen"
    content: |
       Teilen Sie die Datei WORKSHEET jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/worksheet) besuchen.
