...
############################# Head ############################
head_title: "Jaa RTF useiksi tiedostoiksi Java"
...
############################# Header ############################
title: "RTF Jakaja sisään Java"
description: "Jaa RTF muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto RTF sivujen mukaan kohteessa Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa RTF tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto RTF GroupDocs.Merger for Java API:lla
