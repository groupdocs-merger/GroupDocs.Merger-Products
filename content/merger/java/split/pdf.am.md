...
############################# Head ############################
head_title: "PDFን በJava ውስጥ ወደ ብዙ ፋይሎች ተከፋፍል"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም አንድ ነጠላ PDF ፋይል በገጽ ቁጥሮች፣ የገጽ ክፍተቶች፣ አልፎ ተርፎም ወይም ያልተለመዱ ገጾችን ወደ ብዙ ፋይሎች ይከፋፍሉ።"

############################# Header ############################
title: "PDF Splitter በJava ውስጥ"
description: "PDFን በጥቂት የJava ኮድ መስመሮች ተከፍል።"
...
steps:
    enable: true
    title_left: "PDF ፋይል በገጽ በJava ክፈል"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች አንድን ነጠላ PDF ፋይል በመተግበር ወደ ብዙ የውጤት ፋይሎች መከፋፈል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF ፋይልን Java ምሳሌ ኮድን በመጠቀም እንዴት እንደሚከፋፈል">}}

        ```java    
        // GroupDocs.Mergerን ለጃቫ ኤፒአይ በመጠቀም PDF ፋይል ክፈሉ።
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የተከፈለ PDF ፋይል በመስመር ላይ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) ድር ጣቢያን በመጎብኘት የPDF ፋይል አሁኑኑ ይከፋፍሉ።
