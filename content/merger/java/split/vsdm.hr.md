...
############################# Head ############################
head_title: "Podijeli VSDM u više datoteka u Java"
head_description: "Podijelite jednu VSDM datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "VSDM Splitter u Java"
description: "Podijelite VSDM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VSDM datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VSDM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSDM datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VSDM datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split VSDM datoteka na mreži"
    content: |
       Podijeli VSDM datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) web mjesto.
