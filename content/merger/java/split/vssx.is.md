...
############################# Head ############################
head_title: "Skiptu VSSX í margar skrár í Java"
head_description: "Skiptu einni VSSX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSSX Skerandi í Java"
description: "Skiptu VSSX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSSX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSSX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSSX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSSX skrá á netinu"
    content: |
       Skiptu VSSX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) vefsíðu.
