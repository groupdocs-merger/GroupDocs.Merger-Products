...
############################# Head ############################
head_title: "Skiptu PPS í margar skrár í Java"
head_description: "Skiptu einni PPS skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "PPS Skerandi í Java"
description: "Skiptu PPS með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPS skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni PPS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPS skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu PPS skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu PPS skrá á netinu"
    content: |
       Skiptu PPS skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) vefsíðu.
