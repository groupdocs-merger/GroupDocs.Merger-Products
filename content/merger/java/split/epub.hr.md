...
############################# Head ############################
head_title: "Podijeli EPUB u više datoteka u Java"
head_description: "Podijelite jednu EPUB datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "EPUB Splitter u Java"
description: "Podijelite EPUB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli EPUB datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne EPUB datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti EPUB datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli EPUB datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split EPUB datoteka na mreži"
    content: |
       Podijeli EPUB datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) web mjesto.
