...
############################# Head ############################
head_title: "Sadaliet VSSM vairākos failos programmā Java"
head_description: "Sadaliet vienu VSSM failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSSM sadalītājs programmā Java"
description: "Sadaliet VSSM ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSSM failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSSM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSSM failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSSM failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSSM failu tiešsaistē"
    content: |
       Sadaliet VSSM failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
