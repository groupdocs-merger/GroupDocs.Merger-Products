...
############################# Head ############################
head_title: "Teilen Sie CSV in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne CSV-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "CSV Splittereingang Java"
description: "Teilen Sie CSV mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "CSV-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne CSV-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die CSV-Datei mit dem Java-Beispielcode">}}

        ```java    
        // CSV-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - CSV-Datei online teilen"
    content: |
       Teilen Sie die Datei CSV jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) besuchen.
