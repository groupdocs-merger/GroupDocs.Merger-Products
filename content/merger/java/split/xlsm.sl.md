...
############################# Head ############################
head_title: "Razdeli XLSM na več datotek v Java"
head_description: "Eno datoteko XLSM razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XLSM razdelilnik v Java"
description: "Razdelite XLSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XLSM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XLSM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XLSM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XLSM z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XLSM datoteko na spletu"
    content: |
       Takoj razdelite datoteko XLSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm).
