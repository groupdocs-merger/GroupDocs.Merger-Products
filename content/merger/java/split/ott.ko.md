...
############################# Head ############################
head_title: "Java에서 OTT을(를) 여러 파일로 분할"
head_description: "문서 병합 API를 사용하여 단일 OTT 파일을 페이지 번호, 페이지 간격, 짝수 또는 홀수 페이지에 따라 여러 파일로 분할합니다."

############################# Header ############################
title: "OTT Java의 스플리터"
description: "몇 줄의 Java 코드로 OTT를 나눕니다."
...
steps:
    enable: true
    title_left: "Java의 페이지별로 OTT 파일 분할"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 OTT 파일을 분할하는 방법">}}

        ```java    
        // Java API용 GroupDocs.Merger를 사용하여 OTT 파일 분할
...
demos:
    enable: true
    title: "라이브 데모 - 온라인에서 OTT 파일 분할"
    content: |
       지금 바로 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) 웹사이트를 방문하여 OTT 파일을 분할하세요.
