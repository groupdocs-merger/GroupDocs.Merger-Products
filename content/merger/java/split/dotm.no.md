...
############################# Head ############################
head_title: "Del DOTM i flere filer i Java"
...
description: "Del DOTM med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del DOTM-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt DOTM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOTM-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del DOTM-filen med GroupDocs.Merger for Java API
