...
############################# Head ############################
head_title: "Rozdeliť OTP do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor OTP do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "OTP Splitter v Java"
description: "Rozdeľte OTP niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť OTP súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor OTP na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť OTP súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor OTP pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru OTP online"
    content: |
       Rozdeľte súbor OTP hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
