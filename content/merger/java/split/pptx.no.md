...
############################# Head ############################
head_title: "Del PPTX i flere filer i Java"
head_description: "Del en enkelt PPTX-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "PPTX splitter i Java"
description: "Del PPTX med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del PPTX-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt PPTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PPTX-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del PPTX-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del PPTX-fil på nett"
    content: |
       Del opp PPTX-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx).
