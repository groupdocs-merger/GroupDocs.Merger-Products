...
############################# Head ############################
head_title: "Sadaliet VSDX vairākos failos programmā Java"
head_description: "Sadaliet vienu VSDX failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "VSDX sadalītājs programmā Java"
description: "Sadaliet VSDX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSDX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VSDX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSDX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VSDX failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt VSDX failu tiešsaistē"
    content: |
       Sadaliet VSDX failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx).
