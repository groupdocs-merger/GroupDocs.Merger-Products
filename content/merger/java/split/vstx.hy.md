...
############################# Head ############################
head_title: "Բաժանել VSTX-ը մի քանի ֆայլերի Java-ում"
head_description: "Մեկ VSTX ֆայլը բաժանեք մի քանի ֆայլերի՝ հիմնվելով էջերի համարների, էջի ընդմիջումների, զույգ կամ կենտ էջերի վրա՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "VSTX Splitter Java-ում"
description: "Բաժանեք VSTX-ը Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել VSTX ֆայլը ըստ էջերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար մեկ VSTX ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել VSTX ֆայլը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Բաժանեք VSTX ֆայլը՝ օգտագործելով GroupDocs.Merger Java API-ի համար
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Split VSTX File Online"
    content: |
       Բաժանեք VSTX ֆայլը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) կայքը:
