...
############################# Head ############################
head_title: "Jaa ONE useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen ONE-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "ONE Jakaja sisään Java"
description: "Jaa ONE muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto ONE sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden ONE-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ONE tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto ONE GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa ONE tiedosto verkossa"
    content: |
       Jaa tiedosto ONE heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one) -sivustolla.
