...
############################# Head ############################
head_title: "Podziel EPUB na wiele plików w Java"
...
############################# Header ############################
title: "EPUB Rozdzielacz w Java"
description: "Podziel EPUB z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik EPUB według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku EPUB na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik EPUB za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik EPUB za pomocą GroupDocs.Merger for Java API
