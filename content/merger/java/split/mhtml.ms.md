...
############################# Head ############################
head_title: "Pisahkan MHTML kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail MHTML kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "MHTML Pemisah Dalam Java"
description: "Pisahkan MHTML dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan MHTML Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail MHTML kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail MHTML menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail MHTML menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split MHTML Fail Dalam Talian"
    content: |
       Pisahkan fail MHTML sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
