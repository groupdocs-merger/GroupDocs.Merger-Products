...
############################# Head ############################
head_title: "Podziel RTF na wiele plików w Java"
head_description: "Podziel pojedynczy plik RTF na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "RTF Rozdzielacz w Java"
description: "Podziel RTF z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik RTF według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku RTF na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik RTF za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik RTF za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik RTF online"
    content: |
       Podziel plik RTF już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rtf).
