...
############################# Head ############################
head_title: "Padalinkite VSDM į kelis failus Java"
head_description: "Padalinkite vieną VSDM failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "VSDM skirstytuvas Java"
description: "Padalinkite VSDM keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSDM failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną VSDM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSDM failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite VSDM failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite VSDM failą internete"
    content: |
       Padalykite VSDM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm) svetainėje.
