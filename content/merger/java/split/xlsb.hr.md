...
############################# Head ############################
head_title: "Podijeli XLSB u više datoteka u Java"
head_description: "Podijelite jednu XLSB datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "XLSB Splitter u Java"
description: "Podijelite XLSB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli XLSB datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne XLSB datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLSB datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli XLSB datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split XLSB datoteka na mreži"
    content: |
       Podijeli XLSB datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) web mjesto.
