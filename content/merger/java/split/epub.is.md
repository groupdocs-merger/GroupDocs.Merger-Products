...
############################# Head ############################
head_title: "Skiptu EPUB í margar skrár í Java"
head_description: "Skiptu einni EPUB skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "EPUB Skerandi í Java"
description: "Skiptu EPUB með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu EPUB skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni EPUB skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta EPUB skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu EPUB skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu EPUB skrá á netinu"
    content: |
       Skiptu EPUB skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) vefsíðu.
