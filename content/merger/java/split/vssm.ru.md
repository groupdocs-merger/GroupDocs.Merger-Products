...
############################# Head ############################
head_title: "Разделить VSSM на несколько файлов на Java"
...
############################# Header ############################
title: "VSSM Разделитель на Java"
description: "Разделите VSSM страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Разделить VSSM файл по страницам на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) позволяет разработчикам Java легко разделить один файл VSSM на несколько результирующих файлов, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файл VSSM, используя пример кода Java">}}

        ```java    
        // Разделить файл VSSM с помощью GroupDocs.Merger for Java API
