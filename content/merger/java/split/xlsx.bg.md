...
description: "Split XLSX with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) makes it easy for Java developers to split a single XLSX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split XLSX file using Java example code">}}

        ```java    
        // Split XLSX file using GroupDocs.Merger for Java API
