...
############################# Head ############################
head_title: "Разделете XLSX на няколко файла в Java"
head_description: "Разделете един файл XLSX на няколко файла въз основа на номера на страници, интервали между страници, четни или нечетни страници, като използвате API за сливане на документи."

############################# Header ############################
title: "XLSX Сплитер в Java"
description: "Разделете XLSX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете XLSX файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл XLSX на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл XLSX с примерен код на Java">}}

        ```java    
        // Разделете XLSX файл с помощта на GroupDocs.Merger за Java API
...
demos:
    enable: true
    title: "Демонстрации на живо - Разделете XLSX файл онлайн"
    content: |
       Разделете файла XLSX веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx).
