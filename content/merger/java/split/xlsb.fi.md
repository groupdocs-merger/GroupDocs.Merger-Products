...
############################# Head ############################
head_title: "Jaa XLSB useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLSB-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLSB Jakaja sisään Java"
description: "Jaa XLSB muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLSB sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLSB-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLSB tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLSB GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLSB tiedosto verkossa"
    content: |
       Jaa tiedosto XLSB heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) -sivustolla.
