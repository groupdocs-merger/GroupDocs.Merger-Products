...
############################# Head ############################
head_title: "Teilen Sie VISIO in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VISIO-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VISIO Splittereingang Java"
description: "Teilen Sie VISIO mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VISIO-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VISIO-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VISIO-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VISIO-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VISIO-Datei online teilen"
    content: |
       Teilen Sie die Datei VISIO jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/visio) besuchen.
