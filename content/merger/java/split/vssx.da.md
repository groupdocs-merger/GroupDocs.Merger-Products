...
############################# Head ############################
head_title: "Opdel VSSX i flere filer i Java"
head_description: "Opdel en enkelt VSSX-fil i flere filer baseret på sidetal, sideintervaller, lige eller ulige sider ved hjælp af Documents Merger API."

############################# Header ############################
title: "VSSX Splitter i Java"
description: "Opdel VSSX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Opdel VSSX fil efter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at opdele en enkelt VSSX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSSX fil ved hjælp af Java eksempelkode">}}

        ```java    
        // Opdel VSSX fil ved hjælp af GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Livedemoer - Split VSSX fil online"
    content: |
       Opdel VSSX-filen lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
