...
############################# Head ############################
head_title: "Podijeli XLTM u više datoteka u Java"
head_description: "Podijelite jednu XLTM datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "XLTM Splitter u Java"
description: "Podijelite XLTM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli XLTM datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne XLTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLTM datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli XLTM datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split XLTM datoteka na mreži"
    content: |
       Podijeli XLTM datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm) web mjesto.
