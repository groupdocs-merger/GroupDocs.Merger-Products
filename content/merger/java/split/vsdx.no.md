...
############################# Head ############################
head_title: "Del VSDX i flere filer i Java"
head_description: "Del en enkelt VSDX-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "VSDX splitter i Java"
description: "Del VSDX med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del VSDX-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt VSDX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSDX-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del VSDX-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del VSDX-fil på nett"
    content: |
       Del opp VSDX-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx).
