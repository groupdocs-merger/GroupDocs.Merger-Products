...
############################# Head ############################
head_title: "XLSB'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLSB dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLSB Ayırıcı Java"
description: "XLSB kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLSB Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSB dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLSB dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLSB Dosyasını Çevrimiçi Böl"
    content: |
       XLSB dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) web sitesini ziyaret ederek bölün.
