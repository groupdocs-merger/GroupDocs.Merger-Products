...
############################# Head ############################
head_title: "Dividiu TEX en diversos fitxers a Java"
head_description: "Dividiu un únic fitxer TEX en diversos fitxers segons els números de pàgina, els intervals de pàgina i les pàgines parells o senars mitjançant l'API de fusió de documents."

############################# Header ############################
title: "TEX Divisor a Java"
description: "Dividiu TEX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Dividiu el fitxer TEX per pàgines a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita als desenvolupadors de Java dividir un únic fitxer TEX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir el fitxer TEX mitjançant el codi d'exemple Java">}}

        ```java    
        // Dividiu el fitxer TEX mitjançant l'API de GroupDocs.Merger per a Java
...
demos:
    enable: true
    title: "Demostracions en directe: divideix el fitxer TEX en línia"
    content: |
       Dividiu el fitxer TEX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
