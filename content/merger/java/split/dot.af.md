...
############################# Head ############################
head_title: "Verdeel DOT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele DOT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "DOT Splitter in Java"
description: "Verdeel DOT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel DOT lêer aanlyn"
    content: |
       Verdeel DOT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) webwerf te besoek.
