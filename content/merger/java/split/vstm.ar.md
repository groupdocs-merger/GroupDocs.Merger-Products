...
############################# Head ############################
head_title: "تقسيم VSTM إلى ملفات متعددة في Java"
...
############################# Header ############################
title: "VSTM الفاصل في Java"
description: "قسِّم VSTM ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تقسيم VSTM الملف حسب الصفحات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تقسيم ملف واحد VSTM إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملف VSTM باستخدام مثال كود Java">}}

        ```java    
        // انقسام الملف VSTM باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
