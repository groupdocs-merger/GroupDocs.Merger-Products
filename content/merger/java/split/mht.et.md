...
############################# Head ############################
head_title: "Jagage MHT mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail MHT mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "MHT Splitter in Java"
description: "Tükeldage MHT mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage MHT fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks MHT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili MHT, kasutades Java näidet">}}

        ```java    
        // Jagage fail MHT, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – MHT faili jagamine võrgus"
    content: |
       Tükeldage fail MHT kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
