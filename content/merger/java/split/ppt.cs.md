...
############################# Head ############################
head_title: "Rozdělit PPT do více souborů v Java"
head_description: "Rozdělte jeden soubor PPT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "PPT Splitter v Java"
description: "Rozdělte PPT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit PPT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru PPT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor PPT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor PPT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru PPT online"
    content: |
       Rozdělte soubor PPT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
