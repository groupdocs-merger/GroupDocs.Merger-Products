...
############################# Head ############################
head_title: "PDF'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir PDF dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "PDF Ayırıcı Java"
description: "PDF kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "PDF Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak PDF dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak PDF dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - PDF Dosyasını Çevrimiçi Böl"
    content: |
       PDF dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) web sitesini ziyaret ederek bölün.
