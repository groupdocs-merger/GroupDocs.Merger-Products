...
############################# Head ############################
head_title: "Podijeli VSDX u više datoteka u Java"
...
############################# Header ############################
title: "VSDX Splitter u Java"
description: "Podijelite VSDX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VSDX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VSDX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSDX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VSDX datoteku koristeći GroupDocs.Merger za Java API
