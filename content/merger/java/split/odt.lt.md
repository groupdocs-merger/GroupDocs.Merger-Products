...
############################# Head ############################
head_title: "Padalinkite ODT į kelis failus Java"
head_description: "Padalinkite vieną ODT failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "ODT skirstytuvas Java"
description: "Padalinkite ODT keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ODT failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną ODT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ODT failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite ODT failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite ODT failą internete"
    content: |
       Padalykite ODT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) svetainėje.
