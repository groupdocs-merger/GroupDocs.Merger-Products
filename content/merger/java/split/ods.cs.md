...
############################# Head ############################
head_title: "Rozdělit ODS do více souborů v Java"
head_description: "Rozdělte jeden soubor ODS do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "ODS Splitter v Java"
description: "Rozdělte ODS několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit ODS soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru ODS do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor ODS pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor ODS pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru ODS online"
    content: |
       Rozdělte soubor ODS právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
