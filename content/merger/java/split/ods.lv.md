...
############################# Head ############################
head_title: "Sadaliet ODS vairākos failos programmā Java"
head_description: "Sadaliet vienu ODS failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "ODS sadalītājs programmā Java"
description: "Sadaliet ODS ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODS failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu ODS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODS failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet ODS failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt ODS failu tiešsaistē"
    content: |
       Sadaliet ODS failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
