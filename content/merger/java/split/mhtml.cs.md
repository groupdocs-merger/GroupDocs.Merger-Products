...
############################# Head ############################
head_title: "Rozdělit MHTML do více souborů v Java"
head_description: "Rozdělte jeden soubor MHTML do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "MHTML Splitter v Java"
description: "Rozdělte MHTML několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit MHTML soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru MHTML do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor MHTML pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor MHTML pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru MHTML online"
    content: |
       Rozdělte soubor MHTML právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
