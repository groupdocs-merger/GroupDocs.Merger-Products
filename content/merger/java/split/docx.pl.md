...
############################# Head ############################
head_title: "Podziel DOCX na wiele plików w Java"
...
############################# Header ############################
title: "DOCX Rozdzielacz w Java"
description: "Podziel DOCX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik DOCX według stron w Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik DOCX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik DOCX za pomocą GroupDocs.Merger for Java API
