...
############################# Head ############################
head_title: "Del VSSX i flere filer i Java"
...
description: "Del VSSX med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del VSSX-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt VSSX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSSX-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del VSSX-filen med GroupDocs.Merger for Java API
