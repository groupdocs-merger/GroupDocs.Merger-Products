...
############################# Head ############################
head_title: "Del MHT i flere filer i Java"
head_description: "Del en enkelt MHT-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "MHT splitter i Java"
description: "Del MHT med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del MHT-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt MHT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp MHT-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del MHT-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del MHT-fil på nett"
    content: |
       Del opp MHT-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
