...
############################# Head ############################
head_title: "XPS файлын Java ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "XPS Java ішіндегі бөлгіш"
description: "XPS кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "XPS файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір XPS файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // XPS файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
