...
############################# Head ############################
head_title: "Dividi CSV in più file in Java"
head_description: "Dividi un singolo file CSV in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "CSV Separatore in Java"
description: "Dividi CSV con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file CSV per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file CSV in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file CSV utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file CSV utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file CSV online"
    content: |
       Dividi subito il file CSV visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv).
