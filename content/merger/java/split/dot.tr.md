...
############################# Head ############################
head_title: "DOT'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOT dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOT Ayırıcı Java"
description: "DOT kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOT Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOT dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOT dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOT Dosyasını Çevrimiçi Böl"
    content: |
       DOT dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot) web sitesini ziyaret ederek bölün.
