...
############################# Head ############################
head_title: "Teilen Sie OTT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne OTT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "OTT Splittereingang Java"
description: "Teilen Sie OTT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "OTT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne OTT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die OTT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // OTT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - OTT-Datei online teilen"
    content: |
       Teilen Sie die Datei OTT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) besuchen.
