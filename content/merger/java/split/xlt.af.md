...
############################# Head ############################
head_title: "Verdeel XLT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLT Splitter in Java"
description: "Verdeel XLT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLT lêer aanlyn"
    content: |
       Verdeel XLT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt) webwerf te besoek.
