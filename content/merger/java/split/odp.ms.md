...
############################# Head ############################
head_title: "Pisahkan ODP kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail ODP kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "ODP Pemisah Dalam Java"
description: "Pisahkan ODP dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan ODP Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail ODP kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail ODP menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail ODP menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split ODP Fail Dalam Talian"
    content: |
       Pisahkan fail ODP sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp).
