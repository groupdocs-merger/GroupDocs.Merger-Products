...
############################# Head ############################
head_title: "Verdeel EPUB in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele EPUB-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "EPUB Splitter in Java"
description: "Verdeel EPUB met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel EPUB lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele EPUB-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om EPUB-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel EPUB lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel EPUB lêer aanlyn"
    content: |
       Verdeel EPUB-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) webwerf te besoek.
