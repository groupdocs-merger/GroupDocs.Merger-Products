...
############################# Header ############################
title: "WEB Splitter In Java"
description: "Split WEB with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to split a single WEB file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split WEB file using Java example code">}}

        ```java    
        // Split WEB file using GroupDocs.Merger for Java API
