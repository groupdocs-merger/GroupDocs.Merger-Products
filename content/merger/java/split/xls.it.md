...
############################# Head ############################
head_title: "Dividi XLS in più file in Java"
head_description: "Dividi un singolo file XLS in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "XLS Separatore in Java"
description: "Dividi XLS con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file XLS per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file XLS in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file XLS utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file XLS utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file XLS online"
    content: |
       Dividi subito il file XLS visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xls).
