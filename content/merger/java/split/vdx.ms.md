...
############################# Head ############################
head_title: "Pisahkan VDX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VDX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VDX Pemisah Dalam Java"
description: "Pisahkan VDX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VDX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VDX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VDX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VDX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VDX Fail Dalam Talian"
    content: |
       Pisahkan fail VDX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
