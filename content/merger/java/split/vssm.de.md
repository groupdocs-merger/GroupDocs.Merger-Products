...
############################# Head ############################
head_title: "Teilen Sie VSSM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VSSM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VSSM Splittereingang Java"
description: "Teilen Sie VSSM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VSSM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VSSM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VSSM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VSSM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VSSM-Datei online teilen"
    content: |
       Teilen Sie die Datei VSSM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) besuchen.
