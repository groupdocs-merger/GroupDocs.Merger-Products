...
############################# Head ############################
head_title: "Împărțiți VSTM în mai multe fișiere în Java"
...
############################# Header ############################
title: "Splitter VSTM în Java"
description: "Împărțiți VSTM cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul VSTM după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier VSTM în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul VSTM folosind codul exemplu Java">}}

        ```java    
        // Împărțiți fișierul VSTM utilizând API-ul GroupDocs.Merger pentru Java
