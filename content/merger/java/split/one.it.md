...
############################# Head ############################
head_title: "Dividi ONE in più file in Java"
...
############################# Header ############################
title: "ONE Separatore in Java"
description: "Dividi ONE con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file ONE per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file ONE in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file ONE utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file ONE utilizzando GroupDocs.Merger per l'API Java
