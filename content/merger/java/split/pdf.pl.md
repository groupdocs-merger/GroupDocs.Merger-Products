...
############################# Head ############################
head_title: "Podziel PDF na wiele plików w Java"
head_description: "Podziel pojedynczy plik PDF na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "PDF Rozdzielacz w Java"
description: "Podziel PDF z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik PDF według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku PDF na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik PDF za pomocą przykładowego kodu Java">}}
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik PDF online"
    content: |
       Podziel plik PDF już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
