...
############################# Head ############################
head_title: "A(z) VSX felosztása több fájlra a Java programban"
head_description: "Egyetlen VSX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSX Splitter in Java"
description: "Oszd fel az VSX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) VSX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen VSX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az VSX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az VSX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split VSX fájl online"
    content: |
       Ossza meg az VSX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx) webhely meglátogatásával.
