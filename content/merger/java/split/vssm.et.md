...
############################# Head ############################
head_title: "Jagage VSSM mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail VSSM mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "VSSM Splitter in Java"
description: "Tükeldage VSSM mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSSM fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks VSSM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili VSSM, kasutades Java näidet">}}

        ```java    
        // Jagage fail VSSM, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – VSSM faili jagamine võrgus"
    content: |
       Tükeldage fail VSSM kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
