...
############################# Head ############################
head_title: "Jagage DOCM mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail DOCM mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "DOCM Splitter in Java"
description: "Tükeldage DOCM mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOCM fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks DOCM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili DOCM, kasutades Java näidet">}}

        ```java    
        // Jagage fail DOCM, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – DOCM faili jagamine võrgus"
    content: |
       Tükeldage fail DOCM kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm).
