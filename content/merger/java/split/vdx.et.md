...
############################# Head ############################
head_title: "Jagage VDX mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail VDX mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "VDX Splitter in Java"
description: "Tükeldage VDX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage VDX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks VDX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili VDX, kasutades Java näidet">}}

        ```java    
        // Jagage fail VDX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – VDX faili jagamine võrgus"
    content: |
       Tükeldage fail VDX kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
