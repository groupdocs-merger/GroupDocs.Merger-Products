...
############################# Head ############################
head_title: "Dividir ODS en varios archivos en Java"
head_description: "Divida un solo archivo ODS en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "ODS Divisor en Java"
description: "Divida ODS con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir ODS archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo ODS en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo ODS usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo ODS usando GroupDocs.Merger para la API de Java
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir ODS archivo en línea"
    content: |
       Divida el archivo ODS ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
