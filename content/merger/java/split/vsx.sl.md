...
############################# Head ############################
head_title: "Razdeli VSX na več datotek v Java"
head_description: "Eno datoteko VSX razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VSX razdelilnik v Java"
description: "Razdelite VSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VSX po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VSX s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VSX z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VSX datoteko na spletu"
    content: |
       Takoj razdelite datoteko VSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx).
