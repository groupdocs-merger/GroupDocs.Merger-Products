...
############################# Head ############################
head_title: "Di Java de CSV li Pir Pelan veqetînin"
...
############################# Header ############################
title: "CSV Splitter Li Java"
description: "CSV bi çend rêzikên koda Java parçe bikin."
...
steps:
    enable: true
    title_left: "Di Java de CSV Pelê Li gorî Rûpelan veqetînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebiranên Java re hêsan dike ku pelek yek CSV li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelê CSV bi karanîna koda nimûneya Java parçe dike">}}

        ```java    
        // Pelê CSV bi karanîna GroupDocs.Merger ji bo Java API-ê veqetînin
