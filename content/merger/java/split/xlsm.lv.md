...
############################# Head ############################
head_title: "Sadaliet XLSM vairākos failos programmā Java"
head_description: "Sadaliet vienu XLSM failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "XLSM sadalītājs programmā Java"
description: "Sadaliet XLSM ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSM failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu XLSM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSM failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet XLSM failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt XLSM failu tiešsaistē"
    content: |
       Sadaliet XLSM failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm).
