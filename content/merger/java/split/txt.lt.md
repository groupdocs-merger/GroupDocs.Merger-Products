...
############################# Head ############################
head_title: "Padalinkite TXT į kelis failus Java"
head_description: "Padalinkite vieną TXT failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "TXT skirstytuvas Java"
description: "Padalinkite TXT keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite TXT failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną TXT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti TXT failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite TXT failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite TXT failą internete"
    content: |
       Padalykite TXT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) svetainėje.
