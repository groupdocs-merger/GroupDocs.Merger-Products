...
############################# Head ############################
head_title: "Verdeel XLAM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLAM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLAM Splitter in Java"
description: "Verdeel XLAM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLAM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLAM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLAM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLAM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLAM lêer aanlyn"
    content: |
       Verdeel XLAM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) webwerf te besoek.
