...
############################# Head ############################
head_title: "Tách DOCM thành nhiều tệp trong Java"
...
############################# Header ############################
title: "DOCM Splitter trong Java"
description: "Tách DOCM bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp DOCM theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp DOCM thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp DOCM bằng mã mẫu Java">}}

        ```java    
        // Tách tệp DOCM bằng GroupDocs.Merger cho Java API
