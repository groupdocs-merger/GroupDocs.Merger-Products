...
############################# Head ############################
head_title: "Skiptu VSTM í margar skrár í Java"
head_description: "Skiptu einni VSTM skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VSTM Skerandi í Java"
description: "Skiptu VSTM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSTM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VSTM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSTM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VSTM skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VSTM skrá á netinu"
    content: |
       Skiptu VSTM skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm) vefsíðu.
