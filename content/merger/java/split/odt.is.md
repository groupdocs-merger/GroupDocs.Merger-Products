...
############################# Head ############################
head_title: "Skiptu ODT í margar skrár í Java"
head_description: "Skiptu einni ODT skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "ODT Skerandi í Java"
description: "Skiptu ODT með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODT skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni ODT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODT skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu ODT skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu ODT skrá á netinu"
    content: |
       Skiptu ODT skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt) vefsíðu.
