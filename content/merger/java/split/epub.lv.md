...
############################# Head ############################
head_title: "Sadaliet EPUB vairākos failos programmā Java"
head_description: "Sadaliet vienu EPUB failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "EPUB sadalītājs programmā Java"
description: "Sadaliet EPUB ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet EPUB failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu EPUB failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt EPUB failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet EPUB failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt EPUB failu tiešsaistē"
    content: |
       Sadaliet EPUB failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
