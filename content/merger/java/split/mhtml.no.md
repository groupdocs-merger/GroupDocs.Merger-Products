...
############################# Head ############################
head_title: "Del MHTML i flere filer i Java"
head_description: "Del en enkelt MHTML-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "MHTML splitter i Java"
description: "Del MHTML med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del MHTML-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt MHTML-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp MHTML-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del MHTML-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del MHTML-fil på nett"
    content: |
       Del opp MHTML-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml).
