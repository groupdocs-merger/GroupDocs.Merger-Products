...
############################# Head ############################
head_title: "Razdeli EPUB na več datotek v Java"
head_description: "Eno datoteko EPUB razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "EPUB razdelilnik v Java"
description: "Razdelite EPUB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko EPUB po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke EPUB na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko EPUB s primerom kode Java">}}

        ```java    
        // Razdeli datoteko EPUB z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli EPUB datoteko na spletu"
    content: |
       Takoj razdelite datoteko EPUB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
