...
############################# Head ############################
head_title: "Rozdeliť DOTX do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor DOTX do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "DOTX Splitter v Java"
description: "Rozdeľte DOTX niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť DOTX súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor DOTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOTX súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor DOTX pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru DOTX online"
    content: |
       Rozdeľte súbor DOTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx).
