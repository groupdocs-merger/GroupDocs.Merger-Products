...
############################# Head ############################
head_title: "A(z) TSV felosztása több fájlra a Java programban"
head_description: "Egyetlen TSV fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "TSV Splitter in Java"
description: "Oszd fel az TSV elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) TSV fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen TSV fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az TSV fájl felosztása a Java példakóddal">}}

        ```java    
        // Az TSV fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split TSV fájl online"
    content: |
       Ossza meg az TSV fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) webhely meglátogatásával.
