...
############################# Head ############################
head_title: "Разделете OTT на няколко файла в Java"
...
############################# Header ############################
title: "OTT Сплитер в Java"
description: "Разделете OTT с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете OTT файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл OTT на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл OTT с примерен код на Java">}}

        ```java    
        // Разделете OTT файл с помощта на GroupDocs.Merger за Java API
