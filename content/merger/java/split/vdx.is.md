...
############################# Head ############################
head_title: "Skiptu VDX í margar skrár í Java"
head_description: "Skiptu einni VDX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "VDX Skerandi í Java"
description: "Skiptu VDX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu VDX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni VDX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VDX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu VDX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu VDX skrá á netinu"
    content: |
       Skiptu VDX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) vefsíðu.
