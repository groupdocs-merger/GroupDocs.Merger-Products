...
############################# Head ############################
head_title: "Verdeel XLSX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele XLSX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "XLSX Splitter in Java"
description: "Verdeel XLSX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele XLSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel XLSX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel XLSX lêer aanlyn"
    content: |
       Verdeel XLSX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) webwerf te besoek.
