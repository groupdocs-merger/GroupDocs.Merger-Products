...
############################# Head ############################
head_title: "Rozdělit EPUB do více souborů v Java"
head_description: "Rozdělte jeden soubor EPUB do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "EPUB Splitter v Java"
description: "Rozdělte EPUB několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit EPUB soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru EPUB do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor EPUB pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor EPUB pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru EPUB online"
    content: |
       Rozdělte soubor EPUB právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub).
