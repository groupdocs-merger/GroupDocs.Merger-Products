...
############################# Head ############################
head_title: "Verdeel DOTM in veelvuldige lêers in Java"
...
description: "Verdeel DOTM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOTM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOTM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOTM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOTM lêer deur GroupDocs.Merger vir Java API te gebruik
