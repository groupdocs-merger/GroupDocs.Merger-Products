...
############################# Head ############################
head_title: "Teilen Sie XLT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XLT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XLT Splittereingang Java"
description: "Teilen Sie XLT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XLT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XLT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XLT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XLT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XLT-Datei online teilen"
    content: |
       Teilen Sie die Datei XLT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt) besuchen.
