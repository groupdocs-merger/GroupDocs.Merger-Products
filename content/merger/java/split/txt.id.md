...
############################# Head ############################
head_title: "Pecah dokumen TXT dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk memecah file TXT menjadi dokumen terpisah. Kelola PDF, file Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pecah file TXT" 
description: "GroupDocs.Merger for Java meningkatkan aplikasi Java dengan menambahkan fitur pemrosesan dokumen yang canggih. Pecah file TXT dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memecah file TXT"
    content: |
      Dengan [GroupDocs.Merger](/merger/java/), Anda dapat memecah dokumen TXT dan menyimpan halaman yang dipilih sebagai file baru. Integrasikan manajemen dokumen canggih ke dalam aplikasi Java Anda.
      
      1. Sediakan jalur sumber dari file TXT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pecah dokumen TXT dan simpan halaman bernomor genap"
      content: |
        Contoh ini menunjukkan cara memecah dokumen TXT dan menyimpan semua halaman bernomor genap sebagai file terpisah.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
