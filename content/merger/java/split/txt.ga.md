...
############################# Head ############################
head_title: "Scoilt TXT ina Ilchomhaid i Java"
...
############################# Header ############################
title: "TXT Scoilteoir i Java"
description: "Scoilt TXT le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt TXT Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin TXT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad TXT a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt TXT comhad ag baint úsáide as GroupDocs.Merger do Java API
