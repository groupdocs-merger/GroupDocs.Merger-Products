...
############################# Head ############################
head_title: "Scoilt VTX ina Ilchomhaid i Java"
...
############################# Header ############################
title: "VTX Scoilteoir i Java"
description: "Scoilt VTX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt VTX Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin VTX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad VTX a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt VTX comhad ag baint úsáide as GroupDocs.Merger do Java API
