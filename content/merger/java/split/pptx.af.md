...
############################# Head ############################
head_title: "Verdeel PPTX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele PPTX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "PPTX Splitter in Java"
description: "Verdeel PPTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPTX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele PPTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPTX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel PPTX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel PPTX lêer aanlyn"
    content: |
       Verdeel PPTX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) webwerf te besoek.
