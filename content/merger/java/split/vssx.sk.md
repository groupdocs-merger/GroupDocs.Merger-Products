...
############################# Head ############################
head_title: "Rozdeliť VSSX do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor VSSX do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "VSSX Splitter v Java"
description: "Rozdeľte VSSX niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť VSSX súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor VSSX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSSX súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor VSSX pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru VSSX online"
    content: |
       Rozdeľte súbor VSSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
