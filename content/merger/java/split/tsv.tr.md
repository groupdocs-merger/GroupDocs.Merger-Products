...
############################# Head ############################
head_title: "TSV'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir TSV dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "TSV Ayırıcı Java"
description: "TSV kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "TSV Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak TSV dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak TSV dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - TSV Dosyasını Çevrimiçi Böl"
    content: |
       TSV dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) web sitesini ziyaret ederek bölün.
