...
############################# Head ############################
head_title: "Pisahkan VSX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSX Pemisah Dalam Java"
description: "Pisahkan VSX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSX Fail Dalam Talian"
    content: |
       Pisahkan fail VSX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsx).
