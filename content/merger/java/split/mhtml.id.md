...
head_description: "Pisahkan satu file MHTML menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "MHTML Pemisah Di Java"
description: "Pisahkan MHTML dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan MHTML File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file MHTML menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file MHTML menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file MHTML menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan MHTML File Online"
    content: |
       Pisahkan file MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/mhtml).
