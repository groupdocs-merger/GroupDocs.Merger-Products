...
############################# Head ############################
head_title: "Dividi VSSM in più file in Java"
...
############################# Header ############################
title: "VSSM Separatore in Java"
description: "Dividi VSSM con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file VSSM per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file VSSM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file VSSM utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file VSSM utilizzando GroupDocs.Merger per l'API Java
