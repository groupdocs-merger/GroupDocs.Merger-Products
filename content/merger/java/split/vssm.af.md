...
############################# Head ############################
head_title: "Verdeel VSSM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VSSM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VSSM Splitter in Java"
description: "Verdeel VSSM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSSM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSSM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSSM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VSSM lêer aanlyn"
    content: |
       Verdeel VSSM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) webwerf te besoek.
