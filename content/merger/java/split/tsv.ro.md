...
############################# Head ############################
head_title: "Împărțiți TSV în mai multe fișiere în Java"
head_description: "Împărțiți un singur fișier TSV în mai multe fișiere pe baza numerelor de pagină, a intervalelor de pagini, a paginilor pare sau impare, utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Splitter TSV în Java"
description: "Împărțiți TSV cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Împărțiți fișierul TSV după pagini în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java împărțirea unui singur fișier TSV în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișierul TSV folosind codul exemplu Java">}}

        ```java    
        // Împărțiți fișierul TSV utilizând API-ul GroupDocs.Merger pentru Java
...
demos:
    enable: true
    title: "Demo live - Împărțiți fișierul TSV online"
    content: |
       Împărțiți fișierul TSV chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
