...
############################# Head ############################
head_title: "Podijeli CSV u više datoteka u Java"
head_description: "Podijelite jednu CSV datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "CSV Splitter u Java"
description: "Podijelite CSV s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli CSV datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne CSV datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti CSV datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli CSV datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split CSV datoteka na mreži"
    content: |
       Podijeli CSV datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) web mjesto.
