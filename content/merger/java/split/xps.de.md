...
############################# Head ############################
head_title: "Teilen Sie XPS in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XPS-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XPS Splittereingang Java"
description: "Teilen Sie XPS mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XPS-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XPS-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XPS-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XPS-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XPS-Datei online teilen"
    content: |
       Teilen Sie die Datei XPS jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps) besuchen.
