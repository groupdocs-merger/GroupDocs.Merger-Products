...
############################# Head ############################
head_title: "A(z) MHT felosztása több fájlra a Java programban"
...
description: "Oszd fel az MHT elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) MHT fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen MHT fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az MHT fájl felosztása a Java példakóddal">}}

        ```java    
        // Az MHT fájl felosztása a GroupDocs.Merger for Java API segítségével
