...
description: "Split VSTX with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) makes it easy for Java developers to split a single VSTX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VSTX file using Java example code">}}

        ```java    
        // Split VSTX file using GroupDocs.Merger for Java API
