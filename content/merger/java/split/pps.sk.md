...
############################# Head ############################
head_title: "Rozdeliť PPS do viacerých súborov v Java"
...
description: "Rozdeľte PPS niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť PPS súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor PPS na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PPS súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor PPS pomocou rozhrania GroupDocs.Merger for Java API
