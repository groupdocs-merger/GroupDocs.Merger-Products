...
############################# Head ############################
head_title: "Pisahkan VSTM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSTM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSTM Pemisah Dalam Java"
description: "Pisahkan VSTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSTM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSTM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSTM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSTM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSTM Fail Dalam Talian"
    content: |
       Pisahkan fail VSTM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
