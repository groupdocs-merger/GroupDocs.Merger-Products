...
############################# Head ############################
head_title: "A(z) VTX felosztása több fájlra a Java programban"
head_description: "Egyetlen VTX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VTX Splitter in Java"
description: "Oszd fel az VTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) VTX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen VTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az VTX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az VTX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split VTX fájl online"
    content: |
       Ossza meg az VTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) webhely meglátogatásával.
