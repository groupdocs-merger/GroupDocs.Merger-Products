...
############################# Head ############################
head_title: "Verdeel PPS in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele PPS-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "PPS Splitter in Java"
description: "Verdeel PPS met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPS lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele PPS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPS-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel PPS lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel PPS lêer aanlyn"
    content: |
       Verdeel PPS-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) webwerf te besoek.
