...
############################# Head ############################
head_title: "Skiptu OTP í margar skrár í Java"
head_description: "Skiptu einni OTP skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "OTP Skerandi í Java"
description: "Skiptu OTP með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu OTP skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni OTP skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta OTP skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu OTP skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu OTP skrá á netinu"
    content: |
       Skiptu OTP skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) vefsíðu.
