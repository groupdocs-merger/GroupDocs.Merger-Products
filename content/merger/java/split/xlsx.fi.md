...
############################# Head ############################
head_title: "Jaa XLSX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen XLSX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "XLSX Jakaja sisään Java"
description: "Jaa XLSX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto XLSX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden XLSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLSX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto XLSX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa XLSX tiedosto verkossa"
    content: |
       Jaa tiedosto XLSX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) -sivustolla.
