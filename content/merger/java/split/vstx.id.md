...
head_description: "Pisahkan satu file VSTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSTX Pemisah Di Java"
description: "Pisahkan VSTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSTX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSTX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSTX File Online"
    content: |
       Pisahkan file VSTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vstx).
