...
############################# Head ############################
head_title: "Podziel XLTM na wiele plików w Java"
head_description: "Podziel pojedynczy plik XLTM na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "XLTM Rozdzielacz w Java"
description: "Podziel XLTM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLTM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLTM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLTM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLTM za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik XLTM online"
    content: |
       Podziel plik XLTM już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm).
