...
############################# Head ############################
head_title: "Jaa OTP useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen OTP-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "OTP Jakaja sisään Java"
description: "Jaa OTP muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto OTP sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden OTP-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa OTP tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto OTP GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa OTP tiedosto verkossa"
    content: |
       Jaa tiedosto OTP heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) -sivustolla.
