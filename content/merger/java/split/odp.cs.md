...
############################# Head ############################
head_title: "Rozdělit ODP do více souborů v Java"
head_description: "Rozdělte jeden soubor ODP do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "ODP Splitter v Java"
description: "Rozdělte ODP několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit ODP soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru ODP do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor ODP pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor ODP pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru ODP online"
    content: |
       Rozdělte soubor ODP právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp).
