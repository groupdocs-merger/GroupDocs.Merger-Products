...
############################# Head ############################
head_title: "Podziel VSDM na wiele plików w Java"
head_description: "Podziel pojedynczy plik VSDM na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "VSDM Rozdzielacz w Java"
description: "Podziel VSDM z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik VSDM według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku VSDM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik VSDM za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik VSDM za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik VSDM online"
    content: |
       Podziel plik VSDM już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm).
