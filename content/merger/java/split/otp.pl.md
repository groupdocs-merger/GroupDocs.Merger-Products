...
############################# Head ############################
head_title: "Podziel OTP na wiele plików w Java"
head_description: "Podziel pojedynczy plik OTP na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "OTP Rozdzielacz w Java"
description: "Podziel OTP z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik OTP według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku OTP na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik OTP za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik OTP za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik OTP online"
    content: |
       Podziel plik OTP już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp).
