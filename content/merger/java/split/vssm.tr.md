...
############################# Head ############################
head_title: "VSSM'i Java İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSSM Ayırıcı Java"
description: "VSSM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSSM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak VSSM dosyasını ayırın
