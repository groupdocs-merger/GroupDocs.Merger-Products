...
############################# Head ############################
head_title: "Verdeel TXT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele TXT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "TXT Splitter in Java"
description: "Verdeel TXT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel TXT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele TXT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TXT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel TXT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel TXT lêer aanlyn"
    content: |
       Verdeel TXT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) webwerf te besoek.
