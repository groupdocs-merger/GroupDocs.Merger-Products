...
############################# Head ############################
head_title: "Podziel ODS na wiele plików w Java"
head_description: "Podziel pojedynczy plik ODS na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "ODS Rozdzielacz w Java"
description: "Podziel ODS z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik ODS według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku ODS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik ODS za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik ODS za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik ODS online"
    content: |
       Podziel plik ODS już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods).
