...
############################# Head ############################
head_title: "Pisahkan VSDX kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSDX kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSDX Pemisah Dalam Java"
description: "Pisahkan VSDX dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSDX Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSDX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSDX menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSDX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSDX Fail Dalam Talian"
    content: |
       Pisahkan fail VSDX sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx).
