...
head_description: "Pisahkan satu file VSDM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSDM Pemisah Di Java"
description: "Pisahkan VSDM dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSDM File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file VSDM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VSDM menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file VSDM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan VSDM File Online"
    content: |
       Pisahkan file VSDM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/vsdm).
