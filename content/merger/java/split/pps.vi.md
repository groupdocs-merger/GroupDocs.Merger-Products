...
############################# Head ############################
head_title: "Tách PPS thành nhiều tệp trong Java"
...
############################# Header ############################
title: "PPS Splitter trong Java"
description: "Tách PPS bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp PPS theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp PPS thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp PPS bằng mã mẫu Java">}}

        ```java    
        // Tách tệp PPS bằng GroupDocs.Merger cho Java API
