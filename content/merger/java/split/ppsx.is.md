...
############################# Head ############################
head_title: "Skiptu PPSX í margar skrár í Java"
head_description: "Skiptu einni PPSX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "PPSX Skerandi í Java"
description: "Skiptu PPSX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPSX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni PPSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPSX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu PPSX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu PPSX skrá á netinu"
    content: |
       Skiptu PPSX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) vefsíðu.
