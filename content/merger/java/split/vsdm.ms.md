...
############################# Head ############################
head_title: "Pisahkan VSDM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSDM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSDM Pemisah Dalam Java"
description: "Pisahkan VSDM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSDM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSDM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSDM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSDM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSDM Fail Dalam Talian"
    content: |
       Pisahkan fail VSDM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm).
