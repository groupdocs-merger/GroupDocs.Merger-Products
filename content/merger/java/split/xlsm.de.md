...
############################# Head ############################
head_title: "Teilen Sie XLSM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XLSM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XLSM Splittereingang Java"
description: "Teilen Sie XLSM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XLSM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XLSM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XLSM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XLSM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XLSM-Datei online teilen"
    content: |
       Teilen Sie die Datei XLSM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsm) besuchen.
