...
############################# Head ############################
head_title: "Opdel XLSX i flere filer i Java"
...
description: "Opdel XLSX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Opdel XLSX fil efter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at opdele en enkelt XLSX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLSX fil ved hjælp af Java eksempelkode">}}

        ```java    
        // Opdel XLSX fil ved hjælp af GroupDocs.Merger for Java API
