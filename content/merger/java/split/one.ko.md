...
############################# Head ############################
head_title: "Java에서 ONE을(를) 여러 파일로 분할"
head_description: "문서 병합 API를 사용하여 단일 ONE 파일을 페이지 번호, 페이지 간격, 짝수 또는 홀수 페이지에 따라 여러 파일로 분할합니다."

############################# Header ############################
title: "ONE Java의 스플리터"
description: "몇 줄의 Java 코드로 ONE를 나눕니다."
...
steps:
    enable: true
    title_left: "Java의 페이지별로 ONE 파일 분할"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 ONE 파일을 분할하는 방법">}}

        ```java    
        // Java API용 GroupDocs.Merger를 사용하여 ONE 파일 분할
