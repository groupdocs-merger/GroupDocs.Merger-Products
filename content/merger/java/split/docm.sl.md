...
############################# Head ############################
head_title: "Razdeli DOCM na več datotek v Java"
head_description: "Eno datoteko DOCM razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "DOCM razdelilnik v Java"
description: "Razdelite DOCM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko DOCM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke DOCM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko DOCM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko DOCM z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli DOCM datoteko na spletu"
    content: |
       Takoj razdelite datoteko DOCM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm).
