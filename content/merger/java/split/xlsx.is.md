...
############################# Head ############################
head_title: "Skiptu XLSX í margar skrár í Java"
head_description: "Skiptu einni XLSX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "XLSX Skerandi í Java"
description: "Skiptu XLSX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLSX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu XLSX skrá á netinu"
    content: |
       Skiptu XLSX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx) vefsíðu.
