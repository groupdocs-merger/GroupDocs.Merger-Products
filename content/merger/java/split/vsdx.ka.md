...
############################# Head ############################
head_title: "დაყავით VSDX მრავალ ფაილად Java-ში"
...
############################# Header ############################
title: "VSDX სპლიტერი Java-ში"
description: "გაყავით VSDX Java კოდის რამდენიმე ხაზით."
...
steps:
    enable: true
    title_left: "VSDX ფაილის დაყოფა გვერდების მიხედვით Java-ში"
    content_left: |
        [GroupDocs.Merger for Java](/ka/merger/java/) უადვილებს Java-ის დეველოპერებს ერთი VSDX ფაილის დაყოფა მრავალ შედეგიან ფაილად დანერგვით რამდენიმე მარტივი ნაბიჯი.
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ გავყოთ VSDX ფაილი Java-ის მაგალითის კოდის გამოყენებით">}}

        ```java    
        // გაყავით VSDX ფაილი GroupDocs.Merger Java API-სთვის
