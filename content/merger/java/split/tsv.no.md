...
############################# Head ############################
head_title: "Del TSV i flere filer i Java"
head_description: "Del en enkelt TSV-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "TSV splitter i Java"
description: "Del TSV med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del TSV-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt TSV-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp TSV-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del TSV-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del TSV-fil på nett"
    content: |
       Del opp TSV-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv).
