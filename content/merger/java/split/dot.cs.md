...
############################# Head ############################
head_title: "Rozdělit DOT do více souborů v Java"
head_description: "Rozdělte jeden soubor DOT do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "DOT Splitter v Java"
description: "Rozdělte DOT několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit DOT soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru DOT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor DOT pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor DOT pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru DOT online"
    content: |
       Rozdělte soubor DOT právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dot).
