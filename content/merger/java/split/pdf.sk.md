...
############################# Head ############################
head_title: "Rozdeliť PDF do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor PDF do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "PDF Splitter v Java"
description: "Rozdeľte PDF niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť PDF súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor PDF na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PDF súbor pomocou Java vzorového kódu">}}
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru PDF online"
    content: |
       Rozdeľte súbor PDF hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
