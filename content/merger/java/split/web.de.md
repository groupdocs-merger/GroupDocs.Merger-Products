...
############################# Head ############################
head_title: "Teilen Sie WEB in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne WEB-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "WEB Splittereingang Java"
description: "Teilen Sie WEB mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "WEB-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne WEB-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die WEB-Datei mit dem Java-Beispielcode">}}

        ```java    
        // WEB-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - WEB-Datei online teilen"
    content: |
       Teilen Sie die Datei WEB jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/web) besuchen.
