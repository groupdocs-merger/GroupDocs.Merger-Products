...
############################# Head ############################
head_title: "VSTM کو Java میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "VSTM سپلٹر ان Java"
description: "Java کوڈ کی چند لائنوں کے ساتھ VSTM کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "VSTM فائل کو Java میں صفحات کے لحاظ سے تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے ایک VSTM فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کوڈ کا استعمال کرتے ہوئے VSTM فائل کو کیسے تقسیم کیا جائے۔">}}

        ```java    
        // جاوا API کے لیے GroupDocs.Merger کا استعمال کرتے ہوئے VSTM فائل کو تقسیم کریں۔
