...
############################# Head ############################
head_title: "Dividi PPTX in più file in Java"
...
############################# Header ############################
title: "PPTX Separatore in Java"
description: "Dividi PPTX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file PPTX per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file PPTX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file PPTX utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file PPTX utilizzando GroupDocs.Merger per l'API Java
