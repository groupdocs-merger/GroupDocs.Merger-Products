...
############################# Head ############################
head_title: "Razdeli VSTM na več datotek v Java"
head_description: "Eno datoteko VSTM razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "VSTM razdelilnik v Java"
description: "Razdelite VSTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko VSTM po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke VSTM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko VSTM s primerom kode Java">}}

        ```java    
        // Razdeli datoteko VSTM z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli VSTM datoteko na spletu"
    content: |
       Takoj razdelite datoteko VSTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
