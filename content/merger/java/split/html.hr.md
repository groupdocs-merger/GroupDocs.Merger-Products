...
############################# Head ############################
head_title: "Podijeli HTML u više datoteka u Java"
head_description: "Podijelite jednu HTML datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "HTML Splitter u Java"
description: "Podijelite HTML s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli HTML datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne HTML datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti HTML datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli HTML datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split HTML datoteka na mreži"
    content: |
       Podijeli HTML datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html) web mjesto.
