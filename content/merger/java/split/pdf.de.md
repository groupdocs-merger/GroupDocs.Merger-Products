...
############################# Head ############################
head_title: "Teilen Sie PDF in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne PDF-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "PDF Splittereingang Java"
description: "Teilen Sie PDF mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "PDF-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne PDF-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die PDF-Datei mit dem Java-Beispielcode">}}

        ```java    
        // PDF-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - PDF-Datei online teilen"
    content: |
       Teilen Sie die Datei PDF jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf) besuchen.
