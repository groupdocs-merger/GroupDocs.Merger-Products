...
############################# Head ############################
head_title: "A(z) DOCM felosztása több fájlra a Java programban"
head_description: "Egyetlen DOCM fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCM Splitter in Java"
description: "Oszd fel az DOCM elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) DOCM fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen DOCM fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az DOCM fájl felosztása a Java példakóddal">}}

        ```java    
        // Az DOCM fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split DOCM fájl online"
    content: |
       Ossza meg az DOCM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) webhely meglátogatásával.
