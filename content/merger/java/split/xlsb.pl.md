...
############################# Head ############################
head_title: "Podziel XLSB na wiele plików w Java"
head_description: "Podziel pojedynczy plik XLSB na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "XLSB Rozdzielacz w Java"
description: "Podziel XLSB z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLSB według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLSB na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLSB za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLSB za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik XLSB online"
    content: |
       Podziel plik XLSB już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
