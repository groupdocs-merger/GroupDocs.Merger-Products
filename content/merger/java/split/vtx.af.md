...
############################# Head ############################
head_title: "Verdeel VTX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VTX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VTX Splitter in Java"
description: "Verdeel VTX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VTX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VTX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VTX lêer aanlyn"
    content: |
       Verdeel VTX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) webwerf te besoek.
