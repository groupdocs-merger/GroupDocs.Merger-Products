...
head_description: "Pisahkan satu file XLTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "XLTX Pemisah Di Java"
description: "Pisahkan XLTX dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan XLTX File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file XLTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file XLTX menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file XLTX menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan XLTX File Online"
    content: |
       Pisahkan file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/xltx).
