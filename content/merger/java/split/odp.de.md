...
############################# Head ############################
head_title: "Teilen Sie ODP in mehrere Dateien in Java"
...
############################# Header ############################
title: "ODP Splittereingang Java"
description: "Teilen Sie ODP mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "ODP-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne ODP-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die ODP-Datei mit dem Java-Beispielcode">}}

        ```java    
        // ODP-Datei mit GroupDocs.Merger für Java-API aufteilen
