...
############################# Head ############################
head_title: "Tách XLSB thành nhiều tệp trong Java"
head_description: "Tách một tệp XLSB thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "XLSB Splitter trong Java"
description: "Tách XLSB bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp XLSB theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp XLSB thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp XLSB bằng mã mẫu Java">}}

        ```java    
        // Tách tệp XLSB bằng GroupDocs.Merger cho Java API
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Tách tệp XLSB Trực tuyến"
    content: |
       Tách tệp XLSB ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ xlsb) trang web.
