...
############################# Head ############################
head_title: "Rozdeliť VSTM do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor VSTM do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "VSTM Splitter v Java"
description: "Rozdeľte VSTM niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť VSTM súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor VSTM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSTM súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor VSTM pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru VSTM online"
    content: |
       Rozdeľte súbor VSTM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstm).
