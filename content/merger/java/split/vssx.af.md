...
############################# Head ############################
head_title: "Verdeel VSSX in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele VSSX-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "VSSX Splitter in Java"
description: "Verdeel VSSX met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSSX lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele VSSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSX-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel VSSX lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel VSSX lêer aanlyn"
    content: |
       Verdeel VSSX-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) webwerf te besoek.
