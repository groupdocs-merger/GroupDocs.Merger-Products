...
############################# Head ############################
head_title: "Teilen Sie TEX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne TEX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "TEX Splittereingang Java"
description: "Teilen Sie TEX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "TEX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne TEX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die TEX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // TEX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - TEX-Datei online teilen"
    content: |
       Teilen Sie die Datei TEX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex) besuchen.
