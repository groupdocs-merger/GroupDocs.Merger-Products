...
############################# Head ############################
head_title: "Rozdělit PPS do více souborů v Java"
head_description: "Rozdělte jeden soubor PPS do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "PPS Splitter v Java"
description: "Rozdělte PPS několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit PPS soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru PPS do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor PPS pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor PPS pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru PPS online"
    content: |
       Rozdělte soubor PPS právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps).
