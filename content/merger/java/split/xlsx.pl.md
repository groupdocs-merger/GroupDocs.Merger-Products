...
############################# Head ############################
head_title: "Podziel XLSX na wiele plików w Java"
head_description: "Podziel pojedynczy plik XLSX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "XLSX Rozdzielacz w Java"
description: "Podziel XLSX z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik XLSX według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku XLSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik XLSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik XLSX za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik XLSX online"
    content: |
       Podziel plik XLSX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsx).
