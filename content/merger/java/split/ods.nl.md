...
############################# Head ############################
head_title: "Splits ODS in meerdere bestanden in Java"
head_description: "Splits een enkel ODS bestand in meerdere bestanden op basis van paginanummers, pagina-intervallen, even of oneven pagina's met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "ODS Splitter in Java"
description: "Splits ODS met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Splits ODS bestand op pagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het voor Java ontwikkelaars gemakkelijk om een ​​enkel ODS bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe een ODS bestand te splitsen met behulp van Java voorbeeldcode">}}

        ```java    
        // Splits ODS bestand met behulp van GroupDocs.Merger voor Java API
...
demos:
    enable: true
    title: "Live demo's - ODS bestand online splitsen"
    content: |
       Splits ODS bestand nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods) te gaan.
