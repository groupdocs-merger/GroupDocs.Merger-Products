...
############################# Head ############################
head_title: "A(z) VSTX felosztása több fájlra a Java programban"
head_description: "Egyetlen VSTX fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTX Splitter in Java"
description: "Oszd fel az VSTX elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) VSTX fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen VSTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az VSTX fájl felosztása a Java példakóddal">}}

        ```java    
        // Az VSTX fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split VSTX fájl online"
    content: |
       Ossza meg az VSTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) webhely meglátogatásával.
