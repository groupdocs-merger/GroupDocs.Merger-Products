...
############################# Head ############################
head_title: "Teilen Sie XLSB in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne XLSB-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "XLSB Splittereingang Java"
description: "Teilen Sie XLSB mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "XLSB-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne XLSB-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die XLSB-Datei mit dem Java-Beispielcode">}}

        ```java    
        // XLSB-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - XLSB-Datei online teilen"
    content: |
       Teilen Sie die Datei XLSB jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb) besuchen.
