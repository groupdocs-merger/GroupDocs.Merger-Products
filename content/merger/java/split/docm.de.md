...
############################# Head ############################
head_title: "Teilen Sie DOCM in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne DOCM-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "DOCM Splittereingang Java"
description: "Teilen Sie DOCM mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "DOCM-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne DOCM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die DOCM-Datei mit dem Java-Beispielcode">}}

        ```java    
        // DOCM-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - DOCM-Datei online teilen"
    content: |
       Teilen Sie die Datei DOCM jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) besuchen.
