...
############################# Head ############################
head_title: "DOCX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOCX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOCX Ayırıcı Java"
description: "DOCX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOCX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOCX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOCX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOCX Dosyasını Çevrimiçi Böl"
    content: |
       DOCX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) web sitesini ziyaret ederek bölün.
