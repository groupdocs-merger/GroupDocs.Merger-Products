...
############################# Head ############################
head_title: "Разделить VSDM на несколько файлов на Java"
head_description: "Разделите один файл VSDM на несколько файлов на основе номеров страниц, интервалов между страницами, четных или нечетных страниц с помощью Merger API."

############################# Header ############################
title: "VSDM Разделитель на Java"
description: "Разделите VSDM страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Разделить VSDM файл по страницам на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) позволяет разработчикам Java легко разделить один файл VSDM на несколько результирующих файлов, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файл VSDM, используя пример кода Java">}}

        ```java    
        // Разделить файл VSDM с помощью GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Разделите файл VSDM прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/splitter/vsdm).
