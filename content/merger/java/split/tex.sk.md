...
############################# Head ############################
head_title: "Rozdeliť TEX do viacerých súborov v Java"
head_description: "Rozdeľte jeden súbor TEX do niekoľkých súborov na základe čísel strán, intervalov strán, párnych alebo nepárnych strán pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "TEX Splitter v Java"
description: "Rozdeľte TEX niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť TEX súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor TEX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť TEX súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor TEX pomocou rozhrania GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živé ukážky – rozdelenie súboru TEX online"
    content: |
       Rozdeľte súbor TEX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tex).
