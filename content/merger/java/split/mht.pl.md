...
############################# Head ############################
head_title: "Podziel MHT na wiele plików w Java"
head_description: "Podziel pojedynczy plik MHT na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "MHT Rozdzielacz w Java"
description: "Podziel MHT z kilkoma linijkami kodu Java."
...
steps:
    enable: true
    title_left: "Podziel plik MHT według stron w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java podział pojedynczego pliku MHT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić plik MHT za pomocą przykładowego kodu Java">}}

        ```java    
        // Podziel plik MHT za pomocą GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik MHT online"
    content: |
       Podziel plik MHT już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
