...
############################# Head ############################
head_title: "Skiptu CSV í margar skrár í Java"
...
############################# Header ############################
title: "CSV Skerandi í Java"
description: "Skiptu CSV með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu CSV skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni CSV skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta CSV skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu CSV skrá með GroupDocs.Merger fyrir Java API
