...
############################# Head ############################
head_title: "Verdeel DOCM in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele DOCM-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "DOCM Splitter in Java"
description: "Verdeel DOCM met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOCM lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele DOCM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCM-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel DOCM lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel DOCM lêer aanlyn"
    content: |
       Verdeel DOCM-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) webwerf te besoek.
