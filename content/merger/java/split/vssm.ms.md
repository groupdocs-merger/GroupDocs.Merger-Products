...
############################# Head ############################
head_title: "Pisahkan VSSM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail VSSM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "VSSM Pemisah Dalam Java"
description: "Pisahkan VSSM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan VSSM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail VSSM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail VSSM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail VSSM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split VSSM Fail Dalam Talian"
    content: |
       Pisahkan fail VSSM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm).
