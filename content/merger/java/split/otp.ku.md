...
############################# Head ############################
head_title: "Di Java de OTP li Pir Pelan veqetînin"
...
############################# Header ############################
title: "OTP Splitter Li Java"
description: "OTP bi çend rêzikên koda Java parçe bikin."
...
steps:
    enable: true
    title_left: "Di Java de OTP Pelê Li gorî Rûpelan veqetînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebiranên Java re hêsan dike ku pelek yek OTP li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelê OTP bi karanîna koda nimûneya Java parçe dike">}}

        ```java    
        // Pelê OTP bi karanîna GroupDocs.Merger ji bo Java API-ê veqetînin
