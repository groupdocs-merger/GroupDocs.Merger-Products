...
############################# Head ############################
head_title: "Dividir XLTX en varios archivos en Java"
head_description: "Divida un solo archivo XLTX en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "XLTX Divisor en Java"
description: "Divida XLTX con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir XLTX archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo XLTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo XLTX usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo XLTX usando GroupDocs.Merger para la API de Java
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir XLTX archivo en línea"
    content: |
       Divida el archivo XLTX ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx).
