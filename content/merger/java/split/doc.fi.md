...
############################# Head ############################
head_title: "Jaa DOC useiksi tiedostoiksi Java"
...
############################# Header ############################
title: "DOC Jakaja sisään Java"
description: "Jaa DOC muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto DOC sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden DOC-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOC tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto DOC GroupDocs.Merger for Java API:lla
