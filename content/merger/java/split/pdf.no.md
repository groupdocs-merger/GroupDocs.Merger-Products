...
############################# Head ############################
head_title: "Del PDF i flere filer i Java"
...
description: "Del PDF med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del PDF-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt PDF-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PDF-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del PDF-filen med GroupDocs.Merger for Java API
