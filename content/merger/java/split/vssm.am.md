...
############################# Head ############################
head_title: "VSSMን በJava ውስጥ ወደ ብዙ ፋይሎች ተከፋፍል"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም አንድ ነጠላ VSSM ፋይል በገጽ ቁጥሮች፣ የገጽ ክፍተቶች፣ አልፎ ተርፎም ወይም ያልተለመዱ ገጾችን ወደ ብዙ ፋይሎች ይከፋፍሉ።"

############################# Header ############################
title: "VSSM Splitter በJava ውስጥ"
description: "VSSMን በጥቂት የJava ኮድ መስመሮች ተከፍል።"
...
steps:
    enable: true
    title_left: "VSSM ፋይል በገጽ በJava ክፈል"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች አንድን ነጠላ VSSM ፋይል በመተግበር ወደ ብዙ የውጤት ፋይሎች መከፋፈል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM ፋይልን Java ምሳሌ ኮድን በመጠቀም እንዴት እንደሚከፋፈል">}}

        ```java    
        // GroupDocs.Mergerን ለጃቫ ኤፒአይ በመጠቀም VSSM ፋይል ክፈሉ።
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የተከፈለ VSSM ፋይል በመስመር ላይ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssm) ድር ጣቢያን በመጎብኘት የVSSM ፋይል አሁኑኑ ይከፋፍሉ።
