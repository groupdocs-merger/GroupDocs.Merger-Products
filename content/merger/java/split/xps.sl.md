...
############################# Head ############################
head_title: "Razdeli XPS na več datotek v Java"
head_description: "Eno datoteko XPS razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XPS razdelilnik v Java"
description: "Razdelite XPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XPS po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XPS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XPS s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XPS z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XPS datoteko na spletu"
    content: |
       Takoj razdelite datoteko XPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xps).
