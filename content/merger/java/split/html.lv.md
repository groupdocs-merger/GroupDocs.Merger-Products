...
############################# Head ############################
head_title: "Sadaliet HTML vairākos failos programmā Java"
head_description: "Sadaliet vienu HTML failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "HTML sadalītājs programmā Java"
description: "Sadaliet HTML ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet HTML failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu HTML failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt HTML failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet HTML failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt HTML failu tiešsaistē"
    content: |
       Sadaliet HTML failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
