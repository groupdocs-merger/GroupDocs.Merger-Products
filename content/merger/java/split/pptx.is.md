...
############################# Head ############################
head_title: "Skiptu PPTX í margar skrár í Java"
head_description: "Skiptu einni PPTX skrá í nokkrar skrár byggðar á blaðsíðunúmerum, blaðsíðubilum, sléttum eða oddasíðum með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "PPTX Skerandi í Java"
description: "Skiptu PPTX með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPTX skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni PPTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPTX skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu PPTX skrá með GroupDocs.Merger fyrir Java API
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu PPTX skrá á netinu"
    content: |
       Skiptu PPTX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) vefsíðu.
