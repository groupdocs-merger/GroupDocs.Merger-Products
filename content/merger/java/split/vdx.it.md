...
############################# Head ############################
head_title: "Dividi VDX in più file in Java"
head_description: "Dividi un singolo file VDX in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "VDX Separatore in Java"
description: "Dividi VDX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file VDX per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file VDX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file VDX utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file VDX utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file VDX online"
    content: |
       Dividi subito il file VDX visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx).
