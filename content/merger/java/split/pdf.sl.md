...
############################# Head ############################
head_title: "Razdeli PDF na več datotek v Java"
head_description: "Eno datoteko PDF razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "PDF razdelilnik v Java"
description: "Razdelite PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko PDF po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke PDF na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko PDF s primerom kode Java">}}
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli PDF datoteko na spletu"
    content: |
       Takoj razdelite datoteko PDF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
