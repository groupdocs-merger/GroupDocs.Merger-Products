...
############################# Head ############################
head_title: "Jagage XLTM mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail XLTM mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "XLTM Splitter in Java"
description: "Tükeldage XLTM mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLTM fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks XLTM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili XLTM, kasutades Java näidet">}}

        ```java    
        // Jagage fail XLTM, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – XLTM faili jagamine võrgus"
    content: |
       Tükeldage fail XLTM kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm).
