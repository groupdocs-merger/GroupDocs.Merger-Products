...
############################# Head ############################
head_title: "DOTM'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir DOTM dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "DOTM Ayırıcı Java"
description: "DOTM kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOTM Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOTM dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak DOTM dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - DOTM Dosyasını Çevrimiçi Böl"
    content: |
       DOTM dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm) web sitesini ziyaret ederek bölün.
