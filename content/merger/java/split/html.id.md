...
############################# Head ############################
head_title: "Pisahkan HTML menjadi Beberapa File di Java"
head_description: "Pisahkan satu file HTML menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "HTML Pemisah Di Java"
description: "Pisahkan HTML dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan HTML File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file HTML menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file HTML menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file HTML menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan HTML File Online"
    content: |
       Pisahkan file HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/html).
