...
############################# Head ############################
head_title: "Podijeli PPTX u više datoteka u Java"
head_description: "Podijelite jednu PPTX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "PPTX Splitter u Java"
description: "Podijelite PPTX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli PPTX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne PPTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPTX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli PPTX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split PPTX datoteka na mreži"
    content: |
       Podijeli PPTX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pptx) web mjesto.
