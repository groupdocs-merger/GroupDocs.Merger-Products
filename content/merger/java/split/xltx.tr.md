...
############################# Head ############################
head_title: "XLTX'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir XLTX dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "XLTX Ayırıcı Java"
description: "XLTX kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLTX Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLTX dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak XLTX dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - XLTX Dosyasını Çevrimiçi Böl"
    content: |
       XLTX dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltx) web sitesini ziyaret ederek bölün.
