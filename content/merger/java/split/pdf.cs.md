...
############################# Head ############################
head_title: "Rozdělit PDF do více souborů v Java"
...
description: "Rozdělte PDF několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit PDF soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru PDF do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor PDF pomocí ukázkového kódu Java">}}
