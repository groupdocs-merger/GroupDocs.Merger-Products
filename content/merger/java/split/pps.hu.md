...
############################# Head ############################
head_title: "A(z) PPS felosztása több fájlra a Java programban"
head_description: "Egyetlen PPS fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPS Splitter in Java"
description: "Oszd fel az PPS elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) PPS fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen PPS fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az PPS fájl felosztása a Java példakóddal">}}

        ```java    
        // Az PPS fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split PPS fájl online"
    content: |
       Ossza meg az PPS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) webhely meglátogatásával.
