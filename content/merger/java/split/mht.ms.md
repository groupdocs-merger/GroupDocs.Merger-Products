...
############################# Head ############################
head_title: "Pisahkan MHT kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail MHT kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "MHT Pemisah Dalam Java"
description: "Pisahkan MHT dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan MHT Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail MHT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail MHT menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail MHT menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split MHT Fail Dalam Talian"
    content: |
       Pisahkan fail MHT sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mht).
