...
############################# Head ############################
head_title: "Jagage PPSX mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail PPSX mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "PPSX Splitter in Java"
description: "Tükeldage PPSX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPSX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks PPSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili PPSX, kasutades Java näidet">}}

        ```java    
        // Jagage fail PPSX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – PPSX faili jagamine võrgus"
    content: |
       Tükeldage fail PPSX kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx).
