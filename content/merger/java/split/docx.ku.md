...
############################# Head ############################
head_title: "Di Java de DOCX li Pir Pelan veqetînin"
head_description: "Pelê yek DOCX li ser bingeha jimareyên rûpelan, navberên rûpelan, rûpelên zewac an jî cewherî bi karanîna API-ya yekkirina belgeyan li çend pelan dabeş bikin."

############################# Header ############################
title: "DOCX Splitter Li Java"
description: "DOCX bi çend rêzikên koda Java parçe bikin."
...
steps:
    enable: true
    title_left: "Di Java de DOCX Pelê Li gorî Rûpelan veqetînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebiranên Java re hêsan dike ku pelek yek DOCX li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelê DOCX bi karanîna koda nimûneya Java parçe dike">}}

        ```java    
        // Pelê DOCX bi karanîna GroupDocs.Merger ji bo Java API-ê veqetînin
...
demos:
    enable: true
    title: "Demoyên Zindî - Pelê Serhêl ji hev veqetînin DOCX"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) niha pelê DOCX veqetînin.
