...
############################# Head ############################
head_title: "Padalinkite OTT į kelis failus Java"
head_description: "Padalinkite vieną OTT failą į kelis failus pagal puslapių numerius, puslapių intervalus, lyginius ar nelyginius puslapius naudodami dokumentų sujungimo API."

############################# Header ############################
title: "OTT skirstytuvas Java"
description: "Padalinkite OTT keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite OTT failą pagal puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai padalinti vieną OTT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti OTT failą naudojant Java pavyzdinį kodą">}}

        ```java    
        // Padalinkite OTT failą naudodami GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – padalinkite OTT failą internete"
    content: |
       Padalykite OTT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) svetainėje.
