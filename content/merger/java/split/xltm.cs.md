...
############################# Head ############################
head_title: "Rozdělit XLTM do více souborů v Java"
head_description: "Rozdělte jeden soubor XLTM do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "XLTM Splitter v Java"
description: "Rozdělte XLTM několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit XLTM soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru XLTM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor XLTM pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor XLTM pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru XLTM online"
    content: |
       Rozdělte soubor XLTM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xltm).
