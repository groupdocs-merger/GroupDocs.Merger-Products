...
head_description: "Pisahkan satu file OTP menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "OTP Pemisah Di Java"
description: "Pisahkan OTP dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Pisahkan OTP File Berdasarkan Halaman di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk membagi satu file OTP menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file OTP menggunakan kode contoh Java">}}

        ```java    
        // Pisahkan file OTP menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan OTP File Online"
    content: |
       Pisahkan file OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/otp).
