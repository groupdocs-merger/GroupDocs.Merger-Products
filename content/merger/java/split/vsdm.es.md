...
############################# Head ############################
head_title: "Dividir VSDM en varios archivos en Java"
...
############################# Header ############################
title: "VSDM Divisor en Java"
description: "Divida VSDM con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Dividir VSDM archivo por páginas en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java dividir un único archivo VSDM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir el archivo VSDM usando el código de ejemplo Java">}}

        ```java    
        // Divida el archivo VSDM usando GroupDocs.Merger para la API de Java
