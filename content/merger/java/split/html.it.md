...
############################# Head ############################
head_title: "Dividi HTML in più file in Java"
head_description: "Dividi un singolo file HTML in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "HTML Separatore in Java"
description: "Dividi HTML con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Dividi file HTML per pagine in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di dividere facilmente un singolo file HTML in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere il file HTML utilizzando il codice di esempio Java">}}

        ```java    
        // Dividi il file HTML utilizzando GroupDocs.Merger per l'API Java
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file HTML online"
    content: |
       Dividi subito il file HTML visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html).
