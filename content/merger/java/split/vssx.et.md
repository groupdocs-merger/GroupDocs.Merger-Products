...
############################# Head ############################
head_title: "Jagage VSSX mitmeks failiks rakenduses Java"
head_description: "Dokumentide liitmise API abil jagage üks fail VSSX mitmeks failiks leheküljenumbrite, lehtede intervallide, paaris- või paaritute lehtede põhjal."

############################# Header ############################
title: "VSSX Splitter in Java"
description: "Tükeldage VSSX mõne reaga Java koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSSX fail lehtede kaupa tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks jagada üks VSSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada faili VSSX, kasutades Java näidet">}}

        ```java    
        // Jagage fail VSSX, kasutades GroupDocs.Merger for Java API-t
...
demos:
    enable: true
    title: "Reaalajas demod – VSSX faili jagamine võrgus"
    content: |
       Tükeldage fail VSSX kohe, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
