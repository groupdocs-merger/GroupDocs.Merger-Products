...
head_description: "Split a single TXT file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "TXT Splitter In Java"
description: "Split TXT with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) makes it easy for Java developers to split a single TXT file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split TXT file using Java example code">}}

        ```java    
        // Split TXT file using GroupDocs.Merger for Java API
