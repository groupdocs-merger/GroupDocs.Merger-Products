...
############################# Head ############################
head_title: "تقسيم TXT إلى ملفات متعددة في Java"
head_description: "قم بتقسيم ملف واحد TXT إلى عدة ملفات بناءً على أرقام الصفحات وفواصل الصفحات والصفحات الزوجية أو الفردية باستخدام واجهة برمجة التطبيقات لدمج المستندات."

############################# Header ############################
title: "TXT الفاصل في Java"
description: "قسِّم TXT ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تقسيم TXT الملف حسب الصفحات في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تقسيم ملف واحد TXT إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملف TXT باستخدام مثال كود Java">}}

        ```java    
        // انقسام الملف TXT باستخدام GroupDocs.Merger لواجهة برمجة تطبيقات جافا
...
demos:
    enable: true
    title: "العروض التوضيحية المباشرة - تقسيم الملف TXT عبر الإنترنت"
    content: |
       قسّم الملف TXT الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt).
