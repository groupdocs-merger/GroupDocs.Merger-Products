...
############################# Head ############################
head_title: "Jaa ODS useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen ODS-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "ODS Jakaja sisään Java"
description: "Jaa ODS muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto ODS sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden ODS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ODS tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto ODS GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa ODS tiedosto verkossa"
    content: |
       Jaa tiedosto ODS heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ods) -sivustolla.
