...
############################# Head ############################
head_title: "Rozdělit DOTM do více souborů v Java"
head_description: "Rozdělte jeden soubor DOTM do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "DOTM Splitter v Java"
description: "Rozdělte DOTM několika řádky kódu Java."
...
steps:
    enable: true
    title_left: "Rozdělit DOTM soubor podle stránek v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java rozdělení jednoho souboru DOTM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit soubor DOTM pomocí ukázkového kódu Java">}}

        ```java    
        // Rozdělte soubor DOTM pomocí GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru DOTM online"
    content: |
       Rozdělte soubor DOTM právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm).
