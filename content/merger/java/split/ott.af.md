...
############################# Head ############################
head_title: "Verdeel OTT in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele OTT-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "OTT Splitter in Java"
description: "Verdeel OTT met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel OTT lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele OTT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTT-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel OTT lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel OTT lêer aanlyn"
    content: |
       Verdeel OTT-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ott) webwerf te besoek.
