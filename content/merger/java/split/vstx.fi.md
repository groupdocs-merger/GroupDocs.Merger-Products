...
############################# Head ############################
head_title: "Jaa VSTX useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen VSTX-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "VSTX Jakaja sisään Java"
description: "Jaa VSTX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto VSTX sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden VSTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSTX tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto VSTX GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa VSTX tiedosto verkossa"
    content: |
       Jaa tiedosto VSTX heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vstx) -sivustolla.
