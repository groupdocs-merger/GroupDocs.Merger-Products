...
############################# Head ############################
head_title: "Podijeli VSSX u više datoteka u Java"
head_description: "Podijelite jednu VSSX datoteku u nekoliko datoteka na temelju brojeva stranica, intervala stranica, parnih ili neparnih stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "VSSX Splitter u Java"
description: "Podijelite VSSX s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Podijeli VSSX datoteku po stranicama u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava dijeljenje jedne VSSX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSSX datoteku koristeći Java primjer koda">}}

        ```java    
        // Podijeli VSSX datoteku koristeći GroupDocs.Merger za Java API
...
demos:
    enable: true
    title: "Demonstracije uživo - Split VSSX datoteka na mreži"
    content: |
       Podijeli VSSX datoteku odmah tako da posjetiš [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx) web mjesto.
