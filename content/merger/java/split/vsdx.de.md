...
############################# Head ############################
head_title: "Teilen Sie VSDX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne VSDX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "VSDX Splittereingang Java"
description: "Teilen Sie VSDX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "VSDX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne VSDX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die VSDX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // VSDX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - VSDX-Datei online teilen"
    content: |
       Teilen Sie die Datei VSDX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdx) besuchen.
