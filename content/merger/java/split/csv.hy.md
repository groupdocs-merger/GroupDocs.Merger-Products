...
############################# Head ############################
head_title: "Բաժանել CSV-ը մի քանի ֆայլերի Java-ում"
...
############################# Header ############################
title: "CSV Splitter Java-ում"
description: "Բաժանեք CSV-ը Java կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել CSV ֆայլը ըստ էջերի Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար մեկ CSV ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել CSV ֆայլը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Բաժանեք CSV ֆայլը՝ օգտագործելով GroupDocs.Merger Java API-ի համար
