...
############################# Head ############################
head_title: "Rozdeliť PPSX do viacerých súborov v Java"
...
description: "Rozdeľte PPSX niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť PPSX súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor PPSX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PPSX súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor PPSX pomocou rozhrania GroupDocs.Merger for Java API
