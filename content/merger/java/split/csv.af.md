...
############################# Head ############################
head_title: "Verdeel CSV in veelvuldige lêers in Java"
head_description: "Verdeel 'n enkele CSV-lêer in verskeie lêers gebaseer op bladsynommers, bladsy-intervalle, ewe of onewe bladsye met behulp van dokumentsamesmeltings-API."

############################# Header ############################
title: "CSV Splitter in Java"
description: "Verdeel CSV met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verdeel CSV lêer volgens bladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele CSV-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om CSV-lêer te verdeel met behulp van Java voorbeeldkode">}}

        ```java    
        // Verdeel CSV lêer deur GroupDocs.Merger vir Java API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verdeel CSV lêer aanlyn"
    content: |
       Verdeel CSV-lêer op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/csv) webwerf te besoek.
