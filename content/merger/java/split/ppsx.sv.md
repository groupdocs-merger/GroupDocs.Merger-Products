...
############################# Head ############################
head_title: "Dela upp PPSX i flera filer i Java"
...
description: "Dela upp PPSX med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Dela upp PPSX fil efter sidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att dela upp en enda PPSX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PPSX-filen med hjälp av Java exempelkod">}}

        ```java    
        // Dela PPSX-fil med GroupDocs.Merger för Java API
