...
############################# Head ############################
head_title: "Razdeli XLSB na več datotek v Java"
head_description: "Eno datoteko XLSB razdelite na več datotek na podlagi številk strani, intervalov strani, sodih ali lihih strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "XLSB razdelilnik v Java"
description: "Razdelite XLSB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Razdeli datoteko XLSB po straneh v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša razdelitev ene datoteke XLSB na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteko XLSB s primerom kode Java">}}

        ```java    
        // Razdeli datoteko XLSB z API-jem GroupDocs.Merger za Java
...
demos:
    enable: true
    title: "Predstavitve v živo - Razdeli XLSB datoteko na spletu"
    content: |
       Takoj razdelite datoteko XLSB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlsb).
