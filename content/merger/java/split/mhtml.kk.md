...
############################# Head ############################
head_title: "MHTML файлын Java ішінде бірнеше файлға бөліңіз"
head_description: "Бір MHTML файлын құжаттарды біріктіру API көмегімен бет нөмірлеріне, бет аралықтарына, жұп немесе тақ беттерге негізделген бірнеше файлдарға бөліңіз."

############################# Header ############################
title: "MHTML Java ішіндегі бөлгіш"
description: "MHTML кодының бірнеше жолын Java кодымен бөліңіз."
...
steps:
    enable: true
    title_left: "MHTML файлды Java беттері бойынша бөлу"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бір MHTML файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML файлды Java мысал кодын пайдаланып бөлу жолы">}}

        ```java    
        // MHTML файлды Java API үшін GroupDocs.Merger арқылы бөліңіз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - MHTML файлды желіде бөліңіз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml) веб-сайтына кіру арқылы MHTML файлды дәл қазір бөліңіз.
