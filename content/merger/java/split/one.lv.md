...
############################# Head ############################
head_title: "Sadaliet ONE vairākos failos programmā Java"
head_description: "Sadaliet vienu ONE failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "ONE sadalītājs programmā Java"
description: "Sadaliet ONE ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ONE failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu ONE failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ONE failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet ONE failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt ONE failu tiešsaistē"
    content: |
       Sadaliet ONE failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/one).
