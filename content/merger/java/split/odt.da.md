...
############################# Head ############################
head_title: "Opdel ODT i flere filer i Java"
head_description: "Opdel en enkelt ODT-fil i flere filer baseret på sidetal, sideintervaller, lige eller ulige sider ved hjælp af Documents Merger API."

############################# Header ############################
title: "ODT Splitter i Java"
description: "Opdel ODT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Opdel ODT fil efter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at opdele en enkelt ODT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ODT fil ved hjælp af Java eksempelkode">}}

        ```java    
        // Opdel ODT fil ved hjælp af GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Livedemoer - Split ODT fil online"
    content: |
       Opdel ODT-filen lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odt).
