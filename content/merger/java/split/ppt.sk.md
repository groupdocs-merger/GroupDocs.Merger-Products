...
############################# Head ############################
head_title: "Rozdeliť PPT do viacerých súborov v Java"
...
description: "Rozdeľte PPT niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Rozdeliť PPT súbor podľa stránok v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java rozdeliť jeden súbor PPT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PPT súbor pomocou Java vzorového kódu">}}

        ```java    
        // Rozdeľte súbor PPT pomocou rozhrania GroupDocs.Merger for Java API
