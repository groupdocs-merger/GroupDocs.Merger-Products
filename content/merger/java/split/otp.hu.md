...
############################# Head ############################
head_title: "A(z) OTP felosztása több fájlra a Java programban"
head_description: "Egyetlen OTP fájl felosztása több fájlra oldalszámok, oldalintervallumok, páros vagy páratlan oldalak alapján a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTP Splitter in Java"
description: "Oszd fel az OTP elemet néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "A(z) OTP fájl felosztása oldalak szerint itt: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen OTP fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Az OTP fájl felosztása a Java példakóddal">}}

        ```java    
        // Az OTP fájl felosztása a GroupDocs.Merger for Java API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Split OTP fájl online"
    content: |
       Ossza meg az OTP fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/otp) webhely meglátogatásával.
