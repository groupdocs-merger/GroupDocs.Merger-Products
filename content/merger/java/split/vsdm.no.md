...
############################# Head ############################
head_title: "Del VSDM i flere filer i Java"
head_description: "Del en enkelt VSDM-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "VSDM splitter i Java"
description: "Del VSDM med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Del VSDM-fil etter sider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å dele en enkelt VSDM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSDM-fil ved hjelp av Java-eksempelkode">}}

        ```java    
        // Del VSDM-filen med GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Live-demoer - Del VSDM-fil på nett"
    content: |
       Del opp VSDM-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vsdm).
