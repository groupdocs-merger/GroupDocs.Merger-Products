...
############################# Head ############################
head_title: "Teilen Sie DOTX in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne DOTX-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "DOTX Splittereingang Java"
description: "Teilen Sie DOTX mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "DOTX-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne DOTX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die DOTX-Datei mit dem Java-Beispielcode">}}

        ```java    
        // DOTX-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - DOTX-Datei online teilen"
    content: |
       Teilen Sie die Datei DOTX jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotx) besuchen.
