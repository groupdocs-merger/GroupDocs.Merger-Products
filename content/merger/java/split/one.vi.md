...
############################# Head ############################
head_title: "Tách ONE thành nhiều tệp trong Java"
head_description: "Tách một tệp ONE thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "ONE Splitter trong Java"
description: "Tách ONE bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Tách tệp ONE theo các trang trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng chia một tệp ONE thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách tách tệp ONE bằng mã mẫu Java">}}

        ```java    
        // Tách tệp ONE bằng GroupDocs.Merger cho Java API
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Tách tệp ONE Trực tuyến"
    content: |
       Tách tệp ONE ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos] (https://products.groupdocs.app/splitter/ one) trang web.
