...
############################# Head ############################
head_title: "Sadaliet VTX vairākos failos programmā Java"
...
############################# Header ############################
title: "VTX sadalītājs programmā Java"
description: "Sadaliet VTX ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VTX failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu VTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VTX failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet VTX failu, izmantojot GroupDocs.Merger for Java API
