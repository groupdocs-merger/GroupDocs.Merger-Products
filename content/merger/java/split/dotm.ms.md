...
############################# Head ############################
head_title: "Pisahkan DOTM kepada Berbilang Fail dalam Java"
head_description: "Pisahkan satu fail DOTM kepada beberapa fail berdasarkan nombor halaman, selang halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

############################# Header ############################
title: "DOTM Pemisah Dalam Java"
description: "Pisahkan DOTM dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Pisahkan DOTM Fail Mengikut Halaman dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java membahagikan satu fail DOTM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membelah fail DOTM menggunakan kod contoh Java.">}}

        ```java    
        // Pisahkan fail DOTM menggunakan GroupDocs.Merger untuk Java API
...
demos:
    enable: true
    title: "Demo Langsung - Split DOTM Fail Dalam Talian"
    content: |
       Pisahkan fail DOTM sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm).
