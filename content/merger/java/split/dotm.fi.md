...
############################# Head ############################
head_title: "Jaa DOTM useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen DOTM-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "DOTM Jakaja sisään Java"
description: "Jaa DOTM muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto DOTM sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden DOTM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOTM tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto DOTM GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa DOTM tiedosto verkossa"
    content: |
       Jaa tiedosto DOTM heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/dotm) -sivustolla.
