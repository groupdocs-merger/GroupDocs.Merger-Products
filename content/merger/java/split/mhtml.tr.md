...
############################# Head ############################
head_title: "MHTML'i Java İçinde Birden Çok Dosyaya Böl"
head_description: "Belge birleştirme API'sini kullanarak tek bir MHTML dosyasını sayfa numaralarına, sayfa aralıklarına, çift veya tek sayfalara göre birkaç dosyaya bölün."

############################# Header ############################
title: "MHTML Ayırıcı Java"
description: "MHTML kodunu birkaç satır Java koduyla ayırın."
...
steps:
    enable: true
    title_left: "MHTML Dosyasını Java İçindeki Sayfalara Göre Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHTML dosyası nasıl bölünür">}}

        ```java    
        // Java API için GroupDocs.Merger kullanarak MHTML dosyasını ayırın
...
demos:
    enable: true
    title: "Canlı Demolar - MHTML Dosyasını Çevrimiçi Böl"
    content: |
       MHTML dosyasını hemen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/mhtml) web sitesini ziyaret ederek bölün.
