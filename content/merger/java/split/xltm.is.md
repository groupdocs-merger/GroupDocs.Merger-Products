...
############################# Head ############################
head_title: "Skiptu XLTM í margar skrár í Java"
...
############################# Header ############################
title: "XLTM Skerandi í Java"
description: "Skiptu XLTM með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLTM skrá eftir síðum í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta einni XLTM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLTM skrá með Java dæmi kóða">}}

        ```java    
        // Skiptu XLTM skrá með GroupDocs.Merger fyrir Java API
