...
############################# Head ############################
head_title: "Scoilt PPT ina Ilchomhaid i Java"
head_description: "Scoilt comhad PPT amháin i roinnt comhad bunaithe ar líon na leathanach, eatraimh leathanaigh, leathanaigh chothroma nó corr-leathanaigh ag baint úsáide as API cumaisc doiciméad."

############################# Header ############################
title: "PPT Scoilteoir i Java"
description: "Scoilt PPT le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Scoilt PPT Comhad De réir Leathanaigh i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java comhad amháin PPT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhad PPT a scoilt trí úsáid a bhaint as Java cód samplach">}}

        ```java    
        // Scoilt PPT comhad ag baint úsáide as GroupDocs.Merger do Java API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Scoilt PPT Comhad Ar Líne"
    content: |
       Scoilt PPT comhad faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppt).
