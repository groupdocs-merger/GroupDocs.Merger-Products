...
############################# Head ############################
head_title: "Jaa EPUB useiksi tiedostoiksi Java"
head_description: "Jaa yksittäinen EPUB-tiedosto useiksi tiedostoiksi sivunumeroiden, sivuvälien, parillisten tai parittomien sivujen perusteella dokumenttien yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "EPUB Jakaja sisään Java"
description: "Jaa EPUB muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Jaa tiedosto EPUB sivujen mukaan kohteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi jakaa yhden EPUB-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa EPUB tiedosto käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Jaa tiedosto EPUB GroupDocs.Merger for Java API:lla
...
demos:
    enable: true
    title: "Live-esittelyt - Jaa EPUB tiedosto verkossa"
    content: |
       Jaa tiedosto EPUB heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/epub) -sivustolla.
