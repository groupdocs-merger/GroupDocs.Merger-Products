...
############################# Head ############################
head_title: "Разделете DOC на няколко файла в Java"
head_description: "Разделете един файл DOC на няколко файла въз основа на номера на страници, интервали между страници, четни или нечетни страници, като използвате API за сливане на документи."

############################# Header ############################
title: "DOC Сплитер в Java"
description: "Разделете DOC с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Разделете DOC файл по страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да разделят един файл DOC на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделя файл DOC с примерен код на Java">}}

        ```java    
        // Разделете DOC файл с помощта на GroupDocs.Merger за Java API
...
demos:
    enable: true
    title: "Демонстрации на живо - Разделете DOC файл онлайн"
    content: |
       Разделете файла DOC веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/doc).
