...
############################# Head ############################
head_title: "Teilen Sie TXT in mehrere Dateien in Java"
head_description: "Teilen Sie eine einzelne TXT-Datei in mehrere Dateien basierend auf Seitenzahlen, Seitenintervallen, geraden oder ungeraden Seiten mithilfe der Documents Merger API auf."

############################# Header ############################
title: "TXT Splittereingang Java"
description: "Teilen Sie TXT mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "TXT-Datei nach Seiten aufteilen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern einfach, eine einzelne TXT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie die TXT-Datei mit dem Java-Beispielcode">}}

        ```java    
        // TXT-Datei mit GroupDocs.Merger für Java-API aufteilen
...
demos:
    enable: true
    title: "Live-Demos - TXT-Datei online teilen"
    content: |
       Teilen Sie die Datei TXT jetzt, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/txt) besuchen.
