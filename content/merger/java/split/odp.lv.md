...
############################# Head ############################
head_title: "Sadaliet ODP vairākos failos programmā Java"
head_description: "Sadaliet vienu ODP failu vairākos failos, pamatojoties uz lappušu numuriem, lappušu intervāliem, pāra vai nepāra lapām, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "ODP sadalītājs programmā Java"
description: "Sadaliet ODP ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODP failu pa lapām pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli sadalīt vienu ODP failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODP failu, izmantojot Java piemēra kodu">}}

        ```java    
        // Sadaliet ODP failu, izmantojot GroupDocs.Merger for Java API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — sadalīt ODP failu tiešsaistē"
    content: |
       Sadaliet ODP failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/odp).
