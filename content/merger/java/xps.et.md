...
############################# Head ############################
head_title: "Ühendage XPS failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XPS ühinemine programmis Java"
description: "Ühendage XPS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XPS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XPS faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XPS faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XPS, kasutades GroupDocs.Merger for Java API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks XPS faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
