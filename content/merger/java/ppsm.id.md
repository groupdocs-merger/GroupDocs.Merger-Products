...
head_description: "Gabungkan beberapa file PPSM menjadi satu file menggunakan API penggabungan dokumen Java dengan semua data, gaya, dan pemformatan sebagai dokumen sumber."
...
steps:
    enable: true
    title_left: "Gabungkan Dua atau Lebih File PPSM di Java"
    content_left: |
        ...
        * Buat instance kelas **Merger** dan muat file PPSM.
        * Panggil metode **Join** dari instance kelas **Merger** dan muat file PPSM lainnya.
