...
############################# Head ############################
head_title: "Ühendage ONE failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu ONE-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "ONE ühinemine programmis Java"
description: "Ühendage ONE mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ONE faili, kasutades Java näitekoodi">}}
