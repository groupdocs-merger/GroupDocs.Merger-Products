...
############################# Head ############################
head_title: "Fusionner MHTML fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers MHTML en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "MHTML Fusionner dans Java"
description: "Fusionnez MHTML avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers MHTML dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers MHTML en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers MHTML à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers MHTML à l'aide de GroupDocs.Merger pour l'API Java
