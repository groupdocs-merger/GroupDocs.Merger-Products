...
############################# Head ############################
head_title: "دمج ملفات XLAM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLAM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLAM الاندماج في Java"
description: "دمج XLAM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLAM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
