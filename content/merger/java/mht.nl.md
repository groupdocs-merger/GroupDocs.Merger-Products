...
############################# Head ############################
head_title: "Samenvoegen MHT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "MHT Fusie in Java"
description: "Voeg MHT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere MHT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg MHT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één MHT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) te gaan.
