...
############################# Head ############################
head_title: "OTP Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla OTP dosyasını birleştirin."

############################# Header ############################
title: "OTP Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok OTP Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) web sitesini ziyaret ederek birden fazla OTP dosyayı birleştirin.
