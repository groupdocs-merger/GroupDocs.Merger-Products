...
############################# Head ############################
head_title: "Slå sammen PNG filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PNG sammenslåing i Java"
description: "Slå sammen PNG med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PNG filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PNG filer med GroupDocs.Merger for Java API
