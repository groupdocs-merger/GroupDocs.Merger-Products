...
############################# Header ############################
title: "MHTML ควบรวมกิจการใน Java"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีผสาน MHTML ไฟล์โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // รวม MHTML ไฟล์โดยใช้ GroupDocs.Merger สำหรับ Java API
