...
############################# Head ############################
head_title: "JavaでEPUBファイルをマージ"
head_description: "JavaプロジェクトにEPUBドキュメントマージ機能を統合するために、GroupDocs.Merger for Javaを使用します。"

############################# Header ############################
title: "EPUBファイルをマージ" 
description: "GroupDocs.Merger for Javaを使用すれば、Javaアプリケーションを構築して、EPUBドキュメントをシームレスにマージおよび管理できます。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)はEPUBドキュメントのシームレスなマージを可能にします。複数のファイルを1つに統合して、Javaアプリケーションを強化します。
      
      1. 最初のEPUBファイルのパスを指定します。
