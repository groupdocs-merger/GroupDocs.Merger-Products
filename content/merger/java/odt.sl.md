...
############################# Head ############################
head_title: "Spoji datoteke ODT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek ODT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "ODT Združitev v Java"
description: "Spojite ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek ODT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke ODT z API-jem GroupDocs.Merger for Java
