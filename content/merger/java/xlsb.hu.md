...
############################# Head ############################
head_title: "Egyesítse az XLSB fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLSB fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLSB Egyesülés a Java programban"
description: "Egyesítse a(z) XLSB terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLSB fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLSB fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLSB fájlokat a GroupDocs.Merger for Java API segítségével
