...
############################# Head ############################
head_title: "Egyesítse az ONE fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több ONE fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "ONE Egyesülés a Java programban"
description: "Egyesítse a(z) ONE terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több ONE fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több ONE fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen ONE fájlokat a GroupDocs.Merger for Java API segítségével
