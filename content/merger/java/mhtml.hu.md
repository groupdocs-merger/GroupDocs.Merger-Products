...
############################# Head ############################
head_title: "Egyesítse az MHTML fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több MHTML fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "MHTML Egyesülés a Java programban"
description: "Egyesítse a(z) MHTML terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több MHTML fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több MHTML fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen MHTML fájlokat a GroupDocs.Merger for Java API segítségével
