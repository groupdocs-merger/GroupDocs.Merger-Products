...
############################# Head ############################
head_title: "Spoji datoteke XLSM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLSM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLSM Združitev v Java"
description: "Spojite XLSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLSM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLSM z API-jem GroupDocs.Merger for Java
