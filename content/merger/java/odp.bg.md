...
############################# Head ############################
head_title: "Обединете ODP файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество ODP файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "ODP Обединяване в Java"
description: "Обединете ODP с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество ODP файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ODP файлове с Java примерен код">}}

        ```java    
        // Обединете ODP файлове с помощта на GroupDocs.Merger за Java API
