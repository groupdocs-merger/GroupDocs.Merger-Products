...
############################# Head ############################
head_title: "Flet MHT filer via Java & J2SE Documents Merger API"
head_description: "Flet flere MHT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "MHT fusion i Java"
description: "Flet MHT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere MHT filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere MHT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes MHT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet MHT filer ved hjælp af GroupDocs.Merger for Java API
