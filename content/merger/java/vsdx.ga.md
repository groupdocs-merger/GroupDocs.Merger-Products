...
############################# Head ############################
head_title: "Cumaisc VSDX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid VSDX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "VSDX Cumasc i Java"
description: "Cumaisc VSDX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc VSDX Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid VSDX iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSDX comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc VSDX comhad le GroupDocs.Merger le haghaidh Java API
