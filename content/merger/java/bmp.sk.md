...
############################# Head ############################
head_title: "Zlúčiť súbory BMP cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero BMP súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "BMP Zlúčenie v Java"
description: "Zlúčte BMP s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero BMP súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov BMP vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory BMP pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť BMP súbory pomocou GroupDocs.Merger for Java API
