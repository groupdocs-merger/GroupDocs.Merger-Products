...
############################# Head ############################
head_title: "Pelên DOCM bi navgîniya Java & J2SE Documents Merger API-ê ve bikin yek"
head_description: "Gelek pelên DOCM di Java-yê de bi karanîna API-ya yekkirina belgeyan bi hemî dane, şêwaz û şeklê wekî belgeyên çavkaniyê ve bi hev re bikin."

############################# Header ############################
title: "DOCM Yekbûn di Java"
...
steps:
    enable: true
    title_left: "Gelek DOCM Pelên di Java de bibin yek"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên DOCM bi karanîna koda nimûneya Java dike yek">}}

        ```java    
        // Pelên DOCM bi karanîna GroupDocs.Merger ji bo API-a Java-yê bi hev re bikin
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) niha ji yek pelan zêdetir DOCM bikin yek.
