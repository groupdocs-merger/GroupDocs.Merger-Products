...
############################# Head ############################
head_title: "دمج ملفات TEX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات TEX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "TEX الاندماج في Java"
description: "دمج TEX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من TEX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex).
