...
############################# Head ############################
head_title: "Samenvoegen ODS Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "ODS Fusie in Java"
description: "Voeg ODS samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere ODS bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODS bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg ODS bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één ODS bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) te gaan.
