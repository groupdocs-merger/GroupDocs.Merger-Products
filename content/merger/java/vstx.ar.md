...
############################# Head ############################
head_title: "دمج ملفات VSTX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSTX الاندماج في Java"
description: "دمج VSTX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSTX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx).
