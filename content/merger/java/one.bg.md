...
############################# Head ############################
head_title: "Обединете ONE файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество ONE файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "ONE Обединяване в Java"
description: "Обединете ONE с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество ONE файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ONE файлове с Java примерен код">}}

        ```java    
        // Обединете ONE файлове с помощта на GroupDocs.Merger за Java API
