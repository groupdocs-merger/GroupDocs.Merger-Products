...
############################# Head ############################
head_title: "Cumaisc MHTML Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid MHTML iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "MHTML Cumasc i Java"
description: "Cumaisc MHTML le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc MHTML Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid MHTML iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas MHTML comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc MHTML comhad le GroupDocs.Merger le haghaidh Java API
