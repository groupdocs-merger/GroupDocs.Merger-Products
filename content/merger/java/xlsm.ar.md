...
############################# Head ############################
head_title: "دمج ملفات XLSM عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLSM في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLSM الاندماج في Java"
description: "دمج XLSM ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLSM ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
