...
############################# Head ############################
head_title: "Samenvoegen OTP Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "OTP Fusie in Java"
description: "Voeg OTP samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere OTP bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTP bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg OTP bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één OTP bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) te gaan.
