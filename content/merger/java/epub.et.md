...
############################# Head ############################
head_title: "Ühendage EPUB failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu EPUB-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "EPUB ühinemine programmis Java"
description: "Ühendage EPUB mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita EPUB faili, kasutades Java näitekoodi">}}
