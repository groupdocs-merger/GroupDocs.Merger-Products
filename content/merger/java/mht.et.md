...
############################# Head ############################
head_title: "Ühendage MHT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu MHT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "MHT ühinemine programmis Java"
description: "Ühendage MHT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita MHT faili, kasutades Java näitekoodi">}}
