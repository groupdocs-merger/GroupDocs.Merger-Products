...
############################# Head ############################
head_title: "Egyesítse az VDX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VDX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VDX Egyesülés a Java programban"
description: "Egyesítse a(z) VDX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VDX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VDX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VDX fájlokat a GroupDocs.Merger for Java API segítségével
