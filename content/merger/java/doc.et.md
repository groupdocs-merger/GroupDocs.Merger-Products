...
############################# Head ############################
head_title: "Ühendage DOC failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu DOC-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "DOC ühinemine programmis Java"
description: "Ühendage DOC mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOC faili, kasutades Java näitekoodi">}}
