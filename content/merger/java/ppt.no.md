...
############################# Head ############################
head_title: "Slå sammen PPT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PPT sammenslåing i Java"
description: "Slå sammen PPT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PPT filer med GroupDocs.Merger for Java API
