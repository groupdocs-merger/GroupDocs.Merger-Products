...
############################# Head ############################
head_title: "DOT Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla DOT dosyasını birleştirin."

############################# Header ############################
title: "DOT Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok DOT Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) web sitesini ziyaret ederek birden fazla DOT dosyayı birleştirin.
