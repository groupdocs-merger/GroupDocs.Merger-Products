...
############################# Head ############################
head_title: "Spoji datoteke DOCX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOCX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOCX Združitev v Java"
description: "Spojite DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOCX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOCX z API-jem GroupDocs.Merger for Java
