...
############################# Head ############################
head_title: "Συγχώνευση αρχείων TSV μέσω Java & J2SE Documents Merger API"
head_description: "Συγχωνεύστε πολλά αρχεία TSV σε Java χρησιμοποιώντας το API συγχώνευσης εγγράφων με όλα τα δεδομένα, το στυλ και τη μορφοποίηση ως έγγραφα προέλευσης."

############################# Header ############################
title: "TSV Συγχώνευση στο Java"
description: "Συγχώνευση TSV με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Συγχώνευση πολλών TSV αρχείων στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές Java να συγχωνεύουν πολλά αρχεία TSV εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία TSV χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Συγχώνευση αρχείων TSV χρησιμοποιώντας GroupDocs.Merger for Java API
