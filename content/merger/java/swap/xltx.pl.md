...
############################# Head ############################
head_title: "Zamień i zamień XLTX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLTX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLTX strony w Java"
description: "Zamień strony XLTX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLTX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLTX strony plików online"
    content: |
       Zamień strony plików XLTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
