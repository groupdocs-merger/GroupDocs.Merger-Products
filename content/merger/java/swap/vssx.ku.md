...
############################# Head ############################
head_title: "Biguherîne û biguherîne VSSX Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek VSSX de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne VSSX Rûpelên Di Java de"
description: "Rûpelên VSSX bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de VSSX Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên VSSX bi karanîna koda nimûneya Java veguhezîne">}}
