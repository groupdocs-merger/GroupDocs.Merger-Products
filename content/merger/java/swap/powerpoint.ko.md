...
############################# Head ############################
head_title: "Java 앱으로 POWERPOINT 파일의 페이지 교환하기"
head_description: "GroupDocs.Merger for Java을(를) 사용하여 POWERPOINT 문서의 페이지를 재배열하세요. PDF, 워드 파일, 스프레드시트, 프레젠테이션, 비지오 도표, 이미지, 아카이브 등 다양한 형식을 수정할 수 있습니다."

############################# Header ############################
title: "POWERPOINT 페이지 교환" 
description: "GroupDocs.Merger for Java은(는) Java 애플리케이션에 유연한 문서 조작 기능을 추가합니다. POWERPOINT 파일의 페이지를 재배열하여 콘텐츠 구조를 간소화하세요."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)은(는) POWERPOINT 문서의 페이지 재배열을 간편하게 해 주며, 콘텐츠 조직에 대한 완벽한 제어를 제공합니다. 당신의 Java 애플리케이션에 원활한 문서 처리를 통합하세요.
      
      1. POWERPOINT 파일의 경로를 정의하세요.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "POWERPOINT 파일의 첫 번째 페이지와 마지막 페이지 교환"
      content: |
        이 예제에서는 몇 가지 간단한 단계로 POWERPOINT 파일의 페이지를 교환하는 방법을 보여줍니다.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
