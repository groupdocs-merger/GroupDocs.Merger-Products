...
############################# Head ############################
head_title: "Java ішіндегі VSDM беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы VSDM файлындағы екі беттің орнын Java арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "VSDM беттерді Java арқылы ауыстыру"
description: "VSDM беттерді Java кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі VSDM файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы VSDM файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM файл беттерін Java мысал коды арқылы ауыстыру жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы VSDM файл бетін ауыстырыңыз
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - VSDM файл беттерін онлайн ауыстырыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) веб-сайтына кіру арқылы VSDM файл бетін дәл қазір ауыстырыңыз.
