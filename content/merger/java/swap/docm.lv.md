...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOCM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOCM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOCM lapas programmā Java"
description: "Apmainiet DOCM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOCM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOCM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOCM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOCM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOCM failu lapas tiešsaistē"
    content: |
       Apmainiet DOCM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
