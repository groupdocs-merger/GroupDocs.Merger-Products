...
############################# Head ############################
head_title: "Vahetage ja vahetage TEX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone TEX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage TEX lehte keeles Java"
description: "Vahetage TEX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage TEX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis TEX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada TEX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili TEX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus TEX faililehte"
    content: |
       Vahetage kohe TEX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
