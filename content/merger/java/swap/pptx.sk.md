...
############################# Head ############################
head_title: "Vymeňte a vymeňte PPTX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PPTX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PPTX stránky v Java"
description: "Vymeňte PPTX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte PPTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru PPTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PPTX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte PPTX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte PPTX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi PPTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
