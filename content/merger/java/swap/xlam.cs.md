...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLAM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLAM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLAM stránky v Java"
description: "Vyměňte XLAM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLAM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLAM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLAM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLAM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLAM stránky souborů online"
    content: |
       Vyměňte stránky souborů XLAM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
