...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSTX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSTX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSTX puslapius Java"
description: "Pakeiskite VSTX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSTX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSTX failų puslapiais internete"
    content: |
       Apkeiskite VSTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx) svetainėje.
