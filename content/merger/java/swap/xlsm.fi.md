...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSM sivua Java"
description: "Vaihda XLSM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLSM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XLSM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XLSM tiedostosivua verkossa"
    content: |
       Vaihda XLSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm) -sivustolla.
