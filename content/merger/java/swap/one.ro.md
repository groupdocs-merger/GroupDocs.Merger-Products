...
############################# Head ############################
head_title: "Schimbați și schimbați paginile ONE în Java"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier ONE în Java utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați ONE pagini în Java"
description: "Schimbați paginile ONE cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere ONE în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează ca dezvoltatorii Java să schimbe paginile dintr-un fișier ONE prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere ONE utilizând codul exemplu Java">}}

        ```java    
        // Schimbați pagini de fișiere ONE utilizând API-ul GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo live - Schimbați paginile de fișiere ONE online"
    content: |
       Schimbați paginile de fișiere ONE chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
