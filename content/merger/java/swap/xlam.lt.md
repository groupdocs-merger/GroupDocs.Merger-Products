...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLAM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLAM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLAM puslapius Java"
description: "Pakeiskite XLAM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLAM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLAM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLAM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLAM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLAM failų puslapiais internete"
    content: |
       Apkeiskite XLAM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam) svetainėje.
