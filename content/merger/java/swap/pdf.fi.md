...
############################# Head ############################
head_title: "Vaihda ja vaihda PDF sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PDF-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PDF sivua Java"
description: "Vaihda PDF-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PDF tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja PDF-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PDF tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda PDF tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda PDF tiedostosivua verkossa"
    content: |
       Vaihda PDF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf) -sivustolla.
