...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOTX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOTX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOTX lapas programmā Java"
description: "Apmainiet DOTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOTX failu lapas tiešsaistē"
    content: |
       Apmainiet DOTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
