...
############################# Head ############################
head_title: "Tukar & Tukarkan DOC Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOC di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOC Halaman Di Java"
description: "Tukar DOC Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar DOC Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file DOC dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOC menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOC Halaman File Online"
    content: |
       Tukar halaman file DOC sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/doc).
