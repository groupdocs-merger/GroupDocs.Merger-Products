...
############################# Head ############################
head_title: "Tukar & Tukarkan VSX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSX Halaman Di Java"
description: "Tukar VSX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar VSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file VSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSX menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file VSX menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSX Halaman File Online"
    content: |
       Tukar halaman file VSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/vsx).
