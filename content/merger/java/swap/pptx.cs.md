...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPTX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPTX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPTX stránky v Java"
description: "Vyměňte PPTX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte PPTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru PPTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPTX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru PPTX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte PPTX stránky souborů online"
    content: |
       Vyměňte stránky souborů PPTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
