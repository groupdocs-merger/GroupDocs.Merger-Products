...
############################# Head ############################
head_title: "Tukar & Tukarkan HTML Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file HTML di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar HTML Halaman Di Java"
description: "Tukar HTML Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar HTML Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file HTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file HTML menggunakan kode contoh Java">}}
