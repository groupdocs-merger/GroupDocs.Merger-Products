...
############################# Head ############################
head_title: "Seiten in EXCEL-Dateien mit Java-Apps austauschen"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um Seiten in EXCEL-Dokumenten neu anzuordnen. Modifizieren Sie PDFs, Word-Dateien, Tabellenkalkulationen, Präsentationen, Visio-Diagramme, Bilder, Archive und mehr."

############################# Header ############################
title: "Seiten in EXCEL austauschen" 
description: "GroupDocs.Merger for Java erweitert Java-Anwendungen um flexible Funktionen zur Dokumentenmanipulation. Ordnen Sie Seiten in EXCEL-Dateien neu an, um die Struktur des Inhalts zu optimieren."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) vereinfacht das Neuanordnen von Seiten in EXCEL-Dokumenten und gibt Ihnen die volle Kontrolle über die Organisation des Inhalts. Integrieren Sie nahtlose Dokumentenverarbeitung in Ihre Java-Anwendungen.
      
      1. Definieren Sie den Pfad zur EXCEL-Datei.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Erstens und zuletzt Seiten in einer EXCEL-Datei austauschen"
      content: |
        Dieses Beispiel zeigt, wie man Seiten in einer EXCEL-Datei mit nur wenigen einfachen Schritten austauscht.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
