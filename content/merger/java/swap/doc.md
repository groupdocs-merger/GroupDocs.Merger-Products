...
head_description: "Swap & Exchange positions of two pages within a DOC file in Java using the documents merger API."

############################# Header ############################
title: "Swap DOC Pages In Java"
description: "Swap DOC Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a DOC file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap DOC file pages using Java example code">}}
