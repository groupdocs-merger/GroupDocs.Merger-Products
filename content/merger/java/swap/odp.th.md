...
############################# Head ############################
head_title: "สลับและแลกเปลี่ยนหน้า ODP ใน Java"
head_description: "สลับและแลกเปลี่ยนตำแหน่งสองหน้าภายในไฟล์ ODP ใน Java โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "สลับ ODP หน้าใน Java"
description: "สลับ ODP หน้าด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "สลับหน้าไฟล์ ODP ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ทำให้นักพัฒนา Java สามารถสลับหน้าภายในไฟล์ ODP ได้โดยง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน .
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีสลับหน้าไฟล์ ODP โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // สลับหน้าไฟล์ ODP โดยใช้ GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "การสาธิตสด - สลับหน้าไฟล์ ODP ออนไลน์"
    content: |
       สลับหน้าไฟล์ ODP ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp)
