...
############################# Head ############################
head_title: "Troque e troque XLSM páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo XLSM em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar XLSM Páginas em Java"
description: "Troque XLSM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo XLSM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo XLSM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo XLSM usando o código de exemplo Java">}}

        ```java    
        // Troque as páginas do arquivo XLSM usando a API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Trocar páginas de arquivo XLSM on-line"
    content: |
       Troque as páginas do arquivo XLSM agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
