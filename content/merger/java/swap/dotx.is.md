...
############################# Head ############################
head_title: "Skiptu og skiptu á DOTX síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í DOTX skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um DOTX síður í Java"
description: "Skiptu um DOTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um DOTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan DOTX skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um DOTX skráarsíður með því að nota Java dæmikóða">}}
