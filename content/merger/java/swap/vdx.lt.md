...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VDX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VDX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VDX puslapius Java"
description: "Pakeiskite VDX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VDX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VDX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VDX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VDX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VDX failų puslapiais internete"
    content: |
       Apkeiskite VDX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) svetainėje.
