...
############################# Head ############################
head_title: "Tukar & Tukar ONE Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ONE dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ONE Halaman Dalam Java"
description: "Tukar ONE Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar ONE Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail ONE dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ONE halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar ONE halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ONE Halaman Fail Dalam Talian"
    content: |
       Tukar ONE halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
