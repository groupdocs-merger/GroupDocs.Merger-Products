...
############################# Head ############################
head_title: "Zamień i zamień DOCX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOCX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOCX strony w Java"
description: "Zamień strony DOCX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOCX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOCX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOCX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOCX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOCX strony plików online"
    content: |
       Zamień strony plików DOCX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx).
