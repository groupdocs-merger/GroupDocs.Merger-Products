...
############################# Head ############################
head_title: "在 XLSX 文件中交换页面，使用 Java 应用程序"
head_description: "使用 GroupDocs.Merger for Java 来重新排列 XLSX 文档中的页面。修改 PDF、Word 文件、电子表格、演示文稿、Visio 图纸、图像、档案等。"

############################# Header ############################
title: "交换 XLSX 页面" 
description: "GroupDocs.Merger for Java 为 Java 应用程序提供灵活的文档处理功能。重新排列 XLSX 文件中的页面，以简化内容结构。"
...
steps:
    enable: true
    title: "如何重新排序 XLSX 页面"
    content: |
      [GroupDocs.Merger](/merger/java/) 简化了 XLSX 文档中的页面重新排序，让您全面掌控内容组织。将无缝文档处理集成到您的 Java 应用程序中。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "在 XLSX 文件中交换第一页和最后一页"
      content: |
        该示例演示了如何在 XLSX 文件中仅用几个简单步骤交换页面。
      code:
        title: "Java"
        content: |
          ```java {style=abap}
