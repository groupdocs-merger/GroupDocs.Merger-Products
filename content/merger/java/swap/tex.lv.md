...
############################# Head ############################
head_title: "Apmainīt un apmainīt TEX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas TEX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt TEX lapas programmā Java"
description: "Apmainiet TEX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt TEX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām TEX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt TEX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet TEX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt TEX failu lapas tiešsaistē"
    content: |
       Apmainiet TEX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
