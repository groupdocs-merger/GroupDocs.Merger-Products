...
############################# Head ############################
head_title: "Cserélj és cserélj DOCM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOCM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCM oldal cseréje a Java nyelven"
description: "Cserélje ki az DOCM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOCM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy DOCM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOCM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az DOCM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOCM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm) webhely meglátogatásával azonnal cseréljen DOCM fájloldalt.
