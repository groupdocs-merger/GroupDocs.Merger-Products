...
head_description: "Swap & Exchange positions of two pages within a XPS file in Java using the documents merger API."

############################# Header ############################
title: "Swap XPS Pages In Java"
description: "Swap XPS Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a XPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XPS file pages using Java example code">}}
