...
description: "Swap & Exchange positions of two pages within a XPS file using the file splitter API for Java & J2SE applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a XPS file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within XPS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) website.
