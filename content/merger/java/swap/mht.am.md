...
############################# Head ############################
head_title: "በJava ውስጥ MHT ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በJava ውስጥ ባለው የMHT ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "MHT ገጾችን በJava ውስጥ ይቀያይሩ"
description: "MHT ገጾችን በጥቂት የJava ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "MHT የፋይል ገጾችን በJava ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በMHT ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT የፋይል ገጾችን Java ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የMHT ፋይል ገጾችን ይቀይሩ
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የMHT ፋይል ገጾችን በመስመር ላይ ይቀያይሩ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht) ድር ጣቢያን በመጎብኘት የMHT ፋይል ገጾችን አሁኑኑ ይቀይሩ።
