...
############################# Head ############################
head_title: "Skiptu og skiptu á VSDX síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í VSDX skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um VSDX síður í Java"
description: "Skiptu um VSDX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um VSDX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan VSDX skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um VSDX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Skiptu um VSDX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu um VSDX skráarsíður á netinu"
    content: |
       Skiptu um VSDX skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
