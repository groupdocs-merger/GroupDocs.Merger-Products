...
############################# Head ############################
head_title: "Canvia i intercanvia PDF pàgines a Java"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer PDF a Java mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia PDF pàgines a Java"
description: "Canvia les pàgines PDF amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers PDF a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java intercanviïn pàgines dins d'un fitxer PDF implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers PDF utilitzant el codi d'exemple Java">}}

        ```java    
        // Canvia pàgines de fitxers PDF mitjançant l'API de GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: intercanvieu PDF pàgines de fitxers en línia"
    content: |
       Canvia les pàgines de fitxers PDF ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
