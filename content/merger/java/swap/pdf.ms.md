...
############################# Head ############################
head_title: "Tukar & Tukar PDF Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PDF dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PDF Halaman Dalam Java"
description: "Tukar PDF Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar PDF Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail PDF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PDF halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar PDF halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PDF Halaman Fail Dalam Talian"
    content: |
       Tukar PDF halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
