...
############################# Head ############################
head_title: "Vaihda ja vaihda ONE sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ONE-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ONE sivua Java"
description: "Vaihda ONE-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ONE tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja ONE-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ONE tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda ONE tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda ONE tiedostosivua verkossa"
    content: |
       Vaihda ONE tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) -sivustolla.
