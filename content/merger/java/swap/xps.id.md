...
############################# Head ############################
head_title: "Tukar & Tukarkan XPS Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XPS di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XPS Halaman Di Java"
description: "Tukar XPS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XPS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XPS menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XPS Halaman File Online"
    content: |
       Tukar halaman file XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xps).
