...
############################# Head ############################
head_title: "Vahetage ja vahetage VSTM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSTM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSTM lehte keeles Java"
description: "Vahetage VSTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VSTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VSTM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VSTM faililehte"
    content: |
       Vahetage kohe VSTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
