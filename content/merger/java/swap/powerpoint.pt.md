...
############################# Head ############################
head_title: "Troque páginas em arquivos POWERPOINT com aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para reorganizar páginas em documentos POWERPOINT. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos e mais."

############################# Header ############################
title: "Trocar páginas POWERPOINT" 
description: "GroupDocs.Merger for Java melhora aplicações Java com recursos flexíveis de manipulação de documentos. Reordene páginas em arquivos POWERPOINT para otimizar a estrutura do conteúdo."
...
steps:
    enable: true
    title: "Como reordenar páginas POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica a reordenação de páginas em documentos POWERPOINT, dando total controle sobre a organização do conteúdo. Integre um processamento de documentos sem costura em suas aplicações Java.
      
      1. Defina o caminho do arquivo POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última página em um arquivo POWERPOINT"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo POWERPOINT com apenas alguns passos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
