...
############################# Head ############################
head_title: "Tukar & Tukarkan VSDX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSDX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDX Halaman Di Java"
description: "Tukar VSDX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar VSDX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file VSDX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSDX menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file VSDX menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSDX Halaman File Online"
    content: |
       Tukar halaman file VSDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/vsdx).
