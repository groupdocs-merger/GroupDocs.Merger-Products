...
############################# Head ############################
head_title: "Java ішіндегі PPSX беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы PPSX файлындағы екі беттің орнын Java арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "PPSX беттерді Java арқылы ауыстыру"
description: "PPSX беттерді Java кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі PPSX файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы PPSX файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX файл беттерін Java мысал коды арқылы ауыстыру жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы PPSX файл бетін ауыстырыңыз
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - PPSX файл беттерін онлайн ауыстырыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx) веб-сайтына кіру арқылы PPSX файл бетін дәл қазір ауыстырыңыз.
