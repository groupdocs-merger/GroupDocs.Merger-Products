...
############################# Head ############################
head_title: "Ανταλλαγή και ανταλλαγή σελίδων ODP σε Java"
head_description: "Ανταλλαγή και ανταλλαγή θέσεων δύο σελίδων σε ένα αρχείο ODP στο Java χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Ανταλλαγή ODP σελίδων σε Java"
description: "Αλλάξτε ODP σελίδες με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Ανταλλαγή ODP σελίδων αρχείου στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να ανταλλάξουν σελίδες σε ένα αρχείο ODP εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να ανταλλάξετε σελίδες αρχείου ODP χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Ανταλλάξτε ODP σελίδες αρχείου χρησιμοποιώντας το GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Ανταλλαγή ODP σελίδων αρχείων στο Διαδίκτυο"
    content: |
       Ανταλλάξτε σελίδες αρχείου ODP αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
