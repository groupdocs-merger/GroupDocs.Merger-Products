...
############################# Head ############################
head_title: "Zamień i zamień XLAM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLAM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLAM strony w Java"
description: "Zamień strony XLAM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLAM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLAM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLAM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLAM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLAM strony plików online"
    content: |
       Zamień strony plików XLAM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
