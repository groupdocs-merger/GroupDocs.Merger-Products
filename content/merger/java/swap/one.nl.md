...
############################# Head ############################
head_title: "Ruil en ruil ONE pagina's in Java"
head_description: "Wissel en ruil posities van twee pagina's binnen een ONE bestand in Java met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel ONE pagina's in Java"
description: "Verwissel ONE pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwissel ONE Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een ONE bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ONE bestandspagina's te wisselen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verwissel ONE bestandspagina's met de GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live demo's - Verwissel ONE bestandspagina's online"
    content: |
       Ruil ONE bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) te gaan.
