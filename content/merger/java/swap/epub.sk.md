...
############################# Head ############################
head_title: "Vymeňte a vymeňte EPUB stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore EPUB v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte EPUB stránky v Java"
description: "Vymeňte EPUB stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte EPUB strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru EPUB implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru EPUB pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte EPUB stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte EPUB stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi EPUB hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub).
