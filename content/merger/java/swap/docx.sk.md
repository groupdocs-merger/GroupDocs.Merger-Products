...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOCX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOCX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOCX stránky v Java"
description: "Vymeňte DOCX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOCX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOCX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOCX pomocou vzorového kódu Java">}}
