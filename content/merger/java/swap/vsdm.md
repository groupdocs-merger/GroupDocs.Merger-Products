...
############################# Head ############################
head_title: "Swap & Exchange VSDM Pages in Java"
head_description: "Java users to swap & exchange positions of two pages within a VSDM file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange VSDM Pages in Java"
description: "Swap & Exchange positions of two pages within a VSDM file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap VSDM File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a VSDM file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within VSDM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) website.
