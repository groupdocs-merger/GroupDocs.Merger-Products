...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSSM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSSM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSSM lapas programmā Java"
description: "Apmainiet VSSM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSSM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSSM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSSM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSSM failu lapas tiešsaistē"
    content: |
       Apmainiet VSSM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
