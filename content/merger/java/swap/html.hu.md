...
############################# Head ############################
head_title: "Cserélj és cserélj HTML oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy HTML fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "HTML oldal cseréje a Java nyelven"
description: "Cserélje ki az HTML oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "HTML fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy HTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk HTML fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az HTML fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – HTML fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html) webhely meglátogatásával azonnal cseréljen HTML fájloldalt.
