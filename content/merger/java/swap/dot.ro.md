...
############################# Head ############################
head_title: "Schimbați și schimbați paginile DOT în Java"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier DOT în Java utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați DOT pagini în Java"
description: "Schimbați paginile DOT cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere DOT în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează ca dezvoltatorii Java să schimbe paginile dintr-un fișier DOT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere DOT utilizând codul exemplu Java">}}

        ```java    
        // Schimbați pagini de fișiere DOT utilizând API-ul GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo live - Schimbați paginile de fișiere DOT online"
    content: |
       Schimbați paginile de fișiere DOT chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot).
