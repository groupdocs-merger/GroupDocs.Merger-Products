...
############################# Head ############################
head_title: "Schimbați și schimbați paginile TEX în Java"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier TEX în Java utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați TEX pagini în Java"
description: "Schimbați paginile TEX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere TEX în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează ca dezvoltatorii Java să schimbe paginile dintr-un fișier TEX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere TEX utilizând codul exemplu Java">}}

        ```java    
        // Schimbați pagini de fișiere TEX utilizând API-ul GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo live - Schimbați paginile de fișiere TEX online"
    content: |
       Schimbați paginile de fișiere TEX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
