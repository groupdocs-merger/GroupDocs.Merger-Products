...
############################# Head ############################
head_title: "Byt og byt VSDM sider i Java"
head_description: "Byt og udveksle positioner på to sider i en VSDM-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSDM sider i Java"
description: "Byt VSDM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt VSDM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en VSDM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSDM filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift VSDM filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt VSDM filsider online"
    content: |
       Skift VSDM filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
