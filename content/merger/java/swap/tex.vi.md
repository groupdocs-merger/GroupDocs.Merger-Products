...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi TEX Trang trong Java"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp TEX trong Java bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi TEX Trang trong Java"
description: "Hoán đổi các trang TEX bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Hoán đổi TEX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java]({{sl slash_lang}}/merge/java/) giúp các nhà phát triển Java dễ dàng hoán đổi các trang trong một tệp TEX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp TEX bằng mã mẫu Java">}}

        ```java    
        // Hoán đổi các trang tệp TEX bằng API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Trao đổi TEX Trang Tệp Trực tuyến"
    content: |
       Hoán đổi các trang tệp TEX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ tex) trang web.
