...
############################# Head ############################
head_title: "በJava ውስጥ VDX ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በJava ውስጥ ባለው የVDX ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "VDX ገጾችን በJava ውስጥ ይቀያይሩ"
description: "VDX ገጾችን በጥቂት የJava ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "VDX የፋይል ገጾችን በJava ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በVDX ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX የፋይል ገጾችን Java ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የVDX ፋይል ገጾችን ይቀይሩ
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የVDX ፋይል ገጾችን በመስመር ላይ ይቀያይሩ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) ድር ጣቢያን በመጎብኘት የVDX ፋይል ገጾችን አሁኑኑ ይቀይሩ።
