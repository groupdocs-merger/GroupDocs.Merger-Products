...
############################# Head ############################
head_title: "Skiptu og skiptu á TEX síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í TEX skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um TEX síður í Java"
description: "Skiptu um TEX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um TEX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan TEX skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um TEX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Skiptu um TEX skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu um TEX skráarsíður á netinu"
    content: |
       Skiptu um TEX skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
