...
############################# Head ############################
head_title: "Tukar & Tukar XLSB Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSB dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSB Halaman Dalam Java"
description: "Tukar XLSB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLSB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLSB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLSB halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLSB Halaman Fail Dalam Talian"
    content: |
       Tukar XLSB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
