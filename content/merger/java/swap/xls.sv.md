...
############################# Head ############################
head_title: "Byt och byt ut XLS sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en XLS-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLS sidor i Java"
description: "Byt XLS-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt XLS filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en XLS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLS filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt XLS filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut XLS filsidor online"
    content: |
       Byt XLS filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
