...
############################# Head ############################
head_title: "Tukar & Tukar XLAM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLAM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLAM Halaman Dalam Java"
description: "Tukar XLAM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLAM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLAM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLAM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLAM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLAM Halaman Fail Dalam Talian"
    content: |
       Tukar XLAM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
