...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOCM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOCM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOCM puslapius Java"
description: "Pakeiskite DOCM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOCM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais DOCM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOCM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite DOCM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite DOCM failų puslapiais internete"
    content: |
       Apkeiskite DOCM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm) svetainėje.
