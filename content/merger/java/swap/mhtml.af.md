...
############################# Head ############################
head_title: "Ruil en ruil MHTML bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n MHTML-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil MHTML bladsye in Java"
description: "Ruil MHTML Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil MHTML lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n MHTML-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHTML lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil MHTML lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil MHTML lêerbladsye aanlyn"
    content: |
       Ruil nou MHTML lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml) webwerf te besoek.
