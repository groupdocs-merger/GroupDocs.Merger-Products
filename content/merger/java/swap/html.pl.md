...
############################# Head ############################
head_title: "Zamień i zamień HTML strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku HTML w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień HTML strony w Java"
description: "Zamień strony HTML na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików HTML w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku HTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku HTML przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików HTML za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień HTML strony plików online"
    content: |
       Zamień strony plików HTML już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
