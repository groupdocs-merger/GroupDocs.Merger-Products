...
############################# Head ############################
head_title: "Cserélj és cserélj OTT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy OTT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTT oldal cseréje a Java nyelven"
description: "Cserélje ki az OTT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "OTT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy OTT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk OTT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az OTT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – OTT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) webhely meglátogatásával azonnal cseréljen OTT fájloldalt.
