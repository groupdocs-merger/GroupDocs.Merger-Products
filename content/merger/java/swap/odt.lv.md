...
############################# Head ############################
head_title: "Apmainīt un apmainīt ODT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ODT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ODT lapas programmā Java"
description: "Apmainiet ODT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ODT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām ODT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ODT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet ODT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt ODT failu lapas tiešsaistē"
    content: |
       Apmainiet ODT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
