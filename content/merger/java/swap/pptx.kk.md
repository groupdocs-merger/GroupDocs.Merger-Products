...
############################# Head ############################
head_title: "Java ішіндегі PPTX беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы PPTX файлындағы екі беттің орнын Java арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "PPTX беттерді Java арқылы ауыстыру"
description: "PPTX беттерді Java кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі PPTX файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы PPTX файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX файл беттерін Java мысал коды арқылы ауыстыру жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы PPTX файл бетін ауыстырыңыз
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - PPTX файл беттерін онлайн ауыстырыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx) веб-сайтына кіру арқылы PPTX файл бетін дәл қазір ауыстырыңыз.
