...
############################# Head ############################
head_title: "Canvia i intercanvia VSDX pàgines a Java"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer VSDX a Java mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia VSDX pàgines a Java"
description: "Canvia les pàgines VSDX amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers VSDX a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java intercanviïn pàgines dins d'un fitxer VSDX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers VSDX utilitzant el codi d'exemple Java">}}
