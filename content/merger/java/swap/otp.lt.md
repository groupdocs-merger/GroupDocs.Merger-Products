...
############################# Head ############################
head_title: "Sukeiskite ir keiskite OTP puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas OTP faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti OTP puslapius Java"
description: "Pakeiskite OTP puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti OTP failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais OTP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti OTP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite OTP failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite OTP failų puslapiais internete"
    content: |
       Apkeiskite OTP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp) svetainėje.
