...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPT stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPT v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPT stránky v Java"
description: "Vyměňte PPT stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte PPT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru PPT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPT pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru PPT pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte PPT stránky souborů online"
    content: |
       Vyměňte stránky souborů PPT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
