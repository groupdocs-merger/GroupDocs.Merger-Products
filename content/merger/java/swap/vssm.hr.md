...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSSM stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSSM datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSSM stranice u Java"
description: "Zamijenite VSSM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSSM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar VSSM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSSM stranice datoteke koristeći Java primjer koda">}}
