...
############################# Head ############################
head_title: "Échangez et échangez PPSX pages en Java"
head_description: "Échangez et échangez des positions de deux pages dans un fichier PPSX en Java à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Échangez PPSX pages dans Java"
description: "Échangez PPSX pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Échangez PPSX pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java d'échanger facilement des pages dans un fichier PPSX en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment échanger des pages de fichiers PPSX à l'aide de l'exemple de code Java">}}
