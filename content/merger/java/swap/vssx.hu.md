...
############################# Head ############################
head_title: "Cserélj és cserélj VSSX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSSX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSX oldal cseréje a Java nyelven"
description: "Cserélje ki az VSSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSSX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSSX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSSX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSSX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx) webhely meglátogatásával azonnal cseréljen VSSX fájloldalt.
