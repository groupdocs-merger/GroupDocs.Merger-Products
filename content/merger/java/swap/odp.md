...
head_description: "Swap & Exchange positions of two pages within a ODP file in Java using the documents merger API."

############################# Header ############################
title: "Swap ODP Pages In Java"
description: "Swap ODP Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a ODP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ODP file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap ODP file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) website.
