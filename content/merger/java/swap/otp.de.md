...
############################# Head ############################
head_title: "Tausche & tausche OTP Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer OTP-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche OTP Seiten in Java"
description: "Tauschen Sie OTP-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "OTP Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer OTP-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie OTP-Dateiseiten mit Java-Beispielcode aus">}}

        ```java    
        // Tauschen Sie OTP Dateiseiten mit der GroupDocs.Merger API aus
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-Demos - Tauschen Sie OTP Dateiseiten online aus"
    content: |
       Tauschen Sie jetzt OTP Dateiseiten aus, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp) besuchen.
