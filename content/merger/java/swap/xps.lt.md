...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XPS puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XPS faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XPS puslapius Java"
description: "Pakeiskite XPS puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XPS failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XPS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XPS failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XPS failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XPS failų puslapiais internete"
    content: |
       Apkeiskite XPS failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) svetainėje.
