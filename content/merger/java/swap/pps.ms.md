...
############################# Head ############################
head_title: "Tukar & Tukar PPS Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPS dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPS Halaman Dalam Java"
description: "Tukar PPS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar PPS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail PPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar PPS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPS Halaman Fail Dalam Talian"
    content: |
       Tukar PPS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps).
