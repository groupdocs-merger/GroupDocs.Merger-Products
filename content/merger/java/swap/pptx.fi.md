...
############################# Head ############################
head_title: "Vaihda ja vaihda PPTX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPTX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPTX sivua Java"
description: "Vaihda PPTX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja PPTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPTX tiedostosivua käyttämällä Java esimerkkikoodia">}}
