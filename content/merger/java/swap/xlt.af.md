...
############################# Head ############################
head_title: "Ruil en ruil XLT bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLT-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLT bladsye in Java"
description: "Ruil XLT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil XLT lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLT-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil XLT lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil XLT lêerbladsye aanlyn"
    content: |
       Ruil nou XLT lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt) webwerf te besoek.
