...
############################# Head ############################
head_title: "Byt og byt PDF sider i Java"
head_description: "Byt og udveksle positioner på to sider i en PDF-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PDF sider i Java"
description: "Byt PDF sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt PDF filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en PDF-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PDF filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift PDF filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt PDF filsider online"
    content: |
       Skift PDF filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
