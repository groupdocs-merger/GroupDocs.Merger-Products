...
############################# Head ############################
head_title: "Поменяйте местами OTT страницы на Java"
head_description: "Поменяйте местами и обменяйте позиции двух страниц в файле OTT на Java, используя Merger API."

############################# Header ############################
title: "Поменять местами OTT страницы на Java"
description: "Поменять местами OTT страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Поменять местами страницы OTT документов на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) позволяет разработчикам Java обмениваться страницами в файле OTT, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как поменять местами страницы OTT документов, используя пример кода Java">}}

        ```java    
        // Поменять местами страницы OTT документов с помощью GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Живые демонстрации — замена страницы OTT документов онлайн"
    content: |
       Поменяйте местами страницы OTT документов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/splitter/swap-pages/ott).
