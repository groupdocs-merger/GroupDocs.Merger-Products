...
############################# Head ############################
head_title: "Zamień i zamień DOTX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOTX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOTX strony w Java"
description: "Zamień strony DOTX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOTX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOTX strony plików online"
    content: |
       Zamień strony plików DOTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
