...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSTM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSTM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSTM stránky v Java"
description: "Vyměňte VSTM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSTM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSTM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSTM stránky souborů online"
    content: |
       Vyměňte stránky souborů VSTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
