...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOT stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOT v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOT stránky v Java"
description: "Vyměňte DOT stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOT pomocí ukázkového kódu Java">}}
