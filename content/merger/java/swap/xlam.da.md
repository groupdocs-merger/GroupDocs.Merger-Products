...
############################# Head ############################
head_title: "Byt og byt XLAM sider i Java"
head_description: "Byt og udveksle positioner på to sider i en XLAM-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLAM sider i Java"
description: "Byt XLAM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt XLAM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en XLAM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLAM filsider ved hjælp af Java eksempelkode">}}
