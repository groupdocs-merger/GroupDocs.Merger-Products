...
############################# Head ############################
head_title: "Apmainīt un apmainīt ODS lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ODS failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ODS lapas programmā Java"
description: "Apmainiet ODS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ODS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām ODS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ODS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet ODS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt ODS failu lapas tiešsaistē"
    content: |
       Apmainiet ODS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods).
