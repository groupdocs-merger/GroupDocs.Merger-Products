...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj PDF strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke PDF v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj PDF strani v Java"
description: "Zamenjajte strani PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke PDF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki PDF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke PDF s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke PDF z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte PDF strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke PDF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
