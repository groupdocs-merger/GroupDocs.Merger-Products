...
############################# Head ############################
head_title: "Zamień i zamień VSDX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSDX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSDX strony w Java"
description: "Zamień strony VSDX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSDX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSDX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSDX przy użyciu przykładowego kodu Java">}}
