...
############################# Head ############################
head_title: "Tukar & Tukar MHTML Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail MHTML dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHTML Halaman Dalam Java"
description: "Tukar MHTML Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar MHTML Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail MHTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar MHTML halaman fail menggunakan kod contoh Java.">}}
