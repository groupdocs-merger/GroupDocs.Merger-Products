...
############################# Head ############################
head_title: "VSDM Sayfalarını Java İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSDM dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "VSDM Sayfayı Java İçinde Değiştir"
description: "VSDM Sayfalarını birkaç satır Java koduyla değiştirin."
...
steps:
    enable: true
    title_left: "Java içindeki VSDM Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSDM dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSDM dosya sayfaları nasıl değiştirilir?">}}
