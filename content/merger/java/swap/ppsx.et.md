...
############################# Head ############################
head_title: "Vahetage ja vahetage PPSX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPSX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPSX lehte keeles Java"
description: "Vahetage PPSX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis PPSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili PPSX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus PPSX faililehte"
    content: |
       Vahetage kohe PPSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
