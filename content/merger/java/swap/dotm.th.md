...
############################# Head ############################
head_title: "สลับและแลกเปลี่ยนหน้า DOTM ใน Java"
head_description: "สลับและแลกเปลี่ยนตำแหน่งสองหน้าภายในไฟล์ DOTM ใน Java โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "สลับ DOTM หน้าใน Java"
description: "สลับ DOTM หน้าด้วยโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "สลับหน้าไฟล์ DOTM ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ทำให้นักพัฒนา Java สามารถสลับหน้าภายในไฟล์ DOTM ได้โดยง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน .
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีสลับหน้าไฟล์ DOTM โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // สลับหน้าไฟล์ DOTM โดยใช้ GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "การสาธิตสด - สลับหน้าไฟล์ DOTM ออนไลน์"
    content: |
       สลับหน้าไฟล์ DOTM ทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm)
