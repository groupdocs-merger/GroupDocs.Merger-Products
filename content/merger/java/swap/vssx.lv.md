...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSSX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSSX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSSX lapas programmā Java"
description: "Apmainiet VSSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSSX failu lapas tiešsaistē"
    content: |
       Apmainiet VSSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx).
