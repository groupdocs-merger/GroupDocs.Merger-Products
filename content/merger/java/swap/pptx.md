...
head_description: "Swap & Exchange positions of two pages within a PPTX file in Java using the documents merger API."

############################# Header ############################
title: "Swap PPTX Pages In Java"
description: "Swap PPTX Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a PPTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PPTX file pages using Java example code">}}
