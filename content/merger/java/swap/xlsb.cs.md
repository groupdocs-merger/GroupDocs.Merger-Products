...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLSB stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLSB v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLSB stránky v Java"
description: "Vyměňte XLSB stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLSB stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLSB provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLSB pomocí ukázkového kódu Java">}}
