...
############################# Head ############################
head_title: "Tukar & Tukarkan DOCM Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOCM di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCM Halaman Di Java"
description: "Tukar DOCM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar DOCM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file DOCM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOCM menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file DOCM menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOCM Halaman File Online"
    content: |
       Tukar halaman file DOCM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/docm).
