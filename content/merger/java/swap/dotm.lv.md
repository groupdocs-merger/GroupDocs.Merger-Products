...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOTM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOTM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOTM lapas programmā Java"
description: "Apmainiet DOTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOTM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOTM failu lapas tiešsaistē"
    content: |
       Apmainiet DOTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
