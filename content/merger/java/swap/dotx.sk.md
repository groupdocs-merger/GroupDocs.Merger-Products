...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOTX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOTX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOTX stránky v Java"
description: "Vymeňte DOTX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOTX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte DOTX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte DOTX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi DOTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
