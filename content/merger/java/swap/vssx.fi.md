...
############################# Head ############################
head_title: "Vaihda ja vaihda VSSX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSSX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSSX sivua Java"
description: "Vaihda VSSX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSSX tiedostosivua verkossa"
    content: |
       Vaihda VSSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx) -sivustolla.
