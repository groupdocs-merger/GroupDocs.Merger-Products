...
############################# Head ############################
head_title: "Zamień i zamień MHT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku MHT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień MHT strony w Java"
description: "Zamień strony MHT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików MHT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku MHT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku MHT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików MHT za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień MHT strony plików online"
    content: |
       Zamień strony plików MHT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
