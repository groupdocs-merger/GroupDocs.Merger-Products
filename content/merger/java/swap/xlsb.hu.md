...
############################# Head ############################
head_title: "Cserélj és cserélj XLSB oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSB fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSB oldal cseréje a Java nyelven"
description: "Cserélje ki az XLSB oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSB fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLSB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSB fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XLSB fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLSB fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb) webhely meglátogatásával azonnal cseréljen XLSB fájloldalt.
