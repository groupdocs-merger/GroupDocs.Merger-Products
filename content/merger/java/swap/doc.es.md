...
############################# Head ############################
head_title: "Intercambiar e intercambiar DOC páginas en Java"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo DOC en Java utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar DOC páginas en Java"
description: "Intercambie DOC páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Intercambiar DOC páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java intercambiar páginas dentro de un archivo DOC mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos DOC usando el código de ejemplo Java">}}
