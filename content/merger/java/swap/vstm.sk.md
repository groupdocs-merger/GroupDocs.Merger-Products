...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSTM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSTM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSTM stránky v Java"
description: "Vymeňte VSTM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSTM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSTM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSTM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSTM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSTM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
