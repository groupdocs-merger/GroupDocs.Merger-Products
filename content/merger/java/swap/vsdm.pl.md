...
############################# Head ############################
head_title: "Zamień i zamień VSDM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSDM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSDM strony w Java"
description: "Zamień strony VSDM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSDM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSDM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSDM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VSDM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VSDM strony plików online"
    content: |
       Zamień strony plików VSDM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
