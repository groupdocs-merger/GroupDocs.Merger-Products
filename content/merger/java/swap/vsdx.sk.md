...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSDX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSDX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSDX stránky v Java"
description: "Vymeňte VSDX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSDX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSDX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSDX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSDX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSDX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSDX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
