...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ONE puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ONE faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ONE puslapius Java"
description: "Pakeiskite ONE puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ONE failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais ONE faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ONE failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite ONE failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite ONE failų puslapiais internete"
    content: |
       Apkeiskite ONE failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) svetainėje.
