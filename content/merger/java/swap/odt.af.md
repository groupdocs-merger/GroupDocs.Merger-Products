...
############################# Head ############################
head_title: "Ruil en ruil ODT bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n ODT-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil ODT bladsye in Java"
description: "Ruil ODT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil ODT lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n ODT-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODT lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}
