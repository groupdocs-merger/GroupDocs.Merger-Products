...
############################# Head ############################
head_title: "Tukar & Tukar VDX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VDX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VDX Halaman Dalam Java"
description: "Tukar VDX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VDX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VDX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VDX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VDX Halaman Fail Dalam Talian"
    content: |
       Tukar VDX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
