...
############################# Head ############################
head_title: "Vahetage ja vahetage DOTM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOTM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOTM lehte keeles Java"
description: "Vahetage DOTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis DOTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili DOTM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus DOTM faililehte"
    content: |
       Vahetage kohe DOTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
