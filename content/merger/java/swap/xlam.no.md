...
############################# Head ############################
head_title: "Bytt og bytt ut XLAM sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLAM-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLAM sider i Java"
description: "Bytt XLAM-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt XLAM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en XLAM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLAM filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt XLAM filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut XLAM filsider på nettet"
    content: |
       Bytt ut XLAM-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
