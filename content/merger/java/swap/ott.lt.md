...
############################# Head ############################
head_title: "Sukeiskite ir keiskite OTT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas OTT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti OTT puslapius Java"
description: "Pakeiskite OTT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti OTT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais OTT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti OTT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite OTT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite OTT failų puslapiais internete"
    content: |
       Apkeiskite OTT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) svetainėje.
