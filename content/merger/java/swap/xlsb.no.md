...
############################# Head ############################
head_title: "Bytt og bytt ut XLSB sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLSB-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLSB sider i Java"
description: "Bytt XLSB-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt XLSB filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en XLSB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLSB filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt XLSB filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut XLSB filsider på nettet"
    content: |
       Bytt ut XLSB-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
