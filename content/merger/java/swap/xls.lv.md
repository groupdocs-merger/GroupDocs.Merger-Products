...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLS lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLS failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLS lapas programmā Java"
description: "Apmainiet XLS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLS failu lapas tiešsaistē"
    content: |
       Apmainiet XLS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
