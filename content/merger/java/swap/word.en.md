...
############################# Head ############################
head_title: "Swap pages in WORD files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in WORD documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap WORD pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in WORD files to streamline content structure."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in WORD documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
      
      1. Define the path to the WORD file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a WORD file"
      content: |
        This example demonstrates how to swap pages in a WORD file with just a few simple steps.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
