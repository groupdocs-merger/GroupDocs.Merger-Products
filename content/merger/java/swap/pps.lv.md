...
############################# Head ############################
head_title: "Apmainīt un apmainīt PPS lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas PPS failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt PPS lapas programmā Java"
description: "Apmainiet PPS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt PPS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām PPS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt PPS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet PPS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt PPS failu lapas tiešsaistē"
    content: |
       Apmainiet PPS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps).
