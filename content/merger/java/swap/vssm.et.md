...
############################# Head ############################
head_title: "Vahetage ja vahetage VSSM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSSM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSSM lehte keeles Java"
description: "Vahetage VSSM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSSM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VSSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSSM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VSSM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VSSM faililehte"
    content: |
       Vahetage kohe VSSM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
