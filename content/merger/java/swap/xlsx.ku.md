...
############################# Head ############################
head_title: "Biguherîne û biguherîne XLSX Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek XLSX de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne XLSX Rûpelên Di Java de"
description: "Rûpelên XLSX bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de XLSX Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek XLSX de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên XLSX bi karanîna koda nimûneya Java veguhezîne">}}

        ```java    
        // Rûpelên pelan ên XLSX bi karanîna GroupDocs.Merger API-ê biguherînin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demokên Zindî - Biguherîne XLSX Rûpelên Serhêl"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) niha rûpelên pelê yên XLSX biguherînin.
