...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOC stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOC datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOC stranice u Java"
description: "Zamijenite DOC stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOC stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar DOC datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOC stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite DOC stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite DOC stranice datoteka na mreži"
    content: |
       Odmah zamijenite DOC stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc) web mjesto.
