...
############################# Head ############################
head_title: "Sukeiskite ir keiskite RTF puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas RTF faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti RTF puslapius Java"
description: "Pakeiskite RTF puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti RTF failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais RTF faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti RTF failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite RTF failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite RTF failų puslapiais internete"
    content: |
       Apkeiskite RTF failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf) svetainėje.
