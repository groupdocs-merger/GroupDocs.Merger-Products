...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLS puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLS faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLS puslapius Java"
description: "Pakeiskite XLS puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLS failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLS failo puslapius naudojant Java pavyzdinį kodą">}}
