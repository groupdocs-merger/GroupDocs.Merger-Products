...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSSM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSSM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSSM stránky v Java"
description: "Vymeňte VSSM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSSM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSSM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSSM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSSM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSSM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSSM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
