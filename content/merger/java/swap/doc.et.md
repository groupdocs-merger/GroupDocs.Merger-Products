...
############################# Head ############################
head_title: "Vahetage ja vahetage DOC lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOC failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOC lehte keeles Java"
description: "Vahetage DOC lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOC faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis DOC, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOC faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili DOC lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus DOC faililehte"
    content: |
       Vahetage kohe DOC faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
