...
############################# Head ############################
head_title: "Vymeňte a vymeňte PPT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PPT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PPT stránky v Java"
description: "Vymeňte PPT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte PPT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru PPT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PPT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte PPT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte PPT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi PPT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
