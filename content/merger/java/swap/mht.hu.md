...
############################# Head ############################
head_title: "Cserélj és cserélj MHT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy MHT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHT oldal cseréje a Java nyelven"
description: "Cserélje ki az MHT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "MHT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy MHT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk MHT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az MHT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – MHT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht) webhely meglátogatásával azonnal cseréljen MHT fájloldalt.
