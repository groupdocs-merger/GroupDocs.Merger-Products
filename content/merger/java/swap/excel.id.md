...
############################# Head ############################
head_title: "Tukar & Tukarkan EXCEL Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file EXCEL di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EXCEL Halaman Di Java"
description: "Tukar EXCEL Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar EXCEL Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file EXCEL dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file EXCEL menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file EXCEL menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar EXCEL Halaman File Online"
    content: |
       Tukar halaman file EXCEL sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/excel).
