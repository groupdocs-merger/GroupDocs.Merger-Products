...
############################# Head ############################
head_title: "Tukar & Tukarkan RTF Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file RTF di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar RTF Halaman Di Java"
description: "Tukar RTF Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar RTF Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file RTF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file RTF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar RTF Halaman File Online"
    content: |
       Tukar halaman file RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/rtf).
