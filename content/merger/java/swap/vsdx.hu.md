...
############################# Head ############################
head_title: "Cserélj és cserélj VSDX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSDX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDX oldal cseréje a Java nyelven"
description: "Cserélje ki az VSDX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSDX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSDX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSDX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSDX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSDX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) webhely meglátogatásával azonnal cseréljen VSDX fájloldalt.
