...
############################# Head ############################
head_title: "Zamijeni i razmijeni RTF stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar RTF datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni RTF stranice u Java"
description: "Zamijenite RTF stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni RTF stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar RTF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti RTF stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite RTF stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite RTF stranice datoteka na mreži"
    content: |
       Odmah zamijenite RTF stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf) web mjesto.
