...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj DOC strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke DOC v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj DOC strani v Java"
description: "Zamenjajte strani DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke DOC v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki DOC z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke DOC s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke DOC z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte DOC strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke DOC tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
