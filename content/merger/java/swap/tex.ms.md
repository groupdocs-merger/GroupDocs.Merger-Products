...
############################# Head ############################
head_title: "Tukar & Tukar TEX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail TEX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar TEX Halaman Dalam Java"
description: "Tukar TEX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar TEX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail TEX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar TEX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar TEX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar TEX Halaman Fail Dalam Talian"
    content: |
       Tukar TEX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
