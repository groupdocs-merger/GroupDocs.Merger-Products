...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj MHTML strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke MHTML v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj MHTML strani v Java"
description: "Zamenjajte strani MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki MHTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke MHTML s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke MHTML z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte MHTML strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke MHTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
