...
############################# Head ############################
head_title: "Zamijeni i razmijeni PPTX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PPTX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PPTX stranice u Java"
description: "Zamijenite PPTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni PPTX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar PPTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PPTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite PPTX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite PPTX stranice datoteka na mreži"
    content: |
       Odmah zamijenite PPTX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx) web mjesto.
