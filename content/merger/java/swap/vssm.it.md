...
############################# Head ############################
head_title: "Scambia e scambia VSSM pagine in Java"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file VSSM in Java utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia VSSM pagine in Java"
description: "Scambia le pagine VSSM con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Scambia VSSM pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di scambiare facilmente le pagine all'interno di un file VSSM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file VSSM utilizzando il codice di esempio Java">}}

        ```java    
        // Scambia le pagine dei file VSSM utilizzando l'API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Scambia VSSM pagine di file online"
    content: |
       Scambia subito le pagine dei file VSSM visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
