...
############################# Head ############################
head_title: "Sukeiskite ir keiskite MHT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas MHT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti MHT puslapius Java"
description: "Pakeiskite MHT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti MHT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais MHT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti MHT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite MHT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite MHT failų puslapiais internete"
    content: |
       Apkeiskite MHT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht) svetainėje.
