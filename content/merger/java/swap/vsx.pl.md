...
############################# Head ############################
head_title: "Zamień i zamień VSX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSX strony w Java"
description: "Zamień strony VSX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VSX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VSX strony plików online"
    content: |
       Zamień strony plików VSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx).
