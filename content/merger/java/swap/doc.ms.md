...
############################# Head ############################
head_title: "Tukar & Tukar DOC Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOC dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOC Halaman Dalam Java"
description: "Tukar DOC Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOC Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOC dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOC halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar DOC halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOC Halaman Fail Dalam Talian"
    content: |
       Tukar DOC halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
