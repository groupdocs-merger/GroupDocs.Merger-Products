...
############################# Head ############################
head_title: "Tukar & Tukar XLTM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLTM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTM Halaman Dalam Java"
description: "Tukar XLTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLTM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLTM Halaman Fail Dalam Talian"
    content: |
       Tukar XLTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
