...
############################# Head ############################
head_title: "Babhtáil & Malartú TEX Leathanaigh i Java"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad TEX in Java ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil TEX Leathanaigh i Java"
description: "Malartú TEX Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Babhtáil TEX Leathanaigh Chomhaid i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a mhalartú laistigh de chomhad TEX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid TEX a mhalartú le cód samplach Java">}}

        ```java    
        // Babhtáil leathanaigh comhad TEX ag baint úsáide as GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Taispeántais Bheo - Malartú TEX Leathanaigh Chomhad Ar Líne"
    content: |
       Babhtáil TEX leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
