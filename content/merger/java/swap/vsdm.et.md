...
############################# Head ############################
head_title: "Vahetage ja vahetage VSDM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSDM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSDM lehte keeles Java"
description: "Vahetage VSDM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSDM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VSDM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSDM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VSDM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VSDM faililehte"
    content: |
       Vahetage kohe VSDM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
