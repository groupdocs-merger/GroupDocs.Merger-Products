...
############################# Head ############################
head_title: "Vahetage ja vahetage VTX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VTX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VTX lehte keeles Java"
description: "Vahetage VTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VTX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VTX faililehte"
    content: |
       Vahetage kohe VTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
