...
############################# Head ############################
head_title: "Vymeňte a vymeňte MHTML stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore MHTML v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte MHTML stránky v Java"
description: "Vymeňte MHTML stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte MHTML strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru MHTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru MHTML pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte MHTML stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte MHTML stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi MHTML hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
