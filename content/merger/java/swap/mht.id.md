...
############################# Head ############################
head_title: "Tukar & Tukarkan MHT Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file MHT di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHT Halaman Di Java"
description: "Tukar MHT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar MHT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file MHT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file MHT menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file MHT menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar MHT Halaman File Online"
    content: |
       Tukar halaman file MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/mht).
