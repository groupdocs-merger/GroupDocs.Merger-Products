...
############################# Head ############################
head_title: "Vaihda ja vaihda ODS sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ODS-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ODS sivua Java"
description: "Vaihda ODS-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ODS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja ODS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ODS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda ODS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda ODS tiedostosivua verkossa"
    content: |
       Vaihda ODS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) -sivustolla.
