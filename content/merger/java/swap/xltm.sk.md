...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLTM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLTM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLTM stránky v Java"
description: "Vymeňte XLTM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLTM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLTM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLTM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLTM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLTM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
