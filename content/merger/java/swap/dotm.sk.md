...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOTM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOTM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOTM stránky v Java"
description: "Vymeňte DOTM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOTM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOTM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte DOTM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte DOTM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi DOTM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
