...
############################# Head ############################
head_title: "Cserélj és cserélj VSTX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSTX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTX oldal cseréje a Java nyelven"
description: "Cserélje ki az VSTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSTX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSTX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSTX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx) webhely meglátogatásával azonnal cseréljen VSTX fájloldalt.
