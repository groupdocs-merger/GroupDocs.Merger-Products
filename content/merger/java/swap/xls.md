...
head_description: "Swap & Exchange positions of two pages within a XLS file in Java using the documents merger API."

############################# Header ############################
title: "Swap XLS Pages In Java"
description: "Swap XLS Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a XLS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XLS file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap XLS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls) website.
