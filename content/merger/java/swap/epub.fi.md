...
############################# Head ############################
head_title: "Vaihda ja vaihda EPUB sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja EPUB-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda EPUB sivua Java"
description: "Vaihda EPUB-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda EPUB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja EPUB-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa EPUB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda EPUB tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda EPUB tiedostosivua verkossa"
    content: |
       Vaihda EPUB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub) -sivustolla.
