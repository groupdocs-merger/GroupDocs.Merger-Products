...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VTX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VTX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VTX puslapius Java"
description: "Pakeiskite VTX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VTX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VTX failų puslapiais internete"
    content: |
       Apkeiskite VTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx) svetainėje.
