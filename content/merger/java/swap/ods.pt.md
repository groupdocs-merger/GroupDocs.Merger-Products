...
############################# Head ############################
head_title: "Troque e troque ODS páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo ODS em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar ODS Páginas em Java"
description: "Troque ODS Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo ODS em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo ODS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo ODS usando o código de exemplo Java">}}
