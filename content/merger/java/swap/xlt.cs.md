...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLT stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLT v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLT stránky v Java"
description: "Vyměňte XLT stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLT pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLT pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLT stránky souborů online"
    content: |
       Vyměňte stránky souborů XLT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt).
