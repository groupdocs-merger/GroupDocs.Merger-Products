...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSTX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSTX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSTX stránky v Java"
description: "Vyměňte VSTX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSTX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSTX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSTX stránky souborů online"
    content: |
       Vyměňte stránky souborů VSTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx).
