...
############################# Head ############################
head_title: "Vyměňte a vyměňte RTF stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru RTF v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit RTF stránky v Java"
description: "Vyměňte RTF stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte RTF stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru RTF provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru RTF pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru RTF pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte RTF stránky souborů online"
    content: |
       Vyměňte stránky souborů RTF hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
