...
############################# Head ############################
head_title: "Ruil en ruil PPSX pagina's in Java"
head_description: "Wissel en ruil posities van twee pagina's binnen een PPSX bestand in Java met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel PPSX pagina's in Java"
description: "Verwissel PPSX pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwissel PPSX Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een PPSX bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPSX bestandspagina's te wisselen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verwissel PPSX bestandspagina's met de GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live demo's - Verwissel PPSX bestandspagina's online"
    content: |
       Ruil PPSX bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx) te gaan.
