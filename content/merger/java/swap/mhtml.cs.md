...
############################# Head ############################
head_title: "Vyměňte a vyměňte MHTML stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru MHTML v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit MHTML stránky v Java"
description: "Vyměňte MHTML stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte MHTML stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru MHTML provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru MHTML pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru MHTML pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte MHTML stránky souborů online"
    content: |
       Vyměňte stránky souborů MHTML hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
