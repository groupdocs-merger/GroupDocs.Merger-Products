...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOC puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOC faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOC puslapius Java"
description: "Pakeiskite DOC puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOC failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais DOC faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOC failo puslapius naudojant Java pavyzdinį kodą">}}
