...
############################# Head ############################
head_title: "Zamień i zamień XPS strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XPS w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XPS strony w Java"
description: "Zamień strony XPS na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XPS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XPS przy użyciu przykładowego kodu Java">}}
