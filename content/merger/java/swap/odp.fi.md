...
############################# Head ############################
head_title: "Vaihda ja vaihda ODP sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ODP-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ODP sivua Java"
description: "Vaihda ODP-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ODP tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja ODP-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ODP tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda ODP tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda ODP tiedostosivua verkossa"
    content: |
       Vaihda ODP tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) -sivustolla.
