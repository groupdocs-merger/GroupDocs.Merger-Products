...
############################# Head ############################
head_title: "Vaihda ja vaihda PPT sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPT-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPT sivua Java"
description: "Vaihda PPT-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja PPT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda PPT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda PPT tiedostosivua verkossa"
    content: |
       Vaihda PPT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt) -sivustolla.
