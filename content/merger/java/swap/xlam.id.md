...
############################# Head ############################
head_title: "Tukar & Tukarkan XLAM Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLAM di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLAM Halaman Di Java"
description: "Tukar XLAM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLAM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLAM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLAM menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file XLAM menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLAM Halaman File Online"
    content: |
       Tukar halaman file XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xlam).
