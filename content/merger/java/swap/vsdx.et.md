...
############################# Head ############################
head_title: "Vahetage ja vahetage VSDX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSDX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSDX lehte keeles Java"
description: "Vahetage VSDX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSDX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VSDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSDX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VSDX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VSDX faililehte"
    content: |
       Vahetage kohe VSDX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
