...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOTX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOTX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOTX stranice u Java"
description: "Zamijenite DOTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOTX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar DOTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite DOTX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite DOTX stranice datoteka na mreži"
    content: |
       Odmah zamijenite DOTX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx) web mjesto.
