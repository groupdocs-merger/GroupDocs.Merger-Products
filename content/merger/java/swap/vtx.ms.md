...
############################# Head ############################
head_title: "Tukar & Tukar VTX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VTX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VTX Halaman Dalam Java"
description: "Tukar VTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VTX Halaman Fail Dalam Talian"
    content: |
       Tukar VTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
