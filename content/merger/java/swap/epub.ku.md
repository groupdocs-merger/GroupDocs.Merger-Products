...
############################# Head ############################
head_title: "Biguherîne û biguherîne EPUB Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek EPUB de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne EPUB Rûpelên Di Java de"
description: "Rûpelên EPUB bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de EPUB Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên EPUB bi karanîna koda nimûneya Java veguhezîne">}}
