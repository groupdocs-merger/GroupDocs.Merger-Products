...
############################# Head ############################
head_title: "Ruil en ruil VDX pagina's in Java"
head_description: "Wissel en ruil posities van twee pagina's binnen een VDX bestand in Java met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel VDX pagina's in Java"
description: "Verwissel VDX pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwissel VDX Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een VDX bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VDX bestandspagina's te wisselen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verwissel VDX bestandspagina's met de GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live demo's - Verwissel VDX bestandspagina's online"
    content: |
       Ruil VDX bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) te gaan.
