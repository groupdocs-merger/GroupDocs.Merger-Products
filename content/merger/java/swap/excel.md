...
############################# Head ############################
head_title: "Swap & Exchange EXCEL Pages in Java"
head_description: "Java users to swap & exchange positions of two pages within a EXCEL file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange EXCEL Pages in Java"
description: "Swap & Exchange positions of two pages within a EXCEL file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap EXCEL File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a EXCEL file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within EXCEL files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/excel) website.
