...
############################# Head ############################
head_title: "Tukar & Tukarkan WORKSHEET Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file WORKSHEET di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar WORKSHEET Halaman Di Java"
description: "Tukar WORKSHEET Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar WORKSHEET Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file WORKSHEET dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file WORKSHEET menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file WORKSHEET menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar WORKSHEET Halaman File Online"
    content: |
       Tukar halaman file WORKSHEET sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/worksheet).
