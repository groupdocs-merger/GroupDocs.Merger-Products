...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել PPSX էջեր Java-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը PPSX ֆայլում Java-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք PPSX էջեր Java-ում"
description: "Փոխեք PPSX էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք PPSX ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java ծրագրավորողների համար էջերը փոխանակել PPSX ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել PPSX ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}
