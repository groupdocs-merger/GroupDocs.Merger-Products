...
############################# Head ############################
head_title: "Byt och byt ut HTML sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en HTML-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt HTML sidor i Java"
description: "Byt HTML-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt HTML filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en HTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter HTML filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt HTML filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut HTML filsidor online"
    content: |
       Byt HTML filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
