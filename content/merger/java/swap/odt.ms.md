...
############################# Head ############################
head_title: "Tukar & Tukar ODT Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODT dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODT Halaman Dalam Java"
description: "Tukar ODT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar ODT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail ODT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar ODT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ODT Halaman Fail Dalam Talian"
    content: |
       Tukar ODT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
