...
############################# Head ############################
head_title: "Intercambiar e intercambiar DOTM páginas en Java"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo DOTM en Java utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar DOTM páginas en Java"
description: "Intercambie DOTM páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Intercambiar DOTM páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java intercambiar páginas dentro de un archivo DOTM mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos DOTM usando el código de ejemplo Java">}}

        ```java    
        // Intercambiar DOTM páginas de archivos usando GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo: intercambie DOTM páginas de archivos en línea"
    content: |
       Cambie las páginas de archivos DOTM ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
