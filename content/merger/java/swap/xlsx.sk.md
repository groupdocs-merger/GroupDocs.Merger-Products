...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLSX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLSX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLSX stránky v Java"
description: "Vymeňte XLSX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLSX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLSX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLSX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLSX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx).
