...
############################# Head ############################
head_title: "Vahetage ja vahetage DOT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOT lehte keeles Java"
description: "Vahetage DOT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis DOT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili DOT lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus DOT faililehte"
    content: |
       Vahetage kohe DOT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot).
