...
draft: false
############################# Head ############################
head_title: "Подкачка и обмен страницами VSDM в Java"
head_description: "Пользователи Java могут менять местами две страницы в файле VSDM с помощью API слияния и разделения документов."
############################# Header ############################
title: "Подкачка и обмен страницами VSDM в Java"
description: "Обмен позициями двух страниц в файле VSDM с помощью API-интерфейса файлового разделителя для приложений Java и J2SE."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов VSDM в Java"
    content_left: |
        [GroupDocs.Merger](/ru/merger/java/) позволяет разработчикам Java легко обмениваться, обмениваться и упорядочивать страницы в файле VSDM, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Обменивайтесь страницами в файлах VSDM прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/vsdm). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
