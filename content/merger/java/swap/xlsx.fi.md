...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSX sivua Java"
description: "Vaihda XLSX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XLSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XLSX tiedostosivua verkossa"
    content: |
       Vaihda XLSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) -sivustolla.
