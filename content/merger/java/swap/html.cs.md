...
############################# Head ############################
head_title: "Vyměňte a vyměňte HTML stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru HTML v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit HTML stránky v Java"
description: "Vyměňte HTML stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte HTML stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru HTML provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru HTML pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru HTML pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte HTML stránky souborů online"
    content: |
       Vyměňte stránky souborů HTML hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
