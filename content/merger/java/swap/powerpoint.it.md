...
############################# Head ############################
head_title: "Scambia le pagine nei file POWERPOINT con le app Java"
head_description: "Utilizza GroupDocs.Merger for Java per riordinare le pagine nei documenti POWERPOINT. Modifica PDF, file Word, fogli di calcolo, presentazioni, diagrammi di Visio, immagini, archivi e altro ancora."

############################# Header ############################
title: "Scambia le pagine POWERPOINT" 
description: "GroupDocs.Merger for Java potenzia le applicazioni Java con funzionalità di manipolazione documentale flessibili. Riordina le pagine nei file POWERPOINT per ottimizzare la struttura del contenuto."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) semplifica il riordino delle pagine nei documenti POWERPOINT, fornendoti il pieno controllo sull'organizzazione del contenuto. Integra un'elaborazione documentale fluida nelle tue applicazioni Java.
      
      1. Definisci il percorso del file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Scambia la prima e l'ultima pagina in un file POWERPOINT"
      content: |
        Questo esempio dimostra come scambiare le pagine in un file POWERPOINT con solo pochi semplici passaggi.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
