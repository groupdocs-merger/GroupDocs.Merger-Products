...
############################# Head ############################
head_title: "Cserélj és cserélj VSSM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSSM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSM oldal cseréje a Java nyelven"
description: "Cserélje ki az VSSM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSSM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSSM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSSM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSSM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm) webhely meglátogatásával azonnal cseréljen VSSM fájloldalt.
