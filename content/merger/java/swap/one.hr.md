...
############################# Head ############################
head_title: "Zamijeni i razmijeni ONE stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar ONE datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni ONE stranice u Java"
description: "Zamijenite ONE stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni ONE stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar ONE datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti ONE stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite ONE stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite ONE stranice datoteka na mreži"
    content: |
       Odmah zamijenite ONE stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) web mjesto.
