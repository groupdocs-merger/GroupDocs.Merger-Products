...
############################# Head ############################
head_title: "Vaihda ja vaihda DOCX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOCX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOCX sivua Java"
description: "Vaihda DOCX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOCX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja DOCX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOCX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda DOCX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda DOCX tiedostosivua verkossa"
    content: |
       Vaihda DOCX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx) -sivustolla.
