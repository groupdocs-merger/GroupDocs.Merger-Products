...
############################# Head ############################
head_title: "Bytt og bytt ut OTT sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en OTT-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt OTT sider i Java"
description: "Bytt OTT-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt OTT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en OTT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte OTT filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt OTT filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut OTT filsider på nettet"
    content: |
       Bytt ut OTT-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
