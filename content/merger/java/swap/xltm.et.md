...
############################# Head ############################
head_title: "Vahetage ja vahetage XLTM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLTM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLTM lehte keeles Java"
description: "Vahetage XLTM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLTM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLTM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili XLTM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus XLTM faililehte"
    content: |
       Vahetage kohe XLTM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
