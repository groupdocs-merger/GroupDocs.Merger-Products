...
############################# Head ############################
head_title: "Swap pages in PDF files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in PDF documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap PDF pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in PDF files to streamline content structure."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in PDF documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
      
      1. Define the path to the PDF file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a PDF file"
      content: |
        This example demonstrates how to swap pages in a PDF file with just a few simple steps.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
