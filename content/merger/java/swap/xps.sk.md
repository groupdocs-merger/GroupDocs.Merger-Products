...
############################# Head ############################
head_title: "Vymeňte a vymeňte XPS stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XPS v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XPS stránky v Java"
description: "Vymeňte XPS stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XPS strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XPS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XPS pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XPS stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XPS stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XPS hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps).
