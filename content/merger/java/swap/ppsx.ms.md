...
############################# Head ############################
head_title: "Tukar & Tukar PPSX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPSX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPSX Halaman Dalam Java"
description: "Tukar PPSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar PPSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail PPSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar PPSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPSX Halaman Fail Dalam Talian"
    content: |
       Tukar PPSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
