...
############################# Head ############################
head_title: "Обмен ODT страниц в Java"
head_description: "Поменяйте местами и обменяйте позиции двух страниц в файле ODT в Java, используя API слияния документов."

############################# Header ############################
title: "Поменять местами ODT страниц в Java"
description: "Замените ODT страниц несколькими строками кода Java."
...
steps:
    enable: true
    title_left: "Поменять местами ODT файловых страниц в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как поменять местами ODT файловых страниц, используя пример кода Java">}}
...
more_formats:
    ...
    content: |
        Java API слияния и разделения документов для форматов файлов и изображений. Поменяйте местами некоторые популярные форматы файлов, как указано ниже.
