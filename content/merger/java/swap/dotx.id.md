...
############################# Head ############################
head_title: "Tukar & Tukarkan DOTX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOTX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTX Halaman Di Java"
description: "Tukar DOTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar DOTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file DOTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOTX Halaman File Online"
    content: |
       Tukar halaman file DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/dotx).
