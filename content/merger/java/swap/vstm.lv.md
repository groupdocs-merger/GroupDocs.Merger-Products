...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSTM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSTM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSTM lapas programmā Java"
description: "Apmainiet VSTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSTM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSTM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSTM failu lapas tiešsaistē"
    content: |
       Apmainiet VSTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
