...
############################# Head ############################
head_title: "Vyměňte a vyměňte PDF stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PDF v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PDF stránky v Java"
description: "Vyměňte PDF stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte PDF stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru PDF provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PDF pomocí ukázkového kódu Java">}}
