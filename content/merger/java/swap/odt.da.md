...
############################# Head ############################
head_title: "Byt og byt ODT sider i Java"
head_description: "Byt og udveksle positioner på to sider i en ODT-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt ODT sider i Java"
description: "Byt ODT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt ODT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en ODT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du ODT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift ODT filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt ODT filsider online"
    content: |
       Skift ODT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
