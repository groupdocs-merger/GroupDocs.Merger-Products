...
############################# Head ############################
head_title: "Byt och byt ut XLSB sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en XLSB-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLSB sidor i Java"
description: "Byt XLSB-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt XLSB filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en XLSB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLSB filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt XLSB filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut XLSB filsidor online"
    content: |
       Byt XLSB filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
