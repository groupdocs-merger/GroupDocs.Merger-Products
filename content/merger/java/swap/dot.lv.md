...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOT lapas programmā Java"
description: "Apmainiet DOT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOT failu lapas tiešsaistē"
    content: |
       Apmainiet DOT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot).
