...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLT stránky v Java"
description: "Vymeňte XLT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt).
