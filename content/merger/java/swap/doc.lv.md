...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOC lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOC failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOC lapas programmā Java"
description: "Apmainiet DOC lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOC faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOC failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOC faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOC faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOC failu lapas tiešsaistē"
    content: |
       Apmainiet DOC faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
