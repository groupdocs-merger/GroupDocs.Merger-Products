...
############################# Head ############################
head_title: "Обміняти й обмінюватися PDF сторінками на Java"
head_description: "Поміняйте та обміняйтеся позиціями двох сторінок у файлі PDF у Java за допомогою API об’єднання документів."

############################# Header ############################
title: "Поміняти PDF сторінки на Java"
description: "Поміняйте місцями сторінки PDF кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Поміняти PDF сторінками файлів у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) полегшує розробникам Java заміну сторінок у файлі PDF, реалізувавши кілька простих кроків .
    ...
    code: |
     ...
     {{< merger/code-merger title="Як поміняти місцями сторінки файлу PDF за допомогою прикладу коду Java">}}

        ```java    
        // Поміняти місцями сторінки файлу PDF за допомогою API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Демонстрації в прямому ефірі - обміняйте PDF сторінками файлів онлайн"
    content: |
       Поміняйте PDF сторінки файлу просто зараз, відвідавши веб-сайт [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
