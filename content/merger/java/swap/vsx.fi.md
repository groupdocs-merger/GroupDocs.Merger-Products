...
############################# Head ############################
head_title: "Vaihda ja vaihda VSX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSX sivua Java"
description: "Vaihda VSX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSX tiedostosivua verkossa"
    content: |
       Vaihda VSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx) -sivustolla.
