...
############################# Head ############################
head_title: "Bytt og bytt ut DOCX sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOCX-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOCX sider i Java"
description: "Bytt DOCX-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt DOCX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en DOCX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOCX filsider ved å bruke Java eksempelkode">}}
