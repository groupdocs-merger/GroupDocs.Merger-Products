...
############################# Head ############################
head_title: "Zamijeni i razmijeni TEX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar TEX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni TEX stranice u Java"
description: "Zamijenite TEX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni TEX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar TEX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti TEX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite TEX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite TEX stranice datoteka na mreži"
    content: |
       Odmah zamijenite TEX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex) web mjesto.
