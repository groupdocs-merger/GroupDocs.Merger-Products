...
############################# Head ############################
head_title: "Tukar & Tukar VSSX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSSX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSX Halaman Dalam Java"
description: "Tukar VSSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSSX halaman fail menggunakan kod contoh Java.">}}
