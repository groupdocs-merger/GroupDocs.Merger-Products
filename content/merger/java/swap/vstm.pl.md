...
############################# Head ############################
head_title: "Zamień i zamień VSTM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSTM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSTM strony w Java"
description: "Zamień strony VSTM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSTM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VSTM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VSTM strony plików online"
    content: |
       Zamień strony plików VSTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
