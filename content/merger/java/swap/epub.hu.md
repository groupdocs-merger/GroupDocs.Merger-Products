...
############################# Head ############################
head_title: "Cserélj és cserélj EPUB oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy EPUB fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "EPUB oldal cseréje a Java nyelven"
description: "Cserélje ki az EPUB oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "EPUB fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy EPUB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk EPUB fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az EPUB fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – EPUB fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub) webhely meglátogatásával azonnal cseréljen EPUB fájloldalt.
