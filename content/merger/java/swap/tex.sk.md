...
############################# Head ############################
head_title: "Vymeňte a vymeňte TEX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore TEX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte TEX stránky v Java"
description: "Vymeňte TEX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte TEX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru TEX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru TEX pomocou vzorového kódu Java">}}
