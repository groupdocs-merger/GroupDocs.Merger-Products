...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPSX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPSX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPSX stránky v Java"
description: "Vyměňte PPSX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte PPSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru PPSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPSX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru PPSX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte PPSX stránky souborů online"
    content: |
       Vyměňte stránky souborů PPSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
