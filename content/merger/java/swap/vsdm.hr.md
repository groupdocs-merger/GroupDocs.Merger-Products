...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSDM stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSDM datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSDM stranice u Java"
description: "Zamijenite VSDM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSDM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar VSDM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSDM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite VSDM stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite VSDM stranice datoteka na mreži"
    content: |
       Odmah zamijenite VSDM stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) web mjesto.
