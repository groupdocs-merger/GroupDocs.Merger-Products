...
############################# Head ############################
head_title: "Tukar & Tukarkan VTX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file VTX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VTX Halaman Di Java"
description: "Tukar VTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar VTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file VTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VTX menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file VTX menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VTX Halaman File Online"
    content: |
       Tukar halaman file VTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/vtx).
