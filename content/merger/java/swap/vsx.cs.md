...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSX stránky v Java"
description: "Vyměňte VSX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSX stránky souborů online"
    content: |
       Vyměňte stránky souborů VSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx).
