...
############################# Head ############################
head_title: "Tukar & Tukarkan VSSM Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSSM di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSM Halaman Di Java"
description: "Tukar VSSM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar VSSM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file VSSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSSM menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file VSSM menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSSM Halaman File Online"
    content: |
       Tukar halaman file VSSM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/vssm).
