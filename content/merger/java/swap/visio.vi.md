...
############################# Head ############################
head_title: "Hoán đổi các trang trong tệp VISIO với các ứng dụng Java"
head_description: "Sử dụng GroupDocs.Merger for Java để sắp xếp lại các trang trong tài liệu VISIO. Thay đổi các tệp PDF, Word, bảng tính, thuyết trình, sơ đồ Visio, hình ảnh, lưu trữ và hơn thế nữa."

############################# Header ############################
title: "Hoán đổi các trang VISIO" 
description: "GroupDocs.Merger for Java mở rộng các ứng dụng Java với các tính năng thao tác tài liệu linh hoạt. Sắp xếp lại các trang trong các tệp VISIO để cải thiện cấu trúc nội dung."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) đơn giản hóa việc sắp xếp lại các trang trong tài liệu VISIO, tạo cho bạn quyền kiểm soát hoàn toàn đối với việc tổ chức nội dung. Tích hợp quy trình xử lý tài liệu liền mạch vào ứng dụng Java của bạn.
      
      1. Định nghĩa đường dẫn đến tệp VISIO.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hoán đổi trang đầu tiên và trang cuối cùng trong tệp VISIO"
      content: |
        Ví dụ này cho thấy cách hoán đổi các trang trong tệp VISIO chỉ với vài bước đơn giản.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
