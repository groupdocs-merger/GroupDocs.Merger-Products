...
############################# Head ############################
head_title: "Vahetage ja vahetage OTP lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone OTP failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage OTP lehte keeles Java"
description: "Vahetage OTP lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage OTP faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis OTP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada OTP faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili OTP lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus OTP faililehte"
    content: |
       Vahetage kohe OTP faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
