...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSDX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSDX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSDX stránky v Java"
description: "Vyměňte VSDX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSDX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSDX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSDX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSDX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSDX stránky souborů online"
    content: |
       Vyměňte stránky souborů VSDX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
