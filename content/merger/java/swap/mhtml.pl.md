...
############################# Head ############################
head_title: "Zamień i zamień MHTML strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku MHTML w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień MHTML strony w Java"
description: "Zamień strony MHTML na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików MHTML w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku MHTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku MHTML przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików MHTML za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień MHTML strony plików online"
    content: |
       Zamień strony plików MHTML już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
