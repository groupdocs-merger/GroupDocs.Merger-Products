...
############################# Head ############################
head_title: "Apmainīt un apmainīt OTP lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas OTP failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt OTP lapas programmā Java"
description: "Apmainiet OTP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt OTP faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām OTP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt OTP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet OTP faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt OTP failu lapas tiešsaistē"
    content: |
       Apmainiet OTP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
