...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSDX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSDX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSDX puslapius Java"
description: "Pakeiskite VSDX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSDX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSDX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSDX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSDX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSDX failų puslapiais internete"
    content: |
       Apkeiskite VSDX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) svetainėje.
