...
############################# Head ############################
head_title: "Tukar & Tukar VSDX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSDX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDX Halaman Dalam Java"
description: "Tukar VSDX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSDX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSDX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VSDX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSDX Halaman Fail Dalam Talian"
    content: |
       Tukar VSDX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
