...
############################# Head ############################
head_title: "Vahetage ja vahetage XLTX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLTX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLTX lehte keeles Java"
description: "Vahetage XLTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili XLTX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus XLTX faililehte"
    content: |
       Vahetage kohe XLTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
