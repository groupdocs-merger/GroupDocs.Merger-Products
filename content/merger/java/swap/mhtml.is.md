...
############################# Head ############################
head_title: "Skiptu og skiptu á MHTML síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í MHTML skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um MHTML síður í Java"
description: "Skiptu um MHTML síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um MHTML skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan MHTML skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um MHTML skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Skiptu um MHTML skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu um MHTML skráarsíður á netinu"
    content: |
       Skiptu um MHTML skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
