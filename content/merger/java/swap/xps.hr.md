...
############################# Head ############################
head_title: "Zamijeni i razmijeni XPS stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XPS datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XPS stranice u Java"
description: "Zamijenite XPS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni XPS stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar XPS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XPS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite XPS stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite XPS stranice datoteka na mreži"
    content: |
       Odmah zamijenite XPS stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) web mjesto.
