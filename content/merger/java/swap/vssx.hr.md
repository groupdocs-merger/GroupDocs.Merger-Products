...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSSX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSSX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSSX stranice u Java"
description: "Zamijenite VSSX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSSX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar VSSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSSX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite VSSX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite VSSX stranice datoteka na mreži"
    content: |
       Odmah zamijenite VSSX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx) web mjesto.
