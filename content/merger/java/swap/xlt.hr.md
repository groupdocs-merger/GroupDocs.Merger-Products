...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLT stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLT datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLT stranice u Java"
description: "Zamijenite XLT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar XLT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLT stranice datoteke koristeći Java primjer koda">}}
