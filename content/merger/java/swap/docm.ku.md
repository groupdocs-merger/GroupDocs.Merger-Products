...
############################# Head ############################
head_title: "Biguherîne û biguherîne DOCM Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek DOCM de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne DOCM Rûpelên Di Java de"
description: "Rûpelên DOCM bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de DOCM Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên DOCM bi karanîna koda nimûneya Java veguhezîne">}}
