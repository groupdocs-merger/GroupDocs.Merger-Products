...
############################# Head ############################
head_title: "Zamień i zamień XLT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLT strony w Java"
description: "Zamień strony XLT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLT za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLT strony plików online"
    content: |
       Zamień strony plików XLT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt).
