...
############################# Head ############################
head_title: "Skiptu og skiptu á XPS síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í XPS skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um XPS síður í Java"
description: "Skiptu um XPS síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um XPS skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan XPS skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um XPS skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Skiptu um XPS skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu um XPS skráarsíður á netinu"
    content: |
       Skiptu um XPS skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps).
