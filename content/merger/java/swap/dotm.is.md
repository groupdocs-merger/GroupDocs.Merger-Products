...
############################# Head ############################
head_title: "Skiptu og skiptu á DOTM síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í DOTM skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um DOTM síður í Java"
description: "Skiptu um DOTM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um DOTM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan DOTM skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um DOTM skráarsíður með því að nota Java dæmikóða">}}
