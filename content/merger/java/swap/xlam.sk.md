...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLAM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLAM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLAM stránky v Java"
description: "Vymeňte XLAM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLAM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLAM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLAM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLAM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLAM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLAM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
