...
############################# Head ############################
head_title: "Zamień i zamień ODT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ODT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ODT strony w Java"
description: "Zamień strony ODT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików ODT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku ODT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ODT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików ODT za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień ODT strony plików online"
    content: |
       Zamień strony plików ODT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
