...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSSX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSSX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSSX stránky v Java"
description: "Vymeňte VSSX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSSX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSSX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSSX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSSX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx).
