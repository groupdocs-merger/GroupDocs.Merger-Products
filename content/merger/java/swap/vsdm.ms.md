...
############################# Head ############################
head_title: "Tukar & Tukar VSDM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSDM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDM Halaman Dalam Java"
description: "Tukar VSDM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSDM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSDM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSDM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VSDM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSDM Halaman Fail Dalam Talian"
    content: |
       Tukar VSDM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
