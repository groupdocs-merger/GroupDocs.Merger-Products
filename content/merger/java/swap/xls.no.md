...
############################# Head ############################
head_title: "Bytt og bytt ut XLS sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLS-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLS sider i Java"
description: "Bytt XLS-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt XLS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en XLS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLS filsider ved å bruke Java eksempelkode">}}
