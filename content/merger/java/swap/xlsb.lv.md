...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLSB lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLSB failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLSB lapas programmā Java"
description: "Apmainiet XLSB lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLSB faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLSB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLSB faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLSB faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLSB failu lapas tiešsaistē"
    content: |
       Apmainiet XLSB faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
