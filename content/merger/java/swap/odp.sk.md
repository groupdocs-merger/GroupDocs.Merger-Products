...
############################# Head ############################
head_title: "Vymeňte a vymeňte ODP stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ODP v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ODP stránky v Java"
description: "Vymeňte ODP stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte ODP strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru ODP implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ODP pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte ODP stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte ODP stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi ODP hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
