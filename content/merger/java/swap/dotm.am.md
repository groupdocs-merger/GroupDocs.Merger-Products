...
############################# Head ############################
head_title: "በJava ውስጥ DOTM ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በJava ውስጥ ባለው የDOTM ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "DOTM ገጾችን በJava ውስጥ ይቀያይሩ"
description: "DOTM ገጾችን በጥቂት የJava ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "DOTM የፋይል ገጾችን በJava ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በDOTM ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM የፋይል ገጾችን Java ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የDOTM ፋይል ገጾችን ይቀይሩ
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የDOTM ፋይል ገጾችን በመስመር ላይ ይቀያይሩ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm) ድር ጣቢያን በመጎብኘት የDOTM ፋይል ገጾችን አሁኑኑ ይቀይሩ።
