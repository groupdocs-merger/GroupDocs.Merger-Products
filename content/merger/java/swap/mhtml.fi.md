...
############################# Head ############################
head_title: "Vaihda ja vaihda MHTML sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja MHTML-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda MHTML sivua Java"
description: "Vaihda MHTML-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda MHTML tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja MHTML-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa MHTML tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda MHTML tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda MHTML tiedostosivua verkossa"
    content: |
       Vaihda MHTML tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml) -sivustolla.
