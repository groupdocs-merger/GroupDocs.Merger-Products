...
############################# Head ############################
head_title: "Vahetage ja vahetage HTML lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone HTML failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage HTML lehte keeles Java"
description: "Vahetage HTML lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage HTML faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis HTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada HTML faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili HTML lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus HTML faililehte"
    content: |
       Vahetage kohe HTML faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
