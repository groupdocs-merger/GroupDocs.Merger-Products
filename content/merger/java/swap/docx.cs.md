...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOCX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOCX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOCX stránky v Java"
description: "Vyměňte DOCX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOCX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOCX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOCX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru DOCX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte DOCX stránky souborů online"
    content: |
       Vyměňte stránky souborů DOCX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx).
