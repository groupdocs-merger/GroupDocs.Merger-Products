...
############################# Head ############################
head_title: "Swap & Exchange ONE Pages in Java"
head_description: "Swap & Exchange positions of two pages within a ONE file in Java using the documents merger API."

############################# Header ############################
title: "Swap ONE Pages In Java"
description: "Swap ONE Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Swap ONE File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a ONE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ONE file pages using Java example code">}}

        ```java    
        // Swap ONE file pages using GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live Demos - Swap ONE File Pages Online"
    content: |
       Swap ONE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) website.
