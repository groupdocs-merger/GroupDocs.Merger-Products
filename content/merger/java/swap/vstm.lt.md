...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSTM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSTM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSTM puslapius Java"
description: "Pakeiskite VSTM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSTM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSTM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSTM failų puslapiais internete"
    content: |
       Apkeiskite VSTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm) svetainėje.
