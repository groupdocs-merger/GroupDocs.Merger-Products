...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSDM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSDM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSDM puslapius Java"
description: "Pakeiskite VSDM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSDM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSDM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSDM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSDM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSDM failų puslapiais internete"
    content: |
       Apkeiskite VSDM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) svetainėje.
