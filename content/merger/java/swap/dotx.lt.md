...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOTX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOTX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOTX puslapius Java"
description: "Pakeiskite DOTX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOTX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais DOTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite DOTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite DOTX failų puslapiais internete"
    content: |
       Apkeiskite DOTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx) svetainėje.
