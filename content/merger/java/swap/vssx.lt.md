...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSSX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSSX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSSX puslapius Java"
description: "Pakeiskite VSSX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSSX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSSX failų puslapiais internete"
    content: |
       Apkeiskite VSSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx) svetainėje.
