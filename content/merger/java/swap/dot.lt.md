...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOT puslapius Java"
description: "Pakeiskite DOT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais DOT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite DOT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite DOT failų puslapiais internete"
    content: |
       Apkeiskite DOT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) svetainėje.
