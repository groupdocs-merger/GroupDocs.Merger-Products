...
############################# Head ############################
head_title: "Tukar & Tukar HTML Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail HTML dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar HTML Halaman Dalam Java"
description: "Tukar HTML Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar HTML Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail HTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar HTML halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar HTML halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar HTML Halaman Fail Dalam Talian"
    content: |
       Tukar HTML halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
