...
############################# Head ############################
head_title: "Cserélj és cserélj DOT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOT oldal cseréje a Java nyelven"
description: "Cserélje ki az DOT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy DOT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az DOT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) webhely meglátogatásával azonnal cseréljen DOT fájloldalt.
