...
############################# Head ############################
head_title: "Troque páginas em arquivos EXCEL com aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para reorganizar páginas em documentos EXCEL. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos e mais."

############################# Header ############################
title: "Trocar páginas EXCEL" 
description: "GroupDocs.Merger for Java melhora aplicações Java com recursos flexíveis de manipulação de documentos. Reordene páginas em arquivos EXCEL para otimizar a estrutura do conteúdo."
...
steps:
    enable: true
    title: "Como reordenar páginas EXCEL"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica a reordenação de páginas em documentos EXCEL, dando total controle sobre a organização do conteúdo. Integre um processamento de documentos sem costura em suas aplicações Java.
      
      1. Defina o caminho do arquivo EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última página em um arquivo EXCEL"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo EXCEL com apenas alguns passos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
