...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSB sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSB-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSB sivua Java"
description: "Vaihda XLSB-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSB tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLSB-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XLSB tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XLSB tiedostosivua verkossa"
    content: |
       Vaihda XLSB tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb) -sivustolla.
