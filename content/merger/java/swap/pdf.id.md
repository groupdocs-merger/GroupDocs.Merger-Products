...
############################# Head ############################
head_title: "Tukar & Tukarkan PDF Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file PDF di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PDF Halaman Di Java"
description: "Tukar PDF Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar PDF Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file PDF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PDF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PDF Halaman File Online"
    content: |
       Tukar halaman file PDF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/pdf).
