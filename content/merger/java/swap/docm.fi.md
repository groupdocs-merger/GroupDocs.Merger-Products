...
############################# Head ############################
head_title: "Vaihda ja vaihda DOCM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOCM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOCM sivua Java"
description: "Vaihda DOCM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOCM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja DOCM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOCM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda DOCM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda DOCM tiedostosivua verkossa"
    content: |
       Vaihda DOCM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm) -sivustolla.
