...
############################# Head ############################
head_title: "Tukar & Tukarkan XLSX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLSX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSX Halaman Di Java"
description: "Tukar XLSX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLSX menggunakan kode contoh Java">}}
