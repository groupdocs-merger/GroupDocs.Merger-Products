...
############################# Head ############################
head_title: "Swap pages in EXCEL files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in EXCEL documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap EXCEL pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in EXCEL files to streamline content structure."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in EXCEL documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a EXCEL file"
      content: |
        This example demonstrates how to swap pages in a EXCEL file with just a few simple steps.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
