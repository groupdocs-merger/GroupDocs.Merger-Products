...
############################# Head ############################
head_title: "Ruil en ruil VDX bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n VDX-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil VDX bladsye in Java"
description: "Ruil VDX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil VDX lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VDX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil VDX lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil VDX lêerbladsye aanlyn"
    content: |
       Ruil nou VDX lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) webwerf te besoek.
