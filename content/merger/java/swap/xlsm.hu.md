...
############################# Head ############################
head_title: "Cserélj és cserélj XLSM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSM oldal cseréje a Java nyelven"
description: "Cserélje ki az XLSM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XLSM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLSM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm) webhely meglátogatásával azonnal cseréljen XLSM fájloldalt.
