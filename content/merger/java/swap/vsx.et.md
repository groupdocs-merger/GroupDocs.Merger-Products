...
############################# Head ############################
head_title: "Vahetage ja vahetage VSX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSX lehte keeles Java"
description: "Vahetage VSX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VSX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VSX faililehte"
    content: |
       Vahetage kohe VSX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx).
