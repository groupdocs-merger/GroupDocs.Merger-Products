...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj VTX strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke VTX v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj VTX strani v Java"
description: "Zamenjajte strani VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke VTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki VTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke VTX s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke VTX z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte VTX strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke VTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
