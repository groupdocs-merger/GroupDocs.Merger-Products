...
############################# Head ############################
head_title: "Zamijeni i razmijeni PDF stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PDF datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PDF stranice u Java"
description: "Zamijenite PDF stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni PDF stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar PDF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PDF stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite PDF stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite PDF stranice datoteka na mreži"
    content: |
       Odmah zamijenite PDF stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf) web mjesto.
