...
############################# Head ############################
head_title: "Zamijeni i razmijeni ODS stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar ODS datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni ODS stranice u Java"
description: "Zamijenite ODS stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni ODS stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar ODS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti ODS stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite ODS stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite ODS stranice datoteka na mreži"
    content: |
       Odmah zamijenite ODS stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) web mjesto.
