...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLSX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLSX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLSX puslapius Java"
description: "Pakeiskite XLSX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLSX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLSX failų puslapiais internete"
    content: |
       Apkeiskite XLSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) svetainėje.
