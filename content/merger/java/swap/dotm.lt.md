...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOTM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOTM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOTM puslapius Java"
description: "Pakeiskite DOTM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOTM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais DOTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite DOTM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite DOTM failų puslapiais internete"
    content: |
       Apkeiskite DOTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm) svetainėje.
