...
############################# Head ############################
head_title: "Scambia e scambia XLTX pagine in Java"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file XLTX in Java utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia XLTX pagine in Java"
description: "Scambia le pagine XLTX con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Scambia XLTX pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di scambiare facilmente le pagine all'interno di un file XLTX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file XLTX utilizzando il codice di esempio Java">}}

        ```java    
        // Scambia le pagine dei file XLTX utilizzando l'API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Scambia XLTX pagine di file online"
    content: |
       Scambia subito le pagine dei file XLTX visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
