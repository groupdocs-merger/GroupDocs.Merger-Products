...
############################# Head ############################
head_title: "Vyměňte a vyměňte EPUB stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru EPUB v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit EPUB stránky v Java"
description: "Vyměňte EPUB stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte EPUB stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru EPUB provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru EPUB pomocí ukázkového kódu Java">}}
