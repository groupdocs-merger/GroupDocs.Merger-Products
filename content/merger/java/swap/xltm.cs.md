...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLTM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLTM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLTM stránky v Java"
description: "Vyměňte XLTM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLTM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLTM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLTM stránky souborů online"
    content: |
       Vyměňte stránky souborů XLTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
