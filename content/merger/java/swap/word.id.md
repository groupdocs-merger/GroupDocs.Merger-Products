...
############################# Head ############################
head_title: "Tukar & Tukarkan WORD Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file WORD di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar WORD Halaman Di Java"
description: "Tukar WORD Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar WORD Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file WORD dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file WORD menggunakan kode contoh Java">}}
