...
############################# Head ############################
head_title: "Tukar & Tukarkan XLSM Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLSM di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSM Halaman Di Java"
description: "Tukar XLSM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLSM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLSM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLSM Halaman File Online"
    content: |
       Tukar halaman file XLSM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xlsm).
