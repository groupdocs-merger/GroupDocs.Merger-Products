...
############################# Head ############################
head_title: "Swap pages in XPS files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in XPS documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap XPS pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in XPS files to streamline content structure."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in XPS documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
      
      1. Define the path to the XPS file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a XPS file"
      content: |
        This example demonstrates how to swap pages in a XPS file with just a few simple steps.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
