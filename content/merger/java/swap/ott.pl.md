...
############################# Head ############################
head_title: "Zamień i zamień OTT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku OTT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień OTT strony w Java"
description: "Zamień strony OTT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików OTT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku OTT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku OTT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików OTT za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień OTT strony plików online"
    content: |
       Zamień strony plików OTT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
