...
############################# Head ############################
head_title: "Vymeňte a vymeňte VTX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VTX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VTX stránky v Java"
description: "Vymeňte VTX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VTX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VTX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VTX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
