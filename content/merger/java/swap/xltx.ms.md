...
############################# Head ############################
head_title: "Tukar & Tukar XLTX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLTX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTX Halaman Dalam Java"
description: "Tukar XLTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLTX Halaman Fail Dalam Talian"
    content: |
       Tukar XLTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
