...
############################# Head ############################
head_title: "Tukar & Tukarkan MHTML Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file MHTML di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHTML Halaman Di Java"
description: "Tukar MHTML Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar MHTML Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file MHTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file MHTML menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar MHTML Halaman File Online"
    content: |
       Tukar halaman file MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/mhtml).
