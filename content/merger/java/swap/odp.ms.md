...
############################# Head ############################
head_title: "Tukar & Tukar ODP Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODP dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODP Halaman Dalam Java"
description: "Tukar ODP Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar ODP Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail ODP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODP halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar ODP halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ODP Halaman Fail Dalam Talian"
    content: |
       Tukar ODP halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
