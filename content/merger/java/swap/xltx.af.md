...
############################# Head ############################
head_title: "Ruil en ruil XLTX bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLTX-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLTX bladsye in Java"
description: "Ruil XLTX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil XLTX lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLTX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTX lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil XLTX lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil XLTX lêerbladsye aanlyn"
    content: |
       Ruil nou XLTX lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx) webwerf te besoek.
