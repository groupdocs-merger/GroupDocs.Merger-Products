...
############################# Head ############################
head_title: "Tukar & Tukar OTT Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail OTT dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTT Halaman Dalam Java"
description: "Tukar OTT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar OTT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail OTT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar OTT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar OTT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar OTT Halaman Fail Dalam Talian"
    content: |
       Tukar OTT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
