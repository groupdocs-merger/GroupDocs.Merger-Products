...
############################# Head ############################
head_title: "Biguherîne û biguherîne VSDM Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek VSDM de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne VSDM Rûpelên Di Java de"
description: "Rûpelên VSDM bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de VSDM Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek VSDM de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên VSDM bi karanîna koda nimûneya Java veguhezîne">}}

        ```java    
        // Rûpelên pelan ên VSDM bi karanîna GroupDocs.Merger API-ê biguherînin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demokên Zindî - Biguherîne VSDM Rûpelên Serhêl"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) niha rûpelên pelê yên VSDM biguherînin.
