...
############################# Head ############################
head_title: "Zamień i zamień PDF strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PDF w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PDF strony w Java"
description: "Zamień strony PDF na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików PDF w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku PDF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PDF przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików PDF za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień PDF strony plików online"
    content: |
       Zamień strony plików PDF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
