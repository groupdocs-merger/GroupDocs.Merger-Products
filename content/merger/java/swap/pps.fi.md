...
############################# Head ############################
head_title: "Vaihda ja vaihda PPS sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPS-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPS sivua Java"
description: "Vaihda PPS-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja PPS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda PPS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda PPS tiedostosivua verkossa"
    content: |
       Vaihda PPS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps) -sivustolla.
