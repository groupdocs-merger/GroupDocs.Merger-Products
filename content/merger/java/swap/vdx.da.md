...
############################# Head ############################
head_title: "Byt og byt VDX sider i Java"
head_description: "Byt og udveksle positioner på to sider i en VDX-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VDX sider i Java"
description: "Byt VDX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt VDX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en VDX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VDX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift VDX filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt VDX filsider online"
    content: |
       Skift VDX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
