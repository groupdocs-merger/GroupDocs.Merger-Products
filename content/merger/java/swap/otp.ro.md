...
############################# Head ############################
head_title: "Schimbați și schimbați paginile OTP în Java"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier OTP în Java utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați OTP pagini în Java"
description: "Schimbați paginile OTP cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere OTP în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează ca dezvoltatorii Java să schimbe paginile dintr-un fișier OTP prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere OTP utilizând codul exemplu Java">}}

        ```java    
        // Schimbați pagini de fișiere OTP utilizând API-ul GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo live - Schimbați paginile de fișiere OTP online"
    content: |
       Schimbați paginile de fișiere OTP chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
