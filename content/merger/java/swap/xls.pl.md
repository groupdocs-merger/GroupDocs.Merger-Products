...
############################# Head ############################
head_title: "Zamień i zamień XLS strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLS w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLS strony w Java"
description: "Zamień strony XLS na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLS przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLS za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLS strony plików online"
    content: |
       Zamień strony plików XLS już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
