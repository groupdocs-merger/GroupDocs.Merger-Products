...
############################# Head ############################
head_title: "Vymeňte a vymeňte ODT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ODT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ODT stránky v Java"
description: "Vymeňte ODT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte ODT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru ODT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ODT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte ODT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte ODT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi ODT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
