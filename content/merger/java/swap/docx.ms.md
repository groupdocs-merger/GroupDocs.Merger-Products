...
############################# Head ############################
head_title: "Tukar & Tukar DOCX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOCX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCX Halaman Dalam Java"
description: "Tukar DOCX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOCX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOCX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOCX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar DOCX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOCX Halaman Fail Dalam Talian"
    content: |
       Tukar DOCX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx).
