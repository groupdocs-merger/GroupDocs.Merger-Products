...
############################# Head ############################
head_title: "Tukar & Tukar DOT Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOT dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOT Halaman Dalam Java"
description: "Tukar DOT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOT halaman fail menggunakan kod contoh Java.">}}
