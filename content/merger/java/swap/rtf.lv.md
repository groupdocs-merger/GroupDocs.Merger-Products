...
############################# Head ############################
head_title: "Apmainīt un apmainīt RTF lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas RTF failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt RTF lapas programmā Java"
description: "Apmainiet RTF lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt RTF faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām RTF failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt RTF faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet RTF faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt RTF failu lapas tiešsaistē"
    content: |
       Apmainiet RTF faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
