...
############################# Head ############################
head_title: "Ruil en ruil VSDM bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n VSDM-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil VSDM bladsye in Java"
description: "Ruil VSDM Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil VSDM lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSDM-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil VSDM lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil VSDM lêerbladsye aanlyn"
    content: |
       Ruil nou VSDM lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) webwerf te besoek.
