...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOTX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOTX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOTX stránky v Java"
description: "Vyměňte DOTX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOTX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru DOTX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte DOTX stránky souborů online"
    content: |
       Vyměňte stránky souborů DOTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
