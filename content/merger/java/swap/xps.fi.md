...
############################# Head ############################
head_title: "Vaihda ja vaihda XPS sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XPS-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XPS sivua Java"
description: "Vaihda XPS-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XPS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XPS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XPS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XPS tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XPS tiedostosivua verkossa"
    content: |
       Vaihda XPS tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) -sivustolla.
