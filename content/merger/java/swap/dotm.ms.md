...
############################# Head ############################
head_title: "Tukar & Tukar DOTM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOTM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTM Halaman Dalam Java"
description: "Tukar DOTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar DOTM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOTM Halaman Fail Dalam Talian"
    content: |
       Tukar DOTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
