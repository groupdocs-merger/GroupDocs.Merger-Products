...
############################# Head ############################
head_title: "Vymeňte a vymeňte PDF stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PDF v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PDF stránky v Java"
description: "Vymeňte PDF stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte PDF strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru PDF implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PDF pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte PDF stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte PDF stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi PDF hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
