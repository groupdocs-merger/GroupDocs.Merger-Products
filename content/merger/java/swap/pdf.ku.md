...
############################# Head ############################
head_title: "Biguherîne û biguherîne PDF Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek PDF de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne PDF Rûpelên Di Java de"
description: "Rûpelên PDF bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de PDF Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên PDF bi karanîna koda nimûneya Java veguhezîne">}}
