...
############################# Head ############################
head_title: "Vymeňte a vymeňte MHT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore MHT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte MHT stránky v Java"
description: "Vymeňte MHT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte MHT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru MHT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru MHT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte MHT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte MHT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi MHT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
