...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOCM stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOCM datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOCM stranice u Java"
description: "Zamijenite DOCM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOCM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar DOCM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOCM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite DOCM stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite DOCM stranice datoteka na mreži"
    content: |
       Odmah zamijenite DOCM stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm) web mjesto.
