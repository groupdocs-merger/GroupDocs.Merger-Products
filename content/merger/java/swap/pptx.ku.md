...
############################# Head ############################
head_title: "Biguherîne û biguherîne PPTX Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek PPTX de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne PPTX Rûpelên Di Java de"
description: "Rûpelên PPTX bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de PPTX Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek PPTX de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên PPTX bi karanîna koda nimûneya Java veguhezîne">}}

        ```java    
        // Rûpelên pelan ên PPTX bi karanîna GroupDocs.Merger API-ê biguherînin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demokên Zindî - Biguherîne PPTX Rûpelên Serhêl"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx) niha rûpelên pelê yên PPTX biguherînin.
