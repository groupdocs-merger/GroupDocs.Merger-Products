...
############################# Head ############################
head_title: "Intercambiar páginas en archivos MHTML con aplicaciones Java"
head_description: "Utiliza GroupDocs.Merger for Java para reorganizar páginas en documentos MHTML. Modifica PDFs, archivos de Word, hojas de cálculo, presentaciones, diagramas de Visio, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Intercambiar páginas de MHTML" 
description: "GroupDocs.Merger for Java mejora las aplicaciones de Java con características flexibles de manipulación de documentos. Reordena páginas en archivos MHTML para optimizar la estructura del contenido."
...
steps:
    enable: true
    title: "Cómo reordenar páginas de MHTML"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica el reordenamiento de páginas en documentos MHTML, brindándote el control total sobre la organización del contenido. Integra un procesamiento de documentos fluido en tus aplicaciones Java.
      
      1. Define la ruta al archivo MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Intercambiar la primera y la última página en un archivo MHTML"
      content: |
        Este ejemplo demuestra cómo intercambiar páginas en un archivo MHTML en solo unos pocos pasos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
