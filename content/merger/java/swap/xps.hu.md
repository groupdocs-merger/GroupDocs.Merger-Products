...
############################# Head ############################
head_title: "Cserélj és cserélj XPS oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XPS fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XPS oldal cseréje a Java nyelven"
description: "Cserélje ki az XPS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XPS fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XPS fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XPS fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XPS fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) webhely meglátogatásával azonnal cseréljen XPS fájloldalt.
