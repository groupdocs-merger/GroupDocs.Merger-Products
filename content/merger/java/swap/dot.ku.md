...
############################# Head ############################
head_title: "Biguherîne û biguherîne DOT Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek DOT de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne DOT Rûpelên Di Java de"
description: "Rûpelên DOT bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de DOT Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek DOT de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên DOT bi karanîna koda nimûneya Java veguhezîne">}}

        ```java    
        // Rûpelên pelan ên DOT bi karanîna GroupDocs.Merger API-ê biguherînin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demokên Zindî - Biguherîne DOT Rûpelên Serhêl"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) niha rûpelên pelê yên DOT biguherînin.
