...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOCX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOCX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOCX lapas programmā Java"
description: "Apmainiet DOCX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOCX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām DOCX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOCX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet DOCX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt DOCX failu lapas tiešsaistē"
    content: |
       Apmainiet DOCX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx).
