...
############################# Head ############################
head_title: "Troque páginas em arquivos MHTML com aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para reorganizar páginas em documentos MHTML. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos e mais."

############################# Header ############################
title: "Trocar páginas MHTML" 
description: "GroupDocs.Merger for Java melhora aplicações Java com recursos flexíveis de manipulação de documentos. Reordene páginas em arquivos MHTML para otimizar a estrutura do conteúdo."
...
steps:
    enable: true
    title: "Como reordenar páginas MHTML"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica a reordenação de páginas em documentos MHTML, dando total controle sobre a organização do conteúdo. Integre um processamento de documentos sem costura em suas aplicações Java.
      
      1. Defina o caminho do arquivo MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última página em um arquivo MHTML"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo MHTML com apenas alguns passos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
