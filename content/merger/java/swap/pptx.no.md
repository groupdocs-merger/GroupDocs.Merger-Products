...
############################# Head ############################
head_title: "Bytt og bytt ut PPTX sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en PPTX-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PPTX sider i Java"
description: "Bytt PPTX-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt PPTX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en PPTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PPTX filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt PPTX filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut PPTX filsider på nettet"
    content: |
       Bytt ut PPTX-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
