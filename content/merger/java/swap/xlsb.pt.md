...
############################# Head ############################
head_title: "Troque e troque XLSB páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo XLSB em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar XLSB Páginas em Java"
description: "Troque XLSB Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo XLSB em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo XLSB implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo XLSB usando o código de exemplo Java">}}

        ```java    
        // Troque as páginas do arquivo XLSB usando a API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Trocar páginas de arquivo XLSB on-line"
    content: |
       Troque as páginas do arquivo XLSB agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
