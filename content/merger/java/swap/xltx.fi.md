...
############################# Head ############################
head_title: "Vaihda ja vaihda XLTX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLTX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLTX sivua Java"
description: "Vaihda XLTX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLTX tiedostosivua käyttämällä Java esimerkkikoodia">}}
