...
head_title: "Tukar & Tukar XLTM Halaman di Java"
head_description: "Pengguna Java untuk menukar & bertukar posisi dua halaman dalam file XLTM menggunakan penggabungan dokumen & API split."

title: "Tukar & Tukar XLTM Halaman di Java"
description: "Tukar & Tukar posisi dua halaman dalam file XLTM menggunakan file splitter API untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Tukar Halaman File XLTM di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk bertukar, bertukar, dan mengatur halaman dalam file XLTM dengan menerapkan beberapa langkah mudah.
...
demos:
    ...
    content: |
        Tukarkan halaman dalam file XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/swap-pages/XLTM).
