...
############################# Head ############################
head_title: "Tukar & Tukarkan XLTM Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLTM di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTM Halaman Di Java"
description: "Tukar XLTM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLTM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLTM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLTM Halaman File Online"
    content: |
       Tukar halaman file XLTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xltm).
