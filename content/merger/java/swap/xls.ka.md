...
############################# Head ############################
head_title: "გაცვალეთ და გაცვალეთ XLS გვერდები Java-ში"
head_description: "შეცვალეთ და გაცვალეთ ორი გვერდის პოზიციები XLS ფაილში Java-ში დოკუმენტების შერწყმის API-ს გამოყენებით."

############################# Header ############################
title: "შეცვალეთ XLS გვერდი Java-ში"
description: "შეცვალეთ XLS გვერდები Java კოდის რამდენიმე სტრიქონით."
...
steps:
    enable: true
    title_left: "შეცვალეთ XLS ფაილის გვერდები Java-ში"
    content_left: |
        [GroupDocs.Merger for Java](/ka/merger/java/) უადვილებს Java დეველოპერებს გვერდების შეცვლას XLS ფაილში რამდენიმე მარტივი ნაბიჯის განხორციელებით .
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ შევცვალოთ XLS ფაილის გვერდები Java-ის მაგალითის კოდის გამოყენებით">}}

        ```java    
        // შეცვალეთ XLS ფაილის გვერდები GroupDocs.Merger API-ის გამოყენებით
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "ცოცხალი დემო - შეცვალეთ XLS ფაილის გვერდები ონლაინ"
    content: |
       შეცვალეთ XLS ფაილის გვერდები ახლავე, ეწვიეთ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls) ვებსაიტს.
