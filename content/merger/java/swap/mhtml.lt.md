...
############################# Head ############################
head_title: "Sukeiskite ir keiskite MHTML puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas MHTML faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti MHTML puslapius Java"
description: "Pakeiskite MHTML puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti MHTML failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais MHTML faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti MHTML failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite MHTML failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite MHTML failų puslapiais internete"
    content: |
       Apkeiskite MHTML failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml) svetainėje.
