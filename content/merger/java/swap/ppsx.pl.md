...
############################# Head ############################
head_title: "Zamień i zamień PPSX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPSX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPSX strony w Java"
description: "Zamień strony PPSX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku PPSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPSX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików PPSX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień PPSX strony plików online"
    content: |
       Zamień strony plików PPSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
