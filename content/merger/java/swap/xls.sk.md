...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLS stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLS v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLS stránky v Java"
description: "Vymeňte XLS stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLS strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLS pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLS stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLS stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLS hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
