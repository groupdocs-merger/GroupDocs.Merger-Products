...
############################# Head ############################
head_title: "Bytt og bytt ut DOC sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOC-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOC sider i Java"
description: "Bytt DOC-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt DOC filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en DOC-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOC filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt DOC filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut DOC filsider på nettet"
    content: |
       Bytt ut DOC-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
