...
############################# Head ############################
head_title: "Vaihda ja vaihda VDX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VDX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VDX sivua Java"
description: "Vaihda VDX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VDX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VDX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VDX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VDX tiedostosivua verkossa"
    content: |
       Vaihda VDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) -sivustolla.
