...
############################# Head ############################
head_title: "Vahetage ja vahetage PPT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPT lehte keeles Java"
description: "Vahetage PPT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis PPT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili PPT lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus PPT faililehte"
    content: |
       Vahetage kohe PPT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
