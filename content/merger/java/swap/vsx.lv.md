...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSX lapas programmā Java"
description: "Apmainiet VSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSX failu lapas tiešsaistē"
    content: |
       Apmainiet VSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx).
