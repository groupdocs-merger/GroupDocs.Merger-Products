...
############################# Head ############################
head_title: "تبادل الصفحات XLSB في Java"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف XLSB في Java باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات XLSB في Java"
description: "استبدل الصفحات XLSB ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات XLSB في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تبديل الصفحات داخل ملف XLSB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف XLSB باستخدام كود مثال Java">}}

        ```java    
        // قم بتبديل صفحات ملف XLSB باستخدام GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بتبديل XLSB صفحات الملفات عبر الإنترنت"
    content: |
       قم بتبديل صفحات ملف XLSB الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
