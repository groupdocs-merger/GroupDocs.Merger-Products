...
############################# Head ############################
head_title: "Zamień i zamień XLTM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLTM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLTM strony w Java"
description: "Zamień strony XLTM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLTM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLTM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLTM strony plików online"
    content: |
       Zamień strony plików XLTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
