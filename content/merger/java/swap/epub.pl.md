...
############################# Head ############################
head_title: "Zamień i zamień EPUB strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku EPUB w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień EPUB strony w Java"
description: "Zamień strony EPUB na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików EPUB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku EPUB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku EPUB przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików EPUB za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień EPUB strony plików online"
    content: |
       Zamień strony plików EPUB już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub).
