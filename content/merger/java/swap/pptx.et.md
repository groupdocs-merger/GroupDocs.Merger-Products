...
############################# Head ############################
head_title: "Vahetage ja vahetage PPTX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPTX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPTX lehte keeles Java"
description: "Vahetage PPTX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPTX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis PPTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPTX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili PPTX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus PPTX faililehte"
    content: |
       Vahetage kohe PPTX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
