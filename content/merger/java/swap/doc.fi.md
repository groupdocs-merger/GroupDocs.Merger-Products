...
############################# Head ############################
head_title: "Vaihda ja vaihda DOC sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOC-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOC sivua Java"
description: "Vaihda DOC-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOC tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja DOC-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOC tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda DOC tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda DOC tiedostosivua verkossa"
    content: |
       Vaihda DOC tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc) -sivustolla.
