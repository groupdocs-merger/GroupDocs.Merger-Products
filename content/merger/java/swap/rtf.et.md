...
############################# Head ############################
head_title: "Vahetage ja vahetage RTF lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone RTF failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage RTF lehte keeles Java"
description: "Vahetage RTF lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage RTF faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis RTF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada RTF faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili RTF lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus RTF faililehte"
    content: |
       Vahetage kohe RTF faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
