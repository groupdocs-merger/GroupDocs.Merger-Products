...
############################# Head ############################
head_title: "Swap pages in HTML files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in HTML documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap HTML pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in HTML files to streamline content structure."
...
steps:
    enable: true
    title: "How to reorder HTML pages"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in HTML documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
      
      1. Define the path to the HTML file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a HTML file"
      content: |
        This example demonstrates how to swap pages in a HTML file with just a few simple steps.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Change orientation"
          ...
          link: "/merger/java/orientation/html/"
