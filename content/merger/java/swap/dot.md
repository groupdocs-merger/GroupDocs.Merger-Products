...
head_description: "Swap & Exchange positions of two pages within a DOT file in Java using the documents merger API."

############################# Header ############################
title: "Swap DOT Pages In Java"
description: "Swap DOT Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a DOT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap DOT file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap DOT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) website.
