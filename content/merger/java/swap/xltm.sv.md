...
############################# Head ############################
head_title: "Byt och byt ut XLTM sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en XLTM-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLTM sidor i Java"
description: "Byt XLTM-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt XLTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en XLTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLTM filsidor med hjälp av Java exempelkod">}}
