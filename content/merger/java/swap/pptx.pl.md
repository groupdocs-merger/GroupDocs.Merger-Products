...
############################# Head ############################
head_title: "Zamień i zamień PPTX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPTX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPTX strony w Java"
description: "Zamień strony PPTX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku PPTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików PPTX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień PPTX strony plików online"
    content: |
       Zamień strony plików PPTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
