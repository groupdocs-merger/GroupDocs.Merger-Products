...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a VISIO file by implementing a few easy steps.
