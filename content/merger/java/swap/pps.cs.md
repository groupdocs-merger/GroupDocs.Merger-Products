...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPS stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPS v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPS stránky v Java"
description: "Vyměňte PPS stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte PPS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru PPS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPS pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru PPS pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte PPS stránky souborů online"
    content: |
       Vyměňte stránky souborů PPS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps).
