...
############################# Head ############################
head_title: "Intercambiar e intercambiar ODP páginas en Java"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo ODP en Java utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar ODP páginas en Java"
description: "Intercambie ODP páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Intercambiar ODP páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java intercambiar páginas dentro de un archivo ODP mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos ODP usando el código de ejemplo Java">}}

        ```java    
        // Intercambiar ODP páginas de archivos usando GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo: intercambie ODP páginas de archivos en línea"
    content: |
       Cambie las páginas de archivos ODP ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
