...
############################# Head ############################
head_title: "Apmainīt un apmainīt ODP lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ODP failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ODP lapas programmā Java"
description: "Apmainiet ODP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ODP faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām ODP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ODP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet ODP faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt ODP failu lapas tiešsaistē"
    content: |
       Apmainiet ODP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
