...
############################# Head ############################
head_title: "Vyměňte a vyměňte ONE stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ONE v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ONE stránky v Java"
description: "Vyměňte ONE stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte ONE stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru ONE provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ONE pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru ONE pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte ONE stránky souborů online"
    content: |
       Vyměňte stránky souborů ONE hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
