...
############################# Head ############################
head_title: "Biguherîne û biguherîne DOTM Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek DOTM de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne DOTM Rûpelên Di Java de"
description: "Rûpelên DOTM bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de DOTM Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên DOTM bi karanîna koda nimûneya Java veguhezîne">}}
