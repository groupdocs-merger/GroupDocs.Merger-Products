...
############################# Head ############################
head_title: "Tukar & Tukar EPUB Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail EPUB dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EPUB Halaman Dalam Java"
description: "Tukar EPUB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar EPUB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail EPUB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar EPUB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar EPUB halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar EPUB Halaman Fail Dalam Talian"
    content: |
       Tukar EPUB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub).
