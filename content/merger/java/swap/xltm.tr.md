...
############################# Head ############################
head_title: "XLTM Sayfalarını Java İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir XLTM dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "XLTM Sayfayı Java İçinde Değiştir"
description: "XLTM Sayfalarını birkaç satır Java koduyla değiştirin."
...
steps:
    enable: true
    title_left: "Java içindeki XLTM Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir XLTM dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLTM dosya sayfaları nasıl değiştirilir?">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak XLTM dosya sayfalarını değiştirin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - XLTM Dosya Sayfalarını Çevrimiçi Değiştirin"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm) web sitesini ziyaret ederek XLTM dosya sayfalarını hemen değiştirin.
