...
############################# Head ############################
head_title: "Vahetage ja vahetage ONE lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ONE failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ONE lehte keeles Java"
description: "Vahetage ONE lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ONE faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis ONE, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ONE faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili ONE lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus ONE faililehte"
    content: |
       Vahetage kohe ONE faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
