...
############################# Head ############################
head_title: "تبادل الصفحات PPSX في Java"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف PPSX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات PPSX في Java"
description: "استبدل الصفحات PPSX ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات PPSX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تبديل الصفحات داخل ملف PPSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف PPSX باستخدام كود مثال Java">}}

        ```java    
        // قم بتبديل صفحات ملف PPSX باستخدام GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بتبديل PPSX صفحات الملفات عبر الإنترنت"
    content: |
       قم بتبديل صفحات ملف PPSX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
