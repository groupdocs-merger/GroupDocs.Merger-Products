...
############################# Head ############################
head_title: "Vaihda ja vaihda VSSM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSSM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSSM sivua Java"
description: "Vaihda VSSM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSSM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSSM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSSM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSSM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSSM tiedostosivua verkossa"
    content: |
       Vaihda VSSM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm) -sivustolla.
