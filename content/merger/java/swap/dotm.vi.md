...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng hoán đổi các trang trong một tệp DOTM bằng cách thực hiện một vài bước đơn giản .
