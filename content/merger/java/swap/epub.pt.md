...
############################# Head ############################
head_title: "Troque páginas em arquivos EPUB com aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para reorganizar páginas em documentos EPUB. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos e mais."

############################# Header ############################
title: "Trocar páginas EPUB" 
description: "GroupDocs.Merger for Java melhora aplicações Java com recursos flexíveis de manipulação de documentos. Reordene páginas em arquivos EPUB para otimizar a estrutura do conteúdo."
...
steps:
    enable: true
    title: "Como reordenar páginas EPUB"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica a reordenação de páginas em documentos EPUB, dando total controle sobre a organização do conteúdo. Integre um processamento de documentos sem costura em suas aplicações Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última página em um arquivo EPUB"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo EPUB com apenas alguns passos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
