...
############################# Head ############################
head_title: "Zamień i zamień VSSX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSSX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSSX strony w Java"
description: "Zamień strony VSSX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSSX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VSSX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VSSX strony plików online"
    content: |
       Zamień strony plików VSSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx).
