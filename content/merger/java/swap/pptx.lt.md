...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPTX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPTX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPTX puslapius Java"
description: "Pakeiskite PPTX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPTX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais PPTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite PPTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite PPTX failų puslapiais internete"
    content: |
       Apkeiskite PPTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx) svetainėje.
