...
############################# Head ############################
head_title: "Échangez et échangez PPT pages en Java"
head_description: "Échangez et échangez des positions de deux pages dans un fichier PPT en Java à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Échangez PPT pages dans Java"
description: "Échangez PPT pages avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Échangez PPT pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java d'échanger facilement des pages dans un fichier PPT en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment échanger des pages de fichiers PPT à l'aide de l'exemple de code Java">}}

        ```java    
        // Échangez PPT pages de fichiers à l'aide de l'API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Démos en direct - Échangez PPT pages de fichiers en ligne"
    content: |
       Échangez PPT pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
