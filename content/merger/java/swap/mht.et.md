...
############################# Head ############################
head_title: "Vahetage ja vahetage MHT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone MHT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage MHT lehte keeles Java"
description: "Vahetage MHT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage MHT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis MHT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada MHT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili MHT lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus MHT faililehte"
    content: |
       Vahetage kohe MHT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
