...
############################# Head ############################
head_title: "Canvia i intercanvia MHTML pàgines a Java"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer MHTML a Java mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia MHTML pàgines a Java"
description: "Canvia les pàgines MHTML amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers MHTML a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java intercanviïn pàgines dins d'un fitxer MHTML implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers MHTML utilitzant el codi d'exemple Java">}}

        ```java    
        // Canvia pàgines de fitxers MHTML mitjançant l'API de GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostracions en directe: intercanvieu MHTML pàgines de fitxers en línia"
    content: |
       Canvia les pàgines de fitxers MHTML ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
