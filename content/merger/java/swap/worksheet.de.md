...
############################# Head ############################
head_title: "Tausche & tausche WORKSHEET Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer WORKSHEET-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche WORKSHEET Seiten in Java"
description: "Tauschen Sie WORKSHEET-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "WORKSHEET Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer WORKSHEET-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie WORKSHEET-Dateiseiten mit Java-Beispielcode aus">}}

        ```java    
        // Tauschen Sie WORKSHEET Dateiseiten mit der GroupDocs.Merger API aus
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-Demos - Tauschen Sie WORKSHEET Dateiseiten online aus"
    content: |
       Tauschen Sie jetzt WORKSHEET Dateiseiten aus, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/worksheet) besuchen.
