...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLTX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLTX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLTX stránky v Java"
description: "Vyměňte XLTX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLTX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLTX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLTX stránky souborů online"
    content: |
       Vyměňte stránky souborů XLTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
