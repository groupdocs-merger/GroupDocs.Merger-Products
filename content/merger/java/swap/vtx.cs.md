...
############################# Head ############################
head_title: "Vyměňte a vyměňte VTX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VTX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VTX stránky v Java"
description: "Vyměňte VTX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VTX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VTX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VTX stránky souborů online"
    content: |
       Vyměňte stránky souborů VTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
