...
############################# Head ############################
head_title: "Java में HTML पेज स्वैप और एक्सचेंज करें"
head_description: "दस्तावेज़ विलय API का उपयोग करके Java में एक HTML फ़ाइल के भीतर दो पृष्ठों की स्थिति बदलें और बदलें।"

############################# Header ############################
title: "HTML पेजों को Java में बदलें"
description: "HTML पेजों को Java कोड की कुछ पंक्तियों से बदलें।"
...
steps:
    enable: true
    title_left: "HTML फ़ाइल पेजों को Java में बदलें"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) कुछ आसान चरणों को लागू करके Java डेवलपर्स के लिए HTML फ़ाइल के भीतर पृष्ठों को स्वैप करना आसान बनाता है। .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके HTML फ़ाइल पृष्ठों को स्वैप कैसे करें">}}

        ```java    
        // GroupDocs.Merger API का उपयोग करके HTML फ़ाइल पृष्ठों को स्वैप करें
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "लाइव डेमो - स्वैप HTML फाइल पेज ऑनलाइन"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html) वेबसाइट पर जाकर HTML फ़ाइल पेजों को अभी स्वैप करें।
