...
############################# Head ############################
head_title: "Byt och byt ut MHT sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en MHT-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt MHT sidor i Java"
description: "Byt MHT-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt MHT filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en MHT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter MHT filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt MHT filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut MHT filsidor online"
    content: |
       Byt MHT filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
