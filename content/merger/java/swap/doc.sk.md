...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOC stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOC v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOC stránky v Java"
description: "Vymeňte DOC stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOC strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOC implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOC pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte DOC stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte DOC stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi DOC hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
