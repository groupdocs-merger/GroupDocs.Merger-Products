...
############################# Head ############################
head_title: "Tausche & tausche IMAGE Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer IMAGE-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche IMAGE Seiten in Java"
description: "Tauschen Sie IMAGE-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "IMAGE Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer IMAGE-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie IMAGE-Dateiseiten mit Java-Beispielcode aus">}}
