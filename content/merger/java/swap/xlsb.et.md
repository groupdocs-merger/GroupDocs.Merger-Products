...
############################# Head ############################
head_title: "Vahetage ja vahetage XLSB lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLSB failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLSB lehte keeles Java"
description: "Vahetage XLSB lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLSB faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLSB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLSB faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili XLSB lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus XLSB faililehte"
    content: |
       Vahetage kohe XLSB faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
