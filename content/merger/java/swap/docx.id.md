...
############################# Head ############################
head_title: "Tukar & Tukarkan DOCX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOCX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCX Halaman Di Java"
description: "Tukar DOCX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar DOCX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file DOCX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOCX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOCX Halaman File Online"
    content: |
       Tukar halaman file DOCX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/docx).
