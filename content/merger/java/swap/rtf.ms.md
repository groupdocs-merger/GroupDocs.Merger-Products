...
############################# Head ############################
head_title: "Tukar & Tukar RTF Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail RTF dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar RTF Halaman Dalam Java"
description: "Tukar RTF Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar RTF Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail RTF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar RTF halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar RTF halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar RTF Halaman Fail Dalam Talian"
    content: |
       Tukar RTF halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
