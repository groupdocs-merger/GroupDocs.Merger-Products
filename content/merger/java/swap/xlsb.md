...
head_description: "Swap & Exchange positions of two pages within a XLSB file in Java using the documents merger API."

############################# Header ############################
title: "Swap XLSB Pages In Java"
description: "Swap XLSB Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a XLSB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XLSB file pages using Java example code">}}
