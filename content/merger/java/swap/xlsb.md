...
description: "Swap & Exchange positions of two pages within a XLSB file using the file splitter API for Java & J2SE applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a XLSB file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within XLSB files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb) website.
