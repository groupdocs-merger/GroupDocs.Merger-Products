...
############################# Head ############################
head_title: "Ruil en ruil XLT pagina's in Java"
head_description: "Wissel en ruil posities van twee pagina's binnen een XLT bestand in Java met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel XLT pagina's in Java"
description: "Verwissel XLT pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwissel XLT Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een XLT bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLT bestandspagina's te wisselen met behulp van Java voorbeeldcode">}}
