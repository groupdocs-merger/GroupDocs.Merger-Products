...
############################# Head ############################
head_title: "Bytt og bytt ut ODT sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en ODT-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt ODT sider i Java"
description: "Bytt ODT-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt ODT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en ODT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte ODT filsider ved å bruke Java eksempelkode">}}
