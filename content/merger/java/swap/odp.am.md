...
############################# Head ############################
head_title: "በJava ውስጥ ODP ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በJava ውስጥ ባለው የODP ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "ODP ገጾችን በJava ውስጥ ይቀያይሩ"
description: "ODP ገጾችን በጥቂት የJava ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "ODP የፋይል ገጾችን በJava ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በODP ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP የፋይል ገጾችን Java ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የODP ፋይል ገጾችን ይቀይሩ
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - የODP ፋይል ገጾችን በመስመር ላይ ይቀያይሩ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) ድር ጣቢያን በመጎብኘት የODP ፋይል ገጾችን አሁኑኑ ይቀይሩ።
