...
############################# Head ############################
head_title: "Tukar & Tukar XLS Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLS dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLS Halaman Dalam Java"
description: "Tukar XLS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLS Halaman Fail Dalam Talian"
    content: |
       Tukar XLS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
