...
############################# Head ############################
head_title: "Ruil en ruil XLTM bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLTM-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLTM bladsye in Java"
description: "Ruil XLTM Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil XLTM lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLTM-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTM lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil XLTM lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil XLTM lêerbladsye aanlyn"
    content: |
       Ruil nou XLTM lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm) webwerf te besoek.
