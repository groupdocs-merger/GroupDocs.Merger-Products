...
############################# Head ############################
head_title: "Apmainīt un apmainīt ONE lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ONE failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ONE lapas programmā Java"
description: "Apmainiet ONE lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ONE faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām ONE failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ONE faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet ONE faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt ONE failu lapas tiešsaistē"
    content: |
       Apmainiet ONE faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
