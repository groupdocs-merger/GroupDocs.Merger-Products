...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ODP puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ODP faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ODP puslapius Java"
description: "Pakeiskite ODP puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ODP failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais ODP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ODP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite ODP failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite ODP failų puslapiais internete"
    content: |
       Apkeiskite ODP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) svetainėje.
