...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLT lapas programmā Java"
description: "Apmainiet XLT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLT failu lapas tiešsaistē"
    content: |
       Apmainiet XLT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt).
