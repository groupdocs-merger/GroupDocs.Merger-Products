...
############################# Head ############################
head_title: "Vahetage ja vahetage DOCX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOCX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOCX lehte keeles Java"
description: "Vahetage DOCX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOCX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis DOCX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOCX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili DOCX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus DOCX faililehte"
    content: |
       Vahetage kohe DOCX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx).
