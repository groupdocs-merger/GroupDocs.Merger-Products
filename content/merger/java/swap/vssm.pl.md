...
############################# Head ############################
head_title: "Zamień i zamień VSSM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSSM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSSM strony w Java"
description: "Zamień strony VSSM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSSM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VSSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSSM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VSSM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VSSM strony plików online"
    content: |
       Zamień strony plików VSSM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
