...
############################# Head ############################
head_title: "Vymeňte a vymeňte HTML stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore HTML v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte HTML stránky v Java"
description: "Vymeňte HTML stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte HTML strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru HTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru HTML pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte HTML stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte HTML stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi HTML hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
