...
############################# Head ############################
head_title: "Zamień i zamień PPT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPT strony w Java"
description: "Zamień strony PPT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku PPT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPT przy użyciu przykładowego kodu Java">}}
