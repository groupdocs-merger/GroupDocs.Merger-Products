...
############################# Head ############################
head_title: "Apmainīt un apmainīt OTT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas OTT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt OTT lapas programmā Java"
description: "Apmainiet OTT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt OTT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām OTT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt OTT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet OTT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt OTT failu lapas tiešsaistē"
    content: |
       Apmainiet OTT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
