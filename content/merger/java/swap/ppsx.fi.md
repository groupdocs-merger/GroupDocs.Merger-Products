...
############################# Head ############################
head_title: "Vaihda ja vaihda PPSX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPSX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPSX sivua Java"
description: "Vaihda PPSX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPSX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja PPSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda PPSX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda PPSX tiedostosivua verkossa"
    content: |
       Vaihda PPSX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx) -sivustolla.
