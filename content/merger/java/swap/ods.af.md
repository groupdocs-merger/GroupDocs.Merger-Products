...
############################# Head ############################
head_title: "Ruil en ruil ODS bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n ODS-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil ODS bladsye in Java"
description: "Ruil ODS Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil ODS lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n ODS-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODS lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil ODS lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil ODS lêerbladsye aanlyn"
    content: |
       Ruil nou ODS lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) webwerf te besoek.
