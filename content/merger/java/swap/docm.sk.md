...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOCM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOCM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOCM stránky v Java"
description: "Vymeňte DOCM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOCM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOCM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOCM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte DOCM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte DOCM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi DOCM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
