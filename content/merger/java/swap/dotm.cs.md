...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOTM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOTM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOTM stránky v Java"
description: "Vyměňte DOTM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOTM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru DOTM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte DOTM stránky souborů online"
    content: |
       Vyměňte stránky souborů DOTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
