...
############################# Head ############################
head_title: "Vymeňte a vymeňte OTT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore OTT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte OTT stránky v Java"
description: "Vymeňte OTT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte OTT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru OTT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru OTT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte OTT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte OTT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi OTT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
