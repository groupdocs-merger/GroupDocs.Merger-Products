...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLSM stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLSM datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLSM stranice u Java"
description: "Zamijenite XLSM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLSM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar XLSM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLSM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite XLSM stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite XLSM stranice datoteka na mreži"
    content: |
       Odmah zamijenite XLSM stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm) web mjesto.
