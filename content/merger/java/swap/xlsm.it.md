...
############################# Head ############################
head_title: "Scambia e scambia XLSM pagine in Java"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file XLSM in Java utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia XLSM pagine in Java"
description: "Scambia le pagine XLSM con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Scambia XLSM pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di scambiare facilmente le pagine all'interno di un file XLSM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file XLSM utilizzando il codice di esempio Java">}}

        ```java    
        // Scambia le pagine dei file XLSM utilizzando l'API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo dal vivo - Scambia XLSM pagine di file online"
    content: |
       Scambia subito le pagine dei file XLSM visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
