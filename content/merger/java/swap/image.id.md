...
############################# Head ############################
head_title: "Tukar & Tukarkan IMAGE Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file IMAGE di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar IMAGE Halaman Di Java"
description: "Tukar IMAGE Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar IMAGE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file IMAGE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file IMAGE menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar IMAGE Halaman File Online"
    content: |
       Tukar halaman file IMAGE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/image).
