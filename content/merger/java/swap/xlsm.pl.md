...
############################# Head ############################
head_title: "Zamień i zamień XLSM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSM strony w Java"
description: "Zamień strony XLSM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLSM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLSM strony plików online"
    content: |
       Zamień strony plików XLSM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
