...
############################# Head ############################
head_title: "تبادل الصفحات EPUB في Java"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف EPUB في Java باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات EPUB في Java"
description: "استبدل الصفحات EPUB ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات EPUB في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تبديل الصفحات داخل ملف EPUB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف EPUB باستخدام كود مثال Java">}}

        ```java    
        // قم بتبديل صفحات ملف EPUB باستخدام GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بتبديل EPUB صفحات الملفات عبر الإنترنت"
    content: |
       قم بتبديل صفحات ملف EPUB الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub).
