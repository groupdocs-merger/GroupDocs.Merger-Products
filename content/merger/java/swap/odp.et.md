...
############################# Head ############################
head_title: "Vahetage ja vahetage ODP lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODP failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODP lehte keeles Java"
description: "Vahetage ODP lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODP faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis ODP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODP faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili ODP lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus ODP faililehte"
    content: |
       Vahetage kohe ODP faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
