...
############################# Head ############################
head_title: "Vahetage ja vahetage ODS lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODS failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODS lehte keeles Java"
description: "Vahetage ODS lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis ODS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili ODS lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus ODS faililehte"
    content: |
       Vahetage kohe ODS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods).
