...
############################# Head ############################
head_title: "Vahetage ja vahetage VDX lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VDX failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VDX lehte keeles Java"
description: "Vahetage VDX lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VDX faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis VDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VDX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili VDX lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus VDX faililehte"
    content: |
       Vahetage kohe VDX faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
