...
############################# Head ############################
head_title: "Vahetage ja vahetage PPS lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPS failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPS lehte keeles Java"
description: "Vahetage PPS lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis PPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili PPS lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus PPS faililehte"
    content: |
       Vahetage kohe PPS faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps).
