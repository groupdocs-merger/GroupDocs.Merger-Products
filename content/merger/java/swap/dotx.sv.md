...
############################# Head ############################
head_title: "Byt och byt ut DOTX sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en DOTX-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOTX sidor i Java"
description: "Byt DOTX-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt DOTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en DOTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt DOTX filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut DOTX filsidor online"
    content: |
       Byt DOTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
