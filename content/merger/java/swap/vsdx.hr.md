...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSDX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSDX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSDX stranice u Java"
description: "Zamijenite VSDX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSDX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar VSDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSDX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite VSDX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite VSDX stranice datoteka na mreži"
    content: |
       Odmah zamijenite VSDX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) web mjesto.
