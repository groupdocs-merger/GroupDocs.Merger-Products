...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLTX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLTX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLTX lapas programmā Java"
description: "Apmainiet XLTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLTX failu lapas tiešsaistē"
    content: |
       Apmainiet XLTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
