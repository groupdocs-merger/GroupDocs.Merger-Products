...
############################# Head ############################
head_title: "Vahetage ja vahetage XLT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLT lehte keeles Java"
description: "Vahetage XLT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLT faililehte, kasutades Java näitekoodi">}}
