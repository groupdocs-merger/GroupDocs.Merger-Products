...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi ODP Trang trong Java"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp ODP trong Java bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi ODP Trang trong Java"
description: "Hoán đổi các trang ODP bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Hoán đổi ODP Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng hoán đổi các trang trong một tệp ODP bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp ODP bằng mã mẫu Java">}}

        ```java    
        // Hoán đổi các trang tệp ODP bằng API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
