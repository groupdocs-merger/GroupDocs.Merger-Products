...
############################# Head ############################
head_title: "Vahetage ja vahetage PDF lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PDF failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PDF lehte keeles Java"
description: "Vahetage PDF lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PDF faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis PDF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PDF faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili PDF lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus PDF faililehte"
    content: |
       Vahetage kohe PDF faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf).
