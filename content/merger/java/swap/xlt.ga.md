...
############################# Head ############################
head_title: "Babhtáil & Malartú XLT Leathanaigh i Java"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad XLT in Java ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil XLT Leathanaigh i Java"
description: "Malartú XLT Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Babhtáil XLT Leathanaigh Chomhaid i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanaigh a mhalartú laistigh de chomhad XLT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XLT a mhalartú le cód samplach Java">}}
