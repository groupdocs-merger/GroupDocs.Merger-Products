...
############################# Head ############################
head_title: "Vaihda ja vaihda VSDM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSDM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSDM sivua Java"
description: "Vaihda VSDM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSDM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSDM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSDM tiedostosivua käyttämällä Java esimerkkikoodia">}}
