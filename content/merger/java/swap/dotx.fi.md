...
############################# Head ############################
head_title: "Vaihda ja vaihda DOTX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOTX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOTX sivua Java"
description: "Vaihda DOTX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja DOTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOTX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda DOTX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda DOTX tiedostosivua verkossa"
    content: |
       Vaihda DOTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx) -sivustolla.
