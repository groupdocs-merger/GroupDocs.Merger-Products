...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PDF puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PDF faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PDF puslapius Java"
description: "Pakeiskite PDF puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PDF failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais PDF faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PDF failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite PDF failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite PDF failų puslapiais internete"
    content: |
       Apkeiskite PDF failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf) svetainėje.
