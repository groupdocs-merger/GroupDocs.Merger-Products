...
############################# Head ############################
head_title: "Tukar & Tukarkan XLS Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLS di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLS Halaman Di Java"
description: "Tukar XLS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLS menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLS Halaman File Online"
    content: |
       Tukar halaman file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xls).
