...
############################# Head ############################
head_title: "Vyměňte a vyměňte OTP stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru OTP v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit OTP stránky v Java"
description: "Vyměňte OTP stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte OTP stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru OTP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru OTP pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru OTP pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte OTP stránky souborů online"
    content: |
       Vyměňte stránky souborů OTP hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
