...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSDM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSDM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSDM stránky v Java"
description: "Vymeňte VSDM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSDM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSDM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSDM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSDM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSDM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSDM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
