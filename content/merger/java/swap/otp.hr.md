...
############################# Head ############################
head_title: "Zamijeni i razmijeni OTP stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar OTP datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni OTP stranice u Java"
description: "Zamijenite OTP stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni OTP stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar OTP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti OTP stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite OTP stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite OTP stranice datoteka na mreži"
    content: |
       Odmah zamijenite OTP stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp) web mjesto.
