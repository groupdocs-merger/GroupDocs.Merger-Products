...
############################# Head ############################
head_title: "Ruil en ruil DOT bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n DOT-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil DOT bladsye in Java"
description: "Ruil DOT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil DOT lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOT-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOT lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil DOT lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil DOT lêerbladsye aanlyn"
    content: |
       Ruil nou DOT lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) webwerf te besoek.
