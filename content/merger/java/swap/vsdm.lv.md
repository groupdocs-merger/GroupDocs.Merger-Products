...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSDM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSDM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSDM lapas programmā Java"
description: "Apmainiet VSDM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSDM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSDM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSDM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSDM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSDM failu lapas tiešsaistē"
    content: |
       Apmainiet VSDM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
