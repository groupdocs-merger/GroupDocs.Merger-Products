...
############################# Head ############################
head_title: "Ruil en ruil DOTX bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n DOTX-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil DOTX bladsye in Java"
description: "Ruil DOTX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil DOTX lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n DOTX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOTX lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil DOTX lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil DOTX lêerbladsye aanlyn"
    content: |
       Ruil nou DOTX lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx) webwerf te besoek.
