...
############################# Head ############################
head_title: "Vyměňte a vyměňte TEX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru TEX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit TEX stránky v Java"
description: "Vyměňte TEX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte TEX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru TEX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru TEX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru TEX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte TEX stránky souborů online"
    content: |
       Vyměňte stránky souborů TEX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
