...
############################# Head ############################
head_title: "Bytt og bytt ut OTP sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en OTP-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt OTP sider i Java"
description: "Bytt OTP-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt OTP filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en OTP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte OTP filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt OTP filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut OTP filsider på nettet"
    content: |
       Bytt ut OTP-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
