...
############################# Head ############################
head_title: "Skiptu og skiptu á XLTX síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í XLTX skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um XLTX síður í Java"
description: "Skiptu um XLTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um XLTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan XLTX skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um XLTX skráarsíður með því að nota Java dæmikóða">}}
