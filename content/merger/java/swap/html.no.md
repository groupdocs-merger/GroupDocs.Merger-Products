...
############################# Head ############################
head_title: "Bytt og bytt ut HTML sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en HTML-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt HTML sider i Java"
description: "Bytt HTML-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt HTML filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en HTML-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte HTML filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Bytt HTML filsider ved hjelp av GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-demoer - Bytt ut HTML filsider på nettet"
    content: |
       Bytt ut HTML-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
