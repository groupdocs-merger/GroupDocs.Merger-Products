...
############################# Head ############################
head_title: "Vymeňte a vymeňte OTP stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore OTP v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte OTP stránky v Java"
description: "Vymeňte OTP stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte OTP strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru OTP implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru OTP pomocou vzorového kódu Java">}}
