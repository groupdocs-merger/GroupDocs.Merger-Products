...
############################# Head ############################
head_title: "Apmainīt un apmainīt MHTML lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas MHTML failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt MHTML lapas programmā Java"
description: "Apmainiet MHTML lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt MHTML faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām MHTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt MHTML faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet MHTML faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt MHTML failu lapas tiešsaistē"
    content: |
       Apmainiet MHTML faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
