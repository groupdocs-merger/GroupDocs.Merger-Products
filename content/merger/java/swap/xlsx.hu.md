...
############################# Head ############################
head_title: "Cserélj és cserélj XLSX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSX oldal cseréje a Java nyelven"
description: "Cserélje ki az XLSX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLSX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XLSX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLSX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) webhely meglátogatásával azonnal cseréljen XLSX fájloldalt.
