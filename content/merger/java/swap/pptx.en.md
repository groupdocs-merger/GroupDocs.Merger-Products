...
############################# Head ############################
head_title: "Swap pages in PPTX files with Java apps"
head_description: "Use GroupDocs.Merger for Java to rearrange pages in PPTX documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap PPTX pages" 
description: "GroupDocs.Merger for Java enhances Java applications with flexible document manipulation features. Reorder pages in PPTX files to streamline content structure."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) simplifies page reordering in PPTX documents, giving you full control over content organization. Integrate seamless document processing into your Java applications.
