...
############################# Head ############################
head_title: "Tausche & tausche XLSX Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer XLSX-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche XLSX Seiten in Java"
description: "Tauschen Sie XLSX-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "XLSX Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer XLSX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie XLSX-Dateiseiten mit Java-Beispielcode aus">}}

        ```java    
        // Tauschen Sie XLSX Dateiseiten mit der GroupDocs.Merger API aus
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-Demos - Tauschen Sie XLSX Dateiseiten online aus"
    content: |
       Tauschen Sie jetzt XLSX Dateiseiten aus, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) besuchen.
