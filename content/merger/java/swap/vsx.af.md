...
############################# Head ############################
head_title: "Ruil en ruil VSX bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n VSX-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil VSX bladsye in Java"
description: "Ruil VSX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil VSX lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n VSX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSX lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil VSX lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil VSX lêerbladsye aanlyn"
    content: |
       Ruil nou VSX lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx) webwerf te besoek.
