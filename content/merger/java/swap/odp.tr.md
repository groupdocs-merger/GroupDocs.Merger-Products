...
############################# Head ############################
head_title: "ODP Sayfalarını Java İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir ODP dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "ODP Sayfayı Java İçinde Değiştir"
description: "ODP Sayfalarını birkaç satır Java koduyla değiştirin."
...
steps:
    enable: true
    title_left: "Java içindeki ODP Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir ODP dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak ODP dosya sayfaları nasıl değiştirilir?">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak ODP dosya sayfalarını değiştirin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - ODP Dosya Sayfalarını Çevrimiçi Değiştirin"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) web sitesini ziyaret ederek ODP dosya sayfalarını hemen değiştirin.
