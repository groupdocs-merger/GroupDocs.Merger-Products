...
draft: false
############################# Head ############################
head_title: "Подкачка и обмен TEX-страницами в Java"
head_description: "Пользователи Java могут поменять местами две страницы в файле TEX, используя API слияния и разделения документов."
############################# Header ############################
title: "Подкачка и обмен TEX-страницами в Java"
description: "Поменяйте местами и обменяйте позиции двух страниц в файле TEX с помощью API-разделителя файлов для приложений Java и J2SE."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов TEX в Java"
    content_left: |
        [GroupDocs.Merger](/ru/merger/java/) позволяет разработчикам Java легко менять местами, обмениваться и упорядочивать страницы в файле TEX, выполняя несколько простых шагов.
    ...
    code: |
        ```java
        // Поменять местами страницы файла TEX с помощью API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Живые демонстрации - Обмен страницами файлов TEX онлайн"
    content: |
        Обменивайтесь страницами в файлах TEX прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/tex). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
