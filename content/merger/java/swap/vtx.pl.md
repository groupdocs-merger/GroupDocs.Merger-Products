...
############################# Head ############################
head_title: "Zamień i zamień VTX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VTX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VTX strony w Java"
description: "Zamień strony VTX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VTX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VTX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VTX strony plików online"
    content: |
       Zamień strony plików VTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
