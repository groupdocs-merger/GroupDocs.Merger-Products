...
head_description: "Swap & Exchange positions of two pages within a VSTM file in Java using the documents merger API."

############################# Header ############################
title: "Swap VSTM Pages In Java"
description: "Swap VSTM Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a VSTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSTM file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap VSTM file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm) website.
