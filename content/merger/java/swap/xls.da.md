...
############################# Head ############################
head_title: "Byt og byt XLS sider i Java"
head_description: "Byt og udveksle positioner på to sider i en XLS-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLS sider i Java"
description: "Byt XLS sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt XLS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en XLS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLS filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift XLS filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt XLS filsider online"
    content: |
       Skift XLS filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
