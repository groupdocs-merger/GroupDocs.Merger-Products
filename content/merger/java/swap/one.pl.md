...
############################# Head ############################
head_title: "Zamień i zamień ONE strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ONE w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ONE strony w Java"
description: "Zamień strony ONE na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików ONE w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku ONE, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ONE przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików ONE za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień ONE strony plików online"
    content: |
       Zamień strony plików ONE już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
