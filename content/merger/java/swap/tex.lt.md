...
############################# Head ############################
head_title: "Sukeiskite ir keiskite TEX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas TEX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti TEX puslapius Java"
description: "Pakeiskite TEX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti TEX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais TEX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti TEX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite TEX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite TEX failų puslapiais internete"
    content: |
       Apkeiskite TEX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex) svetainėje.
