...
############################# Head ############################
head_title: "Cserélj és cserélj VTX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VTX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VTX oldal cseréje a Java nyelven"
description: "Cserélje ki az VTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VTX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VTX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VTX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VTX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx) webhely meglátogatásával azonnal cseréljen VTX fájloldalt.
