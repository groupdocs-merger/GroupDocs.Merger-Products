...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOC stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOC v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOC stránky v Java"
description: "Vyměňte DOC stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOC stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOC provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOC pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru DOC pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte DOC stránky souborů online"
    content: |
       Vyměňte stránky souborů DOC hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
