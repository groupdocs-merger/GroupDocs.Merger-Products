...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOCX stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOCX datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOCX stranice u Java"
description: "Zamijenite DOCX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOCX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar DOCX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOCX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite DOCX stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite DOCX stranice datoteka na mreži"
    content: |
       Odmah zamijenite DOCX stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx) web mjesto.
