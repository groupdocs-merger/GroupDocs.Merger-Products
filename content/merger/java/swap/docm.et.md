...
############################# Head ############################
head_title: "Vahetage ja vahetage DOCM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOCM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOCM lehte keeles Java"
description: "Vahetage DOCM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOCM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis DOCM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOCM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili DOCM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus DOCM faililehte"
    content: |
       Vahetage kohe DOCM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
