...
############################# Head ############################
head_title: "Tukar & Tukarkan PPSX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPSX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPSX Halaman Di Java"
description: "Tukar PPSX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar PPSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file PPSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPSX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPSX Halaman File Online"
    content: |
       Tukar halaman file PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/ppsx).
