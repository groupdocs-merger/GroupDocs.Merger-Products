...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOCM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOCM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOCM stránky v Java"
description: "Vyměňte DOCM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte DOCM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru DOCM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOCM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru DOCM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte DOCM stránky souborů online"
    content: |
       Vyměňte stránky souborů DOCM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
