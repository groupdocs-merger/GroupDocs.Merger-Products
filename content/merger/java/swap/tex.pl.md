...
############################# Head ############################
head_title: "Zamień i zamień TEX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku TEX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień TEX strony w Java"
description: "Zamień strony TEX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików TEX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku TEX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku TEX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików TEX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień TEX strony plików online"
    content: |
       Zamień strony plików TEX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
