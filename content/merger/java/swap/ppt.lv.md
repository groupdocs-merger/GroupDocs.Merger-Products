...
############################# Head ############################
head_title: "Apmainīt un apmainīt PPT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas PPT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt PPT lapas programmā Java"
description: "Apmainiet PPT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt PPT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām PPT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt PPT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet PPT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt PPT failu lapas tiešsaistē"
    content: |
       Apmainiet PPT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
