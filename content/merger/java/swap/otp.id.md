...
############################# Head ############################
head_title: "Tukar & Tukarkan OTP Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file OTP di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTP Halaman Di Java"
description: "Tukar OTP Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar OTP Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file OTP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file OTP menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar OTP Halaman File Online"
    content: |
       Tukar halaman file OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/otp).
