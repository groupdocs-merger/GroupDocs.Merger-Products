...
############################# Head ############################
head_title: "Tausche & tausche VSDX Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSDX-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSDX Seiten in Java"
description: "Tauschen Sie VSDX-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "VSDX Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSDX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSDX-Dateiseiten mit Java-Beispielcode aus">}}

        ```java    
        // Tauschen Sie VSDX Dateiseiten mit der GroupDocs.Merger API aus
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-Demos - Tauschen Sie VSDX Dateiseiten online aus"
    content: |
       Tauschen Sie jetzt VSDX Dateiseiten aus, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) besuchen.
