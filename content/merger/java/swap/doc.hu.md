...
############################# Head ############################
head_title: "Cserélj és cserélj DOC oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOC fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOC oldal cseréje a Java nyelven"
description: "Cserélje ki az DOC oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOC fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy DOC fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOC fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az DOC fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOC fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc) webhely meglátogatásával azonnal cseréljen DOC fájloldalt.
