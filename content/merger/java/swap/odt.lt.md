...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ODT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ODT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ODT puslapius Java"
description: "Pakeiskite ODT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ODT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais ODT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ODT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite ODT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite ODT failų puslapiais internete"
    content: |
       Apkeiskite ODT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt) svetainėje.
