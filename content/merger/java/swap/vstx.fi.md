...
############################# Head ############################
head_title: "Vaihda ja vaihda VSTX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSTX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSTX sivua Java"
description: "Vaihda VSTX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSTX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSTX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSTX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSTX tiedostosivua verkossa"
    content: |
       Vaihda VSTX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx) -sivustolla.
