...
############################# Head ############################
head_title: "Hoán đổi các trang trong tệp EPUB với các ứng dụng Java"
head_description: "Sử dụng GroupDocs.Merger for Java để sắp xếp lại các trang trong tài liệu EPUB. Thay đổi các tệp PDF, Word, bảng tính, thuyết trình, sơ đồ Visio, hình ảnh, lưu trữ và hơn thế nữa."

############################# Header ############################
title: "Hoán đổi các trang EPUB" 
description: "GroupDocs.Merger for Java mở rộng các ứng dụng Java với các tính năng thao tác tài liệu linh hoạt. Sắp xếp lại các trang trong các tệp EPUB để cải thiện cấu trúc nội dung."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) đơn giản hóa việc sắp xếp lại các trang trong tài liệu EPUB, tạo cho bạn quyền kiểm soát hoàn toàn đối với việc tổ chức nội dung. Tích hợp quy trình xử lý tài liệu liền mạch vào ứng dụng Java của bạn.
      
      1. Định nghĩa đường dẫn đến tệp EPUB.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hoán đổi trang đầu tiên và trang cuối cùng trong tệp EPUB"
      content: |
        Ví dụ này cho thấy cách hoán đổi các trang trong tệp EPUB chỉ với vài bước đơn giản.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
