...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSSM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSSM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSSM puslapius Java"
description: "Pakeiskite VSSM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSSM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSSM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSSM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSSM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSSM failų puslapiais internete"
    content: |
       Apkeiskite VSSM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm) svetainėje.
