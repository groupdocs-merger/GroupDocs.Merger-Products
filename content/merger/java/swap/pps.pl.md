...
############################# Head ############################
head_title: "Zamień i zamień PPS strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPS w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPS strony w Java"
description: "Zamień strony PPS na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku PPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPS przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików PPS za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień PPS strony plików online"
    content: |
       Zamień strony plików PPS już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps).
