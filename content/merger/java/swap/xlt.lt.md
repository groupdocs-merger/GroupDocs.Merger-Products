...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLT puslapius Java"
description: "Pakeiskite XLT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLT failų puslapiais internete"
    content: |
       Apkeiskite XLT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt) svetainėje.
