...
############################# Head ############################
head_title: "Tukar & Tukarkan EPUB Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file EPUB di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EPUB Halaman Di Java"
description: "Tukar EPUB Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar EPUB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file EPUB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file EPUB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar EPUB Halaman File Online"
    content: |
       Tukar halaman file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/epub).
