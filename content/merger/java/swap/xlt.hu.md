...
############################# Head ############################
head_title: "Cserélj és cserélj XLT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLT oldal cseréje a Java nyelven"
description: "Cserélje ki az XLT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XLT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt) webhely meglátogatásával azonnal cseréljen XLT fájloldalt.
