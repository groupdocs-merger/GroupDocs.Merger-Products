...
############################# Head ############################
head_title: "Vymeňte a vymeňte PPSX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PPSX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PPSX stránky v Java"
description: "Vymeňte PPSX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte PPSX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru PPSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PPSX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte PPSX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte PPSX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi PPSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx).
