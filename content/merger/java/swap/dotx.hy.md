...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել DOTX էջեր Java-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը DOTX ֆայլում Java-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք DOTX էջեր Java-ում"
description: "Փոխեք DOTX էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք DOTX ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java ծրագրավորողների համար էջերը փոխանակել DOTX ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել DOTX ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}
