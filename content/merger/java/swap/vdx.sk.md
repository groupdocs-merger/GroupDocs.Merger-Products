...
############################# Head ############################
head_title: "Vymeňte a vymeňte VDX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VDX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VDX stránky v Java"
description: "Vymeňte VDX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VDX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VDX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VDX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VDX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VDX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VDX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
