...
############################# Head ############################
head_title: "Bytt og bytt ut XLT sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLT-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLT sider i Java"
description: "Bytt XLT-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt XLT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en XLT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLT filsider ved å bruke Java eksempelkode">}}
