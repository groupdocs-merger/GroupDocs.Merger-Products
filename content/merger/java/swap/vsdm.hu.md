...
############################# Head ############################
head_title: "Cserélj és cserélj VSDM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSDM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDM oldal cseréje a Java nyelven"
description: "Cserélje ki az VSDM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSDM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSDM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSDM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSDM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSDM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm) webhely meglátogatásával azonnal cseréljen VSDM fájloldalt.
