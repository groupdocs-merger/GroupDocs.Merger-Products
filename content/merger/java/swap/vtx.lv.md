...
############################# Head ############################
head_title: "Apmainīt un apmainīt VTX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VTX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VTX lapas programmā Java"
description: "Apmainiet VTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VTX failu lapas tiešsaistē"
    content: |
       Apmainiet VTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vtx).
