...
############################# Head ############################
head_title: "Vyměňte a vyměňte ODP stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ODP v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ODP stránky v Java"
description: "Vyměňte ODP stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte ODP stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru ODP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ODP pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru ODP pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte ODP stránky souborů online"
    content: |
       Vyměňte stránky souborů ODP hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
