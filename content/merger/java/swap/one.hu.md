...
############################# Head ############################
head_title: "Cserélj és cserélj ONE oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ONE fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ONE oldal cseréje a Java nyelven"
description: "Cserélje ki az ONE oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ONE fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy ONE fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ONE fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az ONE fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ONE fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one) webhely meglátogatásával azonnal cseréljen ONE fájloldalt.
