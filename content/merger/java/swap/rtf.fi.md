...
############################# Head ############################
head_title: "Vaihda ja vaihda RTF sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja RTF-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda RTF sivua Java"
description: "Vaihda RTF-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda RTF tiedostosivua tuotteessa Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa RTF tiedostosivua käyttämällä Java esimerkkikoodia">}}
