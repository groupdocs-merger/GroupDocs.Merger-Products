...
head_description: "Tukar & Tukar posisi dua halaman dalam file WEB di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar WEB Halaman Di Java"
description: "Tukar WEB Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar WEB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file WEB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file WEB menggunakan kode contoh Java">}}
