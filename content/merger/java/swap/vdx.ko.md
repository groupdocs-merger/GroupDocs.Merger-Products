...
############################# Head ############################
head_title: "Java에서 VDX 페이지 교환 및 교환"
head_description: "문서 병합 API를 사용하여 Java의 VDX 파일 내 두 페이지의 위치를 ​​교환 및 교환합니다."

############################# Header ############################
title: "Java에서 VDX 페이지 교체"
description: "몇 줄의 Java 코드로 VDX 페이지를 바꿉니다."
...
steps:
    enable: true
    title_left: "Java에서 VDX 파일 페이지 교체"
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 몇 가지 간단한 단계를 구현하여 Java 개발자가 VDX 파일 내에서 페이지를 쉽게 교환할 수 있습니다. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 VDX 파일 페이지를 바꾸는 방법">}}

        ```java    
        // GroupDocs.Merger API를 사용하여 VDX 파일 페이지 교체
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "라이브 데모 - 온라인에서 VDX 파일 페이지 교체"
    content: |
       지금 바로 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx) 웹사이트를 방문하여 VDX 파일 페이지를 교체하세요.
