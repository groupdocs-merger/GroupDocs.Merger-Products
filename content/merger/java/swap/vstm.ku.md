...
############################# Head ############################
head_title: "Biguherîne û biguherîne VSTM Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek VSTM de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne VSTM Rûpelên Di Java de"
description: "Rûpelên VSTM bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de VSTM Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên VSTM bi karanîna koda nimûneya Java veguhezîne">}}
