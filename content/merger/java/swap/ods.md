...
head_description: "Swap & Exchange positions of two pages within a ODS file in Java using the documents merger API."

############################# Header ############################
title: "Swap ODS Pages In Java"
description: "Swap ODS Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ODS file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap ODS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) website.
