...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLTX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLTX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLTX puslapius Java"
description: "Pakeiskite XLTX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLTX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLTX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLTX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLTX failų puslapiais internete"
    content: |
       Apkeiskite XLTX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx) svetainėje.
