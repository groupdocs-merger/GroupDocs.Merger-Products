...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPT puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPT faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPT puslapius Java"
description: "Pakeiskite PPT puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPT failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais PPT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPT failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite PPT failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite PPT failų puslapiais internete"
    content: |
       Apkeiskite PPT failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt) svetainėje.
