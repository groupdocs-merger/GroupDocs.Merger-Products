...
############################# Head ############################
head_title: "Java ішіндегі XLS беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы XLS файлындағы екі беттің орнын Java арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "XLS беттерді Java арқылы ауыстыру"
description: "XLS беттерді Java кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі XLS файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы XLS файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS файл беттерін Java мысал коды арқылы ауыстыру жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы XLS файл бетін ауыстырыңыз
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - XLS файл беттерін онлайн ауыстырыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls) веб-сайтына кіру арқылы XLS файл бетін дәл қазір ауыстырыңыз.
