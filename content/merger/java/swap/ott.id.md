...
############################# Head ############################
head_title: "Tukar & Tukarkan OTT Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file OTT di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTT Halaman Di Java"
description: "Tukar OTT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar OTT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file OTT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file OTT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar OTT Halaman File Online"
    content: |
       Tukar halaman file OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/ott).
