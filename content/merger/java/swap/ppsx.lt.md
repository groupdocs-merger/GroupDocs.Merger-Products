...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPSX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPSX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPSX puslapius Java"
description: "Pakeiskite PPSX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPSX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais PPSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite PPSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite PPSX failų puslapiais internete"
    content: |
       Apkeiskite PPSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppsx) svetainėje.
