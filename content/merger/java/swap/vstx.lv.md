...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSTX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSTX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSTX lapas programmā Java"
description: "Apmainiet VSTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSTX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSTX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSTX failu lapas tiešsaistē"
    content: |
       Apmainiet VSTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx).
