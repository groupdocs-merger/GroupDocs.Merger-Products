...
############################# Head ############################
head_title: "Cserélj és cserélj DOCX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOCX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCX oldal cseréje a Java nyelven"
description: "Cserélje ki az DOCX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOCX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy DOCX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOCX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az DOCX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOCX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx) webhely meglátogatásával azonnal cseréljen DOCX fájloldalt.
