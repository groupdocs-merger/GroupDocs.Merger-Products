...
############################# Head ############################
head_title: "Vymeňte a vymeňte ONE stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ONE v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ONE stránky v Java"
description: "Vymeňte ONE stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte ONE strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru ONE implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ONE pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte ONE stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte ONE stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi ONE hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/one).
