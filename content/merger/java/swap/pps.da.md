...
############################# Head ############################
head_title: "Byt og byt PPS sider i Java"
head_description: "Byt og udveksle positioner på to sider i en PPS-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PPS sider i Java"
description: "Byt PPS sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt PPS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en PPS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PPS filsider ved hjælp af Java eksempelkode">}}
