...
############################# Head ############################
head_title: "Vyměňte a vyměňte ODS stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ODS v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ODS stránky v Java"
description: "Vyměňte ODS stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte ODS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru ODS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ODS pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru ODS pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte ODS stránky souborů online"
    content: |
       Vyměňte stránky souborů ODS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods).
