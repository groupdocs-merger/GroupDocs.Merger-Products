...
############################# Head ############################
head_title: "Tukar & Tukarkan XLT Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLT di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLT Halaman Di Java"
description: "Tukar XLT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLT Halaman File Online"
    content: |
       Tukar halaman file XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/xlt).
