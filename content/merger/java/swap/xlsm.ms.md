...
############################# Head ############################
head_title: "Tukar & Tukar XLSM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSM Halaman Dalam Java"
description: "Tukar XLSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLSM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLSM Halaman Fail Dalam Talian"
    content: |
       Tukar XLSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
