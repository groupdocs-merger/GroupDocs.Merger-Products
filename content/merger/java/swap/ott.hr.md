...
############################# Head ############################
head_title: "Zamijeni i razmijeni OTT stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar OTT datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni OTT stranice u Java"
description: "Zamijenite OTT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni OTT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar OTT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti OTT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite OTT stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite OTT stranice datoteka na mreži"
    content: |
       Odmah zamijenite OTT stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) web mjesto.
