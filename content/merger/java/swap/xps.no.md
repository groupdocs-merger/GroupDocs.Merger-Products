...
############################# Head ############################
head_title: "Bytt og bytt ut XPS sider i Java"
head_description: "Bytt og bytt ut posisjoner på to sider i en XPS-fil i Java ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XPS sider i Java"
description: "Bytt XPS-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Bytt XPS filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å bytte sider i en XPS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XPS filsider ved å bruke Java eksempelkode">}}
