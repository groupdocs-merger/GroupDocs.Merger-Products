...
############################# Head ############################
head_title: "Cserélj és cserélj MHTML oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy MHTML fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHTML oldal cseréje a Java nyelven"
description: "Cserélje ki az MHTML oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "MHTML fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy MHTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk MHTML fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az MHTML fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – MHTML fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml) webhely meglátogatásával azonnal cseréljen MHTML fájloldalt.
