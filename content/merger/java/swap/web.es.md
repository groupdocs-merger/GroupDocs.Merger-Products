...
############################# Head ############################
head_title: "Intercambiar e intercambiar WEB páginas en Java"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo WEB en Java utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar WEB páginas en Java"
description: "Intercambie WEB páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Intercambiar WEB páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java intercambiar páginas dentro de un archivo WEB mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos WEB usando el código de ejemplo Java">}}

        ```java    
        // Intercambiar WEB páginas de archivos usando GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo: intercambie WEB páginas de archivos en línea"
    content: |
       Cambie las páginas de archivos WEB ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/web).
