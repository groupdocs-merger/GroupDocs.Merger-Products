...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi XLSX Trang trong Java"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp XLSX trong Java bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi XLSX Trang trong Java"
description: "Hoán đổi các trang XLSX bằng một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Hoán đổi XLSX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java]({{sl slash_lang}}/merge/java/) giúp các nhà phát triển Java dễ dàng hoán đổi các trang trong một tệp XLSX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp XLSX bằng mã mẫu Java">}}

        ```java    
        // Hoán đổi các trang tệp XLSX bằng API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Trao đổi XLSX Trang Tệp Trực tuyến"
    content: |
       Hoán đổi các trang tệp XLSX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) trang web.
