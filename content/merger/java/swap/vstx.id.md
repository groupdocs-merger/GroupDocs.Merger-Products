...
############################# Head ############################
head_title: "Tukar & Tukarkan VSTX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSTX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTX Halaman Di Java"
description: "Tukar VSTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar VSTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file VSTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSTX Halaman File Online"
    content: |
       Tukar halaman file VSTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/vstx).
