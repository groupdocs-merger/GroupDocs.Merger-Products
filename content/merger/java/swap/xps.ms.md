...
############################# Head ############################
head_title: "Tukar & Tukar XPS Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XPS dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XPS Halaman Dalam Java"
description: "Tukar XPS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XPS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XPS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XPS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XPS Halaman Fail Dalam Talian"
    content: |
       Tukar XPS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps).
