...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել PPS էջեր Java-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը PPS ֆայլում Java-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք PPS էջեր Java-ում"
description: "Փոխեք PPS էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք PPS ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java ծրագրավորողների համար էջերը փոխանակել PPS ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել PPS ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}
