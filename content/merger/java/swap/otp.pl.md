...
############################# Head ############################
head_title: "Zamień i zamień OTP strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku OTP w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień OTP strony w Java"
description: "Zamień strony OTP na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików OTP w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku OTP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku OTP przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików OTP za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień OTP strony plików online"
    content: |
       Zamień strony plików OTP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
