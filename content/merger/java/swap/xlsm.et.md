...
############################# Head ############################
head_title: "Vahetage ja vahetage XLSM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLSM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLSM lehte keeles Java"
description: "Vahetage XLSM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLSM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLSM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili XLSM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus XLSM faililehte"
    content: |
       Vahetage kohe XLSM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
