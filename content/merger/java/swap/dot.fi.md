...
############################# Head ############################
head_title: "Vaihda ja vaihda DOT sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOT-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOT sivua Java"
description: "Vaihda DOT-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja DOT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda DOT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda DOT tiedostosivua verkossa"
    content: |
       Vaihda DOT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) -sivustolla.
