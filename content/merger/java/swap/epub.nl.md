...
############################# Head ############################
head_title: "Ruil en ruil EPUB pagina's in Java"
head_description: "Wissel en ruil posities van twee pagina's binnen een EPUB bestand in Java met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel EPUB pagina's in Java"
description: "Verwissel EPUB pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwissel EPUB Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om pagina's binnen een EPUB bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestandspagina's te wisselen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verwissel EPUB bestandspagina's met de GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live demo's - Verwissel EPUB bestandspagina's online"
    content: |
       Ruil EPUB bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub) te gaan.
