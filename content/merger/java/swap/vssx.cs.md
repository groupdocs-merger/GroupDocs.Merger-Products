...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSSX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSSX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSSX stránky v Java"
description: "Vyměňte VSSX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSSX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSSX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSSX stránky souborů online"
    content: |
       Vyměňte stránky souborů VSSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssx).
