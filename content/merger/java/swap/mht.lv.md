...
############################# Head ############################
head_title: "Apmainīt un apmainīt MHT lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas MHT failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt MHT lapas programmā Java"
description: "Apmainiet MHT lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt MHT faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām MHT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt MHT faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet MHT faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt MHT failu lapas tiešsaistē"
    content: |
       Apmainiet MHT faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
