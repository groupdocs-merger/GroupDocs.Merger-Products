...
############################# Head ############################
head_title: "Biguherîne û biguherîne DOC Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek DOC de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne DOC Rûpelên Di Java de"
description: "Rûpelên DOC bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de DOC Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek DOC de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên DOC bi karanîna koda nimûneya Java veguhezîne">}}

        ```java    
        // Rûpelên pelan ên DOC bi karanîna GroupDocs.Merger API-ê biguherînin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demokên Zindî - Biguherîne DOC Rûpelên Serhêl"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc) niha rûpelên pelê yên DOC biguherînin.
