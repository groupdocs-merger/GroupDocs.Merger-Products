...
############################# Head ############################
head_title: "Vyměňte a vyměňte MHT stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru MHT v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit MHT stránky v Java"
description: "Vyměňte MHT stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte MHT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru MHT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru MHT pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru MHT pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte MHT stránky souborů online"
    content: |
       Vyměňte stránky souborů MHT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
