...
############################# Head ############################
head_title: "Cserélj és cserélj ODS oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODS fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODS oldal cseréje a Java nyelven"
description: "Cserélje ki az ODS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODS fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy ODS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODS fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az ODS fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ODS fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) webhely meglátogatásával azonnal cseréljen ODS fájloldalt.
