...
############################# Head ############################
head_title: "交换和交换 Java 中的 MHTML 页"
head_description: "使用文档合并 API 在 Java 中的 MHTML 文件中交换和交换两个页面的位置。"

############################# Header ############################
title: "在 Java 中交换 MHTML 页"
description: "用几行 Java 代码交换 MHTML 个页面。"
...
steps:
    enable: true
    title_left: "交换 Java 中的 MHTML 个文件页"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 让 Java 开发人员通过执行几个简单的步骤轻松地在 MHTML 文件中交换页面.
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码交换 MHTML 文件页面">}}

        ```java    
        // 使用 GroupDocs.Merger API 交换 MHTML 文件页面
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "现场演示 - 在线交换 MHTML 文件页面"
    content: |
       立即访问 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml) 网站交换 MHTML 文件页面。
       现场演示具有以下好处。
