...
############################# Head ############################
head_title: "Troque e troque XLTM páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo XLTM em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar XLTM Páginas em Java"
description: "Troque XLTM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo XLTM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo XLTM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo XLTM usando o código de exemplo Java">}}

        ```java    
        // Troque as páginas do arquivo XLTM usando a API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Trocar páginas de arquivo XLTM on-line"
    content: |
       Troque as páginas do arquivo XLTM agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
