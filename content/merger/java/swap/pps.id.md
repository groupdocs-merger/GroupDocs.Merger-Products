...
############################# Head ############################
head_title: "Tukar & Tukarkan PPS Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPS di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPS Halaman Di Java"
description: "Tukar PPS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar PPS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file PPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPS menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPS Halaman File Online"
    content: |
       Tukar halaman file PPS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/pps).
