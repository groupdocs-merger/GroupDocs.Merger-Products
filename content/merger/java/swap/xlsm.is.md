...
date: 2022-11-10T15:13:39
draft: false
otherformats: one otp ott pdf pps ppsx ppt pptx rtf tex vdx vsdm vsdx vssm vssx vstm

############################# Head ############################
head_title: "Skiptu og skiptu á XLSM síðum í Java"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í XLSM skrá í Java með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um XLSM síður í Java"
description: "Skiptu um XLSM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Skiptu um XLSM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að skipta um síður innan XLSM skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um XLSM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Skiptu um XLSM skráarsíður með því að nota GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Sýningar í beinni - Skiptu um XLSM skráarsíður á netinu"
    content: |
       Skiptu um XLSM skráarsíður núna með því að fara á vefsíðu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
