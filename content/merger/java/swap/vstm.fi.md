...
############################# Head ############################
head_title: "Vaihda ja vaihda VSTM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSTM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSTM sivua Java"
description: "Vaihda VSTM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSTM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSTM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSTM tiedostosivua verkossa"
    content: |
       Vaihda VSTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm) -sivustolla.
