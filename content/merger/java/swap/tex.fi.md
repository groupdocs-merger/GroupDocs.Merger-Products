...
############################# Head ############################
head_title: "Vaihda ja vaihda TEX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja TEX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda TEX sivua Java"
description: "Vaihda TEX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda TEX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja TEX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa TEX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda TEX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda TEX tiedostosivua verkossa"
    content: |
       Vaihda TEX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex) -sivustolla.
