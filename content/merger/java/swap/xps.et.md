...
############################# Head ############################
head_title: "Vahetage ja vahetage XPS lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XPS failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XPS lehte keeles Java"
description: "Vahetage XPS lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XPS faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XPS faililehte, kasutades Java näitekoodi">}}
