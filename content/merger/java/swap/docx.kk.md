...
############################# Head ############################
head_title: "Java ішіндегі DOCX беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы DOCX файлындағы екі беттің орнын Java арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "DOCX беттерді Java арқылы ауыстыру"
description: "DOCX беттерді Java кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі DOCX файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы DOCX файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX файл беттерін Java мысал коды арқылы ауыстыру жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы DOCX файл бетін ауыстырыңыз
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - DOCX файл беттерін онлайн ауыстырыңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docx) веб-сайтына кіру арқылы DOCX файл бетін дәл қазір ауыстырыңыз.
