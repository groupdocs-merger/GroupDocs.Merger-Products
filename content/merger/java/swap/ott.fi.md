...
############################# Head ############################
head_title: "Vaihda ja vaihda OTT sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja OTT-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda OTT sivua Java"
description: "Vaihda OTT-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda OTT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja OTT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa OTT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda OTT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda OTT tiedostosivua verkossa"
    content: |
       Vaihda OTT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) -sivustolla.
