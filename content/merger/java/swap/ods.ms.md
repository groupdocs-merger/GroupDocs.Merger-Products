...
############################# Head ############################
head_title: "Tukar & Tukar ODS Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODS dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODS Halaman Dalam Java"
description: "Tukar ODS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar ODS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail ODS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar ODS halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ODS Halaman Fail Dalam Talian"
    content: |
       Tukar ODS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods).
