...
############################# Head ############################
head_title: "Vaihda ja vaihda MHT sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja MHT-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda MHT sivua Java"
description: "Vaihda MHT-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda MHT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja MHT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa MHT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda MHT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda MHT tiedostosivua verkossa"
    content: |
       Vaihda MHT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht) -sivustolla.
