...
############################# Head ############################
head_title: "Byt og byt MHT sider i Java"
head_description: "Byt og udveksle positioner på to sider i en MHT-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt MHT sider i Java"
description: "Byt MHT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt MHT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en MHT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du MHT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift MHT filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt MHT filsider online"
    content: |
       Skift MHT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht).
