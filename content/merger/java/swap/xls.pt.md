...
############################# Head ############################
head_title: "Troque e troque XLS páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo XLS em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar XLS Páginas em Java"
description: "Troque XLS Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo XLS em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo XLS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo XLS usando o código de exemplo Java">}}

        ```java    
        // Troque as páginas do arquivo XLS usando a API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstrações ao vivo - Trocar páginas de arquivo XLS on-line"
    content: |
       Troque as páginas do arquivo XLS agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xls).
