...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLAM lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLAM failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLAM lapas programmā Java"
description: "Apmainiet XLAM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLAM faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLAM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLAM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLAM faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLAM failu lapas tiešsaistē"
    content: |
       Apmainiet XLAM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
