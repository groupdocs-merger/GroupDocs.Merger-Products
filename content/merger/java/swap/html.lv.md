...
############################# Head ############################
head_title: "Apmainīt un apmainīt HTML lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas HTML failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt HTML lapas programmā Java"
description: "Apmainiet HTML lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt HTML faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām HTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt HTML faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet HTML faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt HTML failu lapas tiešsaistē"
    content: |
       Apmainiet HTML faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html).
