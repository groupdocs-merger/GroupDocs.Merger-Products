...
############################# Head ############################
head_title: "Vahetage ja vahetage EPUB lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone EPUB failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage EPUB lehte keeles Java"
description: "Vahetage EPUB lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage EPUB faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis EPUB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada EPUB faililehte, kasutades Java näitekoodi">}}
