...
############################# Head ############################
head_title: "Vaihda ja vaihda XLT sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLT-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLT sivua Java"
description: "Vaihda XLT-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLT tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XLT tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XLT tiedostosivua verkossa"
    content: |
       Vaihda XLT tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt) -sivustolla.
