...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել DOCX էջեր Java-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը DOCX ֆայլում Java-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք DOCX էջեր Java-ում"
description: "Փոխեք DOCX էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք DOCX ֆայլի էջեր Java-ում"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java ծրագրավորողների համար էջերը փոխանակել DOCX ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել DOCX ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}
