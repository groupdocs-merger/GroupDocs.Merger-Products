...
############################# Head ############################
head_title: "Vaihda ja vaihda XLTM sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLTM-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLTM sivua Java"
description: "Vaihda XLTM-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLTM tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLTM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda XLTM tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda XLTM tiedostosivua verkossa"
    content: |
       Vaihda XLTM tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm) -sivustolla.
