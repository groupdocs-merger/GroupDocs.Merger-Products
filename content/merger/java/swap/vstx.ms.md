...
############################# Head ############################
head_title: "Tukar & Tukar VSTX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSTX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTX Halaman Dalam Java"
description: "Tukar VSTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VSTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSTX Halaman Fail Dalam Talian"
    content: |
       Tukar VSTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstx).
