...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj XLTM strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke XLTM v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj XLTM strani v Java"
description: "Zamenjajte strani XLTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke XLTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki XLTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke XLTM s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke XLTM z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte XLTM strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke XLTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
