...
############################# Head ############################
head_title: "Apmainīt un apmainīt VDX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VDX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VDX lapas programmā Java"
description: "Apmainiet VDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VDX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VDX failu lapas tiešsaistē"
    content: |
       Apmainiet VDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
