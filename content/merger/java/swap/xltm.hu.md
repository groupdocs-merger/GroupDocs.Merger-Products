...
############################# Head ############################
head_title: "Cserélj és cserélj XLTM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLTM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTM oldal cseréje a Java nyelven"
description: "Cserélje ki az XLTM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLTM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLTM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az XLTM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – XLTM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm) webhely meglátogatásával azonnal cseréljen XLTM fájloldalt.
