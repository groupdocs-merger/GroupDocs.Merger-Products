...
############################# Head ############################
head_title: "Cserélj és cserélj DOTX oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOTX fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTX oldal cseréje a Java nyelven"
description: "Cserélje ki az DOTX oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "DOTX fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy DOTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOTX fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az DOTX fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – DOTX fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx) webhely meglátogatásával azonnal cseréljen DOTX fájloldalt.
