...
############################# Head ############################
head_title: "Apmainīt un apmainīt XPS lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XPS failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XPS lapas programmā Java"
description: "Apmainiet XPS lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XPS faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XPS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XPS faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XPS faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XPS failu lapas tiešsaistē"
    content: |
       Apmainiet XPS faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps).
