...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLTM puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLTM faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLTM puslapius Java"
description: "Pakeiskite XLTM puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLTM failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLTM failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLTM failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLTM failų puslapiais internete"
    content: |
       Apkeiskite XLTM failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm) svetainėje.
