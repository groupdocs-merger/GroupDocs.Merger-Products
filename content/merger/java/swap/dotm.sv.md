...
############################# Head ############################
head_title: "Byt och byt ut DOTM sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en DOTM-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOTM sidor i Java"
description: "Byt DOTM-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt DOTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en DOTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOTM filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Byt DOTM filsidor med GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemos - Byt ut DOTM filsidor online"
    content: |
       Byt DOTM filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
