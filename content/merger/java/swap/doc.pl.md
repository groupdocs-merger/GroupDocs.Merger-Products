...
############################# Head ############################
head_title: "Zamień i zamień DOC strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOC w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOC strony w Java"
description: "Zamień strony DOC na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOC w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOC, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOC przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOC za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOC strony plików online"
    content: |
       Zamień strony plików DOC już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/doc).
