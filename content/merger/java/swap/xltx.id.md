...
############################# Head ############################
head_title: "Tukar & Tukarkan XLTX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLTX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTX Halaman Di Java"
description: "Tukar XLTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar XLTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file XLTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLTX menggunakan kode contoh Java">}}
