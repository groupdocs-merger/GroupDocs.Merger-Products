...
############################# Head ############################
head_title: "VSSM Sayfalarını Java İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir VSSM dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "VSSM Sayfayı Java İçinde Değiştir"
description: "VSSM Sayfalarını birkaç satır Java koduyla değiştirin."
...
steps:
    enable: true
    title_left: "Java içindeki VSSM Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir VSSM dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSSM dosya sayfaları nasıl değiştirilir?">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak VSSM dosya sayfalarını değiştirin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - VSSM Dosya Sayfalarını Çevrimiçi Değiştirin"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm) web sitesini ziyaret ederek VSSM dosya sayfalarını hemen değiştirin.
