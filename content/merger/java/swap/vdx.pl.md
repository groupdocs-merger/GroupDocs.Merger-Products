...
############################# Head ############################
head_title: "Zamień i zamień VDX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VDX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VDX strony w Java"
description: "Zamień strony VDX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików VDX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku VDX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VDX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików VDX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień VDX strony plików online"
    content: |
       Zamień strony plików VDX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vdx).
