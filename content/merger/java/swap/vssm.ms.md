...
############################# Head ############################
head_title: "Tukar & Tukar VSSM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSSM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSM Halaman Dalam Java"
description: "Tukar VSSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VSSM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSSM Halaman Fail Dalam Talian"
    content: |
       Tukar VSSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
