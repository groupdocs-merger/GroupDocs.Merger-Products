...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLTX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLTX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLTX stránky v Java"
description: "Vymeňte XLTX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLTX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLTX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLTX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLTX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltx).
