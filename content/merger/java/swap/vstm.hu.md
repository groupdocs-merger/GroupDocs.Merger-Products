...
############################# Head ############################
head_title: "Cserélj és cserélj VSTM oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSTM fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTM oldal cseréje a Java nyelven"
description: "Cserélje ki az VSTM oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "VSTM fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy VSTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSTM fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az VSTM fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – VSTM fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm) webhely meglátogatásával azonnal cseréljen VSTM fájloldalt.
