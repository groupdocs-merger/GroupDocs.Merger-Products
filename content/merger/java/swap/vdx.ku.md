...
############################# Head ############################
head_title: "Biguherîne û biguherîne VDX Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek VDX de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne VDX Rûpelên Di Java de"
description: "Rûpelên VDX bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de VDX Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên VDX bi karanîna koda nimûneya Java veguhezîne">}}
