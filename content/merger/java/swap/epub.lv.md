...
############################# Head ############################
head_title: "Apmainīt un apmainīt EPUB lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas EPUB failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt EPUB lapas programmā Java"
description: "Apmainiet EPUB lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt EPUB faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām EPUB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt EPUB faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet EPUB faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt EPUB failu lapas tiešsaistē"
    content: |
       Apmainiet EPUB faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub).
