...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj RTF strani v Java"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke RTF v Java z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj RTF strani v Java"
description: "Zamenjajte strani RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke RTF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša zamenjavo strani v datoteki RTF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke RTF s primerom kode Java">}}

        ```java    
        // Zamenjajte strani datoteke RTF z API-jem GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Predstavitve v živo - zamenjajte RTF strani datotek na spletu"
    content: |
       Takoj zamenjajte strani datoteke RTF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
