...
############################# Head ############################
head_title: "Tukar & Tukarkan TEX Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file TEX di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar TEX Halaman Di Java"
description: "Tukar TEX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar TEX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file TEX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file TEX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar TEX Halaman File Online"
    content: |
       Tukar halaman file TEX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/tex).
