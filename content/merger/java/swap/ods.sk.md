...
############################# Head ############################
head_title: "Vymeňte a vymeňte ODS stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ODS v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ODS stránky v Java"
description: "Vymeňte ODS stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte ODS strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru ODS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ODS pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte ODS stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte ODS stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi ODS hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods).
