...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLSM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLSM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLSM stránky v Java"
description: "Vyměňte XLSM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLSM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLSM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLSM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLSM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLSM stránky souborů online"
    content: |
       Vyměňte stránky souborů XLSM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
