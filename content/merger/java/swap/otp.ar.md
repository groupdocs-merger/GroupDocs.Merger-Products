...
############################# Head ############################
head_title: "تبادل الصفحات OTP في Java"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف OTP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات OTP في Java"
description: "استبدل الصفحات OTP ببضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات OTP في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java تبديل الصفحات داخل ملف OTP من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف OTP باستخدام كود مثال Java">}}

        ```java    
        // قم بتبديل صفحات ملف OTP باستخدام GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بتبديل OTP صفحات الملفات عبر الإنترنت"
    content: |
       قم بتبديل صفحات ملف OTP الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp).
