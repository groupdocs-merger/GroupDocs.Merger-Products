...
############################# Head ############################
head_title: "Vahetage ja vahetage ODT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODT lehte keeles Java"
description: "Vahetage ODT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis ODT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili ODT lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus ODT faililehte"
    content: |
       Vahetage kohe ODT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt).
