...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSX puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSX faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSX puslapius Java"
description: "Pakeiskite VSX puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSX failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais VSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSX failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite VSX failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite VSX failų puslapiais internete"
    content: |
       Apkeiskite VSX failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx) svetainėje.
