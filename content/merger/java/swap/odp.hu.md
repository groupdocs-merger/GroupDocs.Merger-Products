...
############################# Head ############################
head_title: "Cserélj és cserélj ODP oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODP fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODP oldal cseréje a Java nyelven"
description: "Cserélje ki az ODP oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODP fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy ODP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODP fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az ODP fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ODP fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) webhely meglátogatásával azonnal cseréljen ODP fájloldalt.
