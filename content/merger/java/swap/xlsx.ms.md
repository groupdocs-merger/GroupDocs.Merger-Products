...
############################# Head ############################
head_title: "Tukar & Tukar XLSX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSX Halaman Dalam Java"
description: "Tukar XLSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLSX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLSX Halaman Fail Dalam Talian"
    content: |
       Tukar XLSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx).
