...
############################# Head ############################
head_title: "Cserélj és cserélj XLS oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLS fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLS oldal cseréje a Java nyelven"
description: "Cserélje ki az XLS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "XLS fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy XLS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLS fájloldalakat a Java példakóddal">}}
