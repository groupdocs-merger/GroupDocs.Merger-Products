...
############################# Head ############################
head_title: "Tukar & Tukar VSTM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSTM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTM Halaman Dalam Java"
description: "Tukar VSTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar VSTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail VSTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar VSTM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar VSTM Halaman Fail Dalam Talian"
    content: |
       Tukar VSTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vstm).
