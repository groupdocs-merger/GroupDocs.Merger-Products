...
############################# Head ############################
head_title: "Byt og byt TEX sider i Java"
head_description: "Byt og udveksle positioner på to sider i en TEX-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt TEX sider i Java"
description: "Byt TEX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt TEX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en TEX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du TEX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Skift TEX filsider ved hjælp af GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Livedemoer - Byt TEX filsider online"
    content: |
       Skift TEX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tex).
