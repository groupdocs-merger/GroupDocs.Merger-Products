...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLSB puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLSB faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLSB puslapius Java"
description: "Pakeiskite XLSB puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLSB failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais XLSB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLSB failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite XLSB failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite XLSB failų puslapiais internete"
    content: |
       Apkeiskite XLSB failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb) svetainėje.
