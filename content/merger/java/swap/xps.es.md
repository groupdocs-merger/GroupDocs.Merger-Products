...
############################# Head ############################
head_title: "Intercambiar páginas en archivos XPS con aplicaciones Java"
head_description: "Utiliza GroupDocs.Merger for Java para reorganizar páginas en documentos XPS. Modifica PDFs, archivos de Word, hojas de cálculo, presentaciones, diagramas de Visio, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Intercambiar páginas de XPS" 
description: "GroupDocs.Merger for Java mejora las aplicaciones de Java con características flexibles de manipulación de documentos. Reordena páginas en archivos XPS para optimizar la estructura del contenido."
...
steps:
    enable: true
    title: "Cómo reordenar páginas de XPS"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica el reordenamiento de páginas en documentos XPS, brindándote el control total sobre la organización del contenido. Integra un procesamiento de documentos fluido en tus aplicaciones Java.
      
      1. Define la ruta al archivo XPS.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Intercambiar la primera y la última página en un archivo XPS"
      content: |
        Este ejemplo demuestra cómo intercambiar páginas en un archivo XPS en solo unos pocos pasos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
