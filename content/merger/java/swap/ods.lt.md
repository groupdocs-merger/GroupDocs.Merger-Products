...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ODS puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ODS faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ODS puslapius Java"
description: "Pakeiskite ODS puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ODS failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais ODS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ODS failo puslapius naudojant Java pavyzdinį kodą">}}
