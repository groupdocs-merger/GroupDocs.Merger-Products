...
############################# Head ############################
head_title: "Zamień i zamień DOCM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOCM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOCM strony w Java"
description: "Zamień strony DOCM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOCM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOCM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOCM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOCM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOCM strony plików online"
    content: |
       Zamień strony plików DOCM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
