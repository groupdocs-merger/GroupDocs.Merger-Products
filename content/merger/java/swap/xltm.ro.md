...
############################# Head ############################
head_title: "Schimbați și schimbați paginile XLTM în Java"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier XLTM în Java utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați XLTM pagini în Java"
description: "Schimbați paginile XLTM cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere XLTM în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează ca dezvoltatorii Java să schimbe paginile dintr-un fișier XLTM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere XLTM utilizând codul exemplu Java">}}

        ```java    
        // Schimbați pagini de fișiere XLTM utilizând API-ul GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo live - Schimbați paginile de fișiere XLTM online"
    content: |
       Schimbați paginile de fișiere XLTM chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xltm).
