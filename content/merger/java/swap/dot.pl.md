...
############################# Head ############################
head_title: "Zamień i zamień DOT strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOT w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOT strony w Java"
description: "Zamień strony DOT na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOT przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOT za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOT strony plików online"
    content: |
       Zamień strony plików DOT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot).
