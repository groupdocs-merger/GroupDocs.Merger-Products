...
############################# Head ############################
head_title: "交换和交换 Java 中的 PPTX 页"
head_description: "使用文档合并 API 在 Java 中的 PPTX 文件中交换和交换两个页面的位置。"

############################# Header ############################
title: "在 Java 中交换 PPTX 页"
description: "用几行 Java 代码交换 PPTX 个页面。"
...
steps:
    enable: true
    title_left: "交换 Java 中的 PPTX 个文件页"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 让 Java 开发人员通过执行几个简单的步骤轻松地在 PPTX 文件中交换页面.
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码交换 PPTX 文件页面">}}
