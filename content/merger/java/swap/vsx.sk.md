...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSX stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSX v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSX stránky v Java"
description: "Vymeňte VSX stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte VSX strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru VSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSX pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte VSX stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte VSX stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi VSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsx).
