...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSSM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSSM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSSM stránky v Java"
description: "Vyměňte VSSM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSSM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSSM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSSM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSSM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSSM stránky souborů online"
    content: |
       Vyměňte stránky souborů VSSM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vssm).
