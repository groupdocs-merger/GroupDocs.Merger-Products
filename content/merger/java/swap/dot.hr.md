...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOT stranice u Java"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOT datoteke u Java pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOT stranice u Java"
description: "Zamijenite DOT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) olakšava Java programerima zamjenu stranica unutar DOT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Zamijenite DOT stranice datoteke koristeći GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demonstracije uživo - Zamijenite DOT stranice datoteka na mreži"
    content: |
       Odmah zamijenite DOT stranice datoteke tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) web mjesto.
