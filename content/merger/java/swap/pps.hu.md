...
############################# Head ############################
head_title: "Cserélj és cserélj PPS oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PPS fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPS oldal cseréje a Java nyelven"
description: "Cserélje ki az PPS oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPS fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy PPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PPS fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az PPS fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – PPS fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pps) webhely meglátogatásával azonnal cseréljen PPS fájloldalt.
