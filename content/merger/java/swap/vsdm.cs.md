...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSDM stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSDM v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSDM stránky v Java"
description: "Vyměňte VSDM stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte VSDM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru VSDM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSDM pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru VSDM pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte VSDM stránky souborů online"
    content: |
       Vyměňte stránky souborů VSDM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdm).
