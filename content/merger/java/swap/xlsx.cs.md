...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLSX stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLSX v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLSX stránky v Java"
description: "Vyměňte XLSX stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XLSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XLSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLSX pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XLSX pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XLSX stránky souborů online"
    content: |
       Vyměňte stránky souborů XLSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx).
