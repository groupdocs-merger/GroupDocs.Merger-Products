...
############################# Head ############################
head_title: "Tukar & Tukar DOCM Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOCM dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCM Halaman Dalam Java"
description: "Tukar DOCM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOCM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOCM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOCM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar DOCM halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOCM Halaman Fail Dalam Talian"
    content: |
       Tukar DOCM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/docm).
