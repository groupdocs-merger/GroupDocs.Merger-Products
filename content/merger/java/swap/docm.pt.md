...
############################# Head ############################
head_title: "Troque e troque DOCM páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo DOCM em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar DOCM Páginas em Java"
description: "Troque DOCM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo DOCM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo DOCM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo DOCM usando o código de exemplo Java">}}
