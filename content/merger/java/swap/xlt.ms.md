...
############################# Head ############################
head_title: "Tukar & Tukar XLT Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLT dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLT Halaman Dalam Java"
description: "Tukar XLT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar XLT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail XLT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar XLT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar XLT Halaman Fail Dalam Talian"
    content: |
       Tukar XLT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt).
