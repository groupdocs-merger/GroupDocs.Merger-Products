...
############################# Head ############################
head_title: "Vaihda ja vaihda OTP sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja OTP-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda OTP sivua Java"
description: "Vaihda OTP-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda OTP tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja OTP-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa OTP tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda OTP tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda OTP tiedostosivua verkossa"
    content: |
       Vaihda OTP tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/otp) -sivustolla.
