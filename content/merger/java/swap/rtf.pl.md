...
############################# Head ############################
head_title: "Zamień i zamień RTF strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku RTF w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień RTF strony w Java"
description: "Zamień strony RTF na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików RTF w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku RTF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku RTF przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików RTF za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień RTF strony plików online"
    content: |
       Zamień strony plików RTF już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf).
