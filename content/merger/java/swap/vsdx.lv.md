...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSDX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSDX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSDX lapas programmā Java"
description: "Apmainiet VSDX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSDX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām VSDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSDX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet VSDX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt VSDX failu lapas tiešsaistē"
    content: |
       Apmainiet VSDX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx).
