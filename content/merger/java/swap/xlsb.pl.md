...
############################# Head ############################
head_title: "Zamień i zamień XLSB strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSB w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSB strony w Java"
description: "Zamień strony XLSB na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLSB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSB przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLSB za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLSB strony plików online"
    content: |
       Zamień strony plików XLSB już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsb).
