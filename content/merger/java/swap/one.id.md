...
############################# Head ############################
head_title: "Tukar & Tukarkan ONE Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file ONE di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ONE Halaman Di Java"
description: "Tukar ONE Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar ONE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file ONE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ONE menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file ONE menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ONE Halaman File Online"
    content: |
       Tukar halaman file ONE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/one).
