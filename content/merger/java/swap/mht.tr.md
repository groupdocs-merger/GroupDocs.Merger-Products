...
############################# Head ############################
head_title: "MHT Sayfalarını Java İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak Java içindeki bir MHT dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "MHT Sayfayı Java İçinde Değiştir"
description: "MHT Sayfalarını birkaç satır Java koduyla değiştirin."
...
steps:
    enable: true
    title_left: "Java içindeki MHT Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java}/), Java geliştiricilerinin birkaç kolay adımı uygulayarak bir MHT dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak MHT dosya sayfaları nasıl değiştirilir?">}}

        ```java    
        // GroupDocs.Merger API'sini kullanarak MHT dosya sayfalarını değiştirin
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Canlı Demolar - MHT Dosya Sayfalarını Çevrimiçi Değiştirin"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mht) web sitesini ziyaret ederek MHT dosya sayfalarını hemen değiştirin.
