...
############################# Head ############################
head_title: "Vahetage ja vahetage XLAM lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLAM failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLAM lehte keeles Java"
description: "Vahetage XLAM lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLAM faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis XLAM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLAM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili XLAM lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus XLAM faililehte"
    content: |
       Vahetage kohe XLAM faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam).
