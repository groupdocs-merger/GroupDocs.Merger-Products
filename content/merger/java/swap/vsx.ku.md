...
############################# Head ############################
head_title: "Biguherîne û biguherîne VSX Rûpelên di Java de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek VSX de di nav pelek Java de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne VSX Rûpelên Di Java de"
description: "Rûpelên VSX bi çend rêzikên koda Java biguherînin."
...
steps:
    enable: true
    title_left: "Di Java de VSX Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên VSX bi karanîna koda nimûneya Java veguhezîne">}}
