...
############################# Head ############################
head_title: "Cserélj és cserélj PDF oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PDF fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PDF oldal cseréje a Java nyelven"
description: "Cserélje ki az PDF oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PDF fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy PDF fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PDF fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az PDF fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – PDF fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pdf) webhely meglátogatásával azonnal cseréljen PDF fájloldalt.
