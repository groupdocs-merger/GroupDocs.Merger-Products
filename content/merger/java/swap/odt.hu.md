...
############################# Head ############################
head_title: "Cserélj és cserélj ODT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODT oldal cseréje a Java nyelven"
description: "Cserélje ki az ODT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "ODT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy ODT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az ODT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – ODT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odt) webhely meglátogatásával azonnal cseréljen ODT fájloldalt.
