...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOT stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOT v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOT stránky v Java"
description: "Vymeňte DOT stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte DOT strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru DOT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOT pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte DOT stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte DOT stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi DOT hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot).
