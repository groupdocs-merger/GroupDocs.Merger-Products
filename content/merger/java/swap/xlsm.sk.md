...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLSM stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLSM v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLSM stránky v Java"
description: "Vymeňte XLSM stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte XLSM strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru XLSM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLSM pomocou vzorového kódu Java">}}

        ```java    
        // Vymeňte XLSM stránky súboru pomocou GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živé ukážky – Vymeňte XLSM stránok súboru online"
    content: |
       Vymeňte si stránky so súbormi XLSM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsm).
