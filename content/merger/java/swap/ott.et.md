...
############################# Head ############################
head_title: "Vahetage ja vahetage OTT lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone OTT failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage OTT lehte keeles Java"
description: "Vahetage OTT lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage OTT faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis OTT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada OTT faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili OTT lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus OTT faililehte"
    content: |
       Vahetage kohe OTT faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott).
