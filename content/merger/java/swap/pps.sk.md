...
############################# Head ############################
head_title: "Vymeňte a vymeňte PPS stránky v Java"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PPS v Java pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PPS stránky v Java"
description: "Vymeňte PPS stránky za pár riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Vymeňte PPS strán súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java vymieňať si stránky v rámci súboru PPS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PPS pomocou vzorového kódu Java">}}
