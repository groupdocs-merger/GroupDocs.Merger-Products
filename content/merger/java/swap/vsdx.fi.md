...
############################# Head ############################
head_title: "Vaihda ja vaihda VSDX sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSDX-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSDX sivua Java"
description: "Vaihda VSDX-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSDX tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja VSDX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSDX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda VSDX tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda VSDX tiedostosivua verkossa"
    content: |
       Vaihda VSDX tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) -sivustolla.
