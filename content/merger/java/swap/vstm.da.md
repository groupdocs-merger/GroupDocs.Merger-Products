...
############################# Head ############################
head_title: "Byt og byt VSTM sider i Java"
head_description: "Byt og udveksle positioner på to sider i en VSTM-fil i Java ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSTM sider i Java"
description: "Byt VSTM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Byt VSTM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at bytte sider i en VSTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSTM filsider ved hjælp af Java eksempelkode">}}
