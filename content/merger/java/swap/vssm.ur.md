...
############################# Head ############################
head_title: "Java میں VSSM صفحات کی تبادلہ اور تبادلہ"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے Java میں ایک VSSM فائل کے اندر دو صفحات کی پوزیشنوں کو تبدیل اور تبادلہ کریں۔"

############################# Header ############################
title: "VSSM صفحات کو Java میں تبدیل کریں"
description: "VSSM صفحات کو Java کوڈ کی چند سطروں کے ساتھ تبدیل کریں۔"
...
steps:
    enable: true
    title_left: "VSSM فائل صفحات کو Java میں تبدیل کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے VSSM فائل کے اندر صفحات کو تبدیل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے VSSM فائل کے صفحات کو کیسے تبدیل کریں۔">}}
