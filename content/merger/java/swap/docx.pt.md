...
############################# Head ############################
head_title: "Troque e troque DOCX páginas em Java"
head_description: "Troque e troque posições de duas páginas em um arquivo DOCX em Java usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar DOCX Páginas em Java"
description: "Troque DOCX Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo DOCX em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java trocar páginas em um arquivo DOCX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo DOCX usando o código de exemplo Java">}}
