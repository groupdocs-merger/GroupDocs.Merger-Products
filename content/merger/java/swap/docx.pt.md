...
############################# Head ############################
head_title: "Troque páginas em arquivos DOCX com aplicativos Java"
head_description: "Use GroupDocs.Merger for Java para reorganizar páginas em documentos DOCX. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos e mais."

############################# Header ############################
title: "Trocar páginas DOCX" 
description: "GroupDocs.Merger for Java melhora aplicações Java com recursos flexíveis de manipulação de documentos. Reordene páginas em arquivos DOCX para otimizar a estrutura do conteúdo."
...
steps:
    enable: true
    title: "Como reordenar páginas DOCX"
    content: |
      [GroupDocs.Merger](/merger/java/) simplifica a reordenação de páginas em documentos DOCX, dando total controle sobre a organização do conteúdo. Integre um processamento de documentos sem costura em suas aplicações Java.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última página em um arquivo DOCX"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo DOCX com apenas alguns passos simples.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
