...
############################# Head ############################
head_title: "Vahetage ja vahetage MHTML lehti Java-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone MHTML failis Java-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage MHTML lehte keeles Java"
description: "Vahetage MHTML lehed mõne rea Java koodiga."
...
steps:
    enable: true
    title_left: "Vahetage MHTML faililehte tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks lehtede vahetamise failis MHTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada MHTML faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Vahetage faili MHTML lehte, kasutades GroupDocs.Merger API-t
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Reaalajas demod – vahetage võrgus MHTML faililehte"
    content: |
       Vahetage kohe MHTML faililehte, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/mhtml).
