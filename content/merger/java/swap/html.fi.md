...
############################# Head ############################
head_title: "Vaihda ja vaihda HTML sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja HTML-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda HTML sivua Java"
description: "Vaihda HTML-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda HTML tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja HTML-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa HTML tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Vaihda HTML tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda HTML tiedostosivua verkossa"
    content: |
       Vaihda HTML tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/html) -sivustolla.
