...
############################# Head ############################
head_title: "Tukar & Tukar DOTX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOTX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTX Halaman Dalam Java"
description: "Tukar DOTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar DOTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail DOTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar DOTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar DOTX Halaman Fail Dalam Talian"
    content: |
       Tukar DOTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotx).
