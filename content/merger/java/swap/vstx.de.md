...
############################# Head ############################
head_title: "Tausche & tausche VSTX Seiten in Java"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSTX-Datei in Java mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSTX Seiten in Java"
description: "Tauschen Sie VSTX-Seiten mit ein paar Zeilen Java-Code aus."
...
steps:
    enable: true
    title_left: "VSTX Dateiseiten in Java tauschen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, Seiten innerhalb einer VSTX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSTX-Dateiseiten mit Java-Beispielcode aus">}}
