...
############################# Head ############################
head_title: "Intercambiar e intercambiar EXCEL páginas en Java"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo EXCEL en Java utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar EXCEL páginas en Java"
description: "Intercambie EXCEL páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Intercambiar EXCEL páginas de archivo en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita a los desarrolladores de Java intercambiar páginas dentro de un archivo EXCEL mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos EXCEL usando el código de ejemplo Java">}}

        ```java    
        // Intercambiar EXCEL páginas de archivos usando GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demostraciones en vivo: intercambie EXCEL páginas de archivos en línea"
    content: |
       Cambie las páginas de archivos EXCEL ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/excel).
