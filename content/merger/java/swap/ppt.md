...
############################# Head ############################
head_title: "Swap & Exchange PPT Pages in Java"
head_description: "Swap & Exchange positions of two pages within a PPT file in Java using the documents merger API."

############################# Header ############################
title: "Swap PPT Pages In Java"
description: "Swap PPT Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a PPT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PPT file pages using Java example code">}}
