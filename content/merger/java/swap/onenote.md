...
############################# Head ############################
head_title: "Swap & Exchange ONENOTE Pages in Java"
head_description: "Swap & Exchange positions of two pages within a ONENOTE file in Java using the documents merger API."

############################# Header ############################
title: "Swap ONENOTE Pages In Java"
description: "Swap ONENOTE Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to swap pages within a ONENOTE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ONENOTE file pages using Java example code">}}
...
demos:
    ...
    content: |
       Swap ONENOTE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/onenote) website.
