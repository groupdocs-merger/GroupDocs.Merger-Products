...
head_description: "Java users to swap & exchange positions of two pages within a ONENOTE file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange ONENOTE Pages in Java"
description: "Swap & Exchange positions of two pages within a ONENOTE file using the file splitter API for Java & J2SE applications."
...
demos:
    ...
    content: |
        Exchange pages within ONENOTE files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/onenote) website.
