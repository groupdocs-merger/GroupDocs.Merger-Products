...
############################# Head ############################
head_title: "Vyměňte a vyměňte XPS stránky v Java"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XPS v Java pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XPS stránky v Java"
description: "Vyměňte XPS stránky za pár řádků kódu Java."
...
steps:
    enable: true
    title_left: "Vyměňte XPS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java výměnu stránek v souboru XPS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XPS pomocí ukázkového kódu Java">}}

        ```java    
        // Vyměňte stránky souboru XPS pomocí GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Živá ukázka – Vyměňte XPS stránky souborů online"
    content: |
       Vyměňte stránky souborů XPS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps).
