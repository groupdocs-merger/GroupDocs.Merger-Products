...
############################# Head ############################
head_title: "Zamień i zamień DOTM strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOTM w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOTM strony w Java"
description: "Zamień strony DOTM na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku DOTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOTM przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików DOTM za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień DOTM strony plików online"
    content: |
       Zamień strony plików DOTM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dotm).
