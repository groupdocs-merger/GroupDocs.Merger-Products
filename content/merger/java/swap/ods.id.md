...
############################# Head ############################
head_title: "Tukar & Tukarkan ODS Halaman di Java"
head_description: "Tukar & Tukar posisi dua halaman dalam file ODS di Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODS Halaman Di Java"
description: "Tukar ODS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Tukar ODS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menukar halaman dalam file ODS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ODS menggunakan kode contoh Java">}}

        ```java    
        // Tukar halaman file ODS menggunakan GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar ODS Halaman File Online"
    content: |
       Tukar halaman file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/ods).
