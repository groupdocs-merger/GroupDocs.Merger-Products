...
############################# Head ############################
head_title: "Cserélj és cserélj PPT oldalt a Java nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PPT fájlon belül a Java-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPT oldal cseréje a Java nyelven"
description: "Cserélje ki az PPT oldalt néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "PPT fájloldal cseréje a Java termékben"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztői számára, hogy oldalt cseréljenek egy PPT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PPT fájloldalakat a Java példakóddal">}}

        ```java    
        // Cserélje ki az PPT fájloldalakat a GroupDocs.Merger API használatával
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Élő bemutatók – PPT fájloldalak online cseréje"
    content: |
       Az [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt) webhely meglátogatásával azonnal cseréljen PPT fájloldalt.
