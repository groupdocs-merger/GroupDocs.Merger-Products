...
############################# Head ############################
head_title: "Byt och byt ut PPS sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en PPS-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt PPS sidor i Java"
description: "Byt PPS-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt PPS filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en PPS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter PPS filsidor med hjälp av Java exempelkod">}}
