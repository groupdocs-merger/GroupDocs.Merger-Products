...
############################# Head ############################
head_title: "Ruil en ruil XLSX bladsye in Java"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLSX-lêer in Java met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLSX bladsye in Java"
description: "Ruil XLSX Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Ruil XLSX lêerbladsye om in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om bladsye binne 'n XLSX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSX lêerbladsye om te ruil met behulp van Java voorbeeldkode">}}

        ```java    
        // Ruil XLSX lêerbladsye om deur GroupDocs.Merger API te gebruik
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Ruil XLSX lêerbladsye aanlyn"
    content: |
       Ruil nou XLSX lêerbladsye om deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx) webwerf te besoek.
