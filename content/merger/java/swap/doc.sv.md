...
############################# Head ############################
head_title: "Byt och byt ut DOC sidor i Java"
head_description: "Byt och byt ut positioner på två sidor i en DOC-fil i Java med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOC sidor i Java"
description: "Byt DOC-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Byt DOC filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att byta sida i en DOC-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOC filsidor med hjälp av Java exempelkod">}}
