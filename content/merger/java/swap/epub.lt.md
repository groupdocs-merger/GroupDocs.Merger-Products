...
############################# Head ############################
head_title: "Sukeiskite ir keiskite EPUB puslapius Java"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas EPUB faile Java naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti EPUB puslapius Java"
description: "Pakeiskite EPUB puslapius keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti EPUB failo puslapius Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai apsikeisti puslapiais EPUB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti EPUB failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Sukeiskite EPUB failo puslapius naudodami GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – apsikeiskite EPUB failų puslapiais internete"
    content: |
       Apkeiskite EPUB failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/epub) svetainėje.
