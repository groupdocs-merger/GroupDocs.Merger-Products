...
############################# Head ############################
head_title: "Vaihda ja vaihda XLS sivua Java"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLS-tiedostossa Java:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLS sivua Java"
description: "Vaihda XLS-sivut muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLS tiedostosivua tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi vaihtaa sivuja XLS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLS tiedostosivua käyttämällä Java esimerkkikoodia">}}
