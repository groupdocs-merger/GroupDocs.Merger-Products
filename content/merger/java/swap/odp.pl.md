...
############################# Head ############################
head_title: "Zamień i zamień ODP strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ODP w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ODP strony w Java"
description: "Zamień strony ODP na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików ODP w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku ODP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ODP przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików ODP za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień ODP strony plików online"
    content: |
       Zamień strony plików ODP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp).
