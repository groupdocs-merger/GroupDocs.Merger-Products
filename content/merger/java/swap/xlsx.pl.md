...
############################# Head ############################
head_title: "Zamień i zamień XLSX strony w Java"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSX w Java za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSX strony w Java"
description: "Zamień strony XLSX na kilka wierszy kodu Java."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java wymianę stron w pliku XLSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSX przy użyciu przykładowego kodu Java">}}

        ```java    
        // Zamień strony plików XLSX za pomocą GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – zamień XLSX strony plików online"
    content: |
       Zamień strony plików XLSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx).
