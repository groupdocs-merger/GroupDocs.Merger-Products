...
############################# Head ############################
head_title: "Tukar & Tukar PPT Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPT dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPT Halaman Dalam Java"
description: "Tukar PPT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar PPT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail PPT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar PPT halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPT Halaman Fail Dalam Talian"
    content: |
       Tukar PPT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt).
