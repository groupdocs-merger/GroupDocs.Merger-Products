...
############################# Head ############################
head_title: "Tukar & Tukar PPTX Halaman dalam Java"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPTX dalam Java menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPTX Halaman Dalam Java"
description: "Tukar PPTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Tukar PPTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java menukar halaman dalam fail PPTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Tukar PPTX halaman fail menggunakan API GroupDocs.Merger
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar PPTX Halaman Fail Dalam Talian"
    content: |
       Tukar PPTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/pptx).
