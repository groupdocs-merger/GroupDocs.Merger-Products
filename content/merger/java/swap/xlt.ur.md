...
############################# Head ############################
head_title: "Java میں XLT صفحات کی تبادلہ اور تبادلہ"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے Java میں ایک XLT فائل کے اندر دو صفحات کی پوزیشنوں کو تبدیل اور تبادلہ کریں۔"

############################# Header ############################
title: "XLT صفحات کو Java میں تبدیل کریں"
description: "XLT صفحات کو Java کوڈ کی چند سطروں کے ساتھ تبدیل کریں۔"
...
steps:
    enable: true
    title_left: "XLT فائل صفحات کو Java میں تبدیل کریں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے XLT فائل کے اندر صفحات کو تبدیل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے XLT فائل کے صفحات کو کیسے تبدیل کریں۔">}}

        ```java    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے XLT فائل کے صفحات کو تبدیل کریں۔
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "لائیو ڈیمو - XLT فائل صفحات آن لائن تبدیل کریں۔"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlt) ویب سائٹ پر جا کر ابھی XLT فائل کے صفحات کو تبدیل کریں۔
