...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLSX lapas programmā Java"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLSX failā Java, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLSX lapas programmā Java"
description: "Apmainiet XLSX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLSX faila lapas pakalpojumā Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem ērti apmainīties ar lapām XLSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLSX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Apmainiet XLSX faila lapas, izmantojot GroupDocs.Merger API
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — apmainīt XLSX failu lapas tiešsaistē"
    content: |
       Apmainiet XLSX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlsx).
