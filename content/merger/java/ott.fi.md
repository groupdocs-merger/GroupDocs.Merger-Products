...
############################# Head ############################
head_title: "Yhdistä OTT tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita OTT-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "OTT Sulautuminen Java"
description: "Yhdistä OTT muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita OTT tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita OTT-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää OTT tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä OTT tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi OTT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) -sivustolla.
