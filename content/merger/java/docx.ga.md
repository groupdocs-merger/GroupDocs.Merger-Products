...
############################# Head ############################
head_title: "Cumaisc DOCX Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid DOCX iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "DOCX Cumasc i Java"
description: "Cumaisc DOCX le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc DOCX Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid DOCX iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOCX comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc DOCX comhad le GroupDocs.Merger le haghaidh Java API
