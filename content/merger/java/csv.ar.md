...
############################# Head ############################
head_title: "دمج ملفات CSV عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات CSV في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "CSV الاندماج في Java"
description: "دمج CSV ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من CSV ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
