...
############################# Head ############################
head_title: "Îmbinați fișierele XLSX prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere XLSX în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "XLSX Fuziune în Java"
description: "Îmbinați XLSX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere XLSX în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere XLSX pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere XLSX folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere XLSX utilizând API-ul GroupDocs.Merger pentru Java
