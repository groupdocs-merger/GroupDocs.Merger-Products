...
head_description: "Yhdistä useita XLSM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "XLSM Sulautuminen Java"
description: "Yhdistä XLSM muutamalla rivillä Java-koodia."
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLSM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) -sivustolla.
