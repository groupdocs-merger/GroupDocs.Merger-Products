...
############################# Head ############################
head_title: "Slå sammen JPG filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "JPG sammenslåing i Java"
description: "Slå sammen JPG med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen JPG filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen JPG filer med GroupDocs.Merger for Java API
