...
############################# Head ############################
head_title: "Slå sammen TSV filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "TSV sammenslåing i Java"
description: "Slå sammen TSV med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TSV filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen TSV filer med GroupDocs.Merger for Java API
