...
############################# Head ############################
head_title: "Обединете ODS файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество ODS файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "ODS Обединяване в Java"
description: "Обединете ODS с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество ODS файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ODS файлове с Java примерен код">}}

        ```java    
        // Обединете ODS файлове с помощта на GroupDocs.Merger за Java API
