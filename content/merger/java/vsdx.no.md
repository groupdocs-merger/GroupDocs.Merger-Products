...
############################# Head ############################
head_title: "Slå sammen VSDX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "VSDX sammenslåing i Java"
description: "Slå sammen VSDX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSDX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen VSDX filer med GroupDocs.Merger for Java API
