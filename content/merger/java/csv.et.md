...
############################# Head ############################
head_title: "Ühendage CSV failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu CSV-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "CSV ühinemine programmis Java"
description: "Ühendage CSV mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita CSV faili, kasutades Java näitekoodi">}}
