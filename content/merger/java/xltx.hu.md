...
############################# Head ############################
head_title: "Egyesítse az XLTX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több XLTX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "XLTX Egyesülés a Java programban"
description: "Egyesítse a(z) XLTX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több XLTX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több XLTX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen XLTX fájlokat a GroupDocs.Merger for Java API segítségével
