...
############################# Head ############################
head_title: "VSTM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSTM dosyasını birleştirin."

############################# Header ############################
title: "VSTM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSTM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) web sitesini ziyaret ederek birden fazla VSTM dosyayı birleştirin.
