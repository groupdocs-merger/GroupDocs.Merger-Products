...
############################# Head ############################
head_title: "Zlúčiť súbory PPSX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero PPSX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "PPSX Zlúčenie v Java"
description: "Zlúčte PPSX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero PPSX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov PPSX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PPSX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť PPSX súbory pomocou GroupDocs.Merger for Java API
