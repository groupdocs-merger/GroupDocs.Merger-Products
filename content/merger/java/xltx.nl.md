...
############################# Head ############################
head_title: "Samenvoegen XLTX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "XLTX Fusie in Java"
description: "Voeg XLTX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLTX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLTX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLTX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLTX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) te gaan.
