...
############################# Head ############################
head_title: "Cumaisc HTML Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid HTML iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "HTML Cumasc i Java"
description: "Cumaisc HTML le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc HTML Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid HTML iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas HTML comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc HTML comhad le GroupDocs.Merger le haghaidh Java API
