...
############################# Head ############################
head_title: "Slå sammen DOT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOT sammenslåing i Java"
description: "Slå sammen DOT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOT filer med GroupDocs.Merger for Java API
