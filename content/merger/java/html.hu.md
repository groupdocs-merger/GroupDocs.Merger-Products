...
############################# Head ############################
head_title: "Egyesítse az HTML fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több HTML fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "HTML Egyesülés a Java programban"
description: "Egyesítse a(z) HTML terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több HTML fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több HTML fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen HTML fájlokat a GroupDocs.Merger for Java API segítségével
