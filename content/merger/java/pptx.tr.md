...
############################# Head ############################
head_title: "PPTX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla PPTX dosyasını birleştirin."

############################# Header ############################
title: "PPTX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok PPTX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) web sitesini ziyaret ederek birden fazla PPTX dosyayı birleştirin.
