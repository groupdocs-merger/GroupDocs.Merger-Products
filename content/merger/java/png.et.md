...
############################# Head ############################
head_title: "Ühendage PNG failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PNG-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PNG ühinemine programmis Java"
description: "Ühendage PNG mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PNG faili, kasutades Java näitekoodi">}}
