...
############################# Head ############################
head_title: "Spoji datoteke BMP prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek BMP v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "BMP Združitev v Java"
description: "Spojite BMP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek BMP v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke BMP s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke BMP z API-jem GroupDocs.Merger for Java
