...
############################# Head ############################
head_title: "Zlúčiť súbory DOTM cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOTM súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOTM Zlúčenie v Java"
description: "Zlúčte DOTM s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOTM súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOTM vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOTM pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOTM súbory pomocou GroupDocs.Merger for Java API
