...
############################# Head ############################
head_title: "Merge WORD files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate WORD document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge WORD files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage WORD documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of WORD documents. Enhance your Java applications by combining multiple files into one.
