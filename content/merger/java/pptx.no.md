...
############################# Head ############################
head_title: "Slå sammen PPTX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PPTX sammenslåing i Java"
description: "Slå sammen PPTX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPTX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PPTX filer med GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Slå sammen mer enn én PPTX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
