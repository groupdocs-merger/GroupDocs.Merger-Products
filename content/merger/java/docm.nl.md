...
############################# Head ############################
head_title: "Samenvoegen DOCM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "DOCM Fusie in Java"
description: "Voeg DOCM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere DOCM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg DOCM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één DOCM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) te gaan.
