...
############################# Head ############################
head_title: "Führen Sie JPEG-Dateien über die Java- und J2SE-Dokumenten-Merger-API zusammen"
head_description: "Führen Sie mehrere JPEG-Dateien in Java zusammen, indem Sie die Dokumentenzusammenführungs-API mit allen Daten, Stilen und Formatierungen als Quelldokumente verwenden."

############################# Header ############################
title: "JPEG Fusion in Java"
description: "Führen Sie JPEG mit ein paar Zeilen Java-Code zusammen."
...
steps:
    enable: true
    title_left: "Mehrere JPEG-Dateien in Java zusammenführen"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) macht es Java-Entwicklern leicht, mehrere JPEG-Dateien zusammenzuführen, indem sie einige einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie JPEG-Dateien mit Java-Beispielcode zusammen">}}

        ```java    
        // Führen Sie JPEG-Dateien mit GroupDocs.Merger for Java API zusammen
