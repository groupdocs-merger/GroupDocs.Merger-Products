...
############################# Head ############################
head_title: "Zlúčiť súbory XPS cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero XPS súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "XPS Zlúčenie v Java"
description: "Zlúčte XPS s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero XPS súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov XPS vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory XPS pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť XPS súbory pomocou GroupDocs.Merger for Java API
