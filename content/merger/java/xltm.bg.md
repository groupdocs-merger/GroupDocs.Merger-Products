...
############################# Head ############################
head_title: "Обединете XLTM файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество XLTM файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "XLTM Обединяване в Java"
description: "Обединете XLTM с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество XLTM файла в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да обединяват множество XLTM файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините XLTM файлове с Java примерен код">}}

        ```java    
        // Обединете XLTM файлове с помощта на GroupDocs.Merger за Java API
