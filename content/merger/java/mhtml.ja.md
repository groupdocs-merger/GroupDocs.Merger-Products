...
############################# Head ############################
head_title: "JavaでMHTMLファイルをマージ"
head_description: "JavaプロジェクトにMHTMLドキュメントマージ機能を統合するために、GroupDocs.Merger for Javaを使用します。"

############################# Header ############################
title: "MHTMLファイルをマージ" 
description: "GroupDocs.Merger for Javaを使用すれば、Javaアプリケーションを構築して、MHTMLドキュメントをシームレスにマージおよび管理できます。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)はMHTMLドキュメントのシームレスなマージを可能にします。複数のファイルを1つに統合して、Javaアプリケーションを強化します。
      
      1. 最初のMHTMLファイルのパスを指定します。
