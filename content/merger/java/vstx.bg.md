...
############################# Head ############################
head_title: "Обединете VSTX файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество VSTX файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "VSTX Обединяване в Java"
description: "Обединете VSTX с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество VSTX файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VSTX файлове с Java примерен код">}}

        ```java    
        // Обединете VSTX файлове с помощта на GroupDocs.Merger за Java API
