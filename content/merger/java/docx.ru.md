...
############################# Head ############################
head_title: "Объединение DOCX файлов через Java и J2SE Documents Merger API"
head_description: "Объединяйте несколько файлов DOCX в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "DOCX Объединение на Java"
...
steps:
    enable: true
    title_left: "Объединить несколько DOCX файлов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы DOCX, используя пример кода Java">}}
        ...
        ```java    
        // Объединить DOCX файлов с помощью GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Объедините несколько DOCX файлов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/merger/docx).
