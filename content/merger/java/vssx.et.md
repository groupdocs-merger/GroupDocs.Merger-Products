...
############################# Head ############################
head_title: "Ühendage VSSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSSX ühinemine programmis Java"
description: "Ühendage VSSX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSSX faili, kasutades Java näitekoodi">}}
