...
############################# Head ############################
head_title: "Cumaisc XLS Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid XLS iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "XLS Cumasc i Java"
description: "Cumaisc XLS le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc XLS Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid XLS iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLS comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc XLS comhad le GroupDocs.Merger le haghaidh Java API
