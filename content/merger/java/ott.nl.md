...
############################# Head ############################
head_title: "Samenvoegen OTT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "OTT Fusie in Java"
description: "Voeg OTT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere OTT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg OTT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één OTT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) te gaan.
