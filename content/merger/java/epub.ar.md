...
############################# Head ############################
head_title: "دمج ملفات EPUB عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات EPUB في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "EPUB الاندماج في Java"
description: "دمج EPUB ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من EPUB ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
