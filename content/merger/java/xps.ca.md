...
############################# Head ############################
head_title: "Combina fitxers XPS mitjançant l'API de fusió de documents de Java i J2SE"
head_description: "Combineu diversos fitxers XPS a Java mitjançant l'API de fusió de documents amb totes les dades, estil i format com a documents font."

############################# Header ############################
title: "XPS Fusió a Java"
description: "Combina XPS amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Combina diversos fitxers XPS a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) facilita que els desenvolupadors de Java fusionin diversos fitxers XPS implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XPS mitjançant el codi d'exemple Java">}}

        ```java    
        // Combina fitxers XPS mitjançant l'API de GroupDocs.Merger per a Java
