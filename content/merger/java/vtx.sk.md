...
############################# Head ############################
head_title: "Zlúčiť súbory VTX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VTX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VTX Zlúčenie v Java"
description: "Zlúčte VTX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VTX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VTX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VTX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VTX súbory pomocou GroupDocs.Merger for Java API
