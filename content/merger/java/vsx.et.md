...
############################# Head ############################
head_title: "Ühendage VSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu VSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "VSX ühinemine programmis Java"
description: "Ühendage VSX mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu VSX faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme VSX faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSX faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid VSX, kasutades GroupDocs.Merger for Java API-t
