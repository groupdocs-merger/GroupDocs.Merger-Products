...
############################# Head ############################
head_title: "在 Java 中合并 TIFF 文件"
head_description: "使用 GroupDocs.Merger for Java 将 TIFF 文档合并功能集成到您的 Java 项目中。"

############################# Header ############################
title: "合并 TIFF 文件" 
description: "利用 GroupDocs.Merger for Java，您可以构建先进的 Java 应用程序，无缝合并和管理 TIFF 文档。"
...
steps:
    ...
    title: "如何合并 TIFF 文档"
    content: |
      [GroupDocs.Merger](/merger/java/) 使 TIFF 文档的无缝合并成为可能。通过将多个文件合并为一个，提升您的 Java 应用程序。 
