...
############################# Head ############################
head_title: "Spoji EPUB datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više EPUB datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "EPUB Spajanje u Java"
description: "Spoji EPUB s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Spoji više EPUB datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti EPUB datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Spoji EPUB datoteke koristeći GroupDocs.Merger za Java API
