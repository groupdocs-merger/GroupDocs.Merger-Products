...
############################# Head ############################
head_title: "Fusionner TXT fichiers via l'API de fusion de documents Java et J2SE"
head_description: "Fusionnez plusieurs fichiers TXT en Java à l'aide de l'API de fusion de documents avec toutes les données, le style et la mise en forme en tant que documents source."

############################# Header ############################
title: "TXT Fusionner dans Java"
description: "Fusionnez TXT avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Fusionner plusieurs fichiers TXT dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs Java de fusionner facilement plusieurs fichiers TXT en mettant en œuvre quelques étapes simples.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers TXT à l'aide de l'exemple de code Java">}}

        ```java    
        // Fusionner les fichiers TXT à l'aide de GroupDocs.Merger pour l'API Java
