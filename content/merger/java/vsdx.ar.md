...
############################# Head ############################
head_title: "دمج ملفات VSDX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSDX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSDX الاندماج في Java"
description: "دمج VSDX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSDX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
