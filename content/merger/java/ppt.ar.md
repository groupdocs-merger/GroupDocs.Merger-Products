...
############################# Head ############################
head_title: "دمج ملفات PPT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات PPT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "PPT الاندماج في Java"
description: "دمج PPT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من PPT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
