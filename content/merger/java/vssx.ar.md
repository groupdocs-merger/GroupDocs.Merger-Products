...
############################# Head ############################
head_title: "دمج ملفات VSSX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات VSSX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "VSSX الاندماج في Java"
description: "دمج VSSX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من VSSX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
