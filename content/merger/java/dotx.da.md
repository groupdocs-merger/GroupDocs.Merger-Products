...
############################# Head ############################
head_title: "Flet DOTX filer via Java & J2SE Documents Merger API"
head_description: "Flet flere DOTX filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "DOTX fusion i Java"
description: "Flet DOTX med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere DOTX filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere DOTX-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes DOTX filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet DOTX filer ved hjælp af GroupDocs.Merger for Java API
