...
############################# Head ############################
head_title: "Обединете ODT файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество ODT файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "ODT Обединяване в Java"
description: "Обединете ODT с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество ODT файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ODT файлове с Java примерен код">}}

        ```java    
        // Обединете ODT файлове с помощта на GroupDocs.Merger за Java API
