...
############################# Head ############################
head_title: "Ühendage PPSX failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPSX-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PPSX ühinemine programmis Java"
description: "Ühendage PPSX mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PPSX faili, kasutades Java näitekoodi">}}
