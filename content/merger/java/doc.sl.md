...
############################# Head ############################
head_title: "Spoji datoteke DOC prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOC v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOC Združitev v Java"
description: "Spojite DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOC v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOC s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOC z API-jem GroupDocs.Merger for Java
