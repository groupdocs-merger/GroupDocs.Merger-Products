...
############################# Head ############################
head_title: "Spoji datoteke DOT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek DOT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "DOT Združitev v Java"
description: "Spojite DOT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek DOT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke DOT z API-jem GroupDocs.Merger for Java
