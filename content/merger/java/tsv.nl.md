...
############################# Head ############################
head_title: "Samenvoegen TSV Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "TSV Fusie in Java"
description: "Voeg TSV samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere TSV bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TSV bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg TSV bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één TSV bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) te gaan.
