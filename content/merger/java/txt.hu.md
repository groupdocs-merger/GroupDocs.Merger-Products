...
############################# Head ############################
head_title: "Egyesítse az TXT fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több TXT fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "TXT Egyesülés a Java programban"
description: "Egyesítse a(z) TXT terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több TXT fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több TXT fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="TXT fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen TXT fájlokat a GroupDocs.Merger for Java API segítségével
