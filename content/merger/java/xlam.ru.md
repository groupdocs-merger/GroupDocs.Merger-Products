...
############################# Head ############################
head_title: "Объединение XLAM файлов через Java и J2SE Documents Merger API"
head_description: "Объединяйте несколько файлов XLAM в Java, используя Merger API со всеми данными, стилем и форматированием в качестве исходных документов."

############################# Header ############################
title: "XLAM Объединение на Java"
...
steps:
    enable: true
    title_left: "Объединить несколько XLAM файлов на Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы XLAM, используя пример кода Java">}}
        ...
        ```java    
        // Объединить XLAM файлов с помощью GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Объедините несколько XLAM файлов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/merger/xlam).
