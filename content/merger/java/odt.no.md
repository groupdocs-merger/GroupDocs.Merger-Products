...
############################# Head ############################
head_title: "Slå sammen ODT filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "ODT sammenslåing i Java"
description: "Slå sammen ODT med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODT filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen ODT filer med GroupDocs.Merger for Java API
