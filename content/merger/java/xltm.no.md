...
############################# Head ############################
head_title: "Slå sammen XLTM filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "XLTM sammenslåing i Java"
description: "Slå sammen XLTM med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLTM filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen XLTM filer med GroupDocs.Merger for Java API
