...
############################# Head ############################
head_title: "Gabungkan VISIO File melalui API Penggabungan Dokumen Java & J2SE"
...
############################# Header ############################
title: "VISIO Penggabungan Dalam Java"
description: "Gabungkan VISIO dengan beberapa baris kode Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VISIO menggunakan kode contoh Java">}}
        ...
        ```java    
        // Gabungkan file VISIO menggunakan GroupDocs.Merger untuk Java API
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VISIO file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/visio).
