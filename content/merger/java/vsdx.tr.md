...
############################# Head ############################
head_title: "VSDX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSDX dosyasını birleştirin."

############################# Header ############################
title: "VSDX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSDX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) web sitesini ziyaret ederek birden fazla VSDX dosyayı birleştirin.
