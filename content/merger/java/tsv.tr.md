...
############################# Head ############################
head_title: "TSV Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla TSV dosyasını birleştirin."

############################# Header ############################
title: "TSV Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok TSV Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) web sitesini ziyaret ederek birden fazla TSV dosyayı birleştirin.
