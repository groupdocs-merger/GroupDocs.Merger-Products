...
############################# Head ############################
head_title: "Samenvoegen PPT Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "PPT Fusie in Java"
description: "Voeg PPT samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere PPT bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPT bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg PPT bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één PPT bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) te gaan.
