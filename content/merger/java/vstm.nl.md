...
############################# Head ############################
head_title: "Samenvoegen VSTM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VSTM Fusie in Java"
description: "Voeg VSTM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VSTM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSTM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VSTM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VSTM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) te gaan.
