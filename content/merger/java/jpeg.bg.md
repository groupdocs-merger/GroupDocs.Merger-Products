...
############################# Head ############################
head_title: "Обединете JPEG файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество JPEG файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "JPEG Обединяване в Java"
description: "Обединете JPEG с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество JPEG файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините JPEG файлове с Java примерен код">}}

        ```java    
        // Обединете JPEG файлове с помощта на GroupDocs.Merger за Java API
