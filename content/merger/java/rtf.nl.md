...
############################# Head ############################
head_title: "Samenvoegen RTF Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "RTF Fusie in Java"
description: "Voeg RTF samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere RTF bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe RTF bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg RTF bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één RTF bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) te gaan.
