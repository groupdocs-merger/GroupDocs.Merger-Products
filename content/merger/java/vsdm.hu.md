...
############################# Head ############################
head_title: "Egyesítse az VSDM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSDM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSDM Egyesülés a Java programban"
description: "Egyesítse a(z) VSDM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSDM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSDM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSDM fájlokat a GroupDocs.Merger for Java API segítségével
