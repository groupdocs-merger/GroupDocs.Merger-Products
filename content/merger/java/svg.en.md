...
############################# Head ############################
head_title: "Merge SVG files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate SVG document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge SVG files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage SVG documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of SVG documents. Enhance your Java applications by combining multiple files into one.
