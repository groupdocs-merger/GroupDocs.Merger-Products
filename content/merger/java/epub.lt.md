...
############################# Head ############################
head_title: "Sujunkite EPUB failus naudodami Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "EPUB Susijungimas Java"
description: "Sujunkite EPUB su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sujungti kelis EPUB failus Java"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną EPUB failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) svetainėje.
