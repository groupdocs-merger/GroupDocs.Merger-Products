...
############################# Head ############################
head_title: "Voeg VDX lêers saam via Java & J2SE Documents Merger API"
head_description: "Voeg veelvuldige VDX-lêers in Java saam met behulp van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "VDX samesmelting in Java"
description: "Voeg VDX saam met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Voeg veelvuldige VDX-lêers saam in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige VDX-lêers saam te voeg deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX lêers saam te voeg deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Voeg VDX lêers saam met GroupDocs.Merger vir Java API
