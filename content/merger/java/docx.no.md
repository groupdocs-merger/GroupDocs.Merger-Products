...
############################# Head ############################
head_title: "Slå sammen DOCX filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "DOCX sammenslåing i Java"
description: "Slå sammen DOCX med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOCX filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen DOCX filer med GroupDocs.Merger for Java API
