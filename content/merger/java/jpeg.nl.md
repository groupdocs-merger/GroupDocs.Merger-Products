...
############################# Head ############################
head_title: "Samenvoegen JPEG Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "JPEG Fusie in Java"
description: "Voeg JPEG samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere JPEG bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe JPEG bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg JPEG bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één JPEG bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) te gaan.
