...
############################# Head ############################
head_title: "Voeg CSV lêers saam via Java & J2SE Documents Merger API"
head_description: "Voeg veelvuldige CSV-lêers in Java saam met behulp van dokumentsamesmeltings-API met alle data, styl en formatering as die brondokumente."

############################# Header ############################
title: "CSV samesmelting in Java"
description: "Voeg CSV saam met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Voeg veelvuldige CSV-lêers saam in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om veelvuldige CSV-lêers saam te voeg deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om CSV lêers saam te voeg deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Voeg CSV lêers saam met GroupDocs.Merger vir Java API
