...
############################# Head ############################
head_title: "Spoji datoteke RTF prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek RTF v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "RTF Združitev v Java"
description: "Spojite RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek RTF v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke RTF s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke RTF z API-jem GroupDocs.Merger for Java
