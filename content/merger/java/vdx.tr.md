...
############################# Head ############################
head_title: "VDX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VDX dosyasını birleştirin."

############################# Header ############################
title: "VDX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VDX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) web sitesini ziyaret ederek birden fazla VDX dosyayı birleştirin.
