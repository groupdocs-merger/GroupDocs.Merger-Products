...
############################# Head ############################
head_title: "Cumaisc XLSM Comhaid trí Java & J2SE Documents Merger API"
head_description: "Cumaisc comhaid XLSM iolracha i Java ag baint úsáide as API cumasc doiciméad leis na sonraí, an stíl agus an fhormáidiú go léir mar bhundoiciméid."

############################# Header ############################
title: "XLSM Cumasc i Java"
description: "Cumaisc XLSM le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Cumaisc XLSM Comhad iolracha i Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d’fhorbróirí Java chun comhaid XLSM iolracha a chumasc trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLSM comhad a chumasc le cód samplach Java">}}

        ```java    
        // Cumaisc XLSM comhad le GroupDocs.Merger le haghaidh Java API
