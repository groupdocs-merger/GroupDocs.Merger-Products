...
############################# Head ############################
head_title: "دمج ملفات DOT عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات DOT في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "DOT الاندماج في Java"
description: "دمج DOT ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من DOT ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
