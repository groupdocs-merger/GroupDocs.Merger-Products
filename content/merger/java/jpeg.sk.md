...
############################# Head ############################
head_title: "Zlúčiť súbory JPEG cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero JPEG súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "JPEG Zlúčenie v Java"
description: "Zlúčte JPEG s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero JPEG súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov JPEG vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory JPEG pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť JPEG súbory pomocou GroupDocs.Merger for Java API
