...
############################# Head ############################
head_title: "Zlúčiť súbory VDX cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero VDX súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "VDX Zlúčenie v Java"
description: "Zlúčte VDX s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero VDX súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov VDX vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory VDX pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť VDX súbory pomocou GroupDocs.Merger for Java API
