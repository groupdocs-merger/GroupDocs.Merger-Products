...
############################# Head ############################
head_title: "Merge XLSX files in Java"
head_description: "Use GroupDocs.Merger for Java to integrate XLSX document merging capabilities into your Java projects."

############################# Header ############################
title: "Merge XLSX files" 
description: "With GroupDocs.Merger for Java, you can build advanced Java applications that seamlessly merge and manage XLSX documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) enables seamless merging of XLSX documents. Enhance your Java applications by combining multiple files into one.
