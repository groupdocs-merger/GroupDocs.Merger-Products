...
############################# Head ############################
head_title: "Flet XPS filer via Java & J2SE Documents Merger API"
head_description: "Flet flere XPS filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "XPS fusion i Java"
description: "Flet XPS med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere XPS filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere XPS-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XPS filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet XPS filer ved hjælp af GroupDocs.Merger for Java API
