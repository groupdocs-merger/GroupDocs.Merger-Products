...
############################# Head ############################
head_title: "Samenvoegen VSDM Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VSDM Fusie in Java"
description: "Voeg VSDM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VSDM bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSDM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VSDM bestanden samen met GroupDocs.Merger voor Java API
