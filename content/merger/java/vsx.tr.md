...
############################# Head ############################
head_title: "VSX Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla VSX dosyasını birleştirin."

############################# Header ############################
title: "VSX Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok VSX Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) web sitesini ziyaret ederek birden fazla VSX dosyayı birleştirin.
