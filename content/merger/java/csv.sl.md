...
############################# Head ############################
head_title: "Spoji datoteke CSV prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek CSV v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "CSV Združitev v Java"
description: "Spojite CSV z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek CSV v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke CSV s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke CSV z API-jem GroupDocs.Merger for Java
