...
############################# Head ############################
head_title: "Flet DOT filer via Java & J2SE Documents Merger API"
head_description: "Flet flere DOT filer i Java ved hjælp af documents merger API med alle data, stil og formatering som kildedokumenter."

############################# Header ############################
title: "DOT fusion i Java"
description: "Flet DOT med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Flet flere DOT filer i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at flette flere DOT-filer ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes DOT filer ved hjælp af Java eksempelkode">}}

        ```java    
        // Flet DOT filer ved hjælp af GroupDocs.Merger for Java API
