...
############################# Head ############################
head_title: "Samenvoegen ODP Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "ODP Fusie in Java"
description: "Voeg ODP samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere ODP bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODP bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg ODP bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één ODP bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) te gaan.
