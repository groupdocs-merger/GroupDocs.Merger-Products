...
############################# Head ############################
head_title: "Spoji datoteke VSTM prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek VSTM v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "VSTM Združitev v Java"
description: "Spojite VSTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek VSTM v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSTM s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke VSTM z API-jem GroupDocs.Merger for Java
