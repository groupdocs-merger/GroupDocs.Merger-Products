...
############################# Head ############################
head_title: "Samenvoegen BMP Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "BMP Fusie in Java"
description: "Voeg BMP samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere BMP bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe BMP bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg BMP bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één BMP bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) te gaan.
