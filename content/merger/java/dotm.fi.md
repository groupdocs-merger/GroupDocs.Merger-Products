...
head_description: "Yhdistä useita DOTM-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "DOTM Sulautuminen Java"
description: "Yhdistä DOTM muutamalla rivillä Java-koodia."
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOTM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) -sivustolla.
