...
############################# Head ############################
head_title: "XLS ፋይሎችን በJava እና J2SE ሰነዶች ውህደት ኤፒአይ አዋህድ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ XLS ፋይሎችን በጃቫ ውስጥ ያዋህዱ ከሁሉም ውሂብ፣ ቅጥ እና ቅርጸት እንደ ምንጭ ሰነዶች።"

############################# Header ############################
title: "የXLS ውህደት በJava"
description: "XLSን ከጥቂት የJava ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በJava ውስጥ ብዙ XLS ፋይሎችን አዋህድ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java) ጥቂት ቀላል ደረጃዎችን በመተግበር ለጃቫ ገንቢዎች ብዙ XLS ፋይሎችን ማዋሃድ ቀላል ያደርገዋል።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም XLS ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```java    
        // GroupDocs.Merger ለጃቫ ኤፒአይን በመጠቀም XLS ፋይሎችን አዋህድ
