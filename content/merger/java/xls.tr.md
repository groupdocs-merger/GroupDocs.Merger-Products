...
############################# Head ############################
head_title: "XLS Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLS dosyasını birleştirin."

############################# Header ############################
title: "XLS Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLS Dosyayı Java İçinde Birleştirin"
    content_left: |
