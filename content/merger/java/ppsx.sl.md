...
############################# Head ############################
head_title: "Spoji datoteke PPSX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek PPSX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "PPSX Združitev v Java"
description: "Spojite PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek PPSX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPSX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke PPSX z API-jem GroupDocs.Merger for Java
