...
############################# Head ############################
head_title: "Yhdistä TEX tiedostot Java & J2SE Documents Merger API:n kautta"
head_description: "Yhdistä useita TEX-tiedostoja Javassa käyttämällä asiakirjojen yhdistämissovellusliittymää, jossa kaikki tiedot, tyylit ja muotoilut ovat lähdeasiakirjoina."

############################# Header ############################
title: "TEX Sulautuminen Java"
description: "Yhdistä TEX muutamalla rivillä Java-koodia."
...
steps:
    enable: true
    title_left: "Yhdistä useita TEX tiedostoja tuotteessa Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi yhdistää useita TEX-tiedostoja muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää TEX tiedostoja käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Yhdistä TEX tiedostot GroupDocs.Merger for Java API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi TEX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) -sivustolla.
