...
############################# Head ############################
head_title: "Zlúčiť súbory DOC cez rozhranie Java & J2SE Documents Merger API"
head_description: "Zlúčte viacero DOC súborov v jazyku Java pomocou rozhrania API na zlučovanie dokumentov so všetkými údajmi, štýlom a formátovaním ako zdrojovými dokumentmi."

############################# Header ############################
title: "DOC Zlúčenie v Java"
description: "Zlúčte DOC s niekoľkými riadkami kódu Java."
...
steps:
    enable: true
    title_left: "Zlúčiť viacero DOC súborov v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java zlúčiť viacero súborov DOC vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOC pomocou vzorového kódu Java">}}

        ```java    
        // Zlúčiť DOC súbory pomocou GroupDocs.Merger for Java API
