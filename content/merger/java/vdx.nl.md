...
############################# Head ############################
head_title: "Samenvoegen VDX Bestanden via Java & J2SE Documents Fusie-API"
...
############################# Header ############################
title: "VDX Fusie in Java"
description: "Voeg VDX samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere VDX bestanden samen in Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VDX bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg VDX bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één VDX bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) te gaan.
