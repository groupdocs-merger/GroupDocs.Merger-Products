...
############################# Head ############################
head_title: "Spoji DOCM datoteke putem Java & J2SE Documents Merger API-ja"
head_description: "Spojite više DOCM datoteka u Javi pomoću API-ja za spajanje dokumenata sa svim podacima, stilom i oblikovanjem kao izvornim dokumentima."

############################# Header ############################
title: "DOCM Spajanje u Java"
description: "Spoji DOCM s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Spoji više DOCM datoteka u Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCM datoteke koristeći Java primjer koda">}}
        ...
        ```java    
        // Spoji DOCM datoteke koristeći GroupDocs.Merger za Java API
