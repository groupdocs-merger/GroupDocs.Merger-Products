...
############################# Head ############################
head_title: "Samenvoegen XLSM Bestanden via Java & J2SE Documents Fusie-API"
head_description: "Voeg meerdere XLSM-bestanden samen in Java met behulp van de API voor het samenvoegen van documenten met alle gegevens, stijl en opmaak als brondocumenten."

############################# Header ############################
title: "XLSM Fusie in Java"
description: "Voeg XLSM samen met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Voeg meerdere XLSM bestanden samen in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java-ontwikkelaars om meerdere XLSM-bestanden samen te voegen door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSM bestanden samen te voegen met behulp van Java voorbeeldcode">}}

        ```java    
        // Voeg XLSM bestanden samen met GroupDocs.Merger voor Java API
...
demos:
    ...
    content: |
       Voeg nu meer dan één XLSM bestanden samen door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) te gaan.
