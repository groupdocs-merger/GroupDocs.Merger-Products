...
############################# Head ############################
head_title: "Îmbinați fișierele DOC prin API-ul pentru fuziunea documentelor Java și J2SE"
head_description: "Îmbinați mai multe fișiere DOC în Java folosind API-ul de fuziune a documentelor cu toate datele, stilul și formatarea ca documente sursă."

############################# Header ############################
title: "DOC Fuziune în Java"
description: "Îmbinați DOC cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Îmbinați mai multe fișiere DOC în Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează îmbinarea mai multor fișiere DOC pentru dezvoltatorii Java prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere DOC folosind codul exemplu Java">}}

        ```java    
        // Îmbinați fișiere DOC utilizând API-ul GroupDocs.Merger pentru Java
