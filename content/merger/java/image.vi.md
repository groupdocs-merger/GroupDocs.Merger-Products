...
############################# Head ############################
head_title: "Gộp các tệp IMAGE trong Java"
head_description: "Sử dụng GroupDocs.Merger for Java để tích hợp khả năng gộp tài liệu IMAGE vào các dự án Java của bạn."

############################# Header ############################
title: "Gộp các tệp IMAGE" 
description: "Với GroupDocs.Merger for Java, bạn có thể xây dựng các ứng dụng Java tiên tiến có khả năng gộp và quản lý các tài liệu IMAGE một cách liền mạch."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/) cho phép gộp liền mạch các tài liệu IMAGE. Nâng cao các ứng dụng Java của bạn bằng cách kết hợp nhiều tệp thành một.
      
      1. Cung cấp đường dẫn đến tệp IMAGE đầu tiên.
