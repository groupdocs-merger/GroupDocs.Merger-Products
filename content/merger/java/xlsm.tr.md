...
############################# Head ############################
head_title: "XLSM Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla XLSM dosyasını birleştirin."

############################# Header ############################
title: "XLSM Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok XLSM Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) web sitesini ziyaret ederek birden fazla XLSM dosyayı birleştirin.
