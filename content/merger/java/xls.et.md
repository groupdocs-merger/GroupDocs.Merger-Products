...
############################# Head ############################
head_title: "Ühendage XLS failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu XLS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "XLS ühinemine programmis Java"
description: "Ühendage XLS mõne rea koodiga Java."
...
steps:
    enable: true
    title_left: "Ühendage mitu XLS faili tootes Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java-arendajate jaoks lihtsaks mitme XLS faili liitmise, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLS faili, kasutades Java näitekoodi">}}

        ```java    
        // Ühendage failid XLS, kasutades GroupDocs.Merger for Java API-t
