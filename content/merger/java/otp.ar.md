...
############################# Head ############################
head_title: "دمج ملفات OTP عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات OTP في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "OTP الاندماج في Java"
description: "دمج OTP ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من OTP ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
