...
############################# Head ############################
head_title: "Spoji datoteke XLTX prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek XLTX v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "XLTX Združitev v Java"
description: "Spojite XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek XLTX v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLTX s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke XLTX z API-jem GroupDocs.Merger for Java
