...
############################# Head ############################
head_title: "Egyesítse az DOCM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több DOCM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "DOCM Egyesülés a Java programban"
description: "Egyesítse a(z) DOCM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több DOCM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több DOCM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen DOCM fájlokat a GroupDocs.Merger for Java API segítségével
