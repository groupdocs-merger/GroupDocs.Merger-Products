...
############################# Head ############################
head_title: "دمج ملفات XLTX عبر Java & J2SE Documents Merger API"
head_description: "دمج عدة ملفات XLTX في Java باستخدام واجهة برمجة تطبيقات دمج المستندات مع جميع البيانات والأسلوب والتنسيق كمستندات المصدر."

############################# Header ############################
title: "XLTX الاندماج في Java"
description: "دمج XLTX ببضعة أسطر من كود Java."
...
demos:
    ...
    content: |
       ادمج أكثر من XLTX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
