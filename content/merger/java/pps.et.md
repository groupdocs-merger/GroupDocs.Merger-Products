...
############################# Head ############################
head_title: "Ühendage PPS failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPS-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PPS ühinemine programmis Java"
description: "Ühendage PPS mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PPS faili, kasutades Java näitekoodi">}}
