...
############################# Head ############################
head_title: "Slå sammen PPS filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "PPS sammenslåing i Java"
description: "Slå sammen PPS med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPS filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen PPS filer med GroupDocs.Merger for Java API
