...
############################# Head ############################
head_title: "Egyesítse az TEX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több TEX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "TEX Egyesülés a Java programban"
description: "Egyesítse a(z) TEX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több TEX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több TEX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen TEX fájlokat a GroupDocs.Merger for Java API segítségével
