...
############################# Head ############################
head_title: "Slå sammen ODS filer via Java & J2SE Documents Merger API"
...
############################# Header ############################
title: "ODS sammenslåing i Java"
description: "Slå sammen ODS med noen få linjer med Java-kode."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODS filer ved å bruke Java eksempelkode">}}

        ```java    
        // Slå sammen ODS filer med GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
       Slå sammen mer enn én ODS-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
