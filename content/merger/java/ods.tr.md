...
############################# Head ############################
head_title: "ODS Dosyalarını Java ve J2SE Belgeleri Birleştirme API'si ile Birleştirin"
head_description: "Kaynak belgeler olarak tüm veriler, stiller ve biçimlendirme ile belge birleştirme API'sini kullanarak Java'da birden fazla ODS dosyasını birleştirin."

############################# Header ############################
title: "ODS Java'da Birleşme"
...
steps:
    enable: true
    title_left: "Birden Çok ODS Dosyayı Java İçinde Birleştirin"
    content_left: |
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) web sitesini ziyaret ederek birden fazla ODS dosyayı birleştirin.
