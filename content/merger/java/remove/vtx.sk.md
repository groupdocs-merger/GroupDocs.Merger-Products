...
############################# Head ############################
head_title: "Odstrániť VTX stránky v Java"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru VTX v Java obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť VTX stránky v Java"
description: "Odstráňte VTX stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Odstrániť VTX stránky súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java odstrániť jednu alebo viacero konkrétnych stránok v rámci VTX súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru VTX pomocou vzorového kódu Java">}}

        ```java    
        // Odstráňte stránky súboru VTX pomocou rozhrania GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – odstránenie VTX stránok online"
    content: |
       Odstráňte stránky súboru VTX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx).
