...
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en OTP-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern OTP sider i Java"
description: "Fjern OTP-sider med noen få linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en OTP fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne OTP filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Fjern OTP filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern OTP-sider på nettet"
    content: |
       Fjern OTP-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp).
