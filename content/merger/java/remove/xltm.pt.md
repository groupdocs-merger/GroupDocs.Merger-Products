...
############################# Head ############################
head_title: "Remover XLTM Páginas em Java"
head_description: "Remova ou exclua uma única página ou coleção de páginas de um arquivo XLTM em Java invertendo a ordem das páginas usando a API de fusão de documentos."

############################# Header ############################
title: "Remover XLTM Páginas em Java"
description: "Remova XLTM Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Remover páginas de arquivo XLTM em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java excluir uma ou várias páginas específicas em um XLTM arquivo implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como remover páginas de arquivo XLTM usando o código de exemplo Java">}}

        ```java    
        // Remova as páginas do arquivo XLTM usando a API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstrações ao vivo - remover XLTM páginas on-line"
    content: |
       Remova as páginas de arquivo XLTM agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltm).
