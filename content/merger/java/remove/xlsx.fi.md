...
############################# Head ############################
head_title: "Poista XLSX sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLSX-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLSX sivut Java"
description: "Poista XLSX sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista XLSX tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLSX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista XLSX tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista XLSX sivua verkosta"
    content: |
       Poista XLSX tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx) -sivustolla.
