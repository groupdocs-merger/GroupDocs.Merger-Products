...
############################# Head ############################
head_title: "Հեռացնել EPUB էջ Java-ից"
head_description: "Հեռացրեք կամ ջնջեք մեկ էջ կամ էջերի հավաքածու EPUB ֆայլից Java-ում` փոխելով էջերի հերթականությունը` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Հեռացնել EPUB էջ Java-ում"
description: "Հեռացրեք EPUB էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Հեռացնել EPUB ֆայլի էջեր Java-ից"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար ջնջել մեկ կամ մի քանի կոնկրետ էջեր EPUB-ի շրջանակներում: ֆայլ՝ իրականացնելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հեռացնել EPUB ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Հեռացրեք EPUB ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Հեռացրեք EPUB էջեր առցանց"
    content: |
       Հեռացրեք EPUB ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub) կայքը:
