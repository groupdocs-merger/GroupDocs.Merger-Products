...
############################# Head ############################
head_title: "Alih keluar DOTX Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail DOTX dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar DOTX Halaman Dalam Java"
description: "Alih keluar DOTX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar DOTX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam DOTX fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar DOTX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar DOTX halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar DOTX Halaman Dalam Talian"
    content: |
       Alih keluar DOTX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
