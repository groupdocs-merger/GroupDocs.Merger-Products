...
############################# Head ############################
head_title: "Ta bort VTX sidor i Java"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en VTX-fil i Java genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort VTX sidor i Java"
description: "Ta bort VTX-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Ta bort VTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en VTX fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort VTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Ta bort VTX filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Ta bort VTX sidor online"
    content: |
       Ta bort VTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx).
