...
############################# Head ############################
head_title: "Odebrat XLSM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XLSM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XLSM stránky v Java"
description: "Odstraňte XLSM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XLSM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XLSM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XLSM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XLSM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XLSM stránek online"
    content: |
       Odstraňte stránky souborů XLSM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
