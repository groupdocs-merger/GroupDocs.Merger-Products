...
############################# Head ############################
head_title: "Fjern OTT sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en OTT-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern OTT sider i Java"
description: "Fjern OTT sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern OTT filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en OTT fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du OTT filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern OTT filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern OTT sider online"
    content: |
       Fjern OTT filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott).
