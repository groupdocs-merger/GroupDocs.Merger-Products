...
############################# Head ############################
head_title: "Remove VSTX Pages in Java"
head_description: "Remove or delete a single page or collection of pages from a VSTX file in Java by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove VSTX Pages In Java"
description: "Remove VSTX Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a VSTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove VSTX file pages using Java example code">}}
