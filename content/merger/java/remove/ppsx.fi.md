...
############################# Head ############################
head_title: "Poista PPSX sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma PPSX-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista PPSX sivut Java"
description: "Poista PPSX sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista PPSX tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja PPSX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa PPSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista PPSX tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista PPSX sivua verkosta"
    content: |
       Poista PPSX tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx) -sivustolla.
