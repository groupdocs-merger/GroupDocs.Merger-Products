...
############################# Head ############################
head_title: "Hapus XPS Halaman di Java"
...
############################# Header ############################
title: "Hapus XPS Halaman Di Java"
description: "Hapus XPS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus XPS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam XPS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XPS menggunakan kode contoh Java">}}
