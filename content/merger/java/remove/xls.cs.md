...
############################# Head ############################
head_title: "Odebrat XLS stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XLS v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XLS stránky v Java"
description: "Odstraňte XLS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XLS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XLS soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XLS pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XLS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XLS stránek online"
    content: |
       Odstraňte stránky souborů XLS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xls).
