...
############################# Head ############################
head_title: "Java İçindeki VSTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek Java içindeki bir VSTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "Java İçindeki VSTX Sayfayı Kaldır"
description: "Birkaç satır Java kodu içeren VSTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: "Java içindeki VSTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir VSTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VSTX dosya sayfaları nasıl kaldırılır">}}

        ```java    
        // GroupDocs.Merger API kullanarak VSTX dosya sayfalarını kaldırın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi VSTX Sayfayı Kaldırın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx) web sitesini ziyaret ederek VSTX dosya sayfalarını hemen kaldırın.
