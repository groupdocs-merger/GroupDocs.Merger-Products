...
############################# Head ############################
head_title: "Pašalinti ODP puslapius iš Java"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš ODP failo Java, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti ODP puslapius iš Java"
description: "Pašalinkite ODP puslapius su keliomis Java kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti ODP failo puslapius iš Java"
    content_left: |
        [GroupDocs.Merger for Java](/lt/merger/java/) leidžia Java kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš ODP failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti ODP failo puslapius naudojant Java pavyzdinį kodą">}}

        ```java    
        // Pašalinkite ODP failo puslapius naudodami GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiesioginės demonstracinės versijos – pašalinkite ODP puslapius internete"
    content: |
       Pašalinkite ODP failo puslapius dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp) svetainėje.
