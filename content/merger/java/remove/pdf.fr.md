...
############################# Head ############################
head_title: "Supprimer PDF pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier PDF dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer PDF pages dans Java"
description: "Supprimez les pages PDF avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer PDF pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un PDF fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers PDF à l'aide de l'exemple de code Java">}}

        ```java    
        // Supprimer PDF pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Supprimer PDF pages en ligne"
    content: |
       Supprimez PDF pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf).
