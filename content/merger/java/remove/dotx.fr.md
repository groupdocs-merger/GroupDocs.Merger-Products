...
############################# Head ############################
head_title: "Supprimer DOTX pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier DOTX dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer DOTX pages dans Java"
description: "Supprimez les pages DOTX avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer DOTX pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un DOTX fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers DOTX à l'aide de l'exemple de code Java">}}
