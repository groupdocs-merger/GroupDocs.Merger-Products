...
############################# Head ############################
head_title: "Poista VSTM sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSTM-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSTM sivut Java"
description: "Poista VSTM sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista VSTM tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSTM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista VSTM tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista VSTM sivua verkosta"
    content: |
       Poista VSTM tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm) -sivustolla.
