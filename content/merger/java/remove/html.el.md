...
############################# Head ############################
head_title: "Κατάργηση HTML σελίδων στο Java"
head_description: "Καταργήστε ή διαγράψτε μια μεμονωμένη σελίδα ή μια συλλογή σελίδων από ένα αρχείο HTML στο Java αντιστρέφοντας τη σειρά των σελίδων χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Κατάργηση HTML σελίδων στο Java"
description: "Καταργήστε HTML Σελίδες με μερικές γραμμές κώδικα Java."
...
steps:
    enable: true
    title_left: "Κατάργηση σελίδων αρχείου HTML στο Java"
    content_left: |
        [GroupDocs.Merger for Java](/el/merger/java/) διευκολύνει τους προγραμματιστές του Java να διαγράψουν μία ή περισσότερες συγκεκριμένες σελίδες μέσα σε ένα HTML αρχείο εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να αφαιρέσετε HTML σελίδες αρχείου χρησιμοποιώντας παράδειγμα κώδικα Java">}}

        ```java    
        // Καταργήστε HTML σελίδες αρχείου χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    enable: true
    title: "Ζωντανές επιδείξεις - Κατάργηση σελίδων HTML στο διαδίκτυο"
    content: |
       Καταργήστε HTML σελίδες αρχείων αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html).
