...
############################# Head ############################
head_title: "OTT Seiten in Java entfernen"
head_description: "Entfernen oder löschen Sie eine einzelne Seite oder eine Sammlung von Seiten aus einer OTT-Datei in Java, indem Sie die Seitenreihenfolge mithilfe der Documents Merger API umkehren."

############################# Header ############################
title: "Entfernen Sie OTT Seiten in Java"
description: "Entfernen Sie OTT-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Entfernen Sie OTT Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) erleichtert Entwicklern von Java das Löschen einer einzelnen oder mehrerer bestimmter Seiten innerhalb eines OTT Datei, indem Sie ein paar einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So entfernen Sie OTT-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Entfernen Sie OTT-Dateiseiten mithilfe der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Entfernen Sie OTT Seiten online"
    content: |
       Entfernen Sie jetzt OTT Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott) besuchen.
