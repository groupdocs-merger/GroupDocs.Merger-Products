...
############################# Head ############################
head_title: "Java ішіндегі ODP беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы Java ішіндегі ODP файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "Java ішіндегі ODP беттерді жою"
description: "Java кодының бірнеше жолы бар ODP беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі ODP файл бетін жою"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне ODP ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP файл бетін Java мысал кодын пайдаланып жою жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы ODP файл бетін жойыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - ODP беттерді желіден алып тастаңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp) веб-сайтына кіру арқылы ODP файл бетін дәл қазір жойыңыз.
