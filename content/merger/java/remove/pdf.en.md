...
############################# Head ############################
head_title: "Delete PDF pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to remove specific pages from PDF documents. Easily process PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Delete pages in PDF" 
description: "GroupDocs.Merger for Java enhances Java apps with powerful document processing features, including page removal in PDF files."
...
steps:
    enable: true
    title: "How to delete pages in PDF"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to easily remove pages from PDF documents. Enhance your Java applications with advanced document management capabilities.
