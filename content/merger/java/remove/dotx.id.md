...
############################# Head ############################
head_title: "Hapus DOTX Halaman di Java"
...
############################# Header ############################
title: "Hapus DOTX Halaman Di Java"
description: "Hapus DOTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus DOTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam DOTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOTX menggunakan kode contoh Java">}}
