...
############################# Head ############################
head_title: "Odebrat PPSX stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru PPSX v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat PPSX stránky v Java"
description: "Odstraňte PPSX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat PPSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci PPSX soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru PPSX pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru PPSX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte PPSX stránek online"
    content: |
       Odstraňte stránky souborů PPSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
