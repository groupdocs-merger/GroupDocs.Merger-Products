...
############################# Head ############################
head_title: "Poista OTP sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma OTP-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista OTP sivut Java"
description: "Poista OTP sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista OTP tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja OTP tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa OTP tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista OTP tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista OTP sivua verkosta"
    content: |
       Poista OTP tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp) -sivustolla.
