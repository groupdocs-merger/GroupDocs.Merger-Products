...
############################# Head ############################
head_title: "Ta bort XLSX sidor i Java"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en XLSX-fil i Java genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort XLSX sidor i Java"
description: "Ta bort XLSX-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Ta bort XLSX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en XLSX fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort XLSX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Ta bort XLSX filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Ta bort XLSX sidor online"
    content: |
       Ta bort XLSX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx).
