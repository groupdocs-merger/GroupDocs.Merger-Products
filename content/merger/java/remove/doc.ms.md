...
############################# Head ############################
head_title: "Alih keluar DOC Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail DOC dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar DOC Halaman Dalam Java"
description: "Alih keluar DOC Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar DOC Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam DOC fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar DOC halaman fail menggunakan kod contoh Java.">}}
