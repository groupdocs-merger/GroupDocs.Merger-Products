...
############################# Head ############################
head_title: "Rûpelên DOC di Java de rake"
head_description: "Rûpelek yek an berhevokek rûpelan ji pelek DOC ya di Java de jêbikin an jêbikin bi berevajîkirina rêzika rûpelan bi karanîna API-ya yekkirina belgeyan."

############################# Header ############################
title: "Rûpelên DOC Di Java de rake"
description: "Rûpelên DOC yên bi çend rêzikên koda {{Navê berhemê}} rakin."
...
steps:
    enable: true
    title_left: "Rûpelên Pelê DOC di Java de rake"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku yek an çend rûpelên taybetî di nav DOC de jêbikin. pelê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên DOC jêbirin">}}

        ```java    
        // Rûpelên pelê yên DOC bi karanîna API-ya GroupDocs.Merger rakin
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl ên DOC jêbirin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc) niha rûpelên pelê yên DOC rakin.
