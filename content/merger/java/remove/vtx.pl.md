...
############################# Head ############################
head_title: "Usuń VTX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VTX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VTX strony w Java"
description: "Usuń strony VTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików VTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w VTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików VTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń VTX strony online"
    content: |
       Usuń strony plików VTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx).
