...
############################# Head ############################
head_title: "Poista DOC sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOC-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOC sivut Java"
description: "Poista DOC sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista DOC tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOC tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOC tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista DOC tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista DOC sivua verkosta"
    content: |
       Poista DOC tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc) -sivustolla.
