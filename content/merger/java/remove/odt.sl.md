...
############################# Head ############################
head_title: "Odstrani strani ODT v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ODT v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ODT strani v Java"
description: "Odstranite strani ODT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ODT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj ODT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ODT s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke ODT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani ODT na spletu"
    content: |
       Takoj odstranite strani datoteke ODT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odt).
