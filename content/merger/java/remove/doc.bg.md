...
############################# Head ############################
head_title: "Премахване на DOC страници в Java"
head_description: "Премахнете или изтрийте отделна страница или колекция от страници от DOC файл в Java чрез обръщане на реда на страниците с помощта на API за сливане на документи."

############################# Header ############################
title: "Премахване на DOC страници в Java"
description: "Премахнете страниците DOC с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Премахнете DOC файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да изтрият една или няколко конкретни страници в DOC файл, като изпълните няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премахнете DOC файлови страници с помощта на Java примерен код">}}

        ```java    
        // Премахнете DOC файлови страници с помощта на GroupDocs.Merger API
...
demos:
    enable: true
    title: "Демонстрации на живо - Премахнете DOC страници онлайн"
    content: |
       Премахнете DOC файлови страници веднага, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc).
