...
############################# Head ############################
head_title: "በJava ውስጥ OTP ገጾችን ያስወግዱ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የገጾቹን ቅደም ተከተል በመቀየር በJava ውስጥ ካለው የOTP ፋይል አንድ ገጽ ወይም የገጾችን ስብስብ ያስወግዱ ወይም ይሰርዙ።"

############################# Header ############################
title: "በJava ውስጥ OTP ገጾችን አስወግድ"
description: "OTP ገጾችን በጥቂት የJava ኮድ መስመሮች ያስወግዱ።"
...
steps:
    enable: true
    title_left: "OTP የፋይል ገጾችን በJava ውስጥ ያስወግዱ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች በOTP ውስጥ አንድ ነጠላ ወይም የተወሰኑ ገጾችን መሰረዝ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር ፋይል ያድርጉ።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የOTP ፋይል ገጾችን እንዴት ማስወገድ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የOTP ፋይል ገጾችን ያስወግዱ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - OTP ገጾችን በመስመር ላይ ያስወግዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/{ext}}) ድር ጣቢያን በመጎብኘት የOTP ፋይል ገፆችን አሁኑኑ ያስወግዱ።
