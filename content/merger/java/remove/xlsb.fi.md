...
############################# Head ############################
head_title: "Poista XLSB sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLSB-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLSB sivut Java"
description: "Poista XLSB sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista XLSB tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLSB tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLSB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista XLSB tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista XLSB sivua verkosta"
    content: |
       Poista XLSB tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsb) -sivustolla.
