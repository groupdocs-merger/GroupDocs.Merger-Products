...
############################# Head ############################
head_title: "Odstrani strani XLSB v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLSB v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLSB strani v Java"
description: "Odstranite strani XLSB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLSB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLSB datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLSB s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLSB z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLSB na spletu"
    content: |
       Takoj odstranite strani datoteke XLSB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsb).
