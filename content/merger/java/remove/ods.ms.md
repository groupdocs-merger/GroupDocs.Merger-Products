...
############################# Head ############################
head_title: "Alih keluar ODS Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail ODS dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar ODS Halaman Dalam Java"
description: "Alih keluar ODS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar ODS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam ODS fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar ODS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar ODS halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar ODS Halaman Dalam Talian"
    content: |
       Alih keluar ODS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ods).
