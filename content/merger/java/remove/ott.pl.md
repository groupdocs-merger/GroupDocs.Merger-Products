...
############################# Head ############################
head_title: "Usuń OTT strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku OTT w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń OTT strony w Java"
description: "Usuń strony OTT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików OTT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w OTT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików OTT za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików OTT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń OTT strony online"
    content: |
       Usuń strony plików OTT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott).
