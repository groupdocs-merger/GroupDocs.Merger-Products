...
############################# Head ############################
head_title: "Usuń ODS strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku ODS w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń ODS strony w Java"
description: "Usuń strony ODS z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików ODS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w ODS plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików ODS za pomocą przykładowego kodu Java">}}
