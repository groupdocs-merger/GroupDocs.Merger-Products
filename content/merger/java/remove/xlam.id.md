...
############################# Head ############################
head_title: "Hapus XLAM Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLAM di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLAM Halaman Di Java"
description: "Hapus XLAM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus XLAM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam XLAM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLAM menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file XLAM menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLAM Laman Daring"
    content: |
       Hapus halaman file XLAM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/xlam).
