...
############################# Head ############################
head_title: "Hapus MHT Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file MHT di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus MHT Halaman Di Java"
description: "Hapus MHT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus MHT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam MHT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file MHT menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file MHT menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus MHT Laman Daring"
    content: |
       Hapus halaman file MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/mht).
