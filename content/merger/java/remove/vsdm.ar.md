...
############################# Head ############################
head_title: "إزالة صفحات VSDM في Java"
head_description: "قم بإزالة أو حذف صفحة واحدة أو مجموعة صفحات من ملف VSDM في Java عن طريق عكس ترتيب الصفحات باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "إزالة صفحات VSDM في Java"
description: "قم بإزالة صفحات VSDM التي تحتوي على بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "إزالة صفحات ملف VSDM في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java حذف صفحة واحدة أو عدد من الصفحات المعينة داخل VSDM ملف من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية إزالة صفحات الملف VSDM باستخدام كود مثال Java">}}

        ```java    
        // إزالة صفحات الملف VSDM باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بإزالة VSDM من الصفحات على الإنترنت"
    content: |
       قم بإزالة صفحات ملف VSDM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
