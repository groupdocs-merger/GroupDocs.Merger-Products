...
############################# Head ############################
head_title: "በJava ውስጥ MHTML ገጾችን ያስወግዱ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የገጾቹን ቅደም ተከተል በመቀየር በJava ውስጥ ካለው የMHTML ፋይል አንድ ገጽ ወይም የገጾችን ስብስብ ያስወግዱ ወይም ይሰርዙ።"

############################# Header ############################
title: "በJava ውስጥ MHTML ገጾችን አስወግድ"
description: "MHTML ገጾችን በጥቂት የJava ኮድ መስመሮች ያስወግዱ።"
...
steps:
    enable: true
    title_left: "MHTML የፋይል ገጾችን በJava ውስጥ ያስወግዱ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች በMHTML ውስጥ አንድ ነጠላ ወይም የተወሰኑ ገጾችን መሰረዝ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር ፋይል ያድርጉ።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የMHTML ፋይል ገጾችን እንዴት ማስወገድ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የMHTML ፋይል ገጾችን ያስወግዱ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - MHTML ገጾችን በመስመር ላይ ያስወግዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/{ext}}) ድር ጣቢያን በመጎብኘት የMHTML ፋይል ገፆችን አሁኑኑ ያስወግዱ።
