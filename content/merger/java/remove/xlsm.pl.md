...
############################# Head ############################
head_title: "Usuń XLSM strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XLSM w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XLSM strony w Java"
description: "Usuń strony XLSM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików XLSM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w XLSM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XLSM za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików XLSM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń XLSM strony online"
    content: |
       Usuń strony plików XLSM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
