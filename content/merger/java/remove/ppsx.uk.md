...
############################# Head ############################
head_title: "Видалити сторінки PPSX у Java"
head_description: "Вилучіть або видаліть одну сторінку чи колекцію сторінок із файлу PPSX у Java, змінивши порядок сторінок на протилежний за допомогою API об’єднання документів."

############################# Header ############################
title: "Видалити PPSX сторінки в Java"
description: "Видаліть сторінки PPSX із кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Видалити сторінки файлу PPSX у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) спрощує розробникам Java видаляти одну чи кілька конкретних сторінок у PPSX файл, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як видалити сторінки файлу PPSX за допомогою прикладу коду Java">}}
