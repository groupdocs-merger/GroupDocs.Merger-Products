...
############################# Head ############################
head_title: "Fjarlægðu DOTM síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr DOTM skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu DOTM síður í Java"
description: "Fjarlægðu DOTM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu DOTM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan DOTM skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja DOTM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu DOTM skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu DOTM síður á netinu"
    content: |
       Fjarlægðu DOTM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotm) vefsíðu.
