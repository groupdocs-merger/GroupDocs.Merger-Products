...
############################# Head ############################
head_title: "Usuń PPS strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPS w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPS strony w Java"
description: "Usuń strony PPS z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPS w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w PPS plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPS za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików PPS za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń PPS strony online"
    content: |
       Usuń strony plików PPS już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pps).
