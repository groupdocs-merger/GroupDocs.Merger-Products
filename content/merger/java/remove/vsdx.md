...
############################# Head ############################
head_title: "Remove VSDX Pages in Java"
head_description: "Remove or delete a single page or collection of pages from a VSDX file in Java by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove VSDX Pages In Java"
description: "Remove VSDX Pages with a few lines of Java code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove VSDX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove VSDX Pages Online"
    content: |
       Remove VSDX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdx) website.
