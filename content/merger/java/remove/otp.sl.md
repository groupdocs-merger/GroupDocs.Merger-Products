...
############################# Head ############################
head_title: "Odstrani strani OTP v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke OTP v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani OTP strani v Java"
description: "Odstranite strani OTP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke OTP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj OTP datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke OTP s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke OTP z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani OTP na spletu"
    content: |
       Takoj odstranite strani datoteke OTP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp).
