...
############################# Head ############################
head_title: "Odstrani strani ONE v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ONE v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ONE strani v Java"
description: "Odstranite strani ONE z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ONE v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj ONE datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ONE s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke ONE z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani ONE na spletu"
    content: |
       Takoj odstranite strani datoteke ONE tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/one).
