...
############################# Head ############################
head_title: "Odstrani strani XPS v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XPS v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XPS strani v Java"
description: "Odstranite strani XPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XPS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XPS s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XPS z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XPS na spletu"
    content: |
       Takoj odstranite strani datoteke XPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps).
