...
############################# Head ############################
head_title: "Usuń DOCM strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOCM w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOCM strony w Java"
description: "Usuń strony DOCM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOCM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w DOCM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOCM za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików DOCM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń DOCM strony online"
    content: |
       Usuń strony plików DOCM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docm).
