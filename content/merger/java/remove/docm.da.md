...
############################# Head ############################
head_title: "Fjern DOCM sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en DOCM-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern DOCM sider i Java"
description: "Fjern DOCM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern DOCM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en DOCM fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du DOCM filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern DOCM filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern DOCM sider online"
    content: |
       Fjern DOCM filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docm).
