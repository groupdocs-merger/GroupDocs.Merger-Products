...
############################# Head ############################
head_title: "Eliminați paginile VSDM din Java"
head_description: "Eliminați sau ștergeți o singură pagină sau o colecție de pagini dintr-un fișier VSDM din Java inversând ordinea paginilor utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Eliminați VSDM pagini din Java"
description: "Eliminați paginile VSDM cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Eliminați paginile de fișiere VSDM din Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să șterge o singură pagină sau mai multe anumite pagini dintr-un VSDM fișier prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să eliminați pagini de fișiere VSDM folosind codul exemplu Java">}}

        ```java    
        // Eliminați pagini de fișiere VSDM utilizând API-ul GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live - Eliminați VSDM pagini online"
    content: |
       Eliminați paginile de fișiere VSDM chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
