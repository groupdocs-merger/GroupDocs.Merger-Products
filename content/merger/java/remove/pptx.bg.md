...
############################# Head ############################
head_title: "Премахване на PPTX страници в Java"
head_description: "Премахнете или изтрийте отделна страница или колекция от страници от PPTX файл в Java чрез обръщане на реда на страниците с помощта на API за сливане на документи."

############################# Header ############################
title: "Премахване на PPTX страници в Java"
description: "Премахнете страниците PPTX с няколко реда код на Java."
...
steps:
    enable: true
    title_left: "Премахнете PPTX файлови страници в Java"
    content_left: |
        [GroupDocs.Merger for Java](/bg/merger/java/) улеснява разработчиците на Java да изтрият една или няколко конкретни страници в PPTX файл, като изпълните няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премахнете PPTX файлови страници с помощта на Java примерен код">}}
