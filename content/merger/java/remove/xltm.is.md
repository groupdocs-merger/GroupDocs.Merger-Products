...
############################# Head ############################
head_title: "Fjarlægðu XLTM síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr XLTM skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu XLTM síður í Java"
description: "Fjarlægðu XLTM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu XLTM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan XLTM skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja XLTM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu XLTM skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu XLTM síður á netinu"
    content: |
       Fjarlægðu XLTM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltm) vefsíðu.
