...
############################# Head ############################
head_title: "Eemaldage XPS lehed rakenduses Java"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist XPS rakenduses Java, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage XPS lehed rakenduses Java"
description: "Eemaldage XPS lehed, millel on paar rida Java koodi."
...
steps:
    enable: true
    title_left: "Eemaldage XPS faililehed tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise XPS-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada XPS faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Eemaldage faili XPS lehed, kasutades GroupDocs.Merger API-t
...
demos:
    enable: true
    title: "Reaalajas demod – eemaldage XPS veebilehed"
    content: |
       Eemaldage kohe XPS faililehed, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps).
