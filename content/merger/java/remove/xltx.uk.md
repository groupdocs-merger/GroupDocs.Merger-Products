...
############################# Head ############################
head_title: "Видалити сторінки XLTX у Java"
head_description: "Вилучіть або видаліть одну сторінку чи колекцію сторінок із файлу XLTX у Java, змінивши порядок сторінок на протилежний за допомогою API об’єднання документів."

############################# Header ############################
title: "Видалити XLTX сторінки в Java"
description: "Видаліть сторінки XLTX із кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Видалити сторінки файлу XLTX у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) спрощує розробникам Java видаляти одну чи кілька конкретних сторінок у XLTX файл, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як видалити сторінки файлу XLTX за допомогою прикладу коду Java">}}

        ```java    
        // Видаліть сторінки файлу XLTX за допомогою API GroupDocs.Merger
...
demos:
    enable: true
    title: "Демонстрації в прямому ефірі - видаліть XLTX сторінки онлайн"
    content: |
       Видаліть сторінки файлу XLTX просто зараз, відвідавши веб-сайт [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx).
