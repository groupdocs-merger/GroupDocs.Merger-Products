...
############################# Head ############################
head_title: "Java에서 WEB 페이지 제거"
head_description: "문서 병합 API를 사용하여 페이지 순서를 반대로 하여 Java의 WEB 파일에서 단일 페이지 또는 페이지 모음을 제거하거나 삭제합니다."

############################# Header ############################
title: "Java에서 WEB 페이지 제거"
description: "몇 줄의 Java 코드로 WEB 페이지를 제거합니다."
...
steps:
    enable: true
    title_left: "Java에서 WEB 파일 페이지 제거"
    content_left: |
        [GroupDocs.Merger for Java](/ko/merger/java/)를 사용하면 Java 개발자가 WEB 내에서 단일 또는 여러 특정 페이지를 쉽게 삭제할 수 있습니다. 몇 가지 간단한 단계를 구현하여 파일을 만들 수 있습니다.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java 예제 코드를 사용하여 WEB 파일 페이지를 제거하는 방법">}}

        ```java    
        // GroupDocs.Merger API를 사용하여 WEB 파일 페이지 제거
...
demos:
    enable: true
    title: "라이브 데모 - 온라인에서 WEB 페이지 제거"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/web) 웹사이트를 방문하여 WEB 파일 페이지를 지금 제거하세요.
