...
############################# Head ############################
head_title: "Rûpelên HTML di Java de rake"
head_description: "Rûpelek yek an berhevokek rûpelan ji pelek HTML ya di Java de jêbikin an jêbikin bi berevajîkirina rêzika rûpelan bi karanîna API-ya yekkirina belgeyan."

############################# Header ############################
title: "Rûpelên HTML Di Java de rake"
description: "Rûpelên HTML yên bi çend rêzikên koda {{Navê berhemê}} rakin."
...
steps:
    enable: true
    title_left: "Rûpelên Pelê HTML di Java de rake"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku yek an çend rûpelên taybetî di nav HTML de jêbikin. pelê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên HTML jêbirin">}}

        ```java    
        // Rûpelên pelê yên HTML bi karanîna API-ya GroupDocs.Merger rakin
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl ên HTML jêbirin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html) niha rûpelên pelê yên HTML rakin.
