...
############################# Head ############################
head_title: "Remove VSSX Pages in Java"
head_description: "Remove or delete a single page or collection of pages from a VSSX file in Java by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove VSSX Pages In Java"
description: "Remove VSSX Pages with a few lines of Java code."
...
steps:
    enable: true
    title_left: "Remove VSSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger for Java](/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a VSSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove VSSX file pages using Java example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove VSSX Pages Online"
    content: |
       Remove VSSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vssx) website.
