...
############################# Head ############################
head_title: "Poista VSX sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSX-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSX sivut Java"
description: "Poista VSX sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista VSX tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista VSX tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista VSX sivua verkosta"
    content: |
       Poista VSX tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsx) -sivustolla.
