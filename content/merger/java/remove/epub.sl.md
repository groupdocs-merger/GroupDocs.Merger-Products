...
############################# Head ############################
head_title: "Odstrani strani EPUB v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke EPUB v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani EPUB strani v Java"
description: "Odstranite strani EPUB z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke EPUB v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj EPUB datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke EPUB s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke EPUB z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani EPUB na spletu"
    content: |
       Takoj odstranite strani datoteke EPUB tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub).
