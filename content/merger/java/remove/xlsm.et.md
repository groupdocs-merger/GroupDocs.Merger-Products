...
############################# Head ############################
head_title: "Eemaldage XLSM lehed rakenduses Java"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist XLSM rakenduses Java, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage XLSM lehed rakenduses Java"
description: "Eemaldage XLSM lehed, millel on paar rida Java koodi."
...
steps:
    enable: true
    title_left: "Eemaldage XLSM faililehed tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise XLSM-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada XLSM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Eemaldage faili XLSM lehed, kasutades GroupDocs.Merger API-t
...
demos:
    enable: true
    title: "Reaalajas demod – eemaldage XLSM veebilehed"
    content: |
       Eemaldage kohe XLSM faililehed, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
