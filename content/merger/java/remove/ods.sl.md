...
############################# Head ############################
head_title: "Odstrani strani ODS v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ODS v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ODS strani v Java"
description: "Odstranite strani ODS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ODS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj ODS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ODS s primerom kode Java">}}
