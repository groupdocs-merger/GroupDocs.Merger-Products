...
############################# Head ############################
head_title: "Odstrani strani VSX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSX strani v Java"
description: "Odstranite strani VSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj VSX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSX s primerom kode Java">}}
