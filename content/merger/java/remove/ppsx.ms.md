...
############################# Head ############################
head_title: "Alih keluar PPSX Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail PPSX dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar PPSX Halaman Dalam Java"
description: "Alih keluar PPSX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar PPSX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam PPSX fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar PPSX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar PPSX halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar PPSX Halaman Dalam Talian"
    content: |
       Alih keluar PPSX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
