...
############################# Head ############################
head_title: "Hapus halaman PDF dalam aplikasi Java"
head_description: "Gunakan GroupDocs.Merger for Java untuk menghapus halaman tertentu dari dokumen PDF. Proses PDF, Word, Excel, PowerPoint, gambar, arsip, dan lainnya dengan cepat."

############################# Header ############################
title: "Hapus halaman dalam PDF" 
description: "GroupDocs.Merger for Java meningkatkan aplikasi Java dengan fitur pengolahan dokumen yang kuat, termasuk penghapusan halaman dalam file PDF."
...
steps:
    enable: true
    title: "Cara menghapus halaman dalam PDF"
    content: |
      [GroupDocs.Merger](/merger/java/) memungkinkan Anda untuk menghapus halaman dari dokumen PDF. Tingkatkan aplikasi Java Anda dengan kemampuan manajemen dokumen yang canggih.
      
      1. Tentukan jalur file PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cara menghapus semua halaman genap"
      content: |
        Pelajari cara menghapus halaman bernomor genap dari dokumen PDF.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
