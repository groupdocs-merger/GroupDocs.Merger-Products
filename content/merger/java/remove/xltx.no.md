...
############################# Head ############################
head_title: "Fjern XLTX sider i Java"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en XLTX-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern XLTX sider i Java"
description: "Fjern XLTX-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern XLTX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en XLTX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne XLTX filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Fjern XLTX filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern XLTX-sider på nettet"
    content: |
       Fjern XLTX-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx).
