...
############################# Head ############################
head_title: "Odebrat HTML stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru HTML v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat HTML stránky v Java"
description: "Odstraňte HTML stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat HTML stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci HTML soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru HTML pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru HTML pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte HTML stránek online"
    content: |
       Odstraňte stránky souborů HTML hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html).
