...
############################# Head ############################
head_title: "Poista XLTM sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLTM-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLTM sivut Java"
description: "Poista XLTM sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista XLTM tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLTM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista XLTM tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista XLTM sivua verkosta"
    content: |
       Poista XLTM tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltm) -sivustolla.
