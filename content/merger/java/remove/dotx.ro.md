...
############################# Head ############################
head_title: "Eliminați paginile DOTX din Java"
head_description: "Eliminați sau ștergeți o singură pagină sau o colecție de pagini dintr-un fișier DOTX din Java inversând ordinea paginilor utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Eliminați DOTX pagini din Java"
description: "Eliminați paginile DOTX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Eliminați paginile de fișiere DOTX din Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să șterge o singură pagină sau mai multe anumite pagini dintr-un DOTX fișier prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să eliminați pagini de fișiere DOTX folosind codul exemplu Java">}}

        ```java    
        // Eliminați pagini de fișiere DOTX utilizând API-ul GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live - Eliminați DOTX pagini online"
    content: |
       Eliminați paginile de fișiere DOTX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
