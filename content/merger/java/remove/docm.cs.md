...
############################# Head ############################
head_title: "Odebrat DOCM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru DOCM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat DOCM stránky v Java"
description: "Odstraňte DOCM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat DOCM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci DOCM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru DOCM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru DOCM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte DOCM stránek online"
    content: |
       Odstraňte stránky souborů DOCM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docm).
