...
############################# Head ############################
head_title: "Poista VSDM sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSDM-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSDM sivut Java"
description: "Poista VSDM sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista VSDM tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSDM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSDM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista VSDM tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista VSDM sivua verkosta"
    content: |
       Poista VSDM tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm) -sivustolla.
