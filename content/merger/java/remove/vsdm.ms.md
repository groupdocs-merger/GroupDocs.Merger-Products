...
############################# Head ############################
head_title: "Alih keluar VSDM Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail VSDM dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar VSDM Halaman Dalam Java"
description: "Alih keluar VSDM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar VSDM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam VSDM fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar VSDM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar VSDM halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar VSDM Halaman Dalam Talian"
    content: |
       Alih keluar VSDM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
