...
############################# Head ############################
head_title: "Fjarlægðu DOTX síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr DOTX skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu DOTX síður í Java"
description: "Fjarlægðu DOTX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu DOTX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan DOTX skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja DOTX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu DOTX skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu DOTX síður á netinu"
    content: |
       Fjarlægðu DOTX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx) vefsíðu.
