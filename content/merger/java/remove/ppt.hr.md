...
############################# Head ############################
head_title: "Ukloni PPT stranice u Java"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz PPT datoteke u Java obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni PPT stranice u Java"
description: "Ukloni PPT stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ukloni PPT stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava brisanje jedne ili više određenih stranica unutar PPT datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti PPT stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ukloni PPT stranice datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstracije uživo - Ukloni PPT stranice na mreži"
    content: |
       Uklonite PPT stranice datoteke odmah tako što ćete posjetiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppt) web mjesto.
