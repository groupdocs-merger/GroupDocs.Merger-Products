...
############################# Head ############################
head_title: "Fjarlægðu OTT síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr OTT skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu OTT síður í Java"
description: "Fjarlægðu OTT síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu OTT skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan OTT skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja OTT skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu OTT skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu OTT síður á netinu"
    content: |
       Fjarlægðu OTT skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott) vefsíðu.
