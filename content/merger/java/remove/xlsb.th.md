...
############################# Head ############################
head_title: "ลบ XLSB หน้าใน Java"
head_description: "ลบหรือลบหน้าเดียวหรือคอลเลกชันของหน้าจากไฟล์ XLSB ใน Java โดยเปลี่ยนลำดับหน้าโดยใช้ API การควบรวมเอกสาร"

############################# Header ############################
title: "ลบ XLSB หน้าใน Java"
description: "ลบ XLSB หน้าที่มีโค้ด Java สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "ลบหน้าไฟล์ XLSB ใน Java"
    content_left: |
        [GroupDocs.Merger for Java](/th/merger/java/) ช่วยให้นักพัฒนา Java ลบหน้าเดียวหรือบางหน้าภายใน XLSB ได้อย่างง่ายดาย ไฟล์โดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีลบหน้าไฟล์ XLSB โดยใช้โค้ดตัวอย่าง Java">}}

        ```java    
        // ลบหน้าไฟล์ XLSB โดยใช้ GroupDocs.Merger API
...
demos:
    enable: true
    title: "การสาธิตสด - ลบ XLSB เพจออนไลน์"
    content: |
       นำหน้าไฟล์ XLSB ออกทันทีโดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsb)
