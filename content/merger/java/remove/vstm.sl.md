...
############################# Head ############################
head_title: "Odstrani strani VSTM v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSTM v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSTM strani v Java"
description: "Odstranite strani VSTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj VSTM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSTM s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke VSTM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani VSTM na spletu"
    content: |
       Takoj odstranite strani datoteke VSTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm).
