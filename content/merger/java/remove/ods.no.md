...
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en ODS-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern ODS sider i Java"
description: "Fjern ODS-sider med noen få linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en ODS fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne ODS filsider ved å bruke Java eksempelkode">}}
