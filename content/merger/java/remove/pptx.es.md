...
############################# Head ############################
head_title: "Eliminar páginas de PPTX en aplicaciones Java"
head_description: "Utilice GroupDocs.Merger for Java para eliminar páginas específicas de documentos PPTX. Procese documentos PDF, Word, Excel, PowerPoint, imágenes, archivos y más."

############################# Header ############################
title: "Eliminar páginas en PPTX" 
description: "GroupDocs.Merger for Java mejora las aplicaciones Java con potentes funciones de procesamiento de documentos, incluyendo la eliminación de páginas en archivos PPTX."
...
steps:
    enable: true
    title: "Cómo eliminar páginas en PPTX"
    content: |
      [GroupDocs.Merger](/merger/java/) le permite eliminar páginas de documentos PPTX. Mejore sus aplicaciones Java con capacidades avanzadas de gestión de documentos.
      
      1. Especifique la ruta del archivo PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo eliminar todas las páginas pares"
      content: |
        Aprenda a eliminar páginas de número par de un documento PPTX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
