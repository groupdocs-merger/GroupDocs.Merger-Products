...
############################# Head ############################
head_title: "Poista DOT sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOT-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOT sivut Java"
description: "Poista DOT sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista DOT tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista DOT tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista DOT sivua verkosta"
    content: |
       Poista DOT tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot) -sivustolla.
