...
############################# Head ############################
head_title: "Java 애플리케이션에서 HTML 페이지 삭제"
head_description: "GroupDocs.Merger for Java을(를) 사용하여 HTML 문서에서 특정 페이지를 제거하세요. PDF, Word, Excel, PowerPoint, 이미지, 아카이브 등 다양한 형식을 처리합니다."

############################# Header ############################
title: "HTML에서 페이지 삭제" 
description: "GroupDocs.Merger for Java은(는) Java 애플리케이션에 강력한 문서 처리 기능을 추가하여 HTML 파일의 페이지 제거를 지원합니다."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/java/)을(를) 통해 HTML 문서에서 페이지를 제거할 수 있습니다. 고급 문서 관리 기능으로 Java 애플리케이션을 개선하세요.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "모든 짝수 페이지 삭제 방법"
      content: |
        HTML 문서에서 짝수 번호 페이지를 제거하는 방법을 알아보세요.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
