...
############################# Head ############################
head_title: "Hapus XLSB Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLSB di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLSB Halaman Di Java"
description: "Hapus XLSB Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus XLSB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam XLSB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLSB menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file XLSB menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLSB Laman Daring"
    content: |
       Hapus halaman file XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/xlsb).
