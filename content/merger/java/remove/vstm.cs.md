...
############################# Head ############################
head_title: "Odebrat VSTM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru VSTM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat VSTM stránky v Java"
description: "Odstraňte VSTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat VSTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci VSTM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru VSTM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru VSTM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte VSTM stránek online"
    content: |
       Odstraňte stránky souborů VSTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm).
