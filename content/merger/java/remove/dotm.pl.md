...
############################# Head ############################
head_title: "Usuń DOTM strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOTM w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOTM strony w Java"
description: "Usuń strony DOTM z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOTM w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w DOTM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOTM za pomocą przykładowego kodu Java">}}
