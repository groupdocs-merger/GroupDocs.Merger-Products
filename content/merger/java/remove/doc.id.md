...
############################# Head ############################
head_title: "Hapus DOC Halaman di Java"
...
############################# Header ############################
title: "Hapus DOC Halaman Di Java"
description: "Hapus DOC Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus DOC Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam DOC file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOC menggunakan kode contoh Java">}}
