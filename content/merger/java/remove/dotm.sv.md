...
############################# Head ############################
head_title: "Ta bort DOTM sidor i Java"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en DOTM-fil i Java genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort DOTM sidor i Java"
description: "Ta bort DOTM-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Ta bort DOTM filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en DOTM fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort DOTM filsidor med hjälp av Java exempelkod">}}
