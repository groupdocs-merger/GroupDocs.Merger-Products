...
############################# Head ############################
head_title: "Odstrani strani VTX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VTX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VTX strani v Java"
description: "Odstranite strani VTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj VTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VTX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke VTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani VTX na spletu"
    content: |
       Takoj odstranite strani datoteke VTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx).
