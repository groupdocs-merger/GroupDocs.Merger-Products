...
############################# Head ############################
head_title: "Hapus XLTX Halaman di Java"
...
############################# Header ############################
title: "Hapus XLTX Halaman Di Java"
description: "Hapus XLTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus XLTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam XLTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLTX Laman Daring"
    content: |
       Hapus halaman file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/xltx).
