...
############################# Head ############################
head_title: "Hapus XLT Halaman di Java"
...
############################# Header ############################
title: "Hapus XLT Halaman Di Java"
description: "Hapus XLT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus XLT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam XLT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLT Laman Daring"
    content: |
       Hapus halaman file XLT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/xlt).
