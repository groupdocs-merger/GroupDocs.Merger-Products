...
############################# Head ############################
head_title: "በJava ውስጥ VSDM ገጾችን ያስወግዱ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የገጾቹን ቅደም ተከተል በመቀየር በJava ውስጥ ካለው የVSDM ፋይል አንድ ገጽ ወይም የገጾችን ስብስብ ያስወግዱ ወይም ይሰርዙ።"

############################# Header ############################
title: "በJava ውስጥ VSDM ገጾችን አስወግድ"
description: "VSDM ገጾችን በጥቂት የJava ኮድ መስመሮች ያስወግዱ።"
...
steps:
    enable: true
    title_left: "VSDM የፋይል ገጾችን በJava ውስጥ ያስወግዱ"
    content_left: |
        [GroupDocs.Merger for Java](/am/merger/java/) ለJava ገንቢዎች በVSDM ውስጥ አንድ ነጠላ ወይም የተወሰኑ ገጾችን መሰረዝ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር ፋይል ያድርጉ።
    ...
    code: |
     ...
     {{< merger/code-merger title="የJava ምሳሌ ኮድን በመጠቀም የVSDM ፋይል ገጾችን እንዴት ማስወገድ እንደሚቻል">}}

        ```java    
        // GroupDocs.Merger APIን በመጠቀም የVSDM ፋይል ገጾችን ያስወግዱ
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - VSDM ገጾችን በመስመር ላይ ያስወግዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/{ext}}) ድር ጣቢያን በመጎብኘት የVSDM ፋይል ገፆችን አሁኑኑ ያስወግዱ።
