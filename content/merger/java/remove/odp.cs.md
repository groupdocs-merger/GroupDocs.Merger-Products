...
############################# Head ############################
head_title: "Odebrat ODP stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru ODP v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat ODP stránky v Java"
description: "Odstraňte ODP stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat ODP stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci ODP soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru ODP pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru ODP pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte ODP stránek online"
    content: |
       Odstraňte stránky souborů ODP hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp).
