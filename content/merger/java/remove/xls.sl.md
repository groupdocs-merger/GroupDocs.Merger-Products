...
############################# Head ############################
head_title: "Odstrani strani XLS v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLS v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLS strani v Java"
description: "Odstranite strani XLS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLS s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLS z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLS na spletu"
    content: |
       Takoj odstranite strani datoteke XLS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xls).
