...
############################# Head ############################
head_title: "Odstrani strani TEX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke TEX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani TEX strani v Java"
description: "Odstranite strani TEX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke TEX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj TEX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke TEX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke TEX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani TEX na spletu"
    content: |
       Takoj odstranite strani datoteke TEX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/tex).
