...
############################# Head ############################
head_title: "Eemaldage XLAM lehed rakenduses Java"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist XLAM rakenduses Java, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage XLAM lehed rakenduses Java"
description: "Eemaldage XLAM lehed, millel on paar rida Java koodi."
...
steps:
    enable: true
    title_left: "Eemaldage XLAM faililehed tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise XLAM-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada XLAM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Eemaldage faili XLAM lehed, kasutades GroupDocs.Merger API-t
...
demos:
    enable: true
    title: "Reaalajas demod – eemaldage XLAM veebilehed"
    content: |
       Eemaldage kohe XLAM faililehed, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlam).
