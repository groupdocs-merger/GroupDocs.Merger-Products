...
############################# Head ############################
head_title: "Poista VSTX sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSTX-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSTX sivut Java"
description: "Poista VSTX sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista VSTX tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSTX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSTX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista VSTX tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista VSTX sivua verkosta"
    content: |
       Poista VSTX tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx) -sivustolla.
