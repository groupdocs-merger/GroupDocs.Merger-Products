...
############################# Head ############################
head_title: "Odstrani strani XLT v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLT v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLT strani v Java"
description: "Odstranite strani XLT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLT s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLT na spletu"
    content: |
       Takoj odstranite strani datoteke XLT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlt).
