...
############################# Head ############################
head_title: "Odebrat OTP stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru OTP v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat OTP stránky v Java"
description: "Odstraňte OTP stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat OTP stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci OTP soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru OTP pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru OTP pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte OTP stránek online"
    content: |
       Odstraňte stránky souborů OTP hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp).
