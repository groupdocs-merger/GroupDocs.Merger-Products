...
############################# Head ############################
head_title: "Verwyder OTT bladsye in Java"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n OTT-lêer in Java deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder OTT bladsye in Java"
description: "Verwyder OTT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verwyder OTT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n OTT uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTT lêerbladsye te verwyder deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Verwyder OTT lêerbladsye deur GroupDocs.Merger API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verwyder OTT bladsye aanlyn"
    content: |
       Verwyder OTT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott) webwerf te besoek.
