...
############################# Head ############################
head_title: "Odstrani strani DOT v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOT v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOT strani v Java"
description: "Odstranite strani DOT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj DOT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOT s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke DOT z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani DOT na spletu"
    content: |
       Takoj odstranite strani datoteke DOT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot).
