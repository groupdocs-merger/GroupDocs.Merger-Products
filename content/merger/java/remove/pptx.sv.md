...
############################# Head ############################
head_title: "Ta bort PPTX sidor i Java"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en PPTX-fil i Java genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort PPTX sidor i Java"
description: "Ta bort PPTX-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Ta bort PPTX filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en PPTX fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort PPTX filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Ta bort PPTX filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Ta bort PPTX sidor online"
    content: |
       Ta bort PPTX filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pptx).
