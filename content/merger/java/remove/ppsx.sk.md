...
############################# Head ############################
head_title: "Odstrániť PPSX stránky v Java"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru PPSX v Java obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť PPSX stránky v Java"
description: "Odstráňte PPSX stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Odstrániť PPSX stránky súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java odstrániť jednu alebo viacero konkrétnych stránok v rámci PPSX súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru PPSX pomocou vzorového kódu Java">}}

        ```java    
        // Odstráňte stránky súboru PPSX pomocou rozhrania GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – odstránenie PPSX stránok online"
    content: |
       Odstráňte stránky súboru PPSX hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
