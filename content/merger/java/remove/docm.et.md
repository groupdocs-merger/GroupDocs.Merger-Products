...
############################# Head ############################
head_title: "Eemaldage DOCM lehed rakenduses Java"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist DOCM rakenduses Java, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage DOCM lehed rakenduses Java"
description: "Eemaldage DOCM lehed, millel on paar rida Java koodi."
...
steps:
    enable: true
    title_left: "Eemaldage DOCM faililehed tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise DOCM-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada DOCM faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Eemaldage faili DOCM lehed, kasutades GroupDocs.Merger API-t
...
demos:
    enable: true
    title: "Reaalajas demod – eemaldage DOCM veebilehed"
    content: |
       Eemaldage kohe DOCM faililehed, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docm).
