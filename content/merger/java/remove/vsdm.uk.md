...
############################# Head ############################
head_title: "Видалити сторінки VSDM у Java"
head_description: "Вилучіть або видаліть одну сторінку чи колекцію сторінок із файлу VSDM у Java, змінивши порядок сторінок на протилежний за допомогою API об’єднання документів."

############################# Header ############################
title: "Видалити VSDM сторінки в Java"
description: "Видаліть сторінки VSDM із кількома рядками коду Java."
...
steps:
    enable: true
    title_left: "Видалити сторінки файлу VSDM у Java"
    content_left: |
        [GroupDocs.Merger for Java](/uk/merger/java/) спрощує розробникам Java видаляти одну чи кілька конкретних сторінок у VSDM файл, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як видалити сторінки файлу VSDM за допомогою прикладу коду Java">}}

        ```java    
        // Видаліть сторінки файлу VSDM за допомогою API GroupDocs.Merger
...
demos:
    enable: true
    title: "Демонстрації в прямому ефірі - видаліть VSDM сторінки онлайн"
    content: |
       Видаліть сторінки файлу VSDM просто зараз, відвідавши веб-сайт [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
