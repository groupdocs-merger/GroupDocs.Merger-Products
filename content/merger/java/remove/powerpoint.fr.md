...
############################# Head ############################
head_title: "Supprimer les pages POWERPOINT dans les applications Java"
head_description: "Utilisez GroupDocs.Merger for Java pour retirer des pages spécifiques des documents POWERPOINT. Traitez rapidement les PDF, Word, Excel, PowerPoint, images, archives et plus encore."

############################# Header ############################
title: "Supprimer des pages dans POWERPOINT" 
description: "GroupDocs.Merger for Java améliore les applications Java avec des fonctionnalités puissantes de traitement de documents, y compris la suppression de pages dans des fichiers POWERPOINT."
...
steps:
    enable: true
    title: "Comment supprimer des pages dans POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/java/) vous permet de retirer des pages des documents POWERPOINT. Améliorez vos applications Java avec des capacités avancées de gestion de documents.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Comment supprimer toutes les pages paires"
      content: |
        Apprenez à supprimer les pages numérotées paires d'un document POWERPOINT.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
