...
############################# Head ############################
head_title: "Rimuovi OTP pagine in Java"
head_description: "Rimuovere o eliminare una singola pagina o raccolta di pagine da un file OTP in Java invertendo l'ordine delle pagine utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Rimuovi OTP pagine in Java"
description: "Rimuovi OTP Pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Rimuovi OTP pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di eliminare facilmente una o più pagine particolari all'interno di un OTP file implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come rimuovere le pagine di file OTP utilizzando il codice di esempio Java">}}

        ```java    
        // Rimuovere OTP pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live: rimuovi OTP pagine online"
    content: |
       Rimuovere subito OTP pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp).
