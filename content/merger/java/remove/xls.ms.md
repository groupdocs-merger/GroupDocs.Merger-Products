...
############################# Head ############################
head_title: "Alih keluar XLS Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail XLS dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar XLS Halaman Dalam Java"
description: "Alih keluar XLS Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar XLS Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam XLS fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar XLS halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar XLS halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar XLS Halaman Dalam Talian"
    content: |
       Alih keluar XLS halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xls).
