...
############################# Head ############################
head_title: "Java میں VSTX صفحات کو ہٹا دیں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے صفحات کی ترتیب کو الٹ کر Java میں VSTX فائل سے ایک صفحہ یا صفحات کے مجموعہ کو ہٹا دیں یا حذف کریں۔"

############################# Header ############################
title: "Java میں VSTX صفحات کو ہٹا دیں"
description: "VSTX صفحات کو ہٹا دیں جن میں Java کوڈ کی چند سطریں ہیں۔"
...
steps:
    enable: true
    title_left: "Java میں VSTX فائل صفحات کو ہٹائیں"
    content_left: |
        [GroupDocs.Merger for Java](/ur/merger/java/) Java ڈویلپرز کے لیے ایک VSTX کے اندر ایک یا متعدد مخصوص صفحات کو حذف کرنا آسان بناتا ہے۔ چند آسان اقدامات کو لاگو کرکے فائل کریں۔
    ...
    code: |
     ...
     {{< merger/code-merger title="Java مثال کے کوڈ کا استعمال کرتے ہوئے VSTX فائل کے صفحات کو کیسے ہٹایا جائے۔">}}

        ```java    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے VSTX فائل کے صفحات کو ہٹا دیں۔
...
demos:
    enable: true
    title: "لائیو ڈیمو - آن لائن VSTX صفحات کو ہٹا دیں۔"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx) ویب سائٹ پر جا کر ابھی VSTX فائل کے صفحات کو ہٹا دیں۔
