...
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en PPSX-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern PPSX sider i Java"
description: "Fjern PPSX sider med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en PPSX fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du PPSX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern PPSX filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern PPSX sider online"
    content: |
       Fjern PPSX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
