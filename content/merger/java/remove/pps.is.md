...
############################# Head ############################
head_title: "Fjarlægðu PPS síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr PPS skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu PPS síður í Java"
description: "Fjarlægðu PPS síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu PPS skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan PPS skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja PPS skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu PPS skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu PPS síður á netinu"
    content: |
       Fjarlægðu PPS skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pps) vefsíðu.
