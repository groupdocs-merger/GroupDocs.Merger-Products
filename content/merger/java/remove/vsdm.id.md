...
############################# Head ############################
head_title: "Hapus VSDM Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSDM di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSDM Halaman Di Java"
description: "Hapus VSDM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VSDM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VSDM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSDM menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus VSDM Laman Daring"
    content: |
       Hapus halaman file VSDM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/vsdm).
