...
head_title: "Hapus Halaman dari File VSDM di Java"
...
title: "Hapus atau Hapus Halaman Dari VSDM di Java"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman tertentu dari file VSDM menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Hapus Halaman File VSDM di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam file VSDM dengan menerapkan beberapa langkah mudah.
