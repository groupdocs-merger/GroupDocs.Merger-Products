...
############################# Head ############################
head_title: "Delete EPUB pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to remove specific pages from EPUB documents. Easily process PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Delete pages in EPUB" 
description: "GroupDocs.Merger for Java enhances Java apps with powerful document processing features, including page removal in EPUB files."
...
steps:
    enable: true
    title: "How to delete pages in EPUB"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to easily remove pages from EPUB documents. Enhance your Java applications with advanced document management capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to delete all even pages"
      content: |
        Learn how to remove even-numbered pages from a EPUB document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
