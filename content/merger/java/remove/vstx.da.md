...
############################# Head ############################
head_title: "Fjern VSTX sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en VSTX-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern VSTX sider i Java"
description: "Fjern VSTX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern VSTX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en VSTX fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du VSTX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern VSTX filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern VSTX sider online"
    content: |
       Fjern VSTX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx).
