...
############################# Head ############################
head_title: "Ukloni VSTX stranice u Java"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz VSTX datoteke u Java obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni VSTX stranice u Java"
description: "Ukloni VSTX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ukloni VSTX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava brisanje jedne ili više određenih stranica unutar VSTX datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti VSTX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ukloni VSTX stranice datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstracije uživo - Ukloni VSTX stranice na mreži"
    content: |
       Uklonite VSTX stranice datoteke odmah tako što ćete posjetiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx) web mjesto.
