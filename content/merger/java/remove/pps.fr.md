...
############################# Head ############################
head_title: "Supprimer PPS pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier PPS dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer PPS pages dans Java"
description: "Supprimez les pages PPS avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer PPS pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un PPS fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers PPS à l'aide de l'exemple de code Java">}}

        ```java    
        // Supprimer PPS pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Supprimer PPS pages en ligne"
    content: |
       Supprimez PPS pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pps).
