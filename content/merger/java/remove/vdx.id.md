...
############################# Head ############################
head_title: "Hapus VDX Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VDX di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VDX Halaman Di Java"
description: "Hapus VDX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VDX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VDX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VDX menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file VDX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus VDX Laman Daring"
    content: |
       Hapus halaman file VDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/vdx).
