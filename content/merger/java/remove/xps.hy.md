...
############################# Head ############################
head_title: "Հեռացնել XPS էջ Java-ից"
head_description: "Հեռացրեք կամ ջնջեք մեկ էջ կամ էջերի հավաքածու XPS ֆայլից Java-ում` փոխելով էջերի հերթականությունը` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Հեռացնել XPS էջ Java-ում"
description: "Հեռացրեք XPS էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Հեռացնել XPS ֆայլի էջեր Java-ից"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար ջնջել մեկ կամ մի քանի կոնկրետ էջեր XPS-ի շրջանակներում: ֆայլ՝ իրականացնելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հեռացնել XPS ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Հեռացրեք XPS ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Հեռացրեք XPS էջեր առցանց"
    content: |
       Հեռացրեք XPS ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps) կայքը:
