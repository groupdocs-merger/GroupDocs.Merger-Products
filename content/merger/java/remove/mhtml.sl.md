...
############################# Head ############################
head_title: "Odstrani strani MHTML v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke MHTML v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani MHTML strani v Java"
description: "Odstranite strani MHTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke MHTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj MHTML datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke MHTML s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke MHTML z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani MHTML na spletu"
    content: |
       Takoj odstranite strani datoteke MHTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mhtml).
