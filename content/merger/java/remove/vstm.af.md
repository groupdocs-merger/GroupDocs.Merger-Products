...
############################# Head ############################
head_title: "Verwyder VSTM bladsye in Java"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n VSTM-lêer in Java deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder VSTM bladsye in Java"
description: "Verwyder VSTM Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verwyder VSTM lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n VSTM uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTM lêerbladsye te verwyder deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Verwyder VSTM lêerbladsye deur GroupDocs.Merger API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verwyder VSTM bladsye aanlyn"
    content: |
       Verwyder VSTM lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm) webwerf te besoek.
