...
############################# Head ############################
head_title: "Poista ODP sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ODP-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ODP sivut Java"
description: "Poista ODP sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista ODP tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ODP tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ODP tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista ODP tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista ODP sivua verkosta"
    content: |
       Poista ODP tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp) -sivustolla.
