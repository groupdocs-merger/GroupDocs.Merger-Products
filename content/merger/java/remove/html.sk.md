...
############################# Head ############################
head_title: "Odstrániť HTML stránky v Java"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru HTML v Java obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť HTML stránky v Java"
description: "Odstráňte HTML stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Odstrániť HTML stránky súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java odstrániť jednu alebo viacero konkrétnych stránok v rámci HTML súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru HTML pomocou vzorového kódu Java">}}

        ```java    
        // Odstráňte stránky súboru HTML pomocou rozhrania GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – odstránenie HTML stránok online"
    content: |
       Odstráňte stránky súboru HTML hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html).
