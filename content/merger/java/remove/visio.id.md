...
############################# Head ############################
head_title: "Hapus VISIO Halaman di Java"
...
############################# Header ############################
title: "Hapus VISIO Halaman Di Java"
description: "Hapus VISIO Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VISIO Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VISIO file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VISIO menggunakan kode contoh Java">}}
