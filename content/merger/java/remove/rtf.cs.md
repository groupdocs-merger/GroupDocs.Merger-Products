...
############################# Head ############################
head_title: "Odebrat RTF stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru RTF v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat RTF stránky v Java"
description: "Odstraňte RTF stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat RTF stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci RTF soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru RTF pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru RTF pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte RTF stránek online"
    content: |
       Odstraňte stránky souborů RTF hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/rtf).
