...
############################# Head ############################
head_title: "Fjern XLTM sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en XLTM-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern XLTM sider i Java"
description: "Fjern XLTM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern XLTM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en XLTM fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du XLTM filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern XLTM filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern XLTM sider online"
    content: |
       Fjern XLTM filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltm).
