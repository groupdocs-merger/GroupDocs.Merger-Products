...
############################# Head ############################
head_title: "Usuń OTP strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku OTP w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń OTP strony w Java"
description: "Usuń strony OTP z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików OTP w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w OTP plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików OTP za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików OTP za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń OTP strony online"
    content: |
       Usuń strony plików OTP już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp).
