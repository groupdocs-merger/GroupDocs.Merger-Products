...
############################# Head ############################
head_title: "Odstrani strani PDF v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PDF v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PDF strani v Java"
description: "Odstranite strani PDF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PDF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj PDF datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PDF s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke PDF z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani PDF na spletu"
    content: |
       Takoj odstranite strani datoteke PDF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf).
