...
############################# Head ############################
head_title: "Fjern VDX sider i Java"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VDX-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VDX sider i Java"
description: "Fjern VDX-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern VDX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en VDX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VDX filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Fjern VDX filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern VDX-sider på nettet"
    content: |
       Fjern VDX-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx).
