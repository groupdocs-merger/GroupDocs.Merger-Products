...
############################# Head ############################
head_title: "Alih keluar RTF Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail RTF dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar RTF Halaman Dalam Java"
description: "Alih keluar RTF Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar RTF Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam RTF fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar RTF halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar RTF halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar RTF Halaman Dalam Talian"
    content: |
       Alih keluar RTF halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/rtf).
