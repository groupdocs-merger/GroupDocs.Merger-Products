...
############################# Head ############################
head_title: "Supprimer VISIO pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier VISIO dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer VISIO pages dans Java"
description: "Supprimez les pages VISIO avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer VISIO pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un VISIO fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers VISIO à l'aide de l'exemple de code Java">}}

        ```java    
        // Supprimer VISIO pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Supprimer VISIO pages en ligne"
    content: |
       Supprimez VISIO pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/visio).
