...
############################# Head ############################
head_title: "Usuń DOT strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOT w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOT strony w Java"
description: "Usuń strony DOT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w DOT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOT za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików DOT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń DOT strony online"
    content: |
       Usuń strony plików DOT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot).
