...
############################# Head ############################
head_title: "Poista MHTML sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma MHTML-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista MHTML sivut Java"
description: "Poista MHTML sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista MHTML tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja MHTML tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa MHTML tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista MHTML tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista MHTML sivua verkosta"
    content: |
       Poista MHTML tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mhtml) -sivustolla.
