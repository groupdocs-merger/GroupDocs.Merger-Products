...
############################# Head ############################
head_title: "Usuń TEX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku TEX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń TEX strony w Java"
description: "Usuń strony TEX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików TEX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w TEX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików TEX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików TEX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń TEX strony online"
    content: |
       Usuń strony plików TEX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/tex).
