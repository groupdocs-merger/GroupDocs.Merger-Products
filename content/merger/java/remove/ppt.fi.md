...
############################# Head ############################
head_title: "Poista PPT sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma PPT-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista PPT sivut Java"
description: "Poista PPT sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista PPT tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja PPT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa PPT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista PPT tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista PPT sivua verkosta"
    content: |
       Poista PPT tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppt) -sivustolla.
