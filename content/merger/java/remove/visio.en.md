...
############################# Head ############################
head_title: "Delete VISIO pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to remove specific pages from VISIO documents. Easily process PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Delete pages in VISIO" 
description: "GroupDocs.Merger for Java enhances Java apps with powerful document processing features, including page removal in VISIO files."
...
steps:
    enable: true
    title: "How to delete pages in VISIO"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to easily remove pages from VISIO documents. Enhance your Java applications with advanced document management capabilities.
      
      1. Specify the VISIO file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to delete all even pages"
      content: |
        Learn how to remove even-numbered pages from a VISIO document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
