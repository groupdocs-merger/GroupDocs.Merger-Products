...
############################# Head ############################
head_title: "Hapus DOT Halaman di Java"
...
############################# Header ############################
title: "Hapus DOT Halaman Di Java"
description: "Hapus DOT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus DOT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam DOT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus DOT Laman Daring"
    content: |
       Hapus halaman file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/dot).
