...
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en VSDX-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern VSDX sider i Java"
description: "Fjern VSDX sider med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en VSDX fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du VSDX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern VSDX filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern VSDX sider online"
    content: |
       Fjern VSDX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdx).
