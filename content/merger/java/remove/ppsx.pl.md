...
############################# Head ############################
head_title: "Usuń PPSX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPSX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPSX strony w Java"
description: "Usuń strony PPSX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w PPSX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików PPSX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń PPSX strony online"
    content: |
       Usuń strony plików PPSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
