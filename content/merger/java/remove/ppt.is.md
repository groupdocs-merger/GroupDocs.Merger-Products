...
############################# Head ############################
head_title: "Fjarlægðu PPT síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr PPT skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu PPT síður í Java"
description: "Fjarlægðu PPT síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu PPT skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan PPT skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja PPT skráarsíður með því að nota Java dæmikóða">}}
