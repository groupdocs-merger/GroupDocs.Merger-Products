...
############################# Head ############################
head_title: "Odstrani strani XLSM v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLSM v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLSM strani v Java"
description: "Odstranite strani XLSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLSM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLSM s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLSM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLSM na spletu"
    content: |
       Takoj odstranite strani datoteke XLSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
