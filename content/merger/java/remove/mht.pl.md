...
############################# Head ############################
head_title: "Usuń MHT strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku MHT w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń MHT strony w Java"
description: "Usuń strony MHT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików MHT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w MHT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików MHT za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików MHT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń MHT strony online"
    content: |
       Usuń strony plików MHT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mht).
