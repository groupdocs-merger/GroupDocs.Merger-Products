...
############################# Head ############################
head_title: "Fjarlægðu XLSB síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr XLSB skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu XLSB síður í Java"
description: "Fjarlægðu XLSB síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu XLSB skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan XLSB skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja XLSB skráarsíður með því að nota Java dæmikóða">}}
