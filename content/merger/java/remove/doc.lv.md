...
############################# Head ############################
head_title: "Noņemt DOC lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no DOC faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt DOC lapas programmā Java"
description: "Noņemiet DOC lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt DOC faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas DOC ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt DOC faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Noņemiet DOC faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — noņemiet DOC lapas tiešsaistē"
    content: |
       Noņemiet DOC faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc).
