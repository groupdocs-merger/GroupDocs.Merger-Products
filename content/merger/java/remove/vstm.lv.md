...
############################# Head ############################
head_title: "Noņemt VSTM lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no VSTM faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt VSTM lapas programmā Java"
description: "Noņemiet VSTM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt VSTM faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas VSTM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt VSTM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Noņemiet VSTM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — noņemiet VSTM lapas tiešsaistē"
    content: |
       Noņemiet VSTM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm).
