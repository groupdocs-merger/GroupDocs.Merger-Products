...
############################# Head ############################
head_title: "Odebrat DOT stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru DOT v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat DOT stránky v Java"
description: "Odstraňte DOT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat DOT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci DOT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru DOT pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru DOT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte DOT stránek online"
    content: |
       Odstraňte stránky souborů DOT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot).
