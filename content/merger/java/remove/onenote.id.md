...
############################# Head ############################
head_title: "Hapus ONENOTE Halaman di Java"
...
############################# Header ############################
title: "Hapus ONENOTE Halaman Di Java"
description: "Hapus ONENOTE Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus ONENOTE Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam ONENOTE file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ONENOTE menggunakan kode contoh Java">}}
