...
############################# Head ############################
head_title: "Hapus ODT Halaman di Java"
...
############################# Header ############################
title: "Hapus ODT Halaman Di Java"
description: "Hapus ODT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus ODT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam ODT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ODT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus ODT Laman Daring"
    content: |
       Hapus halaman file ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/odt).
