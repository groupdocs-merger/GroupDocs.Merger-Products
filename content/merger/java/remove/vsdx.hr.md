...
############################# Head ############################
head_title: "Ukloni VSDX stranice u Java"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz VSDX datoteke u Java obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni VSDX stranice u Java"
description: "Ukloni VSDX stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ukloni VSDX stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava brisanje jedne ili više određenih stranica unutar VSDX datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti VSDX stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ukloni VSDX stranice datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstracije uživo - Ukloni VSDX stranice na mreži"
    content: |
       Uklonite VSDX stranice datoteke odmah tako što ćete posjetiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdx) web mjesto.
