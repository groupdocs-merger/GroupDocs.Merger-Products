...
############################# Head ############################
head_title: "Poista XPS sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XPS-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XPS sivut Java"
description: "Poista XPS sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista XPS tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XPS tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XPS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista XPS tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista XPS sivua verkosta"
    content: |
       Poista XPS tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps) -sivustolla.
