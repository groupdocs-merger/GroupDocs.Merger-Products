...
############################# Head ############################
head_title: "Noņemt DOCM lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no DOCM faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt DOCM lapas programmā Java"
description: "Noņemiet DOCM lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt DOCM faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas DOCM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt DOCM faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Noņemiet DOCM faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — noņemiet DOCM lapas tiešsaistē"
    content: |
       Noņemiet DOCM faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docm).
