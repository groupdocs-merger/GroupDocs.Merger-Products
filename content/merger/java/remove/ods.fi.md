...
############################# Head ############################
head_title: "Poista ODS sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ODS-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ODS sivut Java"
description: "Poista ODS sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista ODS tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ODS tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ODS tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista ODS tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista ODS sivua verkosta"
    content: |
       Poista ODS tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ods) -sivustolla.
