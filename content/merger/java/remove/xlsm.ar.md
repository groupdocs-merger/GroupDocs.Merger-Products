...
############################# Head ############################
head_title: "إزالة صفحات XLSM في Java"
head_description: "قم بإزالة أو حذف صفحة واحدة أو مجموعة صفحات من ملف XLSM في Java عن طريق عكس ترتيب الصفحات باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "إزالة صفحات XLSM في Java"
description: "قم بإزالة صفحات XLSM التي تحتوي على بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "إزالة صفحات ملف XLSM في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java حذف صفحة واحدة أو عدد من الصفحات المعينة داخل XLSM ملف من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية إزالة صفحات الملف XLSM باستخدام كود مثال Java">}}

        ```java    
        // إزالة صفحات الملف XLSM باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بإزالة XLSM من الصفحات على الإنترنت"
    content: |
       قم بإزالة صفحات ملف XLSM الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
