...
############################# Head ############################
head_title: "Hapus RTF Halaman di Java"
...
############################# Header ############################
title: "Hapus RTF Halaman Di Java"
description: "Hapus RTF Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus RTF Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam RTF file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file RTF menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus RTF Laman Daring"
    content: |
       Hapus halaman file RTF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/rtf).
