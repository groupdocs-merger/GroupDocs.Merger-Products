...
############################# Head ############################
head_title: "Odstrani strani VDX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VDX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VDX strani v Java"
description: "Odstranite strani VDX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VDX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj VDX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VDX s primerom kode Java">}}
