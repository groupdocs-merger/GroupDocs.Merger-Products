...
############################# Head ############################
head_title: "Xóa XLTX Trang trong Java"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp XLTX trong Java bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa XLTX Trang trong Java"
description: "Xóa các trang XLTX có một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Xóa XLTX Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java](/vi/merge/java/) giúp các nhà phát triển Java dễ dàng xóa một hoặc một số trang cụ thể trong XLTX bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp XLTX bằng mã mẫu Java">}}

        ```java    
        // Xóa các trang tệp XLTX bằng API GroupDocs.Merger
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Xóa XLTX Trang Trực tuyến"
    content: |
       Xóa các trang tệp XLTX ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx) trang web.
