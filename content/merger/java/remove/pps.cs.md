...
############################# Head ############################
head_title: "Odebrat PPS stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru PPS v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat PPS stránky v Java"
description: "Odstraňte PPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat PPS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci PPS soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru PPS pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru PPS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte PPS stránek online"
    content: |
       Odstraňte stránky souborů PPS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pps).
