...
############################# Head ############################
head_title: "Távolítsa el az XLT oldalt a Java programból"
head_description: "Távolítson el vagy töröljön egyetlen oldalt vagy oldalgyűjteményt egy XLT fájlból a Java alkalmazásban az oldalak sorrendjének megfordításával a dokumentumok egyesítése API használatával."

############################# Header ############################
title: "XLT oldal eltávolítása a Java nyelven"
description: "Távolítsa el a néhány soros Java kódot tartalmazó XLT oldalt."
...
steps:
    enable: true
    title_left: "Távolítsa el a(z) XLT fájloldalakat a(z) Java termékből"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen vagy több oldalt töröljenek egy XLT-on belül néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan távolítsunk el XLT fájloldalakat a Java példakóddal">}}

        ```java    
        // Távolítsa el az XLT fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Távolítsa el az XLT oldalakat online"
    content: |
       Távolítsa el az XLT fájloldalakat azonnal a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlt) webhely meglátogatásával.
