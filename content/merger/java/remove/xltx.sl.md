...
############################# Head ############################
head_title: "Odstrani strani XLTX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLTX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLTX strani v Java"
description: "Odstranite strani XLTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLTX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLTX na spletu"
    content: |
       Takoj odstranite strani datoteke XLTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx).
