...
############################# Head ############################
head_title: "Rûpelên MHT di Java de rake"
head_description: "Rûpelek yek an berhevokek rûpelan ji pelek MHT ya di Java de jêbikin an jêbikin bi berevajîkirina rêzika rûpelan bi karanîna API-ya yekkirina belgeyan."

############################# Header ############################
title: "Rûpelên MHT Di Java de rake"
description: "Rûpelên MHT yên bi çend rêzikên koda {{Navê berhemê}} rakin."
...
steps:
    enable: true
    title_left: "Rûpelên Pelê MHT di Java de rake"
    content_left: |
        [GroupDocs.Merger for Java](/ku/merger/java/) ji pêşdebirên Java re hêsan dike ku yek an çend rûpelên taybetî di nav MHT de jêbikin. pelê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya Java pelên MHT jêbirin">}}

        ```java    
        // Rûpelên pelê yên MHT bi karanîna API-ya GroupDocs.Merger rakin
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl ên MHT jêbirin"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mht) niha rûpelên pelê yên MHT rakin.
