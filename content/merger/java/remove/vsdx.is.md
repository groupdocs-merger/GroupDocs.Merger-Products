...
############################# Head ############################
head_title: "Fjarlægðu VSDX síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr VSDX skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu VSDX síður í Java"
description: "Fjarlægðu VSDX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu VSDX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan VSDX skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja VSDX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu VSDX skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu VSDX síður á netinu"
    content: |
       Fjarlægðu VSDX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdx) vefsíðu.
