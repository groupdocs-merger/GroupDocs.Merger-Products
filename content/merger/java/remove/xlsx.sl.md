...
############################# Head ############################
head_title: "Odstrani strani XLSX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLSX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLSX strani v Java"
description: "Odstranite strani XLSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLSX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLSX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLSX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLSX na spletu"
    content: |
       Takoj odstranite strani datoteke XLSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx).
