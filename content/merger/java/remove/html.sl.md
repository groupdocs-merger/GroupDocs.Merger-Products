...
############################# Head ############################
head_title: "Odstrani strani HTML v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke HTML v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani HTML strani v Java"
description: "Odstranite strani HTML z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke HTML v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj HTML datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke HTML s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke HTML z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani HTML na spletu"
    content: |
       Takoj odstranite strani datoteke HTML tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html).
