...
############################# Head ############################
head_title: "Odstrani strani DOCX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOCX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOCX strani v Java"
description: "Odstranite strani DOCX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOCX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj DOCX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOCX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke DOCX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani DOCX na spletu"
    content: |
       Takoj odstranite strani datoteke DOCX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docx).
