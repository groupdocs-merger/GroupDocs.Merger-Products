...
############################# Head ############################
head_title: "Odstrániť XLSM stránky v Java"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru XLSM v Java obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť XLSM stránky v Java"
description: "Odstráňte XLSM stránky pomocou niekoľkých riadkov kódu Java."
...
steps:
    enable: true
    title_left: "Odstrániť XLSM stránky súboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sk/merger/java/) uľahčuje vývojárom Java odstrániť jednu alebo viacero konkrétnych stránok v rámci XLSM súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru XLSM pomocou vzorového kódu Java">}}

        ```java    
        // Odstráňte stránky súboru XLSM pomocou rozhrania GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živé ukážky – odstránenie XLSM stránok online"
    content: |
       Odstráňte stránky súboru XLSM hneď teraz na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm).
