...
############################# Head ############################
head_title: "Remover VTX Páginas em Java"
head_description: "Remova ou exclua uma única página ou coleção de páginas de um arquivo VTX em Java invertendo a ordem das páginas usando a API de fusão de documentos."

############################# Header ############################
title: "Remover VTX Páginas em Java"
description: "Remova VTX Páginas com algumas linhas de código Java."
...
steps:
    enable: true
    title_left: "Remover páginas de arquivo VTX em Java"
    content_left: |
        [GroupDocs.Merger for Java](/pt/merger/java/) facilita para os desenvolvedores do Java excluir uma ou várias páginas específicas em um VTX arquivo implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como remover páginas de arquivo VTX usando o código de exemplo Java">}}

        ```java    
        // Remova as páginas do arquivo VTX usando a API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstrações ao vivo - remover VTX páginas on-line"
    content: |
       Remova as páginas de arquivo VTX agora mesmo visitando o site [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx).
