...
############################# Head ############################
head_title: "Java ішіндегі EPUB беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы Java ішіндегі EPUB файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "Java ішіндегі EPUB беттерді жою"
description: "Java кодының бірнеше жолы бар EPUB беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі EPUB файл бетін жою"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне EPUB ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB файл бетін Java мысал кодын пайдаланып жою жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы EPUB файл бетін жойыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - EPUB беттерді желіден алып тастаңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub) веб-сайтына кіру арқылы EPUB файл бетін дәл қазір жойыңыз.
