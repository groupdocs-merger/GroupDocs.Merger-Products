...
############################# Head ############################
head_title: "Excluir páginas de DOCX em apps Java"
head_description: "Use GroupDocs.Merger for Java para remover páginas específicas de documentos DOCX. Processar PDF, Word, Excel, PowerPoint, imagens, arquivos e muito mais."

############################# Header ############################
title: "Excluir páginas em DOCX" 
description: "GroupDocs.Merger for Java aprimora aplicativos Java com recursos poderosos de processamento de documentos, incluindo a remoção de páginas em arquivos DOCX."
...
steps:
    enable: true
    title: "Como excluir páginas em DOCX"
    content: |
      [GroupDocs.Merger](/merger/java/) permite remover páginas de documentos DOCX. Aprimore suas aplicações Java com capacidades avançadas de gerenciamento de documentos.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Como excluir todas as páginas pares"
      content: |
        Aprenda a remover páginas de números pares de um documento DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
