...
############################# Head ############################
head_title: "Usuń ODT strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku ODT w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń ODT strony w Java"
description: "Usuń strony ODT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików ODT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w ODT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików ODT za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików ODT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń ODT strony online"
    content: |
       Usuń strony plików ODT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odt).
