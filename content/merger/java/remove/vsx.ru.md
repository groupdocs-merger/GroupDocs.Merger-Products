...
############################# Head ############################
head_title: "Удалить VSX страницы на Java"
head_description: "Удалите одну или набор страниц из файла VSX на Java, изменив порядок страниц с помощью Merger API."

############################# Header ############################
title: "Удалить VSX страницы на Java"
description: "Удалите VSX страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Удалить страницы VSX документов на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) упрощает для разработчиков Java удаление одной или нескольких определенных страниц для VSX документа, выполнив несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как удалить страницы VSX документов, используя пример кода Java">}}
