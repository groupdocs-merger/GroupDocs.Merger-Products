...
############################# Head ############################
head_title: "Fjarlægðu XLAM síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr XLAM skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu XLAM síður í Java"
description: "Fjarlægðu XLAM síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu XLAM skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan XLAM skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja XLAM skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu XLAM skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu XLAM síður á netinu"
    content: |
       Fjarlægðu XLAM skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlam) vefsíðu.
