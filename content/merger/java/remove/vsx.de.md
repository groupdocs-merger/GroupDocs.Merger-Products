...
############################# Head ############################
head_title: "VSX Seiten in Java entfernen"
head_description: "Entfernen oder löschen Sie eine einzelne Seite oder eine Sammlung von Seiten aus einer VSX-Datei in Java, indem Sie die Seitenreihenfolge mithilfe der Documents Merger API umkehren."

############################# Header ############################
title: "Entfernen Sie VSX Seiten in Java"
description: "Entfernen Sie VSX-Seiten mit ein paar Zeilen Java-Code."
...
steps:
    enable: true
    title_left: "Entfernen Sie VSX Dateiseiten in Java"
    content_left: |
        [GroupDocs.Merger for Java](/de/merger/java/) erleichtert Entwicklern von Java das Löschen einer einzelnen oder mehrerer bestimmter Seiten innerhalb eines VSX Datei, indem Sie ein paar einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So entfernen Sie VSX-Dateiseiten mit Java-Beispielcode">}}

        ```java    
        // Entfernen Sie VSX-Dateiseiten mithilfe der GroupDocs.Merger-API
...
demos:
    enable: true
    title: "Live-Demos - Entfernen Sie VSX Seiten online"
    content: |
       Entfernen Sie jetzt VSX Dateiseiten, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsx) besuchen.
