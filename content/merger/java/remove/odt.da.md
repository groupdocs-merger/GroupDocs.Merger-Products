...
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en ODT-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern ODT sider i Java"
description: "Fjern ODT sider med et par linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en ODT fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du ODT filsider ved hjælp af Java eksempelkode">}}
