...
############################# Head ############################
head_title: "Fjarlægðu HTML síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr HTML skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu HTML síður í Java"
description: "Fjarlægðu HTML síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu HTML skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan HTML skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja HTML skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu HTML skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu HTML síður á netinu"
    content: |
       Fjarlægðu HTML skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html) vefsíðu.
