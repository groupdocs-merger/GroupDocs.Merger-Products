...
############################# Head ############################
head_title: "Usuń XLSB strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XLSB w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XLSB strony w Java"
description: "Usuń strony XLSB z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików XLSB w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w XLSB plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XLSB za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików XLSB za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń XLSB strony online"
    content: |
       Usuń strony plików XLSB już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsb).
