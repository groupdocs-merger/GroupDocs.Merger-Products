...
############################# Head ############################
head_title: "Odebrat XPS stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XPS v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XPS stránky v Java"
description: "Odstraňte XPS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XPS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XPS soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XPS pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XPS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XPS stránek online"
    content: |
       Odstraňte stránky souborů XPS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps).
