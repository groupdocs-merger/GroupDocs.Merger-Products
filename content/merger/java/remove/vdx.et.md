...
############################# Head ############################
head_title: "Eemaldage VDX lehed rakenduses Java"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist VDX rakenduses Java, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage VDX lehed rakenduses Java"
description: "Eemaldage VDX lehed, millel on paar rida Java koodi."
...
steps:
    enable: true
    title_left: "Eemaldage VDX faililehed tootest Java"
    content_left: |
        [GroupDocs.Merger for Java](/et/merger/java/) muudab Java arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise VDX-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada VDX faililehte, kasutades Java näitekoodi">}}

        ```java    
        // Eemaldage faili VDX lehed, kasutades GroupDocs.Merger API-t
...
demos:
    enable: true
    title: "Reaalajas demod – eemaldage VDX veebilehed"
    content: |
       Eemaldage kohe VDX faililehed, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx).
