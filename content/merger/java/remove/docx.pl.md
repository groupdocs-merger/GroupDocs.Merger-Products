...
############################# Head ############################
head_title: "Usuń DOCX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOCX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOCX strony w Java"
description: "Usuń strony DOCX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOCX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w DOCX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOCX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików DOCX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń DOCX strony online"
    content: |
       Usuń strony plików DOCX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docx).
