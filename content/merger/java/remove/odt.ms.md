...
############################# Head ############################
head_title: "Alih keluar ODT Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail ODT dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar ODT Halaman Dalam Java"
description: "Alih keluar ODT Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar ODT Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam ODT fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar ODT halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar ODT halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar ODT Halaman Dalam Talian"
    content: |
       Alih keluar ODT halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odt).
