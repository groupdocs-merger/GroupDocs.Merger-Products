...
############################# Head ############################
head_title: "Odstrani strani XLAM v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLAM v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLAM strani v Java"
description: "Odstranite strani XLAM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLAM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj XLAM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLAM s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke XLAM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani XLAM na spletu"
    content: |
       Takoj odstranite strani datoteke XLAM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlam).
