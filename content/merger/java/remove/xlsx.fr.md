...
############################# Head ############################
head_title: "Supprimer XLSX pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier XLSX dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer XLSX pages dans Java"
description: "Supprimez les pages XLSX avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer XLSX pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un XLSX fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers XLSX à l'aide de l'exemple de code Java">}}

        ```java    
        // Supprimer XLSX pages de fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Démos en direct - Supprimer XLSX pages en ligne"
    content: |
       Supprimez XLSX pages de fichiers dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx).
