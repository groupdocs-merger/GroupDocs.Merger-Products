...
############################# Head ############################
head_title: "Odstrani strani RTF v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke RTF v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani RTF strani v Java"
description: "Odstranite strani RTF z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke RTF v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj RTF datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke RTF s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke RTF z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani RTF na spletu"
    content: |
       Takoj odstranite strani datoteke RTF tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/rtf).
