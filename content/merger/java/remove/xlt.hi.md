...
############################# Head ############################
head_title: "Java में XLT पेज हटाएं"
head_description: "दस्तावेज़ विलय API का उपयोग करके पृष्ठ क्रम को उलट कर Java में XLT फ़ाइल से एकल पृष्ठ या पृष्ठों के संग्रह को निकालें या हटाएं।"

############################# Header ############################
title: "Java में XLT पेज हटाएं"
description: "{{उत्पादनाम}} कोड की कुछ पंक्तियों वाले XLT पृष्ठ हटाएं।"
...
steps:
    enable: true
    title_left: "Java में XLT फ़ाइल पेज हटाएं"
    content_left: |
        [GroupDocs.Merger for Java](/hi/merger/java/) डेवलपर्स के लिए Java डेवलपर्स के लिए एक XLT के भीतर एक या कई विशेष पेज हटाना आसान बनाता है। कुछ आसान चरणों को लागू करके फ़ाइल।
    ...
    code: |
     ...
     {{< merger/code-merger title="Java उदाहरण कोड का उपयोग करके XLT फ़ाइल पृष्ठों को कैसे निकालें">}}
...
demos:
    enable: true
    title: "लाइव डेमो - XLT पेज ऑनलाइन हटाएं"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlt) वेबसाइट पर जाकर अभी XLT फ़ाइल पेज हटाएं।
