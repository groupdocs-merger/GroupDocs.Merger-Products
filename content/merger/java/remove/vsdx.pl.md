...
############################# Head ############################
head_title: "Usuń VSDX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSDX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSDX strony w Java"
description: "Usuń strony VSDX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSDX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w VSDX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSDX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików VSDX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń VSDX strony online"
    content: |
       Usuń strony plików VSDX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdx).
