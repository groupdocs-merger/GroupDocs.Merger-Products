...
############################# Head ############################
head_title: "Poista RTF sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma RTF-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista RTF sivut Java"
description: "Poista RTF sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista RTF tiedostosivut tuotteesta Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa RTF tiedostosivua käyttämällä Java esimerkkikoodia">}}
