...
############################# Head ############################
head_title: "Usuń XLTX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XLTX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XLTX strony w Java"
description: "Usuń strony XLTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików XLTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w XLTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XLTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików XLTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń XLTX strony online"
    content: |
       Usuń strony plików XLTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx).
