...
############################# Head ############################
head_title: "Hapus PPTX Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file PPTX di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus PPTX Halaman Di Java"
description: "Hapus PPTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus PPTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam PPTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file PPTX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus PPTX Laman Daring"
    content: |
       Hapus halaman file PPTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/pptx).
