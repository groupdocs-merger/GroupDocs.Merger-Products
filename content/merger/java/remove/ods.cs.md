...
############################# Head ############################
head_title: "Odebrat ODS stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru ODS v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat ODS stránky v Java"
description: "Odstraňte ODS stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat ODS stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci ODS soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru ODS pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru ODS pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte ODS stránek online"
    content: |
       Odstraňte stránky souborů ODS hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ods).
