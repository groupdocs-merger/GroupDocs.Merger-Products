...
############################# Head ############################
head_title: "Rimuovi XPS pagine in Java"
head_description: "Rimuovere o eliminare una singola pagina o raccolta di pagine da un file XPS in Java invertendo l'ordine delle pagine utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Rimuovi XPS pagine in Java"
description: "Rimuovi XPS Pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Rimuovi XPS pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di eliminare facilmente una o più pagine particolari all'interno di un XPS file implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come rimuovere le pagine di file XPS utilizzando il codice di esempio Java">}}

        ```java    
        // Rimuovere XPS pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live: rimuovi XPS pagine online"
    content: |
       Rimuovere subito XPS pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps).
