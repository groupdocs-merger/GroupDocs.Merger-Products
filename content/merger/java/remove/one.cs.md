...
############################# Head ############################
head_title: "Odebrat ONE stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru ONE v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat ONE stránky v Java"
description: "Odstraňte ONE stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat ONE stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci ONE soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru ONE pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru ONE pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte ONE stránek online"
    content: |
       Odstraňte stránky souborů ONE hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/one).
