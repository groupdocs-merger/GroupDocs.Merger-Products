...
############################# Head ############################
head_title: "Hapus ODP Halaman di Java"
...
############################# Header ############################
title: "Hapus ODP Halaman Di Java"
description: "Hapus ODP Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus ODP Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam ODP file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ODP menggunakan kode contoh Java">}}
