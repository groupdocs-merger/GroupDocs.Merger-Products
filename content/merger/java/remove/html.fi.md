...
############################# Head ############################
head_title: "Poista HTML sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma HTML-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista HTML sivut Java"
description: "Poista HTML sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista HTML tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja HTML tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa HTML tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista HTML tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista HTML sivua verkosta"
    content: |
       Poista HTML tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html) -sivustolla.
