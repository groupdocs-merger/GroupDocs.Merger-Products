...
############################# Head ############################
head_title: "Удалить VSTX страницы на Java"
head_description: "Удалите одну или набор страниц из файла VSTX на Java, изменив порядок страниц с помощью Merger API."

############################# Header ############################
title: "Удалить VSTX страницы на Java"
description: "Удалите VSTX страницы с помощью нескольких строк Java кода."
...
steps:
    enable: true
    title_left: "Удалить страницы VSTX документов на Java"
    content_left: |
        [GroupDocs.Merger for Java](/ru/merger/java/) упрощает для разработчиков Java удаление одной или нескольких определенных страниц для VSTX документа, выполнив несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как удалить страницы VSTX документов, используя пример кода Java">}}

        ```java    
        // Удалите страницы VSTX документов с помощью GroupDocs.Merger API
...
demos:
    enable: true
    title: "Живые демонстрации – удаление VSTX страниц онлайн"
    content: |
       Удалите страницы VSTX документов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/vstx).
