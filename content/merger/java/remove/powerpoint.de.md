...
############################# Head ############################
head_title: "POWERPOINT-Seiten in Java-Apps löschen"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um spezifische Seiten aus POWERPOINT-Dokumenten zu entfernen. Verarbeiten Sie PDF, Word, Excel, PowerPoint, Bilder, Archive und mehr."

############################# Header ############################
title: "POWERPOINT-Seiten löschen" 
description: "GroupDocs.Merger for Java verbessert Java-Apps mit leistungsstarken Dokumentverarbeitungsfunktionen, einschließlich des Entfernens von Seiten in POWERPOINT-Dateien."
...
steps:
    enable: true
    title: "So löschen Sie Seiten in POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/java/) ermöglicht es Ihnen, Seiten aus POWERPOINT-Dokumenten zu entfernen. Verbessern Sie Ihre Java-Anwendungen mit fortschrittlichen Dokumentenverwaltungsfunktionen.
      
      1. Geben Sie den POWERPOINT-Dateipfad an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Wie man alle geraden Seiten löscht"
      content: |
        Erfahren Sie, wie Sie gerade nummerierte Seiten aus einem POWERPOINT-Dokument entfernen.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
