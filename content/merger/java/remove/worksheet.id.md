...
############################# Head ############################
head_title: "Hapus WORKSHEET Halaman di Java"
...
############################# Header ############################
title: "Hapus WORKSHEET Halaman Di Java"
description: "Hapus WORKSHEET Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus WORKSHEET Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam WORKSHEET file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file WORKSHEET menggunakan kode contoh Java">}}
