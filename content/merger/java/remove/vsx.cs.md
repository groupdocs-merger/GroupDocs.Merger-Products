...
############################# Head ############################
head_title: "Odebrat VSX stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru VSX v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat VSX stránky v Java"
description: "Odstraňte VSX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat VSX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci VSX soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru VSX pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru VSX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte VSX stránek online"
    content: |
       Odstraňte stránky souborů VSX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsx).
