...
############################# Head ############################
head_title: "Odebrat EPUB stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru EPUB v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat EPUB stránky v Java"
description: "Odstraňte EPUB stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat EPUB stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci EPUB soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru EPUB pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru EPUB pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte EPUB stránek online"
    content: |
       Odstraňte stránky souborů EPUB hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub).
