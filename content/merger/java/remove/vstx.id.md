...
############################# Head ############################
head_title: "Hapus VSTX Halaman di Java"
...
############################# Header ############################
title: "Hapus VSTX Halaman Di Java"
description: "Hapus VSTX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VSTX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VSTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSTX menggunakan kode contoh Java">}}
