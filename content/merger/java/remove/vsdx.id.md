...
############################# Head ############################
head_title: "Hapus VSDX Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSDX di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSDX Halaman Di Java"
description: "Hapus VSDX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VSDX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VSDX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSDX menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file VSDX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus VSDX Laman Daring"
    content: |
       Hapus halaman file VSDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/vsdx).
