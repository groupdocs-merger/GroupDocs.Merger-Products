...
############################# Head ############################
head_title: "Odstrani strani PPSX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPSX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPSX strani v Java"
description: "Odstranite strani PPSX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPSX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj PPSX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPSX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke PPSX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani PPSX na spletu"
    content: |
       Takoj odstranite strani datoteke PPSX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx).
