...
############################# Head ############################
head_title: "Noņemt ODP lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no ODP faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt ODP lapas programmā Java"
description: "Noņemiet ODP lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt ODP faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas ODP ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt ODP faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Noņemiet ODP faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — noņemiet ODP lapas tiešsaistē"
    content: |
       Noņemiet ODP faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp).
