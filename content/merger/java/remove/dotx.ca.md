...
############################# Head ############################
head_title: "Suprimeix DOTX pàgines a Java"
head_description: "Elimineu o suprimiu una sola pàgina o col·lecció de pàgines d'un fitxer DOTX a Java invertint l'ordre de les pàgines mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Suprimeix DOTX pàgines a Java"
description: "Elimineu DOTX pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Suprimeix DOTX pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) fa que sigui fàcil per als desenvolupadors de Java eliminar una o diverses pàgines concretes dins d'un DOTX fitxer implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com eliminar pàgines de fitxers DOTX utilitzant el codi d'exemple Java">}}

        ```java    
        // Elimineu DOTX pàgines de fitxers mitjançant l'API de GroupDocs.Merger
...
demos:
    enable: true
    title: "Demos en directe: suprimiu DOTX pàgines en línia"
    content: |
       Elimineu DOTX pàgines de fitxers ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
