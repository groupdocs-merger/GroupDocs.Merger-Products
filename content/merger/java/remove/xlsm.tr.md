...
############################# Head ############################
head_title: "Java İçindeki XLSM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek Java içindeki bir XLSM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "Java İçindeki XLSM Sayfayı Kaldır"
description: "Birkaç satır Java kodu içeren XLSM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: "Java içindeki XLSM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir XLSM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak XLSM dosya sayfaları nasıl kaldırılır">}}

        ```java    
        // GroupDocs.Merger API kullanarak XLSM dosya sayfalarını kaldırın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi XLSM Sayfayı Kaldırın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm) web sitesini ziyaret ederek XLSM dosya sayfalarını hemen kaldırın.
