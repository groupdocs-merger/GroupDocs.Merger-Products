...
############################# Head ############################
head_title: "Usuń VSSX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSSX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSSX strony w Java"
description: "Usuń strony VSSX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSSX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w VSSX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSSX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików VSSX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń VSSX strony online"
    content: |
       Usuń strony plików VSSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vssx).
