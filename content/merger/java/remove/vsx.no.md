...
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VSX-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VSX sider i Java"
description: "Fjern VSX-sider med noen få linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en VSX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VSX filsider ved å bruke Java eksempelkode">}}
