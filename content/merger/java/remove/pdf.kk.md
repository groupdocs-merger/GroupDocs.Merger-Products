...
############################# Head ############################
head_title: "Java ішіндегі PDF беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы Java ішіндегі PDF файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "Java ішіндегі PDF беттерді жою"
description: "Java кодының бірнеше жолы бар PDF беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі PDF файл бетін жою"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне PDF ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF файл бетін Java мысал кодын пайдаланып жою жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы PDF файл бетін жойыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - PDF беттерді желіден алып тастаңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf) веб-сайтына кіру арқылы PDF файл бетін дәл қазір жойыңыз.
