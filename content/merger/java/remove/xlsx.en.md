...
############################# Head ############################
head_title: "Delete XLSX pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to remove specific pages from XLSX documents. Easily process PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Delete pages in XLSX" 
description: "GroupDocs.Merger for Java enhances Java apps with powerful document processing features, including page removal in XLSX files."
...
steps:
    enable: true
    title: "How to delete pages in XLSX"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to easily remove pages from XLSX documents. Enhance your Java applications with advanced document management capabilities.
      
      1. Specify the XLSX file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to delete all even pages"
      content: |
        Learn how to remove even-numbered pages from a XLSX document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
