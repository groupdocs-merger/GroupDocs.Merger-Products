...
############################# Head ############################
head_title: "Remove XLSX pages in Java apps"
...
steps:
    enable: true
    title: "How to remove pages in XLSX"
    content: |
      [GroupDocs.Merger](/merger/java/) is able to delete XLSX document pages easily. Java applications may be powered by our solution in order to provide document management features.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Be informed how to remove all even pages"
      content: |
        Learn how to remove even pages in a XLSX document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
