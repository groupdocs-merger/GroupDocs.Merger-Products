...
############################# Head ############################
head_title: "删除 Java 中的 PPT 个页面"
head_description: "通过使用文档合并 API 反转页面顺序，从 Java 中的 PPT 文件中删除或删除单个页面或页面集合。"

############################# Header ############################
title: "删除 Java 中的 PPT 页"
description: "删除包含几行 Java 代码的 PPT 页面。"
...
steps:
    enable: true
    title_left: "删除 Java 中的 PPT 个文件页"
    content_left: |
        [GroupDocs.Merger for Java](/zh/merger/java/) 使 Java 开发人员可以轻松删除 PPT 中的单个或多个特定页面通过执行几个简单的步骤来创建文件。
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 Java 示例代码删除 PPT 文件页面">}}

        ```java    
        // 使用 GroupDocs.Merger API 删除 PPT 文件页面
...
demos:
    enable: true
    title: "现场演示 - 在线删除 PPT 页面"
    content: |
       立即访问 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppt) 网站删除 PPT 文件页面。
       现场演示具有以下好处。
