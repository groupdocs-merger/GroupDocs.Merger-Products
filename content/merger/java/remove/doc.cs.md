...
############################# Head ############################
head_title: "Odebrat DOC stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru DOC v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat DOC stránky v Java"
description: "Odstraňte DOC stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat DOC stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci DOC soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru DOC pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru DOC pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte DOC stránek online"
    content: |
       Odstraňte stránky souborů DOC hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc).
