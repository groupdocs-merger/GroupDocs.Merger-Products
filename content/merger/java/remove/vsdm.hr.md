...
############################# Head ############################
head_title: "Ukloni VSDM stranice u Java"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz VSDM datoteke u Java obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni VSDM stranice u Java"
description: "Ukloni VSDM stranice s nekoliko redaka Java koda."
...
steps:
    enable: true
    title_left: "Ukloni VSDM stranice datoteke u Java"
    content_left: |
        [GroupDocs.Merger for Java](/hr/merger/java/) programerima za Java olakšava brisanje jedne ili više određenih stranica unutar VSDM datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti VSDM stranice datoteke koristeći Java primjer koda">}}

        ```java    
        // Ukloni VSDM stranice datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    enable: true
    title: "Demonstracije uživo - Ukloni VSDM stranice na mreži"
    content: |
       Uklonite VSDM stranice datoteke odmah tako što ćete posjetiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm) web mjesto.
