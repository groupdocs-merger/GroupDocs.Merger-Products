...
############################# Head ############################
head_title: "Usuń VSX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSX strony w Java"
description: "Usuń strony VSX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSX w Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSX za pomocą przykładowego kodu Java">}}
