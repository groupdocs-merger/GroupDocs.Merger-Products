...
############################# Head ############################
head_title: "Fjern VSX sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en VSX-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern VSX sider i Java"
description: "Fjern VSX sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern VSX filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en VSX fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du VSX filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern VSX filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern VSX sider online"
    content: |
       Fjern VSX filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsx).
