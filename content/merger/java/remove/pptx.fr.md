...
############################# Head ############################
head_title: "Supprimer PPTX pages dans Java"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier PPTX dans Java en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer PPTX pages dans Java"
description: "Supprimez les pages PPTX avec quelques lignes de code Java."
...
steps:
    enable: true
    title_left: "Supprimer PPTX pages de fichiers dans Java"
    content_left: |
        [GroupDocs.Merger for Java](/fr/merger/java/) permet aux développeurs de Java de supprimer facilement une ou plusieurs pages particulières dans un PPTX fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers PPTX à l'aide de l'exemple de code Java">}}
