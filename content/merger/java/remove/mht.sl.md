...
############################# Head ############################
head_title: "Odstrani strani MHT v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke MHT v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani MHT strani v Java"
description: "Odstranite strani MHT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke MHT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj MHT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke MHT s primerom kode Java">}}
