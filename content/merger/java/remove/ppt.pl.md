...
############################# Head ############################
head_title: "Usuń PPT strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPT w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPT strony w Java"
description: "Usuń strony PPT z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPT w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w PPT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPT za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików PPT za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń PPT strony online"
    content: |
       Usuń strony plików PPT już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppt).
