...
############################# Head ############################
head_title: "Alih keluar VSSM Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail VSSM dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar VSSM Halaman Dalam Java"
description: "Alih keluar VSSM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar VSSM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam VSSM fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar VSSM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar VSSM halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar VSSM Halaman Dalam Talian"
    content: |
       Alih keluar VSSM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vssm).
