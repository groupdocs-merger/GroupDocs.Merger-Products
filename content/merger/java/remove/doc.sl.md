...
############################# Head ############################
head_title: "Odstrani strani DOC v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOC v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOC strani v Java"
description: "Odstranite strani DOC z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOC v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj DOC datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOC s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke DOC z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani DOC na spletu"
    content: |
       Takoj odstranite strani datoteke DOC tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc).
