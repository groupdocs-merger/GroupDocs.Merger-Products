...
############################# Head ############################
head_title: "إزالة صفحات DOCX في Java"
head_description: "قم بإزالة أو حذف صفحة واحدة أو مجموعة صفحات من ملف DOCX في Java عن طريق عكس ترتيب الصفحات باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "إزالة صفحات DOCX في Java"
description: "قم بإزالة صفحات DOCX التي تحتوي على بضعة أسطر من كود Java."
...
steps:
    enable: true
    title_left: "إزالة صفحات ملف DOCX في Java"
    content_left: |
        يسهّل [GroupDocs.Merger for Java](/ar/merger/java/) على مطوري Java حذف صفحة واحدة أو عدد من الصفحات المعينة داخل DOCX ملف من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية إزالة صفحات الملف DOCX باستخدام كود مثال Java">}}

        ```java    
        // إزالة صفحات الملف DOCX باستخدام GroupDocs.Merger API
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - قم بإزالة DOCX من الصفحات على الإنترنت"
    content: |
       قم بإزالة صفحات ملف DOCX الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/docx).
