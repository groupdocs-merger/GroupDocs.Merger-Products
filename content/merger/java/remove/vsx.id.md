...
############################# Head ############################
head_title: "Hapus VSX Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSX di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSX Halaman Di Java"
description: "Hapus VSX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus VSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam VSX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSX menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file VSX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus VSX Laman Daring"
    content: |
       Hapus halaman file VSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/vsx).
