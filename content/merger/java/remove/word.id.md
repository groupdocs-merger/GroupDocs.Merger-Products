...
############################# Head ############################
head_title: "Hapus WORD Halaman di Java"
...
############################# Header ############################
title: "Hapus WORD Halaman Di Java"
description: "Hapus WORD Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus WORD Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam WORD file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file WORD menggunakan kode contoh Java">}}
