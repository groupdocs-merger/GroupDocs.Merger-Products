...
############################# Head ############################
head_title: "Suprimeix VSTX pàgines a Java"
head_description: "Elimineu o suprimiu una sola pàgina o col·lecció de pàgines d'un fitxer VSTX a Java invertint l'ordre de les pàgines mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Suprimeix VSTX pàgines a Java"
description: "Elimineu VSTX pàgines amb unes quantes línies de codi Java."
...
steps:
    enable: true
    title_left: "Suprimeix VSTX pàgines de fitxers a Java"
    content_left: |
        [GroupDocs.Merger for Java](/ca/merger/java/) fa que sigui fàcil per als desenvolupadors de Java eliminar una o diverses pàgines concretes dins d'un VSTX fitxer implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com eliminar pàgines de fitxers VSTX utilitzant el codi d'exemple Java">}}
