...
############################# Head ############################
head_title: "Poista MHT sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma MHT-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista MHT sivut Java"
description: "Poista MHT sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista MHT tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja MHT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa MHT tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista MHT tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista MHT sivua verkosta"
    content: |
       Poista MHT tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mht) -sivustolla.
