...
############################# Head ############################
head_title: "Hapus DOTM Halaman di Java"
...
############################# Header ############################
title: "Hapus DOTM Halaman Di Java"
description: "Hapus DOTM Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus DOTM Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam DOTM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOTM menggunakan kode contoh Java">}}
