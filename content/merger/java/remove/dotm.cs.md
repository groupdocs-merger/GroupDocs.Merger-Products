...
############################# Head ############################
head_title: "Odebrat DOTM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru DOTM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat DOTM stránky v Java"
description: "Odstraňte DOTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat DOTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci DOTM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru DOTM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru DOTM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte DOTM stránek online"
    content: |
       Odstraňte stránky souborů DOTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotm).
