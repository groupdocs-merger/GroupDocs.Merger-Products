...
############################# Head ############################
head_title: "Odebrat OTT stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru OTT v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat OTT stránky v Java"
description: "Odstraňte OTT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat OTT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci OTT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru OTT pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru OTT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte OTT stránek online"
    content: |
       Odstraňte stránky souborů OTT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ott).
