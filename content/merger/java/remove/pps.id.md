...
head_title: "Hapus Halaman dari File PPS di Java"
...
title: "Hapus atau Hapus Halaman Dari PPS di Java"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman tertentu dari file PPS menggunakan API penggabungan dokumen untuk aplikasi Java & J2SE."
...
steps:
    enable: true
    title_left: "Hapus Halaman File PPS di Java"
    content_left: |
        [GroupDocs.Merger](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam file PPS dengan menerapkan beberapa langkah mudah.
