...
############################# Head ############################
head_title: "Hapus ODS Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file ODS di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus ODS Halaman Di Java"
description: "Hapus ODS Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus ODS Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam ODS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ODS menggunakan kode contoh Java">}}

        ```java    
        // Hapus halaman file ODS menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus ODS Laman Daring"
    content: |
       Hapus halaman file ODS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/ods).
