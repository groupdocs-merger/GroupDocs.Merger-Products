...
############################# Head ############################
head_title: "Verwyder MHT bladsye in Java"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n MHT-lêer in Java deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder MHT bladsye in Java"
description: "Verwyder MHT Bladsye met 'n paar reëls van Java-kode."
...
steps:
    enable: true
    title_left: "Verwyder MHT lêerbladsye in Java"
    content_left: |
        [GroupDocs.Merger for Java](/af/merger/java/) maak dit maklik vir Java-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n MHT uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHT lêerbladsye te verwyder deur Java voorbeeldkode te gebruik">}}

        ```java    
        // Verwyder MHT lêerbladsye deur GroupDocs.Merger API te gebruik
...
demos:
    enable: true
    title: "Regstreekse demonstrasies - Verwyder MHT bladsye aanlyn"
    content: |
       Verwyder MHT lêerbladsye op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mht) webwerf te besoek.
