...
############################# Head ############################
head_title: "Xóa DOTM Trang trong Java"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp DOTM trong Java bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa DOTM Trang trong Java"
description: "Xóa các trang DOTM có một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Xóa DOTM Trang Tệp trong Java"
    content_left: |
        [GroupDocs.Merger for Java] (/vi/merge/java/) giúp các nhà phát triển Java dễ dàng xóa một hoặc một số trang cụ thể trong DOTM bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp DOTM bằng mã mẫu Java">}}

        ```java    
        // Xóa các trang tệp DOTM bằng API GroupDocs.Merger
...
demos:
    enable: true
    title: "Bản trình diễn Trực tiếp - Xóa DOTM Trang Trực tuyến"
    content: |
       Xóa các trang tệp DOTM ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos] (https://products.groupdocs.app/splitter/remove-pages/ dotm) trang web.
