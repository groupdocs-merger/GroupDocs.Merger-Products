...
############################# Head ############################
head_title: "Ta bort HTML sidor i Java"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en HTML-fil i Java genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort HTML sidor i Java"
description: "Ta bort HTML-sidor med några rader med Java-kod."
...
steps:
    enable: true
    title_left: "Ta bort HTML filsidor i Java"
    content_left: |
        [GroupDocs.Merger for Java](/sv/merger/java/) gör det enkelt för Java-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en HTML fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort HTML filsidor med hjälp av Java exempelkod">}}

        ```java    
        // Ta bort HTML filsidor med GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemonstrationer - Ta bort HTML sidor online"
    content: |
       Ta bort HTML filsidor just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/html).
