...
############################# Head ############################
head_title: "Eliminar páginas de XLSX en aplicaciones Java"
head_description: "Utilice GroupDocs.Merger for Java para eliminar páginas específicas de documentos XLSX. Procese documentos PDF, Word, Excel, PowerPoint, imágenes, archivos y más."

############################# Header ############################
title: "Eliminar páginas en XLSX" 
description: "GroupDocs.Merger for Java mejora las aplicaciones Java con potentes funciones de procesamiento de documentos, incluyendo la eliminación de páginas en archivos XLSX."
...
steps:
    enable: true
    title: "Cómo eliminar páginas en XLSX"
    content: |
      [GroupDocs.Merger](/merger/java/) le permite eliminar páginas de documentos XLSX. Mejore sus aplicaciones Java con capacidades avanzadas de gestión de documentos.
      
      1. Especifique la ruta del archivo XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo eliminar todas las páginas pares"
      content: |
        Aprenda a eliminar páginas de número par de un documento XLSX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
