...
############################# Head ############################
head_title: "Java İçindeki DOT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek Java içindeki bir DOT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "Java İçindeki DOT Sayfayı Kaldır"
description: "Birkaç satır Java kodu içeren DOT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: "Java içindeki DOT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir DOT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak DOT dosya sayfaları nasıl kaldırılır">}}

        ```java    
        // GroupDocs.Merger API kullanarak DOT dosya sayfalarını kaldırın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi DOT Sayfayı Kaldırın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot) web sitesini ziyaret ederek DOT dosya sayfalarını hemen kaldırın.
