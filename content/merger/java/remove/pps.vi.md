...
############################# Head ############################
head_title: "Xóa PPS Trang trong Java"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp PPS trong Java bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa PPS Trang trong Java"
description: "Xóa các trang PPS có một vài dòng mã Java."
...
steps:
    enable: true
    title_left: "Xóa PPS Trang Tệp trong Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp PPS bằng mã mẫu Java">}}
