...
############################# Head ############################
head_title: "Հեռացնել VDX էջ Java-ից"
head_description: "Հեռացրեք կամ ջնջեք մեկ էջ կամ էջերի հավաքածու VDX ֆայլից Java-ում` փոխելով էջերի հերթականությունը` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Հեռացնել VDX էջ Java-ում"
description: "Հեռացրեք VDX էջերը մի քանի տող Java կոդով:"
...
steps:
    enable: true
    title_left: "Հեռացնել VDX ֆայլի էջեր Java-ից"
    content_left: |
        [GroupDocs.Merger for Java](/hy/merger/java/) հեշտացնում է Java մշակողների համար ջնջել մեկ կամ մի քանի կոնկրետ էջեր VDX-ի շրջանակներում: ֆայլ՝ իրականացնելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հեռացնել VDX ֆայլի էջերը՝ օգտագործելով Java օրինակ կոդը">}}

        ```java    
        // Հեռացրեք VDX ֆայլի էջեր՝ օգտագործելով GroupDocs.Merger API
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Հեռացրեք VDX էջեր առցանց"
    content: |
       Հեռացրեք VDX ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx) կայքը:
