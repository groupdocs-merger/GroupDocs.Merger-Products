...
############################# Head ############################
head_title: "Odebrat DOTX stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru DOTX v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat DOTX stránky v Java"
description: "Odstraňte DOTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat DOTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci DOTX soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru DOTX pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru DOTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte DOTX stránek online"
    content: |
       Odstraňte stránky souborů DOTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
