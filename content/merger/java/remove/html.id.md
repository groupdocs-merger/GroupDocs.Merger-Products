...
############################# Head ############################
head_title: "Hapus HTML Halaman di Java"
...
############################# Header ############################
title: "Hapus HTML Halaman Di Java"
description: "Hapus HTML Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus HTML Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam HTML file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file HTML menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus HTML Laman Daring"
    content: |
       Hapus halaman file HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/html).
