...
############################# Head ############################
head_title: "Hapus MHTML Halaman di Java"
...
############################# Header ############################
title: "Hapus MHTML Halaman Di Java"
description: "Hapus MHTML Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus MHTML Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam MHTML file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file MHTML menggunakan kode contoh Java">}}
