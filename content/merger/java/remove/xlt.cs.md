...
############################# Head ############################
head_title: "Odebrat XLT stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XLT v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XLT stránky v Java"
description: "Odstraňte XLT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XLT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XLT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XLT pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XLT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XLT stránek online"
    content: |
       Odstraňte stránky souborů XLT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlt).
