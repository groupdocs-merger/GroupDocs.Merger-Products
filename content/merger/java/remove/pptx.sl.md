...
############################# Head ############################
head_title: "Odstrani strani PPTX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPTX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPTX strani v Java"
description: "Odstranite strani PPTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj PPTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPTX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke PPTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani PPTX na spletu"
    content: |
       Takoj odstranite strani datoteke PPTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pptx).
