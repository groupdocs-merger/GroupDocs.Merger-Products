...
############################# Head ############################
head_title: "Usuń DOTX strony w Java"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOTX w Java, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOTX strony w Java"
description: "Usuń strony DOTX z kilkoma wierszami kodu Java."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOTX w Java"
    content_left: |
        [GroupDocs.Merger for Java](/pl/merger/java/) ułatwia programistom Java usunięcie jednej lub kilku określonych stron w DOTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOTX za pomocą przykładowego kodu Java">}}

        ```java    
        // Usuń strony plików DOTX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń DOTX strony online"
    content: |
       Usuń strony plików DOTX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
