...
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VSDM-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VSDM sider i Java"
description: "Fjern VSDM-sider med noen få linjer med Java-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en VSDM fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VSDM filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Fjern VSDM filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern VSDM-sider på nettet"
    content: |
       Fjern VSDM-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
