...
############################# Head ############################
head_title: "Hapus PPSX Halaman di Java"
...
############################# Header ############################
title: "Hapus PPSX Halaman Di Java"
description: "Hapus PPSX Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus PPSX Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam PPSX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file PPSX menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus PPSX Laman Daring"
    content: |
       Hapus halaman file PPSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/ppsx).
