...
############################# Head ############################
head_title: "Eliminar páginas de DOCX en aplicaciones Java"
head_description: "Utilice GroupDocs.Merger for Java para eliminar páginas específicas de documentos DOCX. Procese documentos PDF, Word, Excel, PowerPoint, imágenes, archivos y más."

############################# Header ############################
title: "Eliminar páginas en DOCX" 
description: "GroupDocs.Merger for Java mejora las aplicaciones Java con potentes funciones de procesamiento de documentos, incluyendo la eliminación de páginas en archivos DOCX."
...
steps:
    enable: true
    title: "Cómo eliminar páginas en DOCX"
    content: |
      [GroupDocs.Merger](/merger/java/) le permite eliminar páginas de documentos DOCX. Mejore sus aplicaciones Java con capacidades avanzadas de gestión de documentos.
      
      1. Especifique la ruta del archivo DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo eliminar todas las páginas pares"
      content: |
        Aprenda a eliminar páginas de número par de un documento DOCX.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
