...
############################# Head ############################
head_title: "Távolítsa el az XLSM oldalt a Java programból"
head_description: "Távolítson el vagy töröljön egyetlen oldalt vagy oldalgyűjteményt egy XLSM fájlból a Java alkalmazásban az oldalak sorrendjének megfordításával a dokumentumok egyesítése API használatával."

############################# Header ############################
title: "XLSM oldal eltávolítása a Java nyelven"
description: "Távolítsa el a néhány soros Java kódot tartalmazó XLSM oldalt."
...
steps:
    enable: true
    title_left: "Távolítsa el a(z) XLSM fájloldalakat a(z) Java termékből"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) megkönnyíti a Java fejlesztői számára, hogy egyetlen vagy több oldalt töröljenek egy XLSM-on belül néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan távolítsunk el XLSM fájloldalakat a Java példakóddal">}}

        ```java    
        // Távolítsa el az XLSM fájloldalakat a GroupDocs.Merger API segítségével
...
demos:
    enable: true
    title: "Élő bemutatók – Távolítsa el az XLSM oldalakat online"
    content: |
       Távolítsa el az XLSM fájloldalakat azonnal a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsm) webhely meglátogatásával.
