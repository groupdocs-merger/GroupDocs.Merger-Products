...
############################# Head ############################
head_title: "Java ішіндегі OTP беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы Java ішіндегі OTP файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "Java ішіндегі OTP беттерді жою"
description: "Java кодының бірнеше жолы бар OTP беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: "Java ішіндегі OTP файл бетін жою"
    content_left: |
        [GroupDocs.Merger for Java](/kk/merger/java/) Java әзірлеушілеріне OTP ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP файл бетін Java мысал кодын пайдаланып жою жолы">}}

        ```java    
        // GroupDocs.Merger API арқылы OTP файл бетін жойыңыз
...
demos:
    enable: true
    title: "Тікелей демонстрациялар - OTP беттерді желіден алып тастаңыз"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/otp) веб-сайтына кіру арқылы OTP файл бетін дәл қазір жойыңыз.
