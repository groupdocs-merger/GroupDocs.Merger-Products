...
############################# Head ############################
head_title: "Alih keluar VDX Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail VDX dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar VDX Halaman Dalam Java"
description: "Alih keluar VDX Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar VDX Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam VDX fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar VDX halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar VDX halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar VDX Halaman Dalam Talian"
    content: |
       Alih keluar VDX halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx).
