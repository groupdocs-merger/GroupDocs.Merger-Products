...
############################# Head ############################
head_title: "Eliminați paginile VDX din Java"
head_description: "Eliminați sau ștergeți o singură pagină sau o colecție de pagini dintr-un fișier VDX din Java inversând ordinea paginilor utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Eliminați VDX pagini din Java"
description: "Eliminați paginile VDX cu câteva rânduri de cod Java."
...
steps:
    enable: true
    title_left: "Eliminați paginile de fișiere VDX din Java"
    content_left: |
        [GroupDocs.Merger for Java](/ro/merger/java/) facilitează pentru dezvoltatorii Java să șterge o singură pagină sau mai multe anumite pagini dintr-un VDX fișier prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să eliminați pagini de fișiere VDX folosind codul exemplu Java">}}

        ```java    
        // Eliminați pagini de fișiere VDX utilizând API-ul GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live - Eliminați VDX pagini online"
    content: |
       Eliminați paginile de fișiere VDX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx).
