...
############################# Head ############################
head_title: "Poista VDX sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VDX-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VDX sivut Java"
description: "Poista VDX sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista VDX tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VDX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VDX tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista VDX tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista VDX sivua verkosta"
    content: |
       Poista VDX tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx) -sivustolla.
