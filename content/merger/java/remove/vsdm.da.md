...
############################# Head ############################
head_title: "Fjern VSDM sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en VSDM-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern VSDM sider i Java"
description: "Fjern VSDM sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern VSDM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en VSDM fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du VSDM filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern VSDM filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern VSDM sider online"
    content: |
       Fjern VSDM filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
