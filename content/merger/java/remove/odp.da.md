...
############################# Head ############################
head_title: "Fjern ODP sider i Java"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en ODP-fil i Java ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern ODP sider i Java"
description: "Fjern ODP sider med et par linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern ODP filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/da/merger/java/) gør det nemt for Java-udviklere at slette en enkelt eller et antal bestemte sider inden for en ODP fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du ODP filsider ved hjælp af Java eksempelkode">}}

        ```java    
        // Fjern ODP filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern ODP sider online"
    content: |
       Fjern ODP filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp).
