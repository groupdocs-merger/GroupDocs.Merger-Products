...
############################# Head ############################
head_title: "Odstrani strani PPS v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPS v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPS strani v Java"
description: "Odstranite strani PPS z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPS v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj PPS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPS s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke PPS z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani PPS na spletu"
    content: |
       Takoj odstranite strani datoteke PPS tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pps).
