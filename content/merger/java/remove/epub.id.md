...
############################# Head ############################
head_title: "Hapus EPUB Halaman di Java"
...
############################# Header ############################
title: "Hapus EPUB Halaman Di Java"
description: "Hapus EPUB Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus EPUB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam EPUB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file EPUB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus EPUB Laman Daring"
    content: |
       Hapus halaman file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/epub).
