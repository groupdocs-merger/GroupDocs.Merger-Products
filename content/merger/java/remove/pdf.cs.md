...
############################# Head ############################
head_title: "Odebrat PDF stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru PDF v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat PDF stránky v Java"
description: "Odstraňte PDF stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat PDF stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci PDF soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru PDF pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru PDF pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte PDF stránek online"
    content: |
       Odstraňte stránky souborů PDF hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf).
