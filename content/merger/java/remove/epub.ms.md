...
############################# Head ############################
head_title: "Alih keluar EPUB Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail EPUB dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar EPUB Halaman Dalam Java"
description: "Alih keluar EPUB Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar EPUB Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam EPUB fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar EPUB halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar EPUB halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar EPUB Halaman Dalam Talian"
    content: |
       Alih keluar EPUB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub).
