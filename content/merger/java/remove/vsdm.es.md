...
############################# Head ############################
head_title: "Eliminar VSDM páginas en Java"
head_description: "Quite o elimine una sola página o colección de páginas de un archivo VSDM en Java invirtiendo el orden de las páginas usando la API de combinación de documentos."

############################# Header ############################
title: "Eliminar VSDM páginas en Java"
description: "Elimina VSDM páginas con unas pocas líneas de código Java."
...
steps:
    enable: true
    title_left: "Eliminar VSDM páginas de archivos en Java"
    content_left: |
        [GroupDocs.Merger for Java](/es/merger/java/) facilita que los desarrolladores de Java eliminen una o varias páginas en particular dentro de VSDM archivo mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo eliminar las páginas de archivos VSDM usando el código de ejemplo Java">}}

        ```java    
        // Eliminar VSDM páginas de archivos usando GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demostraciones en vivo - Eliminar VSDM páginas en línea"
    content: |
       Elimine las páginas de archivos VSDM ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsdm).
