...
############################# Head ############################
head_title: "Alih keluar VSTM Halaman dalam Java"
head_description: "Alih keluar atau padamkan satu halaman atau koleksi halaman daripada fail VSTM dalam Java dengan membalikkan susunan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alih keluar VSTM Halaman Dalam Java"
description: "Alih keluar VSTM Halaman dengan beberapa baris kod Java."
...
steps:
    enable: true
    title_left: "Alih keluar VSTM Halaman Fail dalam Java"
    content_left: |
        [GroupDocs.Merger for Java](/ms/merger/java/) memudahkan pembangun Java memadamkan satu atau beberapa halaman tertentu dalam VSTM fail dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk mengalih keluar VSTM halaman fail menggunakan kod contoh Java.">}}

        ```java    
        // Alih keluar VSTM halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Alih Keluar VSTM Halaman Dalam Talian"
    content: |
       Alih keluar VSTM halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstm).
