...
############################# Head ############################
head_title: "Odebrat VSTX stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru VSTX v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat VSTX stránky v Java"
description: "Odstraňte VSTX stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat VSTX stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci VSTX soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru VSTX pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru VSTX pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte VSTX stránek online"
    content: |
       Odstraňte stránky souborů VSTX hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vstx).
