...
############################# Head ############################
head_title: "Noņemt HTML lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no HTML faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt HTML lapas programmā Java"
description: "Noņemiet HTML lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt HTML faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas HTML ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt HTML faila lapas, izmantojot Java piemēra kodu">}}
