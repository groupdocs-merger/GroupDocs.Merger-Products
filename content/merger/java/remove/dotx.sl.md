...
############################# Head ############################
head_title: "Odstrani strani DOTX v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOTX v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOTX strani v Java"
description: "Odstranite strani DOTX z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOTX v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj DOTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOTX s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke DOTX z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani DOTX na spletu"
    content: |
       Takoj odstranite strani datoteke DOTX tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotx).
