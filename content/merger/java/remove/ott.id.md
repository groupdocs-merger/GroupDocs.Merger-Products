...
############################# Head ############################
head_title: "Hapus OTT Halaman di Java"
...
############################# Header ############################
title: "Hapus OTT Halaman Di Java"
description: "Hapus OTT Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus OTT Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam OTT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file OTT menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus OTT Laman Daring"
    content: |
       Hapus halaman file OTT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/ott).
