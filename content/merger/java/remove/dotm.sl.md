...
############################# Head ############################
head_title: "Odstrani strani DOTM v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOTM v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOTM strani v Java"
description: "Odstranite strani DOTM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOTM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj DOTM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOTM s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke DOTM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani DOTM na spletu"
    content: |
       Takoj odstranite strani datoteke DOTM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotm).
