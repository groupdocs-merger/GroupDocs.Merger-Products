...
############################# Head ############################
head_title: "Fjarlægðu TEX síður í Java"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr TEX skrá í Java með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu TEX síður í Java"
description: "Fjarlægðu TEX síður með nokkrum línum af Java kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu TEX skráarsíður í Java"
    content_left: |
        [GroupDocs.Merger for Java](/is/merger/java/) auðveldar Java forriturum að eyða einni eða nokkrum tilteknum síðum innan TEX skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja TEX skráarsíður með því að nota Java dæmikóða">}}

        ```java    
        // Fjarlægðu TEX skráarsíður með því að nota GroupDocs.Merger API
...
demos:
    enable: true
    title: "Sýningar í beinni - Fjarlægðu TEX síður á netinu"
    content: |
       Fjarlægðu TEX skráarsíður núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/tex) vefsíðu.
