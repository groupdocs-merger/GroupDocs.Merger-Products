...
############################# Head ############################
head_title: "Poista DOTM sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOTM-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOTM sivut Java"
description: "Poista DOTM sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista DOTM tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOTM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOTM tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista DOTM tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista DOTM sivua verkosta"
    content: |
       Poista DOTM tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dotm) -sivustolla.
