...
############################# Head ############################
head_title: "Hapus OTP Halaman di Java"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file OTP di Java dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus OTP Halaman Di Java"
description: "Hapus OTP Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus OTP Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam OTP file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file OTP menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus OTP Laman Daring"
    content: |
       Hapus halaman file OTP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/otp).
