...
############################# Head ############################
head_title: "Odebrat XLAM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XLAM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XLAM stránky v Java"
description: "Odstraňte XLAM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XLAM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XLAM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XLAM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XLAM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XLAM stránek online"
    content: |
       Odstraňte stránky souborů XLAM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlam).
