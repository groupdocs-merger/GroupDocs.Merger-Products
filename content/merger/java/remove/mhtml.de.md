...
############################# Head ############################
head_title: "MHTML-Seiten in Java-Apps löschen"
head_description: "Verwenden Sie GroupDocs.Merger for Java, um spezifische Seiten aus MHTML-Dokumenten zu entfernen. Verarbeiten Sie PDF, Word, Excel, PowerPoint, Bilder, Archive und mehr."

############################# Header ############################
title: "MHTML-Seiten löschen" 
description: "GroupDocs.Merger for Java verbessert Java-Apps mit leistungsstarken Dokumentverarbeitungsfunktionen, einschließlich des Entfernens von Seiten in MHTML-Dateien."
...
steps:
    enable: true
    title: "So löschen Sie Seiten in MHTML"
    content: |
      [GroupDocs.Merger](/merger/java/) ermöglicht es Ihnen, Seiten aus MHTML-Dokumenten zu entfernen. Verbessern Sie Ihre Java-Anwendungen mit fortschrittlichen Dokumentenverwaltungsfunktionen.
      
      1. Geben Sie den MHTML-Dateipfad an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Wie man alle geraden Seiten löscht"
      content: |
        Erfahren Sie, wie Sie gerade nummerierte Seiten aus einem MHTML-Dokument entfernen.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
