...
############################# Head ############################
head_title: "Rimuovi DOC pagine in Java"
head_description: "Rimuovere o eliminare una singola pagina o raccolta di pagine da un file DOC in Java invertendo l'ordine delle pagine utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Rimuovi DOC pagine in Java"
description: "Rimuovi DOC Pagine con poche righe di codice Java."
...
steps:
    enable: true
    title_left: "Rimuovi DOC pagine di file in Java"
    content_left: |
        [GroupDocs.Merger for Java](/it/merger/java/) consente agli sviluppatori di Java di eliminare facilmente una o più pagine particolari all'interno di un DOC file implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come rimuovere le pagine di file DOC utilizzando il codice di esempio Java">}}

        ```java    
        // Rimuovere DOC pagine di file utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo live: rimuovi DOC pagine online"
    content: |
       Rimuovere subito DOC pagine di file visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc).
