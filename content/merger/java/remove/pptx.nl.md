...
############################# Head ############################
head_title: "Verwijder PPTX pagina's in Java"
head_description: "Verwijder of verwijder een enkele pagina of verzameling pagina's uit een PPTX-bestand in Java door de paginavolgorde om te draaien met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verwijder PPTX pagina's in Java"
description: "Verwijder PPTX pagina's met een paar regels Java code."
...
steps:
    enable: true
    title_left: "Verwijder PPTX Bestandspagina's in Java"
    content_left: |
        [GroupDocs.Merger for Java](/nl/merger/java/) maakt het gemakkelijk voor Java ontwikkelaars om een ​​enkele of een aantal bepaalde pagina's binnen een PPTX te verwijderen bestand door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestandspagina's te verwijderen met behulp van Java voorbeeldcode">}}

        ```java    
        // Verwijder PPTX bestandspagina's met de GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live demo's - Verwijder PPTX pagina's online"
    content: |
       Verwijder PPTX bestandspagina's nu direct door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pptx) te gaan.
