...
############################# Head ############################
head_title: "Fjern XLAM sider i Java"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en XLAM-fil i Java ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern XLAM sider i Java"
description: "Fjern XLAM-sider med noen få linjer med Java-kode."
...
steps:
    enable: true
    title_left: "Fjern XLAM filsider i Java"
    content_left: |
        [GroupDocs.Merger for Java](/no/merger/java/) gjør det enkelt for Java-utviklere å slette en enkelt eller flere bestemte sider innenfor en XLAM fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne XLAM filsider ved å bruke Java eksempelkode">}}

        ```java    
        // Fjern XLAM filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern XLAM-sider på nettet"
    content: |
       Fjern XLAM-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlam).
