...
############################# Head ############################
head_title: "Poista EPUB sivut Java"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma EPUB-tiedostosta Java:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista EPUB sivut Java"
description: "Poista EPUB sivut, joissa on muutama rivi Java-koodia."
...
steps:
    enable: true
    title_left: "Poista EPUB tiedostosivut tuotteesta Java"
    content_left: |
        [GroupDocs.Merger for Java](/fi/merger/java/) tekee Java-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja EPUB tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa EPUB tiedostosivua käyttämällä Java esimerkkikoodia">}}

        ```java    
        // Poista EPUB tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista EPUB sivua verkosta"
    content: |
       Poista EPUB tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub) -sivustolla.
