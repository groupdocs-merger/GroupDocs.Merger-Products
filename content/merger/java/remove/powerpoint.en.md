...
############################# Head ############################
head_title: "Delete POWERPOINT pages in Java apps"
head_description: "Use GroupDocs.Merger for Java to remove specific pages from POWERPOINT documents. Easily process PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Delete pages in POWERPOINT" 
description: "GroupDocs.Merger for Java enhances Java apps with powerful document processing features, including page removal in POWERPOINT files."
...
steps:
    enable: true
    title: "How to delete pages in POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/java/) allows you to easily remove pages from POWERPOINT documents. Enhance your Java applications with advanced document management capabilities.
      
      1. Specify the POWERPOINT file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "How to delete all even pages"
      content: |
        Learn how to remove even-numbered pages from a POWERPOINT document.
      code:
        title: "Java"
        content: |
          ```java {style=abap}
