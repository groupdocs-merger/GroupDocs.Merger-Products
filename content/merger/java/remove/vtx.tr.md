...
############################# Head ############################
head_title: "Java İçindeki VTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek Java içindeki bir VTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "Java İçindeki VTX Sayfayı Kaldır"
description: "Birkaç satır Java kodu içeren VTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: "Java içindeki VTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for Java](/tr/merger/java/), Java geliştiricilerinin bir VTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="Java örnek kodunu kullanarak VTX dosya sayfaları nasıl kaldırılır">}}

        ```java    
        // GroupDocs.Merger API kullanarak VTX dosya sayfalarını kaldırın
...
demos:
    enable: true
    title: "Canlı Demolar - Çevrimiçi VTX Sayfayı Kaldırın"
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vtx) web sitesini ziyaret ederek VTX dosya sayfalarını hemen kaldırın.
