...
############################# Head ############################
head_title: "Noņemt XLTX lapas programmā Java"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLTX faila programmā Java, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLTX lapas programmā Java"
description: "Noņemiet XLTX lapas ar dažām Java koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLTX faila lapas no Java"
    content_left: |
        [GroupDocs.Merger for Java](/lv/merger/java/) ļauj Java izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLTX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLTX faila lapas, izmantojot Java piemēra kodu">}}

        ```java    
        // Noņemiet XLTX faila lapas, izmantojot GroupDocs.Merger API
...
demos:
    enable: true
    title: "Tiešraides demonstrācijas — noņemiet XLTX lapas tiešsaistē"
    content: |
       Noņemiet XLTX faila lapas tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltx).
