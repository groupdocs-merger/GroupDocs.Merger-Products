...
############################# Head ############################
head_title: "Delete Pages from ODT File in Java"
head_description: "Remove or delete a single page or collection of pages from a ODT file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From ODT in Java"
description: "Delete or Remove a single page or collection of specific pages from a ODT file using documents merger API for Java & J2SE applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a ODT file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within ODT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odt) website.
