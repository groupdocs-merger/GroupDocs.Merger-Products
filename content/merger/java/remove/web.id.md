...
############################# Head ############################
head_title: "Hapus WEB Halaman di Java"
...
############################# Header ############################
title: "Hapus WEB Halaman Di Java"
description: "Hapus WEB Halaman dengan beberapa baris kode Java."
...
steps:
    enable: true
    title_left: "Hapus WEB Halaman File di Java"
    content_left: |
        [GroupDocs.Merger for Java](/id/merger/java/) memudahkan pengembang Java untuk menghapus satu atau beberapa halaman tertentu dalam WEB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file WEB menggunakan kode contoh Java">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus WEB Laman Daring"
    content: |
       Hapus halaman file WEB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/web).
