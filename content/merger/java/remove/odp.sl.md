...
############################# Head ############################
head_title: "Odstrani strani ODP v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ODP v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ODP strani v Java"
description: "Odstranite strani ODP z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ODP v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj ODP datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ODP s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke ODP z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani ODP na spletu"
    content: |
       Takoj odstranite strani datoteke ODP tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/odp).
