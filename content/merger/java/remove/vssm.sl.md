...
############################# Head ############################
head_title: "Odstrani strani VSSM v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSSM v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSSM strani v Java"
description: "Odstranite strani VSSM z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSSM v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj VSSM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSSM s primerom kode Java">}}

        ```java    
        // Odstranite strani datoteke VSSM z API-jem GroupDocs.Merger
...
demos:
    enable: true
    title: "Predstavitve v živo - Odstranite strani VSSM na spletu"
    content: |
       Takoj odstranite strani datoteke VSSM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vssm).
