...
############################# Head ############################
head_title: "Odebrat MHT stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru MHT v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat MHT stránky v Java"
description: "Odstraňte MHT stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat MHT stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci MHT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru MHT pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru MHT pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte MHT stránek online"
    content: |
       Odstraňte stránky souborů MHT hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mht).
