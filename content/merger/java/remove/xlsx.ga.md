...
############################# Head ############################
head_title: "Bain XLSX Leathanaigh in Java"
head_description: "Bain nó scrios leathanach amháin nó bailiúchán leathanaigh ó chomhad XLSX in Java trí ordú na leathanach a aisiompú ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Bain XLSX Leathanaigh in Java"
description: "Bain XLSX Leathanaigh le cúpla líne de chód Java."
...
steps:
    enable: true
    title_left: "Bain XLSX Leathanaigh Chomhad in Java"
    content_left: |
        Déanann [GroupDocs.Merger for Java](/ga/merger/java/) é éasca d'fhorbróirí Java leathanach amháin nó roinnt leathanach ar leith a scriosadh laistigh de XLSX comhad trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XLSX a bhaint ag úsáid cód samplach Java">}}

        ```java    
        // Bain leathanaigh comhad XLSX ag baint úsáide as GroupDocs.Merger API
...
demos:
    enable: true
    title: "Taispeántais Bheo - Bain XLSX Leathanaigh Ar Líne"
    content: |
       Bain XLSX leathanaigh comhaid faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx) láithreán gréasáin.
