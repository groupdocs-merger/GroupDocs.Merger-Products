...
############################# Head ############################
head_title: "Odstrani strani PPT v Java"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPT v Java tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPT strani v Java"
description: "Odstranite strani PPT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPT v Java"
    content_left: |
        [GroupDocs.Merger for Java](/sl/merger/java/) razvijalcem Java olajša brisanje ene ali več določenih strani znotraj PPT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPT s primerom kode Java">}}
