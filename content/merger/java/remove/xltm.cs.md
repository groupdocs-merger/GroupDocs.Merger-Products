...
############################# Head ############################
head_title: "Odebrat XLTM stránky v Java"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru XLTM v Java obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat XLTM stránky v Java"
description: "Odstraňte XLTM stránky pomocí několika řádků kódu Java."
...
steps:
    enable: true
    title_left: "Odebrat XLTM stránky souboru v Java"
    content_left: |
        [GroupDocs.Merger for Java](/cs/merger/java/) usnadňuje vývojářům Java smazat jednu nebo několik konkrétních stránek v rámci XLTM soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru XLTM pomocí ukázkového kódu Java">}}

        ```java    
        // Odstraňte stránky souboru XLTM pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – Odeberte XLTM stránek online"
    content: |
       Odstraňte stránky souborů XLTM hned teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xltm).
