...
############################# Head ############################
head_title: "Spoji datoteke TXT prek API-ja za združevanje dokumentov Java & J2SE"
head_description: "Spojite več datotek TXT v Javi z uporabo API-ja za združevanje dokumentov z vsemi podatki, slogom in oblikovanjem kot izvornimi dokumenti."

############################# Header ############################
title: "TXT Združitev v Java"
description: "Spojite TXT z nekaj vrsticami kode Java."
...
steps:
    enable: true
    title_left: "Spoji več datotek TXT v Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TXT s primerom kode Java">}}
        ...
        ```java    
        // Spojite datoteke TXT z API-jem GroupDocs.Merger for Java
