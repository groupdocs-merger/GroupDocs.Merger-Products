...
############################# Head ############################
head_title: "Egyesítse az VSTX fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSTX fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSTX Egyesülés a Java programban"
description: "Egyesítse a(z) VSTX terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSTX fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSTX fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSTX fájlokat a GroupDocs.Merger for Java API segítségével
