...
############################# Head ############################
head_title: "Обединете OTT файлове чрез Java & J2SE Documents Merger API"
head_description: "Обединете множество OTT файлове в Java, като използвате API за сливане на документи с всички данни, стил и форматиране като изходни документи."

############################# Header ############################
title: "OTT Обединяване в Java"
description: "Обединете OTT с няколко реда от кода на Java."
...
steps:
    enable: true
    title_left: "Обединяване на множество OTT файла в Java"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините OTT файлове с Java примерен код">}}

        ```java    
        // Обединете OTT файлове с помощта на GroupDocs.Merger за Java API
