...
############################# Head ############################
head_title: "Egyesítse az VSTM fájlokat a Java & J2SE Documents Merger API segítségével"
head_description: "Egyesítsen több VSTM fájlt Java-ban a Dokumentumok-egyesítés API-val, minden adattal, stílussal és formázással forrásdokumentumként."

############################# Header ############################
title: "VSTM Egyesülés a Java programban"
description: "Egyesítse a(z) VSTM terméket néhány soros Java kóddal."
...
steps:
    enable: true
    title_left: "Több VSTM fájl egyesítése a következőben: Java"
    content_left: |
        A [GroupDocs.Merger for Java](/hu/merger/java/) néhány egyszerű lépés végrehajtásával megkönnyíti a Java fejlesztők számára több VSTM fájl egyesítését.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM fájlok egyesítése a Java példakóddal">}}

        ```java    
        // Egyesítsen VSTM fájlokat a GroupDocs.Merger for Java API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSTM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) webhely meglátogatásával.
