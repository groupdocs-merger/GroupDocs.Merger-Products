...
############################# Head ############################
head_title: "Ühendage PPT failid Java & J2SE Documents Merger API kaudu"
head_description: "Ühendage Java-s mitu PPT-faili, kasutades dokumentide liitmise API-t koos kõigi andmete, stiili ja vorminguga lähtedokumentidena."

############################# Header ############################
title: "PPT ühinemine programmis Java"
description: "Ühendage PPT mõne rea koodiga Java."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PPT faili, kasutades Java näitekoodi">}}
