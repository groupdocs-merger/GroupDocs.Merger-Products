...
head_description: "Sujunkite kelis PPSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "PPSX Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną PPSX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) svetainėje.
