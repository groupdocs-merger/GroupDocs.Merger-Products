...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa DOCM File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu DOCM file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
