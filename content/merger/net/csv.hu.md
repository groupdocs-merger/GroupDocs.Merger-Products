...
############################# Head ############################
head_title: "CSV fájlok egyesítése a C#-ban | CSV Egyesülés"
head_description: "Egyesítsen több CSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "CSV Egyesülés a C# programban"
description: "Egyesítse a(z) CSV terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több CSV fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több CSV fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="CSV fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen CSV fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több CSV fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) webhely meglátogatásával.
