...
############################# Head ############################
head_title: "Mesclar OTP Arquivos em C# | OTP Fusão"
head_description: "Mescle vários arquivos OTP em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "OTP Fusão em C#"
description: "Mescle OTP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos OTP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos OTP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos OTP usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar OTP arquivos usando a API GroupDocs.Merger
