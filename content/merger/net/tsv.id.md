...
############################# Head ############################
head_title: "Gabungkan TSV File di C# | TSV Penggabungan"
head_description: "Gabungkan beberapa file TSV menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "TSV Penggabungan Dalam C#"
description: "Gabungkan TSV dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa TSV File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file TSV dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file TSV menggunakan kode contoh C#">}}
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu TSV file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
