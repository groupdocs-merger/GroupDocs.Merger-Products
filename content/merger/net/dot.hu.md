...
############################# Head ############################
head_title: "DOT fájlok egyesítése a C#-ban | DOT Egyesülés"
head_description: "Egyesítsen több DOT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOT Egyesülés a C# programban"
description: "Egyesítse a(z) DOT terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOT fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOT fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOT fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több DOT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) webhely meglátogatásával.
