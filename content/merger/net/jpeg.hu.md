...
############################# Head ############################
head_title: "JPEG fájlok egyesítése a C#-ban | JPEG Egyesülés"
head_description: "Egyesítsen több JPEG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "JPEG Egyesülés a C# programban"
description: "Egyesítse a(z) JPEG terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több JPEG fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több JPEG fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPEG fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen JPEG fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több JPEG fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) webhely meglátogatásával.
