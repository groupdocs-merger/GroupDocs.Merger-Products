...
############################# Head ############################
head_title: "Slå sammen PPSX-filer i C# | PPSX Fusjon"
...
############################# Header ############################
title: "PPSX sammenslåing i C#"
description: "Slå sammen PPSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere PPSX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen PPSX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én PPSX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
