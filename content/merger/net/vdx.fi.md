...
############################# Head ############################
head_title: "Yhdistä VDX tiedostot C# | VDX Sulautuminen"
...
############################# Header ############################
title: "VDX Sulautuminen C#"
description: "Yhdistä VDX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VDX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VDX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VDX tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VDX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) -sivustolla.
