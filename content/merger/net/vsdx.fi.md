...
############################# Head ############################
head_title: "Yhdistä VSDX tiedostot C# | VSDX Sulautuminen"
...
############################# Header ############################
title: "VSDX Sulautuminen C#"
description: "Yhdistä VSDX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VSDX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSDX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VSDX tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VSDX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) -sivustolla.
