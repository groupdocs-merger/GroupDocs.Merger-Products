...
############################# Header ############################
title: "XLAM Sulautuminen C#"
description: "Yhdistä XLAM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLAM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
