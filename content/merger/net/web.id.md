...
############################# Head ############################
head_title: "Gabungkan WEB File di C# | WEB Penggabungan"
head_description: "Gabungkan beberapa file WEB menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "WEB Penggabungan Dalam C#"
description: "Gabungkan WEB dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu WEB file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/web).
