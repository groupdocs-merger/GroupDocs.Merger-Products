...
############################# Head ############################
head_title: "Voeg XLSB bestanden samen in C# | XLSB Fusie"
head_description: "Voeg meerdere XLSB bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "XLSB Fusie in C#"
description: "Voeg XLSB samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLSB bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLSB-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSB bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg XLSB bestanden samen met de GroupDocs.Merger API
