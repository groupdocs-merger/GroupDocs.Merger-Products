...
############################# Head ############################
head_title: "Mescle arquivos ZIP via .NET"
head_description: "Integre a mesclagem de documentos ZIP em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos ZIP" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos ZIP de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos ZIP. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Inicialize Merger com o documento ZIP de origem
