...
############################# Head ############################
head_title: "PPS-Dateien in C# zusammenführen | PPS Fusion"
head_description: "Führen Sie mehrere PPS-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "PPS Fusion in C#"
description: "Führen Sie PPS mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere PPS-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr PPS-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie PPS-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie PPS-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument PPS instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine PPS-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) besuchen.
