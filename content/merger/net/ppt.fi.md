...
############################# Head ############################
head_title: "Yhdistä PPT tiedostot C# | PPT Sulautuminen"
...
############################# Header ############################
title: "PPT Sulautuminen C#"
description: "Yhdistä PPT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia PPT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä PPT tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PPT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) -sivustolla.
