...
############################# Head ############################
head_title: "Συγχώνευση αρχείων EPUB στο C# | EPUB Συγχώνευση"
head_description: "Συγχωνεύστε πολλά αρχεία EPUB σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συγχώνευση συγκεκριμένων σελίδων ή περιοχών σελίδων από διάφορα έγγραφα σε ένα μόνο έγγραφο."

############################# Header ############################
title: "EPUB Συγχώνευση στο C#"
description: "Συγχώνευση EPUB με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συγχωνεύσετε πολλά αρχεία EPUB"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να συγχωνεύσουν δύο ή περισσότερα αρχεία EPUB στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία EPUB χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Συγχώνευση αρχείων EPUB χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    ...
    content: |
       Συγχωνεύστε περισσότερα από ένα EPUB αρχεία αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
