...
############################# Head ############################
head_title: "EPUB fájlok egyesítése a C#-ban | EPUB Egyesülés"
head_description: "Egyesítsen több EPUB fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "EPUB Egyesülés a C# programban"
description: "Egyesítse a(z) EPUB terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több EPUB fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több EPUB fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen EPUB fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több EPUB fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) webhely meglátogatásával.
