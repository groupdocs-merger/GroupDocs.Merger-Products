...
############################# Head ############################
head_title: "HTML-Dateien in C# zusammenführen | HTML Fusion"
head_description: "Führen Sie mehrere HTML-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "HTML Fusion in C#"
description: "Führen Sie HTML mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere HTML-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr HTML-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie HTML-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie HTML-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument HTML instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine HTML-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) besuchen.
