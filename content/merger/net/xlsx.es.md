...
############################# Head ############################
head_title: "Combina archivos XLSX a través de .NET"
head_description: "Integra la fusión de documentos XLSX en tus proyectos de .NET con GroupDocs.Merger for .NET."

############################# Header ############################
title: "Combina archivos XLSX" 
description: "Utiliza GroupDocs.Merger for .NET para crear potentes aplicaciones .NET que fusionen y gestionen documentos XLSX sin problemas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita la fusión de documentos XLSX. Agrega la funcionalidad de fusión a tus aplicaciones .NET y combina múltiples archivos sin esfuerzo.
      
      1. Define la ruta al primer archivo XLSX.
