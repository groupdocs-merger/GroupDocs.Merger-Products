...
############################# Head ############################
head_title: "Combina fitxers XLTX a C# | XLTX Fusió"
head_description: "Combina diversos fitxers XLTX en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Combina pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "XLTX Fusió a C#"
description: "Combina XLTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com combinar diversos fitxers XLTX"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET fusionin dos o més fitxers XLTX dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLTX mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Combineu fitxers XLTX mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combina més d'un fitxer XLTX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
