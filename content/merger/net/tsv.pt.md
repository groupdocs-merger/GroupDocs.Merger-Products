...
############################# Head ############################
head_title: "Mesclar TSV Arquivos em C# | TSV Fusão"
head_description: "Mescle vários arquivos TSV em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "TSV Fusão em C#"
description: "Mescle TSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos TSV"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos TSV em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos TSV usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar TSV arquivos usando a API GroupDocs.Merger
