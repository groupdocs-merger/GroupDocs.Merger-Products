...
head_description: "Sujunkite kelis PNG failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "PNG Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną PNG failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) svetainėje.
