...
############################# Head ############################
head_title: "Gabungkan file BMP melalui .NET"
head_description: "Integrasikan penggabungan dokumen BMP ke dalam proyek .NET Anda dengan GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gabungkan file BMP" 
description: "Gunakan GroupDocs.Merger for .NET untuk membuat aplikasi .NET yang kuat yang mampu menggabungkan dan mengelola dokumen BMP tanpa kendala."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan penggabungan dokumen BMP. Tambahkan fungsionalitas penggabungan ke aplikasi .NET Anda dan gabungkan beberapa file dengan mulus.
      
      1. Tentukan jalur ke file BMP yang pertama.
