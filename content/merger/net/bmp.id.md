...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa BMP File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu BMP file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
