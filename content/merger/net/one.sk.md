...
############################# Head ############################
head_title: "Zlúčiť ONE súbory v C# | ONE Zlúčenie"
head_description: "Zlúčte viacero súborov ONE do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Zlúčiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "ONE Zlúčenie v C#"
description: "Zlúčte ONE s niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Ako zlúčiť viacero súborov ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET zlúčiť dva alebo viac súborov ONE v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory ONE pomocou vzorového kódu C#">}}

        ```csharp    
        // Zlúčiť ONE súbory pomocou GroupDocs.Merger API
...
demos:
    ...
    content: |
       Zlúčte hneď teraz viac ako jeden súbor ONE na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
