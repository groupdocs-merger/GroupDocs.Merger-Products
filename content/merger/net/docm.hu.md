...
############################# Head ############################
head_title: "DOCM fájlok egyesítése a C#-ban | DOCM Egyesülés"
head_description: "Egyesítsen több DOCM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOCM Egyesülés a C# programban"
description: "Egyesítse a(z) DOCM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOCM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOCM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOCM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több DOCM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) webhely meglátogatásával.
