...
############################# Head ############################
head_title: "Mesclar PDF Arquivos em C# | PDF Fusão"
head_description: "Mescle vários arquivos PDF em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "PDF Fusão em C#"
description: "Mescle PDF com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos PDF"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos PDF em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos PDF usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar PDF arquivos usando a API GroupDocs.Merger
