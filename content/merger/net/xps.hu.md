...
############################# Head ############################
head_title: "XPS fájlok egyesítése a C#-ban | XPS Egyesülés"
head_description: "Egyesítsen több XPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XPS Egyesülés a C# programban"
description: "Egyesítse a(z) XPS terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XPS fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XPS fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XPS fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XPS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) webhely meglátogatásával.
