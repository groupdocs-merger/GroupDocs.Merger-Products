...
############################# Head ############################
head_title: "Yhdistä ONE tiedostot C# | ONE Sulautuminen"
...
############################# Header ############################
title: "ONE Sulautuminen C#"
description: "Yhdistä ONE muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia ONE tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ONE tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä ONE tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi ONE-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) -sivustolla.
