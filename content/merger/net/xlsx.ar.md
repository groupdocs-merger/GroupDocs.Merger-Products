...
############################# Head ############################
head_title: "دمج ملفات XLSX في C# | XLSX الاندماج"
head_description: "دمج عدة ملفات XLSX في ملف واحد باستخدام C# .NET لدمج المستندات API. دمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "XLSX الاندماج في C#"
description: "دمج XLSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات XLSX"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من XLSX داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات XLSX باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات XLSX باستخدام GroupDocs.Merger API
...
demos:
    ...
    content: |
       ادمج أكثر من XLSX ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
