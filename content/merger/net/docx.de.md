...
############################# Head ############################
head_title: "DOCX-Dateien in C# zusammenführen | DOCX Fusion"
head_description: "Führen Sie mehrere DOCX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "DOCX Fusion in C#"
description: "Führen Sie DOCX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere DOCX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr DOCX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie DOCX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie DOCX-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument DOCX instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine DOCX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) besuchen.
