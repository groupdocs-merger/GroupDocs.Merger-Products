...
############################# Head ############################
head_title: "Flet VSSX filer i C# | VSSX Fusion"
head_description: "Flet flere VSSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VSSX fusion i C#"
description: "Flet VSSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VSSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VSSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VSSX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VSSX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
