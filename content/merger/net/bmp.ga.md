...
############################# Head ############################
head_title: "Cumaisc BMP Comhaid i C# | BMP Cumasc"
head_description: "Cumaisc comhaid BMP iolracha isteach i gcomhad amháin trí úsáid a bhaint as C# .NET doiciméad cumaisc API. Cumaisc leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "BMP Cumasc i C#"
description: "Cumaisc BMP le cúpla líne de chód .NET."
...
about:
    ...
    content: |
        Soláthraíonn [GroupDocs.Merger for .NET](/ga/merger/net/) réiteach áisiúil chun go leor PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, íomhánna agus go leor doiciméad eile isteach i gcomhad amháin laistigh d'fheidhmchláir .NET. Sábhálfaidh GroupDocs.Merger go leor iarrachta duit, mar tá cead agat doiciméid BMP a chumasc - ní gá aon bhogearraí tríú páirtí, feidhmchláir deisce nó forlíontáin a shuiteáil. Anois ní gá do chuid ama a chur amú agus comhaid a chumasc de láimh! Is é misean GroupDocs an cháilíocht is fearr a sholáthar agus sreafaí oibre próiseála doiciméad a shimpliú.
...
steps:
    enable: true
    title_left: "Conas Ilchomhad BMP a chumasc"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá chomhad BMP nó níos mó a chumasc laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas BMP comhad a chumasc le cód samplach C#">}}

        ```csharp    
        // Cumaisc BMP comhad le GroupDocs.Merger API
...
demos:
    ...
    content: |
       Cumaisc níos mó ná comhad BMP amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) láithreán gréasáin.
