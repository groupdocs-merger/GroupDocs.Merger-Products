...
############################# Head ############################
head_title: "Flet PPSX filer i C# | PPSX Fusion"
head_description: "Flet flere PPSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "PPSX fusion i C#"
description: "Flet PPSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere PPSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere PPSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes PPSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet PPSX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én PPSX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
