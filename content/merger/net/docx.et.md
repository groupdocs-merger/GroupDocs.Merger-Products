...
############################# Head ############################
head_title: "Ühendage DOCX failid C# | DOCX Ühinemine"
head_description: "Ühendage mitu DOCX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "DOCX ühinemine programmis C#"
description: "Ühendage DOCX mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam DOCX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOCX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid DOCX, kasutades GroupDocs.Merger API-t
