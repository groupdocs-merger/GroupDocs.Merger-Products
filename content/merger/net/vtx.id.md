...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VTX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VTX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
