...
############################# Head ############################
head_title: "Slå sammen TXT-filer i C# | TXT Fusjon"
...
############################# Header ############################
title: "TXT sammenslåing i C#"
description: "Slå sammen TXT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere TXT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TXT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen TXT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én TXT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
