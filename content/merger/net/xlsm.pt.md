...
############################# Head ############################
head_title: "Mesclar XLSM Arquivos em C# | XLSM Fusão"
head_description: "Mescle vários arquivos XLSM em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLSM Fusão em C#"
description: "Mescle XLSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLSM usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLSM arquivos usando a API GroupDocs.Merger
