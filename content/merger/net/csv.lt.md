...
head_description: "Sujunkite kelis CSV failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "CSV Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną CSV failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) svetainėje.
