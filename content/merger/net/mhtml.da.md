...
############################# Head ############################
head_title: "Flet MHTML filer i C# | MHTML Fusion"
head_description: "Flet flere MHTML filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "MHTML fusion i C#"
description: "Flet MHTML med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere MHTML-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere MHTML-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes MHTML filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet MHTML filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én MHTML-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
