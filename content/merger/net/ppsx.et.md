...
############################# Head ############################
head_title: "Ühendage PPSX failid C# | PPSX Ühinemine"
head_description: "Ühendage mitu PPSX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "PPSX ühinemine programmis C#"
description: "Ühendage PPSX mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam PPSX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PPSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid PPSX, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks PPSX faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
