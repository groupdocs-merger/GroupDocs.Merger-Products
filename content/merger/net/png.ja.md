...
head_title: "PNGファイルをC＃でマージする| PNG合併"
head_description: "C＃/。NETマージAPIを使用して、複数のPNGファイルを1つのファイルにマージします。特定のページまたはページ範囲をさまざまなドキュメントから単一のドキュメントにマージします."

title: "PNGファイルをC＃でマージする"
description: "C＃マージAPIを使用して、複数のPNGファイルを1つのファイルにマージします。選択したページまたはページ範囲をさまざまなソースドキュメントから単一の結果ドキュメントにマージします."
...
steps:
    ...
    code: |
        ```cs
        //GroupDocs.MergerAPIを使用してPNGファイルをマージします
