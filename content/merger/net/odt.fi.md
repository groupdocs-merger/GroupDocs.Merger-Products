...
############################# Head ############################
head_title: "Yhdistä ODT tiedostot C# | ODT Sulautuminen"
...
############################# Header ############################
title: "ODT Sulautuminen C#"
description: "Yhdistä ODT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia ODT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ODT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä ODT tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi ODT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) -sivustolla.
