...
############################# Head ############################
head_title: "Spoji DOCX datoteke u C# | DOCX Spajanje"
head_description: "Spojite više DOCX datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "DOCX Spajanje u C#"
description: "Spoji DOCX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Spoji DOCX datoteke pomoću API-ja GroupDocs.Merger
