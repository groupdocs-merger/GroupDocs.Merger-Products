...
############################# Head ############################
head_title: "Ühendage XPS failid C# | XPS Ühinemine"
head_description: "Ühendage mitu XPS faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "XPS ühinemine programmis C#"
description: "Ühendage XPS mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam XPS faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XPS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid XPS, kasutades GroupDocs.Merger API-t
