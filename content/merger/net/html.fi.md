...
############################# Head ############################
head_title: "Yhdistä HTML tiedostot C# | HTML Sulautuminen"
...
############################# Header ############################
title: "HTML Sulautuminen C#"
description: "Yhdistä HTML muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia HTML tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää HTML tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä HTML tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi HTML-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) -sivustolla.
