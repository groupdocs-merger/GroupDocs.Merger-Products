...
############################# Header ############################
title: "XLTM Sulautuminen C#"
description: "Yhdistä XLTM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLTM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
