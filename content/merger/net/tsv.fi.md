...
############################# Head ############################
head_title: "Yhdistä TSV tiedostot C# | TSV Sulautuminen"
...
############################# Header ############################
title: "TSV Sulautuminen C#"
description: "Yhdistä TSV muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia TSV tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää TSV tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä TSV tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi TSV-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) -sivustolla.
