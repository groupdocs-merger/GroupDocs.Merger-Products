...
############################# Head ############################
head_title: "Slå samman TSV-filer i C# | TSV Sammanslagning"
head_description: "Slå samman flera TSV-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "TSV sammanslagning i C#"
description: "Slå samman TSV med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera TSV-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera TSV-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar TSV filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga TSV filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå samman mer än en TSV-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
