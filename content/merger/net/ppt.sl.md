...
############################# Head ############################
head_title: "Spoji datoteke PPT v C# | PPT Združitev"
head_description: "Spojite več datotek PPT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "PPT Združitev v C#"
description: "Spojite PPT z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek PPT znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPT s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke PPT z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Združite več kot eno datoteko PPT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
