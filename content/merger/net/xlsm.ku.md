...
############################# Head ############################
head_title: "Pelên XLSM di C# de bike yek | XLSM Hevgirtin"
head_description: "Gelek pelên XLSM di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "XLSM Yekbûn di C#"
description: "XLSM bi çend rêzikên koda .NET re bibin yek."
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek XLSM Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir XLSM pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên XLSM bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên XLSM bi karanîna GroupDocs.Merger API-ê bikin yek
