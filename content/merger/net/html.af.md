...
############################# Head ############################
head_title: "Voeg HTML lêers saam in C# | HTML samesmelting"
head_description: "Voeg veelvuldige HTML lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "HTML samesmelting in C#"
description: "Voeg HTML saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige HTML-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer HTML-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om HTML lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg HTML lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een HTML-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) webwerf te besoek.
