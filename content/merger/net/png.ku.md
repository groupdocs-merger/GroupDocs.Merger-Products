...
############################# Head ############################
head_title: "Pelên PNG di C# de bike yek | PNG Hevgirtin"
head_description: "Gelek pelên PNG di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "PNG Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek PNG Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir PNG pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên PNG bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên PNG bi karanîna GroupDocs.Merger API-ê bikin yek
