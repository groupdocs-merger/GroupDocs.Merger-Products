...
############################# Head ############################
head_title: "Slå sammen XPS-filer i C# | XPS Fusjon"
...
############################# Header ############################
title: "XPS sammenslåing i C#"
description: "Slå sammen XPS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XPS-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XPS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XPS filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XPS-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
