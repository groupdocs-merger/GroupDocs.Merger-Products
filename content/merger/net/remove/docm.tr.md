...
############################# Head ############################
head_title: "C# İçindeki DOCM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir DOCM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki DOCM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren DOCM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki DOCM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir DOCM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCM dosya sayfaları nasıl kaldırılır">}}
