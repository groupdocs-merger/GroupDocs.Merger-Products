...
############################# Head ############################
head_title: "Noņemt VSTM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no VSTM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt VSTM lapas programmā C#"
description: "Noņemiet VSTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt VSTM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas VSTM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt VSTM faila lapas, izmantojot C# piemēra kodu">}}
