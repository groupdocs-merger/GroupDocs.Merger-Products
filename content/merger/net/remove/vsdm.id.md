...
############################# Head ############################
head_title: "Hapus VSDM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSDM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSDM Halaman Di C#"
description: "Hapus VSDM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus VSDM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam VSDM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSDM menggunakan kode contoh C#">}}
