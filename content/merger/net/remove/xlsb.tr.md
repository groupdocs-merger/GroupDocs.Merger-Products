...
############################# Head ############################
head_title: "C# İçindeki XLSB Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLSB dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLSB Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLSB Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLSB Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLSB içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosya sayfaları nasıl kaldırılır">}}
