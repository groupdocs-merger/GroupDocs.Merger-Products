...
############################# Head ############################
head_title: "Remove XPS pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to delete specific pages from XPS documents. Easily manage PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages in XPS" 
description: "GroupDocs.Merger for .NET enhances .NET apps with powerful document processing capabilities, including removing pages from XPS files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily delete pages from XPS files. Add document management functionality to your .NET applications effortlessly.
