...
############################# Head ############################
head_title: "Remove PPS Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a PPS file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove PPS Pages In C#"
description: "Remove PPS Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a PPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove PPS file pages using C# example code">}}
