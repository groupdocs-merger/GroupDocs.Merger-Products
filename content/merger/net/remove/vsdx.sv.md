...
############################# Head ############################
head_title: "Ta bort VSDX sidor i C#"
head_description: "Ta bort eller ta bort en enskild sida eller samling av sidor från en VSDX-fil i C# genom att vända sidordningen med hjälp av dokumentsammanslagnings-API:et."

############################# Header ############################
title: "Ta bort VSDX sidor i C#"
description: "Ta bort VSDX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Ta bort VSDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att ta bort en enstaka eller ett antal särskilda sidor inom en VSDX fil genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man tar bort VSDX filsidor med hjälp av C# exempelkod">}}
