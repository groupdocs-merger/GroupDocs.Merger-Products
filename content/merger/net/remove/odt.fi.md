...
############################# Head ############################
head_title: "Poista ODT sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ODT-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ODT sivut C#"
description: "Poista ODT sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista ODT tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ODT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ODT tiedostosivua käyttämällä C# esimerkkikoodia">}}
