...
############################# Head ############################
head_title: "Poista PPT sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma PPT-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista PPT sivut C#"
description: "Poista PPT sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista PPT tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja PPT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa PPT tiedostosivua käyttämällä C# esimerkkikoodia">}}
