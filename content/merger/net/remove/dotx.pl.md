...
############################# Head ############################
head_title: "Usuń DOTX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOTX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOTX strony w C#"
description: "Usuń strony DOTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w DOTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOTX za pomocą przykładowego kodu C#">}}
