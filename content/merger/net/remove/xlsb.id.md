...
head_title: "Hapus Halaman XLSB di C# .NET | Hapus Halaman dari XLSB File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file XLSB menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari XLSB di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file XLSB menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File XLSB di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file XLSB dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLSB Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file XLSB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/XLSB).
