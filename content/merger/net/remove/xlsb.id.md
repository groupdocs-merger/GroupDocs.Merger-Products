...
############################# Head ############################
head_title: "Hapus XLSB Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLSB di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLSB Halaman Di C#"
description: "Hapus XLSB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLSB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLSB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLSB menggunakan kode contoh C#">}}
