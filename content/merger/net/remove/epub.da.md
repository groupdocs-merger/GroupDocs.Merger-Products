...
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en EPUB-fil i C# ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern EPUB sider i C#"
description: "Fjern EPUB sider med et par linjer med .NET-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at slette en enkelt eller et antal bestemte sider inden for en EPUB fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du EPUB filsider ved hjælp af C# eksempelkode">}}
