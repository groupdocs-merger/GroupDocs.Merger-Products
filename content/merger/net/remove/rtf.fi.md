...
############################# Head ############################
head_title: "Poista RTF sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma RTF-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista RTF sivut C#"
description: "Poista RTF sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista RTF tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja RTF tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa RTF tiedostosivua käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Poista RTF tiedostosivut GroupDocs.Merger API:lla
...
demos:
    enable: true
    title: "Live-esittelyt – poista RTF sivua verkosta"
    content: |
       Poista RTF tiedostosivut heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/rtf) -sivustolla.
