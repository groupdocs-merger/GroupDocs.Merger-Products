...
############################# Head ############################
head_title: "Poista DOCX sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOCX-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOCX sivut C#"
description: "Poista DOCX sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista DOCX tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOCX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOCX tiedostosivua käyttämällä C# esimerkkikoodia">}}
