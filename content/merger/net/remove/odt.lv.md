...
############################# Head ############################
head_title: "Noņemt ODT lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no ODT faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt ODT lapas programmā C#"
description: "Noņemiet ODT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt ODT faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas ODT ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt ODT faila lapas, izmantojot C# piemēra kodu">}}
