...
############################# Head ############################
head_title: "Usuń TEX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku TEX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń TEX strony w C#"
description: "Usuń strony TEX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików TEX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w TEX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików TEX za pomocą przykładowego kodu C#">}}
