...
############################# Head ############################
head_title: "Odstrani strani HTML v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke HTML v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani HTML strani v C#"
description: "Odstranite strani HTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke HTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj HTML datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke HTML s primerom kode C#">}}
