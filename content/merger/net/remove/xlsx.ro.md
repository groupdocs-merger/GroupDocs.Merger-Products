...
############################# Head ############################
head_title: "Eliminați paginile XLSX din C#"
head_description: "Eliminați sau ștergeți o singură pagină sau o colecție de pagini dintr-un fișier XLSX din C# inversând ordinea paginilor utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Eliminați XLSX pagini din C#"
description: "Eliminați paginile XLSX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Eliminați paginile de fișiere XLSX din .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să șterge o singură pagină sau mai multe anumite pagini dintr-un XLSX fișier prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să eliminați pagini de fișiere XLSX folosind codul exemplu C#">}}
