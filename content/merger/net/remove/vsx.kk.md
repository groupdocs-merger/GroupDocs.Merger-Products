...
############################# Head ############################
head_title: "C# ішіндегі VSX беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы C# ішіндегі VSX файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "C# ішіндегі VSX беттерді жою"
description: ".NET кодының бірнеше жолы бар VSX беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі VSX файл бетін жою"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне VSX ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX файл бетін C# мысал кодын пайдаланып жою жолы">}}
