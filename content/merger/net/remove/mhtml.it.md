...
############################# Head ############################
head_title: "Remove MHTML Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a MHTML file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove MHTML Pages In C#"
description: "Remove MHTML Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a MHTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove MHTML file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove MHTML Pages Online"
    content: |
       Remove MHTML file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/mhtml) website.
