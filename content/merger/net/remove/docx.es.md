...
############################# Head ############################
head_title: "Eliminar DOCX páginas en C#"
head_description: "Quite o elimine una sola página o colección de páginas de un archivo DOCX en C# invirtiendo el orden de las páginas usando la API de combinación de documentos."

############################# Header ############################
title: "Eliminar DOCX páginas en C#"
description: "Elimina DOCX páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Eliminar DOCX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita que los desarrolladores de C# eliminen una o varias páginas en particular dentro de DOCX archivo mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo eliminar las páginas de archivos DOCX usando el código de ejemplo C#">}}
