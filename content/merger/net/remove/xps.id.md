...
############################# Head ############################
head_title: "Hapus XPS Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XPS di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XPS Halaman Di C#"
description: "Hapus XPS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XPS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XPS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XPS menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XPS Laman Daring"
    content: |
       Hapus halaman file XPS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/xps).
