...
head_title: "Hapus Halaman XPS di C# .NET | Hapus Halaman dari XPS File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file XPS menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari XPS di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file XPS menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File XPS di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file XPS dengan menerapkan beberapa langkah mudah.
