...
draft: false
############################# Head ############################
head_title: "Удаление страниц MHTML в C# .NET | Удалить страницы из файла MHTML"
head_description: "Пользователи C# .NET могут удалить или удалить одну страницу или набор страниц из файла MHTML с помощью API слияния и разделения документов."
############################# Header ############################
title: "Удалить или удалить страницы из MHTML в .NET"
description: "Удаление или удаление отдельной страницы или набора страниц из файла MHTML с помощью API слияния и разделения документов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Удалить страницы файлов MHTML в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко удалить одну или несколько страниц в файле MHTML, выполнив несколько простых шагов.
    ...
    code: |
        ```cs
        // Удаляем страницы файла MHTML с помощью API GroupDocs.Merger
...
demos:
    enable: true
    title: "Живые демонстрации - удаление страниц документа MHTML онлайн"
    content: |
        Удалите страницы в файлах MHTML прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/remove-pages/mhtml). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
