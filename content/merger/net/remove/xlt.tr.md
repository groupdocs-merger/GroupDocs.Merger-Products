...
############################# Head ############################
head_title: "C# İçindeki XLT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLT dosya sayfaları nasıl kaldırılır">}}
