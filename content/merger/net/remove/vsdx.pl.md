...
############################# Head ############################
head_title: "Usuń VSDX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSDX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSDX strony w C#"
description: "Usuń strony VSDX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSDX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSDX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSDX za pomocą przykładowego kodu C#">}}
