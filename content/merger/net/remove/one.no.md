...
############################# Head ############################
head_title: "Fjern ONE sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en ONE-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern ONE sider i C#"
description: "Fjern ONE-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en ONE fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne ONE filsider ved å bruke C# eksempelkode">}}
