...
############################# Head ############################
head_title: "Poista DOT sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOT-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOT sivut C#"
description: "Poista DOT sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista DOT tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOT tiedostosivua käyttämällä C# esimerkkikoodia">}}
