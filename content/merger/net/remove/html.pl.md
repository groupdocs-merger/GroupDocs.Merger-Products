...
############################# Head ############################
head_title: "Usuń HTML strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku HTML w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń HTML strony w C#"
description: "Usuń strony HTML z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików HTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w HTML plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików HTML za pomocą przykładowego kodu C#">}}
