...
############################# Head ############################
head_title: "Poista VSTX sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSTX-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSTX sivut C#"
description: "Poista VSTX sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista VSTX tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSTX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSTX tiedostosivua käyttämällä C# esimerkkikoodia">}}
