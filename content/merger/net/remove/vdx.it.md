...
############################# Head ############################
head_title: "Remove VDX Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a VDX file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove VDX Pages In C#"
description: "Remove VDX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a VDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove VDX file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove VDX Pages Online"
    content: |
       Remove VDX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vdx) website.
