...
############################# Head ############################
head_title: "Hapus ONE Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file ONE di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus ONE Halaman Di C#"
description: "Hapus ONE Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus ONE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam ONE file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ONE menggunakan kode contoh C#">}}
