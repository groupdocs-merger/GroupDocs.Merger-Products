...
############################# Head ############################
head_title: "Hapus DOTX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file DOTX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus DOTX Halaman Di C#"
description: "Hapus DOTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus DOTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam DOTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOTX menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus DOTX Laman Daring"
    content: |
       Hapus halaman file DOTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/dotx).
