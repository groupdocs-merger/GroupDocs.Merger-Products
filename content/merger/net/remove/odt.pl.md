...
############################# Head ############################
head_title: "Usuń ODT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku ODT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń ODT strony w C#"
description: "Usuń strony ODT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików ODT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w ODT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików ODT za pomocą przykładowego kodu C#">}}
