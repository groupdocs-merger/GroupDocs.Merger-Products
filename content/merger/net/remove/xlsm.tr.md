...
############################# Head ############################
head_title: "C# İçindeki XLSM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLSM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLSM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLSM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLSM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLSM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSM dosya sayfaları nasıl kaldırılır">}}
