...
############################# Head ############################
head_title: "Usuń PPS strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPS w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPS strony w C#"
description: "Usuń strony PPS z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w PPS plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPS za pomocą przykładowego kodu C#">}}
