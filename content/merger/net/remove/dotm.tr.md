...
############################# Head ############################
head_title: "C# İçindeki DOTM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir DOTM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki DOTM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren DOTM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki DOTM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir DOTM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosya sayfaları nasıl kaldırılır">}}
