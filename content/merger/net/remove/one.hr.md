...
############################# Head ############################
head_title: "Ukloni ONE stranice u C#"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz ONE datoteke u C# obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni ONE stranice u C#"
description: "Ukloni ONE stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ukloni ONE stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava brisanje jedne ili više određenih stranica unutar ONE datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti ONE stranice datoteke koristeći C# primjer koda">}}
