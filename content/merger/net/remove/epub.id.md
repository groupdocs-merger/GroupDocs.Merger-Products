...
############################# Head ############################
head_title: "Hapus EPUB Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file EPUB di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus EPUB Halaman Di C#"
description: "Hapus EPUB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus EPUB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam EPUB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file EPUB menggunakan kode contoh C#">}}
