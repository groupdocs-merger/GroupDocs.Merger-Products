...
head_title: "Hapus Halaman EPUB di C# .NET | Hapus Halaman dari EPUB File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file EPUB menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari EPUB di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file EPUB menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File EPUB di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file EPUB dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Hapus halaman file EPUB menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus EPUB Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file EPUB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/EPUB).
