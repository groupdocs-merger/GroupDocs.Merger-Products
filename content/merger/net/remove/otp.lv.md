...
############################# Head ############################
head_title: "Noņemt OTP lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no OTP faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt OTP lapas programmā C#"
description: "Noņemiet OTP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt OTP faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas OTP ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt OTP faila lapas, izmantojot C# piemēra kodu">}}
