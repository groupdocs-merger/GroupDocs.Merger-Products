...
############################# Head ############################
head_title: "Fjern VDX sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VDX-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VDX sider i C#"
description: "Fjern VDX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en VDX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VDX filsider ved å bruke C# eksempelkode">}}
