...
############################# Head ############################
head_title: "Odstrani strani OTP v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke OTP v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani OTP strani v C#"
description: "Odstranite strani OTP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke OTP v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj OTP datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke OTP s primerom kode C#">}}
