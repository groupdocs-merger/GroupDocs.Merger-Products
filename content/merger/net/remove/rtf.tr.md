...
############################# Head ############################
head_title: "C# İçindeki RTF Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir RTF dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki RTF Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren RTF Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki RTF Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir RTF içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosya sayfaları nasıl kaldırılır">}}
