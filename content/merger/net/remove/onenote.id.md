...
############################# Head ############################
head_title: "Hapus ONENOTE Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file ONENOTE di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus ONENOTE Halaman Di C#"
description: "Hapus ONENOTE Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus ONENOTE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam ONENOTE file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ONENOTE menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus ONENOTE Laman Daring"
    content: |
       Hapus halaman file ONENOTE sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/onenote).
