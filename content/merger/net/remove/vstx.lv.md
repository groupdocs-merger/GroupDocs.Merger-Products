...
############################# Head ############################
head_title: "Noņemt VSTX lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no VSTX faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt VSTX lapas programmā C#"
description: "Noņemiet VSTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt VSTX faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas VSTX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt VSTX faila lapas, izmantojot C# piemēra kodu">}}
