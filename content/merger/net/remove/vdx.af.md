...
############################# Head ############################
head_title: "Verwyder VDX bladsye in C#"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n VDX-lêer in C# deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder VDX bladsye in C#"
description: "Verwyder VDX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verwyder VDX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n VDX uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX lêerbladsye te verwyder deur C# voorbeeldkode te gebruik">}}
