...
############################# Head ############################
head_title: "Hapus PPSX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file PPSX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus PPSX Halaman Di C#"
description: "Hapus PPSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus PPSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam PPSX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file PPSX menggunakan kode contoh C#">}}
