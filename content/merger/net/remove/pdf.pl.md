...
############################# Head ############################
head_title: "Usuń PDF strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PDF w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PDF strony w C#"
description: "Usuń strony PDF z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików PDF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w PDF plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PDF za pomocą przykładowego kodu C#">}}
