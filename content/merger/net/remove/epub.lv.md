...
############################# Head ############################
head_title: "Noņemt EPUB lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no EPUB faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt EPUB lapas programmā C#"
description: "Noņemiet EPUB lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt EPUB faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas EPUB ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt EPUB faila lapas, izmantojot C# piemēra kodu">}}
