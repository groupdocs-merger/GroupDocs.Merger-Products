...
############################# Head ############################
head_title: "Verwijder DOCM pagina's in C#"
head_description: "Verwijder of verwijder een enkele pagina of verzameling pagina's uit een DOCM-bestand in C# door de paginavolgorde om te draaien met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verwijder DOCM pagina's in C#"
description: "Verwijder DOCM pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verwijder DOCM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om een ​​enkele of een aantal bepaalde pagina's binnen een DOCM te verwijderen bestand door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCM bestandspagina's te verwijderen met behulp van C# voorbeeldcode">}}
