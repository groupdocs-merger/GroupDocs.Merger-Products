...
############################# Head ############################
head_title: "C# ішіндегі XLT беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы C# ішіндегі XLT файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "C# ішіндегі XLT беттерді жою"
description: ".NET кодының бірнеше жолы бар XLT беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі XLT файл бетін жою"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне XLT ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT файл бетін C# мысал кодын пайдаланып жою жолы">}}
