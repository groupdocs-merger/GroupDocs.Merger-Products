...
############################# Head ############################
head_title: "PDF Seiten in C# entfernen"
head_description: "Entfernen oder löschen Sie eine einzelne Seite oder eine Sammlung von Seiten aus einer PDF-Datei in C#, indem Sie die Seitenreihenfolge mithilfe der Documents Merger API umkehren."

############################# Header ############################
title: "Entfernen Sie PDF Seiten in C#"
description: "Entfernen Sie PDF-Seiten mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Entfernen Sie PDF Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von C# das Löschen einer einzelnen oder mehrerer bestimmter Seiten innerhalb eines PDF Datei, indem Sie ein paar einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So entfernen Sie PDF-Dateiseiten mit C#-Beispielcode">}}
