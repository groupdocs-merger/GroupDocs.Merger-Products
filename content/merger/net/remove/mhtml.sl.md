...
############################# Head ############################
head_title: "Odstrani strani MHTML v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke MHTML v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani MHTML strani v C#"
description: "Odstranite strani MHTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke MHTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj MHTML datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke MHTML s primerom kode C#">}}
