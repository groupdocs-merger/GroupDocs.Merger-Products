...
############################# Head ############################
head_title: "Odstrani strani ODT v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ODT v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ODT strani v C#"
description: "Odstranite strani ODT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ODT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj ODT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ODT s primerom kode C#">}}
