...
############################# Head ############################
head_title: "Odstrani strani TEX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke TEX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani TEX strani v C#"
description: "Odstranite strani TEX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke TEX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj TEX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke TEX s primerom kode C#">}}
