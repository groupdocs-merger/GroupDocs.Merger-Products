...
############################# Head ############################
head_title: "Odstrani strani DOTM v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOTM v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOTM strani v C#"
description: "Odstranite strani DOTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj DOTM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOTM s primerom kode C#">}}
