...
############################# Head ############################
head_title: "Fjern VSDX sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VSDX-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VSDX sider i C#"
description: "Fjern VSDX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en VSDX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VSDX filsider ved å bruke C# eksempelkode">}}
