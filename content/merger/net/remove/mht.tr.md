...
############################# Head ############################
head_title: "C# İçindeki MHT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir MHT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki MHT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren MHT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki MHT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir MHT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHT dosya sayfaları nasıl kaldırılır">}}
