...
############################# Head ############################
head_title: "Usuń MHTML strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku MHTML w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń MHTML strony w C#"
description: "Usuń strony MHTML z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików MHTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w MHTML plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików MHTML za pomocą przykładowego kodu C#">}}
