...
############################# Head ############################
head_title: "Eemaldage XLTM lehed rakenduses C#"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist XLTM rakenduses C#, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage XLTM lehed rakenduses C#"
description: "Eemaldage XLTM lehed, millel on paar rida .NET koodi."
...
steps:
    enable: true
    title_left: "Eemaldage XLTM faililehed tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise XLTM-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada XLTM faililehte, kasutades C# näitekoodi">}}
