...
############################# Head ############################
head_title: "Xóa ODP Trang trong C#"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp ODP trong C# bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa ODP Trang trong C#"
description: "Xóa các trang ODP có một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Xóa ODP Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng xóa một hoặc một số trang cụ thể trong ODP bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp ODP bằng mã mẫu C#">}}
