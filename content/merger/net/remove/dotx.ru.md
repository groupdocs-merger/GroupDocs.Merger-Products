...
draft: false
############################# Head ############################
head_title: "Удалить страницы DOTX в C# .NET | Удалить страницы из файла DOTX"
head_description: "Пользователи C# .NET могут удалить или удалить одну страницу или набор страниц из файла DOTX с помощью API слияния и разделения документов."
############################# Header ############################
title: "Удалить или удалить страницы из DOTX в .NET"
description: "Удаление или удаление отдельной страницы или набора страниц из файла DOTX с помощью API слияния и разделения документов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Удалить страницы файлов DOTX в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко удалить одну или несколько страниц в файле DOTX, выполнив несколько простых шагов.
    ...
    code: |
        ```cs
        // Удаляем страницы файла DOTX с помощью API GroupDocs.Merger
...
demos:
    enable: true
    title: "Живые демонстрации — удаление страниц документов DOTX онлайн"
    content: |
        Удалите страницы из файлов DOTX прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/remove-pages/dotx). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
