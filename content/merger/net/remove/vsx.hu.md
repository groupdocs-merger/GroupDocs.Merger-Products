...
############################# Head ############################
head_title: "Távolítsa el az VSX oldalt a C# programból"
head_description: "Távolítson el vagy töröljön egyetlen oldalt vagy oldalgyűjteményt egy VSX fájlból a C# alkalmazásban az oldalak sorrendjének megfordításával a dokumentumok egyesítése API használatával."

############################# Header ############################
title: "VSX oldal eltávolítása a C# nyelven"
description: "Távolítsa el a néhány soros .NET kódot tartalmazó VSX oldalt."
...
steps:
    enable: true
    title_left: "Távolítsa el a(z) VSX fájloldalakat a(z) .NET termékből"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen vagy több oldalt töröljenek egy VSX-on belül néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan távolítsunk el VSX fájloldalakat a C# példakóddal">}}
