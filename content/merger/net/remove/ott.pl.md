...
############################# Head ############################
head_title: "Usuń OTT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku OTT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń OTT strony w C#"
description: "Usuń strony OTT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików OTT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w OTT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików OTT za pomocą przykładowego kodu C#">}}
