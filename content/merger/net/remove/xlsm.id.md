...
############################# Head ############################
head_title: "Hapus XLSM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLSM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLSM Halaman Di C#"
description: "Hapus XLSM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLSM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLSM menggunakan kode contoh C#">}}
