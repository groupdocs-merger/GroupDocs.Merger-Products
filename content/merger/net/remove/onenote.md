...
############################# Head ############################
head_title: "Remove ONENOTE Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a ONENOTE file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove ONENOTE Pages In C#"
description: "Remove ONENOTE Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a ONENOTE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove ONENOTE file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove ONENOTE Pages Online"
    content: |
       Remove ONENOTE file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/onenote) website.
