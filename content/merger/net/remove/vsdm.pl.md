...
############################# Head ############################
head_title: "Usuń VSDM strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSDM w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSDM strony w C#"
description: "Usuń strony VSDM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSDM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSDM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSDM za pomocą przykładowego kodu C#">}}
