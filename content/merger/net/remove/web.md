...
############################# Head ############################
head_title: "Remove WEB Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a WEB file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove WEB Pages In C#"
description: "Remove WEB Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a WEB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove WEB file pages using C# example code">}}
