...
############################# Head ############################
head_title: "إزالة صفحات XLTX في C#"
head_description: "قم بإزالة أو حذف صفحة واحدة أو مجموعة صفحات من ملف XLTX في C# عن طريق عكس ترتيب الصفحات باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "إزالة صفحات XLTX في C#"
description: "قم بإزالة صفحات XLTX التي تحتوي على بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "إزالة صفحات ملف XLTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# حذف صفحة واحدة أو عدد من الصفحات المعينة داخل XLTX ملف من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية إزالة صفحات الملف XLTX باستخدام كود مثال C#">}}
