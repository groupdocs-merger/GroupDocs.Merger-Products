...
############################# Head ############################
head_title: "Odstrániť XLAM stránky v C#"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru XLAM v C# obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť XLAM stránky v C#"
description: "Odstráňte XLAM stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Odstrániť XLAM stránky súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# odstrániť jednu alebo viacero konkrétnych stránok v rámci XLAM súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru XLAM pomocou vzorového kódu C#">}}
