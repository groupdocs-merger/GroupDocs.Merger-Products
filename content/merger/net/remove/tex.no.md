...
############################# Head ############################
head_title: "Fjern TEX sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en TEX-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern TEX sider i C#"
description: "Fjern TEX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en TEX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne TEX filsider ved å bruke C# eksempelkode">}}
