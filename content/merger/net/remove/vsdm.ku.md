...
############################# Head ############################
head_title: "Rûpelên VSDM di C# de rake"
head_description: "Rûpelek yek an berhevokek rûpelan ji pelek VSDM ya di C# de jêbikin an jêbikin bi berevajîkirina rêzika rûpelan bi karanîna API-ya yekkirina belgeyan."

############################# Header ############################
title: "Rûpelên VSDM Di C# de rake"
...
steps:
    enable: true
    title_left: "Rûpelên Pelê VSDM di .NET de rake"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku yek an çend rûpelên taybetî di nav VSDM de jêbikin. pelê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# pelên VSDM jêbirin">}}
