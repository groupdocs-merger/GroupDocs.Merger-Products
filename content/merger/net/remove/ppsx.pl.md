...
############################# Head ############################
head_title: "Usuń PPSX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPSX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPSX strony w C#"
description: "Usuń strony PPSX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w PPSX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPSX za pomocą przykładowego kodu C#">}}
