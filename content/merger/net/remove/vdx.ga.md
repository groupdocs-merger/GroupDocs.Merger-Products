...
############################# Head ############################
head_title: "Bain VDX Leathanaigh in C#"
head_description: "Bain nó scrios leathanach amháin nó bailiúchán leathanaigh ó chomhad VDX in C# trí ordú na leathanach a aisiompú ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Bain VDX Leathanaigh in C#"
description: "Bain VDX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bain VDX Leathanaigh Chomhad in .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanach amháin nó roinnt leathanach ar leith a scriosadh laistigh de VDX comhad trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid VDX a bhaint ag úsáid cód samplach C#">}}
