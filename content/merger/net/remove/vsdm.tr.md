...
############################# Head ############################
head_title: "C# İçindeki VSDM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSDM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSDM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSDM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSDM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSDM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosya sayfaları nasıl kaldırılır">}}
