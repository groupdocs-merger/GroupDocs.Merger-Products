...
############################# Head ############################
head_title: "Poista OTT sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma OTT-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista OTT sivut C#"
description: "Poista OTT sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista OTT tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja OTT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa OTT tiedostosivua käyttämällä C# esimerkkikoodia">}}
