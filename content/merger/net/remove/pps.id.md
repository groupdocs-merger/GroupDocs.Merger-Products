...
############################# Head ############################
head_title: "Hapus PPS Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file PPS di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus PPS Halaman Di C#"
description: "Hapus PPS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus PPS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam PPS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file PPS menggunakan kode contoh C#">}}
