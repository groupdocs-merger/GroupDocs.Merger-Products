...
############################# Head ############################
head_title: "Fjarlægðu VDX síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr VDX skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu VDX síður í C#"
description: "Fjarlægðu VDX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu VDX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan VDX skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja VDX skráarsíður með því að nota C# dæmikóða">}}
