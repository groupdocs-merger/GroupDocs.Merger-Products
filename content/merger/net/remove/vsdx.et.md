...
############################# Head ############################
head_title: "Eemaldage VSDX lehed rakenduses C#"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist VSDX rakenduses C#, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage VSDX lehed rakenduses C#"
description: "Eemaldage VSDX lehed, millel on paar rida .NET koodi."
...
steps:
    enable: true
    title_left: "Eemaldage VSDX faililehed tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise VSDX-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada VSDX faililehte, kasutades C# näitekoodi">}}
