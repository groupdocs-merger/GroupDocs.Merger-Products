...
############################# Head ############################
head_title: "C# İçindeki DOT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir DOT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki DOT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren DOT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki DOT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir DOT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosya sayfaları nasıl kaldırılır">}}
