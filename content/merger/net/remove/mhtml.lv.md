...
############################# Head ############################
head_title: "Noņemt MHTML lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no MHTML faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt MHTML lapas programmā C#"
description: "Noņemiet MHTML lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt MHTML faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas MHTML ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt MHTML faila lapas, izmantojot C# piemēra kodu">}}
