...
draft: false
############################# Head ############################
head_title: "Удалить страницы XLSB в C# .NET | Удалить страницы из файла XLSB"
head_description: "Пользователи C# .NET могут удалять или удалять одну страницу или набор страниц из файла XLSB с помощью API слияния и разделения документов."
############################# Header ############################
title: "Удалить или удалить страницы из XLSB в .NET"
description: "Удаление или удаление отдельной страницы или набора страниц из файла XLSB с помощью API слияния и разделения документов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Удалить страницы файлов XLSB в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко удалить одну или несколько страниц в файле XLSB, выполнив несколько простых шагов.
    ...
    code: |
        ```cs
        // Удаляем страницы файла XLSB с помощью API GroupDocs.Merger
...
demos:
    enable: true
    title: "Живые демонстрации - удаление страниц документа XLSB онлайн"
    content: |
        Удалите страницы из файлов XLSB прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/remove-pages/xlsb). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
