...
############################# Head ############################
head_title: "Remove MHTML pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to delete specific pages from MHTML documents. Easily manage PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages in MHTML" 
description: "GroupDocs.Merger for .NET enhances .NET apps with powerful document processing capabilities, including removing pages from MHTML files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily delete pages from MHTML files. Add document management functionality to your .NET applications effortlessly.
      
      1. Specify the MHTML file path.
