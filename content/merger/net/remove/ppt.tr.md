...
############################# Head ############################
head_title: "C# İçindeki PPT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir PPT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki PPT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren PPT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki PPT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir PPT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPT dosya sayfaları nasıl kaldırılır">}}
