...
############################# Head ############################
head_title: "Odstrani strani XLTX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLTX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLTX strani v C#"
description: "Odstranite strani XLTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj XLTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLTX s primerom kode C#">}}
