...
############################# Head ############################
head_title: "Hapus XLTM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLTM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLTM Halaman Di C#"
description: "Hapus XLTM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLTM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLTM menggunakan kode contoh C#">}}
