...
############################# Head ############################
head_title: "Fjern PDF sider i C#"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en PDF-fil i C# ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern PDF sider i C#"
description: "Fjern PDF sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at slette en enkelt eller et antal bestemte sider inden for en PDF fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du PDF filsider ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Fjern PDF filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern PDF sider online"
    content: |
       Fjern PDF filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf).
