...
############################# Head ############################
head_title: "Ukloni MHT stranice u C#"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz MHT datoteke u C# obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni MHT stranice u C#"
description: "Ukloni MHT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ukloni MHT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava brisanje jedne ili više određenih stranica unutar MHT datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti MHT stranice datoteke koristeći C# primjer koda">}}
