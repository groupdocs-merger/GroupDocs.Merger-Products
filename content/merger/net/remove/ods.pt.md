...
############################# Head ############################
head_title: "Remover ODS Páginas em C#"
head_description: "Remova ou exclua uma única página ou coleção de páginas de um arquivo ODS em C# invertendo a ordem das páginas usando a API de fusão de documentos."

############################# Header ############################
title: "Remover ODS Páginas em C#"
description: "Remova ODS Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Remover páginas de arquivo ODS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# excluir uma ou várias páginas específicas em um ODS arquivo implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como remover páginas de arquivo ODS usando o código de exemplo C#">}}
