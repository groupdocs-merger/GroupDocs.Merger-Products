...
############################# Head ############################
head_title: "Hapus HTML Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file HTML di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus HTML Halaman Di C#"
description: "Hapus HTML Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus HTML Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam HTML file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file HTML menggunakan kode contoh C#">}}
