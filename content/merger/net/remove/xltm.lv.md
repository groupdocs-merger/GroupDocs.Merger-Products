...
############################# Head ############################
head_title: "Noņemt XLTM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLTM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLTM lapas programmā C#"
description: "Noņemiet XLTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLTM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLTM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLTM faila lapas, izmantojot C# piemēra kodu">}}
