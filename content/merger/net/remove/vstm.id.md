...
############################# Head ############################
head_title: "Hapus VSTM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSTM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSTM Halaman Di C#"
description: "Hapus VSTM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus VSTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam VSTM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSTM menggunakan kode contoh C#">}}
