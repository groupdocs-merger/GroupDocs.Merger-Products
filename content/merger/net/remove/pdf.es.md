...
############################# Head ############################
head_title: "Eliminar páginas de PDF en aplicaciones .NET"
head_description: "Utiliza GroupDocs.Merger for .NET para eliminar páginas específicas de documentos PDF. Gestiona documentos PDF, Word, Excel, PowerPoint, imágenes, archivos y más."

############################# Header ############################
title: "Eliminar páginas en PDF" 
description: "GroupDocs.Merger for .NET mejora las aplicaciones .NET con potentes capacidades de procesamiento de documentos, incluyendo la eliminación de páginas de archivos PDF."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/net/), puedes eliminar páginas de archivos PDF. Agrega funcionalidad de gestión de documentos a tus aplicaciones .NET sin complicaciones.
      
      1. Especifica la ruta del archivo PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cómo eliminar todas las páginas pares"
      content: |
        Aprende cómo eliminar las páginas de números pares de un documento PDF.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
