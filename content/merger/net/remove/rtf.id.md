...
############################# Head ############################
head_title: "Hapus RTF Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file RTF di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus RTF Halaman Di C#"
description: "Hapus RTF Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus RTF Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam RTF file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file RTF menggunakan kode contoh C#">}}
