...
############################# Head ############################
head_title: "C# İçindeki VSDX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSDX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSDX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSDX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSDX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSDX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosya sayfaları nasıl kaldırılır">}}
