...
############################# Head ############################
head_title: "Poista XLSB sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLSB-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLSB sivut C#"
description: "Poista XLSB sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista XLSB tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLSB tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLSB tiedostosivua käyttämällä C# esimerkkikoodia">}}
