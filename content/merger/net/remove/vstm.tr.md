...
############################# Head ############################
head_title: "C# İçindeki VSTM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSTM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSTM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSTM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSTM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSTM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosya sayfaları nasıl kaldırılır">}}
