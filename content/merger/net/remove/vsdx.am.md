...
############################# Head ############################
head_title: "በC# ውስጥ VSDX ገጾችን ያስወግዱ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የገጾቹን ቅደም ተከተል በመቀየር በC# ውስጥ ካለው የVSDX ፋይል አንድ ገጽ ወይም የገጾችን ስብስብ ያስወግዱ ወይም ይሰርዙ።"

############################# Header ############################
title: "በC# ውስጥ VSDX ገጾችን አስወግድ"
description: "VSDX ገጾችን በጥቂት የ.NET ኮድ መስመሮች ያስወግዱ።"
...
steps:
    enable: true
    title_left: "VSDX የፋይል ገጾችን በ.NET ውስጥ ያስወግዱ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች በVSDX ውስጥ አንድ ነጠላ ወይም የተወሰኑ ገጾችን መሰረዝ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር ፋይል ያድርጉ።
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የVSDX ፋይል ገጾችን እንዴት ማስወገድ እንደሚቻል">}}
