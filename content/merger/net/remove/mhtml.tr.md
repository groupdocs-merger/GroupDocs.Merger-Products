...
############################# Head ############################
head_title: "C# İçindeki MHTML Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir MHTML dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki MHTML Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren MHTML Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki MHTML Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir MHTML içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHTML dosya sayfaları nasıl kaldırılır">}}
