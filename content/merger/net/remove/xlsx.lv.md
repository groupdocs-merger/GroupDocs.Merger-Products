...
############################# Head ############################
head_title: "Noņemt XLSX lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLSX faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLSX lapas programmā C#"
description: "Noņemiet XLSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLSX faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLSX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLSX faila lapas, izmantojot C# piemēra kodu">}}
