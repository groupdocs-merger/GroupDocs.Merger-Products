...
############################# Head ############################
head_title: "C# İçindeki OTP Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir OTP dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki OTP Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren OTP Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki OTP Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir OTP içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTP dosya sayfaları nasıl kaldırılır">}}
