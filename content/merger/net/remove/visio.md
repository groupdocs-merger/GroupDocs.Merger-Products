...
############################# Head ############################
head_title: "Remove VISIO Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a VISIO file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove VISIO Pages In C#"
description: "Remove VISIO Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a VISIO file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove VISIO file pages using C# example code">}}
