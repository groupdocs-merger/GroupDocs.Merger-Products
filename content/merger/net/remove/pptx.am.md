...
############################# Head ############################
head_title: "በC# ውስጥ PPTX ገጾችን ያስወግዱ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም የገጾቹን ቅደም ተከተል በመቀየር በC# ውስጥ ካለው የPPTX ፋይል አንድ ገጽ ወይም የገጾችን ስብስብ ያስወግዱ ወይም ይሰርዙ።"

############################# Header ############################
title: "በC# ውስጥ PPTX ገጾችን አስወግድ"
description: "PPTX ገጾችን በጥቂት የ.NET ኮድ መስመሮች ያስወግዱ።"
...
steps:
    enable: true
    title_left: "PPTX የፋይል ገጾችን በ.NET ውስጥ ያስወግዱ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች በPPTX ውስጥ አንድ ነጠላ ወይም የተወሰኑ ገጾችን መሰረዝ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር ፋይል ያድርጉ።
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የPPTX ፋይል ገጾችን እንዴት ማስወገድ እንደሚቻል">}}
