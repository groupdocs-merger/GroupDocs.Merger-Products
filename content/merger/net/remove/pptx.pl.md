...
############################# Head ############################
head_title: "Usuń PPTX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPTX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPTX strony w C#"
description: "Usuń strony PPTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w PPTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPTX za pomocą przykładowego kodu C#">}}
