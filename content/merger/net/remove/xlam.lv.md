...
############################# Head ############################
head_title: "Noņemt XLAM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLAM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLAM lapas programmā C#"
description: "Noņemiet XLAM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLAM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLAM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLAM faila lapas, izmantojot C# piemēra kodu">}}
