...
############################# Head ############################
head_title: "C# İçindeki XPS Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XPS dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XPS Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XPS Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XPS Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XPS içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosya sayfaları nasıl kaldırılır">}}
