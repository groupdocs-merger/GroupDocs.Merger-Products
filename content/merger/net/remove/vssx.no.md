...
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en VSSX-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern VSSX sider i C#"
description: "Fjern VSSX-sider med noen få linjer med .NET-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en VSSX fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne VSSX filsider ved å bruke C# eksempelkode">}}
