...
############################# Head ############################
head_title: "Noņemt XLSM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLSM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLSM lapas programmā C#"
description: "Noņemiet XLSM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLSM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLSM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLSM faila lapas, izmantojot C# piemēra kodu">}}
