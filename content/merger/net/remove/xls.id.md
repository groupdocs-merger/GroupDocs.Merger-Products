...
############################# Head ############################
head_title: "Hapus XLS Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLS di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLS Halaman Di C#"
description: "Hapus XLS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLS menggunakan kode contoh C#">}}
