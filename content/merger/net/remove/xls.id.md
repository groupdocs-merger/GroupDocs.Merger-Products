...
head_title: "Hapus Halaman XLS di C# .NET | Hapus Halaman dari XLS File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file XLS menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari XLS di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file XLS menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File XLS di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file XLS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Hapus halaman file XLS menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLS Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/XLS).
