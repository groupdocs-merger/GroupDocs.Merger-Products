...
############################# Head ############################
head_title: "C# İçindeki DOCX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir DOCX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki DOCX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren DOCX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki DOCX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir DOCX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCX dosya sayfaları nasıl kaldırılır">}}
