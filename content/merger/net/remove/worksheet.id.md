...
############################# Head ############################
head_title: "Hapus WORKSHEET Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file WORKSHEET di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus WORKSHEET Halaman Di C#"
description: "Hapus WORKSHEET Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus WORKSHEET Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam WORKSHEET file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file WORKSHEET menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus WORKSHEET Laman Daring"
    content: |
       Hapus halaman file WORKSHEET sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/worksheet).
