...
############################# Head ############################
head_title: "Fjern XPS sider i C#"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en XPS-fil i C# ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern XPS sider i C#"
description: "Fjern XPS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at slette en enkelt eller et antal bestemte sider inden for en XPS fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du XPS filsider ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Fjern XPS filsider ved hjælp af GroupDocs.Merger API
...
demos:
    enable: true
    title: "Livedemoer - Fjern XPS sider online"
    content: |
       Fjern XPS filsider lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xps).
