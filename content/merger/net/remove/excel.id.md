...
############################# Head ############################
head_title: "Hapus EXCEL Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file EXCEL di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus EXCEL Halaman Di C#"
description: "Hapus EXCEL Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus EXCEL Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam EXCEL file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file EXCEL menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Hapus EXCEL Laman Daring"
    content: |
       Hapus halaman file EXCEL sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/remove-pages/excel).
