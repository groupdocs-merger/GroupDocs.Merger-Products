...
############################# Head ############################
head_title: "Hapus DOCX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file DOCX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus DOCX Halaman Di C#"
description: "Hapus DOCX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus DOCX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam DOCX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOCX menggunakan kode contoh C#">}}
