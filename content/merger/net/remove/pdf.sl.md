...
############################# Head ############################
head_title: "Odstrani strani PDF v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PDF v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PDF strani v C#"
description: "Odstranite strani PDF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PDF v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj PDF datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PDF s primerom kode C#">}}
