...
############################# Head ############################
head_title: "Remover ONE Páginas em C#"
head_description: "Remova ou exclua uma única página ou coleção de páginas de um arquivo ONE em C# invertendo a ordem das páginas usando a API de fusão de documentos."

############################# Header ############################
title: "Remover ONE Páginas em C#"
description: "Remova ONE Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Remover páginas de arquivo ONE em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# excluir uma ou várias páginas específicas em um ONE arquivo implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como remover páginas de arquivo ONE usando o código de exemplo C#">}}
