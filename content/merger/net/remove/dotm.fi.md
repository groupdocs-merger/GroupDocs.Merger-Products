...
############################# Head ############################
head_title: "Poista DOTM sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOTM-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOTM sivut C#"
description: "Poista DOTM sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista DOTM tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOTM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
