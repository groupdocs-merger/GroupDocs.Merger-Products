...
############################# Head ############################
head_title: "Odstrani strani XLS v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLS v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLS strani v C#"
description: "Odstranite strani XLS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj XLS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLS s primerom kode C#">}}
