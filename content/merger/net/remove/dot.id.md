...
############################# Head ############################
head_title: "Hapus DOT Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file DOT di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus DOT Halaman Di C#"
description: "Hapus DOT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus DOT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam DOT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOT menggunakan kode contoh C#">}}
