...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a XLTM file by implementing a few easy steps.
