...
############################# Head ############################
head_title: "Poista HTML sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma HTML-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista HTML sivut C#"
description: "Poista HTML sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista HTML tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja HTML tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa HTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
