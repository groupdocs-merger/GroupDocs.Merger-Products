...
############################# Head ############################
head_title: "Fjern MHT sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en MHT-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern MHT sider i C#"
description: "Fjern MHT-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en MHT fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne MHT filsider ved å bruke C# eksempelkode">}}
