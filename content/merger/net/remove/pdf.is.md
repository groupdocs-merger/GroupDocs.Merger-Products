...
############################# Head ############################
head_title: "Fjarlægðu PDF síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr PDF skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu PDF síður í C#"
description: "Fjarlægðu PDF síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu PDF skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan PDF skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja PDF skráarsíður með því að nota C# dæmikóða">}}
