...
############################# Head ############################
head_title: "Usuń VSTM strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSTM w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSTM strony w C#"
description: "Usuń strony VSTM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSTM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSTM za pomocą przykładowego kodu C#">}}
