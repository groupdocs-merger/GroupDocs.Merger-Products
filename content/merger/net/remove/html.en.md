...
############################# Head ############################
head_title: "Remove HTML pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to delete specific pages from HTML documents. Easily manage PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages in HTML" 
description: "GroupDocs.Merger for .NET enhances .NET apps with powerful document processing capabilities, including removing pages from HTML files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily delete pages from HTML files. Add document management functionality to your .NET applications effortlessly.
      
      1. Specify the HTML file path.
