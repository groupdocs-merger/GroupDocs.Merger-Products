...
############################# Head ############################
head_title: "Rimuovi pagine HTML nelle app .NET"
head_description: "Utilizza GroupDocs.Merger for .NET per eliminare pagine specifiche da documenti HTML. Gestisci PDF, Word, Excel, PowerPoint, immagini, archivi e altro."

############################# Header ############################
title: "Rimuovi pagine in HTML" 
description: "GroupDocs.Merger for .NET migliora le app .NET con potenti capacità di elaborazione dei documenti, inclusa la rimozione di pagine dai file HTML."
...
steps:
    enable: true
    title: "Come rimuovere pagine da HTML"
    content: |
      Con [GroupDocs.Merger](/merger/net/), puoi eliminare pagine dai file HTML. Aggiungi funzionalità di gestione documentale alle tue applicazioni .NET in modo efficace.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Come rimuovere tutte le pagine pari"
      content: |
        Scopri come eliminare le pagine numerate pari da un documento HTML.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
