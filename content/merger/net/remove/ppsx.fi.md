...
############################# Head ############################
head_title: "Poista PPSX sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma PPSX-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista PPSX sivut C#"
description: "Poista PPSX sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista PPSX tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja PPSX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa PPSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
