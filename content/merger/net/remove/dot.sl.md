...
############################# Head ############################
head_title: "Odstrani strani DOT v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOT v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOT strani v C#"
description: "Odstranite strani DOT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj DOT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOT s primerom kode C#">}}
