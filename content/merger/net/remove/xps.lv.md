...
############################# Head ############################
head_title: "Noņemt XPS lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XPS faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XPS lapas programmā C#"
description: "Noņemiet XPS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XPS faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XPS ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XPS faila lapas, izmantojot C# piemēra kodu">}}
