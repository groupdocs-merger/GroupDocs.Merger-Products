...
############################# Head ############################
head_title: "Fjern EPUB sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en EPUB-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern EPUB sider i C#"
description: "Fjern EPUB-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en EPUB fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne EPUB filsider ved å bruke C# eksempelkode">}}

        ```csharp    
        // Fjern EPUB filsider ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer – Fjern EPUB-sider på nettet"
    content: |
       Fjern EPUB-filsider akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/epub).
