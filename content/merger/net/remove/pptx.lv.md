...
############################# Head ############################
head_title: "Noņemt PPTX lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no PPTX faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt PPTX lapas programmā C#"
description: "Noņemiet PPTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt PPTX faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas PPTX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt PPTX faila lapas, izmantojot C# piemēra kodu">}}
