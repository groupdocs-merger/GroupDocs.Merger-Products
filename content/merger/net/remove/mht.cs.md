...
############################# Head ############################
head_title: "Odebrat MHT stránky v C#"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru MHT v C# obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat MHT stránky v C#"
description: "Odstraňte MHT stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Odebrat MHT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# smazat jednu nebo několik konkrétních stránek v rámci MHT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru MHT pomocí ukázkového kódu C#">}}
