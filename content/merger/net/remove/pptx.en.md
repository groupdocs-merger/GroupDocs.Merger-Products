...
############################# Head ############################
head_title: "Remove PPTX pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to delete specific pages from PPTX documents. Easily manage PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages in PPTX" 
description: "GroupDocs.Merger for .NET enhances .NET apps with powerful document processing capabilities, including removing pages from PPTX files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily delete pages from PPTX files. Add document management functionality to your .NET applications effortlessly.
