...
############################# Head ############################
head_title: "Noņemt DOCX lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no DOCX faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt DOCX lapas programmā C#"
description: "Noņemiet DOCX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt DOCX faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas DOCX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt DOCX faila lapas, izmantojot C# piemēra kodu">}}
