...
############################# Head ############################
head_title: "Удалить PDF страницы на C#"
head_description: "Удалите одну или набор страниц из файла PDF на C#, изменив порядок страниц с помощью Merger API."

############################# Header ############################
title: "Удалить PDF страницы на C#"
description: "Удалите PDF страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Удалить страницы PDF документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) упрощает для разработчиков C# удаление одной или нескольких определенных страниц для PDF документа, выполнив несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как удалить страницы PDF документов, используя пример кода C#">}}
