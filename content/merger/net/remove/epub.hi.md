...
############################# Head ############################
head_title: "C# में EPUB पेज हटाएं"
head_description: "दस्तावेज़ विलय API का उपयोग करके पृष्ठ क्रम को उलट कर C# में EPUB फ़ाइल से एकल पृष्ठ या पृष्ठों के संग्रह को निकालें या हटाएं।"

############################# Header ############################
title: "C# में EPUB पेज हटाएं"
...
steps:
    enable: true
    title_left: ".NET में EPUB फ़ाइल पेज हटाएं"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए C# डेवलपर्स के लिए एक EPUB के भीतर एक या कई विशेष पेज हटाना आसान बनाता है। कुछ आसान चरणों को लागू करके फ़ाइल।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके EPUB फ़ाइल पृष्ठों को कैसे निकालें">}}
