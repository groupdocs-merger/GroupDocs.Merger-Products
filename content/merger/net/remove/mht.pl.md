...
############################# Head ############################
head_title: "Usuń MHT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku MHT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń MHT strony w C#"
description: "Usuń strony MHT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików MHT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w MHT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików MHT za pomocą przykładowego kodu C#">}}
