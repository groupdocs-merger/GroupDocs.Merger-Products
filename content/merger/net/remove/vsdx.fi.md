...
############################# Head ############################
head_title: "Poista VSDX sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSDX-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSDX sivut C#"
description: "Poista VSDX sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista VSDX tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSDX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSDX tiedostosivua käyttämällä C# esimerkkikoodia">}}
