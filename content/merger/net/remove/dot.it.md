...
############################# Head ############################
head_title: "Remove DOT Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a DOT file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove DOT Pages In C#"
description: "Remove DOT Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a DOT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove DOT file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove DOT Pages Online"
    content: |
       Remove DOT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot) website.
