...
############################# Head ############################
head_title: "Usuń EPUB strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku EPUB w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń EPUB strony w C#"
description: "Usuń strony EPUB z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików EPUB w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w EPUB plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików EPUB za pomocą przykładowego kodu C#">}}
