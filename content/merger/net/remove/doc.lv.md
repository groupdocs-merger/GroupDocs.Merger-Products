...
############################# Head ############################
head_title: "Noņemt DOC lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no DOC faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt DOC lapas programmā C#"
description: "Noņemiet DOC lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt DOC faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas DOC ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt DOC faila lapas, izmantojot C# piemēra kodu">}}
