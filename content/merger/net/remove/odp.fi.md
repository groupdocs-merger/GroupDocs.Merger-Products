...
############################# Head ############################
head_title: "Poista ODP sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ODP-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ODP sivut C#"
description: "Poista ODP sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista ODP tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ODP tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ODP tiedostosivua käyttämällä C# esimerkkikoodia">}}
