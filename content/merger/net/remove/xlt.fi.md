...
############################# Head ############################
head_title: "Poista XLT sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLT-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLT sivut C#"
description: "Poista XLT sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista XLT tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLT tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLT tiedostosivua käyttämällä C# esimerkkikoodia">}}
