...
############################# Head ############################
head_title: "Noņemt ODP lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no ODP faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt ODP lapas programmā C#"
description: "Noņemiet ODP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt ODP faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas ODP ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt ODP faila lapas, izmantojot C# piemēra kodu">}}
