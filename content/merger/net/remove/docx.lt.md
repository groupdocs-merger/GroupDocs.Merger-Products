...
############################# Head ############################
head_title: "Pašalinti DOCX puslapius iš C#"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš DOCX failo C#, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti DOCX puslapius iš C#"
description: "Pašalinkite DOCX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti DOCX failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš DOCX failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti DOCX failo puslapius naudojant C# pavyzdinį kodą">}}
