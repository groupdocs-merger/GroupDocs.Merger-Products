...
############################# Head ############################
head_title: "Poista ONE sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ONE-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ONE sivut C#"
description: "Poista ONE sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista ONE tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ONE tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ONE tiedostosivua käyttämällä C# esimerkkikoodia">}}
