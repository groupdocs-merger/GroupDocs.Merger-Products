...
############################# Head ############################
head_title: "C# İçindeki ODP Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir ODP dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki ODP Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren ODP Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki ODP Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir ODP içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosya sayfaları nasıl kaldırılır">}}
