...
############################# Head ############################
head_title: "C# İçindeki VSSX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSSX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSSX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSSX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSSX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSSX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSX dosya sayfaları nasıl kaldırılır">}}
