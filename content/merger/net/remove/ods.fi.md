...
############################# Head ############################
head_title: "Poista ODS sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma ODS-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista ODS sivut C#"
description: "Poista ODS sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista ODS tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja ODS tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa ODS tiedostosivua käyttämällä C# esimerkkikoodia">}}
