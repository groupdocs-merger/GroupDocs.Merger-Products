...
head_title: "Hapus Halaman DOTM di C# .NET | Hapus Halaman dari DOTM File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file DOTM menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari DOTM di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file DOTM menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File DOTM di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file DOTM dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Hapus DOTM Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/DOTM).
