...
############################# Head ############################
head_title: "Eemaldage VSSM lehed rakenduses C#"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist VSSM rakenduses C#, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage VSSM lehed rakenduses C#"
description: "Eemaldage VSSM lehed, millel on paar rida .NET koodi."
...
steps:
    enable: true
    title_left: "Eemaldage VSSM faililehed tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise VSSM-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada VSSM faililehte, kasutades C# näitekoodi">}}
