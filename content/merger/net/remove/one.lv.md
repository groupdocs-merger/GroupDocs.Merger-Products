...
############################# Head ############################
head_title: "Noņemt ONE lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no ONE faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt ONE lapas programmā C#"
description: "Noņemiet ONE lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt ONE faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas ONE ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt ONE faila lapas, izmantojot C# piemēra kodu">}}
