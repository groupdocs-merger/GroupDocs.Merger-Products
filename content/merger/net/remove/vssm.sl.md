...
############################# Head ############################
head_title: "Odstrani strani VSSM v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSSM v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSSM strani v C#"
description: "Odstranite strani VSSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSSM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj VSSM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSSM s primerom kode C#">}}
