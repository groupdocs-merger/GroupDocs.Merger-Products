...
############################# Head ############################
head_title: "Odebrat ODT stránky v C#"
head_description: "Odeberte nebo smažte jednu stránku nebo kolekci stránek ze souboru ODT v C# obrácením pořadí stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Odebrat ODT stránky v C#"
description: "Odstraňte ODT stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Odebrat ODT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# smazat jednu nebo několik konkrétních stránek v rámci ODT soubor provedením několika snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak odstranit stránky souboru ODT pomocí ukázkového kódu C#">}}
