...
############################# Head ############################
head_title: "Odstrani strani DOTX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOTX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOTX strani v C#"
description: "Odstranite strani DOTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj DOTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOTX s primerom kode C#">}}
