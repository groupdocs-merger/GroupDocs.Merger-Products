...
############################# Head ############################
head_title: "Hapus ODT Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file ODT di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus ODT Halaman Di C#"
description: "Hapus ODT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus ODT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam ODT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ODT menggunakan kode contoh C#">}}
