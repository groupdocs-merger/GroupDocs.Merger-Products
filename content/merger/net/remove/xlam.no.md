...
############################# Head ############################
head_title: "Fjern XLAM sider i C#"
head_description: "Fjern eller slett en enkelt side eller samling av sider fra en XLAM-fil i C# ved å reversere siderekkefølgen ved å bruke Documents Merger API."

############################# Header ############################
title: "Fjern XLAM sider i C#"
description: "Fjern XLAM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern XLAM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å slette en enkelt eller flere bestemte sider innenfor en XLAM fil ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan fjerne XLAM filsider ved å bruke C# eksempelkode">}}
