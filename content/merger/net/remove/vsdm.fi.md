...
############################# Head ############################
head_title: "Poista VSDM sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSDM-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSDM sivut C#"
description: "Poista VSDM sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista VSDM tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSDM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSDM tiedostosivua käyttämällä C# esimerkkikoodia">}}
