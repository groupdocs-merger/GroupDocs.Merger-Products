...
############################# Head ############################
head_title: "Pašalinti VDX puslapius iš C#"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš VDX failo C#, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti VDX puslapius iš C#"
description: "Pašalinkite VDX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti VDX failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš VDX failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti VDX failo puslapius naudojant C# pavyzdinį kodą">}}
