...
############################# Head ############################
head_title: "Pašalinti DOTM puslapius iš C#"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš DOTM failo C#, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti DOTM puslapius iš C#"
description: "Pašalinkite DOTM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti DOTM failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš DOTM failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti DOTM failo puslapius naudojant C# pavyzdinį kodą">}}
