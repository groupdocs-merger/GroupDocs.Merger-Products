...
############################# Head ############################
head_title: "Supprimer DOCX pages dans C#"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier DOCX dans C# en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer DOCX pages dans C#"
description: "Supprimez les pages DOCX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Supprimer DOCX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de supprimer facilement une ou plusieurs pages particulières dans un DOCX fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers DOCX à l'aide de l'exemple de code C#">}}
