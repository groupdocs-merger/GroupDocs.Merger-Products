...
head_title: "Hapus Halaman XLSX di C# .NET | Hapus Halaman dari XLSX File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file XLSX menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari XLSX di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file XLSX menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File XLSX di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file XLSX dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Hapus halaman file XLSX menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Hapus XLSX Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file XLSX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/XLSX).
