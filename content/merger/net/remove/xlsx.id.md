...
############################# Head ############################
head_title: "Hapus XLSX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLSX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLSX Halaman Di C#"
description: "Hapus XLSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLSX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLSX menggunakan kode contoh C#">}}
