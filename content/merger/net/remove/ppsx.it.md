...
############################# Head ############################
head_title: "Remove PPSX Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a PPSX file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove PPSX Pages In C#"
description: "Remove PPSX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a PPSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove PPSX file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Remove PPSX Pages Online"
    content: |
       Remove PPSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ppsx) website.
