...
############################# Head ############################
head_title: "Odstrani strani XPS v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XPS v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XPS strani v C#"
description: "Odstranite strani XPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj XPS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XPS s primerom kode C#">}}
