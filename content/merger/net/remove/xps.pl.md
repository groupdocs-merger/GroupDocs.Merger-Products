...
############################# Head ############################
head_title: "Usuń XPS strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XPS w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XPS strony w C#"
description: "Usuń strony XPS z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików XPS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w XPS plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XPS za pomocą przykładowego kodu C#">}}
