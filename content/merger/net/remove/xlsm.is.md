...
############################# Head ############################
head_title: "Fjarlægðu XLSM síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr XLSM skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu XLSM síður í C#"
description: "Fjarlægðu XLSM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu XLSM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan XLSM skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja XLSM skráarsíður með því að nota C# dæmikóða">}}
