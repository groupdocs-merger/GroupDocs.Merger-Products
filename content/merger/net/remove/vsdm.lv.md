...
############################# Head ############################
head_title: "Noņemt VSDM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no VSDM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt VSDM lapas programmā C#"
description: "Noņemiet VSDM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt VSDM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas VSDM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt VSDM faila lapas, izmantojot C# piemēra kodu">}}
