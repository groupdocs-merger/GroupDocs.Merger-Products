...
############################# Head ############################
head_title: "Noņemt PPS lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no PPS faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt PPS lapas programmā C#"
description: "Noņemiet PPS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt PPS faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas PPS ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt PPS faila lapas, izmantojot C# piemēra kodu">}}
