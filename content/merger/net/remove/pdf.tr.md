...
############################# Head ############################
head_title: "C# İçindeki PDF Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir PDF dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki PDF Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren PDF Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki PDF Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir PDF içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosya sayfaları nasıl kaldırılır">}}
