...
############################# Head ############################
head_title: "Pašalinti PPTX puslapius iš C#"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš PPTX failo C#, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti PPTX puslapius iš C#"
description: "Pašalinkite PPTX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti PPTX failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš PPTX failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti PPTX failo puslapius naudojant C# pavyzdinį kodą">}}
