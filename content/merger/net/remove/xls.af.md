...
############################# Head ############################
head_title: "Verwyder XLS bladsye in C#"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n XLS-lêer in C# deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder XLS bladsye in C#"
description: "Verwyder XLS Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verwyder XLS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n XLS uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLS lêerbladsye te verwyder deur C# voorbeeldkode te gebruik">}}
