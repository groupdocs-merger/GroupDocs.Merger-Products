...
############################# Head ############################
head_title: "Usuń VSTX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSTX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSTX strony w C#"
description: "Usuń strony VSTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSTX za pomocą przykładowego kodu C#">}}
