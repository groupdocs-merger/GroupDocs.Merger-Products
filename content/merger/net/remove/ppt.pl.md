...
############################# Head ############################
head_title: "Usuń PPT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku PPT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń PPT strony w C#"
description: "Usuń strony PPT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików PPT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w PPT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików PPT za pomocą przykładowego kodu C#">}}
