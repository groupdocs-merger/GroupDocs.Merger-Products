...
############################# Head ############################
head_title: "Hapus DOCM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file DOCM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus DOCM Halaman Di C#"
description: "Hapus DOCM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus DOCM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam DOCM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file DOCM menggunakan kode contoh C#">}}
