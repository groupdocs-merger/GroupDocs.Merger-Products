...
############################# Head ############################
head_title: "C# İçindeki EPUB Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir EPUB dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki EPUB Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren EPUB Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki EPUB Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir EPUB içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak EPUB dosya sayfaları nasıl kaldırılır">}}
