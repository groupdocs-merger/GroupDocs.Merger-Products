...
############################# Head ############################
head_title: "Fjarlægðu HTML síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr HTML skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu HTML síður í C#"
description: "Fjarlægðu HTML síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu HTML skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan HTML skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja HTML skráarsíður með því að nota C# dæmikóða">}}
