...
############################# Head ############################
head_title: "Usuń XLTX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XLTX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XLTX strony w C#"
description: "Usuń strony XLTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików XLTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w XLTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XLTX za pomocą przykładowego kodu C#">}}
