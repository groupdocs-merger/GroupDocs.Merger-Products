...
############################# Head ############################
head_title: "Hapus MHT Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file MHT di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus MHT Halaman Di C#"
description: "Hapus MHT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus MHT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam MHT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file MHT menggunakan kode contoh C#">}}
