...
############################# Head ############################
head_title: "Noņemt XLS lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLS faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLS lapas programmā C#"
description: "Noņemiet XLS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLS faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLS ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLS faila lapas, izmantojot C# piemēra kodu">}}
