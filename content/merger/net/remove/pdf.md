...
############################# Head ############################
head_title: "Delete PDF Pages in C# .NET | Remove Pages from PDF File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a PDF file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From PDF in .NET"
description: "Delete or Remove a single page or collection of pages from a PDF file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a PDF file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within PDF files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/pdf) website.
