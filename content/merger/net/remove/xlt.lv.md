...
############################# Head ############################
head_title: "Noņemt XLT lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no XLT faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt XLT lapas programmā C#"
description: "Noņemiet XLT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt XLT faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas XLT ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt XLT faila lapas, izmantojot C# piemēra kodu">}}
