...
############################# Head ############################
head_title: "C# İçindeki OTT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir OTT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki OTT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren OTT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki OTT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir OTT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosya sayfaları nasıl kaldırılır">}}
