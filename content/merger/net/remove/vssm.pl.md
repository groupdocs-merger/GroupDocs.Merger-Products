...
############################# Head ############################
head_title: "Usuń VSSM strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSSM w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSSM strony w C#"
description: "Usuń strony VSSM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSSM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSSM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSSM za pomocą przykładowego kodu C#">}}
