...
############################# Head ############################
head_title: "Odstrani strani ODP v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ODP v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ODP strani v C#"
description: "Odstranite strani ODP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ODP v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj ODP datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ODP s primerom kode C#">}}
