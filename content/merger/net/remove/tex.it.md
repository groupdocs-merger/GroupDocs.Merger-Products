...
############################# Head ############################
head_title: "Remove TEX Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a TEX file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove TEX Pages In C#"
description: "Remove TEX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a TEX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove TEX file pages using C# example code">}}
