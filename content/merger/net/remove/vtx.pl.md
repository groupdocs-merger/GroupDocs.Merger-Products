...
############################# Head ############################
head_title: "Usuń VTX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VTX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VTX strony w C#"
description: "Usuń strony VTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VTX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VTX za pomocą przykładowego kodu C#">}}
