...
############################# Head ############################
head_title: "Hapus VSSX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSSX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSSX Halaman Di C#"
description: "Hapus VSSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus VSSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam VSSX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSSX menggunakan kode contoh C#">}}
