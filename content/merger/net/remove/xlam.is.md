...
############################# Head ############################
head_title: "Fjarlægðu XLAM síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr XLAM skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu XLAM síður í C#"
description: "Fjarlægðu XLAM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu XLAM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan XLAM skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja XLAM skráarsíður með því að nota C# dæmikóða">}}
