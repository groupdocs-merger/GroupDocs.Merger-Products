...
############################# Head ############################
head_title: "Noņemt TEX lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no TEX faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt TEX lapas programmā C#"
description: "Noņemiet TEX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt TEX faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas TEX ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt TEX faila lapas, izmantojot C# piemēra kodu">}}
