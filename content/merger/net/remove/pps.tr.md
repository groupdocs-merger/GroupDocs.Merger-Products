...
############################# Head ############################
head_title: "C# İçindeki PPS Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir PPS dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki PPS Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren PPS Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki PPS Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir PPS içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPS dosya sayfaları nasıl kaldırılır">}}
