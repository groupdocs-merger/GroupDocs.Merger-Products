...
head_title: "Hapus Halaman ODP di C# .NET | Hapus Halaman dari ODP File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file ODP menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari ODP di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file ODP menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File ODP di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file ODP dengan menerapkan beberapa langkah mudah.
