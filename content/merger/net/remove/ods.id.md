...
############################# Head ############################
head_title: "Hapus ODS Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file ODS di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus ODS Halaman Di C#"
description: "Hapus ODS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus ODS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam ODS file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file ODS menggunakan kode contoh C#">}}
