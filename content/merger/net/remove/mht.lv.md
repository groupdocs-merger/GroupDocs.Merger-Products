...
############################# Head ############################
head_title: "Noņemt MHT lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no MHT faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt MHT lapas programmā C#"
description: "Noņemiet MHT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt MHT faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas MHT ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt MHT faila lapas, izmantojot C# piemēra kodu">}}
