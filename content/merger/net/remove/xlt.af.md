...
############################# Head ############################
head_title: "Verwyder XLT bladsye in C#"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n XLT-lêer in C# deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder XLT bladsye in C#"
description: "Verwyder XLT Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verwyder XLT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n XLT uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêerbladsye te verwyder deur C# voorbeeldkode te gebruik">}}
