...
############################# Head ############################
head_title: "Usuń DOCX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOCX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOCX strony w C#"
description: "Usuń strony DOCX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOCX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w DOCX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOCX za pomocą przykładowego kodu C#">}}
