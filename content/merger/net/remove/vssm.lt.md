...
############################# Head ############################
head_title: "Pašalinti VSSM puslapius iš C#"
head_description: "Pašalinkite arba ištrinkite vieną puslapį arba puslapių rinkinį iš VSSM failo C#, pakeisdami puslapių tvarką naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Pašalinti VSSM puslapius iš C#"
description: "Pašalinkite VSSM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pašalinti VSSM failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai ištrinti vieną ar kelis konkrečius puslapius iš VSSM failą, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pašalinti VSSM failo puslapius naudojant C# pavyzdinį kodą">}}
