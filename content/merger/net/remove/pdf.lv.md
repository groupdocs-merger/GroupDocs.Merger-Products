...
############################# Head ############################
head_title: "Noņemt PDF lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no PDF faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt PDF lapas programmā C#"
description: "Noņemiet PDF lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt PDF faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas PDF ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt PDF faila lapas, izmantojot C# piemēra kodu">}}
