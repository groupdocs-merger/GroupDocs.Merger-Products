...
draft: false
############################# Head ############################
head_title: "Удаление веб-страниц в C# .NET | Удалить страницы из файла WEB"
head_description: "Пользователи C# .NET могут удалять или удалять одну страницу или набор страниц из WEB-файла с помощью API слияния и разделения документов."
############################# Header ############################
title: "Удалить или удалить страницы из сети в .NET"
description: "Удаление или удаление отдельной страницы или набора страниц из файла WEB с помощью API слияния и разделения документов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Удалить страницы веб-файлов в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко удалять одну или несколько страниц в веб-файле, выполняя несколько простых шагов.
    ...
    code: |
        ```cs
        // Удалить страницы файла WEB с помощью API GroupDocs.Merger
...
demos:
    enable: true
    title: "Живые демонстрации - удаление страниц веб-документов онлайн"
    content: |
        Удалите страницы из WEB-файлов прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/remove-pages/web). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
