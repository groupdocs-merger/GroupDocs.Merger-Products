...
############################# Head ############################
head_title: "Usuń VSX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSX strony w C#"
description: "Usuń strony VSX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSX za pomocą przykładowego kodu C#">}}

        ```csharp    
        // Usuń strony plików VSX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — usuń VSX strony online"
    content: |
       Usuń strony plików VSX już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/vsx).
