...
############################# Head ############################
head_title: "Eemaldage XPS lehed rakenduses C#"
head_description: "Eemaldage või kustutage üks leht või lehtede kogum failist XPS rakenduses C#, muutes lehtede järjekorra ümber, kasutades dokumentide liitmise API-t."

############################# Header ############################
title: "Eemaldage XPS lehed rakenduses C#"
description: "Eemaldage XPS lehed, millel on paar rida .NET koodi."
...
steps:
    enable: true
    title_left: "Eemaldage XPS faililehed tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks ühe või mitme konkreetse lehe kustutamise XPS-st faili, rakendades mõnda lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas eemaldada XPS faililehte, kasutades C# näitekoodi">}}
