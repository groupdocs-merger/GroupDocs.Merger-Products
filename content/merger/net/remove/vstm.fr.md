...
############################# Head ############################
head_title: "Supprimer VSTM pages dans C#"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier VSTM dans C# en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer VSTM pages dans C#"
description: "Supprimez les pages VSTM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Supprimer VSTM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de supprimer facilement une ou plusieurs pages particulières dans un VSTM fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers VSTM à l'aide de l'exemple de code C#">}}
