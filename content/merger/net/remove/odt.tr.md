...
############################# Head ############################
head_title: "C# İçindeki ODT Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir ODT dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki ODT Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren ODT Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki ODT Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir ODT içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODT dosya sayfaları nasıl kaldırılır">}}
