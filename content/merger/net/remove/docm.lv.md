...
############################# Head ############################
head_title: "Noņemt DOCM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no DOCM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt DOCM lapas programmā C#"
description: "Noņemiet DOCM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt DOCM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas DOCM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt DOCM faila lapas, izmantojot C# piemēra kodu">}}
