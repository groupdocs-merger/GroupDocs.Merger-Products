...
############################# Head ############################
head_title: "Odstrani strani VSTM v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSTM v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSTM strani v C#"
description: "Odstranite strani VSTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj VSTM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSTM s primerom kode C#">}}
