...
############################# Head ############################
head_title: "Supprimer XLSX pages dans C#"
head_description: "Supprimez ou supprimez une seule page ou une collection de pages d'un fichier XLSX dans C# en inversant l'ordre des pages à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Supprimer XLSX pages dans C#"
description: "Supprimez les pages XLSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Supprimer XLSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de supprimer facilement une ou plusieurs pages particulières dans un XLSX fichier en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment supprimer des pages de fichiers XLSX à l'aide de l'exemple de code C#">}}
