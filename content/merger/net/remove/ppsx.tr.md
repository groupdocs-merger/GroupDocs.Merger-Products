...
############################# Head ############################
head_title: "C# İçindeki PPSX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir PPSX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki PPSX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren PPSX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki PPSX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir PPSX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPSX dosya sayfaları nasıl kaldırılır">}}
