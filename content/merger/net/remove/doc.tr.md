...
############################# Head ############################
head_title: "C# İçindeki DOC Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir DOC dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki DOC Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren DOC Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki DOC Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir DOC içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosya sayfaları nasıl kaldırılır">}}
