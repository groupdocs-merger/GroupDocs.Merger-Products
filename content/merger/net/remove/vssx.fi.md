...
############################# Head ############################
head_title: "Poista VSSX sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma VSSX-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista VSSX sivut C#"
description: "Poista VSSX sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista VSSX tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja VSSX tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa VSSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
