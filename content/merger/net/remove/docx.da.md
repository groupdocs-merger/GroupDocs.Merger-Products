...
############################# Head ############################
head_title: "Fjern DOCX sider i C#"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en DOCX-fil i C# ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern DOCX sider i C#"
description: "Fjern DOCX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at slette en enkelt eller et antal bestemte sider inden for en DOCX fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du DOCX filsider ved hjælp af C# eksempelkode">}}
