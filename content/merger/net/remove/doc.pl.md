...
############################# Head ############################
head_title: "Usuń DOC strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOC w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOC strony w C#"
description: "Usuń strony DOC z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOC w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w DOC plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOC za pomocą przykładowego kodu C#">}}
