...
############################# Head ############################
head_title: "Eliminați paginile VSDM din C#"
head_description: "Eliminați sau ștergeți o singură pagină sau o colecție de pagini dintr-un fișier VSDM din C# inversând ordinea paginilor utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Eliminați VSDM pagini din C#"
description: "Eliminați paginile VSDM cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Eliminați paginile de fișiere VSDM din .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să șterge o singură pagină sau mai multe anumite pagini dintr-un VSDM fișier prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să eliminați pagini de fișiere VSDM folosind codul exemplu C#">}}
