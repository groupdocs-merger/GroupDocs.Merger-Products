...
############################# Head ############################
head_title: "Usuń XLT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku XLT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń XLT strony w C#"
description: "Usuń strony XLT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików XLT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w XLT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików XLT za pomocą przykładowego kodu C#">}}
