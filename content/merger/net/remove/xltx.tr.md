...
############################# Head ############################
head_title: "C# İçindeki XLTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLTX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTX dosya sayfaları nasıl kaldırılır">}}
