...
############################# Head ############################
head_title: "Odstrani strani EPUB v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke EPUB v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani EPUB strani v C#"
description: "Odstranite strani EPUB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke EPUB v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj EPUB datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke EPUB s primerom kode C#">}}
