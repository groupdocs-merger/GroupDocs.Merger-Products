...
############################# Head ############################
head_title: "C# میں VSX صفحات کو ہٹا دیں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے صفحات کی ترتیب کو الٹ کر C# میں VSX فائل سے ایک صفحہ یا صفحات کے مجموعہ کو ہٹا دیں یا حذف کریں۔"

############################# Header ############################
title: "C# میں VSX صفحات کو ہٹا دیں"
description: "VSX صفحات کو ہٹا دیں جن میں .NET کوڈ کی چند سطریں ہیں۔"
...
steps:
    enable: true
    title_left: ".NET میں VSX فائل صفحات کو ہٹائیں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک VSX کے اندر ایک یا متعدد مخصوص صفحات کو حذف کرنا آسان بناتا ہے۔ چند آسان اقدامات کو لاگو کرکے فائل کریں۔
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے VSX فائل کے صفحات کو کیسے ہٹایا جائے۔">}}
