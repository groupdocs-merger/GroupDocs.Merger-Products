...
############################# Head ############################
head_title: "C# İçindeki VSSM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSSM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSSM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSSM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSSM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSSM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSM dosya sayfaları nasıl kaldırılır">}}
