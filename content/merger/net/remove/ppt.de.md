...
############################# Head ############################
head_title: "PPT Seiten in C# entfernen"
head_description: "Entfernen oder löschen Sie eine einzelne Seite oder eine Sammlung von Seiten aus einer PPT-Datei in C#, indem Sie die Seitenreihenfolge mithilfe der Documents Merger API umkehren."

############################# Header ############################
title: "Entfernen Sie PPT Seiten in C#"
description: "Entfernen Sie PPT-Seiten mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Entfernen Sie PPT Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von C# das Löschen einer einzelnen oder mehrerer bestimmter Seiten innerhalb eines PPT Datei, indem Sie ein paar einfache Schritte ausführen.
    ...
    code: |
     ...
     {{< merger/code-merger title="So entfernen Sie PPT-Dateiseiten mit C#-Beispielcode">}}
