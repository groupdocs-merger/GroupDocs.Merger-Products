...
############################# Head ############################
head_title: "Fjarlægðu DOCX síður í C#"
head_description: "Fjarlægðu eða eyddu einni síðu eða safni síðna úr DOCX skrá í C# með því að snúa síðuröðinni við með því að nota skjalasamruna API."

############################# Header ############################
title: "Fjarlægðu DOCX síður í C#"
description: "Fjarlægðu DOCX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Fjarlægðu DOCX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að eyða einni eða nokkrum tilteknum síðum innan DOCX skrá með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að fjarlægja DOCX skráarsíður með því að nota C# dæmikóða">}}
