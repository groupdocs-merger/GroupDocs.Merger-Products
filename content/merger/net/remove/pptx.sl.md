...
############################# Head ############################
head_title: "Odstrani strani PPTX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPTX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPTX strani v C#"
description: "Odstranite strani PPTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj PPTX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPTX s primerom kode C#">}}
