...
############################# Head ############################
head_title: "Usuń RTF strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku RTF w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń RTF strony w C#"
description: "Usuń strony RTF z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików RTF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w RTF plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików RTF za pomocą przykładowego kodu C#">}}
