...
############################# Head ############################
head_title: "Odstrani strani PPS v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke PPS v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani PPS strani v C#"
description: "Odstranite strani PPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke PPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj PPS datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke PPS s primerom kode C#">}}
