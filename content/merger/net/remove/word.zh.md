...
############################# Head ############################
head_title: "在.NET应用程序中删除WORD页面"
head_description: "使用GroupDocs.Merger for .NET从WORD文档中删除特定页面。管理PDF、Word、Excel、PowerPoint、图像、档案等文件。"

############################# Header ############################
title: "删除WORD中的页面" 
description: "GroupDocs.Merger for .NET增强了.NET应用程序的文档处理能力，包括从WORD文件中删除页面。"
...
steps:
    ...
    title: "如何从WORD中删除页面"
    content: |
      借助[GroupDocs.Merger](/merger/net/)，您可以从WORD文件中删除页面。轻松为您的.NET应用程序添加文档管理功能。
