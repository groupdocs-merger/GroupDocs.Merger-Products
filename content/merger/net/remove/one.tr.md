...
############################# Head ############################
head_title: "C# İçindeki ONE Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir ONE dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki ONE Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren ONE Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki ONE Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir ONE içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosya sayfaları nasıl kaldırılır">}}
