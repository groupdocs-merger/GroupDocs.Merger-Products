...
############################# Head ############################
head_title: "Usuń OTP strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku OTP w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń OTP strony w C#"
description: "Usuń strony OTP z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików OTP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w OTP plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików OTP za pomocą przykładowego kodu C#">}}
