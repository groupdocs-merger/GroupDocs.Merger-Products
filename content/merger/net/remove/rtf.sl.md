...
############################# Head ############################
head_title: "Odstrani strani RTF v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke RTF v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani RTF strani v C#"
description: "Odstranite strani RTF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke RTF v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj RTF datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke RTF s primerom kode C#">}}
