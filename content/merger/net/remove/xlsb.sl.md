...
############################# Head ############################
head_title: "Odstrani strani XLSB v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLSB v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLSB strani v C#"
description: "Odstranite strani XLSB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLSB v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj XLSB datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLSB s primerom kode C#">}}
