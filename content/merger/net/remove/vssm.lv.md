...
############################# Head ############################
head_title: "Noņemt VSSM lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no VSSM faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt VSSM lapas programmā C#"
description: "Noņemiet VSSM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt VSSM faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas VSSM ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt VSSM faila lapas, izmantojot C# piemēra kodu">}}
