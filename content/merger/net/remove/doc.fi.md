...
############################# Head ############################
head_title: "Poista DOC sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma DOC-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista DOC sivut C#"
description: "Poista DOC sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista DOC tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja DOC tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa DOC tiedostosivua käyttämällä C# esimerkkikoodia">}}
