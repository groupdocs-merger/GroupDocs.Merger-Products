...
############################# Head ############################
head_title: "Usuń DOT strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOT w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOT strony w C#"
description: "Usuń strony DOT z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w DOT plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOT za pomocą przykładowego kodu C#">}}
