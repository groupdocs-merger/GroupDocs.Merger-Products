...
############################# Head ############################
head_title: "Poista XLTM sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLTM-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLTM sivut C#"
description: "Poista XLTM sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista XLTM tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLTM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
