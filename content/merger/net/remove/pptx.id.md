...
############################# Head ############################
head_title: "Hapus PPTX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file PPTX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus PPTX Halaman Di C#"
description: "Hapus PPTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus PPTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam PPTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file PPTX menggunakan kode contoh C#">}}
