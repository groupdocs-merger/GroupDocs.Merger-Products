...
############################# Head ############################
head_title: "Hapus halaman PPTX dalam aplikasi .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk menghapus halaman tertentu dari dokumen PPTX. Kelola PDF, Word, Excel, PowerPoint, gambar, arsip, dan lainnya dengan baik."

############################# Header ############################
title: "Hapus halaman di PPTX" 
description: "GroupDocs.Merger for .NET meningkatkan aplikasi .NET dengan kemampuan pemrosesan dokumen yang kuat, termasuk menghapus halaman dari file PPTX."
...
steps:
    ...
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), Anda dapat menghapus halaman dari file PPTX. Tambahkan fungsionalitas manajemen dokumen ke aplikasi .NET Anda tanpa kesulitan.
