...
############################# Head ############################
head_title: "Usuń DOCM strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku DOCM w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń DOCM strony w C#"
description: "Usuń strony DOCM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików DOCM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w DOCM plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików DOCM za pomocą przykładowego kodu C#">}}
