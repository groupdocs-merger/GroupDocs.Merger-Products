...
############################# Head ############################
head_title: "Poista MHTML sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma MHTML-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista MHTML sivut C#"
description: "Poista MHTML sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista MHTML tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja MHTML tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa MHTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
