...
############################# Head ############################
head_title: "Odstrani strani DOC v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOC v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOC strani v C#"
description: "Odstranite strani DOC z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOC v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj DOC datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOC s primerom kode C#">}}
