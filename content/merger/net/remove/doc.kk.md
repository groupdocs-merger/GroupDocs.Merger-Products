...
############################# Head ############################
head_title: "C# ішіндегі DOC беттерді жою"
head_description: "Құжаттарды біріктіру API арқылы беттер ретін өзгерту арқылы C# ішіндегі DOC файлынан бір бетті немесе беттер жинағын жойыңыз немесе жойыңыз."

############################# Header ############################
title: "C# ішіндегі DOC беттерді жою"
description: ".NET кодының бірнеше жолы бар DOC беттерді алып тастаңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі DOC файл бетін жою"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне DOC ішіндегі бір немесе бірнеше нақты беттерді жоюды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы файлды ашыңыз.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC файл бетін C# мысал кодын пайдаланып жою жолы">}}
