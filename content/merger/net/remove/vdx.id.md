...
head_title: "Hapus Halaman VDX di C# .NET | Hapus Halaman dari VDX File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file VDX menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari VDX di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file VDX menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File VDX di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file VDX dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Hapus VDX Halaman Dokumen Online"
    content: |
        Hapus halaman dalam file VDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/VDX).
