...
############################# Head ############################
head_title: "C# İçindeki XLTM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLTM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLTM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLTM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLTM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLTM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTM dosya sayfaları nasıl kaldırılır">}}
