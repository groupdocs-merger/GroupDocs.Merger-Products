...
############################# Head ############################
head_title: "Verwyder VSSM bladsye in C#"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n VSSM-lêer in C# deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder VSSM bladsye in C#"
description: "Verwyder VSSM Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verwyder VSSM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele of 'n aantal spesifieke bladsye binne 'n VSSM uit te vee lêer deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSM lêerbladsye te verwyder deur C# voorbeeldkode te gebruik">}}
