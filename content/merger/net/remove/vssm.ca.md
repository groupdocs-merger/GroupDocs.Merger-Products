...
############################# Head ############################
head_title: "Suprimeix VSSM pàgines a C#"
head_description: "Elimineu o suprimiu una sola pàgina o col·lecció de pàgines d'un fitxer VSSM a C# invertint l'ordre de les pàgines mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Suprimeix VSSM pàgines a C#"
description: "Elimineu VSSM pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Suprimeix VSSM pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) fa que sigui fàcil per als desenvolupadors de C# eliminar una o diverses pàgines concretes dins d'un VSSM fitxer implementant uns quants passos senzills.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com eliminar pàgines de fitxers VSSM utilitzant el codi d'exemple C#">}}
