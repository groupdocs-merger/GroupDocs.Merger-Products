...
############################# Head ############################
head_title: "Delete DOT Pages in C# .NET | Remove Pages from DOT File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a DOT file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From DOT in .NET"
description: "Delete or Remove a single page or collection of pages from a DOT file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove DOT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a DOT file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within DOT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/dot) website.
