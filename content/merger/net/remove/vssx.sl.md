...
############################# Head ############################
head_title: "Odstrani strani VSSX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke VSSX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani VSSX strani v C#"
description: "Odstranite strani VSSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke VSSX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj VSSX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke VSSX s primerom kode C#">}}
