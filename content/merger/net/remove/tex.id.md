...
############################# Head ############################
head_title: "Hapus TEX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file TEX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus TEX Halaman Di C#"
description: "Hapus TEX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus TEX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam TEX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file TEX menggunakan kode contoh C#">}}
