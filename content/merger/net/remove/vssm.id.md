...
############################# Head ############################
head_title: "Hapus VSSM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file VSSM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus VSSM Halaman Di C#"
description: "Hapus VSSM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus VSSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam VSSM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file VSSM menggunakan kode contoh C#">}}
