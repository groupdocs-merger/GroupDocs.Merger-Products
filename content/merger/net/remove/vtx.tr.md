...
############################# Head ############################
head_title: "C# İçindeki VTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VTX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VTX dosya sayfaları nasıl kaldırılır">}}
