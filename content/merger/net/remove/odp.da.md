...
############################# Head ############################
head_title: "Fjern ODP sider i C#"
head_description: "Fjern eller slet en enkelt side eller samling af sider fra en ODP-fil i C# ved at vende sidernes rækkefølge ved hjælp af documents merger API."

############################# Header ############################
title: "Fjern ODP sider i C#"
description: "Fjern ODP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Fjern ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at slette en enkelt eller et antal bestemte sider inden for en ODP fil ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan fjerner du ODP filsider ved hjælp af C# eksempelkode">}}
