...
############################# Head ############################
head_title: "C# İçindeki XLSX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLSX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLSX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLSX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLSX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLSX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSX dosya sayfaları nasıl kaldırılır">}}
