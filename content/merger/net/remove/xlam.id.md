...
############################# Head ############################
head_title: "Hapus XLAM Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLAM di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLAM Halaman Di C#"
description: "Hapus XLAM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLAM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLAM file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLAM menggunakan kode contoh C#">}}
