...
############################# Head ############################
head_title: "Hapus IMAGE Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file IMAGE di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus IMAGE Halaman Di C#"
description: "Hapus IMAGE Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus IMAGE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam IMAGE file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file IMAGE menggunakan kode contoh C#">}}
