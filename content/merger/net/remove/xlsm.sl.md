...
############################# Head ############################
head_title: "Odstrani strani XLSM v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke XLSM v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani XLSM strani v C#"
description: "Odstranite strani XLSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke XLSM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj XLSM datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke XLSM s primerom kode C#">}}
