...
############################# Head ############################
head_title: "Noņemt RTF lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no RTF faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt RTF lapas programmā C#"
description: "Noņemiet RTF lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt RTF faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas RTF ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt RTF faila lapas, izmantojot C# piemēra kodu">}}
