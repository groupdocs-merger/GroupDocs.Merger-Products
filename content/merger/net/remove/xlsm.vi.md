...
############################# Head ############################
head_title: "Xóa XLSM Trang trong C#"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp XLSM trong C# bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa XLSM Trang trong C#"
description: "Xóa các trang XLSM có một vài dòng mã .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp XLSM bằng mã mẫu C#">}}
