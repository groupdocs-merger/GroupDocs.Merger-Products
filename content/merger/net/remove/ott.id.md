...
############################# Head ############################
head_title: "Hapus OTT Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file OTT di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus OTT Halaman Di C#"
description: "Hapus OTT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus OTT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam OTT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file OTT menggunakan kode contoh C#">}}
