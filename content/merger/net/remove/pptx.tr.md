...
############################# Head ############################
head_title: "C# İçindeki PPTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir PPTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki PPTX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren PPTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki PPTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir PPTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosya sayfaları nasıl kaldırılır">}}
