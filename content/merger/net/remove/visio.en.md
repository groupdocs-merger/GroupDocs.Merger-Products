...
############################# Head ############################
head_title: "Remove VISIO pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to delete specific pages from VISIO documents. Easily manage PDF, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages in VISIO" 
description: "GroupDocs.Merger for .NET enhances .NET apps with powerful document processing capabilities, including removing pages from VISIO files."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily delete pages from VISIO files. Add document management functionality to your .NET applications effortlessly.
