...
############################# Head ############################
head_title: "Xóa MHTML Trang trong C#"
head_description: "Xóa hoặc xóa một trang hoặc tập hợp các trang khỏi tệp MHTML trong C# bằng cách đảo ngược thứ tự các trang bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Xóa MHTML Trang trong C#"
description: "Xóa các trang MHTML có một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Xóa MHTML Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng xóa một hoặc một số trang cụ thể trong MHTML bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xóa các trang tệp MHTML bằng mã mẫu C#">}}
