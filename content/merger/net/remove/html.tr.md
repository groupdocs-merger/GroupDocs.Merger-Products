...
############################# Head ############################
head_title: "C# İçindeki HTML Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir HTML dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki HTML Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren HTML Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki HTML Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir HTML içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak HTML dosya sayfaları nasıl kaldırılır">}}
