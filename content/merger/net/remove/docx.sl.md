...
############################# Head ############################
head_title: "Odstrani strani DOCX v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke DOCX v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani DOCX strani v C#"
description: "Odstranite strani DOCX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke DOCX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj DOCX datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke DOCX s primerom kode C#">}}
