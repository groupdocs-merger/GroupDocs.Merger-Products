...
############################# Head ############################
head_title: "删除 C# 中的 VDX 个页面"
head_description: "通过使用文档合并 API 反转页面顺序，从 C# 中的 VDX 文件中删除或删除单个页面或页面集合。"

############################# Header ############################
title: "删除 C# 中的 VDX 页"
description: "删除包含几行 .NET 代码的 VDX 页面。"
...
steps:
    enable: true
    title_left: "删除 .NET 中的 VDX 个文件页"
    content_left: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 使 C# 开发人员可以轻松删除 VDX 中的单个或多个特定页面通过执行几个简单的步骤来创建文件。
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码删除 VDX 文件页面">}}
