...
############################# Head ############################
head_title: "Odstrani strani ONE v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke ONE v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani ONE strani v C#"
description: "Odstranite strani ONE z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke ONE v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj ONE datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke ONE s primerom kode C#">}}
