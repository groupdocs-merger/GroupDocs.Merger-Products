...
############################# Head ############################
head_title: "Odstrániť VSTX stránky v C#"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru VSTX v C# obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť VSTX stránky v C#"
description: "Odstráňte VSTX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Odstrániť VSTX stránky súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# odstrániť jednu alebo viacero konkrétnych stránok v rámci VSTX súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru VSTX pomocou vzorového kódu C#">}}
