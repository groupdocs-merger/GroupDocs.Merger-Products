...
############################# Head ############################
head_title: "Usuń ONE strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku ONE w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń ONE strony w C#"
description: "Usuń strony ONE z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików ONE w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w ONE plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików ONE za pomocą przykładowego kodu C#">}}
