...
############################# Head ############################
head_title: "C# İçindeki VDX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VDX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VDX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VDX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VDX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VDX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VDX dosya sayfaları nasıl kaldırılır">}}
