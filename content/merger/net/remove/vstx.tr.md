...
############################# Head ############################
head_title: "C# İçindeki VSTX Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir VSTX dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki VSTX Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren VSTX Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSTX Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir VSTX içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTX dosya sayfaları nasıl kaldırılır">}}
