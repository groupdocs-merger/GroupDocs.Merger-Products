...
############################# Head ############################
head_title: "Κατάργηση ODP σελίδων στο C#"
head_description: "Καταργήστε ή διαγράψτε μια μεμονωμένη σελίδα ή μια συλλογή σελίδων από ένα αρχείο ODP στο C# αντιστρέφοντας τη σειρά των σελίδων χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Κατάργηση ODP σελίδων στο C#"
description: "Καταργήστε ODP Σελίδες με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Κατάργηση σελίδων αρχείου ODP στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να διαγράψουν μία ή περισσότερες συγκεκριμένες σελίδες μέσα σε ένα ODP αρχείο εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να αφαιρέσετε ODP σελίδες αρχείου χρησιμοποιώντας παράδειγμα κώδικα C#">}}
