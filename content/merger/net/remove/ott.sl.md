...
############################# Head ############################
head_title: "Odstrani strani OTT v C#"
head_description: "Odstranite ali izbrišite eno stran ali zbirko strani iz datoteke OTT v C# tako, da obrnete vrstni red strani z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Odstrani OTT strani v C#"
description: "Odstranite strani OTT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Odstrani strani datoteke OTT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša brisanje ene ali več določenih strani znotraj OTT datoteko tako, da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako odstraniti strani datoteke OTT s primerom kode C#">}}
