...
############################# Head ############################
head_title: "C# İçindeki XLAM Sayfayı Kaldır"
head_description: "Belge birleştirme API'sini kullanarak sayfa sırasını tersine çevirerek C# içindeki bir XLAM dosyasından tek bir sayfayı veya sayfa koleksiyonunu kaldırın veya silin."

############################# Header ############################
title: "C# İçindeki XLAM Sayfayı Kaldır"
description: "Birkaç satır .NET kodu içeren XLAM Sayfasını kaldırın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLAM Dosya Sayfalarını Kaldırın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin bir XLAM içindeki tek veya birkaç belirli sayfayı silmesini kolaylaştırır birkaç kolay adımı uygulayarak dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLAM dosya sayfaları nasıl kaldırılır">}}
