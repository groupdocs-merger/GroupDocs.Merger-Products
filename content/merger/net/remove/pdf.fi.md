...
############################# Head ############################
head_title: "Poista PDF sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma PDF-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista PDF sivut C#"
description: "Poista PDF sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista PDF tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja PDF tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa PDF tiedostosivua käyttämällä C# esimerkkikoodia">}}
