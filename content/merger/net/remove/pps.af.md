...
############################# Head ############################
head_title: "Verwyder PPS bladsye in C#"
head_description: "Verwyder of skrap 'n enkele bladsy of versameling bladsye uit 'n PPS-lêer in C# deur die bladsyvolgorde om te keer deur die dokumentsamesmeltings-API te gebruik."

############################# Header ############################
title: "Verwyder PPS bladsye in C#"
description: "Verwyder PPS Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verwyder PPS lêerbladsye in .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPS lêerbladsye te verwyder deur C# voorbeeldkode te gebruik">}}
