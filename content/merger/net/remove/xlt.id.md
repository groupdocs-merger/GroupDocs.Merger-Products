...
############################# Head ############################
head_title: "Hapus XLT Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLT di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLT Halaman Di C#"
description: "Hapus XLT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLT file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLT menggunakan kode contoh C#">}}
