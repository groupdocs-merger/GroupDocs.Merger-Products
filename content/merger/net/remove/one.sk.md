...
############################# Head ############################
head_title: "Odstrániť ONE stránky v C#"
head_description: "Odstráňte alebo odstráňte jednu stránku alebo kolekciu stránok zo súboru ONE v C# obrátením poradia stránok pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Odstrániť ONE stránky v C#"
description: "Odstráňte ONE stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Odstrániť ONE stránky súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# odstrániť jednu alebo viacero konkrétnych stránok v rámci ONE súbor vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako odstrániť stránky súboru ONE pomocou vzorového kódu C#">}}
