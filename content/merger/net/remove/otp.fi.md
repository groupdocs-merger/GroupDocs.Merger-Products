...
############################# Head ############################
head_title: "Poista OTP sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma OTP-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista OTP sivut C#"
description: "Poista OTP sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista OTP tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja OTP tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa OTP tiedostosivua käyttämällä C# esimerkkikoodia">}}
