...
############################# Head ############################
head_title: "Remove WORKSHEET Pages in C#"
head_description: "Remove or delete a single page or collection of pages from a WORKSHEET file in C# by reversing the pages order using the documents merger API."

############################# Header ############################
title: "Remove WORKSHEET Pages In C#"
description: "Remove WORKSHEET Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to delete a single or a number of particular pages within a WORKSHEET file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to remove WORKSHEET file pages using C# example code">}}
