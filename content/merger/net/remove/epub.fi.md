...
############################# Head ############################
head_title: "Poista EPUB sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma EPUB-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista EPUB sivut C#"
description: "Poista EPUB sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista EPUB tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja EPUB tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa EPUB tiedostosivua käyttämällä C# esimerkkikoodia">}}
