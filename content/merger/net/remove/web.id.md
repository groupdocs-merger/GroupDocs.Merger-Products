...
############################# Head ############################
head_title: "Hapus WEB Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file WEB di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus WEB Halaman Di C#"
description: "Hapus WEB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus WEB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam WEB file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file WEB menggunakan kode contoh C#">}}
