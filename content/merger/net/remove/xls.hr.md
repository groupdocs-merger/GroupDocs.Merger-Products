...
############################# Head ############################
head_title: "Ukloni XLS stranice u C#"
head_description: "Uklonite ili izbrišite jednu stranicu ili kolekciju stranica iz XLS datoteke u C# obrnutim redoslijedom stranica pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ukloni XLS stranice u C#"
description: "Ukloni XLS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ukloni XLS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava brisanje jedne ili više određenih stranica unutar XLS datoteku provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ukloniti XLS stranice datoteke koristeći C# primjer koda">}}
