...
############################# Head ############################
head_title: "Hapus OTP Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file OTP di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus OTP Halaman Di C#"
description: "Hapus OTP Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus OTP Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam OTP file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file OTP menggunakan kode contoh C#">}}
