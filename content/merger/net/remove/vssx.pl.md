...
############################# Head ############################
head_title: "Usuń VSSX strony w C#"
head_description: "Usuń lub usuń pojedynczą stronę lub zbiór stron z pliku VSSX w C#, odwracając kolejność stron za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Usuń VSSX strony w C#"
description: "Usuń strony VSSX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Usuń strony plików VSSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# usunięcie jednej lub kilku określonych stron w VSSX plik, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak usunąć strony plików VSSX za pomocą przykładowego kodu C#">}}
