...
############################# Head ############################
head_title: "Noņemt ODS lapas programmā C#"
head_description: "Noņemiet vai izdzēsiet vienu lapu vai lapu kolekciju no ODS faila programmā C#, apgriežot lapu secību, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Noņemt ODS lapas programmā C#"
description: "Noņemiet ODS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Noņemt ODS faila lapas no .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli izdzēst vienu vai vairākas noteiktas lapas ODS ietvaros. failu, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā noņemt ODS faila lapas, izmantojot C# piemēra kodu">}}
