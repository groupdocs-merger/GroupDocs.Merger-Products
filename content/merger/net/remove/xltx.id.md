...
############################# Head ############################
head_title: "Hapus XLTX Halaman di C#"
head_description: "Hapus atau hapus satu halaman atau kumpulan halaman dari file XLTX di C# dengan membalik urutan halaman menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Hapus XLTX Halaman Di C#"
description: "Hapus XLTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Hapus XLTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menghapus satu atau beberapa halaman tertentu dalam XLTX file dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menghapus halaman file XLTX menggunakan kode contoh C#">}}
