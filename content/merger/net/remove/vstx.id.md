...
head_title: "Hapus Halaman VSTX di C# .NET | Hapus Halaman dari VSTX File"
head_description: "Pengguna C# .NET untuk menghapus atau menghapus satu halaman atau kumpulan halaman dari file VSTX menggunakan dokumen merger dan split API."

title: "Hapus atau Hapus Halaman Dari VSTX di .NET"
description: "Hapus atau Hapus satu halaman atau kumpulan halaman dari file VSTX menggunakan dokumen merger & split API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Hapus Halaman File VSTX di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menghapus satu atau beberapa halaman dalam file VSTX dengan menerapkan beberapa langkah mudah.
