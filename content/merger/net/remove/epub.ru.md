...
############################# Head ############################
head_title: "Удалить EPUB страницы на C#"
head_description: "Удалите одну или набор страниц из файла EPUB на C#, изменив порядок страниц с помощью Merger API."

############################# Header ############################
title: "Удалить EPUB страницы на C#"
description: "Удалите EPUB страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Удалить страницы EPUB документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) упрощает для разработчиков C# удаление одной или нескольких определенных страниц для EPUB документа, выполнив несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как удалить страницы EPUB документов, используя пример кода C#">}}

        ```csharp    
        // Удалите страницы EPUB документов с помощью GroupDocs.Merger API
...
demos:
    enable: true
    title: "Живые демонстрации – удаление EPUB страниц онлайн"
    content: |
       Удалите страницы EPUB документов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/splitter/remove-pages/epub).
