...
############################# Head ############################
head_title: "ลบ HTML หน้าใน C#"
head_description: "ลบหรือลบหน้าเดียวหรือคอลเลกชันของหน้าจากไฟล์ HTML ใน C# โดยเปลี่ยนลำดับหน้าโดยใช้ API การควบรวมเอกสาร"

############################# Header ############################
title: "ลบ HTML หน้าใน C#"
description: "ลบ HTML หน้าที่มีโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "ลบหน้าไฟล์ HTML ใน .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา C# ลบหน้าเดียวหรือบางหน้าภายใน HTML ได้อย่างง่ายดาย ไฟล์โดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีลบหน้าไฟล์ HTML โดยใช้โค้ดตัวอย่าง C#">}}
