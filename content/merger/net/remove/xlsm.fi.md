...
############################# Head ############################
head_title: "Poista XLSM sivut C#"
head_description: "Poista tai poista yksittäinen sivu tai sivukokoelma XLSM-tiedostosta C#:ssa kääntämällä sivujen järjestys päinvastaiseksi käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Poista XLSM sivut C#"
description: "Poista XLSM sivut, joissa on muutama rivi .NET-koodia."
...
steps:
    enable: true
    title_left: "Poista XLSM tiedostosivut tuotteesta .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi poistaa yhden tai useita tiettyjä sivuja XLSM tiedosto toteuttamalla muutama helppo vaihe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka poistaa XLSM tiedostosivua käyttämällä C# esimerkkikoodia">}}
