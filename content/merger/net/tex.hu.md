...
############################# Head ############################
head_title: "TEX fájlok egyesítése a C#-ban | TEX Egyesülés"
head_description: "Egyesítsen több TEX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "TEX Egyesülés a C# programban"
description: "Egyesítse a(z) TEX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több TEX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több TEX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen TEX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több TEX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) webhely meglátogatásával.
