...
############################# Head ############################
head_title: "Pelên EPUB di C# de bike yek | EPUB Hevgirtin"
head_description: "Gelek pelên EPUB di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "EPUB Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek EPUB Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir EPUB pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên EPUB bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên EPUB bi karanîna GroupDocs.Merger API-ê bikin yek
