...
############################# Head ############################
head_title: "Voeg XLT lêers saam in C# | XLT samesmelting"
head_description: "Voeg veelvuldige XLT lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "XLT samesmelting in C#"
description: "Voeg XLT saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige XLT-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XLT-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg XLT lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een XLT-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) webwerf te besoek.
