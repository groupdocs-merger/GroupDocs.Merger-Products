...
############################# Head ############################
head_title: "DOT Dosyalarını C# İçinde Birleştir | DOT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOT dosyalarını birleştirin
