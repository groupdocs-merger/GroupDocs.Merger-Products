...
############################# Head ############################
head_title: "Ühendage JPEG failid C# | JPEG Ühinemine"
head_description: "Ühendage mitu JPEG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "JPEG ühinemine programmis C#"
description: "Ühendage JPEG mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam JPEG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita JPEG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid JPEG, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks JPEG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
