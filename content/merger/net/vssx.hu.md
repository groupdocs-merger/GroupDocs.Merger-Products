...
############################# Head ############################
head_title: "VSSX fájlok egyesítése a C#-ban | VSSX Egyesülés"
head_description: "Egyesítsen több VSSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSSX Egyesülés a C# programban"
description: "Egyesítse a(z) VSSX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSSX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSSX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSSX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSSX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) webhely meglátogatásával.
