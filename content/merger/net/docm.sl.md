...
############################# Head ############################
head_title: "Spoji datoteke DOCM v C# | DOCM Združitev"
head_description: "Spojite več datotek DOCM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "DOCM Združitev v C#"
description: "Spojite DOCM z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek DOCM znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCM s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke DOCM z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Združite več kot eno datoteko DOCM tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
