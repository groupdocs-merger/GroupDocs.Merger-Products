...
############################# Head ############################
head_title: "Liituge ODP failidega rakenduses C# | ODP Ühinemine"
head_description: "Ühendage mitu ODP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge ODP failiga rakenduses C#"
description: "Liituge tootega ODP mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu ODP faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama ODP faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ODP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil ODP failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe ODP failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
