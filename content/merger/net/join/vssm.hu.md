...
############################# Head ############################
head_title: "Csatlakozás VSSM fájlokhoz a C# nyelven | VSSM Egyesülés"
head_description: "Csatlakoztasson több VSSM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSSM fájlhoz itt: C#"
description: "Csatlakozzon az VSSM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSSM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSSM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSSM fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti VSSM dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSSM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) webhely meglátogatásával.
