...
############################# Head ############################
head_title: "Prisijunkite prie BMP failų C# | BMP Susijungimas"
head_description: "Sujunkite kelis BMP failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie BMP failų C#"
description: "Prisijunkite prie BMP naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių BMP failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau BMP failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti BMP failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite BMP failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties BMP dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno BMP failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) svetainėje.
