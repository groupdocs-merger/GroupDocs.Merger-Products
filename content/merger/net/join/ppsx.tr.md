...
############################# Head ############################
head_title: "C#'da PPSX Dosyalarına Katılın | PPSX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PPSX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki PPSX Dosyaya Katılın"
description: "Birkaç satır .NET koduyla PPSX'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla PPSX Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla PPSX dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPSX dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPSX dosyalarına katılın
