...
############################# Head ############################
head_title: "Junte XLSM Arquivos em C# | XLSM Fusão"
head_description: "Junte vários arquivos XLSM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLSM arquivos em C#"
description: "Junte-se a XLSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLSM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLSM usando a API GroupDocs.Merger
