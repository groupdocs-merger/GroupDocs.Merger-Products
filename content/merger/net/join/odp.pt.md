...
############################# Head ############################
head_title: "Junte ODP Arquivos em C# | ODP Fusão"
head_description: "Junte vários arquivos ODP em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a ODP arquivos em C#"
description: "Junte-se a ODP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos ODP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos ODP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos ODP usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos ODP usando a API GroupDocs.Merger
