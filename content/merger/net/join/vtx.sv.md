...
############################# Head ############################
head_title: "Gå med i VTX-filer i C# | VTX Sammanslagning"
head_description: "Sammanfoga flera VTX-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i VTX-filer i C#"
description: "Gå med i VTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera VTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera VTX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i VTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i VTX-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en VTX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
