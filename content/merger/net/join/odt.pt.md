...
############################# Head ############################
head_title: "Junte ODT Arquivos em C# | ODT Fusão"
head_description: "Junte vários arquivos ODT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a ODT arquivos em C#"
description: "Junte-se a ODT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos ODT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos ODT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos ODT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos ODT usando a API GroupDocs.Merger
