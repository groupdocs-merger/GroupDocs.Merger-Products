...
############################# Head ############################
head_title: "Gabung VSSX File di C# | VSSX Penggabungan"
head_description: "Gabungkan beberapa file VSSX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSSX File Di C#"
description: "Bergabunglah dengan VSSX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSSX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VSSX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu VSSX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/vssx).
