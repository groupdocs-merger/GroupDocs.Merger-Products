...
############################# Head ############################
head_title: "Csatlakozás XLSX fájlokhoz a C# nyelven | XLSX Egyesülés"
head_description: "Csatlakoztasson több XLSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLSX fájlhoz itt: C#"
description: "Csatlakozzon az XLSX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLSX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLSX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLSX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLSX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) webhely meglátogatásával.
