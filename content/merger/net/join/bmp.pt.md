...
############################# Head ############################
head_title: "Junte BMP Arquivos em C# | BMP Fusão"
head_description: "Junte vários arquivos BMP em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a BMP arquivos em C#"
description: "Junte-se a BMP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos BMP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos BMP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos BMP usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos BMP usando a API GroupDocs.Merger
