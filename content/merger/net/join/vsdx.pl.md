...
############################# Head ############################
head_title: "Dołącz do VSDX plików w C# | VSDX Połączenie"
head_description: "Połącz wiele plików VSDX w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do VSDX plików w C#"
description: "Dołącz do VSDX za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików VSDX"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików VSDX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików VSDX za pomocą GroupDocs.Merger API
