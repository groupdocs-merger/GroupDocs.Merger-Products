...
############################# Head ############################
head_title: "Pievienojieties PPSX failiem programmā C# | PPSX Apvienošanās"
head_description: "Apvienojiet vairākus PPSX failus vienā failā, izmantojot C# .NET dokumentu apvienošanas API. Savienojiet noteiktas lapas vai lapu diapazonus no dažādiem dokumentiem līdz vienam dokumentam."

############################# Header ############################
title: "Pievienojieties PPSX failiem programmā C#"
description: "Pievienojieties PPSX, izmantojot dažas .NET koda rindiņas."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) nodrošina ērtu risinājumu, lai savienotu vairākus PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlus un daudzus citus dokumentus vienā failā .NET lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts pievienoties PPSX dokumentiem — nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt savu laiku un manuāli apvienot failus! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Kā pievienoties vairākiem PPSX failiem"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj .NET izstrādātājiem viegli savienot divus vai vairākus PPSX failus savās lietojumprogrammās, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā savienot PPSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Pievienojieties PPSX failiem, izmantojot GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pievienojieties vairāk nekā vienam PPSX failam tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
