...
############################# Head ############################
head_title: "Pridružite ODS datotekama u C# | ODS Spajanje"
head_description: "Spojite više ODS datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite ODS datotekama u C#"
description: "Pridružite se ODS s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODS datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite ODS datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne ODS datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
