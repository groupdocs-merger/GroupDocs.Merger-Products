...
############################# Head ############################
head_title: "Deltag i HTML filer i C# | HTML Fusion"
head_description: "Sammenføj flere HTML filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i HTML filer i C#"
description: "Slut dig til HTML med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere HTML-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere HTML-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du HTML filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i HTML filer ved hjælp af GroupDocs.Merger API
