...
############################# Head ############################
head_title: "C#'da XLT Dosyalarına Katılın | XLT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki XLT Dosyaya Katılın"
description: "Birkaç satır .NET koduyla XLT'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla XLT Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla XLT dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLT dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLT dosyalarına katılın
