...
############################# Head ############################
head_title: "Prisijunkite prie TXT failų C# | TXT Susijungimas"
head_description: "Sujunkite kelis TXT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie TXT failų C#"
description: "Prisijunkite prie TXT naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių TXT failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau TXT failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti TXT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite TXT failus naudodami GroupDocs.Merger API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno TXT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) svetainėje.
