...
############################# Head ############################
head_title: "Joindre les fichiers MHT dans C# | MHT Fusion"
head_description: "Joignez plusieurs fichiers MHT en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Joignez des pages spécifiques ou des plages de pages de divers documents à un seul document."

############################# Header ############################
title: "Joindre MHT fichiers dans C#"
description: "Joignez MHT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment joindre plusieurs fichiers MHT"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de joindre facilement deux ou plusieurs fichiers MHT dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment joindre des fichiers MHT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Joindre MHT fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Joignez-vous à plusieurs fichiers MHT dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
