...
############################# Head ############################
head_title: "Pridružite HTML datotekama u C# | HTML Spajanje"
head_description: "Spojite više HTML datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite HTML datotekama u C#"
description: "Pridružite se HTML s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti HTML datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite HTML datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne HTML datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
