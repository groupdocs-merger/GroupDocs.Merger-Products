...
############################# Head ############################
head_title: "Sertai XPS Fail dalam C# | XPS Penggabungan"
head_description: "Sertai berbilang fail XPS ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Sertai halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Sertai XPS Fail Dalam C#"
description: "Sertai XPS dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menyertai Berbilang XPS Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menyertai dua atau lebih XPS fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail XPS menggunakan kod contoh C#.">}}

        ```csharp    
        // Sertai XPS fail menggunakan API GroupDocs.Merger
