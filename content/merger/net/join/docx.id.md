...
############################# Head ############################
head_title: "Gabung DOCX File di C# | DOCX Penggabungan"
head_description: "Gabungkan beberapa file DOCX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung DOCX File Di C#"
description: "Bergabunglah dengan DOCX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file DOCX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file DOCX menggunakan GroupDocs.Merger API
