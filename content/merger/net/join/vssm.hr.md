...
############################# Head ############################
head_title: "Pridružite VSSM datotekama u C# | VSSM Spajanje"
head_description: "Spojite više VSSM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VSSM datotekama u C#"
description: "Pridružite se VSSM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSSM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VSSM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VSSM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
