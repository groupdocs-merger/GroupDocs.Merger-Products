...
############################# Head ############################
head_title: "Deltag i BMP filer i C# | BMP Fusion"
head_description: "Sammenføj flere BMP filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i BMP filer i C#"
description: "Slut dig til BMP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere BMP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere BMP-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du BMP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i BMP filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slut dig til mere end én BMP-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
