...
############################# Head ############################
head_title: "Pridružite se datotekam PPTX v C# | PPTX Združitev"
head_description: "Združite več datotek PPTX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PPTX v C#"
description: "Pridružite se PPTX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PPTX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
