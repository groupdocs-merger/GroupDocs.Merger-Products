...
############################# Head ############################
head_title: "Deltag i PPSX filer i C# | PPSX Fusion"
head_description: "Sammenføj flere PPSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i PPSX filer i C#"
description: "Slut dig til PPSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere PPSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere PPSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du PPSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i PPSX filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input PPSX dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én PPSX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
