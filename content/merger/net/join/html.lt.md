...
############################# Head ############################
head_title: "Prisijunkite prie HTML failų C# | HTML Susijungimas"
head_description: "Sujunkite kelis HTML failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie HTML failų C#"
description: "Prisijunkite prie HTML naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių HTML failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau HTML failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti HTML failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite HTML failus naudodami GroupDocs.Merger API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno HTML failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) svetainėje.
