...
############################# Head ############################
head_title: "เข้าร่วม VSDX ไฟล์ใน C# | VSDX การควบรวมกิจการ"
head_description: "รวมไฟล์ VSDX หลายไฟล์เป็นไฟล์เดียวโดยใช้ API การรวมเอกสาร C# .NET รวมหน้าหรือช่วงหน้าเฉพาะจากเอกสารต่างๆ เป็นเอกสารเดียว"

############################# Header ############################
title: "เข้าร่วม VSDX ไฟล์ใน C#"
description: "เข้าร่วม VSDX ด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "วิธีเข้าร่วมไฟล์ VSDX หลายไฟล์"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา .NET เข้าร่วมไฟล์ VSDX สองไฟล์ขึ้นไปภายในแอปพลิเคชันได้โดยง่ายโดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีเข้าร่วมไฟล์ VSDX โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // เข้าร่วม VSDX ไฟล์โดยใช้ GroupDocs.Merger API
        // ยกตัวอย่างการควบรวมกิจการด้วยการป้อนข้อมูล VSDX เอกสาร
...
demos:
    ...
    content: |
       เข้าร่วมมากกว่าหนึ่ง VSDX ไฟล์ในขณะนี้โดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx)
