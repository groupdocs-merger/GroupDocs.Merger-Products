...
############################# Head ############################
head_title: "Pridružite se datotekam DOTX v C# | DOTX Združitev"
head_description: "Združite več datotek DOTX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam DOTX v C#"
description: "Pridružite se DOTX z nekaj vrsticami kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOTX s primerom kode C#">}}
        ...
        ```csharp    
        // Združite datoteke DOTX z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Pridružite se več kot eni DOTX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx).
