...
############################# Head ############################
head_title: "Joindre les fichiers VSSM dans C# | VSSM Fusion"
head_description: "Joignez plusieurs fichiers VSSM en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Joignez des pages spécifiques ou des plages de pages de divers documents à un seul document."

############################# Header ############################
title: "Joindre VSSM fichiers dans C#"
description: "Joignez VSSM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment joindre plusieurs fichiers VSSM"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de joindre facilement deux ou plusieurs fichiers VSSM dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment joindre des fichiers VSSM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Joindre VSSM fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Joignez-vous à plusieurs fichiers VSSM dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
