...
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以便合并PNG文件。"
...
steps:
    ...
    title: "合并PNG文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够高效地合并PNG文件。将此功能集成到您的.NET应用程序中，以将多个文档作为单个文件处理。
