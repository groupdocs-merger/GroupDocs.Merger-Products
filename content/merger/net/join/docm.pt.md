...
############################# Head ############################
head_title: "Junte DOCM Arquivos em C# | DOCM Fusão"
head_description: "Junte vários arquivos DOCM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOCM arquivos em C#"
description: "Junte-se a DOCM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOCM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOCM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOCM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOCM usando a API GroupDocs.Merger
