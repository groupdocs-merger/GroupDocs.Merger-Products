...
############################# Head ############################
head_title: "Pridružite se datotekam MHTML v C# | MHTML Združitev"
head_description: "Združite več datotek MHTML v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam MHTML v C#"
description: "Pridružite se MHTML z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni MHTML datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
