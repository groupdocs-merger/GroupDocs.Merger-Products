...
############################# Head ############################
head_title: "Csatlakozás TSV fájlokhoz a C# nyelven | TSV Egyesülés"
head_description: "Csatlakoztasson több TSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás TSV fájlhoz itt: C#"
description: "Csatlakozzon az TSV termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több TSV fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több TSV fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TSV fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson TSV fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több TSV fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) webhely meglátogatásával.
