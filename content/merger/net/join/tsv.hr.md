...
############################# Head ############################
head_title: "Pridružite TSV datotekama u C# | TSV Spajanje"
head_description: "Spojite više TSV datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite TSV datotekama u C#"
description: "Pridružite se TSV s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti TSV datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite TSV datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne TSV datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
