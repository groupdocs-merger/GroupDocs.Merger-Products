...
############################# Head ############################
head_title: "Pridružite se datotekam PPSX v C# | PPSX Združitev"
head_description: "Združite več datotek PPSX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PPSX v C#"
description: "Pridružite se PPSX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PPSX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
