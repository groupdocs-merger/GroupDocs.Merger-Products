...
############################# Head ############################
head_title: "Deltag i VSSM filer i C# | VSSM Fusion"
head_description: "Sammenføj flere VSSM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i VSSM filer i C#"
description: "Slut dig til VSSM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere VSSM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere VSSM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du VSSM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i VSSM filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slut dig til mere end én VSSM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
