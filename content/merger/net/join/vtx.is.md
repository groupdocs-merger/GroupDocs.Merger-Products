...
############################# Head ############################
head_title: "Tengstu VTX skrár í C# | VTX Samruni"
head_description: "Tengdu margar VTX skrár í eina skrá með því að nota C# .NET skjalasamruna API. Tengdu tilteknar síður eða blaðsíðubil frá ýmsum skjölum í eitt skjal."

############################# Header ############################
title: "Tengjast VTX skrár í C#"
description: "Vertu með í VTX með nokkrum línum af .NET kóða."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/is/merger/net/) býður upp á þægilega lausn til að sameina margar PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, myndir og mörg önnur skjöl í einni skrá innan .NET forrita. GroupDocs.Merger mun spara þér mikla fyrirhöfn, þar sem þú hefur leyfi til að taka þátt í VTX skjölum - það er engin þörf á að setja upp hugbúnað frá þriðja aðila, skjáborðsforrit eða viðbætur. Nú er óþarfi að eyða tíma þínum og tengja skrár handvirkt! Hlutverk GroupDocs er að veita bestu gæði og einfalda verkflæði skjalavinnslu.
...
steps:
    enable: true
    title_left: "Hvernig á að tengja margar VTX skrár"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar forriturum .NET að sameina tvær eða fleiri VTX skrár í forritum sínum með því að innleiða nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að sameina VTX skrár með því að nota C# dæmikóða">}}

        ```csharp    
        // Tengstu VTX skrár með því að nota GroupDocs.Merger API
...
demos:
    ...
    content: |
       Vertu með í fleiri en einni VTX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) vefsíðu.
