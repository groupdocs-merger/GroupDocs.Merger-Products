...
############################# Head ############################
head_title: "Uniu-vos a CSV Fitxers a C# | CSV Fusió"
head_description: "Uniu diversos fitxers CSV en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a CSV fitxers a C#"
description: "Uniu-vos a CSV amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers CSV dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers CSV mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers CSV mitjançant l'API de GroupDocs.Merger
