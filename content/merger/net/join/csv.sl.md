...
############################# Head ############################
head_title: "Pridružite se datotekam CSV v C# | CSV Združitev"
head_description: "Združite več datotek CSV v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam CSV v C#"
description: "Pridružite se CSV z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni CSV datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
