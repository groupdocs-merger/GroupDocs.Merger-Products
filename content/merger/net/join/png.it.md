...
############################# Head ############################
head_title: "Unisci file PNG in .NET"
head_description: "Integra GroupDocs.Merger for .NET nei tuoi progetti .NET per unire file PNG."

############################# Header ############################
title: "Unisci file PNG" 
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti PNG."
...
steps:
    enable: true
    title: "Passaggi per unire file PNG"
    content: |
      [GroupDocs.Merger](/merger/net/) ti consente di unire file PNG senza sforzo. Integra questa funzionalità nelle tue applicazioni .NET per gestire più documenti come un unico file.
      
      1. Imposta il percorso del primo file PNG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crea un'istanza di Merger con il documento PNG di input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da file di formati diversi"
      content: |
        Questo esempio illustra come unire file PNG incorporando pagine selezionate da altri formati.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
