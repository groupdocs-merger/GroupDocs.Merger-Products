...
############################# Head ############################
head_title: "Pridružite DOT datotekama u C# | DOT Spajanje"
head_description: "Spojite više DOT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite DOT datotekama u C#"
description: "Pridružite se DOT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite DOT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne DOT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
