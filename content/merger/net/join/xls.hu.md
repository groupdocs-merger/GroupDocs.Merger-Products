...
############################# Head ############################
head_title: "Csatlakozás XLS fájlokhoz a C# nyelven | XLS Egyesülés"
head_description: "Csatlakoztasson több XLS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLS fájlhoz itt: C#"
description: "Csatlakozzon az XLS termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLS fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLS fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLS fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) webhely meglátogatásával.
