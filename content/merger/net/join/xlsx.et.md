...
############################# Head ############################
head_title: "Liituge XLSX failidega rakenduses C# | XLSX Ühinemine"
head_description: "Ühendage mitu XLSX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge XLSX failiga rakenduses C#"
description: "Liituge tootega XLSX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu XLSX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama XLSX faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil XLSX failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe XLSX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
