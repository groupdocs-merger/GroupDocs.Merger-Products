...
############################# Head ############################
head_title: "Gabung XLAM File di C# | XLAM Penggabungan"
head_description: "Gabungkan beberapa file XLAM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XLAM File Di C#"
description: "Bergabunglah dengan XLAM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa XLAM File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file XLAM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLAM menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file XLAM menggunakan GroupDocs.Merger API
