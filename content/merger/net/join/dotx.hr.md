...
############################# Head ############################
head_title: "Pridružite DOTX datotekama u C# | DOTX Spajanje"
head_description: "Spojite više DOTX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite DOTX datotekama u C#"
description: "Pridružite se DOTX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOTX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite DOTX datoteke koristeći GroupDocs.Merger API
