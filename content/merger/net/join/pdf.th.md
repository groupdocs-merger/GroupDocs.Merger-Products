...
head_description: "ผสาน GroupDocs.Merger for .NET เข้ากับโปรเจค .NET ของคุณเพื่อรวมไฟล์ PDF ได้อย่างมีประสิทธิภาพ."

############################# Header ############################
title: "รวมไฟล์ PDF" 
description: "ใช้ GroupDocs.Merger for .NET ในการสร้างแอปพลิเคชัน .NET ที่มีประสิทธิภาพในการรวมเอกสาร PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) ช่วยให้คุณสามารถรวมไฟล์ PDF ได้อย่างมีประสิทธิภาพ รวมฟีเจอร์นี้เข้าไปในแอปพลิเคชัน .NET ของคุณเพื่อจัดการเอกสารหลายรายการเป็นไฟล์เดียว.
      
      1. ตั้งค่าเส้นทางไปยังไฟล์ PDF แรก.
      2. เลือกไฟล์ที่สอง.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // สร้างอินสแตนซ์ Merger ด้วยเอกสาร PDF ที่ต้องการ
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "รวมหน้าที่เลือกจากไฟล์ที่แตกต่างกัน"
      content: |
        ตัวอย่างนี้แสดงวิธีการรวมไฟล์ PDF ขณะที่รวมหน้าที่เลือกจากรูปแบบอื่น.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
