...
############################# Head ############################
head_title: "Pievienojieties XLSX failiem programmā C# | XLSX Apvienošanās"
head_description: "Apvienojiet vairākus XLSX failus vienā failā, izmantojot C# .NET dokumentu apvienošanas API. Savienojiet noteiktas lapas vai lapu diapazonus no dažādiem dokumentiem līdz vienam dokumentam."

############################# Header ############################
title: "Pievienojieties XLSX failiem programmā C#"
description: "Pievienojieties XLSX, izmantojot dažas .NET koda rindiņas."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) nodrošina ērtu risinājumu, lai savienotu vairākus PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlus un daudzus citus dokumentus vienā failā .NET lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts pievienoties XLSX dokumentiem — nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt savu laiku un manuāli apvienot failus! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Kā pievienoties vairākiem XLSX failiem"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj .NET izstrādātājiem viegli savienot divus vai vairākus XLSX failus savās lietojumprogrammās, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā savienot XLSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Pievienojieties XLSX failiem, izmantojot GroupDocs.Merger API
        // Izveidot saplūšanu, ievadot XLSX dokumentu
...
demos:
    ...
    content: |
       Pievienojieties vairāk nekā vienam XLSX failam tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
