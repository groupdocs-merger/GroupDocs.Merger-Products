...
############################# Head ############################
head_title: "Εγγραφείτε σε ODS αρχεία στο C# | ODS Συγχώνευση"
head_description: "Συνδέστε πολλά αρχεία ODS σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συνδέστε συγκεκριμένες σελίδες ή σειρές σελίδων από διάφορα έγγραφα έως ένα μεμονωμένο έγγραφο."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία ODS σε C#"
description: "Εγγραφείτε στο ODS με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συνδέσετε πολλά αρχεία ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να ενώσουν δύο ή περισσότερα αρχεία ODS στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία ODS χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Εγγραφείτε σε αρχεία ODS χρησιμοποιώντας το GroupDocs.Merger API
