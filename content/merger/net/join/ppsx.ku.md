...
############################# Head ############################
head_title: "Tevlî pelên PPSX li C# | PPSX Hevgirtin"
head_description: "Gelek pelên PPSX bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên PPSX Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî PPSX bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên PPSX dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir PPSX pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên PPSX dibe">}}

        ```csharp    
        // Tevlî pelên PPSX bibin bi karanîna GroupDocs.Merger API
