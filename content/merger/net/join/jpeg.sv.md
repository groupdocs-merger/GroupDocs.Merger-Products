...
############################# Head ############################
head_title: "Gå med i JPEG-filer i C# | JPEG Sammanslagning"
head_description: "Sammanfoga flera JPEG-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i JPEG-filer i C#"
description: "Gå med i JPEG med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera JPEG-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera JPEG-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i JPEG-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i JPEG-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en JPEG-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
