...
############################# Head ############################
head_title: "Word lid van TSV bestanden in C# | TSV Fusie"
head_description: "Voeg meerdere TSV-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van TSV bestanden in C#"
description: "Sluit je aan bij TSV met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere TSV bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer TSV-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u TSV bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van TSV bestanden met behulp van GroupDocs.Merger API
