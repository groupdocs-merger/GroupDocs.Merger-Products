...
############################# Head ############################
head_title: "Gabung XLSB File di C# | XLSB Penggabungan"
head_description: "Gabungkan beberapa file XLSB ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XLSB File Di C#"
description: "Bergabunglah dengan XLSB dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLSB menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file XLSB menggunakan GroupDocs.Merger API
