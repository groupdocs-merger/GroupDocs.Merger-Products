...
############################# Head ############################
head_title: "Pridružite XLT datotekama u C# | XLT Spajanje"
head_description: "Spojite više XLT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLT datotekama u C#"
description: "Pridružite se XLT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
