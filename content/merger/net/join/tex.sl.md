...
############################# Head ############################
head_title: "Pridružite se datotekam TEX v C# | TEX Združitev"
head_description: "Združite več datotek TEX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam TEX v C#"
description: "Pridružite se TEX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni TEX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex).
