...
############################# Head ############################
head_title: "C#'da EPUB Dosyalarına Katılın | EPUB Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla EPUB dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki EPUB Dosyaya Katılın"
description: "Birkaç satır .NET koduyla EPUB'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla EPUB Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla EPUB dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak EPUB dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak EPUB dosyalarına katılın
