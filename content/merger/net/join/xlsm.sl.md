...
############################# Head ############################
head_title: "Pridružite se datotekam XLSM v C# | XLSM Združitev"
head_description: "Združite več datotek XLSM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLSM v C#"
description: "Pridružite se XLSM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLSM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
