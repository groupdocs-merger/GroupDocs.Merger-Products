...
############################# Head ############################
head_title: "Prisijunkite prie MHTML failų C# | MHTML Susijungimas"
head_description: "Sujunkite kelis MHTML failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie MHTML failų C#"
description: "Prisijunkite prie MHTML naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių MHTML failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau MHTML failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti MHTML failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite MHTML failus naudodami GroupDocs.Merger API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno MHTML failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) svetainėje.
