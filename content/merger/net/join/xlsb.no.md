...
############################# Head ############################
head_title: "Bli med XLSB-filer i C# | XLSB Fusjon"
head_description: "Slå sammen flere XLSB-filer til én enkelt fil ved å bruke C# .NET-dokumentsammenslåings-API. Slå sammen bestemte sider eller sideområder fra ulike dokumenter til ett enkelt dokument."

############################# Header ############################
title: "Bli med XLSB-filer i C#"
description: "Bli med XLSB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Hvordan slå sammen flere XLSB-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for .NET-utviklere å slå sammen to eller flere XLSB-filer i applikasjonene sine ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til XLSB-filer ved å bruke C#-eksempelkoden">}}

        ```csharp    
        // Bli med XLSB filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bli med mer enn én XLSB-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
