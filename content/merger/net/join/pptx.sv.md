...
############################# Head ############################
head_title: "Gå med i PPTX-filer i C# | PPTX Sammanslagning"
head_description: "Sammanfoga flera PPTX-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i PPTX-filer i C#"
description: "Gå med i PPTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera PPTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera PPTX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i PPTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i PPTX-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en PPTX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
