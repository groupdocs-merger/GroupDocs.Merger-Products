...
############################# Head ############################
head_title: "Alăturați-vă fișierelor OTP în C# | OTP Fuziune"
head_description: "Uniți mai multe fișiere OTP într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Uniți anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Alăturați-vă fișierelor OTP în C#"
description: "Alăturați-vă OTP cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să vă alăturați mai multor fișiere OTP"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să alăture două sau mai multe fișiere OTP în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor OTP utilizând codul exemplu C#">}}

        ```csharp    
        // Alăturați-vă fișierelor OTP utilizând API-ul GroupDocs.Merger
        // Instanțiați fuziunea cu documentul introdus OTP
...
demos:
    ...
    content: |
       Alăturați-vă mai mult de un fișier OTP chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
