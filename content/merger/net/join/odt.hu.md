...
############################# Head ############################
head_title: "Csatlakozás ODT fájlokhoz a C# nyelven | ODT Egyesülés"
head_description: "Csatlakoztasson több ODT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás ODT fájlhoz itt: C#"
description: "Csatlakozzon az ODT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több ODT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson ODT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több ODT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) webhely meglátogatásával.
