...
############################# Head ############################
head_title: "Gabung OTT File di C# | OTT Penggabungan"
head_description: "Gabungkan beberapa file OTT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung OTT File Di C#"
description: "Bergabunglah dengan OTT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa OTT File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file OTT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file OTT menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file OTT menggunakan GroupDocs.Merger API
