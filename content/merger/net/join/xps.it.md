...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti XPS."
...
steps:
    enable: true
    title: "Passaggi per unire file XPS"
    content: |
