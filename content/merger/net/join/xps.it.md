...
############################# Head ############################
head_title: "Unisciti a XPS file in C# | XPS Fusione"
head_description: "Unisci più file XPS in un unico file utilizzando l'API di fusione documenti C# .NET. Unisci pagine o intervalli di pagine specifici da vari documenti in un unico documento."

############################# Header ############################
title: "Unisciti a XPS file in C#"
description: "Unisciti a XPS con poche righe di codice .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/it/merger/net/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni .NET. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unirti a XPS documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    enable: true
    title_left: "Come unire più file XPS"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di .NET di unire due o più file XPS all'interno delle loro applicazioni implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file XPS utilizzando il codice di esempio C#">}}

        ```csharp    
        // Unisciti ai file XPS utilizzando l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Unisci più di un file XPS in questo momento visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
