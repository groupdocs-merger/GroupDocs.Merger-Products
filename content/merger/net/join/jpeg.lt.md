...
############################# Head ############################
head_title: "Prisijunkite prie JPEG failų C# | JPEG Susijungimas"
head_description: "Sujunkite kelis JPEG failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie JPEG failų C#"
description: "Prisijunkite prie JPEG naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių JPEG failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau JPEG failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti JPEG failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite JPEG failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties JPEG dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno JPEG failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) svetainėje.
