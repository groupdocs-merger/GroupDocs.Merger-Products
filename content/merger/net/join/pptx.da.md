...
############################# Head ############################
head_title: "Deltag i PPTX filer i C# | PPTX Fusion"
head_description: "Sammenføj flere PPTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i PPTX filer i C#"
description: "Slut dig til PPTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere PPTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere PPTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du PPTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i PPTX filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input PPTX dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én PPTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
