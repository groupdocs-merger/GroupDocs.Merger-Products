...
############################# Head ############################
head_title: "Gabung VTX File di C# | VTX Penggabungan"
head_description: "Gabungkan beberapa file VTX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VTX File Di C#"
description: "Bergabunglah dengan VTX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VTX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VTX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu VTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/vtx).
