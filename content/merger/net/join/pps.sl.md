...
############################# Head ############################
head_title: "Pridružite se datotekam PPS v C# | PPS Združitev"
head_description: "Združite več datotek PPS v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PPS v C#"
description: "Pridružite se PPS z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PPS datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
