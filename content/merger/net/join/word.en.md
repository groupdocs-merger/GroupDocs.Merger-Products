...
############################# Head ############################
head_title: "Join WORD files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily join WORD files."

############################# Header ############################
title: "Join WORD files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently join WORD documents."
...
steps:
    enable: true
    title: "Steps to join WORD files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to join WORD files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from files of different formats"
      content: |
        This example illustrates how to join WORD files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
