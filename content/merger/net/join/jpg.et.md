...
############################# Head ############################
head_title: "Liituge JPG failidega rakenduses C# | JPG Ühinemine"
head_description: "Ühendage mitu JPG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge JPG failiga rakenduses C#"
description: "Liituge tootega JPG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu JPG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama JPG faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada JPG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil JPG failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe JPG failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg).
