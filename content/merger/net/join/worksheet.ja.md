...
############################# Head ############################
head_title: "C# の WORKSHEET ファイルに参加 | WORKSHEET合併"
...
############################# Header ############################
title: "C# の WORKSHEET ファイルに参加"
description: "数行の .NET コードで WORKSHEET を結合します。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) を使用すると、.NET の開発者は、アプリケーション内で 2 つ以上の WORKSHEET ファイルを簡単に結合できます。いくつかの簡単な手順。
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/worksheet) Web サイトにアクセスして、複数の WORKSHEET ファイルに今すぐ参加してください。
       ライブデモには次の利点があります。
