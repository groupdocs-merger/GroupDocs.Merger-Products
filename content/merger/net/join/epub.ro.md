...
############################# Head ############################
head_title: "Alăturați-vă fișierelor EPUB în C# | EPUB Fuziune"
head_description: "Uniți mai multe fișiere EPUB într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Uniți anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Alăturați-vă fișierelor EPUB în C#"
description: "Alăturați-vă EPUB cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să vă alăturați mai multor fișiere EPUB"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să alăture două sau mai multe fișiere EPUB în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor EPUB utilizând codul exemplu C#">}}

        ```csharp    
        // Alăturați-vă fișierelor EPUB utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Alăturați-vă mai mult de un fișier EPUB chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
