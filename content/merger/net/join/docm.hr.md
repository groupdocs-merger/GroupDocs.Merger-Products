...
############################# Head ############################
head_title: "Pridružite DOCM datotekama u C# | DOCM Spajanje"
head_description: "Spojite više DOCM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite DOCM datotekama u C#"
description: "Pridružite se DOCM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Kako spojiti više DOCM datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava spajanje dvije ili više DOCM datoteka unutar njihovih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Pridružite DOCM datoteke koristeći GroupDocs.Merger API
        // Instancirajte spajanje s ulaznim DOCM dokumentom
...
demos:
    ...
    content: |
       Pridružite se više od jedne DOCM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
