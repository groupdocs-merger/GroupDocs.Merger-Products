...
############################# Head ############################
head_title: "Prisijunkite prie PPSX failų C# | PPSX Susijungimas"
head_description: "Sujunkite kelis PPSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie PPSX failų C#"
description: "Prisijunkite prie PPSX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių PPSX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau PPSX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PPSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite PPSX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties PPSX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno PPSX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) svetainėje.
