...
############################# Head ############################
head_title: "Prisijunkite prie VSSM failų C# | VSSM Susijungimas"
head_description: "Sujunkite kelis VSSM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VSSM failų C#"
description: "Prisijunkite prie VSSM naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VSSM failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VSSM failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSSM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VSSM failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties VSSM dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSSM failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) svetainėje.
