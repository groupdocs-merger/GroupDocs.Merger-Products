...
############################# Head ############################
head_title: "Junte VSX Arquivos em C# | VSX Fusão"
head_description: "Junte vários arquivos VSX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSX arquivos em C#"
description: "Junte-se a VSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSX usando a API GroupDocs.Merger
