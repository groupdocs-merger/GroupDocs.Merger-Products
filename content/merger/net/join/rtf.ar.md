...
############################# Head ############################
head_title: "انضم إلى RTF ملفات في C# | RTF الاندماج"
head_description: "انضم إلى عدة ملفات RTF في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات RTF في C#"
description: "انضم إلى RTF ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات RTF"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من RTF داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات RTF باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات RTF باستخدام GroupDocs.Merger API
