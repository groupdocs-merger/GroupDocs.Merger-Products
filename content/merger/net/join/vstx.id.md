...
############################# Head ############################
head_title: "Gabung VSTX File di C# | VSTX Penggabungan"
head_description: "Gabungkan beberapa file VSTX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSTX File Di C#"
description: "Bergabunglah dengan VSTX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSTX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VSTX menggunakan GroupDocs.Merger API
