...
############################# Head ############################
head_title: "C#'da XPS Dosyalarına Katılın | XPS Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XPS dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki XPS Dosyaya Katılın"
description: "Birkaç satır .NET koduyla XPS'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla XPS Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla XPS dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XPS dosyalarına katılın
