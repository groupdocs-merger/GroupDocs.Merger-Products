...
############################# Head ############################
head_title: "Pridružite se datotekam XPS v C# | XPS Združitev"
head_description: "Združite več datotek XPS v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XPS v C#"
description: "Pridružite se XPS z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XPS datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
