...
############################# Head ############################
head_title: "Uniu-vos a VSX Fitxers a C# | VSX Fusió"
head_description: "Uniu diversos fitxers VSX en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a VSX fitxers a C#"
description: "Uniu-vos a VSX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers VSX"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers VSX dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers VSX mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers VSX mitjançant l'API de GroupDocs.Merger
