...
############################# Head ############################
head_title: "Csatlakozás OTP fájlokhoz a C# nyelven | OTP Egyesülés"
head_description: "Csatlakoztasson több OTP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás OTP fájlhoz itt: C#"
description: "Csatlakozzon az OTP termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több OTP fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több OTP fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson OTP fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több OTP fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) webhely meglátogatásával.
