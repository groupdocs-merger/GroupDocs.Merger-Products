...
############################# Head ############################
head_title: "Gabung PPS File di C# | PPS Penggabungan"
head_description: "Gabungkan beberapa file PPS ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung PPS File Di C#"
description: "Bergabunglah dengan PPS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa PPS File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file PPS dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPS menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file PPS menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu PPS file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/pps).
