...
############################# Head ############################
head_title: "C#'da XLSM Dosyalarına Katılın | XLSM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLSM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki XLSM Dosyaya Katılın"
description: "Birkaç satır .NET koduyla XLSM'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla XLSM Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla XLSM dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSM dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSM dosyalarına katılın
