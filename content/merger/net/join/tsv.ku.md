...
############################# Head ############################
head_title: "Tevlî pelên TSV li C# | TSV Hevgirtin"
head_description: "Gelek pelên TSV bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên TSV Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî TSV bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên TSV dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir TSV pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên TSV dibe">}}

        ```csharp    
        // Tevlî pelên TSV bibin bi karanîna GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) aniha beşdarî zêdetirî yek pelên TSV bibin.
