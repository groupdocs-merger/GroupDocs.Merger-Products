...
############################# Head ############################
head_title: "Junte VSTM Arquivos em C# | VSTM Fusão"
head_description: "Junte vários arquivos VSTM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSTM arquivos em C#"
description: "Junte-se a VSTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSTM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSTM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSTM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSTM usando a API GroupDocs.Merger
