...
############################# Head ############################
head_title: "Csatlakozás JPG fájlokhoz a C# nyelven | JPG Egyesülés"
head_description: "Csatlakoztasson több JPG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás JPG fájlhoz itt: C#"
description: "Csatlakozzon az JPG termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több JPG fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több JPG fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPG fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson JPG fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti JPG dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több JPG fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) webhely meglátogatásával.
