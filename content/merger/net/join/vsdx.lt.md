...
############################# Head ############################
head_title: "Prisijunkite prie VSDX failų C# | VSDX Susijungimas"
head_description: "Sujunkite kelis VSDX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VSDX failų C#"
description: "Prisijunkite prie VSDX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VSDX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VSDX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSDX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VSDX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties VSDX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSDX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) svetainėje.
