...
############################# Head ############################
head_title: "Pridružite VTX datotekama u C# | VTX Spajanje"
head_description: "Spojite više VTX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VTX datotekama u C#"
description: "Pridružite se VTX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VTX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VTX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VTX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
