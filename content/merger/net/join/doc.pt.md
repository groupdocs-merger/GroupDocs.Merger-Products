...
############################# Head ############################
head_title: "Junte DOC Arquivos em C# | DOC Fusão"
head_description: "Junte vários arquivos DOC em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOC arquivos em C#"
description: "Junte-se a DOC com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOC"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOC em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOC usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOC usando a API GroupDocs.Merger
