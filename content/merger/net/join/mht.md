...
############################# Head ############################
head_title: "Join MHT Files into One in C# (.NET Core) - MHT Merger"
...
############################# Header ############################
title: "Join MHT Files In C# (.NET Core)"
description: "Join multiple MHT files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more MHT files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join MHT files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one MHT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
