...
############################# Head ############################
head_title: "Junte RTF Arquivos em C# | RTF Fusão"
head_description: "Junte vários arquivos RTF em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a RTF arquivos em C#"
description: "Junte-se a RTF com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos RTF"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos RTF em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos RTF usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos RTF usando a API GroupDocs.Merger
