...
############################# Head ############################
head_title: "Gabung DOCM File di C# | DOCM Penggabungan"
head_description: "Gabungkan beberapa file DOCM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung DOCM File Di C#"
description: "Bergabunglah dengan DOCM dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file DOCM menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file DOCM menggunakan GroupDocs.Merger API
