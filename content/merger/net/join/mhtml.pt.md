...
############################# Head ############################
head_title: "Junte MHTML Arquivos em C# | MHTML Fusão"
head_description: "Junte vários arquivos MHTML em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a MHTML arquivos em C#"
description: "Junte-se a MHTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos MHTML"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos MHTML em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos MHTML usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos MHTML usando a API GroupDocs.Merger
