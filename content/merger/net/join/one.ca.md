...
############################# Head ############################
head_title: "Uniu-vos a ONE Fitxers a C# | ONE Fusió"
head_description: "Uniu diversos fitxers ONE en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a ONE fitxers a C#"
description: "Uniu-vos a ONE amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers ONE dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers ONE mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers ONE mitjançant l'API de GroupDocs.Merger
        // Instanciï Merger amb el document d'entrada ONE
...
demos:
    ...
    content: |
       Uniu-vos a més d'un fitxer ONE ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
