...
############################# Head ############################
head_title: "انضم إلى VDX ملفات في C# | VDX الاندماج"
head_description: "انضم إلى عدة ملفات VDX في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات VDX في C#"
description: "انضم إلى VDX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات VDX"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من VDX داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات VDX باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات VDX باستخدام GroupDocs.Merger API
