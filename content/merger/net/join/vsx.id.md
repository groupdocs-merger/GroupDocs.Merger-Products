...
############################# Head ############################
head_title: "Gabung VSX File di C# | VSX Penggabungan"
head_description: "Gabungkan beberapa file VSX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSX File Di C#"
description: "Bergabunglah dengan VSX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VSX menggunakan GroupDocs.Merger API
