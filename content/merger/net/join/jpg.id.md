...
############################# Head ############################
head_title: "Gabung JPG File di C# | JPG Penggabungan"
head_description: "Gabungkan beberapa file JPG ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung JPG File Di C#"
description: "Bergabunglah dengan JPG dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPG menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file JPG menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu JPG file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/jpg).
