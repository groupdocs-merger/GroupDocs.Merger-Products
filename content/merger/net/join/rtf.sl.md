...
############################# Head ############################
head_title: "Pridružite se datotekam RTF v C# | RTF Združitev"
head_description: "Združite več datotek RTF v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam RTF v C#"
description: "Pridružite se RTF z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni RTF datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
