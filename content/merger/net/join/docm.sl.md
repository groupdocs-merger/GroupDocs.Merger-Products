...
############################# Head ############################
head_title: "Pridružite se datotekam DOCM v C# | DOCM Združitev"
head_description: "Združite več datotek DOCM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam DOCM v C#"
description: "Pridružite se DOCM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni DOCM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
