...
############################# Head ############################
head_title: "EPUB ፋይሎችን በC# | ይቀላቀሉ EPUB ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ EPUB ፋይሎችን ወደ አንድ ፋይል ይቀላቀሉ። ከተለያዩ ሰነዶች እስከ አንድ ሰነድ የተወሰኑ ገጾችን ወይም የገጽ ክልሎችን ይቀላቀሉ።"

############################# Header ############################
title: "በC# ውስጥ EPUB ፋይሎችን ይቀላቀሉ"
description: "EPUBን በጥቂት የ.NET ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በርካታ EPUB ፋይሎችን እንዴት መቀላቀል እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ EPUB ፋይሎችን በመተግበር ወደ መተግበሪያዎቻቸው መቀላቀል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# ምሳሌ ኮድን በመጠቀም EPUB ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም EPUB ፋይሎችን ይቀላቀሉ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) ድር ጣቢያን በመጎብኘት ከአንድ በላይ EPUB ፋይሎችን ይቀላቀሉ።
