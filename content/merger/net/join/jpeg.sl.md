...
############################# Head ############################
head_title: "Pridružite se datotekam JPEG v C# | JPEG Združitev"
head_description: "Združite več datotek JPEG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam JPEG v C#"
description: "Pridružite se JPEG z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni JPEG datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
