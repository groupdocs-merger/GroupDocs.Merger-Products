...
############################# Head ############################
head_title: "Liituge PNG failidega rakenduses C# | PNG Ühinemine"
head_description: "Ühendage mitu PNG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge PNG failiga rakenduses C#"
description: "Liituge tootega PNG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu PNG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama PNG faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PNG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil PNG failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe PNG failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
