...
############################# Head ############################
head_title: "Gå med i VSSM-filer i C# | VSSM Sammanslagning"
head_description: "Sammanfoga flera VSSM-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i VSSM-filer i C#"
description: "Gå med i VSSM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera VSSM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera VSSM-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i VSSM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i VSSM-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en VSSM-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
