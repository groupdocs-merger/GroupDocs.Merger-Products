...
############################# Head ############################
head_title: "Csatlakozás VTX fájlokhoz a C# nyelven | VTX Egyesülés"
head_description: "Csatlakoztasson több VTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VTX fájlhoz itt: C#"
description: "Csatlakozzon az VTX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VTX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VTX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VTX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) webhely meglátogatásával.
