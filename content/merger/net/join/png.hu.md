...
############################# Head ############################
head_title: "Csatlakozás PNG fájlokhoz a C# nyelven | PNG Egyesülés"
head_description: "Csatlakoztasson több PNG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PNG fájlhoz itt: C#"
description: "Csatlakozzon az PNG termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PNG fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PNG fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PNG fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PNG fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti PNG dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PNG fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) webhely meglátogatásával.
