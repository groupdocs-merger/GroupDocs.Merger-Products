...
############################# Head ############################
head_title: "Gabung VSSM File di C# | VSSM Penggabungan"
head_description: "Gabungkan beberapa file VSSM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSSM File Di C#"
description: "Bergabunglah dengan VSSM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSSM File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VSSM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSSM menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file VSSM menggunakan GroupDocs.Merger API
