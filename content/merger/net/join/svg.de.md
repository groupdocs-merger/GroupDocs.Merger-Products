...
############################# Head ############################
head_title: "Verbinden von SVG-Dateien in .NET"
head_description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Projekte, um SVG-Dateien zu verbinden."

############################# Header ############################
title: "Verbinden von SVG-Dateien" 
description: "Nutzen Sie GroupDocs.Merger for .NET, um .NET-Anwendungen zu erstellen, die SVG-Dokumente effizient verbinden."
...
steps:
    enable: true
    title: "Schritte zum Verbinden von SVG-Dateien"
    content: |
      [GroupDocs.Merger](/merger/net/) ermöglicht es Ihnen, SVG-Dateien effizient zu verbinden. Integrieren Sie diese Funktion in Ihre .NET-Anwendungen, um mehrere Dokumente als eine einzige Datei zu behandeln.
      
      1. Legen Sie den Pfad zur ersten SVG-Datei fest.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Erstellen Sie eine Merger-Instanz mit dem Eingangs-SVG-Dokument
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus Dateien unterschiedlicher Formate verbinden"
      content: |
        Dieses Beispiel veranschaulicht, wie SVG-Dateien verbunden werden, während ausgewählte Seiten aus anderen Formaten integriert werden.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
