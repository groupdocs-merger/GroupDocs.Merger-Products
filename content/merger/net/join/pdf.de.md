...
############################# Head ############################
head_title: "Verbinden von PDF-Dateien in .NET"
head_description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Projekte, um PDF-Dateien zu verbinden."

############################# Header ############################
title: "Verbinden von PDF-Dateien" 
description: "Nutzen Sie GroupDocs.Merger for .NET, um .NET-Anwendungen zu erstellen, die PDF-Dokumente effizient verbinden."
...
steps:
    enable: true
    title: "Schritte zum Verbinden von PDF-Dateien"
    content: |
      [GroupDocs.Merger](/merger/net/) ermöglicht es Ihnen, PDF-Dateien effizient zu verbinden. Integrieren Sie diese Funktion in Ihre .NET-Anwendungen, um mehrere Dokumente als eine einzige Datei zu behandeln.
      
      1. Legen Sie den Pfad zur ersten PDF-Datei fest.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Erstellen Sie eine Merger-Instanz mit dem Eingangs-PDF-Dokument
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus Dateien unterschiedlicher Formate verbinden"
      content: |
        Dieses Beispiel veranschaulicht, wie PDF-Dateien verbunden werden, während ausgewählte Seiten aus anderen Formaten integriert werden.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
