...
############################# Head ############################
head_title: "Tevlî pelên VSTX li C# | VSTX Hevgirtin"
head_description: "Gelek pelên VSTX bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên VSTX Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî VSTX bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên VSTX dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir VSTX pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên VSTX dibe">}}

        ```csharp    
        // Tevlî pelên VSTX bibin bi karanîna GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) aniha beşdarî zêdetirî yek pelên VSTX bibin.
