...
############################# Head ############################
head_title: "Připojte se k XLT souborům v C# | XLT Fúze"
head_description: "Spojte více souborů XLT do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Spojení konkrétních stránek nebo rozsahů stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "Připojte se k XLT souborům v C#"
description: "Připojte se k XLT pomocí několika řádků kódu .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) poskytuje pohodlné řešení pro spojení více PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázků a mnoho dalších dokumentů do jednoho souboru v aplikacích .NET. GroupDocs.Merger vám ušetří spoustu námahy, protože se můžete připojit k XLT dokumentům – není třeba instalovat žádný software třetích stran, desktopové aplikace nebo pluginy. Nyní je zbytečné ztrácet čas a spojovat soubory ručně! Posláním GroupDocs je poskytovat nejlepší kvalitu a zjednodušit pracovní postupy zpracování dokumentů.
...
steps:
    enable: true
    title_left: "Jak spojit více souborů XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET spojit dva nebo více souborů XLT v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak připojit soubory XLT pomocí ukázkového kódu C#">}}

        ```csharp    
        // Připojte se k XLT souborům pomocí GroupDocs.Merger API
...
demos:
    ...
    content: |
       Připojte se k více než jednomu XLT souborům právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
