...
############################# Head ############################
head_title: "Pridružite XLAM datotekama u C# | XLAM Spajanje"
head_description: "Spojite više XLAM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLAM datotekama u C#"
description: "Pridružite se XLAM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLAM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLAM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLAM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
