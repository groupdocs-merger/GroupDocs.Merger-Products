...
############################# Head ############################
head_title: "Deltag i DOCX filer i C# | DOCX Fusion"
head_description: "Sammenføj flere DOCX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i DOCX filer i C#"
description: "Slut dig til DOCX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere DOCX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere DOCX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du DOCX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i DOCX filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input DOCX dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én DOCX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
