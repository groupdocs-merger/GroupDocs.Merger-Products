...
############################# Head ############################
head_title: "在.NET中合并JPEG文件"
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以便合并JPEG文件。"

############################# Header ############################
title: "合并JPEG文件" 
description: "使用GroupDocs.Merger for .NET构建高效合并JPEG文档的.NET应用程序。"
...
steps:
    ...
    title: "合并JPEG文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够高效地合并JPEG文件。将此功能集成到您的.NET应用程序中，以将多个文档作为单个文件处理。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同格式文件中合并选定页面"
      content: |
        此示例演示了如何合并JPEG文件，同时选择其他格式的特定页面。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
