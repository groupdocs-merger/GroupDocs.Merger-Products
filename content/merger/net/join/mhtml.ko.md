...
############################# Head ############################
head_title: ".NET에서 MHTML 파일 결합하기"
head_description: ".NET 프로젝트에 GroupDocs.Merger for .NET를 통합하여 MHTML 파일을 결합하세요."

############################# Header ############################
title: "MHTML 파일 결합하기" 
description: "GroupDocs.Merger for .NET를 사용하여 .NET 애플리케이션을 구축하고 MHTML 문서를 효율적으로 결합하십시오."
...
steps:
    enable: true
    title: "MHTML 파일 결합 단계"
    content: |
      [GroupDocs.Merger](/merger/net/)를 사용하여 MHTML 파일을 간편하게 결합하십시오. 이 기능을 .NET 애플리케이션에 통합하여 여러 문서를 단일 파일로 처리하세요.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "다양한 형식의 파일에서 선택한 페이지 결합"
      content: |
        이 예제는 다른 형식의 MHTML 파일을 결합하는 방법을 보여줍니다.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
