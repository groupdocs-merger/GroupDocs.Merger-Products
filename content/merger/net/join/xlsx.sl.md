...
############################# Head ############################
head_title: "Pridružite se datotekam XLSX v C# | XLSX Združitev"
head_description: "Združite več datotek XLSX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLSX v C#"
description: "Pridružite se XLSX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLSX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
