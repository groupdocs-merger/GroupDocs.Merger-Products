...
############################# Head ############################
head_title: "Pridružite CSV datotekama u C# | CSV Spajanje"
head_description: "Spojite više CSV datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite CSV datotekama u C#"
description: "Pridružite se CSV s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Kako spojiti više CSV datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava spajanje dvije ili više CSV datoteka unutar njihovih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti CSV datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Pridružite CSV datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne CSV datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
