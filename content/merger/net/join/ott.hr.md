...
############################# Head ############################
head_title: "Pridružite OTT datotekama u C# | OTT Spajanje"
head_description: "Spojite više OTT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite OTT datotekama u C#"
description: "Pridružite se OTT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti OTT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite OTT datoteke koristeći GroupDocs.Merger API
