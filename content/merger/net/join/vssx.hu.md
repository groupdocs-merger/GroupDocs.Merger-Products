...
############################# Head ############################
head_title: "Csatlakozás VSSX fájlokhoz a C# nyelven | VSSX Egyesülés"
head_description: "Csatlakoztasson több VSSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSSX fájlhoz itt: C#"
description: "Csatlakozzon az VSSX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSSX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSSX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSSX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSSX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) webhely meglátogatásával.
