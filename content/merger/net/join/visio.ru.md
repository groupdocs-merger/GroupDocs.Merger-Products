...
############################# Head ############################
head_title: "Объедините файлы VISIO в .NET"
head_description: "Интегрируйте GroupDocs.Merger for .NET в свои проекты .NET, чтобы объединять файлы VISIO."

############################# Header ############################
title: "Объединение файлов VISIO" 
description: "Используйте GroupDocs.Merger for .NET для создания приложений .NET, которые эффективно объединяют документы VISIO."
...
steps:
    enable: true
    title: "Шаги для объединения файлов VISIO"
    content: |
      [GroupDocs.Merger](/merger/net/) позволяет вам без труда объединять файлы VISIO. Интегрируйте эту функцию в свои приложения .NET, чтобы обрабатывать несколько документов как один файл.
      
      1. Установите путь к первому файлу VISIO.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Создайте экземпляр Merger с входным документом VISIO
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение выбранных страниц из файлов различных форматов"
      content: |
        Этот пример иллюстрирует, как объединять файлы VISIO, включая выбранные страницы из других форматов.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
