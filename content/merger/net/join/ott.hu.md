...
############################# Head ############################
head_title: "Csatlakozás OTT fájlokhoz a C# nyelven | OTT Egyesülés"
head_description: "Csatlakoztasson több OTT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás OTT fájlhoz itt: C#"
description: "Csatlakozzon az OTT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több OTT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több OTT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson OTT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több OTT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) webhely meglátogatásával.
