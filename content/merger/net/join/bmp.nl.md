...
############################# Head ############################
head_title: "Word lid van BMP bestanden in C# | BMP Fusie"
head_description: "Voeg meerdere BMP-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van BMP bestanden in C#"
description: "Sluit je aan bij BMP met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere BMP bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer BMP-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u BMP bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van BMP bestanden met behulp van GroupDocs.Merger API
