...
############################# Head ############################
head_title: "Join ZIP files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily join ZIP files."

############################# Header ############################
title: "Join ZIP files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently join ZIP documents."
...
steps:
    enable: true
    title: "Steps to join ZIP files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to join ZIP files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from files of different formats"
      content: |
        This example illustrates how to join ZIP files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
