...
############################# Head ############################
head_title: "Junte XLSB Arquivos em C# | XLSB Fusão"
head_description: "Junte vários arquivos XLSB em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLSB arquivos em C#"
description: "Junte-se a XLSB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLSB em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLSB usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLSB usando a API GroupDocs.Merger
