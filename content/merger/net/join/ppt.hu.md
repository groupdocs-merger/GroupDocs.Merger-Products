...
############################# Head ############################
head_title: "Csatlakozás PPT fájlokhoz a C# nyelven | PPT Egyesülés"
head_description: "Csatlakoztasson több PPT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PPT fájlhoz itt: C#"
description: "Csatlakozzon az PPT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PPT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PPT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PPT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) webhely meglátogatásával.
