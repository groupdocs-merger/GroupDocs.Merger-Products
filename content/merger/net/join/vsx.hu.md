...
############################# Head ############################
head_title: "Csatlakozás VSX fájlokhoz a C# nyelven | VSX Egyesülés"
head_description: "Csatlakoztasson több VSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSX fájlhoz itt: C#"
description: "Csatlakozzon az VSX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) webhely meglátogatásával.
