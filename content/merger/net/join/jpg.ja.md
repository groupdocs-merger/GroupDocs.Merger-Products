...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) を使用すると、.NET の開発者は、アプリケーション内で 2 つ以上の JPG ファイルを簡単に結合できます。いくつかの簡単な手順。
