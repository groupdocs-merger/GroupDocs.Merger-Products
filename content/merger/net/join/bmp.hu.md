...
############################# Head ############################
head_title: "Csatlakozás BMP fájlokhoz a C# nyelven | BMP Egyesülés"
head_description: "Csatlakoztasson több BMP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás BMP fájlhoz itt: C#"
description: "Csatlakozzon az BMP termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több BMP fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több BMP fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="BMP fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson BMP fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti BMP dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több BMP fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) webhely meglátogatásával.
