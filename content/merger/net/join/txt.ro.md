...
############################# Head ############################
head_title: "Alăturați-vă fișierelor TXT în C# | TXT Fuziune"
head_description: "Uniți mai multe fișiere TXT într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Uniți anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Alăturați-vă fișierelor TXT în C#"
description: "Alăturați-vă TXT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să vă alăturați mai multor fișiere TXT"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să alăture două sau mai multe fișiere TXT în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor TXT utilizând codul exemplu C#">}}

        ```csharp    
        // Alăturați-vă fișierelor TXT utilizând API-ul GroupDocs.Merger
        // Instanțiați fuziunea cu documentul introdus TXT
...
demos:
    ...
    content: |
       Alăturați-vă mai mult de un fișier TXT chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
