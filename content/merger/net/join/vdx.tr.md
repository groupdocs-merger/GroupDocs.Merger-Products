...
############################# Head ############################
head_title: "C#'da VDX Dosyalarına Katılın | VDX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VDX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki VDX Dosyaya Katılın"
description: "Birkaç satır .NET koduyla VDX'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla VDX Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla VDX dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VDX dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VDX dosyalarına katılın
