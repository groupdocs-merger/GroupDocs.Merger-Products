...
############################# Head ############################
head_title: "Csatlakozás TEX fájlokhoz a C# nyelven | TEX Egyesülés"
head_description: "Csatlakoztasson több TEX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás TEX fájlhoz itt: C#"
description: "Csatlakozzon az TEX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több TEX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több TEX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson TEX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több TEX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) webhely meglátogatásával.
