...
############################# Head ############################
head_title: "C#'da JPEG Dosyalarına Katılın | JPEG Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla JPEG dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki JPEG Dosyaya Katılın"
description: "Birkaç satır .NET koduyla JPEG'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla JPEG Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla JPEG dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak JPEG dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak JPEG dosyalarına katılın
