...
############################# Head ############################
head_title: "Sluit aan by XLSB-lêers in C# | XLSB samesmelting"
head_description: "Sluit aan by verskeie XLSB-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by XLSB-lêers in C#"
description: "Sluit aan by XLSB met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie XLSB-lêers aan te sluit"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XLSB-lêers binne hul toepassings aan te sluit deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by XLSB-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by XLSB lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Sluit nou by meer as een XLSB-lêers aan deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) webwerf te besoek.
