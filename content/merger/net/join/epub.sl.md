...
############################# Head ############################
head_title: "Pridružite se datotekam EPUB v C# | EPUB Združitev"
head_description: "Združite več datotek EPUB v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam EPUB v C#"
description: "Pridružite se EPUB z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek EPUB znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
...
demos:
    ...
    content: |
       Pridružite se več kot eni EPUB datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
