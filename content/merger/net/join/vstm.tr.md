...
############################# Head ############################
head_title: "C#'da VSTM Dosyalarına Katılın | VSTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki VSTM Dosyaya Katılın"
description: "Birkaç satır .NET koduyla VSTM'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla VSTM Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla VSTM dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSTM dosyalarına katılın
