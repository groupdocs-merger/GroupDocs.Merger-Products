...
############################# Head ############################
head_title: "Csatlakozás XPS fájlokhoz a C# nyelven | XPS Egyesülés"
head_description: "Csatlakoztasson több XPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XPS fájlhoz itt: C#"
description: "Csatlakozzon az XPS termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XPS fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XPS fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XPS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XPS fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) webhely meglátogatásával.
