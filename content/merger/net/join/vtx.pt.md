...
############################# Head ############################
head_title: "Junte VTX Arquivos em C# | VTX Fusão"
head_description: "Junte vários arquivos VTX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VTX arquivos em C#"
description: "Junte-se a VTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VTX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VTX usando a API GroupDocs.Merger
