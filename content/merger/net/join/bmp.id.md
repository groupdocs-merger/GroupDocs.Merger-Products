...
############################# Head ############################
head_title: "Gabung BMP File di C# | BMP Penggabungan"
head_description: "Gabungkan beberapa file BMP ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung BMP File Di C#"
description: "Bergabunglah dengan BMP dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file BMP menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file BMP menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu BMP file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/bmp).
