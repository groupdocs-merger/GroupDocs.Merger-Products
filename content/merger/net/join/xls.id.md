...
############################# Head ############################
head_title: "Gabung XLS File di C# | XLS Penggabungan"
head_description: "Gabungkan beberapa file XLS ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XLS File Di C#"
description: "Bergabunglah dengan XLS dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLS menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file XLS menggunakan GroupDocs.Merger API
