...
############################# Head ############################
head_title: "Csatlakozás XLT fájlokhoz a C# nyelven | XLT Egyesülés"
head_description: "Csatlakoztasson több XLT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLT fájlhoz itt: C#"
description: "Csatlakozzon az XLT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) webhely meglátogatásával.
