...
############################# Head ############################
head_title: "Bli med EPUB-filer i C# | EPUB Fusjon"
head_description: "Slå sammen flere EPUB-filer til én enkelt fil ved å bruke C# .NET-dokumentsammenslåings-API. Slå sammen bestemte sider eller sideområder fra ulike dokumenter til ett enkelt dokument."

############################# Header ############################
title: "Bli med EPUB-filer i C#"
description: "Bli med EPUB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Hvordan slå sammen flere EPUB-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for .NET-utviklere å slå sammen to eller flere EPUB-filer i applikasjonene sine ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til EPUB-filer ved å bruke C#-eksempelkoden">}}

        ```csharp    
        // Bli med EPUB filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bli med mer enn én EPUB-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
