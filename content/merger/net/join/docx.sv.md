...
############################# Head ############################
head_title: "Gå med i DOCX-filer i C# | DOCX Sammanslagning"
head_description: "Sammanfoga flera DOCX-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i DOCX-filer i C#"
description: "Gå med i DOCX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera DOCX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera DOCX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i DOCX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i DOCX-filer med GroupDocs.Merger API
