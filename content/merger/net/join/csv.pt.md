...
############################# Head ############################
head_title: "Junte CSV Arquivos em C# | CSV Fusão"
head_description: "Junte vários arquivos CSV em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a CSV arquivos em C#"
description: "Junte-se a CSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos CSV em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos CSV usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos CSV usando a API GroupDocs.Merger
