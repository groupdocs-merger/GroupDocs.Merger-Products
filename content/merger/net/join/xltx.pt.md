...
############################# Head ############################
head_title: "Junte XLTX Arquivos em C# | XLTX Fusão"
head_description: "Junte vários arquivos XLTX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLTX arquivos em C#"
description: "Junte-se a XLTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLTX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLTX usando a API GroupDocs.Merger
