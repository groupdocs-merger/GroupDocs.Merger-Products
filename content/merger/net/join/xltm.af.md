...
############################# Head ############################
head_title: "Sluit aan by XLTM-lêers in C# | XLTM samesmelting"
head_description: "Sluit aan by verskeie XLTM-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by XLTM-lêers in C#"
description: "Sluit aan by XLTM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie XLTM-lêers aan te sluit"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XLTM-lêers binne hul toepassings aan te sluit deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by XLTM-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by XLTM lêers deur GroupDocs.Merger API te gebruik
