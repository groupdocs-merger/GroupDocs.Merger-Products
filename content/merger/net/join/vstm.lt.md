...
############################# Head ############################
head_title: "Prisijunkite prie VSTM failų C# | VSTM Susijungimas"
head_description: "Sujunkite kelis VSTM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VSTM failų C#"
description: "Prisijunkite prie VSTM naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VSTM failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VSTM failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSTM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VSTM failus naudodami GroupDocs.Merger API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSTM failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) svetainėje.
