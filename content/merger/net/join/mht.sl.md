...
############################# Head ############################
head_title: "Pridružite se datotekam MHT v C# | MHT Združitev"
head_description: "Združite več datotek MHT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam MHT v C#"
description: "Pridružite se MHT z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni MHT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
