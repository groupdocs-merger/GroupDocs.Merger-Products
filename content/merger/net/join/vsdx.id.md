...
############################# Head ############################
head_title: "Gabung VSDX File di C# | VSDX Penggabungan"
head_description: "Gabungkan beberapa file VSDX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSDX File Di C#"
description: "Bergabunglah dengan VSDX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSDX File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VSDX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSDX menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file VSDX menggunakan GroupDocs.Merger API
