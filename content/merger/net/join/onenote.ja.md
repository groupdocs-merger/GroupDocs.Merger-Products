...
############################# Head ############################
head_title: "C# の ONENOTE ファイルに参加 | ONENOTE合併"
...
############################# Header ############################
title: "C# の ONENOTE ファイルに参加"
description: "数行の .NET コードで ONENOTE を結合します。"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) を使用すると、.NET の開発者は、アプリケーション内で 2 つ以上の ONENOTE ファイルを簡単に結合できます。いくつかの簡単な手順。
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/onenote) Web サイトにアクセスして、複数の ONENOTE ファイルに今すぐ参加してください。
       ライブデモには次の利点があります。
