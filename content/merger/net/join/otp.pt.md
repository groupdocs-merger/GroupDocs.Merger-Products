...
############################# Head ############################
head_title: "Junte OTP Arquivos em C# | OTP Fusão"
head_description: "Junte vários arquivos OTP em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a OTP arquivos em C#"
description: "Junte-se a OTP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos OTP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos OTP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos OTP usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos OTP usando a API GroupDocs.Merger
