...
############################# Head ############################
head_title: "Gabung DOTM File di C# | DOTM Penggabungan"
head_description: "Gabungkan beberapa file DOTM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung DOTM File Di C#"
description: "Bergabunglah dengan DOTM dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file DOTM menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file DOTM menggunakan GroupDocs.Merger API
