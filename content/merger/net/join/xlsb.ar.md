...
############################# Head ############################
head_title: "انضم إلى XLSB ملفات في C# | XLSB الاندماج"
head_description: "انضم إلى عدة ملفات XLSB في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات XLSB في C#"
description: "انضم إلى XLSB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات XLSB"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من XLSB داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات XLSB باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات XLSB باستخدام GroupDocs.Merger API
