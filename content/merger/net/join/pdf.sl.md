...
############################# Head ############################
head_title: "Pridružite se datotekam PDF v C# | PDF Združitev"
head_description: "Združite več datotek PDF v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PDF v C#"
description: "Pridružite se PDF z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PDF datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
