...
############################# Head ############################
head_title: "XLSX ፋይሎችን በC# | ይቀላቀሉ XLSX ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ XLSX ፋይሎችን ወደ አንድ ፋይል ይቀላቀሉ። ከተለያዩ ሰነዶች እስከ አንድ ሰነድ የተወሰኑ ገጾችን ወይም የገጽ ክልሎችን ይቀላቀሉ።"

############################# Header ############################
title: "በC# ውስጥ XLSX ፋይሎችን ይቀላቀሉ"
description: "XLSXን በጥቂት የ.NET ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በርካታ XLSX ፋይሎችን እንዴት መቀላቀል እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ XLSX ፋይሎችን በመተግበር ወደ መተግበሪያዎቻቸው መቀላቀል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# ምሳሌ ኮድን በመጠቀም XLSX ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም XLSX ፋይሎችን ይቀላቀሉ
        // የፈጣን ውህደት ከግቤት XLSX ሰነድ ጋር
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) ድር ጣቢያን በመጎብኘት ከአንድ በላይ XLSX ፋይሎችን ይቀላቀሉ።
