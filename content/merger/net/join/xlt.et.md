...
############################# Head ############################
head_title: "Liituge XLT failidega rakenduses C# | XLT Ühinemine"
head_description: "Ühendage mitu XLT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge XLT failiga rakenduses C#"
description: "Liituge tootega XLT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu XLT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama XLT faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil XLT failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe XLT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
