...
############################# Head ############################
head_title: "XPS ፋይሎችን በC# | ይቀላቀሉ XPS ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ XPS ፋይሎችን ወደ አንድ ፋይል ይቀላቀሉ። ከተለያዩ ሰነዶች እስከ አንድ ሰነድ የተወሰኑ ገጾችን ወይም የገጽ ክልሎችን ይቀላቀሉ።"

############################# Header ############################
title: "በC# ውስጥ XPS ፋይሎችን ይቀላቀሉ"
description: "XPSን በጥቂት የ.NET ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በርካታ XPS ፋይሎችን እንዴት መቀላቀል እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ XPS ፋይሎችን በመተግበር ወደ መተግበሪያዎቻቸው መቀላቀል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# ምሳሌ ኮድን በመጠቀም XPS ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም XPS ፋይሎችን ይቀላቀሉ
        // የፈጣን ውህደት ከግቤት XPS ሰነድ ጋር
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) ድር ጣቢያን በመጎብኘት ከአንድ በላይ XPS ፋይሎችን ይቀላቀሉ።
