...
############################# Head ############################
head_title: "Unisci file PDF in .NET"
head_description: "Integra GroupDocs.Merger for .NET nei tuoi progetti .NET per unire file PDF."

############################# Header ############################
title: "Unisci file PDF" 
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti PDF."
...
steps:
    enable: true
    title: "Passaggi per unire file PDF"
    content: |
      [GroupDocs.Merger](/merger/net/) ti consente di unire file PDF senza sforzo. Integra questa funzionalità nelle tue applicazioni .NET per gestire più documenti come un unico file.
      
      1. Imposta il percorso del primo file PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da file di formati diversi"
      content: |
        Questo esempio illustra come unire file PDF incorporando pagine selezionate da altri formati.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
