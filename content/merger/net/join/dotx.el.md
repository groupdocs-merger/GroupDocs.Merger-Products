...
############################# Head ############################
head_title: "Εγγραφείτε σε DOTX αρχεία στο C# | DOTX Συγχώνευση"
head_description: "Συνδέστε πολλά αρχεία DOTX σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συνδέστε συγκεκριμένες σελίδες ή σειρές σελίδων από διάφορα έγγραφα έως ένα μεμονωμένο έγγραφο."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία DOTX σε C#"
description: "Εγγραφείτε στο DOTX με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συνδέσετε πολλά αρχεία DOTX"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να ενώσουν δύο ή περισσότερα αρχεία DOTX στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία DOTX χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Εγγραφείτε σε αρχεία DOTX χρησιμοποιώντας το GroupDocs.Merger API
