...
############################# Head ############################
head_title: "Csatlakozás DOTX fájlokhoz a C# nyelven | DOTX Egyesülés"
head_description: "Csatlakoztasson több DOTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOTX fájlhoz itt: C#"
description: "Csatlakozzon az DOTX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOTX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOTX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOTX fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti DOTX dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOTX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) webhely meglátogatásával.
