...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memungkinkan Anda untuk menggabungkan file XLSX dengan cepat. Integrasikan fitur ini ke dalam aplikasi .NET Anda untuk menangani banyak dokumen sebagai satu file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman yang dipilih dari file dengan format berbeda"
      content: |
        Contoh ini menggambarkan cara menggabungkan file XLSX sambil menyertakan halaman yang dipilih dari format lain.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
