...
############################# Head ############################
head_title: "Prisijunkite prie RTF failų C# | RTF Susijungimas"
head_description: "Sujunkite kelis RTF failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie RTF failų C#"
description: "Prisijunkite prie RTF naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių RTF failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau RTF failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti RTF failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite RTF failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties RTF dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno RTF failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) svetainėje.
