...
############################# Head ############################
head_title: "Liituge TSV failidega rakenduses C# | TSV Ühinemine"
head_description: "Ühendage mitu TSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge TSV failiga rakenduses C#"
description: "Liituge tootega TSV mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu TSV faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama TSV faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil TSV failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe TSV failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
