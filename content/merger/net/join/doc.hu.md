...
############################# Head ############################
head_title: "Csatlakozás DOC fájlokhoz a C# nyelven | DOC Egyesülés"
head_description: "Csatlakoztasson több DOC fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOC fájlhoz itt: C#"
description: "Csatlakozzon az DOC termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOC fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOC fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOC fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti DOC dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOC fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) webhely meglátogatásával.
