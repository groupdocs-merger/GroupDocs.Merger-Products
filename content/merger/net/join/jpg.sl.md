...
############################# Head ############################
head_title: "Pridružite se datotekam JPG v C# | JPG Združitev"
head_description: "Združite več datotek JPG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam JPG v C#"
description: "Pridružite se JPG z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni JPG datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg).
