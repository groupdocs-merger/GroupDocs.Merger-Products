...
############################# Head ############################
head_title: "Gå med i DOC-filer i C# | DOC Sammanslagning"
head_description: "Sammanfoga flera DOC-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i DOC-filer i C#"
description: "Gå med i DOC med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera DOC-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera DOC-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i DOC-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i DOC-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en DOC-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
