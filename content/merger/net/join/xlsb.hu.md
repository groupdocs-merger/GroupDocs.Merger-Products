...
############################# Head ############################
head_title: "Csatlakozás XLSB fájlokhoz a C# nyelven | XLSB Egyesülés"
head_description: "Csatlakoztasson több XLSB fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLSB fájlhoz itt: C#"
description: "Csatlakozzon az XLSB termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLSB fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLSB fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLSB fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti XLSB dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLSB fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) webhely meglátogatásával.
