...
############################# Head ############################
head_title: "Pripojte sa k PPSX súborom v C# | PPSX Zlúčenie"
head_description: "Spojiť viacero súborov PPSX do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Spojiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "Pripojte sa k PPSX súborom v C#"
description: "Pripojte sa k PPSX pomocou niekoľkých riadkov kódu .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) poskytuje pohodlné riešenie na spojenie viacerých súborov PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázkov a mnoho ďalších dokumentov do jedného súboru v aplikáciách .NET. GroupDocs.Merger vám ušetrí veľa úsilia, pretože sa môžete pripojiť k PPSX dokumentom – nie je potrebné inštalovať žiadny softvér tretích strán, desktopové aplikácie alebo pluginy. Teraz je zbytočné strácať čas a spájať súbory ručne! Poslaním GroupDocs je poskytovať najlepšiu kvalitu a zjednodušiť pracovné postupy spracovania dokumentov.
...
steps:
    enable: true
    title_left: "Ako spojiť viacero súborov PPSX"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET spojiť dva alebo viac súborov PPSX v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako spojiť súbory PPSX pomocou vzorového kódu C#">}}

        ```csharp    
        // Pripojte sa k PPSX súborom pomocou GroupDocs.Merger API
