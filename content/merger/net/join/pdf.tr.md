...
############################# Head ############################
head_title: "C#'da PDF Dosyalarına Katılın | PDF Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PDF dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki PDF Dosyaya Katılın"
description: "Birkaç satır .NET koduyla PDF'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla PDF Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla PDF dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PDF dosyalarına katılın
