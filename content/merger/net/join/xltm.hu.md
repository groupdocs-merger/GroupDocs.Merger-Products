...
############################# Head ############################
head_title: "Csatlakozás XLTM fájlokhoz a C# nyelven | XLTM Egyesülés"
head_description: "Csatlakoztasson több XLTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLTM fájlhoz itt: C#"
description: "Csatlakozzon az XLTM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLTM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLTM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLTM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLTM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) webhely meglátogatásával.
