...
############################# Head ############################
head_title: "Prisijunkite prie PPT failų C# | PPT Susijungimas"
head_description: "Sujunkite kelis PPT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie PPT failų C#"
description: "Prisijunkite prie PPT naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių PPT failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau PPT failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PPT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite PPT failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties PPT dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno PPT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) svetainėje.
