...
############################# Head ############################
head_title: "Verbinden Sie VSDX-Dateien in C# | VSDX Fusion"
head_description: "Verbinden Sie mehrere VSDX-Dateien mithilfe der C# .NET Documents Merger API zu einer einzigen Datei. Verbinden Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Verbinden Sie VSDX Dateien in C#"
description: "Treten Sie VSDX mit ein paar Zeilen .NET-Code bei."
...
steps:
    enable: true
    title_left: "So verbinden Sie mehrere VSDX-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es Entwicklern von .NET leicht, zwei oder mehr VSDX-Dateien in ihren Anwendungen zusammenzuführen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So verbinden Sie VSDX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Verbinden Sie VSDX Dateien mit der GroupDocs.Merger API
...
demos:
    ...
    content: |
       Treten Sie jetzt mehr als einer VSDX-Datei bei, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) besuchen.
