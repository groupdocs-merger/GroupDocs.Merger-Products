...
############################# Head ############################
head_title: "Gabung PNG File di C# | PNG Penggabungan"
head_description: "Gabungkan beberapa file PNG ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung PNG File Di C#"
description: "Bergabunglah dengan PNG dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PNG menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file PNG menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu PNG file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/png).
