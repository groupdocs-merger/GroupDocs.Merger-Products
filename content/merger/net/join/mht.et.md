...
############################# Head ############################
head_title: "Liituge MHT failidega rakenduses C# | MHT Ühinemine"
head_description: "Ühendage mitu MHT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge MHT failiga rakenduses C#"
description: "Liituge tootega MHT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu MHT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama MHT faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada MHT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil MHT failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe MHT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
