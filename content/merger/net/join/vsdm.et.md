...
############################# Head ############################
head_title: "Liituge VSDM failidega rakenduses C# | VSDM Ühinemine"
head_description: "Ühendage mitu VSDM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge VSDM failiga rakenduses C#"
description: "Liituge tootega VSDM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu VSDM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama VSDM faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSDM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil VSDM failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe VSDM failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
