...
############################# Head ############################
head_title: "Gabung XPS File di C# | XPS Penggabungan"
head_description: "Gabungkan beberapa file XPS ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XPS File Di C#"
description: "Bergabunglah dengan XPS dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XPS menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file XPS menggunakan GroupDocs.Merger API
