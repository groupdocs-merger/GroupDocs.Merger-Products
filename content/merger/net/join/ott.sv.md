...
############################# Head ############################
head_title: "Gå med i OTT-filer i C# | OTT Sammanslagning"
head_description: "Sammanfoga flera OTT-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i OTT-filer i C#"
description: "Gå med i OTT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera OTT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera OTT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i OTT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i OTT-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en OTT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
