...
############################# Head ############################
head_title: "Csatlakozás XLTX fájlokhoz a C# nyelven | XLTX Egyesülés"
head_description: "Csatlakoztasson több XLTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLTX fájlhoz itt: C#"
description: "Csatlakozzon az XLTX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLTX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLTX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLTX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) webhely meglátogatásával.
