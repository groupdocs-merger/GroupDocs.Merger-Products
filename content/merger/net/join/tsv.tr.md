...
############################# Head ############################
head_title: "C#'da TSV Dosyalarına Katılın | TSV Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla TSV dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki TSV Dosyaya Katılın"
description: "Birkaç satır .NET koduyla TSV'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla TSV Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla TSV dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TSV dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TSV dosyalarına katılın
