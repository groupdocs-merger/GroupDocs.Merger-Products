...
############################# Head ############################
head_title: "Pridružite se datotekam ODT v C# | ODT Združitev"
head_description: "Združite več datotek ODT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam ODT v C#"
description: "Pridružite se ODT z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni ODT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
