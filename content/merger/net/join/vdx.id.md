...
############################# Head ############################
head_title: "Gabung VDX File di C# | VDX Penggabungan"
head_description: "Gabungkan beberapa file VDX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VDX File Di C#"
description: "Bergabunglah dengan VDX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VDX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VDX menggunakan GroupDocs.Merger API
