...
############################# Head ############################
head_title: "Csatlakozás PPS fájlokhoz a C# nyelven | PPS Egyesülés"
head_description: "Csatlakoztasson több PPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PPS fájlhoz itt: C#"
description: "Csatlakozzon az PPS termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPS fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PPS fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PPS fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti PPS dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PPS fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) webhely meglátogatásával.
