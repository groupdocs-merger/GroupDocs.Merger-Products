...
############################# Head ############################
head_title: "Pridružite se datotekam VSSM v C# | VSSM Združitev"
head_description: "Združite več datotek VSSM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam VSSM v C#"
description: "Pridružite se VSSM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni VSSM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
