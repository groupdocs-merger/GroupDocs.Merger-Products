...
############################# Head ############################
head_title: "Liituge VSSM failidega rakenduses C# | VSSM Ühinemine"
head_description: "Ühendage mitu VSSM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge VSSM failiga rakenduses C#"
description: "Liituge tootega VSSM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu VSSM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama VSSM faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VSSM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil VSSM failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe VSSM failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
