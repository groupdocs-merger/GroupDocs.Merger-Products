...
############################# Head ############################
head_title: "C#'da VSDM Dosyalarına Katılın | VSDM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSDM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki VSDM Dosyaya Katılın"
description: "Birkaç satır .NET koduyla VSDM'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla VSDM Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla VSDM dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDM dosyalarına katılın
