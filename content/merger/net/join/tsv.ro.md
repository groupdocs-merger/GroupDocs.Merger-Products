...
############################# Head ############################
head_title: "Alăturați-vă fișierelor TSV în C# | TSV Fuziune"
head_description: "Uniți mai multe fișiere TSV într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Uniți anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Alăturați-vă fișierelor TSV în C#"
description: "Alăturați-vă TSV cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să vă alăturați mai multor fișiere TSV"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să alăture două sau mai multe fișiere TSV în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor TSV utilizând codul exemplu C#">}}

        ```csharp    
        // Alăturați-vă fișierelor TSV utilizând API-ul GroupDocs.Merger
        // Instanțiați fuziunea cu documentul introdus TSV
...
demos:
    ...
    content: |
       Alăturați-vă mai mult de un fișier TSV chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
