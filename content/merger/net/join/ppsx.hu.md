...
############################# Head ############################
head_title: "Csatlakozás PPSX fájlokhoz a C# nyelven | PPSX Egyesülés"
head_description: "Csatlakoztasson több PPSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PPSX fájlhoz itt: C#"
description: "Csatlakozzon az PPSX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPSX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PPSX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PPSX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PPSX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) webhely meglátogatásával.
