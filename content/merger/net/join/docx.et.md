...
############################# Head ############################
head_title: "Liituge DOCX failidega rakenduses C# | DOCX Ühinemine"
head_description: "Ühendage mitu DOCX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge DOCX failiga rakenduses C#"
description: "Liituge tootega DOCX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu DOCX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama DOCX faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOCX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil DOCX failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe DOCX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
