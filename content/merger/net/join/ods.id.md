...
############################# Head ############################
head_title: "Gabung ODS File di C# | ODS Penggabungan"
head_description: "Gabungkan beberapa file ODS ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung ODS File Di C#"
description: "Bergabunglah dengan ODS dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ODS menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file ODS menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu ODS file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/ods).
