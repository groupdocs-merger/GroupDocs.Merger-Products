...
############################# Head ############################
head_title: "Junte DOT Arquivos em C# | DOT Fusão"
head_description: "Junte vários arquivos DOT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOT arquivos em C#"
description: "Junte-se a DOT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOT usando a API GroupDocs.Merger
