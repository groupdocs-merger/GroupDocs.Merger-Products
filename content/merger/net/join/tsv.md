...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to join two or more TSV files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join TSV files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one TSV files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
