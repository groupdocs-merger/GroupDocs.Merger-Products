...
############################# Head ############################
head_title: "Csatlakozás XLAM fájlokhoz a C# nyelven | XLAM Egyesülés"
head_description: "Csatlakoztasson több XLAM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLAM fájlhoz itt: C#"
description: "Csatlakozzon az XLAM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLAM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLAM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLAM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLAM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) webhely meglátogatásával.
