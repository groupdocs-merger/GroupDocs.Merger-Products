...
############################# Head ############################
head_title: "Csatlakozás VSTX fájlokhoz a C# nyelven | VSTX Egyesülés"
head_description: "Csatlakoztasson több VSTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSTX fájlhoz itt: C#"
description: "Csatlakozzon az VSTX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSTX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSTX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSTX fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti VSTX dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSTX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) webhely meglátogatásával.
