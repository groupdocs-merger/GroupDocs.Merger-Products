...
############################# Head ############################
head_title: "Csatlakozás PDF fájlokhoz a C# nyelven | PDF Egyesülés"
head_description: "Csatlakoztasson több PDF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PDF fájlhoz itt: C#"
description: "Csatlakozzon az PDF termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PDF fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PDF fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PDF fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PDF fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) webhely meglátogatásával.
