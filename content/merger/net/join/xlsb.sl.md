...
############################# Head ############################
head_title: "Pridružite se datotekam XLSB v C# | XLSB Združitev"
head_description: "Združite več datotek XLSB v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLSB v C#"
description: "Pridružite se XLSB z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLSB datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
