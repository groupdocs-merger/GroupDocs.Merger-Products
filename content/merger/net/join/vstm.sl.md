...
############################# Head ############################
head_title: "Pridružite se datotekam VSTM v C# | VSTM Združitev"
head_description: "Združite več datotek VSTM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam VSTM v C#"
description: "Pridružite se VSTM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni VSTM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm).
