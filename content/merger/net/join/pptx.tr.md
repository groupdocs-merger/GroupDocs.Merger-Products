...
############################# Head ############################
head_title: "C#'da PPTX Dosyalarına Katılın | PPTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PPTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki PPTX Dosyaya Katılın"
description: "Birkaç satır .NET koduyla PPTX'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla PPTX Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla PPTX dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPTX dosyalarına katılın
