...
############################# Head ############################
head_title: "Liituge PDF failidega rakenduses C# | PDF Ühinemine"
head_description: "Ühendage mitu PDF faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge PDF failiga rakenduses C#"
description: "Liituge tootega PDF mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu PDF faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama PDF faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PDF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil PDF failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe PDF failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
