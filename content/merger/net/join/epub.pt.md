...
############################# Head ############################
head_title: "Junte EPUB Arquivos em C# | EPUB Fusão"
head_description: "Junte vários arquivos EPUB em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a EPUB arquivos em C#"
description: "Junte-se a EPUB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos EPUB"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos EPUB em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos EPUB usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos EPUB usando a API GroupDocs.Merger
