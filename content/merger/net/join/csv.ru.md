...
############################# Head ############################
head_title: "Объедините файлы CSV в .NET"
head_description: "Интегрируйте GroupDocs.Merger for .NET в свои проекты .NET, чтобы объединять файлы CSV."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) позволяет вам без труда объединять файлы CSV. Интегрируйте эту функцию в свои приложения .NET, чтобы обрабатывать несколько документов как один файл.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение выбранных страниц из файлов различных форматов"
      content: |
        Этот пример иллюстрирует, как объединять файлы CSV, включая выбранные страницы из других форматов.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
