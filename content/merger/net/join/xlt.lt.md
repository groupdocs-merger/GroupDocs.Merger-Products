...
############################# Head ############################
head_title: "Prisijunkite prie XLT failų C# | XLT Susijungimas"
head_description: "Sujunkite kelis XLT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie XLT failų C#"
description: "Prisijunkite prie XLT naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių XLT failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau XLT failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite XLT failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties XLT dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno XLT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) svetainėje.
