...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) предоставляет удобное решение для объединения нескольких файлов PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, изображений и многие другие документы в один файл в приложениях .NET. GroupDocs.Merger сэкономит вам много усилий, так как вам разрешено объединять ODT документов — нет необходимости устанавливать какое-либо стороннее программное обеспечение, настольные приложения или плагины. Теперь не нужно тратить время и вручную объединять файлы! Миссия GroupDocs — обеспечить наилучшее качество и упростить рабочие процессы обработки документов.
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы ODT, используя пример кода C#">}}
        ...
        ```csharp    
        // Объединить ODT файлов с помощью GroupDocs.Merger API
