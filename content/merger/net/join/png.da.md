...
############################# Head ############################
head_title: "Deltag i PNG filer i C# | PNG Fusion"
head_description: "Sammenføj flere PNG filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i PNG filer i C#"
description: "Slut dig til PNG med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere PNG-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere PNG-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du PNG filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i PNG filer ved hjælp af GroupDocs.Merger API
