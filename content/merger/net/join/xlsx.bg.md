...
############################# Head ############################
head_title: "Присъединете се към XLSX файлове в C# | XLSX Сливане"
head_description: "Свържете няколко XLSX файла в един файл с помощта на C# .NET API за сливане на документи. Свържете конкретни страници или диапазони от страници от различни документи в един документ."

############################# Header ############################
title: "Присъединете се към XLSX файлове в C#"
description: "Присъединете се към XLSX с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Как да съедините няколко XLSX файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да съединят два или повече XLSX файла в своите приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да съедините XLSX файлове с C# примерен код">}}

        ```csharp    
        // Присъединете се към XLSX файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Присъединете се към повече от един XLSX файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
