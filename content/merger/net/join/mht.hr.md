...
############################# Head ############################
head_title: "Pridružite MHT datotekama u C# | MHT Spajanje"
head_description: "Spojite više MHT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite MHT datotekama u C#"
description: "Pridružite se MHT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti MHT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite MHT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne MHT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
