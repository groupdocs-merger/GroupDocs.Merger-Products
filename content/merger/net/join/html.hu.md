...
############################# Head ############################
head_title: "Csatlakozás HTML fájlokhoz a C# nyelven | HTML Egyesülés"
head_description: "Csatlakoztasson több HTML fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás HTML fájlhoz itt: C#"
description: "Csatlakozzon az HTML termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több HTML fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több HTML fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson HTML fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több HTML fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) webhely meglátogatásával.
