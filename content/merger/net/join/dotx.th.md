...
############################# Head ############################
head_title: "เข้าร่วม DOTX ไฟล์ใน C# | DOTX การควบรวมกิจการ"
head_description: "รวมไฟล์ DOTX หลายไฟล์เป็นไฟล์เดียวโดยใช้ API การรวมเอกสาร C# .NET รวมหน้าหรือช่วงหน้าเฉพาะจากเอกสารต่างๆ เป็นเอกสารเดียว"

############################# Header ############################
title: "เข้าร่วม DOTX ไฟล์ใน C#"
description: "เข้าร่วม DOTX ด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "วิธีเข้าร่วมไฟล์ DOTX หลายไฟล์"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา .NET เข้าร่วมไฟล์ DOTX สองไฟล์ขึ้นไปภายในแอปพลิเคชันได้โดยง่ายโดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีเข้าร่วมไฟล์ DOTX โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // เข้าร่วม DOTX ไฟล์โดยใช้ GroupDocs.Merger API
        // ยกตัวอย่างการควบรวมกิจการด้วยการป้อนข้อมูล DOTX เอกสาร
...
demos:
    ...
    content: |
       เข้าร่วมมากกว่าหนึ่ง DOTX ไฟล์ในขณะนี้โดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx)
