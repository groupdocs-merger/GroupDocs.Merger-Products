...
############################# Head ############################
head_title: "Deltag i XLSM filer i C# | XLSM Fusion"
head_description: "Sammenføj flere XLSM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i XLSM filer i C#"
description: "Slut dig til XLSM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere XLSM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere XLSM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du XLSM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i XLSM filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input XLSM dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én XLSM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
