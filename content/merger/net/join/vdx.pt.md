...
############################# Head ############################
head_title: "Junte VDX Arquivos em C# | VDX Fusão"
head_description: "Junte vários arquivos VDX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VDX arquivos em C#"
description: "Junte-se a VDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VDX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VDX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VDX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VDX usando a API GroupDocs.Merger
