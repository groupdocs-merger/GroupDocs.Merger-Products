...
############################# Head ############################
head_title: "Liituge DOCM failidega rakenduses C# | DOCM Ühinemine"
head_description: "Ühendage mitu DOCM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge DOCM failiga rakenduses C#"
description: "Liituge tootega DOCM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu DOCM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama DOCM faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOCM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil DOCM failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe DOCM failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
