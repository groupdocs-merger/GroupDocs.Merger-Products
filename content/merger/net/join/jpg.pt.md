...
############################# Head ############################
head_title: "Junte arquivos JPG em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para juntar arquivos JPG de forma eficiente."

############################# Header ############################
title: "Junte arquivos JPG" 
description: "Utilize GroupDocs.Merger for .NET para desenvolver aplicações .NET que combinam documentos JPG de forma eficaz."
...
steps:
    enable: true
    title: "Passos para juntar arquivos JPG"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você junte arquivos JPG de forma eficiente. Integre esse recurso em suas aplicações .NET para lidar com múltiplos documentos como um único arquivo.
      
      1. Defina o caminho para o primeiro arquivo JPG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância de Merger com o documento de entrada JPG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como juntar arquivos JPG enquanto incorpora páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
