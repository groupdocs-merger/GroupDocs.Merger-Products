...
############################# Head ############################
head_title: "انضم إلى ONE ملفات في C# | ONE الاندماج"
head_description: "انضم إلى عدة ملفات ONE في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات ONE في C#"
description: "انضم إلى ONE ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات ONE"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من ONE داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات ONE باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات ONE باستخدام GroupDocs.Merger API
