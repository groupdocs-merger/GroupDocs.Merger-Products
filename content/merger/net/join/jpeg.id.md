...
############################# Head ############################
head_title: "Gabung JPEG File di C# | JPEG Penggabungan"
head_description: "Gabungkan beberapa file JPEG ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung JPEG File Di C#"
description: "Bergabunglah dengan JPEG dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPEG menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file JPEG menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu JPEG file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/jpeg).
