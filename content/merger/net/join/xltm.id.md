...
############################# Head ############################
head_title: "Gabung XLTM File di C# | XLTM Penggabungan"
head_description: "Gabungkan beberapa file XLTM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XLTM File Di C#"
description: "Bergabunglah dengan XLTM dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLTM menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file XLTM menggunakan GroupDocs.Merger API
