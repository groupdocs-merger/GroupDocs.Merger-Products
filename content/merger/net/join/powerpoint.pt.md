...
############################# Head ############################
head_title: "Junte arquivos POWERPOINT em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para juntar arquivos POWERPOINT de forma eficiente."

############################# Header ############################
title: "Junte arquivos POWERPOINT" 
description: "Utilize GroupDocs.Merger for .NET para desenvolver aplicações .NET que combinam documentos POWERPOINT de forma eficaz."
...
steps:
    enable: true
    title: "Passos para juntar arquivos POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você junte arquivos POWERPOINT de forma eficiente. Integre esse recurso em suas aplicações .NET para lidar com múltiplos documentos como um único arquivo.
      
      1. Defina o caminho para o primeiro arquivo POWERPOINT.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância de Merger com o documento de entrada POWERPOINT
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como juntar arquivos POWERPOINT enquanto incorpora páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
