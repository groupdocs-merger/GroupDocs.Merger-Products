...
############################# Head ############################
head_title: "Junte OTT Arquivos em C# | OTT Fusão"
head_description: "Junte vários arquivos OTT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a OTT arquivos em C#"
description: "Junte-se a OTT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos OTT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos OTT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos OTT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos OTT usando a API GroupDocs.Merger
