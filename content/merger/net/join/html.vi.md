...
############################# Head ############################
head_title: "Gộp các tệp HTML trong .NET"
head_description: "Tích hợp GroupDocs.Merger for .NET vào các dự án .NET của bạn để gộp các tệp HTML một cách hiệu quả."

############################# Header ############################
title: "Gộp các tệp HTML" 
description: "Sử dụng GroupDocs.Merger for .NET để xây dựng các ứng dụng .NET có khả năng gộp các tài liệu HTML một cách hiệu quả."
...
steps:
    enable: true
    title: "Các bước để gộp các tệp HTML"
    content: |
      [GroupDocs.Merger](/merger/net/) cho phép bạn gộp các tệp HTML một cách hiệu quả. Tích hợp tính năng này vào các ứng dụng .NET của bạn để xử lý nhiều tài liệu như một tệp duy nhất.
      
      1. Đặt đường dẫn đến tệp HTML đầu tiên.
      2. Chọn tệp thứ hai.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gộp các trang đã chọn từ các tệp có định dạng khác nhau"
      content: |
        Ví dụ này minh họa cách gộp các tệp HTML trong khi bao gồm các trang đã chọn từ các định dạng khác.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
