...
############################# Head ############################
head_title: "Pridružite se datotekam PNG v C# | PNG Združitev"
head_description: "Združite več datotek PNG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PNG v C#"
description: "Pridružite se PNG z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PNG datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
