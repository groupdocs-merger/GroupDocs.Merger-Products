...
############################# Head ############################
head_title: "Deltag i VSDX filer i C# | VSDX Fusion"
head_description: "Sammenføj flere VSDX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i VSDX filer i C#"
description: "Slut dig til VSDX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere VSDX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere VSDX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du VSDX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i VSDX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slut dig til mere end én VSDX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
