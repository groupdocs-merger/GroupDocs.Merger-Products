...
############################# Head ############################
head_title: "Junte XLT Arquivos em C# | XLT Fusão"
head_description: "Junte vários arquivos XLT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLT arquivos em C#"
description: "Junte-se a XLT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLT usando a API GroupDocs.Merger
