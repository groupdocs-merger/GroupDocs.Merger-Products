...
############################# Head ############################
head_title: "C#'da BMP Dosyalarına Katılın | BMP Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla BMP dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki BMP Dosyaya Katılın"
description: "Birkaç satır .NET koduyla BMP'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla BMP Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla BMP dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak BMP dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak BMP dosyalarına katılın
