...
############################# Head ############################
head_title: "Pridružite DOC datotekama u C# | DOC Spajanje"
head_description: "Spojite više DOC datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite DOC datotekama u C#"
description: "Pridružite se DOC s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOC datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite DOC datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne DOC datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
