...
############################# Head ############################
head_title: "Junte DOTX Arquivos em C# | DOTX Fusão"
head_description: "Junte vários arquivos DOTX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOTX arquivos em C#"
description: "Junte-se a DOTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOTX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOTX usando a API GroupDocs.Merger
