...
############################# Head ############################
head_title: "انضم إلى MHTML ملفات في C# | MHTML الاندماج"
head_description: "انضم إلى عدة ملفات MHTML في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات MHTML في C#"
description: "انضم إلى MHTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات MHTML"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من MHTML داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات MHTML باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات MHTML باستخدام GroupDocs.Merger API
        // إنشاء دمج مع مستند الإدخال MHTML
...
demos:
    ...
    content: |
       انضم إلى أكثر من MHTML ملف واحد الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
