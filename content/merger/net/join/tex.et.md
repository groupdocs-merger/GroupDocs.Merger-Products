...
############################# Head ############################
head_title: "Liituge TEX failidega rakenduses C# | TEX Ühinemine"
head_description: "Ühendage mitu TEX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge TEX failiga rakenduses C#"
description: "Liituge tootega TEX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu TEX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama TEX faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TEX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil TEX failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe TEX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex).
