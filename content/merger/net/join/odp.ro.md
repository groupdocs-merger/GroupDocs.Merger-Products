...
############################# Head ############################
head_title: "Alăturați-vă fișierelor ODP în C# | ODP Fuziune"
head_description: "Uniți mai multe fișiere ODP într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Uniți anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Alăturați-vă fișierelor ODP în C#"
description: "Alăturați-vă ODP cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să vă alăturați mai multor fișiere ODP"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să alăture două sau mai multe fișiere ODP în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să vă alăturați fișierelor ODP utilizând codul exemplu C#">}}

        ```csharp    
        // Alăturați-vă fișierelor ODP utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Alăturați-vă mai mult de un fișier ODP chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
