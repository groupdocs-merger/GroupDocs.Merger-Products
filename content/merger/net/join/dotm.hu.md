...
############################# Head ############################
head_title: "Csatlakozás DOTM fájlokhoz a C# nyelven | DOTM Egyesülés"
head_description: "Csatlakoztasson több DOTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOTM fájlhoz itt: C#"
description: "Csatlakozzon az DOTM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOTM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOTM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOTM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOTM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm) webhely meglátogatásával.
