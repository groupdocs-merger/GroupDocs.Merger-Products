...
############################# Head ############################
head_title: "Junte DOCX Arquivos em C# | DOCX Fusão"
head_description: "Junte vários arquivos DOCX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOCX arquivos em C#"
description: "Junte-se a DOCX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOCX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOCX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOCX usando a API GroupDocs.Merger
