...
############################# Head ############################
head_title: "Deltag i ONE filer i C# | ONE Fusion"
head_description: "Sammenføj flere ONE filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i ONE filer i C#"
description: "Slut dig til ONE med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere ONE-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere ONE-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du ONE filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i ONE filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input ONE dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én ONE-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
