...
############################# Head ############################
head_title: "Gabung ODT File di C# | ODT Penggabungan"
head_description: "Gabungkan beberapa file ODT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung ODT File Di C#"
description: "Bergabunglah dengan ODT dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ODT menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file ODT menggunakan GroupDocs.Merger API
