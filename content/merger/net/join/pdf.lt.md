...
############################# Head ############################
head_title: "Prisijunkite prie PDF failų C# | PDF Susijungimas"
head_description: "Sujunkite kelis PDF failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie PDF failų C#"
description: "Prisijunkite prie PDF naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių PDF failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau PDF failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PDF failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite PDF failus naudodami GroupDocs.Merger API
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno PDF failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) svetainėje.
