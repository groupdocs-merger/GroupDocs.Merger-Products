...
############################# Head ############################
head_title: "Sluit aan by RTF-lêers in C# | RTF samesmelting"
head_description: "Sluit aan by verskeie RTF-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by RTF-lêers in C#"
description: "Sluit aan by RTF met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie RTF-lêers aan te sluit"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer RTF-lêers binne hul toepassings aan te sluit deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by RTF-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by RTF lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Sluit nou by meer as een RTF-lêers aan deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) webwerf te besoek.
