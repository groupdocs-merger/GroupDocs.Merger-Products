...
############################# Head ############################
head_title: "Word lid van PPSX bestanden in C# | PPSX Fusie"
head_description: "Voeg meerdere PPSX-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van PPSX bestanden in C#"
description: "Sluit je aan bij PPSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere PPSX bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPSX-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u PPSX bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van PPSX bestanden met behulp van GroupDocs.Merger API
