...
############################# Head ############################
head_title: "Csatlakozás VDX fájlokhoz a C# nyelven | VDX Egyesülés"
head_description: "Csatlakoztasson több VDX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VDX fájlhoz itt: C#"
description: "Csatlakozzon az VDX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VDX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VDX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VDX fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti VDX dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VDX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) webhely meglátogatásával.
