...
############################# Head ############################
head_title: "انضم إلى XLAM ملفات في C# | XLAM الاندماج"
head_description: "انضم إلى عدة ملفات XLAM في ملف واحد باستخدام واجهة برمجة تطبيقات دمج المستندات C# .NET. قم بربط صفحات أو نطاقات صفحات معينة من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "انضم إلى ملفات XLAM في C#"
description: "انضم إلى XLAM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية ضم عدة ملفات XLAM"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET الانضمام إلى ملفين أو أكثر من XLAM داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية الانضمام إلى ملفات XLAM باستخدام كود مثال C#">}}

        ```csharp    
        // انضم إلى ملفات XLAM باستخدام GroupDocs.Merger API
