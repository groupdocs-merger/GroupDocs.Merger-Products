...
############################# Head ############################
head_title: "Csatlakozás TXT fájlokhoz a C# nyelven | TXT Egyesülés"
head_description: "Csatlakoztasson több TXT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás TXT fájlhoz itt: C#"
description: "Csatlakozzon az TXT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több TXT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több TXT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TXT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson TXT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több TXT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) webhely meglátogatásával.
