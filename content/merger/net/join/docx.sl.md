...
############################# Head ############################
head_title: "Pridružite se datotekam DOCX v C# | DOCX Združitev"
head_description: "Združite več datotek DOCX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam DOCX v C#"
description: "Pridružite se DOCX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni DOCX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
