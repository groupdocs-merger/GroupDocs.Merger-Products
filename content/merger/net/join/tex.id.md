...
############################# Head ############################
head_title: "Gabung TEX File di C# | TEX Penggabungan"
head_description: "Gabungkan beberapa file TEX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung TEX File Di C#"
description: "Bergabunglah dengan TEX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file TEX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file TEX menggunakan GroupDocs.Merger API
