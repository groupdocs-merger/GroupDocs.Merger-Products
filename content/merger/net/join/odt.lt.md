...
############################# Head ############################
head_title: "Prisijunkite prie ODT failų C# | ODT Susijungimas"
head_description: "Sujunkite kelis ODT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie ODT failų C#"
description: "Prisijunkite prie ODT naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių ODT failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau ODT failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti ODT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite ODT failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties ODT dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno ODT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) svetainėje.
