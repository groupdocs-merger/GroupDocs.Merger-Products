...
############################# Head ############################
head_title: "Pridružite XLTX datotekama u C# | XLTX Spajanje"
head_description: "Spojite više XLTX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLTX datotekama u C#"
description: "Pridružite se XLTX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLTX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLTX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLTX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
