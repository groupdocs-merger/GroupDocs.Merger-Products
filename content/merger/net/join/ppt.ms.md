...
############################# Head ############################
head_title: "Sertai PPT Fail dalam C# | PPT Penggabungan"
head_description: "Sertai berbilang fail PPT ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Sertai halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Sertai PPT Fail Dalam C#"
description: "Sertai PPT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menyertai Berbilang PPT Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menyertai dua atau lebih PPT fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail PPT menggunakan kod contoh C#.">}}

        ```csharp    
        // Sertai PPT fail menggunakan API GroupDocs.Merger
