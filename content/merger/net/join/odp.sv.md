...
############################# Head ############################
head_title: "Gå med i ODP-filer i C# | ODP Sammanslagning"
head_description: "Sammanfoga flera ODP-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i ODP-filer i C#"
description: "Gå med i ODP med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera ODP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera ODP-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i ODP-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i ODP-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en ODP-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
