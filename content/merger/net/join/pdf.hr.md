...
############################# Head ############################
head_title: "Pridružite PDF datotekama u C# | PDF Spajanje"
head_description: "Spojite više PDF datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PDF datotekama u C#"
description: "Pridružite se PDF s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PDF datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PDF datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PDF datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
