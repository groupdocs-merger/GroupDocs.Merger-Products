...
############################# Head ############################
head_title: "Deltag i TSV filer i C# | TSV Fusion"
head_description: "Sammenføj flere TSV filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i TSV filer i C#"
description: "Slut dig til TSV med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere TSV-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere TSV-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du TSV filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i TSV filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input TSV dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én TSV-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
