...
############################# Head ############################
head_title: "Junte XLS Arquivos em C# | XLS Fusão"
head_description: "Junte vários arquivos XLS em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLS arquivos em C#"
description: "Junte-se a XLS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLS usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLS usando a API GroupDocs.Merger
