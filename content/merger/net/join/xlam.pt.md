...
############################# Head ############################
head_title: "Junte XLAM Arquivos em C# | XLAM Fusão"
head_description: "Junte vários arquivos XLAM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLAM arquivos em C#"
description: "Junte-se a XLAM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLAM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLAM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLAM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLAM usando a API GroupDocs.Merger
