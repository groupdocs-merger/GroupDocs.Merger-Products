...
############################# Head ############################
head_title: "Gå med i PPT-filer i C# | PPT Sammanslagning"
head_description: "Sammanfoga flera PPT-filer till en enda fil med hjälp av C# .NET documents merger API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Gå med i PPT-filer i C#"
description: "Gå med i PPT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man sammanfogar flera PPT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att ansluta två eller flera PPT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man går med i PPT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Gå med i PPT-filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gå med i mer än en PPT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
