...
############################# Head ############################
head_title: "Join HTML files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily join HTML files."

############################# Header ############################
title: "Join HTML files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently join HTML documents."
...
steps:
    enable: true
    title: "Steps to join HTML files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to join HTML files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from files of different formats"
      content: |
        This example illustrates how to join HTML files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
