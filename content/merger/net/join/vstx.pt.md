...
############################# Head ############################
head_title: "Junte VSTX Arquivos em C# | VSTX Fusão"
head_description: "Junte vários arquivos VSTX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSTX arquivos em C#"
description: "Junte-se a VSTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSTX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSTX usando a API GroupDocs.Merger
