...
############################# Head ############################
head_title: "Junte MHT Arquivos em C# | MHT Fusão"
head_description: "Junte vários arquivos MHT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a MHT arquivos em C#"
description: "Junte-se a MHT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos MHT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos MHT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos MHT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos MHT usando a API GroupDocs.Merger
