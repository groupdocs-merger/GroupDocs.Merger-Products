...
############################# Head ############################
head_title: "C#'da CSV Dosyalarına Katılın | CSV Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla CSV dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki CSV Dosyaya Katılın"
description: "Birkaç satır .NET koduyla CSV'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla CSV Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla CSV dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak CSV dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak CSV dosyalarına katılın
