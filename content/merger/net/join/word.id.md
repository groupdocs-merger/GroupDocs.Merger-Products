...
############################# Head ############################
head_title: "Gabung WORD File di C# | WORD Penggabungan"
head_description: "Gabungkan beberapa file WORD ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung WORD File Di C#"
description: "Bergabunglah dengan WORD dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa WORD File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file WORD dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file WORD menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file WORD menggunakan GroupDocs.Merger API
