...
############################# Head ############################
head_title: "Dołącz do DOC plików w C# | DOC Połączenie"
head_description: "Połącz wiele plików DOC w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do DOC plików w C#"
description: "Dołącz do DOC za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików DOC"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom .NET dołączenie do dwóch lub więcej plików DOC w ich aplikacjach poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików DOC przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików DOC za pomocą GroupDocs.Merger API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego DOC plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
