...
############################# Head ############################
head_title: "Pridružite XLTM datotekama u C# | XLTM Spajanje"
head_description: "Spojite više XLTM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLTM datotekama u C#"
description: "Pridružite se XLTM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLTM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLTM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLTM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
