...
############################# Head ############################
head_title: "Bli med DOCX-filer i C# | DOCX Fusjon"
...
############################# Header ############################
title: "Bli med DOCX-filer i C#"
description: "Bli med DOCX med noen få linjer med .NET-kode."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gir en praktisk løsning for å slå sammen flere PDF-filer, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, bilder og mange andre dokumenter i én enkelt fil i .NET-applikasjoner. GroupDocs.Merger vil spare deg for mye krefter, siden du har lov til å bli med i DOCX-dokumenter - det er ikke nødvendig å installere tredjepartsprogramvare, skrivebordsapplikasjoner eller plugins. Nå er det unødvendig å kaste bort tiden din og koble til filer manuelt! GroupDocs oppgave er å gi den beste kvaliteten og forenkle dokumentbehandlingsarbeidsflyten.
...
steps:
    enable: true
    title_left: "Hvordan slå sammen flere DOCX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til DOCX-filer ved å bruke C#-eksempelkoden">}}

        ```csharp    
        // Bli med DOCX filer ved hjelp av GroupDocs.Merger API
