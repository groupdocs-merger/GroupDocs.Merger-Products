...
############################# Head ############################
head_title: "Pridružite ODT datotekama u C# | ODT Spajanje"
head_description: "Spojite više ODT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite ODT datotekama u C#"
description: "Pridružite se ODT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite ODT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne ODT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
