...
############################# Head ############################
head_title: "Pridružite se datotekam BMP v C# | BMP Združitev"
head_description: "Združite več datotek BMP v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam BMP v C#"
description: "Pridružite se BMP z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni BMP datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
