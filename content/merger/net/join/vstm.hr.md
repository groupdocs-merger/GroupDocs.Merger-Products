...
############################# Head ############################
head_title: "Pridružite VSTM datotekama u C# | VSTM Spajanje"
head_description: "Spojite više VSTM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VSTM datotekama u C#"
description: "Pridružite se VSTM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSTM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VSTM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VSTM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm).
