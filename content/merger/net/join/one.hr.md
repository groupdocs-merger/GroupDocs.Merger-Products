...
############################# Head ############################
head_title: "Pridružite ONE datotekama u C# | ONE Spajanje"
head_description: "Spojite više ONE datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite ONE datotekama u C#"
description: "Pridružite se ONE s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ONE datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite ONE datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne ONE datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
