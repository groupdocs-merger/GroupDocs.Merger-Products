...
############################# Head ############################
head_title: "Joindre les fichiers XLT dans C# | XLT Fusion"
head_description: "Joignez plusieurs fichiers XLT en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Joignez des pages spécifiques ou des plages de pages de divers documents à un seul document."

############################# Header ############################
title: "Joindre XLT fichiers dans C#"
description: "Joignez XLT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment joindre plusieurs fichiers XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de joindre facilement deux ou plusieurs fichiers XLT dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment joindre des fichiers XLT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Joindre XLT fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Joignez-vous à plusieurs fichiers XLT dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
