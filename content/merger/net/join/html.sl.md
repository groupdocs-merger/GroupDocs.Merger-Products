...
############################# Head ############################
head_title: "Pridružite se datotekam HTML v C# | HTML Združitev"
head_description: "Združite več datotek HTML v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam HTML v C#"
description: "Pridružite se HTML z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni HTML datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
