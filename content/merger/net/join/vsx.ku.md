...
############################# Head ############################
head_title: "Tevlî pelên VSX li C# | VSX Hevgirtin"
head_description: "Gelek pelên VSX bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên VSX Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî VSX bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên VSX dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir VSX pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên VSX dibe">}}

        ```csharp    
        // Tevlî pelên VSX bibin bi karanîna GroupDocs.Merger API
