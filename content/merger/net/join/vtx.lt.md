...
############################# Head ############################
head_title: "Prisijunkite prie VTX failų C# | VTX Susijungimas"
head_description: "Sujunkite kelis VTX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VTX failų C#"
description: "Prisijunkite prie VTX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VTX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VTX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VTX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties VTX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VTX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) svetainėje.
