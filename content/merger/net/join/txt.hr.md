...
############################# Head ############################
head_title: "Pridružite TXT datotekama u C# | TXT Spajanje"
head_description: "Spojite više TXT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite TXT datotekama u C#"
description: "Pridružite se TXT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti TXT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite TXT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne TXT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
