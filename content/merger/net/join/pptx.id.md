...
############################# Head ############################
head_title: "Gabung PPTX File di C# | PPTX Penggabungan"
head_description: "Gabungkan beberapa file PPTX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung PPTX File Di C#"
description: "Bergabunglah dengan PPTX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPTX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file PPTX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu PPTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/pptx).
