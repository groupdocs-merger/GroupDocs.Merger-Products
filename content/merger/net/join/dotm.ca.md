...
############################# Head ############################
head_title: "Uniu-vos a DOTM Fitxers a C# | DOTM Fusió"
head_description: "Uniu diversos fitxers DOTM en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a DOTM fitxers a C#"
description: "Uniu-vos a DOTM amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers DOTM"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers DOTM dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers DOTM mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers DOTM mitjançant l'API de GroupDocs.Merger
        // Instanciï Merger amb el document d'entrada DOTM
...
demos:
    ...
    content: |
       Uniu-vos a més d'un fitxer DOTM ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
