...
############################# Head ############################
head_title: "Liituge PPS failidega rakenduses C# | PPS Ühinemine"
head_description: "Ühendage mitu PPS faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge PPS failiga rakenduses C#"
description: "Liituge tootega PPS mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu PPS faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama PPS faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil PPS failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe PPS failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
