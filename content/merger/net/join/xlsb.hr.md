...
############################# Head ############################
head_title: "Pridružite XLSB datotekama u C# | XLSB Spajanje"
head_description: "Spojite više XLSB datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLSB datotekama u C#"
description: "Pridružite se XLSB s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSB datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLSB datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLSB datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
