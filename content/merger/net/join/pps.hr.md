...
############################# Head ############################
head_title: "Pridružite PPS datotekama u C# | PPS Spajanje"
head_description: "Spojite više PPS datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PPS datotekama u C#"
description: "Pridružite se PPS s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPS datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PPS datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PPS datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
