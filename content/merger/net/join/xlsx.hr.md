...
############################# Head ############################
head_title: "Pridružite XLSX datotekama u C# | XLSX Spajanje"
head_description: "Spojite više XLSX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLSX datotekama u C#"
description: "Pridružite se XLSX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLSX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLSX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
