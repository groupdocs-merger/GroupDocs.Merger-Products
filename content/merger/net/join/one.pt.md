...
############################# Head ############################
head_title: "Junte ONE Arquivos em C# | ONE Fusão"
head_description: "Junte vários arquivos ONE em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a ONE arquivos em C#"
description: "Junte-se a ONE com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos ONE em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos ONE usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos ONE usando a API GroupDocs.Merger
