...
############################# Head ############################
head_title: "Gabung MHT File di C# | MHT Penggabungan"
head_description: "Gabungkan beberapa file MHT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung MHT File Di C#"
description: "Bergabunglah dengan MHT dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file MHT menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file MHT menggunakan GroupDocs.Merger API
