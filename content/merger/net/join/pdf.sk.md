...
############################# Head ############################
head_title: "Pripojte sa k PDF súborom v C# | PDF Zlúčenie"
head_description: "Spojiť viacero súborov PDF do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Spojiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "Pripojte sa k PDF súborom v C#"
description: "Pripojte sa k PDF pomocou niekoľkých riadkov kódu .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) poskytuje pohodlné riešenie na spojenie viacerých súborov PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázkov a mnoho ďalších dokumentov do jedného súboru v aplikáciách .NET. GroupDocs.Merger vám ušetrí veľa úsilia, pretože sa môžete pripojiť k PDF dokumentom – nie je potrebné inštalovať žiadny softvér tretích strán, desktopové aplikácie alebo pluginy. Teraz je zbytočné strácať čas a spájať súbory ručne! Poslaním GroupDocs je poskytovať najlepšiu kvalitu a zjednodušiť pracovné postupy spracovania dokumentov.
...
steps:
    enable: true
    title_left: "Ako spojiť viacero súborov PDF"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET spojiť dva alebo viac súborov PDF v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako spojiť súbory PDF pomocou vzorového kódu C#">}}

        ```csharp    
        // Pripojte sa k PDF súborom pomocou GroupDocs.Merger API
