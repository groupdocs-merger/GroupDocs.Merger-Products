...
############################# Head ############################
head_title: "Pridružite se datotekam VSTX v C# | VSTX Združitev"
head_description: "Združite več datotek VSTX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam VSTX v C#"
description: "Pridružite se VSTX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni VSTX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx).
