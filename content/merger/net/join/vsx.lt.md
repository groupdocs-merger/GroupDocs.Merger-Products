...
############################# Head ############################
head_title: "Prisijunkite prie VSX failų C# | VSX Susijungimas"
head_description: "Sujunkite kelis VSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VSX failų C#"
description: "Prisijunkite prie VSX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VSX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VSX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VSX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties VSX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) svetainėje.
