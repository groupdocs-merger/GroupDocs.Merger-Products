...
############################# Head ############################
head_title: "C#'da RTF Dosyalarına Katılın | RTF Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla RTF dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki RTF Dosyaya Katılın"
description: "Birkaç satır .NET koduyla RTF'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla RTF Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla RTF dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak RTF dosyalarına katılın
