...
############################# Head ############################
head_title: "C#'da DOT Dosyalarına Katılın | DOT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki DOT Dosyaya Katılın"
description: "Birkaç satır .NET koduyla DOT'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla DOT Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla DOT dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOT dosyalarına katılın
