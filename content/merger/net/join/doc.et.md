...
############################# Head ############################
head_title: "Liituge DOC failidega rakenduses C# | DOC Ühinemine"
head_description: "Ühendage mitu DOC faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge DOC failiga rakenduses C#"
description: "Liituge tootega DOC mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu DOC faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama DOC faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOC faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil DOC failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe DOC failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
