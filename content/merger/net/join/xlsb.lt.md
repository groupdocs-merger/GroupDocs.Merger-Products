...
############################# Head ############################
head_title: "Prisijunkite prie XLSB failų C# | XLSB Susijungimas"
head_description: "Sujunkite kelis XLSB failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie XLSB failų C#"
description: "Prisijunkite prie XLSB naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių XLSB failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau XLSB failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLSB failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite XLSB failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties XLSB dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno XLSB failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) svetainėje.
