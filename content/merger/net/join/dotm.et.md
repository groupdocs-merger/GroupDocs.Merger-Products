...
############################# Head ############################
head_title: "Liituge DOTM failidega rakenduses C# | DOTM Ühinemine"
head_description: "Ühendage mitu DOTM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge DOTM failiga rakenduses C#"
description: "Liituge tootega DOTM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu DOTM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama DOTM faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada DOTM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil DOTM failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe DOTM failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
