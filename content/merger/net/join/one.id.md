...
############################# Head ############################
head_title: "Gabung ONE File di C# | ONE Penggabungan"
head_description: "Gabungkan beberapa file ONE ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung ONE File Di C#"
description: "Bergabunglah dengan ONE dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ONE menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file ONE menggunakan GroupDocs.Merger API
