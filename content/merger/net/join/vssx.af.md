...
############################# Head ############################
head_title: "Sluit aan by VSSX-lêers in C# | VSSX samesmelting"
head_description: "Sluit aan by verskeie VSSX-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by VSSX-lêers in C#"
description: "Sluit aan by VSSX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie VSSX-lêers aan te sluit"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by VSSX-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by VSSX lêers deur GroupDocs.Merger API te gebruik
