...
############################# Head ############################
head_title: "Pridružite DOTM datotekama u C# | DOTM Spajanje"
head_description: "Spojite više DOTM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite DOTM datotekama u C#"
description: "Pridružite se DOTM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOTM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite DOTM datoteke koristeći GroupDocs.Merger API
