...
############################# Head ############################
head_title: "Unisci file POWERPOINT in .NET"
head_description: "Integra GroupDocs.Merger for .NET nei tuoi progetti .NET per unire file POWERPOINT."

############################# Header ############################
title: "Unisci file POWERPOINT" 
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti POWERPOINT."
...
steps:
    enable: true
    title: "Passaggi per unire file POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/net/) ti consente di unire file POWERPOINT senza sforzo. Integra questa funzionalità nelle tue applicazioni .NET per gestire più documenti come un unico file.
      
      1. Imposta il percorso del primo file POWERPOINT.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crea un'istanza di Merger con il documento POWERPOINT di input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da file di formati diversi"
      content: |
        Questo esempio illustra come unire file POWERPOINT incorporando pagine selezionate da altri formati.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
