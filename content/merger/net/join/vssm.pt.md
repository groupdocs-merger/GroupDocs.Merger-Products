...
############################# Head ############################
head_title: "Junte VSSM Arquivos em C# | VSSM Fusão"
head_description: "Junte vários arquivos VSSM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSSM arquivos em C#"
description: "Junte-se a VSSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSSM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSSM usando a API GroupDocs.Merger
