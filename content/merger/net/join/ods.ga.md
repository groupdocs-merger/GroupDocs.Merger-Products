...
############################# Head ############################
head_title: "Glac páirt i ODS Comhaid i C# | ODS Cumasc"
head_description: "Ceangail an iliomad comhad ODS isteach i gcomhad amháin trí úsáid a bhaint as C# .NET doiciméad cumaisc API. Cláraigh leathanaigh ar leith nó raonta leathanaigh ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Glac páirt i ODS Comhaid in C#"
description: "Ceangail ODS le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Comhad Iolrach ODS a Chuimsiú"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET páirt a ghlacadh i dhá chomhad ODS nó níos mó laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas páirt a ghlacadh i gcomhaid ODS trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Glac páirt i gcomhaid ODS trí úsáid a bhaint as GroupDocs.Merger API
...
demos:
    ...
    content: |
       Glac páirt i níos mó ná comhad ODS amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
