...
############################# Head ############################
head_title: "Εγγραφείτε σε VTX αρχεία στο C# | VTX Συγχώνευση"
head_description: "Συνδέστε πολλά αρχεία VTX σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συνδέστε συγκεκριμένες σελίδες ή σειρές σελίδων από διάφορα έγγραφα έως ένα μεμονωμένο έγγραφο."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία VTX σε C#"
description: "Εγγραφείτε στο VTX με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συνδέσετε πολλά αρχεία VTX"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να ενώσουν δύο ή περισσότερα αρχεία VTX στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία VTX χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Εγγραφείτε σε αρχεία VTX χρησιμοποιώντας το GroupDocs.Merger API
