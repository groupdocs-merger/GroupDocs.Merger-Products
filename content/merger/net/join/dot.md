...
############################# Head ############################
head_title: "Join DOT Files into One in C# (.NET Core) - DOT Merger"
...
############################# Header ############################
title: "Join DOT Files In C# (.NET Core)"
description: "Join multiple DOT files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more DOT files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join DOT files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one DOT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
