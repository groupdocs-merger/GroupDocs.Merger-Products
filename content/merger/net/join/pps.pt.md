...
############################# Head ############################
head_title: "Junte PPS Arquivos em C# | PPS Fusão"
head_description: "Junte vários arquivos PPS em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a PPS arquivos em C#"
description: "Junte-se a PPS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos PPS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos PPS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos PPS usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos PPS usando a API GroupDocs.Merger
