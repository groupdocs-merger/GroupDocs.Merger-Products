...
############################# Head ############################
head_title: "Pridružite se datotekam VSDX v C# | VSDX Združitev"
head_description: "Združite več datotek VSDX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam VSDX v C#"
description: "Pridružite se VSDX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni VSDX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
