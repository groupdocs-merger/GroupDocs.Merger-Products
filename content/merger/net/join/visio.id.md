...
############################# Head ############################
head_title: "Gabung VISIO File di C# | VISIO Penggabungan"
head_description: "Gabungkan beberapa file VISIO ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VISIO File Di C#"
description: "Bergabunglah dengan VISIO dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VISIO File"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VISIO menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VISIO menggunakan GroupDocs.Merger API
