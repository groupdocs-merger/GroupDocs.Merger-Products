...
head_title: "Gabung File VISIO menjadi Satu di C# (.NET Core) – Penggabungan VISIO"
head_description: "Gabungkan beberapa file VISIO ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Bergabunglah dengan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabung File VISIO Di C# (.NET Core)"
description: "Gabungkan beberapa file VISIO ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Bergabung dengan Beberapa File VISIO"
    content_left: |
