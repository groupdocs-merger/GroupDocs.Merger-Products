...
############################# Head ############################
head_title: "Gabung EXCEL File di C# | EXCEL Penggabungan"
head_description: "Gabungkan beberapa file EXCEL ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung EXCEL File Di C#"
description: "Bergabunglah dengan EXCEL dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa EXCEL File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file EXCEL dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file EXCEL menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file EXCEL menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan EXCEL
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu EXCEL file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/excel).
