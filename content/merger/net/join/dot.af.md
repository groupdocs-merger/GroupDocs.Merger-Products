...
############################# Head ############################
head_title: "Sluit aan by DOT-lêers in C# | DOT samesmelting"
head_description: "Sluit aan by verskeie DOT-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by DOT-lêers in C#"
description: "Sluit aan by DOT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie DOT-lêers aan te sluit"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer DOT-lêers binne hul toepassings aan te sluit deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by DOT-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by DOT lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Sluit nou by meer as een DOT-lêers aan deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) webwerf te besoek.
