...
############################# Head ############################
head_title: "Junte DOTM Arquivos em C# | DOTM Fusão"
head_description: "Junte vários arquivos DOTM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a DOTM arquivos em C#"
description: "Junte-se a DOTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos DOTM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos DOTM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos DOTM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos DOTM usando a API GroupDocs.Merger
