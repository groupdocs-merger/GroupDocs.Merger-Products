...
############################# Head ############################
head_title: "Uniu-vos a MHTML Fitxers a C# | MHTML Fusió"
head_description: "Uniu diversos fitxers MHTML en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a MHTML fitxers a C#"
description: "Uniu-vos a MHTML amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers MHTML"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers MHTML dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers MHTML mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers MHTML mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Uniu-vos a més d'un fitxer MHTML ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
