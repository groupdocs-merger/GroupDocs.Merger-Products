...
############################# Head ############################
head_title: "在.NET中合并ZIP文件"
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以便合并ZIP文件。"

############################# Header ############################
title: "合并ZIP文件" 
description: "使用GroupDocs.Merger for .NET构建高效合并ZIP文档的.NET应用程序。"
...
steps:
    ...
    title: "合并ZIP文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够高效地合并ZIP文件。将此功能集成到您的.NET应用程序中，以将多个文档作为单个文件处理。
