...
############################# Head ############################
head_title: "Junte PNG Arquivos em C# | PNG Fusão"
head_description: "Junte vários arquivos PNG em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a PNG arquivos em C#"
description: "Junte-se a PNG com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos PNG em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos PNG usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos PNG usando a API GroupDocs.Merger
