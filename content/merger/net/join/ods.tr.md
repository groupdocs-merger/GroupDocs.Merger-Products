...
############################# Head ############################
head_title: "C#'da ODS Dosyalarına Katılın | ODS Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla ODS dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki ODS Dosyaya Katılın"
description: "Birkaç satır .NET koduyla ODS'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla ODS Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla ODS dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODS dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODS dosyalarına katılın
