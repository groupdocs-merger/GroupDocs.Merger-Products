...
############################# Head ############################
head_title: "Csatlakozás VSDX fájlokhoz a C# nyelven | VSDX Egyesülés"
head_description: "Csatlakoztasson több VSDX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSDX fájlhoz itt: C#"
description: "Csatlakozzon az VSDX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSDX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSDX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSDX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSDX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) webhely meglátogatásával.
