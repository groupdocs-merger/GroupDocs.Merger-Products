...
############################# Head ############################
head_title: "C#'da ODP Dosyalarına Katılın | ODP Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla ODP dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki ODP Dosyaya Katılın"
description: "Birkaç satır .NET koduyla ODP'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla ODP Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla ODP dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODP dosyalarına katılın
