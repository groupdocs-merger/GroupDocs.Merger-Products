...
############################# Head ############################
head_title: "Pridružite VDX datotekama u C# | VDX Spajanje"
head_description: "Spojite više VDX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VDX datotekama u C#"
description: "Pridružite se VDX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VDX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VDX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VDX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
