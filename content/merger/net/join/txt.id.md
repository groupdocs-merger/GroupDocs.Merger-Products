...
############################# Head ############################
head_title: "Gabung TXT File di C# | TXT Penggabungan"
head_description: "Gabungkan beberapa file TXT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung TXT File Di C#"
description: "Bergabunglah dengan TXT dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file TXT menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file TXT menggunakan GroupDocs.Merger API
