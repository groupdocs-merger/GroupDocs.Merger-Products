...
head_title: "Gabung File PPTM menjadi Satu di C# (.NET Core) - Penggabungan PPTM"
head_description: "Gabungkan beberapa file PPTM ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Bergabunglah dengan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabung File PPTM Di C# (.NET Core)"
description: "Gabungkan beberapa file PPTM ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Bergabung dengan Beberapa File PPTM"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file PPTM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Gabung file PPTM menggunakan GroupDocs.Merger untuk .NET API
...
demos:
    ...
    content: |
        Bergabunglah dengan lebih dari satu file PPTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/total). Demo langsung memiliki manfaat sebagai berikut.
