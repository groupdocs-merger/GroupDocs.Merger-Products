...
############################# Head ############################
head_title: "Gabung ONENOTE File di C# | ONENOTE Penggabungan"
head_description: "Gabungkan beberapa file ONENOTE ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung ONENOTE File Di C#"
description: "Bergabunglah dengan ONENOTE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa ONENOTE File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file ONENOTE dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ONENOTE menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file ONENOTE menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu ONENOTE file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/onenote).
