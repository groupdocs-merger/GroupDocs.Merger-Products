...
head_title: "Gabung File ONENOTE menjadi Satu di C# (.NET Core) – Penggabungan ONENOTE"
head_description: "Gabungkan beberapa file ONENOTE ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Bergabunglah dengan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabung File ONENOTE Di C# (.NET Core)"
description: "Gabungkan beberapa file ONENOTE ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Bergabung dengan Beberapa File ONENOTE"
    content_left: |
