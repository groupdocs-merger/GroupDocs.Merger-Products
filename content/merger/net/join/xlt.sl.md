...
############################# Head ############################
head_title: "Pridružite se datotekam XLT v C# | XLT Združitev"
head_description: "Združite več datotek XLT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLT v C#"
description: "Pridružite se XLT z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
