...
############################# Head ############################
head_title: "Junte VSDM Arquivos em C# | VSDM Fusão"
head_description: "Junte vários arquivos VSDM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSDM arquivos em C#"
description: "Junte-se a VSDM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSDM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSDM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSDM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSDM usando a API GroupDocs.Merger
