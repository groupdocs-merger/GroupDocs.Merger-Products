...
############################# Head ############################
head_title: "Liituge ODT failidega rakenduses C# | ODT Ühinemine"
head_description: "Ühendage mitu ODT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge ODT failiga rakenduses C#"
description: "Liituge tootega ODT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu ODT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama ODT faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ODT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil ODT failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe ODT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
