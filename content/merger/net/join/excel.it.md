...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti EXCEL."
...
steps:
    enable: true
    title: "Passaggi per unire file EXCEL"
    content: |
