...
############################# Head ############################
head_title: "DOCX ፋይሎችን በC# | ይቀላቀሉ DOCX ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ DOCX ፋይሎችን ወደ አንድ ፋይል ይቀላቀሉ። ከተለያዩ ሰነዶች እስከ አንድ ሰነድ የተወሰኑ ገጾችን ወይም የገጽ ክልሎችን ይቀላቀሉ።"

############################# Header ############################
title: "በC# ውስጥ DOCX ፋይሎችን ይቀላቀሉ"
description: "DOCXን በጥቂት የ.NET ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በርካታ DOCX ፋይሎችን እንዴት መቀላቀል እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ DOCX ፋይሎችን በመተግበር ወደ መተግበሪያዎቻቸው መቀላቀል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# ምሳሌ ኮድን በመጠቀም DOCX ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም DOCX ፋይሎችን ይቀላቀሉ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) ድር ጣቢያን በመጎብኘት ከአንድ በላይ DOCX ፋይሎችን ይቀላቀሉ።
