...
############################# Head ############################
head_title: "Pridružite XPS datotekama u C# | XPS Spajanje"
head_description: "Spojite više XPS datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XPS datotekama u C#"
description: "Pridružite se XPS s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XPS datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XPS datoteke koristeći GroupDocs.Merger API
