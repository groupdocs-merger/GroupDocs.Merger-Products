...
############################# Head ############################
head_title: "Uniu-vos a PPSX Fitxers a C# | PPSX Fusió"
head_description: "Uniu diversos fitxers PPSX en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Uniu pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Uniu-vos a PPSX fitxers a C#"
description: "Uniu-vos a PPSX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com unir-se a diversos fitxers PPSX"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET uneixin dos o més fitxers PPSX dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com unir fitxers PPSX mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Uniu fitxers PPSX mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Uniu-vos a més d'un fitxer PPSX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
