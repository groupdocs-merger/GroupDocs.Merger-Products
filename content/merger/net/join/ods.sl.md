...
############################# Head ############################
head_title: "Pridružite se datotekam ODS v C# | ODS Združitev"
head_description: "Združite več datotek ODS v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam ODS v C#"
description: "Pridružite se ODS z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni ODS datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
