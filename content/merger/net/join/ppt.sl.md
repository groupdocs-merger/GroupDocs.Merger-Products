...
############################# Head ############################
head_title: "Pridružite se datotekam PPT v C# | PPT Združitev"
head_description: "Združite več datotek PPT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam PPT v C#"
description: "Pridružite se PPT z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni PPT datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
