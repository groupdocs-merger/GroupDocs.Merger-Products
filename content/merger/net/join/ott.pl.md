...
############################# Head ############################
head_title: "Dołącz do OTT plików w C# | OTT Połączenie"
head_description: "Połącz wiele plików OTT w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do OTT plików w C#"
description: "Dołącz do OTT za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików OTT"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom .NET dołączenie do dwóch lub więcej plików OTT w ich aplikacjach poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików OTT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików OTT za pomocą GroupDocs.Merger API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego OTT plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
