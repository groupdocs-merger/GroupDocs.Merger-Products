...
############################# Head ############################
head_title: "C#'da VSDX Dosyalarına Katılın | VSDX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSDX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki VSDX Dosyaya Katılın"
description: "Birkaç satır .NET koduyla VSDX'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla VSDX Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla VSDX dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDX dosyalarına katılın
