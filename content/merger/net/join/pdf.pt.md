...
############################# Head ############################
head_title: "Junte PDF Arquivos em C# | PDF Fusão"
head_description: "Junte vários arquivos PDF em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a PDF arquivos em C#"
description: "Junte-se a PDF com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos PDF"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos PDF em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos PDF usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos PDF usando a API GroupDocs.Merger
