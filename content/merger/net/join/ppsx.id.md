...
############################# Head ############################
head_title: "Gabung PPSX File di C# | PPSX Penggabungan"
head_description: "Gabungkan beberapa file PPSX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung PPSX File Di C#"
description: "Bergabunglah dengan PPSX dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPSX menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file PPSX menggunakan GroupDocs.Merger API
