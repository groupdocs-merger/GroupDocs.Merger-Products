...
############################# Head ############################
head_title: "Liituge JPEG failidega rakenduses C# | JPEG Ühinemine"
head_description: "Ühendage mitu JPEG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge JPEG failiga rakenduses C#"
description: "Liituge tootega JPEG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu JPEG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama JPEG faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada JPEG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil JPEG failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe JPEG failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
