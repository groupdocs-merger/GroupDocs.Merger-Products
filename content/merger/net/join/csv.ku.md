...
############################# Head ############################
head_title: "Tevlî pelên CSV li C# | CSV Hevgirtin"
head_description: "Gelek pelên CSV bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên CSV Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî CSV bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên CSV dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir CSV pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên CSV dibe">}}

        ```csharp    
        // Tevlî pelên CSV bibin bi karanîna GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) aniha beşdarî zêdetirî yek pelên CSV bibin.
