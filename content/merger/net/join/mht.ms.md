...
############################# Head ############################
head_title: "Sertai MHT Fail dalam C# | MHT Penggabungan"
head_description: "Sertai berbilang fail MHT ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Sertai halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Sertai MHT Fail Dalam C#"
description: "Sertai MHT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menyertai Berbilang MHT Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menyertai dua atau lebih MHT fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara untuk menyertai fail MHT menggunakan kod contoh C#.">}}

        ```csharp    
        // Sertai MHT fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Sertai lebih daripada satu MHT fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
