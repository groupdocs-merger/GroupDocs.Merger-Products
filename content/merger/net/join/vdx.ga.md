...
############################# Head ############################
head_title: "Glac páirt i VDX Comhaid i C# | VDX Cumasc"
head_description: "Ceangail an iliomad comhad VDX isteach i gcomhad amháin trí úsáid a bhaint as C# .NET doiciméad cumaisc API. Cláraigh leathanaigh ar leith nó raonta leathanaigh ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Glac páirt i VDX Comhaid in C#"
description: "Ceangail VDX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Comhad Iolrach VDX a Chuimsiú"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET páirt a ghlacadh i dhá chomhad VDX nó níos mó laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas páirt a ghlacadh i gcomhaid VDX trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Glac páirt i gcomhaid VDX trí úsáid a bhaint as GroupDocs.Merger API
