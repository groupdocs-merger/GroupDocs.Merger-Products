...
############################# Head ############################
head_title: "Pridružite se datotekam DOTM v C# | DOTM Združitev"
head_description: "Združite več datotek DOTM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam DOTM v C#"
description: "Pridružite se DOTM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni DOTM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
