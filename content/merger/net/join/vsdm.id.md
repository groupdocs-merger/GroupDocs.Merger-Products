...
############################# Head ############################
head_title: "Gabung VSDM File di C# | VSDM Penggabungan"
head_description: "Gabungkan beberapa file VSDM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung VSDM File Di C#"
description: "Bergabunglah dengan VSDM dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSDM menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file VSDM menggunakan GroupDocs.Merger API
