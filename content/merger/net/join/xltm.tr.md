...
############################# Head ############################
head_title: "C#'da XLTM Dosyalarına Katılın | XLTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki XLTM Dosyaya Katılın"
description: "Birkaç satır .NET koduyla XLTM'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla XLTM Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla XLTM dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTM dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLTM dosyalarına katılın
