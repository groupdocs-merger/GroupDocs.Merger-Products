...
############################# Head ############################
head_title: "Pridružite PPT datotekama u C# | PPT Spajanje"
head_description: "Spojite više PPT datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PPT datotekama u C#"
description: "Pridružite se PPT s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPT datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PPT datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PPT datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
