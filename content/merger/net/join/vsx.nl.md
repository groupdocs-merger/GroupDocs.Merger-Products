...
############################# Head ############################
head_title: "Word lid van VSX bestanden in C# | VSX Fusie"
head_description: "Voeg meerdere VSX-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van VSX bestanden in C#"
description: "Sluit je aan bij VSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere VSX bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSX-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u VSX bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van VSX bestanden met behulp van GroupDocs.Merger API
...
demos:
    ...
    content: |
       Neem nu deel aan meer dan één VSX-bestanden door naar de website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) te gaan.
