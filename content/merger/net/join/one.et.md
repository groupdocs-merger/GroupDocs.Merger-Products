...
############################# Head ############################
head_title: "Liituge ONE failidega rakenduses C# | ONE Ühinemine"
head_description: "Ühendage mitu ONE faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge ONE failiga rakenduses C#"
description: "Liituge tootega ONE mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu ONE faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama ONE faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada ONE faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil ONE failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe ONE failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
