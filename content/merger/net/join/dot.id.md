...
############################# Head ############################
head_title: "Gabung DOT File di C# | DOT Penggabungan"
head_description: "Gabungkan beberapa file DOT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung DOT File Di C#"
description: "Bergabunglah dengan DOT dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file DOT menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file DOT menggunakan GroupDocs.Merger API
