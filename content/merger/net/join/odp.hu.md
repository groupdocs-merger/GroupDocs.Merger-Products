...
############################# Head ############################
head_title: "Csatlakozás ODP fájlokhoz a C# nyelven | ODP Egyesülés"
head_description: "Csatlakoztasson több ODP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás ODP fájlhoz itt: C#"
description: "Csatlakozzon az ODP termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODP fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több ODP fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson ODP fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több ODP fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) webhely meglátogatásával.
