...
############################# Head ############################
head_title: "Junte HTML Arquivos em C# | HTML Fusão"
head_description: "Junte vários arquivos HTML em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a HTML arquivos em C#"
description: "Junte-se a HTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos HTML"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos HTML em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos HTML usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos HTML usando a API GroupDocs.Merger
