...
############################# Head ############################
head_title: "Об'єднайте файли WORD в .NET"
head_description: "Інтегруйте GroupDocs.Merger for .NET у свої проєкти .NET, щоб об'єднувати файли WORD."
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання вибраних сторінок з файлів різних форматів"
      content: |
        Цей приклад ілюструє, як об'єднати файли WORD, включаючи вибрані сторінки з інших форматів.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
