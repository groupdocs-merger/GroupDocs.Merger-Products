...
############################# Head ############################
head_title: "Csatlakozás ONE fájlokhoz a C# nyelven | ONE Egyesülés"
head_description: "Csatlakoztasson több ONE fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás ONE fájlhoz itt: C#"
description: "Csatlakozzon az ONE termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ONE fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több ONE fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson ONE fájlt a GroupDocs.Merger API segítségével
