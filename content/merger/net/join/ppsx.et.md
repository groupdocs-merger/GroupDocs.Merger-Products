...
############################# Head ############################
head_title: "Liituge PPSX failidega rakenduses C# | PPSX Ühinemine"
head_description: "Ühendage mitu PPSX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge PPSX failiga rakenduses C#"
description: "Liituge tootega PPSX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu PPSX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama PPSX faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil PPSX failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe PPSX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
