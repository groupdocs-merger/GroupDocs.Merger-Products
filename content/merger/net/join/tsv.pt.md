...
############################# Head ############################
head_title: "Junte TSV Arquivos em C# | TSV Fusão"
head_description: "Junte vários arquivos TSV em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a TSV arquivos em C#"
description: "Junte-se a TSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos TSV"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos TSV em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos TSV usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos TSV usando a API GroupDocs.Merger
