...
############################# Head ############################
head_title: "Gabung PPT File di C# | PPT Penggabungan"
head_description: "Gabungkan beberapa file PPT ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung PPT File Di C#"
description: "Bergabunglah dengan PPT dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPT menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file PPT menggunakan GroupDocs.Merger API
