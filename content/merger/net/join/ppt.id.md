...
head_title: "Gabung File PPT menjadi Satu di C# (.NET Core) - Penggabungan PPT"
head_description: "Gabungkan beberapa file PPT ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Bergabunglah dengan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabung File PPT Di C# (.NET Core)"
description: "Gabungkan beberapa file PPT ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Bergabung dengan Beberapa File PPT"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file PPT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Gabung file PPT menggunakan GroupDocs.Merger untuk .NET API
...
demos:
    ...
    content: |
        Bergabunglah dengan lebih dari satu file PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/total). Demo langsung memiliki manfaat sebagai berikut.
