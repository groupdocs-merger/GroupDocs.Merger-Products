...
############################# Head ############################
head_title: "Csatlakozás CSV fájlokhoz a C# nyelven | CSV Egyesülés"
head_description: "Csatlakoztasson több CSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás CSV fájlhoz itt: C#"
description: "Csatlakozzon az CSV termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több CSV fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több CSV fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="CSV fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson CSV fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti CSV dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több CSV fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) webhely meglátogatásával.
