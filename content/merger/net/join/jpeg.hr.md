...
############################# Head ############################
head_title: "Pridružite JPEG datotekama u C# | JPEG Spajanje"
head_description: "Spojite više JPEG datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite JPEG datotekama u C#"
description: "Pridružite se JPEG s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Kako spojiti više JPEG datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava spajanje dvije ili više JPEG datoteka unutar njihovih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti JPEG datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Pridružite JPEG datoteke koristeći GroupDocs.Merger API
        // Instancirajte spajanje s ulaznim JPEG dokumentom
...
demos:
    ...
    content: |
       Pridružite se više od jedne JPEG datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
