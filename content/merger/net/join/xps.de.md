...
############################# Head ############################
head_title: "Verbinden von XPS-Dateien in .NET"
head_description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Projekte, um XPS-Dateien zu verbinden."

############################# Header ############################
title: "Verbinden von XPS-Dateien" 
description: "Nutzen Sie GroupDocs.Merger for .NET, um .NET-Anwendungen zu erstellen, die XPS-Dokumente effizient verbinden."
...
steps:
    enable: true
    title: "Schritte zum Verbinden von XPS-Dateien"
    content: |
      [GroupDocs.Merger](/merger/net/) ermöglicht es Ihnen, XPS-Dateien effizient zu verbinden. Integrieren Sie diese Funktion in Ihre .NET-Anwendungen, um mehrere Dokumente als eine einzige Datei zu behandeln.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Erstellen Sie eine Merger-Instanz mit dem Eingangs-XPS-Dokument
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus Dateien unterschiedlicher Formate verbinden"
      content: |
        Dieses Beispiel veranschaulicht, wie XPS-Dateien verbunden werden, während ausgewählte Seiten aus anderen Formaten integriert werden.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
