...
############################# Head ############################
head_title: "Liituge RTF failidega rakenduses C# | RTF Ühinemine"
head_description: "Ühendage mitu RTF faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge RTF failiga rakenduses C#"
description: "Liituge tootega RTF mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu RTF faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama RTF faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada RTF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil RTF failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe RTF failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
