...
############################# Head ############################
head_title: "Join VSDX Files into One in C# (.NET Core) - VSDX Merger"
...
############################# Header ############################
title: "Join VSDX Files In C# (.NET Core)"
description: "Join multiple VSDX files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more VSDX files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join VSDX files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one VSDX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
