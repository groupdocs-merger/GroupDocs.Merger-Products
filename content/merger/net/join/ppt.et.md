...
############################# Head ############################
head_title: "Liituge PPT failidega rakenduses C# | PPT Ühinemine"
head_description: "Ühendage mitu PPT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge PPT failiga rakenduses C#"
description: "Liituge tootega PPT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu PPT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama PPT faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada PPT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil PPT failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe PPT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt).
