...
############################# Head ############################
head_title: "Prisijunkite prie VSDM failų C# | VSDM Susijungimas"
head_description: "Sujunkite kelis VSDM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie VSDM failų C#"
description: "Prisijunkite prie VSDM naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių VSDM failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau VSDM failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti VSDM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite VSDM failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties VSDM dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno VSDM failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) svetainėje.
