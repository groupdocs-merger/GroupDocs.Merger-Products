...
############################# Head ############################
head_title: "Csatlakozás ODS fájlokhoz a C# nyelven | ODS Egyesülés"
head_description: "Csatlakoztasson több ODS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás ODS fájlhoz itt: C#"
description: "Csatlakozzon az ODS termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODS fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több ODS fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODS fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson ODS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több ODS fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) webhely meglátogatásával.
