...
############################# Head ############################
head_title: "Pridružite PPSX datotekama u C# | PPSX Spajanje"
head_description: "Spojite više PPSX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PPSX datotekama u C#"
description: "Pridružite se PPSX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPSX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PPSX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PPSX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx).
