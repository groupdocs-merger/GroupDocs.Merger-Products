...
############################# Head ############################
head_title: "Pridružite se datotekam XLTM v C# | XLTM Združitev"
head_description: "Združite več datotek XLTM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLTM v C#"
description: "Pridružite se XLTM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLTM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
