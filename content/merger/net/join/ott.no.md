...
############################# Head ############################
head_title: "Bli med OTT-filer i C# | OTT Fusjon"
head_description: "Slå sammen flere OTT-filer til én enkelt fil ved å bruke C# .NET-dokumentsammenslåings-API. Slå sammen bestemte sider eller sideområder fra ulike dokumenter til ett enkelt dokument."

############################# Header ############################
title: "Bli med OTT-filer i C#"
description: "Bli med OTT med noen få linjer med .NET-kode."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gir en praktisk løsning for å slå sammen flere PDF-filer, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, bilder og mange andre dokumenter i én enkelt fil i .NET-applikasjoner. GroupDocs.Merger vil spare deg for mye krefter, siden du har lov til å bli med i OTT-dokumenter - det er ikke nødvendig å installere tredjepartsprogramvare, skrivebordsapplikasjoner eller plugins. Nå er det unødvendig å kaste bort tiden din og koble til filer manuelt! GroupDocs oppgave er å gi den beste kvaliteten og forenkle dokumentbehandlingsarbeidsflyten.
...
steps:
    enable: true
    title_left: "Hvordan slå sammen flere OTT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for .NET-utviklere å slå sammen to eller flere OTT-filer i applikasjonene sine ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan koble til OTT-filer ved å bruke C#-eksempelkoden">}}

        ```csharp    
        // Bli med OTT filer ved hjelp av GroupDocs.Merger API
