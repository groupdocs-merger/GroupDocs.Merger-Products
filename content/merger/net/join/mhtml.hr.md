...
############################# Head ############################
head_title: "Pridružite MHTML datotekama u C# | MHTML Spajanje"
head_description: "Spojite više MHTML datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite MHTML datotekama u C#"
description: "Pridružite se MHTML s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti MHTML datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite MHTML datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne MHTML datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
