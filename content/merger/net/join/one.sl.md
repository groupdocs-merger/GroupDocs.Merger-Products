...
############################# Head ############################
head_title: "Pridružite se datotekam ONE v C# | ONE Združitev"
head_description: "Združite več datotek ONE v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam ONE v C#"
description: "Pridružite se ONE z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni ONE datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
