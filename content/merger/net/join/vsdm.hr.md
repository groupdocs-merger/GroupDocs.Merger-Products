...
############################# Head ############################
head_title: "Pridružite VSDM datotekama u C# | VSDM Spajanje"
head_description: "Spojite više VSDM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VSDM datotekama u C#"
description: "Pridružite se VSDM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSDM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VSDM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VSDM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
