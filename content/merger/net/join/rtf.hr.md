...
############################# Head ############################
head_title: "Pridružite RTF datotekama u C# | RTF Spajanje"
head_description: "Spojite više RTF datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite RTF datotekama u C#"
description: "Pridružite se RTF s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti RTF datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite RTF datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne RTF datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
