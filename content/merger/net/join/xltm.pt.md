...
############################# Head ############################
head_title: "Junte XLTM Arquivos em C# | XLTM Fusão"
head_description: "Junte vários arquivos XLTM em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XLTM arquivos em C#"
description: "Junte-se a XLTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XLTM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XLTM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XLTM usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XLTM usando a API GroupDocs.Merger
