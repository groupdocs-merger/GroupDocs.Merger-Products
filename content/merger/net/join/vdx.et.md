...
############################# Head ############################
head_title: "Liituge VDX failidega rakenduses C# | VDX Ühinemine"
head_description: "Ühendage mitu VDX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge VDX failiga rakenduses C#"
description: "Liituge tootega VDX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu VDX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama VDX faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada VDX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil VDX failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe VDX failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
