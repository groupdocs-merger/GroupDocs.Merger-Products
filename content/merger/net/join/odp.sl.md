...
############################# Head ############################
head_title: "Pridružite se datotekam ODP v C# | ODP Združitev"
head_description: "Združite več datotek ODP v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam ODP v C#"
description: "Pridružite se ODP z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni ODP datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
