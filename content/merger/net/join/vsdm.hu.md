...
############################# Head ############################
head_title: "Csatlakozás VSDM fájlokhoz a C# nyelven | VSDM Egyesülés"
head_description: "Csatlakoztasson több VSDM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSDM fájlhoz itt: C#"
description: "Csatlakozzon az VSDM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSDM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSDM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSDM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSDM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) webhely meglátogatásával.
