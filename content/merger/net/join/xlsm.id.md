...
############################# Head ############################
head_title: "Gabung XLSM File di C# | XLSM Penggabungan"
head_description: "Gabungkan beberapa file XLSM ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung XLSM File Di C#"
description: "Bergabunglah dengan XLSM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa XLSM File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file XLSM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLSM menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file XLSM menggunakan GroupDocs.Merger API
