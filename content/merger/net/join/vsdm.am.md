...
############################# Head ############################
head_title: "VSDM ፋይሎችን በC# | ይቀላቀሉ VSDM ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ VSDM ፋይሎችን ወደ አንድ ፋይል ይቀላቀሉ። ከተለያዩ ሰነዶች እስከ አንድ ሰነድ የተወሰኑ ገጾችን ወይም የገጽ ክልሎችን ይቀላቀሉ።"

############################# Header ############################
title: "በC# ውስጥ VSDM ፋይሎችን ይቀላቀሉ"
description: "VSDMን በጥቂት የ.NET ኮድ መስመሮች ይቀላቀሉ።"
...
steps:
    enable: true
    title_left: "በርካታ VSDM ፋይሎችን እንዴት መቀላቀል እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ VSDM ፋይሎችን በመተግበር ወደ መተግበሪያዎቻቸው መቀላቀል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# ምሳሌ ኮድን በመጠቀም VSDM ፋይሎችን እንዴት መቀላቀል እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም VSDM ፋይሎችን ይቀላቀሉ
        // የፈጣን ውህደት ከግቤት VSDM ሰነድ ጋር
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) ድር ጣቢያን በመጎብኘት ከአንድ በላይ VSDM ፋይሎችን ይቀላቀሉ።
