...
############################# Head ############################
head_title: "Pievienojieties VSSX failiem programmā C# | VSSX Apvienošanās"
head_description: "Apvienojiet vairākus VSSX failus vienā failā, izmantojot C# .NET dokumentu apvienošanas API. Savienojiet noteiktas lapas vai lapu diapazonus no dažādiem dokumentiem līdz vienam dokumentam."

############################# Header ############################
title: "Pievienojieties VSSX failiem programmā C#"
description: "Pievienojieties VSSX, izmantojot dažas .NET koda rindiņas."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) nodrošina ērtu risinājumu, lai savienotu vairākus PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlus un daudzus citus dokumentus vienā failā .NET lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts pievienoties VSSX dokumentiem — nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt savu laiku un manuāli apvienot failus! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Kā pievienoties vairākiem VSSX failiem"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj .NET izstrādātājiem viegli savienot divus vai vairākus VSSX failus savās lietojumprogrammās, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā savienot VSSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Pievienojieties VSSX failiem, izmantojot GroupDocs.Merger API
        // Izveidot saplūšanu, ievadot VSSX dokumentu
...
demos:
    ...
    content: |
       Pievienojieties vairāk nekā vienam VSSX failam tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
