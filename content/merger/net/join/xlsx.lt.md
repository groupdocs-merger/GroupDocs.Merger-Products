...
############################# Head ############################
head_title: "Prisijunkite prie XLSX failų C# | XLSX Susijungimas"
head_description: "Sujunkite kelis XLSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie XLSX failų C#"
description: "Prisijunkite prie XLSX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių XLSX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau XLSX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite XLSX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties XLSX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno XLSX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) svetainėje.
