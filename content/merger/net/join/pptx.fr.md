...
############################# Head ############################
head_title: "Fusionnez des fichiers PPTX dans .NET"
head_description: "Intégrez GroupDocs.Merger for .NET dans vos projets .NET pour fusionner des fichiers PPTX."

############################# Header ############################
title: "Fusionnez des fichiers PPTX" 
description: "Utilisez GroupDocs.Merger for .NET pour développer des applications .NET qui fusionnent efficacement des documents PPTX."
...
steps:
    enable: true
    title: "Étapes pour fusionner des fichiers PPTX"
    content: |
      [GroupDocs.Merger](/merger/net/) vous permet de fusionner des fichiers PPTX sans effort. Intégrez cette fonctionnalité dans vos applications .NET pour gérer plusieurs documents comme un seul fichier.
      
      1. Définissez le chemin vers le premier fichier PPTX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Créez une instance de Merger avec le document d'entrée PPTX
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionnez des pages sélectionnées de fichiers de différents formats"
      content: |
        Cet exemple illustre comment fusionner des fichiers PPTX tout en incorporant des pages sélectionnées d'autres formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
