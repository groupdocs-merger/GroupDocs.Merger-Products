...
############################# Head ############################
head_title: "Junte TEX Arquivos em C# | TEX Fusão"
head_description: "Junte vários arquivos TEX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a TEX arquivos em C#"
description: "Junte-se a TEX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos TEX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos TEX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos TEX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos TEX usando a API GroupDocs.Merger
