...
############################# Head ############################
head_title: "Deltag i OTT filer i C# | OTT Fusion"
head_description: "Sammenføj flere OTT filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i OTT filer i C#"
description: "Slut dig til OTT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere OTT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere OTT-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du OTT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i OTT filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input OTT dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én OTT-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
