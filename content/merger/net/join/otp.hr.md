...
############################# Head ############################
head_title: "Pridružite OTP datotekama u C# | OTP Spajanje"
head_description: "Spojite više OTP datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite OTP datotekama u C#"
description: "Pridružite se OTP s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti OTP datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite OTP datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne OTP datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
