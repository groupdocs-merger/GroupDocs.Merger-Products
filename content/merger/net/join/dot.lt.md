...
############################# Head ############################
head_title: "Prisijunkite prie DOT failų C# | DOT Susijungimas"
head_description: "Sujunkite kelis DOT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie DOT failų C#"
description: "Prisijunkite prie DOT naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių DOT failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau DOT failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti DOT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite DOT failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties DOT dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno DOT failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) svetainėje.
