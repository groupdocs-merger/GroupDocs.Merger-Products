...
############################# Head ############################
head_title: "Εγγραφείτε σε VSSX αρχεία στο C# | VSSX Συγχώνευση"
head_description: "Συνδέστε πολλά αρχεία VSSX σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συνδέστε συγκεκριμένες σελίδες ή σειρές σελίδων από διάφορα έγγραφα έως ένα μεμονωμένο έγγραφο."

############################# Header ############################
title: "Εγγραφείτε σε αρχεία VSSX σε C#"
description: "Εγγραφείτε στο VSSX με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συνδέσετε πολλά αρχεία VSSX"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να ενώσουν δύο ή περισσότερα αρχεία VSSX στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδέσετε αρχεία VSSX χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Εγγραφείτε σε αρχεία VSSX χρησιμοποιώντας το GroupDocs.Merger API
