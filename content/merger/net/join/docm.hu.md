...
############################# Head ############################
head_title: "Csatlakozás DOCM fájlokhoz a C# nyelven | DOCM Egyesülés"
head_description: "Csatlakoztasson több DOCM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOCM fájlhoz itt: C#"
description: "Csatlakozzon az DOCM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOCM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOCM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOCM fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti DOCM dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOCM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) webhely meglátogatásával.
