...
############################# Head ############################
head_title: "Pridružite PPTX datotekama u C# | PPTX Spajanje"
head_description: "Spojite više PPTX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PPTX datotekama u C#"
description: "Pridružite se PPTX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPTX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PPTX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PPTX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
