...
############################# Head ############################
head_title: "Csatlakozás PPTX fájlokhoz a C# nyelven | PPTX Egyesülés"
head_description: "Csatlakoztasson több PPTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás PPTX fájlhoz itt: C#"
description: "Csatlakozzon az PPTX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPTX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több PPTX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson PPTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több PPTX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) webhely meglátogatásával.
