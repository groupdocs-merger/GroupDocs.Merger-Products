...
############################# Head ############################
head_title: "Liituge XLAM failidega rakenduses C# | XLAM Ühinemine"
head_description: "Ühendage mitu XLAM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge XLAM failiga rakenduses C#"
description: "Liituge tootega XLAM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu XLAM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama XLAM faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada XLAM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil XLAM failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe XLAM failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
