...
############################# Head ############################
head_title: "Gabung TSV File di C# | TSV Penggabungan"
head_description: "Gabungkan beberapa file TSV ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung TSV File Di C#"
description: "Bergabunglah dengan TSV dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file TSV menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file TSV menggunakan GroupDocs.Merger API
