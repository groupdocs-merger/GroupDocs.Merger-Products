...
############################# Head ############################
head_title: "Pridružite se datotekam XLAM v C# | XLAM Združitev"
head_description: "Združite več datotek XLAM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam XLAM v C#"
description: "Pridružite se XLAM z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni XLAM datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
