...
############################# Head ############################
head_title: "Word lid van DOC bestanden in C# | DOC Fusie"
head_description: "Voeg meerdere DOC-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van DOC bestanden in C#"
description: "Sluit je aan bij DOC met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere DOC bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOC-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u DOC bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van DOC bestanden met behulp van GroupDocs.Merger API
