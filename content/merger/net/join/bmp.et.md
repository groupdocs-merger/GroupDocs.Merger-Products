...
############################# Head ############################
head_title: "Liituge BMP failidega rakenduses C# | BMP Ühinemine"
head_description: "Ühendage mitu BMP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge BMP failiga rakenduses C#"
description: "Liituge tootega BMP mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu BMP faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama BMP faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada BMP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil BMP failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe BMP failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
