...
############################# Head ############################
head_title: "C#'da DOTM Dosyalarına Katılın | DOTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki DOTM Dosyaya Katılın"
description: "Birkaç satır .NET koduyla DOTM'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla DOTM Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla DOTM dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOTM dosyalarına katılın
