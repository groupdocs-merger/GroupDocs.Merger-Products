...
############################# Head ############################
head_title: "Pridružite VSX datotekama u C# | VSX Spajanje"
head_description: "Spojite više VSX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VSX datotekama u C#"
description: "Pridružite se VSX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VSX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VSX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
