...
############################# Head ############################
head_title: "Glac páirt i OTT Comhaid i C# | OTT Cumasc"
head_description: "Ceangail an iliomad comhad OTT isteach i gcomhad amháin trí úsáid a bhaint as C# .NET doiciméad cumaisc API. Cláraigh leathanaigh ar leith nó raonta leathanaigh ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Glac páirt i OTT Comhaid in C#"
description: "Ceangail OTT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Comhad Iolrach OTT a Chuimsiú"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET páirt a ghlacadh i dhá chomhad OTT nó níos mó laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas páirt a ghlacadh i gcomhaid OTT trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Glac páirt i gcomhaid OTT trí úsáid a bhaint as GroupDocs.Merger API
...
demos:
    ...
    content: |
       Glac páirt i níos mó ná comhad OTT amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
