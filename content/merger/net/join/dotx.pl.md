...
############################# Head ############################
head_title: "Dołącz do DOTX plików w C# | DOTX Połączenie"
head_description: "Połącz wiele plików DOTX w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do DOTX plików w C#"
description: "Dołącz do DOTX za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików DOTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom .NET dołączenie do dwóch lub więcej plików DOTX w ich aplikacjach poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików DOTX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików DOTX za pomocą GroupDocs.Merger API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego DOTX plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx).
