...
############################# Head ############################
head_title: "Pridružite ODP datotekama u C# | ODP Spajanje"
head_description: "Spojite više ODP datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite ODP datotekama u C#"
description: "Pridružite se ODP s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODP datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite ODP datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne ODP datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
