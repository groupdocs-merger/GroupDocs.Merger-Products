...
############################# Head ############################
head_title: "Prisijunkite prie ODP failų C# | ODP Susijungimas"
head_description: "Sujunkite kelis ODP failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie ODP failų C#"
description: "Prisijunkite prie ODP naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių ODP failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau ODP failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti ODP failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite ODP failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties ODP dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno ODP failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) svetainėje.
