...
############################# Head ############################
head_title: "Junte arquivos XPS em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para juntar arquivos XPS de forma eficiente."

############################# Header ############################
title: "Junte arquivos XPS" 
description: "Utilize GroupDocs.Merger for .NET para desenvolver aplicações .NET que combinam documentos XPS de forma eficaz."
...
steps:
    enable: true
    title: "Passos para juntar arquivos XPS"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você junte arquivos XPS de forma eficiente. Integre esse recurso em suas aplicações .NET para lidar com múltiplos documentos como um único arquivo.
      
      1. Defina o caminho para o primeiro arquivo XPS.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância de Merger com o documento de entrada XPS
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como juntar arquivos XPS enquanto incorpora páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
