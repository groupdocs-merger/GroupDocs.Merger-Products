...
############################# Head ############################
head_title: "Junte XPS Arquivos em C# | XPS Fusão"
head_description: "Junte vários arquivos XPS em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a XPS arquivos em C#"
description: "Junte-se a XPS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos XPS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos XPS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos XPS usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos XPS usando a API GroupDocs.Merger
