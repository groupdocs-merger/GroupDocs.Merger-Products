...
############################# Head ############################
head_title: "Dołącz do XPS plików w C# | XPS Połączenie"
head_description: "Połącz wiele plików XPS w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do XPS plików w C#"
description: "Dołącz do XPS za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików XPS"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom .NET dołączenie do dwóch lub więcej plików XPS w ich aplikacjach poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików XPS przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików XPS za pomocą GroupDocs.Merger API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego XPS plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
