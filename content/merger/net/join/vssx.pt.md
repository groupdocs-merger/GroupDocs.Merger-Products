...
############################# Head ############################
head_title: "Junte VSSX Arquivos em C# | VSSX Fusão"
head_description: "Junte vários arquivos VSSX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSSX arquivos em C#"
description: "Junte-se a VSSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSSX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSSX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSSX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSSX usando a API GroupDocs.Merger
