...
############################# Head ############################
head_title: "Gabung CSV File di C# | CSV Penggabungan"
head_description: "Gabungkan beberapa file CSV ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung CSV File Di C#"
description: "Bergabunglah dengan CSV dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file CSV menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file CSV menggunakan GroupDocs.Merger API
