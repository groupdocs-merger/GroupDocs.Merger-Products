...
############################# Head ############################
head_title: "Sluit aan by XPS-lêers in C# | XPS samesmelting"
head_description: "Sluit aan by verskeie XPS-lêers in 'n enkele lêer met behulp van C# .NET dokumentsamesmeltings-API. Sluit aan by spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Sluit aan by XPS-lêers in C#"
description: "Sluit aan by XPS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om verskeie XPS-lêers aan te sluit"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XPS-lêers binne hul toepassings aan te sluit deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om by XPS-lêers aan te sluit deur C#-voorbeeldkode te gebruik">}}

        ```csharp    
        // Sluit aan by XPS lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Sluit nou by meer as een XPS-lêers aan deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) webwerf te besoek.
