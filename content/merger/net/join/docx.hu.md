...
############################# Head ############################
head_title: "Csatlakozás DOCX fájlokhoz a C# nyelven | DOCX Egyesülés"
head_description: "Csatlakoztasson több DOCX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOCX fájlhoz itt: C#"
description: "Csatlakozzon az DOCX termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOCX fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOCX fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOCX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOCX fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) webhely meglátogatásával.
