...
############################# Head ############################
head_title: "Junte VSDX Arquivos em C# | VSDX Fusão"
head_description: "Junte vários arquivos VSDX em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a VSDX arquivos em C#"
description: "Junte-se a VSDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos VSDX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos VSDX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos VSDX usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos VSDX usando a API GroupDocs.Merger
