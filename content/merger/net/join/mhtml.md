...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to join two or more MHTML files within their applications by implementing a few easy steps.
