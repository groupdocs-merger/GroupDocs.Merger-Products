...
############################# Head ############################
head_title: "Gabung WORKSHEET File di C# | WORKSHEET Penggabungan"
head_description: "Gabungkan beberapa file WORKSHEET ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung WORKSHEET File Di C#"
description: "Bergabunglah dengan WORKSHEET dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa WORKSHEET File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file WORKSHEET dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file WORKSHEET menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file WORKSHEET menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan WORKSHEET
...
demos:
    ...
    content: |
       Bergabunglah dengan lebih dari satu WORKSHEET file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/worksheet).
