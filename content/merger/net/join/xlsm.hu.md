...
############################# Head ############################
head_title: "Csatlakozás XLSM fájlokhoz a C# nyelven | XLSM Egyesülés"
head_description: "Csatlakoztasson több XLSM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás XLSM fájlhoz itt: C#"
description: "Csatlakozzon az XLSM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLSM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több XLSM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson XLSM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több XLSM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) webhely meglátogatásával.
