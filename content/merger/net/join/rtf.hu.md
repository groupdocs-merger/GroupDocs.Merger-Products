...
############################# Head ############################
head_title: "Csatlakozás RTF fájlokhoz a C# nyelven | RTF Egyesülés"
head_description: "Csatlakoztasson több RTF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás RTF fájlhoz itt: C#"
description: "Csatlakozzon az RTF termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több RTF fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több RTF fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson RTF fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több RTF fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) webhely meglátogatásával.
