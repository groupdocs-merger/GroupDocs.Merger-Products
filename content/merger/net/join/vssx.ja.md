...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) を使用すると、.NET の開発者は、アプリケーション内で 2 つ以上の VSSX ファイルを簡単に結合できます。いくつかの簡単な手順。
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) Web サイトにアクセスして、複数の VSSX ファイルに今すぐ参加してください。
       ライブデモには次の利点があります。
