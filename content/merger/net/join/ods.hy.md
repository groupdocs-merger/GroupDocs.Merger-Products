...
############################# Head ############################
head_title: "Միացեք ODS ֆայլերին C#-ում | ODS Միաձուլում"
head_description: "Միացրեք բազմաթիվ ODS ֆայլեր մեկ ֆայլի մեջ՝ օգտագործելով C# .NET փաստաթղթերի միաձուլման API: Միացեք որոշակի էջերին կամ էջերի տիրույթներին՝ տարբեր փաստաթղթերից մինչև մեկ փաստաթուղթ:"

############################# Header ############################
title: "Միացեք ODS ֆայլերին C#-ում"
description: "Միացեք ODS-ին .NET կոդի մի քանի տողով:"
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) տրամադրում է հարմար լուծում բազմաթիվ PDF-ների, Microsoft Office-ի (Word, Excel, PowerPoint, OneNote), OpenDocument-ի, HTML-ի, պատկերների և շատ այլ փաստաթղթեր մեկ ֆայլի մեջ .NET հավելվածներում: GroupDocs.Merger-ը ձեզ մեծ ջանքեր կխնայի, քանի որ ձեզ թույլատրվում է միանալ ODS փաստաթղթերին. կարիք չկա տեղադրել որևէ երրորդ կողմի ծրագրակազմ, աշխատասեղանի հավելվածներ կամ պլագիններ: Այժմ ավելորդ է վատնել ձեր ժամանակը և ձեռքով միացնել ֆայլերը: GroupDocs-ի առաքելությունն է ապահովել լավագույն որակը և պարզեցնել փաստաթղթերի մշակման աշխատանքային հոսքերը:
...
steps:
    enable: true
    title_left: "Ինչպես միանալ բազմաթիվ ODS ֆայլերի"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է .NET ծրագրավորողների համար միացնել երկու կամ ավելի ODS ֆայլեր իրենց հավելվածներում` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել ODS ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Միացեք ODS ֆայլեր՝ օգտագործելով GroupDocs.Merger API
        // Ակնթարթային միաձուլում ODS փաստաթղթով
...
demos:
    ...
    content: |
       Միացե՛ք մեկից ավելի ODS ֆայլ հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) կայքը:
