...
############################# Head ############################
head_title: "Միացեք BMP ֆայլերին C#-ում | BMP Միաձուլում"
head_description: "Միացրեք բազմաթիվ BMP ֆայլեր մեկ ֆայլի մեջ՝ օգտագործելով C# .NET փաստաթղթերի միաձուլման API: Միացեք որոշակի էջերին կամ էջերի տիրույթներին՝ տարբեր փաստաթղթերից մինչև մեկ փաստաթուղթ:"

############################# Header ############################
title: "Միացեք BMP ֆայլերին C#-ում"
description: "Միացեք BMP-ին .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Ինչպես միանալ բազմաթիվ BMP ֆայլերի"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է .NET ծրագրավորողների համար միացնել երկու կամ ավելի BMP ֆայլեր իրենց հավելվածներում` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միացնել BMP ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Միացեք BMP ֆայլեր՝ օգտագործելով GroupDocs.Merger API
