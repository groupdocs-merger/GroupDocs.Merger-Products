...
############################# Head ############################
head_title: "Pridružite XLSM datotekama u C# | XLSM Spajanje"
head_description: "Spojite više XLSM datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLSM datotekama u C#"
description: "Pridružite se XLSM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLSM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLSM datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLSM datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
