...
############################# Head ############################
head_title: "Tham gia các tệp DOC trong C# | Hợp nhất DOC"
head_description: "Nối nhiều tệp DOC thành một tệp duy nhất bằng cách sử dụng API hợp nhất tài liệu C# .NET. Nối các trang hoặc phạm vi trang cụ thể từ các tài liệu khác nhau thành một tài liệu duy nhất."

############################# Header ############################
title: "Tham gia DOC Tệp trong C#"
description: "Tham gia DOC với một vài dòng mã .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp DOC bằng mã mẫu C#">}}

        ```csharp    
        // Tham gia các tệp DOC bằng API GroupDocs.Merger
