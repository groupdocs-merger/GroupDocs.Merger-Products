...
############################# Head ############################
head_title: "Gabung RTF File di C# | RTF Penggabungan"
head_description: "Gabungkan beberapa file RTF ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung RTF File Di C#"
description: "Bergabunglah dengan RTF dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file RTF menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file RTF menggunakan GroupDocs.Merger API
