...
head_description: "Объедините несколько файлов PPT в один файл, используя C# .NET API для слияния документов. Объединяйте определенные страницы или диапазоны страниц из разных документов в один документ."

############################# Header ############################
title: "PPT Объединение на C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам .NET легко объединять два или более файлов PPT в своих приложениях, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы PPT, используя пример кода C#">}}
        ...
        ```csharp    
        // Объединить PPT файлов с помощью GroupDocs.Merger API
...
demos:
    ...
    content: |
       Объедините несколько PPT файлов прямо сейчас, посетив веб-сайт [Живые демонстрации GroupDocs.Merger](https://products.groupdocs.app/merger/ppt).
