...
############################# Head ############################
head_title: "Deltag i XLAM filer i C# | XLAM Fusion"
head_description: "Sammenføj flere XLAM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i XLAM filer i C#"
description: "Slut dig til XLAM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere XLAM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere XLAM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du XLAM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i XLAM filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slut dig til mere end én XLAM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
