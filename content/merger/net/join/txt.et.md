...
############################# Head ############################
head_title: "Liituge TXT failidega rakenduses C# | TXT Ühinemine"
head_description: "Ühendage mitu TXT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge TXT failiga rakenduses C#"
description: "Liituge tootega TXT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu TXT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama TXT faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada TXT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil TXT failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe TXT failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
