...
############################# Head ############################
head_title: "C#'da OTT Dosyalarına Katılın | OTT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla OTT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki OTT Dosyaya Katılın"
description: "Birkaç satır .NET koduyla OTT'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla OTT Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla OTT dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak OTT dosyalarına katılın
