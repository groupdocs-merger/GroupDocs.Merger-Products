...
############################# Head ############################
head_title: "Csatlakozás VSTM fájlokhoz a C# nyelven | VSTM Egyesülés"
head_description: "Csatlakoztasson több VSTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás VSTM fájlhoz itt: C#"
description: "Csatlakozzon az VSTM termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSTM fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több VSTM fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson VSTM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több VSTM fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) webhely meglátogatásával.
