...
############################# Head ############################
head_title: "Liituge EPUB failidega rakenduses C# | EPUB Ühinemine"
head_description: "Ühendage mitu EPUB faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge EPUB failiga rakenduses C#"
description: "Liituge tootega EPUB mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu EPUB faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama EPUB faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada EPUB faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil EPUB failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe EPUB failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
