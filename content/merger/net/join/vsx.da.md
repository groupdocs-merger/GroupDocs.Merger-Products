...
############################# Head ############################
head_title: "Deltag i VSX filer i C# | VSX Fusion"
head_description: "Sammenføj flere VSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i VSX filer i C#"
description: "Slut dig til VSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere VSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere VSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du VSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i VSX filer ved hjælp af GroupDocs.Merger API
