...
############################# Head ############################
head_title: "Csatlakozás MHT fájlokhoz a C# nyelven | MHT Egyesülés"
head_description: "Csatlakoztasson több MHT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás MHT fájlhoz itt: C#"
description: "Csatlakozzon az MHT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több MHT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több MHT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson MHT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több MHT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) webhely meglátogatásával.
