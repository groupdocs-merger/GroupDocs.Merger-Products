...
############################# Head ############################
head_title: "Pridružite PNG datotekama u C# | PNG Spajanje"
head_description: "Spojite više PNG datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite PNG datotekama u C#"
description: "Pridružite se PNG s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PNG datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite PNG datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne PNG datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
