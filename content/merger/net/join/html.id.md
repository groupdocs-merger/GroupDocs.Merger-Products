...
head_title: "Gabung File HTML menjadi Satu di C# (.NET Core) - Penggabungan HTML"
head_description: "Gabungkan beberapa file HTML ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Bergabunglah dengan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabung File HTML Di C# (.NET Core)"
description: "Gabungkan beberapa file HTML ke dalam satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber ke dalam satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Bergabung dengan Beberapa File HTML"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file HTML dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Gabung file HTML menggunakan GroupDocs.Merger untuk .NET API
...
demos:
    ...
    content: |
        Bergabunglah dengan lebih dari satu file HTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/total).  
