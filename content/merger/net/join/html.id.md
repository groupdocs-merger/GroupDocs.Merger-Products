...
############################# Head ############################
head_title: "Gabung HTML File di C# | HTML Penggabungan"
head_description: "Gabungkan beberapa file HTML ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung HTML File Di C#"
description: "Bergabunglah dengan HTML dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file HTML menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file HTML menggunakan GroupDocs.Merger API
