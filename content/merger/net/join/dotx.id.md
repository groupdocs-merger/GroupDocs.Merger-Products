...
############################# Head ############################
head_title: "Gabung DOTX File di C# | DOTX Penggabungan"
head_description: "Gabungkan beberapa file DOTX ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung DOTX File Di C#"
description: "Bergabunglah dengan DOTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa DOTX File"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file DOTX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file DOTX menggunakan kode contoh C#">}}

        ```csharp    
        // Bergabunglah dengan file DOTX menggunakan GroupDocs.Merger API
