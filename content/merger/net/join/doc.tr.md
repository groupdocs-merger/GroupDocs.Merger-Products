...
############################# Head ############################
head_title: "C#'da DOC Dosyalarına Katılın | DOC Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOC dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki DOC Dosyaya Katılın"
description: "Birkaç satır .NET koduyla DOC'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla DOC Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla DOC dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOC dosyalarına katılın
