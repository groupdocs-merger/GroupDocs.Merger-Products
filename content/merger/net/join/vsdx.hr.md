...
############################# Head ############################
head_title: "Pridružite VSDX datotekama u C# | VSDX Spajanje"
head_description: "Spojite više VSDX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite VSDX datotekama u C#"
description: "Pridružite se VSDX s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti VSDX datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite VSDX datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne VSDX datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
