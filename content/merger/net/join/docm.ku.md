...
############################# Head ############################
head_title: "Tevlî pelên DOCM li C# | DOCM Hevgirtin"
head_description: "Gelek pelên DOCM bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên DOCM Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî DOCM bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên DOCM dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir DOCM pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên DOCM dibe">}}

        ```csharp    
        // Tevlî pelên DOCM bibin bi karanîna GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) aniha beşdarî zêdetirî yek pelên DOCM bibin.
