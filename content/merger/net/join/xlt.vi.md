...
############################# Head ############################
head_title: "Tham gia các tệp XLT trong C# | Hợp nhất XLT"
head_description: "Nối nhiều tệp XLT thành một tệp duy nhất bằng cách sử dụng API hợp nhất tài liệu C# .NET. Nối các trang hoặc phạm vi trang cụ thể từ các tài liệu khác nhau thành một tài liệu duy nhất."

############################# Header ############################
title: "Tham gia XLT Tệp trong C#"
description: "Tham gia XLT với một vài dòng mã .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET]({{Sl slash_lang}}/merge/net/) cung cấp một giải pháp thuận tiện để kết hợp nhiều tệp PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, hình ảnh và nhiều tài liệu khác thành một tệp duy nhất trong các ứng dụng .NET. GroupDocs.Merger sẽ giúp bạn tiết kiệm rất nhiều công sức vì bạn được phép tham gia các tài liệu XLT - không cần cài đặt bất kỳ phần mềm, ứng dụng máy tính để bàn hoặc plugin nào của bên thứ ba. Bây giờ không cần thiết phải lãng phí thời gian của bạn và nối các tệp theo cách thủ công! Sứ mệnh của GroupDocs là cung cấp chất lượng tốt nhất và đơn giản hóa quy trình xử lý tài liệu.
...
steps:
    enable: true
    title_left: "Cách kết hợp nhiều tệp XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển .NET dễ dàng kết hợp hai hoặc nhiều XLT tệp trong ứng dụng của họ bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách nối các tệp XLT bằng mã mẫu C#">}}

        ```csharp    
        // Tham gia các tệp XLT bằng API GroupDocs.Merger
...
demos:
    ...
    content: |
       Tham gia nhiều tệp XLT ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ xlt) trang web.
