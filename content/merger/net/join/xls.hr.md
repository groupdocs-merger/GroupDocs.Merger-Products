...
############################# Head ############################
head_title: "Pridružite XLS datotekama u C# | XLS Spajanje"
head_description: "Spojite više XLS datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite XLS datotekama u C#"
description: "Pridružite se XLS s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti XLS datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite XLS datoteke koristeći GroupDocs.Merger API
...
demos:
    ...
    content: |
       Pridružite se više od jedne XLS datoteke upravo sada tako što ćete posjetiti web-mjesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
