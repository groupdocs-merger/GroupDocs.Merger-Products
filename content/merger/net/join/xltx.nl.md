...
############################# Head ############################
head_title: "Word lid van XLTX bestanden in C# | XLTX Fusie"
head_description: "Voeg meerdere XLTX-bestanden samen in één bestand met behulp van de C# .NET-documentfusie-API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "Word lid van XLTX bestanden in C#"
description: "Sluit je aan bij XLTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Deelnemen aan meerdere XLTX bestanden"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLTX-bestanden in hun applicaties samen te voegen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe u XLTX bestanden samenvoegt met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Word lid van XLTX bestanden met behulp van GroupDocs.Merger API
