...
############################# Head ############################
head_title: "C#'da MHTML Dosyalarına Katılın | MHTML Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla MHTML dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden tek bir belgeye belirli sayfaları veya sayfa aralıklarını birleştirin."

############################# Header ############################
title: "C# İçindeki MHTML Dosyaya Katılın"
description: "Birkaç satır .NET koduyla MHTML'e katılın."
...
steps:
    enable: true
    title_left: "Birden Fazla MHTML Dosyaya Nasıl Katılabilirsiniz?"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), .NET geliştiricilerinin uygulamalarında iki veya daha fazla MHTML dosyasına bir birkaç kolay adım.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHTML dosyalarına nasıl katılınır">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak MHTML dosyalarına katılın
