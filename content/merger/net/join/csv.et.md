...
############################# Head ############################
head_title: "Liituge CSV failidega rakenduses C# | CSV Ühinemine"
head_description: "Ühendage mitu CSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed lehed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Liituge CSV failiga rakenduses C#"
description: "Liituge tootega CSV mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu CSV faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab toote .NET arendajatel hõlpsaks kahe või enama CSV faili liitmise oma rakendustes, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ühendada CSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Liituge GroupDocs.Merger API abil CSV failiga
...
demos:
    ...
    content: |
       Liituge kohe rohkem kui ühe CSV failiga, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
