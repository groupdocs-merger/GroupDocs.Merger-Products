...
############################# Head ############################
head_title: "Gabung ODP File di C# | ODP Penggabungan"
head_description: "Gabungkan beberapa file ODP ke dalam satu file menggunakan C# .NET API penggabungan dokumen. Gabung halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabung ODP File Di C#"
description: "Bergabunglah dengan ODP dengan beberapa baris kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ODP menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Bergabunglah dengan file ODP menggunakan GroupDocs.Merger API
