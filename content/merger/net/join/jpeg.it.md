...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti JPEG."
...
steps:
    enable: true
    title: "Passaggi per unire file JPEG"
    content: |
