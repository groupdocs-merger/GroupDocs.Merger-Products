...
############################# Head ############################
head_title: "Prisijunkite prie CSV failų C# | CSV Susijungimas"
head_description: "Sujunkite kelis CSV failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie CSV failų C#"
description: "Prisijunkite prie CSV naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių CSV failų"
    content_left: |
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno CSV failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) svetainėje.
