...
############################# Head ############################
head_title: "Csatlakozás DOT fájlokhoz a C# nyelven | DOT Egyesülés"
head_description: "Csatlakoztasson több DOT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás DOT fájlhoz itt: C#"
description: "Csatlakozzon az DOT termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOT fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több DOT fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson DOT fájlt a GroupDocs.Merger API segítségével
        // Példányos egyesülés a bemeneti DOT dokumentummal
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több DOT fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) webhely meglátogatásával.
