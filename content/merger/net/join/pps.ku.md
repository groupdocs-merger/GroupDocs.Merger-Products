...
############################# Head ############################
head_title: "Tevlî pelên PPS li C# | PPS Hevgirtin"
head_description: "Gelek pelên PPS bi karanîna API-ya yekkirina belgeyên C# .NET di yek pelê de bibin yek. Tevlî rûpelên taybetî an rêzikên rûpelan bibin ji belgeyên cihêreng heya belgeyek yekane."

############################# Header ############################
title: "Tevlî pelên PPS Di C# de bibin"
description: "Bi çend rêzikên koda .NET beşdarî PPS bibin."
...
steps:
    enable: true
    title_left: "Meriv çawa Tevlî Pir Pelên PPS dibe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên .NET re hêsantir dike ku bi sepanên xwe ve du an bêtir PPS pelan bixin nav sepanên xwe. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# beşdarî pelên PPS dibe">}}

        ```csharp    
        // Tevlî pelên PPS bibin bi karanîna GroupDocs.Merger API
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) aniha beşdarî zêdetirî yek pelên PPS bibin.
