...
############################# Head ############################
head_title: "Pridružite BMP datotekama u C# | BMP Spajanje"
head_description: "Spojite više BMP datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Spajanje određenih stranica ili raspona stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Pridružite BMP datotekama u C#"
description: "Pridružite se BMP s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti BMP datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Pridružite BMP datoteke koristeći GroupDocs.Merger API
