...
############################# Head ############################
head_title: "Csatlakozás EPUB fájlokhoz a C# nyelven | EPUB Egyesülés"
head_description: "Csatlakoztasson több EPUB fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Egyesítsen egyes oldalakat vagy oldaltartományokat a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "Csatlakozás EPUB fájlhoz itt: C#"
description: "Csatlakozzon az EPUB termékhez néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több EPUB fájl összekapcsolása"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy alkalmazásukon belül két vagy több EPUB fájlt összekapcsoljanak egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájlok összekapcsolása a C# példakóddal">}}

        ```csharp    
        // Csatlakoztasson EPUB fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Csatlakozzon most egynél több EPUB fájlhoz a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) webhely meglátogatásával.
