...
############################# Head ############################
head_title: "Dołącz do OTP plików w C# | OTP Połączenie"
head_description: "Połącz wiele plików OTP w jeden plik za pomocą interfejsu API łączenia dokumentów C# .NET. Połącz określone strony lub zakresy stron, od różnych dokumentów do jednego dokumentu."

############################# Header ############################
title: "Dołącz do OTP plików w C#"
description: "Dołącz do OTP za pomocą kilku linijek kodu .NET."
...
steps:
    enable: true
    title_left: "Jak dołączyć do wielu plików OTP"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom .NET dołączenie do dwóch lub więcej plików OTP w ich aplikacjach poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak dołączyć do plików OTP przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Dołącz do plików OTP za pomocą GroupDocs.Merger API
...
demos:
    ...
    content: |
       Dołącz teraz do więcej niż jednego OTP plików, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
