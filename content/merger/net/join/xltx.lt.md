...
############################# Head ############################
head_title: "Prisijunkite prie XLTX failų C# | XLTX Susijungimas"
head_description: "Sujunkite kelis XLTX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų iki vieno dokumento."

############################# Header ############################
title: "Prisijunkite prie XLTX failų C#"
description: "Prisijunkite prie XLTX naudodami kelias .NET kodo eilutes."
...
steps:
    enable: true
    title_left: "Kaip prisijungti prie kelių XLTX failų"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau XLTX failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti XLTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite XLTX failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties XLTX dokumentu
...
demos:
    ...
    content: |
       Prisijunkite prie daugiau nei vieno XLTX failo dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) svetainėje.
