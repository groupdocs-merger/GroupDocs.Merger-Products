...
############################# Head ############################
head_title: "Unisci file JPG in .NET"
head_description: "Integra GroupDocs.Merger for .NET nei tuoi progetti .NET per unire file JPG."

############################# Header ############################
title: "Unisci file JPG" 
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono in modo efficiente documenti JPG."
...
steps:
    enable: true
    title: "Passaggi per unire file JPG"
    content: |
      [GroupDocs.Merger](/merger/net/) ti consente di unire file JPG senza sforzo. Integra questa funzionalità nelle tue applicazioni .NET per gestire più documenti come un unico file.
      
      1. Imposta il percorso del primo file JPG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crea un'istanza di Merger con il documento JPG di input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da file di formati diversi"
      content: |
        Questo esempio illustra come unire file JPG incorporando pagine selezionate da altri formati.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
