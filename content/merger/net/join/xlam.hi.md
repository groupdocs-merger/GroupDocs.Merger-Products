...
############################# Head ############################
head_title: "XLAM फ़ाइलें C# में शामिल हों | XLAM विलय"
head_description: "C# .NET दस्तावेज़ विलय API का उपयोग करके एकाधिक XLAM फ़ाइलों को एक फ़ाइल में शामिल करें। विभिन्न दस्तावेज़ों से लेकर एकल दस्तावेज़ तक विशिष्ट पृष्ठों या पृष्ठ श्रेणियों में शामिल हों।"

############################# Header ############################
title: "XLAM फ़ाइलें C# में शामिल हों"
description: "{{उत्पादनाम}} कोड की कुछ पंक्तियों के साथ XLAM से जुड़ें।"
...
steps:
    enable: true
    title_left: "एकाधिक XLAM फ़ाइलों में कैसे शामिल हों"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए .NET डेवलपर्स के लिए दो या अधिक XLAM फाइलों को अपने एप्लिकेशन में शामिल करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके XLAM फ़ाइलों में कैसे शामिल हों">}}

        ```csharp    
        // GroupDocs.Merger API का उपयोग करके XLAM फ़ाइलों में शामिल हों
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) वेबसाइट पर जाकर अभी एक से अधिक XLAM फाइलों में शामिल हों।
