...
############################# Head ############################
head_title: "Junte PPT Arquivos em C# | PPT Fusão"
head_description: "Junte vários arquivos PPT em um único arquivo usando a API de fusão de documentos C# .NET. Junte páginas ou intervalos de páginas específicos de vários documentos a um único documento."

############################# Header ############################
title: "Junte-se a PPT arquivos em C#"
description: "Junte-se a PPT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como juntar vários arquivos PPT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET juntar dois ou mais arquivos PPT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como juntar arquivos PPT usando o código de exemplo C#">}}

        ```csharp    
        // Junte-se a arquivos PPT usando a API GroupDocs.Merger
