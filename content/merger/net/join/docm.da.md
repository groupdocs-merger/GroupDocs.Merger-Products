...
############################# Head ############################
head_title: "Deltag i DOCM filer i C# | DOCM Fusion"
head_description: "Sammenføj flere DOCM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Sammensæt specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Deltag i DOCM filer i C#"
description: "Slut dig til DOCM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan forbinder du flere DOCM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at forbinde to eller flere DOCM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan tilslutter du DOCM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Deltag i DOCM filer ved hjælp af GroupDocs.Merger API
        // Instantiér fusion med input DOCM dokument
...
demos:
    ...
    content: |
       Slut dig til mere end én DOCM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
