...
############################# Head ############################
head_title: "Join PS Files into One in C# (.NET Core) - PS Merger"
head_description: "Join multiple PS files into a single file using C# .NET documents merger API. Join specific pages or page ranges from various documents to a single document."

############################# Header ############################
title: "Join PS Files In C# (.NET Core)"
description: "Join multiple PS files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    enable: true
    title_left: "How to Join Multiple PS Files"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more PS files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join PS files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one PS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
