...
############################# Head ############################
head_title: "Pridružite se datotekam VDX v C# | VDX Združitev"
head_description: "Združite več datotek VDX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Pridružite se datotekam VDX v C#"
description: "Pridružite se VDX z nekaj vrsticami kode .NET."
...
demos:
    ...
    content: |
       Pridružite se več kot eni VDX datoteki takoj, tako da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
