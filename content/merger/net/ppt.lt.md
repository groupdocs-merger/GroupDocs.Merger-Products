...
head_description: "Sujunkite kelis PPT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "PPT Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną PPT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) svetainėje.
