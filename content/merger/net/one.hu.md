...
############################# Head ############################
head_title: "ONE fájlok egyesítése a C#-ban | ONE Egyesülés"
head_description: "Egyesítsen több ONE fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ONE Egyesülés a C# programban"
description: "Egyesítse a(z) ONE terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ONE fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ONE fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen ONE fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több ONE fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) webhely meglátogatásával.
