...
############################# Head ############################
head_title: "Mesclar DOT Arquivos em C# | DOT Fusão"
head_description: "Mescle vários arquivos DOT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "DOT Fusão em C#"
description: "Mescle DOT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos DOT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos DOT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar DOT arquivos usando a API GroupDocs.Merger
