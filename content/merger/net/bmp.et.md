...
############################# Head ############################
head_title: "Ühendage BMP failid C# | BMP Ühinemine"
head_description: "Ühendage mitu BMP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "BMP ühinemine programmis C#"
description: "Ühendage BMP mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam BMP faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita BMP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid BMP, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks BMP faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
