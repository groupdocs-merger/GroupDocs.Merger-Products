...
############################# Head ############################
head_title: "Voeg TSV lêers saam in C# | TSV samesmelting"
head_description: "Voeg veelvuldige TSV lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "TSV samesmelting in C#"
description: "Voeg TSV saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige TSV-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer TSV-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TSV lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg TSV lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een TSV-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) webwerf te besoek.
