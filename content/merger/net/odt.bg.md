...
############################# Head ############################
head_title: "Обединете ODT файлове в C# | ODT Сливане"
head_description: "Обединете няколко файла ODT в един файл с помощта на API за сливане на документи C# .NET. Обединете конкретни страници или диапазони от различни документи в един документ."

############################# Header ############################
title: "ODT Обединяване в C#"
description: "Обединете ODT с няколко реда от кода на .NET."
...
steps:
    enable: true
    title_left: "Как да обедините няколко ODT файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да обединят два или повече ODT файла в техните приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ODT файлове с C# примерен код">}}

        ```csharp    
        // Обединете ODT файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Обединете повече от един ODT файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
