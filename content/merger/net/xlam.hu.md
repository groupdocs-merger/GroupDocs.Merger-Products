...
############################# Head ############################
head_title: "XLAM fájlok egyesítése a C#-ban | XLAM Egyesülés"
head_description: "Egyesítsen több XLAM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLAM Egyesülés a C# programban"
description: "Egyesítse a(z) XLAM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLAM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLAM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLAM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLAM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam) webhely meglátogatásával.
