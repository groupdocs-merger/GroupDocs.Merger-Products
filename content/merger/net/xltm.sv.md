...
############################# Head ############################
head_title: "Slå samman XLTM-filer i C# | XLTM Sammanslagning"
head_description: "Slå samman flera XLTM-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "XLTM sammanslagning i C#"
description: "Slå samman XLTM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera XLTM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera XLTM-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar XLTM filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga XLTM filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå samman mer än en XLTM-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
