...
############################# Head ############################
head_title: "Mesclar HTML Arquivos em C# | HTML Fusão"
head_description: "Mescle vários arquivos HTML em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "HTML Fusão em C#"
description: "Mescle HTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos HTML"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos HTML em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos HTML usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar HTML arquivos usando a API GroupDocs.Merger
