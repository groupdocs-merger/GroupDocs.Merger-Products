...
############################# Head ############################
head_title: "Slå sammen MHTML-filer i C# | MHTML Fusjon"
...
############################# Header ############################
title: "MHTML sammenslåing i C#"
description: "Slå sammen MHTML med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere MHTML-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen MHTML filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen MHTML filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én MHTML-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
