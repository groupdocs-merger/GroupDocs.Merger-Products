...
############################# Head ############################
head_title: "Ühendage DOTM failid C# | DOTM Ühinemine"
head_description: "Ühendage mitu DOTM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "DOTM ühinemine programmis C#"
description: "Ühendage DOTM mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam DOTM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOTM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid DOTM, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks DOTM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
