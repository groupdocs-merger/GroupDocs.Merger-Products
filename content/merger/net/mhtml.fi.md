...
############################# Head ############################
head_title: "Yhdistä MHTML tiedostot C# | MHTML Sulautuminen"
...
############################# Header ############################
title: "MHTML Sulautuminen C#"
description: "Yhdistä MHTML muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia MHTML tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää MHTML tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä MHTML tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi MHTML-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) -sivustolla.
