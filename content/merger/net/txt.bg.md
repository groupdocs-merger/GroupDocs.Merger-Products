...
############################# Head ############################
head_title: "Обединете TXT файлове в C# | TXT Сливане"
head_description: "Обединете няколко файла TXT в един файл с помощта на API за сливане на документи C# .NET. Обединете конкретни страници или диапазони от различни документи в един документ."

############################# Header ############################
title: "TXT Обединяване в C#"
description: "Обединете TXT с няколко реда от кода на .NET."
...
steps:
    enable: true
    title_left: "Как да обедините няколко TXT файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да обединят два или повече TXT файла в техните приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините TXT файлове с C# примерен код">}}

        ```csharp    
        // Обединете TXT файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Обединете повече от един TXT файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
