...
############################# Head ############################
head_title: "Slå sammen PDF-filer i C# | PDF Fusjon"
...
############################# Header ############################
title: "PDF sammenslåing i C#"
description: "Slå sammen PDF med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere PDF-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PDF filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen PDF filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én PDF-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
