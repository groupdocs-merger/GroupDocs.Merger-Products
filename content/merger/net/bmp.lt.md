...
head_description: "Sujunkite kelis BMP failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "BMP Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną BMP failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) svetainėje.
