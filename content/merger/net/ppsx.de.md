...
############################# Head ############################
head_title: "PPSX-Dateien in C# zusammenführen | PPSX Fusion"
head_description: "Führen Sie mehrere PPSX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "PPSX Fusion in C#"
description: "Führen Sie PPSX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere PPSX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr PPSX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie PPSX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie PPSX-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument PPSX instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine PPSX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) besuchen.
