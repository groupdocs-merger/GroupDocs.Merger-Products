...
############################# Head ############################
head_title: "Yhdistä JPEG tiedostot C# | JPEG Sulautuminen"
...
############################# Header ############################
title: "JPEG Sulautuminen C#"
description: "Yhdistä JPEG muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia JPEG tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää JPEG tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä JPEG tiedostot GroupDocs.Merger API:lla
