...
############################# Head ############################
head_title: "Mesclar OTT Arquivos em C# | OTT Fusão"
head_description: "Mescle vários arquivos OTT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "OTT Fusão em C#"
description: "Mescle OTT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos OTT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos OTT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos OTT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar OTT arquivos usando a API GroupDocs.Merger
