...
############################# Head ############################
head_title: "BMP-Dateien in C# zusammenführen | BMP Fusion"
head_description: "Führen Sie mehrere BMP-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "BMP Fusion in C#"
description: "Führen Sie BMP mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere BMP-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr BMP-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie BMP-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie BMP-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument BMP instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine BMP-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) besuchen.
