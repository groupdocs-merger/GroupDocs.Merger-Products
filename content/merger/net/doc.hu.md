...
############################# Head ############################
head_title: "DOC fájlok egyesítése a C#-ban | DOC Egyesülés"
head_description: "Egyesítsen több DOC fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOC Egyesülés a C# programban"
description: "Egyesítse a(z) DOC terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOC fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOC fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOC fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több DOC fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) webhely meglátogatásával.
