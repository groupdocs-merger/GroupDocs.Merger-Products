...
############################# Head ############################
head_title: "MHTML fájlok egyesítése a C#-ban | MHTML Egyesülés"
head_description: "Egyesítsen több MHTML fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "MHTML Egyesülés a C# programban"
description: "Egyesítse a(z) MHTML terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több MHTML fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több MHTML fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen MHTML fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több MHTML fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) webhely meglátogatásával.
