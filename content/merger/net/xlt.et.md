...
############################# Head ############################
head_title: "Ühendage XLT failid C# | XLT Ühinemine"
head_description: "Ühendage mitu XLT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "XLT ühinemine programmis C#"
description: "Ühendage XLT mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam XLT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid XLT, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks XLT faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
