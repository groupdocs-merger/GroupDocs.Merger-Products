...
############################# Head ############################
head_title: "OTP fájlok egyesítése a C#-ban | OTP Egyesülés"
head_description: "Egyesítsen több OTP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "OTP Egyesülés a C# programban"
description: "Egyesítse a(z) OTP terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több OTP fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több OTP fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen OTP fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több OTP fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) webhely meglátogatásával.
