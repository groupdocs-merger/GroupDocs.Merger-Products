...
############################# Head ############################
head_title: "Mesclar ODS Arquivos em C# | ODS Fusão"
head_description: "Mescle vários arquivos ODS em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "ODS Fusão em C#"
description: "Mescle ODS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos ODS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos ODS usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar ODS arquivos usando a API GroupDocs.Merger
