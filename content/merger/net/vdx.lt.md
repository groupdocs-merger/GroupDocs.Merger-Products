...
head_description: "Sujunkite kelis VDX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "VDX Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną VDX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) svetainėje.
