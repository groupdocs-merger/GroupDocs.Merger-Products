...
############################# Head ############################
head_title: "Mesclar PPS Arquivos em C# | PPS Fusão"
head_description: "Mescle vários arquivos PPS em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "PPS Fusão em C#"
description: "Mescle PPS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos PPS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos PPS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos PPS usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar PPS arquivos usando a API GroupDocs.Merger
