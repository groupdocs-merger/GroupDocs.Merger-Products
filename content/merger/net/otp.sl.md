...
############################# Head ############################
head_title: "Spoji datoteke OTP v C# | OTP Združitev"
head_description: "Spojite več datotek OTP v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "OTP Združitev v C#"
description: "Spojite OTP z nekaj vrsticami kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke OTP s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke OTP z API-jem GroupDocs.Merger
