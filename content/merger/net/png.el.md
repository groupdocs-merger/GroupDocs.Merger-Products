...
############################# Head ############################
head_title: "Συγχώνευση αρχείων PNG στο C# | PNG Συγχώνευση"
head_description: "Συγχωνεύστε πολλά αρχεία PNG σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συγχώνευση συγκεκριμένων σελίδων ή περιοχών σελίδων από διάφορα έγγραφα σε ένα μόνο έγγραφο."

############################# Header ############################
title: "PNG Συγχώνευση στο C#"
description: "Συγχώνευση PNG με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συγχωνεύσετε πολλά αρχεία PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να συγχωνεύσουν δύο ή περισσότερα αρχεία PNG στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία PNG χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Συγχώνευση αρχείων PNG χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    ...
    content: |
       Συγχωνεύστε περισσότερα από ένα PNG αρχεία αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
