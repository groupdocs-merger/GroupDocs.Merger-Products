...
############################# Head ############################
head_title: "VSX-Dateien in C# zusammenführen | VSX Fusion"
head_description: "Führen Sie mehrere VSX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "VSX Fusion in C#"
description: "Führen Sie VSX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere VSX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr VSX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VSX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie VSX-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument VSX instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine VSX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) besuchen.
