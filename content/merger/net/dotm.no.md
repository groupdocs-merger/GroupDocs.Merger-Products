...
############################# Head ############################
head_title: "Slå sammen DOTM-filer i C# | DOTM Fusjon"
...
############################# Header ############################
title: "DOTM sammenslåing i C#"
description: "Slå sammen DOTM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere DOTM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOTM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen DOTM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én DOTM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
