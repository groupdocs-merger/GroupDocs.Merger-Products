...
############################# Head ############################
head_title: "XLS Dosyalarını C# İçinde Birleştir | XLS Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLS dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLS C#'da Birleşme"
description: "XLS kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLS Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLS dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLS dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) web sitesini ziyaret ederek birden fazla XLS dosyayı birleştirin.
