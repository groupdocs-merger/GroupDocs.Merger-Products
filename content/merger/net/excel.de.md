...
############################# Head ############################
head_title: "EXCEL-Dateien in C# zusammenführen | EXCEL Fusion"
head_description: "Führen Sie mehrere EXCEL-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "EXCEL Fusion in C#"
description: "Führen Sie EXCEL mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere EXCEL-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr EXCEL-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie EXCEL-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie EXCEL-Dateien mit der GroupDocs.Merger-API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine EXCEL-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/excel) besuchen.
