...
############################# Head ############################
head_title: "Combina archivos JPG a través de .NET"
head_description: "Integra la fusión de documentos JPG en tus proyectos de .NET con GroupDocs.Merger for .NET."

############################# Header ############################
title: "Combina archivos JPG" 
description: "Utiliza GroupDocs.Merger for .NET para crear potentes aplicaciones .NET que fusionen y gestionen documentos JPG sin problemas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita la fusión de documentos JPG. Agrega la funcionalidad de fusión a tus aplicaciones .NET y combina múltiples archivos sin esfuerzo.
      
      1. Define la ruta al primer archivo JPG.
