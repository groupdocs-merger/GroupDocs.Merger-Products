...
############################# Head ############################
head_title: "Yhdistä BMP tiedostot C# | BMP Sulautuminen"
...
############################# Header ############################
title: "BMP Sulautuminen C#"
description: "Yhdistä BMP muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia BMP tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää BMP tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä BMP tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi BMP-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) -sivustolla.
