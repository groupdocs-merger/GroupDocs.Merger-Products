...
############################# Head ############################
head_title: "Fusionner les fichiers JPEG dans C# | JPEG Fusion"
head_description: "Fusionnez plusieurs fichiers JPEG en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "JPEG Fusionner dans C#"
description: "Fusionnez JPEG avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers JPEG"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers JPEG dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers JPEG à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner JPEG fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée JPEG
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers JPEG dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
