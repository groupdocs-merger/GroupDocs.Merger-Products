...
############################# Header ############################
title: "DOT Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa DOT File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu DOT file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
