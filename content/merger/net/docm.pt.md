...
############################# Head ############################
head_title: "Mesclar DOCM Arquivos em C# | DOCM Fusão"
head_description: "Mescle vários arquivos DOCM em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "DOCM Fusão em C#"
description: "Mescle DOCM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos DOCM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos DOCM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOCM usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar DOCM arquivos usando a API GroupDocs.Merger
