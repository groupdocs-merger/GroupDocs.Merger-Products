...
############################# Head ############################
head_title: "Fusionner les fichiers WORKSHEET dans C# | WORKSHEET Fusion"
head_description: "Fusionnez plusieurs fichiers WORKSHEET en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "WORKSHEET Fusionner dans C#"
description: "Fusionnez WORKSHEET avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers WORKSHEET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers WORKSHEET dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers WORKSHEET à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner WORKSHEET fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée WORKSHEET
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers WORKSHEET dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/worksheet).
