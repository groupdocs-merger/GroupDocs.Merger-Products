...
############################# Head ############################
head_title: "Yhdistä VSSM tiedostot C# | VSSM Sulautuminen"
...
############################# Header ############################
title: "VSSM Sulautuminen C#"
description: "Yhdistä VSSM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VSSM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSSM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VSSM tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VSSM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) -sivustolla.
