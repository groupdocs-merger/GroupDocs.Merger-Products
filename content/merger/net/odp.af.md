...
############################# Head ############################
head_title: "Voeg ODP lêers saam in C# | ODP samesmelting"
head_description: "Voeg veelvuldige ODP lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "ODP samesmelting in C#"
description: "Voeg ODP saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige ODP-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer ODP-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODP lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg ODP lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een ODP-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) webwerf te besoek.
