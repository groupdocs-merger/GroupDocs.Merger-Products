...
############################# Head ############################
head_title: "Slå sammen OTP-filer i C# | OTP Fusjon"
...
############################# Header ############################
title: "OTP sammenslåing i C#"
description: "Slå sammen OTP med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere OTP-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen OTP filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen OTP filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én OTP-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
