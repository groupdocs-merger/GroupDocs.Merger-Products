...
############################# Head ############################
head_title: "PPTX फाइलों को C# में मर्ज करें | PPTX विलय"
head_description: "C# .NET दस्तावेज़ मर्जर API का उपयोग करके एकाधिक PPTX फ़ाइलों को एक फ़ाइल में मर्ज करें। विशिष्ट पृष्ठों या पृष्ठ श्रेणियों को विभिन्न दस्तावेज़ों से एक दस्तावेज़ में मर्ज करें।"

############################# Header ############################
title: "PPTX विलय C# में"
...
steps:
    enable: true
    title_left: "एकाधिक PPTX फ़ाइलें कैसे मर्ज करें"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए .NET डेवलपर्स के लिए दो या अधिक PPTX फाइलों को अपने एप्लिकेशन में मर्ज करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके PPTX फ़ाइलों को कैसे मर्ज करें">}}

        ```csharp    
        // GroupDocs.Merger API का उपयोग करके PPTX फ़ाइलें मर्ज करें
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) वेबसाइट पर जाकर अभी एक से अधिक PPTX फ़ाइलें मर्ज करें।
