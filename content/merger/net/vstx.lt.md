...
############################# Head ############################
head_title: "Sujungti VSTX failus C# | VSTX Susijungimas"
head_description: "Sujunkite kelis VSTX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "VSTX Susijungimas C#"
description: "Sujunkite VSTX su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis VSTX failus"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną VSTX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) svetainėje.
