...
############################# Header ############################
title: "TEX Sulautuminen C#"
description: "Yhdistä TEX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia TEX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
