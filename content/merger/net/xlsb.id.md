...
############################# Header ############################
title: "XLSB Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa XLSB File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLSB file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
