...
############################# Head ############################
head_title: "MHT Dosyalarını C# İçinde Birleştir | MHT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak MHT dosyalarını birleştirin
