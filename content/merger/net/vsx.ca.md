...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET fusionin dos o més fitxers VSX dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers VSX mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Combineu fitxers VSX mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combina més d'un fitxer VSX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
