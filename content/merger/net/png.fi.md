...
############################# Head ############################
head_title: "Yhdistä PNG tiedostot C# | PNG Sulautuminen"
...
############################# Header ############################
title: "PNG Sulautuminen C#"
description: "Yhdistä PNG muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia PNG tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PNG tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä PNG tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PNG-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) -sivustolla.
