...
############################# Head ############################
head_title: "Unisci file PDF tramite .NET"
head_description: "Integra la fusione di documenti PDF nei tuoi progetti .NET con GroupDocs.Merger for .NET."

############################# Header ############################
title: "Unisci file PDF" 
description: "Utilizza GroupDocs.Merger for .NET per creare potenti applicazioni .NET che uniscono e gestiscono senza difficoltà documenti PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) rende semplice unire documenti PDF. Aggiungi funzionalità di fusione alle tue applicazioni .NET e combina più file senza problemi.
      
      1. Definisci il percorso del primo file PDF.
