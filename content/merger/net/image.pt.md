...
############################# Head ############################
head_title: "Mescle arquivos IMAGE via .NET"
head_description: "Integre a mesclagem de documentos IMAGE em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos IMAGE" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos IMAGE de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos IMAGE. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
