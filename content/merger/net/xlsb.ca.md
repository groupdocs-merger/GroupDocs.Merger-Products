...
############################# Head ############################
head_title: "Combina fitxers XLSB a C# | XLSB Fusió"
head_description: "Combina diversos fitxers XLSB en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Combina pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "XLSB Fusió a C#"
description: "Combina XLSB amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com combinar diversos fitxers XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET fusionin dos o més fitxers XLSB dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers XLSB mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Combineu fitxers XLSB mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combina més d'un fitxer XLSB ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
