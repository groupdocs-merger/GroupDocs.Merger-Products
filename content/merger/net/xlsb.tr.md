...
############################# Head ############################
head_title: "XLSB Dosyalarını C# İçinde Birleştir | XLSB Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSB dosyalarını birleştirin
