...
############################# Head ############################
head_title: "Voeg PPTX bestanden samen in C# | PPTX Fusie"
head_description: "Voeg meerdere PPTX bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "PPTX Fusie in C#"
description: "Voeg PPTX samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PPTX bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPTX-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg PPTX bestanden samen met de GroupDocs.Merger API
