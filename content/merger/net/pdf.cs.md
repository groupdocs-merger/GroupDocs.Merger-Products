...
############################# Head ############################
head_title: "Sloučit PDF soubory v C# | PDF Fúze"
head_description: "Sloučit více souborů PDF do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "PDF Fúze v C#"
description: "Sloučit PDF s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů PDF"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů PDF v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory PDF pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit PDF soubory pomocí GroupDocs.Merger API
