...
############################# Head ############################
head_title: "ODS-Dateien in C# zusammenführen | ODS Fusion"
head_description: "Führen Sie mehrere ODS-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "ODS Fusion in C#"
description: "Führen Sie ODS mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere ODS-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr ODS-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie ODS-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie ODS-Dateien mit der GroupDocs.Merger-API zusammen
