...
############################# Head ############################
head_title: "Spoji datoteke ODT v C# | ODT Združitev"
head_description: "Spojite več datotek ODT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "ODT Združitev v C#"
description: "Spojite ODT z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek ODT znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODT s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke ODT z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Združite več kot eno datoteko ODT tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
