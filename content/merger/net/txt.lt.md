...
############################# Head ############################
head_title: "Sujungti TXT failus C# | TXT Susijungimas"
head_description: "Sujunkite kelis TXT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "TXT Susijungimas C#"
description: "Sujunkite TXT su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis TXT failus"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną TXT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) svetainėje.
