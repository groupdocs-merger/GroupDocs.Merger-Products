...
############################# Header ############################
title: "VSX Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
