...
############################# Head ############################
head_title: "Gabungkan VSDX File di C# | VSDX Penggabungan"
head_description: "Gabungkan beberapa file VSDX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "VSDX Penggabungan Dalam C#"
description: "Gabungkan VSDX dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSDX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
