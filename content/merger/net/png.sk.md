...
############################# Head ############################
head_title: "Zlúčiť PNG súbory v C# | PNG Zlúčenie"
head_description: "Zlúčte viacero súborov PNG do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Zlúčiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "PNG Zlúčenie v C#"
description: "Zlúčte PNG s niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Ako zlúčiť viacero súborov PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET zlúčiť dva alebo viac súborov PNG v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory PNG pomocou vzorového kódu C#">}}

        ```csharp    
        // Zlúčiť PNG súbory pomocou GroupDocs.Merger API
...
demos:
    ...
    content: |
       Zlúčte hneď teraz viac ako jeden súbor PNG na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
