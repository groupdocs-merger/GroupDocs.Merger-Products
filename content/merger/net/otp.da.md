...
############################# Head ############################
head_title: "Flet OTP filer i C# | OTP Fusion"
head_description: "Flet flere OTP filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "OTP fusion i C#"
description: "Flet OTP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere OTP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere OTP-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes OTP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet OTP filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én OTP-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp).
