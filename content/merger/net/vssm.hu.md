...
############################# Head ############################
head_title: "VSSM fájlok egyesítése a C#-ban | VSSM Egyesülés"
head_description: "Egyesítsen több VSSM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSSM Egyesülés a C# programban"
description: "Egyesítse a(z) VSSM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSSM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSSM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSSM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSSM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm) webhely meglátogatásával.
