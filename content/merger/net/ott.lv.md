...
############################# Head ############################
head_title: "Apvienot OTT failus programmā C# | OTT Apvienošanās"
head_description: "Apvienojiet vairākus OTT failus vienā failā, izmantojot C# .NET dokumentu sapludināšanas API. Apvienojiet noteiktas lapas vai lapu diapazonus no dažādiem dokumentiem vienā dokumentā."

############################# Header ############################
title: "OTT Apvienošanās programmā C#"
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) nodrošina ērtu risinājumu vairāku PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, attēlu un daudzus citus dokumentus vienā failā .NET lietojumprogrammās. GroupDocs.Merger ietaupīs jums daudz pūļu, jo jums ir atļauts sapludināt OTT dokumentus — nav jāinstalē trešās puses programmatūra, darbvirsmas lietojumprogrammas vai spraudņi. Tagad nav nepieciešams tērēt savu laiku un apvienot failus manuāli! GroupDocs misija ir nodrošināt vislabāko kvalitāti un vienkāršot dokumentu apstrādes darbplūsmas.
...
steps:
    enable: true
    title_left: "Kā sapludināt vairākus OTT failus"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sapludināt OTT failus, izmantojot C# piemēra kodu">}}
...
demos:
    ...
    content: |
       Apvienojiet vairāk nekā vienu OTT failu tūlīt, apmeklējot vietni [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
