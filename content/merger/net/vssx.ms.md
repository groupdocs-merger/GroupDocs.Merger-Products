...
############################# Head ############################
head_title: "Gabungkan VSSX Fail dalam C# | VSSX Penggabungan"
head_description: "Gabungkan berbilang fail VSSX ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "VSSX Penggabungan Dalam C#"
description: "Gabungkan VSSX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Berbilang VSSX Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menggabungkan dua atau lebih VSSX fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan VSSX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Gabungkan VSSX fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu VSSX fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
