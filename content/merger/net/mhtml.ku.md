...
############################# Head ############################
head_title: "Pelên MHTML di C# de bike yek | MHTML Hevgirtin"
head_description: "Gelek pelên MHTML di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "MHTML Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek MHTML Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir MHTML pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên MHTML bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên MHTML bi karanîna GroupDocs.Merger API-ê bikin yek
