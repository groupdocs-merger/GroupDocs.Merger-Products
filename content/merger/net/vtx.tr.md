...
############################# Head ############################
head_title: "VTX Dosyalarını C# İçinde Birleştir | VTX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VTX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VTX dosyalarını birleştirin
