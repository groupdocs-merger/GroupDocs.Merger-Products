...
############################# Head ############################
head_title: "WORKSHEET-Dateien in C# zusammenführen | WORKSHEET Fusion"
head_description: "Führen Sie mehrere WORKSHEET-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "WORKSHEET Fusion in C#"
description: "Führen Sie WORKSHEET mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere WORKSHEET-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr WORKSHEET-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie WORKSHEET-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie WORKSHEET-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument WORKSHEET instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine WORKSHEET-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/worksheet) besuchen.
