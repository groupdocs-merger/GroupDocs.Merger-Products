...
############################# Header ############################
title: "MHT Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa MHT File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu MHT file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
