...
############################# Head ############################
head_title: "Slå sammen VDX-filer i C# | VDX Fusjon"
...
############################# Header ############################
title: "VDX sammenslåing i C#"
description: "Slå sammen VDX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VDX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VDX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VDX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VDX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
