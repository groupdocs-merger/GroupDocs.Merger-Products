...
############################# Head ############################
head_title: "VDX Dosyalarını C# İçinde Birleştir | VDX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VDX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VDX dosyalarını birleştirin
