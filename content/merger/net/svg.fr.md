...
############################# Head ############################
head_title: "Fusionner des fichiers SVG via .NET"
head_description: "Intégrez la fusion de documents SVG dans vos projets .NET avec GroupDocs.Merger for .NET."

############################# Header ############################
title: "Fusionner des fichiers SVG" 
description: "Utilisez GroupDocs.Merger for .NET pour créer des applications .NET puissantes qui fusionnent et gèrent les documents SVG de manière fluide."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilite la fusion de documents SVG. Ajoutez une fonctionnalité de fusion à vos applications .NET et combinez plusieurs fichiers sans effort.
      
      1. Définir le chemin du premier fichier SVG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Initialiser Merger avec le document source SVG
