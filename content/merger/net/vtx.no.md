...
############################# Head ############################
head_title: "Slå sammen VTX-filer i C# | VTX Fusjon"
...
############################# Header ############################
title: "VTX sammenslåing i C#"
description: "Slå sammen VTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VTX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VTX filer ved hjelp av GroupDocs.Merger API
