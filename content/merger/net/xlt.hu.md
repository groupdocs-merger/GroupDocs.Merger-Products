...
############################# Head ############################
head_title: "XLT fájlok egyesítése a C#-ban | XLT Egyesülés"
head_description: "Egyesítsen több XLT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLT Egyesülés a C# programban"
description: "Egyesítse a(z) XLT terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLT fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLT fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLT fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) webhely meglátogatásával.
