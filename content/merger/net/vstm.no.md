...
############################# Head ############################
head_title: "Slå sammen VSTM-filer i C# | VSTM Fusjon"
...
############################# Header ############################
title: "VSTM sammenslåing i C#"
description: "Slå sammen VSTM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSTM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSTM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSTM filer ved hjelp av GroupDocs.Merger API
