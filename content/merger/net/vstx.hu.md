...
############################# Head ############################
head_title: "VSTX fájlok egyesítése a C#-ban | VSTX Egyesülés"
head_description: "Egyesítsen több VSTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSTX Egyesülés a C# programban"
description: "Egyesítse a(z) VSTX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSTX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSTX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSTX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) webhely meglátogatásával.
