...
############################# Head ############################
head_title: "Slå sammen RTF-filer i C# | RTF Fusjon"
...
############################# Header ############################
title: "RTF sammenslåing i C#"
description: "Slå sammen RTF med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere RTF-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen RTF filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen RTF filer ved hjelp av GroupDocs.Merger API
