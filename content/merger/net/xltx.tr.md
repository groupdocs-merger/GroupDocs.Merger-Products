...
############################# Head ############################
head_title: "XLTX Dosyalarını C# İçinde Birleştir | XLTX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLTX dosyalarını birleştirin
