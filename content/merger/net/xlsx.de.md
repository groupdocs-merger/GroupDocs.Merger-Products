...
############################# Head ############################
head_title: "XLSX-Dateien in C# zusammenführen | XLSX Fusion"
head_description: "Führen Sie mehrere XLSX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "XLSX Fusion in C#"
description: "Führen Sie XLSX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere XLSX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr XLSX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie XLSX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie XLSX-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument XLSX instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine XLSX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) besuchen.
