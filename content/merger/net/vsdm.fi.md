...
############################# Header ############################
title: "VSDM Sulautuminen C#"
description: "Yhdistä VSDM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VSDM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
