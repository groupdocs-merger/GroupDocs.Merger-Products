...
############################# Head ############################
head_title: "Yhdistä JPG tiedostot C# | JPG Sulautuminen"
...
############################# Header ############################
title: "JPG Sulautuminen C#"
description: "Yhdistä JPG muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia JPG tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää JPG tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä JPG tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi JPG-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) -sivustolla.
