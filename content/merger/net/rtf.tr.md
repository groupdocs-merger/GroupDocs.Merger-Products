...
############################# Head ############################
head_title: "RTF Dosyalarını C# İçinde Birleştir | RTF Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak RTF dosyalarını birleştirin
