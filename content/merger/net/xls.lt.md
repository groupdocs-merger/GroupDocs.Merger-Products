...
head_description: "Sujunkite kelis XLS failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "XLS Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną XLS failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) svetainėje.
