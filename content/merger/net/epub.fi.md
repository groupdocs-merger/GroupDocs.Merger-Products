...
############################# Header ############################
title: "EPUB Sulautuminen C#"
description: "Yhdistä EPUB muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia EPUB tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
