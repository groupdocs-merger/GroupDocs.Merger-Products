...
head_description: "Sujunkite kelis ODT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "ODT Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną ODT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) svetainėje.
