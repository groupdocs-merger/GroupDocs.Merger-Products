...
############################# Head ############################
head_title: "Zlúčiť DOTM súbory v C# | DOTM Zlúčenie"
head_description: "Zlúčte viacero súborov DOTM do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Zlúčiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "DOTM Zlúčenie v C#"
description: "Zlúčte DOTM s niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Ako zlúčiť viacero súborov DOTM"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET zlúčiť dva alebo viac súborov DOTM v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory DOTM pomocou vzorového kódu C#">}}

        ```csharp    
        // Zlúčiť DOTM súbory pomocou GroupDocs.Merger API
...
demos:
    ...
    content: |
       Zlúčte hneď teraz viac ako jeden súbor DOTM na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotm).
