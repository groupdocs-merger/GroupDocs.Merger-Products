...
############################# Head ############################
head_title: "Slå sammen TSV-filer i C# | TSV Fusjon"
...
############################# Header ############################
title: "TSV sammenslåing i C#"
description: "Slå sammen TSV med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere TSV-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TSV filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen TSV filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én TSV-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
