...
############################# Head ############################
head_title: "Συγχώνευση αρχείων DOC στο C# | DOC Συγχώνευση"
head_description: "Συγχωνεύστε πολλά αρχεία DOC σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συγχώνευση συγκεκριμένων σελίδων ή περιοχών σελίδων από διάφορα έγγραφα σε ένα μόνο έγγραφο."

############################# Header ############################
title: "DOC Συγχώνευση στο C#"
description: "Συγχώνευση DOC με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συγχωνεύσετε πολλά αρχεία DOC"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να συγχωνεύσουν δύο ή περισσότερα αρχεία DOC στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία DOC χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Συγχώνευση αρχείων DOC χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    ...
    content: |
       Συγχωνεύστε περισσότερα από ένα DOC αρχεία αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
