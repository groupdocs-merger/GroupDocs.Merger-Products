...
############################# Header ############################
title: "XLSB Merger In C#"
description: "Merge XLSB with a few lines of .NET code."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/merger/net/) provides a convenient solution to merge multiple PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, images and many other documents into a single file within .NET applications. GroupDocs.Merger will save you a lot of effort, as you are allowed to merge XLSB documents - there is no need to install any third-party software, desktop applications or plugins. Now it is unnecessary to waste your time and merge files manually! GroupDocs mission is to provide the best quality and simplify document-processing workflows.
...
steps:
    enable: true
    title_left: "How to Merge Multiple XLSB Files"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for .NET developers to merge two or more XLSB files within their applications by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to merge XLSB files using C# example code">}}
