...
head_description: "Sujunkite kelis JPEG failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "JPEG Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną JPEG failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) svetainėje.
