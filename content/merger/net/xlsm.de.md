...
############################# Head ############################
head_title: "XLSM-Dateien in C# zusammenführen | XLSM Fusion"
head_description: "Führen Sie mehrere XLSM-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "XLSM Fusion in C#"
description: "Führen Sie XLSM mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere XLSM-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr XLSM-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie XLSM-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie XLSM-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument XLSM instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine XLSM-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) besuchen.
