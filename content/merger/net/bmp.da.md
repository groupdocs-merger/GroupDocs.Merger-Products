...
############################# Head ############################
head_title: "Flet BMP filer i C# | BMP Fusion"
head_description: "Flet flere BMP filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "BMP fusion i C#"
description: "Flet BMP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere BMP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere BMP-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes BMP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet BMP filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én BMP-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
