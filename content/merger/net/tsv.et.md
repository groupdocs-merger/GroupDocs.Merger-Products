...
############################# Head ############################
head_title: "Ühendage TSV failid C# | TSV Ühinemine"
head_description: "Ühendage mitu TSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "TSV ühinemine programmis C#"
description: "Ühendage TSV mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam TSV faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita TSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid TSV, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks TSV faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv).
