...
############################# Head ############################
head_title: "Slå sammen VSDM-filer i C# | VSDM Fusjon"
...
############################# Header ############################
title: "VSDM sammenslåing i C#"
description: "Slå sammen VSDM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSDM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSDM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSDM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VSDM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
