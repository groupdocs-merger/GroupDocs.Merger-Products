...
############################# Head ############################
head_title: "Slå sammen DOT-filer i C# | DOT Fusjon"
...
############################# Header ############################
title: "DOT sammenslåing i C#"
description: "Slå sammen DOT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere DOT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen DOT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én DOT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
