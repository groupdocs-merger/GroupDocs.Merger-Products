...
############################# Head ############################
head_title: "JPEG-Dateien in C# zusammenführen | JPEG Fusion"
head_description: "Führen Sie mehrere JPEG-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "JPEG Fusion in C#"
description: "Führen Sie JPEG mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere JPEG-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr JPEG-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie JPEG-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie JPEG-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument JPEG instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine JPEG-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) besuchen.
