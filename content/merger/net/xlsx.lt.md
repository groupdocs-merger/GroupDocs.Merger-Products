...
head_description: "Sujunkite kelis XLSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "XLSX Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną XLSX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) svetainėje.
