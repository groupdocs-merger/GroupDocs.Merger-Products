...
############################# Head ############################
head_title: "XLT Dosyalarını C# İçinde Birleştir | XLT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLT dosyalarını birleştirin
