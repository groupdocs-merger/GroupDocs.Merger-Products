...
############################# Header ############################
title: "OTT Sulautuminen C#"
description: "Yhdistä OTT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia OTT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
