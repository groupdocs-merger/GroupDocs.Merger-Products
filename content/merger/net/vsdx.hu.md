...
############################# Head ############################
head_title: "VSDX fájlok egyesítése a C#-ban | VSDX Egyesülés"
head_description: "Egyesítsen több VSDX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSDX Egyesülés a C# programban"
description: "Egyesítse a(z) VSDX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSDX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSDX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSDX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSDX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) webhely meglátogatásával.
