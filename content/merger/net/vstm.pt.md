...
############################# Head ############################
head_title: "Mesclar VSTM Arquivos em C# | VSTM Fusão"
head_description: "Mescle vários arquivos VSTM em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "VSTM Fusão em C#"
description: "Mescle VSTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos VSTM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos VSTM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos VSTM usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar VSTM arquivos usando a API GroupDocs.Merger
