...
############################# Head ############################
head_title: "Ühendage ONE failid C# | ONE Ühinemine"
head_description: "Ühendage mitu ONE faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "ONE ühinemine programmis C#"
description: "Ühendage ONE mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam ONE faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ONE faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid ONE, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks ONE faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
