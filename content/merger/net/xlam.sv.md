...
############################# Head ############################
head_title: "Slå samman XLAM-filer i C# | XLAM Sammanslagning"
head_description: "Slå samman flera XLAM-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "XLAM sammanslagning i C#"
description: "Slå samman XLAM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera XLAM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera XLAM-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar XLAM filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga XLAM filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå samman mer än en XLAM-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
