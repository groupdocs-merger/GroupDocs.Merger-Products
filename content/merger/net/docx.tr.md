...
############################# Head ############################
head_title: "DOCX Dosyalarını C# İçinde Birleştir | DOCX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOCX dosyalarını birleştirin
