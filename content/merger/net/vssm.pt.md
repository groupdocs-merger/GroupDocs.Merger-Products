...
############################# Head ############################
head_title: "Mesclar VSSM Arquivos em C# | VSSM Fusão"
head_description: "Mescle vários arquivos VSSM em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "VSSM Fusão em C#"
description: "Mescle VSSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos VSSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos VSSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos VSSM usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar VSSM arquivos usando a API GroupDocs.Merger
