...
############################# Head ############################
head_title: "Slå samman HTML-filer i C# | HTML Sammanslagning"
head_description: "Slå samman flera HTML-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "HTML sammanslagning i C#"
description: "Slå samman HTML med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera HTML-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera HTML-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar HTML filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga HTML filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå samman mer än en HTML-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
