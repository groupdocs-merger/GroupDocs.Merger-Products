...
############################# Head ############################
head_title: "VTX-Dateien in C# zusammenführen | VTX Fusion"
head_description: "Führen Sie mehrere VTX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "VTX Fusion in C#"
description: "Führen Sie VTX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere VTX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr VTX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VTX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie VTX-Dateien mit der GroupDocs.Merger-API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine VTX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) besuchen.
