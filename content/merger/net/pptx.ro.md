...
############################# Head ############################
head_title: "Îmbinați fișierele PPTX în C# | PPTX Fuziune"
head_description: "Îmbinați mai multe fișiere PPTX într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Îmbinați anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "PPTX Fuziune în C#"
description: "Îmbinați PPTX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să îmbinați mai multe fișiere PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să îmbine două sau mai multe fișiere PPTX în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere PPTX folosind codul exemplu C#">}}

        ```csharp    
        // Îmbinați fișiere PPTX utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Îmbinați mai mult de un fișier PPTX chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
