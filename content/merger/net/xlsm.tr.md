...
############################# Head ############################
head_title: "XLSM Dosyalarını C# İçinde Birleştir | XLSM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSM dosyalarını birleştirin
