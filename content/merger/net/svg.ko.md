...
############################# Head ############################
head_title: ".NET를 사용한 SVG 파일 병합"
head_description: "GroupDocs.Merger for .NET로 .NET 프로젝트에 SVG 문서 병합 기능을 통합하세요."

############################# Header ############################
title: "SVG 파일 병합" 
description: "GroupDocs.Merger for .NET를 사용하여 .NET 애플리케이션을 생성하고 SVG 문서를 원활하게 병합 및 관리하세요."
...
steps:
    ...
    title: "SVG 문서 병합 방법"
    content: |
      [GroupDocs.Merger](/merger/net/)는 SVG 문서를 병합하는 것을 간단하게 해줍니다. .NET 애플리케이션에 병합 기능을 추가하고 여러 파일을 결합하세요.
      
      1. 첫 번째 SVG 파일의 경로를 정의합니다.
