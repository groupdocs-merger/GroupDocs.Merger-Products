...
############################# Head ############################
head_title: "Mesclar JPEG Arquivos em C# | JPEG Fusão"
head_description: "Mescle vários arquivos JPEG em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "JPEG Fusão em C#"
description: "Mescle JPEG com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos JPEG"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos JPEG em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos JPEG usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar JPEG arquivos usando a API GroupDocs.Merger
