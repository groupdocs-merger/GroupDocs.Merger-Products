...
############################# Head ############################
head_title: "TEX Dosyalarını C# İçinde Birleştir | TEX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TEX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TEX dosyalarını birleştirin
