...
############################# Head ############################
head_title: "Ühendage XLS failid C# | XLS Ühinemine"
head_description: "Ühendage mitu XLS faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "XLS ühinemine programmis C#"
description: "Ühendage XLS mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu XLS faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam XLS faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid XLS, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks XLS faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
