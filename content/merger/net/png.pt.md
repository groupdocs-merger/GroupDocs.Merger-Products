...
############################# Head ############################
head_title: "Mesclar PNG Arquivos em C# | PNG Fusão"
head_description: "Mescle vários arquivos PNG em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "PNG Fusão em C#"
description: "Mescle PNG com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos PNG em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos PNG usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar PNG arquivos usando a API GroupDocs.Merger
