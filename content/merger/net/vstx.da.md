...
############################# Head ############################
head_title: "Flet VSTX filer i C# | VSTX Fusion"
head_description: "Flet flere VSTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VSTX fusion i C#"
description: "Flet VSTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VSTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VSTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VSTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VSTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx).
