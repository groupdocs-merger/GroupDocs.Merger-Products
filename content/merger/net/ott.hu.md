...
############################# Head ############################
head_title: "OTT fájlok egyesítése a C#-ban | OTT Egyesülés"
head_description: "Egyesítsen több OTT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "OTT Egyesülés a C# programban"
description: "Egyesítse a(z) OTT terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több OTT fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több OTT fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen OTT fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több OTT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) webhely meglátogatásával.
