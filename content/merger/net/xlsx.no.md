...
############################# Head ############################
head_title: "Slå sammen XLSX-filer i C# | XLSX Fusjon"
...
############################# Header ############################
title: "XLSX sammenslåing i C#"
description: "Slå sammen XLSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLSX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLSX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLSX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx).
