...
############################# Head ############################
head_title: "XLSB fájlok egyesítése a C#-ban | XLSB Egyesülés"
head_description: "Egyesítsen több XLSB fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLSB Egyesülés a C# programban"
description: "Egyesítse a(z) XLSB terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLSB fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLSB fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLSB fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLSB fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) webhely meglátogatásával.
