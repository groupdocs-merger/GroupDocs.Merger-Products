...
############################# Head ############################
head_title: "Ühendage CSV failid C# | CSV Ühinemine"
head_description: "Ühendage mitu CSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "CSV ühinemine programmis C#"
description: "Ühendage CSV mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam CSV faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita CSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid CSV, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks CSV faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
