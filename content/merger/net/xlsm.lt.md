...
head_description: "Sujunkite kelis XLSM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "XLSM Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną XLSM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) svetainėje.
