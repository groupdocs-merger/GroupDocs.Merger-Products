...
############################# Head ############################
head_title: "Mesclar BMP Arquivos em C# | BMP Fusão"
head_description: "Mescle vários arquivos BMP em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "BMP Fusão em C#"
description: "Mescle BMP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos BMP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos BMP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos BMP usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar BMP arquivos usando a API GroupDocs.Merger
