...
############################# Head ############################
head_title: "Sloučit VSDM soubory v C# | VSDM Fúze"
head_description: "Sloučit více souborů VSDM do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "VSDM Fúze v C#"
description: "Sloučit VSDM s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů VSDM"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů VSDM v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory VSDM pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit VSDM soubory pomocí GroupDocs.Merger API
