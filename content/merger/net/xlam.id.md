...
############################# Head ############################
head_title: "Gabungkan XLAM File di C# | XLAM Penggabungan"
head_description: "Gabungkan beberapa file XLAM menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "XLAM Penggabungan Dalam C#"
description: "Gabungkan XLAM dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLAM file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
