...
############################# Head ############################
head_title: "Slå sammen VSX-filer i C# | VSX Fusjon"
...
############################# Header ############################
title: "VSX sammenslåing i C#"
description: "Slå sammen VSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VSX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
