...
############################# Head ############################
head_title: "Yhdistä DOTX tiedostot C# | DOTX Sulautuminen"
...
############################# Header ############################
title: "DOTX Sulautuminen C#"
description: "Yhdistä DOTX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia DOTX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä DOTX tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOTX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) -sivustolla.
