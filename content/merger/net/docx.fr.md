...
############################# Head ############################
head_title: "Fusionner les fichiers DOCX dans C# | DOCX Fusion"
head_description: "Fusionnez plusieurs fichiers DOCX en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "DOCX Fusionner dans C#"
description: "Fusionnez DOCX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers DOCX dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers DOCX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner DOCX fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers DOCX dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
