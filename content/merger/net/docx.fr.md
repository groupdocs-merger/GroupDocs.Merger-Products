...
############################# Head ############################
head_title: "Fusionner des fichiers DOCX via .NET"
head_description: "Intégrez la fusion de documents DOCX dans vos projets .NET avec GroupDocs.Merger for .NET."

############################# Header ############################
title: "Fusionner des fichiers DOCX" 
description: "Utilisez GroupDocs.Merger for .NET pour créer des applications .NET puissantes qui fusionnent et gèrent les documents DOCX de manière fluide."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilite la fusion de documents DOCX. Ajoutez une fonctionnalité de fusion à vos applications .NET et combinez plusieurs fichiers sans effort.
      
      1. Définir le chemin du premier fichier DOCX.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Initialiser Merger avec le document source DOCX
