...
############################# Head ############################
head_title: "Yhdistä XLTX tiedostot C# | XLTX Sulautuminen"
...
############################# Header ############################
title: "XLTX Sulautuminen C#"
description: "Yhdistä XLTX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLTX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä XLTX tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLTX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) -sivustolla.
