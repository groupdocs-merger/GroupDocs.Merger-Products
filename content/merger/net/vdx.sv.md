...
############################# Head ############################
head_title: "Slå samman VDX-filer i C# | VDX Sammanslagning"
head_description: "Slå samman flera VDX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "VDX sammanslagning i C#"
description: "Slå samman VDX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera VDX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera VDX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar VDX filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga VDX filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå samman mer än en VDX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
