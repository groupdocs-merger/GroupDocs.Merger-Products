...
############################# Head ############################
head_title: "HTML Dosyalarını C# İçinde Birleştir | HTML Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak HTML dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak HTML dosyalarını birleştirin
