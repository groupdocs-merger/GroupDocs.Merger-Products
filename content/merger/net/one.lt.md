...
head_description: "Sujunkite kelis ONE failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "ONE Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną ONE failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) svetainėje.
