...
############################# Head ############################
head_title: "Ühendage ODP failid C# | ODP Ühinemine"
head_description: "Ühendage mitu ODP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "ODP ühinemine programmis C#"
description: "Ühendage ODP mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam ODP faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ODP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid ODP, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks ODP faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
