...
############################# Head ############################
head_title: "Combina fitxers DOCX a C# | DOCX Fusió"
head_description: "Combina diversos fitxers DOCX en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Combina pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "DOCX Fusió a C#"
description: "Combina DOCX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com combinar diversos fitxers DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET fusionin dos o més fitxers DOCX dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers DOCX mitjançant el codi d'exemple C#">}}

        ```csharp    
        // Combineu fitxers DOCX mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combina més d'un fitxer DOCX ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
