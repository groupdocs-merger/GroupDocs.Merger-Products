...
head_description: "Sujunkite kelis VSX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "VSX Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną VSX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) svetainėje.
