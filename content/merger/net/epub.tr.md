...
############################# Head ############################
head_title: "EPUB Dosyalarını C# İçinde Birleştir | EPUB Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak EPUB dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak EPUB dosyalarını birleştirin
