...
############################# Head ############################
head_title: "ODS Dosyalarını C# İçinde Birleştir | ODS Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODS dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODS dosyalarını birleştirin
