...
############################# Head ############################
head_title: "Slå sammen CSV-filer i C# | CSV Fusjon"
...
############################# Header ############################
title: "CSV sammenslåing i C#"
description: "Slå sammen CSV med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere CSV-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen CSV filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen CSV filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én CSV-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
