...
############################# Head ############################
head_title: "Gabungkan XLSM File di C# | XLSM Penggabungan"
head_description: "Gabungkan beberapa file XLSM menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "XLSM Penggabungan Dalam C#"
description: "Gabungkan XLSM dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLSM file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
