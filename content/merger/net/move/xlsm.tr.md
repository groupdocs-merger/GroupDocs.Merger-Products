...
############################# Head ############################
head_title: "XLSM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XLSM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLSM Sayfayı C# İçinde Taşı"
description: "XLSM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLSM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XLSM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSM dosya sayfaları nasıl taşınır">}}
