...
############################# Head ############################
head_title: "Teisalda XLAM lehte teenuses C#"
head_description: "Teisaldage dokumendi XLAM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLAM lehte rakenduses C#"
description: "Teisaldage XLAM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLAM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLAM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLAM faililehte, kasutades C# näitekoodi">}}
