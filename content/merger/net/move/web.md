...
############################# Head ############################
head_title: "Move WEB Pages in C#"
head_description: "Move pages within a WEB document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move WEB Pages In C#"
description: "Move WEB Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move WEB File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a WEB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WEB file pages using C# example code">}}
