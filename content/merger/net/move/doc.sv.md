...
############################# Head ############################
head_title: "Flytta DOC sidor i C#"
head_description: "Flytta sidor i ett DOC-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOC sidor i C#"
description: "Flytta DOC sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta DOC filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en DOC-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOC filsidor med hjälp av C# exempelkod">}}
