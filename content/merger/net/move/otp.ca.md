...
############################# Head ############################
head_title: "Mou OTP pàgines a C#"
head_description: "Mou les pàgines d'un document OTP a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou OTP pàgines a C#"
description: "Mou OTP pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou OTP pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer OTP implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers OTP utilitzant el codi d'exemple C#">}}
