...
############################# Head ############################
head_title: "Færa ODP síður í C#"
head_description: "Færðu síður innan ODP skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa ODP síður í C#"
description: "Færðu ODP síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa ODP skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í ODP skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa ODP skráarsíður með því að nota C# dæmikóða">}}
