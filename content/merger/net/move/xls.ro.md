...
############################# Head ############################
head_title: "Mutați XLS pagini în C#"
head_description: "Mutați paginile dintr-un document XLS în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLS pagini în C#"
description: "Mutați XLS pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLS pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLS prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLS utilizând codul exemplu C#">}}
