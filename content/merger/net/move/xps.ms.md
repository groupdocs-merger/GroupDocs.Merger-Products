...
############################# Head ############################
head_title: "Alihkan XPS Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XPS dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XPS Halaman Dalam C#"
description: "Alihkan XPS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XPS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XPS halaman fail menggunakan kod contoh C#.">}}
