...
############################# Head ############################
head_title: "Pārvietot XLTM lapas programmā C#"
head_description: "Pārvietojiet lapas XLTM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLTM lapas programmā C#"
description: "Pārvietojiet XLTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLTM faila lapas, izmantojot C# piemēra kodu">}}
