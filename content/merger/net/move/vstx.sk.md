...
############################# Head ############################
head_title: "Presunúť VSTX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu VSTX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť VSTX stránok do C#"
description: "Presuňte VSTX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť VSTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru VSTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru VSTX pomocou vzorového kódu C#">}}
