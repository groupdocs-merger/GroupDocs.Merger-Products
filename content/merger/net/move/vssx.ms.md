...
############################# Head ############################
head_title: "Alihkan VSSX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSSX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSSX Halaman Dalam C#"
description: "Alihkan VSSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSSX halaman fail menggunakan kod contoh C#.">}}
