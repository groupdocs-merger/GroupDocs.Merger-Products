...
############################# Head ############################
head_title: "Mutați XLTM pagini în C#"
head_description: "Mutați paginile dintr-un document XLTM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLTM pagini în C#"
description: "Mutați XLTM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLTM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLTM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLTM utilizând codul exemplu C#">}}
