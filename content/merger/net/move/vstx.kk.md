...
############################# Head ############################
head_title: "VSTX бетті C# ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы VSTX құжатының беттерін C# ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "VSTX бетті C# ішінде жылжыту"
description: "VSTX беттерді .NET кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "VSTX файл бетін .NET ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы VSTX файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX файл беттерін C# мысал кодын пайдаланып жылжыту жолы">}}
