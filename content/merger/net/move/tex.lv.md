...
############################# Head ############################
head_title: "Pārvietot TEX lapas programmā C#"
head_description: "Pārvietojiet lapas TEX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot TEX lapas programmā C#"
description: "Pārvietojiet TEX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot TEX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas TEX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot TEX faila lapas, izmantojot C# piemēra kodu">}}
