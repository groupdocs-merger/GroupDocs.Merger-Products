...
############################# Head ############################
head_title: "Move VDX Pages in C#"
head_description: "Move pages within a VDX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VDX Pages In C#"
description: "Move VDX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VDX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VDX file pages using C# example code">}}
