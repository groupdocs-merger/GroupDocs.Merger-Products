...
############################# Head ############################
head_title: "TEX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir TEX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "TEX Sayfayı C# İçinde Taşı"
description: "TEX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "TEX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir TEX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TEX dosya sayfaları nasıl taşınır">}}
