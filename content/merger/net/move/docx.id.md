...
############################# Head ############################
head_title: "Pindahkan DOCX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOCX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOCX Halaman Di C#"
description: "Pindahkan Halaman DOCX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOCX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOCX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOCX menggunakan kode contoh C#">}}
