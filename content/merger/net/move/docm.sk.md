...
############################# Head ############################
head_title: "Presunúť DOCM stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu DOCM v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOCM stránok do C#"
description: "Presuňte DOCM stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť DOCM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru DOCM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOCM pomocou vzorového kódu C#">}}
