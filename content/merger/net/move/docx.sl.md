...
############################# Head ############################
head_title: "Premakni DOCX strani v C#"
head_description: "Premaknite strani znotraj dokumenta DOCX v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOCX strani v C#"
description: "Premaknite strani DOCX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOCX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke DOCX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOCX s primerom kode C#">}}
