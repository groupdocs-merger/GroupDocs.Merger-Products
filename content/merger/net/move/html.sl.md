...
############################# Head ############################
head_title: "Premakni HTML strani v C#"
head_description: "Premaknite strani znotraj dokumenta HTML v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni HTML strani v C#"
description: "Premaknite strani HTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke HTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke HTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke HTML s primerom kode C#">}}
