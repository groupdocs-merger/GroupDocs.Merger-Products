...
############################# Head ############################
head_title: "Færa XLT síður í C#"
head_description: "Færðu síður innan XLT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLT síður í C#"
description: "Færðu XLT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLT skráarsíður með því að nota C# dæmikóða">}}
