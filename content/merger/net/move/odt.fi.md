...
############################# Head ############################
head_title: "Siirrä ODT sivua C#"
head_description: "Siirrä ODT-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODT sivua C#"
description: "Siirrä ODT sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja ODT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODT tiedostosivua käyttämällä C# esimerkkikoodia">}}
