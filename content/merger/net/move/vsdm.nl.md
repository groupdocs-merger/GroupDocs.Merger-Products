...
############################# Head ############################
head_title: "Verplaats VSDM pagina's in C#"
head_description: "Verplaats pagina's binnen een VSDM document in C# naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats VSDM pagina's in C#"
description: "Verplaats VSDM pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verplaats VSDM bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een VSDM bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSDM bestandspagina's te verplaatsen met behulp van C# voorbeeldcode">}}
