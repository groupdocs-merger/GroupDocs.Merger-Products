...
############################# Head ############################
head_title: "Pārvietot XLS lapas programmā C#"
head_description: "Pārvietojiet lapas XLS dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLS lapas programmā C#"
description: "Pārvietojiet XLS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLS faila lapas, izmantojot C# piemēra kodu">}}
