...
############################# Head ############################
head_title: "Pārvietot VSTM lapas programmā C#"
head_description: "Pārvietojiet lapas VSTM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSTM lapas programmā C#"
description: "Pārvietojiet VSTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSTM faila lapas, izmantojot C# piemēra kodu">}}
