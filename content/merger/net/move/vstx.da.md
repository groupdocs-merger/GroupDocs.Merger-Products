...
############################# Head ############################
head_title: "Flyt VSTX sider i C#"
head_description: "Flyt sider i et VSTX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSTX sider i C#"
description: "Flyt VSTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSTX filsider ved hjælp af C# eksempelkode">}}
