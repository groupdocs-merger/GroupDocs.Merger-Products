...
############################# Head ############################
head_title: "Premakni DOC strani v C#"
head_description: "Premaknite strani znotraj dokumenta DOC v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOC strani v C#"
description: "Premaknite strani DOC z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOC v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke DOC z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOC s primerom kode C#">}}
