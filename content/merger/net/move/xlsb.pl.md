...
############################# Head ############################
head_title: "Przenieś XLSB strony w C#"
head_description: "Przenieś strony w dokumencie XLSB w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLSB strony w C#"
description: "Przenieś strony XLSB za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLSB do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLSB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLSB strony pliku za pomocą C# przykładowego kodu">}}

        ```csharp    
        // Przenieś strony plików XLSB za pomocą GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Prezentacje na żywo – przenieś XLSB strony online"
    content: |
       Przenieś strony plików XLSB już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xlsb).
