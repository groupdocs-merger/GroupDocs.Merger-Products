...
############################# Head ############################
head_title: "C#에서 WEB 페이지 이동"
head_description: "문서 병합 API를 사용하여 C#의 WEB 문서 내의 페이지를 원하는 위치로 이동합니다."

############################# Header ############################
title: "C#에서 WEB 페이지 이동"
description: "몇 줄의 .NET 코드로 WEB 페이지를 이동하세요."
...
steps:
    enable: true
    title_left: ".NET에서 WEB 파일 페이지 이동"
    content_left: |
        [GroupDocs.Merger for .NET](/ko/merger/net/)를 사용하면 C# 개발자가 몇 가지 간단한 단계를 구현하여 WEB 파일 내에서 페이지를 쉽게 이동할 수 있습니다. .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 WEB 파일 페이지를 이동하는 방법">}}
