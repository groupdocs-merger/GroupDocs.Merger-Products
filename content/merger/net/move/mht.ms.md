...
############################# Head ############################
head_title: "Alihkan MHT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen MHT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan MHT Halaman Dalam C#"
description: "Alihkan MHT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan MHT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail MHT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan MHT halaman fail menggunakan kod contoh C#.">}}
