...
############################# Head ############################
head_title: "Mutați DOT pagini în C#"
head_description: "Mutați paginile dintr-un document DOT în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOT pagini în C#"
description: "Mutați DOT pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOT pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOT utilizând codul exemplu C#">}}
