...
############################# Head ############################
head_title: "Alihkan XLT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLT Halaman Dalam C#"
description: "Alihkan XLT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLT halaman fail menggunakan kod contoh C#.">}}
