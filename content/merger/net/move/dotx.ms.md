...
############################# Head ############################
head_title: "Alihkan DOTX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOTX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOTX Halaman Dalam C#"
description: "Alihkan DOTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOTX halaman fail menggunakan kod contoh C#.">}}
