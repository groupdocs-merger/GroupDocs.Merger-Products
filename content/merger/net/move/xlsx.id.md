...
############################# Head ############################
head_title: "Pindahkan XLSX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLSX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLSX Halaman Di C#"
description: "Pindahkan Halaman XLSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLSX menggunakan kode contoh C#">}}
