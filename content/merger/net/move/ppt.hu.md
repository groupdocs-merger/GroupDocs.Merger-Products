...
############################# Head ############################
head_title: "PPT oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy PPT dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPT oldal mozgatása a C# nyelven"
description: "Mozgasson át PPT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPT fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy PPT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPT fájloldalak mozgatása a C# példakóddal">}}
