...
############################# Head ############################
head_title: "Skuif PDF bladsye in C#"
head_description: "Skuif bladsye binne 'n PDF dokument in C# na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif PDF bladsye in C#"
description: "Skuif PDF bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Skuif PDF lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n PDF-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PDF lêerbladsye te skuif deur C# voorbeeldkode te gebruik">}}
