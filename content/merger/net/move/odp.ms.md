...
############################# Head ############################
head_title: "Alihkan ODP Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen ODP dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODP Halaman Dalam C#"
description: "Alihkan ODP Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan ODP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail ODP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODP halaman fail menggunakan kod contoh C#.">}}
