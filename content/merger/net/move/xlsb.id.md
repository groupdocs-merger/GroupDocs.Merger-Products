...
############################# Head ############################
head_title: "Pindahkan XLSB Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLSB di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLSB Halaman Di C#"
description: "Pindahkan Halaman XLSB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLSB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLSB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLSB menggunakan kode contoh C#">}}
