...
############################# Head ############################
head_title: "Sposta RTF pagine in C#"
head_description: "Sposta le pagine all'interno di un documento RTF in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta RTF pagine in C#"
description: "Sposta RTF pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta RTF pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file RTF implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file RTF utilizzando il codice di esempio C#">}}
