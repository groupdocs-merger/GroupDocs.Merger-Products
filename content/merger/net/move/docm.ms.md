...
############################# Head ############################
head_title: "Alihkan DOCM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOCM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOCM Halaman Dalam C#"
description: "Alihkan DOCM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOCM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOCM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOCM halaman fail menggunakan kod contoh C#.">}}
