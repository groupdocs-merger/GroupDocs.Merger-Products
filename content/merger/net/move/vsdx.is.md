...
############################# Head ############################
head_title: "Færa VSDX síður í C#"
head_description: "Færðu síður innan VSDX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSDX síður í C#"
description: "Færðu VSDX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSDX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSDX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSDX skráarsíður með því að nota C# dæmikóða">}}
