...
############################# Head ############################
head_title: "XLSB Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XLSB belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLSB Sayfayı C# İçinde Taşı"
description: "XLSB Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLSB Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XLSB dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosya sayfaları nasıl taşınır">}}
