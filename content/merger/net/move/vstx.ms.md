...
############################# Head ############################
head_title: "Alihkan VSTX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSTX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSTX Halaman Dalam C#"
description: "Alihkan VSTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSTX halaman fail menggunakan kod contoh C#.">}}
