...
############################# Head ############################
head_title: "Pārvietot RTF lapas programmā C#"
head_description: "Pārvietojiet lapas RTF dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot RTF lapas programmā C#"
description: "Pārvietojiet RTF lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot RTF faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas RTF failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot RTF faila lapas, izmantojot C# piemēra kodu">}}
