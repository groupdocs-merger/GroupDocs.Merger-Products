...
############################# Head ############################
head_title: "Perkelti OTP puslapius C#"
head_description: "Perkelkite puslapius OTP dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti OTP puslapius C#"
description: "Perkelkite OTP puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti OTP failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius OTP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti OTP failo puslapius naudojant C# pavyzdinį kodą">}}
