...
############################# Head ############################
head_title: "Move XLSB Pages in C#"
head_description: "Move pages within a XLSB document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLSB Pages In C#"
description: "Move XLSB Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLSB File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLSB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSB file pages using C# example code">}}
