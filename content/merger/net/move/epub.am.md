...
############################# Head ############################
head_title: "EPUB ገጾችን በC# ውስጥ አንቀሳቅስ"
head_description: "ገጾችን በEPUB ሰነድ ውስጥ በC# ውስጥ ወደ ማንኛውም ቦታ የሰነዶች ውህደት ኤፒአይን በመጠቀም ይውሰዱ።"

############################# Header ############################
title: "EPUB ገጾችን በC# ውስጥ አንቀሳቅስ"
description: "EPUB ገጾችን ከጥቂት መስመሮች .NET ኮድ ያንቀሳቅሱ።"
...
steps:
    enable: true
    title_left: "EPUB የፋይል ገጾችን በ.NET አንቀሳቅስ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net) ለC# ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር ገጾችን በEPUB ፋይል ውስጥ ማንቀሳቀስ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የEPUB ፋይል ገጾችን እንዴት ማንቀሳቀስ እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም EPUB የፋይል ገጾችን ይውሰዱ
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "የቀጥታ ማሳያዎች - EPUB ገጾችን በመስመር ላይ ይውሰዱ"
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/{ext}}) ድር ጣቢያን በመጎብኘት የEPUB ፋይል ገጾችን አሁኑኑ ያንቀሳቅሱ።
