...
############################# Head ############################
head_title: "Przenieś OTP strony w C#"
head_description: "Przenieś strony w dokumencie OTP w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś OTP strony w C#"
description: "Przenieś strony OTP za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików OTP do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku OTP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść OTP strony pliku za pomocą C# przykładowego kodu">}}
