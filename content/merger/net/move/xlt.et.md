...
############################# Head ############################
head_title: "Teisalda XLT lehte teenuses C#"
head_description: "Teisaldage dokumendi XLT lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLT lehte rakenduses C#"
description: "Teisaldage XLT lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLT faililehte, kasutades C# näitekoodi">}}
