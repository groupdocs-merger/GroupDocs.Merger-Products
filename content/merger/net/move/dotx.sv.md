...
############################# Head ############################
head_title: "Flytta DOTX sidor i C#"
head_description: "Flytta sidor i ett DOTX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOTX sidor i C#"
description: "Flytta DOTX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta DOTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en DOTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOTX filsidor med hjälp av C# exempelkod">}}
