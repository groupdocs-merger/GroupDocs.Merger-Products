...
############################# Head ############################
head_title: "Move RTF Pages in C#"
head_description: "Move pages within a RTF document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move RTF Pages In C#"
description: "Move RTF Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move RTF File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a RTF file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move RTF file pages using C# example code">}}
