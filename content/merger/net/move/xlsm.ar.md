...
############################# Head ############################
head_title: "نقل صفحات XLSM في C#"
head_description: "انقل الصفحات داخل مستند XLSM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLSM في C#"
description: "انقل صفحات XLSM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLSM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLSM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLSM باستخدام كود مثال C#">}}
