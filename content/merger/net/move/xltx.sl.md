...
############################# Head ############################
head_title: "Premakni XLTX strani v C#"
head_description: "Premaknite strani znotraj dokumenta XLTX v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLTX strani v C#"
description: "Premaknite strani XLTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke XLTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLTX s primerom kode C#">}}
