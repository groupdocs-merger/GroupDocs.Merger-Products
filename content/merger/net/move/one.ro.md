...
############################# Head ############################
head_title: "Mutați ONE pagini în C#"
head_description: "Mutați paginile dintr-un document ONE în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ONE pagini în C#"
description: "Mutați ONE pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați ONE pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier ONE prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ONE utilizând codul exemplu C#">}}
