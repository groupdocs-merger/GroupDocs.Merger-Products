...
############################# Head ############################
head_title: "PPS oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy PPS dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPS oldal mozgatása a C# nyelven"
description: "Mozgasson át PPS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPS fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy PPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájloldalak mozgatása a C# példakóddal">}}
