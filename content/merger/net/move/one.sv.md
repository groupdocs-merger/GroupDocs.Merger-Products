...
############################# Head ############################
head_title: "Flytta ONE sidor i C#"
head_description: "Flytta sidor i ett ONE-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ONE sidor i C#"
description: "Flytta ONE sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta ONE filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en ONE-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ONE filsidor med hjälp av C# exempelkod">}}
