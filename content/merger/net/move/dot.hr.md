...
############################# Head ############################
head_title: "Premjesti DOT stranice u C#"
head_description: "Premjestite stranice unutar DOT dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOT stranice u C#"
description: "Premjesti DOT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti DOT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar DOT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOT stranice datoteke koristeći C# primjer koda">}}
