...
############################# Head ############################
head_title: "Alihkan PPSX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen PPSX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPSX Halaman Dalam C#"
description: "Alihkan PPSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan PPSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail PPSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPSX halaman fail menggunakan kod contoh C#.">}}
