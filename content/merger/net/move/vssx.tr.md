...
############################# Head ############################
head_title: "VSSX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSSX Sayfayı C# İçinde Taşı"
description: "VSSX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSSX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSX dosya sayfaları nasıl taşınır">}}
