...
############################# Head ############################
head_title: "VSTX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSTX Sayfayı C# İçinde Taşı"
description: "VSTX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSTX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTX dosya sayfaları nasıl taşınır">}}
