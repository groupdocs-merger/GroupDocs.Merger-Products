...
############################# Head ############################
head_title: "Perkelti XLTM puslapius C#"
head_description: "Perkelkite puslapius XLTM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLTM puslapius C#"
description: "Perkelkite XLTM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLTM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLTM failo puslapius naudojant C# pavyzdinį kodą">}}
