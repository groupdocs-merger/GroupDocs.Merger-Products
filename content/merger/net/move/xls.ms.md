...
############################# Head ############################
head_title: "Alihkan XLS Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLS dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLS Halaman Dalam C#"
description: "Alihkan XLS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLS halaman fail menggunakan kod contoh C#.">}}
