...
############################# Head ############################
head_title: "Pindahkan XLSM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLSM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLSM Halaman Di C#"
description: "Pindahkan Halaman XLSM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLSM menggunakan kode contoh C#">}}
