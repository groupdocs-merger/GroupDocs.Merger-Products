...
############################# Head ############################
head_title: "Presunúť XLSX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu XLSX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLSX stránok do C#"
description: "Presuňte XLSX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť XLSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru XLSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLSX pomocou vzorového kódu C#">}}
