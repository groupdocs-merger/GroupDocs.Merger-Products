...
############################# Head ############################
head_title: "Premjesti VSDX stranice u C#"
head_description: "Premjestite stranice unutar VSDX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSDX stranice u C#"
description: "Premjesti VSDX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VSDX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VSDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSDX stranice datoteke koristeći C# primjer koda">}}
