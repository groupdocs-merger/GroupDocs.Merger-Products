...
############################# Head ############################
head_title: "Mover OTP Páginas em C#"
head_description: "Mova as páginas em um documento OTP em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover OTP Páginas em C#"
description: "Mova OTP Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo OTP em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo OTP implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo OTP usando o código de exemplo C#">}}
