...
############################# Head ############################
head_title: "Mutați OTT pagini în C#"
head_description: "Mutați paginile dintr-un document OTT în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați OTT pagini în C#"
description: "Mutați OTT pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați OTT pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier OTT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere OTT utilizând codul exemplu C#">}}
