...
############################# Head ############################
head_title: "Flytt DOCX sider i C#"
head_description: "Flytt sider i et DOCX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOCX sider i C#"
description: "Flytt DOCX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOCX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOCX filsider ved hjelp av C# eksempelkode">}}
