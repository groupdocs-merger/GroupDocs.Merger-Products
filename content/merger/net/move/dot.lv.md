...
############################# Head ############################
head_title: "Pārvietot DOT lapas programmā C#"
head_description: "Pārvietojiet lapas DOT dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOT lapas programmā C#"
description: "Pārvietojiet DOT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOT faila lapas, izmantojot C# piemēra kodu">}}
