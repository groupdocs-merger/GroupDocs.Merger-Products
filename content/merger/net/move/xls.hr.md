...
############################# Head ############################
head_title: "Premjesti XLS stranice u C#"
head_description: "Premjestite stranice unutar XLS dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLS stranice u C#"
description: "Premjesti XLS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti XLS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar XLS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLS stranice datoteke koristeći C# primjer koda">}}
