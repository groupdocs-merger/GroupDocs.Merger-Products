...
############################# Head ############################
head_title: "Move DOC Pages in C#"
head_description: "Move pages within a DOC document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move DOC Pages In C#"
description: "Move DOC Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move DOC File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a DOC file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOC file pages using C# example code">}}
