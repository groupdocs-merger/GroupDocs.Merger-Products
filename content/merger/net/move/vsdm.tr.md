...
############################# Head ############################
head_title: "VSDM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSDM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSDM Sayfayı C# İçinde Taşı"
description: "VSDM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSDM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSDM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosya sayfaları nasıl taşınır">}}
