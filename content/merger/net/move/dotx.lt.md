...
############################# Head ############################
head_title: "Perkelti DOTX puslapius C#"
head_description: "Perkelkite puslapius DOTX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOTX puslapius C#"
description: "Perkelkite DOTX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOTX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOTX failo puslapius naudojant C# pavyzdinį kodą">}}
