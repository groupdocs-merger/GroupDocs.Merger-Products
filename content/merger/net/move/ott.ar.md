...
############################# Head ############################
head_title: "نقل صفحات OTT في C#"
head_description: "انقل الصفحات داخل مستند OTT في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات OTT في C#"
description: "انقل صفحات OTT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل OTT صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف OTT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف OTT باستخدام كود مثال C#">}}
