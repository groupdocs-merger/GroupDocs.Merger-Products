...
############################# Head ############################
head_title: "DOT Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOT Sayfayı C# İçinde Taşı"
description: "DOT Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOT Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosya sayfaları nasıl taşınır">}}
