...
############################# Head ############################
head_title: "Teisalda VSX lehte teenuses C#"
head_description: "Teisaldage dokumendi VSX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSX lehte rakenduses C#"
description: "Teisaldage VSX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSX faililehte, kasutades C# näitekoodi">}}
