...
############################# Head ############################
head_title: "Alihkan VTX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VTX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VTX Halaman Dalam C#"
description: "Alihkan VTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VTX halaman fail menggunakan kod contoh C#.">}}
