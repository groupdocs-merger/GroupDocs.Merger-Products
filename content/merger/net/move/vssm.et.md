...
############################# Head ############################
head_title: "Teisalda VSSM lehte teenuses C#"
head_description: "Teisaldage dokumendi VSSM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSSM lehte rakenduses C#"
description: "Teisaldage VSSM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSSM faililehte, kasutades C# näitekoodi">}}
