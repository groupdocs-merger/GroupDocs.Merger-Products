...
############################# Head ############################
head_title: "Pindahkan VSX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSX Halaman Di C#"
description: "Pindahkan Halaman VSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSX menggunakan kode contoh C#">}}
