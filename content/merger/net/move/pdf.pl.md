...
############################# Head ############################
head_title: "Przenieś PDF strony w C#"
head_description: "Przenieś strony w dokumencie PDF w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś PDF strony w C#"
description: "Przenieś strony PDF za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików PDF do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku PDF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść PDF strony pliku za pomocą C# przykładowego kodu">}}
