...
############################# Head ############################
head_title: "نقل صفحات VSSM في C#"
head_description: "انقل الصفحات داخل مستند VSSM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSSM في C#"
description: "انقل صفحات VSSM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSSM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSSM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSSM باستخدام كود مثال C#">}}
