...
############################# Head ############################
head_title: "Alihkan TEX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen TEX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan TEX Halaman Dalam C#"
description: "Alihkan TEX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan TEX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail TEX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan TEX halaman fail menggunakan kod contoh C#.">}}
