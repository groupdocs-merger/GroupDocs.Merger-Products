...
############################# Head ############################
head_title: "Premakni ODT strani v C#"
head_description: "Premaknite strani znotraj dokumenta ODT v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ODT strani v C#"
description: "Premaknite strani ODT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ODT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke ODT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ODT s primerom kode C#">}}
