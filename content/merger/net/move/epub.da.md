...
############################# Head ############################
head_title: "Flyt EPUB sider i C#"
head_description: "Flyt sider i et EPUB-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt EPUB sider i C#"
description: "Flyt EPUB sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en EPUB-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes EPUB filsider ved hjælp af C# eksempelkode">}}
