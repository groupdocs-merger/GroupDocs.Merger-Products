...
############################# Head ############################
head_title: "Teisalda DOT lehte teenuses C#"
head_description: "Teisaldage dokumendi DOT lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOT lehte rakenduses C#"
description: "Teisaldage DOT lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis DOT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOT faililehte, kasutades C# näitekoodi">}}
