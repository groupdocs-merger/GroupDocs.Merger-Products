...
############################# Head ############################
head_title: "Pārvietot MHT lapas programmā C#"
head_description: "Pārvietojiet lapas MHT dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot MHT lapas programmā C#"
description: "Pārvietojiet MHT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot MHT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas MHT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot MHT faila lapas, izmantojot C# piemēra kodu">}}
