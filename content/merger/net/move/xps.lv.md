...
############################# Head ############################
head_title: "Pārvietot XPS lapas programmā C#"
head_description: "Pārvietojiet lapas XPS dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XPS lapas programmā C#"
description: "Pārvietojiet XPS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XPS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XPS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XPS faila lapas, izmantojot C# piemēra kodu">}}
