...
############################# Head ############################
head_title: "Premakni ODS strani v C#"
head_description: "Premaknite strani znotraj dokumenta ODS v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ODS strani v C#"
description: "Premaknite strani ODS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ODS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke ODS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ODS s primerom kode C#">}}
