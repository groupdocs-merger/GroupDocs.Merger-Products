...
############################# Head ############################
head_title: "Færa XLSB síður í C#"
head_description: "Færðu síður innan XLSB skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLSB síður í C#"
description: "Færðu XLSB síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLSB skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLSB skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLSB skráarsíður með því að nota C# dæmikóða">}}
