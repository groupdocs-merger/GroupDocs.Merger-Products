...
############################# Head ############################
head_title: "Flytt ODS sider i C#"
head_description: "Flytt sider i et ODS-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ODS sider i C#"
description: "Flytt ODS sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en ODS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ODS filsider ved hjelp av C# eksempelkode">}}
