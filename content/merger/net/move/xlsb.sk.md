...
############################# Head ############################
head_title: "Presunúť XLSB stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu XLSB v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLSB stránok do C#"
description: "Presuňte XLSB stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť XLSB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru XLSB implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLSB pomocou vzorového kódu C#">}}
