...
############################# Head ############################
head_title: "Flyt OTT sider i C#"
head_description: "Flyt sider i et OTT-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt OTT sider i C#"
description: "Flyt OTT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en OTT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes OTT filsider ved hjælp af C# eksempelkode">}}
