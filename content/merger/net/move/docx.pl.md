...
############################# Head ############################
head_title: "Przenieś DOCX strony w C#"
head_description: "Przenieś strony w dokumencie DOCX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś DOCX strony w C#"
description: "Przenieś strony DOCX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików DOCX do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku DOCX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść DOCX strony pliku za pomocą C# przykładowego kodu">}}
