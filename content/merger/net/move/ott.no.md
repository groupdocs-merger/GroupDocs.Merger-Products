...
############################# Head ############################
head_title: "Flytt OTT sider i C#"
head_description: "Flytt sider i et OTT-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt OTT sider i C#"
description: "Flytt OTT sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en OTT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte OTT filsider ved hjelp av C# eksempelkode">}}
