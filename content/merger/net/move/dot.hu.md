...
############################# Head ############################
head_title: "DOT oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOT dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOT oldal mozgatása a C# nyelven"
description: "Mozgasson át DOT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOT fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOT fájloldalak mozgatása a C# példakóddal">}}
