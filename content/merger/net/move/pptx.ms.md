...
############################# Head ############################
head_title: "Alihkan PPTX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen PPTX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPTX Halaman Dalam C#"
description: "Alihkan PPTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan PPTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail PPTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPTX halaman fail menggunakan kod contoh C#.">}}
