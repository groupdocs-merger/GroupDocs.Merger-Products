...
############################# Head ############################
head_title: "Alihkan EPUB Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen EPUB dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan EPUB Halaman Dalam C#"
description: "Alihkan EPUB Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan EPUB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail EPUB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan EPUB halaman fail menggunakan kod contoh C#.">}}
