...
############################# Head ############################
head_title: "PPTX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy PPTX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPTX oldal mozgatása a C# nyelven"
description: "Mozgasson át PPTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPTX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy PPTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájloldalak mozgatása a C# példakóddal">}}
