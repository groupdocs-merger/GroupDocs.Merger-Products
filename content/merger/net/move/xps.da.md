...
############################# Head ############################
head_title: "Flyt XPS sider i C#"
head_description: "Flyt sider i et XPS-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XPS sider i C#"
description: "Flyt XPS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XPS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XPS filsider ved hjælp af C# eksempelkode">}}
