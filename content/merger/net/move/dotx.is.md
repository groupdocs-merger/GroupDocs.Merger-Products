...
############################# Head ############################
head_title: "Færa DOTX síður í C#"
head_description: "Færðu síður innan DOTX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOTX síður í C#"
description: "Færðu DOTX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa DOTX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í DOTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOTX skráarsíður með því að nota C# dæmikóða">}}
