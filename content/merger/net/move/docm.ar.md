...
############################# Head ############################
head_title: "نقل صفحات DOCM في C#"
head_description: "انقل الصفحات داخل مستند DOCM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOCM في C#"
description: "انقل صفحات DOCM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOCM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOCM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOCM باستخدام كود مثال C#">}}
