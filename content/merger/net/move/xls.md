...
############################# Head ############################
head_title: "Move XLS Pages in C#"
head_description: "Move pages within a XLS document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLS Pages In C#"
description: "Move XLS Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLS File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLS file pages using C# example code">}}
