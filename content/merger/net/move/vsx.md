...
############################# Head ############################
head_title: "Move VSX Pages in C#"
head_description: "Move pages within a VSX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSX Pages In C#"
description: "Move VSX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSX file pages using C# example code">}}
