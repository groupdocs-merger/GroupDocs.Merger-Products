...
############################# Head ############################
head_title: "Pindahkan ONENOTE Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen ONENOTE di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ONENOTE Halaman Di C#"
description: "Pindahkan Halaman ONENOTE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan ONENOTE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file ONENOTE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ONENOTE menggunakan kode contoh C#">}}
