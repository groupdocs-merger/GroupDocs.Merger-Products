...
############################# Head ############################
head_title: "Rûpelên OTT di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek OTT ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên OTT Di C# de biguhezînin"
description: "Rûpelên OTT bi çend rêzikên koda {{Navê berhemê}} biguhezînin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê OTT biguhezînin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek OTT de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê OTT bar dike">}}

        ```csharp    
        // Rûpelên pelê yên OTT bi kar tînin GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Demoyên Zindî - Rûpelên Serhêl biguhezînin OTT"
    content: |
       Bi serdana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/ott) niha rûpelên pelê yên OTT biguhezînin.
