...
############################# Head ############################
head_title: "Rûpelên VDX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VDX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VDX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VDX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VDX bar dike">}}
