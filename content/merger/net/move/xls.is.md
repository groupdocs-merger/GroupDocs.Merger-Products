...
############################# Head ############################
head_title: "Færa XLS síður í C#"
head_description: "Færðu síður innan XLS skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLS síður í C#"
description: "Færðu XLS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLS skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLS skráarsíður með því að nota C# dæmikóða">}}
