...
############################# Head ############################
head_title: "Teisalda PDF lehte teenuses C#"
head_description: "Teisaldage dokumendi PDF lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PDF lehte rakenduses C#"
description: "Teisaldage PDF lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PDF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis PDF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PDF faililehte, kasutades C# näitekoodi">}}
