...
############################# Head ############################
head_title: "نقل صفحات OTP في C#"
head_description: "انقل الصفحات داخل مستند OTP في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات OTP في C#"
description: "انقل صفحات OTP ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل OTP صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف OTP من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف OTP باستخدام كود مثال C#">}}
