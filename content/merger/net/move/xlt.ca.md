...
############################# Head ############################
head_title: "Mou XLT pàgines a C#"
head_description: "Mou les pàgines d'un document XLT a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou XLT pàgines a C#"
description: "Mou XLT pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou XLT pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer XLT implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers XLT utilitzant el codi d'exemple C#">}}
