...
############################# Head ############################
head_title: "Przenieś HTML strony w C#"
head_description: "Przenieś strony w dokumencie HTML w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś HTML strony w C#"
description: "Przenieś strony HTML za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików HTML do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku HTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść HTML strony pliku za pomocą C# przykładowego kodu">}}
