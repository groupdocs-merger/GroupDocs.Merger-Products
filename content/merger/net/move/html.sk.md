...
############################# Head ############################
head_title: "Presunúť HTML stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu HTML v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť HTML stránok do C#"
description: "Presuňte HTML stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť HTML strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru HTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru HTML pomocou vzorového kódu C#">}}
