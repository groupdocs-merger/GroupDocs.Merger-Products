...
############################# Head ############################
head_title: "Premakni VSTM strani v C#"
head_description: "Premaknite strani znotraj dokumenta VSTM v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSTM strani v C#"
description: "Premaknite strani VSTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke VSTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSTM s primerom kode C#">}}
