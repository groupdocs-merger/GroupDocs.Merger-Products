...
############################# Head ############################
head_title: "Perkelti ODS puslapius C#"
head_description: "Perkelkite puslapius ODS dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODS puslapius C#"
description: "Perkelkite ODS puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODS failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius ODS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODS failo puslapius naudojant C# pavyzdinį kodą">}}
