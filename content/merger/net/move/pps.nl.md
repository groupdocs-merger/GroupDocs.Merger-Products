...
############################# Head ############################
head_title: "Verplaats PPS pagina's in C#"
head_description: "Verplaats pagina's binnen een PPS document in C# naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats PPS pagina's in C#"
description: "Verplaats PPS pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verplaats PPS bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een PPS bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPS bestandspagina's te verplaatsen met behulp van C# voorbeeldcode">}}
