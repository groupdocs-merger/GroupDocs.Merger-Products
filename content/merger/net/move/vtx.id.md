...
############################# Head ############################
head_title: "Pindahkan VTX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VTX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VTX Halaman Di C#"
description: "Pindahkan Halaman VTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VTX menggunakan kode contoh C#">}}
