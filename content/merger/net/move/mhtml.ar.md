...
############################# Head ############################
head_title: "نقل صفحات MHTML في C#"
head_description: "انقل الصفحات داخل مستند MHTML في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات MHTML في C#"
description: "انقل صفحات MHTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل MHTML صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف MHTML من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف MHTML باستخدام كود مثال C#">}}
