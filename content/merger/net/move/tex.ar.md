...
############################# Head ############################
head_title: "نقل صفحات TEX في C#"
head_description: "انقل الصفحات داخل مستند TEX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات TEX في C#"
description: "انقل صفحات TEX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل TEX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف TEX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف TEX باستخدام كود مثال C#">}}
