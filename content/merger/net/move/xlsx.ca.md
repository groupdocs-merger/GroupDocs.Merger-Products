...
############################# Head ############################
head_title: "Mou XLSX pàgines a C#"
head_description: "Mou les pàgines d'un document XLSX a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou XLSX pàgines a C#"
description: "Mou XLSX pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou XLSX pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer XLSX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers XLSX utilitzant el codi d'exemple C#">}}
