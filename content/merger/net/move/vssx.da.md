...
############################# Head ############################
head_title: "Flyt VSSX sider i C#"
head_description: "Flyt sider i et VSSX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSSX sider i C#"
description: "Flyt VSSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSSX filsider ved hjælp af C# eksempelkode">}}
