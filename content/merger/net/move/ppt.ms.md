...
############################# Head ############################
head_title: "Alihkan PPT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen PPT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PPT Halaman Dalam C#"
description: "Alihkan PPT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan PPT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail PPT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PPT halaman fail menggunakan kod contoh C#.">}}
