...
############################# Head ############################
head_title: "Flytt PPS sider i C#"
head_description: "Flytt sider i et PPS-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PPS sider i C#"
description: "Flytt PPS sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt PPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en PPS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PPS filsider ved hjelp av C# eksempelkode">}}
