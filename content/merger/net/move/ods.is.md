...
############################# Head ############################
head_title: "Færa ODS síður í C#"
head_description: "Færðu síður innan ODS skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa ODS síður í C#"
description: "Færðu ODS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa ODS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í ODS skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa ODS skráarsíður með því að nota C# dæmikóða">}}
