...
############################# Head ############################
head_title: "MHT oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy MHT dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHT oldal mozgatása a C# nyelven"
description: "Mozgasson át MHT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "MHT fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy MHT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájloldalak mozgatása a C# példakóddal">}}
