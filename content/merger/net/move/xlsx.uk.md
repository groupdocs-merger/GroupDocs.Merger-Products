...
############################# Head ############################
head_title: "Перемістити XLSX сторінки в C#"
head_description: "Перемістіть сторінки в межах документа XLSX у C# у будь-яку позицію за допомогою API об’єднання документів."

############################# Header ############################
title: "Перемістити XLSX сторінки в C#"
description: "Перемістіть сторінки XLSX кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Перемістити XLSX сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) полегшує розробникам C# переміщення сторінок у файлі XLSX, виконавши кілька простих кроків .
    ...
    code: |
     ...
     {{< merger/code-merger title="Як перемістити сторінки файлу XLSX за допомогою прикладу коду C#">}}
