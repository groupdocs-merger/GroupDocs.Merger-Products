...
############################# Head ############################
head_title: "ODT Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir ODT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ODT Sayfayı C# İçinde Taşı"
description: "ODT Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ODT Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir ODT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODT dosya sayfaları nasıl taşınır">}}
