...
############################# Head ############################
head_title: "ODP Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir ODP belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ODP Sayfayı C# İçinde Taşı"
description: "ODP Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ODP Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir ODP dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosya sayfaları nasıl taşınır">}}
