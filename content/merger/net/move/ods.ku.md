...
############################# Head ############################
head_title: "Rûpelên ODS di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek ODS ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên ODS Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê ODS biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê ODS bar dike">}}
