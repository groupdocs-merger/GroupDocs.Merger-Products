...
############################# Head ############################
head_title: "Færa PPTX síður í C#"
head_description: "Færðu síður innan PPTX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPTX síður í C#"
description: "Færðu PPTX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa PPTX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í PPTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPTX skráarsíður með því að nota C# dæmikóða">}}
