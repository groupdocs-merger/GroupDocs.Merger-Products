...
############################# Head ############################
head_title: "Déplacer PPTX pages dans C#"
head_description: "Déplacez les pages d'un document PPTX dans C# vers n'importe quelle position à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Déplacer PPTX pages dans C#"
description: "Déplacez PPTX pages avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Déplacer PPTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de déplacer facilement des pages dans un fichier PPTX en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment déplacer les pages de fichiers PPTX à l'aide de l'exemple de code C#">}}
