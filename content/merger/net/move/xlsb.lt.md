...
############################# Head ############################
head_title: "Perkelti XLSB puslapius C#"
head_description: "Perkelkite puslapius XLSB dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSB puslapius C#"
description: "Perkelkite XLSB puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSB failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLSB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSB failo puslapius naudojant C# pavyzdinį kodą">}}
