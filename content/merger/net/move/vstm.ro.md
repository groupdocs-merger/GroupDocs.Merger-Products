...
############################# Head ############################
head_title: "Mutați VSTM pagini în C#"
head_description: "Mutați paginile dintr-un document VSTM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSTM pagini în C#"
description: "Mutați VSTM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSTM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSTM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSTM utilizând codul exemplu C#">}}
