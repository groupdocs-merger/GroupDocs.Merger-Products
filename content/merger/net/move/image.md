...
############################# Head ############################
head_title: "Move IMAGE Pages in C#"
head_description: "Move pages within a IMAGE document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move IMAGE Pages In C#"
description: "Move IMAGE Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move IMAGE File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a IMAGE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move IMAGE file pages using C# example code">}}
