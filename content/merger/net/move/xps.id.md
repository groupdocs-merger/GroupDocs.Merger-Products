...
############################# Head ############################
head_title: "Pindahkan XPS Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XPS di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XPS Halaman Di C#"
description: "Pindahkan Halaman XPS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XPS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XPS menggunakan kode contoh C#">}}
