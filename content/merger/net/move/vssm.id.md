...
############################# Head ############################
head_title: "Pindahkan VSSM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSSM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSSM Halaman Di C#"
description: "Pindahkan Halaman VSSM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSSM menggunakan kode contoh C#">}}
