...
############################# Head ############################
head_title: "Teisalda XLSB lehte teenuses C#"
head_description: "Teisaldage dokumendi XLSB lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSB lehte rakenduses C#"
description: "Teisaldage XLSB lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLSB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSB faililehte, kasutades C# näitekoodi">}}
