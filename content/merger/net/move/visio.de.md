...
############################# Head ############################
head_title: "Seiten in VISIO in .NET verschieben"
head_description: "GroupDocs.Merger for .NET ermöglicht das mühelose Neuanordnen von Seiten in VISIO-Dokumenten. Verarbeiten Sie PDF, Word, Excel, PowerPoint, Bilder und mehr."

############################# Header ############################
title: "Seiten in VISIO verschieben" 
description: "GroupDocs.Merger for .NET befähigt .NET-Anwendungen, Seiten in VISIO-Dokumenten einfach neu anzuordnen."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) erleichtert das Verschieben ausgewählter Seiten in VISIO-Dokumenten. Verbessern Sie Ihre .NET-Anwendungen mit erweiterten Funktionen zur Dokumentenverarbeitung.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eine Seite ans Ende des Dokuments verschieben"
      content: |
        In diesem Beispiel wird gezeigt, wie eine bestimmte Seite ans Ende eines VISIO-Dokuments verschoben wird.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
