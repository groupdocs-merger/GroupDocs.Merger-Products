...
############################# Head ############################
head_title: "Pindahkan DOCM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOCM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOCM Halaman Di C#"
description: "Pindahkan Halaman DOCM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOCM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOCM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOCM menggunakan kode contoh C#">}}
