...
############################# Head ############################
head_title: "Pindahkan VSTM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSTM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSTM Halaman Di C#"
description: "Pindahkan Halaman VSTM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSTM menggunakan kode contoh C#">}}
