...
############################# Head ############################
head_title: "Move XPS Pages in C#"
head_description: "Move pages within a XPS document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XPS Pages In C#"
description: "Move XPS Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XPS File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XPS file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move XPS Pages Online"
    content: |
       Move XPS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/xps) website.
