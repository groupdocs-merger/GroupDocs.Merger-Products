...
############################# Head ############################
head_title: "MHTML Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir MHTML belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "MHTML Sayfayı C# İçinde Taşı"
description: "MHTML Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "MHTML Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir MHTML dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHTML dosya sayfaları nasıl taşınır">}}
