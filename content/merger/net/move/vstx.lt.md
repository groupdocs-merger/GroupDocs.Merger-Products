...
############################# Head ############################
head_title: "Perkelti VSTX puslapius C#"
head_description: "Perkelkite puslapius VSTX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSTX puslapius C#"
description: "Perkelkite VSTX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSTX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSTX failo puslapius naudojant C# pavyzdinį kodą">}}
