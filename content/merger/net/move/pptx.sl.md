...
############################# Head ############################
head_title: "Premakni PPTX strani v C#"
head_description: "Premaknite strani znotraj dokumenta PPTX v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPTX strani v C#"
description: "Premaknite strani PPTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke PPTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPTX s primerom kode C#">}}
