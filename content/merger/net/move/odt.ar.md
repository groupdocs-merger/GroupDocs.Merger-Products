...
############################# Head ############################
head_title: "نقل صفحات ODT في C#"
head_description: "انقل الصفحات داخل مستند ODT في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ODT في C#"
description: "انقل صفحات ODT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل ODT صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف ODT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ODT باستخدام كود مثال C#">}}
