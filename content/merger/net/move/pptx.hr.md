...
############################# Head ############################
head_title: "Premjesti PPTX stranice u C#"
head_description: "Premjestite stranice unutar PPTX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti PPTX stranice u C#"
description: "Premjesti PPTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti PPTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar PPTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti PPTX stranice datoteke koristeći C# primjer koda">}}
