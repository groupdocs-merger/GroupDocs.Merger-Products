...
############################# Head ############################
head_title: "Flyt VDX sider i C#"
head_description: "Flyt sider i et VDX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VDX sider i C#"
description: "Flyt VDX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VDX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VDX filsider ved hjælp af C# eksempelkode">}}
