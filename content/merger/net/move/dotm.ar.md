...
############################# Head ############################
head_title: "نقل صفحات DOTM في C#"
head_description: "انقل الصفحات داخل مستند DOTM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOTM في C#"
description: "انقل صفحات DOTM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOTM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOTM باستخدام كود مثال C#">}}
