...
############################# Head ############################
head_title: "Flytt VTX sider i C#"
head_description: "Flytt sider i et VTX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VTX sider i C#"
description: "Flytt VTX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VTX filsider ved hjelp av C# eksempelkode">}}
