...
############################# Head ############################
head_title: "Mutați ODT pagini în C#"
head_description: "Mutați paginile dintr-un document ODT în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ODT pagini în C#"
description: "Mutați ODT pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați ODT pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier ODT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ODT utilizând codul exemplu C#">}}
