...
############################# Head ############################
head_title: "Mover VSX Páginas em C#"
head_description: "Mova as páginas em um documento VSX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSX Páginas em C#"
description: "Mova VSX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VSX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSX usando o código de exemplo C#">}}
