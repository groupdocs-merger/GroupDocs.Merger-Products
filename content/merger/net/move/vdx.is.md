...
############################# Head ############################
head_title: "Færa VDX síður í C#"
head_description: "Færðu síður innan VDX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VDX síður í C#"
description: "Færðu VDX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VDX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VDX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VDX skráarsíður með því að nota C# dæmikóða">}}
