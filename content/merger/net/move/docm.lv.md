...
############################# Head ############################
head_title: "Pārvietot DOCM lapas programmā C#"
head_description: "Pārvietojiet lapas DOCM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOCM lapas programmā C#"
description: "Pārvietojiet DOCM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOCM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOCM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOCM faila lapas, izmantojot C# piemēra kodu">}}
