...
############################# Head ############################
head_title: "Mutați VTX pagini în C#"
head_description: "Mutați paginile dintr-un document VTX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VTX pagini în C#"
description: "Mutați VTX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VTX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VTX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VTX utilizând codul exemplu C#">}}
