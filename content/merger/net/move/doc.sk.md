...
############################# Head ############################
head_title: "Presunúť DOC stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu DOC v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOC stránok do C#"
description: "Presuňte DOC stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť DOC strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru DOC implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOC pomocou vzorového kódu C#">}}
