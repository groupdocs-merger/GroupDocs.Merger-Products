...
############################# Head ############################
head_title: "Mou DOTM pàgines a C#"
head_description: "Mou les pàgines d'un document DOTM a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou DOTM pàgines a C#"
description: "Mou DOTM pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou DOTM pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer DOTM implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers DOTM utilitzant el codi d'exemple C#">}}
