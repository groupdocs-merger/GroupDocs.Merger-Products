...
############################# Head ############################
head_title: "Move ODP Pages in C#"
head_description: "Move pages within a ODP document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move ODP Pages In C#"
description: "Move ODP Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move ODP File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a ODP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODP file pages using C# example code">}}
