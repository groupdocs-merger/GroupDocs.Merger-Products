...
############################# Head ############################
head_title: "HTML oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy HTML dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "HTML oldal mozgatása a C# nyelven"
description: "Mozgasson át HTML oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "HTML fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy HTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájloldalak mozgatása a C# példakóddal">}}
