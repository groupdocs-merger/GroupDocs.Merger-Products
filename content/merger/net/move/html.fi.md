...
############################# Head ############################
head_title: "Siirrä HTML sivua C#"
head_description: "Siirrä HTML-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä HTML sivua C#"
description: "Siirrä HTML sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä HTML tiedostosivua tuotteessa .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää HTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
