...
############################# Head ############################
head_title: "Mover DOT páginas en C#"
head_description: "Mueva páginas dentro de un documento DOT en C# a cualquier posición usando la API de fusión de documentos."

############################# Header ############################
title: "Mover DOT páginas en C#"
description: "Mueva DOT páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Mover DOT páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# mover páginas dentro de un archivo DOT mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo mover páginas de archivos DOT usando el código de ejemplo C#">}}
