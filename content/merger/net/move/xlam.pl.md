...
############################# Head ############################
head_title: "Przenieś XLAM strony w C#"
head_description: "Przenieś strony w dokumencie XLAM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLAM strony w C#"
description: "Przenieś strony XLAM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLAM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLAM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLAM strony pliku za pomocą C# przykładowego kodu">}}
