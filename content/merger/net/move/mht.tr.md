...
############################# Head ############################
head_title: "MHT Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir MHT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "MHT Sayfayı C# İçinde Taşı"
description: "MHT Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "MHT Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir MHT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHT dosya sayfaları nasıl taşınır">}}
