...
############################# Head ############################
head_title: "Flytta XLSB sidor i C#"
head_description: "Flytta sidor i ett XLSB-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLSB sidor i C#"
description: "Flytta XLSB sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLSB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLSB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLSB filsidor med hjälp av C# exempelkod">}}
