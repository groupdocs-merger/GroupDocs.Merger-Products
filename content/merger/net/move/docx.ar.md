...
############################# Head ############################
head_title: "نقل صفحات DOCX في C#"
head_description: "انقل الصفحات داخل مستند DOCX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOCX في C#"
description: "انقل صفحات DOCX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOCX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOCX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOCX باستخدام كود مثال C#">}}
