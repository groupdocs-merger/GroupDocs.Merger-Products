...
############################# Head ############################
head_title: "Teisalda DOCM lehte teenuses C#"
head_description: "Teisaldage dokumendi DOCM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOCM lehte rakenduses C#"
description: "Teisaldage DOCM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOCM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis DOCM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOCM faililehte, kasutades C# näitekoodi">}}
