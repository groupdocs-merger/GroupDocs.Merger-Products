...
############################# Head ############################
head_title: "Bog MHT Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad MHT in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog MHT Leathanaigh I C#"
description: "Bog MHT Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog MHT Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad MHT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas MHT leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
