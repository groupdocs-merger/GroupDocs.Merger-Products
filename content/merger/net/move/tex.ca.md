...
############################# Head ############################
head_title: "Mou TEX pàgines a C#"
head_description: "Mou les pàgines d'un document TEX a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou TEX pàgines a C#"
description: "Mou TEX pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou TEX pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer TEX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers TEX utilitzant el codi d'exemple C#">}}
