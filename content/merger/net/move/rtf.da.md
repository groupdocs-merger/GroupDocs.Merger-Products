...
############################# Head ############################
head_title: "Flyt RTF sider i C#"
head_description: "Flyt sider i et RTF-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt RTF sider i C#"
description: "Flyt RTF sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en RTF-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes RTF filsider ved hjælp af C# eksempelkode">}}
