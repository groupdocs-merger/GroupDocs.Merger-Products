...
############################# Head ############################
head_title: "Flyt DOTX sider i C#"
head_description: "Flyt sider i et DOTX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOTX sider i C#"
description: "Flyt DOTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOTX filsider ved hjælp af C# eksempelkode">}}
