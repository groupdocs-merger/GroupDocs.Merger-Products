...
############################# Head ############################
head_title: "RTF Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir RTF belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "RTF Sayfayı C# İçinde Taşı"
description: "RTF Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "RTF Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir RTF dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosya sayfaları nasıl taşınır">}}
