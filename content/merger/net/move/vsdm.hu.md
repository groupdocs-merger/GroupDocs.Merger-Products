...
############################# Head ############################
head_title: "VSDM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSDM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDM oldal mozgatása a C# nyelven"
description: "Mozgasson át VSDM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSDM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSDM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájloldalak mozgatása a C# példakóddal">}}
