...
############################# Head ############################
head_title: "Teisalda XPS lehte teenuses C#"
head_description: "Teisaldage dokumendi XPS lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XPS lehte rakenduses C#"
description: "Teisaldage XPS lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XPS faililehte, kasutades C# näitekoodi">}}
