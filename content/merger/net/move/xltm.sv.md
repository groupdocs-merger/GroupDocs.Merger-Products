...
############################# Head ############################
head_title: "Flytta XLTM sidor i C#"
head_description: "Flytta sidor i ett XLTM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLTM sidor i C#"
description: "Flytta XLTM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLTM filsidor med hjälp av C# exempelkod">}}
