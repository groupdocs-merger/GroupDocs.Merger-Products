...
############################# Head ############################
head_title: "Mover ONE Páginas em C#"
head_description: "Mova as páginas em um documento ONE em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ONE Páginas em C#"
description: "Mova ONE Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ONE em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo ONE implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ONE usando o código de exemplo C#">}}
