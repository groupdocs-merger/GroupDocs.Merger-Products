...
############################# Head ############################
head_title: "نقل صفحات VSSX في C#"
head_description: "انقل الصفحات داخل مستند VSSX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSSX في C#"
description: "انقل صفحات VSSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSSX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSSX باستخدام كود مثال C#">}}
