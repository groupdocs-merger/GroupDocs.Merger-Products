...
############################# Head ############################
head_title: "Pārvietot XLTX lapas programmā C#"
head_description: "Pārvietojiet lapas XLTX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLTX lapas programmā C#"
description: "Pārvietojiet XLTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLTX faila lapas, izmantojot C# piemēra kodu">}}
