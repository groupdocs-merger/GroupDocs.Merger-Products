...
############################# Head ############################
head_title: "Flyt VSDM sider i C#"
head_description: "Flyt sider i et VSDM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSDM sider i C#"
description: "Flyt VSDM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSDM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSDM filsider ved hjælp af C# eksempelkode">}}
