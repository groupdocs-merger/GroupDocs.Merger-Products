...
############################# Head ############################
head_title: "Teisalda XLS lehte teenuses C#"
head_description: "Teisaldage dokumendi XLS lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLS lehte rakenduses C#"
description: "Teisaldage XLS lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLS faililehte, kasutades C# näitekoodi">}}
