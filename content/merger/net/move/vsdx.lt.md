...
############################# Head ############################
head_title: "Perkelti VSDX puslapius C#"
head_description: "Perkelkite puslapius VSDX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSDX puslapius C#"
description: "Perkelkite VSDX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSDX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSDX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSDX failo puslapius naudojant C# pavyzdinį kodą">}}
