...
############################# Head ############################
head_title: "Move VSDX Pages in C#"
head_description: "Move pages within a VSDX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSDX Pages In C#"
description: "Move VSDX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSDX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSDX file pages using C# example code">}}
