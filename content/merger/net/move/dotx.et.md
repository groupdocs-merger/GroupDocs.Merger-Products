...
############################# Head ############################
head_title: "Teisalda DOTX lehte teenuses C#"
head_description: "Teisaldage dokumendi DOTX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOTX lehte rakenduses C#"
description: "Teisaldage DOTX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis DOTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOTX faililehte, kasutades C# näitekoodi">}}
