...
############################# Head ############################
head_title: "Siirrä OTP sivua C#"
head_description: "Siirrä OTP-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä OTP sivua C#"
description: "Siirrä OTP sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä OTP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja OTP-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää OTP tiedostosivua käyttämällä C# esimerkkikoodia">}}
