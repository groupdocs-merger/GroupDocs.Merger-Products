...
############################# Head ############################
head_title: "Premakni DOT strani v C#"
head_description: "Premaknite strani znotraj dokumenta DOT v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOT strani v C#"
description: "Premaknite strani DOT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke DOT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOT s primerom kode C#">}}
