...
############################# Head ############################
head_title: "Færa DOCX síður í C#"
head_description: "Færðu síður innan DOCX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOCX síður í C#"
description: "Færðu DOCX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa DOCX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í DOCX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOCX skráarsíður með því að nota C# dæmikóða">}}
