...
############################# Head ############################
head_title: "OTT Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir OTT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "OTT Sayfayı C# İçinde Taşı"
description: "OTT Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "OTT Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir OTT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosya sayfaları nasıl taşınır">}}
