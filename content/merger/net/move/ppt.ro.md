...
############################# Head ############################
head_title: "Mutați PPT pagini în C#"
head_description: "Mutați paginile dintr-un document PPT în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PPT pagini în C#"
description: "Mutați PPT pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați PPT pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier PPT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PPT utilizând codul exemplu C#">}}
