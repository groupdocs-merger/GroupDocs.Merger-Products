...
############################# Head ############################
head_title: "Alihkan VSSM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSSM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSSM Halaman Dalam C#"
description: "Alihkan VSSM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSSM halaman fail menggunakan kod contoh C#.">}}
