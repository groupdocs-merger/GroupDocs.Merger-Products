...
############################# Head ############################
head_title: "Rûpelên DOTX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek DOTX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên DOTX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê DOTX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê DOTX bar dike">}}
