...
############################# Head ############################
head_title: "Move DOCM Pages in C#"
head_description: "Move pages within a DOCM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move DOCM Pages In C#"
description: "Move DOCM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move DOCM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a DOCM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOCM file pages using C# example code">}}
