...
############################# Head ############################
head_title: "Move VSSM Pages in C#"
head_description: "Move pages within a VSSM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSSM Pages In C#"
description: "Move VSSM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSSM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSSM file pages using C# example code">}}
