...
############################# Head ############################
head_title: "Alihkan XLTM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLTM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLTM Halaman Dalam C#"
description: "Alihkan XLTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLTM halaman fail menggunakan kod contoh C#.">}}
