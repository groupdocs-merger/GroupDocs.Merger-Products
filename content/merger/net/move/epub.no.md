...
############################# Head ############################
head_title: "Flytt EPUB sider i C#"
head_description: "Flytt sider i et EPUB-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt EPUB sider i C#"
description: "Flytt EPUB sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en EPUB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte EPUB filsider ved hjelp av C# eksempelkode">}}
