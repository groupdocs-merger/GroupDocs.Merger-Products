...
############################# Head ############################
head_title: "Teisalda DOC lehte teenuses C#"
head_description: "Teisaldage dokumendi DOC lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOC lehte rakenduses C#"
description: "Teisaldage DOC lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOC faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis DOC, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOC faililehte, kasutades C# näitekoodi">}}
