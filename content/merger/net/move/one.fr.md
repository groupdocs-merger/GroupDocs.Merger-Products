...
############################# Head ############################
head_title: "Déplacer ONE pages dans C#"
head_description: "Déplacez les pages d'un document ONE dans C# vers n'importe quelle position à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Déplacer ONE pages dans C#"
description: "Déplacez ONE pages avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Déplacer ONE pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de déplacer facilement des pages dans un fichier ONE en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment déplacer les pages de fichiers ONE à l'aide de l'exemple de code C#">}}
