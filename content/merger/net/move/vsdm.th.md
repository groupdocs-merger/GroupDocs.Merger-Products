...
############################# Head ############################
head_title: "ย้าย VSDM หน้าใน C#"
head_description: "ย้ายหน้าภายในเอกสาร VSDM ใน C# ไปยังตำแหน่งใดก็ได้โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "ย้าย VSDM หน้าใน C#"
description: "ย้าย VSDM หน้าด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "ย้ายหน้าไฟล์ VSDM ใน .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ทำให้นักพัฒนา C# สามารถย้ายหน้าภายในไฟล์ VSDM ได้โดยง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน .
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีย้ายหน้าไฟล์ VSDM โดยใช้โค้ดตัวอย่าง C#">}}
