...
############################# Head ############################
head_title: "نقل صفحات DOC في C#"
head_description: "انقل الصفحات داخل مستند DOC في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOC في C#"
description: "انقل صفحات DOC ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOC صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOC من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOC باستخدام كود مثال C#">}}
