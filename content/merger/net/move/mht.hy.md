...
############################# Head ############################
head_title: "Տեղափոխել MHT էջ C#-ում"
head_description: "Տեղափոխեք էջերը MHT փաստաթղթում C#-ում ցանկացած դիրք` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Տեղափոխել MHT էջ C#-ում"
description: "Տեղափոխեք MHT էջեր .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Տեղափոխել MHT ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար էջերը տեղափոխել MHT ֆայլի մեջ` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես տեղափոխել MHT ֆայլի էջեր՝ օգտագործելով C# օրինակ կոդը">}}
