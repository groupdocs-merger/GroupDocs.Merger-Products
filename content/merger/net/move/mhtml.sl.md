...
############################# Head ############################
head_title: "Premakni MHTML strani v C#"
head_description: "Premaknite strani znotraj dokumenta MHTML v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni MHTML strani v C#"
description: "Premaknite strani MHTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke MHTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke MHTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke MHTML s primerom kode C#">}}
