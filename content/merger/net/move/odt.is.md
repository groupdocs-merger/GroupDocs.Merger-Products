...
############################# Head ############################
head_title: "Færa ODT síður í C#"
head_description: "Færðu síður innan ODT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa ODT síður í C#"
description: "Færðu ODT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa ODT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í ODT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa ODT skráarsíður með því að nota C# dæmikóða">}}
