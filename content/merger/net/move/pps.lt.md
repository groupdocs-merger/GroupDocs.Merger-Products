...
############################# Head ############################
head_title: "Perkelti PPS puslapius C#"
head_description: "Perkelkite puslapius PPS dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPS puslapius C#"
description: "Perkelkite PPS puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPS failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius PPS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPS failo puslapius naudojant C# pavyzdinį kodą">}}
