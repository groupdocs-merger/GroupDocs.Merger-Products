...
############################# Head ############################
head_title: "Presunúť MHTML stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu MHTML v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť MHTML stránok do C#"
description: "Presuňte MHTML stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť MHTML strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru MHTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru MHTML pomocou vzorového kódu C#">}}
