...
############################# Head ############################
head_title: "Flytt DOCM sider i C#"
head_description: "Flytt sider i et DOCM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOCM sider i C#"
description: "Flytt DOCM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOCM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOCM filsider ved hjelp av C# eksempelkode">}}
