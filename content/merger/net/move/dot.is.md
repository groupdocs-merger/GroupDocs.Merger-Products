...
############################# Head ############################
head_title: "Færa DOT síður í C#"
head_description: "Færðu síður innan DOT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOT síður í C#"
description: "Færðu DOT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa DOT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í DOT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOT skráarsíður með því að nota C# dæmikóða">}}
