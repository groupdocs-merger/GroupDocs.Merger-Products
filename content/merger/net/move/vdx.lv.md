...
############################# Head ############################
head_title: "Pārvietot VDX lapas programmā C#"
head_description: "Pārvietojiet lapas VDX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VDX lapas programmā C#"
description: "Pārvietojiet VDX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VDX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VDX faila lapas, izmantojot C# piemēra kodu">}}
