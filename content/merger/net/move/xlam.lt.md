...
############################# Head ############################
head_title: "Perkelti XLAM puslapius C#"
head_description: "Perkelkite puslapius XLAM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLAM puslapius C#"
description: "Perkelkite XLAM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLAM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLAM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLAM failo puslapius naudojant C# pavyzdinį kodą">}}
