...
############################# Head ############################
head_title: "Perkelti XLS puslapius C#"
head_description: "Perkelkite puslapius XLS dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLS puslapius C#"
description: "Perkelkite XLS puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLS failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLS failo puslapius naudojant C# pavyzdinį kodą">}}
