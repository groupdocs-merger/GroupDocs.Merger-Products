...
############################# Head ############################
head_title: "Flyt MHT sider i C#"
head_description: "Flyt sider i et MHT-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt MHT sider i C#"
description: "Flyt MHT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en MHT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes MHT filsider ved hjælp af C# eksempelkode">}}
