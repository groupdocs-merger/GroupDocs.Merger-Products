...
############################# Head ############################
head_title: "Alihkan VDX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VDX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VDX Halaman Dalam C#"
description: "Alihkan VDX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VDX halaman fail menggunakan kod contoh C#.">}}
