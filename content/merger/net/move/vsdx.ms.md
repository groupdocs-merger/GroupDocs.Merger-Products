...
############################# Head ############################
head_title: "Alihkan VSDX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSDX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSDX Halaman Dalam C#"
description: "Alihkan VSDX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSDX halaman fail menggunakan kod contoh C#.">}}
