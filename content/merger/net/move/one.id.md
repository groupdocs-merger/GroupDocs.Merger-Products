...
############################# Head ############################
head_title: "Pindahkan ONE Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen ONE di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ONE Halaman Di C#"
description: "Pindahkan Halaman ONE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan ONE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file ONE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ONE menggunakan kode contoh C#">}}
