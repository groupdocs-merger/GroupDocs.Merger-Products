...
############################# Head ############################
head_title: "Presunúť PPSX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu PPSX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť PPSX stránok do C#"
description: "Presuňte PPSX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť PPSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru PPSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru PPSX pomocou vzorového kódu C#">}}
