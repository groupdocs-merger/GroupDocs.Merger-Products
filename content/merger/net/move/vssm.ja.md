...
############################# Head ############################
head_title: "C# で VSSM ページ移動"
head_description: "ドキュメント マージ API を使用して、C# 内の VSSM ドキュメント内のページを任意の位置に移動します。"

############################# Header ############################
title: "C# 内の VSSM ページを移動"
description: "数行の .NET コードで VSSM ページを移動します。"
...
steps:
    enable: true
    title_left: ".NET で VSSM ファイル ページを移動"
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) は、C# 開発者が VSSM ファイル内でページを簡単に移動できるようにするために、いくつかの簡単な手順を実装します。 .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# サンプル コードを使用して VSSM ファイル ページを移動する方法">}}
