...
############################# Head ############################
head_title: "Flyt XLS sider i C#"
head_description: "Flyt sider i et XLS-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLS sider i C#"
description: "Flyt XLS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLS filsider ved hjælp af C# eksempelkode">}}
