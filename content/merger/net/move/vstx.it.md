...
############################# Head ############################
head_title: "Sposta VSTX pagine in C#"
head_description: "Sposta le pagine all'interno di un documento VSTX in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta VSTX pagine in C#"
description: "Sposta VSTX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta VSTX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file VSTX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file VSTX utilizzando il codice di esempio C#">}}
