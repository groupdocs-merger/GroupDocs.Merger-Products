...
############################# Head ############################
head_title: "VSSX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSSX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSX oldal mozgatása a C# nyelven"
description: "Mozgasson át VSSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSSX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX fájloldalak mozgatása a C# példakóddal">}}
