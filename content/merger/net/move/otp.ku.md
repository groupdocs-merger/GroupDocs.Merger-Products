...
############################# Head ############################
head_title: "Rûpelên OTP di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek OTP ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên OTP Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê OTP biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê OTP bar dike">}}
