...
############################# Head ############################
head_title: "Perkelti XLSM puslapius C#"
head_description: "Perkelkite puslapius XLSM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSM puslapius C#"
description: "Perkelkite XLSM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLSM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSM failo puslapius naudojant C# pavyzdinį kodą">}}
