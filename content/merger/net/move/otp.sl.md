...
############################# Head ############################
head_title: "Premakni OTP strani v C#"
head_description: "Premaknite strani znotraj dokumenta OTP v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni OTP strani v C#"
description: "Premaknite strani OTP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke OTP v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke OTP z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke OTP s primerom kode C#">}}
