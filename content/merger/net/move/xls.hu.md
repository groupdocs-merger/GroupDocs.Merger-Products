...
############################# Head ############################
head_title: "XLS oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XLS dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLS oldal mozgatása a C# nyelven"
description: "Mozgasson át XLS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLS fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XLS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájloldalak mozgatása a C# példakóddal">}}
