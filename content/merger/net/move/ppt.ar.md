...
############################# Head ############################
head_title: "نقل صفحات PPT في C#"
head_description: "انقل الصفحات داخل مستند PPT في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPT في C#"
description: "انقل صفحات PPT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل PPT صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف PPT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPT باستخدام كود مثال C#">}}
