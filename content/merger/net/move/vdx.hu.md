...
############################# Head ############################
head_title: "VDX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VDX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VDX oldal mozgatása a C# nyelven"
description: "Mozgasson át VDX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VDX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VDX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX fájloldalak mozgatása a C# példakóddal">}}
