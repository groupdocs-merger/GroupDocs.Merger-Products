...
############################# Head ############################
head_title: "Mutați XPS pagini în C#"
head_description: "Mutați paginile dintr-un document XPS în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XPS pagini în C#"
description: "Mutați XPS pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XPS pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XPS prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XPS utilizând codul exemplu C#">}}
