...
############################# Head ############################
head_title: "Flytta VSDM sidor i C#"
head_description: "Flytta sidor i ett VSDM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSDM sidor i C#"
description: "Flytta VSDM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSDM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSDM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSDM filsidor med hjälp av C# exempelkod">}}
