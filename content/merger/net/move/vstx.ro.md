...
############################# Head ############################
head_title: "Mutați VSTX pagini în C#"
head_description: "Mutați paginile dintr-un document VSTX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSTX pagini în C#"
description: "Mutați VSTX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSTX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSTX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSTX utilizând codul exemplu C#">}}
