...
############################# Head ############################
head_title: "Premjesti TEX stranice u C#"
head_description: "Premjestite stranice unutar TEX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti TEX stranice u C#"
description: "Premjesti TEX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti TEX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar TEX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti TEX stranice datoteke koristeći C# primjer koda">}}
