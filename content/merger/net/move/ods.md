...
############################# Head ############################
head_title: "Move ODS Pages in C#"
head_description: "Move pages within a ODS document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move ODS Pages In C#"
description: "Move ODS Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODS file pages using C# example code">}}
