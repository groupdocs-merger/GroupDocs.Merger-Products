...
############################# Head ############################
head_title: "Flytt XLSB sider i C#"
head_description: "Flytt sider i et XLSB-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLSB sider i C#"
description: "Flytt XLSB sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLSB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLSB filsider ved hjelp av C# eksempelkode">}}
