...
############################# Head ############################
head_title: "Flytt ODT sider i C#"
head_description: "Flytt sider i et ODT-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ODT sider i C#"
description: "Flytt ODT sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt ODT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en ODT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ODT filsider ved hjelp av C# eksempelkode">}}
