...
############################# Head ############################
head_title: "Move PPT Pages in C#"
head_description: "Move pages within a PPT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move PPT Pages In C#"
description: "Move PPT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move PPT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a PPT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPT file pages using C# example code">}}
