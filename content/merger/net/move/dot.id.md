...
############################# Head ############################
head_title: "Pindahkan DOT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOT Halaman Di C#"
description: "Pindahkan Halaman DOT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOT menggunakan kode contoh C#">}}
