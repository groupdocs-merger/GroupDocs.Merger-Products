...
############################# Head ############################
head_title: "Flytta MHT sidor i C#"
head_description: "Flytta sidor i ett MHT-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta MHT sidor i C#"
description: "Flytta MHT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta MHT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en MHT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar MHT filsidor med hjälp av C# exempelkod">}}
