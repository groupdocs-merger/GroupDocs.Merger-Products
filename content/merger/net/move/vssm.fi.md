...
############################# Head ############################
head_title: "Siirrä VSSM sivua C#"
head_description: "Siirrä VSSM-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSSM sivua C#"
description: "Siirrä VSSM sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja VSSM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSSM tiedostosivua käyttämällä C# esimerkkikoodia">}}
