...
############################# Head ############################
head_title: "Flytta PPSX sidor i C#"
head_description: "Flytta sidor i ett PPSX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPSX sidor i C#"
description: "Flytta PPSX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta PPSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en PPSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPSX filsidor med hjälp av C# exempelkod">}}
