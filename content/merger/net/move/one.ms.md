...
############################# Head ############################
head_title: "Alihkan ONE Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen ONE dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ONE Halaman Dalam C#"
description: "Alihkan ONE Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan ONE Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail ONE dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ONE halaman fail menggunakan kod contoh C#.">}}
