...
############################# Head ############################
head_title: "Przenieś VSSM strony w C#"
head_description: "Przenieś strony w dokumencie VSSM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VSSM strony w C#"
description: "Przenieś strony VSSM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VSSM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku VSSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VSSM strony pliku za pomocą C# przykładowego kodu">}}
