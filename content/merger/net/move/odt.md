...
############################# Head ############################
head_title: "Move ODT Pages in C#"
head_description: "Move pages within a ODT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move ODT Pages In C#"
description: "Move ODT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move ODT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a ODT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ODT file pages using C# example code">}}
