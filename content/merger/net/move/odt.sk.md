...
############################# Head ############################
head_title: "Presunúť ODT stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu ODT v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť ODT stránok do C#"
description: "Presuňte ODT stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť ODT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru ODT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru ODT pomocou vzorového kódu C#">}}
