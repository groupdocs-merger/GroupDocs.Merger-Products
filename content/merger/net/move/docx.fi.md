...
############################# Head ############################
head_title: "Siirrä DOCX sivua C#"
head_description: "Siirrä DOCX-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOCX sivua C#"
description: "Siirrä DOCX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOCX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja DOCX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOCX tiedostosivua käyttämällä C# esimerkkikoodia">}}
