...
############################# Head ############################
head_title: "Move ONENOTE Pages in C#"
head_description: "Move pages within a ONENOTE document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move ONENOTE Pages In C#"
description: "Move ONENOTE Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a ONENOTE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ONENOTE file pages using C# example code">}}
