...
############################# Head ############################
head_title: "Alihkan RTF Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen RTF dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan RTF Halaman Dalam C#"
description: "Alihkan RTF Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan RTF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail RTF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan RTF halaman fail menggunakan kod contoh C#.">}}
