...
############################# Head ############################
head_title: "Siirrä PPT sivua C#"
head_description: "Siirrä PPT-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PPT sivua C#"
description: "Siirrä PPT sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PPT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja PPT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PPT tiedostosivua käyttämällä C# esimerkkikoodia">}}
