...
############################# Head ############################
head_title: "EPUB oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy EPUB dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "EPUB oldal mozgatása a C# nyelven"
description: "Mozgasson át EPUB oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "EPUB fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy EPUB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="EPUB fájloldalak mozgatása a C# példakóddal">}}
