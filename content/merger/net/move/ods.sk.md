...
############################# Head ############################
head_title: "Presunúť ODS stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu ODS v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť ODS stránok do C#"
description: "Presuňte ODS stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť ODS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru ODS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru ODS pomocou vzorového kódu C#">}}
