...
############################# Head ############################
head_title: "Տեղափոխել VSSM էջ C#-ում"
head_description: "Տեղափոխեք էջերը VSSM փաստաթղթում C#-ում ցանկացած դիրք` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Տեղափոխել VSSM էջ C#-ում"
description: "Տեղափոխեք VSSM էջեր .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Տեղափոխել VSSM ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար էջերը տեղափոխել VSSM ֆայլի մեջ` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես տեղափոխել VSSM ֆայլի էջեր՝ օգտագործելով C# օրինակ կոդը">}}
