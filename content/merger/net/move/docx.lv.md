...
############################# Head ############################
head_title: "Pārvietot DOCX lapas programmā C#"
head_description: "Pārvietojiet lapas DOCX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOCX lapas programmā C#"
description: "Pārvietojiet DOCX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOCX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOCX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOCX faila lapas, izmantojot C# piemēra kodu">}}
