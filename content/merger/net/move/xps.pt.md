...
############################# Head ############################
head_title: "Mover XPS Páginas em C#"
head_description: "Mova as páginas em um documento XPS em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XPS Páginas em C#"
description: "Mova XPS Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XPS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo XPS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XPS usando o código de exemplo C#">}}
