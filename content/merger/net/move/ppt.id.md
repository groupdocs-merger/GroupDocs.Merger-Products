...
############################# Head ############################
head_title: "Pindahkan PPT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen PPT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PPT Halaman Di C#"
description: "Pindahkan Halaman PPT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan PPT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file PPT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PPT menggunakan kode contoh C#">}}
