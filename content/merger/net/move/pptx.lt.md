...
############################# Head ############################
head_title: "Perkelti PPTX puslapius C#"
head_description: "Perkelkite puslapius PPTX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPTX puslapius C#"
description: "Perkelkite PPTX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPTX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius PPTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPTX failo puslapius naudojant C# pavyzdinį kodą">}}
