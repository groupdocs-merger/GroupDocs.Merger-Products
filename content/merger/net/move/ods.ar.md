...
############################# Head ############################
head_title: "نقل صفحات ODS في C#"
head_description: "انقل الصفحات داخل مستند ODS في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ODS في C#"
description: "انقل صفحات ODS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل ODS صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف ODS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ODS باستخدام كود مثال C#">}}
