...
############################# Head ############################
head_title: "Mutați ODP pagini în C#"
head_description: "Mutați paginile dintr-un document ODP în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ODP pagini în C#"
description: "Mutați ODP pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați ODP pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier ODP prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ODP utilizând codul exemplu C#">}}
