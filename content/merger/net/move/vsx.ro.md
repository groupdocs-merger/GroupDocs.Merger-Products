...
############################# Head ############################
head_title: "Mutați VSX pagini în C#"
head_description: "Mutați paginile dintr-un document VSX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSX pagini în C#"
description: "Mutați VSX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSX utilizând codul exemplu C#">}}
