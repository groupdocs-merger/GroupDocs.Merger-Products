...
############################# Head ############################
head_title: "Pārvietot VSDM lapas programmā C#"
head_description: "Pārvietojiet lapas VSDM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSDM lapas programmā C#"
description: "Pārvietojiet VSDM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSDM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSDM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSDM faila lapas, izmantojot C# piemēra kodu">}}
