...
############################# Head ############################
head_title: "Przenieś ONE strony w C#"
head_description: "Przenieś strony w dokumencie ONE w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś ONE strony w C#"
description: "Przenieś strony ONE za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików ONE do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku ONE, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść ONE strony pliku za pomocą C# przykładowego kodu">}}
