...
############################# Head ############################
head_title: "Rûpelên DOC di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek DOC ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên DOC Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê DOC biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê DOC bar dike">}}
