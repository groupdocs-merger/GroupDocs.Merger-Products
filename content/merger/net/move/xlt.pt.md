...
############################# Head ############################
head_title: "Mover XLT Páginas em C#"
head_description: "Mova as páginas em um documento XLT em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLT Páginas em C#"
description: "Mova XLT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo XLT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLT usando o código de exemplo C#">}}
