...
############################# Head ############################
head_title: "Mutați DOCM pagini în C#"
head_description: "Mutați paginile dintr-un document DOCM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOCM pagini în C#"
description: "Mutați DOCM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOCM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOCM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOCM utilizând codul exemplu C#">}}
