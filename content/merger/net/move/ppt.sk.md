...
############################# Head ############################
head_title: "Presunúť PPT stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu PPT v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť PPT stránok do C#"
description: "Presuňte PPT stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť PPT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru PPT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru PPT pomocou vzorového kódu C#">}}
