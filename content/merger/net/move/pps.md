...
############################# Head ############################
head_title: "Move PPS Pages in C#"
head_description: "Move pages within a PPS document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move PPS Pages In C#"
description: "Move PPS Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move PPS File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a PPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPS file pages using C# example code">}}
