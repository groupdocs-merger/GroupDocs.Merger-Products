...
############################# Head ############################
head_title: "Przenieś DOTM strony w C#"
head_description: "Przenieś strony w dokumencie DOTM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś DOTM strony w C#"
description: "Przenieś strony DOTM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików DOTM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku DOTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść DOTM strony pliku za pomocą C# przykładowego kodu">}}
