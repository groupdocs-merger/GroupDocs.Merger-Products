...
############################# Head ############################
head_title: "Mover XLSB páginas en C#"
head_description: "Mueva páginas dentro de un documento XLSB en C# a cualquier posición usando la API de fusión de documentos."

############################# Header ############################
title: "Mover XLSB páginas en C#"
description: "Mueva XLSB páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Mover XLSB páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# mover páginas dentro de un archivo XLSB mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo mover páginas de archivos XLSB usando el código de ejemplo C#">}}
