...
############################# Head ############################
head_title: "Premakni DOCM strani v C#"
head_description: "Premaknite strani znotraj dokumenta DOCM v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOCM strani v C#"
description: "Premaknite strani DOCM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOCM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke DOCM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOCM s primerom kode C#">}}
