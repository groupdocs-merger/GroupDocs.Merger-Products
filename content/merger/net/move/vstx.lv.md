...
############################# Head ############################
head_title: "Pārvietot VSTX lapas programmā C#"
head_description: "Pārvietojiet lapas VSTX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSTX lapas programmā C#"
description: "Pārvietojiet VSTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSTX faila lapas, izmantojot C# piemēra kodu">}}
