...
############################# Head ############################
head_title: "Mover páginas de EPUB em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos EPUB de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em EPUB" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos EPUB. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
