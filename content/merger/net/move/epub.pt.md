...
############################# Head ############################
head_title: "Mover EPUB Páginas em C#"
head_description: "Mova as páginas em um documento EPUB em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover EPUB Páginas em C#"
description: "Mova EPUB Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo EPUB em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo EPUB implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo EPUB usando o código de exemplo C#">}}
