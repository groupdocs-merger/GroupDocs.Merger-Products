...
############################# Head ############################
head_title: "Mutați TEX pagini în C#"
head_description: "Mutați paginile dintr-un document TEX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați TEX pagini în C#"
description: "Mutați TEX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați TEX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier TEX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere TEX utilizând codul exemplu C#">}}
