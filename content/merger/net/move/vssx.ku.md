...
############################# Head ############################
head_title: "Rûpelên VSSX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VSSX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VSSX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSSX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VSSX bar dike">}}
