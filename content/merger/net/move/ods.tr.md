...
############################# Head ############################
head_title: "ODS Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir ODS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ODS Sayfayı C# İçinde Taşı"
description: "ODS Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ODS Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir ODS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODS dosya sayfaları nasıl taşınır">}}
