...
############################# Head ############################
head_title: "Premakni ONE strani v C#"
head_description: "Premaknite strani znotraj dokumenta ONE v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni ONE strani v C#"
description: "Premaknite strani ONE z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke ONE v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke ONE z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke ONE s primerom kode C#">}}
