...
############################# Head ############################
head_title: "Premjesti DOTX stranice u C#"
head_description: "Premjestite stranice unutar DOTX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOTX stranice u C#"
description: "Premjesti DOTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti DOTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar DOTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOTX stranice datoteke koristeći C# primjer koda">}}
