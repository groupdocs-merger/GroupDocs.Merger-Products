...
############################# Head ############################
head_title: "Przenieś ODS strony w C#"
head_description: "Przenieś strony w dokumencie ODS w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś ODS strony w C#"
description: "Przenieś strony ODS za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików ODS do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku ODS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść ODS strony pliku za pomocą C# przykładowego kodu">}}
