...
############################# Head ############################
head_title: "Perkelti HTML puslapius C#"
head_description: "Perkelkite puslapius HTML dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti HTML puslapius C#"
description: "Perkelkite HTML puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti HTML failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius HTML faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti HTML failo puslapius naudojant C# pavyzdinį kodą">}}
