...
############################# Head ############################
head_title: "Siirrä ODP sivua C#"
head_description: "Siirrä ODP-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODP sivua C#"
description: "Siirrä ODP sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja ODP-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODP tiedostosivua käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Siirrä ODP tiedostosivua GroupDocs.Merger API:lla
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Siirrä ODP sivua verkkoon"
    content: |
       Siirrä ODP tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/odp) -sivustolla.
