...
############################# Head ############################
head_title: "Flytta XLSM sidor i C#"
head_description: "Flytta sidor i ett XLSM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLSM sidor i C#"
description: "Flytta XLSM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLSM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLSM filsidor med hjälp av C# exempelkod">}}
