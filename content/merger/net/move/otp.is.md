...
############################# Head ############################
head_title: "Færa OTP síður í C#"
head_description: "Færðu síður innan OTP skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa OTP síður í C#"
description: "Færðu OTP síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa OTP skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í OTP skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa OTP skráarsíður með því að nota C# dæmikóða">}}
