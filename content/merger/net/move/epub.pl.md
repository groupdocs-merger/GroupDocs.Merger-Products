...
############################# Head ############################
head_title: "Przenieś EPUB strony w C#"
head_description: "Przenieś strony w dokumencie EPUB w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś EPUB strony w C#"
description: "Przenieś strony EPUB za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików EPUB do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku EPUB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść EPUB strony pliku za pomocą C# przykładowego kodu">}}
