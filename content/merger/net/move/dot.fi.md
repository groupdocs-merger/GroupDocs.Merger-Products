...
############################# Head ############################
head_title: "Siirrä DOT sivua C#"
head_description: "Siirrä DOT-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOT sivua C#"
description: "Siirrä DOT sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja DOT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOT tiedostosivua käyttämällä C# esimerkkikoodia">}}
