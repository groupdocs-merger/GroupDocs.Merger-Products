...
############################# Head ############################
head_title: "Move XLSX Pages in C#"
head_description: "Move pages within a XLSX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLSX Pages In C#"
description: "Move XLSX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSX file pages using C# example code">}}
