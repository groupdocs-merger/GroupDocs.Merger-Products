...
############################# Head ############################
head_title: "Przenieś VSTM strony w C#"
head_description: "Przenieś strony w dokumencie VSTM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VSTM strony w C#"
description: "Przenieś strony VSTM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VSTM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku VSTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VSTM strony pliku za pomocą C# przykładowego kodu">}}
