...
############################# Head ############################
head_title: "نقل صفحات VSTX في C#"
head_description: "انقل الصفحات داخل مستند VSTX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSTX في C#"
description: "انقل صفحات VSTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSTX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSTX باستخدام كود مثال C#">}}
