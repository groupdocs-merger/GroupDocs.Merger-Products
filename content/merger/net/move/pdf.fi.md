...
############################# Head ############################
head_title: "Siirrä PDF sivua C#"
head_description: "Siirrä PDF-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PDF sivua C#"
description: "Siirrä PDF sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PDF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja PDF-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PDF tiedostosivua käyttämällä C# esimerkkikoodia">}}
