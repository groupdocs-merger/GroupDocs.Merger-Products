...
############################# Head ############################
head_title: "Flytt ODP sider i C#"
head_description: "Flytt sider i et ODP-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ODP sider i C#"
description: "Flytt ODP sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en ODP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ODP filsider ved hjelp av C# eksempelkode">}}
