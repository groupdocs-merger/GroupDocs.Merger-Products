...
############################# Head ############################
head_title: "Siirrä XLSB sivua C#"
head_description: "Siirrä XLSB-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLSB sivua C#"
description: "Siirrä XLSB sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLSB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja XLSB-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLSB tiedostosivua käyttämällä C# esimerkkikoodia">}}
