...
############################# Head ############################
head_title: "Rûpelên VSTX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VSTX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VSTX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSTX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VSTX bar dike">}}
