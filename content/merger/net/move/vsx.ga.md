...
############################# Head ############################
head_title: "Bog VSX Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad VSX in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog VSX Leathanaigh I C#"
description: "Bog VSX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog VSX Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad VSX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSX leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
