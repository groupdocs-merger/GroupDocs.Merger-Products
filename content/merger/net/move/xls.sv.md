...
############################# Head ############################
head_title: "Flytta XLS sidor i C#"
head_description: "Flytta sidor i ett XLS-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLS sidor i C#"
description: "Flytta XLS sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLS filsidor med hjälp av C# exempelkod">}}
