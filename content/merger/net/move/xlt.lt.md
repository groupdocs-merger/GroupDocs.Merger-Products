...
############################# Head ############################
head_title: "Perkelti XLT puslapius C#"
head_description: "Perkelkite puslapius XLT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLT puslapius C#"
description: "Perkelkite XLT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLT failo puslapius naudojant C# pavyzdinį kodą">}}
