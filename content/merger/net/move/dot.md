...
############################# Head ############################
head_title: "Move DOT Pages in C#"
head_description: "Move pages within a DOT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move DOT Pages In C#"
description: "Move DOT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move DOT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a DOT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOT file pages using C# example code">}}
