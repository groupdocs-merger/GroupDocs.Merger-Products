...
############################# Head ############################
head_title: "Skuif VTX bladsye in C#"
head_description: "Skuif bladsye binne 'n VTX dokument in C# na enige posisie deur die dokumente samesmelting API te gebruik."

############################# Header ############################
title: "Skuif VTX bladsye in C#"
description: "Skuif VTX bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Skuif VTX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n VTX-lêer te skuif deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX lêerbladsye te skuif deur C# voorbeeldkode te gebruik">}}
