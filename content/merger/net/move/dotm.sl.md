...
############################# Head ############################
head_title: "Premakni DOTM strani v C#"
head_description: "Premaknite strani znotraj dokumenta DOTM v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni DOTM strani v C#"
description: "Premaknite strani DOTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke DOTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke DOTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke DOTM s primerom kode C#">}}
