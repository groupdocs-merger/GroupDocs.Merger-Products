...
############################# Head ############################
head_title: "Pindahkan PDF Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen PDF di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PDF Halaman Di C#"
description: "Pindahkan Halaman PDF dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan PDF Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file PDF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PDF menggunakan kode contoh C#">}}
