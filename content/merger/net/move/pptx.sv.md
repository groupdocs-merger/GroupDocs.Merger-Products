...
############################# Head ############################
head_title: "Flytta PPTX sidor i C#"
head_description: "Flytta sidor i ett PPTX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPTX sidor i C#"
description: "Flytta PPTX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta PPTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en PPTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPTX filsidor med hjälp av C# exempelkod">}}
