...
############################# Head ############################
head_title: "Di chuyển HTML Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu HTML trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển HTML Trang trong C#"
description: "Di chuyển các Trang HTML với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển HTML Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp HTML bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp HTML bằng mã mẫu C#">}}
