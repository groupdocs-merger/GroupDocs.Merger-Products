...
############################# Head ############################
head_title: "DOC Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOC belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOC Sayfayı C# İçinde Taşı"
description: "DOC Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOC Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOC dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosya sayfaları nasıl taşınır">}}
