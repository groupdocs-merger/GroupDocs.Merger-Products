...
############################# Head ############################
head_title: "VSX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSX oldal mozgatása a C# nyelven"
description: "Mozgasson át VSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX fájloldalak mozgatása a C# példakóddal">}}
