...
############################# Head ############################
head_title: "XLS бетті C# ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы XLS құжатының беттерін C# ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "XLS бетті C# ішінде жылжыту"
description: "XLS беттерді .NET кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "XLS файл бетін .NET ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы XLS файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS файл беттерін C# мысал кодын пайдаланып жылжыту жолы">}}
