...
############################# Head ############################
head_title: "Perkelti XLTX puslapius C#"
head_description: "Perkelkite puslapius XLTX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLTX puslapius C#"
description: "Perkelkite XLTX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLTX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLTX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLTX failo puslapius naudojant C# pavyzdinį kodą">}}
