...
############################# Head ############################
head_title: "نقل صفحات VSDM في C#"
head_description: "انقل الصفحات داخل مستند VSDM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSDM في C#"
description: "انقل صفحات VSDM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSDM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSDM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSDM باستخدام كود مثال C#">}}
