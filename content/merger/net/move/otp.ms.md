...
############################# Head ############################
head_title: "Alihkan OTP Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen OTP dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan OTP Halaman Dalam C#"
description: "Alihkan OTP Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan OTP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail OTP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan OTP halaman fail menggunakan kod contoh C#.">}}
