...
############################# Head ############################
head_title: "Mover VSDX Páginas em C#"
head_description: "Mova as páginas em um documento VSDX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSDX Páginas em C#"
description: "Mova VSDX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSDX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VSDX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSDX usando o código de exemplo C#">}}
