...
############################# Head ############################
head_title: "Mover PPT Páginas em C#"
head_description: "Mova as páginas em um documento PPT em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PPT Páginas em C#"
description: "Mova PPT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PPT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo PPT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PPT usando o código de exemplo C#">}}
