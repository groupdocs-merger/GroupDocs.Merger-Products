...
############################# Head ############################
head_title: "Flytt ONE sider i C#"
head_description: "Flytt sider i et ONE-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt ONE sider i C#"
description: "Flytt ONE sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en ONE-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte ONE filsider ved hjelp av C# eksempelkode">}}
