...
############################# Head ############################
head_title: "Færa VSDM síður í C#"
head_description: "Færðu síður innan VSDM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSDM síður í C#"
description: "Færðu VSDM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSDM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSDM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSDM skráarsíður með því að nota C# dæmikóða">}}
