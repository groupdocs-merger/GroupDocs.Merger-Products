...
############################# Head ############################
head_title: "Færa XPS síður í C#"
head_description: "Færðu síður innan XPS skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XPS síður í C#"
description: "Færðu XPS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XPS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XPS skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XPS skráarsíður með því að nota C# dæmikóða">}}
