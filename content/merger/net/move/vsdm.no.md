...
############################# Head ############################
head_title: "Flytt VSDM sider i C#"
head_description: "Flytt sider i et VSDM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSDM sider i C#"
description: "Flytt VSDM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSDM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSDM filsider ved hjelp av C# eksempelkode">}}
