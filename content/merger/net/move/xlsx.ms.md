...
############################# Head ############################
head_title: "Alihkan XLSX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLSX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLSX Halaman Dalam C#"
description: "Alihkan XLSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLSX halaman fail menggunakan kod contoh C#.">}}
