...
############################# Head ############################
head_title: "Rûpelên XLSX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLSX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLSX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLSX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XLSX bar dike">}}
