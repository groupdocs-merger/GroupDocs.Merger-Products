...
############################# Head ############################
head_title: "Mover VSTX Páginas em C#"
head_description: "Mova as páginas em um documento VSTX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSTX Páginas em C#"
description: "Mova VSTX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VSTX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSTX usando o código de exemplo C#">}}
