...
############################# Head ############################
head_title: "Move EXCEL pages in .NET"
head_description: "Use GroupDocs.Merger for .NET to effortlessly reorder pages in EXCEL documents. Process PDF, Word, Excel, PowerPoint, images, and more with ease."

############################# Header ############################
title: "Move pages in EXCEL" 
description: "GroupDocs.Merger for .NET enables .NET applications to easily reorder pages in EXCEL documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to move selected pages in EXCEL documents. Enhance your .NET applications with advanced document processing features.
