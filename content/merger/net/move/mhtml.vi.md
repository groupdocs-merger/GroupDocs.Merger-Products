...
############################# Head ############################
head_title: "Di chuyển MHTML Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu MHTML trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển MHTML Trang trong C#"
description: "Di chuyển các Trang MHTML với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển MHTML Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp MHTML bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp MHTML bằng mã mẫu C#">}}
