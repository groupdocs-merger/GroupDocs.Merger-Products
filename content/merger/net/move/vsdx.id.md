...
############################# Head ############################
head_title: "Pindahkan VSDX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSDX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSDX Halaman Di C#"
description: "Pindahkan Halaman VSDX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSDX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSDX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSDX menggunakan kode contoh C#">}}
