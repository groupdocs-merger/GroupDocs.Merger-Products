...
############################# Head ############################
head_title: "Flytt XLTX sider i C#"
head_description: "Flytt sider i et XLTX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLTX sider i C#"
description: "Flytt XLTX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLTX filsider ved hjelp av C# eksempelkode">}}
