...
############################# Head ############################
head_title: "نقل صفحات RTF في C#"
head_description: "انقل الصفحات داخل مستند RTF في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات RTF في C#"
description: "انقل صفحات RTF ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل RTF صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف RTF من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف RTF باستخدام كود مثال C#">}}
