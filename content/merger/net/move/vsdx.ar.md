...
############################# Head ############################
head_title: "نقل صفحات VSDX في C#"
head_description: "انقل الصفحات داخل مستند VSDX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSDX في C#"
description: "انقل صفحات VSDX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSDX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSDX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSDX باستخدام كود مثال C#">}}
