...
############################# Head ############################
head_title: "Flytt XLSM sider i C#"
head_description: "Flytt sider i et XLSM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLSM sider i C#"
description: "Flytt XLSM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLSM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLSM filsider ved hjelp av C# eksempelkode">}}
