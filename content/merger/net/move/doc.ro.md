...
############################# Head ############################
head_title: "Mutați DOC pagini în C#"
head_description: "Mutați paginile dintr-un document DOC în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOC pagini în C#"
description: "Mutați DOC pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOC pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOC prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOC utilizând codul exemplu C#">}}
