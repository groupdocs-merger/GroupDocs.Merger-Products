...
############################# Head ############################
head_title: "نقل صفحات PPTX في C#"
head_description: "انقل الصفحات داخل مستند PPTX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPTX في C#"
description: "انقل صفحات PPTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل PPTX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف PPTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPTX باستخدام كود مثال C#">}}
