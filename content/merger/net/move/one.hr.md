...
############################# Head ############################
head_title: "Premjesti ONE stranice u C#"
head_description: "Premjestite stranice unutar ONE dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ONE stranice u C#"
description: "Premjesti ONE stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti ONE stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar ONE datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ONE stranice datoteke koristeći C# primjer koda">}}
