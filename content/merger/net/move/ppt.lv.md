...
############################# Head ############################
head_title: "Pārvietot PPT lapas programmā C#"
head_description: "Pārvietojiet lapas PPT dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPT lapas programmā C#"
description: "Pārvietojiet PPT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas PPT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPT faila lapas, izmantojot C# piemēra kodu">}}
