...
############################# Head ############################
head_title: "Færa ONE síður í C#"
head_description: "Færðu síður innan ONE skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa ONE síður í C#"
description: "Færðu ONE síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa ONE skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í ONE skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa ONE skráarsíður með því að nota C# dæmikóða">}}
