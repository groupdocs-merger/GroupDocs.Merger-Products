...
############################# Head ############################
head_title: "Pindahkan WEB Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen WEB di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WEB Halaman Di C#"
description: "Pindahkan Halaman WEB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan WEB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file WEB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WEB menggunakan kode contoh C#">}}
