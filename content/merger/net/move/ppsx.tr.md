...
############################# Head ############################
head_title: "PPSX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir PPSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPSX Sayfayı C# İçinde Taşı"
description: "PPSX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPSX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir PPSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPSX dosya sayfaları nasıl taşınır">}}
