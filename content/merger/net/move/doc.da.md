...
############################# Head ############################
head_title: "Flyt DOC sider i C#"
head_description: "Flyt sider i et DOC-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOC sider i C#"
description: "Flyt DOC sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOC-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOC filsider ved hjælp af C# eksempelkode">}}
