...
############################# Head ############################
head_title: "XLTX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XLTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLTX Sayfayı C# İçinde Taşı"
description: "XLTX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLTX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XLTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTX dosya sayfaları nasıl taşınır">}}
