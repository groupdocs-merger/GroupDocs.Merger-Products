...
############################# Head ############################
head_title: "Flytt VDX sider i C#"
head_description: "Flytt sider i et VDX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VDX sider i C#"
description: "Flytt VDX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VDX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VDX filsider ved hjelp av C# eksempelkode">}}
