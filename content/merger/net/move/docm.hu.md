...
############################# Head ############################
head_title: "DOCM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOCM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCM oldal mozgatása a C# nyelven"
description: "Mozgasson át DOCM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOCM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOCM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCM fájloldalak mozgatása a C# példakóddal">}}
