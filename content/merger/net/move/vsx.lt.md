...
############################# Head ############################
head_title: "Perkelti VSX puslapius C#"
head_description: "Perkelkite puslapius VSX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSX puslapius C#"
description: "Perkelkite VSX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSX failo puslapius naudojant C# pavyzdinį kodą">}}
