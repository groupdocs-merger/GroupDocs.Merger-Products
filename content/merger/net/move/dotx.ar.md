...
############################# Head ############################
head_title: "نقل صفحات DOTX في C#"
head_description: "انقل الصفحات داخل مستند DOTX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOTX في C#"
description: "انقل صفحات DOTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOTX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOTX باستخدام كود مثال C#">}}
