...
############################# Head ############################
head_title: "Premjesti DOC stranice u C#"
head_description: "Premjestite stranice unutar DOC dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOC stranice u C#"
description: "Premjesti DOC stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti DOC stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar DOC datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOC stranice datoteke koristeći C# primjer koda">}}
