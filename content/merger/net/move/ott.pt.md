...
############################# Head ############################
head_title: "Mover OTT Páginas em C#"
head_description: "Mova as páginas em um documento OTT em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover OTT Páginas em C#"
description: "Mova OTT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo OTT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo OTT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo OTT usando o código de exemplo C#">}}
