...
############################# Head ############################
head_title: "Rûpelên DOCM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek DOCM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên DOCM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê DOCM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê DOCM bar dike">}}
