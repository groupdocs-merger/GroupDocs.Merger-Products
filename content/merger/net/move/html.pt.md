...
############################# Head ############################
head_title: "Mover páginas de HTML em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos HTML de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em HTML" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos HTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos HTML. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
