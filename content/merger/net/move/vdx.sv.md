...
############################# Head ############################
head_title: "Flytta VDX sidor i C#"
head_description: "Flytta sidor i ett VDX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VDX sidor i C#"
description: "Flytta VDX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VDX filsidor med hjälp av C# exempelkod">}}
