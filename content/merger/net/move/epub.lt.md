...
############################# Head ############################
head_title: "Perkelti EPUB puslapius C#"
head_description: "Perkelkite puslapius EPUB dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti EPUB puslapius C#"
description: "Perkelkite EPUB puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti EPUB failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius EPUB faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti EPUB failo puslapius naudojant C# pavyzdinį kodą">}}
