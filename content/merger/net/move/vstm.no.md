...
############################# Head ############################
head_title: "Flytt VSTM sider i C#"
head_description: "Flytt sider i et VSTM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSTM sider i C#"
description: "Flytt VSTM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSTM filsider ved hjelp av C# eksempelkode">}}
