...
############################# Head ############################
head_title: "نقل صفحات XPS في C#"
head_description: "انقل الصفحات داخل مستند XPS في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XPS في C#"
description: "انقل صفحات XPS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XPS صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XPS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XPS باستخدام كود مثال C#">}}
