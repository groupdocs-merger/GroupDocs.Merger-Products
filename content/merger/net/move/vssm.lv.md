...
############################# Head ############################
head_title: "Pārvietot VSSM lapas programmā C#"
head_description: "Pārvietojiet lapas VSSM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSSM lapas programmā C#"
description: "Pārvietojiet VSSM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSSM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSSM faila lapas, izmantojot C# piemēra kodu">}}
