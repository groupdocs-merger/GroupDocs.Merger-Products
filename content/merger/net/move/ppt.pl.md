...
############################# Head ############################
head_title: "Przenieś PPT strony w C#"
head_description: "Przenieś strony w dokumencie PPT w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś PPT strony w C#"
description: "Przenieś strony PPT za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików PPT do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku PPT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść PPT strony pliku za pomocą C# przykładowego kodu">}}
