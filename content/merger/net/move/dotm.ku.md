...
############################# Head ############################
head_title: "Rûpelên DOTM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek DOTM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên DOTM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê DOTM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê DOTM bar dike">}}
