...
############################# Head ############################
head_title: "Flytta XPS sidor i C#"
head_description: "Flytta sidor i ett XPS-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XPS sidor i C#"
description: "Flytta XPS sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XPS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XPS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XPS filsidor med hjälp av C# exempelkod">}}
