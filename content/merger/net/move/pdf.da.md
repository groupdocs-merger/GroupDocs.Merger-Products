...
############################# Head ############################
head_title: "Flyt PDF sider i C#"
head_description: "Flyt sider i et PDF-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PDF sider i C#"
description: "Flyt PDF sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en PDF-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PDF filsider ved hjælp af C# eksempelkode">}}
