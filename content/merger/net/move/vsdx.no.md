...
############################# Head ############################
head_title: "Flytt VSDX sider i C#"
head_description: "Flytt sider i et VSDX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSDX sider i C#"
description: "Flytt VSDX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSDX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSDX filsider ved hjelp av C# eksempelkode">}}
