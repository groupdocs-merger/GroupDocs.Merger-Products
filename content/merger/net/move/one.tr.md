...
############################# Head ############################
head_title: "ONE Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir ONE belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "ONE Sayfayı C# İçinde Taşı"
description: "ONE Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "ONE Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir ONE dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosya sayfaları nasıl taşınır">}}
