...
############################# Head ############################
head_title: "نقل صفحات HTML في C#"
head_description: "انقل الصفحات داخل مستند HTML في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات HTML في C#"
description: "انقل صفحات HTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل HTML صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف HTML من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف HTML باستخدام كود مثال C#">}}
