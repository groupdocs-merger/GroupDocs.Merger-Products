...
############################# Head ############################
head_title: "VSTM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSTM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSTM Sayfayı C# İçinde Taşı"
description: "VSTM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSTM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSTM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosya sayfaları nasıl taşınır">}}
