...
############################# Head ############################
head_title: "Pārvietot ODP lapas programmā C#"
head_description: "Pārvietojiet lapas ODP dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot ODP lapas programmā C#"
description: "Pārvietojiet ODP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot ODP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas ODP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot ODP faila lapas, izmantojot C# piemēra kodu">}}
