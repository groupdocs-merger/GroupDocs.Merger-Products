...
############################# Head ############################
head_title: "Pārvietot DOC lapas programmā C#"
head_description: "Pārvietojiet lapas DOC dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOC lapas programmā C#"
description: "Pārvietojiet DOC lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOC faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOC failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOC faila lapas, izmantojot C# piemēra kodu">}}
