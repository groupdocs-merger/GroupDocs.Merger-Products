...
############################# Head ############################
head_title: "Pārvietot HTML lapas programmā C#"
head_description: "Pārvietojiet lapas HTML dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot HTML lapas programmā C#"
description: "Pārvietojiet HTML lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot HTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas HTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot HTML faila lapas, izmantojot C# piemēra kodu">}}
