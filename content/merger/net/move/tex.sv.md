...
############################# Head ############################
head_title: "Flytta TEX sidor i C#"
head_description: "Flytta sidor i ett TEX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta TEX sidor i C#"
description: "Flytta TEX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta TEX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en TEX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar TEX filsidor med hjälp av C# exempelkod">}}
