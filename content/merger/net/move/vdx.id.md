...
############################# Head ############################
head_title: "Pindahkan VDX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VDX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VDX Halaman Di C#"
description: "Pindahkan Halaman VDX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VDX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VDX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VDX menggunakan kode contoh C#">}}
