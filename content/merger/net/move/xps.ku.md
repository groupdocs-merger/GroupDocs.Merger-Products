...
############################# Head ############################
head_title: "Rûpelên XPS di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XPS ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XPS Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XPS biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XPS bar dike">}}
