...
############################# Head ############################
head_title: "Rûpelên VSSM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VSSM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VSSM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSSM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VSSM bar dike">}}
