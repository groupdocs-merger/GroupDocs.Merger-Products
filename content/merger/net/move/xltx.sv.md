...
############################# Head ############################
head_title: "Flytta XLTX sidor i C#"
head_description: "Flytta sidor i ett XLTX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLTX sidor i C#"
description: "Flytta XLTX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLTX filsidor med hjälp av C# exempelkod">}}
