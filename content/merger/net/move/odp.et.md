...
############################# Head ############################
head_title: "Teisalda ODP lehte teenuses C#"
head_description: "Teisaldage dokumendi ODP lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ODP lehte rakenduses C#"
description: "Teisaldage ODP lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ODP faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis ODP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ODP faililehte, kasutades C# näitekoodi">}}
