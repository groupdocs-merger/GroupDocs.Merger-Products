...
############################# Head ############################
head_title: "Færa RTF síður í C#"
head_description: "Færðu síður innan RTF skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa RTF síður í C#"
description: "Færðu RTF síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa RTF skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í RTF skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa RTF skráarsíður með því að nota C# dæmikóða">}}
