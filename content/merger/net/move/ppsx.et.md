...
############################# Head ############################
head_title: "Teisalda PPSX lehte teenuses C#"
head_description: "Teisaldage dokumendi PPSX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPSX lehte rakenduses C#"
description: "Teisaldage PPSX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis PPSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPSX faililehte, kasutades C# näitekoodi">}}
