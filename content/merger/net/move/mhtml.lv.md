...
############################# Head ############################
head_title: "Pārvietot MHTML lapas programmā C#"
head_description: "Pārvietojiet lapas MHTML dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot MHTML lapas programmā C#"
description: "Pārvietojiet MHTML lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot MHTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas MHTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot MHTML faila lapas, izmantojot C# piemēra kodu">}}
