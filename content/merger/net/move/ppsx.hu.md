...
############################# Head ############################
head_title: "PPSX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy PPSX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPSX oldal mozgatása a C# nyelven"
description: "Mozgasson át PPSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPSX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy PPSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájloldalak mozgatása a C# példakóddal">}}
