...
############################# Head ############################
head_title: "Flyt ODP sider i C#"
head_description: "Flyt sider i et ODP-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt ODP sider i C#"
description: "Flyt ODP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en ODP-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes ODP filsider ved hjælp af C# eksempelkode">}}
