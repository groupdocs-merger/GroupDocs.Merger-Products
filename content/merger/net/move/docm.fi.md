...
############################# Head ############################
head_title: "Siirrä DOCM sivua C#"
head_description: "Siirrä DOCM-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä DOCM sivua C#"
description: "Siirrä DOCM sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä DOCM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja DOCM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää DOCM tiedostosivua käyttämällä C# esimerkkikoodia">}}
