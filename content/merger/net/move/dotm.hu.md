...
############################# Head ############################
head_title: "DOTM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOTM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTM oldal mozgatása a C# nyelven"
description: "Mozgasson át DOTM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOTM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM fájloldalak mozgatása a C# példakóddal">}}
