...
############################# Head ############################
head_title: "Perkelti OTT puslapius C#"
head_description: "Perkelkite puslapius OTT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti OTT puslapius C#"
description: "Perkelkite OTT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti OTT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius OTT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti OTT failo puslapius naudojant C# pavyzdinį kodą">}}
