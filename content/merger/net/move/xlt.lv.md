...
############################# Head ############################
head_title: "Pārvietot XLT lapas programmā C#"
head_description: "Pārvietojiet lapas XLT dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLT lapas programmā C#"
description: "Pārvietojiet XLT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLT faila lapas, izmantojot C# piemēra kodu">}}
