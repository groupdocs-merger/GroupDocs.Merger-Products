...
############################# Head ############################
head_title: "Move HTML Pages in C#"
head_description: "Move pages within a HTML document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move HTML Pages In C#"
description: "Move HTML Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move HTML File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a HTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move HTML file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move HTML Pages Online"
    content: |
       Move HTML file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/html) website.
