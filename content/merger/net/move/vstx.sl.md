...
############################# Head ############################
head_title: "Premakni VSTX strani v C#"
head_description: "Premaknite strani znotraj dokumenta VSTX v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSTX strani v C#"
description: "Premaknite strani VSTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke VSTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSTX s primerom kode C#">}}
