...
############################# Head ############################
head_title: "Færa PPT síður í C#"
head_description: "Færðu síður innan PPT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPT síður í C#"
description: "Færðu PPT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa PPT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í PPT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPT skráarsíður með því að nota C# dæmikóða">}}
