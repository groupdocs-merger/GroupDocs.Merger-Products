...
############################# Head ############################
head_title: "MHTML oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy MHTML dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHTML oldal mozgatása a C# nyelven"
description: "Mozgasson át MHTML oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "MHTML fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy MHTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="MHTML fájloldalak mozgatása a C# példakóddal">}}
