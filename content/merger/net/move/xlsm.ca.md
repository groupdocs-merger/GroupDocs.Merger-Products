...
############################# Head ############################
head_title: "Mou XLSM pàgines a C#"
head_description: "Mou les pàgines d'un document XLSM a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou XLSM pàgines a C#"
description: "Mou XLSM pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou XLSM pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer XLSM implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers XLSM utilitzant el codi d'exemple C#">}}
