...
############################# Head ############################
head_title: "Premjesti ODP stranice u C#"
head_description: "Premjestite stranice unutar ODP dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti ODP stranice u C#"
description: "Premjesti ODP stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti ODP stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar ODP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti ODP stranice datoteke koristeći C# primjer koda">}}
