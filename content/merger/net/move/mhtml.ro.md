...
############################# Head ############################
head_title: "Mutați MHTML pagini în C#"
head_description: "Mutați paginile dintr-un document MHTML în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați MHTML pagini în C#"
description: "Mutați MHTML pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați MHTML pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier MHTML prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere MHTML utilizând codul exemplu C#">}}
