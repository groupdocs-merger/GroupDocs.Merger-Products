...
############################# Head ############################
head_title: "Przenieś VSDM strony w C#"
head_description: "Przenieś strony w dokumencie VSDM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VSDM strony w C#"
description: "Przenieś strony VSDM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VSDM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku VSDM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VSDM strony pliku za pomocą C# przykładowego kodu">}}
