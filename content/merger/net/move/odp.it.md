...
############################# Head ############################
head_title: "Sposta ODP pagine in C#"
head_description: "Sposta le pagine all'interno di un documento ODP in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta ODP pagine in C#"
description: "Sposta ODP pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta ODP pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file ODP implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file ODP utilizzando il codice di esempio C#">}}
