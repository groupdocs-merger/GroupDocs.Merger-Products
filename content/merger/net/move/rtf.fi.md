...
############################# Head ############################
head_title: "Siirrä RTF sivua C#"
head_description: "Siirrä RTF-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä RTF sivua C#"
description: "Siirrä RTF sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä RTF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja RTF-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää RTF tiedostosivua käyttämällä C# esimerkkikoodia">}}
