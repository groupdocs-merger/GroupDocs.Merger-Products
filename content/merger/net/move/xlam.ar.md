...
############################# Head ############################
head_title: "نقل صفحات XLAM في C#"
head_description: "انقل الصفحات داخل مستند XLAM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLAM في C#"
description: "انقل صفحات XLAM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLAM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLAM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLAM باستخدام كود مثال C#">}}
