...
############################# Head ############################
head_title: "Siirrä VSDX sivua C#"
head_description: "Siirrä VSDX-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VSDX sivua C#"
description: "Siirrä VSDX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VSDX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja VSDX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VSDX tiedostosivua käyttämällä C# esimerkkikoodia">}}
