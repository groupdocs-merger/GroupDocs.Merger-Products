...
############################# Head ############################
head_title: "PPS Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir PPS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPS Sayfayı C# İçinde Taşı"
description: "PPS Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPS Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir PPS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPS dosya sayfaları nasıl taşınır">}}
