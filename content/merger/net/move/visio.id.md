...
############################# Head ############################
head_title: "Pindahkan VISIO Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VISIO di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VISIO Halaman Di C#"
description: "Pindahkan Halaman VISIO dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VISIO Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VISIO dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VISIO menggunakan kode contoh C#">}}
