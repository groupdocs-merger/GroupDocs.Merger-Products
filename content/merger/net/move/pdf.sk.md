...
############################# Head ############################
head_title: "Presunúť PDF stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu PDF v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť PDF stránok do C#"
description: "Presuňte PDF stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť PDF strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru PDF implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru PDF pomocou vzorového kódu C#">}}
