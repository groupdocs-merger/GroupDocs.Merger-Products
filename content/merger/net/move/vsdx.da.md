...
############################# Head ############################
head_title: "Flyt VSDX sider i C#"
head_description: "Flyt sider i et VSDX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSDX sider i C#"
description: "Flyt VSDX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSDX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSDX filsider ved hjælp af C# eksempelkode">}}
