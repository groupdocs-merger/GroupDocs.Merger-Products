...
############################# Head ############################
head_title: "Rûpelên EPUB di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek EPUB ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên EPUB Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê EPUB biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê EPUB bar dike">}}
