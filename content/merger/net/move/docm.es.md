...
############################# Head ############################
head_title: "Mover DOCM páginas en C#"
head_description: "Mueva páginas dentro de un documento DOCM en C# a cualquier posición usando la API de fusión de documentos."

############################# Header ############################
title: "Mover DOCM páginas en C#"
description: "Mueva DOCM páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Mover DOCM páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# mover páginas dentro de un archivo DOCM mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo mover páginas de archivos DOCM usando el código de ejemplo C#">}}
