...
############################# Head ############################
head_title: "Siirrä ONE sivua C#"
head_description: "Siirrä ONE-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ONE sivua C#"
description: "Siirrä ONE sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ONE tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja ONE-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ONE tiedostosivua käyttämällä C# esimerkkikoodia">}}
