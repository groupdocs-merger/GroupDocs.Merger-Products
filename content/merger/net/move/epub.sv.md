...
############################# Head ############################
head_title: "Flytta EPUB sidor i C#"
head_description: "Flytta sidor i ett EPUB-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta EPUB sidor i C#"
description: "Flytta EPUB sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta EPUB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en EPUB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar EPUB filsidor med hjälp av C# exempelkod">}}
