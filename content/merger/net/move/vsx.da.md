...
############################# Head ############################
head_title: "Flyt VSX sider i C#"
head_description: "Flyt sider i et VSX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSX sider i C#"
description: "Flyt VSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSX filsider ved hjælp af C# eksempelkode">}}
