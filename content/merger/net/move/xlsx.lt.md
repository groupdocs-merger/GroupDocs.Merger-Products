...
############################# Head ############################
head_title: "Perkelti XLSX puslapius C#"
head_description: "Perkelkite puslapius XLSX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XLSX puslapius C#"
description: "Perkelkite XLSX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XLSX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XLSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XLSX failo puslapius naudojant C# pavyzdinį kodą">}}
