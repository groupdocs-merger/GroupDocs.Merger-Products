...
############################# Head ############################
head_title: "Sposta XLAM pagine in C#"
head_description: "Sposta le pagine all'interno di un documento XLAM in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta XLAM pagine in C#"
description: "Sposta XLAM pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta XLAM pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file XLAM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file XLAM utilizzando il codice di esempio C#">}}
