...
############################# Head ############################
head_title: "Siirrä XLAM sivua C#"
head_description: "Siirrä XLAM-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLAM sivua C#"
description: "Siirrä XLAM sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLAM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja XLAM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLAM tiedostosivua käyttämällä C# esimerkkikoodia">}}
