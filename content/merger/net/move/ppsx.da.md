...
############################# Head ############################
head_title: "Flyt PPSX sider i C#"
head_description: "Flyt sider i et PPSX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PPSX sider i C#"
description: "Flyt PPSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en PPSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PPSX filsider ved hjælp af C# eksempelkode">}}
