...
############################# Head ############################
head_title: "Mover DOTM Páginas em C#"
head_description: "Mova as páginas em um documento DOTM em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover DOTM Páginas em C#"
description: "Mova DOTM Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo DOTM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo DOTM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo DOTM usando o código de exemplo C#">}}
