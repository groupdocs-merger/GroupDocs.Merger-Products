...
############################# Head ############################
head_title: "Premjesti PPSX stranice u C#"
head_description: "Premjestite stranice unutar PPSX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti PPSX stranice u C#"
description: "Premjesti PPSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti PPSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar PPSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti PPSX stranice datoteke koristeći C# primjer koda">}}
