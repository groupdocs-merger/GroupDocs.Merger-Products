...
############################# Head ############################
head_title: "Mover PPS Páginas em C#"
head_description: "Mova as páginas em um documento PPS em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PPS Páginas em C#"
description: "Mova PPS Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PPS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo PPS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PPS usando o código de exemplo C#">}}
