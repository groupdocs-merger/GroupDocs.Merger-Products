...
############################# Head ############################
head_title: "Perkelti PPSX puslapius C#"
head_description: "Perkelkite puslapius PPSX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPSX puslapius C#"
description: "Perkelkite PPSX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPSX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius PPSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPSX failo puslapius naudojant C# pavyzdinį kodą">}}
