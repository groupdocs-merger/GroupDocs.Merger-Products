...
############################# Head ############################
head_title: "Flytta ODT sidor i C#"
head_description: "Flytta sidor i ett ODT-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ODT sidor i C#"
description: "Flytta ODT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta ODT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en ODT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ODT filsidor med hjälp av C# exempelkod">}}
