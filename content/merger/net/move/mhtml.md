...
############################# Head ############################
head_title: "Move MHTML Pages in C#"
head_description: "Move pages within a MHTML document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move MHTML Pages In C#"
description: "Move MHTML Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move MHTML File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a MHTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move MHTML file pages using C# example code">}}
