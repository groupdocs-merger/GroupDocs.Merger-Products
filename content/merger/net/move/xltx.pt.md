...
############################# Head ############################
head_title: "Mover XLTX Páginas em C#"
head_description: "Mova as páginas em um documento XLTX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLTX Páginas em C#"
description: "Mova XLTX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo XLTX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLTX usando o código de exemplo C#">}}
