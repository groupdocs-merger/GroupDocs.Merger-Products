...
############################# Head ############################
head_title: "Flytta DOTM sidor i C#"
head_description: "Flytta sidor i ett DOTM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOTM sidor i C#"
description: "Flytta DOTM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta DOTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en DOTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOTM filsidor med hjälp av C# exempelkod">}}
