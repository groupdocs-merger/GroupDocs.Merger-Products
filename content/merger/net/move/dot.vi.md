...
############################# Head ############################
head_title: "Di chuyển DOT Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu DOT trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển DOT Trang trong C#"
description: "Di chuyển các Trang DOT với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển DOT Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp DOT bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp DOT bằng mã mẫu C#">}}
