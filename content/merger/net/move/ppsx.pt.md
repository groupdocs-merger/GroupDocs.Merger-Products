...
############################# Head ############################
head_title: "Mover PPSX Páginas em C#"
head_description: "Mova as páginas em um documento PPSX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PPSX Páginas em C#"
description: "Mova PPSX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PPSX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo PPSX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PPSX usando o código de exemplo C#">}}
