...
############################# Head ############################
head_title: "Przenieś XLSX strony w C#"
head_description: "Przenieś strony w dokumencie XLSX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLSX strony w C#"
description: "Przenieś strony XLSX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLSX do .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLSX strony pliku za pomocą C# przykładowego kodu">}}
