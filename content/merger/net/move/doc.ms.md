...
############################# Head ############################
head_title: "Alihkan DOC Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOC dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOC Halaman Dalam C#"
description: "Alihkan DOC Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOC Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOC dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOC halaman fail menggunakan kod contoh C#.">}}
