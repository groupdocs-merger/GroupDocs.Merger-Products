...
############################# Head ############################
head_title: "Premakni RTF strani v C#"
head_description: "Premaknite strani znotraj dokumenta RTF v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni RTF strani v C#"
description: "Premaknite strani RTF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke RTF v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke RTF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke RTF s primerom kode C#">}}
