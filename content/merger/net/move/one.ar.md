...
############################# Head ############################
head_title: "نقل صفحات ONE في C#"
head_description: "انقل الصفحات داخل مستند ONE في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات ONE في C#"
description: "انقل صفحات ONE ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل ONE صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف ONE من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف ONE باستخدام كود مثال C#">}}
