...
############################# Head ############################
head_title: "Mou XLTX pàgines a C#"
head_description: "Mou les pàgines d'un document XLTX a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou XLTX pàgines a C#"
description: "Mou XLTX pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou XLTX pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer XLTX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers XLTX utilitzant el codi d'exemple C#">}}
