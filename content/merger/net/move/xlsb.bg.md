...
############################# Head ############################
head_title: "Преместете XLSB страници в C#"
head_description: "Преместете страници в XLSB документ в C# на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете XLSB страници в C#"
description: "Преместете XLSB страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Преместете XLSB файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да преместват страници в рамките на файл XLSB чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате XLSB файлови страници с помощта на C# примерен код">}}
