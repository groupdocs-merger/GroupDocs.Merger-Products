...
############################# Head ############################
head_title: "Przenieś DOCM strony w C#"
head_description: "Przenieś strony w dokumencie DOCM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś DOCM strony w C#"
description: "Przenieś strony DOCM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików DOCM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku DOCM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść DOCM strony pliku za pomocą C# przykładowego kodu">}}
