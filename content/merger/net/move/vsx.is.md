...
############################# Head ############################
head_title: "Færa VSX síður í C#"
head_description: "Færðu síður innan VSX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSX síður í C#"
description: "Færðu VSX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSX skráarsíður með því að nota C# dæmikóða">}}
