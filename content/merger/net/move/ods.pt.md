...
############################# Head ############################
head_title: "Mover ODS Páginas em C#"
head_description: "Mova as páginas em um documento ODS em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ODS Páginas em C#"
description: "Mova ODS Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ODS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo ODS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ODS usando o código de exemplo C#">}}
