...
############################# Head ############################
head_title: "Mover páginas de MHTML em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos MHTML de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em MHTML" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos MHTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos MHTML. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
