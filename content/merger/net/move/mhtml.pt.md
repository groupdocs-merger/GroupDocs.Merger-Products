...
############################# Head ############################
head_title: "Mover MHTML Páginas em C#"
head_description: "Mova as páginas em um documento MHTML em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover MHTML Páginas em C#"
description: "Mova MHTML Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo MHTML em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo MHTML implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo MHTML usando o código de exemplo C#">}}
