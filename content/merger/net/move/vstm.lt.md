...
############################# Head ############################
head_title: "Perkelti VSTM puslapius C#"
head_description: "Perkelkite puslapius VSTM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSTM puslapius C#"
description: "Perkelkite VSTM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSTM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSTM failo puslapius naudojant C# pavyzdinį kodą">}}
