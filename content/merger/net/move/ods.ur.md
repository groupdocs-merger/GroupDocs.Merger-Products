...
############################# Head ############################
head_title: "ODS صفحات کو C# میں منتقل کریں"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے C# میں ODS دستاویز کے اندر صفحات کو کسی بھی پوزیشن پر منتقل کریں۔"

############################# Header ############################
title: "ODS صفحات کو C# میں منتقل کریں"
description: ".NET کوڈ کی چند سطروں کے ساتھ ODS صفحات کو منتقل کریں۔"
...
steps:
    enable: true
    title_left: "ODS فائل صفحات کو .NET میں منتقل کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) کچھ آسان اقدامات کو لاگو کرکے C# ڈویلپرز کے لیے صفحات کو ODS فائل میں منتقل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے ODS فائل کے صفحات کو کیسے منتقل کریں۔">}}
