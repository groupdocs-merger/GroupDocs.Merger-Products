...
############################# Head ############################
head_title: "نقل صفحات XLSX في C#"
head_description: "انقل الصفحات داخل مستند XLSX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLSX في C#"
description: "انقل صفحات XLSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLSX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLSX باستخدام كود مثال C#">}}
