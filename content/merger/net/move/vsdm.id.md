...
############################# Head ############################
head_title: "Pindahkan VSDM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSDM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSDM Halaman Di C#"
description: "Pindahkan Halaman VSDM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSDM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSDM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSDM menggunakan kode contoh C#">}}
