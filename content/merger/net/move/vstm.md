...
############################# Head ############################
head_title: "Move VSTM Pages in C#"
head_description: "Move pages within a VSTM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSTM Pages In C#"
description: "Move VSTM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSTM file pages using C# example code">}}
