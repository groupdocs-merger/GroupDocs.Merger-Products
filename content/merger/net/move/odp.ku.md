...
############################# Head ############################
head_title: "Rûpelên ODP di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek ODP ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên ODP Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê ODP biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê ODP bar dike">}}
