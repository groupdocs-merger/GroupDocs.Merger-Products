...
############################# Head ############################
head_title: "Mover XLSB Páginas em C#"
head_description: "Mova as páginas em um documento XLSB em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLSB Páginas em C#"
description: "Mova XLSB Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLSB em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo XLSB implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLSB usando o código de exemplo C#">}}
