...
############################# Head ############################
head_title: "Flytt XLT sider i C#"
head_description: "Flytt sider i et XLT-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLT sider i C#"
description: "Flytt XLT sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLT filsider ved hjelp av C# eksempelkode">}}
