...
############################# Head ############################
head_title: "Flyt ONE sider i C#"
head_description: "Flyt sider i et ONE-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt ONE sider i C#"
description: "Flyt ONE sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en ONE-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes ONE filsider ved hjælp af C# eksempelkode">}}
