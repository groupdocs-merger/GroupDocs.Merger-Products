...
############################# Head ############################
head_title: "Verplaats DOTX pagina's in C#"
head_description: "Verplaats pagina's binnen een DOTX document in C# naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats DOTX pagina's in C#"
description: "Verplaats DOTX pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verplaats DOTX bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een DOTX bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTX bestandspagina's te verplaatsen met behulp van C# voorbeeldcode">}}
