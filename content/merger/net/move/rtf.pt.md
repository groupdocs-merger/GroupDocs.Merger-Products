...
############################# Head ############################
head_title: "Mover RTF Páginas em C#"
head_description: "Mova as páginas em um documento RTF em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover RTF Páginas em C#"
description: "Mova RTF Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo RTF em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo RTF implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo RTF usando o código de exemplo C#">}}
