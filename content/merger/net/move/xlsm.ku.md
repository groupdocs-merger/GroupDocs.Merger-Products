...
############################# Head ############################
head_title: "Rûpelên XLSM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLSM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLSM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLSM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XLSM bar dike">}}
