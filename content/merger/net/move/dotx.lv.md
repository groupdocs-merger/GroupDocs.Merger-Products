...
############################# Head ############################
head_title: "Pārvietot DOTX lapas programmā C#"
head_description: "Pārvietojiet lapas DOTX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOTX lapas programmā C#"
description: "Pārvietojiet DOTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOTX faila lapas, izmantojot C# piemēra kodu">}}
