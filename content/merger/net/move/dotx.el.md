...
############################# Head ############################
head_title: "Μετακίνηση DOTX σελίδων σε C#"
head_description: "Μετακινήστε σελίδες σε ένα έγγραφο DOTX στο C# σε οποιαδήποτε θέση χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Μετακίνηση DOTX σελίδων σε C#"
description: "Μετακινήστε DOTX σελίδες με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Μετακίνηση DOTX σελίδων αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να μετακινούν σελίδες μέσα σε ένα αρχείο DOTX εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να μετακινήσετε DOTX σελίδες αρχείου χρησιμοποιώντας παράδειγμα κώδικα C#">}}
