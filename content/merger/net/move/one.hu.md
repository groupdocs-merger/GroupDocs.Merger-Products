...
############################# Head ############################
head_title: "ONE oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy ONE dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ONE oldal mozgatása a C# nyelven"
description: "Mozgasson át ONE oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ONE fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy ONE fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE fájloldalak mozgatása a C# példakóddal">}}
