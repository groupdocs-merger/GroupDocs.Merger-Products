...
############################# Head ############################
head_title: "Pārvietot PPTX lapas programmā C#"
head_description: "Pārvietojiet lapas PPTX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPTX lapas programmā C#"
description: "Pārvietojiet PPTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas PPTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPTX faila lapas, izmantojot C# piemēra kodu">}}
