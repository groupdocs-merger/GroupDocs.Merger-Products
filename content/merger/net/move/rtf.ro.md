...
############################# Head ############################
head_title: "Mutați RTF pagini în C#"
head_description: "Mutați paginile dintr-un document RTF în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați RTF pagini în C#"
description: "Mutați RTF pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați RTF pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier RTF prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere RTF utilizând codul exemplu C#">}}
