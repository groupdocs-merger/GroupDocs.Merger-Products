...
############################# Head ############################
head_title: "Move WORKSHEET Pages in C#"
head_description: "Move pages within a WORKSHEET document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move WORKSHEET Pages In C#"
description: "Move WORKSHEET Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move WORKSHEET File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a WORKSHEET file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WORKSHEET file pages using C# example code">}}
