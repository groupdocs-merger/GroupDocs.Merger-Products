...
############################# Head ############################
head_title: "Pindahkan ODS Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen ODS di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ODS Halaman Di C#"
description: "Pindahkan Halaman ODS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan ODS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file ODS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ODS menggunakan kode contoh C#">}}
