...
############################# Head ############################
head_title: "Flytta VSX sidor i C#"
head_description: "Flytta sidor i ett VSX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSX sidor i C#"
description: "Flytta VSX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSX filsidor med hjälp av C# exempelkod">}}
