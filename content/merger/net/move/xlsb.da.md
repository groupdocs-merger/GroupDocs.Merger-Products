...
############################# Head ############################
head_title: "Flyt XLSB sider i C#"
head_description: "Flyt sider i et XLSB-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLSB sider i C#"
description: "Flyt XLSB sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLSB-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLSB filsider ved hjælp af C# eksempelkode">}}
