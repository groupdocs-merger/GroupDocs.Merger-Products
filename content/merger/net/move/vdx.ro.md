...
############################# Head ############################
head_title: "Mutați VDX pagini în C#"
head_description: "Mutați paginile dintr-un document VDX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VDX pagini în C#"
description: "Mutați VDX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VDX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VDX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VDX utilizând codul exemplu C#">}}
