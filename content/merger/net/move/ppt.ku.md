...
############################# Head ############################
head_title: "Rûpelên PPT di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek PPT ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PPT Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê PPT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê PPT bar dike">}}
