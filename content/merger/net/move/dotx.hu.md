...
############################# Head ############################
head_title: "DOTX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOTX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTX oldal mozgatása a C# nyelven"
description: "Mozgasson át DOTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOTX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájloldalak mozgatása a C# példakóddal">}}
