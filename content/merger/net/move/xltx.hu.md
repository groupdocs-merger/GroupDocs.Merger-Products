...
############################# Head ############################
head_title: "XLTX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XLTX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTX oldal mozgatása a C# nyelven"
description: "Mozgasson át XLTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLTX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XLTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájloldalak mozgatása a C# példakóddal">}}
