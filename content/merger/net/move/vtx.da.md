...
############################# Head ############################
head_title: "Flyt VTX sider i C#"
head_description: "Flyt sider i et VTX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VTX sider i C#"
description: "Flyt VTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VTX filsider ved hjælp af C# eksempelkode">}}
