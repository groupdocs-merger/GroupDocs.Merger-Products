...
############################# Head ############################
head_title: "Færa XLTM síður í C#"
head_description: "Færðu síður innan XLTM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLTM síður í C#"
description: "Færðu XLTM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLTM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLTM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLTM skráarsíður með því að nota C# dæmikóða">}}
