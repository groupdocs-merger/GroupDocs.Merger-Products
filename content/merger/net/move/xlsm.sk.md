...
############################# Head ############################
head_title: "Presunúť XLSM stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu XLSM v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLSM stránok do C#"
description: "Presuňte XLSM stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť XLSM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru XLSM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLSM pomocou vzorového kódu C#">}}
