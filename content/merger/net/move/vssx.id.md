...
############################# Head ############################
head_title: "Pindahkan VSSX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSSX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSSX Halaman Di C#"
description: "Pindahkan Halaman VSSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSSX menggunakan kode contoh C#">}}
