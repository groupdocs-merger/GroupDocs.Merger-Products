...
############################# Head ############################
head_title: "Pārvietot OTT lapas programmā C#"
head_description: "Pārvietojiet lapas OTT dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot OTT lapas programmā C#"
description: "Pārvietojiet OTT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot OTT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas OTT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot OTT faila lapas, izmantojot C# piemēra kodu">}}
