...
############################# Head ############################
head_title: "Flytt PPT sider i C#"
head_description: "Flytt sider i et PPT-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PPT sider i C#"
description: "Flytt PPT sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en PPT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PPT filsider ved hjelp av C# eksempelkode">}}
