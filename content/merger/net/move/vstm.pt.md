...
############################# Head ############################
head_title: "Mover VSTM Páginas em C#"
head_description: "Mova as páginas em um documento VSTM em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSTM Páginas em C#"
description: "Mova VSTM Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSTM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VSTM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSTM usando o código de exemplo C#">}}
