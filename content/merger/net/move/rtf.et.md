...
############################# Head ############################
head_title: "Teisalda RTF lehte teenuses C#"
head_description: "Teisaldage dokumendi RTF lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda RTF lehte rakenduses C#"
description: "Teisaldage RTF lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda RTF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis RTF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada RTF faililehte, kasutades C# näitekoodi">}}
