...
############################# Head ############################
head_title: "Move POWERPOINT pages in .NET"
head_description: "Use GroupDocs.Merger for .NET to effortlessly reorder pages in POWERPOINT documents. Process PDF, Word, Excel, PowerPoint, images, and more with ease."

############################# Header ############################
title: "Move pages in POWERPOINT" 
description: "GroupDocs.Merger for .NET enables .NET applications to easily reorder pages in POWERPOINT documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to move selected pages in POWERPOINT documents. Enhance your .NET applications with advanced document processing features.
