...
############################# Head ############################
head_title: "Teisalda VSTM lehte teenuses C#"
head_description: "Teisaldage dokumendi VSTM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSTM lehte rakenduses C#"
description: "Teisaldage VSTM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSTM faililehte, kasutades C# näitekoodi">}}
