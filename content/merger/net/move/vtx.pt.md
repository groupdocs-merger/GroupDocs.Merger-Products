...
############################# Head ############################
head_title: "Mover VTX Páginas em C#"
head_description: "Mova as páginas em um documento VTX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VTX Páginas em C#"
description: "Mova VTX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VTX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VTX usando o código de exemplo C#">}}
