...
############################# Head ############################
head_title: "C# で PPTX ページ移動"
head_description: "ドキュメント マージ API を使用して、C# 内の PPTX ドキュメント内のページを任意の位置に移動します。"

############################# Header ############################
title: "C# 内の PPTX ページを移動"
description: "数行の .NET コードで PPTX ページを移動します。"
...
steps:
    enable: true
    title_left: ".NET で PPTX ファイル ページを移動"
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) は、C# 開発者が PPTX ファイル内でページを簡単に移動できるようにするために、いくつかの簡単な手順を実装します。 .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# サンプル コードを使用して PPTX ファイル ページを移動する方法">}}
