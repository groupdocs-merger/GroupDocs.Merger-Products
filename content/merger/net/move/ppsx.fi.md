...
############################# Head ############################
head_title: "Siirrä PPSX sivua C#"
head_description: "Siirrä PPSX-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä PPSX sivua C#"
description: "Siirrä PPSX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä PPSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja PPSX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää PPSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
