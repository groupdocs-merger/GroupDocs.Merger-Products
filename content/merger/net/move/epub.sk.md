...
############################# Head ############################
head_title: "Presunúť EPUB stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu EPUB v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť EPUB stránok do C#"
description: "Presuňte EPUB stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť EPUB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru EPUB implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru EPUB pomocou vzorového kódu C#">}}
