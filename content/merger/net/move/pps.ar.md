...
############################# Head ############################
head_title: "نقل صفحات PPS في C#"
head_description: "انقل الصفحات داخل مستند PPS في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPS في C#"
description: "انقل صفحات PPS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل PPS صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف PPS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPS باستخدام كود مثال C#">}}
