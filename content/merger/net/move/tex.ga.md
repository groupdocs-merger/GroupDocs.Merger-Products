...
############################# Head ############################
head_title: "Bog TEX Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad TEX in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog TEX Leathanaigh I C#"
description: "Bog TEX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog TEX Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad TEX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas TEX leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
