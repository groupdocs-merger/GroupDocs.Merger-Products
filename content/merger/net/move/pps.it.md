...
############################# Head ############################
head_title: "Sposta PPS pagine in C#"
head_description: "Sposta le pagine all'interno di un documento PPS in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta PPS pagine in C#"
description: "Sposta PPS pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta PPS pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file PPS implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file PPS utilizzando il codice di esempio C#">}}
