...
############################# Head ############################
head_title: "نقل صفحات XLS في C#"
head_description: "انقل الصفحات داخل مستند XLS في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLS في C#"
description: "انقل صفحات XLS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLS صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLS باستخدام كود مثال C#">}}
