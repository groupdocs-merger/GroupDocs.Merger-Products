...
############################# Head ############################
head_title: "Flyt PPT sider i C#"
head_description: "Flyt sider i et PPT-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PPT sider i C#"
description: "Flyt PPT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en PPT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PPT filsider ved hjælp af C# eksempelkode">}}
