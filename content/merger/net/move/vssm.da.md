...
############################# Head ############################
head_title: "Flyt VSSM sider i C#"
head_description: "Flyt sider i et VSSM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSSM sider i C#"
description: "Flyt VSSM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSSM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSSM filsider ved hjælp af C# eksempelkode">}}
