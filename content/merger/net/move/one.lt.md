...
############################# Head ############################
head_title: "Perkelti ONE puslapius C#"
head_description: "Perkelkite puslapius ONE dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ONE puslapius C#"
description: "Perkelkite ONE puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ONE failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius ONE faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ONE failo puslapius naudojant C# pavyzdinį kodą">}}
