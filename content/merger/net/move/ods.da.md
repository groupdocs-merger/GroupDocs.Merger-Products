...
############################# Head ############################
head_title: "Flyt ODS sider i C#"
head_description: "Flyt sider i et ODS-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt ODS sider i C#"
description: "Flyt ODS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en ODS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes ODS filsider ved hjælp af C# eksempelkode">}}
