...
############################# Head ############################
head_title: "Flyt DOT sider i C#"
head_description: "Flyt sider i et DOT-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOT sider i C#"
description: "Flyt DOT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOT filsider ved hjælp af C# eksempelkode">}}
