...
############################# Head ############################
head_title: "Mover páginas de DOCX em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos DOCX de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em DOCX" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos DOCX."
...
steps:
    enable: true
    title: "Como mover páginas de DOCX"
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos DOCX. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
