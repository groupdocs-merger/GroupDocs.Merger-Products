...
############################# Head ############################
head_title: "Mover DOCX Páginas em C#"
head_description: "Mova as páginas em um documento DOCX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover DOCX Páginas em C#"
description: "Mova DOCX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo DOCX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo DOCX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo DOCX usando o código de exemplo C#">}}
