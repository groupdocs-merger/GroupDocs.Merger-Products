...
############################# Head ############################
head_title: "Presunúť XLS stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu XLS v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLS stránok do C#"
description: "Presuňte XLS stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť XLS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru XLS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLS pomocou vzorového kódu C#">}}
