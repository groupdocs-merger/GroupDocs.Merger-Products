...
############################# Head ############################
head_title: "Siirrä EPUB sivua C#"
head_description: "Siirrä EPUB-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä EPUB sivua C#"
description: "Siirrä EPUB sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä EPUB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja EPUB-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää EPUB tiedostosivua käyttämällä C# esimerkkikoodia">}}
