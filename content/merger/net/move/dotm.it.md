...
############################# Head ############################
head_title: "Sposta DOTM pagine in C#"
head_description: "Sposta le pagine all'interno di un documento DOTM in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta DOTM pagine in C#"
description: "Sposta DOTM pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta DOTM pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file DOTM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file DOTM utilizzando il codice di esempio C#">}}
