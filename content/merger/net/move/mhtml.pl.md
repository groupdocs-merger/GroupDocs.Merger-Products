...
############################# Head ############################
head_title: "Przenieś MHTML strony w C#"
head_description: "Przenieś strony w dokumencie MHTML w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś MHTML strony w C#"
description: "Przenieś strony MHTML za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików MHTML do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku MHTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść MHTML strony pliku za pomocą C# przykładowego kodu">}}
