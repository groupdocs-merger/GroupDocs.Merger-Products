...
############################# Head ############################
head_title: "DOC oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOC dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOC oldal mozgatása a C# nyelven"
description: "Mozgasson át DOC oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOC fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOC fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájloldalak mozgatása a C# példakóddal">}}
