...
############################# Head ############################
head_title: "Flytta XLT sidor i C#"
head_description: "Flytta sidor i ett XLT-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLT sidor i C#"
description: "Flytta XLT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLT filsidor med hjälp av C# exempelkod">}}
