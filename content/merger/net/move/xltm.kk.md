...
############################# Head ############################
head_title: "XLTM бетті C# ішінде жылжыту"
head_description: "Құжаттарды біріктіру API арқылы XLTM құжатының беттерін C# ішінде кез келген орынға жылжытыңыз."

############################# Header ############################
title: "XLTM бетті C# ішінде жылжыту"
description: "XLTM беттерді .NET кодының бірнеше жолымен жылжытыңыз."
...
steps:
    enable: true
    title_left: "XLTM файл бетін .NET ішінде жылжыту"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы XLTM файлындағы беттерді жылжытуды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTM файл беттерін C# мысал кодын пайдаланып жылжыту жолы">}}
