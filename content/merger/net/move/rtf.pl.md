...
############################# Head ############################
head_title: "Przenieś RTF strony w C#"
head_description: "Przenieś strony w dokumencie RTF w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś RTF strony w C#"
description: "Przenieś strony RTF za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików RTF do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku RTF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść RTF strony pliku za pomocą C# przykładowego kodu">}}
