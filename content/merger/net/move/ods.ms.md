...
############################# Head ############################
head_title: "Alihkan ODS Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen ODS dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODS Halaman Dalam C#"
description: "Alihkan ODS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan ODS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail ODS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODS halaman fail menggunakan kod contoh C#.">}}
