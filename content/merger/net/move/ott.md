...
############################# Head ############################
head_title: "Move OTT Pages in C#"
head_description: "Move pages within a OTT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move OTT Pages In C#"
description: "Move OTT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move OTT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a OTT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move OTT file pages using C# example code">}}
