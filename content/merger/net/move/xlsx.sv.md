...
############################# Head ############################
head_title: "Flytta XLSX sidor i C#"
head_description: "Flytta sidor i ett XLSX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLSX sidor i C#"
description: "Flytta XLSX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLSX filsidor med hjälp av C# exempelkod">}}
