...
############################# Head ############################
head_title: "Rûpelên XLSB di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLSB ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLSB Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLSB biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XLSB bar dike">}}
