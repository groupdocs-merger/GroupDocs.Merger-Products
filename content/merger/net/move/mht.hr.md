...
############################# Head ############################
head_title: "Premjesti MHT stranice u C#"
head_description: "Premjestite stranice unutar MHT dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti MHT stranice u C#"
description: "Premjesti MHT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti MHT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar MHT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti MHT stranice datoteke koristeći C# primjer koda">}}
