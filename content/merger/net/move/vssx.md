...
############################# Head ############################
head_title: "Move VSSX Pages in C#"
head_description: "Move pages within a VSSX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSSX Pages In C#"
description: "Move VSSX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSSX file pages using C# example code">}}
