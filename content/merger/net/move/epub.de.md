...
############################# Head ############################
head_title: "Seiten in EPUB in .NET verschieben"
head_description: "GroupDocs.Merger for .NET ermöglicht das mühelose Neuanordnen von Seiten in EPUB-Dokumenten. Verarbeiten Sie PDF, Word, Excel, PowerPoint, Bilder und mehr."

############################# Header ############################
title: "Seiten in EPUB verschieben" 
description: "GroupDocs.Merger for .NET befähigt .NET-Anwendungen, Seiten in EPUB-Dokumenten einfach neu anzuordnen."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) erleichtert das Verschieben ausgewählter Seiten in EPUB-Dokumenten. Verbessern Sie Ihre .NET-Anwendungen mit erweiterten Funktionen zur Dokumentenverarbeitung.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eine Seite ans Ende des Dokuments verschieben"
      content: |
        In diesem Beispiel wird gezeigt, wie eine bestimmte Seite ans Ende eines EPUB-Dokuments verschoben wird.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
