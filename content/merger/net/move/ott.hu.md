...
############################# Head ############################
head_title: "OTT oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy OTT dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTT oldal mozgatása a C# nyelven"
description: "Mozgasson át OTT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "OTT fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy OTT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="OTT fájloldalak mozgatása a C# példakóddal">}}
