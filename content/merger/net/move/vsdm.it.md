...
############################# Head ############################
head_title: "Sposta VSDM pagine in C#"
head_description: "Sposta le pagine all'interno di un documento VSDM in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta VSDM pagine in C#"
description: "Sposta VSDM pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta VSDM pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file VSDM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file VSDM utilizzando il codice di esempio C#">}}
