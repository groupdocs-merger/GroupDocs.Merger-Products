...
############################# Head ############################
head_title: "Teisalda XLTX lehte teenuses C#"
head_description: "Teisaldage dokumendi XLTX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLTX lehte rakenduses C#"
description: "Teisaldage XLTX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLTX faililehte, kasutades C# näitekoodi">}}
