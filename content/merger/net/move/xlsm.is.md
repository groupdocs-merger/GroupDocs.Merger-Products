...
############################# Head ############################
head_title: "Færa XLSM síður í C#"
head_description: "Færðu síður innan XLSM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLSM síður í C#"
description: "Færðu XLSM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLSM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLSM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLSM skráarsíður með því að nota C# dæmikóða">}}
