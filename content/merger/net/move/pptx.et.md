...
############################# Head ############################
head_title: "Teisalda PPTX lehte teenuses C#"
head_description: "Teisaldage dokumendi PPTX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPTX lehte rakenduses C#"
description: "Teisaldage PPTX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis PPTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPTX faililehte, kasutades C# näitekoodi">}}
