...
############################# Head ############################
head_title: "Pindahkan PPSX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen PPSX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan PPSX Halaman Di C#"
description: "Pindahkan Halaman PPSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan PPSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file PPSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file PPSX menggunakan kode contoh C#">}}
