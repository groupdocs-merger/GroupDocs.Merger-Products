...
############################# Head ############################
head_title: "Di chuyển VSDM Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu VSDM trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển VSDM Trang trong C#"
description: "Di chuyển các Trang VSDM với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển VSDM Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp VSDM bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp VSDM bằng mã mẫu C#">}}
