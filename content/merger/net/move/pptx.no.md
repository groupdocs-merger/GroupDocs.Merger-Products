...
############################# Head ############################
head_title: "Flytt PPTX sider i C#"
head_description: "Flytt sider i et PPTX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PPTX sider i C#"
description: "Flytt PPTX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en PPTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PPTX filsider ved hjelp av C# eksempelkode">}}
