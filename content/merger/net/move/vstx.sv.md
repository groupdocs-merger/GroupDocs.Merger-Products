...
############################# Head ############################
head_title: "Flytta VSTX sidor i C#"
head_description: "Flytta sidor i ett VSTX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSTX sidor i C#"
description: "Flytta VSTX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSTX filsidor med hjälp av C# exempelkod">}}
