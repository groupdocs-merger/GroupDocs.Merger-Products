...
############################# Head ############################
head_title: "Pindahkan EXCEL Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen EXCEL di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan EXCEL Halaman Di C#"
description: "Pindahkan Halaman EXCEL dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan EXCEL Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file EXCEL dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file EXCEL menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Pindahkan EXCEL Halaman Online"
    content: |
       Pindahkan halaman file EXCEL sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/move-pages/excel).
