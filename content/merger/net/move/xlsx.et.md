...
############################# Head ############################
head_title: "Teisalda XLSX lehte teenuses C#"
head_description: "Teisaldage dokumendi XLSX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSX lehte rakenduses C#"
description: "Teisaldage XLSX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSX faililehte, kasutades C# näitekoodi">}}
