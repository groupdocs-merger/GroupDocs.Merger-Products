...
############################# Head ############################
head_title: "EXCEL ページの移動 - .NET"
head_description: "GroupDocs.Merger for .NET を使用して、EXCEL ドキュメント内のページを簡単に再配置します。PDF、Word、Excel、PowerPoint、画像などを処理できます。"

############################# Header ############################
title: "EXCEL におけるページの移動" 
description: "GroupDocs.Merger for .NET は .NET アプリケーションが EXCEL ドキュメント内でページを再配置することを可能にします。"
...
steps:
    enable: true
    title: "EXCEL ページを移動する方法"
    content: |
      [GroupDocs.Merger](/merger/net/) を使用すると、EXCEL ドキュメント内の選択したページを移動できます。.NET アプリケーションに高度なドキュメント処理機能を追加します。
      
      1. ソース EXCEL ドキュメントのファイルパスを提供します。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "ドキュメントの最後にページを移動"
      content: |
        この例では、特定のページを EXCEL ドキュメントの最後に移動する方法を示します。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
