...
############################# Head ############################
head_title: "OTP Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir OTP belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "OTP Sayfayı C# İçinde Taşı"
description: "OTP Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "OTP Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir OTP dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTP dosya sayfaları nasıl taşınır">}}
