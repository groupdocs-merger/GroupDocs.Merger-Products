...
############################# Head ############################
head_title: "DOCX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy DOCX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCX oldal mozgatása a C# nyelven"
description: "Mozgasson át DOCX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOCX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy DOCX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájloldalak mozgatása a C# példakóddal">}}
