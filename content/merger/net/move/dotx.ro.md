...
############################# Head ############################
head_title: "Mutați DOTX pagini în C#"
head_description: "Mutați paginile dintr-un document DOTX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOTX pagini în C#"
description: "Mutați DOTX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOTX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOTX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOTX utilizând codul exemplu C#">}}
