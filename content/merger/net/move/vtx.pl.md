...
############################# Head ############################
head_title: "Przenieś VTX strony w C#"
head_description: "Przenieś strony w dokumencie VTX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VTX strony w C#"
description: "Przenieś strony VTX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VTX do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku VTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VTX strony pliku za pomocą C# przykładowego kodu">}}
