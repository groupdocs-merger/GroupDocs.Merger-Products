...
############################# Head ############################
head_title: "Pindahkan XLS Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLS di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLS Halaman Di C#"
description: "Pindahkan Halaman XLS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLS menggunakan kode contoh C#">}}
