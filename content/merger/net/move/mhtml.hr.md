...
############################# Head ############################
head_title: "Premjesti MHTML stranice u C#"
head_description: "Premjestite stranice unutar MHTML dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti MHTML stranice u C#"
description: "Premjesti MHTML stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti MHTML stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar MHTML datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti MHTML stranice datoteke koristeći C# primjer koda">}}
