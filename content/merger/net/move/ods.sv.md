...
############################# Head ############################
head_title: "Flytta ODS sidor i C#"
head_description: "Flytta sidor i ett ODS-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ODS sidor i C#"
description: "Flytta ODS sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta ODS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en ODS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ODS filsidor med hjälp av C# exempelkod">}}
