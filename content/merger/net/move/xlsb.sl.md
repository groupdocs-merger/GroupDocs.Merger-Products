...
############################# Head ############################
head_title: "Premakni XLSB strani v C#"
head_description: "Premaknite strani znotraj dokumenta XLSB v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLSB strani v C#"
description: "Premaknite strani XLSB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLSB v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke XLSB z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLSB s primerom kode C#">}}
