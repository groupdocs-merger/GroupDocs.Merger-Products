...
############################# Head ############################
head_title: "Pindahkan XLAM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLAM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLAM Halaman Di C#"
description: "Pindahkan Halaman XLAM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLAM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLAM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLAM menggunakan kode contoh C#">}}
