...
############################# Head ############################
head_title: "Move VTX Pages in C#"
head_description: "Move pages within a VTX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VTX Pages In C#"
description: "Move VTX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VTX file pages using C# example code">}}
