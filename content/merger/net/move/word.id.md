...
############################# Head ############################
head_title: "Pindahkan WORD Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen WORD di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WORD Halaman Di C#"
description: "Pindahkan Halaman WORD dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan WORD Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file WORD dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WORD menggunakan kode contoh C#">}}
