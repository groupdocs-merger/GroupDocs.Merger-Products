...
############################# Head ############################
head_title: "نقل صفحات EPUB في C#"
head_description: "انقل الصفحات داخل مستند EPUB في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات EPUB في C#"
description: "انقل صفحات EPUB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل EPUB صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف EPUB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف EPUB باستخدام كود مثال C#">}}
