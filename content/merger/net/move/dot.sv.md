...
############################# Head ############################
head_title: "Flytta DOT sidor i C#"
head_description: "Flytta sidor i ett DOT-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOT sidor i C#"
description: "Flytta DOT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta DOT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en DOT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOT filsidor med hjälp av C# exempelkod">}}
