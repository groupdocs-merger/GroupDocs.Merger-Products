...
############################# Head ############################
head_title: "Teisalda HTML lehte teenuses C#"
head_description: "Teisaldage dokumendi HTML lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda HTML lehte rakenduses C#"
description: "Teisaldage HTML lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda HTML faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis HTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada HTML faililehte, kasutades C# näitekoodi">}}
