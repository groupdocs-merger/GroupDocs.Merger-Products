...
############################# Head ############################
head_title: "Pindahkan OTP Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen OTP di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan OTP Halaman Di C#"
description: "Pindahkan Halaman OTP dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan OTP Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file OTP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file OTP menggunakan kode contoh C#">}}
