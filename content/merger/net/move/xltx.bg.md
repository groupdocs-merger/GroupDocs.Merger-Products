...
############################# Head ############################
head_title: "Преместете XLTX страници в C#"
head_description: "Преместете страници в XLTX документ в C# на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете XLTX страници в C#"
description: "Преместете XLTX страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Преместете XLTX файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да преместват страници в рамките на файл XLTX чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате XLTX файлови страници с помощта на C# примерен код">}}
