...
############################# Head ############################
head_title: "Mutați PPS pagini în C#"
head_description: "Mutați paginile dintr-un document PPS în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PPS pagini în C#"
description: "Mutați PPS pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați PPS pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier PPS prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PPS utilizând codul exemplu C#">}}
