...
############################# Head ############################
head_title: "Perkelti XPS puslapius C#"
head_description: "Perkelkite puslapius XPS dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti XPS puslapius C#"
description: "Perkelkite XPS puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti XPS failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius XPS faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti XPS failo puslapius naudojant C# pavyzdinį kodą">}}
