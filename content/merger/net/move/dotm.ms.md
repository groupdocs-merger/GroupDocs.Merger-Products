...
############################# Head ############################
head_title: "Alihkan DOTM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOTM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOTM Halaman Dalam C#"
description: "Alihkan DOTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOTM halaman fail menggunakan kod contoh C#.">}}
