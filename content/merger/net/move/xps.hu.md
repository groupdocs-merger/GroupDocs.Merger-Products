...
############################# Head ############################
head_title: "XPS oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XPS dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XPS oldal mozgatása a C# nyelven"
description: "Mozgasson át XPS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XPS fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XPS fájloldalak mozgatása a C# példakóddal">}}
