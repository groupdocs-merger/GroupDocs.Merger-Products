...
############################# Head ############################
head_title: "Mover VDX Páginas em C#"
head_description: "Mova as páginas em um documento VDX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VDX Páginas em C#"
description: "Mova VDX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VDX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VDX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VDX usando o código de exemplo C#">}}
