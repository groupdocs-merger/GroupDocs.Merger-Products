...
############################# Head ############################
head_title: "Pārvietot VSX lapas programmā C#"
head_description: "Pārvietojiet lapas VSX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSX lapas programmā C#"
description: "Pārvietojiet VSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSX faila lapas, izmantojot C# piemēra kodu">}}
