...
############################# Head ############################
head_title: "Mutați EPUB pagini în C#"
head_description: "Mutați paginile dintr-un document EPUB în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați EPUB pagini în C#"
description: "Mutați EPUB pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați EPUB pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier EPUB prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere EPUB utilizând codul exemplu C#">}}
