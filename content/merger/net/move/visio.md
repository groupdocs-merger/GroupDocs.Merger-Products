...
############################# Head ############################
head_title: "Move VISIO Pages in C#"
head_description: "Move pages within a VISIO document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VISIO Pages In C#"
description: "Move VISIO Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VISIO File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VISIO file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VISIO file pages using C# example code">}}
