...
############################# Head ############################
head_title: "Flyt XLTX sider i C#"
head_description: "Flyt sider i et XLTX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLTX sider i C#"
description: "Flyt XLTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLTX filsider ved hjælp af C# eksempelkode">}}
