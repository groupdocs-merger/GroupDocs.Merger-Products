...
############################# Head ############################
head_title: "Bog DOT Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad DOT in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog DOT Leathanaigh I C#"
description: "Bog DOT Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog DOT Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad DOT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas DOT leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
