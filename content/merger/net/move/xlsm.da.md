...
############################# Head ############################
head_title: "Flyt XLSM sider i C#"
head_description: "Flyt sider i et XLSM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLSM sider i C#"
description: "Flyt XLSM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLSM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLSM filsider ved hjælp af C# eksempelkode">}}
