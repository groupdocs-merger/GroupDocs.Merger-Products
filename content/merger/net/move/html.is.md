...
############################# Head ############################
head_title: "Færa HTML síður í C#"
head_description: "Færðu síður innan HTML skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa HTML síður í C#"
description: "Færðu HTML síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa HTML skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í HTML skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa HTML skráarsíður með því að nota C# dæmikóða">}}
