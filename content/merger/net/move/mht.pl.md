...
############################# Head ############################
head_title: "Przenieś MHT strony w C#"
head_description: "Przenieś strony w dokumencie MHT w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś MHT strony w C#"
description: "Przenieś strony MHT za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików MHT do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku MHT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść MHT strony pliku za pomocą C# przykładowego kodu">}}
