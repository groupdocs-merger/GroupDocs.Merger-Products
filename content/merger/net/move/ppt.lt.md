...
############################# Head ############################
head_title: "Perkelti PPT puslapius C#"
head_description: "Perkelkite puslapius PPT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti PPT puslapius C#"
description: "Perkelkite PPT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti PPT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius PPT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti PPT failo puslapius naudojant C# pavyzdinį kodą">}}
