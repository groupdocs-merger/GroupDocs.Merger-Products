...
############################# Head ############################
head_title: "Pindahkan XLTM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLTM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLTM Halaman Di C#"
description: "Pindahkan Halaman XLTM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLTM menggunakan kode contoh C#">}}
