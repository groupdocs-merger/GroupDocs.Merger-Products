...
############################# Head ############################
head_title: "نقل صفحات PDF في C#"
head_description: "انقل الصفحات داخل مستند PDF في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PDF في C#"
description: "انقل صفحات PDF ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل PDF صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف PDF من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PDF باستخدام كود مثال C#">}}

        ```csharp    
        // انقل صفحات ملف PDF باستخدام GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "عروض توضيحية مباشرة - نقل صفحات PDF عبر الإنترنت"
    content: |
       انقل صفحات ملف PDF الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pdf).
