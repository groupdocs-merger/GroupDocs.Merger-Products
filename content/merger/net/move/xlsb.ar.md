...
############################# Head ############################
head_title: "نقل صفحات XLSB في C#"
head_description: "انقل الصفحات داخل مستند XLSB في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLSB في C#"
description: "انقل صفحات XLSB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLSB صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLSB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLSB باستخدام كود مثال C#">}}
