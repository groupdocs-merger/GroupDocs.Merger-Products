...
############################# Head ############################
head_title: "Flyt DOCX sider i C#"
head_description: "Flyt sider i et DOCX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOCX sider i C#"
description: "Flyt DOCX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOCX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOCX filsider ved hjælp af C# eksempelkode">}}
