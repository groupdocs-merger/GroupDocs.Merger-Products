...
############################# Head ############################
head_title: "Perkelti DOTM puslapius C#"
head_description: "Perkelkite puslapius DOTM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOTM puslapius C#"
description: "Perkelkite DOTM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOTM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOTM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOTM failo puslapius naudojant C# pavyzdinį kodą">}}
