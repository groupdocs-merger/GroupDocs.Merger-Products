...
############################# Head ############################
head_title: "EPUB Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir EPUB belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "EPUB Sayfayı C# İçinde Taşı"
description: "EPUB Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "EPUB Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir EPUB dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak EPUB dosya sayfaları nasıl taşınır">}}
