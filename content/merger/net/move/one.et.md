...
############################# Head ############################
head_title: "Teisalda ONE lehte teenuses C#"
head_description: "Teisaldage dokumendi ONE lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ONE lehte rakenduses C#"
description: "Teisaldage ONE lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ONE faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis ONE, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ONE faililehte, kasutades C# näitekoodi">}}
