...
############################# Head ############################
head_title: "Rûpelên VSTM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VSTM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VSTM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSTM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VSTM bar dike">}}
