...
############################# Head ############################
head_title: "PPT Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir PPT belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPT Sayfayı C# İçinde Taşı"
description: "PPT Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPT Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir PPT dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPT dosya sayfaları nasıl taşınır">}}
