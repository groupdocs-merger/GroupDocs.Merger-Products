...
############################# Head ############################
head_title: "Mou VSX pàgines a C#"
head_description: "Mou les pàgines d'un document VSX a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou VSX pàgines a C#"
description: "Mou VSX pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou VSX pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer VSX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers VSX utilitzant el codi d'exemple C#">}}
