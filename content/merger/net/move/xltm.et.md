...
############################# Head ############################
head_title: "Teisalda XLTM lehte teenuses C#"
head_description: "Teisaldage dokumendi XLTM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLTM lehte rakenduses C#"
description: "Teisaldage XLTM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLTM faililehte, kasutades C# näitekoodi">}}
