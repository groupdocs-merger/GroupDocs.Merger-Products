...
############################# Head ############################
head_title: "Alihkan DOCX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOCX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOCX Halaman Dalam C#"
description: "Alihkan DOCX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOCX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOCX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOCX halaman fail menggunakan kod contoh C#.">}}
