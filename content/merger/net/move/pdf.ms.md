...
############################# Head ############################
head_title: "Alihkan PDF Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen PDF dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan PDF Halaman Dalam C#"
description: "Alihkan PDF Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan PDF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail PDF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan PDF halaman fail menggunakan kod contoh C#.">}}
