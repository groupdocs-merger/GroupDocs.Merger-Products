...
############################# Head ############################
head_title: "Presunúť DOT stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu DOT v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOT stránok do C#"
description: "Presuňte DOT stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť DOT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru DOT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOT pomocou vzorového kódu C#">}}
