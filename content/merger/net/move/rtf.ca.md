...
############################# Head ############################
head_title: "Mou RTF pàgines a C#"
head_description: "Mou les pàgines d'un document RTF a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou RTF pàgines a C#"
description: "Mou RTF pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou RTF pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer RTF implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers RTF utilitzant el codi d'exemple C#">}}
