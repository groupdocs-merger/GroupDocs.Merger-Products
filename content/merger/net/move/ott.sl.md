...
############################# Head ############################
head_title: "Premakni OTT strani v C#"
head_description: "Premaknite strani znotraj dokumenta OTT v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni OTT strani v C#"
description: "Premaknite strani OTT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke OTT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke OTT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke OTT s primerom kode C#">}}
