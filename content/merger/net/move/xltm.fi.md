...
############################# Head ############################
head_title: "Siirrä XLTM sivua C#"
head_description: "Siirrä XLTM-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLTM sivua C#"
description: "Siirrä XLTM sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja XLTM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
