...
############################# Head ############################
head_title: "Pārvietot VTX lapas programmā C#"
head_description: "Pārvietojiet lapas VTX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VTX lapas programmā C#"
description: "Pārvietojiet VTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VTX faila lapas, izmantojot C# piemēra kodu">}}
