...
############################# Head ############################
head_title: "Flytta XLAM sidor i C#"
head_description: "Flytta sidor i ett XLAM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta XLAM sidor i C#"
description: "Flytta XLAM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta XLAM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en XLAM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar XLAM filsidor med hjälp av C# exempelkod">}}
