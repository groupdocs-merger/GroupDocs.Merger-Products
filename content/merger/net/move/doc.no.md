...
############################# Head ############################
head_title: "Flytt DOC sider i C#"
head_description: "Flytt sider i et DOC-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOC sider i C#"
description: "Flytt DOC sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOC-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOC filsider ved hjelp av C# eksempelkode">}}
