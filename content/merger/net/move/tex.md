...
############################# Head ############################
head_title: "Move TEX Pages in C#"
head_description: "Move pages within a TEX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move TEX Pages In C#"
description: "Move TEX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move TEX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a TEX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move TEX file pages using C# example code">}}
