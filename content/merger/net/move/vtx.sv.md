...
############################# Head ############################
head_title: "Flytta VTX sidor i C#"
head_description: "Flytta sidor i ett VTX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VTX sidor i C#"
description: "Flytta VTX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VTX filsidor med hjälp av C# exempelkod">}}
