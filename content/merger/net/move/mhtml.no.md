...
############################# Head ############################
head_title: "Flytt MHTML sider i C#"
head_description: "Flytt sider i et MHTML-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt MHTML sider i C#"
description: "Flytt MHTML sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en MHTML-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte MHTML filsider ved hjelp av C# eksempelkode">}}
