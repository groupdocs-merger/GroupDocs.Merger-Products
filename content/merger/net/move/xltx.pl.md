...
############################# Head ############################
head_title: "Przenieś XLTX strony w C#"
head_description: "Przenieś strony w dokumencie XLTX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLTX strony w C#"
description: "Przenieś strony XLTX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLTX do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLTX strony pliku za pomocą C# przykładowego kodu">}}
