...
############################# Head ############################
head_title: "Flytt DOTM sider i C#"
head_description: "Flytt sider i et DOTM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOTM sider i C#"
description: "Flytt DOTM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOTM filsider ved hjelp av C# eksempelkode">}}
