...
############################# Head ############################
head_title: "Pindahkan WORKSHEET Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen WORKSHEET di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan WORKSHEET Halaman Di C#"
description: "Pindahkan Halaman WORKSHEET dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan WORKSHEET Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file WORKSHEET dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file WORKSHEET menggunakan kode contoh C#">}}
