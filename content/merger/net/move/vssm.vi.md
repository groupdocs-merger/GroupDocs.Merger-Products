...
############################# Head ############################
head_title: "Di chuyển VSSM Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu VSSM trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển VSSM Trang trong C#"
description: "Di chuyển các Trang VSSM với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển VSSM Trang Tệp trong .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp VSSM bằng mã mẫu C#">}}
