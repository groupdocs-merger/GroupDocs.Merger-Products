...
############################# Head ############################
head_title: "Færa MHT síður í C#"
head_description: "Færðu síður innan MHT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa MHT síður í C#"
description: "Færðu MHT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa MHT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í MHT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa MHT skráarsíður með því að nota C# dæmikóða">}}
