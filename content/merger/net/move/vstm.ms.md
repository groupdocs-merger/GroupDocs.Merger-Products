...
############################# Head ############################
head_title: "Alihkan VSTM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSTM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSTM Halaman Dalam C#"
description: "Alihkan VSTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSTM halaman fail menggunakan kod contoh C#.">}}
