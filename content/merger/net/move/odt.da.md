...
############################# Head ############################
head_title: "Flyt ODT sider i C#"
head_description: "Flyt sider i et ODT-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt ODT sider i C#"
description: "Flyt ODT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt ODT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en ODT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes ODT filsider ved hjælp af C# eksempelkode">}}
