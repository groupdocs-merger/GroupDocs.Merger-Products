...
############################# Head ############################
head_title: "Presunúť OTP stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu OTP v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť OTP stránok do C#"
description: "Presuňte OTP stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť OTP strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru OTP implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru OTP pomocou vzorového kódu C#">}}
