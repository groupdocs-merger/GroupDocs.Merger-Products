...
############################# Head ############################
head_title: "Færa EPUB síður í C#"
head_description: "Færðu síður innan EPUB skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa EPUB síður í C#"
description: "Færðu EPUB síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa EPUB skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í EPUB skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa EPUB skráarsíður með því að nota C# dæmikóða">}}
