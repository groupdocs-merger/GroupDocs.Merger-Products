...
############################# Head ############################
head_title: "نقل صفحات DOT في C#"
head_description: "انقل الصفحات داخل مستند DOT في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات DOT في C#"
description: "انقل صفحات DOT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل DOT صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف DOT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف DOT باستخدام كود مثال C#">}}
