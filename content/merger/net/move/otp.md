...
############################# Head ############################
head_title: "Move OTP Pages in C#"
head_description: "Move pages within a OTP document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move OTP Pages In C#"
description: "Move OTP Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a OTP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move OTP file pages using C# example code">}}
