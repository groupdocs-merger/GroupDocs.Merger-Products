...
############################# Head ############################
head_title: "Premjesti VDX stranice u C#"
head_description: "Premjestite stranice unutar VDX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VDX stranice u C#"
description: "Premjesti VDX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VDX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VDX stranice datoteke koristeći C# primjer koda">}}
