...
############################# Head ############################
head_title: "Flyt MHTML sider i C#"
head_description: "Flyt sider i et MHTML-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt MHTML sider i C#"
description: "Flyt MHTML sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en MHTML-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes MHTML filsider ved hjælp af C# eksempelkode">}}
