...
############################# Head ############################
head_title: "Flytt XLAM sider i C#"
head_description: "Flytt sider i et XLAM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLAM sider i C#"
description: "Flytt XLAM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLAM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLAM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLAM filsider ved hjelp av C# eksempelkode">}}
