...
############################# Head ############################
head_title: "Mover XLS Páginas em C#"
head_description: "Mova as páginas em um documento XLS em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover XLS Páginas em C#"
description: "Mova XLS Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo XLS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo XLS implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo XLS usando o código de exemplo C#">}}
