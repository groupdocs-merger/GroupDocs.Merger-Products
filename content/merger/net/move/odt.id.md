...
head_title: "Pindahkan, Susun Ulang & Susun Ulang Halaman ODT di C# .NET"
head_description: "Pengguna C# .NET untuk memindahkan, mengatur ulang, dan menyusun ulang halaman dalam dokumen ODT dengan membalik urutan halaman menggunakan API penggabungan dokumen."

title: "Pindahkan & Susun Ulang ODT Halaman di .NET"
description: "Pindahkan dan Susun ulang halaman dalam dokumen ODT ke posisi apa pun menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Pindahkan ODT File Pages di .NET"
    content_left: |
