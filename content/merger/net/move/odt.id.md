...
############################# Head ############################
head_title: "Pindahkan ODT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen ODT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ODT Halaman Di C#"
description: "Pindahkan Halaman ODT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan ODT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file ODT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ODT menggunakan kode contoh C#">}}
