...
############################# Head ############################
head_title: "Move XLTM Pages in C#"
head_description: "Move pages within a XLTM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLTM Pages In C#"
description: "Move XLTM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLTM file pages using C# example code">}}
