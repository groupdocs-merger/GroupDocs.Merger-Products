...
############################# Head ############################
head_title: "Przenieś VSX strony w C#"
head_description: "Przenieś strony w dokumencie VSX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś VSX strony w C#"
description: "Przenieś strony VSX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików VSX do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku VSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść VSX strony pliku za pomocą C# przykładowego kodu">}}
