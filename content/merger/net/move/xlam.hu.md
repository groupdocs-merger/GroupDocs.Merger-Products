...
############################# Head ############################
head_title: "XLAM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XLAM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLAM oldal mozgatása a C# nyelven"
description: "Mozgasson át XLAM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLAM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XLAM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLAM fájloldalak mozgatása a C# példakóddal">}}
