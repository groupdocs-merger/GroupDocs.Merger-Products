...
############################# Head ############################
head_title: "Færa PDF síður í C#"
head_description: "Færðu síður innan PDF skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PDF síður í C#"
description: "Færðu PDF síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa PDF skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í PDF skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PDF skráarsíður með því að nota C# dæmikóða">}}
