...
############################# Head ############################
head_title: "Move PPTX Pages in C#"
head_description: "Move pages within a PPTX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move PPTX Pages In C#"
description: "Move PPTX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move PPTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a PPTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move PPTX file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Move PPTX Pages Online"
    content: |
       Move PPTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/move-pages/pptx) website.
