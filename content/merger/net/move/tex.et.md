...
############################# Head ############################
head_title: "Teisalda TEX lehte teenuses C#"
head_description: "Teisaldage dokumendi TEX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda TEX lehte rakenduses C#"
description: "Teisaldage TEX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda TEX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis TEX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada TEX faililehte, kasutades C# näitekoodi">}}
