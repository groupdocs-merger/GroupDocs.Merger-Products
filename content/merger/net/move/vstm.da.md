...
############################# Head ############################
head_title: "Flyt VSTM sider i C#"
head_description: "Flyt sider i et VSTM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt VSTM sider i C#"
description: "Flyt VSTM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt VSTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en VSTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes VSTM filsider ved hjælp af C# eksempelkode">}}
