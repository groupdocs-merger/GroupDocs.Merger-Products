...
############################# Head ############################
head_title: "Perkelti VSSM puslapius C#"
head_description: "Perkelkite puslapius VSSM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSSM puslapius C#"
description: "Perkelkite VSSM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSSM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSSM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSSM failo puslapius naudojant C# pavyzdinį kodą">}}
