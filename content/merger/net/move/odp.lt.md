...
############################# Head ############################
head_title: "Perkelti ODP puslapius C#"
head_description: "Perkelkite puslapius ODP dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODP puslapius C#"
description: "Perkelkite ODP puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODP failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius ODP faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODP failo puslapius naudojant C# pavyzdinį kodą">}}
