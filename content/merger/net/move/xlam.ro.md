...
############################# Head ############################
head_title: "Mutați XLAM pagini în C#"
head_description: "Mutați paginile dintr-un document XLAM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLAM pagini în C#"
description: "Mutați XLAM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLAM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLAM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLAM utilizând codul exemplu C#">}}
