...
############################# Head ############################
head_title: "Přesunout ODP stránky v C#"
head_description: "Přesunout stránky v dokumentu ODP v C# na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout ODP stránky do C#"
description: "Přesuňte ODP stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Přesunout ODP stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# přesouvat stránky v souboru ODP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru ODP pomocí ukázkového kódu C#">}}
