...
############################# Head ############################
head_title: "Преместете XLT страници в C#"
head_description: "Преместете страници в XLT документ в C# на всяка позиция, като използвате API за сливане на документи."

############################# Header ############################
title: "Преместете XLT страници в C#"
description: "Преместете XLT страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Преместете XLT файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да преместват страници в рамките на файл XLT чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да премествате XLT файлови страници с помощта на C# примерен код">}}
