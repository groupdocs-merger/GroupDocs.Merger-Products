...
############################# Head ############################
head_title: "Mutați DOTM pagini în C#"
head_description: "Mutați paginile dintr-un document DOTM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOTM pagini în C#"
description: "Mutați DOTM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOTM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOTM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOTM utilizând codul exemplu C#">}}
