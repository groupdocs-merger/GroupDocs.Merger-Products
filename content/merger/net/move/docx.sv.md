...
############################# Head ############################
head_title: "Flytta DOCX sidor i C#"
head_description: "Flytta sidor i ett DOCX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta DOCX sidor i C#"
description: "Flytta DOCX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta DOCX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en DOCX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar DOCX filsidor med hjälp av C# exempelkod">}}
