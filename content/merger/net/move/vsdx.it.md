...
############################# Head ############################
head_title: "Sposta VSDX pagine in C#"
head_description: "Sposta le pagine all'interno di un documento VSDX in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta VSDX pagine in C#"
description: "Sposta VSDX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta VSDX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file VSDX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file VSDX utilizzando il codice di esempio C#">}}
