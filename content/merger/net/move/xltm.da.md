...
############################# Head ############################
head_title: "Flyt XLTM sider i C#"
head_description: "Flyt sider i et XLTM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLTM sider i C#"
description: "Flyt XLTM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLTM filsider ved hjælp af C# eksempelkode">}}
