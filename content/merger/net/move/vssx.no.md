...
############################# Head ############################
head_title: "Flytt VSSX sider i C#"
head_description: "Flytt sider i et VSSX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSSX sider i C#"
description: "Flytt VSSX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSSX filsider ved hjelp av C# eksempelkode">}}
