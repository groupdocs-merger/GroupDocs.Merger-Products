...
############################# Head ############################
head_title: "Pindahkan DOTM Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOTM di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOTM Halaman Di C#"
description: "Pindahkan Halaman DOTM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOTM menggunakan kode contoh C#">}}
