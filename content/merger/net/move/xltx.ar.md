...
############################# Head ############################
head_title: "نقل صفحات XLTX في C#"
head_description: "انقل الصفحات داخل مستند XLTX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLTX في C#"
description: "انقل صفحات XLTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLTX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLTX باستخدام كود مثال C#">}}
