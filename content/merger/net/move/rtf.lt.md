...
############################# Head ############################
head_title: "Perkelti RTF puslapius C#"
head_description: "Perkelkite puslapius RTF dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti RTF puslapius C#"
description: "Perkelkite RTF puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti RTF failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius RTF faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti RTF failo puslapius naudojant C# pavyzdinį kodą">}}
