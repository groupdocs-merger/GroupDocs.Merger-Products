...
############################# Head ############################
head_title: "Переместить WEB страницы на C#"
head_description: "Переместите страницы в документе WEB на C# в любую позицию с помощью Merger API."

############################# Header ############################
title: "Переместить WEB страницы на C#"
description: "Переместите WEB страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Переместить страницы WEB документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко перемещать страницы в файле WEB, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как переместить страницы WEB документов, используя пример кода C#">}}
