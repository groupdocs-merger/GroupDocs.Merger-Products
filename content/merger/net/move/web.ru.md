...
draft: false
############################# Head ############################
head_title: "Перемещение, перестановка и изменение порядка веб-страниц в C# .NET"
head_description: "Пользователи C# .NET могут перемещать, переупорядочивать и изменять порядок страниц в веб-документе путем изменения порядка страниц с помощью API слияния документов."
############################# Header ############################
title: "Перемещение и изменение порядка веб-страниц в .NET"
description: "Перемещение и перестановка страниц в веб-документе в любое место с помощью API слияния документов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Перемещение файловых страниц WEB в .NET"
    content_left: |
