...
############################# Head ############################
head_title: "Přesunout OTT stránky v C#"
head_description: "Přesunout stránky v dokumentu OTT v C# na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout OTT stránky do C#"
description: "Přesuňte OTT stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Přesunout OTT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# přesouvat stránky v souboru OTT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru OTT pomocí ukázkového kódu C#">}}
