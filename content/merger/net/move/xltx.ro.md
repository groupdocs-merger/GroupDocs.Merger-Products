...
############################# Head ############################
head_title: "Mutați XLTX pagini în C#"
head_description: "Mutați paginile dintr-un document XLTX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLTX pagini în C#"
description: "Mutați XLTX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLTX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLTX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLTX utilizând codul exemplu C#">}}
