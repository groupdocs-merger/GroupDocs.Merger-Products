...
############################# Head ############################
head_title: "Alihkan VSDM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSDM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSDM Halaman Dalam C#"
description: "Alihkan VSDM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSDM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSDM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSDM halaman fail menggunakan kod contoh C#.">}}
