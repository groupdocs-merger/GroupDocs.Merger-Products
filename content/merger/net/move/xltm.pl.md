...
############################# Head ############################
head_title: "Przenieś XLTM strony w C#"
head_description: "Przenieś strony w dokumencie XLTM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLTM strony w C#"
description: "Przenieś strony XLTM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLTM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLTM strony pliku za pomocą C# przykładowego kodu">}}
