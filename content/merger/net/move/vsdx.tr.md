...
############################# Head ############################
head_title: "VSDX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSDX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSDX Sayfayı C# İçinde Taşı"
description: "VSDX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSDX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSDX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosya sayfaları nasıl taşınır">}}
