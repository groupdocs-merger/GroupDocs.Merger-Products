...
############################# Head ############################
head_title: "Presunúť RTF stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu RTF v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť RTF stránok do C#"
description: "Presuňte RTF stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť RTF strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru RTF implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru RTF pomocou vzorového kódu C#">}}
