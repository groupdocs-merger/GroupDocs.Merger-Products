...
############################# Head ############################
head_title: "Perkelti TEX puslapius C#"
head_description: "Perkelkite puslapius TEX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti TEX puslapius C#"
description: "Perkelkite TEX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti TEX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius TEX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti TEX failo puslapius naudojant C# pavyzdinį kodą">}}
