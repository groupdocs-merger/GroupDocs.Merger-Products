...
############################# Head ############################
head_title: "Rûpelên XLTM di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLTM ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLTM Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLTM biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XLTM bar dike">}}
