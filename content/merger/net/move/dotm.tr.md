...
############################# Head ############################
head_title: "DOTM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOTM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOTM Sayfayı C# İçinde Taşı"
description: "DOTM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOTM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOTM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosya sayfaları nasıl taşınır">}}
