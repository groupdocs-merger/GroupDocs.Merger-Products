...
############################# Head ############################
head_title: "Alihkan VSX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen VSX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan VSX Halaman Dalam C#"
description: "Alihkan VSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan VSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail VSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan VSX halaman fail menggunakan kod contoh C#.">}}
