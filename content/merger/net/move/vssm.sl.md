...
############################# Head ############################
head_title: "Premakni VSSM strani v C#"
head_description: "Premaknite strani znotraj dokumenta VSSM v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni VSSM strani v C#"
description: "Premaknite strani VSSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke VSSM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke VSSM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke VSSM s primerom kode C#">}}
