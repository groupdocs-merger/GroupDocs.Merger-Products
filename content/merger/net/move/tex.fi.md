...
############################# Head ############################
head_title: "Siirrä TEX sivua C#"
head_description: "Siirrä TEX-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä TEX sivua C#"
description: "Siirrä TEX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä TEX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja TEX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää TEX tiedostosivua käyttämällä C# esimerkkikoodia">}}
