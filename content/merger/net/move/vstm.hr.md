...
############################# Head ############################
head_title: "Premjesti VSTM stranice u C#"
head_description: "Premjestite stranice unutar VSTM dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSTM stranice u C#"
description: "Premjesti VSTM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VSTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VSTM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSTM stranice datoteke koristeći C# primjer koda">}}
