...
############################# Head ############################
head_title: "Mutați VSDM pagini în C#"
head_description: "Mutați paginile dintr-un document VSDM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSDM pagini în C#"
description: "Mutați VSDM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSDM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSDM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSDM utilizând codul exemplu C#">}}
