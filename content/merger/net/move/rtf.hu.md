...
############################# Head ############################
head_title: "RTF oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy RTF dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "RTF oldal mozgatása a C# nyelven"
description: "Mozgasson át RTF oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "RTF fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy RTF fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájloldalak mozgatása a C# példakóddal">}}
