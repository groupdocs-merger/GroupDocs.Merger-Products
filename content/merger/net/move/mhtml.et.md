...
############################# Head ############################
head_title: "Teisalda MHTML lehte teenuses C#"
head_description: "Teisaldage dokumendi MHTML lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda MHTML lehte rakenduses C#"
description: "Teisaldage MHTML lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda MHTML faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis MHTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada MHTML faililehte, kasutades C# näitekoodi">}}
