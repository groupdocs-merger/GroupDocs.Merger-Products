...
############################# Head ############################
head_title: "Flyt DOTM sider i C#"
head_description: "Flyt sider i et DOTM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOTM sider i C#"
description: "Flyt DOTM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOTM filsider ved hjælp af C# eksempelkode">}}
