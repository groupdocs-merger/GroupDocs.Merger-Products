...
############################# Head ############################
head_title: "Pindahkan EPUB Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen EPUB di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan EPUB Halaman Di C#"
description: "Pindahkan Halaman EPUB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan EPUB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file EPUB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file EPUB menggunakan kode contoh C#">}}
