...
############################# Head ############################
head_title: "Flytta VSSM sidor i C#"
head_description: "Flytta sidor i ett VSSM-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSSM sidor i C#"
description: "Flytta VSSM sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSSM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSSM filsidor med hjälp av C# exempelkod">}}
