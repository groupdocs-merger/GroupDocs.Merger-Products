...
############################# Head ############################
head_title: "Move DOTX Pages in C#"
head_description: "Move pages within a DOTX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move DOTX Pages In C#"
description: "Move DOTX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move DOTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a DOTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOTX file pages using C# example code">}}
