...
############################# Head ############################
head_title: "Perkelti DOCX puslapius C#"
head_description: "Perkelkite puslapius DOCX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOCX puslapius C#"
description: "Perkelkite DOCX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOCX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOCX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOCX failo puslapius naudojant C# pavyzdinį kodą">}}
