...
############################# Head ############################
head_title: "Move ONE Pages in C#"
head_description: "Move pages within a ONE document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move ONE Pages In C#"
description: "Move ONE Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move ONE File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a ONE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move ONE file pages using C# example code">}}
