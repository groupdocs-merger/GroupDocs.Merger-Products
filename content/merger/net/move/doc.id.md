...
############################# Head ############################
head_title: "Pindahkan DOC Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOC di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOC Halaman Di C#"
description: "Pindahkan Halaman DOC dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOC Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOC dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOC menggunakan kode contoh C#">}}
