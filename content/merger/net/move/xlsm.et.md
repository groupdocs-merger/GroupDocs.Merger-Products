...
############################# Head ############################
head_title: "Teisalda XLSM lehte teenuses C#"
head_description: "Teisaldage dokumendi XLSM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda XLSM lehte rakenduses C#"
description: "Teisaldage XLSM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda XLSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis XLSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada XLSM faililehte, kasutades C# näitekoodi">}}
