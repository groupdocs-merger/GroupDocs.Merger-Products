...
############################# Head ############################
head_title: "Færa VSSM síður í C#"
head_description: "Færðu síður innan VSSM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSSM síður í C#"
description: "Færðu VSSM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSSM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSSM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSSM skráarsíður með því að nota C# dæmikóða">}}
