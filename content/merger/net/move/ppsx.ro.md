...
############################# Head ############################
head_title: "Mutați PPSX pagini în C#"
head_description: "Mutați paginile dintr-un document PPSX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați PPSX pagini în C#"
description: "Mutați PPSX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați PPSX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier PPSX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere PPSX utilizând codul exemplu C#">}}
