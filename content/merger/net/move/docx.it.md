...
############################# Head ############################
head_title: "Sposta DOCX pagine in C#"
head_description: "Sposta le pagine all'interno di un documento DOCX in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta DOCX pagine in C#"
description: "Sposta DOCX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta DOCX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file DOCX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file DOCX utilizzando il codice di esempio C#">}}
