...
############################# Head ############################
head_title: "Bog ODP Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad ODP in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog ODP Leathanaigh I C#"
description: "Bog ODP Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog ODP Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad ODP trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas ODP leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
