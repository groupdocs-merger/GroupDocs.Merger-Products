...
############################# Head ############################
head_title: "Sposta PDF pagine in C#"
head_description: "Sposta le pagine all'interno di un documento PDF in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta PDF pagine in C#"
description: "Sposta PDF pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta PDF pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file PDF implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file PDF utilizzando il codice di esempio C#">}}
