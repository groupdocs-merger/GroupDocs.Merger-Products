...
############################# Head ############################
head_title: "Bog OTT Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad OTT in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog OTT Leathanaigh I C#"
description: "Bog OTT Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog OTT Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad OTT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas OTT leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
