...
############################# Head ############################
head_title: "نقل صفحات XLT في C#"
head_description: "انقل الصفحات داخل مستند XLT في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLT في C#"
description: "انقل صفحات XLT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLT صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLT من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLT باستخدام كود مثال C#">}}
