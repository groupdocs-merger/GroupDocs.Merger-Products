...
############################# Head ############################
head_title: "Perkelti MHT puslapius C#"
head_description: "Perkelkite puslapius MHT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti MHT puslapius C#"
description: "Perkelkite MHT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti MHT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius MHT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti MHT failo puslapius naudojant C# pavyzdinį kodą">}}
