...
############################# Head ############################
head_title: "Move WORD Pages in C#"
head_description: "Move pages within a WORD document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move WORD Pages In C#"
description: "Move WORD Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move WORD File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a WORD file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move WORD file pages using C# example code">}}
