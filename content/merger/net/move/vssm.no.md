...
############################# Head ############################
head_title: "Flytt VSSM sider i C#"
head_description: "Flytt sider i et VSSM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSSM sider i C#"
description: "Flytt VSSM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSSM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSSM filsider ved hjelp av C# eksempelkode">}}
