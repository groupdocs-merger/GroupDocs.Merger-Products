...
############################# Head ############################
head_title: "Alihkan XLTX Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLTX dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLTX Halaman Dalam C#"
description: "Alihkan XLTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLTX halaman fail menggunakan kod contoh C#.">}}
