...
############################# Head ############################
head_title: "Færa XLSX síður í C#"
head_description: "Færðu síður innan XLSX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLSX síður í C#"
description: "Færðu XLSX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLSX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLSX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLSX skráarsíður með því að nota C# dæmikóða">}}
