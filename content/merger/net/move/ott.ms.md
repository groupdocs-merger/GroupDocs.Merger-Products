...
############################# Head ############################
head_title: "Alihkan OTT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen OTT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan OTT Halaman Dalam C#"
description: "Alihkan OTT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan OTT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail OTT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan OTT halaman fail menggunakan kod contoh C#.">}}
