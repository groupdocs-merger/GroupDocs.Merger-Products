...
############################# Head ############################
head_title: "Teisalda VDX lehte teenuses C#"
head_description: "Teisaldage dokumendi VDX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VDX lehte rakenduses C#"
description: "Teisaldage VDX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VDX faililehte, kasutades C# näitekoodi">}}
