...
############################# Head ############################
head_title: "Pārvietot DOTM lapas programmā C#"
head_description: "Pārvietojiet lapas DOTM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot DOTM lapas programmā C#"
description: "Pārvietojiet DOTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot DOTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas DOTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot DOTM faila lapas, izmantojot C# piemēra kodu">}}
