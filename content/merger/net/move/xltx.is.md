...
############################# Head ############################
head_title: "Færa XLTX síður í C#"
head_description: "Færðu síður innan XLTX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLTX síður í C#"
description: "Færðu XLTX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLTX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLTX skráarsíður með því að nota C# dæmikóða">}}
