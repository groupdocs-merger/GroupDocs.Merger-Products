...
############################# Head ############################
head_title: "Flytt VSTX sider i C#"
head_description: "Flytt sider i et VSTX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt VSTX sider i C#"
description: "Flytt VSTX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en VSTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte VSTX filsider ved hjelp av C# eksempelkode">}}
