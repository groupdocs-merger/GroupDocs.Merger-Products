...
############################# Head ############################
head_title: "Presunúť PPTX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu PPTX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť PPTX stránok do C#"
description: "Presuňte PPTX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť PPTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru PPTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru PPTX pomocou vzorového kódu C#">}}
