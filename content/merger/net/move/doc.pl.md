...
############################# Head ############################
head_title: "Przenieś DOC strony w C#"
head_description: "Przenieś strony w dokumencie DOC w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś DOC strony w C#"
description: "Przenieś strony DOC za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików DOC do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku DOC, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść DOC strony pliku za pomocą C# przykładowego kodu">}}
