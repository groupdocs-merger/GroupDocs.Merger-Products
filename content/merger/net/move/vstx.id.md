...
############################# Head ############################
head_title: "Pindahkan VSTX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen VSTX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan VSTX Halaman Di C#"
description: "Pindahkan Halaman VSTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan VSTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file VSTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file VSTX menggunakan kode contoh C#">}}
