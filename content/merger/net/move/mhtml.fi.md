...
############################# Head ############################
head_title: "Siirrä MHTML sivua C#"
head_description: "Siirrä MHTML-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä MHTML sivua C#"
description: "Siirrä MHTML sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä MHTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja MHTML-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää MHTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
