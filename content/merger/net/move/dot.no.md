...
############################# Head ############################
head_title: "Flytt DOT sider i C#"
head_description: "Flytt sider i et DOT-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOT sider i C#"
description: "Flytt DOT sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOT filsider ved hjelp av C# eksempelkode">}}
