...
############################# Head ############################
head_title: "Sposta VSSM pagine in C#"
head_description: "Sposta le pagine all'interno di un documento VSSM in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta VSSM pagine in C#"
description: "Sposta VSSM pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta VSSM pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file VSSM implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file VSSM utilizzando il codice di esempio C#">}}
