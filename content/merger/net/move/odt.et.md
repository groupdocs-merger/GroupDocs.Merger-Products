...
############################# Head ############################
head_title: "Teisalda ODT lehte teenuses C#"
head_description: "Teisaldage dokumendi ODT lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda ODT lehte rakenduses C#"
description: "Teisaldage ODT lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda ODT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis ODT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada ODT faililehte, kasutades C# näitekoodi">}}
