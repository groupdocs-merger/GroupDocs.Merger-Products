...
############################# Head ############################
head_title: "Teisalda VSTX lehte teenuses C#"
head_description: "Teisaldage dokumendi VSTX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSTX lehte rakenduses C#"
description: "Teisaldage VSTX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSTX faililehte, kasutades C# näitekoodi">}}
