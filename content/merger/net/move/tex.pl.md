...
############################# Head ############################
head_title: "Przenieś TEX strony w C#"
head_description: "Przenieś strony w dokumencie TEX w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś TEX strony w C#"
description: "Przenieś strony TEX za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików TEX do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku TEX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść TEX strony pliku za pomocą C# przykładowego kodu">}}
