...
############################# Head ############################
head_title: "Flytta MHTML sidor i C#"
head_description: "Flytta sidor i ett MHTML-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta MHTML sidor i C#"
description: "Flytta MHTML sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta MHTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en MHTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar MHTML filsidor med hjälp av C# exempelkod">}}
