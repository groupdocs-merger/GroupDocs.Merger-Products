...
############################# Head ############################
head_title: "Alihkan HTML Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen HTML dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan HTML Halaman Dalam C#"
description: "Alihkan HTML Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan HTML Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail HTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan HTML halaman fail menggunakan kod contoh C#.">}}
