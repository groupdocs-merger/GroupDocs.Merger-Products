...
############################# Head ############################
head_title: "Flytta PPS sidor i C#"
head_description: "Flytta sidor i ett PPS-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta PPS sidor i C#"
description: "Flytta PPS sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta PPS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en PPS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar PPS filsidor med hjälp av C# exempelkod">}}
