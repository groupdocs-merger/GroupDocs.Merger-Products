...
############################# Head ############################
head_title: "Przenieś XLT strony w C#"
head_description: "Przenieś strony w dokumencie XLT w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLT strony w C#"
description: "Przenieś strony XLT za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLT do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLT strony pliku za pomocą C# przykładowego kodu">}}
