...
############################# Head ############################
head_title: "Mutați XLSB pagini în C#"
head_description: "Mutați paginile dintr-un document XLSB în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLSB pagini în C#"
description: "Mutați XLSB pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLSB pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLSB prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLSB utilizând codul exemplu C#">}}
