...
############################# Head ############################
head_title: "Teisalda DOTM lehte teenuses C#"
head_description: "Teisaldage dokumendi DOTM lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda DOTM lehte rakenduses C#"
description: "Teisaldage DOTM lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda DOTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis DOTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada DOTM faililehte, kasutades C# näitekoodi">}}
