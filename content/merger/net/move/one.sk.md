...
############################# Head ############################
head_title: "Presunúť ONE stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu ONE v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť ONE stránok do C#"
description: "Presuňte ONE stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť ONE strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru ONE implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru ONE pomocou vzorového kódu C#">}}
