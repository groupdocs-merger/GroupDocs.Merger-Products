...
############################# Head ############################
head_title: "Move EPUB Pages in C#"
head_description: "Move pages within a EPUB document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move EPUB Pages In C#"
description: "Move EPUB Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move EPUB File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a EPUB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move EPUB file pages using C# example code">}}
