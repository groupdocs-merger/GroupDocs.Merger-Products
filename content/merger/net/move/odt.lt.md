...
############################# Head ############################
head_title: "Perkelti ODT puslapius C#"
head_description: "Perkelkite puslapius ODT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti ODT puslapius C#"
description: "Perkelkite ODT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti ODT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius ODT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti ODT failo puslapius naudojant C# pavyzdinį kodą">}}
