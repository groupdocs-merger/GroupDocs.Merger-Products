...
############################# Head ############################
head_title: "Siirrä VTX sivua C#"
head_description: "Siirrä VTX-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä VTX sivua C#"
description: "Siirrä VTX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä VTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja VTX-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää VTX tiedostosivua käyttämällä C# esimerkkikoodia">}}
