...
############################# Head ############################
head_title: "XLSM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XLSM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSM oldal mozgatása a C# nyelven"
description: "Mozgasson át XLSM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLSM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XLSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájloldalak mozgatása a C# példakóddal">}}
