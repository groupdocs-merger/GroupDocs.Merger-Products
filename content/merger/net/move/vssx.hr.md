...
############################# Head ############################
head_title: "Premjesti VSSX stranice u C#"
head_description: "Premjestite stranice unutar VSSX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSSX stranice u C#"
description: "Premjesti VSSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VSSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VSSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSSX stranice datoteke koristeći C# primjer koda">}}
