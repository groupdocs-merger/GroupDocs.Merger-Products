...
############################# Head ############################
head_title: "Sposta XLTX pagine in C#"
head_description: "Sposta le pagine all'interno di un documento XLTX in C# in qualsiasi posizione utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Sposta XLTX pagine in C#"
description: "Sposta XLTX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Sposta XLTX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di spostare facilmente le pagine all'interno di un file XLTX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come spostare le pagine di file XLTX utilizzando il codice di esempio C#">}}
