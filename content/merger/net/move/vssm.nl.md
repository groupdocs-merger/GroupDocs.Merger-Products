...
############################# Head ############################
head_title: "Verplaats VSSM pagina's in C#"
head_description: "Verplaats pagina's binnen een VSSM document in C# naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats VSSM pagina's in C#"
description: "Verplaats VSSM pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verplaats VSSM bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een VSSM bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestandspagina's te verplaatsen met behulp van C# voorbeeldcode">}}
