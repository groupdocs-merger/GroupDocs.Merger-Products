...
############################# Head ############################
head_title: "Perkelti MHTML puslapius C#"
head_description: "Perkelkite puslapius MHTML dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti MHTML puslapius C#"
description: "Perkelkite MHTML puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti MHTML failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius MHTML faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti MHTML failo puslapius naudojant C# pavyzdinį kodą">}}
