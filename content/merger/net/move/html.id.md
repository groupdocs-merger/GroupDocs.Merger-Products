...
############################# Head ############################
head_title: "Pindahkan HTML Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen HTML di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan HTML Halaman Di C#"
description: "Pindahkan Halaman HTML dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan HTML Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file HTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file HTML menggunakan kode contoh C#">}}
