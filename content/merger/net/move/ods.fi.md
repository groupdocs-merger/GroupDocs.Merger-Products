...
############################# Head ############################
head_title: "Siirrä ODS sivua C#"
head_description: "Siirrä ODS-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä ODS sivua C#"
description: "Siirrä ODS sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä ODS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja ODS-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää ODS tiedostosivua käyttämällä C# esimerkkikoodia">}}
