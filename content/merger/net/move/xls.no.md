...
############################# Head ############################
head_title: "Flytt XLS sider i C#"
head_description: "Flytt sider i et XLS-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLS sider i C#"
description: "Flytt XLS sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLS filsider ved hjelp av C# eksempelkode">}}
