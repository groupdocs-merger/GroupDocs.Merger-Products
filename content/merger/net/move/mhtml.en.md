...
############################# Head ############################
head_title: "Move MHTML pages in .NET"
head_description: "Use GroupDocs.Merger for .NET to effortlessly reorder pages in MHTML documents. Process PDF, Word, Excel, PowerPoint, images, and more with ease."

############################# Header ############################
title: "Move pages in MHTML" 
description: "GroupDocs.Merger for .NET enables .NET applications to easily reorder pages in MHTML documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to move selected pages in MHTML documents. Enhance your .NET applications with advanced document processing features.
