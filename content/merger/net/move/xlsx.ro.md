...
############################# Head ############################
head_title: "Mutați XLSX pagini în C#"
head_description: "Mutați paginile dintr-un document XLSX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLSX pagini în C#"
description: "Mutați XLSX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLSX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLSX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLSX utilizând codul exemplu C#">}}
