...
############################# Head ############################
head_title: "Pindahkan TEX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen TEX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan TEX Halaman Di C#"
description: "Pindahkan Halaman TEX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan TEX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file TEX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file TEX menggunakan kode contoh C#">}}
