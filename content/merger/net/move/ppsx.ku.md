...
############################# Head ############################
head_title: "Rûpelên PPSX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek PPSX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PPSX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê PPSX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê PPSX bar dike">}}
