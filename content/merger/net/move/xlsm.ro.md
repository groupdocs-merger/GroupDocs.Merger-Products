...
############################# Head ############################
head_title: "Mutați XLSM pagini în C#"
head_description: "Mutați paginile dintr-un document XLSM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLSM pagini în C#"
description: "Mutați XLSM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLSM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLSM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLSM utilizând codul exemplu C#">}}
