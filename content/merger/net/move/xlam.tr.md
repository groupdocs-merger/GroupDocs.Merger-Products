...
############################# Head ############################
head_title: "XLAM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XLAM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLAM Sayfayı C# İçinde Taşı"
description: "XLAM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLAM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XLAM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLAM dosya sayfaları nasıl taşınır">}}
