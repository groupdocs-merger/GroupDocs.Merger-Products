...
############################# Head ############################
head_title: "Færa PPS síður í C#"
head_description: "Færðu síður innan PPS skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPS síður í C#"
description: "Færðu PPS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa PPS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í PPS skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPS skráarsíður með því að nota C# dæmikóða">}}
