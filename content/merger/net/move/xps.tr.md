...
############################# Head ############################
head_title: "XPS Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XPS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XPS Sayfayı C# İçinde Taşı"
description: "XPS Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XPS Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XPS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosya sayfaları nasıl taşınır">}}
