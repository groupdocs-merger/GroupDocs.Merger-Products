...
############################# Head ############################
head_title: "VSX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSX Sayfayı C# İçinde Taşı"
description: "VSX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSX dosya sayfaları nasıl taşınır">}}
