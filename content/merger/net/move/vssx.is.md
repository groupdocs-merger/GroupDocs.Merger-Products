...
############################# Head ############################
head_title: "Færa VSSX síður í C#"
head_description: "Færðu síður innan VSSX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSSX síður í C#"
description: "Færðu VSSX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSSX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSSX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSSX skráarsíður með því að nota C# dæmikóða">}}
