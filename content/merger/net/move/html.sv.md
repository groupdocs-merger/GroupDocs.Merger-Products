...
############################# Head ############################
head_title: "Flytta HTML sidor i C#"
head_description: "Flytta sidor i ett HTML-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta HTML sidor i C#"
description: "Flytta HTML sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta HTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en HTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar HTML filsidor med hjälp av C# exempelkod">}}
