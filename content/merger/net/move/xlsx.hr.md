...
############################# Head ############################
head_title: "Premjesti XLSX stranice u C#"
head_description: "Premjestite stranice unutar XLSX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLSX stranice u C#"
description: "Premjesti XLSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti XLSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar XLSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLSX stranice datoteke koristeći C# primjer koda">}}
