...
############################# Head ############################
head_title: "Presunúť DOTX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu DOTX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOTX stránok do C#"
description: "Presuňte DOTX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť DOTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru DOTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOTX pomocou vzorového kódu C#">}}
