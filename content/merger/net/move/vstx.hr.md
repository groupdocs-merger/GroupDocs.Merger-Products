...
############################# Head ############################
head_title: "Premjesti VSTX stranice u C#"
head_description: "Premjestite stranice unutar VSTX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VSTX stranice u C#"
description: "Premjesti VSTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VSTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VSTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VSTX stranice datoteke koristeći C# primjer koda">}}
