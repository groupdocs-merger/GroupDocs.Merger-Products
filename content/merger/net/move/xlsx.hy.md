...
############################# Head ############################
head_title: "Տեղափոխել XLSX էջ C#-ում"
head_description: "Տեղափոխեք էջերը XLSX փաստաթղթում C#-ում ցանկացած դիրք` օգտագործելով փաստաթղթերի միաձուլման API-ը:"

############################# Header ############################
title: "Տեղափոխել XLSX էջ C#-ում"
description: "Տեղափոխեք XLSX էջեր .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Տեղափոխել XLSX ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար էջերը տեղափոխել XLSX ֆայլի մեջ` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես տեղափոխել XLSX ֆայլի էջեր՝ օգտագործելով C# օրինակ կոդը">}}
