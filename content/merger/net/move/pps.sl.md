...
############################# Head ############################
head_title: "Premakni PPS strani v C#"
head_description: "Premaknite strani znotraj dokumenta PPS v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni PPS strani v C#"
description: "Premaknite strani PPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke PPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke PPS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke PPS s primerom kode C#">}}
