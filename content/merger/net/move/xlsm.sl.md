...
############################# Head ############################
head_title: "Premakni XLSM strani v C#"
head_description: "Premaknite strani znotraj dokumenta XLSM v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni XLSM strani v C#"
description: "Premaknite strani XLSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke XLSM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke XLSM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke XLSM s primerom kode C#">}}
