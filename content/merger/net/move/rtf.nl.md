...
############################# Head ############################
head_title: "Verplaats RTF pagina's in C#"
head_description: "Verplaats pagina's binnen een RTF document in C# naar elke positie met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Verplaats RTF pagina's in C#"
description: "Verplaats RTF pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verplaats RTF bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een RTF bestand te verplaatsen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe RTF bestandspagina's te verplaatsen met behulp van C# voorbeeldcode">}}
