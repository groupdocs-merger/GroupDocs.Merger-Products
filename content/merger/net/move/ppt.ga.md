...
############################# Head ############################
head_title: "Bog PPT Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad PPT in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog PPT Leathanaigh I C#"
description: "Bog PPT Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog PPT Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad PPT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas PPT leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
