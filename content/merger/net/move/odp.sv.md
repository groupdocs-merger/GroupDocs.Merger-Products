...
############################# Head ############################
head_title: "Flytta ODP sidor i C#"
head_description: "Flytta sidor i ett ODP-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta ODP sidor i C#"
description: "Flytta ODP sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta ODP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en ODP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar ODP filsidor med hjälp av C# exempelkod">}}
