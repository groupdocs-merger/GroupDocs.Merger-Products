...
############################# Head ############################
head_title: "Mutați VSSX pagini în C#"
head_description: "Mutați paginile dintr-un document VSSX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSSX pagini în C#"
description: "Mutați VSSX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSSX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSSX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSSX utilizând codul exemplu C#">}}
