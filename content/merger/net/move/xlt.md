...
############################# Head ############################
head_title: "Move XLT Pages in C#"
head_description: "Move pages within a XLT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLT Pages In C#"
description: "Move XLT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLT file pages using C# example code">}}
