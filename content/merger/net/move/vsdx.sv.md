...
############################# Head ############################
head_title: "Flytta VSDX sidor i C#"
head_description: "Flytta sidor i ett VSDX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSDX sidor i C#"
description: "Flytta VSDX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSDX filsidor med hjälp av C# exempelkod">}}
