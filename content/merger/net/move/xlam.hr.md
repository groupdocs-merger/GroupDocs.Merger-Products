...
############################# Head ############################
head_title: "Premjesti XLAM stranice u C#"
head_description: "Premjestite stranice unutar XLAM dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti XLAM stranice u C#"
description: "Premjesti XLAM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti XLAM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar XLAM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti XLAM stranice datoteke koristeći C# primjer koda">}}
