...
############################# Head ############################
head_title: "Pindahkan XLT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLT Halaman Di C#"
description: "Pindahkan Halaman XLT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLT menggunakan kode contoh C#">}}
