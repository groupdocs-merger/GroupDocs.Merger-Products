...
############################# Head ############################
head_title: "Move XLTX Pages in C#"
head_description: "Move pages within a XLTX document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLTX Pages In C#"
description: "Move XLTX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLTX file pages using C# example code">}}
