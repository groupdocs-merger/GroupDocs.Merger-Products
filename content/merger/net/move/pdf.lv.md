...
############################# Head ############################
head_title: "Pārvietot PDF lapas programmā C#"
head_description: "Pārvietojiet lapas PDF dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PDF lapas programmā C#"
description: "Pārvietojiet PDF lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PDF faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas PDF failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PDF faila lapas, izmantojot C# piemēra kodu">}}
