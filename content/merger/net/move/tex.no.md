...
############################# Head ############################
head_title: "Flytt TEX sider i C#"
head_description: "Flytt sider i et TEX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt TEX sider i C#"
description: "Flytt TEX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en TEX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte TEX filsider ved hjelp av C# eksempelkode">}}
