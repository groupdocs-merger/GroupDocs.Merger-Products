...
############################# Head ############################
head_title: "Mou VSSX pàgines a C#"
head_description: "Mou les pàgines d'un document VSSX a C# a qualsevol posició mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Mou VSSX pàgines a C#"
description: "Mou VSSX pàgines amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Mou VSSX pàgines de fitxers a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# puguin moure pàgines dins d'un fitxer VSSX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com moure pàgines de fitxers VSSX utilitzant el codi d'exemple C#">}}
