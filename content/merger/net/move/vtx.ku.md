...
############################# Head ############################
head_title: "Rûpelên VTX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek VTX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên VTX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VTX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê VTX bar dike">}}
