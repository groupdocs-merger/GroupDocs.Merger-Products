...
############################# Head ############################
head_title: "Siirrä XLSM sivua C#"
head_description: "Siirrä XLSM-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä XLSM sivua C#"
description: "Siirrä XLSM sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä XLSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja XLSM-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää XLSM tiedostosivua käyttämällä C# esimerkkikoodia">}}
