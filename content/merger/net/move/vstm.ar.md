...
############################# Head ############################
head_title: "نقل صفحات VSTM في C#"
head_description: "انقل الصفحات داخل مستند VSTM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات VSTM في C#"
description: "انقل صفحات VSTM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل VSTM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف VSTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف VSTM باستخدام كود مثال C#">}}
