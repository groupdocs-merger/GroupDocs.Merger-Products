...
############################# Head ############################
head_title: "Di chuyển EPUB Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu EPUB trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển EPUB Trang trong C#"
description: "Di chuyển các Trang EPUB với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển EPUB Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp EPUB bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp EPUB bằng mã mẫu C#">}}
