...
############################# Head ############################
head_title: "Di chuyển các trang EPUB trong .NET"
head_description: "Sử dụng GroupDocs.Merger for .NET để sắp xếp lại các trang trong tài liệu EPUB một cách hiệu quả. Xử lý PDF, Word, Excel, PowerPoint, hình ảnh và nhiều định dạng khác."

############################# Header ############################
title: "Di chuyển các trang trong EPUB" 
description: "GroupDocs.Merger for .NET cho phép các ứng dụng .NET sắp xếp lại các trang trong tài liệu EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) giúp bạn di chuyển các trang đã chọn trong tài liệu EPUB. Cải thiện các ứng dụng .NET của bạn với các tính năng xử lý tài liệu nâng cao.
      
      1. Cung cấp đường dẫn của tệp tài liệu EPUB nguồn.
