...
############################# Head ############################
head_title: "Переместить VISIO страницы на C#"
head_description: "Переместите страницы в документе VISIO на C# в любую позицию с помощью Merger API."

############################# Header ############################
title: "Переместить VISIO страницы на C#"
description: "Переместите VISIO страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Переместить страницы VISIO документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко перемещать страницы в файле VISIO, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как переместить страницы VISIO документов, используя пример кода C#">}}
