...
############################# Head ############################
head_title: "Move VSDM Pages in C#"
head_description: "Move pages within a VSDM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move VSDM Pages In C#"
description: "Move VSDM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move VSDM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a VSDM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move VSDM file pages using C# example code">}}
