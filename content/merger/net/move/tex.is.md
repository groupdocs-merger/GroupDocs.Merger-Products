...
############################# Head ############################
head_title: "Færa TEX síður í C#"
head_description: "Færðu síður innan TEX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa TEX síður í C#"
description: "Færðu TEX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa TEX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í TEX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa TEX skráarsíður með því að nota C# dæmikóða">}}
