...
############################# Head ############################
head_title: "Flytta OTT sidor i C#"
head_description: "Flytta sidor i ett OTT-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta OTT sidor i C#"
description: "Flytta OTT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta OTT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en OTT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar OTT filsidor med hjälp av C# exempelkod">}}
