...
############################# Head ############################
head_title: "Di chuyển XLAM Trang trong C#"
head_description: "Di chuyển các trang trong tài liệu XLAM trong C# đến bất kỳ vị trí nào bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Di chuyển XLAM Trang trong C#"
description: "Di chuyển các Trang XLAM với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Di chuyển XLAM Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng di chuyển các trang trong tệp XLAM bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách di chuyển các trang tệp XLAM bằng mã mẫu C#">}}
