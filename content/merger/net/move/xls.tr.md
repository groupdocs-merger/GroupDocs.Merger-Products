...
############################# Head ############################
head_title: "XLS Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir XLS belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "XLS Sayfayı C# İçinde Taşı"
description: "XLS Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "XLS Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir XLS dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLS dosya sayfaları nasıl taşınır">}}
