...
############################# Head ############################
head_title: "Pindahkan ODP Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen ODP di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan ODP Halaman Di C#"
description: "Pindahkan Halaman ODP dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan ODP Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file ODP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file ODP menggunakan kode contoh C#">}}
