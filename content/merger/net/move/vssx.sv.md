...
############################# Head ############################
head_title: "Flytta VSSX sidor i C#"
head_description: "Flytta sidor i ett VSSX-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta VSSX sidor i C#"
description: "Flytta VSSX sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta VSSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en VSSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar VSSX filsidor med hjälp av C# exempelkod">}}
