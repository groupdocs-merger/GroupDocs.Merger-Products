...
############################# Head ############################
head_title: "Rûpelên XLS di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek XLS ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên XLS Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLS biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê XLS bar dike">}}
