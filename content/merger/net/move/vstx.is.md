...
############################# Head ############################
head_title: "Færa VSTX síður í C#"
head_description: "Færðu síður innan VSTX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa VSTX síður í C#"
description: "Færðu VSTX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa VSTX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í VSTX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa VSTX skráarsíður með því að nota C# dæmikóða">}}
