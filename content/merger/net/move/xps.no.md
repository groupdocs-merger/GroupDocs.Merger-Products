...
############################# Head ############################
head_title: "Flytt XPS sider i C#"
head_description: "Flytt sider i et XPS-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XPS sider i C#"
description: "Flytt XPS sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XPS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XPS filsider ved hjelp av C# eksempelkode">}}
