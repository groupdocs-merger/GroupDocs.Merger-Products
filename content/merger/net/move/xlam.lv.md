...
############################# Head ############################
head_title: "Pārvietot XLAM lapas programmā C#"
head_description: "Pārvietojiet lapas XLAM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLAM lapas programmā C#"
description: "Pārvietojiet XLAM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLAM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLAM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLAM faila lapas, izmantojot C# piemēra kodu">}}
