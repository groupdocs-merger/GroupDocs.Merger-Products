...
############################# Head ############################
head_title: "Perkelti DOCM puslapius C#"
head_description: "Perkelkite puslapius DOCM dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOCM puslapius C#"
description: "Perkelkite DOCM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOCM failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOCM faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOCM failo puslapius naudojant C# pavyzdinį kodą">}}
