...
############################# Head ############################
head_title: "Przenieś ODP strony w C#"
head_description: "Przenieś strony w dokumencie ODP w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś ODP strony w C#"
description: "Przenieś strony ODP za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików ODP do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku ODP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść ODP strony pliku za pomocą C# przykładowego kodu">}}
