...
############################# Head ############################
head_title: "Rûpelên MHTML di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek MHTML ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên MHTML Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê MHTML biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê MHTML bar dike">}}
