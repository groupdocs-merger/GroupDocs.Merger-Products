...
############################# Head ############################
head_title: "Bog HTML Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad HTML in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog HTML Leathanaigh I C#"
description: "Bog HTML Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog HTML Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad HTML trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas HTML leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
