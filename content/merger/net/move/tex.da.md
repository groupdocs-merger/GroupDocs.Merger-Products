...
############################# Head ############################
head_title: "Flyt TEX sider i C#"
head_description: "Flyt sider i et TEX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt TEX sider i C#"
description: "Flyt TEX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en TEX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes TEX filsider ved hjælp af C# eksempelkode">}}
