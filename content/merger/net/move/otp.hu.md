...
############################# Head ############################
head_title: "OTP oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy OTP dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTP oldal mozgatása a C# nyelven"
description: "Mozgasson át OTP oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "OTP fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy OTP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP fájloldalak mozgatása a C# példakóddal">}}
