...
############################# Head ############################
head_title: "ODP oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy ODP dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODP oldal mozgatása a C# nyelven"
description: "Mozgasson át ODP oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODP fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy ODP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájloldalak mozgatása a C# példakóddal">}}
