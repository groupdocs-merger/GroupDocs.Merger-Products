...
############################# Head ############################
head_title: "Flyt XLSX sider i C#"
head_description: "Flyt sider i et XLSX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt XLSX sider i C#"
description: "Flyt XLSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt XLSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en XLSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes XLSX filsider ved hjælp af C# eksempelkode">}}
