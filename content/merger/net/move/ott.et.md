...
############################# Head ############################
head_title: "Teisalda OTT lehte teenuses C#"
head_description: "Teisaldage dokumendi OTT lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda OTT lehte rakenduses C#"
description: "Teisaldage OTT lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda OTT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis OTT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada OTT faililehte, kasutades C# näitekoodi">}}
