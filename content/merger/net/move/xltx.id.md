...
############################# Head ############################
head_title: "Pindahkan XLTX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen XLTX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan XLTX Halaman Di C#"
description: "Pindahkan Halaman XLTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan XLTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file XLTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file XLTX menggunakan kode contoh C#">}}
