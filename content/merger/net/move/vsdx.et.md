...
############################# Head ############################
head_title: "Teisalda VSDX lehte teenuses C#"
head_description: "Teisaldage dokumendi VSDX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSDX lehte rakenduses C#"
description: "Teisaldage VSDX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSDX faililehte, kasutades C# näitekoodi">}}
