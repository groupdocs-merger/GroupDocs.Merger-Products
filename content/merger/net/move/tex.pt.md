...
############################# Head ############################
head_title: "Mover TEX Páginas em C#"
head_description: "Mova as páginas em um documento TEX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover TEX Páginas em C#"
description: "Mova TEX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo TEX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo TEX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo TEX usando o código de exemplo C#">}}
