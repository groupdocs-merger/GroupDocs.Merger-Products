...
############################# Head ############################
head_title: "Siirrä OTT sivua C#"
head_description: "Siirrä OTT-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä OTT sivua C#"
description: "Siirrä OTT sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä OTT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja OTT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää OTT tiedostosivua käyttämällä C# esimerkkikoodia">}}
