...
############################# Head ############################
head_title: "Przenieś DOT strony w C#"
head_description: "Przenieś strony w dokumencie DOT w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś DOT strony w C#"
description: "Przenieś strony DOT za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików DOT do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku DOT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść DOT strony pliku za pomocą C# przykładowego kodu">}}
