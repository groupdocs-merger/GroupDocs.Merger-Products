...
############################# Head ############################
head_title: "VSTX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSTX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTX oldal mozgatása a C# nyelven"
description: "Mozgasson át VSTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájloldalak mozgatása a C# példakóddal">}}
