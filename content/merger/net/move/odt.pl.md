...
############################# Head ############################
head_title: "Przenieś ODT strony w C#"
head_description: "Przenieś strony w dokumencie ODT w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś ODT strony w C#"
description: "Przenieś strony ODT za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików ODT do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku ODT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść ODT strony pliku za pomocą C# przykładowego kodu">}}
