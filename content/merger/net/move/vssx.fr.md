...
############################# Head ############################
head_title: "Déplacer VSSX pages dans C#"
head_description: "Déplacez les pages d'un document VSSX dans C# vers n'importe quelle position à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Déplacer VSSX pages dans C#"
description: "Déplacez VSSX pages avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Déplacer VSSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de déplacer facilement des pages dans un fichier VSSX en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment déplacer les pages de fichiers VSSX à l'aide de l'exemple de code C#">}}
