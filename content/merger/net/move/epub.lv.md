...
############################# Head ############################
head_title: "Pārvietot EPUB lapas programmā C#"
head_description: "Pārvietojiet lapas EPUB dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot EPUB lapas programmā C#"
description: "Pārvietojiet EPUB lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot EPUB faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas EPUB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot EPUB faila lapas, izmantojot C# piemēra kodu">}}
