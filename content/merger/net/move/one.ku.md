...
############################# Head ############################
head_title: "Rûpelên ONE di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek ONE ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên ONE Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê ONE biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê ONE bar dike">}}
