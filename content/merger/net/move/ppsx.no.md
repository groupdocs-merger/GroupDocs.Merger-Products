...
############################# Head ############################
head_title: "Flytt PPSX sider i C#"
head_description: "Flytt sider i et PPSX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PPSX sider i C#"
description: "Flytt PPSX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en PPSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PPSX filsider ved hjelp av C# eksempelkode">}}
