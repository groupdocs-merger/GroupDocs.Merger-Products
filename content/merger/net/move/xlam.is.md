...
############################# Head ############################
head_title: "Færa XLAM síður í C#"
head_description: "Færðu síður innan XLAM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa XLAM síður í C#"
description: "Færðu XLAM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa XLAM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í XLAM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa XLAM skráarsíður með því að nota C# dæmikóða">}}
