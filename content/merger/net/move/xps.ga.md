...
############################# Head ############################
head_title: "Bog XPS Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad XPS in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog XPS Leathanaigh I C#"
description: "Bog XPS Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog XPS Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad XPS trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XPS leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
