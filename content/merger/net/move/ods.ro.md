...
############################# Head ############################
head_title: "Mutați ODS pagini în C#"
head_description: "Mutați paginile dintr-un document ODS în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați ODS pagini în C#"
description: "Mutați ODS pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați ODS pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier ODS prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere ODS utilizând codul exemplu C#">}}
