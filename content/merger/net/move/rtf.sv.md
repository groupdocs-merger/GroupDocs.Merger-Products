...
############################# Head ############################
head_title: "Flytta RTF sidor i C#"
head_description: "Flytta sidor i ett RTF-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta RTF sidor i C#"
description: "Flytta RTF sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta RTF filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en RTF-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar RTF filsidor med hjälp av C# exempelkod">}}
