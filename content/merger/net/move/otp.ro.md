...
############################# Head ############################
head_title: "Mutați OTP pagini în C#"
head_description: "Mutați paginile dintr-un document OTP în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați OTP pagini în C#"
description: "Mutați OTP pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați OTP pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier OTP prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere OTP utilizând codul exemplu C#">}}
