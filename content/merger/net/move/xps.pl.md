...
############################# Head ############################
head_title: "Przenieś XPS strony w C#"
head_description: "Przenieś strony w dokumencie XPS w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XPS strony w C#"
description: "Przenieś strony XPS za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XPS do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XPS strony pliku za pomocą C# przykładowego kodu">}}
