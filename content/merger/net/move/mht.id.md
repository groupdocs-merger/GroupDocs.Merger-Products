...
############################# Head ############################
head_title: "Pindahkan MHT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen MHT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan MHT Halaman Di C#"
description: "Pindahkan Halaman MHT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan MHT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file MHT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file MHT menggunakan kode contoh C#">}}
