...
############################# Head ############################
head_title: "Teisalda EPUB lehte teenuses C#"
head_description: "Teisaldage dokumendi EPUB lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda EPUB lehte rakenduses C#"
description: "Teisaldage EPUB lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda EPUB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis EPUB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada EPUB faililehte, kasutades C# näitekoodi">}}
