...
############################# Head ############################
head_title: "Presunúť ODP stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu ODP v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť ODP stránok do C#"
description: "Presuňte ODP stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť ODP strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru ODP implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru ODP pomocou vzorového kódu C#">}}
