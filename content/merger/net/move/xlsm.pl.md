...
############################# Head ############################
head_title: "Przenieś XLSM strony w C#"
head_description: "Przenieś strony w dokumencie XLSM w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLSM strony w C#"
description: "Przenieś strony XLSM za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLSM do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLSM strony pliku za pomocą C# przykładowego kodu">}}
