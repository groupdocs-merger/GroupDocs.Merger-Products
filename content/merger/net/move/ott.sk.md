...
############################# Head ############################
head_title: "Presunúť OTT stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu OTT v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť OTT stránok do C#"
description: "Presuňte OTT stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť OTT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru OTT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru OTT pomocou vzorového kódu C#">}}
