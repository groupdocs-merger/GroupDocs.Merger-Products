...
############################# Head ############################
head_title: "Færa OTT síður í C#"
head_description: "Færðu síður innan OTT skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa OTT síður í C#"
description: "Færðu OTT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa OTT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í OTT skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa OTT skráarsíður með því að nota C# dæmikóða">}}
