...
############################# Head ############################
head_title: "Premakni MHT strani v C#"
head_description: "Premaknite strani znotraj dokumenta MHT v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni MHT strani v C#"
description: "Premaknite strani MHT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke MHT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke MHT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke MHT s primerom kode C#">}}
