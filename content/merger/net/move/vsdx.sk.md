...
############################# Head ############################
head_title: "Presunúť VSDX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu VSDX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť VSDX stránok do C#"
description: "Presuňte VSDX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť VSDX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru VSDX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru VSDX pomocou vzorového kódu C#">}}
