...
############################# Head ############################
head_title: "Flytt RTF sider i C#"
head_description: "Flytt sider i et RTF-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt RTF sider i C#"
description: "Flytt RTF sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en RTF-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte RTF filsider ved hjelp av C# eksempelkode">}}
