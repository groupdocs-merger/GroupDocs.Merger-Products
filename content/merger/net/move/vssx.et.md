...
############################# Head ############################
head_title: "Teisalda VSSX lehte teenuses C#"
head_description: "Teisaldage dokumendi VSSX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VSSX lehte rakenduses C#"
description: "Teisaldage VSSX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VSSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VSSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VSSX faililehte, kasutades C# näitekoodi">}}
