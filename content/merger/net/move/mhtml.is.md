...
############################# Head ############################
head_title: "Færa MHTML síður í C#"
head_description: "Færðu síður innan MHTML skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa MHTML síður í C#"
description: "Færðu MHTML síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa MHTML skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í MHTML skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa MHTML skráarsíður með því að nota C# dæmikóða">}}
