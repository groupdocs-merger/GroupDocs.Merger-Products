...
############################# Head ############################
head_title: "Teisalda VTX lehte teenuses C#"
head_description: "Teisaldage dokumendi VTX lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda VTX lehte rakenduses C#"
description: "Teisaldage VTX lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda VTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis VTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada VTX faililehte, kasutades C# näitekoodi">}}
