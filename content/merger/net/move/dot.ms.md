...
############################# Head ############################
head_title: "Alihkan DOT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen DOT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan DOT Halaman Dalam C#"
description: "Alihkan DOT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan DOT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail DOT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan DOT halaman fail menggunakan kod contoh C#.">}}
