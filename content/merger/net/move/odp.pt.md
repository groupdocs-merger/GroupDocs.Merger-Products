...
############################# Head ############################
head_title: "Mover ODP Páginas em C#"
head_description: "Mova as páginas em um documento ODP em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover ODP Páginas em C#"
description: "Mova ODP Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo ODP em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo ODP implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo ODP usando o código de exemplo C#">}}
