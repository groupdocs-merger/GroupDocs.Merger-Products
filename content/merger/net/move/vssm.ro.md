...
############################# Head ############################
head_title: "Mutați VSSM pagini în C#"
head_description: "Mutați paginile dintr-un document VSSM în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSSM pagini în C#"
description: "Mutați VSSM pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSSM pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSSM prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSSM utilizând codul exemplu C#">}}
