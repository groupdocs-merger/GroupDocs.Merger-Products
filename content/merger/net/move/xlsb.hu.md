...
############################# Head ############################
head_title: "XLSB oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy XLSB dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSB oldal mozgatása a C# nyelven"
description: "Mozgasson át XLSB oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLSB fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy XLSB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB fájloldalak mozgatása a C# példakóddal">}}
