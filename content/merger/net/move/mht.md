...
############################# Head ############################
head_title: "Move MHT Pages in C#"
head_description: "Move pages within a MHT document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move MHT Pages In C#"
description: "Move MHT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move MHT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a MHT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move MHT file pages using C# example code">}}
