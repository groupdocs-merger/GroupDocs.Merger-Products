...
############################# Head ############################
head_title: "Przenieś XLS strony w C#"
head_description: "Przenieś strony w dokumencie XLS w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś XLS strony w C#"
description: "Przenieś strony XLS za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików XLS do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku XLS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść XLS strony pliku za pomocą C# przykładowego kodu">}}
