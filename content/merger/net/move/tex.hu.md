...
############################# Head ############################
head_title: "TEX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy TEX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "TEX oldal mozgatása a C# nyelven"
description: "Mozgasson át TEX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "TEX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy TEX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájloldalak mozgatása a C# példakóddal">}}
