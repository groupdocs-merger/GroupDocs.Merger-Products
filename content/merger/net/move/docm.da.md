...
############################# Head ############################
head_title: "Flyt DOCM sider i C#"
head_description: "Flyt sider i et DOCM-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt DOCM sider i C#"
description: "Flyt DOCM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en DOCM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes DOCM filsider ved hjælp af C# eksempelkode">}}
