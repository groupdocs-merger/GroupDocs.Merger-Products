...
############################# Head ############################
head_title: "Mutați HTML pagini în C#"
head_description: "Mutați paginile dintr-un document HTML în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați HTML pagini în C#"
description: "Mutați HTML pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați HTML pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier HTML prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere HTML utilizând codul exemplu C#">}}
