...
############################# Head ############################
head_title: "Siirrä MHT sivua C#"
head_description: "Siirrä MHT-asiakirjan sivuja C#:ssa mihin tahansa kohtaan käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Siirrä MHT sivua C#"
description: "Siirrä MHT sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Siirrä MHT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi siirtää sivuja MHT-tiedostossa muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka siirtää MHT tiedostosivua käyttämällä C# esimerkkikoodia">}}
