...
############################# Head ############################
head_title: "Rûpelên PDF di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek PDF ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PDF Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê PDF biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê PDF bar dike">}}
