...
############################# Head ############################
head_title: "Alihkan XLSM Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen XLSM dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan XLSM Halaman Dalam C#"
description: "Alihkan XLSM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan XLSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail XLSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan XLSM halaman fail menggunakan kod contoh C#.">}}
