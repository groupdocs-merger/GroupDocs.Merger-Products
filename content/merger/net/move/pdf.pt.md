...
############################# Head ############################
head_title: "Mover páginas de PDF em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos PDF de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em PDF" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos PDF."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos PDF. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
