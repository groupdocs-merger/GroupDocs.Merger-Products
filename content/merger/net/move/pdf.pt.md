...
############################# Head ############################
head_title: "Mover PDF Páginas em C#"
head_description: "Mova as páginas em um documento PDF em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PDF Páginas em C#"
description: "Mova PDF Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PDF em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo PDF implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PDF usando o código de exemplo C#">}}
