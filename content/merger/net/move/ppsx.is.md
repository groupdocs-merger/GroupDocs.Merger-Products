...
############################# Head ############################
head_title: "Færa PPSX síður í C#"
head_description: "Færðu síður innan PPSX skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa PPSX síður í C#"
description: "Færðu PPSX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa PPSX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í PPSX skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa PPSX skráarsíður með því að nota C# dæmikóða">}}
