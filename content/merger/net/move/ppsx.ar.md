...
############################# Head ############################
head_title: "نقل صفحات PPSX في C#"
head_description: "انقل الصفحات داخل مستند PPSX في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات PPSX في C#"
description: "انقل صفحات PPSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل PPSX صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف PPSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف PPSX باستخدام كود مثال C#">}}
