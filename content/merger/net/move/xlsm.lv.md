...
############################# Head ############################
head_title: "Pārvietot XLSM lapas programmā C#"
head_description: "Pārvietojiet lapas XLSM dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLSM lapas programmā C#"
description: "Pārvietojiet XLSM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLSM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLSM faila lapas, izmantojot C# piemēra kodu">}}
