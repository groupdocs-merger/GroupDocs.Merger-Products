...
############################# Head ############################
head_title: "Perkelti DOT puslapius C#"
head_description: "Perkelkite puslapius DOT dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOT puslapius C#"
description: "Perkelkite DOT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOT failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOT faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOT failo puslapius naudojant C# pavyzdinį kodą">}}
