...
############################# Head ############################
head_title: "Premjesti VTX stranice u C#"
head_description: "Premjestite stranice unutar VTX dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti VTX stranice u C#"
description: "Premjesti VTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti VTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar VTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti VTX stranice datoteke koristeći C# primjer koda">}}
