...
############################# Head ############################
head_title: "Przenieś PPS strony w C#"
head_description: "Przenieś strony w dokumencie PPS w C# w dowolne miejsce za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Przenieś PPS strony w C#"
description: "Przenieś strony PPS za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Przenieś strony plików PPS do .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# przenoszenie stron w pliku PPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak przenieść PPS strony pliku za pomocą C# przykładowego kodu">}}
