...
############################# Head ############################
head_title: "Flyt OTP sider i C#"
head_description: "Flyt sider i et OTP-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt OTP sider i C#"
description: "Flyt OTP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en OTP-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes OTP filsider ved hjælp af C# eksempelkode">}}
