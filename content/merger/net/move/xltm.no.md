...
############################# Head ############################
head_title: "Flytt XLTM sider i C#"
head_description: "Flytt sider i et XLTM-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLTM sider i C#"
description: "Flytt XLTM sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLTM filsider ved hjelp av C# eksempelkode">}}
