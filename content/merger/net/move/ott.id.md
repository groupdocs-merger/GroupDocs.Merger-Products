...
############################# Head ############################
head_title: "Pindahkan OTT Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen OTT di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan OTT Halaman Di C#"
description: "Pindahkan Halaman OTT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan OTT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file OTT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file OTT menggunakan kode contoh C#">}}
