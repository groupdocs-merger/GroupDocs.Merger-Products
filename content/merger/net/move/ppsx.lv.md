...
############################# Head ############################
head_title: "Pārvietot PPSX lapas programmā C#"
head_description: "Pārvietojiet lapas PPSX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot PPSX lapas programmā C#"
description: "Pārvietojiet PPSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot PPSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas PPSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot PPSX faila lapas, izmantojot C# piemēra kodu">}}
