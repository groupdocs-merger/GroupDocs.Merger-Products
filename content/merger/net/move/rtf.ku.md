...
############################# Head ############################
head_title: "Rûpelên RTF di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek RTF ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên RTF Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê RTF biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê RTF bar dike">}}
