...
############################# Head ############################
head_title: "Перемістити PDF сторінки в C#"
head_description: "Перемістіть сторінки в межах документа PDF у C# у будь-яку позицію за допомогою API об’єднання документів."

############################# Header ############################
title: "Перемістити PDF сторінки в C#"
description: "Перемістіть сторінки PDF кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Перемістити PDF сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) полегшує розробникам C# переміщення сторінок у файлі PDF, виконавши кілька простих кроків .
    ...
    code: |
     ...
     {{< merger/code-merger title="Як перемістити сторінки файлу PDF за допомогою прикладу коду C#">}}
