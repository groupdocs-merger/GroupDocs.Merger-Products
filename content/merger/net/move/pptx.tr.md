...
############################# Head ############################
head_title: "PPTX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir PPTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "PPTX Sayfayı C# İçinde Taşı"
description: "PPTX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "PPTX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir PPTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosya sayfaları nasıl taşınır">}}
