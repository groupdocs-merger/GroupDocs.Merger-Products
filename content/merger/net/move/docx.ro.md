...
############################# Head ############################
head_title: "Mutați DOCX pagini în C#"
head_description: "Mutați paginile dintr-un document DOCX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați DOCX pagini în C#"
description: "Mutați DOCX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați DOCX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier DOCX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere DOCX utilizând codul exemplu C#">}}
