...
############################# Head ############################
head_title: "Mover DOT Páginas em C#"
head_description: "Mova as páginas em um documento DOT em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover DOT Páginas em C#"
description: "Mova DOT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo DOT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo DOT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo DOT usando o código de exemplo C#">}}
