...
############################# Head ############################
head_title: "Mutați XLT pagini în C#"
head_description: "Mutați paginile dintr-un document XLT în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați XLT pagini în C#"
description: "Mutați XLT pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați XLT pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier XLT prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere XLT utilizând codul exemplu C#">}}
