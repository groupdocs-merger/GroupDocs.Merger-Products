...
############################# Head ############################
head_title: "VSSM Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSSM belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "VSSM Sayfayı C# İçinde Taşı"
description: "VSSM Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "VSSM Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSSM dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSM dosya sayfaları nasıl taşınır">}}
