...
############################# Head ############################
head_title: "Flytt DOTX sider i C#"
head_description: "Flytt sider i et DOTX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt DOTX sider i C#"
description: "Flytt DOTX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en DOTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte DOTX filsider ved hjelp av C# eksempelkode">}}
