...
############################# Head ############################
head_title: "Premjesti DOTM stranice u C#"
head_description: "Premjestite stranice unutar DOTM dokumenta u C# na bilo koje mjesto pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Premjesti DOTM stranice u C#"
description: "Premjesti DOTM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Premjesti DOTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima premještanje stranica unutar DOTM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premjestiti DOTM stranice datoteke koristeći C# primjer koda">}}
