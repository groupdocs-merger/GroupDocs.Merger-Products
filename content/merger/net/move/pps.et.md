...
############################# Head ############################
head_title: "Teisalda PPS lehte teenuses C#"
head_description: "Teisaldage dokumendi PPS lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda PPS lehte rakenduses C#"
description: "Teisaldage PPS lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda PPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis PPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada PPS faililehte, kasutades C# näitekoodi">}}
