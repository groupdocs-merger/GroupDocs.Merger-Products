...
############################# Head ############################
head_title: "Flyt PPTX sider i C#"
head_description: "Flyt sider i et PPTX-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt PPTX sider i C#"
description: "Flyt PPTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en PPTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes PPTX filsider ved hjælp af C# eksempelkode">}}
