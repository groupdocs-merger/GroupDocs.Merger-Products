...
############################# Head ############################
head_title: "Flytta OTP sidor i C#"
head_description: "Flytta sidor i ett OTP-dokument i C# till valfri position med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Flytta OTP sidor i C#"
description: "Flytta OTP sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Flytta OTP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att flytta sidor i en OTP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man flyttar OTP filsidor med hjälp av C# exempelkod">}}
