...
############################# Head ############################
head_title: "Přesunout MHT stránky v C#"
head_description: "Přesunout stránky v dokumentu MHT v C# na libovolnou pozici pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Přesunout MHT stránky do C#"
description: "Přesuňte MHT stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Přesunout MHT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# přesouvat stránky v souboru MHT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak přesunout stránky souboru MHT pomocí ukázkového kódu C#">}}
