...
############################# Head ############################
head_title: "Move DOTM Pages in C#"
head_description: "Move pages within a DOTM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move DOTM Pages In C#"
description: "Move DOTM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a DOTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move DOTM file pages using C# example code">}}
