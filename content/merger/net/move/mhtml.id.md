...
############################# Head ############################
head_title: "Pindahkan MHTML Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen MHTML di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan MHTML Halaman Di C#"
description: "Pindahkan Halaman MHTML dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan MHTML Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file MHTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file MHTML menggunakan kode contoh C#">}}
