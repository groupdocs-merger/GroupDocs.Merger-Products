...
############################# Head ############################
head_title: "Pindahkan halaman MHTML di .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk mengubah urutan halaman dalam dokumen MHTML. Proses PDF, Word, Excel, PowerPoint, gambar, dan lainnya secara efisien."

############################# Header ############################
title: "Pindahkan halaman dalam MHTML" 
description: "GroupDocs.Merger for .NET memungkinkan aplikasi .NET untuk mengatur ulang halaman dalam dokumen MHTML."
...
steps:
    enable: true
    title: "Cara memindahkan halaman MHTML"
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan untuk memindahkan halaman yang dipilih dalam dokumen MHTML. Tingkatkan aplikasi .NET Anda dengan fitur pemrosesan dokumen yang canggih.
      
      1. Sediakan jalur file dari dokumen MHTML sumber.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pindahkan halaman ke akhir dokumen"
      content: |
        Contoh ini menunjukkan bagaimana cara memindahkan halaman tertentu ke akhir dokumen MHTML.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
