...
############################# Head ############################
head_title: "Flytt OTP sider i C#"
head_description: "Flytt sider i et OTP-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt OTP sider i C#"
description: "Flytt OTP sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en OTP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte OTP filsider ved hjelp av C# eksempelkode">}}
