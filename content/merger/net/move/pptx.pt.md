...
############################# Head ############################
head_title: "Mover páginas de PPTX em .NET"
head_description: "Use GroupDocs.Merger for .NET para reorganizar as páginas de documentos PPTX de forma eficiente. Processar PDF, Word, Excel, PowerPoint, imagens e mais."

############################# Header ############################
title: "Mover páginas em PPTX" 
description: "GroupDocs.Merger for .NET permite que aplicações .NET reorganizem facilmente as páginas de documentos PPTX."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a movimentação de páginas selecionadas em documentos PPTX. Amplie suas aplicações .NET com recursos avançados de processamento de documentos.
