...
############################# Head ############################
head_title: "Mover PPTX Páginas em C#"
head_description: "Mova as páginas em um documento PPTX em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover PPTX Páginas em C#"
description: "Mova PPTX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo PPTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo PPTX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo PPTX usando o código de exemplo C#">}}
