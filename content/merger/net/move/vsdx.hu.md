...
############################# Head ############################
head_title: "VSDX oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSDX dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDX oldal mozgatása a C# nyelven"
description: "Mozgasson át VSDX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSDX fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSDX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDX fájloldalak mozgatása a C# példakóddal">}}
