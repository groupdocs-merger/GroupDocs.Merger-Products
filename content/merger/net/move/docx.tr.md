...
############################# Head ############################
head_title: "DOCX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOCX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOCX Sayfayı C# İçinde Taşı"
description: "DOCX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOCX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOCX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCX dosya sayfaları nasıl taşınır">}}
