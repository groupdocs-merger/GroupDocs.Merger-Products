...
############################# Head ############################
head_title: "Alihkan ODT Halaman dalam C#"
head_description: "Alihkan halaman dalam dokumen ODT dalam C# ke mana-mana kedudukan menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Alihkan ODT Halaman Dalam C#"
description: "Alihkan ODT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Alihkan ODT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memindahkan halaman dalam fail ODT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengalihkan ODT halaman fail menggunakan kod contoh C#.">}}
