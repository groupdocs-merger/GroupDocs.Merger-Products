...
############################# Head ############################
head_title: "HTML Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir HTML belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "HTML Sayfayı C# İçinde Taşı"
description: "HTML Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "HTML Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir HTML dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak HTML dosya sayfaları nasıl taşınır">}}
