...
############################# Head ############################
head_title: "Pindahkan DOTX Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen DOTX di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan DOTX Halaman Di C#"
description: "Pindahkan Halaman DOTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan DOTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file DOTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file DOTX menggunakan kode contoh C#">}}
