...
############################# Head ############################
head_title: "Teisalda MHT lehte teenuses C#"
head_description: "Teisaldage dokumendi MHT lehed rakenduses C# mis tahes asukohta, kasutades dokumentide ühendamise API-t."

############################# Header ############################
title: "Teisalda MHT lehte rakenduses C#"
description: "Teisaldage MHT lehti mõne toote .NET koodireaga."
...
steps:
    enable: true
    title_left: "Teisalda MHT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede teisaldamise failis MHT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas teisaldada MHT faililehte, kasutades C# näitekoodi">}}
