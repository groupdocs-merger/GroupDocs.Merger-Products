...
############################# Head ############################
head_title: "VSSM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSSM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSM oldal mozgatása a C# nyelven"
description: "Mozgasson át VSSM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSSM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájloldalak mozgatása a C# példakóddal">}}
