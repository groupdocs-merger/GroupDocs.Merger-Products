...
############################# Head ############################
head_title: "DOTX Sayfayı C# İçinde Taşı"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOTX belgesindeki sayfaları herhangi bir konuma taşıyın."

############################# Header ############################
title: "DOTX Sayfayı C# İçinde Taşı"
description: "DOTX Sayfasını birkaç satır .NET koduyla taşıyın."
...
steps:
    enable: true
    title_left: "DOTX Dosya Sayfalarını .NET içinde taşıyın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOTX dosyasındaki sayfaları taşımasını kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTX dosya sayfaları nasıl taşınır">}}
