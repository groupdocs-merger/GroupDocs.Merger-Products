...
############################# Head ############################
head_title: "Rûpelên DOT di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek DOT ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên DOT Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê DOT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê DOT bar dike">}}
