...
############################# Head ############################
head_title: "Flytt XLSX sider i C#"
head_description: "Flytt sider i et XLSX-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt XLSX sider i C#"
description: "Flytt XLSX sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt XLSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en XLSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte XLSX filsider ved hjelp av C# eksempelkode">}}
