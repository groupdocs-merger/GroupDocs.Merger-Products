...
############################# Head ############################
head_title: "Færa DOTM síður í C#"
head_description: "Færðu síður innan DOTM skjals í C# á hvaða stað sem er með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Færa DOTM síður í C#"
description: "Færðu DOTM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Færa DOTM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að færa síður í DOTM skrá með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að færa DOTM skráarsíður með því að nota C# dæmikóða">}}
