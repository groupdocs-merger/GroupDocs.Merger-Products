...
############################# Head ############################
head_title: "Flyt HTML sider i C#"
head_description: "Flyt sider i et HTML-dokument i C# til en hvilken som helst position ved hjælp af documents merger API."

############################# Header ############################
title: "Flyt HTML sider i C#"
description: "Flyt HTML sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flyt HTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at flytte sider i en HTML-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flyttes HTML filsider ved hjælp af C# eksempelkode">}}
