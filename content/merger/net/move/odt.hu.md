...
############################# Head ############################
head_title: "ODT oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy ODT dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODT oldal mozgatása a C# nyelven"
description: "Mozgasson át ODT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODT fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy ODT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT fájloldalak mozgatása a C# példakóddal">}}
