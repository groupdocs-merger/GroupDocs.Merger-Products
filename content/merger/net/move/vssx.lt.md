...
############################# Head ############################
head_title: "Perkelti VSSX puslapius C#"
head_description: "Perkelkite puslapius VSSX dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti VSSX puslapius C#"
description: "Perkelkite VSSX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti VSSX failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius VSSX faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti VSSX failo puslapius naudojant C# pavyzdinį kodą">}}
