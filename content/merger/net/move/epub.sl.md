...
############################# Head ############################
head_title: "Premakni EPUB strani v C#"
head_description: "Premaknite strani znotraj dokumenta EPUB v C# na kateri koli položaj z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Premakni EPUB strani v C#"
description: "Premaknite strani EPUB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Premakni strani datoteke EPUB v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša premikanje strani znotraj datoteke EPUB z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako premikati strani datoteke EPUB s primerom kode C#">}}
