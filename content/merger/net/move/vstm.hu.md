...
############################# Head ############################
head_title: "VSTM oldal áthelyezése a C# nyelven"
head_description: "Mozgassa át az oldalakat egy VSTM dokumentumon belül a C# nyelven tetszőleges helyre a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTM oldal mozgatása a C# nyelven"
description: "Mozgasson át VSTM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSTM fájloldal áthelyezése a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára az oldalak áthelyezését egy VSTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM fájloldalak mozgatása a C# példakóddal">}}
