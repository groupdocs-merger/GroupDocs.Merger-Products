...
############################# Head ############################
head_title: "Rûpelên PPTX di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek PPTX ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên PPTX Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê PPTX biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê PPTX bar dike">}}
