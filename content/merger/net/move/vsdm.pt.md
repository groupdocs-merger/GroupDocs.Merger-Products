...
############################# Head ############################
head_title: "Mover VSDM Páginas em C#"
head_description: "Mova as páginas em um documento VSDM em C# para qualquer posição usando a API de fusão de documentos."

############################# Header ############################
title: "Mover VSDM Páginas em C#"
description: "Mova VSDM Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Mover páginas de arquivo VSDM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# mover páginas em um arquivo VSDM implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mover páginas de arquivo VSDM usando o código de exemplo C#">}}
