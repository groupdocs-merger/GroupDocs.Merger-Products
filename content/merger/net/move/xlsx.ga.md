...
############################# Head ############################
head_title: "Bog XLSX Leathanaigh i C#"
head_description: "Bog leathanaigh laistigh de dhoiciméad XLSX in C# go dtí suíomh ar bith agus úsáid á baint as an API merger doiciméad."

############################# Header ############################
title: "Bog XLSX Leathanaigh I C#"
description: "Bog XLSX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bog XLSX Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a bhogadh laistigh de chomhad XLSX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLSX leathanaigh chomhaid a bhogadh ag úsáid cód sampla C#">}}
