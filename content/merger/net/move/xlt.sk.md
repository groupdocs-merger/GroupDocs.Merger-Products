...
############################# Head ############################
head_title: "Presunúť XLT stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu XLT v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť XLT stránok do C#"
description: "Presuňte XLT stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť XLT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru XLT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru XLT pomocou vzorového kódu C#">}}
