...
############################# Head ############################
head_title: "Pārvietot XLSX lapas programmā C#"
head_description: "Pārvietojiet lapas XLSX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot XLSX lapas programmā C#"
description: "Pārvietojiet XLSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot XLSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas XLSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot XLSX faila lapas, izmantojot C# piemēra kodu">}}
