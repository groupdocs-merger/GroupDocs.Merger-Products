...
############################# Head ############################
head_title: "Perkelti DOC puslapius C#"
head_description: "Perkelkite puslapius DOC dokumente C# į bet kurią vietą naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Perkelti DOC puslapius C#"
description: "Perkelkite DOC puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Perkelti DOC failo puslapius į .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai perkelti puslapius DOC faile, atlikdami kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip perkelti DOC failo puslapius naudojant C# pavyzdinį kodą">}}
