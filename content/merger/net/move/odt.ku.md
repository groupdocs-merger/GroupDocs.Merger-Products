...
############################# Head ############################
head_title: "Rûpelên ODT di C# de biguhezînin"
head_description: "Rûpelên di nav belgeyek ODT ya di C# de bi karanîna API-ya yekkirina belgeyan veguhezîne her cîhek."

############################# Header ############################
title: "Rûpelên ODT Di C# de biguhezînin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê ODT biguhezînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# rûpelên pelê ODT bar dike">}}
