...
############################# Head ############################
head_title: "Pārvietot VSDX lapas programmā C#"
head_description: "Pārvietojiet lapas VSDX dokumentā programmā C# uz jebkuru pozīciju, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Pārvietot VSDX lapas programmā C#"
description: "Pārvietojiet VSDX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pārvietot VSDX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pārvietot lapas VSDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pārvietot VSDX faila lapas, izmantojot C# piemēra kodu">}}
