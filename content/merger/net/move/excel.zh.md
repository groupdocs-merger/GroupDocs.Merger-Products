...
############################# Head ############################
head_title: "在 C# 中移动 EXCEL 页"
head_description: "使用文档合并 API 将 C# 中的 EXCEL 文档中的页面移动到任何位置。"

############################# Header ############################
title: "在 C# 中移动 EXCEL 页"
description: "使用几行 .NET 代码移动 EXCEL 页。"
...
steps:
    enable: true
    title_left: "移动 .NET 中的 EXCEL 个文件页"
    content_left: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 让 C# 开发人员通过执行几个简单的步骤即可轻松地在 EXCEL 文件中移动页面.
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码移动 EXCEL 文件页面">}}
