...
############################# Head ############################
head_title: "نقل صفحات XLTM في C#"
head_description: "انقل الصفحات داخل مستند XLTM في C# إلى أي موضع باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "نقل صفحات XLTM في C#"
description: "انقل صفحات XLTM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "نقل XLTM صفحات الملفات في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# نقل الصفحات داخل ملف XLTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية نقل صفحات ملف XLTM باستخدام كود مثال C#">}}
