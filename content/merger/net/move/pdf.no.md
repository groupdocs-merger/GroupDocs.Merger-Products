...
############################# Head ############################
head_title: "Flytt PDF sider i C#"
head_description: "Flytt sider i et PDF-dokument i C# til en hvilken som helst posisjon ved å bruke Documents Merger API."

############################# Header ############################
title: "Flytt PDF sider i C#"
description: "Flytt PDF sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Flytt PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å flytte sider i en PDF-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan flytte PDF filsider ved hjelp av C# eksempelkode">}}
