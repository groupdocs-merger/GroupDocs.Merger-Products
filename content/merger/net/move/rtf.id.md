...
############################# Head ############################
head_title: "Pindahkan RTF Halaman di C#"
head_description: "Pindahkan halaman dalam dokumen RTF di C# ke posisi mana pun menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Pindahkan RTF Halaman Di C#"
description: "Pindahkan Halaman RTF dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pindahkan RTF Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk memindahkan halaman dalam file RTF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memindahkan halaman file RTF menggunakan kode contoh C#">}}
