...
############################# Head ############################
head_title: "Mutați VSDX pagini în C#"
head_description: "Mutați paginile dintr-un document VSDX în C# în orice poziție utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Mutați VSDX pagini în C#"
description: "Mutați VSDX pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Mutați VSDX pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să mute paginile dintr-un fișier VSDX prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să mutați pagini de fișiere VSDX utilizând codul exemplu C#">}}
