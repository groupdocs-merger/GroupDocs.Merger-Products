...
############################# Head ############################
head_title: "Presunúť DOCX stránok v C#"
head_description: "Presuňte stránky v rámci dokumentu DOCX v C# na ľubovoľnú pozíciu pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Presunúť DOCX stránok do C#"
description: "Presuňte DOCX stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Presunúť DOCX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# presúvať stránky v rámci súboru DOCX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako presunúť stránky súboru DOCX pomocou vzorového kódu C#">}}
