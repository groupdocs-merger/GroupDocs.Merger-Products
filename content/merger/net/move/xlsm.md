...
############################# Head ############################
head_title: "Move XLSM Pages in C#"
head_description: "Move pages within a XLSM document in C# to any position using the documents merger API."

############################# Header ############################
title: "Move XLSM Pages In C#"
description: "Move XLSM Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Move XLSM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to move pages within a XLSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to move XLSM file pages using C# example code">}}
