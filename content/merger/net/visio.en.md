...
############################# Head ############################
head_title: "Merge VISIO files via .NET"
head_description: "Integrate VISIO document merging into your .NET projects with GroupDocs.Merger for .NET."

############################# Header ############################
title: "Merge VISIO files" 
description: "Use GroupDocs.Merger for .NET to create powerful .NET applications that seamlessly merge and manage VISIO documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to merge VISIO documents. Add merging functionality to your .NET applications and combine multiple files effortlessly.
      
      1. Define the path to the first VISIO file.
