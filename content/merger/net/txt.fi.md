...
############################# Head ############################
head_title: "Yhdistä TXT tiedostot C# | TXT Sulautuminen"
...
############################# Header ############################
title: "TXT Sulautuminen C#"
description: "Yhdistä TXT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia TXT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää TXT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä TXT tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi TXT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) -sivustolla.
