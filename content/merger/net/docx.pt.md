...
############################# Head ############################
head_title: "Mesclar DOCX Arquivos em C# | DOCX Fusão"
head_description: "Mescle vários arquivos DOCX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "DOCX Fusão em C#"
description: "Mescle DOCX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos DOCX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOCX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar DOCX arquivos usando a API GroupDocs.Merger
