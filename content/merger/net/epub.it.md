...
############################# Head ############################
head_title: "Unisci file EPUB tramite .NET"
head_description: "Integra la fusione di documenti EPUB nei tuoi progetti .NET con GroupDocs.Merger for .NET."

############################# Header ############################
title: "Unisci file EPUB" 
description: "Utilizza GroupDocs.Merger for .NET per creare potenti applicazioni .NET che uniscono e gestiscono senza difficoltà documenti EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) rende semplice unire documenti EPUB. Aggiungi funzionalità di fusione alle tue applicazioni .NET e combina più file senza problemi.
      
      1. Definisci il percorso del primo file EPUB.
