...
############################# Head ############################
head_title: "Pelên VDX di C# de bike yek | VDX Hevgirtin"
head_description: "Gelek pelên VDX di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "VDX Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek VDX Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir VDX pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên VDX bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên VDX bi karanîna GroupDocs.Merger API-ê bikin yek
...
demos:
    ...
    content: |
       Bi seredana malpera [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) niha ji yek pelan zêdetir VDX bikin yek.
