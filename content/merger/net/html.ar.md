...
############################# Head ############################
head_title: "دمج ملفات HTML في C# | HTML الاندماج"
head_description: "دمج عدة ملفات HTML في ملف واحد باستخدام C# .NET لدمج المستندات API. دمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "HTML الاندماج في C#"
description: "دمج HTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات HTML"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من HTML داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات HTML باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات HTML باستخدام GroupDocs.Merger API
