...
############################# Header ############################
title: "TEX Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa TEX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu TEX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex).
