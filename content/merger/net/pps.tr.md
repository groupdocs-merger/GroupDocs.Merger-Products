...
############################# Head ############################
head_title: "PPS Dosyalarını C# İçinde Birleştir | PPS Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPS dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPS dosyalarını birleştirin
