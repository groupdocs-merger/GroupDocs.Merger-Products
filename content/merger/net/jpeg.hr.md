...
############################# Head ############################
head_title: "Spoji JPEG datoteke u C# | JPEG Spajanje"
head_description: "Spojite više JPEG datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "JPEG Spajanje u C#"
description: "Spoji JPEG s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti JPEG datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Spoji JPEG datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    ...
    content: |
       Spojite više od jedne JPEG datoteke upravo sada tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) web mjesto.
