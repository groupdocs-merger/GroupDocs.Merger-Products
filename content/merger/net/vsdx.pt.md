...
############################# Head ############################
head_title: "Mesclar VSDX Arquivos em C# | VSDX Fusão"
head_description: "Mescle vários arquivos VSDX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "VSDX Fusão em C#"
description: "Mescle VSDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos VSDX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos VSDX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos VSDX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar VSDX arquivos usando a API GroupDocs.Merger
