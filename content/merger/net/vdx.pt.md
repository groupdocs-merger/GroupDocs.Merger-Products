...
############################# Head ############################
head_title: "Mesclar VDX Arquivos em C# | VDX Fusão"
head_description: "Mescle vários arquivos VDX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "VDX Fusão em C#"
description: "Mescle VDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos VDX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos VDX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos VDX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar VDX arquivos usando a API GroupDocs.Merger
