...
############################# Head ############################
head_title: "Flet DOTX filer i C# | DOTX Fusion"
head_description: "Flet flere DOTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "DOTX fusion i C#"
description: "Flet DOTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere DOTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere DOTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes DOTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet DOTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én DOTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx).
