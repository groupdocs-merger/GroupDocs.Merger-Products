...
############################# Head ############################
head_title: "Slå sammen HTML-filer i C# | HTML Fusjon"
...
############################# Header ############################
title: "HTML sammenslåing i C#"
description: "Slå sammen HTML med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere HTML-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen HTML filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen HTML filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én HTML-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
