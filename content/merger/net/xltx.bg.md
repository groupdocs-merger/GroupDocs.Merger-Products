...
############################# Head ############################
head_title: "Обединете XLTX файлове в C# | XLTX Сливане"
head_description: "Обединете няколко файла XLTX в един файл с помощта на API за сливане на документи C# .NET. Обединете конкретни страници или диапазони от различни документи в един документ."

############################# Header ############################
title: "XLTX Обединяване в C#"
description: "Обединете XLTX с няколко реда от кода на .NET."
...
steps:
    enable: true
    title_left: "Как да обедините няколко XLTX файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да обединят два или повече XLTX файла в техните приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините XLTX файлове с C# примерен код">}}

        ```csharp    
        // Обединете XLTX файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Обединете повече от един XLTX файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
