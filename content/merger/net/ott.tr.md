...
############################# Head ############################
head_title: "OTT Dosyalarını C# İçinde Birleştir | OTT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak OTT dosyalarını birleştirin
