...
############################# Head ############################
head_title: "Gộp các tệp JPEG qua .NET"
head_description: "Tích hợp việc gộp tài liệu JPEG vào các dự án .NET của bạn với GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gộp các tệp JPEG" 
description: "Sử dụng GroupDocs.Merger for .NET để tạo ra các ứng dụng .NET mạnh mẽ có khả năng gộp và quản lý tài liệu JPEG một cách liền mạch."
...
steps:
    enable: true
    title: "Cách gộp các tài liệu JPEG"
    content: |
      [GroupDocs.Merger](/merger/net/) cho phép bạn gộp các tài liệu JPEG. Thêm chức năng gộp vào các ứng dụng .NET của bạn và kết hợp nhiều tệp một cách hiệu quả.
      
      1. Xác định đường dẫn đến tệp JPEG đầu tiên.
