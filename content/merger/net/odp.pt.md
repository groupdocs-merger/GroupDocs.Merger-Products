...
############################# Head ############################
head_title: "Mesclar ODP Arquivos em C# | ODP Fusão"
head_description: "Mescle vários arquivos ODP em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "ODP Fusão em C#"
description: "Mescle ODP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos ODP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos ODP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos ODP usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar ODP arquivos usando a API GroupDocs.Merger
