...
############################# Head ############################
head_title: "XPS Dosyalarını C# İçinde Birleştir | XPS Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XPS dosyalarını birleştirin
