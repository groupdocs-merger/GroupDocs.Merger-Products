...
############################# Head ############################
head_title: "Slå sammen XLS-filer i C# | XLS Fusjon"
...
############################# Header ############################
title: "XLS sammenslåing i C#"
description: "Slå sammen XLS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLS-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLS filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLS-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
