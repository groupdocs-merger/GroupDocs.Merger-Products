...
############################# Head ############################
head_title: "Voeg XLS bestanden samen in C# | XLS Fusie"
head_description: "Voeg meerdere XLS bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "XLS Fusie in C#"
description: "Voeg XLS samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLS bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLS-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLS bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg XLS bestanden samen met de GroupDocs.Merger API
