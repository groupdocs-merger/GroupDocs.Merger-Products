...
############################# Head ############################
head_title: "XLSM fájlok egyesítése a C#-ban | XLSM Egyesülés"
head_description: "Egyesítsen több XLSM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLSM Egyesülés a C# programban"
description: "Egyesítse a(z) XLSM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLSM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLSM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLSM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLSM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm) webhely meglátogatásával.
