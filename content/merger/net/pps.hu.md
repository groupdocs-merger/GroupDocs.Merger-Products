...
############################# Head ############################
head_title: "PPS fájlok egyesítése a C#-ban | PPS Egyesülés"
head_description: "Egyesítsen több PPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPS Egyesülés a C# programban"
description: "Egyesítse a(z) PPS terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPS fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPS fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPS fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen PPS fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több PPS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) webhely meglátogatásával.
