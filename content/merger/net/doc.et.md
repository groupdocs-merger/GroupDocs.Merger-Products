...
############################# Head ############################
head_title: "Ühendage DOC failid C# | DOC Ühinemine"
head_description: "Ühendage mitu DOC faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "DOC ühinemine programmis C#"
description: "Ühendage DOC mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam DOC faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita DOC faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid DOC, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks DOC faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
