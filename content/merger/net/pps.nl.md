...
############################# Head ############################
head_title: "Voeg PPS bestanden samen in C# | PPS Fusie"
head_description: "Voeg meerdere PPS bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "PPS Fusie in C#"
description: "Voeg PPS samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PPS bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPS-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPS bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg PPS bestanden samen met de GroupDocs.Merger API
