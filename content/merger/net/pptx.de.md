...
############################# Head ############################
head_title: "PPTX-Dateien in C# zusammenführen | PPTX Fusion"
head_description: "Führen Sie mehrere PPTX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "PPTX Fusion in C#"
description: "Führen Sie PPTX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere PPTX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr PPTX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie PPTX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie PPTX-Dateien mit der GroupDocs.Merger-API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine PPTX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) besuchen.
