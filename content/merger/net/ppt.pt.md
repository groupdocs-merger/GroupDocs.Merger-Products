...
############################# Head ############################
head_title: "Mesclar PPT Arquivos em C# | PPT Fusão"
head_description: "Mescle vários arquivos PPT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "PPT Fusão em C#"
description: "Mescle PPT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos PPT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos PPT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos PPT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar PPT arquivos usando a API GroupDocs.Merger
