...
############################# Head ############################
head_title: "Spoji datoteke VSSX v C# | VSSX Združitev"
head_description: "Spojite več datotek VSSX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "VSSX Združitev v C#"
description: "Spojite VSSX z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek VSSX znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke VSSX s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke VSSX z API-jem GroupDocs.Merger
