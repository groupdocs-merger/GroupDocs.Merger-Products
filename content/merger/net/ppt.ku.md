...
############################# Head ############################
head_title: "Pelên PPT di C# de bike yek | PPT Hevgirtin"
head_description: "Gelek pelên PPT di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "PPT Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek PPT Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir PPT pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên PPT bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên PPT bi karanîna GroupDocs.Merger API-ê bikin yek
