...
############################# Head ############################
head_title: "Ekstrakt VDX stranica u C#"
head_description: "Brzo izdvojite stranice iz VDX datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt VDX stranica u C#"
description: "Izdvojite VDX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt VDX stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz VDX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti VDX stranice datoteke koristeći C# primjer koda">}}
