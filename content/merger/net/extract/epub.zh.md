...
############################# Head ############################
head_title: "在 .NET 中提取 EPUB 页"
head_description: "使用 GroupDocs.Merger for .NET 快速提取 EPUB 文件中的特定页面，并将其保存为单独的文档。"

############################# Header ############################
title: "提取 EPUB 页" 
description: "将 GroupDocs.Merger for .NET 集成到您的 .NET 应用程序中，以高效处理带有高级页面提取功能的 EPUB 文件。"
...
steps:
    ...
    title: "如何提取 EPUB 页"
    content: |
      [GroupDocs.Merger](/merger/net/) 使从 EPUB 文档中提取页面变得简单。在您的 .NET 应用程序中增强无缝文档处理能力。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从文档中提取特定页面"
      content: |
        此示例展示如何从 EPUB 文件中提取选定范围的页面，并将其保存为新文档。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
