...
############################# Head ############################
head_title: "Bain HTML Leathanaigh as C#"
head_description: "Bain go tapa leathanaigh as comhad HTML in C#. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain HTML Leathanaigh I C#"
description: "Sliocht HTML Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bain HTML Leathanaigh Chomhad as .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# na leathanaigh atá ag teastáil a bhaint as comhad HTML agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid HTML a bhaint as trí úsáid a bhaint as cód samplach C#">}}
