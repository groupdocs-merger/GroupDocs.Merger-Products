...
############################# Head ############################
head_title: "Pura XLAM sivua C#"
head_description: "Pura sivut nopeasti XLAM-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLAM sivua C#"
description: "Pura XLAM sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLAM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLAM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLAM tiedostosivut käyttämällä C# esimerkkikoodia">}}
