...
############################# Head ############################
head_title: "Ekstrak ODP Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail ODP dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODP Halaman Dalam C#"
description: "Ekstrak ODP Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak ODP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail ODP dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ODP halaman fail menggunakan kod contoh C#.">}}
