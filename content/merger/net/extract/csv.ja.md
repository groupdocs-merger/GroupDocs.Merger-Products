...
head_title: "C＃ASP.NETおよびVB.NETでCSVページを抽出する"
head_description: "C＃.NETのCSVファイルからページをすばやく抽出します。ドキュメントマージAPIを使用して、選択したページを含む新しいドキュメントを保存します."

title: "C＃.NETアプリケーションでCSVページを抽出する"
description: "選択したページをCSVファイルからすばやく抽出し、.NET（C＃、ASP.NET、VB.NET、.NET Core）アプリケーション用のドキュメントマージAPIを使用して新しいドキュメントとして保存します."
...
steps:
    enable: true
    title_left: "C＃.NETでCSVファイルからページを抽出する"
    content_left: |
    ...
    code: |
        ```cs
        //GroupDocs.MergerAPIを使用してCSVファイルページを抽出します
