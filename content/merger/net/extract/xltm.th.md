...
############################# Head ############################
head_title: "แยก XLTM หน้าใน C#"
head_description: "แยกหน้าอย่างรวดเร็วจากไฟล์ XLTM ใน C# บันทึกเอกสารใหม่ที่มีหน้าที่เลือกโดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "แยก XLTM หน้าใน C#"
description: "แยก XLTM หน้าด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "แยกหน้าไฟล์ XLTM ใน .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ทำให้นักพัฒนา C# แยกหน้าที่ต้องการจากไฟล์ XLTM ได้อย่างง่ายดายและบันทึกเป็น ไฟล์ใหม่ที่มีหน้าที่เลือกโดยทำตามขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีแยกหน้าไฟล์ XLTM โดยใช้โค้ดตัวอย่าง C#">}}
