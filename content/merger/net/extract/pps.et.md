...
############################# Head ############################
head_title: "Ekstraheerige PPS lehte C#"
head_description: "Eksportige kiiresti lehed PPS failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige PPS lehte rakenduses C#"
description: "Ekstraheerige PPS lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige PPS faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist PPS ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili PPS lehekülgi, kasutades C# näidiskoodi">}}
