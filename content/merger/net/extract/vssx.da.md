...
############################# Head ############################
head_title: "Udpak VSSX sider i C#"
head_description: "Udpak hurtigt sider fra en VSSX-fil i C#. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak VSSX sider i C#"
description: "Udpak VSSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Udpak VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at udtrække de ønskede sider fra en VSSX-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes VSSX filsider ved hjælp af C# eksempelkode">}}
