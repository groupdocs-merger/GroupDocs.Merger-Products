...
############################# Head ############################
head_title: "Ekstraheerige VSDX lehte C#"
head_description: "Eksportige kiiresti lehed VSDX failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSDX lehte rakenduses C#"
description: "Ekstraheerige VSDX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSDX faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist VSDX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSDX lehekülgi, kasutades C# näidiskoodi">}}
