...
############################# Head ############################
head_title: "Bain ODS Leathanaigh as C#"
head_description: "Bain go tapa leathanaigh as comhad ODS in C#. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain ODS Leathanaigh I C#"
description: "Sliocht ODS Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bain ODS Leathanaigh Chomhad as .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# na leathanaigh atá ag teastáil a bhaint as comhad ODS agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ODS a bhaint as trí úsáid a bhaint as cód samplach C#">}}
