...
############################# Head ############################
head_title: "Pura RTF sivua C#"
head_description: "Pura sivut nopeasti RTF-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura RTF sivua C#"
description: "Pura RTF sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura RTF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut RTF-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa RTF tiedostosivut käyttämällä C# esimerkkikoodia">}}
