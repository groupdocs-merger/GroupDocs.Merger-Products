...
############################# Head ############################
head_title: "Ekstraheerige XLSX lehte C#"
head_description: "Eksportige kiiresti lehed XLSX failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLSX lehte rakenduses C#"
description: "Ekstraheerige XLSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLSX faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist XLSX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLSX lehekülgi, kasutades C# näidiskoodi">}}
