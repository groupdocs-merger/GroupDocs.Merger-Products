...
############################# Head ############################
head_title: "Extrageți XLS pagini în C#"
head_description: "Extrageți rapid pagini dintr-un fișier XLS în C#. Salvați noul document care conține paginile selectate folosind API-ul de fuziune a documentelor."

############################# Header ############################
title: "Extrageți XLS pagini în C#"
description: "Extrageți XLS pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Extrageți XLS pagini de fișiere din .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să extragă paginile dorite dintr-un fișier XLS și să le salveze ca un nou fișier care conține paginile selectate prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să extrageți pagini de fișiere XLS folosind codul exemplu C#">}}
