...
############################# Head ############################
head_title: "Ekstraheerige VSTX lehte C#"
head_description: "Eksportige kiiresti lehed VSTX failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSTX lehte rakenduses C#"
description: "Ekstraheerige VSTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSTX faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist VSTX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSTX lehekülgi, kasutades C# näidiskoodi">}}
