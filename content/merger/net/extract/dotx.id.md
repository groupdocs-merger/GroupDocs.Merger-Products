...
############################# Head ############################
head_title: "Ekstrak DOTX Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file DOTX di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOTX Halaman Di C#"
description: "Ekstrak Halaman DOTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File DOTX di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file DOTX dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file DOTX menggunakan kode contoh C#">}}
