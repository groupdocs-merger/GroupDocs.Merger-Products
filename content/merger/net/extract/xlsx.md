...
############################# Head ############################
head_title: "Extract XLSX Pages in C#"
head_description: "Quickly extract pages from a XLSX file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract XLSX Pages In C#"
description: "Extract XLSX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract XLSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a XLSX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract XLSX file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract XLSX Pages Online"
    content: |
       Extract XLSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/xlsx) website.
