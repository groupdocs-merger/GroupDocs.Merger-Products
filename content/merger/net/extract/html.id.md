...
############################# Head ############################
head_title: "Ekstrak HTML Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file HTML di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak HTML Halaman Di C#"
description: "Ekstrak Halaman HTML dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File HTML di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file HTML dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file HTML menggunakan kode contoh C#">}}
