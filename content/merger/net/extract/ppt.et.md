...
############################# Head ############################
head_title: "Ekstraheerige PPT lehte C#"
head_description: "Eksportige kiiresti lehed PPT failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige PPT lehte rakenduses C#"
description: "Ekstraheerige PPT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige PPT faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist PPT ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili PPT lehekülgi, kasutades C# näidiskoodi">}}
