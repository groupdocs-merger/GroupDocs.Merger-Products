...
############################# Head ############################
head_title: "Išskleiskite DOCM puslapius C#"
head_description: "Greitai išskleiskite puslapius iš DOCM failo C#. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite DOCM puslapius C#"
description: "Išskleiskite DOCM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite DOCM failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai išgauti norimus puslapius iš DOCM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti DOCM failo puslapius naudojant C# pavyzdinį kodą">}}
