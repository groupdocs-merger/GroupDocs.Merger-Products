...
############################# Head ############################
head_title: "Ekstraheerige VSX lehte C#"
head_description: "Eksportige kiiresti lehed VSX failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSX lehte rakenduses C#"
description: "Ekstraheerige VSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSX faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist VSX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSX lehekülgi, kasutades C# näidiskoodi">}}
