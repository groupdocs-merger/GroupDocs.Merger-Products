...
############################# Head ############################
head_title: "Extrahujte XLAM stránok v C#"
head_description: "Rýchlo extrahujte stránky zo súboru XLAM v C#. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte XLAM stránok v C#"
description: "Extrahujte XLAM stránok pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Extrahujte XLAM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# extrahovať požadované stránky zo súboru XLAM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru XLAM pomocou vzorového kódu C#">}}
