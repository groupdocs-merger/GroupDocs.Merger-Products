...
############################# Head ############################
head_title: "Pura VSTX sivua C#"
head_description: "Pura sivut nopeasti VSTX-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VSTX sivua C#"
description: "Pura VSTX sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura VSTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut VSTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VSTX tiedostosivut käyttämällä C# esimerkkikoodia">}}
