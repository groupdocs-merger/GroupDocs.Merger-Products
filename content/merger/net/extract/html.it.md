...
############################# Head ############################
head_title: "Estrai HTML pagine in C#"
head_description: "Estrai rapidamente le pagine da un file HTML in C#. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai HTML pagine in C#"
description: "Estrai HTML pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Estrai HTML pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di estrarre facilmente le pagine desiderate da un file HTML e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file HTML utilizzando il codice di esempio C#">}}
