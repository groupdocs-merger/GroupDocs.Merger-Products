...
############################# Head ############################
head_title: "Izvilkt DOT lapas programmā C#"
head_description: "Ātri izvelciet lapas no DOT faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOT lapas programmā C#"
description: "Izvelciet DOT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOT faila lapas, izmantojot C# piemēra kodu">}}
