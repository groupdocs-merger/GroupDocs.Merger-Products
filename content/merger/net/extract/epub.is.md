...
############################# Head ############################
head_title: "Dragðu út EPUB síður í C#"
head_description: "Dragðu síður út á fljótlegan hátt úr EPUB skrá í C#. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út EPUB síður í C#"
description: "Dragðu út EPUB síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Dragðu út EPUB skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar forriturum C# að draga þær síður sem óskað er eftir úr EPUB skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út EPUB skráarsíður með því að nota C# dæmi kóða">}}
