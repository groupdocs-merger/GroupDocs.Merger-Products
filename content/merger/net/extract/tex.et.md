...
############################# Head ############################
head_title: "Ekstraheerige TEX lehte C#"
head_description: "Eksportige kiiresti lehed TEX failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige TEX lehte rakenduses C#"
description: "Ekstraheerige TEX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige TEX faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist TEX ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili TEX lehekülgi, kasutades C# näidiskoodi">}}
