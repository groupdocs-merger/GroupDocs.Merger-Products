...
############################# Head ############################
head_title: "Extraire des pages XLSX dans .NET"
head_description: "Extraire rapidement des pages spécifiques d'un fichier XLSX à l'aide de GroupDocs.Merger for .NET et les enregistrer en tant que document séparé."

############################# Header ############################
title: "Extraire des pages XLSX" 
description: "Intégrez GroupDocs.Merger for .NET dans vos applications .NET pour traiter efficacement les fichiers XLSX avec des fonctionnalités avancées d'extraction de pages."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilite l'extraction de pages à partir de documents XLSX. Améliorez vos applications .NET avec des capacités de traitement de documents sans faille.
      
      1. Fournir le chemin du fichier du document XLSX source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire des pages spécifiques d'un document"
      content: |
        Cet exemple montre comment extraire une plage sélectionnée de pages d'un fichier XLSX et les enregistrer en tant que nouveau document.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
