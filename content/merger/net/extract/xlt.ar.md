...
############################# Head ############################
head_title: "استخراج صفحات XLT في C#"
head_description: "استخرج سريعًا الصفحات من ملف XLT في C#. احفظ المستند الجديد الذي يحتوي على الصفحات المحددة باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "استخراج صفحات XLT في C#"
description: "استخراج صفحات XLT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "استخراج صفحات الملف XLT في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# استخراج الصفحات المطلوبة من ملف XLT وحفظها باسم ملف جديد يحتوي على الصفحات المحددة من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية استخراج صفحات ملف XLT باستخدام كود مثال C#">}}
