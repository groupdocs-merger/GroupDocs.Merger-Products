...
############################# Head ############################
head_title: "Trích xuất các trang XLS trong C#"
head_description: "Nhanh chóng trích xuất các trang từ tệp XLS trong C#. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất XLS Trang trong C#"
description: "Trích xuất các Trang XLS với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp XLS trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng trích xuất các trang mong muốn từ tệp XLS và lưu nó dưới dạng một tệp mới chứa các trang đã chọn bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp XLS bằng mã mẫu C#">}}
