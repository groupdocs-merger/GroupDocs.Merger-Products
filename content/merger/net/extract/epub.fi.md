...
############################# Head ############################
head_title: "Pura EPUB sivua C#"
head_description: "Pura sivut nopeasti EPUB-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura EPUB sivua C#"
description: "Pura EPUB sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura EPUB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut EPUB-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa EPUB tiedostosivut käyttämällä C# esimerkkikoodia">}}
