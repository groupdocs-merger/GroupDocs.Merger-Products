...
############################# Head ############################
head_title: "Ekstrak MHTML Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file MHTML di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak MHTML Halaman Di C#"
description: "Ekstrak Halaman MHTML dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File MHTML di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file MHTML dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file MHTML menggunakan kode contoh C#">}}
