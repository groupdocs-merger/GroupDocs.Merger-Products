...
############################# Head ############################
head_title: "Extrahera ODT sidor i C#"
head_description: "Extrahera snabbt sidor från en ODT-fil i C#. Spara det nya dokumentet som innehåller de valda sidorna med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Extrahera ODT sidor i C#"
description: "Extrahera ODT sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Extrahera ODT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att extrahera önskade sidor från en ODT-fil och spara den som en ny fil som innehåller de valda sidorna genom att implementera några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man extraherar ODT filsidor med hjälp av C# exempelkod">}}
