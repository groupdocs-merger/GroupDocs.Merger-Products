...
############################# Head ############################
head_title: "Ekstrakt MHTML stranica u C#"
head_description: "Brzo izdvojite stranice iz MHTML datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt MHTML stranica u C#"
description: "Izdvojite MHTML stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt MHTML stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz MHTML datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti MHTML stranice datoteke koristeći C# primjer koda">}}
