...
############################# Head ############################
head_title: "Pura DOT sivua C#"
head_description: "Pura sivut nopeasti DOT-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOT sivua C#"
description: "Pura DOT sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura DOT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut DOT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOT tiedostosivut käyttämällä C# esimerkkikoodia">}}
