...
############################# Head ############################
head_title: "Pura XLSM sivua C#"
head_description: "Pura sivut nopeasti XLSM-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSM sivua C#"
description: "Pura XLSM sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLSM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSM tiedostosivut käyttämällä C# esimerkkikoodia">}}
