...
############################# Head ############################
head_title: "VSTM ገጾችን በC# ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከVSTM ፋይል በC# ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "VSTM ገጾችን በC# ውስጥ ያውጡ"
description: "VSTM ገጾችን ከጥቂት መስመሮች .NET ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "VSTM የፋይል ገጾችን በ.NET ያውጡ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች የሚፈለጉትን ገፆች ከVSTM ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የVSTM ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}
