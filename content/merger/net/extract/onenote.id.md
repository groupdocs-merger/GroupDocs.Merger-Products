...
############################# Head ############################
head_title: "Ekstrak ONENOTE Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file ONENOTE di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ONENOTE Halaman Di C#"
description: "Ekstrak Halaman ONENOTE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File ONENOTE di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file ONENOTE dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file ONENOTE menggunakan kode contoh C#">}}
