...
############################# Head ############################
head_title: "Ekstrak ODT Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail ODT dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ODT Halaman Dalam C#"
description: "Ekstrak ODT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak ODT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail ODT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ODT halaman fail menggunakan kod contoh C#.">}}
