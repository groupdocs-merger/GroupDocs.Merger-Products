...
############################# Head ############################
head_title: "Ekstrakt ODS stranica u C#"
head_description: "Brzo izdvojite stranice iz ODS datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt ODS stranica u C#"
description: "Izdvojite ODS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt ODS stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz ODS datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti ODS stranice datoteke koristeći C# primjer koda">}}
