...
############################# Head ############################
head_title: "Pura MHTML sivua C#"
head_description: "Pura sivut nopeasti MHTML-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura MHTML sivua C#"
description: "Pura MHTML sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura MHTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut MHTML-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa MHTML tiedostosivut käyttämällä C# esimerkkikoodia">}}
