...
############################# Head ############################
head_title: "Extrahujte OTP stránek v C#"
head_description: "Rychle extrahujte stránky ze souboru OTP v C#. Uložte nový dokument obsahující vybrané stránky pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Extrahujte OTP stránek v C#"
description: "Extrahujte OTP stránky pomocí několika řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Extrahujte OTP stránek souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# extrahovat požadované stránky ze souboru OTP a uložit jej jako nový soubor obsahující vybrané stránky provedením několika jednoduchých kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak extrahovat stránky souboru OTP pomocí ukázkového kódu C#">}}
