...
############################# Head ############################
head_title: "Izvilkt XLT lapas programmā C#"
head_description: "Ātri izvelciet lapas no XLT faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLT lapas programmā C#"
description: "Izvelciet XLT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLT un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLT faila lapas, izmantojot C# piemēra kodu">}}
