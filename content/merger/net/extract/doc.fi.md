...
############################# Head ############################
head_title: "Pura DOC sivua C#"
head_description: "Pura sivut nopeasti DOC-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOC sivua C#"
description: "Pura DOC sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura DOC tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut DOC-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOC tiedostosivut käyttämällä C# esimerkkikoodia">}}
