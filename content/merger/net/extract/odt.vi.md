...
############################# Head ############################
head_title: "Trích xuất các trang ODT trong C#"
head_description: "Nhanh chóng trích xuất các trang từ tệp ODT trong C#. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất ODT Trang trong C#"
description: "Trích xuất các Trang ODT với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp ODT trong .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp ODT bằng mã mẫu C#">}}
