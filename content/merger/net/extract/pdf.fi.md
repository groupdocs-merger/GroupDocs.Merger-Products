...
############################# Head ############################
head_title: "Pura PDF sivua C#"
head_description: "Pura sivut nopeasti PDF-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PDF sivua C#"
description: "Pura PDF sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura PDF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut PDF-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PDF tiedostosivut käyttämällä C# esimerkkikoodia">}}
