...
############################# Head ############################
head_title: "Ekstrak OTP Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file OTP di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak OTP Halaman Di C#"
description: "Ekstrak Halaman OTP dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File OTP di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file OTP dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file OTP menggunakan kode contoh C#">}}
