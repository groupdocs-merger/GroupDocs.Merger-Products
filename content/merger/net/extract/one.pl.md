...
############################# Head ############################
head_title: "Wyodrębnij strony ONE w C#"
head_description: "Szybko wyodrębnij strony z pliku ONE w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij ONE strony w C#"
description: "Wyodrębnij strony ONE z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików ONE w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku ONE i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku ONE za pomocą przykładowego kodu C#">}}
