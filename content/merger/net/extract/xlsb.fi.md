...
############################# Head ############################
head_title: "Pura XLSB sivua C#"
head_description: "Pura sivut nopeasti XLSB-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSB sivua C#"
description: "Pura XLSB sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLSB-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSB tiedostosivut käyttämällä C# esimerkkikoodia">}}
