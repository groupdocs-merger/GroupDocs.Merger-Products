...
head_description: "Quickly extract pages from a WEB file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract WEB Pages In C#"
description: "Extract WEB Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract WEB File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a WEB file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract WEB file pages using C# example code">}}
