...
############################# Head ############################
head_title: "C# で XLAM ページを抽出"
head_description: "C# の XLAM ファイルからページをすばやく抽出します。ドキュメント マージ API を使用して、選択したページを含む新しいドキュメントを保存します。"

############################# Header ############################
title: "C# の XLAM ページを抽出"
description: "数行の .NET コードで XLAM ページを抽出します。"
...
steps:
    enable: true
    title_left: ".NET で XLAM ファイル ページを抽出"
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) により、C# 開発者は XLAM ファイルから目的のページを簡単に抽出して、次のように保存できます。いくつかの簡単な手順を実行して、選択したページを含む新しいファイルを作成します。
    ...
    code: |
     ...
     {{< merger/code-merger title="C# サンプル コードを使用して XLAM ファイル ページを抽出する方法">}}
