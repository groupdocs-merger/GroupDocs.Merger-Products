...
############################# Head ############################
head_title: "Ekstrakt VSTX stranica u C#"
head_description: "Brzo izdvojite stranice iz VSTX datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt VSTX stranica u C#"
description: "Izdvojite VSTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt VSTX stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz VSTX datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti VSTX stranice datoteke koristeći C# primjer koda">}}
