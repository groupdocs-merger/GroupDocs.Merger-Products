...
############################# Head ############################
head_title: "Ekstrak DOCM Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file DOCM di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOCM Halaman Di C#"
description: "Ekstrak Halaman DOCM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File DOCM di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file DOCM dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file DOCM menggunakan kode contoh C#">}}
