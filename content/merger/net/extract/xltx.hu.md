...
############################# Head ############################
head_title: "XLTX oldal kibontása a C# nyelven"
head_description: "Gyorsan kibonthatja az oldalakat egy XLTX fájlból a C# nyelven. Mentse el a kiválasztott oldalakat tartalmazó új dokumentumot a dokumentum-egyesítési API segítségével."

############################# Header ############################
title: "XLTX oldal kibontása a C# nyelven"
description: "Bontsa ki az XLTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLTX fájloldal kibontása a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy kivonják a kívánt oldalakat egy XLTX fájlból, és más néven elmentsék a kiválasztott oldalakat tartalmazó új fájl néhány egyszerű lépés végrehajtásával.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájloldalak kibontása a C# példakóddal">}}
