...
############################# Head ############################
head_title: "Wyodrębnij strony VSDM w C#"
head_description: "Szybko wyodrębnij strony z pliku VSDM w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij VSDM strony w C#"
description: "Wyodrębnij strony VSDM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików VSDM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku VSDM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku VSDM za pomocą przykładowego kodu C#">}}

        ```csharp    
        // Wyodrębnij strony pliku VSDM za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo — wyodrębnij VSDM strony online"
    content: |
       Wyodrębnij strony plików VSDM już teraz, odwiedzając witrynę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/vsdm).
