...
############################# Head ############################
head_title: "Ekstrakt DOC stranica u C#"
head_description: "Brzo izdvojite stranice iz DOC datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt DOC stranica u C#"
description: "Izdvojite DOC stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt DOC stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz DOC datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti DOC stranice datoteke koristeći C# primjer koda">}}
