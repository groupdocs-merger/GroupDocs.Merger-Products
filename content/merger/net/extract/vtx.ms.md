...
############################# Head ############################
head_title: "Ekstrak VTX Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail VTX dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VTX Halaman Dalam C#"
description: "Ekstrak VTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak VTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail VTX dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak VTX halaman fail menggunakan kod contoh C#.">}}
