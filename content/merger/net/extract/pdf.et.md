...
############################# Head ############################
head_title: "Ekstraheerige PDF lehte C#"
head_description: "Eksportige kiiresti lehed PDF failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige PDF lehte rakenduses C#"
description: "Ekstraheerige PDF lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige PDF faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist PDF ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili PDF lehekülgi, kasutades C# näidiskoodi">}}
