...
############################# Head ############################
head_title: "在 C# 中提取 DOTX 个页面"
head_description: "从 C# 中的 DOTX 文件中快速提取页面。使用文档合并 API 保存包含所选页面的新文档。"

############################# Header ############################
title: "在 C# 中提取 DOTX 页"
description: "使用几行 .NET 代码提取 DOTX 页面。"
...
steps:
    enable: true
    title_left: "提取 .NET 中的 DOTX 个文件页"
    content_left: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 使 C# 开发人员可以轻松地从 DOTX 文件中提取所需的页面并将其另存为通过执行几个简单的步骤来创建一个包含所选页面的新文件。
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码提取 DOTX 文件页面">}}
