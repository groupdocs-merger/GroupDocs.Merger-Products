...
############################# Head ############################
head_title: "Di C# de PPTX Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek PPTX di C# de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên PPTX Di C# de derxe"
description: "Rûpelên PPTX bi çend rêzikên koda .NET derxe."
...
steps:
    enable: true
    title_left: "Di .NET de PPTX Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku rûpelên xwestinê ji pelek PPTX derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# pelên PPTX derxe">}}
