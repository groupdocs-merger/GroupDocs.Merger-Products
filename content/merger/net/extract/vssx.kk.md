...
############################# Head ############################
head_title: "C# ішіндегі VSSX беттерді шығарып алу"
head_description: "C# ішіндегі VSSX файлынан беттерді жылдам шығарып алыңыз. Таңдалған беттерді қамтитын жаңа құжатты құжаттарды біріктіру API арқылы сақтаңыз."

############################# Header ############################
title: "VSSX беттерді C# ішінен шығарып алу"
description: "VSSX .NET кодының бірнеше жолы бар VSSX беттерді шығарып алыңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі VSSX файл беттерін шығарып алыңыз"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне VSSX файлынан қажетті беттерді шығарып, оны келесідей сақтауды жеңілдетеді. бірнеше оңай қадамдарды орындау арқылы таңдалған беттерді қамтитын жаңа файл.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSX файл беттерін C# мысал кодын пайдаланып шығару жолы">}}
