...
############################# Head ############################
head_title: "C# میں DOCX صفحات نکالیں"
head_description: "C# میں کسی DOCX فائل سے جلدی سے صفحات نکالیں۔ دستاویزات کے انضمام API کا استعمال کرتے ہوئے منتخب صفحات پر مشتمل نئی دستاویز کو محفوظ کریں۔"

############################# Header ############################
title: "C# میں DOCX صفحات نکالیں"
description: "DOCX صفحات کو .NET کوڈ کی چند سطروں کے ساتھ نکالیں۔"
...
steps:
    enable: true
    title_left: ".NET میں DOCX فائل کے صفحات نکالیں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے مطلوبہ صفحات کو DOCX فائل سے نکالنا اور اسے بطور محفوظ کرنا آسان بناتا ہے۔ ایک نئی فائل جس میں چند آسان مراحل کو لاگو کرکے منتخب صفحات پر مشتمل ہے۔
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے DOCX فائل کے صفحات کو کیسے نکالا جائے۔">}}
