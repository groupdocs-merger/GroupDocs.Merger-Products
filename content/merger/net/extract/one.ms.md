...
############################# Head ############################
head_title: "Ekstrak ONE Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail ONE dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak ONE Halaman Dalam C#"
description: "Ekstrak ONE Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak ONE Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail ONE dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak ONE halaman fail menggunakan kod contoh C#.">}}
