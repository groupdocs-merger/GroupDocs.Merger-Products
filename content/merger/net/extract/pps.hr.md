...
############################# Head ############################
head_title: "Ekstrakt PPS stranica u C#"
head_description: "Brzo izdvojite stranice iz PPS datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt PPS stranica u C#"
description: "Izdvojite PPS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt PPS stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz PPS datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti PPS stranice datoteke koristeći C# primjer koda">}}
