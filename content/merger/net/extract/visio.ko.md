...
############################# Head ############################
head_title: "VISIO 페이지 추출하기 - .NET"
head_description: "GroupDocs.Merger for .NET를 사용하여 VISIO 파일에서 특정 페이지를 신속하게 추출하고 별도의 문서로 저장하세요."

############################# Header ############################
title: "VISIO 페이지 추출하기" 
description: ".NET 애플리케이션에 GroupDocs.Merger for .NET를 통합하여 VISIO 파일을 효율적으로 처리할 수 있는 고급 페이지 추출 기능을 제공합니다."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/)는 VISIO 문서에서 페이지를 추출하는 과정을 간단하게 만듭니다. 원활한 문서 처리 기능으로 .NET 애플리케이션을 향상시켜 보세요.
      
      1. 소스 VISIO 문서의 파일 경로를 제공합니다.
      2. 추출하려는 페이지를 선택합니다.
      3. 추출 프로세스를 실행합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "문서에서 특정 페이지 추출하기"
      content: |
        이 예제는 VISIO 파일에서 선택한 페이지 범위를 추출하고 새로운 문서로 저장하는 방법을 보여줍니다.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
