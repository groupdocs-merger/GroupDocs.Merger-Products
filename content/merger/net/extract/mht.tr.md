...
############################# Head ############################
head_title: "C# İçindeki MHT Sayfayı Çıkarın"
head_description: "Sayfaları bir MHT dosyasından C# içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "C# İçindeki MHT Sayfayı Çıkarın"
description: "MHT Sayfalarını birkaç satır .NET koduyla çıkarın."
...
steps:
    enable: true
    title_left: ".NET içindeki MHT Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin bir MHT dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHT dosya sayfaları nasıl ayıklanır">}}
