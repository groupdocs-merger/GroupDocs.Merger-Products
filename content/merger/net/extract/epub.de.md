...
############################# Head ############################
head_title: "Seiten von EPUB in .NET extrahieren"
head_description: "Extrahieren Sie schnell bestimmte Seiten aus einer EPUB-Datei mit GroupDocs.Merger for .NET und speichern Sie sie als separates Dokument."

############################# Header ############################
title: "Seiten von EPUB extrahieren" 
description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Anwendungen, um EPUB-Dateien effizient mit erweiterten Funktionen zur Seitenextraktion zu verarbeiten."
...
steps:
    enable: true
    title: "So extrahieren Sie Seiten von EPUB"
    content: |
      [GroupDocs.Merger](/merger/net/) erleichtert das Extrahieren von Seiten aus EPUB-Dokumenten. Verbessern Sie Ihre .NET-Anwendungen durch nahtlose Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Dateipfad des Quelldokuments im EPUB-Format an.
