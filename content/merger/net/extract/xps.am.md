...
############################# Head ############################
head_title: "XPS ገጾችን በC# ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከXPS ፋይል በC# ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "XPS ገጾችን በC# ውስጥ ያውጡ"
description: "XPS ገጾችን ከጥቂት መስመሮች .NET ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "XPS የፋይል ገጾችን በ.NET ያውጡ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች የሚፈለጉትን ገፆች ከXPS ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የXPS ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}
