...
############################# Head ############################
head_title: "Pura ODP sivua C#"
head_description: "Pura sivut nopeasti ODP-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ODP sivua C#"
description: "Pura ODP sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura ODP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut ODP-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ODP tiedostosivut käyttämällä C# esimerkkikoodia">}}
