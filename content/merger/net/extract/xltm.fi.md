...
############################# Head ############################
head_title: "Pura XLTM sivua C#"
head_description: "Pura sivut nopeasti XLTM-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLTM sivua C#"
description: "Pura XLTM sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLTM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLTM tiedostosivut käyttämällä C# esimerkkikoodia">}}
