...
############################# Head ############################
head_title: "Extract PPSX Pages in C# ASP.NET & VB.NET"
head_description: "Quickly extract pages from a PPSX file in C# .NET. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract PPSX Pages In C# .NET Applications"
description: "Quickly extract the selected pages from a PPSX file and save it as a new document using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Extract Pages from PPSX File in C# .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to extract the desired pages from a PPSX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Extract PPSX file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Exract PPSX Document Pages App"
    content: |
        Extract PPSX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) website.
