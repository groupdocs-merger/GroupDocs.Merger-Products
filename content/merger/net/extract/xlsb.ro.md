...
############################# Head ############################
head_title: "Extrageți XLSB pagini în C#"
head_description: "Extrageți rapid pagini dintr-un fișier XLSB în C#. Salvați noul document care conține paginile selectate folosind API-ul de fuziune a documentelor."

############################# Header ############################
title: "Extrageți XLSB pagini în C#"
description: "Extrageți XLSB pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Extrageți XLSB pagini de fișiere din .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să extragă paginile dorite dintr-un fișier XLSB și să le salveze ca un nou fișier care conține paginile selectate prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să extrageți pagini de fișiere XLSB folosind codul exemplu C#">}}
