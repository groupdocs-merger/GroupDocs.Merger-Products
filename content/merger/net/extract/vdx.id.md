...
head_title: "Ekstrak Halaman VDX di C# ASP.NET & VB.NET"
head_description: "Ekstrak halaman dengan cepat dari file VDX di C# .NET. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

title: "Ekstrak Halaman VDX Dalam Aplikasi C# .NET"
description: "Ekstrak halaman yang dipilih dengan cepat dari file VDX dan simpan sebagai dokumen baru menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman dari File VDX di C# .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk mengekstrak halaman yang diinginkan dari file VDX dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Halaman Dokumen Ekstrak VDX"
    content: |
        Ekstrak halaman file VDX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/VDX).
