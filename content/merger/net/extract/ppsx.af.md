...
############################# Head ############################
head_title: "Onttrek PPSX bladsye in C#"
head_description: "Onttrek bladsye vinnig uit 'n PPSX-lêer in C#. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek PPSX bladsye in C#"
description: "Onttrek PPSX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Onttrek PPSX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om die verlangde bladsye uit 'n PPSX-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêerbladsye te onttrek deur C# voorbeeldkode te gebruik">}}
