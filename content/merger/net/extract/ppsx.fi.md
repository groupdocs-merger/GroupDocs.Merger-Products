...
############################# Head ############################
head_title: "Pura PPSX sivua C#"
head_description: "Pura sivut nopeasti PPSX-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPSX sivua C#"
description: "Pura PPSX sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura PPSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut PPSX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPSX tiedostosivut käyttämällä C# esimerkkikoodia">}}
