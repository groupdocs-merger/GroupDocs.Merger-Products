...
############################# Head ############################
head_title: "C# İçindeki XLSX Sayfayı Çıkarın"
head_description: "Sayfaları bir XLSX dosyasından C# içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "C# İçindeki XLSX Sayfayı Çıkarın"
description: "XLSX Sayfalarını birkaç satır .NET koduyla çıkarın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLSX Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin bir XLSX dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSX dosya sayfaları nasıl ayıklanır">}}
