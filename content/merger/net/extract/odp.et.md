...
############################# Head ############################
head_title: "Ekstraheerige ODP lehte C#"
head_description: "Eksportige kiiresti lehed ODP failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige ODP lehte rakenduses C#"
description: "Ekstraheerige ODP lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige ODP faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist ODP ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili ODP lehekülgi, kasutades C# näidiskoodi">}}
