...
############################# Head ############################
head_title: "Ekstrak WORKSHEET Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file WORKSHEET di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak WORKSHEET Halaman Di C#"
description: "Ekstrak Halaman WORKSHEET dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File WORKSHEET di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file WORKSHEET dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file WORKSHEET menggunakan kode contoh C#">}}
