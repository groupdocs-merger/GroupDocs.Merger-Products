...
############################# Head ############################
head_title: "Pura ODS sivua C#"
head_description: "Pura sivut nopeasti ODS-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ODS sivua C#"
description: "Pura ODS sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura ODS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut ODS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ODS tiedostosivut käyttämällä C# esimerkkikoodia">}}
