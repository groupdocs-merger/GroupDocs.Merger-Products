...
############################# Head ############################
head_title: "Izvilkt XLAM lapas programmā C#"
head_description: "Ātri izvelciet lapas no XLAM faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt XLAM lapas programmā C#"
description: "Izvelciet XLAM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt XLAM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila XLAM un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt XLAM faila lapas, izmantojot C# piemēra kodu">}}
