...
############################# Head ############################
head_title: "Ekstrak VSSM Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file VSSM di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VSSM Halaman Di C#"
description: "Ekstrak Halaman VSSM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File VSSM di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file VSSM dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file VSSM menggunakan kode contoh C#">}}
