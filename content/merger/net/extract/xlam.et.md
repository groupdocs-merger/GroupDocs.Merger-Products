...
############################# Head ############################
head_title: "Ekstraheerige XLAM lehte C#"
head_description: "Eksportige kiiresti lehed XLAM failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige XLAM lehte rakenduses C#"
description: "Ekstraheerige XLAM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige XLAM faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist XLAM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili XLAM lehekülgi, kasutades C# näidiskoodi">}}
