...
############################# Head ############################
head_title: "Ekstrak EXCEL Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file EXCEL di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EXCEL Halaman Di C#"
description: "Ekstrak Halaman EXCEL dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File EXCEL di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file EXCEL dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file EXCEL menggunakan kode contoh C#">}}
