...
############################# Head ############################
head_title: "Ekstrahiraj PPS strani v C#"
head_description: "Hitro ekstrahirajte strani iz datoteke PPS v C#. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj PPS strani v C#"
description: "Izvlecite strani PPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke PPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša ekstrahiranje želenih strani iz datoteke PPS in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke PPS s primerom kode C#">}}
