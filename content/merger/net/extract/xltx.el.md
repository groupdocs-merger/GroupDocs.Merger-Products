...
############################# Head ############################
head_title: "Εξαγωγή XLTX σελίδων σε C#"
head_description: "Εξάγετε γρήγορα σελίδες από ένα αρχείο XLTX στο C#. Αποθηκεύστε το νέο έγγραφο που περιέχει τις επιλεγμένες σελίδες χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Εξαγωγή XLTX σελίδων σε C#"
description: "Εξαγωγή σελίδων XLTX με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Εξαγωγή XLTX σελίδων αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να εξαγάγουν τις επιθυμητές σελίδες από ένα αρχείο XLTX και να το αποθηκεύσουν ως ένα νέο αρχείο που περιέχει τις επιλεγμένες σελίδες εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να εξαγάγετε σελίδες αρχείου XLTX χρησιμοποιώντας παράδειγμα κώδικα C#">}}
