...
############################# Head ############################
head_title: "EPUB ገጾችን በC# ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከEPUB ፋይል በC# ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "EPUB ገጾችን በC# ውስጥ ያውጡ"
description: "EPUB ገጾችን ከጥቂት መስመሮች .NET ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "EPUB የፋይል ገጾችን በ.NET ያውጡ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች የሚፈለጉትን ገፆች ከEPUB ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የEPUB ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}
