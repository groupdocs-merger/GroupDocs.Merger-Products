...
############################# Head ############################
head_title: "C# İçindeki XPS Sayfayı Çıkarın"
head_description: "Sayfaları bir XPS dosyasından C# içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "C# İçindeki XPS Sayfayı Çıkarın"
description: "XPS Sayfalarını birkaç satır .NET koduyla çıkarın."
...
steps:
    enable: true
    title_left: ".NET içindeki XPS Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin bir XPS dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosya sayfaları nasıl ayıklanır">}}
