...
############################# Head ############################
head_title: "Extraheer XLAM pagina's in C#"
head_description: "Extraheer snel pagina's uit een XLAM bestand in C#. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer XLAM pagina's in C#"
description: "Extraheer XLAM pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Pak XLAM Bestandspagina's uit in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om de gewenste pagina's uit een XLAM bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLAM bestandspagina's te extraheren met behulp van C# voorbeeldcode">}}
