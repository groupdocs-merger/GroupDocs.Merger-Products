...
############################# Head ############################
head_title: "Onttrek XLTM bladsye in C#"
head_description: "Onttrek bladsye vinnig uit 'n XLTM-lêer in C#. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek XLTM bladsye in C#"
description: "Onttrek XLTM Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Onttrek XLTM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om die verlangde bladsye uit 'n XLTM-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTM lêerbladsye te onttrek deur C# voorbeeldkode te gebruik">}}
