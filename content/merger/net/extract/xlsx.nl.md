...
############################# Head ############################
head_title: "Extraheer XLSX pagina's in C#"
head_description: "Extraheer snel pagina's uit een XLSX bestand in C#. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer XLSX pagina's in C#"
description: "Extraheer XLSX pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Pak XLSX Bestandspagina's uit in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om de gewenste pagina's uit een XLSX bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSX bestandspagina's te extraheren met behulp van C# voorbeeldcode">}}
