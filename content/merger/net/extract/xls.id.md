...
############################# Head ############################
head_title: "Ekstrak XLS Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file XLS di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLS Halaman Di C#"
description: "Ekstrak Halaman XLS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File XLS di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file XLS dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file XLS menggunakan kode contoh C#">}}
