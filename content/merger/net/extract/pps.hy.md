...
############################# Head ############################
head_title: "Արտահանել PPS էջ C#-ում"
head_description: "Արագ հանեք էջերը PPS ֆայլից C#-ում: Պահպանեք ընտրված էջերը պարունակող նոր փաստաթուղթը՝ օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Արտահանել PPS էջ C#-ում"
description: "Հանեք PPS էջեր .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Արտահանել PPS ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար ցանկալի էջերը հանել PPS ֆայլից և պահպանել այն որպես ընտրված էջերը պարունակող նոր ֆայլ՝ կատարելով մի քանի հեշտ քայլ:
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես հանել PPS ֆայլի էջեր՝ օգտագործելով C# օրինակ կոդը">}}
