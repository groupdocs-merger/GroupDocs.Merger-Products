...
############################# Head ############################
head_title: "Ekstrak WORD Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file WORD di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak WORD Halaman Di C#"
description: "Ekstrak Halaman WORD dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File WORD di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file WORD dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file WORD menggunakan kode contoh C#">}}
