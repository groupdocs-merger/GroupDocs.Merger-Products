...
############################# Head ############################
head_title: "Ekstraheerige EPUB lehte C#"
head_description: "Eksportige kiiresti lehed EPUB failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige EPUB lehte rakenduses C#"
description: "Ekstraheerige EPUB lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige EPUB faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist EPUB ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili EPUB lehekülgi, kasutades C# näidiskoodi">}}
