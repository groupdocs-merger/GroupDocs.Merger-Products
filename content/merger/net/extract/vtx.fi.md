...
############################# Head ############################
head_title: "Pura VTX sivua C#"
head_description: "Pura sivut nopeasti VTX-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura VTX sivua C#"
description: "Pura VTX sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura VTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut VTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa VTX tiedostosivut käyttämällä C# esimerkkikoodia">}}
