...
############################# Head ############################
head_title: "Ekstrak XLT Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail XLT dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLT Halaman Dalam C#"
description: "Ekstrak XLT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak XLT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail XLT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak XLT halaman fail menggunakan kod contoh C#.">}}
