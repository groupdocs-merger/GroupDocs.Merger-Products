...
############################# Head ############################
head_title: "Ekstraheerige DOC lehte C#"
head_description: "Eksportige kiiresti lehed DOC failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige DOC lehte rakenduses C#"
description: "Ekstraheerige DOC lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige DOC faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist DOC ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili DOC lehekülgi, kasutades C# näidiskoodi">}}
