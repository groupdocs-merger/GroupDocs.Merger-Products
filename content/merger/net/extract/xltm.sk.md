...
############################# Head ############################
head_title: "Extrahujte XLTM stránok v C#"
head_description: "Rýchlo extrahujte stránky zo súboru XLTM v C#. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte XLTM stránok v C#"
description: "Extrahujte XLTM stránok pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Extrahujte XLTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# extrahovať požadované stránky zo súboru XLTM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru XLTM pomocou vzorového kódu C#">}}
