...
############################# Head ############################
head_title: "Pura PPS sivua C#"
head_description: "Pura sivut nopeasti PPS-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPS sivua C#"
description: "Pura PPS sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura PPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut PPS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPS tiedostosivut käyttämällä C# esimerkkikoodia">}}
