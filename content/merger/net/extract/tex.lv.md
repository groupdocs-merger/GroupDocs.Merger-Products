...
############################# Head ############################
head_title: "Izvilkt TEX lapas programmā C#"
head_description: "Ātri izvelciet lapas no TEX faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt TEX lapas programmā C#"
description: "Izvelciet TEX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt TEX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila TEX un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt TEX faila lapas, izmantojot C# piemēra kodu">}}
