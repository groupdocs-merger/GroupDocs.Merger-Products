...
############################# Head ############################
head_title: "Išskleiskite VSDM puslapius C#"
head_description: "Greitai išskleiskite puslapius iš VSDM failo C#. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSDM puslapius C#"
description: "Išskleiskite VSDM puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSDM failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai išgauti norimus puslapius iš VSDM failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSDM failo puslapius naudojant C# pavyzdinį kodą">}}
