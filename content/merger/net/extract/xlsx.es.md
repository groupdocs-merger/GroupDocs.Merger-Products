...
############################# Head ############################
head_title: "Extraer páginas de XLSX en .NET"
head_description: "Extrae rápidamente páginas específicas de un archivo XLSX usando GroupDocs.Merger for .NET y guárdalas como un documento separado."

############################# Header ############################
title: "Extraer páginas de XLSX" 
description: "Integra GroupDocs.Merger for .NET en tus aplicaciones .NET para procesar eficientemente archivos XLSX con funciones avanzadas de extracción de páginas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita la extracción de páginas de documentos XLSX. Mejora tus aplicaciones .NET con capacidades de procesamiento de documentos perfectamente integradas.
      
      1. Proporciona la ruta del archivo del documento XLSX de origen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraer páginas específicas de un documento"
      content: |
        Este ejemplo muestra cómo extraer un rango seleccionado de páginas de un archivo XLSX y guardarlas como un nuevo documento.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
