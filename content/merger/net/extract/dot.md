...
############################# Head ############################
head_title: "Extract DOT Pages in C#"
head_description: "Quickly extract pages from a DOT file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract DOT Pages In C#"
description: "Extract DOT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract DOT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a DOT file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract DOT file pages using C# example code">}}
