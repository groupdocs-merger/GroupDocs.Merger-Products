...
############################# Head ############################
head_title: "Pura OTT sivua C#"
head_description: "Pura sivut nopeasti OTT-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura OTT sivua C#"
description: "Pura OTT sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura OTT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut OTT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa OTT tiedostosivut käyttämällä C# esimerkkikoodia">}}
