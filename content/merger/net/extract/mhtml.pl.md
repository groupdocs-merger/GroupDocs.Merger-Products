...
############################# Head ############################
head_title: "Wyodrębnij strony MHTML w C#"
head_description: "Szybko wyodrębnij strony z pliku MHTML w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij MHTML strony w C#"
description: "Wyodrębnij strony MHTML z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików MHTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku MHTML i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku MHTML za pomocą przykładowego kodu C#">}}
