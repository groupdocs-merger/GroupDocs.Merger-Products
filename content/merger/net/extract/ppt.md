...
############################# Head ############################
head_title: "Extract PPT Pages in C#"
head_description: "Quickly extract pages from a PPT file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract PPT Pages In C#"
description: "Extract PPT Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract PPT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a PPT file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract PPT file pages using C# example code">}}
