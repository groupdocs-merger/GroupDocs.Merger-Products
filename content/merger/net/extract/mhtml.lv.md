...
############################# Head ############################
head_title: "Izvilkt MHTML lapas programmā C#"
head_description: "Ātri izvelciet lapas no MHTML faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt MHTML lapas programmā C#"
description: "Izvelciet MHTML lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt MHTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila MHTML un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt MHTML faila lapas, izmantojot C# piemēra kodu">}}
