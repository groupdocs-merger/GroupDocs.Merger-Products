...
############################# Head ############################
head_title: "Estrai VSDX pagine in C#"
head_description: "Estrai rapidamente le pagine da un file VSDX in C#. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai VSDX pagine in C#"
description: "Estrai VSDX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Estrai VSDX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di estrarre facilmente le pagine desiderate da un file VSDX e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file VSDX utilizzando il codice di esempio C#">}}
