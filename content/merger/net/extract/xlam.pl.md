...
############################# Head ############################
head_title: "Wyodrębnij strony XLAM w C#"
head_description: "Szybko wyodrębnij strony z pliku XLAM w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLAM strony w C#"
description: "Wyodrębnij strony XLAM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLAM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku XLAM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLAM za pomocą przykładowego kodu C#">}}
