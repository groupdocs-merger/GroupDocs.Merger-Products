...
############################# Head ############################
head_title: "Извлечь ODT страницы на C#"
head_description: "Быстрое извлечение страниц из файла ODT на C#. Сохраните новый документ, содержащий выбранные страницы, с помощью Merger API."

############################# Header ############################
title: "Извлечь ODT страницы на C#"
description: "Извлечь ODT страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Извлечь страницы ODT документов на .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как извлечь страницы ODT документов, используя пример кода C#">}}
