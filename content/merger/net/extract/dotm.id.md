...
head_title: "Ekstrak Halaman DOTM di C# ASP.NET & VB.NET"
head_description: "Ekstrak halaman dengan cepat dari file DOTM di C# .NET. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

title: "Ekstrak Halaman DOTM Dalam Aplikasi C# .NET"
description: "Ekstrak halaman yang dipilih dengan cepat dari file DOTM dan simpan sebagai dokumen baru menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman dari File DOTM di C# .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk mengekstrak halaman yang diinginkan dari file DOTM dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak halaman file DOTM menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Halaman Dokumen Ekstrak DOTM"
    content: |
        Ekstrak halaman file DOTM sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/DOTM).
