...
############################# Head ############################
head_title: "Estrai OTT pagine in C#"
head_description: "Estrai rapidamente le pagine da un file OTT in C#. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai OTT pagine in C#"
description: "Estrai OTT pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Estrai OTT pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di estrarre facilmente le pagine desiderate da un file OTT e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file OTT utilizzando il codice di esempio C#">}}
