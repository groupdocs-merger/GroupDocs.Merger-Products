...
############################# Head ############################
head_title: "Ekstrakt XLTM stranica u C#"
head_description: "Brzo izdvojite stranice iz XLTM datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt XLTM stranica u C#"
description: "Izdvojite XLTM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt XLTM stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz XLTM datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti XLTM stranice datoteke koristeći C# primjer koda">}}
