...
############################# Head ############################
head_title: "Izvilkt ODP lapas programmā C#"
head_description: "Ātri izvelciet lapas no ODP faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt ODP lapas programmā C#"
description: "Izvelciet ODP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt ODP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila ODP un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt ODP faila lapas, izmantojot C# piemēra kodu">}}
