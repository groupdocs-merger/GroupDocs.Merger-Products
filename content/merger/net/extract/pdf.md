...
############################# Head ############################
head_title: "Extract PDF Pages in C#"
head_description: "Quickly extract pages from a PDF file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract PDF Pages In C#"
description: "Extract PDF Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract PDF File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a PDF file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract PDF file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract PDF Pages Online"
    content: |
       Extract PDF file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf) website.
