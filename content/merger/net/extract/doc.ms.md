...
############################# Head ############################
head_title: "Ekstrak DOC Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail DOC dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOC Halaman Dalam C#"
description: "Ekstrak DOC Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak DOC Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail DOC dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak DOC halaman fail menggunakan kod contoh C#.">}}
