...
############################# Head ############################
head_title: "Seiten von PDF in .NET extrahieren"
head_description: "Extrahieren Sie schnell bestimmte Seiten aus einer PDF-Datei mit GroupDocs.Merger for .NET und speichern Sie sie als separates Dokument."

############################# Header ############################
title: "Seiten von PDF extrahieren" 
description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Anwendungen, um PDF-Dateien effizient mit erweiterten Funktionen zur Seitenextraktion zu verarbeiten."
...
steps:
    enable: true
    title: "So extrahieren Sie Seiten von PDF"
    content: |
      [GroupDocs.Merger](/merger/net/) erleichtert das Extrahieren von Seiten aus PDF-Dokumenten. Verbessern Sie Ihre .NET-Anwendungen durch nahtlose Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Dateipfad des Quelldokuments im PDF-Format an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Spezifische Seiten aus einem Dokument extrahieren"
      content: |
        Dieses Beispiel zeigt, wie man einen ausgewählten Seitenbereich aus einer PDF-Datei extrahiert und als neues Dokument speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
