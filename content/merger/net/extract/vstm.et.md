...
############################# Head ############################
head_title: "Ekstraheerige VSTM lehte C#"
head_description: "Eksportige kiiresti lehed VSTM failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSTM lehte rakenduses C#"
description: "Ekstraheerige VSTM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSTM faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist VSTM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSTM lehekülgi, kasutades C# näidiskoodi">}}
