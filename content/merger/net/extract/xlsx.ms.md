...
############################# Head ############################
head_title: "Ekstrak XLSX Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail XLSX dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLSX Halaman Dalam C#"
description: "Ekstrak XLSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak XLSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail XLSX dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak XLSX halaman fail menggunakan kod contoh C#.">}}
