...
############################# Head ############################
head_title: "Dragðu út MHT síður í C#"
head_description: "Dragðu síður út á fljótlegan hátt úr MHT skrá í C#. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út MHT síður í C#"
description: "Dragðu út MHT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Dragðu út MHT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar forriturum C# að draga þær síður sem óskað er eftir úr MHT skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út MHT skráarsíður með því að nota C# dæmi kóða">}}
