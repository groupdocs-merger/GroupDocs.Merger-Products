...
############################# Head ############################
head_title: "Wyodrębnij strony OTP w C#"
head_description: "Szybko wyodrębnij strony z pliku OTP w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij OTP strony w C#"
description: "Wyodrębnij strony OTP z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików OTP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku OTP i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku OTP za pomocą przykładowego kodu C#">}}
