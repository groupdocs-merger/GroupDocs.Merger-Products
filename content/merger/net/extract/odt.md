...
date: 2022-09-13T13:31:00
draft: false
otherformats: otp ott pdf pps ppsx ppt pptx rtf tex vdx vsdm vsdx vssm vssx vstm vstx

############################# Head ############################
head_title: "Extract ODT Pages in C#"
...
steps:
    enable: true
    title_left: "Extract ODT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a ODT file and save it as a new file containing the selected pages by implementing a few easy steps.
