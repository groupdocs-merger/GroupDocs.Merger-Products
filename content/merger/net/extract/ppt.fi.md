...
############################# Head ############################
head_title: "Pura PPT sivua C#"
head_description: "Pura sivut nopeasti PPT-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura PPT sivua C#"
description: "Pura PPT sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura PPT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut PPT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa PPT tiedostosivut käyttämällä C# esimerkkikoodia">}}
