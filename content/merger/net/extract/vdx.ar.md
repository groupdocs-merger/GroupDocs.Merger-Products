...
############################# Head ############################
head_title: "استخراج صفحات VDX في C#"
head_description: "استخرج سريعًا الصفحات من ملف VDX في C#. احفظ المستند الجديد الذي يحتوي على الصفحات المحددة باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "استخراج صفحات VDX في C#"
description: "استخراج صفحات VDX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "استخراج صفحات الملف VDX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# استخراج الصفحات المطلوبة من ملف VDX وحفظها باسم ملف جديد يحتوي على الصفحات المحددة من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية استخراج صفحات ملف VDX باستخدام كود مثال C#">}}
