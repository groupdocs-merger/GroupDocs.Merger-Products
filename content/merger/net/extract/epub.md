...
############################# Head ############################
head_title: "Extract EPUB Pages in C#"
head_description: "Quickly extract pages from a EPUB file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract EPUB Pages In C#"
description: "Extract EPUB Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract EPUB File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a EPUB file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract EPUB file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract EPUB Pages Online"
    content: |
       Extract EPUB file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/epub) website.
