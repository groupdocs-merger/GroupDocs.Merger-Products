...
############################# Head ############################
head_title: "Seiten von PPTX in .NET extrahieren"
head_description: "Extrahieren Sie schnell bestimmte Seiten aus einer PPTX-Datei mit GroupDocs.Merger for .NET und speichern Sie sie als separates Dokument."

############################# Header ############################
title: "Seiten von PPTX extrahieren" 
description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Anwendungen, um PPTX-Dateien effizient mit erweiterten Funktionen zur Seitenextraktion zu verarbeiten."
...
steps:
    enable: true
    title: "So extrahieren Sie Seiten von PPTX"
    content: |
      [GroupDocs.Merger](/merger/net/) erleichtert das Extrahieren von Seiten aus PPTX-Dokumenten. Verbessern Sie Ihre .NET-Anwendungen durch nahtlose Funktionen zur Dokumentenverarbeitung.
      
      1. Geben Sie den Dateipfad des Quelldokuments im PPTX-Format an.
