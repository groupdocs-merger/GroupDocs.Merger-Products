...
############################# Head ############################
head_title: "Extract PDF pages in .NET"
head_description: "Quickly extract specific pages from a PDF file using GroupDocs.Merger for .NET and save them as a separate document."

############################# Header ############################
title: "Extract PDF pages" 
description: "Integrate GroupDocs.Merger for .NET into your .NET applications to efficiently process PDF files with advanced page extraction features."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it simple to extract pages from PDF documents. Enhance your .NET applications with seamless document processing capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example shows how to extract a selected range of pages from a PDF file and save them as a new document.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
