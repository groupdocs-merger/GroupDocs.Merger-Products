...
############################# Head ############################
head_title: "C#에서 PDF 페이지 추출"
head_description: "C#의 PDF 파일에서 페이지를 빠르게 추출합니다. 문서 병합 API를 사용하여 선택한 페이지가 포함된 새 문서를 저장합니다."

############################# Header ############################
title: "C#에서 PDF 페이지 추출"
description: "몇 줄의 .NET 코드로 PDF 페이지를 추출합니다."
...
steps:
    enable: true
    title_left: ".NET에서 PDF 파일 페이지 추출"
    content_left: |
        [GroupDocs.Merger for .NET](/ko/merger/net/)를 사용하면 C# 개발자가 PDF 파일에서 원하는 페이지를 쉽게 추출하여 다른 이름으로 저장할 수 있습니다. 몇 가지 간단한 단계를 구현하여 선택한 페이지를 포함하는 새 파일.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 PDF 파일 페이지를 추출하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 PDF 파일 페이지 추출
...
demos:
    enable: true
    title: "라이브 데모 - 온라인에서 PDF 페이지 추출"
    content: |
       지금 바로 [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pdf) 웹사이트를 방문하여 PDF 파일 페이지의 압축을 풉니다.
