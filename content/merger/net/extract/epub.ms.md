...
############################# Head ############################
head_title: "Ekstrak EPUB Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail EPUB dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EPUB Halaman Dalam C#"
description: "Ekstrak EPUB Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak EPUB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail EPUB dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak EPUB halaman fail menggunakan kod contoh C#.">}}
