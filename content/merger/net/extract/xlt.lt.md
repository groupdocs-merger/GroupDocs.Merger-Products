...
############################# Head ############################
head_title: "Išskleiskite XLT puslapius C#"
head_description: "Greitai išskleiskite puslapius iš XLT failo C#. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite XLT puslapius C#"
description: "Išskleiskite XLT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite XLT failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai išgauti norimus puslapius iš XLT failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti XLT failo puslapius naudojant C# pavyzdinį kodą">}}
