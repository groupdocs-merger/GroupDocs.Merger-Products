...
############################# Head ############################
head_title: "Ekstrakt MHT stranica u C#"
head_description: "Brzo izdvojite stranice iz MHT datoteke u C#. Spremite novi dokument koji sadrži odabrane stranice pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Ekstrakt MHT stranica u C#"
description: "Izdvojite MHT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Ekstrakt MHT stranica datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima izdvajanje željenih stranica iz MHT datoteke i njihovo spremanje kao novu datoteku koja sadrži odabrane stranice provedbom nekoliko jednostavnih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako izdvojiti MHT stranice datoteke koristeći C# primjer koda">}}
