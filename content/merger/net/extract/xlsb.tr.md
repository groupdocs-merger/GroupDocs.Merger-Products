...
############################# Head ############################
head_title: "C# İçindeki XLSB Sayfayı Çıkarın"
head_description: "Sayfaları bir XLSB dosyasından C# içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "C# İçindeki XLSB Sayfayı Çıkarın"
description: "XLSB Sayfalarını birkaç satır .NET koduyla çıkarın."
...
steps:
    enable: true
    title_left: ".NET içindeki XLSB Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin bir XLSB dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosya sayfaları nasıl ayıklanır">}}
