...
############################# Head ############################
head_title: "Wyodrębnij strony PPTX w C#"
head_description: "Szybko wyodrębnij strony z pliku PPTX w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij PPTX strony w C#"
description: "Wyodrębnij strony PPTX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików PPTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku PPTX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku PPTX za pomocą przykładowego kodu C#">}}
