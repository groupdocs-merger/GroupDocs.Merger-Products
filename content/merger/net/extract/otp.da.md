...
############################# Head ############################
head_title: "Udpak OTP sider i C#"
head_description: "Udpak hurtigt sider fra en OTP-fil i C#. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak OTP sider i C#"
description: "Udpak OTP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Udpak OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at udtrække de ønskede sider fra en OTP-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes OTP filsider ved hjælp af C# eksempelkode">}}
