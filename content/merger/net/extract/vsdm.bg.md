...
############################# Head ############################
head_title: "Извличане на VSDM страници в C#"
head_description: "Бързо извличане на страници от VSDM файл в C#. Запазете новия документ, съдържащ избраните страници, като използвате API за сливане на документи."

############################# Header ############################
title: "Извличане на VSDM страници в C#"
description: "Извлечете VSDM страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Извличане на VSDM файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да извличат желаните страници от VSDM файл и да го запазват като нов файл, съдържащ избраните страници, като изпълните няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да извлечете VSDM файлови страници с помощта на C# примерен код">}}
