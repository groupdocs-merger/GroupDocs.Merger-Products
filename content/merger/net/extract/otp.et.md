...
############################# Head ############################
head_title: "Ekstraheerige OTP lehte C#"
head_description: "Eksportige kiiresti lehed OTP failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige OTP lehte rakenduses C#"
description: "Ekstraheerige OTP lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige OTP faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist OTP ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili OTP lehekülgi, kasutades C# näidiskoodi">}}
