...
############################# Head ############################
head_title: "Pura MHT sivua C#"
head_description: "Pura sivut nopeasti MHT-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura MHT sivua C#"
description: "Pura MHT sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura MHT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut MHT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa MHT tiedostosivut käyttämällä C# esimerkkikoodia">}}
