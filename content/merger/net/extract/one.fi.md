...
############################# Head ############################
head_title: "Pura ONE sivua C#"
head_description: "Pura sivut nopeasti ONE-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura ONE sivua C#"
description: "Pura ONE sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura ONE tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut ONE-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa ONE tiedostosivut käyttämällä C# esimerkkikoodia">}}
