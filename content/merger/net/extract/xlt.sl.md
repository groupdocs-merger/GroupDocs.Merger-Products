...
############################# Head ############################
head_title: "Ekstrahiraj XLT strani v C#"
head_description: "Hitro ekstrahirajte strani iz datoteke XLT v C#. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj XLT strani v C#"
description: "Izvlecite strani XLT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke XLT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša ekstrahiranje želenih strani iz datoteke XLT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke XLT s primerom kode C#">}}
