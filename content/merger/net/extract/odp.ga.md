...
############################# Head ############################
head_title: "Bain ODP Leathanaigh as C#"
head_description: "Bain go tapa leathanaigh as comhad ODP in C#. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain ODP Leathanaigh I C#"
description: "Sliocht ODP Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bain ODP Leathanaigh Chomhad as .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# na leathanaigh atá ag teastáil a bhaint as comhad ODP agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ODP a bhaint as trí úsáid a bhaint as cód samplach C#">}}
