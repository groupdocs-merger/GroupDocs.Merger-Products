...
############################# Head ############################
head_title: "Wyodrębnij strony EPUB w C#"
head_description: "Szybko wyodrębnij strony z pliku EPUB w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij EPUB strony w C#"
description: "Wyodrębnij strony EPUB z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików EPUB w .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku EPUB za pomocą przykładowego kodu C#">}}
