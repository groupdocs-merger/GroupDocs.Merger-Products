...
############################# Head ############################
head_title: "Wyodrębnij strony DOC w C#"
head_description: "Szybko wyodrębnij strony z pliku DOC w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOC strony w C#"
description: "Wyodrębnij strony DOC z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOC w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku DOC i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOC za pomocą przykładowego kodu C#">}}
