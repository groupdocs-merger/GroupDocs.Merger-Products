...
############################# Head ############################
head_title: "Izvilkt DOC lapas programmā C#"
head_description: "Ātri izvelciet lapas no DOC faila programmā C#. Saglabājiet jauno dokumentu, kurā ir atlasītās lapas, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Izvilkt DOC lapas programmā C#"
description: "Izvelciet DOC lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Izvilkt DOC faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET/lv/merger/net/) ļauj C# izstrādātājiem viegli izvilkt vajadzīgās lapas no faila DOC un saglabāt to kā jaunu failu, kurā ir atlasītās lapas, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā izvilkt DOC faila lapas, izmantojot C# piemēra kodu">}}
