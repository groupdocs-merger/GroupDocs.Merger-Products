...
############################# Head ############################
head_title: "Ekstrak PDF Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail PDF dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak PDF Halaman Dalam C#"
description: "Ekstrak PDF Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak PDF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail PDF dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak PDF halaman fail menggunakan kod contoh C#.">}}
