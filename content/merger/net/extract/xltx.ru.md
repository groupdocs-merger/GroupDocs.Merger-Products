...
############################# Head ############################
head_title: "Извлечь XLTX страницы на C#"
head_description: "Быстрое извлечение страниц из файла XLTX на C#. Сохраните новый документ, содержащий выбранные страницы, с помощью Merger API."

############################# Header ############################
title: "Извлечь XLTX страницы на C#"
description: "Извлечь XLTX страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Извлечь страницы XLTX документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко извлекать нужные страницы из файла XLTX и сохранять его как новый файл, содержащий выбранные страницы, выполнив несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как извлечь страницы XLTX документов, используя пример кода C#">}}
