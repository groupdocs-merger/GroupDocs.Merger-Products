...
############################# Head ############################
head_title: "DOCX ገጾችን በC# ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከDOCX ፋይል በC# ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "DOCX ገጾችን በC# ውስጥ ያውጡ"
description: "DOCX ገጾችን ከጥቂት መስመሮች .NET ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "DOCX የፋይል ገጾችን በ.NET ያውጡ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች የሚፈለጉትን ገፆች ከDOCX ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የDOCX ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}
