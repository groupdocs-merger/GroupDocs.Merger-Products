...
############################# Head ############################
head_title: "Pura DOCM sivua C#"
head_description: "Pura sivut nopeasti DOCM-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura DOCM sivua C#"
description: "Pura DOCM sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura DOCM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut DOCM-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa DOCM tiedostosivut käyttämällä C# esimerkkikoodia">}}
