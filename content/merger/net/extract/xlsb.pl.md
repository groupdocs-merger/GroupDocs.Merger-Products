...
############################# Head ############################
head_title: "Wyodrębnij strony XLSB w C#"
head_description: "Szybko wyodrębnij strony z pliku XLSB w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij XLSB strony w C#"
description: "Wyodrębnij strony XLSB z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików XLSB w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku XLSB i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku XLSB za pomocą przykładowego kodu C#">}}
