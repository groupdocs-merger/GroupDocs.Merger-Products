...
############################# Head ############################
head_title: "Wyodrębnij strony DOCM w C#"
head_description: "Szybko wyodrębnij strony z pliku DOCM w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOCM strony w C#"
description: "Wyodrębnij strony DOCM z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOCM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku DOCM i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOCM za pomocą przykładowego kodu C#">}}
