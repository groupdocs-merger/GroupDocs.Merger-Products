...
############################# Head ############################
head_title: "Išskleiskite VSSX puslapius C#"
head_description: "Greitai išskleiskite puslapius iš VSSX failo C#. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite VSSX puslapius C#"
description: "Išskleiskite VSSX puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite VSSX failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai išgauti norimus puslapius iš VSSX failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti VSSX failo puslapius naudojant C# pavyzdinį kodą">}}
