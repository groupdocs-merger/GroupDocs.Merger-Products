...
############################# Head ############################
head_title: "Bain XLTM Leathanaigh as C#"
head_description: "Bain go tapa leathanaigh as comhad XLTM in C#. Sábháil an doiciméad nua ina bhfuil na leathanaigh roghnaithe ag baint úsáide as an API cumaisc doiciméid."

############################# Header ############################
title: "Bain XLTM Leathanaigh I C#"
description: "Sliocht XLTM Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Bain XLTM Leathanaigh Chomhad as .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# na leathanaigh atá ag teastáil a bhaint as comhad XLTM agus é a shábháil mar comhad nua ina bhfuil na leathanaigh roghnaithe trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XLTM a bhaint as trí úsáid a bhaint as cód samplach C#">}}
