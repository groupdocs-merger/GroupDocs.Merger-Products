...
############################# Head ############################
head_title: "Estrai MHT pagine in C#"
head_description: "Estrai rapidamente le pagine da un file MHT in C#. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai MHT pagine in C#"
description: "Estrai MHT pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Estrai MHT pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di estrarre facilmente le pagine desiderate da un file MHT e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file MHT utilizzando il codice di esempio C#">}}
