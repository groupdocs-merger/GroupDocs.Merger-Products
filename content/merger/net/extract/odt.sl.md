...
############################# Head ############################
head_title: "Ekstrahiraj ODT strani v C#"
head_description: "Hitro ekstrahirajte strani iz datoteke ODT v C#. Shranite nov dokument, ki vsebuje izbrane strani, z API-jem za združevanje dokumentov."

############################# Header ############################
title: "Ekstrahiraj ODT strani v C#"
description: "Izvlecite strani ODT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Izvlecite strani datoteke ODT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša ekstrahiranje želenih strani iz datoteke ODT in shranjevanje kot novo datoteko, ki vsebuje izbrane strani, tako da izvedete nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako ekstrahirati strani datoteke ODT s primerom kode C#">}}
