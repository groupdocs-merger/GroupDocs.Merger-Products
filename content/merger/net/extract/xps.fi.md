...
############################# Head ############################
head_title: "Pura XPS sivua C#"
head_description: "Pura sivut nopeasti XPS-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XPS sivua C#"
description: "Pura XPS sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XPS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XPS tiedostosivut käyttämällä C# esimerkkikoodia">}}
