...
############################# Head ############################
head_title: "Estrai XLTX pagine in C#"
head_description: "Estrai rapidamente le pagine da un file XLTX in C#. Salva il nuovo documento contenente le pagine selezionate utilizzando l'API di fusione documenti."

############################# Header ############################
title: "Estrai XLTX pagine in C#"
description: "Estrai XLTX pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Estrai XLTX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di estrarre facilmente le pagine desiderate da un file XLTX e salvarlo come un nuovo file contenente le pagine selezionate implementando alcuni semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come estrarre le pagine di file XLTX utilizzando il codice di esempio C#">}}
