...
############################# Head ############################
head_title: "Ekstrak VSTM Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file VSTM di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak VSTM Halaman Di C#"
description: "Ekstrak Halaman VSTM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File VSTM di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file VSTM dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file VSTM menggunakan kode contoh C#">}}
