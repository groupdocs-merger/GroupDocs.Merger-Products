...
############################# Head ############################
head_title: "Extract VISIO Pages in C#"
head_description: "Quickly extract pages from a VISIO file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract VISIO Pages In C#"
description: "Extract VISIO Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract VISIO File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a VISIO file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract VISIO file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract VISIO Pages Online"
    content: |
       Extract VISIO file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/visio) website.
