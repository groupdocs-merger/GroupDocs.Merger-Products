...
############################# Head ############################
head_title: "Di C# de ODP Rûpelan derxe"
head_description: "Bi lez rûpelan ji pelek ODP di C# de derxînin. Belgeya nû ya ku rûpelên hilbijartî vedihewîne bi karanîna API-ya yekbûna belgeyan hilînin."

############################# Header ############################
title: "Rûpelên ODP Di C# de derxe"
description: "Rûpelên ODP bi çend rêzikên koda .NET derxe."
...
steps:
    enable: true
    title_left: "Di .NET de ODP Rûpelên Pelê derxe"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku rûpelên xwestinê ji pelek ODP derxînin û wekî hilînin. pelek nû ku rûpelên hilbijartî vedihewîne bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi koda nimûneya C# pelên ODP derxe">}}
