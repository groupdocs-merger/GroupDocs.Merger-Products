...
############################# Head ############################
head_title: "Ekstrak OTT Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail OTT dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak OTT Halaman Dalam C#"
description: "Ekstrak OTT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak OTT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail OTT dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak OTT halaman fail menggunakan kod contoh C#.">}}
