...
############################# Head ############################
head_title: "Wyodrębnij strony DOCX w C#"
head_description: "Szybko wyodrębnij strony z pliku DOCX w C#. Zapisz nowy dokument zawierający wybrane strony za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Wyodrębnij DOCX strony w C#"
description: "Wyodrębnij strony DOCX z kilkoma wierszami kodu .NET."
...
steps:
    enable: true
    title_left: "Wyodrębnij strony plików DOCX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wyodrębnienie żądanych stron z pliku DOCX i zapisanie go jako nowy plik zawierający wybrane strony, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak wyodrębnić strony pliku DOCX za pomocą przykładowego kodu C#">}}
