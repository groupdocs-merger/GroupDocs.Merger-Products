...
############################# Head ############################
head_title: "Trích xuất các trang XPS trong .NET"
head_description: "Nhanh chóng trích xuất các trang cụ thể từ tệp XPS bằng GroupDocs.Merger for .NET và lưu chúng như một tài liệu riêng biệt."

############################# Header ############################
title: "Trích xuất các trang XPS" 
description: "Tích hợp GroupDocs.Merger for .NET vào các ứng dụng .NET của bạn để xử lý các tệp XPS một cách hiệu quả với các tính năng trích xuất trang nâng cao."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) giúp dễ dàng trích xuất các trang từ tài liệu XPS. Tăng cường ứng dụng .NET của bạn với các khả năng xử lý tài liệu liền mạch.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trích xuất các trang cụ thể từ một tài liệu"
      content: |
        Ví dụ này cho thấy cách trích xuất một dải trang được chọn từ một tệp XPS và lưu chúng như một tài liệu mới.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
