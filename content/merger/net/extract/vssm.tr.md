...
############################# Head ############################
head_title: "C# İçindeki VSSM Sayfayı Çıkarın"
head_description: "Sayfaları bir VSSM dosyasından C# içinde hızla çıkarın. Belge birleştirme API'sini kullanarak seçilen sayfaları içeren yeni belgeyi kaydedin."

############################# Header ############################
title: "C# İçindeki VSSM Sayfayı Çıkarın"
description: "VSSM Sayfalarını birkaç satır .NET koduyla çıkarın."
...
steps:
    enable: true
    title_left: ".NET içindeki VSSM Dosya Sayfalarını Çıkarın"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin bir VSSM dosyasından istenen sayfaları çıkarmasını ve farklı kaydetmesini kolaylaştırır birkaç kolay adımı uygulayarak seçilen sayfaları içeren yeni bir dosya.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSM dosya sayfaları nasıl ayıklanır">}}
