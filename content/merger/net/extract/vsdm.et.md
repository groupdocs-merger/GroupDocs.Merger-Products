...
############################# Head ############################
head_title: "Ekstraheerige VSDM lehte C#"
head_description: "Eksportige kiiresti lehed VSDM failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige VSDM lehte rakenduses C#"
description: "Ekstraheerige VSDM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige VSDM faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist VSDM ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili VSDM lehekülgi, kasutades C# näidiskoodi">}}
