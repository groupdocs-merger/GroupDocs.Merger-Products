...
############################# Head ############################
head_title: "Ekstrak RTF Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file RTF di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak RTF Halaman Di C#"
description: "Ekstrak Halaman RTF dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File RTF di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file RTF dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file RTF menggunakan kode contoh C#">}}
