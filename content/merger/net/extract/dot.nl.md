...
############################# Head ############################
head_title: "Extraheer DOT pagina's in C#"
head_description: "Extraheer snel pagina's uit een DOT bestand in C#. Sla het nieuwe document met de geselecteerde pagina's op met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Extraheer DOT pagina's in C#"
description: "Extraheer DOT pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Pak DOT Bestandspagina's uit in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om de gewenste pagina's uit een DOT bestand te extraheren en op te slaan als een nieuw bestand met de geselecteerde pagina's door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOT bestandspagina's te extraheren met behulp van C# voorbeeldcode">}}
