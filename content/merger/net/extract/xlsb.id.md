...
############################# Head ############################
head_title: "Ekstrak XLSB Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file XLSB di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLSB Halaman Di C#"
description: "Ekstrak Halaman XLSB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File XLSB di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file XLSB dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file XLSB menggunakan kode contoh C#">}}
