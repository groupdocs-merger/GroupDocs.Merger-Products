...
############################# Head ############################
head_title: "Dragðu út ODS síður í C#"
head_description: "Dragðu síður út á fljótlegan hátt úr ODS skrá í C#. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út ODS síður í C#"
description: "Dragðu út ODS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Dragðu út ODS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar forriturum C# að draga þær síður sem óskað er eftir úr ODS skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út ODS skráarsíður með því að nota C# dæmi kóða">}}
