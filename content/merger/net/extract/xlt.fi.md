...
############################# Head ############################
head_title: "Pura XLT sivua C#"
head_description: "Pura sivut nopeasti XLT-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLT sivua C#"
description: "Pura XLT sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLT-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLT tiedostosivut käyttämällä C# esimerkkikoodia">}}
