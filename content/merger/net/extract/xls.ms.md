...
############################# Head ############################
head_title: "Ekstrak XLS Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail XLS dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak XLS Halaman Dalam C#"
description: "Ekstrak XLS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak XLS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail XLS dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak XLS halaman fail menggunakan kod contoh C#.">}}
