...
############################# Head ############################
head_title: "Extract PPTX Pages in C#"
head_description: "Quickly extract pages from a PPTX file in C#. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract PPTX Pages In C#"
description: "Extract PPTX Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Extract PPTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to extract the desired pages from a PPTX file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to extract PPTX file pages using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Extract PPTX Pages Online"
    content: |
       Extract PPTX file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/extract-pages/pptx) website.
