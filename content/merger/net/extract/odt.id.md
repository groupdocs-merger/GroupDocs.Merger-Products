...
head_title: "Ekstrak Halaman ODT di C# ASP.NET & VB.NET"
head_description: "Ekstrak halaman dengan cepat dari file ODT di C# .NET. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

title: "Ekstrak Halaman ODT Dalam Aplikasi C# .NET"
description: "Ekstrak halaman yang dipilih dengan cepat dari file ODT dan simpan sebagai dokumen baru menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman dari File ODT di C# .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk mengekstrak halaman yang diinginkan dari file ODT dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak halaman file ODT menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Halaman Dokumen Ekstrak ODT"
    content: |
        Ekstrak halaman file ODT sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/ODT).
