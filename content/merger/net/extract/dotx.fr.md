...
############################# Head ############################
head_title: "Extraire DOTX pages en C#"
head_description: "Extrayez rapidement des pages d'un fichier DOTX en C#. Enregistrez le nouveau document contenant les pages sélectionnées à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Extraire DOTX pages dans C#"
description: "Extrayez DOTX pages avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Extraire DOTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# d'extraire facilement les pages souhaitées d'un fichier DOTX et de l'enregistrer sous un nouveau fichier contenant les pages sélectionnées en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment extraire les pages de fichier DOTX à l'aide de l'exemple de code C#">}}
