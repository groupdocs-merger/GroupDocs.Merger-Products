...
############################# Head ############################
head_title: "Estrai pagine VISIO in .NET"
head_description: "Estrai rapidamente pagine specifiche da un file VISIO utilizzando GroupDocs.Merger for .NET e salvale come documento separato."

############################# Header ############################
title: "Estrai pagine VISIO" 
description: "Integra GroupDocs.Merger for .NET nelle tue applicazioni .NET per elaborare in modo efficiente file VISIO con funzionalità avanzate di estrazione delle pagine."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) semplifica l'estrazione di pagine dai documenti VISIO. Migliora le tue applicazioni .NET con capacità di elaborazione documenti senza soluzione di continuità.
      
      1. Fornisci il percorso del file del documento VISIO sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Estrai pagine specifiche da un documento"
      content: |
        Questo esempio mostra come estrarre un intervallo selezionato di pagine da un file VISIO e salvarle come un nuovo documento.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
