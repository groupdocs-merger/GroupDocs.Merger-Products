...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to extract the desired pages from a MHTML file and save it as a new file containing the selected pages by implementing a few easy steps.
