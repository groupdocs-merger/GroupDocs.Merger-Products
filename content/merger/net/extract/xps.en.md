...
############################# Head ############################
head_title: "Extract XPS pages in .NET"
head_description: "Quickly extract specific pages from a XPS file using GroupDocs.Merger for .NET and save them as a separate document."

############################# Header ############################
title: "Extract XPS pages" 
description: "Integrate GroupDocs.Merger for .NET into your .NET applications to efficiently process XPS files with advanced page extraction features."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it simple to extract pages from XPS documents. Enhance your .NET applications with seamless document processing capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example shows how to extract a selected range of pages from a XPS file and save them as a new document.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
