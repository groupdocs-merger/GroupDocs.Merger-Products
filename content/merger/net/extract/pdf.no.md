...
############################# Head ############################
head_title: "Trekk ut PDF sider i C#"
head_description: "Trekk ut sider raskt fra en PDF-fil i C#. Lagre det nye dokumentet som inneholder de valgte sidene ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "Trekk ut PDF sider i C#"
description: "Trekk ut PDF sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Pakk ut PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å trekke ut de ønskede sidene fra en PDF-fil og lagre den som en ny fil som inneholder de valgte sidene ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan trekke ut PDF filsider ved å bruke C# eksempelkode">}}
