...
############################# Head ############################
head_title: "Extract MHTML pages in .NET"
head_description: "Quickly extract specific pages from a MHTML file using GroupDocs.Merger for .NET and save them as a separate document."

############################# Header ############################
title: "Extract MHTML pages" 
description: "Integrate GroupDocs.Merger for .NET into your .NET applications to efficiently process MHTML files with advanced page extraction features."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it simple to extract pages from MHTML documents. Enhance your .NET applications with seamless document processing capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example shows how to extract a selected range of pages from a MHTML file and save them as a new document.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
