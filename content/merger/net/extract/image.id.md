...
############################# Head ############################
head_title: "Ekstrak IMAGE Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file IMAGE di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak IMAGE Halaman Di C#"
description: "Ekstrak Halaman IMAGE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File IMAGE di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file IMAGE dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file IMAGE menggunakan kode contoh C#">}}
