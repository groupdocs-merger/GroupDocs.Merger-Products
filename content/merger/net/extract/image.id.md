...
head_title: "Ekstrak Halaman IMAGE di C# ASP.NET & VB.NET"
head_description: "Ekstrak halaman dengan cepat dari file IMAGE di C# .NET. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

title: "Ekstrak Halaman IMAGE Dalam Aplikasi C# .NET"
description: "Ekstrak halaman yang dipilih dengan cepat dari file IMAGE dan simpan sebagai dokumen baru menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman dari File IMAGE di C# .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk mengekstrak halaman yang diinginkan dari file IMAGE dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah
    ...
    code: |
        ```cs
        // Ekstrak halaman file IMAGE menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Halaman Dokumen Ekstrak IMAGE"
    content: |
        Ekstrak halaman file IMAGE sekarang dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/doc).
