...
head_title: "Ekstrak Halaman ODP di C# ASP.NET & VB.NET"
head_description: "Ekstrak halaman dengan cepat dari file ODP di C# .NET. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

title: "Ekstrak Halaman ODP Dalam Aplikasi C# .NET"
description: "Ekstrak halaman yang dipilih dengan cepat dari file ODP dan simpan sebagai dokumen baru menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman dari File ODP di C# .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk mengekstrak halaman yang diinginkan dari file ODP dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Ekstrak halaman file ODP menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Aplikasi Halaman Dokumen Ekstrak ODP"
    content: |
        Ekstrak halaman file ODP sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/ODP).
