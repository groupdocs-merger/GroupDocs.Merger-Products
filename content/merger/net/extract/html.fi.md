...
############################# Head ############################
head_title: "Pura HTML sivua C#"
head_description: "Pura sivut nopeasti HTML-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura HTML sivua C#"
description: "Pura HTML sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura HTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut HTML-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa HTML tiedostosivut käyttämällä C# esimerkkikoodia">}}
