...
############################# Head ############################
head_title: "Extrahujte VSDM stránok v C#"
head_description: "Rýchlo extrahujte stránky zo súboru VSDM v C#. Uložte nový dokument obsahujúci vybraté strany pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Extrahujte VSDM stránok v C#"
description: "Extrahujte VSDM stránok pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Extrahujte VSDM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# extrahovať požadované stránky zo súboru VSDM a uložiť ho ako nový súbor obsahujúci vybrané stránky vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako extrahovať stránky súboru VSDM pomocou vzorového kódu C#">}}
