...
############################# Head ############################
head_title: "Ekstrak EPUB Halaman di C#"
head_description: "Ekstrak halaman dengan cepat dari file EPUB di C#. Simpan dokumen baru yang berisi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak EPUB Halaman Di C#"
description: "Ekstrak Halaman EPUB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Ekstrak Halaman File EPUB di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk mengekstrak halaman yang diinginkan dari file EPUB dan menyimpannya sebagai file baru yang berisi halaman yang dipilih dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak halaman file EPUB menggunakan kode contoh C#">}}
