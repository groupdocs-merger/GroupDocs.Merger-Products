...
############################# Head ############################
head_title: "Pura XLTX sivua C#"
head_description: "Pura sivut nopeasti XLTX-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLTX sivua C#"
description: "Pura XLTX sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLTX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLTX tiedostosivut käyttämällä C# esimerkkikoodia">}}
