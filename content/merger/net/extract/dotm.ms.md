...
############################# Head ############################
head_title: "Ekstrak DOTM Halaman dalam C#"
head_description: "Ekstrak halaman dengan cepat daripada fail DOTM dalam C#. Simpan dokumen baharu yang mengandungi halaman yang dipilih menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Ekstrak DOTM Halaman Dalam C#"
description: "Ekstrak DOTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Ekstrak DOTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# mengekstrak halaman yang dikehendaki daripada fail DOTM dan menyimpannya sebagai fail baharu yang mengandungi halaman yang dipilih dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara mengekstrak DOTM halaman fail menggunakan kod contoh C#.">}}
