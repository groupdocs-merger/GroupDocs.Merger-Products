...
############################# Head ############################
head_title: "Dragðu út XLS síður í C#"
head_description: "Dragðu síður út á fljótlegan hátt úr XLS skrá í C#. Vistaðu nýja skjalið sem inniheldur valdar síður með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Dragðu út XLS síður í C#"
description: "Dragðu út XLS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Dragðu út XLS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar forriturum C# að draga þær síður sem óskað er eftir úr XLS skrá og vista hana sem nýja skrá sem inniheldur valdar síður með því að útfæra nokkur einföld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að draga út XLS skráarsíður með því að nota C# dæmi kóða">}}
