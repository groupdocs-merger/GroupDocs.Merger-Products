...
############################# Head ############################
head_title: "Extraia MHT Páginas em C#"
head_description: "Extraia rapidamente páginas de um arquivo MHT em C#. Salve o novo documento que contém as páginas selecionadas usando a API de fusão de documentos."

############################# Header ############################
title: "Extraia MHT Páginas em C#"
description: "Extraia MHT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Extrair páginas de arquivo MHT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do C# extrair as páginas desejadas de um arquivo MHT e salvá-lo como um novo arquivo contendo as páginas selecionadas implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como extrair páginas de arquivo MHT usando o código de exemplo C#">}}
