...
############################# Head ############################
head_title: "Ekstraheerige ONE lehte C#"
head_description: "Eksportige kiiresti lehed ONE failist rakenduses C#. Salvestage uus dokument, mis sisaldab valitud lehti, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Ekstraktige ONE lehte rakenduses C#"
description: "Ekstraheerige ONE lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Ekstraktige ONE faililehte tootest .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks soovitud lehtede eraldamise failist ONE ja selle salvestamise mõne lihtsa toiminguga uue faili, mis sisaldab valitud lehti.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas ekstraheerida faili ONE lehekülgi, kasutades C# näidiskoodi">}}
