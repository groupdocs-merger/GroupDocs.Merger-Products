...
############################# Head ############################
head_title: "Pura XLSX sivua C#"
head_description: "Pura sivut nopeasti XLSX-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLSX sivua C#"
description: "Pura XLSX sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLSX-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLSX tiedostosivut käyttämällä C# esimerkkikoodia">}}
