...
############################# Head ############################
head_title: "Pura XLS sivua C#"
head_description: "Pura sivut nopeasti XLS-tiedostosta C#:ssa. Tallenna uusi asiakirja, joka sisältää valitut sivut asiakirjojen yhdistämissovellusliittymän avulla."

############################# Header ############################
title: "Pura XLS sivua C#"
description: "Pura XLS sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Pura XLS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi purkaa halutut sivut XLS-tiedostosta ja tallentaa sen nimellä uuden tiedoston, joka sisältää valitut sivut muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka purkaa XLS tiedostosivut käyttämällä C# esimerkkikoodia">}}
