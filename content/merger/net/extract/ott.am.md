...
############################# Head ############################
head_title: "OTT ገጾችን በC# ውስጥ ያውጡ"
head_description: "ገጾችን በፍጥነት ከOTT ፋይል በC# ያውጡ። የሰነዶች ውህደት ኤፒአይ በመጠቀም የተመረጡ ገጾችን የያዘ አዲሱን ሰነድ ያስቀምጡ።"

############################# Header ############################
title: "OTT ገጾችን በC# ውስጥ ያውጡ"
description: "OTT ገጾችን ከጥቂት መስመሮች .NET ኮድ ያውጡ።"
...
steps:
    enable: true
    title_left: "OTT የፋይል ገጾችን በ.NET ያውጡ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች የሚፈለጉትን ገፆች ከOTT ፋይል ማውጣት እና እንደ ማስቀመጥ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎችን በመተግበር የተመረጡ ገጾችን የያዘ አዲስ ፋይል.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም የOTT ፋይል ገጾችን እንዴት ማውጣት እንደሚቻል">}}
