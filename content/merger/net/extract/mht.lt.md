...
############################# Head ############################
head_title: "Išskleiskite MHT puslapius C#"
head_description: "Greitai išskleiskite puslapius iš MHT failo C#. Išsaugokite naują dokumentą, kuriame yra pasirinkti puslapiai, naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Išskleiskite MHT puslapius C#"
description: "Išskleiskite MHT puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Išskleiskite MHT failo puslapius iš .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai išgauti norimus puslapius iš MHT failo ir išsaugoti jį kaip naują failą su pasirinktais puslapiais, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip išgauti MHT failo puslapius naudojant C# pavyzdinį kodą">}}
