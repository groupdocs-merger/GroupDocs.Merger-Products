...
############################# Head ############################
head_title: "Udpak PPTX sider i C#"
head_description: "Udpak hurtigt sider fra en PPTX-fil i C#. Gem det nye dokument, der indeholder de valgte sider, ved hjælp af documents merger API."

############################# Header ############################
title: "Udpak PPTX sider i C#"
description: "Udpak PPTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Udpak PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at udtrække de ønskede sider fra en PPTX-fil og gemme den som en ny fil, der indeholder de valgte sider ved at implementere nogle få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan udtrækkes PPTX filsider ved hjælp af C# eksempelkode">}}
