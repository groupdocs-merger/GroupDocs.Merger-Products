...
############################# Head ############################
head_title: "Trích xuất các trang VSDX trong C#"
head_description: "Nhanh chóng trích xuất các trang từ tệp VSDX trong C#. Lưu tài liệu mới chứa các trang đã chọn bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Trích xuất VSDX Trang trong C#"
description: "Trích xuất các Trang VSDX với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Giải nén các Trang Tệp VSDX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng trích xuất các trang mong muốn từ tệp VSDX và lưu nó dưới dạng một tệp mới chứa các trang đã chọn bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách giải nén các trang tệp VSDX bằng mã mẫu C#">}}
