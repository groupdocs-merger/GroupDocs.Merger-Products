...
############################# Head ############################
head_title: "Onttrek VSX bladsye in C#"
head_description: "Onttrek bladsye vinnig uit 'n VSX-lêer in C#. Stoor die nuwe dokument wat die geselekteerde bladsye bevat deur die dokumente-samesmeltings-API."

############################# Header ############################
title: "Onttrek VSX bladsye in C#"
description: "Onttrek VSX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Onttrek VSX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om die verlangde bladsye uit 'n VSX-lêer te onttrek en dit te stoor as 'n nuwe lêer wat die geselekteerde bladsye bevat deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSX lêerbladsye te onttrek deur C# voorbeeldkode te gebruik">}}
