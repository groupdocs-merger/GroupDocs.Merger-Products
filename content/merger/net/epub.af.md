...
############################# Head ############################
head_title: "Voeg EPUB lêers saam in C# | EPUB samesmelting"
head_description: "Voeg veelvuldige EPUB lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "EPUB samesmelting in C#"
description: "Voeg EPUB saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige EPUB-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer EPUB-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om EPUB lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg EPUB lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een EPUB-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) webwerf te besoek.
