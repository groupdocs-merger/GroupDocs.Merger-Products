...
############################# Head ############################
head_title: "VDX fájlok egyesítése a C#-ban | VDX Egyesülés"
head_description: "Egyesítsen több VDX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VDX Egyesülés a C# programban"
description: "Egyesítse a(z) VDX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VDX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VDX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VDX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VDX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VDX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) webhely meglátogatásával.
