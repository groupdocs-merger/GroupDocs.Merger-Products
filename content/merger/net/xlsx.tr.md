...
############################# Head ############################
head_title: "XLSX Dosyalarını C# İçinde Birleştir | XLSX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSX dosyalarını birleştirin
