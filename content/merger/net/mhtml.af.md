...
############################# Head ############################
head_title: "Voeg MHTML lêers saam in C# | MHTML samesmelting"
head_description: "Voeg veelvuldige MHTML lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "MHTML samesmelting in C#"
description: "Voeg MHTML saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige MHTML-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer MHTML-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHTML lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg MHTML lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een MHTML-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) webwerf te besoek.
