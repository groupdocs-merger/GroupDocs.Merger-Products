...
############################# Head ############################
head_title: "OTP ፋይሎችን በC# | አዋህድ OTP ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ OTP ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች ወደ አንድ ሰነድ ያዋህዱ።"

############################# Header ############################
title: "የOTP ውህደት በC#"
description: "OTPን ከጥቂት የ.NET ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በርካታ OTP ፋይሎችን እንዴት እንደሚዋሃድ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች አንድን በመተግበር ሁለት ወይም ከዚያ በላይ የሆኑ OTP ፋይሎችን በመተግበሪያዎቻቸው ውስጥ ማዋሃድ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም OTP ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም OTP ፋይሎችን አዋህድ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ OTP ፋይሎችን አዋህድ።
