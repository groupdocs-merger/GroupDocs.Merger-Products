...
############################# Head ############################
head_title: "Slå sammen DOC-filer i C# | DOC Fusjon"
...
############################# Header ############################
title: "DOC sammenslåing i C#"
description: "Slå sammen DOC med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere DOC-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOC filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen DOC filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én DOC-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
