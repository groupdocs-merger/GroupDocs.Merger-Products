...
############################# Head ############################
head_title: "VSDM fájlok egyesítése a C#-ban | VSDM Egyesülés"
head_description: "Egyesítsen több VSDM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSDM Egyesülés a C# programban"
description: "Egyesítse a(z) VSDM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VSDM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSDM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSDM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VSDM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm) webhely meglátogatásával.
