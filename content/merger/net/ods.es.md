...
############################# Head ############################
head_title: "Combinar ODS archivos en C# | ODS Fusión"
head_description: "Combine varios archivos ODS en un solo archivo usando la API de fusión de documentos C# .NET. Combine páginas específicas o rangos de páginas de varios documentos en un solo documento."

############################# Header ############################
title: "ODS Fusión en C#"
description: "Combine ODS con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Cómo fusionar varios archivos ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de .NET fusionar dos o más archivos ODS dentro de sus aplicaciones mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo fusionar archivos ODS usando el código de ejemplo C#">}}

        ```csharp    
        // Combinar ODS archivos usando GroupDocs.Merger API
