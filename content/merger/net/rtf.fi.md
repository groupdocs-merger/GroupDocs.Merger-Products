...
############################# Head ############################
head_title: "Yhdistä RTF tiedostot C# | RTF Sulautuminen"
...
############################# Header ############################
title: "RTF Sulautuminen C#"
description: "Yhdistä RTF muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia RTF tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää RTF tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä RTF tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi RTF-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) -sivustolla.
