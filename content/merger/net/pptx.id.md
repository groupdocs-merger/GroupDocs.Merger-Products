...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa PPTX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu PPTX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx).
