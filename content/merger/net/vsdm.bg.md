...
############################# Head ############################
head_title: "Обединете VSDM файлове в C# | VSDM Сливане"
head_description: "Обединете няколко файла VSDM в един файл с помощта на API за сливане на документи C# .NET. Обединете конкретни страници или диапазони от различни документи в един документ."

############################# Header ############################
title: "VSDM Обединяване в C#"
description: "Обединете VSDM с няколко реда от кода на .NET."
...
steps:
    enable: true
    title_left: "Как да обедините няколко VSDM файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да обединят два или повече VSDM файла в техните приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините VSDM файлове с C# примерен код">}}

        ```csharp    
        // Обединете VSDM файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Обединете повече от един VSDM файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
