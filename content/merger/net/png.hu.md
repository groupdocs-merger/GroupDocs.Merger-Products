...
############################# Head ############################
head_title: "PNG fájlok egyesítése a C#-ban | PNG Egyesülés"
head_description: "Egyesítsen több PNG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PNG Egyesülés a C# programban"
description: "Egyesítse a(z) PNG terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PNG fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PNG fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PNG fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen PNG fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több PNG fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) webhely meglátogatásával.
