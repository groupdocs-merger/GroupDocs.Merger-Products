...
############################# Head ############################
head_title: "PPT Dosyalarını C# İçinde Birleştir | PPT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPT dosyalarını birleştirin
