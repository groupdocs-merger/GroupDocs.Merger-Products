...
############################# Head ############################
head_title: "Flet XLSX filer i C# | XLSX Fusion"
head_description: "Flet flere XLSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "XLSX fusion i C#"
description: "Flet XLSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere XLSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere XLSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet XLSX filer ved hjælp af GroupDocs.Merger API
