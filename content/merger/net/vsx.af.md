...
############################# Head ############################
head_title: "Voeg VSX lêers saam in C# | VSX samesmelting"
head_description: "Voeg veelvuldige VSX lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "VSX samesmelting in C#"
description: "Voeg VSX saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige VSX-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer VSX-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSX lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg VSX lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een VSX-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) webwerf te besoek.
