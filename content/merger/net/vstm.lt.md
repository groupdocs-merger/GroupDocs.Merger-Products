...
head_description: "Sujunkite kelis VSTM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "VSTM Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną VSTM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) svetainėje.
