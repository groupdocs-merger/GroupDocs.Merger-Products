...
############################# Head ############################
head_title: "Voeg DOCM lêers saam in C# | DOCM samesmelting"
head_description: "Voeg veelvuldige DOCM lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "DOCM samesmelting in C#"
description: "Voeg DOCM saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige DOCM-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer DOCM-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCM lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg DOCM lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een DOCM-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) webwerf te besoek.
