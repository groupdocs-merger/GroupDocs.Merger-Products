...
############################# Head ############################
head_title: "Flet XLSM filer i C# | XLSM Fusion"
head_description: "Flet flere XLSM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "XLSM fusion i C#"
description: "Flet XLSM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere XLSM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere XLSM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLSM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet XLSM filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én XLSM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsm).
