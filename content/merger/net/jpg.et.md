...
############################# Head ############################
head_title: "Ühendage JPG failid C# | JPG Ühinemine"
head_description: "Ühendage mitu JPG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "JPG ühinemine programmis C#"
description: "Ühendage JPG mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam JPG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita JPG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid JPG, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks JPG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg).
