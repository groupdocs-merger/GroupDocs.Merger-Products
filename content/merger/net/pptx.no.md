...
############################# Head ############################
head_title: "Slå sammen PPTX-filer i C# | PPTX Fusjon"
...
############################# Header ############################
title: "PPTX sammenslåing i C#"
description: "Slå sammen PPTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere PPTX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen PPTX filer ved hjelp av GroupDocs.Merger API
