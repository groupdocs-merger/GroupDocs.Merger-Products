...
############################# Head ############################
head_title: "RTF فائلوں کو C# میں ضم کریں۔ RTF انضمام"
head_description: "C# .NET دستاویزات کے انضمام API کا استعمال کرتے ہوئے متعدد RTF فائلوں کو ایک فائل میں ضم کریں۔ مخصوص صفحات یا صفحہ کی حدود کو مختلف دستاویزات سے ایک دستاویز میں ضم کریں۔"

############################# Header ############################
title: "RTF انضمام C# میں"
description: "RTF کو .NET کوڈ کی چند سطروں کے ساتھ ضم کریں۔"
...
steps:
    enable: true
    title_left: "ایک سے زیادہ RTF فائلوں کو کیسے ملایا جائے۔"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) .NET ڈویلپرز کے لیے اپنی ایپلی کیشنز میں دو یا زیادہ RTF فائلوں کو ضم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے RTF فائلوں کو کیسے ملایا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے RTF فائلوں کو ضم کریں۔
