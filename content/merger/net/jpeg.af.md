...
############################# Head ############################
head_title: "Voeg JPEG lêers saam in C# | JPEG samesmelting"
head_description: "Voeg veelvuldige JPEG lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "JPEG samesmelting in C#"
description: "Voeg JPEG saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige JPEG-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer JPEG-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om JPEG lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg JPEG lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een JPEG-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg) webwerf te besoek.
