...
############################# Head ############################
head_title: "Cumaisc PPS Comhaid i C# | PPS Cumasc"
head_description: "Cumaisc comhaid PPS iolracha isteach i gcomhad amháin trí úsáid a bhaint as C# .NET doiciméad cumaisc API. Cumaisc leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "PPS Cumasc i C#"
description: "Cumaisc PPS le cúpla líne de chód .NET."
...
about:
    ...
    content: |
        Soláthraíonn [GroupDocs.Merger for .NET](/ga/merger/net/) réiteach áisiúil chun go leor PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, íomhánna agus go leor doiciméad eile isteach i gcomhad amháin laistigh d'fheidhmchláir .NET. Sábhálfaidh GroupDocs.Merger go leor iarrachta duit, mar tá cead agat doiciméid PPS a chumasc - ní gá aon bhogearraí tríú páirtí, feidhmchláir deisce nó forlíontáin a shuiteáil. Anois ní gá do chuid ama a chur amú agus comhaid a chumasc de láimh! Is é misean GroupDocs an cháilíocht is fearr a sholáthar agus sreafaí oibre próiseála doiciméad a shimpliú.
...
steps:
    enable: true
    title_left: "Conas Ilchomhad PPS a chumasc"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá chomhad PPS nó níos mó a chumasc laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas PPS comhad a chumasc le cód samplach C#">}}

        ```csharp    
        // Cumaisc PPS comhad le GroupDocs.Merger API
...
demos:
    ...
    content: |
       Cumaisc níos mó ná comhad PPS amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) láithreán gréasáin.
