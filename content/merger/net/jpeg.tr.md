...
############################# Head ############################
head_title: "JPEG Dosyalarını C# İçinde Birleştir | JPEG Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak JPEG dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak JPEG dosyalarını birleştirin
