...
############################# Head ############################
head_title: "VSDX Dosyalarını C# İçinde Birleştir | VSDX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDX dosyalarını birleştirin
