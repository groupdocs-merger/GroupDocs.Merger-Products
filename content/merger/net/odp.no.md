...
############################# Head ############################
head_title: "Slå sammen ODP-filer i C# | ODP Fusjon"
...
############################# Header ############################
title: "ODP sammenslåing i C#"
description: "Slå sammen ODP med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere ODP-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODP filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen ODP filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én ODP-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
