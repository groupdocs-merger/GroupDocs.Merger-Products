...
############################# Head ############################
head_title: "VSTM Dosyalarını C# İçinde Birleştir | VSTM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSTM dosyalarını birleştirin
