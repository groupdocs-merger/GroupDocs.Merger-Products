...
############################# Head ############################
head_title: "Fusionner les fichiers CSV dans C# | CSV Fusion"
head_description: "Fusionnez plusieurs fichiers CSV en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "CSV Fusionner dans C#"
description: "Fusionnez CSV avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers CSV dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers CSV à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner CSV fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée CSV
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers CSV dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
