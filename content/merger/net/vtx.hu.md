...
############################# Head ############################
head_title: "VTX fájlok egyesítése a C#-ban | VTX Egyesülés"
head_description: "Egyesítsen több VTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VTX Egyesülés a C# programban"
description: "Egyesítse a(z) VTX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több VTX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VTX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VTX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több VTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) webhely meglátogatásával.
