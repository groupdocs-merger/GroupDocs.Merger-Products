...
############################# Head ############################
head_title: "DOTX fájlok egyesítése a C#-ban | DOTX Egyesülés"
head_description: "Egyesítsen több DOTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOTX Egyesülés a C# programban"
description: "Egyesítse a(z) DOTX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOTX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOTX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOTX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több DOTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx) webhely meglátogatásával.
