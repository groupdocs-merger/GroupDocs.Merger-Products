...
############################# Head ############################
head_title: "VDX ፋይሎችን በC# | አዋህድ VDX ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ VDX ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች ወደ አንድ ሰነድ ያዋህዱ።"

############################# Header ############################
title: "የVDX ውህደት በC#"
description: "VDXን ከጥቂት የ.NET ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በርካታ VDX ፋይሎችን እንዴት እንደሚዋሃድ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች አንድን በመተግበር ሁለት ወይም ከዚያ በላይ የሆኑ VDX ፋይሎችን በመተግበሪያዎቻቸው ውስጥ ማዋሃድ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም VDX ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም VDX ፋይሎችን አዋህድ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ VDX ፋይሎችን አዋህድ።
