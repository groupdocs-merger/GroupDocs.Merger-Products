...
head_description: "Sujunkite kelis VTX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "VTX Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną VTX failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) svetainėje.
