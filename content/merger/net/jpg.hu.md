...
############################# Head ############################
head_title: "JPG fájlok egyesítése a C#-ban | JPG Egyesülés"
head_description: "Egyesítsen több JPG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "JPG Egyesülés a C# programban"
description: "Egyesítse a(z) JPG terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több JPG fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több JPG fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="JPG fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen JPG fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több JPG fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) webhely meglátogatásával.
