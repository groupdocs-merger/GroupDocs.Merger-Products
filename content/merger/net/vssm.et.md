...
############################# Head ############################
head_title: "Ühendage VSSM failid C# | VSSM Ühinemine"
head_description: "Ühendage mitu VSSM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "VSSM ühinemine programmis C#"
description: "Ühendage VSSM mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam VSSM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSSM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid VSSM, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks VSSM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
