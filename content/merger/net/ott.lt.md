...
head_description: "Sujunkite kelis OTT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "OTT Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną OTT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) svetainėje.
