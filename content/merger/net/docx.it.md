...
############################# Head ############################
head_title: "Unisci DOCX file in C# | DOCX Fusione"
...
############################# Header ############################
title: "DOCX Fusione in C#"
description: "Unisci DOCX con poche righe di codice .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/it/merger/net/) fornisce una comoda soluzione per unire più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni .NET. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito unire DOCX documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e unire i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Come unire file DOCX utilizzando il codice di esempio C#">}}
        ...
        ```csharp    
        // Unisci i file DOCX utilizzando l'API GroupDocs.Merger
