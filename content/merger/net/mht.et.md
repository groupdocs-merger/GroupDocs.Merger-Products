...
############################# Head ############################
head_title: "Ühendage MHT failid C# | MHT Ühinemine"
head_description: "Ühendage mitu MHT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "MHT ühinemine programmis C#"
description: "Ühendage MHT mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam MHT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita MHT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid MHT, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks MHT faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
