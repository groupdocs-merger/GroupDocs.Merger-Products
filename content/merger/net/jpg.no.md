...
############################# Head ############################
head_title: "Slå sammen JPG-filer i C# | JPG Fusjon"
...
############################# Header ############################
title: "JPG sammenslåing i C#"
description: "Slå sammen JPG med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere JPG-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen JPG filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen JPG filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én JPG-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg).
