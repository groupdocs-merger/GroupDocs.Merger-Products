...
############################# Head ############################
head_title: "Gabungkan file VISIO melalui .NET"
head_description: "Integrasikan penggabungan dokumen VISIO ke dalam proyek .NET Anda dengan GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gabungkan file VISIO" 
description: "Gunakan GroupDocs.Merger for .NET untuk membuat aplikasi .NET yang kuat yang mampu menggabungkan dan mengelola dokumen VISIO tanpa kendala."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan penggabungan dokumen VISIO. Tambahkan fungsionalitas penggabungan ke aplikasi .NET Anda dan gabungkan beberapa file dengan mulus.
      
      1. Tentukan jalur ke file VISIO yang pertama.
