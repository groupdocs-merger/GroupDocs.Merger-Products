...
############################# Head ############################
head_title: "Pelên XLAM di C# de bike yek | XLAM Hevgirtin"
head_description: "Gelek pelên XLAM di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "XLAM Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek XLAM Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir XLAM pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên XLAM bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên XLAM bi karanîna GroupDocs.Merger API-ê bikin yek
