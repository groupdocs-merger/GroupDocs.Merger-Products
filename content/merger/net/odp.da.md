...
############################# Head ############################
head_title: "Flet ODP filer i C# | ODP Fusion"
head_description: "Flet flere ODP filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "ODP fusion i C#"
description: "Flet ODP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere ODP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere ODP-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes ODP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet ODP filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én ODP-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp).
