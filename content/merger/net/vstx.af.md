...
############################# Head ############################
head_title: "Voeg VSTX lêers saam in C# | VSTX samesmelting"
head_description: "Voeg veelvuldige VSTX lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "VSTX samesmelting in C#"
description: "Voeg VSTX saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige VSTX-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer VSTX-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTX lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg VSTX lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een VSTX-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) webwerf te besoek.
