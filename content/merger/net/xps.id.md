...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa XPS File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XPS file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps).
