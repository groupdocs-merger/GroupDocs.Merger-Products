...
############################# Head ############################
head_title: "XLS fájlok egyesítése a C#-ban | XLS Egyesülés"
head_description: "Egyesítsen több XLS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLS Egyesülés a C# programban"
description: "Egyesítse a(z) XLS terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLS fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLS fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLS fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLS fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls) webhely meglátogatásával.
