...
############################# Head ############################
head_title: "RTF fájlok egyesítése a C#-ban | RTF Egyesülés"
head_description: "Egyesítsen több RTF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "RTF Egyesülés a C# programban"
description: "Egyesítse a(z) RTF terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több RTF fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több RTF fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="RTF fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen RTF fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több RTF fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) webhely meglátogatásával.
