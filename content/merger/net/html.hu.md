...
############################# Head ############################
head_title: "HTML fájlok egyesítése a C#-ban | HTML Egyesülés"
head_description: "Egyesítsen több HTML fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "HTML Egyesülés a C# programban"
description: "Egyesítse a(z) HTML terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több HTML fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több HTML fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="HTML fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen HTML fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több HTML fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) webhely meglátogatásával.
