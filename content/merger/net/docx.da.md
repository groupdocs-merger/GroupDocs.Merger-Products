...
############################# Head ############################
head_title: "Flet DOCX filer i C# | DOCX Fusion"
head_description: "Flet flere DOCX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "DOCX fusion i C#"
description: "Flet DOCX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere DOCX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere DOCX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes DOCX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet DOCX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én DOCX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
