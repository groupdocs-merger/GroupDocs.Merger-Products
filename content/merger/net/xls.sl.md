...
############################# Head ############################
head_title: "Spoji datoteke XLS v C# | XLS Združitev"
head_description: "Spojite več datotek XLS v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "XLS Združitev v C#"
description: "Spojite XLS z nekaj vrsticami kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLS s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke XLS z API-jem GroupDocs.Merger
