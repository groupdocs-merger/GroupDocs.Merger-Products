...
############################# Head ############################
head_title: "Ühendage OTT failid C# | OTT Ühinemine"
head_description: "Ühendage mitu OTT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "OTT ühinemine programmis C#"
description: "Ühendage OTT mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam OTT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita OTT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid OTT, kasutades GroupDocs.Merger API-t
