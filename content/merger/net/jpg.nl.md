...
############################# Head ############################
head_title: "Voeg JPG bestanden samen in C# | JPG Fusie"
head_description: "Voeg meerdere JPG bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "JPG Fusie in C#"
description: "Voeg JPG samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere JPG bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer JPG-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe JPG bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg JPG bestanden samen met de GroupDocs.Merger API
