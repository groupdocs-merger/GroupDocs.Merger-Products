...
############################# Head ############################
head_title: "Merge POWERPOINT files via .NET"
head_description: "Integrate POWERPOINT document merging into your .NET projects with GroupDocs.Merger for .NET."

############################# Header ############################
title: "Merge POWERPOINT files" 
description: "Use GroupDocs.Merger for .NET to create powerful .NET applications that seamlessly merge and manage POWERPOINT documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to merge POWERPOINT documents. Add merging functionality to your .NET applications and combine multiple files effortlessly.
      
      1. Define the path to the first POWERPOINT file.
