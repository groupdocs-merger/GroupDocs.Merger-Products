...
############################# Head ############################
head_title: "Slå samman CSV-filer i C# | CSV Sammanslagning"
head_description: "Slå samman flera CSV-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "CSV sammanslagning i C#"
description: "Slå samman CSV med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera CSV-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera CSV-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar CSV filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga CSV filer med GroupDocs.Merger API
