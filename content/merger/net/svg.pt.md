...
############################# Head ############################
head_title: "Mescle arquivos SVG via .NET"
head_description: "Integre a mesclagem de documentos SVG em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos SVG" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos SVG de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos SVG. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
