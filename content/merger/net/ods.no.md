...
############################# Head ############################
head_title: "Slå sammen ODS-filer i C# | ODS Fusjon"
...
############################# Header ############################
title: "ODS sammenslåing i C#"
description: "Slå sammen ODS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere ODS-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen ODS filer ved hjelp av GroupDocs.Merger API
