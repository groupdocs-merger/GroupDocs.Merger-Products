...
head_description: "使用 C# .NET 文档合并 API 将多个 XLAM 文件合并到一个文件中。将特定页面或页面范围从各种文档合并到单个文档。"

############################# Header ############################
title: "XLAM 合并到 C#"
description: "将 XLAM 与几行 .NET 代码合并。"
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 为合并多个 PDF、Microsoft Office（Word、Excel、PowerPoint、OneNote）、OpenDocument、HTML、图像和在 .NET 应用程序中将许多其他文档合并到一个文件中。 GroupDocs.Merger 将为您节省大量精力，因为您可以合并 XLAM 文档 - 无需安装任何第三方软件、桌面应用程序或插件。现在不必浪费时间手动合并文件了！ GroupDocs 的使命是提供最佳质量并简化文档处理工作流程。
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码合并 XLAM 文件">}}
