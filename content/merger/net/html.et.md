...
############################# Head ############################
head_title: "Ühendage HTML failid C# | HTML Ühinemine"
head_description: "Ühendage mitu HTML faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "HTML ühinemine programmis C#"
description: "Ühendage HTML mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu HTML faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam HTML faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita HTML faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid HTML, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks HTML faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
