...
############################# Head ############################
head_title: "รวมไฟล์ EXCEL ผ่าน .NET"
head_description: "รวมการรวมเอกสาร EXCEL เข้ากับโปรเจกต์ .NET ของคุณด้วย GroupDocs.Merger for .NET."

############################# Header ############################
title: "รวมไฟล์ EXCEL" 
description: "ใช้ GroupDocs.Merger for .NET เพื่อสร้างแอปพลิเคชัน .NET ที่ทรงพลังในการรวมและจัดการเอกสาร EXCEL อย่างราบรื่น."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) ช่วยให้การรวมเอกสาร EXCEL เป็นไปได้อย่างสะดวก เพิ่มฟังก์ชันการรวมเข้าไปในแอปพลิเคชัน .NET ของคุณและรวมไฟล์หลายไฟล์ได้อย่างมีประสิทธิภาพ.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // เริ่มต้น Merger ด้วยเอกสาร EXCEL ต้นฉบับ
