...
############################# Head ############################
head_title: "VSDX-Dateien in C# zusammenführen | VSDX Fusion"
head_description: "Führen Sie mehrere VSDX-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "VSDX Fusion in C#"
description: "Führen Sie VSDX mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere VSDX-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr VSDX-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie VSDX-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie VSDX-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument VSDX instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine VSDX-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) besuchen.
