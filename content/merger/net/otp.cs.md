...
############################# Head ############################
head_title: "Sloučit OTP soubory v C# | OTP Fúze"
head_description: "Sloučit více souborů OTP do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "OTP Fúze v C#"
description: "Sloučit OTP s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů OTP"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů OTP v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory OTP pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit OTP soubory pomocí GroupDocs.Merger API
