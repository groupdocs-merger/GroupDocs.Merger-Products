...
############################# Head ############################
head_title: "VSSX Dosyalarını C# İçinde Birleştir | VSSX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSSX dosyalarını birleştirin
