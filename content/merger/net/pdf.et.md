...
############################# Head ############################
head_title: "Ühendage PDF failid C# | PDF Ühinemine"
head_description: "Ühendage mitu PDF faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "PDF ühinemine programmis C#"
description: "Ühendage PDF mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam PDF faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PDF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid PDF, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks PDF faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
