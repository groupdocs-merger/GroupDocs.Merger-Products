...
############################# Head ############################
head_title: "Yhdistä ODS tiedostot C# | ODS Sulautuminen"
...
############################# Header ############################
title: "ODS Sulautuminen C#"
description: "Yhdistä ODS muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia ODS tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ODS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä ODS tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi ODS-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) -sivustolla.
