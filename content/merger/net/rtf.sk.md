...
############################# Head ############################
head_title: "Zlúčiť RTF súbory v C# | RTF Zlúčenie"
head_description: "Zlúčte viacero súborov RTF do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Zlúčiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "RTF Zlúčenie v C#"
description: "Zlúčte RTF s niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Ako zlúčiť viacero súborov RTF"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET zlúčiť dva alebo viac súborov RTF v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory RTF pomocou vzorového kódu C#">}}

        ```csharp    
        // Zlúčiť RTF súbory pomocou GroupDocs.Merger API
...
demos:
    ...
    content: |
       Zlúčte hneď teraz viac ako jeden súbor RTF na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
