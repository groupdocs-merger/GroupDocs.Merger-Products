...
head_description: "Sujunkite kelis PPS failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "PPS Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną PPS failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) svetainėje.
