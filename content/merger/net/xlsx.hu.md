...
############################# Head ############################
head_title: "XLSX fájlok egyesítése a C#-ban | XLSX Egyesülés"
head_description: "Egyesítsen több XLSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLSX Egyesülés a C# programban"
description: "Egyesítse a(z) XLSX terméket néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLSX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLSX fájlokat a GroupDocs.Merger API segítségével
