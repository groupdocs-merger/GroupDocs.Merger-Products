...
############################# Head ############################
head_title: "Spoji DOCM datoteke u C# | DOCM Spajanje"
head_description: "Spojite više DOCM datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "DOCM Spajanje u C#"
description: "Spoji DOCM s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti DOCM datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Spoji DOCM datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    ...
    content: |
       Spojite više od jedne DOCM datoteke upravo sada tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) web mjesto.
