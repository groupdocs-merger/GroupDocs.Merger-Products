...
############################# Head ############################
head_title: "Seitenorientierung von EXCEL in .NET-Apps anpassen"
head_description: "Mit GroupDocs.Merger for .NET passen Sie die Seitenlayouts von EXCEL (Hoch- oder Querformat) an. Verarbeiten Sie PDFs, Word-Dokumente, Excel-Tabellen, PowerPoint-Präsentationen, Visio-Zeichnungen, Bilder, Archive und mehr mühelos."

############################# Header ############################
title: "Seitenorientierung für EXCEL anpassen" 
description: "GroupDocs.Merger for .NET bietet praktische Werkzeuge für .NET-Apps. Entwickler können ihre Projekte verbessern, indem sie wichtige Dateiformate verwalten und die Seitenlayouts von EXCEL anpassen."
...
steps:
    enable: true
    title: "So passen Sie die Seitenorientierung von EXCEL an"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie die Seitenlayouts von EXCEL anpassen. Diese Funktion und weitere bieten eine intelligente Dokumentenverwaltung für .NET-Projekte.
      
      1. Laden Sie den Speicherort der EXCEL-Datei.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ändern Sie die Ausrichtung der letzten EXCEL-Seite"
      content: |
        Sehen Sie, wie die Seiten in einer EXCEL-Datei gezählt werden und wie die Ausrichtung der letzten Seite geändert wird.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
