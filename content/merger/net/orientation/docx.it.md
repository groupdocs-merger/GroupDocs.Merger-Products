...
############################# Head ############################
head_title: "Regola l'orientamento delle pagine DOCX nelle app .NET"
head_description: "Con GroupDocs.Merger for .NET, modifica i layout delle pagine DOCX (verticale o orizzontale). Gestisci PDF, file Word, fogli Excel, presentazioni PowerPoint, disegni Visio, immagini, archivi e altro senza problemi."

############################# Header ############################
title: "Modifiche all'orientamento delle pagine DOCX" 
description: "GroupDocs.Merger for .NET offre strumenti pratici per le app .NET. Gli sviluppatori possono migliorare i loro progetti gestendo formati di file chiave e regolando i layout delle pagine DOCX."
...
steps:
    enable: true
    title: "Come regolare l'orientamento delle pagine DOCX"
    content: |
      Con [GroupDocs.Merger](/merger/net/), modifica i layout delle pagine DOCX. Questa funzionalità e altre offrono un controllo intelligente dei documenti per i progetti .NET.
      
      1. Carica la posizione del file DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cambia l'orientamento dell'ultima pagina DOCX"
      content: |
