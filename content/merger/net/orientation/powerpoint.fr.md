...
############################# Head ############################
head_title: "Ajustez l'orientation des pages POWERPOINT dans les applications .NET"
head_description: "Avec GroupDocs.Merger for .NET, modifiez les mises en page des pages POWERPOINT (portrait ou paysage). Gérez facilement des PDF, des fichiers Word, des feuilles Excel, des présentations PowerPoint, des dessins Visio, des images, des archives et bien plus encore."

############################# Header ############################
title: "Ajustements d'orientation des pages pour POWERPOINT" 
description: "GroupDocs.Merger for .NET apporte des outils pratiques aux applications .NET. Les développeurs peuvent améliorer leurs projets en gérant des formats de fichiers clés et en ajustant les mises en page des pages POWERPOINT."
...
steps:
    enable: true
    title: "Comment ajuster l'orientation des pages POWERPOINT"
    content: |
      Avec [GroupDocs.Merger](/merger/net/), ajustez les mises en page des pages POWERPOINT. Cette fonctionnalité et d'autres offrent un contrôle documentaire intelligent pour les projets .NET.
      
      1. Chargez l'emplacement du fichier POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Modifier l'orientation de la dernière page POWERPOINT"
      content: |
        Voyez comment compter les pages dans un fichier POWERPOINT et inverser l'orientation de la dernière page.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
