...
############################# Head ############################
head_title: "Ajustar la orientación de página DOCX en aplicaciones .NET"
head_description: "Con GroupDocs.Merger for .NET, ajusta los diseños de página DOCX (vertical u horizontal). Maneja PDFs, archivos de Word, hojas de Excel, presentaciones de PowerPoint, dibujos de Visio, imágenes, archivos y más sin complicaciones."

############################# Header ############################
title: "Ajustes de orientación de página para DOCX" 
description: "GroupDocs.Merger for .NET ofrece herramientas prácticas para aplicaciones .NET. Los desarrolladores pueden mejorar sus proyectos al gestionar formatos de archivo clave y ajustar los diseños de página DOCX."
...
steps:
    enable: true
    title: "Cómo ajustar la orientación de página DOCX"
    content: |
      Con [GroupDocs.Merger](/merger/net/), ajusta los diseños de página DOCX. Esta función y otras ofrecen un control inteligente de documentos para proyectos .NET.
      
      1. Carga la ubicación del archivo DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Cambiar la orientación de la última página DOCX"
      content: |
        Descubre cómo contar páginas en un archivo DOCX y voltear la orientación de la última página.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
