...
############################# Head ############################
head_title: "Adjust XLSX page orientation in .NET apps"
head_description: "With GroupDocs.Merger for .NET, tweak XLSX page layouts (portrait or landscape). Handle PDFs, Word files, Excel sheets, PowerPoint decks, Visio drawings, images, archives, and more effortlessly."

############################# Header ############################
title: "Page orientation tweaks for XLSX" 
description: "GroupDocs.Merger for .NET brings practical tools to .NET apps. Developers can upgrade their projects by managing key file formats and adjusting XLSX page layouts."
...
steps:
    enable: true
    title: "How to tweak XLSX page orientation"
    content: |
      With [GroupDocs.Merger](/merger/net/), adjust XLSX page layouts. This feature and others offer smart document control for .NET projects.
      
      1. Load the XLSX file location.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Change orientation of the last XLSX page"
      content: |
        See how to count pages in a XLSX file and flip the last page’s orientation.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
