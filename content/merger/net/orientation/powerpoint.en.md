...
############################# Head ############################
head_title: "Adjust POWERPOINT page orientation in .NET apps"
head_description: "With GroupDocs.Merger for .NET, tweak POWERPOINT page layouts (portrait or landscape). Handle PDFs, Word files, Excel sheets, PowerPoint decks, Visio drawings, images, archives, and more effortlessly."

############################# Header ############################
title: "Page orientation tweaks for POWERPOINT" 
description: "GroupDocs.Merger for .NET brings practical tools to .NET apps. Developers can upgrade their projects by managing key file formats and adjusting POWERPOINT page layouts."
...
steps:
    enable: true
    title: "How to tweak POWERPOINT page orientation"
    content: |
      With [GroupDocs.Merger](/merger/net/), adjust POWERPOINT page layouts. This feature and others offer smart document control for .NET projects.
      
      1. Load the POWERPOINT file location.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Change orientation of the last POWERPOINT page"
      content: |
        See how to count pages in a POWERPOINT file and flip the last page’s orientation.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
