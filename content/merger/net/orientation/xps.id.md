...
############################# Head ############################
head_title: "Sesuaikan orientasi halaman XPS dalam aplikasi .NET"
head_description: "Dengan GroupDocs.Merger for .NET, atur tata letak halaman XPS (potret atau lanskap). Tangani PDF, file Word, lembar Excel, presentasi PowerPoint, gambar Visio, gambar, arsip, dan lainnya secara efisien."

############################# Header ############################
title: "Penyesuaian orientasi halaman untuk XPS" 
description: "GroupDocs.Merger for .NET menghadirkan alat praktis untuk aplikasi .NET. Pengembang dapat meningkatkan proyek mereka dengan mengelola format file utama dan menyesuaikan tata letak halaman XPS."
...
steps:
    enable: true
    title: "Cara menyesuaikan orientasi halaman XPS"
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), sesuaikan tata letak halaman XPS. Fitur ini dan lainnya menawarkan kontrol dokumen yang cerdas untuk proyek .NET.
      
      1. Muati lokasi file XPS.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ubah orientasi halaman terakhir XPS"
      content: |
        Lihat bagaimana cara menghitung halaman dalam file XPS dan membalikkan orientasi halaman terakhir.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
