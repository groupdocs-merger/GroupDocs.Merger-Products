...
############################# Head ############################
head_title: "Ühendage EPUB failid C# | EPUB Ühinemine"
head_description: "Ühendage mitu EPUB faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "EPUB ühinemine programmis C#"
description: "Ühendage EPUB mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam EPUB faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita EPUB faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid EPUB, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks EPUB faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
