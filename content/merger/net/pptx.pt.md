...
############################# Head ############################
head_title: "Mesclar PPTX Arquivos em C# | PPTX Fusão"
head_description: "Mescle vários arquivos PPTX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "PPTX Fusão em C#"
description: "Mescle PPTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos PPTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos PPTX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar PPTX arquivos usando a API GroupDocs.Merger
