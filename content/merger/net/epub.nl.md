...
############################# Head ############################
head_title: "Voeg EPUB bestanden samen in C# | EPUB Fusie"
head_description: "Voeg meerdere EPUB bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "EPUB Fusie in C#"
description: "Voeg EPUB samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere EPUB bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer EPUB-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg EPUB bestanden samen met de GroupDocs.Merger API
