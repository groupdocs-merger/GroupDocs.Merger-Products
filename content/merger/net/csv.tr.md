...
############################# Head ############################
head_title: "CSV Dosyalarını C# İçinde Birleştir | CSV Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak CSV dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak CSV dosyalarını birleştirin
