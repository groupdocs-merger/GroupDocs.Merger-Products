...
############################# Head ############################
head_title: "Slå sammen ODT-filer i C# | ODT Fusjon"
...
############################# Header ############################
title: "ODT sammenslåing i C#"
description: "Slå sammen ODT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere ODT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ODT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen ODT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én ODT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt).
