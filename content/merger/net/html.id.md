...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa HTML File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu HTML file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html).
