...
############################# Head ############################
head_title: "Yhdistä VSTM tiedostot C# | VSTM Sulautuminen"
...
############################# Header ############################
title: "VSTM Sulautuminen C#"
description: "Yhdistä VSTM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VSTM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSTM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VSTM tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VSTM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm) -sivustolla.
