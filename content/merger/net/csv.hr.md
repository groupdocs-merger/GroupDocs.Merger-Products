...
############################# Head ############################
head_title: "Spoji CSV datoteke u C# | CSV Spajanje"
head_description: "Spojite više CSV datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "CSV Spajanje u C#"
description: "Spoji CSV s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti CSV datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Spoji CSV datoteke pomoću API-ja GroupDocs.Merger
