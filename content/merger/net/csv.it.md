...
############################# Head ############################
head_title: "Unisci file CSV tramite .NET"
head_description: "Integra la fusione di documenti CSV nei tuoi progetti .NET con GroupDocs.Merger for .NET."

############################# Header ############################
title: "Unisci file CSV" 
description: "Utilizza GroupDocs.Merger for .NET per creare potenti applicazioni .NET che uniscono e gestiscono senza difficoltà documenti CSV."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) rende semplice unire documenti CSV. Aggiungi funzionalità di fusione alle tue applicazioni .NET e combina più file senza problemi.
      
      1. Definisci il percorso del primo file CSV.
