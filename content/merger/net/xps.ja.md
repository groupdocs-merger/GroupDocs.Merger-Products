...
############################# Head ############################
head_title: "C# 内の XPS ファイルをマージ | XPS合併"
head_description: "C# .NET ドキュメント マージ API を使用して、複数の XPS ファイルを 1 つのファイルにマージします。さまざまなドキュメントの特定のページまたはページ範囲を 1 つのドキュメントにマージします。"

############################# Header ############################
title: "XPS C#での合併"
description: "XPS を数行の .NET コードとマージします。"
...
steps:
    enable: true
    title_left: "複数の XPS ファイルをマージする方法"
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) を使用すると、.NET の開発者は、アプリケーション内で 2 つ以上の XPS ファイルを簡単にマージできます。いくつかの簡単な手順。
    ...
    code: |
     ...
     {{< merger/code-merger title="C# サンプル コードを使用して XPS ファイルをマージする方法">}}

        ```csharp    
        // GroupDocs.Merger API を使用して XPS ファイルをマージします
