...
############################# Head ############################
head_title: "BMP Dosyalarını C# İçinde Birleştir | BMP Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak BMP dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak BMP dosyalarını birleştirin
