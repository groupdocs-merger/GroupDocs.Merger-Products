...
############################# Head ############################
head_title: "Yhdistä VTX tiedostot C# | VTX Sulautuminen"
...
############################# Header ############################
title: "VTX Sulautuminen C#"
description: "Yhdistä VTX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia VTX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VTX tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VTX-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx) -sivustolla.
