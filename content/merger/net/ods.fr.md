...
############################# Head ############################
head_title: "Fusionner les fichiers ODS dans C# | ODS Fusion"
head_description: "Fusionnez plusieurs fichiers ODS en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "ODS Fusionner dans C#"
description: "Fusionnez ODS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers ODS dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers ODS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner ODS fichiers à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers ODS dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
