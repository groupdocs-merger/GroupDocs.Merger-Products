...
############################# Head ############################
head_title: "Mesclar ODT Arquivos em C# | ODT Fusão"
head_description: "Mescle vários arquivos ODT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "ODT Fusão em C#"
description: "Mescle ODT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos ODT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos ODT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos ODT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar ODT arquivos usando a API GroupDocs.Merger
