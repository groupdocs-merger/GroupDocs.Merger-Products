...
############################# Head ############################
head_title: "Slå sammen OTT-filer i C# | OTT Fusjon"
...
############################# Header ############################
title: "OTT sammenslåing i C#"
description: "Slå sammen OTT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere OTT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen OTT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen OTT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én OTT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
