...
############################# Head ############################
head_title: "JPG ፋይሎችን በC# | አዋህድ JPG ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ JPG ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች ወደ አንድ ሰነድ ያዋህዱ።"

############################# Header ############################
title: "የJPG ውህደት በC#"
description: "JPGን ከጥቂት የ.NET ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በርካታ JPG ፋይሎችን እንዴት እንደሚዋሃድ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች አንድን በመተግበር ሁለት ወይም ከዚያ በላይ የሆኑ JPG ፋይሎችን በመተግበሪያዎቻቸው ውስጥ ማዋሃድ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም JPG ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም JPG ፋይሎችን አዋህድ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ JPG ፋይሎችን አዋህድ።
