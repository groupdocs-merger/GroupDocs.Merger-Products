...
############################# Head ############################
head_title: "Sloučit XLSM soubory v C# | XLSM Fúze"
head_description: "Sloučit více souborů XLSM do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "XLSM Fúze v C#"
description: "Sloučit XLSM s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů XLSM"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů XLSM v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory XLSM pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit XLSM soubory pomocí GroupDocs.Merger API
