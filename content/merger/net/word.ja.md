...
############################# Head ############################
head_title: ".NETでWORDファイルをマージする"
head_description: "GroupDocs.Merger for .NETを使用して、.NETプロジェクトにWORDドキュメントのマージ機能を統合します。"

############################# Header ############################
title: "WORDファイルをマージする" 
description: "GroupDocs.Merger for .NETを使用して、.NETアプリケーションを作成し、WORDドキュメントをシームレスにマージおよび管理します。"
...
steps:
    enable: true
    title: "WORDドキュメントをマージする手順"
    content: |
      [GroupDocs.Merger](/merger/net/)を使用して、WORDドキュメントをマージします。.NETアプリケーションにマージ機能を追加し、複数のファイルをスムーズに結合します。
      
      1. 最初のWORDファイルのパスを定義します。
