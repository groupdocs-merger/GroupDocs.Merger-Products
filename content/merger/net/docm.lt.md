...
head_description: "Sujunkite kelis DOCM failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "DOCM Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną DOCM failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) svetainėje.
