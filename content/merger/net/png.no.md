...
############################# Head ############################
head_title: "Slå sammen PNG-filer i C# | PNG Fusjon"
...
############################# Header ############################
title: "PNG sammenslåing i C#"
description: "Slå sammen PNG med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere PNG-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PNG filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen PNG filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én PNG-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
