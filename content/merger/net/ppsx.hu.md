...
############################# Head ############################
head_title: "PPSX fájlok egyesítése a C#-ban | PPSX Egyesülés"
head_description: "Egyesítsen több PPSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPSX Egyesülés a C# programban"
description: "Egyesítse a(z) PPSX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPSX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPSX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen PPSX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több PPSX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) webhely meglátogatásával.
