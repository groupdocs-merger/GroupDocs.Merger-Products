...
############################# Head ############################
head_title: "Sujungti PDF failus C# | PDF Susijungimas"
head_description: "Sujunkite kelis PDF failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "PDF Susijungimas C#"
description: "Sujunkite PDF su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis PDF failus"
    content_left: |
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną PDF failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) svetainėje.
