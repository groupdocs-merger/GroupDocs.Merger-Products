...
############################# Head ############################
head_title: "ONENOTE-Dateien in C# zusammenführen | ONENOTE Fusion"
head_description: "Führen Sie mehrere ONENOTE-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "ONENOTE Fusion in C#"
description: "Führen Sie ONENOTE mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere ONENOTE-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr ONENOTE-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie ONENOTE-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie ONENOTE-Dateien mit der GroupDocs.Merger-API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine ONENOTE-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/onenote) besuchen.
