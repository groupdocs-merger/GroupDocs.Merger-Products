...
############################# Head ############################
head_title: "Yhdistä XLSB tiedostot C# | XLSB Sulautuminen"
...
############################# Header ############################
title: "XLSB Sulautuminen C#"
description: "Yhdistä XLSB muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLSB tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLSB tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä XLSB tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLSB-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb) -sivustolla.
