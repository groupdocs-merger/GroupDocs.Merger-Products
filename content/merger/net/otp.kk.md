...
############################# Head ############################
head_title: "C# ішіндегі OTP файлдарды біріктіру | OTP Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше OTP файлдарды бір файлға біріктіріңіз. Арнайы беттерді немесе бет ауқымдарын әртүрлі құжаттардан бір құжатқа біріктіріңіз."

############################# Header ############################
title: "OTP Біріктіру C#"
description: "OTP кодының бірнеше жолын .NET кодымен біріктіріңіз."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп OTP файлды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
...
demos:
    ...
    content: |
       Дәл қазір [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) веб-сайтына кіру арқылы бірден көп OTP файлдарды біріктіріңіз.
