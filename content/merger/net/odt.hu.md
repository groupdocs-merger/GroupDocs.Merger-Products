...
############################# Head ############################
head_title: "ODT fájlok egyesítése a C#-ban | ODT Egyesülés"
head_description: "Egyesítsen több ODT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODT Egyesülés a C# programban"
description: "Egyesítse a(z) ODT terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODT fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODT fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen ODT fájlokat a GroupDocs.Merger API segítségével
