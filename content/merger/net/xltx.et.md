...
############################# Head ############################
head_title: "Ühendage XLTX failid C# | XLTX Ühinemine"
head_description: "Ühendage mitu XLTX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "XLTX ühinemine programmis C#"
description: "Ühendage XLTX mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam XLTX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLTX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid XLTX, kasutades GroupDocs.Merger API-t
