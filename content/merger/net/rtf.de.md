...
############################# Head ############################
head_title: "RTF-Dateien in C# zusammenführen | RTF Fusion"
head_description: "Führen Sie mehrere RTF-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "RTF Fusion in C#"
description: "Führen Sie RTF mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere RTF-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr RTF-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie RTF-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie RTF-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument RTF instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine RTF-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf) besuchen.
