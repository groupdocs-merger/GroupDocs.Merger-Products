...
############################# Head ############################
head_title: "Merge PNG files via .NET"
head_description: "Integrate PNG document merging into your .NET projects with GroupDocs.Merger for .NET."

############################# Header ############################
title: "Merge PNG files" 
description: "Use GroupDocs.Merger for .NET to create powerful .NET applications that seamlessly merge and manage PNG documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to merge PNG documents. Add merging functionality to your .NET applications and combine multiple files effortlessly.
      
      1. Define the path to the first PNG file.
