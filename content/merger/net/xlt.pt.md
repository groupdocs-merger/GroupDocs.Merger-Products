...
############################# Head ############################
head_title: "Mesclar XLT Arquivos em C# | XLT Fusão"
head_description: "Mescle vários arquivos XLT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLT Fusão em C#"
description: "Mescle XLT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLT arquivos usando a API GroupDocs.Merger
