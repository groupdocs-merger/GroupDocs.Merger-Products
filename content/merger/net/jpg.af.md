...
############################# Head ############################
head_title: "Voeg JPG lêers saam in C# | JPG samesmelting"
head_description: "Voeg veelvuldige JPG lêers saam in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Voeg spesifieke bladsye of bladsyreekse saam van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "JPG samesmelting in C#"
description: "Voeg JPG saam met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige JPG-lêers saam te voeg"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer JPG-lêers binne hul toepassings saam te voeg deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om JPG lêers saam te voeg deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Voeg JPG lêers saam met GroupDocs.Merger API
...
demos:
    ...
    content: |
       Voeg nou meer as een JPG-lêers saam deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) webwerf te besoek.
