...
############################# Head ############################
head_title: "دمج ملفات DOC في C# | DOC الاندماج"
head_description: "دمج عدة ملفات DOC في ملف واحد باستخدام C# .NET لدمج المستندات API. دمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "DOC الاندماج في C#"
description: "دمج DOC ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات DOC"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من DOC داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات DOC باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات DOC باستخدام GroupDocs.Merger API
...
demos:
    ...
    content: |
       ادمج أكثر من DOC ملفًا واحدًا الآن من خلال زيارة موقع ويب [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc).
