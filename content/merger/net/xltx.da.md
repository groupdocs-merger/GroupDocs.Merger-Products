...
############################# Head ############################
head_title: "Flet XLTX filer i C# | XLTX Fusion"
head_description: "Flet flere XLTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "XLTX fusion i C#"
description: "Flet XLTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere XLTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere XLTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet XLTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én XLTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
