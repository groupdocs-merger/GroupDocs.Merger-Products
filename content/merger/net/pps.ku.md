...
############################# Head ############################
head_title: "Pelên PPS di C# de bike yek | PPS Hevgirtin"
head_description: "Gelek pelên PPS di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "PPS Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek PPS Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir PPS pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên PPS bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên PPS bi karanîna GroupDocs.Merger API-ê bikin yek
