...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa TXT File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu TXT file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt).
