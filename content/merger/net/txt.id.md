...
############################# Head ############################
head_title: "Gabungkan file TXT melalui .NET"
head_description: "Integrasikan penggabungan dokumen TXT ke dalam proyek .NET Anda dengan GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gabungkan file TXT" 
description: "Gunakan GroupDocs.Merger for .NET untuk membuat aplikasi .NET yang kuat yang mampu menggabungkan dan mengelola dokumen TXT tanpa kendala."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan penggabungan dokumen TXT. Tambahkan fungsionalitas penggabungan ke aplikasi .NET Anda dan gabungkan beberapa file dengan mulus.
      
      1. Tentukan jalur ke file TXT yang pertama.
