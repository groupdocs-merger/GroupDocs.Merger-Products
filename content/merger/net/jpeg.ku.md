...
############################# Head ############################
head_title: "Pelên JPEG di C# de bike yek | JPEG Hevgirtin"
head_description: "Gelek pelên JPEG di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "JPEG Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek JPEG Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir JPEG pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên JPEG bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên JPEG bi karanîna GroupDocs.Merger API-ê bikin yek
