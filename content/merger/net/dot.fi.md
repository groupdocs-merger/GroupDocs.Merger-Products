...
############################# Head ############################
head_title: "Yhdistä DOT tiedostot C# | DOT Sulautuminen"
...
############################# Header ############################
title: "DOT Sulautuminen C#"
description: "Yhdistä DOT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia DOT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä DOT tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot) -sivustolla.
