...
############################# Head ############################
head_title: "Mesclar EPUB Arquivos em C# | EPUB Fusão"
head_description: "Mescle vários arquivos EPUB em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "EPUB Fusão em C#"
description: "Mescle EPUB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos EPUB"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos EPUB em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos EPUB usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar EPUB arquivos usando a API GroupDocs.Merger
