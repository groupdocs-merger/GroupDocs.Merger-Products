...
head_description: "Sujunkite kelis XLT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "XLT Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną XLT failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) svetainėje.
