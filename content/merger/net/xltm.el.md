...
############################# Head ############################
head_title: "Συγχώνευση αρχείων XLTM στο C# | XLTM Συγχώνευση"
head_description: "Συγχωνεύστε πολλά αρχεία XLTM σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συγχώνευση συγκεκριμένων σελίδων ή περιοχών σελίδων από διάφορα έγγραφα σε ένα μόνο έγγραφο."

############################# Header ############################
title: "XLTM Συγχώνευση στο C#"
description: "Συγχώνευση XLTM με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συγχωνεύσετε πολλά αρχεία XLTM"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να συγχωνεύσουν δύο ή περισσότερα αρχεία XLTM στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συγχωνεύσετε αρχεία XLTM χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Συγχώνευση αρχείων XLTM χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    ...
    content: |
       Συγχωνεύστε περισσότερα από ένα XLTM αρχεία αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
