...
############################# Head ############################
head_title: "Slå sammen DOCM-filer i C# | DOCM Fusjon"
...
############################# Header ############################
title: "DOCM sammenslåing i C#"
description: "Slå sammen DOCM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere DOCM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOCM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen DOCM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én DOCM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm).
