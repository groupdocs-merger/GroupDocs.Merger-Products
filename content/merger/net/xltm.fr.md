...
############################# Head ############################
head_title: "Fusionner les fichiers XLTM dans C# | XLTM Fusion"
head_description: "Fusionnez plusieurs fichiers XLTM en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "XLTM Fusionner dans C#"
description: "Fusionnez XLTM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers XLTM"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers XLTM dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers XLTM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner XLTM fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée XLTM
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers XLTM dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
