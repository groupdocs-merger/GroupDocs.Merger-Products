...
############################# Head ############################
head_title: "TXT Dosyalarını C# İçinde Birleştir | TXT Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TXT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TXT dosyalarını birleştirin
