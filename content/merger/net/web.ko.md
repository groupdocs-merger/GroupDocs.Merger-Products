...
############################# Head ############################
head_title: "C#에서 WEB 파일 병합 | WEB 합병"
head_description: "C# .NET 문서 병합 API를 사용하여 여러 WEB 파일을 단일 파일로 병합합니다. 다양한 문서의 특정 페이지 또는 페이지 범위를 단일 문서로 병합합니다."

############################# Header ############################
title: "WEB C# 합병"
description: "몇 줄의 .NET 코드와 WEB를 병합합니다."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 WEB 파일을 병합하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 WEB 파일 병합
