...
############################# Head ############################
head_title: "Slå sammen MHT-filer i C# | MHT Fusjon"
...
############################# Header ############################
title: "MHT sammenslåing i C#"
description: "Slå sammen MHT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere MHT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen MHT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen MHT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én MHT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht).
