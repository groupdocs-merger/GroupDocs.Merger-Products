...
############################# Head ############################
head_title: "Slå sammen TEX-filer i C# | TEX Fusjon"
...
############################# Header ############################
title: "TEX sammenslåing i C#"
description: "Slå sammen TEX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere TEX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen TEX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen TEX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én TEX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex).
