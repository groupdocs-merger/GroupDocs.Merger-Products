...
############################# Head ############################
head_title: "Slå sammen XLTM-filer i C# | XLTM Fusjon"
...
############################# Header ############################
title: "XLTM sammenslåing i C#"
description: "Slå sammen XLTM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLTM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLTM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLTM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLTM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm).
