...
############################# Head ############################
head_title: "Обединете ONE файлове в C# | ONE Сливане"
head_description: "Обединете няколко файла ONE в един файл с помощта на API за сливане на документи C# .NET. Обединете конкретни страници или диапазони от различни документи в един документ."

############################# Header ############################
title: "ONE Обединяване в C#"
description: "Обединете ONE с няколко реда от кода на .NET."
...
steps:
    enable: true
    title_left: "Как да обедините няколко ONE файла"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да обединят два или повече ONE файла в техните приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да обедините ONE файлове с C# примерен код">}}

        ```csharp    
        // Обединете ONE файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Обединете повече от един ONE файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
