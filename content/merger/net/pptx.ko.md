...
############################# Head ############################
head_title: "C#에서 PPTX 파일 병합 | PPTX 합병"
head_description: "C# .NET 문서 병합 API를 사용하여 여러 PPTX 파일을 단일 파일로 병합합니다. 다양한 문서의 특정 페이지 또는 페이지 범위를 단일 문서로 병합합니다."

############################# Header ############################
title: "PPTX C# 합병"
description: "몇 줄의 .NET 코드와 PPTX를 병합합니다."
...
steps:
    enable: true
    title_left: "여러 PPTX 파일을 병합하는 방법"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 PPTX 파일을 병합하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 PPTX 파일 병합
