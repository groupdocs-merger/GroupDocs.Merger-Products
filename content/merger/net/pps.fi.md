...
############################# Head ############################
head_title: "Yhdistä PPS tiedostot C# | PPS Sulautuminen"
...
############################# Header ############################
title: "PPS Sulautuminen C#"
description: "Yhdistä PPS muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia PPS tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PPS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä PPS tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PPS-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) -sivustolla.
