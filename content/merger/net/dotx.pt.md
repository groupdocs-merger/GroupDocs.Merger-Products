...
############################# Head ############################
head_title: "Mesclar DOTX Arquivos em C# | DOTX Fusão"
head_description: "Mescle vários arquivos DOTX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "DOTX Fusão em C#"
description: "Mescle DOTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos DOTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos DOTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOTX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar DOTX arquivos usando a API GroupDocs.Merger
