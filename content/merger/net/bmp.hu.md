...
############################# Head ############################
head_title: "BMP fájlok egyesítése a C#-ban | BMP Egyesülés"
head_description: "Egyesítsen több BMP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "BMP Egyesülés a C# programban"
description: "Egyesítse a(z) BMP terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több BMP fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több BMP fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="BMP fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen BMP fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több BMP fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp) webhely meglátogatásával.
