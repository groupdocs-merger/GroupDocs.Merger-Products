...
############################# Head ############################
head_title: "Mescle arquivos XPS via .NET"
head_description: "Integre a mesclagem de documentos XPS em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos XPS" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos XPS de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos XPS. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
