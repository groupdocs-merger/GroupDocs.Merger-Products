...
############################# Head ############################
head_title: "Mesclar XPS Arquivos em C# | XPS Fusão"
head_description: "Mescle vários arquivos XPS em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XPS Fusão em C#"
description: "Mescle XPS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XPS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XPS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XPS usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XPS arquivos usando a API GroupDocs.Merger
