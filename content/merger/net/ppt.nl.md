...
############################# Head ############################
head_title: "Voeg PPT bestanden samen in C# | PPT Fusie"
head_description: "Voeg meerdere PPT bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "PPT Fusie in C#"
description: "Voeg PPT samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PPT bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPT-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPT bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg PPT bestanden samen met de GroupDocs.Merger API
