...
############################# Head ############################
head_title: "DOTM Dosyalarını C# İçinde Birleştir | DOTM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOTM dosyalarını birleştirin
