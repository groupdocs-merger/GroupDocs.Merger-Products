...
############################# Head ############################
head_title: "Slå sammen DOTX-filer i C# | DOTX Fusjon"
...
############################# Header ############################
title: "DOTX sammenslåing i C#"
description: "Slå sammen DOTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere DOTX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen DOTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen DOTX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én DOTX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dotx).
