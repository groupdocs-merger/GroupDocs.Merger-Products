...
############################# Head ############################
head_title: "C# ішіндегі HTML файлдарды біріктіру | HTML Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше HTML файлдарды бір файлға біріктіріңіз. Арнайы беттерді немесе бет ауқымдарын әртүрлі құжаттардан бір құжатқа біріктіріңіз."

############################# Header ############################
title: "HTML Біріктіру C#"
description: "HTML кодының бірнеше жолын .NET кодымен біріктіріңіз."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп HTML файлды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
