...
############################# Head ############################
head_title: "PPTX Dosyalarını C# İçinde Birleştir | PPTX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPTX dosyalarını birleştirin
