...
############################# Head ############################
head_title: "Gabungkan VSTM File di C# | VSTM Penggabungan"
head_description: "Gabungkan beberapa file VSTM menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "VSTM Penggabungan Dalam C#"
description: "Gabungkan VSTM dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSTM file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm).
