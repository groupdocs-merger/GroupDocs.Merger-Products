...
############################# Head ############################
head_title: "Flet VSTM filer i C# | VSTM Fusion"
head_description: "Flet flere VSTM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VSTM fusion i C#"
description: "Flet VSTM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VSTM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VSTM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSTM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VSTM filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VSTM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstm).
