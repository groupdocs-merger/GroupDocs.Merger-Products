...
############################# Head ############################
head_title: "Ühendage VSDM failid C# | VSDM Ühinemine"
head_description: "Ühendage mitu VSDM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "VSDM ühinemine programmis C#"
description: "Ühendage VSDM mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam VSDM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita VSDM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid VSDM, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks VSDM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
