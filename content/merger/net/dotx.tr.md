...
############################# Head ############################
head_title: "DOTX Dosyalarını C# İçinde Birleştir | DOTX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOTX dosyalarını birleştirin
