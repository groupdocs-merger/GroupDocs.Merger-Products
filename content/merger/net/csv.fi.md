...
############################# Head ############################
head_title: "Yhdistä CSV tiedostot C# | CSV Sulautuminen"
...
############################# Header ############################
title: "CSV Sulautuminen C#"
description: "Yhdistä CSV muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia CSV tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää CSV tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä CSV tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi CSV-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv) -sivustolla.
