...
############################# Head ############################
head_title: "Mesclar XLSB Arquivos em C# | XLSB Fusão"
head_description: "Mescle vários arquivos XLSB em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLSB Fusão em C#"
description: "Mescle XLSB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLSB em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLSB usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLSB arquivos usando a API GroupDocs.Merger
