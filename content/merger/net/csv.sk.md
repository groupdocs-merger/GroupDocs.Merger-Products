...
############################# Head ############################
head_title: "Zlúčiť CSV súbory v C# | CSV Zlúčenie"
head_description: "Zlúčte viacero súborov CSV do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Zlúčiť konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "CSV Zlúčenie v C#"
description: "Zlúčte CSV s niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Ako zlúčiť viacero súborov CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET zlúčiť dva alebo viac súborov CSV v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako zlúčiť súbory CSV pomocou vzorového kódu C#">}}

        ```csharp    
        // Zlúčiť CSV súbory pomocou GroupDocs.Merger API
...
demos:
    ...
    content: |
       Zlúčte hneď teraz viac ako jeden súbor CSV na webovej lokalite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv).
