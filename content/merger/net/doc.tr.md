...
############################# Head ############################
head_title: "DOC Dosyalarını C# İçinde Birleştir | DOC Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOC dosyalarını birleştirin
