...
############################# Head ############################
head_title: "Slå sammen ONE-filer i C# | ONE Fusjon"
...
############################# Header ############################
title: "ONE sammenslåing i C#"
description: "Slå sammen ONE med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere ONE-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen ONE filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen ONE filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én ONE-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
