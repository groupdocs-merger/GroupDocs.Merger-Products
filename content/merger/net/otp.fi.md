...
############################# Head ############################
head_title: "Yhdistä OTP tiedostot C# | OTP Sulautuminen"
...
############################# Header ############################
title: "OTP Sulautuminen C#"
description: "Yhdistä OTP muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia OTP tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää OTP tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä OTP tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi OTP-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) -sivustolla.
