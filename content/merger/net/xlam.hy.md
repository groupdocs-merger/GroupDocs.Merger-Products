...
head_description: "Միավորել բազմաթիվ XLAM ֆայլեր մեկ ֆայլի մեջ՝ օգտագործելով C# .NET փաստաթղթերի միաձուլման API-ն: Միավորել որոշակի էջեր կամ էջերի միջակայքերը՝ տարբեր փաստաթղթերից մինչև մեկ փաստաթուղթ:"

############################# Header ############################
title: "XLAM Միաձուլում C#-ում"
...
steps:
    enable: true
    title_left: "Ինչպես միացնել բազմաթիվ XLAM ֆայլեր"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է .NET ծրագրավորողների համար միաձուլել երկու կամ ավելի XLAM ֆայլեր իրենց հավելվածներում` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միաձուլել XLAM ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}
