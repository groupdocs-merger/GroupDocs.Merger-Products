...
############################# Head ############################
head_title: "Slå sammen VSSX-filer i C# | VSSX Fusjon"
...
############################# Header ############################
title: "VSSX sammenslåing i C#"
description: "Slå sammen VSSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSSX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSSX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VSSX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
