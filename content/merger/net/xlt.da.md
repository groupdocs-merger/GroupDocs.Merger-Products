...
############################# Head ############################
head_title: "Flet XLT filer i C# | XLT Fusion"
head_description: "Flet flere XLT filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "XLT fusion i C#"
description: "Flet XLT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere XLT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere XLT-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet XLT filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én XLT-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
