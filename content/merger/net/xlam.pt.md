...
############################# Head ############################
head_title: "Mesclar XLAM Arquivos em C# | XLAM Fusão"
head_description: "Mescle vários arquivos XLAM em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLAM Fusão em C#"
description: "Mescle XLAM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLAM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLAM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLAM usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLAM arquivos usando a API GroupDocs.Merger
