...
############################# Head ############################
head_title: "Pööra EPUB lehekülge C#-s – pöörake 90, 180, 270 nurga all"
...
############################# Header ############################
title: "Pööra EPUB lehte programmis C#"
description: "Pöörake EPUB lehte mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Pöörake EPUB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab C# arendajatel hõlpsasti pöörata mõnda konkreetset või kõiki lehti EPUB failis 90 juures , 180 või 270 pöördenurka mõne lihtsa sammu abil.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas pöörata EPUB faililehte, kasutades C# näitekoodi">}}
