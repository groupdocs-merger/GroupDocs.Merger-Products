...
############################# Head ############################
head_title: "Girar EPUB Páginas em C# – Girar em 90, 180, 270 Ângulo"
...
############################# Header ############################
title: "Girar EPUB Páginas em C#"
description: "Gire EPUB Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Girar EPUB Páginas de Arquivo em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do C# girar algumas páginas específicas ou todas em um arquivo EPUB em 90 , 180 ou 270 ângulo de rotação implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como girar as páginas do arquivo EPUB usando o código de exemplo C#">}}
