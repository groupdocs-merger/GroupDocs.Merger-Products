...
############################# Head ############################
head_title: "Pööra XPS lehekülge C#-s – pöörake 90, 180, 270 nurga all"
...
############################# Header ############################
title: "Pööra XPS lehte programmis C#"
description: "Pöörake XPS lehte mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Pöörake XPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab C# arendajatel hõlpsasti pöörata mõnda konkreetset või kõiki lehti XPS failis 90 juures , 180 või 270 pöördenurka mõne lihtsa sammu abil.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas pöörata XPS faililehte, kasutades C# näitekoodi">}}
