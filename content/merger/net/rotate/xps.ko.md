...
############################# Head ############################
head_title: "C#에서 XPS 페이지 회전 – 90, 180, 270 각도로 회전"
head_description: "문서 병합 API를 사용하여 XPS 파일의 특정 또는 모든 문서 페이지를 90, 180, 270 회전 각도로 회전합니다."

############################# Header ############################
title: "C#에서 XPS 페이지 회전"
description: "몇 줄의 .NET 코드로 XPS 페이지를 회전합니다."
...
steps:
    enable: true
    title_left: ".NET에서 XPS 파일 페이지 회전"
    content_left: |
        [GroupDocs.Merger for .NET](/ko/merger/net/)를 사용하면 C# 개발자가 XPS 파일 내의 특정 또는 모든 페이지를 90도로 회전할 수 있습니다. , 몇 가지 간단한 단계를 구현하여 180도 또는 270도 회전 각도.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 XPS 파일 페이지를 회전하는 방법">}}
