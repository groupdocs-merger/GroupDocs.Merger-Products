...
############################# Head ############################
head_title: "Girar EPUB páginas en C#: girar en ángulo de 90, 180, 270"
...
############################# Header ############################
title: "Rotar EPUB páginas en C#"
description: "Gire EPUB páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Rotar EPUB páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# rotar algunas páginas específicas o todas dentro de un archivo EPUB en 90 , 180 o 270 ángulo de rotación mediante la implementación de unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo rotar las páginas del archivo EPUB usando el código de ejemplo C#">}}
