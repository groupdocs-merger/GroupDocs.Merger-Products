...
############################# Head ############################
head_title: "หมุน XPS หน้าใน C# – หมุนที่มุม 90, 180, 270"
head_description: "หมุนหน้าเอกสารเฉพาะหรือทั้งหมดของไฟล์ XPS ที่มุมการหมุน 90, 180, 270 โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "หมุน XPS หน้าใน C#"
description: "หมุน XPS หน้าด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "หมุนหน้าไฟล์ XPS ใน .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา C# สามารถหมุนเวียนบางหน้าหรือบางหน้าภายในไฟล์ XPS ที่ 90 ได้ง่าย , มุมการหมุน 180 หรือ 270 โดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีหมุนหน้าไฟล์ XPS โดยใช้โค้ดตัวอย่าง C#">}}
