...
description: "Roter EPUB sider med noen få linjer med .NET-kode."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å rotere noen spesifikke eller alle sider i en EPUB-fil ved 90 , 180 eller 270 rotasjonsvinkel ved å implementere noen få enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan rotere EPUB filsider ved å bruke C# eksempelkode">}}
