...
############################# Head ############################
head_title: "Zasukaj TEX strani v C# – zasukaj pod kotom 90, 180, 270"
...
############################# Header ############################
title: "Zavrti TEX strani v C#"
description: "Zavrtite strani TEX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zavrti strani datoteke TEX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša vrtenje nekaterih ali vseh strani znotraj datoteke TEX na 90 , kot vrtenja 180 ali 270 z izvedbo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zasukati strani datoteke TEX s primerom kode C#">}}
