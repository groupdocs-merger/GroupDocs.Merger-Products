...
############################# Head ############################
head_title: "XPS беттерді C# ішінде бұру – 90, 180, 270 бұрышта бұру"
...
############################# Header ############################
title: "XPS беттерді C# ішінде бұру"
description: "XPS беттерді .NET кодының бірнеше жолымен айналдырыңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі XPS файл бетін бұру"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне XPS файлындағы кейбір нақты немесе барлық беттерді 90 градусқа бұруды жеңілдетеді. , Бірнеше оңай қадамдарды орындау арқылы 180 немесе 270 айналу бұрышы.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# мысал кодын пайдаланып XPS файл бетін қалай бұруға болады">}}
