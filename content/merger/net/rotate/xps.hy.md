...
############################# Head ############################
head_title: "Պտտեցնել XPS էջերը C#-ում – Պտտել 90, 180, 270 անկյան տակ"
...
############################# Header ############################
title: "Պտտեցնել XPS էջ C#-ում"
description: "Պտտեցնել XPS էջերը .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Պտտեցնել XPS ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար պտտել որոշ կոնկրետ կամ բոլոր էջերը XPS ֆայլում 90-ով: , 180 կամ 270 ռոտացիայի անկյուն՝ կատարելով մի քանի հեշտ քայլեր։
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես պտտել XPS ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}
