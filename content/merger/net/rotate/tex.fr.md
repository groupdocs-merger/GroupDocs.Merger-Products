...
############################# Head ############################
head_title: "Faire pivoter TEX Pages dans C# - Faire pivoter à 90, 180, 270 Angle"
...
############################# Header ############################
title: "Faire pivoter TEX pages dans C#"
description: "Faites pivoter les pages TEX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Faire pivoter TEX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de faire pivoter facilement certaines pages ou toutes les pages d'un fichier TEX à 90 , 180 ou 270 angle de rotation en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment faire pivoter les pages de fichiers TEX à l'aide de l'exemple de code C#">}}
