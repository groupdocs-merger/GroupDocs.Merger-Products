...
############################# Head ############################
head_title: "Kierrä EPUB sivua C#:ssa – Kierrä 90, 180, 270 kulmassa"
...
############################# Header ############################
title: "Kierrä EPUB sivua C#"
description: "Kierrä EPUB sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Kierrä EPUB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi kiertää tiettyjä tai kaikkia sivuja EPUB-tiedostossa 90:ssä , 180 tai 270 kiertokulma muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka kiertää EPUB tiedostosivua käyttämällä C# esimerkkikoodia">}}
