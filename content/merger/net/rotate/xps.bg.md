...
############################# Head ############################
head_title: "Завъртане на XPS страници в C# – Завъртане на 90, 180, 270 ъгъл"
...
############################# Header ############################
title: "Завъртете XPS страници в C#"
description: "Завъртете XPS страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Завъртете XPS файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да завъртят някои конкретни или всички страници в XPS файл на 90 , 180 или 270 ъгъл на завъртане чрез изпълнение на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да завъртате XPS файлови страници с помощта на C# примерен код">}}
