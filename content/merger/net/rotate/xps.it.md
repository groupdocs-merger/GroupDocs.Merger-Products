...
############################# Head ############################
head_title: "Ruota XPS pagine in C# – Ruota ad angolo di 90, 180, 270"
...
############################# Header ############################
title: "Ruota XPS pagine in C#"
description: "Ruota XPS pagine con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Ruota XPS pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di ruotare facilmente alcune pagine specifiche o tutte all'interno di un file XPS a 90 , angolo di rotazione 180 o 270 implementando pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come ruotare le pagine dei file XPS utilizzando il codice di esempio C#">}}
