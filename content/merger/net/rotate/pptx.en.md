...
############################# Head ############################
head_title: "Rotate PPTX pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to rotate pages in PPTX documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, images, archives, and more."

############################# Header ############################
title: "Page rotation in PPTX" 
description: "GroupDocs.Merger for .NET enhances .NET applications by adding advanced document processing features. Rotate pages in PPTX files and work with popular business formats effortlessly."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily rotate pages in PPTX documents, adding powerful document management capabilities to .NET applications.
