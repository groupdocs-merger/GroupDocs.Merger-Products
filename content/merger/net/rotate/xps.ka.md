...
############################# Head ############################
head_title: "XPS გვერდის როტაცია C#-ში – 90, 180, 270 კუთხით როტაცია"
...
############################# Header ############################
title: "XPS გვერდის როტაცია C#-ში"
description: "დაატრიალეთ XPS გვერდი .NET კოდის რამდენიმე სტრიქონით."
...
steps:
    enable: true
    title_left: "XPS ფაილის გვერდის როტაცია .NET-ში"
    content_left: |
        [GroupDocs.Merger for .NET](/ka/merger/net/) აადვილებს C# დეველოპერებს 90-ზე როტაციას ზოგიერთი კონკრეტული ან ყველა გვერდის ფაილში XPS , 180 ან 270 ბრუნვის კუთხე რამდენიმე მარტივი ნაბიჯის განხორციელებით.
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ მოვატრიალოთ XPS ფაილის გვერდები C#-ის მაგალითის კოდის გამოყენებით">}}
