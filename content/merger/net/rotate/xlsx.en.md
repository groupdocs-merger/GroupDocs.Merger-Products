...
############################# Head ############################
head_title: "Rotate XLSX pages in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to rotate pages in XLSX documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, images, archives, and more."

############################# Header ############################
title: "Page rotation in XLSX" 
description: "GroupDocs.Merger for .NET enhances .NET applications by adding advanced document processing features. Rotate pages in XLSX files and work with popular business formats effortlessly."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily rotate pages in XLSX documents, adding powerful document management capabilities to .NET applications.
