...
############################# Head ############################
head_title: "Rothlaigh TEX Leathanaigh i C# - Rothlaigh ag 90, 180, 270 Uillinn"
...
############################# Header ############################
title: "Rothlaigh TEX Leathanaigh i C#"
description: "Rothlaigh TEX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Rothlaigh TEX Leathanaigh Chomhad i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# roinnt leathanaigh ar leith nó gach leathanach a rothlú laistigh de chomhad TEX ag 90 , uillinn uainíochta 180 nó 270 trí roinnt céimeanna éasca a chur i bhfeidhm.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid TEX a rothlú ag úsáid cód sampla C#">}}
