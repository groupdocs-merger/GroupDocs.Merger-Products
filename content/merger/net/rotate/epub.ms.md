...
############################# Head ############################
head_title: "Putar EPUB Halaman dalam C# – Putar pada Sudut 90, 180, 270"
head_description: "Putar khusus atau semua halaman dokumen bagi fail EPUB pada sudut putaran 90, 180, 270 menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Putar EPUB Halaman Dalam C#"
description: "Putar EPUB Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Putar EPUB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memutar beberapa halaman tertentu atau semua halaman dalam fail EPUB pada 90 , 180 atau 270 sudut putaran dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memutar EPUB halaman fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Putar EPUB halaman fail menggunakan API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo Langsung - Putar EPUB Halaman Fail Dalam Talian"
    content: |
       Putar EPUB halaman fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/rotate-pages/epub).
