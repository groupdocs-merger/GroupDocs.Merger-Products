...
############################# Head ############################
head_title: "Περιστροφή σελίδων XPS σε C# – Περιστροφή σε γωνία 90, 180, 270"
...
############################# Header ############################
title: "Περιστροφή XPS σελίδων σε C#"
description: "Περιστρέψτε XPS σελίδες με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Περιστροφή XPS σελίδων αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να περιστρέψουν ορισμένες συγκεκριμένες ή όλες τις σελίδες σε ένα αρχείο XPS στα 90 , γωνία περιστροφής 180 ή 270 εφαρμόζοντας μερικά εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Τρόπος περιστροφής σελίδων αρχείου XPS χρησιμοποιώντας παράδειγμα κώδικα C#">}}
