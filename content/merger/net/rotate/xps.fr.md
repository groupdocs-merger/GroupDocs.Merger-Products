...
############################# Head ############################
head_title: "Faire pivoter XPS Pages dans C# - Faire pivoter à 90, 180, 270 Angle"
...
############################# Header ############################
title: "Faire pivoter XPS pages dans C#"
description: "Faites pivoter les pages XPS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Faire pivoter XPS pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de faire pivoter facilement certaines pages ou toutes les pages d'un fichier XPS à 90 , 180 ou 270 angle de rotation en mettant en œuvre quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment faire pivoter les pages de fichiers XPS à l'aide de l'exemple de code C#">}}
