...
############################# Head ############################
head_title: "EPUB पृष्ठों को C# में घुमाएं - 90, 180, 270 कोण पर घुमाएं"
...
############################# Header ############################
title: "EPUB पृष्ठों को C# में घुमाएं"
description: "EPUB पृष्ठों को .NET कोड की कुछ पंक्तियों के साथ घुमाएं।"
...
steps:
    enable: true
    title_left: "EPUB फ़ाइल पृष्ठों को .NET में घुमाएं"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए C# फ़ाइल के भीतर कुछ विशिष्ट या सभी पृष्ठों को 90 पर एक EPUB फ़ाइल में घुमाना आसान बनाता है। कुछ आसान चरणों को लागू करके 180 या 270 रोटेशन कोण।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके EPUB फ़ाइल पृष्ठों को कैसे घुमाएँ">}}
