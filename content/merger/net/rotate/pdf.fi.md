...
############################# Head ############################
head_title: "Kierrä PDF sivua C#:ssa – Kierrä 90, 180, 270 kulmassa"
...
############################# Header ############################
title: "Kierrä PDF sivua C#"
description: "Kierrä PDF sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Kierrä PDF tiedostosivua tuotteessa .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka kiertää PDF tiedostosivua käyttämällä C# esimerkkikoodia">}}
