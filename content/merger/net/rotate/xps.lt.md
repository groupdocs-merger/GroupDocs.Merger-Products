...
############################# Head ############################
head_title: "Pasukti XPS puslapius C# – pasukti 90, 180, 270 kampu"
...
############################# Header ############################
title: "Pasukti XPS puslapius C#"
description: "Pasukite XPS puslapius su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Pasukti XPS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai pasukti kai kuriuos konkrečius arba visus puslapius XPS faile esant 90 , 180 arba 270 sukimosi kampu, atlikdami kelis paprastus veiksmus.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip pasukti XPS failo puslapius naudojant C# pavyzdinį kodą">}}
