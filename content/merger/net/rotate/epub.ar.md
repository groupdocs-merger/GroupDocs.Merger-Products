...
############################# Head ############################
head_title: "تدوير الصفحات EPUB في C# - تدوير بزاوية 90 و 180 و 270"
...
############################# Header ############################
title: "تدوير الصفحات EPUB في C#"
description: "تدوير الصفحات EPUB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تدوير صفحات الملفات EPUB في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تدوير بعض الصفحات المحددة أو جميعها داخل ملف EPUB عند 90 180 أو 270 زاوية دوران من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تدوير صفحات ملف EPUB باستخدام كود مثال C#">}}
