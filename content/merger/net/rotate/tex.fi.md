...
############################# Head ############################
head_title: "Kierrä TEX sivua C#:ssa – Kierrä 90, 180, 270 kulmassa"
...
############################# Header ############################
title: "Kierrä TEX sivua C#"
description: "Kierrä TEX sivua muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Kierrä TEX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi kiertää tiettyjä tai kaikkia sivuja TEX-tiedostossa 90:ssä , 180 tai 270 kiertokulma muutaman helpon vaiheen avulla.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka kiertää TEX tiedostosivua käyttämällä C# esimerkkikoodia">}}
