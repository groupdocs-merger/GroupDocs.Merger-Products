...
############################# Head ############################
head_title: "Obróć PDF Strony w C# – Obróć o 90, 180, 270 Kąt"
...
############################# Header ############################
title: "Obróć PDF strony w C#"
description: "Obracaj strony PDF za pomocą kilku wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Obróć strony plików PDF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# rotację niektórych lub wszystkich stron w pliku PDF o 90 , kąt obrotu 180 lub 270, wykonując kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak obracać strony plików PDF przy użyciu przykładowego kodu C#">}}
