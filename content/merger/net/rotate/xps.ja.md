...
############################# Head ############################
head_title: "C#でXPSページを回転 – 90度、180度、270度の角度で回転"
head_description: "ドキュメント マージ API を使用して、XPS ファイルの特定またはすべてのドキュメント ページを 90、180、270 の回転角度で回転します。"

############################# Header ############################
title: "C# で XPS ページを回転"
description: "数行の .NET コードで XPS ページをローテーションします。"
...
steps:
    enable: true
    title_left: ".NET で XPS ファイル ページを回転"
    content_left: |
        [GroupDocs.Merger for .NET](/ja/merger/net/) により、C# 開発者は XPS ファイル内の一部またはすべてのページを 90 度で簡単に回転できます、180 または 270 の回転角度を、いくつかの簡単な手順を実行することで設定できます。
    ...
    code: |
     ...
     {{< merger/code-merger title="C# サンプル コードを使用して XPS ファイル ページをローテーションする方法">}}
