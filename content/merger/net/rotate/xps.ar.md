...
############################# Head ############################
head_title: "تدوير الصفحات XPS في C# - تدوير بزاوية 90 و 180 و 270"
...
############################# Header ############################
title: "تدوير الصفحات XPS في C#"
description: "تدوير الصفحات XPS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تدوير صفحات الملفات XPS في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تدوير بعض الصفحات المحددة أو جميعها داخل ملف XPS عند 90 180 أو 270 زاوية دوران من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تدوير صفحات ملف XPS باستخدام كود مثال C#">}}
