...
############################# Head ############################
head_title: "Otočiť PDF strán v C# – Otočiť o uhol 90, 180, 270"
...
############################# Header ############################
title: "Otočiť PDF strán v C#"
description: "Otočte PDF stránky pomocou niekoľkých riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Otočte PDF strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# otáčať niektoré konkrétne alebo všetky stránky v súbore PDF o 90° , 180 alebo 270 uhol otáčania vykonaním niekoľkých jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako otočiť PDF strán súboru pomocou C# vzorového kódu">}}
