...
############################# Head ############################
head_title: "Rotiți paginile XPS în C# – Rotiți la un unghi de 90, 180, 270"
...
############################# Header ############################
title: "Rotiți XPS pagini în C#"
description: "Rotiți XPS Pagini cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Rotiți XPS pagini de fișiere în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# să rotească anumite pagini sau toate paginile dintr-un fișier XPS la 90 , 180 sau 270 unghi de rotație prin implementarea câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să rotiți pagini de fișiere XPS folosind codul exemplu C#">}}
