...
############################# Head ############################
head_title: "Xoay TEX Trang trong C# - Xoay ở các góc 90, 180, 270"
...
############################# Header ############################
title: "Xoay TEX Trang trong C#"
description: "Xoay các trang TEX với một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Xoay TEX Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng xoay một số trang cụ thể hoặc tất cả các trang trong tệp TEX ở 90 , Góc quay 180 hoặc 270 bằng cách thực hiện một vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách xoay các trang tệp TEX bằng mã mẫu C#">}}
