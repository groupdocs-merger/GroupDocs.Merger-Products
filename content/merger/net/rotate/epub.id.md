...
############################# Header ############################
title: "Putar EPUB Halaman Di C#"
description: "Putar halaman EPUB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Putar EPUB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk merotasi beberapa halaman tertentu atau semua halaman dalam file EPUB pada 90 , 180 atau 270 sudut rotasi dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memutar halaman file EPUB menggunakan kode contoh C#">}}
