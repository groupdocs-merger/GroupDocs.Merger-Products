...
############################# Head ############################
head_title: "Bizivire EPUB Rûpelên di C# de - Bi 90, 180, 270 Goşeyê Bizivire"
...
############################# Header ############################
title: "Rûpelên EPUB Di C# de bizivirin"
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê EPUB bizivirîne"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku hin rûpelan an hemî rûpelan di nav pelek EPUB de di 90 de bizivirînin. , 180 an 270 goşeya zivirandinê bi pêkanîna çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa bi karanîna koda nimûneya C# rûpelên pelê EPUB dizivire">}}
