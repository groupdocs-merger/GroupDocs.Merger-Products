...
############################# Head ############################
head_title: "Պտտեցնել TEX էջերը C#-ում – Պտտել 90, 180, 270 անկյան տակ"
...
############################# Header ############################
title: "Պտտեցնել TEX էջ C#-ում"
description: "Պտտեցնել TEX էջերը .NET կոդով մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Պտտեցնել TEX ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար պտտել որոշ կոնկրետ կամ բոլոր էջերը TEX ֆայլում 90-ով: , 180 կամ 270 ռոտացիայի անկյուն՝ կատարելով մի քանի հեշտ քայլեր։
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես պտտել TEX ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}
