...
############################# Head ############################
head_title: "Draai XPS Pagina's in C# - Draai in een hoek van 90, 180, 270"
...
############################# Header ############################
title: "Draai XPS pagina's in C#"
description: "Roteer XPS pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Draai XPS Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om bepaalde of alle pagina's binnen een XPS bestand op 90 te roteren , 180 of 270 draaihoek door een paar eenvoudige stappen te implementeren.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XPS bestandspagina's te roteren met behulp van C# voorbeeldcode">}}
