...
############################# Head ############################
head_title: "Snúa PDF síðum í C# – Snúa í 90, 180, 270 horn"
...
############################# Header ############################
title: "Snúa PDF síðum í C#"
description: "Snúðu PDF síðum með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Snúa PDF skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að snúa einhverjum ákveðnum eða öllum síðum innan PDF skráar í 90 , 180 eða 270 snúningshorn með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að snúa PDF skráarsíðum með því að nota C# dæmikóða">}}
