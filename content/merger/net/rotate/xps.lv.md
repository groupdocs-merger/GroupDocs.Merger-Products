...
############################# Head ############################
head_title: "Pagriezt XPS lapas C# — pagriezt 90, 180, 270 leņķī"
...
############################# Header ############################
title: "Pagriezt XPS lapas programmā C#"
description: "Pagrieziet XPS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Pagriezt XPS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli pagriezt dažas konkrētas vai visas lapas XPS failā ar 90 , 180 vai 270 griešanās leņķis, veicot dažas vienkāršas darbības.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā pagriezt XPS faila lapas, izmantojot C# piemēra kodu">}}
