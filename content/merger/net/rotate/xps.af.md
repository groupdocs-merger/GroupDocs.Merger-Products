...
############################# Head ############################
head_title: "Draai XPS bladsye in C# – Draai teen 90, 180, 270 hoek"
...
############################# Header ############################
title: "Draai XPS bladsye in C#"
description: "Draai XPS Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Draai XPS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om sekere spesifieke of alle bladsye binne 'n XPS-lêer teen 90 te draai , 180 of 270 rotasiehoek deur 'n paar maklike stappe te implementeer.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XPS lêerbladsye te draai deur C# voorbeeldkode te gebruik">}}
