...
############################# Header ############################
title: "Putar XPS Halaman Dalam C#"
description: "Putar XPS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Putar XPS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# memutar beberapa halaman tertentu atau semua halaman dalam fail XPS pada 90 , 180 atau 270 sudut putaran dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara memutar XPS halaman fail menggunakan kod contoh C#.">}}
