...
############################# Head ############################
head_title: "Girar TEX Páginas em C# – Girar em 90, 180, 270 Ângulo"
...
############################# Header ############################
title: "Girar TEX Páginas em C#"
description: "Gire TEX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Girar TEX Páginas de Arquivo em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do C# girar algumas páginas específicas ou todas em um arquivo TEX em 90 , 180 ou 270 ângulo de rotação implementando algumas etapas fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como girar as páginas do arquivo TEX usando o código de exemplo C#">}}
