...
############################# Head ############################
head_title: "Обертати PDF сторінки в C# – повертати на 90, 180, 270 кут"
...
############################# Header ############################
title: "Обертати PDF сторінки на C#"
description: "Поверніть PDF сторінки з кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Обертати PDF сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко обертати окремі або всі сторінки у файлі PDF на 90 , кут повороту 180 або 270, виконавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як обертати сторінки файлу PDF за допомогою прикладу коду C#">}}
