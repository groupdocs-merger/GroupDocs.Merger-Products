...
############################# Head ############################
head_title: "Mesclar VTX Arquivos em C# | VTX Fusão"
head_description: "Mescle vários arquivos VTX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "VTX Fusão em C#"
description: "Mescle VTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos VTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos VTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos VTX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar VTX arquivos usando a API GroupDocs.Merger
