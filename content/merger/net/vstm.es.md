...
############################# Head ############################
head_title: "Combinar VSTM archivos en C# | VSTM Fusión"
head_description: "Combine varios archivos VSTM en un solo archivo usando la API de fusión de documentos C# .NET. Combine páginas específicas o rangos de páginas de varios documentos en un solo documento."

############################# Header ############################
title: "VSTM Fusión en C#"
description: "Combine VSTM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Cómo fusionar varios archivos VSTM"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de .NET fusionar dos o más archivos VSTM dentro de sus aplicaciones mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo fusionar archivos VSTM usando el código de ejemplo C#">}}

        ```csharp    
        // Combinar VSTM archivos usando GroupDocs.Merger API
