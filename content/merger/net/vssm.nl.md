...
############################# Head ############################
head_title: "Voeg VSSM bestanden samen in C# | VSSM Fusie"
head_description: "Voeg meerdere VSSM bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "VSSM Fusie in C#"
description: "Voeg VSSM samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere VSSM bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSSM-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg VSSM bestanden samen met de GroupDocs.Merger API
