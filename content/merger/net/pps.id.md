...
############################# Head ############################
head_title: "Gabungkan PPS File di C# | PPS Penggabungan"
head_description: "Gabungkan beberapa file PPS menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "PPS Penggabungan Dalam C#"
description: "Gabungkan PPS dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu PPS file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
