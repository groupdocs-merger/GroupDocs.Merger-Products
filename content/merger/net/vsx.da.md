...
############################# Head ############################
head_title: "Flet VSX filer i C# | VSX Fusion"
head_description: "Flet flere VSX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VSX fusion i C#"
description: "Flet VSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VSX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VSX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VSX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx).
