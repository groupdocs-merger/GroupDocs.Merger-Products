...
############################# Head ############################
head_title: "Mesclar TEX Arquivos em C# | TEX Fusão"
head_description: "Mescle vários arquivos TEX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "TEX Fusão em C#"
description: "Mescle TEX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos TEX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos TEX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos TEX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar TEX arquivos usando a API GroupDocs.Merger
