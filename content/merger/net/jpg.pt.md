...
############################# Head ############################
head_title: "Mesclar JPG Arquivos em C# | JPG Fusão"
head_description: "Mescle vários arquivos JPG em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "JPG Fusão em C#"
description: "Mescle JPG com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos JPG"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos JPG em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos JPG usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar JPG arquivos usando a API GroupDocs.Merger
