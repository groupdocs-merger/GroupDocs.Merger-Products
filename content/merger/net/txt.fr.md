...
############################# Head ############################
head_title: "Fusionner des fichiers TXT via .NET"
head_description: "Intégrez la fusion de documents TXT dans vos projets .NET avec GroupDocs.Merger for .NET."

############################# Header ############################
title: "Fusionner des fichiers TXT" 
description: "Utilisez GroupDocs.Merger for .NET pour créer des applications .NET puissantes qui fusionnent et gèrent les documents TXT de manière fluide."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilite la fusion de documents TXT. Ajoutez une fonctionnalité de fusion à vos applications .NET et combinez plusieurs fichiers sans effort.
      
      1. Définir le chemin du premier fichier TXT.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Initialiser Merger avec le document source TXT
