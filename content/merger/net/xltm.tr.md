...
############################# Head ############################
head_title: "XLTM Dosyalarını C# İçinde Birleştir | XLTM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLTM dosyalarını birleştirin
