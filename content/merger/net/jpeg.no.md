...
############################# Head ############################
head_title: "Slå sammen JPEG-filer i C# | JPEG Fusjon"
...
############################# Header ############################
title: "JPEG sammenslåing i C#"
description: "Slå sammen JPEG med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere JPEG-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen JPEG filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen JPEG filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én JPEG-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
