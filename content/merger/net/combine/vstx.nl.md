...
############################# Head ############################
head_title: "Combineer VSTX Bestanden in C# | VSTX Fusie"
head_description: "Combineer meerdere VSTX bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer VSTX bestanden in C#"
description: "Combineer VSTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere VSTX bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSTX-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSTX bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer VSTX bestanden met behulp van GroupDocs.Merger API
