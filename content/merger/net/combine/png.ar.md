...
############################# Head ############################
head_title: "اجمع ملفات PNG في C# | PNG الاندماج"
head_description: "ادمج عدة ملفات PNG في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات PNG في C#"
description: "ادمج PNG مع بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات PNG"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من PNG داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات PNG باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات PNG باستخدام GroupDocs.Merger API
