...
############################# Head ############################
head_title: "Gabungkan file HTML di .NET"
head_description: "Integrasikan GroupDocs.Merger for .NET ke dalam proyek .NET Anda untuk menggabungkan file HTML."

############################# Header ############################
title: "Gabungkan file HTML" 
description: "Gunakan GroupDocs.Merger for .NET untuk membangun aplikasi .NET yang secara efisien menggabungkan dokumen HTML."
...
steps:
    enable: true
    title: "Langkah-langkah untuk menggabungkan file HTML"
    content: |
      [GroupDocs.Merger](/merger/net/) memungkinkan Anda untuk menggabungkan file HTML tanpa kesulitan. Integrasikan fitur ini ke dalam aplikasi .NET Anda untuk menangani beberapa dokumen sebagai satu file.
      
      1. Tetapkan jalur ke file HTML pertama.
      2. Pilih file kedua.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Buat instance Merger dengan dokumen HTML input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman terpilih dari file dengan format yang berbeda"
      content: |
        Contoh ini menjelaskan cara menggabungkan file HTML sambil menggabungkan halaman terpilih dari format lain.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
