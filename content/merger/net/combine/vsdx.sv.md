...
############################# Head ############################
head_title: "Kombinera VSDX-filer i C# | VSDX Sammanslagning"
head_description: "Kombinera flera VSDX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera VSDX filer i C#"
description: "Kombinera VSDX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera VSDX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera VSDX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSDX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera VSDX filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet VSDX
...
demos:
    ...
    content: |
       Kombinera mer än en VSDX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
