...
############################# Head ############################
head_title: "Combineer PDF Bestanden in C# | PDF Fusie"
head_description: "Combineer meerdere PDF bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer PDF bestanden in C#"
description: "Combineer PDF met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PDF bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PDF-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PDF bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer PDF bestanden met behulp van GroupDocs.Merger API
