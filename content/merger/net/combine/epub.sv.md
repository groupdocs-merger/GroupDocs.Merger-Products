...
############################# Head ############################
head_title: "Kombinera EPUB-filer i C# | EPUB Sammanslagning"
head_description: "Kombinera flera EPUB-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera EPUB filer i C#"
description: "Kombinera EPUB med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera EPUB-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera EPUB-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar EPUB-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera EPUB filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en EPUB-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
