...
############################# Head ############################
head_title: "Kombineerige TSV failid C# | TSV Ühinemine"
head_description: "Kombineerige mitu TSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri TSV faili C#"
description: "Kombineerige TSV mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut TSV faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat TSV faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida TSV faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige TSV faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga TSV
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks TSV faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
