...
############################# Header ############################
title: "Yhdistä MHT tiedostoa C#"
description: "Yhdistä MHT muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia MHT-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
