...
############################# Head ############################
head_title: "Kombineerige CSV failid C# | CSV Ühinemine"
head_description: "Kombineerige mitu CSV faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri CSV faili C#"
description: "Kombineerige CSV mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut CSV faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat CSV faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida CSV faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige CSV faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga CSV
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks CSV faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
