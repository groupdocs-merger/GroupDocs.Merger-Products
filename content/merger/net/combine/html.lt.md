...
############################# Head ############################
head_title: "Sujungti HTML failus C# | HTML Susijungimas"
head_description: "Sujunkite kelis HTML failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti HTML failus C#"
description: "Sujunkite HTML su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis HTML failus"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną HTML failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
