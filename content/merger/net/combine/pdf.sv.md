...
############################# Head ############################
head_title: "Kombinera PDF-filer i C# | PDF Sammanslagning"
head_description: "Kombinera flera PDF-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera PDF filer i C#"
description: "Kombinera PDF med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera PDF-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera PDF-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PDF-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera PDF filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en PDF-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
