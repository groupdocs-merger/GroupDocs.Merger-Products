...
############################# Head ############################
head_title: "Mesclar arquivos IMAGE em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para mesclar arquivos IMAGE."

############################# Header ############################
title: "Mesclar arquivos IMAGE" 
description: "Use GroupDocs.Merger for .NET para construir aplicações .NET que mesclam documentos IMAGE de forma eficiente."
...
steps:
    enable: true
    title: "Etapas para mesclar arquivos IMAGE"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você mescle arquivos IMAGE de forma eficaz. Integre essa funcionalidade em suas aplicações .NET para lidar com vários documentos como um único arquivo.
      
      1. Defina o caminho para o primeiro arquivo IMAGE.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância do Merger com o documento IMAGE de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como mesclar arquivos IMAGE incorporando páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
