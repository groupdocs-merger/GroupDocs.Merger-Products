...
############################# Head ############################
head_title: "DOT Dosyalarını C# İçinde Birleştirin | DOT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "DOT Dosyalarını C# İçinde Birleştirin"
description: "DOT kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok DOT Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak DOT dosyalarını birleştirin
