...
############################# Header ############################
title: "Yhdistä JPEG tiedostoa C#"
description: "Yhdistä JPEG muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia JPEG-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
