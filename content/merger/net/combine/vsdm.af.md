...
############################# Head ############################
head_title: "Kombineer VSDM lêers in C# | VSDM samesmelting"
head_description: "Kombineer veelvuldige VSDM lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer VSDM lêers in C#"
description: "Kombineer VSDM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige VSDM-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer VSDM-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer VSDM lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer VSDM dokument
...
demos:
    ...
    content: |
       Kombineer meer as een VSDM lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
