...
############################# Head ############################
head_title: "Sujungti ODS failus C# | ODS Susijungimas"
head_description: "Sujunkite kelis ODS failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti ODS failus C#"
description: "Sujunkite ODS su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis ODS failus"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną ODS failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
