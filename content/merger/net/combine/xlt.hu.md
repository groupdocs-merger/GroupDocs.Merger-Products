...
############################# Head ############################
head_title: "Kombinálja az XLT fájlokat a C# |-ben XLT Egyesülés"
head_description: "Kombináljon több XLT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XLT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XLT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több XLT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
