...
############################# Head ############################
head_title: "Comhcheangail XLSM Comhaid i C# | XLSM Cumasc"
head_description: "Comhcheangail comhaid XLSM iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail XLSM Comhaid i C#"
description: "Comhcheangail XLSM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad XLSM a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid XLSM a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLSM comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail XLSM comhad le GroupDocs.Merger API
