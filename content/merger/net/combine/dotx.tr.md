...
############################# Head ############################
head_title: "DOTX Dosyalarını C# İçinde Birleştirin | DOTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "DOTX Dosyalarını C# İçinde Birleştirin"
description: "DOTX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok DOTX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak DOTX dosyalarını birleştirin
