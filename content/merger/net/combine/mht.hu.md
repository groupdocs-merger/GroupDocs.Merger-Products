...
############################# Head ############################
head_title: "Kombinálja az MHT fájlokat a C# |-ben MHT Egyesülés"
head_description: "Kombináljon több MHT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "MHT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) MHT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több MHT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk MHT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon MHT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több MHT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
