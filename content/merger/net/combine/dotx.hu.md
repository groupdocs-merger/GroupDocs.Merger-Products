...
############################# Head ############################
head_title: "Kombinálja az DOTX fájlokat a C# |-ben DOTX Egyesülés"
head_description: "Kombináljon több DOTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOTX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) DOTX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOTX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk DOTX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon DOTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több DOTX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
