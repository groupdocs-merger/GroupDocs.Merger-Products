...
############################# Head ############################
head_title: "Kombinálja az BMP fájlokat a C# |-ben BMP Egyesülés"
head_description: "Kombináljon több BMP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "BMP fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) BMP elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több BMP fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk BMP fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon BMP fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több BMP fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
