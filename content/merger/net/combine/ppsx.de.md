...
############################# Head ############################
head_title: "Kombinieren Sie PPSX-Dateien in C# | PPSX Fusion"
head_description: "Kombinieren Sie mehrere PPSX-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie PPSX-Dateien in C#"
description: "Kombinieren Sie PPSX mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere PPSX-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr PPSX-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie PPSX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie PPSX-Dateien mit der GroupDocs.Merger-API
...
demos:
    ...
    content: |
       Kombinieren Sie jetzt mehr als eine PPSX-Datei, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) besuchen.
