...
############################# Head ############################
head_title: "Kombineerige PPSX failid C# | PPSX Ühinemine"
head_description: "Kombineerige mitu PPSX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri PPSX faili C#"
description: "Kombineerige PPSX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut PPSX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat PPSX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPSX faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige PPSX faili GroupDocs.Merger API abil
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks PPSX faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
