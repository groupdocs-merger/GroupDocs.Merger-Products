...
############################# Head ############################
head_title: "Объединение файлов JPG в .NET"
head_description: "Интегрируйте GroupDocs.Merger for .NET в ваши проекты .NET, чтобы объединять файлы JPG."

############################# Header ############################
title: "Объединение файлов JPG" 
description: "Используйте GroupDocs.Merger for .NET для создания приложений .NET, которые эффективно объединяют документы JPG."
...
steps:
    enable: true
    title: "Шаги для объединения файлов JPG"
    content: |
      [GroupDocs.Merger](/merger/net/) позволяет вам легко объединять файлы JPG. Интегрируйте эту функцию в ваши приложения .NET, чтобы обрабатывать несколько документов как единый файл.
      
      1. Установите путь к первому файлу JPG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Создайте экземпляр Merger с входным документом JPG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение выбранных страниц из файлов разных форматов"
      content: |
        Этот пример иллюстрирует, как объединить файлы JPG, включив выбранные страницы из других форматов.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
