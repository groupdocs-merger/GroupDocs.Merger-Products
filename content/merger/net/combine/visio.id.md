...
############################# Head ############################
head_title: "Gabungkan file VISIO di .NET"
head_description: "Integrasikan GroupDocs.Merger for .NET ke dalam proyek .NET Anda untuk menggabungkan file VISIO."

############################# Header ############################
title: "Gabungkan file VISIO" 
description: "Gunakan GroupDocs.Merger for .NET untuk membangun aplikasi .NET yang secara efisien menggabungkan dokumen VISIO."
...
steps:
    enable: true
    title: "Langkah-langkah untuk menggabungkan file VISIO"
    content: |
      [GroupDocs.Merger](/merger/net/) memungkinkan Anda untuk menggabungkan file VISIO tanpa kesulitan. Integrasikan fitur ini ke dalam aplikasi .NET Anda untuk menangani beberapa dokumen sebagai satu file.
      
      1. Tetapkan jalur ke file VISIO pertama.
      2. Pilih file kedua.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Buat instance Merger dengan dokumen VISIO input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman terpilih dari file dengan format yang berbeda"
      content: |
        Contoh ini menjelaskan cara menggabungkan file VISIO sambil menggabungkan halaman terpilih dari format lain.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
