...
############################# Head ############################
head_title: "Mesclar arquivos CSV em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para mesclar arquivos CSV."

############################# Header ############################
title: "Mesclar arquivos CSV" 
description: "Use GroupDocs.Merger for .NET para construir aplicações .NET que mesclam documentos CSV de forma eficiente."
...
steps:
    enable: true
    title: "Etapas para mesclar arquivos CSV"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você mescle arquivos CSV de forma eficaz. Integre essa funcionalidade em suas aplicações .NET para lidar com vários documentos como um único arquivo.
      
      1. Defina o caminho para o primeiro arquivo CSV.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância do Merger com o documento CSV de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como mesclar arquivos CSV incorporando páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
