...
head_description: "Kombinieren Sie mehrere IMAGE-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie IMAGE-Dateien in C#"
description: "Kombinieren Sie IMAGE mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere IMAGE-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr IMAGE-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie IMAGE-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie IMAGE-Dateien mit der GroupDocs.Merger-API
