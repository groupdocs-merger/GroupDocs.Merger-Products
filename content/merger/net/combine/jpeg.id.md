...
############################# Head ############################
head_title: "Gabungkan JPEG File di C# | JPEG Penggabungan"
head_description: "Gabungkan beberapa file JPEG menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan JPEG File Di C#"
description: "Gabungkan JPEG dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File JPEG"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file JPEG dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPEG menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file JPEG menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan JPEG
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu JPEG file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
