...
############################# Head ############################
head_title: "Kombinálja az PNG fájlokat a C# |-ben PNG Egyesülés"
head_description: "Kombináljon több PNG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PNG fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PNG elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PNG fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PNG fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PNG fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több PNG fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
