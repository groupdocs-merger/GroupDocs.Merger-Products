...
############################# Head ############################
head_title: "VSSM файлдарды C# ішінде біріктіру | VSSM Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше VSSM файлдарды бір файлға біріктіріңіз. Әртүрлі құжаттардан бір құжатқа дейін арнайы беттерді немесе бет ауқымдарын біріктіріңіз."

############################# Header ############################
title: "VSSM файлды C# ішінде біріктіру"
description: "VSSM .NET кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Бірнеше VSSM файлдарды біріктіру жолы"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп VSSM файлдарды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM файлдарды C# мысал кодын пайдаланып біріктіру жолы">}}

        ```csharp    
        // GroupDocs.Merger API арқылы VSSM файлдарды біріктіріңіз
