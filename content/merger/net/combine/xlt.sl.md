...
############################# Head ############################
head_title: "Združi XLT datoteke v C# | XLT Združitev"
head_description: "Združite več datotek XLT v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi XLT datotek v C#"
description: "Kombinirajte XLT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek XLT"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek XLT znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLT s primerom kode C#">}}

        ```csharp    
        // Združite datoteke XLT z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom XLT
...
demos:
    ...
    content: |
       Takoj združite več kot eno XLT datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
