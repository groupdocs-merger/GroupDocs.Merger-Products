...
############################# Head ############################
head_title: "Kombineerige DOCX failid C# | DOCX Ühinemine"
head_description: "Kombineerige mitu DOCX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri DOCX faili C#"
description: "Kombineerige DOCX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut DOCX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat DOCX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida DOCX faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige DOCX faili GroupDocs.Merger API abil
