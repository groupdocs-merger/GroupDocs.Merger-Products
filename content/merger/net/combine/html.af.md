...
############################# Head ############################
head_title: "Kombineer HTML lêers in C# | HTML samesmelting"
head_description: "Kombineer veelvuldige HTML lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer HTML lêers in C#"
description: "Kombineer HTML met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige HTML-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer HTML-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om HTML lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer HTML lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Kombineer meer as een HTML lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
