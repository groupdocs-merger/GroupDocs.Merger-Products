...
############################# Head ############################
head_title: "Kombinirajte DOCX datoteke u C# | DOCX Spajanje"
head_description: "Kombinirajte više DOCX datoteka u jednu datoteku koristeći C# .NET API za spajanje dokumenata. Kombinirajte određene stranice ili nizove stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "Kombinirajte DOCX datoteka u C#"
description: "Kombinirajte DOCX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Kako kombinirati više DOCX datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava kombiniranje dvije ili više DOCX datoteka unutar svojih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako kombinirati DOCX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Kombinirajte DOCX datoteke koristeći GroupDocs.Merger API
