...
############################# Head ############################
head_title: "Kombineer CSV lêers in C# | CSV samesmelting"
head_description: "Kombineer veelvuldige CSV lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer CSV lêers in C#"
description: "Kombineer CSV met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige CSV-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer CSV-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om CSV lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer CSV lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer CSV dokument
...
demos:
    ...
    content: |
       Kombineer meer as een CSV lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
