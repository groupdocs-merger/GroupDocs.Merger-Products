...
############################# Head ############################
head_title: "Kombinálja az TXT fájlokat a C# |-ben TXT Egyesülés"
head_description: "Kombináljon több TXT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "TXT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) TXT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több TXT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk TXT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon TXT fájlt a GroupDocs.Merger API segítségével
