...
############################# Head ############################
head_title: "Kombinera TEX-filer i C# | TEX Sammanslagning"
head_description: "Kombinera flera TEX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera TEX filer i C#"
description: "Kombinera TEX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera TEX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera TEX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar TEX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera TEX filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en TEX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
