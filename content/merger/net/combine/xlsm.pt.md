...
############################# Head ############################
head_title: "Combine XLSM Arquivos em C# | XLSM Fusão"
head_description: "Combine vários arquivos XLSM em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine XLSM Arquivos em C#"
description: "Combine XLSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos XLSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos XLSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos XLSM usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos XLSM usando a API GroupDocs.Merger
