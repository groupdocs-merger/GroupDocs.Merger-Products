...
############################# Head ############################
head_title: ".NET에서 CSV 파일 병합"
head_description: ".NET 프로젝트에 GroupDocs.Merger for .NET을 통합하여 CSV 파일을 병합하십시오."

############################# Header ############################
title: "CSV 파일 병합" 
description: "GroupDocs.Merger for .NET을 사용하여 .NET 애플리케이션을 구축하고 CSV 문서를 효율적으로 병합하십시오."
...
steps:
    ...
    title: "CSV 파일 병합 단계"
    content: |
      [GroupDocs.Merger](/merger/net/)을 사용하면 CSV 파일을 간편하게 병합할 수 있습니다. 이 기능을 .NET 애플리케이션에 통합하여 여러 문서를 하나의 파일로 처리하십시오.
      
      1. 첫 번째 CSV 파일의 경로를 설정합니다.
      2. 두 번째 파일을 선택합니다.
      3. 선택적 설정을 구성합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "다양한 형식의 파일에서 선택한 페이지 병합"
      content: |
        이 예제는 다른 형식에서 선택한 페이지를 포함하여 CSV 파일을 병합하는 방법을 설명합니다.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
