...
############################# Head ############################
head_title: "Kombineerige OTT failid C# | OTT Ühinemine"
head_description: "Kombineerige mitu OTT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri OTT faili C#"
description: "Kombineerige OTT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut OTT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat OTT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida OTT faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige OTT faili GroupDocs.Merger API abil
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks OTT faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
