...
############################# Head ############################
head_title: "VSTX Dosyalarını C# İçinde Birleştirin | VSTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSTX Dosyalarını C# İçinde Birleştirin"
description: "VSTX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSTX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSTX dosyalarını birleştirin
