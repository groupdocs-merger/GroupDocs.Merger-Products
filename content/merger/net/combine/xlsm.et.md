...
############################# Head ############################
head_title: "Kombineerige XLSM failid C# | XLSM Ühinemine"
head_description: "Kombineerige mitu XLSM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri XLSM faili C#"
description: "Kombineerige XLSM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut XLSM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat XLSM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLSM faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige XLSM faili GroupDocs.Merger API abil
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks XLSM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
