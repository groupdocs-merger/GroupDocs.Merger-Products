...
############################# Head ############################
head_title: "Combine XLTX Arquivos em C# | XLTX Fusão"
head_description: "Combine vários arquivos XLTX em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine XLTX Arquivos em C#"
description: "Combine XLTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos XLTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos XLTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos XLTX usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos XLTX usando a API GroupDocs.Merger
