...
############################# Head ############################
head_title: "Sameina DOTX skrár í C# | DOTX Samruni"
head_description: "Sameina margar DOTX skrár í eina skrá með því að nota C# .NET skjalasamruna API. Sameina tilteknar síður eða blaðsíðubil frá ýmsum skjölum í eitt skjal."

############################# Header ############################
title: "Sameina DOTX skrár í C#"
description: "Sameina DOTX með nokkrum línum af .NET kóða."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/is/merger/net/) býður upp á þægilega lausn til að sameina margar PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, myndir og mörg önnur skjöl í einni skrá innan .NET forrita. GroupDocs.Merger mun spara þér mikla fyrirhöfn, þar sem þú hefur leyfi til að sameina DOTX skjöl - það er engin þörf á að setja upp hugbúnað frá þriðja aðila, skjáborðsforrit eða viðbætur. Nú er óþarfi að eyða tíma þínum og sameina skrár handvirkt! Hlutverk GroupDocs er að veita bestu gæði og einfalda verkflæði skjalavinnslu.
...
steps:
    enable: true
    title_left: "Hvernig á að sameina margar DOTX skrár"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að sameina DOTX skrár með því að nota C# dæmi kóða">}}

        ```csharp    
        // Sameina DOTX skrár með því að nota GroupDocs.Merger API
...
demos:
    ...
    content: |
       Sameina fleiri en eina DOTX skrá núna með því að fara á [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) vefsíðu.
