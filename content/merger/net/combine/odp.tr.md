...
############################# Head ############################
head_title: "ODP Dosyalarını C# İçinde Birleştirin | ODP Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla ODP dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "ODP Dosyalarını C# İçinde Birleştirin"
description: "ODP kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok ODP Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak ODP dosyalarını birleştirin
