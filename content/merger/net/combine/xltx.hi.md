...
############################# Head ############################
head_title: "XLTX फाइलों को C# में मिलाएं | XLTX विलय"
head_description: "C# .NET दस्तावेज़ विलय API का उपयोग करके एकाधिक XLTX फ़ाइलों को एक फ़ाइल में संयोजित करें। विशिष्ट पृष्ठों या पृष्ठ श्रेणियों को विभिन्न दस्तावेज़ों से एक दस्तावेज़ में संयोजित करें।"

############################# Header ############################
title: "XLTX फाइलों को C# में मिलाएं"
description: "XLTX को .NET कोड की कुछ पंक्तियों के साथ मिलाएं।"
...
steps:
    enable: true
    title_left: "एकाधिक XLTX फ़ाइलें कैसे संयोजित करें"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए .NET डेवलपर्स के लिए दो या दो से अधिक XLTX फाइलों को अपने एप्लिकेशन के भीतर संयोजित करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके XLTX फ़ाइलों को कैसे संयोजित करें">}}

        ```csharp    
        // GroupDocs.Merger API का उपयोग करके XLTX फ़ाइलें संयोजित करें
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) वेबसाइट पर जाकर अभी एक से अधिक XLTX फ़ाइलें संयोजित करें।
