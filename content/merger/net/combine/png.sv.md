...
############################# Head ############################
head_title: "Kombinera PNG-filer i C# | PNG Sammanslagning"
head_description: "Kombinera flera PNG-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera PNG filer i C#"
description: "Kombinera PNG med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera PNG-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera PNG-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PNG-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera PNG filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet PNG
...
demos:
    ...
    content: |
       Kombinera mer än en PNG-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
