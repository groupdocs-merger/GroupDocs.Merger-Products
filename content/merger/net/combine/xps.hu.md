...
############################# Head ############################
head_title: "Kombinálja az XPS fájlokat a C# |-ben XPS Egyesülés"
head_description: "Kombináljon több XPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XPS fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XPS elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XPS fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XPS fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XPS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több XPS fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
