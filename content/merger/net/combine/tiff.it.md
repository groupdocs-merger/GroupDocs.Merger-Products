...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono efficientemente documenti TIFF."
...
steps:
    enable: true
    title: "Passi per unire file TIFF"
    content: |
