...
############################# Head ############################
head_title: "Kombineerige MHTML failid C# | MHTML Ühinemine"
head_description: "Kombineerige mitu MHTML faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri MHTML faili C#"
description: "Kombineerige MHTML mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut MHTML faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat MHTML faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida MHTML faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige MHTML faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga MHTML
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks MHTML faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
