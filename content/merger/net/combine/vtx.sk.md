...
############################# Head ############################
head_title: "Skombinujte VTX súbory v C# | VTX Zlúčenie"
head_description: "Skombinujte viacero súborov VTX do jedného súboru pomocou rozhrania API na zlučovanie dokumentov C# .NET. Skombinujte konkrétne strany alebo rozsahy strán z rôznych dokumentov do jedného dokumentu."

############################# Header ############################
title: "Skombinujte VTX súbory v C#"
description: "Skombinujte VTX s niekoľkými riadkami kódu .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) poskytuje pohodlné riešenie na kombináciu viacerých súborov PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, obrázkov a mnoho ďalších dokumentov do jedného súboru v aplikáciách .NET. GroupDocs.Merger vám ušetrí veľa námahy, pretože máte povolené kombinovať VTX dokumenty – nie je potrebné inštalovať žiadny softvér tretích strán, desktopové aplikácie alebo pluginy. Teraz je zbytočné strácať čas a kombinovať súbory ručne! Poslaním GroupDocs je poskytovať najlepšiu kvalitu a zjednodušiť pracovné postupy spracovania dokumentov.
...
steps:
    enable: true
    title_left: "Ako skombinovať viacero súborov VTX"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom .NET kombinovať dva alebo viac súborov VTX v rámci ich aplikácií implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako skombinovať súbory VTX pomocou vzorového kódu C#">}}

        ```csharp    
        // Skombinujte VTX súbory pomocou GroupDocs.Merger API
