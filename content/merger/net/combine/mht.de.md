...
############################# Head ############################
head_title: "Kombinieren Sie MHT-Dateien in C# | MHT Fusion"
head_description: "Kombinieren Sie mehrere MHT-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie MHT-Dateien in C#"
description: "Kombinieren Sie MHT mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere MHT-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr MHT-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie MHT-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie MHT-Dateien mit der GroupDocs.Merger-API
