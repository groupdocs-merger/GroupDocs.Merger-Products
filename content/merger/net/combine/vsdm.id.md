...
############################# Head ############################
head_title: "Gabungkan VSDM File di C# | VSDM Penggabungan"
head_description: "Gabungkan beberapa file VSDM menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan VSDM File Di C#"
description: "Gabungkan VSDM dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File VSDM"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VSDM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSDM menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file VSDM menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan VSDM
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSDM file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
