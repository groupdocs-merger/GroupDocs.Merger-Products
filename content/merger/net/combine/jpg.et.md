...
############################# Head ############################
head_title: "Kombineerige JPG failid C# | JPG Ühinemine"
head_description: "Kombineerige mitu JPG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri JPG faili C#"
description: "Kombineerige JPG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut JPG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat JPG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida JPG faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige JPG faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga JPG
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks JPG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
