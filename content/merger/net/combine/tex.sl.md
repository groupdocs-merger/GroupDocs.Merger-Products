...
############################# Head ############################
head_title: "Združi TEX datoteke v C# | TEX Združitev"
head_description: "Združite več datotek TEX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi TEX datotek v C#"
description: "Kombinirajte TEX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek TEX"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek TEX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke TEX s primerom kode C#">}}

        ```csharp    
        // Združite datoteke TEX z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom TEX
...
demos:
    ...
    content: |
       Takoj združite več kot eno TEX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
