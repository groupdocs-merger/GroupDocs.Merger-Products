...
############################# Header ############################
title: "Yhdistä ODT tiedostoa C#"
description: "Yhdistä ODT muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia ODT-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi ODT tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
