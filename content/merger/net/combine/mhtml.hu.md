...
############################# Head ############################
head_title: "Kombinálja az MHTML fájlokat a C# |-ben MHTML Egyesülés"
head_description: "Kombináljon több MHTML fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "MHTML fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) MHTML elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több MHTML fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk MHTML fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon MHTML fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több MHTML fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
