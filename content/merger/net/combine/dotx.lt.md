...
############################# Head ############################
head_title: "Sujungti DOTX failus C# | DOTX Susijungimas"
head_description: "Sujunkite kelis DOTX failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti DOTX failus C#"
description: "Sujunkite DOTX su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis DOTX failus"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną DOTX failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
