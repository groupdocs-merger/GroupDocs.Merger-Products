...
############################# Head ############################
head_title: "Sujungti PNG failus C# | PNG Susijungimas"
head_description: "Sujunkite kelis PNG failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti PNG failus C#"
description: "Sujunkite PNG su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis PNG failus"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau PNG failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti PNG failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite PNG failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties PNG dokumentu
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną PNG failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
