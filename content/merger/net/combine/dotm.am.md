...
############################# Head ############################
head_title: "DOTM ፋይሎችን በC# | ያጣምሩ DOTM ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ DOTM ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች እስከ አንድ ሰነድ ያጣምሩ።"

############################# Header ############################
title: "DOTM ፋይሎችን በC# ውስጥ ያጣምሩ"
description: "DOTMን ከጥቂት የ.NET ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በርካታ DOTM ፋይሎችን እንዴት ማጣመር እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ DOTM ፋይሎችን በመተግበር በመተግበሪያዎቻቸው ውስጥ ማጣመር ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም DOTM ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም DOTM ፋይሎችን ያጣምሩ
...
demos:
    ...
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ DOTM ፋይሎችን ያጣምሩ።
