...
############################# Head ############################
head_title: "PNG файлдарды C# ішінде біріктіру | PNG Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше PNG файлдарды бір файлға біріктіріңіз. Әртүрлі құжаттардан бір құжатқа дейін арнайы беттерді немесе бет ауқымдарын біріктіріңіз."

############################# Header ############################
title: "PNG файлды C# ішінде біріктіру"
description: "PNG .NET кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Бірнеше PNG файлдарды біріктіру жолы"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп PNG файлдарды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="PNG файлдарды C# мысал кодын пайдаланып біріктіру жолы">}}

        ```csharp    
        // GroupDocs.Merger API арқылы PNG файлдарды біріктіріңіз
