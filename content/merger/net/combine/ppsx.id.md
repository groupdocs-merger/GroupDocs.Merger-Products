...
############################# Head ############################
head_title: "Gabungkan PPSX File di C# | PPSX Penggabungan"
head_description: "Gabungkan beberapa file PPSX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan PPSX File Di C#"
description: "Gabungkan PPSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File PPSX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file PPSX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPSX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file PPSX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu PPSX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
