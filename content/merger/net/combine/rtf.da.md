...
############################# Head ############################
head_title: "Kombiner RTF filer i C# | RTF Fusion"
head_description: "Kombiner flere RTF filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner RTF filer i C#"
description: "Kombiner RTF med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere RTF-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere RTF-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer RTF filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner RTF filer ved hjælp af GroupDocs.Merger API
