...
############################# Head ############################
head_title: "Gabungkan BMP File di C# | BMP Penggabungan"
head_description: "Gabungkan beberapa file BMP menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan BMP File Di C#"
description: "Gabungkan BMP dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File BMP"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file BMP dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file BMP menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file BMP menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan BMP
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu BMP file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
