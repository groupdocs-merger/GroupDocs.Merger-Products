...
############################# Head ############################
head_title: "Combineer XLS Bestanden in C# | XLS Fusie"
head_description: "Combineer meerdere XLS bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer XLS bestanden in C#"
description: "Combineer XLS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLS bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLS-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLS bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer XLS bestanden met behulp van GroupDocs.Merger API
