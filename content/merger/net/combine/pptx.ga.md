...
############################# Head ############################
head_title: "Comhcheangail PPTX Comhaid i C# | PPTX Cumasc"
head_description: "Comhcheangail comhaid PPTX iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail PPTX Comhaid i C#"
description: "Comhcheangail PPTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad PPTX a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid PPTX a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas PPTX comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail PPTX comhad le GroupDocs.Merger API
...
demos:
    ...
    content: |
       Comhcheangail níos mó ná comhad PPTX amháin faoi láthair trí chuairt a thabhairt ar [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
