...
############################# Header ############################
title: "Yhdistä PNG tiedostoa C#"
description: "Yhdistä PNG muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia PNG-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PNG tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
