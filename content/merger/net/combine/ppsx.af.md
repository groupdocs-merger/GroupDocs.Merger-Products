...
############################# Head ############################
head_title: "Kombineer PPSX lêers in C# | PPSX samesmelting"
head_description: "Kombineer veelvuldige PPSX lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer PPSX lêers in C#"
description: "Kombineer PPSX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige PPSX-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer PPSX-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer PPSX lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer PPSX dokument
...
demos:
    ...
    content: |
       Kombineer meer as een PPSX lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
