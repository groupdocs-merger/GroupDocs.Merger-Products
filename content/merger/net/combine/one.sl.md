...
############################# Head ############################
head_title: "Združi ONE datoteke v C# | ONE Združitev"
head_description: "Združite več datotek ONE v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi ONE datotek v C#"
description: "Kombinirajte ONE z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek ONE znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ONE s primerom kode C#">}}

        ```csharp    
        // Združite datoteke ONE z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom ONE
...
demos:
    ...
    content: |
       Takoj združite več kot eno ONE datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
