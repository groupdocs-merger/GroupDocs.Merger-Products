...
############################# Head ############################
head_title: "Združi ODS datoteke v C# | ODS Združitev"
head_description: "Združite več datotek ODS v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi ODS datotek v C#"
description: "Kombinirajte ODS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek ODS znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke ODS s primerom kode C#">}}

        ```csharp    
        // Združite datoteke ODS z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Takoj združite več kot eno ODS datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
