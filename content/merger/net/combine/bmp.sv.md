...
############################# Head ############################
head_title: "Kombinera BMP-filer i C# | BMP Sammanslagning"
head_description: "Kombinera flera BMP-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera BMP filer i C#"
description: "Kombinera BMP med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera BMP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera BMP-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar BMP-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera BMP filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet BMP
...
demos:
    ...
    content: |
       Kombinera mer än en BMP-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
