...
############################# Head ############################
head_title: "Kombineer RTF lêers in C# | RTF samesmelting"
head_description: "Kombineer veelvuldige RTF lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer RTF lêers in C#"
description: "Kombineer RTF met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige RTF-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer RTF-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om RTF lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer RTF lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer RTF dokument
...
demos:
    ...
    content: |
       Kombineer meer as een RTF lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
