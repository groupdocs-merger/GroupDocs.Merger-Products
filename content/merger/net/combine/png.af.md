...
############################# Head ############################
head_title: "Kombineer PNG lêers in C# | PNG samesmelting"
head_description: "Kombineer veelvuldige PNG lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer PNG lêers in C#"
description: "Kombineer PNG met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige PNG-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer PNG-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PNG lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer PNG lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer PNG dokument
...
demos:
    ...
    content: |
       Kombineer meer as een PNG lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
