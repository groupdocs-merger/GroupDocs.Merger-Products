...
############################# Head ############################
head_title: "Kombineerige VSSM failid C# | VSSM Ühinemine"
head_description: "Kombineerige mitu VSSM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri VSSM faili C#"
description: "Kombineerige VSSM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut VSSM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat VSSM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSSM faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige VSSM faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga VSSM
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks VSSM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
