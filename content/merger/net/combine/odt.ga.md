...
############################# Head ############################
head_title: "Comhcheangail ODT Comhaid i C# | ODT Cumasc"
head_description: "Comhcheangail comhaid ODT iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail ODT Comhaid i C#"
description: "Comhcheangail ODT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad ODT a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid ODT a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas ODT comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail ODT comhad le GroupDocs.Merger API
