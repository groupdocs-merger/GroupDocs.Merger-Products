...
############################# Head ############################
head_title: "Kombiner ODS filer i C# | ODS Fusjon"
head_description: "Kombiner flere ODS-filer til én enkelt fil ved å bruke C# .NET-dokumentsammenslåings-API. Kombiner spesifikke sider eller sideområder fra ulike dokumenter til ett enkelt dokument."

############################# Header ############################
title: "Kombiner ODS filer i C#"
description: "Kombiner ODS med noen få linjer med .NET-kode."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gir en praktisk løsning for å kombinere flere PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, bilder og mange andre dokumenter i én enkelt fil i .NET-applikasjoner. GroupDocs.Merger vil spare deg for mye krefter, siden du har lov til å kombinere ODS dokumenter - det er ikke nødvendig å installere tredjepartsprogramvare, skrivebordsapplikasjoner eller plugins. Nå er det unødvendig å kaste bort tiden din og kombinere filer manuelt! GroupDocs oppgave er å gi den beste kvaliteten og forenkle dokumentbehandlingsarbeidsflyten.
...
steps:
    enable: true
    title_left: "Hvordan kombinere flere ODS-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for .NET-utviklere å kombinere to eller flere ODS-filer i applikasjonene sine ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan kombinere ODS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Kombiner ODS filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombiner mer enn én ODS-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
