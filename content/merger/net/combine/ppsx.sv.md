...
############################# Head ############################
head_title: "Kombinera PPSX-filer i C# | PPSX Sammanslagning"
head_description: "Kombinera flera PPSX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera PPSX filer i C#"
description: "Kombinera PPSX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera PPSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera PPSX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PPSX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera PPSX filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en PPSX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
