...
############################# Head ############################
head_title: "Kombineerige XLAM failid C# | XLAM Ühinemine"
head_description: "Kombineerige mitu XLAM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri XLAM faili C#"
description: "Kombineerige XLAM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut XLAM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat XLAM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLAM faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige XLAM faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga XLAM
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks XLAM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
