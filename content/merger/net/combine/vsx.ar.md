...
############################# Head ############################
head_title: "اجمع ملفات VSX في C# | VSX الاندماج"
head_description: "ادمج عدة ملفات VSX في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات VSX في C#"
description: "ادمج VSX مع بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات VSX"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من VSX داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات VSX باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات VSX باستخدام GroupDocs.Merger API
