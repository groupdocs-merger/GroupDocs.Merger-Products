...
############################# Head ############################
head_title: "Združi HTML datoteke v C# | HTML Združitev"
head_description: "Združite več datotek HTML v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi HTML datotek v C#"
description: "Kombinirajte HTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek HTML"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek HTML znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke HTML s primerom kode C#">}}

        ```csharp    
        // Združite datoteke HTML z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom HTML
...
demos:
    ...
    content: |
       Takoj združite več kot eno HTML datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
