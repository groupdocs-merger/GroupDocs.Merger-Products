...
############################# Head ############################
head_title: "Comhcheangail TXT Comhaid i C# | TXT Cumasc"
head_description: "Comhcheangail comhaid TXT iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail TXT Comhaid i C#"
description: "Comhcheangail TXT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad TXT a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid TXT a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas TXT comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail TXT comhad le GroupDocs.Merger API
