...
############################# Head ############################
head_title: "Kombinálja az TEX fájlokat a C# |-ben TEX Egyesülés"
head_description: "Kombináljon több TEX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "TEX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) TEX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több TEX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk TEX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon TEX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több TEX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
