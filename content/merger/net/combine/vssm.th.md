...
head_description: "รวมไฟล์ VSSM หลายไฟล์เป็นไฟล์เดียวโดยใช้ API การรวมเอกสาร C# .NET รวมหน้าหรือช่วงหน้าเฉพาะจากเอกสารต่างๆ ให้เป็นเอกสารเดียว"

############################# Header ############################
title: "รวม VSSM ไฟล์ใน C#"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีรวมไฟล์ VSSM ไฟล์โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // รวมไฟล์ VSSM ไฟล์โดยใช้ GroupDocs.Merger API
