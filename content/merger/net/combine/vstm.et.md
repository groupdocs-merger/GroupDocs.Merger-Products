...
############################# Head ############################
head_title: "Kombineerige VSTM failid C# | VSTM Ühinemine"
head_description: "Kombineerige mitu VSTM faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri VSTM faili C#"
description: "Kombineerige VSTM mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut VSTM faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat VSTM faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSTM faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige VSTM faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga VSTM
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks VSTM faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
