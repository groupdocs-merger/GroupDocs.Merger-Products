...
############################# Head ############################
head_title: "Combine VSSX Arquivos em C# | VSSX Fusão"
head_description: "Combine vários arquivos VSSX em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine VSSX Arquivos em C#"
description: "Combine VSSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos VSSX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos VSSX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos VSSX usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos VSSX usando a API GroupDocs.Merger
