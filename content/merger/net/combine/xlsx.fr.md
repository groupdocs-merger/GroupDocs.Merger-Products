...
############################# Head ############################
head_title: "Combiner les fichiers XLSX dans C# | XLSX Fusion"
head_description: "Combinez plusieurs fichiers XLSX en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Combinez des pages ou des plages de pages spécifiques de divers documents en un seul document."

############################# Header ############################
title: "Combinez XLSX fichiers dans C#"
description: "Combinez XLSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment combiner plusieurs fichiers XLSX"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de combiner facilement deux fichiers XLSX ou plus dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers XLSX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Combinez les fichiers XLSX à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Combinez plusieurs fichiers XLSX dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
