...
############################# Head ############################
head_title: "Kombineerige PNG failid C# | PNG Ühinemine"
head_description: "Kombineerige mitu PNG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri PNG faili C#"
description: "Kombineerige PNG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut PNG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat PNG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PNG faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige PNG faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga PNG
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks PNG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
