...
############################# Head ############################
head_title: "Kombinálja az PPS fájlokat a C# |-ben PPS Egyesülés"
head_description: "Kombináljon több PPS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPS fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PPS elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPS fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPS fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PPS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több PPS fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
