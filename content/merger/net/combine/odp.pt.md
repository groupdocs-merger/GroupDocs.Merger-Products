...
############################# Head ############################
head_title: "Combine ODP Arquivos em C# | ODP Fusão"
head_description: "Combine vários arquivos ODP em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine ODP Arquivos em C#"
description: "Combine ODP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos ODP"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos ODP em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos ODP usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos ODP usando a API GroupDocs.Merger
