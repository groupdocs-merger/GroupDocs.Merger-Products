...
############################# Head ############################
head_title: "Kombineerige RTF failid C# | RTF Ühinemine"
head_description: "Kombineerige mitu RTF faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri RTF faili C#"
description: "Kombineerige RTF mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut RTF faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat RTF faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida RTF faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige RTF faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga RTF
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks RTF faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
