...
############################# Head ############################
head_title: "Kombinálja az CSV fájlokat a C# |-ben CSV Egyesülés"
head_description: "Kombináljon több CSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "CSV fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) CSV elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több CSV fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk CSV fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon CSV fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több CSV fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
