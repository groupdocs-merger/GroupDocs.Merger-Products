...
############################# Head ############################
head_title: "Combineer CSV Bestanden in C# | CSV Fusie"
head_description: "Combineer meerdere CSV bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer CSV bestanden in C#"
description: "Combineer CSV met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere CSV bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer CSV-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe CSV bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer CSV bestanden met behulp van GroupDocs.Merger API
