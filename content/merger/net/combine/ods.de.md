...
############################# Head ############################
head_title: "Kombinieren Sie ODS-Dateien in C# | ODS Fusion"
head_description: "Kombinieren Sie mehrere ODS-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie ODS-Dateien in C#"
description: "Kombinieren Sie ODS mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere ODS-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr ODS-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie ODS-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie ODS-Dateien mit der GroupDocs.Merger-API
