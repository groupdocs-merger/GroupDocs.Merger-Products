...
############################# Head ############################
head_title: "Kombinálja az OTT fájlokat a C# |-ben OTT Egyesülés"
head_description: "Kombináljon több OTT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "OTT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) OTT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több OTT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk OTT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon OTT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több OTT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
