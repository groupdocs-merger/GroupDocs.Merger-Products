...
############################# Head ############################
head_title: "Kombinálja az XLS fájlokat a C# |-ben XLS Egyesülés"
head_description: "Kombináljon több XLS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLS fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XLS elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLS fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLS fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XLS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több XLS fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
