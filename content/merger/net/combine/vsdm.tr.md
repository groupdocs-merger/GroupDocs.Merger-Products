...
############################# Head ############################
head_title: "VSDM Dosyalarını C# İçinde Birleştirin | VSDM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSDM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSDM Dosyalarını C# İçinde Birleştirin"
description: "VSDM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSDM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSDM dosyalarını birleştirin
