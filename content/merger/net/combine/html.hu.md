...
############################# Head ############################
head_title: "Kombinálja az HTML fájlokat a C# |-ben HTML Egyesülés"
head_description: "Kombináljon több HTML fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "HTML fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) HTML elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több HTML fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk HTML fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon HTML fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több HTML fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
