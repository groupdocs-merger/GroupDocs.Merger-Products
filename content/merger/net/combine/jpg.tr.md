...
############################# Head ############################
head_title: "JPG Dosyalarını C# İçinde Birleştirin | JPG Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla JPG dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "JPG Dosyalarını C# İçinde Birleştirin"
description: "JPG kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok JPG Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak JPG dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak JPG dosyalarını birleştirin
