...
############################# Head ############################
head_title: "Kombineer TSV lêers in C# | TSV samesmelting"
head_description: "Kombineer veelvuldige TSV lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer TSV lêers in C#"
description: "Kombineer TSV met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige TSV-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer TSV-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TSV lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer TSV lêers deur GroupDocs.Merger API te gebruik
