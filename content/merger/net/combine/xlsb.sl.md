...
############################# Head ############################
head_title: "Združi XLSB datoteke v C# | XLSB Združitev"
head_description: "Združite več datotek XLSB v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi XLSB datotek v C#"
description: "Kombinirajte XLSB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek XLSB znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSB s primerom kode C#">}}

        ```csharp    
        // Združite datoteke XLSB z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom XLSB
...
demos:
    ...
    content: |
       Takoj združite več kot eno XLSB datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
