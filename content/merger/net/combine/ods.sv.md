...
############################# Head ############################
head_title: "Kombinera ODS-filer i C# | ODS Sammanslagning"
head_description: "Kombinera flera ODS-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera ODS filer i C#"
description: "Kombinera ODS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera ODS-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera ODS-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ODS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera ODS filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet ODS
...
demos:
    ...
    content: |
       Kombinera mer än en ODS-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
