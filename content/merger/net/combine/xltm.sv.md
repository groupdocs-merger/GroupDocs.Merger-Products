...
############################# Head ############################
head_title: "Kombinera XLTM-filer i C# | XLTM Sammanslagning"
head_description: "Kombinera flera XLTM-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera XLTM filer i C#"
description: "Kombinera XLTM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera XLTM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera XLTM-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XLTM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera XLTM filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en XLTM-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
