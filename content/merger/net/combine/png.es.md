...
############################# Head ############################
head_title: "Fusionar archivos PNG en .NET"
head_description: "Integra GroupDocs.Merger for .NET en tus proyectos de .NET para fusionar archivos PNG."

############################# Header ############################
title: "Fusionar archivos PNG" 
description: "Utiliza GroupDocs.Merger for .NET para construir aplicaciones de .NET que fusionen de manera eficiente documentos PNG."
...
steps:
    enable: true
    title: "Pasos para fusionar archivos PNG"
    content: |
      [GroupDocs.Merger](/merger/net/) te permite fusionar archivos PNG de manera eficiente. Integra esta función en tus aplicaciones de .NET para manejar múltiples documentos como un solo archivo.
      
      1. Establece la ruta al primer archivo PNG.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crea una instancia de Merger con el documento PNG de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de archivos de diferentes formatos"
      content: |
        Este ejemplo ilustra cómo fusionar archivos PNG incorporando páginas seleccionadas de otros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
