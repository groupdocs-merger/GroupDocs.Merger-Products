...
############################# Head ############################
head_title: "Combiner les fichiers XLS dans C# | XLS Fusion"
head_description: "Combinez plusieurs fichiers XLS en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Combinez des pages ou des plages de pages spécifiques de divers documents en un seul document."

############################# Header ############################
title: "Combinez XLS fichiers dans C#"
description: "Combinez XLS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment combiner plusieurs fichiers XLS"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de combiner facilement deux fichiers XLS ou plus dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers XLS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Combinez les fichiers XLS à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée XLS
...
demos:
    ...
    content: |
       Combinez plusieurs fichiers XLS dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
