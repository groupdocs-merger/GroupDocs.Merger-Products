...
############################# Head ############################
head_title: "Combineer JPEG Bestanden in C# | JPEG Fusie"
head_description: "Combineer meerdere JPEG bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer JPEG bestanden in C#"
description: "Combineer JPEG met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere JPEG bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer JPEG-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe JPEG bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer JPEG bestanden met behulp van GroupDocs.Merger API
