...
############################# Head ############################
head_title: "Gabungkan file MHTML di .NET"
head_description: "Integrasikan GroupDocs.Merger for .NET ke dalam proyek .NET Anda untuk menggabungkan file MHTML."

############################# Header ############################
title: "Gabungkan file MHTML" 
description: "Gunakan GroupDocs.Merger for .NET untuk membangun aplikasi .NET yang secara efisien menggabungkan dokumen MHTML."
...
steps:
    enable: true
    title: "Langkah-langkah untuk menggabungkan file MHTML"
    content: |
      [GroupDocs.Merger](/merger/net/) memungkinkan Anda untuk menggabungkan file MHTML tanpa kesulitan. Integrasikan fitur ini ke dalam aplikasi .NET Anda untuk menangani beberapa dokumen sebagai satu file.
      
      1. Tetapkan jalur ke file MHTML pertama.
      2. Pilih file kedua.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Buat instance Merger dengan dokumen MHTML input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman terpilih dari file dengan format yang berbeda"
      content: |
        Contoh ini menjelaskan cara menggabungkan file MHTML sambil menggabungkan halaman terpilih dari format lain.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
