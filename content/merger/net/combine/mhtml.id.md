...
head_title: "Gabungkan File MHTML di C# | MHTML Penggabungan"
head_description: "Gabungkan beberapa file MHTML menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabungkan File MHTML Di C#"
description: "Gabungkan beberapa file MHTML menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber menjadi satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File MHTML"
    content_left: |
...
demos:
    ...
    content: |
        Gabungkan lebih dari satu file MHTML sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/family).  
