...
############################# Head ############################
head_title: "Combine VDX Arquivos em C# | VDX Fusão"
head_description: "Combine vários arquivos VDX em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine VDX Arquivos em C#"
description: "Combine VDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos VDX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos VDX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos VDX usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos VDX usando a API GroupDocs.Merger
