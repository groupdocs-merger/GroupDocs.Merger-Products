...
############################# Head ############################
head_title: "Combineer PPT Bestanden in C# | PPT Fusie"
head_description: "Combineer meerdere PPT bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer PPT bestanden in C#"
description: "Combineer PPT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PPT bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPT-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPT bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer PPT bestanden met behulp van GroupDocs.Merger API
