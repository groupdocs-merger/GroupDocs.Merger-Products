...
############################# Head ############################
head_title: "VSSM Dosyalarını C# İçinde Birleştirin | VSSM Birleşme"
...
############################# Header ############################
title: "VSSM Dosyalarını C# İçinde Birleştirin"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API kullanarak VSSM dosyalarını birleştirin
