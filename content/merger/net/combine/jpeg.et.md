...
############################# Head ############################
head_title: "Kombineerige JPEG failid C# | JPEG Ühinemine"
head_description: "Kombineerige mitu JPEG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri JPEG faili C#"
description: "Kombineerige JPEG mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut JPEG faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat JPEG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida JPEG faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige JPEG faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga JPEG
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks JPEG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
