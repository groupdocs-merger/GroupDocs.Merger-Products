...
############################# Head ############################
head_title: "Combineer XLSB Bestanden in C# | XLSB Fusie"
head_description: "Combineer meerdere XLSB bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer XLSB bestanden in C#"
description: "Combineer XLSB met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLSB bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLSB-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSB bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer XLSB bestanden met behulp van GroupDocs.Merger API
