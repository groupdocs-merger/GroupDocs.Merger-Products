...
############################# Head ############################
head_title: "Merge JPEG files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge JPEG files."

############################# Header ############################
title: "Merge JPEG files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge JPEG documents."
...
steps:
    enable: true
    title: "Steps to merge JPEG files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge JPEG files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
      
      1. Set the path to the first JPEG file.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Create a Merger instance with the input JPEG document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge JPEG files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Extract pages"
          operation: "extract"
          link: "/merger/net/extract/jpeg/"
          description: "Save selected pages as a separate document"

        # operation loop 3
        - name: "Move pages"
          operation: "move"
          link: "/merger/net/move/jpeg/"
          description: "Reposition any page within a document"

        # operation loop 4
        - name: "Remove pages"
          operation: "remove"
          link: "/merger/net/remove/jpeg/"
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/net/rotate/jpeg/"
          description: "Rotate document pages"

        # operation loop 7
        - name: "Split doc"
          operation: "split"
          link: "/merger/net/split/jpeg/"
          description: "Split documents"

        # operation loop 8
        - name: "Swap pages"
          operation: "swap"
          link: "/merger/net/swap/jpeg/"
          description: "Swap document pages"

        # operation loop 9
        - name: "Change orientation"
          operation: "orientation"
          link: "/merger/net/orientation/jpeg/"
