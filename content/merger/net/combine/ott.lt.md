...
############################# Head ############################
head_title: "Sujungti OTT failus C# | OTT Susijungimas"
head_description: "Sujunkite kelis OTT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti OTT failus C#"
description: "Sujunkite OTT su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis OTT failus"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną OTT failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
