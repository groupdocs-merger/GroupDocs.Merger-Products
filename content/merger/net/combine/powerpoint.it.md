...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono efficientemente documenti POWERPOINT."
...
steps:
    enable: true
    title: "Passi per unire file POWERPOINT"
    content: |
