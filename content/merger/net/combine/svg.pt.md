...
############################# Head ############################
head_title: "Mesclar arquivos SVG em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para mesclar arquivos SVG."

############################# Header ############################
title: "Mesclar arquivos SVG" 
description: "Use GroupDocs.Merger for .NET para construir aplicações .NET que mesclam documentos SVG de forma eficiente."
...
steps:
    enable: true
    title: "Etapas para mesclar arquivos SVG"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você mescle arquivos SVG de forma eficaz. Integre essa funcionalidade em suas aplicações .NET para lidar com vários documentos como um único arquivo.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância do Merger com o documento SVG de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como mesclar arquivos SVG incorporando páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
