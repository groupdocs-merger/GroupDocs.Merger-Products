...
############################# Head ############################
head_title: "Kombinálja az VSTX fájlokat a C# |-ben VSTX Egyesülés"
head_description: "Kombináljon több VSTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSTX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) VSTX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSTX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSTX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon VSTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több VSTX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
