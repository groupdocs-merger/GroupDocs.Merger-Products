...
############################# Head ############################
head_title: "Združi PPSX datoteke v C# | PPSX Združitev"
head_description: "Združite več datotek PPSX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi PPSX datotek v C#"
description: "Kombinirajte PPSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek PPSX"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek PPSX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPSX s primerom kode C#">}}

        ```csharp    
        // Združite datoteke PPSX z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom PPSX
...
demos:
    ...
    content: |
       Takoj združite več kot eno PPSX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
