...
############################# Head ############################
head_title: "Comhcheangail OTP Comhaid i C# | OTP Cumasc"
head_description: "Comhcheangail comhaid OTP iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail OTP Comhaid i C#"
description: "Comhcheangail OTP le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad OTP a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid OTP a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas OTP comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail OTP comhad le GroupDocs.Merger API
