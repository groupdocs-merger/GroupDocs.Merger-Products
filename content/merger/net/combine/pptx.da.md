...
############################# Head ############################
head_title: "Kombiner PPTX filer i C# | PPTX Fusion"
head_description: "Kombiner flere PPTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner PPTX filer i C#"
description: "Kombiner PPTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere PPTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere PPTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer PPTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner PPTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombiner mere end én PPTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
