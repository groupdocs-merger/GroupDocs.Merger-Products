...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to combine two or more VTX files within their applications by implementing a few easy steps.
