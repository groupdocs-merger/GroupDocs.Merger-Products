...
############################# Head ############################
head_title: "在.NET中合并VISIO文件"
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以合并VISIO文件."

############################# Header ############################
title: "合并VISIO文件" 
description: "使用GroupDocs.Merger for .NET构建高效合并VISIO文档的.NET应用程序。"
...
steps:
    ...
    title: "合并VISIO文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够轻松合并VISIO文件。将此功能集成到您的.NET应用程序中，以将多个文档处理为一个文件。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同格式的文件合并选定页面"
      content: |
        该示例说明如何在合并VISIO文件时，包含来自其他格式的选定页面。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
