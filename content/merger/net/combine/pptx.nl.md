...
############################# Head ############################
head_title: "Combineer PPTX Bestanden in C# | PPTX Fusie"
head_description: "Combineer meerdere PPTX bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer PPTX bestanden in C#"
description: "Combineer PPTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere PPTX bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer PPTX-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer PPTX bestanden met behulp van GroupDocs.Merger API
