...
############################# Head ############################
head_title: "ODT Dosyalarını C# İçinde Birleştirin | ODT Birleşme"
...
############################# Header ############################
title: "ODT Dosyalarını C# İçinde Birleştirin"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODT dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API kullanarak ODT dosyalarını birleştirin
