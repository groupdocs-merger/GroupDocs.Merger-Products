...
############################# Head ############################
head_title: "Combineer XLT Bestanden in C# | XLT Fusie"
head_description: "Combineer meerdere XLT bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer XLT bestanden in C#"
description: "Combineer XLT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLT bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLT-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLT bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer XLT bestanden met behulp van GroupDocs.Merger API
