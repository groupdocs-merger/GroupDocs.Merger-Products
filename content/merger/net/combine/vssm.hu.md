...
############################# Head ############################
head_title: "Kombinálja az VSSM fájlokat a C# |-ben VSSM Egyesülés"
head_description: "Kombináljon több VSSM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSSM fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) VSSM elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSSM fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSSM fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon VSSM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több VSSM fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
