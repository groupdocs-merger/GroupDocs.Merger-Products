...
############################# Head ############################
head_title: "Combineer VSSM Bestanden in C# | VSSM Fusie"
head_description: "Combineer meerdere VSSM bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer VSSM bestanden in C#"
description: "Combineer VSSM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere VSSM bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSSM-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer VSSM bestanden met behulp van GroupDocs.Merger API
