...
############################# Head ############################
head_title: "Kombineerige XLSB failid C# | XLSB Ühinemine"
head_description: "Kombineerige mitu XLSB faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri XLSB faili C#"
description: "Kombineerige XLSB mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut XLSB faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat XLSB faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida XLSB faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige XLSB faili GroupDocs.Merger API abil
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks XLSB faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
