...
############################# Head ############################
head_title: "Gabungkan CSV File di C# | CSV Penggabungan"
head_description: "Gabungkan beberapa file CSV menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan CSV File Di C#"
description: "Gabungkan CSV dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file CSV dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file CSV menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file CSV menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan CSV
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu CSV file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
