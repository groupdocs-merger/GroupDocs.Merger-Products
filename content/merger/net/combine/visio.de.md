...
############################# Head ############################
head_title: "Kombinieren Sie VISIO-Dateien in C# | VISIO Fusion"
head_description: "Kombinieren Sie mehrere VISIO-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie VISIO-Dateien in C#"
description: "Kombinieren Sie VISIO mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere VISIO-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr VISIO-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie VISIO-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie VISIO-Dateien mit der GroupDocs.Merger-API
...
demos:
    ...
    content: |
       Kombinieren Sie jetzt mehr als eine VISIO-Datei, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) besuchen.
