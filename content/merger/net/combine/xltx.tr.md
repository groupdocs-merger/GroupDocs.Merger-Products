...
############################# Head ############################
head_title: "XLTX Dosyalarını C# İçinde Birleştirin | XLTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLTX Dosyalarını C# İçinde Birleştirin"
description: "XLTX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLTX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLTX dosyalarını birleştirin
