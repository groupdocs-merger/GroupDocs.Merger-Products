...
############################# Head ############################
head_title: "Kombiner CSV filer i C# | CSV Fusion"
head_description: "Kombiner flere CSV filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner CSV filer i C#"
description: "Kombiner CSV med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere CSV-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere CSV-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer CSV filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner CSV filer ved hjælp af GroupDocs.Merger API
