...
############################# Head ############################
head_title: "Gabungkan PPTX File di C# | PPTX Penggabungan"
head_description: "Gabungkan beberapa file PPTX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan PPTX File Di C#"
description: "Gabungkan PPTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file PPTX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file PPTX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file PPTX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu PPTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
