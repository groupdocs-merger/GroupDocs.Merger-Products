...
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以合并ZIP文件."
...
steps:
    ...
    title: "合并ZIP文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够轻松合并ZIP文件。将此功能集成到您的.NET应用程序中，以将多个文档处理为一个文件。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同格式的文件合并选定页面"
      content: |
        该示例说明如何在合并ZIP文件时，包含来自其他格式的选定页面。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
