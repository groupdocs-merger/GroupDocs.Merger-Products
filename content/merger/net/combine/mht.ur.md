...
############################# Head ############################
head_title: "MHT فائلوں کو C# میں یکجا کریں۔ MHT انضمام"
head_description: "C# .NET دستاویزات کے انضمام API کا استعمال کرتے ہوئے متعدد MHT فائلوں کو ایک فائل میں یکجا کریں۔ مختلف دستاویزات سے کسی ایک دستاویز تک مخصوص صفحات یا صفحہ کی حدود کو یکجا کریں۔"

############################# Header ############################
title: "MHT فائلوں کو C# میں یکجا کریں"
description: "MHT کو .NET کوڈ کی چند سطروں کے ساتھ جوڑیں۔"
...
steps:
    enable: true
    title_left: "متعدد MHT فائلوں کو یکجا کرنے کا طریقہ"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) .NET ڈویلپرز کے لیے اپنی ایپلی کیشنز میں دو یا زیادہ MHT فائلوں کو اکٹھا کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے MHT فائلوں کو کیسے جوڑیں۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے MHT فائلوں کو یکجا کریں۔
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) ویب سائٹ پر جا کر ابھی ایک سے زیادہ MHT فائلوں کو یکجا کریں۔
