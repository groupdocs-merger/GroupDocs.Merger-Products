...
############################# Head ############################
head_title: "Združi JPG datoteke v C# | JPG Združitev"
head_description: "Združite več datotek JPG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi JPG datotek v C#"
description: "Kombinirajte JPG z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek JPG"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek JPG znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPG s primerom kode C#">}}

        ```csharp    
        // Združite datoteke JPG z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom JPG
...
demos:
    ...
    content: |
       Takoj združite več kot eno JPG datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
