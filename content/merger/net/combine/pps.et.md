...
############################# Head ############################
head_title: "Kombineerige PPS failid C# | PPS Ühinemine"
head_description: "Kombineerige mitu PPS faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri PPS faili C#"
description: "Kombineerige PPS mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut PPS faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat PPS faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida PPS faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige PPS faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga PPS
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks PPS faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
