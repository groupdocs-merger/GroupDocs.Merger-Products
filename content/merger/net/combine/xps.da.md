...
############################# Head ############################
head_title: "Kombiner XPS filer i C# | XPS Fusion"
head_description: "Kombiner flere XPS filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner XPS filer i C#"
description: "Kombiner XPS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere XPS-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere XPS-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer XPS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner XPS filer ved hjælp af GroupDocs.Merger API
