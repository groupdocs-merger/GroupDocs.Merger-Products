...
############################# Head ############################
head_title: "اجمع ملفات HTML في C# | HTML الاندماج"
head_description: "ادمج عدة ملفات HTML في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات HTML في C#"
description: "ادمج HTML مع بضعة أسطر من كود .NET."
