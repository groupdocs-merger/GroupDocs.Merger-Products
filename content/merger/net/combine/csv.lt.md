...
############################# Head ############################
head_title: "Sujungti CSV failus C# | CSV Susijungimas"
head_description: "Sujunkite kelis CSV failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti CSV failus C#"
description: "Sujunkite CSV su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis CSV failus"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia .NET kūrėjams lengvai sujungti du ar daugiau CSV failų savo programose įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sujungti CSV failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Sujunkite CSV failus naudodami GroupDocs.Merger API
        // Momentinis susijungimas su įvesties CSV dokumentu
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną CSV failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
