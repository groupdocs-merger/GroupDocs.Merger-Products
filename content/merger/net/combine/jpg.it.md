...
############################# Head ############################
head_title: "Combina file JPG in C# | JPG Fusione"
head_description: "Combina più file JPG in un unico file utilizzando l'API di fusione documenti C# .NET. Combina pagine o intervalli di pagine specifici da vari documenti in un unico documento."

############################# Header ############################
title: "Combina JPG file in C#"
description: "Combina JPG con poche righe di codice .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/it/merger/net/) fornisce una comoda soluzione per combinare più PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, immagini e molti altri documenti in un unico file all'interno delle applicazioni .NET. GroupDocs.Merger ti farà risparmiare un sacco di fatica, poiché ti è consentito combinare JPG documenti: non è necessario installare alcun software, applicazioni desktop o plug-in di terze parti. Ora non è più necessario perdere tempo e combinare i file manualmente! La missione di GroupDocs è fornire la migliore qualità e semplificare i flussi di lavoro di elaborazione dei documenti.
...
steps:
    enable: true
    title_left: "Come combinare più file JPG"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di .NET di combinare facilmente due o più JPG file all'interno delle loro applicazioni implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come combinare file JPG utilizzando il codice di esempio C#">}}

        ```csharp    
        // Combina file JPG utilizzando l'API GroupDocs.Merger
        // Istanzia la fusione con il documento di input JPG
...
demos:
    ...
    content: |
       Combina più di un file JPG in questo momento visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
