...
############################# Head ############################
head_title: "Kombinálja az OTP fájlokat a C# |-ben OTP Egyesülés"
head_description: "Kombináljon több OTP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "OTP fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) OTP elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több OTP fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk OTP fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon OTP fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több OTP fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
