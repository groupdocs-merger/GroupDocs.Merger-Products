...
############################# Head ############################
head_title: "Mesclar arquivos EXCEL em .NET"
head_description: "Integre GroupDocs.Merger for .NET em seus projetos .NET para mesclar arquivos EXCEL."

############################# Header ############################
title: "Mesclar arquivos EXCEL" 
description: "Use GroupDocs.Merger for .NET para construir aplicações .NET que mesclam documentos EXCEL de forma eficiente."
...
steps:
    enable: true
    title: "Etapas para mesclar arquivos EXCEL"
    content: |
      [GroupDocs.Merger](/merger/net/) permite que você mescle arquivos EXCEL de forma eficaz. Integre essa funcionalidade em suas aplicações .NET para lidar com vários documentos como um único arquivo.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Crie uma instância do Merger com o documento EXCEL de entrada
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de arquivos de diferentes formatos"
      content: |
        Este exemplo ilustra como mesclar arquivos EXCEL incorporando páginas selecionadas de outros formatos.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
