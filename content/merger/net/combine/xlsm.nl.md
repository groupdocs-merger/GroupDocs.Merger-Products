...
############################# Head ############################
head_title: "Combineer XLSM Bestanden in C# | XLSM Fusie"
head_description: "Combineer meerdere XLSM bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer XLSM bestanden in C#"
description: "Combineer XLSM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLSM bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLSM-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSM bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer XLSM bestanden met behulp van GroupDocs.Merger API
