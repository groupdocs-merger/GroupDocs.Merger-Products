...
############################# Head ############################
head_title: "JPEG Dosyalarını C# İçinde Birleştirin | JPEG Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla JPEG dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "JPEG Dosyalarını C# İçinde Birleştirin"
description: "JPEG kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok JPEG Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak JPEG dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak JPEG dosyalarını birleştirin
