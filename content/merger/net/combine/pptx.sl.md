...
############################# Head ############################
head_title: "Združi PPTX datoteke v C# | PPTX Združitev"
head_description: "Združite več datotek PPTX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi PPTX datotek v C#"
description: "Kombinirajte PPTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek PPTX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PPTX s primerom kode C#">}}

        ```csharp    
        // Združite datoteke PPTX z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom PPTX
...
demos:
    ...
    content: |
       Takoj združite več kot eno PPTX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
