...
############################# Head ############################
head_title: "Gabungkan VDX File di C# | VDX Penggabungan"
head_description: "Gabungkan beberapa file VDX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan VDX File Di C#"
description: "Gabungkan VDX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File VDX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VDX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VDX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file VDX menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan VDX
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VDX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
