...
############################# Head ############################
head_title: "Comhcheangail BMP Comhaid i C# | BMP Cumasc"
head_description: "Comhcheangail comhaid BMP iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail BMP Comhaid i C#"
description: "Comhcheangail BMP le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad BMP a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid BMP a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas BMP comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail BMP comhad le GroupDocs.Merger API
