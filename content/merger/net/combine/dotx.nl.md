...
############################# Head ############################
head_title: "Combineer DOTX Bestanden in C# | DOTX Fusie"
head_description: "Combineer meerdere DOTX bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer DOTX bestanden in C#"
description: "Combineer DOTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOTX bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOTX-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTX bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer DOTX bestanden met behulp van GroupDocs.Merger API
