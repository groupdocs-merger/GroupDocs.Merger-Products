...
############################# Head ############################
head_title: "Združi DOTX datoteke v C# | DOTX Združitev"
head_description: "Združite več datotek DOTX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi DOTX datotek v C#"
description: "Kombinirajte DOTX z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek DOTX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
