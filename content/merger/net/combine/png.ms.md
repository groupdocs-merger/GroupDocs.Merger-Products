...
############################# Head ############################
head_title: "Gabungkan PNG Fail dalam C# | PNG Penggabungan"
head_description: "Gabungkan berbilang fail PNG ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Gabungkan PNG Fail Dalam C#"
description: "Gabungkan PNG dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Berbilang PNG Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menggabungkan dua atau lebih PNG fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan PNG fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Gabungkan PNG fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu PNG fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
