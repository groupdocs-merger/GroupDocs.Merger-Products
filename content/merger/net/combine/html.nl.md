...
############################# Head ############################
head_title: "Combineer HTML Bestanden in C# | HTML Fusie"
head_description: "Combineer meerdere HTML bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer HTML bestanden in C#"
description: "Combineer HTML met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere HTML bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer HTML-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe HTML bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer HTML bestanden met behulp van GroupDocs.Merger API
