...
head_title: "Gabungkan File XLTX di C# | XLTX Penggabungan"
head_description: "Gabungkan beberapa file XLTX menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabungkan File XLTX Di C#"
description: "Gabungkan beberapa file XLTX menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber menjadi satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File XLTX"
    content_left: |
    ...
    code: |
        ```cs
        // Gabungkan file XLTX menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
        Gabungkan lebih dari satu file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/family).  
