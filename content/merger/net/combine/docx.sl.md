...
############################# Head ############################
head_title: "Združi DOCX datoteke v C# | DOCX Združitev"
head_description: "Združite več datotek DOCX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi DOCX datotek v C#"
description: "Kombinirajte DOCX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek DOCX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke DOCX s primerom kode C#">}}

        ```csharp    
        // Združite datoteke DOCX z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom DOCX
...
demos:
    ...
    content: |
       Takoj združite več kot eno DOCX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
