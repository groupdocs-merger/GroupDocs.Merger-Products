...
############################# Head ############################
head_title: "VSDX файлдарды C# ішінде біріктіру | VSDX Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше VSDX файлдарды бір файлға біріктіріңіз. Әртүрлі құжаттардан бір құжатқа дейін арнайы беттерді немесе бет ауқымдарын біріктіріңіз."

############################# Header ############################
title: "VSDX файлды C# ішінде біріктіру"
description: "VSDX .NET кодының бірнеше жолымен біріктіріңіз."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп VSDX файлдарды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
