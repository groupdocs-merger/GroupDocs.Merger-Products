...
############################# Head ############################
head_title: "Sujungti PPT failus C# | PPT Susijungimas"
head_description: "Sujunkite kelis PPT failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus iš įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "Sujungti PPT failus C#"
description: "Sujunkite PPT su keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Kaip sujungti kelis PPT failus"
    content_left: |
...
demos:
    ...
    content: |
       Šiuo metu sujunkite daugiau nei vieną PPT failą apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) svetainėje.
