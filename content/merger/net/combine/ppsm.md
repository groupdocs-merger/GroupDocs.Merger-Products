...
############################# Head ############################
head_title: "Combine PPSM Files in C# | PPSM Merger"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to combine two or more PPSM files within their applications by implementing a few easy steps.
