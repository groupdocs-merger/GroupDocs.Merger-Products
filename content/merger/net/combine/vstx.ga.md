...
############################# Head ############################
head_title: "Comhcheangail VSTX Comhaid i C# | VSTX Cumasc"
head_description: "Comhcheangail comhaid VSTX iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail VSTX Comhaid i C#"
description: "Comhcheangail VSTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad VSTX a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid VSTX a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSTX comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail VSTX comhad le GroupDocs.Merger API
