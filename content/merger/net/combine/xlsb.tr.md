...
############################# Head ############################
head_title: "XLSB Dosyalarını C# İçinde Birleştirin | XLSB Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLSB dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLSB Dosyalarını C# İçinde Birleştirin"
description: "XLSB kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLSB Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLSB dosyalarını birleştirin
