...
############################# Head ############################
head_title: "Kombineer TXT lêers in C# | TXT samesmelting"
head_description: "Kombineer veelvuldige TXT lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer TXT lêers in C#"
description: "Kombineer TXT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige TXT-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer TXT-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TXT lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer TXT lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer TXT dokument
...
demos:
    ...
    content: |
       Kombineer meer as een TXT lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
