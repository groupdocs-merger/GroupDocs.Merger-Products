...
############################# Head ############################
head_title: "Gabungkan VTX File di C# | VTX Penggabungan"
head_description: "Gabungkan beberapa file VTX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan VTX File Di C#"
description: "Gabungkan VTX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File VTX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VTX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VTX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file VTX menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan VTX
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VTX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
