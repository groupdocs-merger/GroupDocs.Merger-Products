...
############################# Head ############################
head_title: "Kombinálja az ODP fájlokat a C# |-ben ODP Egyesülés"
head_description: "Kombináljon több ODP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODP fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) ODP elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODP fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ODP fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon ODP fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több ODP fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
