...
############################# Head ############################
head_title: "PDF Dosyalarını C# İçinde Birleştirin | PDF Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PDF dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "PDF Dosyalarını C# İçinde Birleştirin"
description: "PDF kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok PDF Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak PDF dosyalarını birleştirin
