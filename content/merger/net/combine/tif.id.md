...
head_title: "Gabungkan File TIF di C# | TIF Penggabungan"
head_description: "Gabungkan beberapa file TIF menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabungkan File TIF Di C#"
description: "Gabungkan beberapa file TIF menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber menjadi satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File TIF"
    content_left: |
    ...
    code: |
        ```cs
        // Gabungkan file TIF menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
        Gabungkan lebih dari satu file TIF sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/family).  
