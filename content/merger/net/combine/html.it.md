...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono efficientemente documenti HTML."
...
steps:
    enable: true
    title: "Passi per unire file HTML"
    content: |
