...
############################# Head ############################
head_title: "Gabungkan MHT File di C# | MHT Penggabungan"
head_description: "Gabungkan beberapa file MHT menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan MHT File Di C#"
description: "Gabungkan MHT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File MHT"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file MHT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file MHT menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file MHT menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan MHT
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu MHT file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
