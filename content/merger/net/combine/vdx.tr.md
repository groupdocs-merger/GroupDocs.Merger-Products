...
############################# Head ############################
head_title: "VDX Dosyalarını C# İçinde Birleştirin | VDX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VDX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VDX Dosyalarını C# İçinde Birleştirin"
description: "VDX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VDX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VDX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VDX dosyalarını birleştirin
