...
############################# Head ############################
head_title: "Combineer DOC Bestanden in C# | DOC Fusie"
head_description: "Combineer meerdere DOC bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer DOC bestanden in C#"
description: "Combineer DOC met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOC bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOC-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOC bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer DOC bestanden met behulp van GroupDocs.Merger API
