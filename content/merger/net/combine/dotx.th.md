...
############################# Head ############################
head_title: "รวม DOTX ไฟล์ใน C# | DOTX การควบรวมกิจการ"
head_description: "รวมไฟล์ DOTX หลายไฟล์เป็นไฟล์เดียวโดยใช้ API การรวมเอกสาร C# .NET รวมหน้าหรือช่วงหน้าเฉพาะจากเอกสารต่างๆ ให้เป็นเอกสารเดียว"

############################# Header ############################
title: "รวม DOTX ไฟล์ใน C#"
description: "รวม DOTX กับโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "วิธีรวมไฟล์หลายไฟล์ DOTX เข้าด้วยกัน"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา .NET สามารถรวมไฟล์ DOTX สองไฟล์ขึ้นไปภายในแอปพลิเคชันของตนได้โดยง่ายโดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีรวมไฟล์ DOTX ไฟล์โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // รวมไฟล์ DOTX ไฟล์โดยใช้ GroupDocs.Merger API
...
demos:
    ...
    content: |
       รวมไฟล์ DOTX มากกว่าหนึ่งไฟล์ในขณะนี้โดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family)
