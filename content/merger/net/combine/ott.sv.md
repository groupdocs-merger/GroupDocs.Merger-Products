...
############################# Head ############################
head_title: "Kombinera OTT-filer i C# | OTT Sammanslagning"
head_description: "Kombinera flera OTT-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera OTT filer i C#"
description: "Kombinera OTT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera OTT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera OTT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar OTT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera OTT filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en OTT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
