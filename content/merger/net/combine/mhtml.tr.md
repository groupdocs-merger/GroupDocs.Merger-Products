...
############################# Head ############################
head_title: "MHTML Dosyalarını C# İçinde Birleştirin | MHTML Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla MHTML dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "MHTML Dosyalarını C# İçinde Birleştirin"
description: "MHTML kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok MHTML Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHTML dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak MHTML dosyalarını birleştirin
