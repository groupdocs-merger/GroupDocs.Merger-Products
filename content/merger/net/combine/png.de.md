...
############################# Head ############################
head_title: "PNG-Dateien in .NET zusammenführen"
head_description: "Integrieren Sie GroupDocs.Merger for .NET in Ihre .NET-Projekte, um PNG-Dateien zusammenzuführen."

############################# Header ############################
title: "PNG-Dateien zusammenführen" 
description: "Nutzen Sie GroupDocs.Merger for .NET, um .NET-Anwendungen zu erstellen, die PNG-Dokumente effizient zusammenführen."
...
steps:
    enable: true
    title: "PNG-Dateien zusammenführen: Schritte"
    content: |
      [GroupDocs.Merger](/merger/net/) ermöglicht es Ihnen, PNG-Dateien mühelos zusammenzuführen. Integrieren Sie diese Funktion in Ihre .NET-Anwendungen, um mehrere Dokumente als eine einzige Datei zu verarbeiten.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Erstellen Sie eine Instanz von Merger mit dem Eingangs-PNG-Dokument.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus Dateien verschiedener Formate zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie PNG-Dateien zusammengeführt werden, während ausgewählte Seiten aus anderen Formaten integriert werden.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
