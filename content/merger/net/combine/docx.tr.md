...
############################# Head ############################
head_title: "DOCX Dosyalarını C# İçinde Birleştirin | DOCX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOCX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "DOCX Dosyalarını C# İçinde Birleştirin"
description: "DOCX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok DOCX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak DOCX dosyalarını birleştirin
