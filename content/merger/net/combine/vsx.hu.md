...
############################# Head ############################
head_title: "Kombinálja az VSX fájlokat a C# |-ben VSX Egyesülés"
head_description: "Kombináljon több VSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) VSX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk VSX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon VSX fájlt a GroupDocs.Merger API segítségével
