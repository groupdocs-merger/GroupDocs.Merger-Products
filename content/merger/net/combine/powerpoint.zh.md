...
############################# Head ############################
head_title: "在.NET中合并POWERPOINT文件"
head_description: "将GroupDocs.Merger for .NET集成到您的.NET项目中，以合并POWERPOINT文件."

############################# Header ############################
title: "合并POWERPOINT文件" 
description: "使用GroupDocs.Merger for .NET构建高效合并POWERPOINT文档的.NET应用程序。"
...
steps:
    enable: true
    title: "合并POWERPOINT文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/net/)使您能够轻松合并POWERPOINT文件。将此功能集成到您的.NET应用程序中，以将多个文档处理为一个文件。
      
      1. 设置第一个POWERPOINT文件的路径。
      2. 选择第二个文件。
      3. 配置可选设置。
      4. 合并文档并保存输出文件。
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // 创建一个Merger实例，并传入输入的POWERPOINT文档
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同格式的文件合并选定页面"
      content: |
        该示例说明如何在合并POWERPOINT文件时，包含来自其他格式的选定页面。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
