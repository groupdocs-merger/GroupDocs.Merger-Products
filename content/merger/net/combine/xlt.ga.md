...
############################# Head ############################
head_title: "Comhcheangail XLT Comhaid i C# | XLT Cumasc"
head_description: "Comhcheangail comhaid XLT iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail XLT Comhaid i C#"
description: "Comhcheangail XLT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad XLT a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid XLT a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas XLT comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail XLT comhad le GroupDocs.Merger API
