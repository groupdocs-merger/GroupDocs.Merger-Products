...
############################# Head ############################
head_title: "اجمع ملفات OTT في C# | OTT الاندماج"
head_description: "ادمج عدة ملفات OTT في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات OTT في C#"
description: "ادمج OTT مع بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات OTT"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من OTT داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات OTT باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات OTT باستخدام GroupDocs.Merger API
