...
############################# Head ############################
head_title: "Combineer TSV Bestanden in C# | TSV Fusie"
head_description: "Combineer meerdere TSV bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer TSV bestanden in C#"
description: "Combineer TSV met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere TSV bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer TSV-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TSV bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer TSV bestanden met behulp van GroupDocs.Merger API
