...
############################# Head ############################
head_title: "Združi OTP datoteke v C# | OTP Združitev"
head_description: "Združite več datotek OTP v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi OTP datotek v C#"
description: "Kombinirajte OTP z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek OTP znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
