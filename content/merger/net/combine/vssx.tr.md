...
############################# Head ############################
head_title: "VSSX Dosyalarını C# İçinde Birleştirin | VSSX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSSX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSSX Dosyalarını C# İçinde Birleştirin"
description: "VSSX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSSX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSSX dosyalarını birleştirin
