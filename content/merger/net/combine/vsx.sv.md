...
############################# Head ############################
head_title: "Kombinera VSX-filer i C# | VSX Sammanslagning"
head_description: "Kombinera flera VSX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera VSX filer i C#"
description: "Kombinera VSX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera VSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera VSX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera VSX filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet VSX
...
demos:
    ...
    content: |
       Kombinera mer än en VSX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
