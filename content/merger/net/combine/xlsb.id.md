...
############################# Head ############################
head_title: "Gabungkan XLSB File di C# | XLSB Penggabungan"
head_description: "Gabungkan beberapa file XLSB menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan XLSB File Di C#"
description: "Gabungkan XLSB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file XLSB dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file XLSB menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file XLSB menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan XLSB
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLSB file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
