...
############################# Head ############################
head_title: "Zkombinujte VSDM soubory v C# | VSDM Fúze"
head_description: "Zkombinujte více souborů VSDM do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Kombinujte konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "Kombinovat VSDM soubory v C#"
description: "Zkombinujte VSDM s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak zkombinovat více souborů VSDM"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET kombinovat dva nebo více souborů VSDM v jejich aplikacích implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory VSDM pomocí ukázkového kódu C#">}}

        ```csharp    
        // Zkombinujte VSDM soubory pomocí GroupDocs.Merger API
...
demos:
    ...
    content: |
       Na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) zkombinujte hned teď více než jeden soubor VSDM.
