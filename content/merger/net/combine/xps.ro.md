...
############################# Head ############################
head_title: "Combinați fișierele XPS în C# | XPS Fuziune"
head_description: "Combinați mai multe fișiere XPS într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Combinați anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Combinați fișiere XPS în C#"
description: "Combinați XPS cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să combinați mai multe fișiere XPS"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să combine două sau mai multe fișiere XPS în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să combinați fișiere XPS folosind codul exemplu C#">}}

        ```csharp    
        // Combinați fișiere XPS utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Combinați mai mult de un fișier XPS chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
