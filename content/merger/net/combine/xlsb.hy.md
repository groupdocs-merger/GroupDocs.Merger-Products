...
############################# Head ############################
head_title: "Միավորել XLSB ֆայլեր C#-ում | XLSB Միաձուլում"
head_description: "Միավորել մի քանի XLSB ֆայլ մեկ ֆայլի մեջ՝ օգտագործելով C# .NET փաստաթղթերի միաձուլման API-ն: Միավորել որոշակի էջեր կամ էջերի միջակայքեր՝ տարբեր փաստաթղթերից մինչև մեկ փաստաթուղթ:"

############################# Header ############################
title: "Միավորել XLSB ֆայլեր C#-ում"
description: "Միավորել XLSB-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Ինչպես միավորել բազմաթիվ XLSB ֆայլեր"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է .NET ծրագրավորողների համար համատեղել երկու կամ ավելի XLSB ֆայլեր իրենց հավելվածներում` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես միավորել XLSB ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Միավորել XLSB ֆայլեր՝ օգտագործելով GroupDocs.Merger API
