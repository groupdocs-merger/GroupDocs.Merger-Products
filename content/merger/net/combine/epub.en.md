...
############################# Head ############################
head_title: "Merge EPUB files in C# via .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge EPUB files."

############################# Header ############################
title: "Merge EPUB files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge EPUB documents."
...
steps:
    enable: true
    title: "Steps to merge EPUB files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge EPUB files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
      
      1. Set the path to the first EPUB file.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Create a Merger instance with the input EPUB document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge EPUB files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Combine documents"
          operation: "combine"
          link: "/search/net/combine/epub/"
          description: "Find information in documents using boolean conditions"

        # operation loop 2
        - name: "{common-content.operations.case-sensitive.name}"
          operation: "case-sensitive"
          link: "/search/net/case-sensitive/epub/"
          description: "{common-content.operations.case-sensitive.description}"

        # operation loop 3
        - name: "{common-content.operations.document.name}"
          operation: "document"
          link: "/search/net/document/epub/"
          description: "{common-content.operations.document.description}"

        # operation loop 4
        - name: "{common-content.operations.filters.name}"
          operation: "filters"
          link: "/search/net/filters/epub/"
          description: "{common-content.operations.filters.description}"

        # operation loop 5
        - name: "{common-content.operations.phrase.name}"
          operation: "phrase"
          link: "/search/net/phrase/epub/"
