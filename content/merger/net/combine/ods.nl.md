...
############################# Head ############################
head_title: "Combineer ODS Bestanden in C# | ODS Fusie"
head_description: "Combineer meerdere ODS bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer ODS bestanden in C#"
description: "Combineer ODS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere ODS bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer ODS-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODS bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer ODS bestanden met behulp van GroupDocs.Merger API
