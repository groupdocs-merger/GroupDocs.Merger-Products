...
############################# Head ############################
head_title: "Gabungkan TSV Fail dalam C# | TSV Penggabungan"
head_description: "Gabungkan berbilang fail TSV ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Gabungkan TSV Fail Dalam C#"
description: "Gabungkan TSV dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Berbilang TSV Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menggabungkan dua atau lebih TSV fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan TSV fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Gabungkan TSV fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu TSV fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
