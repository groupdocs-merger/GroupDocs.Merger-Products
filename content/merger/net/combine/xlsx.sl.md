...
############################# Head ############################
head_title: "Združi XLSX datoteke v C# | XLSX Združitev"
head_description: "Združite več datotek XLSX v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi XLSX datotek v C#"
description: "Kombinirajte XLSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek XLSX"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek XLSX znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSX s primerom kode C#">}}

        ```csharp    
        // Združite datoteke XLSX z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom XLSX
...
demos:
    ...
    content: |
       Takoj združite več kot eno XLSX datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
