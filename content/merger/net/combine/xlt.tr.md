...
############################# Head ############################
head_title: "XLT Dosyalarını C# İçinde Birleştirin | XLT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLT Dosyalarını C# İçinde Birleştirin"
description: "XLT kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLT Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLT dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLT dosyalarını birleştirin
