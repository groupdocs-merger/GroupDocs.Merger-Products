...
############################# Head ############################
head_title: "Kombinálja az PPT fájlokat a C# |-ben PPT Egyesülés"
head_description: "Kombináljon több PPT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PPT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PPT fájlt a GroupDocs.Merger API segítségével
