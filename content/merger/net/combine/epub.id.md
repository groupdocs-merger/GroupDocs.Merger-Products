...
############################# Head ############################
head_title: "Gabungkan EPUB File di C# | EPUB Penggabungan"
head_description: "Gabungkan beberapa file EPUB menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan EPUB File Di C#"
description: "Gabungkan EPUB dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File EPUB"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file EPUB menggunakan kode contoh C#">}}
        ...
        ```csharp    
        // Gabungkan file EPUB menggunakan GroupDocs.Merger API
