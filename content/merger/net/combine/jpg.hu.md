...
############################# Head ############################
head_title: "Kombinálja az JPG fájlokat a C# |-ben JPG Egyesülés"
head_description: "Kombináljon több JPG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "JPG fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) JPG elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több JPG fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk JPG fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon JPG fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több JPG fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
