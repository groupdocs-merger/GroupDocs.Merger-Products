...
############################# Head ############################
head_title: "Kombineerige ODT failid C# | ODT Ühinemine"
head_description: "Kombineerige mitu ODT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri ODT faili C#"
description: "Kombineerige ODT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut ODT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat ODT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida ODT faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige ODT faili GroupDocs.Merger API abil
