...
############################# Head ############################
head_title: "Comhcheangail VSDM Comhaid i C# | VSDM Cumasc"
head_description: "Comhcheangail comhaid VSDM iolracha i gcomhad amháin ag baint úsáide as C# .NET doiciméad cumaisc API. Comhcheangail leathanaigh nó raonta leathanach ar leith ó dhoiciméid éagsúla go doiciméad amháin."

############################# Header ############################
title: "Comhcheangail VSDM Comhaid i C#"
description: "Comhcheangail VSDM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Conas Ilchomhad VSDM a Chomhcheangail"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí .NET dhá cheann nó níos mó de chomhaid VSDM a chur le chéile laistigh dá bhfeidhmchlár trí a roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas VSDM comhad a chur le chéile trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Comhcheangail VSDM comhad le GroupDocs.Merger API
