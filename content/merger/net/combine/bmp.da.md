...
############################# Head ############################
head_title: "Kombiner BMP filer i C# | BMP Fusion"
head_description: "Kombiner flere BMP filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner BMP filer i C#"
description: "Kombiner BMP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere BMP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere BMP-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer BMP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner BMP filer ved hjælp af GroupDocs.Merger API
