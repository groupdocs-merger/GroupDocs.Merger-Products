...
############################# Head ############################
head_title: "Gabungkan VSX File di C# | VSX Penggabungan"
head_description: "Gabungkan beberapa file VSX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan VSX File Di C#"
description: "Gabungkan VSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File VSX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VSX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file VSX menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan VSX
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
