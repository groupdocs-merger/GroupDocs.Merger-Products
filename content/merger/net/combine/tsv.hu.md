...
############################# Head ############################
head_title: "Kombinálja az TSV fájlokat a C# |-ben TSV Egyesülés"
head_description: "Kombináljon több TSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "TSV fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) TSV elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több TSV fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk TSV fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon TSV fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több TSV fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
