...
############################# Head ############################
head_title: "Kombinálja az PPTX fájlokat a C# |-ben PPTX Egyesülés"
head_description: "Kombináljon több PPTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPTX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PPTX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPTX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPTX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PPTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több PPTX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
