...
############################# Head ############################
head_title: "Kombinálja az PPSX fájlokat a C# |-ben PPSX Egyesülés"
head_description: "Kombináljon több PPSX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPSX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PPSX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPSX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PPSX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PPSX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több PPSX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
