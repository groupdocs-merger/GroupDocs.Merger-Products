...
############################# Head ############################
head_title: "Kombinieren Sie XLSM-Dateien in C# | XLSM Fusion"
head_description: "Kombinieren Sie mehrere XLSM-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie XLSM-Dateien in C#"
description: "Kombinieren Sie XLSM mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere XLSM-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr XLSM-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie XLSM-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie XLSM-Dateien mit der GroupDocs.Merger-API
...
demos:
    ...
    content: |
       Kombinieren Sie jetzt mehr als eine XLSM-Datei, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) besuchen.
