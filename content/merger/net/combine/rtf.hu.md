...
############################# Head ############################
head_title: "Kombinálja az RTF fájlokat a C# |-ben RTF Egyesülés"
head_description: "Kombináljon több RTF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "RTF fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) RTF elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több RTF fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk RTF fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon RTF fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több RTF fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
