...
############################# Head ############################
head_title: "DOC Dosyalarını C# İçinde Birleştirin | DOC Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOC dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "DOC Dosyalarını C# İçinde Birleştirin"
description: "DOC kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok DOC Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak DOC dosyalarını birleştirin
