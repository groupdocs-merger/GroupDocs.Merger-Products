...
############################# Head ############################
head_title: "Συνδυάστε XLSX αρχεία στο C# | XLSX Συγχώνευση"
head_description: "Συνδυάστε πολλά αρχεία XLSX σε ένα μόνο αρχείο χρησιμοποιώντας το API συγχώνευσης εγγράφων C# .NET. Συνδυάστε συγκεκριμένες σελίδες ή σειρές σελίδων από διάφορα έγγραφα σε ένα μόνο έγγραφο."

############################# Header ############################
title: "Συνδυάστε XLSX αρχεία σε C#"
description: "Συνδυάστε το XLSX με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Πώς να συνδυάσετε πολλά αρχεία XLSX"
    content_left: |
        Το [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του .NET να συνδυάσουν δύο ή περισσότερα αρχεία XLSX στις εφαρμογές τους εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να συνδυάσετε αρχεία XLSX χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Συνδυάστε XLSX αρχεία χρησιμοποιώντας το GroupDocs.Merger API
...
demos:
    ...
    content: |
       Συνδυάστε περισσότερα από ένα XLSX αρχεία αυτήν τη στιγμή, μεταβαίνοντας στον ιστότοπο [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
