...
############################# Head ############################
head_title: "Kết hợp tập tin TIFF trong .NET"
head_description: "Tích hợp GroupDocs.Merger for .NET vào các dự án .NET của bạn để kết hợp TIFF một cách hiệu quả."

############################# Header ############################
title: "Kết hợp tập tin TIFF" 
description: "Sử dụng GroupDocs.Merger for .NET để xây dựng các ứng dụng .NET có khả năng kết hợp tài liệu TIFF một cách hiệu quả."
...
steps:
    enable: true
    title: "Các bước để kết hợp tập tin TIFF"
    content: |
      [GroupDocs.Merger](/merger/net/) cho phép bạn kết hợp các tập tin TIFF một cách hiệu quả. Tích hợp tính năng này vào các ứng dụng .NET của bạn để xử lý nhiều tài liệu như một tập tin duy nhất.
      
      1. Đặt đường dẫn đến tập tin TIFF đầu tiên.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Tạo một thể hiện Merger với tài liệu TIFF đầu vào
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Kết hợp các trang được chọn từ các tập tin ở định dạng khác nhau"
      content: |
        Ví dụ này minh họa cách kết hợp các tập tin TIFF trong khi tích hợp các trang đã chọn từ các định dạng khác.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
