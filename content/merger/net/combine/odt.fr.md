...
############################# Head ############################
head_title: "Combiner les fichiers ODT dans C# | ODT Fusion"
head_description: "Combinez plusieurs fichiers ODT en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Combinez des pages ou des plages de pages spécifiques de divers documents en un seul document."

############################# Header ############################
title: "Combinez ODT fichiers dans C#"
description: "Combinez ODT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment combiner plusieurs fichiers ODT"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de combiner facilement deux fichiers ODT ou plus dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers ODT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Combinez les fichiers ODT à l'aide de l'API GroupDocs.Merger
