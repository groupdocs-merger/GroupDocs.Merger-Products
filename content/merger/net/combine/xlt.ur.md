...
############################# Head ############################
head_title: "XLT فائلوں کو C# میں یکجا کریں۔ XLT انضمام"
head_description: "C# .NET دستاویزات کے انضمام API کا استعمال کرتے ہوئے متعدد XLT فائلوں کو ایک فائل میں یکجا کریں۔ مختلف دستاویزات سے کسی ایک دستاویز تک مخصوص صفحات یا صفحہ کی حدود کو یکجا کریں۔"

############################# Header ############################
title: "XLT فائلوں کو C# میں یکجا کریں"
description: "XLT کو .NET کوڈ کی چند سطروں کے ساتھ جوڑیں۔"
...
steps:
    enable: true
    title_left: "متعدد XLT فائلوں کو یکجا کرنے کا طریقہ"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) .NET ڈویلپرز کے لیے اپنی ایپلی کیشنز میں دو یا زیادہ XLT فائلوں کو اکٹھا کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے XLT فائلوں کو کیسے جوڑیں۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے XLT فائلوں کو یکجا کریں۔
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) ویب سائٹ پر جا کر ابھی ایک سے زیادہ XLT فائلوں کو یکجا کریں۔
