...
############################# Head ############################
head_title: "Kombinálja az XLTM fájlokat a C# |-ben XLTM Egyesülés"
head_description: "Kombináljon több XLTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLTM fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XLTM elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLTM fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLTM fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XLTM fájlt a GroupDocs.Merger API segítségével
