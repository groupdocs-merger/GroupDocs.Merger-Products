...
############################# Head ############################
head_title: "Kombinálja az JPEG fájlokat a C# |-ben JPEG Egyesülés"
head_description: "Kombináljon több JPEG fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "JPEG fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) JPEG elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több JPEG fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk JPEG fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon JPEG fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több JPEG fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
