...
############################# Header ############################
title: "Yhdistä XLSM tiedostoa C#"
description: "Yhdistä XLSM muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia XLSM-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
