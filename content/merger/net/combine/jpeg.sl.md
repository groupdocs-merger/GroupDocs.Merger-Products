...
############################# Head ############################
head_title: "Združi JPEG datoteke v C# | JPEG Združitev"
head_description: "Združite več datotek JPEG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi JPEG datotek v C#"
description: "Kombinirajte JPEG z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek JPEG"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek JPEG znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPEG s primerom kode C#">}}

        ```csharp    
        // Združite datoteke JPEG z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom JPEG
...
demos:
    ...
    content: |
       Takoj združite več kot eno JPEG datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
