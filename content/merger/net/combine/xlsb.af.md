...
############################# Head ############################
head_title: "Kombineer XLSB lêers in C# | XLSB samesmelting"
head_description: "Kombineer veelvuldige XLSB lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer XLSB lêers in C#"
description: "Kombineer XLSB met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige XLSB-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XLSB-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSB lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer XLSB lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer XLSB dokument
...
demos:
    ...
    content: |
       Kombineer meer as een XLSB lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
