...
############################# Head ############################
head_title: "اجمع ملفات TSV في C# | TSV الاندماج"
head_description: "ادمج عدة ملفات TSV في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات TSV في C#"
description: "ادمج TSV مع بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات TSV"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من TSV داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات TSV باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات TSV باستخدام GroupDocs.Merger API
