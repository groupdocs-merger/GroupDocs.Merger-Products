...
############################# Head ############################
head_title: "Kombineerige BMP failid C# | BMP Ühinemine"
head_description: "Kombineerige mitu BMP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri BMP faili C#"
description: "Kombineerige BMP mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut BMP faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat BMP faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida BMP faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige BMP faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga BMP
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks BMP faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
