...
############################# Head ############################
head_title: "Združi PNG datoteke v C# | PNG Združitev"
head_description: "Združite več datotek PNG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi PNG datotek v C#"
description: "Kombinirajte PNG z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek PNG znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke PNG s primerom kode C#">}}

        ```csharp    
        // Združite datoteke PNG z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom PNG
...
demos:
    ...
    content: |
       Takoj združite več kot eno PNG datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
