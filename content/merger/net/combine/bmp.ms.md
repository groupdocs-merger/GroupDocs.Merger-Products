...
############################# Head ############################
head_title: "Gabungkan BMP Fail dalam C# | BMP Penggabungan"
head_description: "Gabungkan berbilang fail BMP ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Gabungkan BMP Fail Dalam C#"
description: "Gabungkan BMP dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Berbilang BMP Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menggabungkan dua atau lebih BMP fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan BMP fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Gabungkan BMP fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu BMP fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
