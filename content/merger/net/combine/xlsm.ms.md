...
############################# Head ############################
head_title: "Gabungkan XLSM Fail dalam C# | XLSM Penggabungan"
head_description: "Gabungkan berbilang fail XLSM ke dalam satu fail menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau julat halaman tertentu daripada pelbagai dokumen kepada satu dokumen."

############################# Header ############################
title: "Gabungkan XLSM Fail Dalam C#"
description: "Gabungkan XLSM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Berbilang XLSM Fail"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun .NET untuk menggabungkan dua atau lebih XLSM fail dalam aplikasi mereka dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Bagaimana untuk menggabungkan XLSM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Gabungkan XLSM fail menggunakan API GroupDocs.Merger
...
demos:
    ...
    content: |
       Gabungkan lebih daripada satu XLSM fail sekarang dengan melawati tapak web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
