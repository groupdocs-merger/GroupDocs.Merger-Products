...
############################# Head ############################
head_title: "Kombiner VSTX filer i C# | VSTX Fusion"
head_description: "Kombiner flere VSTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner VSTX filer i C#"
description: "Kombiner VSTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere VSTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere VSTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer VSTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner VSTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombiner mere end én VSTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
