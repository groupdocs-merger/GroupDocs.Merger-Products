...
############################# Head ############################
head_title: "Kombinera MHT-filer i C# | MHT Sammanslagning"
head_description: "Kombinera flera MHT-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera MHT filer i C#"
description: "Kombinera MHT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera MHT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera MHT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar MHT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera MHT filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet MHT
...
demos:
    ...
    content: |
       Kombinera mer än en MHT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
