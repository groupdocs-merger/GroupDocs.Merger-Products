...
############################# Head ############################
head_title: "TEX Dosyalarını C# İçinde Birleştirin | TEX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla TEX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "TEX Dosyalarını C# İçinde Birleştirin"
description: "TEX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok TEX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TEX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak TEX dosyalarını birleştirin
