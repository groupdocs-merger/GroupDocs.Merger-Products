...
############################# Head ############################
head_title: "Združi XLSM datoteke v C# | XLSM Združitev"
head_description: "Združite več datotek XLSM v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi XLSM datotek v C#"
description: "Kombinirajte XLSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek XLSM"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek XLSM znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke XLSM s primerom kode C#">}}

        ```csharp    
        // Združite datoteke XLSM z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom XLSM
...
demos:
    ...
    content: |
       Takoj združite več kot eno XLSM datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
