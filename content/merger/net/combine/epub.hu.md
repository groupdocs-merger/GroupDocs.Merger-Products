...
############################# Head ############################
head_title: "Kombinálja az EPUB fájlokat a C# |-ben EPUB Egyesülés"
head_description: "Kombináljon több EPUB fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "EPUB fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) EPUB elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több EPUB fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk EPUB fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon EPUB fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több EPUB fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
