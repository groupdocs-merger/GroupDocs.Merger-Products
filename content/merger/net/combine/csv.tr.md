...
############################# Head ############################
head_title: "CSV Dosyalarını C# İçinde Birleştirin | CSV Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla CSV dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "CSV Dosyalarını C# İçinde Birleştirin"
description: "CSV kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok CSV Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak CSV dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak CSV dosyalarını birleştirin
