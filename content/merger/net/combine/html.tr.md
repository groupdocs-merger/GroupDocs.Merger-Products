...
############################# Head ############################
head_title: "HTML Dosyalarını C# İçinde Birleştirin | HTML Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla HTML dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "HTML Dosyalarını C# İçinde Birleştirin"
description: "HTML kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok HTML Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak HTML dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak HTML dosyalarını birleştirin
