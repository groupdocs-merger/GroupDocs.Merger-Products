...
############################# Head ############################
head_title: "Kombiner XLTM filer i C# | XLTM Fusion"
head_description: "Kombiner flere XLTM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Kombiner specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "Kombiner XLTM filer i C#"
description: "Kombiner XLTM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan kombinerer du flere XLTM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at kombinere to eller flere XLTM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan man kombinerer XLTM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Kombiner XLTM filer ved hjælp af GroupDocs.Merger API
