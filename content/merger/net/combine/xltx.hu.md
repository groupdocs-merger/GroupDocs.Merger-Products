...
############################# Head ############################
head_title: "Kombinálja az XLTX fájlokat a C# |-ben XLTX Egyesülés"
head_description: "Kombináljon több XLTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLTX fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XLTX elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLTX fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLTX fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XLTX fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több XLTX fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
