...
############################# Head ############################
head_title: "Объединить TSV файлы на C# | TSV Объединение"
head_description: "Объедините несколько файлов TSV в один файл с помощью C# .NET API объединения документов. Объединяйте определенные страницы или диапазоны страниц из разных документов в один документ."

############################# Header ############################
title: "Объединить TSV на C#"
description: "Объедините TSV с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Как объединить несколько файлов TSV"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) упрощает для разработчиков .NET объединение двух или более TSV файлов в своих приложениях путем реализации несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как объединить файлы TSV, используя пример кода C#">}}

        ```csharp    
        // Объедините TSV файлов с помощью GroupDocs.Merger API
