...
############################# Head ############################
head_title: "Kombineerige TXT failid C# | TXT Ühinemine"
head_description: "Kombineerige mitu TXT faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri TXT faili C#"
description: "Kombineerige TXT mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut TXT faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat TXT faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida TXT faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige TXT faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga TXT
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks TXT faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
