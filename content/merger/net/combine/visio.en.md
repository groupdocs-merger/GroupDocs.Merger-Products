...
############################# Head ############################
head_title: "Merge VISIO files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge VISIO files."

############################# Header ############################
title: "Merge VISIO files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge VISIO documents."
...
steps:
    enable: true
    title: "Steps to merge VISIO files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge VISIO files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
      
      1. Set the path to the first VISIO file.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Create a Merger instance with the input VISIO document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge VISIO files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
