...
############################# Head ############################
head_title: "Združi BMP datoteke v C# | BMP Združitev"
head_description: "Združite več datotek BMP v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi BMP datotek v C#"
description: "Kombinirajte BMP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek BMP"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek BMP znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke BMP s primerom kode C#">}}

        ```csharp    
        // Združite datoteke BMP z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom BMP
...
demos:
    ...
    content: |
       Takoj združite več kot eno BMP datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
