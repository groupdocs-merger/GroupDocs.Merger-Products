...
############################# Head ############################
head_title: "Combine DOCM Arquivos em C# | DOCM Fusão"
head_description: "Combine vários arquivos DOCM em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine DOCM Arquivos em C#"
description: "Combine DOCM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos DOCM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos DOCM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos DOCM usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos DOCM usando a API GroupDocs.Merger
