...
############################# Head ############################
head_title: "Kombineer JPG lêers in C# | JPG samesmelting"
head_description: "Kombineer veelvuldige JPG lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer JPG lêers in C#"
description: "Kombineer JPG met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige JPG-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer JPG-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om JPG lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer JPG lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer JPG dokument
...
demos:
    ...
    content: |
       Kombineer meer as een JPG lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
