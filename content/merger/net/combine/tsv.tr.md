...
############################# Head ############################
head_title: "TSV Dosyalarını C# İçinde Birleştirin | TSV Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla TSV dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "TSV Dosyalarını C# İçinde Birleştirin"
description: "TSV kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok TSV Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TSV dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak TSV dosyalarını birleştirin
