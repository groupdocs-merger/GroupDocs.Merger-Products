...
############################# Head ############################
head_title: "Combineer BMP Bestanden in C# | BMP Fusie"
head_description: "Combineer meerdere BMP bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer BMP bestanden in C#"
description: "Combineer BMP met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere BMP bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer BMP-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe BMP bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer BMP bestanden met behulp van GroupDocs.Merger API
