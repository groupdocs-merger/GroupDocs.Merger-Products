...
############################# Head ############################
head_title: "Combineer VSSX Bestanden in C# | VSSX Fusie"
head_description: "Combineer meerdere VSSX bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer VSSX bestanden in C#"
description: "Combineer VSSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere VSSX bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSSX-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSX bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer VSSX bestanden met behulp van GroupDocs.Merger API
