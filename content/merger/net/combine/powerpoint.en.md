...
############################# Head ############################
head_title: "Merge POWERPOINT files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge POWERPOINT files."

############################# Header ############################
title: "Merge POWERPOINT files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge POWERPOINT documents."
...
steps:
    enable: true
    title: "Steps to merge POWERPOINT files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge POWERPOINT files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge POWERPOINT files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
