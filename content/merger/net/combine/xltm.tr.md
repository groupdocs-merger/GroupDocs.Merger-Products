...
############################# Head ############################
head_title: "XLTM Dosyalarını C# İçinde Birleştirin | XLTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLTM Dosyalarını C# İçinde Birleştirin"
description: "XLTM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLTM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLTM dosyalarını birleştirin
