...
############################# Head ############################
head_title: "Combine ODS Arquivos em C# | ODS Fusão"
head_description: "Combine vários arquivos ODS em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine ODS Arquivos em C#"
description: "Combine ODS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos ODS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos ODS usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos ODS usando a API GroupDocs.Merger
