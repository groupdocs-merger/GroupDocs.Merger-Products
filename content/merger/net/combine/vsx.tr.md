...
############################# Head ############################
head_title: "VSX Dosyalarını C# İçinde Birleştirin | VSX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSX Dosyalarını C# İçinde Birleştirin"
description: "VSX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSX dosyalarını birleştirin
