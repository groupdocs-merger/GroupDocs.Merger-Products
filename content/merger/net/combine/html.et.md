...
############################# Head ############################
head_title: "Kombineerige HTML failid C# | HTML Ühinemine"
head_description: "Kombineerige mitu HTML faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri HTML faili C#"
description: "Kombineerige HTML mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut HTML faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat HTML faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida HTML faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige HTML faili GroupDocs.Merger API abil
