...
############################# Head ############################
head_title: "Комбинирайте XLS файлове в C# | XLS Сливане"
head_description: "Комбинирайте множество XLS файлове в един файл, като използвате API за сливане на документи C# .NET. Комбинирайте конкретни страници или диапазони от страници от различни документи в един документ."

############################# Header ############################
title: "Комбинирайте XLS файлове в C#"
description: "Комбинирайте XLS с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Как да комбинирате множество XLS файлове"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да комбинират два или повече XLS файла в своите приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате XLS файлове с помощта на C# примерен код">}}

        ```csharp    
        // Комбинирайте XLS файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Комбинирайте повече от един XLS файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
