...
############################# Head ############################
head_title: "XLAM Dosyalarını C# İçinde Birleştirin | XLAM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLAM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLAM Dosyalarını C# İçinde Birleştirin"
description: "XLAM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLAM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLAM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLAM dosyalarını birleştirin
