...
############################# Head ############################
head_title: "Kombineer XLS lêers in C# | XLS samesmelting"
head_description: "Kombineer veelvuldige XLS lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer XLS lêers in C#"
description: "Kombineer XLS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige XLS-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer XLS-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLS lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer XLS lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer XLS dokument
...
demos:
    ...
    content: |
       Kombineer meer as een XLS lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
