...
############################# Head ############################
head_title: "PPTX Dosyalarını C# İçinde Birleştirin | PPTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PPTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "PPTX Dosyalarını C# İçinde Birleştirin"
description: "PPTX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok PPTX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak PPTX dosyalarını birleştirin
