...
############################# Head ############################
head_title: "Yhdistä VSDM tiedostot C# | VSDM Sulautuminen"
...
############################# Header ############################
title: "Yhdistä VSDM tiedostoa C#"
description: "Yhdistä VSDM muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia VSDM-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää VSDM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä VSDM tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi VSDM tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
