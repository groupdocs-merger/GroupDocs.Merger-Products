...
############################# Head ############################
head_title: "Merge XLSX files in C# via .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge XLSX files."

############################# Header ############################
title: "Merge XLSX files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge XLSX documents."
...
steps:
    enable: true
    title: "Steps to merge XLSX files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge XLSX files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
      
      1. Set the path to the first XLSX file.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Create a Merger instance with the input XLSX document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge XLSX files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
