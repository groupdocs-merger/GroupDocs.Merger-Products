...
############################# Head ############################
head_title: "RTF Dosyalarını C# İçinde Birleştirin | RTF Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla RTF dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "RTF Dosyalarını C# İçinde Birleştirin"
description: "RTF kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok RTF Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak RTF dosyalarını birleştirin
