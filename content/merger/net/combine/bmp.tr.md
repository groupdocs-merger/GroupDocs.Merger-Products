...
############################# Head ############################
head_title: "BMP Dosyalarını C# İçinde Birleştirin | BMP Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla BMP dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "BMP Dosyalarını C# İçinde Birleştirin"
description: "BMP kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok BMP Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak BMP dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak BMP dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla BMP dosyayı birleştirin.
