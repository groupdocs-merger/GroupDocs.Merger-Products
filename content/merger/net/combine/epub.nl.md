...
############################# Head ############################
head_title: "Combineer EPUB Bestanden in C# | EPUB Fusie"
head_description: "Combineer meerdere EPUB bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer EPUB bestanden in C#"
description: "Combineer EPUB met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere EPUB bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer EPUB-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer EPUB bestanden met behulp van GroupDocs.Merger API
