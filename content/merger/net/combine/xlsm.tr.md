...
############################# Head ############################
head_title: "XLSM Dosyalarını C# İçinde Birleştirin | XLSM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLSM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLSM Dosyalarını C# İçinde Birleştirin"
description: "XLSM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLSM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLSM dosyalarını birleştirin
