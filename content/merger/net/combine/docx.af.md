...
############################# Head ############################
head_title: "Kombineer DOCX lêers in C# | DOCX samesmelting"
head_description: "Kombineer veelvuldige DOCX lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer DOCX lêers in C#"
description: "Kombineer DOCX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige DOCX-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer DOCX-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCX lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer DOCX lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Kombineer meer as een DOCX lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
