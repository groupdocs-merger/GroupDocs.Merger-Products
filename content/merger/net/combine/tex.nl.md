...
############################# Head ############################
head_title: "Combineer TEX Bestanden in C# | TEX Fusie"
head_description: "Combineer meerdere TEX bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer TEX bestanden in C#"
description: "Combineer TEX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere TEX bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer TEX-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TEX bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer TEX bestanden met behulp van GroupDocs.Merger API
