...
############################# Head ############################
head_title: "在 C# 中合并 PPTX 个文件 | PPTX 合并"
head_description: "使用 C# .NET 文档合并 API 将多个 PPTX 文件合并为一个文件。将不同文档中的特定页面或页面范围合并为单个文档。"

############################# Header ############################
title: "在 C# 中合并 PPTX 个文件"
description: "将 PPTX 与几行 .NET 代码结合起来。"
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 提供了一个方便的解决方案来组合多个 PDF、Microsoft Office（Word、Excel、PowerPoint、OneNote）、OpenDocument、HTML、图像和在 .NET 应用程序中将许多其他文档合并到一个文件中。 GroupDocs.Merger 将为您节省大量精力，因为您可以合并 PPTX 文档 - 无需安装任何第三方软件、桌面应用程序或插件。现在不必浪费时间手动合并文件了！ GroupDocs 的使命是提供最佳质量并简化文档处理工作流程。
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码组合 PPTX 文件">}}

        ```csharp    
        // 使用 GroupDocs.Merger API 合并 PPTX 文件
        // 使用输入 PPTX 文档实例化合并
