...
############################# Head ############################
head_title: "BMP файлдарды C# ішінде біріктіру | BMP Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше BMP файлдарды бір файлға біріктіріңіз. Әртүрлі құжаттардан бір құжатқа дейін арнайы беттерді немесе бет ауқымдарын біріктіріңіз."

############################# Header ############################
title: "BMP файлды C# ішінде біріктіру"
description: "BMP .NET кодының бірнеше жолымен біріктіріңіз."
...
steps:
    enable: true
    title_left: "Бірнеше BMP файлдарды біріктіру жолы"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп BMP файлдарды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="BMP файлдарды C# мысал кодын пайдаланып біріктіру жолы">}}

        ```csharp    
        // GroupDocs.Merger API арқылы BMP файлдарды біріктіріңіз
