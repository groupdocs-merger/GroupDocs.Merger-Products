...
############################# Head ############################
head_title: "Kombinera TXT-filer i C# | TXT Sammanslagning"
head_description: "Kombinera flera TXT-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera TXT filer i C#"
description: "Kombinera TXT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera TXT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera TXT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar TXT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera TXT filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet TXT
...
demos:
    ...
    content: |
       Kombinera mer än en TXT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
