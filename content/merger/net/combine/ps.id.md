...
head_title: "Gabungkan File PS di C# | PS Penggabungan"
head_description: "Gabungkan beberapa file PS menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabungkan File PS Di C#"
description: "Gabungkan beberapa file PS menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber menjadi satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File PS"
    content_left: |
    ...
    code: |
        ```cs
        // Gabungkan file PS menggunakan GroupDocs.Merger API
...
demos:
    ...
    content: |
        Gabungkan lebih dari satu file PS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/merger/family).  
