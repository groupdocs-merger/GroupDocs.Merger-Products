...
############################# Head ############################
head_title: "DOT ፋይሎችን በC# | ያጣምሩ DOT ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ DOT ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች እስከ አንድ ሰነድ ያጣምሩ።"

############################# Header ############################
title: "DOT ፋይሎችን በC# ውስጥ ያጣምሩ"
description: "DOTን ከጥቂት የ.NET ኮድ መስመሮች ጋር ያጣምሩ።"
...
steps:
    enable: true
    title_left: "በርካታ DOT ፋይሎችን እንዴት ማጣመር እንደሚቻል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች ሁለት ወይም ከዚያ በላይ DOT ፋይሎችን በመተግበር በመተግበሪያዎቻቸው ውስጥ ማጣመር ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም DOT ፋይሎችን እንዴት ማጣመር እንደሚቻል">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም DOT ፋይሎችን ያጣምሩ
...
demos:
    ...
    content: |
       የ[GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ DOT ፋይሎችን ያጣምሩ።
