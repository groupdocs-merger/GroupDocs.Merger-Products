...
############################# Head ############################
head_title: "Kombineer JPEG lêers in C# | JPEG samesmelting"
head_description: "Kombineer veelvuldige JPEG lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer JPEG lêers in C#"
description: "Kombineer JPEG met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige JPEG-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer JPEG-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om JPEG lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer JPEG lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer JPEG dokument
...
demos:
    ...
    content: |
       Kombineer meer as een JPEG lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
