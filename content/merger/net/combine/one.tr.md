...
############################# Head ############################
head_title: "ONE Dosyalarını C# İçinde Birleştirin | ONE Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla ONE dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "ONE Dosyalarını C# İçinde Birleştirin"
description: "ONE kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok ONE Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak ONE dosyalarını birleştirin
...
demos:
    ...
    content: |
       Şu anda [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) web sitesini ziyaret ederek birden fazla ONE dosyayı birleştirin.
