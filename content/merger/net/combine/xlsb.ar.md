...
############################# Head ############################
head_title: "اجمع ملفات XLSB في C# | XLSB الاندماج"
head_description: "ادمج عدة ملفات XLSB في ملف واحد باستخدام C# .NET لدمج المستندات API. ادمج صفحات معينة أو نطاقات صفحات من مستندات مختلفة إلى مستند واحد."

############################# Header ############################
title: "دمج ملفات XLSB في C#"
description: "ادمج XLSB مع بضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "كيفية دمج عدة ملفات XLSB"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري .NET دمج ملفين أو أكثر من XLSB داخل تطبيقاتهم من خلال تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية دمج ملفات XLSB باستخدام كود مثال C#">}}

        ```csharp    
        // دمج ملفات XLSB باستخدام GroupDocs.Merger API
