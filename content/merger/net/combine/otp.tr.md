...
############################# Head ############################
head_title: "OTP Dosyalarını C# İçinde Birleştirin | OTP Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla OTP dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "OTP Dosyalarını C# İçinde Birleştirin"
description: "OTP kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok OTP Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTP dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak OTP dosyalarını birleştirin
