...
############################# Head ############################
head_title: "Combine PPTX Arquivos em C# | PPTX Fusão"
head_description: "Combine vários arquivos PPTX em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine PPTX Arquivos em C#"
description: "Combine PPTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos PPTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos PPTX usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos PPTX usando a API GroupDocs.Merger
