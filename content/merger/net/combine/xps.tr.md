...
############################# Head ############################
head_title: "XPS Dosyalarını C# İçinde Birleştirin | XPS Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XPS dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XPS Dosyalarını C# İçinde Birleştirin"
description: "XPS kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XPS Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XPS dosyalarını birleştirin
