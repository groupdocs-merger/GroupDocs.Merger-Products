...
############################# Head ############################
head_title: "Combineer DOTM Bestanden in C# | DOTM Fusie"
head_description: "Combineer meerdere DOTM bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer DOTM bestanden in C#"
description: "Combineer DOTM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOTM bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOTM-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTM bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer DOTM bestanden met behulp van GroupDocs.Merger API
