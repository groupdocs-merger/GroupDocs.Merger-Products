...
############################# Head ############################
head_title: "Kombinera JPG-filer i C# | JPG Sammanslagning"
head_description: "Kombinera flera JPG-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera JPG filer i C#"
description: "Kombinera JPG med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera JPG-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera JPG-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar JPG-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera JPG filer med GroupDocs.Merger API
