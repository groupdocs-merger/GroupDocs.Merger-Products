...
############################# Head ############################
head_title: "Combineer ODP Bestanden in C# | ODP Fusie"
head_description: "Combineer meerdere ODP bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer ODP bestanden in C#"
description: "Combineer ODP met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere ODP bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer ODP-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODP bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer ODP bestanden met behulp van GroupDocs.Merger API
