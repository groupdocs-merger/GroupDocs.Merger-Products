...
############################# Head ############################
head_title: "Kombinera ODP-filer i C# | ODP Sammanslagning"
head_description: "Kombinera flera ODP-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera ODP filer i C#"
description: "Kombinera ODP med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera ODP-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera ODP-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar ODP-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera ODP filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet ODP
...
demos:
    ...
    content: |
       Kombinera mer än en ODP-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
