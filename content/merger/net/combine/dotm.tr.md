...
############################# Head ############################
head_title: "DOTM Dosyalarını C# İçinde Birleştirin | DOTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla DOTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "DOTM Dosyalarını C# İçinde Birleştirin"
description: "DOTM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok DOTM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak DOTM dosyalarını birleştirin
