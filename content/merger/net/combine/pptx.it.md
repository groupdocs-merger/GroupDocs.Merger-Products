...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono efficientemente documenti PPTX."
...
steps:
    enable: true
    title: "Passi per unire file PPTX"
    content: |
