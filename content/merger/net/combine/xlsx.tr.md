...
############################# Head ############################
head_title: "XLSX Dosyalarını C# İçinde Birleştirin | XLSX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla XLSX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "XLSX Dosyalarını C# İçinde Birleştirin"
description: "XLSX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok XLSX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak XLSX dosyalarını birleştirin
