...
############################# Head ############################
head_title: "Kombinera VSSM-filer i C# | VSSM Sammanslagning"
head_description: "Kombinera flera VSSM-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera VSSM filer i C#"
description: "Kombinera VSSM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera VSSM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera VSSM-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VSSM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera VSSM filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet VSSM
...
demos:
    ...
    content: |
       Kombinera mer än en VSSM-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
