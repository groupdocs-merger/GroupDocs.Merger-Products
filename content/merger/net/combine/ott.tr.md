...
############################# Head ############################
head_title: "OTT Dosyalarını C# İçinde Birleştirin | OTT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla OTT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "OTT Dosyalarını C# İçinde Birleştirin"
description: "OTT kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok OTT Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak OTT dosyalarını birleştirin
