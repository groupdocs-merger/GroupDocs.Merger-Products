...
############################# Head ############################
head_title: "Combineer MHTML Bestanden in C# | MHTML Fusie"
head_description: "Combineer meerdere MHTML bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer MHTML bestanden in C#"
description: "Combineer MHTML met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere MHTML bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer MHTML-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHTML bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer MHTML bestanden met behulp van GroupDocs.Merger API
