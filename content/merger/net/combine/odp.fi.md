...
############################# Head ############################
head_title: "Yhdistä ODP tiedostot C# | ODP Sulautuminen"
...
############################# Header ############################
title: "Yhdistä ODP tiedostoa C#"
description: "Yhdistä ODP muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia ODP-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää ODP tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä ODP tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi ODP tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
