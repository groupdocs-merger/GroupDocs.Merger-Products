...
############################# Head ############################
head_title: "Combine DOCX Arquivos em C# | DOCX Fusão"
head_description: "Combine vários arquivos DOCX em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine DOCX Arquivos em C#"
description: "Combine DOCX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos DOCX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos DOCX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos DOCX usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos DOCX usando a API GroupDocs.Merger
