...
############################# Head ############################
head_title: "Kombineer OTT lêers in C# | OTT samesmelting"
head_description: "Kombineer veelvuldige OTT lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer OTT lêers in C#"
description: "Kombineer OTT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige OTT-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer OTT-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTT lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer OTT lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Kombineer meer as een OTT lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
