...
############################# Head ############################
head_title: "VSTM Dosyalarını C# İçinde Birleştirin | VSTM Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSTM dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSTM Dosyalarını C# İçinde Birleştirin"
description: "VSTM kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSTM Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSTM dosyalarını birleştirin
