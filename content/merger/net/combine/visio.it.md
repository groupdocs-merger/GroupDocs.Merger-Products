...
description: "Utilizza GroupDocs.Merger for .NET per costruire applicazioni .NET che uniscono efficientemente documenti VISIO."
...
steps:
    enable: true
    title: "Passi per unire file VISIO"
    content: |
