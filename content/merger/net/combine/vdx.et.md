...
############################# Head ############################
head_title: "Kombineerige VDX failid C# | VDX Ühinemine"
head_description: "Kombineerige mitu VDX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri VDX faili C#"
description: "Kombineerige VDX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut VDX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat VDX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VDX faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige VDX faili GroupDocs.Merger API abil
        // Ühinemise käivitamine sisenddokumendiga VDX
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks VDX faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
