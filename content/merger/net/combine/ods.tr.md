...
############################# Head ############################
head_title: "ODS Dosyalarını C# İçinde Birleştirin | ODS Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla ODS dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "ODS Dosyalarını C# İçinde Birleştirin"
description: "ODS kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok ODS Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODS dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak ODS dosyalarını birleştirin
