...
############################# Head ############################
head_title: "Комбинирайте OTT файлове в C# | OTT Сливане"
head_description: "Комбинирайте множество OTT файлове в един файл, като използвате API за сливане на документи C# .NET. Комбинирайте конкретни страници или диапазони от страници от различни документи в един документ."

############################# Header ############################
title: "Комбинирайте OTT файлове в C#"
description: "Комбинирайте OTT с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Как да комбинирате множество OTT файлове"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на .NET да комбинират два или повече OTT файла в своите приложения чрез внедряване на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да комбинирате OTT файлове с помощта на C# примерен код">}}

        ```csharp    
        // Комбинирайте OTT файлове с помощта на GroupDocs.Merger API
...
demos:
    ...
    content: |
       Комбинирайте повече от един OTT файл точно сега, като посетите уебсайта [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
