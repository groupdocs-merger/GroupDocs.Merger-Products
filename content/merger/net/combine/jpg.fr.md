...
############################# Head ############################
head_title: "Combiner les fichiers JPG dans C# | JPG Fusion"
head_description: "Combinez plusieurs fichiers JPG en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Combinez des pages ou des plages de pages spécifiques de divers documents en un seul document."

############################# Header ############################
title: "Combinez JPG fichiers dans C#"
description: "Combinez JPG avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment combiner plusieurs fichiers JPG"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de combiner facilement deux fichiers JPG ou plus dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers JPG à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Combinez les fichiers JPG à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée JPG
...
demos:
    ...
    content: |
       Combinez plusieurs fichiers JPG dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
