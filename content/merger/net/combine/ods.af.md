...
############################# Head ############################
head_title: "Kombineer ODS lêers in C# | ODS samesmelting"
head_description: "Kombineer veelvuldige ODS lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer ODS lêers in C#"
description: "Kombineer ODS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige ODS-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer ODS-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODS lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer ODS lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Kombineer meer as een ODS lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
