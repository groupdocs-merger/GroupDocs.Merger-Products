...
############################# Head ############################
head_title: "Kombinieren Sie BMP-Dateien in C# | BMP Fusion"
head_description: "Kombinieren Sie mehrere BMP-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie BMP-Dateien in C#"
description: "Kombinieren Sie BMP mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere BMP-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr BMP-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie BMP-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie BMP-Dateien mit der GroupDocs.Merger-API
...
demos:
    ...
    content: |
       Kombinieren Sie jetzt mehr als eine BMP-Datei, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) besuchen.
