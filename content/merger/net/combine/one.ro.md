...
############################# Head ############################
head_title: "Combinați fișierele ONE în C# | ONE Fuziune"
head_description: "Combinați mai multe fișiere ONE într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Combinați anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "Combinați fișiere ONE în C#"
description: "Combinați ONE cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să combinați mai multe fișiere ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să combine două sau mai multe fișiere ONE în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să combinați fișiere ONE folosind codul exemplu C#">}}

        ```csharp    
        // Combinați fișiere ONE utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Combinați mai mult de un fișier ONE chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
