...
############################# Head ############################
head_title: "Združi CSV datoteke v C# | CSV Združitev"
head_description: "Združite več datotek CSV v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi CSV datotek v C#"
description: "Kombinirajte CSV z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek CSV znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke CSV s primerom kode C#">}}

        ```csharp    
        // Združite datoteke CSV z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom CSV
...
demos:
    ...
    content: |
       Takoj združite več kot eno CSV datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
