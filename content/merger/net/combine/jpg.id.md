...
############################# Head ############################
head_title: "Gabungkan JPG File di C# | JPG Penggabungan"
head_description: "Gabungkan beberapa file JPG menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan JPG File Di C#"
description: "Gabungkan JPG dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File JPG"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file JPG dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file JPG menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file JPG menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan JPG
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu JPG file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
