...
############################# Head ############################
head_title: "Kombineer VTX lêers in C# | VTX samesmelting"
head_description: "Kombineer veelvuldige VTX lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer VTX lêers in C#"
description: "Kombineer VTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige VTX-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer VTX-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer VTX lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer VTX dokument
...
demos:
    ...
    content: |
       Kombineer meer as een VTX lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
