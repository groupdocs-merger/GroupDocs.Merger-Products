...
############################# Head ############################
head_title: "Kết hợp VSSM Tệp trong C# | Hợp nhất VSSM"
head_description: "Kết hợp nhiều tệp VSSM thành một tệp duy nhất bằng cách sử dụng API hợp nhất tài liệu C# .NET. Kết hợp các trang hoặc phạm vi trang cụ thể từ các tài liệu khác nhau vào một tài liệu duy nhất."

############################# Header ############################
title: "Kết hợp VSSM Tệp trong C#"
description: "Kết hợp VSSM với một vài dòng mã .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) cung cấp một giải pháp thuận tiện để kết hợp nhiều tệp PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, hình ảnh và nhiều tài liệu khác thành một tệp duy nhất trong các ứng dụng .NET. GroupDocs.Merger sẽ giúp bạn tiết kiệm rất nhiều công sức, vì bạn được phép kết hợp các tài liệu VSSM - không cần cài đặt bất kỳ phần mềm, ứng dụng máy tính để bàn hoặc plugin nào của bên thứ ba. Bây giờ không cần thiết phải lãng phí thời gian của bạn và kết hợp các tệp theo cách thủ công! Sứ mệnh của GroupDocs là cung cấp chất lượng tốt nhất và đơn giản hóa quy trình xử lý tài liệu.
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách kết hợp các tệp VSSM bằng mã mẫu C#">}}

        ```csharp    
        // Kết hợp các tệp VSSM bằng API GroupDocs.Merger
