...
############################# Head ############################
head_title: "Kombinálja az XLAM fájlokat a C# |-ben XLAM Egyesülés"
head_description: "Kombináljon több XLAM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLAM fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) XLAM elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLAM fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk XLAM fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon XLAM fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több XLAM fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
