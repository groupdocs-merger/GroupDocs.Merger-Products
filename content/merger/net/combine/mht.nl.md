...
############################# Head ############################
head_title: "Combineer MHT Bestanden in C# | MHT Fusie"
head_description: "Combineer meerdere MHT bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer MHT bestanden in C#"
description: "Combineer MHT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere MHT bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer MHT-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHT bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer MHT bestanden met behulp van GroupDocs.Merger API
