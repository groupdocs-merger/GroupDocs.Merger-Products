...
############################# Head ############################
head_title: "Gabungkan VSSX File di C# | VSSX Penggabungan"
head_description: "Gabungkan beberapa file VSSX menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan VSSX File Di C#"
description: "Gabungkan VSSX dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File VSSX"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file VSSX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file VSSX menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file VSSX menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan VSSX
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSSX file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
