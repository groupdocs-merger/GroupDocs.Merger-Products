...
############################# Head ############################
head_title: "C#에서 DOTM 파일 결합 | DOTM 합병"
head_description: "C# .NET 문서 병합 API를 사용하여 여러 DOTM 파일을 단일 파일로 결합합니다. 다양한 문서의 특정 페이지 또는 페이지 범위를 단일 문서로 결합합니다."

############################# Header ############################
title: "C#에서 DOTM 파일 결합"
description: "몇 줄의 .NET 코드와 DOTM를 결합합니다."
...
steps:
    enable: true
    title_left: "여러 DOTM 파일을 결합하는 방법"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 DOTM 파일을 결합하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 DOTM 파일 결합
