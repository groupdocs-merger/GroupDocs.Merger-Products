...
############################# Head ############################
head_title: "Zkombinujte OTT soubory v C# | OTT Fúze"
head_description: "Zkombinujte více souborů OTT do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Kombinujte konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "Kombinovat OTT soubory v C#"
description: "Zkombinujte OTT s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak zkombinovat více souborů OTT"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET kombinovat dva nebo více souborů OTT v jejich aplikacích implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory OTT pomocí ukázkového kódu C#">}}

        ```csharp    
        // Zkombinujte OTT soubory pomocí GroupDocs.Merger API
