...
############################# Head ############################
head_title: "Kombinera XPS-filer i C# | XPS Sammanslagning"
head_description: "Kombinera flera XPS-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera XPS filer i C#"
description: "Kombinera XPS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera XPS-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera XPS-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar XPS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera XPS filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en XPS-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
