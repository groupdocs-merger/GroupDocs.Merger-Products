...
############################# Head ############################
head_title: "Combina fitxers ODT a C# | ODT Fusió"
head_description: "Combina diversos fitxers ODT en un sol fitxer mitjançant l'API de fusió de documents de C# .NET. Combina pàgines específiques o intervals de pàgines des de diversos documents fins a un sol document."

############################# Header ############################
title: "Combina ODT fitxers a C#"
description: "Combina ODT amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Com combinar diversos fitxers ODT"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET combinen dos o més fitxers ODT dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers ODT utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Combina fitxers ODT mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combineu més d'un fitxer ODT ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
