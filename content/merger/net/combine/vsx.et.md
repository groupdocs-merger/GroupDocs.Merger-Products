...
############################# Head ############################
head_title: "Kombineerige VSX failid C# | VSX Ühinemine"
head_description: "Kombineerige mitu VSX faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Kombineerige konkreetsed leheküljed või leheküljevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "Kombineeri VSX faili C#"
description: "Kombineerige VSX mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas kombineerida mitut VSX faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti kombineerida oma rakendustes kahte või enamat VSX faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas kombineerida VSX faile, kasutades C# näitekoodi">}}

        ```csharp    
        // Kombineerige VSX faili GroupDocs.Merger API abil
...
demos:
    ...
    content: |
       Kombineerige kohe rohkem kui üks VSX faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
