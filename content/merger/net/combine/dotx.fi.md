...
############################# Header ############################
title: "Yhdistä DOTX tiedostoa C#"
description: "Yhdistä DOTX muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia DOTX-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
