...
############################# Head ############################
head_title: "Combine VSSM Arquivos em C# | VSSM Fusão"
head_description: "Combine vários arquivos VSSM em um único arquivo usando a API de fusão de documentos C# .NET. Combine páginas ou intervalos de páginas específicos de vários documentos em um único documento."

############################# Header ############################
title: "Combine VSSM Arquivos em C#"
description: "Combine VSSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como combinar vários arquivos VSSM"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET combinar dois ou mais arquivos VSSM em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como combinar arquivos VSSM usando o código de exemplo C#">}}

        ```csharp    
        // Combine arquivos VSSM usando a API GroupDocs.Merger
