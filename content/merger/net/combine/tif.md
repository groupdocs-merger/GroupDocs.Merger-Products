...
############################# Head ############################
head_title: "Combine TIF Files in C# | TIF Merger"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to combine two or more TIF files within their applications by implementing a few easy steps.
