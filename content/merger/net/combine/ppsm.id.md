...
head_title: "Gabungkan File PPSM di C# | PPSM Penggabungan"
head_description: "Gabungkan beberapa file PPSM menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

title: "Gabungkan File PPSM Di C#"
description: "Gabungkan beberapa file PPSM menjadi satu file menggunakan API penggabungan dokumen C# .NET. Gabungkan halaman atau rentang halaman yang dipilih dari berbagai dokumen sumber menjadi satu dokumen yang dihasilkan."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File PPSM"
    content_left: |
    ...
    code: |
        ```cs
        // Gabungkan file PPSM menggunakan GroupDocs.Merger API
