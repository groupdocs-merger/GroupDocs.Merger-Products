...
############################# Head ############################
head_title: "Kombineer PPTX lêers in C# | PPTX samesmelting"
head_description: "Kombineer veelvuldige PPTX lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer PPTX lêers in C#"
description: "Kombineer PPTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige PPTX-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer PPTX-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPTX lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer PPTX lêers deur GroupDocs.Merger API te gebruik
...
demos:
    ...
    content: |
       Kombineer meer as een PPTX lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
