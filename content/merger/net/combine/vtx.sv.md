...
############################# Head ############################
head_title: "Kombinera VTX-filer i C# | VTX Sammanslagning"
head_description: "Kombinera flera VTX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera VTX filer i C#"
description: "Kombinera VTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera VTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera VTX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar VTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera VTX filer med GroupDocs.Merger API
        // Instantiera sammanslagning med indatadokumentet VTX
...
demos:
    ...
    content: |
       Kombinera mer än en VTX-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
