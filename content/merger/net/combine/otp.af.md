...
############################# Head ############################
head_title: "Kombineer OTP lêers in C# | OTP samesmelting"
head_description: "Kombineer veelvuldige OTP lêers in 'n enkele lêer deur gebruik te maak van C# .NET dokumentsamesmeltings-API. Kombineer spesifieke bladsye of bladsyreekse van verskeie dokumente tot 'n enkele dokument."

############################# Header ############################
title: "Kombineer OTP lêers in C#"
description: "Kombineer OTP met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Hoe om veelvuldige OTP-lêers te kombineer"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir .NET-ontwikkelaars om twee of meer OTP-lêers binne hul toepassings te kombineer deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTP lêers te kombineer deur C# voorbeeldkode te gebruik">}}

        ```csharp    
        // Kombineer OTP lêers deur GroupDocs.Merger API te gebruik
        // Instansieer samesmelting met invoer OTP dokument
...
demos:
    ...
    content: |
       Kombineer meer as een OTP lêers op die oomblik deur [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webwerf te besoek.
