...
############################# Head ############################
head_title: "Kombinálja az ODS fájlokat a C# |-ben ODS Egyesülés"
head_description: "Kombináljon több ODS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODS fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) ODS elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODS fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ODS fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon ODS fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több ODS fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
