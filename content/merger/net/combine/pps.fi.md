...
############################# Header ############################
title: "Yhdistä PPS tiedostoa C#"
description: "Yhdistä PPS muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia PPS-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PPS tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) -sivustolla.
