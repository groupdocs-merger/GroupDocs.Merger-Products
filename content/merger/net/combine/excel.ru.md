...
############################# Head ############################
head_title: "Объединение файлов EXCEL в .NET"
head_description: "Интегрируйте GroupDocs.Merger for .NET в ваши проекты .NET, чтобы объединять файлы EXCEL."

############################# Header ############################
title: "Объединение файлов EXCEL" 
description: "Используйте GroupDocs.Merger for .NET для создания приложений .NET, которые эффективно объединяют документы EXCEL."
...
steps:
    enable: true
    title: "Шаги для объединения файлов EXCEL"
    content: |
      [GroupDocs.Merger](/merger/net/) позволяет вам легко объединять файлы EXCEL. Интегрируйте эту функцию в ваши приложения .NET, чтобы обрабатывать несколько документов как единый файл.
      
      1. Установите путь к первому файлу EXCEL.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Создайте экземпляр Merger с входным документом EXCEL
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение выбранных страниц из файлов разных форматов"
      content: |
        Этот пример иллюстрирует, как объединить файлы EXCEL, включив выбранные страницы из других форматов.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
