...
############################# Head ############################
head_title: "VTX Dosyalarını C# İçinde Birleştirin | VTX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VTX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VTX Dosyalarını C# İçinde Birleştirin"
description: "VTX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VTX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VTX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VTX dosyalarını birleştirin
