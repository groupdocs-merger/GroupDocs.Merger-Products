...
############################# Head ############################
head_title: "Kombinera PPT-filer i C# | PPT Sammanslagning"
head_description: "Kombinera flera PPT-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Kombinera specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "Kombinera PPT filer i C#"
description: "Kombinera PPT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man kombinerar flera PPT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att kombinera två eller flera PPT-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man kombinerar PPT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Kombinera PPT filer med GroupDocs.Merger API
...
demos:
    ...
    content: |
       Kombinera mer än en PPT-fil just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
