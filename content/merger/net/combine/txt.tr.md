...
############################# Head ############################
head_title: "TXT Dosyalarını C# İçinde Birleştirin | TXT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla TXT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "TXT Dosyalarını C# İçinde Birleştirin"
description: "TXT kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok TXT Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TXT dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak TXT dosyalarını birleştirin
