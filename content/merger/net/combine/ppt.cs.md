...
############################# Head ############################
head_title: "Zkombinujte PPT soubory v C# | PPT Fúze"
head_description: "Zkombinujte více souborů PPT do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Kombinujte konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "Kombinovat PPT soubory v C#"
description: "Zkombinujte PPT s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak zkombinovat více souborů PPT"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET kombinovat dva nebo více souborů PPT v jejich aplikacích implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zkombinovat soubory PPT pomocí ukázkového kódu C#">}}

        ```csharp    
        // Zkombinujte PPT soubory pomocí GroupDocs.Merger API
...
demos:
    ...
    content: |
       Na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) zkombinujte hned teď více než jeden soubor PPT.
