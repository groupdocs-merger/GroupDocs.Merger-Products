...
############################# Head ############################
head_title: "Combineer VSTM Bestanden in C# | VSTM Fusie"
head_description: "Combineer meerdere VSTM bestanden in een enkel bestand met behulp van de C# .NET document merge API. Combineer specifieke pagina's of paginabereiken van verschillende documenten tot één document."

############################# Header ############################
title: "Combineer VSTM bestanden in C#"
description: "Combineer VSTM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere VSTM bestanden combineren"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer VSTM-bestanden in hun applicaties te combineren door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSTM bestanden te combineren met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Combineer VSTM bestanden met behulp van GroupDocs.Merger API
