...
############################# Head ############################
head_title: "Kombinálja az PDF fájlokat a C# |-ben PDF Egyesülés"
head_description: "Kombináljon több PDF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PDF fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) PDF elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PDF fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk PDF fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon PDF fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több PDF fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
