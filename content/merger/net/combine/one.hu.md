...
############################# Head ############################
head_title: "Kombinálja az ONE fájlokat a C# |-ben ONE Egyesülés"
head_description: "Kombináljon több ONE fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ONE fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) ONE elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ONE fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ONE fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon ONE fájlt a GroupDocs.Merger API segítségével
