...
############################# Header ############################
title: "Yhdistä VSSX tiedostoa C#"
description: "Yhdistä VSSX muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia VSSX-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
