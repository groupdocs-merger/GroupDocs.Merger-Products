...
############################# Head ############################
head_title: "Gabungkan ODS File di C# | ODS Penggabungan"
head_description: "Gabungkan beberapa file ODS menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "Gabungkan ODS File Di C#"
description: "Gabungkan ODS dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa File ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang .NET untuk menggabungkan dua atau lebih file ODS dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menggabungkan file ODS menggunakan kode contoh C#">}}

        ```csharp    
        // Gabungkan file ODS menggunakan GroupDocs.Merger API
        // Instansiasi Penggabungan dengan dokumen masukan ODS
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu ODS file sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/merger/family).
