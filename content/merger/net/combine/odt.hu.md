...
############################# Head ############################
head_title: "Kombinálja az ODT fájlokat a C# |-ben ODT Egyesülés"
head_description: "Kombináljon több ODT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok kombinálása a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODT fájlok kombinálása a C# nyelven"
description: "Kombinálja a(z) ODT elemet néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODT fájlt kombináljanak alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan kombinálhatunk ODT fájlokat a C# példakóddal">}}

        ```csharp    
        // Kombináljon ODT fájlt a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egynél több ODT fájlt kombinálhat most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) webhely meglátogatásával.
