...
############################# Header ############################
title: "Yhdistä DOTM tiedostoa C#"
description: "Yhdistä DOTM muutamaan riviin .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee .NET-kehittäjien helpoksi yhdistää kaksi tai useampia DOTM-tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
