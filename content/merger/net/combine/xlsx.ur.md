...
############################# Head ############################
head_title: "XLSX فائلوں کو C# میں یکجا کریں۔ XLSX انضمام"
head_description: "C# .NET دستاویزات کے انضمام API کا استعمال کرتے ہوئے متعدد XLSX فائلوں کو ایک فائل میں یکجا کریں۔ مختلف دستاویزات سے کسی ایک دستاویز تک مخصوص صفحات یا صفحہ کی حدود کو یکجا کریں۔"

############################# Header ############################
title: "XLSX فائلوں کو C# میں یکجا کریں"
description: "XLSX کو .NET کوڈ کی چند سطروں کے ساتھ جوڑیں۔"
...
steps:
    enable: true
    title_left: "متعدد XLSX فائلوں کو یکجا کرنے کا طریقہ"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) .NET ڈویلپرز کے لیے اپنی ایپلی کیشنز میں دو یا زیادہ XLSX فائلوں کو اکٹھا کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے XLSX فائلوں کو کیسے جوڑیں۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے XLSX فائلوں کو یکجا کریں۔
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) ویب سائٹ پر جا کر ابھی ایک سے زیادہ XLSX فائلوں کو یکجا کریں۔
