...
############################# Head ############################
head_title: "Kombinieren Sie DOCM-Dateien in C# | DOCM Fusion"
head_description: "Kombinieren Sie mehrere DOCM-Dateien in einer einzigen Datei mithilfe der C# .NET Documents Merger API. Kombinieren Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument."

############################# Header ############################
title: "Kombinieren Sie DOCM-Dateien in C#"
description: "Kombinieren Sie DOCM mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "So kombinieren Sie mehrere DOCM-Dateien"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es .NET-Entwicklern einfach, zwei oder mehr DOCM-Dateien in ihren Anwendungen zu kombinieren, indem sie eine paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So kombinieren Sie DOCM-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Kombinieren Sie DOCM-Dateien mit der GroupDocs.Merger-API
