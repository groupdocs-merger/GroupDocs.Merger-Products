...
############################# Head ############################
head_title: "PNG Dosyalarını C# İçinde Birleştirin | PNG Birleşme"
...
############################# Header ############################
title: "PNG Dosyalarını C# İçinde Birleştirin"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PNG dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API kullanarak PNG dosyalarını birleştirin
