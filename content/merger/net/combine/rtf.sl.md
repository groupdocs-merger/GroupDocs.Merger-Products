...
############################# Head ############################
head_title: "Združi RTF datoteke v C# | RTF Združitev"
head_description: "Združite več datotek RTF v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali nize strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "Združi RTF datotek v C#"
description: "Kombinirajte RTF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Kako združiti več datotek RTF"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek RTF znotraj svojih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke RTF s primerom kode C#">}}

        ```csharp    
        // Združite datoteke RTF z API-jem GroupDocs.Merger
        // Ustvari združitev z vhodnim dokumentom RTF
...
demos:
    ...
    content: |
       Takoj združite več kot eno RTF datoteko tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
