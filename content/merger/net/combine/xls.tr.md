...
############################# Head ############################
head_title: "XLS Dosyalarını C# İçinde Birleştirin | XLS Birleşme"
...
############################# Header ############################
title: "XLS Dosyalarını C# İçinde Birleştirin"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLS dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API kullanarak XLS dosyalarını birleştirin
