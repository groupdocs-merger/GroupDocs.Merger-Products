...
############################# Head ############################
head_title: "Merge TIFF files in .NET"
head_description: "Integrate GroupDocs.Merger for .NET into your .NET projects to easily merge TIFF files."

############################# Header ############################
title: "Merge TIFF files" 
description: "Use GroupDocs.Merger for .NET to build .NET applications that efficiently merge TIFF documents."
...
steps:
    enable: true
    title: "Steps to merge TIFF files"
    content: |
      [GroupDocs.Merger](/merger/net/) allows you to merge TIFF files effortlessly. Integrate this feature into your .NET applications to handle multiple documents as a single file.
      
      1. Set the path to the first TIFF file.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Create a Merger instance with the input TIFF document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from files of different formats"
      content: |
        This example illustrates how to merge TIFF files while incorporating selected pages from other formats.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
