...
############################# Header ############################
title: "Combina JPEG fitxers a C#"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de .NET combinen dos o més fitxers JPEG dins de les seves aplicacions mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com combinar fitxers JPEG utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Combina fitxers JPEG mitjançant l'API de GroupDocs.Merger
...
demos:
    ...
    content: |
       Combineu més d'un fitxer JPEG ara mateix visitant el lloc web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
