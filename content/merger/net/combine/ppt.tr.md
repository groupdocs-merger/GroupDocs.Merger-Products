...
############################# Head ############################
head_title: "PPT Dosyalarını C# İçinde Birleştirin | PPT Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla PPT dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "PPT Dosyalarını C# İçinde Birleştirin"
description: "PPT kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok PPT Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPT dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak PPT dosyalarını birleştirin
