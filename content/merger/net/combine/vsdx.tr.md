...
############################# Head ############################
head_title: "VSDX Dosyalarını C# İçinde Birleştirin | VSDX Birleşme"
head_description: "C# .NET doküman birleştirme API'sini kullanarak birden fazla VSDX dosyasını tek bir dosyada birleştirin. Çeşitli belgelerden belirli sayfaları veya sayfa aralıklarını tek bir belgede birleştirin."

############################# Header ############################
title: "VSDX Dosyalarını C# İçinde Birleştirin"
description: "VSDX kodunu birkaç satır .NET koduyla birleştirin."
...
steps:
    enable: true
    title_left: "Birden Çok VSDX Dosya Nasıl Birleştirilir"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosyaları nasıl birleştirilir">}}

        ```csharp    
        // GroupDocs.Merger API kullanarak VSDX dosyalarını birleştirin
