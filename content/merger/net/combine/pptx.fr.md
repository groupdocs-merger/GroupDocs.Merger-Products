...
############################# Head ############################
head_title: "Combiner les fichiers PPTX dans C# | PPTX Fusion"
head_description: "Combinez plusieurs fichiers PPTX en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Combinez des pages ou des plages de pages spécifiques de divers documents en un seul document."

############################# Header ############################
title: "Combinez PPTX fichiers dans C#"
description: "Combinez PPTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment combiner plusieurs fichiers PPTX"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de combiner facilement deux fichiers PPTX ou plus dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment combiner des fichiers PPTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Combinez les fichiers PPTX à l'aide de l'API GroupDocs.Merger
...
demos:
    ...
    content: |
       Combinez plusieurs fichiers PPTX dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family).
