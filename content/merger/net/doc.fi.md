...
############################# Head ############################
head_title: "Yhdistä DOC tiedostot C# | DOC Sulautuminen"
...
############################# Header ############################
title: "DOC Sulautuminen C#"
description: "Yhdistä DOC muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia DOC tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOC tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä DOC tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOC-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) -sivustolla.
