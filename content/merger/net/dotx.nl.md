...
############################# Head ############################
head_title: "Voeg DOTX bestanden samen in C# | DOTX Fusie"
head_description: "Voeg meerdere DOTX bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "DOTX Fusie in C#"
description: "Voeg DOTX samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOTX bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOTX-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTX bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg DOTX bestanden samen met de GroupDocs.Merger API
