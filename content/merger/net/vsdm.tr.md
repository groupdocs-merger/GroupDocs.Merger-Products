...
############################# Head ############################
head_title: "VSDM Dosyalarını C# İçinde Birleştir | VSDM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDM dosyalarını birleştirin
