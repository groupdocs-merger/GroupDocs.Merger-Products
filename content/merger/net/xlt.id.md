...
############################# Head ############################
head_title: "Gabungkan XLT File di C# | XLT Penggabungan"
head_description: "Gabungkan beberapa file XLT menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "XLT Penggabungan Dalam C#"
description: "Gabungkan XLT dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu XLT file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
