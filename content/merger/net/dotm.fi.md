...
############################# Head ############################
head_title: "Yhdistä DOTM tiedostot C# | DOTM Sulautuminen"
...
############################# Header ############################
title: "DOTM Sulautuminen C#"
description: "Yhdistä DOTM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia DOTM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOTM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä DOTM tiedostot GroupDocs.Merger API:lla
