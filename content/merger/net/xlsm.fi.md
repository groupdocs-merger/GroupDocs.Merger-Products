...
############################# Head ############################
head_title: "Yhdistä XLSM tiedostot C# | XLSM Sulautuminen"
...
############################# Header ############################
title: "XLSM Sulautuminen C#"
description: "Yhdistä XLSM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLSM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLSM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä XLSM tiedostot GroupDocs.Merger API:lla
