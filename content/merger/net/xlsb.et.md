...
############################# Head ############################
head_title: "Ühendage XLSB failid C# | XLSB Ühinemine"
head_description: "Ühendage mitu XLSB faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "XLSB ühinemine programmis C#"
description: "Ühendage XLSB mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu XLSB faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam XLSB faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita XLSB faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid XLSB, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks XLSB faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
