...
############################# Head ############################
head_title: "Spoji EPUB datoteke u C# | EPUB Spajanje"
head_description: "Spojite više EPUB datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "EPUB Spajanje u C#"
description: "Spoji EPUB s nekoliko redaka .NET koda."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti EPUB datoteke koristeći C# primjer koda">}}
        ...
        ```csharp    
        // Spoji EPUB datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    ...
    content: |
       Spojite više od jedne EPUB datoteke upravo sada tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub) web mjesto.
