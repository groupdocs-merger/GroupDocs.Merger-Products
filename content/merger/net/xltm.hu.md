...
############################# Head ############################
head_title: "XLTM fájlok egyesítése a C#-ban | XLTM Egyesülés"
head_description: "Egyesítsen több XLTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLTM Egyesülés a C# programban"
description: "Egyesítse a(z) XLTM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLTM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLTM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLTM fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLTM fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) webhely meglátogatásával.
