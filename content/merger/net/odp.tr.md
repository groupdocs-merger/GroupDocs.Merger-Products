...
############################# Head ############################
head_title: "ODP Dosyalarını C# İçinde Birleştir | ODP Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODP dosyalarını birleştirin
