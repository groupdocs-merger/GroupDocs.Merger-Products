...
############################# Head ############################
head_title: "XLAM Dosyalarını C# İçinde Birleştir | XLAM Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLAM dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLAM dosyalarını birleştirin
