...
############################# Head ############################
head_title: "Slå sammen XLSB-filer i C# | XLSB Fusjon"
...
############################# Header ############################
title: "XLSB sammenslåing i C#"
description: "Slå sammen XLSB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLSB-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLSB filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLSB filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLSB-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
