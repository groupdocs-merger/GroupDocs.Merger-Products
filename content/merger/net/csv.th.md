...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีผสาน CSV ไฟล์โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // รวม CSV ไฟล์โดยใช้ GroupDocs.Merger API
...
demos:
    ...
    content: |
       รวมไฟล์ CSV มากกว่าหนึ่งไฟล์ในขณะนี้โดยไปที่เว็บไซต์ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/csv)
