...
############################# Header ############################
title: "PPSX Sulautuminen C#"
description: "Yhdistä PPSX muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia PPSX tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
