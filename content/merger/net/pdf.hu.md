...
############################# Head ############################
head_title: "PDF fájlok egyesítése a C#-ban | PDF Egyesülés"
head_description: "Egyesítsen több PDF fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PDF Egyesülés a C# programban"
description: "Egyesítse a(z) PDF terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PDF fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PDF fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PDF fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen PDF fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több PDF fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) webhely meglátogatásával.
