...
############################# Head ############################
head_title: "DOCX fájlok egyesítése a C#-ban | DOCX Egyesülés"
head_description: "Egyesítsen több DOCX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOCX Egyesülés a C# programban"
description: "Egyesítse a(z) DOCX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOCX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOCX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOCX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több DOCX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx) webhely meglátogatásával.
