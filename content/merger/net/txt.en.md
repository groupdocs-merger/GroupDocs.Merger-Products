...
############################# Head ############################
head_title: "Merge TXT files via .NET"
head_description: "Integrate TXT document merging into your .NET projects with GroupDocs.Merger for .NET."

############################# Header ############################
title: "Merge TXT files" 
description: "Use GroupDocs.Merger for .NET to create powerful .NET applications that seamlessly merge and manage TXT documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) makes it easy to merge TXT documents. Add merging functionality to your .NET applications and combine multiple files effortlessly.
      
      1. Define the path to the first TXT file.
