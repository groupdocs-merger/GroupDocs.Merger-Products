...
############################# Head ############################
head_title: "DOTX Sayfalarını C# İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir DOTX dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "DOTX Sayfayı C# İçinde Değiştir"
description: "DOTX Sayfalarını birkaç satır .NET koduyla değiştirin."
...
steps:
    enable: true
    title_left: ".NET içindeki DOTX Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir DOTX dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTX dosya sayfaları nasıl değiştirilir?">}}
