...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSSX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSSX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSSX stránky v C#"
description: "Vyměňte VSSX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSSX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSSX pomocí ukázkového kódu C#">}}
