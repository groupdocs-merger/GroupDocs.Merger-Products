...
############################# Head ############################
head_title: "Swap & Exchange VSTM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSTM file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSTM Pages In C#"
description: "Swap VSTM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSTM file pages using C# example code">}}
