...
############################# Head ############################
head_title: "Troque e troque DOT páginas em C#"
head_description: "Troque e troque posições de duas páginas em um arquivo DOT em C# usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar DOT Páginas em C#"
description: "Troque DOT Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo DOT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# trocar páginas em um arquivo DOT implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo DOT usando o código de exemplo C#">}}
