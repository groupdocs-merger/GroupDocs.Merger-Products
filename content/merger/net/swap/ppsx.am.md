...
############################# Head ############################
head_title: "በC# ውስጥ PPSX ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በC# ውስጥ ባለው የPPSX ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "PPSX ገጾችን በC# ውስጥ ይቀያይሩ"
description: "PPSX ገጾችን በጥቂት የ.NET ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "PPSX የፋይል ገጾችን በ.NET ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በPPSX ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="PPSX የፋይል ገጾችን C# ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}
