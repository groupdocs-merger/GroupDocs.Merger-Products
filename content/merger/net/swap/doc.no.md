...
############################# Head ############################
head_title: "Bytt og bytt ut DOC sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOC-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOC sider i C#"
description: "Bytt DOC-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en DOC-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOC filsider ved å bruke C# eksempelkode">}}
