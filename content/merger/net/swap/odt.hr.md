...
############################# Head ############################
head_title: "Zamijeni i razmijeni ODT stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar ODT datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni ODT stranice u C#"
description: "Zamijenite ODT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni ODT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar ODT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti ODT stranice datoteke koristeći C# primjer koda">}}
