...
############################# Head ############################
head_title: "Zamień i zamień VSSX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSSX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSSX strony w C#"
description: "Zamień strony VSSX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSSX przy użyciu przykładowego kodu C#">}}
