...
############################# Head ############################
head_title: "Byt og byt TEX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en TEX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt TEX sider i C#"
description: "Byt TEX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en TEX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du TEX filsider ved hjælp af C# eksempelkode">}}
