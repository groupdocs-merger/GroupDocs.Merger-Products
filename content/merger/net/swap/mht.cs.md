...
############################# Head ############################
head_title: "Vyměňte a vyměňte MHT stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru MHT v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit MHT stránky v C#"
description: "Vyměňte MHT stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte MHT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru MHT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru MHT pomocí ukázkového kódu C#">}}
