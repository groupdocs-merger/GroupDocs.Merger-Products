...
############################# Head ############################
head_title: "Cserélj és cserélj PPT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PPT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPT oldal cseréje a C# nyelven"
description: "Cserélje ki az PPT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy PPT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PPT fájloldalakat a C# példakóddal">}}
