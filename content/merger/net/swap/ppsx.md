...
############################# Head ############################
head_title: "Swap & Exchange PPSX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a PPSX file in C# using the documents merger API."

############################# Header ############################
title: "Swap PPSX Pages In C#"
description: "Swap PPSX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a PPSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PPSX file pages using C# example code">}}
