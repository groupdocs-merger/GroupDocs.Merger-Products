...
############################# Head ############################
head_title: "Byt og byt XPS sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XPS-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XPS sider i C#"
description: "Byt XPS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XPS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XPS filsider ved hjælp af C# eksempelkode">}}
