...
############################# Head ############################
head_title: "Vyměňte a vyměňte OTP stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru OTP v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit OTP stránky v C#"
description: "Vyměňte OTP stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte OTP stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru OTP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru OTP pomocí ukázkového kódu C#">}}
