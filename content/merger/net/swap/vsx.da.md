...
############################# Head ############################
head_title: "Byt og byt VSX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSX sider i C#"
description: "Byt VSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSX filsider ved hjælp af C# eksempelkode">}}
