...
############################# Head ############################
head_title: "Échangez et échangez TEX pages en C#"
head_description: "Échangez et échangez des positions de deux pages dans un fichier TEX en C# à l'aide de l'API de fusion de documents."

############################# Header ############################
title: "Échangez TEX pages dans C#"
description: "Échangez TEX pages avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Échangez TEX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs C# d'échanger facilement des pages dans un fichier TEX en mettant en œuvre quelques étapes simples .
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment échanger des pages de fichiers TEX à l'aide de l'exemple de code C#">}}
