...
############################# Head ############################
head_title: "Cserélj és cserélj XLSB oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSB fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSB oldal cseréje a C# nyelven"
description: "Cserélje ki az XLSB oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLSB fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLSB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSB fájloldalakat a C# példakóddal">}}
