...
############################# Head ############################
head_title: "Vahetage ja vahetage XLSM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLSM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLSM lehte keeles C#"
description: "Vahetage XLSM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLSM faililehte, kasutades C# näitekoodi">}}
