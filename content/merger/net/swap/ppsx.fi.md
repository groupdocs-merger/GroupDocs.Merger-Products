...
############################# Head ############################
head_title: "Vaihda ja vaihda PPSX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPSX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPSX sivua C#"
description: "Vaihda PPSX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja PPSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
