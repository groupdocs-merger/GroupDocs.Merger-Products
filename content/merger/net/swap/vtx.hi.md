...
############################# Head ############################
head_title: "C# में VTX पेज स्वैप और एक्सचेंज करें"
head_description: "दस्तावेज़ विलय API का उपयोग करके C# में एक VTX फ़ाइल के भीतर दो पृष्ठों की स्थिति बदलें और बदलें।"

############################# Header ############################
title: "VTX पेजों को C# में बदलें"
description: "VTX पेजों को .NET कोड की कुछ पंक्तियों से बदलें।"
...
steps:
    enable: true
    title_left: "VTX फ़ाइल पेजों को .NET में बदलें"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/विलय/net/) कुछ आसान चरणों को लागू करके C# डेवलपर्स के लिए VTX फ़ाइल के भीतर पृष्ठों को स्वैप करना आसान बनाता है। .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके VTX फ़ाइल पृष्ठों को स्वैप कैसे करें">}}
