...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLTM puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLTM faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLTM puslapius C#"
description: "Pakeiskite XLTM puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLTM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLTM faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLTM failo puslapius naudojant C# pavyzdinį kodą">}}
