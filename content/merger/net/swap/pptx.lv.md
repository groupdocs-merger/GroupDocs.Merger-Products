...
############################# Head ############################
head_title: "Apmainīt un apmainīt PPTX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas PPTX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt PPTX lapas programmā C#"
description: "Apmainiet PPTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt PPTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām PPTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt PPTX faila lapas, izmantojot C# piemēra kodu">}}
