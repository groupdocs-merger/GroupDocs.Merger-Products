...
############################# Head ############################
head_title: "Bytt og bytt ut VSTX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSTX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSTX sider i C#"
description: "Bytt VSTX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSTX filsider ved å bruke C# eksempelkode">}}
