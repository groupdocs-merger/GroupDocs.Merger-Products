...
############################# Head ############################
head_title: "Byt och byt ut RTF sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en RTF-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt RTF sidor i C#"
description: "Byt RTF-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt RTF filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en RTF-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter RTF filsidor med hjälp av C# exempelkod">}}
