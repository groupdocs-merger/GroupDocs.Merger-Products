...
############################# Head ############################
head_title: "Biguherîne û biguherîne DOT Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek DOT de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne DOT Rûpelên Di C# de"
description: "Rûpelên DOT bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de DOT Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek DOT de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên DOT bi karanîna koda nimûneya C# veguhezîne">}}
