...
############################# Head ############################
head_title: "Swap & Exchange ONE Pages in C#"
head_description: "Swap & Exchange positions of two pages within a ONE file in C# using the documents merger API."

############################# Header ############################
title: "Swap ONE Pages In C#"
description: "Swap ONE Pages with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Swap ONE File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a ONE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ONE file pages using C# example code">}}
