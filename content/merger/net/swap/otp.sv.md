...
############################# Head ############################
head_title: "Byt och byt ut OTP sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en OTP-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt OTP sidor i C#"
description: "Byt OTP-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt OTP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en OTP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter OTP filsidor med hjälp av C# exempelkod">}}
