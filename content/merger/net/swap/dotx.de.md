...
############################# Head ############################
head_title: "Tausche & tausche DOTX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer DOTX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche DOTX Seiten in C#"
description: "Tauschen Sie DOTX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "DOTX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer DOTX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie DOTX-Dateiseiten mit C#-Beispielcode aus">}}
