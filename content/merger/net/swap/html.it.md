...
############################# Head ############################
head_title: "Scambia e scambia HTML pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file HTML in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia HTML pagine in C#"
description: "Scambia le pagine HTML con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia HTML pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file HTML implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file HTML utilizzando il codice di esempio C#">}}
