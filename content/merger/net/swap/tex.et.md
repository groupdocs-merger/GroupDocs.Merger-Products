...
############################# Head ############################
head_title: "Vahetage ja vahetage TEX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone TEX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage TEX lehte keeles C#"
description: "Vahetage TEX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage TEX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis TEX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada TEX faililehte, kasutades C# näitekoodi">}}
