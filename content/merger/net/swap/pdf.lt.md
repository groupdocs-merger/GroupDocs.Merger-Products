...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PDF puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PDF faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PDF puslapius C#"
description: "Pakeiskite PDF puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PDF failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais PDF faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PDF failo puslapius naudojant C# pavyzdinį kodą">}}
