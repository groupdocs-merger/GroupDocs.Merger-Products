...
############################# Head ############################
head_title: "Zamijeni i razmijeni VTX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VTX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VTX stranice u C#"
description: "Zamijenite VTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VTX stranice datoteke koristeći C# primjer koda">}}
