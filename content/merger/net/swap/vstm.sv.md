...
############################# Head ############################
head_title: "Byt och byt ut VSTM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSTM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSTM sidor i C#"
description: "Byt VSTM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSTM filsidor med hjälp av C# exempelkod">}}
