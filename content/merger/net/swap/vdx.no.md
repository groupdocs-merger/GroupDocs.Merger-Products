...
############################# Head ############################
head_title: "Bytt og bytt ut VDX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VDX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VDX sider i C#"
description: "Bytt VDX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VDX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VDX filsider ved å bruke C# eksempelkode">}}
