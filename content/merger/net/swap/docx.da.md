...
############################# Head ############################
head_title: "Byt og byt DOCX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOCX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOCX sider i C#"
description: "Byt DOCX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOCX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOCX filsider ved hjælp af C# eksempelkode">}}
