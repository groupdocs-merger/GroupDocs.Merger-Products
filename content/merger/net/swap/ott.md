...
############################# Head ############################
head_title: "Swap & Exchange OTT Pages in C#"
head_description: "Swap & Exchange positions of two pages within a OTT file in C# using the documents merger API."

############################# Header ############################
title: "Swap OTT Pages In C#"
description: "Swap OTT Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a OTT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap OTT file pages using C# example code">}}
...
demos:
    ...
    content: |
       Swap OTT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) website.
