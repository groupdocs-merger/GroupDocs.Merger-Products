...
############################# Head ############################
head_title: "Swap & Exchange OTT Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a OTT file using the file split API."

############################# Header ############################
title: "Swap OTT Pages in .NET"
description: "Swap and exchange positions of two pages within a OTT file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
demos:
    ...
    content: |
        Swap pages within OTT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ott) website.
