...
############################# Head ############################
head_title: "Tukar & Tukar DOC Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOC dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOC Halaman Dalam C#"
description: "Tukar DOC Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar DOC Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail DOC dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOC halaman fail menggunakan kod contoh C#.">}}
