...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj TEX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke TEX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj TEX strani v C#"
description: "Zamenjajte strani TEX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke TEX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki TEX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke TEX s primerom kode C#">}}
