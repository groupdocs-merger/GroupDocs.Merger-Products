...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOTM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOTM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOTM stránky v C#"
description: "Vymeňte DOTM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte DOTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru DOTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOTM pomocou vzorového kódu C#">}}
