...
############################# Head ############################
head_title: "Swap pages in POWERPOINT files using .NET apps"
head_description: "Use GroupDocs.Merger for .NET to reorder pages in POWERPOINT documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, and more."

############################# Header ############################
title: "Swap POWERPOINT pages" 
description: "GroupDocs.Merger for .NET extends .NET applications with advanced document management capabilities. Easily rearrange pages in POWERPOINT files to structure content exactly as needed."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily reorganize pages in POWERPOINT documents to enhance readability and structure. Add efficient document processing to your .NET applications.
      
      1. Provide the path to the POWERPOINT file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a POWERPOINT file"
      content: |
        This example demonstrates how to swap pages in a POWERPOINT file in a few simple steps.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
