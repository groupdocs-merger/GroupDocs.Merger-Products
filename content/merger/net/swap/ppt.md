...
############################# Head ############################
head_title: "Swap & Exchange PPT Pages in C#"
head_description: "Swap & Exchange positions of two pages within a PPT file in C# using the documents merger API."

############################# Header ############################
title: "Swap PPT Pages In C#"
description: "Swap PPT Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a PPT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PPT file pages using C# example code">}}
...
demos:
    ...
    content: |
       Swap PPT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ppt) website.
