...
############################# Head ############################
head_title: "ONE Sayfalarını C# İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir ONE dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "ONE Sayfayı C# İçinde Değiştir"
description: "ONE Sayfalarını birkaç satır .NET koduyla değiştirin."
...
steps:
    enable: true
    title_left: ".NET içindeki ONE Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir ONE dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosya sayfaları nasıl değiştirilir?">}}
