...
############################# Head ############################
head_title: "Zamień i zamień MHT strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku MHT w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień MHT strony w C#"
description: "Zamień strony MHT na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików MHT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku MHT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku MHT przy użyciu przykładowego kodu C#">}}
