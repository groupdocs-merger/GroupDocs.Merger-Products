...
############################# Head ############################
head_title: "Vahetage ja vahetage XLSX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLSX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLSX lehte keeles C#"
description: "Vahetage XLSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLSX faililehte, kasutades C# näitekoodi">}}
