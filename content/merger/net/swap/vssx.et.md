...
############################# Head ############################
head_title: "Vahetage ja vahetage VSSX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSSX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSSX lehte keeles C#"
description: "Vahetage VSSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSSX faililehte, kasutades C# näitekoodi">}}
