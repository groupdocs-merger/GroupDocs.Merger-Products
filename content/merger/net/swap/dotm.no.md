...
############################# Head ############################
head_title: "Bytt og bytt ut DOTM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOTM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOTM sider i C#"
description: "Bytt DOTM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt DOTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en DOTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOTM filsider ved å bruke C# eksempelkode">}}
