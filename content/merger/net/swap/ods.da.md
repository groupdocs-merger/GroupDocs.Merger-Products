...
############################# Head ############################
head_title: "Byt og byt ODS sider i C#"
head_description: "Byt og udveksle positioner på to sider i en ODS-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt ODS sider i C#"
description: "Byt ODS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en ODS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du ODS filsider ved hjælp af C# eksempelkode">}}
