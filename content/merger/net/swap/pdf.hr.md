...
############################# Head ############################
head_title: "Zamijeni i razmijeni PDF stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PDF datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PDF stranice u C#"
description: "Zamijenite PDF stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni PDF stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar PDF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PDF stranice datoteke koristeći C# primjer koda">}}
