...
############################# Head ############################
head_title: "Tukar & Tukarkan PPS Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPS di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPS Halaman Di C#"
description: "Tukar PPS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar PPS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file PPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPS menggunakan kode contoh C#">}}
