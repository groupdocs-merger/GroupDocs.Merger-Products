...
############################# Head ############################
head_title: "Bytt og bytt ut VSDM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSDM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSDM sider i C#"
description: "Bytt VSDM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSDM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSDM filsider ved å bruke C# eksempelkode">}}
