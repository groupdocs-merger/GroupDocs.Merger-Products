...
############################# Head ############################
head_title: "Cserélj és cserélj ODP oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODP fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODP oldal cseréje a C# nyelven"
description: "Cserélje ki az ODP oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODP fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy ODP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODP fájloldalakat a C# példakóddal">}}
