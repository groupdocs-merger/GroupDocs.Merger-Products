...
############################# Head ############################
head_title: "Canvia i intercanvia VTX pàgines a C#"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer VTX a C# mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia VTX pàgines a C#"
description: "Canvia les pàgines VTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers VTX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# intercanviïn pàgines dins d'un fitxer VTX implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers VTX utilitzant el codi d'exemple C#">}}
