...
############################# Head ############################
head_title: "Vaihda ja vaihda VSTM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSTM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSTM sivua C#"
description: "Vaihda VSTM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSTM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
