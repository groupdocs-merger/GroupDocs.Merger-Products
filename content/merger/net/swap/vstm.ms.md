...
############################# Head ############################
head_title: "Tukar & Tukar VSTM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSTM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTM Halaman Dalam C#"
description: "Tukar VSTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VSTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VSTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSTM halaman fail menggunakan kod contoh C#.">}}
