...
############################# Head ############################
head_title: "Byt og byt PPTX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en PPTX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PPTX sider i C#"
description: "Byt PPTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en PPTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PPTX filsider ved hjælp af C# eksempelkode">}}
