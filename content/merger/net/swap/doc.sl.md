...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj DOC strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke DOC v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj DOC strani v C#"
description: "Zamenjajte strani DOC z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke DOC v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki DOC z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke DOC s primerom kode C#">}}
