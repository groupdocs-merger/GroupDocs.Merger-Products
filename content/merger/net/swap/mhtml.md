...
############################# Head ############################
head_title: "Swap & Exchange MHTML Pages in C#"
head_description: "Swap & Exchange positions of two pages within a MHTML file in C# using the documents merger API."

############################# Header ############################
title: "Swap MHTML Pages In C#"
description: "Swap MHTML Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a MHTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap MHTML file pages using C# example code">}}
