...
############################# Head ############################
head_title: "Byt och byt ut VSDM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSDM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSDM sidor i C#"
description: "Byt VSDM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSDM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSDM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSDM filsidor med hjälp av C# exempelkod">}}
