...
############################# Head ############################
head_title: "Babhtáil & Malartú VTX Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad VTX in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil VTX Leathanaigh i C#"
description: "Malartú VTX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil VTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad VTX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid VTX a mhalartú le cód samplach C#">}}
