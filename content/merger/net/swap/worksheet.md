...
############################# Head ############################
head_title: "Swap & Exchange WORKSHEET Pages in C#"
head_description: "Swap & Exchange positions of two pages within a WORKSHEET file in C# using the documents merger API."

############################# Header ############################
title: "Swap WORKSHEET Pages In C#"
description: "Swap WORKSHEET Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a WORKSHEET file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap WORKSHEET file pages using C# example code">}}
