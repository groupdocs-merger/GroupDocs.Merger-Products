...
############################# Head ############################
head_title: "Swap & Exchange VSDM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSDM file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSDM Pages In C#"
description: "Swap VSDM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSDM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSDM file pages using C# example code">}}
