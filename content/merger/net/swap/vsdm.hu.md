...
############################# Head ############################
head_title: "Cserélj és cserélj VSDM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSDM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDM oldal cseréje a C# nyelven"
description: "Cserélje ki az VSDM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSDM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSDM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSDM fájloldalakat a C# példakóddal">}}
