...
############################# Head ############################
head_title: "Vahetage ja vahetage MHTML lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone MHTML failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage MHTML lehte keeles C#"
description: "Vahetage MHTML lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage MHTML faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis MHTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada MHTML faililehte, kasutades C# näitekoodi">}}
