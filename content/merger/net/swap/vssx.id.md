...
############################# Head ############################
head_title: "Tukar & Tukarkan VSSX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSSX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSX Halaman Di C#"
description: "Tukar VSSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSSX menggunakan kode contoh C#">}}
