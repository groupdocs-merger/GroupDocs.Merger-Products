...
############################# Head ############################
head_title: "Skiptu og skiptu á OTT síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í OTT skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um OTT síður í C#"
description: "Skiptu um OTT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um OTT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan OTT skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um OTT skráarsíður með því að nota C# dæmikóða">}}
