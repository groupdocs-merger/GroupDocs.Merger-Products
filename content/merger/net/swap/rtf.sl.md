...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj RTF strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke RTF v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj RTF strani v C#"
description: "Zamenjajte strani RTF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke RTF v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki RTF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke RTF s primerom kode C#">}}
