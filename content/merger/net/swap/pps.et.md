...
############################# Head ############################
head_title: "Vahetage ja vahetage PPS lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPS failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPS lehte keeles C#"
description: "Vahetage PPS lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis PPS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPS faililehte, kasutades C# näitekoodi">}}
