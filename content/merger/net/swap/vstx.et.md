...
############################# Head ############################
head_title: "Vahetage ja vahetage VSTX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSTX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSTX lehte keeles C#"
description: "Vahetage VSTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSTX faililehte, kasutades C# näitekoodi">}}
