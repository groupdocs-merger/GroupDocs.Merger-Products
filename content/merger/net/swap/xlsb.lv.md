...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLSB lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLSB failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLSB lapas programmā C#"
description: "Apmainiet XLSB lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLSB faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām XLSB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLSB faila lapas, izmantojot C# piemēra kodu">}}
