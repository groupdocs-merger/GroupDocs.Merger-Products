...
############################# Head ############################
head_title: "Vaihda ja vaihda XPS sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XPS-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XPS sivua C#"
description: "Vaihda XPS-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XPS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XPS tiedostosivua käyttämällä C# esimerkkikoodia">}}
