...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi DOCX Trang trong C#"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp DOCX trong C# bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi DOCX Trang trong C#"
description: "Hoán đổi các trang DOCX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Hoán đổi DOCX Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET]({{sl slash_lang}}/merge/net/) giúp các nhà phát triển C# dễ dàng hoán đổi các trang trong một tệp DOCX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp DOCX bằng mã mẫu C#">}}
