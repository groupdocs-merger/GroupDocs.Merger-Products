...
############################# Head ############################
head_title: "Ruil en ruil VSX pagina's in C#"
head_description: "Wissel en ruil posities van twee pagina's binnen een VSX bestand in C# met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel VSX pagina's in C#"
description: "Verwissel VSX pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verwissel VSX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een VSX bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSX bestandspagina's te wisselen met behulp van C# voorbeeldcode">}}
