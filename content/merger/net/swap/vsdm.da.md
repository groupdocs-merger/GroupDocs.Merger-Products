...
############################# Head ############################
head_title: "Byt og byt VSDM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSDM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSDM sider i C#"
description: "Byt VSDM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSDM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSDM filsider ved hjælp af C# eksempelkode">}}
