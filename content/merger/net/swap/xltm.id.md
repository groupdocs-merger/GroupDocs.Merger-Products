...
############################# Head ############################
head_title: "Tukar & Tukarkan XLTM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLTM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTM Halaman Di C#"
description: "Tukar XLTM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLTM menggunakan kode contoh C#">}}
