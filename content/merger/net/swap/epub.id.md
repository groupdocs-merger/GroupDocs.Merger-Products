...
############################# Head ############################
head_title: "Tukar & Tukarkan EPUB Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file EPUB di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EPUB Halaman Di C#"
description: "Tukar EPUB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar EPUB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file EPUB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file EPUB menggunakan kode contoh C#">}}
