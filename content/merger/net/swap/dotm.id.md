...
############################# Head ############################
head_title: "Tukar & Tukarkan DOTM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOTM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTM Halaman Di C#"
description: "Tukar DOTM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOTM menggunakan kode contoh C#">}}
