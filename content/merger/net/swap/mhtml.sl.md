...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj MHTML strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke MHTML v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj MHTML strani v C#"
description: "Zamenjajte strani MHTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke MHTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki MHTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke MHTML s primerom kode C#">}}
