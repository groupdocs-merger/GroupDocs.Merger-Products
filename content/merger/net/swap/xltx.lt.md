...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLTX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLTX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLTX puslapius C#"
description: "Pakeiskite XLTX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLTX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLTX failo puslapius naudojant C# pavyzdinį kodą">}}
