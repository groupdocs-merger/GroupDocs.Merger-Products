...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSDX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSDX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSDX puslapius C#"
description: "Pakeiskite VSDX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSDX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSDX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSDX failo puslapius naudojant C# pavyzdinį kodą">}}
