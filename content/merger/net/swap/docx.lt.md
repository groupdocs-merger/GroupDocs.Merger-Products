...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOCX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOCX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOCX puslapius C#"
description: "Pakeiskite DOCX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOCX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais DOCX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOCX failo puslapius naudojant C# pavyzdinį kodą">}}
