...
############################# Head ############################
head_title: "Vyměňte a vyměňte XPS stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XPS v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XPS stránky v C#"
description: "Vyměňte XPS stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XPS stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XPS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XPS pomocí ukázkového kódu C#">}}
