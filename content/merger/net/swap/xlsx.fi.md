...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSX sivua C#"
description: "Vaihda XLSX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
