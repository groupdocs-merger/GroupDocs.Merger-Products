...
############################# Head ############################
head_title: "Vaihda ja vaihda DOTM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOTM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOTM sivua C#"
description: "Vaihda DOTM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOTM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
