...
############################# Head ############################
head_title: "Tausche & tausche DOT Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer DOT-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche DOT Seiten in C#"
description: "Tauschen Sie DOT-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "DOT Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer DOT-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie DOT-Dateiseiten mit C#-Beispielcode aus">}}
