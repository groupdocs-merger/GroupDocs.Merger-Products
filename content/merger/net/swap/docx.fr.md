...
############################# Head ############################
head_title: "Échanger des pages dans des fichiers DOCX à l'aide des applications .NET"
head_description: "Utilisez GroupDocs.Merger for .NET pour réorganiser les pages dans des documents DOCX. Modifiez des fichiers PDF, Word, des tableurs, des présentations, des diagrammes Visio, des images, et bien plus encore."

############################# Header ############################
title: "Échanger des pages DOCX" 
description: "GroupDocs.Merger for .NET étend les applications .NET avec des capacités avancées de gestion de documents. Réorganisez les pages dans des fichiers DOCX pour structurer le contenu exactement comme souhaité."
...
steps:
    ...
    content: |
      Avec [GroupDocs.Merger](/merger/net/), vous pouvez réorganiser les pages dans des documents DOCX pour améliorer la lisibilité et la structure. Ajoutez un traitement de documents efficace à vos applications .NET.
      
      1. Fournir le chemin vers le fichier DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Échanger la première et la dernière page d'un fichier DOCX"
      content: |
        Cet exemple montre comment échanger des pages dans un fichier DOCX en quelques étapes simples.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
