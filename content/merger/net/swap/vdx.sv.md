...
############################# Head ############################
head_title: "Byt och byt ut VDX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VDX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VDX sidor i C#"
description: "Byt VDX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VDX filsidor med hjälp av C# exempelkod">}}
