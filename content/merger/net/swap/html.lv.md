...
############################# Head ############################
head_title: "Apmainīt un apmainīt HTML lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas HTML failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt HTML lapas programmā C#"
description: "Apmainiet HTML lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt HTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām HTML failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt HTML faila lapas, izmantojot C# piemēra kodu">}}
