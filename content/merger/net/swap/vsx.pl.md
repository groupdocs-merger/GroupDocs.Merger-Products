...
############################# Head ############################
head_title: "Zamień i zamień VSX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSX strony w C#"
description: "Zamień strony VSX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSX przy użyciu przykładowego kodu C#">}}
