...
############################# Head ############################
head_title: "Tukar & Tukar XLSB Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSB dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSB Halaman Dalam C#"
description: "Tukar XLSB Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLSB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLSB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSB halaman fail menggunakan kod contoh C#.">}}
