...
############################# Head ############################
head_title: "Tausche & tausche VSDM Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSDM-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSDM Seiten in C#"
description: "Tauschen Sie VSDM-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSDM Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSDM-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSDM-Dateiseiten mit C#-Beispielcode aus">}}
