...
############################# Head ############################
head_title: "Byt och byt ut OTT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en OTT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt OTT sidor i C#"
description: "Byt OTT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt OTT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en OTT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter OTT filsidor med hjälp av C# exempelkod">}}
