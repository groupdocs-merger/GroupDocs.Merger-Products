...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSDM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSDM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSDM stránky v C#"
description: "Vymeňte VSDM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte VSDM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru VSDM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSDM pomocou vzorového kódu C#">}}
