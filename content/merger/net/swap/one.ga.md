...
############################# Head ############################
head_title: "Babhtáil & Malartú ONE Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad ONE in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil ONE Leathanaigh i C#"
description: "Malartú ONE Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil ONE Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad ONE trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ONE a mhalartú le cód samplach C#">}}
