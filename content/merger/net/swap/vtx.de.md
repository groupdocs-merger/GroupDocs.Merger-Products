...
############################# Head ############################
head_title: "Tausche & tausche VTX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VTX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VTX Seiten in C#"
description: "Tauschen Sie VTX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VTX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VTX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VTX-Dateiseiten mit C#-Beispielcode aus">}}
