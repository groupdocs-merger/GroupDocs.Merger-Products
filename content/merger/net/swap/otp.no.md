...
############################# Head ############################
head_title: "Bytt og bytt ut OTP sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en OTP-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt OTP sider i C#"
description: "Bytt OTP-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en OTP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte OTP filsider ved å bruke C# eksempelkode">}}
