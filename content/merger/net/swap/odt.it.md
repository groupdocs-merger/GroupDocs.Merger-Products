...
############################# Head ############################
head_title: "Scambia e scambia ODT pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file ODT in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia ODT pagine in C#"
description: "Scambia le pagine ODT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia ODT pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file ODT implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file ODT utilizzando il codice di esempio C#">}}
