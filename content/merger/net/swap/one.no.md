...
############################# Head ############################
head_title: "Bytt og bytt ut ONE sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en ONE-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt ONE sider i C#"
description: "Bytt ONE-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en ONE-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte ONE filsider ved å bruke C# eksempelkode">}}
