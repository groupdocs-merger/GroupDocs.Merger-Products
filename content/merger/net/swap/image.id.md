...
############################# Head ############################
head_title: "Tukar & Tukarkan IMAGE Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file IMAGE di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar IMAGE Halaman Di C#"
description: "Tukar IMAGE Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar IMAGE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file IMAGE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file IMAGE menggunakan kode contoh C#">}}
