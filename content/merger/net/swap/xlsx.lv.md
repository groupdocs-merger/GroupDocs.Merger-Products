...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLSX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLSX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLSX lapas programmā C#"
description: "Apmainiet XLSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām XLSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLSX faila lapas, izmantojot C# piemēra kodu">}}
