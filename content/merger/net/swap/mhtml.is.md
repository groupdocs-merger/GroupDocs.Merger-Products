...
############################# Head ############################
head_title: "Skiptu og skiptu á MHTML síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í MHTML skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um MHTML síður í C#"
description: "Skiptu um MHTML síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um MHTML skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan MHTML skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um MHTML skráarsíður með því að nota C# dæmikóða">}}
