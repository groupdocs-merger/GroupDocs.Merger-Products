...
############################# Head ############################
head_title: "Cserélj és cserélj VSSM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSSM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSM oldal cseréje a C# nyelven"
description: "Cserélje ki az VSSM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSSM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSSM fájloldalakat a C# példakóddal">}}
