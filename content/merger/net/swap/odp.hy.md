...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել ODP էջեր C#-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը ODP ֆայլում C#-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք ODP էջեր C#-ում"
description: "Փոխեք ODP էջերը մի քանի տող .NET կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք ODP ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# ծրագրավորողների համար էջերը փոխանակել ODP ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել ODP ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Փոխեք ODP ֆայլի էջերը՝ օգտագործելով GroupDocs.Merger API-ը
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Փոխանակեք ODP Ֆայլի էջերը առցանց"
    content: |
       Փոխեք ODP ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) կայքը:
