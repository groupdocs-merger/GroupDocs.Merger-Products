...
############################# Head ############################
head_title: "Tukar & Tukarkan DOC Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOC di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOC Halaman Di C#"
description: "Tukar DOC Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOC Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOC dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOC menggunakan kode contoh C#">}}
