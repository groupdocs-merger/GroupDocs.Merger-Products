...
############################# Head ############################
head_title: "Byt og byt VSSM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSSM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSSM sider i C#"
description: "Byt VSSM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSSM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSSM filsider ved hjælp af C# eksempelkode">}}
