...
############################# Head ############################
head_title: "Zamień i zamień RTF strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku RTF w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień RTF strony w C#"
description: "Zamień strony RTF na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików RTF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku RTF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku RTF przy użyciu przykładowego kodu C#">}}
