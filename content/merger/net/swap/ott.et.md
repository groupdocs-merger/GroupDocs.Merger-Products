...
############################# Head ############################
head_title: "Vahetage ja vahetage OTT lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone OTT failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage OTT lehte keeles C#"
description: "Vahetage OTT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage OTT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis OTT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada OTT faililehte, kasutades C# näitekoodi">}}
