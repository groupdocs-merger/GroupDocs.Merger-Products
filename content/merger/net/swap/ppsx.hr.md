...
############################# Head ############################
head_title: "Zamijeni i razmijeni PPSX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PPSX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PPSX stranice u C#"
description: "Zamijenite PPSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni PPSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar PPSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PPSX stranice datoteke koristeći C# primjer koda">}}
