...
############################# Head ############################
head_title: "Bytt og bytt ut RTF sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en RTF-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt RTF sider i C#"
description: "Bytt RTF-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en RTF-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte RTF filsider ved å bruke C# eksempelkode">}}
