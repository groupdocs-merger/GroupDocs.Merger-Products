...
############################# Head ############################
head_title: "Vaihda ja vaihda DOC sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOC-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOC sivua C#"
description: "Vaihda DOC-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOC tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOC-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOC tiedostosivua käyttämällä C# esimerkkikoodia">}}
