...
############################# Head ############################
head_title: "Tausche & tausche RTF Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer RTF-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche RTF Seiten in C#"
description: "Tauschen Sie RTF-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "RTF Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer RTF-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie RTF-Dateiseiten mit C#-Beispielcode aus">}}
