...
############################# Head ############################
head_title: "Tukar & Tukarkan VSSM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSSM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSM Halaman Di C#"
description: "Tukar VSSM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSSM menggunakan kode contoh C#">}}
