...
############################# Head ############################
head_title: "Zamijeni i razmijeni HTML stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar HTML datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni HTML stranice u C#"
description: "Zamijenite HTML stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni HTML stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar HTML datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti HTML stranice datoteke koristeći C# primjer koda">}}
