...
############################# Head ############################
head_title: "Tukar & Tukar DOCM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOCM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCM Halaman Dalam C#"
description: "Tukar DOCM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar DOCM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail DOCM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOCM halaman fail menggunakan kod contoh C#.">}}
