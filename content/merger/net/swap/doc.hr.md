...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOC stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOC datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOC stranice u C#"
description: "Zamijenite DOC stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOC stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar DOC datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOC stranice datoteke koristeći C# primjer koda">}}
