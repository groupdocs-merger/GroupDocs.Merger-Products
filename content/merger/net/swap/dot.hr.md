...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOT stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOT datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOT stranice u C#"
description: "Zamijenite DOT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar DOT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOT stranice datoteke koristeći C# primjer koda">}}
