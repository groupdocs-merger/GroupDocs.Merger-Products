...
############################# Head ############################
head_title: "Tukar & Tukarkan ODT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file ODT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODT Halaman Di C#"
description: "Tukar ODT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar ODT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file ODT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ODT menggunakan kode contoh C#">}}
