...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOCM lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOCM failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOCM lapas programmā C#"
description: "Apmainiet DOCM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOCM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām DOCM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOCM faila lapas, izmantojot C# piemēra kodu">}}
