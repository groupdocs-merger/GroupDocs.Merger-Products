...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLSM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLSM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLSM stránky v C#"
description: "Vymeňte XLSM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLSM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLSM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLSM pomocou vzorového kódu C#">}}
