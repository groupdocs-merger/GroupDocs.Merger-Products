...
############################# Head ############################
head_title: "تبادل الصفحات DOTM في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف DOTM في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات DOTM في C#"
description: "استبدل الصفحات DOTM ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات DOTM في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف DOTM من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف DOTM باستخدام كود مثال C#">}}
