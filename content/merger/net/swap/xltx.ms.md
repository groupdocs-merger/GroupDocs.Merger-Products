...
############################# Head ############################
head_title: "Tukar & Tukar XLTX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLTX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTX Halaman Dalam C#"
description: "Tukar XLTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLTX halaman fail menggunakan kod contoh C#.">}}
