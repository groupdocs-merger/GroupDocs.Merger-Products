...
############################# Head ############################
head_title: "Vahetage ja vahetage PDF lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PDF failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PDF lehte keeles C#"
description: "Vahetage PDF lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PDF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis PDF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PDF faililehte, kasutades C# näitekoodi">}}
