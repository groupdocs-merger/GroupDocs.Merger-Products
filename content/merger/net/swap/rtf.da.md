...
############################# Head ############################
head_title: "Byt og byt RTF sider i C#"
head_description: "Byt og udveksle positioner på to sider i en RTF-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt RTF sider i C#"
description: "Byt RTF sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en RTF-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du RTF filsider ved hjælp af C# eksempelkode">}}
