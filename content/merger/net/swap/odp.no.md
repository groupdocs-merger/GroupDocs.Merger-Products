...
############################# Head ############################
head_title: "Bytt og bytt ut ODP sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en ODP-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt ODP sider i C#"
description: "Bytt ODP-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en ODP-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte ODP filsider ved å bruke C# eksempelkode">}}
