...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել XLAM էջեր C#-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը XLAM ֆայլում C#-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք XLAM էջեր C#-ում"
description: "Փոխեք XLAM էջերը մի քանի տող .NET կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք XLAM ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# ծրագրավորողների համար էջերը փոխանակել XLAM ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել XLAM ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Փոխեք XLAM ֆայլի էջերը՝ օգտագործելով GroupDocs.Merger API-ը
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Փոխանակեք XLAM Ֆայլի էջերը առցանց"
    content: |
       Փոխեք XLAM ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xlam) կայքը:
