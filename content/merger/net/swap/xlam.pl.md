...
############################# Head ############################
head_title: "Zamień i zamień XLAM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLAM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLAM strony w C#"
description: "Zamień strony XLAM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLAM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLAM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLAM przy użyciu przykładowego kodu C#">}}
