...
############################# Head ############################
head_title: "Vaihda ja vaihda ODP sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ODP-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ODP sivua C#"
description: "Vaihda ODP-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ODP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja ODP-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ODP tiedostosivua käyttämällä C# esimerkkikoodia">}}
