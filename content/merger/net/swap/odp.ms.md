...
############################# Head ############################
head_title: "Tukar & Tukar ODP Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODP dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODP Halaman Dalam C#"
description: "Tukar ODP Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar ODP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail ODP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODP halaman fail menggunakan kod contoh C#.">}}
