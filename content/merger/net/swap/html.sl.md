...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj HTML strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke HTML v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj HTML strani v C#"
description: "Zamenjajte strani HTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke HTML v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki HTML z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke HTML s primerom kode C#">}}
