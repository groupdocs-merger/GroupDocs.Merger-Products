...
############################# Head ############################
head_title: "Vahetage ja vahetage DOC lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOC failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOC lehte keeles C#"
description: "Vahetage DOC lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOC faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOC, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOC faililehte, kasutades C# näitekoodi">}}
