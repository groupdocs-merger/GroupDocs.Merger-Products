...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOT lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOT failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOT lapas programmā C#"
description: "Apmainiet DOT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām DOT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOT faila lapas, izmantojot C# piemēra kodu">}}
