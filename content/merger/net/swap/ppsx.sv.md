...
############################# Head ############################
head_title: "Byt och byt ut PPSX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en PPSX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt PPSX sidor i C#"
description: "Byt PPSX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt PPSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en PPSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter PPSX filsidor med hjälp av C# exempelkod">}}
