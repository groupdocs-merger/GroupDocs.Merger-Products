...
############################# Head ############################
head_title: "Biguherîne û biguherîne HTML Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek HTML de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne HTML Rûpelên Di C# de"
description: "Rûpelên HTML bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de HTML Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên HTML bi karanîna koda nimûneya C# veguhezîne">}}
