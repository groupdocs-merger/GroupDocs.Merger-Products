...
############################# Head ############################
head_title: "Zamień i zamień DOTX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOTX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOTX strony w C#"
description: "Zamień strony DOTX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOTX przy użyciu przykładowego kodu C#">}}
