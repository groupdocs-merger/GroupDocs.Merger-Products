...
############################# Head ############################
head_title: "تبادل الصفحات ONE في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف ONE في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات ONE في C#"
description: "استبدل الصفحات ONE ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات ONE في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف ONE من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف ONE باستخدام كود مثال C#">}}
