...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPT stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPT v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPT stránky v C#"
description: "Vyměňte PPT stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte PPT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru PPT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPT pomocí ukázkového kódu C#">}}
