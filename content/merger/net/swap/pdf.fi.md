...
############################# Head ############################
head_title: "Vaihda ja vaihda PDF sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PDF-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PDF sivua C#"
description: "Vaihda PDF-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PDF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja PDF-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PDF tiedostosivua käyttämällä C# esimerkkikoodia">}}
