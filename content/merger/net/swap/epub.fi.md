...
############################# Head ############################
head_title: "Vaihda ja vaihda EPUB sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja EPUB-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda EPUB sivua C#"
description: "Vaihda EPUB-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda EPUB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja EPUB-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa EPUB tiedostosivua käyttämällä C# esimerkkikoodia">}}
