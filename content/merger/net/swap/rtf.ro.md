...
############################# Head ############################
head_title: "Schimbați și schimbați paginile RTF în C#"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier RTF în C# utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați RTF pagini în C#"
description: "Schimbați paginile RTF cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere RTF în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează ca dezvoltatorii C# să schimbe paginile dintr-un fișier RTF prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere RTF utilizând codul exemplu C#">}}
