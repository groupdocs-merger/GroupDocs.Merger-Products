...
############################# Head ############################
head_title: "Bytt og bytt ut VTX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VTX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VTX sider i C#"
description: "Bytt VTX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VTX filsider ved å bruke C# eksempelkode">}}
