...
############################# Head ############################
head_title: "Scambia e scambia DOT pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file DOT in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia DOT pagine in C#"
description: "Scambia le pagine DOT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia DOT pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file DOT implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file DOT utilizzando il codice di esempio C#">}}
