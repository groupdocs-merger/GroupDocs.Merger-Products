...
############################# Head ############################
head_title: "Zamień i zamień ODT strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ODT w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ODT strony w C#"
description: "Zamień strony ODT na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików ODT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku ODT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ODT przy użyciu przykładowego kodu C#">}}
