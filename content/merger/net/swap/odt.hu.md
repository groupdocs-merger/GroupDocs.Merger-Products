...
############################# Head ############################
head_title: "Cserélj és cserélj ODT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODT oldal cseréje a C# nyelven"
description: "Cserélje ki az ODT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy ODT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODT fájloldalakat a C# példakóddal">}}
