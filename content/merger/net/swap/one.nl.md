...
############################# Head ############################
head_title: "Ruil en ruil ONE pagina's in C#"
head_description: "Wissel en ruil posities van twee pagina's binnen een ONE bestand in C# met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel ONE pagina's in C#"
description: "Verwissel ONE pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verwissel ONE Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een ONE bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ONE bestandspagina's te wisselen met behulp van C# voorbeeldcode">}}
