...
############################# Head ############################
head_title: "Tukar & Tukar PPT Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPT dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPT Halaman Dalam C#"
description: "Tukar PPT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar PPT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail PPT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPT halaman fail menggunakan kod contoh C#.">}}
