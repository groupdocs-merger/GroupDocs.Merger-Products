...
############################# Head ############################
head_title: "Byt og byt DOT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOT sider i C#"
description: "Byt DOT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOT filsider ved hjælp af C# eksempelkode">}}
