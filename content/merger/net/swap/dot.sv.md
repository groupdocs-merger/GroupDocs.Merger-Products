...
############################# Head ############################
head_title: "Byt och byt ut DOT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en DOT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOT sidor i C#"
description: "Byt DOT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt DOT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en DOT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOT filsidor med hjälp av C# exempelkod">}}
