...
############################# Head ############################
head_title: "C# میں PPSX صفحات کی تبادلہ اور تبادلہ"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے C# میں ایک PPSX فائل کے اندر دو صفحات کی پوزیشنوں کو تبدیل اور تبادلہ کریں۔"

############################# Header ############################
title: "PPSX صفحات کو C# میں تبدیل کریں"
description: "PPSX صفحات کو .NET کوڈ کی چند سطروں کے ساتھ تبدیل کریں۔"
...
steps:
    enable: true
    title_left: "PPSX فائل صفحات کو .NET میں تبدیل کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے PPSX فائل کے اندر صفحات کو تبدیل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے PPSX فائل کے صفحات کو کیسے تبدیل کریں۔">}}
