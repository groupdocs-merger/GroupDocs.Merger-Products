...
############################# Head ############################
head_title: "Vaihda ja vaihda DOCM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOCM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOCM sivua C#"
description: "Vaihda DOCM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOCM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOCM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOCM tiedostosivua käyttämällä C# esimerkkikoodia">}}
