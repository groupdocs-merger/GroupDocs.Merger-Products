...
############################# Head ############################
head_title: "تبادل الصفحات VDX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف VDX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات VDX في C#"
description: "استبدل الصفحات VDX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات VDX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف VDX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف VDX باستخدام كود مثال C#">}}
