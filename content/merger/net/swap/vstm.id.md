...
############################# Head ############################
head_title: "Tukar & Tukarkan VSTM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSTM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTM Halaman Di C#"
description: "Tukar VSTM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSTM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSTM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSTM menggunakan kode contoh C#">}}
