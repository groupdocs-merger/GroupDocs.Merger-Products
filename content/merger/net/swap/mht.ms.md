...
############################# Head ############################
head_title: "Tukar & Tukar MHT Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail MHT dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHT Halaman Dalam C#"
description: "Tukar MHT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar MHT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail MHT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar MHT halaman fail menggunakan kod contoh C#.">}}
