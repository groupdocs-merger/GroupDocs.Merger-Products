...
############################# Head ############################
head_title: "Tukar & Tukarkan XLS Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLS di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLS Halaman Di C#"
description: "Tukar XLS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLS menggunakan kode contoh C#">}}
