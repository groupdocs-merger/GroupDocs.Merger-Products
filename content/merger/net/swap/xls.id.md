...
head_title: "Tukar & Tukar Halaman XLS di C# .NET"
head_description: " Pengguna C# .NET untuk menukar dan bertukar posisi dua halaman dalam file XLS menggunakan file split API."

title: "Tukar XLS Halaman di .NET"
description: "Tukar dan tukar posisi dua halaman dalam file XLS menggunakan file splitter API untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Tukar Halaman File XLS di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk bertukar, bertukar, dan mengatur halaman dalam file XLS dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Tukar halaman file XLS menggunakan GroupDocs.Merger API
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Demo Langsung - Tukar Halaman Berkas XLS Online"
    content: |
        Tukar halaman dalam file XLS sekarang juga dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/swap-pages/XLS).
