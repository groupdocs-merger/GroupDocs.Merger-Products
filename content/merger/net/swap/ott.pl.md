...
############################# Head ############################
head_title: "Zamień i zamień OTT strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku OTT w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień OTT strony w C#"
description: "Zamień strony OTT na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików OTT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku OTT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku OTT przy użyciu przykładowego kodu C#">}}
