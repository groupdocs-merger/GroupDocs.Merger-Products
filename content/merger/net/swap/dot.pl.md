...
############################# Head ############################
head_title: "Zamień i zamień DOT strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOT w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOT strony w C#"
description: "Zamień strony DOT na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOT przy użyciu przykładowego kodu C#">}}
