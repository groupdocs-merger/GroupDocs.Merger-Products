...
############################# Head ############################
head_title: "Byt och byt ut ONE sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en ONE-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt ONE sidor i C#"
description: "Byt ONE-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt ONE filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en ONE-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter ONE filsidor med hjälp av C# exempelkod">}}
