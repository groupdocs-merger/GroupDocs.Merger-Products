...
############################# Head ############################
head_title: "Zamień i zamień PPS strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPS w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPS strony w C#"
description: "Zamień strony PPS na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku PPS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPS przy użyciu przykładowego kodu C#">}}
