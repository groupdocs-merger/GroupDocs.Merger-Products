...
############################# Head ############################
head_title: "Tukar & Tukarkan ODP Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file ODP di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODP Halaman Di C#"
description: "Tukar ODP Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar ODP Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file ODP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ODP menggunakan kode contoh C#">}}
