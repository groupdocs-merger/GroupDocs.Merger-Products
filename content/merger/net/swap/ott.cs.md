...
############################# Head ############################
head_title: "Vyměňte a vyměňte OTT stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru OTT v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit OTT stránky v C#"
description: "Vyměňte OTT stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte OTT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru OTT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru OTT pomocí ukázkového kódu C#">}}
