...
############################# Head ############################
head_title: "Vaihda ja vaihda VTX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VTX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VTX sivua C#"
description: "Vaihda VTX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VTX tiedostosivua käyttämällä C# esimerkkikoodia">}}
