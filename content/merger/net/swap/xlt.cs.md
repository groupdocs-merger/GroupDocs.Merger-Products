...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLT stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLT v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLT stránky v C#"
description: "Vyměňte XLT stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLT pomocí ukázkového kódu C#">}}
