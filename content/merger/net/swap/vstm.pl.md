...
############################# Head ############################
head_title: "Zamień i zamień VSTM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSTM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSTM strony w C#"
description: "Zamień strony VSTM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSTM przy użyciu przykładowego kodu C#">}}
