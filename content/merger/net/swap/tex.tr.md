...
############################# Head ############################
head_title: "TEX Sayfalarını C# İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir TEX dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "TEX Sayfayı C# İçinde Değiştir"
description: "TEX Sayfalarını birkaç satır .NET koduyla değiştirin."
...
steps:
    enable: true
    title_left: ".NET içindeki TEX Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir TEX dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TEX dosya sayfaları nasıl değiştirilir?">}}
