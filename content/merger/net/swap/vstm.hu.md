...
############################# Head ############################
head_title: "Cserélj és cserélj VSTM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSTM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTM oldal cseréje a C# nyelven"
description: "Cserélje ki az VSTM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSTM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSTM fájloldalakat a C# példakóddal">}}
