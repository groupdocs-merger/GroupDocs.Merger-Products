...
############################# Head ############################
head_title: "Byt og byt VTX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VTX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VTX sider i C#"
description: "Byt VTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VTX filsider ved hjælp af C# eksempelkode">}}
