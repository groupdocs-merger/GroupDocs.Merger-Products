...
############################# Head ############################
head_title: "Scambia e scambia OTT pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file OTT in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia OTT pagine in C#"
description: "Scambia le pagine OTT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia OTT pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file OTT implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file OTT utilizzando il codice di esempio C#">}}
