...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPTX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPTX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPTX stránky v C#"
description: "Vyměňte PPTX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte PPTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru PPTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPTX pomocí ukázkového kódu C#">}}
