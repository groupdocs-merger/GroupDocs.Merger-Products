...
############################# Head ############################
head_title: "Cserélj és cserélj MHT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy MHT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHT oldal cseréje a C# nyelven"
description: "Cserélje ki az MHT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "MHT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy MHT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk MHT fájloldalakat a C# példakóddal">}}
