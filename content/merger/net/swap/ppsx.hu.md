...
############################# Head ############################
head_title: "Cserélj és cserélj PPSX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PPSX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPSX oldal cseréje a C# nyelven"
description: "Cserélje ki az PPSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPSX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy PPSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PPSX fájloldalakat a C# példakóddal">}}
