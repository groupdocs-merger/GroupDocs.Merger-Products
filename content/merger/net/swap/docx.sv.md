...
############################# Head ############################
head_title: "Byt och byt ut DOCX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en DOCX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOCX sidor i C#"
description: "Byt DOCX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt DOCX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en DOCX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOCX filsidor med hjälp av C# exempelkod">}}
