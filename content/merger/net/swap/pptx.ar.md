...
############################# Head ############################
head_title: "تبادل الصفحات PPTX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف PPTX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات PPTX في C#"
description: "استبدل الصفحات PPTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات PPTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف PPTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف PPTX باستخدام كود مثال C#">}}
