...
############################# Head ############################
head_title: "Apmainīt un apmainīt EPUB lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas EPUB failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt EPUB lapas programmā C#"
description: "Apmainiet EPUB lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt EPUB faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām EPUB failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt EPUB faila lapas, izmantojot C# piemēra kodu">}}
