...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSX stranice u C#"
description: "Zamijenite VSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSX stranice datoteke koristeći C# primjer koda">}}
