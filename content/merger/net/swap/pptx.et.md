...
############################# Head ############################
head_title: "Vahetage ja vahetage PPTX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPTX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPTX lehte keeles C#"
description: "Vahetage PPTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis PPTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPTX faililehte, kasutades C# näitekoodi">}}
