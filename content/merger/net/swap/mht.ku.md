...
############################# Head ############################
head_title: "Biguherîne û biguherîne MHT Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek MHT de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne MHT Rûpelên Di C# de"
description: "Rûpelên MHT bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de MHT Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên MHT bi karanîna koda nimûneya C# veguhezîne">}}
