...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj VSTX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke VSTX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj VSTX strani v C#"
description: "Zamenjajte strani VSTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke VSTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki VSTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke VSTX s primerom kode C#">}}
