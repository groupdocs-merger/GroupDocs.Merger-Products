...
############################# Head ############################
head_title: "Tukar & Tukar TEX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail TEX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar TEX Halaman Dalam C#"
description: "Tukar TEX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar TEX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail TEX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar TEX halaman fail menggunakan kod contoh C#.">}}
