...
############################# Head ############################
head_title: "Vymeňte a vymeňte XPS stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XPS v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XPS stránky v C#"
description: "Vymeňte XPS stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XPS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XPS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XPS pomocou vzorového kódu C#">}}
