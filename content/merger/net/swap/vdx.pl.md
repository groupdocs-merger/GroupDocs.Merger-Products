...
############################# Head ############################
head_title: "Zamień i zamień VDX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VDX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VDX strony w C#"
description: "Zamień strony VDX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VDX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VDX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VDX przy użyciu przykładowego kodu C#">}}
