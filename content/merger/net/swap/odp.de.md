...
############################# Head ############################
head_title: "Tausche & tausche ODP Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer ODP-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche ODP Seiten in C#"
description: "Tauschen Sie ODP-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "ODP Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer ODP-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie ODP-Dateiseiten mit C#-Beispielcode aus">}}
