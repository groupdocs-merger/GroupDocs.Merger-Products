...
############################# Head ############################
head_title: "Swap & Exchange DOCX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a DOCX file in C# using the documents merger API."

############################# Header ############################
title: "Swap DOCX Pages In C#"
description: "Swap DOCX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a DOCX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap DOCX file pages using C# example code">}}
