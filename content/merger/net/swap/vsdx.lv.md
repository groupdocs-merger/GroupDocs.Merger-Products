...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSDX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSDX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSDX lapas programmā C#"
description: "Apmainiet VSDX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSDX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām VSDX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSDX faila lapas, izmantojot C# piemēra kodu">}}
