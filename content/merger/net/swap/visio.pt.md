...
############################# Head ############################
head_title: "Troque páginas em arquivos VISIO usando aplicativos .NET"
head_description: "Use o GroupDocs.Merger for .NET para reorganizar páginas em documentos VISIO. Modifique PDFs, arquivos Word, planilhas, apresentações, diagramas Visio, imagens e muito mais."

############################# Header ############################
title: "Troque páginas VISIO" 
description: "GroupDocs.Merger for .NET expande as aplicações .NET com recursos avançados de gerenciamento de documentos. Reorganize páginas em arquivos VISIO para estruturar o conteúdo exatamente como necessário."
...
steps:
    ...
    content: |
      Com [GroupDocs.Merger](/merger/net/), você pode reorganizar páginas em documentos VISIO para melhorar a legibilidade e a estrutura. Adicione processamento de documentos eficiente às suas aplicações .NET.
      
      1. Forneça o caminho para o arquivo VISIO.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trocar a primeira e a última páginas de um arquivo VISIO"
      content: |
        Este exemplo demonstra como trocar páginas em um arquivo VISIO em alguns passos simples.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
