...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLT lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLT failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLT lapas programmā C#"
description: "Apmainiet XLT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām XLT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLT faila lapas, izmantojot C# piemēra kodu">}}
