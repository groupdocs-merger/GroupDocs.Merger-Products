...
############################# Head ############################
head_title: "Vahetage ja vahetage DOTX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOTX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOTX lehte keeles C#"
description: "Vahetage DOTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOTX faililehte, kasutades C# näitekoodi">}}
