...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPS puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPS faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPS puslapius C#"
description: "Pakeiskite PPS puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais PPS faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPS failo puslapius naudojant C# pavyzdinį kodą">}}
