...
############################# Head ############################
head_title: "Tausche & tausche VISIO Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VISIO-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VISIO Seiten in C#"
description: "Tauschen Sie VISIO-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VISIO Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VISIO-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VISIO-Dateiseiten mit C#-Beispielcode aus">}}
