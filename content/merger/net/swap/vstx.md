...
############################# Head ############################
head_title: "Swap & Exchange VSTX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSTX file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSTX Pages In C#"
description: "Swap VSTX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSTX file pages using C# example code">}}
