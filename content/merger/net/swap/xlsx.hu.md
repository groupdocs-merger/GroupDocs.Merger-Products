...
############################# Head ############################
head_title: "Cserélj és cserélj XLSX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSX oldal cseréje a C# nyelven"
description: "Cserélje ki az XLSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLSX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSX fájloldalakat a C# példakóddal">}}
