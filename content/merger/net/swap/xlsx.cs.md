...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLSX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLSX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLSX stránky v C#"
description: "Vyměňte XLSX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLSX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLSX pomocí ukázkového kódu C#">}}
