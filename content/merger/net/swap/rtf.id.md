...
############################# Head ############################
head_title: "Tukar & Tukarkan RTF Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file RTF di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar RTF Halaman Di C#"
description: "Tukar RTF Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar RTF Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file RTF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file RTF menggunakan kode contoh C#">}}
