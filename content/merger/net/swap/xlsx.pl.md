...
############################# Head ############################
head_title: "Zamień i zamień XLSX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSX strony w C#"
description: "Zamień strony XLSX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSX przy użyciu przykładowego kodu C#">}}
