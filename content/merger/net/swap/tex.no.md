...
############################# Head ############################
head_title: "Bytt og bytt ut TEX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en TEX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt TEX sider i C#"
description: "Bytt TEX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en TEX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte TEX filsider ved å bruke C# eksempelkode">}}
