...
############################# Head ############################
head_title: "Vyměňte a vyměňte HTML stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru HTML v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit HTML stránky v C#"
description: "Vyměňte HTML stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte HTML stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru HTML provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru HTML pomocí ukázkového kódu C#">}}
