...
############################# Head ############################
head_title: "Cserélj és cserélj VSX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSX oldal cseréje a C# nyelven"
description: "Cserélje ki az VSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSX fájloldalakat a C# példakóddal">}}
