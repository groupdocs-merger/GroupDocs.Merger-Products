...
############################# Head ############################
head_title: "Swap & Exchange WORD Pages in C#"
head_description: "Swap & Exchange positions of two pages within a WORD file in C# using the documents merger API."

############################# Header ############################
title: "Swap WORD Pages In C#"
description: "Swap WORD Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a WORD file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap WORD file pages using C# example code">}}
