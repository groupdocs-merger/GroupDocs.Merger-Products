...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSSX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSSX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSSX puslapius C#"
description: "Pakeiskite VSSX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSSX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSSX failo puslapius naudojant C# pavyzdinį kodą">}}
