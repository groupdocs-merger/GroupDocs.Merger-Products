...
############################# Head ############################
head_title: "Cserélj és cserélj XLTX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLTX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTX oldal cseréje a C# nyelven"
description: "Cserélje ki az XLTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLTX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLTX fájloldalakat a C# példakóddal">}}
