...
############################# Head ############################
head_title: "Ruil en ruil XLSB bladsye in C#"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLSB-lêer in C# met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLSB bladsye in C#"
description: "Ruil XLSB Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Ruil XLSB lêerbladsye om in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n XLSB-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSB lêerbladsye om te ruil met behulp van C# voorbeeldkode">}}
