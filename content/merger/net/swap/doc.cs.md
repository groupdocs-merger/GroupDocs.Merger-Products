...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOC stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOC v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOC stránky v C#"
description: "Vyměňte DOC stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte DOC stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru DOC provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOC pomocí ukázkového kódu C#">}}
