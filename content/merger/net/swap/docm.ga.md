...
############################# Head ############################
head_title: "Babhtáil & Malartú DOCM Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad DOCM in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil DOCM Leathanaigh i C#"
description: "Malartú DOCM Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil DOCM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad DOCM trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOCM a mhalartú le cód samplach C#">}}
