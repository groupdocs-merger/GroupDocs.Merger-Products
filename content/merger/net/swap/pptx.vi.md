...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng hoán đổi các trang trong một tệp PPTX bằng cách thực hiện một vài bước đơn giản .
