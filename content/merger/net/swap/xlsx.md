...
############################# Head ############################
head_title: "Swap & Exchange XLSX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a XLSX file in C# using the documents merger API."

############################# Header ############################
title: "Swap XLSX Pages In C#"
description: "Swap XLSX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a XLSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XLSX file pages using C# example code">}}
