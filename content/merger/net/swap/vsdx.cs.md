...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSDX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSDX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSDX stránky v C#"
description: "Vyměňte VSDX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSDX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSDX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSDX pomocí ukázkového kódu C#">}}
