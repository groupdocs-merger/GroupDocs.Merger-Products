...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLSB puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLSB faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLSB puslapius C#"
description: "Pakeiskite XLSB puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLSB failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLSB faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLSB failo puslapius naudojant C# pavyzdinį kodą">}}
