...
############################# Head ############################
head_title: "Byt og byt ODP sider i C#"
head_description: "Byt og udveksle positioner på to sider i en ODP-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt ODP sider i C#"
description: "Byt ODP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en ODP-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du ODP filsider ved hjælp af C# eksempelkode">}}
