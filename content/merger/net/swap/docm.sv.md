...
############################# Head ############################
head_title: "Byt och byt ut DOCM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en DOCM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOCM sidor i C#"
description: "Byt DOCM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt DOCM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en DOCM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOCM filsidor med hjälp av C# exempelkod">}}
