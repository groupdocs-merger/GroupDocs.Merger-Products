...
############################# Head ############################
head_title: "Babhtáil & Malartú ODP Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad ODP in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil ODP Leathanaigh i C#"
description: "Malartú ODP Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil ODP Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad ODP trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid ODP a mhalartú le cód samplach C#">}}
