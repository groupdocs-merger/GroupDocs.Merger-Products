...
############################# Head ############################
head_title: "Byt og byt MHTML sider i C#"
head_description: "Byt og udveksle positioner på to sider i en MHTML-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt MHTML sider i C#"
description: "Byt MHTML sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en MHTML-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du MHTML filsider ved hjælp af C# eksempelkode">}}
