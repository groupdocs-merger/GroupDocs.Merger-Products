...
############################# Head ############################
head_title: "Zamień i zamień VSTX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSTX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSTX strony w C#"
description: "Zamień strony VSTX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSTX przy użyciu przykładowego kodu C#">}}
