...
############################# Head ############################
head_title: "Tukar & Tukar VSDX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSDX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDX Halaman Dalam C#"
description: "Tukar VSDX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VSDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VSDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSDX halaman fail menggunakan kod contoh C#.">}}
