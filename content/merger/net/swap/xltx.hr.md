...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLTX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLTX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLTX stranice u C#"
description: "Zamijenite XLTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XLTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLTX stranice datoteke koristeći C# primjer koda">}}
