...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOTX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOTX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOTX stranice u C#"
description: "Zamijenite DOTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar DOTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOTX stranice datoteke koristeći C# primjer koda">}}
