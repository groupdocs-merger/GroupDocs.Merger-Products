...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSSX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSSX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSSX stranice u C#"
description: "Zamijenite VSSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSSX stranice datoteke koristeći C# primjer koda">}}
