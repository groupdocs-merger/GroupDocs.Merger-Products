...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj MHT strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke MHT v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj MHT strani v C#"
description: "Zamenjajte strani MHT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke MHT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki MHT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke MHT s primerom kode C#">}}
