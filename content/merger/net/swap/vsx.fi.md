...
############################# Head ############################
head_title: "Vaihda ja vaihda VSX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSX sivua C#"
description: "Vaihda VSX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
