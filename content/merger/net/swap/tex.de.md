...
############################# Head ############################
head_title: "Tausche & tausche TEX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer TEX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche TEX Seiten in C#"
description: "Tauschen Sie TEX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "TEX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer TEX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie TEX-Dateiseiten mit C#-Beispielcode aus">}}
