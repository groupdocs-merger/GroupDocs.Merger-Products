...
############################# Head ############################
head_title: "Apmainīt un apmainīt TEX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas TEX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt TEX lapas programmā C#"
description: "Apmainiet TEX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt TEX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām TEX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt TEX faila lapas, izmantojot C# piemēra kodu">}}
