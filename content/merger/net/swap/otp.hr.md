...
############################# Head ############################
head_title: "Zamijeni i razmijeni OTP stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar OTP datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni OTP stranice u C#"
description: "Zamijenite OTP stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni OTP stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar OTP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti OTP stranice datoteke koristeći C# primjer koda">}}
