...
############################# Head ############################
head_title: "Byt och byt ut MHTML sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en MHTML-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt MHTML sidor i C#"
description: "Byt MHTML-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt MHTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en MHTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter MHTML filsidor med hjälp av C# exempelkod">}}
