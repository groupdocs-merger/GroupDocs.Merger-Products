...
############################# Head ############################
head_title: "Bytt og bytt ut PDF sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en PDF-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PDF sider i C#"
description: "Bytt PDF-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en PDF-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PDF filsider ved å bruke C# eksempelkode">}}
