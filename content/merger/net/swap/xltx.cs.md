...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLTX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLTX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLTX stránky v C#"
description: "Vyměňte XLTX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLTX pomocí ukázkového kódu C#">}}
