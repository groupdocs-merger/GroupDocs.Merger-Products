...
############################# Head ############################
head_title: "Apmainīt un apmainīt OTP lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas OTP failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt OTP lapas programmā C#"
description: "Apmainiet OTP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt OTP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām OTP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt OTP faila lapas, izmantojot C# piemēra kodu">}}
