...
############################# Head ############################
head_title: "Skiptu og skiptu á XPS síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í XPS skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um XPS síður í C#"
description: "Skiptu um XPS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um XPS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan XPS skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um XPS skráarsíður með því að nota C# dæmikóða">}}
