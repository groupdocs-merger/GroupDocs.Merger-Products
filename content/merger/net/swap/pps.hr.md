...
############################# Head ############################
head_title: "Zamijeni i razmijeni PPS stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PPS datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PPS stranice u C#"
description: "Zamijenite PPS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni PPS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar PPS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PPS stranice datoteke koristeći C# primjer koda">}}
