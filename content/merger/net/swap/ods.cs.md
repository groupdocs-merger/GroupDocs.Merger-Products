...
############################# Head ############################
head_title: "Vyměňte a vyměňte ODS stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ODS v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ODS stránky v C#"
description: "Vyměňte ODS stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte ODS stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru ODS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ODS pomocí ukázkového kódu C#">}}
