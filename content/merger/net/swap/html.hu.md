...
############################# Head ############################
head_title: "Cserélj és cserélj HTML oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy HTML fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "HTML oldal cseréje a C# nyelven"
description: "Cserélje ki az HTML oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "HTML fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy HTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk HTML fájloldalakat a C# példakóddal">}}
