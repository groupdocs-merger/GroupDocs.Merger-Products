...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj OTT strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke OTT v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj OTT strani v C#"
description: "Zamenjajte strani OTT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke OTT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki OTT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke OTT s primerom kode C#">}}
