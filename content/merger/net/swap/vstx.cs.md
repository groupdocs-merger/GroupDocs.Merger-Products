...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSTX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSTX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSTX stránky v C#"
description: "Vyměňte VSTX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSTX pomocí ukázkového kódu C#">}}
