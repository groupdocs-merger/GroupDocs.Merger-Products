...
############################# Head ############################
head_title: "Swap & Exchange XLTM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a XLTM file in C# using the documents merger API."

############################# Header ############################
title: "Swap XLTM Pages In C#"
description: "Swap XLTM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a XLTM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XLTM file pages using C# example code">}}
