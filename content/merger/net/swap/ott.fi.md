...
############################# Head ############################
head_title: "Vaihda ja vaihda OTT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja OTT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda OTT sivua C#"
description: "Vaihda OTT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda OTT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja OTT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa OTT tiedostosivua käyttämällä C# esimerkkikoodia">}}
