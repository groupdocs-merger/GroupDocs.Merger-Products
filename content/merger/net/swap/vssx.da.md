...
############################# Head ############################
head_title: "Byt og byt VSSX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSSX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSSX sider i C#"
description: "Byt VSSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSSX filsider ved hjælp af C# eksempelkode">}}
