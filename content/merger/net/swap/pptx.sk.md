...
############################# Head ############################
head_title: "Vymeňte a vymeňte PPTX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore PPTX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte PPTX stránky v C#"
description: "Vymeňte PPTX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte PPTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru PPTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru PPTX pomocou vzorového kódu C#">}}
