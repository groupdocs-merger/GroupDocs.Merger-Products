...
############################# Head ############################
head_title: "Tukar & Tukar XLAM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLAM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLAM Halaman Dalam C#"
description: "Tukar XLAM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLAM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLAM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLAM halaman fail menggunakan kod contoh C#.">}}
