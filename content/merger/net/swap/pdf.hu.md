...
############################# Head ############################
head_title: "Cserélj és cserélj PDF oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PDF fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PDF oldal cseréje a C# nyelven"
description: "Cserélje ki az PDF oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PDF fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy PDF fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PDF fájloldalakat a C# példakóddal">}}
