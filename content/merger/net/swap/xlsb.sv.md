...
############################# Head ############################
head_title: "Byt och byt ut XLSB sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLSB-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLSB sidor i C#"
description: "Byt XLSB-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLSB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLSB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLSB filsidor med hjälp av C# exempelkod">}}
