...
draft: false
############################# Head ############################
head_title: "Обмен XPS-страницами в C# .NET"
head_description: " Пользователи C# .NET могут менять местами две страницы в XPS-файле с помощью API разделения файлов."
############################# Header ############################
title: "Обмен XPS-страницами в .NET"
description: "Меняйте местами две страницы в XPS-файле с помощью API-интерфейса файлового разделителя для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов XPS в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко менять местами, обмениваться и упорядочивать страницы в файле XPS, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Поменяйте местами страницы в файлах XPS прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/xps). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
