...
############################# Head ############################
head_title: "Intercambiar e intercambiar OTT páginas en C#"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo OTT en C# utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar OTT páginas en C#"
description: "Intercambie OTT páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Intercambiar OTT páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# intercambiar páginas dentro de un archivo OTT mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos OTT usando el código de ejemplo C#">}}
