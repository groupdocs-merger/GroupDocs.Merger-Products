...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj VTX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke VTX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj VTX strani v C#"
description: "Zamenjajte strani VTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke VTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki VTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke VTX s primerom kode C#">}}
