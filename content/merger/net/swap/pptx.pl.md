...
############################# Head ############################
head_title: "Zamień i zamień PPTX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPTX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPTX strony w C#"
description: "Zamień strony PPTX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku PPTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPTX przy użyciu przykładowego kodu C#">}}
