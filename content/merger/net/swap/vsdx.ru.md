...
draft: false
############################# Head ############################
head_title: "Обмен и обмен страницами VSDX в C# .NET"
head_description: " Пользователи C# .NET могут обмениваться позициями двух страниц в файле VSDX с помощью API разделения файлов."
############################# Header ############################
title: "Поменять местами страницы VSDX в .NET"
description: "Меняйте местами и меняйте местами две страницы в файле VSDX с помощью API-разделителя файлов для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов VSDX в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко менять местами, обмениваться и упорядочивать страницы в файле VSDX, выполняя несколько простых шагов.
    ...
    code: |
        ```cs
        // Поменять местами страницы файла VSDX с помощью API GroupDocs.Merger
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Живые демонстрации — замена страниц файлов VSDX онлайн"
    content: |
        Поменяйте местами страницы в файлах VSDX прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/vsdx). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
