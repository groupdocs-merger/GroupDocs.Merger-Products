...
############################# Head ############################
head_title: "Bytt og bytt ut EPUB sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en EPUB-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt EPUB sider i C#"
description: "Bytt EPUB-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en EPUB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte EPUB filsider ved å bruke C# eksempelkode">}}
