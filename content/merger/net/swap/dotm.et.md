...
############################# Head ############################
head_title: "Vahetage ja vahetage DOTM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOTM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOTM lehte keeles C#"
description: "Vahetage DOTM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOTM faililehte, kasutades C# näitekoodi">}}
