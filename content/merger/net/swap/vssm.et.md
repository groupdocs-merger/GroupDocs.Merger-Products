...
############################# Head ############################
head_title: "Vahetage ja vahetage VSSM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSSM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSSM lehte keeles C#"
description: "Vahetage VSSM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSSM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSSM faililehte, kasutades C# näitekoodi">}}
