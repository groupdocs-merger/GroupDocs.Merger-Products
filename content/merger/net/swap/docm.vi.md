...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET]({{sl slash_lang}}/merge/net/) giúp các nhà phát triển C# dễ dàng hoán đổi các trang trong một tệp DOCM bằng cách thực hiện một vài bước đơn giản .
