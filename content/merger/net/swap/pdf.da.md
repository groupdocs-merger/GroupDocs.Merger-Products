...
############################# Head ############################
head_title: "Byt og byt PDF sider i C#"
head_description: "Byt og udveksle positioner på to sider i en PDF-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PDF sider i C#"
description: "Byt PDF sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en PDF-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PDF filsider ved hjælp af C# eksempelkode">}}
