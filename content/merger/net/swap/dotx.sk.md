...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOTX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOTX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOTX stránky v C#"
description: "Vymeňte DOTX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte DOTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru DOTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOTX pomocou vzorového kódu C#">}}
