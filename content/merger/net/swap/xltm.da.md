...
############################# Head ############################
head_title: "Byt og byt XLTM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLTM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLTM sider i C#"
description: "Byt XLTM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLTM filsider ved hjælp af C# eksempelkode">}}
