...
############################# Head ############################
head_title: "Sukeiskite ir keiskite EPUB puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas EPUB faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti EPUB puslapius C#"
description: "Pakeiskite EPUB puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti EPUB failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais EPUB faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti EPUB failo puslapius naudojant C# pavyzdinį kodą">}}
