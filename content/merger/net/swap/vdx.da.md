...
############################# Head ############################
head_title: "Byt og byt VDX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VDX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VDX sider i C#"
description: "Byt VDX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VDX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VDX filsider ved hjælp af C# eksempelkode">}}
