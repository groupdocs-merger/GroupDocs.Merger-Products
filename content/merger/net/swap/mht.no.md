...
############################# Head ############################
head_title: "Bytt og bytt ut MHT sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en MHT-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt MHT sider i C#"
description: "Bytt MHT-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en MHT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte MHT filsider ved å bruke C# eksempelkode">}}
