...
############################# Head ############################
head_title: "Vaihda ja vaihda MHTML sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja MHTML-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda MHTML sivua C#"
description: "Vaihda MHTML-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda MHTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja MHTML-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa MHTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
