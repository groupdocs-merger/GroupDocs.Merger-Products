...
############################# Head ############################
head_title: "Bytt og bytt ut XLSX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLSX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLSX sider i C#"
description: "Bytt XLSX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLSX filsider ved å bruke C# eksempelkode">}}
