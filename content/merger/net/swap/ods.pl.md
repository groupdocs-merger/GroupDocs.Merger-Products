...
############################# Head ############################
head_title: "Zamień i zamień ODS strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ODS w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ODS strony w C#"
description: "Zamień strony ODS na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików ODS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku ODS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ODS przy użyciu przykładowego kodu C#">}}
