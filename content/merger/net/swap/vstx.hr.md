...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSTX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSTX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSTX stranice u C#"
description: "Zamijenite VSTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSTX stranice datoteke koristeći C# primjer koda">}}
