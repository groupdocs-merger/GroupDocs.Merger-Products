...
############################# Head ############################
head_title: "Skiptu og skiptu á VSTX síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í VSTX skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um VSTX síður í C#"
description: "Skiptu um VSTX síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um VSTX skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan VSTX skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um VSTX skráarsíður með því að nota C# dæmikóða">}}
