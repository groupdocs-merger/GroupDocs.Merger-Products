...
draft: false
############################# Head ############################
head_title: "Swap & Exchange PPSM Pages в C# .NET"
head_description: " Пользователи C# .NET могут менять местами две страницы в файле PPSM с помощью API разделения файлов."
############################# Header ############################
title: "Поменять местами страницы PPSM в .NET"
description: "Меняйте местами две страницы в файле PPSM с помощью API-интерфейса файлового разделителя для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов PPSM в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко менять местами, обмениваться и упорядочивать страницы в файле PPSM, выполняя несколько простых шагов.
    ...
    code: |
        ```cs
        // Поменять местами страницы файла PPSM с помощью API GroupDocs.Merger
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Демонстрации в реальном времени - Обмен страницами файлов PPSM онлайн"
    content: |
        Поменяйте местами страницы в файлах PPSM прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/ppsm). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
