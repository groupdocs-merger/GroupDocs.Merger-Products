...
############################# Head ############################
head_title: "Поменяйте местами OTT страницы на C#"
head_description: "Поменяйте местами и обменяйте позиции двух страниц в файле OTT на C#, используя Merger API."

############################# Header ############################
title: "Поменять местами OTT страницы на C#"
description: "Поменять местами OTT страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Поменять местами страницы OTT документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# обмениваться страницами в файле OTT, выполняя несколько простых шагов. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как поменять местами страницы OTT документов, используя пример кода C#">}}
