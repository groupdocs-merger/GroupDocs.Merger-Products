...
############################# Head ############################
head_title: "Biguherîne û biguherîne RTF Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek RTF de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne RTF Rûpelên Di C# de"
description: "Rûpelên RTF bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de RTF Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek RTF de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên RTF bi karanîna koda nimûneya C# veguhezîne">}}
