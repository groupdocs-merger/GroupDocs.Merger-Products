...
############################# Head ############################
head_title: "Zamień i zamień XLSB strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSB w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSB strony w C#"
description: "Zamień strony XLSB na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSB w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLSB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSB przy użyciu przykładowego kodu C#">}}
