...
############################# Head ############################
head_title: "使用 .NET 应用程序在 PDF 文件中交换页面"
head_description: "使用 GroupDocs.Merger for .NET 重新排序 PDF 文档中的页面。修改 PDF、Word 文件、电子表格、演示文稿、Visio 图表、图像等。"

############################# Header ############################
title: "交换 PDF 页面" 
description: "GroupDocs.Merger for .NET 为 .NET 应用程序扩展了先进的文档管理功能。重新排列 PDF 文件中的页面，以便准确结构化内容。"
...
steps:
    enable: true
    title: "如何重新排列 PDF 页面的步骤"
    content: |
      借助 [GroupDocs.Merger](/merger/net/)，您可以重新组织 PDF 文档中的页面，以提升可读性和结构性。为您的 .NET 应用程序添加高效的文档处理功能。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "在 PDF 文件中交换第一页和最后一页"
      content: |
        此示例演示如何在几个简单步骤中交换 PDF 文件的页面。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
