...
############################# Head ############################
head_title: "Vaihda ja vaihda OTP sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja OTP-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda OTP sivua C#"
description: "Vaihda OTP-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda OTP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja OTP-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa OTP tiedostosivua käyttämällä C# esimerkkikoodia">}}
