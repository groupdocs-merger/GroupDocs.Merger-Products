...
############################# Head ############################
head_title: "Byt och byt ut ODS sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en ODS-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt ODS sidor i C#"
description: "Byt ODS-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt ODS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en ODS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter ODS filsidor med hjälp av C# exempelkod">}}
