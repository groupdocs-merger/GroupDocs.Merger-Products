...
############################# Head ############################
head_title: "تبادل الصفحات EPUB في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف EPUB في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات EPUB في C#"
description: "استبدل الصفحات EPUB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات EPUB في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف EPUB من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف EPUB باستخدام كود مثال C#">}}
