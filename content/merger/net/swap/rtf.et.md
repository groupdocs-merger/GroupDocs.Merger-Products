...
############################# Head ############################
head_title: "Vahetage ja vahetage RTF lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone RTF failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage RTF lehte keeles C#"
description: "Vahetage RTF lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage RTF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis RTF, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada RTF faililehte, kasutades C# näitekoodi">}}
