...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSTM lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSTM failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSTM lapas programmā C#"
description: "Apmainiet VSTM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām VSTM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSTM faila lapas, izmantojot C# piemēra kodu">}}
