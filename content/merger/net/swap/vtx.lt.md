...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VTX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VTX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VTX puslapius C#"
description: "Pakeiskite VTX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VTX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VTX failo puslapius naudojant C# pavyzdinį kodą">}}
