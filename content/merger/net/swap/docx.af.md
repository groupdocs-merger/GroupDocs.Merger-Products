...
############################# Head ############################
head_title: "Ruil en ruil DOCX bladsye in C#"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n DOCX-lêer in C# met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil DOCX bladsye in C#"
description: "Ruil DOCX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Ruil DOCX lêerbladsye om in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n DOCX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCX lêerbladsye om te ruil met behulp van C# voorbeeldkode">}}
