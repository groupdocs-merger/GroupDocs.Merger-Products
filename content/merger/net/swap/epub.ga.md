...
############################# Head ############################
head_title: "Babhtáil & Malartú EPUB Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad EPUB in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil EPUB Leathanaigh i C#"
description: "Malartú EPUB Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil EPUB Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad EPUB trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid EPUB a mhalartú le cód samplach C#">}}
