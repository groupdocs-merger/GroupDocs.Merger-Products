...
############################# Head ############################
head_title: "Swap & Exchange ODS Pages in C#"
head_description: "Swap & Exchange positions of two pages within a ODS file in C# using the documents merger API."

############################# Header ############################
title: "Swap ODS Pages In C#"
description: "Swap ODS Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a ODS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ODS file pages using C# example code">}}
