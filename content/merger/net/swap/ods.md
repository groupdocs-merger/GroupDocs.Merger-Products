...
############################# Head ############################
head_title: "Swap & Exchange ODS Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a ODS file using the file split API."

############################# Header ############################
title: "Swap ODS Pages in .NET"
description: "Swap and exchange positions of two pages within a ODS file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a ODS file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Swap pages within ODS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) website.
