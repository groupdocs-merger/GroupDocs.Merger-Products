...
############################# Head ############################
head_title: "Swap & Exchange VSSX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSSX file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSSX Pages In C#"
description: "Swap VSSX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSSX file pages using C# example code">}}
