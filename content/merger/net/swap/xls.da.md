...
############################# Head ############################
head_title: "Byt og byt XLS sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLS-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLS sider i C#"
description: "Byt XLS sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLS-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLS filsider ved hjælp af C# eksempelkode">}}
