...
############################# Head ############################
head_title: "Vahetage ja vahetage OTP lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone OTP failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage OTP lehte keeles C#"
description: "Vahetage OTP lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage OTP faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis OTP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada OTP faililehte, kasutades C# näitekoodi">}}
