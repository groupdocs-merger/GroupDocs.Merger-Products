...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPSX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPSX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPSX puslapius C#"
description: "Pakeiskite PPSX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais PPSX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPSX failo puslapius naudojant C# pavyzdinį kodą">}}
