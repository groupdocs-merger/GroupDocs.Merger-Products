...
############################# Head ############################
head_title: "تبادل الصفحات DOTX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف DOTX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات DOTX في C#"
description: "استبدل الصفحات DOTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات DOTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف DOTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف DOTX باستخدام كود مثال C#">}}
