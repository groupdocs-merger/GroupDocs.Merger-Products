...
############################# Head ############################
head_title: "Skiptu og skiptu á VSTM síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í VSTM skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um VSTM síður í C#"
description: "Skiptu um VSTM síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um VSTM skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan VSTM skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um VSTM skráarsíður með því að nota C# dæmikóða">}}
