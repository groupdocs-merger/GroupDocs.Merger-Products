...
############################# Head ############################
head_title: "Tukar & Tukar PPTX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPTX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPTX Halaman Dalam C#"
description: "Tukar PPTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar PPTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail PPTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPTX halaman fail menggunakan kod contoh C#.">}}
