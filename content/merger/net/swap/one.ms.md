...
############################# Head ############################
head_title: "Tukar & Tukar ONE Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ONE dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ONE Halaman Dalam C#"
description: "Tukar ONE Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar ONE Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail ONE dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ONE halaman fail menggunakan kod contoh C#.">}}
