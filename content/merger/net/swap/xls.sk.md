...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLS stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLS v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLS stránky v C#"
description: "Vymeňte XLS stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLS pomocou vzorového kódu C#">}}
