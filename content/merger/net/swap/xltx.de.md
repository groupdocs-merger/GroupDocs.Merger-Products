...
############################# Head ############################
head_title: "Tausche & tausche XLTX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer XLTX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche XLTX Seiten in C#"
description: "Tauschen Sie XLTX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "XLTX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer XLTX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie XLTX-Dateiseiten mit C#-Beispielcode aus">}}
