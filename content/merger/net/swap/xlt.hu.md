...
############################# Head ############################
head_title: "Cserélj és cserélj XLT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLT oldal cseréje a C# nyelven"
description: "Cserélje ki az XLT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLT fájloldalakat a C# példakóddal">}}
