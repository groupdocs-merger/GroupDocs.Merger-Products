...
############################# Head ############################
head_title: "Cserélj és cserélj ONE oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ONE fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ONE oldal cseréje a C# nyelven"
description: "Cserélje ki az ONE oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ONE fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy ONE fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ONE fájloldalakat a C# példakóddal">}}
