...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj ODT strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke ODT v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj ODT strani v C#"
description: "Zamenjajte strani ODT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke ODT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki ODT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke ODT s primerom kode C#">}}
