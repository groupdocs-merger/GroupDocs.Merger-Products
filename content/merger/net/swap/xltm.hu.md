...
############################# Head ############################
head_title: "Cserélj és cserélj XLTM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLTM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLTM oldal cseréje a C# nyelven"
description: "Cserélje ki az XLTM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLTM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLTM fájloldalakat a C# példakóddal">}}
