...
############################# Head ############################
head_title: "Apmainīt un apmainīt ODP lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ODP failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ODP lapas programmā C#"
description: "Apmainiet ODP lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ODP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām ODP failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ODP faila lapas, izmantojot C# piemēra kodu">}}
