...
############################# Head ############################
head_title: "Ruil en ruil OTP bladsye in C#"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n OTP-lêer in C# met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil OTP bladsye in C#"
description: "Ruil OTP Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Ruil OTP lêerbladsye om in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n OTP-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTP lêerbladsye om te ruil met behulp van C# voorbeeldkode">}}
