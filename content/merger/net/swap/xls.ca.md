...
############################# Head ############################
head_title: "Canvia i intercanvia XLS pàgines a C#"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer XLS a C# mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia XLS pàgines a C#"
description: "Canvia les pàgines XLS amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers XLS a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# intercanviïn pàgines dins d'un fitxer XLS implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers XLS utilitzant el codi d'exemple C#">}}
