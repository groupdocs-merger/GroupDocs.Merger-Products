...
############################# Head ############################
head_title: "Vyměňte a vyměňte VDX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VDX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VDX stránky v C#"
description: "Vyměňte VDX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VDX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VDX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VDX pomocí ukázkového kódu C#">}}
