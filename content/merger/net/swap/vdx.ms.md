...
############################# Head ############################
head_title: "Tukar & Tukar VDX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VDX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VDX Halaman Dalam C#"
description: "Tukar VDX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VDX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VDX halaman fail menggunakan kod contoh C#.">}}
