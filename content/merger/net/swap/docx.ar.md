...
############################# Head ############################
head_title: "تبادل الصفحات DOCX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف DOCX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات DOCX في C#"
description: "استبدل الصفحات DOCX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات DOCX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف DOCX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف DOCX باستخدام كود مثال C#">}}
