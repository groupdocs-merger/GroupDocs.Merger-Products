...
############################# Head ############################
head_title: "Byt och byt ut DOTM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en DOTM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOTM sidor i C#"
description: "Byt DOTM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt DOTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en DOTM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOTM filsidor med hjälp av C# exempelkod">}}
