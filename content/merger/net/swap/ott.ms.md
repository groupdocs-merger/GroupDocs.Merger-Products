...
############################# Head ############################
head_title: "Tukar & Tukar OTT Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail OTT dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTT Halaman Dalam C#"
description: "Tukar OTT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar OTT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail OTT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar OTT halaman fail menggunakan kod contoh C#.">}}
