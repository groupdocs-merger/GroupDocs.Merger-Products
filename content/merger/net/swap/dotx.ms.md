...
############################# Head ############################
head_title: "Tukar & Tukar DOTX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOTX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTX Halaman Dalam C#"
description: "Tukar DOTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar DOTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail DOTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOTX halaman fail menggunakan kod contoh C#.">}}
