...
############################# Head ############################
head_title: "Byt og byt PPT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en PPT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PPT sider i C#"
description: "Byt PPT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en PPT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PPT filsider ved hjælp af C# eksempelkode">}}
