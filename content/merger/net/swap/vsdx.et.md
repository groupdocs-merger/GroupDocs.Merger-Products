...
############################# Head ############################
head_title: "Vahetage ja vahetage VSDX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSDX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSDX lehte keeles C#"
description: "Vahetage VSDX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSDX faililehte, kasutades C# näitekoodi">}}
