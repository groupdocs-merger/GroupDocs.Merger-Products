...
############################# Head ############################
head_title: "Zamień i zamień XLTX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLTX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLTX strony w C#"
description: "Zamień strony XLTX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLTX przy użyciu przykładowego kodu C#">}}
