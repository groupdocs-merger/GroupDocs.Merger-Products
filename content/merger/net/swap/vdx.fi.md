...
############################# Head ############################
head_title: "Vaihda ja vaihda VDX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VDX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VDX sivua C#"
description: "Vaihda VDX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VDX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VDX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VDX tiedostosivua käyttämällä C# esimerkkikoodia">}}
