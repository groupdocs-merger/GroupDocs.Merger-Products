...
############################# Head ############################
head_title: "Skiptu og skiptu á EPUB síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í EPUB skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um EPUB síður í C#"
description: "Skiptu um EPUB síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um EPUB skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan EPUB skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um EPUB skráarsíður með því að nota C# dæmikóða">}}
