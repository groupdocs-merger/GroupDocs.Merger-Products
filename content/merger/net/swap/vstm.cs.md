...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSTM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSTM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSTM stránky v C#"
description: "Vyměňte VSTM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSTM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSTM pomocí ukázkového kódu C#">}}
