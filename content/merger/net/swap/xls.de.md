...
############################# Head ############################
head_title: "Tausche & tausche XLS Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer XLS-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche XLS Seiten in C#"
description: "Tauschen Sie XLS-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "XLS Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer XLS-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie XLS-Dateiseiten mit C#-Beispielcode aus">}}
