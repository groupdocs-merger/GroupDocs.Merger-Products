...
############################# Head ############################
head_title: "Tukar & Tukarkan XLT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLT Halaman Di C#"
description: "Tukar XLT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLT menggunakan kode contoh C#">}}
