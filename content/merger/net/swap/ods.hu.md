...
############################# Head ############################
head_title: "Cserélj és cserélj ODS oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy ODS fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "ODS oldal cseréje a C# nyelven"
description: "Cserélje ki az ODS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODS fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy ODS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk ODS fájloldalakat a C# példakóddal">}}
