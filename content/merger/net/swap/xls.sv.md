...
############################# Head ############################
head_title: "Byt och byt ut XLS sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLS-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLS sidor i C#"
description: "Byt XLS-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLS filsidor med hjälp av C# exempelkod">}}
