...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ODP puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ODP faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ODP puslapius C#"
description: "Pakeiskite ODP puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ODP failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais ODP faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ODP failo puslapius naudojant C# pavyzdinį kodą">}}
