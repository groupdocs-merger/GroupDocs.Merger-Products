...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLAM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLAM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLAM stránky v C#"
description: "Vymeňte XLAM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLAM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLAM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLAM pomocou vzorového kódu C#">}}
