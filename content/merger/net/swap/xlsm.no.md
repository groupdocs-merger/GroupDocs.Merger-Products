...
############################# Head ############################
head_title: "Bytt og bytt ut XLSM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLSM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLSM sider i C#"
description: "Bytt XLSM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLSM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLSM filsider ved å bruke C# eksempelkode">}}
