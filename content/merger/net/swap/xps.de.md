...
############################# Head ############################
head_title: "Seiten in XPS-Dateien mit .NET-Apps austauschen"
head_description: "Verwenden Sie GroupDocs.Merger for .NET, um Seiten in XPS-Dokumenten neu anzuordnen. Passen Sie PDFs, Word-Dateien, Tabellenkalkulationen, Präsentationen, Visio-Diagramme, Bilder und mehr an."

############################# Header ############################
title: "Seiten in XPS austauschen" 
description: "GroupDocs.Merger for .NET erweitert .NET-Anwendungen um fortgeschrittene Dokumentenverwaltungsfunktionen. Ordnen Sie Seiten in XPS-Dateien neu an, um den Inhalt genau nach Ihren Bedürfnissen zu strukturieren."
...
steps:
    ...
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie Seiten in XPS-Dokumenten neu organisieren, um die Lesbarkeit und Struktur zu verbessern. Fügen Sie effiziente Dokumentenverarbeitung zu Ihren .NET-Anwendungen hinzu.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tauschen Sie die erste und letzte Seite in einer XPS-Datei"
      content: |
        Dieses Beispiel demonstriert, wie Sie Seiten in einer XPS-Datei in wenigen einfachen Schritten austauschen.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
