...
############################# Head ############################
head_title: "Vaihda ja vaihda ONE sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ONE-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ONE sivua C#"
description: "Vaihda ONE-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ONE tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja ONE-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ONE tiedostosivua käyttämällä C# esimerkkikoodia">}}
