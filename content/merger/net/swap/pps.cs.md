...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPS stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPS v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPS stránky v C#"
description: "Vyměňte PPS stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte PPS stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru PPS provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPS pomocí ukázkového kódu C#">}}
