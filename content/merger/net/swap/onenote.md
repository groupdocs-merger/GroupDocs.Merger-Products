...
############################# Head ############################
head_title: "Swap & Exchange ONENOTE Pages in C#"
head_description: "Swap & Exchange positions of two pages within a ONENOTE file in C# using the documents merger API."

############################# Header ############################
title: "Swap ONENOTE Pages In C#"
description: "Swap ONENOTE Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a ONENOTE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ONENOTE file pages using C# example code">}}
