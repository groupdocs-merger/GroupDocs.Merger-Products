...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSDX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSDX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSDX stranice u C#"
description: "Zamijenite VSDX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSDX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSDX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSDX stranice datoteke koristeći C# primjer koda">}}
