...
############################# Head ############################
head_title: "تبادل الصفحات VTX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف VTX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات VTX في C#"
description: "استبدل الصفحات VTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات VTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف VTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف VTX باستخدام كود مثال C#">}}
