...
############################# Head ############################
head_title: "Cserélj és cserélj VSTX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSTX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSTX oldal cseréje a C# nyelven"
description: "Cserélje ki az VSTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSTX fájloldalakat a C# példakóddal">}}
