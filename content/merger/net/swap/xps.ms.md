...
############################# Head ############################
head_title: "Tukar & Tukar XPS Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XPS dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XPS Halaman Dalam C#"
description: "Tukar XPS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XPS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XPS halaman fail menggunakan kod contoh C#.">}}
