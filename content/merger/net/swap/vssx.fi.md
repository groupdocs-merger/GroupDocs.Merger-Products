...
############################# Head ############################
head_title: "Vaihda ja vaihda VSSX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSSX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSSX sivua C#"
description: "Vaihda VSSX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSSX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSSX tiedostosivua käyttämällä C# esimerkkikoodia">}}
