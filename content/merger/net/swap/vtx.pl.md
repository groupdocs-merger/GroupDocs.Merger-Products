...
############################# Head ############################
head_title: "Zamień i zamień VTX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VTX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VTX strony w C#"
description: "Zamień strony VTX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VTX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VTX przy użyciu przykładowego kodu C#">}}
