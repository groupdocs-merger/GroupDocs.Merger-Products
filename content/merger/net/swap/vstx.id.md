...
############################# Head ############################
head_title: "Tukar & Tukarkan VSTX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSTX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTX Halaman Di C#"
description: "Tukar VSTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSTX menggunakan kode contoh C#">}}
