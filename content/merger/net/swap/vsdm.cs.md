...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSDM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSDM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSDM stránky v C#"
description: "Vyměňte VSDM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSDM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSDM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSDM pomocí ukázkového kódu C#">}}
