...
############################# Head ############################
head_title: "Zamień i zamień DOCX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOCX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOCX strony w C#"
description: "Zamień strony DOCX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOCX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOCX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOCX przy użyciu przykładowego kodu C#">}}
