...
############################# Head ############################
head_title: "Tukar & Tukarkan PPTX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPTX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPTX Halaman Di C#"
description: "Tukar PPTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar PPTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file PPTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPTX menggunakan kode contoh C#">}}
