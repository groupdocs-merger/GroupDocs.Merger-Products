...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLTM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLTM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLTM stránky v C#"
description: "Vymeňte XLTM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLTM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLTM pomocou vzorového kódu C#">}}
