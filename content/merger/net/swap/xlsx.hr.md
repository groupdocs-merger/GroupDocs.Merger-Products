...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLSX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLSX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLSX stranice u C#"
description: "Zamijenite XLSX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XLSX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLSX stranice datoteke koristeći C# primjer koda">}}
