...
############################# Head ############################
head_title: "Vaihda ja vaihda VSDX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSDX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSDX sivua C#"
description: "Vaihda VSDX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSDX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSDX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSDX tiedostosivua käyttämällä C# esimerkkikoodia">}}
