...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSM sivua C#"
description: "Vaihda XLSM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLSM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSM tiedostosivua käyttämällä C# esimerkkikoodia">}}
