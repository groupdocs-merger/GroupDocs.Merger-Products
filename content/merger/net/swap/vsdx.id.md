...
############################# Head ############################
head_title: "Tukar & Tukarkan VSDX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSDX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDX Halaman Di C#"
description: "Tukar VSDX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSDX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSDX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSDX menggunakan kode contoh C#">}}
