...
############################# Head ############################
head_title: "Zamijeni i razmijeni XPS stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XPS datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XPS stranice u C#"
description: "Zamijenite XPS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XPS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XPS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XPS stranice datoteke koristeći C# primjer koda">}}
