...
############################# Head ############################
head_title: "Ανταλλαγή και ανταλλαγή σελίδων XLSX σε C#"
head_description: "Ανταλλαγή και ανταλλαγή θέσεων δύο σελίδων σε ένα αρχείο XLSX στο C# χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Ανταλλαγή XLSX σελίδων σε C#"
description: "Αλλάξτε XLSX σελίδες με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Ανταλλαγή XLSX σελίδων αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να ανταλλάξουν σελίδες σε ένα αρχείο XLSX εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να ανταλλάξετε σελίδες αρχείου XLSX χρησιμοποιώντας παράδειγμα κώδικα C#">}}
