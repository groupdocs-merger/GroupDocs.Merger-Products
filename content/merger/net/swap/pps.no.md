...
############################# Head ############################
head_title: "Bytt og bytt ut PPS sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en PPS-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PPS sider i C#"
description: "Bytt PPS-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt PPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en PPS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PPS filsider ved å bruke C# eksempelkode">}}
