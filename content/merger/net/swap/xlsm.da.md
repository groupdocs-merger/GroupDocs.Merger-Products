...
############################# Head ############################
head_title: "Byt og byt XLSM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLSM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLSM sider i C#"
description: "Byt XLSM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLSM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLSM filsider ved hjælp af C# eksempelkode">}}
