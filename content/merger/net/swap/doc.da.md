...
############################# Head ############################
head_title: "Byt og byt DOC sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOC-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOC sider i C#"
description: "Byt DOC sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOC-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOC filsider ved hjælp af C# eksempelkode">}}
