...
############################# Head ############################
head_title: "Byt och byt ut XLSX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLSX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLSX sidor i C#"
description: "Byt XLSX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLSX filsidor med hjälp av C# exempelkod">}}
