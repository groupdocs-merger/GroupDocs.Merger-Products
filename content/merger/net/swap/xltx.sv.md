...
############################# Head ############################
head_title: "Byt och byt ut XLTX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLTX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLTX sidor i C#"
description: "Byt XLTX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLTX filsidor med hjälp av C# exempelkod">}}
