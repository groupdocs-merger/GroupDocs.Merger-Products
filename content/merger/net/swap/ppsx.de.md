...
############################# Head ############################
head_title: "Tausche & tausche PPSX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer PPSX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche PPSX Seiten in C#"
description: "Tauschen Sie PPSX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "PPSX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer PPSX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie PPSX-Dateiseiten mit C#-Beispielcode aus">}}
