...
############################# Head ############################
head_title: "Tukar & Tukarkan ODS Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file ODS di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODS Halaman Di C#"
description: "Tukar ODS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar ODS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file ODS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ODS menggunakan kode contoh C#">}}
