...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ODT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ODT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ODT puslapius C#"
description: "Pakeiskite ODT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ODT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais ODT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ODT failo puslapius naudojant C# pavyzdinį kodą">}}
