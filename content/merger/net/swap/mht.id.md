...
############################# Head ############################
head_title: "Tukar & Tukarkan MHT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file MHT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHT Halaman Di C#"
description: "Tukar MHT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar MHT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file MHT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file MHT menggunakan kode contoh C#">}}
