...
############################# Head ############################
head_title: "Tukar & Tukar PDF Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PDF dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PDF Halaman Dalam C#"
description: "Tukar PDF Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar PDF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail PDF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PDF halaman fail menggunakan kod contoh C#.">}}
