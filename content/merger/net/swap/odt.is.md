...
############################# Head ############################
head_title: "Skiptu og skiptu á ODT síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í ODT skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um ODT síður í C#"
description: "Skiptu um ODT síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um ODT skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan ODT skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um ODT skráarsíður með því að nota C# dæmikóða">}}
