...
############################# Head ############################
head_title: "Tukar & Tukarkan TEX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file TEX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar TEX Halaman Di C#"
description: "Tukar TEX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar TEX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file TEX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file TEX menggunakan kode contoh C#">}}
