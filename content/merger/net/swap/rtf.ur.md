...
############################# Head ############################
head_title: "C# میں RTF صفحات کی تبادلہ اور تبادلہ"
head_description: "دستاویزات کے انضمام API کا استعمال کرتے ہوئے C# میں ایک RTF فائل کے اندر دو صفحات کی پوزیشنوں کو تبدیل اور تبادلہ کریں۔"

############################# Header ############################
title: "RTF صفحات کو C# میں تبدیل کریں"
description: "RTF صفحات کو .NET کوڈ کی چند سطروں کے ساتھ تبدیل کریں۔"
...
steps:
    enable: true
    title_left: "RTF فائل صفحات کو .NET میں تبدیل کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے چند آسان مراحل کو لاگو کرکے RTF فائل کے اندر صفحات کو تبدیل کرنا آسان بناتا ہے۔ .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے RTF فائل کے صفحات کو کیسے تبدیل کریں۔">}}
