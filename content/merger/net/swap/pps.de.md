...
############################# Head ############################
head_title: "Tausche & tausche PPS Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer PPS-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche PPS Seiten in C#"
description: "Tauschen Sie PPS-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "PPS Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer PPS-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie PPS-Dateiseiten mit C#-Beispielcode aus">}}
