...
############################# Head ############################
head_title: "Zamijeni i razmijeni PPTX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PPTX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PPTX stranice u C#"
description: "Zamijenite PPTX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni PPTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar PPTX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PPTX stranice datoteke koristeći C# primjer koda">}}
