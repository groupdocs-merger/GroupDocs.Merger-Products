...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLSB stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLSB v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLSB stránky v C#"
description: "Vymeňte XLSB stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLSB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLSB implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLSB pomocou vzorového kódu C#">}}
