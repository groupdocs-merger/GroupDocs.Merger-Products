...
############################# Head ############################
head_title: "VSSM Sayfalarını C# İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir VSSM dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "VSSM Sayfayı C# İçinde Değiştir"
description: "VSSM Sayfalarını birkaç satır .NET koduyla değiştirin."
...
steps:
    enable: true
    title_left: ".NET içindeki VSSM Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir VSSM dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSM dosya sayfaları nasıl değiştirilir?">}}
