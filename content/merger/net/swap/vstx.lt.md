...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSTX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSTX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSTX puslapius C#"
description: "Pakeiskite VSTX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSTX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSTX failo puslapius naudojant C# pavyzdinį kodą">}}
