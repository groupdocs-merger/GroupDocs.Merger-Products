...
############################# Head ############################
head_title: "Apmainīt un apmainīt DOCX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas DOCX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt DOCX lapas programmā C#"
description: "Apmainiet DOCX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt DOCX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām DOCX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt DOCX faila lapas, izmantojot C# piemēra kodu">}}
