...
############################# Head ############################
head_title: "Byt og byt OTP sider i C#"
head_description: "Byt og udveksle positioner på to sider i en OTP-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt OTP sider i C#"
description: "Byt OTP sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en OTP-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du OTP filsider ved hjælp af C# eksempelkode">}}
