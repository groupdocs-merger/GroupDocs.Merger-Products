...
############################# Head ############################
head_title: "Sukeiskite ir keiskite RTF puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas RTF faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti RTF puslapius C#"
description: "Pakeiskite RTF puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti RTF failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais RTF faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti RTF failo puslapius naudojant C# pavyzdinį kodą">}}
