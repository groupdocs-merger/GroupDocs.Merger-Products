...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj XLSM strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke XLSM v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj XLSM strani v C#"
description: "Zamenjajte strani XLSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke XLSM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki XLSM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke XLSM s primerom kode C#">}}
