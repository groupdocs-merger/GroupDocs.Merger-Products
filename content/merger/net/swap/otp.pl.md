...
############################# Head ############################
head_title: "Zamień i zamień OTP strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku OTP w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień OTP strony w C#"
description: "Zamień strony OTP na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików OTP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku OTP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku OTP przy użyciu przykładowego kodu C#">}}
