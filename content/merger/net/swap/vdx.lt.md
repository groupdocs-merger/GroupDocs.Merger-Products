...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VDX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VDX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VDX puslapius C#"
description: "Pakeiskite VDX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VDX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VDX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VDX failo puslapius naudojant C# pavyzdinį kodą">}}
