...
############################# Head ############################
head_title: "Scambia e scambia XLSB pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file XLSB in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia XLSB pagine in C#"
description: "Scambia le pagine XLSB con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia XLSB pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file XLSB implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file XLSB utilizzando il codice di esempio C#">}}
