...
############################# Head ############################
head_title: "Zamień i zamień DOCM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOCM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOCM strony w C#"
description: "Zamień strony DOCM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOCM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOCM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOCM przy użyciu przykładowego kodu C#">}}
