...
############################# Head ############################
head_title: "Tukar & Tukar XLS Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLS dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLS Halaman Dalam C#"
description: "Tukar XLS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLS halaman fail menggunakan kod contoh C#.">}}
