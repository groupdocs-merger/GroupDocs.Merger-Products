...
############################# Head ############################
head_title: "Ruil en ruil PPTX pagina's in C#"
head_description: "Wissel en ruil posities van twee pagina's binnen een PPTX bestand in C# met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel PPTX pagina's in C#"
description: "Verwissel PPTX pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verwissel PPTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een PPTX bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestandspagina's te wisselen met behulp van C# voorbeeldcode">}}
