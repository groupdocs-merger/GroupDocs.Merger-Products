...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLSX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLSX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLSX puslapius C#"
description: "Pakeiskite XLSX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLSX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLSX failo puslapius naudojant C# pavyzdinį kodą">}}
