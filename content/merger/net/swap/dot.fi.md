...
############################# Head ############################
head_title: "Vaihda ja vaihda DOT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOT sivua C#"
description: "Vaihda DOT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOT tiedostosivua käyttämällä C# esimerkkikoodia">}}
