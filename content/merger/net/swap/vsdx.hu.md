...
############################# Head ############################
head_title: "Cserélj és cserélj VSDX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSDX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSDX oldal cseréje a C# nyelven"
description: "Cserélje ki az VSDX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSDX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSDX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSDX fájloldalakat a C# példakóddal">}}
