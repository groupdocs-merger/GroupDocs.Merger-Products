...
############################# Head ############################
head_title: "Tukar & Tukar RTF Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail RTF dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar RTF Halaman Dalam C#"
description: "Tukar RTF Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar RTF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail RTF dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar RTF halaman fail menggunakan kod contoh C#.">}}
