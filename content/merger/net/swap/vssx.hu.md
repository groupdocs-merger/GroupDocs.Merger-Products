...
############################# Head ############################
head_title: "Cserélj és cserélj VSSX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VSSX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VSSX oldal cseréje a C# nyelven"
description: "Cserélje ki az VSSX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSSX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VSSX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VSSX fájloldalakat a C# példakóddal">}}
