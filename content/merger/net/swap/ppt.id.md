...
############################# Head ############################
head_title: "Tukar & Tukarkan PPT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPT Halaman Di C#"
description: "Tukar PPT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar PPT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file PPT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPT menggunakan kode contoh C#">}}
