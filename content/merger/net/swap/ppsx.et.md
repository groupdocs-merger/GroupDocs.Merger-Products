...
############################# Head ############################
head_title: "Vahetage ja vahetage PPSX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPSX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPSX lehte keeles C#"
description: "Vahetage PPSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis PPSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPSX faililehte, kasutades C# näitekoodi">}}
