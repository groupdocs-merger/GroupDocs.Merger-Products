...
############################# Head ############################
head_title: "Byt og byt VSDX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSDX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSDX sider i C#"
description: "Byt VSDX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSDX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSDX filsider ved hjælp af C# eksempelkode">}}
