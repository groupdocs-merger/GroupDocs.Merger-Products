...
############################# Head ############################
head_title: "Vymeňte a vymeňte ODS stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ODS v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ODS stránky v C#"
description: "Vymeňte ODS stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte ODS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru ODS implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ODS pomocou vzorového kódu C#">}}
