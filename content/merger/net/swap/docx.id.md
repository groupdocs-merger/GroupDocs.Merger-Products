...
############################# Head ############################
head_title: "Tukar & Tukarkan DOCX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOCX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCX Halaman Di C#"
description: "Tukar DOCX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOCX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOCX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOCX menggunakan kode contoh C#">}}
