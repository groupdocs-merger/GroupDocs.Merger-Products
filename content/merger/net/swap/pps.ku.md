...
############################# Head ############################
head_title: "Biguherîne û biguherîne PPS Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek PPS de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne PPS Rûpelên Di C# de"
description: "Rûpelên PPS bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de PPS Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên PPS bi karanîna koda nimûneya C# veguhezîne">}}
