...
############################# Head ############################
head_title: "Zamijeni i razmijeni TEX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar TEX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni TEX stranice u C#"
description: "Zamijenite TEX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni TEX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar TEX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti TEX stranice datoteke koristeći C# primjer koda">}}
