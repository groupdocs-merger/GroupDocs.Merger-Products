...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj ODP strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke ODP v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj ODP strani v C#"
description: "Zamenjajte strani ODP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke ODP v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki ODP z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke ODP s primerom kode C#">}}
