...
############################# Head ############################
head_title: "Byt och byt ut XLAM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLAM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLAM sidor i C#"
description: "Byt XLAM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLAM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLAM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLAM filsidor med hjälp av C# exempelkod">}}
