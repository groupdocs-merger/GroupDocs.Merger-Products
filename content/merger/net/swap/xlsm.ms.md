...
############################# Head ############################
head_title: "Tukar & Tukar XLSM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSM Halaman Dalam C#"
description: "Tukar XLSM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSM halaman fail menggunakan kod contoh C#.">}}
