...
############################# Head ############################
head_title: "Vahetage ja vahetage XLS lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLS failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLS lehte keeles C#"
description: "Vahetage XLS lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLS faililehte, kasutades C# näitekoodi">}}
