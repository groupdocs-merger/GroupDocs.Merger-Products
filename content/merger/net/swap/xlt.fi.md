...
############################# Head ############################
head_title: "Vaihda ja vaihda XLT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLT sivua C#"
description: "Vaihda XLT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLT tiedostosivua käyttämällä C# esimerkkikoodia">}}
