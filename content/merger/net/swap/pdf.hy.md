...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել PDF էջեր C#-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը PDF ֆայլում C#-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք PDF էջեր C#-ում"
description: "Փոխեք PDF էջերը մի քանի տող .NET կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք PDF ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# ծրագրավորողների համար էջերը փոխանակել PDF ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել PDF ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}
