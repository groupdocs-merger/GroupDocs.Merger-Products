...
############################# Head ############################
head_title: "Byt och byt ut DOTX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en DOTX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt DOTX sidor i C#"
description: "Byt DOTX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt DOTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en DOTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter DOTX filsidor med hjälp av C# exempelkod">}}
