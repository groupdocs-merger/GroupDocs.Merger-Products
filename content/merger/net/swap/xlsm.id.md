...
############################# Head ############################
head_title: "Tukar & Tukarkan XLSM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLSM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSM Halaman Di C#"
description: "Tukar XLSM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLSM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLSM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLSM menggunakan kode contoh C#">}}
