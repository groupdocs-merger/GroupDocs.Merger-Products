...
############################# Head ############################
head_title: "Schimbați și schimbați paginile EPUB în C#"
head_description: "Schimbați și schimbați pozițiile a două pagini dintr-un fișier EPUB în C# utilizând API-ul pentru fuziunea documentelor."

############################# Header ############################
title: "Schimbați EPUB pagini în C#"
description: "Schimbați paginile EPUB cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Schimbați paginile de fișiere EPUB în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează ca dezvoltatorii C# să schimbe paginile dintr-un fișier EPUB prin implementarea câțiva pași simpli .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să schimbați paginile de fișiere EPUB utilizând codul exemplu C#">}}
