...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XPS puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XPS faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XPS puslapius C#"
description: "Pakeiskite XPS puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XPS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XPS faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XPS failo puslapius naudojant C# pavyzdinį kodą">}}
