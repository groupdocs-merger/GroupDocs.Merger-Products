...
############################# Head ############################
head_title: "Swap pages in PPTX files using .NET apps"
head_description: "Use GroupDocs.Merger for .NET to reorder pages in PPTX documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, and more."

############################# Header ############################
title: "Swap PPTX pages" 
description: "GroupDocs.Merger for .NET extends .NET applications with advanced document management capabilities. Easily rearrange pages in PPTX files to structure content exactly as needed."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily reorganize pages in PPTX documents to enhance readability and structure. Add efficient document processing to your .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a PPTX file"
      content: |
        This example demonstrates how to swap pages in a PPTX file in a few simple steps.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
