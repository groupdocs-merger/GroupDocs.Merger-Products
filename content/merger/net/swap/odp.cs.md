...
############################# Head ############################
head_title: "Vyměňte a vyměňte ODP stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ODP v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ODP stránky v C#"
description: "Vyměňte ODP stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte ODP stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru ODP provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ODP pomocí ukázkového kódu C#">}}
