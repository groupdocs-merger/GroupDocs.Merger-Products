...
############################# Head ############################
head_title: "Skiptu og skiptu á ODS síðum í C#"
head_description: "Skiptu um og skiptu um stöðu tveggja síðna í ODS skrá í C# með því að nota forritaskil skjalasamruna."

############################# Header ############################
title: "Skiptu um ODS síður í C#"
description: "Skiptu um ODS síður með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu um ODS skráarsíður í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta um síður innan ODS skráar með því að útfæra nokkur auðveld skref .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta um ODS skráarsíður með því að nota C# dæmikóða">}}
