...
############################# Head ############################
head_title: "Tausche & tausche ODS Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer ODS-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche ODS Seiten in C#"
description: "Tauschen Sie ODS-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "ODS Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer ODS-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie ODS-Dateiseiten mit C#-Beispielcode aus">}}
