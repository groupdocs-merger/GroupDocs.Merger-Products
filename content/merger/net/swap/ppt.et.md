...
############################# Head ############################
head_title: "Vahetage ja vahetage PPT lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone PPT failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage PPT lehte keeles C#"
description: "Vahetage PPT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage PPT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis PPT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada PPT faililehte, kasutades C# näitekoodi">}}
