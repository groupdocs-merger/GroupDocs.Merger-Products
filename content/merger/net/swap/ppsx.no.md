...
############################# Head ############################
head_title: "Bytt og bytt ut PPSX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en PPSX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PPSX sider i C#"
description: "Bytt PPSX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en PPSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PPSX filsider ved å bruke C# eksempelkode">}}
