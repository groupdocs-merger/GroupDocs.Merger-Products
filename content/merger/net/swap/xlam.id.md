...
############################# Head ############################
head_title: "Tukar & Tukarkan XLAM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLAM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLAM Halaman Di C#"
description: "Tukar XLAM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLAM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLAM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLAM menggunakan kode contoh C#">}}
