...
############################# Head ############################
head_title: "Byt og byt PPSX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en PPSX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt PPSX sider i C#"
description: "Byt PPSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en PPSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du PPSX filsider ved hjælp af C# eksempelkode">}}
