...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj VSTM strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke VSTM v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj VSTM strani v C#"
description: "Zamenjajte strani VSTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke VSTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki VSTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke VSTM s primerom kode C#">}}
