...
############################# Head ############################
head_title: "C#에서 PPSX 페이지 교환 및 교환"
head_description: "문서 병합 API를 사용하여 C#의 PPSX 파일 내 두 페이지의 위치를 ​​교환 및 교환합니다."

############################# Header ############################
title: "C#에서 PPSX 페이지 교체"
description: "몇 줄의 .NET 코드로 PPSX 페이지를 바꿉니다."
...
steps:
    enable: true
    title_left: ".NET에서 PPSX 파일 페이지 교체"
    content_left: |
        [GroupDocs.Merger for .NET](/ko/merger/net/)를 사용하면 몇 가지 간단한 단계를 구현하여 C# 개발자가 PPSX 파일 내에서 페이지를 쉽게 교환할 수 있습니다. .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 PPSX 파일 페이지를 바꾸는 방법">}}
