...
############################# Head ############################
head_title: "Tukar & Tukar EPUB Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail EPUB dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EPUB Halaman Dalam C#"
description: "Tukar EPUB Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar EPUB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail EPUB dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar EPUB halaman fail menggunakan kod contoh C#.">}}
