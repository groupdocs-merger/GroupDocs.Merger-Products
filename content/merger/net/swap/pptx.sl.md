...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj PPTX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke PPTX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj PPTX strani v C#"
description: "Zamenjajte strani PPTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke PPTX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki PPTX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke PPTX s primerom kode C#">}}
