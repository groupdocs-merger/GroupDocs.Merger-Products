...
############################# Head ############################
head_title: "Tukar & Tukar VTX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VTX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VTX Halaman Dalam C#"
description: "Tukar VTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VTX halaman fail menggunakan kod contoh C#.">}}
