...
############################# Head ############################
head_title: "Byt och byt ut XLSM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLSM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLSM sidor i C#"
description: "Byt XLSM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLSM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLSM filsidor med hjälp av C# exempelkod">}}
