...
############################# Head ############################
head_title: "በC# ውስጥ ODT ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በC# ውስጥ ባለው የODT ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "ODT ገጾችን በC# ውስጥ ይቀያይሩ"
description: "ODT ገጾችን በጥቂት የ.NET ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "ODT የፋይል ገጾችን በ.NET ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በODT ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT የፋይል ገጾችን C# ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}
