...
############################# Head ############################
head_title: "Cserélj és cserélj DOTM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOTM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTM oldal cseréje a C# nyelven"
description: "Cserélje ki az DOTM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOTM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOTM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOTM fájloldalakat a C# példakóddal">}}
