...
############################# Head ############################
head_title: "Swap & Exchange VDX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VDX file in C# using the documents merger API."

############################# Header ############################
title: "Swap VDX Pages In C#"
description: "Swap VDX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VDX file pages using C# example code">}}
