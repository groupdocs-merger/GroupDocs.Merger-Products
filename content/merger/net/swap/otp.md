...
############################# Head ############################
head_title: "Swap & Exchange OTP Pages in C#"
head_description: "Swap & Exchange positions of two pages within a OTP file in C# using the documents merger API."

############################# Header ############################
title: "Swap OTP Pages In C#"
description: "Swap OTP Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a OTP file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap OTP file pages using C# example code">}}
