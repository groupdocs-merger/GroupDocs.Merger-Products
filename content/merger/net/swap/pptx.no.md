...
############################# Head ############################
head_title: "Bytt og bytt ut PPTX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en PPTX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PPTX sider i C#"
description: "Bytt PPTX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en PPTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PPTX filsider ved å bruke C# eksempelkode">}}
