...
############################# Head ############################
head_title: "Swap pages in XPS files using .NET apps"
head_description: "Use GroupDocs.Merger for .NET to reorder pages in XPS documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, and more."

############################# Header ############################
title: "Swap XPS pages" 
description: "GroupDocs.Merger for .NET extends .NET applications with advanced document management capabilities. Easily rearrange pages in XPS files to structure content exactly as needed."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily reorganize pages in XPS documents to enhance readability and structure. Add efficient document processing to your .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a XPS file"
      content: |
        This example demonstrates how to swap pages in a XPS file in a few simple steps.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
