...
############################# Head ############################
head_title: "Bytt og bytt ut MHTML sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en MHTML-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt MHTML sider i C#"
description: "Bytt MHTML-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en MHTML-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte MHTML filsider ved å bruke C# eksempelkode">}}
