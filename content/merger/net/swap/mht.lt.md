...
############################# Head ############################
head_title: "Sukeiskite ir keiskite MHT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas MHT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti MHT puslapius C#"
description: "Pakeiskite MHT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti MHT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais MHT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti MHT failo puslapius naudojant C# pavyzdinį kodą">}}
