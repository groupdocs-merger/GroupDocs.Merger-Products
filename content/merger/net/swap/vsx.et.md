...
############################# Head ############################
head_title: "Vahetage ja vahetage VSX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSX lehte keeles C#"
description: "Vahetage VSX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSX faililehte, kasutades C# näitekoodi">}}
