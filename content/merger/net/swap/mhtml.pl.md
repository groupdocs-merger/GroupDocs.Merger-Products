...
############################# Head ############################
head_title: "Zamień i zamień MHTML strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku MHTML w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień MHTML strony w C#"
description: "Zamień strony MHTML na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików MHTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku MHTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku MHTML przy użyciu przykładowego kodu C#">}}
