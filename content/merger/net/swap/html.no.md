...
############################# Head ############################
head_title: "Bytt og bytt ut HTML sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en HTML-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt HTML sider i C#"
description: "Bytt HTML-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt HTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en HTML-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte HTML filsider ved å bruke C# eksempelkode">}}
