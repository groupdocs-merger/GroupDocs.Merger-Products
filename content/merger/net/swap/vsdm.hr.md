...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSDM stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSDM datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSDM stranice u C#"
description: "Zamijenite VSDM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSDM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSDM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSDM stranice datoteke koristeći C# primjer koda">}}
