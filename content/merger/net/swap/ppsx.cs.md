...
############################# Head ############################
head_title: "Vyměňte a vyměňte PPSX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru PPSX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit PPSX stránky v C#"
description: "Vyměňte PPSX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte PPSX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru PPSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru PPSX pomocí ukázkového kódu C#">}}
