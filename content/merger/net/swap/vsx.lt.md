...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSX puslapius C#"
description: "Pakeiskite VSX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSX failo puslapius naudojant C# pavyzdinį kodą">}}
