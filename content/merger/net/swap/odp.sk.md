...
############################# Head ############################
head_title: "Vymeňte a vymeňte ODP stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore ODP v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte ODP stránky v C#"
description: "Vymeňte ODP stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte ODP strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru ODP implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru ODP pomocou vzorového kódu C#">}}
