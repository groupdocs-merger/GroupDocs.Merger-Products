...
############################# Head ############################
head_title: "Փոխանակել և փոխանակել ODS էջեր C#-ում"
head_description: "Փոխանակեք և փոխանակեք երկու էջերի դիրքերը ODS ֆայլում C#-ում` օգտագործելով փաստաթղթերի միաձուլման API:"

############################# Header ############################
title: "Փոխանակեք ODS էջեր C#-ում"
description: "Փոխեք ODS էջերը մի քանի տող .NET կոդով:"
...
steps:
    enable: true
    title_left: "Փոխանակեք ODS ֆայլի էջեր .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# ծրագրավորողների համար էջերը փոխանակել ODS ֆայլում` իրականացնելով մի քանի հեշտ քայլեր: .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես փոխանակել ODS ֆայլի էջերը՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Փոխեք ODS ֆայլի էջերը՝ օգտագործելով GroupDocs.Merger API-ը
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Կենդանի ցուցադրություններ - Փոխանակեք ODS Ֆայլի էջերը առցանց"
    content: |
       Փոխեք ODS ֆայլի էջերը հենց հիմա՝ այցելելով [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) կայքը:
