...
############################# Head ############################
head_title: "Zamijeni i razmijeni EPUB stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar EPUB datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni EPUB stranice u C#"
description: "Zamijenite EPUB stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni EPUB stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar EPUB datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti EPUB stranice datoteke koristeći C# primjer koda">}}
