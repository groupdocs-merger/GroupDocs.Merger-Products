...
############################# Head ############################
head_title: "Zamijeni i razmijeni PPT stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar PPT datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni PPT stranice u C#"
description: "Zamijenite PPT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni PPT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar PPT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti PPT stranice datoteke koristeći C# primjer koda">}}
