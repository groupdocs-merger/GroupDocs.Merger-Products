...
############################# Head ############################
head_title: "Tukar & Tukarkan OTP Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file OTP di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTP Halaman Di C#"
description: "Tukar OTP Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar OTP Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file OTP dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file OTP menggunakan kode contoh C#">}}
