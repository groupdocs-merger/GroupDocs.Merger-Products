...
############################# Head ############################
head_title: "Swap & Exchange MHT Pages in C#"
head_description: "Swap & Exchange positions of two pages within a MHT file in C# using the documents merger API."

############################# Header ############################
title: "Swap MHT Pages In C#"
description: "Swap MHT Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a MHT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap MHT file pages using C# example code">}}
