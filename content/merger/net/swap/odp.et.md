...
############################# Head ############################
head_title: "Vahetage ja vahetage ODP lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODP failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODP lehte keeles C#"
description: "Vahetage ODP lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODP faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis ODP, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODP faililehte, kasutades C# näitekoodi">}}
