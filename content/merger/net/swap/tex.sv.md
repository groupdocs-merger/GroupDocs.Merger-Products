...
############################# Head ############################
head_title: "Byt och byt ut TEX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en TEX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt TEX sidor i C#"
description: "Byt TEX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt TEX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en TEX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter TEX filsidor med hjälp av C# exempelkod">}}
