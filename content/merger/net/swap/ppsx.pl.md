...
############################# Head ############################
head_title: "Zamień i zamień PPSX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PPSX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PPSX strony w C#"
description: "Zamień strony PPSX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików PPSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku PPSX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PPSX przy użyciu przykładowego kodu C#">}}
