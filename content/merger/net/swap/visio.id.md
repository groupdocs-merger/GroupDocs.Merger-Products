...
############################# Head ############################
head_title: "Tukar & Tukarkan VISIO Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VISIO di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VISIO Halaman Di C#"
description: "Tukar VISIO Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VISIO Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VISIO dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VISIO menggunakan kode contoh C#">}}
