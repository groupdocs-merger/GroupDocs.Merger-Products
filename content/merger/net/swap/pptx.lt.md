...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPTX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPTX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPTX puslapius C#"
description: "Pakeiskite PPTX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais PPTX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPTX failo puslapius naudojant C# pavyzdinį kodą">}}
