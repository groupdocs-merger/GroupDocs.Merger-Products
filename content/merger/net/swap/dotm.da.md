...
############################# Head ############################
head_title: "Byt og byt DOTM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOTM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOTM sider i C#"
description: "Byt DOTM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOTM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOTM filsider ved hjælp af C# eksempelkode">}}
