...
############################# Head ############################
head_title: "Vahetage ja vahetage HTML lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone HTML failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage HTML lehte keeles C#"
description: "Vahetage HTML lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage HTML faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis HTML, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada HTML faililehte, kasutades C# näitekoodi">}}
