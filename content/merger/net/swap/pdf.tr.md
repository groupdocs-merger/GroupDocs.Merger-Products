...
############################# Head ############################
head_title: "PDF Sayfalarını C# İçinde Değiştirin ve Değiştirin"
head_description: "Belge birleştirme API'sini kullanarak C# içindeki bir PDF dosyasındaki iki sayfanın pozisyonlarını değiştirin ve değiştirin."

############################# Header ############################
title: "PDF Sayfayı C# İçinde Değiştir"
description: "PDF Sayfalarını birkaç satır .NET koduyla değiştirin."
...
steps:
    enable: true
    title_left: ".NET içindeki PDF Dosya Sayfalarını Değiştirin"
    content_left: |
        [GroupDocs.Merger for .NET](/tr/merger/net}/), C# geliştiricilerinin birkaç kolay adımı uygulayarak bir PDF dosyası içinde sayfaları değiştirmesini kolaylaştırır .
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosya sayfaları nasıl değiştirilir?">}}
