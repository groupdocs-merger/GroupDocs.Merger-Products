...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLTM stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLTM datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLTM stranice u C#"
description: "Zamijenite XLTM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XLTM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLTM stranice datoteke koristeći C# primjer koda">}}
