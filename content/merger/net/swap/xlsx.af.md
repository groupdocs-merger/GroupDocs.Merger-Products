...
############################# Head ############################
head_title: "Ruil en ruil XLSX bladsye in C#"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n XLSX-lêer in C# met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil XLSX bladsye in C#"
description: "Ruil XLSX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Ruil XLSX lêerbladsye om in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n XLSX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSX lêerbladsye om te ruil met behulp van C# voorbeeldkode">}}
