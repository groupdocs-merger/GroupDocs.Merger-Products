...
############################# Head ############################
head_title: "Vaihda ja vaihda DOCX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOCX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOCX sivua C#"
description: "Vaihda DOCX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOCX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOCX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOCX tiedostosivua käyttämällä C# esimerkkikoodia">}}
