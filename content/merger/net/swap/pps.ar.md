...
############################# Head ############################
head_title: "تبادل الصفحات PPS في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف PPS في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات PPS في C#"
description: "استبدل الصفحات PPS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات PPS في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف PPS من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف PPS باستخدام كود مثال C#">}}
