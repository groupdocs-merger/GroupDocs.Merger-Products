...
############################# Head ############################
head_title: "Cserélj és cserélj DOC oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOC fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOC oldal cseréje a C# nyelven"
description: "Cserélje ki az DOC oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOC fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOC fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOC fájloldalakat a C# példakóddal">}}
