...
############################# Head ############################
head_title: "Tukar & Tukarkan VDX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VDX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VDX Halaman Di C#"
description: "Tukar VDX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VDX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VDX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VDX menggunakan kode contoh C#">}}
