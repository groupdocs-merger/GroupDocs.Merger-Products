...
############################# Head ############################
head_title: "Babhtáil & Malartú XPS Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad XPS in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil XPS Leathanaigh i C#"
description: "Malartú XPS Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil XPS Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad XPS trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XPS a mhalartú le cód samplach C#">}}
