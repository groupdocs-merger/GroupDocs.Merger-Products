...
############################# Head ############################
head_title: "Vaihda ja vaihda XLSB sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLSB-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLSB sivua C#"
description: "Vaihda XLSB-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLSB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLSB-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLSB tiedostosivua käyttämällä C# esimerkkikoodia">}}
