...
############################# Head ############################
head_title: "Vahetage ja vahetage VDX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VDX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VDX lehte keeles C#"
description: "Vahetage VDX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VDX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VDX faililehte, kasutades C# näitekoodi">}}
