...
############################# Head ############################
head_title: "Bytt og bytt ut XLTM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLTM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLTM sider i C#"
description: "Bytt XLTM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLTM filsider ved å bruke C# eksempelkode">}}
