...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOT puslapius C#"
description: "Pakeiskite DOT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais DOT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOT failo puslapius naudojant C# pavyzdinį kodą">}}
