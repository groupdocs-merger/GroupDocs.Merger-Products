...
############################# Head ############################
head_title: "Tausche & tausche XLT Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer XLT-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche XLT Seiten in C#"
description: "Tauschen Sie XLT-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "XLT Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer XLT-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie XLT-Dateiseiten mit C#-Beispielcode aus">}}
