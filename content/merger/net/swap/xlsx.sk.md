...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLSX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLSX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLSX stránky v C#"
description: "Vymeňte XLSX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLSX pomocou vzorového kódu C#">}}
