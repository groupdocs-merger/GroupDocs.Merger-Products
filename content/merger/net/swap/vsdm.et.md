...
############################# Head ############################
head_title: "Vahetage ja vahetage VSDM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSDM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSDM lehte keeles C#"
description: "Vahetage VSDM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSDM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSDM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSDM faililehte, kasutades C# näitekoodi">}}
