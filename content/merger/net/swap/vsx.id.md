...
############################# Head ############################
head_title: "Tukar & Tukarkan VSX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSX Halaman Di C#"
description: "Tukar VSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSX menggunakan kode contoh C#">}}
