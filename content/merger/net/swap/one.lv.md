...
############################# Head ############################
head_title: "Apmainīt un apmainīt ONE lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ONE failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ONE lapas programmā C#"
description: "Apmainiet ONE lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ONE faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām ONE failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ONE faila lapas, izmantojot C# piemēra kodu">}}
