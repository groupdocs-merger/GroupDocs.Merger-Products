...
############################# Head ############################
head_title: "Vahetage ja vahetage ODS lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODS failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODS lehte keeles C#"
description: "Vahetage ODS lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis ODS, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODS faililehte, kasutades C# näitekoodi">}}
