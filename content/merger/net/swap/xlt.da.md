...
############################# Head ############################
head_title: "Byt og byt XLT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLT sider i C#"
description: "Byt XLT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLT filsider ved hjælp af C# eksempelkode">}}
