...
############################# Head ############################
head_title: "Vaihda ja vaihda XLAM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLAM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLAM sivua C#"
description: "Vaihda XLAM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLAM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLAM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLAM tiedostosivua käyttämällä C# esimerkkikoodia">}}
