...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLAM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLAM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLAM stránky v C#"
description: "Vyměňte XLAM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLAM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLAM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLAM pomocí ukázkového kódu C#">}}
