...
############################# Head ############################
head_title: "Zamień i zamień XLS strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLS w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLS strony w C#"
description: "Zamień strony XLS na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLS, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLS przy użyciu przykładowego kodu C#">}}
