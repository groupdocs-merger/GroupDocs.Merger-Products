...
############################# Head ############################
head_title: "تبادل الصفحات VSTX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف VSTX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات VSTX في C#"
description: "استبدل الصفحات VSTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات VSTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف VSTX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف VSTX باستخدام كود مثال C#">}}
