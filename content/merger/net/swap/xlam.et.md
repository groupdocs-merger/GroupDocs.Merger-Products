...
############################# Head ############################
head_title: "Vahetage ja vahetage XLAM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLAM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLAM lehte keeles C#"
description: "Vahetage XLAM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLAM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLAM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLAM faililehte, kasutades C# näitekoodi">}}
