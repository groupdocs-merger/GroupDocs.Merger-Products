...
############################# Head ############################
head_title: "Vahetage ja vahetage ONE lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ONE failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ONE lehte keeles C#"
description: "Vahetage ONE lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ONE faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis ONE, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ONE faililehte, kasutades C# näitekoodi">}}
