...
############################# Head ############################
head_title: "Tukar & Tukarkan XLSB Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XLSB di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSB Halaman Di C#"
description: "Tukar XLSB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XLSB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XLSB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XLSB menggunakan kode contoh C#">}}
