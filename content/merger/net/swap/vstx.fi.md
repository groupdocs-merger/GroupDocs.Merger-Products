...
############################# Head ############################
head_title: "Vaihda ja vaihda VSTX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSTX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSTX sivua C#"
description: "Vaihda VSTX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSTX tiedostosivua käyttämällä C# esimerkkikoodia">}}
