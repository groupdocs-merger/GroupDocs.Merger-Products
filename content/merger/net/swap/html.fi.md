...
############################# Head ############################
head_title: "Vaihda ja vaihda HTML sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja HTML-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda HTML sivua C#"
description: "Vaihda HTML-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda HTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja HTML-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa HTML tiedostosivua käyttämällä C# esimerkkikoodia">}}
