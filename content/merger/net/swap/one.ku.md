...
############################# Head ############################
head_title: "Biguherîne û biguherîne ONE Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek ONE de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne ONE Rûpelên Di C# de"
description: "Rûpelên ONE bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de ONE Rûpelên Pelan biguherînin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên C# re hêsan dike ku bi pêkanîna çend gavên hêsan rûpelan di nav pelek ONE de biguhezînin. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên ONE bi karanîna koda nimûneya C# veguhezîne">}}
