...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSTM puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSTM faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSTM puslapius C#"
description: "Pakeiskite VSTM puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSTM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSTM faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSTM failo puslapius naudojant C# pavyzdinį kodą">}}
