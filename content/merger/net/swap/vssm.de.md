...
############################# Head ############################
head_title: "Tausche & tausche VSSM Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSSM-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSSM Seiten in C#"
description: "Tauschen Sie VSSM-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSSM Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSSM-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSSM-Dateiseiten mit C#-Beispielcode aus">}}
