...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOTX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOTX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOTX stránky v C#"
description: "Vyměňte DOTX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte DOTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru DOTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOTX pomocí ukázkového kódu C#">}}
