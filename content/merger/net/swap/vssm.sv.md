...
############################# Head ############################
head_title: "Byt och byt ut VSSM sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSSM-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSSM sidor i C#"
description: "Byt VSSM-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSSM-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSSM filsidor med hjälp av C# exempelkod">}}
