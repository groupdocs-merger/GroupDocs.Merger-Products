...
############################# Head ############################
head_title: "Cserélj és cserélj MHTML oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy MHTML fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "MHTML oldal cseréje a C# nyelven"
description: "Cserélje ki az MHTML oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "MHTML fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy MHTML fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk MHTML fájloldalakat a C# példakóddal">}}
