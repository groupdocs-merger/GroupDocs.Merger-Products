...
############################# Head ############################
head_title: "Tukar & Tukar HTML Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail HTML dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar HTML Halaman Dalam C#"
description: "Tukar HTML Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar HTML Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail HTML dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar HTML halaman fail menggunakan kod contoh C#.">}}
