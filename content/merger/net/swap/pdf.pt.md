...
############################# Head ############################
head_title: "Troque e troque PDF páginas em C#"
head_description: "Troque e troque posições de duas páginas em um arquivo PDF em C# usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar PDF Páginas em C#"
description: "Troque PDF Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo PDF em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# trocar páginas em um arquivo PDF implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo PDF usando o código de exemplo C#">}}
