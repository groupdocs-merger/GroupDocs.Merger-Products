...
############################# Head ############################
head_title: "Tukar & Tukar DOCX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOCX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCX Halaman Dalam C#"
description: "Tukar DOCX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar DOCX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail DOCX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOCX halaman fail menggunakan kod contoh C#.">}}
