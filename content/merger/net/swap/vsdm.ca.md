...
############################# Head ############################
head_title: "Canvia i intercanvia VSDM pàgines a C#"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer VSDM a C# mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia VSDM pàgines a C#"
description: "Canvia les pàgines VSDM amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers VSDM a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# intercanviïn pàgines dins d'un fitxer VSDM implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers VSDM utilitzant el codi d'exemple C#">}}
