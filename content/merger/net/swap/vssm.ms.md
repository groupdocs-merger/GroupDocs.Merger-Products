...
############################# Head ############################
head_title: "Tukar & Tukar VSSM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSSM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSSM Halaman Dalam C#"
description: "Tukar VSSM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VSSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VSSM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSSM halaman fail menggunakan kod contoh C#.">}}
