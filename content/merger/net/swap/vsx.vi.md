...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi VSX Trang trong C#"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp VSX trong C# bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi VSX Trang trong C#"
description: "Hoán đổi các trang VSX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Hoán đổi VSX Trang Tệp trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET]({{sl slash_lang}}/merge/net/) giúp các nhà phát triển C# dễ dàng hoán đổi các trang trong một tệp VSX bằng cách thực hiện một vài bước đơn giản .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp VSX bằng mã mẫu C#">}}
