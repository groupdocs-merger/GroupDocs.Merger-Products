...
############################# Head ############################
head_title: "Canvia i intercanvia RTF pàgines a C#"
head_description: "Canvia i intercanvia les posicions de dues pàgines dins d'un fitxer RTF a C# mitjançant l'API de fusió de documents."

############################# Header ############################
title: "Canvia RTF pàgines a C#"
description: "Canvia les pàgines RTF amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Canvia les pàgines de fitxers RTF a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita que els desenvolupadors de C# intercanviïn pàgines dins d'un fitxer RTF implementant uns quants passos senzills .
    ...
    code: |
     ...
     {{< merger/code-merger title="Com intercanviar pàgines de fitxers RTF utilitzant el codi d'exemple C#">}}
