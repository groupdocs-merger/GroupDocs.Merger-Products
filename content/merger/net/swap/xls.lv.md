...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLS lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLS failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLS lapas programmā C#"
description: "Apmainiet XLS lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām XLS failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLS faila lapas, izmantojot C# piemēra kodu">}}
