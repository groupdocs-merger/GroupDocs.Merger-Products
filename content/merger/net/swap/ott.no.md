...
############################# Head ############################
head_title: "Bytt og bytt ut OTT sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en OTT-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt OTT sider i C#"
description: "Bytt OTT-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en OTT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte OTT filsider ved å bruke C# eksempelkode">}}
