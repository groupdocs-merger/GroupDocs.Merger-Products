...
############################# Head ############################
head_title: "Byt och byt ut PPTX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en PPTX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt PPTX sidor i C#"
description: "Byt PPTX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt PPTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en PPTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter PPTX filsidor med hjälp av C# exempelkod">}}
