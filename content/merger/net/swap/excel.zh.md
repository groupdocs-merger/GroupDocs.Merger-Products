...
############################# Head ############################
head_title: "交换和交换 C# 中的 EXCEL 页"
head_description: "使用文档合并 API 在 C# 中的 EXCEL 文件中交换和交换两个页面的位置。"

############################# Header ############################
title: "在 C# 中交换 EXCEL 页"
description: "用几行 .NET 代码交换 EXCEL 个页面。"
...
steps:
    enable: true
    title_left: "交换 .NET 中的 EXCEL 个文件页"
    content_left: |
        [GroupDocs.Merger for .NET](/zh/merger/net/) 让 C# 开发人员通过执行几个简单的步骤轻松地在 EXCEL 文件中交换页面.
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码交换 EXCEL 文件页面">}}
