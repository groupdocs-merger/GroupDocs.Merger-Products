...
############################# Head ############################
head_title: "Swap & Exchange TSV Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a TSV file using the file split API."

############################# Header ############################
title: "Swap TSV Pages in .NET"
description: "Swap and exchange positions of two pages within a TSV file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Swap TSV File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a TSV file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Swap TSV file pages using GroupDocs.Merger API
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Live Demos - Swap TSV File Pages Online"
    content: |
        Swap pages within TSV files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/tsv) website.
