...
############################# Head ############################
head_title: "Tukar & Tukarkan PPSX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file PPSX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPSX Halaman Di C#"
description: "Tukar PPSX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar PPSX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file PPSX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PPSX menggunakan kode contoh C#">}}
