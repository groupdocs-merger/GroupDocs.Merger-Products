...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLTM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLTM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLTM stránky v C#"
description: "Vyměňte XLTM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLTM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLTM pomocí ukázkového kódu C#">}}
