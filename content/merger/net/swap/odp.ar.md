...
############################# Head ############################
head_title: "تبادل الصفحات ODP في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف ODP في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات ODP في C#"
description: "استبدل الصفحات ODP ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات ODP في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف ODP من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف ODP باستخدام كود مثال C#">}}
