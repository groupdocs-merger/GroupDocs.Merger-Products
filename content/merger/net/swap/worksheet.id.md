...
############################# Head ############################
head_title: "Tukar & Tukarkan WORKSHEET Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file WORKSHEET di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar WORKSHEET Halaman Di C#"
description: "Tukar WORKSHEET Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar WORKSHEET Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file WORKSHEET dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file WORKSHEET menggunakan kode contoh C#">}}
