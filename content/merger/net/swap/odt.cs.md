...
############################# Head ############################
head_title: "Vyměňte a vyměňte ODT stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ODT v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ODT stránky v C#"
description: "Vyměňte ODT stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte ODT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru ODT provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ODT pomocí ukázkového kódu C#">}}
