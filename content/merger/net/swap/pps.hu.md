...
############################# Head ############################
head_title: "Cserélj és cserélj PPS oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy PPS fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "PPS oldal cseréje a C# nyelven"
description: "Cserélje ki az PPS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "PPS fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy PPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk PPS fájloldalakat a C# példakóddal">}}
