...
############################# Head ############################
head_title: "Cserélj és cserélj XLSM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLSM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLSM oldal cseréje a C# nyelven"
description: "Cserélje ki az XLSM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLSM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLSM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLSM fájloldalakat a C# példakóddal">}}
