...
draft: false
############################# Head ############################
head_title: "Подкачка и обмен страницами DOCX в C# .NET"
head_description: " Пользователи C# .NET могут обмениваться позициями двух страниц в файле DOCX с помощью API разделения файлов."
############################# Header ############################
title: "Поменять местами страницы DOCX в .NET"
description: "Меняйте местами две страницы в файле DOCX с помощью API-интерфейса файлового разделителя для приложений .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Поменять местами страницы файлов DOCX в .NET"
    content_left: |
        [GroupDocs.Merger](/ru/merger/net/) позволяет разработчикам .NET легко менять местами, обмениваться и упорядочивать страницы в файле DOCX, выполняя несколько простых шагов.
...
demos:
    ...
    content: |
        Поменяйте местами страницы в файлах DOCX прямо сейчас, посетив веб-сайт [Живые демонстрации](https://products.groupdocs.app/splitter/swap-pages/docx). Живая демонстрация имеет следующие преимущества
############################# About Formats ############################
about_formats:
    enable: true
    format:
