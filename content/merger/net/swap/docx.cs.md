...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOCX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOCX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOCX stránky v C#"
description: "Vyměňte DOCX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte DOCX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru DOCX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOCX pomocí ukázkového kódu C#">}}
