...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSSM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSSM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSSM stránky v C#"
description: "Vymeňte VSSM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte VSSM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru VSSM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSSM pomocou vzorového kódu C#">}}
