...
############################# Head ############################
head_title: "Ruil en ruil OTP pagina's in C#"
head_description: "Wissel en ruil posities van twee pagina's binnen een OTP bestand in C# met behulp van de API voor het samenvoegen van documenten."

############################# Header ############################
title: "Wissel OTP pagina's in C#"
description: "Verwissel OTP pagina's met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Verwissel OTP Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het gemakkelijk voor C# ontwikkelaars om pagina's binnen een OTP bestand te wisselen door een paar eenvoudige stappen te implementeren .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTP bestandspagina's te wisselen met behulp van C# voorbeeldcode">}}
