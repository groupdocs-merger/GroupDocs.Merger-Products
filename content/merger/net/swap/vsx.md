...
############################# Head ############################
head_title: "Swap & Exchange VSX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSX file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSX Pages In C#"
description: "Swap VSX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSX file pages using C# example code">}}
