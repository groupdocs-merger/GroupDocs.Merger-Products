...
############################# Head ############################
head_title: "Sukeiskite ir keiskite MHTML puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas MHTML faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti MHTML puslapius C#"
description: "Pakeiskite MHTML puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti MHTML failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais MHTML faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti MHTML failo puslapius naudojant C# pavyzdinį kodą">}}
