...
############################# Head ############################
head_title: "Tausche & tausche VSDX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSDX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSDX Seiten in C#"
description: "Tauschen Sie VSDX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSDX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSDX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSDX-Dateiseiten mit C#-Beispielcode aus">}}
