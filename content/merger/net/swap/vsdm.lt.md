...
############################# Head ############################
head_title: "Sukeiskite ir keiskite VSDM puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas VSDM faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti VSDM puslapius C#"
description: "Pakeiskite VSDM puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti VSDM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais VSDM faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti VSDM failo puslapius naudojant C# pavyzdinį kodą">}}
