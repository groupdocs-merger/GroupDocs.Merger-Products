...
############################# Head ############################
head_title: "Bytt og bytt ut VSTM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSTM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSTM sider i C#"
description: "Bytt VSTM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSTM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSTM filsider ved å bruke C# eksempelkode">}}
