...
############################# Head ############################
head_title: "Tukar & Tukarkan VTX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VTX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VTX Halaman Di C#"
description: "Tukar VTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VTX menggunakan kode contoh C#">}}
