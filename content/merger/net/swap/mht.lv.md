...
############################# Head ############################
head_title: "Apmainīt un apmainīt MHT lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas MHT failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt MHT lapas programmā C#"
description: "Apmainiet MHT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt MHT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām MHT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt MHT faila lapas, izmantojot C# piemēra kodu">}}
