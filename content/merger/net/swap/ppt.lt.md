...
############################# Head ############################
head_title: "Sukeiskite ir keiskite PPT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas PPT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti PPT puslapius C#"
description: "Pakeiskite PPT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti PPT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais PPT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti PPT failo puslapius naudojant C# pavyzdinį kodą">}}
