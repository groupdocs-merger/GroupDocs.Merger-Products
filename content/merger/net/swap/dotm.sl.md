...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj DOTM strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke DOTM v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj DOTM strani v C#"
description: "Zamenjajte strani DOTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke DOTM v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki DOTM z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke DOTM s primerom kode C#">}}
