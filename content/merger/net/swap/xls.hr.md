...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLS stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLS datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLS stranice u C#"
description: "Zamijenite XLS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XLS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLS stranice datoteke koristeći C# primjer koda">}}
