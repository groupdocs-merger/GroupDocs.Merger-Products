...
############################# Head ############################
head_title: "Sukeiskite ir keiskite ONE puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas ONE faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti ONE puslapius C#"
description: "Pakeiskite ONE puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti ONE failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais ONE faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti ONE failo puslapius naudojant C# pavyzdinį kodą">}}
