...
############################# Head ############################
head_title: "Intercambiar e intercambiar MHTML páginas en C#"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo MHTML en C# utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar MHTML páginas en C#"
description: "Intercambie MHTML páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Intercambiar MHTML páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# intercambiar páginas dentro de un archivo MHTML mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos MHTML usando el código de ejemplo C#">}}
