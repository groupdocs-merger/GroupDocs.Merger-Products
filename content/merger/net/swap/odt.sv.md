...
############################# Head ############################
head_title: "Byt och byt ut ODT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en ODT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt ODT sidor i C#"
description: "Byt ODT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt ODT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en ODT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter ODT filsidor med hjälp av C# exempelkod">}}
