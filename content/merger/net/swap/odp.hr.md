...
############################# Head ############################
head_title: "Zamijeni i razmijeni ODP stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar ODP datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni ODP stranice u C#"
description: "Zamijenite ODP stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni ODP stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar ODP datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti ODP stranice datoteke koristeći C# primjer koda">}}
