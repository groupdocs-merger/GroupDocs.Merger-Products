...
############################# Head ############################
head_title: "Byt och byt ut VTX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VTX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VTX sidor i C#"
description: "Byt VTX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VTX filsidor med hjälp av C# exempelkod">}}
