...
############################# Head ############################
head_title: "Tukar & Tukar XLTM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLTM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLTM Halaman Dalam C#"
description: "Tukar XLTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLTM halaman fail menggunakan kod contoh C#.">}}
