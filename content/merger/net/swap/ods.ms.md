...
############################# Head ############################
head_title: "Tukar & Tukar ODS Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODS dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODS Halaman Dalam C#"
description: "Tukar ODS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar ODS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail ODS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODS halaman fail menggunakan kod contoh C#.">}}
