...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj DOCX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke DOCX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj DOCX strani v C#"
description: "Zamenjajte strani DOCX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke DOCX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki DOCX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke DOCX s primerom kode C#">}}
