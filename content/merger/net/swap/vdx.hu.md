...
############################# Head ############################
head_title: "Cserélj és cserélj VDX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VDX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VDX oldal cseréje a C# nyelven"
description: "Cserélje ki az VDX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VDX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VDX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VDX fájloldalakat a C# példakóddal">}}
