...
############################# Head ############################
head_title: "Tukar & Tukar XLSX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLSX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLSX Halaman Dalam C#"
description: "Tukar XLSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLSX halaman fail menggunakan kod contoh C#.">}}
