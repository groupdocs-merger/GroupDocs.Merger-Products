...
############################# Head ############################
head_title: "Tukar & Tukarkan DOTX Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOTX di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTX Halaman Di C#"
description: "Tukar DOTX Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOTX Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOTX dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOTX menggunakan kode contoh C#">}}
