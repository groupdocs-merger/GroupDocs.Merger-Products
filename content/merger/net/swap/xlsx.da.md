...
############################# Head ############################
head_title: "Byt og byt XLSX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLSX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLSX sider i C#"
description: "Byt XLSX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLSX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLSX filsider ved hjælp af C# eksempelkode">}}
