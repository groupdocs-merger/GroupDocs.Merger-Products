...
############################# Head ############################
head_title: "Apmainīt un apmainīt XLTX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas XLTX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt XLTX lapas programmā C#"
description: "Apmainiet XLTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt XLTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām XLTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt XLTX faila lapas, izmantojot C# piemēra kodu">}}
