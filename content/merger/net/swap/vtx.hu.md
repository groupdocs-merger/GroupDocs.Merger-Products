...
############################# Head ############################
head_title: "Cserélj és cserélj VTX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy VTX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "VTX oldal cseréje a C# nyelven"
description: "Cserélje ki az VTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VTX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy VTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk VTX fájloldalakat a C# példakóddal">}}
