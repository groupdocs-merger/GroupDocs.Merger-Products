...
############################# Head ############################
head_title: "Byt og byt ODT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en ODT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt ODT sider i C#"
description: "Byt ODT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt ODT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en ODT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du ODT filsider ved hjælp af C# eksempelkode">}}
