...
############################# Head ############################
head_title: "Byt och byt ut PPT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en PPT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt PPT sidor i C#"
description: "Byt PPT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt PPT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en PPT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter PPT filsidor med hjälp av C# exempelkod">}}
