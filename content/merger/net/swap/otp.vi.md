...
############################# Head ############################
head_title: "Hoán đổi & Trao đổi OTP Trang trong C#"
head_description: "Hoán đổi & Trao đổi vị trí của hai trang trong tệp OTP trong C# bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "Hoán đổi OTP Trang trong C#"
description: "Hoán đổi các trang OTP bằng một vài dòng mã .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hoán đổi các trang tệp OTP bằng mã mẫu C#">}}
