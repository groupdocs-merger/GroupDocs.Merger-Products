...
############################# Head ############################
head_title: "Byt og byt DOTX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOTX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOTX sider i C#"
description: "Byt DOTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOTX filsider ved hjælp af C# eksempelkode">}}
