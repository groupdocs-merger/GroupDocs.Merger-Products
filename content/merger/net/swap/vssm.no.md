...
############################# Head ############################
head_title: "Bytt og bytt ut VSSM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSSM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSSM sider i C#"
description: "Bytt VSSM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSSM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSSM filsider ved å bruke C# eksempelkode">}}
