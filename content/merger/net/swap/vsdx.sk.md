...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSDX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSDX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSDX stránky v C#"
description: "Vymeňte VSDX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte VSDX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru VSDX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSDX pomocou vzorového kódu C#">}}
