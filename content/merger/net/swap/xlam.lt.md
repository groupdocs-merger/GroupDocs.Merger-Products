...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLAM puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLAM faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLAM puslapius C#"
description: "Pakeiskite XLAM puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLAM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLAM faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLAM failo puslapius naudojant C# pavyzdinį kodą">}}
