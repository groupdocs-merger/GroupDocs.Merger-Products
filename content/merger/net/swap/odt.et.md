...
############################# Head ############################
head_title: "Vahetage ja vahetage ODT lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone ODT failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage ODT lehte keeles C#"
description: "Vahetage ODT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage ODT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis ODT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada ODT faililehte, kasutades C# näitekoodi">}}
