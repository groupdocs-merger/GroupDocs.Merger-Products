...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj PPS strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke PPS v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj PPS strani v C#"
description: "Zamenjajte strani PPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke PPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki PPS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke PPS s primerom kode C#">}}
