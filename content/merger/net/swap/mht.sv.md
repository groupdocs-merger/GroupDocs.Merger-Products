...
############################# Head ############################
head_title: "Byt och byt ut MHT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en MHT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt MHT sidor i C#"
description: "Byt MHT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt MHT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en MHT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter MHT filsidor med hjälp av C# exempelkod">}}
