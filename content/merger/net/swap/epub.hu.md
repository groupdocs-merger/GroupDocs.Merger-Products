...
############################# Head ############################
head_title: "Cserélj és cserélj EPUB oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy EPUB fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "EPUB oldal cseréje a C# nyelven"
description: "Cserélje ki az EPUB oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "EPUB fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy EPUB fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk EPUB fájloldalakat a C# példakóddal">}}
