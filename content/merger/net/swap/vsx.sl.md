...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj VSX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke VSX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj VSX strani v C#"
description: "Zamenjajte strani VSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke VSX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki VSX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke VSX s primerom kode C#">}}
