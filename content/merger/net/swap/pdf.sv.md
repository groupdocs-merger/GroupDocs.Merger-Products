...
############################# Head ############################
head_title: "Byt och byt ut PDF sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en PDF-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt PDF sidor i C#"
description: "Byt PDF-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt PDF filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en PDF-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter PDF filsidor med hjälp av C# exempelkod">}}
