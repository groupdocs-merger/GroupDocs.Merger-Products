...
############################# Head ############################
head_title: "Tukar & Tukarkan WEB Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file WEB di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar WEB Halaman Di C#"
description: "Tukar WEB Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar WEB Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file WEB dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file WEB menggunakan kode contoh C#">}}
...
demos:
    enable: true
    title: "Demo Langsung - Tukar WEB Halaman File Online"
    content: |
       Tukar halaman file WEB sekarang juga dengan mengunjungi situs web [GroupDocs.Merger Live Demo](https://products.groupdocs.app/splitter/swap-pages/web).
