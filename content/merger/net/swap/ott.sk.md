...
############################# Head ############################
head_title: "Vymeňte a vymeňte OTT stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore OTT v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte OTT stránky v C#"
description: "Vymeňte OTT stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte OTT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru OTT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru OTT pomocou vzorového kódu C#">}}
