...
############################# Head ############################
head_title: "Zamień i zamień TEX strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku TEX w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień TEX strony w C#"
description: "Zamień strony TEX na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików TEX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku TEX, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku TEX przy użyciu przykładowego kodu C#">}}
