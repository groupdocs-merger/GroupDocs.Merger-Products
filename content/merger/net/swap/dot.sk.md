...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOT stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOT v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOT stránky v C#"
description: "Vymeňte DOT stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte DOT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru DOT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOT pomocou vzorového kódu C#">}}
