...
############################# Head ############################
head_title: "Zamień i zamień DOC strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOC w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOC strony w C#"
description: "Zamień strony DOC na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOC w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOC, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOC przy użyciu przykładowego kodu C#">}}
