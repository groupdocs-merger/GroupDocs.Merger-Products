...
############################# Head ############################
head_title: "Byt och byt ut VSDX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSDX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSDX sidor i C#"
description: "Byt VSDX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSDX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSDX filsidor med hjälp av C# exempelkod">}}
