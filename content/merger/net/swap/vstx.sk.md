...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSTX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSTX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSTX stránky v C#"
description: "Vymeňte VSTX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte VSTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru VSTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSTX pomocou vzorového kódu C#">}}
