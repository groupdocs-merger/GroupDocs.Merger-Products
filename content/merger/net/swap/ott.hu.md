...
############################# Head ############################
head_title: "Cserélj és cserélj OTT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy OTT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTT oldal cseréje a C# nyelven"
description: "Cserélje ki az OTT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "OTT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy OTT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk OTT fájloldalakat a C# példakóddal">}}
