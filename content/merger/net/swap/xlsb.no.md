...
############################# Head ############################
head_title: "Bytt og bytt ut XLSB sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLSB-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLSB sider i C#"
description: "Bytt XLSB-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLSB-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLSB filsider ved å bruke C# eksempelkode">}}
