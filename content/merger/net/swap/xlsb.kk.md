...
############################# Head ############################
head_title: "C# ішіндегі XLSB беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы XLSB файлындағы екі беттің орнын C# арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "XLSB беттерді C# арқылы ауыстыру"
description: "XLSB беттерді .NET кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі XLSB файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы XLSB файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="XLSB файл беттерін C# мысал коды арқылы ауыстыру жолы">}}
