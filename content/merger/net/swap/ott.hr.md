...
############################# Head ############################
head_title: "Zamijeni i razmijeni OTT stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar OTT datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni OTT stranice u C#"
description: "Zamijenite OTT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni OTT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar OTT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti OTT stranice datoteke koristeći C# primjer koda">}}
