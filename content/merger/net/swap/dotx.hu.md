...
############################# Head ############################
head_title: "Cserélj és cserélj DOTX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOTX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOTX oldal cseréje a C# nyelven"
description: "Cserélje ki az DOTX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOTX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOTX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOTX fájloldalakat a C# példakóddal">}}
