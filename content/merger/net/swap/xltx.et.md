...
############################# Head ############################
head_title: "Vahetage ja vahetage XLTX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLTX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLTX lehte keeles C#"
description: "Vahetage XLTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLTX faililehte, kasutades C# näitekoodi">}}
