...
############################# Head ############################
head_title: "Tukar & Tukarkan XPS Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file XPS di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XPS Halaman Di C#"
description: "Tukar XPS Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar XPS Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file XPS dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file XPS menggunakan kode contoh C#">}}
