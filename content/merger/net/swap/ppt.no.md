...
############################# Head ############################
head_title: "Bytt og bytt ut PPT sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en PPT-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt PPT sider i C#"
description: "Bytt PPT-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en PPT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte PPT filsider ved å bruke C# eksempelkode">}}
