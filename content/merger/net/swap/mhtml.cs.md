...
############################# Head ############################
head_title: "Vyměňte a vyměňte MHTML stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru MHTML v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit MHTML stránky v C#"
description: "Vyměňte MHTML stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte MHTML stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru MHTML provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru MHTML pomocí ukázkového kódu C#">}}
