...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSSM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSSM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSSM stránky v C#"
description: "Vyměňte VSSM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSSM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSSM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSSM pomocí ukázkového kódu C#">}}
