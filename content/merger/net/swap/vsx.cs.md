...
############################# Head ############################
head_title: "Vyměňte a vyměňte VSX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VSX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VSX stránky v C#"
description: "Vyměňte VSX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VSX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VSX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VSX pomocí ukázkového kódu C#">}}
