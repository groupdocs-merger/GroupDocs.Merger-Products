...
############################# Head ############################
head_title: "Tukar & Tukarkan OTT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file OTT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTT Halaman Di C#"
description: "Tukar OTT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar OTT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file OTT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file OTT menggunakan kode contoh C#">}}
