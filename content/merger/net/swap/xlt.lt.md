...
############################# Head ############################
head_title: "Sukeiskite ir keiskite XLT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas XLT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti XLT puslapius C#"
description: "Pakeiskite XLT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti XLT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais XLT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti XLT failo puslapius naudojant C# pavyzdinį kodą">}}
