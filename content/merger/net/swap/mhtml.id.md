...
############################# Head ############################
head_title: "Tukar & Tukarkan MHTML Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file MHTML di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar MHTML Halaman Di C#"
description: "Tukar MHTML Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar MHTML Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file MHTML dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file MHTML menggunakan kode contoh C#">}}
