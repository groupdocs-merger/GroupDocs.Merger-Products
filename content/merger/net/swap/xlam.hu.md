...
############################# Head ############################
head_title: "Cserélj és cserélj XLAM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XLAM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XLAM oldal cseréje a C# nyelven"
description: "Cserélje ki az XLAM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XLAM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XLAM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XLAM fájloldalakat a C# példakóddal">}}
