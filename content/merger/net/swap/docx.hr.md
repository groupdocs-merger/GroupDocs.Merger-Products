...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOCX stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOCX datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOCX stranice u C#"
description: "Zamijenite DOCX stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOCX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar DOCX datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOCX stranice datoteke koristeći C# primjer koda">}}
