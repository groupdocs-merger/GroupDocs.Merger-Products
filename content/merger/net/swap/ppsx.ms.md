...
############################# Head ############################
head_title: "Tukar & Tukar PPSX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPSX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPSX Halaman Dalam C#"
description: "Tukar PPSX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar PPSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail PPSX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPSX halaman fail menggunakan kod contoh C#.">}}
