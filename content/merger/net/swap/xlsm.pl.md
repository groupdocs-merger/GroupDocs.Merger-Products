...
############################# Head ############################
head_title: "Zamień i zamień XLSM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLSM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLSM strony w C#"
description: "Zamień strony XLSM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLSM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLSM przy użyciu przykładowego kodu C#">}}
