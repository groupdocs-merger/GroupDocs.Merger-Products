...
############################# Head ############################
head_title: "C# ішіндегі OTP беттерді ауыстыру және алмасу"
head_description: "Құжаттарды біріктіру API арқылы OTP файлындағы екі беттің орнын C# арқылы ауыстырыңыз және ауыстырыңыз."

############################# Header ############################
title: "OTP беттерді C# арқылы ауыстыру"
description: "OTP беттерді .NET кодының бірнеше жолымен ауыстырыңыз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі OTP файл беттерін ауыстыру"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бірнеше оңай қадамдарды орындау арқылы OTP файлындағы беттерді ауыстыруды жеңілдетеді. .
    ...
    code: |
     ...
     {{< merger/code-merger title="OTP файл беттерін C# мысал коды арқылы ауыстыру жолы">}}
