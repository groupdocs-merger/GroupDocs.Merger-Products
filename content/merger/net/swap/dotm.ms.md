...
############################# Head ############################
head_title: "Tukar & Tukar DOTM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail DOTM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOTM Halaman Dalam C#"
description: "Tukar DOTM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar DOTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail DOTM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar DOTM halaman fail menggunakan kod contoh C#.">}}
