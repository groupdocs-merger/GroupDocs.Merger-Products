...
############################# Head ############################
head_title: "Vymeňte a vymeňte HTML stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore HTML v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte HTML stránky v C#"
description: "Vymeňte HTML stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte HTML strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru HTML implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru HTML pomocou vzorového kódu C#">}}
