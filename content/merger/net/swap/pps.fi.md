...
############################# Head ############################
head_title: "Vaihda ja vaihda PPS sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPS-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPS sivua C#"
description: "Vaihda PPS-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja PPS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPS tiedostosivua käyttämällä C# esimerkkikoodia">}}
