...
############################# Head ############################
head_title: "Tukar & Tukar ODT Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail ODT dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ODT Halaman Dalam C#"
description: "Tukar ODT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar ODT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail ODT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar ODT halaman fail menggunakan kod contoh C#.">}}
