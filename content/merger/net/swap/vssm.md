...
############################# Head ############################
head_title: "Swap & Exchange VSSM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSSM file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSSM Pages In C#"
description: "Swap VSSM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSSM file pages using C# example code">}}
