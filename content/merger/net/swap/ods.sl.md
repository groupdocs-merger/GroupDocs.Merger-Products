...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj ODS strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke ODS v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj ODS strani v C#"
description: "Zamenjajte strani ODS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke ODS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki ODS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke ODS s primerom kode C#">}}
