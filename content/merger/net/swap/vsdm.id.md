...
############################# Head ############################
head_title: "Tukar & Tukarkan VSDM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file VSDM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDM Halaman Di C#"
description: "Tukar VSDM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar VSDM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file VSDM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file VSDM menggunakan kode contoh C#">}}
