...
############################# Head ############################
head_title: "Swap & Exchange HTML Pages in C#"
head_description: "Swap & Exchange positions of two pages within a HTML file in C# using the documents merger API."

############################# Header ############################
title: "Swap HTML Pages In C#"
description: "Swap HTML Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a HTML file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap HTML file pages using C# example code">}}
