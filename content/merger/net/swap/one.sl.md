...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj ONE strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke ONE v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj ONE strani v C#"
description: "Zamenjajte strani ONE z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke ONE v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki ONE z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke ONE s primerom kode C#">}}
