...
############################# Head ############################
head_title: "Tausche & tausche VSX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSX Seiten in C#"
description: "Tauschen Sie VSX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSX-Dateiseiten mit C#-Beispielcode aus">}}
