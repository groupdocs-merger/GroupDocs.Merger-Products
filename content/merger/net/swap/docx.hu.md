...
############################# Head ############################
head_title: "Cserélj és cserélj DOCX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOCX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCX oldal cseréje a C# nyelven"
description: "Cserélje ki az DOCX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOCX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOCX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOCX fájloldalakat a C# példakóddal">}}
