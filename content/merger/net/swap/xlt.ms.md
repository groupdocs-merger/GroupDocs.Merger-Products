...
############################# Head ############################
head_title: "Tukar & Tukar XLT Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail XLT dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar XLT Halaman Dalam C#"
description: "Tukar XLT Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar XLT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail XLT dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar XLT halaman fail menggunakan kod contoh C#.">}}
