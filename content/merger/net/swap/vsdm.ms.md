...
############################# Head ############################
head_title: "Tukar & Tukar VSDM Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSDM dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSDM Halaman Dalam C#"
description: "Tukar VSDM Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VSDM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VSDM dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSDM halaman fail menggunakan kod contoh C#.">}}
