...
############################# Head ############################
head_title: "በC# ውስጥ ONE ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በC# ውስጥ ባለው የONE ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "ONE ገጾችን በC# ውስጥ ይቀያይሩ"
description: "ONE ገጾችን በጥቂት የ.NET ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "ONE የፋይል ገጾችን በ.NET ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በONE ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="ONE የፋይል ገጾችን C# ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}
