...
############################# Head ############################
head_title: "Tukar & Tukarkan DOCM Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOCM di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOCM Halaman Di C#"
description: "Tukar DOCM Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOCM Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOCM dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOCM menggunakan kode contoh C#">}}
