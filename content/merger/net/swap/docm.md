...
############################# Head ############################
head_title: "Swap & Exchange DOCM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a DOCM file in C# using the documents merger API."

############################# Header ############################
title: "Swap DOCM Pages In C#"
description: "Swap DOCM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a DOCM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap DOCM file pages using C# example code">}}
