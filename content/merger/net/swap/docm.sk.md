...
############################# Head ############################
head_title: "Vymeňte a vymeňte DOCM stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore DOCM v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte DOCM stránky v C#"
description: "Vymeňte DOCM stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte DOCM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru DOCM implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru DOCM pomocou vzorového kódu C#">}}
