...
############################# Head ############################
head_title: "Swap & Exchange EXCEL Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a EXCEL file using the file split API."

############################# Header ############################
title: "Swap EXCEL Pages in .NET"
description: "Swap and exchange positions of two pages within a EXCEL file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Swap EXCEL File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a EXCEL file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Swap EXCEL file pages using GroupDocs.Merger API
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Live Demos - Swap EXCEL File Pages Online"
    content: |
        Swap pages within EXCEL files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/excel) website.
