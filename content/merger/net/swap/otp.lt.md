...
############################# Head ############################
head_title: "Sukeiskite ir keiskite OTP puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas OTP faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti OTP puslapius C#"
description: "Pakeiskite OTP puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti OTP failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais OTP faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti OTP failo puslapius naudojant C# pavyzdinį kodą">}}
