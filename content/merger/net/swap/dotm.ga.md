...
############################# Head ############################
head_title: "Babhtáil & Malartú DOTM Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad DOTM in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil DOTM Leathanaigh i C#"
description: "Malartú DOTM Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil DOTM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad DOTM trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOTM a mhalartú le cód samplach C#">}}
