...
############################# Head ############################
head_title: "Разменете и обменяйте XLAM страници на C#"
head_description: "Разменете и разменете позиции на две страници във файл XLAM в C# с помощта на API за сливане на документи."

############################# Header ############################
title: "Разменете XLAM страници в C#"
description: "Разменете XLAM страници с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разменете XLAM файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разменят страници в рамките на файл XLAM чрез прилагане на няколко лесни стъпки .
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разменяте XLAM файлови страници с C# примерен код">}}
