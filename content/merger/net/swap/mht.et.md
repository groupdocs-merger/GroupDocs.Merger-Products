...
############################# Head ############################
head_title: "Vahetage ja vahetage MHT lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone MHT failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage MHT lehte keeles C#"
description: "Vahetage MHT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage MHT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis MHT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada MHT faililehte, kasutades C# näitekoodi">}}
