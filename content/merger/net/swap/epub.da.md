...
############################# Head ############################
head_title: "Byt og byt EPUB sider i C#"
head_description: "Byt og udveksle positioner på to sider i en EPUB-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt EPUB sider i C#"
description: "Byt EPUB sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en EPUB-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du EPUB filsider ved hjælp af C# eksempelkode">}}
