...
############################# Head ############################
head_title: "Cserélj és cserélj OTP oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy OTP fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "OTP oldal cseréje a C# nyelven"
description: "Cserélje ki az OTP oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "OTP fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy OTP fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk OTP fájloldalakat a C# példakóddal">}}
