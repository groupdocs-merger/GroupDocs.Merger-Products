...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOCM puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOCM faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOCM puslapius C#"
description: "Pakeiskite DOCM puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOCM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais DOCM faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOCM failo puslapius naudojant C# pavyzdinį kodą">}}
