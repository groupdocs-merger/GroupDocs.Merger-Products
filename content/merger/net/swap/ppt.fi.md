...
############################# Head ############################
head_title: "Vaihda ja vaihda PPT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja PPT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda PPT sivua C#"
description: "Vaihda PPT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda PPT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja PPT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa PPT tiedostosivua käyttämällä C# esimerkkikoodia">}}
