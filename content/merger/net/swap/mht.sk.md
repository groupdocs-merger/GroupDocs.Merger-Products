...
############################# Head ############################
head_title: "Vymeňte a vymeňte MHT stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore MHT v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte MHT stránky v C#"
description: "Vymeňte MHT stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte MHT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru MHT implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru MHT pomocou vzorového kódu C#">}}
