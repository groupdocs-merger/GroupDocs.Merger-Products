...
############################# Head ############################
head_title: "Scambia le pagine nei file POWERPOINT utilizzando le app .NET"
head_description: "Utilizza GroupDocs.Merger for .NET per riordinare le pagine nei documenti POWERPOINT. Modifica PDF, file Word, fogli di calcolo, presentazioni, diagrammi Visio, immagini e altro."

############################# Header ############################
title: "Scambia le pagine POWERPOINT" 
description: "GroupDocs.Merger for .NET estende le applicazioni .NET con avanzate funzionalità di gestione dei documenti. Riorganizza le pagine nei file POWERPOINT per strutturare il contenuto esattamente come necessario."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/net/), puoi riorganizzare le pagine nei documenti POWERPOINT per migliorare leggibilità e struttura. Aggiungi un'elaborazione documentale efficiente alle tue applicazioni .NET.
      
      1. Fornisci il percorso al file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Scambia la prima e l'ultima pagina in un file POWERPOINT"
      content: |
        Questo esempio dimostra come scambiare pagine in un file POWERPOINT in pochi semplici passaggi.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
