...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSSM lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSSM failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSSM lapas programmā C#"
description: "Apmainiet VSSM lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSSM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām VSSM failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSSM faila lapas, izmantojot C# piemēra kodu">}}
