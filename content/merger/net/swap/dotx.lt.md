...
############################# Head ############################
head_title: "Sukeiskite ir keiskite DOTX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas DOTX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti DOTX puslapius C#"
description: "Pakeiskite DOTX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti DOTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais DOTX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti DOTX failo puslapius naudojant C# pavyzdinį kodą">}}
