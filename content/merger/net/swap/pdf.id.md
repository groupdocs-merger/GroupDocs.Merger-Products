...
############################# Head ############################
head_title: "Tukar & Tukarkan PDF Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file PDF di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PDF Halaman Di C#"
description: "Tukar PDF Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar PDF Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file PDF dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file PDF menggunakan kode contoh C#">}}
