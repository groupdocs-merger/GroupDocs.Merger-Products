...
############################# Head ############################
head_title: "Vyměňte a vyměňte RTF stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru RTF v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit RTF stránky v C#"
description: "Vyměňte RTF stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte RTF stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru RTF provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru RTF pomocí ukázkového kódu C#">}}
