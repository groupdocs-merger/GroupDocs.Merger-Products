...
############################# Head ############################
head_title: "Swap & Exchange IMAGE Pages in C#"
head_description: "Swap & Exchange positions of two pages within a IMAGE file in C# using the documents merger API."

############################# Header ############################
title: "Swap IMAGE Pages In C#"
description: "Swap IMAGE Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a IMAGE file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap IMAGE file pages using C# example code">}}
