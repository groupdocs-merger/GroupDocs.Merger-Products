...
############################# Head ############################
head_title: "Vaihda ja vaihda MHT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja MHT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda MHT sivua C#"
description: "Vaihda MHT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda MHT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja MHT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa MHT tiedostosivua käyttämällä C# esimerkkikoodia">}}
