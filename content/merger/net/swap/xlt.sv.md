...
############################# Head ############################
head_title: "Byt och byt ut XLT sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XLT-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XLT sidor i C#"
description: "Byt XLT-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XLT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XLT-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XLT filsidor med hjälp av C# exempelkod">}}
