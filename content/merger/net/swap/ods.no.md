...
############################# Head ############################
head_title: "Bytt og bytt ut ODS sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en ODS-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt ODS sider i C#"
description: "Bytt ODS-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en ODS-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte ODS filsider ved å bruke C# eksempelkode">}}
