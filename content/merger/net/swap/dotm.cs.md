...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOTM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOTM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOTM stránky v C#"
description: "Vyměňte DOTM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte DOTM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru DOTM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOTM pomocí ukázkového kódu C#">}}
