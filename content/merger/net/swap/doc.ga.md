...
############################# Head ############################
head_title: "Babhtáil & Malartú DOC Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad DOC in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil DOC Leathanaigh i C#"
description: "Malartú DOC Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil DOC Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad DOC trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOC a mhalartú le cód samplach C#">}}
