...
############################# Head ############################
head_title: "Tausche & tausche MHTML Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer MHTML-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche MHTML Seiten in C#"
description: "Tauschen Sie MHTML-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "MHTML Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer MHTML-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie MHTML-Dateiseiten mit C#-Beispielcode aus">}}
