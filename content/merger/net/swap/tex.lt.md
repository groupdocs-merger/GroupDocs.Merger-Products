...
############################# Head ############################
head_title: "Sukeiskite ir keiskite TEX puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas TEX faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti TEX puslapius C#"
description: "Pakeiskite TEX puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti TEX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais TEX faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti TEX failo puslapius naudojant C# pavyzdinį kodą">}}
