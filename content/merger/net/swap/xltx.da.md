...
############################# Head ############################
head_title: "Byt og byt XLTX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLTX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLTX sider i C#"
description: "Byt XLTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLTX filsider ved hjælp af C# eksempelkode">}}
