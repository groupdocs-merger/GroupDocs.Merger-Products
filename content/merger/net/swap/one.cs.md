...
############################# Head ############################
head_title: "Vyměňte a vyměňte ONE stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru ONE v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit ONE stránky v C#"
description: "Vyměňte ONE stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte ONE stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru ONE provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru ONE pomocí ukázkového kódu C#">}}
