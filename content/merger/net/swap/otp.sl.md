...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj OTP strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke OTP v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj OTP strani v C#"
description: "Zamenjajte strani OTP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke OTP v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki OTP z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke OTP s primerom kode C#">}}
