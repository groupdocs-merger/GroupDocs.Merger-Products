...
############################# Head ############################
head_title: "Sukeiskite ir keiskite OTT puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas OTT faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti OTT puslapius C#"
description: "Pakeiskite OTT puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti OTT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais OTT faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti OTT failo puslapius naudojant C# pavyzdinį kodą">}}
