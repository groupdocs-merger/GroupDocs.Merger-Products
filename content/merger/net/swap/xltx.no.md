...
############################# Head ############################
head_title: "Bytt og bytt ut XLTX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLTX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLTX sider i C#"
description: "Bytt XLTX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLTX filsider ved å bruke C# eksempelkode">}}
