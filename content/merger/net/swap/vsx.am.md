...
############################# Head ############################
head_title: "በC# ውስጥ VSX ገጾችን ይቀይሩ እና ይለዋወጡ"
head_description: "የሰነዶች ውህደት ኤፒአይን በመጠቀም በC# ውስጥ ባለው የVSX ፋይል ውስጥ የሁለት ገጾችን ቦታ ይቀይሩ እና ይለዋወጡ።"

############################# Header ############################
title: "VSX ገጾችን በC# ውስጥ ይቀያይሩ"
description: "VSX ገጾችን በጥቂት የ.NET ኮድ መስመሮች ይቀያይሩ።"
...
steps:
    enable: true
    title_left: "VSX የፋይል ገጾችን በ.NET ይቀያይሩ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች ጥቂት ቀላል ደረጃዎችን በመተግበር በVSX ፋይል ውስጥ ገጾችን ለመለዋወጥ ቀላል ያደርገዋል። .
    ...
    code: |
     ...
     {{< merger/code-merger title="VSX የፋይል ገጾችን C# ምሳሌ ኮድ እንዴት መቀየር እንደሚቻል">}}
