...
############################# Head ############################
head_title: "Apmainīt un apmainīt ODT lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas ODT failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt ODT lapas programmā C#"
description: "Apmainiet ODT lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt ODT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām ODT failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt ODT faila lapas, izmantojot C# piemēra kodu">}}
