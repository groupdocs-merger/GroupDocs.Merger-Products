...
############################# Head ############################
head_title: "Vahetage ja vahetage VTX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VTX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VTX lehte keeles C#"
description: "Vahetage VTX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VTX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VTX faililehte, kasutades C# näitekoodi">}}
