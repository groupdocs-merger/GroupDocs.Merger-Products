...
############################# Head ############################
head_title: "Swap & Exchange XLSM Pages in C#"
head_description: "Swap & Exchange positions of two pages within a XLSM file in C# using the documents merger API."

############################# Header ############################
title: "Swap XLSM Pages In C#"
description: "Swap XLSM Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a XLSM file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XLSM file pages using C# example code">}}
