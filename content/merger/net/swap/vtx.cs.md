...
############################# Head ############################
head_title: "Vyměňte a vyměňte VTX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru VTX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit VTX stránky v C#"
description: "Vyměňte VTX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte VTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru VTX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru VTX pomocí ukázkového kódu C#">}}
