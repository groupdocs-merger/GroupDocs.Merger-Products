...
############################# Head ############################
head_title: "Swap & Exchange RTF Pages in C#"
head_description: "Swap & Exchange positions of two pages within a RTF file in C# using the documents merger API."

############################# Header ############################
title: "Swap RTF Pages In C#"
description: "Swap RTF Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a RTF file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap RTF file pages using C# example code">}}
