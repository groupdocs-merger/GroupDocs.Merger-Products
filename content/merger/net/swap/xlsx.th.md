...
############################# Head ############################
head_title: "สลับและแลกเปลี่ยนหน้า XLSX ใน C#"
head_description: "สลับและแลกเปลี่ยนตำแหน่งสองหน้าภายในไฟล์ XLSX ใน C# โดยใช้ API การรวมเอกสาร"

############################# Header ############################
title: "สลับ XLSX หน้าใน C#"
description: "สลับ XLSX หน้าด้วยโค้ด .NET สองสามบรรทัด"
...
steps:
    enable: true
    title_left: "สลับหน้าไฟล์ XLSX ใน .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ทำให้นักพัฒนา C# สามารถสลับหน้าภายในไฟล์ XLSX ได้โดยง่ายโดยใช้ขั้นตอนง่ายๆ ไม่กี่ขั้นตอน .
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีสลับหน้าไฟล์ XLSX โดยใช้โค้ดตัวอย่าง C#">}}
