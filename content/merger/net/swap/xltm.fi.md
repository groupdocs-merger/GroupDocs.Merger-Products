...
############################# Head ############################
head_title: "Vaihda ja vaihda XLTM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja XLTM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda XLTM sivua C#"
description: "Vaihda XLTM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda XLTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja XLTM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa XLTM tiedostosivua käyttämällä C# esimerkkikoodia">}}
