...
############################# Head ############################
head_title: "Zamijeni i razmijeni XLAM stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar XLAM datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni XLAM stranice u C#"
description: "Zamijenite XLAM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni XLAM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar XLAM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti XLAM stranice datoteke koristeći C# primjer koda">}}
