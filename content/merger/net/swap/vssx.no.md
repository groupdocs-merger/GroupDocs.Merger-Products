...
############################# Head ############################
head_title: "Bytt og bytt ut VSSX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSSX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSSX sider i C#"
description: "Bytt VSSX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSSX filsider ved å bruke C# eksempelkode">}}
