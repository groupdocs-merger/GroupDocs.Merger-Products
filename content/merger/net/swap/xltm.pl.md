...
############################# Head ############################
head_title: "Zamień i zamień XLTM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLTM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLTM strony w C#"
description: "Zamień strony XLTM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLTM przy użyciu przykładowego kodu C#">}}
