...
############################# Head ############################
head_title: "Vahetage ja vahetage DOCM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOCM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOCM lehte keeles C#"
description: "Vahetage DOCM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOCM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOCM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOCM faililehte, kasutades C# näitekoodi">}}
