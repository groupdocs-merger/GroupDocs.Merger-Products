...
############################# Head ############################
head_title: "Ανταλλαγή και ανταλλαγή σελίδων ODS σε C#"
head_description: "Ανταλλαγή και ανταλλαγή θέσεων δύο σελίδων σε ένα αρχείο ODS στο C# χρησιμοποιώντας το API συγχώνευσης εγγράφων."

############################# Header ############################
title: "Ανταλλαγή ODS σελίδων σε C#"
description: "Αλλάξτε ODS σελίδες με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Ανταλλαγή ODS σελίδων αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να ανταλλάξουν σελίδες σε ένα αρχείο ODS εφαρμόζοντας μερικά εύκολα βήματα .
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να ανταλλάξετε σελίδες αρχείου ODS χρησιμοποιώντας παράδειγμα κώδικα C#">}}
