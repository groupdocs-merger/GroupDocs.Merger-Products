...
############################# Head ############################
head_title: "Zamijeni i razmijeni MHT stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar MHT datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni MHT stranice u C#"
description: "Zamijenite MHT stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni MHT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar MHT datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti MHT stranice datoteke koristeći C# primjer koda">}}
