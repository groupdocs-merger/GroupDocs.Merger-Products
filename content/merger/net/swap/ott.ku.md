...
############################# Head ############################
head_title: "Biguherîne û biguherîne OTT Rûpelên di C# de"
head_description: "Bi karanîna API-ya yekkirina belgeyan, di nav pelek OTT de di nav pelek C# de du rûpelan biguhezînin û biguhezînin."

############################# Header ############################
title: "Biguherîne OTT Rûpelên Di C# de"
description: "Rûpelên OTT bi çend rêzikên koda .NET biguherînin."
...
steps:
    enable: true
    title_left: "Di .NET de OTT Rûpelên Pelan biguherînin"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa rûpelên pelê yên OTT bi karanîna koda nimûneya C# veguhezîne">}}
