...
############################# Head ############################
head_title: "Babhtáil & Malartú MHT Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad MHT in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil MHT Leathanaigh i C#"
description: "Malartú MHT Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil MHT Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad MHT trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid MHT a mhalartú le cód samplach C#">}}
