...
############################# Head ############################
head_title: "Byt og byt MHT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en MHT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt MHT sider i C#"
description: "Byt MHT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en MHT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du MHT filsider ved hjælp af C# eksempelkode">}}
