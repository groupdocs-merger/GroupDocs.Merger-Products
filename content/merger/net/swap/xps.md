...
############################# Head ############################
head_title: "Swap & Exchange XPS Pages in C#"
head_description: "Swap & Exchange positions of two pages within a XPS file in C# using the documents merger API."

############################# Header ############################
title: "Swap XPS Pages In C#"
description: "Swap XPS Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a XPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap XPS file pages using C# example code">}}
...
demos:
    ...
    content: |
       Swap XPS file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/xps) website.
