...
############################# Head ############################
head_title: "Vaihda ja vaihda VSSM sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja VSSM-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda VSSM sivua C#"
description: "Vaihda VSSM-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda VSSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja VSSM-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa VSSM tiedostosivua käyttämällä C# esimerkkikoodia">}}
