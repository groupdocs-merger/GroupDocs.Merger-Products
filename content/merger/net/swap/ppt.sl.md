...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj PPT strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke PPT v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj PPT strani v C#"
description: "Zamenjajte strani PPT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke PPT v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki PPT z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke PPT s primerom kode C#">}}
