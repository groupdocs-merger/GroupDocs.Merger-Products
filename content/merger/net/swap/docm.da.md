...
############################# Head ############################
head_title: "Byt og byt DOCM sider i C#"
head_description: "Byt og udveksle positioner på to sider i en DOCM-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt DOCM sider i C#"
description: "Byt DOCM sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en DOCM-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du DOCM filsider ved hjælp af C# eksempelkode">}}
