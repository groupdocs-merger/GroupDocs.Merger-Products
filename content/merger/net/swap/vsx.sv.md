...
############################# Head ############################
head_title: "Byt och byt ut VSX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSX sidor i C#"
description: "Byt VSX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSX filsidor med hjälp av C# exempelkod">}}
