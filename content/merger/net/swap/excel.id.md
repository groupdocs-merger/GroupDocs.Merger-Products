...
############################# Head ############################
head_title: "Tukar & Tukarkan EXCEL Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file EXCEL di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar EXCEL Halaman Di C#"
description: "Tukar EXCEL Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar EXCEL Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file EXCEL dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file EXCEL menggunakan kode contoh C#">}}
