...
############################# Head ############################
head_title: "Zamień i zamień EPUB strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku EPUB w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień EPUB strony w C#"
description: "Zamień strony EPUB na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików EPUB w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku EPUB, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku EPUB przy użyciu przykładowego kodu C#">}}
