...
############################# Head ############################
head_title: "Swap & Exchange DOTX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a DOTX file in C# using the documents merger API."

############################# Header ############################
title: "Swap DOTX Pages In C#"
description: "Swap DOTX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a DOTX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap DOTX file pages using C# example code">}}
