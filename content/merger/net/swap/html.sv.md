...
############################# Head ############################
head_title: "Byt och byt ut HTML sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en HTML-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt HTML sidor i C#"
description: "Byt HTML-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt HTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en HTML-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter HTML filsidor med hjälp av C# exempelkod">}}
