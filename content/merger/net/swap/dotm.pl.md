...
############################# Head ############################
head_title: "Zamień i zamień DOTM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku DOTM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień DOTM strony w C#"
description: "Zamień strony DOTM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików DOTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku DOTM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku DOTM przy użyciu przykładowego kodu C#">}}
