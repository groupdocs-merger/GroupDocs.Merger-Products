...
############################# Head ############################
head_title: "Zamień i zamień HTML strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku HTML w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień HTML strony w C#"
description: "Zamień strony HTML na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików HTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku HTML, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku HTML przy użyciu przykładowego kodu C#">}}
