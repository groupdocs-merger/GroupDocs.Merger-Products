...
############################# Head ############################
head_title: "Vyměňte a vyměňte DOCM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru DOCM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit DOCM stránky v C#"
description: "Vyměňte DOCM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte DOCM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru DOCM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru DOCM pomocí ukázkového kódu C#">}}
