...
############################# Head ############################
head_title: "Zamień i zamień ONE strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ONE w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ONE strony w C#"
description: "Zamień strony ONE na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików ONE w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku ONE, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ONE przy użyciu przykładowego kodu C#">}}
