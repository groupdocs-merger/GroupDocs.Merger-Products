...
############################# Head ############################
head_title: "Swap & Exchange ODT Pages in C#"
head_description: "Swap & Exchange positions of two pages within a ODT file in C# using the documents merger API."

############################# Header ############################
title: "Swap ODT Pages In C#"
description: "Swap ODT Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a ODT file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap ODT file pages using C# example code">}}
