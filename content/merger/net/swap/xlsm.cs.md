...
############################# Head ############################
head_title: "Vyměňte a vyměňte XLSM stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru XLSM v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit XLSM stránky v C#"
description: "Vyměňte XLSM stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte XLSM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru XLSM provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru XLSM pomocí ukázkového kódu C#">}}
