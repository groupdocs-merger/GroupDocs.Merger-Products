...
############################# Head ############################
head_title: "Byt og byt VSTX sider i C#"
head_description: "Byt og udveksle positioner på to sider i en VSTX-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt VSTX sider i C#"
description: "Byt VSTX sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en VSTX-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du VSTX filsider ved hjælp af C# eksempelkode">}}
