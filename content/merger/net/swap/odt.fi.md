...
############################# Head ############################
head_title: "Vaihda ja vaihda ODT sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ODT-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ODT sivua C#"
description: "Vaihda ODT-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ODT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja ODT-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ODT tiedostosivua käyttämällä C# esimerkkikoodia">}}
