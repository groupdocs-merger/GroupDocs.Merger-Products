...
############################# Head ############################
head_title: "Vymeňte a vymeňte VSX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore VSX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte VSX stránky v C#"
description: "Vymeňte VSX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte VSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru VSX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru VSX pomocou vzorového kódu C#">}}
