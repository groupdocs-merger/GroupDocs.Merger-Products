...
############################# Head ############################
head_title: "Cserélj és cserélj RTF oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy RTF fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "RTF oldal cseréje a C# nyelven"
description: "Cserélje ki az RTF oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "RTF fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy RTF fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk RTF fájloldalakat a C# példakóddal">}}
