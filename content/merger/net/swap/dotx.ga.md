...
############################# Head ############################
head_title: "Babhtáil & Malartú DOTX Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad DOTX in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil DOTX Leathanaigh i C#"
description: "Malartú DOTX Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil DOTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad DOTX trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid DOTX a mhalartú le cód samplach C#">}}
