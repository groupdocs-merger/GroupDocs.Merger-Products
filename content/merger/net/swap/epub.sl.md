...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj EPUB strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke EPUB v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj EPUB strani v C#"
description: "Zamenjajte strani EPUB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke EPUB v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki EPUB z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke EPUB s primerom kode C#">}}
