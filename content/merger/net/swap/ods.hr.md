...
############################# Head ############################
head_title: "Zamijeni i razmijeni ODS stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar ODS datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni ODS stranice u C#"
description: "Zamijenite ODS stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni ODS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar ODS datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti ODS stranice datoteke koristeći C# primjer koda">}}
