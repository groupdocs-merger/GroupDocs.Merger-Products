...
############################# Head ############################
head_title: "Vymeňte a vymeňte EPUB stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore EPUB v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte EPUB stránky v C#"
description: "Vymeňte EPUB stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte EPUB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru EPUB implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru EPUB pomocou vzorového kódu C#">}}
