...
############################# Head ############################
head_title: "Swap pages in PDF files using .NET apps"
head_description: "Use GroupDocs.Merger for .NET to reorder pages in PDF documents. Easily modify PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, and more."

############################# Header ############################
title: "Swap PDF pages" 
description: "GroupDocs.Merger for .NET extends .NET applications with advanced document management capabilities. Easily rearrange pages in PDF files to structure content exactly as needed."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can easily reorganize pages in PDF documents to enhance readability and structure. Add efficient document processing to your .NET applications.
