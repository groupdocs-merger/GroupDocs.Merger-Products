...
############################# Head ############################
head_title: "Bytt og bytt ut DOCM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOCM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOCM sider i C#"
description: "Bytt DOCM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en DOCM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOCM filsider ved å bruke C# eksempelkode">}}
