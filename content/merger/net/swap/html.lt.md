...
############################# Head ############################
head_title: "Sukeiskite ir keiskite HTML puslapius C#"
head_description: "Sukeiskite ir keiskite dviejų puslapių pozicijas HTML faile C# naudodami dokumentų sujungimo API."

############################# Header ############################
title: "Sukeisti HTML puslapius C#"
description: "Pakeiskite HTML puslapius keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Sukeisti HTML failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai apsikeisti puslapiais HTML faile, atlikus kelis paprastus veiksmus .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip sukeisti HTML failo puslapius naudojant C# pavyzdinį kodą">}}
