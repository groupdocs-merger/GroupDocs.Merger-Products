...
############################# Head ############################
head_title: "Byt och byt ut EPUB sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en EPUB-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt EPUB sidor i C#"
description: "Byt EPUB-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt EPUB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en EPUB-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter EPUB filsidor med hjälp av C# exempelkod">}}
