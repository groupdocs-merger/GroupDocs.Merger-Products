...
############################# Head ############################
head_title: "Vahetage ja vahetage DOT lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOT failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOT lehte keeles C#"
description: "Vahetage DOT lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOT, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOT faililehte, kasutades C# näitekoodi">}}
