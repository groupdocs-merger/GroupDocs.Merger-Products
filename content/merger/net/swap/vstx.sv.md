...
############################# Head ############################
head_title: "Byt och byt ut VSTX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSTX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSTX sidor i C#"
description: "Byt VSTX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSTX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSTX filsidor med hjälp av C# exempelkod">}}
