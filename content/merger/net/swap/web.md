...
############################# Head ############################
head_title: "Swap & Exchange WEB Pages in C#"
head_description: "Swap & Exchange positions of two pages within a WEB file in C# using the documents merger API."

############################# Header ############################
title: "Swap WEB Pages In C#"
description: "Swap WEB Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a WEB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap WEB file pages using C# example code">}}
...
demos:
    ...
    content: |
       Swap WEB file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/web) website.
