...
############################# Head ############################
head_title: "Zamień i zamień VSDM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSDM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSDM strony w C#"
description: "Zamień strony VSDM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSDM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSDM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSDM przy użyciu przykładowego kodu C#">}}
