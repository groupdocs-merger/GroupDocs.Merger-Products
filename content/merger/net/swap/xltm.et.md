...
############################# Head ############################
head_title: "Vahetage ja vahetage XLTM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLTM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLTM lehte keeles C#"
description: "Vahetage XLTM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLTM faililehte, kasutades C# näitekoodi">}}
