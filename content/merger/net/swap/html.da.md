...
############################# Head ############################
head_title: "Byt og byt HTML sider i C#"
head_description: "Byt og udveksle positioner på to sider i en HTML-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt HTML sider i C#"
description: "Byt HTML sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt HTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en HTML-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du HTML filsider ved hjælp af C# eksempelkode">}}
