...
############################# Head ############################
head_title: "Vaihda ja vaihda TEX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja TEX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda TEX sivua C#"
description: "Vaihda TEX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda TEX tiedostosivua tuotteessa .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa TEX tiedostosivua käyttämällä C# esimerkkikoodia">}}
