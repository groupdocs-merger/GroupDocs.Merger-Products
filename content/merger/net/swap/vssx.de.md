...
############################# Head ############################
head_title: "Tausche & tausche VSSX Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSSX-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSSX Seiten in C#"
description: "Tauschen Sie VSSX-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSSX Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSSX-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSSX-Dateiseiten mit C#-Beispielcode aus">}}
