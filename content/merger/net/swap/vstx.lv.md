...
############################# Head ############################
head_title: "Apmainīt un apmainīt VSTX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas VSTX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt VSTX lapas programmā C#"
description: "Apmainiet VSTX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt VSTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām VSTX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt VSTX faila lapas, izmantojot C# piemēra kodu">}}
