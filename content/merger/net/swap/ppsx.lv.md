...
############################# Head ############################
head_title: "Apmainīt un apmainīt PPSX lapas programmā C#"
head_description: "Apmainiet un apmainiet divu lapu pozīcijas PPSX failā C#, izmantojot dokumentu apvienošanas API."

############################# Header ############################
title: "Apmainīt PPSX lapas programmā C#"
description: "Apmainiet PPSX lapas ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Apmainīt PPSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem ērti apmainīties ar lapām PPSX failā, veicot dažas vienkāršas darbības. .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā apmainīt PPSX faila lapas, izmantojot C# piemēra kodu">}}
