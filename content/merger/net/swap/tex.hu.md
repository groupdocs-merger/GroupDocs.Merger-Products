...
############################# Head ############################
head_title: "Cserélj és cserélj TEX oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy TEX fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "TEX oldal cseréje a C# nyelven"
description: "Cserélje ki az TEX oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "TEX fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy TEX fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk TEX fájloldalakat a C# példakóddal">}}
