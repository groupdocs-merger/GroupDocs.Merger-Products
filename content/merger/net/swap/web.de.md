...
############################# Head ############################
head_title: "Tausche & tausche WEB Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer WEB-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche WEB Seiten in C#"
description: "Tauschen Sie WEB-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "WEB Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer WEB-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie WEB-Dateiseiten mit C#-Beispielcode aus">}}
