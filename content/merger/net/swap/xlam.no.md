...
############################# Head ############################
head_title: "Bytt og bytt ut XLAM sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en XLAM-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt XLAM sider i C#"
description: "Bytt XLAM-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt XLAM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en XLAM-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte XLAM filsider ved å bruke C# eksempelkode">}}
