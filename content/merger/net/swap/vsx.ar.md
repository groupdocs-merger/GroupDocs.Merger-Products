...
############################# Head ############################
head_title: "تبادل الصفحات VSX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف VSX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات VSX في C#"
description: "استبدل الصفحات VSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات VSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف VSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف VSX باستخدام كود مثال C#">}}
