...
############################# Head ############################
head_title: "Tukar & Tukar VSTX Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail VSTX dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar VSTX Halaman Dalam C#"
description: "Tukar VSTX Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar VSTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail VSTX dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar VSTX halaman fail menggunakan kod contoh C#.">}}
