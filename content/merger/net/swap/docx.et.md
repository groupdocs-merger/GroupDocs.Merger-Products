...
############################# Head ############################
head_title: "Vahetage ja vahetage DOCX lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone DOCX failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage DOCX lehte keeles C#"
description: "Vahetage DOCX lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage DOCX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis DOCX, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada DOCX faililehte, kasutades C# näitekoodi">}}
