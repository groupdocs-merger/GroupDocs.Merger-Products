...
############################# Head ############################
head_title: "تبادل الصفحات VSSX في C#"
head_description: "قم بالتبديل والتبادل بين صفحتين داخل ملف VSSX في C# باستخدام واجهة برمجة تطبيقات دمج المستندات."

############################# Header ############################
title: "تبديل الصفحات VSSX في C#"
description: "استبدل الصفحات VSSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تبديل صفحات الملفات VSSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تبديل الصفحات داخل ملف VSSX من خلال تنفيذ بضع خطوات سهلة .
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تبديل صفحات ملف VSSX باستخدام كود مثال C#">}}
