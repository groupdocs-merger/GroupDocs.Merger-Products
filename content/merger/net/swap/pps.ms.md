...
############################# Head ############################
head_title: "Tukar & Tukar PPS Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail PPS dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar PPS Halaman Dalam C#"
description: "Tukar PPS Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar PPS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail PPS dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar PPS halaman fail menggunakan kod contoh C#.">}}
