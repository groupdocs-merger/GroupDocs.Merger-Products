...
############################# Head ############################
head_title: "Vaihda ja vaihda DOTX sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja DOTX-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda DOTX sivua C#"
description: "Vaihda DOTX-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda DOTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja DOTX-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa DOTX tiedostosivua käyttämällä C# esimerkkikoodia">}}
