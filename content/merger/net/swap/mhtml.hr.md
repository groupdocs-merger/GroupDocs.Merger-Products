...
############################# Head ############################
head_title: "Zamijeni i razmijeni MHTML stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar MHTML datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni MHTML stranice u C#"
description: "Zamijenite MHTML stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni MHTML stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar MHTML datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti MHTML stranice datoteke koristeći C# primjer koda">}}
