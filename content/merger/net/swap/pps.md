...
############################# Head ############################
head_title: "Swap & Exchange PPS Pages in C#"
head_description: "Swap & Exchange positions of two pages within a PPS file in C# using the documents merger API."

############################# Header ############################
title: "Swap PPS Pages In C#"
description: "Swap PPS Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a PPS file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PPS file pages using C# example code">}}
