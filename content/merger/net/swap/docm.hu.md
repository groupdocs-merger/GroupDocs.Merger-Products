...
############################# Head ############################
head_title: "Cserélj és cserélj DOCM oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOCM fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOCM oldal cseréje a C# nyelven"
description: "Cserélje ki az DOCM oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOCM fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOCM fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOCM fájloldalakat a C# példakóddal">}}
