...
############################# Head ############################
head_title: "Vymeňte a vymeňte XLTX stránky v C#"
head_description: "Vymeňte a vymeňte pozície dvoch stránok v súbore XLTX v C# pomocou rozhrania API na zlúčenie dokumentov."

############################# Header ############################
title: "Vymeňte XLTX stránky v C#"
description: "Vymeňte XLTX stránky za pár riadkov kódu .NET."
...
steps:
    enable: true
    title_left: "Vymeňte XLTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# vymieňať si stránky v rámci súboru XLTX implementáciou niekoľkých jednoduchých krokov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako vymeniť stránky súboru XLTX pomocou vzorového kódu C#">}}
