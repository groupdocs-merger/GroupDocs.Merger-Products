...
############################# Head ############################
head_title: "Vaihda ja vaihda RTF sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja RTF-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda RTF sivua C#"
description: "Vaihda RTF-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda RTF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja RTF-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa RTF tiedostosivua käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Vaihda RTF tiedostosivua GroupDocs.Merger API:lla
        int pageNumber1 = 6;
        int pageNumber2 = 1;
...
demos:
    enable: true
    title: "Live-esittelyt - Vaihda RTF tiedostosivua verkossa"
    content: |
       Vaihda RTF tiedostosivua heti käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/rtf) -sivustolla.
