...
############################# Head ############################
head_title: "Tausche & tausche ODT Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer ODT-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche ODT Seiten in C#"
description: "Tauschen Sie ODT-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "ODT Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer ODT-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie ODT-Dateiseiten mit C#-Beispielcode aus">}}
