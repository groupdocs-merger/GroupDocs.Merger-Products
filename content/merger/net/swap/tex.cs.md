...
############################# Head ############################
head_title: "Vyměňte a vyměňte TEX stránky v C#"
head_description: "Vyměňte a vyměňte pozice dvou stránek v souboru TEX v C# pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "Vyměnit TEX stránky v C#"
description: "Vyměňte TEX stránky za pár řádků kódu .NET."
...
steps:
    enable: true
    title_left: "Vyměňte TEX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# výměnu stránek v souboru TEX provedením několika snadných kroků .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak vyměnit stránky souboru TEX pomocí ukázkového kódu C#">}}
