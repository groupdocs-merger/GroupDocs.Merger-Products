...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj PDF strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke PDF v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj PDF strani v C#"
description: "Zamenjajte strani PDF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke PDF v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki PDF z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke PDF s primerom kode C#">}}
