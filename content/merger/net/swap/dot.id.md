...
############################# Head ############################
head_title: "Tukar & Tukarkan DOT Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file DOT di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar DOT Halaman Di C#"
description: "Tukar DOT Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar DOT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file DOT dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file DOT menggunakan kode contoh C#">}}
