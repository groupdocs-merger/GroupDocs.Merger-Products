...
############################# Head ############################
head_title: "Bytt og bytt ut VSX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSX sider i C#"
description: "Bytt VSX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSX filsider ved å bruke C# eksempelkode">}}
