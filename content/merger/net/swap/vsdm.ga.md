...
############################# Head ############################
head_title: "Babhtáil & Malartú VSDM Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad VSDM in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil VSDM Leathanaigh i C#"
description: "Malartú VSDM Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil VSDM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad VSDM trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid VSDM a mhalartú le cód samplach C#">}}
