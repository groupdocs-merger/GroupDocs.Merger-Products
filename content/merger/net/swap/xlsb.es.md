...
############################# Head ############################
head_title: "Intercambiar e intercambiar XLSB páginas en C#"
head_description: "Intercambiar e intercambiar posiciones de dos páginas dentro de un archivo XLSB en C# utilizando la API de fusión de documentos."

############################# Header ############################
title: "Intercambiar XLSB páginas en C#"
description: "Intercambie XLSB páginas con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Intercambiar XLSB páginas de archivo en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# intercambiar páginas dentro de un archivo XLSB mediante la implementación de unos sencillos pasos .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo intercambiar páginas de archivos XLSB usando el código de ejemplo C#">}}
