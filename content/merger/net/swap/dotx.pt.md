...
############################# Head ############################
head_title: "Troque e troque DOTX páginas em C#"
head_description: "Troque e troque posições de duas páginas em um arquivo DOTX em C# usando a API de fusão de documentos."

############################# Header ############################
title: "Trocar DOTX Páginas em C#"
description: "Troque DOTX Páginas com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Trocar páginas de arquivo DOTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# trocar páginas em um arquivo DOTX implementando algumas etapas fáceis .
    ...
    code: |
     ...
     {{< merger/code-merger title="Como trocar as páginas do arquivo DOTX usando o código de exemplo C#">}}
