...
############################# Head ############################
head_title: "Swap & Exchange PDF Pages in C#"
head_description: "Swap & Exchange positions of two pages within a PDF file in C# using the documents merger API."

############################# Header ############################
title: "Swap PDF Pages In C#"
description: "Swap PDF Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a PDF file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap PDF file pages using C# example code">}}
