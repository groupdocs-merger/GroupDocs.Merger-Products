...
############################# Head ############################
head_title: "Byt og byt OTT sider i C#"
head_description: "Byt og udveksle positioner på to sider i en OTT-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt OTT sider i C#"
description: "Byt OTT sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en OTT-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du OTT filsider ved hjælp af C# eksempelkode">}}
