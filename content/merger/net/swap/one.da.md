...
############################# Head ############################
head_title: "Byt og byt ONE sider i C#"
head_description: "Byt og udveksle positioner på to sider i en ONE-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt ONE sider i C#"
description: "Byt ONE sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en ONE-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du ONE filsider ved hjælp af C# eksempelkode">}}
