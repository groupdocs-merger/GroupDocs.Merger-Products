...
############################# Head ############################
head_title: "Bytt og bytt ut DOTX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOTX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOTX sider i C#"
description: "Bytt DOTX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en DOTX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOTX filsider ved å bruke C# eksempelkode">}}
