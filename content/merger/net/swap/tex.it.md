...
############################# Head ############################
head_title: "Scambia e scambia TEX pagine in C#"
head_description: "Scambia e scambia le posizioni di due pagine all'interno di un file TEX in C# utilizzando l'API di fusione dei documenti."

############################# Header ############################
title: "Scambia TEX pagine in C#"
description: "Scambia le pagine TEX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Scambia TEX pagine di file in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di scambiare facilmente le pagine all'interno di un file TEX implementando alcuni semplici passaggi .
    ...
    code: |
     ...
     {{< merger/code-merger title="Come scambiare pagine di file TEX utilizzando il codice di esempio C#">}}
