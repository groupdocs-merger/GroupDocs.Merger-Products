...
############################# Head ############################
head_title: "Babhtáil & Malartú XLAM Leathanaigh i C#"
head_description: "Babhtáil & Malartú suímh dhá leathanach laistigh de chomhad XLAM in C# ag baint úsáide as an API cumasc doiciméad."

############################# Header ############################
title: "Babhtáil XLAM Leathanaigh i C#"
description: "Malartú XLAM Leathanaigh le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Babhtáil XLAM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# leathanaigh a mhalartú laistigh de chomhad XLAM trí roinnt céimeanna éasca a chur i bhfeidhm .
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas leathanaigh comhaid XLAM a mhalartú le cód samplach C#">}}
