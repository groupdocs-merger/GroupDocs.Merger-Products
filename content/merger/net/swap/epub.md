...
############################# Head ############################
head_title: "Swap & Exchange EPUB Pages in C#"
head_description: "Swap & Exchange positions of two pages within a EPUB file in C# using the documents merger API."

############################# Header ############################
title: "Swap EPUB Pages In C#"
description: "Swap EPUB Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a EPUB file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap EPUB file pages using C# example code">}}
