...
############################# Head ############################
head_title: "Byt och byt ut VSSX sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en VSSX-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt VSSX sidor i C#"
description: "Byt VSSX-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt VSSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en VSSX-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter VSSX filsidor med hjälp av C# exempelkod">}}
