...
############################# Head ############################
head_title: "Tukar & Tukarkan ONE Halaman di C#"
head_description: "Tukar & Tukar posisi dua halaman dalam file ONE di C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar ONE Halaman Di C#"
description: "Tukar ONE Halaman dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Tukar ONE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk menukar halaman dalam file ONE dengan menerapkan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar halaman file ONE menggunakan kode contoh C#">}}
