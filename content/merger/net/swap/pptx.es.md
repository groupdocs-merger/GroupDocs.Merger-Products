...
############################# Head ############################
head_title: "Intercambiar páginas en archivos PPTX utilizando aplicaciones .NET"
head_description: "Utiliza GroupDocs.Merger for .NET para reordenar páginas en documentos PPTX. Modifica PDFs, archivos de Word, hojas de cálculo, presentaciones, diagramas de Visio, imágenes y más."

############################# Header ############################
title: "Intercambiar páginas PPTX" 
description: "GroupDocs.Merger for .NET amplía las aplicaciones .NET con capacidades avanzadas de gestión de documentos. Reorganiza fácilmente páginas en archivos PPTX para estructurar el contenido exactamente como se necesita."
...
steps:
    enable: true
    title: "Cómo reorganizar páginas PPTX"
    content: |
      Con [GroupDocs.Merger](/merger/net/), puedes reorganizar páginas en documentos PPTX para mejorar la legibilidad y la estructura. Agrega procesamiento de documentos eficiente a tus aplicaciones .NET.
      
      1. Proporciona la ruta al archivo PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Intercambiar la primera y última página en un archivo PPTX"
      content: |
        Este ejemplo demuestra cómo intercambiar páginas en un archivo PPTX en unos pocos pasos simples.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
