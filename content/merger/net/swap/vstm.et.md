...
############################# Head ############################
head_title: "Vahetage ja vahetage VSTM lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone VSTM failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage VSTM lehte keeles C#"
description: "Vahetage VSTM lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage VSTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis VSTM, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada VSTM faililehte, kasutades C# näitekoodi">}}
