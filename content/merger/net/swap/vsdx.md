...
############################# Head ############################
head_title: "Swap & Exchange VSDX Pages in C#"
head_description: "Swap & Exchange positions of two pages within a VSDX file in C# using the documents merger API."

############################# Header ############################
title: "Swap VSDX Pages In C#"
description: "Swap VSDX Pages with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to swap pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to swap VSDX file pages using C# example code">}}
