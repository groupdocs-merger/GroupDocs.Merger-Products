...
############################# Head ############################
head_title: "Bytt og bytt ut VSDX sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en VSDX-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt VSDX sider i C#"
description: "Bytt VSDX-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en VSDX-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte VSDX filsider ved å bruke C# eksempelkode">}}
