...
############################# Head ############################
head_title: "Zamień i zamień ODP strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku ODP w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień ODP strony w C#"
description: "Zamień strony ODP na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików ODP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku ODP, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku ODP przy użyciu przykładowego kodu C#">}}
