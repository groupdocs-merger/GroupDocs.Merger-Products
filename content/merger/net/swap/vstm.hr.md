...
############################# Head ############################
head_title: "Zamijeni i razmijeni VSTM stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar VSTM datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni VSTM stranice u C#"
description: "Zamijenite VSTM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni VSTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar VSTM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti VSTM stranice datoteke koristeći C# primjer koda">}}
