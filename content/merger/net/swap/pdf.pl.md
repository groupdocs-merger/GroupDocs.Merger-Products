...
############################# Head ############################
head_title: "Zamień i zamień PDF strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku PDF w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień PDF strony w C#"
description: "Zamień strony PDF na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików PDF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku PDF, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku PDF przy użyciu przykładowego kodu C#">}}
