...
############################# Head ############################
head_title: "Zamijeni i razmijeni RTF stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar RTF datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni RTF stranice u C#"
description: "Zamijenite RTF stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni RTF stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar RTF datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti RTF stranice datoteke koristeći C# primjer koda">}}
