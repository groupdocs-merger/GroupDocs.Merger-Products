...
############################# Head ############################
head_title: "Vahetage ja vahetage XLSB lehti C#-s"
head_description: "Vahetage ja vahetage kahe lehe positsioone XLSB failis C#-s, kasutades dokumentide liitmise API-d."

############################# Header ############################
title: "Vahetage XLSB lehte keeles C#"
description: "Vahetage XLSB lehed mõne rea .NET koodiga."
...
steps:
    enable: true
    title_left: "Vahetage XLSB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks lehtede vahetamise failis XLSB, rakendades mõnda lihtsat sammu .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas vahetada XLSB faililehte, kasutades C# näitekoodi">}}
