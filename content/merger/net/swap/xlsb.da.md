...
############################# Head ############################
head_title: "Byt og byt XLSB sider i C#"
head_description: "Byt og udveksle positioner på to sider i en XLSB-fil i C# ved hjælp af documents merger API."

############################# Header ############################
title: "Byt XLSB sider i C#"
description: "Byt XLSB sider med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Byt XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at bytte sider i en XLSB-fil ved at implementere nogle få nemme trin .
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan bytter du XLSB filsider ved hjælp af C# eksempelkode">}}
