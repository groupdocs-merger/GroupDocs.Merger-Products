...
############################# Head ############################
head_title: "Ruil en ruil PPSX bladsye in C#"
head_description: "Ruil en ruil posisies van twee bladsye binne 'n PPSX-lêer in C# met behulp van die dokumentsamesmeltings-API."

############################# Header ############################
title: "Ruil PPSX bladsye in C#"
description: "Ruil PPSX Bladsye met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Ruil PPSX lêerbladsye om in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om bladsye binne 'n PPSX-lêer te ruil deur 'n paar maklike stappe te implementeer .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêerbladsye om te ruil met behulp van C# voorbeeldkode">}}
