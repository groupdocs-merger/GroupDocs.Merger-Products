...
############################# Head ############################
head_title: "Cserélj és cserélj XPS oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy XPS fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "XPS oldal cseréje a C# nyelven"
description: "Cserélje ki az XPS oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "XPS fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy XPS fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk XPS fájloldalakat a C# példakóddal">}}
