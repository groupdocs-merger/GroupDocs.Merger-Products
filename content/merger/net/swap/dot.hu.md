...
############################# Head ############################
head_title: "Cserélj és cserélj DOT oldalt a C# nyelven"
head_description: "Cserélje ki és cserélje ki két oldal pozícióját egy DOT fájlon belül a C#-ban a dokumentumok egyesítése API segítségével."

############################# Header ############################
title: "DOT oldal cseréje a C# nyelven"
description: "Cserélje ki az DOT oldalt néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOT fájloldal cseréje a .NET termékben"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) néhány egyszerű lépés végrehajtásával megkönnyíti a C# fejlesztői számára, hogy oldalt cseréljenek egy DOT fájlon belül .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hogyan cseréljünk DOT fájloldalakat a C# példakóddal">}}
