...
############################# Head ############################
head_title: "Tukar & Tukar OTP Halaman dalam C#"
head_description: "Tukar & Tukar kedudukan dua halaman dalam fail OTP dalam C# menggunakan API penggabungan dokumen."

############################# Header ############################
title: "Tukar OTP Halaman Dalam C#"
description: "Tukar OTP Halaman dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Tukar OTP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# menukar halaman dalam fail OTP dengan melaksanakan beberapa langkah mudah .
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara menukar OTP halaman fail menggunakan kod contoh C#.">}}
