...
############################# Head ############################
head_title: "Zamień i zamień VSSM strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku VSSM w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień VSSM strony w C#"
description: "Zamień strony VSSM na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików VSSM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku VSSM, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku VSSM przy użyciu przykładowego kodu C#">}}
