...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj XPS strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke XPS v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj XPS strani v C#"
description: "Zamenjajte strani XPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke XPS v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki XPS z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke XPS s primerom kode C#">}}
