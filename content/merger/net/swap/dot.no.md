...
############################# Head ############################
head_title: "Bytt og bytt ut DOT sider i C#"
head_description: "Bytt og bytt ut posisjoner på to sider i en DOT-fil i C# ved hjelp av dokumentsammenslåings-APIet."

############################# Header ############################
title: "Bytt DOT sider i C#"
description: "Bytt DOT-sider med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Bytt DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å bytte sider i en DOT-fil ved å implementere noen få enkle trinn .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan bytte DOT filsider ved å bruke C# eksempelkode">}}
