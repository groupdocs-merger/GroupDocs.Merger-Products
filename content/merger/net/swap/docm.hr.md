...
############################# Head ############################
head_title: "Zamijeni i razmijeni DOCM stranice u C#"
head_description: "Zamijenite i razmijenite pozicije dviju stranica unutar DOCM datoteke u C# pomoću API-ja za spajanje dokumenata."

############################# Header ############################
title: "Zamijeni DOCM stranice u C#"
description: "Zamijenite DOCM stranice s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Zamijeni DOCM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) olakšava C# programerima zamjenu stranica unutar DOCM datoteke implementacijom nekoliko jednostavnih koraka .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamijeniti DOCM stranice datoteke koristeći C# primjer koda">}}
