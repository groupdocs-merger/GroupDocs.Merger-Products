...
############################# Head ############################
head_title: "Vaihda ja vaihda ODS sivua C#"
head_description: "Vaihda ja vaihda kahden sivun paikkoja ODS-tiedostossa C#:ssa käyttämällä asiakirjojen yhdistämissovellusliittymää."

############################# Header ############################
title: "Vaihda ODS sivua C#"
description: "Vaihda ODS-sivut muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Vaihda ODS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi vaihtaa sivuja ODS-tiedoston sisällä muutaman helpon vaiheen avulla .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka vaihtaa ODS tiedostosivua käyttämällä C# esimerkkikoodia">}}
