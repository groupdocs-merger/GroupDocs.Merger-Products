...
############################# Head ############################
head_title: "Byt och byt ut ODP sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en ODP-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt ODP sidor i C#"
description: "Byt ODP-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt ODP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en ODP-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter ODP filsidor med hjälp av C# exempelkod">}}
