...
############################# Head ############################
head_title: "Zamenjaj in izmenjaj XLSX strani v C#"
head_description: "Zamenjaj in izmenjaj položaje dveh strani znotraj datoteke XLSX v C# z uporabo API-ja za združevanje dokumentov."

############################# Header ############################
title: "Zamenjaj XLSX strani v C#"
description: "Zamenjajte strani XLSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Zamenjaj strani datoteke XLSX v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša zamenjavo strani v datoteki XLSX z implementacijo nekaj preprostih korakov .
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako zamenjati strani datoteke XLSX s primerom kode C#">}}
