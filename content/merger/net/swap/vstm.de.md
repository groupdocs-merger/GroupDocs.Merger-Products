...
############################# Head ############################
head_title: "Tausche & tausche VSTM Seiten in C#"
head_description: "Tauschen und tauschen Sie Positionen von zwei Seiten innerhalb einer VSTM-Datei in C# mithilfe der Documents Merger API aus."

############################# Header ############################
title: "Tausche VSTM Seiten in C#"
description: "Tauschen Sie VSTM-Seiten mit ein paar Zeilen .NET-Code aus."
...
steps:
    enable: true
    title_left: "VSTM Dateiseiten in .NET tauschen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern leicht, Seiten innerhalb einer VSTM-Datei auszutauschen, indem einige einfache Schritte implementiert werden .
    ...
    code: |
     ...
     {{< merger/code-merger title="So tauschen Sie VSTM-Dateiseiten mit C#-Beispielcode aus">}}
