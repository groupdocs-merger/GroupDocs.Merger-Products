...
############################# Head ############################
head_title: "Zamień i zamień XLT strony w C#"
head_description: "Zamień i zamień pozycje dwóch stron w pliku XLT w C# za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "Zamień XLT strony w C#"
description: "Zamień strony XLT na kilka wierszy kodu .NET."
...
steps:
    enable: true
    title_left: "Zamień strony plików XLT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# wymianę stron w pliku XLT, wykonując kilka prostych kroków .
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak zamienić strony pliku XLT przy użyciu przykładowego kodu C#">}}
