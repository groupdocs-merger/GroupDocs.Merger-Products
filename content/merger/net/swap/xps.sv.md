...
############################# Head ############################
head_title: "Byt och byt ut XPS sidor i C#"
head_description: "Byt och byt ut positioner på två sidor i en XPS-fil i C# med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "Byt XPS sidor i C#"
description: "Byt XPS-sidor med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Byt XPS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att byta sida i en XPS-fil genom att implementera några enkla steg .
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man byter XPS filsidor med hjälp av C# exempelkod">}}
