...
head_description: "Sujunkite kelis OTP failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "OTP Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną OTP failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/otp) svetainėje.
