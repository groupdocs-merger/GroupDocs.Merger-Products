...
############################# Head ############################
head_title: "Mesclar ONE Arquivos em C# | ONE Fusão"
head_description: "Mescle vários arquivos ONE em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "ONE Fusão em C#"
description: "Mescle ONE com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos ONE em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos ONE usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar ONE arquivos usando a API GroupDocs.Merger
