...
############################# Header ############################
title: "VDX Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VDX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VDX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
