...
############################# Head ############################
head_title: "Ühendage PNG failid C# | PNG Ühinemine"
head_description: "Ühendage mitu PNG faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "PNG ühinemine programmis C#"
description: "Ühendage PNG mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam PNG faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita PNG faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid PNG, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks PNG faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png).
