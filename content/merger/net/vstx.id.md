...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSTX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSTX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx).
