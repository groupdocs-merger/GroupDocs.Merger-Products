...
############################# Head ############################
head_title: "Sloučit ODS soubory v C# | ODS Fúze"
head_description: "Sloučit více souborů ODS do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "ODS Fúze v C#"
description: "Sloučit ODS s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů ODS"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů ODS v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory ODS pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit ODS soubory pomocí GroupDocs.Merger API
