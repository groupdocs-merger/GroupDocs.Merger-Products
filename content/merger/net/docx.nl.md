...
############################# Head ############################
head_title: "Voeg DOCX bestanden samen in C# | DOCX Fusie"
head_description: "Voeg meerdere DOCX bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "DOCX Fusie in C#"
description: "Voeg DOCX samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOCX bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOCX-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCX bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg DOCX bestanden samen met de GroupDocs.Merger API
