...
############################# Head ############################
head_title: "Mesclar MHTML Arquivos em C# | MHTML Fusão"
head_description: "Mescle vários arquivos MHTML em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "MHTML Fusão em C#"
description: "Mescle MHTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos MHTML"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos MHTML em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos MHTML usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar MHTML arquivos usando a API GroupDocs.Merger
