...
############################# Head ############################
head_title: "Mescle arquivos MHTML via .NET"
head_description: "Integre a mesclagem de documentos MHTML em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos MHTML" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos MHTML de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos MHTML. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
    ...
    code:
      ...
      content: |
        ```csharp {style=abap}
        // Inicialize Merger com o documento MHTML de origem
