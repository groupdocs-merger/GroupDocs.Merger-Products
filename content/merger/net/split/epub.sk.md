...
############################# Head ############################
head_title: "Rozdeliť EPUB do viacerých súborov v C#"
...
description: "Rozdeľte EPUB niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť EPUB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor EPUB na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť EPUB súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor EPUB pomocou rozhrania GroupDocs.Merger API
