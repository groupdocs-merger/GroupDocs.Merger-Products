...
############################# Head ############################
head_title: "Rozdeliť XLT do viacerých súborov v C#"
...
description: "Rozdeľte XLT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLT pomocou rozhrania GroupDocs.Merger API
