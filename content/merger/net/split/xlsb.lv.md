...
############################# Head ############################
head_title: "Sadaliet XLSB vairākos failos programmā C#"
...
############################# Header ############################
title: "XLSB sadalītājs programmā C#"
description: "Sadaliet XLSB ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSB faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLSB failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSB failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLSB failu, izmantojot GroupDocs.Merger API
