...
############################# Head ############################
head_title: "Dividi ODS in più file in C#"
...
############################# Header ############################
title: "ODS Separatore in C#"
description: "Dividi ODS con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file ODS in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file ODS in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file ODS utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file ODS utilizzando l'API GroupDocs.Merger
