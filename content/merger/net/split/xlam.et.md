...
############################# Head ############################
head_title: "Jagage XLAM mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLAM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLAM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLAM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLAM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLAM, kasutades GroupDocs.Merger API-t
