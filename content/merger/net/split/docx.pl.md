...
############################# Head ############################
head_title: "Podziel DOCX na wiele plików w C#"
head_description: "Podziel pojedynczy plik DOCX na kilka plików w oparciu o numery stron, odstępy między stronami, strony parzyste lub nieparzyste za pomocą interfejsu API łączenia dokumentów."

############################# Header ############################
title: "DOCX Rozdzielacz w C#"
description: "Podziel DOCX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOCX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOCX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOCX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOCX za pomocą GroupDocs.Merger API
...
demos:
    enable: true
    title: "Prezentacje na żywo - Podziel plik DOCX online"
    content: |
       Podziel plik DOCX już teraz, odwiedzając stronę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx).
