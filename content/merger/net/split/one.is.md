...
############################# Head ############################
head_title: "Skiptu ONE í margar skrár í C#"
...
############################# Header ############################
title: "ONE Skerandi í C#"
description: "Skiptu ONE með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu ONE skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni ONE skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ONE skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu ONE skrá með GroupDocs.Merger API
