...
############################# Head ############################
head_title: "Dividiu XLSB en diversos fitxers a C#"
...
############################# Header ############################
title: "XLSB Divisor a C#"
description: "Dividiu XLSB amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XLSB a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XLSB en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XLSB utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XLSB mitjançant l'API de GroupDocs.Merger
