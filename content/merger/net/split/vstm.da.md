...
############################# Head ############################
head_title: "Opdel VSTM i flere filer i C#"
...
description: "Opdel VSTM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSTM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSTM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSTM fil ved hjælp af GroupDocs.Merger API
