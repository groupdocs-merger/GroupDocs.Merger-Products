...
############################# Head ############################
head_title: "Dela upp MHTML i flera filer i C#"
...
############################# Header ############################
title: "MHTML splitter i C#"
description: "Dela upp MHTML med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp MHTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda MHTML-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp MHTML-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela MHTML-fil med GroupDocs.Merger API
