...
############################# Head ############################
head_title: "Jagage ODS mitmeks failiks rakenduses C#"
...
description: "Tükeldage ODS mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage ODS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks ODS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada ODS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail ODS, kasutades GroupDocs.Merger API-t
