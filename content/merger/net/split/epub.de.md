...
############################# Head ############################
head_title: "Teilen von EPUB-Dokumenten in .NET-Apps"
head_description: "Nutzen Sie GroupDocs.Merger for .NET, um EPUB-Dateien in separate Dokumente zu teilen. Verwalten Sie PDFs, Word-Dateien, Excel-Tabellen, PowerPoint-Folien, Visio-Dateien, Bilder, Archive und mehr."

############################# Header ############################
title: "Teilen von EPUB-Dateien" 
description: "GroupDocs.Merger for .NET verbessert .NET-Anwendungen mit fortschrittlichen Funktionen zur Dokumentenverarbeitung. Teilen Sie EPUB-Dateien und arbeiten Sie mit verschiedenen gängigen Geschäftsformaten."
...
steps:
    enable: true
    title: "So teilen Sie EPUB-Dateien"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie EPUB-Dokumente teilen und ausgewählte Seiten als neue Datei speichern. Verbessern Sie die Dokumentenverarbeitung in Ihren .NET-Anwendungen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "EPUB-Dokument teilen und gerade Seiten speichern"
      content: |
        Dieses Beispiel zeigt, wie man ein EPUB-Dokument teilt und alle geraden Seiten als separate Datei speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
