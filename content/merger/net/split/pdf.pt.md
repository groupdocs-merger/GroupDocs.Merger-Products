...
############################# Head ############################
head_title: "Divida documentos PDF em aplicativos .NET"
head_description: "Use GroupDocs.Merger for .NET para dividir arquivos PDF em documentos separados. Gerencie PDFs, arquivos do Word, planilhas do Excel, slides do PowerPoint, arquivos do Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Divida arquivos PDF" 
description: "GroupDocs.Merger for .NET aprimora aplicativos .NET com recursos avançados de processamento de documentos. Divida arquivos PDF e trabalhe com vários formatos de negócios populares."
...
steps:
    ...
    content: |
      Com [GroupDocs.Merger](/merger/net/), você pode dividir documentos PDF e salvar páginas selecionadas como um novo arquivo. Melhore o processamento de documentos em seus aplicativos .NET.
      
      1. Especifique o caminho do arquivo PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Dividir documento PDF e salvar páginas em números pares"
      content: |
        Este exemplo mostra como dividir um documento PDF e salvar todas as páginas em números pares como um arquivo separado.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
