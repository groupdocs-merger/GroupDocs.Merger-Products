...
############################# Head ############################
head_title: "Divida PDF em vários arquivos em C#"
...
############################# Header ############################
title: "PDF Divisor em C#"
description: "Divida PDF com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo PDF em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo PDF em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos PDF usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo PDF usando a API GroupDocs.Merger
