...
############################# Head ############################
head_title: "Dividir IMAGE en varios archivos en C#"
...
############################# Header ############################
title: "IMAGE Divisor en C#"
description: "Divida IMAGE con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir IMAGE páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo IMAGE en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos IMAGE usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo IMAGE usando GroupDocs.Merger API
