...
############################# Head ############################
head_title: "Padalinkite PPSX į kelis failus C#"
...
############################# Header ############################
title: "PPSX skirstytuvas C#"
description: "Padalinkite PPSX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite PPSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną PPSX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti PPSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite PPSX failą naudodami GroupDocs.Merger API
