...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to split a single DOTM file into multiple resultant files by implementing a few easy steps.
