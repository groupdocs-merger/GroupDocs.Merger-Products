...
############################# Head ############################
head_title: "Divisez VSDM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSDM Séparateur dans C#"
description: "Divisez VSDM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSDM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSDM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSDM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSDM à l'aide de l'API GroupDocs.Merger
