...
############################# Head ############################
head_title: "Divida EPUB em vários arquivos em C#"
...
############################# Header ############################
title: "EPUB Divisor em C#"
description: "Divida EPUB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo EPUB em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo EPUB em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos EPUB usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo EPUB usando a API GroupDocs.Merger
