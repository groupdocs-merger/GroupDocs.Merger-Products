...
############################# Head ############################
head_title: "Skiptu DOCM í margar skrár í C#"
...
############################# Header ############################
title: "DOCM Skerandi í C#"
description: "Skiptu DOCM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOCM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOCM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOCM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOCM skrá með GroupDocs.Merger API
