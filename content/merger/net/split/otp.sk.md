...
############################# Head ############################
head_title: "Rozdeliť OTP do viacerých súborov v C#"
...
############################# Header ############################
title: "OTP Splitter v C#"
description: "Rozdeľte OTP niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť OTP strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor OTP na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť OTP súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor OTP pomocou rozhrania GroupDocs.Merger API
