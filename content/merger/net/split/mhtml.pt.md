...
############################# Head ############################
head_title: "Divida MHTML em vários arquivos em C#"
...
############################# Header ############################
title: "MHTML Divisor em C#"
description: "Divida MHTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo MHTML em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo MHTML em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos MHTML usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo MHTML usando a API GroupDocs.Merger
