...
############################# Head ############################
head_title: "Splits ODT in meerdere bestanden in C#"
...
############################# Header ############################
title: "ODT Splitter in C#"
description: "Splits ODT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits ODT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel ODT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits ODT bestand met behulp van GroupDocs.Merger API
