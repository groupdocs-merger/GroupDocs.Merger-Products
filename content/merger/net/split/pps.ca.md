...
############################# Head ############################
head_title: "Dividiu PPS en diversos fitxers a C#"
...
############################# Header ############################
title: "PPS Divisor a C#"
description: "Dividiu PPS amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers PPS a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer PPS en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers PPS utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer PPS mitjançant l'API de GroupDocs.Merger
