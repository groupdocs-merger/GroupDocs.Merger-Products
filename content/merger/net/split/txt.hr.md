...
############################# Head ############################
head_title: "Podijeli TXT u više datoteka u C#"
...
############################# Header ############################
title: "TXT Splitter u C#"
description: "Podijelite TXT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli TXT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne TXT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti TXT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli TXT datoteku pomoću API-ja GroupDocs.Merger
