...
############################# Head ############################
head_title: "Divisez ONENOTE en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "ONENOTE Séparateur dans C#"
description: "Divisez ONENOTE avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner ONENOTE pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier ONENOTE en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers ONENOTE à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier ONENOTE à l'aide de l'API GroupDocs.Merger
