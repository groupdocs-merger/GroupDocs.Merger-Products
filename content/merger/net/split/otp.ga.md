...
############################# Head ############################
head_title: "Scoilt OTP ina Ilchomhaid i C#"
...
############################# Header ############################
title: "OTP Scoilteoir i C#"
description: "Scoilt OTP le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt OTP Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin OTP a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid OTP a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt OTP comhad ag baint úsáide as GroupDocs.Merger API
