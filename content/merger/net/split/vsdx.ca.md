...
############################# Head ############################
head_title: "Dividiu VSDX en diversos fitxers a C#"
...
############################# Header ############################
title: "VSDX Divisor a C#"
description: "Dividiu VSDX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers VSDX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer VSDX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers VSDX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer VSDX mitjançant l'API de GroupDocs.Merger
