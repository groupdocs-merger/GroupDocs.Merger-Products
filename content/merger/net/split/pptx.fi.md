...
############################# Head ############################
head_title: "Jaa PPTX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "PPTX Jakaja sisään C#"
description: "Jaa PPTX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa PPTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden PPTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto PPTX GroupDocs.Merger API:lla
