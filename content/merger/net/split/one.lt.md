...
############################# Head ############################
head_title: "Padalinkite ONE į kelis failus C#"
...
############################# Header ############################
title: "ONE skirstytuvas C#"
description: "Padalinkite ONE keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ONE failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną ONE failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ONE failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite ONE failą naudodami GroupDocs.Merger API
