...
############################# Head ############################
head_title: "Pisahkan EXCEL menjadi Beberapa File di C#"
...
############################# Header ############################
title: "EXCEL Pemisah Di C#"
description: "Pisahkan EXCEL dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan EXCEL Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file EXCEL menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file EXCEL menggunakan kode contoh C#">}}
