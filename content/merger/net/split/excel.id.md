...
############################# Head ############################
head_title: "Pisahkan dokumen EXCEL dalam aplikasi .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk memisahkan file EXCEL menjadi dokumen terpisah. Kelola file PDF, dokumen Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pisahkan file EXCEL" 
description: "GroupDocs.Merger for .NET meningkatkan aplikasi .NET dengan fitur pemrosesan dokumen canggih. Pisahkan file EXCEL dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memisahkan file EXCEL"
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), Anda dapat memisahkan dokumen EXCEL dan menyimpan halaman yang dipilih sebagai file baru. Tingkatkan pemrosesan dokumen dalam aplikasi .NET Anda.
      
      1. Tentukan jalur sumber dari file EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pisahkan dokumen EXCEL dan simpan halaman genap"
      content: |
        Contoh ini menunjukkan cara memisahkan dokumen EXCEL dan menyimpan semua halaman genap sebagai file terpisah.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
