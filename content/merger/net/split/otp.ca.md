...
############################# Head ############################
head_title: "Dividiu OTP en diversos fitxers a C#"
...
############################# Header ############################
title: "OTP Divisor a C#"
description: "Dividiu OTP amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers OTP a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer OTP en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers OTP utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer OTP mitjançant l'API de GroupDocs.Merger
