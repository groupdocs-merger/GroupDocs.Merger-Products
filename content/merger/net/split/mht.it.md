...
############################# Head ############################
head_title: "Dividi MHT in più file in C#"
...
############################# Header ############################
title: "MHT Separatore in C#"
description: "Dividi MHT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file MHT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file MHT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file MHT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file MHT utilizzando l'API GroupDocs.Merger
