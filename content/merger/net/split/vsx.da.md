...
############################# Head ############################
head_title: "Opdel VSX i flere filer i C#"
...
description: "Opdel VSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSX fil ved hjælp af GroupDocs.Merger API
