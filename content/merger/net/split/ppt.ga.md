...
############################# Head ############################
head_title: "Scoilt PPT ina Ilchomhaid i C#"
...
############################# Header ############################
title: "PPT Scoilteoir i C#"
description: "Scoilt PPT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt PPT Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin PPT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid PPT a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt PPT comhad ag baint úsáide as GroupDocs.Merger API
