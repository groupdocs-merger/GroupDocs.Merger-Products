...
############################# Head ############################
head_title: "Del XLSX i flere filer i C#"
...
description: "Del XLSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLSX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLSX-filen ved hjelp av GroupDocs.Merger API
