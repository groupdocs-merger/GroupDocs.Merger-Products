...
############################# Head ############################
head_title: "Del XLS i flere filer i C#"
...
description: "Del XLS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLS-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLS-filen ved hjelp av GroupDocs.Merger API
