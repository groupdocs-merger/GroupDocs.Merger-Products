...
############################# Head ############################
head_title: "Rozdeliť ONE do viacerých súborov v C#"
...
############################# Header ############################
title: "ONE Splitter v C#"
description: "Rozdeľte ONE niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť ONE strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor ONE na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ONE súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor ONE pomocou rozhrania GroupDocs.Merger API
