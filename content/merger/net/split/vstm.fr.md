...
############################# Head ############################
head_title: "Divisez VSTM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSTM Séparateur dans C#"
description: "Divisez VSTM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSTM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSTM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSTM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSTM à l'aide de l'API GroupDocs.Merger
