...
############################# Head ############################
head_title: "Jagage PPSX mitmeks failiks rakenduses C#"
...
description: "Tükeldage PPSX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks PPSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada PPSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail PPSX, kasutades GroupDocs.Merger API-t
