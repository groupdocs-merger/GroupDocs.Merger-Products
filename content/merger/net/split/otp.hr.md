...
############################# Head ############################
head_title: "Podijeli OTP u više datoteka u C#"
...
############################# Header ############################
title: "OTP Splitter u C#"
description: "Podijelite OTP s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli OTP stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne OTP datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti OTP datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli OTP datoteku pomoću API-ja GroupDocs.Merger
