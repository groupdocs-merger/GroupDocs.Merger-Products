...
############################# Head ############################
head_title: "Skiptu XLSB í margar skrár í C#"
...
############################# Header ############################
title: "XLSB Skerandi í C#"
description: "Skiptu XLSB með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSB skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLSB skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSB skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLSB skrá með GroupDocs.Merger API
