...
############################# Head ############################
head_title: "Pisahkan RTF kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "RTF Pemisah Dalam C#"
description: "Pisahkan RTF dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan RTF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail RTF kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi RTF fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail RTF menggunakan API GroupDocs.Merger
