...
############################# Head ############################
head_title: "Jaa DOTX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "DOTX Jakaja sisään C#"
description: "Jaa DOTX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa DOTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden DOTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto DOTX GroupDocs.Merger API:lla
