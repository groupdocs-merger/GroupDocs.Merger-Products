...
############################# Head ############################
head_title: "ONE'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "ONE Ayırıcı C#"
description: "ONE kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "ONE Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ONE dosyasını ayırın
