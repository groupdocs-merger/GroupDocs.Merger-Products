...
############################# Head ############################
head_title: "Skiptu DOTM í margar skrár í C#"
...
############################# Header ############################
title: "DOTM Skerandi í C#"
description: "Skiptu DOTM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOTM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOTM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOTM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOTM skrá með GroupDocs.Merger API
