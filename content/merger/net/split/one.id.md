...
############################# Head ############################
head_title: "Pisahkan ONE menjadi Beberapa File di C#"
...
############################# Header ############################
title: "ONE Pemisah Di C#"
description: "Pisahkan ONE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan ONE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file ONE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file ONE menggunakan kode contoh C#">}}

        ```csharp    
        // Pisahkan file ONE menggunakan GroupDocs.Merger API
