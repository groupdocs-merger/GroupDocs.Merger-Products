...
############################# Head ############################
head_title: "Splits XPS in meerdere bestanden in C#"
...
############################# Header ############################
title: "XPS Splitter in C#"
description: "Splits XPS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XPS Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XPS bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XPS bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XPS bestand met behulp van GroupDocs.Merger API
