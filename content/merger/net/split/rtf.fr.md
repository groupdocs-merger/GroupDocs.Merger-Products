...
############################# Head ############################
head_title: "Divisez RTF en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "RTF Séparateur dans C#"
description: "Divisez RTF avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner RTF pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier RTF en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers RTF à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier RTF à l'aide de l'API GroupDocs.Merger
