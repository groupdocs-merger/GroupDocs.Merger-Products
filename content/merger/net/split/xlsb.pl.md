...
############################# Head ############################
head_title: "Podziel XLSB na wiele plików w C#"
...
############################# Header ############################
title: "XLSB Rozdzielacz w C#"
description: "Podziel XLSB z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XLSB w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XLSB na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XLSB przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XLSB za pomocą GroupDocs.Merger API
