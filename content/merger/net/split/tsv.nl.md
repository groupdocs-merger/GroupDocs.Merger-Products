...
############################# Head ############################
head_title: "Splits TSV in meerdere bestanden in C#"
...
description: "Splits TSV met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits TSV Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel TSV bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TSV bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits TSV bestand met behulp van GroupDocs.Merger API
