...
############################# Head ############################
head_title: "Skiptu OTT í margar skrár í C#"
...
############################# Header ############################
title: "OTT Skerandi í C#"
description: "Skiptu OTT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu OTT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni OTT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta OTT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu OTT skrá með GroupDocs.Merger API
