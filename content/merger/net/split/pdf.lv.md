...
############################# Head ############################
head_title: "Sadaliet PDF vairākos failos programmā C#"
...
############################# Header ############################
title: "PDF sadalītājs programmā C#"
description: "Sadaliet PDF ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PDF faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu PDF failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PDF failus, izmantojot C# piemēra kodu">}}
