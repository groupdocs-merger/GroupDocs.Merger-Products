...
############################# Head ############################
head_title: "Jagage XLTM mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLTM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLTM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLTM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLTM, kasutades GroupDocs.Merger API-t
