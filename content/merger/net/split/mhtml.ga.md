...
############################# Head ############################
head_title: "Scoilt MHTML ina Ilchomhaid i C#"
...
############################# Header ############################
title: "MHTML Scoilteoir i C#"
description: "Scoilt MHTML le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt MHTML Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin MHTML a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid MHTML a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt MHTML comhad ag baint úsáide as GroupDocs.Merger API
