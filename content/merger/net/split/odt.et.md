...
############################# Head ############################
head_title: "Jagage ODT mitmeks failiks rakenduses C#"
...
description: "Tükeldage ODT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage ODT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks ODT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada ODT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail ODT, kasutades GroupDocs.Merger API-t
