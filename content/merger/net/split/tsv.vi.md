...
############################# Head ############################
head_title: "Tách TSV thành nhiều tệp trong C#"
...
############################# Header ############################
title: "TSV Splitter trong C#"
description: "Tách TSV bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp TSV trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp TSV thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp TSV bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp TSV bằng API GroupDocs.Merger
