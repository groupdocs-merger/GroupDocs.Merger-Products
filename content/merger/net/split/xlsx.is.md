...
############################# Head ############################
head_title: "Skiptu XLSX í margar skrár í C#"
...
############################# Header ############################
title: "XLSX Skerandi í C#"
description: "Skiptu XLSX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLSX skrá með GroupDocs.Merger API
