...
############################# Head ############################
head_title: "Podijeli PDF u više datoteka u C#"
...
############################# Header ############################
title: "PDF Splitter u C#"
description: "Podijelite PDF s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli PDF stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne PDF datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PDF datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli PDF datoteku pomoću API-ja GroupDocs.Merger
