...
############################# Head ############################
head_title: "Sadaliet VSDX vairākos failos programmā C#"
...
############################# Header ############################
title: "VSDX sadalītājs programmā C#"
description: "Sadaliet VSDX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSDX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSDX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSDX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSDX failu, izmantojot GroupDocs.Merger API
