...
############################# Head ############################
head_title: "Dela upp CSV i flera filer i C#"
...
description: "Dela upp CSV med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp CSV filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda CSV-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp CSV-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela CSV-fil med GroupDocs.Merger API
