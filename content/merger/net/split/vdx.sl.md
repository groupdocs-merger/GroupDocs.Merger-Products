...
############################# Head ############################
head_title: "Razdeli VDX na več datotek v C#"
...
############################# Header ############################
title: "VDX razdelilnik v C#"
description: "Razdelite VDX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VDX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VDX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VDX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VDX z API-jem GroupDocs.Merger
