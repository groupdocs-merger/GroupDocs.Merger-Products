...
############################# Head ############################
head_title: "XLS'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLS Ayırıcı C#"
description: "XLS kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLS Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLS dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLS dosyasını ayırın
