...
############################# Head ############################
head_title: "تقسيم DOT إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "DOT الفاصل في C#"
description: "قسِّم DOT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات DOT في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد DOT إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات DOT باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف DOT باستخدام GroupDocs.Merger API
