...
############################# Head ############################
head_title: "Sadaliet HTML vairākos failos programmā C#"
...
############################# Header ############################
title: "HTML sadalītājs programmā C#"
description: "Sadaliet HTML ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet HTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu HTML failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt HTML failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet HTML failu, izmantojot GroupDocs.Merger API
