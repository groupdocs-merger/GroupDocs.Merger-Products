...
############################# Head ############################
head_title: "OTT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "OTT Ayırıcı C#"
description: "OTT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "OTT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak OTT dosyasını ayırın
