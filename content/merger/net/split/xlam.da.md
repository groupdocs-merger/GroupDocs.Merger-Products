...
############################# Head ############################
head_title: "Opdel XLAM i flere filer i C#"
...
description: "Opdel XLAM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLAM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLAM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLAM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLAM fil ved hjælp af GroupDocs.Merger API
