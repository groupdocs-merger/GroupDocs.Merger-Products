...
############################# Head ############################
head_title: "Podijeli ODP u više datoteka u C#"
...
############################# Header ############################
title: "ODP Splitter u C#"
description: "Podijelite ODP s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli ODP stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne ODP datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti ODP datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli ODP datoteku pomoću API-ja GroupDocs.Merger
