...
############################# Head ############################
head_title: "Divisez XLSM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLSM Séparateur dans C#"
description: "Divisez XLSM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLSM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLSM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLSM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLSM à l'aide de l'API GroupDocs.Merger
