...
############################# Head ############################
head_title: "Verdeel XLTM in veelvuldige lêers in C#"
...
description: "Verdeel XLTM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLTM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLTM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLTM lêer deur GroupDocs.Merger API te gebruik
