...
############################# Head ############################
head_title: "Padalinkite DOTX į kelis failus C#"
...
############################# Header ############################
title: "DOTX skirstytuvas C#"
description: "Padalinkite DOTX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną DOTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite DOTX failą naudodami GroupDocs.Merger API
