...
############################# Head ############################
head_title: "Tách EPUB thành nhiều tệp trong C#"
...
############################# Header ############################
title: "EPUB Splitter trong C#"
description: "Tách EPUB bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp EPUB trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp EPUB thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp EPUB bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp EPUB bằng API GroupDocs.Merger
