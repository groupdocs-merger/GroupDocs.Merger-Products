...
############################# Head ############################
head_title: "Razdeli MHTML na več datotek v C#"
...
############################# Header ############################
title: "MHTML razdelilnik v C#"
description: "Razdelite MHTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli MHTML strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke MHTML na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke MHTML s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko MHTML z API-jem GroupDocs.Merger
