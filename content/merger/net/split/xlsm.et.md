...
############################# Head ############################
head_title: "Jagage XLSM mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLSM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLSM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLSM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLSM, kasutades GroupDocs.Merger API-t
