...
############################# Head ############################
head_title: "Pisahkan XLSB kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLSB Pemisah Dalam C#"
description: "Pisahkan XLSB dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLSB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLSB kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLSB fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLSB menggunakan API GroupDocs.Merger
