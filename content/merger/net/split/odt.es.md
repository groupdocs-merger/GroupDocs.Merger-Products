...
############################# Head ############################
head_title: "Dividir ODT en varios archivos en C#"
...
############################# Header ############################
title: "ODT Divisor en C#"
description: "Divida ODT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir ODT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo ODT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos ODT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo ODT usando GroupDocs.Merger API
