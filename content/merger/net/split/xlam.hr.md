...
############################# Head ############################
head_title: "Podijeli XLAM u više datoteka u C#"
...
############################# Header ############################
title: "XLAM Splitter u C#"
description: "Podijelite XLAM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLAM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLAM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLAM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLAM datoteku pomoću API-ja GroupDocs.Merger
