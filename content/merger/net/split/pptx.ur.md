...
############################# Head ############################
head_title: "PPTX کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "PPTX سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ PPTX کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "PPTX فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک PPTX فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے PPTX فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے PPTX فائل کو تقسیم کریں۔
