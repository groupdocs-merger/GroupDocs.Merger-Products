...
############################# Head ############################
head_title: "Dividi EPUB in più file in C#"
...
############################# Header ############################
title: "EPUB Separatore in C#"
description: "Dividi EPUB con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file EPUB in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file EPUB in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file EPUB utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file EPUB utilizzando l'API GroupDocs.Merger
