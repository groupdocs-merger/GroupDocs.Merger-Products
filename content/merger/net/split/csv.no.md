...
############################# Head ############################
head_title: "Del CSV i flere filer i C#"
...
############################# Header ############################
title: "CSV splitter i C#"
description: "Del CSV med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del CSV filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt CSV-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp CSV filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del CSV-filen ved hjelp av GroupDocs.Merger API
