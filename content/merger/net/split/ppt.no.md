...
############################# Head ############################
head_title: "Del PPT i flere filer i C#"
...
description: "Del PPT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt PPT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PPT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del PPT-filen ved hjelp av GroupDocs.Merger API
