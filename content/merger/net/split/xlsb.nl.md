...
############################# Head ############################
head_title: "Splits XLSB in meerdere bestanden in C#"
...
description: "Splits XLSB met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLSB Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLSB bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSB bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLSB bestand met behulp van GroupDocs.Merger API
