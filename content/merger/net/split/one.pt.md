...
############################# Head ############################
head_title: "Divida ONE em vários arquivos em C#"
...
############################# Header ############################
title: "ONE Divisor em C#"
description: "Divida ONE com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo ONE em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo ONE em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos ONE usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo ONE usando a API GroupDocs.Merger
