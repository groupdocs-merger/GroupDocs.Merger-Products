...
############################# Head ############################
head_title: "OTP'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "OTP Ayırıcı C#"
description: "OTP kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "OTP Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak OTP dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak OTP dosyasını ayırın
