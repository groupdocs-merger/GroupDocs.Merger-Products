...
############################# Head ############################
head_title: "Opdel PPT i flere filer i C#"
...
############################# Header ############################
title: "PPT Splitter i C#"
description: "Opdel PPT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel PPT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt PPT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles PPT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel PPT fil ved hjælp af GroupDocs.Merger API
