...
############################# Head ############################
head_title: "XLAM'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLAM Ayırıcı C#"
description: "XLAM kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLAM Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLAM dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLAM dosyasını ayırın
