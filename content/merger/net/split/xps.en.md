...
############################# Head ############################
head_title: "Split XPS documents in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to split XPS files into separate documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, Visio files, images, archives, and more."

############################# Header ############################
title: "Split XPS files" 
description: "GroupDocs.Merger for .NET enhances .NET applications with advanced document processing features. Easily split XPS files and work with various popular business formats."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can split XPS documents and save selected pages as a new file. Enhance document processing in your .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Split XPS document and save even-numbered pages"
      content: |
        This example shows how to split a XPS document and save all even-numbered pages as a separate file.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
