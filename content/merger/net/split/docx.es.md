...
############################# Head ############################
head_title: "Dividir DOCX en varios archivos en C#"
...
############################# Header ############################
title: "DOCX Divisor en C#"
description: "Divida DOCX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOCX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOCX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOCX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOCX usando GroupDocs.Merger API
