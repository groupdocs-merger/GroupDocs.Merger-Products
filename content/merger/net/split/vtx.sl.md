...
############################# Head ############################
head_title: "Razdeli VTX na več datotek v C#"
...
############################# Header ############################
title: "VTX razdelilnik v C#"
description: "Razdelite VTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VTX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VTX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VTX z API-jem GroupDocs.Merger
