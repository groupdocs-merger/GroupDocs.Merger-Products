...
############################# Head ############################
head_title: "Verdeel DOT in veelvuldige lêers in C#"
...
############################# Header ############################
title: "DOT Splitter in C#"
description: "Verdeel DOT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele DOT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel DOT lêer deur GroupDocs.Merger API te gebruik
