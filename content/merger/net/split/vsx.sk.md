...
############################# Head ############################
head_title: "Rozdeliť VSX do viacerých súborov v C#"
...
############################# Header ############################
title: "VSX Splitter v C#"
description: "Rozdeľte VSX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSX pomocou rozhrania GroupDocs.Merger API
