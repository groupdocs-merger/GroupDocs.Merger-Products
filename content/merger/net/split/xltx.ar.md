...
############################# Head ############################
head_title: "تقسيم XLTX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "XLTX الفاصل في C#"
description: "قسِّم XLTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات XLTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد XLTX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات XLTX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف XLTX باستخدام GroupDocs.Merger API
