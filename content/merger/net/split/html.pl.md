...
############################# Head ############################
head_title: "Podziel HTML na wiele plików w C#"
...
############################# Header ############################
title: "HTML Rozdzielacz w C#"
description: "Podziel HTML z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików HTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku HTML na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki HTML przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik HTML za pomocą GroupDocs.Merger API
