...
############################# Head ############################
head_title: "Padalinkite VSX į kelis failus C#"
...
############################# Header ############################
title: "VSX skirstytuvas C#"
description: "Padalinkite VSX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSX failą naudodami GroupDocs.Merger API
