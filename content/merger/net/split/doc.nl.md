...
############################# Head ############################
head_title: "Splits DOC in meerdere bestanden in C#"
...
description: "Splits DOC met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOC Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOC bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOC bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOC bestand met behulp van GroupDocs.Merger API
