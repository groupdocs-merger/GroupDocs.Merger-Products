...
############################# Head ############################
head_title: "Jaa XLTX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLTX Jakaja sisään C#"
description: "Jaa XLTX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLTX GroupDocs.Merger API:lla
