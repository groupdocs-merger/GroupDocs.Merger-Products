...
############################# Head ############################
head_title: "Splits XLTX in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLTX Splitter in C#"
description: "Splits XLTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLTX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLTX bestand met behulp van GroupDocs.Merger API
