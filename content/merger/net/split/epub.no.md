...
############################# Head ############################
head_title: "Del EPUB i flere filer i C#"
...
description: "Del EPUB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt EPUB-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp EPUB filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del EPUB-filen ved hjelp av GroupDocs.Merger API
