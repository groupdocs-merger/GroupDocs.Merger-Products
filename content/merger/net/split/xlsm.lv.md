...
############################# Head ############################
head_title: "Sadaliet XLSM vairākos failos programmā C#"
...
############################# Header ############################
title: "XLSM sadalītājs programmā C#"
description: "Sadaliet XLSM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLSM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLSM failu, izmantojot GroupDocs.Merger API
