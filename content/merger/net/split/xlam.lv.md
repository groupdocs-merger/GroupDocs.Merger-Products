...
############################# Head ############################
head_title: "Sadaliet XLAM vairākos failos programmā C#"
...
############################# Header ############################
title: "XLAM sadalītājs programmā C#"
description: "Sadaliet XLAM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLAM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLAM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLAM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLAM failu, izmantojot GroupDocs.Merger API
