...
############################# Head ############################
head_title: "Razdeli XPS na več datotek v C#"
...
############################# Header ############################
title: "XPS razdelilnik v C#"
description: "Razdelite XPS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XPS strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XPS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XPS s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XPS z API-jem GroupDocs.Merger
