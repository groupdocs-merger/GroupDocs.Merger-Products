...
############################# Head ############################
head_title: "Razdeli PPT na več datotek v C#"
...
############################# Header ############################
title: "PPT razdelilnik v C#"
description: "Razdelite PPT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli PPT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke PPT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke PPT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko PPT z API-jem GroupDocs.Merger
