...
############################# Head ############################
head_title: "Del XLT i flere filer i C#"
...
description: "Del XLT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLT-filen ved hjelp av GroupDocs.Merger API
