...
############################# Head ############################
head_title: "Dividiu DOTX en diversos fitxers a C#"
...
############################# Header ############################
title: "DOTX Divisor a C#"
description: "Dividiu DOTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers DOTX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer DOTX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers DOTX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer DOTX mitjançant l'API de GroupDocs.Merger
