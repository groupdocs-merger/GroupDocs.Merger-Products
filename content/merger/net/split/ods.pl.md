...
############################# Head ############################
head_title: "Podziel ODS na wiele plików w C#"
...
############################# Header ############################
title: "ODS Rozdzielacz w C#"
description: "Podziel ODS z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików ODS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku ODS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki ODS przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik ODS za pomocą GroupDocs.Merger API
