...
############################# Head ############################
head_title: "Rozdeliť XLAM do viacerých súborov v C#"
...
############################# Header ############################
title: "XLAM Splitter v C#"
description: "Rozdeľte XLAM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLAM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLAM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLAM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLAM pomocou rozhrania GroupDocs.Merger API
