...
############################# Head ############################
head_title: "Padalinkite XPS į kelis failus C#"
...
############################# Header ############################
title: "XPS skirstytuvas C#"
description: "Padalinkite XPS keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XPS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XPS failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XPS failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XPS failą naudodami GroupDocs.Merger API
