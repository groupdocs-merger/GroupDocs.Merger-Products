...
############################# Head ############################
head_title: "Skiptu VSDM í margar skrár í C#"
...
############################# Header ############################
title: "VSDM Skerandi í C#"
description: "Skiptu VSDM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSDM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSDM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSDM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSDM skrá með GroupDocs.Merger API
