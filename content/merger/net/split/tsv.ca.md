...
############################# Head ############################
head_title: "Dividiu TSV en diversos fitxers a C#"
...
############################# Header ############################
title: "TSV Divisor a C#"
description: "Dividiu TSV amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers TSV a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer TSV en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers TSV utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer TSV mitjançant l'API de GroupDocs.Merger
