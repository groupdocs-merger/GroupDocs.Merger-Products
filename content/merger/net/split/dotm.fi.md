...
############################# Head ############################
head_title: "Jaa DOTM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "DOTM Jakaja sisään C#"
description: "Jaa DOTM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa DOTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden DOTM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOTM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto DOTM GroupDocs.Merger API:lla
