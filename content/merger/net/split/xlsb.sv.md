...
############################# Head ############################
head_title: "Dela upp XLSB i flera filer i C#"
...
############################# Header ############################
title: "XLSB splitter i C#"
description: "Dela upp XLSB med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLSB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLSB-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLSB-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLSB-fil med GroupDocs.Merger API
