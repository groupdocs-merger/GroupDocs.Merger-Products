...
############################# Head ############################
head_title: "Divisez IMAGE en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "IMAGE Séparateur dans C#"
description: "Divisez IMAGE avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner IMAGE pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier IMAGE en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers IMAGE à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier IMAGE à l'aide de l'API GroupDocs.Merger
