...
############################# Head ############################
head_title: "Tách DOTM thành nhiều tệp trong C#"
...
############################# Header ############################
title: "DOTM Splitter trong C#"
description: "Tách DOTM bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp DOTM trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp DOTM thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp DOTM bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp DOTM bằng API GroupDocs.Merger
