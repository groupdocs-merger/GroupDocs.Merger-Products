...
############################# Head ############################
head_title: "Divida VSTM em vários arquivos em C#"
...
############################# Header ############################
title: "VSTM Divisor em C#"
description: "Divida VSTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSTM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSTM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSTM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSTM usando a API GroupDocs.Merger
