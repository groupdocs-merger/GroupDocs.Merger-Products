...
############################# Head ############################
head_title: "Sadaliet ONE vairākos failos programmā C#"
...
############################# Header ############################
title: "ONE sadalītājs programmā C#"
description: "Sadaliet ONE ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ONE faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu ONE failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ONE failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet ONE failu, izmantojot GroupDocs.Merger API
