...
############################# Head ############################
head_title: "TSV کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "TSV سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ TSV کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "TSV فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک TSV فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے TSV فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے TSV فائل کو تقسیم کریں۔
