...
############################# Head ############################
head_title: "Splits VSSX in meerdere bestanden in C#"
...
description: "Splits VSSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSSX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSSX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSSX bestand met behulp van GroupDocs.Merger API
