...
############################# Head ############################
head_title: "XLT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLT Ayırıcı C#"
description: "XLT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLT dosyasını ayırın
