...
############################# Head ############################
head_title: "Sadaliet XLTM vairākos failos programmā C#"
...
############################# Header ############################
title: "XLTM sadalītājs programmā C#"
description: "Sadaliet XLTM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLTM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLTM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLTM failu, izmantojot GroupDocs.Merger API
