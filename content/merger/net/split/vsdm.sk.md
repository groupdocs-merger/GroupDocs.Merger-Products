...
############################# Head ############################
head_title: "Rozdeliť VSDM do viacerých súborov v C#"
...
############################# Header ############################
title: "VSDM Splitter v C#"
description: "Rozdeľte VSDM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSDM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSDM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSDM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSDM pomocou rozhrania GroupDocs.Merger API
