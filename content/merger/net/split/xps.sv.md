...
############################# Head ############################
head_title: "Dela upp XPS i flera filer i C#"
...
############################# Header ############################
title: "XPS splitter i C#"
description: "Dela upp XPS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XPS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XPS-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XPS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XPS-fil med GroupDocs.Merger API
