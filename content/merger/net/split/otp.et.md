...
############################# Head ############################
head_title: "Jagage OTP mitmeks failiks rakenduses C#"
...
description: "Tükeldage OTP mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage OTP faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks OTP-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada OTP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail OTP, kasutades GroupDocs.Merger API-t
