...
############################# Head ############################
head_title: "Splits VSDX in meerdere bestanden in C#"
...
description: "Splits VSDX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSDX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSDX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSDX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSDX bestand met behulp van GroupDocs.Merger API
