...
############################# Head ############################
head_title: "Dividi VSDM in più file in C#"
...
############################# Header ############################
title: "VSDM Separatore in C#"
description: "Dividi VSDM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file VSDM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file VSDM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file VSDM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file VSDM utilizzando l'API GroupDocs.Merger
