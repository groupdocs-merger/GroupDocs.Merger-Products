...
############################# Head ############################
head_title: "Scoilt TSV ina Ilchomhaid i C#"
...
############################# Header ############################
title: "TSV Scoilteoir i C#"
description: "Scoilt TSV le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt TSV Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin TSV a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid TSV a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt TSV comhad ag baint úsáide as GroupDocs.Merger API
