...
############################# Head ############################
head_title: "Jaa PPS useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "PPS Jakaja sisään C#"
description: "Jaa PPS muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa PPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden PPS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto PPS GroupDocs.Merger API:lla
