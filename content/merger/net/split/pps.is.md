...
############################# Head ############################
head_title: "Skiptu PPS í margar skrár í C#"
...
############################# Header ############################
title: "PPS Skerandi í C#"
description: "Skiptu PPS með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPS skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni PPS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPS skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu PPS skrá með GroupDocs.Merger API
