...
############################# Head ############################
head_title: "Jaa ONE useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "ONE Jakaja sisään C#"
description: "Jaa ONE muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa ONE tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden ONE-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ONE tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto ONE GroupDocs.Merger API:lla
