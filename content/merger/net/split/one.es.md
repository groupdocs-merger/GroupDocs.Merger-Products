...
############################# Head ############################
head_title: "Dividir ONE en varios archivos en C#"
...
############################# Header ############################
title: "ONE Divisor en C#"
description: "Divida ONE con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir ONE páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo ONE en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos ONE usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo ONE usando GroupDocs.Merger API
