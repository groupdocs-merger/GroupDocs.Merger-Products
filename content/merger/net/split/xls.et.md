...
############################# Head ############################
head_title: "Jagage XLS mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLS mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLS, kasutades GroupDocs.Merger API-t
