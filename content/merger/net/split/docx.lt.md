...
############################# Head ############################
head_title: "Padalinkite DOCX į kelis failus C#"
...
############################# Header ############################
title: "DOCX skirstytuvas C#"
description: "Padalinkite DOCX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOCX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną DOCX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOCX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite DOCX failą naudodami GroupDocs.Merger API
