...
############################# Head ############################
head_title: "Skiptu PPT í margar skrár í C#"
...
############################# Header ############################
title: "PPT Skerandi í C#"
description: "Skiptu PPT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni PPT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu PPT skrá með GroupDocs.Merger API
