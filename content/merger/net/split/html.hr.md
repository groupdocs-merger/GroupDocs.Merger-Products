...
############################# Head ############################
head_title: "Podijeli HTML u više datoteka u C#"
...
############################# Header ############################
title: "HTML Splitter u C#"
description: "Podijelite HTML s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli HTML stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne HTML datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti HTML datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli HTML datoteku pomoću API-ja GroupDocs.Merger
