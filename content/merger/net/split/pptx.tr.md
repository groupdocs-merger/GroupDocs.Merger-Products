...
############################# Head ############################
head_title: "PPTX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "PPTX Ayırıcı C#"
description: "PPTX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPTX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPTX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPTX dosyasını ayırın
