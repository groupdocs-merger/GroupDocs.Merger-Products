...
############################# Head ############################
head_title: "Padalinkite XLTM į kelis failus C#"
...
############################# Header ############################
title: "XLTM skirstytuvas C#"
description: "Padalinkite XLTM keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLTM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XLTM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLTM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XLTM failą naudodami GroupDocs.Merger API
