...
############################# Head ############################
head_title: "Skiptu VSTX í margar skrár í C#"
...
############################# Header ############################
title: "VSTX Skerandi í C#"
description: "Skiptu VSTX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSTX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSTX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSTX skrá með GroupDocs.Merger API
