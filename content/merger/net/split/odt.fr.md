...
############################# Head ############################
head_title: "Divisez ODT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "ODT Séparateur dans C#"
description: "Divisez ODT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner ODT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier ODT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers ODT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier ODT à l'aide de l'API GroupDocs.Merger
