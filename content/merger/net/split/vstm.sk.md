...
############################# Head ############################
head_title: "Rozdeliť VSTM do viacerých súborov v C#"
...
############################# Header ############################
title: "VSTM Splitter v C#"
description: "Rozdeľte VSTM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSTM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSTM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSTM pomocou rozhrania GroupDocs.Merger API
