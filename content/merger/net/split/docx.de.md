...
############################# Head ############################
head_title: "Teilen von DOCX-Dokumenten in .NET-Apps"
head_description: "Nutzen Sie GroupDocs.Merger for .NET, um DOCX-Dateien in separate Dokumente zu teilen. Verwalten Sie PDFs, Word-Dateien, Excel-Tabellen, PowerPoint-Folien, Visio-Dateien, Bilder, Archive und mehr."

############################# Header ############################
title: "Teilen von DOCX-Dateien" 
description: "GroupDocs.Merger for .NET verbessert .NET-Anwendungen mit fortschrittlichen Funktionen zur Dokumentenverarbeitung. Teilen Sie DOCX-Dateien und arbeiten Sie mit verschiedenen gängigen Geschäftsformaten."
...
steps:
    enable: true
    title: "So teilen Sie DOCX-Dateien"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie DOCX-Dokumente teilen und ausgewählte Seiten als neue Datei speichern. Verbessern Sie die Dokumentenverarbeitung in Ihren .NET-Anwendungen.
      
      1. Geben Sie den Quellpfad der DOCX-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "DOCX-Dokument teilen und gerade Seiten speichern"
      content: |
        Dieses Beispiel zeigt, wie man ein DOCX-Dokument teilt und alle geraden Seiten als separate Datei speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
