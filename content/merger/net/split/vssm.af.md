...
############################# Head ############################
head_title: "Verdeel VSSM in veelvuldige lêers in C#"
...
description: "Verdeel VSSM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSSM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VSSM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VSSM lêer deur GroupDocs.Merger API te gebruik
