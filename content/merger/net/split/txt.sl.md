...
############################# Head ############################
head_title: "Razdeli TXT na več datotek v C#"
...
############################# Header ############################
title: "TXT razdelilnik v C#"
description: "Razdelite TXT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli TXT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke TXT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke TXT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko TXT z API-jem GroupDocs.Merger
