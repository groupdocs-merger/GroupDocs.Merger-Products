...
############################# Head ############################
head_title: "Dela upp XLS i flera filer i C#"
...
############################# Header ############################
title: "XLS splitter i C#"
description: "Dela upp XLS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLS-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLS-fil med GroupDocs.Merger API
