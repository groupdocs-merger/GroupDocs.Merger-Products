...
############################# Head ############################
head_title: "Opdel DOTX i flere filer i C#"
...
description: "Opdel DOTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOTX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOTX fil ved hjælp af GroupDocs.Merger API
