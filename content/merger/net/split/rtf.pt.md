...
############################# Head ############################
head_title: "Divida RTF em vários arquivos em C#"
...
############################# Header ############################
title: "RTF Divisor em C#"
description: "Divida RTF com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo RTF em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo RTF em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos RTF usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo RTF usando a API GroupDocs.Merger
