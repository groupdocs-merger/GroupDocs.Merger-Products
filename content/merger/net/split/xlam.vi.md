...
############################# Head ############################
head_title: "Tách XLAM thành nhiều tệp trong C#"
...
############################# Header ############################
title: "XLAM Splitter trong C#"
description: "Tách XLAM bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp XLAM trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp XLAM thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp XLAM bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp XLAM bằng API GroupDocs.Merger
