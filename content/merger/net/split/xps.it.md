...
############################# Head ############################
head_title: "Dividi XPS in più file in C#"
...
############################# Header ############################
title: "XPS Separatore in C#"
description: "Dividi XPS con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XPS in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XPS in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XPS utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XPS utilizzando l'API GroupDocs.Merger
