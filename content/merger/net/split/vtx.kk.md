...
############################# Head ############################
head_title: "VTX файлын C# ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "VTX C# ішіндегі бөлгіш"
description: "VTX кодының бірнеше жолын .NET кодымен бөліңіз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі VTX файл беттерін бөлу"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бір VTX файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="VTX файлдарды C# мысал кодын пайдаланып қалай бөлуге болады">}}

        ```csharp    
        // GroupDocs.Merger API арқылы VTX файлды бөліңіз
