...
############################# Head ############################
head_title: "Skiptu XLSM í margar skrár í C#"
...
############################# Header ############################
title: "XLSM Skerandi í C#"
description: "Skiptu XLSM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLSM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLSM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLSM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLSM skrá með GroupDocs.Merger API
