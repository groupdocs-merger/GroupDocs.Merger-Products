...
############################# Head ############################
head_title: "Divida DOC em vários arquivos em C#"
...
############################# Header ############################
title: "DOC Divisor em C#"
description: "Divida DOC com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOC em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOC em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOC usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOC usando a API GroupDocs.Merger
