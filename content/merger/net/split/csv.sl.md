...
############################# Head ############################
head_title: "Razdeli CSV na več datotek v C#"
...
############################# Header ############################
title: "CSV razdelilnik v C#"
description: "Razdelite CSV z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli CSV strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke CSV na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke CSV s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko CSV z API-jem GroupDocs.Merger
