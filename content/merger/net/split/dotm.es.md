...
############################# Head ############################
head_title: "Dividir DOTM en varios archivos en C#"
...
############################# Header ############################
title: "DOTM Divisor en C#"
description: "Divida DOTM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOTM páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOTM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOTM usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOTM usando GroupDocs.Merger API
