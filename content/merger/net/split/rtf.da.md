...
############################# Head ############################
head_title: "Opdel RTF i flere filer i C#"
...
description: "Opdel RTF med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt RTF-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles RTF filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel RTF fil ved hjælp af GroupDocs.Merger API
