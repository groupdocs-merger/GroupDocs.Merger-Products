...
############################# Head ############################
head_title: "Scoilt ODT ina Ilchomhaid i C#"
...
############################# Header ############################
title: "ODT Scoilteoir i C#"
description: "Scoilt ODT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt ODT Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin ODT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid ODT a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt ODT comhad ag baint úsáide as GroupDocs.Merger API
