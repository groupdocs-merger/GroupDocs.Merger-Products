...
############################# Head ############################
head_title: "Divisez ODP en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "ODP Séparateur dans C#"
description: "Divisez ODP avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner ODP pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier ODP en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers ODP à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier ODP à l'aide de l'API GroupDocs.Merger
