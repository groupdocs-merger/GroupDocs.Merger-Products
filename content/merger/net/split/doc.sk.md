...
############################# Head ############################
head_title: "Rozdeliť DOC do viacerých súborov v C#"
...
############################# Header ############################
title: "DOC Splitter v C#"
description: "Rozdeľte DOC niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOC strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOC na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOC súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOC pomocou rozhrania GroupDocs.Merger API
