...
############################# Head ############################
head_title: "Podijeli VSSM u više datoteka u C#"
...
############################# Header ############################
title: "VSSM Splitter u C#"
description: "Podijelite VSSM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSSM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSSM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSSM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSSM datoteku pomoću API-ja GroupDocs.Merger
