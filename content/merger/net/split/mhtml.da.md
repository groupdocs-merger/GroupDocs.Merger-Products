...
############################# Head ############################
head_title: "Opdel MHTML i flere filer i C#"
...
description: "Opdel MHTML med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt MHTML-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles MHTML filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel MHTML fil ved hjælp af GroupDocs.Merger API
