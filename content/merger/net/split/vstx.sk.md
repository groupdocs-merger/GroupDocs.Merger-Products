...
############################# Head ############################
head_title: "Rozdeliť VSTX do viacerých súborov v C#"
...
############################# Header ############################
title: "VSTX Splitter v C#"
description: "Rozdeľte VSTX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSTX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSTX pomocou rozhrania GroupDocs.Merger API
