...
############################# Head ############################
head_title: "Rozdeliť DOTM do viacerých súborov v C#"
...
description: "Rozdeľte DOTM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOTM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOTM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOTM pomocou rozhrania GroupDocs.Merger API
