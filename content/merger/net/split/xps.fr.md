...
############################# Head ############################
head_title: "Divisez XPS en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XPS Séparateur dans C#"
description: "Divisez XPS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XPS pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XPS en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XPS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XPS à l'aide de l'API GroupDocs.Merger
