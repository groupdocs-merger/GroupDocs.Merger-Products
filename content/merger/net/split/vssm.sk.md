...
############################# Head ############################
head_title: "Rozdeliť VSSM do viacerých súborov v C#"
...
description: "Rozdeľte VSSM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSSM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSSM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSSM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSSM pomocou rozhrania GroupDocs.Merger API
