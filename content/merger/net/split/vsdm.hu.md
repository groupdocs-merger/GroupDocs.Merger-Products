...
############################# Head ############################
head_title: "A(z) VSDM felosztása több fájlra a C# programban"
...
description: "Oszd fel az VSDM elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSDM fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen VSDM fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSDM fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az VSDM fájl felosztása a GroupDocs.Merger API segítségével
