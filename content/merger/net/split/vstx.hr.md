...
############################# Head ############################
head_title: "Podijeli VSTX u više datoteka u C#"
...
############################# Header ############################
title: "VSTX Splitter u C#"
description: "Podijelite VSTX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSTX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSTX datoteku pomoću API-ja GroupDocs.Merger
