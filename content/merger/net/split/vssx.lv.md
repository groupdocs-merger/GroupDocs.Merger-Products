...
############################# Head ############################
head_title: "Sadaliet VSSX vairākos failos programmā C#"
...
############################# Header ############################
title: "VSSX sadalītājs programmā C#"
description: "Sadaliet VSSX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSSX failu, izmantojot GroupDocs.Merger API
