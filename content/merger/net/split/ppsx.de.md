...
############################# Head ############################
head_title: "Teilen Sie PPSX in mehrere Dateien in C#"
...
############################# Header ############################
title: "PPSX Splittereingang C#"
description: "Teilen Sie PPSX mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie PPSX Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne PPSX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie PPSX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die PPSX-Datei mithilfe der GroupDocs.Merger-API
