...
############################# Head ############################
head_title: "Scoilt XLSM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLSM Scoilteoir i C#"
description: "Scoilt XLSM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLSM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLSM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLSM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLSM comhad ag baint úsáide as GroupDocs.Merger API
