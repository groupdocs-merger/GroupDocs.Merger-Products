...
############################# Head ############################
head_title: "Split VSX into Multiple Files in C#"
...
description: "Split VSX with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Split VSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single VSX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VSX files using C# example code">}}
