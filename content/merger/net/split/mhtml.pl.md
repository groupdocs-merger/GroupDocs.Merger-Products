...
############################# Head ############################
head_title: "Podziel MHTML na wiele plików w C#"
...
############################# Header ############################
title: "MHTML Rozdzielacz w C#"
description: "Podziel MHTML z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików MHTML w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku MHTML na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki MHTML przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik MHTML za pomocą GroupDocs.Merger API
