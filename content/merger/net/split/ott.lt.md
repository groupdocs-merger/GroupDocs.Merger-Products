...
############################# Head ############################
head_title: "Padalinkite OTT į kelis failus C#"
...
############################# Header ############################
title: "OTT skirstytuvas C#"
description: "Padalinkite OTT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite OTT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną OTT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti OTT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite OTT failą naudodami GroupDocs.Merger API
