...
############################# Head ############################
head_title: "Tách TXT thành nhiều tệp trong C#"
...
############################# Header ############################
title: "TXT Splitter trong C#"
description: "Tách TXT bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp TXT trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp TXT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp TXT bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp TXT bằng API GroupDocs.Merger
