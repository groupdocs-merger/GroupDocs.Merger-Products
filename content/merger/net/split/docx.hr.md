...
############################# Head ############################
head_title: "Podijeli DOCX u više datoteka u C#"
...
############################# Header ############################
title: "DOCX Splitter u C#"
description: "Podijelite DOCX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOCX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOCX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOCX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOCX datoteku pomoću API-ja GroupDocs.Merger
