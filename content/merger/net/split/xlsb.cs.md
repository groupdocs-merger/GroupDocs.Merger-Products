...
############################# Head ############################
head_title: "Rozdělit XLSB do více souborů v C#"
...
description: "Rozdělte XLSB několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit XLSB stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru XLSB do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit XLSB soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor XLSB pomocí GroupDocs.Merger API
