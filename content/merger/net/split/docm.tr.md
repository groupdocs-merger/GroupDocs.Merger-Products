...
############################# Head ############################
head_title: "DOCM'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOCM Ayırıcı C#"
description: "DOCM kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOCM Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCM dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOCM dosyasını ayırın
