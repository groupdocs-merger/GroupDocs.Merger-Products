...
############################# Head ############################
head_title: "Podijeli DOCM u više datoteka u C#"
...
############################# Header ############################
title: "DOCM Splitter u C#"
description: "Podijelite DOCM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOCM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOCM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOCM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOCM datoteku pomoću API-ja GroupDocs.Merger
