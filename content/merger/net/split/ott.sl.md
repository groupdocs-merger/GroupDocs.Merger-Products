...
############################# Head ############################
head_title: "Razdeli OTT na več datotek v C#"
...
############################# Header ############################
title: "OTT razdelilnik v C#"
description: "Razdelite OTT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli OTT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke OTT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke OTT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko OTT z API-jem GroupDocs.Merger
