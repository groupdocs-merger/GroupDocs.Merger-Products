...
############################# Head ############################
head_title: "C# में PPTX को कई फाइलों में विभाजित करें"
...
############################# Header ############################
title: "PPTX स्प्लिटर इन C#"
description: "PPTX को .NET कोड की कुछ पंक्तियों से विभाजित करें।"
...
steps:
    enable: true
    title_left: "PPTX फ़ाइल पृष्ठों को .NET में विभाजित करें"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए C# डेवलपर्स के लिए एक PPTX फ़ाइल को कई परिणामी फाइलों में विभाजित करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके PPTX फ़ाइलों को कैसे विभाजित करें">}}

        ```csharp    
        // GroupDocs.Merger API का उपयोग करके PPTX फ़ाइल को विभाजित करें
