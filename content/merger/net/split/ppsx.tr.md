...
############################# Head ############################
head_title: "PPSX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "PPSX Ayırıcı C#"
description: "PPSX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPSX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPSX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPSX dosyasını ayırın
