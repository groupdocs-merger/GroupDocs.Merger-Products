...
############################# Head ############################
head_title: "Scoilt XLT ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLT Scoilteoir i C#"
description: "Scoilt XLT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLT Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLT a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLT comhad ag baint úsáide as GroupDocs.Merger API
