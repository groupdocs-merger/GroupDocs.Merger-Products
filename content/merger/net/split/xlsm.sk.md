...
############################# Head ############################
head_title: "Rozdeliť XLSM do viacerých súborov v C#"
...
############################# Header ############################
title: "XLSM Splitter v C#"
description: "Rozdeľte XLSM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLSM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLSM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLSM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLSM pomocou rozhrania GroupDocs.Merger API
