...
############################# Head ############################
head_title: "Skiptu DOC í margar skrár í C#"
...
############################# Header ############################
title: "DOC Skerandi í C#"
description: "Skiptu DOC með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOC skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOC skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOC skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOC skrá með GroupDocs.Merger API
