...
############################# Head ############################
head_title: "Dividir XLSX en varios archivos en C#"
...
############################# Header ############################
title: "XLSX Divisor en C#"
description: "Divida XLSX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLSX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLSX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLSX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLSX usando GroupDocs.Merger API
