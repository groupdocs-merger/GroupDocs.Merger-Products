...
############################# Head ############################
head_title: "Opdel XLSM i flere filer i C#"
...
description: "Opdel XLSM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLSM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLSM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLSM fil ved hjælp af GroupDocs.Merger API
