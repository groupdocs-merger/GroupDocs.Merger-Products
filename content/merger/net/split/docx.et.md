...
############################# Head ############################
head_title: "Jagage DOCX mitmeks failiks rakenduses C#"
...
description: "Tükeldage DOCX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOCX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks DOCX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada DOCX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail DOCX, kasutades GroupDocs.Merger API-t
