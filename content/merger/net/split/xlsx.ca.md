...
############################# Head ############################
head_title: "Dividiu XLSX en diversos fitxers a C#"
...
############################# Header ############################
title: "XLSX Divisor a C#"
description: "Dividiu XLSX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XLSX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XLSX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XLSX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XLSX mitjançant l'API de GroupDocs.Merger
