...
############################# Head ############################
head_title: "Divisez EPUB en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "EPUB Séparateur dans C#"
description: "Divisez EPUB avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner EPUB pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier EPUB en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers EPUB à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier EPUB à l'aide de l'API GroupDocs.Merger
