...
############################# Head ############################
head_title: "Podijeli MHT u više datoteka u C#"
...
############################# Header ############################
title: "MHT Splitter u C#"
description: "Podijelite MHT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli MHT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne MHT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti MHT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli MHT datoteku pomoću API-ja GroupDocs.Merger
