...
############################# Head ############################
head_title: "Jagage TXT mitmeks failiks rakenduses C#"
...
description: "Tükeldage TXT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage TXT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks TXT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada TXT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail TXT, kasutades GroupDocs.Merger API-t
