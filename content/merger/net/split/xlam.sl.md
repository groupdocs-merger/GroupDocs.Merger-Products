...
############################# Head ############################
head_title: "Razdeli XLAM na več datotek v C#"
...
############################# Header ############################
title: "XLAM razdelilnik v C#"
description: "Razdelite XLAM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLAM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLAM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLAM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLAM z API-jem GroupDocs.Merger
