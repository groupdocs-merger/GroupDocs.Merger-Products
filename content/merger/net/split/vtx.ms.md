...
############################# Head ############################
head_title: "Pisahkan VTX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VTX Pemisah Dalam C#"
description: "Pisahkan VTX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VTX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VTX menggunakan API GroupDocs.Merger
