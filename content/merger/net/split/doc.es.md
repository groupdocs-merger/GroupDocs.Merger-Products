...
############################# Head ############################
head_title: "Dividir DOC en varios archivos en C#"
...
############################# Header ############################
title: "DOC Divisor en C#"
description: "Divida DOC con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOC páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOC en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOC usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOC usando GroupDocs.Merger API
