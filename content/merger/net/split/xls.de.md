...
############################# Head ############################
head_title: "Teilen Sie XLS in mehrere Dateien in C#"
...
############################# Header ############################
title: "XLS Splittereingang C#"
description: "Teilen Sie XLS mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie XLS Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne XLS-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie XLS-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die XLS-Datei mithilfe der GroupDocs.Merger-API
