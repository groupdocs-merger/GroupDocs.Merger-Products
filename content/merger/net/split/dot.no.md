...
############################# Head ############################
head_title: "Del DOT i flere filer i C#"
...
description: "Del DOT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt DOT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del DOT-filen ved hjelp av GroupDocs.Merger API
