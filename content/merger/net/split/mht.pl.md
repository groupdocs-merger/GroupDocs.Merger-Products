...
############################# Head ############################
head_title: "Podziel MHT na wiele plików w C#"
...
############################# Header ############################
title: "MHT Rozdzielacz w C#"
description: "Podziel MHT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików MHT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku MHT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki MHT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik MHT za pomocą GroupDocs.Merger API
