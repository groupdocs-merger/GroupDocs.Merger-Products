...
############################# Head ############################
head_title: "Sadaliet MHT vairākos failos programmā C#"
...
############################# Header ############################
title: "MHT sadalītājs programmā C#"
description: "Sadaliet MHT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet MHT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu MHT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt MHT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet MHT failu, izmantojot GroupDocs.Merger API
