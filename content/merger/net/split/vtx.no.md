...
############################# Head ############################
head_title: "Del VTX i flere filer i C#"
...
description: "Del VTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VTX-filen ved hjelp av GroupDocs.Merger API
