...
############################# Head ############################
head_title: "Podziel DOTX na wiele plików w C#"
...
############################# Header ############################
title: "DOTX Rozdzielacz w C#"
description: "Podziel DOTX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOTX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOTX za pomocą GroupDocs.Merger API
