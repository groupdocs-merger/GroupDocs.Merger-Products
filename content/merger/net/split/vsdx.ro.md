...
############################# Head ############################
head_title: "Împărțiți VSDX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VSDX în C#"
description: "Împărțiți VSDX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VSDX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VSDX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VSDX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VSDX utilizând API-ul GroupDocs.Merger
