...
############################# Head ############################
head_title: "Splits VSDM in meerdere bestanden in C#"
...
description: "Splits VSDM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSDM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSDM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSDM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSDM bestand met behulp van GroupDocs.Merger API
