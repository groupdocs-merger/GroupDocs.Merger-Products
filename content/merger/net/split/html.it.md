...
############################# Head ############################
head_title: "Dividi i documenti HTML nelle app .NET"
head_description: "Utilizza GroupDocs.Merger for .NET per suddividere i file HTML in documenti separati. Gestisci facilmente PDF, file Word, fogli Excel, diapositive PowerPoint, file Visio, immagini, archivi e altro ancora."

############################# Header ############################
title: "Dividi i file HTML" 
description: "GroupDocs.Merger for .NET potenzia le applicazioni .NET con funzionalità avanzate di elaborazione dei documenti. Suddividi i file HTML e lavora con vari formati di business popolari."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/net/), puoi suddividere i documenti HTML e salvare le pagine selezionate come un nuovo file. Migliora l'elaborazione dei documenti nelle tue applicazioni .NET.
      
      1. Specifica il percorso sorgente del file HTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Dividi il documento HTML e salva le pagine con numero pari"
      content: |
        Questo esempio mostra come suddividere un documento HTML e salvare tutte le pagine con numero pari come file separato.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
