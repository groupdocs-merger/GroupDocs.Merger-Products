...
############################# Head ############################
head_title: "Dividi HTML in più file in C#"
...
############################# Header ############################
title: "HTML Separatore in C#"
description: "Dividi HTML con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file HTML in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file HTML in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file HTML utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file HTML utilizzando l'API GroupDocs.Merger
