...
############################# Head ############################
head_title: "Skiptu DOCX í margar skrár í C#"
...
############################# Header ############################
title: "DOCX Skerandi í C#"
description: "Skiptu DOCX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOCX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOCX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOCX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOCX skrá með GroupDocs.Merger API
