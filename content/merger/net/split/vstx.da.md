...
############################# Head ############################
head_title: "Opdel VSTX i flere filer i C#"
...
description: "Opdel VSTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSTX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSTX fil ved hjælp af GroupDocs.Merger API
