...
steps:
    enable: true
    title_left: "Split PPTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to split a single PPTM file into multiple resultant files by implementing a few easy steps.
