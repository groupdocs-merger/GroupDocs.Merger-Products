...
############################# Head ############################
head_title: "Divisez OTP en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "OTP Séparateur dans C#"
description: "Divisez OTP avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner OTP pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier OTP en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers OTP à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier OTP à l'aide de l'API GroupDocs.Merger
