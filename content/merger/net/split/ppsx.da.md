...
############################# Head ############################
head_title: "Opdel PPSX i flere filer i C#"
...
description: "Opdel PPSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt PPSX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles PPSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel PPSX fil ved hjælp af GroupDocs.Merger API
