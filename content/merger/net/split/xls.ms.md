...
############################# Head ############################
head_title: "Pisahkan XLS kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLS Pemisah Dalam C#"
description: "Pisahkan XLS dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLS fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLS menggunakan API GroupDocs.Merger
