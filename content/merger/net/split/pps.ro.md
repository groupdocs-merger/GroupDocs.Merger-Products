...
############################# Head ############################
head_title: "Împărțiți PPS în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter PPS în C#"
description: "Împărțiți PPS cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere PPS în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier PPS în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere PPS folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul PPS utilizând API-ul GroupDocs.Merger
