...
############################# Head ############################
head_title: "在 C# 中将 WORKSHEET 拆分为多个文件"
head_description: "使用文档合并 API 根据页码、页间隔、偶数页或奇数页将单个 WORKSHEET 文件拆分为多个文件。"

############################# Header ############################
title: "WORKSHEET C# 中的拆分器"
description: "用几行 .NET 代码拆分 WORKSHEET。"
...
steps:
    enable: true
    title_left: "在 .NET 中拆分 WORKSHEET 个文件页"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="如何使用 C# 示例代码拆分 WORKSHEET 文件">}}

        ```csharp    
        // 使用 GroupDocs.Merger API 拆分 WORKSHEET 文件
...
demos:
    enable: true
    title: "现场演示 - 在线拆分 WORKSHEET 文件"
    content: |
       立即访问 [GroupDocs.Merger 现场演示](https://products.groupdocs.app/splitter/worksheet) 网站拆分 WORKSHEET 文件。
       现场演示具有以下好处。
