...
############################# Head ############################
head_title: "تقسيم TEX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "TEX الفاصل في C#"
description: "قسِّم TEX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات TEX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد TEX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات TEX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف TEX باستخدام GroupDocs.Merger API
