...
############################# Head ############################
head_title: "Rozdělit DOTX do více souborů v C#"
...
description: "Rozdělte DOTX několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit DOTX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru DOTX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit DOTX soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor DOTX pomocí GroupDocs.Merger API
