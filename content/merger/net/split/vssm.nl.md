...
############################# Head ############################
head_title: "Splits VSSM in meerdere bestanden in C#"
...
############################# Header ############################
title: "VSSM Splitter in C#"
description: "Splits VSSM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSSM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSSM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSSM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSSM bestand met behulp van GroupDocs.Merger API
