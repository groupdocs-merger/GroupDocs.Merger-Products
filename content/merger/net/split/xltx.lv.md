...
############################# Head ############################
head_title: "Sadaliet XLTX vairākos failos programmā C#"
...
############################# Header ############################
title: "XLTX sadalītājs programmā C#"
description: "Sadaliet XLTX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLTX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLTX failu, izmantojot GroupDocs.Merger API
