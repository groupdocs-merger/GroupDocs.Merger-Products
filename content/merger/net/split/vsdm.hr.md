...
############################# Head ############################
head_title: "Podijeli VSDM u više datoteka u C#"
...
############################# Header ############################
title: "VSDM Splitter u C#"
description: "Podijelite VSDM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSDM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSDM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSDM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSDM datoteku pomoću API-ja GroupDocs.Merger
