...
############################# Head ############################
head_title: "Tách VSDX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "VSDX Splitter trong C#"
description: "Tách VSDX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp VSDX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp VSDX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp VSDX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp VSDX bằng API GroupDocs.Merger
