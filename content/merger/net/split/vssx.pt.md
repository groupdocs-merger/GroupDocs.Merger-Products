...
############################# Head ############################
head_title: "Divida VSSX em vários arquivos em C#"
...
############################# Header ############################
title: "VSSX Divisor em C#"
description: "Divida VSSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSSX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSSX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSSX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSSX usando a API GroupDocs.Merger
