...
############################# Head ############################
head_title: "Divida TEX em vários arquivos em C#"
...
############################# Header ############################
title: "TEX Divisor em C#"
description: "Divida TEX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo TEX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo TEX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos TEX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo TEX usando a API GroupDocs.Merger
