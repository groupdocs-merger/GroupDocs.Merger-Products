...
############################# Head ############################
head_title: "Splits ODS in meerdere bestanden in C#"
...
############################# Header ############################
title: "ODS Splitter in C#"
description: "Splits ODS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits ODS Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel ODS bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODS bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits ODS bestand met behulp van GroupDocs.Merger API
