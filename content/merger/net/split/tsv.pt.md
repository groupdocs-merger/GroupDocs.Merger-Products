...
############################# Head ############################
head_title: "Divida TSV em vários arquivos em C#"
...
############################# Header ############################
title: "TSV Divisor em C#"
description: "Divida TSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo TSV em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo TSV em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos TSV usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo TSV usando a API GroupDocs.Merger
