...
############################# Head ############################
head_title: "Padalinkite EPUB į kelis failus C#"
...
############################# Header ############################
title: "EPUB skirstytuvas C#"
description: "Padalinkite EPUB keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite EPUB failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną EPUB failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti EPUB failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite EPUB failą naudodami GroupDocs.Merger API
