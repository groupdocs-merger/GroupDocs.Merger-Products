...
############################# Head ############################
head_title: "Dividi XLT in più file in C#"
...
############################# Header ############################
title: "XLT Separatore in C#"
description: "Dividi XLT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLT utilizzando l'API GroupDocs.Merger
