...
############################# Head ############################
head_title: "Împărțiți VSX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VSX în C#"
description: "Împărțiți VSX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VSX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VSX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VSX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VSX utilizând API-ul GroupDocs.Merger
