...
############################# Head ############################
head_title: "Verdeel XLS in veelvuldige lêers in C#"
...
############################# Header ############################
title: "XLS Splitter in C#"
description: "Verdeel XLS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLS lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLS lêer deur GroupDocs.Merger API te gebruik
