...
############################# Head ############################
head_title: "VSDM کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "VSDM سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ VSDM کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "VSDM فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک VSDM فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے VSDM فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے VSDM فائل کو تقسیم کریں۔
