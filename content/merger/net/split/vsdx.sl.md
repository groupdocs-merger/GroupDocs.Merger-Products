...
############################# Head ############################
head_title: "Razdeli VSDX na več datotek v C#"
...
############################# Header ############################
title: "VSDX razdelilnik v C#"
description: "Razdelite VSDX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSDX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSDX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSDX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSDX z API-jem GroupDocs.Merger
