...
############################# Head ############################
head_title: "Opdel VSDM i flere filer i C#"
...
############################# Header ############################
title: "VSDM Splitter i C#"
description: "Opdel VSDM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSDM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSDM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSDM fil ved hjælp af GroupDocs.Merger API
