...
############################# Head ############################
head_title: "Podziel XLS na wiele plików w C#"
...
############################# Header ############################
title: "XLS Rozdzielacz w C#"
description: "Podziel XLS z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XLS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XLS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XLS przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XLS za pomocą GroupDocs.Merger API
