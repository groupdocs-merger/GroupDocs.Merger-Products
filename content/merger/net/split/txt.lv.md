...
############################# Head ############################
head_title: "Sadaliet TXT vairākos failos programmā C#"
...
############################# Header ############################
title: "TXT sadalītājs programmā C#"
description: "Sadaliet TXT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TXT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu TXT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TXT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet TXT failu, izmantojot GroupDocs.Merger API
