...
############################# Head ############################
head_title: "Opdel CSV i flere filer i C#"
...
description: "Opdel CSV med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel CSV filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt CSV-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles CSV filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel CSV fil ved hjælp af GroupDocs.Merger API
