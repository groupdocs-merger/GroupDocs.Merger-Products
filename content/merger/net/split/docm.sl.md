...
############################# Head ############################
head_title: "Razdeli DOCM na več datotek v C#"
...
############################# Header ############################
title: "DOCM razdelilnik v C#"
description: "Razdelite DOCM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOCM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOCM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOCM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOCM z API-jem GroupDocs.Merger
