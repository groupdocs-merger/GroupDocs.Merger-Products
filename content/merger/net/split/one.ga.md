...
############################# Head ############################
head_title: "Scoilt ONE ina Ilchomhaid i C#"
...
############################# Header ############################
title: "ONE Scoilteoir i C#"
description: "Scoilt ONE le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt ONE Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin ONE a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid ONE a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt ONE comhad ag baint úsáide as GroupDocs.Merger API
