...
############################# Head ############################
head_title: "Teilen Sie DOTM in mehrere Dateien in C#"
...
############################# Header ############################
title: "DOTM Splittereingang C#"
description: "Teilen Sie DOTM mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie DOTM Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne DOTM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie DOTM-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die DOTM-Datei mithilfe der GroupDocs.Merger-API
