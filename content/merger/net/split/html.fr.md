...
############################# Head ############################
head_title: "Divisez les documents HTML dans les applications .NET"
head_description: "Utilisez GroupDocs.Merger for .NET pour diviser des fichiers HTML en documents individuels. Gérez efficacement les fichiers PDF, Word, Excel, PowerPoint, Visio, images, archives et plus encore."

############################# Header ############################
title: "Divisez les fichiers HTML" 
description: "GroupDocs.Merger for .NET améliore les applications .NET avec des fonctionnalités avancées de traitement de documents. Divisez facilement les fichiers HTML et travaillez avec divers formats commerciaux populaires."
...
steps:
    enable: true
    title: "Comment diviser les fichiers HTML"
    content: |
      Avec [GroupDocs.Merger](/merger/net/), vous pouvez diviser des documents HTML et enregistrer les pages sélectionnées sous un nouveau fichier. Améliorez le traitement des documents dans vos applications .NET.
      
      1. Spécifiez le chemin source du fichier HTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Divisez un document HTML et enregistrez les pages paires"
      content: |
        Cet exemple montre comment diviser un document HTML et enregistrer toutes les pages paires en tant que fichier séparé.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
