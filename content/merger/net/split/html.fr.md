...
############################# Head ############################
head_title: "Divisez HTML en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "HTML Séparateur dans C#"
description: "Divisez HTML avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner HTML pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier HTML en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers HTML à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier HTML à l'aide de l'API GroupDocs.Merger
