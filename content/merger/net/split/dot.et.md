...
############################# Head ############################
head_title: "Jagage DOT mitmeks failiks rakenduses C#"
...
description: "Tükeldage DOT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks DOT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada DOT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail DOT, kasutades GroupDocs.Merger API-t
