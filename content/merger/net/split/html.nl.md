...
############################# Head ############################
head_title: "Splits HTML in meerdere bestanden in C#"
...
description: "Splits HTML met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits HTML Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel HTML bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe HTML bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits HTML bestand met behulp van GroupDocs.Merger API
