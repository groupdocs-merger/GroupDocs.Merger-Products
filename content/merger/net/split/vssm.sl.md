...
############################# Head ############################
head_title: "Razdeli VSSM na več datotek v C#"
...
############################# Header ############################
title: "VSSM razdelilnik v C#"
description: "Razdelite VSSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSSM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSSM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSSM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSSM z API-jem GroupDocs.Merger
