...
############################# Head ############################
head_title: "Opdel TXT i flere filer i C#"
...
description: "Opdel TXT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel TXT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt TXT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles TXT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel TXT fil ved hjælp af GroupDocs.Merger API
