...
############################# Head ############################
head_title: "Split XLT into Multiple Files in C#"
head_description: "Split a single XLT file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "XLT Splitter In C#"
description: "Split XLT with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single XLT file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split XLT files using C# example code">}}
