...
############################# Head ############################
head_title: "Разделете XLT на няколко файла в C#"
...
############################# Header ############################
title: "XLT Сплитер в C#"
description: "Разделете XLT с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разделете XLT файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разделят един файл XLT на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделяте XLT файлове с помощта на C# примерен код">}}

        ```csharp    
        // Разделете файла XLT с помощта на API на GroupDocs.Merger
