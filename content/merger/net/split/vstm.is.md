...
############################# Head ############################
head_title: "Skiptu VSTM í margar skrár í C#"
...
############################# Header ############################
title: "VSTM Skerandi í C#"
description: "Skiptu VSTM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSTM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSTM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSTM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSTM skrá með GroupDocs.Merger API
