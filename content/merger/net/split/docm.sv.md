...
############################# Head ############################
head_title: "Dela upp DOCM i flera filer i C#"
...
description: "Dela upp DOCM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOCM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda DOCM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOCM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela DOCM-fil med GroupDocs.Merger API
