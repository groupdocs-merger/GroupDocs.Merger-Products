...
############################# Head ############################
head_title: "Împărțiți TXT în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter TXT în C#"
description: "Împărțiți TXT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere TXT în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier TXT în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere TXT folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul TXT utilizând API-ul GroupDocs.Merger
