...
############################# Head ############################
head_title: "Verdeel RTF in veelvuldige lêers in C#"
...
############################# Header ############################
title: "RTF Splitter in C#"
description: "Verdeel RTF met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel RTF lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele RTF-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om RTF lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel RTF lêer deur GroupDocs.Merger API te gebruik
