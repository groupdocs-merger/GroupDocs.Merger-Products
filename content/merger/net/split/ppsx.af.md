...
############################# Head ############################
head_title: "Verdeel PPSX in veelvuldige lêers in C#"
...
############################# Header ############################
title: "PPSX Splitter in C#"
description: "Verdeel PPSX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPSX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele PPSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPSX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel PPSX lêer deur GroupDocs.Merger API te gebruik
