...
############################# Head ############################
head_title: "Opdel OTP i flere filer i C#"
...
############################# Header ############################
title: "OTP Splitter i C#"
description: "Opdel OTP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt OTP-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles OTP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel OTP fil ved hjælp af GroupDocs.Merger API
