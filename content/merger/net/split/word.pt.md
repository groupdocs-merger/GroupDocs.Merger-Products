...
############################# Head ############################
head_title: "Divida documentos WORD em aplicativos .NET"
head_description: "Use GroupDocs.Merger for .NET para dividir arquivos WORD em documentos separados. Gerencie PDFs, arquivos do Word, planilhas do Excel, slides do PowerPoint, arquivos do Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Divida arquivos WORD" 
description: "GroupDocs.Merger for .NET aprimora aplicativos .NET com recursos avançados de processamento de documentos. Divida arquivos WORD e trabalhe com vários formatos de negócios populares."
...
steps:
    enable: true
    title: "Como dividir arquivos WORD"
    content: |
      Com [GroupDocs.Merger](/merger/net/), você pode dividir documentos WORD e salvar páginas selecionadas como um novo arquivo. Melhore o processamento de documentos em seus aplicativos .NET.
      
      1. Especifique o caminho do arquivo WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Dividir documento WORD e salvar páginas em números pares"
      content: |
        Este exemplo mostra como dividir um documento WORD e salvar todas as páginas em números pares como um arquivo separado.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
