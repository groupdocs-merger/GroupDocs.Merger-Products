...
############################# Head ############################
head_title: "Verdeel XLSX in veelvuldige lêers in C#"
...
description: "Verdeel XLSX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLSX lêer deur GroupDocs.Merger API te gebruik
