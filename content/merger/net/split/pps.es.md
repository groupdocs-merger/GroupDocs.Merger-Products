...
############################# Head ############################
head_title: "Dividir PPS en varios archivos en C#"
...
############################# Header ############################
title: "PPS Divisor en C#"
description: "Divida PPS con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir PPS páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo PPS en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos PPS usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo PPS usando GroupDocs.Merger API
