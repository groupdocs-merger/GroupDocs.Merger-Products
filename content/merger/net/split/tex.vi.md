...
############################# Head ############################
head_title: "Tách TEX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "TEX Splitter trong C#"
description: "Tách TEX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp TEX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp TEX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp TEX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp TEX bằng API GroupDocs.Merger
