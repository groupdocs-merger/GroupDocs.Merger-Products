...
############################# Head ############################
head_title: "Jagage VSDX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSDX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSDX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSDX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSDX, kasutades GroupDocs.Merger API-t
