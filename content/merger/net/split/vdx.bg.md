...
############################# Head ############################
head_title: "Split VDX into Multiple Files in C#"
head_description: "Split a single VDX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "VDX Splitter In C#"
description: "Split VDX with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single VDX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VDX files using C# example code">}}
