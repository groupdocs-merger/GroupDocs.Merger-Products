...
############################# Head ############################
head_title: "XLSX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLSX Ayırıcı C#"
description: "XLSX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLSX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSX dosyasını ayırın
