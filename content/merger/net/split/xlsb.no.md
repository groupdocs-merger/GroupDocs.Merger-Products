...
############################# Head ############################
head_title: "Del XLSB i flere filer i C#"
...
description: "Del XLSB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLSB-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLSB filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLSB-filen ved hjelp av GroupDocs.Merger API
