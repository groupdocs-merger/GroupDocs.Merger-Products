...
############################# Head ############################
head_title: "تقسيم XLSX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "XLSX الفاصل في C#"
description: "قسِّم XLSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات XLSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد XLSX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات XLSX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف XLSX باستخدام GroupDocs.Merger API
