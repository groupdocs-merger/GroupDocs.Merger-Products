...
############################# Head ############################
head_title: "Dividir XPS en varios archivos en C#"
...
############################# Header ############################
title: "XPS Divisor en C#"
description: "Divida XPS con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XPS páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XPS en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XPS usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XPS usando GroupDocs.Merger API
