...
############################# Head ############################
head_title: "Divisez VSDX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSDX Séparateur dans C#"
description: "Divisez VSDX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSDX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSDX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSDX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSDX à l'aide de l'API GroupDocs.Merger
