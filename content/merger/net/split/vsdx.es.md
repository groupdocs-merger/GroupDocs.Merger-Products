...
############################# Head ############################
head_title: "Dividir VSDX en varios archivos en C#"
...
############################# Header ############################
title: "VSDX Divisor en C#"
description: "Divida VSDX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VSDX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VSDX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VSDX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VSDX usando GroupDocs.Merger API
