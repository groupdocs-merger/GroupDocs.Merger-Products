...
############################# Head ############################
head_title: "Podziel TSV na wiele plików w C#"
...
############################# Header ############################
title: "TSV Rozdzielacz w C#"
description: "Podziel TSV z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików TSV w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku TSV na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki TSV przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik TSV za pomocą GroupDocs.Merger API
