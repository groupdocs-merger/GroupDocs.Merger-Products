...
############################# Head ############################
head_title: "Divida XLS em vários arquivos em C#"
...
############################# Header ############################
title: "XLS Divisor em C#"
description: "Divida XLS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLS em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLS usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLS usando a API GroupDocs.Merger
