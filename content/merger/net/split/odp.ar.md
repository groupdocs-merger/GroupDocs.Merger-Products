...
############################# Head ############################
head_title: "تقسيم ODP إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "ODP الفاصل في C#"
description: "قسِّم ODP ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات ODP في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد ODP إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات ODP باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف ODP باستخدام GroupDocs.Merger API
