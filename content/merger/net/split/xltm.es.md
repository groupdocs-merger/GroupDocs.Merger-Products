...
############################# Head ############################
head_title: "Dividir XLTM en varios archivos en C#"
...
############################# Header ############################
title: "XLTM Divisor en C#"
description: "Divida XLTM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLTM páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLTM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLTM usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLTM usando GroupDocs.Merger API
