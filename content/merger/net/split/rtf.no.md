...
############################# Head ############################
head_title: "Del RTF i flere filer i C#"
...
description: "Del RTF med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del RTF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt RTF-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp RTF filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del RTF-filen ved hjelp av GroupDocs.Merger API
