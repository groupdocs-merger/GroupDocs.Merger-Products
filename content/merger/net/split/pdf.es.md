...
############################# Head ############################
head_title: "Dividir PDF en varios archivos en C#"
head_description: "Divida un solo archivo PDF en varios archivos según los números de página, los intervalos de página, las páginas pares o impares mediante la API de fusión de documentos."

############################# Header ############################
title: "PDF Divisor en C#"
description: "Divida PDF con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir PDF páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo PDF en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos PDF usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo PDF usando GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demostraciones en vivo: dividir PDF archivo en línea"
    content: |
       Divida el archivo PDF ahora mismo visitando el sitio web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
