...
############################# Head ############################
head_title: "Dividi ODP in più file in C#"
...
############################# Header ############################
title: "ODP Separatore in C#"
description: "Dividi ODP con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file ODP in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file ODP in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file ODP utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file ODP utilizzando l'API GroupDocs.Merger
