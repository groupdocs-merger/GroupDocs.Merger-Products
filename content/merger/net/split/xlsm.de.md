...
############################# Head ############################
head_title: "Teilen Sie XLSM in mehrere Dateien in C#"
...
############################# Header ############################
title: "XLSM Splittereingang C#"
description: "Teilen Sie XLSM mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie XLSM Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne XLSM-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie XLSM-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die XLSM-Datei mithilfe der GroupDocs.Merger-API
