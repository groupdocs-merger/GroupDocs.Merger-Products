...
############################# Head ############################
head_title: "Del OTT i flere filer i C#"
...
description: "Del OTT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt OTT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp OTT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del OTT-filen ved hjelp av GroupDocs.Merger API
