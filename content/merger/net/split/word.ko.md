...
steps:
    enable: true
    title_left: ".NET의 WORD 파일 페이지 분할"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 WORD 파일을 분할하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 WORD 파일 분할
