...
############################# Head ############################
head_title: "Jagage VSTM mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSTM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSTM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSTM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSTM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSTM, kasutades GroupDocs.Merger API-t
