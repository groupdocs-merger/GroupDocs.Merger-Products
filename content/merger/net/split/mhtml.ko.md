...
############################# Head ############################
head_title: "C#에서 MHTML을(를) 여러 파일로 분할"
head_description: "문서 병합 API를 사용하여 단일 MHTML 파일을 페이지 번호, 페이지 간격, 짝수 또는 홀수 페이지에 따라 여러 파일로 분할합니다."

############################# Header ############################
title: "MHTML C#의 스플리터"
description: "몇 줄의 .NET 코드로 MHTML를 나눕니다."
...
steps:
    enable: true
    title_left: ".NET의 MHTML 파일 페이지 분할"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 MHTML 파일을 분할하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 MHTML 파일 분할
