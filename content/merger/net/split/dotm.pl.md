...
############################# Head ############################
head_title: "Podziel DOTM na wiele plików w C#"
...
############################# Header ############################
title: "DOTM Rozdzielacz w C#"
description: "Podziel DOTM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOTM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOTM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOTM za pomocą GroupDocs.Merger API
