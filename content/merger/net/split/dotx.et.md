...
############################# Head ############################
head_title: "Jagage DOTX mitmeks failiks rakenduses C#"
...
description: "Tükeldage DOTX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks DOTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada DOTX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail DOTX, kasutades GroupDocs.Merger API-t
