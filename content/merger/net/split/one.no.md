...
############################# Head ############################
head_title: "Del ONE i flere filer i C#"
...
############################# Header ############################
title: "ONE splitter i C#"
description: "Del ONE med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt ONE-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp ONE filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del ONE-filen ved hjelp av GroupDocs.Merger API
