...
############################# Head ############################
head_title: "Scoilt XLTX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLTX Scoilteoir i C#"
description: "Scoilt XLTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLTX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLTX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLTX comhad ag baint úsáide as GroupDocs.Merger API
