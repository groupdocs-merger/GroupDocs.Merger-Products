...
############################# Head ############################
head_title: "Podijeli DOT u više datoteka u C#"
...
############################# Header ############################
title: "DOT Splitter u C#"
description: "Podijelite DOT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOT datoteku pomoću API-ja GroupDocs.Merger
