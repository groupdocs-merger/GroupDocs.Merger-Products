...
############################# Head ############################
head_title: "Jaa OTT useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "OTT Jakaja sisään C#"
description: "Jaa OTT muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa OTT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden OTT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa OTT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto OTT GroupDocs.Merger API:lla
