...
############################# Head ############################
head_title: "Splits OTP in meerdere bestanden in C#"
...
description: "Splits OTP met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits OTP Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel OTP bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTP bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits OTP bestand met behulp van GroupDocs.Merger API
