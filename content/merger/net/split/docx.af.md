...
############################# Head ############################
head_title: "Verdeel DOCX in veelvuldige lêers in C#"
...
description: "Verdeel DOCX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOCX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele DOCX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel DOCX lêer deur GroupDocs.Merger API te gebruik
