...
############################# Head ############################
head_title: "Rozdeliť ODT do viacerých súborov v C#"
...
############################# Header ############################
title: "ODT Splitter v C#"
description: "Rozdeľte ODT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť ODT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor ODT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ODT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor ODT pomocou rozhrania GroupDocs.Merger API
