...
############################# Head ############################
head_title: "Del MHTML i flere filer i C#"
...
description: "Del MHTML med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del MHTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt MHTML-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp MHTML filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del MHTML-filen ved hjelp av GroupDocs.Merger API
