...
############################# Head ############################
head_title: "Splits PPSX in meerdere bestanden in C#"
...
description: "Splits PPSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits PPSX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel PPSX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPSX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits PPSX bestand met behulp van GroupDocs.Merger API
