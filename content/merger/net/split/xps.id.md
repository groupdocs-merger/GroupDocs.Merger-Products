...
############################# Head ############################
head_title: "Pisahkan dokumen XPS dalam aplikasi .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk memisahkan file XPS menjadi dokumen terpisah. Kelola file PDF, dokumen Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pisahkan file XPS" 
description: "GroupDocs.Merger for .NET meningkatkan aplikasi .NET dengan fitur pemrosesan dokumen canggih. Pisahkan file XPS dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memisahkan file XPS"
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), Anda dapat memisahkan dokumen XPS dan menyimpan halaman yang dipilih sebagai file baru. Tingkatkan pemrosesan dokumen dalam aplikasi .NET Anda.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pisahkan dokumen XPS dan simpan halaman genap"
      content: |
        Contoh ini menunjukkan cara memisahkan dokumen XPS dan menyimpan semua halaman genap sebagai file terpisah.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
