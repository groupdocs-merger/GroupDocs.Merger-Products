...
############################# Head ############################
head_title: "Pisahkan VSDX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSDX Pemisah Dalam C#"
description: "Pisahkan VSDX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSDX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSDX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSDX menggunakan API GroupDocs.Merger
