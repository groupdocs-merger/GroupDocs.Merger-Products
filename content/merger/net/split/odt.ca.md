...
############################# Head ############################
head_title: "Dividiu ODT en diversos fitxers a C#"
...
############################# Header ############################
title: "ODT Divisor a C#"
description: "Dividiu ODT amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers ODT a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer ODT en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers ODT utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer ODT mitjançant l'API de GroupDocs.Merger
