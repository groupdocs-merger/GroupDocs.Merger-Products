...
############################# Head ############################
head_title: "Dividi TEX in più file in C#"
...
############################# Header ############################
title: "TEX Separatore in C#"
description: "Dividi TEX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file TEX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file TEX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file TEX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file TEX utilizzando l'API GroupDocs.Merger
