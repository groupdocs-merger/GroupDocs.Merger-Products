...
############################# Head ############################
head_title: "Razdeli EPUB na več datotek v C#"
...
############################# Header ############################
title: "EPUB razdelilnik v C#"
description: "Razdelite EPUB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli EPUB strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke EPUB na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke EPUB s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko EPUB z API-jem GroupDocs.Merger
