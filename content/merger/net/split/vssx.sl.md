...
############################# Head ############################
head_title: "Razdeli VSSX na več datotek v C#"
...
############################# Header ############################
title: "VSSX razdelilnik v C#"
description: "Razdelite VSSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSSX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSSX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSSX z API-jem GroupDocs.Merger
