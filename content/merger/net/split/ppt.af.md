...
############################# Head ############################
head_title: "Verdeel PPT in veelvuldige lêers in C#"
...
description: "Verdeel PPT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele PPT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel PPT lêer deur GroupDocs.Merger API te gebruik
