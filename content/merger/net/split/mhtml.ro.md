...
############################# Head ############################
head_title: "Împărțiți MHTML în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter MHTML în C#"
description: "Împărțiți MHTML cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere MHTML în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier MHTML în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere MHTML folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul MHTML utilizând API-ul GroupDocs.Merger
