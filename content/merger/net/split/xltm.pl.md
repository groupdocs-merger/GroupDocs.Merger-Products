...
############################# Head ############################
head_title: "Podziel XLTM na wiele plików w C#"
...
############################# Header ############################
title: "XLTM Rozdzielacz w C#"
description: "Podziel XLTM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XLTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XLTM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XLTM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XLTM za pomocą GroupDocs.Merger API
