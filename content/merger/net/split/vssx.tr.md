...
############################# Head ############################
head_title: "VSSX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSSX Ayırıcı C#"
description: "VSSX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSSX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSSX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSSX dosyasını ayırın
