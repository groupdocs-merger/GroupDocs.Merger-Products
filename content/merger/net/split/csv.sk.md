...
############################# Head ############################
head_title: "Rozdeliť CSV do viacerých súborov v C#"
...
description: "Rozdeľte CSV niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť CSV strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor CSV na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť CSV súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor CSV pomocou rozhrania GroupDocs.Merger API
