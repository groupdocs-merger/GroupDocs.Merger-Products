...
############################# Head ############################
head_title: "Skiptu VTX í margar skrár í C#"
...
############################# Header ############################
title: "VTX Skerandi í C#"
description: "Skiptu VTX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VTX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VTX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VTX skrá með GroupDocs.Merger API
