...
############################# Head ############################
head_title: "Scoilt ODP ina Ilchomhaid i C#"
...
############################# Header ############################
title: "ODP Scoilteoir i C#"
description: "Scoilt ODP le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt ODP Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin ODP a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid ODP a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt ODP comhad ag baint úsáide as GroupDocs.Merger API
