...
############################# Head ############################
head_title: "Divida VTX em vários arquivos em C#"
...
############################# Header ############################
title: "VTX Divisor em C#"
description: "Divida VTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VTX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VTX usando a API GroupDocs.Merger
