...
############################# Head ############################
head_title: "Разделить DOTX на несколько файлов на C#"
...
############################# Header ############################
title: "DOTX Разделитель на C#"
description: "Разделите DOTX страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Разделить страницы DOTX документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко разделить один файл DOTX на несколько результирующих файлов, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файлы DOTX, используя пример кода C#">}}

        ```csharp    
        // Разделить файл DOTX с помощью GroupDocs.Merger API
