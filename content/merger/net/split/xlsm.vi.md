...
############################# Head ############################
head_title: "Tách XLSM thành nhiều tệp trong C#"
...
############################# Header ############################
title: "XLSM Splitter trong C#"
description: "Tách XLSM bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp XLSM trong .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp XLSM bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp XLSM bằng API GroupDocs.Merger
