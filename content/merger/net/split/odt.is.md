...
############################# Head ############################
head_title: "Skiptu ODT í margar skrár í C#"
...
############################# Header ############################
title: "ODT Skerandi í C#"
description: "Skiptu ODT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni ODT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu ODT skrá með GroupDocs.Merger API
