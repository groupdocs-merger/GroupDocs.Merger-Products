...
############################# Head ############################
head_title: "VSSM کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "VSSM سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ VSSM کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "VSSM فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک VSSM فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے VSSM فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے VSSM فائل کو تقسیم کریں۔
