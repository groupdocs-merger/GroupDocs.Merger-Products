...
head_title: "Pisahkan DOTX menjadi Beberapa File di C# .NET"
head_description: "Pengguna C# .NET untuk membagi satu file DOTX menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Pisahkan DOTX Menjadi Beberapa File di .NET"
description: "Pisahkan satu file DOTX menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Pisahkan Halaman File DOTX di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk membagi satu file DOTX menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan File DOTX Online"
    content: |
        Pisahkan file DOTX sekarang dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/DOTX).
