...
############################# Head ############################
head_title: "Opdel DOCM i flere filer i C#"
...
############################# Header ############################
title: "DOCM Splitter i C#"
description: "Opdel DOCM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOCM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOCM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOCM fil ved hjælp af GroupDocs.Merger API
