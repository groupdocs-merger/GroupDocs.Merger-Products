...
############################# Head ############################
head_title: "Opdel VSSX i flere filer i C#"
...
description: "Opdel VSSX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSSX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSSX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSSX fil ved hjælp af GroupDocs.Merger API
