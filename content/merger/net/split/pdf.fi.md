...
############################# Head ############################
head_title: "Jaa PDF useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "PDF Jakaja sisään C#"
description: "Jaa PDF muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa PDF tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden PDF-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PDF tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto PDF GroupDocs.Merger API:lla
