...
############################# Head ############################
head_title: "Dividi PPT in più file in C#"
...
############################# Header ############################
title: "PPT Separatore in C#"
description: "Dividi PPT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file PPT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file PPT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file PPT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file PPT utilizzando l'API GroupDocs.Merger
