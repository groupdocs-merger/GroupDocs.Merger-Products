...
############################# Head ############################
head_title: "Dela upp DOTM i flera filer i C#"
...
description: "Dela upp DOTM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda DOTM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOTM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela DOTM-fil med GroupDocs.Merger API
