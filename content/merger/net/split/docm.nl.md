...
############################# Head ############################
head_title: "Splits DOCM in meerdere bestanden in C#"
...
############################# Header ############################
title: "DOCM Splitter in C#"
description: "Splits DOCM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOCM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOCM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOCM bestand met behulp van GroupDocs.Merger API
