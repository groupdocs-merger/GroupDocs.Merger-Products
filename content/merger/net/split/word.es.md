...
############################# Head ############################
head_title: "Dividir WORD en varios archivos en C#"
...
############################# Header ############################
title: "WORD Divisor en C#"
description: "Divida WORD con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir WORD páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo WORD en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos WORD usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo WORD usando GroupDocs.Merger API
