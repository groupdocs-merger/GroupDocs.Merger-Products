...
############################# Head ############################
head_title: "Împărțiți OTP în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter OTP în C#"
description: "Împărțiți OTP cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere OTP în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier OTP în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere OTP folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul OTP utilizând API-ul GroupDocs.Merger
