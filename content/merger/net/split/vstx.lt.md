...
############################# Head ############################
head_title: "Padalinkite VSTX į kelis failus C#"
...
############################# Header ############################
title: "VSTX skirstytuvas C#"
description: "Padalinkite VSTX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSTX failą naudodami GroupDocs.Merger API
