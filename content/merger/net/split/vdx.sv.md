...
############################# Head ############################
head_title: "Dela upp VDX i flera filer i C#"
...
description: "Dela upp VDX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VDX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VDX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VDX-fil med GroupDocs.Merger API
