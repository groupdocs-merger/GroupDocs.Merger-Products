...
############################# Head ############################
head_title: "Împărțiți VDX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VDX în C#"
description: "Împărțiți VDX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VDX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VDX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VDX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VDX utilizând API-ul GroupDocs.Merger
