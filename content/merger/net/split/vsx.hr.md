...
############################# Head ############################
head_title: "Podijeli VSX u više datoteka u C#"
...
############################# Header ############################
title: "VSX Splitter u C#"
description: "Podijelite VSX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSX datoteku pomoću API-ja GroupDocs.Merger
