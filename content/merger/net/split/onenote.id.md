...
############################# Head ############################
head_title: "Pisahkan ONENOTE menjadi Beberapa File di C#"
...
############################# Header ############################
title: "ONENOTE Pemisah Di C#"
description: "Pisahkan ONENOTE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan ONENOTE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file ONENOTE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file ONENOTE menggunakan kode contoh C#">}}
