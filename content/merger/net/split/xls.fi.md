...
############################# Head ############################
head_title: "Jaa XLS useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLS Jakaja sisään C#"
description: "Jaa XLS muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLS GroupDocs.Merger API:lla
