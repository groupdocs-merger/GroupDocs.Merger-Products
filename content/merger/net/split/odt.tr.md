...
############################# Head ############################
head_title: "ODT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "ODT Ayırıcı C#"
description: "ODT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODT dosyasını ayırın
