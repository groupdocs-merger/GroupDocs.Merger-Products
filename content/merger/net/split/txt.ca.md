...
############################# Head ############################
head_title: "Dividiu TXT en diversos fitxers a C#"
...
############################# Header ############################
title: "TXT Divisor a C#"
description: "Dividiu TXT amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers TXT a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer TXT en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers TXT utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer TXT mitjançant l'API de GroupDocs.Merger
