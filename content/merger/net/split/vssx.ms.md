...
############################# Head ############################
head_title: "Pisahkan VSSX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSSX Pemisah Dalam C#"
description: "Pisahkan VSSX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSSX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSSX menggunakan API GroupDocs.Merger
