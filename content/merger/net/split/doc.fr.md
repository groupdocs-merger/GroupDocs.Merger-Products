...
############################# Head ############################
head_title: "Divisez DOC en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOC Séparateur dans C#"
description: "Divisez DOC avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOC pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOC en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOC à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOC à l'aide de l'API GroupDocs.Merger
