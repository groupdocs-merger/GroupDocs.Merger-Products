...
############################# Head ############################
head_title: "Scoilt DOTX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOTX Scoilteoir i C#"
description: "Scoilt DOTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOTX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOTX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOTX comhad ag baint úsáide as GroupDocs.Merger API
