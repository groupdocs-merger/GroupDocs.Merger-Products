...
############################# Head ############################
head_title: "تقسيم RTF إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "RTF الفاصل في C#"
description: "قسِّم RTF ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات RTF في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد RTF إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات RTF باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف RTF باستخدام GroupDocs.Merger API
