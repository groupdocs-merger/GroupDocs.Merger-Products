...
############################# Head ############################
head_title: "Verdeel VDX in veelvuldige lêers in C#"
...
description: "Verdeel VDX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VDX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VDX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VDX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VDX lêer deur GroupDocs.Merger API te gebruik
