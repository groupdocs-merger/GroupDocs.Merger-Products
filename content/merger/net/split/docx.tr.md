...
############################# Head ############################
head_title: "DOCX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOCX Ayırıcı C#"
description: "DOCX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOCX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOCX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOCX dosyasını ayırın
