...
############################# Head ############################
head_title: "Padalinkite ODP į kelis failus C#"
...
############################# Header ############################
title: "ODP skirstytuvas C#"
description: "Padalinkite ODP keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ODP failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną ODP failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ODP failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite ODP failą naudodami GroupDocs.Merger API
