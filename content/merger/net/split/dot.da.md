...
############################# Head ############################
head_title: "Opdel DOT i flere filer i C#"
...
description: "Opdel DOT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOT fil ved hjælp af GroupDocs.Merger API
