...
############################# Head ############################
head_title: "Pisahkan VISIO menjadi Beberapa File di C#"
...
############################# Header ############################
title: "VISIO Pemisah Di C#"
description: "Pisahkan VISIO dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VISIO Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file VISIO menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file VISIO menggunakan kode contoh C#">}}
