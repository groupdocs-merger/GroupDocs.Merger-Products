...
############################# Head ############################
head_title: "Skiptu XLTX í margar skrár í C#"
...
############################# Header ############################
title: "XLTX Skerandi í C#"
description: "Skiptu XLTX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLTX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLTX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLTX skrá með GroupDocs.Merger API
