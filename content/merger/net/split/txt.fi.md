...
############################# Head ############################
head_title: "Jaa TXT useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "TXT Jakaja sisään C#"
description: "Jaa TXT muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa TXT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden TXT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TXT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto TXT GroupDocs.Merger API:lla
