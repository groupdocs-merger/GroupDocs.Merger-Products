...
############################# Head ############################
head_title: "Jaa VTX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VTX Jakaja sisään C#"
description: "Jaa VTX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VTX GroupDocs.Merger API:lla
