...
############################# Head ############################
head_title: "Podijeli CSV u više datoteka u C#"
...
############################# Header ############################
title: "CSV Splitter u C#"
description: "Podijelite CSV s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli CSV stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne CSV datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti CSV datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli CSV datoteku pomoću API-ja GroupDocs.Merger
