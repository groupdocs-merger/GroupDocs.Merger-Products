...
############################# Head ############################
head_title: "Dividir OTP en varios archivos en C#"
...
############################# Header ############################
title: "OTP Divisor en C#"
description: "Divida OTP con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir OTP páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo OTP en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos OTP usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo OTP usando GroupDocs.Merger API
