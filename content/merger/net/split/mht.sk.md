...
############################# Head ############################
head_title: "Rozdeliť MHT do viacerých súborov v C#"
...
description: "Rozdeľte MHT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť MHT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor MHT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť MHT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor MHT pomocou rozhrania GroupDocs.Merger API
