...
############################# Head ############################
head_title: "Divida XLTM em vários arquivos em C#"
...
############################# Header ############################
title: "XLTM Divisor em C#"
description: "Divida XLTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLTM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLTM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLTM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLTM usando a API GroupDocs.Merger
