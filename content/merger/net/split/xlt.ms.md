...
############################# Head ############################
head_title: "Pisahkan XLT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLT Pemisah Dalam C#"
description: "Pisahkan XLT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLT menggunakan API GroupDocs.Merger
