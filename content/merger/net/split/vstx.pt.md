...
############################# Head ############################
head_title: "Divida VSTX em vários arquivos em C#"
...
############################# Header ############################
title: "VSTX Divisor em C#"
description: "Divida VSTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSTX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSTX usando a API GroupDocs.Merger
