...
############################# Head ############################
head_title: "Jaa XLSX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLSX Jakaja sisään C#"
description: "Jaa XLSX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLSX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLSX GroupDocs.Merger API:lla
