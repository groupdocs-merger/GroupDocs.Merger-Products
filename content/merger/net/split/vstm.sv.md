...
############################# Head ############################
head_title: "Dela upp VSTM i flera filer i C#"
...
############################# Header ############################
title: "VSTM splitter i C#"
description: "Dela upp VSTM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSTM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSTM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSTM-fil med GroupDocs.Merger API
