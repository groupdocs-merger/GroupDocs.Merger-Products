...
############################# Head ############################
head_title: "Scoilt VSDX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSDX Scoilteoir i C#"
description: "Scoilt VSDX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSDX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSDX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSDX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSDX comhad ag baint úsáide as GroupDocs.Merger API
