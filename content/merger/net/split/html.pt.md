...
############################# Head ############################
head_title: "Divida HTML em vários arquivos em C#"
...
############################# Header ############################
title: "HTML Divisor em C#"
description: "Divida HTML com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo HTML em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo HTML em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos HTML usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo HTML usando a API GroupDocs.Merger
