...
############################# Head ############################
head_title: "Jagage XPS mitmeks failiks rakenduses C#"
...
description: "Tükeldage XPS mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XPS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XPS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XPS, kasutades GroupDocs.Merger API-t
