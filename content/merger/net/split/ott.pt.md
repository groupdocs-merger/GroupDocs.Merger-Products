...
############################# Head ############################
head_title: "Divida OTT em vários arquivos em C#"
...
############################# Header ############################
title: "OTT Divisor em C#"
description: "Divida OTT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo OTT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo OTT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos OTT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo OTT usando a API GroupDocs.Merger
