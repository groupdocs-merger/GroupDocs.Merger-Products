...
############################# Head ############################
head_title: "Opdel VSDX i flere filer i C#"
...
description: "Opdel VSDX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VSDX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VSDX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VSDX fil ved hjælp af GroupDocs.Merger API
