...
############################# Head ############################
head_title: "Divisez WORKSHEET en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "WORKSHEET Séparateur dans C#"
description: "Divisez WORKSHEET avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner WORKSHEET pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier WORKSHEET en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers WORKSHEET à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier WORKSHEET à l'aide de l'API GroupDocs.Merger
