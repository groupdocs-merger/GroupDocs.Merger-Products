...
############################# Head ############################
head_title: "Podziel PPT na wiele plików w C#"
...
############################# Header ############################
title: "PPT Rozdzielacz w C#"
description: "Podziel PPT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików PPT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku PPT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki PPT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik PPT za pomocą GroupDocs.Merger API
