...
############################# Head ############################
head_title: "Splits CSV in meerdere bestanden in C#"
...
description: "Splits CSV met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits CSV Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel CSV bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe CSV bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits CSV bestand met behulp van GroupDocs.Merger API
