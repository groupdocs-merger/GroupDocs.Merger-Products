...
############################# Head ############################
head_title: "Verdeel PPTX in veelvuldige lêers in C#"
...
description: "Verdeel PPTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPTX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele PPTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPTX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel PPTX lêer deur GroupDocs.Merger API te gebruik
