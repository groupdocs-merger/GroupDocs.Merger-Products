...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/th/merger/net/) ช่วยให้นักพัฒนา C# แยกไฟล์ DOC ไฟล์เดียวออกเป็นไฟล์ผลลัพธ์ได้หลายไฟล์โดยใช้ ไม่กี่ขั้นตอนง่ายๆ
    ...
    code: |
     ...
     {{< merger/code-merger title="วิธีแยกไฟล์ DOC ไฟล์โดยใช้โค้ดตัวอย่าง C#">}}

        ```csharp    
        // แยกไฟล์ DOC โดยใช้ GroupDocs.Merger API
