...
############################# Head ############################
head_title: "Opdel ODP i flere filer i C#"
...
description: "Opdel ODP med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt ODP-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ODP filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel ODP fil ved hjælp af GroupDocs.Merger API
