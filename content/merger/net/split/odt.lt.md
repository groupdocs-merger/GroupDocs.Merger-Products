...
############################# Head ############################
head_title: "Padalinkite ODT į kelis failus C#"
...
############################# Header ############################
title: "ODT skirstytuvas C#"
description: "Padalinkite ODT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ODT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną ODT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ODT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite ODT failą naudodami GroupDocs.Merger API
