...
############################# Head ############################
head_title: "Padalinkite HTML į kelis failus C#"
...
############################# Header ############################
title: "HTML skirstytuvas C#"
description: "Padalinkite HTML keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite HTML failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną HTML failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti HTML failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite HTML failą naudodami GroupDocs.Merger API
