...
############################# Head ############################
head_title: "Podziel RTF na wiele plików w C#"
...
############################# Header ############################
title: "RTF Rozdzielacz w C#"
description: "Podziel RTF z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików RTF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku RTF na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki RTF przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik RTF za pomocą GroupDocs.Merger API
