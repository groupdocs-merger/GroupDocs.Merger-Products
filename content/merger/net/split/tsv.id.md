...
############################# Head ############################
head_title: "Pisahkan TSV menjadi Beberapa File di C#"
...
############################# Header ############################
title: "TSV Pemisah Di C#"
description: "Pisahkan TSV dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan TSV Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file TSV menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file TSV menggunakan kode contoh C#">}}
