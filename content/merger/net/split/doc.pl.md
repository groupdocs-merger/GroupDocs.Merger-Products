...
############################# Head ############################
head_title: "Podziel DOC na wiele plików w C#"
...
############################# Header ############################
title: "DOC Rozdzielacz w C#"
description: "Podziel DOC z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOC w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOC na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOC przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOC za pomocą GroupDocs.Merger API
