...
############################# Head ############################
head_title: "Sadaliet DOTM vairākos failos programmā C#"
...
############################# Header ############################
title: "DOTM sadalītājs programmā C#"
description: "Sadaliet DOTM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu DOTM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOTM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet DOTM failu, izmantojot GroupDocs.Merger API
