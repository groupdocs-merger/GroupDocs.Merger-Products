...
############################# Head ############################
head_title: "Divisez VTX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VTX Séparateur dans C#"
description: "Divisez VTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VTX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VTX à l'aide de l'API GroupDocs.Merger
