...
############################# Head ############################
head_title: "Del DOCX i flere filer i C#"
...
description: "Del DOCX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt DOCX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOCX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del DOCX-filen ved hjelp av GroupDocs.Merger API
