...
############################# Head ############################
head_title: "Opdel HTML i flere filer i C#"
...
description: "Opdel HTML med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel HTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt HTML-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles HTML filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel HTML fil ved hjælp af GroupDocs.Merger API
