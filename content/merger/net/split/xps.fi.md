...
############################# Head ############################
head_title: "Jaa XPS useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XPS Jakaja sisään C#"
description: "Jaa XPS muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XPS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XPS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XPS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XPS GroupDocs.Merger API:lla
