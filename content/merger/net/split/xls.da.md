...
############################# Head ############################
head_title: "Opdel XLS i flere filer i C#"
...
description: "Opdel XLS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLS-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLS fil ved hjælp af GroupDocs.Merger API
