...
############################# Head ############################
head_title: "Dela upp ODP i flera filer i C#"
...
############################# Header ############################
title: "ODP splitter i C#"
description: "Dela upp ODP med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp ODP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda ODP-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp ODP-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela ODP-fil med GroupDocs.Merger API
