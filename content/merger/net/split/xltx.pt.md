...
############################# Head ############################
head_title: "Divida XLTX em vários arquivos em C#"
...
############################# Header ############################
title: "XLTX Divisor em C#"
description: "Divida XLTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLTX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLTX usando a API GroupDocs.Merger
