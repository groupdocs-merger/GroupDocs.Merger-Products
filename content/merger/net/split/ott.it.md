...
############################# Head ############################
head_title: "Dividi OTT in più file in C#"
...
############################# Header ############################
title: "OTT Separatore in C#"
description: "Dividi OTT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file OTT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file OTT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file OTT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file OTT utilizzando l'API GroupDocs.Merger
