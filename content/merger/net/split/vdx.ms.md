...
############################# Head ############################
head_title: "Pisahkan VDX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VDX Pemisah Dalam C#"
description: "Pisahkan VDX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VDX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VDX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VDX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VDX menggunakan API GroupDocs.Merger
