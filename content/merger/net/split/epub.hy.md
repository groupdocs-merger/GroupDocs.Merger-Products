...
############################# Head ############################
head_title: "Բաժանել EPUB-ը մի քանի ֆայլերի C#-ում"
...
############################# Header ############################
title: "EPUB Splitter C#-ում"
description: "Բաժանեք EPUB-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել EPUB ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար մեկ EPUB ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել EPUB ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Բաժանեք EPUB ֆայլը` օգտագործելով GroupDocs.Merger API
