...
############################# Head ############################
head_title: "Di C# de VSTX li Pir Pelan veqetînin"
...
############################# Header ############################
title: "VSTX Splitter Li C#"
description: "VSTX bi çend rêzikên koda .NET parçe bikin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSTX parçe bikin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên C# re hêsan dike ku pelek yek VSTX li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên VSTX bi karanîna koda nimûneya C# dabeş dike">}}

        ```csharp    
        // Pelê VSTX bi karanîna GroupDocs.Merger API-ê veqetînin
