...
############################# Head ############################
head_title: "Jagage TSV mitmeks failiks rakenduses C#"
...
description: "Tükeldage TSV mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage TSV faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks TSV-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada TSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail TSV, kasutades GroupDocs.Merger API-t
