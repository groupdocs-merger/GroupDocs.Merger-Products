...
############################# Head ############################
head_title: "Divida VSX em vários arquivos em C#"
...
############################# Header ############################
title: "VSX Divisor em C#"
description: "Divida VSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSX usando a API GroupDocs.Merger
