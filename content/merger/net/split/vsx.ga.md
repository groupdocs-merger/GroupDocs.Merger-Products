...
############################# Head ############################
head_title: "Scoilt VSX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSX Scoilteoir i C#"
description: "Scoilt VSX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSX comhad ag baint úsáide as GroupDocs.Merger API
