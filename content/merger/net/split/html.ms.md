...
############################# Head ############################
head_title: "Pisahkan HTML kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "HTML Pemisah Dalam C#"
description: "Pisahkan HTML dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan HTML Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail HTML kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi HTML fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail HTML menggunakan API GroupDocs.Merger
