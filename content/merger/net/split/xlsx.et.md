...
############################# Head ############################
head_title: "Jagage XLSX mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLSX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLSX, kasutades GroupDocs.Merger API-t
