...
############################# Head ############################
head_title: "Sadaliet ODS vairākos failos programmā C#"
...
############################# Header ############################
title: "ODS sadalītājs programmā C#"
description: "Sadaliet ODS ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu ODS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODS failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet ODS failu, izmantojot GroupDocs.Merger API
