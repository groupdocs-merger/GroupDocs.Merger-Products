...
############################# Head ############################
head_title: "Dela upp VSDM i flera filer i C#"
...
description: "Dela upp VSDM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSDM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSDM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSDM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSDM-fil med GroupDocs.Merger API
