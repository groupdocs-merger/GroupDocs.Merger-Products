...
############################# Head ############################
head_title: "Opdel PPTX i flere filer i C#"
...
############################# Header ############################
title: "PPTX Splitter i C#"
description: "Opdel PPTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt PPTX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles PPTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel PPTX fil ved hjælp af GroupDocs.Merger API
