...
############################# Head ############################
head_title: "Razdeli DOCX na več datotek v C#"
...
############################# Header ############################
title: "DOCX razdelilnik v C#"
description: "Razdelite DOCX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOCX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOCX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOCX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOCX z API-jem GroupDocs.Merger
