...
############################# Head ############################
head_title: "Dividiu MHT en diversos fitxers a C#"
...
############################# Header ############################
title: "MHT Divisor a C#"
description: "Dividiu MHT amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers MHT a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer MHT en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers MHT utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer MHT mitjançant l'API de GroupDocs.Merger
