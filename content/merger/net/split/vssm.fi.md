...
############################# Head ############################
head_title: "Jaa VSSM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSSM Jakaja sisään C#"
description: "Jaa VSSM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSSM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSSM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSSM GroupDocs.Merger API:lla
