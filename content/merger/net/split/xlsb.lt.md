...
############################# Head ############################
head_title: "Padalinkite XLSB į kelis failus C#"
...
############################# Header ############################
title: "XLSB skirstytuvas C#"
description: "Padalinkite XLSB keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLSB failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XLSB failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLSB failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XLSB failą naudodami GroupDocs.Merger API
