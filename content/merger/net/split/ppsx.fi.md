...
############################# Head ############################
head_title: "Jaa PPSX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "PPSX Jakaja sisään C#"
description: "Jaa PPSX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa PPSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden PPSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa PPSX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto PPSX GroupDocs.Merger API:lla
