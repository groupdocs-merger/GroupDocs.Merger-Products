...
############################# Head ############################
head_title: "Pisahkan DOTM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "DOTM Pemisah Dalam C#"
description: "Pisahkan DOTM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan DOTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail DOTM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi DOTM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail DOTM menggunakan API GroupDocs.Merger
