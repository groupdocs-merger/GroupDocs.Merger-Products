...
############################# Head ############################
head_title: "Split ODP into Multiple Files in C#"
head_description: "Split a single ODP file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "ODP Splitter In C#"
description: "Split ODP with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Split ODP File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single ODP file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split ODP files using C# example code">}}
...
demos:
    enable: true
    title: "Live Demos - Split ODP File Online"
    content: |
