...
############################# Head ############################
head_title: "Dividir VSTX en varios archivos en C#"
...
############################# Header ############################
title: "VSTX Divisor en C#"
description: "Divida VSTX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VSTX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VSTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VSTX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VSTX usando GroupDocs.Merger API
