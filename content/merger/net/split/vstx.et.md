...
############################# Head ############################
head_title: "Jagage VSTX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSTX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSTX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSTX, kasutades GroupDocs.Merger API-t
