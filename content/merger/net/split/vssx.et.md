...
############################# Head ############################
head_title: "Jagage VSSX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSSX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSSX, kasutades GroupDocs.Merger API-t
