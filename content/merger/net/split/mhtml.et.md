...
############################# Head ############################
head_title: "Jagage MHTML mitmeks failiks rakenduses C#"
...
description: "Tükeldage MHTML mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage MHTML faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks MHTML-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada MHTML faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail MHTML, kasutades GroupDocs.Merger API-t
