...
############################# Head ############################
head_title: "Împărțiți DOT în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter DOT în C#"
description: "Împărțiți DOT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere DOT în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier DOT în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere DOT folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul DOT utilizând API-ul GroupDocs.Merger
