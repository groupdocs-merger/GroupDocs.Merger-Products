...
############################# Head ############################
head_title: "Dela upp RTF i flera filer i C#"
...
############################# Header ############################
title: "RTF splitter i C#"
description: "Dela upp RTF med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp RTF filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda RTF-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp RTF-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela RTF-fil med GroupDocs.Merger API
