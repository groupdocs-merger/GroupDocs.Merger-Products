...
############################# Head ############################
head_title: "Divisez WORD en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "WORD Séparateur dans C#"
description: "Divisez WORD avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner WORD pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier WORD en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers WORD à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier WORD à l'aide de l'API GroupDocs.Merger
