...
############################# Head ############################
head_title: "Sadaliet OTP vairākos failos programmā C#"
...
############################# Header ############################
title: "OTP sadalītājs programmā C#"
description: "Sadaliet OTP ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet OTP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu OTP failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt OTP failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet OTP failu, izmantojot GroupDocs.Merger API
