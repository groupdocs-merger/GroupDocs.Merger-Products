...
############################# Head ############################
head_title: "Dividir VSSX en varios archivos en C#"
...
############################# Header ############################
title: "VSSX Divisor en C#"
description: "Divida VSSX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VSSX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VSSX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VSSX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VSSX usando GroupDocs.Merger API
