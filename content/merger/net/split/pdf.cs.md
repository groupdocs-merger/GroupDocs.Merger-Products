...
############################# Head ############################
head_title: "Rozdělit PDF do více souborů v C#"
head_description: "Rozdělte jeden soubor PDF do několika souborů na základě čísel stránek, intervalů stránek, sudých nebo lichých stránek pomocí rozhraní API pro slučování dokumentů."

############################# Header ############################
title: "PDF Splitter v C#"
description: "Rozdělte PDF několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit PDF stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru PDF do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit PDF soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor PDF pomocí GroupDocs.Merger API
...
demos:
    enable: true
    title: "Živá ukázka – rozdělení souboru PDF online"
    content: |
       Rozdělte soubor PDF právě teď na webu [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
