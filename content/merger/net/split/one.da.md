...
############################# Head ############################
head_title: "Opdel ONE i flere filer i C#"
...
description: "Opdel ONE med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel ONE filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt ONE-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ONE filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel ONE fil ved hjælp af GroupDocs.Merger API
