...
############################# Head ############################
head_title: "Razdeli DOT na več datotek v C#"
...
############################# Header ############################
title: "DOT razdelilnik v C#"
description: "Razdelite DOT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOT z API-jem GroupDocs.Merger
