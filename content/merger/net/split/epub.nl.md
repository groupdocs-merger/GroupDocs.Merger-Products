...
############################# Head ############################
head_title: "Splits EPUB in meerdere bestanden in C#"
...
############################# Header ############################
title: "EPUB Splitter in C#"
description: "Splits EPUB met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits EPUB Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel EPUB bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe EPUB bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits EPUB bestand met behulp van GroupDocs.Merger API
