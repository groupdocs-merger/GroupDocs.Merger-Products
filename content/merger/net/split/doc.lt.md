...
############################# Head ############################
head_title: "Padalinkite DOC į kelis failus C#"
...
############################# Header ############################
title: "DOC skirstytuvas C#"
description: "Padalinkite DOC keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOC failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną DOC failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOC failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite DOC failą naudodami GroupDocs.Merger API
