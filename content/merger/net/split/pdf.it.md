...
############################# Head ############################
head_title: "Dividi PDF in più file in C#"
head_description: "Dividi un singolo file PDF in più file in base a numeri di pagina, intervalli di pagina, pagine pari o dispari utilizzando l'API di fusione documenti."

############################# Header ############################
title: "PDF Separatore in C#"
description: "Dividi PDF con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file PDF in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file PDF in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file PDF utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file PDF utilizzando l'API GroupDocs.Merger
...
demos:
    enable: true
    title: "Demo dal vivo - Dividi file PDF online"
    content: |
       Dividi subito il file PDF visitando il sito Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
