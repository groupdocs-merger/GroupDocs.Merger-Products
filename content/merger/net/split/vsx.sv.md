...
############################# Head ############################
head_title: "Dela upp VSX i flera filer i C#"
...
############################# Header ############################
title: "VSX splitter i C#"
description: "Dela upp VSX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSX-fil med GroupDocs.Merger API
