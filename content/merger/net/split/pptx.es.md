...
############################# Head ############################
head_title: "Dividir PPTX en varios archivos en C#"
...
############################# Header ############################
title: "PPTX Divisor en C#"
description: "Divida PPTX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir PPTX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo PPTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos PPTX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo PPTX usando GroupDocs.Merger API
