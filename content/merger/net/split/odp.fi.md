...
############################# Head ############################
head_title: "Jaa ODP useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "ODP Jakaja sisään C#"
description: "Jaa ODP muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa ODP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden ODP-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ODP tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto ODP GroupDocs.Merger API:lla
