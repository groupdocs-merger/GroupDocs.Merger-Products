...
############################# Head ############################
head_title: "Splits PPS in meerdere bestanden in C#"
...
############################# Header ############################
title: "PPS Splitter in C#"
description: "Splits PPS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits PPS Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel PPS bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPS bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits PPS bestand met behulp van GroupDocs.Merger API
