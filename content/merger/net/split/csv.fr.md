...
############################# Head ############################
head_title: "Divisez CSV en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "CSV Séparateur dans C#"
description: "Divisez CSV avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner CSV pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier CSV en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers CSV à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier CSV à l'aide de l'API GroupDocs.Merger
