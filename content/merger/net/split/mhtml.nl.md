...
############################# Head ############################
head_title: "Splits MHTML in meerdere bestanden in C#"
...
description: "Splits MHTML met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits MHTML Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel MHTML bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHTML bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits MHTML bestand met behulp van GroupDocs.Merger API
