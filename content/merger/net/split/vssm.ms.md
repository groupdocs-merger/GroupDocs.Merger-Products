...
############################# Head ############################
head_title: "Pisahkan VSSM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSSM Pemisah Dalam C#"
description: "Pisahkan VSSM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSSM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSSM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSSM menggunakan API GroupDocs.Merger
