...
############################# Head ############################
head_title: "Pisahkan TXT menjadi Beberapa File di C#"
...
############################# Header ############################
title: "TXT Pemisah Di C#"
description: "Pisahkan TXT dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan TXT Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file TXT menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file TXT menggunakan kode contoh C#">}}
