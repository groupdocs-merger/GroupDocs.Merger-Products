...
############################# Head ############################
head_title: "Pisahkan XLTX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLTX Pemisah Dalam C#"
description: "Pisahkan XLTX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLTX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLTX menggunakan API GroupDocs.Merger
