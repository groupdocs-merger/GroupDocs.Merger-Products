...
############################# Head ############################
head_title: "Sadaliet VSTM vairākos failos programmā C#"
...
############################# Header ############################
title: "VSTM sadalītājs programmā C#"
description: "Sadaliet VSTM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSTM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSTM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSTM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSTM failu, izmantojot GroupDocs.Merger API
