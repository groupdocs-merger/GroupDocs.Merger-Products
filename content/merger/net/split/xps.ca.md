...
############################# Head ############################
head_title: "Dividiu XPS en diversos fitxers a C#"
...
############################# Header ############################
title: "XPS Divisor a C#"
description: "Dividiu XPS amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XPS a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XPS en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XPS utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XPS mitjançant l'API de GroupDocs.Merger
