...
############################# Head ############################
head_title: "A(z) VSSM felosztása több fájlra a C# programban"
...
description: "Oszd fel az VSSM elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSSM fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen VSSM fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSSM fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az VSSM fájl felosztása a GroupDocs.Merger API segítségével
