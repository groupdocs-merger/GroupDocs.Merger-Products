...
############################# Head ############################
head_title: "Padalinkite ODS į kelis failus C#"
...
############################# Header ############################
title: "ODS skirstytuvas C#"
description: "Padalinkite ODS keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite ODS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną ODS failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti ODS failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite ODS failą naudodami GroupDocs.Merger API
