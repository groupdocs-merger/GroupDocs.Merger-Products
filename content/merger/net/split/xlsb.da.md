...
############################# Head ############################
head_title: "Opdel XLSB i flere filer i C#"
...
description: "Opdel XLSB med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLSB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLSB-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLSB filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLSB fil ved hjælp af GroupDocs.Merger API
