...
############################# Head ############################
head_title: "Padalinkite TSV į kelis failus C#"
...
############################# Header ############################
title: "TSV skirstytuvas C#"
description: "Padalinkite TSV keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite TSV failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną TSV failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti TSV failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite TSV failą naudodami GroupDocs.Merger API
