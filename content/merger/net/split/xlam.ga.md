...
############################# Head ############################
head_title: "Scoilt XLAM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLAM Scoilteoir i C#"
description: "Scoilt XLAM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLAM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLAM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLAM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLAM comhad ag baint úsáide as GroupDocs.Merger API
