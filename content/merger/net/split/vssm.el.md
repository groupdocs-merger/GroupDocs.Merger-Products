...
############################# Head ############################
head_title: "Διαχωρίστε το VSSM σε πολλά αρχεία στο C#"
...
############################# Header ############################
title: "VSSM Splitter σε C#"
description: "Διαχωρίστε το VSSM με μερικές γραμμές κώδικα .NET."
...
steps:
    enable: true
    title_left: "Διαχωρίστε VSSM σελίδες αρχείου στο .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/el/merger/net/) διευκολύνει τους προγραμματιστές του C# να χωρίσουν ένα μεμονωμένο αρχείο VSSM σε πολλά προκύπτοντα αρχεία εφαρμόζοντας ένα λίγα εύκολα βήματα.
    ...
    code: |
     ...
     {{< merger/code-merger title="Πώς να χωρίσετε VSSM αρχεία χρησιμοποιώντας παράδειγμα κώδικα C#">}}

        ```csharp    
        // Διαχωρίστε το αρχείο VSSM χρησιμοποιώντας το GroupDocs.Merger API
