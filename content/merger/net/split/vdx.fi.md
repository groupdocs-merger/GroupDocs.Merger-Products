...
############################# Head ############################
head_title: "Jaa VDX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VDX Jakaja sisään C#"
description: "Jaa VDX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VDX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VDX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VDX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VDX GroupDocs.Merger API:lla
