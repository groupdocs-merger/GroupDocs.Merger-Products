...
############################# Head ############################
head_title: "VDX کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "VDX سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ VDX کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "VDX فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک VDX فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے VDX فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے VDX فائل کو تقسیم کریں۔
