...
############################# Head ############################
head_title: "Podziel OTP na wiele plików w C#"
...
############################# Header ############################
title: "OTP Rozdzielacz w C#"
description: "Podziel OTP z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików OTP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku OTP na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki OTP przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik OTP za pomocą GroupDocs.Merger API
