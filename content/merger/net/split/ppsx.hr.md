...
############################# Head ############################
head_title: "Podijeli PPSX u više datoteka u C#"
...
############################# Header ############################
title: "PPSX Splitter u C#"
description: "Podijelite PPSX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli PPSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne PPSX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPSX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli PPSX datoteku pomoću API-ja GroupDocs.Merger
