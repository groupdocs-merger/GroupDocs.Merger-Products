...
############################# Head ############################
head_title: "Divisez MHT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "MHT Séparateur dans C#"
description: "Divisez MHT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner MHT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier MHT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers MHT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier MHT à l'aide de l'API GroupDocs.Merger
