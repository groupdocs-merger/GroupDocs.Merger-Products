...
############################# Head ############################
head_title: "Scoilt RTF ina Ilchomhaid i C#"
...
############################# Header ############################
title: "RTF Scoilteoir i C#"
description: "Scoilt RTF le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt RTF Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin RTF a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid RTF a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt RTF comhad ag baint úsáide as GroupDocs.Merger API
