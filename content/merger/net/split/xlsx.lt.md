...
############################# Head ############################
head_title: "Padalinkite XLSX į kelis failus C#"
...
############################# Header ############################
title: "XLSX skirstytuvas C#"
description: "Padalinkite XLSX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XLSX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XLSX failą naudodami GroupDocs.Merger API
