...
############################# Head ############################
head_title: "Dividir MHT en varios archivos en C#"
...
############################# Header ############################
title: "MHT Divisor en C#"
description: "Divida MHT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir MHT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo MHT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos MHT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo MHT usando GroupDocs.Merger API
