...
############################# Head ############################
head_title: "Di C# de VSTM li Pir Pelan veqetînin"
...
############################# Header ############################
title: "VSTM Splitter Li C#"
description: "VSTM bi çend rêzikên koda .NET parçe bikin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê VSTM parçe bikin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên C# re hêsan dike ku pelek yek VSTM li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên VSTM bi karanîna koda nimûneya C# dabeş dike">}}

        ```csharp    
        // Pelê VSTM bi karanîna GroupDocs.Merger API-ê veqetînin
