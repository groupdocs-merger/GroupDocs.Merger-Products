...
############################# Head ############################
head_title: "Skiptu PPSX í margar skrár í C#"
...
############################# Header ############################
title: "PPSX Skerandi í C#"
description: "Skiptu PPSX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPSX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni PPSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPSX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu PPSX skrá með GroupDocs.Merger API
