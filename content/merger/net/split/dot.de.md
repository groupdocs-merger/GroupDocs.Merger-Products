...
############################# Head ############################
head_title: "Teilen Sie DOT in mehrere Dateien in C#"
...
############################# Header ############################
title: "DOT Splittereingang C#"
description: "Teilen Sie DOT mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie DOT Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne DOT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie DOT-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die DOT-Datei mithilfe der GroupDocs.Merger-API
