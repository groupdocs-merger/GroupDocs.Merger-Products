...
############################# Head ############################
head_title: "TEX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "TEX Ayırıcı C#"
description: "TEX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "TEX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TEX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TEX dosyasını ayırın
