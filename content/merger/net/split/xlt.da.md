...
############################# Head ############################
head_title: "Opdel XLT i flere filer i C#"
...
description: "Opdel XLT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLT fil ved hjælp af GroupDocs.Merger API
