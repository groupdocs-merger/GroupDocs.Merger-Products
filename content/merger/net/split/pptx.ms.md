...
############################# Head ############################
head_title: "Pisahkan PPTX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "PPTX Pemisah Dalam C#"
description: "Pisahkan PPTX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan PPTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail PPTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi PPTX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail PPTX menggunakan API GroupDocs.Merger
