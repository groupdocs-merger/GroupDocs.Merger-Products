...
############################# Head ############################
head_title: "Dividir XLSB en varios archivos en C#"
...
############################# Header ############################
title: "XLSB Divisor en C#"
description: "Divida XLSB con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLSB páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLSB en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLSB usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLSB usando GroupDocs.Merger API
