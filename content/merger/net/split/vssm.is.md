...
############################# Head ############################
head_title: "Skiptu VSSM í margar skrár í C#"
...
############################# Header ############################
title: "VSSM Skerandi í C#"
description: "Skiptu VSSM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSSM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSSM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSSM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSSM skrá með GroupDocs.Merger API
