...
############################# Head ############################
head_title: "Dividir MHTML en varios archivos en C#"
...
############################# Header ############################
title: "MHTML Divisor en C#"
description: "Divida MHTML con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir MHTML páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo MHTML en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos MHTML usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo MHTML usando GroupDocs.Merger API
