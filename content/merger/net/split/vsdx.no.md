...
############################# Head ############################
head_title: "Del VSDX i flere filer i C#"
...
description: "Del VSDX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSDX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSDX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSDX-filen ved hjelp av GroupDocs.Merger API
