...
############################# Head ############################
head_title: "Padalinkite OTP į kelis failus C#"
...
############################# Header ############################
title: "OTP skirstytuvas C#"
description: "Padalinkite OTP keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite OTP failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną OTP failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti OTP failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite OTP failą naudodami GroupDocs.Merger API
