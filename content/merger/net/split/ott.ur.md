...
############################# Head ############################
head_title: "OTT کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "OTT سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ OTT کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "OTT فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک OTT فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے OTT فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے OTT فائل کو تقسیم کریں۔
