...
############################# Head ############################
head_title: "Dividir WORKSHEET en varios archivos en C#"
...
############################# Header ############################
title: "WORKSHEET Divisor en C#"
description: "Divida WORKSHEET con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir WORKSHEET páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo WORKSHEET en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos WORKSHEET usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo WORKSHEET usando GroupDocs.Merger API
