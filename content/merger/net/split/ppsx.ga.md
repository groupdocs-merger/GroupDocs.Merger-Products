...
############################# Head ############################
head_title: "Scoilt PPSX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "PPSX Scoilteoir i C#"
description: "Scoilt PPSX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt PPSX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin PPSX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid PPSX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt PPSX comhad ag baint úsáide as GroupDocs.Merger API
