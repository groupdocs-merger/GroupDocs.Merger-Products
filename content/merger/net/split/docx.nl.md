...
############################# Head ############################
head_title: "Splits DOCX in meerdere bestanden in C#"
...
############################# Header ############################
title: "DOCX Splitter in C#"
description: "Splits DOCX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOCX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOCX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOCX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOCX bestand met behulp van GroupDocs.Merger API
