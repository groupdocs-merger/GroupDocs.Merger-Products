...
############################# Head ############################
head_title: "Divida DOTX em vários arquivos em C#"
...
############################# Header ############################
title: "DOTX Divisor em C#"
description: "Divida DOTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOTX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOTX usando a API GroupDocs.Merger
