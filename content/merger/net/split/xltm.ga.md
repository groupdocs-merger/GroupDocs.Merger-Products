...
############################# Head ############################
head_title: "Scoilt XLTM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLTM Scoilteoir i C#"
description: "Scoilt XLTM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLTM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLTM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLTM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLTM comhad ag baint úsáide as GroupDocs.Merger API
