...
############################# Head ############################
head_title: "Pisahkan VSX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSX Pemisah Dalam C#"
description: "Pisahkan VSX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSX menggunakan API GroupDocs.Merger
