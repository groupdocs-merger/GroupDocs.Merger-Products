...
############################# Head ############################
head_title: "Dela upp DOCX i flera filer i C#"
...
description: "Dela upp DOCX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOCX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda DOCX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOCX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela DOCX-fil med GroupDocs.Merger API
