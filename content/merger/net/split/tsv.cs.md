...
############################# Head ############################
head_title: "Rozdělit TSV do více souborů v C#"
...
description: "Rozdělte TSV několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit TSV stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru TSV do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit TSV soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor TSV pomocí GroupDocs.Merger API
