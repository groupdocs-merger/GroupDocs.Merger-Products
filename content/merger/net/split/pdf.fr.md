...
############################# Head ############################
head_title: "Divisez PDF en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "PDF Séparateur dans C#"
description: "Divisez PDF avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner PDF pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier PDF en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers PDF à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier PDF à l'aide de l'API GroupDocs.Merger
