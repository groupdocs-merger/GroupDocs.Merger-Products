...
############################# Head ############################
head_title: "Splits XLSM in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLSM Splitter in C#"
description: "Splits XLSM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLSM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLSM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLSM bestand met behulp van GroupDocs.Merger API
