...
############################# Head ############################
head_title: "Разделить ODT на несколько файлов на C#"
...
############################# Header ############################
title: "ODT Разделитель на C#"
description: "Разделите ODT страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Разделить страницы ODT документов на .NET"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файлы ODT, используя пример кода C#">}}
        ...
        ```csharp    
        // Разделить файл ODT с помощью GroupDocs.Merger API
