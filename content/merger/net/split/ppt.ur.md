...
############################# Head ############################
head_title: "PPT کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "PPT سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ PPT کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "PPT فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک PPT فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے PPT فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے PPT فائل کو تقسیم کریں۔
