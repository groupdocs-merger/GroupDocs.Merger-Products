...
############################# Head ############################
head_title: "Tách XLS thành nhiều tệp trong C#"
...
############################# Header ############################
title: "XLS Splitter trong C#"
description: "Tách XLS bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp XLS trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp XLS thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp XLS bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp XLS bằng API GroupDocs.Merger
