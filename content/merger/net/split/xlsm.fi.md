...
############################# Head ############################
head_title: "Jaa XLSM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLSM Jakaja sisään C#"
description: "Jaa XLSM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLSM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLSM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLSM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLSM GroupDocs.Merger API:lla
