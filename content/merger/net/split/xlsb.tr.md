...
############################# Head ############################
head_title: "XLSB'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLSB Ayırıcı C#"
description: "XLSB kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLSB Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLSB dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLSB dosyasını ayırın
