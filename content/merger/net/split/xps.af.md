...
############################# Head ############################
head_title: "Verdeel XPS in veelvuldige lêers in C#"
...
description: "Verdeel XPS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XPS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XPS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XPS lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XPS lêer deur GroupDocs.Merger API te gebruik
