...
############################# Head ############################
head_title: "Dela upp TEX i flera filer i C#"
...
description: "Dela upp TEX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp TEX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda TEX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp TEX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela TEX-fil med GroupDocs.Merger API
