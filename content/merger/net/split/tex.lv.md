...
############################# Head ############################
head_title: "Sadaliet TEX vairākos failos programmā C#"
...
############################# Header ############################
title: "TEX sadalītājs programmā C#"
description: "Sadaliet TEX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TEX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu TEX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TEX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet TEX failu, izmantojot GroupDocs.Merger API
