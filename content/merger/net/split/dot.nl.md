...
############################# Head ############################
head_title: "Splits DOT in meerdere bestanden in C#"
...
description: "Splits DOT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOT bestand met behulp van GroupDocs.Merger API
