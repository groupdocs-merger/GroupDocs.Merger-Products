...
############################# Head ############################
head_title: "Împărțiți ODP în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter ODP în C#"
description: "Împărțiți ODP cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere ODP în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier ODP în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere ODP folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul ODP utilizând API-ul GroupDocs.Merger
