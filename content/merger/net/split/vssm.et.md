...
############################# Head ############################
head_title: "Jagage VSSM mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSSM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSSM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSSM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSSM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSSM, kasutades GroupDocs.Merger API-t
