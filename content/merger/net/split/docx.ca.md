...
############################# Head ############################
head_title: "Dividiu DOCX en diversos fitxers a C#"
...
############################# Header ############################
title: "DOCX Divisor a C#"
description: "Dividiu DOCX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers DOCX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer DOCX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers DOCX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer DOCX mitjançant l'API de GroupDocs.Merger
