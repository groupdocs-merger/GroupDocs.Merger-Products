...
############################# Head ############################
head_title: "Dividiu RTF en diversos fitxers a C#"
...
############################# Header ############################
title: "RTF Divisor a C#"
description: "Dividiu RTF amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers RTF a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer RTF en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers RTF utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer RTF mitjançant l'API de GroupDocs.Merger
