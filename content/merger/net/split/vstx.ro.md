...
############################# Head ############################
head_title: "Împărțiți VSTX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VSTX în C#"
description: "Împărțiți VSTX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VSTX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VSTX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VSTX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VSTX utilizând API-ul GroupDocs.Merger
