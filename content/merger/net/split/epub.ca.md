...
############################# Head ############################
head_title: "Dividiu EPUB en diversos fitxers a C#"
...
############################# Header ############################
title: "EPUB Divisor a C#"
description: "Dividiu EPUB amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers EPUB a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer EPUB en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers EPUB utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer EPUB mitjançant l'API de GroupDocs.Merger
