...
############################# Head ############################
head_title: "Розділити VSSX на кілька файлів у C#"
...
############################# Header ############################
title: "VSSX Спліттер у C#"
description: "Розділіть VSSX кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Розділити VSSX сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко розділити один файл VSSX на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файли VSSX за допомогою прикладу коду C#">}}

        ```csharp    
        // Розділіть файл VSSX за допомогою API GroupDocs.Merger
