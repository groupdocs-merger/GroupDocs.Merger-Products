...
############################# Head ############################
head_title: "Rozdeliť DOTX do viacerých súborov v C#"
...
############################# Header ############################
title: "DOTX Splitter v C#"
description: "Rozdeľte DOTX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOTX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOTX pomocou rozhrania GroupDocs.Merger API
