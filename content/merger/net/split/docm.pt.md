...
############################# Head ############################
head_title: "Divida DOCM em vários arquivos em C#"
...
############################# Header ############################
title: "DOCM Divisor em C#"
description: "Divida DOCM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOCM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOCM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOCM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOCM usando a API GroupDocs.Merger
