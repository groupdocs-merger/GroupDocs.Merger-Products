...
############################# Head ############################
head_title: "تقسيم VSSX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "VSSX الفاصل في C#"
description: "قسِّم VSSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات VSSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد VSSX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات VSSX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف VSSX باستخدام GroupDocs.Merger API
