...
############################# Head ############################
head_title: "Scoilt TEX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "TEX Scoilteoir i C#"
description: "Scoilt TEX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt TEX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin TEX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid TEX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt TEX comhad ag baint úsáide as GroupDocs.Merger API
