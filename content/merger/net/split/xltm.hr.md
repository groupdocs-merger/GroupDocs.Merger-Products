...
############################# Head ############################
head_title: "Podijeli XLTM u više datoteka u C#"
...
############################# Header ############################
title: "XLTM Splitter u C#"
description: "Podijelite XLTM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLTM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLTM datoteku pomoću API-ja GroupDocs.Merger
