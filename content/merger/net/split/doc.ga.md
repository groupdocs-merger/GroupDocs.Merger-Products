...
############################# Head ############################
head_title: "Scoilt DOC ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOC Scoilteoir i C#"
description: "Scoilt DOC le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOC Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOC a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOC a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOC comhad ag baint úsáide as GroupDocs.Merger API
