...
############################# Head ############################
head_title: "Jaa TSV useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "TSV Jakaja sisään C#"
description: "Jaa TSV muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa TSV tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden TSV-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TSV tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto TSV GroupDocs.Merger API:lla
