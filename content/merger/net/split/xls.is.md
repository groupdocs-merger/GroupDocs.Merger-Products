...
############################# Head ############################
head_title: "Skiptu XLS í margar skrár í C#"
...
############################# Header ############################
title: "XLS Skerandi í C#"
description: "Skiptu XLS með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLS skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLS skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLS skrá með GroupDocs.Merger API
