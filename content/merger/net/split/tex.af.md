...
############################# Head ############################
head_title: "Verdeel TEX in veelvuldige lêers in C#"
...
description: "Verdeel TEX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel TEX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele TEX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TEX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel TEX lêer deur GroupDocs.Merger API te gebruik
