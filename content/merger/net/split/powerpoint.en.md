...
############################# Head ############################
head_title: "Split POWERPOINT documents in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to split POWERPOINT files into separate documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, Visio files, images, archives, and more."

############################# Header ############################
title: "Split POWERPOINT files" 
description: "GroupDocs.Merger for .NET enhances .NET applications with advanced document processing features. Easily split POWERPOINT files and work with various popular business formats."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can split POWERPOINT documents and save selected pages as a new file. Enhance document processing in your .NET applications.
      
      1. Specify the source path of the POWERPOINT file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Split POWERPOINT document and save even-numbered pages"
      content: |
        This example shows how to split a POWERPOINT document and save all even-numbered pages as a separate file.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
