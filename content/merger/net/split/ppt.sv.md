...
############################# Head ############################
head_title: "Dela upp PPT i flera filer i C#"
...
description: "Dela upp PPT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp PPT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda PPT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PPT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela PPT-fil med GroupDocs.Merger API
