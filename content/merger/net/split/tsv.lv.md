...
############################# Head ############################
head_title: "Sadaliet TSV vairākos failos programmā C#"
...
############################# Header ############################
title: "TSV sadalītājs programmā C#"
description: "Sadaliet TSV ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet TSV faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu TSV failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt TSV failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet TSV failu, izmantojot GroupDocs.Merger API
