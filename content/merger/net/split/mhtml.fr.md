...
############################# Head ############################
head_title: "Divisez MHTML en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "MHTML Séparateur dans C#"
description: "Divisez MHTML avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner MHTML pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier MHTML en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers MHTML à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier MHTML à l'aide de l'API GroupDocs.Merger
