...
############################# Head ############################
head_title: "Împărțiți EPUB în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter EPUB în C#"
description: "Împărțiți EPUB cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere EPUB în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier EPUB în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere EPUB folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul EPUB utilizând API-ul GroupDocs.Merger
