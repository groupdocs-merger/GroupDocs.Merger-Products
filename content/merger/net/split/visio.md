...
############################# Head ############################
head_title: "Split VISIO into Multiple Files in C#"
...
############################# Header ############################
title: "VISIO Splitter In C#"
description: "Split VISIO with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single VISIO file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VISIO files using C# example code">}}
