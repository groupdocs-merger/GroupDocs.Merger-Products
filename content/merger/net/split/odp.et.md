...
############################# Head ############################
head_title: "Jagage ODP mitmeks failiks rakenduses C#"
...
description: "Tükeldage ODP mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage ODP faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks ODP-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada ODP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail ODP, kasutades GroupDocs.Merger API-t
