...
############################# Head ############################
head_title: "Dividir XLSM en varios archivos en C#"
...
############################# Header ############################
title: "XLSM Divisor en C#"
description: "Divida XLSM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLSM páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLSM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLSM usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLSM usando GroupDocs.Merger API
