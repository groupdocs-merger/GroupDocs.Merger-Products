...
############################# Head ############################
head_title: "Teilen von PPTX-Dokumenten in .NET-Apps"
head_description: "Nutzen Sie GroupDocs.Merger for .NET, um PPTX-Dateien in separate Dokumente zu teilen. Verwalten Sie PDFs, Word-Dateien, Excel-Tabellen, PowerPoint-Folien, Visio-Dateien, Bilder, Archive und mehr."

############################# Header ############################
title: "Teilen von PPTX-Dateien" 
description: "GroupDocs.Merger for .NET verbessert .NET-Anwendungen mit fortschrittlichen Funktionen zur Dokumentenverarbeitung. Teilen Sie PPTX-Dateien und arbeiten Sie mit verschiedenen gängigen Geschäftsformaten."
...
steps:
    enable: true
    title: "So teilen Sie PPTX-Dateien"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie PPTX-Dokumente teilen und ausgewählte Seiten als neue Datei speichern. Verbessern Sie die Dokumentenverarbeitung in Ihren .NET-Anwendungen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "PPTX-Dokument teilen und gerade Seiten speichern"
      content: |
        Dieses Beispiel zeigt, wie man ein PPTX-Dokument teilt und alle geraden Seiten als separate Datei speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
