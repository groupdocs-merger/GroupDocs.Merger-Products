...
############################# Head ############################
head_title: "Podziel XPS na wiele plików w C#"
...
############################# Header ############################
title: "XPS Rozdzielacz w C#"
description: "Podziel XPS z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XPS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XPS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XPS przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XPS za pomocą GroupDocs.Merger API
