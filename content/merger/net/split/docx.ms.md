...
############################# Head ############################
head_title: "Pisahkan DOCX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "DOCX Pemisah Dalam C#"
description: "Pisahkan DOCX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan DOCX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail DOCX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi DOCX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail DOCX menggunakan API GroupDocs.Merger
