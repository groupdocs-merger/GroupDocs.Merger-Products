...
############################# Head ############################
head_title: "Dividi DOC in più file in C#"
...
############################# Header ############################
title: "DOC Separatore in C#"
description: "Dividi DOC con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOC in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOC in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOC utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOC utilizzando l'API GroupDocs.Merger
