...
############################# Head ############################
head_title: "Splits XLT in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLT Splitter in C#"
description: "Splits XLT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLT bestand met behulp van GroupDocs.Merger API
