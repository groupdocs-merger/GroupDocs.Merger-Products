...
############################# Head ############################
head_title: "Split MHT into Multiple Files in C#"
...
description: "Split MHT with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Split MHT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single MHT file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split MHT files using C# example code">}}
