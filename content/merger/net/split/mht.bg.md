...
############################# Head ############################
head_title: "Разделете MHT на няколко файла в C#"
...
############################# Header ############################
title: "MHT Сплитер в C#"
description: "Разделете MHT с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разделете MHT файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разделят един файл MHT на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделяте MHT файлове с помощта на C# примерен код">}}

        ```csharp    
        // Разделете файла MHT с помощта на API на GroupDocs.Merger
