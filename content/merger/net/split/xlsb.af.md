...
############################# Head ############################
head_title: "Verdeel XLSB in veelvuldige lêers in C#"
...
############################# Header ############################
title: "XLSB Splitter in C#"
description: "Verdeel XLSB met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSB lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLSB-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSB lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLSB lêer deur GroupDocs.Merger API te gebruik
