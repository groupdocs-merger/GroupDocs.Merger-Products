...
############################# Head ############################
head_title: "Del VSTM i flere filer i C#"
...
description: "Del VSTM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSTM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSTM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSTM-filen ved hjelp av GroupDocs.Merger API
