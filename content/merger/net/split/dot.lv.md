...
############################# Head ############################
head_title: "Sadaliet DOT vairākos failos programmā C#"
...
############################# Header ############################
title: "DOT sadalītājs programmā C#"
description: "Sadaliet DOT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu DOT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet DOT failu, izmantojot GroupDocs.Merger API
