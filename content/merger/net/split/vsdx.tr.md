...
############################# Head ############################
head_title: "VSDX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSDX Ayırıcı C#"
description: "VSDX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSDX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDX dosyasını ayırın
