...
############################# Head ############################
head_title: "Rozdeliť PPTX do viacerých súborov v C#"
...
############################# Header ############################
title: "PPTX Splitter v C#"
description: "Rozdeľte PPTX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť PPTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor PPTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PPTX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor PPTX pomocou rozhrania GroupDocs.Merger API
