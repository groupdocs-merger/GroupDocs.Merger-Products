...
############################# Head ############################
head_title: "Verdeel VTX in veelvuldige lêers in C#"
...
############################# Header ############################
title: "VTX Splitter in C#"
description: "Verdeel VTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VTX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VTX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VTX lêer deur GroupDocs.Merger API te gebruik
