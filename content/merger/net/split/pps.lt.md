...
############################# Head ############################
head_title: "Padalinkite PPS į kelis failus C#"
...
############################# Header ############################
title: "PPS skirstytuvas C#"
description: "Padalinkite PPS keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite PPS failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną PPS failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti PPS failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite PPS failą naudodami GroupDocs.Merger API
