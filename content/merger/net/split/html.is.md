...
############################# Head ############################
head_title: "Skiptu HTML í margar skrár í C#"
...
############################# Header ############################
title: "HTML Skerandi í C#"
description: "Skiptu HTML með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu HTML skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni HTML skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta HTML skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu HTML skrá með GroupDocs.Merger API
