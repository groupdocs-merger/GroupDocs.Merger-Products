...
############################# Head ############################
head_title: "Del VSTX i flere filer i C#"
...
description: "Del VSTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSTX-filen ved hjelp av GroupDocs.Merger API
