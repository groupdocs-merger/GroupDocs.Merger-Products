...
############################# Head ############################
head_title: "VSTX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSTX Ayırıcı C#"
description: "VSTX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSTX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSTX dosyasını ayırın
