...
############################# Head ############################
head_title: "Del VSSX i flere filer i C#"
head_description: "Del en enkelt VSSX-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "VSSX splitter i C#"
description: "Del VSSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSSX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSSX-filen ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer - Del VSSX-fil på nett"
    content: |
       Del opp VSSX-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vssx).
