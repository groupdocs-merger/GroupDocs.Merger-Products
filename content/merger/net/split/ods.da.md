...
############################# Head ############################
head_title: "Opdel ODS i flere filer i C#"
...
description: "Opdel ODS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt ODS-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ODS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel ODS fil ved hjælp af GroupDocs.Merger API
