...
############################# Head ############################
head_title: "Opdel VTX i flere filer i C#"
...
description: "Opdel VTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VTX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VTX fil ved hjælp af GroupDocs.Merger API
