...
############################# Head ############################
head_title: "Jaa ODS useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "ODS Jakaja sisään C#"
description: "Jaa ODS muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa ODS tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden ODS-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa ODS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto ODS GroupDocs.Merger API:lla
