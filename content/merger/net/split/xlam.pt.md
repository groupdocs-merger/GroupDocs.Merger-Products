...
############################# Head ############################
head_title: "Divida XLAM em vários arquivos em C#"
...
############################# Header ############################
title: "XLAM Divisor em C#"
description: "Divida XLAM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLAM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLAM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLAM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLAM usando a API GroupDocs.Merger
