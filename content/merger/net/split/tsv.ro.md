...
############################# Head ############################
head_title: "Împărțiți TSV în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter TSV în C#"
description: "Împărțiți TSV cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere TSV în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier TSV în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere TSV folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul TSV utilizând API-ul GroupDocs.Merger
