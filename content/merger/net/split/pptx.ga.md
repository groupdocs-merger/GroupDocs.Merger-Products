...
############################# Head ############################
head_title: "Scoilt PPTX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "PPTX Scoilteoir i C#"
description: "Scoilt PPTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt PPTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin PPTX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid PPTX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt PPTX comhad ag baint úsáide as GroupDocs.Merger API
