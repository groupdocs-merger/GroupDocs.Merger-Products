...
############################# Head ############################
head_title: "Divida MHT em vários arquivos em C#"
...
############################# Header ############################
title: "MHT Divisor em C#"
description: "Divida MHT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo MHT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo MHT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos MHT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo MHT usando a API GroupDocs.Merger
