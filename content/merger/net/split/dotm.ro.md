...
############################# Head ############################
head_title: "Împărțiți DOTM în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter DOTM în C#"
description: "Împărțiți DOTM cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere DOTM în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier DOTM în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere DOTM folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul DOTM utilizând API-ul GroupDocs.Merger
