...
############################# Head ############################
head_title: "Dividi XLS in più file in C#"
...
############################# Header ############################
title: "XLS Separatore in C#"
description: "Dividi XLS con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLS in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLS in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLS utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLS utilizzando l'API GroupDocs.Merger
