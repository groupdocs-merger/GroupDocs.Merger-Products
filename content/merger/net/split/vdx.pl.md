...
############################# Head ############################
head_title: "Podziel VDX na wiele plików w C#"
...
############################# Header ############################
title: "VDX Rozdzielacz w C#"
description: "Podziel VDX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VDX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VDX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VDX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VDX za pomocą GroupDocs.Merger API
