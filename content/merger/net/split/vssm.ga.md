...
############################# Head ############################
head_title: "Scoilt VSSM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSSM Scoilteoir i C#"
description: "Scoilt VSSM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSSM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSSM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSSM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSSM comhad ag baint úsáide as GroupDocs.Merger API
