...
############################# Head ############################
head_title: "Dela upp ODS i flera filer i C#"
...
############################# Header ############################
title: "ODS splitter i C#"
description: "Dela upp ODS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp ODS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda ODS-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp ODS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela ODS-fil med GroupDocs.Merger API
