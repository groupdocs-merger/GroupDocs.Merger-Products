...
############################# Head ############################
head_title: "Բաժանել VSTM-ը մի քանի ֆայլերի C#-ում"
...
############################# Header ############################
title: "VSTM Splitter C#-ում"
description: "Բաժանեք VSTM-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել VSTM ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար մեկ VSTM ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել VSTM ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Բաժանեք VSTM ֆայլը` օգտագործելով GroupDocs.Merger API
