...
############################# Head ############################
head_title: "Dividir DOT en varios archivos en C#"
...
############################# Header ############################
title: "DOT Divisor en C#"
description: "Divida DOT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOT usando GroupDocs.Merger API
