...
############################# Head ############################
head_title: "Razdeli XLTM na več datotek v C#"
...
############################# Header ############################
title: "XLTM razdelilnik v C#"
description: "Razdelite XLTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLTM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLTM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLTM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLTM z API-jem GroupDocs.Merger
