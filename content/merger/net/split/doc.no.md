...
############################# Head ############################
head_title: "Del DOC i flere filer i C#"
...
description: "Del DOC med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt DOC-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOC filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del DOC-filen ved hjelp av GroupDocs.Merger API
