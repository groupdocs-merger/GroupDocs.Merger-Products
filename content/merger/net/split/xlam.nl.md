...
############################# Head ############################
head_title: "Splits XLAM in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLAM Splitter in C#"
description: "Splits XLAM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLAM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLAM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLAM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLAM bestand met behulp van GroupDocs.Merger API
