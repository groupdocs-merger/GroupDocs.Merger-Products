...
############################# Head ############################
head_title: "Dividir XLS en varios archivos en C#"
...
############################# Header ############################
title: "XLS Divisor en C#"
description: "Divida XLS con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLS páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLS en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLS usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLS usando GroupDocs.Merger API
