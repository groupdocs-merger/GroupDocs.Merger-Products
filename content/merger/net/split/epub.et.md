...
############################# Head ############################
head_title: "Jagage EPUB mitmeks failiks rakenduses C#"
...
description: "Tükeldage EPUB mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage EPUB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks EPUB-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada EPUB faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail EPUB, kasutades GroupDocs.Merger API-t
