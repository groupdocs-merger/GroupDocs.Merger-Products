...
############################# Head ############################
head_title: "Pisahkan PPSX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "PPSX Pemisah Dalam C#"
description: "Pisahkan PPSX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan PPSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail PPSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi PPSX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail PPSX menggunakan API GroupDocs.Merger
