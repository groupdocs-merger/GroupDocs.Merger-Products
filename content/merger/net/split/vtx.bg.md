...
############################# Head ############################
head_title: "Split VTX into Multiple Files in C#"
...
description: "Split VTX with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single VTX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split VTX files using C# example code">}}
