...
############################# Head ############################
head_title: "Sadaliet DOC vairākos failos programmā C#"
...
############################# Header ############################
title: "DOC sadalītājs programmā C#"
description: "Sadaliet DOC ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOC faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu DOC failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOC failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet DOC failu, izmantojot GroupDocs.Merger API
