...
############################# Head ############################
head_title: "Divisez VSSX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSSX Séparateur dans C#"
description: "Divisez VSSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSSX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSSX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSSX à l'aide de l'API GroupDocs.Merger
