...
############################# Head ############################
head_title: "Sadaliet VSSM vairākos failos programmā C#"
...
############################# Header ############################
title: "VSSM sadalītājs programmā C#"
description: "Sadaliet VSSM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSSM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSSM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSSM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSSM failu, izmantojot GroupDocs.Merger API
