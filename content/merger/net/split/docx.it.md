...
############################# Head ############################
head_title: "Dividi DOCX in più file in C#"
...
############################# Header ############################
title: "DOCX Separatore in C#"
description: "Dividi DOCX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOCX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOCX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOCX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOCX utilizzando l'API GroupDocs.Merger
