...
############################# Head ############################
head_title: "DOTX файлын C# ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "DOTX C# ішіндегі бөлгіш"
description: "DOTX кодының бірнеше жолын .NET кодымен бөліңіз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі DOTX файл беттерін бөлу"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бір DOTX файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTX файлдарды C# мысал кодын пайдаланып қалай бөлуге болады">}}

        ```csharp    
        // GroupDocs.Merger API арқылы DOTX файлды бөліңіз
