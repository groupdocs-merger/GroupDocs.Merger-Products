...
############################# Head ############################
head_title: "Pisahkan OTT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "OTT Pemisah Dalam C#"
description: "Pisahkan OTT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan OTT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail OTT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi OTT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail OTT menggunakan API GroupDocs.Merger
