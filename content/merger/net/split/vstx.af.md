...
############################# Head ############################
head_title: "Verdeel VSTX in veelvuldige lêers in C#"
...
description: "Verdeel VSTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSTX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VSTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VSTX lêer deur GroupDocs.Merger API te gebruik
