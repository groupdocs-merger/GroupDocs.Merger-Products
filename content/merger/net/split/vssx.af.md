...
############################# Head ############################
head_title: "Verdeel VSSX in veelvuldige lêers in C#"
...
############################# Header ############################
title: "VSSX Splitter in C#"
description: "Verdeel VSSX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSSX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VSSX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSSX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VSSX lêer deur GroupDocs.Merger API te gebruik
