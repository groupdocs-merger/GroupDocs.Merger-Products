...
############################# Head ############################
head_title: "Opdel DOTM i flere filer i C#"
...
description: "Opdel DOTM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOTM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOTM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOTM fil ved hjælp af GroupDocs.Merger API
