...
############################# Head ############################
head_title: "ODT файлын C# ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "ODT C# ішіндегі бөлгіш"
description: "ODT кодының бірнеше жолын .NET кодымен бөліңіз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі ODT файл беттерін бөлу"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бір ODT файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT файлдарды C# мысал кодын пайдаланып қалай бөлуге болады">}}

        ```csharp    
        // GroupDocs.Merger API арқылы ODT файлды бөліңіз
