...
############################# Head ############################
head_title: "Verdeel CSV in veelvuldige lêers in C#"
...
description: "Verdeel CSV met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel CSV lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele CSV-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om CSV lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel CSV lêer deur GroupDocs.Merger API te gebruik
