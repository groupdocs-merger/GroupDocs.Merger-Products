...
############################# Head ############################
head_title: "Sadaliet OTT vairākos failos programmā C#"
...
############################# Header ############################
title: "OTT sadalītājs programmā C#"
description: "Sadaliet OTT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet OTT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu OTT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt OTT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet OTT failu, izmantojot GroupDocs.Merger API
