...
############################# Head ############################
head_title: "Dividiu XLAM en diversos fitxers a C#"
...
############################# Header ############################
title: "XLAM Divisor a C#"
description: "Dividiu XLAM amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XLAM a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XLAM en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XLAM utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XLAM mitjançant l'API de GroupDocs.Merger
