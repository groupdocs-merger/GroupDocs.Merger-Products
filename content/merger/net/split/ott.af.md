...
############################# Head ############################
head_title: "Verdeel OTT in veelvuldige lêers in C#"
...
description: "Verdeel OTT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel OTT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele OTT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel OTT lêer deur GroupDocs.Merger API te gebruik
