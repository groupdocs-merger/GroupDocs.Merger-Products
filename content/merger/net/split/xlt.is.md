...
############################# Head ############################
head_title: "Skiptu XLT í margar skrár í C#"
...
############################# Header ############################
title: "XLT Skerandi í C#"
description: "Skiptu XLT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLT skrá með GroupDocs.Merger API
