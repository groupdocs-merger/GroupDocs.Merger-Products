...
############################# Head ############################
head_title: "Teilen von XPS-Dokumenten in .NET-Apps"
head_description: "Nutzen Sie GroupDocs.Merger for .NET, um XPS-Dateien in separate Dokumente zu teilen. Verwalten Sie PDFs, Word-Dateien, Excel-Tabellen, PowerPoint-Folien, Visio-Dateien, Bilder, Archive und mehr."

############################# Header ############################
title: "Teilen von XPS-Dateien" 
description: "GroupDocs.Merger for .NET verbessert .NET-Anwendungen mit fortschrittlichen Funktionen zur Dokumentenverarbeitung. Teilen Sie XPS-Dateien und arbeiten Sie mit verschiedenen gängigen Geschäftsformaten."
...
steps:
    enable: true
    title: "So teilen Sie XPS-Dateien"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie XPS-Dokumente teilen und ausgewählte Seiten als neue Datei speichern. Verbessern Sie die Dokumentenverarbeitung in Ihren .NET-Anwendungen.
      
      1. Geben Sie den Quellpfad der XPS-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "XPS-Dokument teilen und gerade Seiten speichern"
      content: |
        Dieses Beispiel zeigt, wie man ein XPS-Dokument teilt und alle geraden Seiten als separate Datei speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
