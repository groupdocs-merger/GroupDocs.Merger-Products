...
############################# Head ############################
head_title: "Teilen Sie XPS in mehrere Dateien in C#"
...
############################# Header ############################
title: "XPS Splittereingang C#"
description: "Teilen Sie XPS mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie XPS Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne XPS-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie XPS-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die XPS-Datei mithilfe der GroupDocs.Merger-API
