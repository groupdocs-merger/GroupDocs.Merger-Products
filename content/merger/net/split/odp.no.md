...
############################# Head ############################
head_title: "Del ODP i flere filer i C#"
...
description: "Del ODP med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del ODP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt ODP-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp ODP filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del ODP-filen ved hjelp av GroupDocs.Merger API
