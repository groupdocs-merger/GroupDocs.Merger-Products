...
############################# Head ############################
head_title: "Rozdeliť VSSX do viacerých súborov v C#"
...
############################# Header ############################
title: "VSSX Splitter v C#"
description: "Rozdeľte VSSX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSSX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSSX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSSX pomocou rozhrania GroupDocs.Merger API
