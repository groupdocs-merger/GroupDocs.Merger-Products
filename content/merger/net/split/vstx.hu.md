...
############################# Head ############################
head_title: "A(z) VSTX felosztása több fájlra a C# programban"
...
description: "Oszd fel az VSTX elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "VSTX fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen VSTX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTX fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az VSTX fájl felosztása a GroupDocs.Merger API segítségével
