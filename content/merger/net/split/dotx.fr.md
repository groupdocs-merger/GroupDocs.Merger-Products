...
############################# Head ############################
head_title: "Divisez DOTX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOTX Séparateur dans C#"
description: "Divisez DOTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOTX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOTX à l'aide de l'API GroupDocs.Merger
