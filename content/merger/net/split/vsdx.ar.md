...
############################# Head ############################
head_title: "تقسيم VSDX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "VSDX الفاصل في C#"
description: "قسِّم VSDX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات VSDX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد VSDX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات VSDX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف VSDX باستخدام GroupDocs.Merger API
