...
############################# Head ############################
head_title: "Divida VSSM em vários arquivos em C#"
...
############################# Header ############################
title: "VSSM Divisor em C#"
description: "Divida VSSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSSM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSSM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSSM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSSM usando a API GroupDocs.Merger
