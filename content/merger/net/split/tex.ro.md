...
############################# Head ############################
head_title: "Împărțiți TEX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter TEX în C#"
description: "Împărțiți TEX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere TEX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier TEX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere TEX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul TEX utilizând API-ul GroupDocs.Merger
