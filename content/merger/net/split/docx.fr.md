...
############################# Head ############################
head_title: "Divisez DOCX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOCX Séparateur dans C#"
description: "Divisez DOCX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOCX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOCX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOCX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOCX à l'aide de l'API GroupDocs.Merger
