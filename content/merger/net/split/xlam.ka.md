...
############################# Head ############################
head_title: "დაყავით XLAM მრავალ ფაილად C#-ში"
head_description: "დაყავით ერთი XLAM ფაილი რამდენიმე ფაილად გვერდების ნომრების, გვერდების ინტერვალების, ლუწი ან კენტი გვერდების საფუძველზე დოკუმენტების შერწყმის API-ს გამოყენებით."

############################# Header ############################
title: "XLAM სპლიტერი C#-ში"
description: "გაყავით XLAM .NET კოდის რამდენიმე ხაზით."
...
steps:
    enable: true
    title_left: "გაყავით XLAM ფაილის გვერდები .NET-ში"
    content_left: |
        [GroupDocs.Merger for .NET](/ka/merger/net/) უადვილებს C#-ის დეველოპერებს ერთი XLAM ფაილის დაყოფა მრავალ შედეგიან ფაილად დანერგვით რამდენიმე მარტივი ნაბიჯი.
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ გავყოთ XLAM ფაილი C#-ის მაგალითის კოდის გამოყენებით">}}

        ```csharp    
        // გაყავით XLAM ფაილი GroupDocs.Merger API-ის გამოყენებით
...
demos:
    enable: true
    title: "ცოცხალი დემო - გაყოფა XLAM ფაილი ონლაინ"
    content: |
       გაყავით XLAM ფაილი ახლავე, ეწვიეთ [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlam) ვებსაიტს.
