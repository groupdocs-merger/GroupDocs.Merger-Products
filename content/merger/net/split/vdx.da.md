...
############################# Head ############################
head_title: "Opdel VDX i flere filer i C#"
...
description: "Opdel VDX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt VDX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles VDX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel VDX fil ved hjælp af GroupDocs.Merger API
