...
############################# Head ############################
head_title: "Jaa OTP useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "OTP Jakaja sisään C#"
description: "Jaa OTP muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa OTP tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden OTP-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa OTP tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto OTP GroupDocs.Merger API:lla
