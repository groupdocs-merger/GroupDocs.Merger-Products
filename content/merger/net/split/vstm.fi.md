...
############################# Head ############################
head_title: "Jaa VSTM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSTM Jakaja sisään C#"
description: "Jaa VSTM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSTM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSTM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSTM GroupDocs.Merger API:lla
