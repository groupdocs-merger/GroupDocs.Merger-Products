...
############################# Head ############################
head_title: "Jagage DOC mitmeks failiks rakenduses C#"
...
description: "Tükeldage DOC mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOC faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks DOC-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada DOC faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail DOC, kasutades GroupDocs.Merger API-t
