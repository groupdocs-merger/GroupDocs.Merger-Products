...
############################# Head ############################
head_title: "Rozdeliť XLTM do viacerých súborov v C#"
...
############################# Header ############################
title: "XLTM Splitter v C#"
description: "Rozdeľte XLTM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLTM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLTM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLTM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLTM pomocou rozhrania GroupDocs.Merger API
