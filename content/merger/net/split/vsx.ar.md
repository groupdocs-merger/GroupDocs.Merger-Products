...
############################# Head ############################
head_title: "تقسيم VSX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "VSX الفاصل في C#"
description: "قسِّم VSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات VSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد VSX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات VSX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف VSX باستخدام GroupDocs.Merger API
