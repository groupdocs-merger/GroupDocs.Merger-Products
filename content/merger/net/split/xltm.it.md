...
############################# Head ############################
head_title: "Dividi XLTM in più file in C#"
...
############################# Header ############################
title: "XLTM Separatore in C#"
description: "Dividi XLTM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLTM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLTM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLTM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLTM utilizzando l'API GroupDocs.Merger
