...
############################# Head ############################
head_title: "Разделете TSV на няколко файла в C#"
...
############################# Header ############################
title: "TSV Сплитер в C#"
description: "Разделете TSV с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разделете TSV файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разделят един файл TSV на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделяте TSV файлове с помощта на C# примерен код">}}

        ```csharp    
        // Разделете файла TSV с помощта на API на GroupDocs.Merger
