...
############################# Head ############################
head_title: "Dela upp XLTX i flera filer i C#"
...
description: "Dela upp XLTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLTX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLTX-fil med GroupDocs.Merger API
