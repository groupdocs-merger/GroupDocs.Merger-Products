...
############################# Head ############################
head_title: "Podijeli PPT u više datoteka u C#"
...
############################# Header ############################
title: "PPT Splitter u C#"
description: "Podijelite PPT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli PPT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne PPT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli PPT datoteku pomoću API-ja GroupDocs.Merger
