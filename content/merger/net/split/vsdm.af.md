...
############################# Head ############################
head_title: "Verdeel VSDM in veelvuldige lêers in C#"
...
############################# Header ############################
title: "VSDM Splitter in C#"
description: "Verdeel VSDM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSDM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VSDM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSDM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VSDM lêer deur GroupDocs.Merger API te gebruik
