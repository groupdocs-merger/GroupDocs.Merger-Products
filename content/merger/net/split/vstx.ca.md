...
############################# Head ############################
head_title: "Dividiu VSTX en diversos fitxers a C#"
...
############################# Header ############################
title: "VSTX Divisor a C#"
description: "Dividiu VSTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers VSTX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer VSTX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers VSTX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer VSTX mitjançant l'API de GroupDocs.Merger
