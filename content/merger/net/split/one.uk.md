...
############################# Head ############################
head_title: "Розділити ONE на кілька файлів у C#"
...
############################# Header ############################
title: "ONE Спліттер у C#"
description: "Розділіть ONE кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Розділити ONE сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко розділити один файл ONE на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файли ONE за допомогою прикладу коду C#">}}

        ```csharp    
        // Розділіть файл ONE за допомогою API GroupDocs.Merger
