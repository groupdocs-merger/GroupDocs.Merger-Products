...
############################# Head ############################
head_title: "Dela upp PDF i flera filer i C#"
head_description: "Dela upp en enda PDF-fil i flera filer baserat på sidnummer, sidintervall, jämna eller udda sidor med hjälp av dokumentsammanslagnings-API."

############################# Header ############################
title: "PDF splitter i C#"
description: "Dela upp PDF med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp PDF filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda PDF-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PDF-filer med hjälp av C# exempelkod">}}
...
demos:
    enable: true
    title: "Livedemos - Split PDF fil online"
    content: |
       Dela upp PDF-filen just nu genom att besöka webbplatsen [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
