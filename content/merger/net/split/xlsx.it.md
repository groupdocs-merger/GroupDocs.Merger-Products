...
############################# Head ############################
head_title: "Dividi XLSX in più file in C#"
...
############################# Header ############################
title: "XLSX Separatore in C#"
description: "Dividi XLSX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLSX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLSX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLSX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLSX utilizzando l'API GroupDocs.Merger
