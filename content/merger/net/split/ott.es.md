...
############################# Head ############################
head_title: "Dividir OTT en varios archivos en C#"
...
############################# Header ############################
title: "OTT Divisor en C#"
description: "Divida OTT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir OTT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo OTT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos OTT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo OTT usando GroupDocs.Merger API
