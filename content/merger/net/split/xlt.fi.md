...
############################# Head ############################
head_title: "Jaa XLT useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLT Jakaja sisään C#"
description: "Jaa XLT muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLT GroupDocs.Merger API:lla
