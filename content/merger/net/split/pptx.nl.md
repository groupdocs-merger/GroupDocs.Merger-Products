...
############################# Head ############################
head_title: "Splits PPTX in meerdere bestanden in C#"
...
description: "Splits PPTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits PPTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel PPTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPTX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits PPTX bestand met behulp van GroupDocs.Merger API
