...
############################# Head ############################
head_title: "Podijeli EPUB u više datoteka u C#"
...
############################# Header ############################
title: "EPUB Splitter u C#"
description: "Podijelite EPUB s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli EPUB stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne EPUB datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti EPUB datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli EPUB datoteku pomoću API-ja GroupDocs.Merger
