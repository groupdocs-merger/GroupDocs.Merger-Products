...
############################# Head ############################
head_title: "Jagage PPT mitmeks failiks rakenduses C#"
...
description: "Tükeldage PPT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks PPT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada PPT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail PPT, kasutades GroupDocs.Merger API-t
