...
############################# Head ############################
head_title: "Jaa CSV useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "CSV Jakaja sisään C#"
description: "Jaa CSV muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa CSV tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden CSV-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa CSV tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto CSV GroupDocs.Merger API:lla
