...
############################# Head ############################
head_title: "Dividir DOTX en varios archivos en C#"
...
############################# Header ############################
title: "DOTX Divisor en C#"
description: "Divida DOTX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOTX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOTX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOTX usando GroupDocs.Merger API
