...
############################# Head ############################
head_title: "Dividir PPSX en varios archivos en C#"
...
############################# Header ############################
title: "PPSX Divisor en C#"
description: "Divida PPSX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir PPSX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo PPSX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos PPSX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo PPSX usando GroupDocs.Merger API
