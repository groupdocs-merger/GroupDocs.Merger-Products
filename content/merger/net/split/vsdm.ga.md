...
############################# Head ############################
head_title: "Scoilt VSDM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSDM Scoilteoir i C#"
description: "Scoilt VSDM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSDM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSDM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSDM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSDM comhad ag baint úsáide as GroupDocs.Merger API
