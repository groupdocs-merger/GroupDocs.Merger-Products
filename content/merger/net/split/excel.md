...
############################# Head ############################
head_title: "Split EXCEL into Multiple Files in C#"
...
############################# Header ############################
title: "EXCEL Splitter In C#"
description: "Split EXCEL with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single EXCEL file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split EXCEL files using C# example code">}}
