...
############################# Head ############################
head_title: "Podijeli TEX u više datoteka u C#"
...
############################# Header ############################
title: "TEX Splitter u C#"
description: "Podijelite TEX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli TEX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne TEX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti TEX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli TEX datoteku pomoću API-ja GroupDocs.Merger
