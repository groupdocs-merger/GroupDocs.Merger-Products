...
############################# Head ############################
head_title: "Dividi PPS in più file in C#"
...
############################# Header ############################
title: "PPS Separatore in C#"
description: "Dividi PPS con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file PPS in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file PPS in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file PPS utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file PPS utilizzando l'API GroupDocs.Merger
