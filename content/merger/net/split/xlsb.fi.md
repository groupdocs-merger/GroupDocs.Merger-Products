...
############################# Head ############################
head_title: "Jaa XLSB useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLSB Jakaja sisään C#"
description: "Jaa XLSB muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLSB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLSB-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLSB tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLSB GroupDocs.Merger API:lla
