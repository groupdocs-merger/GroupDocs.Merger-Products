...
############################# Head ############################
head_title: "Jagage ONE mitmeks failiks rakenduses C#"
...
description: "Tükeldage ONE mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage ONE faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks ONE-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada ONE faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail ONE, kasutades GroupDocs.Merger API-t
