...
############################# Head ############################
head_title: "Podziel VSDM na wiele plików w C#"
...
############################# Header ############################
title: "VSDM Rozdzielacz w C#"
description: "Podziel VSDM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSDM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSDM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSDM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSDM za pomocą GroupDocs.Merger API
