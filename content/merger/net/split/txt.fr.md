...
############################# Head ############################
head_title: "Divisez TXT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "TXT Séparateur dans C#"
description: "Divisez TXT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner TXT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier TXT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers TXT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier TXT à l'aide de l'API GroupDocs.Merger
