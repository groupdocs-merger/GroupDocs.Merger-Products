...
############################# Head ############################
head_title: "Pisahkan VSTM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSTM Pemisah Dalam C#"
description: "Pisahkan VSTM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSTM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSTM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSTM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSTM menggunakan API GroupDocs.Merger
