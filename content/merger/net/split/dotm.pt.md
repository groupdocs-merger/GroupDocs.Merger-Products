...
############################# Head ############################
head_title: "Divida DOTM em vários arquivos em C#"
...
############################# Header ############################
title: "DOTM Divisor em C#"
description: "Divida DOTM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOTM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOTM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOTM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOTM usando a API GroupDocs.Merger
