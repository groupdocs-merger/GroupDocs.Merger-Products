...
############################# Head ############################
head_title: "Podijeli VDX u više datoteka u C#"
...
############################# Header ############################
title: "VDX Splitter u C#"
description: "Podijelite VDX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VDX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VDX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VDX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VDX datoteku pomoću API-ja GroupDocs.Merger
