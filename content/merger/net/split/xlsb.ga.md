...
############################# Head ############################
head_title: "Scoilt XLSB ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLSB Scoilteoir i C#"
description: "Scoilt XLSB le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLSB Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLSB a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLSB a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLSB comhad ag baint úsáide as GroupDocs.Merger API
