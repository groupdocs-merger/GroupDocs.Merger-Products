...
############################# Head ############################
head_title: "Dividi VSSX in più file in C#"
...
############################# Header ############################
title: "VSSX Separatore in C#"
description: "Dividi VSSX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file VSSX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file VSSX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file VSSX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file VSSX utilizzando l'API GroupDocs.Merger
