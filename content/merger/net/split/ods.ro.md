...
############################# Head ############################
head_title: "Împărțiți ODS în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter ODS în C#"
description: "Împărțiți ODS cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere ODS în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier ODS în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere ODS folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul ODS utilizând API-ul GroupDocs.Merger
