...
############################# Head ############################
head_title: "تقسيم TSV إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "TSV الفاصل في C#"
description: "قسِّم TSV ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات TSV في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد TSV إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات TSV باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف TSV باستخدام GroupDocs.Merger API
