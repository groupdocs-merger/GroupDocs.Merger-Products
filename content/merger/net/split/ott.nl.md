...
############################# Head ############################
head_title: "Splits OTT in meerdere bestanden in C#"
...
description: "Splits OTT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits OTT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel OTT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits OTT bestand met behulp van GroupDocs.Merger API
