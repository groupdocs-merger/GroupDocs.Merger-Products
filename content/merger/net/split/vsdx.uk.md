...
############################# Head ############################
head_title: "Розділити VSDX на кілька файлів у C#"
...
############################# Header ############################
title: "VSDX Спліттер у C#"
description: "Розділіть VSDX кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Розділити VSDX сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко розділити один файл VSDX на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файли VSDX за допомогою прикладу коду C#">}}

        ```csharp    
        // Розділіть файл VSDX за допомогою API GroupDocs.Merger
