...
############################# Head ############################
head_title: "Divida PPTX em vários arquivos em C#"
...
############################# Header ############################
title: "PPTX Divisor em C#"
description: "Divida PPTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo PPTX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo PPTX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos PPTX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo PPTX usando a API GroupDocs.Merger
