...
############################# Head ############################
head_title: "A(z) ODT felosztása több fájlra a C# programban"
...
description: "Oszd fel az ODT elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "ODT fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen ODT fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODT fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az ODT fájl felosztása a GroupDocs.Merger API segítségével
