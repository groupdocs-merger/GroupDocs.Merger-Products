...
############################# Head ############################
head_title: "Skiptu TEX í margar skrár í C#"
...
############################# Header ############################
title: "TEX Skerandi í C#"
description: "Skiptu TEX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu TEX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni TEX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta TEX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu TEX skrá með GroupDocs.Merger API
