...
############################# Head ############################
head_title: "Divida VSDX em vários arquivos em C#"
...
############################# Header ############################
title: "VSDX Divisor em C#"
description: "Divida VSDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSDX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSDX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSDX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSDX usando a API GroupDocs.Merger
