...
############################# Head ############################
head_title: "Împărțiți DOC în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter DOC în C#"
description: "Împărțiți DOC cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere DOC în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier DOC în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere DOC folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul DOC utilizând API-ul GroupDocs.Merger
