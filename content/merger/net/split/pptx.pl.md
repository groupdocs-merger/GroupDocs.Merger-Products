...
############################# Head ############################
head_title: "Podziel PPTX na wiele plików w C#"
...
############################# Header ############################
title: "PPTX Rozdzielacz w C#"
description: "Podziel PPTX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików PPTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku PPTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki PPTX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik PPTX za pomocą GroupDocs.Merger API
