...
############################# Head ############################
head_title: "TXT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "TXT Ayırıcı C#"
description: "TXT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "TXT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TXT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TXT dosyasını ayırın
