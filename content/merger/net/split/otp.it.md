...
############################# Head ############################
head_title: "Dividi OTP in più file in C#"
...
############################# Header ############################
title: "OTP Separatore in C#"
description: "Dividi OTP con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file OTP in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file OTP in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file OTP utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file OTP utilizzando l'API GroupDocs.Merger
