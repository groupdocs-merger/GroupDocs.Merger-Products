...
############################# Head ############################
head_title: "Scoilt DOCM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOCM Scoilteoir i C#"
description: "Scoilt DOCM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOCM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOCM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOCM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOCM comhad ag baint úsáide as GroupDocs.Merger API
