...
############################# Head ############################
head_title: "Skiptu PPTX í margar skrár í C#"
...
############################# Header ############################
title: "PPTX Skerandi í C#"
description: "Skiptu PPTX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu PPTX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni PPTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PPTX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu PPTX skrá með GroupDocs.Merger API
