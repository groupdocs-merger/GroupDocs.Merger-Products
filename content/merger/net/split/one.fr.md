...
############################# Head ############################
head_title: "Divisez ONE en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "ONE Séparateur dans C#"
description: "Divisez ONE avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner ONE pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier ONE en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers ONE à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier ONE à l'aide de l'API GroupDocs.Merger
