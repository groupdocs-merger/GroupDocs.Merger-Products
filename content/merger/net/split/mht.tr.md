...
############################# Head ############################
head_title: "MHT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "MHT Ayırıcı C#"
description: "MHT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "MHT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak MHT dosyasını ayırın
