...
############################# Head ############################
head_title: "Razdeli ODS na več datotek v C#"
...
############################# Header ############################
title: "ODS razdelilnik v C#"
description: "Razdelite ODS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli ODS strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke ODS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke ODS s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko ODS z API-jem GroupDocs.Merger
