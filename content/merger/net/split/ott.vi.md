...
############################# Head ############################
head_title: "Tách OTT thành nhiều tệp trong C#"
...
############################# Header ############################
title: "OTT Splitter trong C#"
description: "Tách OTT bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp OTT trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp OTT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp OTT bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp OTT bằng API GroupDocs.Merger
