...
############################# Head ############################
head_title: "Pisahkan dokumen POWERPOINT dalam aplikasi .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk memisahkan file POWERPOINT menjadi dokumen terpisah. Kelola file PDF, dokumen Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pisahkan file POWERPOINT" 
description: "GroupDocs.Merger for .NET meningkatkan aplikasi .NET dengan fitur pemrosesan dokumen canggih. Pisahkan file POWERPOINT dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memisahkan file POWERPOINT"
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), Anda dapat memisahkan dokumen POWERPOINT dan menyimpan halaman yang dipilih sebagai file baru. Tingkatkan pemrosesan dokumen dalam aplikasi .NET Anda.
      
      1. Tentukan jalur sumber dari file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pisahkan dokumen POWERPOINT dan simpan halaman genap"
      content: |
        Contoh ini menunjukkan cara memisahkan dokumen POWERPOINT dan menyimpan semua halaman genap sebagai file terpisah.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
