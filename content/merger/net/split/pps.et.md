...
############################# Head ############################
head_title: "Jagage PPS mitmeks failiks rakenduses C#"
...
description: "Tükeldage PPS mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage PPS faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks PPS-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada PPS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail PPS, kasutades GroupDocs.Merger API-t
