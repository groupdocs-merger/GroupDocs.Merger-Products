...
############################# Head ############################
head_title: "Opdel OTT i flere filer i C#"
...
description: "Opdel OTT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel OTT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt OTT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles OTT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel OTT fil ved hjælp af GroupDocs.Merger API
