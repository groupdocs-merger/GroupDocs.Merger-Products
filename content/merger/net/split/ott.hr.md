...
############################# Head ############################
head_title: "Podijeli OTT u više datoteka u C#"
...
############################# Header ############################
title: "OTT Splitter u C#"
description: "Podijelite OTT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli OTT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne OTT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti OTT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli OTT datoteku pomoću API-ja GroupDocs.Merger
