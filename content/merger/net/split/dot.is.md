...
############################# Head ############################
head_title: "Skiptu DOT í margar skrár í C#"
...
############################# Header ############################
title: "DOT Skerandi í C#"
description: "Skiptu DOT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOT skrá með GroupDocs.Merger API
