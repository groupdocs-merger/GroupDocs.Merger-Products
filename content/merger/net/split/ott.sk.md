...
############################# Head ############################
head_title: "Rozdeliť OTT do viacerých súborov v C#"
...
############################# Header ############################
title: "OTT Splitter v C#"
description: "Rozdeľte OTT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť OTT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor OTT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť OTT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor OTT pomocou rozhrania GroupDocs.Merger API
