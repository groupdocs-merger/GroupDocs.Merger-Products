...
############################# Head ############################
head_title: "Scoilt DOTM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOTM Scoilteoir i C#"
description: "Scoilt DOTM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOTM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOTM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOTM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOTM comhad ag baint úsáide as GroupDocs.Merger API
