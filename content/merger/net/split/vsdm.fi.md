...
############################# Head ############################
head_title: "Jaa VSDM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSDM Jakaja sisään C#"
description: "Jaa VSDM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSDM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSDM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSDM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSDM GroupDocs.Merger API:lla
