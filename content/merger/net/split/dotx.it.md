...
############################# Head ############################
head_title: "Dividi DOTX in più file in C#"
...
############################# Header ############################
title: "DOTX Separatore in C#"
description: "Dividi DOTX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOTX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOTX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOTX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOTX utilizzando l'API GroupDocs.Merger
