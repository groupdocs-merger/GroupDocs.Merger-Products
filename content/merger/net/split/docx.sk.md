...
############################# Head ############################
head_title: "Rozdeliť DOCX do viacerých súborov v C#"
...
############################# Header ############################
title: "DOCX Splitter v C#"
description: "Rozdeľte DOCX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOCX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOCX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOCX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOCX pomocou rozhrania GroupDocs.Merger API
