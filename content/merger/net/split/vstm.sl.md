...
############################# Head ############################
head_title: "Razdeli VSTM na več datotek v C#"
...
############################# Header ############################
title: "VSTM razdelilnik v C#"
description: "Razdelite VSTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSTM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSTM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSTM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSTM z API-jem GroupDocs.Merger
