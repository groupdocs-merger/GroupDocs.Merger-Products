...
############################# Head ############################
head_title: "PDF'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "PDF Ayırıcı C#"
description: "PDF kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "PDF Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PDF dosyasını ayırın
