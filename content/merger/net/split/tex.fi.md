...
############################# Head ############################
head_title: "Jaa TEX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "TEX Jakaja sisään C#"
description: "Jaa TEX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa TEX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden TEX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa TEX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto TEX GroupDocs.Merger API:lla
