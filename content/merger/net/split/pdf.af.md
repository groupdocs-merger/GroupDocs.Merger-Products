...
############################# Head ############################
head_title: "Verdeel PDF in veelvuldige lêers in C#"
...
description: "Verdeel PDF met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel PDF lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele PDF-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PDF lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel PDF lêer deur GroupDocs.Merger API te gebruik
