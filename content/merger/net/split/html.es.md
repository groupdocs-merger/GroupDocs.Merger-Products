...
############################# Head ############################
head_title: "Dividir HTML en varios archivos en C#"
...
############################# Header ############################
title: "HTML Divisor en C#"
description: "Divida HTML con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir HTML páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo HTML en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos HTML usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo HTML usando GroupDocs.Merger API
