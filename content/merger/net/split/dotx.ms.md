...
############################# Head ############################
head_title: "Pisahkan DOTX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "DOTX Pemisah Dalam C#"
description: "Pisahkan DOTX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan DOTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail DOTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi DOTX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail DOTX menggunakan API GroupDocs.Merger
