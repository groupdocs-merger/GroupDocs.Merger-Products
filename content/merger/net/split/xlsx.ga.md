...
############################# Head ############################
head_title: "Scoilt XLSX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLSX Scoilteoir i C#"
description: "Scoilt XLSX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLSX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLSX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLSX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLSX comhad ag baint úsáide as GroupDocs.Merger API
