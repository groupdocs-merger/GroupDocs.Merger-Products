...
############################# Head ############################
head_title: "XPS'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XPS Ayırıcı C#"
description: "XPS kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XPS Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XPS dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XPS dosyasını ayırın
