...
############################# Head ############################
head_title: "Splits VSTX in meerdere bestanden in C#"
...
############################# Header ############################
title: "VSTX Splitter in C#"
description: "Splits VSTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSTX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSTX bestand met behulp van GroupDocs.Merger API
