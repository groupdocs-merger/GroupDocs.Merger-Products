...
############################# Head ############################
head_title: "Dividi DOT in più file in C#"
...
############################# Header ############################
title: "DOT Separatore in C#"
description: "Dividi DOT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOT utilizzando l'API GroupDocs.Merger
