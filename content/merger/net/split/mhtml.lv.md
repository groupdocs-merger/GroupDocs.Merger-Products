...
############################# Head ############################
head_title: "Sadaliet MHTML vairākos failos programmā C#"
...
############################# Header ############################
title: "MHTML sadalītājs programmā C#"
description: "Sadaliet MHTML ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet MHTML faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu MHTML failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt MHTML failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet MHTML failu, izmantojot GroupDocs.Merger API
