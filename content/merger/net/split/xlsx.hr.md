...
############################# Head ############################
head_title: "Podijeli XLSX u više datoteka u C#"
...
############################# Header ############################
title: "XLSX Splitter u C#"
description: "Podijelite XLSX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLSX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLSX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLSX datoteku pomoću API-ja GroupDocs.Merger
