...
############################# Head ############################
head_title: "Dela upp PPTX i flera filer i C#"
...
description: "Dela upp PPTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp PPTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda PPTX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PPTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela PPTX-fil med GroupDocs.Merger API
