...
############################# Head ############################
head_title: "Skiptu RTF í margar skrár í C#"
...
############################# Header ############################
title: "RTF Skerandi í C#"
description: "Skiptu RTF með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu RTF skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni RTF skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta RTF skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu RTF skrá með GroupDocs.Merger API
