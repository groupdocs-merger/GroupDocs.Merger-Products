...
############################# Head ############################
head_title: "Padalinkite PPTX į kelis failus C#"
...
############################# Header ############################
title: "PPTX skirstytuvas C#"
description: "Padalinkite PPTX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite PPTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną PPTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti PPTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite PPTX failą naudodami GroupDocs.Merger API
