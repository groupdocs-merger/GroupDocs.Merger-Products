...
############################# Head ############################
head_title: "Jaa MHT useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "MHT Jakaja sisään C#"
description: "Jaa MHT muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa MHT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden MHT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa MHT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto MHT GroupDocs.Merger API:lla
