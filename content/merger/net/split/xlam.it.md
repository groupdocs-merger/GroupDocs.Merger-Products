...
############################# Head ############################
head_title: "Dividi XLAM in più file in C#"
...
############################# Header ############################
title: "XLAM Separatore in C#"
description: "Dividi XLAM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLAM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLAM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLAM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLAM utilizzando l'API GroupDocs.Merger
