...
############################# Head ############################
head_title: "Dividir ODS en varios archivos en C#"
...
############################# Header ############################
title: "ODS Divisor en C#"
description: "Divida ODS con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir ODS páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo ODS en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos ODS usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo ODS usando GroupDocs.Merger API
