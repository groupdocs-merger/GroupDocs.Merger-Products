...
############################# Head ############################
head_title: "A(z) TXT felosztása több fájlra a C# programban"
...
description: "Oszd fel az TXT elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "TXT fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen TXT fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TXT fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az TXT fájl felosztása a GroupDocs.Merger API segítségével
