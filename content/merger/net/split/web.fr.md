...
############################# Head ############################
head_title: "Divisez WEB en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "WEB Séparateur dans C#"
description: "Divisez WEB avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner WEB pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier WEB en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers WEB à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier WEB à l'aide de l'API GroupDocs.Merger
