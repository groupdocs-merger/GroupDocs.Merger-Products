...
############################# Head ############################
head_title: "Padalinkite RTF į kelis failus C#"
...
############################# Header ############################
title: "RTF skirstytuvas C#"
description: "Padalinkite RTF keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite RTF failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną RTF failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti RTF failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite RTF failą naudodami GroupDocs.Merger API
