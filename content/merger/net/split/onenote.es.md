...
############################# Head ############################
head_title: "Dividir ONENOTE en varios archivos en C#"
...
############################# Header ############################
title: "ONENOTE Divisor en C#"
description: "Divida ONENOTE con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir ONENOTE páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo ONENOTE en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos ONENOTE usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo ONENOTE usando GroupDocs.Merger API
