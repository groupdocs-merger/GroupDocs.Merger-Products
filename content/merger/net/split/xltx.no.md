...
############################# Head ############################
head_title: "Del XLTX i flere filer i C#"
...
description: "Del XLTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLTX-filen ved hjelp av GroupDocs.Merger API
