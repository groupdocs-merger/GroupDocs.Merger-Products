...
############################# Head ############################
head_title: "Divida PPSX em vários arquivos em C#"
...
############################# Header ############################
title: "PPSX Divisor em C#"
description: "Divida PPSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo PPSX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo PPSX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos PPSX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo PPSX usando a API GroupDocs.Merger
