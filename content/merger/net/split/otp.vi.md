...
############################# Head ############################
head_title: "Tách OTP thành nhiều tệp trong C#"
...
############################# Header ############################
title: "OTP Splitter trong C#"
description: "Tách OTP bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp OTP trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp OTP thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp OTP bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp OTP bằng API GroupDocs.Merger
