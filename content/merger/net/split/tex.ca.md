...
############################# Head ############################
head_title: "Dividiu TEX en diversos fitxers a C#"
...
############################# Header ############################
title: "TEX Divisor a C#"
description: "Dividiu TEX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers TEX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer TEX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers TEX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer TEX mitjançant l'API de GroupDocs.Merger
