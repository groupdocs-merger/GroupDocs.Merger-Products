...
############################# Head ############################
head_title: "Split VISIO documents in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to split VISIO files into separate documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, Visio files, images, archives, and more."

############################# Header ############################
title: "Split VISIO files" 
description: "GroupDocs.Merger for .NET enhances .NET applications with advanced document processing features. Easily split VISIO files and work with various popular business formats."
...
steps:
    enable: true
    title: "How to split VISIO files"
    content: |
      With [GroupDocs.Merger](/merger/net/), you can split VISIO documents and save selected pages as a new file. Enhance document processing in your .NET applications.
      
      1. Specify the source path of the VISIO file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Split VISIO document and save even-numbered pages"
      content: |
        This example shows how to split a VISIO document and save all even-numbered pages as a separate file.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Change orientation"
          ...
          link: "/merger/net/orientation/visio/"
