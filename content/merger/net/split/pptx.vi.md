...
############################# Head ############################
head_title: "Tách PPTX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "PPTX Splitter trong C#"
description: "Tách PPTX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp PPTX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp PPTX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp PPTX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp PPTX bằng API GroupDocs.Merger
