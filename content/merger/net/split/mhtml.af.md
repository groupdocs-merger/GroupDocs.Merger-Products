...
############################# Head ############################
head_title: "Verdeel MHTML in veelvuldige lêers in C#"
...
description: "Verdeel MHTML met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel MHTML lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele MHTML-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHTML lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel MHTML lêer deur GroupDocs.Merger API te gebruik
