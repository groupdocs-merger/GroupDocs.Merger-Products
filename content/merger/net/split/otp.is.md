...
############################# Head ############################
head_title: "Skiptu OTP í margar skrár í C#"
...
############################# Header ############################
title: "OTP Skerandi í C#"
description: "Skiptu OTP með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu OTP skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni OTP skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta OTP skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu OTP skrá með GroupDocs.Merger API
