...
############################# Head ############################
head_title: "Tách XPS thành nhiều tệp trong C#"
...
############################# Header ############################
title: "XPS Splitter trong C#"
description: "Tách XPS bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp XPS trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp XPS thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp XPS bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp XPS bằng API GroupDocs.Merger
