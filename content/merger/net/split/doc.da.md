...
############################# Head ############################
head_title: "Opdel DOC i flere filer i C#"
...
description: "Opdel DOC med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOC filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOC-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOC filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOC fil ved hjælp af GroupDocs.Merger API
