...
############################# Head ############################
head_title: "Razdeli XLT na več datotek v C#"
...
############################# Header ############################
title: "XLT razdelilnik v C#"
description: "Razdelite XLT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLT z API-jem GroupDocs.Merger
