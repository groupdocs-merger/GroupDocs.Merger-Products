...
############################# Head ############################
head_title: "Del MHT i flere filer i C#"
...
description: "Del MHT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt MHT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp MHT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del MHT-filen ved hjelp av GroupDocs.Merger API
