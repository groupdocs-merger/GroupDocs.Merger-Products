...
############################# Head ############################
head_title: "Scoilt HTML ina Ilchomhaid i C#"
...
############################# Header ############################
title: "HTML Scoilteoir i C#"
description: "Scoilt HTML le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt HTML Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin HTML a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid HTML a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt HTML comhad ag baint úsáide as GroupDocs.Merger API
