...
############################# Head ############################
head_title: "Razdeli OTP na več datotek v C#"
...
############################# Header ############################
title: "OTP razdelilnik v C#"
description: "Razdelite OTP z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli OTP strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke OTP na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke OTP s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko OTP z API-jem GroupDocs.Merger
