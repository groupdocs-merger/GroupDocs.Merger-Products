...
############################# Head ############################
head_title: "تقسيم PDF إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "PDF الفاصل في C#"
description: "قسِّم PDF ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات PDF في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد PDF إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات PDF باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف PDF باستخدام GroupDocs.Merger API
