...
############################# Head ############################
head_title: "Pisahkan PDF kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "PDF Pemisah Dalam C#"
description: "Pisahkan PDF dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan PDF Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail PDF kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi PDF fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail PDF menggunakan API GroupDocs.Merger
