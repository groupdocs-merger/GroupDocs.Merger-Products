...
############################# Head ############################
head_title: "Tách VTX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "VTX Splitter trong C#"
description: "Tách VTX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp VTX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp VTX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp VTX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp VTX bằng API GroupDocs.Merger
