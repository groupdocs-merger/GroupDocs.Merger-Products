...
############################# Head ############################
head_title: "HTML کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "HTML سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ HTML کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "HTML فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک HTML فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے HTML فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے HTML فائل کو تقسیم کریں۔
