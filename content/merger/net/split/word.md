...
############################# Head ############################
head_title: "Split WORD into Multiple Files in C#"
...
############################# Header ############################
title: "WORD Splitter In C#"
description: "Split WORD with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single WORD file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split WORD files using C# example code">}}
