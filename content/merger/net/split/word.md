...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to split a single WORD file into multiple resultant files by implementing a few easy steps.
