...
############################# Head ############################
head_title: "Padalinkite VSSX į kelis failus C#"
...
############################# Header ############################
title: "VSSX skirstytuvas C#"
description: "Padalinkite VSSX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSSX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSSX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSSX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSSX failą naudodami GroupDocs.Merger API
