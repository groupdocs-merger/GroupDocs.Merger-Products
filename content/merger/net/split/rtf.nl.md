...
############################# Head ############################
head_title: "Splits RTF in meerdere bestanden in C#"
...
description: "Splits RTF met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits RTF Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel RTF bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe RTF bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits RTF bestand met behulp van GroupDocs.Merger API
