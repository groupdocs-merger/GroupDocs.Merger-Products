...
############################# Head ############################
head_title: "Pisahkan CSV kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "CSV Pemisah Dalam C#"
description: "Pisahkan CSV dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan CSV Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail CSV kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi CSV fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail CSV menggunakan API GroupDocs.Merger
