...
############################# Head ############################
head_title: "Rozdeliť MHTML do viacerých súborov v C#"
...
description: "Rozdeľte MHTML niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť MHTML strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor MHTML na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť MHTML súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor MHTML pomocou rozhrania GroupDocs.Merger API
