...
############################# Head ############################
head_title: "Divisez XLTX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLTX Séparateur dans C#"
description: "Divisez XLTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLTX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLTX à l'aide de l'API GroupDocs.Merger
