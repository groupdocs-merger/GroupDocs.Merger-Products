...
############################# Head ############################
head_title: "Podijeli VSSX u više datoteka u C#"
...
############################# Header ############################
title: "VSSX Splitter u C#"
description: "Podijelite VSSX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSSX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSSX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSSX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSSX datoteku pomoću API-ja GroupDocs.Merger
