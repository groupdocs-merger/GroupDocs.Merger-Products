...
############################# Head ############################
head_title: "Dividiu VTX en diversos fitxers a C#"
...
############################# Header ############################
title: "VTX Divisor a C#"
description: "Dividiu VTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers VTX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer VTX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers VTX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer VTX mitjançant l'API de GroupDocs.Merger
