...
############################# Head ############################
head_title: "Opdel MHT i flere filer i C#"
...
description: "Opdel MHT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel MHT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt MHT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles MHT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel MHT fil ved hjælp af GroupDocs.Merger API
