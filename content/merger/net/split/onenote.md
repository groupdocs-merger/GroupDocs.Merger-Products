...
############################# Head ############################
head_title: "Split ONENOTE into Multiple Files in C#"
head_description: "Split a single ONENOTE file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "ONENOTE Splitter In C#"
description: "Split ONENOTE with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single ONENOTE file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split ONENOTE files using C# example code">}}
