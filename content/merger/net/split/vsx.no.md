...
############################# Head ############################
head_title: "Del VSX i flere filer i C#"
...
description: "Del VSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSX-filen ved hjelp av GroupDocs.Merger API
