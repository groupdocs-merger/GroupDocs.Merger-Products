...
############################# Head ############################
head_title: "Padalinkite VSDM į kelis failus C#"
...
############################# Header ############################
title: "VSDM skirstytuvas C#"
description: "Padalinkite VSDM keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSDM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSDM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSDM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSDM failą naudodami GroupDocs.Merger API
