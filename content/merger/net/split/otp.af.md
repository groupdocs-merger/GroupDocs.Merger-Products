...
############################# Head ############################
head_title: "Verdeel OTP in veelvuldige lêers in C#"
...
############################# Header ############################
title: "OTP Splitter in C#"
description: "Verdeel OTP met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel OTP lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele OTP-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om OTP lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel OTP lêer deur GroupDocs.Merger API te gebruik
