...
############################# Head ############################
head_title: "Sadaliet ODP vairākos failos programmā C#"
...
############################# Header ############################
title: "ODP sadalītājs programmā C#"
description: "Sadaliet ODP ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODP faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu ODP failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODP failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet ODP failu, izmantojot GroupDocs.Merger API
