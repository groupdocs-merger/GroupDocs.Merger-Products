...
############################# Head ############################
head_title: "Dela upp VTX i flera filer i C#"
...
############################# Header ############################
title: "VTX splitter i C#"
description: "Dela upp VTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VTX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VTX-fil med GroupDocs.Merger API
