...
############################# Head ############################
head_title: "Verdeel PPS in veelvuldige lêers in C#"
...
description: "Verdeel PPS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel PPS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele PPS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om PPS lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel PPS lêer deur GroupDocs.Merger API te gebruik
