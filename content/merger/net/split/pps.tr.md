...
############################# Head ############################
head_title: "PPS'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "PPS Ayırıcı C#"
description: "PPS kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "PPS Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PPS dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PPS dosyasını ayırın
