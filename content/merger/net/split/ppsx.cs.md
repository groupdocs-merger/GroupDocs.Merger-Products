...
############################# Head ############################
head_title: "Rozdělit PPSX do více souborů v C#"
...
description: "Rozdělte PPSX několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit PPSX stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru PPSX do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit PPSX soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor PPSX pomocí GroupDocs.Merger API
