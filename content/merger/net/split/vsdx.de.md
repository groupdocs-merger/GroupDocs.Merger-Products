...
############################# Head ############################
head_title: "Teilen Sie VSDX in mehrere Dateien in C#"
...
############################# Header ############################
title: "VSDX Splittereingang C#"
description: "Teilen Sie VSDX mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie VSDX Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne VSDX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie VSDX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die VSDX-Datei mithilfe der GroupDocs.Merger-API
