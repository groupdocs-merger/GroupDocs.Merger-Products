...
############################# Head ############################
head_title: "Dividi CSV in più file in C#"
...
############################# Header ############################
title: "CSV Separatore in C#"
description: "Dividi CSV con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file CSV in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file CSV in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file CSV utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file CSV utilizzando l'API GroupDocs.Merger
