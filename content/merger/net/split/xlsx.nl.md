...
############################# Head ############################
head_title: "Splits XLSX in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLSX Splitter in C#"
description: "Splits XLSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLSX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLSX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLSX bestand met behulp van GroupDocs.Merger API
