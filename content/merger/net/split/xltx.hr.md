...
############################# Head ############################
head_title: "Podijeli XLTX u više datoteka u C#"
...
############################# Header ############################
title: "XLTX Splitter u C#"
description: "Podijelite XLTX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLTX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLTX datoteku pomoću API-ja GroupDocs.Merger
