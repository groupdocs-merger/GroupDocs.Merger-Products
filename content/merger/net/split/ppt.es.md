...
############################# Head ############################
head_title: "Dividir PPT en varios archivos en C#"
...
############################# Header ############################
title: "PPT Divisor en C#"
description: "Divida PPT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir PPT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo PPT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos PPT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo PPT usando GroupDocs.Merger API
