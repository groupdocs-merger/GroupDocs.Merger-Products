...
############################# Head ############################
head_title: "Del HTML i flere filer i C#"
...
description: "Del HTML med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del HTML filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt HTML-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp HTML filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del HTML-filen ved hjelp av GroupDocs.Merger API
