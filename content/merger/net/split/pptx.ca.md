...
############################# Head ############################
head_title: "Dividiu PPTX en diversos fitxers a C#"
...
############################# Header ############################
title: "PPTX Divisor a C#"
description: "Dividiu PPTX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers PPTX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer PPTX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers PPTX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer PPTX mitjançant l'API de GroupDocs.Merger
