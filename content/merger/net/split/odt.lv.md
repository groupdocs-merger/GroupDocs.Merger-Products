...
############################# Head ############################
head_title: "Sadaliet ODT vairākos failos programmā C#"
...
############################# Header ############################
title: "ODT sadalītājs programmā C#"
description: "Sadaliet ODT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet ODT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu ODT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt ODT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet ODT failu, izmantojot GroupDocs.Merger API
