...
############################# Head ############################
head_title: "Dela upp XLSM i flera filer i C#"
...
############################# Header ############################
title: "XLSM splitter i C#"
description: "Dela upp XLSM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLSM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLSM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLSM-fil med GroupDocs.Merger API
