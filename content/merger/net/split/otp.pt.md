...
############################# Head ############################
head_title: "Divida OTP em vários arquivos em C#"
...
############################# Header ############################
title: "OTP Divisor em C#"
description: "Divida OTP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo OTP em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo OTP em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos OTP usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo OTP usando a API GroupDocs.Merger
