...
############################# Head ############################
head_title: "Sadaliet VSDM vairākos failos programmā C#"
...
############################# Header ############################
title: "VSDM sadalītājs programmā C#"
description: "Sadaliet VSDM ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSDM faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSDM failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSDM failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSDM failu, izmantojot GroupDocs.Merger API
