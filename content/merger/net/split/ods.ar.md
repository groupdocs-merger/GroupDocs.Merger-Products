...
############################# Head ############################
head_title: "تقسيم ODS إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "ODS الفاصل في C#"
description: "قسِّم ODS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات ODS في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد ODS إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات ODS باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف ODS باستخدام GroupDocs.Merger API
