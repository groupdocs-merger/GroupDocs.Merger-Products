...
############################# Head ############################
head_title: "Jaa EPUB useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "EPUB Jakaja sisään C#"
description: "Jaa EPUB muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa EPUB tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden EPUB-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa EPUB tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto EPUB GroupDocs.Merger API:lla
