...
############################# Head ############################
head_title: "Jaa VSDX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSDX Jakaja sisään C#"
description: "Jaa VSDX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSDX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSDX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSDX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSDX GroupDocs.Merger API:lla
