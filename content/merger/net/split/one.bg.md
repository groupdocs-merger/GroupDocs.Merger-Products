...
############################# Head ############################
head_title: "Split ONE into Multiple Files in C#"
...
description: "Split ONE with a few lines of .NET code."
...
steps:
    enable: true
    title_left: "Split ONE File Pages in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single ONE file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split ONE files using C# example code">}}

        ```csharp    
        // Split ONE file using GroupDocs.Merger API
