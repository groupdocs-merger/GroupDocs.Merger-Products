...
############################# Head ############################
head_title: "Dividi XLTX in più file in C#"
...
############################# Header ############################
title: "XLTX Separatore in C#"
description: "Dividi XLTX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLTX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLTX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLTX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLTX utilizzando l'API GroupDocs.Merger
