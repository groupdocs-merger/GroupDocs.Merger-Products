...
############################# Head ############################
head_title: "Sadaliet VSTX vairākos failos programmā C#"
...
############################# Header ############################
title: "VSTX sadalītājs programmā C#"
description: "Sadaliet VSTX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSTX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSTX failu, izmantojot GroupDocs.Merger API
