...
############################# Head ############################
head_title: "Dividir RTF en varios archivos en C#"
...
############################# Header ############################
title: "RTF Divisor en C#"
description: "Divida RTF con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir RTF páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo RTF en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos RTF usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo RTF usando GroupDocs.Merger API
