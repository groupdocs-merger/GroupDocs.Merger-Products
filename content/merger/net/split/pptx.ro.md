...
############################# Head ############################
head_title: "Împărțiți PPTX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter PPTX în C#"
description: "Împărțiți PPTX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere PPTX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier PPTX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere PPTX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul PPTX utilizând API-ul GroupDocs.Merger
