...
############################# Head ############################
head_title: "Dela upp PPS i flera filer i C#"
...
############################# Header ############################
title: "PPS splitter i C#"
description: "Dela upp PPS med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp PPS filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda PPS-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp PPS-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela PPS-fil med GroupDocs.Merger API
