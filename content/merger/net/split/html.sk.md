...
############################# Head ############################
head_title: "Rozdeliť HTML do viacerých súborov v C#"
...
############################# Header ############################
title: "HTML Splitter v C#"
description: "Rozdeľte HTML niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť HTML strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor HTML na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť HTML súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor HTML pomocou rozhrania GroupDocs.Merger API
