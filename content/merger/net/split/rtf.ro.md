...
############################# Head ############################
head_title: "Împărțiți RTF în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter RTF în C#"
description: "Împărțiți RTF cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere RTF în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier RTF în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere RTF folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul RTF utilizând API-ul GroupDocs.Merger
