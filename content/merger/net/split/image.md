...
############################# Head ############################
head_title: "Split IMAGE into Multiple Files in C#"
...
############################# Header ############################
title: "IMAGE Splitter In C#"
description: "Split IMAGE with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single IMAGE file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split IMAGE files using C# example code">}}
