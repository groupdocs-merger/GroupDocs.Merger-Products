...
############################# Head ############################
head_title: "Podijeli VSTM u više datoteka u C#"
...
############################# Header ############################
title: "VSTM Splitter u C#"
description: "Podijelite VSTM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VSTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VSTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VSTM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VSTM datoteku pomoću API-ja GroupDocs.Merger
