...
############################# Head ############################
head_title: "Dela upp MHT i flera filer i C#"
...
############################# Header ############################
title: "MHT splitter i C#"
description: "Dela upp MHT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp MHT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda MHT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp MHT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela MHT-fil med GroupDocs.Merger API
