...
############################# Head ############################
head_title: "Jaa MHTML useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "MHTML Jakaja sisään C#"
description: "Jaa MHTML muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa MHTML tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden MHTML-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa MHTML tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto MHTML GroupDocs.Merger API:lla
