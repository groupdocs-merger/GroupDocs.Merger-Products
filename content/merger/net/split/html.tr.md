...
############################# Head ############################
head_title: "HTML'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "HTML Ayırıcı C#"
description: "HTML kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "HTML Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak HTML dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak HTML dosyasını ayırın
