...
############################# Head ############################
head_title: "Sadaliet PPSX vairākos failos programmā C#"
...
############################# Header ############################
title: "PPSX sadalītājs programmā C#"
description: "Sadaliet PPSX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu PPSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet PPSX failu, izmantojot GroupDocs.Merger API
