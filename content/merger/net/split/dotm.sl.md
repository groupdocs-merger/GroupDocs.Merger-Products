...
############################# Head ############################
head_title: "Razdeli DOTM na več datotek v C#"
...
############################# Header ############################
title: "DOTM razdelilnik v C#"
description: "Razdelite DOTM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOTM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOTM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOTM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOTM z API-jem GroupDocs.Merger
