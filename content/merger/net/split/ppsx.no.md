...
############################# Head ############################
head_title: "Del PPSX i flere filer i C#"
...
description: "Del PPSX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del PPSX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt PPSX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PPSX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del PPSX-filen ved hjelp av GroupDocs.Merger API
