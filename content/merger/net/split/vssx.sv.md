...
############################# Head ############################
head_title: "Dela upp VSSX i flera filer i C#"
...
description: "Dela upp VSSX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSSX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSSX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSSX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSSX-fil med GroupDocs.Merger API
