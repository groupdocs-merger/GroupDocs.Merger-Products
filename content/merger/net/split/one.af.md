...
############################# Head ############################
head_title: "Verdeel ONE in veelvuldige lêers in C#"
...
description: "Verdeel ONE met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel ONE lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele ONE-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ONE lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel ONE lêer deur GroupDocs.Merger API te gebruik
