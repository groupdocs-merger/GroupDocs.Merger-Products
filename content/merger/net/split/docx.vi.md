...
############################# Head ############################
head_title: "Tách DOCX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "DOCX Splitter trong C#"
description: "Tách DOCX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp DOCX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp DOCX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp DOCX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp DOCX bằng API GroupDocs.Merger
