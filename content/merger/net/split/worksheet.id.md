...
############################# Head ############################
head_title: "Pisahkan WORKSHEET menjadi Beberapa File di C#"
...
############################# Header ############################
title: "WORKSHEET Pemisah Di C#"
description: "Pisahkan WORKSHEET dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan WORKSHEET Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file WORKSHEET menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file WORKSHEET menggunakan kode contoh C#">}}

        ```csharp    
        // Pisahkan file WORKSHEET menggunakan GroupDocs.Merger API
