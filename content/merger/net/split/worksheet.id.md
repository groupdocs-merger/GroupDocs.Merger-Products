...
head_title: "Pisahkan WORKSHEET menjadi Beberapa File di C# .NET"
head_description: "Pengguna C# .NET untuk membagi satu file WORKSHEET menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Pisahkan WORKSHEET Menjadi Beberapa File di .NET"
description: "Pisahkan satu file WORKSHEET menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Pisahkan Halaman File WORKSHEET di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk membagi satu file WORKSHEET menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan File WORKSHEET Online"
    content: |
        Pisahkan file WORKSHEET sekarang dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/WORKSHEET).
