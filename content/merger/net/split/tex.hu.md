...
############################# Head ############################
head_title: "A(z) TEX felosztása több fájlra a C# programban"
...
description: "Oszd fel az TEX elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "TEX fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen TEX fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TEX fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az TEX fájl felosztása a GroupDocs.Merger API segítségével
