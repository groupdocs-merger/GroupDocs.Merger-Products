...
############################# Head ############################
head_title: "DOTX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOTX Ayırıcı C#"
description: "DOTX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOTX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOTX dosyasını ayırın
