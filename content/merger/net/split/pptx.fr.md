...
############################# Head ############################
head_title: "Divisez PPTX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "PPTX Séparateur dans C#"
description: "Divisez PPTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner PPTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier PPTX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers PPTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier PPTX à l'aide de l'API GroupDocs.Merger
