...
############################# Head ############################
head_title: "Rozdělit DOTM do více souborů v C#"
...
############################# Header ############################
title: "DOTM Splitter v C#"
description: "Rozdělte DOTM několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit DOTM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru DOTM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit DOTM soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor DOTM pomocí GroupDocs.Merger API
