...
############################# Head ############################
head_title: "تقسيم EPUB إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "EPUB الفاصل في C#"
description: "قسِّم EPUB ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات EPUB في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد EPUB إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات EPUB باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف EPUB باستخدام GroupDocs.Merger API
