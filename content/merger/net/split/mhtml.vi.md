...
############################# Head ############################
head_title: "Tách MHTML thành nhiều tệp trong C#"
...
############################# Header ############################
title: "MHTML Splitter trong C#"
description: "Tách MHTML bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp MHTML trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp MHTML thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp MHTML bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp MHTML bằng API GroupDocs.Merger
