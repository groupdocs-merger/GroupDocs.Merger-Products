...
############################# Head ############################
head_title: "Dividir ODP en varios archivos en C#"
...
############################# Header ############################
title: "ODP Divisor en C#"
description: "Divida ODP con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir ODP páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo ODP en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos ODP usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo ODP usando GroupDocs.Merger API
