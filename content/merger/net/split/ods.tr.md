...
############################# Head ############################
head_title: "ODS'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "ODS Ayırıcı C#"
description: "ODS kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODS Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODS dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODS dosyasını ayırın
