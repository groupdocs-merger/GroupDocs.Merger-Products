...
############################# Head ############################
head_title: "Divida TXT em vários arquivos em C#"
...
############################# Header ############################
title: "TXT Divisor em C#"
description: "Divida TXT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo TXT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo TXT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos TXT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo TXT usando a API GroupDocs.Merger
