...
############################# Head ############################
head_title: "Разделете XLTX на няколко файла в C#"
...
############################# Header ############################
title: "XLTX Сплитер в C#"
description: "Разделете XLTX с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разделете XLTX файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разделят един файл XLTX на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделяте XLTX файлове с помощта на C# примерен код">}}

        ```csharp    
        // Разделете файла XLTX с помощта на API на GroupDocs.Merger
