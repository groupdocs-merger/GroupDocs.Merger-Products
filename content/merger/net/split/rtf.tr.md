...
############################# Head ############################
head_title: "RTF'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "RTF Ayırıcı C#"
description: "RTF kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "RTF Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak RTF dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak RTF dosyasını ayırın
