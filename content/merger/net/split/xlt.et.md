...
############################# Head ############################
head_title: "Jagage XLT mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLT, kasutades GroupDocs.Merger API-t
