...
############################# Head ############################
head_title: "Sadaliet XLSX vairākos failos programmā C#"
...
############################# Header ############################
title: "XLSX sadalītājs programmā C#"
description: "Sadaliet XLSX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLSX failu, izmantojot GroupDocs.Merger API
