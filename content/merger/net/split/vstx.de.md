...
############################# Head ############################
head_title: "Teilen Sie VSTX in mehrere Dateien in C#"
...
############################# Header ############################
title: "VSTX Splittereingang C#"
description: "Teilen Sie VSTX mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie VSTX Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne VSTX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie VSTX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die VSTX-Datei mithilfe der GroupDocs.Merger-API
