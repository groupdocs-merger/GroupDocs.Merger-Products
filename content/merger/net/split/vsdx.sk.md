...
############################# Head ############################
head_title: "Rozdeliť VSDX do viacerých súborov v C#"
...
############################# Header ############################
title: "VSDX Splitter v C#"
description: "Rozdeľte VSDX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VSDX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VSDX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VSDX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VSDX pomocou rozhrania GroupDocs.Merger API
