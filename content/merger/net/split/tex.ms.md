...
############################# Head ############################
head_title: "Pisahkan TEX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "TEX Pemisah Dalam C#"
description: "Pisahkan TEX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan TEX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail TEX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi TEX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail TEX menggunakan API GroupDocs.Merger
