...
############################# Head ############################
head_title: "Jaa VSX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSX Jakaja sisään C#"
description: "Jaa VSX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSX GroupDocs.Merger API:lla
