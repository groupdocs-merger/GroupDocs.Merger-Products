...
############################# Head ############################
head_title: "Verdeel MHT in veelvuldige lêers in C#"
...
description: "Verdeel MHT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel MHT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele MHT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om MHT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel MHT lêer deur GroupDocs.Merger API te gebruik
