...
############################# Head ############################
head_title: "Dela upp ODT i flera filer i C#"
...
############################# Header ############################
title: "ODT splitter i C#"
description: "Dela upp ODT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp ODT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda ODT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp ODT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela ODT-fil med GroupDocs.Merger API
