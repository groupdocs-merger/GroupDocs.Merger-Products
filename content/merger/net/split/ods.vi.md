...
############################# Head ############################
head_title: "Tách ODS thành nhiều tệp trong C#"
head_description: "Tách một tệp ODS thành nhiều tệp dựa trên số trang, khoảng trang, trang chẵn hoặc lẻ bằng cách sử dụng API hợp nhất tài liệu."

############################# Header ############################
title: "ODS Splitter trong C#"
description: "Tách ODS bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp ODS trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp ODS thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp ODS bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp ODS bằng API GroupDocs.Merger
