...
############################# Head ############################
head_title: "Dela upp HTML i flera filer i C#"
...
############################# Header ############################
title: "HTML splitter i C#"
description: "Dela upp HTML med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp HTML filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda HTML-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp HTML-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela HTML-fil med GroupDocs.Merger API
