...
############################# Head ############################
head_title: "Dela upp DOTX i flera filer i C#"
...
description: "Dela upp DOTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda DOTX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela DOTX-fil med GroupDocs.Merger API
