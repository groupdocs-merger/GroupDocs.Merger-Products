...
############################# Head ############################
head_title: "Splits MHT in meerdere bestanden in C#"
...
description: "Splits MHT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits MHT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel MHT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits MHT bestand met behulp van GroupDocs.Merger API
