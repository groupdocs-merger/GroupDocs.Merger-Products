...
############################# Head ############################
head_title: "Pisahkan ODS kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "ODS Pemisah Dalam C#"
description: "Pisahkan ODS dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan ODS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail ODS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi ODS fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail ODS menggunakan API GroupDocs.Merger
