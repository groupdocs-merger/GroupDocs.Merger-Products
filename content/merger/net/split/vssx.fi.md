...
############################# Head ############################
head_title: "Jaa VSSX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSSX Jakaja sisään C#"
description: "Jaa VSSX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSSX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSSX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSSX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSSX GroupDocs.Merger API:lla
