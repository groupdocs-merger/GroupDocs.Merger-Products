...
############################# Head ############################
head_title: "Împărțiți XPS în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter XPS în C#"
description: "Împărțiți XPS cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere XPS în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier XPS în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere XPS folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul XPS utilizând API-ul GroupDocs.Merger
