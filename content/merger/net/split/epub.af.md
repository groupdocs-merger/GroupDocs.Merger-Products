...
############################# Head ############################
head_title: "Verdeel EPUB in veelvuldige lêers in C#"
...
description: "Verdeel EPUB met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel EPUB lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele EPUB-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om EPUB lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel EPUB lêer deur GroupDocs.Merger API te gebruik
