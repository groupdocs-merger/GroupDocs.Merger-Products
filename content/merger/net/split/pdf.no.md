...
############################# Head ############################
head_title: "Del PDF i flere filer i C#"
head_description: "Del en enkelt PDF-fil i flere filer basert på sidetall, sideintervaller, partalls- eller oddetallssider ved hjelp av dokumentsammenslåings-API."

############################# Header ############################
title: "PDF splitter i C#"
description: "Del PDF med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt PDF-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PDF filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del PDF-filen ved hjelp av GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live-demoer - Del PDF-fil på nett"
    content: |
       Del opp PDF-filen akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pdf).
