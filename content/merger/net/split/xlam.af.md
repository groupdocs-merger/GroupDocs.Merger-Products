...
############################# Head ############################
head_title: "Verdeel XLAM in veelvuldige lêers in C#"
...
description: "Verdeel XLAM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLAM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLAM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLAM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLAM lêer deur GroupDocs.Merger API te gebruik
