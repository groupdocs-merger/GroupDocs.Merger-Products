...
############################# Head ############################
head_title: "Tách tài liệu EXCEL trong các ứng dụng .NET"
head_description: "Sử dụng GroupDocs.Merger for .NET để tách các tệp EXCEL thành các tài liệu riêng biệt. Quản lý PDF, tệp Word, bảng tính Excel, trang trình chiếu PowerPoint, tệp Visio, hình ảnh, tệp nén và nhiều hơn nữa."

############################# Header ############################
title: "Tách tệp EXCEL" 
description: "GroupDocs.Merger for .NET cải thiện các ứng dụng .NET với những tính năng xử lý tài liệu nâng cao. Tách tệp EXCEL và làm việc với nhiều định dạng kinh doanh phổ biến."
...
steps:
    enable: true
    title: "Cách tách tệp EXCEL"
    content: |
      Với [GroupDocs.Merger](/merger/net/), bạn có thể tách tài liệu EXCEL và lưu các trang đã chọn dưới dạng tệp mới. Nâng cao quá trình xử lý tài liệu trong các ứng dụng .NET của bạn.
      
      1. Xác định đường dẫn tệp nguồn của tệp EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tách tài liệu EXCEL và lưu các trang chẵn"
      content: |
        Ví dụ này cho thấy cách tách một tài liệu EXCEL và lưu tất cả các trang chẵn thành một tệp riêng.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
