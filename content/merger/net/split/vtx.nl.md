...
############################# Head ############################
head_title: "Splits VTX in meerdere bestanden in C#"
...
description: "Splits VTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VTX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VTX bestand met behulp van GroupDocs.Merger API
