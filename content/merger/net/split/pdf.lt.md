...
############################# Head ############################
head_title: "Padalinkite PDF į kelis failus C#"
...
############################# Header ############################
title: "PDF skirstytuvas C#"
description: "Padalinkite PDF keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite PDF failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną PDF failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti PDF failus naudojant C# pavyzdinį kodą">}}
