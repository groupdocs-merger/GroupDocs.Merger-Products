...
############################# Head ############################
head_title: "Padalinkite XLT į kelis failus C#"
...
############################# Header ############################
title: "XLT skirstytuvas C#"
description: "Padalinkite XLT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XLT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XLT failą naudodami GroupDocs.Merger API
