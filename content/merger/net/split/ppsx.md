...
############################# Head ############################
head_title: "Split PPSX into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single PPSX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split PPSX Into Multiple Files in .NET"
description: "Split a single PPSX file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split PPSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single PPSX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split PPSX file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split PPSX File Online"
    content: |
        Split PPSX file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/ppsx) website.
