...
############################# Head ############################
head_title: "Di C# de XLSB li Pir Pelan veqetînin"
...
############################# Header ############################
title: "XLSB Splitter Li C#"
description: "XLSB bi çend rêzikên koda .NET parçe bikin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XLSB parçe bikin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên C# re hêsan dike ku pelek yek XLSB li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên XLSB bi karanîna koda nimûneya C# dabeş dike">}}

        ```csharp    
        // Pelê XLSB bi karanîna GroupDocs.Merger API-ê veqetînin
