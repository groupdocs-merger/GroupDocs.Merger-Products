...
############################# Head ############################
head_title: "Pisahkan PPS kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "PPS Pemisah Dalam C#"
description: "Pisahkan PPS dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan PPS Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail PPS kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi PPS fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail PPS menggunakan API GroupDocs.Merger
