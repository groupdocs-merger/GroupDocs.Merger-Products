...
############################# Head ############################
head_title: "Opdel XLTM i flere filer i C#"
...
description: "Opdel XLTM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XLTM-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XLTM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XLTM fil ved hjælp af GroupDocs.Merger API
