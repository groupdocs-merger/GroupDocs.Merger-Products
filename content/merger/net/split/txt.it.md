...
############################# Head ############################
head_title: "Dividi TXT in più file in C#"
...
############################# Header ############################
title: "TXT Separatore in C#"
description: "Dividi TXT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file TXT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file TXT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file TXT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file TXT utilizzando l'API GroupDocs.Merger
