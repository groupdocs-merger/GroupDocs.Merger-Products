...
############################# Head ############################
head_title: "تقسيم PPT إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "PPT الفاصل في C#"
description: "قسِّم PPT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات PPT في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد PPT إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات PPT باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف PPT باستخدام GroupDocs.Merger API
