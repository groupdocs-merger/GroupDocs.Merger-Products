...
############################# Head ############################
head_title: "Sadaliet EPUB vairākos failos programmā C#"
...
############################# Header ############################
title: "EPUB sadalītājs programmā C#"
description: "Sadaliet EPUB ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet EPUB faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu EPUB failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt EPUB failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet EPUB failu, izmantojot GroupDocs.Merger API
