...
############################# Head ############################
head_title: "Rozdeliť DOCM do viacerých súborov v C#"
...
description: "Rozdeľte DOCM niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOCM strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOCM na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOCM súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOCM pomocou rozhrania GroupDocs.Merger API
