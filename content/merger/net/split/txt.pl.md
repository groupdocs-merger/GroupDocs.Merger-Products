...
############################# Head ############################
head_title: "Podziel TXT na wiele plików w C#"
...
############################# Header ############################
title: "TXT Rozdzielacz w C#"
description: "Podziel TXT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików TXT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku TXT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki TXT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik TXT za pomocą GroupDocs.Merger API
