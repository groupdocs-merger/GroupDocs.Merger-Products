...
############################# Head ############################
head_title: "Разделить PDF на несколько файлов на C#"
...
############################# Header ############################
title: "PDF Разделитель на C#"
description: "Разделите PDF страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Разделить страницы PDF документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко разделить один файл PDF на несколько результирующих файлов, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файлы PDF, используя пример кода C#">}}

        ```csharp    
        // Разделить файл PDF с помощью GroupDocs.Merger API
