...
############################# Head ############################
head_title: "Dela upp XLTM i flera filer i C#"
...
############################# Header ############################
title: "XLTM splitter i C#"
description: "Dela upp XLTM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLTM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLTM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLTM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLTM-fil med GroupDocs.Merger API
