...
############################# Head ############################
head_title: "Rozdělit MHT do více souborů v C#"
...
############################# Header ############################
title: "MHT Splitter v C#"
description: "Rozdělte MHT několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit MHT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru MHT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit MHT soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor MHT pomocí GroupDocs.Merger API
