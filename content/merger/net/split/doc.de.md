...
############################# Head ############################
head_title: "Teilen Sie DOC in mehrere Dateien in C#"
...
############################# Header ############################
title: "DOC Splittereingang C#"
description: "Teilen Sie DOC mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie DOC Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne DOC-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie DOC-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die DOC-Datei mithilfe der GroupDocs.Merger-API
