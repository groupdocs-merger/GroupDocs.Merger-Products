...
############################# Head ############################
head_title: "Divisez XLSB en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLSB Séparateur dans C#"
description: "Divisez XLSB avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLSB pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLSB en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLSB à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLSB à l'aide de l'API GroupDocs.Merger
