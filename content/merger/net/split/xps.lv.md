...
############################# Head ############################
head_title: "Sadaliet XPS vairākos failos programmā C#"
...
############################# Header ############################
title: "XPS sadalītājs programmā C#"
description: "Sadaliet XPS ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XPS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XPS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XPS failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XPS failu, izmantojot GroupDocs.Merger API
