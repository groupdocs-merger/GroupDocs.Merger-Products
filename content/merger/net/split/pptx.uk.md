...
############################# Head ############################
head_title: "Розділити PPTX на кілька файлів у C#"
...
############################# Header ############################
title: "PPTX Спліттер у C#"
description: "Розділіть PPTX кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Розділити PPTX сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко розділити один файл PPTX на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файли PPTX за допомогою прикладу коду C#">}}

        ```csharp    
        // Розділіть файл PPTX за допомогою API GroupDocs.Merger
