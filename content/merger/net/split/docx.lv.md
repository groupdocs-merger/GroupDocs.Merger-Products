...
############################# Head ############################
head_title: "Sadaliet DOCX vairākos failos programmā C#"
...
############################# Header ############################
title: "DOCX sadalītājs programmā C#"
description: "Sadaliet DOCX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet DOCX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu DOCX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt DOCX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet DOCX failu, izmantojot GroupDocs.Merger API
