...
############################# Head ############################
head_title: "Padalinkite TEX į kelis failus C#"
...
############################# Header ############################
title: "TEX skirstytuvas C#"
description: "Padalinkite TEX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite TEX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną TEX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti TEX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite TEX failą naudodami GroupDocs.Merger API
