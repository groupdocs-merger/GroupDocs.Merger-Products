...
head_title: "Pisahkan DOCM menjadi Beberapa File di C# .NET"
head_description: "Pengguna C# .NET untuk membagi satu file DOCM menjadi beberapa file berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen."

title: "Pisahkan DOCM Menjadi Beberapa File di .NET"
description: "Pisahkan satu file DOCM menjadi beberapa file yang dihasilkan berdasarkan nomor halaman, interval halaman, halaman genap atau ganjil menggunakan API penggabungan dokumen untuk aplikasi .NET (C#, ASP.NET, VB.NET, .NET Core)."
...
steps:
    enable: true
    title_left: "Pisahkan Halaman File DOCM di .NET"
    content_left: |
        [GroupDocs.Merger](/id/merger/net/) memudahkan pengembang .NET untuk membagi satu file DOCM menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
        ```cs
        // Pisahkan file DOCM menggunakan GroupDocs.Merger API
...
demos:
    enable: true
    title: "Demo Langsung - Pisahkan File DOCM Online"
    content: |
        Pisahkan file DOCM sekarang dengan mengunjungi situs web [GroupDocs.Merger](https://products.groupdocs.app/splitter/DOCM).
