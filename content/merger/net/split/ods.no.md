...
############################# Head ############################
head_title: "Del ODS i flere filer i C#"
...
description: "Del ODS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del ODS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt ODS-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp ODS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del ODS-filen ved hjelp av GroupDocs.Merger API
