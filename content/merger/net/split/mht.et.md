...
############################# Head ############################
head_title: "Jagage MHT mitmeks failiks rakenduses C#"
...
description: "Tükeldage MHT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage MHT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks MHT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada MHT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail MHT, kasutades GroupDocs.Merger API-t
