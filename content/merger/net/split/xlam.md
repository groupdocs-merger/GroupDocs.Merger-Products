...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single XLAM file into multiple resultant files by implementing a few easy steps.
