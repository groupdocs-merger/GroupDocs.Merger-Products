...
############################# Head ############################
head_title: "Podziel PPSX na wiele plików w C#"
...
############################# Header ############################
title: "PPSX Rozdzielacz w C#"
description: "Podziel PPSX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików PPSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku PPSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki PPSX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik PPSX za pomocą GroupDocs.Merger API
