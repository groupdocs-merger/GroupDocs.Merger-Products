...
############################# Head ############################
head_title: "Verdeel ODS in veelvuldige lêers in C#"
...
description: "Verdeel ODS met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel ODS lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele ODS-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODS lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel ODS lêer deur GroupDocs.Merger API te gebruik
