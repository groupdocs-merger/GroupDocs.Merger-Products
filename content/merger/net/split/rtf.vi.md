...
############################# Head ############################
head_title: "Tách RTF thành nhiều tệp trong C#"
...
############################# Header ############################
title: "RTF Splitter trong C#"
description: "Tách RTF bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp RTF trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp RTF thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp RTF bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp RTF bằng API GroupDocs.Merger
