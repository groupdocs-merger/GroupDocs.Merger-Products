...
############################# Head ############################
head_title: "Razdeli PPSX na več datotek v C#"
...
############################# Header ############################
title: "PPSX razdelilnik v C#"
description: "Razdelite PPSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli PPSX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke PPSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke PPSX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko PPSX z API-jem GroupDocs.Merger
