...
############################# Head ############################
head_title: "Skiptu EPUB í margar skrár í C#"
...
############################# Header ############################
title: "EPUB Skerandi í C#"
description: "Skiptu EPUB með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu EPUB skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni EPUB skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta EPUB skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu EPUB skrá með GroupDocs.Merger API
