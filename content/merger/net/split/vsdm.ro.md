...
############################# Head ############################
head_title: "Împărțiți VSDM în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VSDM în C#"
description: "Împărțiți VSDM cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VSDM în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VSDM în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VSDM folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VSDM utilizând API-ul GroupDocs.Merger
