...
############################# Head ############################
head_title: "Pisahkan MHTML kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "MHTML Pemisah Dalam C#"
description: "Pisahkan MHTML dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan MHTML Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail MHTML kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi MHTML fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail MHTML menggunakan API GroupDocs.Merger
