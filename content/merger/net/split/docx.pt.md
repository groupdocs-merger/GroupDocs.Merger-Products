...
############################# Head ############################
head_title: "Divida DOCX em vários arquivos em C#"
...
############################# Header ############################
title: "DOCX Divisor em C#"
description: "Divida DOCX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOCX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOCX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOCX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOCX usando a API GroupDocs.Merger
