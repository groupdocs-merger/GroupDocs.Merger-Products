...
############################# Head ############################
head_title: "Rozdělit TXT do více souborů v C#"
...
description: "Rozdělte TXT několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit TXT stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru TXT do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit TXT soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor TXT pomocí GroupDocs.Merger API
