...
############################# Head ############################
head_title: "Podziel DOCM na wiele plików w C#"
...
############################# Header ############################
title: "DOCM Rozdzielacz w C#"
description: "Podziel DOCM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOCM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOCM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOCM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOCM za pomocą GroupDocs.Merger API
