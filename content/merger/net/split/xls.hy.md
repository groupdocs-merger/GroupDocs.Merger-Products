...
############################# Head ############################
head_title: "Բաժանել XLS-ը մի քանի ֆայլերի C#-ում"
...
############################# Header ############################
title: "XLS Splitter C#-ում"
description: "Բաժանեք XLS-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել XLS ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար մեկ XLS ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել XLS ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Բաժանեք XLS ֆայլը` օգտագործելով GroupDocs.Merger API
