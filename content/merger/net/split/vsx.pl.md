...
############################# Head ############################
head_title: "Podziel VSX na wiele plików w C#"
...
############################# Header ############################
title: "VSX Rozdzielacz w C#"
description: "Podziel VSX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSX za pomocą GroupDocs.Merger API
