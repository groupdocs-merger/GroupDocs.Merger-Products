...
############################# Head ############################
head_title: "Rozdeliť XLTX do viacerých súborov v C#"
...
############################# Header ############################
title: "XLTX Splitter v C#"
description: "Rozdeľte XLTX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLTX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLTX pomocou rozhrania GroupDocs.Merger API
