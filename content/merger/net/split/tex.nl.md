...
############################# Head ############################
head_title: "Splits TEX in meerdere bestanden in C#"
...
description: "Splits TEX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits TEX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel TEX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe TEX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits TEX bestand met behulp van GroupDocs.Merger API
