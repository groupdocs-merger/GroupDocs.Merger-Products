...
############################# Head ############################
head_title: "Scoilt VSSX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSSX Scoilteoir i C#"
description: "Scoilt VSSX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSSX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSSX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSSX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSSX comhad ag baint úsáide as GroupDocs.Merger API
