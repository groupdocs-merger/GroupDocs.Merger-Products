...
############################# Head ############################
head_title: "Verdeel TXT in veelvuldige lêers in C#"
...
description: "Verdeel TXT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel TXT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele TXT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TXT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel TXT lêer deur GroupDocs.Merger API te gebruik
