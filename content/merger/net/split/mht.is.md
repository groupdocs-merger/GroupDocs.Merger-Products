...
############################# Head ############################
head_title: "Skiptu MHT í margar skrár í C#"
...
############################# Header ############################
title: "MHT Skerandi í C#"
description: "Skiptu MHT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu MHT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni MHT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta MHT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu MHT skrá með GroupDocs.Merger API
