...
############################# Head ############################
head_title: "Rozdělit XLTM do více souborů v C#"
...
description: "Rozdělte XLTM několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit XLTM stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru XLTM do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit XLTM soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor XLTM pomocí GroupDocs.Merger API
