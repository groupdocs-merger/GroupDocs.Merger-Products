...
############################# Head ############################
head_title: "VSTM'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSTM Ayırıcı C#"
description: "VSTM kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSTM Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSTM dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSTM dosyasını ayırın
