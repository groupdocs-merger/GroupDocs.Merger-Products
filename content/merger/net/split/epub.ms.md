...
############################# Head ############################
head_title: "Pisahkan EPUB kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "EPUB Pemisah Dalam C#"
description: "Pisahkan EPUB dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan EPUB Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail EPUB kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi EPUB fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail EPUB menggunakan API GroupDocs.Merger
