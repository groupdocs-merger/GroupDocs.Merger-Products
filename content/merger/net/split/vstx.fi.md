...
############################# Head ############################
head_title: "Jaa VSTX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "VSTX Jakaja sisään C#"
description: "Jaa VSTX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa VSTX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden VSTX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa VSTX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto VSTX GroupDocs.Merger API:lla
