...
############################# Head ############################
head_title: "DOC'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOC Ayırıcı C#"
description: "DOC kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOC Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOC dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOC dosyasını ayırın
