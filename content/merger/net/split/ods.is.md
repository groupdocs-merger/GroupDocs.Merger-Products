...
############################# Head ############################
head_title: "Skiptu ODS í margar skrár í C#"
...
############################# Header ############################
title: "ODS Skerandi í C#"
description: "Skiptu ODS með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODS skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni ODS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODS skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu ODS skrá með GroupDocs.Merger API
