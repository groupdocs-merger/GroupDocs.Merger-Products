...
############################# Head ############################
head_title: "Jagage XLSB mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLSB mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLSB faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLSB-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLSB faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLSB, kasutades GroupDocs.Merger API-t
