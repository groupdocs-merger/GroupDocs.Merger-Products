...
############################# Head ############################
head_title: "Splits DOTX in meerdere bestanden in C#"
...
description: "Splits DOTX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOTX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOTX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOTX bestand met behulp van GroupDocs.Merger API
