...
############################# Head ############################
head_title: "تقسيم MHTML إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "MHTML الفاصل في C#"
description: "قسِّم MHTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات MHTML في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد MHTML إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات MHTML باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف MHTML باستخدام GroupDocs.Merger API
