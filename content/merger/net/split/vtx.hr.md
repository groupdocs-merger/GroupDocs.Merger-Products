...
############################# Head ############################
head_title: "Podijeli VTX u više datoteka u C#"
...
############################# Header ############################
title: "VTX Splitter u C#"
description: "Podijelite VTX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli VTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne VTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti VTX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli VTX datoteku pomoću API-ja GroupDocs.Merger
