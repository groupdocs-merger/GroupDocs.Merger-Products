...
############################# Head ############################
head_title: "Teilen Sie TXT in mehrere Dateien in C#"
...
############################# Header ############################
title: "TXT Splittereingang C#"
description: "Teilen Sie TXT mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie TXT Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne TXT-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie TXT-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die TXT-Datei mithilfe der GroupDocs.Merger-API
