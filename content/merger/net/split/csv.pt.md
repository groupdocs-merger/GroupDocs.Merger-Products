...
############################# Head ############################
head_title: "Divida CSV em vários arquivos em C#"
...
############################# Header ############################
title: "CSV Divisor em C#"
description: "Divida CSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo CSV em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo CSV em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos CSV usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo CSV usando a API GroupDocs.Merger
