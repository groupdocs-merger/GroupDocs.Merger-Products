...
############################# Head ############################
head_title: "Di C# de TEX li Pir Pelan veqetînin"
...
############################# Header ############################
title: "TEX Splitter Li C#"
description: "TEX bi çend rêzikên koda .NET parçe bikin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê TEX parçe bikin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên C# re hêsan dike ku pelek yek TEX li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên TEX bi karanîna koda nimûneya C# dabeş dike">}}

        ```csharp    
        // Pelê TEX bi karanîna GroupDocs.Merger API-ê veqetînin
