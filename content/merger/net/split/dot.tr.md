...
############################# Head ############################
head_title: "DOT'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOT Ayırıcı C#"
description: "DOT kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOT Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOT dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOT dosyasını ayırın
