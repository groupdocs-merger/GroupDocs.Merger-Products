...
############################# Head ############################
head_title: "Podijeli PPTX u više datoteka u C#"
...
############################# Header ############################
title: "PPTX Splitter u C#"
description: "Podijelite PPTX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli PPTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne PPTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti PPTX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli PPTX datoteku pomoću API-ja GroupDocs.Merger
