...
steps:
    enable: true
    title_left: "Split POTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](/merger/net/) makes it easy for .NET developers to split a single POTM file into multiple resultant files by implementing a few easy steps.
