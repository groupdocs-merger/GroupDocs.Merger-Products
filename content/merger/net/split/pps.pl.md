...
############################# Head ############################
head_title: "Podziel PPS na wiele plików w C#"
...
############################# Header ############################
title: "PPS Rozdzielacz w C#"
description: "Podziel PPS z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików PPS w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku PPS na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki PPS przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik PPS za pomocą GroupDocs.Merger API
