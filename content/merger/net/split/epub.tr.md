...
############################# Head ############################
head_title: "EPUB'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "EPUB Ayırıcı C#"
description: "EPUB kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "EPUB Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak EPUB dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak EPUB dosyasını ayırın
