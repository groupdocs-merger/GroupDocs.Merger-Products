...
############################# Head ############################
head_title: "Разделете VSDX на няколко файла в C#"
...
############################# Header ############################
title: "VSDX Сплитер в C#"
description: "Разделете VSDX с няколко реда код на .NET."
...
steps:
    enable: true
    title_left: "Разделете VSDX файлови страници в .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) улеснява разработчиците на C# да разделят един файл VSDX на множество получени файлове чрез прилагане на няколко лесни стъпки.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как да разделяте VSDX файлове с помощта на C# примерен код">}}

        ```csharp    
        // Разделете файла VSDX с помощта на API на GroupDocs.Merger
