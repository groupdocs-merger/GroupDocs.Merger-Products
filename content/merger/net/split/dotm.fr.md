...
############################# Head ############################
head_title: "Divisez DOTM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOTM Séparateur dans C#"
description: "Divisez DOTM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOTM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOTM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOTM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOTM à l'aide de l'API GroupDocs.Merger
