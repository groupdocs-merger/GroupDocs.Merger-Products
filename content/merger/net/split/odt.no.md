...
############################# Head ############################
head_title: "Del ODT i flere filer i C#"
...
description: "Del ODT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del ODT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt ODT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp ODT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del ODT-filen ved hjelp av GroupDocs.Merger API
