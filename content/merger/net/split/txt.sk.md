...
############################# Head ############################
head_title: "Rozdeliť TXT do viacerých súborov v C#"
...
############################# Header ############################
title: "TXT Splitter v C#"
description: "Rozdeľte TXT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť TXT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor TXT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť TXT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor TXT pomocou rozhrania GroupDocs.Merger API
