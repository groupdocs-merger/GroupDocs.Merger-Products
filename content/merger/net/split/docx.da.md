...
############################# Head ############################
head_title: "Opdel DOCX i flere filer i C#"
...
############################# Header ############################
title: "DOCX Splitter i C#"
description: "Opdel DOCX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel DOCX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt DOCX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles DOCX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel DOCX fil ved hjælp af GroupDocs.Merger API
