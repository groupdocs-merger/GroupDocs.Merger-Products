...
############################# Head ############################
head_title: "Pisahkan XLAM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLAM Pemisah Dalam C#"
description: "Pisahkan XLAM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLAM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLAM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLAM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLAM menggunakan API GroupDocs.Merger
