...
############################# Head ############################
head_title: "Dividir VSSM en varios archivos en C#"
...
############################# Header ############################
title: "VSSM Divisor en C#"
description: "Divida VSSM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VSSM páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VSSM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VSSM usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VSSM usando GroupDocs.Merger API
