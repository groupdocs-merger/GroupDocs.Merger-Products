...
############################# Head ############################
head_title: "Sadaliet CSV vairākos failos programmā C#"
...
############################# Header ############################
title: "CSV sadalītājs programmā C#"
description: "Sadaliet CSV ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet CSV faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu CSV failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt CSV failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet CSV failu, izmantojot GroupDocs.Merger API
