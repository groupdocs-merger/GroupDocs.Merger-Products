...
############################# Head ############################
head_title: "Podziel VSSM na wiele plików w C#"
...
############################# Header ############################
title: "VSSM Rozdzielacz w C#"
description: "Podziel VSSM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSSM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSSM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSSM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSSM za pomocą GroupDocs.Merger API
