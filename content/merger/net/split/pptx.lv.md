...
############################# Head ############################
head_title: "Sadaliet PPTX vairākos failos programmā C#"
...
############################# Header ############################
title: "PPTX sadalītājs programmā C#"
description: "Sadaliet PPTX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPTX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu PPTX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPTX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet PPTX failu, izmantojot GroupDocs.Merger API
