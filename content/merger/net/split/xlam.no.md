...
############################# Head ############################
head_title: "Del XLAM i flere filer i C#"
...
############################# Header ############################
title: "XLAM splitter i C#"
description: "Del XLAM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLAM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLAM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLAM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLAM-filen ved hjelp av GroupDocs.Merger API
