...
############################# Head ############################
head_title: "Split EXCEL documents in .NET apps"
head_description: "Use GroupDocs.Merger for .NET to split EXCEL files into separate documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, Visio files, images, archives, and more."

############################# Header ############################
title: "Split EXCEL files" 
description: "GroupDocs.Merger for .NET enhances .NET applications with advanced document processing features. Easily split EXCEL files and work with various popular business formats."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/net/), you can split EXCEL documents and save selected pages as a new file. Enhance document processing in your .NET applications.
      
      1. Specify the source path of the EXCEL file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Split EXCEL document and save even-numbered pages"
      content: |
        This example shows how to split a EXCEL document and save all even-numbered pages as a separate file.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
