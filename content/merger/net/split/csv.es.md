...
############################# Head ############################
head_title: "Dividir CSV en varios archivos en C#"
...
############################# Header ############################
title: "CSV Divisor en C#"
description: "Divida CSV con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir CSV páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo CSV en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos CSV usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo CSV usando GroupDocs.Merger API
