...
############################# Head ############################
head_title: "Dela upp VSDX i flera filer i C#"
...
############################# Header ############################
title: "VSDX splitter i C#"
description: "Dela upp VSDX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSDX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSDX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSDX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSDX-fil med GroupDocs.Merger API
