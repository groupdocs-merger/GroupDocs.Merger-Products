...
############################# Head ############################
head_title: "Splits XLTM in meerdere bestanden in C#"
...
############################# Header ############################
title: "XLTM Splitter in C#"
description: "Splits XLTM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLTM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLTM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLTM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLTM bestand met behulp van GroupDocs.Merger API
