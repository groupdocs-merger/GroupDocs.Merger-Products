...
############################# Head ############################
head_title: "Dela upp VSTX i flera filer i C#"
...
############################# Header ############################
title: "VSTX splitter i C#"
description: "Dela upp VSTX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSTX filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSTX-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSTX-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSTX-fil med GroupDocs.Merger API
