...
############################# Head ############################
head_title: "Verdeel TSV in veelvuldige lêers in C#"
...
############################# Header ############################
title: "TSV Splitter in C#"
description: "Verdeel TSV met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel TSV lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele TSV-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om TSV lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel TSV lêer deur GroupDocs.Merger API te gebruik
