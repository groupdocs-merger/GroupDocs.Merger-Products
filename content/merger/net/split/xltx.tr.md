...
############################# Head ############################
head_title: "XLTX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "XLTX Ayırıcı C#"
description: "XLTX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "XLTX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak XLTX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak XLTX dosyasını ayırın
