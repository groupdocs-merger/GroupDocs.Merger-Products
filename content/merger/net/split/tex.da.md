...
############################# Head ############################
head_title: "Opdel TEX i flere filer i C#"
...
description: "Opdel TEX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel TEX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt TEX-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles TEX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel TEX fil ved hjælp af GroupDocs.Merger API
