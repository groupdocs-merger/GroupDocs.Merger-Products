...
############################# Head ############################
head_title: "Dividiu DOCM en diversos fitxers a C#"
...
############################# Header ############################
title: "DOCM Divisor a C#"
description: "Dividiu DOCM amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers DOCM a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer DOCM en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers DOCM utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer DOCM mitjançant l'API de GroupDocs.Merger
