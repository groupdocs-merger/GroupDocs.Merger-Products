...
############################# Head ############################
head_title: "Padalinkite VSTM į kelis failus C#"
...
############################# Header ############################
title: "VSTM skirstytuvas C#"
description: "Padalinkite VSTM keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSTM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSTM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSTM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSTM failą naudodami GroupDocs.Merger API
