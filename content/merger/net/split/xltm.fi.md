...
############################# Head ############################
head_title: "Jaa XLTM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLTM Jakaja sisään C#"
description: "Jaa XLTM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLTM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLTM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLTM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLTM GroupDocs.Merger API:lla
