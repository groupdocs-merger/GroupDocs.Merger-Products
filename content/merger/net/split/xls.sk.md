...
############################# Head ############################
head_title: "Rozdeliť XLS do viacerých súborov v C#"
...
############################# Header ############################
title: "XLS Splitter v C#"
description: "Rozdeľte XLS niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLS na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLS súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLS pomocou rozhrania GroupDocs.Merger API
