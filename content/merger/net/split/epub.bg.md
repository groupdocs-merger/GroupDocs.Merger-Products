...
############################# Head ############################
head_title: "Split EPUB into Multiple Files in C#"
...
description: "Split EPUB with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single EPUB file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split EPUB files using C# example code">}}
