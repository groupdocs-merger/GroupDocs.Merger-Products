...
############################# Head ############################
head_title: "Divisez TSV en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "TSV Séparateur dans C#"
description: "Divisez TSV avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner TSV pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier TSV en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers TSV à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier TSV à l'aide de l'API GroupDocs.Merger
