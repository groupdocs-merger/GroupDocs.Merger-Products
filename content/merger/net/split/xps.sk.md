...
############################# Head ############################
head_title: "Rozdeliť XPS do viacerých súborov v C#"
...
############################# Header ############################
title: "XPS Splitter v C#"
description: "Rozdeľte XPS niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XPS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XPS na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XPS súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XPS pomocou rozhrania GroupDocs.Merger API
