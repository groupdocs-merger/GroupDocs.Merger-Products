...
############################# Head ############################
head_title: "Skiptu PDF í margar skrár í C#"
...
############################# Header ############################
title: "PDF Skerandi í C#"
description: "Skiptu PDF með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu PDF skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni PDF skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta PDF skrám með því að nota C# dæmikóða">}}
