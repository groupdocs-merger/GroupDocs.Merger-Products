...
############################# Head ############################
head_title: "Opdel XPS i flere filer i C#"
...
description: "Opdel XPS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt XPS-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles XPS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel XPS fil ved hjælp af GroupDocs.Merger API
