...
############################# Head ############################
head_title: "Բաժանել XPS-ը մի քանի ֆայլերի C#-ում"
...
############################# Header ############################
title: "XPS Splitter C#-ում"
description: "Բաժանեք XPS-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել XPS ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար մեկ XPS ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել XPS ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Բաժանեք XPS ֆայլը` օգտագործելով GroupDocs.Merger API
