...
############################# Head ############################
head_title: "Podijeli XPS u više datoteka u C#"
...
############################# Header ############################
title: "XPS Splitter u C#"
description: "Podijelite XPS s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XPS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XPS datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XPS datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XPS datoteku pomoću API-ja GroupDocs.Merger
