...
############################# Head ############################
head_title: "Razdeli RTF na več datotek v C#"
...
############################# Header ############################
title: "RTF razdelilnik v C#"
description: "Razdelite RTF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli RTF strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke RTF na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke RTF s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko RTF z API-jem GroupDocs.Merger
