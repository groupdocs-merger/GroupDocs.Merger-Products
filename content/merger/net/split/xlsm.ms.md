...
############################# Head ############################
head_title: "Pisahkan XLSM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLSM Pemisah Dalam C#"
description: "Pisahkan XLSM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLSM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLSM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLSM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLSM menggunakan API GroupDocs.Merger
