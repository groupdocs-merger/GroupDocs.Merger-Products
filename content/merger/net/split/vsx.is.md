...
############################# Head ############################
head_title: "Skiptu VSX í margar skrár í C#"
...
############################# Header ############################
title: "VSX Skerandi í C#"
description: "Skiptu VSX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSX skrá með GroupDocs.Merger API
