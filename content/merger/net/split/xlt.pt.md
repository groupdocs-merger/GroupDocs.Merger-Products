...
############################# Head ############################
head_title: "Divida XLT em vários arquivos em C#"
...
############################# Header ############################
title: "XLT Divisor em C#"
description: "Divida XLT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLT usando a API GroupDocs.Merger
