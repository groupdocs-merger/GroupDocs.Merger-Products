...
############################# Head ############################
head_title: "Împărțiți CSV în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter CSV în C#"
description: "Împărțiți CSV cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere CSV în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier CSV în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere CSV folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul CSV utilizând API-ul GroupDocs.Merger
