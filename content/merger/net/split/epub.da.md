...
############################# Head ############################
head_title: "Opdel EPUB i flere filer i C#"
...
description: "Opdel EPUB med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel EPUB filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt EPUB-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles EPUB filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel EPUB fil ved hjælp af GroupDocs.Merger API
