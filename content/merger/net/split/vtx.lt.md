...
############################# Head ############################
head_title: "Padalinkite VTX į kelis failus C#"
...
############################# Header ############################
title: "VTX skirstytuvas C#"
description: "Padalinkite VTX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VTX failą naudodami GroupDocs.Merger API
