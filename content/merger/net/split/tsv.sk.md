...
############################# Head ############################
head_title: "Rozdeliť TSV do viacerých súborov v C#"
...
############################# Header ############################
title: "TSV Splitter v C#"
description: "Rozdeľte TSV niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť TSV strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor TSV na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť TSV súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor TSV pomocou rozhrania GroupDocs.Merger API
