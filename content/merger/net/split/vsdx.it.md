...
############################# Head ############################
head_title: "Dividi VSDX in più file in C#"
...
############################# Header ############################
title: "VSDX Separatore in C#"
description: "Dividi VSDX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file VSDX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file VSDX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file VSDX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file VSDX utilizzando l'API GroupDocs.Merger
