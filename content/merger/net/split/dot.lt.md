...
############################# Head ############################
head_title: "Padalinkite DOT į kelis failus C#"
...
############################# Header ############################
title: "DOT skirstytuvas C#"
description: "Padalinkite DOT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną DOT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite DOT failą naudodami GroupDocs.Merger API
