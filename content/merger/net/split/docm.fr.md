...
############################# Head ############################
head_title: "Divisez DOCM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOCM Séparateur dans C#"
description: "Divisez DOCM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOCM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOCM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOCM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOCM à l'aide de l'API GroupDocs.Merger
