...
############################# Head ############################
head_title: "Del OTP i flere filer i C#"
...
description: "Del OTP med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del OTP filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt OTP-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp OTP filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del OTP-filen ved hjelp av GroupDocs.Merger API
