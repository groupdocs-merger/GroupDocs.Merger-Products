...
############################# Head ############################
head_title: "Teilen von POWERPOINT-Dokumenten in .NET-Apps"
head_description: "Nutzen Sie GroupDocs.Merger for .NET, um POWERPOINT-Dateien in separate Dokumente zu teilen. Verwalten Sie PDFs, Word-Dateien, Excel-Tabellen, PowerPoint-Folien, Visio-Dateien, Bilder, Archive und mehr."

############################# Header ############################
title: "Teilen von POWERPOINT-Dateien" 
description: "GroupDocs.Merger for .NET verbessert .NET-Anwendungen mit fortschrittlichen Funktionen zur Dokumentenverarbeitung. Teilen Sie POWERPOINT-Dateien und arbeiten Sie mit verschiedenen gängigen Geschäftsformaten."
...
steps:
    enable: true
    title: "So teilen Sie POWERPOINT-Dateien"
    content: |
      Mit [GroupDocs.Merger](/merger/net/) können Sie POWERPOINT-Dokumente teilen und ausgewählte Seiten als neue Datei speichern. Verbessern Sie die Dokumentenverarbeitung in Ihren .NET-Anwendungen.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "POWERPOINT-Dokument teilen und gerade Seiten speichern"
      content: |
        Dieses Beispiel zeigt, wie man ein POWERPOINT-Dokument teilt und alle geraden Seiten als separate Datei speichert.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
