...
############################# Head ############################
head_title: "Împărțiți MHT în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter MHT în C#"
description: "Împărțiți MHT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere MHT în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier MHT în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere MHT folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul MHT utilizând API-ul GroupDocs.Merger
