...
############################# Head ############################
head_title: "Scoilt DOCX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOCX Scoilteoir i C#"
description: "Scoilt DOCX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOCX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOCX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOCX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOCX comhad ag baint úsáide as GroupDocs.Merger API
