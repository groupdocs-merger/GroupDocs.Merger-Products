...
############################# Head ############################
head_title: "Dividir DOCM en varios archivos en C#"
...
############################# Header ############################
title: "DOCM Divisor en C#"
description: "Divida DOCM con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir DOCM páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo DOCM en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos DOCM usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo DOCM usando GroupDocs.Merger API
