...
############################# Head ############################
head_title: "Tách DOC thành nhiều tệp trong C#"
...
############################# Header ############################
title: "DOC Splitter trong C#"
description: "Tách DOC bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp DOC trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp DOC thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp DOC bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp DOC bằng API GroupDocs.Merger
