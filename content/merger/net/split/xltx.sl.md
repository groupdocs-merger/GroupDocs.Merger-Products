...
############################# Head ############################
head_title: "Razdeli XLTX na več datotek v C#"
...
############################# Header ############################
title: "XLTX razdelilnik v C#"
description: "Razdelite XLTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLTX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLTX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLTX z API-jem GroupDocs.Merger
