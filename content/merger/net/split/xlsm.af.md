...
############################# Head ############################
head_title: "Verdeel XLSM in veelvuldige lêers in C#"
...
description: "Verdeel XLSM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLSM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLSM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLSM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLSM lêer deur GroupDocs.Merger API te gebruik
