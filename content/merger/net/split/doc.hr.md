...
############################# Head ############################
head_title: "Podijeli DOC u više datoteka u C#"
...
############################# Header ############################
title: "DOC Splitter u C#"
description: "Podijelite DOC s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOC stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOC datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOC datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOC datoteku pomoću API-ja GroupDocs.Merger
