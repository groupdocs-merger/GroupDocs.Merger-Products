...
############################# Head ############################
head_title: "Rozdeliť VDX do viacerých súborov v C#"
...
description: "Rozdeľte VDX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VDX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VDX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VDX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VDX pomocou rozhrania GroupDocs.Merger API
