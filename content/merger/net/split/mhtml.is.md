...
############################# Head ############################
head_title: "Skiptu MHTML í margar skrár í C#"
...
############################# Header ############################
title: "MHTML Skerandi í C#"
description: "Skiptu MHTML með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu MHTML skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni MHTML skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta MHTML skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu MHTML skrá með GroupDocs.Merger API
