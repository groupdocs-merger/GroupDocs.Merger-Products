...
############################# Head ############################
head_title: "Scoilt DOT ina Ilchomhaid i C#"
...
############################# Header ############################
title: "DOT Scoilteoir i C#"
description: "Scoilt DOT le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt DOT Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin DOT a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid DOT a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt DOT comhad ag baint úsáide as GroupDocs.Merger API
