...
############################# Head ############################
head_title: "Împărțiți DOCM în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter DOCM în C#"
description: "Împărțiți DOCM cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere DOCM în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier DOCM în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere DOCM folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul DOCM utilizând API-ul GroupDocs.Merger
