...
############################# Head ############################
head_title: "Divisez XLS en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLS Séparateur dans C#"
description: "Divisez XLS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLS pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLS en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLS à l'aide de l'API GroupDocs.Merger
