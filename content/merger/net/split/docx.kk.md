...
############################# Head ############################
head_title: "DOCX файлын C# ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "DOCX C# ішіндегі бөлгіш"
description: "DOCX кодының бірнеше жолын .NET кодымен бөліңіз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі DOCX файл беттерін бөлу"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бір DOCX файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOCX файлдарды C# мысал кодын пайдаланып қалай бөлуге болады">}}

        ```csharp    
        // GroupDocs.Merger API арқылы DOCX файлды бөліңіз
