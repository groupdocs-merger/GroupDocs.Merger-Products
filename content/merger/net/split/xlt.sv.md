...
############################# Head ############################
head_title: "Dela upp XLT i flera filer i C#"
...
############################# Header ############################
title: "XLT splitter i C#"
description: "Dela upp XLT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLT-fil med GroupDocs.Merger API
