...
############################# Head ############################
head_title: "Jagage PDF mitmeks failiks rakenduses C#"
...
description: "Tükeldage PDF mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage PDF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks PDF-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada PDF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail PDF, kasutades GroupDocs.Merger API-t
