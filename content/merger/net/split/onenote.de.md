...
############################# Head ############################
head_title: "Teilen Sie ONENOTE in mehrere Dateien in C#"
...
############################# Header ############################
title: "ONENOTE Splittereingang C#"
description: "Teilen Sie ONENOTE mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie ONENOTE Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne ONENOTE-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie ONENOTE-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die ONENOTE-Datei mithilfe der GroupDocs.Merger-API
