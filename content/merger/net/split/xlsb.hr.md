...
############################# Head ############################
head_title: "Podijeli XLSB u više datoteka u C#"
...
############################# Header ############################
title: "XLSB Splitter u C#"
description: "Podijelite XLSB s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLSB stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLSB datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLSB datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLSB datoteku pomoću API-ja GroupDocs.Merger
