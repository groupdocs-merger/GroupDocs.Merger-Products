...
############################# Head ############################
head_title: "Розділити PDF на кілька файлів у C#"
...
############################# Header ############################
title: "PDF Спліттер у C#"
description: "Розділіть PDF кількома рядками коду .NET."
...
steps:
    enable: true
    title_left: "Розділити PDF сторінки файлів у .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/uk/merger/net/) дозволяє розробникам C# легко розділити один файл PDF на кілька результуючих файлів, реалізувавши кілька простих кроків.
    ...
    code: |
     ...
     {{< merger/code-merger title="Як розділити файли PDF за допомогою прикладу коду C#">}}
