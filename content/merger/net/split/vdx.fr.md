...
############################# Head ############################
head_title: "Divisez VDX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VDX Séparateur dans C#"
description: "Divisez VDX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VDX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VDX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VDX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VDX à l'aide de l'API GroupDocs.Merger
