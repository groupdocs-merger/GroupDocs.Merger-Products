...
############################# Head ############################
head_title: "Razdeli VSTX na več datotek v C#"
...
############################# Header ############################
title: "VSTX razdelilnik v C#"
description: "Razdelite VSTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSTX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSTX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSTX z API-jem GroupDocs.Merger
