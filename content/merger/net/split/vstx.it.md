...
############################# Head ############################
head_title: "Dividi VSTX in più file in C#"
...
############################# Header ############################
title: "VSTX Separatore in C#"
description: "Dividi VSTX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file VSTX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file VSTX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file VSTX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file VSTX utilizzando l'API GroupDocs.Merger
