...
############################# Head ############################
head_title: "Del DOCM i flere filer i C#"
...
description: "Del DOCM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del DOCM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt DOCM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOCM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del DOCM-filen ved hjelp av GroupDocs.Merger API
