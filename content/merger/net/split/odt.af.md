...
############################# Head ############################
head_title: "Verdeel ODT in veelvuldige lêers in C#"
...
description: "Verdeel ODT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel ODT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele ODT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om ODT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel ODT lêer deur GroupDocs.Merger API te gebruik
