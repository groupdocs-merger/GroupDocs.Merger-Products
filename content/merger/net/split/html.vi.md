...
############################# Head ############################
head_title: "Tách HTML thành nhiều tệp trong C#"
...
############################# Header ############################
title: "HTML Splitter trong C#"
description: "Tách HTML bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp HTML trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp HTML thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp HTML bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp HTML bằng API GroupDocs.Merger
