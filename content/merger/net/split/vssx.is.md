...
############################# Head ############################
head_title: "Skiptu VSSX í margar skrár í C#"
...
############################# Header ############################
title: "VSSX Skerandi í C#"
description: "Skiptu VSSX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSSX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSSX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSSX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSSX skrá með GroupDocs.Merger API
