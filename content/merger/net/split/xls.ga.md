...
############################# Head ############################
head_title: "Scoilt XLS ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XLS Scoilteoir i C#"
description: "Scoilt XLS le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XLS Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XLS a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XLS a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XLS comhad ag baint úsáide as GroupDocs.Merger API
