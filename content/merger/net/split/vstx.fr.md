...
############################# Head ############################
head_title: "Divisez VSTX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSTX Séparateur dans C#"
description: "Divisez VSTX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSTX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSTX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSTX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSTX à l'aide de l'API GroupDocs.Merger
