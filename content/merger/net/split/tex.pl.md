...
############################# Head ############################
head_title: "Podziel TEX na wiele plików w C#"
...
############################# Header ############################
title: "TEX Rozdzielacz w C#"
description: "Podziel TEX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików TEX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku TEX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki TEX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik TEX za pomocą GroupDocs.Merger API
