...
############################# Head ############################
head_title: "TSV'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "TSV Ayırıcı C#"
description: "TSV kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "TSV Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak TSV dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak TSV dosyasını ayırın
