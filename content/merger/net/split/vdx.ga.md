...
############################# Head ############################
head_title: "Scoilt VDX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VDX Scoilteoir i C#"
description: "Scoilt VDX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VDX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VDX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VDX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VDX comhad ag baint úsáide as GroupDocs.Merger API
