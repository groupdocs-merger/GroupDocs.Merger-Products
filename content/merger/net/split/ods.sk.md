...
############################# Head ############################
head_title: "Rozdeliť ODS do viacerých súborov v C#"
...
############################# Header ############################
title: "ODS Splitter v C#"
description: "Rozdeľte ODS niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť ODS strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor ODS na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť ODS súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor ODS pomocou rozhrania GroupDocs.Merger API
