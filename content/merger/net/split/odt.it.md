...
############################# Head ############################
head_title: "Dividi ODT in più file in C#"
...
############################# Header ############################
title: "ODT Separatore in C#"
description: "Dividi ODT con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file ODT in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file ODT in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file ODT utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file ODT utilizzando l'API GroupDocs.Merger
