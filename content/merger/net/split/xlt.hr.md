...
############################# Head ############################
head_title: "Podijeli XLT u više datoteka u C#"
...
############################# Header ############################
title: "XLT Splitter u C#"
description: "Podijelite XLT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLT datoteku pomoću API-ja GroupDocs.Merger
