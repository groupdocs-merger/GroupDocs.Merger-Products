...
############################# Head ############################
head_title: "Rozdělit DOC do více souborů v C#"
...
description: "Rozdělte DOC několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit DOC stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru DOC do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit DOC soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor DOC pomocí GroupDocs.Merger API
