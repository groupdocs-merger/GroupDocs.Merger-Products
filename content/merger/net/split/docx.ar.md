...
############################# Head ############################
head_title: "تقسيم DOCX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "DOCX الفاصل في C#"
description: "قسِّم DOCX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات DOCX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد DOCX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات DOCX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف DOCX باستخدام GroupDocs.Merger API
