...
############################# Head ############################
head_title: "Pisahkan OTP kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "OTP Pemisah Dalam C#"
description: "Pisahkan OTP dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan OTP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail OTP kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi OTP fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail OTP menggunakan API GroupDocs.Merger
