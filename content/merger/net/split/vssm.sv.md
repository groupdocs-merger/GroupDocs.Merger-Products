...
############################# Head ############################
head_title: "Dela upp VSSM i flera filer i C#"
...
description: "Dela upp VSSM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp VSSM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda VSSM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp VSSM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela VSSM-fil med GroupDocs.Merger API
