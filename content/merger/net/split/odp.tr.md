...
############################# Head ############################
head_title: "ODP'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "ODP Ayırıcı C#"
description: "ODP kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "ODP Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ODP dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ODP dosyasını ayırın
