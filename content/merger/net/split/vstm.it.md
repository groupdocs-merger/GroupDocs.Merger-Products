...
############################# Head ############################
head_title: "Dividi VSTM in più file in C#"
...
############################# Header ############################
title: "VSTM Separatore in C#"
description: "Dividi VSTM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file VSTM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file VSTM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file VSTM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file VSTM utilizzando l'API GroupDocs.Merger
