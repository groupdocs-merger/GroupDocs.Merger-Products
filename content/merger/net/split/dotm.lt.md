...
############################# Head ############################
head_title: "Padalinkite DOTM į kelis failus C#"
...
############################# Header ############################
title: "DOTM skirstytuvas C#"
description: "Padalinkite DOTM keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite DOTM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną DOTM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti DOTM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite DOTM failą naudodami GroupDocs.Merger API
