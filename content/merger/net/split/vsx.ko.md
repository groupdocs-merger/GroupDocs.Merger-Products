...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# 예제 코드를 사용하여 VSX 파일을 분할하는 방법">}}

        ```csharp    
        // GroupDocs.Merger API를 사용하여 VSX 파일 분할
