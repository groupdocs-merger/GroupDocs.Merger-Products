...
############################# Head ############################
head_title: "Divisez XLSX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLSX Séparateur dans C#"
description: "Divisez XLSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLSX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLSX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLSX à l'aide de l'API GroupDocs.Merger
