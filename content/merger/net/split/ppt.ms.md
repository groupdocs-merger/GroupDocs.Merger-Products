...
############################# Head ############################
head_title: "Pisahkan PPT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "PPT Pemisah Dalam C#"
description: "Pisahkan PPT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan PPT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail PPT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi PPT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail PPT menggunakan API GroupDocs.Merger
