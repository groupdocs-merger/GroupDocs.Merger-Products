...
############################# Head ############################
head_title: "Pisahkan IMAGE menjadi Beberapa File di C#"
...
############################# Header ############################
title: "IMAGE Pemisah Di C#"
description: "Pisahkan IMAGE dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan IMAGE Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file IMAGE menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file IMAGE menggunakan kode contoh C#">}}
