...
############################# Head ############################
head_title: "Skiptu DOTX í margar skrár í C#"
...
############################# Header ############################
title: "DOTX Skerandi í C#"
description: "Skiptu DOTX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu DOTX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni DOTX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta DOTX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu DOTX skrá með GroupDocs.Merger API
