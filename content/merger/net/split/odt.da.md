...
############################# Head ############################
head_title: "Opdel ODT i flere filer i C#"
...
description: "Opdel ODT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel ODT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt ODT-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles ODT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel ODT fil ved hjælp af GroupDocs.Merger API
