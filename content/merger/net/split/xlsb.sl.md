...
############################# Head ############################
head_title: "Razdeli XLSB na več datotek v C#"
...
############################# Header ############################
title: "XLSB razdelilnik v C#"
description: "Razdelite XLSB z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLSB strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLSB na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLSB s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLSB z API-jem GroupDocs.Merger
