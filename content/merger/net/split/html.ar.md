...
############################# Head ############################
head_title: "تقسيم HTML إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "HTML الفاصل في C#"
description: "قسِّم HTML ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات HTML في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد HTML إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات HTML باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف HTML باستخدام GroupDocs.Merger API
