...
############################# Head ############################
head_title: "Divida VSDM em vários arquivos em C#"
...
############################# Header ############################
title: "VSDM Divisor em C#"
description: "Divida VSDM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VSDM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VSDM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VSDM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VSDM usando a API GroupDocs.Merger
