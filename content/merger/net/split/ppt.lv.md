...
############################# Head ############################
head_title: "Sadaliet PPT vairākos failos programmā C#"
...
############################# Header ############################
title: "PPT sadalītājs programmā C#"
description: "Sadaliet PPT ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPT faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu PPT failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPT failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet PPT failu, izmantojot GroupDocs.Merger API
