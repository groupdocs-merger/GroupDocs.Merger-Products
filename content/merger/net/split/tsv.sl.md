...
############################# Head ############################
head_title: "Razdeli TSV na več datotek v C#"
...
############################# Header ############################
title: "TSV razdelilnik v C#"
description: "Razdelite TSV z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli TSV strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke TSV na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke TSV s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko TSV z API-jem GroupDocs.Merger
