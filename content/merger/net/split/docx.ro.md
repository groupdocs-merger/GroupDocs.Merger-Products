...
############################# Head ############################
head_title: "Împărțiți DOCX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter DOCX în C#"
description: "Împărțiți DOCX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere DOCX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier DOCX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere DOCX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul DOCX utilizând API-ul GroupDocs.Merger
