...
############################# Head ############################
head_title: "Pisahkan TXT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "TXT Pemisah Dalam C#"
description: "Pisahkan TXT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan TXT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail TXT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi TXT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail TXT menggunakan API GroupDocs.Merger
