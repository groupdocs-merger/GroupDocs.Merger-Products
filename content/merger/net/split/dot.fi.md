...
############################# Head ############################
head_title: "Jaa DOT useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "DOT Jakaja sisään C#"
description: "Jaa DOT muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa DOT tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden DOT-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto DOT GroupDocs.Merger API:lla
