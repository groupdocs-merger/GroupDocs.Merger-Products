...
############################# Head ############################
head_title: "Dividir TEX en varios archivos en C#"
...
############################# Header ############################
title: "TEX Divisor en C#"
description: "Divida TEX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir TEX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo TEX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos TEX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo TEX usando GroupDocs.Merger API
