...
############################# Head ############################
head_title: "Scoilt CSV ina Ilchomhaid i C#"
...
############################# Header ############################
title: "CSV Scoilteoir i C#"
description: "Scoilt CSV le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt CSV Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin CSV a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid CSV a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt CSV comhad ag baint úsáide as GroupDocs.Merger API
