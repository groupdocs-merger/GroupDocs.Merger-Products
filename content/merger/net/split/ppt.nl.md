...
############################# Head ############################
head_title: "Splits PPT in meerdere bestanden in C#"
...
############################# Header ############################
title: "PPT Splitter in C#"
description: "Splits PPT met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits PPT Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel PPT bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe PPT bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits PPT bestand met behulp van GroupDocs.Merger API
