...
############################# Head ############################
head_title: "Splits ODP in meerdere bestanden in C#"
...
description: "Splits ODP met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits ODP Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel ODP bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ODP bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits ODP bestand met behulp van GroupDocs.Merger API
