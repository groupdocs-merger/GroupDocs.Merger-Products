...
############################# Head ############################
head_title: "A(z) DOC felosztása több fájlra a C# programban"
...
description: "Oszd fel az DOC elemet néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "DOC fájloldal felosztása a következőben: .NET"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a C# fejlesztői számára, hogy egyetlen DOC fájlt több eredményfájlra osszanak fel egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOC fájlok felosztása a C# példakóddal">}}

        ```csharp    
        // Az DOC fájl felosztása a GroupDocs.Merger API segítségével
