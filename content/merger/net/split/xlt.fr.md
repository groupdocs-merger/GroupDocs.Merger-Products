...
############################# Head ############################
head_title: "Divisez XLT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLT Séparateur dans C#"
description: "Divisez XLT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLT à l'aide de l'API GroupDocs.Merger
