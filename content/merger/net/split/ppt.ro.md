...
############################# Head ############################
head_title: "Împărțiți PPT în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter PPT în C#"
description: "Împărțiți PPT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere PPT în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier PPT în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere PPT folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul PPT utilizând API-ul GroupDocs.Merger
