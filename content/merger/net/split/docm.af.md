...
############################# Head ############################
head_title: "Verdeel DOCM in veelvuldige lêers in C#"
...
description: "Verdeel DOCM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel DOCM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele DOCM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om DOCM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel DOCM lêer deur GroupDocs.Merger API te gebruik
