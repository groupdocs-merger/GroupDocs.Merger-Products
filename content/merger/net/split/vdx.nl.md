...
############################# Head ############################
head_title: "Splits VDX in meerdere bestanden in C#"
...
############################# Header ############################
title: "VDX Splitter in C#"
description: "Splits VDX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VDX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VDX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VDX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VDX bestand met behulp van GroupDocs.Merger API
