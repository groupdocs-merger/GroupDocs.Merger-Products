...
############################# Head ############################
head_title: "Del DOTX i flere filer i C#"
...
############################# Header ############################
title: "DOTX splitter i C#"
description: "Del DOTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del DOTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt DOTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp DOTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del DOTX-filen ved hjelp av GroupDocs.Merger API
