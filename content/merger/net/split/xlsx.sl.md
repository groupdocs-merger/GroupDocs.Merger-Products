...
############################# Head ############################
head_title: "Razdeli XLSX na več datotek v C#"
...
############################# Header ############################
title: "XLSX razdelilnik v C#"
description: "Razdelite XLSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLSX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLSX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLSX z API-jem GroupDocs.Merger
