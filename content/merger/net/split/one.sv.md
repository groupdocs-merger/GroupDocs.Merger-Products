...
############################# Head ############################
head_title: "Dela upp ONE i flera filer i C#"
...
description: "Dela upp ONE med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp ONE filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda ONE-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp ONE-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela ONE-fil med GroupDocs.Merger API
