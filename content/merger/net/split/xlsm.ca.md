...
############################# Head ############################
head_title: "Dividiu XLSM en diversos fitxers a C#"
...
############################# Header ############################
title: "XLSM Divisor a C#"
description: "Dividiu XLSM amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XLSM a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XLSM en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XLSM utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XLSM mitjançant l'API de GroupDocs.Merger
