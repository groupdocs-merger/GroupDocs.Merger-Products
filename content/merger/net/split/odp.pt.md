...
############################# Head ############################
head_title: "Divida ODP em vários arquivos em C#"
...
############################# Header ############################
title: "ODP Divisor em C#"
description: "Divida ODP com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo ODP em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo ODP em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos ODP usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo ODP usando a API GroupDocs.Merger
