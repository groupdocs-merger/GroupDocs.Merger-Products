...
############################# Head ############################
head_title: "Împărțiți VSSM în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter VSSM în C#"
description: "Împărțiți VSSM cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere VSSM în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier VSSM în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere VSSM folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul VSSM utilizând API-ul GroupDocs.Merger
