...
############################# Head ############################
head_title: "Rozdeliť TEX do viacerých súborov v C#"
...
############################# Header ############################
title: "TEX Splitter v C#"
description: "Rozdeľte TEX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť TEX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor TEX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť TEX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor TEX pomocou rozhrania GroupDocs.Merger API
