...
############################# Head ############################
head_title: "Verdeel VSTM in veelvuldige lêers in C#"
...
description: "Verdeel VSTM met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel VSTM lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele VSTM-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om VSTM lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel VSTM lêer deur GroupDocs.Merger API te gebruik
