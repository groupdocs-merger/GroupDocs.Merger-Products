...
############################# Head ############################
head_title: "Padalinkite VSSM į kelis failus C#"
...
############################# Header ############################
title: "VSSM skirstytuvas C#"
description: "Padalinkite VSSM keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSSM failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSSM failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSSM failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSSM failą naudodami GroupDocs.Merger API
