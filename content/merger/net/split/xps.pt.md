...
############################# Head ############################
head_title: "Divida XPS em vários arquivos em C#"
...
############################# Header ############################
title: "XPS Divisor em C#"
description: "Divida XPS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XPS em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XPS em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XPS usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XPS usando a API GroupDocs.Merger
