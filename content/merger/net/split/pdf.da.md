...
############################# Head ############################
head_title: "Opdel PDF i flere filer i C#"
...
description: "Opdel PDF med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel PDF filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt PDF-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles PDF filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel PDF fil ved hjælp af GroupDocs.Merger API
