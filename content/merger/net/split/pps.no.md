...
############################# Head ############################
head_title: "Del PPS i flere filer i C#"
...
description: "Del PPS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del PPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt PPS-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PPS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del PPS-filen ved hjelp av GroupDocs.Merger API
