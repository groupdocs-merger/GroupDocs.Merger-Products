...
############################# Head ############################
head_title: "Jagage VDX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VDX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VDX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VDX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VDX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VDX, kasutades GroupDocs.Merger API-t
