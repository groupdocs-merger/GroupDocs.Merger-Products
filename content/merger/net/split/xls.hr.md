...
############################# Head ############################
head_title: "Podijeli XLS u više datoteka u C#"
...
############################# Header ############################
title: "XLS Splitter u C#"
description: "Podijelite XLS s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLS datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLS datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLS datoteku pomoću API-ja GroupDocs.Merger
