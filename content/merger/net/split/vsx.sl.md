...
############################# Head ############################
head_title: "Razdeli VSX na več datotek v C#"
...
############################# Header ############################
title: "VSX razdelilnik v C#"
description: "Razdelite VSX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli VSX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke VSX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke VSX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko VSX z API-jem GroupDocs.Merger
