...
############################# Head ############################
head_title: "Skiptu VDX í margar skrár í C#"
...
############################# Header ############################
title: "VDX Skerandi í C#"
description: "Skiptu VDX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VDX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VDX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VDX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VDX skrá með GroupDocs.Merger API
