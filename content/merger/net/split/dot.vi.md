...
############################# Head ############################
head_title: "Tách DOT thành nhiều tệp trong C#"
...
############################# Header ############################
title: "DOT Splitter trong C#"
description: "Tách DOT bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp DOT trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp DOT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp DOT bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp DOT bằng API GroupDocs.Merger
