...
############################# Head ############################
head_title: "Dividi DOCM in più file in C#"
...
############################# Header ############################
title: "DOCM Separatore in C#"
description: "Dividi DOCM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOCM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOCM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOCM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOCM utilizzando l'API GroupDocs.Merger
