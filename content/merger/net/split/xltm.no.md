...
############################# Head ############################
head_title: "Del XLTM i flere filer i C#"
...
description: "Del XLTM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLTM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLTM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLTM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLTM-filen ved hjelp av GroupDocs.Merger API
