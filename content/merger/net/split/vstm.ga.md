...
############################# Head ############################
head_title: "Scoilt VSTM ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSTM Scoilteoir i C#"
description: "Scoilt VSTM le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSTM Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSTM a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSTM a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSTM comhad ag baint úsáide as GroupDocs.Merger API
