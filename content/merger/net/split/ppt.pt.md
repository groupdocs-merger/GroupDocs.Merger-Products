...
############################# Head ############################
head_title: "Divida PPT em vários arquivos em C#"
...
############################# Header ############################
title: "PPT Divisor em C#"
description: "Divida PPT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo PPT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo PPT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos PPT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo PPT usando a API GroupDocs.Merger
