...
############################# Head ############################
head_title: "Divida DOT em vários arquivos em C#"
...
############################# Header ############################
title: "DOT Divisor em C#"
description: "Divida DOT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo DOT em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo DOT em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos DOT usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo DOT usando a API GroupDocs.Merger
