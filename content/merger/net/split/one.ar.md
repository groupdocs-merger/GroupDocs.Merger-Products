...
############################# Head ############################
head_title: "تقسيم ONE إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "ONE الفاصل في C#"
description: "قسِّم ONE ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات ONE في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد ONE إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات ONE باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف ONE باستخدام GroupDocs.Merger API
