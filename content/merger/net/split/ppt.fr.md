...
############################# Head ############################
head_title: "Divisez PPT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "PPT Séparateur dans C#"
description: "Divisez PPT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner PPT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier PPT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers PPT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier PPT à l'aide de l'API GroupDocs.Merger
