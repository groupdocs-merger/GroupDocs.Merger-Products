...
############################# Head ############################
head_title: "Skiptu TXT í margar skrár í C#"
...
############################# Header ############################
title: "TXT Skerandi í C#"
description: "Skiptu TXT með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu TXT skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni TXT skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta TXT skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu TXT skrá með GroupDocs.Merger API
