...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/bg/merger/net/) makes it easy for C# developers to split a single ODT file into multiple resultant files by implementing a few easy steps.
