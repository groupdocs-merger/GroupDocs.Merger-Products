...
############################# Head ############################
head_title: "Dividi i documenti POWERPOINT nelle app .NET"
head_description: "Utilizza GroupDocs.Merger for .NET per suddividere i file POWERPOINT in documenti separati. Gestisci facilmente PDF, file Word, fogli Excel, diapositive PowerPoint, file Visio, immagini, archivi e altro ancora."

############################# Header ############################
title: "Dividi i file POWERPOINT" 
description: "GroupDocs.Merger for .NET potenzia le applicazioni .NET con funzionalità avanzate di elaborazione dei documenti. Suddividi i file POWERPOINT e lavora con vari formati di business popolari."
...
steps:
    enable: true
    title: "Come dividere i file POWERPOINT"
    content: |
      Con [GroupDocs.Merger](/merger/net/), puoi suddividere i documenti POWERPOINT e salvare le pagine selezionate come un nuovo file. Migliora l'elaborazione dei documenti nelle tue applicazioni .NET.
      
      1. Specifica il percorso sorgente del file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Dividi il documento POWERPOINT e salva le pagine con numero pari"
      content: |
        Questo esempio mostra come suddividere un documento POWERPOINT e salvare tutte le pagine con numero pari come file separato.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
