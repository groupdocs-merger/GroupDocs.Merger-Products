...
############################# Head ############################
head_title: "Padalinkite CSV į kelis failus C#"
...
############################# Header ############################
title: "CSV skirstytuvas C#"
description: "Padalinkite CSV keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite CSV failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną CSV failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti CSV failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite CSV failą naudodami GroupDocs.Merger API
