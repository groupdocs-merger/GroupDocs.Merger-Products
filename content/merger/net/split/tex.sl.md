...
############################# Head ############################
head_title: "Razdeli TEX na več datotek v C#"
...
############################# Header ############################
title: "TEX razdelilnik v C#"
description: "Razdelite TEX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli TEX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke TEX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke TEX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko TEX z API-jem GroupDocs.Merger
