...
############################# Head ############################
head_title: "Podijeli RTF u više datoteka u C#"
...
############################# Header ############################
title: "RTF Splitter u C#"
description: "Podijelite RTF s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli RTF stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne RTF datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti RTF datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli RTF datoteku pomoću API-ja GroupDocs.Merger
