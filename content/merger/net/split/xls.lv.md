...
############################# Head ############################
head_title: "Sadaliet XLS vairākos failos programmā C#"
...
############################# Header ############################
title: "XLS sadalītājs programmā C#"
description: "Sadaliet XLS ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet XLS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu XLS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt XLS failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet XLS failu, izmantojot GroupDocs.Merger API
