...
############################# Head ############################
head_title: "Dela upp TXT i flera filer i C#"
...
############################# Header ############################
title: "TXT splitter i C#"
description: "Dela upp TXT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp TXT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda TXT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp TXT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela TXT-fil med GroupDocs.Merger API
