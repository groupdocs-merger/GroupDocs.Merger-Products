...
############################# Head ############################
head_title: "Padalinkite MHT į kelis failus C#"
...
############################# Header ############################
title: "MHT skirstytuvas C#"
description: "Padalinkite MHT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite MHT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną MHT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti MHT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite MHT failą naudodami GroupDocs.Merger API
