...
############################# Head ############################
head_title: "Razdeli ONE na več datotek v C#"
...
############################# Header ############################
title: "ONE razdelilnik v C#"
description: "Razdelite ONE z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli ONE strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke ONE na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke ONE s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko ONE z API-jem GroupDocs.Merger
