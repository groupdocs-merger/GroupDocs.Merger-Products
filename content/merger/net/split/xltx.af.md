...
############################# Head ############################
head_title: "Verdeel XLTX in veelvuldige lêers in C#"
...
description: "Verdeel XLTX met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLTX lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLTX-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLTX lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLTX lêer deur GroupDocs.Merger API te gebruik
