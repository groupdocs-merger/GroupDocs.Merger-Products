...
############################# Head ############################
head_title: "Podziel ONE na wiele plików w C#"
...
############################# Header ############################
title: "ONE Rozdzielacz w C#"
description: "Podziel ONE z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików ONE w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku ONE na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki ONE przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik ONE za pomocą GroupDocs.Merger API
