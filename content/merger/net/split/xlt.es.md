...
############################# Head ############################
head_title: "Dividir XLT en varios archivos en C#"
...
############################# Header ############################
title: "XLT Divisor en C#"
description: "Divida XLT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLT usando GroupDocs.Merger API
