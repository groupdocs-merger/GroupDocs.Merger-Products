...
############################# Head ############################
head_title: "Dividi PPSX in più file in C#"
...
############################# Header ############################
title: "PPSX Separatore in C#"
description: "Dividi PPSX con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file PPSX in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file PPSX in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file PPSX utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file PPSX utilizzando l'API GroupDocs.Merger
