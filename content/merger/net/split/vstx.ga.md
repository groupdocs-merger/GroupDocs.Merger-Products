...
############################# Head ############################
head_title: "Scoilt VSTX ina Ilchomhaid i C#"
...
############################# Header ############################
title: "VSTX Scoilteoir i C#"
description: "Scoilt VSTX le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt VSTX Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin VSTX a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid VSTX a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt VSTX comhad ag baint úsáide as GroupDocs.Merger API
