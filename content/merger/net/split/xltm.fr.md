...
############################# Head ############################
head_title: "Divisez XLTM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLTM Séparateur dans C#"
description: "Divisez XLTM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLTM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLTM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLTM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLTM à l'aide de l'API GroupDocs.Merger
