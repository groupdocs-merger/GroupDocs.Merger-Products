...
############################# Head ############################
head_title: "Padalinkite XLTX į kelis failus C#"
...
############################# Header ############################
title: "XLTX skirstytuvas C#"
description: "Padalinkite XLTX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite XLTX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną XLTX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti XLTX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite XLTX failą naudodami GroupDocs.Merger API
