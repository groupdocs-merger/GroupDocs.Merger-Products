...
############################# Head ############################
head_title: "TXT کو C# میں متعدد فائلوں میں تقسیم کریں"
...
############################# Header ############################
title: "TXT سپلٹر ان C#"
description: ".NET کوڈ کی چند لائنوں کے ساتھ TXT کو تقسیم کریں۔"
...
steps:
    enable: true
    title_left: "TXT فائل صفحات کو .NET میں تقسیم کریں"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) C# ڈویلپرز کے لیے ایک TXT فائل کو متعدد نتیجہ خیز فائلوں میں تقسیم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کوڈ کا استعمال کرتے ہوئے TXT فائلوں کو کیسے تقسیم کیا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے TXT فائل کو تقسیم کریں۔
