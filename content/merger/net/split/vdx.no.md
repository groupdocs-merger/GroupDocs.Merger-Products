...
############################# Head ############################
head_title: "Del VDX i flere filer i C#"
...
############################# Header ############################
title: "VDX splitter i C#"
description: "Del VDX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VDX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VDX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VDX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VDX-filen ved hjelp av GroupDocs.Merger API
