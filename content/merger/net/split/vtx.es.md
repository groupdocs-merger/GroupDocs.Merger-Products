...
############################# Head ############################
head_title: "Dividir VTX en varios archivos en C#"
...
############################# Header ############################
title: "VTX Divisor en C#"
description: "Divida VTX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VTX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VTX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VTX usando GroupDocs.Merger API
