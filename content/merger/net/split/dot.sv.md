...
############################# Head ############################
head_title: "Dela upp DOT i flera filer i C#"
...
############################# Header ############################
title: "DOT splitter i C#"
description: "Dela upp DOT med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp DOT filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda DOT-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp DOT-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela DOT-fil med GroupDocs.Merger API
