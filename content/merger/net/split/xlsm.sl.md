...
############################# Head ############################
head_title: "Razdeli XLSM na več datotek v C#"
...
############################# Header ############################
title: "XLSM razdelilnik v C#"
description: "Razdelite XLSM z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLSM strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLSM na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLSM s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLSM z API-jem GroupDocs.Merger
