...
############################# Head ############################
head_title: "Verdeel XLT in veelvuldige lêers in C#"
...
description: "Verdeel XLT met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel XLT lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele XLT-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om XLT lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel XLT lêer deur GroupDocs.Merger API te gebruik
