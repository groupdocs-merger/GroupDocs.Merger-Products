...
############################# Head ############################
head_title: "Del VSSM i flere filer i C#"
...
description: "Del VSSM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSSM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSSM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSSM-filen ved hjelp av GroupDocs.Merger API
