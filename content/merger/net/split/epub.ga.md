...
############################# Head ############################
head_title: "Scoilt EPUB ina Ilchomhaid i C#"
...
############################# Header ############################
title: "EPUB Scoilteoir i C#"
description: "Scoilt EPUB le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt EPUB Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin EPUB a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid EPUB a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt EPUB comhad ag baint úsáide as GroupDocs.Merger API
