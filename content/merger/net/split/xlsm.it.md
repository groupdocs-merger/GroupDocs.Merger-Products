...
############################# Head ############################
head_title: "Dividi XLSM in più file in C#"
...
############################# Header ############################
title: "XLSM Separatore in C#"
description: "Dividi XLSM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file XLSM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file XLSM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file XLSM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file XLSM utilizzando l'API GroupDocs.Merger
