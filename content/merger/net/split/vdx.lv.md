...
############################# Head ############################
head_title: "Sadaliet VDX vairākos failos programmā C#"
...
############################# Header ############################
title: "VDX sadalītājs programmā C#"
description: "Sadaliet VDX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VDX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VDX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VDX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VDX failu, izmantojot GroupDocs.Merger API
