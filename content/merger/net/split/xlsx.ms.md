...
############################# Head ############################
head_title: "Pisahkan XLSX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "XLSX Pemisah Dalam C#"
description: "Pisahkan XLSX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan XLSX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail XLSX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi XLSX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail XLSX menggunakan API GroupDocs.Merger
