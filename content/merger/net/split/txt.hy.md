...
############################# Head ############################
head_title: "Բաժանել TXT-ը մի քանի ֆայլերի C#-ում"
...
############################# Header ############################
title: "TXT Splitter C#-ում"
description: "Բաժանեք TXT-ը .NET կոդի մի քանի տողով:"
...
steps:
    enable: true
    title_left: "Բաժանել TXT ֆայլի էջերը .NET-ում"
    content_left: |
        [GroupDocs.Merger for .NET](/hy/merger/net/) հեշտացնում է C# մշակողների համար մեկ TXT ֆայլը բաժանել մի քանի արդյունքի ֆայլերի` կիրառելով մի քանի հեշտ քայլ.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ինչպես բաժանել TXT ֆայլեր՝ օգտագործելով C# օրինակ կոդը">}}

        ```csharp    
        // Բաժանեք TXT ֆայլը` օգտագործելով GroupDocs.Merger API
