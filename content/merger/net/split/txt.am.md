...
steps:
    enable: true
    title_left: "TXT የፋይል ገጾችን በ.NET ክፈል"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለC# ገንቢዎች አንድን ነጠላ TXT ፋይል በመተግበር ወደ ብዙ የውጤት ፋይሎች መከፋፈል ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም TXT ፋይሎችን እንዴት እንደሚከፋፈል">}}

        ```csharp    
        // GroupDocs.Merger APIን በመጠቀም TXT ፋይልን ክፈሉ።
