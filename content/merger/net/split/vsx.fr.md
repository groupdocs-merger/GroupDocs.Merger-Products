...
############################# Head ############################
head_title: "Divisez VSX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "VSX Séparateur dans C#"
description: "Divisez VSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner VSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier VSX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers VSX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier VSX à l'aide de l'API GroupDocs.Merger
