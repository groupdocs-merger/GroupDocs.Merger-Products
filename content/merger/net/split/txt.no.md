...
############################# Head ############################
head_title: "Del TXT i flere filer i C#"
...
description: "Del TXT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del TXT filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt TXT-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp TXT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del TXT-filen ved hjelp av GroupDocs.Merger API
