...
############################# Head ############################
head_title: "MHTML'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "MHTML Ayırıcı C#"
description: "MHTML kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "MHTML Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak MHTML dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak MHTML dosyasını ayırın
