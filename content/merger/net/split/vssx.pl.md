...
############################# Head ############################
head_title: "Podziel VSSX na wiele plików w C#"
...
############################# Header ############################
title: "VSSX Rozdzielacz w C#"
description: "Podziel VSSX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSSX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSSX za pomocą GroupDocs.Merger API
