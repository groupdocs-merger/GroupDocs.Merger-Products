...
############################# Head ############################
head_title: "Podziel XLT na wiele plików w C#"
...
############################# Header ############################
title: "XLT Rozdzielacz w C#"
description: "Podziel XLT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XLT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XLT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XLT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XLT za pomocą GroupDocs.Merger API
