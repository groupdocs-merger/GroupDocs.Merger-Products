...
############################# Head ############################
head_title: "Del PPTX i flere filer i C#"
...
description: "Del PPTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del PPTX filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt PPTX-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp PPTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del PPTX-filen ved hjelp av GroupDocs.Merger API
