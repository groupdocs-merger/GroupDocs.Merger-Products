...
############################# Head ############################
head_title: "Tách VDX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "VDX Splitter trong C#"
description: "Tách VDX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp VDX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp VDX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp VDX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp VDX bằng API GroupDocs.Merger
