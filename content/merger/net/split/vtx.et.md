...
############################# Head ############################
head_title: "Jagage VTX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VTX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VTX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VTX, kasutades GroupDocs.Merger API-t
