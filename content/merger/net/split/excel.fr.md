...
############################# Head ############################
head_title: "Divisez EXCEL en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "EXCEL Séparateur dans C#"
description: "Divisez EXCEL avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner EXCEL pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier EXCEL en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers EXCEL à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier EXCEL à l'aide de l'API GroupDocs.Merger
