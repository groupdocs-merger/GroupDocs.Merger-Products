...
############################# Head ############################
head_title: "Sadaliet PPS vairākos failos programmā C#"
...
############################# Header ############################
title: "PPS sadalītājs programmā C#"
description: "Sadaliet PPS ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet PPS faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu PPS failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt PPS failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet PPS failu, izmantojot GroupDocs.Merger API
