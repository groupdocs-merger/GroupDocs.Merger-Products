...
############################# Head ############################
head_title: "Divisez XLAM en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "XLAM Séparateur dans C#"
description: "Divisez XLAM avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner XLAM pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier XLAM en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers XLAM à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier XLAM à l'aide de l'API GroupDocs.Merger
