...
############################# Head ############################
head_title: "Teilen Sie VDX in mehrere Dateien in C#"
...
############################# Header ############################
title: "VDX Splittereingang C#"
description: "Teilen Sie VDX mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie VDX Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne VDX-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie VDX-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die VDX-Datei mithilfe der GroupDocs.Merger-API
