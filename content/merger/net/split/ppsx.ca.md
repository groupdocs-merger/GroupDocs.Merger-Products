...
############################# Head ############################
head_title: "Dividiu PPSX en diversos fitxers a C#"
...
############################# Header ############################
title: "PPSX Divisor a C#"
description: "Dividiu PPSX amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers PPSX a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer PPSX en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers PPSX utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer PPSX mitjançant l'API de GroupDocs.Merger
