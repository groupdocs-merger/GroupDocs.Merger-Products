...
############################# Head ############################
head_title: "დაყავით RTF მრავალ ფაილად C#-ში"
...
############################# Header ############################
title: "RTF სპლიტერი C#-ში"
description: "გაყავით RTF .NET კოდის რამდენიმე ხაზით."
...
steps:
    enable: true
    title_left: "გაყავით RTF ფაილის გვერდები .NET-ში"
    content_left: |
        [GroupDocs.Merger for .NET](/ka/merger/net/) უადვილებს C#-ის დეველოპერებს ერთი RTF ფაილის დაყოფა მრავალ შედეგიან ფაილად დანერგვით რამდენიმე მარტივი ნაბიჯი.
    ...
    code: |
     ...
     {{< merger/code-merger title="როგორ გავყოთ RTF ფაილი C#-ის მაგალითის კოდის გამოყენებით">}}

        ```csharp    
        // გაყავით RTF ფაილი GroupDocs.Merger API-ის გამოყენებით
