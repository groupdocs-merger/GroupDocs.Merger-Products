...
############################# Head ############################
head_title: "Splits VSX in meerdere bestanden in C#"
...
description: "Splits VSX met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits VSX Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel VSX bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe VSX bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits VSX bestand met behulp van GroupDocs.Merger API
