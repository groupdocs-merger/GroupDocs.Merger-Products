...
############################# Head ############################
head_title: "Skiptu VSDX í margar skrár í C#"
...
############################# Header ############################
title: "VSDX Skerandi í C#"
description: "Skiptu VSDX með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu VSDX skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni VSDX skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta VSDX skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu VSDX skrá með GroupDocs.Merger API
