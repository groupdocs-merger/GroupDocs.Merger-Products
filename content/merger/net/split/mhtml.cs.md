...
############################# Head ############################
head_title: "Rozdělit MHTML do více souborů v C#"
...
############################# Header ############################
title: "MHTML Splitter v C#"
description: "Rozdělte MHTML několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit MHTML stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru MHTML do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit MHTML soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor MHTML pomocí GroupDocs.Merger API
