...
############################# Head ############################
head_title: "Scoilt XPS ina Ilchomhaid i C#"
...
############################# Header ############################
title: "XPS Scoilteoir i C#"
description: "Scoilt XPS le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt XPS Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin XPS a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid XPS a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt XPS comhad ag baint úsáide as GroupDocs.Merger API
