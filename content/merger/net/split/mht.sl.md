...
############################# Head ############################
head_title: "Razdeli MHT na več datotek v C#"
...
############################# Header ############################
title: "MHT razdelilnik v C#"
description: "Razdelite MHT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli MHT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke MHT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke MHT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko MHT z API-jem GroupDocs.Merger
