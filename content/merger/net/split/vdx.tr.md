...
############################# Head ############################
head_title: "VDX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VDX Ayırıcı C#"
description: "VDX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VDX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VDX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VDX dosyasını ayırın
