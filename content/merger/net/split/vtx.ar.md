...
############################# Head ############################
head_title: "تقسيم VTX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "VTX الفاصل في C#"
description: "قسِّم VTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات VTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد VTX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات VTX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف VTX باستخدام GroupDocs.Merger API
