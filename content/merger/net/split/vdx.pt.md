...
############################# Head ############################
head_title: "Divida VDX em vários arquivos em C#"
...
############################# Header ############################
title: "VDX Divisor em C#"
description: "Divida VDX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo VDX em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo VDX em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos VDX usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo VDX usando a API GroupDocs.Merger
