...
############################# Head ############################
head_title: "Razdeli PPTX na več datotek v C#"
...
############################# Header ############################
title: "PPTX razdelilnik v C#"
description: "Razdelite PPTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli PPTX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke PPTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke PPTX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko PPTX z API-jem GroupDocs.Merger
