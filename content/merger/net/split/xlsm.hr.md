...
############################# Head ############################
head_title: "Podijeli XLSM u više datoteka u C#"
...
############################# Header ############################
title: "XLSM Splitter u C#"
description: "Podijelite XLSM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli XLSM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne XLSM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti XLSM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli XLSM datoteku pomoću API-ja GroupDocs.Merger
