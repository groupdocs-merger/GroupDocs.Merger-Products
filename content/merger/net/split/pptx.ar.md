...
############################# Head ############################
head_title: "تقسيم PPTX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "PPTX الفاصل في C#"
description: "قسِّم PPTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات PPTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد PPTX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات PPTX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف PPTX باستخدام GroupDocs.Merger API
