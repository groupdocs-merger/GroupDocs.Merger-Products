...
############################# Head ############################
head_title: "Jagage VSDM mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSDM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSDM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSDM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSDM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSDM, kasutades GroupDocs.Merger API-t
