...
############################# Head ############################
head_title: "Divisez PPSX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "PPSX Séparateur dans C#"
description: "Divisez PPSX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner PPSX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier PPSX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers PPSX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier PPSX à l'aide de l'API GroupDocs.Merger
