...
############################# Head ############################
head_title: "Del VSDM i flere filer i C#"
...
description: "Del VSDM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del VSDM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt VSDM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp VSDM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del VSDM-filen ved hjelp av GroupDocs.Merger API
