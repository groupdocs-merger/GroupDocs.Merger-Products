...
############################# Head ############################
head_title: "Rozdeliť VTX do viacerých súborov v C#"
...
############################# Header ############################
title: "VTX Splitter v C#"
description: "Rozdeľte VTX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť VTX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor VTX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť VTX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor VTX pomocou rozhrania GroupDocs.Merger API
