...
############################# Head ############################
head_title: "Jaa DOCM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "DOCM Jakaja sisään C#"
description: "Jaa DOCM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa DOCM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden DOCM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOCM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto DOCM GroupDocs.Merger API:lla
