...
############################# Head ############################
head_title: "Jagage OTT mitmeks failiks rakenduses C#"
...
description: "Tükeldage OTT mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage OTT faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks OTT-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada OTT faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail OTT, kasutades GroupDocs.Merger API-t
