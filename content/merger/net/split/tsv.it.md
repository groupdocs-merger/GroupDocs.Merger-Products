...
############################# Head ############################
head_title: "Dividi TSV in più file in C#"
...
############################# Header ############################
title: "TSV Separatore in C#"
description: "Dividi TSV con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file TSV in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file TSV in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file TSV utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file TSV utilizzando l'API GroupDocs.Merger
