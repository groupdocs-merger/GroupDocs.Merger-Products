...
############################# Head ############################
head_title: "Dividir XLTX en varios archivos en C#"
...
############################# Header ############################
title: "XLTX Divisor en C#"
description: "Divida XLTX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir XLTX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo XLTX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos XLTX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo XLTX usando GroupDocs.Merger API
