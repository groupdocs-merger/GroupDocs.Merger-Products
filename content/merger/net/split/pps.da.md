...
############################# Head ############################
head_title: "Opdel PPS i flere filer i C#"
...
description: "Opdel PPS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel PPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt PPS-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles PPS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel PPS fil ved hjælp af GroupDocs.Merger API
