...
############################# Head ############################
head_title: "Sadaliet RTF vairākos failos programmā C#"
...
############################# Header ############################
title: "RTF sadalītājs programmā C#"
description: "Sadaliet RTF ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet RTF faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu RTF failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt RTF failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet RTF failu, izmantojot GroupDocs.Merger API
