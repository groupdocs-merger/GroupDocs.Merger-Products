...
############################# Head ############################
head_title: "تقسيم PPSX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "PPSX الفاصل في C#"
description: "قسِّم PPSX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات PPSX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد PPSX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات PPSX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف PPSX باستخدام GroupDocs.Merger API
