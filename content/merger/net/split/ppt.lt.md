...
############################# Head ############################
head_title: "Padalinkite PPT į kelis failus C#"
...
############################# Header ############################
title: "PPT skirstytuvas C#"
description: "Padalinkite PPT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite PPT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną PPT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti PPT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite PPT failą naudodami GroupDocs.Merger API
