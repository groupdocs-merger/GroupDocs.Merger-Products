...
############################# Head ############################
head_title: "Podijeli MHTML u više datoteka u C#"
...
############################# Header ############################
title: "MHTML Splitter u C#"
description: "Podijelite MHTML s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli MHTML stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne MHTML datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti MHTML datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli MHTML datoteku pomoću API-ja GroupDocs.Merger
