...
############################# Head ############################
head_title: "Razdeli HTML na več datotek v C#"
...
############################# Header ############################
title: "HTML razdelilnik v C#"
description: "Razdelite HTML z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli HTML strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke HTML na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke HTML s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko HTML z API-jem GroupDocs.Merger
