...
############################# Head ############################
head_title: "Rozdeliť XLSB do viacerých súborov v C#"
...
############################# Header ############################
title: "XLSB Splitter v C#"
description: "Rozdeľte XLSB niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLSB strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLSB na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLSB súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLSB pomocou rozhrania GroupDocs.Merger API
