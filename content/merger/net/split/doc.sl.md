...
############################# Head ############################
head_title: "Razdeli DOC na več datotek v C#"
...
############################# Header ############################
title: "DOC razdelilnik v C#"
description: "Razdelite DOC z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOC strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOC na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOC s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOC z API-jem GroupDocs.Merger
