...
############################# Head ############################
head_title: "Tách VSTX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "VSTX Splitter trong C#"
description: "Tách VSTX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp VSTX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp VSTX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp VSTX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp VSTX bằng API GroupDocs.Merger
