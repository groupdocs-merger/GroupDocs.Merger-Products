...
############################# Head ############################
head_title: "Razdeli ODT na več datotek v C#"
...
############################# Header ############################
title: "ODT razdelilnik v C#"
description: "Razdelite ODT z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli ODT strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke ODT na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke ODT s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko ODT z API-jem GroupDocs.Merger
