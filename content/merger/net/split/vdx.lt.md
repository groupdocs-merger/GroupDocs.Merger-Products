...
############################# Head ############################
head_title: "Padalinkite VDX į kelis failus C#"
...
############################# Header ############################
title: "VDX skirstytuvas C#"
description: "Padalinkite VDX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VDX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VDX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VDX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VDX failą naudodami GroupDocs.Merger API
