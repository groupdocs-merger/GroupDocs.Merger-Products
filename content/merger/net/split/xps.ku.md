...
############################# Head ############################
head_title: "Di C# de XPS li Pir Pelan veqetînin"
...
############################# Header ############################
title: "XPS Splitter Li C#"
description: "XPS bi çend rêzikên koda .NET parçe bikin."
...
steps:
    enable: true
    title_left: "Di .NET de Rûpelên Pelê XPS parçe bikin"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebiranên C# re hêsan dike ku pelek yek XPS li çend pelên encam de bi cîh bikin. çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên XPS bi karanîna koda nimûneya C# dabeş dike">}}

        ```csharp    
        // Pelê XPS bi karanîna GroupDocs.Merger API-ê veqetînin
