...
############################# Head ############################
head_title: "Dividiu ONE en diversos fitxers a C#"
...
############################# Header ############################
title: "ONE Divisor a C#"
description: "Dividiu ONE amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers ONE a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer ONE en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers ONE utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer ONE mitjançant l'API de GroupDocs.Merger
