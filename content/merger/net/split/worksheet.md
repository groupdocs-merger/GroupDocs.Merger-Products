...
############################# Head ############################
head_title: "Split WORKSHEET into Multiple Files in C#"
head_description: "Split a single WORKSHEET file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "WORKSHEET Splitter In C#"
description: "Split WORKSHEET with a few lines of .NET code."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/merger/net/) makes it easy for C# developers to split a single WORKSHEET file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
     ...
     {{< merger/code-merger title="How to split WORKSHEET files using C# example code">}}
