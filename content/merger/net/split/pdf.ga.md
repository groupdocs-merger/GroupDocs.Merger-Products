...
############################# Head ############################
head_title: "Scoilt PDF ina Ilchomhaid i C#"
...
############################# Header ############################
title: "PDF Scoilteoir i C#"
description: "Scoilt PDF le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt PDF Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin PDF a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid PDF a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt PDF comhad ag baint úsáide as GroupDocs.Merger API
