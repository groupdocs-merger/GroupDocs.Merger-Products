...
############################# Head ############################
head_title: "Jagage XLTX mitmeks failiks rakenduses C#"
...
description: "Tükeldage XLTX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage XLTX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks XLTX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada XLTX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail XLTX, kasutades GroupDocs.Merger API-t
