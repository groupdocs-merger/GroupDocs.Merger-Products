...
############################# Head ############################
head_title: "Divida XLSM em vários arquivos em C#"
...
############################# Header ############################
title: "XLSM Divisor em C#"
description: "Divida XLSM com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLSM em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLSM em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLSM usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLSM usando a API GroupDocs.Merger
