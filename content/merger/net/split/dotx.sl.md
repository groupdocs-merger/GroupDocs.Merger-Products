...
############################# Head ############################
head_title: "Razdeli DOTX na več datotek v C#"
...
############################# Header ############################
title: "DOTX razdelilnik v C#"
description: "Razdelite DOTX z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli DOTX strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke DOTX na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke DOTX s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko DOTX z API-jem GroupDocs.Merger
