...
############################# Head ############################
head_title: "Skiptu XLAM í margar skrár í C#"
...
############################# Header ############################
title: "XLAM Skerandi í C#"
description: "Skiptu XLAM með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XLAM skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XLAM skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XLAM skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XLAM skrá með GroupDocs.Merger API
