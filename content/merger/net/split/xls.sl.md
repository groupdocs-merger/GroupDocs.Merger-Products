...
############################# Head ############################
head_title: "Razdeli XLS na več datotek v C#"
...
############################# Header ############################
title: "XLS razdelilnik v C#"
description: "Razdelite XLS z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli XLS strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke XLS na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke XLS s primerom kode C#">}}

        ```csharp    
        // Razdeli datoteko XLS z API-jem GroupDocs.Merger
