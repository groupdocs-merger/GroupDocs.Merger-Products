...
############################# Head ############################
head_title: "Del XLSM i flere filer i C#"
...
description: "Del XLSM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XLSM filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XLSM-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XLSM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XLSM-filen ved hjelp av GroupDocs.Merger API
