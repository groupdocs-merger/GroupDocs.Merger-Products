...
############################# Head ############################
head_title: "Skiptu XPS í margar skrár í C#"
...
############################# Header ############################
title: "XPS Skerandi í C#"
description: "Skiptu XPS með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu XPS skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni XPS skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta XPS skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu XPS skrá með GroupDocs.Merger API
