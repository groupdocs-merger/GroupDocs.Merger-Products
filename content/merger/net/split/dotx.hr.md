...
############################# Head ############################
head_title: "Podijeli DOTX u više datoteka u C#"
...
############################# Header ############################
title: "DOTX Splitter u C#"
description: "Podijelite DOTX s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOTX stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOTX datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOTX datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOTX datoteku pomoću API-ja GroupDocs.Merger
