...
############################# Head ############################
head_title: "Teilen Sie EXCEL in mehrere Dateien in C#"
...
############################# Header ############################
title: "EXCEL Splittereingang C#"
description: "Teilen Sie EXCEL mit ein paar Zeilen .NET-Code."
...
steps:
    enable: true
    title_left: "Teilen Sie EXCEL Dateiseiten in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) macht es C#-Entwicklern einfach, eine einzelne EXCEL-Datei in mehrere resultierende Dateien aufzuteilen, indem sie a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So teilen Sie EXCEL-Dateien mit C#-Beispielcode">}}

        ```csharp    
        // Teilen Sie die EXCEL-Datei mithilfe der GroupDocs.Merger-API
