...
############################# Head ############################
head_title: "Pisahkan VSTX kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSTX Pemisah Dalam C#"
description: "Pisahkan VSTX dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSTX Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSTX kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSTX fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSTX menggunakan API GroupDocs.Merger
