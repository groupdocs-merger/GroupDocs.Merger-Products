...
############################# Head ############################
head_title: "Pisahkan MHT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "MHT Pemisah Dalam C#"
description: "Pisahkan MHT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan MHT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail MHT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi MHT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail MHT menggunakan API GroupDocs.Merger
