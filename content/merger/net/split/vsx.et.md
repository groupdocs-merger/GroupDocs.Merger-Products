...
############################# Head ############################
head_title: "Jagage VSX mitmeks failiks rakenduses C#"
...
description: "Tükeldage VSX mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage VSX faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks VSX-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada VSX faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail VSX, kasutades GroupDocs.Merger API-t
