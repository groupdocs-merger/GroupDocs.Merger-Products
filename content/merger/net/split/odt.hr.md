...
############################# Head ############################
head_title: "Podijeli ODT u više datoteka u C#"
...
############################# Header ############################
title: "ODT Splitter u C#"
description: "Podijelite ODT s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli ODT stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne ODT datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti ODT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli ODT datoteku pomoću API-ja GroupDocs.Merger
