...
############################# Head ############################
head_title: "Skiptu ODP í margar skrár í C#"
...
############################# Header ############################
title: "ODP Skerandi í C#"
description: "Skiptu ODP með nokkrum línum af .NET kóða."
...
steps:
    enable: true
    title_left: "Skiptu ODP skráarsíðum í .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/is/merger/net/) auðveldar C# forriturum að skipta einni ODP skrá í margar skrár sem myndast með því að útfæra nokkur auðveld skref.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvernig á að skipta ODP skrám með því að nota C# dæmikóða">}}

        ```csharp    
        // Skiptu ODP skrá með GroupDocs.Merger API
