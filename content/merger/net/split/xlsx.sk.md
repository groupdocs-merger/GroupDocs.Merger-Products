...
############################# Head ############################
head_title: "Rozdeliť XLSX do viacerých súborov v C#"
...
############################# Header ############################
title: "XLSX Splitter v C#"
description: "Rozdeľte XLSX niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť XLSX strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor XLSX na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť XLSX súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor XLSX pomocou rozhrania GroupDocs.Merger API
