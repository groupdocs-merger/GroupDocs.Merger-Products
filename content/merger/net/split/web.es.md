...
############################# Head ############################
head_title: "Dividir WEB en varios archivos en C#"
...
############################# Header ############################
title: "WEB Divisor en C#"
description: "Divida WEB con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir WEB páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo WEB en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos WEB usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo WEB usando GroupDocs.Merger API
