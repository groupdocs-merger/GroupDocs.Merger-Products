...
############################# Head ############################
head_title: "Divida XLSB em vários arquivos em C#"
...
############################# Header ############################
title: "XLSB Divisor em C#"
description: "Divida XLSB com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir páginas de arquivo XLSB em .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) facilita para os desenvolvedores do C# dividir um único arquivo XLSB em vários arquivos resultantes implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como dividir arquivos XLSB usando o código de exemplo C#">}}

        ```csharp    
        // Divida o arquivo XLSB usando a API GroupDocs.Merger
