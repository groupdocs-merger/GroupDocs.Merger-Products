...
############################# Head ############################
head_title: "Podziel DOT na wiele plików w C#"
...
############################# Header ############################
title: "DOT Rozdzielacz w C#"
description: "Podziel DOT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików DOT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku DOT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki DOT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik DOT za pomocą GroupDocs.Merger API
