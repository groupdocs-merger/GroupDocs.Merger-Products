...
############################# Head ############################
head_title: "Dela upp EPUB i flera filer i C#"
...
############################# Header ############################
title: "EPUB splitter i C#"
description: "Dela upp EPUB med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp EPUB filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda EPUB-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp EPUB-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela EPUB-fil med GroupDocs.Merger API
