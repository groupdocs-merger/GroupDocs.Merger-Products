...
############################# Head ############################
head_title: "DOTM'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "DOTM Ayırıcı C#"
description: "DOTM kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "DOTM Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak DOTM dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak DOTM dosyasını ayırın
