...
############################# Head ############################
head_title: "Pisahkan dokumen DOCX dalam aplikasi .NET"
head_description: "Gunakan GroupDocs.Merger for .NET untuk memisahkan file DOCX menjadi dokumen terpisah. Kelola file PDF, dokumen Word, lembar Excel, slide PowerPoint, file Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Pisahkan file DOCX" 
description: "GroupDocs.Merger for .NET meningkatkan aplikasi .NET dengan fitur pemrosesan dokumen canggih. Pisahkan file DOCX dan bekerja dengan berbagai format bisnis populer."
...
steps:
    enable: true
    title: "Cara memisahkan file DOCX"
    content: |
      Dengan [GroupDocs.Merger](/merger/net/), Anda dapat memisahkan dokumen DOCX dan menyimpan halaman yang dipilih sebagai file baru. Tingkatkan pemrosesan dokumen dalam aplikasi .NET Anda.
      
      1. Tentukan jalur sumber dari file DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Pisahkan dokumen DOCX dan simpan halaman genap"
      content: |
        Contoh ini menunjukkan cara memisahkan dokumen DOCX dan menyimpan semua halaman genap sebagai file terpisah.
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
