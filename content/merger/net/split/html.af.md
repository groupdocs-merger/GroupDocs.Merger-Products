...
############################# Head ############################
head_title: "Verdeel HTML in veelvuldige lêers in C#"
...
description: "Verdeel HTML met 'n paar reëls van .NET-kode."
...
steps:
    enable: true
    title_left: "Verdeel HTML lêerbladsye in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/af/merger/net/) maak dit maklik vir C#-ontwikkelaars om 'n enkele HTML-lêer in veelvuldige resulterende lêers te verdeel deur 'n paar maklike stappe.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe om HTML lêers te verdeel met behulp van C# voorbeeldkode">}}

        ```csharp    
        // Verdeel HTML lêer deur GroupDocs.Merger API te gebruik
