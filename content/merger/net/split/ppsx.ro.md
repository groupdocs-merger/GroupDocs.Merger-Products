...
############################# Head ############################
head_title: "Împărțiți PPSX în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter PPSX în C#"
description: "Împărțiți PPSX cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere PPSX în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier PPSX în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere PPSX folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul PPSX utilizând API-ul GroupDocs.Merger
