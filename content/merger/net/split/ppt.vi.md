...
############################# Head ############################
head_title: "Tách PPT thành nhiều tệp trong C#"
...
############################# Header ############################
title: "PPT Splitter trong C#"
description: "Tách PPT bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp PPT trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp PPT thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp PPT bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp PPT bằng API GroupDocs.Merger
