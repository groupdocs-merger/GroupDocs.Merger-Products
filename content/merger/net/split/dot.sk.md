...
############################# Head ############################
head_title: "Rozdeliť DOT do viacerých súborov v C#"
...
############################# Header ############################
title: "DOT Splitter v C#"
description: "Rozdeľte DOT niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť DOT strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor DOT na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť DOT súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor DOT pomocou rozhrania GroupDocs.Merger API
