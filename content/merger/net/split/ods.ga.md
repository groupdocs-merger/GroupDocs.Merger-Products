...
############################# Head ############################
head_title: "Scoilt ODS ina Ilchomhaid i C#"
...
############################# Header ############################
title: "ODS Scoilteoir i C#"
description: "Scoilt ODS le cúpla líne de chód .NET."
...
steps:
    enable: true
    title_left: "Scoilt ODS Leathanaigh Chomhaid i .NET"
    content_left: |
        Déanann [GroupDocs.Merger for .NET](/ga/merger/net/) é éasca d'fhorbróirí C# comhad amháin ODS a roinnt ina chomhaid iarmhartacha éagsúla trí chomhad iarmhartach a chur i bhfeidhm roinnt céimeanna éasca.
    ...
    code: |
     ...
     {{< merger/code-merger title="Conas comhaid ODS a scoilt trí úsáid a bhaint as C# cód samplach">}}

        ```csharp    
        // Scoilt ODS comhad ag baint úsáide as GroupDocs.Merger API
