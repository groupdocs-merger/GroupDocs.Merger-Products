...
############################# Head ############################
head_title: "Dividir EPUB en varios archivos en C#"
...
############################# Header ############################
title: "EPUB Divisor en C#"
description: "Divida EPUB con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir EPUB páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo EPUB en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos EPUB usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo EPUB usando GroupDocs.Merger API
