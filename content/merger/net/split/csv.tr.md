...
############################# Head ############################
head_title: "CSV'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "CSV Ayırıcı C#"
description: "CSV kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "CSV Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak CSV dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak CSV dosyasını ayırın
