...
############################# Head ############################
head_title: "Podziel ODP na wiele plików w C#"
...
############################# Header ############################
title: "ODP Rozdzielacz w C#"
description: "Podziel ODP z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików ODP w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku ODP na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki ODP przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik ODP za pomocą GroupDocs.Merger API
