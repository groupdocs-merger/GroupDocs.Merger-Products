...
############################# Head ############################
head_title: "Podijeli ODS u više datoteka u C#"
...
############################# Header ############################
title: "ODS Splitter u C#"
description: "Podijelite ODS s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli ODS stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne ODS datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti ODS datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli ODS datoteku pomoću API-ja GroupDocs.Merger
