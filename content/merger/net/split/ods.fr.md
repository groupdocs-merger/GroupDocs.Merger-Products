...
############################# Head ############################
head_title: "Divisez ODS en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "ODS Séparateur dans C#"
description: "Divisez ODS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner ODS pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier ODS en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers ODS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier ODS à l'aide de l'API GroupDocs.Merger
