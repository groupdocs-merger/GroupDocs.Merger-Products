...
############################# Head ############################
head_title: "XLT файлын C# ішінде бірнеше файлға бөліңіз"
...
############################# Header ############################
title: "XLT C# ішіндегі бөлгіш"
description: "XLT кодының бірнеше жолын .NET кодымен бөліңіз."
...
steps:
    enable: true
    title_left: ".NET ішіндегі XLT файл беттерін бөлу"
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) C# әзірлеушілеріне бір XLT файлды бірнеше нәтиже файлдарына бөлуді жеңілдетеді бірнеше оңай қадамдар.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLT файлдарды C# мысал кодын пайдаланып қалай бөлуге болады">}}

        ```csharp    
        // GroupDocs.Merger API арқылы XLT файлды бөліңіз
