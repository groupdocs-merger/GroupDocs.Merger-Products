...
############################# Head ############################
head_title: "Podziel PDF na wiele plików w C#"
...
############################# Header ############################
title: "PDF Rozdzielacz w C#"
description: "Podziel PDF z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików PDF w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku PDF na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki PDF przy użyciu przykładowego kodu C#">}}
