...
############################# Head ############################
head_title: "Dividiu XLT en diversos fitxers a C#"
...
############################# Header ############################
title: "XLT Divisor a C#"
description: "Dividiu XLT amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers XLT a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer XLT en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers XLT utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer XLT mitjançant l'API de GroupDocs.Merger
