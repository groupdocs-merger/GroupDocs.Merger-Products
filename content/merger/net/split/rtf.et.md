...
############################# Head ############################
head_title: "Jagage RTF mitmeks failiks rakenduses C#"
...
description: "Tükeldage RTF mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage RTF faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks RTF-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada RTF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail RTF, kasutades GroupDocs.Merger API-t
