...
############################# Head ############################
head_title: "Razdeli PDF na več datotek v C#"
...
############################# Header ############################
title: "PDF razdelilnik v C#"
description: "Razdelite PDF z nekaj vrsticami kode .NET."
...
steps:
    enable: true
    title_left: "Razdeli PDF strani datotek v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem C# olajša razdelitev ene datoteke PDF na več nastalih datotek z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako razdeliti datoteke PDF s primerom kode C#">}}
