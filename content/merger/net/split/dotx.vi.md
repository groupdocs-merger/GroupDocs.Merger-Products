...
############################# Head ############################
head_title: "Tách DOTX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "DOTX Splitter trong C#"
description: "Tách DOTX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp DOTX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp DOTX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp DOTX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp DOTX bằng API GroupDocs.Merger
