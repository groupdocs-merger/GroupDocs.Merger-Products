...
############################# Head ############################
head_title: "C# में ODS को कई फाइलों में विभाजित करें"
...
############################# Header ############################
title: "ODS स्प्लिटर इन C#"
description: "ODS को .NET कोड की कुछ पंक्तियों से विभाजित करें।"
...
steps:
    enable: true
    title_left: "ODS फ़ाइल पृष्ठों को .NET में विभाजित करें"
    content_left: |
        [GroupDocs.Merger for .NET](/hi/merger/net/) डेवलपर्स के लिए C# डेवलपर्स के लिए एक ODS फ़ाइल को कई परिणामी फाइलों में विभाजित करना आसान बनाता है। कुछ आसान कदम।
    ...
    code: |
     ...
     {{< merger/code-merger title="C# उदाहरण कोड का उपयोग करके ODS फ़ाइलों को कैसे विभाजित करें">}}

        ```csharp    
        // GroupDocs.Merger API का उपयोग करके ODS फ़ाइल को विभाजित करें
