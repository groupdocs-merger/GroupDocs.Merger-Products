...
############################# Head ############################
head_title: "Pisahkan VSDM kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "VSDM Pemisah Dalam C#"
description: "Pisahkan VSDM dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan VSDM Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail VSDM kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi VSDM fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail VSDM menggunakan API GroupDocs.Merger
