...
############################# Head ############################
head_title: "VSDM'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSDM Ayırıcı C#"
description: "VSDM kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSDM Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSDM dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSDM dosyasını ayırın
