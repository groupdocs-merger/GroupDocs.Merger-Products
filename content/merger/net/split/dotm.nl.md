...
############################# Head ############################
head_title: "Splits DOTM in meerdere bestanden in C#"
...
description: "Splits DOTM met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits DOTM Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel DOTM bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOTM bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits DOTM bestand met behulp van GroupDocs.Merger API
