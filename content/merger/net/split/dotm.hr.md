...
############################# Head ############################
head_title: "Podijeli DOTM u više datoteka u C#"
...
############################# Header ############################
title: "DOTM Splitter u C#"
description: "Podijelite DOTM s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli DOTM stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne DOTM datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti DOTM datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli DOTM datoteku pomoću API-ja GroupDocs.Merger
