...
############################# Head ############################
head_title: "在.NET应用中拆分TXT文档"
head_description: "使用GroupDocs.Merger for .NET将TXT文件拆分为单独的文档。管理PDF、Word文件、Excel表、PowerPoint幻灯片、Visio文件、图像、压缩文件等变得简单。"

############################# Header ############################
title: "拆分TXT文件" 
description: "GroupDocs.Merger for .NET通过先进的文档处理功能增强.NET应用程序。拆分TXT文件并处理多种常用业务格式。"
...
steps:
    ...
    title: "如何拆分TXT文件"
    content: |
      使用[GroupDocs.Merger](/merger/net/)，您可以拆分TXT文档并将选定页面保存为新文件。提升您在.NET应用中的文档处理能力。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "拆分TXT文档并保存偶数页"
      content: |
        本示例展示如何拆分一个TXT文档，并将所有偶数页保存为单独文件。
      code:
        title: "C#"
        content: |
          ```csharp {style=abap}
