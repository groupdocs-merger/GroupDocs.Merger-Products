...
############################# Head ############################
head_title: "Jagage CSV mitmeks failiks rakenduses C#"
...
description: "Tükeldage CSV mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage CSV faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks CSV-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada CSV faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail CSV, kasutades GroupDocs.Merger API-t
