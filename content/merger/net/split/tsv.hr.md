...
############################# Head ############################
head_title: "Podijeli TSV u više datoteka u C#"
...
############################# Header ############################
title: "TSV Splitter u C#"
description: "Podijelite TSV s nekoliko redaka .NET koda."
...
steps:
    enable: true
    title_left: "Podijeli TSV stranice datoteke u .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za C# olakšava dijeljenje jedne TSV datoteke u više rezultirajućih datoteka implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako podijeliti TSV datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Podijeli TSV datoteku pomoću API-ja GroupDocs.Merger
