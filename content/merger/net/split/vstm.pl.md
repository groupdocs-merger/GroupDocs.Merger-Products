...
############################# Head ############################
head_title: "Podziel VSTM na wiele plików w C#"
...
############################# Header ############################
title: "VSTM Rozdzielacz w C#"
description: "Podziel VSTM z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSTM w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSTM na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSTM przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSTM za pomocą GroupDocs.Merger API
