...
############################# Head ############################
head_title: "تقسيم XLT إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "XLT الفاصل في C#"
description: "قسِّم XLT ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات XLT في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد XLT إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات XLT باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف XLT باستخدام GroupDocs.Merger API
