...
############################# Head ############################
head_title: "VTX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VTX Ayırıcı C#"
description: "VTX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VTX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VTX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VTX dosyasını ayırın
