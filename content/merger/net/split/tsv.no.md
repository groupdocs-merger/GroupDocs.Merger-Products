...
############################# Head ############################
head_title: "Del TSV i flere filer i C#"
...
############################# Header ############################
title: "TSV splitter i C#"
description: "Del TSV med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del TSV filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt TSV-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp TSV filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del TSV-filen ved hjelp av GroupDocs.Merger API
