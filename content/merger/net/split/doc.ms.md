...
############################# Head ############################
head_title: "Pisahkan DOC kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "DOC Pemisah Dalam C#"
description: "Pisahkan DOC dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan DOC Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail DOC kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi DOC fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail DOC menggunakan API GroupDocs.Merger
