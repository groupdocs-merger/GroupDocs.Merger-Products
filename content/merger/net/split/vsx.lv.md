...
############################# Head ############################
head_title: "Sadaliet VSX vairākos failos programmā C#"
...
############################# Header ############################
title: "VSX sadalītājs programmā C#"
description: "Sadaliet VSX ar dažām .NET koda rindām."
...
steps:
    enable: true
    title_left: "Sadaliet VSX faila lapas pakalpojumā .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lv/merger/net/) ļauj C# izstrādātājiem viegli sadalīt vienu VSX failu vairākos iegūtajos failos, ieviešot daži vienkārši soļi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kā sadalīt VSX failus, izmantojot C# piemēra kodu">}}

        ```csharp    
        // Sadaliet VSX failu, izmantojot GroupDocs.Merger API
