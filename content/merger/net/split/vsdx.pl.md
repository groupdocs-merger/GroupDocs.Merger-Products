...
############################# Head ############################
head_title: "Podziel VSDX na wiele plików w C#"
...
############################# Header ############################
title: "VSDX Rozdzielacz w C#"
description: "Podziel VSDX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSDX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSDX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSDX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSDX za pomocą GroupDocs.Merger API
