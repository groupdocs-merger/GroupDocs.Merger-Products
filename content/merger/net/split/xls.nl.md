...
############################# Head ############################
head_title: "Splits XLS in meerdere bestanden in C#"
...
description: "Splits XLS met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits XLS Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel XLS bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLS bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits XLS bestand met behulp van GroupDocs.Merger API
