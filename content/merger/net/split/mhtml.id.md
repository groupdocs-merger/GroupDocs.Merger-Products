...
############################# Head ############################
head_title: "Pisahkan MHTML menjadi Beberapa File di C#"
...
############################# Header ############################
title: "MHTML Pemisah Di C#"
description: "Pisahkan MHTML dengan beberapa baris kode .NET."
...
steps:
    enable: true
    title_left: "Pisahkan MHTML Halaman File di .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/id/merger/net/) memudahkan pengembang C# untuk membagi satu file MHTML menjadi beberapa file yang dihasilkan dengan menerapkan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membagi file MHTML menggunakan kode contoh C#">}}
