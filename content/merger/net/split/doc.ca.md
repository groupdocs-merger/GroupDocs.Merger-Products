...
############################# Head ############################
head_title: "Dividiu DOC en diversos fitxers a C#"
...
############################# Header ############################
title: "DOC Divisor a C#"
description: "Dividiu DOC amb unes quantes línies de codi .NET."
...
steps:
    enable: true
    title_left: "Dividiu les pàgines de fitxers DOC a .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ca/merger/net/) facilita als desenvolupadors de C# dividir un únic fitxer DOC en diversos fitxers resultants mitjançant la implementació d'un uns quants passos fàcils.
    ...
    code: |
     ...
     {{< merger/code-merger title="Com dividir fitxers DOC utilitzant el codi d'exemple C#">}}

        ```csharp    
        // Dividiu el fitxer DOC mitjançant l'API de GroupDocs.Merger
