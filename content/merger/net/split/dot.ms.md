...
############################# Head ############################
head_title: "Pisahkan DOT kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "DOT Pemisah Dalam C#"
description: "Pisahkan DOT dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan DOT Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail DOT kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi DOT fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail DOT menggunakan API GroupDocs.Merger
