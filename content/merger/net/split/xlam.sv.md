...
############################# Head ############################
head_title: "Dela upp XLAM i flera filer i C#"
...
description: "Dela upp XLAM med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp XLAM filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda XLAM-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp XLAM-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela XLAM-fil med GroupDocs.Merger API
