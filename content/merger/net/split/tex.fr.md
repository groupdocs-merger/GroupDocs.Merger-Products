...
############################# Head ############################
head_title: "Divisez TEX en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "TEX Séparateur dans C#"
description: "Divisez TEX avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner TEX pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier TEX en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers TEX à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier TEX à l'aide de l'API GroupDocs.Merger
