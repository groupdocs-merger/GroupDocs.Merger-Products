...
############################# Head ############################
head_title: "Del XPS i flere filer i C#"
...
description: "Del XPS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Del XPS filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/no/merger/net/) gjør det enkelt for C#-utviklere å dele en enkelt XPS-fil i flere resulterende filer ved å implementere en noen enkle trinn.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan dele opp XPS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Del XPS-filen ved hjelp av GroupDocs.Merger API
