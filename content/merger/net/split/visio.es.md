...
############################# Head ############################
head_title: "Dividir VISIO en varios archivos en C#"
...
############################# Header ############################
title: "VISIO Divisor en C#"
description: "Divida VISIO con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VISIO páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VISIO en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VISIO usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VISIO usando GroupDocs.Merger API
