...
############################# Head ############################
head_title: "Splits ONE in meerdere bestanden in C#"
...
############################# Header ############################
title: "ONE Splitter in C#"
description: "Splits ONE met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Splits ONE Bestandspagina's in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor C# ontwikkelaars gemakkelijk om een ​​enkel ONE bestand in meerdere resulterende bestanden te splitsen door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe ONE bestanden te splitsen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Splits ONE bestand met behulp van GroupDocs.Merger API
