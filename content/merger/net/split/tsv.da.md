...
############################# Head ############################
head_title: "Opdel TSV i flere filer i C#"
...
description: "Opdel TSV med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Opdel TSV filsider i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for C#-udviklere at opdele en enkelt TSV-fil i flere resulterende filer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan opdeles TSV filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Opdel TSV fil ved hjælp af GroupDocs.Merger API
