...
############################# Head ############################
head_title: "Dela upp TSV i flera filer i C#"
...
description: "Dela upp TSV med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp TSV filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda TSV-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp TSV-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela TSV-fil med GroupDocs.Merger API
