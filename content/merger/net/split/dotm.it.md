...
############################# Head ############################
head_title: "Dividi DOTM in più file in C#"
...
############################# Header ############################
title: "DOTM Separatore in C#"
description: "Dividi DOTM con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file DOTM in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file DOTM in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file DOTM utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file DOTM utilizzando l'API GroupDocs.Merger
