...
############################# Head ############################
head_title: "Podziel VSTX na wiele plików w C#"
...
############################# Header ############################
title: "VSTX Rozdzielacz w C#"
description: "Podziel VSTX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VSTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VSTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VSTX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VSTX za pomocą GroupDocs.Merger API
