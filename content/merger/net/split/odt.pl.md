...
############################# Head ############################
head_title: "Podziel ODT na wiele plików w C#"
...
############################# Header ############################
title: "ODT Rozdzielacz w C#"
description: "Podziel ODT z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików ODT w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku ODT na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki ODT przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik ODT za pomocą GroupDocs.Merger API
