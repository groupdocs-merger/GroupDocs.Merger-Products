...
############################# Head ############################
head_title: "Jagage DOCM mitmeks failiks rakenduses C#"
...
description: "Tükeldage DOCM mõne reaga .NET koodiga."
...
steps:
    enable: true
    title_left: "Jagage DOCM faililehte tootes .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) muudab C# arendajatel lihtsaks jagada üks DOCM-fail mitmeks tulemuseks olevaks failiks, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas jagada DOCM faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Poolita fail DOCM, kasutades GroupDocs.Merger API-t
