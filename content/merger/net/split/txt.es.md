...
############################# Head ############################
head_title: "Dividir TXT en varios archivos en C#"
...
############################# Header ############################
title: "TXT Divisor en C#"
description: "Divida TXT con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir TXT páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo TXT en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos TXT usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo TXT usando GroupDocs.Merger API
