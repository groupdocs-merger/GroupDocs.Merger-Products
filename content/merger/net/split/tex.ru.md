...
############################# Head ############################
head_title: "Разделить TEX на несколько файлов на C#"
...
############################# Header ############################
title: "TEX Разделитель на C#"
description: "Разделите TEX страницы с помощью нескольких строк .NET кода."
...
steps:
    enable: true
    title_left: "Разделить страницы TEX документов на .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ru/merger/net/) позволяет разработчикам C# легко разделить один файл TEX на несколько результирующих файлов, реализуя несколько простых шагов.
    ...
    code: |
     ...
     {{< merger/code-merger title="Как разделить файлы TEX, используя пример кода C#">}}

        ```csharp    
        // Разделить файл TEX с помощью GroupDocs.Merger API
