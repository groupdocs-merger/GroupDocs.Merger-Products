...
############################# Head ############################
head_title: "Jaa DOCX useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "DOCX Jakaja sisään C#"
description: "Jaa DOCX muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa DOCX tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden DOCX-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa DOCX tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto DOCX GroupDocs.Merger API:lla
