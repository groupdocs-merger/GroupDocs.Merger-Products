...
############################# Head ############################
head_title: "Rozdeliť RTF do viacerých súborov v C#"
...
############################# Header ############################
title: "RTF Splitter v C#"
description: "Rozdeľte RTF niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť RTF strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor RTF na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť RTF súbory pomocou C# vzorového kódu">}}

        ```csharp    
        // Rozdeľte súbor RTF pomocou rozhrania GroupDocs.Merger API
