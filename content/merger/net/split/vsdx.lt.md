...
############################# Head ############################
head_title: "Padalinkite VSDX į kelis failus C#"
...
############################# Header ############################
title: "VSDX skirstytuvas C#"
description: "Padalinkite VSDX keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite VSDX failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną VSDX failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti VSDX failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite VSDX failą naudodami GroupDocs.Merger API
