...
############################# Head ############################
head_title: "Dela upp OTP i flera filer i C#"
...
description: "Dela upp OTP med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Dela upp OTP filsidor i .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för C#-utvecklare att dela upp en enda OTP-fil i flera resulterande filer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man delar upp OTP-filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Dela OTP-fil med GroupDocs.Merger API
