...
############################# Head ############################
head_title: "Divisez PPS en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "PPS Séparateur dans C#"
description: "Divisez PPS avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner PPS pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier PPS en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers PPS à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier PPS à l'aide de l'API GroupDocs.Merger
