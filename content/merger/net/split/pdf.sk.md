...
############################# Head ############################
head_title: "Rozdeliť PDF do viacerých súborov v C#"
...
description: "Rozdeľte PDF niekoľkými riadkami kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdeliť PDF strán súboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/sk/merger/net/) uľahčuje vývojárom C# rozdeliť jeden súbor PDF na viacero výsledných súborov implementáciou niekoľko jednoduchých krokov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Ako rozdeliť PDF súbory pomocou C# vzorového kódu">}}
