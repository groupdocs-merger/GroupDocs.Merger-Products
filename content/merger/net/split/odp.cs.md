...
############################# Head ############################
head_title: "Rozdělit ODP do více souborů v C#"
...
description: "Rozdělte ODP několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Rozdělit ODP stránky souboru v .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům C# rozdělení jednoho souboru ODP do několika výsledných souborů implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak rozdělit ODP soubory pomocí C# ukázkového kódu">}}

        ```csharp    
        // Rozdělit soubor ODP pomocí GroupDocs.Merger API
