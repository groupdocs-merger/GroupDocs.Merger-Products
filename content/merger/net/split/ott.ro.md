...
############################# Head ############################
head_title: "Împărțiți OTT în mai multe fișiere în C#"
...
############################# Header ############################
title: "Splitter OTT în C#"
description: "Împărțiți OTT cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Împărțiți pagini de fișiere OTT în .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii C# împărțirea unui singur fișier OTT în mai multe fișiere rezultate prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să împărțiți fișiere OTT folosind codul exemplu C#">}}

        ```csharp    
        // Împărțiți fișierul OTT utilizând API-ul GroupDocs.Merger
