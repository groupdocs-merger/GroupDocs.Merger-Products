...
############################# Head ############################
head_title: "Podziel XLSX na wiele plików w C#"
...
############################# Header ############################
title: "XLSX Rozdzielacz w C#"
description: "Podziel XLSX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików XLSX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku XLSX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki XLSX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik XLSX za pomocą GroupDocs.Merger API
