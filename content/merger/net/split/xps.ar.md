...
############################# Head ############################
head_title: "تقسيم XPS إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "XPS الفاصل في C#"
description: "قسِّم XPS ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات XPS في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد XPS إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات XPS باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف XPS باستخدام GroupDocs.Merger API
