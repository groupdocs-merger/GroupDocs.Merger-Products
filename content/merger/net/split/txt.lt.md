...
############################# Head ############################
head_title: "Padalinkite TXT į kelis failus C#"
...
############################# Header ############################
title: "TXT skirstytuvas C#"
description: "Padalinkite TXT keliomis .NET kodo eilutėmis."
...
steps:
    enable: true
    title_left: "Padalinkite TXT failo puslapius .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/lt/merger/net/) leidžia C# kūrėjams lengvai padalinti vieną TXT failą į kelis gautus failus, įdiegiant keli lengvi žingsneliai.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kaip padalinti TXT failus naudojant C# pavyzdinį kodą">}}

        ```csharp    
        // Padalinkite TXT failą naudodami GroupDocs.Merger API
