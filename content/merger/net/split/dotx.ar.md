...
############################# Head ############################
head_title: "تقسيم DOTX إلى ملفات متعددة في C#"
...
############################# Header ############################
title: "DOTX الفاصل في C#"
description: "قسِّم DOTX ببضعة أسطر من كود .NET."
...
steps:
    enable: true
    title_left: "تقسيم صفحات الملفات DOTX في .NET"
    content_left: |
        يسهّل [GroupDocs.Merger for .NET](/ar/merger/net/) على مطوري C# تقسيم ملف واحد DOTX إلى عدة ملفات ناتجة عن طريق تنفيذ بضع خطوات سهلة.
    ...
    code: |
     ...
     {{< merger/code-merger title="كيفية تقسيم ملفات DOTX باستخدام كود مثال C#">}}

        ```csharp    
        // انقسام الملف DOTX باستخدام GroupDocs.Merger API
