...
############################# Head ############################
head_title: "VSX'i C# İçinde Birden Çok Dosyaya Böl"
...
############################# Header ############################
title: "VSX Ayırıcı C#"
description: "VSX kodunu birkaç satır .NET koduyla ayırın."
...
steps:
    enable: true
    title_left: "VSX Dosya Sayfalarını .NET İçinde Böl"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSX dosyaları nasıl bölünür">}}

        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSX dosyasını ayırın
