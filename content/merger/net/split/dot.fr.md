...
############################# Head ############################
head_title: "Divisez DOT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "DOT Séparateur dans C#"
description: "Divisez DOT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner DOT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier DOT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers DOT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier DOT à l'aide de l'API GroupDocs.Merger
