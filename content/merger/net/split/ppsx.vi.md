...
############################# Head ############################
head_title: "Tách PPSX thành nhiều tệp trong C#"
...
############################# Header ############################
title: "PPSX Splitter trong C#"
description: "Tách PPSX bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp PPSX trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp PPSX thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp PPSX bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp PPSX bằng API GroupDocs.Merger
