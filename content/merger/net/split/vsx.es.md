...
############################# Head ############################
head_title: "Dividir VSX en varios archivos en C#"
...
############################# Header ############################
title: "VSX Divisor en C#"
description: "Divida VSX con unas pocas líneas de código .NET."
...
steps:
    enable: true
    title_left: "Dividir VSX páginas de archivos en .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/es/merger/net/) facilita a los desarrolladores de C# dividir un único archivo VSX en varios archivos resultantes mediante la implementación de un unos sencillos pasos.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cómo dividir archivos VSX usando el código de ejemplo C#">}}

        ```csharp    
        // Divida el archivo VSX usando GroupDocs.Merger API
