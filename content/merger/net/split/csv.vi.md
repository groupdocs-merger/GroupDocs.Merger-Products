...
############################# Head ############################
head_title: "Tách CSV thành nhiều tệp trong C#"
...
############################# Header ############################
title: "CSV Splitter trong C#"
description: "Tách CSV bằng một vài dòng mã .NET."
...
steps:
    enable: true
    title_left: "Tách các Trang Tệp CSV trong .NET"
    content_left: |
        [GroupDocs.Merger for .NET] (/vi/merge/net/) giúp các nhà phát triển C# dễ dàng chia một tệp CSV thành nhiều tệp kết quả bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách chia tệp CSV bằng mã mẫu C#">}}

        ```csharp    
        // Tách tệp CSV bằng API GroupDocs.Merger
