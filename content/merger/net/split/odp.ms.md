...
############################# Head ############################
head_title: "Pisahkan ODP kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "ODP Pemisah Dalam C#"
description: "Pisahkan ODP dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan ODP Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail ODP kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi ODP fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail ODP menggunakan API GroupDocs.Merger
