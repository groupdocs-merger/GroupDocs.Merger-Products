...
############################# Head ############################
head_title: "Podziel CSV na wiele plików w C#"
...
############################# Header ############################
title: "CSV Rozdzielacz w C#"
description: "Podziel CSV z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików CSV w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku CSV na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki CSV przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik CSV za pomocą GroupDocs.Merger API
