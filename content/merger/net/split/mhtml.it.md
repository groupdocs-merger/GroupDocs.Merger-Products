...
############################# Head ############################
head_title: "Dividi MHTML in più file in C#"
...
############################# Header ############################
title: "MHTML Separatore in C#"
description: "Dividi MHTML con poche righe di codice .NET."
...
steps:
    enable: true
    title_left: "Dividi le pagine dei file MHTML in .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/it/merger/net/) consente agli sviluppatori di C# di dividere facilmente un singolo file MHTML in più file risultanti implementando un pochi semplici passaggi.
    ...
    code: |
     ...
     {{< merger/code-merger title="Come dividere i file MHTML utilizzando il codice di esempio C#">}}

        ```csharp    
        // Dividi il file MHTML utilizzando l'API GroupDocs.Merger
