...
############################# Head ############################
head_title: "Podziel VTX na wiele plików w C#"
...
############################# Header ############################
title: "VTX Rozdzielacz w C#"
description: "Podziel VTX z kilkoma linijkami kodu .NET."
...
steps:
    enable: true
    title_left: "Podziel strony plików VTX w .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/pl/merger/net/) ułatwia programistom C# podział pojedynczego pliku VTX na wiele plików wynikowych poprzez zaimplementowanie kilka prostych kroków.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak podzielić pliki VTX przy użyciu przykładowego kodu C#">}}

        ```csharp    
        // Podziel plik VTX za pomocą GroupDocs.Merger API
