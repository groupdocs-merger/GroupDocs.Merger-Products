...
############################# Head ############################
head_title: "Divisez OTT en plusieurs fichiers dans C#"
...
############################# Header ############################
title: "OTT Séparateur dans C#"
description: "Divisez OTT avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Fractionner OTT pages de fichiers dans .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de C# de diviser facilement un seul fichier OTT en plusieurs fichiers résultants en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment diviser les fichiers OTT à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fractionner le fichier OTT à l'aide de l'API GroupDocs.Merger
