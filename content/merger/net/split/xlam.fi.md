...
############################# Head ############################
head_title: "Jaa XLAM useiksi tiedostoiksi C#"
...
############################# Header ############################
title: "XLAM Jakaja sisään C#"
description: "Jaa XLAM muutamalla rivillä .NET-koodia."
...
steps:
    enable: true
    title_left: "Jaa XLAM tiedostosivua tuotteessa .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee C#-kehittäjien helpoksi jakaa yhden XLAM-tiedoston useiksi tuloksena oleviksi tiedostoiksi toteuttamalla muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka jakaa XLAM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Jaa tiedosto XLAM GroupDocs.Merger API:lla
