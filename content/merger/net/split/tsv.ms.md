...
############################# Head ############################
head_title: "Pisahkan TSV kepada Berbilang Fail dalam C#"
...
############################# Header ############################
title: "TSV Pemisah Dalam C#"
description: "Pisahkan TSV dengan beberapa baris kod .NET."
...
steps:
    enable: true
    title_left: "Pisahkan TSV Halaman Fail dalam .NET"
    content_left: |
        [GroupDocs.Merger for .NET](/ms/merger/net/) memudahkan pembangun C# membahagikan satu fail TSV kepada berbilang fail hasil dengan melaksanakan beberapa langkah mudah.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cara membahagi TSV fail menggunakan kod contoh C#.">}}

        ```csharp    
        // Pisahkan fail TSV menggunakan API GroupDocs.Merger
