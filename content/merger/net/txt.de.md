...
############################# Head ############################
head_title: "TXT-Dateien in C# zusammenführen | TXT Fusion"
head_description: "Führen Sie mehrere TXT-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "TXT Fusion in C#"
description: "Führen Sie TXT mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere TXT-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr TXT-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie TXT-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie TXT-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument TXT instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine TXT-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/txt) besuchen.
