...
############################# Head ############################
head_title: "C# ішіндегі VSDM файлдарды біріктіру | VSDM Біріктіру"
head_description: "C# .NET құжаттарын біріктіру API арқылы бірнеше VSDM файлдарды бір файлға біріктіріңіз. Арнайы беттерді немесе бет ауқымдарын әртүрлі құжаттардан бір құжатқа біріктіріңіз."

############################# Header ############################
title: "VSDM Біріктіру C#"
description: "VSDM кодының бірнеше жолын .NET кодымен біріктіріңіз."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/kk/merger/net/) .NET әзірлеушілеріне екі немесе одан да көп VSDM файлды қолданбаларында біріктіруді жеңілдетеді. бірнеше оңай қадамдар.
