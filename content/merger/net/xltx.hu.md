...
############################# Head ############################
head_title: "XLTX fájlok egyesítése a C#-ban | XLTX Egyesülés"
head_description: "Egyesítsen több XLTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "XLTX Egyesülés a C# programban"
description: "Egyesítse a(z) XLTX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több XLTX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több XLTX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="XLTX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen XLTX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több XLTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) webhely meglátogatásával.
