...
############################# Head ############################
head_title: "VSX Dosyalarını C# İçinde Birleştir | VSX Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak VSX dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak VSX dosyalarını birleştirin
