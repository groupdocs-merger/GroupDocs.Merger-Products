...
############################# Head ############################
head_title: "Spoji PPS datoteke u C# | PPS Spajanje"
head_description: "Spojite više PPS datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "PPS Spajanje u C#"
description: "Spoji PPS s nekoliko redaka .NET koda."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) pruža praktično rješenje za spajanje više PDF-ova, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, slika i mnogo drugih dokumenata u jednu datoteku unutar .NET aplikacija. GroupDocs.Merger će vam uštedjeti mnogo truda, jer vam je dopušteno spojiti PPS dokumenata - nema potrebe za instaliranjem bilo kakvog softvera treće strane, desktop aplikacija ili dodataka. Sada je nepotrebno gubiti vrijeme i spajati datoteke ručno! Misija GroupDocs je pružiti najbolju kvalitetu i pojednostaviti tijek rada za obradu dokumenata.
...
steps:
    enable: true
    title_left: "Kako spojiti više PPS datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava spajanje dvije ili više PPS datoteka unutar njihovih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti PPS datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Spoji PPS datoteke pomoću API-ja GroupDocs.Merger
...
demos:
    ...
    content: |
       Spojite više od jedne PPS datoteke upravo sada tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps) web mjesto.
