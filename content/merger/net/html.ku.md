...
############################# Head ############################
head_title: "Pelên HTML di C# de bike yek | HTML Hevgirtin"
head_description: "Gelek pelên HTML di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "HTML Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek HTML Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir HTML pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên HTML bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên HTML bi karanîna GroupDocs.Merger API-ê bikin yek
