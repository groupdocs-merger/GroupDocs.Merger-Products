...
############################# Head ############################
head_title: "Mesclar XLS Arquivos em C# | XLS Fusão"
head_description: "Mescle vários arquivos XLS em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLS Fusão em C#"
description: "Mescle XLS com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLS"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLS em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLS usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLS arquivos usando a API GroupDocs.Merger
