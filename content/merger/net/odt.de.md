...
############################# Head ############################
head_title: "ODT-Dateien in C# zusammenführen | ODT Fusion"
head_description: "Führen Sie mehrere ODT-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "ODT Fusion in C#"
description: "Führen Sie ODT mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere ODT-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr ODT-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie ODT-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie ODT-Dateien mit der GroupDocs.Merger-API zusammen
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine ODT-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) besuchen.
