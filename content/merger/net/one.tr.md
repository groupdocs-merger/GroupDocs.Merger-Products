...
############################# Head ############################
head_title: "ONE Dosyalarını C# İçinde Birleştir | ONE Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak ONE dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak ONE dosyalarını birleştirin
