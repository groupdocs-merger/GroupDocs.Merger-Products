...
############################# Head ############################
head_title: "Mesclar CSV Arquivos em C# | CSV Fusão"
head_description: "Mescle vários arquivos CSV em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "CSV Fusão em C#"
description: "Mescle CSV com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos CSV"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos CSV em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos CSV usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar CSV arquivos usando a API GroupDocs.Merger
