...
############################# Head ############################
head_title: "ODS fájlok egyesítése a C#-ban | ODS Egyesülés"
head_description: "Egyesítsen több ODS fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODS Egyesülés a C# programban"
description: "Egyesítse a(z) ODS terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODS fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODS fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODS fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen ODS fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több ODS fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods) webhely meglátogatásával.
