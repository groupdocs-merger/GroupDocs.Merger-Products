...
############################# Head ############################
head_title: "Ühendage MHTML failid C# | MHTML Ühinemine"
head_description: "Ühendage mitu MHTML faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "MHTML ühinemine programmis C#"
description: "Ühendage MHTML mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam MHTML faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita MHTML faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid MHTML, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks MHTML faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml).
