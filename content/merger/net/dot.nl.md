...
############################# Head ############################
head_title: "Voeg DOT bestanden samen in C# | DOT Fusie"
head_description: "Voeg meerdere DOT bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "DOT Fusie in C#"
description: "Voeg DOT samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere DOT bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer DOT-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe DOT bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg DOT bestanden samen met de GroupDocs.Merger API
