...
############################# Head ############################
head_title: "Mesclar MHT Arquivos em C# | MHT Fusão"
head_description: "Mescle vários arquivos MHT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "MHT Fusão em C#"
description: "Mescle MHT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos MHT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos MHT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos MHT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar MHT arquivos usando a API GroupDocs.Merger
