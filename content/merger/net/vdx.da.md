...
############################# Head ############################
head_title: "Flet VDX filer i C# | VDX Fusion"
head_description: "Flet flere VDX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VDX fusion i C#"
description: "Flet VDX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VDX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VDX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VDX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VDX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VDX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vdx).
