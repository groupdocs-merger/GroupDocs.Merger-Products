...
############################# Head ############################
head_title: "Mesclar XLTX Arquivos em C# | XLTX Fusão"
head_description: "Mescle vários arquivos XLTX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLTX Fusão em C#"
description: "Mescle XLTX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLTX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLTX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLTX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLTX arquivos usando a API GroupDocs.Merger
