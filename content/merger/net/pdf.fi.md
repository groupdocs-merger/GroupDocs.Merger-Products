...
############################# Head ############################
head_title: "Yhdistä PDF tiedostot C# | PDF Sulautuminen"
...
############################# Header ############################
title: "PDF Sulautuminen C#"
description: "Yhdistä PDF muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia PDF tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää PDF tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä PDF tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi PDF-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf) -sivustolla.
