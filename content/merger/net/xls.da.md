...
############################# Head ############################
head_title: "Flet XLS filer i C# | XLS Fusion"
head_description: "Flet flere XLS filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "XLS fusion i C#"
description: "Flet XLS med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere XLS-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere XLS-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes XLS filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet XLS filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én XLS-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xls).
