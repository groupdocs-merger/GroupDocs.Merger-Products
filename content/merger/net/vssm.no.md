...
############################# Head ############################
head_title: "Slå sammen VSSM-filer i C# | VSSM Fusjon"
...
############################# Header ############################
title: "VSSM sammenslåing i C#"
description: "Slå sammen VSSM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSSM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSSM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSSM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VSSM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssm).
