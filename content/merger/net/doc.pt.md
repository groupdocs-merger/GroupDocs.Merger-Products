...
############################# Head ############################
head_title: "Mesclar DOC Arquivos em C# | DOC Fusão"
head_description: "Mescle vários arquivos DOC em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "DOC Fusão em C#"
description: "Mescle DOC com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos DOC"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos DOC em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos DOC usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar DOC arquivos usando a API GroupDocs.Merger
