...
############################# Head ############################
head_title: "XLTM-Dateien in C# zusammenführen | XLTM Fusion"
head_description: "Führen Sie mehrere XLTM-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "XLTM Fusion in C#"
description: "Führen Sie XLTM mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere XLTM-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr XLTM-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie XLTM-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie XLTM-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument XLTM instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine XLTM-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltm) besuchen.
