...
############################# Head ############################
head_title: "MHT fájlok egyesítése a C#-ban | MHT Egyesülés"
head_description: "Egyesítsen több MHT fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "MHT Egyesülés a C# programban"
description: "Egyesítse a(z) MHT terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több MHT fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több MHT fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="MHT fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen MHT fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több MHT fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) webhely meglátogatásával.
