...
############################# Head ############################
head_title: "Slå sammen PPS-filer i C# | PPS Fusjon"
...
############################# Header ############################
title: "PPS sammenslåing i C#"
description: "Slå sammen PPS med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere PPS-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen PPS filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen PPS filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én PPS-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pps).
