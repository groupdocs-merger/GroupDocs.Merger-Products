...
############################# Head ############################
head_title: "TSV-Dateien in C# zusammenführen | TSV Fusion"
head_description: "Führen Sie mehrere TSV-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "TSV Fusion in C#"
description: "Führen Sie TSV mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere TSV-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr TSV-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie TSV-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie TSV-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument TSV instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine TSV-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tsv) besuchen.
