...
############################# Head ############################
head_title: "Voeg MHTML bestanden samen in C# | MHTML Fusie"
head_description: "Voeg meerdere MHTML bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "MHTML Fusie in C#"
description: "Voeg MHTML samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere MHTML bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer MHTML-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe MHTML bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg MHTML bestanden samen met de GroupDocs.Merger API
