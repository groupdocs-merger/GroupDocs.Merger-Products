...
############################# Head ############################
head_title: "Spoji datoteke EPUB v C# | EPUB Združitev"
head_description: "Spojite več datotek EPUB v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "EPUB Združitev v C#"
description: "Spojite EPUB z nekaj vrsticami kode .NET."
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke EPUB s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke EPUB z API-jem GroupDocs.Merger
