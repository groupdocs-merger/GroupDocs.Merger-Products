...
############################# Head ############################
head_title: "PPTX fájlok egyesítése a C#-ban | PPTX Egyesülés"
head_description: "Egyesítsen több PPTX fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "PPTX Egyesülés a C# programban"
description: "Egyesítse a(z) PPTX terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több PPTX fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több PPTX fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="PPTX fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen PPTX fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több PPTX fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pptx) webhely meglátogatásával.
