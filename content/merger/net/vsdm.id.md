...
############################# Header ############################
title: "VSDM Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSDM File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSDM file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
