...
############################# Head ############################
head_title: "Slå sammen XLTX-filer i C# | XLTX Fusjon"
...
############################# Header ############################
title: "XLTX sammenslåing i C#"
description: "Slå sammen XLTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLTX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLTX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLTX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx).
