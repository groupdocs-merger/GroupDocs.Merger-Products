...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa DOCX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu DOCX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docx).
