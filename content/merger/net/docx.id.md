...
############################# Head ############################
head_title: "Gabungkan file DOCX melalui .NET"
head_description: "Integrasikan penggabungan dokumen DOCX ke dalam proyek .NET Anda dengan GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gabungkan file DOCX" 
description: "Gunakan GroupDocs.Merger for .NET untuk membuat aplikasi .NET yang kuat yang mampu menggabungkan dan mengelola dokumen DOCX tanpa kendala."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan penggabungan dokumen DOCX. Tambahkan fungsionalitas penggabungan ke aplikasi .NET Anda dan gabungkan beberapa file dengan mulus.
      
      1. Tentukan jalur ke file DOCX yang pertama.
