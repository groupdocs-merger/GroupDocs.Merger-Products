...
############################# Head ############################
head_title: "Voeg OTP bestanden samen in C# | OTP Fusie"
head_description: "Voeg meerdere OTP bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "OTP Fusie in C#"
description: "Voeg OTP samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere OTP bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer OTP-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe OTP bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg OTP bestanden samen met de GroupDocs.Merger API
