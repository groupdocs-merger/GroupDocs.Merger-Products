...
############################# Head ############################
head_title: "Slå sammen XLAM-filer i C# | XLAM Fusjon"
...
############################# Header ############################
title: "XLAM sammenslåing i C#"
description: "Slå sammen XLAM med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLAM-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLAM filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLAM filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLAM-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlam).
