...
############################# Head ############################
head_title: "Spoji ODT datoteke u C# | ODT Spajanje"
head_description: "Spojite više ODT datoteka u jednu pomoću API-ja za spajanje dokumenata C# .NET. Spojite određene stranice ili raspone stranica iz različitih dokumenata u jedan dokument."

############################# Header ############################
title: "ODT Spajanje u C#"
description: "Spoji ODT s nekoliko redaka .NET koda."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) pruža praktično rješenje za spajanje više PDF-ova, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, slika i mnogo drugih dokumenata u jednu datoteku unutar .NET aplikacija. GroupDocs.Merger će vam uštedjeti mnogo truda, jer vam je dopušteno spojiti ODT dokumenata - nema potrebe za instaliranjem bilo kakvog softvera treće strane, desktop aplikacija ili dodataka. Sada je nepotrebno gubiti vrijeme i spajati datoteke ručno! Misija GroupDocs je pružiti najbolju kvalitetu i pojednostaviti tijek rada za obradu dokumenata.
...
steps:
    enable: true
    title_left: "Kako spojiti više ODT datoteka"
    content_left: |
        [GroupDocs.Merger for .NET](/hr/merger/net/) programerima za .NET olakšava spajanje dvije ili više ODT datoteka unutar njihovih aplikacija implementacijom nekoliko lakih koraka.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako spojiti ODT datoteke koristeći C# primjer koda">}}

        ```csharp    
        // Spoji ODT datoteke pomoću API-ja GroupDocs.Merger
        // Instancirajte spajanje s ulaznim ODT dokumentom
...
demos:
    ...
    content: |
       Spojite više od jedne ODT datoteke upravo sada tako da posjetite [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) web mjesto.
