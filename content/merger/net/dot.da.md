...
############################# Head ############################
head_title: "Flet DOT filer i C# | DOT Fusion"
head_description: "Flet flere DOT filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "DOT fusion i C#"
description: "Flet DOT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere DOT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere DOT-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes DOT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet DOT filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én DOT-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/dot).
