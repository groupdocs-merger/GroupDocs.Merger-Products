...
############################# Head ############################
head_title: "Slå samman VSSX-filer i C# | VSSX Sammanslagning"
head_description: "Slå samman flera VSSX-filer till en enda fil med hjälp av C# .NET dokumentsammanslagnings-API. Slå samman specifika sidor eller sidintervall från olika dokument till ett enda dokument."

############################# Header ############################
title: "VSSX sammanslagning i C#"
description: "Slå samman VSSX med några rader med .NET-kod."
...
steps:
    enable: true
    title_left: "Hur man slår ihop flera VSSX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/sv/merger/net/) gör det enkelt för .NET-utvecklare att slå samman två eller flera VSSX-filer i sina applikationer genom att implementera en några enkla steg.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hur man sammanfogar VSSX filer med hjälp av C# exempelkod">}}

        ```csharp    
        // Sammanfoga VSSX filer med GroupDocs.Merger API
