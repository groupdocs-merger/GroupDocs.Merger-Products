...
############################# Head ############################
head_title: "VSTX ፋይሎችን በC# | አዋህድ VSTX ውህደት"
head_description: "C# .NET ሰነዶች ውህደት ኤፒአይን በመጠቀም ብዙ VSTX ፋይሎችን ወደ አንድ ፋይል ያዋህዱ። የተወሰኑ ገጾችን ወይም ገጾችን ከተለያዩ ሰነዶች ወደ አንድ ሰነድ ያዋህዱ።"

############################# Header ############################
title: "የVSTX ውህደት በC#"
description: "VSTXን ከጥቂት የ.NET ኮድ መስመሮች ጋር አዋህድ።"
...
steps:
    enable: true
    title_left: "በርካታ VSTX ፋይሎችን እንዴት እንደሚዋሃድ"
    content_left: |
        [GroupDocs.Merger for .NET](/am/merger/net/) ለ.NET ገንቢዎች አንድን በመተግበር ሁለት ወይም ከዚያ በላይ የሆኑ VSTX ፋይሎችን በመተግበሪያዎቻቸው ውስጥ ማዋሃድ ቀላል ያደርገዋል። ጥቂት ቀላል ደረጃዎች.
    ...
    code: |
     ...
     {{< merger/code-merger title="የC# ምሳሌ ኮድን በመጠቀም VSTX ፋይሎችን እንዴት እንደሚዋሃድ">}}

        ```csharp    
        // GroupDocs.Merger API በመጠቀም VSTX ፋይሎችን አዋህድ
...
demos:
    ...
    content: |
       [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vstx) ድር ጣቢያን በመጎብኘት አሁን ከአንድ በላይ VSTX ፋይሎችን አዋህድ።
