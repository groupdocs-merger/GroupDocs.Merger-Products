...
############################# Head ############################
head_title: "Yhdistä XLT tiedostot C# | XLT Sulautuminen"
...
############################# Header ############################
title: "XLT Sulautuminen C#"
description: "Yhdistä XLT muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XLT tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XLT tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä XLT tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XLT-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt) -sivustolla.
