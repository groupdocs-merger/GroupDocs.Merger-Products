...
head_description: "Sujunkite kelis HTML failus į vieną failą naudodami C# .NET dokumentų sujungimo API. Sujunkite konkrečius puslapius arba puslapių diapazonus nuo įvairių dokumentų į vieną dokumentą."

############################# Header ############################
title: "HTML Susijungimas C#"
...
demos:
    ...
    content: |
       Sujunkite daugiau nei vieną HTML failą dabar apsilankę [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) svetainėje.
