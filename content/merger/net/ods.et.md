...
############################# Head ############################
head_title: "Ühendage ODS failid C# | ODS Ühinemine"
head_description: "Ühendage mitu ODS faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "ODS ühinemine programmis C#"
description: "Ühendage ODS mõne rea koodiga .NET."
...
steps:
    enable: true
    title_left: "Kuidas ühendada mitu ODS faili"
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam ODS faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita ODS faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid ODS, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks ODS faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ods).
