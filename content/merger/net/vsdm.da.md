...
############################# Head ############################
head_title: "Flet VSDM filer i C# | VSDM Fusion"
head_description: "Flet flere VSDM filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VSDM fusion i C#"
description: "Flet VSDM med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VSDM-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VSDM-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VSDM filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VSDM filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VSDM-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdm).
