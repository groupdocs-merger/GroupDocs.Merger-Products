...
############################# Header ############################
title: "VSSX Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa VSSX File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu VSSX file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx).
