...
############################# Head ############################
head_title: "Pelên ODP di C# de bike yek | ODP Hevgirtin"
head_description: "Gelek pelên ODP di pelek yekane de bi karanîna API-ya yekbûnê ya belgeyên C# .NET bikin yek. Rûpelên taybetî an rêzikên rûpelan ji belgeyên cihêreng bigire heya yek belgeyek yek."

############################# Header ############################
title: "ODP Yekbûn di C#"
...
steps:
    enable: true
    title_left: "Meriv çawa Gelek ODP Pelan dike yek"
    content_left: |
        [GroupDocs.Merger for .NET](/ku/merger/net/) ji pêşdebirên .NET re hêsantir dike ku du an bêtir ODP pelan di nav sepanên xwe de bi cîbicîkirina çend gavên hêsan.
    ...
    code: |
     ...
     {{< merger/code-merger title="Meriv çawa pelên ODP bi karanîna koda nimûneya C# dike yek">}}

        ```csharp    
        // Pelên ODP bi karanîna GroupDocs.Merger API-ê bikin yek
