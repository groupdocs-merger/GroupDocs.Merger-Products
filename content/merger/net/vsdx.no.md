...
############################# Head ############################
head_title: "Slå sammen VSDX-filer i C# | VSDX Fusjon"
...
############################# Header ############################
title: "VSDX sammenslåing i C#"
description: "Slå sammen VSDX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSDX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSDX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSDX filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én VSDX-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx).
