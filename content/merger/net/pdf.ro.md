...
############################# Head ############################
head_title: "Îmbinați fișierele PDF în C# | PDF Fuziune"
head_description: "Îmbinați mai multe fișiere PDF într-un singur fișier folosind API-ul de fuziune a documentelor C# .NET. Îmbinați anumite pagini sau intervale de pagini de la diverse documente la un singur document."

############################# Header ############################
title: "PDF Fuziune în C#"
description: "Îmbinați PDF cu câteva rânduri de cod .NET."
...
steps:
    enable: true
    title_left: "Cum să îmbinați mai multe fișiere PDF"
    content_left: |
        [GroupDocs.Merger for .NET](/ro/merger/net/) facilitează pentru dezvoltatorii .NET să îmbine două sau mai multe fișiere PDF în aplicațiile lor prin implementarea unui câțiva pași simpli.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cum să îmbinați fișiere PDF folosind codul exemplu C#">}}

        ```csharp    
        // Îmbinați fișiere PDF utilizând API-ul GroupDocs.Merger
...
demos:
    ...
    content: |
       Îmbinați mai mult de un fișier PDF chiar acum, vizitând site-ul web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/pdf).
