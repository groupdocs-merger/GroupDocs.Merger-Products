...
############################# Head ############################
head_title: "ODP fájlok egyesítése a C#-ban | ODP Egyesülés"
head_description: "Egyesítsen több ODP fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "ODP Egyesülés a C# programban"
description: "Egyesítse a(z) ODP terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több ODP fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több ODP fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="ODP fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen ODP fájlokat a GroupDocs.Merger API segítségével
...
demos:
    ...
    content: |
       Egyesítsen egynél több ODP fájlt most a [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odp) webhely meglátogatásával.
