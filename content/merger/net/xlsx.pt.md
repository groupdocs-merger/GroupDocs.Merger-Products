...
############################# Head ############################
head_title: "Mesclar XLSX Arquivos em C# | XLSX Fusão"
head_description: "Mescle vários arquivos XLSX em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "XLSX Fusão em C#"
description: "Mescle XLSX com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos XLSX"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos XLSX em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos XLSX usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar XLSX arquivos usando a API GroupDocs.Merger
