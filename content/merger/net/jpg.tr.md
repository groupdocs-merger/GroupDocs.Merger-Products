...
############################# Head ############################
head_title: "JPG Dosyalarını C# İçinde Birleştir | JPG Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak JPG dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak JPG dosyalarını birleştirin
