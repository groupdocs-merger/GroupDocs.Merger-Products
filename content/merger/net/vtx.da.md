...
############################# Head ############################
head_title: "Flet VTX filer i C# | VTX Fusion"
head_description: "Flet flere VTX filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "VTX fusion i C#"
description: "Flet VTX med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere VTX-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere VTX-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes VTX filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet VTX filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én VTX-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vtx).
