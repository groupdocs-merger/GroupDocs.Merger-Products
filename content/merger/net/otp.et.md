...
############################# Head ############################
head_title: "Ühendage OTP failid C# | OTP Ühinemine"
head_description: "Ühendage mitu OTP faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "OTP ühinemine programmis C#"
description: "Ühendage OTP mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam OTP faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita OTP faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid OTP, kasutades GroupDocs.Merger API-t
