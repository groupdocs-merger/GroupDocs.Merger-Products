...
############################# Head ############################
head_title: "Mesclar TXT Arquivos em C# | TXT Fusão"
head_description: "Mescle vários arquivos TXT em um único arquivo usando a API de fusão de documentos C# .NET. Mescle páginas específicas ou intervalos de páginas de vários documentos em um único documento."

############################# Header ############################
title: "TXT Fusão em C#"
description: "Mescle TXT com algumas linhas de código .NET."
...
steps:
    enable: true
    title_left: "Como mesclar vários arquivos TXT"
    content_left: |
        [GroupDocs.Merger for .NET](/pt/merger/net/) torna mais fácil para os desenvolvedores do .NET mesclar dois ou mais arquivos TXT em seus aplicativos implementando um alguns passos fáceis.
    ...
    code: |
     ...
     {{< merger/code-merger title="Como mesclar arquivos TXT usando o código de exemplo C#">}}

        ```csharp    
        // Mesclar TXT arquivos usando a API GroupDocs.Merger
