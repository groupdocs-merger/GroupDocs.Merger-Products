...
############################# Head ############################
head_title: "Ühendage RTF failid C# | RTF Ühinemine"
head_description: "Ühendage mitu RTF faili üheks failiks, kasutades C# .NET dokumentide liitmise API-t. Ühendage konkreetsed leheküljed või lehevahemikud erinevatest dokumentidest üheks dokumendiks."

############################# Header ############################
title: "RTF ühinemine programmis C#"
description: "Ühendage RTF mõne rea koodiga .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/et/merger/net/) võimaldab toote .NET arendajatel hõlpsasti liita oma rakendustes kaks või enam RTF faili, rakendades paar lihtsat sammu.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuidas liita RTF faili, kasutades C# näitekoodi">}}

        ```csharp    
        // Ühendage failid RTF, kasutades GroupDocs.Merger API-t
...
demos:
    ...
    content: |
       Ühendage kohe rohkem kui üks RTF faili, külastades veebisaiti [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
