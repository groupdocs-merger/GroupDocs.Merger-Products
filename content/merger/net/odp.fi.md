...
############################# Header ############################
title: "ODP Sulautuminen C#"
description: "Yhdistä ODP muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia ODP tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
