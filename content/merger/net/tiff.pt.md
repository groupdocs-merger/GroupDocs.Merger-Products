...
############################# Head ############################
head_title: "Mescle arquivos TIFF via .NET"
head_description: "Integre a mesclagem de documentos TIFF em seus projetos .NET com GroupDocs.Merger for .NET."

############################# Header ############################
title: "Mescle arquivos TIFF" 
description: "Utilize GroupDocs.Merger for .NET para criar aplicações poderosas em .NET que mesclam e gerenciam documentos TIFF de forma eficiente."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) facilita a mesclagem de documentos TIFF. Adicione a funcionalidade de mesclagem às suas aplicações .NET e combine vários arquivos de forma eficiente.
