...
############################# Head ############################
head_title: "Yhdistä XPS tiedostot C# | XPS Sulautuminen"
...
############################# Header ############################
title: "XPS Sulautuminen C#"
description: "Yhdistä XPS muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia XPS tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää XPS tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä XPS tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi XPS-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xps) -sivustolla.
