...
############################# Head ############################
head_title: "PPT-Dateien in C# zusammenführen | PPT Fusion"
head_description: "Führen Sie mehrere PPT-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "PPT Fusion in C#"
description: "Führen Sie PPT mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere PPT-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr PPT-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie PPT-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie PPT-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument PPT instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine PPT-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) besuchen.
