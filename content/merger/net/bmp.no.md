...
############################# Head ############################
head_title: "Slå sammen BMP-filer i C# | BMP Fusjon"
...
############################# Header ############################
title: "BMP sammenslåing i C#"
description: "Slå sammen BMP med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere BMP-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen BMP filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen BMP filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én BMP-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/bmp).
