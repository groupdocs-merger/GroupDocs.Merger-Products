...
############################# Head ############################
head_title: "Sloučit PPT soubory v C# | PPT Fúze"
head_description: "Sloučit více souborů PPT do jednoho souboru pomocí rozhraní API pro slučování dokumentů C# .NET. Sloučit konkrétní stránky nebo rozsahy stránek z různých dokumentů do jednoho dokumentu."

############################# Header ############################
title: "PPT Fúze v C#"
description: "Sloučit PPT s několika řádky kódu .NET."
...
steps:
    enable: true
    title_left: "Jak sloučit více souborů PPT"
    content_left: |
        [GroupDocs.Merger for .NET](/cs/merger/net/) usnadňuje vývojářům .NET sloučit dva nebo více souborů PPT v rámci jejich aplikací implementací několik snadných kroků.
    ...
    code: |
     ...
     {{< merger/code-merger title="Jak sloučit soubory PPT pomocí ukázkového kódu C#">}}

        ```csharp    
        // Sloučit PPT soubory pomocí GroupDocs.Merger API
