...
############################# Head ############################
head_title: "Fusionner les fichiers XLSB dans C# | XLSB Fusion"
head_description: "Fusionnez plusieurs fichiers XLSB en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "XLSB Fusionner dans C#"
description: "Fusionnez XLSB avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers XLSB"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers XLSB dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers XLSB à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner XLSB fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée XLSB
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers XLSB dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsb).
