...
############################# Head ############################
head_title: "Spoji datoteke JPEG v C# | JPEG Združitev"
head_description: "Spojite več datotek JPEG v eno datoteko z API-jem za združevanje dokumentov C# .NET. Združite določene strani ali obsege strani iz različnih dokumentov v en sam dokument."

############################# Header ############################
title: "JPEG Združitev v C#"
description: "Spojite JPEG z nekaj vrsticami kode .NET."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/sl/merger/net/) razvijalcem izdelka .NET olajša združevanje dveh ali več datotek JPEG znotraj njihovih aplikacij z implementacijo nekaj preprostih korakov.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kako združiti datoteke JPEG s primerom kode C#">}}
        ...
        ```csharp    
        // Spoji datoteke JPEG z API-jem GroupDocs.Merger
...
demos:
    ...
    content: |
       Združite več kot eno datoteko JPEG tako, da obiščete spletno mesto [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpeg).
