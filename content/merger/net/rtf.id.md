...
############################# Header ############################
title: "RTF Penggabungan Dalam C#"
...
steps:
    enable: true
    title_left: "Cara Menggabungkan Beberapa RTF File"
    content_left: |
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu RTF file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/rtf).
