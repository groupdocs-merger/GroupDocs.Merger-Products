...
############################# Head ############################
head_title: "Slå sammen VSTX-filer i C# | VSTX Fusjon"
...
############################# Header ############################
title: "VSTX sammenslåing i C#"
description: "Slå sammen VSTX med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere VSTX-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen VSTX filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen VSTX filer ved hjelp av GroupDocs.Merger API
