...
############################# Head ############################
head_title: "Slå sammen XLT-filer i C# | XLT Fusjon"
...
############################# Header ############################
title: "XLT sammenslåing i C#"
description: "Slå sammen XLT med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere XLT-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen XLT filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen XLT filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én XLT-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlt).
