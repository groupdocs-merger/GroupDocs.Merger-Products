...
############################# Head ############################
head_title: "JPG-Dateien in C# zusammenführen | JPG Fusion"
head_description: "Führen Sie mehrere JPG-Dateien mithilfe der Dokumentenfusions-API von C# .NET zu einer einzigen Datei zusammen. Führen Sie bestimmte Seiten oder Seitenbereiche aus verschiedenen Dokumenten zu einem einzigen Dokument zusammen."

############################# Header ############################
title: "JPG Fusion in C#"
description: "Führen Sie JPG mit ein paar Zeilen .NET-Code zusammen."
...
steps:
    enable: true
    title_left: "So führen Sie mehrere JPG-Dateien zusammen"
    content_left: |
        [GroupDocs.Merger for .NET](/de/merger/net/) erleichtert Entwicklern von .NET das Zusammenführen von zwei oder mehr JPG-Dateien in ihren Anwendungen durch Implementieren von a paar einfache Schritte.
    ...
    code: |
     ...
     {{< merger/code-merger title="So führen Sie JPG-Dateien mit C#-Beispielcode zusammen">}}

        ```csharp    
        // Führen Sie JPG-Dateien mit der GroupDocs.Merger-API zusammen
        // Merger mit Eingabedokument JPG instanziieren
...
demos:
    ...
    content: |
       Führen Sie jetzt mehr als eine JPG-Datei zusammen, indem Sie die Website [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/jpg) besuchen.
