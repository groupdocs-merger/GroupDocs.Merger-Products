...
############################# Head ############################
head_title: "Voeg XLSM bestanden samen in C# | XLSM Fusie"
head_description: "Voeg meerdere XLSM bestanden samen tot één bestand met behulp van de C# .NET document merge API. Voeg specifieke pagina's of paginabereiken van verschillende documenten samen tot één document."

############################# Header ############################
title: "XLSM Fusie in C#"
description: "Voeg XLSM samen met een paar regels .NET code."
...
steps:
    enable: true
    title_left: "Meerdere XLSM bestanden samenvoegen"
    content_left: |
        [GroupDocs.Merger for .NET](/nl/merger/net/) maakt het voor .NET-ontwikkelaars gemakkelijk om twee of meer XLSM-bestanden samen te voegen in hun applicaties door een paar eenvoudige stappen.
    ...
    code: |
     ...
     {{< merger/code-merger title="Hoe XLSM bestanden samen te voegen met behulp van C# voorbeeldcode">}}

        ```csharp    
        // Voeg XLSM bestanden samen met de GroupDocs.Merger API
