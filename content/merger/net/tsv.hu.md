...
############################# Head ############################
head_title: "TSV fájlok egyesítése a C#-ban | TSV Egyesülés"
head_description: "Egyesítsen több TSV fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "TSV Egyesülés a C# programban"
description: "Egyesítse a(z) TSV terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több TSV fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több TSV fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="TSV fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen TSV fájlokat a GroupDocs.Merger API segítségével
