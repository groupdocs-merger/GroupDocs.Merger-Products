...
############################# Head ############################
head_title: "VSTM fájlok egyesítése a C#-ban | VSTM Egyesülés"
head_description: "Egyesítsen több VSTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "VSTM Egyesülés a C# programban"
description: "Egyesítse a(z) VSTM terméket néhány soros .NET kóddal."
...
steps:
    ...
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több VSTM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="VSTM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen VSTM fájlokat a GroupDocs.Merger API segítségével
