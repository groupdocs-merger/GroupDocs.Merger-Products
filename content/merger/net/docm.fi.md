...
############################# Head ############################
head_title: "Yhdistä DOCM tiedostot C# | DOCM Sulautuminen"
...
############################# Header ############################
title: "DOCM Sulautuminen C#"
description: "Yhdistä DOCM muutamalla rivillä .NET-koodia."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger for .NET](/fi/merger/net/) tekee tuotteen .NET kehittäjien helpoksi yhdistää kaksi tai useampia DOCM tiedostoa sovelluksissaan ottamalla käyttöön muutama helppo askel.
    ...
    code: |
     ...
     {{< merger/code-merger title="Kuinka yhdistää DOCM tiedostoja käyttämällä C# esimerkkikoodia">}}

        ```csharp    
        // Yhdistä DOCM tiedostot GroupDocs.Merger API:lla
...
demos:
    ...
    content: |
       Yhdistä useampi kuin yksi DOCM-tiedosto juuri nyt käymällä [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) -sivustolla.
