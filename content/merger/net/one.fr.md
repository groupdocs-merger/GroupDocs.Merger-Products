...
############################# Head ############################
head_title: "Fusionner les fichiers ONE dans C# | ONE Fusion"
head_description: "Fusionnez plusieurs fichiers ONE en un seul fichier à l'aide de l'API de fusion de documents C# .NET. Fusionnez des pages spécifiques ou des plages de pages de divers documents en un seul document."

############################# Header ############################
title: "ONE Fusionner dans C#"
description: "Fusionnez ONE avec quelques lignes de code .NET."
...
steps:
    enable: true
    title_left: "Comment fusionner plusieurs fichiers ONE"
    content_left: |
        [GroupDocs.Merger for .NET](/fr/merger/net/) permet aux développeurs de .NET de fusionner facilement deux ou plusieurs fichiers ONE dans leurs applications en implémentant un quelques étapes faciles.
    ...
    code: |
     ...
     {{< merger/code-merger title="Comment fusionner des fichiers ONE à l'aide de l'exemple de code C#">}}

        ```csharp    
        // Fusionner ONE fichiers à l'aide de l'API GroupDocs.Merger
        // Instancier la fusion avec le document d'entrée ONE
...
demos:
    ...
    content: |
       Fusionnez plusieurs fichiers ONE dès maintenant en visitant le site Web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one).
