...
############################# Head ############################
head_title: "Slå sammen EPUB-filer i C# | EPUB Fusjon"
...
############################# Header ############################
title: "EPUB sammenslåing i C#"
description: "Slå sammen EPUB med noen få linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Slik slår du sammen flere EPUB-filer"
    content_left: |
    ...
    code: |
     ...
     {{< merger/code-merger title="Hvordan slå sammen EPUB filer ved å bruke C# eksempelkode">}}

        ```csharp    
        // Slå sammen EPUB filer ved hjelp av GroupDocs.Merger API
...
demos:
    ...
    content: |
       Slå sammen mer enn én EPUB-fil akkurat nå ved å gå til nettstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/epub).
