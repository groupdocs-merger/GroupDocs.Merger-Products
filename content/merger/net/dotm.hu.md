...
############################# Head ############################
head_title: "DOTM fájlok egyesítése a C#-ban | DOTM Egyesülés"
head_description: "Egyesítsen több DOTM fájlt egyetlen fájlba a C# .NET dokumentumok egyesítő API-jával. Konkrét oldalak vagy oldaltartományok egyesítése a különböző dokumentumoktól egyetlen dokumentummá."

############################# Header ############################
title: "DOTM Egyesülés a C# programban"
description: "Egyesítse a(z) DOTM terméket néhány soros .NET kóddal."
...
steps:
    enable: true
    title_left: "Több DOTM fájl egyesítése"
    content_left: |
        A [GroupDocs.Merger for .NET](/hu/merger/net/) megkönnyíti a .NET fejlesztői számára, hogy két vagy több DOTM fájlt egyesítsenek alkalmazásaikban egy néhány egyszerű lépés.
    ...
    code: |
     ...
     {{< merger/code-merger title="DOTM fájlok egyesítése a C# példakóddal">}}

        ```csharp    
        // Egyesítsen DOTM fájlokat a GroupDocs.Merger API segítségével
