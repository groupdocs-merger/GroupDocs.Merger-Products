...
############################# Head ############################
head_title: "VDX فائلوں کو C# میں ضم کریں۔ VDX انضمام"
head_description: "C# .NET دستاویزات کے انضمام API کا استعمال کرتے ہوئے متعدد VDX فائلوں کو ایک فائل میں ضم کریں۔ مخصوص صفحات یا صفحہ کی حدود کو مختلف دستاویزات سے ایک دستاویز میں ضم کریں۔"

############################# Header ############################
title: "VDX انضمام C# میں"
description: "VDX کو .NET کوڈ کی چند سطروں کے ساتھ ضم کریں۔"
...
steps:
    enable: true
    title_left: "ایک سے زیادہ VDX فائلوں کو کیسے ملایا جائے۔"
    content_left: |
        [GroupDocs.Merger for .NET](/ur/merger/net/) .NET ڈویلپرز کے لیے اپنی ایپلی کیشنز میں دو یا زیادہ VDX فائلوں کو ضم کرنا آسان بناتا ہے۔ چند آسان اقدامات.
    ...
    code: |
     ...
     {{< merger/code-merger title="C# مثال کے کوڈ کا استعمال کرتے ہوئے VDX فائلوں کو کیسے ملایا جائے۔">}}

        ```csharp    
        // GroupDocs.Merger API کا استعمال کرتے ہوئے VDX فائلوں کو ضم کریں۔
