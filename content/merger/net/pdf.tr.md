...
############################# Head ############################
head_title: "PDF Dosyalarını C# İçinde Birleştir | PDF Birleşme"
...
steps:
    ...
    code: |
     ...
     {{< merger/code-merger title="C# örnek kodunu kullanarak PDF dosyaları nasıl birleştirilir">}}
        ...
        ```csharp    
        // GroupDocs.Merger API'sini kullanarak PDF dosyalarını birleştirin
