...
############################# Head ############################
head_title: "Flet OTT filer i C# | OTT Fusion"
head_description: "Flet flere OTT filer til en enkelt fil ved hjælp af C# .NET documents merger API. Flet specifikke sider eller sideintervaller fra forskellige dokumenter til et enkelt dokument."

############################# Header ############################
title: "OTT fusion i C#"
description: "Flet OTT med et par linjer med .NET-kode."
...
steps:
    enable: true
    title_left: "Sådan flettes flere OTT-filer"
    content_left: |
        [GroupDocs.Merger for .NET](/da/merger/net/) gør det nemt for .NET-udviklere at flette to eller flere OTT-filer i deres applikationer ved at implementere en få nemme trin.
    ...
    code: |
     ...
     {{< merger/code-merger title="Sådan flettes OTT filer ved hjælp af C# eksempelkode">}}

        ```csharp    
        // Flet OTT filer ved hjælp af GroupDocs.Merger API
...
demos:
    ...
    content: |
       Flet mere end én OTT-fil lige nu ved at besøge webstedet [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott).
