...
############################# Head ############################
head_title: "Gabungkan file PNG melalui .NET"
head_description: "Integrasikan penggabungan dokumen PNG ke dalam proyek .NET Anda dengan GroupDocs.Merger for .NET."

############################# Header ############################
title: "Gabungkan file PNG" 
description: "Gunakan GroupDocs.Merger for .NET untuk membuat aplikasi .NET yang kuat yang mampu menggabungkan dan mengelola dokumen PNG tanpa kendala."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/net/) memudahkan penggabungan dokumen PNG. Tambahkan fungsionalitas penggabungan ke aplikasi .NET Anda dan gabungkan beberapa file dengan mulus.
      
      1. Tentukan jalur ke file PNG yang pertama.
