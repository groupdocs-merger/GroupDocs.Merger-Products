...
############################# Head ############################
head_title: "Hợp nhất các tệp PNG trong C# | Hợp nhất PNG"
head_description: "Hợp nhất nhiều tệp PNG thành một tệp duy nhất bằng cách sử dụng API hợp nhất tài liệu C# .NET. Hợp nhất các trang hoặc phạm vi trang cụ thể từ các tài liệu khác nhau thành một tài liệu duy nhất."

############################# Header ############################
title: "PNG Hợp nhất trong C#"
description: "Hợp nhất PNG với một vài dòng mã .NET."
...
about:
    ...
    content: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) cung cấp một giải pháp thuận tiện để hợp nhất nhiều tệp PDF, Microsoft Office (Word, Excel, PowerPoint, OneNote), OpenDocument, HTML, hình ảnh và nhiều tài liệu khác thành một tệp duy nhất trong các ứng dụng .NET. GroupDocs.Merger sẽ giúp bạn tiết kiệm rất nhiều công sức, vì bạn được phép hợp nhất các tài liệu PNG - không cần cài đặt bất kỳ phần mềm, ứng dụng máy tính để bàn hoặc plugin nào của bên thứ ba. Bây giờ không cần thiết phải lãng phí thời gian của bạn và hợp nhất các tệp theo cách thủ công! Sứ mệnh của GroupDocs là cung cấp chất lượng tốt nhất và đơn giản hóa quy trình xử lý tài liệu.
...
steps:
    enable: true
    title_left: "Cách hợp nhất nhiều tệp PNG"
    content_left: |
        [GroupDocs.Merger for .NET](/vi/merge/net/) giúp các nhà phát triển .NET dễ dàng hợp nhất hai hoặc nhiều PNG tệp trong ứng dụng của họ bằng cách triển khai vài bước đơn giản.
    ...
    code: |
     ...
     {{< merger/code-merger title="Cách hợp nhất các tệp PNG bằng mã mẫu C#">}}

        ```csharp    
        // Hợp nhất các tệp PNG bằng API GroupDocs.Merger
        // Khởi tạo hợp nhất với tài liệu đầu vào PNG
...
demos:
    ...
    content: |
       Hợp nhất nhiều hơn một PNG tệp ngay bây giờ bằng cách truy cập trang web [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/png) trang web.
