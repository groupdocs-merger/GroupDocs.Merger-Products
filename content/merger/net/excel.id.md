...
############################# Head ############################
head_title: "Gabungkan EXCEL File di C# | EXCEL Penggabungan"
head_description: "Gabungkan beberapa file EXCEL menjadi satu file menggunakan C# .NET API penggabungan dokumen. Gabungkan halaman atau rentang halaman tertentu dari berbagai dokumen ke satu dokumen."

############################# Header ############################
title: "EXCEL Penggabungan Dalam C#"
description: "Gabungkan EXCEL dengan beberapa baris kode .NET."
...
demos:
    ...
    content: |
       Gabungkan lebih dari satu EXCEL file sekarang juga dengan mengunjungi situs [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/excel).
