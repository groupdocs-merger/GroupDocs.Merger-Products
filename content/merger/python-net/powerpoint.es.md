...
############################# Head ############################
head_title: "Combina archivos POWERPOINT a través de Python via .NET"
head_description: "Integra la fusión de documentos POWERPOINT sin problemas en tus proyectos de Python con GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Combina archivos POWERPOINT" 
description: "Optimiza el procesamiento de documentos en tus aplicaciones Python con GroupDocs.Merger for Python via .NET, permitiendo una fusión rápida y eficiente de archivos POWERPOINT."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita la fusión de documentos POWERPOINT. Añade capacidades de fusión a tus aplicaciones Python via .NET para combinar eficientemente múltiples archivos.
      
      1. Proporciona la ruta al primer archivo POWERPOINT.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa Merger con el documento POWERPOINT de origen
