...
############################# Head ############################
head_title: "通过 Python via .NET 合并 POWERPOINT 文件"
head_description: "使用 GroupDocs.Merger for Python via .NET 无缝集成 POWERPOINT 文档合并到您的 Python 项目中。"

############################# Header ############################
title: "合并 POWERPOINT 文件" 
description: "通过 GroupDocs.Merger for Python via .NET 简化您 Python 应用程序中的文档处理，快速高效地执行 POWERPOINT 文件合并。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) 让合并 POWERPOINT 文档变得简单。将合并功能添加到您的 Python via .NET 应用程序中，以高效地组合多个文件。
      
      1. 提供第一个 POWERPOINT 文件的路径。
      2. 选择要合并的附加文件。
      3. 如果需要，应用可选设置。
      4. 执行合并过程并保存输出文档。
