...
############################# Head ############################
head_title: "XLSX-Dateien über Python via .NET zusammenführen"
head_description: "Integrieren Sie die Zusammenführung von XLSX-Dokumenten nahtlos in Ihre Python-Projekte mit GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "XLSX-Dateien zusammenführen" 
description: "Optimieren Sie die Dokumentenverarbeitung in Ihren Python-Anwendungen mit GroupDocs.Merger for Python via .NET, um schnelles und effizientes Zusammenführen von XLSX-Dateien zu ermöglichen."
...
steps:
    enable: true
    title: "Wie man XLSX-Dokumente zusammenführt"
    content: |
      [GroupDocs.Merger](/merger/python-net/) macht es einfach, XLSX-Dokumente zusammenzuführen. Fügen Sie Ihren Python via .NET-Anwendungen die Zusammenführungsfunktionen hinzu, um mehrere Dateien effizient zu kombinieren.
      
      1. Geben Sie den Pfad zur ersten XLSX-Datei an.
    ...
    code:
      ...
      content: |
        ...
        # Merger mit dem Quell-XLSX-Dokument initialisieren
