...
############################# Head ############################
head_title: "Pisahkan dokumen POWERPOINT dalam aplikasi Python via .NET"
head_description: "Gunakan GroupDocs.Merger for Python via .NET untuk memisahkan file POWERPOINT menjadi beberapa dokumen. Kelola PDF, file Word, spreadsheet, presentasi, diagram Visio, gambar, arsip, dan banyak lagi dengan efektif."

############################# Header ############################
title: "Pisahkan file POWERPOINT menjadi bagian" 
description: "GroupDocs.Merger for Python via .NET meningkatkan aplikasi Python dengan pemrosesan dokumen yang canggih. Pisahkan file POWERPOINT dengan efektif dan bekerja dengan berbagai format yang umum digunakan."
...
steps:
    enable: true
    title: "Cara memecah dokumen POWERPOINT menjadi bagian"
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan pemisahan file POWERPOINT, mengekstrak halaman yang dipilih dan menyimpannya sebagai dokumen baru. Integrasikan pemrosesan dokumen yang efisien ke dalam aplikasi Python via .NET Anda.
      
      1. Tentukan jalur file POWERPOINT asli.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ekstrak halaman genap dari file POWERPOINT"
      content: |
        Contoh ini menunjukkan cara memisahkan file POWERPOINT dan menyimpan semua halaman bernomor genap ke dalam dokumen baru.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
