...
############################# Head ############################
head_title: "Dividi i documenti VISIO nelle app Python via .NET"
head_description: "Utilizza GroupDocs.Merger for Python via .NET per separare i file VISIO in più documenti. Gestisci con precisione PDF, file Word, fogli di calcolo, presentazioni, diagrammi Visio, immagini, archivi e altro."

############################# Header ############################
title: "Dividi i file VISIO in parti" 
description: "GroupDocs.Merger for Python via .NET potenzia le applicazioni Python con un avanzato elaborazione dei documenti. Suddividi i file VISIO senza difficoltà e lavora con una varietà di formati comunemente utilizzati."
...
steps:
    enable: true
    title: "Come suddividere i documenti VISIO in parti"
    content: |
      [GroupDocs.Merger](/merger/python-net/) semplifica la suddivisione dei file VISIO, estraendo pagine selezionate e salvandole come un nuovo documento. Integra processi di elaborazione documentale efficienti nelle tue applicazioni Python via .NET.
      
      1. Specifica il percorso del file VISIO originale.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Estrai solo le pagine pari da un file VISIO"
      content: |
        Questo esempio dimostra come suddividere un file VISIO e salvare tutte le pagine numerate pari in un nuovo documento.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
