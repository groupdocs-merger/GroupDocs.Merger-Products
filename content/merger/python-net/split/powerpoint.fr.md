...
############################# Head ############################
head_title: "Divisez des documents POWERPOINT dans des applications Python via .NET"
head_description: "Utilisez GroupDocs.Merger for Python via .NET pour séparer des fichiers POWERPOINT en plusieurs documents. Gérez facilement des PDF, des fichiers Word, des tableurs, des présentations, des diagrammes Visio, des images, des archives, et plus encore."

############################# Header ############################
title: "Divisez des fichiers POWERPOINT en parties" 
description: "GroupDocs.Merger for Python via .NET améliore les applications Python avec un traitement documentaire avancé. Divisez des fichiers POWERPOINT sans effort et travaillez avec une variété de formats couramment utilisés."
...
steps:
    enable: true
    title: "Comment diviser des documents POWERPOINT en parties"
    content: |
      [GroupDocs.Merger](/merger/python-net/) simplifie la division des fichiers POWERPOINT, en extrayant les pages sélectionnées et en les sauvegardant en tant que nouveau document. Intégrez un traitement documentaire efficace dans vos applications Python via .NET.
      
      1. Spécifiez le chemin du fichier POWERPOINT d'origine.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire les pages paires d'un fichier POWERPOINT"
      content: |
        Cet exemple démontre comment diviser un fichier POWERPOINT et sauvegarder toutes les pages paires dans un nouveau document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
