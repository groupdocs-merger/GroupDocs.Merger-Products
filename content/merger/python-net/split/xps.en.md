...
############################# Head ############################
head_title: "Split XPS documents in Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to separate XPS files into multiple documents. Easily manage PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Split XPS files into parts" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Split XPS files effortlessly and work with a variety of commonly used formats."
...
steps:
    enable: true
    title: "How to break XPS documents into parts"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to split XPS files, extracting selected pages and saving them as a new document. Integrate efficient document processing into your Python via .NET applications.
      
      1. Specify the original XPS file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract even pages from a XPS file"
      content: |
        This example demonstrates how to split a XPS file and save all even-numbered pages into a new document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
