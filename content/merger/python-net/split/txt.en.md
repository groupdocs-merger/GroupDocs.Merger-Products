...
############################# Head ############################
head_title: "Split TXT documents in Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to separate TXT files into multiple documents. Easily manage PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Split TXT files into parts" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Split TXT files effortlessly and work with a variety of commonly used formats."
...
steps:
    enable: true
    title: "How to break TXT documents into parts"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to split TXT files, extracting selected pages and saving them as a new document. Integrate efficient document processing into your Python via .NET applications.
      
      1. Specify the original TXT file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract even pages from a TXT file"
      content: |
        This example demonstrates how to split a TXT file and save all even-numbered pages into a new document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Extract pages"
          operation: "extract"
          link: "/merger/python-net/extract/txt/"
          description: "Save selected pages as a separate document"

        # operation loop 3
        - name: "Move pages"
          operation: "move"
          link: "/merger/python-net/move/txt/"
          description: "Reposition any page within a document"

        # operation loop 4
        - name: "Remove pages"
          operation: "remove"
          link: "/merger/python-net/remove/txt/"
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/python-net/rotate/txt/"
        ...
        - name: "Swap pages"
          operation: "swap"
          link: "/merger/python-net/swap/txt/"
          description: "Swap document pages"

        # operation loop 9
        - name: "Change orientation"
          operation: "orientation"
          link: "/merger/python-net/orientation/txt/"
