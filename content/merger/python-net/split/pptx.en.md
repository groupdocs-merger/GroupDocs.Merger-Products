...
############################# Head ############################
head_title: "Break apart PPTX documents in Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to separate PPTX files into multiple documents. Easily manage PDFs, Word files, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Break PPTX files into parts" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Split PPTX files effortlessly and work with a variety of commonly used formats."
...
steps:
    enable: true
    title: "How to break PPTX documents into parts"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to split PPTX files, extracting selected pages and saving them as a new document. Integrate efficient document processing into your Python via .NET applications.
      
      1. Specify the original PPTX file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract even pages from a PPTX file"
      content: |
        This example demonstrates how to split a PPTX file and save all even-numbered pages into a new document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
