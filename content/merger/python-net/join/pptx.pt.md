...
############################# Head ############################
head_title: "Junte arquivos PPTX em Python via .NET"
head_description: "Integre perfeitamente a junção de arquivos PPTX em seus projetos Python usando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Junte arquivos PPTX" 
description: "GroupDocs.Merger for Python via .NET permite que você junte documentos PPTX de forma eficiente dentro de suas aplicações Python, proporcionando integração contínua e alta performance."
...
steps:
    enable: true
    title: "Como juntar documentos PPTX"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), juntar documentos PPTX é simples. Aprimore suas aplicações Python via .NET com capacidades eficientes de combinação de documentos.
      
      1. Forneça o caminho do arquivo para o primeiro documento PPTX.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize o Merger com o documento PPTX de origem
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de diferentes formatos de documentos"
      content: |
        Este exemplo demonstra como juntar arquivos PPTX enquanto seleciona páginas específicas de documentos em outros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
