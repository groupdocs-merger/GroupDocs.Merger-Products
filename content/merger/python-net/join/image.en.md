...
############################# Head ############################
head_title: "Join IMAGE files in Python via .NET"
head_description: "Seamlessly integrate IMAGE file joining into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Join IMAGE files" 
description: "GroupDocs.Merger for Python via .NET enables you to join IMAGE documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), joining IMAGE documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
      
      1. Provide the file path for the first IMAGE document.
    ...
    code:
      ...
      content: |
        ...
        # Initialize the Merger with the source IMAGE document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different document formats"
      content: |
        This example demonstrates how to join IMAGE files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
