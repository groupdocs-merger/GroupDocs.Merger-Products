...
############################# Head ############################
head_title: "Join XPS files in Python via .NET"
head_description: "Seamlessly integrate XPS file joining into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Join XPS files" 
description: "GroupDocs.Merger for Python via .NET enables you to join XPS documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    enable: true
    title: "How to join XPS documents"
    content: |
      With [GroupDocs.Merger](/merger/python-net/), joining XPS documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
      
      1. Provide the file path for the first XPS document.
    ...
    code:
      ...
      content: |
        ...
        # Initialize the Merger with the source XPS document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different document formats"
      content: |
        This example demonstrates how to join XPS files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
