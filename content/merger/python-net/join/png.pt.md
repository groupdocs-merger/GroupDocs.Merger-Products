...
############################# Head ############################
head_title: "Junte arquivos PNG em Python via .NET"
head_description: "Integre perfeitamente a junção de arquivos PNG em seus projetos Python usando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Junte arquivos PNG" 
description: "GroupDocs.Merger for Python via .NET permite que você junte documentos PNG de forma eficiente dentro de suas aplicações Python, proporcionando integração contínua e alta performance."
...
steps:
    enable: true
    title: "Como juntar documentos PNG"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), juntar documentos PNG é simples. Aprimore suas aplicações Python via .NET com capacidades eficientes de combinação de documentos.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize o Merger com o documento PNG de origem
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de diferentes formatos de documentos"
      content: |
        Este exemplo demonstra como juntar arquivos PNG enquanto seleciona páginas específicas de documentos em outros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
