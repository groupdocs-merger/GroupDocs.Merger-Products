...
############################# Head ############################
head_title: "Объедините файлы PPTX в Python via .NET"
head_description: "Бесшовно интегрируйте объединение файлов PPTX в ваши проекты на Python с помощью GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Объедините файлы PPTX" 
description: "GroupDocs.Merger for Python via .NET позволяет вам объединять документы PPTX в ваших приложениях Python, обеспечивая бесшовную интеграцию и высокую производительность."
...
steps:
    enable: true
    title: "Как объединять документы PPTX"
    content: |
      С помощью [GroupDocs.Merger](/merger/python-net/) объединение документов PPTX является простым. Улучшите ваши приложения Python via .NET с помощью эффективных возможностей комбинирования документов.
      
      1. Укажите путь к первому документу PPTX.
    ...
    code:
      ...
      content: |
        ...
        # Инициализируйте Merger с исходным документом PPTX
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Объединение выбранных страниц из различных форматов документов"
      content: |
        Этот пример демонстрирует, как объединять файлы PPTX, выбирая определенные страницы из документов других форматов.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
