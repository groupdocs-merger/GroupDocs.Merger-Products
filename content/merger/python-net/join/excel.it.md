...
############################# Head ############################
head_title: "Unisci file EXCEL in Python via .NET"
head_description: "Integra senza soluzione di continuità l'unione di file EXCEL nei tuoi progetti Python utilizzando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unisci file EXCEL" 
description: "GroupDocs.Merger for Python via .NET ti consente di unire documenti EXCEL all'interno delle tue applicazioni Python, offrendo un'integrazione perfetta e prestazioni elevate."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), unire documenti EXCEL è semplice. Migliora le tue applicazioni Python via .NET con capacità efficienti di combinazione dei documenti.
      
      1. Fornisci il percorso del primo documento EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da diversi formati di documento"
      content: |
        Questo esempio dimostra come unire file EXCEL selezionando pagine specifiche da documenti in altri formati.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
