...
############################# Head ############################
head_title: "Join ZIP files in Python via .NET"
head_description: "Seamlessly integrate ZIP file joining into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Join ZIP files" 
description: "GroupDocs.Merger for Python via .NET enables you to join ZIP documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), joining ZIP documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different document formats"
      content: |
        This example demonstrates how to join ZIP files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
