...
############################# Head ############################
head_title: "Junte arquivos MHTML em Python via .NET"
head_description: "Integre perfeitamente a junção de arquivos MHTML em seus projetos Python usando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Junte arquivos MHTML" 
description: "GroupDocs.Merger for Python via .NET permite que você junte documentos MHTML de forma eficiente dentro de suas aplicações Python, proporcionando integração contínua e alta performance."
...
steps:
    enable: true
    title: "Como juntar documentos MHTML"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), juntar documentos MHTML é simples. Aprimore suas aplicações Python via .NET com capacidades eficientes de combinação de documentos.
      
      1. Forneça o caminho do arquivo para o primeiro documento MHTML.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize o Merger com o documento MHTML de origem
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Junte páginas selecionadas de diferentes formatos de documentos"
      content: |
        Este exemplo demonstra como juntar arquivos MHTML enquanto seleciona páginas específicas de documentos em outros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
