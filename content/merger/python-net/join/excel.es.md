...
############################# Head ############################
head_title: "Unir archivos EXCEL en Python via .NET"
head_description: "Integra sin problemas la unión de archivos EXCEL en tus proyectos Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unir archivos EXCEL" 
description: "GroupDocs.Merger for Python via .NET te permite unir documentos EXCEL en tus aplicaciones Python, proporcionando integración fluida y alto rendimiento."
...
steps:
    enable: true
    title: "Cómo unir documentos EXCEL"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), unir documentos EXCEL es sencillo. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa Merger con el documento fuente EXCEL
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo unir archivos EXCEL seleccionando páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
