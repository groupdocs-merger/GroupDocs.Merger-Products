...
############################# Head ############################
head_title: "Unir archivos MHTML en Python via .NET"
head_description: "Integra sin problemas la unión de archivos MHTML en tus proyectos Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unir archivos MHTML" 
description: "GroupDocs.Merger for Python via .NET te permite unir documentos MHTML en tus aplicaciones Python, proporcionando integración fluida y alto rendimiento."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), unir documentos MHTML es sencillo. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
      
      1. Proporciona la ruta del primer documento MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo unir archivos MHTML seleccionando páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
