...
############################# Head ############################
head_title: "Gabungkan file ZIP di Python via .NET"
head_description: "Integrasikan proses penggabungan file ZIP ke dalam proyek Python Anda menggunakan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file ZIP" 
description: "GroupDocs.Merger for Python via .NET memungkinkan Anda untuk menggabungkan dokumen ZIP dengan efisien dalam aplikasi Python Anda, menyediakan integrasi yang mulus dan kinerja tinggi."
...
steps:
    enable: true
    title: "Cara menggabungkan dokumen ZIP"
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), menggabungkan dokumen ZIP sangatlah sederhana. Tingkatkan aplikasi Python via .NET Anda dengan kemampuan kombinasi dokumen yang efisien.
      
      1. Berikan jalur file untuk dokumen ZIP pertama.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen sumber ZIP
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman yang dipilih dari format dokumen yang berbeda"
      content: |
        Contoh ini menunjukkan cara menggabungkan file ZIP sambil memilih halaman tertentu dari dokumen dalam format lain.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
