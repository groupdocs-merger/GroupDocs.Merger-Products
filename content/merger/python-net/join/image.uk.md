...
head_description: "Безперешкодно інтегруйте об'єднання файлів IMAGE у свої проекти Python з допомогою GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Об'єднайте файли IMAGE" 
description: "GroupDocs.Merger for Python via .NET дозволяє вам об'єднувати документи IMAGE у ваших програмах Python, забезпечуючи безшовну інтеграцію та високу продуктивність."
...
steps:
    ...
    content: |
      З [GroupDocs.Merger](/merger/python-net/), об'єднання документів IMAGE – це просто. Покращте ваші програми Python via .NET ефективними можливостями комбінації документів.
      
      1. Вкажіть шлях до першого документа IMAGE.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання вибраних сторінок з різних форматів документів"
      content: |
        Цей приклад демонструє, як об'єднати файли IMAGE, вибравши конкретні сторінки з документів в інших форматах.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
