...
############################# Head ############################
head_title: "Unir archivos DOCX en Python via .NET"
head_description: "Integra sin problemas la unión de archivos DOCX en tus proyectos Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unir archivos DOCX" 
description: "GroupDocs.Merger for Python via .NET te permite unir documentos DOCX en tus aplicaciones Python, proporcionando integración fluida y alto rendimiento."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), unir documentos DOCX es sencillo. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa Merger con el documento fuente DOCX
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo unir archivos DOCX seleccionando páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
