...
############################# Head ############################
head_title: "Gabungkan file JPG di Python via .NET"
head_description: "Integrasikan proses penggabungan file JPG ke dalam proyek Python Anda menggunakan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file JPG" 
description: "GroupDocs.Merger for Python via .NET memungkinkan Anda untuk menggabungkan dokumen JPG dengan efisien dalam aplikasi Python Anda, menyediakan integrasi yang mulus dan kinerja tinggi."
...
steps:
    enable: true
    title: "Cara menggabungkan dokumen JPG"
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), menggabungkan dokumen JPG sangatlah sederhana. Tingkatkan aplikasi Python via .NET Anda dengan kemampuan kombinasi dokumen yang efisien.
      
      1. Berikan jalur file untuk dokumen JPG pertama.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen sumber JPG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman yang dipilih dari format dokumen yang berbeda"
      content: |
        Contoh ini menunjukkan cara menggabungkan file JPG sambil memilih halaman tertentu dari dokumen dalam format lain.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
