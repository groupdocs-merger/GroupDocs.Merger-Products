...
############################# Head ############################
head_title: "Join POWERPOINT files in Python via .NET"
head_description: "Seamlessly integrate POWERPOINT file joining into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Join POWERPOINT files" 
description: "GroupDocs.Merger for Python via .NET enables you to join POWERPOINT documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    enable: true
    title: "How to join POWERPOINT documents"
    content: |
      With [GroupDocs.Merger](/merger/python-net/), joining POWERPOINT documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
      
      1. Provide the file path for the first POWERPOINT document.
    ...
    code:
      ...
      content: |
        ...
        # Initialize the Merger with the source POWERPOINT document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different document formats"
      content: |
        This example demonstrates how to join POWERPOINT files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
