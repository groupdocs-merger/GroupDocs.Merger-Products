...
############################# Head ############################
head_title: "Joindre des fichiers JPEG dans Python via .NET"
head_description: "Intégrez sans effort le regroupement de fichiers JPEG dans vos projets Python en utilisant GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Joindre des fichiers JPEG" 
description: "GroupDocs.Merger for Python via .NET vous permet de regrouper des documents JPEG de manière fluide dans vos applications Python, offrant une intégration transparente et des performances élevées."
...
steps:
    enable: true
    title: "Comment joindre des documents JPEG"
    content: |
      Avec [GroupDocs.Merger](/merger/python-net/), le regroupement de documents JPEG est simple. Améliorez vos applications Python via .NET avec des capacités de combinaison de documents efficaces.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Joindre des pages sélectionnées de différents formats de documents"
      content: |
        Cet exemple démontre comment joindre des fichiers JPEG tout en sélectionnant des pages spécifiques dans d'autres formats de documents.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
