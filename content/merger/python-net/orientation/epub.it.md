...
############################# Head ############################
head_title: "Regola le pagine EPUB nelle app Python via .NET"
head_description: "GroupDocs.Merger for Python via .NET ti consente di spostare le pagine EPUB in modalità ritratto o paesaggio. Elabora PDF, documenti Word, fogli Excel, diapositive PowerPoint, design Visio, immagini, archivi e altro ancora con controllo."

############################# Header ############################
title: "Allineamento delle pagine per EPUB" 
description: "GroupDocs.Merger for Python via .NET arricchisce le app Python con funzionalità utili. Gli sviluppatori possono creare soluzioni migliori gestendo i formati di file e modificando i layout delle pagine EPUB."
...
steps:
    enable: true
    title: "Come regolare le pagine EPUB"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), sposta le pagine EPUB. Questa funzionalità, insieme ad altre, aggiunge strumenti documentali affidabili alle app Python via .NET.
      
      1. Carica il file EPUB.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta l'ultima pagina EPUB"
      content: |
        Scopri come controllare il numero di pagine in un file EPUB e regolare la sua pagina finale.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
