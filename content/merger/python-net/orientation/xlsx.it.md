...
############################# Head ############################
head_title: "Regola le pagine XLSX nelle app Python via .NET"
head_description: "GroupDocs.Merger for Python via .NET ti consente di spostare le pagine XLSX in modalità ritratto o paesaggio. Elabora PDF, documenti Word, fogli Excel, diapositive PowerPoint, design Visio, immagini, archivi e altro ancora con controllo."

############################# Header ############################
title: "Allineamento delle pagine per XLSX" 
description: "GroupDocs.Merger for Python via .NET arricchisce le app Python con funzionalità utili. Gli sviluppatori possono creare soluzioni migliori gestendo i formati di file e modificando i layout delle pagine XLSX."
...
steps:
    enable: true
    title: "Come regolare le pagine XLSX"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), sposta le pagine XLSX. Questa funzionalità, insieme ad altre, aggiunge strumenti documentali affidabili alle app Python via .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Sposta l'ultima pagina XLSX"
      content: |
        Scopri come controllare il numero di pagine in un file XLSX e regolare la sua pagina finale.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
