...
############################# Head ############################
head_title: "Ajuste de páginas PPTX em aplicativos Python via .NET"
head_description: "GroupDocs.Merger for Python via .NET permite que você mude páginas PPTX para retrato ou paisagem. Processar PDFs, documentos do Word, planilhas do Excel, slides do PowerPoint, designs do Visio, imagens, arquivos compactados e mais com controle."

############################# Header ############################
title: "Alinhamento de páginas para PPTX" 
description: "GroupDocs.Merger for Python via .NET melhora aplicativos Python com recursos úteis. Os desenvolvedores podem construir soluções melhores gerenciando formatos de arquivo e ajustando layouts de páginas PPTX."
...
steps:
    enable: true
    title: "Como ajustar páginas PPTX"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), ajuste páginas PPTX. Este recurso, juntamente com outros, adiciona ferramentas confiáveis de documentos aos aplicativos Python via .NET.
      
      1. Carregue o arquivo PPTX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ajuste a última página PPTX"
      content: |
        Aprenda a verificar a contagem de páginas em um arquivo PPTX e ajustar sua última página.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
