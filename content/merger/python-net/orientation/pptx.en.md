...
############################# Head ############################
head_title: "Adjust PPTX pages in Python via .NET apps"
head_description: "GroupDocs.Merger for Python via .NET helps you shift PPTX pages to portrait or landscape. Process PDFs, Word files, Excel sheets, PowerPoint slides, Visio designs, images, archives, and more with control."

############################# Header ############################
title: "Page alignment for PPTX" 
description: "GroupDocs.Merger for Python via .NET enhances Python apps with useful features. Developers can build better solutions by managing file formats and tweaking PPTX page layouts."
...
steps:
    enable: true
    title: "How to adjust PPTX pages"
    content: |
      With [GroupDocs.Merger](/merger/python-net/), shift PPTX pages. This feature, plus others, adds reliable document tools to Python via .NET apps.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Shift the last PPTX page"
      content: |
        Learn to check the page count in a PPTX file and adjust its final page.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
