...
############################# Head ############################
head_title: "Ajuste de páginas XLSX em aplicativos Python via .NET"
head_description: "GroupDocs.Merger for Python via .NET permite que você mude páginas XLSX para retrato ou paisagem. Processar PDFs, documentos do Word, planilhas do Excel, slides do PowerPoint, designs do Visio, imagens, arquivos compactados e mais com controle."

############################# Header ############################
title: "Alinhamento de páginas para XLSX" 
description: "GroupDocs.Merger for Python via .NET melhora aplicativos Python com recursos úteis. Os desenvolvedores podem construir soluções melhores gerenciando formatos de arquivo e ajustando layouts de páginas XLSX."
...
steps:
    enable: true
    title: "Como ajustar páginas XLSX"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), ajuste páginas XLSX. Este recurso, juntamente com outros, adiciona ferramentas confiáveis de documentos aos aplicativos Python via .NET.
      
      1. Carregue o arquivo XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ajuste a última página XLSX"
      content: |
        Aprenda a verificar a contagem de páginas em um arquivo XLSX e ajustar sua última página.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
