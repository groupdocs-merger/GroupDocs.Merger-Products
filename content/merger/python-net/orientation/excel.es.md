...
############################# Head ############################
head_title: "Ajustar páginas EXCEL en aplicaciones Python via .NET"
head_description: "GroupDocs.Merger for Python via .NET te permite cambiar las páginas EXCEL a retrato o paisaje. Procesa PDFs, documentos de Word, hojas de Excel, diapositivas de PowerPoint, diseños de Visio, imágenes, archivos y más con control."

############################# Header ############################
title: "Alineación de páginas para EXCEL" 
description: "GroupDocs.Merger for Python via .NET mejora las aplicaciones Python con funcionalidades útiles. Los desarrolladores pueden crear mejores soluciones gestionando formatos de archivo y ajustando los diseños de páginas EXCEL."
...
steps:
    enable: true
    title: "Cómo ajustar páginas EXCEL"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), ajusta las páginas EXCEL. Esta funcionalidad, junto con otras, agrega herramientas documentales confiables a las aplicaciones Python via .NET.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ajusta la última página EXCEL"
      content: |
        Aprende a verificar el número de páginas en un archivo EXCEL y ajustar su última página.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
