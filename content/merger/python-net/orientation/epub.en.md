...
############################# Head ############################
head_title: "Adjust EPUB pages in Python via .NET apps"
head_description: "GroupDocs.Merger for Python via .NET helps you shift EPUB pages to portrait or landscape. Process PDFs, Word files, Excel sheets, PowerPoint slides, Visio designs, images, archives, and more with control."

############################# Header ############################
title: "Page alignment for EPUB" 
description: "GroupDocs.Merger for Python via .NET enhances Python apps with useful features. Developers can build better solutions by managing file formats and tweaking EPUB page layouts."
...
steps:
    enable: true
    title: "How to adjust EPUB pages"
    content: |
      With [GroupDocs.Merger](/merger/python-net/), shift EPUB pages. This feature, plus others, adds reliable document tools to Python via .NET apps.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Shift the last EPUB page"
      content: |
