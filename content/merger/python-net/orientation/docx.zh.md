...
############################# Head ############################
head_title: "调整 DOCX 页面在 Python via .NET 应用中"
head_description: "GroupDocs.Merger for Python via .NET 帮助您将 DOCX 页面转换为纵向或横向格式。处理 PDF、Word 文件、Excel 表格、PowerPoint 幻灯片、Visio 设计、图像、压缩文件等，同时保持控制。"

############################# Header ############################
title: "DOCX 页面对齐" 
description: "GroupDocs.Merger for Python via .NET 为 Python 应用增强了实用功能。开发者可以通过管理文件格式和调整 DOCX 页面布局来构建更优质的解决方案。"
...
steps:
    ...
    title: "如何调整 DOCX 页面"
    content: |
      使用 [GroupDocs.Merger](/merger/python-net/)，调整 DOCX 页。这一功能以及其他功能为 Python via .NET 应用提供可靠的文档工具。
