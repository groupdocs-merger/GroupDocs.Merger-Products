...
############################# Head ############################
head_title: "Rotate XLSX pages in Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to rotate pages in XLSX documents. Easily modify PDFs, Word files, Excel spreadsheets, PowerPoint slides, images, and archives."

############################# Header ############################
title: "Rotate pages in XLSX files" 
description: "Enhance your Python applications with GroupDocs.Merger for Python via .NET, a powerful document processing solution. Rotate pages in XLSX and manage various file formats effortlessly."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), you can rotate pages in XLSX documents, bringing powerful document management to Python via .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rotate all even-numbered XLSX pages"
      content: |
        This example demonstrates how to rotate every even-numbered page in a XLSX document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
