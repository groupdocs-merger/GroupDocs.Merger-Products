...
############################# Head ############################
head_title: "Troque páginas em documentos VISIO usando aplicativos Python via .NET"
head_description: "Utilize GroupDocs.Merger for Python via .NET para trocar páginas em arquivos VISIO. Gerencie arquivos PDF, documentos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Trocar páginas VISIO" 
description: "GroupDocs.Merger for Python via .NET aprimora aplicações Python com um processamento avançado de documentos. Troque páginas em arquivos VISIO para organizar e controlar melhor seu conteúdo."
...
steps:
    enable: true
    title: "Como trocar páginas VISIO"
    content: |
      [GroupDocs.Merger](/merger/python-net/) permite trocar páginas VISIO, oferecendo total controle sobre o conteúdo do documento. Utilize-o em suas aplicações Python via .NET para um processamento de documentos fluido.
      
      1. Especifique o caminho para o arquivo VISIO.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Troque as primeiras e últimas páginas de um arquivo VISIO"
      content: |
        Este exemplo mostra como trocar páginas em um arquivo VISIO em apenas alguns passos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
