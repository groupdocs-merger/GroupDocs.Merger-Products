...
############################# Head ############################
head_title: "Scambia pagine in documenti POWERPOINT utilizzando app Python via .NET"
head_description: "Utilizza GroupDocs.Merger for Python via .NET per scambiare pagine nei file POWERPOINT. Gestisci PDF, documenti Word, fogli di calcolo, presentazioni, diagrammi Visio, immagini, archivi e altro ancora."

############################# Header ############################
title: "Scambia pagine POWERPOINT" 
description: "GroupDocs.Merger for Python via .NET arricchisce le applicazioni Python con avanzate funzionalità di elaborazione documentale. Scambia pagine nei file POWERPOINT per organizzare e controllare meglio i tuoi contenuti."
...
steps:
    enable: true
    title: "Come scambiare pagine POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/python-net/) semplifica il processo di scambio di pagine POWERPOINT, consentendoti il pieno controllo sui contenuti documentali. Usalo nelle tue applicazioni Python via .NET per un'elaborazione fluida dei documenti.
      
      1. Specifica il percorso del file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Scambia la prima e l'ultima pagina di un file POWERPOINT"
      content: |
        Questo esempio mostra come scambiare le pagine in un file POWERPOINT in pochi passaggi.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
