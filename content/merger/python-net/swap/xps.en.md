...
############################# Head ############################
head_title: "Swap pages in XPS documents using Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to swap pages in XPS files. Easily manage PDFs, Word documents, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap XPS pages" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Swap pages in XPS files to better organize and control your content."
...
steps:
    enable: true
    title: "How to swap XPS pages"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to swap XPS pages, giving you full control over document content. Use it in your Python via .NET applications for seamless document processing.
      
      1. Specify the path to the XPS file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages of a XPS file"
      content: |
