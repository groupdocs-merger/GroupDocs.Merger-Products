...
############################# Head ############################
head_title: "Tukar halaman di dokumen VISIO menggunakan aplikasi Python via .NET"
head_description: "Gunakan GroupDocs.Merger for Python via .NET untuk menukar halaman di file VISIO. Kelola PDF, dokumen Word, spreadsheet, presentasi, diagram Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Tukar halaman VISIO" 
description: "GroupDocs.Merger for Python via .NET meningkatkan aplikasi Python dengan pemrosesan dokumen yang canggih. Tukar halaman di file VISIO untuk mengorganisasi dan mengontrol konten Anda dengan lebih baik."
...
steps:
    enable: true
    title: "Cara menukar halaman VISIO"
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan untuk menukar halaman VISIO, memberi Anda kontrol penuh atas konten dokumen. Gunakan dalam aplikasi Python via .NET Anda untuk pemrosesan dokumen yang lancar.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tukar halaman pertama dan terakhir dari file VISIO"
      content: |
