...
############################# Head ############################
head_title: "Tukar halaman di dokumen HTML menggunakan aplikasi Python via .NET"
head_description: "Gunakan GroupDocs.Merger for Python via .NET untuk menukar halaman di file HTML. Kelola PDF, dokumen Word, spreadsheet, presentasi, diagram Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Tukar halaman HTML" 
description: "GroupDocs.Merger for Python via .NET meningkatkan aplikasi Python dengan pemrosesan dokumen yang canggih. Tukar halaman di file HTML untuk mengorganisasi dan mengontrol konten Anda dengan lebih baik."
...
steps:
    enable: true
    title: "Cara menukar halaman HTML"
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan untuk menukar halaman HTML, memberi Anda kontrol penuh atas konten dokumen. Gunakan dalam aplikasi Python via .NET Anda untuk pemrosesan dokumen yang lancar.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tukar halaman pertama dan terakhir dari file HTML"
      content: |
        Contoh ini menunjukkan cara menukar halaman dalam file HTML hanya dalam beberapa langkah.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
