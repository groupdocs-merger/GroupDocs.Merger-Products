...
############################# Head ############################
head_title: "Intercambiar páginas en documentos MHTML utilizando aplicaciones Python via .NET"
head_description: "Utiliza GroupDocs.Merger for Python via .NET para intercambiar páginas en archivos MHTML. Gestiona PDFs, documentos de Word, hojas de cálculo, presentaciones, diagramas de Visio, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Intercambiar páginas MHTML" 
description: "GroupDocs.Merger for Python via .NET mejora las aplicaciones Python con un procesamiento avanzado de documentos. Intercambia páginas en archivos MHTML para organizar y controlar mejor tu contenido."
...
steps:
    enable: true
    title: "Cómo intercambiar páginas MHTML"
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita el intercambio de páginas MHTML, brindándote un control total sobre el contenido del documento. Úsalo en tus aplicaciones Python via .NET para un procesamiento fluido de documentos.
      
      1. Especifica la ruta al archivo MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Intercambiar la primera y la última página de un archivo MHTML"
      content: |
        Este ejemplo muestra cómo intercambiar páginas en un archivo MHTML en solo unos pocos pasos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
