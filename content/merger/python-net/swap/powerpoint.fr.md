...
############################# Head ############################
head_title: "Échanger des pages dans des documents POWERPOINT en utilisant des applications Python via .NET"
head_description: "Utilisez GroupDocs.Merger for Python via .NET pour échanger des pages dans des fichiers POWERPOINT. Gérez les fichiers PDF, les documents Word, les tableurs, les présentations, les diagrammes Visio, les images, les archives et bien plus."

############################# Header ############################
title: "Échanger des pages POWERPOINT" 
description: "GroupDocs.Merger for Python via .NET améliore les applications Python avec un traitement de documents avancé. Échangez des pages dans des fichiers POWERPOINT pour mieux organiser et contrôler votre contenu."
...
steps:
    enable: true
    title: "Comment échanger des pages POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/python-net/) permet d'échanger des pages POWERPOINT, vous donnant un contrôle total sur le contenu des documents. Utilisez-le dans vos applications Python via .NET pour un traitement des documents fluide.
      
      1. Spécifiez le chemin vers le fichier POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Échanger les premières et dernières pages d'un fichier POWERPOINT"
      content: |
        Cet exemple montre comment échanger des pages dans un fichier POWERPOINT en quelques étapes.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
