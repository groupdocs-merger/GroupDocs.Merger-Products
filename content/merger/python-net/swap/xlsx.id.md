...
############################# Head ############################
head_title: "Tukar halaman di dokumen XLSX menggunakan aplikasi Python via .NET"
head_description: "Gunakan GroupDocs.Merger for Python via .NET untuk menukar halaman di file XLSX. Kelola PDF, dokumen Word, spreadsheet, presentasi, diagram Visio, gambar, arsip, dan banyak lagi."

############################# Header ############################
title: "Tukar halaman XLSX" 
description: "GroupDocs.Merger for Python via .NET meningkatkan aplikasi Python dengan pemrosesan dokumen yang canggih. Tukar halaman di file XLSX untuk mengorganisasi dan mengontrol konten Anda dengan lebih baik."
...
steps:
    enable: true
    title: "Cara menukar halaman XLSX"
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan untuk menukar halaman XLSX, memberi Anda kontrol penuh atas konten dokumen. Gunakan dalam aplikasi Python via .NET Anda untuk pemrosesan dokumen yang lancar.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Tukar halaman pertama dan terakhir dari file XLSX"
      content: |
