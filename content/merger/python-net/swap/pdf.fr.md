...
############################# Head ############################
head_title: "Échanger des pages dans des documents PDF en utilisant des applications Python via .NET"
head_description: "Utilisez GroupDocs.Merger for Python via .NET pour échanger des pages dans des fichiers PDF. Gérez les fichiers PDF, les documents Word, les tableurs, les présentations, les diagrammes Visio, les images, les archives et bien plus."

############################# Header ############################
title: "Échanger des pages PDF" 
description: "GroupDocs.Merger for Python via .NET améliore les applications Python avec un traitement de documents avancé. Échangez des pages dans des fichiers PDF pour mieux organiser et contrôler votre contenu."
...
steps:
    enable: true
    title: "Comment échanger des pages PDF"
    content: |
      [GroupDocs.Merger](/merger/python-net/) permet d'échanger des pages PDF, vous donnant un contrôle total sur le contenu des documents. Utilisez-le dans vos applications Python via .NET pour un traitement des documents fluide.
      
      1. Spécifiez le chemin vers le fichier PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Échanger les premières et dernières pages d'un fichier PDF"
      content: |
        Cet exemple montre comment échanger des pages dans un fichier PDF en quelques étapes.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
