...
############################# Head ############################
head_title: "Swap pages in VISIO documents using Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to swap pages in VISIO files. Easily manage PDFs, Word documents, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap VISIO pages" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Swap pages in VISIO files to better organize and control your content."
...
steps:
    enable: true
    title: "How to swap VISIO pages"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to swap VISIO pages, giving you full control over document content. Use it in your Python via .NET applications for seamless document processing.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages of a VISIO file"
      content: |
