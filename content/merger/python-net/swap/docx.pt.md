...
############################# Head ############################
head_title: "Troque páginas em documentos DOCX usando aplicativos Python via .NET"
head_description: "Utilize GroupDocs.Merger for Python via .NET para trocar páginas em arquivos DOCX. Gerencie arquivos PDF, documentos Word, planilhas, apresentações, diagramas Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Trocar páginas DOCX" 
description: "GroupDocs.Merger for Python via .NET aprimora aplicações Python com um processamento avançado de documentos. Troque páginas em arquivos DOCX para organizar e controlar melhor seu conteúdo."
...
steps:
    enable: true
    title: "Como trocar páginas DOCX"
    content: |
      [GroupDocs.Merger](/merger/python-net/) permite trocar páginas DOCX, oferecendo total controle sobre o conteúdo do documento. Utilize-o em suas aplicações Python via .NET para um processamento de documentos fluido.
      
      1. Especifique o caminho para o arquivo DOCX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Troque as primeiras e últimas páginas de um arquivo DOCX"
      content: |
        Este exemplo mostra como trocar páginas em um arquivo DOCX em apenas alguns passos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
