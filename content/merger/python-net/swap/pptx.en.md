...
############################# Head ############################
head_title: "Swap pages in PPTX documents using Python via .NET apps"
head_description: "Use GroupDocs.Merger for Python via .NET to swap pages in PPTX files. Easily manage PDFs, Word documents, spreadsheets, presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Swap PPTX pages" 
description: "GroupDocs.Merger for Python via .NET enhances Python applications with advanced document processing. Swap pages in PPTX files to better organize and control your content."
...
steps:
    enable: true
    title: "How to swap PPTX pages"
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to swap PPTX pages, giving you full control over document content. Use it in your Python via .NET applications for seamless document processing.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages of a PPTX file"
      content: |
