...
############################# Head ############################
head_title: "Échanger des pages dans des documents WORD en utilisant des applications Python via .NET"
head_description: "Utilisez GroupDocs.Merger for Python via .NET pour échanger des pages dans des fichiers WORD. Gérez les fichiers PDF, les documents Word, les tableurs, les présentations, les diagrammes Visio, les images, les archives et bien plus."

############################# Header ############################
title: "Échanger des pages WORD" 
description: "GroupDocs.Merger for Python via .NET améliore les applications Python avec un traitement de documents avancé. Échangez des pages dans des fichiers WORD pour mieux organiser et contrôler votre contenu."
...
steps:
    enable: true
    title: "Comment échanger des pages WORD"
    content: |
      [GroupDocs.Merger](/merger/python-net/) permet d'échanger des pages WORD, vous donnant un contrôle total sur le contenu des documents. Utilisez-le dans vos applications Python via .NET pour un traitement des documents fluide.
      
      1. Spécifiez le chemin vers le fichier WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Échanger les premières et dernières pages d'un fichier WORD"
      content: |
        Cet exemple montre comment échanger des pages dans un fichier WORD en quelques étapes.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
