...
############################# Head ############################
head_title: "Combina archivos HTML a través de Python via .NET"
head_description: "Integra la fusión de documentos HTML sin problemas en tus proyectos de Python con GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Combina archivos HTML" 
description: "Optimiza el procesamiento de documentos en tus aplicaciones Python con GroupDocs.Merger for Python via .NET, permitiendo una fusión rápida y eficiente de archivos HTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita la fusión de documentos HTML. Añade capacidades de fusión a tus aplicaciones Python via .NET para combinar eficientemente múltiples archivos.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa Merger con el documento HTML de origen
