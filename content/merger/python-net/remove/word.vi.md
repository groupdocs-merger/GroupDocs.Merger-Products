...
############################# Head ############################
head_title: "Xóa các trang khỏi WORD trong ứng dụng Python via .NET"
head_description: "Xóa các trang cụ thể từ các tệp WORD bằng cách sử dụng GroupDocs.Merger for Python via .NET. Xử lý PDF, Word, Excel, PowerPoint, hình ảnh, lưu trữ, và nhiều hơn nữa."

############################# Header ############################
title: "Xóa các trang khỏi WORD" 
...
steps:
    enable: true
    title: "Các bước để xóa trang khỏi WORD"
    content: |
      Với [GroupDocs.Merger](/merger/python-net/), bạn có thể nhanh chóng xóa các trang từ tài liệu WORD. Tích hợp nó vào các ứng dụng Python via .NET của bạn để cải thiện quản lý tài liệu.
      
      1. Cung cấp đường dẫn tệp của tài liệu WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Xóa tất cả các trang chẵn"
      content: |
        Tìm hiểu cách xóa các trang chẵn từ tệp WORD.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
