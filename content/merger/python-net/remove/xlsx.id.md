...
############################# Head ############################
head_title: "Hapus halaman dari XLSX dalam aplikasi Python via .NET"
head_description: "Hapus halaman tertentu dari file XLSX menggunakan GroupDocs.Merger for Python via .NET. Proses PDF, Word, Excel, PowerPoint, gambar, arsip, dan banyak lagi."
...
steps:
    enable: true
    title: "Langkah untuk menghapus halaman dari XLSX"
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), Anda dapat dengan cepat menghapus halaman dari dokumen XLSX. Integrasikan ke dalam aplikasi Python via .NET Anda untuk pengelolaan dokumen yang lebih baik.
      
      1. Berikan jalur file dari dokumen XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hapus semua halaman dengan nomor genap"
      content: |
        Pelajari cara menghapus halaman genap dari file XLSX.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
