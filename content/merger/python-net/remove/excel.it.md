...
############################# Head ############################
head_title: "Rimuovi pagine da EXCEL nelle app Python via .NET"
head_description: "Elimina specifiche pagine da file EXCEL utilizzando GroupDocs.Merger for Python via .NET. Elabora PDF, Word, Excel, PowerPoint, immagini, archivi e altro ancora."
...
steps:
    enable: true
    title: "Passaggi per rimuovere pagine da EXCEL"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), puoi rapidamente eliminare pagine da documenti EXCEL. Integralo nelle tue app Python via .NET per una gestione avanzata dei documenti.
      
      1. Fornisci il percorso del file del documento EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Elimina tutte le pagine con numero pari"
      content: |
        Scopri come rimuovere le pagine pari da un file EXCEL.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
