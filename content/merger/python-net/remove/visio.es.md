...
############################# Head ############################
head_title: "Eliminar páginas de VISIO en aplicaciones Python via .NET"
head_description: "Elimina páginas específicas de archivos VISIO usando GroupDocs.Merger for Python via .NET. Procesa PDFs, Word, Excel, PowerPoint, imágenes, archivos comprimidos y más."
...
steps:
    enable: true
    title: "Pasos para eliminar páginas de VISIO"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), puedes eliminar rápidamente páginas de documentos VISIO. Integrarlo en tus aplicaciones Python via .NET mejora la gestión de documentos.
      
      1. Proporciona la ruta del archivo del documento VISIO.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eliminar todas las páginas de números pares"
      content: |
        Aprende cómo eliminar páginas pares de un archivo VISIO.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
