...
############################# Head ############################
head_title: "Eliminar páginas de PDF en aplicaciones Python via .NET"
head_description: "Elimina páginas específicas de archivos PDF usando GroupDocs.Merger for Python via .NET. Procesa PDFs, Word, Excel, PowerPoint, imágenes, archivos comprimidos y más."
...
steps:
    enable: true
    title: "Pasos para eliminar páginas de PDF"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), puedes eliminar rápidamente páginas de documentos PDF. Integrarlo en tus aplicaciones Python via .NET mejora la gestión de documentos.
      
      1. Proporciona la ruta del archivo del documento PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eliminar todas las páginas de números pares"
      content: |
        Aprende cómo eliminar páginas pares de un archivo PDF.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
