...
############################# Head ############################
head_title: "Hapus halaman dari XPS dalam aplikasi Python via .NET"
head_description: "Hapus halaman tertentu dari file XPS menggunakan GroupDocs.Merger for Python via .NET. Proses PDF, Word, Excel, PowerPoint, gambar, arsip, dan banyak lagi."
...
steps:
    enable: true
    title: "Langkah untuk menghapus halaman dari XPS"
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), Anda dapat dengan cepat menghapus halaman dari dokumen XPS. Integrasikan ke dalam aplikasi Python via .NET Anda untuk pengelolaan dokumen yang lebih baik.
      
      1. Berikan jalur file dari dokumen XPS.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hapus semua halaman dengan nomor genap"
      content: |
        Pelajari cara menghapus halaman genap dari file XPS.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
