...
############################# Head ############################
head_title: "Remover páginas de POWERPOINT em aplicativos Python via .NET"
head_description: "Delete páginas específicas de arquivos POWERPOINT usando GroupDocs.Merger for Python via .NET. Processar PDFs, Word, Excel, PowerPoint, imagens, arquivos compactados e mais."
...
steps:
    enable: true
    title: "Passos para remover páginas de POWERPOINT"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), você pode rapidamente deletar páginas de documentos POWERPOINT. Integre-o em seus aplicativos Python via .NET para uma melhor gestão de documentos.
      
      1. Forneça o caminho do arquivo do documento POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Deletar todas as páginas de números pares"
      content: |
        Aprenda como remover páginas pares de um arquivo POWERPOINT.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
