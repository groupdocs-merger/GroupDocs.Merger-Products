...
############################# Head ############################
head_title: "Hapus halaman dari EXCEL dalam aplikasi Python via .NET"
head_description: "Hapus halaman tertentu dari file EXCEL menggunakan GroupDocs.Merger for Python via .NET. Proses PDF, Word, Excel, PowerPoint, gambar, arsip, dan banyak lagi."
...
steps:
    enable: true
    title: "Langkah untuk menghapus halaman dari EXCEL"
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), Anda dapat dengan cepat menghapus halaman dari dokumen EXCEL. Integrasikan ke dalam aplikasi Python via .NET Anda untuk pengelolaan dokumen yang lebih baik.
      
      1. Berikan jalur file dari dokumen EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hapus semua halaman dengan nomor genap"
      content: |
        Pelajari cara menghapus halaman genap dari file EXCEL.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
