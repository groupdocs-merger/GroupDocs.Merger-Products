...
############################# Head ############################
head_title: "Eliminar páginas de EXCEL en aplicaciones Python via .NET"
head_description: "Elimina páginas específicas de archivos EXCEL usando GroupDocs.Merger for Python via .NET. Procesa PDFs, Word, Excel, PowerPoint, imágenes, archivos comprimidos y más."
...
steps:
    enable: true
    title: "Pasos para eliminar páginas de EXCEL"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), puedes eliminar rápidamente páginas de documentos EXCEL. Integrarlo en tus aplicaciones Python via .NET mejora la gestión de documentos.
      
      1. Proporciona la ruta del archivo del documento EXCEL.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Eliminar todas las páginas de números pares"
      content: |
        Aprende cómo eliminar páginas pares de un archivo EXCEL.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
