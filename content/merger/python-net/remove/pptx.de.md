...
############################# Head ############################
head_title: "Seiten aus PPTX in Python via .NET-Apps entfernen"
head_description: "Löschen Sie spezifische Seiten aus PPTX-Dateien mit GroupDocs.Merger for Python via .NET. Verarbeiten Sie PDFs, Word, Excel, PowerPoint, Bilder, Archive und mehr."
...
steps:
    enable: true
    title: "Schritte zum Entfernen von Seiten aus PPTX"
    content: |
      Mit [GroupDocs.Merger](/merger/python-net/) können Sie schnell Seiten aus PPTX-Dokumenten löschen. Integrieren Sie es in Ihre Python via .NET-Apps für eine verbesserte Dokumentenverwaltung.
      
      1. Geben Sie den Dateipfad des PPTX-Dokuments an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Löschen Sie alle geraden Seiten"
      content: |
        Erfahren Sie, wie Sie gerade Seiten aus einer PPTX-Datei entfernen.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
