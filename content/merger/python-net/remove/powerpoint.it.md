...
############################# Head ############################
head_title: "Rimuovi pagine da POWERPOINT nelle app Python via .NET"
head_description: "Elimina specifiche pagine da file POWERPOINT utilizzando GroupDocs.Merger for Python via .NET. Elabora PDF, Word, Excel, PowerPoint, immagini, archivi e altro ancora."
...
steps:
    enable: true
    title: "Passaggi per rimuovere pagine da POWERPOINT"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), puoi rapidamente eliminare pagine da documenti POWERPOINT. Integralo nelle tue app Python via .NET per una gestione avanzata dei documenti.
      
      1. Fornisci il percorso del file del documento POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Elimina tutte le pagine con numero pari"
      content: |
        Scopri come rimuovere le pagine pari da un file POWERPOINT.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
