...
############################# Head ############################
head_title: "Mesclar arquivos PNG via Python via .NET"
head_description: "Integre a mesclagem de documentos PNG perfeitamente em seus projetos Python com GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Mesclar arquivos PNG" 
description: "Otimize o processamento de documentos em suas aplicações Python com GroupDocs.Merger for Python via .NET, permitindo a mesclagem rápida e eficiente de arquivos PNG."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) torna simples a mesclagem de documentos PNG. Adicione capacidades de mesclagem às suas aplicações Python via .NET para combinar vários arquivos de forma eficiente.
      
      1. Forneça o caminho para o primeiro arquivo PNG.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize Merger com o documento PNG fonte
