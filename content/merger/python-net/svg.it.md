...
############################# Head ############################
head_title: "Unisci file SVG tramite Python via .NET"
head_description: "Integra la fusione di documenti SVG senza problemi nei tuoi progetti Python con GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unisci file SVG" 
description: "Ottimizza l'elaborazione dei documenti nelle tue applicazioni Python con GroupDocs.Merger for Python via .NET, consentendo una fusione rapida ed efficiente dei file SVG."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) rende semplice unire documenti SVG. Aggiungi funzionalità di fusione alle tue applicazioni Python via .NET per combinare efficientemente più file.
      
      1. Fornisci il percorso del primo file SVG.
