...
############################# Head ############################
head_title: "Mesclar arquivos BMP via Python via .NET"
head_description: "Integre a mesclagem de documentos BMP perfeitamente em seus projetos Python com GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Mesclar arquivos BMP" 
description: "Otimize o processamento de documentos em suas aplicações Python com GroupDocs.Merger for Python via .NET, permitindo a mesclagem rápida e eficiente de arquivos BMP."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) torna simples a mesclagem de documentos BMP. Adicione capacidades de mesclagem às suas aplicações Python via .NET para combinar vários arquivos de forma eficiente.
      
      1. Forneça o caminho para o primeiro arquivo BMP.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize Merger com o documento BMP fonte
