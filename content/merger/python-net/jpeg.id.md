...
############################# Head ############################
head_title: "Gabungkan file JPEG melalui Python via .NET"
head_description: "Integrasikan penggabungan dokumen JPEG secara seamless ke dalam proyek Python Anda dengan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file JPEG" 
description: "Permudah pemrosesan dokumen dalam aplikasi Python Anda dengan GroupDocs.Merger for Python via .NET, memungkinkan penggabungan file JPEG yang cepat dan efisien."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan penggabungan dokumen JPEG. Tambahkan kemampuan penggabungan ke aplikasi Python via .NET Anda untuk menggabungkan beberapa file secara efisien.
      
      1. Berikan jalur ke file JPEG pertama.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen JPEG sumber
