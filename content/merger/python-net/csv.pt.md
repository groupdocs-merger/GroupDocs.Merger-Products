...
############################# Head ############################
head_title: "Mesclar arquivos CSV via Python via .NET"
head_description: "Integre a mesclagem de documentos CSV perfeitamente em seus projetos Python com GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Mesclar arquivos CSV" 
description: "Otimize o processamento de documentos em suas aplicações Python com GroupDocs.Merger for Python via .NET, permitindo a mesclagem rápida e eficiente de arquivos CSV."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) torna simples a mesclagem de documentos CSV. Adicione capacidades de mesclagem às suas aplicações Python via .NET para combinar vários arquivos de forma eficiente.
      
      1. Forneça o caminho para o primeiro arquivo CSV.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize Merger com o documento CSV fonte
