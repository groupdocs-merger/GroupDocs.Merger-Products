...
############################# Head ############################
head_title: "Gabungkan file WORD melalui Python via .NET"
head_description: "Integrasikan penggabungan dokumen WORD secara seamless ke dalam proyek Python Anda dengan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file WORD" 
description: "Permudah pemrosesan dokumen dalam aplikasi Python Anda dengan GroupDocs.Merger for Python via .NET, memungkinkan penggabungan file WORD yang cepat dan efisien."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan penggabungan dokumen WORD. Tambahkan kemampuan penggabungan ke aplikasi Python via .NET Anda untuk menggabungkan beberapa file secara efisien.
      
      1. Berikan jalur ke file WORD pertama.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen WORD sumber
