...
############################# Head ############################
head_title: "Hợp nhất tập tin TIFF trong Python via .NET"
head_description: "Tích hợp mượt mà việc hợp nhất tập tin TIFF vào các dự án Python của bạn bằng cách sử dụng GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Hợp nhất tập tin TIFF" 
description: "GroupDocs.Merger for Python via .NET cho phép bạn hợp nhất các tài liệu TIFF trong các ứng dụng Python của bạn, cung cấp tích hợp liền mạch và hiệu suất cao."
...
steps:
    enable: true
    title: "Cách hợp nhất tài liệu TIFF"
    content: |
      Với [GroupDocs.Merger](/merger/python-net/), việc hợp nhất tài liệu TIFF rất đơn giản. Nâng cao các ứng dụng Python via .NET của bạn với khả năng kết hợp tài liệu hiệu quả.
      
      1. Cung cấp đường dẫn tập tin cho tài liệu TIFF đầu tiên.
    ...
    code:
      ...
      content: |
        ...
        # Khởi tạo Merger với tài liệu TIFF nguồn
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hợp nhất các trang được chọn từ các định dạng tài liệu khác nhau"
      content: |
        Ví dụ này minh họa cách hợp nhất các tập tin TIFF trong khi chọn các trang cụ thể từ các tài liệu khác định dạng.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
