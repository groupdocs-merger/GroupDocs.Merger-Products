...
############################# Head ############################
head_title: "Fusionar archivos HTML en Python via .NET"
head_description: "Integra sin problemas la fusión de archivos HTML en tus proyectos de Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionar archivos HTML" 
description: "GroupDocs.Merger for Python via .NET te permite fusionar documentos HTML de manera eficiente dentro de tus aplicaciones Python, ofreciendo una integración fluida y alto rendimiento."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), fusionar documentos HTML es simple. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa el Merger con el documento HTML de origen
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo fusionar archivos HTML mientras seleccionas páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
