...
head_description: "Безшовно інтегруйте об'єднання файлів HTML у свої проекти Python за допомогою GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Об'єднання файлів HTML" 
description: "GroupDocs.Merger for Python via .NET дозволяє вам безперешкодно об'єднувати документи HTML у ваших додатках Python, забезпечуючи інтеграцію та високу продуктивність."
...
steps:
    enable: true
    title: "Як з'єднати документи HTML"
    content: |
      За допомогою [GroupDocs.Merger](/merger/python-net/) об'єднання документів HTML є простим. Покращте свої додатки Python via .NET з допомогою ефективних можливостей поєднання документів.
      
      1. Введіть шлях до першого документа HTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання обраних сторінок з різних форматів документів"
      content: |
        Цей приклад демонструє, як об'єднати файли HTML, вибираючи конкретні сторінки з документів в інших форматах.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
