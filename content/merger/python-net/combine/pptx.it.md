...
head_description: "Integra senza soluzione di continuità la fusione di file PPTX nei tuoi progetti Python utilizzando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unisci file PPTX" 
description: "GroupDocs.Merger for Python via .NET ti consente di unire documenti PPTX all'interno delle tue applicazioni Python, offrendo integrazione fluida e alte prestazioni."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), unire documenti PPTX è semplice. Migliora le tue applicazioni Python via .NET con capacità di combinazione documenti efficienti.
