...
############################# Head ############################
head_title: "Fusionner des fichiers BMP dans Python via .NET"
head_description: "Intégrez sans effort la fusion de fichiers BMP dans vos projets Python en utilisant GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionner des fichiers BMP" 
description: "GroupDocs.Merger for Python via .NET vous permet de fusionner des documents BMP au sein de vos applications Python, offrant une intégration fluide et des performances élevées."
...
steps:
    ...
    content: |
      Avec [GroupDocs.Merger](/merger/python-net/), la fusion de documents BMP est directe. Améliorez vos applications Python via .NET avec des capacités de combinaison de documents efficaces.
    ...
    code:
      ...
      content: |
        ...
        # Initialisez le Merger avec le document source BMP
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages sélectionnées à partir de différents formats de documents"
      content: |
        Cet exemple montre comment fusionner des fichiers BMP tout en sélectionnant des pages spécifiques de documents dans d'autres formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
