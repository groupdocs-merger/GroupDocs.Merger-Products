...
############################# Head ############################
head_title: "在 Python via .NET 中合并 CSV 文件"
head_description: "使用 GroupDocs.Merger for Python via .NET 无缝整合 CSV 文件合并到您的 Python 项目中。"

############################# Header ############################
title: "合并 CSV 文件" 
description: "GroupDocs.Merger for Python via .NET 使您能够在 Python 应用程序中高效合并 CSV 文档，提供无缝集成和高性能。"
...
steps:
    ...
    title: "如何合并 CSV 文档"
    content: |
      使用 [GroupDocs.Merger](/merger/python-net/)，合并 CSV 文档非常简单。增强您的 Python via .NET 应用程序，实现高效的文档组合功能。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同文档格式合并选定页面"
      content: |
        本示例演示如何在合并 CSV 文件时选择来自其他格式文档的特定页面。
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
