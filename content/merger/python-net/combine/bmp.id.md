...
head_description: "Integrasikan penggabungan file BMP ke dalam proyek Python Anda menggunakan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file BMP" 
description: "GroupDocs.Merger for Python via .NET memungkinkan Anda untuk menggabungkan dokumen BMP dengan efisien dalam aplikasi Python Anda, memberikan integrasi yang mulus dan kinerja tinggi."
...
steps:
    ...
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), menggabungkan dokumen BMP menjadi mudah. Tingkatkan aplikasi Python via .NET Anda dengan kemampuan kombinasi dokumen yang efisien.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen BMP sumber
