...
############################# Head ############################
head_title: "Fusionar archivos TIFF en Python via .NET"
head_description: "Integra sin problemas la fusión de archivos TIFF en tus proyectos de Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionar archivos TIFF" 
description: "GroupDocs.Merger for Python via .NET te permite fusionar documentos TIFF de manera eficiente dentro de tus aplicaciones Python, ofreciendo una integración fluida y alto rendimiento."
...
steps:
    enable: true
    title: "Cómo fusionar documentos TIFF"
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), fusionar documentos TIFF es simple. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
      
      1. Proporciona la ruta del primer documento TIFF.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa el Merger con el documento TIFF de origen
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo fusionar archivos TIFF mientras seleccionas páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
