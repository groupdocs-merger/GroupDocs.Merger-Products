...
############################# Head ############################
head_title: "Merge VISIO files in Python via .NET"
head_description: "Seamlessly integrate VISIO file merging into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Merge VISIO files" 
description: "GroupDocs.Merger for Python via .NET enables you to merge VISIO documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), merging VISIO documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
      
      1. Provide the file path for the first VISIO document.
    ...
    code:
      ...
      content: |
        ...
        # Initialize the Merger with the source VISIO document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different document formats"
      content: |
        This example demonstrates how to merge VISIO files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/python-net/rotate/visio/"
        ...
        - name: "Change orientation"
          ...
          link: "/merger/python-net/orientation/visio/"
