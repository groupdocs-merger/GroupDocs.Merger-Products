...
############################# Head ############################
head_title: "Merge ZIP files in Python via .NET"
head_description: "Seamlessly integrate ZIP file merging into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Merge ZIP files" 
description: "GroupDocs.Merger for Python via .NET enables you to merge ZIP documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), merging ZIP documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
      
      1. Provide the file path for the first ZIP document.
    ...
    code:
      ...
      content: |
        ...
        # Initialize the Merger with the source ZIP document
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different document formats"
      content: |
        This example demonstrates how to merge ZIP files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Extract pages"
          operation: "extract"
          link: "/merger/python-net/extract/zip/"
          description: "Save selected pages as a separate document"

        # operation loop 3
        - name: "Move pages"
          operation: "move"
          link: "/merger/python-net/move/zip/"
          description: "Reposition any page within a document"

        # operation loop 4
        - name: "Remove pages"
          operation: "remove"
          link: "/merger/python-net/remove/zip/"
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/python-net/rotate/zip/"
          description: "Rotate document pages"

        # operation loop 7
        - name: "Split doc"
          operation: "split"
          link: "/merger/python-net/split/zip/"
          description: "Split documents"

        # operation loop 8
        - name: "Swap pages"
          operation: "swap"
          link: "/merger/python-net/swap/zip/"
          description: "Swap document pages"

        # operation loop 9
        - name: "Change orientation"
          operation: "orientation"
          link: "/merger/python-net/orientation/zip/"
