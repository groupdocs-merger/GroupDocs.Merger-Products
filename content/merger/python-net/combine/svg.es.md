...
############################# Head ############################
head_title: "Fusionar archivos SVG en Python via .NET"
head_description: "Integra sin problemas la fusión de archivos SVG en tus proyectos de Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionar archivos SVG" 
description: "GroupDocs.Merger for Python via .NET te permite fusionar documentos SVG de manera eficiente dentro de tus aplicaciones Python, ofreciendo una integración fluida y alto rendimiento."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), fusionar documentos SVG es simple. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
      
      1. Proporciona la ruta del primer documento SVG.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa el Merger con el documento SVG de origen
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo fusionar archivos SVG mientras seleccionas páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
