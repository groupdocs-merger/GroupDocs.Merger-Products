...
############################# Head ############################
head_title: "Merge POWERPOINT files in Python via .NET"
head_description: "Seamlessly integrate POWERPOINT file merging into your Python projects using GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Merge POWERPOINT files" 
description: "GroupDocs.Merger for Python via .NET enables you to merge POWERPOINT documents effortlessly within your Python applications, providing seamless integration and high performance."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/python-net/), merging POWERPOINT documents is simple. Enhance your Python via .NET applications with efficient document combination capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different document formats"
      content: |
        This example demonstrates how to merge POWERPOINT files while selecting specific pages from documents in other formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
