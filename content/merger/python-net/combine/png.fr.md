...
############################# Head ############################
head_title: "Fusionner des fichiers PNG dans Python via .NET"
head_description: "Intégrez sans effort la fusion de fichiers PNG dans vos projets Python en utilisant GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionner des fichiers PNG" 
description: "GroupDocs.Merger for Python via .NET vous permet de fusionner des documents PNG au sein de vos applications Python, offrant une intégration fluide et des performances élevées."
...
steps:
    ...
    content: |
      Avec [GroupDocs.Merger](/merger/python-net/), la fusion de documents PNG est directe. Améliorez vos applications Python via .NET avec des capacités de combinaison de documents efficaces.
    ...
    code:
      ...
      content: |
        ...
        # Initialisez le Merger avec le document source PNG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages sélectionnées à partir de différents formats de documents"
      content: |
        Cet exemple montre comment fusionner des fichiers PNG tout en sélectionnant des pages spécifiques de documents dans d'autres formats.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
