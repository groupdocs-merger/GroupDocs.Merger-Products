...
############################# Head ############################
head_title: "Fusionar archivos JPEG en Python via .NET"
head_description: "Integra sin problemas la fusión de archivos JPEG en tus proyectos de Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Fusionar archivos JPEG" 
description: "GroupDocs.Merger for Python via .NET te permite fusionar documentos JPEG de manera eficiente dentro de tus aplicaciones Python, ofreciendo una integración fluida y alto rendimiento."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/python-net/), fusionar documentos JPEG es simple. Mejora tus aplicaciones Python via .NET con capacidades eficientes de combinación de documentos.
      
      1. Proporciona la ruta del primer documento JPEG.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa el Merger con el documento JPEG de origen
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de documentos"
      content: |
        Este ejemplo demuestra cómo fusionar archivos JPEG mientras seleccionas páginas específicas de documentos en otros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
