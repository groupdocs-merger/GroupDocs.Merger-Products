...
############################# Head ############################
head_title: "Fügen Sie IMAGE-Dateien in Python via .NET zusammen"
head_description: "Integrieren Sie das Zusammenführen von IMAGE-Dateien nahtlos in Ihre Python-Projekte mit GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Vereinigen Sie IMAGE-Dateien" 
...
steps:
    ...
    content: |
      Mit [GroupDocs.Merger](/merger/python-net/) ist das Zusammenführen von IMAGE-Dokumenten unkompliziert. Bereichern Sie Ihre Python via .NET-Anwendungen mit effizienten Kombinationsmöglichkeiten für Dokumente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus verschiedenen Dokumentformaten zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man IMAGE-Dateien zusammenführt, während spezifische Seiten aus Dokumenten anderer Formate ausgewählt werden.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
