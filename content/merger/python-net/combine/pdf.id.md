...
head_description: "Integrasikan penggabungan file PDF ke dalam proyek Python Anda menggunakan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file PDF" 
description: "GroupDocs.Merger for Python via .NET memungkinkan Anda untuk menggabungkan dokumen PDF dengan efisien dalam aplikasi Python Anda, memberikan integrasi yang mulus dan kinerja tinggi."
...
steps:
    ...
    content: |
      Dengan [GroupDocs.Merger](/merger/python-net/), menggabungkan dokumen PDF menjadi mudah. Tingkatkan aplikasi Python via .NET Anda dengan kemampuan kombinasi dokumen yang efisien.
    ...
    code:
      ...
      content: |
        ...
        # Inisialisasi Merger dengan dokumen PDF sumber
