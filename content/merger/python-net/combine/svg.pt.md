...
############################# Head ############################
head_title: "Mesclar arquivos SVG em Python via .NET"
head_description: "Integre perfeitamente a mesclagem de arquivos SVG em seus projetos Python utilizando GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Mesclar arquivos SVG" 
description: "GroupDocs.Merger for Python via .NET permite que você mescle documentos SVG de forma eficiente em suas aplicações Python, proporcionando integração fluida e alto desempenho."
...
steps:
    enable: true
    title: "Como mesclar documentos SVG"
    content: |
      Com [GroupDocs.Merger](/merger/python-net/), mesclar documentos SVG é simples. Aprimore suas aplicações Python via .NET com capacidades eficientes de combinação de documentos.
      
      1. Forneça o caminho do arquivo para o primeiro documento SVG.
    ...
    code:
      ...
      content: |
        ...
        # Inicialize o Merger com o documento SVG fonte
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de diferentes formatos de documentos"
      content: |
        Este exemplo demonstra como mesclar arquivos SVG enquanto seleciona páginas específicas de documentos em outros formatos.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
