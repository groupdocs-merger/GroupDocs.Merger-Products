...
############################# Head ############################
head_title: "Rearrange WORD pages in Python via .NET"
head_description: "Use GroupDocs.Merger for Python via .NET to quickly reorder pages in WORD documents. Process PDFs, Word, Excel, PowerPoint files, images, and more with ease."

############################# Header ############################
title: "Rearrange pages in WORD" 
description: "GroupDocs.Merger for Python via .NET enables Python applications to modify page order in WORD documents effortlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to move pages within WORD documents. Upgrade your Python via .NET applications with advanced document management features.
      
      1. Provide the path to the WORD document.
