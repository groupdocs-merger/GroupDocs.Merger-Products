...
############################# Head ############################
head_title: "Rearrange POWERPOINT pages in Python via .NET"
head_description: "Use GroupDocs.Merger for Python via .NET to quickly reorder pages in POWERPOINT documents. Process PDFs, Word, Excel, PowerPoint files, images, and more with ease."

############################# Header ############################
title: "Rearrange pages in POWERPOINT" 
description: "GroupDocs.Merger for Python via .NET enables Python applications to modify page order in POWERPOINT documents effortlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to move pages within POWERPOINT documents. Upgrade your Python via .NET applications with advanced document management features.
      
      1. Provide the path to the POWERPOINT document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Move a page to the last position in a document"
      content: |
        This example demonstrates how to move a specific page to the end of a POWERPOINT document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
