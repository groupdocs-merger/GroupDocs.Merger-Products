...
############################# Head ############################
head_title: "VISIO-Seiten in Python via .NET neu anordnen"
head_description: "Verwenden Sie GroupDocs.Merger for Python via .NET, um Seiten in VISIO-Dokumenten schnell neu anzuordnen. Verarbeiten Sie PDFs, Word-, Excel-, PowerPoint-Dateien, Bilder und mehr."

############################# Header ############################
title: "VISIO-Seiten neu anordnen" 
description: "GroupDocs.Merger for Python via .NET ermöglicht es Python-Anwendungen, die Seitenreihenfolge in VISIO-Dokumenten mühelos zu ändern."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) erleichtert das Verschieben von Seiten innerhalb von VISIO-Dokumenten. Rüsten Sie Ihre Python via .NET-Anwendungen mit erweiterten Dokumentenmanagementfunktionen auf.
      
      1. Geben Sie den Pfad zum VISIO-Dokument an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Bewege eine Seite zum letzten Platz in einem Dokument"
      content: |
        Dieses Beispiel zeigt, wie man eine bestimmte Seite an das Ende eines VISIO-Dokuments verschiebt.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
