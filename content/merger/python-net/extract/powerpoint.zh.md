...
############################# Head ############################
head_title: "在Python via .NET中提取POWERPOINT页面"
head_description: "使用GroupDocs.Merger for Python via .NET快速提取POWERPOINT文件中的特定页面，并将其另存为独立文档。"

############################# Header ############################
title: "提取POWERPOINT页面" 
description: "通过GroupDocs.Merger for Python via .NET增强您的Python应用，实现POWERPOINT文档的无缝页面提取。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) 使您能够从POWERPOINT文档中提取页面。将无缝文档处理集成到您的Python via .NET应用中。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从文档中提取特定页面"
      content: |
        本示例展示如何从POWERPOINT文件中提取选定范围的页面，并将它们另存为独立文档。
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
