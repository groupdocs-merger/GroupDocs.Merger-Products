...
############################# Head ############################
head_title: "Извлечение страниц HTML в Python via .NET"
head_description: "Быстро извлекайте конкретные страницы из файла HTML с помощью GroupDocs.Merger for Python via .NET и сохраняйте их в отдельный документ."

############################# Header ############################
title: "Извлечение страниц HTML" 
description: "Усовершенствуйте свои приложения Python с помощью GroupDocs.Merger for Python via .NET, обеспечивая бесшовное извлечение страниц для документов HTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) позволяет извлекать страницы из документов HTML. Интегрируйте бесшовную обработку документов в ваши приложения Python via .NET.
      
      1. Укажите путь к файлу исходного документа HTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Извлечение конкретных страниц из документа"
      content: |
        Этот пример демонстрирует, как извлечь выбранный диапазон страниц из файла HTML и сохранить их в отдельный документ.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
