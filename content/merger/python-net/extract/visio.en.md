...
############################# Head ############################
head_title: "Extract VISIO pages in Python via .NET"
head_description: "Quickly extract specific pages from a VISIO file using GroupDocs.Merger for Python via .NET and save them as a separate document."

############################# Header ############################
title: "Extract VISIO pages" 
description: "Enhance your Python applications with GroupDocs.Merger for Python via .NET, providing seamless page extraction for VISIO documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) makes it easy to extract pages from VISIO documents. Integrate seamless document processing into your Python via .NET applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example shows how to extract a selected range of pages from a VISIO file and save them as a separate document.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
