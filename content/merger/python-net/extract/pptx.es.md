...
############################# Head ############################
head_title: "Extraer páginas de PPTX en Python via .NET"
head_description: "Extraiga rápidamente páginas específicas de un archivo PPTX usando GroupDocs.Merger for Python via .NET y guárdelas como un documento separado."

############################# Header ############################
title: "Extraer páginas de PPTX" 
description: "Mejore sus aplicaciones Python con GroupDocs.Merger for Python via .NET, que proporciona una extracción de páginas fluida para documentos PPTX."
...
steps:
    enable: true
    title: "Cómo extraer páginas PPTX"
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita la extracción de páginas de documentos PPTX. Integre un procesamiento de documentos fluido en sus aplicaciones Python via .NET.
      
      1. Especifique la ruta del archivo del documento PPTX fuente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraer páginas específicas de un documento"
      content: |
        Este ejemplo muestra cómo extraer un rango seleccionado de páginas de un archivo PPTX y guardarlas como un documento separado.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
