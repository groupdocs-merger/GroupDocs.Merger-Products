...
############################# Head ############################
head_title: "Trích xuất trang XLSX trong Python via .NET"
head_description: "Nhanh chóng trích xuất các trang cụ thể từ một tệp XLSX bằng cách sử dụng GroupDocs.Merger for Python via .NET và lưu chúng dưới dạng tài liệu riêng biệt."

############################# Header ############################
title: "Trích xuất trang XLSX" 
description: "Tăng cường ứng dụng Python của bạn với GroupDocs.Merger for Python via .NET, cung cấp khả năng trích xuất trang mượt mà cho tài liệu XLSX."
...
steps:
    enable: true
    title: "Cách trích xuất trang XLSX"
    content: |
      [GroupDocs.Merger](/merger/python-net/) cho phép bạn trích xuất các trang từ tài liệu XLSX. Tích hợp khả năng xử lý tài liệu mượt mà vào các ứng dụng Python via .NET của bạn.
      
      1. Xác định đường dẫn tệp của tài liệu XLSX nguồn.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trích xuất các trang cụ thể từ một tài liệu"
      content: |
        Ví dụ này cho thấy cách trích xuất một khoảng trang đã chọn từ tệp XLSX và lưu chúng dưới dạng tài liệu riêng biệt.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
