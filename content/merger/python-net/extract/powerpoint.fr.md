...
############################# Head ############################
head_title: "Extraire les pages POWERPOINT en Python via .NET"
head_description: "Extraire rapidement des pages spécifiques d'un fichier POWERPOINT à l'aide de GroupDocs.Merger for Python via .NET et les enregistrer en tant que document séparé."

############################# Header ############################
title: "Extraire les pages POWERPOINT" 
description: "Améliorez vos applications Python avec GroupDocs.Merger for Python via .NET, offrant une extraction de pages transparente pour les documents POWERPOINT."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) permet d'extraire des pages de documents POWERPOINT. Intégrez un traitement de document transparent dans vos applications Python via .NET.
      
      1. Spécifiez le chemin d'accès du document POWERPOINT source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire des pages spécifiques d'un document"
      content: |
        Cet exemple montre comment extraire une plage de pages sélectionnée d'un fichier POWERPOINT et les sauvegarder en tant que document séparé.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
