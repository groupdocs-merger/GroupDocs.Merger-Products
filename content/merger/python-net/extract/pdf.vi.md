...
############################# Head ############################
head_title: "Trích xuất trang PDF trong Python via .NET"
head_description: "Nhanh chóng trích xuất các trang cụ thể từ một tệp PDF bằng cách sử dụng GroupDocs.Merger for Python via .NET và lưu chúng dưới dạng tài liệu riêng biệt."

############################# Header ############################
title: "Trích xuất trang PDF" 
description: "Tăng cường ứng dụng Python của bạn với GroupDocs.Merger for Python via .NET, cung cấp khả năng trích xuất trang mượt mà cho tài liệu PDF."
...
steps:
    enable: true
    title: "Cách trích xuất trang PDF"
    content: |
      [GroupDocs.Merger](/merger/python-net/) cho phép bạn trích xuất các trang từ tài liệu PDF. Tích hợp khả năng xử lý tài liệu mượt mà vào các ứng dụng Python via .NET của bạn.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trích xuất các trang cụ thể từ một tài liệu"
      content: |
        Ví dụ này cho thấy cách trích xuất một khoảng trang đã chọn từ tệp PDF và lưu chúng dưới dạng tài liệu riêng biệt.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
