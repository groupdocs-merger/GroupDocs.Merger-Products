...
############################# Head ############################
head_title: "Estrai pagine PPTX in Python via .NET"
head_description: "Estrai rapidamente pagine specifiche da un file PPTX utilizzando GroupDocs.Merger for Python via .NET e salvale come documento separato."

############################# Header ############################
title: "Estrai pagine PPTX" 
description: "Migliora le tue applicazioni Python con GroupDocs.Merger for Python via .NET, offrendo un'estrazione senza interruzioni per documenti PPTX."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) semplifica l'estrazione di pagine dai documenti PPTX. Integra un'elaborazione documentale senza interruzioni nelle tue applicazioni Python via .NET.
      
      1. Specifica il percorso del file del documento PPTX sorgente.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Estrai pagine specifiche da un documento"
      content: |
        Questo esempio mostra come estrarre un intervallo selezionato di pagine da un file PPTX e salvarle come documento separato.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
