...
############################# Head ############################
head_title: "Extrair páginas de EPUB em Python via .NET"
head_description: "Extraia rapidamente páginas específicas de um arquivo EPUB usando GroupDocs.Merger for Python via .NET e salve-as como um documento separado."

############################# Header ############################
title: "Extrair páginas de EPUB" 
description: "Aprimore suas aplicações em Python com GroupDocs.Merger for Python via .NET, proporcionando extração de páginas sem interrupções para documentos EPUB."
...
steps:
    enable: true
    title: "Como extrair páginas de EPUB"
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita a extração de páginas de documentos EPUB. Integre o processamento de documentos sem interrupções em suas aplicações Python via .NET.
      
      1. Especifique o caminho do arquivo do documento EPUB fonte.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extrair páginas específicas de um documento"
      content: |
        Este exemplo mostra como extrair um intervalo selecionado de páginas de um arquivo EPUB e salvá-las como um documento separado.
      code:
        title: "JavaScript"
        content: |
          ```python {style=abap}
