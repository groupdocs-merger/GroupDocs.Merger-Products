...
############################# Head ############################
head_title: "Gabungkan file SVG melalui Python via .NET"
head_description: "Integrasikan penggabungan dokumen SVG secara seamless ke dalam proyek Python Anda dengan GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Gabungkan file SVG" 
description: "Permudah pemrosesan dokumen dalam aplikasi Python Anda dengan GroupDocs.Merger for Python via .NET, memungkinkan penggabungan file SVG yang cepat dan efisien."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) memudahkan penggabungan dokumen SVG. Tambahkan kemampuan penggabungan ke aplikasi Python via .NET Anda untuk menggabungkan beberapa file secara efisien.
      
      1. Berikan jalur ke file SVG pertama.
