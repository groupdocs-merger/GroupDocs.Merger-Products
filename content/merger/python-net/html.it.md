...
############################# Head ############################
head_title: "Unisci file HTML tramite Python via .NET"
head_description: "Integra la fusione di documenti HTML senza problemi nei tuoi progetti Python con GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Unisci file HTML" 
description: "Ottimizza l'elaborazione dei documenti nelle tue applicazioni Python con GroupDocs.Merger for Python via .NET, consentendo una fusione rapida ed efficiente dei file HTML."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) rende semplice unire documenti HTML. Aggiungi funzionalità di fusione alle tue applicazioni Python via .NET per combinare efficientemente più file.
      
      1. Fornisci il percorso del primo file HTML.
