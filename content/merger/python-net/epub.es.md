...
############################# Head ############################
head_title: "Combina archivos EPUB a través de Python via .NET"
head_description: "Integra la fusión de documentos EPUB sin problemas en tus proyectos de Python con GroupDocs.Merger for Python via .NET."

############################# Header ############################
title: "Combina archivos EPUB" 
description: "Optimiza el procesamiento de documentos en tus aplicaciones Python con GroupDocs.Merger for Python via .NET, permitiendo una fusión rápida y eficiente de archivos EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/python-net/) facilita la fusión de documentos EPUB. Añade capacidades de fusión a tus aplicaciones Python via .NET para combinar eficientemente múltiples archivos.
      
      1. Proporciona la ruta al primer archivo EPUB.
    ...
    code:
      ...
      content: |
        ...
        # Inicializa Merger con el documento EPUB de origen
