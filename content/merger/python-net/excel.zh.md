...
############################# Head ############################
head_title: "通过 Python via .NET 合并 EXCEL 文件"
head_description: "使用 GroupDocs.Merger for Python via .NET 无缝集成 EXCEL 文档合并到您的 Python 项目中。"

############################# Header ############################
title: "合并 EXCEL 文件" 
description: "通过 GroupDocs.Merger for Python via .NET 简化您 Python 应用程序中的文档处理，快速高效地执行 EXCEL 文件合并。"
...
steps:
    ...
    title: "如何合并 EXCEL 文档"
    content: |
      [GroupDocs.Merger](/merger/python-net/) 让合并 EXCEL 文档变得简单。将合并功能添加到您的 Python via .NET 应用程序中，以高效地组合多个文件。
