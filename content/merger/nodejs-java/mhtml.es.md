...
############################# Head ############################
head_title: "Fusionar archivos MHTML a través de Node.js via Java"
head_description: "Integra la fusión de documentos MHTML en tus proyectos de Node.js utilizando GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Fusionar archivos MHTML" 
description: "Aprovecha GroupDocs.Merger for Node.js via Java para construir aplicaciones Node.js eficientes que fusionen y gestionen documentos MHTML sin problemas."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifica la fusión de documentos MHTML. Integra la funcionalidad de fusión en tus aplicaciones Node.js via Java y combina múltiples archivos sin dificultad.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el documento MHTML de entrada
