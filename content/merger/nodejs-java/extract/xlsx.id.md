...
############################# Head ############################
head_title: "Ekstrak Halaman XLSX di Node.js via Java"
head_description: "Ekstrak halaman tertentu dari file XLSX menggunakan GroupDocs.Merger for Node.js via Java dan simpan sebagai dokumen baru."

############################# Header ############################
title: "Ekstrak Halaman XLSX" 
description: "Gunakan GroupDocs.Merger for Node.js via Java untuk meningkatkan aplikasi Node.js Anda dengan fitur ekstraksi halaman canggih untuk dokumen XLSX."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) memudahkan untuk mengekstrak halaman dari dokumen XLSX. Tambahkan pengolahan dokumen yang mulus ke aplikasi Node.js via Java Anda.
      
      1. Berikan jalur file dari dokumen sumber XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ekstrak halaman tertentu dari dokumen"
      content: |
        Contoh ini menunjukkan cara mengekstrak rentang halaman yang dipilih dari file XLSX dan menyimpannya sebagai dokumen baru.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
