...
############################# Head ############################
head_title: "Extract EXCEL pages in Node.js via Java"
head_description: "Easily extract specific pages from a EXCEL file using GroupDocs.Merger for Node.js via Java and save them as a new document."

############################# Header ############################
title: "Extract EXCEL pages" 
description: "Use GroupDocs.Merger for Node.js via Java to enhance your Node.js applications with advanced page extraction features for EXCEL documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to extract pages from EXCEL documents. Add seamless document processing to your Node.js via Java applications.
      
      1. Provide the file path of the source EXCEL document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example demonstrates how to extract a selected range of pages from a EXCEL file and save them as a new document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
