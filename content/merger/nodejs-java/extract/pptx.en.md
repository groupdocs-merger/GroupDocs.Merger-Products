...
############################# Head ############################
head_title: "Extract PPTX pages in Node.js via Java"
head_description: "Easily extract specific pages from a PPTX file using GroupDocs.Merger for Node.js via Java and save them as a new document."

############################# Header ############################
title: "Extract PPTX pages" 
description: "Use GroupDocs.Merger for Node.js via Java to enhance your Node.js applications with advanced page extraction features for PPTX documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to extract pages from PPTX documents. Add seamless document processing to your Node.js via Java applications.
