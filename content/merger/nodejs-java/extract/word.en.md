...
############################# Head ############################
head_title: "Extract WORD pages in Node.js via Java"
head_description: "Easily extract specific pages from a WORD file using GroupDocs.Merger for Node.js via Java and save them as a new document."

############################# Header ############################
title: "Extract WORD pages" 
description: "Use GroupDocs.Merger for Node.js via Java to enhance your Node.js applications with advanced page extraction features for WORD documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to extract pages from WORD documents. Add seamless document processing to your Node.js via Java applications.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract specific pages from a document"
      content: |
        This example demonstrates how to extract a selected range of pages from a WORD file and save them as a new document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
