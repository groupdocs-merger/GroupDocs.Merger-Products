...
############################# Head ############################
head_title: "Trích xuất các trang PPTX trong Node.js via Java"
head_description: "Trích xuất các trang cụ thể từ tệp PPTX bằng cách sử dụng GroupDocs.Merger for Node.js via Java và lưu chúng dưới dạng tài liệu mới."

############################# Header ############################
title: "Trích xuất các trang PPTX" 
description: "Sử dụng GroupDocs.Merger for Node.js via Java để cải thiện các ứng dụng Node.js của bạn với các tính năng trích xuất trang nâng cao cho tài liệu PPTX."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) giúp bạn trích xuất các trang từ tài liệu PPTX. Thêm khả năng xử lý tài liệu liền mạch vào các ứng dụng Node.js via Java của bạn.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Trích xuất các trang cụ thể từ một tài liệu"
      content: |
        Ví dụ này cho thấy cách để trích xuất một dải các trang được chọn từ tệp PPTX và lưu chúng dưới dạng tài liệu mới.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
