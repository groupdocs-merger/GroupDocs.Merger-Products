...
############################# Head ############################
head_title: "Extraire des pages VISIO en Node.js via Java"
head_description: "Extraire des pages spécifiques d'un fichier VISIO en utilisant GroupDocs.Merger for Node.js via Java et les enregistrer en tant que nouveau document."

############################# Header ############################
title: "Extraire des pages VISIO" 
description: "Utilisez GroupDocs.Merger for Node.js via Java pour améliorer vos applications Node.js avec des fonctionnalités avancées d'extraction de pages pour les documents VISIO."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifie l'extraction de pages à partir de documents VISIO. Ajoutez un traitement de documents fluide à vos applications Node.js via Java.
      
      1. Fournissez le chemin du fichier du document VISIO source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire des pages spécifiques d'un document"
      content: |
        Cet exemple démontre comment extraire une plage sélectionnée de pages d'un fichier VISIO et les enregistrer en tant que nouveau document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
