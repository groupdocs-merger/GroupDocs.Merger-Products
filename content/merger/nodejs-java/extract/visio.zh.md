...
############################# Head ############################
head_title: "在 Node.js via Java 中提取 VISIO 页"
head_description: "使用 GroupDocs.Merger for Node.js via Java 从 VISIO 文件中提取特定页面，并将其保存为新文档。"

############################# Header ############################
title: "提取 VISIO 页" 
description: "使用 GroupDocs.Merger for Node.js via Java 为您的 Node.js 应用程序增强先进的页面提取功能，适用于 VISIO 文档。"
...
steps:
    ...
    title: "如何提取 VISIO 页"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) 使提取 VISIO 文档中的页面变得简单。为您的 Node.js via Java 应用程序添加无缝的文档处理。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从文档中提取特定页面"
      content: |
        此示例演示如何从 VISIO 文件中提取选定范围的页面并将其保存为新文档。
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
