...
############################# Head ############################
head_title: "Extrahieren von EPUB-Seiten in Node.js via Java"
head_description: "Extrahieren Sie gezielt bestimmte Seiten aus einer EPUB-Datei mit GroupDocs.Merger for Node.js via Java und speichern Sie diese als neues Dokument."

############################# Header ############################
title: "Extrahieren von EPUB-Seiten" 
description: "Nutzen Sie GroupDocs.Merger for Node.js via Java, um Ihre Node.js-Anwendungen mit fortschrittlichen Seitenextraktionsfunktionen für EPUB-Dokumente zu bereichern."
...
steps:
    enable: true
    title: "So extrahieren Sie EPUB-Seiten"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) vereinfacht das Extrahieren von Seiten aus EPUB-Dokumenten. Fügen Sie Ihrer Node.js via Java-Anwendung eine nahtlose Dokumentenverarbeitung hinzu.
      
      1. Geben Sie den Dateipfad des Quell-EPUB-Dokuments an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Spezifische Seiten aus einem Dokument extrahieren"
      content: |
        Dieses Beispiel zeigt, wie man einen ausgewählten Seitenbereich aus einer EPUB-Datei extrahiert und als neues Dokument speichert.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
