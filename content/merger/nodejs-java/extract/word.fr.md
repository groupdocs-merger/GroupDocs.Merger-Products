...
############################# Head ############################
head_title: "Extraire des pages WORD en Node.js via Java"
head_description: "Extraire des pages spécifiques d'un fichier WORD en utilisant GroupDocs.Merger for Node.js via Java et les enregistrer en tant que nouveau document."

############################# Header ############################
title: "Extraire des pages WORD" 
description: "Utilisez GroupDocs.Merger for Node.js via Java pour améliorer vos applications Node.js avec des fonctionnalités avancées d'extraction de pages pour les documents WORD."
...
steps:
    enable: true
    title: "Comment extraire des pages WORD"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifie l'extraction de pages à partir de documents WORD. Ajoutez un traitement de documents fluide à vos applications Node.js via Java.
      
      1. Fournissez le chemin du fichier du document WORD source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire des pages spécifiques d'un document"
      content: |
        Cet exemple démontre comment extraire une plage sélectionnée de pages d'un fichier WORD et les enregistrer en tant que nouveau document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
