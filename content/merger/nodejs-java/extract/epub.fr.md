...
############################# Head ############################
head_title: "Extraire des pages EPUB en Node.js via Java"
head_description: "Extraire des pages spécifiques d'un fichier EPUB en utilisant GroupDocs.Merger for Node.js via Java et les enregistrer en tant que nouveau document."

############################# Header ############################
title: "Extraire des pages EPUB" 
description: "Utilisez GroupDocs.Merger for Node.js via Java pour améliorer vos applications Node.js avec des fonctionnalités avancées d'extraction de pages pour les documents EPUB."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifie l'extraction de pages à partir de documents EPUB. Ajoutez un traitement de documents fluide à vos applications Node.js via Java.
      
      1. Fournissez le chemin du fichier du document EPUB source.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire des pages spécifiques d'un document"
      content: |
        Cet exemple démontre comment extraire une plage sélectionnée de pages d'un fichier EPUB et les enregistrer en tant que nouveau document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
