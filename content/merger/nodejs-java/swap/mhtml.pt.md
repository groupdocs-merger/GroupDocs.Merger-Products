...
############################# Head ############################
head_title: "Troque páginas em arquivos MHTML com aplicativos Node.js via Java"
head_description: "Use GroupDocs.Merger for Node.js via Java para modificar a ordem das páginas em documentos MHTML. Gerencie PDFs, arquivos do Word, planilhas, apresentações, imagens e muito mais."

############################# Header ############################
title: "Troque páginas MHTML" 
description: "GroupDocs.Merger for Node.js via Java adiciona recursos avançados de edição de documentos às aplicações Node.js. Reordene páginas em arquivos MHTML para melhorar a estrutura e a legibilidade."
...
steps:
    enable: true
    title: "Como reorganizar páginas MHTML"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) facilita a reorganização das páginas em documentos MHTML, oferecendo total controle sobre a organização do documento. Integre a edição eficiente de documentos em suas aplicações Node.js via Java.
      
      1. Especifique o caminho do arquivo para o documento MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Troque a primeira e a última páginas em um arquivo MHTML"
      content: |
        Este exemplo mostra como trocar páginas em um arquivo MHTML em apenas algumas etapas.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
