...
############################# Head ############################
head_title: "Seiten in XLSX-Dateien mit Node.js via Java-Anwendungen tauschen"
head_description: "Verwenden Sie GroupDocs.Merger for Node.js via Java, um die Seitenreihenfolge in XLSX-Dokumenten zu ändern. Verwaltet PDFs, Word-Dateien, Tabellenkalkulationen, Präsentationen, Bilder und mehr."

############################# Header ############################
title: "XLSX-Seiten tauschen" 
description: "GroupDocs.Merger for Node.js via Java fügt Node.js-Anwendungen fortschrittliche Dokumentenbearbeitungsfunktionen hinzu. Ordnen Sie Seiten in XLSX-Dateien neu an, um die Struktur und Lesbarkeit zu verbessern."
...
steps:
    enable: true
    title: "Wie man XLSX-Seiten umsortiert"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) erleichtert das Umordnen von Seiten in XLSX-Dokumenten, wodurch Sie volle Kontrolle über die Organisation haben. Integrieren Sie eine effiziente Dokumentenbearbeitung in Ihre Node.js via Java-Anwendungen.
      
      1. Geben Sie den Dateipfad für das XLSX-Dokument an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Die erste und letzte Seite in einer XLSX-Datei tauschen"
      content: |
        Dieses Beispiel zeigt, wie Sie in wenigen Schritten Seiten in einer XLSX-Datei tauschen.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
