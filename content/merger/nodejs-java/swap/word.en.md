...
############################# Head ############################
head_title: "Swap pages in WORD files with Node.js via Java apps"
head_description: "Use GroupDocs.Merger for Node.js via Java to modify the page order in WORD documents. Easily manage PDFs, Word files, spreadsheets, presentations, images, and more."

############################# Header ############################
title: "Swap WORD pages" 
description: "GroupDocs.Merger for Node.js via Java adds advanced document editing features to Node.js applications. Effortlessly reorder pages in WORD files to improve structure and readability."
...
steps:
    enable: true
    title: "How to reorder WORD pages"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to rearrange pages in WORD documents, giving you full control over document organization. Integrate efficient document editing into your Node.js via Java applications.
      
      1. Specify the file path for the WORD document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a WORD file"
      content: |
        This example shows how to swap pages in a WORD file in just a few steps.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
