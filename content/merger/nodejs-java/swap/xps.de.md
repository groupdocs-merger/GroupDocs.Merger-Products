...
############################# Head ############################
head_title: "Seiten in XPS-Dateien mit Node.js via Java-Anwendungen tauschen"
head_description: "Verwenden Sie GroupDocs.Merger for Node.js via Java, um die Seitenreihenfolge in XPS-Dokumenten zu ändern. Verwaltet PDFs, Word-Dateien, Tabellenkalkulationen, Präsentationen, Bilder und mehr."

############################# Header ############################
title: "XPS-Seiten tauschen" 
description: "GroupDocs.Merger for Node.js via Java fügt Node.js-Anwendungen fortschrittliche Dokumentenbearbeitungsfunktionen hinzu. Ordnen Sie Seiten in XPS-Dateien neu an, um die Struktur und Lesbarkeit zu verbessern."
...
steps:
    enable: true
    title: "Wie man XPS-Seiten umsortiert"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) erleichtert das Umordnen von Seiten in XPS-Dokumenten, wodurch Sie volle Kontrolle über die Organisation haben. Integrieren Sie eine effiziente Dokumentenbearbeitung in Ihre Node.js via Java-Anwendungen.
      
      1. Geben Sie den Dateipfad für das XPS-Dokument an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Die erste und letzte Seite in einer XPS-Datei tauschen"
      content: |
        Dieses Beispiel zeigt, wie Sie in wenigen Schritten Seiten in einer XPS-Datei tauschen.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
