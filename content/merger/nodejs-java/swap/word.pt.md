...
############################# Head ############################
head_title: "Troque páginas em arquivos WORD com aplicativos Node.js via Java"
head_description: "Use GroupDocs.Merger for Node.js via Java para modificar a ordem das páginas em documentos WORD. Gerencie PDFs, arquivos do Word, planilhas, apresentações, imagens e muito mais."

############################# Header ############################
title: "Troque páginas WORD" 
description: "GroupDocs.Merger for Node.js via Java adiciona recursos avançados de edição de documentos às aplicações Node.js. Reordene páginas em arquivos WORD para melhorar a estrutura e a legibilidade."
...
steps:
    enable: true
    title: "Como reorganizar páginas WORD"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) facilita a reorganização das páginas em documentos WORD, oferecendo total controle sobre a organização do documento. Integre a edição eficiente de documentos em suas aplicações Node.js via Java.
      
      1. Especifique o caminho do arquivo para o documento WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Troque a primeira e a última páginas em um arquivo WORD"
      content: |
        Este exemplo mostra como trocar páginas em um arquivo WORD em apenas algumas etapas.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
