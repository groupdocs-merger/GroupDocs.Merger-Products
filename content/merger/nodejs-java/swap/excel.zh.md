...
############################# Head ############################
head_title: "在EXCEL文件中交换页面与Node.js via Java应用"
head_description: "使用GroupDocs.Merger for Node.js via Java修改EXCEL文档中的页面顺序。管理PDF、Word文件、电子表格、演示文稿、图像等。"

############################# Header ############################
title: "交换EXCEL页面" 
description: "GroupDocs.Merger for Node.js via Java为Node.js应用程序添加了先进的文档编辑功能。重新排序EXCEL文件中的页面，以改善结构和可读性。"
...
steps:
    ...
    title: "如何重新排序EXCEL页面"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/)使重新排列EXCEL文档中的页面变得简便，为文档组织提供了完全的控制。将高效的文档编辑集成到您的Node.js via Java应用中。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "在EXCEL文件中交换第一页和最后一页"
      content: |
        本示例展示了如何在EXCEL文件中仅用几步交换页面。
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
