...
############################# Head ############################
head_title: "Seiten in PDF-Dateien mit Node.js via Java-Anwendungen tauschen"
head_description: "Verwenden Sie GroupDocs.Merger for Node.js via Java, um die Seitenreihenfolge in PDF-Dokumenten zu ändern. Verwaltet PDFs, Word-Dateien, Tabellenkalkulationen, Präsentationen, Bilder und mehr."

############################# Header ############################
title: "PDF-Seiten tauschen" 
description: "GroupDocs.Merger for Node.js via Java fügt Node.js-Anwendungen fortschrittliche Dokumentenbearbeitungsfunktionen hinzu. Ordnen Sie Seiten in PDF-Dateien neu an, um die Struktur und Lesbarkeit zu verbessern."
...
steps:
    enable: true
    title: "Wie man PDF-Seiten umsortiert"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) erleichtert das Umordnen von Seiten in PDF-Dokumenten, wodurch Sie volle Kontrolle über die Organisation haben. Integrieren Sie eine effiziente Dokumentenbearbeitung in Ihre Node.js via Java-Anwendungen.
      
      1. Geben Sie den Dateipfad für das PDF-Dokument an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Die erste und letzte Seite in einer PDF-Datei tauschen"
      content: |
        Dieses Beispiel zeigt, wie Sie in wenigen Schritten Seiten in einer PDF-Datei tauschen.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
