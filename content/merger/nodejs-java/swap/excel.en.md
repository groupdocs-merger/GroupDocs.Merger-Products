...
############################# Head ############################
head_title: "Swap pages in EXCEL files with Node.js via Java apps"
head_description: "Use GroupDocs.Merger for Node.js via Java to modify the page order in EXCEL documents. Easily manage PDFs, Word files, spreadsheets, presentations, images, and more."

############################# Header ############################
title: "Swap EXCEL pages" 
description: "GroupDocs.Merger for Node.js via Java adds advanced document editing features to Node.js applications. Effortlessly reorder pages in EXCEL files to improve structure and readability."
...
steps:
    enable: true
    title: "How to reorder EXCEL pages"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to rearrange pages in EXCEL documents, giving you full control over document organization. Integrate efficient document editing into your Node.js via Java applications.
      
      1. Specify the file path for the EXCEL document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Swap the first and last pages in a EXCEL file"
      content: |
        This example shows how to swap pages in a EXCEL file in just a few steps.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
