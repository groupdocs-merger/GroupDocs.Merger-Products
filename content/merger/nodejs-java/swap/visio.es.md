...
############################# Head ############################
head_title: "Intercambiar páginas en archivos VISIO con aplicaciones Node.js via Java"
head_description: "Utiliza GroupDocs.Merger for Node.js via Java para modificar el orden de las páginas en documentos VISIO. Administra PDFs, archivos de Word, hojas de cálculo, presentaciones, imágenes y más."

############################# Header ############################
title: "Intercambiar páginas VISIO" 
description: "GroupDocs.Merger for Node.js via Java añade funciones avanzadas de edición de documentos a aplicaciones Node.js. Reordena las páginas en archivos VISIO sin esfuerzo para mejorar la estructura y la legibilidad."
...
steps:
    enable: true
    title: "Cómo reordenar páginas VISIO"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) facilita la reorganización de páginas en documentos VISIO, brindándote un control total sobre la organización del documento. Integra edición de documentos eficiente en tus aplicaciones Node.js via Java.
      
      1. Especifica la ruta del archivo para el documento VISIO.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Intercambiar la primera y última página en un archivo VISIO"
      content: |
        Este ejemplo muestra cómo intercambiar páginas en un archivo VISIO en solo unos pocos pasos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
