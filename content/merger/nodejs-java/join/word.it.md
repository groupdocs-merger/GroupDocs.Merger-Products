...
############################# Head ############################
head_title: "Unisci file WORD in JavaScript"
head_description: "Integra l'unione dei file WORD nei tuoi progetti Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unisci file WORD" 
description: "GroupDocs.Merger for Node.js via Java ti consente di unire senza soluzione di continuità documenti WORD all'interno delle tue applicazioni Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) offre un'unione fluida per documenti WORD. Migliora le tue applicazioni Node.js via Java combinando più file in uno.
      
      1. Imposta il percorso per il primo documento WORD.
    ...
    code:
      ...
      content: |
        ...
        // Inizializza Merger con il file WORD di input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da diversi formati di file"
      content: |
        Questo esempio mostra come unire file WORD selezionando pagine specifiche da altri tipi di documento.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
