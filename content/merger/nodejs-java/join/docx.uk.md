...
############################# Head ############################
head_title: "Об'єднайте файли DOCX в JavaScript"
head_description: "Інтегруйте об'єднання файлів DOCX у свої проєкти Node.js за допомогою GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Об'єднання файлів DOCX" 
description: "GroupDocs.Merger for Node.js via Java дозволяє безперешкодно об'єднувати документи DOCX у ваших додатках Node.js."
...
steps:
    enable: true
    title: "Як об'єднати документи DOCX"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) забезпечує безперешкодне об'єднання документів DOCX. Покращте свої додатки Node.js via Java шляхом об'єднання кількох файлів в один.
      
      1. Встановіть шлях до першого документа DOCX.
    ...
    code:
      ...
      content: |
        ...
        // Ініціалізуйте Merger з вхідним файлом DOCX
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання вибраних сторінок з різних форматів файлів"
      content: |
        Цей приклад показує, як об'єднати файли DOCX, вибираючи конкретні сторінки з інших типів документів.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
