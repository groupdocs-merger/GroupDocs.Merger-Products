...
############################# Head ############################
head_title: "Ghép các tệp ZIP trong JavaScript"
head_description: "Tích hợp việc ghép tệp ZIP vào các dự án Node.js của bạn với GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Ghép các tệp ZIP" 
description: "GroupDocs.Merger for Node.js via Java cho phép bạn ghép các tài liệu ZIP một cách liền mạch trong các ứng dụng Node.js của bạn."
...
steps:
    enable: true
    title: "Cách ghép các tài liệu ZIP"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) cung cấp việc ghép liền mạch cho các tài liệu ZIP. Nâng cao ứng dụng Node.js via Java của bạn bằng cách kết hợp nhiều tệp thành một.
    ...
    code:
      ...
      content: |
        ...
        // Khởi tạo Merger với tệp ZIP đầu vào
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ghép các trang được chọn từ các định dạng tệp khác nhau"
      content: |
        Ví dụ này cho thấy cách ghép các tệp ZIP trong khi chọn các trang cụ thể từ các loại tài liệu khác.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
