...
############################# Head ############################
head_title: "Junte arquivos JPG em JavaScript"
head_description: "Integre a junção de arquivos JPG rapidamente em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Junte arquivos JPG" 
description: "GroupDocs.Merger for Node.js via Java permite que você una documentos JPG de forma eficiente dentro de suas aplicações Node.js."
...
steps:
    enable: true
    title: "Como unir documentos JPG"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece junção sem interrupções para documentos JPG. Melhore suas aplicações Node.js via Java combinando vários arquivos em um.
      
      1. Defina o caminho para o primeiro documento JPG.
    ...
    code:
      ...
      content: |
        ...
        // Inicialize Merger com o arquivo de entrada JPG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Una páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo demonstra como unir arquivos JPG selecionando páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
