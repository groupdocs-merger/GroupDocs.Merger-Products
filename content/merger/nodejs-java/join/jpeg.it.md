...
############################# Head ############################
head_title: "Unisci file JPEG in JavaScript"
head_description: "Integra l'unione dei file JPEG nei tuoi progetti Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unisci file JPEG" 
description: "GroupDocs.Merger for Node.js via Java ti consente di unire senza soluzione di continuità documenti JPEG all'interno delle tue applicazioni Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) offre un'unione fluida per documenti JPEG. Migliora le tue applicazioni Node.js via Java combinando più file in uno.
      
      1. Imposta il percorso per il primo documento JPEG.
    ...
    code:
      ...
      content: |
        ...
        // Inizializza Merger con il file JPEG di input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unisci pagine selezionate da diversi formati di file"
      content: |
        Questo esempio mostra come unire file JPEG selezionando pagine specifiche da altri tipi di documento.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
