...
############################# Head ############################
head_title: "Join XPS files in JavaScript"
head_description: "Easily integrate XPS file joining into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Join XPS files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly join XPS documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless joining for XPS documents. Enhance your Node.js via Java applications by combining multiple files into one.
      
      1. Set the path to the first XPS document.
    ...
    code:
      ...
      content: |
        ...
        // Initialize Merger with the input XPS file
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different file formats"
      content: |
        This example shows how to join XPS files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
