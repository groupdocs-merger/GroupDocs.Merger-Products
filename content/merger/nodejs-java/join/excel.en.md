...
############################# Head ############################
head_title: "Join EXCEL files in JavaScript"
head_description: "Easily integrate EXCEL file joining into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Join EXCEL files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly join EXCEL documents within your Node.js applications."
...
steps:
    enable: true
    title: "How to join EXCEL documents"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless joining for EXCEL documents. Enhance your Node.js via Java applications by combining multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Join selected pages from different file formats"
      content: |
        This example shows how to join EXCEL files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
