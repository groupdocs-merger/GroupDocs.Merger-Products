...
############################# Head ############################
head_title: "Об'єднайте файли TIFF в JavaScript"
head_description: "Інтегруйте об'єднання файлів TIFF у свої проєкти Node.js за допомогою GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Об'єднання файлів TIFF" 
description: "GroupDocs.Merger for Node.js via Java дозволяє безперешкодно об'єднувати документи TIFF у ваших додатках Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) забезпечує безперешкодне об'єднання документів TIFF. Покращте свої додатки Node.js via Java шляхом об'єднання кількох файлів в один.
      
      1. Встановіть шлях до першого документа TIFF.
    ...
    code:
      ...
      content: |
        ...
        // Ініціалізуйте Merger з вхідним файлом TIFF
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Об'єднання вибраних сторінок з різних форматів файлів"
      content: |
        Цей приклад показує, як об'єднати файли TIFF, вибираючи конкретні сторінки з інших типів документів.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
