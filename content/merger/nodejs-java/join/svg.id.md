...
############################# Head ############################
head_title: "Gabungkan file SVG dalam JavaScript"
head_description: "Integrasikan penggabungan file SVG ke dalam proyek Node.js Anda dengan GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Gabungkan file SVG" 
description: "GroupDocs.Merger for Node.js via Java memungkinkan Anda untuk dengan mudah menggabungkan dokumen SVG dalam aplikasi Node.js Anda."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) memberikan penggabungan mulus untuk dokumen SVG. Tingkatkan aplikasi Node.js via Java Anda dengan menggabungkan beberapa file menjadi satu.
    ...
    code:
      ...
      content: |
        ...
        // Inisialisasi Merger dengan file input SVG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Gabungkan halaman terpilih dari format file yang berbeda"
      content: |
        Contoh ini menunjukkan cara menggabungkan file SVG sambil memilih halaman tertentu dari jenis dokumen lain.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
