...
############################# Head ############################
head_title: "Unir archivos TXT en JavaScript"
head_description: "Integra la unión de archivos TXT en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unir archivos TXT" 
description: "GroupDocs.Merger for Node.js via Java te permite unir documentos TXT de manera fluida dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona una unión fluida para documentos TXT. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno.
      
      1. Establece la ruta al primer documento TXT.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada TXT
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo unir archivos TXT mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
