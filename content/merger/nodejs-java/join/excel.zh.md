...
############################# Head ############################
head_title: "在JavaScript中合并EXCEL文件"
head_description: "将EXCEL文件合并轻松集成到您的Node.js项目中，使用GroupDocs.Merger for Node.js via Java。"

############################# Header ############################
title: "合并EXCEL文件" 
description: "GroupDocs.Merger for Node.js via Java使您能够在Node.js应用程序中无缝合并EXCEL文档。"
...
steps:
    ...
    title: "如何合并EXCEL文档"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) 提供EXCEL文档的无缝合并。通过将多个文件合并为一个，提升您的Node.js via Java应用程序。 
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从不同文件格式中合并选定页面"
      content: |
        此示例展示了如何在选择其他文档类型的特定页面时合并EXCEL文件。
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
