...
############################# Head ############################
head_title: "Junte arquivos XPS em JavaScript"
head_description: "Integre a junção de arquivos XPS rapidamente em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Junte arquivos XPS" 
description: "GroupDocs.Merger for Node.js via Java permite que você una documentos XPS de forma eficiente dentro de suas aplicações Node.js."
...
steps:
    enable: true
    title: "Como unir documentos XPS"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece junção sem interrupções para documentos XPS. Melhore suas aplicações Node.js via Java combinando vários arquivos em um.
      
      1. Defina o caminho para o primeiro documento XPS.
    ...
    code:
      ...
      content: |
        ...
        // Inicialize Merger com o arquivo de entrada XPS
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Una páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo demonstra como unir arquivos XPS selecionando páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
