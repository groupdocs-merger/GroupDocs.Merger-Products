...
############################# Head ############################
head_title: "Unir archivos HTML en JavaScript"
head_description: "Integra la unión de archivos HTML en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unir archivos HTML" 
description: "GroupDocs.Merger for Node.js via Java te permite unir documentos HTML de manera fluida dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona una unión fluida para documentos HTML. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo unir archivos HTML mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
