...
############################# Head ############################
head_title: "Unir archivos MHTML en JavaScript"
head_description: "Integra la unión de archivos MHTML en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unir archivos MHTML" 
description: "GroupDocs.Merger for Node.js via Java te permite unir documentos MHTML de manera fluida dentro de tus aplicaciones Node.js."
...
steps:
    enable: true
    title: "Cómo unir documentos MHTML"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona una unión fluida para documentos MHTML. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno.
      
      1. Establece la ruta al primer documento MHTML.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada MHTML
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo unir archivos MHTML mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
