...
############################# Head ############################
head_title: "Junte arquivos MHTML em JavaScript"
head_description: "Integre a junção de arquivos MHTML rapidamente em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Junte arquivos MHTML" 
description: "GroupDocs.Merger for Node.js via Java permite que você una documentos MHTML de forma eficiente dentro de suas aplicações Node.js."
...
steps:
    enable: true
    title: "Como unir documentos MHTML"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece junção sem interrupções para documentos MHTML. Melhore suas aplicações Node.js via Java combinando vários arquivos em um.
      
      1. Defina o caminho para o primeiro documento MHTML.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Una páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo demonstra como unir arquivos MHTML selecionando páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
