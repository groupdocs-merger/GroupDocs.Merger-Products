...
############################# Head ############################
head_title: "DOCX-Dateien in JavaScript zusammenführen"
head_description: "Integrieren Sie das Zusammenführen von DOCX-Dateien in Ihre Node.js-Projekte mit GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "DOCX-Dateien zusammenführen" 
description: "GroupDocs.Merger for Node.js via Java ermöglicht es Ihnen, DOCX-Dokumente nahtlos in Ihren Node.js-Anwendungen zusammenzuführen."
...
steps:
    enable: true
    title: "DOCX-Dokumente zusammenführen"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) ermöglicht eine nahtlose Zusammenführung von DOCX-Dokumenten. Verbessern Sie Ihre Node.js via Java-Anwendungen, indem Sie mehrere Dateien in einer zusammenfassen.
      
      1. Den Pfad zum ersten DOCX-Dokument festlegen.
    ...
    code:
      ...
      content: |
        ...
        // Merger mit der Eingabedatei DOCX initialisieren
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus verschiedenen Dateiformaten zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie man DOCX-Dateien zusammenführt, während spezifische Seiten aus anderen Dokumenttypen ausgewählt werden.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
