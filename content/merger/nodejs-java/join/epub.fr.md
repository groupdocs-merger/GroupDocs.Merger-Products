...
############################# Head ############################
head_title: "Fusionner des fichiers EPUB en JavaScript"
head_description: "Intégrez la fusion de fichiers EPUB dans vos projets Node.js avec GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Fusionner des fichiers EPUB" 
description: "GroupDocs.Merger for Node.js via Java vous permet de fusionner sans effort des documents EPUB au sein de vos applications Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permet une fusion fluide pour les documents EPUB. Améliorez vos applications Node.js via Java en combinant plusieurs fichiers en un seul.
      
      1. Définissez le chemin du premier document EPUB.
    ...
    code:
      ...
      content: |
        ...
        // Initialisez Merger avec le fichier EPUB d'entrée
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionner des pages sélectionnées de différents formats de fichiers"
      content: |
        Cet exemple montre comment fusionner des fichiers EPUB tout en sélectionnant des pages spécifiques d'autres types de documents.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
