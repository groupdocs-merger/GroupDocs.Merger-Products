...
############################# Head ############################
head_title: "Unir archivos ZIP en JavaScript"
head_description: "Integra la unión de archivos ZIP en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unir archivos ZIP" 
description: "GroupDocs.Merger for Node.js via Java te permite unir documentos ZIP de manera fluida dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona una unión fluida para documentos ZIP. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno.
      
      1. Establece la ruta al primer documento ZIP.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada ZIP
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Unir páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo unir archivos ZIP mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
