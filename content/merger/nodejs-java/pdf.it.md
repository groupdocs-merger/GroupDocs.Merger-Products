...
############################# Head ############################
head_title: "Unisci file PDF tramite Node.js via Java"
head_description: "Integra la fusione di documenti PDF nei tuoi progetti Node.js utilizzando GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unisci file PDF" 
description: "Sfrutta GroupDocs.Merger for Node.js via Java per costruire applicazioni efficienti Node.js che uniscono e gestiscono documenti PDF senza soluzione di continuità."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) semplifica la fusione di documenti PDF. Integra la funzionalità di fusione nelle tue applicazioni Node.js via Java e combina più file senza difficoltà.
      
      1. Specifica il percorso del primo file PDF.
    ...
    code:
      ...
      content: |
        ...
        // Inizializza Merger con il documento PDF di input
