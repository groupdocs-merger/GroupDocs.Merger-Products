...
############################# Head ############################
head_title: "Node.js via Javaを使用してPOWERPOINTファイルをマージ"
head_description: "GroupDocs.Merger for Node.js via Javaを使用してNode.jsプロジェクトにPOWERPOINTドキュメントのマージを統合します。"

############################# Header ############################
title: "POWERPOINTファイルのマージ" 
description: "GroupDocs.Merger for Node.js via Javaを活用して、Node.jsアプリケーションでPOWERPOINTドキュメントをシームレスにマージ・管理します。"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/)はPOWERPOINTドキュメントのマージを簡素化します。マージ機能をNode.js via Javaアプリケーションに統合して、複数のファイルを簡単に組み合わせます。
    ...
    code:
      ...
      content: |
        ...
        // 入力POWERPOINTドキュメントでMergerを初期化します
