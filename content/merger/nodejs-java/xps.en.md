...
############################# Head ############################
head_title: "Merge XPS files via Node.js via Java"
head_description: "Easily integrate XPS document merging into your Node.js projects using GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge XPS files" 
description: "Leverage GroupDocs.Merger for Node.js via Java to build efficient Node.js applications that merge and manage XPS documents seamlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifies merging XPS documents. Integrate merging functionality into your Node.js via Java applications and combine multiple files effortlessly.
