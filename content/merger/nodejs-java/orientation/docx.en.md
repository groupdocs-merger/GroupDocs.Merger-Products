...
############################# Head ############################
head_title: "Set DOCX page orientation in Node.js via Java apps"
head_description: "GroupDocs.Merger for Node.js via Java lets you switch DOCX pages between portrait and landscape. Manage PDFs, Word docs, Excel files, PowerPoint slides, Visio charts, images, archives, and more with precision."

############################# Header ############################
title: "Page orientation for DOCX files" 
description: "GroupDocs.Merger for Node.js via Java adds smart features to Node.js apps. Developers can improve their tools by handling popular formats and setting DOCX page orientations."
...
steps:
    enable: true
    title: "How to set DOCX page orientation"
    content: |
      Use [GroupDocs.Merger](/merger/nodejs-java/) to modify DOCX page layouts. This and other tools bring strong document handling to Node.js via Java apps.
      
      1. Provide the DOCX file path.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Flip the last page in a DOCX file"
      content: |
        Find out how to tally pages in a DOCX document and adjust the last page’s layout.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
