...
############################# Head ############################
head_title: "Defina a orientação da página WORD em aplicativos Node.js via Java"
head_description: "GroupDocs.Merger for Node.js via Java permite alternar páginas WORD entre retrato e paisagem. Gerencie PDFs, documentos do Word, arquivos do Excel, slides do PowerPoint, diagramas do Visio, imagens, arquivos compactados e mais com precisão."

############################# Header ############################
title: "Orientação da página para arquivos WORD" 
description: "GroupDocs.Merger for Node.js via Java adiciona recursos inteligentes aos aplicativos Node.js. Os desenvolvedores podem aprimorar suas ferramentas ao lidar com formatos populares e definir orientações de página WORD."
...
steps:
    enable: true
    title: "Como definir a orientação da página WORD"
    content: |
      Use [GroupDocs.Merger](/merger/nodejs-java/) para modificar layouts de página WORD. Esta e outras ferramentas trazem um forte tratamento de documentos para aplicativos Node.js via Java.
      
      1. Forneça o caminho do arquivo WORD.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Inverta a última página em um arquivo WORD"
      content: |
        Descubra como contar páginas em um documento WORD e ajustar o layout da última página.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
