...
############################# Head ############################
head_title: "Atur orientasi halaman XLSX dalam aplikasi Node.js via Java"
head_description: "GroupDocs.Merger for Node.js via Java memungkinkan Anda mengubah halaman XLSX antara potret dan lanskap. Kelola PDF, dokumen Word, file Excel, slide PowerPoint, diagram Visio, gambar, arsip, dan banyak lagi dengan presisi."

############################# Header ############################
title: "Orientasi halaman untuk file XLSX" 
description: "GroupDocs.Merger for Node.js via Java menambahkan fitur cerdas ke aplikasi Node.js. Pengembang dapat meningkatkan alat mereka dengan menangani format umum dan mengatur orientasi halaman XLSX."
...
steps:
    enable: true
    title: "Cara mengatur orientasi halaman XLSX"
    content: |
      Gunakan [GroupDocs.Merger](/merger/nodejs-java/) untuk memodifikasi tata letak halaman XLSX. Alat ini dan alat lainnya membawa penanganan dokumen yang kuat ke aplikasi Node.js via Java.
      
      1. Berikan jalur file XLSX.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Balik halaman terakhir dalam file XLSX"
      content: |
        Temukan cara untuk menghitung halaman dalam dokumen XLSX dan sesuaikan tata letak halaman terakhir.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
