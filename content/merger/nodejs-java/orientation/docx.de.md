...
############################# Head ############################
head_title: "Seitenorientierung für DOCX in Node.js via Java-Apps einstellen"
head_description: "GroupDocs.Merger for Node.js via Java ermöglicht es, DOCX-Seiten zwischen Hochformat und Querformat zu wechseln. Verwalten Sie PDFs, Word-Dokumente, Excel-Dateien, PowerPoint-Präsentationen, Visio-Diagramme, Bilder, Archive und mehr präzise."

############################# Header ############################
title: "Seitenorientierung für DOCX-Dateien" 
description: "GroupDocs.Merger for Node.js via Java ergänzt Node.js-Apps um intelligente Funktionen. Entwickler können ihre Werkzeuge verbessern, indem sie gängige Formate verarbeiten und die Seitenorientierung für DOCX festlegen."
...
steps:
    enable: true
    title: "So stellen Sie die Seitenorientierung für DOCX ein"
    content: |
      Verwenden Sie [GroupDocs.Merger](/merger/nodejs-java/), um die Seitenlayouts von DOCX zu ändern. Dieses und andere Werkzeuge bieten starke Dokumentenbearbeitung für Node.js via Java-Apps.
      
      1. Geben Sie den Pfad zur DOCX-Datei an.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Letzte Seite in einer DOCX-Datei umdrehen"
      content: |
        Erfahren Sie, wie Sie die Seiten in einem DOCX-Dokument zählen und das Layout der letzten Seite anpassen.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
