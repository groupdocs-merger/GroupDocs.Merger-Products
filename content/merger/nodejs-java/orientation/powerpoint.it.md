...
############################# Head ############################
head_title: "Imposta l'orientamento della pagina POWERPOINT nelle app Node.js via Java"
head_description: "GroupDocs.Merger for Node.js via Java ti consente di alternare le pagine POWERPOINT tra modalità verticale e orizzontale. Gestisci PDF, documenti Word, file Excel, presentazioni PowerPoint, diagrammi Visio, immagini, archivi e altro con precisione."

############################# Header ############################
title: "Orientamento della pagina per file POWERPOINT" 
description: "GroupDocs.Merger for Node.js via Java aggiunge funzionalità avanzate alle app Node.js. Gli sviluppatori possono migliorare i propri strumenti gestendo formati popolari e impostando gli orientamenti delle pagine POWERPOINT."
...
steps:
    enable: true
    title: "Come impostare l'orientamento della pagina POWERPOINT"
    content: |
      Utilizza [GroupDocs.Merger](/merger/nodejs-java/) per modificare i layout delle pagine POWERPOINT. Questo e altri strumenti offrono una gestione dei documenti robusta per le app Node.js via Java.
      
      1. Fornisci il percorso del file POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Capovolgi l'ultima pagina in un file POWERPOINT"
      content: |
        Scopri come contare le pagine in un documento POWERPOINT e regolare il layout dell'ultima pagina.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
