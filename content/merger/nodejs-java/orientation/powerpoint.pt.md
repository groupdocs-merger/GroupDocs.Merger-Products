...
############################# Head ############################
head_title: "Defina a orientação da página POWERPOINT em aplicativos Node.js via Java"
head_description: "GroupDocs.Merger for Node.js via Java permite alternar páginas POWERPOINT entre retrato e paisagem. Gerencie PDFs, documentos do Word, arquivos do Excel, slides do PowerPoint, diagramas do Visio, imagens, arquivos compactados e mais com precisão."

############################# Header ############################
title: "Orientação da página para arquivos POWERPOINT" 
description: "GroupDocs.Merger for Node.js via Java adiciona recursos inteligentes aos aplicativos Node.js. Os desenvolvedores podem aprimorar suas ferramentas ao lidar com formatos populares e definir orientações de página POWERPOINT."
...
steps:
    enable: true
    title: "Como definir a orientação da página POWERPOINT"
    content: |
      Use [GroupDocs.Merger](/merger/nodejs-java/) para modificar layouts de página POWERPOINT. Esta e outras ferramentas trazem um forte tratamento de documentos para aplicativos Node.js via Java.
      
      1. Forneça o caminho do arquivo POWERPOINT.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Inverta a última página em um arquivo POWERPOINT"
      content: |
        Descubra como contar páginas em um documento POWERPOINT e ajustar o layout da última página.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
