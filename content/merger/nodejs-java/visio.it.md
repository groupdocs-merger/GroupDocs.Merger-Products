...
############################# Head ############################
head_title: "Unisci file VISIO tramite Node.js via Java"
head_description: "Integra la fusione di documenti VISIO nei tuoi progetti Node.js utilizzando GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unisci file VISIO" 
description: "Sfrutta GroupDocs.Merger for Node.js via Java per costruire applicazioni efficienti Node.js che uniscono e gestiscono documenti VISIO senza soluzione di continuità."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) semplifica la fusione di documenti VISIO. Integra la funzionalità di fusione nelle tue applicazioni Node.js via Java e combina più file senza difficoltà.
      
      1. Specifica il percorso del primo file VISIO.
    ...
    code:
      ...
      content: |
        ...
        // Inizializza Merger con il documento VISIO di input
