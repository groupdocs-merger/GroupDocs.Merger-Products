...
############################# Head ############################
head_title: "Faire pivoter les pages PDF dans les applications Node.js via Java"
head_description: "Utilisez GroupDocs.Merger for Node.js via Java pour faire pivoter les pages dans les documents PDF. Gérez efficacement des PDF, des fichiers Word, des feuilles Excel, des présentations PowerPoint, des images, des archives et plus encore."

############################# Header ############################
title: "Rotation des pages dans PDF" 
description: "GroupDocs.Merger for Node.js via Java améliore les applications Node.js en ajoutant des fonctionnalités avancées de traitement de documents. Faites pivoter les pages dans les fichiers PDF et travaillez sans effort avec les formats commerciaux populaires."
...
steps:
    ...
    content: |
      Avec [GroupDocs.Merger](/merger/nodejs-java/), vous pouvez faire pivoter les pages dans les documents PDF, ajoutant des fonctionnalités puissantes de gestion des documents aux applications Node.js via Java.
      
      1. Définir le chemin source du fichier PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Faire pivoter toutes les pages PDF numérotées paires"
      content: |
        Cet exemple démontre comment faire pivoter toutes les pages numérotées paires dans un document PDF.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
