...
############################# Head ############################
head_title: "Rotar páginas de XPS en aplicaciones Node.js via Java"
head_description: "Utiliza GroupDocs.Merger for Node.js via Java para rotar páginas en documentos XPS. Gestiona PDFs, archivos de Word, hojas de Excel, presentaciones de PowerPoint, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Rotación de páginas en XPS" 
description: "GroupDocs.Merger for Node.js via Java mejora las aplicaciones Node.js añadiendo funciones avanzadas de procesamiento de documentos. Rota páginas en archivos XPS y trabaja con formatos comerciales populares de manera eficiente."
...
steps:
    ...
    content: |
      Con [GroupDocs.Merger](/merger/nodejs-java/), puedes rotar páginas en documentos XPS, añadiendo capacidades poderosas de gestión de documentos a aplicaciones Node.js via Java.
      
      1. Define la ruta del archivo XPS.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rota todas las páginas de XPS con número par"
      content: |
        Este ejemplo demuestra cómo rotar todas las páginas con número par en un documento XPS.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
