...
############################# Head ############################
head_title: "Xoay trang PDF trong ứng dụng Node.js via Java"
head_description: "Sử dụng GroupDocs.Merger for Node.js via Java để xoay các trang trong tài liệu PDF. Quản lý PDF, tài liệu Word, bảng tính Excel, slide PowerPoint, hình ảnh, lưu trữ và nhiều hơn nữa."

############################# Header ############################
title: "Xoay trang trong PDF" 
description: "GroupDocs.Merger for Node.js via Java nâng cao ứng dụng Node.js bằng cách thêm các tính năng xử lý tài liệu nâng cao. Xoay các trang trong tệp PDF và làm việc với các định dạng phổ biến một cách dễ dàng."
...
steps:
    ...
    content: |
      Với [GroupDocs.Merger](/merger/nodejs-java/), bạn có thể xoay các trang trong tài liệu PDF, thêm các khả năng quản lý tài liệu mạnh mẽ vào ứng dụng Node.js via Java.
      
      1. Xác định đường dẫn nguồn của tệp PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Xoay tất cả trang số chẵn của PDF"
      content: |
        Ví dụ này mô tả cách xoay tất cả các trang số chẵn trong tài liệu PDF.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
