...
############################# Head ############################
head_title: "Поворот страниц PDF в приложениях Node.js via Java"
head_description: "Используйте GroupDocs.Merger for Node.js via Java для поворота страниц в документах PDF. Управляйте PDF, Word файлами, таблицами Excel, слайдами PowerPoint, изображениями, архивами и многое другое."

############################# Header ############################
title: "Поворот страниц в PDF" 
description: "GroupDocs.Merger for Node.js via Java улучшает приложения Node.js, добавляя расширенные функции обработки документов. Поворачивайте страницы в файлах PDF и работайте с популярными бизнес-форматами без лишних усилий."
...
steps:
    ...
    content: |
      С помощью [GroupDocs.Merger](/merger/nodejs-java/) вы можете поворачивать страницы в документах PDF, добавляя мощные возможности управления документами в приложения Node.js via Java.
      
      1. Определите путь исходного файла PDF.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Повернуть все страницы PDF с чётными номерами"
      content: |
        В этом примере показано, как повернуть все страницы с чётными номерами в документе PDF.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
