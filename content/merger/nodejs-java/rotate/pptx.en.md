...
############################# Head ############################
head_title: "Rotate PPTX pages in Node.js via Java apps"
head_description: "Use GroupDocs.Merger for Node.js via Java to rotate pages in PPTX documents. Easily manage PDFs, Word files, Excel sheets, PowerPoint slides, images, archives, and more."

############################# Header ############################
title: "Page rotation in PPTX" 
description: "GroupDocs.Merger for Node.js via Java enhances Node.js applications by adding advanced document processing features. Rotate pages in PPTX files and work with popular business formats effortlessly."
...
steps:
    ...
    content: |
      With [GroupDocs.Merger](/merger/nodejs-java/), you can easily rotate pages in PPTX documents, adding powerful document management capabilities to Node.js via Java applications.
      
      1. Define the source path of the PPTX file.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Rotate all even-numbered PPTX pages"
      content: |
        This example demonstrates how to rotate all even-numbered pages in a PPTX document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
