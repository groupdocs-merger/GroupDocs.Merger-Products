...
############################# Head ############################
head_title: "Remove MHTML pages in Node.js via Java apps"
head_description: "Use GroupDocs.Merger for Node.js via Java to remove specific pages from MHTML documents. Effortlessly process PDFs, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages from MHTML" 
description: "GroupDocs.Merger for Node.js via Java enhances Node.js apps with powerful document processing features, including page removal from MHTML files."
...
steps:
    enable: true
    title: "How to remove pages from MHTML"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to delete pages from MHTML documents. Integrate it into your Node.js via Java applications to enhance document management capabilities.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Remove all even-numbered pages"
      content: |
        Learn how to delete even-numbered pages from a MHTML document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
