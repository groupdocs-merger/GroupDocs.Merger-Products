...
############################# Head ############################
head_title: "Remove POWERPOINT pages in Node.js via Java apps"
head_description: "Use GroupDocs.Merger for Node.js via Java to remove specific pages from POWERPOINT documents. Effortlessly process PDFs, Word, Excel, PowerPoint, images, archives, and more."

############################# Header ############################
title: "Remove pages from POWERPOINT" 
description: "GroupDocs.Merger for Node.js via Java enhances Node.js apps with powerful document processing features, including page removal from POWERPOINT files."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) makes it easy to delete pages from POWERPOINT documents. Integrate it into your Node.js via Java applications to enhance document management capabilities.
