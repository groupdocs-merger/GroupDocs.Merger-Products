...
############################# Head ############################
head_title: "Удаление страниц EXCEL в приложениях Node.js via Java"
head_description: "Используйте GroupDocs.Merger for Node.js via Java для удаления конкретных страниц из документов EXCEL. Эффективная обработка PDF, Word, Excel, PowerPoint, изображений, архивов и других форматов."

############################# Header ############################
title: "Удаление страниц из EXCEL" 
description: "GroupDocs.Merger for Node.js via Java расширяет возможности приложений Node.js с помощью мощных функций обработки документов, включая удаление страниц из файлов EXCEL."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) упрощает процесс удаления страниц из документов EXCEL. Интегрируйте его в свои приложения Node.js via Java, чтобы улучшить возможности управления документами.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Удаление всех четных страниц"
      content: |
        Узнайте, как удалить четные страницы из документа EXCEL.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
