...
############################# Head ############################
head_title: "Rearrange XLSX pages in Node.js via Java"
head_description: "Use GroupDocs.Merger for Node.js via Java to effortlessly change the order of pages in XLSX documents. Process PDF, Word, Excel, PowerPoint, images, and more."

############################# Header ############################
title: "Rearrange pages in XLSX" 
description: "GroupDocs.Merger for Node.js via Java provides Node.js applications with the ability to easily change the order of pages in XLSX documents."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifies the process of moving pages within XLSX documents. Enhance your Node.js via Java applications with advanced document organization capabilities.
      
      1. Specify the path to the XLSX document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Move a page to the last position in a document"
      content: |
        This example demonstrates how to relocate a page to the end of a XLSX document.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
