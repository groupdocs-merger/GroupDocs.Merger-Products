...
############################# Head ############################
head_title: "DOCX 페이지 재배열 (Node.js)"
head_description: "GroupDocs.Merger for Node.js via Java을(를) 사용하여 DOCX 문서의 페이지 순서를 손쉽게 변경하세요. PDF, Word, Excel, PowerPoint, 이미지 등을 처리할 수 있습니다."

############################# Header ############################
title: "DOCX에서 페이지 재배열하기" 
description: "GroupDocs.Merger for Node.js via Java은(는) Node.js 애플리케이션에 DOCX 문서의 페이지 순서를 변경할 수 있는 기능을 제공합니다."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/)은(는) DOCX 문서 내에서 페이지 이동 과정을 단순화합니다. Node.js via Java 애플리케이션을 향상시키고 고급 문서 조직 기능을 활용하세요.
      
      1. DOCX 문서의 경로를 지정합니다.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "문서의 마지막 위치로 페이지 이동"
      content: |
        이 예제는 DOCX 문서의 끝으로 페이지를 이동하는 방법을 보여줍니다.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
