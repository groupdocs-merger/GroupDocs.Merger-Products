...
############################# Head ############################
head_title: "Gabungkan file DOCX melalui Node.js via Java"
head_description: "Integrasikan penggabungan dokumen DOCX ke dalam proyek Node.js Anda menggunakan GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Gabungkan file DOCX" 
description: "Manfaatkan GroupDocs.Merger for Node.js via Java untuk membangun aplikasi Node.js yang efisien yang menggabungkan dan mengelola dokumen DOCX dengan mulus."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) menyederhanakan penggabungan dokumen DOCX. Integrasikan fungsionalitas penggabungan ke dalam aplikasi Node.js via Java Anda dan gabungkan beberapa file dengan lancar.
      
      1. Tentukan jalur ke file DOCX pertama.
