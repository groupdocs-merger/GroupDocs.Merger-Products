...
############################# Head ############################
head_title: "รวมไฟล์ XLSX ใน JavaScript"
head_description: "รวมการจัดการไฟล์ XLSX ให้เข้ากับโปรเจกต์ Node.js ของคุณด้วย GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "รวมไฟล์ XLSX" 
description: "GroupDocs.Merger for Node.js via Java ช่วยให้คุณรวมเอกสาร XLSX ได้อย่างไร้รอยต่อในแอปพลิเคชัน Node.js ของคุณ."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) ให้การรวมเอกสาร XLSX ที่ไร้รอยต่อ เพิ่มประสิทธิภาพแอปพลิเคชัน Node.js via Java ของคุณโดยการรวมหลายไฟล์เข้าด้วยกัน.
      
      1. ตั้งค่าพาธไปยังเอกสาร XLSX แรก.
      2. เลือกเอกสารที่สอง.
    ...
    code:
      ...
      content: |
        ...
        // เริ่มต้น Merger พร้อมไฟล์อินพุต XLSX
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "รวมหน้าที่เลือกจากไฟล์รูปแบบต่างๆ"
      content: |
        ตัวอย่างนี้แสดงให้เห็นว่าคุณสามารถรวมไฟล์ XLSX ขณะเลือกหน้าที่เฉพาะจากเอกสารประเภทอื่นได้อย่างไร.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
