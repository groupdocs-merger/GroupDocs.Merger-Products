...
############################# Head ############################
head_title: "รวมไฟล์ IMAGE ใน JavaScript"
head_description: "รวมการจัดการไฟล์ IMAGE ให้เข้ากับโปรเจกต์ Node.js ของคุณด้วย GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "รวมไฟล์ IMAGE" 
description: "GroupDocs.Merger for Node.js via Java ช่วยให้คุณรวมเอกสาร IMAGE ได้อย่างไร้รอยต่อในแอปพลิเคชัน Node.js ของคุณ."
...
steps:
    enable: true
    title: "วิธีรวมเอกสาร IMAGE"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) ให้การรวมเอกสาร IMAGE ที่ไร้รอยต่อ เพิ่มประสิทธิภาพแอปพลิเคชัน Node.js via Java ของคุณโดยการรวมหลายไฟล์เข้าด้วยกัน.
      
      1. ตั้งค่าพาธไปยังเอกสาร IMAGE แรก.
      2. เลือกเอกสารที่สอง.
    ...
    code:
      ...
      content: |
        ...
        // เริ่มต้น Merger พร้อมไฟล์อินพุต IMAGE
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "รวมหน้าที่เลือกจากไฟล์รูปแบบต่างๆ"
      content: |
        ตัวอย่างนี้แสดงให้เห็นว่าคุณสามารถรวมไฟล์ IMAGE ขณะเลือกหน้าที่เฉพาะจากเอกสารประเภทอื่นได้อย่างไร.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
