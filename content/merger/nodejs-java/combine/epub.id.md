...
############################# Head ############################
head_title: "Gabungkan berkas EPUB dalam JavaScript"
head_description: "Integrasikan penggabungan berkas EPUB ke dalam proyek Node.js Anda dengan GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Gabungkan berkas EPUB" 
description: "GroupDocs.Merger for Node.js via Java memungkinkan Anda untuk dengan lancar menggabungkan dokumen EPUB dalam aplikasi Node.js Anda."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) menyediakan penggabungan mulus untuk dokumen EPUB. Tingkatkan aplikasi Node.js via Java Anda dengan menggabungkan beberapa berkas menjadi satu.
      
      1. Atur jalur ke dokumen EPUB pertama.
    ...
    code:
      ...
      content: |
        ...
        // Inisialisasi Merger dengan berkas EPUB input
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Menggabungkan halaman terpilih dari format berkas yang berbeda"
      content: |
        Contoh ini menunjukkan cara menggabungkan berkas EPUB sambil memilih halaman tertentu dari jenis dokumen lain.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
