...
############################# Head ############################
head_title: "Merge JPEG files in JavaScript"
head_description: "Easily integrate JPEG file merging into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge JPEG files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly merge JPEG documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless merging for JPEG documents. Enhance your Node.js via Java applications by combining multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different file formats"
      content: |
        This example shows how to merge JPEG files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
...
more_operations:
    ...
    items: 
        ...
        - name: "Extract pages"
          operation: "extract"
          link: "/merger/nodejs-java/extract/jpeg/"
          description: "Save selected pages as a separate document"

        # operation loop 3
        - name: "Move pages"
          operation: "move"
          link: "/merger/nodejs-java/move/jpeg/"
          description: "Reposition any page within a document"

        # operation loop 4
        - name: "Remove pages"
          operation: "remove"
          link: "/merger/nodejs-java/remove/jpeg/"
        ...
        - name: "Rotate pages"
          operation: "rotate"
          link: "/merger/nodejs-java/rotate/jpeg/"
          description: "Rotate document pages"

        # operation loop 7
        - name: "Split doc"
          operation: "split"
          link: "/merger/nodejs-java/split/jpeg/"
          description: "Split documents"

        # operation loop 8
        - name: "Swap pages"
          operation: "swap"
          link: "/merger/nodejs-java/swap/jpeg/"
          description: "Swap document pages"

        # operation loop 9
        - name: "Change orientation"
          operation: "orientation"
          link: "/merger/nodejs-java/orientation/jpeg/"
