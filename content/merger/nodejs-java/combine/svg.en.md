...
############################# Head ############################
head_title: "Merge SVG files in JavaScript"
head_description: "Easily integrate SVG file merging into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge SVG files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly merge SVG documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless merging for SVG documents. Enhance your Node.js via Java applications by combining multiple files into one.
