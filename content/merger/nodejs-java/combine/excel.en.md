...
############################# Head ############################
head_title: "Merge EXCEL files in JavaScript"
head_description: "Easily integrate EXCEL file merging into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge EXCEL files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly merge EXCEL documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless merging for EXCEL documents. Enhance your Node.js via Java applications by combining multiple files into one.
      
      1. Set the path to the first EXCEL document.
    ...
    code:
      ...
      content: |
        ...
        // Initialize Merger with the input EXCEL file
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different file formats"
      content: |
        This example shows how to merge EXCEL files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
