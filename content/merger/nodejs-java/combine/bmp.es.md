...
############################# Head ############################
head_title: "Fusionar archivos BMP en JavaScript"
head_description: "Integra la fusión de archivos BMP en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Fusionar archivos BMP" 
description: "GroupDocs.Merger for Node.js via Java te permite fusionar documentos BMP sin problemas dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona fusión sin interrupciones para documentos BMP. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno solo.
      
      1. Establece la ruta al primer documento BMP.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada BMP
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo fusionar archivos BMP mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
