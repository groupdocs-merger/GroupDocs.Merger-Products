...
############################# Head ############################
head_title: "Fusionner des fichiers JPEG dans JavaScript"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permet une fusion fluide des documents JPEG. Améliorez vos applications Node.js via Java en combinant plusieurs fichiers en un seul.
      
      1. Définir le chemin vers le premier document JPEG.
    ...
    code:
      ...
      content: |
        ...
        // Initialiser Merger avec le fichier JPEG d'entrée
