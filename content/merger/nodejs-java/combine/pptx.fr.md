...
############################# Head ############################
head_title: "Fusionner des fichiers PPTX dans JavaScript"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permet une fusion fluide des documents PPTX. Améliorez vos applications Node.js via Java en combinant plusieurs fichiers en un seul.
      
      1. Définir le chemin vers le premier document PPTX.
    ...
    code:
      ...
      content: |
        ...
        // Initialiser Merger avec le fichier PPTX d'entrée
