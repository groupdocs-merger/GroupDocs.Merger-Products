...
############################# Head ############################
head_title: "Fusionner des fichiers IMAGE dans JavaScript"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permet une fusion fluide des documents IMAGE. Améliorez vos applications Node.js via Java en combinant plusieurs fichiers en un seul.
      
      1. Définir le chemin vers le premier document IMAGE.
    ...
    code:
      ...
      content: |
        ...
        // Initialiser Merger avec le fichier IMAGE d'entrée
