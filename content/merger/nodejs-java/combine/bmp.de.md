...
head_description: "GroupDocs.Merger for Node.js via Java integriert das Zusammenführen von BMP-Dateien in Ihre Node.js-Projekte."

############################# Header ############################
title: "BMP-Dateien zusammenführen" 
description: "GroupDocs.Merger for Node.js via Java ermöglicht es Ihnen, BMP-Dokumente nahtlos in Ihren Node.js-Anwendungen zu kombinieren."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) bietet nahtloses Zusammenführen für BMP-Dokumente. Verbessern Sie Ihre Node.js via Java-Anwendungen, indem Sie mehrere Dateien in einer zusammenfassen.
      
      1. Setzen Sie den Pfad zum ersten BMP-Dokument.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ausgewählte Seiten aus verschiedenen Dateiformaten zusammenführen"
      content: |
        Dieses Beispiel zeigt, wie BMP-Dateien zusammengeführt werden, während spezifische Seiten aus anderen Dokumententypen ausgewählt werden.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
