...
############################# Head ############################
head_title: "Mesclar arquivos TXT em JavaScript"
head_description: "Integre a mesclagem de arquivos TXT em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Mesclar arquivos TXT" 
description: "GroupDocs.Merger for Node.js via Java permite que você mescle documentos TXT com facilidade em suas aplicações Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece mesclagem perfeita para documentos TXT. Melhore suas aplicações Node.js via Java combinando vários arquivos em um só.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo mostra como mesclar arquivos TXT enquanto seleciona páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
