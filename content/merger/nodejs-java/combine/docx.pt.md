...
############################# Head ############################
head_title: "Mesclar arquivos DOCX em JavaScript"
head_description: "Integre a mesclagem de arquivos DOCX em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Mesclar arquivos DOCX" 
description: "GroupDocs.Merger for Node.js via Java permite que você mescle documentos DOCX com facilidade em suas aplicações Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece mesclagem perfeita para documentos DOCX. Melhore suas aplicações Node.js via Java combinando vários arquivos em um só.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo mostra como mesclar arquivos DOCX enquanto seleciona páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
