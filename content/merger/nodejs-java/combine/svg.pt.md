...
############################# Head ############################
head_title: "Mesclar arquivos SVG em JavaScript"
head_description: "Integre a mesclagem de arquivos SVG em seus projetos Node.js com GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Mesclar arquivos SVG" 
description: "GroupDocs.Merger for Node.js via Java permite que você mescle documentos SVG com facilidade em suas aplicações Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) oferece mesclagem perfeita para documentos SVG. Melhore suas aplicações Node.js via Java combinando vários arquivos em um só.
      
      1. Defina o caminho para o primeiro documento SVG.
    ...
    code:
      ...
      content: |
        ...
        // Inicialize Merger com o arquivo de entrada SVG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Mesclar páginas selecionadas de diferentes formatos de arquivo"
      content: |
        Este exemplo mostra como mesclar arquivos SVG enquanto seleciona páginas específicas de outros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
