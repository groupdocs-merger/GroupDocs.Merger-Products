...
############################# Head ############################
head_title: "Fusionar archivos SVG en JavaScript"
head_description: "Integra la fusión de archivos SVG en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Fusionar archivos SVG" 
description: "GroupDocs.Merger for Node.js via Java te permite fusionar documentos SVG sin problemas dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona fusión sin interrupciones para documentos SVG. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno solo.
      
      1. Establece la ruta al primer documento SVG.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada SVG
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo fusionar archivos SVG mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
