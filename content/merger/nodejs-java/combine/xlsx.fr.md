...
############################# Head ############################
head_title: "Fusionner des fichiers XLSX dans JavaScript"
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permet une fusion fluide des documents XLSX. Améliorez vos applications Node.js via Java en combinant plusieurs fichiers en un seul.
      
      1. Définir le chemin vers le premier document XLSX.
    ...
    code:
      ...
      content: |
        ...
        // Initialiser Merger avec le fichier XLSX d'entrée
