...
############################# Head ############################
head_title: "Kết hợp các tệp EPUB trong JavaScript"
head_description: "Tích hợp việc hợp nhất tệp EPUB vào các dự án Node.js của bạn với GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Hợp nhất tệp EPUB" 
description: "GroupDocs.Merger for Node.js via Java cho phép bạn hợp nhất các tài liệu EPUB một cách liền mạch trong các ứng dụng Node.js của bạn."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) cung cấp việc hợp nhất liền mạch cho các tài liệu EPUB. Nâng cao các ứng dụng Node.js via Java của bạn bằng cách kết hợp nhiều tệp thành một.
      
      1. Đặt đường dẫn đến tài liệu EPUB đầu tiên.
    ...
    code:
      ...
      content: |
        ...
        // Khởi tạo Merger với tệp đầu vào EPUB
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Hợp nhất các trang đã chọn từ các định dạng tệp khác nhau"
      content: |
        Ví dụ này cho thấy cách hợp nhất các tệp EPUB trong khi chọn các trang cụ thể từ các loại tài liệu khác.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
