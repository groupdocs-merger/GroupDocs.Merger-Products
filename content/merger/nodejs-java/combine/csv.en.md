...
############################# Head ############################
head_title: "Merge CSV files in JavaScript"
head_description: "Easily integrate CSV file merging into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge CSV files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly merge CSV documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless merging for CSV documents. Enhance your Node.js via Java applications by combining multiple files into one.
      
      1. Set the path to the first CSV document.
    ...
    code:
      ...
      content: |
        ...
        // Initialize Merger with the input CSV file
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different file formats"
      content: |
        This example shows how to merge CSV files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
