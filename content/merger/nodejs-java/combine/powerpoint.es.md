...
############################# Head ############################
head_title: "Fusionar archivos POWERPOINT en JavaScript"
head_description: "Integra la fusión de archivos POWERPOINT en tus proyectos de Node.js con GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Fusionar archivos POWERPOINT" 
description: "GroupDocs.Merger for Node.js via Java te permite fusionar documentos POWERPOINT sin problemas dentro de tus aplicaciones Node.js."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) proporciona fusión sin interrupciones para documentos POWERPOINT. Mejora tus aplicaciones Node.js via Java combinando múltiples archivos en uno solo.
      
      1. Establece la ruta al primer documento POWERPOINT.
    ...
    code:
      ...
      content: |
        ...
        // Inicializa Merger con el archivo de entrada POWERPOINT
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Fusionar páginas seleccionadas de diferentes formatos de archivo"
      content: |
        Este ejemplo muestra cómo fusionar archivos POWERPOINT mientras seleccionas páginas específicas de otros tipos de documentos.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
