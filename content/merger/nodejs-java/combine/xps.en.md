...
############################# Head ############################
head_title: "Merge XPS files in JavaScript"
head_description: "Easily integrate XPS file merging into your Node.js projects with GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge XPS files" 
description: "GroupDocs.Merger for Node.js via Java allows you to seamlessly merge XPS documents within your Node.js applications."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) provides seamless merging for XPS documents. Enhance your Node.js via Java applications by combining multiple files into one.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Merge selected pages from different file formats"
      content: |
        This example shows how to merge XPS files while selecting specific pages from other document types.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
