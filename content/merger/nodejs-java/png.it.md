...
############################# Head ############################
head_title: "Unisci file PNG tramite Node.js via Java"
head_description: "Integra la fusione di documenti PNG nei tuoi progetti Node.js utilizzando GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Unisci file PNG" 
description: "Sfrutta GroupDocs.Merger for Node.js via Java per costruire applicazioni efficienti Node.js che uniscono e gestiscono documenti PNG senza soluzione di continuità."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) semplifica la fusione di documenti PNG. Integra la funzionalità di fusione nelle tue applicazioni Node.js via Java e combina più file senza difficoltà.
      
      1. Specifica il percorso del primo file PNG.
    ...
    code:
      ...
      content: |
        ...
        // Inizializza Merger con il documento PNG di input
