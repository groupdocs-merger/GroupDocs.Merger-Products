...
############################# Head ############################
head_title: "Merge EXCEL files via Node.js via Java"
head_description: "Easily integrate EXCEL document merging into your Node.js projects using GroupDocs.Merger for Node.js via Java."

############################# Header ############################
title: "Merge EXCEL files" 
description: "Leverage GroupDocs.Merger for Node.js via Java to build efficient Node.js applications that merge and manage EXCEL documents seamlessly."
...
steps:
    ...
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) simplifies merging EXCEL documents. Integrate merging functionality into your Node.js via Java applications and combine multiple files effortlessly.
