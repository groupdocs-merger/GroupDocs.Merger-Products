...
############################# Head ############################
head_title: "Dividir documentos POWERPOINT en aplicaciones Node.js via Java"
head_description: "Con GroupDocs.Merger for Node.js via Java, descomponga fácilmente archivos POWERPOINT en documentos separados. Trabaje con PDFs, archivos de Word, hojas de Excel, presentaciones de PowerPoint, diagramas de Visio, imágenes, archivos comprimidos y más."

############################# Header ############################
title: "Dividir archivos POWERPOINT" 
description: "GroupDocs.Merger for Node.js via Java agrega potentes características de manipulación de documentos a aplicaciones Node.js. Divida sin problemas archivos POWERPOINT y procese una variedad de formatos ampliamente utilizados."
...
steps:
    enable: true
    title: "Pasos para dividir archivos POWERPOINT"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) le permite dividir documentos POWERPOINT, extrayendo páginas seleccionadas en un nuevo archivo. Integre una gestión eficiente de documentos en sus aplicaciones Node.js via Java.
      
      1. Proporcione la ruta del archivo del documento POWERPOINT original.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraer páginas de número par del documento POWERPOINT"
      content: |
        Este ejemplo demuestra cómo dividir un documento POWERPOINT y guardar solo las páginas de número par como un nuevo archivo.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
