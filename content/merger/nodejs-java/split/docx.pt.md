...
############################# Head ############################
head_title: "Divida documentos DOCX em aplicativos Node.js via Java"
head_description: "Com GroupDocs.Merger for Node.js via Java, você pode dividir arquivos DOCX em documentos separados. Trabalhe com PDFs, arquivos Word, planilhas Excel, apresentações PowerPoint, diagramas Visio, imagens, arquivos compactados e muito mais."

############################# Header ############################
title: "Divida arquivos DOCX" 
description: "GroupDocs.Merger for Node.js via Java adiciona recursos poderosos de manipulação de documentos às aplicações Node.js. Divida arquivos DOCX de forma integrada e processe uma variedade de formatos amplamente usados."
...
steps:
    enable: true
    title: "Passos para dividir arquivos DOCX"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) permite que você divida documentos DOCX, extraindo páginas selecionadas para um novo arquivo. Integre um gerenciamento de documentos eficiente em suas aplicações Node.js via Java.
      
      1. Forneça o caminho do arquivo do documento DOCX original.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extrair páginas de número par do documento DOCX"
      content: |
        Este exemplo demonstra como dividir um documento DOCX e salvar apenas as páginas de número par como um novo arquivo.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
