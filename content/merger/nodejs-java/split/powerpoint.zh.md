...
############################# Head ############################
head_title: "在Node.js via Java应用中拆分POWERPOINT文档"
head_description: "使用GroupDocs.Merger for Node.js via Java，轻松将POWERPOINT文件拆分为单独的文档。处理PDF、Word文件、Excel表格、PowerPoint演示文稿、Visio图表、图像、压缩文件等。"

############################# Header ############################
title: "拆分POWERPOINT文件" 
description: "GroupDocs.Merger for Node.js via Java向Node.js应用程序添加强大的文档处理功能。无缝地拆分POWERPOINT文件，并处理多种广泛使用的格式。"
...
steps:
    enable: true
    title: "拆分POWERPOINT文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) 允许您拆分POWERPOINT文档，将选定的页面提取到新文件中。在您的Node.js via Java应用中集成高效的文档管理。
      
      1. 提供原始POWERPOINT文档的文件路径。
      2. 设置拆分文档将保存的位置。
      3. 定义控制拆分操作的设置。
      4. 处理文件并保存结果。
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "从POWERPOINT文档中提取偶数页"
      content: |
        此示例演示了如何拆分POWERPOINT文档并仅保存偶数页作为新文件。
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
