...
############################# Head ############################
head_title: "Diviser des documents WORD dans des applications Node.js via Java"
head_description: "Avec GroupDocs.Merger for Node.js via Java, décomposez facilement les fichiers WORD en documents séparés. Travaillez avec des PDF, des fichiers Word, des feuilles Excel, des présentations PowerPoint, des diagrammes Visio, des images, des archives et bien plus encore."

############################# Header ############################
title: "Diviser des fichiers WORD" 
description: "GroupDocs.Merger for Node.js via Java ajoute des fonctionnalités puissantes de manipulation de documents aux applications Node.js. Divisez de manière transparente les fichiers WORD et traitez une variété de formats largement utilisés."
...
steps:
    enable: true
    title: "Étapes pour diviser des fichiers WORD"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) vous permet de diviser des documents WORD, en extrayant les pages sélectionnées dans un nouveau fichier. Intégrer une gestion de documents efficace dans vos applications Node.js via Java.
      
      1. Fournissez le chemin du fichier du document WORD original.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extraire les pages de numéro pair du document WORD"
      content: |
        Cet exemple démontre comment diviser un document WORD et enregistrer uniquement les pages de numéro pair en tant que nouveau fichier.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
