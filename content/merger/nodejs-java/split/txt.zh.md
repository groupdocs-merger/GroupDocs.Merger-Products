...
############################# Head ############################
head_title: "在Node.js via Java应用中拆分TXT文档"
head_description: "使用GroupDocs.Merger for Node.js via Java，轻松将TXT文件拆分为单独的文档。处理PDF、Word文件、Excel表格、PowerPoint演示文稿、Visio图表、图像、压缩文件等。"

############################# Header ############################
title: "拆分TXT文件" 
description: "GroupDocs.Merger for Node.js via Java向Node.js应用程序添加强大的文档处理功能。无缝地拆分TXT文件，并处理多种广泛使用的格式。"
...
steps:
    ...
    title: "拆分TXT文件的步骤"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) 允许您拆分TXT文档，将选定的页面提取到新文件中。在您的Node.js via Java应用中集成高效的文档管理。
