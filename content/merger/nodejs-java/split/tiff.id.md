...
############################# Head ############################
head_title: "Pecah dokumen TIFF dalam aplikasi Node.js via Java"
head_description: "Dengan GroupDocs.Merger for Node.js via Java, pecah berkas TIFF menjadi dokumen terpisah. Bekerja dengan PDF, dokumen Word, lembar Excel, presentasi PowerPoint, diagram Visio, gambar, arsip, dan lainnya."

############################# Header ############################
title: "Pecah berkas TIFF" 
description: "GroupDocs.Merger for Node.js via Java menambahkan fitur manipulasi dokumen yang kuat ke aplikasi Node.js. Pisahkan berkas TIFF dengan mulus dan proses berbagai format yang banyak digunakan."
...
steps:
    enable: true
    title: "Langkah-langkah untuk membagi berkas TIFF"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) memungkinkan Anda untuk membagi dokumen TIFF, mengekstrak halaman yang dipilih ke dalam berkas baru. Integrasikan manajemen dokumen yang efisien ke dalam aplikasi Node.js via Java Anda.
      
      1. Sediakan jalur berkas dari dokumen TIFF asli.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Ekstrak halaman nomor genap dari dokumen TIFF"
      content: |
        Contoh ini menunjukkan cara membagi dokumen TIFF dan menyimpan hanya halaman nomor genap sebagai berkas baru.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
