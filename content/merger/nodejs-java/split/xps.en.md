...
############################# Head ############################
head_title: "Split XPS documents in Node.js via Java apps"
head_description: "With GroupDocs.Merger for Node.js via Java, easily break down XPS files into separate documents. Work with PDFs, Word files, Excel sheets, PowerPoint presentations, Visio diagrams, images, archives, and more."

############################# Header ############################
title: "Split XPS files" 
description: "GroupDocs.Merger for Node.js via Java adds powerful document manipulation features to Node.js applications. Seamlessly split XPS files and process a variety of widely used formats."
...
steps:
    enable: true
    title: "Steps to divide XPS files"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) allows you to split XPS documents, extracting selected pages into a new file. Integrate efficient document management into your Node.js via Java applications.
      
      1. Provide the file path of the original XPS document.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Extract even-numbered pages from XPS document"
      content: |
        This sample demonstrates how to split a XPS document and save only even-numbered pages as a new file.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
