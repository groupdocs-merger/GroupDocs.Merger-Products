...
############################# Head ############################
head_title: "Dividi i documenti VISIO nelle app Node.js via Java"
head_description: "Con GroupDocs.Merger for Node.js via Java, suddividi facilmente i file VISIO in documenti separati. Lavora con PDF, file Word, fogli Excel, presentazioni PowerPoint, diagrammi Visio, immagini, archivi e altro."

############################# Header ############################
title: "Dividi file VISIO" 
description: "GroupDocs.Merger for Node.js via Java aggiunge potenti funzionalità di manipolazione dei documenti alle app Node.js. Dividi senza soluzione di continuità i file VISIO e gestisci una varietà di formati ampiamente utilizzati."
...
steps:
    enable: true
    title: "Passaggi per dividere i file VISIO"
    content: |
      [GroupDocs.Merger](/merger/nodejs-java/) consente di dividere i documenti VISIO, estraendo le pagine selezionate in un nuovo file. Integra una gestione documentale efficiente nelle tue applicazioni Node.js via Java.
      
      1. Fornisci il percorso del file del documento VISIO originale.
...
more_features:
  ...
  code_samples_ext:
    ...
    - title: "Estrai pagine con numero pari dal documento VISIO"
      content: |
        Questo esempio dimostra come dividere un documento VISIO e salvare solo le pagine con numero pari come un nuovo file.
      code:
        title: "JavaScript"
        content: |
          ```javascript {style=abap}
