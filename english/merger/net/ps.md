...
steps:
    enable: true
    title_left: "How to Merge Multiple PS Files"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to merge two or more PS files within their applications by implementing a few easy steps.
