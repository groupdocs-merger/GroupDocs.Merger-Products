...
steps:
    ...
    code: |
        ...
        using (Merger merger = new Merger("input.bmp"))
          {
...
demos:
    ...
    content: |
        Extract Image file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/image) website.  
