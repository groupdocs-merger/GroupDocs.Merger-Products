...
############################# Head ############################
head_title: "Extract XLT Pages in C# ASP.NET & VB.NET"
head_description: "Quickly extract pages from a XLT file in C# .NET. Save the new document containing the selected pages using the documents merger API."

############################# Header ############################
title: "Extract XLT Pages In C# .NET Applications"
description: "Quickly extract the selected pages from a XLT file and save it as a new document using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Extract Pages from XLT File in C# .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to extract the desired pages from a XLT file and save it as a new file containing the selected pages by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Extract XLT file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Exract XLT Document Pages App"
    content: |
        Extract XLT file pages right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/xlt) website.
