...
############################# Head ############################
head_title: "Swap & Exchange VSDX Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a VSDX file using the file split API."

############################# Header ############################
title: "Swap VSDX Pages in .NET"
description: "Swap and exchange positions of two pages within a VSDX file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Swap VSDX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Swap VSDX file pages using GroupDocs.Merger API
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    enable: true
    title: "Live Demos - Swap VSDX File Pages Online"
    content: |
        Swap pages within VSDX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/vsdx) website.
