...
############################# Head ############################
head_title: "Swap Image File Pages in C# .NET"
head_description: "C# .NET users to swap and exchange positions of two pages within a Image document using documents merger and split API."

############################# Header ############################
title: "Swap Image File Pages in .NET"
description: "Swap and exchange positions of two pages within a Image document using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Swap Image File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a Image file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Swap Image file pages using GroupDocs.Merger API
        int pageNumber1 = 3;
        int pageNumber2 = 6;
...
demos:
    ...
    content: |
        Swap pages within Image files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
