...
############################# Head ############################
head_title: "Swap & Exchange WORD Pages in C# .NET"
head_description: " C# .NET users to swap and exchange positions of two pages within a WORD file using the file split API."

############################# Header ############################
title: "Swap WORD Pages in .NET"
description: "Swap and exchange positions of two pages within a WORD file using the file splitter API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
demos:
    ...
    content: |
        Swap pages within WORD files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/word) website.
