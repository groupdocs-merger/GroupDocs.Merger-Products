...
############################# Head ############################
head_title: "Swap VTX File Pages in C# .NET"
head_description: "C# .NET users to swap and exchange positions of two pages within a VTX document using documents merger and split API."

############################# Header ############################
title: "Swap VTX File Pages in .NET"
description: "Swap and exchange positions of two pages within a VTX document using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to swap, exchange and organize pages within a VTX file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Swap pages within VTX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
