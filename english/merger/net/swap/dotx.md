...
############################# Head ############################
head_title: "Swap DOTX File Pages in C# .NET"
head_description: "C# .NET users to swap and exchange positions of two pages within a DOTX document using documents merger and split API."

############################# Header ############################
title: "Swap DOTX File Pages in .NET"
description: "Swap and exchange positions of two pages within a DOTX document using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
demos:
    ...
    content: |
        Swap pages within DOTX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
