...
############################# Header ############################
title: "Merge XLT Files In C#"
description: "Merge multiple XLT files into a single file using C# merger API. Merge selected pages or page ranges from various source documents into a single resultant document."
