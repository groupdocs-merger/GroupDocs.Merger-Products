...
############################# Head ############################
head_title: "Merge OTT Files into One in C# (.NET Core) – OTT Merger"
...
############################# Header ############################
title: "Merge OTT Files In C# (.NET Core)"
description: "Merge multiple OTT files into a single file using C# .NET documents merger API. Merge selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to merge two or more OTT files within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Merge more than one OTT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
