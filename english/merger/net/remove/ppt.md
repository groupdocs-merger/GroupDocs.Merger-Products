...
description: "Delere or Remove a single page or collection of pages from a PPT file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
demos:
    ...
    content: |
        Remove pages within PPT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
