...
############################# Head ############################
head_title: "Delete PPT Pages in C# .NET | Remove Pages from PPT File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a PPT file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From PPT in .NET"
description: "Delete or Remove a single page or collection of pages from a PPT file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove PPT File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a PPT file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Remove PPT file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove PPT Document Pages Online"
    content: |
        Remove pages within PPT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppt) website.
