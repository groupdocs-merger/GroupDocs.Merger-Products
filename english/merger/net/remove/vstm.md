...
############################# Head ############################
head_title: "Delete VSTM Pages in C# .NET – Remove Pages from VSTM File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a VSTM file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages from VSTM in .NET"
description: "Delere or Remove a single page or collection of pages from a VSTM file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove VSTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a VSTM file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within VSTM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
