...
############################# Head ############################
head_title: "Delete ODS Pages in C# .NET | Remove Pages from ODS File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a ODS file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From ODS in .NET"
description: "Delete or Remove a single page or collection of pages from a ODS file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove ODS File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a ODS file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Remove ODS Document Pages Online"
    content: |
        Remove pages within ODS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/ods) website.
