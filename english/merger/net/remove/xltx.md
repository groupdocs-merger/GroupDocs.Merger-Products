...
############################# Static ############################
layout: "auto-gen"
date: 2022-03-04T18:47:58
draft: false

############################# Head ############################
head_title: "Delete XLTX Pages in C# .NET | Remove Pages from XLTX File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a XLTX file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From XLTX in .NET"
description: "Delete or Remove a single page or collection of pages from a XLTX file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove XLTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a XLTX file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Remove XLTX file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove XLTX Document Pages Online"
    content: |
        Remove pages within XLTX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xltx) website.
