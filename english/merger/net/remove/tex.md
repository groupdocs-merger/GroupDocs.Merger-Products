...
############################# Head ############################
head_title: "Delete TEX Pages in C# .NET | Remove Pages from TEX File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a TEX file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From TEX in .NET"
description: "Delete or Remove a single page or collection of pages from a TEX file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove TEX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a TEX file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Remove TEX file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove TEX Document Pages Online"
    content: |
        Remove pages within TEX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/tex) website.
