...
############################# Head ############################
head_title: "Delete VSDX Pages in C# .NET | Remove Pages from VSDX File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a VSDX file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From VSDX in .NET"
description: "Delete or Remove a single page or collection of pages from a VSDX file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
