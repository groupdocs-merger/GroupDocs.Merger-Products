...
############################# Static ############################
layout: "auto-gen"
date: 2022-03-04T17:54:38
draft: false

############################# Head ############################
head_title: "Delete PPSM Pages in C# .NET | Remove Pages from PPSM File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a PPSM file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From PPSM in .NET"
description: "Delete or Remove a single page or collection of pages from a PPSM file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove PPSM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a PPSM file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Remove PPSM file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove PPSM Document Pages Online"
    content: |
        Remove pages within PPSM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsm) website.
