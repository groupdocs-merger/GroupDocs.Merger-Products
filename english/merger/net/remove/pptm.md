...
############################# Head ############################
head_title: "Delete PPTM Pages in C# .NET – Remove Pages from PPTM File"
...
steps:
    enable: true
    title_left: "Remove PPTM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a PPTM file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within PPTM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
