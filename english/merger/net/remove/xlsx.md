...
############################# Head ############################
head_title: "Delete XLSX Pages in C# .NET | Remove Pages from XLSX File"
head_description: "C# .NET users to remove or delete a single page or collection of pages from a XLSX file using documents merger and split API."

############################# Header ############################
title: "Delete or Remove Pages From XLSX in .NET"
description: "Delete or Remove a single page or collection of pages from a XLSX file using documents merger & split API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Remove XLSX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to delete a single or a number of pages within a XLSX file by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Remove XLSX file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove XLSX Document Pages Online"
    content: |
        Remove pages within XLSX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/xlsx) website.
