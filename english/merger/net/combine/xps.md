...
############################# Head ############################
head_title: "Combine XPS Files into One in C# (.NET Core) – XPS Merger"
...
############################# Header ############################
title: "Combine XPS Files In C# (.NET Core)"
description: "Combine multiple XPS files into a single file using C# .NET documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more XPS files within their applications by implementing a few easy steps.
