...
############################# Head ############################
head_title: "Combine Word Files into One in C# (.NET Core) – Word Merger"
...
############################# Header ############################
title: "Combine Word Files In C# (.NET Core)"
description: "Combine multiple Word files into a single file using C# .NET documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more Word files within their applications by implementing a few easy steps.
