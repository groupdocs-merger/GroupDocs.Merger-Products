...
############################# Head ############################
head_title: "Combine ODT Files into One in C# (.NET Core) – ODT Merger"
...
############################# Header ############################
title: "Combine ODT Files In C# (.NET Core)"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more ODT files within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Combine more than one ODT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/odt) website.  
