...
############################# Head ############################
head_title: "Combine POTM Files into One in C# (.NET Core) – POTM Merger"
head_description: "Combine multiple POTM files into a single file using C# .NET documents merger API. Combine specific pages or page ranges from various documents to a single document."

############################# Header ############################
title: "Combine POTM Files In C# (.NET Core)"
description: "Combine multiple POTM files into a single file using C# .NET documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    enable: true
    title_left: "How to Combine Multiple POTM Files"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more POTM files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Combine POTM files using GroupDocs.Merger API
