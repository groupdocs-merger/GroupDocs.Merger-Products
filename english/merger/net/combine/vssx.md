...
############################# Head ############################
head_title: "Combine VSSX Files into One in C# (.NET Core) – VSSX Merger"
...
############################# Header ############################
title: "Combine VSSX Files In C# (.NET Core)"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more VSSX files within their applications by implementing a few easy steps.
