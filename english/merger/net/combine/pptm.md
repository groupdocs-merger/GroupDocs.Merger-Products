...
steps:
    enable: true
    title_left: "How to Combine Multiple PPTM Files"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more PPTM files within their applications by implementing a few easy steps.
