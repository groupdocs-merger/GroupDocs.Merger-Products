...
############################# Head ############################
head_title: "Combine OTP Files into One in C# (.NET Core) – OTP Merger"
...
############################# Header ############################
title: "Combine OTP Files In C# (.NET Core)"
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to combine two or more OTP files within their applications by implementing a few easy steps.
