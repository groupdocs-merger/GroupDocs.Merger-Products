...
steps:
    enable: true
    title_left: "Split VSSX File By Pages in C# .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single VSSX file into multiple resultant files by implementing a few easy steps.
