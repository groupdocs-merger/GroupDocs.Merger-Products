...
############################# Static ############################
layout: "auto-gen"
date: 2022-03-05T16:42:16
draft: false

############################# Head ############################
head_title: "Split DOCM into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single DOCM file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split DOCM Into Multiple Files in .NET"
description: "Split a single DOCM file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split DOCM File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single DOCM file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split DOCM file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split DOCM File Online"
    content: |
        Split DOCM file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docm) website.
