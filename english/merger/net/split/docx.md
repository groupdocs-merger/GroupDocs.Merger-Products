...
############################# Head ############################
head_title: "Split DOCX into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single DOCX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split DOCX Into Multiple Files in .NET"
description: "Split a single DOCX file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split DOCX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single DOCX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split DOCX file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split DOCX File Online"
    content: |
        Split DOCX file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/docx) website.
