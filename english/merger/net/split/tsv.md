...
############################# Head ############################
head_title: "Split TSV into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single TSV file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split TSV Into Multiple Files in .NET"
description: "Split a single TSV file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split TSV File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single TSV file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split TSV file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split TSV File Online"
    content: |
        Split TSV file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/tsv) website.
