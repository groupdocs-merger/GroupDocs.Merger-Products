...
steps:
    enable: true
    title_left: "Split Visio File By Pages in C# .NET"
    content_left: |
...
demos:
    ...
    content: |
        Split Visio file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vdx) website.  
