...
############################# Head ############################
head_title: "Split VISIO into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single VISIO file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split VISIO Into Multiple Files in .NET"
description: "Split a single VISIO file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split VISIO File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single VISIO file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split VISIO file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split VISIO File Online"
    content: |
        Split VISIO file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/visio) website.
