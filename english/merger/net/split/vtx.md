...
############################# Head ############################
head_title: "Split VTX into Multiple Files in C# .NET"
head_description: "C# .NET users to split a single VTX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split VTX Into Multiple Files in .NET"
description: "Split a single VTX file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for .NET (C#, ASP.NET, VB.NET, .NET Core) applications."
...
steps:
    enable: true
    title_left: "Split VTX File Pages in .NET"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to split a single VTX file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Split VTX file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split VTX File Online"
    content: |
        Split VTX file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/vtx) website.
