...
############################# Header ############################
title: "Join VSX Files In C# (.NET Core)"
description: "Join multiple VSX files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more VSX files within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Join more than one VSX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
