...
############################# Head ############################
head_title: "Join XLT Files into One in C# (.NET Core) - XLT Merger"
...
############################# Header ############################
title: "Join XLT Files In C# (.NET Core)"
description: "Join multiple XLT files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more XLT files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join XLT files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one XLT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
