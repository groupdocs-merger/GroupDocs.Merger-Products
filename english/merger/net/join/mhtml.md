...
############################# Head ############################
head_title: "Join MHTML Files into One in C# (.NET Core) - MHTML Merger"
...
############################# Header ############################
title: "Join MHTML Files In C# (.NET Core)"
description: "Join multiple MHTML files into a single file using C# .NET documents merger API. Join selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to join two or more MHTML files within their applications by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Join MHTML files using GroupDocs.Merger for .NET API
...
demos:
    ...
    content: |
        Join more than one MHTML files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/total) website.  
