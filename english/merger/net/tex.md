...
############################# Head ############################
head_title: "Merge TEX Files into One in C# (.NET Core) – TEX Merger"
...
############################# Header ############################
title: "Merge TEX Files In C# (.NET Core)"
description: "Merge multiple TEX files into a single file using C# .NET documents merger API. Merge selected pages or page ranges from various source documents into a single resultant document."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net) makes it easy for .NET developers to merge two or more TEX files within their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Merge more than one TEX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
