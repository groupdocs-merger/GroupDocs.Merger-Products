...
############################# Head ############################
head_title: "Merge DOC Files into One in C# (.NET Core) – DOC Merger"
...
############################# Header ############################
title: "Merge DOC Files In C# (.NET Core)"
description: "Merge multiple DOC files into a single file using C# .NET documents merger API. Merge selected pages or page ranges from various source documents into a single resultant document."
