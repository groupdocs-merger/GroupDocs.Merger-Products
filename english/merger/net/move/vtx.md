...
steps:
    enable: true
    title_left: "Move VTX File Pages"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/net/) makes it easy for .NET developers to move and rearrange pages within a VTX file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Move pages within VTX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
