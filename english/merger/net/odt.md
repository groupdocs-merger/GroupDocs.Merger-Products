...
############################# Head ############################
head_title: "Merge ODT Files into One in C# (.NET Core) – ODT Merger"
...
############################# Header ############################
title: "Merge ODT Files In C# (.NET Core)"
description: "Merge multiple ODT files into a single file using C# .NET documents merger API. Merge selected pages or page ranges from various source documents into a single resultant document."
