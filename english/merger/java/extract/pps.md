...
############################# Head ############################
head_title: "Extract PPS into Multiple Files in Java"
head_description: "Java users to extract a single PPS file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Extract PPS Into Multiple Files in Java"
description: "Extract a single PPS file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Extract PPS File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to extract a single PPS file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```cs
        // Extract PPS file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Exract PPS Pages Online"
    content: |
        Extract PPS file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/pps) website.
