...
############################# Head ############################
head_title: "Delete Specific Pages from Web File in Java"
...
demos:
    ...
    content: |
        Remove pages within Web files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/html) website.  
