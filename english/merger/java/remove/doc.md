...
############################# Head ############################
head_title: "Delete Pages from DOC File in Java"
head_description: "Remove or delete a single page or collection of pages from a DOC file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From DOC in Java"
description: "Delete or Remove a single page or collection of specific pages from a DOC file using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Remove DOC File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a DOC file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Remove DOC Document Pages Online"
    content: |
        Remove pages within DOC files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/remove-pages/doc) website.
