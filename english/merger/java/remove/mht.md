...
############################# Head ############################
head_title: "Delete Pages from MHT File in Java"
head_description: "Remove or delete a single page or collection of pages from a MHT file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From MHT in Java"
description: "Delete or Remove a single page or collection of specific pages from a MHT file using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Remove MHT File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a MHT file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Remove pages within MHT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) website.
