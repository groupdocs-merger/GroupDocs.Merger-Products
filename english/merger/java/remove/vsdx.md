...
############################# Static ############################
layout: "auto-gen"
date: 2022-03-04T17:54:42
draft: false

############################# Head ############################
head_title: "Delete Pages from VSDX File in Java"
head_description: "Remove or delete a single page or collection of pages from a VSDX file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From VSDX in Java"
description: "Delete or Remove a single page or collection of specific pages from a VSDX file using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Remove VSDX File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a VSDX file by implementing a few easy steps.
    ...
    code: |
        ```java
        // Remove VSDX file pages using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Remove VSDX Document Pages Online"
    content: |
        Remove pages within VSDX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsdx) website.
