...
############################# Head ############################
head_title: "Delete Pages from PPT File in Java"
head_description: "Remove or delete a single page or collection of pages from a PPT file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From PPT in Java"
description: "Delete or Remove a single page or collection of specific pages from a PPT file using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Remove PPT File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to delete a single or a number of particular pages within a PPT file by implementing a few easy steps.
