...
############################# Head ############################
head_title: "Delete Specific Pages from OneNote File in Java"
head_description: "Remove or delete a single page or collection of pages from a OneNote file in Java by reversing the pages order using document merger API."

############################# Header ############################
title: "Delete or Remove Pages From OneNote in Java"
description: "Delete or Remove a single page or collection of specific pages from a OneNote file using documents merger API for Java & J2SE applications."
