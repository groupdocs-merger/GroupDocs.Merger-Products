...
############################# Head ############################
head_title: "Combine POTX Files via Java & J2SE Documents Merger API"
head_description: "Combine multiple POTX files in Java using documents merger API with all data, style and formatting as the source documents."

############################# Header ############################
title: "Combine POTX Files in Java Applications"
description: "Combine multiple POTX files into a single file using Java documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    enable: true
    title_left: "Combine Multiple POTX Files in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to combine multiple POTX files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Combine POTX files using GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
        Combine more than one POTX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
