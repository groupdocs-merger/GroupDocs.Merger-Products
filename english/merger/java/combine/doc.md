...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to Combine multiple DOC files by implementing a few easy steps.
...
demos:
    ...
    content: |
        Combine more than one DOC files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/doc) website.  
