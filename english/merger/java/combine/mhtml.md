...
############################# Header ############################
title: "Combine MHTML Files in Java Applications"
description: "Combine multiple MHTML files into a single file using Java documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to combine multiple MHTML files by implementing a few easy steps.
