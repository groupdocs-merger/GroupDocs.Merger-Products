...
############################# Head ############################
head_title: "Combine PS Files via Java & J2SE Documents Merger API"
head_description: "Combine multiple PS files in Java using documents merger API with all data, style and formatting as the source documents."

############################# Header ############################
title: "Combine PS Files in Java Applications"
description: "Combine multiple PS files into a single file using Java documents merger API. Combine selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    enable: true
    title_left: "Combine Multiple PS Files in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to combine multiple PS files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Combine PS files using GroupDocs.Merger for Java API
...
demos:
    ...
    content: |
        Combine more than one PS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/family) website.  
