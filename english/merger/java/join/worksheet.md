...
############################# Header ############################
title: "Join Worksheet Files in Java & J2SE Applications"
description: "Join multiple Worksheet files into a single file using Java documents merger API. Join selected pages or page ranges from various source documents into a single resultant document with all data, style and formatting as the source documents."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to Join multiple Worksheet files by implementing a few easy steps.
...
demos:
    ...
    content: |
        Join more than one Worksheet files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/xlsx) website.  
