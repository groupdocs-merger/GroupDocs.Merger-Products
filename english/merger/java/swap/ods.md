...
############################# Head ############################
head_title: "Swap & Exchange ODS Pages in Java"
head_description: "Java users to swap & exchange positions of two pages within a ODS file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange ODS Pages in Java"
description: "Swap & Exchange positions of two pages within a ODS file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap ODS File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a ODS file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Swap ODS File Pages Online"
    content: |
        Exchange pages within ODS files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/ods) website.
