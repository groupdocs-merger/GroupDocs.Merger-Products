...
############################# Head ############################
head_title: "Swap & Exchange ODP Pages in Java"
head_description: "Java users to swap & exchange positions of two pages within a ODP file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange ODP Pages in Java"
description: "Swap & Exchange positions of two pages within a ODP file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap ODP File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a ODP file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within ODP files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/odp) website.
