...
############################# Head ############################
head_title: "Swap & Exchange DOT Pages in Java"
head_description: "Java users to swap & exchange positions of two pages within a DOT file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange DOT Pages in Java"
description: "Swap & Exchange positions of two pages within a DOT file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap DOT File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a DOT file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Swap DOT File Pages Online"
    content: |
        Exchange pages within DOT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/dot) website.
