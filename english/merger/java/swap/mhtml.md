...
description: "Swap & Exchange positions of two pages within a MHTML file using the documents merger API for Java & J2SE applications."
...
demos:
    ...
    content: |
        Exchange pages within MHTML files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mhtml) website.  
