...
description: "Swap & Exchange positions of two pages within a VSSX file using the documents merger API for Java & J2SE applications."
...
demos:
    ...
    content: |
        Exchange pages within VSSX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vssx) website.  
