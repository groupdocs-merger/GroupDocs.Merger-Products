...
description: "Swap & Exchange positions of two pages within a MHT file using the documents merger API for Java & J2SE applications."
...
steps:
    ...
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a MHT file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within MHT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/mht) website.  
