...
description: "Swap & Exchange positions of two pages within a PPSX file using the documents merger API for Java & J2SE applications."
...
demos:
    ...
    content: |
        Exchange pages within PPSX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ppsx) website.  
