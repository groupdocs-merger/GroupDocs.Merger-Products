...
head_description: "Java users to swap & exchange positions of two pages within a VISIO file using the document merger & split API."

############################# Header ############################
title: "Swap & Exchange VISIO Pages in Java"
description: "Swap & Exchange positions of two pages within a VISIO file using the file splitter API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Swap VISIO File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to swap, exchange and organize pages within a VISIO file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Exchange pages within VISIO files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/swap-pages/visio) website.
