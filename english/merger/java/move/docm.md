...
############################# Head ############################
head_title: "Move, Rearrange & Reorder DOCM Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a DOCM document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder DOCM Pages in Java"
description: "Move and Rearrange the pages within a DOCM document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange DOCM File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a DOCM file by implementing a few easy steps.
    ...
    code: |
        ```java
        // Move DOCM file pages using GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live Demos - Move DOCM Document Pages Online"
    content: |
        Move pages within DOCM files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/docm) website.
