...
############################# Head ############################
head_title: "Move, Rearrange & Reorder OneNote Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a OneNote document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder OneNote Pages in Java"
description: "Move and Rearrange the pages within a OneNote document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange OneNote File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a OneNote file by implementing a few easy steps.
...
demos:
    ...
    content: |
        Move pages within OneNote files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/one) website.  
