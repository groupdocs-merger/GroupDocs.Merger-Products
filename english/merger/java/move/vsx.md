...
############################# Head ############################
head_title: "Move, Rearrange & Reorder VSX Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a VSX document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder VSX Pages in Java"
description: "Move and Rearrange the pages within a VSX document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange VSX File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a VSX file by implementing a few easy steps.
    ...
    code: |
        ```java
        // Move VSX file pages using GroupDocs.Merger API
        int pageNumber = 6;
        int newPageNumber = 1;
...
demos:
    enable: true
    title: "Live Demos - Move VSX Document Pages Online"
    content: |
        Move pages within VSX files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/vsx) website.
