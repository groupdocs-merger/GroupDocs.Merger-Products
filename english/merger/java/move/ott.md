...
############################# Head ############################
head_title: "Move, Rearrange & Reorder OTT Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a OTT document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder OTT Pages in Java"
description: "Move and Rearrange the pages within a OTT document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange OTT File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a OTT file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Move OTT Document Pages Online"
    content: |
        Move pages within OTT files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/ott) website.
