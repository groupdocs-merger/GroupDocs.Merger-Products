...
############################# Head ############################
head_title: "Move, Rearrange & Reorder DOTM Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a DOTM document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder DOTM Pages in Java"
description: "Move and Rearrange the pages within a DOTM document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange DOTM File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a DOTM file by implementing a few easy steps.
