...
############################# Head ############################
head_title: "Move, Rearrange & Reorder EXCEL Pages in Java"
head_description: "Java users to move, rearrange and reorder pages within a EXCEL document by reversing the pages order using document merger API."

############################# Header ############################
title: "Move & Reorder EXCEL Pages in Java"
description: "Move and Rearrange the pages within a EXCEL document to any position using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Rearrange EXCEL File Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to move and rearrange pages within a EXCEL file by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Move EXCEL Document Pages Online"
    content: |
        Move pages within EXCEL files right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/merger/excel) website.
