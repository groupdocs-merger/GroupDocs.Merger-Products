...
############################# Head ############################
head_title: "Split EXCEL into Multiple Files in Java"
head_description: "Java users to split a single EXCEL file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split EXCEL Into Multiple Files in Java"
description: "Split a single EXCEL file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Split EXCEL File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to split a single EXCEL file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Split EXCEL file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split EXCEL File Online"
    content: |
        Split EXCEL file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/excel) website.
