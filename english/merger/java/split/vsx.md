...
############################# Head ############################
head_title: "Split VSX into Multiple Files in Java"
head_description: "Java users to split a single VSX file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split VSX Into Multiple Files in Java"
description: "Split a single VSX file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Split VSX File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to split a single VSX file into multiple resultant files by implementing a few easy steps.
...
demos:
    enable: true
    title: "Live Demos - Split VSX File Online"
    content: |
