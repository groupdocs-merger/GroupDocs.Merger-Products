...
############################# Head ############################
head_title: "Split VISIO into Multiple Files in Java"
head_description: "Java users to split a single VISIO file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split VISIO Into Multiple Files in Java"
description: "Split a single VISIO file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Split VISIO File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to split a single VISIO file into multiple resultant files by implementing a few easy steps.
