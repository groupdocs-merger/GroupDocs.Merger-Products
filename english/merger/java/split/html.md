...
############################# Head ############################
head_title: "Split HTML into Multiple Files in Java"
head_description: "Java users to split a single HTML file into several files based on page numbers, page intervals, even or odd pages using documents merger API."

############################# Header ############################
title: "Split HTML Into Multiple Files in Java"
description: "Split a single HTML file into several resultant files based on page numbers, page intervals, even or odd pages using documents merger API for Java & J2SE applications."
...
steps:
    enable: true
    title_left: "Split HTML File By Pages in Java"
    content_left: |
        [GroupDocs.Merger](https://products.groupdocs.com/merger/java/) makes it easy for Java developers to split a single HTML file into multiple resultant files by implementing a few easy steps.
    ...
    code: |
        ```java
        // Split HTML file using GroupDocs.Merger API
...
demos:
    enable: true
    title: "Live Demos - Split HTML File Online"
    content: |
        Split HTML file right now by visiting [GroupDocs.Merger Live Demos](https://products.groupdocs.app/splitter/html) website.
